...
namespace IdentityStore
{
  ...
  class AWS_IDENTITYSTORE_API IdentityStoreClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        IdentityStoreClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                            std::shared_ptr<Endpoint::IdentityStoreEndpointProvider> endpointProvider = Aws::MakeShared<IdentityStore::Endpoint::IdentityStoreEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::IdentityStoreEndpointProvider> m_endpointProvider;
  };
