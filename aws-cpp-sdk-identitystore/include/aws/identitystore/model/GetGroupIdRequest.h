...
namespace Model
{
  ...
  /**
   */
  class AWS_IDENTITYSTORE_API GetGroupIdRequest : public IdentityStoreRequest
  {
  public:
    GetGroupIdRequest();
    ...
    */
    virtual Aws::UniquePtr<GetGroupIdRequest> Clone() const
    {
      return Aws::MakeUnique<GetGroupIdRequest>(GetServiceRequestName(), *this);
    }
