...
namespace Model
{
  ...
  /**
   */
  class AWS_IDENTITYSTORE_API ListGroupMembershipsRequest : public IdentityStoreRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListGroupMembershipsRequest> Clone() const
    {
      return Aws::MakeUnique<ListGroupMembershipsRequest>(GetServiceRequestName(), *this);
    }
