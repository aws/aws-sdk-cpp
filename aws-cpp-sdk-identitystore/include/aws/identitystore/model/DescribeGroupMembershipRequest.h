...
namespace Model
{
  ...
  /**
   */
  class AWS_IDENTITYSTORE_API DescribeGroupMembershipRequest : public IdentityStoreRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeGroupMembershipRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeGroupMembershipRequest>(GetServiceRequestName(), *this);
    }
