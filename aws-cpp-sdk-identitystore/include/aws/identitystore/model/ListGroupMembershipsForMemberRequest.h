...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListGroupMembershipsForMemberRequest> Clone() const
    {
      return Aws::MakeUnique<ListGroupMembershipsForMemberRequest>(GetServiceRequestName(), *this);
    }
