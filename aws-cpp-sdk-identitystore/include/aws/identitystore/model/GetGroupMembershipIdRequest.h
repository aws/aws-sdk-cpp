...
namespace Model
{
  ...
  /**
   */
  class AWS_IDENTITYSTORE_API GetGroupMembershipIdRequest : public IdentityStoreRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetGroupMembershipIdRequest> Clone() const
    {
      return Aws::MakeUnique<GetGroupMembershipIdRequest>(GetServiceRequestName(), *this);
    }
