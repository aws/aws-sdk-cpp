...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_IDENTITYSTORE_API Email
  {
  public:
    Email();
    Email(Aws::Utils::Json::JsonView jsonValue);
    Email& operator=(Aws::Utils::Json::JsonView jsonValue);
    ...
    /**
     * <p>A boolean representing whether this is the primary email for the associated
     * resource.</p>
     */
