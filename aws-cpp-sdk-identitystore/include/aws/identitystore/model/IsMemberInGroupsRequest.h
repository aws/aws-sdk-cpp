...
namespace Model
{
  ...
  /**
   */
  class AWS_IDENTITYSTORE_API IsMemberInGroupsRequest : public IdentityStoreRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<IsMemberInGroupsRequest> Clone() const
    {
      return Aws::MakeUnique<IsMemberInGroupsRequest>(GetServiceRequestName(), *this);
    }
