...
static const char* ALLOCATION_TAG = "AWSRoute53RecoveryControlConfigEndpointProviderTests";
...
using Route53RecoveryControlConfigResolveEndpointOutcome = Aws::Route53RecoveryControlConfig::Endpoint::Route53RecoveryControlConfigEndpointProvider::Route53RecoveryControlConfigResolveEndpointOutcome;
...
static const Aws::Vector<Route53RecoveryControlConfigEndpointProviderEndpointTestCase> TEST_CASES = {
  ...
  {"For region aws-global with FIPS disabled and DualStack disabled", // documentation
    ...
    {{/*epUrl*/"https://route53-recovery-control-config.us-west-2.amazonaws.com",
       {/*properties*/{"authSchemes", {EpProp("signingRegion", "us-west-2"), EpProp("name", "sigv4"), EpProp("signingName", "route53-recovery-control-config")}}},
...
void ValidateOutcome(const Route53RecoveryControlConfigResolveEndpointOutcome& outcome, const Route53RecoveryControlConfigEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(Route53RecoveryControlConfigEndpointProviderTests, EndpointProviderTest)
{
    ...
    for(const auto& operation : TEST_CASE.operationInput)
    {
         ...
         */
        const Aws::Vector<std::reference_wrapper<const Route53RecoveryControlConfigEndpointProviderEndpointTestCase::OperationParamsFromTest>>
