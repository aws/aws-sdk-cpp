...
using ResolveEndpointOutcome = Aws::DataExchange::Endpoint::DataExchangeEndpointProvider::DataExchangeResolveEndpointOutcome;
...
DataExchangeClient::DataExchangeClient(const Client::ClientConfiguration& clientConfiguration,
                                       std::shared_ptr<Endpoint::DataExchangeEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<DataExchangeErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<DataExchange::Endpoint::DataExchangeEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
