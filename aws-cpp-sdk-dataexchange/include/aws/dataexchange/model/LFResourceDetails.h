...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_DATAEXCHANGE_API LFResourceDetails
  {
  public:
    LFResourceDetails();
    LFResourceDetails(Aws::Utils::Json::JsonView jsonValue);
    LFResourceDetails& operator=(Aws::Utils::Json::JsonView jsonValue);
