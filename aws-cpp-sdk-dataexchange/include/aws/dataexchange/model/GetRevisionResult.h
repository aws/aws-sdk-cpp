...
namespace Model
{
  ...
  public:
     ...
     * revision was revoked.</p>
     */
    inline GetRevisionResult& WithRevocationComment(const Aws::String& value) { SetRevocationComment(value); return *this;}

    /**
     * <p>A required comment to inform subscribers of the reason their access to the
     * revision was revoked.</p>
     */
    inline GetRevisionResult& WithRevocationComment(Aws::String&& value) { SetRevocationComment(std::move(value)); return *this;}

    /**
     * <p>A required comment to inform subscribers of the reason their access to the
     * revision was revoked.</p>
     */
    inline GetRevisionResult& WithRevocationComment(const char* value) { SetRevocationComment(value); return *this;}
     ...
     * <p>A status indicating that subscribers' access to the revision was revoked.</p>
     */
    inline GetRevisionResult& WithRevoked(bool value) { SetRevoked(value); return *this;}
     ...
     * <p>The date and time that the revision was revoked, in ISO 8601 format.</p>
     */
    inline GetRevisionResult& WithRevokedAt(const Aws::Utils::DateTime& value) { SetRevokedAt(value); return *this;}

    /**
     * <p>The date and time that the revision was revoked, in ISO 8601 format.</p>
     */
    inline GetRevisionResult& WithRevokedAt(Aws::Utils::DateTime&& value) { SetRevokedAt(std::move(value)); return *this;}
