...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_DATAEXCHANGE_API ImportAssetsFromLakeFormationTagPolicyRequestDetails
  {
  public:
    ImportAssetsFromLakeFormationTagPolicyRequestDetails();
    ImportAssetsFromLakeFormationTagPolicyRequestDetails(Aws::Utils::Json::JsonView jsonValue);
    ImportAssetsFromLakeFormationTagPolicyRequestDetails& operator=(Aws::Utils::Json::JsonView jsonValue);
