...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_DATAEXCHANGE_API TableLFTagPolicyAndPermissions
  {
  public:
    TableLFTagPolicyAndPermissions();
    TableLFTagPolicyAndPermissions(Aws::Utils::Json::JsonView jsonValue);
    TableLFTagPolicyAndPermissions& operator=(Aws::Utils::Json::JsonView jsonValue);
