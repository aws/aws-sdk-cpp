...
namespace DataExchange
{
  ...
  class AWS_DATAEXCHANGE_API DataExchangeClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        DataExchangeClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                           std::shared_ptr<Endpoint::DataExchangeEndpointProvider> endpointProvider = Aws::MakeShared<DataExchange::Endpoint::DataExchangeEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::DataExchangeEndpointProvider> m_endpointProvider;
  };
