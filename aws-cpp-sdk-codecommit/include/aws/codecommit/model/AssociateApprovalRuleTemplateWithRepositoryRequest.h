...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateApprovalRuleTemplateWithRepositoryRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateApprovalRuleTemplateWithRepositoryRequest>(GetServiceRequestName(), *this);
    }
