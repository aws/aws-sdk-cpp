...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateUnreferencedMergeCommitRequest> Clone() const
    {
      return Aws::MakeUnique<CreateUnreferencedMergeCommitRequest>(GetServiceRequestName(), *this);
    }
