...
namespace Model
{
  ...
  /**
   */
  class AWS_CODECOMMIT_API UpdateApprovalRuleTemplateContentRequest : public CodeCommitRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateApprovalRuleTemplateContentRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateApprovalRuleTemplateContentRequest>(GetServiceRequestName(), *this);
    }
