...
namespace Model
{
  ...
  /**
   */
  class AWS_CODECOMMIT_API UpdatePullRequestApprovalStateRequest : public CodeCommitRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdatePullRequestApprovalStateRequest> Clone() const
    {
      return Aws::MakeUnique<UpdatePullRequestApprovalStateRequest>(GetServiceRequestName(), *this);
    }
