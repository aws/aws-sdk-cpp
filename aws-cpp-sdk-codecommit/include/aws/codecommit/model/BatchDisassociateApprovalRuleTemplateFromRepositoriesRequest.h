...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchDisassociateApprovalRuleTemplateFromRepositoriesRequest> Clone() const
    {
      return Aws::MakeUnique<BatchDisassociateApprovalRuleTemplateFromRepositoriesRequest>(GetServiceRequestName(), *this);
    }
