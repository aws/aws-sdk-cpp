...
namespace Model
{
  ...
  /**
   */
  class AWS_CODECOMMIT_API UpdateApprovalRuleTemplateDescriptionRequest : public CodeCommitRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateApprovalRuleTemplateDescriptionRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateApprovalRuleTemplateDescriptionRequest>(GetServiceRequestName(), *this);
    }
