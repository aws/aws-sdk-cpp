...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<MergePullRequestByFastForwardRequest> Clone() const
    {
      return Aws::MakeUnique<MergePullRequestByFastForwardRequest>(GetServiceRequestName(), *this);
    }
