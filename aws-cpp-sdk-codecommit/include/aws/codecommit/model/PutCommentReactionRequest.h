...
namespace Model
{
  ...
  /**
   */
  class AWS_CODECOMMIT_API PutCommentReactionRequest : public CodeCommitRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutCommentReactionRequest> Clone() const
    {
      return Aws::MakeUnique<PutCommentReactionRequest>(GetServiceRequestName(), *this);
    }
