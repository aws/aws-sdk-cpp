...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateRepositoryDescriptionRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateRepositoryDescriptionRequest>(GetServiceRequestName(), *this);
    }
