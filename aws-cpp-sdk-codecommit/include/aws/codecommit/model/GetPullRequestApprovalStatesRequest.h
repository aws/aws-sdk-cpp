...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetPullRequestApprovalStatesRequest> Clone() const
    {
      return Aws::MakeUnique<GetPullRequestApprovalStatesRequest>(GetServiceRequestName(), *this);
    }
