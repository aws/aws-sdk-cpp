...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchAssociateApprovalRuleTemplateWithRepositoriesRequest> Clone() const
    {
      return Aws::MakeUnique<BatchAssociateApprovalRuleTemplateWithRepositoriesRequest>(GetServiceRequestName(), *this);
    }
