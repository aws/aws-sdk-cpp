...
namespace Model
{
  ...
  /**
   */
  class AWS_CODECOMMIT_API UpdatePullRequestApprovalRuleContentRequest : public CodeCommitRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdatePullRequestApprovalRuleContentRequest> Clone() const
    {
      return Aws::MakeUnique<UpdatePullRequestApprovalRuleContentRequest>(GetServiceRequestName(), *this);
    }
