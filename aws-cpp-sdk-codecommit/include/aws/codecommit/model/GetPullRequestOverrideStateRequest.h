...
namespace Model
{
  ...
  /**
   */
  class AWS_CODECOMMIT_API GetPullRequestOverrideStateRequest : public CodeCommitRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetPullRequestOverrideStateRequest> Clone() const
    {
      return Aws::MakeUnique<GetPullRequestOverrideStateRequest>(GetServiceRequestName(), *this);
    }
