...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdatePullRequestDescriptionRequest> Clone() const
    {
      return Aws::MakeUnique<UpdatePullRequestDescriptionRequest>(GetServiceRequestName(), *this);
    }
