...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListRepositoriesForApprovalRuleTemplateRequest> Clone() const
    {
      return Aws::MakeUnique<ListRepositoriesForApprovalRuleTemplateRequest>(GetServiceRequestName(), *this);
    }
