...
namespace Model
{
  ...
  /**
   */
  class AWS_CODECOMMIT_API GetApprovalRuleTemplateRequest : public CodeCommitRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetApprovalRuleTemplateRequest> Clone() const
    {
      return Aws::MakeUnique<GetApprovalRuleTemplateRequest>(GetServiceRequestName(), *this);
    }
