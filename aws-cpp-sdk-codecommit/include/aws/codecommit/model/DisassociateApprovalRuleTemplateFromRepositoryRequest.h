...
namespace Model
{
  ...
  /**
   */
  class AWS_CODECOMMIT_API DisassociateApprovalRuleTemplateFromRepositoryRequest : public CodeCommitRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateApprovalRuleTemplateFromRepositoryRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateApprovalRuleTemplateFromRepositoryRequest>(GetServiceRequestName(), *this);
    }
