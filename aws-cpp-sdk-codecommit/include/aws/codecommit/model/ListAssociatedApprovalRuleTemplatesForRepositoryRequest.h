...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListAssociatedApprovalRuleTemplatesForRepositoryRequest> Clone() const
    {
      return Aws::MakeUnique<ListAssociatedApprovalRuleTemplatesForRepositoryRequest>(GetServiceRequestName(), *this);
    }
