...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreatePullRequestApprovalRuleRequest> Clone() const
    {
      return Aws::MakeUnique<CreatePullRequestApprovalRuleRequest>(GetServiceRequestName(), *this);
    }
