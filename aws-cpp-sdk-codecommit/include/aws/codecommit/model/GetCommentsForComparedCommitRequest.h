...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetCommentsForComparedCommitRequest> Clone() const
    {
      return Aws::MakeUnique<GetCommentsForComparedCommitRequest>(GetServiceRequestName(), *this);
    }
