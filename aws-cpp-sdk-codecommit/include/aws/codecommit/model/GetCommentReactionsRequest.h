...
namespace Model
{
  ...
  /**
   */
  class AWS_CODECOMMIT_API GetCommentReactionsRequest : public CodeCommitRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetCommentReactionsRequest> Clone() const
    {
      return Aws::MakeUnique<GetCommentReactionsRequest>(GetServiceRequestName(), *this);
    }
