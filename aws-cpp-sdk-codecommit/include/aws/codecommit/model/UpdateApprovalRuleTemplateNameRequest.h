...
namespace Model
{
  ...
  /**
   */
  class AWS_CODECOMMIT_API UpdateApprovalRuleTemplateNameRequest : public CodeCommitRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateApprovalRuleTemplateNameRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateApprovalRuleTemplateNameRequest>(GetServiceRequestName(), *this);
    }
