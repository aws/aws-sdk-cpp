...
namespace Model
{
  ...
  /**
   */
  class AWS_CODECOMMIT_API EvaluatePullRequestApprovalRulesRequest : public CodeCommitRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<EvaluatePullRequestApprovalRulesRequest> Clone() const
    {
      return Aws::MakeUnique<EvaluatePullRequestApprovalRulesRequest>(GetServiceRequestName(), *this);
    }
