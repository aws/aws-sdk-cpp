...
namespace Model
{
  ...
  /**
   */
  class AWS_CODECOMMIT_API MergeBranchesBySquashRequest : public CodeCommitRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<MergeBranchesBySquashRequest> Clone() const
    {
      return Aws::MakeUnique<MergeBranchesBySquashRequest>(GetServiceRequestName(), *this);
    }
