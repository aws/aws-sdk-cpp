...
namespace Model
{
  ...
  /**
   */
  class AWS_CODECOMMIT_API DeletePullRequestApprovalRuleRequest : public CodeCommitRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeletePullRequestApprovalRuleRequest> Clone() const
    {
      return Aws::MakeUnique<DeletePullRequestApprovalRuleRequest>(GetServiceRequestName(), *this);
    }
