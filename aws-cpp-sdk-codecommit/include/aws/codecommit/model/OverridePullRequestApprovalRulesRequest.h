...
namespace Model
{
  ...
  /**
   */
  class AWS_CODECOMMIT_API OverridePullRequestApprovalRulesRequest : public CodeCommitRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<OverridePullRequestApprovalRulesRequest> Clone() const
    {
      return Aws::MakeUnique<OverridePullRequestApprovalRulesRequest>(GetServiceRequestName(), *this);
    }
