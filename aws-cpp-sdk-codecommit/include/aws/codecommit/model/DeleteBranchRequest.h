...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CODECOMMIT_API DeleteBranchRequest : public CodeCommitRequest
  {
  public:
    DeleteBranchRequest();
    ...
    */
    virtual Aws::UniquePtr<DeleteBranchRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteBranchRequest>(GetServiceRequestName(), *this);
    }
