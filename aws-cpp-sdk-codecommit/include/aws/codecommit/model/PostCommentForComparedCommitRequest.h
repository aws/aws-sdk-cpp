...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PostCommentForComparedCommitRequest> Clone() const
    {
      return Aws::MakeUnique<PostCommentForComparedCommitRequest>(GetServiceRequestName(), *this);
    }
