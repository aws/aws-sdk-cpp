...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchDescribeMergeConflictsRequest> Clone() const
    {
      return Aws::MakeUnique<BatchDescribeMergeConflictsRequest>(GetServiceRequestName(), *this);
    }
