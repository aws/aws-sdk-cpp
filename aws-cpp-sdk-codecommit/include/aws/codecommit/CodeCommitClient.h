...
namespace Model
{
   ...
   * Reference</i>. This reference provides descriptions of the AWS CodeCommit
   * API.</p> <p>You can use the AWS CodeCommit API to work with the following
   * objects:</p> <ul> <li>Repositories</li> <li>Branches</li> <li>Commits</li> </ul>
   * <p>For information about how to use AWS CodeCommit, see the <i>AWS CodeCommit
   * User Guide</i>.</p>
   */
    ...
    public:
      typedef Aws::Client::AWSJsonClient BASECLASS;
        ...
        */
        ...
        /**
         * <p>Gets information about one or more repositories.</p> <note><p>The description
         ...
         * in a web page could expose users to potentially malicious code. Make sure that
         * you HTML-encode the description field in any application that uses this API to
         ...
         * <note>Calling the create branch operation does not set a repository's default
         * branch. To do this, call the update default branch operation.</note>
         */
        ...
        /**
         * <p>Retrieves information about a repository branch, including its name and the
         * last commit ID.</p>
         */
        ...
        /**
         * <p>Gets information about a repository.</p> <note><p>The description field for a
