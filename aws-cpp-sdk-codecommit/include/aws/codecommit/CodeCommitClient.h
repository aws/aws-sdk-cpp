...
namespace CodeCommit
{
  ...
  class AWS_CODECOMMIT_API CodeCommitClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        CodeCommitClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                         std::shared_ptr<Endpoint::CodeCommitEndpointProvider> endpointProvider = Aws::MakeShared<CodeCommit::Endpoint::CodeCommitEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::CodeCommitEndpointProvider> m_endpointProvider;
  };
