...
Aws::String CodeCommitEndpointRules::GetRulesAsString()
{
    return Aws::String(CodeCommitEndpointRules::Rules.begin(), CodeCommitEndpointRules::Rules.end());
}

const Aws::Vector<char> CodeCommitEndpointRules::Rules = {
