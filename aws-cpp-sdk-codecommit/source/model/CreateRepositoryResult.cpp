...
CreateRepositoryResult::CreateRepositoryResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

CreateRepositoryResult& CreateRepositoryResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
