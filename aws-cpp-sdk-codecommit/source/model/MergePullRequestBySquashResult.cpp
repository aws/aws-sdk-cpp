...
MergePullRequestBySquashResult::MergePullRequestBySquashResult()
{
}

MergePullRequestBySquashResult::MergePullRequestBySquashResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
