...
DescribeSessionsResult::DescribeSessionsResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

DescribeSessionsResult& DescribeSessionsResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
