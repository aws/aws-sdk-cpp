...
using ResolveEndpointOutcome = Aws::AppStream::Endpoint::AppStreamEndpointProvider::AppStreamResolveEndpointOutcome;
...
AppStreamClient::AppStreamClient(const Client::ClientConfiguration& clientConfiguration,
                                 std::shared_ptr<Endpoint::AppStreamEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<AppStreamErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<AppStream::Endpoint::AppStreamEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
