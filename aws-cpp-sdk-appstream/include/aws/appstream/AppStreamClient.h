...
namespace AppStream
{
  ...
  class AWS_APPSTREAM_API AppStreamClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        AppStreamClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                        std::shared_ptr<Endpoint::AppStreamEndpointProvider> endpointProvider = Aws::MakeShared<AppStream::Endpoint::AppStreamEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::AppStreamEndpointProvider> m_endpointProvider;
  };
