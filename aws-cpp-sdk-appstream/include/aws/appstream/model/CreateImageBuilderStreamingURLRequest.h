...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateImageBuilderStreamingURLRequest> Clone() const
    {
      return Aws::MakeUnique<CreateImageBuilderStreamingURLRequest>(GetServiceRequestName(), *this);
    }
