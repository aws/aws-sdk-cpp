...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListAssociatedFleetsRequest> Clone() const
    {
      return Aws::MakeUnique<ListAssociatedFleetsRequest>(GetServiceRequestName(), *this);
    }
     ...
     * operation. If this value is null, it retrieves the first page.</p>
     */
    inline ListAssociatedFleetsRequest& WithNextToken(Aws::String&& value) { SetNextToken(std::move(value)); return *this;}
