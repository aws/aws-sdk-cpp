...
namespace Model
{
  ...
  /**
   */
  class AWS_APPSTREAM_API DeleteEntitlementRequest : public AppStreamRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteEntitlementRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteEntitlementRequest>(GetServiceRequestName(), *this);
    }
