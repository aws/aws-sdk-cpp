...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateApplicationFleetRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateApplicationFleetRequest>(GetServiceRequestName(), *this);
    }
