...
namespace Model
{
  ...
  /**
   */
  class AWS_APPSTREAM_API AssociateApplicationToEntitlementRequest : public AppStreamRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateApplicationToEntitlementRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateApplicationToEntitlementRequest>(GetServiceRequestName(), *this);
    }
