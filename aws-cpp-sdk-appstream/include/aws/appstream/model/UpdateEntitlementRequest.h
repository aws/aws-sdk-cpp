...
namespace Model
{
  ...
  /**
   */
  class AWS_APPSTREAM_API UpdateEntitlementRequest : public AppStreamRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateEntitlementRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateEntitlementRequest>(GetServiceRequestName(), *this);
    }
