...
namespace Model
{
  ...
  /**
   */
  class AWS_APPSTREAM_API AssociateApplicationFleetRequest : public AppStreamRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateApplicationFleetRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateApplicationFleetRequest>(GetServiceRequestName(), *this);
    }
