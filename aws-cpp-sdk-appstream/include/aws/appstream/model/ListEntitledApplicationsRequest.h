...
namespace Model
{
  ...
  /**
   */
  class AWS_APPSTREAM_API ListEntitledApplicationsRequest : public AppStreamRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListEntitledApplicationsRequest> Clone() const
    {
      return Aws::MakeUnique<ListEntitledApplicationsRequest>(GetServiceRequestName(), *this);
    }
