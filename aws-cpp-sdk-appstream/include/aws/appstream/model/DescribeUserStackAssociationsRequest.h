...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeUserStackAssociationsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeUserStackAssociationsRequest>(GetServiceRequestName(), *this);
    }
