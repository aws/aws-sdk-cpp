...
namespace Model
{
  ...
  /**
   */
  class AWS_APPSTREAM_API DescribeApplicationsRequest : public AppStreamRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeApplicationsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeApplicationsRequest>(GetServiceRequestName(), *this);
    }
