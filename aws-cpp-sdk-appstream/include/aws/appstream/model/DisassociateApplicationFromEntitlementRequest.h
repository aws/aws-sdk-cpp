...
namespace Model
{
  ...
  /**
   */
  class AWS_APPSTREAM_API DisassociateApplicationFromEntitlementRequest : public AppStreamRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateApplicationFromEntitlementRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateApplicationFromEntitlementRequest>(GetServiceRequestName(), *this);
    }
