...
namespace Model
{
  ...
  /**
   */
  class AWS_APPSTREAM_API DescribeEntitlementsRequest : public AppStreamRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeEntitlementsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeEntitlementsRequest>(GetServiceRequestName(), *this);
    }
