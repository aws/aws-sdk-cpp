...
namespace Model
{
  ...
  /**
   */
  class AWS_APPSTREAM_API DisableUserRequest : public AppStreamRequest
  {
  public:
    DisableUserRequest();
    ...
    */
    virtual Aws::UniquePtr<DisableUserRequest> Clone() const
    {
      return Aws::MakeUnique<DisableUserRequest>(GetServiceRequestName(), *this);
    }
