...
namespace Model
{
  ...
  /**
   */
  class AWS_APPSTREAM_API DescribeApplicationFleetAssociationsRequest : public AppStreamRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeApplicationFleetAssociationsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeApplicationFleetAssociationsRequest>(GetServiceRequestName(), *this);
    }
