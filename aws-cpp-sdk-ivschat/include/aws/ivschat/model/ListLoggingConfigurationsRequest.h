...
namespace Model
{
  ...
  /**
   */
  class AWS_IVSCHAT_API ListLoggingConfigurationsRequest : public IvschatRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListLoggingConfigurationsRequest> Clone() const
    {
      return Aws::MakeUnique<ListLoggingConfigurationsRequest>(GetServiceRequestName(), *this);
    }
