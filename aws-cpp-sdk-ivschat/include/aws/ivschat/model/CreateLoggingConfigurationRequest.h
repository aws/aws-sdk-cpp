...
namespace Model
{
  ...
  /**
   */
  class AWS_IVSCHAT_API CreateLoggingConfigurationRequest : public IvschatRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateLoggingConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<CreateLoggingConfigurationRequest>(GetServiceRequestName(), *this);
    }
