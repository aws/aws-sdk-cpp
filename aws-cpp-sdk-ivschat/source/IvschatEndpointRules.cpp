...
Aws::String IvschatEndpointRules::GetRulesAsString()
{
    return Aws::String(IvschatEndpointRules::Rules.begin(), IvschatEndpointRules::Rules.end());
}

const Aws::Vector<char> IvschatEndpointRules::Rules = {
...
'/','i','v','s','c','h','a','t','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P',
...
's','c','h','a','t','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n',
