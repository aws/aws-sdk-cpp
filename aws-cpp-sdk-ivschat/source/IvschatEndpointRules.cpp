...
namespace ivschat
{
const size_t IvschatEndpointRules::RulesBlobStrLen = 3522;
const size_t IvschatEndpointRules::RulesBlobSize = 3523;
...
'c','h','a','t','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i',
...
't','p','s',':','/','/','i','v','s','c','h','a','t','-','f','i','p','s','.','{','R','e','g','i','o',
