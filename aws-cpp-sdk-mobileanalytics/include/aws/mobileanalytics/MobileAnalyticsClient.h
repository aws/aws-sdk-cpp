...
namespace Model
{
  ...
  */
  class AWS_MOBILEANALYTICS_API MobileAnalyticsClient : public Aws::Client::AWSJsonRestClient
  {
    public:
    ...
    * use PutEventsAsync.
    */
    inline void RegisterPutEventsOutcomeReceivedHandler(const PutEventsOutcomeReceivedEvent::EventHandler& handler)
    {
      m_onPutEventsOutcomeReceived += handler;
    }

    /**
    * Clears all event handlers for PutEvents.
    */
    inline void ClearAllPutEventsOutcomeReceivedHandlers()
    {
      m_onPutEventsOutcomeReceived.Clear();
    }
  ...
  private:
    ...
    /** events **/
    PutEventsOutcomeReceivedEvent m_onPutEventsOutcomeReceived;
  };
