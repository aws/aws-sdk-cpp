...
/* Service model headers required in MobileAnalyticsClient header */
#include <aws/core/NoResult.h>
/* End of service model headers required in MobileAnalyticsClient header */
...
namespace Aws
{
  ...
  namespace MobileAnalytics
  {
    namespace Model
    {
      /* Service model forward declarations required in MobileAnalyticsClient header */
      class PutEventsRequest;
      /* End of service model forward declarations required in MobileAnalyticsClient header */
