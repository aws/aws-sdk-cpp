  ...
  Aws::String ForRegion(Region region)
  {
    switch(region)
    {
     case Region::US_EAST_1:
        return "mobileanalytics.us-east-1.amazonaws.com";
     case Region::US_WEST_1:
        return "mobileanalytics.us-west-1.amazonaws.com";
     case Region::US_WEST_2:
        return "mobileanalytics.us-west-2.amazonaws.com";
     case Region::EU_WEST_1:
        return "mobileanalytics.eu-west-1.amazonaws.com";
     case Region::EU_CENTRAL_1:
        return "mobileanalytics.eu-central-1.amazonaws.com";
     case Region::AP_SOUTHEAST_1:
        return "mobileanalytics.ap-southeast-1.amazonaws.com";
     ...
     case Region::AP_SOUTH_1:
        return "mobileanalytics.ap-south-1.amazonaws.com";
     default:
        return "mobileanalytics.us-east-1.amazonaws.com";
    }
  }
