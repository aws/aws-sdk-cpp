...
static const char* ALLOCATION_TAG = "AWSEC2InstanceConnectEndpointProviderTests";
using EC2InstanceConnectEndpointProvider = Aws::EC2InstanceConnect::Endpoint::EC2InstanceConnectEndpointProvider;
using EndpointParameters = Aws::Vector<Aws::Endpoint::EndpointParameter>;
using EC2InstanceConnectResolveEndpointOutcome = Aws::EC2InstanceConnect::Endpoint::EC2InstanceConnectEndpointProvider::EC2InstanceConnectResolveEndpointOutcome;
...
class EC2InstanceConnectEndpointProviderTests :public ::testing::TestWithParam<size_t>
{
public:
...
struct EC2InstanceConnectEndpointProviderEndpointTestCase
{
...
static const Aws::Vector<EC2InstanceConnectEndpointProviderEndpointTestCase> TEST_CASES = {
  /*TEST CASE 0*/
...
void ValidateOutcome(const EC2InstanceConnectResolveEndpointOutcome& outcome, const EC2InstanceConnectEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(EC2InstanceConnectEndpointProviderTests, EndpointProviderTest)
{
    ...
    const EC2InstanceConnectEndpointProviderEndpointTestCase& TEST_CASE = TEST_CASES.at(TEST_CASE_IDX);
    SCOPED_TRACE(Aws::String("\nTEST CASE # ") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX) + ": " + TEST_CASE.documentation);

    std::shared_ptr<EC2InstanceConnectEndpointProvider> endpointProvider = Aws::MakeShared<EC2InstanceConnectEndpointProvider>(ALLOCATION_TAG);
    ASSERT_TRUE(endpointProvider) << "Failed to allocate/initialize EC2InstanceConnectEndpointProvider";
    ...
    for(const auto& operation : TEST_CASE.operationInput)
    {
         ...
         */
        const Aws::Vector<std::reference_wrapper<const EC2InstanceConnectEndpointProviderEndpointTestCase::OperationParamsFromTest>>
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         EC2InstanceConnectEndpointProviderTests,
