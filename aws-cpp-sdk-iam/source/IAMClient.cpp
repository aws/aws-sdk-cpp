...
using ResolveEndpointOutcome = Aws::IAM::Endpoint::IAMEndpointProvider::IAMResolveEndpointOutcome;
...
IAMClient::IAMClient(const Client::ClientConfiguration& clientConfiguration,
                     std::shared_ptr<Endpoint::IAMEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<IAMErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<IAM::Endpoint::IAMEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
