...
Aws::String IAMEndpointRules::GetRulesAsString()
{
    return Aws::String(IAMEndpointRules::Rules.begin(), IAMEndpointRules::Rules.end());
}

const Aws::Vector<char> IAMEndpointRules::Rules = {
