...
CreateGroupResult::CreateGroupResult(const AmazonWebServiceResult<XmlDocument>& result)
{
  *this = result;
}

CreateGroupResult& CreateGroupResult::operator =(const AmazonWebServiceResult<XmlDocument>& result)
{
