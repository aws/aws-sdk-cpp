...
CreateAccessKeyResult::CreateAccessKeyResult(const AmazonWebServiceResult<XmlDocument>& result)
{
  *this = result;
}

CreateAccessKeyResult& CreateAccessKeyResult::operator =(const AmazonWebServiceResult<XmlDocument>& result)
{
