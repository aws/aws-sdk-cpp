...
GetGroupPolicyResult::GetGroupPolicyResult(const AmazonWebServiceResult<XmlDocument>& result)
{
  *this = result;
}

GetGroupPolicyResult& GetGroupPolicyResult::operator =(const AmazonWebServiceResult<XmlDocument>& result)
{
