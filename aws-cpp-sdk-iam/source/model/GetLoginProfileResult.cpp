...
GetLoginProfileResult::GetLoginProfileResult(const AmazonWebServiceResult<XmlDocument>& result)
{
  *this = result;
}

GetLoginProfileResult& GetLoginProfileResult::operator =(const AmazonWebServiceResult<XmlDocument>& result)
{
