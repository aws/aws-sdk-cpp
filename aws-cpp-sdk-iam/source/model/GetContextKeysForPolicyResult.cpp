...
GetContextKeysForPolicyResult::GetContextKeysForPolicyResult()
{
}

GetContextKeysForPolicyResult::GetContextKeysForPolicyResult(const AmazonWebServiceResult<XmlDocument>& result)
{
  *this = result;
}

GetContextKeysForPolicyResult& GetContextKeysForPolicyResult::operator =(const AmazonWebServiceResult<XmlDocument>& result)
{
  ...
  AWS_LOGSTREAM_DEBUG("Aws::IAM::Model::GetContextKeysForPolicyResult", "x-amzn-request-id: " << m_responseMetadata.GetRequestId() );
