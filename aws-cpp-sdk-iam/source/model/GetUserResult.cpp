...
GetUserResult::GetUserResult(const AmazonWebServiceResult<XmlDocument>& result)
{
  *this = result;
}

GetUserResult& GetUserResult::operator =(const AmazonWebServiceResult<XmlDocument>& result)
{
