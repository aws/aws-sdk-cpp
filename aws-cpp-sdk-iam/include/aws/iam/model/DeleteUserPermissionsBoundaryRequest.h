...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteUserPermissionsBoundaryRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteUserPermissionsBoundaryRequest>(GetServiceRequestName(), *this);
    }
