...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetAccountAuthorizationDetailsRequest> Clone() const
    {
      return Aws::MakeUnique<GetAccountAuthorizationDetailsRequest>(GetServiceRequestName(), *this);
    }
