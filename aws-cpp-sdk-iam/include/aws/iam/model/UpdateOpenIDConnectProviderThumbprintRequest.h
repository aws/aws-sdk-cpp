...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateOpenIDConnectProviderThumbprintRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateOpenIDConnectProviderThumbprintRequest>(GetServiceRequestName(), *this);
    }
