...
namespace Model
{
  ...
  public:
    ...
    inline virtual const char* GetServiceRequestName() override { return "ListGroupsForUser"; }
  ...
  public:
    ...
    /**
     * <p>The name of the user to list groups for.</p> <p>This parameter allows (per
