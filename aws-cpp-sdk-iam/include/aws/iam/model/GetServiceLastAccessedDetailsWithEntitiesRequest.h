...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetServiceLastAccessedDetailsWithEntitiesRequest> Clone() const
    {
      return Aws::MakeUnique<GetServiceLastAccessedDetailsWithEntitiesRequest>(GetServiceRequestName(), *this);
    }
