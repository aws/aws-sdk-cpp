...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateAccountPasswordPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateAccountPasswordPolicyRequest>(GetServiceRequestName(), *this);
    }
