...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<SetSecurityTokenServicePreferencesRequest> Clone() const
    {
      return Aws::MakeUnique<SetSecurityTokenServicePreferencesRequest>(GetServiceRequestName(), *this);
    }
