...
namespace Model
{
   ...
   * certificate chain, and private key. </p> <p> This data type is used as a
   * response element in the <a>UploadServerCertificate</a> and
   * <a>ListServerCertificates</a> actions. </p>
   */
