...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateServiceSpecificCredentialRequest> Clone() const
    {
      return Aws::MakeUnique<CreateServiceSpecificCredentialRequest>(GetServiceRequestName(), *this);
    }
