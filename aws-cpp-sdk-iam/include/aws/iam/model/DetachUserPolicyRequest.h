...
namespace Model
{
  ...
  /**
   */
  class AWS_IAM_API DetachUserPolicyRequest : public IAMRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DetachUserPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<DetachUserPolicyRequest>(GetServiceRequestName(), *this);
    }
