...
namespace Model
{
  ...
  public:
     ...
     * 3rd 2018 22:50 PDT to May 23rd 2018 14:08 PDT. This affects <a
     ...
     * date the user last signed in before May 3rd 2018. For users that signed in after
     * May 23rd 2018 14:08 PDT, the returned password last used date is accurate.</p>
     * <p>If you use password last used information to identify unused credentials for
     * deletion, such as deleting users who did not sign in to AWS in the last 90 days,
     * we recommend that you adjust your evaluation window to include dates after May
     * 23rd 2018. Alternatively, if your users use access keys to access AWS
     * programmatically you can refer to access key last used information because it is
     * accurate for all dates. </p> </important>
     */
