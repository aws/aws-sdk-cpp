...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<RemoveUserFromGroupRequest> Clone() const
    {
      return Aws::MakeUnique<RemoveUserFromGroupRequest>(GetServiceRequestName(), *this);
    }
  ...
  public:
    ...
    /**
     * <p>The name of the user to remove.</p> <p>This parameter allows (through its <a
     * href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string of characters
     * consisting of upper and lowercase alphanumeric characters with no spaces. You
     * can also include any of the following characters: _+=,.@-</p>
     */
