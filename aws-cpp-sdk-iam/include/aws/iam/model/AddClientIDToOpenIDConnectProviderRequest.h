...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AddClientIDToOpenIDConnectProviderRequest> Clone() const
    {
      return Aws::MakeUnique<AddClientIDToOpenIDConnectProviderRequest>(GetServiceRequestName(), *this);
    }
