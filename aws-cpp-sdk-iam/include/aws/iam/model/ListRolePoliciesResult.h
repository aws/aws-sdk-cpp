...
namespace Model
{
   ...
   */
  class AWS_IAM_API ListRolePoliciesResult
  {
  public:
    ListRolePoliciesResult();
    ListRolePoliciesResult(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    ListRolePoliciesResult& operator=(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
     ...
     * <p>A list of policy names.</p>
     */
    inline ListRolePoliciesResult& WithPolicyNames(Aws::Vector<Aws::String>&& value) { SetPolicyNames(value); return *this;}
    ...
    inline ListRolePoliciesResult& WithResponseMetadata(ResponseMetadata&& value) { SetResponseMetadata(value); return *this;}
