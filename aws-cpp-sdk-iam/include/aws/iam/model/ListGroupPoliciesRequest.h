...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListGroupPoliciesRequest> Clone() const
    {
      return Aws::MakeUnique<ListGroupPoliciesRequest>(GetServiceRequestName(), *this);
    }
  ...
  public:
     ...
     * the next call should start.</p>
     */
    inline ListGroupPoliciesRequest& WithMarker(Aws::String&& value) { SetMarker(std::move(value)); return *this;}
