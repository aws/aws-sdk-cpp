...
namespace Model
{
  ...
  */
  class AWS_IAM_API ListInstanceProfilesResult
  {
  public:
    ListInstanceProfilesResult();
    ListInstanceProfilesResult(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    ListInstanceProfilesResult& operator=(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    ...
    */
    ...
    /*
     <p> A flag that indicates whether there are more instance profiles to list. If your results were truncated, you can make a subsequent pagination request using the <code>Marker</code> request parameter to retrieve more instance profiles in the list. </p>
    */
