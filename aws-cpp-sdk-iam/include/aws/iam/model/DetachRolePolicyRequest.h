...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DetachRolePolicyRequest> Clone() const
    {
      return Aws::MakeUnique<DetachRolePolicyRequest>(GetServiceRequestName(), *this);
    }
  ...
  public:
     ...
     * can also include any of the following characters: _+=,.@-</p>
     */
    inline DetachRolePolicyRequest& WithRoleName(Aws::String&& value) { SetRoleName(std::move(value)); return *this;}
