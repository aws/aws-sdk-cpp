...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListRolePoliciesRequest> Clone() const
    {
      return Aws::MakeUnique<ListRolePoliciesRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "ListRolePolicies"; }
  ...
  public:
    ...
    /**
     * <p>The name of the role to list policies for.</p> <p>This parameter allows
     ...
     * _+=,.@-</p>
     */
    inline ListRolePoliciesRequest& WithRoleName(Aws::String&& value) { SetRoleName(std::move(value)); return *this;}
     ...
     * the next call should start.</p>
     */
    inline ListRolePoliciesRequest& WithMarker(Aws::String&& value) { SetMarker(std::move(value)); return *this;}
