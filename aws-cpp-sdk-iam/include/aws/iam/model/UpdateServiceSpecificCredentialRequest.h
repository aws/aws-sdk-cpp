...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateServiceSpecificCredentialRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateServiceSpecificCredentialRequest>(GetServiceRequestName(), *this);
    }
