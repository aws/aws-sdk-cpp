...
namespace Model
{
  ...
  /**
   */
  class AWS_IAM_API UntagMFADeviceRequest : public IAMRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UntagMFADeviceRequest> Clone() const
    {
      return Aws::MakeUnique<UntagMFADeviceRequest>(GetServiceRequestName(), *this);
    }
