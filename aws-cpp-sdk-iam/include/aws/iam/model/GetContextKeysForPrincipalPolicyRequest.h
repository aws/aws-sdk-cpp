...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetContextKeysForPrincipalPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<GetContextKeysForPrincipalPolicyRequest>(GetServiceRequestName(), *this);
    }
