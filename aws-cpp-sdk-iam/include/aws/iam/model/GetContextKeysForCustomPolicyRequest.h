...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetContextKeysForCustomPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<GetContextKeysForCustomPolicyRequest>(GetServiceRequestName(), *this);
    }
