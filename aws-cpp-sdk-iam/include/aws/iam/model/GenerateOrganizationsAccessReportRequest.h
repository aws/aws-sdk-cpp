...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GenerateOrganizationsAccessReportRequest> Clone() const
    {
      return Aws::MakeUnique<GenerateOrganizationsAccessReportRequest>(GetServiceRequestName(), *this);
    }
