...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetUserRequest> Clone() const
    {
      return Aws::MakeUnique<GetUserRequest>(GetServiceRequestName(), *this);
    }
  ...
  public:
     ...
     * can also include any of the following characters: _+=,.@-</p>
     */
    inline GetUserRequest& WithUserName(Aws::String&& value) { SetUserName(std::move(value)); return *this;}
