...
namespace Model
{
  ...
  /**
   */
  class AWS_IAM_API TagPolicyRequest : public IAMRequest
  {
  public:
    TagPolicyRequest();
    ...
    */
    virtual Aws::UniquePtr<TagPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<TagPolicyRequest>(GetServiceRequestName(), *this);
    }
