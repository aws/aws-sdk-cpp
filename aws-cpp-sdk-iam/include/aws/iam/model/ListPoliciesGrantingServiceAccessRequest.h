...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListPoliciesGrantingServiceAccessRequest> Clone() const
    {
      return Aws::MakeUnique<ListPoliciesGrantingServiceAccessRequest>(GetServiceRequestName(), *this);
    }
