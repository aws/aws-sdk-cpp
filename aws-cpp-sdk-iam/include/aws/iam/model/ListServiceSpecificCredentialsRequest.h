...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListServiceSpecificCredentialsRequest> Clone() const
    {
      return Aws::MakeUnique<ListServiceSpecificCredentialsRequest>(GetServiceRequestName(), *this);
    }
