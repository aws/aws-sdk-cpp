...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ResetServiceSpecificCredentialRequest> Clone() const
    {
      return Aws::MakeUnique<ResetServiceSpecificCredentialRequest>(GetServiceRequestName(), *this);
    }
