...
namespace Model
{
  ...
  /**
   */
  class AWS_IAM_API ResetServiceSpecificCredentialRequest : public IAMRequest
  {
  public:
  ...
  public:
     ...
     * spaces. You can also include any of the following characters: =,.@-</p>
     */
    inline ResetServiceSpecificCredentialRequest& WithUserName(Aws::String&& value) { SetUserName(value); return *this;}
     ...
     * letter or digit.</p>
     */
    inline ResetServiceSpecificCredentialRequest& WithServiceSpecificCredentialId(Aws::String&& value) { SetServiceSpecificCredentialId(value); return *this;}
