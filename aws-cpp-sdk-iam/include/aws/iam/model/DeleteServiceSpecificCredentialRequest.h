...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteServiceSpecificCredentialRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteServiceSpecificCredentialRequest>(GetServiceRequestName(), *this);
    }
