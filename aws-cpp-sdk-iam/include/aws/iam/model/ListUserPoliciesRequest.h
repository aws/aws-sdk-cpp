...
namespace Model
{
  ...
  /**
   */
  class AWS_IAM_API ListUserPoliciesRequest : public IAMRequest
  {
  public:
    ...
    /**
     * <p>The name of the user to list policies for.</p> <p>The <a
     ...
     * subsequent call that tells the service where to continue from.</p>
     */
    inline ListUserPoliciesRequest& WithMaxItems(long value) { SetMaxItems(value); return *this;}
