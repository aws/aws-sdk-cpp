...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateOpenIDConnectProviderRequest> Clone() const
    {
      return Aws::MakeUnique<CreateOpenIDConnectProviderRequest>(GetServiceRequestName(), *this);
    }
