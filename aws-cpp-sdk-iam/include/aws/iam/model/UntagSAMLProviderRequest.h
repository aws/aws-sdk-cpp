...
namespace Model
{
  ...
  /**
   */
  class AWS_IAM_API UntagSAMLProviderRequest : public IAMRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UntagSAMLProviderRequest> Clone() const
    {
      return Aws::MakeUnique<UntagSAMLProviderRequest>(GetServiceRequestName(), *this);
    }
