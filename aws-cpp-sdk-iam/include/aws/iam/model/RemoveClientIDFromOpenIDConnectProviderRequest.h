...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<RemoveClientIDFromOpenIDConnectProviderRequest> Clone() const
    {
      return Aws::MakeUnique<RemoveClientIDFromOpenIDConnectProviderRequest>(GetServiceRequestName(), *this);
    }
