...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetServiceLinkedRoleDeletionStatusRequest> Clone() const
    {
      return Aws::MakeUnique<GetServiceLinkedRoleDeletionStatusRequest>(GetServiceRequestName(), *this);
    }
