...
namespace Model
{
  ...
  /**
   */
  class AWS_IAM_API DeleteRolePermissionsBoundaryRequest : public IAMRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteRolePermissionsBoundaryRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteRolePermissionsBoundaryRequest>(GetServiceRequestName(), *this);
    }
