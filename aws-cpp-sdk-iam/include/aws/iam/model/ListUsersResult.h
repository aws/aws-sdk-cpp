...
namespace Model
{
  ...
  public:
     ...
     * <p>A list of users.</p>
     */
    inline ListUsersResult& WithUsers(Aws::Vector<User>&& value) { SetUsers(value); return *this;}
    ...
    inline ListUsersResult& WithResponseMetadata(ResponseMetadata&& value) { SetResponseMetadata(value); return *this;}
