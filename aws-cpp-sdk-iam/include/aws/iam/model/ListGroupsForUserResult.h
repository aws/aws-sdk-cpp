...
namespace Model
{
  ...
  public:
     ...
     * <p>A list of groups.</p>
     */
    inline ListGroupsForUserResult& WithGroups(Aws::Vector<Group>&& value) { SetGroups(std::move(value)); return *this;}
     ...
     * <p>A list of groups.</p>
     */
    inline ListGroupsForUserResult& AddGroups(Group&& value) { m_groups.push_back(std::move(value)); return *this; }
     ...
     * subsequent pagination request.</p>
     */
    inline ListGroupsForUserResult& WithMarker(Aws::String&& value) { SetMarker(std::move(value)); return *this;}
    ...
    inline ListGroupsForUserResult& WithResponseMetadata(const ResponseMetadata& value) { SetResponseMetadata(value); return *this;}

    
    inline ListGroupsForUserResult& WithResponseMetadata(ResponseMetadata&& value) { SetResponseMetadata(std::move(value)); return *this;}
