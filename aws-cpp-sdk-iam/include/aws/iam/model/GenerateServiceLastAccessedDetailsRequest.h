...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GenerateServiceLastAccessedDetailsRequest> Clone() const
    {
      return Aws::MakeUnique<GenerateServiceLastAccessedDetailsRequest>(GetServiceRequestName(), *this);
    }
