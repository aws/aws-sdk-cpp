...
{
  /**
   * <p>Contains the response to a successful <a>ListGroups</a> request.
   * </p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/iam-2010-05-08/ListGroupsResponse">AWS
   * API Reference</a></p>
   */
  ...
  public:
    ListGroupsResult();
    ListGroupsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    ListGroupsResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
     ...
     * subsequent pagination request.</p>
     */
    inline ListGroupsResult& WithMarker(Aws::String&& value) { SetMarker(std::move(value)); return *this;}
    ...
    inline ListGroupsResult& WithResponseMetadata(ResponseMetadata&& value) { SetResponseMetadata(std::move(value)); return *this;}
