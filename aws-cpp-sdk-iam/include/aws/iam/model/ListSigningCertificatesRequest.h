...
namespace Model
{
  ...
  /**
   */
  class AWS_IAM_API ListSigningCertificatesRequest : public IAMRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListSigningCertificatesRequest> Clone() const
    {
      return Aws::MakeUnique<ListSigningCertificatesRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "ListSigningCertificates"; }
  ...
  public:
     ...
     * can also include any of the following characters: _+=,.@-</p>
     */
    inline ListSigningCertificatesRequest& WithUserName(Aws::String&& value) { SetUserName(std::move(value)); return *this;}
     ...
     * the next call should start.</p>
     */
    inline ListSigningCertificatesRequest& WithMarker(Aws::String&& value) { SetMarker(std::move(value)); return *this;}
