...
namespace Model
{
  ...
  /**
   */
  class AWS_IAM_API ListInstanceProfilesForRoleRequest : public IAMRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListInstanceProfilesForRoleRequest> Clone() const
    {
      return Aws::MakeUnique<ListInstanceProfilesForRoleRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "ListInstanceProfilesForRole"; }
  ...
  public:
     ...
     * subsequent call that tells the service where to continue from.</p>
     */
    inline ListInstanceProfilesForRoleRequest& WithMaxItems(int value) { SetMaxItems(value); return *this;}
