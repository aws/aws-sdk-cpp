...
namespace Model
{
  ...
  /**
   */
  class AWS_IAM_API ListOpenIDConnectProviderTagsRequest : public IAMRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListOpenIDConnectProviderTagsRequest> Clone() const
    {
      return Aws::MakeUnique<ListOpenIDConnectProviderTagsRequest>(GetServiceRequestName(), *this);
    }
