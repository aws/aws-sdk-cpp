...
namespace Model
{
  ...
  /**
   */
  class AWS_IAM_API TagOpenIDConnectProviderRequest : public IAMRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<TagOpenIDConnectProviderRequest> Clone() const
    {
      return Aws::MakeUnique<TagOpenIDConnectProviderRequest>(GetServiceRequestName(), *this);
    }
