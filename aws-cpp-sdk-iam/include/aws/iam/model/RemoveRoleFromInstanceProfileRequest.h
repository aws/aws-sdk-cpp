...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<RemoveRoleFromInstanceProfileRequest> Clone() const
    {
      return Aws::MakeUnique<RemoveRoleFromInstanceProfileRequest>(GetServiceRequestName(), *this);
    }
