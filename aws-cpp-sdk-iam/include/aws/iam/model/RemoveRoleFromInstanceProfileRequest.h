...
namespace Model
{
  ...
  public:
    ...
    inline virtual const char* GetServiceRequestName() override { return "RemoveRoleFromInstanceProfile"; }
  ...
  public:
    ...
    /**
     * <p>The name of the role to remove.</p> <p>This parameter allows (per its <a
