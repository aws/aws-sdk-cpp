...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteOpenIDConnectProviderRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteOpenIDConnectProviderRequest>(GetServiceRequestName(), *this);
    }
