...
namespace Model
{
  ...
  /**
   */
  class AWS_IAM_API GetOrganizationsAccessReportRequest : public IAMRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetOrganizationsAccessReportRequest> Clone() const
    {
      return Aws::MakeUnique<GetOrganizationsAccessReportRequest>(GetServiceRequestName(), *this);
    }
