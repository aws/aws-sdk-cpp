...
namespace IAM
{
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        IAMClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                  std::shared_ptr<Endpoint::IAMEndpointProvider> endpointProvider = Aws::MakeShared<IAM::Endpoint::IAMEndpointProvider>(ALLOCATION_TAG));
  ...
  private:
        ...
        std::shared_ptr<Endpoint::IAMEndpointProvider> m_endpointProvider;
  };
