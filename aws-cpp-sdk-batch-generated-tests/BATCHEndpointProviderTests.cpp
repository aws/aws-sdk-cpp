...
using BatchResolveEndpointOutcome = Aws::Batch::Endpoint::BatchEndpointProvider::BatchResolveEndpointOutcome;
...
void ValidateOutcome(const BatchResolveEndpointOutcome& outcome, const BatchEndpointProviderEndpointTestCase::Expect& expect)
{
