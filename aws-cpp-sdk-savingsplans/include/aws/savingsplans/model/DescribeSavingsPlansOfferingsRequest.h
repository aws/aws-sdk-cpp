...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeSavingsPlansOfferingsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeSavingsPlansOfferingsRequest>(GetServiceRequestName(), *this);
    }
