...
namespace Model
{
  ...
  /**
   */
  class AWS_SAVINGSPLANS_API DeleteQueuedSavingsPlanRequest : public SavingsPlansRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteQueuedSavingsPlanRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteQueuedSavingsPlanRequest>(GetServiceRequestName(), *this);
    }
