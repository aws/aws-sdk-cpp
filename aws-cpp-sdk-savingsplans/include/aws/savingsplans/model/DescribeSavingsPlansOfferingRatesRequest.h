...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeSavingsPlansOfferingRatesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeSavingsPlansOfferingRatesRequest>(GetServiceRequestName(), *this);
    }
