...
namespace SavingsPlans
{
  ...
  class AWS_SAVINGSPLANS_API SavingsPlansClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        SavingsPlansClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                           std::shared_ptr<Endpoint::SavingsPlansEndpointProvider> endpointProvider = Aws::MakeShared<SavingsPlans::Endpoint::SavingsPlansEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::SavingsPlansEndpointProvider> m_endpointProvider;
  };
