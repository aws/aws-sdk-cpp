...
namespace Model
{
  ...
  /**
   */
  class AWS_FORECASTSERVICE_API DeletePredictorBacktestExportJobRequest : public ForecastServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeletePredictorBacktestExportJobRequest> Clone() const
    {
      return Aws::MakeUnique<DeletePredictorBacktestExportJobRequest>(GetServiceRequestName(), *this);
    }
