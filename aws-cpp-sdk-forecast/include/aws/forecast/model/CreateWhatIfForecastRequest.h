...
namespace Model
{
  ...
  /**
   */
  class AWS_FORECASTSERVICE_API CreateWhatIfForecastRequest : public ForecastServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateWhatIfForecastRequest> Clone() const
    {
      return Aws::MakeUnique<CreateWhatIfForecastRequest>(GetServiceRequestName(), *this);
    }
