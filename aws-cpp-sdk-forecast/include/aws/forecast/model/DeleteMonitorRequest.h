...
namespace Model
{
  ...
  /**
   */
  class AWS_FORECASTSERVICE_API DeleteMonitorRequest : public ForecastServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteMonitorRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteMonitorRequest>(GetServiceRequestName(), *this);
    }
