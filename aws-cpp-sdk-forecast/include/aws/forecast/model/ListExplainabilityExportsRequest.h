...
namespace Model
{
  ...
  /**
   */
  class AWS_FORECASTSERVICE_API ListExplainabilityExportsRequest : public ForecastServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListExplainabilityExportsRequest> Clone() const
    {
      return Aws::MakeUnique<ListExplainabilityExportsRequest>(GetServiceRequestName(), *this);
    }
