...
namespace Model
{
  ...
  /**
   */
  class AWS_FORECASTSERVICE_API ListWhatIfForecastExportsRequest : public ForecastServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListWhatIfForecastExportsRequest> Clone() const
    {
      return Aws::MakeUnique<ListWhatIfForecastExportsRequest>(GetServiceRequestName(), *this);
    }
