...
namespace Model
{
  ...
  /**
   */
  class AWS_FORECASTSERVICE_API CreateMonitorRequest : public ForecastServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateMonitorRequest> Clone() const
    {
      return Aws::MakeUnique<CreateMonitorRequest>(GetServiceRequestName(), *this);
    }
