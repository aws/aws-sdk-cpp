...
namespace Model
{
  ...
  /**
   */
  class AWS_FORECASTSERVICE_API ListPredictorBacktestExportJobsRequest : public ForecastServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListPredictorBacktestExportJobsRequest> Clone() const
    {
      return Aws::MakeUnique<ListPredictorBacktestExportJobsRequest>(GetServiceRequestName(), *this);
    }
