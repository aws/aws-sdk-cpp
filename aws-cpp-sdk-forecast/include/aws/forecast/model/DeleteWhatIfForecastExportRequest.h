...
namespace Model
{
  ...
  /**
   */
  class AWS_FORECASTSERVICE_API DeleteWhatIfForecastExportRequest : public ForecastServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteWhatIfForecastExportRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteWhatIfForecastExportRequest>(GetServiceRequestName(), *this);
    }
