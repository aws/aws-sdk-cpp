...
namespace Model
{
  ...
  /**
   */
  class AWS_FORECASTSERVICE_API DescribeWhatIfForecastExportRequest : public ForecastServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeWhatIfForecastExportRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeWhatIfForecastExportRequest>(GetServiceRequestName(), *this);
    }
