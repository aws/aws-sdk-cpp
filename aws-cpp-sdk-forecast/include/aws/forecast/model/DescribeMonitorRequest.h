...
namespace Model
{
  ...
  /**
   */
  class AWS_FORECASTSERVICE_API DescribeMonitorRequest : public ForecastServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeMonitorRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeMonitorRequest>(GetServiceRequestName(), *this);
    }
