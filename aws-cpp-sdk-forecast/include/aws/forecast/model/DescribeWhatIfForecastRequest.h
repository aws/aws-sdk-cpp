...
namespace Model
{
  ...
  /**
   */
  class AWS_FORECASTSERVICE_API DescribeWhatIfForecastRequest : public ForecastServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeWhatIfForecastRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeWhatIfForecastRequest>(GetServiceRequestName(), *this);
    }
