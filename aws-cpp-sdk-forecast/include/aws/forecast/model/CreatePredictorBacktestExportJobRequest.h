...
namespace Model
{
  ...
  /**
   */
  class AWS_FORECASTSERVICE_API CreatePredictorBacktestExportJobRequest : public ForecastServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreatePredictorBacktestExportJobRequest> Clone() const
    {
      return Aws::MakeUnique<CreatePredictorBacktestExportJobRequest>(GetServiceRequestName(), *this);
    }
