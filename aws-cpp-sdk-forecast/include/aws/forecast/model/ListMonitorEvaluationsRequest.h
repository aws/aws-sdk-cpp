...
namespace Model
{
  ...
  /**
   */
  class AWS_FORECASTSERVICE_API ListMonitorEvaluationsRequest : public ForecastServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListMonitorEvaluationsRequest> Clone() const
    {
      return Aws::MakeUnique<ListMonitorEvaluationsRequest>(GetServiceRequestName(), *this);
    }
