...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>The name for the dataset import job. It is recommended to include the current
     * timestamp in the name to guard against getting a
     * <code>ResourceAlreadyExistsException</code> exception, for example,
     * <code>20190721DatasetImport</code>.</p>
     */
