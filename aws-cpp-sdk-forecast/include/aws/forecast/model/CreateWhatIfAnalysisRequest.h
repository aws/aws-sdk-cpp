...
namespace Model
{
  ...
  /**
   */
  class AWS_FORECASTSERVICE_API CreateWhatIfAnalysisRequest : public ForecastServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateWhatIfAnalysisRequest> Clone() const
    {
      return Aws::MakeUnique<CreateWhatIfAnalysisRequest>(GetServiceRequestName(), *this);
    }
