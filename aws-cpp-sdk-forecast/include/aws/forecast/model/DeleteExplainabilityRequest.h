...
namespace Model
{
  ...
  /**
   */
  class AWS_FORECASTSERVICE_API DeleteExplainabilityRequest : public ForecastServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteExplainabilityRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteExplainabilityRequest>(GetServiceRequestName(), *this);
    }
