...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeExplainabilityExportRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeExplainabilityExportRequest>(GetServiceRequestName(), *this);
    }
