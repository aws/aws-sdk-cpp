...
namespace Model
{
  ...
  /**
   */
  class AWS_FORECASTSERVICE_API DeleteWhatIfAnalysisRequest : public ForecastServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteWhatIfAnalysisRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteWhatIfAnalysisRequest>(GetServiceRequestName(), *this);
    }
