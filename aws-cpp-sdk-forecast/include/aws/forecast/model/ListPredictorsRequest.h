...
namespace Model
{
  ...
  public:
     ...
     * predictors that match the statement. The match statement consists of a key and a
     * value. In this release, <code>Name</code> is the only valid key, which filters
     * on the <code>PredictorName</code> property.</p> <ul> <li> <p>
     * <code>Condition</code> - <code>IS</code> or <code>IS_NOT</code> </p> </li> <li>
     * <p> <code>Key</code> - <code>Name</code> </p> </li> <li> <p> <code>Value</code>
     * - the value to match</p> </li> </ul> <p>For example, to list all predictors
     * named <i>my_predictor</i>, you would specify:</p> <p> <code>"Filters": [ {
     * "Condition": "IS", "Key": "Name", "Value": "my_predictor" } ]</code> </p>
     */
