...
namespace Model
{
  ...
  /**
   */
  class AWS_FORECASTSERVICE_API CreateExplainabilityExportRequest : public ForecastServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateExplainabilityExportRequest> Clone() const
    {
      return Aws::MakeUnique<CreateExplainabilityExportRequest>(GetServiceRequestName(), *this);
    }
