...
namespace Model
{
  ...
  /**
   */
  class AWS_FORECASTSERVICE_API ListWhatIfAnalysesRequest : public ForecastServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListWhatIfAnalysesRequest> Clone() const
    {
      return Aws::MakeUnique<ListWhatIfAnalysesRequest>(GetServiceRequestName(), *this);
    }
     ...
     * the next request. Tokens expire after 24 hours.</p>
     */
    inline ListWhatIfAnalysesRequest& WithNextToken(const Aws::String& value) { SetNextToken(value); return *this;}
     ...
     * the next request. Tokens expire after 24 hours.</p>
     */
    inline ListWhatIfAnalysesRequest& WithNextToken(Aws::String&& value) { SetNextToken(std::move(value)); return *this;}
     ...
     * the next request. Tokens expire after 24 hours.</p>
     */
    inline ListWhatIfAnalysesRequest& WithNextToken(const char* value) { SetNextToken(value); return *this;}
     ...
     * ]</code> </p>
     */
    inline ListWhatIfAnalysesRequest& WithFilters(const Aws::Vector<Filter>& value) { SetFilters(value); return *this;}
     ...
     * ]</code> </p>
     */
    inline ListWhatIfAnalysesRequest& WithFilters(Aws::Vector<Filter>&& value) { SetFilters(std::move(value)); return *this;}
     ...
     * ]</code> </p>
     */
    inline ListWhatIfAnalysesRequest& AddFilters(const Filter& value) { m_filtersHasBeenSet = true; m_filters.push_back(value); return *this; }
     ...
     * ]</code> </p>
     */
    inline ListWhatIfAnalysesRequest& AddFilters(Filter&& value) { m_filtersHasBeenSet = true; m_filters.push_back(std::move(value)); return *this; }
