...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_FORECASTSERVICE_API WhatIfForecastSummary
  {
  public:
    WhatIfForecastSummary();
    WhatIfForecastSummary(Aws::Utils::Json::JsonView jsonValue);
    WhatIfForecastSummary& operator=(Aws::Utils::Json::JsonView jsonValue);
