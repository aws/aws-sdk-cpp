...
namespace Model
{
  ...
  /**
   */
  class AWS_FORECASTSERVICE_API DescribePredictorBacktestExportJobRequest : public ForecastServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribePredictorBacktestExportJobRequest> Clone() const
    {
      return Aws::MakeUnique<DescribePredictorBacktestExportJobRequest>(GetServiceRequestName(), *this);
    }
