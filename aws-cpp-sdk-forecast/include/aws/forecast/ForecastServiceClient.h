...
namespace ForecastService
{
  ...
  class AWS_FORECASTSERVICE_API ForecastServiceClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        ForecastServiceClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                              std::shared_ptr<Endpoint::ForecastServiceEndpointProvider> endpointProvider = Aws::MakeShared<ForecastService::Endpoint::ForecastServiceEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::ForecastServiceEndpointProvider> m_endpointProvider;
  };
