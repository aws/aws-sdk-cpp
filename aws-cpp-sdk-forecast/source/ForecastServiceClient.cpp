...
using ResolveEndpointOutcome = Aws::ForecastService::Endpoint::ForecastServiceEndpointProvider::ForecastServiceResolveEndpointOutcome;
...
ForecastServiceClient::ForecastServiceClient(const Client::ClientConfiguration& clientConfiguration,
                                             std::shared_ptr<Endpoint::ForecastServiceEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<ForecastServiceErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<ForecastService::Endpoint::ForecastServiceEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
