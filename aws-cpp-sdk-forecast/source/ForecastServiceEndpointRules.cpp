...
Aws::String ForecastServiceEndpointRules::GetRulesAsString()
{
    return Aws::String(ForecastServiceEndpointRules::Rules.begin(), ForecastServiceEndpointRules::Rules.end());
}

const Aws::Vector<char> ForecastServiceEndpointRules::Rules = {
...
'o','r','e','c','a','s','t','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i',
...
'l','"',':','"','h','t','t','p','s',':','/','/','f','o','r','e','c','a','s','t','.','{','R','e','g',
