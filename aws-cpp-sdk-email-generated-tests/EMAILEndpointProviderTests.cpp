...
using SESResolveEndpointOutcome = Aws::SES::Endpoint::SESEndpointProvider::SESResolveEndpointOutcome;
...
void ValidateOutcome(const SESResolveEndpointOutcome& outcome, const SESEndpointProviderEndpointTestCase::Expect& expect)
{
