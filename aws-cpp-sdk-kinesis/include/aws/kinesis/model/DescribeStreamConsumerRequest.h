...
namespace Model
{
  ...
  /**
   */
  class AWS_KINESIS_API DescribeStreamConsumerRequest : public KinesisRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeStreamConsumerRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeStreamConsumerRequest>(GetServiceRequestName(), *this);
    }
