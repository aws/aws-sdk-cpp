...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<IncreaseStreamRetentionPeriodRequest> Clone() const
    {
      return Aws::MakeUnique<IncreaseStreamRetentionPeriodRequest>(GetServiceRequestName(), *this);
    }
