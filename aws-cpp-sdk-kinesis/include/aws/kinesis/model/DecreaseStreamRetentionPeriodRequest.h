...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DecreaseStreamRetentionPeriodRequest> Clone() const
    {
      return Aws::MakeUnique<DecreaseStreamRetentionPeriodRequest>(GetServiceRequestName(), *this);
    }
