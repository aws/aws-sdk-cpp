...
namespace Model
{
  ...
  typedef Aws::Utils::Event<KinesisClient, const Model::AddTagsToStreamRequest&, const Model::AddTagsToStreamOutcome&, const Aws::Client::AsyncCallerContext*> AddTagsToStreamOutcomeReceivedEvent;
  typedef Aws::Utils::Event<KinesisClient, const Model::CreateStreamRequest&, const Model::CreateStreamOutcome&, const Aws::Client::AsyncCallerContext*> CreateStreamOutcomeReceivedEvent;
  typedef Aws::Utils::Event<KinesisClient, const Model::DeleteStreamRequest&, const Model::DeleteStreamOutcome&, const Aws::Client::AsyncCallerContext*> DeleteStreamOutcomeReceivedEvent;
  typedef Aws::Utils::Event<KinesisClient, const Model::DescribeStreamRequest&, const Model::DescribeStreamOutcome&, const Aws::Client::AsyncCallerContext*> DescribeStreamOutcomeReceivedEvent;
  typedef Aws::Utils::Event<KinesisClient, const Model::GetRecordsRequest&, const Model::GetRecordsOutcome&, const Aws::Client::AsyncCallerContext*> GetRecordsOutcomeReceivedEvent;
  typedef Aws::Utils::Event<KinesisClient, const Model::GetShardIteratorRequest&, const Model::GetShardIteratorOutcome&, const Aws::Client::AsyncCallerContext*> GetShardIteratorOutcomeReceivedEvent;
  typedef Aws::Utils::Event<KinesisClient, const Model::ListStreamsRequest&, const Model::ListStreamsOutcome&, const Aws::Client::AsyncCallerContext*> ListStreamsOutcomeReceivedEvent;
  typedef Aws::Utils::Event<KinesisClient, const Model::ListTagsForStreamRequest&, const Model::ListTagsForStreamOutcome&, const Aws::Client::AsyncCallerContext*> ListTagsForStreamOutcomeReceivedEvent;
  typedef Aws::Utils::Event<KinesisClient, const Model::MergeShardsRequest&, const Model::MergeShardsOutcome&, const Aws::Client::AsyncCallerContext*> MergeShardsOutcomeReceivedEvent;
  typedef Aws::Utils::Event<KinesisClient, const Model::PutRecordRequest&, const Model::PutRecordOutcome&, const Aws::Client::AsyncCallerContext*> PutRecordOutcomeReceivedEvent;
  typedef Aws::Utils::Event<KinesisClient, const Model::PutRecordsRequest&, const Model::PutRecordsOutcome&, const Aws::Client::AsyncCallerContext*> PutRecordsOutcomeReceivedEvent;
  typedef Aws::Utils::Event<KinesisClient, const Model::RemoveTagsFromStreamRequest&, const Model::RemoveTagsFromStreamOutcome&, const Aws::Client::AsyncCallerContext*> RemoveTagsFromStreamOutcomeReceivedEvent;
  typedef Aws::Utils::Event<KinesisClient, const Model::SplitShardRequest&, const Model::SplitShardOutcome&, const Aws::Client::AsyncCallerContext*> SplitShardOutcomeReceivedEvent;
  ...
  */
  class AWS_KINESIS_API KinesisClient : public Aws::Client::AWSJsonClient
  {
     ...
     */
     Model::AddTagsToStreamOutcome AddTagsToStream(const Model::AddTagsToStreamRequest& request) const;
     ...
     */
     Model::AddTagsToStreamOutcomeCallable AddTagsToStreamCallable(const Model::AddTagsToStreamRequest& request) const;
     ...
     */
     void AddTagsToStreamAsync(const Model::AddTagsToStreamRequest& request, const Aws::Client::AsyncCallerContext* context = nullptr) const;
     ...
     */
     Model::CreateStreamOutcome CreateStream(const Model::CreateStreamRequest& request) const;
     ...
     /*
       ...
       returns a future to the operation so that it can be executed in parallel to other requests.
     */
     Model::CreateStreamOutcomeCallable CreateStreamCallable(const Model::CreateStreamRequest& request) const;
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void CreateStreamAsync(const Model::CreateStreamRequest& request, const Aws::Client::AsyncCallerContext* context = nullptr) const;
     ...
     */
     ...
     /*
       ...
       returns a future to the operation so that it can be executed in parallel to other requests.
     */
     Model::DeleteStreamOutcomeCallable DeleteStreamCallable(const Model::DeleteStreamRequest& request) const;
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void DeleteStreamAsync(const Model::DeleteStreamRequest& request, const Aws::Client::AsyncCallerContext* context = nullptr) const;
     ...
     */
     Model::DescribeStreamOutcome DescribeStream(const Model::DescribeStreamRequest& request) const;
     ...
     /*
       ...
       returns a future to the operation so that it can be executed in parallel to other requests.
     */
     Model::DescribeStreamOutcomeCallable DescribeStreamCallable(const Model::DescribeStreamRequest& request) const;
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void DescribeStreamAsync(const Model::DescribeStreamRequest& request, const Aws::Client::AsyncCallerContext* context = nullptr) const;
     ...
     */
     Model::GetRecordsOutcome GetRecords(const Model::GetRecordsRequest& request) const;
     ...
     /*
       ...
       returns a future to the operation so that it can be executed in parallel to other requests.
     */
     Model::GetRecordsOutcomeCallable GetRecordsCallable(const Model::GetRecordsRequest& request) const;
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void GetRecordsAsync(const Model::GetRecordsRequest& request, const Aws::Client::AsyncCallerContext* context = nullptr) const;
     ...
     */
     Model::GetShardIteratorOutcome GetShardIterator(const Model::GetShardIteratorRequest& request) const;
     ...
     /*
       ...
       returns a future to the operation so that it can be executed in parallel to other requests.
     */
     Model::GetShardIteratorOutcomeCallable GetShardIteratorCallable(const Model::GetShardIteratorRequest& request) const;
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void GetShardIteratorAsync(const Model::GetShardIteratorRequest& request, const Aws::Client::AsyncCallerContext* context = nullptr) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void ListStreamsAsync(const Model::ListStreamsRequest& request, const Aws::Client::AsyncCallerContext* context = nullptr) const;

     /*
       <p>Lists the tags for the specified Amazon Kinesis stream.</p>
     */
     Model::ListTagsForStreamOutcome ListTagsForStream(const Model::ListTagsForStreamRequest& request) const;
     ...
     /*
       ...
       returns a future to the operation so that it can be executed in parallel to other requests.
     */
     Model::ListTagsForStreamOutcomeCallable ListTagsForStreamCallable(const Model::ListTagsForStreamRequest& request) const;
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void ListTagsForStreamAsync(const Model::ListTagsForStreamRequest& request, const Aws::Client::AsyncCallerContext* context = nullptr) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void MergeShardsAsync(const Model::MergeShardsRequest& request, const Aws::Client::AsyncCallerContext* context = nullptr) const;
     ...
     */
     Model::PutRecordOutcome PutRecord(const Model::PutRecordRequest& request) const;
     ...
     /*
       ...
       returns a future to the operation so that it can be executed in parallel to other requests.
     */
     Model::PutRecordOutcomeCallable PutRecordCallable(const Model::PutRecordRequest& request) const;
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void PutRecordAsync(const Model::PutRecordRequest& request, const Aws::Client::AsyncCallerContext* context = nullptr) const;
     ...
     */
     ...
     /*
       ...
       returns a future to the operation so that it can be executed in parallel to other requests.
     */
     Model::PutRecordsOutcomeCallable PutRecordsCallable(const Model::PutRecordsRequest& request) const;
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void PutRecordsAsync(const Model::PutRecordsRequest& request, const Aws::Client::AsyncCallerContext* context = nullptr) const;

     /*
       <p>Deletes tags from the specified Amazon Kinesis stream.</p> <p>If you specify a tag that does not exist, it is ignored.</p>
     */
     Model::RemoveTagsFromStreamOutcome RemoveTagsFromStream(const Model::RemoveTagsFromStreamRequest& request) const;
     ...
     /*
       ...
       returns a future to the operation so that it can be executed in parallel to other requests.
     */
     Model::RemoveTagsFromStreamOutcomeCallable RemoveTagsFromStreamCallable(const Model::RemoveTagsFromStreamRequest& request) const;
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void RemoveTagsFromStreamAsync(const Model::RemoveTagsFromStreamRequest& request, const Aws::Client::AsyncCallerContext* context = nullptr) const;
     ...
     */
     Model::SplitShardOutcome SplitShard(const Model::SplitShardRequest& request) const;
     ...
     /*
       ...
       returns a future to the operation so that it can be executed in parallel to other requests.
     */
     Model::SplitShardOutcomeCallable SplitShardCallable(const Model::SplitShardRequest& request) const;
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void SplitShardAsync(const Model::SplitShardRequest& request, const Aws::Client::AsyncCallerContext* context = nullptr) const;

   /**
    * Adds an event handler for AddTagsToStreamAsync to call upon completion to the handler chain. You need to call this to
    * use AddTagsToStreamAsync.
    */
    inline void RegisterAddTagsToStreamOutcomeReceivedHandler(const AddTagsToStreamOutcomeReceivedEvent::EventHandler& handler)
    {
      m_onAddTagsToStreamOutcomeReceived += handler;
    }

    /**
    * Clears all event handlers for AddTagsToStream.
    */
    inline void ClearAllAddTagsToStreamOutcomeReceivedHandlers()
    {
      m_onAddTagsToStreamOutcomeReceived.Clear();
    }

   /**
    * Adds an event handler for CreateStreamAsync to call upon completion to the handler chain. You need to call this to
    * use CreateStreamAsync.
    */
    inline void RegisterCreateStreamOutcomeReceivedHandler(const CreateStreamOutcomeReceivedEvent::EventHandler& handler)
    {
      m_onCreateStreamOutcomeReceived += handler;
    }

    /**
    * Clears all event handlers for CreateStream.
    */
    inline void ClearAllCreateStreamOutcomeReceivedHandlers()
    {
      m_onCreateStreamOutcomeReceived.Clear();
    }

   /**
    * Adds an event handler for DeleteStreamAsync to call upon completion to the handler chain. You need to call this to
    * use DeleteStreamAsync.
    */
    inline void RegisterDeleteStreamOutcomeReceivedHandler(const DeleteStreamOutcomeReceivedEvent::EventHandler& handler)
    {
      m_onDeleteStreamOutcomeReceived += handler;
    }

    /**
    * Clears all event handlers for DeleteStream.
    */
    inline void ClearAllDeleteStreamOutcomeReceivedHandlers()
    {
      m_onDeleteStreamOutcomeReceived.Clear();
    }

   /**
    * Adds an event handler for DescribeStreamAsync to call upon completion to the handler chain. You need to call this to
    * use DescribeStreamAsync.
    */
    inline void RegisterDescribeStreamOutcomeReceivedHandler(const DescribeStreamOutcomeReceivedEvent::EventHandler& handler)
    {
      m_onDescribeStreamOutcomeReceived += handler;
    }

    /**
    * Clears all event handlers for DescribeStream.
    */
    inline void ClearAllDescribeStreamOutcomeReceivedHandlers()
    {
      m_onDescribeStreamOutcomeReceived.Clear();
    }

   /**
    * Adds an event handler for GetRecordsAsync to call upon completion to the handler chain. You need to call this to
    * use GetRecordsAsync.
    */
    inline void RegisterGetRecordsOutcomeReceivedHandler(const GetRecordsOutcomeReceivedEvent::EventHandler& handler)
    {
      m_onGetRecordsOutcomeReceived += handler;
    }

    /**
    * Clears all event handlers for GetRecords.
    */
    inline void ClearAllGetRecordsOutcomeReceivedHandlers()
    {
      m_onGetRecordsOutcomeReceived.Clear();
    }

   /**
    * Adds an event handler for GetShardIteratorAsync to call upon completion to the handler chain. You need to call this to
    * use GetShardIteratorAsync.
    */
    inline void RegisterGetShardIteratorOutcomeReceivedHandler(const GetShardIteratorOutcomeReceivedEvent::EventHandler& handler)
    {
      m_onGetShardIteratorOutcomeReceived += handler;
    }

    /**
    * Clears all event handlers for GetShardIterator.
    */
    inline void ClearAllGetShardIteratorOutcomeReceivedHandlers()
    {
      m_onGetShardIteratorOutcomeReceived.Clear();
    }

   /**
    * Adds an event handler for ListStreamsAsync to call upon completion to the handler chain. You need to call this to
    * use ListStreamsAsync.
    */
    inline void RegisterListStreamsOutcomeReceivedHandler(const ListStreamsOutcomeReceivedEvent::EventHandler& handler)
    {
      m_onListStreamsOutcomeReceived += handler;
    }

    /**
    * Clears all event handlers for ListStreams.
    */
    inline void ClearAllListStreamsOutcomeReceivedHandlers()
    {
      m_onListStreamsOutcomeReceived.Clear();
    }

   /**
    * Adds an event handler for ListTagsForStreamAsync to call upon completion to the handler chain. You need to call this to
    * use ListTagsForStreamAsync.
    */
    inline void RegisterListTagsForStreamOutcomeReceivedHandler(const ListTagsForStreamOutcomeReceivedEvent::EventHandler& handler)
    {
      m_onListTagsForStreamOutcomeReceived += handler;
    }

    /**
    * Clears all event handlers for ListTagsForStream.
    */
    inline void ClearAllListTagsForStreamOutcomeReceivedHandlers()
    {
      m_onListTagsForStreamOutcomeReceived.Clear();
    }

   /**
    * Adds an event handler for MergeShardsAsync to call upon completion to the handler chain. You need to call this to
    * use MergeShardsAsync.
    */
    inline void RegisterMergeShardsOutcomeReceivedHandler(const MergeShardsOutcomeReceivedEvent::EventHandler& handler)
    {
      m_onMergeShardsOutcomeReceived += handler;
    }

    /**
    * Clears all event handlers for MergeShards.
    */
    inline void ClearAllMergeShardsOutcomeReceivedHandlers()
    {
      m_onMergeShardsOutcomeReceived.Clear();
    }

   /**
    * Adds an event handler for PutRecordAsync to call upon completion to the handler chain. You need to call this to
    * use PutRecordAsync.
    */
    inline void RegisterPutRecordOutcomeReceivedHandler(const PutRecordOutcomeReceivedEvent::EventHandler& handler)
    {
      m_onPutRecordOutcomeReceived += handler;
    }

    /**
    * Clears all event handlers for PutRecord.
    */
    inline void ClearAllPutRecordOutcomeReceivedHandlers()
    {
      m_onPutRecordOutcomeReceived.Clear();
    }

   /**
    * Adds an event handler for PutRecordsAsync to call upon completion to the handler chain. You need to call this to
    * use PutRecordsAsync.
    */
    inline void RegisterPutRecordsOutcomeReceivedHandler(const PutRecordsOutcomeReceivedEvent::EventHandler& handler)
    {
      m_onPutRecordsOutcomeReceived += handler;
    }

    /**
    * Clears all event handlers for PutRecords.
    */
    inline void ClearAllPutRecordsOutcomeReceivedHandlers()
    {
      m_onPutRecordsOutcomeReceived.Clear();
    }

   /**
    * Adds an event handler for RemoveTagsFromStreamAsync to call upon completion to the handler chain. You need to call this to
    * use RemoveTagsFromStreamAsync.
    */
    inline void RegisterRemoveTagsFromStreamOutcomeReceivedHandler(const RemoveTagsFromStreamOutcomeReceivedEvent::EventHandler& handler)
    {
      m_onRemoveTagsFromStreamOutcomeReceived += handler;
    }

    /**
    * Clears all event handlers for RemoveTagsFromStream.
    */
    inline void ClearAllRemoveTagsFromStreamOutcomeReceivedHandlers()
    {
      m_onRemoveTagsFromStreamOutcomeReceived.Clear();
    }

   /**
    * Adds an event handler for SplitShardAsync to call upon completion to the handler chain. You need to call this to
    * use SplitShardAsync.
    */
    inline void RegisterSplitShardOutcomeReceivedHandler(const SplitShardOutcomeReceivedEvent::EventHandler& handler)
    {
      m_onSplitShardOutcomeReceived += handler;
    }

    /**
    * Clears all event handlers for SplitShard.
    */
    inline void ClearAllSplitShardOutcomeReceivedHandlers()
    {
      m_onSplitShardOutcomeReceived.Clear();
    }
  ...
  private:
    ...
    /**Async helpers**/
    void AddTagsToStreamAsyncHelper(const Model::AddTagsToStreamRequest& request, const Aws::Client::AsyncCallerContext* context) const;
    void CreateStreamAsyncHelper(const Model::CreateStreamRequest& request, const Aws::Client::AsyncCallerContext* context) const;
    void DeleteStreamAsyncHelper(const Model::DeleteStreamRequest& request, const Aws::Client::AsyncCallerContext* context) const;
    void DescribeStreamAsyncHelper(const Model::DescribeStreamRequest& request, const Aws::Client::AsyncCallerContext* context) const;
    void GetRecordsAsyncHelper(const Model::GetRecordsRequest& request, const Aws::Client::AsyncCallerContext* context) const;
    void GetShardIteratorAsyncHelper(const Model::GetShardIteratorRequest& request, const Aws::Client::AsyncCallerContext* context) const;
    void ListStreamsAsyncHelper(const Model::ListStreamsRequest& request, const Aws::Client::AsyncCallerContext* context) const;
    void ListTagsForStreamAsyncHelper(const Model::ListTagsForStreamRequest& request, const Aws::Client::AsyncCallerContext* context) const;
    void MergeShardsAsyncHelper(const Model::MergeShardsRequest& request, const Aws::Client::AsyncCallerContext* context) const;
    void PutRecordAsyncHelper(const Model::PutRecordRequest& request, const Aws::Client::AsyncCallerContext* context) const;
    void PutRecordsAsyncHelper(const Model::PutRecordsRequest& request, const Aws::Client::AsyncCallerContext* context) const;
    void RemoveTagsFromStreamAsyncHelper(const Model::RemoveTagsFromStreamRequest& request, const Aws::Client::AsyncCallerContext* context) const;
    void SplitShardAsyncHelper(const Model::SplitShardRequest& request, const Aws::Client::AsyncCallerContext* context) const;

    Aws::String m_uri;
    std::shared_ptr<Utils::Threading::Executor> m_executor;

    /** events **/
    AddTagsToStreamOutcomeReceivedEvent m_onAddTagsToStreamOutcomeReceived;
    CreateStreamOutcomeReceivedEvent m_onCreateStreamOutcomeReceived;
    DeleteStreamOutcomeReceivedEvent m_onDeleteStreamOutcomeReceived;
    DescribeStreamOutcomeReceivedEvent m_onDescribeStreamOutcomeReceived;
    GetRecordsOutcomeReceivedEvent m_onGetRecordsOutcomeReceived;
    GetShardIteratorOutcomeReceivedEvent m_onGetShardIteratorOutcomeReceived;
    ListStreamsOutcomeReceivedEvent m_onListStreamsOutcomeReceived;
    ListTagsForStreamOutcomeReceivedEvent m_onListTagsForStreamOutcomeReceived;
    MergeShardsOutcomeReceivedEvent m_onMergeShardsOutcomeReceived;
    PutRecordOutcomeReceivedEvent m_onPutRecordOutcomeReceived;
    PutRecordsOutcomeReceivedEvent m_onPutRecordsOutcomeReceived;
    RemoveTagsFromStreamOutcomeReceivedEvent m_onRemoveTagsFromStreamOutcomeReceived;
    SplitShardOutcomeReceivedEvent m_onSplitShardOutcomeReceived;
  };
