...
namespace Model
{
  ...
  typedef Aws::Utils::Event<KinesisClient, const Model::AddTagsToStreamRequest&, const Model::AddTagsToStreamOutcome&> AddTagsToStreamOutcomeReceivedEvent;
  typedef Aws::Utils::Event<KinesisClient, const Model::CreateStreamRequest&, const Model::CreateStreamOutcome&> CreateStreamOutcomeReceivedEvent;
  typedef Aws::Utils::Event<KinesisClient, const Model::DeleteStreamRequest&, const Model::DeleteStreamOutcome&> DeleteStreamOutcomeReceivedEvent;
  typedef Aws::Utils::Event<KinesisClient, const Model::DescribeStreamRequest&, const Model::DescribeStreamOutcome&> DescribeStreamOutcomeReceivedEvent;
  typedef Aws::Utils::Event<KinesisClient, const Model::GetRecordsRequest&, const Model::GetRecordsOutcome&> GetRecordsOutcomeReceivedEvent;
  typedef Aws::Utils::Event<KinesisClient, const Model::GetShardIteratorRequest&, const Model::GetShardIteratorOutcome&> GetShardIteratorOutcomeReceivedEvent;
  typedef Aws::Utils::Event<KinesisClient, const Model::ListStreamsRequest&, const Model::ListStreamsOutcome&> ListStreamsOutcomeReceivedEvent;
  typedef Aws::Utils::Event<KinesisClient, const Model::ListTagsForStreamRequest&, const Model::ListTagsForStreamOutcome&> ListTagsForStreamOutcomeReceivedEvent;
  typedef Aws::Utils::Event<KinesisClient, const Model::MergeShardsRequest&, const Model::MergeShardsOutcome&> MergeShardsOutcomeReceivedEvent;
  typedef Aws::Utils::Event<KinesisClient, const Model::PutRecordRequest&, const Model::PutRecordOutcome&> PutRecordOutcomeReceivedEvent;
  typedef Aws::Utils::Event<KinesisClient, const Model::PutRecordsRequest&, const Model::PutRecordsOutcome&> PutRecordsOutcomeReceivedEvent;
  typedef Aws::Utils::Event<KinesisClient, const Model::RemoveTagsFromStreamRequest&, const Model::RemoveTagsFromStreamOutcome&> RemoveTagsFromStreamOutcomeReceivedEvent;
  typedef Aws::Utils::Event<KinesisClient, const Model::SplitShardRequest&, const Model::SplitShardOutcome&> SplitShardOutcomeReceivedEvent;
  ...
  */
  class AWS_KINESIS_API KinesisClient : public Aws::Client::AWSJsonClient
  {
     ...
     */
     void AddTagsToStreamAsync(const Model::AddTagsToStreamRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void CreateStreamAsync(const Model::CreateStreamRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void DeleteStreamAsync(const Model::DeleteStreamRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void DescribeStreamAsync(const Model::DescribeStreamRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void GetRecordsAsync(const Model::GetRecordsRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void GetShardIteratorAsync(const Model::GetShardIteratorRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void ListStreamsAsync(const Model::ListStreamsRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void ListTagsForStreamAsync(const Model::ListTagsForStreamRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void MergeShardsAsync(const Model::MergeShardsRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void PutRecordAsync(const Model::PutRecordRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void PutRecordsAsync(const Model::PutRecordsRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void RemoveTagsFromStreamAsync(const Model::RemoveTagsFromStreamRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void SplitShardAsync(const Model::SplitShardRequest& request) const;
  ...
  private:
    ...
    /**Async helpers**/
    void AddTagsToStreamAsyncHelper(const Model::AddTagsToStreamRequest& request) const;
    void CreateStreamAsyncHelper(const Model::CreateStreamRequest& request) const;
    void DeleteStreamAsyncHelper(const Model::DeleteStreamRequest& request) const;
    void DescribeStreamAsyncHelper(const Model::DescribeStreamRequest& request) const;
    void GetRecordsAsyncHelper(const Model::GetRecordsRequest& request) const;
    void GetShardIteratorAsyncHelper(const Model::GetShardIteratorRequest& request) const;
    void ListStreamsAsyncHelper(const Model::ListStreamsRequest& request) const;
    void ListTagsForStreamAsyncHelper(const Model::ListTagsForStreamRequest& request) const;
    void MergeShardsAsyncHelper(const Model::MergeShardsRequest& request) const;
    void PutRecordAsyncHelper(const Model::PutRecordRequest& request) const;
    void PutRecordsAsyncHelper(const Model::PutRecordsRequest& request) const;
    void RemoveTagsFromStreamAsyncHelper(const Model::RemoveTagsFromStreamRequest& request) const;
    void SplitShardAsyncHelper(const Model::SplitShardRequest& request) const;
