...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTFLEETHUB_API DescribeApplicationRequest : public IoTFleetHubRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeApplicationRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeApplicationRequest>(GetServiceRequestName(), *this);
    }
