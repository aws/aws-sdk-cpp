...
using ResolveEndpointOutcome = Aws::IoTFleetHub::Endpoint::IoTFleetHubEndpointProvider::IoTFleetHubResolveEndpointOutcome;
...
IoTFleetHubClient::IoTFleetHubClient(const Client::ClientConfiguration& clientConfiguration,
                                     std::shared_ptr<Endpoint::IoTFleetHubEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<IoTFleetHubErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<IoTFleetHub::Endpoint::IoTFleetHubEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
