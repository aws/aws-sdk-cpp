...
{
const size_t IoTFleetHubEndpointRules::RulesBlobStrLen = 3494;
const size_t IoTFleetHubEndpointRules::RulesBlobSize = 3495;

using RulesBlobT = Aws::Array<const char, IoTFleetHubEndpointRules::RulesBlobSize>;
...
't','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','a','p','i','.','f','l',
'e','e','t','h','u','b','.','i','o','t','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.',
...
':','"','h','t','t','p','s',':','/','/','a','p','i','.','f','l','e','e','t','h','u','b','.','i','o',
...
'{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','a','p','i','.','f','l','e','e','t',
'h','u','b','.','i','o','t','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i',
...
'l','"',':','"','h','t','t','p','s',':','/','/','a','p','i','.','f','l','e','e','t','h','u','b','.',
'i','o','t','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R','e',
's','u','l','t','#','d','n','s','S','u','f','f','i','x','}','"',',','"','p','r','o','p','e','r','t',
'i','e','s','"',':','{','}',',','"','h','e','a','d','e','r','s','"',':','{','}','}',',','"','t','y',
'p','e','"',':','"','e','n','d','p','o','i','n','t','"','}',']','}',']','}','\0'
}};

const char* IoTFleetHubEndpointRules::GetRulesBlob()
{
