...
Aws::String AmplifyEndpointRules::GetRulesAsString()
{
    return Aws::String(AmplifyEndpointRules::Rules.begin(), AmplifyEndpointRules::Rules.end());
}

const Aws::Vector<char> AmplifyEndpointRules::Rules = {
...
'a','m','p','l','i','f','y','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a',
...
'o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','a','m','p',
'l','i','f','y','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R',
