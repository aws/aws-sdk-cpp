...
namespace Amplify
{
  ...
  class AWS_AMPLIFY_API AmplifyClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        AmplifyClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                      std::shared_ptr<Endpoint::AmplifyEndpointProvider> endpointProvider = Aws::MakeShared<Amplify::Endpoint::AmplifyEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::AmplifyEndpointProvider> m_endpointProvider;
  };
