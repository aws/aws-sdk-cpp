...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_AMPLIFY_API DeleteWebhookRequest : public AmplifyRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteWebhookRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteWebhookRequest>(GetServiceRequestName(), *this);
    }
