...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_AMPLIFY_API DeleteJobRequest : public AmplifyRequest
  {
  public:
    DeleteJobRequest();
    ...
    */
    virtual Aws::UniquePtr<DeleteJobRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteJobRequest>(GetServiceRequestName(), *this);
    }
