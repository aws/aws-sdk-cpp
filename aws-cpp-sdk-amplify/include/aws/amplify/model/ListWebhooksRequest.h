...
namespace Model
{
  ...
  /**
   * <p> Request structure for the list webhooks request. </p><p><h3>See Also:</h3>  
   * <a
  ...
  public:
    ...
    /**
     * <p> Pagination token. Set to null to start listing webhooks from start. If
     * non-null pagination token is returned in a result, then pass its value in here
     * to list more webhooks. </p>
     */
