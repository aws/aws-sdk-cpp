...
using ResolveEndpointOutcome = Aws::EMRContainers::Endpoint::EMRContainersEndpointProvider::EMRContainersResolveEndpointOutcome;
...
EMRContainersClient::EMRContainersClient(const Client::ClientConfiguration& clientConfiguration,
                                         std::shared_ptr<Endpoint::EMRContainersEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<EMRContainersErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<EMRContainers::Endpoint::EMRContainersEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
