...
Aws::String EMRContainersEndpointRules::GetRulesAsString()
{
    return Aws::String(EMRContainersEndpointRules::Rules.begin(), EMRContainersEndpointRules::Rules.end());
}

const Aws::Vector<char> EMRContainersEndpointRules::Rules = {
...
't','t','p','s',':','/','/','e','m','r','-','c','o','n','t','a','i','n','e','r','s','-','f','i','p',
...
'"',':','"','h','t','t','p','s',':','/','/','e','m','r','-','c','o','n','t','a','i','n','e','r','s',
...
'p','s',':','/','/','e','m','r','-','c','o','n','t','a','i','n','e','r','s','.','{','R','e','g','i',
