...
namespace Model
{
  ...
  /**
   */
  class AWS_EMRCONTAINERS_API DescribeManagedEndpointRequest : public EMRContainersRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeManagedEndpointRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeManagedEndpointRequest>(GetServiceRequestName(), *this);
    }
