...
namespace Model
{
  ...
  /**
   */
  class AWS_EMRCONTAINERS_API ListVirtualClustersRequest : public EMRContainersRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListVirtualClustersRequest> Clone() const
    {
      return Aws::MakeUnique<ListVirtualClustersRequest>(GetServiceRequestName(), *this);
    }
