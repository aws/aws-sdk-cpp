...
namespace Model
{
  ...
  /**
   */
  class AWS_EMRCONTAINERS_API ListManagedEndpointsRequest : public EMRContainersRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListManagedEndpointsRequest> Clone() const
    {
      return Aws::MakeUnique<ListManagedEndpointsRequest>(GetServiceRequestName(), *this);
    }
