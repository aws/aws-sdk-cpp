...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EMRCONTAINERS_API ParametricMonitoringConfiguration
  {
  public:
    ParametricMonitoringConfiguration();
    ParametricMonitoringConfiguration(Aws::Utils::Json::JsonView jsonValue);
    ParametricMonitoringConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
