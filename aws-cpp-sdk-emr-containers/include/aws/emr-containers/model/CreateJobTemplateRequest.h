...
namespace Model
{
  ...
  /**
   */
  class AWS_EMRCONTAINERS_API CreateJobTemplateRequest : public EMRContainersRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateJobTemplateRequest> Clone() const
    {
      return Aws::MakeUnique<CreateJobTemplateRequest>(GetServiceRequestName(), *this);
    }
