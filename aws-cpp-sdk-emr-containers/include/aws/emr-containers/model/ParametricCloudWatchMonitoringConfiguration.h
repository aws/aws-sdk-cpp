...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EMRCONTAINERS_API ParametricCloudWatchMonitoringConfiguration
  {
  public:
    ParametricCloudWatchMonitoringConfiguration();
    ParametricCloudWatchMonitoringConfiguration(Aws::Utils::Json::JsonView jsonValue);
    ParametricCloudWatchMonitoringConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
