...
namespace Model
{
  ...
  /**
   */
  class AWS_EMRCONTAINERS_API DescribeVirtualClusterRequest : public EMRContainersRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeVirtualClusterRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeVirtualClusterRequest>(GetServiceRequestName(), *this);
    }
