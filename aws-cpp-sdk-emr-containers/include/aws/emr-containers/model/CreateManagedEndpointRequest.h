...
namespace Model
{
  ...
  /**
   */
  class AWS_EMRCONTAINERS_API CreateManagedEndpointRequest : public EMRContainersRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateManagedEndpointRequest> Clone() const
    {
      return Aws::MakeUnique<CreateManagedEndpointRequest>(GetServiceRequestName(), *this);
    }
