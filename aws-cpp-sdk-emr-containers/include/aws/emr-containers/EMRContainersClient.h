...
namespace EMRContainers
{
  ...
  class AWS_EMRCONTAINERS_API EMRContainersClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        EMRContainersClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                            std::shared_ptr<Endpoint::EMRContainersEndpointProvider> endpointProvider = Aws::MakeShared<EMRContainers::Endpoint::EMRContainersEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::EMRContainersEndpointProvider> m_endpointProvider;
  };
