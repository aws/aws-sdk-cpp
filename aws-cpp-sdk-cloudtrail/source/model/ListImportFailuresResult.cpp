...
ListImportFailuresResult::ListImportFailuresResult()
{
}

ListImportFailuresResult::ListImportFailuresResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListImportFailuresResult& ListImportFailuresResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
