...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDTRAIL_API DeleteEventDataStoreRequest : public CloudTrailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteEventDataStoreRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteEventDataStoreRequest>(GetServiceRequestName(), *this);
    }
