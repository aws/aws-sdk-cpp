...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CLOUDTRAIL_API RegisterOrganizationDelegatedAdminRequest : public CloudTrailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<RegisterOrganizationDelegatedAdminRequest> Clone() const
    {
      return Aws::MakeUnique<RegisterOrganizationDelegatedAdminRequest>(GetServiceRequestName(), *this);
    }
