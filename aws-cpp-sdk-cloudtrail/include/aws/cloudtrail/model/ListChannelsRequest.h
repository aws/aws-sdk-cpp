...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDTRAIL_API ListChannelsRequest : public CloudTrailRequest
  {
  public:
    ListChannelsRequest();
    ...
    */
    virtual Aws::UniquePtr<ListChannelsRequest> Clone() const
    {
      return Aws::MakeUnique<ListChannelsRequest>(GetServiceRequestName(), *this);
    }
