...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDTRAIL_API ListImportFailuresRequest : public CloudTrailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListImportFailuresRequest> Clone() const
    {
      return Aws::MakeUnique<ListImportFailuresRequest>(GetServiceRequestName(), *this);
    }
