...
namespace Model
{
  ...
  public:
     ...
     * file delivery.</p>
     */
    inline void SetSnsTopicName(const Aws::String& value) { m_snsTopicName = value; }

    /**
     * <p>Specifies the name of the Amazon SNS topic defined for notification of log
     * file delivery.</p>
     */
    inline void SetSnsTopicName(Aws::String&& value) { m_snsTopicName = value; }

    /**
     * <p>Specifies the name of the Amazon SNS topic defined for notification of log
     * file delivery.</p>
     */
    inline void SetSnsTopicName(const char* value) { m_snsTopicName.assign(value); }

    /**
     * <p>Specifies the name of the Amazon SNS topic defined for notification of log
     * file delivery.</p>
     */
    inline CreateTrailResult& WithSnsTopicName(const Aws::String& value) { SetSnsTopicName(value); return *this;}

    /**
     * <p>Specifies the name of the Amazon SNS topic defined for notification of log
     * file delivery.</p>
     */
    inline CreateTrailResult& WithSnsTopicName(Aws::String&& value) { SetSnsTopicName(value); return *this;}

    /**
     * <p>Specifies the name of the Amazon SNS topic defined for notification of log
     * file delivery.</p>
     */
    inline CreateTrailResult& WithSnsTopicName(const char* value) { SetSnsTopicName(value); return *this;}
    ...
    /**
     * <p>Specifies the ARN of the trail that was created.</p>
     */
