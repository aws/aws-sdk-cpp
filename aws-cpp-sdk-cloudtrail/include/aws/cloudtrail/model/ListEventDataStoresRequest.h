...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDTRAIL_API ListEventDataStoresRequest : public CloudTrailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListEventDataStoresRequest> Clone() const
    {
      return Aws::MakeUnique<ListEventDataStoresRequest>(GetServiceRequestName(), *this);
    }
