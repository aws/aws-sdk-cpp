...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDTRAIL_API ListImportsRequest : public CloudTrailRequest
  {
  public:
    ListImportsRequest();
    ...
    */
    virtual Aws::UniquePtr<ListImportsRequest> Clone() const
    {
      return Aws::MakeUnique<ListImportsRequest>(GetServiceRequestName(), *this);
    }
