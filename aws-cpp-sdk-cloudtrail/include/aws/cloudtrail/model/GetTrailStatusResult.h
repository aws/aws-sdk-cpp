...
namespace Model
{
  ...
  public:
    ...
    GetTrailStatusResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    GetTrailStatusResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
