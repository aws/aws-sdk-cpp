...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CLOUDTRAIL_API DeregisterOrganizationDelegatedAdminRequest : public CloudTrailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeregisterOrganizationDelegatedAdminRequest> Clone() const
    {
      return Aws::MakeUnique<DeregisterOrganizationDelegatedAdminRequest>(GetServiceRequestName(), *this);
    }
