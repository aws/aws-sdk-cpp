...
namespace CloudTrail
{
  ...
  class AWS_CLOUDTRAIL_API CloudTrailClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        CloudTrailClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                         std::shared_ptr<Endpoint::CloudTrailEndpointProvider> endpointProvider = Aws::MakeShared<CloudTrail::Endpoint::CloudTrailEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::CloudTrailEndpointProvider> m_endpointProvider;
  };
