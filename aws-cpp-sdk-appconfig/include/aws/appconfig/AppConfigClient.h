...
namespace AppConfig
{
  ...
  class AWS_APPCONFIG_API AppConfigClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        AppConfigClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                        std::shared_ptr<Endpoint::AppConfigEndpointProvider> endpointProvider = Aws::MakeShared<AppConfig::Endpoint::AppConfigEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::AppConfigEndpointProvider> m_endpointProvider;
  };
