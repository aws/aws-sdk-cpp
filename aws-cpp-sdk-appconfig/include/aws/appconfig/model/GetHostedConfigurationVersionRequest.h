...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetHostedConfigurationVersionRequest> Clone() const
    {
      return Aws::MakeUnique<GetHostedConfigurationVersionRequest>(GetServiceRequestName(), *this);
    }
