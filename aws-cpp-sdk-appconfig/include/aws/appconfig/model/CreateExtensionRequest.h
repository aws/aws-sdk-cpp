...
namespace Model
{
  ...
  /**
   */
  class AWS_APPCONFIG_API CreateExtensionRequest : public AppConfigRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateExtensionRequest> Clone() const
    {
      return Aws::MakeUnique<CreateExtensionRequest>(GetServiceRequestName(), *this);
    }
