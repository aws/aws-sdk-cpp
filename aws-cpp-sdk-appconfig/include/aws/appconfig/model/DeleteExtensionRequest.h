...
namespace Model
{
  ...
  /**
   */
  class AWS_APPCONFIG_API DeleteExtensionRequest : public AppConfigRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteExtensionRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteExtensionRequest>(GetServiceRequestName(), *this);
    }
