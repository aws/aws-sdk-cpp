...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListHostedConfigurationVersionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListHostedConfigurationVersionsRequest>(GetServiceRequestName(), *this);
    }
