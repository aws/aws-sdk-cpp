...
namespace Model
{
  ...
  /**
   */
  class AWS_APPCONFIG_API CreateExtensionAssociationRequest : public AppConfigRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateExtensionAssociationRequest> Clone() const
    {
      return Aws::MakeUnique<CreateExtensionAssociationRequest>(GetServiceRequestName(), *this);
    }
