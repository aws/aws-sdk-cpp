...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateHostedConfigurationVersionRequest> Clone() const
    {
      return Aws::MakeUnique<CreateHostedConfigurationVersionRequest>(GetServiceRequestName(), *this);
    }
