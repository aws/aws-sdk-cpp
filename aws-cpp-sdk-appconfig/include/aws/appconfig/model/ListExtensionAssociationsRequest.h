...
namespace Model
{
  ...
  /**
   */
  class AWS_APPCONFIG_API ListExtensionAssociationsRequest : public AppConfigRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListExtensionAssociationsRequest> Clone() const
    {
      return Aws::MakeUnique<ListExtensionAssociationsRequest>(GetServiceRequestName(), *this);
    }
