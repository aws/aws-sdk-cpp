...
namespace Model
{
  ...
  /**
   */
  class AWS_APPCONFIG_API UpdateExtensionAssociationRequest : public AppConfigRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateExtensionAssociationRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateExtensionAssociationRequest>(GetServiceRequestName(), *this);
    }
