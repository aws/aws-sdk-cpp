...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteHostedConfigurationVersionRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteHostedConfigurationVersionRequest>(GetServiceRequestName(), *this);
    }
