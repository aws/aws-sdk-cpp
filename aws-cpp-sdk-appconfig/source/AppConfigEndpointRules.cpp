...
Aws::String AppConfigEndpointRules::GetRulesAsString()
{
    return Aws::String(AppConfigEndpointRules::Rules.begin(), AppConfigEndpointRules::Rules.end());
}

const Aws::Vector<char> AppConfigEndpointRules::Rules = {
...
':','"','h','t','t','p','s',':','/','/','a','p','p','c','o','n','f','i','g','.','u','s','-','g','o',
