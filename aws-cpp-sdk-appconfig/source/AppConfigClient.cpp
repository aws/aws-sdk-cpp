...
using ResolveEndpointOutcome = Aws::AppConfig::Endpoint::AppConfigEndpointProvider::AppConfigResolveEndpointOutcome;
...
AppConfigClient::AppConfigClient(const Client::ClientConfiguration& clientConfiguration,
                                 std::shared_ptr<Endpoint::AppConfigEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<AppConfigErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<AppConfig::Endpoint::AppConfigEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
