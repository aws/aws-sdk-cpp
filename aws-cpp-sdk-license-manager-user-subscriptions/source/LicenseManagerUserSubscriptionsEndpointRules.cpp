...
Aws::String LicenseManagerUserSubscriptionsEndpointRules::GetRulesAsString()
{
    return Aws::String(LicenseManagerUserSubscriptionsEndpointRules::Rules.begin(), LicenseManagerUserSubscriptionsEndpointRules::Rules.end());
}

const Aws::Vector<char> LicenseManagerUserSubscriptionsEndpointRules::Rules = {
...
'"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','l','i','c','e','n','s','e',
'-','m','a','n','a','g','e','r','-','u','s','e','r','-','s','u','b','s','c','r','i','p','t','i','o',
...
'e','r','-','u','s','e','r','-','s','u','b','s','c','r','i','p','t','i','o','n','s','-','f','i','p',
...
'u','s','e','r','-','s','u','b','s','c','r','i','p','t','i','o','n','s','.','{','R','e','g','i','o',
