...
namespace LicenseManagerUserSubscriptions
{
  ...
  class AWS_LICENSEMANAGERUSERSUBSCRIPTIONS_API LicenseManagerUserSubscriptionsClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        LicenseManagerUserSubscriptionsClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                              std::shared_ptr<Endpoint::LicenseManagerUserSubscriptionsEndpointProvider> endpointProvider = Aws::MakeShared<LicenseManagerUserSubscriptions::Endpoint::LicenseManagerUserSubscriptionsEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::LicenseManagerUserSubscriptionsEndpointProvider> m_endpointProvider;
  };
