...
namespace Model
{
  ...
  /**
   */
  class AWS_LICENSEMANAGERUSERSUBSCRIPTIONS_API DisassociateUserRequest : public LicenseManagerUserSubscriptionsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateUserRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateUserRequest>(GetServiceRequestName(), *this);
    }
