...
namespace Model
{
  ...
  /**
   */
  class AWS_LICENSEMANAGERUSERSUBSCRIPTIONS_API ListUserAssociationsRequest : public LicenseManagerUserSubscriptionsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListUserAssociationsRequest> Clone() const
    {
      return Aws::MakeUnique<ListUserAssociationsRequest>(GetServiceRequestName(), *this);
    }
