...
namespace Model
{
  ...
  /**
   */
  class AWS_LICENSEMANAGERUSERSUBSCRIPTIONS_API StopProductSubscriptionRequest : public LicenseManagerUserSubscriptionsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StopProductSubscriptionRequest> Clone() const
    {
      return Aws::MakeUnique<StopProductSubscriptionRequest>(GetServiceRequestName(), *this);
    }
