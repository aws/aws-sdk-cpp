...
namespace Model
{
  ...
  /**
   */
  class AWS_LICENSEMANAGERUSERSUBSCRIPTIONS_API StartProductSubscriptionRequest : public LicenseManagerUserSubscriptionsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StartProductSubscriptionRequest> Clone() const
    {
      return Aws::MakeUnique<StartProductSubscriptionRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "StartProductSubscription"; }
