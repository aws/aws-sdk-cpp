...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_LICENSEMANAGERUSERSUBSCRIPTIONS_API ProductUserSummary
  {
  public:
    ProductUserSummary();
    ProductUserSummary(Aws::Utils::Json::JsonView jsonValue);
    ProductUserSummary& operator=(Aws::Utils::Json::JsonView jsonValue);
