...
namespace Model
{
  ...
  /**
   */
  class AWS_LICENSEMANAGERUSERSUBSCRIPTIONS_API DeregisterIdentityProviderRequest : public LicenseManagerUserSubscriptionsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeregisterIdentityProviderRequest> Clone() const
    {
      return Aws::MakeUnique<DeregisterIdentityProviderRequest>(GetServiceRequestName(), *this);
    }
