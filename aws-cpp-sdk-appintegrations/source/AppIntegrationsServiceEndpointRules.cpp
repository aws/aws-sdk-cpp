...
Aws::String AppIntegrationsServiceEndpointRules::GetRulesAsString()
{
    return Aws::String(AppIntegrationsServiceEndpointRules::Rules.begin(), AppIntegrationsServiceEndpointRules::Rules.end());
}

const Aws::Vector<char> AppIntegrationsServiceEndpointRules::Rules = {
...
'"','h','t','t','p','s',':','/','/','a','p','p','-','i','n','t','e','g','r','a','t','i','o','n','s',
...
'a','t','i','o','n','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o',
