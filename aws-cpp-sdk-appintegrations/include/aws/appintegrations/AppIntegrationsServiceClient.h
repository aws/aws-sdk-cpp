...
namespace AppIntegrationsService
{
  ...
  class AWS_APPINTEGRATIONSSERVICE_API AppIntegrationsServiceClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        AppIntegrationsServiceClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                     std::shared_ptr<Endpoint::AppIntegrationsServiceEndpointProvider> endpointProvider = Aws::MakeShared<AppIntegrationsService::Endpoint::AppIntegrationsServiceEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::AppIntegrationsServiceEndpointProvider> m_endpointProvider;
  };
