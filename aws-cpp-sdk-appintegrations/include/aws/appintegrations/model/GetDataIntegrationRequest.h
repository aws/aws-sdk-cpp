...
namespace Model
{
  ...
  /**
   */
  class AWS_APPINTEGRATIONSSERVICE_API GetDataIntegrationRequest : public AppIntegrationsServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetDataIntegrationRequest> Clone() const
    {
      return Aws::MakeUnique<GetDataIntegrationRequest>(GetServiceRequestName(), *this);
    }
