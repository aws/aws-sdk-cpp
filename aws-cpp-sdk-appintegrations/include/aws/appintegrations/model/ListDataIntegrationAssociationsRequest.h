...
namespace Model
{
  ...
  /**
   */
  class AWS_APPINTEGRATIONSSERVICE_API ListDataIntegrationAssociationsRequest : public AppIntegrationsServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListDataIntegrationAssociationsRequest> Clone() const
    {
      return Aws::MakeUnique<ListDataIntegrationAssociationsRequest>(GetServiceRequestName(), *this);
    }
