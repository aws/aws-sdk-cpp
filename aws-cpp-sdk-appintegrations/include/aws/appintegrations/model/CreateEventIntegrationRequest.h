...
namespace Model
{
  ...
  /**
   */
  class AWS_APPINTEGRATIONSSERVICE_API CreateEventIntegrationRequest : public AppIntegrationsServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateEventIntegrationRequest> Clone() const
    {
      return Aws::MakeUnique<CreateEventIntegrationRequest>(GetServiceRequestName(), *this);
    }
