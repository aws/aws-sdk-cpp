...
namespace Model
{
  ...
  /**
   */
  class AWS_APPINTEGRATIONSSERVICE_API ListEventIntegrationAssociationsRequest : public AppIntegrationsServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListEventIntegrationAssociationsRequest> Clone() const
    {
      return Aws::MakeUnique<ListEventIntegrationAssociationsRequest>(GetServiceRequestName(), *this);
    }
