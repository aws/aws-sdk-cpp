...
namespace Model
{
  ...
  /**
   */
  class AWS_APPINTEGRATIONSSERVICE_API UpdateDataIntegrationRequest : public AppIntegrationsServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateDataIntegrationRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateDataIntegrationRequest>(GetServiceRequestName(), *this);
    }
