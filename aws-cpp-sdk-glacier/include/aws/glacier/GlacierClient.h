...
namespace Glacier
{
  ...
  class AWS_GLACIER_API GlacierClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        GlacierClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                      std::shared_ptr<Endpoint::GlacierEndpointProvider> endpointProvider = Aws::MakeShared<Glacier::Endpoint::GlacierEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::GlacierEndpointProvider> m_endpointProvider;
  };
