...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PurchaseProvisionedCapacityRequest> Clone() const
    {
      return Aws::MakeUnique<PurchaseProvisionedCapacityRequest>(GetServiceRequestName(), *this);
    }
