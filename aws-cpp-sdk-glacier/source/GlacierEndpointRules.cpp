...
namespace Glacier
{
const size_t GlacierEndpointRules::RulesBlobStrLen = 3458;
const size_t GlacierEndpointRules::RulesBlobSize = 3459;

using RulesBlobT = Aws::Array<const char, GlacierEndpointRules::RulesBlobSize>;
...
'/','g','l','a','c','i','e','r','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P',
...
'p','o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','g','l',
'a','c','i','e','r','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n',
...
const char* GlacierEndpointRules::GetRulesBlob()
{
