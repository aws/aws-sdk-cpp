...
ListVaultsResult::ListVaultsResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListVaultsResult& ListVaultsResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
