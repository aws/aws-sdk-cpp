...
using STSResolveEndpointOutcome = Aws::STS::Endpoint::STSEndpointProvider::STSResolveEndpointOutcome;
...
void ValidateOutcome(const STSResolveEndpointOutcome& outcome, const STSEndpointProviderEndpointTestCase::Expect& expect)
{
