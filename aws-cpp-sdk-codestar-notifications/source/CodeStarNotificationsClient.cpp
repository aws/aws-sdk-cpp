...
using ResolveEndpointOutcome = Aws::CodeStarNotifications::Endpoint::CodeStarNotificationsEndpointProvider::CodeStarNotificationsResolveEndpointOutcome;
...
CodeStarNotificationsClient::CodeStarNotificationsClient(const Client::ClientConfiguration& clientConfiguration,
                                                         std::shared_ptr<Endpoint::CodeStarNotificationsEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<CodeStarNotificationsErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<CodeStarNotifications::Endpoint::CodeStarNotificationsEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
