...
Aws::String CodeStarNotificationsEndpointRules::GetRulesAsString()
{
    return Aws::String(CodeStarNotificationsEndpointRules::Rules.begin(), CodeStarNotificationsEndpointRules::Rules.end());
}

const Aws::Vector<char> CodeStarNotificationsEndpointRules::Rules = {
...
't','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','c','o','d','e','s','t',
'a','r','-','n','o','t','i','f','i','c','a','t','i','o','n','s','-','f','i','p','s','.','{','R','e',
...
'/','c','o','d','e','s','t','a','r','-','n','o','t','i','f','i','c','a','t','i','o','n','s','-','f',
...
'"',':','"','h','t','t','p','s',':','/','/','c','o','d','e','s','t','a','r','-','n','o','t','i','f',
'i','c','a','t','i','o','n','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t',
