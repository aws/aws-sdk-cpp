...
namespace CloudHSMV2
{
  ...
  class AWS_CLOUDHSMV2_API CloudHSMV2Client : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        CloudHSMV2Client(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                         std::shared_ptr<Endpoint::CloudHSMV2EndpointProvider> endpointProvider = Aws::MakeShared<CloudHSMV2::Endpoint::CloudHSMV2EndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::CloudHSMV2EndpointProvider> m_endpointProvider;
  };
