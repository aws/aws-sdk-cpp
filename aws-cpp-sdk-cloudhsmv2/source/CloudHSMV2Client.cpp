...
using ResolveEndpointOutcome = Aws::CloudHSMV2::Endpoint::CloudHSMV2EndpointProvider::CloudHSMV2ResolveEndpointOutcome;
...
CloudHSMV2Client::CloudHSMV2Client(const Client::ClientConfiguration& clientConfiguration,
                                   std::shared_ptr<Endpoint::CloudHSMV2EndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<CloudHSMV2ErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<CloudHSMV2::Endpoint::CloudHSMV2EndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
