...
RestoreBackupResult::RestoreBackupResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

RestoreBackupResult& RestoreBackupResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
