...
Aws::String IoTEventsEndpointRules::GetRulesAsString()
{
    return Aws::String(IoTEventsEndpointRules::Rules.begin(), IoTEventsEndpointRules::Rules.end());
}

const Aws::Vector<char> IoTEventsEndpointRules::Rules = {
