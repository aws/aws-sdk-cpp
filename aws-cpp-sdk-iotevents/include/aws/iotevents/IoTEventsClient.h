...
namespace IoTEvents
{
  ...
  class AWS_IOTEVENTS_API IoTEventsClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        IoTEventsClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                        std::shared_ptr<Endpoint::IoTEventsEndpointProvider> endpointProvider = Aws::MakeShared<IoTEvents::Endpoint::IoTEventsEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::IoTEventsEndpointProvider> m_endpointProvider;
  };
