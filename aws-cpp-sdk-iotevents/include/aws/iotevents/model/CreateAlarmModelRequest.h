...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTEVENTS_API CreateAlarmModelRequest : public IoTEventsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateAlarmModelRequest> Clone() const
    {
      return Aws::MakeUnique<CreateAlarmModelRequest>(GetServiceRequestName(), *this);
    }
