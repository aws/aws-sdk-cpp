...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTEVENTS_API ListInputRoutingsRequest : public IoTEventsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListInputRoutingsRequest> Clone() const
    {
      return Aws::MakeUnique<ListInputRoutingsRequest>(GetServiceRequestName(), *this);
    }
