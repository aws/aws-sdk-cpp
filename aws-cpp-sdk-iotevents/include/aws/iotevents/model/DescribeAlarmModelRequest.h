...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTEVENTS_API DescribeAlarmModelRequest : public IoTEventsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeAlarmModelRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeAlarmModelRequest>(GetServiceRequestName(), *this);
    }
