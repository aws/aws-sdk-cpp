...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetDetectorModelAnalysisResultsRequest> Clone() const
    {
      return Aws::MakeUnique<GetDetectorModelAnalysisResultsRequest>(GetServiceRequestName(), *this);
    }
