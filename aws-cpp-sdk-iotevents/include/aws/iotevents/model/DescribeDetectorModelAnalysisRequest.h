...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTEVENTS_API DescribeDetectorModelAnalysisRequest : public IoTEventsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeDetectorModelAnalysisRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeDetectorModelAnalysisRequest>(GetServiceRequestName(), *this);
    }
