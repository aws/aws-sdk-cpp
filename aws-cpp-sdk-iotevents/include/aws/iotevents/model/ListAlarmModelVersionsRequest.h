...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTEVENTS_API ListAlarmModelVersionsRequest : public IoTEventsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListAlarmModelVersionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListAlarmModelVersionsRequest>(GetServiceRequestName(), *this);
    }
