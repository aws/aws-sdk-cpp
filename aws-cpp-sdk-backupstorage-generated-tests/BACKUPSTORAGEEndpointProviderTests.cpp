...
using BackupStorageResolveEndpointOutcome = Aws::BackupStorage::Endpoint::BackupStorageEndpointProvider::BackupStorageResolveEndpointOutcome;
...
void ValidateOutcome(const BackupStorageResolveEndpointOutcome& outcome, const BackupStorageEndpointProviderEndpointTestCase::Expect& expect)
{
