...
namespace Model
{
  ...
  /**
   */
  class AWS_BUDGETS_API DescribeBudgetActionRequest : public BudgetsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeBudgetActionRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeBudgetActionRequest>(GetServiceRequestName(), *this);
    }
