...
namespace Model
{
  ...
  /**
   * <p>The amount of cost or usage being measured for a budget.</p> <p>For example,
   * a <code>Spend</code> for <code>3 GB</code> of S3 usage would have the following
  ...
  public:
    ...
    /**
     * <p>The cost or usage amount associated with a budget forecast, actual spend, or
     * budget threshold.</p>
     */
    ...
    /**
     * <p>The unit of measurement used for the budget forecast, actual spend, or budget
