...
namespace Model
{
  ...
  /**
   */
  class AWS_BUDGETS_API DescribeBudgetActionHistoriesRequest : public BudgetsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeBudgetActionHistoriesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeBudgetActionHistoriesRequest>(GetServiceRequestName(), *this);
    }
