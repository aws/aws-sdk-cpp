...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeBudgetPerformanceHistoryRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeBudgetPerformanceHistoryRequest>(GetServiceRequestName(), *this);
    }
