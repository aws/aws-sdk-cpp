...
namespace Model
{
  ...
  /**
   */
  class AWS_BUDGETS_API DescribeBudgetActionsForBudgetRequest : public BudgetsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeBudgetActionsForBudgetRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeBudgetActionsForBudgetRequest>(GetServiceRequestName(), *this);
    }
