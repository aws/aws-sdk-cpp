...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeBudgetActionsForAccountRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeBudgetActionsForAccountRequest>(GetServiceRequestName(), *this);
    }
