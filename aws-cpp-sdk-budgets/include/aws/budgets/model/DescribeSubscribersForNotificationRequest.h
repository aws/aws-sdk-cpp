...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeSubscribersForNotificationRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeSubscribersForNotificationRequest>(GetServiceRequestName(), *this);
    }
