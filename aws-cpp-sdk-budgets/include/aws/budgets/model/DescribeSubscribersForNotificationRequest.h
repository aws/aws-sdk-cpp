...
namespace Model
{
  ...
  /**
   * Request of DescribeSubscribersForNotification<p><h3>See Also:</h3>   <a
  ...
  public:
    ...
    inline virtual const char* GetServiceRequestName() override { return "DescribeSubscribersForNotification"; }
