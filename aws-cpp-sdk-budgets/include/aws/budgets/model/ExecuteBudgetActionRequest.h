...
namespace Model
{
  ...
  /**
   */
  class AWS_BUDGETS_API ExecuteBudgetActionRequest : public BudgetsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ExecuteBudgetActionRequest> Clone() const
    {
      return Aws::MakeUnique<ExecuteBudgetActionRequest>(GetServiceRequestName(), *this);
    }
