...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeNotificationsForBudgetRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeNotificationsForBudgetRequest>(GetServiceRequestName(), *this);
    }
