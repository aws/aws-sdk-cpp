...
namespace Model
{
  ...
  /**
   * Request of DescribeNotificationsForBudget<p><h3>See Also:</h3>   <a
  ...
  public:
    ...
    inline virtual const char* GetServiceRequestName() override { return "DescribeNotificationsForBudget"; }
