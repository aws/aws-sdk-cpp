...
namespace Model
{
  ...
  /**
   */
  class AWS_BUDGETS_API DescribeBudgetNotificationsForAccountRequest : public BudgetsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeBudgetNotificationsForAccountRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeBudgetNotificationsForAccountRequest>(GetServiceRequestName(), *this);
    }
