...
namespace Model
{
  ...
  /**
   */
  class AWS_BUDGETS_API CreateBudgetActionRequest : public BudgetsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateBudgetActionRequest> Clone() const
    {
      return Aws::MakeUnique<CreateBudgetActionRequest>(GetServiceRequestName(), *this);
    }
