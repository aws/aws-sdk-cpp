...
namespace Budgets
{
  ...
  class AWS_BUDGETS_API BudgetsClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        BudgetsClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                      std::shared_ptr<Endpoint::BudgetsEndpointProvider> endpointProvider = Aws::MakeShared<Budgets::Endpoint::BudgetsEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::BudgetsEndpointProvider> m_endpointProvider;
  };
