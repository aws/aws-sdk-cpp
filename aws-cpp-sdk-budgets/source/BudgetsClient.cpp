...
using ResolveEndpointOutcome = Aws::Budgets::Endpoint::BudgetsEndpointProvider::BudgetsResolveEndpointOutcome;
...
BudgetsClient::BudgetsClient(const Client::ClientConfiguration& clientConfiguration,
                             std::shared_ptr<Endpoint::BudgetsEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<BudgetsErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<Budgets::Endpoint::BudgetsEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
