...
DescribeBudgetResult::DescribeBudgetResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

DescribeBudgetResult& DescribeBudgetResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
