...
using ResolveEndpointOutcome = Aws::ResilienceHub::Endpoint::ResilienceHubEndpointProvider::ResilienceHubResolveEndpointOutcome;
...
ResilienceHubClient::ResilienceHubClient(const Client::ClientConfiguration& clientConfiguration,
                                         std::shared_ptr<Endpoint::ResilienceHubEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<ResilienceHubErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<ResilienceHub::Endpoint::ResilienceHubEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
