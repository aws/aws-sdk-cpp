...
Aws::String ResilienceHubEndpointRules::GetRulesAsString()
{
    return Aws::String(ResilienceHubEndpointRules::Rules.begin(), ResilienceHubEndpointRules::Rules.end());
}

const Aws::Vector<char> ResilienceHubEndpointRules::Rules = {
...
't','p','s',':','/','/','r','e','s','i','l','i','e','n','c','e','h','u','b','-','f','i','p','s','.',
...
'"','h','t','t','p','s',':','/','/','r','e','s','i','l','i','e','n','c','e','h','u','b','.','{','R',
