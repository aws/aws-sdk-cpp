...
namespace Model
{
  ...
  /**
   */
  class AWS_RESILIENCEHUB_API CreateResiliencyPolicyRequest : public ResilienceHubRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateResiliencyPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<CreateResiliencyPolicyRequest>(GetServiceRequestName(), *this);
    }
