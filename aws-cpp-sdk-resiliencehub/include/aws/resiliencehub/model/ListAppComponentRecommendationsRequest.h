...
namespace Model
{
  ...
  /**
   */
  class AWS_RESILIENCEHUB_API ListAppComponentRecommendationsRequest : public ResilienceHubRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListAppComponentRecommendationsRequest> Clone() const
    {
      return Aws::MakeUnique<ListAppComponentRecommendationsRequest>(GetServiceRequestName(), *this);
    }
