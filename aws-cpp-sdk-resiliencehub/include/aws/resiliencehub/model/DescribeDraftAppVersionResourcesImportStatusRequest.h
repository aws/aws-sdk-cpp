...
namespace Model
{
  ...
  /**
   */
  class AWS_RESILIENCEHUB_API DescribeDraftAppVersionResourcesImportStatusRequest : public ResilienceHubRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeDraftAppVersionResourcesImportStatusRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeDraftAppVersionResourcesImportStatusRequest>(GetServiceRequestName(), *this);
    }
