...
namespace Model
{
  ...
  /**
   */
  class AWS_RESILIENCEHUB_API ListAppVersionsRequest : public ResilienceHubRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListAppVersionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListAppVersionsRequest>(GetServiceRequestName(), *this);
    }
