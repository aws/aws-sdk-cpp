...
namespace Model
{
  ...
  /**
   */
  class AWS_RESILIENCEHUB_API ListAppsRequest : public ResilienceHubRequest
  {
  public:
    ListAppsRequest();
    ...
    */
    virtual Aws::UniquePtr<ListAppsRequest> Clone() const
    {
      return Aws::MakeUnique<ListAppsRequest>(GetServiceRequestName(), *this);
    }
