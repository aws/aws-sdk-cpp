...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<RemoveDraftAppVersionResourceMappingsRequest> Clone() const
    {
      return Aws::MakeUnique<RemoveDraftAppVersionResourceMappingsRequest>(GetServiceRequestName(), *this);
    }
