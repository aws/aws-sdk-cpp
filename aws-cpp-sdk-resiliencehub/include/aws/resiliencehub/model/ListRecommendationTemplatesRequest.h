...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListRecommendationTemplatesRequest> Clone() const
    {
      return Aws::MakeUnique<ListRecommendationTemplatesRequest>(GetServiceRequestName(), *this);
    }
