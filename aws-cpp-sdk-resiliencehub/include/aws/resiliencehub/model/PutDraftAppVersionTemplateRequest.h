...
namespace Model
{
  ...
  /**
   */
  class AWS_RESILIENCEHUB_API PutDraftAppVersionTemplateRequest : public ResilienceHubRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutDraftAppVersionTemplateRequest> Clone() const
    {
      return Aws::MakeUnique<PutDraftAppVersionTemplateRequest>(GetServiceRequestName(), *this);
    }
