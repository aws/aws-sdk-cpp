...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListAppComponentCompliancesRequest> Clone() const
    {
      return Aws::MakeUnique<ListAppComponentCompliancesRequest>(GetServiceRequestName(), *this);
    }
