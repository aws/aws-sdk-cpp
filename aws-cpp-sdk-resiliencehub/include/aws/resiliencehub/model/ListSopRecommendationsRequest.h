...
namespace Model
{
  ...
  /**
   */
  class AWS_RESILIENCEHUB_API ListSopRecommendationsRequest : public ResilienceHubRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListSopRecommendationsRequest> Clone() const
    {
      return Aws::MakeUnique<ListSopRecommendationsRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "ListSopRecommendations"; }
