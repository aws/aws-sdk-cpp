...
namespace Model
{
  ...
  /**
   */
  class AWS_RESILIENCEHUB_API CreateAppRequest : public ResilienceHubRequest
  {
  public:
    CreateAppRequest();
    ...
    */
    virtual Aws::UniquePtr<CreateAppRequest> Clone() const
    {
      return Aws::MakeUnique<CreateAppRequest>(GetServiceRequestName(), *this);
    }
