...
namespace Model
{
  ...
  /**
   */
  class AWS_RESILIENCEHUB_API StartAppAssessmentRequest : public ResilienceHubRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StartAppAssessmentRequest> Clone() const
    {
      return Aws::MakeUnique<StartAppAssessmentRequest>(GetServiceRequestName(), *this);
    }
