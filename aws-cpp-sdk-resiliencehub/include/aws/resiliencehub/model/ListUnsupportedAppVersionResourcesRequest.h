...
namespace Model
{
  ...
  /**
   */
  class AWS_RESILIENCEHUB_API ListUnsupportedAppVersionResourcesRequest : public ResilienceHubRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListUnsupportedAppVersionResourcesRequest> Clone() const
    {
      return Aws::MakeUnique<ListUnsupportedAppVersionResourcesRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "ListUnsupportedAppVersionResources"; }
