...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ImportResourcesToDraftAppVersionRequest> Clone() const
    {
      return Aws::MakeUnique<ImportResourcesToDraftAppVersionRequest>(GetServiceRequestName(), *this);
    }
