...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateRecommendationTemplateRequest> Clone() const
    {
      return Aws::MakeUnique<CreateRecommendationTemplateRequest>(GetServiceRequestName(), *this);
    }
