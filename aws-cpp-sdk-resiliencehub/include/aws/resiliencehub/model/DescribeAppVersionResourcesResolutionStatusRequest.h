...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeAppVersionResourcesResolutionStatusRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeAppVersionResourcesResolutionStatusRequest>(GetServiceRequestName(), *this);
    }
