...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AddDraftAppVersionResourceMappingsRequest> Clone() const
    {
      return Aws::MakeUnique<AddDraftAppVersionResourceMappingsRequest>(GetServiceRequestName(), *this);
    }
