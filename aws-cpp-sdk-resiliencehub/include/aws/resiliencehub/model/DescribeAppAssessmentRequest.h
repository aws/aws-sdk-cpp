...
namespace Model
{
  ...
  /**
   */
  class AWS_RESILIENCEHUB_API DescribeAppAssessmentRequest : public ResilienceHubRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeAppAssessmentRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeAppAssessmentRequest>(GetServiceRequestName(), *this);
    }
