...
namespace Model
{
  ...
  /**
   */
  class AWS_RESILIENCEHUB_API DeleteRecommendationTemplateRequest : public ResilienceHubRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteRecommendationTemplateRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteRecommendationTemplateRequest>(GetServiceRequestName(), *this);
    }
