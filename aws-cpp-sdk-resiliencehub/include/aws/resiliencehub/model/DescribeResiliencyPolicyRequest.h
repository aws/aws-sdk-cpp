...
namespace Model
{
  ...
  /**
   */
  class AWS_RESILIENCEHUB_API DescribeResiliencyPolicyRequest : public ResilienceHubRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeResiliencyPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeResiliencyPolicyRequest>(GetServiceRequestName(), *this);
    }
