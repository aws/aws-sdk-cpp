...
namespace Model
{
  ...
  /**
   */
  class AWS_RESILIENCEHUB_API ListResiliencyPoliciesRequest : public ResilienceHubRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListResiliencyPoliciesRequest> Clone() const
    {
      return Aws::MakeUnique<ListResiliencyPoliciesRequest>(GetServiceRequestName(), *this);
    }
