...
namespace Model
{
  ...
  /**
   */
  class AWS_RESILIENCEHUB_API ListAlarmRecommendationsRequest : public ResilienceHubRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListAlarmRecommendationsRequest> Clone() const
    {
      return Aws::MakeUnique<ListAlarmRecommendationsRequest>(GetServiceRequestName(), *this);
    }
