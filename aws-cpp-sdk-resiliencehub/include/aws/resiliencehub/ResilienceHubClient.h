...
namespace ResilienceHub
{
  ...
  class AWS_RESILIENCEHUB_API ResilienceHubClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        ResilienceHubClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                            std::shared_ptr<Endpoint::ResilienceHubEndpointProvider> endpointProvider = Aws::MakeShared<ResilienceHub::Endpoint::ResilienceHubEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::ResilienceHubEndpointProvider> m_endpointProvider;
  };
