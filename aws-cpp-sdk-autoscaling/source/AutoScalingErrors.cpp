...
static const int RESOURCE_IN_USE_FAULT_HASH = HashingUtils::HashString("ResourceInUseFault");
static const int INVALID_NEXT_TOKEN_HASH = HashingUtils::HashString("InvalidNextToken");
static const int SCALING_ACTIVITY_IN_PROGRESS_FAULT_HASH = HashingUtils::HashString("ScalingActivityInProgressFault");
static const int RESOURCE_CONTENTION_FAULT_HASH = HashingUtils::HashString("ResourceContentionFault");
static const int LIMIT_EXCEEDED_FAULT_HASH = HashingUtils::HashString("LimitExceededFault");
static const int ALREADY_EXISTS_FAULT_HASH = HashingUtils::HashString("AlreadyExistsFault");
