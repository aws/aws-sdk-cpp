...
Aws::String AutoScalingEndpointRules::GetRulesAsString()
{
    return Aws::String(AutoScalingEndpointRules::Rules.begin(), AutoScalingEndpointRules::Rules.end());
}

const Aws::Vector<char> AutoScalingEndpointRules::Rules = {
...
'a','l','i','n','g','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t',
...
't','t','p','s',':','/','/','a','u','t','o','s','c','a','l','i','n','g','.','{','R','e','g','i','o',
...
'a','u','t','o','s','c','a','l','i','n','g','-','f','i','p','s','.','{','R','e','g','i','o','n','}',
...
'i','n','g','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R','e',
