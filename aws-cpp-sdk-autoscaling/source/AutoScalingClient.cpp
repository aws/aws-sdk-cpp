...
using ResolveEndpointOutcome = Aws::AutoScaling::Endpoint::AutoScalingEndpointProvider::AutoScalingResolveEndpointOutcome;
...
AutoScalingClient::AutoScalingClient(const Client::ClientConfiguration& clientConfiguration,
                                     std::shared_ptr<Endpoint::AutoScalingEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<AutoScalingErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<AutoScaling::Endpoint::AutoScalingEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
