...
LoadBalancerStateType::LoadBalancerStateType(const XmlNode& xmlNode) : 
    m_loadBalancerNameHasBeenSet(false),
    m_stateHasBeenSet(false)
{
  *this = xmlNode;
...
LoadBalancerStateType& LoadBalancerStateType::operator =(const XmlNode& xmlNode)
{
...
void LoadBalancerStateType::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const
{
...
void LoadBalancerStateType::OutputToStream(Aws::OStream& oStream, const char* location) const
{
  if(m_loadBalancerNameHasBeenSet)
  {
