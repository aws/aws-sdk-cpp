...
AttachLoadBalancersResult::AttachLoadBalancersResult(const AmazonWebServiceResult<XmlDocument>& result)
{
  *this = result;
}
...
AttachLoadBalancersResult& AttachLoadBalancersResult::operator =(const AmazonWebServiceResult<XmlDocument>& result)
{
  ...
  XmlNode resultNode = rootNode.FirstChild("AttachLoadBalancersResult");
