...
PredictiveScalingCustomizedScalingMetric& PredictiveScalingCustomizedScalingMetric::operator =(const XmlNode& xmlNode)
{
...
void PredictiveScalingCustomizedScalingMetric::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const
{
...
void PredictiveScalingCustomizedScalingMetric::OutputToStream(Aws::OStream& oStream, const char* location) const
{
  if(m_metricDataQueriesHasBeenSet)
  {
      unsigned metricDataQueriesIdx = 1;
