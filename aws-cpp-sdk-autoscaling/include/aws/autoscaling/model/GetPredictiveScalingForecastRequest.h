...
namespace Model
{
  ...
  /**
   */
  class AWS_AUTOSCALING_API GetPredictiveScalingForecastRequest : public AutoScalingRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetPredictiveScalingForecastRequest> Clone() const
    {
      return Aws::MakeUnique<GetPredictiveScalingForecastRequest>(GetServiceRequestName(), *this);
    }
