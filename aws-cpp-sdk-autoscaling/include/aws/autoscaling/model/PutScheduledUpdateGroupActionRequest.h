...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>This parameter is deprecated; use <code>StartTime</code> instead.</p> <p>The
     * time for this action to start. If both <code>Time</code> and
     * <code>StartTime</code> are specified, their values must be identical.</p>
     */
