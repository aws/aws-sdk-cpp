...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PutScheduledUpdateGroupActionRequest> Clone() const
    {
      return Aws::MakeUnique<PutScheduledUpdateGroupActionRequest>(GetServiceRequestName(), *this);
    }
