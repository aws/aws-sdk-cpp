...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_AUTOSCALING_API VCpuCountRequest
  {
  public:
    VCpuCountRequest();
    VCpuCountRequest(const Aws::Utils::Xml::XmlNode& xmlNode);
    VCpuCountRequest& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
