...
namespace Model
{
  ...
  public:
     ...
     * suppose that you create a step scaling policy to scale out an Auto Scaling group
     * by 25 percent and you specify a <code>MinAdjustmentMagnitude</code> of 2. If the
     * group has 4 instances and the scaling policy is performed, 25 percent of 4 is 1.
     * However, because you specified a <code>MinAdjustmentMagnitude</code> of 2,
     * Amazon EC2 Auto Scaling scales out the group by 2 instances. </p> <p>Valid only
     * if the policy type is <code>StepScaling</code> or <code>SimpleScaling</code> and
     * the adjustment type is <code>PercentChangeInCapacity</code>. For more
     * information, see <a
     * href="https://docs.aws.amazon.com/autoscaling/ec2/userguide/as-scaling-simple-step.html#as-scaling-adjustment">Scaling
     * Adjustment Types</a> in the <i>Amazon EC2 Auto Scaling User Guide</i>.</p>
     */
