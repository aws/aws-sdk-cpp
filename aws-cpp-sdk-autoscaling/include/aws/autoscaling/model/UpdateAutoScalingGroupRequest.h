...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>The type of health check for the instances in the Auto Scaling group. The
     * health check type can either be <code>EC2</code> for Amazon EC2 or
     * <code>ELB</code> for Elastic Load Balancing. </p>
     */
