...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_AUTOSCALING_API MetricDimension
  {
  public:
    MetricDimension();
    MetricDimension(const Aws::Utils::Xml::XmlNode& xmlNode);
    MetricDimension& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
