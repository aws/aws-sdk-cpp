...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<TerminateInstanceInAutoScalingGroupRequest> Clone() const
    {
      return Aws::MakeUnique<TerminateInstanceInAutoScalingGroupRequest>(GetServiceRequestName(), *this);
    }
