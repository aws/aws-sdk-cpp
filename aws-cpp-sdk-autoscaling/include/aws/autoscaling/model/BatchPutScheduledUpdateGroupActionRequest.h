...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchPutScheduledUpdateGroupActionRequest> Clone() const
    {
      return Aws::MakeUnique<BatchPutScheduledUpdateGroupActionRequest>(GetServiceRequestName(), *this);
    }
