...
namespace Model
{
  ...
  /**
   */
  class AWS_AUTOSCALING_API CancelInstanceRefreshRequest : public AutoScalingRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CancelInstanceRefreshRequest> Clone() const
    {
      return Aws::MakeUnique<CancelInstanceRefreshRequest>(GetServiceRequestName(), *this);
    }
