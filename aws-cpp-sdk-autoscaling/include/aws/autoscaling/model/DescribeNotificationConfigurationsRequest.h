...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeNotificationConfigurationsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeNotificationConfigurationsRequest>(GetServiceRequestName(), *this);
    }
