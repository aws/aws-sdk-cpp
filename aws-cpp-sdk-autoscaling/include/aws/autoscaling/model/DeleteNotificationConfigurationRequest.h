...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteNotificationConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteNotificationConfigurationRequest>(GetServiceRequestName(), *this);
    }
