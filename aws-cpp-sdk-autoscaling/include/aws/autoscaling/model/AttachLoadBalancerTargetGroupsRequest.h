...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AttachLoadBalancerTargetGroupsRequest> Clone() const
    {
      return Aws::MakeUnique<AttachLoadBalancerTargetGroupsRequest>(GetServiceRequestName(), *this);
    }
