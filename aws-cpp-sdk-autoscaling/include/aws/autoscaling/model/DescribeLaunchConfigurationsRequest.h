...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeLaunchConfigurationsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeLaunchConfigurationsRequest>(GetServiceRequestName(), *this);
    }
