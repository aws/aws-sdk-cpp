...
namespace Model
{
  ...
  /**
   */
  class AWS_AUTOSCALING_API DescribeInstanceRefreshesRequest : public AutoScalingRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeInstanceRefreshesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeInstanceRefreshesRequest>(GetServiceRequestName(), *this);
    }
