...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PutNotificationConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<PutNotificationConfigurationRequest>(GetServiceRequestName(), *this);
    }
