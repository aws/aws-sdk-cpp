...
namespace Model
{
  ...
  public:
    ...
    inline virtual const char* GetServiceRequestName() override { return "PutLifecycleHook"; }
  ...
  public:
     ...
     * hour).</p> <p>If the lifecycle hook times out, Auto Scaling performs the default
