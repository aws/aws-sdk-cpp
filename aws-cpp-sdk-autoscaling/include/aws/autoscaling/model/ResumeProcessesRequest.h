...
namespace Model
{
  ...
  /**
   */
  class AWS_AUTOSCALING_API ResumeProcessesRequest : public AutoScalingRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ResumeProcessesRequest> Clone() const
    {
      return Aws::MakeUnique<ResumeProcessesRequest>(GetServiceRequestName(), *this);
    }
