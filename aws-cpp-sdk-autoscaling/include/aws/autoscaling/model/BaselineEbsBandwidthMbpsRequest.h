...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_AUTOSCALING_API BaselineEbsBandwidthMbpsRequest
  {
  public:
    BaselineEbsBandwidthMbpsRequest();
    BaselineEbsBandwidthMbpsRequest(const Aws::Utils::Xml::XmlNode& xmlNode);
    BaselineEbsBandwidthMbpsRequest& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
