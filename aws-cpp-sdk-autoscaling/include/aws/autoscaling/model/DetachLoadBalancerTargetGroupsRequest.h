...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DetachLoadBalancerTargetGroupsRequest> Clone() const
    {
      return Aws::MakeUnique<DetachLoadBalancerTargetGroupsRequest>(GetServiceRequestName(), *this);
    }
