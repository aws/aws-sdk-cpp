...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeLoadBalancerTargetGroupsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeLoadBalancerTargetGroupsRequest>(GetServiceRequestName(), *this);
    }
