...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeAutoScalingInstancesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeAutoScalingInstancesRequest>(GetServiceRequestName(), *this);
    }
