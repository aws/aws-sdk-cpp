...
namespace Model
{
   ...
   * match all of the specified filters. </p> <p>For more information, see <a
  ...
  public:
     ...
     * on the API operation that you are including the filter in,
     ...
     * keys. The results will only include information about the Auto Scaling groups
     * associated with these tag keys. </p> </li> <li> <p> <code>tag-value</code> -
     * Accepts tag values. The results will only include information about the Auto
     * Scaling groups associated with these tag values. </p> </li> <li> <p>
     ...
     * results will only include information about the Auto Scaling groups associated
     * with the specified key/value combination. </p> </li> </ul> <p>
     * <b>DescribeTags</b> </p> <p>Valid values for <code>Name</code> include the
     * following: </p> <ul> <li> <p> <code>auto-scaling-group</code> - Accepts the
     * names of Auto Scaling groups. The results will only include information about
     * the tags associated with these Auto Scaling groups. </p> </li> <li> <p>
     * <code>key</code> - Accepts tag keys. The results will only include information
     * about the tags associated with these tag keys. </p> </li> <li> <p>
     * <code>value</code> - Accepts tag values. The results will only include
     * information about the tags associated with these tag values. </p> </li> <li> <p>
     ...
     * specified values. For example, specify "tag:environment" for the filter name and
     * "production,development" for the filter values to find Auto Scaling groups with
     * the tag "environment=production" or "environment=development".</p>
     */
