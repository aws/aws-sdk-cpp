...
{
  /**
   * <p>Contains the output of DetachInstances.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/autoscaling-2011-01-01/DetachInstancesAnswer">AWS
   * API Reference</a></p>
   */
