...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<RecordLifecycleActionHeartbeatRequest> Clone() const
    {
      return Aws::MakeUnique<RecordLifecycleActionHeartbeatRequest>(GetServiceRequestName(), *this);
    }
