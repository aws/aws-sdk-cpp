...
{
  /**
   * <p>Contains the output of DescribeAutoScalingNotificationTypes.</p><p><h3>See
   * Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/autoscaling-2011-01-01/DescribeAutoScalingNotificationTypesAnswer">AWS
   * API Reference</a></p>
   */
