...
namespace Model
{
  ...
  /**
   */
  class AWS_AUTOSCALING_API DeleteWarmPoolRequest : public AutoScalingRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteWarmPoolRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteWarmPoolRequest>(GetServiceRequestName(), *this);
    }
