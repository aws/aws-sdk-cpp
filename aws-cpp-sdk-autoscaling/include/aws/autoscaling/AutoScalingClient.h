...
namespace AutoScaling
{
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        AutoScalingClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                          std::shared_ptr<Endpoint::AutoScalingEndpointProvider> endpointProvider = Aws::MakeShared<AutoScaling::Endpoint::AutoScalingEndpointProvider>(ALLOCATION_TAG));
  ...
  private:
        ...
        std::shared_ptr<Endpoint::AutoScalingEndpointProvider> m_endpointProvider;
  };
