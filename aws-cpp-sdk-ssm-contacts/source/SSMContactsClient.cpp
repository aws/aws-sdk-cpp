...
using ResolveEndpointOutcome = Aws::SSMContacts::Endpoint::SSMContactsEndpointProvider::SSMContactsResolveEndpointOutcome;
...
SSMContactsClient::SSMContactsClient(const Client::ClientConfiguration& clientConfiguration,
                                     std::shared_ptr<Endpoint::SSMContactsEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<SSMContactsErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<SSMContacts::Endpoint::SSMContactsEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
