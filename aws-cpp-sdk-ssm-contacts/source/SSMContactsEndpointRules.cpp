...
Aws::String SSMContactsEndpointRules::GetRulesAsString()
{
    return Aws::String(SSMContactsEndpointRules::Rules.begin(), SSMContactsEndpointRules::Rules.end());
}

const Aws::Vector<char> SSMContactsEndpointRules::Rules = {
