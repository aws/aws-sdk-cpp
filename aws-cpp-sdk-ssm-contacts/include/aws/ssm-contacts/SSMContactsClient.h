...
namespace SSMContacts
{
  ...
  class AWS_SSMCONTACTS_API SSMContactsClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        SSMContactsClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                          std::shared_ptr<Endpoint::SSMContactsEndpointProvider> endpointProvider = Aws::MakeShared<SSMContacts::Endpoint::SSMContactsEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::SSMContactsEndpointProvider> m_endpointProvider;
  };
