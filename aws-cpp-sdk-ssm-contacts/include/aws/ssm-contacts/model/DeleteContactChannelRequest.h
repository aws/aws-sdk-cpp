...
namespace Model
{
  ...
  /**
   */
  class AWS_SSMCONTACTS_API DeleteContactChannelRequest : public SSMContactsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteContactChannelRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteContactChannelRequest>(GetServiceRequestName(), *this);
    }
