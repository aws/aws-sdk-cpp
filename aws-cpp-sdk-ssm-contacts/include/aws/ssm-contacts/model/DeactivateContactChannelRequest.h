...
namespace Model
{
  ...
  /**
   */
  class AWS_SSMCONTACTS_API DeactivateContactChannelRequest : public SSMContactsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeactivateContactChannelRequest> Clone() const
    {
      return Aws::MakeUnique<DeactivateContactChannelRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "DeactivateContactChannel"; }
