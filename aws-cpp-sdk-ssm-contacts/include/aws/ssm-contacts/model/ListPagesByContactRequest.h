...
namespace Model
{
  ...
  /**
   */
  class AWS_SSMCONTACTS_API ListPagesByContactRequest : public SSMContactsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListPagesByContactRequest> Clone() const
    {
      return Aws::MakeUnique<ListPagesByContactRequest>(GetServiceRequestName(), *this);
    }
