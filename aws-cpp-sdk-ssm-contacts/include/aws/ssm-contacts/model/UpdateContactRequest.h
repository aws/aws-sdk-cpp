...
namespace Model
{
  ...
  /**
   */
  class AWS_SSMCONTACTS_API UpdateContactRequest : public SSMContactsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateContactRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateContactRequest>(GetServiceRequestName(), *this);
    }
