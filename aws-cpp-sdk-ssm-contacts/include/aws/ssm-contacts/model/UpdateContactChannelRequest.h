...
namespace Model
{
  ...
  /**
   */
  class AWS_SSMCONTACTS_API UpdateContactChannelRequest : public SSMContactsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateContactChannelRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateContactChannelRequest>(GetServiceRequestName(), *this);
    }
