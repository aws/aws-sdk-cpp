...
namespace Model
{
  ...
  /**
   */
  class AWS_SSMCONTACTS_API ListPagesByEngagementRequest : public SSMContactsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListPagesByEngagementRequest> Clone() const
    {
      return Aws::MakeUnique<ListPagesByEngagementRequest>(GetServiceRequestName(), *this);
    }
