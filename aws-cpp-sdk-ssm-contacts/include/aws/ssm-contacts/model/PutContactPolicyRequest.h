...
namespace Model
{
  ...
  /**
   */
  class AWS_SSMCONTACTS_API PutContactPolicyRequest : public SSMContactsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutContactPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<PutContactPolicyRequest>(GetServiceRequestName(), *this);
    }
