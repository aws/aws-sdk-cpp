...
namespace Model
{
  ...
  /**
   */
  class AWS_SSMCONTACTS_API GetContactPolicyRequest : public SSMContactsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetContactPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<GetContactPolicyRequest>(GetServiceRequestName(), *this);
    }
