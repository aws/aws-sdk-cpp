...
namespace Model
{
  ...
  /**
   */
  class AWS_SSMCONTACTS_API GetContactRequest : public SSMContactsRequest
  {
  public:
    GetContactRequest();
    ...
    */
    virtual Aws::UniquePtr<GetContactRequest> Clone() const
    {
      return Aws::MakeUnique<GetContactRequest>(GetServiceRequestName(), *this);
    }
