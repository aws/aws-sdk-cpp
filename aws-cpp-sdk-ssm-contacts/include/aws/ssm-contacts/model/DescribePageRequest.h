...
namespace Model
{
  ...
  /**
   */
  class AWS_SSMCONTACTS_API DescribePageRequest : public SSMContactsRequest
  {
  public:
    DescribePageRequest();
    ...
    */
    virtual Aws::UniquePtr<DescribePageRequest> Clone() const
    {
      return Aws::MakeUnique<DescribePageRequest>(GetServiceRequestName(), *this);
    }
