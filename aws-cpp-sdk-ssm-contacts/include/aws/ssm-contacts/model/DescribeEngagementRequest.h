...
namespace Model
{
  ...
  /**
   */
  class AWS_SSMCONTACTS_API DescribeEngagementRequest : public SSMContactsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeEngagementRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeEngagementRequest>(GetServiceRequestName(), *this);
    }
