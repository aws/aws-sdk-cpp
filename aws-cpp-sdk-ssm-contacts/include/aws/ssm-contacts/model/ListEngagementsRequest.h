...
namespace Model
{
  ...
  /**
   */
  class AWS_SSMCONTACTS_API ListEngagementsRequest : public SSMContactsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListEngagementsRequest> Clone() const
    {
      return Aws::MakeUnique<ListEngagementsRequest>(GetServiceRequestName(), *this);
    }
