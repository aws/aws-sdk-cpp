...
namespace Model
{
  ...
  /**
   */
  class AWS_SSMCONTACTS_API ListPageReceiptsRequest : public SSMContactsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListPageReceiptsRequest> Clone() const
    {
      return Aws::MakeUnique<ListPageReceiptsRequest>(GetServiceRequestName(), *this);
    }
