...
namespace Model
{
  ...
  /**
   */
  class AWS_SSMCONTACTS_API CreateContactChannelRequest : public SSMContactsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateContactChannelRequest> Clone() const
    {
      return Aws::MakeUnique<CreateContactChannelRequest>(GetServiceRequestName(), *this);
    }
