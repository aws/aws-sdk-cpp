...
public:
  ...
  SSMContactsError(const Aws::Client::AWSError<SSMContactsErrors>& rhs) : Aws::Client::AWSError<SSMContactsErrors>(rhs) {}
  SSMContactsError(Aws::Client::AWSError<SSMContactsErrors>&& rhs) : Aws::Client::AWSError<SSMContactsErrors>(rhs) {}
