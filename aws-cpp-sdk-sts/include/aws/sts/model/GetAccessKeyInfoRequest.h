...
namespace Model
{
  ...
  /**
   */
  class AWS_STS_API GetAccessKeyInfoRequest : public STSRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetAccessKeyInfoRequest> Clone() const
    {
      return Aws::MakeUnique<GetAccessKeyInfoRequest>(GetServiceRequestName(), *this);
    }
