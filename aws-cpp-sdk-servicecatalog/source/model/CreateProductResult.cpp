...
CreateProductResult::CreateProductResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

CreateProductResult& CreateProductResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
