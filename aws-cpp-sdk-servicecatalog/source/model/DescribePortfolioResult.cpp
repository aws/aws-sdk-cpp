...
DescribePortfolioResult::DescribePortfolioResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

DescribePortfolioResult& DescribePortfolioResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
