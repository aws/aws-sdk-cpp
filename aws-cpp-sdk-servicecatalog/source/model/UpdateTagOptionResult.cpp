...
UpdateTagOptionResult::UpdateTagOptionResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

UpdateTagOptionResult& UpdateTagOptionResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
