...
ListTagOptionsResult::ListTagOptionsResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListTagOptionsResult& ListTagOptionsResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
