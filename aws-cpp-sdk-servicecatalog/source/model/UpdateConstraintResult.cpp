...
UpdateConstraintResult::UpdateConstraintResult(const AmazonWebServiceResult<JsonValue>& result) : 
    m_status(Status::NOT_SET)
{
  *this = result;
}

UpdateConstraintResult& UpdateConstraintResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
