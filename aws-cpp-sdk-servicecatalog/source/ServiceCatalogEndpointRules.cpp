...
Aws::String ServiceCatalogEndpointRules::GetRulesAsString()
{
    return Aws::String(ServiceCatalogEndpointRules::Rules.begin(), ServiceCatalogEndpointRules::Rules.end());
}

const Aws::Vector<char> ServiceCatalogEndpointRules::Rules = {
...
't','t','p','s',':','/','/','s','e','r','v','i','c','e','c','a','t','a','l','o','g','-','f','i','p',
...
'p','s',':','/','/','s','e','r','v','i','c','e','c','a','t','a','l','o','g','.','{','R','e','g','i',
