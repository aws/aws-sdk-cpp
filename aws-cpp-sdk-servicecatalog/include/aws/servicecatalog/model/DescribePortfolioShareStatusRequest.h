...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribePortfolioShareStatusRequest> Clone() const
    {
      return Aws::MakeUnique<DescribePortfolioShareStatusRequest>(GetServiceRequestName(), *this);
    }
