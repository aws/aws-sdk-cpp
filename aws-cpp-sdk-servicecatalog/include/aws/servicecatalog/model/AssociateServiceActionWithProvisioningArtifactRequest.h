...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateServiceActionWithProvisioningArtifactRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateServiceActionWithProvisioningArtifactRequest>(GetServiceRequestName(), *this);
    }
