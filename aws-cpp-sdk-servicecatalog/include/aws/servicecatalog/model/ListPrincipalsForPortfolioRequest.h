...
namespace Model
{
  ...
  /**
   */
  class AWS_SERVICECATALOG_API ListPrincipalsForPortfolioRequest : public ServiceCatalogRequest
  {
  public:
     ...
     * <p>If no code is specified, "en" is used as the default.</p>
     */
    inline ListPrincipalsForPortfolioRequest& WithAcceptLanguage(Aws::String&& value) { SetAcceptLanguage(value); return *this;}
     ...
     * <p>The portfolio identifier.</p>
     */
    inline ListPrincipalsForPortfolioRequest& WithPortfolioId(Aws::String&& value) { SetPortfolioId(value); return *this;}
     ...
     * page of size <code>PageSize</code>.</p>
     */
    inline ListPrincipalsForPortfolioRequest& WithPageToken(Aws::String&& value) { SetPageToken(value); return *this;}
