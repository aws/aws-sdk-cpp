...
namespace Model
{
   ...
   * without a stack��for example, if the stack couldn't be created for some reason.
   * A stack instance is associated with only one stack set. Each stack instance
