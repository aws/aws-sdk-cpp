...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeServiceActionExecutionParametersRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeServiceActionExecutionParametersRequest>(GetServiceRequestName(), *this);
    }
