...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetAWSOrganizationsAccessStatusRequest> Clone() const
    {
      return Aws::MakeUnique<GetAWSOrganizationsAccessStatusRequest>(GetServiceRequestName(), *this);
    }
