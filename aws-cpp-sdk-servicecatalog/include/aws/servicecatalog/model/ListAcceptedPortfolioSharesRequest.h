...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListAcceptedPortfolioSharesRequest> Clone() const
    {
      return Aws::MakeUnique<ListAcceptedPortfolioSharesRequest>(GetServiceRequestName(), *this);
    }
