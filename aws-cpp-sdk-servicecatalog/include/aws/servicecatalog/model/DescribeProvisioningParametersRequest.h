...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeProvisioningParametersRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeProvisioningParametersRequest>(GetServiceRequestName(), *this);
    }
