...
namespace Model
{
  ...
  public:
     ...
     * <p>If no code is specified, "en" is used as the default.</p>
     */
    inline DescribeProductAsAdminRequest& WithAcceptLanguage(Aws::String&& value) { SetAcceptLanguage(value); return *this;}
     ...
     * <p>The identifier of the product for which to retrieve information.</p>
     */
    inline DescribeProductAsAdminRequest& WithId(Aws::String&& value) { SetId(value); return *this;}
