...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateProductWithPortfolioRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateProductWithPortfolioRequest>(GetServiceRequestName(), *this);
    }
