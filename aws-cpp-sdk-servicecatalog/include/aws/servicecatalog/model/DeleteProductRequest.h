...
namespace Model
{
  ...
  public:
     ...
     * <p>If no code is specified, "en" is used as the default.</p>
     */
    inline DeleteProductRequest& WithAcceptLanguage(Aws::String&& value) { SetAcceptLanguage(value); return *this;}
     ...
     * <p>The identifier of the product for the delete request.</p>
     */
    inline DeleteProductRequest& WithId(Aws::String&& value) { SetId(value); return *this;}
