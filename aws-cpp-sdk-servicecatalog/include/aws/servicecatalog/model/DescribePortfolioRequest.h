...
namespace Model
{
  ...
  public:
     ...
     * <p>If no code is specified, "en" is used as the default.</p>
     */
    inline DescribePortfolioRequest& WithAcceptLanguage(Aws::String&& value) { SetAcceptLanguage(value); return *this;}
     ...
     * <p>The identifier of the portfolio for which to retrieve information.</p>
     */
    inline DescribePortfolioRequest& WithId(Aws::String&& value) { SetId(value); return *this;}
