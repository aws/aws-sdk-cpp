...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateBudgetWithResourceRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateBudgetWithResourceRequest>(GetServiceRequestName(), *this);
    }
