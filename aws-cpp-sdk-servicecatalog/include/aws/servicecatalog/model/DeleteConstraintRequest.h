...
namespace Model
{
  ...
  public:
     ...
     * <p>If no code is specified, "en" is used as the default.</p>
     */
    inline DeleteConstraintRequest& WithAcceptLanguage(Aws::String&& value) { SetAcceptLanguage(value); return *this;}
     ...
     * <p>The identifier of the constraint to delete.</p>
     */
    inline DeleteConstraintRequest& WithId(Aws::String&& value) { SetId(value); return *this;}
