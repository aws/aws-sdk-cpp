...
namespace Model
{
  ...
  /**
   */
  class AWS_SERVICECATALOG_API ListBudgetsForResourceRequest : public ServiceCatalogRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListBudgetsForResourceRequest> Clone() const
    {
      return Aws::MakeUnique<ListBudgetsForResourceRequest>(GetServiceRequestName(), *this);
    }
