...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateProductFromPortfolioRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateProductFromPortfolioRequest>(GetServiceRequestName(), *this);
    }
