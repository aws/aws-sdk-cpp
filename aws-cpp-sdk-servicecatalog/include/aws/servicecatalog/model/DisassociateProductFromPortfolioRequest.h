...
namespace Model
{
  ...
  public:
     ...
     * <p>If no code is specified, "en" is used as the default.</p>
     */
    inline DisassociateProductFromPortfolioRequest& WithAcceptLanguage(Aws::String&& value) { SetAcceptLanguage(value); return *this;}
     ...
     * <p>The product identifier.</p>
     */
    inline DisassociateProductFromPortfolioRequest& WithProductId(Aws::String&& value) { SetProductId(value); return *this;}
     ...
     * <p>The portfolio identifier.</p>
     */
    inline DisassociateProductFromPortfolioRequest& WithPortfolioId(Aws::String&& value) { SetPortfolioId(value); return *this;}
