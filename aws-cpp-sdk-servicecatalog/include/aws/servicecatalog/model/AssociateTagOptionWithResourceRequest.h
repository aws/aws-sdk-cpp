...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateTagOptionWithResourceRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateTagOptionWithResourceRequest>(GetServiceRequestName(), *this);
    }
