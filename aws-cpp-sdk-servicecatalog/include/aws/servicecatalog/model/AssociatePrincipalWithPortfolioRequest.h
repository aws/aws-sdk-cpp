...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociatePrincipalWithPortfolioRequest> Clone() const
    {
      return Aws::MakeUnique<AssociatePrincipalWithPortfolioRequest>(GetServiceRequestName(), *this);
    }
