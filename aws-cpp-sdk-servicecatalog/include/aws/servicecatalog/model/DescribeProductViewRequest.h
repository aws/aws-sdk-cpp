...
namespace Model
{
  ...
  public:
     ...
     * <p>If no code is specified, "en" is used as the default.</p>
     */
    inline DescribeProductViewRequest& WithAcceptLanguage(Aws::String&& value) { SetAcceptLanguage(value); return *this;}
     ...
     * <p>The <code>ProductViewId</code> of the product to describe.</p>
     */
    inline DescribeProductViewRequest& WithId(Aws::String&& value) { SetId(value); return *this;}
