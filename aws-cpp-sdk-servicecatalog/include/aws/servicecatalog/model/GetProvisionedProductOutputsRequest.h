...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetProvisionedProductOutputsRequest> Clone() const
    {
      return Aws::MakeUnique<GetProvisionedProductOutputsRequest>(GetServiceRequestName(), *this);
    }
