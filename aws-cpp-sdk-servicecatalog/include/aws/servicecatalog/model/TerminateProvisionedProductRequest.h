...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<TerminateProvisionedProductRequest> Clone() const
    {
      return Aws::MakeUnique<TerminateProvisionedProductRequest>(GetServiceRequestName(), *this);
    }
