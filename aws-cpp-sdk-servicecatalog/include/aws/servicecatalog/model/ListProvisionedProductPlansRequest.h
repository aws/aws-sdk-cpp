...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListProvisionedProductPlansRequest> Clone() const
    {
      return Aws::MakeUnique<ListProvisionedProductPlansRequest>(GetServiceRequestName(), *this);
    }
