...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeProvisionedProductPlanRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeProvisionedProductPlanRequest>(GetServiceRequestName(), *this);
    }
