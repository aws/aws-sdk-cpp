...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchDisassociateServiceActionFromProvisioningArtifactRequest> Clone() const
    {
      return Aws::MakeUnique<BatchDisassociateServiceActionFromProvisioningArtifactRequest>(GetServiceRequestName(), *this);
    }
