...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DisableAWSOrganizationsAccessRequest> Clone() const
    {
      return Aws::MakeUnique<DisableAWSOrganizationsAccessRequest>(GetServiceRequestName(), *this);
    }
