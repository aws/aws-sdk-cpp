...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateTagOptionFromResourceRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateTagOptionFromResourceRequest>(GetServiceRequestName(), *this);
    }
