...
namespace Model
{
  ...
  public:
     ...
     * <p>If no code is specified, "en" is used as the default.</p>
     */
    inline RejectPortfolioShareRequest& WithAcceptLanguage(Aws::String&& value) { SetAcceptLanguage(value); return *this;}
     ...
     * <p>The portfolio identifier.</p>
     */
    inline RejectPortfolioShareRequest& WithPortfolioId(Aws::String&& value) { SetPortfolioId(value); return *this;}
