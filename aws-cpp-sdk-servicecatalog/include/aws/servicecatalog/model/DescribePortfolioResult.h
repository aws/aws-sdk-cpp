...
namespace Model
{
  ...
  public:
     ...
     * <p>Detailed portfolio information.</p>
     */
    inline DescribePortfolioResult& WithPortfolioDetail(PortfolioDetail&& value) { SetPortfolioDetail(value); return *this;}
     ...
     * <p>Tags associated with the portfolio.</p>
     */
    inline DescribePortfolioResult& WithTags(Aws::Vector<Tag>&& value) { SetTags(value); return *this;}
     ...
     * <p>Tags associated with the portfolio.</p>
     */
    inline DescribePortfolioResult& AddTags(Tag&& value) { m_tags.push_back(value); return *this; }
