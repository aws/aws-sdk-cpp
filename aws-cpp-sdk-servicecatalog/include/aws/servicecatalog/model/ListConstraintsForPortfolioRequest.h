...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListConstraintsForPortfolioRequest> Clone() const
    {
      return Aws::MakeUnique<ListConstraintsForPortfolioRequest>(GetServiceRequestName(), *this);
    }
