...
namespace Model
{
  ...
  /**
   */
  class AWS_SERVICECATALOG_API ListStackInstancesForProvisionedProductRequest : public ServiceCatalogRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListStackInstancesForProvisionedProductRequest> Clone() const
    {
      return Aws::MakeUnique<ListStackInstancesForProvisionedProductRequest>(GetServiceRequestName(), *this);
    }
