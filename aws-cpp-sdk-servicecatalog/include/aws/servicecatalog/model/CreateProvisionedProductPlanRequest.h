...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateProvisionedProductPlanRequest> Clone() const
    {
      return Aws::MakeUnique<CreateProvisionedProductPlanRequest>(GetServiceRequestName(), *this);
    }
