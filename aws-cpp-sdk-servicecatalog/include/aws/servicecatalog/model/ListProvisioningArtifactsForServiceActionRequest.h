...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListProvisioningArtifactsForServiceActionRequest> Clone() const
    {
      return Aws::MakeUnique<ListProvisioningArtifactsForServiceActionRequest>(GetServiceRequestName(), *this);
    }
