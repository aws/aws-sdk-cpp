...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateProvisionedProductPropertiesRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateProvisionedProductPropertiesRequest>(GetServiceRequestName(), *this);
    }
