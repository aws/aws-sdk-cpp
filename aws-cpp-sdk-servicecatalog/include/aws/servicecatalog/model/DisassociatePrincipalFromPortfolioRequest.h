...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociatePrincipalFromPortfolioRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociatePrincipalFromPortfolioRequest>(GetServiceRequestName(), *this);
    }
