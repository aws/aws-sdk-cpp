...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteProvisionedProductPlanRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteProvisionedProductPlanRequest>(GetServiceRequestName(), *this);
    }
