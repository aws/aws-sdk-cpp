...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListOrganizationPortfolioAccessRequest> Clone() const
    {
      return Aws::MakeUnique<ListOrganizationPortfolioAccessRequest>(GetServiceRequestName(), *this);
    }
