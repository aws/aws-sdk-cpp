...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateServiceActionFromProvisioningArtifactRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateServiceActionFromProvisioningArtifactRequest>(GetServiceRequestName(), *this);
    }
