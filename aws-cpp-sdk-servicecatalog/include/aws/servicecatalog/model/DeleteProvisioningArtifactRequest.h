...
namespace Model
{
  ...
  public:
     ...
     * <p>If no code is specified, "en" is used as the default.</p>
     */
    inline DeleteProvisioningArtifactRequest& WithAcceptLanguage(Aws::String&& value) { SetAcceptLanguage(value); return *this;}
     ...
     * <p>The product identifier.</p>
     */
    inline DeleteProvisioningArtifactRequest& WithProductId(Aws::String&& value) { SetProductId(value); return *this;}
    ...
    /**
     * <p>The identifier of the provisioning artifact for the delete request.</p>
     */
     ...
     * <p>The identifier of the provisioning artifact for the delete request.</p>
     */
    inline DeleteProvisioningArtifactRequest& WithProvisioningArtifactId(Aws::String&& value) { SetProvisioningArtifactId(value); return *this;}
