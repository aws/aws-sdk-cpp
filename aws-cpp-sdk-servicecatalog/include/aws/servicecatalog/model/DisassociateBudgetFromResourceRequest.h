...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateBudgetFromResourceRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateBudgetFromResourceRequest>(GetServiceRequestName(), *this);
    }
