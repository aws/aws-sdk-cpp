...
namespace Model
{
  ...
  public:
    ...
    ListPortfoliosForProductResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ListPortfoliosForProductResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
     ...
     * <p>List of detailed portfolio information objects.</p>
     */
    inline ListPortfoliosForProductResult& WithPortfolioDetails(Aws::Vector<PortfolioDetail>&& value) { SetPortfolioDetails(value); return *this;}
     ...
     * <p>List of detailed portfolio information objects.</p>
     */
    inline ListPortfoliosForProductResult& AddPortfolioDetails(PortfolioDetail&& value) { m_portfolioDetails.push_back(value); return *this; }
     ...
     * operation. If there are no more pages, this value is null.</p>
     */
    inline ListPortfoliosForProductResult& WithNextPageToken(Aws::String&& value) { SetNextPageToken(value); return *this;}
