...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ExecuteProvisionedProductServiceActionRequest> Clone() const
    {
      return Aws::MakeUnique<ExecuteProvisionedProductServiceActionRequest>(GetServiceRequestName(), *this);
    }
