...
namespace Model
{
  ...
  /**
   */
  class AWS_SERVICECATALOG_API ExecuteProvisionedProductPlanRequest : public ServiceCatalogRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ExecuteProvisionedProductPlanRequest> Clone() const
    {
      return Aws::MakeUnique<ExecuteProvisionedProductPlanRequest>(GetServiceRequestName(), *this);
    }
