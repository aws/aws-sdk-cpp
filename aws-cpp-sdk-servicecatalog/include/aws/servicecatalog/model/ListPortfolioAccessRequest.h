...
namespace Model
{
  ...
  /**
   */
  class AWS_SERVICECATALOG_API ListPortfolioAccessRequest : public ServiceCatalogRequest
  {
  public:
     ...
     * <p>If no code is specified, "en" is used as the default.</p>
     */
    inline ListPortfolioAccessRequest& WithAcceptLanguage(Aws::String&& value) { SetAcceptLanguage(value); return *this;}
     ...
     * <p>The portfolio identifier.</p>
     */
    inline ListPortfolioAccessRequest& WithPortfolioId(Aws::String&& value) { SetPortfolioId(value); return *this;}
