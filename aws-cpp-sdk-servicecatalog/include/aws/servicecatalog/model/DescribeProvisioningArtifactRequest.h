...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeProvisioningArtifactRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeProvisioningArtifactRequest>(GetServiceRequestName(), *this);
    }
