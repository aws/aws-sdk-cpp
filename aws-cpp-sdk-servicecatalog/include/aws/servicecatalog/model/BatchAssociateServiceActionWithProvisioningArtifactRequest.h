...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchAssociateServiceActionWithProvisioningArtifactRequest> Clone() const
    {
      return Aws::MakeUnique<BatchAssociateServiceActionWithProvisioningArtifactRequest>(GetServiceRequestName(), *this);
    }
