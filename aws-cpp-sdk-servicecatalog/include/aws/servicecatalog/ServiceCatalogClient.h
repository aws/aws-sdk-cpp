...
namespace ServiceCatalog
{
  ...
  class AWS_SERVICECATALOG_API ServiceCatalogClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        ServiceCatalogClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                             std::shared_ptr<Endpoint::ServiceCatalogEndpointProvider> endpointProvider = Aws::MakeShared<ServiceCatalog::Endpoint::ServiceCatalogEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::ServiceCatalogEndpointProvider> m_endpointProvider;
  };
