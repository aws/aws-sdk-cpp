...
using ResolveEndpointOutcome = Aws::Inspector2::Endpoint::Inspector2EndpointProvider::Inspector2ResolveEndpointOutcome;
...
Inspector2Client::Inspector2Client(const Client::ClientConfiguration& clientConfiguration,
                                   std::shared_ptr<Endpoint::Inspector2EndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<Inspector2ErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<Inspector2::Endpoint::Inspector2EndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
