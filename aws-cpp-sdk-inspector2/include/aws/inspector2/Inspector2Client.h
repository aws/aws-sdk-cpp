...
namespace Inspector2
{
  ...
  class AWS_INSPECTOR2_API Inspector2Client : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        Inspector2Client(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                         std::shared_ptr<Endpoint::Inspector2EndpointProvider> endpointProvider = Aws::MakeShared<Inspector2::Endpoint::Inspector2EndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::Inspector2EndpointProvider> m_endpointProvider;
  };
