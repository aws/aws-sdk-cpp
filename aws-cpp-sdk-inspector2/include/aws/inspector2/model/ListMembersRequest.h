...
namespace Model
{
  ...
  /**
   */
  class AWS_INSPECTOR2_API ListMembersRequest : public Inspector2Request
  {
  public:
    ListMembersRequest();
    ...
    */
    virtual Aws::UniquePtr<ListMembersRequest> Clone() const
    {
      return Aws::MakeUnique<ListMembersRequest>(GetServiceRequestName(), *this);
    }
