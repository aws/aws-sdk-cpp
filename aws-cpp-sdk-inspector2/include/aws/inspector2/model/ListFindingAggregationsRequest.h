...
namespace Model
{
  ...
  /**
   */
  class AWS_INSPECTOR2_API ListFindingAggregationsRequest : public Inspector2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListFindingAggregationsRequest> Clone() const
    {
      return Aws::MakeUnique<ListFindingAggregationsRequest>(GetServiceRequestName(), *this);
    }
