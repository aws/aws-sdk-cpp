...
namespace Model
{
  ...
  /**
   */
  class AWS_INSPECTOR2_API EnableDelegatedAdminAccountRequest : public Inspector2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<EnableDelegatedAdminAccountRequest> Clone() const
    {
      return Aws::MakeUnique<EnableDelegatedAdminAccountRequest>(GetServiceRequestName(), *this);
    }
