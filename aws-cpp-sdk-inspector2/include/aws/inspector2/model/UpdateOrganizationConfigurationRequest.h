...
namespace Model
{
  ...
  /**
   */
  class AWS_INSPECTOR2_API UpdateOrganizationConfigurationRequest : public Inspector2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateOrganizationConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateOrganizationConfigurationRequest>(GetServiceRequestName(), *this);
    }
