...
namespace Model
{
  ...
  /**
   */
  class AWS_INSPECTOR2_API DeleteFilterRequest : public Inspector2Request
  {
  public:
    DeleteFilterRequest();
    ...
    */
    virtual Aws::UniquePtr<DeleteFilterRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteFilterRequest>(GetServiceRequestName(), *this);
    }
