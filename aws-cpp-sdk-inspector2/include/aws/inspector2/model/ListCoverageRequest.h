...
namespace Model
{
  ...
  /**
   */
  class AWS_INSPECTOR2_API ListCoverageRequest : public Inspector2Request
  {
  public:
    ListCoverageRequest();
    ...
    */
    virtual Aws::UniquePtr<ListCoverageRequest> Clone() const
    {
      return Aws::MakeUnique<ListCoverageRequest>(GetServiceRequestName(), *this);
    }
