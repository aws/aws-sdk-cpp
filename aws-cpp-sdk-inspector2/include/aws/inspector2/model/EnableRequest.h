...
namespace Model
{
  ...
  /**
   */
  class AWS_INSPECTOR2_API EnableRequest : public Inspector2Request
  {
  public:
    EnableRequest();
    ...
    */
    virtual Aws::UniquePtr<EnableRequest> Clone() const
    {
      return Aws::MakeUnique<EnableRequest>(GetServiceRequestName(), *this);
    }
