...
namespace Model
{
  ...
  /**
   */
  class AWS_INSPECTOR2_API DisableRequest : public Inspector2Request
  {
  public:
    DisableRequest();
    ...
    */
    virtual Aws::UniquePtr<DisableRequest> Clone() const
    {
      return Aws::MakeUnique<DisableRequest>(GetServiceRequestName(), *this);
    }
