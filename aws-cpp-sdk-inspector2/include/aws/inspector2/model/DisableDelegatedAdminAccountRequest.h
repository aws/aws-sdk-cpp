...
namespace Model
{
  ...
  /**
   */
  class AWS_INSPECTOR2_API DisableDelegatedAdminAccountRequest : public Inspector2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DisableDelegatedAdminAccountRequest> Clone() const
    {
      return Aws::MakeUnique<DisableDelegatedAdminAccountRequest>(GetServiceRequestName(), *this);
    }
