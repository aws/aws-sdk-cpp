...
namespace Model
{
  ...
  /**
   */
  class AWS_INSPECTOR2_API CancelFindingsReportRequest : public Inspector2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CancelFindingsReportRequest> Clone() const
    {
      return Aws::MakeUnique<CancelFindingsReportRequest>(GetServiceRequestName(), *this);
    }
