...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_INSPECTOR2_API LambdaLayerAggregation
  {
  public:
    LambdaLayerAggregation();
    LambdaLayerAggregation(Aws::Utils::Json::JsonView jsonValue);
    LambdaLayerAggregation& operator=(Aws::Utils::Json::JsonView jsonValue);
