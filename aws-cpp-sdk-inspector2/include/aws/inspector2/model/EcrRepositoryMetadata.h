...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_INSPECTOR2_API EcrRepositoryMetadata
  {
  public:
    EcrRepositoryMetadata();
    EcrRepositoryMetadata(Aws::Utils::Json::JsonView jsonValue);
    EcrRepositoryMetadata& operator=(Aws::Utils::Json::JsonView jsonValue);
