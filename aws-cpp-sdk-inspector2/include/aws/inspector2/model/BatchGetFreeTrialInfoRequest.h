...
namespace Model
{
  ...
  /**
   */
  class AWS_INSPECTOR2_API BatchGetFreeTrialInfoRequest : public Inspector2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchGetFreeTrialInfoRequest> Clone() const
    {
      return Aws::MakeUnique<BatchGetFreeTrialInfoRequest>(GetServiceRequestName(), *this);
    }
