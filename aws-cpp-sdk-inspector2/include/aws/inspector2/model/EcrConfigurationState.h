...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_INSPECTOR2_API EcrConfigurationState
  {
  public:
    EcrConfigurationState();
    EcrConfigurationState(Aws::Utils::Json::JsonView jsonValue);
    EcrConfigurationState& operator=(Aws::Utils::Json::JsonView jsonValue);
