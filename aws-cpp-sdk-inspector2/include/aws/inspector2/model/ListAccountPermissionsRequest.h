...
namespace Model
{
  ...
  /**
   */
  class AWS_INSPECTOR2_API ListAccountPermissionsRequest : public Inspector2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListAccountPermissionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListAccountPermissionsRequest>(GetServiceRequestName(), *this);
    }
