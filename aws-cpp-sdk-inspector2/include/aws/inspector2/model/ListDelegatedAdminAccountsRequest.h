...
namespace Model
{
  ...
  /**
   */
  class AWS_INSPECTOR2_API ListDelegatedAdminAccountsRequest : public Inspector2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListDelegatedAdminAccountsRequest> Clone() const
    {
      return Aws::MakeUnique<ListDelegatedAdminAccountsRequest>(GetServiceRequestName(), *this);
    }
