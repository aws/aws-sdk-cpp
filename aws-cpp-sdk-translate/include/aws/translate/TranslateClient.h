...
namespace Translate
{
  ...
  class AWS_TRANSLATE_API TranslateClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        TranslateClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                        std::shared_ptr<Endpoint::TranslateEndpointProvider> endpointProvider = Aws::MakeShared<Translate::Endpoint::TranslateEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::TranslateEndpointProvider> m_endpointProvider;
  };
