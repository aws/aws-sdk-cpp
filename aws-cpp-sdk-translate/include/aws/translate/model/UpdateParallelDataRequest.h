...
namespace Model
{
  ...
  /**
   */
  class AWS_TRANSLATE_API UpdateParallelDataRequest : public TranslateRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateParallelDataRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateParallelDataRequest>(GetServiceRequestName(), *this);
    }
