...
namespace Model
{
  ...
  public:
     ...
     * Translate doesn't scan parallel data input files for the risk of CSV injection
     ...
     * within it.</p> <p>Before you download a parallel data input file from Amazon S3,
     * ensure that you recognize the file and trust its creator.</p> 
     */
