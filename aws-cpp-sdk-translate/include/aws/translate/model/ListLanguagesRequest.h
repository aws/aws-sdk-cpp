...
namespace Model
{
  ...
  /**
   */
  class AWS_TRANSLATE_API ListLanguagesRequest : public TranslateRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListLanguagesRequest> Clone() const
    {
      return Aws::MakeUnique<ListLanguagesRequest>(GetServiceRequestName(), *this);
    }
