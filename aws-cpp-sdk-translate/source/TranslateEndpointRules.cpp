...
Aws::String TranslateEndpointRules::GetRulesAsString()
{
    return Aws::String(TranslateEndpointRules::Rules.begin(), TranslateEndpointRules::Rules.end());
}

const Aws::Vector<char> TranslateEndpointRules::Rules = {
...
't','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','t','r','a','n','s','l',
'a','t','e','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t',
...
':','/','/','t','r','a','n','s','l','a','t','e','-','f','i','p','s','.','{','R','e','g','i','o','n',
...
'r','u','l','e','s','"',':','[','{','"','c','o','n','d','i','t','i','o','n','s','"',':','[',']',',',
'"','e','n','d','p','o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':',
'/','/','t','r','a','n','s','l','a','t','e','.','{','R','e','g','i','o','n','}','.','{','P','a','r',
