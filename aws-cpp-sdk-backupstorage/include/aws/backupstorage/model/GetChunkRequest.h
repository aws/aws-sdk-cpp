...
namespace Model
{
  ...
  /**
   */
  class AWS_BACKUPSTORAGE_API GetChunkRequest : public BackupStorageRequest
  {
  public:
    GetChunkRequest();
    ...
    */
    virtual Aws::UniquePtr<GetChunkRequest> Clone() const
    {
      return Aws::MakeUnique<GetChunkRequest>(GetServiceRequestName(), *this);
    }
