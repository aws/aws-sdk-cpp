...
namespace Model
{
  ...
  /**
   */
  class AWS_BACKUPSTORAGE_API ListChunksRequest : public BackupStorageRequest
  {
  public:
    ListChunksRequest();
    ...
    */
    virtual Aws::UniquePtr<ListChunksRequest> Clone() const
    {
      return Aws::MakeUnique<ListChunksRequest>(GetServiceRequestName(), *this);
    }
