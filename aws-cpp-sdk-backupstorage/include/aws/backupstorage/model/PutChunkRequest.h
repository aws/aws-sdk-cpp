...
namespace Model
{
  ...
  /**
   */
  class AWS_BACKUPSTORAGE_API PutChunkRequest : public StreamingBackupStorageRequest
  {
  public:
    PutChunkRequest();
    ...
    */
    virtual Aws::UniquePtr<PutChunkRequest> Clone() const
    {
      return Aws::MakeUnique<PutChunkRequest>(GetServiceRequestName(), *this);
    }
