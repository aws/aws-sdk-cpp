...
namespace Model
{
  ...
  /**
   */
  class AWS_BACKUPSTORAGE_API ListObjectsRequest : public BackupStorageRequest
  {
  public:
    ListObjectsRequest();
    ...
    */
    virtual Aws::UniquePtr<ListObjectsRequest> Clone() const
    {
      return Aws::MakeUnique<ListObjectsRequest>(GetServiceRequestName(), *this);
    }
