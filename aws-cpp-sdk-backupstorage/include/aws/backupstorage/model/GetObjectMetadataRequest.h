...
namespace Model
{
  ...
  /**
   */
  class AWS_BACKUPSTORAGE_API GetObjectMetadataRequest : public BackupStorageRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetObjectMetadataRequest> Clone() const
    {
      return Aws::MakeUnique<GetObjectMetadataRequest>(GetServiceRequestName(), *this);
    }
