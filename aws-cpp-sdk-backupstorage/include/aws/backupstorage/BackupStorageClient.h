...
namespace BackupStorage
{
  ...
  class AWS_BACKUPSTORAGE_API BackupStorageClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        BackupStorageClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                            std::shared_ptr<Endpoint::BackupStorageEndpointProvider> endpointProvider = Aws::MakeShared<BackupStorage::Endpoint::BackupStorageEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::BackupStorageEndpointProvider> m_endpointProvider;
  };
