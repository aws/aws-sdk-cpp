...
using TransferResolveEndpointOutcome = Aws::Transfer::Endpoint::TransferEndpointProvider::TransferResolveEndpointOutcome;
...
void ValidateOutcome(const TransferResolveEndpointOutcome& outcome, const TransferEndpointProviderEndpointTestCase::Expect& expect)
{
