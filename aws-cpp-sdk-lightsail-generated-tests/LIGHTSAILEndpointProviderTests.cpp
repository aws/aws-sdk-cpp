...
static const char* ALLOCATION_TAG = "AWSLightsailEndpointProviderTests";
using LightsailEndpointProvider = Aws::Lightsail::Endpoint::LightsailEndpointProvider;
using EndpointParameters = Aws::Vector<Aws::Endpoint::EndpointParameter>;
using LightsailResolveEndpointOutcome = Aws::Lightsail::Endpoint::LightsailEndpointProvider::LightsailResolveEndpointOutcome;
...
class LightsailEndpointProviderTests :public ::testing::TestWithParam<size_t>
{
public:
...
struct LightsailEndpointProviderEndpointTestCase
{
...
static const Aws::Vector<LightsailEndpointProviderEndpointTestCase> TEST_CASES = {
  /*TEST CASE 0*/
  {"For region ap-south-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail-fips.ap-south-1.api.aws",
       {/*properties*/},
  ...
  {"For region ap-south-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail-fips.ap-south-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-south-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail.ap-south-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-south-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail.ap-south-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ca-central-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail-fips.ca-central-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ca-central-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail-fips.ca-central-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ca-central-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail.ca-central-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ca-central-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail.ca-central-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-central-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail-fips.eu-central-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-central-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail-fips.eu-central-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-central-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail.eu-central-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-central-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail.eu-central-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-west-2 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail-fips.us-west-2.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-west-2 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail-fips.us-west-2.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-west-2 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail.us-west-2.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-west-2 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail.us-west-2.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-north-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail-fips.eu-north-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-north-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail-fips.eu-north-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-north-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail.eu-north-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-north-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail.eu-north-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-west-3 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail-fips.eu-west-3.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-west-3 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail-fips.eu-west-3.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-west-3 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail.eu-west-3.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-west-3 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail.eu-west-3.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-west-2 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail-fips.eu-west-2.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-west-2 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail-fips.eu-west-2.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-west-2 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail.eu-west-2.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-west-2 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail.eu-west-2.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-west-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail-fips.eu-west-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-west-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail-fips.eu-west-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-west-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail.eu-west-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-west-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail.eu-west-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-northeast-2 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail-fips.ap-northeast-2.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-northeast-2 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail-fips.ap-northeast-2.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-northeast-2 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail.ap-northeast-2.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-northeast-2 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail.ap-northeast-2.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-northeast-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail-fips.ap-northeast-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-northeast-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail-fips.ap-northeast-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-northeast-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail.ap-northeast-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-northeast-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail.ap-northeast-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-southeast-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail-fips.ap-southeast-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-southeast-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail-fips.ap-southeast-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-southeast-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail.ap-southeast-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-southeast-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail.ap-southeast-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-southeast-2 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail-fips.ap-southeast-2.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-southeast-2 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail-fips.ap-southeast-2.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-southeast-2 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail.ap-southeast-2.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-southeast-2 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail.ap-southeast-2.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-east-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail-fips.us-east-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-east-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail-fips.us-east-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-east-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail.us-east-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-east-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail.us-east-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-east-2 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail-fips.us-east-2.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-east-2 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail-fips.us-east-2.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-east-2 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail.us-east-2.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-east-2 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://lightsail.us-east-2.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
...
void ValidateOutcome(const LightsailResolveEndpointOutcome& outcome, const LightsailEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(LightsailEndpointProviderTests, EndpointProviderTest)
{
    ...
    const LightsailEndpointProviderEndpointTestCase& TEST_CASE = TEST_CASES.at(TEST_CASE_IDX);
    SCOPED_TRACE(Aws::String("\nTEST CASE # ") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX) + ": " + TEST_CASE.documentation);

    std::shared_ptr<LightsailEndpointProvider> endpointProvider = Aws::MakeShared<LightsailEndpointProvider>(ALLOCATION_TAG);
    ASSERT_TRUE(endpointProvider) << "Failed to allocate/initialize LightsailEndpointProvider";
    ...
    for(const auto& operation : TEST_CASE.operationInput)
    {
         ...
         */
        const Aws::Vector<std::reference_wrapper<const LightsailEndpointProviderEndpointTestCase::OperationParamsFromTest>>
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         LightsailEndpointProviderTests,
