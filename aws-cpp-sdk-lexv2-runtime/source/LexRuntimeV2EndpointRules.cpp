...
{
const size_t LexRuntimeV2EndpointRules::RulesBlobStrLen = 3486;
const size_t LexRuntimeV2EndpointRules::RulesBlobSize = 3487;

using RulesBlobT = Aws::Array<const char, LexRuntimeV2EndpointRules::RulesBlobSize>;
...
'e','-','v','2','-','l','e','x','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P',
...
'h','t','t','p','s',':','/','/','r','u','n','t','i','m','e','-','v','2','-','l','e','x','-','f','i',
...
'l','"',':','"','h','t','t','p','s',':','/','/','r','u','n','t','i','m','e','-','v','2','-','l','e',
...
't','p','s',':','/','/','r','u','n','t','i','m','e','-','v','2','-','l','e','x','.','{','R','e','g',
...
const char* LexRuntimeV2EndpointRules::GetRulesBlob()
{
