...
Aws::String LexRuntimeV2EndpointRules::GetRulesAsString()
{
    return Aws::String(LexRuntimeV2EndpointRules::Rules.begin(), LexRuntimeV2EndpointRules::Rules.end());
}

const Aws::Vector<char> LexRuntimeV2EndpointRules::Rules = {
...
'"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','r','u','n','t','i','m','e',
'-','v','2','-','l','e','x','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a',
...
't','t','p','s',':','/','/','r','u','n','t','i','m','e','-','v','2','-','l','e','x','-','f','i','p',
...
'"',':','"','h','t','t','p','s',':','/','/','r','u','n','t','i','m','e','-','v','2','-','l','e','x',
...
'p','s',':','/','/','r','u','n','t','i','m','e','-','v','2','-','l','e','x','.','{','R','e','g','i',
