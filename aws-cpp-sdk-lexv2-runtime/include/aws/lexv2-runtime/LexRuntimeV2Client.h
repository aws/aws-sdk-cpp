...
namespace LexRuntimeV2
{
  ...
  class AWS_LEXRUNTIMEV2_API LexRuntimeV2Client : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        LexRuntimeV2Client(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                           std::shared_ptr<Endpoint::LexRuntimeV2EndpointProvider> endpointProvider = Aws::MakeShared<LexRuntimeV2::Endpoint::LexRuntimeV2EndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::LexRuntimeV2EndpointProvider> m_endpointProvider;
  };
