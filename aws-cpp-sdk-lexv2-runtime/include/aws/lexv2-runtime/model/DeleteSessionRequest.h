...
namespace Model
{
  ...
  /**
   */
  class AWS_LEXRUNTIMEV2_API DeleteSessionRequest : public LexRuntimeV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteSessionRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteSessionRequest>(GetServiceRequestName(), *this);
    }
