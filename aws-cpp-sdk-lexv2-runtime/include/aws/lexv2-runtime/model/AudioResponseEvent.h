...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_LEXRUNTIMEV2_API AudioResponseEvent
  {
  public:
    AudioResponseEvent();
    AudioResponseEvent(Aws::Utils::Json::JsonView jsonValue);
    AudioResponseEvent& operator=(Aws::Utils::Json::JsonView jsonValue);
