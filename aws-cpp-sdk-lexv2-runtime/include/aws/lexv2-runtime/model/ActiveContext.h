...
namespace Model
{
   ...
   * You can configure Amazon Lex to set a context when an intent is fulfilled, or
   * you can set a context using the , , or operations.</p> <p>Use a context to
   * indicate to Amazon Lex intents that should be used as follow-up intents. For
  ...
  public:
    ...
    /**
     * <p>A lis tof contexts active for the request. A context can be activated when a
