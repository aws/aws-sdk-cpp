...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_LEXRUNTIMEV2_API DisconnectionEvent
  {
  public:
    DisconnectionEvent();
    DisconnectionEvent(Aws::Utils::Json::JsonView jsonValue);
    DisconnectionEvent& operator=(Aws::Utils::Json::JsonView jsonValue);
