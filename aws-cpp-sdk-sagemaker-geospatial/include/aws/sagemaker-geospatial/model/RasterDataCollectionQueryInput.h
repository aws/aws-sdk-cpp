...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SAGEMAKERGEOSPATIAL_API RasterDataCollectionQueryInput
  {
  public:
    RasterDataCollectionQueryInput();
    RasterDataCollectionQueryInput(Aws::Utils::Json::JsonView jsonValue);
    RasterDataCollectionQueryInput& operator=(Aws::Utils::Json::JsonView jsonValue);
