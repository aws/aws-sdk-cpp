...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SAGEMAKERGEOSPATIAL_API AreaOfInterest
  {
  public:
    AreaOfInterest();
    AreaOfInterest(Aws::Utils::Json::JsonView jsonValue);
    AreaOfInterest& operator=(Aws::Utils::Json::JsonView jsonValue);
