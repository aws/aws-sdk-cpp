...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SAGEMAKERGEOSPATIAL_API PolygonGeometryInput
  {
  public:
    PolygonGeometryInput();
    PolygonGeometryInput(Aws::Utils::Json::JsonView jsonValue);
    PolygonGeometryInput& operator=(Aws::Utils::Json::JsonView jsonValue);
