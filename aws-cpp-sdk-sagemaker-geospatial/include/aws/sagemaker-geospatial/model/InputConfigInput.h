...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SAGEMAKERGEOSPATIAL_API InputConfigInput
  {
  public:
    InputConfigInput();
    InputConfigInput(Aws::Utils::Json::JsonView jsonValue);
    InputConfigInput& operator=(Aws::Utils::Json::JsonView jsonValue);
