...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SAGEMAKERGEOSPATIAL_API PlatformInput
  {
  public:
    PlatformInput();
    PlatformInput(Aws::Utils::Json::JsonView jsonValue);
    PlatformInput& operator=(Aws::Utils::Json::JsonView jsonValue);
