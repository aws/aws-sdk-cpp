...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SAGEMAKERGEOSPATIAL_API ReverseGeocodingConfig
  {
  public:
    ReverseGeocodingConfig();
    ReverseGeocodingConfig(Aws::Utils::Json::JsonView jsonValue);
    ReverseGeocodingConfig& operator=(Aws::Utils::Json::JsonView jsonValue);
