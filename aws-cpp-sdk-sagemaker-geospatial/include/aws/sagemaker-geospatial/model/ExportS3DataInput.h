...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SAGEMAKERGEOSPATIAL_API ExportS3DataInput
  {
  public:
    ExportS3DataInput();
    ExportS3DataInput(Aws::Utils::Json::JsonView jsonValue);
    ExportS3DataInput& operator=(Aws::Utils::Json::JsonView jsonValue);
