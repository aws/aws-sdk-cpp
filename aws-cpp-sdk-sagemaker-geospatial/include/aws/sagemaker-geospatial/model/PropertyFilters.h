...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SAGEMAKERGEOSPATIAL_API PropertyFilters
  {
  public:
    PropertyFilters();
    PropertyFilters(Aws::Utils::Json::JsonView jsonValue);
    PropertyFilters& operator=(Aws::Utils::Json::JsonView jsonValue);
