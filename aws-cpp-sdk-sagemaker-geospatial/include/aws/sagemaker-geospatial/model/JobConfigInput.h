...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SAGEMAKERGEOSPATIAL_API JobConfigInput
  {
  public:
    JobConfigInput();
    JobConfigInput(Aws::Utils::Json::JsonView jsonValue);
    JobConfigInput& operator=(Aws::Utils::Json::JsonView jsonValue);
