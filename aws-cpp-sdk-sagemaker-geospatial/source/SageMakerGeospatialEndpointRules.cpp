...
Aws::String SageMakerGeospatialEndpointRules::GetRulesAsString()
{
    return Aws::String(SageMakerGeospatialEndpointRules::Rules.begin(), SageMakerGeospatialEndpointRules::Rules.end());
}

const Aws::Vector<char> SageMakerGeospatialEndpointRules::Rules = {
