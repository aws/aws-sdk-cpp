...
{
const size_t SageMakerGeospatialEndpointRules::RulesBlobStrLen = 3467;
const size_t SageMakerGeospatialEndpointRules::RulesBlobSize = 3468;

using RulesBlobT = Aws::Array<const char, SageMakerGeospatialEndpointRules::RulesBlobSize>;
...
'"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','s','a','g','e','m','a','k',
'e','r','-','g','e','o','s','p','a','t','i','a','l','-','f','i','p','s','.','{','R','e','g','i','o',
...
'p','o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','s','a',
'g','e','m','a','k','e','r','-','g','e','o','s','p','a','t','i','a','l','-','f','i','p','s','.','{',
...
't','p','s',':','/','/','s','a','g','e','m','a','k','e','r','-','g','e','o','s','p','a','t','i','a',
...
const char* SageMakerGeospatialEndpointRules::GetRulesBlob()
{
