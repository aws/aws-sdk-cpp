...
Aws::String LocationServiceEndpointRules::GetRulesAsString()
{
    return Aws::String(LocationServiceEndpointRules::Rules.begin(), LocationServiceEndpointRules::Rules.end());
}

const Aws::Vector<char> LocationServiceEndpointRules::Rules = {
...
't','t','p','s',':','/','/','g','e','o','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.',
