...
{
const size_t LocationServiceEndpointRules::RulesBlobStrLen = 3506;
const size_t LocationServiceEndpointRules::RulesBlobSize = 3507;
...
'/','/','g','e','o','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t',
