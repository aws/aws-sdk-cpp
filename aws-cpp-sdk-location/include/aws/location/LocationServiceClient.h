...
namespace LocationService
{
  ...
  class AWS_LOCATIONSERVICE_API LocationServiceClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        LocationServiceClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                              std::shared_ptr<Endpoint::LocationServiceEndpointProvider> endpointProvider = Aws::MakeShared<LocationService::Endpoint::LocationServiceEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::LocationServiceEndpointProvider> m_endpointProvider;
  };
