...
namespace Model
{
  ...
  /**
   */
  class AWS_LOCATIONSERVICE_API ListDevicePositionsRequest : public LocationServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListDevicePositionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListDevicePositionsRequest>(GetServiceRequestName(), *this);
    }
