...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>The pricing plan for the specified route calculator resource.</p> <p>For
     ...
     * pricing</a>.</p>
     */
    inline ListRouteCalculatorsResponseEntry& WithPricingPlan(const PricingPlan& value) { SetPricingPlan(value); return *this;}
     ...
     * pricing</a>.</p>
     */
    inline ListRouteCalculatorsResponseEntry& WithPricingPlan(PricingPlan&& value) { SetPricingPlan(std::move(value)); return *this;}
