...
namespace Model
{
  ...
  /**
   */
  class AWS_LOCATIONSERVICE_API BatchPutGeofenceRequest : public LocationServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchPutGeofenceRequest> Clone() const
    {
      return Aws::MakeUnique<BatchPutGeofenceRequest>(GetServiceRequestName(), *this);
    }
