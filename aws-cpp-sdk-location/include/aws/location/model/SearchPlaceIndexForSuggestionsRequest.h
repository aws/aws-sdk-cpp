...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<SearchPlaceIndexForSuggestionsRequest> Clone() const
    {
      return Aws::MakeUnique<SearchPlaceIndexForSuggestionsRequest>(GetServiceRequestName(), *this);
    }
