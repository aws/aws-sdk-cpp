...
namespace Model
{
  ...
  /**
   */
  class AWS_LOCATIONSERVICE_API BatchDeleteDevicePositionHistoryRequest : public LocationServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchDeleteDevicePositionHistoryRequest> Clone() const
    {
      return Aws::MakeUnique<BatchDeleteDevicePositionHistoryRequest>(GetServiceRequestName(), *this);
    }
