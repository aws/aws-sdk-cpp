...
namespace Model
{
  ...
  /**
   */
  class AWS_LOCATIONSERVICE_API BatchEvaluateGeofencesRequest : public LocationServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchEvaluateGeofencesRequest> Clone() const
    {
      return Aws::MakeUnique<BatchEvaluateGeofencesRequest>(GetServiceRequestName(), *this);
    }
