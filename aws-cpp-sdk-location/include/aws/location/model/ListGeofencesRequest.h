...
namespace Model
{
  ...
  /**
   */
  class AWS_LOCATIONSERVICE_API ListGeofencesRequest : public LocationServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListGeofencesRequest> Clone() const
    {
      return Aws::MakeUnique<ListGeofencesRequest>(GetServiceRequestName(), *this);
    }
