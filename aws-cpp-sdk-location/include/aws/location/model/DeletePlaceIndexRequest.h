...
namespace Model
{
  ...
  /**
   */
  class AWS_LOCATIONSERVICE_API DeletePlaceIndexRequest : public LocationServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeletePlaceIndexRequest> Clone() const
    {
      return Aws::MakeUnique<DeletePlaceIndexRequest>(GetServiceRequestName(), *this);
    }
