...
namespace Model
{
  ...
  /**
   */
  class AWS_LOCATIONSERVICE_API DescribeTrackerRequest : public LocationServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeTrackerRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeTrackerRequest>(GetServiceRequestName(), *this);
    }
