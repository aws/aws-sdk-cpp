...
namespace Model
{
  ...
  /**
   */
  class AWS_LOCATIONSERVICE_API PutGeofenceRequest : public LocationServiceRequest
  {
  public:
    PutGeofenceRequest();
    ...
    */
    virtual Aws::UniquePtr<PutGeofenceRequest> Clone() const
    {
      return Aws::MakeUnique<PutGeofenceRequest>(GetServiceRequestName(), *this);
    }
