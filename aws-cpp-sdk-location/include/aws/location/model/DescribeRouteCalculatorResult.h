...
namespace Model
{
  class AWS_LOCATIONSERVICE_API DescribeRouteCalculatorResult
  {
  public:
    DescribeRouteCalculatorResult();
    DescribeRouteCalculatorResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    DescribeRouteCalculatorResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
     ...
     * <p>For additional details and restrictions on each pricing plan option, see <a
     ...
     * pricing</a>.</p>
     */
    inline DescribeRouteCalculatorResult& WithPricingPlan(const PricingPlan& value) { SetPricingPlan(value); return *this;}
     ...
     * pricing</a>.</p>
     */
    inline DescribeRouteCalculatorResult& WithPricingPlan(PricingPlan&& value) { SetPricingPlan(std::move(value)); return *this;}
