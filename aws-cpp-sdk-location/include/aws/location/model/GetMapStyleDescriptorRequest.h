...
namespace Model
{
  ...
  /**
   */
  class AWS_LOCATIONSERVICE_API GetMapStyleDescriptorRequest : public LocationServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetMapStyleDescriptorRequest> Clone() const
    {
      return Aws::MakeUnique<GetMapStyleDescriptorRequest>(GetServiceRequestName(), *this);
    }
