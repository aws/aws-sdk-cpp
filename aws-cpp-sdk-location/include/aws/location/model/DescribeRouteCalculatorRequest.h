...
namespace Model
{
  ...
  /**
   */
  class AWS_LOCATIONSERVICE_API DescribeRouteCalculatorRequest : public LocationServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeRouteCalculatorRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeRouteCalculatorRequest>(GetServiceRequestName(), *this);
    }
