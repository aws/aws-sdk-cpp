...
namespace Model
{
  class AWS_LOCATIONSERVICE_API ListGeofenceCollectionsResult
  {
  public:
    ListGeofenceCollectionsResult();
    ListGeofenceCollectionsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ListGeofenceCollectionsResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
