...
namespace Model
{
  ...
  /**
   */
  class AWS_LOCATIONSERVICE_API BatchUpdateDevicePositionRequest : public LocationServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchUpdateDevicePositionRequest> Clone() const
    {
      return Aws::MakeUnique<BatchUpdateDevicePositionRequest>(GetServiceRequestName(), *this);
    }
