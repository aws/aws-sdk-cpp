...
namespace Model
{
  ...
  /**
   */
  class AWS_LOCATIONSERVICE_API GetGeofenceRequest : public LocationServiceRequest
  {
  public:
    GetGeofenceRequest();
    ...
    */
    virtual Aws::UniquePtr<GetGeofenceRequest> Clone() const
    {
      return Aws::MakeUnique<GetGeofenceRequest>(GetServiceRequestName(), *this);
    }
