...
namespace Model
{
  ...
  /**
   */
  class AWS_LOCATIONSERVICE_API DeleteGeofenceCollectionRequest : public LocationServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteGeofenceCollectionRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteGeofenceCollectionRequest>(GetServiceRequestName(), *this);
    }
