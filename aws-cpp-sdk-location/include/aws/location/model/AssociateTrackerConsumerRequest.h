...
namespace Model
{
  ...
  /**
   */
  class AWS_LOCATIONSERVICE_API AssociateTrackerConsumerRequest : public LocationServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateTrackerConsumerRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateTrackerConsumerRequest>(GetServiceRequestName(), *this);
    }
