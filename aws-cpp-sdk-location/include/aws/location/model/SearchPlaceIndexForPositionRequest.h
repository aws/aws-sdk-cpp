...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<SearchPlaceIndexForPositionRequest> Clone() const
    {
      return Aws::MakeUnique<SearchPlaceIndexForPositionRequest>(GetServiceRequestName(), *this);
    }
