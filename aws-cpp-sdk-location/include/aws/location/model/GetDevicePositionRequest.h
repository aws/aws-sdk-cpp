...
namespace Model
{
  ...
  /**
   */
  class AWS_LOCATIONSERVICE_API GetDevicePositionRequest : public LocationServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetDevicePositionRequest> Clone() const
    {
      return Aws::MakeUnique<GetDevicePositionRequest>(GetServiceRequestName(), *this);
    }
