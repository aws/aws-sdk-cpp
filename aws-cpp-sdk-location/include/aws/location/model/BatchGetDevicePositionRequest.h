...
namespace Model
{
  ...
  /**
   */
  class AWS_LOCATIONSERVICE_API BatchGetDevicePositionRequest : public LocationServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchGetDevicePositionRequest> Clone() const
    {
      return Aws::MakeUnique<BatchGetDevicePositionRequest>(GetServiceRequestName(), *this);
    }
