...
namespace Model
{
  ...
  /**
   */
  class AWS_LOCATIONSERVICE_API CalculateRouteMatrixRequest : public LocationServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CalculateRouteMatrixRequest> Clone() const
    {
      return Aws::MakeUnique<CalculateRouteMatrixRequest>(GetServiceRequestName(), *this);
    }
