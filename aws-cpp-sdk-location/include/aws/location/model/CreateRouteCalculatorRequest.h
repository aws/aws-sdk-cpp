...
namespace Model
{
  ...
  /**
   */
  class AWS_LOCATIONSERVICE_API CreateRouteCalculatorRequest : public LocationServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateRouteCalculatorRequest> Clone() const
    {
      return Aws::MakeUnique<CreateRouteCalculatorRequest>(GetServiceRequestName(), *this);
    }
