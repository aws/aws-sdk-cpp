...
namespace Model
{
  ...
  /**
   */
  class AWS_LOCATIONSERVICE_API GetPlaceRequest : public LocationServiceRequest
  {
  public:
    GetPlaceRequest();
    ...
    */
    virtual Aws::UniquePtr<GetPlaceRequest> Clone() const
    {
      return Aws::MakeUnique<GetPlaceRequest>(GetServiceRequestName(), *this);
    }
