...
namespace Model
{
  ...
  /**
   */
  class AWS_LOCATIONSERVICE_API DisassociateTrackerConsumerRequest : public LocationServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateTrackerConsumerRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateTrackerConsumerRequest>(GetServiceRequestName(), *this);
    }
