...
Aws::String OAMEndpointRules::GetRulesAsString()
{
    return Aws::String(OAMEndpointRules::Rules.begin(), OAMEndpointRules::Rules.end());
}

const Aws::Vector<char> OAMEndpointRules::Rules = {
...
't','p','s',':','/','/','o','a','m','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{',
...
'p','s',':','/','/','o','a','m','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t',
