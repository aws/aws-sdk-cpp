...
namespace Model
{
  class AWS_OAM_API GetSinkResult
  {
  public:
    GetSinkResult();
    GetSinkResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    GetSinkResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
