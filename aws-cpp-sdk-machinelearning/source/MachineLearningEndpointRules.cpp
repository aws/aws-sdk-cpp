...
Aws::String MachineLearningEndpointRules::GetRulesAsString()
{
    return Aws::String(MachineLearningEndpointRules::Rules.begin(), MachineLearningEndpointRules::Rules.end());
}

const Aws::Vector<char> MachineLearningEndpointRules::Rules = {
...
'l','e','a','r','n','i','n','g','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P',
...
'h','t','t','p','s',':','/','/','m','a','c','h','i','n','e','l','e','a','r','n','i','n','g','-','f',
...
'r','l','"',':','"','h','t','t','p','s',':','/','/','m','a','c','h','i','n','e','l','e','a','r','n',
