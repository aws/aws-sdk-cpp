...
namespace MachineLearning
{
  ...
  class AWS_MACHINELEARNING_API MachineLearningClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        MachineLearningClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                              std::shared_ptr<Endpoint::MachineLearningEndpointProvider> endpointProvider = Aws::MakeShared<MachineLearning::Endpoint::MachineLearningEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::MachineLearningEndpointProvider> m_endpointProvider;
  };
