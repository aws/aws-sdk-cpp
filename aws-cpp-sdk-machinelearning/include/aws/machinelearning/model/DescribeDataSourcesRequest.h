...
namespace Model
{
  ...
  /**
   */
  class AWS_MACHINELEARNING_API DescribeDataSourcesRequest : public MachineLearningRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeDataSourcesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeDataSourcesRequest>(GetServiceRequestName(), *this);
    }
