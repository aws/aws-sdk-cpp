...
namespace Model
{
  ...
  /**
   */
  class AWS_MACHINELEARNING_API DeleteRealtimeEndpointRequest : public MachineLearningRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteRealtimeEndpointRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteRealtimeEndpointRequest>(GetServiceRequestName(), *this);
    }
