...
namespace Model
{
  ...
  public:
     ...
     * <li><p>DatabaseInformation - <ul> <li> <code>DatabaseName </code> - Name of the
     * Amazon RDS database.</li> <li> <code> InstanceIdentifier </code> - Unique
     ...
     * <li><p>ResourceRole - Role (DataPipelineDefaultResourceRole) assumed by an
     * Amazon Elastic Compute Cloud (EC2) instance to carry out the copy task from
     ...
     * templates</a> for data pipelines.</p></li> <li><p>ServiceRole - Role
     * (DataPipelineDefaultRole) assumed by the AWS Data Pipeline service to monitor
     * the progress of the copy task from Amazon RDS to Amazon Simple Storage Service
     * (S3). For more information, see <a
     * href="http://docs.aws.amazon.com/datapipeline/latest/DeveloperGuide/dp-iam-roles.html">Role
     * templates</a> for data pipelines.</p></li> <li><p>SecurityInfo - Security
     * information to use to access an Amazon RDS instance. You need to set up
     * appropriate ingress rules for the security entity IDs provided to allow access
     * to the Amazon RDS instance. Specify a [<code>SubnetId</code>,
     * <code>SecurityGroupIds</code>] pair for a VPC-based Amazon RDS
     * instance.</p></li> <li><p>SelectSqlQuery - Query that is used to retrieve the
     * observation data for the <code>Datasource</code>.</p></li>
     * <li><p>S3StagingLocation - Amazon S3 location for staging RDS data. The data
     * retrieved from Amazon RDS using <code>SelectSqlQuery</code> is stored in this
     * location.</p></li> <li><p>DataSchemaUri - Amazon S3 location of the
