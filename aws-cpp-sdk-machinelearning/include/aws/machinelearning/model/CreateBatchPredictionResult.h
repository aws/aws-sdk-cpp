...
{
  /**
   * <p> Represents the output of a <a>CreateBatchPrediction</a> operation, and is an
   * acknowledgement that Amazon ML received the request.</p> <p>The
   * <a>CreateBatchPrediction</a> operation is asynchronous. You can poll for status
  ...
  public:
     ...
     * the request.</p>
     */
    inline CreateBatchPredictionResult& WithBatchPredictionId(Aws::String&& value) { SetBatchPredictionId(value); return *this;}
