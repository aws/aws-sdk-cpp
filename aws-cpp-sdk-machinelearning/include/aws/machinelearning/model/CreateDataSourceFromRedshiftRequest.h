...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateDataSourceFromRedshiftRequest> Clone() const
    {
      return Aws::MakeUnique<CreateDataSourceFromRedshiftRequest>(GetServiceRequestName(), *this);
    }
