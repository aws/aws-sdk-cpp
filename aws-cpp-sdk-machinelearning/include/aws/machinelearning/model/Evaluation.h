...
namespace Model
{
  ...
  public:
     ...
     * in epoch time.</p>
     */
    inline Evaluation& WithCreatedAt(double value) { SetCreatedAt(value); return *this;}
     ...
     * expressed in epoch time.</p>
     */
    inline Evaluation& WithLastUpdatedAt(double value) { SetLastUpdatedAt(value); return *this;}
