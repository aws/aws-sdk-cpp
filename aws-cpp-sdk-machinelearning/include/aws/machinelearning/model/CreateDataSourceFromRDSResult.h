...
{
  /**
   * <p> Represents the output of a <a>CreateDataSourceFromRDS</a> operation, and is
   * an acknowledgement that Amazon ML received the request.</p> <p>The
   * <a>CreateDataSourceFromRDS</a> operation is asynchronous. You can poll for
   ...
   * and looking up the pipeline using the pipelineId from the describe call.</p>
   */
