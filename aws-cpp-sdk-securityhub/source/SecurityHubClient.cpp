...
using ResolveEndpointOutcome = Aws::SecurityHub::Endpoint::SecurityHubEndpointProvider::SecurityHubResolveEndpointOutcome;
...
SecurityHubClient::SecurityHubClient(const Client::ClientConfiguration& clientConfiguration,
                                     std::shared_ptr<Endpoint::SecurityHubEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<SecurityHubErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<SecurityHub::Endpoint::SecurityHubEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
