...
{
const size_t SecurityHubEndpointRules::RulesBlobStrLen = 3412;
const size_t SecurityHubEndpointRules::RulesBlobSize = 3413;

using RulesBlobT = Aws::Array<const char, SecurityHubEndpointRules::RulesBlobSize>;
...
't','t','p','s',':','/','/','s','e','c','u','r','i','t','y','h','u','b','-','f','i','p','s','.','{',
...
'P','S',' ','a','n','d',' ','D','u','a','l','S','t','a','c','k',' ','a','r','e',' ','e','n','a','b',
'l','e','d',',',' ','b','u','t',' ','t','h','i','s',' ','p','a','r','t','i','t','i','o','n',' ','d',
'o','e','s',' ','n','o','t',' ','s','u','p','p','o','r','t',' ','o','n','e',' ','o','r',' ','b','o',
't','h','"',',','"','t','y','p','e','"',':','"','e','r','r','o','r','"','}',']','}',',','{','"','c',
...
'F','I','P','S','"',']','}',']','}',']',',','"','t','y','p','e','"',':','"','t','r','e','e','"',',',
'"','r','u','l','e','s','"',':','[','{','"','c','o','n','d','i','t','i','o','n','s','"',':','[',']',
',','"','t','y','p','e','"',':','"','t','r','e','e','"',',','"','r','u','l','e','s','"',':','[','{',
'"','c','o','n','d','i','t','i','o','n','s','"',':','[',']',',','"','e','n','d','p','o','i','n','t',
'"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','s','e','c','u','r','i','t',
'y','h','u','b','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i',
...
']',',','"','t','y','p','e','"',':','"','t','r','e','e','"',',','"','r','u','l','e','s','"',':','[',
'{','"','c','o','n','d','i','t','i','o','n','s','"',':','[',']',',','"','e','n','d','p','o','i','n',
't','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','s','e','c','u','r','i',
't','y','h','u','b','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n',
...
':','"','h','t','t','p','s',':','/','/','s','e','c','u','r','i','t','y','h','u','b','.','{','R','e',
...
const char* SecurityHubEndpointRules::GetRulesBlob()
{
