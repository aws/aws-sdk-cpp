...
Aws::String SecurityHubEndpointRules::GetRulesAsString()
{
    return Aws::String(SecurityHubEndpointRules::Rules.begin(), SecurityHubEndpointRules::Rules.end());
}

const Aws::Vector<char> SecurityHubEndpointRules::Rules = {
