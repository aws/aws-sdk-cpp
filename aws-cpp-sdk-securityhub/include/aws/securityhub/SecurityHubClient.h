...
namespace SecurityHub
{
  ...
  class AWS_SECURITYHUB_API SecurityHubClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        SecurityHubClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                          std::shared_ptr<Endpoint::SecurityHubEndpointProvider> endpointProvider = Aws::MakeShared<SecurityHub::Endpoint::SecurityHubEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::SecurityHubEndpointProvider> m_endpointProvider;
  };
