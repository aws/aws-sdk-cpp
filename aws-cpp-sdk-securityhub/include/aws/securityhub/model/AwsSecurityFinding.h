...
namespace Model
{
   ...
   * (GuardDuty, Inspector, Macie) or by the integrated third-party solutions and
   * compliance checks.</p> </note><p><h3>See Also:</h3>   <a
  ...
  public:
    ...
    /**
     * <p>The schema version for which a finding is formatted.</p>
     */
     ...
     * that classify a finding.</p> <p>Valid namespace values are: Software and
     * Configuration Checks | TTPs | Effects | Unusual Behaviors | Sensitive Data
     * Identifications</p>
     */
    ...
    /**
     * <p>A set of resource data types that describe the resources to which the finding
     * refers.</p>
     */
     ...
     * check run against a specific rule in a supported standard (for example, AWS CIS
