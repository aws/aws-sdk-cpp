...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SECURITYHUB_API AwsBackupRecoveryPointLifecycleDetails
  {
  public:
    AwsBackupRecoveryPointLifecycleDetails();
    AwsBackupRecoveryPointLifecycleDetails(Aws::Utils::Json::JsonView jsonValue);
    AwsBackupRecoveryPointLifecycleDetails& operator=(Aws::Utils::Json::JsonView jsonValue);
