...
namespace Model
{
  ...
  /**
   * <p>The request was rejected because we can't find the specified
   * resource.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/securityhub-2018-10-26/ResourceNotFoundException">AWS
   * API Reference</a></p>
   */
  class AWS_SECURITYHUB_API ResourceNotFoundException
  {
  public:
