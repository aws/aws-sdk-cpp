...
namespace Model
{
  ...
  /**
   */
  class AWS_SECURITYHUB_API GetInsightResultsRequest : public SecurityHubRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetInsightResultsRequest> Clone() const
    {
      return Aws::MakeUnique<GetInsightResultsRequest>(GetServiceRequestName(), *this);
    }
