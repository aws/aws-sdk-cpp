...
namespace Model
{
  ...
  /**
   * <p>The account details that couldn't be processed.</p><p><h3>See Also:</h3>   <a
  ...
  public:
    ...
    /**
     * <p>An ID of the AWS account that couldn't be processed. </p>
     */
    ...
    /**
     * <p>The reason for why an account couldn't be processed.</p>
     */
