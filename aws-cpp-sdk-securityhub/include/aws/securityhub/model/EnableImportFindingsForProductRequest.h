...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<EnableImportFindingsForProductRequest> Clone() const
    {
      return Aws::MakeUnique<EnableImportFindingsForProductRequest>(GetServiceRequestName(), *this);
    }
