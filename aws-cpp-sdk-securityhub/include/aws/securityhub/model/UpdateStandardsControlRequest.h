...
namespace Model
{
  ...
  /**
   */
  class AWS_SECURITYHUB_API UpdateStandardsControlRequest : public SecurityHubRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateStandardsControlRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateStandardsControlRequest>(GetServiceRequestName(), *this);
    }
