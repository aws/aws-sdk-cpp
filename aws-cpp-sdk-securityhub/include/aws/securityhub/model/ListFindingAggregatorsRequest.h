...
namespace Model
{
  ...
  /**
   */
  class AWS_SECURITYHUB_API ListFindingAggregatorsRequest : public SecurityHubRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListFindingAggregatorsRequest> Clone() const
    {
      return Aws::MakeUnique<ListFindingAggregatorsRequest>(GetServiceRequestName(), *this);
    }
