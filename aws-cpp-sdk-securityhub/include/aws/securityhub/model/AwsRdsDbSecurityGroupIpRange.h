...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SECURITYHUB_API AwsRdsDbSecurityGroupIpRange
  {
  public:
    AwsRdsDbSecurityGroupIpRange();
    AwsRdsDbSecurityGroupIpRange(Aws::Utils::Json::JsonView jsonValue);
    AwsRdsDbSecurityGroupIpRange& operator=(Aws::Utils::Json::JsonView jsonValue);
