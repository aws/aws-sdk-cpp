...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SECURITYHUB_API AwsRdsDbStatusInfo
  {
  public:
    AwsRdsDbStatusInfo();
    AwsRdsDbStatusInfo(Aws::Utils::Json::JsonView jsonValue);
    AwsRdsDbStatusInfo& operator=(Aws::Utils::Json::JsonView jsonValue);
