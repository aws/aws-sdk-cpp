...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SECURITYHUB_API AwsApiCallActionDomainDetails
  {
  public:
    AwsApiCallActionDomainDetails();
    AwsApiCallActionDomainDetails(Aws::Utils::Json::JsonView jsonValue);
    AwsApiCallActionDomainDetails& operator=(Aws::Utils::Json::JsonView jsonValue);
