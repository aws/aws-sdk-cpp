...
namespace Model
{
  ...
  /**
   */
  class AWS_SECURITYHUB_API DeleteFindingAggregatorRequest : public SecurityHubRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteFindingAggregatorRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteFindingAggregatorRequest>(GetServiceRequestName(), *this);
    }
