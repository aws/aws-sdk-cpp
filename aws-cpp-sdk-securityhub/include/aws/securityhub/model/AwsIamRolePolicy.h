...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SECURITYHUB_API AwsIamRolePolicy
  {
  public:
    AwsIamRolePolicy();
    AwsIamRolePolicy(Aws::Utils::Json::JsonView jsonValue);
    AwsIamRolePolicy& operator=(Aws::Utils::Json::JsonView jsonValue);
