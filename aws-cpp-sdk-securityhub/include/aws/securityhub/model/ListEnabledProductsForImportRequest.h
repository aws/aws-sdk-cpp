...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListEnabledProductsForImportRequest> Clone() const
    {
      return Aws::MakeUnique<ListEnabledProductsForImportRequest>(GetServiceRequestName(), *this);
    }
