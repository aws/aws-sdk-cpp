...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SECURITYHUB_API AwsWafWebAclRule
  {
  public:
    AwsWafWebAclRule();
    AwsWafWebAclRule(Aws::Utils::Json::JsonView jsonValue);
    AwsWafWebAclRule& operator=(Aws::Utils::Json::JsonView jsonValue);
