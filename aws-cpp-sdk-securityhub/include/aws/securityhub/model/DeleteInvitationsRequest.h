...
namespace Model
{
  ...
  /**
   */
  class AWS_SECURITYHUB_API DeleteInvitationsRequest : public SecurityHubRequest
  {
  public:
    ...
    /**
     * <p>A list of account IDs that specify accounts whose invitations to Security Hub
