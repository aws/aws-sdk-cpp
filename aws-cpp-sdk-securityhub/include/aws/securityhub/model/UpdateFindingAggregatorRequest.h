...
namespace Model
{
  ...
  /**
   */
  class AWS_SECURITYHUB_API UpdateFindingAggregatorRequest : public SecurityHubRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateFindingAggregatorRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateFindingAggregatorRequest>(GetServiceRequestName(), *this);
    }
