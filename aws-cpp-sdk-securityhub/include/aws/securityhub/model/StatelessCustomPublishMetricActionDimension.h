...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SECURITYHUB_API StatelessCustomPublishMetricActionDimension
  {
  public:
    StatelessCustomPublishMetricActionDimension();
    StatelessCustomPublishMetricActionDimension(Aws::Utils::Json::JsonView jsonValue);
    StatelessCustomPublishMetricActionDimension& operator=(Aws::Utils::Json::JsonView jsonValue);
