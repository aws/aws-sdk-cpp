...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SECURITYHUB_API StandardsStatusReason
  {
  public:
    StandardsStatusReason();
    StandardsStatusReason(Aws::Utils::Json::JsonView jsonValue);
    StandardsStatusReason& operator=(Aws::Utils::Json::JsonView jsonValue);
