...
namespace Model
{
  ...
  /**
   */
  class AWS_SECURITYHUB_API CreateFindingAggregatorRequest : public SecurityHubRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateFindingAggregatorRequest> Clone() const
    {
      return Aws::MakeUnique<CreateFindingAggregatorRequest>(GetServiceRequestName(), *this);
    }
