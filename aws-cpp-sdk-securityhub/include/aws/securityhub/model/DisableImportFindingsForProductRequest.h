...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DisableImportFindingsForProductRequest> Clone() const
    {
      return Aws::MakeUnique<DisableImportFindingsForProductRequest>(GetServiceRequestName(), *this);
    }
