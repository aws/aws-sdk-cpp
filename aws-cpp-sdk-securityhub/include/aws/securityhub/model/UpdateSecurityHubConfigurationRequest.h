...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateSecurityHubConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateSecurityHubConfigurationRequest>(GetServiceRequestName(), *this);
    }
