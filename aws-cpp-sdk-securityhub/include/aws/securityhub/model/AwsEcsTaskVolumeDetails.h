...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SECURITYHUB_API AwsEcsTaskVolumeDetails
  {
  public:
    AwsEcsTaskVolumeDetails();
    AwsEcsTaskVolumeDetails(Aws::Utils::Json::JsonView jsonValue);
    AwsEcsTaskVolumeDetails& operator=(Aws::Utils::Json::JsonView jsonValue);
