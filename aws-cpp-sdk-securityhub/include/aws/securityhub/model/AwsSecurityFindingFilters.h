...
namespace Model
{
  ...
  public:
     ...
     * company (security findings provider) once this provider's product (solution that
     * generates findings) is registered with Security Hub.</p>
     */
    ...
    /**
     * <p>The AWS account ID in which a finding is generated.</p>
     */
    ...
    /**
     * <p>This is the identifier for the solution-specific component (a discrete unit
    ...
    /**
     * <p>A finding type in the format of 'namespace/category/classifier' that
    ...
    /**
     * <p>An ISO8601-formatted timestamp that indicates when the potential security
     * issue captured by a finding was first observed by the security findings
     * provider.</p>
     */
    ...
    /**
     * <p>An ISO8601-formatted timestamp that indicates when the potential security
     * issue captured by a finding was created by the security findings provider.</p>
     */
    ...
    /**
     * <p>An ISO8601-formatted timestamp that indicates when the finding record was
     * last updated by the security findings provider. </p>
     */
     ...
     * identify. Confidence is scored on a 0-100 basis using a ratio scale. 0 equates
     * zero percent confidence and 100 equates to 100 percent confidence.</p>
     */
