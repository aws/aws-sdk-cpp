...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SECURITYHUB_API StandardsManagedBy
  {
  public:
    StandardsManagedBy();
    StandardsManagedBy(Aws::Utils::Json::JsonView jsonValue);
    StandardsManagedBy& operator=(Aws::Utils::Json::JsonView jsonValue);
