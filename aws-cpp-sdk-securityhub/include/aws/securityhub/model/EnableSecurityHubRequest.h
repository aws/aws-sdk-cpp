...
namespace Model
{
  ...
  /**
   */
  class AWS_SECURITYHUB_API EnableSecurityHubRequest : public SecurityHubRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<EnableSecurityHubRequest> Clone() const
    {
      return Aws::MakeUnique<EnableSecurityHubRequest>(GetServiceRequestName(), *this);
    }
