...
{
const size_t MarketplaceMeteringEndpointRules::RulesBlobStrLen = 3510;
const size_t MarketplaceMeteringEndpointRules::RulesBlobSize = 3511;

using RulesBlobT = Aws::Array<const char, MarketplaceMeteringEndpointRules::RulesBlobSize>;
...
't','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','m','e','t','e','r','i',
'n','g','.','m','a','r','k','e','t','p','l','a','c','e','-','f','i','p','s','.','{','R','e','g','i',
...
'u','r','l','"',':','"','h','t','t','p','s',':','/','/','m','e','t','e','r','i','n','g','.','m','a',
...
'e','t','e','r','i','n','g','.','m','a','r','k','e','t','p','l','a','c','e','.','{','R','e','g','i',
'o','n','}','.','{','P','a','r','t','i','t','i','o','n','R','e','s','u','l','t','#','d','u','a','l',
'S','t','a','c','k','D','n','s','S','u','f','f','i','x','}','"',',','"','p','r','o','p','e','r','t',
'i','e','s','"',':','{','}',',','"','h','e','a','d','e','r','s','"',':','{','}','}',',','"','t','y',
'p','e','"',':','"','e','n','d','p','o','i','n','t','"','}',']','}',',','{','"','c','o','n','d','i',
...
const char* MarketplaceMeteringEndpointRules::GetRulesBlob()
{
