...
Aws::String MarketplaceMeteringEndpointRules::GetRulesAsString()
{
    return Aws::String(MarketplaceMeteringEndpointRules::Rules.begin(), MarketplaceMeteringEndpointRules::Rules.end());
}

const Aws::Vector<char> MarketplaceMeteringEndpointRules::Rules = {
