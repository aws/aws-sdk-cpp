...
Aws::String FISEndpointRules::GetRulesAsString()
{
    return Aws::String(FISEndpointRules::Rules.begin(), FISEndpointRules::Rules.end());
}

const Aws::Vector<char> FISEndpointRules::Rules = {
...
't','p','s',':','/','/','f','i','s','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{',
...
'p','s',':','/','/','f','i','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t',
