...
namespace FIS
{
  ...
  class AWS_FIS_API FISClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        FISClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                  std::shared_ptr<Endpoint::FISEndpointProvider> endpointProvider = Aws::MakeShared<FIS::Endpoint::FISEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::FISEndpointProvider> m_endpointProvider;
  };
