...
namespace Model
{
  ...
  /**
   */
  class AWS_FIS_API GetExperimentTemplateRequest : public FISRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetExperimentTemplateRequest> Clone() const
    {
      return Aws::MakeUnique<GetExperimentTemplateRequest>(GetServiceRequestName(), *this);
    }
