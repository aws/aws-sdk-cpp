...
namespace Model
{
  ...
  /**
   */
  class AWS_SIGNER_API ListProfilePermissionsRequest : public SignerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListProfilePermissionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListProfilePermissionsRequest>(GetServiceRequestName(), *this);
    }
