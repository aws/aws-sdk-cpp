...
namespace Model
{
  ...
  /**
   */
  class AWS_SIGNER_API RevokeSignatureRequest : public SignerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<RevokeSignatureRequest> Clone() const
    {
      return Aws::MakeUnique<RevokeSignatureRequest>(GetServiceRequestName(), *this);
    }
