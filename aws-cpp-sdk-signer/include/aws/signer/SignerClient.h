...
namespace signer
{
  ...
  class AWS_SIGNER_API SignerClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        SignerClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                     std::shared_ptr<Endpoint::SignerEndpointProvider> endpointProvider = Aws::MakeShared<signer::Endpoint::SignerEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::SignerEndpointProvider> m_endpointProvider;
  };
