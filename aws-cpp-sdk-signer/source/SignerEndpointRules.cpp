...
Aws::String SignerEndpointRules::GetRulesAsString()
{
    return Aws::String(SignerEndpointRules::Rules.begin(), SignerEndpointRules::Rules.end());
}

const Aws::Vector<char> SignerEndpointRules::Rules = {
...
'"','h','t','t','p','s',':','/','/','s','i','g','n','e','r','-','f','i','p','s','.','{','R','e','g',
...
':','/','/','s','i','g','n','e','r','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i',
