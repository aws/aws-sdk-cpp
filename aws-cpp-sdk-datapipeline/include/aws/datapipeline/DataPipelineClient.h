...
namespace DataPipeline
{
  ...
  class AWS_DATAPIPELINE_API DataPipelineClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        DataPipelineClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                           std::shared_ptr<Endpoint::DataPipelineEndpointProvider> endpointProvider = Aws::MakeShared<DataPipeline::Endpoint::DataPipelineEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::DataPipelineEndpointProvider> m_endpointProvider;
  };
