...
namespace Model
{
  ...
  typedef Aws::Utils::Event<DataPipelineClient, const Model::ActivatePipelineRequest&, const Model::ActivatePipelineOutcome&> ActivatePipelineOutcomeReceivedEvent;
  typedef Aws::Utils::Event<DataPipelineClient, const Model::AddTagsRequest&, const Model::AddTagsOutcome&> AddTagsOutcomeReceivedEvent;
  typedef Aws::Utils::Event<DataPipelineClient, const Model::CreatePipelineRequest&, const Model::CreatePipelineOutcome&> CreatePipelineOutcomeReceivedEvent;
  typedef Aws::Utils::Event<DataPipelineClient, const Model::DeactivatePipelineRequest&, const Model::DeactivatePipelineOutcome&> DeactivatePipelineOutcomeReceivedEvent;
  typedef Aws::Utils::Event<DataPipelineClient, const Model::DeletePipelineRequest&, const Model::DeletePipelineOutcome&> DeletePipelineOutcomeReceivedEvent;
  typedef Aws::Utils::Event<DataPipelineClient, const Model::DescribeObjectsRequest&, const Model::DescribeObjectsOutcome&> DescribeObjectsOutcomeReceivedEvent;
  typedef Aws::Utils::Event<DataPipelineClient, const Model::DescribePipelinesRequest&, const Model::DescribePipelinesOutcome&> DescribePipelinesOutcomeReceivedEvent;
  typedef Aws::Utils::Event<DataPipelineClient, const Model::EvaluateExpressionRequest&, const Model::EvaluateExpressionOutcome&> EvaluateExpressionOutcomeReceivedEvent;
  typedef Aws::Utils::Event<DataPipelineClient, const Model::GetPipelineDefinitionRequest&, const Model::GetPipelineDefinitionOutcome&> GetPipelineDefinitionOutcomeReceivedEvent;
  typedef Aws::Utils::Event<DataPipelineClient, const Model::ListPipelinesRequest&, const Model::ListPipelinesOutcome&> ListPipelinesOutcomeReceivedEvent;
  typedef Aws::Utils::Event<DataPipelineClient, const Model::PollForTaskRequest&, const Model::PollForTaskOutcome&> PollForTaskOutcomeReceivedEvent;
  typedef Aws::Utils::Event<DataPipelineClient, const Model::PutPipelineDefinitionRequest&, const Model::PutPipelineDefinitionOutcome&> PutPipelineDefinitionOutcomeReceivedEvent;
  typedef Aws::Utils::Event<DataPipelineClient, const Model::QueryObjectsRequest&, const Model::QueryObjectsOutcome&> QueryObjectsOutcomeReceivedEvent;
  typedef Aws::Utils::Event<DataPipelineClient, const Model::RemoveTagsRequest&, const Model::RemoveTagsOutcome&> RemoveTagsOutcomeReceivedEvent;
  typedef Aws::Utils::Event<DataPipelineClient, const Model::ReportTaskProgressRequest&, const Model::ReportTaskProgressOutcome&> ReportTaskProgressOutcomeReceivedEvent;
  typedef Aws::Utils::Event<DataPipelineClient, const Model::ReportTaskRunnerHeartbeatRequest&, const Model::ReportTaskRunnerHeartbeatOutcome&> ReportTaskRunnerHeartbeatOutcomeReceivedEvent;
  typedef Aws::Utils::Event<DataPipelineClient, const Model::SetStatusRequest&, const Model::SetStatusOutcome&> SetStatusOutcomeReceivedEvent;
  typedef Aws::Utils::Event<DataPipelineClient, const Model::SetTaskStatusRequest&, const Model::SetTaskStatusOutcome&> SetTaskStatusOutcomeReceivedEvent;
  typedef Aws::Utils::Event<DataPipelineClient, const Model::ValidatePipelineDefinitionRequest&, const Model::ValidatePipelineDefinitionOutcome&> ValidatePipelineDefinitionOutcomeReceivedEvent;
  ...
  */
  class AWS_DATAPIPELINE_API DataPipelineClient : public Aws::Client::AWSJsonClient
  {
     ...
     */
     void ActivatePipelineAsync(const Model::ActivatePipelineRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void DeactivatePipelineAsync(const Model::DeactivatePipelineRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void DescribeObjectsAsync(const Model::DescribeObjectsRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void DescribePipelinesAsync(const Model::DescribePipelinesRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void EvaluateExpressionAsync(const Model::EvaluateExpressionRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void GetPipelineDefinitionAsync(const Model::GetPipelineDefinitionRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void PollForTaskAsync(const Model::PollForTaskRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void PutPipelineDefinitionAsync(const Model::PutPipelineDefinitionRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void QueryObjectsAsync(const Model::QueryObjectsRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void ReportTaskProgressAsync(const Model::ReportTaskProgressRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void ReportTaskRunnerHeartbeatAsync(const Model::ReportTaskRunnerHeartbeatRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void SetStatusAsync(const Model::SetStatusRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void SetTaskStatusAsync(const Model::SetTaskStatusRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void ValidatePipelineDefinitionAsync(const Model::ValidatePipelineDefinitionRequest& request) const;
  ...
  private:
    ...
    /**Async helpers**/
    void ActivatePipelineAsyncHelper(const Model::ActivatePipelineRequest& request) const;
    ...
    void DeactivatePipelineAsyncHelper(const Model::DeactivatePipelineRequest& request) const;
    void DeletePipelineAsyncHelper(const Model::DeletePipelineRequest& request) const;
    void DescribeObjectsAsyncHelper(const Model::DescribeObjectsRequest& request) const;
    void DescribePipelinesAsyncHelper(const Model::DescribePipelinesRequest& request) const;
    void EvaluateExpressionAsyncHelper(const Model::EvaluateExpressionRequest& request) const;
    void GetPipelineDefinitionAsyncHelper(const Model::GetPipelineDefinitionRequest& request) const;
    void ListPipelinesAsyncHelper(const Model::ListPipelinesRequest& request) const;
    void PollForTaskAsyncHelper(const Model::PollForTaskRequest& request) const;
    void PutPipelineDefinitionAsyncHelper(const Model::PutPipelineDefinitionRequest& request) const;
    void QueryObjectsAsyncHelper(const Model::QueryObjectsRequest& request) const;
    void RemoveTagsAsyncHelper(const Model::RemoveTagsRequest& request) const;
    void ReportTaskProgressAsyncHelper(const Model::ReportTaskProgressRequest& request) const;
    void ReportTaskRunnerHeartbeatAsyncHelper(const Model::ReportTaskRunnerHeartbeatRequest& request) const;
    void SetStatusAsyncHelper(const Model::SetStatusRequest& request) const;
    void SetTaskStatusAsyncHelper(const Model::SetTaskStatusRequest& request) const;
    void ValidatePipelineDefinitionAsyncHelper(const Model::ValidatePipelineDefinitionRequest& request) const;
