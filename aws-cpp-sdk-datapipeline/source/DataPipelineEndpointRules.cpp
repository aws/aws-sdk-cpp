...
Aws::String DataPipelineEndpointRules::GetRulesAsString()
{
    return Aws::String(DataPipelineEndpointRules::Rules.begin(), DataPipelineEndpointRules::Rules.end());
}

const Aws::Vector<char> DataPipelineEndpointRules::Rules = {
...
'p','s',':','/','/','d','a','t','a','p','i','p','e','l','i','n','e','-','f','i','p','s','.','{','R',
...
'a','t','a','p','i','p','e','l','i','n','e','.','{','R','e','g','i','o','n','}','.','{','P','a','r',
