...
using ResolveEndpointOutcome = Aws::DataPipeline::Endpoint::DataPipelineEndpointProvider::DataPipelineResolveEndpointOutcome;
...
DataPipelineClient::DataPipelineClient(const Client::ClientConfiguration& clientConfiguration,
                                       std::shared_ptr<Endpoint::DataPipelineEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<DataPipelineErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<DataPipeline::Endpoint::DataPipelineEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
