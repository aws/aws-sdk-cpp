...
using ResolveEndpointOutcome = Aws::ChimeSDKIdentity::Endpoint::ChimeSDKIdentityEndpointProvider::ChimeSDKIdentityResolveEndpointOutcome;
...
ChimeSDKIdentityClient::ChimeSDKIdentityClient(const Client::ClientConfiguration& clientConfiguration,
                                               std::shared_ptr<Endpoint::ChimeSDKIdentityEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<ChimeSDKIdentityErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<ChimeSDKIdentity::Endpoint::ChimeSDKIdentityEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
