...
Aws::String ChimeSDKIdentityEndpointRules::GetRulesAsString()
{
    return Aws::String(ChimeSDKIdentityEndpointRules::Rules.begin(), ChimeSDKIdentityEndpointRules::Rules.end());
}

const Aws::Vector<char> ChimeSDKIdentityEndpointRules::Rules = {
...
't','y','-','c','h','i','m','e','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P',
...
'h','t','t','p','s',':','/','/','i','d','e','n','t','i','t','y','-','c','h','i','m','e','-','f','i',
...
'l','"',':','"','h','t','t','p','s',':','/','/','i','d','e','n','t','i','t','y','-','c','h','i','m',
...
't','p','s',':','/','/','i','d','e','n','t','i','t','y','-','c','h','i','m','e','.','{','R','e','g',
