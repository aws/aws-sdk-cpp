...
namespace ChimeSDKIdentity
{
  ...
  class AWS_CHIMESDKIDENTITY_API ChimeSDKIdentityClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        ChimeSDKIdentityClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                               std::shared_ptr<Endpoint::ChimeSDKIdentityEndpointProvider> endpointProvider = Aws::MakeShared<ChimeSDKIdentity::Endpoint::ChimeSDKIdentityEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::ChimeSDKIdentityEndpointProvider> m_endpointProvider;
  };
