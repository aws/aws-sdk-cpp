...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<RegisterAppInstanceUserEndpointRequest> Clone() const
    {
      return Aws::MakeUnique<RegisterAppInstanceUserEndpointRequest>(GetServiceRequestName(), *this);
    }
