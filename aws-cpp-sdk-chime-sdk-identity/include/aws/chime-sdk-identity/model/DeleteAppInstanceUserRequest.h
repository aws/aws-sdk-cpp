...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIMESDKIDENTITY_API DeleteAppInstanceUserRequest : public ChimeSDKIdentityRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteAppInstanceUserRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteAppInstanceUserRequest>(GetServiceRequestName(), *this);
    }
