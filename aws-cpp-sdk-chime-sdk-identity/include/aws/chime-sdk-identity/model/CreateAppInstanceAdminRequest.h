...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIMESDKIDENTITY_API CreateAppInstanceAdminRequest : public ChimeSDKIdentityRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateAppInstanceAdminRequest> Clone() const
    {
      return Aws::MakeUnique<CreateAppInstanceAdminRequest>(GetServiceRequestName(), *this);
    }
