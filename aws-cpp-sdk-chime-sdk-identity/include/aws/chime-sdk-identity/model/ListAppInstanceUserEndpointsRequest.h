...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIMESDKIDENTITY_API ListAppInstanceUserEndpointsRequest : public ChimeSDKIdentityRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListAppInstanceUserEndpointsRequest> Clone() const
    {
      return Aws::MakeUnique<ListAppInstanceUserEndpointsRequest>(GetServiceRequestName(), *this);
    }
