...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIMESDKIDENTITY_API UpdateAppInstanceUserEndpointRequest : public ChimeSDKIdentityRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateAppInstanceUserEndpointRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateAppInstanceUserEndpointRequest>(GetServiceRequestName(), *this);
    }
