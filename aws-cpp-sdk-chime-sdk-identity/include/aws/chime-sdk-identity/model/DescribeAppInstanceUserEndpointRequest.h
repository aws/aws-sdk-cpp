...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeAppInstanceUserEndpointRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeAppInstanceUserEndpointRequest>(GetServiceRequestName(), *this);
    }
