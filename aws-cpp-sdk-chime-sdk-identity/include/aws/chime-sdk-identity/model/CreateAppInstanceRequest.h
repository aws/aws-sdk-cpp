...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIMESDKIDENTITY_API CreateAppInstanceRequest : public ChimeSDKIdentityRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateAppInstanceRequest> Clone() const
    {
      return Aws::MakeUnique<CreateAppInstanceRequest>(GetServiceRequestName(), *this);
    }
