...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIMESDKIDENTITY_API ListAppInstanceUsersRequest : public ChimeSDKIdentityRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListAppInstanceUsersRequest> Clone() const
    {
      return Aws::MakeUnique<ListAppInstanceUsersRequest>(GetServiceRequestName(), *this);
    }
