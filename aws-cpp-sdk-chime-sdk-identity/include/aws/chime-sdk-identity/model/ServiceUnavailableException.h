...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/chime-sdk-identity-2021-04-20/ServiceUnavailableException">AWS
   * API Reference</a></p>
   */
  class AWS_CHIMESDKIDENTITY_API ServiceUnavailableException
  {
  public:
