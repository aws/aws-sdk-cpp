...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIMESDKIDENTITY_API DescribeAppInstanceAdminRequest : public ChimeSDKIdentityRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeAppInstanceAdminRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeAppInstanceAdminRequest>(GetServiceRequestName(), *this);
    }
