...
namespace WAFV2
{
  ...
  class AWS_WAFV2_API WAFV2Client : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        WAFV2Client(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                    std::shared_ptr<Endpoint::WAFV2EndpointProvider> endpointProvider = Aws::MakeShared<WAFV2::Endpoint::WAFV2EndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::WAFV2EndpointProvider> m_endpointProvider;
  };
