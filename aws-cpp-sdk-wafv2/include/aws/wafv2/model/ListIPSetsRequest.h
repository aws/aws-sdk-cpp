...
namespace Model
{
  ...
  {
  public:
    AWS_WAFV2_API ListIPSetsRequest();
     ...
     * the Region endpoint us-east-1. </p> </li> </ul>
     */
    inline ListIPSetsRequest& WithScope(const Scope& value) { SetScope(value); return *this;}
     ...
     * the Region endpoint us-east-1. </p> </li> </ul>
     */
    inline ListIPSetsRequest& WithScope(Scope&& value) { SetScope(std::move(value)); return *this;}
