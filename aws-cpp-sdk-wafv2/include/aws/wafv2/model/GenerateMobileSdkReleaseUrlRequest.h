...
namespace Model
{
  ...
  /**
   */
  class AWS_WAFV2_API GenerateMobileSdkReleaseUrlRequest : public WAFV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GenerateMobileSdkReleaseUrlRequest> Clone() const
    {
      return Aws::MakeUnique<GenerateMobileSdkReleaseUrlRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "GenerateMobileSdkReleaseUrl"; }
     ...
     * <code>LATEST</code>.</p>
     */
    inline GenerateMobileSdkReleaseUrlRequest& WithReleaseVersion(const char* value) { SetReleaseVersion(value); return *this;}
