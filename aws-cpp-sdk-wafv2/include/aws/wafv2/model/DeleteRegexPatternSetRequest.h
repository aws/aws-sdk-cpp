...
namespace Model
{
  ...
  /**
   */
  class AWS_WAFV2_API DeleteRegexPatternSetRequest : public WAFV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteRegexPatternSetRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteRegexPatternSetRequest>(GetServiceRequestName(), *this);
    }
     ...
     * another <code>get</code>, and use the new token returned by that operation. </p>
     */
    inline DeleteRegexPatternSetRequest& WithLockToken(const char* value) { SetLockToken(value); return *this;}
