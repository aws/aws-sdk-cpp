...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_WAFV2_API AWSManagedRulesBotControlRuleSet
  {
  public:
    AWSManagedRulesBotControlRuleSet();
    AWSManagedRulesBotControlRuleSet(Aws::Utils::Json::JsonView jsonValue);
    AWSManagedRulesBotControlRuleSet& operator=(Aws::Utils::Json::JsonView jsonValue);
