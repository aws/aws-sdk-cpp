...
namespace Model
{
   ...
   * customers, and Marketplace managed rule groups, which you can subscribe to
   * through Marketplace. </p><p><h3>See Also:</h3>   <a
  ...
  public:
     ...
     * Managed Rules or the Marketplace seller who manages it.</p>
     */
