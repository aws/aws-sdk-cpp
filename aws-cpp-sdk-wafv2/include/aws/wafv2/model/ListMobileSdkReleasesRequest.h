...
namespace Model
{
  ...
  /**
   */
  class AWS_WAFV2_API ListMobileSdkReleasesRequest : public WAFV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListMobileSdkReleasesRequest> Clone() const
    {
      return Aws::MakeUnique<ListMobileSdkReleasesRequest>(GetServiceRequestName(), *this);
    }
