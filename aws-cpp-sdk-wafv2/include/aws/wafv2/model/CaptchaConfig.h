...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_WAFV2_API CaptchaConfig
  {
  public:
    CaptchaConfig();
    CaptchaConfig(Aws::Utils::Json::JsonView jsonValue);
    CaptchaConfig& operator=(Aws::Utils::Json::JsonView jsonValue);
    Aws::Utils::Json::JsonValue Jsonize() const;


    /**
     * <p>Determines how long a <code>CAPTCHA</code> token remains valid after the
     * client successfully solves a <code>CAPTCHA</code> puzzle. </p>
     */
