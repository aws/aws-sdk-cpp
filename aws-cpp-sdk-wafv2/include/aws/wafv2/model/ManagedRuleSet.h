...
namespace Model
{
  ...
  /**
   * <p>A set of rules that is managed by Amazon Web Services and Marketplace sellers
   * to provide versioned managed rule groups for customers of WAF.</p> 
   * <p>This is intended for use only by vendors of managed rule sets. Vendors are
   * Amazon Web Services and Marketplace sellers. </p> <p>Vendors, you can use the
   ...
   * API Reference</a></p>
   */
  class AWS_WAFV2_API ManagedRuleSet
  {
  public:
    ManagedRuleSet();
    ManagedRuleSet(Aws::Utils::Json::JsonView jsonValue);
    ManagedRuleSet& operator=(Aws::Utils::Json::JsonView jsonValue);
