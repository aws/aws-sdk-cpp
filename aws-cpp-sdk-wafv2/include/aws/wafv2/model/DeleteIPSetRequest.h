...
namespace Model
{
  ...
  /**
   */
  class AWS_WAFV2_API DeleteIPSetRequest : public WAFV2Request
  {
  public:
    DeleteIPSetRequest();
    ...
    */
    virtual Aws::UniquePtr<DeleteIPSetRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteIPSetRequest>(GetServiceRequestName(), *this);
    }
