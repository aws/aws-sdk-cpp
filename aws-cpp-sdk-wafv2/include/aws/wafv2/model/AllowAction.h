...
namespace Model
{
  ...
  /**
   * <p>Specifies that AWS WAF should allow the request and optionally defines
   * additional custom handling for the request.</p> <p>This is used in the context
   * of other settings, for example to specify values for <a>RuleAction</a> and web
   * ACL <a>DefaultAction</a>. </p><p><h3>See Also:</h3>   <a
