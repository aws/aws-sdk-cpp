...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>References the response body that you want AWS WAF to return to the web
     * request client. You can define a custom response for a rule action or a default
     * web ACL action that is set to block. To do this, you first define the response
     * body key and value in the <code>CustomResponseBodies</code> setting for the
     * <a>WebACL</a> or <a>RuleGroup</a> where you want to use it. Then, in the rule
     * action or web ACL default action <code>BlockAction</code> setting, you reference
