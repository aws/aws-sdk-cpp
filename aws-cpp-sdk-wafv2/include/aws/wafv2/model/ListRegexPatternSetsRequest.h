...
namespace Model
{
  ...
  /**
   */
  class AWS_WAFV2_API ListRegexPatternSetsRequest : public WAFV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListRegexPatternSetsRequest> Clone() const
    {
      return Aws::MakeUnique<ListRegexPatternSetsRequest>(GetServiceRequestName(), *this);
    }
