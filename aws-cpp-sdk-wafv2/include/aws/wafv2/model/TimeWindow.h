...
namespace Model
{
   ...
   * WAF Developer Guide</a>. </p>  <p>In a <a>GetSampledRequests</a> request,
   * the <code>StartTime</code> and <code>EndTime</code> objects specify the time
   * range for which you want AWS WAF to return a sample of web requests.</p> <p>You
   ...
   * three hours.</p> <p>In a <a>GetSampledRequests</a> response, the
   * <code>StartTime</code> and <code>EndTime</code> objects specify the time range
   * for which AWS WAF actually returned a sample of web requests. AWS WAF gets the
   ...
   * received the 5,000th request.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/wafv2-2019-07-29/TimeWindow">AWS
   * API Reference</a></p>
   */
  class AWS_WAFV2_API TimeWindow
  {
  public:
    TimeWindow();
     ...
     * resource received. You must specify the times in Coordinated Universal Time
     * (UTC) format. UTC format includes the special designator, <code>Z</code>. For
     * example, <code>"2016-09-27T14:50Z"</code>. You can specify any time range in the
