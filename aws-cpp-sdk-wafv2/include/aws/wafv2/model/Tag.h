...
namespace Model
{
   ...
   * tags to add to each AWS resource, up to 50 tags for a resource.</p> <p>You can
   * tag the AWS resources that you manage through AWS WAF: web ACLs, rule groups, IP
   * sets, and regex pattern sets. You can't manage or view tags through the AWS WAF
   * console. </p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/wafv2-2019-07-29/Tag">AWS API
   * Reference</a></p>
   */
  class AWS_WAFV2_API Tag
  {
  public:
    Tag();
