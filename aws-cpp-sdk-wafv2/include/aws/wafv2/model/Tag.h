...
namespace Model
{
   ...
   * WAF Developer Guide</a>. </p> </note> <p>A collection of key:value pairs
   * associated with an AWS resource. The key:value pair can be anything you define.
   * Typically, the tag key represents a category (such as "environment") and the tag
