...
namespace Model
{
   ...
   * <code>CAPTCHA</code> token, WAF allows the web request inspection to proceed to
   * the next rule, similar to a <code>CountAction</code>. </p> </li> <li> <p>If the
   * request doesn't include a valid, unexpired <code>CAPTCHA</code> token, WAF
   * discontinues the web ACL evaluation of the request and blocks it from going to
   * its intended destination.</p> <p>WAF generates a response that it sends back to
   * the client, which includes the following: </p> <ul> <li> <p>The header
   ...
   * <code>text/html</code>, the response includes a <code>CAPTCHA</code> challenge.
   * </p> </li> </ul> </li> </ul> <p>You can configure the expiration time in the
