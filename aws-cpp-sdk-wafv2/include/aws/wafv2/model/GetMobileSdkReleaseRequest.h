...
namespace Model
{
  ...
  /**
   */
  class AWS_WAFV2_API GetMobileSdkReleaseRequest : public WAFV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetMobileSdkReleaseRequest> Clone() const
    {
      return Aws::MakeUnique<GetMobileSdkReleaseRequest>(GetServiceRequestName(), *this);
    }
