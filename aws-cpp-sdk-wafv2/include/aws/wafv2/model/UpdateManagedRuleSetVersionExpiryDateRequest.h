...
namespace Model
{
  ...
  /**
   */
  class AWS_WAFV2_API UpdateManagedRuleSetVersionExpiryDateRequest : public WAFV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateManagedRuleSetVersionExpiryDateRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateManagedRuleSetVersionExpiryDateRequest>(GetServiceRequestName(), *this);
    }
