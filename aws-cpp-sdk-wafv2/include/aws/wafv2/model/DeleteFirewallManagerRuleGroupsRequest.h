...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteFirewallManagerRuleGroupsRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteFirewallManagerRuleGroupsRequest>(GetServiceRequestName(), *this);
    }
