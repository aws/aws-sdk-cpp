...
namespace Model
{
  ...
  /**
   */
  class AWS_WAFV2_API ListAvailableManagedRuleGroupVersionsRequest : public WAFV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListAvailableManagedRuleGroupVersionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListAvailableManagedRuleGroupVersionsRequest>(GetServiceRequestName(), *this);
    }
