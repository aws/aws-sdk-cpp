...
namespace Model
{
  ...
  /**
   * <p>The collection of tagging definitions for an AWS resource. Tags are key:value
   ...
   * one or more tags to add to each AWS resource, up to 50 tags for a resource.</p>
