...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetRateBasedStatementManagedKeysRequest> Clone() const
    {
      return Aws::MakeUnique<GetRateBasedStatementManagedKeysRequest>(GetServiceRequestName(), *this);
    }
