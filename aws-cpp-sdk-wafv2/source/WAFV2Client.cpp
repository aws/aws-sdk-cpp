...
using ResolveEndpointOutcome = Aws::WAFV2::Endpoint::WAFV2EndpointProvider::WAFV2ResolveEndpointOutcome;
...
WAFV2Client::WAFV2Client(const Client::ClientConfiguration& clientConfiguration,
                         std::shared_ptr<Endpoint::WAFV2EndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<WAFV2ErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<WAFV2::Endpoint::WAFV2EndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
