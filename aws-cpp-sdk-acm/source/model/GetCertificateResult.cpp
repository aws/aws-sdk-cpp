...
GetCertificateResult::GetCertificateResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

GetCertificateResult& GetCertificateResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
