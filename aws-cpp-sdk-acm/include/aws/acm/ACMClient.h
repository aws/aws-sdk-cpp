...
namespace ACM
{
  ...
  class AWS_ACM_API ACMClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        ACMClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                  std::shared_ptr<Endpoint::ACMEndpointProvider> endpointProvider = Aws::MakeShared<ACM::Endpoint::ACMEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::ACMEndpointProvider> m_endpointProvider;
  };
