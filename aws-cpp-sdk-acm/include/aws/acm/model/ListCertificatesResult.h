...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p> If the list has been truncated, this value is present and should be used for
     * the <code>NextToken</code> input parameter on your next call to
     * <code>ListCertificates</code>. </p>
     */
    ...
    /**
     * <p> A list of the certificate ARNs. </p>
     */
