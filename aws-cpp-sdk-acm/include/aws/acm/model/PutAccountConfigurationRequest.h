...
namespace Model
{
  ...
  /**
   */
  class AWS_ACM_API PutAccountConfigurationRequest : public ACMRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutAccountConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<PutAccountConfigurationRequest>(GetServiceRequestName(), *this);
    }
