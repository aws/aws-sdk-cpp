...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetRightsizingRecommendationRequest> Clone() const
    {
      return Aws::MakeUnique<GetRightsizingRecommendationRequest>(GetServiceRequestName(), *this);
    }
