...
namespace Model
{
  ...
  /**
   */
  class AWS_COSTEXPLORER_API UpdateCostAllocationTagsStatusRequest : public CostExplorerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateCostAllocationTagsStatusRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateCostAllocationTagsStatusRequest>(GetServiceRequestName(), *this);
    }
