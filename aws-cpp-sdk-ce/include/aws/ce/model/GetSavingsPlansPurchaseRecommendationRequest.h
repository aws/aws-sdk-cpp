...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetSavingsPlansPurchaseRecommendationRequest> Clone() const
    {
      return Aws::MakeUnique<GetSavingsPlansPurchaseRecommendationRequest>(GetServiceRequestName(), *this);
    }
