...
namespace Model
{
  ...
  /**
   */
  class AWS_COSTEXPLORER_API UpdateAnomalyMonitorRequest : public CostExplorerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateAnomalyMonitorRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateAnomalyMonitorRequest>(GetServiceRequestName(), *this);
    }
