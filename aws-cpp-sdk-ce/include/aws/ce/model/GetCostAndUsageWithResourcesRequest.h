...
namespace Model
{
  ...
  /**
   */
  class AWS_COSTEXPLORER_API GetCostAndUsageWithResourcesRequest : public CostExplorerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetCostAndUsageWithResourcesRequest> Clone() const
    {
      return Aws::MakeUnique<GetCostAndUsageWithResourcesRequest>(GetServiceRequestName(), *this);
    }
