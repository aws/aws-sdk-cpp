...
namespace Model
{
  ...
  /**
   */
  class AWS_COSTEXPLORER_API GetAnomalyMonitorsRequest : public CostExplorerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetAnomalyMonitorsRequest> Clone() const
    {
      return Aws::MakeUnique<GetAnomalyMonitorsRequest>(GetServiceRequestName(), *this);
    }
