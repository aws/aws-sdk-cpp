...
namespace Model
{
  ...
  /**
   */
  class AWS_COSTEXPLORER_API DeleteCostCategoryDefinitionRequest : public CostExplorerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteCostCategoryDefinitionRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteCostCategoryDefinitionRequest>(GetServiceRequestName(), *this);
    }
