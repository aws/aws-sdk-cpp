...
namespace Model
{
  ...
  public:
     ...
     * <li> <p>INSTANCE_TYPE - The type of EC2 instance. An example is
     ...
     * <code>CreateBucket</code>.</p> </li> <li> <p>PLATFORM - The EC2 operating
     ...
     * response for this operation includes a unit attribute.</p> </li> <li>
     ...
     * <code>MultiAZ</code>.</p> </li> <li> <p>INSTANCE_TYPE - The type of EC2
     ...
     * <li> <p>PLATFORM - The EC2 operating system. Examples are Windows or Linux.</p>
     * </li> <li> <p>REGION - The AWS Region.</p> </li> <li> <p>SCOPE (Utilization
     * only) - The scope of a Reserved Instance (RI). Values are regional or a single
     * Availability Zone.</p> </li> <li> <p>TAG (Coverage only) - The tags that are
     * associated with a Reserved Instance (RI).</p> </li> <li> <p>TENANCY - The
