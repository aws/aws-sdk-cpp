...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateCostCategoryDefinitionRequest> Clone() const
    {
      return Aws::MakeUnique<CreateCostCategoryDefinitionRequest>(GetServiceRequestName(), *this);
    }
