...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeCostCategoryDefinitionRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeCostCategoryDefinitionRequest>(GetServiceRequestName(), *this);
    }
