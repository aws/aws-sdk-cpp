...
namespace Model
{
  ...
  /**
   */
  class AWS_COSTEXPLORER_API ListCostAllocationTagsRequest : public CostExplorerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListCostAllocationTagsRequest> Clone() const
    {
      return Aws::MakeUnique<ListCostAllocationTagsRequest>(GetServiceRequestName(), *this);
    }
