...
namespace Model
{
  ...
  /**
   */
  class AWS_COSTEXPLORER_API DeleteAnomalyMonitorRequest : public CostExplorerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteAnomalyMonitorRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteAnomalyMonitorRequest>(GetServiceRequestName(), *this);
    }
