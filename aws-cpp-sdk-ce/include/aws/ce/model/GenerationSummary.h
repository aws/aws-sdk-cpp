...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_COSTEXPLORER_API GenerationSummary
  {
  public:
    GenerationSummary();
    GenerationSummary(Aws::Utils::Json::JsonView jsonValue);
    GenerationSummary& operator=(Aws::Utils::Json::JsonView jsonValue);
