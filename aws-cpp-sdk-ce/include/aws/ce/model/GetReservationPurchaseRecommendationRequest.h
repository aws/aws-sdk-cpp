...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetReservationPurchaseRecommendationRequest> Clone() const
    {
      return Aws::MakeUnique<GetReservationPurchaseRecommendationRequest>(GetServiceRequestName(), *this);
    }
