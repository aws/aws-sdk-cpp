...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateCostCategoryDefinitionRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateCostCategoryDefinitionRequest>(GetServiceRequestName(), *this);
    }
