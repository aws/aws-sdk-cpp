...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListCostCategoryDefinitionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListCostCategoryDefinitionsRequest>(GetServiceRequestName(), *this);
    }
