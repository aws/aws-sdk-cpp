...
namespace Model
{
  ...
  public:
    ...
    ReservationPurchaseRecommendationDetail(const Aws::Utils::Json::JsonValue& jsonValue);
    ReservationPurchaseRecommendationDetail& operator=(const Aws::Utils::Json::JsonValue& jsonValue);
