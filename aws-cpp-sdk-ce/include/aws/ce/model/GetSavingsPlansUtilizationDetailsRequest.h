...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetSavingsPlansUtilizationDetailsRequest> Clone() const
    {
      return Aws::MakeUnique<GetSavingsPlansUtilizationDetailsRequest>(GetServiceRequestName(), *this);
    }
