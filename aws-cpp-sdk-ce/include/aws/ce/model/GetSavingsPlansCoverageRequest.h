...
namespace Model
{
  ...
  /**
   */
  class AWS_COSTEXPLORER_API GetSavingsPlansCoverageRequest : public CostExplorerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetSavingsPlansCoverageRequest> Clone() const
    {
      return Aws::MakeUnique<GetSavingsPlansCoverageRequest>(GetServiceRequestName(), *this);
    }
