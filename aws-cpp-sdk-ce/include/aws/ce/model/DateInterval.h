...
namespace Model
{
  ...
  public:
     ...
     * if <code>start</code> is <code>2017-01-01</code>, AWS retrieves cost and usage
     * data starting at <code>2017-01-01</code> up to the end date. The start date must
     ...
     * <code>end</code> is <code>2017-05-01</code>, AWS retrieves cost and usage data
     * from the start date up to, but not including, <code>2017-05-01</code>.</p>
     */
