...
namespace Model
{
  ...
  /**
   * <p>Reservation coverage, in hours.</p><p><h3>See Also:</h3>   <a
  ...
  public:
    CoverageByTime();
    CoverageByTime(const Aws::Utils::Json::JsonValue& jsonValue);
    CoverageByTime& operator=(const Aws::Utils::Json::JsonValue& jsonValue);
    ...
    /**
     * <p>The group of instances that a reservation covered.</p>
     */
