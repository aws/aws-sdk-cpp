...
namespace Model
{
  ...
  /**
   * <p>Can occur if you specify a number of tags for a resource greater than the
   * maximum 50 user tags per resource.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/ce-2017-10-25/TooManyTagsException">AWS
   * API Reference</a></p>
   */
  class AWS_COSTEXPLORER_API TooManyTagsException
  {
  public:
