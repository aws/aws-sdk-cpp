...
{
  /**
   * <p>Contains the output of <a>CreateDeliveryStream</a>.</p><p><h3>See Also:</h3> 
   * <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/firehose-2015-08-04/CreateDeliveryStreamOutput">AWS
   * API Reference</a></p>
   */
