...
namespace Model
{
  ...
  /**
   */
  class AWS_FIREHOSE_API UntagDeliveryStreamRequest : public FirehoseRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UntagDeliveryStreamRequest> Clone() const
    {
      return Aws::MakeUnique<UntagDeliveryStreamRequest>(GetServiceRequestName(), *this);
    }
