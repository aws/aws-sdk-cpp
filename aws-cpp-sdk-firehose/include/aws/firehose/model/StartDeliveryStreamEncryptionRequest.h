...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<StartDeliveryStreamEncryptionRequest> Clone() const
    {
      return Aws::MakeUnique<StartDeliveryStreamEncryptionRequest>(GetServiceRequestName(), *this);
    }
