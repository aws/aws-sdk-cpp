...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_FIREHOSE_API HttpEndpointDescription
  {
  public:
    HttpEndpointDescription();
    HttpEndpointDescription(Aws::Utils::Json::JsonView jsonValue);
    HttpEndpointDescription& operator=(Aws::Utils::Json::JsonView jsonValue);
