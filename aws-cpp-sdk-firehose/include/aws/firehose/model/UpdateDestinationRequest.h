...
namespace Model
{
  ...
  public:
     ...
     * <a>DeliveryStreamDescription</a>. This value is required, and it helps the
     * service perform conditional operations. For example, if there is an interleaving
     * update and this value is null, then the update destination fails. After the
     * update is successful, the <code>VersionId</code> value is updated. The service
     * then performs a merge of the old configuration with the new configuration.</p>
     */
