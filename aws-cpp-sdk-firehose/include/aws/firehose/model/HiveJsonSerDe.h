...
namespace Model
{
  ...
  public:
    HiveJsonSerDe();
    HiveJsonSerDe(const Aws::Utils::Json::JsonValue& jsonValue);
    HiveJsonSerDe& operator=(const Aws::Utils::Json::JsonValue& jsonValue);
    Aws::Utils::Json::JsonValue Jsonize() const;


    /**
     * <p>Indicates how you want Kinesis Data Firehose to parse the date and time
     * stamps that may be present in your input data JSON. To specify these format
     * strings, follow the pattern syntax of JodaTime's DateTimeFormat format strings.
     ...
     * parse time stamps in epoch milliseconds. If you don't specify a format, Kinesis
