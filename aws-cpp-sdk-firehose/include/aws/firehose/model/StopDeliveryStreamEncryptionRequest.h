...
namespace Model
{
  ...
  /**
   */
  class AWS_FIREHOSE_API StopDeliveryStreamEncryptionRequest : public FirehoseRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StopDeliveryStreamEncryptionRequest> Clone() const
    {
      return Aws::MakeUnique<StopDeliveryStreamEncryptionRequest>(GetServiceRequestName(), *this);
    }
