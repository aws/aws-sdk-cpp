...
namespace Model
{
  ...
  public:
     ...
     * COPY command</a>. Some possible examples that would apply to Amazon Kinesis
     * Firehose are as follows.</p> <p><code>delimiter '\t' lzop;</code> - fields are
     * delimited with "\t" (TAB character) and compressed using lzop.</p>
     * <p><code>delimiter '|</code> - fields are delimited with "|" (this is the
     * default delimiter).</p> <p><code>delimiter '|' escape</code> - the delimiter
     * should be escaped.</p> <p><code>fixedwidth
     ...
     * Redshift COPY command exmaples</a>.</p>
     */
