...
Aws::String FirehoseEndpointRules::GetRulesAsString()
{
    return Aws::String(FirehoseEndpointRules::Rules.begin(), FirehoseEndpointRules::Rules.end());
}

const Aws::Vector<char> FirehoseEndpointRules::Rules = {
...
'/','/','f','i','r','e','h','o','s','e','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.',
...
'f','i','r','e','h','o','s','e','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t',
...
'r','l','"',':','"','h','t','t','p','s',':','/','/','f','i','r','e','h','o','s','e','.','{','R','e',
