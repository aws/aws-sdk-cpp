...
using ResolveEndpointOutcome = Aws::Firehose::Endpoint::FirehoseEndpointProvider::FirehoseResolveEndpointOutcome;
...
FirehoseClient::FirehoseClient(const Client::ClientConfiguration& clientConfiguration,
                               std::shared_ptr<Endpoint::FirehoseEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<FirehoseErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<Firehose::Endpoint::FirehoseEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
