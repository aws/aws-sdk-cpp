...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<RemoveRegionsFromReplicationRequest> Clone() const
    {
      return Aws::MakeUnique<RemoveRegionsFromReplicationRequest>(GetServiceRequestName(), *this);
    }
