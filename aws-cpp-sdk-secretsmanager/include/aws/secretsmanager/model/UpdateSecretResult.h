...
namespace Model
{
  ...
  public:
     ...
     * <i>don't</i> automatically get access to the new secret because the ARNs are
     * different.</p> </note>
     */
    ...
    /**
     * <p>If a version of the secret was created or updated by this operation, then its
     * unique identifier is returned.</p>
     */
