...
namespace SecretsManager
{
  ...
  class AWS_SECRETSMANAGER_API SecretsManagerClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        SecretsManagerClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                             std::shared_ptr<Endpoint::SecretsManagerEndpointProvider> endpointProvider = Aws::MakeShared<SecretsManager::Endpoint::SecretsManagerEndpointProvider>(ALLOCATION_TAG));
        ...
        */
         ...
         * secret.</p> <p>For information about creating a secret in the console, see <a
         ...
         * secrets</a>.</p> <p>If you include the configuration parameters, the operation
         * sets the values for the secret and then immediately starts a rotation. If you
         * don't include the configuration parameters, the operation starts a rotation with
         * the values already stored in the secret. </p> <p>For database credentials you
         * want to rotate, for Secrets Manager to be able to rotate the secret, you must
         * make sure the secret value is in the <a
         * href="https://docs.aws.amazon.com/secretsmanager/latest/userguide/reference_secret_json_structure.html">
         * JSON structure of a database secret</a>. In particular, if you want to use the
         * <a
         ...
         * secret.</p> <p>To configure rotation, you also need the ARN of an Amazon Web
         ...
         * automatically moves the staging label <code>AWSCURRENT</code> to the new
         * version. Then it attaches the label <code>AWSPREVIOUS</code> to the version that
         * <code>AWSCURRENT</code> was removed from.</p> <p>If you call this operation with
         * a <code>ClientRequestToken</code> that matches an existing version's
         ...
         * all staging labels from it. See <a>UpdateSecretVersionStage</a>.</p> <p>Secrets
         * Manager generates a CloudTrail log entry when you call this action. Do not
         ...
         * href="https://docs.aws.amazon.com/secretsmanager/latest/userguide/retrieve-ct-entries.html">Logging
         * Secrets Manager events with CloudTrail</a>.</p> <p> <b>Required permissions:
         * </b> <code>secretsmanager:ValidateResourcePolicy</code>. For more information,
         * see <a
         * href="https://docs.aws.amazon.com/secretsmanager/latest/userguide/reference_iam-permissions.html#reference_iam-permissions_actions">
         * IAM policy actions for Secrets Manager</a> and <a
         * href="https://docs.aws.amazon.com/secretsmanager/latest/userguide/auth-and-access.html">Authentication
    ...
    private:
      ...
      std::shared_ptr<Endpoint::SecretsManagerEndpointProvider> m_endpointProvider;
  };
