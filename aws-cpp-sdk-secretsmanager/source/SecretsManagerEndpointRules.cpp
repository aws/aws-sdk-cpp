...
Aws::String SecretsManagerEndpointRules::GetRulesAsString()
{
    return Aws::String(SecretsManagerEndpointRules::Rules.begin(), SecretsManagerEndpointRules::Rules.end());
}

const Aws::Vector<char> SecretsManagerEndpointRules::Rules = {
...
's','m','a','n','a','g','e','r','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P',
...
'h','t','t','p','s',':','/','/','s','e','c','r','e','t','s','m','a','n','a','g','e','r','-','f','i',
