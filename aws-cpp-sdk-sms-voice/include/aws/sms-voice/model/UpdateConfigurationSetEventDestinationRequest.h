...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateConfigurationSetEventDestinationRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateConfigurationSetEventDestinationRequest>(GetServiceRequestName(), *this);
    }
