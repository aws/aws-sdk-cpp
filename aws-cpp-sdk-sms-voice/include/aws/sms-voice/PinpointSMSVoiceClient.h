...
namespace PinpointSMSVoice
{
  ...
  class AWS_PINPOINTSMSVOICE_API PinpointSMSVoiceClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        PinpointSMSVoiceClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                               std::shared_ptr<Endpoint::PinpointSMSVoiceEndpointProvider> endpointProvider = Aws::MakeShared<PinpointSMSVoice::Endpoint::PinpointSMSVoiceEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::PinpointSMSVoiceEndpointProvider> m_endpointProvider;
  };
