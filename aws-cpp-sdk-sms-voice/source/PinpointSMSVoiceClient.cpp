...
using ResolveEndpointOutcome = Aws::PinpointSMSVoice::Endpoint::PinpointSMSVoiceEndpointProvider::PinpointSMSVoiceResolveEndpointOutcome;
...
PinpointSMSVoiceClient::PinpointSMSVoiceClient(const Client::ClientConfiguration& clientConfiguration,
                                               std::shared_ptr<Endpoint::PinpointSMSVoiceEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<PinpointSMSVoiceErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<PinpointSMSVoice::Endpoint::PinpointSMSVoiceEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
