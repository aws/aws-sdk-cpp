...
Aws::String PinpointSMSVoiceEndpointRules::GetRulesAsString()
{
    return Aws::String(PinpointSMSVoiceEndpointRules::Rules.begin(), PinpointSMSVoiceEndpointRules::Rules.end());
}

const Aws::Vector<char> PinpointSMSVoiceEndpointRules::Rules = {
...
'v','o','i','c','e','.','p','i','n','p','o','i','n','t','-','f','i','p','s','.','{','R','e','g','i',
...
's','m','s','-','v','o','i','c','e','.','p','i','n','p','o','i','n','t','.','{','R','e','g','i','o',
