...
namespace DocDB
{
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        DocDBClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                    std::shared_ptr<Endpoint::DocDBEndpointProvider> endpointProvider = Aws::MakeShared<DocDB::Endpoint::DocDBEndpointProvider>(ALLOCATION_TAG));
  ...
  private:
        ...
        std::shared_ptr<Endpoint::DocDBEndpointProvider> m_endpointProvider;
  };
