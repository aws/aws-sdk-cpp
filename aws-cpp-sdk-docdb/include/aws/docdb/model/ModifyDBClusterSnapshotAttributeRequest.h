...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_DOCDB_API ModifyDBClusterSnapshotAttributeRequest : public DocDBRequest
  {
  public:
  ...
  public:
     ...
     * authorization for other AWS accounts to copy or restore a manual cluster
     ...
     * restore a manual cluster snapshot, set this list to include one or more AWS
     * account IDs. To make the manual cluster snapshot restorable by any AWS account,
     * set it to <code>all</code>. Do not add the <code>all</code> value for any manual
     ...
     * by <code>AttributeName</code>.</p> <p>To remove authorization for other AWS
     * accounts to copy or restore a manual cluster snapshot, set this list to include
     * one or more AWS account identifiers. To remove authorization for any AWS account
     * to copy or restore the cluster snapshot, set it to <code>all</code> . If you
     * specify <code>all</code>, an AWS account whose account ID is explicitly added to
     * the <code>restore</code> attribute can still copy or restore a manual cluster
     * snapshot.</p>
     */
