...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeEngineDefaultClusterParametersRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeEngineDefaultClusterParametersRequest>(GetServiceRequestName(), *this);
    }
