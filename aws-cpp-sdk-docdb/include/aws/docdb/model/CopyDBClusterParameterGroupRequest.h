...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CopyDBClusterParameterGroupRequest> Clone() const
    {
      return Aws::MakeUnique<CopyDBClusterParameterGroupRequest>(GetServiceRequestName(), *this);
    }
