...
namespace Model
{
  ...
  /**
   * <p>Represents the input to <a>DescribeDBSubnetGroups</a>.</p><p><h3>See
   * Also:</h3>   <a
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeDBSubnetGroupsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeDBSubnetGroupsRequest>(GetServiceRequestName(), *this);
    }
