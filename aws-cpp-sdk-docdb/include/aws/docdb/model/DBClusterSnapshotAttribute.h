...
namespace Model
{
   ...
   * <p>Manual cluster snapshot attributes are used to authorize other accounts to
   * restore a manual cluster snapshot.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/docdb-2014-10-31/DBClusterSnapshotAttribute">AWS
   * API Reference</a></p>
   */
  class AWS_DOCDB_API DBClusterSnapshotAttribute
  {
  public:
     ...
     * <code>restore</code> refers to the list of accounts that have permission to copy
     * or restore the manual cluster snapshot.</p>
     */
     ...
     * element returns a list of IDs of the accounts that are authorized to copy or
     * restore the manual cluster snapshot. If a value of <code>all</code> is in the
     * list, then the manual cluster snapshot is public and available for any account
     * to copy or restore.</p>
     */
