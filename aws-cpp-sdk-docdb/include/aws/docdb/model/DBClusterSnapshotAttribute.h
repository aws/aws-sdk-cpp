...
namespace Model
{
   ...
   * <p>Manual cluster snapshot attributes are used to authorize other AWS accounts
   * to restore a manual cluster snapshot.</p><p><h3>See Also:</h3>   <a
  ...
  public:
     ...
     * copy or restore the manual cluster snapshot.</p>
     */
     ...
     * list, then the manual cluster snapshot is public and available for any AWS
