...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_DOCDB_API AddSourceIdentifierToSubscriptionRequest : public DocDBRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AddSourceIdentifierToSubscriptionRequest> Clone() const
    {
      return Aws::MakeUnique<AddSourceIdentifierToSubscriptionRequest>(GetServiceRequestName(), *this);
    }
