...
Aws::String DocDBEndpointRules::GetRulesAsString()
{
    return Aws::String(DocDBEndpointRules::Rules.begin(), DocDBEndpointRules::Rules.end());
}

const Aws::Vector<char> DocDBEndpointRules::Rules = {
