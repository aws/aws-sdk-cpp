...
using ResolveEndpointOutcome = Aws::DocDB::Endpoint::DocDBEndpointProvider::DocDBResolveEndpointOutcome;
...
DocDBClient::DocDBClient(const Client::ClientConfiguration& clientConfiguration,
                         std::shared_ptr<Endpoint::DocDBEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<DocDBErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<DocDB::Endpoint::DocDBEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
