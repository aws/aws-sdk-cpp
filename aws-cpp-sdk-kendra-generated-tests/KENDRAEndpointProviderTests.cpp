...
using KendraResolveEndpointOutcome = Aws::kendra::Endpoint::KendraEndpointProvider::KendraResolveEndpointOutcome;
...
void ValidateOutcome(const KendraResolveEndpointOutcome& outcome, const KendraEndpointProviderEndpointTestCase::Expect& expect)
{
