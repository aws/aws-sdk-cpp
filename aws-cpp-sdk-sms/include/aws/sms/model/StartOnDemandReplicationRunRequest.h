...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<StartOnDemandReplicationRunRequest> Clone() const
    {
      return Aws::MakeUnique<StartOnDemandReplicationRunRequest>(GetServiceRequestName(), *this);
    }
