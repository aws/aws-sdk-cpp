...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PutAppValidationConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<PutAppValidationConfigurationRequest>(GetServiceRequestName(), *this);
    }
