...
namespace Model
{
  ...
  /**
   */
  class AWS_SMS_API StartOnDemandAppReplicationRequest : public SMSRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StartOnDemandAppReplicationRequest> Clone() const
    {
      return Aws::MakeUnique<StartOnDemandAppReplicationRequest>(GetServiceRequestName(), *this);
    }
