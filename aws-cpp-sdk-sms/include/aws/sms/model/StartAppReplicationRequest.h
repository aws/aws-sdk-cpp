...
namespace Model
{
  ...
  /**
   */
  class AWS_SMS_API StartAppReplicationRequest : public SMSRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StartAppReplicationRequest> Clone() const
    {
      return Aws::MakeUnique<StartAppReplicationRequest>(GetServiceRequestName(), *this);
    }
