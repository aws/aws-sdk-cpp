...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteAppValidationConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteAppValidationConfigurationRequest>(GetServiceRequestName(), *this);
    }
