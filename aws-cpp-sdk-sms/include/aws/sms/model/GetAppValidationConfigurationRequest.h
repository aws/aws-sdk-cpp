...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetAppValidationConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<GetAppValidationConfigurationRequest>(GetServiceRequestName(), *this);
    }
