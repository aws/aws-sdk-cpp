...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteAppLaunchConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteAppLaunchConfigurationRequest>(GetServiceRequestName(), *this);
    }
