...
namespace SMS
{
  ...
  class AWS_SMS_API SMSClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        SMSClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                  std::shared_ptr<Endpoint::SMSEndpointProvider> endpointProvider = Aws::MakeShared<SMS::Endpoint::SMSEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::SMSEndpointProvider> m_endpointProvider;
  };
