...
Aws::String SMSEndpointRules::GetRulesAsString()
{
    return Aws::String(SMSEndpointRules::Rules.begin(), SMSEndpointRules::Rules.end());
}

const Aws::Vector<char> SMSEndpointRules::Rules = {
...
'u','r','l','"',':','"','h','t','t','p','s',':','/','/','s','m','s','.','{','R','e','g','i','o','n',
