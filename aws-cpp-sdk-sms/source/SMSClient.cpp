...
using ResolveEndpointOutcome = Aws::SMS::Endpoint::SMSEndpointProvider::SMSResolveEndpointOutcome;
...
SMSClient::SMSClient(const Client::ClientConfiguration& clientConfiguration,
                     std::shared_ptr<Endpoint::SMSEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<SMSErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<SMS::Endpoint::SMSEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
