...
Aws::String GreengrassV2EndpointRules::GetRulesAsString()
{
    return Aws::String(GreengrassV2EndpointRules::Rules.begin(), GreengrassV2EndpointRules::Rules.end());
}

const Aws::Vector<char> GreengrassV2EndpointRules::Rules = {
...
':','/','/','g','r','e','e','n','g','r','a','s','s','-','f','i','p','s','.','{','R','e','g','i','o',
...
'"','d','a','t','a','p','l','a','n','e','-','u','s','-','g','o','v','-','w','e','s','t','-','1','"',
']','}',']',',','"','e','n','d','p','o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t',
't','p','s',':','/','/','g','r','e','e','n','g','r','a','s','s','-','a','t','s','.','i','o','t','.',
...
'e','f','"',':','"','R','e','g','i','o','n','"','}',',','"','d','a','t','a','p','l','a','n','e','-',
'u','s','-','g','o','v','-','e','a','s','t','-','1','"',']','}',']',',','"','e','n','d','p','o','i',
'n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','g','r','e','e','n',
'g','r','a','s','s','-','a','t','s','.','i','o','t','.','u','s','-','g','o','v','-','e','a','s','t',
...
'"',':','"','h','t','t','p','s',':','/','/','g','r','e','e','n','g','r','a','s','s','.','{','R','e',
