...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchAssociateClientDeviceWithCoreDeviceRequest> Clone() const
    {
      return Aws::MakeUnique<BatchAssociateClientDeviceWithCoreDeviceRequest>(GetServiceRequestName(), *this);
    }
