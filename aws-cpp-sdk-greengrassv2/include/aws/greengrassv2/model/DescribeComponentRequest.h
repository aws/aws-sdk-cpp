...
namespace Model
{
  ...
  /**
   */
  class AWS_GREENGRASSV2_API DescribeComponentRequest : public GreengrassV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeComponentRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeComponentRequest>(GetServiceRequestName(), *this);
    }
     ...
     * of the component version.</p>
     */
    inline DescribeComponentRequest& WithArn(const char* value) { SetArn(value); return *this;}
