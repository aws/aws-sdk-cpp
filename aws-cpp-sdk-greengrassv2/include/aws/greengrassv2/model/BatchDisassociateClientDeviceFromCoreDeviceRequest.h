...
namespace Model
{
  ...
  /**
   */
  class AWS_GREENGRASSV2_API BatchDisassociateClientDeviceFromCoreDeviceRequest : public GreengrassV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchDisassociateClientDeviceFromCoreDeviceRequest> Clone() const
    {
      return Aws::MakeUnique<BatchDisassociateClientDeviceFromCoreDeviceRequest>(GetServiceRequestName(), *this);
    }
