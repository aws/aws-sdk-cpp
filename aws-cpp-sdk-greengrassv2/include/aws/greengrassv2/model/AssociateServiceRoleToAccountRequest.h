...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateServiceRoleToAccountRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateServiceRoleToAccountRequest>(GetServiceRequestName(), *this);
    }
