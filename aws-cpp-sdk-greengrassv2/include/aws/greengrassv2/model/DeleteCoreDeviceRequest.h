...
namespace Model
{
  ...
  /**
   */
  class AWS_GREENGRASSV2_API DeleteCoreDeviceRequest : public GreengrassV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteCoreDeviceRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteCoreDeviceRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "DeleteCoreDevice"; }
