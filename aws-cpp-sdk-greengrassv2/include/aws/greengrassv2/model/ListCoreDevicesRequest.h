...
namespace Model
{
  ...
  /**
   */
  class AWS_GREENGRASSV2_API ListCoreDevicesRequest : public GreengrassV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListCoreDevicesRequest> Clone() const
    {
      return Aws::MakeUnique<ListCoreDevicesRequest>(GetServiceRequestName(), *this);
    }
