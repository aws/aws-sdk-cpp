...
namespace Model
{
  ...
  /**
   */
  class AWS_GREENGRASSV2_API GetConnectivityInfoRequest : public GreengrassV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetConnectivityInfoRequest> Clone() const
    {
      return Aws::MakeUnique<GetConnectivityInfoRequest>(GetServiceRequestName(), *this);
    }
