...
namespace Model
{
  ...
  /**
   */
  class AWS_GREENGRASSV2_API DeleteComponentRequest : public GreengrassV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteComponentRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteComponentRequest>(GetServiceRequestName(), *this);
    }
