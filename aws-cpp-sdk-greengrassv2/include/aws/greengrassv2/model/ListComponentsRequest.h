...
namespace Model
{
  ...
  /**
   */
  class AWS_GREENGRASSV2_API ListComponentsRequest : public GreengrassV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListComponentsRequest> Clone() const
    {
      return Aws::MakeUnique<ListComponentsRequest>(GetServiceRequestName(), *this);
    }
