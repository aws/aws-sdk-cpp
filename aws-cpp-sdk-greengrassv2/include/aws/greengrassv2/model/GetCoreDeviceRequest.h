...
namespace Model
{
  ...
  /**
   */
  class AWS_GREENGRASSV2_API GetCoreDeviceRequest : public GreengrassV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetCoreDeviceRequest> Clone() const
    {
      return Aws::MakeUnique<GetCoreDeviceRequest>(GetServiceRequestName(), *this);
    }
