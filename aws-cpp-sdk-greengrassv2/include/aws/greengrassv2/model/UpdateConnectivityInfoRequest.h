...
namespace Model
{
  ...
  /**
   */
  class AWS_GREENGRASSV2_API UpdateConnectivityInfoRequest : public GreengrassV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateConnectivityInfoRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateConnectivityInfoRequest>(GetServiceRequestName(), *this);
    }
