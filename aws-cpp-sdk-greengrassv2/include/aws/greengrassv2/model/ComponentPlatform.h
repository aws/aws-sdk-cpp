...
namespace Model
{
  ...
  public:
     ...
     * platform.</p> <p>If you omit this parameter, AWS IoT Greengrass creates a
     * friendly name from the <code>os</code> and <code>architecture</code> of the
     * platform.</p>
     */
    ...
    /**
     * <p>A dictionary of attributes for the platform. The AWS IoT Greengrass Core
     * software defines the <code>os</code> and <code>platform</code> by default. You
     * can specify additional platform attributes for a core device when you deploy the
     * AWS IoT Greengrass nucleus component. For more information, see the <a
