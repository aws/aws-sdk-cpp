...
namespace Model
{
  class AWS_GREENGRASSV2_API BatchAssociateClientDeviceWithCoreDeviceResult
  {
  public:
    BatchAssociateClientDeviceWithCoreDeviceResult();
    BatchAssociateClientDeviceWithCoreDeviceResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    BatchAssociateClientDeviceWithCoreDeviceResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
