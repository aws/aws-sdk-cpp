...
namespace Model
{
  ...
  /**
   */
  class AWS_GREENGRASSV2_API ListClientDevicesAssociatedWithCoreDeviceRequest : public GreengrassV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListClientDevicesAssociatedWithCoreDeviceRequest> Clone() const
    {
      return Aws::MakeUnique<ListClientDevicesAssociatedWithCoreDeviceRequest>(GetServiceRequestName(), *this);
    }
