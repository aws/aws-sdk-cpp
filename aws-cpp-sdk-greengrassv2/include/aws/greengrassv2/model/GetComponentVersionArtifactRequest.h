...
namespace Model
{
  ...
  /**
   */
  class AWS_GREENGRASSV2_API GetComponentVersionArtifactRequest : public GreengrassV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetComponentVersionArtifactRequest> Clone() const
    {
      return Aws::MakeUnique<GetComponentVersionArtifactRequest>(GetServiceRequestName(), *this);
    }
