...
namespace Model
{
  ...
  /**
   */
  class AWS_GREENGRASSV2_API CancelDeploymentRequest : public GreengrassV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CancelDeploymentRequest> Clone() const
    {
      return Aws::MakeUnique<CancelDeploymentRequest>(GetServiceRequestName(), *this);
    }
