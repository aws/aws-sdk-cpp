...
namespace GreengrassV2
{
  ...
  class AWS_GREENGRASSV2_API GreengrassV2Client : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        GreengrassV2Client(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                           std::shared_ptr<Endpoint::GreengrassV2EndpointProvider> endpointProvider = Aws::MakeShared<GreengrassV2::Endpoint::GreengrassV2EndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::GreengrassV2EndpointProvider> m_endpointProvider;
  };
