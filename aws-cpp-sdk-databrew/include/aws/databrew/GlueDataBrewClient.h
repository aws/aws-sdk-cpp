...
namespace GlueDataBrew
{
  ...
  class AWS_GLUEDATABREW_API GlueDataBrewClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        GlueDataBrewClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                           std::shared_ptr<Endpoint::GlueDataBrewEndpointProvider> endpointProvider = Aws::MakeShared<GlueDataBrew::Endpoint::GlueDataBrewEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::GlueDataBrewEndpointProvider> m_endpointProvider;
  };
