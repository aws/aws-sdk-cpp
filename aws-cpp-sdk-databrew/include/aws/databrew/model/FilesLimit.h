...
namespace Model
{
  ...
  /**
   * <p>Represents a limit imposed on number of S3 files that should be selected for
   * a dataset from a connected S3 path.</p><p><h3>See Also:</h3>   <a
  ...
  public:
    ...
    /**
     * <p>A criteria to use for S3 files sorting before their selection. By default
