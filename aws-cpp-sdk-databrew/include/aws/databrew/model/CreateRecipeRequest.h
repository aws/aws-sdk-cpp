...
namespace Model
{
  ...
  /**
   */
  class AWS_GLUEDATABREW_API CreateRecipeRequest : public GlueDataBrewRequest
  {
  public:
    CreateRecipeRequest();
    ...
    */
    virtual Aws::UniquePtr<CreateRecipeRequest> Clone() const
    {
      return Aws::MakeUnique<CreateRecipeRequest>(GetServiceRequestName(), *this);
    }
