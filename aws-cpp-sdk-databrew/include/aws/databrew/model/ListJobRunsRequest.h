...
namespace Model
{
  ...
  /**
   */
  class AWS_GLUEDATABREW_API ListJobRunsRequest : public GlueDataBrewRequest
  {
  public:
    ListJobRunsRequest();
    ...
    */
    virtual Aws::UniquePtr<ListJobRunsRequest> Clone() const
    {
      return Aws::MakeUnique<ListJobRunsRequest>(GetServiceRequestName(), *this);
    }
