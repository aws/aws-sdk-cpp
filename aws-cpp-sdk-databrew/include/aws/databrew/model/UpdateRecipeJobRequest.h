...
namespace Model
{
  ...
  /**
   */
  class AWS_GLUEDATABREW_API UpdateRecipeJobRequest : public GlueDataBrewRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateRecipeJobRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateRecipeJobRequest>(GetServiceRequestName(), *this);
    }
