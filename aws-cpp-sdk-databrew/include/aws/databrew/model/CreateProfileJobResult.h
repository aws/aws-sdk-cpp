...
namespace Model
{
  ...
  public:
     ...
     * <p>The name of the job that was created.</p>
     */
    inline CreateProfileJobResult& WithName(const Aws::String& value) { SetName(value); return *this;}

    /**
     * <p>The name of the job that was created.</p>
     */
    inline CreateProfileJobResult& WithName(Aws::String&& value) { SetName(std::move(value)); return *this;}

    /**
     * <p>The name of the job that was created.</p>
     */
    inline CreateProfileJobResult& WithName(const char* value) { SetName(value); return *this;}
