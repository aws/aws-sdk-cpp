...
namespace Model
{
  ...
  /**
   */
  class AWS_GLUEDATABREW_API StopJobRunRequest : public GlueDataBrewRequest
  {
  public:
    StopJobRunRequest();
    ...
    */
    virtual Aws::UniquePtr<StopJobRunRequest> Clone() const
    {
      return Aws::MakeUnique<StopJobRunRequest>(GetServiceRequestName(), *this);
    }
