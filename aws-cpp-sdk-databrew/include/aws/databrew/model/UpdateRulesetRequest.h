...
namespace Model
{
  ...
  /**
   */
  class AWS_GLUEDATABREW_API UpdateRulesetRequest : public GlueDataBrewRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateRulesetRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateRulesetRequest>(GetServiceRequestName(), *this);
    }
