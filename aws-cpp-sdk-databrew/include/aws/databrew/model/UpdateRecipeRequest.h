...
namespace Model
{
  ...
  /**
   */
  class AWS_GLUEDATABREW_API UpdateRecipeRequest : public GlueDataBrewRequest
  {
  public:
    UpdateRecipeRequest();
    ...
    */
    virtual Aws::UniquePtr<UpdateRecipeRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateRecipeRequest>(GetServiceRequestName(), *this);
    }
