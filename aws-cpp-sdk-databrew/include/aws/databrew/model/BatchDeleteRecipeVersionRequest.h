...
namespace Model
{
  ...
  /**
   */
  class AWS_GLUEDATABREW_API BatchDeleteRecipeVersionRequest : public GlueDataBrewRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchDeleteRecipeVersionRequest> Clone() const
    {
      return Aws::MakeUnique<BatchDeleteRecipeVersionRequest>(GetServiceRequestName(), *this);
    }
