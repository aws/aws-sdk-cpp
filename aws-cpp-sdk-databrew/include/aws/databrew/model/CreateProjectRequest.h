...
namespace Model
{
  ...
  /**
   */
  class AWS_GLUEDATABREW_API CreateProjectRequest : public GlueDataBrewRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateProjectRequest> Clone() const
    {
      return Aws::MakeUnique<CreateProjectRequest>(GetServiceRequestName(), *this);
    }
