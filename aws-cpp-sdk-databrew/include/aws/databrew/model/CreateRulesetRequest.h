...
namespace Model
{
  ...
  /**
   */
  class AWS_GLUEDATABREW_API CreateRulesetRequest : public GlueDataBrewRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateRulesetRequest> Clone() const
    {
      return Aws::MakeUnique<CreateRulesetRequest>(GetServiceRequestName(), *this);
    }
