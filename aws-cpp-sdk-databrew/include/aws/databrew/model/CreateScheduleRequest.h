...
namespace Model
{
  ...
  /**
   */
  class AWS_GLUEDATABREW_API CreateScheduleRequest : public GlueDataBrewRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateScheduleRequest> Clone() const
    {
      return Aws::MakeUnique<CreateScheduleRequest>(GetServiceRequestName(), *this);
    }
