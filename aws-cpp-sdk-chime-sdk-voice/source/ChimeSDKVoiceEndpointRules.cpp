...
Aws::String ChimeSDKVoiceEndpointRules::GetRulesAsString()
{
    return Aws::String(ChimeSDKVoiceEndpointRules::Rules.begin(), ChimeSDKVoiceEndpointRules::Rules.end());
}

const Aws::Vector<char> ChimeSDKVoiceEndpointRules::Rules = {
...
't','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','v','o','i','c','e','-',
'c','h','i','m','e','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t',
...
'"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','v','o','i','c','e','-','c','h','i','m',
...
'u','r','l','"',':','"','h','t','t','p','s',':','/','/','v','o','i','c','e','-','c','h','i','m','e',
...
'p','s',':','/','/','v','o','i','c','e','-','c','h','i','m','e','.','{','R','e','g','i','o','n','}',
