...
namespace Model
{
  ...
  /**
   */
  class DeleteVoiceConnectorEmergencyCallingConfigurationRequest : public ChimeSDKVoiceRequest
  {
  public:
    AWS_CHIMESDKVOICE_API DeleteVoiceConnectorEmergencyCallingConfigurationRequest();
