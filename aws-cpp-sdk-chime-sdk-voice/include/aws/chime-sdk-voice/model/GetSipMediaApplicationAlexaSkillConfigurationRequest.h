...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIMESDKVOICE_API GetSipMediaApplicationAlexaSkillConfigurationRequest : public ChimeSDKVoiceRequest
  {
  public:
    ...
    inline virtual const char* GetServiceRequestName() const override { return "GetSipMediaApplicationAlexaSkillConfiguration"; }
    ...
    inline GetSipMediaApplicationAlexaSkillConfigurationRequest& WithSipMediaApplicationId(const Aws::String& value) { SetSipMediaApplicationId(value); return *this;}

    
    inline GetSipMediaApplicationAlexaSkillConfigurationRequest& WithSipMediaApplicationId(Aws::String&& value) { SetSipMediaApplicationId(std::move(value)); return *this;}

    
    inline GetSipMediaApplicationAlexaSkillConfigurationRequest& WithSipMediaApplicationId(const char* value) { SetSipMediaApplicationId(value); return *this;}
