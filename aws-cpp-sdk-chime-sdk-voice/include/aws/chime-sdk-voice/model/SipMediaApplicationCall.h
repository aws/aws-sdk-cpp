...
namespace Model
{
  ...
  class AWS_CHIMESDKVOICE_API SipMediaApplicationCall
  {
  public:
    SipMediaApplicationCall();
    SipMediaApplicationCall(Aws::Utils::Json::JsonView jsonValue);
    SipMediaApplicationCall& operator=(Aws::Utils::Json::JsonView jsonValue);
