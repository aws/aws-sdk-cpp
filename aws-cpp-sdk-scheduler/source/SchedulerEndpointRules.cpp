...
Aws::String SchedulerEndpointRules::GetRulesAsString()
{
    return Aws::String(SchedulerEndpointRules::Rules.begin(), SchedulerEndpointRules::Rules.end());
}

const Aws::Vector<char> SchedulerEndpointRules::Rules = {
...
't','t','p','s',':','/','/','s','c','h','e','d','u','l','e','r','-','f','i','p','s','.','{','R','e',
...
'/','s','c','h','e','d','u','l','e','r','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.',
...
'p','o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','s','c',
'h','e','d','u','l','e','r','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i',
...
'l','"',':','"','h','t','t','p','s',':','/','/','s','c','h','e','d','u','l','e','r','.','{','R','e',
