...
namespace Model
{
  ...
  /**
   */
  class AWS_SCHEDULER_API UpdateScheduleRequest : public SchedulerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateScheduleRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateScheduleRequest>(GetServiceRequestName(), *this);
    }
