...
namespace Model
{
  ...
  /**
   */
  class AWS_SCHEDULER_API CreateScheduleGroupRequest : public SchedulerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateScheduleGroupRequest> Clone() const
    {
      return Aws::MakeUnique<CreateScheduleGroupRequest>(GetServiceRequestName(), *this);
    }
