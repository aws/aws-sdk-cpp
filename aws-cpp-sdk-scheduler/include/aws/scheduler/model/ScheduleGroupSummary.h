...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SCHEDULER_API ScheduleGroupSummary
  {
  public:
    ScheduleGroupSummary();
    ScheduleGroupSummary(Aws::Utils::Json::JsonView jsonValue);
    ScheduleGroupSummary& operator=(Aws::Utils::Json::JsonView jsonValue);
