...
namespace Model
{
  ...
  /**
   */
  class AWS_SCHEDULER_API ListScheduleGroupsRequest : public SchedulerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListScheduleGroupsRequest> Clone() const
    {
      return Aws::MakeUnique<ListScheduleGroupsRequest>(GetServiceRequestName(), *this);
    }
