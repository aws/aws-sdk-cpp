...
namespace Model
{
  ...
  /**
   */
  class AWS_SCHEDULER_API DeleteScheduleGroupRequest : public SchedulerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteScheduleGroupRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteScheduleGroupRequest>(GetServiceRequestName(), *this);
    }
