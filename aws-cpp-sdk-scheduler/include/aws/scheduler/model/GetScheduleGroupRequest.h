...
namespace Model
{
  ...
  /**
   */
  class AWS_SCHEDULER_API GetScheduleGroupRequest : public SchedulerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetScheduleGroupRequest> Clone() const
    {
      return Aws::MakeUnique<GetScheduleGroupRequest>(GetServiceRequestName(), *this);
    }
