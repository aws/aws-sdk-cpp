...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKSPACES_API RegisterWorkspaceDirectoryRequest : public WorkSpacesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<RegisterWorkspaceDirectoryRequest> Clone() const
    {
      return Aws::MakeUnique<RegisterWorkspaceDirectoryRequest>(GetServiceRequestName(), *this);
    }
