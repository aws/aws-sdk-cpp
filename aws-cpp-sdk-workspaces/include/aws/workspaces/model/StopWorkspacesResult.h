...
namespace Model
{
  ...
  public:
     ...
     * <p>The failed requests.</p>
     */
    inline StopWorkspacesResult& WithFailedRequests(Aws::Vector<FailedWorkspaceChangeRequest>&& value) { SetFailedRequests(value); return *this;}
     ...
     * <p>The failed requests.</p>
     */
    inline StopWorkspacesResult& AddFailedRequests(FailedWorkspaceChangeRequest&& value) { m_failedRequests.push_back(value); return *this; }
