...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKSPACES_API DescribeConnectClientAddInsRequest : public WorkSpacesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeConnectClientAddInsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeConnectClientAddInsRequest>(GetServiceRequestName(), *this);
    }
