...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKSPACES_API UpdateWorkspaceImagePermissionRequest : public WorkSpacesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateWorkspaceImagePermissionRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateWorkspaceImagePermissionRequest>(GetServiceRequestName(), *this);
    }
