...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKSPACES_API CreateStandbyWorkspacesRequest : public WorkSpacesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateStandbyWorkspacesRequest> Clone() const
    {
      return Aws::MakeUnique<CreateStandbyWorkspacesRequest>(GetServiceRequestName(), *this);
    }
