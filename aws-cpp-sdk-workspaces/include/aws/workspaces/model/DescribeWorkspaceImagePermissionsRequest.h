...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeWorkspaceImagePermissionsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeWorkspaceImagePermissionsRequest>(GetServiceRequestName(), *this);
    }
