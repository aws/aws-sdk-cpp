...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKSPACES_API DisassociateConnectionAliasRequest : public WorkSpacesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateConnectionAliasRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateConnectionAliasRequest>(GetServiceRequestName(), *this);
    }
