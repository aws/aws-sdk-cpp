...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKSPACES_API CreateUpdatedWorkspaceImageRequest : public WorkSpacesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateUpdatedWorkspaceImageRequest> Clone() const
    {
      return Aws::MakeUnique<CreateUpdatedWorkspaceImageRequest>(GetServiceRequestName(), *this);
    }
