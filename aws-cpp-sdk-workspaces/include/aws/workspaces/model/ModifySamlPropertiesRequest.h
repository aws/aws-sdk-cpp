...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKSPACES_API ModifySamlPropertiesRequest : public WorkSpacesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ModifySamlPropertiesRequest> Clone() const
    {
      return Aws::MakeUnique<ModifySamlPropertiesRequest>(GetServiceRequestName(), *this);
    }
