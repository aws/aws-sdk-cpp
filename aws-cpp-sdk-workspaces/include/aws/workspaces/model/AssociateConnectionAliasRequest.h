...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKSPACES_API AssociateConnectionAliasRequest : public WorkSpacesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateConnectionAliasRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateConnectionAliasRequest>(GetServiceRequestName(), *this);
    }
