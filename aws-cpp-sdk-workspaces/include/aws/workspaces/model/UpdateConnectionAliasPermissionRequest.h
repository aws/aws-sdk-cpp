...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateConnectionAliasPermissionRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateConnectionAliasPermissionRequest>(GetServiceRequestName(), *this);
    }
