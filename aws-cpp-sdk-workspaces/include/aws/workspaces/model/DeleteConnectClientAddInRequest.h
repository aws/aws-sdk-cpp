...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKSPACES_API DeleteConnectClientAddInRequest : public WorkSpacesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteConnectClientAddInRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteConnectClientAddInRequest>(GetServiceRequestName(), *this);
    }
