...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeWorkspacesConnectionStatusRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeWorkspacesConnectionStatusRequest>(GetServiceRequestName(), *this);
    }
