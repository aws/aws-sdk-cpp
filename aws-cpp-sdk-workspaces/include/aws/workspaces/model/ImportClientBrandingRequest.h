...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKSPACES_API ImportClientBrandingRequest : public WorkSpacesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ImportClientBrandingRequest> Clone() const
    {
      return Aws::MakeUnique<ImportClientBrandingRequest>(GetServiceRequestName(), *this);
    }
