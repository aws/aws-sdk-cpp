...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKSPACES_API UpdateConnectClientAddInRequest : public WorkSpacesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateConnectClientAddInRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateConnectClientAddInRequest>(GetServiceRequestName(), *this);
    }
