...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKSPACES_API DescribeConnectionAliasPermissionsRequest : public WorkSpacesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeConnectionAliasPermissionsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeConnectionAliasPermissionsRequest>(GetServiceRequestName(), *this);
    }
