...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKSPACES_API ModifyCertificateBasedAuthPropertiesRequest : public WorkSpacesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ModifyCertificateBasedAuthPropertiesRequest> Clone() const
    {
      return Aws::MakeUnique<ModifyCertificateBasedAuthPropertiesRequest>(GetServiceRequestName(), *this);
    }
