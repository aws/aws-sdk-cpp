...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ModifyWorkspaceAccessPropertiesRequest> Clone() const
    {
      return Aws::MakeUnique<ModifyWorkspaceAccessPropertiesRequest>(GetServiceRequestName(), *this);
    }
