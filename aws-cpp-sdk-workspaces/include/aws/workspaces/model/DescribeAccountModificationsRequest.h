...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeAccountModificationsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeAccountModificationsRequest>(GetServiceRequestName(), *this);
    }
