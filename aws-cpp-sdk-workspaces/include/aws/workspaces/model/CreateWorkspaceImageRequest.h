...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKSPACES_API CreateWorkspaceImageRequest : public WorkSpacesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateWorkspaceImageRequest> Clone() const
    {
      return Aws::MakeUnique<CreateWorkspaceImageRequest>(GetServiceRequestName(), *this);
    }
