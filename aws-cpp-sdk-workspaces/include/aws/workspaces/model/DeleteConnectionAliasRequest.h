...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKSPACES_API DeleteConnectionAliasRequest : public WorkSpacesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteConnectionAliasRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteConnectionAliasRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "DeleteConnectionAlias"; }
