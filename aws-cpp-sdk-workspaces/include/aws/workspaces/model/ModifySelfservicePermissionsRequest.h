...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ModifySelfservicePermissionsRequest> Clone() const
    {
      return Aws::MakeUnique<ModifySelfservicePermissionsRequest>(GetServiceRequestName(), *this);
    }
