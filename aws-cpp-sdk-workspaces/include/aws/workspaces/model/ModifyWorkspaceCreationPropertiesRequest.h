...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ModifyWorkspaceCreationPropertiesRequest> Clone() const
    {
      return Aws::MakeUnique<ModifyWorkspaceCreationPropertiesRequest>(GetServiceRequestName(), *this);
    }
