...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKSPACES_API DescribeClientBrandingRequest : public WorkSpacesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeClientBrandingRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeClientBrandingRequest>(GetServiceRequestName(), *this);
    }
