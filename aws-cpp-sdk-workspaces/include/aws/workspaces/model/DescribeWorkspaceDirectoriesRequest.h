...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeWorkspaceDirectoriesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeWorkspaceDirectoriesRequest>(GetServiceRequestName(), *this);
    }
