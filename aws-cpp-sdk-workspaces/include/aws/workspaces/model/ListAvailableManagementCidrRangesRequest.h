...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListAvailableManagementCidrRangesRequest> Clone() const
    {
      return Aws::MakeUnique<ListAvailableManagementCidrRangesRequest>(GetServiceRequestName(), *this);
    }
