...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKSPACES_API CreateWorkspaceBundleRequest : public WorkSpacesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateWorkspaceBundleRequest> Clone() const
    {
      return Aws::MakeUnique<CreateWorkspaceBundleRequest>(GetServiceRequestName(), *this);
    }
