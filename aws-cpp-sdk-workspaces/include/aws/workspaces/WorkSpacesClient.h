...
namespace WorkSpaces
{
  ...
  class AWS_WORKSPACES_API WorkSpacesClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        WorkSpacesClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                         std::shared_ptr<Endpoint::WorkSpacesEndpointProvider> endpointProvider = Aws::MakeShared<WorkSpaces::Endpoint::WorkSpacesEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::WorkSpacesEndpointProvider> m_endpointProvider;
  };
