...
CreateUpdatedWorkspaceImageResult::CreateUpdatedWorkspaceImageResult()
{
}

CreateUpdatedWorkspaceImageResult::CreateUpdatedWorkspaceImageResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
