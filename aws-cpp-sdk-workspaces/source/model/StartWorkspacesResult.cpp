...
StartWorkspacesResult::StartWorkspacesResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

StartWorkspacesResult& StartWorkspacesResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
