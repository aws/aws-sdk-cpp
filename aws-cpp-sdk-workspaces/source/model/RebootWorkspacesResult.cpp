...
RebootWorkspacesResult::RebootWorkspacesResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

RebootWorkspacesResult& RebootWorkspacesResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
