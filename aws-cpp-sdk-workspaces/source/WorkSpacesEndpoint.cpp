  ...
  Aws::String ForRegion(Region region)
  {
    switch(region)
    {
     ...
     case Region::US_WEST_1:
        return "workspaces.us-west-1.amazonaws.com";
     case Region::US_WEST_2:
        return "workspaces.us-west-2.amazonaws.com";
     case Region::EU_WEST_1:
        return "workspaces.eu-west-1.amazonaws.com";
     case Region::EU_CENTRAL_1:
        return "workspaces.eu-central-1.amazonaws.com";
     case Region::AP_SOUTHEAST_1:
        return "workspaces.ap-southeast-1.amazonaws.com";
     case Region::AP_SOUTHEAST_2:
        return "workspaces.ap-southeast-2.amazonaws.com";
     case Region::AP_NORTHEAST_1:
        return "workspaces.ap-northeast-1.amazonaws.com";
