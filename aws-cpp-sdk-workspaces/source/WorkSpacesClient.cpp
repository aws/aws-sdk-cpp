...
using ResolveEndpointOutcome = Aws::WorkSpaces::Endpoint::WorkSpacesEndpointProvider::WorkSpacesResolveEndpointOutcome;
...
WorkSpacesClient::WorkSpacesClient(const Client::ClientConfiguration& clientConfiguration,
                                   std::shared_ptr<Endpoint::WorkSpacesEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<WorkSpacesErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<WorkSpaces::Endpoint::WorkSpacesEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
