...
Aws::String StorageGatewayEndpointRules::GetRulesAsString()
{
    return Aws::String(StorageGatewayEndpointRules::Rules.begin(), StorageGatewayEndpointRules::Rules.end());
}

const Aws::Vector<char> StorageGatewayEndpointRules::Rules = {
...
't','t','p','s',':','/','/','s','t','o','r','a','g','e','g','a','t','e','w','a','y','-','f','i','p',
...
'"',':','"','h','t','t','p','s',':','/','/','s','t','o','r','a','g','e','g','a','t','e','w','a','y',
...
'p','s',':','/','/','s','t','o','r','a','g','e','g','a','t','e','w','a','y','.','{','R','e','g','i',
