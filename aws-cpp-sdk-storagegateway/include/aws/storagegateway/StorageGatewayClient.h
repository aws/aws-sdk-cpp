...
namespace StorageGateway
{
  ...
  class AWS_STORAGEGATEWAY_API StorageGatewayClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        StorageGatewayClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                             std::shared_ptr<Endpoint::StorageGatewayEndpointProvider> endpointProvider = Aws::MakeShared<StorageGateway::Endpoint::StorageGatewayEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::StorageGatewayEndpointProvider> m_endpointProvider;
  };
