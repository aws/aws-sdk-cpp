...
namespace Model
{
   ...
   * regions and endpoints available for use with AWS Storage Gateway. </li> </ul>
   ...
   * example, in Storage Gateway the ID for a volume might be vol-1122AABB. When you
   * use this ID with the EC2 API, you must change it to vol-1122aabb. Otherwise, the
   * EC2 API might not behave as expected.</note>
   */
    ...
    public:
      typedef Aws::Client::AWSJsonClient BASECLASS;
        ...
        */
        ...
        /**
         * <p>This operation activates the gateway you previously deployed on your host.
         ...
         * information such as the region you want to use for storing snapshots, the time
        ...
        /**
         * <p>This operation configures one or more gateway local disks as cache for a
         * cached-volume gateway. This operation is supported only for the gateway-cached
         * volume architecture (see <a
        ...
        /**
         * <p>This operation adds one or more tags to the specified resource. You use tags
         ...
         * team. Each tag consists of a key and a value, which you define. You can add tags
         * to the following AWS Storage Gateway resources:</p> <ul> <li><p>Storage gateways
         * of all types</p></li> </ul> <ul> <li><p>Storage Volumes</p></li> </ul> <ul>
        ...
        /**
         * <p>This operation configures one or more gateway local disks as upload buffer
         * for a specified gateway. This operation is supported for both the gateway-stored
         * and gateway-cached volume architectures. </p> <p> In the request, you specify
         * the gateway Amazon Resource Name (ARN) to which you want to add upload buffer,
        ...
        /**
         * <p>This operation configures one or more gateway local disks as working storage
         ...
         * (20120630). Use AddUploadBuffer instead.</p> <note><p>Working storage is also
         * referred to as upload buffer. You can also use the <a>AddUploadBuffer</a>
         * operation to add upload buffer to a stored-volume gateway.</p></note> <p>In the
         * request, you specify the gateway Amazon Resource Name (ARN) to which you want to
        ...
        /**
         * <p>This operation creates a cached volume on a specified cached gateway. This
         ...
         * gateway. </note> <p>In the request, you must specify the gateway, size of the
         * volume in bytes, the iSCSI target name, an IP address on which to expose the
         * target, and a unique client token. In response, AWS Storage Gateway creates the
         * volume and returns information about it such as the volume Amazon Resource Name
        ...
        /**
         * <p>This operation initiates a snapshot of a volume.</p> <p>AWS Storage Gateway
         * provides the ability to back up point-in-time snapshots of your data to Amazon
         * Simple Storage (S3) for durable off-site recovery, as well as import the data to
         * an Amazon Elastic Block Store (EBS) volume in Amazon Elastic Compute Cloud
         * (EC2). You can take snapshots of your gateway volume on a scheduled or ad-hoc
         * basis. This API enables you to take ad-hoc snapshot. For more information, see
         * <a
        ...
        /**
         * <p>This operation initiates a snapshot of a gateway from a volume recovery
         * point. This operation is supported only for the gateway-cached volume
         * architecture (see ).</p> <p>A volume recovery point is a point in time at which
         * all data of the volume is consistent and from which you can create a snapshot.
         * To get a list of volume recovery point for gateway-cached volumes, use
        ...
        /**
         * <p>This operation creates a volume on a specified gateway. This operation is
         * supported only for the gateway-stored volume architecture. </p> <p>The size of
         * the volume to create is inferred from the disk size. You can choose to preserve
         * existing data on the disk, create volume from an existing snapshot, or create an
         * empty volume. If you choose to create an empty gateway volume, then any existing
         * data on the disk is erased.</p> <p>In the request you must specify the gateway
         * and the disk information on which you are creating the volume. In response, AWS
         * Storage Gateway creates the volume and returns volume information such as the
        ...
        /**
         * <p>This operation deletes the bandwidth rate limits of a gateway. You can delete
        ...
        /**
         * <p>This operation deletes Challenge-Handshake Authentication Protocol (CHAP)
         * credentials for a specified iSCSI target and initiator pair.</p>
         */
        ...
        /**
         * <p>This operation deletes a gateway. To specify which gateway to delete, use the
         ...
         * your host computer.</p> <p>After you delete a gateway, you cannot reactivate it.
        ...
        /**
         * <p> This operation deletes a snapshot of a volume. </p> <p> You can take
         * snapshots of your gateway volumes on a scheduled or ad-hoc basis. This API
         * enables you to delete a snapshot schedule for a volume. For more information,
         * see <a
         * href="http://docs.aws.amazon.com/storagegateway/latest/userguide/WorkingWithSnapshots.html">Working
        ...
        /**
         * <p>This operation deletes the specified gateway volume that you previously
         * created using the <a>CreateCachediSCSIVolume</a> or
         * <a>CreateStorediSCSIVolume</a> API. For gateway-stored volumes, the local disk
         * that was configured as the storage volume is not deleted. You can reuse the
         * local disk to create another storage volume. </p> <p>Before you delete a gateway
         * volume, make sure there are no iSCSI connections to the volume you are deleting.
         * You should also make sure there is no snapshot in progress. You can use the
         * Amazon Elastic Compute Cloud (Amazon EC2) API to query snapshots on the volume
         * you are deleting and check the snapshot status. For more information, go to <a
        ...
        /**
         * <p>This operation returns the bandwidth rate limits of a gateway. By default,
         * these limits are not set, which means no bandwidth rate limiting is in
         * effect.</p> <p>This operation only returns a value for a bandwidth rate limit
         * only if the limit is set. If no limits are set for the gateway, then this
         * operation returns only the gateway ARN in the response body. To specify which
        ...
        /**
         * <p>This operation returns information about the cache of a gateway. This
        ...
        /**
         * <p>This operation returns a description of the gateway volumes specified in the
         * request. This operation is supported only for the gateway-cached volume
         * architecture.</p> <p> The list of gateway volumes in the request must be from
         * one gateway. In the response Amazon Storage Gateway returns volume information
         * sorted by volume Amazon Resource Name (ARN). </p>
         */
        ...
        /**
         * <p>This operation returns an array of Challenge-Handshake Authentication
         * Protocol (CHAP) credentials information for a specified iSCSI target, one for
         * each target-initiator pair.</p>
         */
        ...
        /**
         * <p>This operation returns metadata about a gateway such as its name, network
        ...
        /**
         * <p>This operation returns your gateway's weekly maintenance start time including
        ...
        /**
         * <p>This operation describes the snapshot schedule for the specified gateway
         * volume. The snapshot schedule information includes intervals at which snapshots
         * are automatically initiated on the volume.</p>
         */
        ...
        /**
         * <p>This operation returns the description of the gateway volumes specified in
        ...
        /**
         * <p>This operation returns information about the upload buffer of a gateway. This
        ...
        /**
         * <p>This operation returns information about the working storage of a gateway.
         ...
         * DescribeUploadBuffer instead.</p> <note><p>Working storage is also referred to
         * as upload buffer. You can also use the DescribeUploadBuffer operation to add
         * upload buffer to a stored-volume gateway.</p></note> <p>The response includes
         * disk IDs that are configured as working storage, and it includes the amount of
         * working storage allocated and used.</p>
         */
        ...
        /**
         * <p>This operation lists gateways owned by an AWS account in a region specified
         * in the request. The returned list is ordered by gateway Amazon Resource Name
         * (ARN).</p> <p>By default, the operation returns a maximum of 100 gateways. This
         * operation supports pagination that allows you to optionally reduce the number of
         * gateways returned in a response.</p> <p>If you have more gateways than are
         * returned in a response-that is, the response returns only a truncated list of
         * your gateways-the response contains a marker that you can specify in your next
         * request to fetch the next page of gateways.</p>
         */
        ...
        /**
         * <p>This operation returns a list of the gateway's local disks. To specify which
         * gateway to describe, you use the Amazon Resource Name (ARN) of the gateway in
         * the body of the request.</p> <p>The request returns a list of all disks,
         * specifying which are configured as working storage, cache storage, or stored
         * volume or not configured at all. The response includes a <code>DiskStatus</code>
         * field. This field can have a value of present (the disk is available to use),
         * missing (the disk is no longer connected to the gateway), or mismatch (the disk
        ...
        /**
         * <p>This operation lists the tags that have been added to the specified resource.
         * </p>
         */
        ...
        /**
         * <p>This operation lists iSCSI initiators that are connected to a volume. You can
         * use this operation to determine whether a volume is being used or not.</p>
         */
        ...
        /**
         * <p>This operation lists the recovery points for a specified gateway. This
         * operation is supported only for the gateway-cached volume architecture.</p>
         * <p>Each gateway-cached volume has one recovery point. A volume recovery point is
        ...
        /**
         * <p>This operation lists the iSCSI stored volumes of a gateway. Results are
         ...
         * API.</p> <p>The operation supports pagination. By default, the operation returns
         ...
         * subsequent request to retrieve the next set of volumes.</p>
         */
        ...
        /**
         * <p>This operation removes one or more tags from the specified resource.</p>
         */
        ...
        /**
         * <p>This operation resets all cache disks that have encountered a error and makes
         ...
         * or removed from the gateway. When a cache is reset, the gateway loses its cache
         * storage. At this point you can reconfigure the disks as cache disks. </p>
         * <important> <p>If the cache disk you are resetting contains data that has not
         * been uploaded to Amazon S3 yet, that data can be lost. After you reset cache
         * disks, there will be no configured cache disks left in the gateway, so you must
         * configure at least one new cache disk for your gateway to function properly.</p>
         * </important>
         */
        ...
        /**
         * <p>This operation shuts down a gateway. To specify which gateway to shut down,
         * use the Amazon Resource Name (ARN) of the gateway in the body of your
         * request.</p> <p>The operation shuts down the gateway service component running
         * in the storage gateway's virtual machine (VM) and not the VM.</p> <note>If you
         * want to shut down the VM, it is recommended that you first shut down the gateway
         * component in the VM to avoid unpredictable conditions.</note> <p>After the
         * gateway is shutdown, you cannot call any other API except <a>StartGateway</a>,
        ...
        /**
         * <p>This operation starts a gateway that you previously shut down (see
         * <a>ShutdownGateway</a>). After the gateway starts, you can then make other API
         * calls, your applications can read from or write to the gateway's storage volumes
         * and you will be able to take snapshot backups.</p> <note>When you make a
         * request, you will get a 200 OK success response immediately. However, it might
         * take some time for the gateway to be ready. You should call
         * <a>DescribeGatewayInformation</a> and check the status before making any
         * additional API calls. For more information, see <a>ActivateGateway</a>.</note>
         * <p>To specify which gateway to start, use the Amazon Resource Name (ARN) of the
        ...
        /**
         * <p>This operation updates the bandwidth rate limits of a gateway. You can update
         ...
         * remains.</p> <p>By default, a gateway's bandwidth rate limits are not set. If
         * you don't set any limit, the gateway does not have any limitations on its
         * bandwidth usage and could potentially use the maximum available bandwidth.</p>
         * <p>To specify which gateway to update, use the Amazon Resource Name (ARN) of the
         * gateway in your request.</p>
         */
        ...
        /**
         * <p>This operation updates the Challenge-Handshake Authentication Protocol (CHAP)
         * credentials for a specified iSCSI target. By default, a gateway does not have
         * CHAP enabled; however, for added security, you might use it.</p> <important>
         * <p>When you update CHAP credentials, all existing connections on the target are
         * closed and initiators must reconnect with the new credentials.</p> </important>
         */
        ...
        /**
         * <p>This operation updates a gateway's metadata, which includes the gateway's
         * name and time zone. To specify which gateway to update, use the Amazon Resource
         * Name (ARN) of the gateway in your request.</p> <note>For Gateways activated
         * after September 02, 2015, the gateway's ARN contains the gateway id rather than
         * the gateway name. However changing the name of the gateway has no effect on the
         * gateway's ARN.</note>
         */
        ...
        /**
         * <p>This operation updates the gateway virtual machine (VM) software. The request
         * immediately triggers the software update. </p> <note>When you make this request,
         * you get a <code>200 OK</code> success response immediately. However, it might
         * take some time for the update to complete. You can call
         * <a>DescribeGatewayInformation</a> to verify the gateway is in the
         * <code>STATE_RUNNING</code> state.</note> <important>A software update forces a
         * system restart of your gateway. You can minimize the chance of any disruption to
        ...
        /**
         * <p>This operation updates a gateway's weekly maintenance start time information,
         * including day and time of the week. The maintenance time is the time in your
         * gateway's time zone.</p>
         */
        ...
        /**
         * <p>This operation updates a snapshot schedule configured for a gateway
         * volume.</p> <p>The default snapshot schedule for volume is once every 24 hours,
         * starting at the creation time of the volume. You can use this API to change the
         * snapshot schedule configured for the volume.</p> <p>In the request you must
         * identify the gateway volume whose snapshot schedule you want to update, and the
         * schedule information, including when you want the snapshot to begin on a day and
         * the frequency (in hours) of snapshots.</p>
         */
        ...
        /**
         * <p>This operation updates the type of medium changer in a gateway-VTL. When you
         * activate a gateway-VTL, you select a medium changer type for the gateway-VTL.
         * This operation enables you to select a different type of medium changer after a
