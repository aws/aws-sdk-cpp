...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateBandwidthRateLimitScheduleRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateBandwidthRateLimitScheduleRequest>(GetServiceRequestName(), *this);
    }
