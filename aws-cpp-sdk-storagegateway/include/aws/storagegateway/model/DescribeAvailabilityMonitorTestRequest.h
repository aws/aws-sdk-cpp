...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeAvailabilityMonitorTestRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeAvailabilityMonitorTestRequest>(GetServiceRequestName(), *this);
    }
