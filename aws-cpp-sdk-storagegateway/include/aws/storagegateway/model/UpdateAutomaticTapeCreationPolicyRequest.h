...
namespace Model
{
  ...
  /**
   */
  class AWS_STORAGEGATEWAY_API UpdateAutomaticTapeCreationPolicyRequest : public StorageGatewayRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateAutomaticTapeCreationPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateAutomaticTapeCreationPolicyRequest>(GetServiceRequestName(), *this);
    }
