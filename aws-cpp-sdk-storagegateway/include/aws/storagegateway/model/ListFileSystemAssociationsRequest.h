...
namespace Model
{
  ...
  /**
   */
  class AWS_STORAGEGATEWAY_API ListFileSystemAssociationsRequest : public StorageGatewayRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListFileSystemAssociationsRequest> Clone() const
    {
      return Aws::MakeUnique<ListFileSystemAssociationsRequest>(GetServiceRequestName(), *this);
    }
