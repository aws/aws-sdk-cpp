...
namespace Model
{
  ...
  public:
    AddCacheResult();
    AddCacheResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AddCacheResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
