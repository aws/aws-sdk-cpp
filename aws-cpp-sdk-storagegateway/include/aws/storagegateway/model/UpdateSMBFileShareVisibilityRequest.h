...
namespace Model
{
  ...
  /**
   */
  class AWS_STORAGEGATEWAY_API UpdateSMBFileShareVisibilityRequest : public StorageGatewayRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateSMBFileShareVisibilityRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateSMBFileShareVisibilityRequest>(GetServiceRequestName(), *this);
    }
