...
namespace Model
{
  ...
  /**
   */
  class AWS_STORAGEGATEWAY_API AssociateFileSystemRequest : public StorageGatewayRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateFileSystemRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateFileSystemRequest>(GetServiceRequestName(), *this);
    }
