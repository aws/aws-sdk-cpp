...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteAutomaticTapeCreationPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteAutomaticTapeCreationPolicyRequest>(GetServiceRequestName(), *this);
    }
