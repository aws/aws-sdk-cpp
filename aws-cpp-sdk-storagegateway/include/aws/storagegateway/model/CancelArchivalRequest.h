...
namespace Model
{
  ...
  public:
    ...
    inline CancelArchivalRequest& WithGatewayARN(Aws::String&& value) { SetGatewayARN(value); return *this;}
     ...
     * archiving for.</p>
     */
    inline CancelArchivalRequest& WithTapeARN(Aws::String&& value) { SetTapeARN(value); return *this;}
