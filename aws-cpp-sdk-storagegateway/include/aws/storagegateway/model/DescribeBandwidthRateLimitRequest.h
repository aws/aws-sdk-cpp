...
namespace Model
{
  ...
  /**
   * <p>A JSON object containing the of the gateway.</p><p><h3>See Also:</h3>   <a
  ...
  public:
    ...
    inline DescribeBandwidthRateLimitRequest& WithGatewayARN(Aws::String&& value) { SetGatewayARN(value); return *this;}
