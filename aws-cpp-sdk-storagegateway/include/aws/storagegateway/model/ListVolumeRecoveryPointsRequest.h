...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListVolumeRecoveryPointsRequest> Clone() const
    {
      return Aws::MakeUnique<ListVolumeRecoveryPointsRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "ListVolumeRecoveryPoints"; }
