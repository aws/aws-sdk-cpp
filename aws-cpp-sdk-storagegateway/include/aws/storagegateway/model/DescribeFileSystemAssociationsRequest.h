...
namespace Model
{
  ...
  /**
   */
  class AWS_STORAGEGATEWAY_API DescribeFileSystemAssociationsRequest : public StorageGatewayRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeFileSystemAssociationsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeFileSystemAssociationsRequest>(GetServiceRequestName(), *this);
    }
