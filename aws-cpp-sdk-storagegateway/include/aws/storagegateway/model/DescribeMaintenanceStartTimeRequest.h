...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeMaintenanceStartTimeRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeMaintenanceStartTimeRequest>(GetServiceRequestName(), *this);
    }
