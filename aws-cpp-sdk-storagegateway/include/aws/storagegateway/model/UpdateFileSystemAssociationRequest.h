...
namespace Model
{
  ...
  /**
   */
  class AWS_STORAGEGATEWAY_API UpdateFileSystemAssociationRequest : public StorageGatewayRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateFileSystemAssociationRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateFileSystemAssociationRequest>(GetServiceRequestName(), *this);
    }
