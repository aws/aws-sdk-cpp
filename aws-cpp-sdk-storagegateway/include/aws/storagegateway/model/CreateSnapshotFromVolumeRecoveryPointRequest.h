...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateSnapshotFromVolumeRecoveryPointRequest> Clone() const
    {
      return Aws::MakeUnique<CreateSnapshotFromVolumeRecoveryPointRequest>(GetServiceRequestName(), *this);
    }
