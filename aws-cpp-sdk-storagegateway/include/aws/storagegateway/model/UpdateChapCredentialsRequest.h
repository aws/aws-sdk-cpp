...
namespace Model
{
   ...
   * <a>UpdateChapCredentialsInput$InitiatorName</a> </li> <li>
   * <a>UpdateChapCredentialsInput$SecretToAuthenticateInitiator</a> </li> <li>
   * <a>UpdateChapCredentialsInput$SecretToAuthenticateTarget</a> </li> <li>
   * <a>UpdateChapCredentialsInput$TargetARN</a> </li> </ul>
   */
  ...
  public:
     ...
     * provide to participate in mutual CHAP with the target.</p> <note>The secret key
     * must be between 12 and 16 bytes when encoded in UTF-8.</note>
     */
     ...
     * of 12. Maximum bytes of 16.</p> <note>The secret key must be between 12 and 16
     * bytes when encoded in UTF-8.</note>
     */
