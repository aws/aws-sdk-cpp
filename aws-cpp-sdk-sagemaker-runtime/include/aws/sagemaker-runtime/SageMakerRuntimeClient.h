...
namespace SageMakerRuntime
{
  ...
  class AWS_SAGEMAKERRUNTIME_API SageMakerRuntimeClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        SageMakerRuntimeClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                               std::shared_ptr<Endpoint::SageMakerRuntimeEndpointProvider> endpointProvider = Aws::MakeShared<SageMakerRuntime::Endpoint::SageMakerRuntimeEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::SageMakerRuntimeEndpointProvider> m_endpointProvider;
  };
