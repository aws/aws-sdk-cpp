...
{
const size_t CleanRoomsEndpointRules::RulesBlobStrLen = 3366;
const size_t CleanRoomsEndpointRules::RulesBlobSize = 3367;
...
't','t','p','s',':','/','/','c','l','e','a','n','r','o','o','m','s','-','f','i','p','s','.','{','R',
...
'/','/','c','l','e','a','n','r','o','o','m','s','-','f','i','p','s','.','{','R','e','g','i','o','n',
...
'c','l','e','a','n','r','o','o','m','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t',
...
'"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','c','l','e','a','n','r','o','o','m','s',
...
const char* CleanRoomsEndpointRules::GetRulesBlob()
{
