...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SECURITYLAKE_API FailuresResponse
  {
  public:
    FailuresResponse();
    FailuresResponse(Aws::Utils::Json::JsonView jsonValue);
    FailuresResponse& operator=(Aws::Utils::Json::JsonView jsonValue);
