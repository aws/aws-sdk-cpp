...
Aws::String SecurityLakeEndpointRules::GetRulesAsString()
{
    return Aws::String(SecurityLakeEndpointRules::Rules.begin(), SecurityLakeEndpointRules::Rules.end());
}

const Aws::Vector<char> SecurityLakeEndpointRules::Rules = {
