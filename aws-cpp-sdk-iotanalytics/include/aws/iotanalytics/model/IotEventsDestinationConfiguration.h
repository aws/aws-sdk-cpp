...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>The name of the AWS IoT Events input to which dataset contents are
     * delivered.</p>
     */
    ...
    /**
     * <p>The ARN of the role that grants AWS IoT Analytics permission to deliver
     * dataset contents to an AWS IoT Events input.</p>
     */
