...
Aws::String IoTAnalyticsEndpointRules::GetRulesAsString()
{
    return Aws::String(IoTAnalyticsEndpointRules::Rules.begin(), IoTAnalyticsEndpointRules::Rules.end());
}

const Aws::Vector<char> IoTAnalyticsEndpointRules::Rules = {
...
't','p','s',':','/','/','i','o','t','a','n','a','l','y','t','i','c','s','-','f','i','p','s','.','{',
...
'h','t','t','p','s',':','/','/','i','o','t','a','n','a','l','y','t','i','c','s','.','{','R','e','g',
...
'i','o','t','a','n','a','l','y','t','i','c','s','.','{','R','e','g','i','o','n','}','.','{','P','a',
