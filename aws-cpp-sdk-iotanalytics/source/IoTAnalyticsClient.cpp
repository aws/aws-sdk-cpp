...
using ResolveEndpointOutcome = Aws::IoTAnalytics::Endpoint::IoTAnalyticsEndpointProvider::IoTAnalyticsResolveEndpointOutcome;
...
IoTAnalyticsClient::IoTAnalyticsClient(const Client::ClientConfiguration& clientConfiguration,
                                       std::shared_ptr<Endpoint::IoTAnalyticsEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<IoTAnalyticsErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<IoTAnalytics::Endpoint::IoTAnalyticsEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
