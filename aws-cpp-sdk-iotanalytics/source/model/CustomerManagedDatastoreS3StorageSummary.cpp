...
CustomerManagedDatastoreS3StorageSummary& CustomerManagedDatastoreS3StorageSummary::operator =(JsonView jsonValue)
{
...
JsonValue CustomerManagedDatastoreS3StorageSummary::Jsonize() const
{
  JsonValue payload;
