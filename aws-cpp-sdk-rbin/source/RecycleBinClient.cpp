...
using ResolveEndpointOutcome = Aws::RecycleBin::Endpoint::RecycleBinEndpointProvider::RecycleBinResolveEndpointOutcome;
...
RecycleBinClient::RecycleBinClient(const Client::ClientConfiguration& clientConfiguration,
                                   std::shared_ptr<Endpoint::RecycleBinEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<RecycleBinErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<RecycleBin::Endpoint::RecycleBinEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
