...
Aws::String RecycleBinEndpointRules::GetRulesAsString()
{
    return Aws::String(RecycleBinEndpointRules::Rules.begin(), RecycleBinEndpointRules::Rules.end());
}

const Aws::Vector<char> RecycleBinEndpointRules::Rules = {
...
'p','o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','r','b',
'i','n','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i',
...
'/','r','b','i','n','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n',
