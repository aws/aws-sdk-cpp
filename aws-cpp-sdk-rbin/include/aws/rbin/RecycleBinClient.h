...
namespace RecycleBin
{
  ...
  class AWS_RECYCLEBIN_API RecycleBinClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        RecycleBinClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                         std::shared_ptr<Endpoint::RecycleBinEndpointProvider> endpointProvider = Aws::MakeShared<RecycleBin::Endpoint::RecycleBinEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::RecycleBinEndpointProvider> m_endpointProvider;
  };
