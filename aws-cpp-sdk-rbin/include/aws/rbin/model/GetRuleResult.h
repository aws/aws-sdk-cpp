...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>The resource type retained by the retention rule. Currently, only Amazon EBS
     * snapshots are supported.</p>
     */
    ...
    /**
     * <p>Information about the period for which the retention rule retains
     * resources.</p>
     */
    ...
    /**
     * <p>The resource tags used to identify resources that are to be retained by the
     * retention rule.</p>
     */
