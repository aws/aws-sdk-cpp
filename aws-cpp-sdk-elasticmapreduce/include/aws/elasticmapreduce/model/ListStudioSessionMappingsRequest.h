...
namespace Model
{
  ...
  /**
   */
  class AWS_EMR_API ListStudioSessionMappingsRequest : public EMRRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListStudioSessionMappingsRequest> Clone() const
    {
      return Aws::MakeUnique<ListStudioSessionMappingsRequest>(GetServiceRequestName(), *this);
    }
