...
namespace Model
{
  ...
  /**
   */
  class AWS_EMR_API PutAutoTerminationPolicyRequest : public EMRRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutAutoTerminationPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<PutAutoTerminationPolicyRequest>(GetServiceRequestName(), *this);
    }
