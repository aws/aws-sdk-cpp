...
namespace Model
{
  ...
  /**
   */
  class AWS_EMR_API GetManagedScalingPolicyRequest : public EMRRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetManagedScalingPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<GetManagedScalingPolicyRequest>(GetServiceRequestName(), *this);
    }
