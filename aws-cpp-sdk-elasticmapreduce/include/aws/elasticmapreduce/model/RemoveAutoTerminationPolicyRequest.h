...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<RemoveAutoTerminationPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<RemoveAutoTerminationPolicyRequest>(GetServiceRequestName(), *this);
    }
