...
namespace Model
{
  ...
  public:
     ...
     * scaling policy is applied is within this cluster.</p>
     */
    inline PutAutoScalingPolicyRequest& WithClusterId(Aws::String&& value) { SetClusterId(value); return *this;}
     ...
     * is applied.</p>
     */
    inline PutAutoScalingPolicyRequest& WithInstanceGroupId(Aws::String&& value) { SetInstanceGroupId(value); return *this;}
     ...
     * <p>Specifies the definition of the automatic scaling policy.</p>
     */
    inline PutAutoScalingPolicyRequest& WithAutoScalingPolicy(AutoScalingPolicy&& value) { SetAutoScalingPolicy(value); return *this;}
