...
namespace Model
{
  ...
  /**
   */
  class AWS_EMR_API DescribeNotebookExecutionRequest : public EMRRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeNotebookExecutionRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeNotebookExecutionRequest>(GetServiceRequestName(), *this);
    }
