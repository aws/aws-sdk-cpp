...
namespace Model
{
  ...
  public:
     ...
     * account can perform EMR cluster actions that their IAM policies allow. When
     ...
     * perform actions on the cluster can use the <a>SetVisibleToAllUsers</a> action to
     * change the value on a running cluster. For more information, see <a
