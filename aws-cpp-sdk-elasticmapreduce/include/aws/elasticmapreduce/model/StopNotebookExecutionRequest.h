...
namespace Model
{
  ...
  /**
   */
  class AWS_EMR_API StopNotebookExecutionRequest : public EMRRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StopNotebookExecutionRequest> Clone() const
    {
      return Aws::MakeUnique<StopNotebookExecutionRequest>(GetServiceRequestName(), *this);
    }
