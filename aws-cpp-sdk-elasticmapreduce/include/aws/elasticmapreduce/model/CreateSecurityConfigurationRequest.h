...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateSecurityConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<CreateSecurityConfigurationRequest>(GetServiceRequestName(), *this);
    }
