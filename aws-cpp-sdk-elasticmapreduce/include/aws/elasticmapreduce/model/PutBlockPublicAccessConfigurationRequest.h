...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PutBlockPublicAccessConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<PutBlockPublicAccessConfigurationRequest>(GetServiceRequestName(), *this);
    }
