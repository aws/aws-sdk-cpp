...
namespace Model
{
  ...
  /**
   */
  class AWS_EMR_API DeleteStudioSessionMappingRequest : public EMRRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteStudioSessionMappingRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteStudioSessionMappingRequest>(GetServiceRequestName(), *this);
    }
