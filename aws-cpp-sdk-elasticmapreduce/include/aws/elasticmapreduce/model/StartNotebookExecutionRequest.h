...
namespace Model
{
  ...
  /**
   */
  class AWS_EMR_API StartNotebookExecutionRequest : public EMRRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StartNotebookExecutionRequest> Clone() const
    {
      return Aws::MakeUnique<StartNotebookExecutionRequest>(GetServiceRequestName(), *this);
    }
