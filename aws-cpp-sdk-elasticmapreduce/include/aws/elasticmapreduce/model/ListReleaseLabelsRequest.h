...
namespace Model
{
  ...
  /**
   */
  class AWS_EMR_API ListReleaseLabelsRequest : public EMRRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListReleaseLabelsRequest> Clone() const
    {
      return Aws::MakeUnique<ListReleaseLabelsRequest>(GetServiceRequestName(), *this);
    }
