...
namespace Model
{
  ...
  /**
   */
  class AWS_EMR_API PutManagedScalingPolicyRequest : public EMRRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutManagedScalingPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<PutManagedScalingPolicyRequest>(GetServiceRequestName(), *this);
    }
