  ...
  public:
    ...
    */
    ...
    /*
     <p> A list of <a>StepConfig</a> to be executed by the job flow. </p>
    */
    inline void SetSteps(const Aws::Vector<StepConfig>& value) { m_steps = value; }
    ...
    */
    ...
    /*
     <p> A list of <a>StepConfig</a> to be executed by the job flow. </p>
    */
    inline AddJobFlowStepsRequest& AddSteps(const StepConfig& value) { m_steps.push_back(value); return *this; }
