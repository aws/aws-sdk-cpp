...
namespace EMR
{
  ...
  class AWS_EMR_API EMRClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        EMRClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                  std::shared_ptr<Endpoint::EMREndpointProvider> endpointProvider = Aws::MakeShared<EMR::Endpoint::EMREndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::EMREndpointProvider> m_endpointProvider;
  };
