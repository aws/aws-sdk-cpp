...
ListStepsResult::ListStepsResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListStepsResult& ListStepsResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
