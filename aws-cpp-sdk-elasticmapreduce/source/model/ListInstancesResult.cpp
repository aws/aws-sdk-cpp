...
ListInstancesResult::ListInstancesResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListInstancesResult& ListInstancesResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
