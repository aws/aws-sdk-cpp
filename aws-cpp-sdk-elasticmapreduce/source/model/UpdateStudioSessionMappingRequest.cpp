...
Aws::String UpdateStudioSessionMappingRequest::SerializePayload() const
{
  JsonValue payload;
...
Aws::Http::HeaderValueCollection UpdateStudioSessionMappingRequest::GetRequestSpecificHeaders() const
{
  Aws::Http::HeaderValueCollection headers;
  headers.insert(Aws::Http::HeaderValuePair("X-Amz-Target", "ElasticMapReduce.UpdateStudioSessionMapping"));
  return headers;
