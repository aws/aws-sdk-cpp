...
Aws::String EMREndpointRules::GetRulesAsString()
{
    return Aws::String(EMREndpointRules::Rules.begin(), EMREndpointRules::Rules.end());
}

const Aws::Vector<char> EMREndpointRules::Rules = {
