...
namespace EMR
{
const size_t EMREndpointRules::RulesBlobStrLen = 3682;
const size_t EMREndpointRules::RulesBlobSize = 3683;
...
't','t','p','s',':','/','/','e','l','a','s','t','i','c','m','a','p','r','e','d','u','c','e','-','f',
...
'"','s','t','r','i','n','g','E','q','u','a','l','s','"',',','"','a','r','g','v','"',':','[','"','a',
'w','s','-','u','s','-','g','o','v','"',',','{','"','f','n','"',':','"','g','e','t','A','t','t','r',
'"',',','"','a','r','g','v','"',':','[','{','"','r','e','f','"',':','"','P','a','r','t','i','t','i',
'o','n','R','e','s','u','l','t','"','}',',','"','n','a','m','e','"',']','}',']','}',']',',','"','e',
...
'p','o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','e','l',
'a','s','t','i','c','m','a','p','r','e','d','u','c','e','-','f','i','p','s','.','{','R','e','g','i',
...
's',':','/','/','e','l','a','s','t','i','c','m','a','p','r','e','d','u','c','e','.','{','R','e','g',
...
const char* EMREndpointRules::GetRulesBlob()
{
