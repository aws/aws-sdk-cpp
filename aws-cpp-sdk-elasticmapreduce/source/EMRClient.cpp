...
using ResolveEndpointOutcome = Aws::EMR::Endpoint::EMREndpointProvider::EMRResolveEndpointOutcome;
...
EMRClient::EMRClient(const Client::ClientConfiguration& clientConfiguration,
                     std::shared_ptr<Endpoint::EMREndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<EMRErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<EMR::Endpoint::EMREndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
