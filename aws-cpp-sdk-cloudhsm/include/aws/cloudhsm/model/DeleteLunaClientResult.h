...
namespace Model
{
  ...
  public:
    ...
    DeleteLunaClientResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    DeleteLunaClientResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
