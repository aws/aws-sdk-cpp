...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDHSM_API ListHapgsRequest : public CloudHSMRequest
  {
  public:
    ListHapgsRequest();
    ...
    */
    virtual Aws::UniquePtr<ListHapgsRequest> Clone() const
    {
      return Aws::MakeUnique<ListHapgsRequest>(GetServiceRequestName(), *this);
    }
