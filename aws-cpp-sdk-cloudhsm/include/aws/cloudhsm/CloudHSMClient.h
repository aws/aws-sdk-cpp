...
namespace CloudHSM
{
  ...
  class AWS_CLOUDHSM_API CloudHSMClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        CloudHSMClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                       std::shared_ptr<Endpoint::CloudHSMEndpointProvider> endpointProvider = Aws::MakeShared<CloudHSM::Endpoint::CloudHSMEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::CloudHSMEndpointProvider> m_endpointProvider;
  };
