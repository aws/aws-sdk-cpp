...
using ResolveEndpointOutcome = Aws::CloudHSM::Endpoint::CloudHSMEndpointProvider::CloudHSMResolveEndpointOutcome;
...
CloudHSMClient::CloudHSMClient(const Client::ClientConfiguration& clientConfiguration,
                               std::shared_ptr<Endpoint::CloudHSMEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<CloudHSMErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<CloudHSM::Endpoint::CloudHSMEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
