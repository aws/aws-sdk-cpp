...
Aws::String CloudHSMEndpointRules::GetRulesAsString()
{
    return Aws::String(CloudHSMEndpointRules::Rules.begin(), CloudHSMEndpointRules::Rules.end());
}

const Aws::Vector<char> CloudHSMEndpointRules::Rules = {
...
'"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','c','l','o','u','d','h','s',
'm','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o',
...
'/','c','l','o','u','d','h','s','m','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{',
...
'l','o','u','d','h','s','m','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i',
...
'l','"',':','"','h','t','t','p','s',':','/','/','c','l','o','u','d','h','s','m','.','{','R','e','g',
