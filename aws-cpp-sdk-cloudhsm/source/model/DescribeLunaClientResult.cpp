...
DescribeLunaClientResult::DescribeLunaClientResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

DescribeLunaClientResult& DescribeLunaClientResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
