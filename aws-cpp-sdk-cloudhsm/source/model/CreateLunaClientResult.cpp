...
CreateLunaClientResult::CreateLunaClientResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

CreateLunaClientResult& CreateLunaClientResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
