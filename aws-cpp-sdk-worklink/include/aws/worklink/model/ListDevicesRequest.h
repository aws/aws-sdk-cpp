...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKLINK_API ListDevicesRequest : public WorkLinkRequest
  {
  public:
    ListDevicesRequest();
     ...
     * <p>The ARN of the fleet.</p>
     */
    inline ListDevicesRequest& WithFleetArn(const Aws::String& value) { SetFleetArn(value); return *this;}

    /**
     * <p>The ARN of the fleet.</p>
     */
    inline ListDevicesRequest& WithFleetArn(Aws::String&& value) { SetFleetArn(std::move(value)); return *this;}

    /**
     * <p>The ARN of the fleet.</p>
     */
    inline ListDevicesRequest& WithFleetArn(const char* value) { SetFleetArn(value); return *this;}
