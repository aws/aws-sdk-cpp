...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKLINK_API DescribeDomainRequest : public WorkLinkRequest
  {
  public:
     ...
     * <p>The ARN of the fleet.</p>
     */
    inline DescribeDomainRequest& WithFleetArn(const Aws::String& value) { SetFleetArn(value); return *this;}

    /**
     * <p>The ARN of the fleet.</p>
     */
    inline DescribeDomainRequest& WithFleetArn(Aws::String&& value) { SetFleetArn(std::move(value)); return *this;}

    /**
     * <p>The ARN of the fleet.</p>
     */
    inline DescribeDomainRequest& WithFleetArn(const char* value) { SetFleetArn(value); return *this;}
