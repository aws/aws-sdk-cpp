...
namespace WorkLink
{
  ...
  class AWS_WORKLINK_API WorkLinkClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        WorkLinkClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                       std::shared_ptr<Endpoint::WorkLinkEndpointProvider> endpointProvider = Aws::MakeShared<WorkLink::Endpoint::WorkLinkEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::WorkLinkEndpointProvider> m_endpointProvider;
  };
