...
namespace WorkLink
{
const size_t WorkLinkEndpointRules::RulesBlobStrLen = 3420;
const size_t WorkLinkEndpointRules::RulesBlobSize = 3421;

using RulesBlobT = Aws::Array<const char, WorkLinkEndpointRules::RulesBlobSize>;
...
't','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','w','o','r','k','l','i',
'n','k','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i',
...
'l','"',':','"','h','t','t','p','s',':','/','/','w','o','r','k','l','i','n','k','-','f','i','p','s',
...
'h','t','t','p','s',':','/','/','w','o','r','k','l','i','n','k','.','{','R','e','g','i','o','n','}',
...
'i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','w','o','r','k',
'l','i','n','k','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R',
'e','s','u','l','t','#','d','n','s','S','u','f','f','i','x','}','"',',','"','p','r','o','p','e','r',
't','i','e','s','"',':','{','}',',','"','h','e','a','d','e','r','s','"',':','{','}','}',',','"','t',
'y','p','e','"',':','"','e','n','d','p','o','i','n','t','"','}',']','}',']','}','\0'
}};

const char* WorkLinkEndpointRules::GetRulesBlob()
{
