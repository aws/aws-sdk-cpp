...
using ResolveEndpointOutcome = Aws::WorkLink::Endpoint::WorkLinkEndpointProvider::WorkLinkResolveEndpointOutcome;
...
WorkLinkClient::WorkLinkClient(const Client::ClientConfiguration& clientConfiguration,
                               std::shared_ptr<Endpoint::WorkLinkEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<WorkLinkErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<WorkLink::Endpoint::WorkLinkEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
