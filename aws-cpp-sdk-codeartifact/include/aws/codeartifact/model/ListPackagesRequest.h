...
namespace Model
{
  ...
  /**
   */
  class AWS_CODEARTIFACT_API ListPackagesRequest : public CodeArtifactRequest
  {
  public:
    ListPackagesRequest();
    ...
    /**
     * <p> The domain that contains the repository that contains the requested list of
     * packages. </p>
     */
    ...
    /**
     * <p> The format of the packages. The valid package types are: </p> <ul> <li> <p>
     * <code>npm</code>: A Node Package Manager (npm) package. </p> </li> <li> <p>
     * <code>pypi</code>: A Python Package Index (PyPI) package. </p> </li> <li> <p>
    ...
    /**
     * <p> A prefix used to filter returned packages. Only packages with names that
  ...
  private:
    ...
    bool m_packagePrefixHasBeenSet;
