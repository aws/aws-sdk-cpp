...
namespace Model
{
  ...
  /**
   */
  class AWS_CODEARTIFACT_API DeleteDomainPermissionsPolicyRequest : public CodeArtifactRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteDomainPermissionsPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteDomainPermissionsPolicyRequest>(GetServiceRequestName(), *this);
    }
