...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListPackageVersionDependenciesRequest> Clone() const
    {
      return Aws::MakeUnique<ListPackageVersionDependenciesRequest>(GetServiceRequestName(), *this);
    }
