...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PutRepositoryPermissionsPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<PutRepositoryPermissionsPolicyRequest>(GetServiceRequestName(), *this);
    }
