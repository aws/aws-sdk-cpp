...
namespace Model
{
  ...
  /**
   */
  class AWS_CODEARTIFACT_API PutDomainPermissionsPolicyRequest : public CodeArtifactRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutDomainPermissionsPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<PutDomainPermissionsPolicyRequest>(GetServiceRequestName(), *this);
    }
