...
namespace Model
{
  ...
  /**
   */
  class AWS_CODEARTIFACT_API GetDomainPermissionsPolicyRequest : public CodeArtifactRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetDomainPermissionsPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<GetDomainPermissionsPolicyRequest>(GetServiceRequestName(), *this);
    }
