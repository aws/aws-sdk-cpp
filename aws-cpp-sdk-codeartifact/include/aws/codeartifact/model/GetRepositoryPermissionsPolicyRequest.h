...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetRepositoryPermissionsPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<GetRepositoryPermissionsPolicyRequest>(GetServiceRequestName(), *this);
    }
