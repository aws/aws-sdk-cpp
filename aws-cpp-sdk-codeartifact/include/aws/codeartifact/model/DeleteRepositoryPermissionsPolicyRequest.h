...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteRepositoryPermissionsPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteRepositoryPermissionsPolicyRequest>(GetServiceRequestName(), *this);
    }
