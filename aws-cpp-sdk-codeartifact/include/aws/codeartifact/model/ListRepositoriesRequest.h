...
namespace Model
{
  ...
  /**
   */
  class AWS_CODEARTIFACT_API ListRepositoriesRequest : public CodeArtifactRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListRepositoriesRequest> Clone() const
    {
      return Aws::MakeUnique<ListRepositoriesRequest>(GetServiceRequestName(), *this);
    }
