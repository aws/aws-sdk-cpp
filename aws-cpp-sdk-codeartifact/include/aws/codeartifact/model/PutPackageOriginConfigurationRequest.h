...
namespace Model
{
  ...
  /**
   */
  class AWS_CODEARTIFACT_API PutPackageOriginConfigurationRequest : public CodeArtifactRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutPackageOriginConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<PutPackageOriginConfigurationRequest>(GetServiceRequestName(), *this);
    }
