...
namespace Model
{
  ...
  /**
   */
  class AWS_CODEARTIFACT_API UpdatePackageVersionsStatusRequest : public CodeArtifactRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdatePackageVersionsStatusRequest> Clone() const
    {
      return Aws::MakeUnique<UpdatePackageVersionsStatusRequest>(GetServiceRequestName(), *this);
    }
