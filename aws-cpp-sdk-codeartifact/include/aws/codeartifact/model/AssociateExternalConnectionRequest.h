...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateExternalConnectionRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateExternalConnectionRequest>(GetServiceRequestName(), *this);
    }
