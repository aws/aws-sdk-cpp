...
namespace Model
{
  ...
  /**
   */
  class AWS_CODEARTIFACT_API GetPackageVersionReadmeRequest : public CodeArtifactRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetPackageVersionReadmeRequest> Clone() const
    {
      return Aws::MakeUnique<GetPackageVersionReadmeRequest>(GetServiceRequestName(), *this);
    }
     ...
     * <code>3.5.2</code>). </p>
     */
    inline GetPackageVersionReadmeRequest& WithPackageVersion(const char* value) { SetPackageVersion(value); return *this;}
