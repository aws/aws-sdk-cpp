...
namespace Model
{
  ...
  /**
   */
  class AWS_CODEARTIFACT_API ListPackageVersionAssetsRequest : public CodeArtifactRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListPackageVersionAssetsRequest> Clone() const
    {
      return Aws::MakeUnique<ListPackageVersionAssetsRequest>(GetServiceRequestName(), *this);
    }
