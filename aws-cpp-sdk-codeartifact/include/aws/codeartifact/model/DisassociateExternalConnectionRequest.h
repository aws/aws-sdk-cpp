...
namespace Model
{
  ...
  /**
   */
  class AWS_CODEARTIFACT_API DisassociateExternalConnectionRequest : public CodeArtifactRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateExternalConnectionRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateExternalConnectionRequest>(GetServiceRequestName(), *this);
    }
