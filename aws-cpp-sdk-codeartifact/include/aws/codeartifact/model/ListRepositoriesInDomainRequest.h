...
namespace Model
{
  ...
  /**
   */
  class AWS_CODEARTIFACT_API ListRepositoriesInDomainRequest : public CodeArtifactRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListRepositoriesInDomainRequest> Clone() const
    {
      return Aws::MakeUnique<ListRepositoriesInDomainRequest>(GetServiceRequestName(), *this);
    }
