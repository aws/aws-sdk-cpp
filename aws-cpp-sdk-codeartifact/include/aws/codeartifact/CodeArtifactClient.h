...
namespace CodeArtifact
{
  ...
  class AWS_CODEARTIFACT_API CodeArtifactClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        CodeArtifactClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                           std::shared_ptr<Endpoint::CodeArtifactEndpointProvider> endpointProvider = Aws::MakeShared<CodeArtifact::Endpoint::CodeArtifactEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::CodeArtifactEndpointProvider> m_endpointProvider;
  };
