...
namespace Model
{
        ...
        typedef Aws::Utils::Outcome<AssociateExternalConnectionResult, Aws::Client::AWSError<CodeArtifactErrors>> AssociateExternalConnectionOutcome;
        typedef Aws::Utils::Outcome<CopyPackageVersionsResult, Aws::Client::AWSError<CodeArtifactErrors>> CopyPackageVersionsOutcome;
        typedef Aws::Utils::Outcome<CreateDomainResult, Aws::Client::AWSError<CodeArtifactErrors>> CreateDomainOutcome;
        typedef Aws::Utils::Outcome<CreateRepositoryResult, Aws::Client::AWSError<CodeArtifactErrors>> CreateRepositoryOutcome;
        typedef Aws::Utils::Outcome<DeleteDomainResult, Aws::Client::AWSError<CodeArtifactErrors>> DeleteDomainOutcome;
        typedef Aws::Utils::Outcome<DeleteDomainPermissionsPolicyResult, Aws::Client::AWSError<CodeArtifactErrors>> DeleteDomainPermissionsPolicyOutcome;
        typedef Aws::Utils::Outcome<DeletePackageVersionsResult, Aws::Client::AWSError<CodeArtifactErrors>> DeletePackageVersionsOutcome;
        typedef Aws::Utils::Outcome<DeleteRepositoryResult, Aws::Client::AWSError<CodeArtifactErrors>> DeleteRepositoryOutcome;
        typedef Aws::Utils::Outcome<DeleteRepositoryPermissionsPolicyResult, Aws::Client::AWSError<CodeArtifactErrors>> DeleteRepositoryPermissionsPolicyOutcome;
        typedef Aws::Utils::Outcome<DescribeDomainResult, Aws::Client::AWSError<CodeArtifactErrors>> DescribeDomainOutcome;
        typedef Aws::Utils::Outcome<DescribePackageVersionResult, Aws::Client::AWSError<CodeArtifactErrors>> DescribePackageVersionOutcome;
        typedef Aws::Utils::Outcome<DescribeRepositoryResult, Aws::Client::AWSError<CodeArtifactErrors>> DescribeRepositoryOutcome;
        typedef Aws::Utils::Outcome<DisassociateExternalConnectionResult, Aws::Client::AWSError<CodeArtifactErrors>> DisassociateExternalConnectionOutcome;
        typedef Aws::Utils::Outcome<DisposePackageVersionsResult, Aws::Client::AWSError<CodeArtifactErrors>> DisposePackageVersionsOutcome;
        typedef Aws::Utils::Outcome<GetAuthorizationTokenResult, Aws::Client::AWSError<CodeArtifactErrors>> GetAuthorizationTokenOutcome;
        typedef Aws::Utils::Outcome<GetDomainPermissionsPolicyResult, Aws::Client::AWSError<CodeArtifactErrors>> GetDomainPermissionsPolicyOutcome;
        typedef Aws::Utils::Outcome<GetPackageVersionAssetResult, Aws::Client::AWSError<CodeArtifactErrors>> GetPackageVersionAssetOutcome;
        typedef Aws::Utils::Outcome<GetPackageVersionReadmeResult, Aws::Client::AWSError<CodeArtifactErrors>> GetPackageVersionReadmeOutcome;
        typedef Aws::Utils::Outcome<GetRepositoryEndpointResult, Aws::Client::AWSError<CodeArtifactErrors>> GetRepositoryEndpointOutcome;
        typedef Aws::Utils::Outcome<GetRepositoryPermissionsPolicyResult, Aws::Client::AWSError<CodeArtifactErrors>> GetRepositoryPermissionsPolicyOutcome;
        typedef Aws::Utils::Outcome<ListDomainsResult, Aws::Client::AWSError<CodeArtifactErrors>> ListDomainsOutcome;
        typedef Aws::Utils::Outcome<ListPackageVersionAssetsResult, Aws::Client::AWSError<CodeArtifactErrors>> ListPackageVersionAssetsOutcome;
        typedef Aws::Utils::Outcome<ListPackageVersionDependenciesResult, Aws::Client::AWSError<CodeArtifactErrors>> ListPackageVersionDependenciesOutcome;
        typedef Aws::Utils::Outcome<ListPackageVersionsResult, Aws::Client::AWSError<CodeArtifactErrors>> ListPackageVersionsOutcome;
        typedef Aws::Utils::Outcome<ListPackagesResult, Aws::Client::AWSError<CodeArtifactErrors>> ListPackagesOutcome;
        typedef Aws::Utils::Outcome<ListRepositoriesResult, Aws::Client::AWSError<CodeArtifactErrors>> ListRepositoriesOutcome;
        typedef Aws::Utils::Outcome<ListRepositoriesInDomainResult, Aws::Client::AWSError<CodeArtifactErrors>> ListRepositoriesInDomainOutcome;
        typedef Aws::Utils::Outcome<PutDomainPermissionsPolicyResult, Aws::Client::AWSError<CodeArtifactErrors>> PutDomainPermissionsPolicyOutcome;
        typedef Aws::Utils::Outcome<PutRepositoryPermissionsPolicyResult, Aws::Client::AWSError<CodeArtifactErrors>> PutRepositoryPermissionsPolicyOutcome;
        typedef Aws::Utils::Outcome<UpdatePackageVersionsStatusResult, Aws::Client::AWSError<CodeArtifactErrors>> UpdatePackageVersionsStatusOutcome;
        typedef Aws::Utils::Outcome<UpdateRepositoryResult, Aws::Client::AWSError<CodeArtifactErrors>> UpdateRepositoryOutcome;
