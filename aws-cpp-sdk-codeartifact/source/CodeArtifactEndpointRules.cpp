...
Aws::String CodeArtifactEndpointRules::GetRulesAsString()
{
    return Aws::String(CodeArtifactEndpointRules::Rules.begin(), CodeArtifactEndpointRules::Rules.end());
}

const Aws::Vector<char> CodeArtifactEndpointRules::Rules = {
...
'"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','c','o','d','e','a','r','t',
'i','f','a','c','t','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t',
...
'p','s',':','/','/','c','o','d','e','a','r','t','i','f','a','c','t','-','f','i','p','s','.','{','R',
...
't','t','p','s',':','/','/','c','o','d','e','a','r','t','i','f','a','c','t','.','{','R','e','g','i',
...
'o','d','e','a','r','t','i','f','a','c','t','.','{','R','e','g','i','o','n','}','.','{','P','a','r',
