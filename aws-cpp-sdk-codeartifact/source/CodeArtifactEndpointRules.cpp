...
{
const size_t CodeArtifactEndpointRules::RulesBlobStrLen = 3478;
const size_t CodeArtifactEndpointRules::RulesBlobSize = 3479;
...
't','p','s',':','/','/','c','o','d','e','a','r','t','i','f','a','c','t','-','f','i','p','s','.','{',
...
'h','t','t','p','s',':','/','/','c','o','d','e','a','r','t','i','f','a','c','t','.','{','R','e','g',
...
'c','o','d','e','a','r','t','i','f','a','c','t','.','{','R','e','g','i','o','n','}','.','{','P','a',
