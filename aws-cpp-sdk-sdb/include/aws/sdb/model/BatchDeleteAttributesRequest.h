  ...
  public:
    ...
    */
    ...
    /*
     A list of items on which to perform the operation.
    */
    inline void SetItems(const Aws::Vector<DeletableItem>& value) { m_items = value; }
    ...
    */
    ...
    /*
     A list of items on which to perform the operation.
    */
    inline BatchDeleteAttributesRequest& AddItems(const DeletableItem& value) { m_items.push_back(value); return *this; }
