...
GetAttributesResult::GetAttributesResult(const AmazonWebServiceResult<XmlDocument>& result)
{
  *this = result;
}

GetAttributesResult& GetAttributesResult::operator =(const AmazonWebServiceResult<XmlDocument>& result)
{
