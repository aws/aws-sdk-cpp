...
namespace SimpleDB
{
const size_t SimpleDBEndpointRules::RulesBlobStrLen = 3655;
const size_t SimpleDBEndpointRules::RulesBlobSize = 3656;

using RulesBlobT = Aws::Array<const char, SimpleDBEndpointRules::RulesBlobSize>;
...
'"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','s','d','b','.','{','R','e','g','i','o',
...
'"','h','t','t','p','s',':','/','/','s','d','b','.','{','R','e','g','i','o','n','}','.','{','P','a',
...
const char* SimpleDBEndpointRules::GetRulesBlob()
{
