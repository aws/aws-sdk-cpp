...
Aws::String SimpleDBEndpointRules::GetRulesAsString()
{
    return Aws::String(SimpleDBEndpointRules::Rules.begin(), SimpleDBEndpointRules::Rules.end());
}

const Aws::Vector<char> SimpleDBEndpointRules::Rules = {
