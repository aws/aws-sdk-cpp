...
namespace QuickSight
{
  ...
  class AWS_QUICKSIGHT_API QuickSightClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        QuickSightClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                         std::shared_ptr<Endpoint::QuickSightEndpointProvider> endpointProvider = Aws::MakeShared<QuickSight::Endpoint::QuickSightEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::QuickSightEndpointProvider> m_endpointProvider;
  };
