...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API UnaggregatedField
  {
  public:
    UnaggregatedField();
    UnaggregatedField(Aws::Utils::Json::JsonView jsonValue);
    UnaggregatedField& operator=(Aws::Utils::Json::JsonView jsonValue);
