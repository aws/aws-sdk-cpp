...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API BoxPlotFieldWells
  {
  public:
    BoxPlotFieldWells();
    BoxPlotFieldWells(Aws::Utils::Json::JsonView jsonValue);
    BoxPlotFieldWells& operator=(Aws::Utils::Json::JsonView jsonValue);
