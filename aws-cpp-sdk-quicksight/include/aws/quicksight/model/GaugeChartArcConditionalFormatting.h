...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API GaugeChartArcConditionalFormatting
  {
  public:
    GaugeChartArcConditionalFormatting();
    GaugeChartArcConditionalFormatting(Aws::Utils::Json::JsonView jsonValue);
    GaugeChartArcConditionalFormatting& operator=(Aws::Utils::Json::JsonView jsonValue);
