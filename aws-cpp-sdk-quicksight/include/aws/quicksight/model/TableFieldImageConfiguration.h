...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API TableFieldImageConfiguration
  {
  public:
    TableFieldImageConfiguration();
    TableFieldImageConfiguration(Aws::Utils::Json::JsonView jsonValue);
    TableFieldImageConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
