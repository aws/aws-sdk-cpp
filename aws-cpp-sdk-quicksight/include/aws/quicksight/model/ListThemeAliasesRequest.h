...
namespace Model
{
  ...
  /**
   */
  class AWS_QUICKSIGHT_API ListThemeAliasesRequest : public QuickSightRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListThemeAliasesRequest> Clone() const
    {
      return Aws::MakeUnique<ListThemeAliasesRequest>(GetServiceRequestName(), *this);
    }
