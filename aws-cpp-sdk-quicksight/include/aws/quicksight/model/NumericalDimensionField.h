...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API NumericalDimensionField
  {
  public:
    NumericalDimensionField();
    NumericalDimensionField(Aws::Utils::Json::JsonView jsonValue);
    NumericalDimensionField& operator=(Aws::Utils::Json::JsonView jsonValue);
