...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API IntegerValueWhenUnsetConfiguration
  {
  public:
    IntegerValueWhenUnsetConfiguration();
    IntegerValueWhenUnsetConfiguration(Aws::Utils::Json::JsonView jsonValue);
    IntegerValueWhenUnsetConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
