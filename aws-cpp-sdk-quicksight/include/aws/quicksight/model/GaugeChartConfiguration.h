...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API GaugeChartConfiguration
  {
  public:
    GaugeChartConfiguration();
    GaugeChartConfiguration(Aws::Utils::Json::JsonView jsonValue);
    GaugeChartConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
