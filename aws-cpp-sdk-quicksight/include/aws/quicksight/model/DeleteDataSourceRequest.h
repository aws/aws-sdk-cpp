...
namespace Model
{
  ...
  /**
   */
  class AWS_QUICKSIGHT_API DeleteDataSourceRequest : public QuickSightRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteDataSourceRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteDataSourceRequest>(GetServiceRequestName(), *this);
    }
