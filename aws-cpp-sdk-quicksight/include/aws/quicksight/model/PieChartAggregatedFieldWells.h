...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API PieChartAggregatedFieldWells
  {
  public:
    PieChartAggregatedFieldWells();
    PieChartAggregatedFieldWells(Aws::Utils::Json::JsonView jsonValue);
    PieChartAggregatedFieldWells& operator=(Aws::Utils::Json::JsonView jsonValue);
