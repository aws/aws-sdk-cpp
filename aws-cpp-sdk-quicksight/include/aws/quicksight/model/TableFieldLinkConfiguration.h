...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API TableFieldLinkConfiguration
  {
  public:
    TableFieldLinkConfiguration();
    TableFieldLinkConfiguration(Aws::Utils::Json::JsonView jsonValue);
    TableFieldLinkConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
