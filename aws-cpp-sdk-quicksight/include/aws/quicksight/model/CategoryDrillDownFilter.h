...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API CategoryDrillDownFilter
  {
  public:
    CategoryDrillDownFilter();
    CategoryDrillDownFilter(Aws::Utils::Json::JsonView jsonValue);
    CategoryDrillDownFilter& operator=(Aws::Utils::Json::JsonView jsonValue);
