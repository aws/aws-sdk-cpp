...
namespace Model
{
  ...
  /**
   */
  class AWS_QUICKSIGHT_API ListIAMPolicyAssignmentsForUserRequest : public QuickSightRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListIAMPolicyAssignmentsForUserRequest> Clone() const
    {
      return Aws::MakeUnique<ListIAMPolicyAssignmentsForUserRequest>(GetServiceRequestName(), *this);
    }
