...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API GeospatialMapVisual
  {
  public:
    GeospatialMapVisual();
    GeospatialMapVisual(Aws::Utils::Json::JsonView jsonValue);
    GeospatialMapVisual& operator=(Aws::Utils::Json::JsonView jsonValue);
