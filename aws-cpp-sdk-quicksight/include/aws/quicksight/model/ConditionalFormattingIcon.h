...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API ConditionalFormattingIcon
  {
  public:
    ConditionalFormattingIcon();
    ConditionalFormattingIcon(Aws::Utils::Json::JsonView jsonValue);
    ConditionalFormattingIcon& operator=(Aws::Utils::Json::JsonView jsonValue);
