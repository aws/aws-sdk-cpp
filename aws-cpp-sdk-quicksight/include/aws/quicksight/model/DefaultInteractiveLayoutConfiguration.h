...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API DefaultInteractiveLayoutConfiguration
  {
  public:
    DefaultInteractiveLayoutConfiguration();
    DefaultInteractiveLayoutConfiguration(Aws::Utils::Json::JsonView jsonValue);
    DefaultInteractiveLayoutConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
