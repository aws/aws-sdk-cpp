...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API FilterDropDownControl
  {
  public:
    FilterDropDownControl();
    FilterDropDownControl(Aws::Utils::Json::JsonView jsonValue);
    FilterDropDownControl& operator=(Aws::Utils::Json::JsonView jsonValue);
