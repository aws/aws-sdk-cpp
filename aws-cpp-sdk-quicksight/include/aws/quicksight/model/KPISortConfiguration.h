...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API KPISortConfiguration
  {
  public:
    KPISortConfiguration();
    KPISortConfiguration(Aws::Utils::Json::JsonView jsonValue);
    KPISortConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
