...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API WhatIfRangeScenario
  {
  public:
    WhatIfRangeScenario();
    WhatIfRangeScenario(Aws::Utils::Json::JsonView jsonValue);
    WhatIfRangeScenario& operator=(Aws::Utils::Json::JsonView jsonValue);
