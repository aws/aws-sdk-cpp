...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API ForecastConfiguration
  {
  public:
    ForecastConfiguration();
    ForecastConfiguration(Aws::Utils::Json::JsonView jsonValue);
    ForecastConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
