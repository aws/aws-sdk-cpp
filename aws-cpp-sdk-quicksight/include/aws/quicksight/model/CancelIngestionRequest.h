...
namespace Model
{
  ...
  /**
   */
  class AWS_QUICKSIGHT_API CancelIngestionRequest : public QuickSightRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CancelIngestionRequest> Clone() const
    {
      return Aws::MakeUnique<CancelIngestionRequest>(GetServiceRequestName(), *this);
    }
