...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API HistogramAggregatedFieldWells
  {
  public:
    HistogramAggregatedFieldWells();
    HistogramAggregatedFieldWells(Aws::Utils::Json::JsonView jsonValue);
    HistogramAggregatedFieldWells& operator=(Aws::Utils::Json::JsonView jsonValue);
