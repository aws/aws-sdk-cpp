...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeIAMPolicyAssignmentRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeIAMPolicyAssignmentRequest>(GetServiceRequestName(), *this);
    }
