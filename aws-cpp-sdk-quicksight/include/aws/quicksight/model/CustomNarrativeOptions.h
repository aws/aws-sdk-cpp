...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API CustomNarrativeOptions
  {
  public:
    CustomNarrativeOptions();
    CustomNarrativeOptions(Aws::Utils::Json::JsonView jsonValue);
    CustomNarrativeOptions& operator=(Aws::Utils::Json::JsonView jsonValue);
