...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API TableFieldOption
  {
  public:
    TableFieldOption();
    TableFieldOption(Aws::Utils::Json::JsonView jsonValue);
    TableFieldOption& operator=(Aws::Utils::Json::JsonView jsonValue);
