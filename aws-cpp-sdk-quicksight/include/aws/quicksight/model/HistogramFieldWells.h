...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API HistogramFieldWells
  {
  public:
    HistogramFieldWells();
    HistogramFieldWells(Aws::Utils::Json::JsonView jsonValue);
    HistogramFieldWells& operator=(Aws::Utils::Json::JsonView jsonValue);
