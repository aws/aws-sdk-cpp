...
namespace Model
{
  ...
  /**
   */
  class AWS_QUICKSIGHT_API SearchGroupsRequest : public QuickSightRequest
  {
  public:
    SearchGroupsRequest();
    ...
    */
    virtual Aws::UniquePtr<SearchGroupsRequest> Clone() const
    {
      return Aws::MakeUnique<SearchGroupsRequest>(GetServiceRequestName(), *this);
    }
