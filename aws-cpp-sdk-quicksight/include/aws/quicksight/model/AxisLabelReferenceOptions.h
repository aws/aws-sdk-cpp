...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API AxisLabelReferenceOptions
  {
  public:
    AxisLabelReferenceOptions();
    AxisLabelReferenceOptions(Aws::Utils::Json::JsonView jsonValue);
    AxisLabelReferenceOptions& operator=(Aws::Utils::Json::JsonView jsonValue);
