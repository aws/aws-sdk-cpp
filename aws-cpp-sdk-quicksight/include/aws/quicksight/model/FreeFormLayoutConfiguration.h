...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API FreeFormLayoutConfiguration
  {
  public:
    FreeFormLayoutConfiguration();
    FreeFormLayoutConfiguration(Aws::Utils::Json::JsonView jsonValue);
    FreeFormLayoutConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
