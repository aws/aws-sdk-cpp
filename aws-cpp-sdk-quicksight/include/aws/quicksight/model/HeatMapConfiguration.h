...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API HeatMapConfiguration
  {
  public:
    HeatMapConfiguration();
    HeatMapConfiguration(Aws::Utils::Json::JsonView jsonValue);
    HeatMapConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
