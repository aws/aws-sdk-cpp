...
namespace Model
{
  ...
  /**
   */
  class AWS_QUICKSIGHT_API SearchDashboardsRequest : public QuickSightRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<SearchDashboardsRequest> Clone() const
    {
      return Aws::MakeUnique<SearchDashboardsRequest>(GetServiceRequestName(), *this);
    }
