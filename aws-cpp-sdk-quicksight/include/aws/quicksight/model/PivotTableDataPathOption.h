...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API PivotTableDataPathOption
  {
  public:
    PivotTableDataPathOption();
    PivotTableDataPathOption(Aws::Utils::Json::JsonView jsonValue);
    PivotTableDataPathOption& operator=(Aws::Utils::Json::JsonView jsonValue);
