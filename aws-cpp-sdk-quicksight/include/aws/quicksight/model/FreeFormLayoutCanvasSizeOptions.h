...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API FreeFormLayoutCanvasSizeOptions
  {
  public:
    FreeFormLayoutCanvasSizeOptions();
    FreeFormLayoutCanvasSizeOptions(Aws::Utils::Json::JsonView jsonValue);
    FreeFormLayoutCanvasSizeOptions& operator=(Aws::Utils::Json::JsonView jsonValue);
