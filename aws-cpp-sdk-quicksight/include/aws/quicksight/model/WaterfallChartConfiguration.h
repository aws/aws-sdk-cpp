...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API WaterfallChartConfiguration
  {
  public:
    WaterfallChartConfiguration();
    WaterfallChartConfiguration(Aws::Utils::Json::JsonView jsonValue);
    WaterfallChartConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
