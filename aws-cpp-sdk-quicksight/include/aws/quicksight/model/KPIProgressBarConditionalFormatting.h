...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API KPIProgressBarConditionalFormatting
  {
  public:
    KPIProgressBarConditionalFormatting();
    KPIProgressBarConditionalFormatting(Aws::Utils::Json::JsonView jsonValue);
    KPIProgressBarConditionalFormatting& operator=(Aws::Utils::Json::JsonView jsonValue);
