...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API StringDefaultValues
  {
  public:
    StringDefaultValues();
    StringDefaultValues(Aws::Utils::Json::JsonView jsonValue);
    StringDefaultValues& operator=(Aws::Utils::Json::JsonView jsonValue);
