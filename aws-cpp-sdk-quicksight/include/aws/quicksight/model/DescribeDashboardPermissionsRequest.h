...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeDashboardPermissionsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeDashboardPermissionsRequest>(GetServiceRequestName(), *this);
    }
