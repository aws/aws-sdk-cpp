...
namespace Model
{
  ...
  /**
   */
  class AWS_QUICKSIGHT_API DescribeDataSetPermissionsRequest : public QuickSightRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeDataSetPermissionsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeDataSetPermissionsRequest>(GetServiceRequestName(), *this);
    }
