...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API WordCloudAggregatedFieldWells
  {
  public:
    WordCloudAggregatedFieldWells();
    WordCloudAggregatedFieldWells(Aws::Utils::Json::JsonView jsonValue);
    WordCloudAggregatedFieldWells& operator=(Aws::Utils::Json::JsonView jsonValue);
