...
namespace Model
{
  ...
  /**
   */
  class AWS_QUICKSIGHT_API UpdateAccountCustomizationRequest : public QuickSightRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateAccountCustomizationRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateAccountCustomizationRequest>(GetServiceRequestName(), *this);
    }
