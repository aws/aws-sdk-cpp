...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API SectionAfterPageBreak
  {
  public:
    SectionAfterPageBreak();
    SectionAfterPageBreak(Aws::Utils::Json::JsonView jsonValue);
    SectionAfterPageBreak& operator=(Aws::Utils::Json::JsonView jsonValue);
