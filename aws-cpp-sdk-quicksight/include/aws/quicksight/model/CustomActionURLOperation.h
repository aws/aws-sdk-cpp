...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API CustomActionURLOperation
  {
  public:
    CustomActionURLOperation();
    CustomActionURLOperation(Aws::Utils::Json::JsonView jsonValue);
    CustomActionURLOperation& operator=(Aws::Utils::Json::JsonView jsonValue);
