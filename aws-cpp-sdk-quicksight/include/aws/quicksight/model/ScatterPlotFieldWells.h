...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API ScatterPlotFieldWells
  {
  public:
    ScatterPlotFieldWells();
    ScatterPlotFieldWells(Aws::Utils::Json::JsonView jsonValue);
    ScatterPlotFieldWells& operator=(Aws::Utils::Json::JsonView jsonValue);
