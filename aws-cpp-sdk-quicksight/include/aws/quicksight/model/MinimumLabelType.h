...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API MinimumLabelType
  {
  public:
    MinimumLabelType();
    MinimumLabelType(Aws::Utils::Json::JsonView jsonValue);
    MinimumLabelType& operator=(Aws::Utils::Json::JsonView jsonValue);
