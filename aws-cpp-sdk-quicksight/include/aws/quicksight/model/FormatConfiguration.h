...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API FormatConfiguration
  {
  public:
    FormatConfiguration();
    FormatConfiguration(Aws::Utils::Json::JsonView jsonValue);
    FormatConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
