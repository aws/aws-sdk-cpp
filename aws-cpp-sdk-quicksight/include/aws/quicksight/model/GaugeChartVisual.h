...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API GaugeChartVisual
  {
  public:
    GaugeChartVisual();
    GaugeChartVisual(Aws::Utils::Json::JsonView jsonValue);
    GaugeChartVisual& operator=(Aws::Utils::Json::JsonView jsonValue);
