...
namespace Model
{
  ...
  /**
   */
  class AWS_QUICKSIGHT_API DescribeDataSourcePermissionsRequest : public QuickSightRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeDataSourcePermissionsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeDataSourcePermissionsRequest>(GetServiceRequestName(), *this);
    }
