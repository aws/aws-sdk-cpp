...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API PercentVisibleRange
  {
  public:
    PercentVisibleRange();
    PercentVisibleRange(Aws::Utils::Json::JsonView jsonValue);
    PercentVisibleRange& operator=(Aws::Utils::Json::JsonView jsonValue);
