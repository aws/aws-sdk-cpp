...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API FreeFormLayoutElementBorderStyle
  {
  public:
    FreeFormLayoutElementBorderStyle();
    FreeFormLayoutElementBorderStyle(Aws::Utils::Json::JsonView jsonValue);
    FreeFormLayoutElementBorderStyle& operator=(Aws::Utils::Json::JsonView jsonValue);
