...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API DateDimensionField
  {
  public:
    DateDimensionField();
    DateDimensionField(Aws::Utils::Json::JsonView jsonValue);
    DateDimensionField& operator=(Aws::Utils::Json::JsonView jsonValue);
