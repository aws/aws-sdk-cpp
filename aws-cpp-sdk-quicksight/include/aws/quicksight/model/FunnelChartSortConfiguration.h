...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API FunnelChartSortConfiguration
  {
  public:
    FunnelChartSortConfiguration();
    FunnelChartSortConfiguration(Aws::Utils::Json::JsonView jsonValue);
    FunnelChartSortConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
