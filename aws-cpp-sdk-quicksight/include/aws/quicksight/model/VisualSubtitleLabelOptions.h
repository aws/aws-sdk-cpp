...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API VisualSubtitleLabelOptions
  {
  public:
    VisualSubtitleLabelOptions();
    VisualSubtitleLabelOptions(Aws::Utils::Json::JsonView jsonValue);
    VisualSubtitleLabelOptions& operator=(Aws::Utils::Json::JsonView jsonValue);
