...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API PreconditionNotMetException
  {
  public:
    PreconditionNotMetException();
    PreconditionNotMetException(Aws::Utils::Json::JsonView jsonValue);
    PreconditionNotMetException& operator=(Aws::Utils::Json::JsonView jsonValue);
