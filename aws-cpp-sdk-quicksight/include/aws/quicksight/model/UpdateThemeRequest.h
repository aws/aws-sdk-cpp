...
namespace Model
{
  ...
  /**
   */
  class AWS_QUICKSIGHT_API UpdateThemeRequest : public QuickSightRequest
  {
  public:
    UpdateThemeRequest();
    ...
    */
    virtual Aws::UniquePtr<UpdateThemeRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateThemeRequest>(GetServiceRequestName(), *this);
    }
