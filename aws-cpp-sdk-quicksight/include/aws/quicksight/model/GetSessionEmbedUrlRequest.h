...
namespace Model
{
  ...
  /**
   */
  class AWS_QUICKSIGHT_API GetSessionEmbedUrlRequest : public QuickSightRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetSessionEmbedUrlRequest> Clone() const
    {
      return Aws::MakeUnique<GetSessionEmbedUrlRequest>(GetServiceRequestName(), *this);
    }
