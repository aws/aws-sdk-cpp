...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API HeatMapSortConfiguration
  {
  public:
    HeatMapSortConfiguration();
    HeatMapSortConfiguration(Aws::Utils::Json::JsonView jsonValue);
    HeatMapSortConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
