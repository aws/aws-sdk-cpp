...
namespace Model
{
  ...
  /**
   */
  class AWS_QUICKSIGHT_API DeleteThemeAliasRequest : public QuickSightRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteThemeAliasRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteThemeAliasRequest>(GetServiceRequestName(), *this);
    }
