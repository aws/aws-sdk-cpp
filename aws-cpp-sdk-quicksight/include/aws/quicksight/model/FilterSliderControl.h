...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API FilterSliderControl
  {
  public:
    FilterSliderControl();
    FilterSliderControl(Aws::Utils::Json::JsonView jsonValue);
    FilterSliderControl& operator=(Aws::Utils::Json::JsonView jsonValue);
