...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API TotalAggregationComputation
  {
  public:
    TotalAggregationComputation();
    TotalAggregationComputation(Aws::Utils::Json::JsonView jsonValue);
    TotalAggregationComputation& operator=(Aws::Utils::Json::JsonView jsonValue);
