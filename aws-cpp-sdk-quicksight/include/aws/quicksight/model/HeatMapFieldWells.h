...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API HeatMapFieldWells
  {
  public:
    HeatMapFieldWells();
    HeatMapFieldWells(Aws::Utils::Json::JsonView jsonValue);
    HeatMapFieldWells& operator=(Aws::Utils::Json::JsonView jsonValue);
