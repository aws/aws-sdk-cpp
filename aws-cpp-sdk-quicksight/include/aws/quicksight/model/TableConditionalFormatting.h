...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API TableConditionalFormatting
  {
  public:
    TableConditionalFormatting();
    TableConditionalFormatting(Aws::Utils::Json::JsonView jsonValue);
    TableConditionalFormatting& operator=(Aws::Utils::Json::JsonView jsonValue);
