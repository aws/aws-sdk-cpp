...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API FilterSelectableValues
  {
  public:
    FilterSelectableValues();
    FilterSelectableValues(Aws::Utils::Json::JsonView jsonValue);
    FilterSelectableValues& operator=(Aws::Utils::Json::JsonView jsonValue);
