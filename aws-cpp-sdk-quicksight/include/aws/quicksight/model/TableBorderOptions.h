...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API TableBorderOptions
  {
  public:
    TableBorderOptions();
    TableBorderOptions(Aws::Utils::Json::JsonView jsonValue);
    TableBorderOptions& operator=(Aws::Utils::Json::JsonView jsonValue);
