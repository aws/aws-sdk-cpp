...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API NumericEqualityFilter
  {
  public:
    NumericEqualityFilter();
    NumericEqualityFilter(Aws::Utils::Json::JsonView jsonValue);
    NumericEqualityFilter& operator=(Aws::Utils::Json::JsonView jsonValue);
