...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API GridLayoutConfiguration
  {
  public:
    GridLayoutConfiguration();
    GridLayoutConfiguration(Aws::Utils::Json::JsonView jsonValue);
    GridLayoutConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
