...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeAccountSubscriptionRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeAccountSubscriptionRequest>(GetServiceRequestName(), *this);
    }
