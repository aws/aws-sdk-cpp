...
namespace Model
{
  ...
  /**
   */
  class AWS_QUICKSIGHT_API DescribeAnalysisPermissionsRequest : public QuickSightRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeAnalysisPermissionsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeAnalysisPermissionsRequest>(GetServiceRequestName(), *this);
    }
