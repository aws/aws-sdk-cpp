...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API AnchorDateConfiguration
  {
  public:
    AnchorDateConfiguration();
    AnchorDateConfiguration(Aws::Utils::Json::JsonView jsonValue);
    AnchorDateConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
