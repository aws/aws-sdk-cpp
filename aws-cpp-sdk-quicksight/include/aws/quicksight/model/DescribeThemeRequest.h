...
namespace Model
{
  ...
  /**
   */
  class AWS_QUICKSIGHT_API DescribeThemeRequest : public QuickSightRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeThemeRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeThemeRequest>(GetServiceRequestName(), *this);
    }
