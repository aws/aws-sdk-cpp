...
namespace Model
{
  ...
  /**
   */
  class AWS_QUICKSIGHT_API UpdateAnalysisRequest : public QuickSightRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateAnalysisRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateAnalysisRequest>(GetServiceRequestName(), *this);
    }
