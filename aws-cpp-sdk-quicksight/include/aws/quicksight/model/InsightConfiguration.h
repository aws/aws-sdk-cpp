...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API InsightConfiguration
  {
  public:
    InsightConfiguration();
    InsightConfiguration(Aws::Utils::Json::JsonView jsonValue);
    InsightConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
