...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API DateTimeHierarchy
  {
  public:
    DateTimeHierarchy();
    DateTimeHierarchy(Aws::Utils::Json::JsonView jsonValue);
    DateTimeHierarchy& operator=(Aws::Utils::Json::JsonView jsonValue);
