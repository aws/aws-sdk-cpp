...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API GeospatialMapFieldWells
  {
  public:
    GeospatialMapFieldWells();
    GeospatialMapFieldWells(Aws::Utils::Json::JsonView jsonValue);
    GeospatialMapFieldWells& operator=(Aws::Utils::Json::JsonView jsonValue);
