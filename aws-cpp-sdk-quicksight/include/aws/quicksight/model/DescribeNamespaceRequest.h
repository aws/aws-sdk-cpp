...
namespace Model
{
  ...
  /**
   */
  class AWS_QUICKSIGHT_API DescribeNamespaceRequest : public QuickSightRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeNamespaceRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeNamespaceRequest>(GetServiceRequestName(), *this);
    }
