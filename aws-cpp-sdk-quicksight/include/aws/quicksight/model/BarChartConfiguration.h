...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API BarChartConfiguration
  {
  public:
    BarChartConfiguration();
    BarChartConfiguration(Aws::Utils::Json::JsonView jsonValue);
    BarChartConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
