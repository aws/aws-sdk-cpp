...
namespace Model
{
  ...
  /**
   */
  class AWS_QUICKSIGHT_API UpdateDashboardPublishedVersionRequest : public QuickSightRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateDashboardPublishedVersionRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateDashboardPublishedVersionRequest>(GetServiceRequestName(), *this);
    }
