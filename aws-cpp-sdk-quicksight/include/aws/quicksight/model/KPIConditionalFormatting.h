...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API KPIConditionalFormatting
  {
  public:
    KPIConditionalFormatting();
    KPIConditionalFormatting(Aws::Utils::Json::JsonView jsonValue);
    KPIConditionalFormatting& operator=(Aws::Utils::Json::JsonView jsonValue);
