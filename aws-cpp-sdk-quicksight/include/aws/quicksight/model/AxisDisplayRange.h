...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API AxisDisplayRange
  {
  public:
    AxisDisplayRange();
    AxisDisplayRange(Aws::Utils::Json::JsonView jsonValue);
    AxisDisplayRange& operator=(Aws::Utils::Json::JsonView jsonValue);
