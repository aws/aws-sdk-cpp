...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API PieChartFieldWells
  {
  public:
    PieChartFieldWells();
    PieChartFieldWells(Aws::Utils::Json::JsonView jsonValue);
    PieChartFieldWells& operator=(Aws::Utils::Json::JsonView jsonValue);
