...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API FilterScopeConfiguration
  {
  public:
    FilterScopeConfiguration();
    FilterScopeConfiguration(Aws::Utils::Json::JsonView jsonValue);
    FilterScopeConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
