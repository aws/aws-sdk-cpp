...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API ScrollBarOptions
  {
  public:
    ScrollBarOptions();
    ScrollBarOptions(Aws::Utils::Json::JsonView jsonValue);
    ScrollBarOptions& operator=(Aws::Utils::Json::JsonView jsonValue);
