...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API FilledMapShapeConditionalFormatting
  {
  public:
    FilledMapShapeConditionalFormatting();
    FilledMapShapeConditionalFormatting(Aws::Utils::Json::JsonView jsonValue);
    FilledMapShapeConditionalFormatting& operator=(Aws::Utils::Json::JsonView jsonValue);
