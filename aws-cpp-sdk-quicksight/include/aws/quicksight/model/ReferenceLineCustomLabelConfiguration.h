...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API ReferenceLineCustomLabelConfiguration
  {
  public:
    ReferenceLineCustomLabelConfiguration();
    ReferenceLineCustomLabelConfiguration(Aws::Utils::Json::JsonView jsonValue);
    ReferenceLineCustomLabelConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
