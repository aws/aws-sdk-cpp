...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API PivotTotalOptions
  {
  public:
    PivotTotalOptions();
    PivotTotalOptions(Aws::Utils::Json::JsonView jsonValue);
    PivotTotalOptions& operator=(Aws::Utils::Json::JsonView jsonValue);
