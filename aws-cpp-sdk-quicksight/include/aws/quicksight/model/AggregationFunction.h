...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API AggregationFunction
  {
  public:
    AggregationFunction();
    AggregationFunction(Aws::Utils::Json::JsonView jsonValue);
    AggregationFunction& operator=(Aws::Utils::Json::JsonView jsonValue);
