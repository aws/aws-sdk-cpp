...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API GeospatialMapStyleOptions
  {
  public:
    GeospatialMapStyleOptions();
    GeospatialMapStyleOptions(Aws::Utils::Json::JsonView jsonValue);
    GeospatialMapStyleOptions& operator=(Aws::Utils::Json::JsonView jsonValue);
