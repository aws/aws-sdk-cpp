...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API ForecastComputation
  {
  public:
    ForecastComputation();
    ForecastComputation(Aws::Utils::Json::JsonView jsonValue);
    ForecastComputation& operator=(Aws::Utils::Json::JsonView jsonValue);
