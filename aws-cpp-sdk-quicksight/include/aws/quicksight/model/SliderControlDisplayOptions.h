...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API SliderControlDisplayOptions
  {
  public:
    SliderControlDisplayOptions();
    SliderControlDisplayOptions(Aws::Utils::Json::JsonView jsonValue);
    SliderControlDisplayOptions& operator=(Aws::Utils::Json::JsonView jsonValue);
