...
namespace Model
{
  ...
  /**
   */
  class AWS_QUICKSIGHT_API DescribeUserRequest : public QuickSightRequest
  {
  public:
    DescribeUserRequest();
    ...
    */
    virtual Aws::UniquePtr<DescribeUserRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeUserRequest>(GetServiceRequestName(), *this);
    }
