...
namespace Model
{
  ...
  /**
   */
  class AWS_QUICKSIGHT_API DeleteFolderMembershipRequest : public QuickSightRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteFolderMembershipRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteFolderMembershipRequest>(GetServiceRequestName(), *this);
    }
