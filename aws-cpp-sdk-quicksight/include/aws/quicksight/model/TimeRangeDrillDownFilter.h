...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API TimeRangeDrillDownFilter
  {
  public:
    TimeRangeDrillDownFilter();
    TimeRangeDrillDownFilter(Aws::Utils::Json::JsonView jsonValue);
    TimeRangeDrillDownFilter& operator=(Aws::Utils::Json::JsonView jsonValue);
