...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API LineChartSortConfiguration
  {
  public:
    LineChartSortConfiguration();
    LineChartSortConfiguration(Aws::Utils::Json::JsonView jsonValue);
    LineChartSortConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
