...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API DataPathLabelType
  {
  public:
    DataPathLabelType();
    DataPathLabelType(Aws::Utils::Json::JsonView jsonValue);
    DataPathLabelType& operator=(Aws::Utils::Json::JsonView jsonValue);
