...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API FreeFormLayoutElementBackgroundStyle
  {
  public:
    FreeFormLayoutElementBackgroundStyle();
    FreeFormLayoutElementBackgroundStyle(Aws::Utils::Json::JsonView jsonValue);
    FreeFormLayoutElementBackgroundStyle& operator=(Aws::Utils::Json::JsonView jsonValue);
