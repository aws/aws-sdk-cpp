...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API FilterListControl
  {
  public:
    FilterListControl();
    FilterListControl(Aws::Utils::Json::JsonView jsonValue);
    FilterListControl& operator=(Aws::Utils::Json::JsonView jsonValue);
