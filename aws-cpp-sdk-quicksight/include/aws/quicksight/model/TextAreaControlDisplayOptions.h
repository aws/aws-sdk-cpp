...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API TextAreaControlDisplayOptions
  {
  public:
    TextAreaControlDisplayOptions();
    TextAreaControlDisplayOptions(Aws::Utils::Json::JsonView jsonValue);
    TextAreaControlDisplayOptions& operator=(Aws::Utils::Json::JsonView jsonValue);
