...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API PivotTableConditionalFormattingScope
  {
  public:
    PivotTableConditionalFormattingScope();
    PivotTableConditionalFormattingScope(Aws::Utils::Json::JsonView jsonValue);
    PivotTableConditionalFormattingScope& operator=(Aws::Utils::Json::JsonView jsonValue);
