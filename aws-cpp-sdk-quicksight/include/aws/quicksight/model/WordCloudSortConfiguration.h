...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API WordCloudSortConfiguration
  {
  public:
    WordCloudSortConfiguration();
    WordCloudSortConfiguration(Aws::Utils::Json::JsonView jsonValue);
    WordCloudSortConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
