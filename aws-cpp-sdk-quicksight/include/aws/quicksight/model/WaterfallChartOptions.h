...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API WaterfallChartOptions
  {
  public:
    WaterfallChartOptions();
    WaterfallChartOptions(Aws::Utils::Json::JsonView jsonValue);
    WaterfallChartOptions& operator=(Aws::Utils::Json::JsonView jsonValue);
