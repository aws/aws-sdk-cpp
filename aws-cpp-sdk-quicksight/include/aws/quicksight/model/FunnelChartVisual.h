...
namespace Model
{
   ...
   * funnel charts</a> in the <i>Amazon QuickSight User Guide</i>.</p><p><h3>See
   * Also:</h3>   <a
  ...
  public:
     ...
     * templates can have visuals with the same identifiers..</p>
     */
    inline FunnelChartVisual& WithVisualId(const Aws::String& value) { SetVisualId(value); return *this;}
     ...
     * templates can have visuals with the same identifiers..</p>
     */
    inline FunnelChartVisual& WithVisualId(Aws::String&& value) { SetVisualId(std::move(value)); return *this;}
     ...
     * templates can have visuals with the same identifiers..</p>
     */
    inline FunnelChartVisual& WithVisualId(const char* value) { SetVisualId(value); return *this;}
     ...
     * <p>The title that is displayed on the visual.</p>
     */
    inline FunnelChartVisual& WithTitle(const VisualTitleLabelOptions& value) { SetTitle(value); return *this;}

    /**
     * <p>The title that is displayed on the visual.</p>
     */
    inline FunnelChartVisual& WithTitle(VisualTitleLabelOptions&& value) { SetTitle(std::move(value)); return *this;}
     ...
     * <p>The subtitle that is displayed on the visual.</p>
     */
    inline FunnelChartVisual& WithSubtitle(const VisualSubtitleLabelOptions& value) { SetSubtitle(value); return *this;}

    /**
     * <p>The subtitle that is displayed on the visual.</p>
     */
    inline FunnelChartVisual& WithSubtitle(VisualSubtitleLabelOptions&& value) { SetSubtitle(std::move(value)); return *this;}


    /**
     * <p>The configuration of a <code>FunnelChartVisual</code>.</p>
     */
    inline const FunnelChartConfiguration& GetChartConfiguration() const{ return m_chartConfiguration; }
     ...
     * <p>The configuration of a <code>FunnelChartVisual</code>.</p>
     */
    inline void SetChartConfiguration(const FunnelChartConfiguration& value) { m_chartConfigurationHasBeenSet = true; m_chartConfiguration = value; }

    /**
     * <p>The configuration of a <code>FunnelChartVisual</code>.</p>
     */
    inline void SetChartConfiguration(FunnelChartConfiguration&& value) { m_chartConfigurationHasBeenSet = true; m_chartConfiguration = std::move(value); }

    /**
     * <p>The configuration of a <code>FunnelChartVisual</code>.</p>
     */
    inline FunnelChartVisual& WithChartConfiguration(const FunnelChartConfiguration& value) { SetChartConfiguration(value); return *this;}

    /**
     * <p>The configuration of a <code>FunnelChartVisual</code>.</p>
     */
    inline FunnelChartVisual& WithChartConfiguration(FunnelChartConfiguration&& value) { SetChartConfiguration(std::move(value)); return *this;}
     ...
     * <p>The list of custom actions that are configured for a visual.</p>
     */
    inline FunnelChartVisual& WithActions(const Aws::Vector<VisualCustomAction>& value) { SetActions(value); return *this;}

    /**
     * <p>The list of custom actions that are configured for a visual.</p>
     */
    inline FunnelChartVisual& WithActions(Aws::Vector<VisualCustomAction>&& value) { SetActions(std::move(value)); return *this;}

    /**
     * <p>The list of custom actions that are configured for a visual.</p>
     */
    inline FunnelChartVisual& AddActions(const VisualCustomAction& value) { m_actionsHasBeenSet = true; m_actions.push_back(value); return *this; }

    /**
     * <p>The list of custom actions that are configured for a visual.</p>
     */
    inline FunnelChartVisual& AddActions(VisualCustomAction&& value) { m_actionsHasBeenSet = true; m_actions.push_back(std::move(value)); return *this; }
     ...
     * <p>The column hierarchy that is used during drill-downs and drill-ups.</p>
     */
    inline FunnelChartVisual& WithColumnHierarchies(const Aws::Vector<ColumnHierarchy>& value) { SetColumnHierarchies(value); return *this;}

    /**
     * <p>The column hierarchy that is used during drill-downs and drill-ups.</p>
     */
    inline FunnelChartVisual& WithColumnHierarchies(Aws::Vector<ColumnHierarchy>&& value) { SetColumnHierarchies(std::move(value)); return *this;}

    /**
     * <p>The column hierarchy that is used during drill-downs and drill-ups.</p>
     */
    inline FunnelChartVisual& AddColumnHierarchies(const ColumnHierarchy& value) { m_columnHierarchiesHasBeenSet = true; m_columnHierarchies.push_back(value); return *this; }

    /**
     * <p>The column hierarchy that is used during drill-downs and drill-ups.</p>
     */
    inline FunnelChartVisual& AddColumnHierarchies(ColumnHierarchy&& value) { m_columnHierarchiesHasBeenSet = true; m_columnHierarchies.push_back(std::move(value)); return *this; }
  ...
  private:
    ...
    FunnelChartConfiguration m_chartConfiguration;
