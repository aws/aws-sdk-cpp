...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GenerateEmbedUrlForRegisteredUserRequest> Clone() const
    {
      return Aws::MakeUnique<GenerateEmbedUrlForRegisteredUserRequest>(GetServiceRequestName(), *this);
    }
