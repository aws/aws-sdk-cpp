...
namespace Model
{
  ...
  public:
     ...
     * you could add a default theme by setting <code>AccountCustomization</code> to
     * the midnight theme: <code>"AccountCustomization": { "DefaultTheme":
     * "arn:aws:quicksight::aws:theme/MIDNIGHT" }. </code>. Or, you could add a custom
