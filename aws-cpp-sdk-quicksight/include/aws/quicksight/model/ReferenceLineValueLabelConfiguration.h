...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API ReferenceLineValueLabelConfiguration
  {
  public:
    ReferenceLineValueLabelConfiguration();
    ReferenceLineValueLabelConfiguration(Aws::Utils::Json::JsonView jsonValue);
    ReferenceLineValueLabelConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
