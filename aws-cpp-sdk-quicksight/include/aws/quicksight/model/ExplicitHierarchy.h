...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API ExplicitHierarchy
  {
  public:
    ExplicitHierarchy();
    ExplicitHierarchy(Aws::Utils::Json::JsonView jsonValue);
    ExplicitHierarchy& operator=(Aws::Utils::Json::JsonView jsonValue);
