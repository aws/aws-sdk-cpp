...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API FieldSortOptions
  {
  public:
    FieldSortOptions();
    FieldSortOptions(Aws::Utils::Json::JsonView jsonValue);
    FieldSortOptions& operator=(Aws::Utils::Json::JsonView jsonValue);
