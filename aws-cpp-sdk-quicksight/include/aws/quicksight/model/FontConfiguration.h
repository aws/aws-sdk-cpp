...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API FontConfiguration
  {
  public:
    FontConfiguration();
    FontConfiguration(Aws::Utils::Json::JsonView jsonValue);
    FontConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
