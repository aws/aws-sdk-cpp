...
namespace Model
{
  ...
  /**
   */
  class AWS_QUICKSIGHT_API UpdateFolderRequest : public QuickSightRequest
  {
  public:
    UpdateFolderRequest();
    ...
    */
    virtual Aws::UniquePtr<UpdateFolderRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateFolderRequest>(GetServiceRequestName(), *this);
    }
