...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API SheetElementRenderingRule
  {
  public:
    SheetElementRenderingRule();
    SheetElementRenderingRule(Aws::Utils::Json::JsonView jsonValue);
    SheetElementRenderingRule& operator=(Aws::Utils::Json::JsonView jsonValue);
