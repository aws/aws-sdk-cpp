...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API TableFieldOptions
  {
  public:
    TableFieldOptions();
    TableFieldOptions(Aws::Utils::Json::JsonView jsonValue);
    TableFieldOptions& operator=(Aws::Utils::Json::JsonView jsonValue);
