...
namespace Model
{
  ...
  /**
   */
  class AWS_QUICKSIGHT_API ListTemplateVersionsRequest : public QuickSightRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListTemplateVersionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListTemplateVersionsRequest>(GetServiceRequestName(), *this);
    }
