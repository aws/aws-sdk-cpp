...
namespace Model
{
  class AWS_QUICKSIGHT_API DescribeAnalysisPermissionsResult
  {
  public:
    ...
    DescribeAnalysisPermissionsResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
