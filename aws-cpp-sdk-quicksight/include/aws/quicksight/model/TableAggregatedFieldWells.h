...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API TableAggregatedFieldWells
  {
  public:
    TableAggregatedFieldWells();
    TableAggregatedFieldWells(Aws::Utils::Json::JsonView jsonValue);
    TableAggregatedFieldWells& operator=(Aws::Utils::Json::JsonView jsonValue);
