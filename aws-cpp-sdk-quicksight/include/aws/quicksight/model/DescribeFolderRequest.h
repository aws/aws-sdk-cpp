...
namespace Model
{
  ...
  /**
   */
  class AWS_QUICKSIGHT_API DescribeFolderRequest : public QuickSightRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeFolderRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeFolderRequest>(GetServiceRequestName(), *this);
    }
