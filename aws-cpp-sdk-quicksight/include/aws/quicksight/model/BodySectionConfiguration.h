...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API BodySectionConfiguration
  {
  public:
    BodySectionConfiguration();
    BodySectionConfiguration(Aws::Utils::Json::JsonView jsonValue);
    BodySectionConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
