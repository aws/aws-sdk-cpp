...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API TextConditionalFormat
  {
  public:
    TextConditionalFormat();
    TextConditionalFormat(Aws::Utils::Json::JsonView jsonValue);
    TextConditionalFormat& operator=(Aws::Utils::Json::JsonView jsonValue);
