...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API TableFieldCustomTextContent
  {
  public:
    TableFieldCustomTextContent();
    TableFieldCustomTextContent(Aws::Utils::Json::JsonView jsonValue);
    TableFieldCustomTextContent& operator=(Aws::Utils::Json::JsonView jsonValue);
