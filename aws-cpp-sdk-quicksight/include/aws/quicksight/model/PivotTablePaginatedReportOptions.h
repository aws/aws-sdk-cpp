...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API PivotTablePaginatedReportOptions
  {
  public:
    PivotTablePaginatedReportOptions();
    PivotTablePaginatedReportOptions(Aws::Utils::Json::JsonView jsonValue);
    PivotTablePaginatedReportOptions& operator=(Aws::Utils::Json::JsonView jsonValue);
