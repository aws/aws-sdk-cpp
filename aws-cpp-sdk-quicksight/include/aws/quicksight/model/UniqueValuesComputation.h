...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API UniqueValuesComputation
  {
  public:
    UniqueValuesComputation();
    UniqueValuesComputation(Aws::Utils::Json::JsonView jsonValue);
    UniqueValuesComputation& operator=(Aws::Utils::Json::JsonView jsonValue);
