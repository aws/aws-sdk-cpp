...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API NumericRangeFilterValue
  {
  public:
    NumericRangeFilterValue();
    NumericRangeFilterValue(Aws::Utils::Json::JsonView jsonValue);
    NumericRangeFilterValue& operator=(Aws::Utils::Json::JsonView jsonValue);
