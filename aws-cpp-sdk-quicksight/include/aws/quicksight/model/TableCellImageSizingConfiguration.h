...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API TableCellImageSizingConfiguration
  {
  public:
    TableCellImageSizingConfiguration();
    TableCellImageSizingConfiguration(Aws::Utils::Json::JsonView jsonValue);
    TableCellImageSizingConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
