...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API DonutCenterOptions
  {
  public:
    DonutCenterOptions();
    DonutCenterOptions(Aws::Utils::Json::JsonView jsonValue);
    DonutCenterOptions& operator=(Aws::Utils::Json::JsonView jsonValue);
