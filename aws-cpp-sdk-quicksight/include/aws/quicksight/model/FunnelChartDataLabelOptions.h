...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API FunnelChartDataLabelOptions
  {
  public:
    FunnelChartDataLabelOptions();
    FunnelChartDataLabelOptions(Aws::Utils::Json::JsonView jsonValue);
    FunnelChartDataLabelOptions& operator=(Aws::Utils::Json::JsonView jsonValue);
