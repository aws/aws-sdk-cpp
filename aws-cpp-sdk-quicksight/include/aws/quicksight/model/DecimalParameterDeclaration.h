...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API DecimalParameterDeclaration
  {
  public:
    DecimalParameterDeclaration();
    DecimalParameterDeclaration(Aws::Utils::Json::JsonView jsonValue);
    DecimalParameterDeclaration& operator=(Aws::Utils::Json::JsonView jsonValue);
