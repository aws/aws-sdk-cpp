...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API TableCellConditionalFormatting
  {
  public:
    TableCellConditionalFormatting();
    TableCellConditionalFormatting(Aws::Utils::Json::JsonView jsonValue);
    TableCellConditionalFormatting& operator=(Aws::Utils::Json::JsonView jsonValue);
