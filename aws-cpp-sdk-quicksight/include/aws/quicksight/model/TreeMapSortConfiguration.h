...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API TreeMapSortConfiguration
  {
  public:
    TreeMapSortConfiguration();
    TreeMapSortConfiguration(Aws::Utils::Json::JsonView jsonValue);
    TreeMapSortConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
