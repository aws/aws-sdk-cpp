...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API PivotTableFieldOption
  {
  public:
    PivotTableFieldOption();
    PivotTableFieldOption(Aws::Utils::Json::JsonView jsonValue);
    PivotTableFieldOption& operator=(Aws::Utils::Json::JsonView jsonValue);
