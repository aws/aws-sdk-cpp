...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API ParameterTextAreaControl
  {
  public:
    ParameterTextAreaControl();
    ParameterTextAreaControl(Aws::Utils::Json::JsonView jsonValue);
    ParameterTextAreaControl& operator=(Aws::Utils::Json::JsonView jsonValue);
