...
namespace Model
{
  ...
  /**
   */
  class AWS_QUICKSIGHT_API DeleteThemeRequest : public QuickSightRequest
  {
  public:
    DeleteThemeRequest();
    ...
    */
    virtual Aws::UniquePtr<DeleteThemeRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteThemeRequest>(GetServiceRequestName(), *this);
    }
