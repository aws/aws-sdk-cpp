...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API ComboChartSortConfiguration
  {
  public:
    ComboChartSortConfiguration();
    ComboChartSortConfiguration(Aws::Utils::Json::JsonView jsonValue);
    ComboChartSortConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
