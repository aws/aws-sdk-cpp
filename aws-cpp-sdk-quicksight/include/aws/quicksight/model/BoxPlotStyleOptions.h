...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API BoxPlotStyleOptions
  {
  public:
    BoxPlotStyleOptions();
    BoxPlotStyleOptions(Aws::Utils::Json::JsonView jsonValue);
    BoxPlotStyleOptions& operator=(Aws::Utils::Json::JsonView jsonValue);
