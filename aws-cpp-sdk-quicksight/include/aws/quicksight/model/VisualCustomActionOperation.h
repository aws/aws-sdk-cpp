...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API VisualCustomActionOperation
  {
  public:
    VisualCustomActionOperation();
    VisualCustomActionOperation(Aws::Utils::Json::JsonView jsonValue);
    VisualCustomActionOperation& operator=(Aws::Utils::Json::JsonView jsonValue);
