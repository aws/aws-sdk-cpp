...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API AxisDisplayMinMaxRange
  {
  public:
    AxisDisplayMinMaxRange();
    AxisDisplayMinMaxRange(Aws::Utils::Json::JsonView jsonValue);
    AxisDisplayMinMaxRange& operator=(Aws::Utils::Json::JsonView jsonValue);
