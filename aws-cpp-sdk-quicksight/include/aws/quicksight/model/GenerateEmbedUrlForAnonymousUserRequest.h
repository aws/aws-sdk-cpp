...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GenerateEmbedUrlForAnonymousUserRequest> Clone() const
    {
      return Aws::MakeUnique<GenerateEmbedUrlForAnonymousUserRequest>(GetServiceRequestName(), *this);
    }
