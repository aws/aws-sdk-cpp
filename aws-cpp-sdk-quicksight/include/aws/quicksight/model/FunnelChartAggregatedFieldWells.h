...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API FunnelChartAggregatedFieldWells
  {
  public:
    FunnelChartAggregatedFieldWells();
    FunnelChartAggregatedFieldWells(Aws::Utils::Json::JsonView jsonValue);
    FunnelChartAggregatedFieldWells& operator=(Aws::Utils::Json::JsonView jsonValue);
