...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API KPIConfiguration
  {
  public:
    KPIConfiguration();
    KPIConfiguration(Aws::Utils::Json::JsonView jsonValue);
    KPIConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
