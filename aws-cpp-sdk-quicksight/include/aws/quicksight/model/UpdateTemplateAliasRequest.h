...
namespace Model
{
  ...
  /**
   */
  class AWS_QUICKSIGHT_API UpdateTemplateAliasRequest : public QuickSightRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateTemplateAliasRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateTemplateAliasRequest>(GetServiceRequestName(), *this);
    }
