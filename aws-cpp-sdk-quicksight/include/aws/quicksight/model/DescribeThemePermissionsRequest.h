...
namespace Model
{
  ...
  /**
   */
  class AWS_QUICKSIGHT_API DescribeThemePermissionsRequest : public QuickSightRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeThemePermissionsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeThemePermissionsRequest>(GetServiceRequestName(), *this);
    }
