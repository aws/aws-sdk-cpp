...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API PivotTableConfiguration
  {
  public:
    PivotTableConfiguration();
    PivotTableConfiguration(Aws::Utils::Json::JsonView jsonValue);
    PivotTableConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
