...
namespace Model
{
  ...
  /**
   */
  class AWS_QUICKSIGHT_API UpdatePublicSharingSettingsRequest : public QuickSightRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdatePublicSharingSettingsRequest> Clone() const
    {
      return Aws::MakeUnique<UpdatePublicSharingSettingsRequest>(GetServiceRequestName(), *this);
    }
