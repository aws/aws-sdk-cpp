...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API AxisLabelOptions
  {
  public:
    AxisLabelOptions();
    AxisLabelOptions(Aws::Utils::Json::JsonView jsonValue);
    AxisLabelOptions& operator=(Aws::Utils::Json::JsonView jsonValue);
