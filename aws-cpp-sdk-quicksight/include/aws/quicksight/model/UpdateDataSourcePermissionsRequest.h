...
namespace Model
{
  ...
  /**
   */
  class AWS_QUICKSIGHT_API UpdateDataSourcePermissionsRequest : public QuickSightRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateDataSourcePermissionsRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateDataSourcePermissionsRequest>(GetServiceRequestName(), *this);
    }
