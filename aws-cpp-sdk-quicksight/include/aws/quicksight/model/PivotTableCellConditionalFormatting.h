...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API PivotTableCellConditionalFormatting
  {
  public:
    PivotTableCellConditionalFormatting();
    PivotTableCellConditionalFormatting(Aws::Utils::Json::JsonView jsonValue);
    PivotTableCellConditionalFormatting& operator=(Aws::Utils::Json::JsonView jsonValue);
