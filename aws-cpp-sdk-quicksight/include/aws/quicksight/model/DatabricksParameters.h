...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API DatabricksParameters
  {
  public:
    DatabricksParameters();
    DatabricksParameters(Aws::Utils::Json::JsonView jsonValue);
    DatabricksParameters& operator=(Aws::Utils::Json::JsonView jsonValue);
