...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API ConditionalFormattingIconSet
  {
  public:
    ConditionalFormattingIconSet();
    ConditionalFormattingIconSet(Aws::Utils::Json::JsonView jsonValue);
    ConditionalFormattingIconSet& operator=(Aws::Utils::Json::JsonView jsonValue);
