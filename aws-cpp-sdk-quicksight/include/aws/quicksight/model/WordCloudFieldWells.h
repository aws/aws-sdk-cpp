...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API WordCloudFieldWells
  {
  public:
    WordCloudFieldWells();
    WordCloudFieldWells(Aws::Utils::Json::JsonView jsonValue);
    WordCloudFieldWells& operator=(Aws::Utils::Json::JsonView jsonValue);
