...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API TableUnaggregatedFieldWells
  {
  public:
    TableUnaggregatedFieldWells();
    TableUnaggregatedFieldWells(Aws::Utils::Json::JsonView jsonValue);
    TableUnaggregatedFieldWells& operator=(Aws::Utils::Json::JsonView jsonValue);
