...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API DefaultSectionBasedLayoutConfiguration
  {
  public:
    DefaultSectionBasedLayoutConfiguration();
    DefaultSectionBasedLayoutConfiguration(Aws::Utils::Json::JsonView jsonValue);
    DefaultSectionBasedLayoutConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
