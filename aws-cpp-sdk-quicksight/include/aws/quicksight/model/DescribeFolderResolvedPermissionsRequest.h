...
namespace Model
{
  ...
  /**
   */
  class AWS_QUICKSIGHT_API DescribeFolderResolvedPermissionsRequest : public QuickSightRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeFolderResolvedPermissionsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeFolderResolvedPermissionsRequest>(GetServiceRequestName(), *this);
    }
