...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API FreeFormSectionLayoutConfiguration
  {
  public:
    FreeFormSectionLayoutConfiguration();
    FreeFormSectionLayoutConfiguration(Aws::Utils::Json::JsonView jsonValue);
    FreeFormSectionLayoutConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
