...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API LayoutConfiguration
  {
  public:
    LayoutConfiguration();
    LayoutConfiguration(Aws::Utils::Json::JsonView jsonValue);
    LayoutConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
