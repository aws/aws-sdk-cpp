...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API SheetVisualScopingConfiguration
  {
  public:
    SheetVisualScopingConfiguration();
    SheetVisualScopingConfiguration(Aws::Utils::Json::JsonView jsonValue);
    SheetVisualScopingConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
