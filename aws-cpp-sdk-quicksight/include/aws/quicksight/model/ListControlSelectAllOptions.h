...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API ListControlSelectAllOptions
  {
  public:
    ListControlSelectAllOptions();
    ListControlSelectAllOptions(Aws::Utils::Json::JsonView jsonValue);
    ListControlSelectAllOptions& operator=(Aws::Utils::Json::JsonView jsonValue);
