...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API RowAlternateColorOptions
  {
  public:
    RowAlternateColorOptions();
    RowAlternateColorOptions(Aws::Utils::Json::JsonView jsonValue);
    RowAlternateColorOptions& operator=(Aws::Utils::Json::JsonView jsonValue);
