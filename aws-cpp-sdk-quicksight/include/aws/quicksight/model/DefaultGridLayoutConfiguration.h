...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API DefaultGridLayoutConfiguration
  {
  public:
    DefaultGridLayoutConfiguration();
    DefaultGridLayoutConfiguration(Aws::Utils::Json::JsonView jsonValue);
    DefaultGridLayoutConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
