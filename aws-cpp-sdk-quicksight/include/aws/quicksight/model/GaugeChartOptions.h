...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API GaugeChartOptions
  {
  public:
    GaugeChartOptions();
    GaugeChartOptions(Aws::Utils::Json::JsonView jsonValue);
    GaugeChartOptions& operator=(Aws::Utils::Json::JsonView jsonValue);
