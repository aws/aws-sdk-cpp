...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API DefaultPaginatedLayoutConfiguration
  {
  public:
    DefaultPaginatedLayoutConfiguration();
    DefaultPaginatedLayoutConfiguration(Aws::Utils::Json::JsonView jsonValue);
    DefaultPaginatedLayoutConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
