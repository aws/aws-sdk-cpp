...
namespace Model
{
  ...
  /**
   */
  class AWS_QUICKSIGHT_API CreateDataSetRequest : public QuickSightRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateDataSetRequest> Clone() const
    {
      return Aws::MakeUnique<CreateDataSetRequest>(GetServiceRequestName(), *this);
    }
