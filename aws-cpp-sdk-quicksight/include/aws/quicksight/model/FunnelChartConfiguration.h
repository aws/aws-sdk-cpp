...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API FunnelChartConfiguration
  {
  public:
    FunnelChartConfiguration();
    FunnelChartConfiguration(Aws::Utils::Json::JsonView jsonValue);
    FunnelChartConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
