...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API AxisLogarithmicScale
  {
  public:
    AxisLogarithmicScale();
    AxisLogarithmicScale(Aws::Utils::Json::JsonView jsonValue);
    AxisLogarithmicScale& operator=(Aws::Utils::Json::JsonView jsonValue);
