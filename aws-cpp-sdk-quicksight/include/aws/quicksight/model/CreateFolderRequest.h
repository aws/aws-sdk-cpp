...
namespace Model
{
  ...
  /**
   */
  class AWS_QUICKSIGHT_API CreateFolderRequest : public QuickSightRequest
  {
  public:
    CreateFolderRequest();
    ...
    */
    virtual Aws::UniquePtr<CreateFolderRequest> Clone() const
    {
      return Aws::MakeUnique<CreateFolderRequest>(GetServiceRequestName(), *this);
    }
