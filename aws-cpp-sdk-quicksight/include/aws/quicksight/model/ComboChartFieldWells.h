...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API ComboChartFieldWells
  {
  public:
    ComboChartFieldWells();
    ComboChartFieldWells(Aws::Utils::Json::JsonView jsonValue);
    ComboChartFieldWells& operator=(Aws::Utils::Json::JsonView jsonValue);
