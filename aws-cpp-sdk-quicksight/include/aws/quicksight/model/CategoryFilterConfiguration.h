...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API CategoryFilterConfiguration
  {
  public:
    CategoryFilterConfiguration();
    CategoryFilterConfiguration(Aws::Utils::Json::JsonView jsonValue);
    CategoryFilterConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
