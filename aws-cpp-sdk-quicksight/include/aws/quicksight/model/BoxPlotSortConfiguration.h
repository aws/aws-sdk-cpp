...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API BoxPlotSortConfiguration
  {
  public:
    BoxPlotSortConfiguration();
    BoxPlotSortConfiguration(Aws::Utils::Json::JsonView jsonValue);
    BoxPlotSortConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
