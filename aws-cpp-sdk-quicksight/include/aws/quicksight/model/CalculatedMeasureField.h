...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API CalculatedMeasureField
  {
  public:
    CalculatedMeasureField();
    CalculatedMeasureField(Aws::Utils::Json::JsonView jsonValue);
    CalculatedMeasureField& operator=(Aws::Utils::Json::JsonView jsonValue);
