...
namespace Model
{
  ...
  /**
   */
  class AWS_QUICKSIGHT_API UpdateThemeAliasRequest : public QuickSightRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateThemeAliasRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateThemeAliasRequest>(GetServiceRequestName(), *this);
    }
