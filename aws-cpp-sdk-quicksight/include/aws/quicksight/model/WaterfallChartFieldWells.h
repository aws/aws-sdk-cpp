...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API WaterfallChartFieldWells
  {
  public:
    WaterfallChartFieldWells();
    WaterfallChartFieldWells(Aws::Utils::Json::JsonView jsonValue);
    WaterfallChartFieldWells& operator=(Aws::Utils::Json::JsonView jsonValue);
