...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API ColumnTooltipItem
  {
  public:
    ColumnTooltipItem();
    ColumnTooltipItem(Aws::Utils::Json::JsonView jsonValue);
    ColumnTooltipItem& operator=(Aws::Utils::Json::JsonView jsonValue);
