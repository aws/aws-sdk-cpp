...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API DashboardVisualId
  {
  public:
    DashboardVisualId();
    DashboardVisualId(Aws::Utils::Json::JsonView jsonValue);
    DashboardVisualId& operator=(Aws::Utils::Json::JsonView jsonValue);
