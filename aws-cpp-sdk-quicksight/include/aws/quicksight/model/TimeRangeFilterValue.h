...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API TimeRangeFilterValue
  {
  public:
    TimeRangeFilterValue();
    TimeRangeFilterValue(Aws::Utils::Json::JsonView jsonValue);
    TimeRangeFilterValue& operator=(Aws::Utils::Json::JsonView jsonValue);
