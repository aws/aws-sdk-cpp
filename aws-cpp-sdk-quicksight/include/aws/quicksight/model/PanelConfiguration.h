...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API PanelConfiguration
  {
  public:
    PanelConfiguration();
    PanelConfiguration(Aws::Utils::Json::JsonView jsonValue);
    PanelConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
