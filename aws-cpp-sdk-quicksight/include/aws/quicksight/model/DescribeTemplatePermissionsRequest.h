...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeTemplatePermissionsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeTemplatePermissionsRequest>(GetServiceRequestName(), *this);
    }
