...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API PivotTableConditionalFormattingOption
  {
  public:
    PivotTableConditionalFormattingOption();
    PivotTableConditionalFormattingOption(Aws::Utils::Json::JsonView jsonValue);
    PivotTableConditionalFormattingOption& operator=(Aws::Utils::Json::JsonView jsonValue);
