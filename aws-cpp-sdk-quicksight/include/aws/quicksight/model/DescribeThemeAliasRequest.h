...
namespace Model
{
  ...
  /**
   */
  class AWS_QUICKSIGHT_API DescribeThemeAliasRequest : public QuickSightRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeThemeAliasRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeThemeAliasRequest>(GetServiceRequestName(), *this);
    }
