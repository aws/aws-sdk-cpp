...
namespace Model
{
  ...
  /**
   */
  class AWS_QUICKSIGHT_API DescribeFolderPermissionsRequest : public QuickSightRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeFolderPermissionsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeFolderPermissionsRequest>(GetServiceRequestName(), *this);
    }
