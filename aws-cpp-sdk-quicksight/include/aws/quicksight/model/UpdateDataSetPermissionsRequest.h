...
namespace Model
{
  ...
  /**
   */
  class AWS_QUICKSIGHT_API UpdateDataSetPermissionsRequest : public QuickSightRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateDataSetPermissionsRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateDataSetPermissionsRequest>(GetServiceRequestName(), *this);
    }
