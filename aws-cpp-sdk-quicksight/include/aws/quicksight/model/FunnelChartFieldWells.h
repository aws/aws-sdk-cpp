...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API FunnelChartFieldWells
  {
  public:
    FunnelChartFieldWells();
    FunnelChartFieldWells(Aws::Utils::Json::JsonView jsonValue);
    FunnelChartFieldWells& operator=(Aws::Utils::Json::JsonView jsonValue);
