...
namespace Model
{
   ...
   * waterfall charts</a> in the <i>Amazon QuickSight User Guide</i>.</p><p><h3>See
   * Also:</h3>   <a
  ...
  public:
     ...
     * templates can have visuals with the same identifiers.</p>
     */
    inline WaterfallVisual& WithVisualId(const Aws::String& value) { SetVisualId(value); return *this;}
     ...
     * templates can have visuals with the same identifiers.</p>
     */
    inline WaterfallVisual& WithVisualId(Aws::String&& value) { SetVisualId(std::move(value)); return *this;}
     ...
     * templates can have visuals with the same identifiers.</p>
     */
    inline WaterfallVisual& WithVisualId(const char* value) { SetVisualId(value); return *this;}
     ...
     * <p>The title that is displayed on the visual.</p>
     */
    inline WaterfallVisual& WithTitle(const VisualTitleLabelOptions& value) { SetTitle(value); return *this;}

    /**
     * <p>The title that is displayed on the visual.</p>
     */
    inline WaterfallVisual& WithTitle(VisualTitleLabelOptions&& value) { SetTitle(std::move(value)); return *this;}
     ...
     * <p>The subtitle that is displayed on the visual.</p>
     */
    inline WaterfallVisual& WithSubtitle(const VisualSubtitleLabelOptions& value) { SetSubtitle(value); return *this;}

    /**
     * <p>The subtitle that is displayed on the visual.</p>
     */
    inline WaterfallVisual& WithSubtitle(VisualSubtitleLabelOptions&& value) { SetSubtitle(std::move(value)); return *this;}


    /**
     * <p>The configuration for a waterfall visual.</p>
     */
    inline const WaterfallChartConfiguration& GetChartConfiguration() const{ return m_chartConfiguration; }
     ...
     * <p>The configuration for a waterfall visual.</p>
     */
    inline void SetChartConfiguration(const WaterfallChartConfiguration& value) { m_chartConfigurationHasBeenSet = true; m_chartConfiguration = value; }

    /**
     * <p>The configuration for a waterfall visual.</p>
     */
    inline void SetChartConfiguration(WaterfallChartConfiguration&& value) { m_chartConfigurationHasBeenSet = true; m_chartConfiguration = std::move(value); }

    /**
     * <p>The configuration for a waterfall visual.</p>
     */
    inline WaterfallVisual& WithChartConfiguration(const WaterfallChartConfiguration& value) { SetChartConfiguration(value); return *this;}

    /**
     * <p>The configuration for a waterfall visual.</p>
     */
    inline WaterfallVisual& WithChartConfiguration(WaterfallChartConfiguration&& value) { SetChartConfiguration(std::move(value)); return *this;}
     ...
     * <p>The list of custom actions that are configured for a visual.</p>
     */
    inline WaterfallVisual& WithActions(const Aws::Vector<VisualCustomAction>& value) { SetActions(value); return *this;}

    /**
     * <p>The list of custom actions that are configured for a visual.</p>
     */
    inline WaterfallVisual& WithActions(Aws::Vector<VisualCustomAction>&& value) { SetActions(std::move(value)); return *this;}

    /**
     * <p>The list of custom actions that are configured for a visual.</p>
     */
    inline WaterfallVisual& AddActions(const VisualCustomAction& value) { m_actionsHasBeenSet = true; m_actions.push_back(value); return *this; }

    /**
     * <p>The list of custom actions that are configured for a visual.</p>
     */
    inline WaterfallVisual& AddActions(VisualCustomAction&& value) { m_actionsHasBeenSet = true; m_actions.push_back(std::move(value)); return *this; }
     ...
     * <p>The column hierarchy that is used during drill-downs and drill-ups.</p>
     */
    inline WaterfallVisual& WithColumnHierarchies(const Aws::Vector<ColumnHierarchy>& value) { SetColumnHierarchies(value); return *this;}

    /**
     * <p>The column hierarchy that is used during drill-downs and drill-ups.</p>
     */
    inline WaterfallVisual& WithColumnHierarchies(Aws::Vector<ColumnHierarchy>&& value) { SetColumnHierarchies(std::move(value)); return *this;}

    /**
     * <p>The column hierarchy that is used during drill-downs and drill-ups.</p>
     */
    inline WaterfallVisual& AddColumnHierarchies(const ColumnHierarchy& value) { m_columnHierarchiesHasBeenSet = true; m_columnHierarchies.push_back(value); return *this; }

    /**
     * <p>The column hierarchy that is used during drill-downs and drill-ups.</p>
     */
    inline WaterfallVisual& AddColumnHierarchies(ColumnHierarchy&& value) { m_columnHierarchiesHasBeenSet = true; m_columnHierarchies.push_back(std::move(value)); return *this; }
  ...
  private:
    ...
    WaterfallChartConfiguration m_chartConfiguration;
