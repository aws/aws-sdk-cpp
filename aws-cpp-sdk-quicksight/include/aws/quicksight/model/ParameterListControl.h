...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API ParameterListControl
  {
  public:
    ParameterListControl();
    ParameterListControl(Aws::Utils::Json::JsonView jsonValue);
    ParameterListControl& operator=(Aws::Utils::Json::JsonView jsonValue);
