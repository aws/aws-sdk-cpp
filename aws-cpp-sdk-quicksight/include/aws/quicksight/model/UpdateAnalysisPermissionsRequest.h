...
namespace Model
{
  ...
  /**
   */
  class AWS_QUICKSIGHT_API UpdateAnalysisPermissionsRequest : public QuickSightRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateAnalysisPermissionsRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateAnalysisPermissionsRequest>(GetServiceRequestName(), *this);
    }
