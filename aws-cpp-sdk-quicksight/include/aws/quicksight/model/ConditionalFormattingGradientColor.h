...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API ConditionalFormattingGradientColor
  {
  public:
    ConditionalFormattingGradientColor();
    ConditionalFormattingGradientColor(Aws::Utils::Json::JsonView jsonValue);
    ConditionalFormattingGradientColor& operator=(Aws::Utils::Json::JsonView jsonValue);
