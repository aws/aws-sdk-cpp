...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API SheetElementConfigurationOverrides
  {
  public:
    SheetElementConfigurationOverrides();
    SheetElementConfigurationOverrides(Aws::Utils::Json::JsonView jsonValue);
    SheetElementConfigurationOverrides& operator=(Aws::Utils::Json::JsonView jsonValue);
