...
namespace Model
{
  ...
  /**
   */
  class AWS_QUICKSIGHT_API CreateThemeAliasRequest : public QuickSightRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateThemeAliasRequest> Clone() const
    {
      return Aws::MakeUnique<CreateThemeAliasRequest>(GetServiceRequestName(), *this);
    }
