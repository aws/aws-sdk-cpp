...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API RelativeDatesFilter
  {
  public:
    RelativeDatesFilter();
    RelativeDatesFilter(Aws::Utils::Json::JsonView jsonValue);
    RelativeDatesFilter& operator=(Aws::Utils::Json::JsonView jsonValue);
