...
namespace Model
{
  ...
  /**
   */
  class AWS_QUICKSIGHT_API CreateDataSourceRequest : public QuickSightRequest
  {
  public:
    ...
    /**
     * <p>An ID for the data source. This is unique per AWS Region per AWS account.
     * </p>
     */
    ...
    /**
     * <p>The type of the data source. Currently the supported types for this operation
     * are: <code>ATHENA, AURORA, AURORA_POSTGRESQL, MARIADB, MYSQL, POSTGRESQL,
     * PRESTO, REDSHIFT, S3, SNOWFLAKE, SPARK, SQLSERVER, TERADATA</code>. Use
     * <code>ListDataSources</code> to return a list of all data sources.</p>
     */
