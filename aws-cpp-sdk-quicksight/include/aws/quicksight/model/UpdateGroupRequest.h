...
namespace Model
{
  ...
  /**
   */
  class AWS_QUICKSIGHT_API UpdateGroupRequest : public QuickSightRequest
  {
  public:
    UpdateGroupRequest();
    ...
    */
    virtual Aws::UniquePtr<UpdateGroupRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateGroupRequest>(GetServiceRequestName(), *this);
    }
