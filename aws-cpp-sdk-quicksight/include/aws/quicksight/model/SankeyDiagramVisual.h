...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API SankeyDiagramVisual
  {
  public:
    SankeyDiagramVisual();
    SankeyDiagramVisual(Aws::Utils::Json::JsonView jsonValue);
    SankeyDiagramVisual& operator=(Aws::Utils::Json::JsonView jsonValue);
