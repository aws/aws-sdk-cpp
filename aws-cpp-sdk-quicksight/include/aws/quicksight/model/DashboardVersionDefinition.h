...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API DashboardVersionDefinition
  {
  public:
    DashboardVersionDefinition();
    DashboardVersionDefinition(Aws::Utils::Json::JsonView jsonValue);
    DashboardVersionDefinition& operator=(Aws::Utils::Json::JsonView jsonValue);
