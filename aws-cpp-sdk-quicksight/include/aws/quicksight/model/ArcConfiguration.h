...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API ArcConfiguration
  {
  public:
    ArcConfiguration();
    ArcConfiguration(Aws::Utils::Json::JsonView jsonValue);
    ArcConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
