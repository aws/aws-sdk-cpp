...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API LineChartDefaultSeriesSettings
  {
  public:
    LineChartDefaultSeriesSettings();
    LineChartDefaultSeriesSettings(Aws::Utils::Json::JsonView jsonValue);
    LineChartDefaultSeriesSettings& operator=(Aws::Utils::Json::JsonView jsonValue);
