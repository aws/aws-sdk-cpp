...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API GridLayoutScreenCanvasSizeOptions
  {
  public:
    GridLayoutScreenCanvasSizeOptions();
    GridLayoutScreenCanvasSizeOptions(Aws::Utils::Json::JsonView jsonValue);
    GridLayoutScreenCanvasSizeOptions& operator=(Aws::Utils::Json::JsonView jsonValue);
