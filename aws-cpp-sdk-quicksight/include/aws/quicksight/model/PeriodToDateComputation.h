...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API PeriodToDateComputation
  {
  public:
    PeriodToDateComputation();
    PeriodToDateComputation(Aws::Utils::Json::JsonView jsonValue);
    PeriodToDateComputation& operator=(Aws::Utils::Json::JsonView jsonValue);
