...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API FreeFormLayoutElement
  {
  public:
    FreeFormLayoutElement();
    FreeFormLayoutElement(Aws::Utils::Json::JsonView jsonValue);
    FreeFormLayoutElement& operator=(Aws::Utils::Json::JsonView jsonValue);
