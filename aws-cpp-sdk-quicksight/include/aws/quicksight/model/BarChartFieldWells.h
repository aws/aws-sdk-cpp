...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API BarChartFieldWells
  {
  public:
    BarChartFieldWells();
    BarChartFieldWells(Aws::Utils::Json::JsonView jsonValue);
    BarChartFieldWells& operator=(Aws::Utils::Json::JsonView jsonValue);
