...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API FilterListConfiguration
  {
  public:
    FilterListConfiguration();
    FilterListConfiguration(Aws::Utils::Json::JsonView jsonValue);
    FilterListConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
