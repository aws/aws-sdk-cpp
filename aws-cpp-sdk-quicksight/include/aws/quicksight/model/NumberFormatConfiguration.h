...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API NumberFormatConfiguration
  {
  public:
    NumberFormatConfiguration();
    NumberFormatConfiguration(Aws::Utils::Json::JsonView jsonValue);
    NumberFormatConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
