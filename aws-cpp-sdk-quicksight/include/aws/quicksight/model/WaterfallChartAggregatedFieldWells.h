...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API WaterfallChartAggregatedFieldWells
  {
  public:
    WaterfallChartAggregatedFieldWells();
    WaterfallChartAggregatedFieldWells(Aws::Utils::Json::JsonView jsonValue);
    WaterfallChartAggregatedFieldWells& operator=(Aws::Utils::Json::JsonView jsonValue);
