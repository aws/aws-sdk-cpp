...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeAccountCustomizationRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeAccountCustomizationRequest>(GetServiceRequestName(), *this);
    }
