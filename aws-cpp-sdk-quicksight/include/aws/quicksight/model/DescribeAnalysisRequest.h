...
namespace Model
{
  ...
  /**
   */
  class AWS_QUICKSIGHT_API DescribeAnalysisRequest : public QuickSightRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeAnalysisRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeAnalysisRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "DescribeAnalysis"; }
     ...
     * the analysis.</p>
     */
    inline DescribeAnalysisRequest& WithAnalysisId(const char* value) { SetAnalysisId(value); return *this;}
