...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API DataFieldSeriesItem
  {
  public:
    DataFieldSeriesItem();
    DataFieldSeriesItem(Aws::Utils::Json::JsonView jsonValue);
    DataFieldSeriesItem& operator=(Aws::Utils::Json::JsonView jsonValue);
