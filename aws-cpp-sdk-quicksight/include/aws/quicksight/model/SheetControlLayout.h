...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API SheetControlLayout
  {
  public:
    SheetControlLayout();
    SheetControlLayout(Aws::Utils::Json::JsonView jsonValue);
    SheetControlLayout& operator=(Aws::Utils::Json::JsonView jsonValue);
