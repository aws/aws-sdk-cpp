...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API TreeMapConfiguration
  {
  public:
    TreeMapConfiguration();
    TreeMapConfiguration(Aws::Utils::Json::JsonView jsonValue);
    TreeMapConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
