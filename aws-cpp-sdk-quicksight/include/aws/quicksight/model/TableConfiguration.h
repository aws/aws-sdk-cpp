...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API TableConfiguration
  {
  public:
    TableConfiguration();
    TableConfiguration(Aws::Utils::Json::JsonView jsonValue);
    TableConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
