...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API ChartAxisLabelOptions
  {
  public:
    ChartAxisLabelOptions();
    ChartAxisLabelOptions(Aws::Utils::Json::JsonView jsonValue);
    ChartAxisLabelOptions& operator=(Aws::Utils::Json::JsonView jsonValue);
