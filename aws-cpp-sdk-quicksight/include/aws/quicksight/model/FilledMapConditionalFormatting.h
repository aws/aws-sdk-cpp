...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QUICKSIGHT_API FilledMapConditionalFormatting
  {
  public:
    FilledMapConditionalFormatting();
    FilledMapConditionalFormatting(Aws::Utils::Json::JsonView jsonValue);
    FilledMapConditionalFormatting& operator=(Aws::Utils::Json::JsonView jsonValue);
