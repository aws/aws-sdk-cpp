...
Aws::String ListIAMPolicyAssignmentsForUserRequest::SerializePayload() const
{
  return {};
}

void ListIAMPolicyAssignmentsForUserRequest::AddQueryStringParameters(URI& uri) const
{
    Aws::StringStream ss;
