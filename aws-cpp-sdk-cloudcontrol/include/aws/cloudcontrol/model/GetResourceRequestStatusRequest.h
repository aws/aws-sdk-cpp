...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDCONTROLAPI_API GetResourceRequestStatusRequest : public CloudControlApiRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetResourceRequestStatusRequest> Clone() const
    {
      return Aws::MakeUnique<GetResourceRequestStatusRequest>(GetServiceRequestName(), *this);
    }
