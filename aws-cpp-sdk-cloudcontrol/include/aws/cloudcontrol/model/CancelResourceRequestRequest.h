...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDCONTROLAPI_API CancelResourceRequestRequest : public CloudControlApiRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CancelResourceRequestRequest> Clone() const
    {
      return Aws::MakeUnique<CancelResourceRequestRequest>(GetServiceRequestName(), *this);
    }
