...
namespace CloudControlApi
{
  ...
  class AWS_CLOUDCONTROLAPI_API CloudControlApiClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        CloudControlApiClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                              std::shared_ptr<Endpoint::CloudControlApiEndpointProvider> endpointProvider = Aws::MakeShared<CloudControlApi::Endpoint::CloudControlApiEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::CloudControlApiEndpointProvider> m_endpointProvider;
  };
