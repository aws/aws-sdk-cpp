...
Aws::String CloudControlApiEndpointRules::GetRulesAsString()
{
    return Aws::String(CloudControlApiEndpointRules::Rules.begin(), CloudControlApiEndpointRules::Rules.end());
}

const Aws::Vector<char> CloudControlApiEndpointRules::Rules = {
...
'h','t','t','p','s',':','/','/','c','l','o','u','d','c','o','n','t','r','o','l','a','p','i','-','f',
...
'r','l','"',':','"','h','t','t','p','s',':','/','/','c','l','o','u','d','c','o','n','t','r','o','l',
'a','p','i','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R','e',
