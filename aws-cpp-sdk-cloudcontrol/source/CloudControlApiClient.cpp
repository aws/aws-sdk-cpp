...
using ResolveEndpointOutcome = Aws::CloudControlApi::Endpoint::CloudControlApiEndpointProvider::CloudControlApiResolveEndpointOutcome;
...
CloudControlApiClient::CloudControlApiClient(const Client::ClientConfiguration& clientConfiguration,
                                             std::shared_ptr<Endpoint::CloudControlApiEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<CloudControlApiErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<CloudControlApi::Endpoint::CloudControlApiEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
