...
using ECSResolveEndpointOutcome = Aws::ECS::Endpoint::ECSEndpointProvider::ECSResolveEndpointOutcome;
...
void ValidateOutcome(const ECSResolveEndpointOutcome& outcome, const ECSEndpointProviderEndpointTestCase::Expect& expect)
{
