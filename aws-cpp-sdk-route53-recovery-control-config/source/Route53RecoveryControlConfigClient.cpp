...
using ResolveEndpointOutcome = Aws::Route53RecoveryControlConfig::Endpoint::Route53RecoveryControlConfigEndpointProvider::Route53RecoveryControlConfigResolveEndpointOutcome;
...
Route53RecoveryControlConfigClient::Route53RecoveryControlConfigClient(const Client::ClientConfiguration& clientConfiguration,
                                                                       std::shared_ptr<Endpoint::Route53RecoveryControlConfigEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<Route53RecoveryControlConfigErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<Route53RecoveryControlConfig::Endpoint::Route53RecoveryControlConfigEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
