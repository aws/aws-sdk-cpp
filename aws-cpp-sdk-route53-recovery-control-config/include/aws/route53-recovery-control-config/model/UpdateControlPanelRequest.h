...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_ROUTE53RECOVERYCONTROLCONFIG_API UpdateControlPanelRequest : public Route53RecoveryControlConfigRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateControlPanelRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateControlPanelRequest>(GetServiceRequestName(), *this);
    }
