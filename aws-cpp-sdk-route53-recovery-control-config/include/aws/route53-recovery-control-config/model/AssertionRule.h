...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_ROUTE53RECOVERYCONTROLCONFIG_API AssertionRule
  {
  public:
    AssertionRule();
    AssertionRule(Aws::Utils::Json::JsonView jsonValue);
    AssertionRule& operator=(Aws::Utils::Json::JsonView jsonValue);
