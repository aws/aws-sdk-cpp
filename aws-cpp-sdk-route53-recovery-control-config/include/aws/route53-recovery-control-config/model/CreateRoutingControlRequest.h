...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_ROUTE53RECOVERYCONTROLCONFIG_API CreateRoutingControlRequest : public Route53RecoveryControlConfigRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateRoutingControlRequest> Clone() const
    {
      return Aws::MakeUnique<CreateRoutingControlRequest>(GetServiceRequestName(), *this);
    }
