...
namespace Model
{
  ...
  /**
   */
  class AWS_ROUTE53RECOVERYCONTROLCONFIG_API DeleteRoutingControlRequest : public Route53RecoveryControlConfigRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteRoutingControlRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteRoutingControlRequest>(GetServiceRequestName(), *this);
    }
