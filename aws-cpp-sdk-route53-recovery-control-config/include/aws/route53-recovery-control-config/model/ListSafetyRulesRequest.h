...
namespace Model
{
  ...
  /**
   */
  class AWS_ROUTE53RECOVERYCONTROLCONFIG_API ListSafetyRulesRequest : public Route53RecoveryControlConfigRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListSafetyRulesRequest> Clone() const
    {
      return Aws::MakeUnique<ListSafetyRulesRequest>(GetServiceRequestName(), *this);
    }
