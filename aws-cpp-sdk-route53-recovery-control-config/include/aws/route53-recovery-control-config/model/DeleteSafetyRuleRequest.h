...
namespace Model
{
  ...
  /**
   */
  class AWS_ROUTE53RECOVERYCONTROLCONFIG_API DeleteSafetyRuleRequest : public Route53RecoveryControlConfigRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteSafetyRuleRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteSafetyRuleRequest>(GetServiceRequestName(), *this);
    }
