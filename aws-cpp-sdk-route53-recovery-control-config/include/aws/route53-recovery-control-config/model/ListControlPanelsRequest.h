...
namespace Model
{
  ...
  /**
   */
  class AWS_ROUTE53RECOVERYCONTROLCONFIG_API ListControlPanelsRequest : public Route53RecoveryControlConfigRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListControlPanelsRequest> Clone() const
    {
      return Aws::MakeUnique<ListControlPanelsRequest>(GetServiceRequestName(), *this);
    }
