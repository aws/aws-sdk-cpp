...
namespace Model
{
  ...
  /**
   */
  class AWS_ROUTE53RECOVERYCONTROLCONFIG_API DescribeRoutingControlRequest : public Route53RecoveryControlConfigRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeRoutingControlRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeRoutingControlRequest>(GetServiceRequestName(), *this);
    }
