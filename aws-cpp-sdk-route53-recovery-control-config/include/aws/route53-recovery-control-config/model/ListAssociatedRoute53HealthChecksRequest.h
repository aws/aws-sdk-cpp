...
namespace Model
{
  ...
  /**
   */
  class AWS_ROUTE53RECOVERYCONTROLCONFIG_API ListAssociatedRoute53HealthChecksRequest : public Route53RecoveryControlConfigRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListAssociatedRoute53HealthChecksRequest> Clone() const
    {
      return Aws::MakeUnique<ListAssociatedRoute53HealthChecksRequest>(GetServiceRequestName(), *this);
    }
