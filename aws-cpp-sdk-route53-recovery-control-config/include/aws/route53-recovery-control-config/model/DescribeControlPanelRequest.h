...
namespace Model
{
  ...
  /**
   */
  class AWS_ROUTE53RECOVERYCONTROLCONFIG_API DescribeControlPanelRequest : public Route53RecoveryControlConfigRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeControlPanelRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeControlPanelRequest>(GetServiceRequestName(), *this);
    }
