...
namespace Route53RecoveryControlConfig
{
  ...
  class AWS_ROUTE53RECOVERYCONTROLCONFIG_API Route53RecoveryControlConfigClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        Route53RecoveryControlConfigClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                           std::shared_ptr<Endpoint::Route53RecoveryControlConfigEndpointProvider> endpointProvider = Aws::MakeShared<Route53RecoveryControlConfig::Endpoint::Route53RecoveryControlConfigEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::Route53RecoveryControlConfigEndpointProvider> m_endpointProvider;
  };
