...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeStateMachineForExecutionRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeStateMachineForExecutionRequest>(GetServiceRequestName(), *this);
    }
