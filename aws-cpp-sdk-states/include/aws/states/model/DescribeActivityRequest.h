...
namespace Model
{
  ...
  /**
   */
  class AWS_SFN_API DescribeActivityRequest : public SFNRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeActivityRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeActivityRequest>(GetServiceRequestName(), *this);
    }
