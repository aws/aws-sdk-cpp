...
namespace Model
{
  ...
  public:
     ...
     * when the tasks are assigned to a worker (see GetActivityTask::taskToken).</p>
     */
    inline SendTaskSuccessRequest& WithTaskToken(Aws::String&& value) { SetTaskToken(value); return *this;}
     ...
     * <p>The JSON output of the task.</p>
     */
    inline SendTaskSuccessRequest& WithOutput(Aws::String&& value) { SetOutput(value); return *this;}
