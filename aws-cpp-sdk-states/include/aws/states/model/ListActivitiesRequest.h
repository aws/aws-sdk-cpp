...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListActivitiesRequest> Clone() const
    {
      return Aws::MakeUnique<ListActivitiesRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "ListActivities"; }
