...
namespace Model
{
  ...
  public:
     ...
     * when the tasks are assigned to a worker (see GetActivityTask::taskToken).</p>
     */
    inline SendTaskFailureRequest& WithTaskToken(Aws::String&& value) { SetTaskToken(value); return *this;}
     ...
     * <p>An arbitrary error code that identifies the cause of the failure.</p>
     */
    inline SendTaskFailureRequest& WithError(Aws::String&& value) { SetError(value); return *this;}
     ...
     * <p>A more detailed explanation of the cause of the failure.</p>
     */
    inline SendTaskFailureRequest& WithCause(Aws::String&& value) { SetCause(value); return *this;}
