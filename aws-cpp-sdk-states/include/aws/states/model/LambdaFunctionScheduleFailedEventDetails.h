...
namespace Model
{
  ...
  public:
    ...
    LambdaFunctionScheduleFailedEventDetails(const Aws::Utils::Json::JsonValue& jsonValue);
    LambdaFunctionScheduleFailedEventDetails& operator=(const Aws::Utils::Json::JsonValue& jsonValue);
     ...
     * <p>The error code of the failure.</p>
     */
    inline LambdaFunctionScheduleFailedEventDetails& WithError(Aws::String&& value) { SetError(value); return *this;}
     ...
     * <p>A more detailed explanation of the cause of the failure.</p>
     */
    inline LambdaFunctionScheduleFailedEventDetails& WithCause(Aws::String&& value) { SetCause(value); return *this;}
