...
namespace Model
{
  ...
  /**
   */
  class AWS_SFN_API ListStateMachinesRequest : public SFNRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListStateMachinesRequest> Clone() const
    {
      return Aws::MakeUnique<ListStateMachinesRequest>(GetServiceRequestName(), *this);
    }
