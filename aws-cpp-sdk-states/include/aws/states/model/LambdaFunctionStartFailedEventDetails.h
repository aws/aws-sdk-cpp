...
namespace Model
{
  ...
  class AWS_SFN_API LambdaFunctionStartFailedEventDetails
  {
  public:
    LambdaFunctionStartFailedEventDetails();
    LambdaFunctionStartFailedEventDetails(const Aws::Utils::Json::JsonValue& jsonValue);
    LambdaFunctionStartFailedEventDetails& operator=(const Aws::Utils::Json::JsonValue& jsonValue);
     ...
     * <p>The error code of the failure.</p>
     */
    inline LambdaFunctionStartFailedEventDetails& WithError(Aws::String&& value) { SetError(value); return *this;}
     ...
     * <p>A more detailed explanation of the cause of the failure.</p>
     */
    inline LambdaFunctionStartFailedEventDetails& WithCause(Aws::String&& value) { SetCause(value); return *this;}
