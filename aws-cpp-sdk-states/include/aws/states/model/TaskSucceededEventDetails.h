...
namespace Model
{
  ...
  /**
   * <p>Contains details about the start of connected service by a task
  ...
  public:
    ...
    /**
     * <p>The full JSON response from a connected service when a task has succeeded.
     * This response becomes the output of the related task.</p>
     */
