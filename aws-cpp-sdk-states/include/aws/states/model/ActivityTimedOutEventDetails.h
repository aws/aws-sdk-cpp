...
namespace Model
{
  ...
  public:
     ...
     * <p>The error code of the failure.</p>
     */
    inline ActivityTimedOutEventDetails& WithError(Aws::String&& value) { SetError(value); return *this;}
     ...
     * <p>A more detailed explanation of the cause of the timeout.</p>
     */
    inline ActivityTimedOutEventDetails& WithCause(Aws::String&& value) { SetCause(value); return *this;}
