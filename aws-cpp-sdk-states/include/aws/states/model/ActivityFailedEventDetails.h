...
namespace Model
{
  ...
  public:
    ...
    ActivityFailedEventDetails(const Aws::Utils::Json::JsonValue& jsonValue);
    ActivityFailedEventDetails& operator=(const Aws::Utils::Json::JsonValue& jsonValue);
     ...
     * <p>The error code of the failure.</p>
     */
    inline ActivityFailedEventDetails& WithError(Aws::String&& value) { SetError(value); return *this;}
     ...
     * <p>A more detailed explanation of the cause of the failure.</p>
     */
    inline ActivityFailedEventDetails& WithCause(Aws::String&& value) { SetCause(value); return *this;}
