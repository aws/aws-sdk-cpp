...
namespace Model
{
  ...
  public:
     ...
     * <p>The error code of the failure.</p>
     */
    inline LambdaFunctionFailedEventDetails& WithError(Aws::String&& value) { SetError(std::move(value)); return *this;}
     ...
     * <p>A more detailed explanation of the cause of the failure.</p>
     */
    inline LambdaFunctionFailedEventDetails& WithCause(Aws::String&& value) { SetCause(std::move(value)); return *this;}
