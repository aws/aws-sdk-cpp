...
namespace Model
{
  ...
  public:
    ...
    LambdaFunctionTimedOutEventDetails(const Aws::Utils::Json::JsonValue& jsonValue);
    LambdaFunctionTimedOutEventDetails& operator=(const Aws::Utils::Json::JsonValue& jsonValue);
     ...
     * <p>The error code of the failure.</p>
     */
    inline LambdaFunctionTimedOutEventDetails& WithError(Aws::String&& value) { SetError(value); return *this;}
     ...
     * <p>A more detailed explanation of the cause of the timeout.</p>
     */
    inline LambdaFunctionTimedOutEventDetails& WithCause(Aws::String&& value) { SetCause(value); return *this;}
