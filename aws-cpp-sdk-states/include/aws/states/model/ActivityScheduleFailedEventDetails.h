...
namespace Model
{
  ...
  public:
    ...
    ActivityScheduleFailedEventDetails(const Aws::Utils::Json::JsonValue& jsonValue);
     ...
     * <p>The error code of the failure.</p>
     */
    inline ActivityScheduleFailedEventDetails& WithError(Aws::String&& value) { SetError(value); return *this;}
     ...
     * <p>A more detailed explanation of the cause of the failure.</p>
     */
    inline ActivityScheduleFailedEventDetails& WithCause(Aws::String&& value) { SetCause(value); return *this;}
