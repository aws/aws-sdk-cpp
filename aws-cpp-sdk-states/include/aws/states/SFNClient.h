...
namespace SFN
{
  ...
  class AWS_SFN_API SFNClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        SFNClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                  std::shared_ptr<Endpoint::SFNEndpointProvider> endpointProvider = Aws::MakeShared<SFN::Endpoint::SFNEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::SFNEndpointProvider> m_endpointProvider;
  };
