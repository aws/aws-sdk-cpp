...
Aws::String SFNEndpointRules::GetRulesAsString()
{
    return Aws::String(SFNEndpointRules::Rules.begin(), SFNEndpointRules::Rules.end());
}

const Aws::Vector<char> SFNEndpointRules::Rules = {
...
'r','l','"',':','"','h','t','t','p','s',':','/','/','s','t','a','t','e','s','.','u','s','-','g','o',
...
'r','l','"',':','"','h','t','t','p','s',':','/','/','s','t','a','t','e','s','.','{','R','e','g','i',
...
't','a','t','e','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n',
