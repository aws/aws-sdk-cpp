...
Aws::String KinesisVideoWebRTCStorageEndpointRules::GetRulesAsString()
{
    return Aws::String(KinesisVideoWebRTCStorageEndpointRules::Rules.begin(), KinesisVideoWebRTCStorageEndpointRules::Rules.end());
}

const Aws::Vector<char> KinesisVideoWebRTCStorageEndpointRules::Rules = {
...
's',':','/','/','k','i','n','e','s','i','s','v','i','d','e','o','-','f','i','p','s','.','{','R','e',
...
',','"','r','u','l','e','s','"',':','[','{','"','c','o','n','d','i','t','i','o','n','s','"',':','[',
']',',','"','e','n','d','p','o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p',
's',':','/','/','k','i','n','e','s','i','s','v','i','d','e','o','.','{','R','e','g','i','o','n','}',
