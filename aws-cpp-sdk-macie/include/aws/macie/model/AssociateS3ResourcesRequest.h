...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>The ID of the Amazon Macie Classic member account whose resources you want to
     * associate with Macie Classic. </p>
     */
    ...
    /**
     * <p>The S3 resources that you want to associate with Amazon Macie Classic for
     * monitoring and data classification. </p>
     */
