...
namespace Model
{
  ...
  /**
   */
  class AWS_MACIE_API AssociateMemberAccountRequest : public MacieRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateMemberAccountRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateMemberAccountRequest>(GetServiceRequestName(), *this);
    }
