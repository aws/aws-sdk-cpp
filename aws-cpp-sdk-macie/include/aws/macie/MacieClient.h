...
namespace Macie
{
  ...
  class AWS_MACIE_API MacieClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        MacieClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                    std::shared_ptr<Endpoint::MacieEndpointProvider> endpointProvider = Aws::MakeShared<Macie::Endpoint::MacieEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::MacieEndpointProvider> m_endpointProvider;
  };
