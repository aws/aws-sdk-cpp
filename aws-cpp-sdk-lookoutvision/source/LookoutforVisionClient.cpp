...
using ResolveEndpointOutcome = Aws::LookoutforVision::Endpoint::LookoutforVisionEndpointProvider::LookoutforVisionResolveEndpointOutcome;
...
LookoutforVisionClient::LookoutforVisionClient(const Client::ClientConfiguration& clientConfiguration,
                                               std::shared_ptr<Endpoint::LookoutforVisionEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<LookoutforVisionErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<LookoutforVision::Endpoint::LookoutforVisionEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
