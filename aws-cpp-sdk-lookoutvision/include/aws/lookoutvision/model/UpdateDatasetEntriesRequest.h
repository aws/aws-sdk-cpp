...
namespace Model
{
  ...
  public:
     ...
     * pass. For example, An issue, such as an network outage, might prevent you from
     * getting a response from <code>UpdateDatasetEntries</code>. In this case, safely
     * retry your call to <code>UpdateDatasetEntries</code> by using the same
     * <code>ClientToken</code> parameter value. An error occurs if the other input
     * parameters are not the same as in the first request. Using a different value for
     * <code>ClientToken</code> is considered a new call to
