...
namespace Model
{
  ...
  /**
   */
  class AWS_LOOKOUTFORVISION_API StartModelPackagingJobRequest : public LookoutforVisionRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StartModelPackagingJobRequest> Clone() const
    {
      return Aws::MakeUnique<StartModelPackagingJobRequest>(GetServiceRequestName(), *this);
    }
