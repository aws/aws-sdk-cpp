...
namespace Model
{
  ...
  /**
   */
  class AWS_LOOKOUTFORVISION_API DeleteProjectRequest : public LookoutforVisionRequest
  {
  public:
     ...
     * a response from <code>DeleteProject</code>. In this case, safely retry your call
     ...
     * considered a new call to <code>DeleteProject</code>. An idempotency token is
