...
namespace Model
{
  ...
  /**
   */
  class AWS_LOOKOUTFORVISION_API DescribeProjectRequest : public LookoutforVisionRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeProjectRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeProjectRequest>(GetServiceRequestName(), *this);
    }
