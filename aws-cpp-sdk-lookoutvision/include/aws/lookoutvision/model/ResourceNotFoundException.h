...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/lookoutvision-2020-11-20/ResourceNotFoundException">AWS
   * API Reference</a></p>
   */
  class AWS_LOOKOUTFORVISION_API ResourceNotFoundException
  {
  public:
