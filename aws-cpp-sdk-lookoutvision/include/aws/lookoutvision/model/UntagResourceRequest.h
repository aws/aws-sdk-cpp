...
namespace Model
{
  ...
  /**
   */
  class UntagResourceRequest : public LookoutforVisionRequest
  {
  public:
    AWS_LOOKOUTFORVISION_API UntagResourceRequest();
    ...
    /**
     * <p>The Amazon Resource Name (ARN) of the model from which you want to remove
     * tags. </p>
     */
