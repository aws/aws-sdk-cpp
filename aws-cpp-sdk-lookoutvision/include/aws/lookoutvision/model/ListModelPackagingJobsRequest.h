...
namespace Model
{
  ...
  /**
   */
  class AWS_LOOKOUTFORVISION_API ListModelPackagingJobsRequest : public LookoutforVisionRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListModelPackagingJobsRequest> Clone() const
    {
      return Aws::MakeUnique<ListModelPackagingJobsRequest>(GetServiceRequestName(), *this);
    }
