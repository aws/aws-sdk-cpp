...
namespace Model
{
  ...
  /**
   */
  class AWS_LOOKOUTFORVISION_API DeleteModelRequest : public LookoutforVisionRequest
  {
  public:
    DeleteModelRequest();
    ...
    */
    virtual Aws::UniquePtr<DeleteModelRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteModelRequest>(GetServiceRequestName(), *this);
    }
