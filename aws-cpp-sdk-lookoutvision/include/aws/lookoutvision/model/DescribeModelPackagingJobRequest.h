...
namespace Model
{
  ...
  /**
   */
  class AWS_LOOKOUTFORVISION_API DescribeModelPackagingJobRequest : public LookoutforVisionRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeModelPackagingJobRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeModelPackagingJobRequest>(GetServiceRequestName(), *this);
    }
