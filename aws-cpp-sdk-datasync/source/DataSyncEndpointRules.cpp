...
namespace DataSync
{
const size_t DataSyncEndpointRules::RulesBlobStrLen = 3400;
const size_t DataSyncEndpointRules::RulesBlobSize = 3401;
...
't','t','p','s',':','/','/','d','a','t','a','s','y','n','c','-','f','i','p','s','.','{','R','e','g',
...
'r','l','"',':','"','h','t','t','p','s',':','/','/','d','a','t','a','s','y','n','c','.','{','R','e',
