...
Aws::String DataSyncEndpointRules::GetRulesAsString()
{
    return Aws::String(DataSyncEndpointRules::Rules.begin(), DataSyncEndpointRules::Rules.end());
}

const Aws::Vector<char> DataSyncEndpointRules::Rules = {
