...
namespace DataSync
{
  ...
  class AWS_DATASYNC_API DataSyncClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        DataSyncClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                       std::shared_ptr<Endpoint::DataSyncEndpointProvider> endpointProvider = Aws::MakeShared<DataSync::Endpoint::DataSyncEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::DataSyncEndpointProvider> m_endpointProvider;
  };
