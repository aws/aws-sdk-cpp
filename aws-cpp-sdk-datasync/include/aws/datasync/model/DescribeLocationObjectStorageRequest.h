...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeLocationObjectStorageRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeLocationObjectStorageRequest>(GetServiceRequestName(), *this);
    }
