...
namespace Model
{
  ...
  /**
   */
  class AWS_DATASYNC_API DescribeLocationHdfsRequest : public DataSyncRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeLocationHdfsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeLocationHdfsRequest>(GetServiceRequestName(), *this);
    }
