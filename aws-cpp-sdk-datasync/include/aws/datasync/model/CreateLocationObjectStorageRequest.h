...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateLocationObjectStorageRequest> Clone() const
    {
      return Aws::MakeUnique<CreateLocationObjectStorageRequest>(GetServiceRequestName(), *this);
    }
