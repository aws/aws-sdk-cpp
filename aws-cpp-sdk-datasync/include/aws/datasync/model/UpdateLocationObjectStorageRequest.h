...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateLocationObjectStorageRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateLocationObjectStorageRequest>(GetServiceRequestName(), *this);
    }
