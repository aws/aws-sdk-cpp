...
namespace Model
{
  ...
  /**
   */
  class AWS_DATASYNC_API CreateLocationFsxOntapRequest : public DataSyncRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateLocationFsxOntapRequest> Clone() const
    {
      return Aws::MakeUnique<CreateLocationFsxOntapRequest>(GetServiceRequestName(), *this);
    }
