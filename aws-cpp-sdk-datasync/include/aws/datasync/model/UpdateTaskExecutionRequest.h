...
namespace Model
{
  ...
  /**
   */
  class AWS_DATASYNC_API UpdateTaskExecutionRequest : public DataSyncRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateTaskExecutionRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateTaskExecutionRequest>(GetServiceRequestName(), *this);
    }
