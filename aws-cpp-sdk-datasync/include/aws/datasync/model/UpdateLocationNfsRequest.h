...
namespace Model
{
  ...
  /**
   */
  class AWS_DATASYNC_API UpdateLocationNfsRequest : public DataSyncRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateLocationNfsRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateLocationNfsRequest>(GetServiceRequestName(), *this);
    }
