...
namespace Model
{
  ...
  /**
   */
  class AWS_DATASYNC_API CreateLocationHdfsRequest : public DataSyncRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateLocationHdfsRequest> Clone() const
    {
      return Aws::MakeUnique<CreateLocationHdfsRequest>(GetServiceRequestName(), *this);
    }
