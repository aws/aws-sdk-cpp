...
namespace Model
{
  ...
  /**
   */
  class AWS_DATASYNC_API DescribeLocationFsxOntapRequest : public DataSyncRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeLocationFsxOntapRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeLocationFsxOntapRequest>(GetServiceRequestName(), *this);
    }
