...
{
const size_t ApiGatewayManagementApiEndpointRules::RulesBlobStrLen = 3432;
const size_t ApiGatewayManagementApiEndpointRules::RulesBlobSize = 3433;

using RulesBlobT = Aws::Array<const char, ApiGatewayManagementApiEndpointRules::RulesBlobSize>;
...
'"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','e','x','e','c','u','t','e','-','a','p',
'i','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o',
...
'p','s',':','/','/','e','x','e','c','u','t','e','-','a','p','i','.','{','R','e','g','i','o','n','}',
...
const char* ApiGatewayManagementApiEndpointRules::GetRulesBlob()
{
