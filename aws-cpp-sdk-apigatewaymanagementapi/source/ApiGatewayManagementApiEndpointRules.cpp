...
Aws::String ApiGatewayManagementApiEndpointRules::GetRulesAsString()
{
    return Aws::String(ApiGatewayManagementApiEndpointRules::Rules.begin(), ApiGatewayManagementApiEndpointRules::Rules.end());
}

const Aws::Vector<char> ApiGatewayManagementApiEndpointRules::Rules = {
...
'"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','e','x','e','c','u','t','e',
'-','a','p','i','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i',
...
'u','r','l','"',':','"','h','t','t','p','s',':','/','/','e','x','e','c','u','t','e','-','a','p','i',
...
'r','l','"',':','"','h','t','t','p','s',':','/','/','e','x','e','c','u','t','e','-','a','p','i','.',
...
's',':','/','/','e','x','e','c','u','t','e','-','a','p','i','.','{','R','e','g','i','o','n','}','.',
