...
using ResolveEndpointOutcome = Aws::ApiGatewayManagementApi::Endpoint::ApiGatewayManagementApiEndpointProvider::ApiGatewayManagementApiResolveEndpointOutcome;
...
ApiGatewayManagementApiClient::ApiGatewayManagementApiClient(const Client::ClientConfiguration& clientConfiguration,
                                                             std::shared_ptr<Endpoint::ApiGatewayManagementApiEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<ApiGatewayManagementApiErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<ApiGatewayManagementApi::Endpoint::ApiGatewayManagementApiEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
