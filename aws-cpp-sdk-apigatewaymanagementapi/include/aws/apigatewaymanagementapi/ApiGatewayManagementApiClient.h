...
namespace ApiGatewayManagementApi
{
  ...
  class AWS_APIGATEWAYMANAGEMENTAPI_API ApiGatewayManagementApiClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        ApiGatewayManagementApiClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                      std::shared_ptr<Endpoint::ApiGatewayManagementApiEndpointProvider> endpointProvider = Aws::MakeShared<ApiGatewayManagementApi::Endpoint::ApiGatewayManagementApiEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::ApiGatewayManagementApiEndpointProvider> m_endpointProvider;
  };
