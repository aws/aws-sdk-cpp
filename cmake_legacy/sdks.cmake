...
if(REGENERATE_CLIENTS OR REGENERATE_DEFAULTS)
    ...
    execute_process(
        COMMAND ${PYTHON3_CMD} scripts/run_code_generation.py ${REGENERATE_CLIENTS_ARG} ${MERGED_BUILD_LIST_STR} ${REGENERATE_DEFAULTS_ARG} ${ENABLE_VIRTUAL_OPERATIONS_ARG} --output_location ./generated/
...
foreach(custom_client ${ADD_CUSTOM_CLIENTS})
    ...
    if(CMAKE_MATCH_COUNT GREATER 0)
        ...
        execute_process(
            COMMAND ${PYTHON3_CMD} scripts/legacy/generate_sdks.py --serviceName ${C_SERVICE_NAME} --apiVersion ${C_VERSION} ${ENABLE_VIRTUAL_OPERATIONS_ARG} --outputLocation ./generated/
            WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}
        )
...
function(add_sdks)
    ...
    foreach(SDK IN LISTS SDK_BUILD_LIST)
        ...
        if(SDK STREQUAL "core")
            ...
            set(SDK_DIR "generated/${SDK_TARGET}")
        endif()
    ...
    if(ENABLE_TESTING)
        ...
        if(ENABLE_FUNCTIONAL_TESTING)
            ...
            execute_process(
                COMMAND ${PYTHON3_CMD} scripts/legacy/generate_sdks.py --pathToApiDefinitions aws-cpp-sdk-core-tests/resources/api-descriptions --serviceName document-test --apiVersion 2021-06-28 --outputLocation ./generated/ --prepareTool
                WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}
            )
