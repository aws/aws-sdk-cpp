...
Aws::String EBSEndpointRules::GetRulesAsString()
{
    return Aws::String(EBSEndpointRules::Rules.begin(), EBSEndpointRules::Rules.end());
}

const Aws::Vector<char> EBSEndpointRules::Rules = {
...
'u','r','l','"',':','"','h','t','t','p','s',':','/','/','e','b','s','.','{','R','e','g','i','o','n',
