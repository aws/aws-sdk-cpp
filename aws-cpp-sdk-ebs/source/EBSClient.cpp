...
using ResolveEndpointOutcome = Aws::EBS::Endpoint::EBSEndpointProvider::EBSResolveEndpointOutcome;
...
EBSClient::EBSClient(const Client::ClientConfiguration& clientConfiguration,
                     std::shared_ptr<Endpoint::EBSEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<EBSErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<EBS::Endpoint::EBSEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
