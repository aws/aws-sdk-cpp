...
namespace EBS
{
  ...
  class AWS_EBS_API EBSClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        EBSClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                  std::shared_ptr<Endpoint::EBSEndpointProvider> endpointProvider = Aws::MakeShared<EBS::Endpoint::EBSEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::EBSEndpointProvider> m_endpointProvider;
  };
