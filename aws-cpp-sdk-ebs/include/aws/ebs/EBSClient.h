...
namespace Model
{
   ...
   * services for EBS, the EBS direct APIs makes it easier and more cost-effective to
   * track incremental changes on your EBS volumes via EBS snapshots. This can be
   * done without having to create new volumes from EBS snapshots, and then use EC2
   * instances to compare the differences.</p> <p>This API reference provides
   ...
   * EBS direct APIs, and examples of how to use them effectively, see <a
   * href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ebs-accessing-snapshot.html">Accessing
   * the Contents of an EBS Snapshot</a>. For more information about how to use the
   * EBS direct APIs, see the <a
   * href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ebs-accessing-snapshots.html">EBS
   * direct APIs User Guide</a>. To view the currently supported AWS Regions and
   * endpoints for the EBS direct APIs, see <a
   * href="https://docs.aws.amazon.com/general/latest/gr/rande.html#ebs_region">AWS
   * Service Endpoints</a> in the <i>AWS General Reference</i>.</p>
   */
