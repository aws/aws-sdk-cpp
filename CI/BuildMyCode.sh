...
echo "Remember that the code that is going to be build and tested is the one in the remote branch. If you didn't push your changes, you are building an old version."
