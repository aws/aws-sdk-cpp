...
Aws::String BackupGatewayEndpointRules::GetRulesAsString()
{
    return Aws::String(BackupGatewayEndpointRules::Rules.begin(), BackupGatewayEndpointRules::Rules.end());
}

const Aws::Vector<char> BackupGatewayEndpointRules::Rules = {
