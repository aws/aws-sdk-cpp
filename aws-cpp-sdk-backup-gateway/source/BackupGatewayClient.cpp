...
using ResolveEndpointOutcome = Aws::BackupGateway::Endpoint::BackupGatewayEndpointProvider::BackupGatewayResolveEndpointOutcome;
...
BackupGatewayClient::BackupGatewayClient(const Client::ClientConfiguration& clientConfiguration,
                                         std::shared_ptr<Endpoint::BackupGatewayEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<BackupGatewayErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<BackupGateway::Endpoint::BackupGatewayEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
