...
namespace BackupGateway
{
  ...
  class AWS_BACKUPGATEWAY_API BackupGatewayClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        BackupGatewayClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                            std::shared_ptr<Endpoint::BackupGatewayEndpointProvider> endpointProvider = Aws::MakeShared<BackupGateway::Endpoint::BackupGatewayEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::BackupGatewayEndpointProvider> m_endpointProvider;
  };
