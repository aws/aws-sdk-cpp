...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<TestHypervisorConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<TestHypervisorConfigurationRequest>(GetServiceRequestName(), *this);
    }
