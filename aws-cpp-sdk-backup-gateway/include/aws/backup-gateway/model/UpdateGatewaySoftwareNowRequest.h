...
namespace Model
{
  ...
  /**
   */
  class AWS_BACKUPGATEWAY_API UpdateGatewaySoftwareNowRequest : public BackupGatewayRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateGatewaySoftwareNowRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateGatewaySoftwareNowRequest>(GetServiceRequestName(), *this);
    }
