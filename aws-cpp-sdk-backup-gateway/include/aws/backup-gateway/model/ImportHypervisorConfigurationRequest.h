...
namespace Model
{
  ...
  /**
   */
  class AWS_BACKUPGATEWAY_API ImportHypervisorConfigurationRequest : public BackupGatewayRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ImportHypervisorConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<ImportHypervisorConfigurationRequest>(GetServiceRequestName(), *this);
    }
