...
namespace Model
{
  ...
  /**
   */
  class AWS_BACKUPGATEWAY_API ListGatewaysRequest : public BackupGatewayRequest
  {
  public:
    ListGatewaysRequest();
    ...
    */
    virtual Aws::UniquePtr<ListGatewaysRequest> Clone() const
    {
      return Aws::MakeUnique<ListGatewaysRequest>(GetServiceRequestName(), *this);
    }
