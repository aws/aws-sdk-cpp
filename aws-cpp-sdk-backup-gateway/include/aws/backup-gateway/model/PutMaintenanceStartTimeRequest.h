...
namespace Model
{
  ...
  /**
   */
  class AWS_BACKUPGATEWAY_API PutMaintenanceStartTimeRequest : public BackupGatewayRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutMaintenanceStartTimeRequest> Clone() const
    {
      return Aws::MakeUnique<PutMaintenanceStartTimeRequest>(GetServiceRequestName(), *this);
    }
