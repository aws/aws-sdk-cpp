...
namespace Model
{
  ...
  {
  public:
    AWS_BACKUPGATEWAY_API ResourceNotFoundException();
    AWS_BACKUPGATEWAY_API ResourceNotFoundException(Aws::Utils::Json::JsonView jsonValue);
    AWS_BACKUPGATEWAY_API ResourceNotFoundException& operator=(Aws::Utils::Json::JsonView jsonValue);
