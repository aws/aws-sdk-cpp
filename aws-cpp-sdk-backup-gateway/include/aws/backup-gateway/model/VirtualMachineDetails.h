...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_BACKUPGATEWAY_API VirtualMachineDetails
  {
  public:
    VirtualMachineDetails();
    VirtualMachineDetails(Aws::Utils::Json::JsonView jsonValue);
    VirtualMachineDetails& operator=(Aws::Utils::Json::JsonView jsonValue);
