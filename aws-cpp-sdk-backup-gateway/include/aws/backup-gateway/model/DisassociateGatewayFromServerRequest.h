...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateGatewayFromServerRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateGatewayFromServerRequest>(GetServiceRequestName(), *this);
    }
