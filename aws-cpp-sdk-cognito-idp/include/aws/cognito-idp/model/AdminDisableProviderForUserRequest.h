...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AdminDisableProviderForUserRequest> Clone() const
    {
      return Aws::MakeUnique<AdminDisableProviderForUserRequest>(GetServiceRequestName(), *this);
    }
