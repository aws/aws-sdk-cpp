...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetIdentityProviderByIdentifierRequest> Clone() const
    {
      return Aws::MakeUnique<GetIdentityProviderByIdentifierRequest>(GetServiceRequestName(), *this);
    }
