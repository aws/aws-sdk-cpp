...
namespace Model
{
  ...
  /**
   */
  class AWS_COGNITOIDENTITYPROVIDER_API ListIdentityProvidersRequest : public CognitoIdentityProviderRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListIdentityProvidersRequest> Clone() const
    {
      return Aws::MakeUnique<ListIdentityProvidersRequest>(GetServiceRequestName(), *this);
    }
