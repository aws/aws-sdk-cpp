...
namespace Model
{
  ...
  public:
     ...
     * <p>The user pool ID for the user pool where you want to enable the user.</p>
     */
    inline AdminEnableUserRequest& WithUserPoolId(Aws::String&& value) { SetUserPoolId(value); return *this;}
     ...
     * <p>The user name of the user you wish to ebable.</p>
     */
    inline AdminEnableUserRequest& WithUsername(Aws::String&& value) { SetUsername(value); return *this;}
