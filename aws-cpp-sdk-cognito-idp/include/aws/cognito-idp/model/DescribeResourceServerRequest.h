...
namespace Model
{
  ...
  /**
   */
  class AWS_COGNITOIDENTITYPROVIDER_API DescribeResourceServerRequest : public CognitoIdentityProviderRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeResourceServerRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeResourceServerRequest>(GetServiceRequestName(), *this);
    }
