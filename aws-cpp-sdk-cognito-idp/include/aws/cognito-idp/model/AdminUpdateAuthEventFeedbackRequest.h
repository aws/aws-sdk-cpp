...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AdminUpdateAuthEventFeedbackRequest> Clone() const
    {
      return Aws::MakeUnique<AdminUpdateAuthEventFeedbackRequest>(GetServiceRequestName(), *this);
    }
