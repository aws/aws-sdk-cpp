...
namespace Model
{
  ...
  public:
    ...
    UpdateIdentityProviderResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    UpdateIdentityProviderResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
