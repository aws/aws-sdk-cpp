...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetUserAttributeVerificationCodeRequest> Clone() const
    {
      return Aws::MakeUnique<GetUserAttributeVerificationCodeRequest>(GetServiceRequestName(), *this);
    }
