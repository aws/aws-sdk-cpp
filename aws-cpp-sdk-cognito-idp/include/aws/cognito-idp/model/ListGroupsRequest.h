...
namespace Model
{
  ...
  /**
   */
  class AWS_COGNITOIDENTITYPROVIDER_API ListGroupsRequest : public CognitoIdentityProviderRequest
  {
  public:
    ListGroupsRequest();
     ...
     * <p>The user pool ID for the user pool.</p>
     */
    inline ListGroupsRequest& WithUserPoolId(Aws::String&& value) { SetUserPoolId(value); return *this;}
     ...
     * which can be used to return the next set of items in the list.</p>
     */
    inline ListGroupsRequest& WithNextToken(Aws::String&& value) { SetNextToken(value); return *this;}
