...
namespace Model
{
  ...
  public:
    ...
    CreateUserImportJobResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    CreateUserImportJobResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
