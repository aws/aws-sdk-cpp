...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_COGNITOIDENTITYPROVIDER_API GetSigningCertificateRequest : public CognitoIdentityProviderRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetSigningCertificateRequest> Clone() const
    {
      return Aws::MakeUnique<GetSigningCertificateRequest>(GetServiceRequestName(), *this);
    }
