...
namespace Model
{
  ...
  /**
   */
  class AWS_COGNITOIDENTITYPROVIDER_API ListResourceServersRequest : public CognitoIdentityProviderRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListResourceServersRequest> Clone() const
    {
      return Aws::MakeUnique<ListResourceServersRequest>(GetServiceRequestName(), *this);
    }
