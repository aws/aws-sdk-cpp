...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>Indicates whether token revocation is enabled for the user pool client. When
     * you create a new user pool client, token revocation is enabled by default. For
     * more information about revoking tokens, see <a
