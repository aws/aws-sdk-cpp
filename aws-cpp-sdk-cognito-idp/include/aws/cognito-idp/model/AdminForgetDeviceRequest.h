...
namespace Model
{
  ...
  public:
     ...
     * <p>The user pool ID.</p>
     */
    inline AdminForgetDeviceRequest& WithUserPoolId(Aws::String&& value) { SetUserPoolId(value); return *this;}
     ...
     * <p>The user name.</p>
     */
    inline AdminForgetDeviceRequest& WithUsername(Aws::String&& value) { SetUsername(value); return *this;}
     ...
     * <p>The device key.</p>
     */
    inline AdminForgetDeviceRequest& WithDeviceKey(Aws::String&& value) { SetDeviceKey(value); return *this;}
