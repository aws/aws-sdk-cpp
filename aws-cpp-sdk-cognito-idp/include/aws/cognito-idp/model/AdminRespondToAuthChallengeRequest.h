...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AdminRespondToAuthChallengeRequest> Clone() const
    {
      return Aws::MakeUnique<AdminRespondToAuthChallengeRequest>(GetServiceRequestName(), *this);
    }
