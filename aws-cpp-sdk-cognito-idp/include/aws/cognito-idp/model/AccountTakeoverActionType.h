...
namespace Model
{
  ...
  public:
     ...
     * will block the request.</p> </li> <li> <p> <code>MFA_IF_CONFIGURED</code>
     * Present an MFA challenge if user has configured it, else allow the request.</p>
     * </li> <li> <p> <code>MFA_REQUIRED</code> Present an MFA challenge if user has
     * configured it, else block the request.</p> </li> <li> <p> <code>NO_ACTION</code>
     * Allow the user to sign in.</p> </li> </ul>
     */
