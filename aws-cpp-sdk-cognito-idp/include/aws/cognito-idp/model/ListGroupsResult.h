...
namespace Model
{
  ...
  public:
     ...
     * <p>The group objects for the groups.</p>
     */
    inline ListGroupsResult& WithGroups(Aws::Vector<GroupType>&& value) { SetGroups(value); return *this;}
     ...
     * <p>The group objects for the groups.</p>
     */
    inline ListGroupsResult& AddGroups(GroupType&& value) { m_groups.push_back(value); return *this; }
     ...
     * which can be used to return the next set of items in the list.</p>
     */
    inline ListGroupsResult& WithNextToken(Aws::String&& value) { SetNextToken(value); return *this;}
