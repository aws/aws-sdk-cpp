...
namespace CognitoIdentityProvider
{
  ...
  class AWS_COGNITOIDENTITYPROVIDER_API CognitoIdentityProviderClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        CognitoIdentityProviderClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                      std::shared_ptr<Endpoint::CognitoIdentityProviderEndpointProvider> endpointProvider = Aws::MakeShared<CognitoIdentityProvider::Endpoint::CognitoIdentityProviderEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::CognitoIdentityProviderEndpointProvider> m_endpointProvider;
  };
