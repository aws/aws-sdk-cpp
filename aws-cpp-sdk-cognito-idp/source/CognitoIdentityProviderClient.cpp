...
using ResolveEndpointOutcome = Aws::CognitoIdentityProvider::Endpoint::CognitoIdentityProviderEndpointProvider::CognitoIdentityProviderResolveEndpointOutcome;
...
CognitoIdentityProviderClient::CognitoIdentityProviderClient(const Client::ClientConfiguration& clientConfiguration,
                                                             std::shared_ptr<Endpoint::CognitoIdentityProviderEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<CognitoIdentityProviderErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<CognitoIdentityProvider::Endpoint::CognitoIdentityProviderEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
