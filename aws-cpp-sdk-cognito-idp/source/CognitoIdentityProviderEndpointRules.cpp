...
Aws::String CognitoIdentityProviderEndpointRules::GetRulesAsString()
{
    return Aws::String(CognitoIdentityProviderEndpointRules::Rules.begin(), CognitoIdentityProviderEndpointRules::Rules.end());
}

const Aws::Vector<char> CognitoIdentityProviderEndpointRules::Rules = {
...
's',':','/','/','c','o','g','n','i','t','o','-','i','d','p','-','f','i','p','s','.','{','R','e','g',
...
'i','t','o','-','i','d','p','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i',
