...
SetRiskConfigurationResult::SetRiskConfigurationResult()
{
}

SetRiskConfigurationResult::SetRiskConfigurationResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
