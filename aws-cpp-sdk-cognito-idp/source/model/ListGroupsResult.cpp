...
ListGroupsResult::ListGroupsResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListGroupsResult& ListGroupsResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
