...
using CostExplorerResolveEndpointOutcome = Aws::CostExplorer::Endpoint::CostExplorerEndpointProvider::CostExplorerResolveEndpointOutcome;
...
void ValidateOutcome(const CostExplorerResolveEndpointOutcome& outcome, const CostExplorerEndpointProviderEndpointTestCase::Expect& expect)
{
