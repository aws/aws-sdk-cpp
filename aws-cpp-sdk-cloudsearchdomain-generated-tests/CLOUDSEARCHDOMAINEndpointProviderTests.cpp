...
static const char* ALLOCATION_TAG = "AWSCloudSearchDomainEndpointProviderTests";
using CloudSearchDomainEndpointProvider = Aws::CloudSearchDomain::Endpoint::CloudSearchDomainEndpointProvider;
using EndpointParameters = Aws::Vector<Aws::Endpoint::EndpointParameter>;
using CloudSearchDomainResolveEndpointOutcome = Aws::CloudSearchDomain::Endpoint::CloudSearchDomainEndpointProvider::CloudSearchDomainResolveEndpointOutcome;
...
class CloudSearchDomainEndpointProviderTests :public ::testing::TestWithParam<size_t>
{
public:
...
struct CloudSearchDomainEndpointProviderEndpointTestCase
{
...
static const Aws::Vector<CloudSearchDomainEndpointProviderEndpointTestCase> TEST_CASES = {
  /*TEST CASE 0*/
...
void ValidateOutcome(const CloudSearchDomainResolveEndpointOutcome& outcome, const CloudSearchDomainEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(CloudSearchDomainEndpointProviderTests, EndpointProviderTest)
{
    ...
    const CloudSearchDomainEndpointProviderEndpointTestCase& TEST_CASE = TEST_CASES.at(TEST_CASE_IDX);
    SCOPED_TRACE(Aws::String("\nTEST CASE # ") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX) + ": " + TEST_CASE.documentation);

    std::shared_ptr<CloudSearchDomainEndpointProvider> endpointProvider = Aws::MakeShared<CloudSearchDomainEndpointProvider>(ALLOCATION_TAG);
    ASSERT_TRUE(endpointProvider) << "Failed to allocate/initialize CloudSearchDomainEndpointProvider";
    ...
    for(const auto& operation : TEST_CASE.operationInput)
    {
         ...
         */
        const Aws::Vector<std::reference_wrapper<const CloudSearchDomainEndpointProviderEndpointTestCase::OperationParamsFromTest>>
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         CloudSearchDomainEndpointProviderTests,
