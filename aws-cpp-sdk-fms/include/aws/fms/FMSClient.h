...
namespace FMS
{
  ...
  class AWS_FMS_API FMSClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        FMSClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                  std::shared_ptr<Endpoint::FMSEndpointProvider> endpointProvider = Aws::MakeShared<FMS::Endpoint::FMSEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::FMSEndpointProvider> m_endpointProvider;
  };
