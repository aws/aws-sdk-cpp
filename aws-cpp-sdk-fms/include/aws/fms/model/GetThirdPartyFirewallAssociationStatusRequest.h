...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetThirdPartyFirewallAssociationStatusRequest> Clone() const
    {
      return Aws::MakeUnique<GetThirdPartyFirewallAssociationStatusRequest>(GetServiceRequestName(), *this);
    }
