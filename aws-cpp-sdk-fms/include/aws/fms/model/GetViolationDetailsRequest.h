...
namespace Model
{
  ...
  /**
   */
  class AWS_FMS_API GetViolationDetailsRequest : public FMSRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetViolationDetailsRequest> Clone() const
    {
      return Aws::MakeUnique<GetViolationDetailsRequest>(GetServiceRequestName(), *this);
    }
