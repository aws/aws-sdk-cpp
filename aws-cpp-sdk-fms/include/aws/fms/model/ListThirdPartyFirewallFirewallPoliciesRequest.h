...
namespace Model
{
  ...
  /**
   */
  class AWS_FMS_API ListThirdPartyFirewallFirewallPoliciesRequest : public FMSRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListThirdPartyFirewallFirewallPoliciesRequest> Clone() const
    {
      return Aws::MakeUnique<ListThirdPartyFirewallFirewallPoliciesRequest>(GetServiceRequestName(), *this);
    }
