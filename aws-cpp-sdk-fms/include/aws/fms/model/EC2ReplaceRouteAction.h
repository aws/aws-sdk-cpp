...
namespace Model
{
  ...
  public:
     ...
     * <p>A description of the ReplaceRoute action in Amazon EC2.</p>
     */
    inline EC2ReplaceRouteAction& WithDescription(const Aws::String& value) { SetDescription(value); return *this;}

    /**
     * <p>A description of the ReplaceRoute action in Amazon EC2.</p>
     */
    inline EC2ReplaceRouteAction& WithDescription(Aws::String&& value) { SetDescription(std::move(value)); return *this;}

    /**
     * <p>A description of the ReplaceRoute action in Amazon EC2.</p>
     */
    inline EC2ReplaceRouteAction& WithDescription(const char* value) { SetDescription(value); return *this;}
     ...
     * table.</p>
     */
    inline EC2ReplaceRouteAction& WithDestinationCidrBlock(const Aws::String& value) { SetDestinationCidrBlock(value); return *this;}
     ...
     * table.</p>
     */
    inline EC2ReplaceRouteAction& WithDestinationCidrBlock(Aws::String&& value) { SetDestinationCidrBlock(std::move(value)); return *this;}
     ...
     * table.</p>
     */
    inline EC2ReplaceRouteAction& WithDestinationCidrBlock(const char* value) { SetDestinationCidrBlock(value); return *this;}
     ...
     * <p>Information about the ID of the prefix list for the route.</p>
     */
    inline EC2ReplaceRouteAction& WithDestinationPrefixListId(const Aws::String& value) { SetDestinationPrefixListId(value); return *this;}

    /**
     * <p>Information about the ID of the prefix list for the route.</p>
     */
    inline EC2ReplaceRouteAction& WithDestinationPrefixListId(Aws::String&& value) { SetDestinationPrefixListId(std::move(value)); return *this;}

    /**
     * <p>Information about the ID of the prefix list for the route.</p>
     */
    inline EC2ReplaceRouteAction& WithDestinationPrefixListId(const char* value) { SetDestinationPrefixListId(value); return *this;}
     ...
     * table.</p>
     */
    inline EC2ReplaceRouteAction& WithDestinationIpv6CidrBlock(const Aws::String& value) { SetDestinationIpv6CidrBlock(value); return *this;}
     ...
     * table.</p>
     */
    inline EC2ReplaceRouteAction& WithDestinationIpv6CidrBlock(Aws::String&& value) { SetDestinationIpv6CidrBlock(std::move(value)); return *this;}
     ...
     * table.</p>
     */
    inline EC2ReplaceRouteAction& WithDestinationIpv6CidrBlock(const char* value) { SetDestinationIpv6CidrBlock(value); return *this;}
     ...
     * gateway.</p>
     */
    inline EC2ReplaceRouteAction& WithGatewayId(const ActionTarget& value) { SetGatewayId(value); return *this;}

    /**
     * <p>Information about the ID of an internet gateway or virtual private
     * gateway.</p>
     */
    inline EC2ReplaceRouteAction& WithGatewayId(ActionTarget&& value) { SetGatewayId(std::move(value)); return *this;}
     ...
     * <p>Information about the ID of the route table.</p>
     */
    inline EC2ReplaceRouteAction& WithRouteTableId(const ActionTarget& value) { SetRouteTableId(value); return *this;}

    /**
     * <p>Information about the ID of the route table.</p>
     */
    inline EC2ReplaceRouteAction& WithRouteTableId(ActionTarget&& value) { SetRouteTableId(std::move(value)); return *this;}
