...
namespace Model
{
  ...
  /**
   */
  class AWS_FMS_API AssociateThirdPartyFirewallRequest : public FMSRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateThirdPartyFirewallRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateThirdPartyFirewallRequest>(GetServiceRequestName(), *this);
    }
