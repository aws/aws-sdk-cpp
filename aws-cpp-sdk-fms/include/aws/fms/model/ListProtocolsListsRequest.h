...
namespace Model
{
  ...
  /**
   */
  class AWS_FMS_API ListProtocolsListsRequest : public FMSRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListProtocolsListsRequest> Clone() const
    {
      return Aws::MakeUnique<ListProtocolsListsRequest>(GetServiceRequestName(), *this);
    }
