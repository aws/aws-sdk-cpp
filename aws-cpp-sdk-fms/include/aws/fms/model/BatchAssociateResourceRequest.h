...
namespace Model
{
  ...
  /**
   */
  class AWS_FMS_API BatchAssociateResourceRequest : public FMSRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchAssociateResourceRequest> Clone() const
    {
      return Aws::MakeUnique<BatchAssociateResourceRequest>(GetServiceRequestName(), *this);
    }
