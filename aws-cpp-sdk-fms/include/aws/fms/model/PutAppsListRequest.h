...
namespace Model
{
  ...
  /**
   */
  class AWS_FMS_API PutAppsListRequest : public FMSRequest
  {
  public:
    PutAppsListRequest();
    ...
    */
    virtual Aws::UniquePtr<PutAppsListRequest> Clone() const
    {
      return Aws::MakeUnique<PutAppsListRequest>(GetServiceRequestName(), *this);
    }
