...
namespace Model
{
  ...
  /**
   */
  class AWS_FMS_API GetProtocolsListRequest : public FMSRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetProtocolsListRequest> Clone() const
    {
      return Aws::MakeUnique<GetProtocolsListRequest>(GetServiceRequestName(), *this);
    }
