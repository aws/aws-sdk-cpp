...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_FMS_API EC2AssociateRouteTableAction
  {
  public:
    EC2AssociateRouteTableAction();
    EC2AssociateRouteTableAction(Aws::Utils::Json::JsonView jsonValue);
    EC2AssociateRouteTableAction& operator=(Aws::Utils::Json::JsonView jsonValue);
