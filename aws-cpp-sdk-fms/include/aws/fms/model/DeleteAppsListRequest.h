...
namespace Model
{
  ...
  /**
   */
  class AWS_FMS_API DeleteAppsListRequest : public FMSRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteAppsListRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteAppsListRequest>(GetServiceRequestName(), *this);
    }
