...
namespace Model
{
  ...
  /**
   */
  class AWS_FMS_API GetResourceSetRequest : public FMSRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetResourceSetRequest> Clone() const
    {
      return Aws::MakeUnique<GetResourceSetRequest>(GetServiceRequestName(), *this);
    }
