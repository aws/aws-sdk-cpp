...
namespace Model
{
  ...
  /**
   */
  class AWS_FMS_API ListDiscoveredResourcesRequest : public FMSRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListDiscoveredResourcesRequest> Clone() const
    {
      return Aws::MakeUnique<ListDiscoveredResourcesRequest>(GetServiceRequestName(), *this);
    }
