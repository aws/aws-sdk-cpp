...
namespace Model
{
  ...
  /**
   */
  class AWS_FMS_API PutResourceSetRequest : public FMSRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutResourceSetRequest> Clone() const
    {
      return Aws::MakeUnique<PutResourceSetRequest>(GetServiceRequestName(), *this);
    }
