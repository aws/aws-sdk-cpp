...
namespace Model
{
  ...
  /**
   */
  class AWS_FMS_API TagResourceRequest : public FMSRequest
  {
  public:
    TagResourceRequest();
    ...
    /**
     * <p>The Amazon Resource Name (ARN) of the resource. The Firewall Manager policy
     * is the only AWS resource that supports tagging, so this ARN is a policy ARN.</p>
     */
