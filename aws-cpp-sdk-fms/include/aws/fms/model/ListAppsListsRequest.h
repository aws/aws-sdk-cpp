...
namespace Model
{
  ...
  /**
   */
  class AWS_FMS_API ListAppsListsRequest : public FMSRequest
  {
  public:
    ...
    /**
     * <p>Specifies whether the lists to retrieve are default lists owned by AWS
     * Firewall Manager.</p>
     */
     ...
     * in the response. For all but the first request, you provide the token returned
     * by the prior request in the request parameters, to retrieve the next batch of
     * objects.</p>
     */
    ...
    /**
     * <p>The maximum number of objects that you want AWS Firewall Manager to return
     * for this request. If more objects are available, in the response, AWS Firewall
     * Manager provides a <code>NextToken</code> value that you can use in a subsequent
     * call to get the next batch of objects.</p> <p>If you don't specify this, AWS
     * Firewall Manager returns all available objects.</p>
     */
