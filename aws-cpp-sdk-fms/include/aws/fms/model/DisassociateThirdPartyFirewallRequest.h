...
namespace Model
{
  ...
  /**
   */
  class AWS_FMS_API DisassociateThirdPartyFirewallRequest : public FMSRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateThirdPartyFirewallRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateThirdPartyFirewallRequest>(GetServiceRequestName(), *this);
    }
