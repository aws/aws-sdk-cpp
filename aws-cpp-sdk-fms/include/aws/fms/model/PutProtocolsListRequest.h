...
namespace Model
{
  ...
  /**
   */
  class AWS_FMS_API PutProtocolsListRequest : public FMSRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutProtocolsListRequest> Clone() const
    {
      return Aws::MakeUnique<PutProtocolsListRequest>(GetServiceRequestName(), *this);
    }
