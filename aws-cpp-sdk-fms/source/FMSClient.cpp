...
using ResolveEndpointOutcome = Aws::FMS::Endpoint::FMSEndpointProvider::FMSResolveEndpointOutcome;
...
FMSClient::FMSClient(const Client::ClientConfiguration& clientConfiguration,
                     std::shared_ptr<Endpoint::FMSEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<FMSErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<FMS::Endpoint::FMSEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
