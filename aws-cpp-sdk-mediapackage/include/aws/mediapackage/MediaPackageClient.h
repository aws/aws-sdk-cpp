...
namespace MediaPackage
{
  ...
  class AWS_MEDIAPACKAGE_API MediaPackageClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        MediaPackageClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                           std::shared_ptr<Endpoint::MediaPackageEndpointProvider> endpointProvider = Aws::MakeShared<MediaPackage::Endpoint::MediaPackageEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::MediaPackageEndpointProvider> m_endpointProvider;
  };
