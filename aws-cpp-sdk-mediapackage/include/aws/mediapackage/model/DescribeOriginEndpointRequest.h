...
namespace Model
{
  ...
  /**
   */
  class AWS_MEDIAPACKAGE_API DescribeOriginEndpointRequest : public MediaPackageRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeOriginEndpointRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeOriginEndpointRequest>(GetServiceRequestName(), *this);
    }
