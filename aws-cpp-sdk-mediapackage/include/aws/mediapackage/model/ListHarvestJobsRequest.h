...
namespace Model
{
  ...
  /**
   */
  class AWS_MEDIAPACKAGE_API ListHarvestJobsRequest : public MediaPackageRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListHarvestJobsRequest> Clone() const
    {
      return Aws::MakeUnique<ListHarvestJobsRequest>(GetServiceRequestName(), *this);
    }
