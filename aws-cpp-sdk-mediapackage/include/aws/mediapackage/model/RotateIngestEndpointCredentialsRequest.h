...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<RotateIngestEndpointCredentialsRequest> Clone() const
    {
      return Aws::MakeUnique<RotateIngestEndpointCredentialsRequest>(GetServiceRequestName(), *this);
    }
