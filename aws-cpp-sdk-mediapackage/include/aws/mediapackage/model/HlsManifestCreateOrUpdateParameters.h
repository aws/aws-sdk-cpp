...
namespace Model
{
  ...
  public:
    ...
    HlsManifestCreateOrUpdateParameters(const Aws::Utils::Json::JsonValue& jsonValue);
    HlsManifestCreateOrUpdateParameters& operator=(const Aws::Utils::Json::JsonValue& jsonValue);
