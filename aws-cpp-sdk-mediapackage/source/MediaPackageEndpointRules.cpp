...
Aws::String MediaPackageEndpointRules::GetRulesAsString()
{
    return Aws::String(MediaPackageEndpointRules::Rules.begin(), MediaPackageEndpointRules::Rules.end());
}

const Aws::Vector<char> MediaPackageEndpointRules::Rules = {
