...
RotateChannelCredentialsResult::RotateChannelCredentialsResult()
{
}

RotateChannelCredentialsResult::RotateChannelCredentialsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
