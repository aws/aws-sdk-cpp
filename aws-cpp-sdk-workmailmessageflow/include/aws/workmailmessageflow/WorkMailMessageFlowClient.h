...
namespace WorkMailMessageFlow
{
  ...
  class AWS_WORKMAILMESSAGEFLOW_API WorkMailMessageFlowClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        WorkMailMessageFlowClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                  std::shared_ptr<Endpoint::WorkMailMessageFlowEndpointProvider> endpointProvider = Aws::MakeShared<WorkMailMessageFlow::Endpoint::WorkMailMessageFlowEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::WorkMailMessageFlowEndpointProvider> m_endpointProvider;
  };
