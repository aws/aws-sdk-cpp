...
static const char* ALLOCATION_TAG = "AWSImagebuilderEndpointProviderTests";
using ImagebuilderEndpointProvider = Aws::imagebuilder::Endpoint::ImagebuilderEndpointProvider;
using EndpointParameters = Aws::Vector<Aws::Endpoint::EndpointParameter>;
using ImagebuilderResolveEndpointOutcome = Aws::imagebuilder::Endpoint::ImagebuilderEndpointProvider::ImagebuilderResolveEndpointOutcome;
...
class ImagebuilderEndpointProviderTests :public ::testing::TestWithParam<size_t>
{
public:
...
struct ImagebuilderEndpointProviderEndpointTestCase
{
...
static const Aws::Vector<ImagebuilderEndpointProviderEndpointTestCase> TEST_CASES = {
  /*TEST CASE 0*/
...
void ValidateOutcome(const ImagebuilderResolveEndpointOutcome& outcome, const ImagebuilderEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(ImagebuilderEndpointProviderTests, EndpointProviderTest)
{
    ...
    const ImagebuilderEndpointProviderEndpointTestCase& TEST_CASE = TEST_CASES.at(TEST_CASE_IDX);
    SCOPED_TRACE(Aws::String("\nTEST CASE # ") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX) + ": " + TEST_CASE.documentation);

    std::shared_ptr<ImagebuilderEndpointProvider> endpointProvider = Aws::MakeShared<ImagebuilderEndpointProvider>(ALLOCATION_TAG);
    ASSERT_TRUE(endpointProvider) << "Failed to allocate/initialize ImagebuilderEndpointProvider";
    ...
    for(const auto& operation : TEST_CASE.operationInput)
    {
         ...
         */
        const Aws::Vector<std::reference_wrapper<const ImagebuilderEndpointProviderEndpointTestCase::OperationParamsFromTest>>
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ImagebuilderEndpointProviderTests,
