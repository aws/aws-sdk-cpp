...
using TimestreamWriteResolveEndpointOutcome = Aws::TimestreamWrite::Endpoint::TimestreamWriteEndpointProvider::TimestreamWriteResolveEndpointOutcome;
...
void ValidateOutcome(const TimestreamWriteResolveEndpointOutcome& outcome, const TimestreamWriteEndpointProviderEndpointTestCase::Expect& expect)
{
