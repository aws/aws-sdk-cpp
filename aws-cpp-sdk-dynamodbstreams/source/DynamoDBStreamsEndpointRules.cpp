...
Aws::String DynamoDBStreamsEndpointRules::GetRulesAsString()
{
    return Aws::String(DynamoDBStreamsEndpointRules::Rules.begin(), DynamoDBStreamsEndpointRules::Rules.end());
}

const Aws::Vector<char> DynamoDBStreamsEndpointRules::Rules = {
...
's','.','d','y','n','a','m','o','d','b','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.',
...
't','t','p','s',':','/','/','l','o','c','a','l','h','o','s','t',':','8','0','0','0','"',',','"','p',
'r','o','p','e','r','t','i','e','s','"',':','{','"','a','u','t','h','S','c','h','e','m','e','s','"',
':','[','{','"','n','a','m','e','"',':','"','s','i','g','v','4','"',',','"','s','i','g','n','i','n',
'g','N','a','m','e','"',':','"','d','y','n','a','m','o','d','b','"',',','"','s','i','g','n','i','n',
