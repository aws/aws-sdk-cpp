...
using ResolveEndpointOutcome = Aws::DynamoDBStreams::Endpoint::DynamoDBStreamsEndpointProvider::DynamoDBStreamsResolveEndpointOutcome;
...
DynamoDBStreamsClient::DynamoDBStreamsClient(const Client::ClientConfiguration& clientConfiguration,
                                             std::shared_ptr<Endpoint::DynamoDBStreamsEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<DynamoDBStreamsErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<DynamoDBStreams::Endpoint::DynamoDBStreamsEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
