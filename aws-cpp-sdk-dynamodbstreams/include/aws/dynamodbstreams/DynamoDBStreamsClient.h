...
namespace DynamoDBStreams
{
  ...
  class AWS_DYNAMODBSTREAMS_API DynamoDBStreamsClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        DynamoDBStreamsClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                              std::shared_ptr<Endpoint::DynamoDBStreamsEndpointProvider> endpointProvider = Aws::MakeShared<DynamoDBStreams::Endpoint::DynamoDBStreamsEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::DynamoDBStreamsEndpointProvider> m_endpointProvider;
  };
