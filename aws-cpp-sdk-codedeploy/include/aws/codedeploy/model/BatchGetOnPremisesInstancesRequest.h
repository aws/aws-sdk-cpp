...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchGetOnPremisesInstancesRequest> Clone() const
    {
      return Aws::MakeUnique<BatchGetOnPremisesInstancesRequest>(GetServiceRequestName(), *this);
    }
