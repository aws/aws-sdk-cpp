...
namespace Model
{
  ...
  /**
   * <p>Represents the input of a ListDeploymentInstances operation.</p><p><h3>See
   * Also:</h3>   <a
  ...
  public:
    ...
    inline virtual const char* GetServiceRequestName() const override { return "ListDeploymentInstances"; }
