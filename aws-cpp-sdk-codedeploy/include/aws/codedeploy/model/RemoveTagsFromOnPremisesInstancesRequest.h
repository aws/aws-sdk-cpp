...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<RemoveTagsFromOnPremisesInstancesRequest> Clone() const
    {
      return Aws::MakeUnique<RemoveTagsFromOnPremisesInstancesRequest>(GetServiceRequestName(), *this);
    }
