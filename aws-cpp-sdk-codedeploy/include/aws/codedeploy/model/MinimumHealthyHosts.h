...
namespace Model
{
  ...
  public:
     ...
     * deployment fails.</p> <note> <p>In a call to the get deployment configuration
     * operation, CodeDeployDefault.OneAtATime returns a minimum healthy instance type
     ...
     * to the last instance fails, the overall deployment is still successful.</p>
