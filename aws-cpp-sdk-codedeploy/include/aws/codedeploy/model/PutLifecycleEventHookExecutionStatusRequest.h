...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PutLifecycleEventHookExecutionStatusRequest> Clone() const
    {
      return Aws::MakeUnique<PutLifecycleEventHookExecutionStatusRequest>(GetServiceRequestName(), *this);
    }
