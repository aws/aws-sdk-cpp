...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AddTagsToOnPremisesInstancesRequest> Clone() const
    {
      return Aws::MakeUnique<AddTagsToOnPremisesInstancesRequest>(GetServiceRequestName(), *this);
    }
