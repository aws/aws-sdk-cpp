...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeregisterOnPremisesInstanceRequest> Clone() const
    {
      return Aws::MakeUnique<DeregisterOnPremisesInstanceRequest>(GetServiceRequestName(), *this);
    }
