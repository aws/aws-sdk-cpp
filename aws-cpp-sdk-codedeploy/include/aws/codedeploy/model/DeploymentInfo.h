  ...
  */
  ...
  public:
    ...
    */
    ...
    /*
     <p>Information about the location of application artifacts that are stored and the service to retrieve them from.</p>
    */
    ...
    */
    ...
    /*
     <p>How the deployment was created:</p> <ul> <li>user: A user created the deployment.</li> <li>autoscaling: Auto Scaling created the deployment.</li> </ul>
    */
