...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>The column name to sort the list results by:</p> <ul> <li>registerTime: Sort
     * the list results by when the revisions were registered with AWS CodeDeploy.</li>
     * <li>firstUsedTime: Sort the list results by when the revisions were first used
     * by in a deployment.</li> <li>lastUsedTime: Sort the list results by when the
     * revisions were last used in a deployment.</li> </ul> <p>If not specified or set
     * to null, the results will be returned in an arbitrary order.</p>
     */
    ...
    /**
     * <p>The order to sort the list results by:</p> <ul> <li>ascending: Sort the list
     * of results in ascending order.</li> <li>descending: Sort the list of results in
     * descending order.</li> </ul> <p>If not specified, the results will be sorted in
    ...
    /**
     * <p>A specific Amazon S3 bucket name to limit the search for revisions.</p> <p>If
     * set to null, then all of the user's buckets will be searched.</p>
     */
    ...
    /**
     * <p>A specific key prefix for the set of Amazon S3 objects to limit the search
     * for revisions.</p>
     */
     ...
     * revisions, regardless of whether they are target revisions of a deployment
     * group.</li> </ul>
     */
    ...
    /**
     * <p>An identifier that was returned from the previous list application revisions
     * call, which can be used to return the next set of applications in the list.</p>
     */
