...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteResourcesByExternalIdRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteResourcesByExternalIdRequest>(GetServiceRequestName(), *this);
    }
