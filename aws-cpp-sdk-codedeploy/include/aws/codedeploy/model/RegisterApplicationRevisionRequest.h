...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<RegisterApplicationRevisionRequest> Clone() const
    {
      return Aws::MakeUnique<RegisterApplicationRevisionRequest>(GetServiceRequestName(), *this);
    }
