...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchGetApplicationRevisionsRequest> Clone() const
    {
      return Aws::MakeUnique<BatchGetApplicationRevisionsRequest>(GetServiceRequestName(), *this);
    }
