  ...
  public:
    ...
    */
    ...
    /*
     <p>The current name of the existing deployment group.</p>
    */
    inline void SetCurrentDeploymentGroupName(const Aws::String& value) { m_currentDeploymentGroupName = value; }

    /*
     <p>The current name of the existing deployment group.</p>
    */
    inline void SetCurrentDeploymentGroupName(const char* value) { m_currentDeploymentGroupName.assign(value); }
