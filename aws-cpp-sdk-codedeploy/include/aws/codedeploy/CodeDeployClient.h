...
namespace CodeDeploy
{
  ...
  class AWS_CODEDEPLOY_API CodeDeployClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        CodeDeployClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                         std::shared_ptr<Endpoint::CodeDeployEndpointProvider> endpointProvider = Aws::MakeShared<CodeDeploy::Endpoint::CodeDeployEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::CodeDeployEndpointProvider> m_endpointProvider;
  };
