...
GetDeploymentGroupResult::GetDeploymentGroupResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

GetDeploymentGroupResult& GetDeploymentGroupResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
