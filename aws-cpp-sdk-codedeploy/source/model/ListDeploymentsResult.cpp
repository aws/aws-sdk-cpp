...
ListDeploymentsResult::ListDeploymentsResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListDeploymentsResult& ListDeploymentsResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
