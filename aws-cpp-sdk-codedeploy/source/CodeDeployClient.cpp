...
using ResolveEndpointOutcome = Aws::CodeDeploy::Endpoint::CodeDeployEndpointProvider::CodeDeployResolveEndpointOutcome;
...
CodeDeployClient::CodeDeployClient(const Client::ClientConfiguration& clientConfiguration,
                                   std::shared_ptr<Endpoint::CodeDeployEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<CodeDeployErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<CodeDeploy::Endpoint::CodeDeployEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
