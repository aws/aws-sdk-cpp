...
namespace Model
{
  ...
  /**
   */
  class AWS_SNOWBALL_API UpdateJobShipmentStateRequest : public SnowballRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateJobShipmentStateRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateJobShipmentStateRequest>(GetServiceRequestName(), *this);
    }
