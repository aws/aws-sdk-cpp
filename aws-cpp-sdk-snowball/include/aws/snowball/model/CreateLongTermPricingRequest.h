...
namespace Model
{
  ...
  /**
   */
  class AWS_SNOWBALL_API CreateLongTermPricingRequest : public SnowballRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateLongTermPricingRequest> Clone() const
    {
      return Aws::MakeUnique<CreateLongTermPricingRequest>(GetServiceRequestName(), *this);
    }
