...
namespace Model
{
  ...
  /**
   */
  class AWS_SNOWBALL_API UpdateLongTermPricingRequest : public SnowballRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateLongTermPricingRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateLongTermPricingRequest>(GetServiceRequestName(), *this);
    }
