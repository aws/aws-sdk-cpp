...
namespace Model
{
  ...
  /**
   */
  class AWS_SNOWBALL_API DescribeReturnShippingLabelRequest : public SnowballRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeReturnShippingLabelRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeReturnShippingLabelRequest>(GetServiceRequestName(), *this);
    }
