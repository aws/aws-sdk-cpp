...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeAddressesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeAddressesRequest>(GetServiceRequestName(), *this);
    }
     ...
     * addresses.</p>
     */
    inline DescribeAddressesRequest& WithNextToken(Aws::String&& value) { SetNextToken(std::move(value)); return *this;}
