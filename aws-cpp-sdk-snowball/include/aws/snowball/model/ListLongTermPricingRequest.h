...
namespace Model
{
  ...
  /**
   */
  class AWS_SNOWBALL_API ListLongTermPricingRequest : public SnowballRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListLongTermPricingRequest> Clone() const
    {
      return Aws::MakeUnique<ListLongTermPricingRequest>(GetServiceRequestName(), *this);
    }
