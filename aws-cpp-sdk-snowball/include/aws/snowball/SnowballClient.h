...
namespace Snowball
{
  ...
  class AWS_SNOWBALL_API SnowballClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        SnowballClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                       std::shared_ptr<Endpoint::SnowballEndpointProvider> endpointProvider = Aws::MakeShared<Snowball::Endpoint::SnowballEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::SnowballEndpointProvider> m_endpointProvider;
  };
