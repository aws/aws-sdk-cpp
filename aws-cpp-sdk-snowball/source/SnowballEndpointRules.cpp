...
namespace Snowball
{
const size_t SnowballEndpointRules::RulesBlobStrLen = 3462;
const size_t SnowballEndpointRules::RulesBlobSize = 3463;
...
's','n','o','w','b','a','l','l','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t',
...
'r','l','"',':','"','h','t','t','p','s',':','/','/','s','n','o','w','b','a','l','l','.','{','R','e',
