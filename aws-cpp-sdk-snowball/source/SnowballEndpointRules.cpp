...
Aws::String SnowballEndpointRules::GetRulesAsString()
{
    return Aws::String(SnowballEndpointRules::Rules.begin(), SnowballEndpointRules::Rules.end());
}

const Aws::Vector<char> SnowballEndpointRules::Rules = {
