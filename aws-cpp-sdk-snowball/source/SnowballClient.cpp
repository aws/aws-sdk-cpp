...
using ResolveEndpointOutcome = Aws::Snowball::Endpoint::SnowballEndpointProvider::SnowballResolveEndpointOutcome;
...
SnowballClient::SnowballClient(const Client::ClientConfiguration& clientConfiguration,
                               std::shared_ptr<Endpoint::SnowballEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<SnowballErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<Snowball::Endpoint::SnowballEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
