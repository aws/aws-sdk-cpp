...
namespace drs
{
  ...
  class AWS_DRS_API DrsClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        DrsClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                  std::shared_ptr<Endpoint::DrsEndpointProvider> endpointProvider = Aws::MakeShared<drs::Endpoint::DrsEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::DrsEndpointProvider> m_endpointProvider;
  };
