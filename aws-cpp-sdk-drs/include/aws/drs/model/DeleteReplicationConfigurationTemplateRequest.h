...
namespace Model
{
  ...
  /**
   */
  class AWS_DRS_API DeleteReplicationConfigurationTemplateRequest : public DrsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteReplicationConfigurationTemplateRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteReplicationConfigurationTemplateRequest>(GetServiceRequestName(), *this);
    }
