...
namespace Model
{
  ...
  /**
   */
  class AWS_DRS_API TerminateRecoveryInstancesRequest : public DrsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<TerminateRecoveryInstancesRequest> Clone() const
    {
      return Aws::MakeUnique<TerminateRecoveryInstancesRequest>(GetServiceRequestName(), *this);
    }
