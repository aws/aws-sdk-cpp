...
namespace Model
{
  ...
  /**
   */
  class AWS_DRS_API ListStagingAccountsRequest : public DrsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListStagingAccountsRequest> Clone() const
    {
      return Aws::MakeUnique<ListStagingAccountsRequest>(GetServiceRequestName(), *this);
    }
