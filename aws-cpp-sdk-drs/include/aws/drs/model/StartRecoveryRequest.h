...
namespace Model
{
  ...
  /**
   */
  class AWS_DRS_API StartRecoveryRequest : public DrsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StartRecoveryRequest> Clone() const
    {
      return Aws::MakeUnique<StartRecoveryRequest>(GetServiceRequestName(), *this);
    }
