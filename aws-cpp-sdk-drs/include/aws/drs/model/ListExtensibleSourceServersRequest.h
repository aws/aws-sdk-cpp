...
namespace Model
{
  ...
  /**
   */
  class AWS_DRS_API ListExtensibleSourceServersRequest : public DrsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListExtensibleSourceServersRequest> Clone() const
    {
      return Aws::MakeUnique<ListExtensibleSourceServersRequest>(GetServiceRequestName(), *this);
    }
