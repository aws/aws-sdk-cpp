...
namespace Model
{
  ...
  {
  public:
    AWS_DRS_API AccessDeniedException();
    AWS_DRS_API AccessDeniedException(Aws::Utils::Json::JsonView jsonValue);
    AWS_DRS_API AccessDeniedException& operator=(Aws::Utils::Json::JsonView jsonValue);
