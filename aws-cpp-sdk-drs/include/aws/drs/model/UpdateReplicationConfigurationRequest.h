...
namespace Model
{
  ...
  /**
   */
  class AWS_DRS_API UpdateReplicationConfigurationRequest : public DrsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateReplicationConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateReplicationConfigurationRequest>(GetServiceRequestName(), *this);
    }
