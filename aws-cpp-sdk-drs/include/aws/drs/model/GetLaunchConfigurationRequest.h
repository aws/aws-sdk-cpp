...
namespace Model
{
  ...
  /**
   */
  class AWS_DRS_API GetLaunchConfigurationRequest : public DrsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetLaunchConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<GetLaunchConfigurationRequest>(GetServiceRequestName(), *this);
    }
