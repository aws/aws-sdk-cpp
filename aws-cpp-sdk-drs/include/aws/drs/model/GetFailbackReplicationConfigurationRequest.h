...
namespace Model
{
  ...
  /**
   */
  class AWS_DRS_API GetFailbackReplicationConfigurationRequest : public DrsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetFailbackReplicationConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<GetFailbackReplicationConfigurationRequest>(GetServiceRequestName(), *this);
    }
