...
namespace Model
{
  ...
  public:
     ...
     * <p>The staging area of the source server.</p>
     */
    inline RetryDataReplicationResult& WithStagingArea(const StagingArea& value) { SetStagingArea(value); return *this;}

    /**
     * <p>The staging area of the source server.</p>
     */
    inline RetryDataReplicationResult& WithStagingArea(StagingArea&& value) { SetStagingArea(std::move(value)); return *this;}
