...
namespace Model
{
  ...
  /**
   */
  class AWS_DRS_API DescribeJobsRequest : public DrsRequest
  {
  public:
    DescribeJobsRequest();
    ...
    */
    virtual Aws::UniquePtr<DescribeJobsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeJobsRequest>(GetServiceRequestName(), *this);
    }
