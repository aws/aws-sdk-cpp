...
namespace Model
{
  ...
  /**
   */
  class AWS_DRS_API DescribeRecoveryInstancesRequest : public DrsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeRecoveryInstancesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeRecoveryInstancesRequest>(GetServiceRequestName(), *this);
    }
