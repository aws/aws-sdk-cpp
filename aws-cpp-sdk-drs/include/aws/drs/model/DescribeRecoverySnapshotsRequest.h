...
namespace Model
{
  ...
  /**
   */
  class AWS_DRS_API DescribeRecoverySnapshotsRequest : public DrsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeRecoverySnapshotsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeRecoverySnapshotsRequest>(GetServiceRequestName(), *this);
    }
