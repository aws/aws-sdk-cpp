...
namespace Model
{
  ...
  /**
   */
  class AWS_DRS_API StartFailbackLaunchRequest : public DrsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StartFailbackLaunchRequest> Clone() const
    {
      return Aws::MakeUnique<StartFailbackLaunchRequest>(GetServiceRequestName(), *this);
    }
