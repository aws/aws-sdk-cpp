...
DescribeRecoveryInstancesResult::DescribeRecoveryInstancesResult()
{
}

DescribeRecoveryInstancesResult::DescribeRecoveryInstancesResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
