...
namespace drs
{
const size_t DrsEndpointRules::RulesBlobStrLen = 3442;
const size_t DrsEndpointRules::RulesBlobSize = 3443;

using RulesBlobT = Aws::Array<const char, DrsEndpointRules::RulesBlobSize>;
...
'"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','d','r','s','.','{','R','e','g','i','o',
...
const char* DrsEndpointRules::GetRulesBlob()
{
