...
Aws::String DrsEndpointRules::GetRulesAsString()
{
    return Aws::String(DrsEndpointRules::Rules.begin(), DrsEndpointRules::Rules.end());
}

const Aws::Vector<char> DrsEndpointRules::Rules = {
