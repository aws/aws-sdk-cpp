...
static const char* ALLOCATION_TAG = "AWSAppRegistryEndpointProviderTests";
using AppRegistryEndpointProvider = Aws::AppRegistry::Endpoint::AppRegistryEndpointProvider;
using EndpointParameters = Aws::Vector<Aws::Endpoint::EndpointParameter>;
using AppRegistryResolveEndpointOutcome = Aws::AppRegistry::Endpoint::AppRegistryEndpointProvider::AppRegistryResolveEndpointOutcome;
...
class AppRegistryEndpointProviderTests :public ::testing::TestWithParam<size_t>
{
public:
...
struct AppRegistryEndpointProviderEndpointTestCase
{
...
static const Aws::Vector<AppRegistryEndpointProviderEndpointTestCase> TEST_CASES = {
  /*TEST CASE 0*/
  {"For region ap-south-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry-fips.ap-south-1.api.aws",
       {/*properties*/},
  ...
  {"For region ap-south-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry-fips.ap-south-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-south-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry.ap-south-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-south-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry.ap-south-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-south-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry-fips.eu-south-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-south-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry-fips.eu-south-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-south-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry.eu-south-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-south-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry.eu-south-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-gov-east-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry-fips.us-gov-east-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-gov-east-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry.us-gov-east-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-gov-east-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry.us-gov-east-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ca-central-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry-fips.ca-central-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ca-central-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry-fips.ca-central-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ca-central-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry.ca-central-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ca-central-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry.ca-central-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-central-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry-fips.eu-central-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-central-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry-fips.eu-central-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-central-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry.eu-central-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-central-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry.eu-central-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-west-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry-fips.us-west-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-west-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry-fips.us-west-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-west-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry.us-west-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-west-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry.us-west-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-west-2 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry-fips.us-west-2.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-west-2 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry-fips.us-west-2.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-west-2 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry.us-west-2.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-west-2 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry.us-west-2.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region af-south-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry-fips.af-south-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region af-south-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry-fips.af-south-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region af-south-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry.af-south-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region af-south-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry.af-south-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-north-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry-fips.eu-north-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-north-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry-fips.eu-north-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-north-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry.eu-north-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-north-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry.eu-north-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-west-3 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry-fips.eu-west-3.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-west-3 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry-fips.eu-west-3.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-west-3 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry.eu-west-3.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-west-3 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry.eu-west-3.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-west-2 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry-fips.eu-west-2.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-west-2 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry-fips.eu-west-2.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-west-2 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry.eu-west-2.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-west-2 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry.eu-west-2.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-west-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry-fips.eu-west-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-west-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry-fips.eu-west-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-west-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry.eu-west-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-west-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry.eu-west-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-northeast-3 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry-fips.ap-northeast-3.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-northeast-3 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry-fips.ap-northeast-3.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-northeast-3 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry.ap-northeast-3.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-northeast-3 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry.ap-northeast-3.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-northeast-2 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry-fips.ap-northeast-2.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-northeast-2 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry-fips.ap-northeast-2.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-northeast-2 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry.ap-northeast-2.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-northeast-2 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry.ap-northeast-2.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-northeast-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry-fips.ap-northeast-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-northeast-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry-fips.ap-northeast-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-northeast-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry.ap-northeast-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-northeast-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry.ap-northeast-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region me-south-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry-fips.me-south-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region me-south-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry-fips.me-south-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region me-south-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry.me-south-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region me-south-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry.me-south-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region sa-east-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry-fips.sa-east-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region sa-east-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry-fips.sa-east-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region sa-east-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry.sa-east-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region sa-east-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry.sa-east-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-east-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry-fips.ap-east-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-east-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry-fips.ap-east-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-east-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry.ap-east-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-east-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry.ap-east-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-gov-west-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry-fips.us-gov-west-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-gov-west-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry.us-gov-west-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-gov-west-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry.us-gov-west-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-southeast-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry-fips.ap-southeast-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-southeast-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry-fips.ap-southeast-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-southeast-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry.ap-southeast-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-southeast-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry.ap-southeast-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-southeast-2 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry-fips.ap-southeast-2.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-southeast-2 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry-fips.ap-southeast-2.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-southeast-2 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry.ap-southeast-2.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-southeast-2 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry.ap-southeast-2.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-southeast-3 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry-fips.ap-southeast-3.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-southeast-3 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry-fips.ap-southeast-3.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-southeast-3 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry.ap-southeast-3.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-southeast-3 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry.ap-southeast-3.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-east-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry-fips.us-east-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-east-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry-fips.us-east-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-east-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry.us-east-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-east-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry.us-east-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-east-2 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry-fips.us-east-2.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-east-2 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry-fips.us-east-2.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-east-2 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry.us-east-2.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-east-2 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://servicecatalog-appregistry.us-east-2.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
...
void ValidateOutcome(const AppRegistryResolveEndpointOutcome& outcome, const AppRegistryEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(AppRegistryEndpointProviderTests, EndpointProviderTest)
{
    ...
    const AppRegistryEndpointProviderEndpointTestCase& TEST_CASE = TEST_CASES.at(TEST_CASE_IDX);
    SCOPED_TRACE(Aws::String("\nTEST CASE # ") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX) + ": " + TEST_CASE.documentation);

    std::shared_ptr<AppRegistryEndpointProvider> endpointProvider = Aws::MakeShared<AppRegistryEndpointProvider>(ALLOCATION_TAG);
    ASSERT_TRUE(endpointProvider) << "Failed to allocate/initialize AppRegistryEndpointProvider";
    ...
    for(const auto& operation : TEST_CASE.operationInput)
    {
         ...
         */
        const Aws::Vector<std::reference_wrapper<const AppRegistryEndpointProviderEndpointTestCase::OperationParamsFromTest>>
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         AppRegistryEndpointProviderTests,
