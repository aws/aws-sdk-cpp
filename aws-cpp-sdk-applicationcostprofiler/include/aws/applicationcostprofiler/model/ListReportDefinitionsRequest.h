...
namespace Model
{
  ...
  /**
   */
  class ListReportDefinitionsRequest : public ApplicationCostProfilerRequest
  {
  public:
    AWS_APPLICATIONCOSTPROFILER_API ListReportDefinitionsRequest();
    ...
    AWS_APPLICATIONCOSTPROFILER_API void AddQueryStringParameters(Aws::Http::URI& uri) const override;
