...
namespace Model
{
  ...
  /**
   */
  class AWS_APPLICATIONCOSTPROFILER_API UpdateReportDefinitionRequest : public ApplicationCostProfilerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateReportDefinitionRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateReportDefinitionRequest>(GetServiceRequestName(), *this);
    }
