...
namespace ApplicationCostProfiler
{
  ...
  class AWS_APPLICATIONCOSTPROFILER_API ApplicationCostProfilerClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        ApplicationCostProfilerClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                      std::shared_ptr<Endpoint::ApplicationCostProfilerEndpointProvider> endpointProvider = Aws::MakeShared<ApplicationCostProfiler::Endpoint::ApplicationCostProfilerEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::ApplicationCostProfilerEndpointProvider> m_endpointProvider;
  };
