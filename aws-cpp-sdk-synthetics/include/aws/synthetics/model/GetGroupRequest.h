...
namespace Model
{
  ...
  /**
   */
  class AWS_SYNTHETICS_API GetGroupRequest : public SyntheticsRequest
  {
  public:
    GetGroupRequest();
    ...
    */
    virtual Aws::UniquePtr<GetGroupRequest> Clone() const
    {
      return Aws::MakeUnique<GetGroupRequest>(GetServiceRequestName(), *this);
    }
