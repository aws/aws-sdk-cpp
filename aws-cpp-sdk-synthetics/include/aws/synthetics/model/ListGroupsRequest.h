...
namespace Model
{
  ...
  /**
   */
  class AWS_SYNTHETICS_API ListGroupsRequest : public SyntheticsRequest
  {
  public:
    ListGroupsRequest();
    ...
    */
    virtual Aws::UniquePtr<ListGroupsRequest> Clone() const
    {
      return Aws::MakeUnique<ListGroupsRequest>(GetServiceRequestName(), *this);
    }
