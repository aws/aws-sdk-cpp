...
namespace Model
{
  ...
  /**
   */
  class AWS_SYNTHETICS_API AssociateResourceRequest : public SyntheticsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateResourceRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateResourceRequest>(GetServiceRequestName(), *this);
    }
