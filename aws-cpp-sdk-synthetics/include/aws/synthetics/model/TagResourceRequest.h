...
namespace Model
{
  ...
  /**
   */
  class TagResourceRequest : public SyntheticsRequest
  {
  public:
    AWS_SYNTHETICS_API TagResourceRequest();
    ...
    /**
     * <p>The ARN of the canary or group that you're adding tags to.</p> <p>The ARN
