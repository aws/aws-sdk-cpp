...
namespace Synthetics
{
  ...
  class AWS_SYNTHETICS_API SyntheticsClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        SyntheticsClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                         std::shared_ptr<Endpoint::SyntheticsEndpointProvider> endpointProvider = Aws::MakeShared<Synthetics::Endpoint::SyntheticsEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::SyntheticsEndpointProvider> m_endpointProvider;
  };
