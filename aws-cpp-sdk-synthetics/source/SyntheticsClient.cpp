...
using ResolveEndpointOutcome = Aws::Synthetics::Endpoint::SyntheticsEndpointProvider::SyntheticsResolveEndpointOutcome;
...
SyntheticsClient::SyntheticsClient(const Client::ClientConfiguration& clientConfiguration,
                                   std::shared_ptr<Endpoint::SyntheticsEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<SyntheticsErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<Synthetics::Endpoint::SyntheticsEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
