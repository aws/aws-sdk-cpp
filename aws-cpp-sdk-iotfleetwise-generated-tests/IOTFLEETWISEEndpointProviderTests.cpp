...
using IoTFleetWiseResolveEndpointOutcome = Aws::IoTFleetWise::Endpoint::IoTFleetWiseEndpointProvider::IoTFleetWiseResolveEndpointOutcome;
...
static const Aws::Vector<IoTFleetWiseEndpointProviderEndpointTestCase> TEST_CASES = {
  ...
  {"For region eu-central-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://iotfleetwise-fips.eu-central-1.api.aws",
       {/*properties*/},
  ...
  {"For region eu-central-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://iotfleetwise-fips.eu-central-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-central-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://iotfleetwise.eu-central-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
...
void ValidateOutcome(const IoTFleetWiseResolveEndpointOutcome& outcome, const IoTFleetWiseEndpointProviderEndpointTestCase::Expect& expect)
{
