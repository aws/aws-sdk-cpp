...
DescribeEventsResult::DescribeEventsResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

DescribeEventsResult& DescribeEventsResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
