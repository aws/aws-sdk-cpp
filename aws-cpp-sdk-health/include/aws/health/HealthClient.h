...
namespace Health
{
  ...
  class AWS_HEALTH_API HealthClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        HealthClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                     std::shared_ptr<Endpoint::HealthEndpointProvider> endpointProvider = Aws::MakeShared<Health::Endpoint::HealthEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::HealthEndpointProvider> m_endpointProvider;
  };
