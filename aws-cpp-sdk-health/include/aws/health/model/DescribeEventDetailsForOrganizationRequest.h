...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeEventDetailsForOrganizationRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeEventDetailsForOrganizationRequest>(GetServiceRequestName(), *this);
    }
