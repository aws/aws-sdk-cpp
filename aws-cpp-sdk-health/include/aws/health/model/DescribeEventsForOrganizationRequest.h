...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeEventsForOrganizationRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeEventsForOrganizationRequest>(GetServiceRequestName(), *this);
    }
