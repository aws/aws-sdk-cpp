...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeAffectedEntitiesForOrganizationRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeAffectedEntitiesForOrganizationRequest>(GetServiceRequestName(), *this);
    }
