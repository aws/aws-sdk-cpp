...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeAffectedAccountsForOrganizationRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeAffectedAccountsForOrganizationRequest>(GetServiceRequestName(), *this);
    }
