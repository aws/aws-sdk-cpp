...
Aws::String AugmentedAIRuntimeEndpointRules::GetRulesAsString()
{
    return Aws::String(AugmentedAIRuntimeEndpointRules::Rules.begin(), AugmentedAIRuntimeEndpointRules::Rules.end());
}

const Aws::Vector<char> AugmentedAIRuntimeEndpointRules::Rules = {
...
'2','i','-','r','u','n','t','i','m','e','.','s','a','g','e','m','a','k','e','r','-','f','i','p','s',
...
'h','t','t','p','s',':','/','/','a','2','i','-','r','u','n','t','i','m','e','.','s','a','g','e','m',
