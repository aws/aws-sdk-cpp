...
namespace Model
{
  ...
  /**
   */
  class AWS_AUGMENTEDAIRUNTIME_API StopHumanLoopRequest : public AugmentedAIRuntimeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StopHumanLoopRequest> Clone() const
    {
      return Aws::MakeUnique<StopHumanLoopRequest>(GetServiceRequestName(), *this);
    }
