...
namespace AugmentedAIRuntime
{
  ...
  class AWS_AUGMENTEDAIRUNTIME_API AugmentedAIRuntimeClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        AugmentedAIRuntimeClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                 std::shared_ptr<Endpoint::AugmentedAIRuntimeEndpointProvider> endpointProvider = Aws::MakeShared<AugmentedAIRuntime::Endpoint::AugmentedAIRuntimeEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::AugmentedAIRuntimeEndpointProvider> m_endpointProvider;
  };
