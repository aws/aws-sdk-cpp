...
namespace Support
{
const size_t SupportEndpointRules::RulesBlobStrLen = 5029;
const size_t SupportEndpointRules::RulesBlobSize = 5030;
...
const char* SupportEndpointRules::GetRulesBlob()
{
