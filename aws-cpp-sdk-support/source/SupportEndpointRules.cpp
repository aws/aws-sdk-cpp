...
Aws::String SupportEndpointRules::GetRulesAsString()
{
    return Aws::String(SupportEndpointRules::Rules.begin(), SupportEndpointRules::Rules.end());
}

const Aws::Vector<char> SupportEndpointRules::Rules = {
...
'u','r','l','"',':','"','h','t','t','p','s',':','/','/','s','u','p','p','o','r','t','.','u','s','-',
