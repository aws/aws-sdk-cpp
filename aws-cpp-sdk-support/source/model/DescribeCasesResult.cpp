...
DescribeCasesResult::DescribeCasesResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

DescribeCasesResult& DescribeCasesResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
