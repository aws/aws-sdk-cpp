...
DescribeServicesResult::DescribeServicesResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

DescribeServicesResult& DescribeServicesResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
