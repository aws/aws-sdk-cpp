...
using ResolveEndpointOutcome = Aws::Support::Endpoint::SupportEndpointProvider::SupportResolveEndpointOutcome;
...
SupportClient::SupportClient(const Client::ClientConfiguration& clientConfiguration,
                             std::shared_ptr<Endpoint::SupportEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<SupportErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<Support::Endpoint::SupportEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
