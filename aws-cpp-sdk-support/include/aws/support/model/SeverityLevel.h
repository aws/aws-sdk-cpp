...
namespace Model
{
  ...
  public:
     ...
     * that appear in the AWS Support Center. For example, the API uses the code
     * <code>low</code>, but the name appears as General guidance in Support Center.
     * </p> <p>The following are the API code names and how they appear in the
