...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeTrustedAdvisorChecksRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeTrustedAdvisorChecksRequest>(GetServiceRequestName(), *this);
    }
