...
namespace Model
{
  ...
  public:
     ...
     * can use the <a>DescribeSeverityLevels</a> operation to get the possible values
    ...
    /**
     * <p>A list of email addresses that AWS Support copies on case correspondence. AWS
     ...
     * href="http://aws.amazon.com/tools/">AWS SDKs</a>. </p>
     */
    ...
    /**
     * <p>The language in which AWS Support handles the case. You must specify the ISO
     * 639-1 code for the <code>language</code> parameter if you want support in that
     * language. Currently, English ("en") and Japanese ("ja") are supported.</p>
     */
