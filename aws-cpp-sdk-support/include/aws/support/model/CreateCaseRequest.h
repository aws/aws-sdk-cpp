...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateCaseRequest> Clone() const
    {
      return Aws::MakeUnique<CreateCaseRequest>(GetServiceRequestName(), *this);
    }
    ...
    /**
     * <p>The language in which Amazon Web Services Support handles the case. You must
     * specify the ISO 639-1 code for the <code>language</code> parameter if you want
     * support in that language. Currently, English ("en") and Japanese ("ja") are
     * supported.</p>
     */
