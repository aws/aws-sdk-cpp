...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeTrustedAdvisorCheckResultRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeTrustedAdvisorCheckResultRequest>(GetServiceRequestName(), *this);
    }
