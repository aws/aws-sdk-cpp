...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeTrustedAdvisorCheckRefreshStatusesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeTrustedAdvisorCheckRefreshStatusesRequest>(GetServiceRequestName(), *this);
    }
