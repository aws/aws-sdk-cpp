...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeTrustedAdvisorCheckSummariesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeTrustedAdvisorCheckSummariesRequest>(GetServiceRequestName(), *this);
    }
