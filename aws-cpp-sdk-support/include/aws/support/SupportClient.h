...
namespace Support
{
  ...
  class AWS_SUPPORT_API SupportClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        SupportClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                      std::shared_ptr<Endpoint::SupportEndpointProvider> endpointProvider = Aws::MakeShared<Support::Endpoint::SupportEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::SupportEndpointProvider> m_endpointProvider;
  };
