...
using DeviceFarmResolveEndpointOutcome = Aws::DeviceFarm::Endpoint::DeviceFarmEndpointProvider::DeviceFarmResolveEndpointOutcome;
...
void ValidateOutcome(const DeviceFarmResolveEndpointOutcome& outcome, const DeviceFarmEndpointProviderEndpointTestCase::Expect& expect)
{
