...
namespace RDSDataService
{
  ...
  class AWS_RDSDATASERVICE_API RDSDataServiceClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        RDSDataServiceClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                             std::shared_ptr<Endpoint::RDSDataServiceEndpointProvider> endpointProvider = Aws::MakeShared<RDSDataService::Endpoint::RDSDataServiceEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::RDSDataServiceEndpointProvider> m_endpointProvider;
  };
