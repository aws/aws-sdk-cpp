...
Aws::String RDSDataServiceEndpointRules::GetRulesAsString()
{
    return Aws::String(RDSDataServiceEndpointRules::Rules.begin(), RDSDataServiceEndpointRules::Rules.end());
}

const Aws::Vector<char> RDSDataServiceEndpointRules::Rules = {
...
'"',':','"','h','t','t','p','s',':','/','/','r','d','s','-','d','a','t','a','-','f','i','p','s','.',
...
't','t','p','s',':','/','/','r','d','s','-','d','a','t','a','.','{','R','e','g','i','o','n','}','.',
