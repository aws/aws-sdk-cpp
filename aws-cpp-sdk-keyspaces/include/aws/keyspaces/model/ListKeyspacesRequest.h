...
namespace Model
{
  ...
  /**
   */
  class AWS_KEYSPACES_API ListKeyspacesRequest : public KeyspacesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListKeyspacesRequest> Clone() const
    {
      return Aws::MakeUnique<ListKeyspacesRequest>(GetServiceRequestName(), *this);
    }
