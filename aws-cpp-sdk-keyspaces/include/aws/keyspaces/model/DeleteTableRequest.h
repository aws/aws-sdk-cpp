...
namespace Model
{
  ...
  /**
   */
  class AWS_KEYSPACES_API DeleteTableRequest : public KeyspacesRequest
  {
  public:
    DeleteTableRequest();
    ...
    */
    virtual Aws::UniquePtr<DeleteTableRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteTableRequest>(GetServiceRequestName(), *this);
    }
