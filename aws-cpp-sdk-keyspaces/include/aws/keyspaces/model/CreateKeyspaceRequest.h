...
namespace Model
{
  ...
  /**
   */
  class AWS_KEYSPACES_API CreateKeyspaceRequest : public KeyspacesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateKeyspaceRequest> Clone() const
    {
      return Aws::MakeUnique<CreateKeyspaceRequest>(GetServiceRequestName(), *this);
    }
