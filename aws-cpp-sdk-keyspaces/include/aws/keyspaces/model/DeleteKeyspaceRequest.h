...
namespace Model
{
  ...
  /**
   */
  class AWS_KEYSPACES_API DeleteKeyspaceRequest : public KeyspacesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteKeyspaceRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteKeyspaceRequest>(GetServiceRequestName(), *this);
    }
