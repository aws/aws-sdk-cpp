...
namespace Model
{
  ...
  /**
   */
  class AWS_KEYSPACES_API ListTablesRequest : public KeyspacesRequest
  {
  public:
    ListTablesRequest();
    ...
    */
    virtual Aws::UniquePtr<ListTablesRequest> Clone() const
    {
      return Aws::MakeUnique<ListTablesRequest>(GetServiceRequestName(), *this);
    }
