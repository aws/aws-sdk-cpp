...
namespace Keyspaces
{
  ...
  class AWS_KEYSPACES_API KeyspacesClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        KeyspacesClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                        std::shared_ptr<Endpoint::KeyspacesEndpointProvider> endpointProvider = Aws::MakeShared<Keyspaces::Endpoint::KeyspacesEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::KeyspacesEndpointProvider> m_endpointProvider;
  };
