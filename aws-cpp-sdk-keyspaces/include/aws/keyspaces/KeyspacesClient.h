...
namespace Model
{
   ...
   * in detail. &lt;/p&gt; &lt;note&gt; &lt;p&gt;For the list of all supported CQL
   * APIs, see &lt;a
   ...
   * &lt;i&gt;Amazon Keyspaces Developer Guide&lt;/i&gt;.&lt;/p&gt; &lt;p&gt;For more
   * information about Amazon Web Services APIs, for example how to implement retry
   * logic or how to sign Amazon Web Services API requests, see &lt;a
    ...
    public:
      typedef Aws::Client::AWSJsonClient BASECLASS;
        ...
        */
         ...
         * status, the keyspace name, configuration settings, and metadata.</p><p><h3>See
         * Also:</h3>   <a
         ...
         * Console for cost allocation tracking.</p> <p>For more information, see <a
