...
static const char* ALLOCATION_TAG = "AWSOrganizationsEndpointProviderTests";
using OrganizationsEndpointProvider = Aws::Organizations::Endpoint::OrganizationsEndpointProvider;
using EndpointParameters = Aws::Vector<Aws::Endpoint::EndpointParameter>;
using OrganizationsResolveEndpointOutcome = Aws::Organizations::Endpoint::OrganizationsEndpointProvider::OrganizationsResolveEndpointOutcome;
...
class OrganizationsEndpointProviderTests :public ::testing::TestWithParam<size_t>
{
public:
...
struct OrganizationsEndpointProviderEndpointTestCase
{
...
static const Aws::Vector<OrganizationsEndpointProviderEndpointTestCase> TEST_CASES = {
  /*TEST CASE 0*/
  {"For region aws-cn-global with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://organizations.cn-northwest-1.amazonaws.com.cn",
       {/*properties*/{"authSchemes", {EpProp("signingRegion", "cn-northwest-1"), EpProp("name", "sigv4"), EpProp("signingName", "organizations")}}},
  ...
  {"For region aws-global with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://organizations.us-east-1.amazonaws.com",
       {/*properties*/{"authSchemes", {EpProp("signingRegion", "us-east-1"), EpProp("name", "sigv4"), EpProp("signingName", "organizations")}}},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  /*TEST CASE 2*/
  {"For region aws-us-gov-global with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://organizations.us-gov-west-1.amazonaws.com",
       {/*properties*/{"authSchemes", {EpProp("signingRegion", "us-gov-west-1"), EpProp("name", "sigv4"), EpProp("signingName", "organizations")}}},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  /*TEST CASE 3*/
...
void ValidateOutcome(const OrganizationsResolveEndpointOutcome& outcome, const OrganizationsEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(OrganizationsEndpointProviderTests, EndpointProviderTest)
{
    ...
    const OrganizationsEndpointProviderEndpointTestCase& TEST_CASE = TEST_CASES.at(TEST_CASE_IDX);
    SCOPED_TRACE(Aws::String("\nTEST CASE # ") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX) + ": " + TEST_CASE.documentation);

    std::shared_ptr<OrganizationsEndpointProvider> endpointProvider = Aws::MakeShared<OrganizationsEndpointProvider>(ALLOCATION_TAG);
    ASSERT_TRUE(endpointProvider) << "Failed to allocate/initialize OrganizationsEndpointProvider";
    ...
    for(const auto& operation : TEST_CASE.operationInput)
    {
         ...
         */
        const Aws::Vector<std::reference_wrapper<const OrganizationsEndpointProviderEndpointTestCase::OperationParamsFromTest>>
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         OrganizationsEndpointProviderTests,
