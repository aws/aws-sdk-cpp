...
namespace Model
{
  ...
  /**
   */
  class AWS_RESOURCEEXPLORER2_API SearchRequest : public ResourceExplorer2Request
  {
  public:
    SearchRequest();
    ...
    */
    virtual Aws::UniquePtr<SearchRequest> Clone() const
    {
      return Aws::MakeUnique<SearchRequest>(GetServiceRequestName(), *this);
    }
