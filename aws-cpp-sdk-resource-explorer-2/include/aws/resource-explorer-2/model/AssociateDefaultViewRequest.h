...
namespace Model
{
  ...
  /**
   */
  class AWS_RESOURCEEXPLORER2_API AssociateDefaultViewRequest : public ResourceExplorer2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateDefaultViewRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateDefaultViewRequest>(GetServiceRequestName(), *this);
    }
