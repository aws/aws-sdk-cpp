...
namespace Model
{
  ...
  /**
   */
  class AWS_RESOURCEEXPLORER2_API DeleteViewRequest : public ResourceExplorer2Request
  {
  public:
    DeleteViewRequest();
    ...
    */
    virtual Aws::UniquePtr<DeleteViewRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteViewRequest>(GetServiceRequestName(), *this);
    }
