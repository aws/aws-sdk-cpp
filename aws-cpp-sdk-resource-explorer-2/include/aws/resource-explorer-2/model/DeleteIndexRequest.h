...
namespace Model
{
  ...
  /**
   */
  class AWS_RESOURCEEXPLORER2_API DeleteIndexRequest : public ResourceExplorer2Request
  {
  public:
    DeleteIndexRequest();
    ...
    */
    virtual Aws::UniquePtr<DeleteIndexRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteIndexRequest>(GetServiceRequestName(), *this);
    }
