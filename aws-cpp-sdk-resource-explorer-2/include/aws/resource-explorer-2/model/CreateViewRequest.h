...
namespace Model
{
  ...
  /**
   */
  class AWS_RESOURCEEXPLORER2_API CreateViewRequest : public ResourceExplorer2Request
  {
  public:
    CreateViewRequest();
    ...
    */
    virtual Aws::UniquePtr<CreateViewRequest> Clone() const
    {
      return Aws::MakeUnique<CreateViewRequest>(GetServiceRequestName(), *this);
    }
