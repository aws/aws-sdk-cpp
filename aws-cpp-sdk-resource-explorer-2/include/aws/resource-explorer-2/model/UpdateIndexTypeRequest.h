...
namespace Model
{
  ...
  /**
   */
  class AWS_RESOURCEEXPLORER2_API UpdateIndexTypeRequest : public ResourceExplorer2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateIndexTypeRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateIndexTypeRequest>(GetServiceRequestName(), *this);
    }
