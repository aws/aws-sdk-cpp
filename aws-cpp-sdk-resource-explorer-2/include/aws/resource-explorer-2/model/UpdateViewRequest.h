...
namespace Model
{
  ...
  /**
   */
  class AWS_RESOURCEEXPLORER2_API UpdateViewRequest : public ResourceExplorer2Request
  {
  public:
    UpdateViewRequest();
    ...
    */
    virtual Aws::UniquePtr<UpdateViewRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateViewRequest>(GetServiceRequestName(), *this);
    }
