...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_RESOURCEEXPLORER2_API ResourceProperty
  {
  public:
    ResourceProperty();
    ResourceProperty(Aws::Utils::Json::JsonView jsonValue);
    ResourceProperty& operator=(Aws::Utils::Json::JsonView jsonValue);
