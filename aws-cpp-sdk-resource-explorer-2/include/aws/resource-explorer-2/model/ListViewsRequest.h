...
namespace Model
{
  ...
  /**
   */
  class AWS_RESOURCEEXPLORER2_API ListViewsRequest : public ResourceExplorer2Request
  {
  public:
    ListViewsRequest();
    ...
    */
    virtual Aws::UniquePtr<ListViewsRequest> Clone() const
    {
      return Aws::MakeUnique<ListViewsRequest>(GetServiceRequestName(), *this);
    }
