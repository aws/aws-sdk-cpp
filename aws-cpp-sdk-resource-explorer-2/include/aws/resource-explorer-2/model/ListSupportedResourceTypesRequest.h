...
namespace Model
{
  ...
  /**
   */
  class AWS_RESOURCEEXPLORER2_API ListSupportedResourceTypesRequest : public ResourceExplorer2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListSupportedResourceTypesRequest> Clone() const
    {
      return Aws::MakeUnique<ListSupportedResourceTypesRequest>(GetServiceRequestName(), *this);
    }
     ...
     * the output should continue from.</p>
     */
    inline ListSupportedResourceTypesRequest& WithNextToken(const Aws::String& value) { SetNextToken(value); return *this;}
     ...
     * the output should continue from.</p>
     */
    inline ListSupportedResourceTypesRequest& WithNextToken(Aws::String&& value) { SetNextToken(std::move(value)); return *this;}
     ...
     * the output should continue from.</p>
     */
    inline ListSupportedResourceTypesRequest& WithNextToken(const char* value) { SetNextToken(value); return *this;}
