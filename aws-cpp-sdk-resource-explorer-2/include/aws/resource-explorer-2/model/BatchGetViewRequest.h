...
namespace Model
{
  ...
  /**
   */
  class AWS_RESOURCEEXPLORER2_API BatchGetViewRequest : public ResourceExplorer2Request
  {
  public:
    BatchGetViewRequest();
    ...
    */
    virtual Aws::UniquePtr<BatchGetViewRequest> Clone() const
    {
      return Aws::MakeUnique<BatchGetViewRequest>(GetServiceRequestName(), *this);
    }
