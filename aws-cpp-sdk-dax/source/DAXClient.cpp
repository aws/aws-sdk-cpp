...
using ResolveEndpointOutcome = Aws::DAX::Endpoint::DAXEndpointProvider::DAXResolveEndpointOutcome;
...
DAXClient::DAXClient(const Client::ClientConfiguration& clientConfiguration,
                     std::shared_ptr<Endpoint::DAXEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<DAXErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<DAX::Endpoint::DAXEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
