...
Aws::String DAXEndpointRules::GetRulesAsString()
{
    return Aws::String(DAXEndpointRules::Rules.begin(), DAXEndpointRules::Rules.end());
}

const Aws::Vector<char> DAXEndpointRules::Rules = {
...
'u','r','l','"',':','"','h','t','t','p','s',':','/','/','d','a','x','.','{','R','e','g','i','o','n',
