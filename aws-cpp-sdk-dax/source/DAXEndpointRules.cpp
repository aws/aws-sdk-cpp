...
namespace DAX
{
const size_t DAXEndpointRules::RulesBlobStrLen = 3442;
const size_t DAXEndpointRules::RulesBlobSize = 3443;

using RulesBlobT = Aws::Array<const char, DAXEndpointRules::RulesBlobSize>;
...
'"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','d','a','x','.','{','R','e','g','i','o',
...
const char* DAXEndpointRules::GetRulesBlob()
{
