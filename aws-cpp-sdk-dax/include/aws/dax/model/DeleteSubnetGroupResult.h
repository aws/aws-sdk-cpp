...
namespace Model
{
  ...
  public:
    ...
    DeleteSubnetGroupResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    DeleteSubnetGroupResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
