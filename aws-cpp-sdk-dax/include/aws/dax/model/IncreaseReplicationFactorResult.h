...
namespace Model
{
  ...
  public:
    ...
    IncreaseReplicationFactorResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    IncreaseReplicationFactorResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
