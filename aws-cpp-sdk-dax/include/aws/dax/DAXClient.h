...
namespace DAX
{
  ...
  class AWS_DAX_API DAXClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        DAXClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                  std::shared_ptr<Endpoint::DAXEndpointProvider> endpointProvider = Aws::MakeShared<DAX::Endpoint::DAXEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::DAXEndpointProvider> m_endpointProvider;
  };
