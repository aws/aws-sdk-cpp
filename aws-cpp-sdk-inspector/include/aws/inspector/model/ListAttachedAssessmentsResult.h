...
namespace Model
{
  class AWS_INSPECTOR_API ListAttachedAssessmentsResult
  {
  public:
    ListAttachedAssessmentsResult();
    ListAttachedAssessmentsResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ListAttachedAssessmentsResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
     ...
     * <p>A list of ARNs specifying the assessments returned by the action.</p>
     */
    inline ListAttachedAssessmentsResult& WithAssessmentArnList(const Aws::Vector<Aws::String>& value) { SetAssessmentArnList(value); return *this;}
     ...
     * <p>A list of ARNs specifying the assessments returned by the action.</p>
     */
    inline ListAttachedAssessmentsResult& AddAssessmentArnList(const Aws::String& value) { m_assessmentArnList.push_back(value); return *this; }
     ...
     * <p>A list of ARNs specifying the assessments returned by the action.</p>
     */
    inline ListAttachedAssessmentsResult& AddAssessmentArnList(const char* value) { m_assessmentArnList.push_back(value); return *this; }
     ...
     * more data to be listed, this parameter is set to 'null'.</p>
     */
    inline ListAttachedAssessmentsResult& WithNextToken(const Aws::String& value) { SetNextToken(value); return *this;}
     ...
     * more data to be listed, this parameter is set to 'null'.</p>
     */
    inline ListAttachedAssessmentsResult& WithNextToken(const char* value) { SetNextToken(value); return *this;}
