...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_INSPECTOR_API NoSuchEntityException
  {
  public:
    NoSuchEntityException();
    NoSuchEntityException(Aws::Utils::Json::JsonView jsonValue);
    NoSuchEntityException& operator=(Aws::Utils::Json::JsonView jsonValue);
