...
namespace Model
{
  ...
  /**
   */
  class AWS_INSPECTOR_API PreviewAgentsRequest : public InspectorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PreviewAgentsRequest> Clone() const
    {
      return Aws::MakeUnique<PreviewAgentsRequest>(GetServiceRequestName(), *this);
    }
