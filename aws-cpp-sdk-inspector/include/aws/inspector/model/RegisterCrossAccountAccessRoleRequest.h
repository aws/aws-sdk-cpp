...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<RegisterCrossAccountAccessRoleRequest> Clone() const
    {
      return Aws::MakeUnique<RegisterCrossAccountAccessRoleRequest>(GetServiceRequestName(), *this);
    }
