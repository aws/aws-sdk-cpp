...
namespace Model
{
  ...
  public:
    ...
    ListAssessmentTargetsResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ListAssessmentTargetsResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
