...
namespace Model
{
  ...
  /**
   */
  class AWS_INSPECTOR_API UnsubscribeFromEventRequest : public InspectorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UnsubscribeFromEventRequest> Clone() const
    {
      return Aws::MakeUnique<UnsubscribeFromEventRequest>(GetServiceRequestName(), *this);
    }
