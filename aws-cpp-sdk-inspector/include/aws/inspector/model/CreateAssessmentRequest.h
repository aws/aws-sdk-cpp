...
namespace Model
{
  ...
  public:
     ...
     * assessment.</p>
     */
    inline CreateAssessmentRequest& WithApplicationArn(Aws::String&& value) { SetApplicationArn(std::move(value)); return *this;}
     ...
     * corresponding to a particular application must be unique.</p>
     */
    inline CreateAssessmentRequest& WithAssessmentName(Aws::String&& value) { SetAssessmentName(std::move(value)); return *this;}
     ...
     * running this assessment.</p>
     */
    inline CreateAssessmentRequest& WithUserAttributesForFindings(Aws::Vector<Attribute>&& value) { SetUserAttributesForFindings(std::move(value)); return *this;}
     ...
     * running this assessment.</p>
     */
    inline CreateAssessmentRequest& AddUserAttributesForFindings(Attribute&& value) { m_userAttributesForFindingsHasBeenSet = true; m_userAttributesForFindings.push_back(std::move(value)); return *this; }
