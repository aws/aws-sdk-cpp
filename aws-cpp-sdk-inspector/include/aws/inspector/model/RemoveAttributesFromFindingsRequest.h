...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<RemoveAttributesFromFindingsRequest> Clone() const
    {
      return Aws::MakeUnique<RemoveAttributesFromFindingsRequest>(GetServiceRequestName(), *this);
    }
