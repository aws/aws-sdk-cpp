...
namespace Model
{
  ...
  public:
     ...
     * <p>A list of ARNs specifying the assessments returned by the action.</p>
     */
    inline ListAssessmentsResult& WithAssessmentArnList(Aws::Vector<Aws::String>&& value) { SetAssessmentArnList(std::move(value)); return *this;}
     ...
     * <p>A list of ARNs specifying the assessments returned by the action.</p>
     */
    inline ListAssessmentsResult& AddAssessmentArnList(Aws::String&& value) { m_assessmentArnList.push_back(std::move(value)); return *this; }
