...
namespace Model
{
  ...
  /**
   */
  class AWS_INSPECTOR_API ListAssessmentsRequest : public InspectorRequest
  {
  public:
     ...
     * to list.</p>
     */
    inline ListAssessmentsRequest& WithApplicationArns(const Aws::Vector<Aws::String>& value) { SetApplicationArns(value); return *this;}
     ...
     * to list.</p>
     */
    inline ListAssessmentsRequest& AddApplicationArns(const Aws::String& value) { m_applicationArnsHasBeenSet = true; m_applicationArns.push_back(value); return *this; }
     ...
     * to list.</p>
     */
    inline ListAssessmentsRequest& AddApplicationArns(const char* value) { m_applicationArnsHasBeenSet = true; m_applicationArns.push_back(value); return *this; }
     ...
     * attribute, any of the values can match.</p>
     */
    inline ListAssessmentsRequest& WithFilter(const AssessmentsFilter& value) { SetFilter(value); return *this;}
     ...
     * parameter to 'null' on your first call to the <b>ListAssessments</b> action.
     ...
     * in the response. The default value is 10. The maximum value is 500.</p>
     */
    inline ListAssessmentsRequest& WithMaxResults(long value) { SetMaxResults(value); return *this;}
