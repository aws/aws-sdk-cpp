...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeAssessmentTemplatesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeAssessmentTemplatesRequest>(GetServiceRequestName(), *this);
    }
