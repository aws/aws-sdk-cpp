...
namespace Model
{
  ...
  public:
     ...
     * package.</p>
     */
    inline AttachAssessmentAndRulesPackageRequest& WithAssessmentArn(Aws::String&& value) { SetAssessmentArn(std::move(value)); return *this;}
     ...
     * assessment.</p>
     */
    inline AttachAssessmentAndRulesPackageRequest& WithRulesPackageArn(Aws::String&& value) { SetRulesPackageArn(std::move(value)); return *this;}
