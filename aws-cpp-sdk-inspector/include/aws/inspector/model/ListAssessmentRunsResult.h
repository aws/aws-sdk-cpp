...
namespace Model
{
  ...
  public:
    ...
    ListAssessmentRunsResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ListAssessmentRunsResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
