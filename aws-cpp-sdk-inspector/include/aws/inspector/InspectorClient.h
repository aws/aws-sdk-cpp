...
namespace Inspector
{
  ...
  class AWS_INSPECTOR_API InspectorClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        InspectorClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                        std::shared_ptr<Endpoint::InspectorEndpointProvider> endpointProvider = Aws::MakeShared<Inspector::Endpoint::InspectorEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::InspectorEndpointProvider> m_endpointProvider;
  };
