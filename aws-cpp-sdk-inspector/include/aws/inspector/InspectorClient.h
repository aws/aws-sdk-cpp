    ...
    public:
      typedef Aws::Client::AWSJsonClient BASECLASS;
        ...
        */
         ...
         * generated by <a>CreateResourceGroup</a>. You can create up to 50 assessment
         ...
         * the ARN of the assessment target.</p><p><h3>See Also:</h3>   <a
        ...
        /**
         * <p>Registers the IAM role that Amazon Inspector uses to list your EC2 instances
         * at the start of the assessment run or when you call the <a>PreviewAgents</a>
