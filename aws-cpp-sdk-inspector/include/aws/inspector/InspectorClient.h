    ...
    public:
      typedef Aws::Client::AWSJsonClient BASECLASS;
        ...
        */
         ...
         * generated by <a>CreateResourceGroup</a>. If the <a
         * href="https://docs.aws.amazon.com/inspector/latest/userguide/inspector_slr.html">service-linked
         * role</a> isn’t already registered, also creates and registers a service-linked
         * role to grant Amazon Inspector access to AWS Services needed to perform security
         * assessments. You can create up to 50 assessment targets per AWS account. You can
         * run up to 500 concurrent agents per AWS account. For more information, see <a
         ...
         * role</a> isn’t already registered, also creates and registers a service-linked
         * role to grant Amazon Inspector access to AWS Services needed to perform security
         * assessments.</p><p><h3>See Also:</h3>   <a
