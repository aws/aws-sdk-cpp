...
using ResolveEndpointOutcome = Aws::Inspector::Endpoint::InspectorEndpointProvider::InspectorResolveEndpointOutcome;
...
InspectorClient::InspectorClient(const Client::ClientConfiguration& clientConfiguration,
                                 std::shared_ptr<Endpoint::InspectorEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<InspectorErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<Inspector::Endpoint::InspectorEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
