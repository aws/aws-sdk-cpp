...
DescribeFindingsResult::DescribeFindingsResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

DescribeFindingsResult& DescribeFindingsResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
