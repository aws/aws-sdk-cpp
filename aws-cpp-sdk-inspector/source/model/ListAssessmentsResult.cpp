...
ListAssessmentsResult::ListAssessmentsResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListAssessmentsResult& ListAssessmentsResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
