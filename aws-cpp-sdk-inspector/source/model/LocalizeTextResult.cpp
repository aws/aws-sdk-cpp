...
LocalizeTextResult::LocalizeTextResult()
{
}

LocalizeTextResult::LocalizeTextResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

LocalizeTextResult& LocalizeTextResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
