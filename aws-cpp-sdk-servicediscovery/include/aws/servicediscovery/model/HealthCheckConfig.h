...
namespace Model
{
   ...
   * <p>Note the following about configuring health checks.</p> <p> <b>
   * <code>A</code> and <code>AAAA</code> records</b> </p> <p>If
   * <code>DnsConfig</code> includes configurations for both <code>A</code> and
   * <code>AAAA</code> records, AWS Cloud Map creates a health check that uses the
   * IPv4 address to check the health of the resource. If the endpoint that is
   * specified by the IPv4 address is unhealthy, Route 53 considers both the
   * <code>A</code> and <code>AAAA</code> records to be unhealthy. </p> <p> <b>
   * <code>CNAME</code> records</b> </p> <p>You can't specify settings for
