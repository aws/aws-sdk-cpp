...
namespace Model
{
   ...
   * include the <code>AWS_ALIAS_DNS_NAME</code> attribute, Cloud Map creates a Route
   * 53 alias record. Note the following:</p> <ul> <li> <p>Route 53 automatically
   * sets <code>EvaluateTargetHealth</code> to true for alias records. When
