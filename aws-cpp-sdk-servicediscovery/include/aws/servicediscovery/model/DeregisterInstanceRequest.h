...
namespace Model
{
  ...
  /**
   */
  class AWS_SERVICEDISCOVERY_API DeregisterInstanceRequest : public ServiceDiscoveryRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeregisterInstanceRequest> Clone() const
    {
      return Aws::MakeUnique<DeregisterInstanceRequest>(GetServiceRequestName(), *this);
    }
