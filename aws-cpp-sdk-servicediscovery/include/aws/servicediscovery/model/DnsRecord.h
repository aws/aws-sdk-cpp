...
namespace Model
{
   ...
   * Route 53 to create when you register an instance.</p><p><h3>See Also:</h3>   <a
  ...
  public:
     ...
     * <b>A, AAAA, and SRV records: You can specify settings for a maximum of one A,
     * one AAAA, and one SRV record. You can specify them in any combination.</b> </p>
     ...
     * want Route 53 to create an alias record when you register an instance, specify
     * <code>A</code> or <code>AAAA</code> for <code>Type</code>.</p> </li> <li> <p>
     * <b>All records:</b> You specify settings other than <code>TTL</code> and
     * <code>Type</code> when you register an instance.</p> </li> </ul> <p>The
     * following values are supported:</p> <p> <b>A</b> </p> <p>Route 53 returns the IP
     * address of the resource in IPv4 format, such as 192.0.2.44.</p> <p> <b>AAAA</b>
     * </p> <p>Route 53 returns the IP address of the resource in IPv6 format, such as
     * 2001:0db8:85a3:0000:0000:abcd:0001:2345.</p> <p> <b>CNAME</b> </p> <p>Route 53
     * returns the domain name of the resource, such as www.example.com. Note the
     * following:</p> <ul> <li> <p>You specify the domain name that you want to route
     * traffic to when you register an instance. For more information, see
     * <a>RegisterInstanceRequest$Attributes</a>.</p> </li> <li> <p>You must specify
     * <code>WEIGHTED</code> for the value of <code>RoutingPolicy</code>.</p> </li>
     * <li> <p>You can't specify both <code>CNAME</code> for <code>Type</code> and
     * settings for <code>HealthCheckConfig</code>. If you do, the request will fail
     * with an <code>InvalidInput</code> error.</p> </li> </ul> <p> <b>SRV</b> </p>
     * <p>Route 53 returns the value for an SRV record. The value for an SRV record
     * uses the following values:</p> <p> <code>priority weight port
     * service-hostname</code> </p> <p>Note the following about the values:</p> <ul>
     * <li> <p>The values of <code>priority</code> and <code>weight</code> are both set
     * to <code>1</code> and can't be changed. </p> </li> <li> <p>The value of
     * <code>port</code> comes from the value that you specify for the
     * <code>AWS_INSTANCE_PORT</code> attribute when you submit a
     * <a>RegisterInstance</a> request. </p> </li> <li> <p>The value of
     ...
     * <code>RegisterInstance</code> request, Route 53 automatically creates
