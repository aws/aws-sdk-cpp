...
namespace Model
{
  ...
  /**
   */
  class AWS_SERVICEDISCOVERY_API UpdatePublicDnsNamespaceRequest : public ServiceDiscoveryRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdatePublicDnsNamespaceRequest> Clone() const
    {
      return Aws::MakeUnique<UpdatePublicDnsNamespaceRequest>(GetServiceRequestName(), *this);
    }
