...
namespace Model
{
  ...
  public:
     ...
     * more than <code>MaxResults</code> namespaces match the specified criteria, you
     * can submit another <code>ListNamespaces</code> request to get the next group of
    ...
    /**
     * <p>The maximum number of namespaces that you want Amazon Route 53 to return in
     * the response to a <code>ListNamespaces</code> request. If you don't specify a
     ...
     * to list.</p> <p>If you specify more than one filter, an operation must match all
     * filters to be returned by ListNamespaces.</p>
     */
