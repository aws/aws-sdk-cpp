...
namespace Model
{
  ...
  public:
     ...
     * more than <code>MaxResults</code> operations match the specified criteria, you
     * can submit another <code>ListOperations</code> request to get the next group of
    ...
    /**
     * <p>The maximum number of items that you want Amazon Route 53 to return in the
     * response to a <code>ListOperations</code> request. If you don't specify a value
     * for <code>MaxResults</code>, Amazon Route 53 returns up to 100 operations.</p>
     */
