...
namespace Model
{
  ...
  /**
   * <p>A complex type that contains information about changes to the resource record
   * sets that Amazon Route 53 creates when you register an instance.</p><p><h3>See
   * Also:</h3>   <a
  ...
  public:
    DnsConfigChange();
    DnsConfigChange(const Aws::Utils::Json::JsonValue& jsonValue);
    DnsConfigChange& operator=(const Aws::Utils::Json::JsonValue& jsonValue);
