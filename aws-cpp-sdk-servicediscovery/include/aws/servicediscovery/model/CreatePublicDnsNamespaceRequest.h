...
namespace Model
{
  ...
  /**
   */
  class AWS_SERVICEDISCOVERY_API CreatePublicDnsNamespaceRequest : public ServiceDiscoveryRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreatePublicDnsNamespaceRequest> Clone() const
    {
      return Aws::MakeUnique<CreatePublicDnsNamespaceRequest>(GetServiceRequestName(), *this);
    }
