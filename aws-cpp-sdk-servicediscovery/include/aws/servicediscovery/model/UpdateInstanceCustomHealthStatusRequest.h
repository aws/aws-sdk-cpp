...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateInstanceCustomHealthStatusRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateInstanceCustomHealthStatusRequest>(GetServiceRequestName(), *this);
    }
