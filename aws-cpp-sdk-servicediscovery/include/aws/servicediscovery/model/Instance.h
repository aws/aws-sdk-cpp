...
namespace Model
{
  ...
  public:
     ...
     * is specified by <code>ServiceId</code> must include settings for an
     * <code>A</code> record, an <code>AAAA</code> record, or both.</p> </li> <li>
     ...
     * <code>HealthCheckConfig</code> settings, AWS Cloud Map will create the health
     * check, but it won't associate the health check with the alias record.</p> </li>
     * <li> <p>Auto naming currently doesn't support creating alias records that route
     * traffic to AWS resources other than ELB load balancers.</p> </li> <li> <p>If you
     * specify a value for <code>AWS_ALIAS_DNS_NAME</code>, don't specify values for
     * any of the <code>AWS_INSTANCE</code> attributes.</p> </li> </ul> <p>
     * <b>AWS_EC2_INSTANCE_ID</b> </p> <p> <i>HTTP namespaces only.</i> The Amazon EC2
     * instance ID for the instance. The <code>AWS_INSTANCE_IPV4</code> attribute
     * contains the primary private IPv4 address.</p> <p> <b>AWS_INSTANCE_CNAME</b>
     * </p> <p>If the service configuration includes a <code>CNAME</code> record, the
     * domain name that you want Route 53 to return in response to DNS queries, for
     * example, <code>example.com</code>.</p> <p>This value is required if the service
