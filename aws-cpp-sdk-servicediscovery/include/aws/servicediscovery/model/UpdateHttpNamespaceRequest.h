...
namespace Model
{
  ...
  /**
   */
  class AWS_SERVICEDISCOVERY_API UpdateHttpNamespaceRequest : public ServiceDiscoveryRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateHttpNamespaceRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateHttpNamespaceRequest>(GetServiceRequestName(), *this);
    }
