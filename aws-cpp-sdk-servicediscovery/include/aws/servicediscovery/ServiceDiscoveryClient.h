...
namespace ServiceDiscovery
{
  ...
  class AWS_SERVICEDISCOVERY_API ServiceDiscoveryClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        ServiceDiscoveryClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                               std::shared_ptr<Endpoint::ServiceDiscoveryEndpointProvider> endpointProvider = Aws::MakeShared<ServiceDiscovery::Endpoint::ServiceDiscoveryEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::ServiceDiscoveryEndpointProvider> m_endpointProvider;
  };
