...
namespace Model
{
  ...
  public:
     ...
     * <p>The version of the intent.</p>
     */
    inline DeleteIntentRequest& WithVersion(const Aws::String& value) { SetVersion(value); return *this;}

    /**
     * <p>The version of the intent.</p>
     */
    inline DeleteIntentRequest& WithVersion(Aws::String&& value) { SetVersion(std::move(value)); return *this;}

    /**
     * <p>The version of the intent.</p>
     */
    inline DeleteIntentRequest& WithVersion(const char* value) { SetVersion(value); return *this;}
