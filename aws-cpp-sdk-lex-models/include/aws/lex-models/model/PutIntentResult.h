...
namespace Model
{
  ...
  public:
    PutIntentResult();
    PutIntentResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    PutIntentResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
