...
namespace Model
{
  ...
  /**
   */
  class AWS_LEXMODELBUILDINGSERVICE_API DeleteIntentVersionRequest : public LexModelBuildingServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteIntentVersionRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteIntentVersionRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "DeleteIntentVersion"; }
     ...
     * <p>The name of the intent.</p>
     */
    inline DeleteIntentVersionRequest& WithName(const Aws::String& value) { SetName(value); return *this;}

    /**
     * <p>The name of the intent.</p>
     */
    inline DeleteIntentVersionRequest& WithName(Aws::String&& value) { SetName(std::move(value)); return *this;}
