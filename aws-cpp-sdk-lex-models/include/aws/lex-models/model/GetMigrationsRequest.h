...
namespace Model
{
  ...
  /**
   */
  class AWS_LEXMODELBUILDINGSERVICE_API GetMigrationsRequest : public LexModelBuildingServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetMigrationsRequest> Clone() const
    {
      return Aws::MakeUnique<GetMigrationsRequest>(GetServiceRequestName(), *this);
    }
