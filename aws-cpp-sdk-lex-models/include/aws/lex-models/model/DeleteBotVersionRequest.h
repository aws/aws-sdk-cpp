...
namespace Model
{
  ...
  /**
   */
  class AWS_LEXMODELBUILDINGSERVICE_API DeleteBotVersionRequest : public LexModelBuildingServiceRequest
  {
  public:
    ...
    inline virtual const char* GetServiceRequestName() override { return "DeleteBotVersion"; }
