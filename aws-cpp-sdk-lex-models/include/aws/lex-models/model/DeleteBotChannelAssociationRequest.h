...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteBotChannelAssociationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteBotChannelAssociationRequest>(GetServiceRequestName(), *this);
    }
