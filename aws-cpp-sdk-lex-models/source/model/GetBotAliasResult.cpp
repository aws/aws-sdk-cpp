...
GetBotAliasResult::GetBotAliasResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

GetBotAliasResult& GetBotAliasResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
