...
GetBotsResult::GetBotsResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

GetBotsResult& GetBotsResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
