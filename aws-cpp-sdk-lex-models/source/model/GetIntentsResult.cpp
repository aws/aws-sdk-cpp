...
GetIntentsResult::GetIntentsResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

GetIntentsResult& GetIntentsResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
