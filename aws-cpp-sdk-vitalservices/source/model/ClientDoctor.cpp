...
ClientDoctor::ClientDoctor(const JsonValue& jsonValue) : 
    m_idHasBeenSet(false),
    m_firstNameHasBeenSet(false),
    m_lastNameHasBeenSet(false),
    m_specialtyIdHasBeenSet(false),
...
ClientDoctor& ClientDoctor::operator =(const JsonValue& jsonValue)
{
...
JsonValue ClientDoctor::Jsonize() const
{
  JsonValue payload;
