...
searchForDoctorsByNameResult::searchForDoctorsByNameResult()
{
}

searchForDoctorsByNameResult::searchForDoctorsByNameResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

searchForDoctorsByNameResult& searchForDoctorsByNameResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
  const JsonValue& jsonValue = result.GetPayload();
  if(jsonValue.ValueExists("searchString"))
  {
    m_searchString = jsonValue.GetString("searchString");
