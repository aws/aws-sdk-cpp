...
ClientAppointment::ClientAppointment(const JsonValue& jsonValue) : 
    m_idHasBeenSet(false),
    m_appointmentStateHasBeenSet(false),
    m_basePriceCentsHasBeenSet(false),
    m_chargeIdHasBeenSet(false),
...
ClientAppointment& ClientAppointment::operator =(const JsonValue& jsonValue)
{
...
JsonValue ClientAppointment::Jsonize() const
{
  JsonValue payload;
