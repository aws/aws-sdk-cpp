...
searchForDoctorsResult::searchForDoctorsResult()
{
}

searchForDoctorsResult::searchForDoctorsResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

searchForDoctorsResult& searchForDoctorsResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
