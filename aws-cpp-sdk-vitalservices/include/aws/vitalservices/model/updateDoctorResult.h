...
namespace Model
{
  ...
  public:
    ...
    inline updateDoctorResult& WithServiceDetailsList(const Aws::Vector<ClientDoctorServiceDetails>& value) { SetServiceDetailsList(value); return *this;}

    
    inline updateDoctorResult& WithServiceDetailsList(Aws::Vector<ClientDoctorServiceDetails>&& value) { SetServiceDetailsList(value); return *this;}

    
    inline updateDoctorResult& AddServiceDetailsList(const ClientDoctorServiceDetails& value) { m_serviceDetailsList.push_back(value); return *this; }

    
    inline updateDoctorResult& AddServiceDetailsList(ClientDoctorServiceDetails&& value) { m_serviceDetailsList.push_back(value); return *this; }
