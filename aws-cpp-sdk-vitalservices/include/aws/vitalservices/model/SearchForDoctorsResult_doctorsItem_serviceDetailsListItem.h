...
namespace Model
{
  ...
  class AWS_VITALSERVICES_API SearchForDoctorsResult_doctorsItem_serviceDetailsListItem
  {
  public:
    SearchForDoctorsResult_doctorsItem_serviceDetailsListItem();
    SearchForDoctorsResult_doctorsItem_serviceDetailsListItem(const Aws::Utils::Json::JsonValue& jsonValue);
    SearchForDoctorsResult_doctorsItem_serviceDetailsListItem& operator=(const Aws::Utils::Json::JsonValue& jsonValue);
    ...
    inline SearchForDoctorsResult_doctorsItem_serviceDetailsListItem& WithDurationSeconds(const Aws::String& value) { SetDurationSeconds(value); return *this;}

    
    inline SearchForDoctorsResult_doctorsItem_serviceDetailsListItem& WithDurationSeconds(Aws::String&& value) { SetDurationSeconds(value); return *this;}
