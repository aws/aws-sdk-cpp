...
namespace Model
{
  ...
  class AWS_VITALSERVICES_API ClientDoctor_serviceDetailsListItem
  {
  public:
    ClientDoctor_serviceDetailsListItem();
    ClientDoctor_serviceDetailsListItem(const Aws::Utils::Json::JsonValue& jsonValue);
    ClientDoctor_serviceDetailsListItem& operator=(const Aws::Utils::Json::JsonValue& jsonValue);
    ...
    inline ClientDoctor_serviceDetailsListItem& WithDoctorId(const Aws::String& value) { SetDoctorId(value); return *this;}

    
    inline ClientDoctor_serviceDetailsListItem& WithDoctorId(Aws::String&& value) { SetDoctorId(value); return *this;}

    
    inline ClientDoctor_serviceDetailsListItem& WithDoctorId(const char* value) { SetDoctorId(value); return *this;}
    ...
    inline ClientDoctor_serviceDetailsListItem& WithDurationSeconds(const Aws::String& value) { SetDurationSeconds(value); return *this;}

    
    inline ClientDoctor_serviceDetailsListItem& WithDurationSeconds(Aws::String&& value) { SetDurationSeconds(value); return *this;}

    
    inline ClientDoctor_serviceDetailsListItem& WithDurationSeconds(const char* value) { SetDurationSeconds(value); return *this;}
    ...
    inline ClientDoctor_serviceDetailsListItem& WithServiceId(const Aws::String& value) { SetServiceId(value); return *this;}

    
    inline ClientDoctor_serviceDetailsListItem& WithServiceId(Aws::String&& value) { SetServiceId(value); return *this;}
