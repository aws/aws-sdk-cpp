...
namespace Model
{
  ...
  public:
    ...
    inline void SetServiceDetailsList(const Aws::Vector<ClientDoctorServiceDetails>& value) { m_serviceDetailsList = value; }

    
    inline void SetServiceDetailsList(Aws::Vector<ClientDoctorServiceDetails>&& value) { m_serviceDetailsList = value; }

    
    inline registerDoctorResult& WithServiceDetailsList(const Aws::Vector<ClientDoctorServiceDetails>& value) { SetServiceDetailsList(value); return *this;}

    
    inline registerDoctorResult& WithServiceDetailsList(Aws::Vector<ClientDoctorServiceDetails>&& value) { SetServiceDetailsList(value); return *this;}

    
    inline registerDoctorResult& AddServiceDetailsList(const ClientDoctorServiceDetails& value) { m_serviceDetailsList.push_back(value); return *this; }

    
    inline registerDoctorResult& AddServiceDetailsList(ClientDoctorServiceDetails&& value) { m_serviceDetailsList.push_back(value); return *this; }
