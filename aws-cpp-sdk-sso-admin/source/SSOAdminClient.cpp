...
using ResolveEndpointOutcome = Aws::SSOAdmin::Endpoint::SSOAdminEndpointProvider::SSOAdminResolveEndpointOutcome;
...
SSOAdminClient::SSOAdminClient(const Client::ClientConfiguration& clientConfiguration,
                               std::shared_ptr<Endpoint::SSOAdminEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<SSOAdminErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<SSOAdmin::Endpoint::SSOAdminEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
