...
Aws::String SSOAdminEndpointRules::GetRulesAsString()
{
    return Aws::String(SSOAdminEndpointRules::Rules.begin(), SSOAdminEndpointRules::Rules.end());
}

const Aws::Vector<char> SSOAdminEndpointRules::Rules = {
