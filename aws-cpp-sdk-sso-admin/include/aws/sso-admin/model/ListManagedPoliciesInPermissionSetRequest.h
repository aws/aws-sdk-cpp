...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListManagedPoliciesInPermissionSetRequest> Clone() const
    {
      return Aws::MakeUnique<ListManagedPoliciesInPermissionSetRequest>(GetServiceRequestName(), *this);
    }
