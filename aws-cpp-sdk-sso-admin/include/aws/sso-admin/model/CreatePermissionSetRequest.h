...
namespace Model
{
  ...
  /**
   */
  class AWS_SSOADMIN_API CreatePermissionSetRequest : public SSOAdminRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreatePermissionSetRequest> Clone() const
    {
      return Aws::MakeUnique<CreatePermissionSetRequest>(GetServiceRequestName(), *this);
    }
