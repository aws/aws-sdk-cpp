...
namespace Model
{
  ...
  /**
   */
  class AWS_SSOADMIN_API ListPermissionSetsProvisionedToAccountRequest : public SSOAdminRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListPermissionSetsProvisionedToAccountRequest> Clone() const
    {
      return Aws::MakeUnique<ListPermissionSetsProvisionedToAccountRequest>(GetServiceRequestName(), *this);
    }
