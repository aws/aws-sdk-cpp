...
namespace Model
{
  ...
  /**
   */
  class AWS_SSOADMIN_API UpdateInstanceAccessControlAttributeConfigurationRequest : public SSOAdminRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateInstanceAccessControlAttributeConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateInstanceAccessControlAttributeConfigurationRequest>(GetServiceRequestName(), *this);
    }
