...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DetachManagedPolicyFromPermissionSetRequest> Clone() const
    {
      return Aws::MakeUnique<DetachManagedPolicyFromPermissionSetRequest>(GetServiceRequestName(), *this);
    }
