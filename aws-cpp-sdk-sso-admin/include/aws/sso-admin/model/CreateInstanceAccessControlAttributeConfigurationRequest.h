...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateInstanceAccessControlAttributeConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<CreateInstanceAccessControlAttributeConfigurationRequest>(GetServiceRequestName(), *this);
    }
