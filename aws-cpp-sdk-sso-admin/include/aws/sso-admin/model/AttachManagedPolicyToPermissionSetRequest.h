...
namespace Model
{
  ...
  /**
   */
  class AWS_SSOADMIN_API AttachManagedPolicyToPermissionSetRequest : public SSOAdminRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AttachManagedPolicyToPermissionSetRequest> Clone() const
    {
      return Aws::MakeUnique<AttachManagedPolicyToPermissionSetRequest>(GetServiceRequestName(), *this);
    }
