...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteInlinePolicyFromPermissionSetRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteInlinePolicyFromPermissionSetRequest>(GetServiceRequestName(), *this);
    }
