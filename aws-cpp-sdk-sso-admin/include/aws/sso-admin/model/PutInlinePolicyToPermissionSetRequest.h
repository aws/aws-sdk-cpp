...
namespace Model
{
  ...
  /**
   */
  class AWS_SSOADMIN_API PutInlinePolicyToPermissionSetRequest : public SSOAdminRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutInlinePolicyToPermissionSetRequest> Clone() const
    {
      return Aws::MakeUnique<PutInlinePolicyToPermissionSetRequest>(GetServiceRequestName(), *this);
    }
