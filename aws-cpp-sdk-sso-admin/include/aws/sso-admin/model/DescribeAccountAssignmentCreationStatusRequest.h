...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeAccountAssignmentCreationStatusRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeAccountAssignmentCreationStatusRequest>(GetServiceRequestName(), *this);
    }
