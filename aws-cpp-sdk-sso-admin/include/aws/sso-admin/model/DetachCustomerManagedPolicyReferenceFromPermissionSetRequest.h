...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DetachCustomerManagedPolicyReferenceFromPermissionSetRequest> Clone() const
    {
      return Aws::MakeUnique<DetachCustomerManagedPolicyReferenceFromPermissionSetRequest>(GetServiceRequestName(), *this);
    }
