...
namespace Model
{
  ...
  /**
   */
  class AWS_SSOADMIN_API DescribePermissionSetProvisioningStatusRequest : public SSOAdminRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribePermissionSetProvisioningStatusRequest> Clone() const
    {
      return Aws::MakeUnique<DescribePermissionSetProvisioningStatusRequest>(GetServiceRequestName(), *this);
    }
