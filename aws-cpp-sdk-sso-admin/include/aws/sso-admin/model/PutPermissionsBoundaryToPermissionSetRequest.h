...
namespace Model
{
  ...
  /**
   */
  class AWS_SSOADMIN_API PutPermissionsBoundaryToPermissionSetRequest : public SSOAdminRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutPermissionsBoundaryToPermissionSetRequest> Clone() const
    {
      return Aws::MakeUnique<PutPermissionsBoundaryToPermissionSetRequest>(GetServiceRequestName(), *this);
    }
