...
namespace Model
{
  ...
  /**
   */
  class AWS_SSOADMIN_API GetInlinePolicyForPermissionSetRequest : public SSOAdminRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetInlinePolicyForPermissionSetRequest> Clone() const
    {
      return Aws::MakeUnique<GetInlinePolicyForPermissionSetRequest>(GetServiceRequestName(), *this);
    }
