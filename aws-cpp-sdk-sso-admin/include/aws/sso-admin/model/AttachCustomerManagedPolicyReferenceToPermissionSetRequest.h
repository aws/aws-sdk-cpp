...
namespace Model
{
  ...
  /**
   */
  class AWS_SSOADMIN_API AttachCustomerManagedPolicyReferenceToPermissionSetRequest : public SSOAdminRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AttachCustomerManagedPolicyReferenceToPermissionSetRequest> Clone() const
    {
      return Aws::MakeUnique<AttachCustomerManagedPolicyReferenceToPermissionSetRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "AttachCustomerManagedPolicyReferenceToPermissionSet"; }
     ...
     * executed. </p>
     */
    inline AttachCustomerManagedPolicyReferenceToPermissionSetRequest& WithInstanceArn(const Aws::String& value) { SetInstanceArn(value); return *this;}

    /**
     * <p>The ARN of the IAM Identity Center instance under which the operation will be
     * executed. </p>
     */
    inline AttachCustomerManagedPolicyReferenceToPermissionSetRequest& WithInstanceArn(Aws::String&& value) { SetInstanceArn(std::move(value)); return *this;}

    /**
     * <p>The ARN of the IAM Identity Center instance under which the operation will be
     * executed. </p>
     */
    inline AttachCustomerManagedPolicyReferenceToPermissionSetRequest& WithInstanceArn(const char* value) { SetInstanceArn(value); return *this;}
     ...
     * <p>The ARN of the <code>PermissionSet</code>.</p>
     */
    inline AttachCustomerManagedPolicyReferenceToPermissionSetRequest& WithPermissionSetArn(const Aws::String& value) { SetPermissionSetArn(value); return *this;}

    /**
     * <p>The ARN of the <code>PermissionSet</code>.</p>
     */
    inline AttachCustomerManagedPolicyReferenceToPermissionSetRequest& WithPermissionSetArn(Aws::String&& value) { SetPermissionSetArn(std::move(value)); return *this;}
