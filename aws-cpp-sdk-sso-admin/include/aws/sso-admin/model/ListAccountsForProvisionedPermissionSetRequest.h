...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListAccountsForProvisionedPermissionSetRequest> Clone() const
    {
      return Aws::MakeUnique<ListAccountsForProvisionedPermissionSetRequest>(GetServiceRequestName(), *this);
    }
