...
namespace Model
{
  ...
  /**
   */
  class AWS_SSOADMIN_API GetPermissionsBoundaryForPermissionSetRequest : public SSOAdminRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetPermissionsBoundaryForPermissionSetRequest> Clone() const
    {
      return Aws::MakeUnique<GetPermissionsBoundaryForPermissionSetRequest>(GetServiceRequestName(), *this);
    }
