...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListCustomerManagedPolicyReferencesInPermissionSetRequest> Clone() const
    {
      return Aws::MakeUnique<ListCustomerManagedPolicyReferencesInPermissionSetRequest>(GetServiceRequestName(), *this);
    }
