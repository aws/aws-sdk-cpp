...
namespace Model
{
  ...
  /**
   */
  class AWS_SSOADMIN_API DescribeAccountAssignmentDeletionStatusRequest : public SSOAdminRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeAccountAssignmentDeletionStatusRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeAccountAssignmentDeletionStatusRequest>(GetServiceRequestName(), *this);
    }
