...
namespace Model
{
  ...
  /**
   * <p>A structure that stores the details of the Amazon Web Services managed IAM
  ...
  public:
    ...
    /**
     * <p>The ARN of the Amazon Web Services managed IAM policy. For more information
