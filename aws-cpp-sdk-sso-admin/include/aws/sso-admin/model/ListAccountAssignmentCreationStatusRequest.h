...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListAccountAssignmentCreationStatusRequest> Clone() const
    {
      return Aws::MakeUnique<ListAccountAssignmentCreationStatusRequest>(GetServiceRequestName(), *this);
    }
