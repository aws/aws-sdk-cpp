...
namespace Model
{
  ...
  /**
   */
  class AWS_SSOADMIN_API ListPermissionSetProvisioningStatusRequest : public SSOAdminRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListPermissionSetProvisioningStatusRequest> Clone() const
    {
      return Aws::MakeUnique<ListPermissionSetProvisioningStatusRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "ListPermissionSetProvisioningStatus"; }
     ...
     * <p>Filters results based on the passed attribute value.</p>
     */
    inline ListPermissionSetProvisioningStatusRequest& WithFilter(OperationStatusFilter&& value) { SetFilter(std::move(value)); return *this;}
