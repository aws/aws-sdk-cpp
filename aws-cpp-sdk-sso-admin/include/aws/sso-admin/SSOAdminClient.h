...
namespace SSOAdmin
{
  ...
  class AWS_SSOADMIN_API SSOAdminClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        SSOAdminClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                       std::shared_ptr<Endpoint::SSOAdminEndpointProvider> endpointProvider = Aws::MakeShared<SSOAdmin::Endpoint::SSOAdminEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::SSOAdminEndpointProvider> m_endpointProvider;
  };
