...
using ResolveEndpointOutcome = Aws::WAFRegional::Endpoint::WAFRegionalEndpointProvider::WAFRegionalResolveEndpointOutcome;
...
WAFRegionalClient::WAFRegionalClient(const Client::ClientConfiguration& clientConfiguration,
                                     std::shared_ptr<Endpoint::WAFRegionalEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<WAFRegionalErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<WAFRegional::Endpoint::WAFRegionalEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
