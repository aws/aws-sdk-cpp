...
namespace WAFRegional
{
  ...
  class AWS_WAFREGIONAL_API WAFRegionalClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        WAFRegionalClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                          std::shared_ptr<Endpoint::WAFRegionalEndpointProvider> endpointProvider = Aws::MakeShared<WAFRegional::Endpoint::WAFRegionalEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::WAFRegionalEndpointProvider> m_endpointProvider;
  };
