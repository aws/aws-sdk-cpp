...
namespace Model
{
  ...
  /**
   */
  class AWS_WAFREGIONAL_API ListSubscribedRuleGroupsRequest : public WAFRegionalRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListSubscribedRuleGroupsRequest> Clone() const
    {
      return Aws::MakeUnique<ListSubscribedRuleGroupsRequest>(GetServiceRequestName(), *this);
    }
