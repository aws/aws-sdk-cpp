...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetRateBasedRuleManagedKeysRequest> Clone() const
    {
      return Aws::MakeUnique<GetRateBasedRuleManagedKeysRequest>(GetServiceRequestName(), *this);
    }
