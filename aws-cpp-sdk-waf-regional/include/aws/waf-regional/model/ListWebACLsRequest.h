...
namespace Model
{
  ...
  /**
   */
  class AWS_WAFREGIONAL_API ListWebACLsRequest : public WAFRegionalRequest
  {
  public:
    ListWebACLsRequest();
    ...
    */
    virtual Aws::UniquePtr<ListWebACLsRequest> Clone() const
    {
      return Aws::MakeUnique<ListWebACLsRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "ListWebACLs"; }
