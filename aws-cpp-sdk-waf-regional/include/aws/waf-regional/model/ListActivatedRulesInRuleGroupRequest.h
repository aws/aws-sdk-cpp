...
namespace Model
{
  ...
  /**
   */
  class AWS_WAFREGIONAL_API ListActivatedRulesInRuleGroupRequest : public WAFRegionalRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListActivatedRulesInRuleGroupRequest> Clone() const
    {
      return Aws::MakeUnique<ListActivatedRulesInRuleGroupRequest>(GetServiceRequestName(), *this);
    }
