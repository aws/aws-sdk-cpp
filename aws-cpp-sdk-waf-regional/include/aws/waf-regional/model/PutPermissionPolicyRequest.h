...
namespace Model
{
  ...
  /**
   */
  class AWS_WAFREGIONAL_API PutPermissionPolicyRequest : public WAFRegionalRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutPermissionPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<PutPermissionPolicyRequest>(GetServiceRequestName(), *this);
    }
