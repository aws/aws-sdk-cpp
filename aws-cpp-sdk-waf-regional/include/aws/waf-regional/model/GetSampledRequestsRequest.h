...
namespace Model
{
  ...
  /**
   */
  class AWS_WAFREGIONAL_API GetSampledRequestsRequest : public WAFRegionalRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetSampledRequestsRequest> Clone() const
    {
      return Aws::MakeUnique<GetSampledRequestsRequest>(GetServiceRequestName(), *this);
    }
