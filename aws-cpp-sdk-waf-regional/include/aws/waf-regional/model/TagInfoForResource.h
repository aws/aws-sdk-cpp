...
namespace Model
{
   ...
   * endpoints for regional and global use. </p> </note> <p>Information for a tag
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/TagInfoForResource">AWS
   * API Reference</a></p>
   */
