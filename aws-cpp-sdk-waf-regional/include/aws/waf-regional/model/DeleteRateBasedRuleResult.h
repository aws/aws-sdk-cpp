...
namespace Model
{
  ...
  public:
    ...
    DeleteRateBasedRuleResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    DeleteRateBasedRuleResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
