...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_WAFREGIONAL_API ListXssMatchSetsRequest : public WAFRegionalRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListXssMatchSetsRequest> Clone() const
    {
      return Aws::MakeUnique<ListXssMatchSetsRequest>(GetServiceRequestName(), *this);
    }
