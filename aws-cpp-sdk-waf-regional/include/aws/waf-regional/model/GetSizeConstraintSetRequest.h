...
namespace Model
{
  ...
  /**
   */
  class AWS_WAFREGIONAL_API GetSizeConstraintSetRequest : public WAFRegionalRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetSizeConstraintSetRequest> Clone() const
    {
      return Aws::MakeUnique<GetSizeConstraintSetRequest>(GetServiceRequestName(), *this);
    }
