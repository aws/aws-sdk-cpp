...
namespace Model
{
  ...
  public:
    DeleteWebACLResult();
    DeleteWebACLResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    DeleteWebACLResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
