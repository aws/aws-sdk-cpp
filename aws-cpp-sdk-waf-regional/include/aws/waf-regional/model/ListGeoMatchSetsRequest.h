...
namespace Model
{
  ...
  /**
   */
  class AWS_WAFREGIONAL_API ListGeoMatchSetsRequest : public WAFRegionalRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListGeoMatchSetsRequest> Clone() const
    {
      return Aws::MakeUnique<ListGeoMatchSetsRequest>(GetServiceRequestName(), *this);
    }
