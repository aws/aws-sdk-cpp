...
namespace Model
{
  ...
  /**
   */
  class AWS_WAFREGIONAL_API UpdateSizeConstraintSetRequest : public WAFRegionalRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateSizeConstraintSetRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateSizeConstraintSetRequest>(GetServiceRequestName(), *this);
    }
