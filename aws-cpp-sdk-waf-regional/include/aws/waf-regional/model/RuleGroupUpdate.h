...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_WAFREGIONAL_API RuleGroupUpdate
  {
  public:
    RuleGroupUpdate();
    RuleGroupUpdate(const Aws::Utils::Json::JsonValue& jsonValue);
    RuleGroupUpdate& operator=(const Aws::Utils::Json::JsonValue& jsonValue);
