...
namespace ElasticInference
{
  ...
  class AWS_ELASTICINFERENCE_API ElasticInferenceClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        ElasticInferenceClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                               std::shared_ptr<Endpoint::ElasticInferenceEndpointProvider> endpointProvider = Aws::MakeShared<ElasticInference::Endpoint::ElasticInferenceEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::ElasticInferenceEndpointProvider> m_endpointProvider;
  };
