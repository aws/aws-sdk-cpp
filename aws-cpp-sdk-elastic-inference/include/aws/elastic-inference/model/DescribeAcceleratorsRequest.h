...
namespace Model
{
  ...
  /**
   */
  class AWS_ELASTICINFERENCE_API DescribeAcceleratorsRequest : public ElasticInferenceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeAcceleratorsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeAcceleratorsRequest>(GetServiceRequestName(), *this);
    }
