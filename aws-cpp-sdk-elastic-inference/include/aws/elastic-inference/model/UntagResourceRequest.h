...
namespace Model
{
  ...
  /**
   */
  class UntagResourceRequest : public ElasticInferenceRequest
  {
  public:
    AWS_ELASTICINFERENCE_API UntagResourceRequest();
    ...
    AWS_ELASTICINFERENCE_API void AddQueryStringParameters(Aws::Http::URI& uri) const override;
