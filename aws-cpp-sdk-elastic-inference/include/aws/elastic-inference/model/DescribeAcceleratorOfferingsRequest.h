...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeAcceleratorOfferingsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeAcceleratorOfferingsRequest>(GetServiceRequestName(), *this);
    }
