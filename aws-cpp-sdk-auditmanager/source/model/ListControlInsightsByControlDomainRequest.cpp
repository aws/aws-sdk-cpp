...
Aws::String ListControlInsightsByControlDomainRequest::SerializePayload() const
{
  return {};
}

void ListControlInsightsByControlDomainRequest::AddQueryStringParameters(URI& uri) const
{
    Aws::StringStream ss;
