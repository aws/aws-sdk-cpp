...
namespace Model
{
  ...
  /**
   */
  class AWS_AUDITMANAGER_API CreateAssessmentFrameworkRequest : public AuditManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateAssessmentFrameworkRequest> Clone() const
    {
      return Aws::MakeUnique<CreateAssessmentFrameworkRequest>(GetServiceRequestName(), *this);
    }
