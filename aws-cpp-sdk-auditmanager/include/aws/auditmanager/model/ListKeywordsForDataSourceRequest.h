...
namespace Model
{
  ...
  /**
   */
  class AWS_AUDITMANAGER_API ListKeywordsForDataSourceRequest : public AuditManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListKeywordsForDataSourceRequest> Clone() const
    {
      return Aws::MakeUnique<ListKeywordsForDataSourceRequest>(GetServiceRequestName(), *this);
    }
