...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<StartAssessmentFrameworkShareRequest> Clone() const
    {
      return Aws::MakeUnique<StartAssessmentFrameworkShareRequest>(GetServiceRequestName(), *this);
    }
