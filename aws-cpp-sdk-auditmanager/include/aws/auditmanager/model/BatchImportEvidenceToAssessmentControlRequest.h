...
namespace Model
{
  ...
  /**
   */
  class AWS_AUDITMANAGER_API BatchImportEvidenceToAssessmentControlRequest : public AuditManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchImportEvidenceToAssessmentControlRequest> Clone() const
    {
      return Aws::MakeUnique<BatchImportEvidenceToAssessmentControlRequest>(GetServiceRequestName(), *this);
    }
