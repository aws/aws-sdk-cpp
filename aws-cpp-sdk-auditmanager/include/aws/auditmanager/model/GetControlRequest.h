...
namespace Model
{
  ...
  /**
   */
  class AWS_AUDITMANAGER_API GetControlRequest : public AuditManagerRequest
  {
  public:
    GetControlRequest();
    ...
    */
    virtual Aws::UniquePtr<GetControlRequest> Clone() const
    {
      return Aws::MakeUnique<GetControlRequest>(GetServiceRequestName(), *this);
    }
