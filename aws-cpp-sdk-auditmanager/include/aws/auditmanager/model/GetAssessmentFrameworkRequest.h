...
namespace Model
{
  ...
  /**
   */
  class AWS_AUDITMANAGER_API GetAssessmentFrameworkRequest : public AuditManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetAssessmentFrameworkRequest> Clone() const
    {
      return Aws::MakeUnique<GetAssessmentFrameworkRequest>(GetServiceRequestName(), *this);
    }
