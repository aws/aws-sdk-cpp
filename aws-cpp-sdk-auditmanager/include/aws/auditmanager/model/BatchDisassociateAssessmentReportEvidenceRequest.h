...
namespace Model
{
  ...
  /**
   */
  class AWS_AUDITMANAGER_API BatchDisassociateAssessmentReportEvidenceRequest : public AuditManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchDisassociateAssessmentReportEvidenceRequest> Clone() const
    {
      return Aws::MakeUnique<BatchDisassociateAssessmentReportEvidenceRequest>(GetServiceRequestName(), *this);
    }
