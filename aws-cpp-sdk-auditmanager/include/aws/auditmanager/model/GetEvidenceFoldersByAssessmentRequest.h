...
namespace Model
{
  ...
  /**
   */
  class AWS_AUDITMANAGER_API GetEvidenceFoldersByAssessmentRequest : public AuditManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetEvidenceFoldersByAssessmentRequest> Clone() const
    {
      return Aws::MakeUnique<GetEvidenceFoldersByAssessmentRequest>(GetServiceRequestName(), *this);
    }
