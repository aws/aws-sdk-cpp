...
namespace Model
{
  ...
  /**
   */
  class AWS_AUDITMANAGER_API UpdateAssessmentFrameworkShareRequest : public AuditManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateAssessmentFrameworkShareRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateAssessmentFrameworkShareRequest>(GetServiceRequestName(), *this);
    }
