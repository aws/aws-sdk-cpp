...
namespace Model
{
  ...
  /**
   */
  class AWS_AUDITMANAGER_API DisassociateAssessmentReportEvidenceFolderRequest : public AuditManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateAssessmentReportEvidenceFolderRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateAssessmentReportEvidenceFolderRequest>(GetServiceRequestName(), *this);
    }
