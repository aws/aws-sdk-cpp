...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_AUDITMANAGER_API ControlMappingSource
  {
  public:
    ControlMappingSource();
    ControlMappingSource(Aws::Utils::Json::JsonView jsonValue);
    ControlMappingSource& operator=(Aws::Utils::Json::JsonView jsonValue);
    Aws::Utils::Json::JsonValue Jsonize() const;


    /**
     * <p> The unique identifier for the specified source. </p>
     */
    ...
    /**
     * <p> The name of the specified source. </p>
     */
    ...
    /**
     * <p> The description of the specified source. </p>
     */
