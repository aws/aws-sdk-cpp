...
namespace Model
{
  ...
  /**
   */
  class AWS_AUDITMANAGER_API DeleteAssessmentRequest : public AuditManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteAssessmentRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteAssessmentRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "DeleteAssessment"; }
