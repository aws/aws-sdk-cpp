...
namespace Model
{
  ...
  /**
   */
  class AWS_AUDITMANAGER_API GetEvidenceFolderRequest : public AuditManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetEvidenceFolderRequest> Clone() const
    {
      return Aws::MakeUnique<GetEvidenceFolderRequest>(GetServiceRequestName(), *this);
    }
