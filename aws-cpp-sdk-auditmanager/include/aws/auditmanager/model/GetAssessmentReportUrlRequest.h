...
namespace Model
{
  ...
  /**
   */
  class AWS_AUDITMANAGER_API GetAssessmentReportUrlRequest : public AuditManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetAssessmentReportUrlRequest> Clone() const
    {
      return Aws::MakeUnique<GetAssessmentReportUrlRequest>(GetServiceRequestName(), *this);
    }
