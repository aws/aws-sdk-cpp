...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchAssociateAssessmentReportEvidenceRequest> Clone() const
    {
      return Aws::MakeUnique<BatchAssociateAssessmentReportEvidenceRequest>(GetServiceRequestName(), *this);
    }
