...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListAssessmentControlInsightsByControlDomainRequest> Clone() const
    {
      return Aws::MakeUnique<ListAssessmentControlInsightsByControlDomainRequest>(GetServiceRequestName(), *this);
    }
