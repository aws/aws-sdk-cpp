...
namespace Model
{
  ...
  /**
   */
  class AWS_AUDITMANAGER_API AssociateAssessmentReportEvidenceFolderRequest : public AuditManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateAssessmentReportEvidenceFolderRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateAssessmentReportEvidenceFolderRequest>(GetServiceRequestName(), *this);
    }
