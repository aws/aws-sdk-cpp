...
namespace Model
{
  ...
  /**
   * <p> The wrapper of Amazon Web Services account details, such as account ID,
   * email address, and so on. </p><p><h3>See Also:</h3>   <a
  ...
  public:
    ...
    /**
     * <p> The email address associated with the specified Amazon Web Services account.
     * </p>
     */
    ...
    /**
     * <p> The name of the specified Amazon Web Services account. </p>
     */
