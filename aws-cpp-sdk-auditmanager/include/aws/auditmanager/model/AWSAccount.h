...
namespace Model
{
  ...
  /**
   * <p> The wrapper of account details, such as account ID, email address, and so
  ...
  public:
    ...
    /**
     * <p> The email address associated with the specified account. </p>
     */
    ...
    /**
     * <p> The name of the specified account. </p>
     */
