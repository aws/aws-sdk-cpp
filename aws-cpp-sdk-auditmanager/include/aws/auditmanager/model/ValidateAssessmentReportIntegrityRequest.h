...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ValidateAssessmentReportIntegrityRequest> Clone() const
    {
      return Aws::MakeUnique<ValidateAssessmentReportIntegrityRequest>(GetServiceRequestName(), *this);
    }
