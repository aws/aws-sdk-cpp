...
namespace Model
{
  ...
  /**
   */
  class AWS_AUDITMANAGER_API UpdateAssessmentFrameworkRequest : public AuditManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateAssessmentFrameworkRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateAssessmentFrameworkRequest>(GetServiceRequestName(), *this);
    }
