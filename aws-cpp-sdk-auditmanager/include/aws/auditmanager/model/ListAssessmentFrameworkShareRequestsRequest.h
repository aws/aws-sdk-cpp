...
namespace Model
{
  ...
  /**
   */
  class AWS_AUDITMANAGER_API ListAssessmentFrameworkShareRequestsRequest : public AuditManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListAssessmentFrameworkShareRequestsRequest> Clone() const
    {
      return Aws::MakeUnique<ListAssessmentFrameworkShareRequestsRequest>(GetServiceRequestName(), *this);
    }
