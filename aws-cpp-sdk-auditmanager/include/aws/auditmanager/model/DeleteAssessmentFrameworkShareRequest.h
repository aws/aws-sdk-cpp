...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteAssessmentFrameworkShareRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteAssessmentFrameworkShareRequest>(GetServiceRequestName(), *this);
    }
