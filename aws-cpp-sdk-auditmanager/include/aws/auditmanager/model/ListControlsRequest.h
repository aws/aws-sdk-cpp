...
namespace Model
{
  ...
  /**
   */
  class AWS_AUDITMANAGER_API ListControlsRequest : public AuditManagerRequest
  {
  public:
    ListControlsRequest();
    ...
    */
    virtual Aws::UniquePtr<ListControlsRequest> Clone() const
    {
      return Aws::MakeUnique<ListControlsRequest>(GetServiceRequestName(), *this);
    }
