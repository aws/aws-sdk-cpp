...
namespace Model
{
  ...
  /**
   */
  class AWS_AUDITMANAGER_API DeregisterOrganizationAdminAccountRequest : public AuditManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeregisterOrganizationAdminAccountRequest> Clone() const
    {
      return Aws::MakeUnique<DeregisterOrganizationAdminAccountRequest>(GetServiceRequestName(), *this);
    }
