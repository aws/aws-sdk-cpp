...
namespace Model
{
  ...
  /**
   */
  class AWS_AUDITMANAGER_API GetEvidenceFoldersByAssessmentControlRequest : public AuditManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetEvidenceFoldersByAssessmentControlRequest> Clone() const
    {
      return Aws::MakeUnique<GetEvidenceFoldersByAssessmentControlRequest>(GetServiceRequestName(), *this);
    }
