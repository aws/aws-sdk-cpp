...
namespace Model
{
  ...
  /**
   */
  class AWS_AUDITMANAGER_API DeleteControlRequest : public AuditManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteControlRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteControlRequest>(GetServiceRequestName(), *this);
    }
