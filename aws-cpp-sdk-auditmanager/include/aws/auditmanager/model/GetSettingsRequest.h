...
namespace Model
{
  ...
  /**
   */
  class AWS_AUDITMANAGER_API GetSettingsRequest : public AuditManagerRequest
  {
  public:
    GetSettingsRequest();
    ...
    */
    virtual Aws::UniquePtr<GetSettingsRequest> Clone() const
    {
      return Aws::MakeUnique<GetSettingsRequest>(GetServiceRequestName(), *this);
    }
