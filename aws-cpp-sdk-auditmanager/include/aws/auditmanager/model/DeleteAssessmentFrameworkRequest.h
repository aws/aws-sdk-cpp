...
namespace Model
{
  ...
  /**
   */
  class AWS_AUDITMANAGER_API DeleteAssessmentFrameworkRequest : public AuditManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteAssessmentFrameworkRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteAssessmentFrameworkRequest>(GetServiceRequestName(), *this);
    }
