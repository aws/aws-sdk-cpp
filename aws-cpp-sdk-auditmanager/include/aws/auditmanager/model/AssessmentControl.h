...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p> The response of the specified control. </p>
     */
    ...
    /**
     * <p> The list of comments attached to the specified control. </p>
     */
    ...
    /**
     * <p> The list of data sources for the specified evidence. </p>
     */
    ...
    /**
     * <p> The amount of evidence generated for the control. </p>
     */
  ...
  private:
    ...
    bool m_evidenceSourcesHasBeenSet;

    int m_evidenceCount;
    bool m_evidenceCountHasBeenSet;

    int m_assessmentReportEvidenceCount;
    bool m_assessmentReportEvidenceCountHasBeenSet;
  };
