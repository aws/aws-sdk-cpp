...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateAssessmentControlSetStatusRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateAssessmentControlSetStatusRequest>(GetServiceRequestName(), *this);
    }
