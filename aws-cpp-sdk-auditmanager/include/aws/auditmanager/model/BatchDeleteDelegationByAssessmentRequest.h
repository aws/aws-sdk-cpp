...
namespace Model
{
  ...
  /**
   */
  class AWS_AUDITMANAGER_API BatchDeleteDelegationByAssessmentRequest : public AuditManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchDeleteDelegationByAssessmentRequest> Clone() const
    {
      return Aws::MakeUnique<BatchDeleteDelegationByAssessmentRequest>(GetServiceRequestName(), *this);
    }
