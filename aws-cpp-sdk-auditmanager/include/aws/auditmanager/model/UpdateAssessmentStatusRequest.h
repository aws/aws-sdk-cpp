...
namespace Model
{
  ...
  /**
   */
  class AWS_AUDITMANAGER_API UpdateAssessmentStatusRequest : public AuditManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateAssessmentStatusRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateAssessmentStatusRequest>(GetServiceRequestName(), *this);
    }
