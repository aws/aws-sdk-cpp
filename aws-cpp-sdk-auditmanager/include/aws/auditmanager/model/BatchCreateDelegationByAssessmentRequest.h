...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchCreateDelegationByAssessmentRequest> Clone() const
    {
      return Aws::MakeUnique<BatchCreateDelegationByAssessmentRequest>(GetServiceRequestName(), *this);
    }
