...
namespace Model
{
  ...
  /**
   */
  class AWS_AUDITMANAGER_API ListControlInsightsByControlDomainRequest : public AuditManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListControlInsightsByControlDomainRequest> Clone() const
    {
      return Aws::MakeUnique<ListControlInsightsByControlDomainRequest>(GetServiceRequestName(), *this);
    }
