...
namespace Model
{
  ...
  /**
   */
  class AWS_AUDITMANAGER_API ListNotificationsRequest : public AuditManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListNotificationsRequest> Clone() const
    {
      return Aws::MakeUnique<ListNotificationsRequest>(GetServiceRequestName(), *this);
    }
