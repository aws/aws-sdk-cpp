...
namespace Model
{
  ...
  /**
   */
  class AWS_AUDITMANAGER_API RegisterOrganizationAdminAccountRequest : public AuditManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<RegisterOrganizationAdminAccountRequest> Clone() const
    {
      return Aws::MakeUnique<RegisterOrganizationAdminAccountRequest>(GetServiceRequestName(), *this);
    }
