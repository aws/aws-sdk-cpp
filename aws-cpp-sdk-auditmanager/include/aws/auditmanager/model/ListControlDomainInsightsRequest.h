...
namespace Model
{
  ...
  /**
   */
  class AWS_AUDITMANAGER_API ListControlDomainInsightsRequest : public AuditManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListControlDomainInsightsRequest> Clone() const
    {
      return Aws::MakeUnique<ListControlDomainInsightsRequest>(GetServiceRequestName(), *this);
    }
