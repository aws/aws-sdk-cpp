...
namespace Model
{
  ...
  /**
   */
  class AWS_AUDITMANAGER_API GetEvidenceByEvidenceFolderRequest : public AuditManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetEvidenceByEvidenceFolderRequest> Clone() const
    {
      return Aws::MakeUnique<GetEvidenceByEvidenceFolderRequest>(GetServiceRequestName(), *this);
    }
