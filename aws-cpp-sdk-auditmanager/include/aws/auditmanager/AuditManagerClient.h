...
namespace AuditManager
{
  ...
  class AWS_AUDITMANAGER_API AuditManagerClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        AuditManagerClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                           std::shared_ptr<Endpoint::AuditManagerEndpointProvider> endpointProvider = Aws::MakeShared<AuditManager::Endpoint::AuditManagerEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::AuditManagerEndpointProvider> m_endpointProvider;
  };
