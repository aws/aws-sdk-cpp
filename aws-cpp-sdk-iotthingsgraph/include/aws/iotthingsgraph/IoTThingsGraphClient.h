...
namespace IoTThingsGraph
{
  ...
  class AWS_IOTTHINGSGRAPH_API IoTThingsGraphClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        IoTThingsGraphClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                             std::shared_ptr<Endpoint::IoTThingsGraphEndpointProvider> endpointProvider = Aws::MakeShared<IoTThingsGraph::Endpoint::IoTThingsGraphEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::IoTThingsGraphEndpointProvider> m_endpointProvider;
  };
