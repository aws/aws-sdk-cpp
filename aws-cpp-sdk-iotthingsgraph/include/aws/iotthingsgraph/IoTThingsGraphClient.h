    ...
    public:
      typedef Aws::Client::AWSJsonClient BASECLASS;
        ...
        */
        ...
        /**
         * A Callable wrapper for AssociateEntityToThing that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for AssociateEntityToThing that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        ...
        /**
         * A Callable wrapper for CreateFlowTemplate that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for CreateFlowTemplate that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        ...
        /**
         * A Callable wrapper for CreateSystemInstance that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for CreateSystemInstance that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        ...
        /**
         * A Callable wrapper for CreateSystemTemplate that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for CreateSystemTemplate that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        ...
        /**
         * A Callable wrapper for DeleteFlowTemplate that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for DeleteFlowTemplate that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        ...
        /**
         * A Callable wrapper for DeleteSystemInstance that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for DeleteSystemInstance that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        ...
        /**
         * A Callable wrapper for DeleteSystemTemplate that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for DeleteSystemTemplate that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        ...
        /**
         * A Callable wrapper for DeploySystemInstance that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for DeploySystemInstance that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        ...
        /**
         * A Callable wrapper for DeprecateFlowTemplate that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for DeprecateFlowTemplate that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        ...
        /**
         * A Callable wrapper for DeprecateSystemTemplate that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for DeprecateSystemTemplate that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        ...
        /**
         * A Callable wrapper for DissociateEntityFromThing that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for DissociateEntityFromThing that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        ...
        /**
         * A Callable wrapper for GetEntities that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        virtual Model::GetEntitiesOutcomeCallable GetEntitiesCallable(const Model::GetEntitiesRequest& request) const;

        /**
         * An Async wrapper for GetEntities that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        ...
        /**
         * A Callable wrapper for GetFlowTemplate that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        virtual Model::GetFlowTemplateOutcomeCallable GetFlowTemplateCallable(const Model::GetFlowTemplateRequest& request) const;

        /**
         * An Async wrapper for GetFlowTemplate that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        ...
        /**
         * A Callable wrapper for GetFlowTemplateRevisions that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for GetFlowTemplateRevisions that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        ...
        /**
         * A Callable wrapper for GetNamespaceDeletionStatus that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for GetNamespaceDeletionStatus that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        ...
        /**
         * A Callable wrapper for GetSystemInstance that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for GetSystemInstance that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        ...
        /**
         * A Callable wrapper for GetSystemTemplate that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for GetSystemTemplate that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        ...
        /**
         * A Callable wrapper for GetSystemTemplateRevisions that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for GetSystemTemplateRevisions that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        ...
        /**
         * A Callable wrapper for GetUploadStatus that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        virtual Model::GetUploadStatusOutcomeCallable GetUploadStatusCallable(const Model::GetUploadStatusRequest& request) const;

        /**
         * An Async wrapper for GetUploadStatus that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        ...
        /**
         * A Callable wrapper for ListFlowExecutionMessages that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for ListFlowExecutionMessages that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        ...
        /**
         * A Callable wrapper for SearchEntities that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        virtual Model::SearchEntitiesOutcomeCallable SearchEntitiesCallable(const Model::SearchEntitiesRequest& request) const;

        /**
         * An Async wrapper for SearchEntities that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        ...
        /**
         * A Callable wrapper for SearchFlowExecutions that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for SearchFlowExecutions that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        ...
        /**
         * A Callable wrapper for SearchFlowTemplates that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for SearchFlowTemplates that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        ...
        /**
         * A Callable wrapper for SearchSystemInstances that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for SearchSystemInstances that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        ...
        /**
         * A Callable wrapper for SearchSystemTemplates that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for SearchSystemTemplates that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        ...
        /**
         * A Callable wrapper for SearchThings that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        virtual Model::SearchThingsOutcomeCallable SearchThingsCallable(const Model::SearchThingsRequest& request) const;

        /**
         * An Async wrapper for SearchThings that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        ...
        /**
         * A Callable wrapper for UndeploySystemInstance that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for UndeploySystemInstance that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        ...
        /**
         * A Callable wrapper for UpdateFlowTemplate that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for UpdateFlowTemplate that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        ...
        /**
         * A Callable wrapper for UpdateSystemTemplate that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for UpdateSystemTemplate that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        ...
        /**
         * A Callable wrapper for UploadEntityDefinitions that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for UploadEntityDefinitions that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
