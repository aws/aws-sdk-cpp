...
Aws::String IoTThingsGraphEndpointRules::GetRulesAsString()
{
    return Aws::String(IoTThingsGraphEndpointRules::Rules.begin(), IoTThingsGraphEndpointRules::Rules.end());
}

const Aws::Vector<char> IoTThingsGraphEndpointRules::Rules = {
...
'g','s','g','r','a','p','h','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a',
...
't','t','p','s',':','/','/','i','o','t','t','h','i','n','g','s','g','r','a','p','h','-','f','i','p',
...
'p','s',':','/','/','i','o','t','t','h','i','n','g','s','g','r','a','p','h','.','{','R','e','g','i',
