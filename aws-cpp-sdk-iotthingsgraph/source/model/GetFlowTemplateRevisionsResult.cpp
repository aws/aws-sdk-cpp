...
GetFlowTemplateRevisionsResult::GetFlowTemplateRevisionsResult()
{
}

GetFlowTemplateRevisionsResult::GetFlowTemplateRevisionsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

GetFlowTemplateRevisionsResult& GetFlowTemplateRevisionsResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
