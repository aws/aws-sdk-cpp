...
GetEntitiesResult::GetEntitiesResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

GetEntitiesResult& GetEntitiesResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
