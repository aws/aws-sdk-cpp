...
Aws::String MarketplaceEntitlementServiceEndpointRules::GetRulesAsString()
{
    return Aws::String(MarketplaceEntitlementServiceEndpointRules::Rules.begin(), MarketplaceEntitlementServiceEndpointRules::Rules.end());
}

const Aws::Vector<char> MarketplaceEntitlementServiceEndpointRules::Rules = {
