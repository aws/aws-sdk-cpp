...
{
const size_t MarketplaceEntitlementServiceEndpointRules::RulesBlobStrLen = 3522;
const size_t MarketplaceEntitlementServiceEndpointRules::RulesBlobSize = 3523;

using RulesBlobT = Aws::Array<const char, MarketplaceEntitlementServiceEndpointRules::RulesBlobSize>;
...
't','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','e','n','t','i','t','l',
'e','m','e','n','t','.','m','a','r','k','e','t','p','l','a','c','e','-','f','i','p','s','.','{','R',
...
':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','e','n','t','i','t','l','e','m',
'e','n','t','.','m','a','r','k','e','t','p','l','a','c','e','-','f','i','p','s','.','{','R','e','g',
...
'p','s',':','/','/','e','n','t','i','t','l','e','m','e','n','t','.','m','a','r','k','e','t','p','l',
'a','c','e','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R','e',
...
'h','t','t','p','s',':','/','/','e','n','t','i','t','l','e','m','e','n','t','.','m','a','r','k','e',
't','p','l','a','c','e','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o',
'n','R','e','s','u','l','t','#','d','n','s','S','u','f','f','i','x','}','"',',','"','p','r','o','p',
'e','r','t','i','e','s','"',':','{','}',',','"','h','e','a','d','e','r','s','"',':','{','}','}',',',
'"','t','y','p','e','"',':','"','e','n','d','p','o','i','n','t','"','}',']','}',']','}','\0'
}};

const char* MarketplaceEntitlementServiceEndpointRules::GetRulesBlob()
{
