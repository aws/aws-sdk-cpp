...
namespace MarketplaceEntitlementService
{
  ...
  class AWS_MARKETPLACEENTITLEMENTSERVICE_API MarketplaceEntitlementServiceClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        MarketplaceEntitlementServiceClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                            std::shared_ptr<Endpoint::MarketplaceEntitlementServiceEndpointProvider> endpointProvider = Aws::MakeShared<MarketplaceEntitlementService::Endpoint::MarketplaceEntitlementServiceEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::MarketplaceEntitlementServiceEndpointProvider> m_endpointProvider;
  };
