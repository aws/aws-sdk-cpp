...
public class DirectFromC2jGenerator {
    ...
    public File generateSourceFromJson(String rawJson, String languageBinding, String serviceName, boolean generateStandalonePackage) throws Exception {
        ...
        return mainClientGenerator.generateSourceFromC2jModel(c2jServiceModel, serviceName, languageBinding, generateStandalonePackage);
    }
}
