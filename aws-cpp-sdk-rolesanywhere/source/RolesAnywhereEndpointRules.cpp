...
Aws::String RolesAnywhereEndpointRules::GetRulesAsString()
{
    return Aws::String(RolesAnywhereEndpointRules::Rules.begin(), RolesAnywhereEndpointRules::Rules.end());
}

const Aws::Vector<char> RolesAnywhereEndpointRules::Rules = {
...
't','p','s',':','/','/','r','o','l','e','s','a','n','y','w','h','e','r','e','-','f','i','p','s','.',
...
'"','h','t','t','p','s',':','/','/','r','o','l','e','s','a','n','y','w','h','e','r','e','.','{','R',
