...
DisableProfileResult::DisableProfileResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

DisableProfileResult& DisableProfileResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
