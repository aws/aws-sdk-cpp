...
namespace Model
{
  ...
  /**
   */
  class AWS_ROLESANYWHERE_API GetCrlRequest : public RolesAnywhereRequest
  {
  public:
    GetCrlRequest();
    ...
    */
    virtual Aws::UniquePtr<GetCrlRequest> Clone() const
    {
      return Aws::MakeUnique<GetCrlRequest>(GetServiceRequestName(), *this);
    }
