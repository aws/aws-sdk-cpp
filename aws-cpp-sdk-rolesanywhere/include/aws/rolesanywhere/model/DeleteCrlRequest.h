...
namespace Model
{
  ...
  /**
   */
  class AWS_ROLESANYWHERE_API DeleteCrlRequest : public RolesAnywhereRequest
  {
  public:
    DeleteCrlRequest();
    ...
    */
    virtual Aws::UniquePtr<DeleteCrlRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteCrlRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "DeleteCrl"; }
