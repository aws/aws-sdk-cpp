...
namespace Model
{
  ...
  /**
   */
  class AWS_ROLESANYWHERE_API DisableCrlRequest : public RolesAnywhereRequest
  {
  public:
    DisableCrlRequest();
    ...
    */
    virtual Aws::UniquePtr<DisableCrlRequest> Clone() const
    {
      return Aws::MakeUnique<DisableCrlRequest>(GetServiceRequestName(), *this);
    }
