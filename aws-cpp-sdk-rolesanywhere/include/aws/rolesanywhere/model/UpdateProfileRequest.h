...
namespace Model
{
  ...
  /**
   */
  class AWS_ROLESANYWHERE_API UpdateProfileRequest : public RolesAnywhereRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateProfileRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateProfileRequest>(GetServiceRequestName(), *this);
    }
