...
namespace Model
{
  ...
  /**
   */
  class AWS_ROLESANYWHERE_API CreateTrustAnchorRequest : public RolesAnywhereRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateTrustAnchorRequest> Clone() const
    {
      return Aws::MakeUnique<CreateTrustAnchorRequest>(GetServiceRequestName(), *this);
    }
