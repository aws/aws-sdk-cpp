...
namespace Model
{
  ...
  /**
   */
  class AWS_ROLESANYWHERE_API EnableCrlRequest : public RolesAnywhereRequest
  {
  public:
    EnableCrlRequest();
    ...
    */
    virtual Aws::UniquePtr<EnableCrlRequest> Clone() const
    {
      return Aws::MakeUnique<EnableCrlRequest>(GetServiceRequestName(), *this);
    }
