...
namespace Model
{
  class AWS_ROLESANYWHERE_API CreateProfileResult
  {
  public:
    CreateProfileResult();
     ...
     * <p>The state of the profile after a read or write operation.</p>
     */
    inline CreateProfileResult& WithProfile(const ProfileDetail& value) { SetProfile(value); return *this;}

    /**
     * <p>The state of the profile after a read or write operation.</p>
     */
    inline CreateProfileResult& WithProfile(ProfileDetail&& value) { SetProfile(std::move(value)); return *this;}
