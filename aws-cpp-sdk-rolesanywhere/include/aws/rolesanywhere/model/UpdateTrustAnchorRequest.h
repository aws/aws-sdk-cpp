...
namespace Model
{
  ...
  /**
   */
  class AWS_ROLESANYWHERE_API UpdateTrustAnchorRequest : public RolesAnywhereRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateTrustAnchorRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateTrustAnchorRequest>(GetServiceRequestName(), *this);
    }
