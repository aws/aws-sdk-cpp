...
namespace Model
{
  ...
  /**
   */
  class AWS_ROLESANYWHERE_API ImportCrlRequest : public RolesAnywhereRequest
  {
  public:
    ImportCrlRequest();
    ...
    */
    virtual Aws::UniquePtr<ImportCrlRequest> Clone() const
    {
      return Aws::MakeUnique<ImportCrlRequest>(GetServiceRequestName(), *this);
    }
