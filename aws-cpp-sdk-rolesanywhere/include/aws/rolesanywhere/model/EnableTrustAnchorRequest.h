...
namespace Model
{
  ...
  /**
   */
  class AWS_ROLESANYWHERE_API EnableTrustAnchorRequest : public RolesAnywhereRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<EnableTrustAnchorRequest> Clone() const
    {
      return Aws::MakeUnique<EnableTrustAnchorRequest>(GetServiceRequestName(), *this);
    }
