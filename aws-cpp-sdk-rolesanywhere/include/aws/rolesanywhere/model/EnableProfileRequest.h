...
namespace Model
{
  ...
  /**
   */
  class AWS_ROLESANYWHERE_API EnableProfileRequest : public RolesAnywhereRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<EnableProfileRequest> Clone() const
    {
      return Aws::MakeUnique<EnableProfileRequest>(GetServiceRequestName(), *this);
    }
