...
namespace Model
{
  ...
  /**
   */
  class AWS_ROLESANYWHERE_API ListCrlsRequest : public RolesAnywhereRequest
  {
  public:
    ListCrlsRequest();
    ...
    */
    virtual Aws::UniquePtr<ListCrlsRequest> Clone() const
    {
      return Aws::MakeUnique<ListCrlsRequest>(GetServiceRequestName(), *this);
    }
