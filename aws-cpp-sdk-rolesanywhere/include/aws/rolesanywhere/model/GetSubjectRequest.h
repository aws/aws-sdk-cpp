...
namespace Model
{
  ...
  /**
   */
  class AWS_ROLESANYWHERE_API GetSubjectRequest : public RolesAnywhereRequest
  {
  public:
    GetSubjectRequest();
    ...
    */
    virtual Aws::UniquePtr<GetSubjectRequest> Clone() const
    {
      return Aws::MakeUnique<GetSubjectRequest>(GetServiceRequestName(), *this);
    }
