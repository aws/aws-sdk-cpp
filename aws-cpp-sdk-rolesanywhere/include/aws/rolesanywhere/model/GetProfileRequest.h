...
namespace Model
{
  ...
  /**
   */
  class AWS_ROLESANYWHERE_API GetProfileRequest : public RolesAnywhereRequest
  {
  public:
    GetProfileRequest();
    ...
    */
    virtual Aws::UniquePtr<GetProfileRequest> Clone() const
    {
      return Aws::MakeUnique<GetProfileRequest>(GetServiceRequestName(), *this);
    }
