...
namespace Model
{
  ...
  /**
   */
  class AWS_ROLESANYWHERE_API UpdateCrlRequest : public RolesAnywhereRequest
  {
  public:
    UpdateCrlRequest();
    ...
    */
    virtual Aws::UniquePtr<UpdateCrlRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateCrlRequest>(GetServiceRequestName(), *this);
    }
