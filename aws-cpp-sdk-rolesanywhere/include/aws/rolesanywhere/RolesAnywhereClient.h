...
namespace RolesAnywhere
{
  ...
  class AWS_ROLESANYWHERE_API RolesAnywhereClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        RolesAnywhereClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                            std::shared_ptr<Endpoint::RolesAnywhereEndpointProvider> endpointProvider = Aws::MakeShared<RolesAnywhere::Endpoint::RolesAnywhereEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::RolesAnywhereEndpointProvider> m_endpointProvider;
  };
