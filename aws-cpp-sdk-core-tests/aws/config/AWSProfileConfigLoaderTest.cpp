...
static void WriteDefaultConfigFile(Aws::OStream& stream, bool useProfilePrefix = false)
{
    ...
    stream << "external_id = +CsOo4kcN4UKViieKhF7qDs46qmM974XLOzp+TEs/9M=" << std::endl;
...
TEST(AWSConfigFileProfileConfigLoaderTest, TestCredentialsFileLoad)
{
    ...
    ASSERT_STREQ("+CsOo4kcN4UKViieKhF7qDs46qmM974XLOzp+TEs/9M=", profiles["assumes_role"].GetExternalId().c_str());
