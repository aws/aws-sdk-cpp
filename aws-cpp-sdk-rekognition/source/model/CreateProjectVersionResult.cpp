...
CreateProjectVersionResult::CreateProjectVersionResult()
{
}

CreateProjectVersionResult::CreateProjectVersionResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
