...
using ResolveEndpointOutcome = Aws::Rekognition::Endpoint::RekognitionEndpointProvider::RekognitionResolveEndpointOutcome;
...
RekognitionClient::RekognitionClient(const Client::ClientConfiguration& clientConfiguration,
                                     std::shared_ptr<Endpoint::RekognitionEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<RekognitionErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<Rekognition::Endpoint::RekognitionEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
