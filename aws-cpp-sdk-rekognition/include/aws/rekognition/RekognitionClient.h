...
namespace Rekognition
{
  ...
  class AWS_REKOGNITION_API RekognitionClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        RekognitionClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                          std::shared_ptr<Endpoint::RekognitionEndpointProvider> endpointProvider = Aws::MakeShared<Rekognition::Endpoint::RekognitionEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::RekognitionEndpointProvider> m_endpointProvider;
  };
