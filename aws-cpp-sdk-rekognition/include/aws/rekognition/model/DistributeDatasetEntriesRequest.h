...
namespace Model
{
  ...
  /**
   */
  class AWS_REKOGNITION_API DistributeDatasetEntriesRequest : public RekognitionRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DistributeDatasetEntriesRequest> Clone() const
    {
      return Aws::MakeUnique<DistributeDatasetEntriesRequest>(GetServiceRequestName(), *this);
    }
