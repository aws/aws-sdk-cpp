...
namespace Model
{
  ...
  /**
   */
  class AWS_REKOGNITION_API CopyProjectVersionRequest : public RekognitionRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CopyProjectVersionRequest> Clone() const
    {
      return Aws::MakeUnique<CopyProjectVersionRequest>(GetServiceRequestName(), *this);
    }
