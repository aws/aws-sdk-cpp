...
namespace Model
{
  ...
  /**
   */
  class AWS_REKOGNITION_API DeleteProjectPolicyRequest : public RekognitionRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteProjectPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteProjectPolicyRequest>(GetServiceRequestName(), *this);
    }
