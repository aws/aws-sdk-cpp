...
namespace Model
{
  ...
  /**
   */
  class AWS_REKOGNITION_API DetectProtectiveEquipmentRequest : public RekognitionRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DetectProtectiveEquipmentRequest> Clone() const
    {
      return Aws::MakeUnique<DetectProtectiveEquipmentRequest>(GetServiceRequestName(), *this);
    }
