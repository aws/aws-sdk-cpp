...
namespace Model
{
   ...
   * <code>Pose</code>, and <code>Quality</code>.</p> <p> is the only Rekognition
   * Video stored video operation that can return a <code>FaceDetail</code> object
   * with all attributes. To specify which attributes to return, use the
   * <code>FaceAttributes</code> input parameter for . The following Rekognition
   * Video operations return only the default attributes. The corresponding Start
   * operations don't have a <code>FaceAttributes</code> input parameter.</p> <ul>
   * <li> <p>GetCelebrityRecognition</p> </li> <li> <p>GetPersonTracking</p> </li>
   * <li> <p>GetFaceSearch</p> </li> </ul> <p>The Rekognition Image and operations
