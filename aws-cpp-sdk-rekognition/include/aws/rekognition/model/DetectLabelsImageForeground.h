...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_REKOGNITION_API DetectLabelsImageForeground
  {
  public:
    DetectLabelsImageForeground();
    DetectLabelsImageForeground(Aws::Utils::Json::JsonView jsonValue);
    DetectLabelsImageForeground& operator=(Aws::Utils::Json::JsonView jsonValue);
