...
namespace Model
{
  ...
  /**
   */
  class AWS_REKOGNITION_API StopStreamProcessorRequest : public RekognitionRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StopStreamProcessorRequest> Clone() const
    {
      return Aws::MakeUnique<StopStreamProcessorRequest>(GetServiceRequestName(), *this);
    }
