...
namespace Model
{
  ...
  /**
   */
  class AWS_REKOGNITION_API ListProjectPoliciesRequest : public RekognitionRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListProjectPoliciesRequest> Clone() const
    {
      return Aws::MakeUnique<ListProjectPoliciesRequest>(GetServiceRequestName(), *this);
    }
