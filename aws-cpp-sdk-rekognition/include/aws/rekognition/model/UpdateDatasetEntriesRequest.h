...
namespace Model
{
  ...
  /**
   */
  class AWS_REKOGNITION_API UpdateDatasetEntriesRequest : public RekognitionRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateDatasetEntriesRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateDatasetEntriesRequest>(GetServiceRequestName(), *this);
    }
