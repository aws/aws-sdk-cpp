...
namespace Model
{
  ...
  /**
   */
  class AWS_REKOGNITION_API ListDatasetLabelsRequest : public RekognitionRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListDatasetLabelsRequest> Clone() const
    {
      return Aws::MakeUnique<ListDatasetLabelsRequest>(GetServiceRequestName(), *this);
    }
