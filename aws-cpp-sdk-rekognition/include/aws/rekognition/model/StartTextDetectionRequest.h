...
namespace Model
{
  ...
  /**
   */
  class AWS_REKOGNITION_API StartTextDetectionRequest : public RekognitionRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StartTextDetectionRequest> Clone() const
    {
      return Aws::MakeUnique<StartTextDetectionRequest>(GetServiceRequestName(), *this);
    }
