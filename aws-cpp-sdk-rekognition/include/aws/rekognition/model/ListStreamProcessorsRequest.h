...
namespace Model
{
  ...
  public:
     ...
     * processors to retrieve), Rekognition Video returns a pagination token in the
    ...
    /**
     * <p>Maximum number of stream processors you want Rekognition Video to return in
     * the response. The default is 1000. </p>
     */
