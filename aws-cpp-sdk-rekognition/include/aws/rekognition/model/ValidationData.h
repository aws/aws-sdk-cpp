...
namespace Model
{
   ...
   * Failed Model Training in the Amazon Rekognition Custom Labels Developer Guide.
   * </p> <p>You get the <code>ValidationData</code> object for the training dataset
   * (<a>TrainingDataResult</a>) and the test dataset (<a>TestingDataResult</a>) by
   * calling <a>DescribeProjectVersions</a>. </p> <p>The assets array contains a
   * single <a>Asset</a> object. The <a>GroundTruthManifest</a> field of the Asset
   * object contains the S3 bucket location of the validation data. </p><p><h3>See
   * Also:</h3>   <a
