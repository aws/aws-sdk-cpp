...
namespace Model
{
  ...
  public:
    ...
    inline GetLabelDetectionResult& WithBillableDurationSeconds(int value) { SetBillableDurationSeconds(value); return *this;}
    ...
    inline GetLabelDetectionResult& WithErrorCode(const Aws::String& value) { SetErrorCode(value); return *this;}

    
    inline GetLabelDetectionResult& WithErrorCode(Aws::String&& value) { SetErrorCode(std::move(value)); return *this;}

    
    inline GetLabelDetectionResult& WithErrorCode(const char* value) { SetErrorCode(value); return *this;}
    ...
    inline GetLabelDetectionResult& WithWarnings(const Aws::Vector<Warning>& value) { SetWarnings(value); return *this;}

    
    inline GetLabelDetectionResult& WithWarnings(Aws::Vector<Warning>&& value) { SetWarnings(std::move(value)); return *this;}

    
    inline GetLabelDetectionResult& AddWarnings(const Warning& value) { m_warnings.push_back(value); return *this; }

    
    inline GetLabelDetectionResult& AddWarnings(Warning&& value) { m_warnings.push_back(std::move(value)); return *this; }
