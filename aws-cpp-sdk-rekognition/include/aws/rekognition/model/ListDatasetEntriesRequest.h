...
namespace Model
{
  ...
  /**
   */
  class AWS_REKOGNITION_API ListDatasetEntriesRequest : public RekognitionRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListDatasetEntriesRequest> Clone() const
    {
      return Aws::MakeUnique<ListDatasetEntriesRequest>(GetServiceRequestName(), *this);
    }
