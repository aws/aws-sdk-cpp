...
Aws::String ChimeSDKMeetingsEndpointRules::GetRulesAsString()
{
    return Aws::String(ChimeSDKMeetingsEndpointRules::Rules.begin(), ChimeSDKMeetingsEndpointRules::Rules.end());
}

const Aws::Vector<char> ChimeSDKMeetingsEndpointRules::Rules = {
...
't','t','p','s',':','/','/','m','e','e','t','i','n','g','s','-','c','h','i','m','e','-','f','i','p',
...
'"',':','"','h','t','t','p','s',':','/','/','m','e','e','t','i','n','g','s','-','c','h','i','m','e',
...
'p','s',':','/','/','m','e','e','t','i','n','g','s','-','c','h','i','m','e','.','{','R','e','g','i',
