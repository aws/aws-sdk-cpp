...
using ResolveEndpointOutcome = Aws::ChimeSDKMeetings::Endpoint::ChimeSDKMeetingsEndpointProvider::ChimeSDKMeetingsResolveEndpointOutcome;
...
ChimeSDKMeetingsClient::ChimeSDKMeetingsClient(const Client::ClientConfiguration& clientConfiguration,
                                               std::shared_ptr<Endpoint::ChimeSDKMeetingsEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<ChimeSDKMeetingsErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<ChimeSDKMeetings::Endpoint::ChimeSDKMeetingsEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
