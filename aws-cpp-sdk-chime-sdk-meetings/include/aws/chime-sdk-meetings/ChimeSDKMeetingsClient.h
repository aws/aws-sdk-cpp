...
namespace ChimeSDKMeetings
{
  ...
  class AWS_CHIMESDKMEETINGS_API ChimeSDKMeetingsClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        ChimeSDKMeetingsClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                               std::shared_ptr<Endpoint::ChimeSDKMeetingsEndpointProvider> endpointProvider = Aws::MakeShared<ChimeSDKMeetings::Endpoint::ChimeSDKMeetingsEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::ChimeSDKMeetingsEndpointProvider> m_endpointProvider;
  };
