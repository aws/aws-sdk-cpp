...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchUpdateAttendeeCapabilitiesExceptRequest> Clone() const
    {
      return Aws::MakeUnique<BatchUpdateAttendeeCapabilitiesExceptRequest>(GetServiceRequestName(), *this);
    }
