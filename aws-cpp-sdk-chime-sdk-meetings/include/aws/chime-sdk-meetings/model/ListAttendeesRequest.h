...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIMESDKMEETINGS_API ListAttendeesRequest : public ChimeSDKMeetingsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListAttendeesRequest> Clone() const
    {
      return Aws::MakeUnique<ListAttendeesRequest>(GetServiceRequestName(), *this);
    }
