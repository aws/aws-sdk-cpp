...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIMESDKMEETINGS_API GetMeetingRequest : public ChimeSDKMeetingsRequest
  {
  public:
    GetMeetingRequest();
    ...
    */
    virtual Aws::UniquePtr<GetMeetingRequest> Clone() const
    {
      return Aws::MakeUnique<GetMeetingRequest>(GetServiceRequestName(), *this);
    }
