    ...
    namespace Client
    {
        ...
        protected:
            ...
            template<typename ClientT,
                     ...
                     typename ExecutorT>
            void MakeAsyncOperation(OperationFuncT&& operationFunc,
                                    const ClientT* clientThis,
                                    const RequestT& request,
                                    const HandlerT& handler,
                                    const HandlerContextT& context,
                                    ExecutorT* pExecutor) const
            {
            ...
            template<typename ClientT,
                     ...
                     typename OperationFuncT,
                     typename ExecutorT>
            void MakeAsyncStreamingOperation(OperationFuncT&& operationFunc,
                                             const ClientT* clientThis,
            ...
            template<typename ClientT,
                     ...
                     typename OperationFuncT,
                     typename ExecutorT>
            auto MakeCallableOperation(const char* ALLOCATION_TAG,
                                       OperationFuncT&& operationFunc,
                                       const ClientT* clientThis,
                                       const RequestT& request,
                                       ExecutorT* pExecutor) const -> std::future<decltype((clientThis->*operationFunc)(request))>
            {
            ...
            template<typename ClientT,
                     ...
                     typename OperationFuncT,
                     typename ExecutorT>
            auto MakeCallableStreamingOperation(const char* ALLOCATION_TAG,
                                                OperationFuncT&& operationFunc,
                                                const ClientT* clientThis,
                                                RequestT& request,  // note non-const ref
                                                ExecutorT* pExecutor) const -> std::future<decltype((clientThis->*operationFunc)(request))>
        ...
        private:
            ...
            std::shared_ptr<Aws::Http::HttpRequest> ConvertToRequestForPresigning(const Aws::AmazonWebServiceRequest& request, const Aws::Http::URI& uri,
