...
namespace Aws
{
    namespace Monitoring
    {
        ...
        HttpClientMetricsType AWS_CORE_API GetHttpClientMetricTypeByName(const Aws::String& name);

        Aws::String AWS_CORE_API GetHttpClientMetricNameByType(HttpClientMetricsType type);
    }
}
