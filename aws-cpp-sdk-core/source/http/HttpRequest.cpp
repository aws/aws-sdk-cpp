...
namespace Aws
{
    namespace Http
    {
        ...
        {
            auto request = Aws::MakeShared<Aws::Crt::Http::HttpRequest>("HttpRequestConvertion");
            request->SetBody(httpRequest.GetContentBody());
            ...
            request->SetPath(Aws::Crt::ByteCursorFromCString(httpRequest.GetURIString(/*default includes query string*/).c_str()));
            const char *method = HttpMethodMapper::GetNameForHttpMethod(httpRequest.GetMethod());
