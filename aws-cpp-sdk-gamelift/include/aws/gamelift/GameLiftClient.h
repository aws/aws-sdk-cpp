...
namespace Model
{
   ...
   * SDK guides and the AWS CLI reference. Useful links:</p> <ul> <li> <p> <a
    ...
    public:
      typedef Aws::Client::AWSJsonClient BASECLASS;
        ...
        */
         ...
         * with build files that are in an Amazon S3 location under an AWS account that you
         * control. To use this option, you must first give Amazon GameLift access to the
         * Amazon S3 bucket. With permissions in place, call <code>CreateBuild</code> and
         * specify a build name, operating system, and the Amazon S3 storage location of
         * your game build.</p> </li> <li> <p>To directly upload your build files to a
         * GameLift Amazon S3 location. To use this option, first call
         * <code>CreateBuild</code> and specify a build name and operating system. This
         ...
         * build files to the specified Amazon S3 location. For more information, see <a
         ...
         * running game servers on each instance.</p> <p>Most GameLift fleets can deploy
         * instances to multiple locations, including the home Region (where the fleet is
         * created) and an optional set of remote locations. Fleets that are created in the
         ...
         * multiple locations only if they reside in AWS Regions that support this feature
         * (see <a>CreateFleet</a> for the complete list) and were created after the
         * feature was released in March 2021.</p>  <p>To add fleet locations,
         * specify the fleet to be updated and provide a list of one or more locations.
         * </p> <p>If successful, this operation returns the list of added locations with
         * their status set to <code>NEW</code>. GameLift initiates the process of starting
         ...
         * game hosting on a collection of Amazon EC2 instances for game hosting. This
         * operation creates the game server group, creates an Auto Scaling group in your
         * AWS account, and establishes a link between the two groups. You can view the
         * status of your game server groups in the GameLift console. Game server group
         ...
         * to download the log files.</p> <p> <i>Available in GameLift Local.</i> </p> <p>
         * <b>Learn more</b> </p> <p> <a
         ...
         * fleet types (Spot and On-Demand), instance types, and AWS Regions. If the queue
         ...
         * needed.</p> <p>The queue configuration also determines how FleetIQ selects the
         * best available placement for a new game session. Before searching for an
         * available game server, FleetIQ first prioritizes the queue's destinations and
         * locations, with the best placement locations on top. You can set up the queue to
         ...
         * Create a game session queue</a> </p> <p> <b>Related actions</b> </p> <p>
         ...
         * the GameLift service. Player sessions cannot be updated. </p> <p> <i>Available
         * in Amazon GameLift Local.</i> </p> <p> <b>Related actions</b> </p> <p>
         ...
         * cannot be updated.</p> <p> <i>Available in Amazon GameLift Local.</i> </p> <p>
         ...
         * </p> <p> <b>Related actions</b> </p> <p> <a>CreateVpcPeeringAuthorization</a> |
         * <a>DescribeVpcPeeringAuthorizations</a> | <a>DeleteVpcPeeringAuthorization</a> |
         * <a>CreateVpcPeeringConnection</a> | <a>DescribeVpcPeeringConnections</a> |
         * <a>DeleteVpcPeeringConnection</a> | <a
         * href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All
         ...
         * Using Multi-Region Queues</a> </p> <p> <b>Related actions</b> </p> <p>
         * <a>CreateGameSessionQueue</a> | <a>DescribeGameSessionQueues</a> |
         * <a>UpdateGameSessionQueue</a> | <a>DeleteGameSessionQueue</a> | <a
         * href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All
         * APIs by task</a> </p><p><h3>See Also:</h3>   <a
         ...
         * fleet ID. If successful, the connection is removed. </p> <p> <b>Related
        ...
        /**
         * <p>The GameLift service limits and current utilization for an AWS Region or
         * location. Instance limits control the number of instances, per instance type,
         * per location, that your AWS account can use. Learn more at <a
         ...
         * ability to scale your GameLift fleets. You can request a limit increase for your
         * account by using the <b>Service limits</b> page in the GameLift console.</p>
         ...
         * must specify an AWS Region (either explicitly or as your default settings). To
         * get the limit for a remote location, you must also specify the location. For
         * example, the following requests all return different results: </p> <ul> <li>
         * <p>Request specifies the Region <code>ap-northeast-1</code> with no location.
         ...
         * instance types that are deployed in an AWS Region by fleets that reside in the
         * same Region: Specify the Region only. Optionally, specify a single instance type
         * to retrieve information for.</p> </li> <li> <p>To get limit and usage data for
         * all instance types that are deployed to a remote location by fleets that reside
         * in different AWS Region: Provide both the AWS Region and the remote location.
         * Optionally, specify a single instance type to retrieve information for.</p>
         * </li> </ul> <p>If successful, an <code>EC2InstanceLimits</code> object is
         * returned with limits and usage data for each requested instance type.</p> <p>
         * <b>Learn more</b> </p> <p> <a
         * href="https://docs.aws.amazon.com/gamelift/latest/developerguide/fleets-intro.html">Setting
         * up GameLift fleets</a> </p> <p> <b>Related actions</b> </p> <p>
         ...
         * fleets that reside in the AWS Region defined in the request.</p> </li> </ul>
         * <p>Use the pagination parameters to retrieve results as a set of sequential
         * pages. </p> <p>If successful, a <code>GameSessionDetail</code> object is
         * returned for each game session that matches the request.</p> <p> <b>Learn
         * more</b> </p> <p> <a
         ...
         * placement ID.</p> <p>If successful, a <a>GameSessionPlacement</a> object is
         * returned.</p> <p> <b>Related actions</b> </p> <p> <a>CreateGameSession</a> |
         ...
         * View Your Queues</a> </p> <p> <b>Related actions</b> </p> <p>
         * <a>CreateGameSessionQueue</a> | <a>DescribeGameSessionQueues</a> |
         * <a>UpdateGameSessionQueue</a> | <a>DeleteGameSessionQueue</a> | <a
         * href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All
         * APIs by task</a> </p><p><h3>See Also:</h3>   <a
         ...
         * operation can be used in the following ways: </p> <ul> <li> <p>To retrieve all
         * game sessions that are currently running on all locations in a fleet, provide a
         * fleet or alias ID, with an optional status filter. This approach returns all
         * game sessions in the fleet's home Region and all remote locations.</p> </li>
         * <li> <p>To retrieve all game sessions that are currently running on a specific
         * fleet location, provide a fleet or alias ID and a location name, with optional
         * status filter. The location can be the fleet's home Region or any remote
         * location.</p> </li> <li> <p>To retrieve a specific game session, provide the
         * game session ID. This approach looks for the game session ID in all fleets that
         * reside in the AWS Region defined in the request.</p> </li> </ul> <p>Use the
         * pagination parameters to retrieve results as a set of sequential pages. </p>
         * <p>If successful, a <code>GameSession</code> object is returned for each game
         * session that matches the request.</p> <p> <i>Available in GameLift Local.</i>
         ...
         * identify the IpV4 CIDR block that the VPC uses to connect. </p> <p> <b>Related
         * actions</b> </p> <p> <a>CreateVpcPeeringAuthorization</a> |
         * <a>DescribeVpcPeeringAuthorizations</a> | <a>DeleteVpcPeeringAuthorization</a> |
         * <a>CreateVpcPeeringConnection</a> | <a>DescribeVpcPeeringConnections</a> |
         * <a>DeleteVpcPeeringConnection</a> | <a
         ...
         * limit are not saved.</p>  <p> <b>Related actions</b> </p> <p>
         * <a>CreateGameSession</a> | <a>DescribeGameSessions</a> |
         * <a>DescribeGameSessionDetails</a> | <a>SearchGameSessions</a> |
         * <a>UpdateGameSession</a> | <a>GetGameSessionLogUrl</a> |
         * <a>StartGameSessionPlacement</a> | <a>DescribeGameSessionPlacement</a> |
         ...
         * listed in any particular order.</p>  <p> <b>Related actions</b> </p> <p>
        ...
        /**
         * <p>Retrieves a collection of fleet resources in an AWS Region. You can call this
         * operation to get fleets in a previously selected default Region (see <a
         ...
         * in the current AWS account for the selected Region. Use the pagination
         ...
         * sorts them into a specified order. </p> <p>When searching for game sessions, you
         * specify exactly where you want to search and provide a search filter expression,
         * a sort expression, or both. A search request can search only one fleet, but it
         * can search all of a fleet's locations. </p> <p>This operation can be used in the
         * following ways: </p> <ul> <li> <p>To search all game sessions that are currently
         * running on all locations in a fleet, provide a fleet or alias ID. This approach
         * returns game sessions in the fleet's home Region and all remote locations that
         * fit the search criteria.</p> </li> <li> <p>To search all game sessions that are
         * currently running on a specific fleet location, provide a fleet or alias ID and
         * a location name. For location, you can specify a fleet's home Region or any
         * remote location.</p> </li> </ul> <p>Use the pagination parameters to retrieve
         * results as a set of sequential pages. </p> <p>If successful, a
         * <code>GameSession</code> object is returned for each game session that matches
         * the request. Search finds game sessions that are in <code>ACTIVE</code> status
         * only. To retrieve information on game sessions in other statuses, use
         * <a>DescribeGameSessions</a>.</p> <p>You can search or sort by the following game
         ...
         * using the same method for tracking tickets for new matches.</p> <p> <b>Learn
         * more</b> </p> <p> <a
         ...
         * through Amazon Simple Notification Service (SNS), which is defined in the
         ...
         * of EC2 instances to be maintained in a fleet location. Before changing a fleet's
         * desired capacity, you may want to call <a>DescribeEC2InstanceLimits</a> to get
         * the maximum capacity of the fleet's EC2 instance type. Alternatively, consider
         * using automatic scaling to adjust capacity based on player demand.</p> </li>
         * </ul> <p>This operation can be used in the following ways: </p> <ul> <li> <p>To
         * update capacity for a fleet's home Region, or if the fleet has no remote
         * locations, omit the <code>Location</code> parameter. The fleet must be in
         * <code>ACTIVE</code> status. </p> </li> <li> <p>To update capacity for a fleet's
         * remote location, include the <code>Location</code> parameter set to the location
         * to be updated. The location must be in <code>ACTIVE</code> status.</p> </li>
         * </ul> <p>If successful, capacity settings are updated immediately. In response a
         * change in desired capacity, GameLift initiates steps to start new instances or
         ...
         * <a>DescribeFleetCapacity</a> or <a>DescribeFleetLocationCapacity</a>. If the
         * requested desired instance count is higher than the instance type's limit, the
         * <code>LimitExceeded</code> exception occurs.</p> <p> <b>Learn more</b> </p> <p>
         * <a
