...
namespace GameLift
{
  ...
  class AWS_GAMELIFT_API GameLiftClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        GameLiftClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                       std::shared_ptr<Endpoint::GameLiftEndpointProvider> endpointProvider = Aws::MakeShared<GameLift::Endpoint::GameLiftEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::GameLiftEndpointProvider> m_endpointProvider;
  };
