...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteVpcPeeringAuthorizationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteVpcPeeringAuthorizationRequest>(GetServiceRequestName(), *this);
    }
