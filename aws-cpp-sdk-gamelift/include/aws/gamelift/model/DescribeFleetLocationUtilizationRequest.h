...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/gamelift-2015-10-01/DescribeFleetLocationUtilizationInput">AWS
   * API Reference</a></p>
   */
  class AWS_GAMELIFT_API DescribeFleetLocationUtilizationRequest : public GameLiftRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeFleetLocationUtilizationRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeFleetLocationUtilizationRequest>(GetServiceRequestName(), *this);
    }
