...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeRuntimeConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeRuntimeConfigurationRequest>(GetServiceRequestName(), *this);
    }
