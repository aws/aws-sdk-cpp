...
namespace Model
{
  ...
  /**
   */
  class AWS_GAMELIFT_API TagResourceRequest : public GameLiftRequest
  {
  public:
    TagResourceRequest();
     ...
     * to assign tags to. GameLift resource ARNs are included in the data object for
    ...
    /**
     * <p>A list of one or more tags to assign to the specified GameLift resource. Tags
