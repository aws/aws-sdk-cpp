...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateMatchmakingConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<CreateMatchmakingConfigurationRequest>(GetServiceRequestName(), *this);
    }
