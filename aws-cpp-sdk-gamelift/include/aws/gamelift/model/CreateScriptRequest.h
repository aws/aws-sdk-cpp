...
namespace Model
{
  ...
  /**
   */
  class AWS_GAMELIFT_API CreateScriptRequest : public GameLiftRequest
  {
  public:
    CreateScriptRequest();
    ...
    */
    virtual Aws::UniquePtr<CreateScriptRequest> Clone() const
    {
      return Aws::MakeUnique<CreateScriptRequest>(GetServiceRequestName(), *this);
    }
