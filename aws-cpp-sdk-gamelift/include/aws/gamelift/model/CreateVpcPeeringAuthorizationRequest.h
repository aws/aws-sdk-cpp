...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/gamelift-2015-10-01/CreateVpcPeeringAuthorizationInput">AWS
   * API Reference</a></p>
   */
  class AWS_GAMELIFT_API CreateVpcPeeringAuthorizationRequest : public GameLiftRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateVpcPeeringAuthorizationRequest> Clone() const
    {
      return Aws::MakeUnique<CreateVpcPeeringAuthorizationRequest>(GetServiceRequestName(), *this);
    }
