...
namespace Model
{
  ...
  /**
   */
  class AWS_GAMELIFT_API DescribeGameServerGroupRequest : public GameLiftRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeGameServerGroupRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeGameServerGroupRequest>(GetServiceRequestName(), *this);
    }
