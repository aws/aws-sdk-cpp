...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeFleetLocationAttributesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeFleetLocationAttributesRequest>(GetServiceRequestName(), *this);
    }
