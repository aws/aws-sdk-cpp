...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/gamelift-2015-10-01/DescribeFleetLocationCapacityInput">AWS
   * API Reference</a></p>
   */
  class AWS_GAMELIFT_API DescribeFleetLocationCapacityRequest : public GameLiftRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeFleetLocationCapacityRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeFleetLocationCapacityRequest>(GetServiceRequestName(), *this);
    }
