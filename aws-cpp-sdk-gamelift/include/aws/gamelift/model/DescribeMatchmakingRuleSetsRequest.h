...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeMatchmakingRuleSetsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeMatchmakingRuleSetsRequest>(GetServiceRequestName(), *this);
    }
