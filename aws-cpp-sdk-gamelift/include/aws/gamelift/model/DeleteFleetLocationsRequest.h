...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/gamelift-2015-10-01/DeleteFleetLocationsInput">AWS
   * API Reference</a></p>
   */
  class AWS_GAMELIFT_API DeleteFleetLocationsRequest : public GameLiftRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteFleetLocationsRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteFleetLocationsRequest>(GetServiceRequestName(), *this);
    }
