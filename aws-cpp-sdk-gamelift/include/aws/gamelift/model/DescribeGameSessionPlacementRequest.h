...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeGameSessionPlacementRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeGameSessionPlacementRequest>(GetServiceRequestName(), *this);
    }
