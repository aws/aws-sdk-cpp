...
namespace Model
{
  ...
  public:
     ...
     * ignored when the request specifies one or a list of fleet IDs.</p>
     */
    inline DescribeFleetUtilizationRequest& WithLimit(long value) { SetLimit(value); return *this;}
     ...
     * request specifies one or a list of fleet IDs.</p>
     */
    inline DescribeFleetUtilizationRequest& WithNextToken(Aws::String&& value) { SetNextToken(value); return *this;}
