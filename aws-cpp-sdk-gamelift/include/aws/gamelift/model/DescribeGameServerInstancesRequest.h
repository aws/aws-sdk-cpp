...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeGameServerInstancesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeGameServerInstancesRequest>(GetServiceRequestName(), *this);
    }
