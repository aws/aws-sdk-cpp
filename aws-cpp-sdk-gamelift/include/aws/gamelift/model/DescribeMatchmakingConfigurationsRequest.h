...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeMatchmakingConfigurationsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeMatchmakingConfigurationsRequest>(GetServiceRequestName(), *this);
    }
