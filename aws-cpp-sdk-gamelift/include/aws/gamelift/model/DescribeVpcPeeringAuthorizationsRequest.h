...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeVpcPeeringAuthorizationsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeVpcPeeringAuthorizationsRequest>(GetServiceRequestName(), *this);
    }
