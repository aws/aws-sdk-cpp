...
namespace Model
{
  ...
  public:
    ...
    inline virtual const char* GetServiceRequestName() override { return "CreateGameSessionQueue"; }
     ...
     * MaximumIndividualPlayerLatencyMilliseconds; if none is set, this API requests
     * will fail.</p>
     */
