...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateMatchmakingConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateMatchmakingConfigurationRequest>(GetServiceRequestName(), *this);
    }
