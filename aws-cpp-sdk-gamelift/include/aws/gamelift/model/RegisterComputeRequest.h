...
namespace Model
{
  ...
  /**
   */
  class AWS_GAMELIFT_API RegisterComputeRequest : public GameLiftRequest
  {
  public:
    ...
    /**
     * <p>The name of the custom location you added to the fleet you are registering
     * this compute resource to.</p>
     */
