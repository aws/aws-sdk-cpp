...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/gamelift-2015-10-01/DeleteMatchmakingConfigurationInput">AWS
   * API Reference</a></p>
   */
  class AWS_GAMELIFT_API DeleteMatchmakingConfigurationRequest : public GameLiftRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteMatchmakingConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteMatchmakingConfigurationRequest>(GetServiceRequestName(), *this);
    }
