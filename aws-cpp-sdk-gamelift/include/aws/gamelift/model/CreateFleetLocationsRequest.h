...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/gamelift-2015-10-01/CreateFleetLocationsInput">AWS
   * API Reference</a></p>
   */
  class AWS_GAMELIFT_API CreateFleetLocationsRequest : public GameLiftRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateFleetLocationsRequest> Clone() const
    {
      return Aws::MakeUnique<CreateFleetLocationsRequest>(GetServiceRequestName(), *this);
    }
