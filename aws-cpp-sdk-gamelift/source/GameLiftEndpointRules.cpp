...
namespace GameLift
{
const size_t GameLiftEndpointRules::RulesBlobStrLen = 3461;
const size_t GameLiftEndpointRules::RulesBlobSize = 3462;
...
'a','m','e','l','i','f','t','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i',
...
'l','"',':','"','h','t','t','p','s',':','/','/','g','a','m','e','l','i','f','t','.','{','R','e','g',
