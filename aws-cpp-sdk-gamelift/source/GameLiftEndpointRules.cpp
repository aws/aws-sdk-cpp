...
Aws::String GameLiftEndpointRules::GetRulesAsString()
{
    return Aws::String(GameLiftEndpointRules::Rules.begin(), GameLiftEndpointRules::Rules.end());
}

const Aws::Vector<char> GameLiftEndpointRules::Rules = {
...
't','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','g','a','m','e','l','i',
'f','t','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i',
...
'g','a','m','e','l','i','f','t','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t',
...
'r','l','"',':','"','h','t','t','p','s',':','/','/','g','a','m','e','l','i','f','t','.','{','R','e',
