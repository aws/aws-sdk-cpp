...
static const int INVALID_CLUSTER_STATE_HASH = HashingUtils::HashString("InvalidClusterState");
static const int CLUSTER_PARAMETER_GROUP_ALREADY_EXISTS_HASH = HashingUtils::HashString("ClusterParameterGroupAlreadyExists");
static const int CLUSTER_SUBNET_GROUP_QUOTA_EXCEEDED_HASH = HashingUtils::HashString("ClusterSubnetGroupQuotaExceeded");
...
static const int CLUSTER_NOT_FOUND_HASH = HashingUtils::HashString("ClusterNotFound");
static const int CLUSTER_PARAMETER_GROUP_NOT_FOUND_HASH = HashingUtils::HashString("ClusterParameterGroupNotFound");
static const int AUTHORIZATION_QUOTA_EXCEEDED_HASH = HashingUtils::HashString("AuthorizationQuotaExceeded");
static const int ACCESS_TO_SNAPSHOT_DENIED_HASH = HashingUtils::HashString("AccessToSnapshotDenied");
static const int CLUSTER_PARAMETER_GROUP_QUOTA_EXCEEDED_HASH = HashingUtils::HashString("ClusterParameterGroupQuotaExceeded");
static const int RESERVED_NODE_QUOTA_EXCEEDED_HASH = HashingUtils::HashString("ReservedNodeQuotaExceeded");
static const int NUMBER_OF_NODES_QUOTA_EXCEEDED_HASH = HashingUtils::HashString("NumberOfNodesQuotaExceeded");
static const int CLUSTER_SNAPSHOT_ALREADY_EXISTS_HASH = HashingUtils::HashString("ClusterSnapshotAlreadyExists");
...
static const int SUBSCRIPTION_EVENT_ID_NOT_FOUND_HASH = HashingUtils::HashString("SubscriptionEventIdNotFound");
static const int CLUSTER_SNAPSHOT_NOT_FOUND_HASH = HashingUtils::HashString("ClusterSnapshotNotFound");
static const int SNAPSHOT_COPY_ALREADY_DISABLED_FAULT_HASH = HashingUtils::HashString("SnapshotCopyAlreadyDisabledFault");
static const int CLUSTER_SUBNET_GROUP_ALREADY_EXISTS_HASH = HashingUtils::HashString("ClusterSubnetGroupAlreadyExists");
...
static const int CLUSTER_SNAPSHOT_QUOTA_EXCEEDED_HASH = HashingUtils::HashString("ClusterSnapshotQuotaExceeded");
...
static const int INVALID_RESTORE_HASH = HashingUtils::HashString("InvalidRestore");
static const int SOURCE_NOT_FOUND_HASH = HashingUtils::HashString("SourceNotFound");
static const int NUMBER_OF_NODES_PER_CLUSTER_LIMIT_EXCEEDED_HASH = HashingUtils::HashString("NumberOfNodesPerClusterLimitExceeded");
static const int QUOTA_EXCEEDED__CLUSTER_SECURITY_GROUP_HASH = HashingUtils::HashString("QuotaExceeded.ClusterSecurityGroup");
...
static const int RESERVED_NODE_OFFERING_NOT_FOUND_HASH = HashingUtils::HashString("ReservedNodeOfferingNotFound");
static const int INVALID_CLUSTER_SNAPSHOT_STATE_HASH = HashingUtils::HashString("InvalidClusterSnapshotState");
static const int HSM_CLIENT_CERTIFICATE_NOT_FOUND_FAULT_HASH = HashingUtils::HashString("HsmClientCertificateNotFoundFault");
static const int INVALID_CLUSTER_PARAMETER_GROUP_STATE_HASH = HashingUtils::HashString("InvalidClusterParameterGroupState");
static const int INSUFFICIENT_CLUSTER_CAPACITY_HASH = HashingUtils::HashString("InsufficientClusterCapacity");
...
static const int INVALID_CLUSTER_SECURITY_GROUP_STATE_HASH = HashingUtils::HashString("InvalidClusterSecurityGroupState");
...
static const int CLUSTER_SECURITY_GROUP_NOT_FOUND_HASH = HashingUtils::HashString("ClusterSecurityGroupNotFound");
...
static const int RESERVED_NODE_ALREADY_EXISTS_HASH = HashingUtils::HashString("ReservedNodeAlreadyExists");
static const int CLUSTER_SECURITY_GROUP_ALREADY_EXISTS_HASH = HashingUtils::HashString("ClusterSecurityGroupAlreadyExists");
...
static const int SUBSCRIPTION_SEVERITY_NOT_FOUND_HASH = HashingUtils::HashString("SubscriptionSeverityNotFound");
static const int RESIZE_NOT_FOUND_HASH = HashingUtils::HashString("ResizeNotFound");
static const int EVENT_SUBSCRIPTION_QUOTA_EXCEEDED_HASH = HashingUtils::HashString("EventSubscriptionQuotaExceeded");
static const int CLUSTER_QUOTA_EXCEEDED_HASH = HashingUtils::HashString("ClusterQuotaExceeded");
...
static const int CLUSTER_ALREADY_EXISTS_HASH = HashingUtils::HashString("ClusterAlreadyExists");
...
static const int RESERVED_NODE_NOT_FOUND_HASH = HashingUtils::HashString("ReservedNodeNotFound");
...
AWSError<CoreErrors> GetErrorForName(const char* errorName)
{
  ...
  if (hashCode == INVALID_S3_KEY_PREFIX_FAULT_HASH)
  {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(RedshiftErrors::INVALID_S3_KEY_PREFIX_FAULT), false);
  }
  else if (hashCode == INVALID_CLUSTER_STATE_HASH)
  {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(RedshiftErrors::INVALID_CLUSTER_STATE), false);
  }
  else if (hashCode == CLUSTER_PARAMETER_GROUP_ALREADY_EXISTS_HASH)
  {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(RedshiftErrors::CLUSTER_PARAMETER_GROUP_ALREADY_EXISTS), false);
  }
  else if (hashCode == CLUSTER_SUBNET_GROUP_QUOTA_EXCEEDED_HASH)
  {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(RedshiftErrors::CLUSTER_SUBNET_GROUP_QUOTA_EXCEEDED), false);
  }
  else if (hashCode == SUBSCRIPTION_ALREADY_EXIST_HASH)
  {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(RedshiftErrors::SUBSCRIPTION_ALREADY_EXIST), false);
  }
  ...
  {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(RedshiftErrors::CLUSTER_NOT_FOUND), false);
  }
  else if (hashCode == CLUSTER_PARAMETER_GROUP_NOT_FOUND_HASH)
  {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(RedshiftErrors::CLUSTER_PARAMETER_GROUP_NOT_FOUND), false);
  }
  else if (hashCode == AUTHORIZATION_QUOTA_EXCEEDED_HASH)
  {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(RedshiftErrors::AUTHORIZATION_QUOTA_EXCEEDED), false);
  }
  else if (hashCode == ACCESS_TO_SNAPSHOT_DENIED_HASH)
  {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(RedshiftErrors::ACCESS_TO_SNAPSHOT_DENIED), false);
  }
  else if (hashCode == CLUSTER_PARAMETER_GROUP_QUOTA_EXCEEDED_HASH)
  {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(RedshiftErrors::CLUSTER_PARAMETER_GROUP_QUOTA_EXCEEDED), false);
  }
  else if (hashCode == RESERVED_NODE_QUOTA_EXCEEDED_HASH)
  {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(RedshiftErrors::RESERVED_NODE_QUOTA_EXCEEDED), false);
  }
  else if (hashCode == NUMBER_OF_NODES_QUOTA_EXCEEDED_HASH)
  {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(RedshiftErrors::NUMBER_OF_NODES_QUOTA_EXCEEDED), false);
  }
  else if (hashCode == CLUSTER_SNAPSHOT_ALREADY_EXISTS_HASH)
  {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(RedshiftErrors::CLUSTER_SNAPSHOT_ALREADY_EXISTS), false);
  }
  ...
  else if (hashCode == SUBSCRIPTION_EVENT_ID_NOT_FOUND_HASH)
  {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(RedshiftErrors::SUBSCRIPTION_EVENT_ID_NOT_FOUND), false);
  }
  else if (hashCode == CLUSTER_SNAPSHOT_NOT_FOUND_HASH)
  {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(RedshiftErrors::CLUSTER_SNAPSHOT_NOT_FOUND), false);
  }
  ...
  else if (hashCode == CLUSTER_SUBNET_GROUP_ALREADY_EXISTS_HASH)
  {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(RedshiftErrors::CLUSTER_SUBNET_GROUP_ALREADY_EXISTS), false);
  }
  ...
  else if (hashCode == CLUSTER_SNAPSHOT_QUOTA_EXCEEDED_HASH)
  {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(RedshiftErrors::CLUSTER_SNAPSHOT_QUOTA_EXCEEDED), false);
  }
  ...
  {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(RedshiftErrors::UNSUPPORTED_OPERATION), false);
  }
  else if (hashCode == S_N_S_NO_AUTHORIZATION_HASH)
  {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(RedshiftErrors::S_N_S_NO_AUTHORIZATION), false);
  }
  ...
  else if (hashCode == INVALID_RESTORE_HASH)
  {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(RedshiftErrors::INVALID_RESTORE), false);
  }
  else if (hashCode == SOURCE_NOT_FOUND_HASH)
  {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(RedshiftErrors::SOURCE_NOT_FOUND), false);
  }
  else if (hashCode == NUMBER_OF_NODES_PER_CLUSTER_LIMIT_EXCEEDED_HASH)
  {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(RedshiftErrors::NUMBER_OF_NODES_PER_CLUSTER_LIMIT_EXCEEDED), false);
  }
  else if (hashCode == QUOTA_EXCEEDED__CLUSTER_SECURITY_GROUP_HASH)
  {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(RedshiftErrors::QUOTA_EXCEEDED__CLUSTER_SECURITY_GROUP), false);
  }
  ...
  {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(RedshiftErrors::S_N_S_INVALID_TOPIC), false);
  }
  ...
  else if (hashCode == RESERVED_NODE_OFFERING_NOT_FOUND_HASH)
  {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(RedshiftErrors::RESERVED_NODE_OFFERING_NOT_FOUND), false);
  }
  else if (hashCode == INVALID_CLUSTER_SNAPSHOT_STATE_HASH)
  {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(RedshiftErrors::INVALID_CLUSTER_SNAPSHOT_STATE), false);
  }
  ...
  else if (hashCode == INVALID_CLUSTER_PARAMETER_GROUP_STATE_HASH)
  {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(RedshiftErrors::INVALID_CLUSTER_PARAMETER_GROUP_STATE), false);
  }
  else if (hashCode == INSUFFICIENT_CLUSTER_CAPACITY_HASH)
  {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(RedshiftErrors::INSUFFICIENT_CLUSTER_CAPACITY), false);
  }
  ...
  {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(RedshiftErrors::S_N_S_TOPIC_ARN_NOT_FOUND), false);
  }
  else if (hashCode == INVALID_CLUSTER_SECURITY_GROUP_STATE_HASH)
  {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(RedshiftErrors::INVALID_CLUSTER_SECURITY_GROUP_STATE), false);
  }
  ...
  {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(RedshiftErrors::AUTHORIZATION_NOT_FOUND), false);
  }
  ...
  else if (hashCode == CLUSTER_SECURITY_GROUP_NOT_FOUND_HASH)
  {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(RedshiftErrors::CLUSTER_SECURITY_GROUP_NOT_FOUND), false);
  }
  ...
  {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(RedshiftErrors::AUTHORIZATION_ALREADY_EXISTS), false);
  }
  ...
  else if (hashCode == RESERVED_NODE_ALREADY_EXISTS_HASH)
  {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(RedshiftErrors::RESERVED_NODE_ALREADY_EXISTS), false);
  }
  else if (hashCode == CLUSTER_SECURITY_GROUP_ALREADY_EXISTS_HASH)
  {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(RedshiftErrors::CLUSTER_SECURITY_GROUP_ALREADY_EXISTS), false);
  }
  else if (hashCode == SUBSCRIPTION_NOT_FOUND_HASH)
  {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(RedshiftErrors::SUBSCRIPTION_NOT_FOUND), false);
  }
  ...
  else if (hashCode == SUBSCRIPTION_SEVERITY_NOT_FOUND_HASH)
  {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(RedshiftErrors::SUBSCRIPTION_SEVERITY_NOT_FOUND), false);
  }
  else if (hashCode == RESIZE_NOT_FOUND_HASH)
  {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(RedshiftErrors::RESIZE_NOT_FOUND), false);
  }
  else if (hashCode == EVENT_SUBSCRIPTION_QUOTA_EXCEEDED_HASH)
  {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(RedshiftErrors::EVENT_SUBSCRIPTION_QUOTA_EXCEEDED), false);
  }
  else if (hashCode == CLUSTER_QUOTA_EXCEEDED_HASH)
  {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(RedshiftErrors::CLUSTER_QUOTA_EXCEEDED), false);
  }
  else if (hashCode == SUBSCRIPTION_CATEGORY_NOT_FOUND_HASH)
  {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(RedshiftErrors::SUBSCRIPTION_CATEGORY_NOT_FOUND), false);
  }
  ...
  else if (hashCode == CLUSTER_ALREADY_EXISTS_HASH)
  {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(RedshiftErrors::CLUSTER_ALREADY_EXISTS), false);
  }
  ...
  else if (hashCode == RESERVED_NODE_NOT_FOUND_HASH)
  {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(RedshiftErrors::RESERVED_NODE_NOT_FOUND), false);
  }
