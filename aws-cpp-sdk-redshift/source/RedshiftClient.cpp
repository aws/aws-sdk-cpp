...
using ResolveEndpointOutcome = Aws::Redshift::Endpoint::RedshiftEndpointProvider::RedshiftResolveEndpointOutcome;
...
RedshiftClient::RedshiftClient(const Client::ClientConfiguration& clientConfiguration,
                               std::shared_ptr<Endpoint::RedshiftEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<RedshiftErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<Redshift::Endpoint::RedshiftEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
