...
EnableSnapshotCopyResult::EnableSnapshotCopyResult(const AmazonWebServiceResult<XmlDocument>& result)
{
  *this = result;
}

EnableSnapshotCopyResult& EnableSnapshotCopyResult::operator =(const AmazonWebServiceResult<XmlDocument>& result)
{
  const XmlDocument& xmlDocument = result.GetPayload();
  XmlNode rootNode = xmlDocument.GetRootElement();
  XmlNode resultNode = rootNode;
  if (!rootNode.IsNull() && (rootNode.GetName() != "EnableSnapshotCopyResult"))
  {
