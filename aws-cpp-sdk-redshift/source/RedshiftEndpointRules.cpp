...
Aws::String RedshiftEndpointRules::GetRulesAsString()
{
    return Aws::String(RedshiftEndpointRules::Rules.begin(), RedshiftEndpointRules::Rules.end());
}

const Aws::Vector<char> RedshiftEndpointRules::Rules = {
