...
namespace Redshift
{
const size_t RedshiftEndpointRules::RulesBlobStrLen = 3462;
const size_t RedshiftEndpointRules::RulesBlobSize = 3463;
...
'/','/','r','e','d','s','h','i','f','t','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.',
...
'r','e','d','s','h','i','f','t','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t',
