...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p> The size of the complete set of backup data that would be used to restore
     * the cluster. </p>
     */
    ...
    /**
     * <p> The number of megabytes that have been transferred to the snapshot backup.
     * </p>
     */
