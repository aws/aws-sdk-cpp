...
namespace Model
{
  ...
  /**
   */
  class AWS_REDSHIFT_API CreateAuthenticationProfileRequest : public RedshiftRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateAuthenticationProfileRequest> Clone() const
    {
      return Aws::MakeUnique<CreateAuthenticationProfileRequest>(GetServiceRequestName(), *this);
    }
