...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AuthorizeClusterSecurityGroupIngressRequest> Clone() const
    {
      return Aws::MakeUnique<AuthorizeClusterSecurityGroupIngressRequest>(GetServiceRequestName(), *this);
    }
