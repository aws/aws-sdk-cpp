...
namespace Model
{
  ...
  /**
   */
  class AWS_REDSHIFT_API RejectDataShareRequest : public RedshiftRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<RejectDataShareRequest> Clone() const
    {
      return Aws::MakeUnique<RejectDataShareRequest>(GetServiceRequestName(), *this);
    }
