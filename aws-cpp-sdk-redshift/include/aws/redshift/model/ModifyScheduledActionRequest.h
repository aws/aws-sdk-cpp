...
namespace Model
{
  ...
  /**
   */
  class AWS_REDSHIFT_API ModifyScheduledActionRequest : public RedshiftRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ModifyScheduledActionRequest> Clone() const
    {
      return Aws::MakeUnique<ModifyScheduledActionRequest>(GetServiceRequestName(), *this);
    }
