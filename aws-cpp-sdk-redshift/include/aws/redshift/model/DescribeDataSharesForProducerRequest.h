...
namespace Model
{
  ...
  /**
   */
  class AWS_REDSHIFT_API DescribeDataSharesForProducerRequest : public RedshiftRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeDataSharesForProducerRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeDataSharesForProducerRequest>(GetServiceRequestName(), *this);
    }
