...
namespace Model
{
  ...
  /**
   */
  class AWS_REDSHIFT_API DescribeAuthenticationProfilesRequest : public RedshiftRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeAuthenticationProfilesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeAuthenticationProfilesRequest>(GetServiceRequestName(), *this);
    }
