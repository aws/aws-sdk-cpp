...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeClusterSecurityGroupsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeClusterSecurityGroupsRequest>(GetServiceRequestName(), *this);
    }
