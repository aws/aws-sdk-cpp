...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<RevokeClusterSecurityGroupIngressRequest> Clone() const
    {
      return Aws::MakeUnique<RevokeClusterSecurityGroupIngressRequest>(GetServiceRequestName(), *this);
    }
