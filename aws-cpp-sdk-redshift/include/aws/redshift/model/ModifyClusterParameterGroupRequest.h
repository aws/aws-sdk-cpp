...
namespace Model
{
  ...
  public:
     ...
     * modified in a single request. </p> <p> For each parameter to be modified, you
     * must supply at least the parameter name and parameter value; other name-value
     * pairs of the parameter are optional. </p> <p> For the workload management (WLM)
