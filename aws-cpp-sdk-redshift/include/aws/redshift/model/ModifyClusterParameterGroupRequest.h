...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ModifyClusterParameterGroupRequest> Clone() const
    {
      return Aws::MakeUnique<ModifyClusterParameterGroupRequest>(GetServiceRequestName(), *this);
    }
