...
namespace Model
{
  ...
  /**
   */
  class AWS_REDSHIFT_API AuthorizeEndpointAccessRequest : public RedshiftRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AuthorizeEndpointAccessRequest> Clone() const
    {
      return Aws::MakeUnique<AuthorizeEndpointAccessRequest>(GetServiceRequestName(), *this);
    }
