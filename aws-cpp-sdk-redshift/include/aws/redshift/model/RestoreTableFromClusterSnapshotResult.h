...
namespace Model
{
  ...
  public:
    ...
    inline void SetTableRestoreStatus(TableRestoreStatus&& value) { m_tableRestoreStatus = value; }
    ...
    inline RestoreTableFromClusterSnapshotResult& WithTableRestoreStatus(TableRestoreStatus&& value) { SetTableRestoreStatus(value); return *this;}
    ...
    inline RestoreTableFromClusterSnapshotResult& WithResponseMetadata(ResponseMetadata&& value) { SetResponseMetadata(value); return *this;}
