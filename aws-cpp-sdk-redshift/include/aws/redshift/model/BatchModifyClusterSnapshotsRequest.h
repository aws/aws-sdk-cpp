...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchModifyClusterSnapshotsRequest> Clone() const
    {
      return Aws::MakeUnique<BatchModifyClusterSnapshotsRequest>(GetServiceRequestName(), *this);
    }
