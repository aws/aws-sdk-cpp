...
namespace Model
{
  ...
  /**
   */
  class AWS_REDSHIFT_API ModifyUsageLimitRequest : public RedshiftRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ModifyUsageLimitRequest> Clone() const
    {
      return Aws::MakeUnique<ModifyUsageLimitRequest>(GetServiceRequestName(), *this);
    }
