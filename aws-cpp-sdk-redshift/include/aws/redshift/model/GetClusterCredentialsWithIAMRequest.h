...
namespace Model
{
  ...
  /**
   */
  class AWS_REDSHIFT_API GetClusterCredentialsWithIAMRequest : public RedshiftRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetClusterCredentialsWithIAMRequest> Clone() const
    {
      return Aws::MakeUnique<GetClusterCredentialsWithIAMRequest>(GetServiceRequestName(), *this);
    }
