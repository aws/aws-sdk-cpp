...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeClusterSubnetGroupsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeClusterSubnetGroupsRequest>(GetServiceRequestName(), *this);
    }
