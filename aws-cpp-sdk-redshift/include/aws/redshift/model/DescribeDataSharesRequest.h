...
namespace Model
{
  ...
  /**
   */
  class AWS_REDSHIFT_API DescribeDataSharesRequest : public RedshiftRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeDataSharesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeDataSharesRequest>(GetServiceRequestName(), *this);
    }
