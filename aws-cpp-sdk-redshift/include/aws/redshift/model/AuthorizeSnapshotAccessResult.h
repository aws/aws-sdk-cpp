...
namespace Model
{
  ...
  public:
    ...
    AuthorizeSnapshotAccessResult(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    AuthorizeSnapshotAccessResult& operator=(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    ...
    inline AuthorizeSnapshotAccessResult& WithSnapshot(Snapshot&& value) { SetSnapshot(value); return *this;}
    ...
    inline AuthorizeSnapshotAccessResult& WithResponseMetadata(ResponseMetadata&& value) { SetResponseMetadata(value); return *this;}
