...
namespace Model
{
  ...
  /**
   */
  class AWS_REDSHIFT_API DeauthorizeDataShareRequest : public RedshiftRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeauthorizeDataShareRequest> Clone() const
    {
      return Aws::MakeUnique<DeauthorizeDataShareRequest>(GetServiceRequestName(), *this);
    }
