...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_REDSHIFT_API AuthorizeEndpointAccessResult
  {
  public:
    ...
    AuthorizeEndpointAccessResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
