...
namespace Model
{
  ...
  public:
    ...
    CreateClusterSnapshotResult(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    CreateClusterSnapshotResult& operator=(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    ...
    inline CreateClusterSnapshotResult& WithSnapshot(Snapshot&& value) { SetSnapshot(value); return *this;}
    ...
    inline CreateClusterSnapshotResult& WithResponseMetadata(ResponseMetadata&& value) { SetResponseMetadata(value); return *this;}
