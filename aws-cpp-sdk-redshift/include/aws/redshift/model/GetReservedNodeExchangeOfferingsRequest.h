...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetReservedNodeExchangeOfferingsRequest> Clone() const
    {
      return Aws::MakeUnique<GetReservedNodeExchangeOfferingsRequest>(GetServiceRequestName(), *this);
    }
