...
namespace Model
{
  ...
  /**
   */
  class AWS_REDSHIFT_API ModifyAuthenticationProfileRequest : public RedshiftRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ModifyAuthenticationProfileRequest> Clone() const
    {
      return Aws::MakeUnique<ModifyAuthenticationProfileRequest>(GetServiceRequestName(), *this);
    }
