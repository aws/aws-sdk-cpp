...
namespace Model
{
  ...
  public:
     ...
     * maximum 100.</p>
     */
    inline DescribeClustersRequest& WithMaxRecords(long value) { SetMaxRecords(value); return *this;}
     ...
     * You can specify either the <b>ClusterIdentifier</b> parameter or the
