...
namespace Model
{
  ...
  public:
     ...
     * alphanumeric characters or hyphens.</li> <li>Alphabetic characters must be
     * lowercase.</li> <li>First character must be a letter.</li> <li>Cannot end with a
     * hyphen or contain two consecutive hyphens.</li> <li>Must be unique for all
     * clusters within an AWS account.</li> </ul> </p>
     */
    ...
    /**
     * <p> The name of the snapshot from which to create the new cluster. This
     * parameter isn't case sensitive. </p> <p>Example: <code>my-snapshot-id</code></p>
     */
    ...
    /**
     * <p> If <code>true</code>, the cluster can be accessed from a public network.
     * </p>
     */
    ...
    /**
     * <p> The AWS customer account used to create or copy the snapshot. Required if
     ...
     * with Amazon Redshift Parameter Groups</a>.</p> <p> Constraints: </p> <ul>
    ...
    /**
     * <p> A list of security groups to be associated with this cluster. </p> <p>
     * Default: The default cluster security group for Amazon Redshift. </p> <p>Cluster
     * security groups only apply to clusters outside of VPCs.</p>
     */
    ...
    /**
     * <p> The weekly time range (in UTC) during which automated cluster maintenance
     * can occur. </p> <p> Format: <code>ddd:hh24:mi-ddd:hh24:mi</code> </p> <p>
    ...
    /**
     * <p> The node type that the restored cluster will be provisioned with.</p> <p>
     * Default: The node type of the cluster from which the snapshot was taken. You can
     * modify this if you are using any DS node type. In that case, you can choose to
     * restore into another DS node type of the same size. For example, you can restore
     * ds1.8xlarge into ds2.8xlarge, or ds2.xlarge into ds1.xlarge. If you have a DC
     * instance type, you must restore into that same instance type and size. In other
     * words, you can only restore a dc1.large instance type into another dc1.large
     * instance type. For more information about node types, see <a
