...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeEndpointAuthorizationRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeEndpointAuthorizationRequest>(GetServiceRequestName(), *this);
    }
