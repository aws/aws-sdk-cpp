...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchDeleteClusterSnapshotsRequest> Clone() const
    {
      return Aws::MakeUnique<BatchDeleteClusterSnapshotsRequest>(GetServiceRequestName(), *this);
    }
