...
namespace Model
{
  ...
  /**
   */
  class AWS_REDSHIFT_API DeleteAuthenticationProfileRequest : public RedshiftRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteAuthenticationProfileRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteAuthenticationProfileRequest>(GetServiceRequestName(), *this);
    }
