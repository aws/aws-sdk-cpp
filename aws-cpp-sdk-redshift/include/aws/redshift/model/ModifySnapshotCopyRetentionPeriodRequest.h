...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ModifySnapshotCopyRetentionPeriodRequest> Clone() const
    {
      return Aws::MakeUnique<ModifySnapshotCopyRetentionPeriodRequest>(GetServiceRequestName(), *this);
    }
