...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_REDSHIFT_API DescribeDefaultClusterParametersRequest : public RedshiftRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeDefaultClusterParametersRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeDefaultClusterParametersRequest>(GetServiceRequestName(), *this);
    }
