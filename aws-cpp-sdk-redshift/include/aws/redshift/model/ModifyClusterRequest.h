...
namespace Model
{
  ...
  public:
     ...
     * <code>examplecluster</code></p>
     */
    inline ModifyClusterRequest& WithClusterIdentifier(Aws::String&& value) { SetClusterIdentifier(value); return *this;}
     ...
     * resize request. </p> <p>Valid Values: <code> multi-node | single-node
     * </code></p>
     */
     ...
     * </code></p>
     */
    inline ModifyClusterRequest& WithClusterType(Aws::String&& value) { SetClusterType(value); return *this;}
     ...
     * also specify the number of nodes parameter. </p> <p> When you submit your
     ...
     * <code>dc1.large</code> | <code>dc1.8xlarge</code>.</p>
     */
    inline ModifyClusterRequest& WithNodeType(Aws::String&& value) { SetNodeType(value); return *this;}
     ...
     * nodes, you must also specify the node type parameter. </p> <p> When you submit
     * your request to resize a cluster, Amazon Redshift sets access permissions for
     * the cluster to read-only. After Amazon Redshift provisions a new cluster
     * according to your resize requirements, there will be a temporary outage while
     * the old cluster is deleted and your connection is switched to the new cluster.
     * When the new connection is complete, the original access permissions for the
     * cluster are restored. You can use <a>DescribeResize</a> to track the progress of
     ...
     * will be revoked from the cluster.</p> <p>Constraints:</p> <ul> <li>Must be 1 to
     * 255 alphanumeric characters or hyphens</li> <li>First character must be a
     ...
     * </ul>
     */
    inline ModifyClusterRequest& WithClusterSecurityGroups(Aws::Vector<Aws::String>&& value) { SetClusterSecurityGroups(value); return *this;}
     ...
     * </ul>
     */
    inline ModifyClusterRequest& AddClusterSecurityGroups(Aws::String&& value) { m_clusterSecurityGroupsHasBeenSet = true; m_clusterSecurityGroups.push_back(value); return *this; }
     ...
     * the cluster. </p>
     */
    inline ModifyClusterRequest& WithVpcSecurityGroupIds(Aws::Vector<Aws::String>&& value) { SetVpcSecurityGroupIds(value); return *this;}
     ...
     * the cluster. </p>
     */
    inline ModifyClusterRequest& AddVpcSecurityGroupIds(Aws::String&& value) { m_vpcSecurityGroupIdsHasBeenSet = true; m_vpcSecurityGroupIds.push_back(value); return *this; }
     ...
     * <code>PendingModifiedValues</code> element of the operation response. <note>
     * Operations never return the password, so this operation provides a way to regain
     * access to the master user account for a cluster if the password is lost. </note>
     * </p> <p>Default: Uses existing setting.</p> <p> Constraints: </p> <ul> <li>Must
     * be between 8 and 64 characters in length.</li> <li>Must contain at least one
     * uppercase letter.</li> <li>Must contain at least one lowercase letter.</li>
     * <li>Must contain one number.</li> <li>Can be any printable ASCII character
     ...
     * space.</li> </ul>
     */
    inline ModifyClusterRequest& WithMasterUserPassword(Aws::String&& value) { SetMasterUserPassword(value); return *this;}
    ...
    /**
     * <p> The name of the cluster parameter group to apply to this cluster. This
     ...
     * family that matches the cluster version.</p>
     */
    inline ModifyClusterRequest& WithClusterParameterGroupName(Aws::String&& value) { SetClusterParameterGroupName(value); return *this;}
     ...
     * in an outage. </p> <p> This maintenance window change is made immediately. If
     * the new maintenance window indicates the current time, there must be at least
     * 120 minutes between the current time and end of the window in order to ensure
     * that pending changes are applied. </p> <p>Default: Uses existing setting.</p>
     ...
     * | Sat | Sun</p> <p>Constraints: Must be at least 30 minutes.</p>
     */
    inline ModifyClusterRequest& WithPreferredMaintenanceWindow(Aws::String&& value) { SetPreferredMaintenanceWindow(value); return *this;}
    ...
    /**
     * <p> The new version number of the Amazon Redshift engine to upgrade to. </p> <p>
     ...
     * Guide</i>. </p> <p>Example: <code>1.0</code></p>
     */
    inline ModifyClusterRequest& WithClusterVersion(Aws::String&& value) { SetClusterVersion(value); return *this;}
    ...
    /**
     * <p> If <code>true</code>, major version upgrades will be applied automatically
     * to the cluster during the maintenance window. </p> <p>Default:
     * <code>false</code></p>
     */
     ...
     * uses to retrieve the data encryption keys stored in an HSM.</p>
     */
    inline ModifyClusterRequest& WithHsmClientCertificateIdentifier(Aws::String&& value) { SetHsmClientCertificateIdentifier(value); return *this;}
     ...
     * Amazon Redshift cluster can use to retrieve and store keys in an HSM.</p>
     */
    inline ModifyClusterRequest& WithHsmConfigurationIdentifier(Aws::String&& value) { SetHsmConfigurationIdentifier(value); return *this;}
    ...
    /**
     * <p>The new identifier for the cluster.</p> <p>Constraints:</p> <ul> <li>Must
     * contain from 1 to 63 alphanumeric characters or hyphens.</li> <li>Alphabetic
     * characters must be lowercase.</li> <li>First character must be a letter.</li>
     * <li>Cannot end with a hyphen or contain two consecutive hyphens.</li> <li>Must
     * be unique for all clusters within an AWS account.</li> </ul> <p>Example:
     * <code>examplecluster</code></p>
     */
     ...
     * <code>examplecluster</code></p>
     */
    inline void SetNewClusterIdentifier(Aws::String&& value) { m_newClusterIdentifierHasBeenSet = true; m_newClusterIdentifier = value; }
     ...
     * <code>examplecluster</code></p>
     */
    inline ModifyClusterRequest& WithNewClusterIdentifier(Aws::String&& value) { SetNewClusterIdentifier(value); return *this;}
     ...
     * Guide.</p>
     */
    inline ModifyClusterRequest& WithElasticIp(Aws::String&& value) { SetElasticIp(value); return *this;}
