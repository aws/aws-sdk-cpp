...
namespace Model
{
  ...
  /**
   */
  class AWS_REDSHIFT_API DescribeScheduledActionsRequest : public RedshiftRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeScheduledActionsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeScheduledActionsRequest>(GetServiceRequestName(), *this);
    }
