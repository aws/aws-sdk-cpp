...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateDataShareConsumerRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateDataShareConsumerRequest>(GetServiceRequestName(), *this);
    }
