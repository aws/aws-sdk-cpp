...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeClusterParameterGroupsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeClusterParameterGroupsRequest>(GetServiceRequestName(), *this);
    }
