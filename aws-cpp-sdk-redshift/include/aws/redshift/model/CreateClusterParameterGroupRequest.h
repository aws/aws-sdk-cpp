...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateClusterParameterGroupRequest> Clone() const
    {
      return Aws::MakeUnique<CreateClusterParameterGroupRequest>(GetServiceRequestName(), *this);
    }
