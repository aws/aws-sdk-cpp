...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PurchaseReservedNodeOfferingRequest> Clone() const
    {
      return Aws::MakeUnique<PurchaseReservedNodeOfferingRequest>(GetServiceRequestName(), *this);
    }
