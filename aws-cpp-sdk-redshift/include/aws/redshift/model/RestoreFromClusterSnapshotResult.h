...
namespace Model
{
  ...
  public:
    ...
    inline RestoreFromClusterSnapshotResult& WithCluster(Cluster&& value) { SetCluster(value); return *this;}
    ...
    inline RestoreFromClusterSnapshotResult& WithResponseMetadata(ResponseMetadata&& value) { SetResponseMetadata(value); return *this;}
