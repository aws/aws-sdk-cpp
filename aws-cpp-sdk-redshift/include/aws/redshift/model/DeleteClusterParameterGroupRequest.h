...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteClusterParameterGroupRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteClusterParameterGroupRequest>(GetServiceRequestName(), *this);
    }
