...
namespace Model
{
  ...
  /**
   */
  class AWS_REDSHIFT_API DescribeReservedNodeExchangeStatusRequest : public RedshiftRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeReservedNodeExchangeStatusRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeReservedNodeExchangeStatusRequest>(GetServiceRequestName(), *this);
    }
