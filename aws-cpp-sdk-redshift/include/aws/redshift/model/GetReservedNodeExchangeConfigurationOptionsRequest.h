...
namespace Model
{
  ...
  /**
   */
  class AWS_REDSHIFT_API GetReservedNodeExchangeConfigurationOptionsRequest : public RedshiftRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetReservedNodeExchangeConfigurationOptionsRequest> Clone() const
    {
      return Aws::MakeUnique<GetReservedNodeExchangeConfigurationOptionsRequest>(GetServiceRequestName(), *this);
    }
