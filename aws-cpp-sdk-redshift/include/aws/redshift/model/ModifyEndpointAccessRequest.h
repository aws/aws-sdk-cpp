...
namespace Model
{
  ...
  /**
   */
  class AWS_REDSHIFT_API ModifyEndpointAccessRequest : public RedshiftRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ModifyEndpointAccessRequest> Clone() const
    {
      return Aws::MakeUnique<ModifyEndpointAccessRequest>(GetServiceRequestName(), *this);
    }
