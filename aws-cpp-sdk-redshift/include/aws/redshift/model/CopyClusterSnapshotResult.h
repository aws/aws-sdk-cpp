...
namespace Model
{
  ...
  public:
    ...
    CopyClusterSnapshotResult(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    CopyClusterSnapshotResult& operator=(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    ...
    inline CopyClusterSnapshotResult& WithSnapshot(Snapshot&& value) { SetSnapshot(value); return *this;}
    ...
    inline CopyClusterSnapshotResult& WithResponseMetadata(ResponseMetadata&& value) { SetResponseMetadata(value); return *this;}
