...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeHsmClientCertificatesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeHsmClientCertificatesRequest>(GetServiceRequestName(), *this);
    }
