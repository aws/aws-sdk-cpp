...
namespace Model
{
  class AWS_REDSHIFT_API ModifyClusterIamRolesResult
  {
  public:
    ...
    inline ModifyClusterIamRolesResult& WithCluster(Cluster&& value) { SetCluster(value); return *this;}
    ...
    inline ModifyClusterIamRolesResult& WithResponseMetadata(ResponseMetadata&& value) { SetResponseMetadata(value); return *this;}
