...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeOrderableClusterOptionsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeOrderableClusterOptionsRequest>(GetServiceRequestName(), *this);
    }
