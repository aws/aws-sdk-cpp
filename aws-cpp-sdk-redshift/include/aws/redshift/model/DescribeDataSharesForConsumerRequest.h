...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeDataSharesForConsumerRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeDataSharesForConsumerRequest>(GetServiceRequestName(), *this);
    }
