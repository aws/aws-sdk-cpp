...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeNodeConfigurationOptionsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeNodeConfigurationOptionsRequest>(GetServiceRequestName(), *this);
    }
