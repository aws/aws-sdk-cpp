...
namespace Model
{
  ...
  public:
     ...
     * database that is specified in <b>DBName</b>. </p>
     */
     ...
     * database was not specified, a database named "dev" was created by default. </p>
     */
     ...
     * groups are used when the cluster is not created in a VPC. Clusters that are
     * created in a VPC use VPC security groups, which are listed by the
     * <b>VpcSecurityGroups</b> parameter. </p>
     */
    ...
    /**
     * <p> A list of Virtual Private Cloud (VPC) security groups that are associated
    ...
    /**
     * <p> If present, changes to the cluster are pending. Specific pending changes are
    ...
    /**
     * <p> The version ID of the Amazon Redshift engine that is running on the cluster.
     * </p>
     */
     ...
     * to the cluster during the maintenance window. </p>
     */
    ...
    /**
     * <p> Describes the status of a cluster restore action. Returns null if the
     * cluster was not created by restoring a snapshot. </p>
     */
    ...
    /**
     * <p>The AWS Key Management Service (KMS) key ID of the encryption key used to
