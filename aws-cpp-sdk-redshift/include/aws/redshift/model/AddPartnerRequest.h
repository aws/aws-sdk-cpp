...
namespace Model
{
  ...
  /**
   */
  class AWS_REDSHIFT_API AddPartnerRequest : public RedshiftRequest
  {
  public:
    AddPartnerRequest();
    ...
    */
    virtual Aws::UniquePtr<AddPartnerRequest> Clone() const
    {
      return Aws::MakeUnique<AddPartnerRequest>(GetServiceRequestName(), *this);
    }
