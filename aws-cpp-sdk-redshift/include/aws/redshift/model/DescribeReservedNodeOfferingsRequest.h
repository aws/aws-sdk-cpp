...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeReservedNodeOfferingsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeReservedNodeOfferingsRequest>(GetServiceRequestName(), *this);
    }
