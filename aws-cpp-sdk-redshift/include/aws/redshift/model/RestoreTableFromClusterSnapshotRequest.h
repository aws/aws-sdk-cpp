...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<RestoreTableFromClusterSnapshotRequest> Clone() const
    {
      return Aws::MakeUnique<RestoreTableFromClusterSnapshotRequest>(GetServiceRequestName(), *this);
    }
