...
namespace Model
{
  ...
  /**
   */
  class AWS_REDSHIFT_API UpdatePartnerStatusRequest : public RedshiftRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdatePartnerStatusRequest> Clone() const
    {
      return Aws::MakeUnique<UpdatePartnerStatusRequest>(GetServiceRequestName(), *this);
    }
