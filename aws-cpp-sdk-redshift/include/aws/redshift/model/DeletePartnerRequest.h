...
namespace Model
{
  ...
  /**
   */
  class AWS_REDSHIFT_API DeletePartnerRequest : public RedshiftRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeletePartnerRequest> Clone() const
    {
      return Aws::MakeUnique<DeletePartnerRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "DeletePartner"; }
