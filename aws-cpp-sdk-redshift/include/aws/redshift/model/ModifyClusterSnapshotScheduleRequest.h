...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ModifyClusterSnapshotScheduleRequest> Clone() const
    {
      return Aws::MakeUnique<ModifyClusterSnapshotScheduleRequest>(GetServiceRequestName(), *this);
    }
