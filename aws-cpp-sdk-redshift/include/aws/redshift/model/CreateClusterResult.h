...
namespace Model
{
  ...
  public:
    CreateClusterResult();
    CreateClusterResult(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    CreateClusterResult& operator=(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
