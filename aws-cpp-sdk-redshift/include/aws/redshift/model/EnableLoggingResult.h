...
namespace Model
{
  ...
  public:
     ...
     * <p>The last time that logs were delivered.</p>
     */
    inline EnableLoggingResult& WithLastSuccessfulDeliveryTime(Aws::Utils::DateTime&& value) { SetLastSuccessfulDeliveryTime(value); return *this;}
     ...
     * <p>The last time when logs failed to be delivered.</p>
     */
    inline EnableLoggingResult& WithLastFailureTime(Aws::Utils::DateTime&& value) { SetLastFailureTime(value); return *this;}
