...
namespace Redshift
{
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        RedshiftClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                       std::shared_ptr<Endpoint::RedshiftEndpointProvider> endpointProvider = Aws::MakeShared<Redshift::Endpoint::RedshiftEndpointProvider>(ALLOCATION_TAG));
  ...
  private:
        ...
        std::shared_ptr<Endpoint::RedshiftEndpointProvider> m_endpointProvider;
  };
