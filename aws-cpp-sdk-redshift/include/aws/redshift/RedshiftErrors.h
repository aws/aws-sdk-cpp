...
enum class AWS_REDSHIFT_API RedshiftErrors
{
  ...
  ACCESS_TO_SNAPSHOT_DENIED= static_cast<int>(Client::CoreErrors::SERVICE_EXTENSION_START_RANGE) + 1,
  ...
  CLUSTER_NOT_FOUND,
  CLUSTER_PARAMETER_GROUP_ALREADY_EXISTS,
  CLUSTER_PARAMETER_GROUP_NOT_FOUND,
  CLUSTER_PARAMETER_GROUP_QUOTA_EXCEEDED,
  CLUSTER_QUOTA_EXCEEDED,
  CLUSTER_SECURITY_GROUP_ALREADY_EXISTS,
  CLUSTER_SECURITY_GROUP_NOT_FOUND,
  CLUSTER_SNAPSHOT_ALREADY_EXISTS,
  CLUSTER_SNAPSHOT_NOT_FOUND,
  CLUSTER_SNAPSHOT_QUOTA_EXCEEDED,
  CLUSTER_SUBNET_GROUP_ALREADY_EXISTS,
  CLUSTER_SUBNET_GROUP_NOT_FOUND_FAULT,
  CLUSTER_SUBNET_GROUP_QUOTA_EXCEEDED,
  ...
  INVALID_CLUSTER_PARAMETER_GROUP_STATE,
  INVALID_CLUSTER_SECURITY_GROUP_STATE,
  INVALID_CLUSTER_SNAPSHOT_STATE,
  INVALID_CLUSTER_STATE,
  ...
  NUMBER_OF_NODES_PER_CLUSTER_LIMIT_EXCEEDED,
  NUMBER_OF_NODES_QUOTA_EXCEEDED,
  QUOTA_EXCEEDED__CLUSTER_SECURITY_GROUP,
  RESERVED_NODE_ALREADY_EXISTS,
  RESERVED_NODE_NOT_FOUND,
  RESERVED_NODE_OFFERING_NOT_FOUND,
  RESERVED_NODE_QUOTA_EXCEEDED,
  RESIZE_NOT_FOUND,
  ...
  SUBSCRIPTION_EVENT_ID_NOT_FOUND,
  SUBSCRIPTION_NOT_FOUND,
  SUBSCRIPTION_SEVERITY_NOT_FOUND,
  S_N_S_INVALID_TOPIC,
