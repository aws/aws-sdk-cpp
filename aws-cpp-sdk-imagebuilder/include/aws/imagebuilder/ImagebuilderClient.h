...
namespace imagebuilder
{
  ...
  class AWS_IMAGEBUILDER_API ImagebuilderClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        ImagebuilderClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                           std::shared_ptr<Endpoint::ImagebuilderEndpointProvider> endpointProvider = Aws::MakeShared<imagebuilder::Endpoint::ImagebuilderEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::ImagebuilderEndpointProvider> m_endpointProvider;
  };
