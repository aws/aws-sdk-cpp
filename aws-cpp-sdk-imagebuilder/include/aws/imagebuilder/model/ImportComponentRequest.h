...
namespace Model
{
  ...
  /**
   */
  class AWS_IMAGEBUILDER_API ImportComponentRequest : public ImagebuilderRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ImportComponentRequest> Clone() const
    {
      return Aws::MakeUnique<ImportComponentRequest>(GetServiceRequestName(), *this);
    }
