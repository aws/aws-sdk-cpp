...
namespace Model
{
   ...
   * build instances.</p><p><h3>See Also:</h3>   <a
  ...
  public:
     ...
     * launch your build instance.</p>  <p>The userDataOverride property replaces
     * any commands that Image Builder might have added to ensure that SSM is installed
     * on your Linux build instance. If you override the user data, make sure that you
     * add commands to install SSM, if it is not pre-installed on your source
     * image.</p> 
     */
