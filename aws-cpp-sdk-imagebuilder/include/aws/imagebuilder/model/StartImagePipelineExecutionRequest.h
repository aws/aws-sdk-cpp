...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<StartImagePipelineExecutionRequest> Clone() const
    {
      return Aws::MakeUnique<StartImagePipelineExecutionRequest>(GetServiceRequestName(), *this);
    }
