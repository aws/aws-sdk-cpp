...
namespace Model
{
  ...
  /**
   */
  class AWS_IMAGEBUILDER_API CreateContainerRecipeRequest : public ImagebuilderRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateContainerRecipeRequest> Clone() const
    {
      return Aws::MakeUnique<CreateContainerRecipeRequest>(GetServiceRequestName(), *this);
    }
