...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetDistributionConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<GetDistributionConfigurationRequest>(GetServiceRequestName(), *this);
    }
