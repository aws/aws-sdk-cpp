...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateInfrastructureConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<CreateInfrastructureConfigurationRequest>(GetServiceRequestName(), *this);
    }
