...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListInfrastructureConfigurationsRequest> Clone() const
    {
      return Aws::MakeUnique<ListInfrastructureConfigurationsRequest>(GetServiceRequestName(), *this);
    }
