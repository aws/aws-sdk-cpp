...
namespace Model
{
  ...
  /**
   */
  class AWS_IMAGEBUILDER_API GetImageRecipeRequest : public ImagebuilderRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetImageRecipeRequest> Clone() const
    {
      return Aws::MakeUnique<GetImageRecipeRequest>(GetServiceRequestName(), *this);
    }
