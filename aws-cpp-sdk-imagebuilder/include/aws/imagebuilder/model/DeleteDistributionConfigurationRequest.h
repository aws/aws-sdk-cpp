...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteDistributionConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteDistributionConfigurationRequest>(GetServiceRequestName(), *this);
    }
