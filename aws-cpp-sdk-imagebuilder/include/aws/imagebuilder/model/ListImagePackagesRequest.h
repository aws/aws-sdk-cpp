...
namespace Model
{
  ...
  /**
   */
  class AWS_IMAGEBUILDER_API ListImagePackagesRequest : public ImagebuilderRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListImagePackagesRequest> Clone() const
    {
      return Aws::MakeUnique<ListImagePackagesRequest>(GetServiceRequestName(), *this);
    }
