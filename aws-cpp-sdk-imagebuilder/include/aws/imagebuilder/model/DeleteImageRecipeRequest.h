...
namespace Model
{
  ...
  /**
   */
  class AWS_IMAGEBUILDER_API DeleteImageRecipeRequest : public ImagebuilderRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteImageRecipeRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteImageRecipeRequest>(GetServiceRequestName(), *this);
    }
