...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateDistributionConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateDistributionConfigurationRequest>(GetServiceRequestName(), *this);
    }
