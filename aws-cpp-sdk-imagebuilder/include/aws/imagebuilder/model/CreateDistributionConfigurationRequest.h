...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateDistributionConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<CreateDistributionConfigurationRequest>(GetServiceRequestName(), *this);
    }
