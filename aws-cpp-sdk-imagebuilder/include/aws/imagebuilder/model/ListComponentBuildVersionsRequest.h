...
namespace Model
{
  ...
  /**
   */
  class AWS_IMAGEBUILDER_API ListComponentBuildVersionsRequest : public ImagebuilderRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListComponentBuildVersionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListComponentBuildVersionsRequest>(GetServiceRequestName(), *this);
    }
