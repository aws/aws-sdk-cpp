...
namespace Model
{
  ...
  /**
   */
  class AWS_IMAGEBUILDER_API GetContainerRecipePolicyRequest : public ImagebuilderRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetContainerRecipePolicyRequest> Clone() const
    {
      return Aws::MakeUnique<GetContainerRecipePolicyRequest>(GetServiceRequestName(), *this);
    }
