...
namespace Model
{
  ...
  /**
   */
  class AWS_IMAGEBUILDER_API PutContainerRecipePolicyRequest : public ImagebuilderRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutContainerRecipePolicyRequest> Clone() const
    {
      return Aws::MakeUnique<PutContainerRecipePolicyRequest>(GetServiceRequestName(), *this);
    }
