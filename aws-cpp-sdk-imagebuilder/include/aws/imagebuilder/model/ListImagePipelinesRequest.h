...
namespace Model
{
  ...
  /**
   */
  class AWS_IMAGEBUILDER_API ListImagePipelinesRequest : public ImagebuilderRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListImagePipelinesRequest> Clone() const
    {
      return Aws::MakeUnique<ListImagePipelinesRequest>(GetServiceRequestName(), *this);
    }
