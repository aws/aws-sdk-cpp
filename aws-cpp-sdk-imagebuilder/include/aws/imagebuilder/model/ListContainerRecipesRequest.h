...
namespace Model
{
  ...
  /**
   */
  class AWS_IMAGEBUILDER_API ListContainerRecipesRequest : public ImagebuilderRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListContainerRecipesRequest> Clone() const
    {
      return Aws::MakeUnique<ListContainerRecipesRequest>(GetServiceRequestName(), *this);
    }
