...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateInfrastructureConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateInfrastructureConfigurationRequest>(GetServiceRequestName(), *this);
    }
