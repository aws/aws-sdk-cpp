...
namespace Model
{
  ...
  /**
   */
  class AWS_IMAGEBUILDER_API ListComponentsRequest : public ImagebuilderRequest
  {
  public:
    ...
    /**
     * <p> The owner defines which components you want to list. By default, this
     * request will only show components owned by your account. You can use this field
     * to specify if you want to view components owned by yourself, by Amazon, or those
