...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteInfrastructureConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteInfrastructureConfigurationRequest>(GetServiceRequestName(), *this);
    }
