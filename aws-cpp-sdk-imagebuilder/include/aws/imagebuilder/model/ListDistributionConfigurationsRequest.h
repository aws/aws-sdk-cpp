...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListDistributionConfigurationsRequest> Clone() const
    {
      return Aws::MakeUnique<ListDistributionConfigurationsRequest>(GetServiceRequestName(), *this);
    }
