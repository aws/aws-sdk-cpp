...
namespace Model
{
  ...
  /**
   */
  class AWS_IMAGEBUILDER_API GetImageRecipePolicyRequest : public ImagebuilderRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetImageRecipePolicyRequest> Clone() const
    {
      return Aws::MakeUnique<GetImageRecipePolicyRequest>(GetServiceRequestName(), *this);
    }
