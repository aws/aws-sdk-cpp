...
namespace Model
{
  ...
  /**
   */
  class AWS_IMAGEBUILDER_API CreateImagePipelineRequest : public ImagebuilderRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateImagePipelineRequest> Clone() const
    {
      return Aws::MakeUnique<CreateImagePipelineRequest>(GetServiceRequestName(), *this);
    }
