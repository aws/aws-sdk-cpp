...
{
const size_t ImagebuilderEndpointRules::RulesBlobStrLen = 3436;
const size_t ImagebuilderEndpointRules::RulesBlobSize = 3437;
...
'{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','i','m','a','g','e','b','u','i','l',
...
'h','t','t','p','s',':','/','/','i','m','a','g','e','b','u','i','l','d','e','r','.','{','R','e','g',
