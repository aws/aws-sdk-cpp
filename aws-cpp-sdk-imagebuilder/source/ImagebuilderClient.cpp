...
using ResolveEndpointOutcome = Aws::imagebuilder::Endpoint::imagebuilderEndpointProvider::ImagebuilderResolveEndpointOutcome;
...
ImagebuilderClient::ImagebuilderClient(const Client::ClientConfiguration& clientConfiguration,
                                       std::shared_ptr<Endpoint::ImagebuilderEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<ImagebuilderErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<imagebuilder::Endpoint::ImagebuilderEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
