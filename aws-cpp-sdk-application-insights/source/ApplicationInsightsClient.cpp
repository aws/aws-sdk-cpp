...
using ResolveEndpointOutcome = Aws::ApplicationInsights::Endpoint::ApplicationInsightsEndpointProvider::ApplicationInsightsResolveEndpointOutcome;
...
ApplicationInsightsClient::ApplicationInsightsClient(const Client::ClientConfiguration& clientConfiguration,
                                                     std::shared_ptr<Endpoint::ApplicationInsightsEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<ApplicationInsightsErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<ApplicationInsights::Endpoint::ApplicationInsightsEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
