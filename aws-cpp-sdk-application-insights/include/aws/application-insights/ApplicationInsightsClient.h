...
namespace ApplicationInsights
{
  ...
  class AWS_APPLICATIONINSIGHTS_API ApplicationInsightsClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        ApplicationInsightsClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                  std::shared_ptr<Endpoint::ApplicationInsightsEndpointProvider> endpointProvider = Aws::MakeShared<ApplicationInsights::Endpoint::ApplicationInsightsEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::ApplicationInsightsEndpointProvider> m_endpointProvider;
  };
