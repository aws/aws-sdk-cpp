...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeProblemObservationsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeProblemObservationsRequest>(GetServiceRequestName(), *this);
    }
