...
namespace Model
{
  ...
  /**
   */
  class AWS_APPLICATIONINSIGHTS_API DescribeLogPatternRequest : public ApplicationInsightsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeLogPatternRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeLogPatternRequest>(GetServiceRequestName(), *this);
    }
