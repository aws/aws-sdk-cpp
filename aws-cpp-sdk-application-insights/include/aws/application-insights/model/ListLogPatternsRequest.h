...
namespace Model
{
  ...
  /**
   */
  class AWS_APPLICATIONINSIGHTS_API ListLogPatternsRequest : public ApplicationInsightsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListLogPatternsRequest> Clone() const
    {
      return Aws::MakeUnique<ListLogPatternsRequest>(GetServiceRequestName(), *this);
    }
