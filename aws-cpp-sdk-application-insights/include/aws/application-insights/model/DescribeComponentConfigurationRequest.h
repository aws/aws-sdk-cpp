...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeComponentConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeComponentConfigurationRequest>(GetServiceRequestName(), *this);
    }
