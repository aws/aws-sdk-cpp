...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateComponentConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateComponentConfigurationRequest>(GetServiceRequestName(), *this);
    }
