...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeComponentConfigurationRecommendationRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeComponentConfigurationRecommendationRequest>(GetServiceRequestName(), *this);
    }
