...
namespace CloudSearchDomain
{
  ...
  class AWS_CLOUDSEARCHDOMAIN_API CloudSearchDomainClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        CloudSearchDomainClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                std::shared_ptr<Endpoint::CloudSearchDomainEndpointProvider> endpointProvider = Aws::MakeShared<CloudSearchDomain::Endpoint::CloudSearchDomainEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::CloudSearchDomainEndpointProvider> m_endpointProvider;
  };
