...
Aws::String CloudSearchDomainEndpointRules::GetRulesAsString()
{
    return Aws::String(CloudSearchDomainEndpointRules::Rules.begin(), CloudSearchDomainEndpointRules::Rules.end());
}

const Aws::Vector<char> CloudSearchDomainEndpointRules::Rules = {
