...
{
const size_t CloudSearchDomainEndpointRules::RulesBlobStrLen = 3456;
const size_t CloudSearchDomainEndpointRules::RulesBlobSize = 3457;
...
'o','u','d','s','e','a','r','c','h','d','o','m','a','i','n','.','{','R','e','g','i','o','n','}','.',
