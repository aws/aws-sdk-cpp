...
namespace RoboMaker
{
  ...
  class AWS_ROBOMAKER_API RoboMakerClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        RoboMakerClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                        std::shared_ptr<Endpoint::RoboMakerEndpointProvider> endpointProvider = Aws::MakeShared<RoboMaker::Endpoint::RoboMakerEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::RoboMakerEndpointProvider> m_endpointProvider;
  };
