...
namespace Model
{
  ...
  /**
   */
  class AWS_ROBOMAKER_API ListWorldTemplatesRequest : public RoboMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListWorldTemplatesRequest> Clone() const
    {
      return Aws::MakeUnique<ListWorldTemplatesRequest>(GetServiceRequestName(), *this);
    }
