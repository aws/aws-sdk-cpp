...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeSimulationApplicationRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeSimulationApplicationRequest>(GetServiceRequestName(), *this);
    }
