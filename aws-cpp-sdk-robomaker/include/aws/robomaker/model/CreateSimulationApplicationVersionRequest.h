...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateSimulationApplicationVersionRequest> Clone() const
    {
      return Aws::MakeUnique<CreateSimulationApplicationVersionRequest>(GetServiceRequestName(), *this);
    }
