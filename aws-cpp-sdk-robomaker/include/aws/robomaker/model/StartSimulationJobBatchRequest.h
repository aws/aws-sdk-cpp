...
namespace Model
{
  ...
  /**
   */
  class AWS_ROBOMAKER_API StartSimulationJobBatchRequest : public RoboMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StartSimulationJobBatchRequest> Clone() const
    {
      return Aws::MakeUnique<StartSimulationJobBatchRequest>(GetServiceRequestName(), *this);
    }
