...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteSimulationApplicationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteSimulationApplicationRequest>(GetServiceRequestName(), *this);
    }
