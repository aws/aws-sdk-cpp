...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateSimulationApplicationRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateSimulationApplicationRequest>(GetServiceRequestName(), *this);
    }
