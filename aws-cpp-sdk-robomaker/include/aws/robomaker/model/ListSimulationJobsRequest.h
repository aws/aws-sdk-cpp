...
namespace Model
{
  ...
  /**
   */
  class AWS_ROBOMAKER_API ListSimulationJobsRequest : public RoboMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListSimulationJobsRequest> Clone() const
    {
      return Aws::MakeUnique<ListSimulationJobsRequest>(GetServiceRequestName(), *this);
    }
