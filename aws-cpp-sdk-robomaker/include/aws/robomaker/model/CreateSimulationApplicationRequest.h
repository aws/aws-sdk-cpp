...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateSimulationApplicationRequest> Clone() const
    {
      return Aws::MakeUnique<CreateSimulationApplicationRequest>(GetServiceRequestName(), *this);
    }
