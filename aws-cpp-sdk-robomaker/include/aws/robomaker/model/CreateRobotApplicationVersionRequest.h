...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateRobotApplicationVersionRequest> Clone() const
    {
      return Aws::MakeUnique<CreateRobotApplicationVersionRequest>(GetServiceRequestName(), *this);
    }
