...
using ResolveEndpointOutcome = Aws::RoboMaker::Endpoint::RoboMakerEndpointProvider::RoboMakerResolveEndpointOutcome;
...
RoboMakerClient::RoboMakerClient(const Client::ClientConfiguration& clientConfiguration,
                                 std::shared_ptr<Endpoint::RoboMakerEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<RoboMakerErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<RoboMaker::Endpoint::RoboMakerEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
