...
Aws::String RoboMakerEndpointRules::GetRulesAsString()
{
    return Aws::String(RoboMakerEndpointRules::Rules.begin(), RoboMakerEndpointRules::Rules.end());
}

const Aws::Vector<char> RoboMakerEndpointRules::Rules = {
...
':','/','/','r','o','b','o','m','a','k','e','r','-','f','i','p','s','.','{','R','e','g','i','o','n',
...
'r','u','l','e','s','"',':','[','{','"','c','o','n','d','i','t','i','o','n','s','"',':','[',']',',',
'"','e','n','d','p','o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':',
'/','/','r','o','b','o','m','a','k','e','r','.','{','R','e','g','i','o','n','}','.','{','P','a','r',
