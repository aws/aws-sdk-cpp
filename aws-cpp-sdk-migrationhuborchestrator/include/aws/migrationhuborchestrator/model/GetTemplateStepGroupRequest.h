...
namespace Model
{
  ...
  /**
   */
  class AWS_MIGRATIONHUBORCHESTRATOR_API GetTemplateStepGroupRequest : public MigrationHubOrchestratorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetTemplateStepGroupRequest> Clone() const
    {
      return Aws::MakeUnique<GetTemplateStepGroupRequest>(GetServiceRequestName(), *this);
    }
