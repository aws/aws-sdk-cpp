...
namespace Model
{
  ...
  /**
   */
  class AWS_MIGRATIONHUBORCHESTRATOR_API CreateWorkflowRequest : public MigrationHubOrchestratorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateWorkflowRequest> Clone() const
    {
      return Aws::MakeUnique<CreateWorkflowRequest>(GetServiceRequestName(), *this);
    }
