...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_MIGRATIONHUBORCHESTRATOR_API TemplateStepSummary
  {
  public:
    TemplateStepSummary();
    TemplateStepSummary(Aws::Utils::Json::JsonView jsonValue);
    TemplateStepSummary& operator=(Aws::Utils::Json::JsonView jsonValue);
