...
namespace Model
{
  ...
  /**
   */
  class AWS_MIGRATIONHUBORCHESTRATOR_API ListTemplateStepsRequest : public MigrationHubOrchestratorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListTemplateStepsRequest> Clone() const
    {
      return Aws::MakeUnique<ListTemplateStepsRequest>(GetServiceRequestName(), *this);
    }
