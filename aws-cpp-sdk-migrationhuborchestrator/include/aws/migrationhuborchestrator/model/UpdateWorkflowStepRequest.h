...
namespace Model
{
  ...
  /**
   */
  class AWS_MIGRATIONHUBORCHESTRATOR_API UpdateWorkflowStepRequest : public MigrationHubOrchestratorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateWorkflowStepRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateWorkflowStepRequest>(GetServiceRequestName(), *this);
    }
