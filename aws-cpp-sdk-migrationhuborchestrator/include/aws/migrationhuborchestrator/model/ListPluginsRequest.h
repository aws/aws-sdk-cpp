...
namespace Model
{
  ...
  /**
   */
  class AWS_MIGRATIONHUBORCHESTRATOR_API ListPluginsRequest : public MigrationHubOrchestratorRequest
  {
  public:
    ListPluginsRequest();
    ...
    */
    virtual Aws::UniquePtr<ListPluginsRequest> Clone() const
    {
      return Aws::MakeUnique<ListPluginsRequest>(GetServiceRequestName(), *this);
    }
