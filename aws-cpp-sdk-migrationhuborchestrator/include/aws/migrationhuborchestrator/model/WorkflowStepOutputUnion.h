...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_MIGRATIONHUBORCHESTRATOR_API WorkflowStepOutputUnion
  {
  public:
    WorkflowStepOutputUnion();
    WorkflowStepOutputUnion(Aws::Utils::Json::JsonView jsonValue);
    WorkflowStepOutputUnion& operator=(Aws::Utils::Json::JsonView jsonValue);
