...
namespace Model
{
  ...
  /**
   */
  class AWS_MIGRATIONHUBORCHESTRATOR_API UpdateWorkflowStepGroupRequest : public MigrationHubOrchestratorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateWorkflowStepGroupRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateWorkflowStepGroupRequest>(GetServiceRequestName(), *this);
    }
