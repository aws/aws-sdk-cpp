...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_MIGRATIONHUBORCHESTRATOR_API WorkflowStepSummary
  {
  public:
    WorkflowStepSummary();
    WorkflowStepSummary(Aws::Utils::Json::JsonView jsonValue);
    WorkflowStepSummary& operator=(Aws::Utils::Json::JsonView jsonValue);
