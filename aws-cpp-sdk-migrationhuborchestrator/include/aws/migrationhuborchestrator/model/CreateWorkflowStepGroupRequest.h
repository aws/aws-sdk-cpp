...
namespace Model
{
  ...
  /**
   */
  class AWS_MIGRATIONHUBORCHESTRATOR_API CreateWorkflowStepGroupRequest : public MigrationHubOrchestratorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateWorkflowStepGroupRequest> Clone() const
    {
      return Aws::MakeUnique<CreateWorkflowStepGroupRequest>(GetServiceRequestName(), *this);
    }
