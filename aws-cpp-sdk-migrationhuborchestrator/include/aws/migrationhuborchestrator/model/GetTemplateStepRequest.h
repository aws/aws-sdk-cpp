...
namespace Model
{
  ...
  /**
   */
  class AWS_MIGRATIONHUBORCHESTRATOR_API GetTemplateStepRequest : public MigrationHubOrchestratorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetTemplateStepRequest> Clone() const
    {
      return Aws::MakeUnique<GetTemplateStepRequest>(GetServiceRequestName(), *this);
    }
