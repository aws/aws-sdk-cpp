...
namespace Model
{
  ...
  /**
   */
  class AWS_MIGRATIONHUBORCHESTRATOR_API ListWorkflowStepsRequest : public MigrationHubOrchestratorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListWorkflowStepsRequest> Clone() const
    {
      return Aws::MakeUnique<ListWorkflowStepsRequest>(GetServiceRequestName(), *this);
    }
