...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_MIGRATIONHUBORCHESTRATOR_API StepAutomationConfiguration
  {
  public:
    StepAutomationConfiguration();
    StepAutomationConfiguration(Aws::Utils::Json::JsonView jsonValue);
    StepAutomationConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
     ...
     * <p>The Amazon S3 bucket where the script is located.</p>
     */
    inline StepAutomationConfiguration& WithScriptLocationS3Bucket(const Aws::String& value) { SetScriptLocationS3Bucket(value); return *this;}

    /**
     * <p>The Amazon S3 bucket where the script is located.</p>
     */
    inline StepAutomationConfiguration& WithScriptLocationS3Bucket(Aws::String&& value) { SetScriptLocationS3Bucket(std::move(value)); return *this;}

    /**
     * <p>The Amazon S3 bucket where the script is located.</p>
     */
    inline StepAutomationConfiguration& WithScriptLocationS3Bucket(const char* value) { SetScriptLocationS3Bucket(value); return *this;}
     ...
     * <p>The Amazon S3 key for the script location.</p>
     */
    inline StepAutomationConfiguration& WithScriptLocationS3Key(const PlatformScriptKey& value) { SetScriptLocationS3Key(value); return *this;}

    /**
     * <p>The Amazon S3 key for the script location.</p>
     */
    inline StepAutomationConfiguration& WithScriptLocationS3Key(PlatformScriptKey&& value) { SetScriptLocationS3Key(std::move(value)); return *this;}
     ...
     * <p>The command to run the script.</p>
     */
    inline StepAutomationConfiguration& WithCommand(const PlatformCommand& value) { SetCommand(value); return *this;}

    /**
     * <p>The command to run the script.</p>
     */
    inline StepAutomationConfiguration& WithCommand(PlatformCommand&& value) { SetCommand(std::move(value)); return *this;}
     ...
     * <p>The source or target environment.</p>
     */
    inline StepAutomationConfiguration& WithRunEnvironment(const RunEnvironment& value) { SetRunEnvironment(value); return *this;}

    /**
     * <p>The source or target environment.</p>
     */
    inline StepAutomationConfiguration& WithRunEnvironment(RunEnvironment&& value) { SetRunEnvironment(std::move(value)); return *this;}
     ...
     * <p>The servers on which to run the script.</p>
     */
    inline StepAutomationConfiguration& WithTargetType(const TargetType& value) { SetTargetType(value); return *this;}

    /**
     * <p>The servers on which to run the script.</p>
     */
    inline StepAutomationConfiguration& WithTargetType(TargetType&& value) { SetTargetType(std::move(value)); return *this;}
