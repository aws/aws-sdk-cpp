...
namespace Model
{
  ...
  /**
   */
  class AWS_MIGRATIONHUBORCHESTRATOR_API ListTemplateStepGroupsRequest : public MigrationHubOrchestratorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListTemplateStepGroupsRequest> Clone() const
    {
      return Aws::MakeUnique<ListTemplateStepGroupsRequest>(GetServiceRequestName(), *this);
    }
