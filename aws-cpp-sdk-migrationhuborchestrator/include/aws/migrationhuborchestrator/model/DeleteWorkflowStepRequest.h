...
namespace Model
{
  ...
  /**
   */
  class AWS_MIGRATIONHUBORCHESTRATOR_API DeleteWorkflowStepRequest : public MigrationHubOrchestratorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteWorkflowStepRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteWorkflowStepRequest>(GetServiceRequestName(), *this);
    }
