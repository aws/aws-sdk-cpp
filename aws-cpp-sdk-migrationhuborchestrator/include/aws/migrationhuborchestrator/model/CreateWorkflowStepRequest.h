...
namespace Model
{
  ...
  /**
   */
  class AWS_MIGRATIONHUBORCHESTRATOR_API CreateWorkflowStepRequest : public MigrationHubOrchestratorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateWorkflowStepRequest> Clone() const
    {
      return Aws::MakeUnique<CreateWorkflowStepRequest>(GetServiceRequestName(), *this);
    }
