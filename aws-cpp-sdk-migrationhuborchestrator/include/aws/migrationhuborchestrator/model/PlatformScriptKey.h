...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_MIGRATIONHUBORCHESTRATOR_API PlatformScriptKey
  {
  public:
    PlatformScriptKey();
    PlatformScriptKey(Aws::Utils::Json::JsonView jsonValue);
    PlatformScriptKey& operator=(Aws::Utils::Json::JsonView jsonValue);
