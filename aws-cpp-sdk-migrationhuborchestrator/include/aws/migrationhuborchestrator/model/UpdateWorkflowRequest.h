...
namespace Model
{
  ...
  /**
   */
  class AWS_MIGRATIONHUBORCHESTRATOR_API UpdateWorkflowRequest : public MigrationHubOrchestratorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateWorkflowRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateWorkflowRequest>(GetServiceRequestName(), *this);
    }
