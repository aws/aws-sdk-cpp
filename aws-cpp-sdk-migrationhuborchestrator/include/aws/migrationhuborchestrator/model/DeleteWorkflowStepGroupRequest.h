...
namespace Model
{
  ...
  /**
   */
  class AWS_MIGRATIONHUBORCHESTRATOR_API DeleteWorkflowStepGroupRequest : public MigrationHubOrchestratorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteWorkflowStepGroupRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteWorkflowStepGroupRequest>(GetServiceRequestName(), *this);
    }
