...
namespace IoTWireless
{
  ...
  class AWS_IOTWIRELESS_API IoTWirelessClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        IoTWirelessClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                          std::shared_ptr<Endpoint::IoTWirelessEndpointProvider> endpointProvider = Aws::MakeShared<IoTWireless::Endpoint::IoTWirelessEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::IoTWirelessEndpointProvider> m_endpointProvider;
  };
