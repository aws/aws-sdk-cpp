...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteWirelessGatewayTaskDefinitionRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteWirelessGatewayTaskDefinitionRequest>(GetServiceRequestName(), *this);
    }
