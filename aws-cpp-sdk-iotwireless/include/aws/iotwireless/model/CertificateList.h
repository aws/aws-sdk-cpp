...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_IOTWIRELESS_API CertificateList
  {
  public:
    CertificateList();
    CertificateList(Aws::Utils::Json::JsonView jsonValue);
    CertificateList& operator=(Aws::Utils::Json::JsonView jsonValue);
