...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTWIRELESS_API AssociateWirelessGatewayWithThingRequest : public IoTWirelessRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateWirelessGatewayWithThingRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateWirelessGatewayWithThingRequest>(GetServiceRequestName(), *this);
    }
