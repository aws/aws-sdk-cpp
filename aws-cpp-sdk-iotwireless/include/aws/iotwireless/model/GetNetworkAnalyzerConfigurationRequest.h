...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTWIRELESS_API GetNetworkAnalyzerConfigurationRequest : public IoTWirelessRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetNetworkAnalyzerConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<GetNetworkAnalyzerConfigurationRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "GetNetworkAnalyzerConfiguration"; }
