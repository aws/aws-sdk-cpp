...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTWIRELESS_API SendDataToMulticastGroupRequest : public IoTWirelessRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<SendDataToMulticastGroupRequest> Clone() const
    {
      return Aws::MakeUnique<SendDataToMulticastGroupRequest>(GetServiceRequestName(), *this);
    }
