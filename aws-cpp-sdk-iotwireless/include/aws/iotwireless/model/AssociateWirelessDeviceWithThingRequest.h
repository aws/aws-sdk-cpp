...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTWIRELESS_API AssociateWirelessDeviceWithThingRequest : public IoTWirelessRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateWirelessDeviceWithThingRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateWirelessDeviceWithThingRequest>(GetServiceRequestName(), *this);
    }
