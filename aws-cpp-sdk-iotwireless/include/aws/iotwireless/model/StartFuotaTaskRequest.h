...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTWIRELESS_API StartFuotaTaskRequest : public IoTWirelessRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StartFuotaTaskRequest> Clone() const
    {
      return Aws::MakeUnique<StartFuotaTaskRequest>(GetServiceRequestName(), *this);
    }
