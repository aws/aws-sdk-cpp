...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTWIRELESS_API CreateFuotaTaskRequest : public IoTWirelessRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateFuotaTaskRequest> Clone() const
    {
      return Aws::MakeUnique<CreateFuotaTaskRequest>(GetServiceRequestName(), *this);
    }
