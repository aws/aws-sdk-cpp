...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetResourceEventConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<GetResourceEventConfigurationRequest>(GetServiceRequestName(), *this);
    }
