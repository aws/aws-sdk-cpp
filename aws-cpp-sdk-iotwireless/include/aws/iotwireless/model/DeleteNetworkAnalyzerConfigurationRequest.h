...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTWIRELESS_API DeleteNetworkAnalyzerConfigurationRequest : public IoTWirelessRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteNetworkAnalyzerConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteNetworkAnalyzerConfigurationRequest>(GetServiceRequestName(), *this);
    }
