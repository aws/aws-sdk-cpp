...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTWIRELESS_API StartBulkAssociateWirelessDeviceWithMulticastGroupRequest : public IoTWirelessRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StartBulkAssociateWirelessDeviceWithMulticastGroupRequest> Clone() const
    {
      return Aws::MakeUnique<StartBulkAssociateWirelessDeviceWithMulticastGroupRequest>(GetServiceRequestName(), *this);
    }
