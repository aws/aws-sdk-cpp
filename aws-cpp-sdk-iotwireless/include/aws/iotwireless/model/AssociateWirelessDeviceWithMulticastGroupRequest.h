...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateWirelessDeviceWithMulticastGroupRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateWirelessDeviceWithMulticastGroupRequest>(GetServiceRequestName(), *this);
    }
