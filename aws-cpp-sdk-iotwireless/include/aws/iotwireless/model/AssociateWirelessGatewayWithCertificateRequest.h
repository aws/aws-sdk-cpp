...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTWIRELESS_API AssociateWirelessGatewayWithCertificateRequest : public IoTWirelessRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateWirelessGatewayWithCertificateRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateWirelessGatewayWithCertificateRequest>(GetServiceRequestName(), *this);
    }
