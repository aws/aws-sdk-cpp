...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTWIRELESS_API DisassociateAwsAccountFromPartnerAccountRequest : public IoTWirelessRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateAwsAccountFromPartnerAccountRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateAwsAccountFromPartnerAccountRequest>(GetServiceRequestName(), *this);
    }
