...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTWIRELESS_API ListQueuedMessagesRequest : public IoTWirelessRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListQueuedMessagesRequest> Clone() const
    {
      return Aws::MakeUnique<ListQueuedMessagesRequest>(GetServiceRequestName(), *this);
    }
