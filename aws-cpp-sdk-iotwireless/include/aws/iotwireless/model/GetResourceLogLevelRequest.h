...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTWIRELESS_API GetResourceLogLevelRequest : public IoTWirelessRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetResourceLogLevelRequest> Clone() const
    {
      return Aws::MakeUnique<GetResourceLogLevelRequest>(GetServiceRequestName(), *this);
    }
