...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTWIRELESS_API GetWirelessDeviceStatisticsRequest : public IoTWirelessRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetWirelessDeviceStatisticsRequest> Clone() const
    {
      return Aws::MakeUnique<GetWirelessDeviceStatisticsRequest>(GetServiceRequestName(), *this);
    }
