...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTWIRELESS_API DeleteDestinationRequest : public IoTWirelessRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteDestinationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteDestinationRequest>(GetServiceRequestName(), *this);
    }
     ...
     * <p>The name of the resource to delete.</p>
     */
    inline DeleteDestinationRequest& WithName(const char* value) { SetName(value); return *this;}
