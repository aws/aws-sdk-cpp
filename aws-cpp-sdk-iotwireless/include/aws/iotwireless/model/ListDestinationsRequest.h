...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTWIRELESS_API ListDestinationsRequest : public IoTWirelessRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListDestinationsRequest> Clone() const
    {
      return Aws::MakeUnique<ListDestinationsRequest>(GetServiceRequestName(), *this);
    }
