...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTWIRELESS_API UpdateDestinationRequest : public IoTWirelessRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateDestinationRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateDestinationRequest>(GetServiceRequestName(), *this);
    }
