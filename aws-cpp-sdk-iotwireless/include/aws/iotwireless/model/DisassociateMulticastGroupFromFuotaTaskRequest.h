...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateMulticastGroupFromFuotaTaskRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateMulticastGroupFromFuotaTaskRequest>(GetServiceRequestName(), *this);
    }
