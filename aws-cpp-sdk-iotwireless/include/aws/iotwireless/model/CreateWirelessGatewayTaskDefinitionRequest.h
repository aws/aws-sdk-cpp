...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateWirelessGatewayTaskDefinitionRequest> Clone() const
    {
      return Aws::MakeUnique<CreateWirelessGatewayTaskDefinitionRequest>(GetServiceRequestName(), *this);
    }
