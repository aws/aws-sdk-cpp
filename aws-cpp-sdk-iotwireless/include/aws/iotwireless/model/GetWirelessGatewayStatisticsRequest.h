...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTWIRELESS_API GetWirelessGatewayStatisticsRequest : public IoTWirelessRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetWirelessGatewayStatisticsRequest> Clone() const
    {
      return Aws::MakeUnique<GetWirelessGatewayStatisticsRequest>(GetServiceRequestName(), *this);
    }
