...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTWIRELESS_API UpdateMulticastGroupRequest : public IoTWirelessRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateMulticastGroupRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateMulticastGroupRequest>(GetServiceRequestName(), *this);
    }
