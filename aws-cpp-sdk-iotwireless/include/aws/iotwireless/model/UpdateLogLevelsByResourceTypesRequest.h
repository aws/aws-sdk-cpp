...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateLogLevelsByResourceTypesRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateLogLevelsByResourceTypesRequest>(GetServiceRequestName(), *this);
    }
