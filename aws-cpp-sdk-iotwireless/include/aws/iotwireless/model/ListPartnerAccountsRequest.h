...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTWIRELESS_API ListPartnerAccountsRequest : public IoTWirelessRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListPartnerAccountsRequest> Clone() const
    {
      return Aws::MakeUnique<ListPartnerAccountsRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "ListPartnerAccounts"; }
     ...
     * <p>The maximum number of results to return in this operation.</p>
     */
    inline ListPartnerAccountsRequest& WithMaxResults(int value) { SetMaxResults(value); return *this;}
