...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTWIRELESS_API ListEventConfigurationsRequest : public IoTWirelessRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListEventConfigurationsRequest> Clone() const
    {
      return Aws::MakeUnique<ListEventConfigurationsRequest>(GetServiceRequestName(), *this);
    }
