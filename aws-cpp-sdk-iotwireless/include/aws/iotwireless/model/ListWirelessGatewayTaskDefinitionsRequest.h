...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTWIRELESS_API ListWirelessGatewayTaskDefinitionsRequest : public IoTWirelessRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListWirelessGatewayTaskDefinitionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListWirelessGatewayTaskDefinitionsRequest>(GetServiceRequestName(), *this);
    }
