...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTWIRELESS_API ListWirelessGatewaysRequest : public IoTWirelessRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListWirelessGatewaysRequest> Clone() const
    {
      return Aws::MakeUnique<ListWirelessGatewaysRequest>(GetServiceRequestName(), *this);
    }
