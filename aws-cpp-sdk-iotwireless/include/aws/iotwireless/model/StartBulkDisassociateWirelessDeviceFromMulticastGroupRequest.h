...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<StartBulkDisassociateWirelessDeviceFromMulticastGroupRequest> Clone() const
    {
      return Aws::MakeUnique<StartBulkDisassociateWirelessDeviceFromMulticastGroupRequest>(GetServiceRequestName(), *this);
    }
