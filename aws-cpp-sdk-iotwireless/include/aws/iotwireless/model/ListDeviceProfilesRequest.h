...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTWIRELESS_API ListDeviceProfilesRequest : public IoTWirelessRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListDeviceProfilesRequest> Clone() const
    {
      return Aws::MakeUnique<ListDeviceProfilesRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "ListDeviceProfiles"; }
