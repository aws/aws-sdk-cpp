...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateAwsAccountWithPartnerAccountRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateAwsAccountWithPartnerAccountRequest>(GetServiceRequestName(), *this);
    }
