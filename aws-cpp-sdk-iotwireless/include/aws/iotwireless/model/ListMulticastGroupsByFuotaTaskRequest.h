...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListMulticastGroupsByFuotaTaskRequest> Clone() const
    {
      return Aws::MakeUnique<ListMulticastGroupsByFuotaTaskRequest>(GetServiceRequestName(), *this);
    }
