...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTWIRELESS_API GetWirelessGatewayRequest : public IoTWirelessRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetWirelessGatewayRequest> Clone() const
    {
      return Aws::MakeUnique<GetWirelessGatewayRequest>(GetServiceRequestName(), *this);
    }
