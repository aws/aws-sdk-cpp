...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateNetworkAnalyzerConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateNetworkAnalyzerConfigurationRequest>(GetServiceRequestName(), *this);
    }
