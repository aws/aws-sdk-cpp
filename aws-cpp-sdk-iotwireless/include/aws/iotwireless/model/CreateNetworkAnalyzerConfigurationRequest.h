...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTWIRELESS_API CreateNetworkAnalyzerConfigurationRequest : public IoTWirelessRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateNetworkAnalyzerConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<CreateNetworkAnalyzerConfigurationRequest>(GetServiceRequestName(), *this);
    }
