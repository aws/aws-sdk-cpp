...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateResourceEventConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateResourceEventConfigurationRequest>(GetServiceRequestName(), *this);
    }
