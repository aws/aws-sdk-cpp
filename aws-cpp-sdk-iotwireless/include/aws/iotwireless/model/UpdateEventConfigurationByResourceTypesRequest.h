...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateEventConfigurationByResourceTypesRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateEventConfigurationByResourceTypesRequest>(GetServiceRequestName(), *this);
    }
