...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTWIRELESS_API GetServiceEndpointRequest : public IoTWirelessRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetServiceEndpointRequest> Clone() const
    {
      return Aws::MakeUnique<GetServiceEndpointRequest>(GetServiceRequestName(), *this);
    }
