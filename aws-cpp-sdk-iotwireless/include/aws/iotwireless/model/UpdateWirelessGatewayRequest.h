...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTWIRELESS_API UpdateWirelessGatewayRequest : public IoTWirelessRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateWirelessGatewayRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateWirelessGatewayRequest>(GetServiceRequestName(), *this);
    }
