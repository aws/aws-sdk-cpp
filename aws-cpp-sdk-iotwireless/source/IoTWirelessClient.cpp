...
using ResolveEndpointOutcome = Aws::IoTWireless::Endpoint::IoTWirelessEndpointProvider::IoTWirelessResolveEndpointOutcome;
...
IoTWirelessClient::IoTWirelessClient(const Client::ClientConfiguration& clientConfiguration,
                                     std::shared_ptr<Endpoint::IoTWirelessEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<IoTWirelessErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<IoTWireless::Endpoint::IoTWirelessEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
