...
Aws::String IoTWirelessEndpointRules::GetRulesAsString()
{
    return Aws::String(IoTWirelessEndpointRules::Rules.begin(), IoTWirelessEndpointRules::Rules.end());
}

const Aws::Vector<char> IoTWirelessEndpointRules::Rules = {
...
'w','i','r','e','l','e','s','s','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P',
...
'h','t','t','p','s',':','/','/','a','p','i','.','i','o','t','w','i','r','e','l','e','s','s','-','f',
...
'r','l','"',':','"','h','t','t','p','s',':','/','/','a','p','i','.','i','o','t','w','i','r','e','l',
'e','s','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R','e',
...
's','"',':','[',']',',','"','e','n','d','p','o','i','n','t','"',':','{','"','u','r','l','"',':','"',
'h','t','t','p','s',':','/','/','a','p','i','.','i','o','t','w','i','r','e','l','e','s','s','.','{',
