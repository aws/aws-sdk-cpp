...
namespace Model
{
  ...
  public:
    ScheduledAction();
    ScheduledAction(const Aws::Utils::Json::JsonValue& jsonValue);
    ScheduledAction& operator=(const Aws::Utils::Json::JsonValue& jsonValue);
     ...
     * href="https://en.wikipedia.org/wiki/Cron">Cron</a>.</p>
     */
