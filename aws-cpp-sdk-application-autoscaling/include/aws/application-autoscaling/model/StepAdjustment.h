...
namespace Model
{
  ...
  /**
   * <p>An object representing a step adjustment for a
   * <a>StepScalingPolicyConfiguration</a>. Describes an adjustment based on the
   * difference between the value of the aggregated CloudWatch metric and the breach
   * threshold that you've defined for the alarm. </p> <p>For the following examples,
   * suppose that you have an alarm with a breach threshold of 50:</p> <ul> <li>
   * <p>If you want the adjustment to be triggered when the metric is greater than or
   * equal to 50 and less than 60, specify a lower bound of 0 and an upper bound of
   * 10.</p> </li> <li> <p>If you want the adjustment to be triggered when the metric
   * is greater than 40 and less than or equal to 50, specify a lower bound of -10
   * and an upper bound of 0.</p> </li> </ul> <p>There are a few rules for the step
   ...
   * null in the same step adjustment.</p> </li> </ul>
   */
