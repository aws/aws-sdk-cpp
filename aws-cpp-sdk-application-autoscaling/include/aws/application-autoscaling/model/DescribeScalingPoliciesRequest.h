...
namespace Model
{
  ...
  public:
     ...
     * associated with. The scalable dimension contains the service namespace, the
     * resource type, and the scaling property, such as
     * <code>ecs:service:DesiredCount</code> for the desired task count for an Amazon
