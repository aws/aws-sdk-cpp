...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeScalingPoliciesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeScalingPoliciesRequest>(GetServiceRequestName(), *this);
    }
    ...
    /**
     * <p>The maximum number of scalable targets. This value can be between 1 and 10.
     * The default value is 10.</p> <p>If this parameter is used, the operation returns
