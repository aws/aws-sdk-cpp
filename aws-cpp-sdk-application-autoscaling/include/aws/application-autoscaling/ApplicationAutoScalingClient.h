...
namespace ApplicationAutoScaling
{
  ...
  class AWS_APPLICATIONAUTOSCALING_API ApplicationAutoScalingClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        ApplicationAutoScalingClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                     std::shared_ptr<Endpoint::ApplicationAutoScalingEndpointProvider> endpointProvider = Aws::MakeShared<ApplicationAutoScaling::Endpoint::ApplicationAutoScalingEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::ApplicationAutoScalingEndpointProvider> m_endpointProvider;
  };
