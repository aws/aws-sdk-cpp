...
using ResolveEndpointOutcome = Aws::ApplicationAutoScaling::Endpoint::ApplicationAutoScalingEndpointProvider::ApplicationAutoScalingResolveEndpointOutcome;
...
ApplicationAutoScalingClient::ApplicationAutoScalingClient(const Client::ClientConfiguration& clientConfiguration,
                                                           std::shared_ptr<Endpoint::ApplicationAutoScalingEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<ApplicationAutoScalingErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<ApplicationAutoScaling::Endpoint::ApplicationAutoScalingEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
