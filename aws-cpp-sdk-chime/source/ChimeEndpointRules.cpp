...
Aws::String ChimeEndpointRules::GetRulesAsString()
{
    return Aws::String(ChimeEndpointRules::Rules.begin(), ChimeEndpointRules::Rules.end());
}

const Aws::Vector<char> ChimeEndpointRules::Rules = {
