...
RedactConversationMessageResult::RedactConversationMessageResult()
{
}

RedactConversationMessageResult::RedactConversationMessageResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
