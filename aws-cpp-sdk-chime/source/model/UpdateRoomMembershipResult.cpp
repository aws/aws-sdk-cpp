...
UpdateRoomMembershipResult::UpdateRoomMembershipResult()
{
}

UpdateRoomMembershipResult::UpdateRoomMembershipResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
