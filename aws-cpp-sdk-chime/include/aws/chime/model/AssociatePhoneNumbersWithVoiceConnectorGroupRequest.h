...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociatePhoneNumbersWithVoiceConnectorGroupRequest> Clone() const
    {
      return Aws::MakeUnique<AssociatePhoneNumbersWithVoiceConnectorGroupRequest>(GetServiceRequestName(), *this);
    }
