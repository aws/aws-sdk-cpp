...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociatePhoneNumberFromUserRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociatePhoneNumberFromUserRequest>(GetServiceRequestName(), *this);
    }
