...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociatePhoneNumbersWithVoiceConnectorRequest> Clone() const
    {
      return Aws::MakeUnique<AssociatePhoneNumbersWithVoiceConnectorRequest>(GetServiceRequestName(), *this);
    }
