...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIME_API UpdateAccountRequest : public ChimeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateAccountRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateAccountRequest>(GetServiceRequestName(), *this);
    }
