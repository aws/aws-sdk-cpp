...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIME_API GetVoiceConnectorProxyRequest : public ChimeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetVoiceConnectorProxyRequest> Clone() const
    {
      return Aws::MakeUnique<GetVoiceConnectorProxyRequest>(GetServiceRequestName(), *this);
    }
