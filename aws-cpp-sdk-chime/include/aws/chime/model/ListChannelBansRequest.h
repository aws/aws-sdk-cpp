...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIME_API ListChannelBansRequest : public ChimeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListChannelBansRequest> Clone() const
    {
      return Aws::MakeUnique<ListChannelBansRequest>(GetServiceRequestName(), *this);
    }
