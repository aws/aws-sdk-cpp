...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PutVoiceConnectorOriginationRequest> Clone() const
    {
      return Aws::MakeUnique<PutVoiceConnectorOriginationRequest>(GetServiceRequestName(), *this);
    }
