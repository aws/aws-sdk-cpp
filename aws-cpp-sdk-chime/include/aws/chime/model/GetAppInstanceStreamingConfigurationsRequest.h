...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIME_API GetAppInstanceStreamingConfigurationsRequest : public ChimeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetAppInstanceStreamingConfigurationsRequest> Clone() const
    {
      return Aws::MakeUnique<GetAppInstanceStreamingConfigurationsRequest>(GetServiceRequestName(), *this);
    }
