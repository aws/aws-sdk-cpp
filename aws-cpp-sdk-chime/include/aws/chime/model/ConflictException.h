...
namespace Model
{
  ...
  {
  public:
    AWS_CHIME_API ConflictException();
    AWS_CHIME_API ConflictException(Aws::Utils::Json::JsonView jsonValue);
    AWS_CHIME_API ConflictException& operator=(Aws::Utils::Json::JsonView jsonValue);
