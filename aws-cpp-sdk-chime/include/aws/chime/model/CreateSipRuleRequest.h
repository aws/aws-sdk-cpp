...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIME_API CreateSipRuleRequest : public ChimeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateSipRuleRequest> Clone() const
    {
      return Aws::MakeUnique<CreateSipRuleRequest>(GetServiceRequestName(), *this);
    }
