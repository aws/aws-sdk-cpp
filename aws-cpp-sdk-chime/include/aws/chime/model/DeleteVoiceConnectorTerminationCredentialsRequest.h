...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteVoiceConnectorTerminationCredentialsRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteVoiceConnectorTerminationCredentialsRequest>(GetServiceRequestName(), *this);
    }
