...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIME_API DeleteAppInstanceStreamingConfigurationsRequest : public ChimeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteAppInstanceStreamingConfigurationsRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteAppInstanceStreamingConfigurationsRequest>(GetServiceRequestName(), *this);
    }
