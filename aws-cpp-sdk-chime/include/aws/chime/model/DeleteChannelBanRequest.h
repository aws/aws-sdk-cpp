...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIME_API DeleteChannelBanRequest : public ChimeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteChannelBanRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteChannelBanRequest>(GetServiceRequestName(), *this);
    }
