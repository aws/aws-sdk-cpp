...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociatePhoneNumbersFromVoiceConnectorRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociatePhoneNumbersFromVoiceConnectorRequest>(GetServiceRequestName(), *this);
    }
