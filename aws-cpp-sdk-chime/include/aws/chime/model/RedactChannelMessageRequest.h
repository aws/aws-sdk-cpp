...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIME_API RedactChannelMessageRequest : public ChimeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<RedactChannelMessageRequest> Clone() const
    {
      return Aws::MakeUnique<RedactChannelMessageRequest>(GetServiceRequestName(), *this);
    }
