...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIME_API GetAppInstanceRetentionSettingsRequest : public ChimeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetAppInstanceRetentionSettingsRequest> Clone() const
    {
      return Aws::MakeUnique<GetAppInstanceRetentionSettingsRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "GetAppInstanceRetentionSettings"; }
     ...
     * <p>The ARN of the <code>AppInstance</code>.</p>
     */
    inline GetAppInstanceRetentionSettingsRequest& WithAppInstanceArn(const char* value) { SetAppInstanceArn(value); return *this;}
