...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteVoiceConnectorEmergencyCallingConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteVoiceConnectorEmergencyCallingConfigurationRequest>(GetServiceRequestName(), *this);
    }
