...
namespace Model
{
  ...
  /**
   */
  class DeleteVoiceConnectorEmergencyCallingConfigurationRequest : public ChimeRequest
  {
  public:
    AWS_CHIME_API DeleteVoiceConnectorEmergencyCallingConfigurationRequest();
