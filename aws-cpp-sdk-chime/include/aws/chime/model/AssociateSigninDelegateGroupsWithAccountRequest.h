...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateSigninDelegateGroupsWithAccountRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateSigninDelegateGroupsWithAccountRequest>(GetServiceRequestName(), *this);
    }
