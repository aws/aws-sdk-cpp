...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIME_API ListChannelMessagesRequest : public ChimeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListChannelMessagesRequest> Clone() const
    {
      return Aws::MakeUnique<ListChannelMessagesRequest>(GetServiceRequestName(), *this);
    }
