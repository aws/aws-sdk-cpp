...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIME_API UpdateChannelRequest : public ChimeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateChannelRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateChannelRequest>(GetServiceRequestName(), *this);
    }
