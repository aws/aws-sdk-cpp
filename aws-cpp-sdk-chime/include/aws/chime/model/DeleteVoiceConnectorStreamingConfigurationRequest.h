...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteVoiceConnectorStreamingConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteVoiceConnectorStreamingConfigurationRequest>(GetServiceRequestName(), *this);
    }
