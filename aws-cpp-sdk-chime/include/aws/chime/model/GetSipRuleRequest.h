...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIME_API GetSipRuleRequest : public ChimeRequest
  {
  public:
    GetSipRuleRequest();
    ...
    */
    virtual Aws::UniquePtr<GetSipRuleRequest> Clone() const
    {
      return Aws::MakeUnique<GetSipRuleRequest>(GetServiceRequestName(), *this);
    }
