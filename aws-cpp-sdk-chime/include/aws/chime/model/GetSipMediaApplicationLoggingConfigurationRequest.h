...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetSipMediaApplicationLoggingConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<GetSipMediaApplicationLoggingConfigurationRequest>(GetServiceRequestName(), *this);
    }
