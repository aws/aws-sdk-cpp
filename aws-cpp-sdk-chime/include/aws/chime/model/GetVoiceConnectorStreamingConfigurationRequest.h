...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIME_API GetVoiceConnectorStreamingConfigurationRequest : public ChimeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetVoiceConnectorStreamingConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<GetVoiceConnectorStreamingConfigurationRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "GetVoiceConnectorStreamingConfiguration"; }
