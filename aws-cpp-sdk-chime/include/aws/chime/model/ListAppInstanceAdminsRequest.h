...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIME_API ListAppInstanceAdminsRequest : public ChimeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListAppInstanceAdminsRequest> Clone() const
    {
      return Aws::MakeUnique<ListAppInstanceAdminsRequest>(GetServiceRequestName(), *this);
    }
