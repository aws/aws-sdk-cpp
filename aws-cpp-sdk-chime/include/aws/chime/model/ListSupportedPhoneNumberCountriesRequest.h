...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIME_API ListSupportedPhoneNumberCountriesRequest : public ChimeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListSupportedPhoneNumberCountriesRequest> Clone() const
    {
      return Aws::MakeUnique<ListSupportedPhoneNumberCountriesRequest>(GetServiceRequestName(), *this);
    }
