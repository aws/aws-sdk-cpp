...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateSipMediaApplicationCallRequest> Clone() const
    {
      return Aws::MakeUnique<CreateSipMediaApplicationCallRequest>(GetServiceRequestName(), *this);
    }
