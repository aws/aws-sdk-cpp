...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PutAppInstanceRetentionSettingsRequest> Clone() const
    {
      return Aws::MakeUnique<PutAppInstanceRetentionSettingsRequest>(GetServiceRequestName(), *this);
    }
