...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIME_API StopMeetingTranscriptionRequest : public ChimeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StopMeetingTranscriptionRequest> Clone() const
    {
      return Aws::MakeUnique<StopMeetingTranscriptionRequest>(GetServiceRequestName(), *this);
    }
