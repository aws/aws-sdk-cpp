...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociatePhoneNumberWithUserRequest> Clone() const
    {
      return Aws::MakeUnique<AssociatePhoneNumberWithUserRequest>(GetServiceRequestName(), *this);
    }
