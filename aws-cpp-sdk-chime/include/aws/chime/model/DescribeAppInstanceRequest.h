...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIME_API DescribeAppInstanceRequest : public ChimeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeAppInstanceRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeAppInstanceRequest>(GetServiceRequestName(), *this);
    }
