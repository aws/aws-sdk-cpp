...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIME_API UpdateAppInstanceRequest : public ChimeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateAppInstanceRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateAppInstanceRequest>(GetServiceRequestName(), *this);
    }
