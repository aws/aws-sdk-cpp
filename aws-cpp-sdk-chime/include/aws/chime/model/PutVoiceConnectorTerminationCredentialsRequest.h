...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PutVoiceConnectorTerminationCredentialsRequest> Clone() const
    {
      return Aws::MakeUnique<PutVoiceConnectorTerminationCredentialsRequest>(GetServiceRequestName(), *this);
    }
