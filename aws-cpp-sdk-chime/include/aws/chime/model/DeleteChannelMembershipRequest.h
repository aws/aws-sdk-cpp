...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIME_API DeleteChannelMembershipRequest : public ChimeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteChannelMembershipRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteChannelMembershipRequest>(GetServiceRequestName(), *this);
    }
