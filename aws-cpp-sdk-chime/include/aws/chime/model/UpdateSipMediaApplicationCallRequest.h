...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateSipMediaApplicationCallRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateSipMediaApplicationCallRequest>(GetServiceRequestName(), *this);
    }
