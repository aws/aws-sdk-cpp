...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteVoiceConnectorOriginationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteVoiceConnectorOriginationRequest>(GetServiceRequestName(), *this);
    }
