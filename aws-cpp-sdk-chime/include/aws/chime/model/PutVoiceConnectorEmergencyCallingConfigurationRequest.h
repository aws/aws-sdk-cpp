...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIME_API PutVoiceConnectorEmergencyCallingConfigurationRequest : public ChimeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutVoiceConnectorEmergencyCallingConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<PutVoiceConnectorEmergencyCallingConfigurationRequest>(GetServiceRequestName(), *this);
    }
