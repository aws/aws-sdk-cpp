...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeChannelModeratedByAppInstanceUserRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeChannelModeratedByAppInstanceUserRequest>(GetServiceRequestName(), *this);
    }
