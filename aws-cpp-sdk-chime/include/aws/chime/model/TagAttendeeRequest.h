...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIME_API TagAttendeeRequest : public ChimeRequest
  {
  public:
    TagAttendeeRequest();
    ...
    */
    virtual Aws::UniquePtr<TagAttendeeRequest> Clone() const
    {
      return Aws::MakeUnique<TagAttendeeRequest>(GetServiceRequestName(), *this);
    }
