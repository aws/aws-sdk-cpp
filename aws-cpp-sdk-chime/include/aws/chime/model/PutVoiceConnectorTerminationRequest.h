...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIME_API PutVoiceConnectorTerminationRequest : public ChimeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutVoiceConnectorTerminationRequest> Clone() const
    {
      return Aws::MakeUnique<PutVoiceConnectorTerminationRequest>(GetServiceRequestName(), *this);
    }
