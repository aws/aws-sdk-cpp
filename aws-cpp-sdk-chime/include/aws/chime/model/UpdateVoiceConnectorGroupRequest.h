...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIME_API UpdateVoiceConnectorGroupRequest : public ChimeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateVoiceConnectorGroupRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateVoiceConnectorGroupRequest>(GetServiceRequestName(), *this);
    }
