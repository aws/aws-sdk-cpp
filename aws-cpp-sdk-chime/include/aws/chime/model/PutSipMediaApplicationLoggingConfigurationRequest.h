...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PutSipMediaApplicationLoggingConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<PutSipMediaApplicationLoggingConfigurationRequest>(GetServiceRequestName(), *this);
    }
