...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIME_API ListMeetingTagsRequest : public ChimeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListMeetingTagsRequest> Clone() const
    {
      return Aws::MakeUnique<ListMeetingTagsRequest>(GetServiceRequestName(), *this);
    }
