...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIME_API ListBotsRequest : public ChimeRequest
  {
  public:
    ListBotsRequest();
    ...
    */
    virtual Aws::UniquePtr<ListBotsRequest> Clone() const
    {
      return Aws::MakeUnique<ListBotsRequest>(GetServiceRequestName(), *this);
    }
     ...
     * <p>The Amazon Chime account ID.</p>
     */
    inline ListBotsRequest& WithAccountId(const Aws::String& value) { SetAccountId(value); return *this;}

    /**
     * <p>The Amazon Chime account ID.</p>
     */
    inline ListBotsRequest& WithAccountId(Aws::String&& value) { SetAccountId(std::move(value)); return *this;}

    /**
     * <p>The Amazon Chime account ID.</p>
     */
    inline ListBotsRequest& WithAccountId(const char* value) { SetAccountId(value); return *this;}
