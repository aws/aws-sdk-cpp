...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIME_API UpdateSipMediaApplicationRequest : public ChimeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateSipMediaApplicationRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateSipMediaApplicationRequest>(GetServiceRequestName(), *this);
    }
