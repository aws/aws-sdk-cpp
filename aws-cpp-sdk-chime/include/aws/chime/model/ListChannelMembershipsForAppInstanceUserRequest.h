...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIME_API ListChannelMembershipsForAppInstanceUserRequest : public ChimeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListChannelMembershipsForAppInstanceUserRequest> Clone() const
    {
      return Aws::MakeUnique<ListChannelMembershipsForAppInstanceUserRequest>(GetServiceRequestName(), *this);
    }
