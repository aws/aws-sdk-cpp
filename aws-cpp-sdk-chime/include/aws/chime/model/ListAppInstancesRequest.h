...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIME_API ListAppInstancesRequest : public ChimeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListAppInstancesRequest> Clone() const
    {
      return Aws::MakeUnique<ListAppInstancesRequest>(GetServiceRequestName(), *this);
    }
