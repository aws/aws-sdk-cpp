...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIME_API GetVoiceConnectorEmergencyCallingConfigurationRequest : public ChimeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetVoiceConnectorEmergencyCallingConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<GetVoiceConnectorEmergencyCallingConfigurationRequest>(GetServiceRequestName(), *this);
    }
