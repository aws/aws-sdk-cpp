...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIME_API RestorePhoneNumberRequest : public ChimeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<RestorePhoneNumberRequest> Clone() const
    {
      return Aws::MakeUnique<RestorePhoneNumberRequest>(GetServiceRequestName(), *this);
    }
