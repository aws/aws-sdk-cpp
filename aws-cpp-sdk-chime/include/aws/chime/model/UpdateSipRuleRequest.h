...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIME_API UpdateSipRuleRequest : public ChimeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateSipRuleRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateSipRuleRequest>(GetServiceRequestName(), *this);
    }
