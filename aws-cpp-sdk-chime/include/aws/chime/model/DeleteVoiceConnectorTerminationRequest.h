...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteVoiceConnectorTerminationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteVoiceConnectorTerminationRequest>(GetServiceRequestName(), *this);
    }
