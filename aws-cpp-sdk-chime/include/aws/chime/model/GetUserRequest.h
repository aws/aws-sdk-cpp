...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIME_API GetUserRequest : public ChimeRequest
  {
  public:
    GetUserRequest();
     ...
     * <p>The Amazon Chime account ID.</p>
     */
    inline GetUserRequest& WithAccountId(const Aws::String& value) { SetAccountId(value); return *this;}

    /**
     * <p>The Amazon Chime account ID.</p>
     */
    inline GetUserRequest& WithAccountId(Aws::String&& value) { SetAccountId(std::move(value)); return *this;}

    /**
     * <p>The Amazon Chime account ID.</p>
     */
    inline GetUserRequest& WithAccountId(const char* value) { SetAccountId(value); return *this;}
