...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIME_API CreateSipMediaApplicationRequest : public ChimeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateSipMediaApplicationRequest> Clone() const
    {
      return Aws::MakeUnique<CreateSipMediaApplicationRequest>(GetServiceRequestName(), *this);
    }
