...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateSigninDelegateGroupsFromAccountRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateSigninDelegateGroupsFromAccountRequest>(GetServiceRequestName(), *this);
    }
