...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIME_API UpdateRoomMembershipRequest : public ChimeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateRoomMembershipRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateRoomMembershipRequest>(GetServiceRequestName(), *this);
    }
