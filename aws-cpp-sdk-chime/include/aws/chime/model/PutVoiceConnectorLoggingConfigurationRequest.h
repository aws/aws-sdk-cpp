...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIME_API PutVoiceConnectorLoggingConfigurationRequest : public ChimeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutVoiceConnectorLoggingConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<PutVoiceConnectorLoggingConfigurationRequest>(GetServiceRequestName(), *this);
    }
