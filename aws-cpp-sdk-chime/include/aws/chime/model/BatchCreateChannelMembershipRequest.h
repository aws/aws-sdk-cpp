...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIME_API BatchCreateChannelMembershipRequest : public ChimeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchCreateChannelMembershipRequest> Clone() const
    {
      return Aws::MakeUnique<BatchCreateChannelMembershipRequest>(GetServiceRequestName(), *this);
    }
