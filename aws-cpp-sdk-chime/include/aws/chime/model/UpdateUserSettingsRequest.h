...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIME_API UpdateUserSettingsRequest : public ChimeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateUserSettingsRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateUserSettingsRequest>(GetServiceRequestName(), *this);
    }
