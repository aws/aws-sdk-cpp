...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociatePhoneNumbersFromVoiceConnectorGroupRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociatePhoneNumbersFromVoiceConnectorGroupRequest>(GetServiceRequestName(), *this);
    }
