...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIME_API PutVoiceConnectorStreamingConfigurationRequest : public ChimeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutVoiceConnectorStreamingConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<PutVoiceConnectorStreamingConfigurationRequest>(GetServiceRequestName(), *this);
    }
