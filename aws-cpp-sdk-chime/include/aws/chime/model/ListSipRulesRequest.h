...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIME_API ListSipRulesRequest : public ChimeRequest
  {
  public:
    ListSipRulesRequest();
    ...
    */
    virtual Aws::UniquePtr<ListSipRulesRequest> Clone() const
    {
      return Aws::MakeUnique<ListSipRulesRequest>(GetServiceRequestName(), *this);
    }
