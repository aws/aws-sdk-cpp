...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIME_API UpdateVoiceConnectorRequest : public ChimeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateVoiceConnectorRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateVoiceConnectorRequest>(GetServiceRequestName(), *this);
    }
