...
namespace Chime
{
  ...
  class AWS_CHIME_API ChimeClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        ChimeClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                    std::shared_ptr<Endpoint::ChimeEndpointProvider> endpointProvider = Aws::MakeShared<Chime::Endpoint::ChimeEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::ChimeEndpointProvider> m_endpointProvider;
  };
