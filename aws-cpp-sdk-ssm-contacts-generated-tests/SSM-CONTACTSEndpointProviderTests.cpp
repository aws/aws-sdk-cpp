...
static const char* ALLOCATION_TAG = "AWSSSMContactsEndpointProviderTests";
using SSMContactsEndpointProvider = Aws::SSMContacts::Endpoint::SSMContactsEndpointProvider;
using EndpointParameters = Aws::Vector<Aws::Endpoint::EndpointParameter>;
using SSMContactsResolveEndpointOutcome = Aws::SSMContacts::Endpoint::SSMContactsEndpointProvider::SSMContactsResolveEndpointOutcome;
...
class SSMContactsEndpointProviderTests :public ::testing::TestWithParam<size_t>
{
public:
...
struct SSMContactsEndpointProviderEndpointTestCase
{
...
static const Aws::Vector<SSMContactsEndpointProviderEndpointTestCase> TEST_CASES = {
  /*TEST CASE 0*/
...
void ValidateOutcome(const SSMContactsResolveEndpointOutcome& outcome, const SSMContactsEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(SSMContactsEndpointProviderTests, EndpointProviderTest)
{
    ...
    const SSMContactsEndpointProviderEndpointTestCase& TEST_CASE = TEST_CASES.at(TEST_CASE_IDX);
    SCOPED_TRACE(Aws::String("\nTEST CASE # ") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX) + ": " + TEST_CASE.documentation);

    std::shared_ptr<SSMContactsEndpointProvider> endpointProvider = Aws::MakeShared<SSMContactsEndpointProvider>(ALLOCATION_TAG);
    ASSERT_TRUE(endpointProvider) << "Failed to allocate/initialize SSMContactsEndpointProvider";
    ...
    for(const auto& operation : TEST_CASE.operationInput)
    {
         ...
         */
        const Aws::Vector<std::reference_wrapper<const SSMContactsEndpointProviderEndpointTestCase::OperationParamsFromTest>>
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         SSMContactsEndpointProviderTests,
