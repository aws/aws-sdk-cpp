...
namespace Model
{
  ...
  /**
   */
  class AWS_CODEBUILD_API RetryBuildRequest : public CodeBuildRequest
  {
  public:
    RetryBuildRequest();
    ...
    */
    virtual Aws::UniquePtr<RetryBuildRequest> Clone() const
    {
      return Aws::MakeUnique<RetryBuildRequest>(GetServiceRequestName(), *this);
    }
