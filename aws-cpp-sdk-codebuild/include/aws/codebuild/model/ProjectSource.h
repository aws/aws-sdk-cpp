...
namespace Model
{
  ...
  public:
     ...
     * must connect your account to your GitHub account. Use the CodeBuild console to
     ...
     * you want to allow CodeBuild to have access to, and then choose <b>Authorize
     * application</b>. (After you have connected to your GitHub account, you do not
     * need to finish creating the build project. You can leave the CodeBuild console.)
     * To instruct CodeBuild to use this connection, in the <code>source</code> object,
     ...
     * file. You must connect your Amazon Web Services account to your Bitbucket
     * account. Use the CodeBuild console to start creating a build project. When you
     ...
     * </li> </ul> <p> If you specify <code>CODEPIPELINE</code> for the
     * <code>Type</code> property, don't specify this property. For all of the other
     * types, you must specify <code>Location</code>. </p>
     */
     ...
     * S3 bucket. The bucket must be in the same Region as the build project. Specify
