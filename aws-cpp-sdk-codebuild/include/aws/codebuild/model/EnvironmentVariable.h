...
namespace Model
{
  ...
  public:
     ...
     * environment variable in plain text format. This is the default value.</p> </li>
     * <li> <p> <code>SECRETS_MANAGER</code>: An environment variable stored in AWS
     * Secrets Manager.</p> </li> </ul>
     */
