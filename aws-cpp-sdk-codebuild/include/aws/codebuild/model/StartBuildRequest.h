...
namespace Model
{
  ...
  public:
     ...
     * same Region as the build project. Specify the buildspec file using its ARN (for
     * example, <code>arn:aws:s3:::my-codebuild-sample2/buildspec.yml</code>). If this
     * value is not provided or is set to an empty string, the source code must contain
     * a buildspec file in its root directory. For more information, see <a
