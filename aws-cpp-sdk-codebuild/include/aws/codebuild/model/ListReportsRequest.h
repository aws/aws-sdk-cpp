...
namespace Model
{
  ...
  /**
   */
  class AWS_CODEBUILD_API ListReportsRequest : public CodeBuildRequest
  {
  public:
    ListReportsRequest();
    ...
    */
    virtual Aws::UniquePtr<ListReportsRequest> Clone() const
    {
      return Aws::MakeUnique<ListReportsRequest>(GetServiceRequestName(), *this);
    }
