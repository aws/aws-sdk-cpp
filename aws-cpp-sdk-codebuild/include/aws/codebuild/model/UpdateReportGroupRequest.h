...
namespace Model
{
  ...
  /**
   */
  class AWS_CODEBUILD_API UpdateReportGroupRequest : public CodeBuildRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateReportGroupRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateReportGroupRequest>(GetServiceRequestName(), *this);
    }
