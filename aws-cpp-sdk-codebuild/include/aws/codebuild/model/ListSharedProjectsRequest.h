...
namespace Model
{
  ...
  /**
   */
  class AWS_CODEBUILD_API ListSharedProjectsRequest : public CodeBuildRequest
  {
  public:
    ...
    /**
     * <p> The criterion to be used to list build projects shared with the current AWS
     ...
     * when information about the shared project was last changed. </p> </li> </ul>
     */
