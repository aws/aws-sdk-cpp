...
namespace CodeBuild
{
  ...
  class AWS_CODEBUILD_API CodeBuildClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        CodeBuildClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                        std::shared_ptr<Endpoint::CodeBuildEndpointProvider> endpointProvider = Aws::MakeShared<CodeBuild::Endpoint::CodeBuildEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::CodeBuildEndpointProvider> m_endpointProvider;
  };
