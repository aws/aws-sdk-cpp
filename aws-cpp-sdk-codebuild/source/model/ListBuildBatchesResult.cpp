...
ListBuildBatchesResult::ListBuildBatchesResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListBuildBatchesResult& ListBuildBatchesResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
