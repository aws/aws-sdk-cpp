...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIMESDKMEDIAPIPELINES_API GetMediaPipelineRequest : public ChimeSDKMediaPipelinesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetMediaPipelineRequest> Clone() const
    {
      return Aws::MakeUnique<GetMediaPipelineRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "GetMediaPipeline"; }
