...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CHIMESDKMEDIAPIPELINES_API MediaPipeline
  {
  public:
    MediaPipeline();
    MediaPipeline(Aws::Utils::Json::JsonView jsonValue);
    MediaPipeline& operator=(Aws::Utils::Json::JsonView jsonValue);
