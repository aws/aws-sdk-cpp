...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIMESDKMEDIAPIPELINES_API GetMediaCapturePipelineRequest : public ChimeSDKMediaPipelinesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetMediaCapturePipelineRequest> Clone() const
    {
      return Aws::MakeUnique<GetMediaCapturePipelineRequest>(GetServiceRequestName(), *this);
    }
