...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIMESDKMEDIAPIPELINES_API CreateMediaConcatenationPipelineRequest : public ChimeSDKMediaPipelinesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateMediaConcatenationPipelineRequest> Clone() const
    {
      return Aws::MakeUnique<CreateMediaConcatenationPipelineRequest>(GetServiceRequestName(), *this);
    }
