...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CHIMESDKMEDIAPIPELINES_API MediaLiveConnectorPipeline
  {
  public:
    MediaLiveConnectorPipeline();
    MediaLiveConnectorPipeline(Aws::Utils::Json::JsonView jsonValue);
    MediaLiveConnectorPipeline& operator=(Aws::Utils::Json::JsonView jsonValue);
