...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIMESDKMEDIAPIPELINES_API DeleteMediaPipelineRequest : public ChimeSDKMediaPipelinesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteMediaPipelineRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteMediaPipelineRequest>(GetServiceRequestName(), *this);
    }
