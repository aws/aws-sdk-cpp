...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/chime-sdk-media-pipelines-2021-07-15/ResourceLimitExceededException">AWS
   * API Reference</a></p>
   */
  class AWS_CHIMESDKMEDIAPIPELINES_API ResourceLimitExceededException
  {
  public:
     ...
     * <p>The request id associated with the call responsible for the exception.</p>
     */
    inline ResourceLimitExceededException& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    /**
     * <p>The request id associated with the call responsible for the exception.</p>
     */
    inline ResourceLimitExceededException& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    /**
     * <p>The request id associated with the call responsible for the exception.</p>
     */
    inline ResourceLimitExceededException& WithRequestId(const char* value) { SetRequestId(value); return *this;}
