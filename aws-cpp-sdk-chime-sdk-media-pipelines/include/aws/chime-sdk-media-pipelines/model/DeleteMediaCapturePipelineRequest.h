...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIMESDKMEDIAPIPELINES_API DeleteMediaCapturePipelineRequest : public ChimeSDKMediaPipelinesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteMediaCapturePipelineRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteMediaCapturePipelineRequest>(GetServiceRequestName(), *this);
    }
