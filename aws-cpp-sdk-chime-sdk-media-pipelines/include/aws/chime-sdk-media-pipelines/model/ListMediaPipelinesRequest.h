...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIMESDKMEDIAPIPELINES_API ListMediaPipelinesRequest : public ChimeSDKMediaPipelinesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListMediaPipelinesRequest> Clone() const
    {
      return Aws::MakeUnique<ListMediaPipelinesRequest>(GetServiceRequestName(), *this);
    }
