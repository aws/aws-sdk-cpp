...
{
  AWS_MAKE_CALLABLE_OPERATION(CreateMediaConcatenationPipeline, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(CreateMediaConcatenationPipeline, request, handler, context, m_executor.get());
}
...
{
  AWS_MAKE_CALLABLE_OPERATION(CreateMediaLiveConnectorPipeline, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(CreateMediaLiveConnectorPipeline, request, handler, context, m_executor.get());
}
...
{
  AWS_MAKE_CALLABLE_OPERATION(DeleteMediaPipeline, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(DeleteMediaPipeline, request, handler, context, m_executor.get());
}
...
{
  AWS_MAKE_CALLABLE_OPERATION(GetMediaPipeline, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(GetMediaPipeline, request, handler, context, m_executor.get());
}
...
{
  AWS_MAKE_CALLABLE_OPERATION(ListMediaPipelines, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(ListMediaPipelines, request, handler, context, m_executor.get());
}
