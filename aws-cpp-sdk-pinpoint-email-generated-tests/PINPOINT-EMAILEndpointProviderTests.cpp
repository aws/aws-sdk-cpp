...
static const char* ALLOCATION_TAG = "AWSPinpointEmailEndpointProviderTests";
using PinpointEmailEndpointProvider = Aws::PinpointEmail::Endpoint::PinpointEmailEndpointProvider;
using EndpointParameters = Aws::Vector<Aws::Endpoint::EndpointParameter>;
using PinpointEmailResolveEndpointOutcome = Aws::PinpointEmail::Endpoint::PinpointEmailEndpointProvider::PinpointEmailResolveEndpointOutcome;
...
class PinpointEmailEndpointProviderTests :public ::testing::TestWithParam<size_t>
{
public:
...
struct PinpointEmailEndpointProviderEndpointTestCase
{
...
static const Aws::Vector<PinpointEmailEndpointProviderEndpointTestCase> TEST_CASES = {
  /*TEST CASE 0*/
...
void ValidateOutcome(const PinpointEmailResolveEndpointOutcome& outcome, const PinpointEmailEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(PinpointEmailEndpointProviderTests, EndpointProviderTest)
{
    ...
    const PinpointEmailEndpointProviderEndpointTestCase& TEST_CASE = TEST_CASES.at(TEST_CASE_IDX);
    SCOPED_TRACE(Aws::String("\nTEST CASE # ") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX) + ": " + TEST_CASE.documentation);

    std::shared_ptr<PinpointEmailEndpointProvider> endpointProvider = Aws::MakeShared<PinpointEmailEndpointProvider>(ALLOCATION_TAG);
    ASSERT_TRUE(endpointProvider) << "Failed to allocate/initialize PinpointEmailEndpointProvider";
    ...
    for(const auto& operation : TEST_CASE.operationInput)
    {
         ...
         */
        const Aws::Vector<std::reference_wrapper<const PinpointEmailEndpointProviderEndpointTestCase::OperationParamsFromTest>>
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         PinpointEmailEndpointProviderTests,
