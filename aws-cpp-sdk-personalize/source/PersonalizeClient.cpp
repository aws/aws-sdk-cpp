...
using ResolveEndpointOutcome = Aws::Personalize::Endpoint::PersonalizeEndpointProvider::PersonalizeResolveEndpointOutcome;
...
PersonalizeClient::PersonalizeClient(const Client::ClientConfiguration& clientConfiguration,
                                     std::shared_ptr<Endpoint::PersonalizeEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<PersonalizeErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<Personalize::Endpoint::PersonalizeEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
