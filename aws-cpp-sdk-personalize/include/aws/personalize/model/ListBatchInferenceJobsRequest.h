...
namespace Model
{
  ...
  /**
   */
  class AWS_PERSONALIZE_API ListBatchInferenceJobsRequest : public PersonalizeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListBatchInferenceJobsRequest> Clone() const
    {
      return Aws::MakeUnique<ListBatchInferenceJobsRequest>(GetServiceRequestName(), *this);
    }
