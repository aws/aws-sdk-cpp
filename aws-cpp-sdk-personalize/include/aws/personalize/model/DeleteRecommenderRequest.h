...
namespace Model
{
  ...
  /**
   */
  class AWS_PERSONALIZE_API DeleteRecommenderRequest : public PersonalizeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteRecommenderRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteRecommenderRequest>(GetServiceRequestName(), *this);
    }
