...
namespace Model
{
  ...
  /**
   */
  class AWS_PERSONALIZE_API DescribeBatchSegmentJobRequest : public PersonalizeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeBatchSegmentJobRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeBatchSegmentJobRequest>(GetServiceRequestName(), *this);
    }
