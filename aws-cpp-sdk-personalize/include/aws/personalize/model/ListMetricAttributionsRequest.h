...
namespace Model
{
  ...
  /**
   */
  class AWS_PERSONALIZE_API ListMetricAttributionsRequest : public PersonalizeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListMetricAttributionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListMetricAttributionsRequest>(GetServiceRequestName(), *this);
    }
