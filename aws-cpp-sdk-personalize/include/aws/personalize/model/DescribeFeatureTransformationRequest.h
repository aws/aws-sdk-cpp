...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeFeatureTransformationRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeFeatureTransformationRequest>(GetServiceRequestName(), *this);
    }
