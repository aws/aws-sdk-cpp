...
namespace Model
{
  ...
  /**
   */
  class AWS_PERSONALIZE_API DescribeDatasetExportJobRequest : public PersonalizeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeDatasetExportJobRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeDatasetExportJobRequest>(GetServiceRequestName(), *this);
    }
