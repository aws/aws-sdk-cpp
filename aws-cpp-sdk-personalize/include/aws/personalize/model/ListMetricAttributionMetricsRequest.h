...
namespace Model
{
  ...
  /**
   */
  class AWS_PERSONALIZE_API ListMetricAttributionMetricsRequest : public PersonalizeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListMetricAttributionMetricsRequest> Clone() const
    {
      return Aws::MakeUnique<ListMetricAttributionMetricsRequest>(GetServiceRequestName(), *this);
    }
