...
namespace Model
{
  ...
  /**
   */
  class AWS_PERSONALIZE_API DeleteMetricAttributionRequest : public PersonalizeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteMetricAttributionRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteMetricAttributionRequest>(GetServiceRequestName(), *this);
    }
