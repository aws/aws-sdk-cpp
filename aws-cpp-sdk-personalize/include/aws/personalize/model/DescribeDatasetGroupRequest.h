...
namespace Model
{
  ...
  /**
   */
  class AWS_PERSONALIZE_API DescribeDatasetGroupRequest : public PersonalizeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeDatasetGroupRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeDatasetGroupRequest>(GetServiceRequestName(), *this);
    }
