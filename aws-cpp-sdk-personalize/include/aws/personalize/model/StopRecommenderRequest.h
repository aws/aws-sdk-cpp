...
namespace Model
{
  ...
  /**
   */
  class AWS_PERSONALIZE_API StopRecommenderRequest : public PersonalizeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StopRecommenderRequest> Clone() const
    {
      return Aws::MakeUnique<StopRecommenderRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "StopRecommender"; }
     ...
     * <p>The Amazon Resource Name (ARN) of the recommender to stop.</p>
     */
    inline StopRecommenderRequest& WithRecommenderArn(const char* value) { SetRecommenderArn(value); return *this;}
