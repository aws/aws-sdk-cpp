...
namespace Model
{
  ...
  /**
   */
  class AWS_PERSONALIZE_API CreateMetricAttributionRequest : public PersonalizeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateMetricAttributionRequest> Clone() const
    {
      return Aws::MakeUnique<CreateMetricAttributionRequest>(GetServiceRequestName(), *this);
    }
