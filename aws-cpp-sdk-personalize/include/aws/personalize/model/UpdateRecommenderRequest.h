...
namespace Model
{
  ...
  /**
   */
  class AWS_PERSONALIZE_API UpdateRecommenderRequest : public PersonalizeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateRecommenderRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateRecommenderRequest>(GetServiceRequestName(), *this);
    }
