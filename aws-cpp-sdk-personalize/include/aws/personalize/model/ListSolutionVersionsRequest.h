...
namespace Model
{
  ...
  /**
   */
  class AWS_PERSONALIZE_API ListSolutionVersionsRequest : public PersonalizeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListSolutionVersionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListSolutionVersionsRequest>(GetServiceRequestName(), *this);
    }
