...
namespace Model
{
  ...
  /**
   */
  class AWS_PERSONALIZE_API StartRecommenderRequest : public PersonalizeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StartRecommenderRequest> Clone() const
    {
      return Aws::MakeUnique<StartRecommenderRequest>(GetServiceRequestName(), *this);
    }
