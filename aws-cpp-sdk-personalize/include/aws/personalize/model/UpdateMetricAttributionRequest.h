...
namespace Model
{
  ...
  /**
   */
  class AWS_PERSONALIZE_API UpdateMetricAttributionRequest : public PersonalizeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateMetricAttributionRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateMetricAttributionRequest>(GetServiceRequestName(), *this);
    }
