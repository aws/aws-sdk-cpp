...
namespace Model
{
  ...
  /**
   */
  class AWS_PERSONALIZE_API DeleteEventTrackerRequest : public PersonalizeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteEventTrackerRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteEventTrackerRequest>(GetServiceRequestName(), *this);
    }
