...
namespace Personalize
{
  ...
  class AWS_PERSONALIZE_API PersonalizeClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        PersonalizeClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                          std::shared_ptr<Endpoint::PersonalizeEndpointProvider> endpointProvider = Aws::MakeShared<Personalize::Endpoint::PersonalizeEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::PersonalizeEndpointProvider> m_endpointProvider;
  };
