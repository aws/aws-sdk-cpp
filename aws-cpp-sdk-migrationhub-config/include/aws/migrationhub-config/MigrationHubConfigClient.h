...
namespace MigrationHubConfig
{
  ...
  class AWS_MIGRATIONHUBCONFIG_API MigrationHubConfigClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        MigrationHubConfigClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                 std::shared_ptr<Endpoint::MigrationHubConfigEndpointProvider> endpointProvider = Aws::MakeShared<MigrationHubConfig::Endpoint::MigrationHubConfigEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::MigrationHubConfigEndpointProvider> m_endpointProvider;
  };
