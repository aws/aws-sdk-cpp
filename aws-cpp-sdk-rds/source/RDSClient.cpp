...
{
  return std::async(std::launch::async, &RDSClient::CopyDBClusterParameterGroup, this, request);
}
...
{
  m_executor->Submit(&RDSClient::CopyDBClusterParameterGroupAsyncHelper, this, request, handler, context);
}
