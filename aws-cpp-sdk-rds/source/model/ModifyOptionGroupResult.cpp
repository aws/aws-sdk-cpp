...
ModifyOptionGroupResult::ModifyOptionGroupResult(const AmazonWebServiceResult<XmlDocument>& result)
{
  *this = result;
}

ModifyOptionGroupResult& ModifyOptionGroupResult::operator =(const AmazonWebServiceResult<XmlDocument>& result)
{
