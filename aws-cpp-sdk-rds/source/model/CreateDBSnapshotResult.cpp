...
CreateDBSnapshotResult::CreateDBSnapshotResult(const AmazonWebServiceResult<XmlDocument>& result)
{
  *this = result;
}

CreateDBSnapshotResult& CreateDBSnapshotResult::operator =(const AmazonWebServiceResult<XmlDocument>& result)
{
