...
Aws::String DescribeDBProxyTargetGroupsRequest::SerializePayload() const
{
  Aws::StringStream ss;
  ss << "Action=DescribeDBProxyTargetGroups&";
...
void  DescribeDBProxyTargetGroupsRequest::DumpBodyToUrl(Aws::Http::URI& uri ) const
{
