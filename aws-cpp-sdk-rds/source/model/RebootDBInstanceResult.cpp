...
RebootDBInstanceResult::RebootDBInstanceResult(const AmazonWebServiceResult<XmlDocument>& result)
{
  *this = result;
}

RebootDBInstanceResult& RebootDBInstanceResult::operator =(const AmazonWebServiceResult<XmlDocument>& result)
{
