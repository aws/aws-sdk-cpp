...
namespace Model
{
  ...
  public:
     ...
     * traffic to and from the database. <code>MYSQL</code> supports Aurora MySQL and
     * RDS for MySQL databases. <code>POSTGRESQL</code> supports Aurora PostgreSQL and
     * RDS for PostgreSQL databases.</p>
     */
