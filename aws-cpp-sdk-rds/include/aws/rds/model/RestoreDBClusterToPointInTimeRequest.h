...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<RestoreDBClusterToPointInTimeRequest> Clone() const
    {
      return Aws::MakeUnique<RestoreDBClusterToPointInTimeRequest>(GetServiceRequestName(), *this);
    }
