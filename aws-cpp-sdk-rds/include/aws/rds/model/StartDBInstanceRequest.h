...
namespace Model
{
  ...
  /**
   */
  class AWS_RDS_API StartDBInstanceRequest : public RDSRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StartDBInstanceRequest> Clone() const
    {
      return Aws::MakeUnique<StartDBInstanceRequest>(GetServiceRequestName(), *this);
    }
