...
namespace Model
{
  ...
  public:
     ...
     * soon as possible. </p> <p>Constraints:</p> <ul> <li>Must be 1 to 255
     ...
     * Server).</p> <note> Amazon RDS API actions never return the password, so this
    ...
    /**
     * <p> The name of the DB parameter group to apply to the DB instance. Changing
     * this setting does not result in an outage. The parameter group name itself is
     * changed immediately, but the actual parameter changes are not applied until you
     * reboot the instance without failover. The db instance will NOT be rebooted
     ...
     * 35</li> <li>Can be specified for a MySQL Read Replica only if the source is
     * running MySQL 5.6</li> <li>Can be specified for a PostgreSQL Read Replica only
     * if the source is running PostgreSQL 9.3.5</li> <li>Cannot be set to 0 if the DB
     * instance is a source to Read Replicas</li> </ul>
     */
     ...
     * <li>Must be in the format hh24:mi-hh24:mi</li> <li>Times should be in Universal
     ...
     * </p> <p>For a list of valid engine versions, see <a>CreateDBInstance</a>.</p>
     */
     ...
     * supported.</p> <p>Type: Integer</p> <p> If you choose to migrate your DB
     ...
     * in some cases. During the migration, the DB instance will be available for use,
     * but might experience performance degradation. While the migration takes place,
     * nightly backups for the instance will be suspended. No other Amazon RDS
     ...
     * connections are rejected but existing connections are not interrupted. </p> <p>
    ...
    /**
     * <p> Indicates the certificate that needs to be associated with the instance.
     * </p>
     */
