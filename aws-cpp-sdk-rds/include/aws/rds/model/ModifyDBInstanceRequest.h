...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p> The new storage capacity of the RDS instance. Changing this parameter does
     ...
     * <code>true</code> for this request. </p> <p><b>MySQL</b></p> <p>Default: Uses
     * existing setting</p> <p>Valid Values: 5-1024</p> <p>Constraints: Value supplied
     ...
     * greater than the current value.</p> <p>Type: Integer</p> <p><b>Oracle</b></p>
     * <p>Default: Uses existing setting</p> <p>Valid Values: 10-1024</p>
     ...
     * rounded up so that they are 10% greater than the current value.</p> <p><b>SQL
     * Server</b></p> <p>Cannot be modified.</p>
     */
     ...
     * this parameter causes an outage during the change and is applied during the next
     ...
     * as soon as possible. </p> <p>Constraints:</p> <ul> <li>Must be 1 to 255
     ...
     * be a letter</li> <li>Cannot end with a hyphen or contain two consecutive
     * hyphens</li> </ul>
     */
    ...
    /**
     * <p> Specifies whether or not the modifications in this request and any pending
     * modifications are asynchronously applied as soon as possible, regardless of the
     * <code>PreferredMaintenanceWindow</code> setting for the DB Instance. </p> <p> If
     * this parameter is passed as <code>false</code>, changes to the DB Instance are
     * applied on the next call to <a>RebootDBInstance</a>, the next maintenance
     * reboot, or the next failure reboot, whichever occurs first. See each parameter
     * to determine when a change is applied. </p> <p>Default: <code>false</code></p>
     */
     ...
     * alphanumeric characters (MySQL), 8 to 30 alphanumeric characters (Oracle), or 8
     * to 128 alphanumeric characters (SQL Server).</p> <note> Amazon RDS API actions
     * never return the password, so this action provides a way to regain access to a
    ...
    /**
     * <p> The name of the DB Parameter Group to apply to this DB Instance. Changing
     * this parameter does not result in an outage and the change is applied during the
     * next maintenance window unless the <code>ApplyImmediately</code> parameter is
     * set to <code>true</code> for this request. </p> <p>Default: Uses existing
     * setting</p> <p>Constraints: The DB Parameter Group must be in the same DB
     ...
     * Uses existing setting</p> <p>Constraints:</p> <ul> <li>Must be a value from 0 to
     * 8</li> <li>Cannot be set to 0 if the DB Instance is a master instance with read
     * replicas or if the DB Instance is a read replica</li> </ul>
     */
     ...
     * asynchronously applied as soon as possible. </p> <p>Constraints:</p> <ul>
     * <li>Must be in the format hh24:mi-hh24:mi</li> <li>Times should be Universal
     * Time Coordinated (UTC)</li> <li>Must not conflict with the preferred maintenance
     ...
     * </p> <p>Example: <code>5.1.42</code></p>
     */
     ...
     * instance. Changing this parameter does not result in an outage and the change is
     * applied during the next maintenance window unless the
     * <code>ApplyImmediately</code> parameter is set to <code>true</code> for this
     ...
     * 10% greater than the current value.</p> <p>Type: Integer</p>
     */
     ...
     * Instance. This value is stored as a lowercase string. </p> <p>Constraints:</p>
