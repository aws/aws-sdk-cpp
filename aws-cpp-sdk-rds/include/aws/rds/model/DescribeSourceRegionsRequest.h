...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_RDS_API DescribeSourceRegionsRequest : public RDSRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeSourceRegionsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeSourceRegionsRequest>(GetServiceRequestName(), *this);
    }
