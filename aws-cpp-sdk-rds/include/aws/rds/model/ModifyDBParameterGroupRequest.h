...
namespace Model
{
  ...
  public:
     ...
     * subsequent arguments are optional. A maximum of 20 parameters may be modified in
     ...
     * both dynamic and static parameters, and changes are applied when DB Instance
     * reboots. </note>
     */
