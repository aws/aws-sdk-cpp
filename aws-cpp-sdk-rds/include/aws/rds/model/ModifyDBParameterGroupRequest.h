...
namespace Model
{
  ...
  public:
     ...
     * parameters can be modified in a single request.</p> <p>Valid Values (for the
     * application method): <code>immediate | pending-reboot</code> </p>  <p>You
     * can use the <code>immediate</code> value with dynamic parameters only. You can
     * use the <code>pending-reboot</code> value for both dynamic and static
     * parameters.</p> <p>When the application method is <code>immediate</code>,
     * changes to dynamic parameters are applied immediately to the DB instances
     * associated with the parameter group. When the application method is
