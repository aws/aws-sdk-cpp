...
namespace Model
{
  class AWS_RDS_API RevokeDBSecurityGroupIngressResult
  {
  public:
    ...
    inline RevokeDBSecurityGroupIngressResult& WithDBSecurityGroup(DBSecurityGroup&& value) { SetDBSecurityGroup(value); return *this;}
    ...
    inline RevokeDBSecurityGroupIngressResult& WithResponseMetadata(ResponseMetadata&& value) { SetResponseMetadata(value); return *this;}
