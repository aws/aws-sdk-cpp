...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<RestoreDBInstanceFromDBSnapshotRequest> Clone() const
    {
      return Aws::MakeUnique<RestoreDBInstanceFromDBSnapshotRequest>(GetServiceRequestName(), *this);
    }
