...
namespace Model
{
  ...
  public:
     ...
     * alphanumeric characters or hyphens (1 to 15 for SQL Server)</li> <li>First
     * character must be a letter</li> <li>Cannot end with a hyphen or contain two
     * consecutive hyphens</li> </ul> <p>Example: <code>my-snapshot-id</code></p>
     */
     ...
     * <ul> <li>Must contain from 1 to 255 alphanumeric characters or hyphens</li>
     * <li>First character must be a letter</li> <li>Cannot end with a hyphen or
     * contain two consecutive hyphens</li> </ul> <p>If you are restoring from a shared
     * manual DB snapshot, the <code>DBSnapshotIdentifier</code> must be the ARN of the
     * shared DB snapshot.</p>
     */
     ...
     * parameter doesn't apply to the MySQL or MariaDB engines.</p> </note>
     */
     ...
     * starts. </p> <p> Constraints: Must be an integer greater than 1000.</p> <p>
     * <b>SQL Server</b> </p> <p>Setting the IOPS value for the SQL Server database
     * engine is not supported.</p>
     */
