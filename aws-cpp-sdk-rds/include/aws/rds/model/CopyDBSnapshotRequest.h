...
namespace Model
{
  ...
  public:
     ...
     * <p>Constraints:</p> <ul> <li>Must specify a valid system snapshot in the
     * "available" state.</li> <li>If the source snapshot is in the same region as the
     * copy, specify a valid DB snapshot identifier.</li> <li>If the source snapshot is
     * in a different region than the copy, specify a valid DB snapshot ARN. For more
     * information, go to <a
     ...
     * <code>arn:aws:rds:rr-regn-1:123456789012:snapshot:mysql-instance1-snapshot-20130805</code></p>
     */
