...
namespace Model
{
  ...
  public:
    ...
    PromoteReadReplicaResult(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    PromoteReadReplicaResult& operator=(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    ...
    inline PromoteReadReplicaResult& WithDBInstance(DBInstance&& value) { SetDBInstance(value); return *this;}
    ...
    inline PromoteReadReplicaResult& WithResponseMetadata(ResponseMetadata&& value) { SetResponseMetadata(value); return *this;}
