...
namespace Model
{
  ...
  public:
    ...
    inline virtual const char* GetServiceRequestName() override { return "CopyDBClusterSnapshot"; }
  ...
  public:
     ...
     * created in, and you cannot use encryption keys from one AWS Region in another
     * AWS Region.</p>
     */
