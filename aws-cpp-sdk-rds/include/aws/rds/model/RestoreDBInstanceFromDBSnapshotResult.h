...
namespace Model
{
  ...
  public:
    ...
    RestoreDBInstanceFromDBSnapshotResult(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    RestoreDBInstanceFromDBSnapshotResult& operator=(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    ...
    inline RestoreDBInstanceFromDBSnapshotResult& WithDBInstance(DBInstance&& value) { SetDBInstance(value); return *this;}
    ...
    inline RestoreDBInstanceFromDBSnapshotResult& WithResponseMetadata(ResponseMetadata&& value) { SetResponseMetadata(value); return *this;}
