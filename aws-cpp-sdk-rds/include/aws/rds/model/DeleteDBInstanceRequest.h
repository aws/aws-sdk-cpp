...
namespace Model
{
  ...
  public:
     ...
     * 63 alphanumeric characters or hyphens</li> <li>First character must be a
     ...
     * <p>Specify <code>true</code> when deleting a Read Replica.</p> <note>The
     * FinalDBSnapshotIdentifier parameter must be specified if SkipFinalSnapshot is
     * <code>false</code>.</note> <p>Default: <code>false</code></p>
     */
     ...
     * SkipFinalSnapshot is set to <code>false</code>. </p> <note> Specifying this
     * parameter and also setting the SkipFinalShapshot parameter to true results in an
     * error. </note> <p>Constraints:</p> <ul> <li>Must be 1 to 255 alphanumeric
     * characters</li> <li>First character must be a letter</li> <li>Cannot end with a
     * hyphen or contain two consecutive hyphens</li> <li>Cannot be specified when
     * deleting a Read Replica.</li> </ul>
     */
