...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateDBInstanceReadReplicaRequest> Clone() const
    {
      return Aws::MakeUnique<CreateDBInstanceReadReplicaRequest>(GetServiceRequestName(), *this);
    }
