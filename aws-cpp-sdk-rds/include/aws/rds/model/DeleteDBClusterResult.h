...
namespace Model
{
  ...
  public:
    ...
    DeleteDBClusterResult(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    DeleteDBClusterResult& operator=(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    ...
    inline DeleteDBClusterResult& WithDBCluster(DBCluster&& value) { SetDBCluster(value); return *this;}
    ...
    inline DeleteDBClusterResult& WithResponseMetadata(ResponseMetadata&& value) { SetResponseMetadata(value); return *this;}
