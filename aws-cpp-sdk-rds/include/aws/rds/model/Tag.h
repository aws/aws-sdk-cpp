...
namespace Model
{
  ...
  public:
     ...
     * Unicode characters in length and cannot be prefixed with "aws:". The string may
     ...
     * 256 Unicode characters in length and cannot be prefixed with "aws:". The string
     * may only contain only the set of Unicode letters, digits, white-space, '_', '.',
     * '/', '=', '+', '-' (Java regex: "^([\\p{L}\\p{Z}\\p{N}_.:/=+\\-]*)$").</p>
     */
