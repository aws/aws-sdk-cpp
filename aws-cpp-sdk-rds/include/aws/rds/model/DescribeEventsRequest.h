...
namespace Model
{
  ...
  public:
     ...
     * also be provided.</li> <li>If the source type is DBInstance, then a
     * DBInstanceIdentifier must be supplied.</li> <li>If the source type is
     * DBSecurityGroup, a DBSecurityGroupName must be supplied.</li> <li>If the source
     * type is DBParameterGroup, a DBParameterGroupName must be supplied.</li> <li>If
     * the source type is DBSnapshot, a DBSnapshotIdentifier must be supplied.</li>
