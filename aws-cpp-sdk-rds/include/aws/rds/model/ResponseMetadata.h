...
namespace Model
{
  ...
  {
  public:
    AWS_RDS_API ResponseMetadata();
    AWS_RDS_API ResponseMetadata(const Aws::Utils::Xml::XmlNode& xmlNode);
    AWS_RDS_API ResponseMetadata& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
