...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeOrderableDBInstanceOptionsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeOrderableDBInstanceOptionsRequest>(GetServiceRequestName(), *this);
    }
