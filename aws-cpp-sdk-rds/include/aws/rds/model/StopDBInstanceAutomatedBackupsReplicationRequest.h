...
namespace Model
{
  ...
  /**
   */
  class AWS_RDS_API StopDBInstanceAutomatedBackupsReplicationRequest : public RDSRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StopDBInstanceAutomatedBackupsReplicationRequest> Clone() const
    {
      return Aws::MakeUnique<StopDBInstanceAutomatedBackupsReplicationRequest>(GetServiceRequestName(), *this);
    }
