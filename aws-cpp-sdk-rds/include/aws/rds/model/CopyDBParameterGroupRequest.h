...
namespace Model
{
  ...
  public:
     ...
     * <ul> <li> <p>Must specify a valid DB parameter group.</p> </li> <li> <p>If the
     * source DB parameter group is in the same region as the copy, specify a valid DB
     * parameter group identifier, for example <code>my-db-param-group</code>, or a
     * valid ARN.</p> </li> <li> <p>If the source DB parameter group is in a different
     * region than the copy, specify a valid DB parameter group ARN, for example
     * <code>arn:aws:rds:us-west-2:123456789012:pg:special-parameters</code>.</p> </li>
     * </ul>
     */
