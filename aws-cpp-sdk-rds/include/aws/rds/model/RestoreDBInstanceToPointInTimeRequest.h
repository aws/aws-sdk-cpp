...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<RestoreDBInstanceToPointInTimeRequest> Clone() const
    {
      return Aws::MakeUnique<RestoreDBInstanceToPointInTimeRequest>(GetServiceRequestName(), *this);
    }
