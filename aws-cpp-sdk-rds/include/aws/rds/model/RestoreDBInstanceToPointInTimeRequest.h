...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p> The name of the new database instance to be created. </p>
     * <p>Constraints:</p> <ul> <li>Must contain from 1 to 63 alphanumeric characters
     * or hyphens</li> <li>First character must be a letter</li> <li>Cannot end with a
     * hyphen or contain two consecutive hyphens</li> </ul>
     */
    ...
    /**
     * <p> The date and time to restore from. </p> <p>Valid Values: Value must be a UTC
     * time</p> <p>Constraints:</p> <ul> <li>Must be before the latest restorable time
     * for the DB Instance</li> <li>Cannot be specified if UseLatestRestorableTime
     * parameter is true</li> </ul> <p>Example: <code>2009-09-07T23:45:00Z</code></p>
     */
     ...
     * db.m1.xlarge | db.m2.2xlarge | db.m2.4xlarge</code></p> <p>Default: The same
     ...
     * set to true.</p> <p>Example: <code>us-east-1a</code></p>
     */
     ...
     * parameter is not used for the MySQL engine.</p> </note>
     */
