...
namespace Model
{
  class AWS_RDS_API CreateOptionGroupResult
  {
  public:
    CreateOptionGroupResult();
    CreateOptionGroupResult(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    CreateOptionGroupResult& operator=(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    ...
    inline CreateOptionGroupResult& WithOptionGroup(OptionGroup&& value) { SetOptionGroup(value); return *this;}
    ...
    inline CreateOptionGroupResult& WithResponseMetadata(ResponseMetadata&& value) { SetResponseMetadata(value); return *this;}
