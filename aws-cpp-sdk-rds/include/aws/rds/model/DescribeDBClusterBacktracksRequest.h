...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeDBClusterBacktracksRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeDBClusterBacktracksRequest>(GetServiceRequestName(), *this);
    }
