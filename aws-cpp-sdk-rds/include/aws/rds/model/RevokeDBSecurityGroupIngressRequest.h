...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<RevokeDBSecurityGroupIngressRequest> Clone() const
    {
      return Aws::MakeUnique<RevokeDBSecurityGroupIngressRequest>(GetServiceRequestName(), *this);
    }
