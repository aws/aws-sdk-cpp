...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeReservedDBInstancesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeReservedDBInstancesRequest>(GetServiceRequestName(), *this);
    }
