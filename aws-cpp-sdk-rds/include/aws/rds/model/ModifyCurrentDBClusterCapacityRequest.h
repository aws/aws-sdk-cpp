...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ModifyCurrentDBClusterCapacityRequest> Clone() const
    {
      return Aws::MakeUnique<ModifyCurrentDBClusterCapacityRequest>(GetServiceRequestName(), *this);
    }
