...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteDBInstanceAutomatedBackupRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteDBInstanceAutomatedBackupRequest>(GetServiceRequestName(), *this);
    }
