...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeReservedDBInstancesOfferingsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeReservedDBInstancesOfferingsRequest>(GetServiceRequestName(), *this);
    }
