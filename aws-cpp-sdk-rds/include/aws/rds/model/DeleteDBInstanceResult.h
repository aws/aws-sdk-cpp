...
namespace Model
{
  class AWS_RDS_API DeleteDBInstanceResult
  {
  public:
    ...
    inline DeleteDBInstanceResult& WithDBInstance(DBInstance&& value) { SetDBInstance(value); return *this;}
    ...
    inline DeleteDBInstanceResult& WithResponseMetadata(ResponseMetadata&& value) { SetResponseMetadata(value); return *this;}
