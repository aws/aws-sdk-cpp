...
namespace Model
{
  ...
  /**
   */
  class AWS_RDS_API ModifyActivityStreamRequest : public RDSRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ModifyActivityStreamRequest> Clone() const
    {
      return Aws::MakeUnique<ModifyActivityStreamRequest>(GetServiceRequestName(), *this);
    }
