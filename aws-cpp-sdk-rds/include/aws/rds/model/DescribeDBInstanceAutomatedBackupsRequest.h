...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeDBInstanceAutomatedBackupsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeDBInstanceAutomatedBackupsRequest>(GetServiceRequestName(), *this);
    }
