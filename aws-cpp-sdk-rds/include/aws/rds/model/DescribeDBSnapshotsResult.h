...
namespace Model
{
   ...
   * <a>DescribeDBSnapshots</a> action. </p>
   */
  class AWS_RDS_API DescribeDBSnapshotsResult
  {
  public:
    DescribeDBSnapshotsResult();
    DescribeDBSnapshotsResult(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    DescribeDBSnapshotsResult& operator=(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
     ...
     * <p> A list of <a>DBSnapshot</a> instances. </p>
     */
    inline void SetDBSnapshots(Aws::Vector<DBSnapshot>&& value) { m_dBSnapshots = value; }
     ...
     * <p> A list of <a>DBSnapshot</a> instances. </p>
     */
    inline DescribeDBSnapshotsResult& WithDBSnapshots(Aws::Vector<DBSnapshot>&& value) { SetDBSnapshots(value); return *this;}
     ...
     * <p> A list of <a>DBSnapshot</a> instances. </p>
     */
    inline DescribeDBSnapshotsResult& AddDBSnapshots(DBSnapshot&& value) { m_dBSnapshots.push_back(value); return *this; }
    ...
    inline DescribeDBSnapshotsResult& WithResponseMetadata(ResponseMetadata&& value) { SetResponseMetadata(value); return *this;}
