...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeDBProxyTargetGroupsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeDBProxyTargetGroupsRequest>(GetServiceRequestName(), *this);
    }
