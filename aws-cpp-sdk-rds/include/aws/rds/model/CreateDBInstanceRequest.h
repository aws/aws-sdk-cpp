...
namespace Model
{
  ...
  public:
     ...
     * no database is created in the DB instance. </p> <p>Constraints:</p> <ul>
     * <li>Must contain 1 to 64 alphanumeric characters</li> <li>Cannot be a word
     * reserved by the specified database engine</li> </ul> <p> <b>MariaDB</b> </p>
     * <p>The name of the database to create when the DB instance is created. If this
     * parameter is not specified, no database is created in the DB instance. </p>
     * <p>Constraints:</p> <ul> <li>Must contain 1 to 64 alphanumeric characters</li>
     * <li>Cannot be a word reserved by the specified database engine</li> </ul> <p>
     ...
     * database is created in the DB instance. </p> <p>Constraints:</p> <ul> <li>Must
     * contain 1 to 63 alphanumeric characters</li> <li>Must begin with a letter or an
     * underscore. Subsequent characters can be letters, underscores, or digits
     * (0-9).</li> <li>Cannot be a word reserved by the specified database engine</li>
     * </ul> <p> <b>Oracle</b> </p> <p> The Oracle System ID (SID) of the created DB
     * instance. </p> <p>Default: <code>ORCL</code></p> <p>Constraints:</p> <ul>
     * <li>Cannot be longer than 8 characters</li> </ul> <p> <b>SQL Server</b> </p>
     ...
     * instance. </p> <p>Constraints:</p> <ul> <li>Must contain 1 to 64 alphanumeric
     * characters</li> <li>Cannot be a word reserved by the specified database
     * engine</li> </ul>
     */
     ...
     * database instance. </p> <p> Type: Integer</p> <p> <b>MySQL</b> </p> <p>
     * Constraints: Must be an integer from 5 to 6144.</p> <p> <b>MariaDB</b> </p> <p>
     * Constraints: Must be an integer from 5 to 6144.</p> <p> <b>PostgreSQL</b> </p>
     * <p> Constraints: Must be an integer from 5 to 6144.</p> <p> <b>Oracle</b> </p>
     * <p> Constraints: Must be an integer from 10 to 6144.</p> <p> <b>SQL Server</b>
     * </p> <p> Constraints: Must be an integer from 200 to 4096 (Standard Edition and
     * Enterprise Edition) or from 20 to 4096 (Express Edition and Web Edition)</p>
     */
     ...
     * <code>sqlserver-web</code> | <code>postgres</code> | <code>aurora</code></p> <p>
     * Not every database engine is available for every AWS region. </p>
     */
    ...
    /**
     * <p> The name of master user for the client DB instance. </p> <p> <b>MySQL</b>
     * </p> <p>Constraints:</p> <ul> <li>Must be 1 to 16 alphanumeric characters.</li>
     * <li>First character must be a letter.</li> <li>Cannot be a reserved word for the
     * chosen database engine.</li> </ul> <p> <b>MariaDB</b> </p> <p>Constraints:</p>
     * <ul> <li>Must be 1 to 16 alphanumeric characters.</li> <li>Cannot be a reserved
     * word for the chosen database engine.</li> </ul> <p>Type: String</p> <p>
     * <b>Oracle</b> </p> <p>Constraints:</p> <ul> <li>Must be 1 to 30 alphanumeric
     * characters.</li> <li>First character must be a letter.</li> <li>Cannot be a
     * reserved word for the chosen database engine.</li> </ul> <p> <b>SQL Server</b>
     * </p> <p>Constraints:</p> <ul> <li>Must be 1 to 128 alphanumeric characters.</li>
     * <li>First character must be a letter.</li> <li>Cannot be a reserved word for the
     * chosen database engine.</li> </ul> <p> <b>PostgreSQL</b> </p>
     * <p>Constraints:</p> <ul> <li>Must be 1 to 63 alphanumeric characters.</li>
     * <li>First character must be a letter.</li> <li>Cannot be a reserved word for the
     ...
     * character except "/", """, or "@". </p> <p>Type: String</p> <p> <b>MySQL</b>
     * </p> <p> Constraints: Must contain from 8 to 41 characters. </p> <p>
     * <b>MariaDB</b> </p> <p> Constraints: Must contain from 8 to 41 characters. </p>
     * <p> <b>Oracle</b> </p> <p> Constraints: Must contain from 8 to 30 characters.
     * </p> <p> <b>SQL Server</b> </p> <p> Constraints: Must contain from 8 to 128
     * characters. </p> <p> <b>PostgreSQL</b> </p> <p> Constraints: Must contain from 8
     * to 128 characters. </p> <p> <b>Amazon Aurora</b> </p> <p> Constraints: Must
     ...
     * Instance Maintenance</a>. </p> <p> Format:
     * <code>ddd:hh24:mi-ddd:hh24:mi</code></p> <p> Default: A 30-minute window
     ...
     * <li>Must be a value from 0 to 35</li> <li>Cannot be set to 0 if the DB instance
     ...
     * <p>Type: Integer </p> <p> <b>PostgreSQL</b> </p> <p> Default:
     ...
     * RDS. Not every database engine is available for every AWS region. </p>
     * <p><b>MySQL</b></p> <ul> <li><b>Version 5.1 (Only available in the following
     * regions: ap-northeast-1, ap-southeast-1, ap-southeast-2, eu-west-1, sa-east-1,
     * us-west-1, us-west-2):</b> <code> 5.1.73a | 5.1.73b</code></li> <li><b>Version
     * 5.5 (Only available in the following regions: ap-northeast-1, ap-southeast-1,
     ...
     * regions: ap-northeast-1, ap-southeast-1, ap-southeast-2, eu-west-1, sa-east-1,
     * us-west-1, us-west-2):</b> <code> 11.2.0.2.v3 | 11.2.0.2.v4 | 11.2.0.2.v5 |
     * 11.2.0.2.v6 | 11.2.0.2.v7</code></li> <li><b>Version 11.2 (Available in all
     * regions):</b> <code> 11.2.0.3.v1 | 11.2.0.3.v2 | 11.2.0.3.v3 | 11.2.0.4.v1 |
     * 11.2.0.4.v3 | 11.2.0.4.v4</code></li> <li><b>Version 12.1 (Available in all
     * regions):</b> <code>12.1.0.1.v1 | 12.1.0.1.v2 | 12.1.0.2.v1 </code></li> </ul>
     * <p><b>Oracle Database Standard Edition (oracle-se)</b></p> <ul> <li><b>Version
     * 11.2 (Only available in the following regions: us-west-1):</b> <code>
     * 11.2.0.2.v3 | 11.2.0.2.v4 | 11.2.0.2.v5 | 11.2.0.2.v6 | 11.2.0.2.v7</code></li>
     * <li><b>Version 11.2 (Only available in the following regions: eu-central-1,
     * us-west-1):</b> <code> 11.2.0.3.v1 | 11.2.0.3.v2 | 11.2.0.3.v3 | 11.2.0.4.v1 |
     * 11.2.0.4.v3 | 11.2.0.4.v4</code></li> <li><b>Version 12.1 (Only available in the
     * following regions: eu-central-1, us-west-1):</b> <code>12.1.0.1.v1 |
     * 12.1.0.1.v2</code></li> </ul> <p><b>Oracle Database Standard Edition One
     * (oracle-se1)</b></p> <ul> <li><b>Version 11.2 (Only available in the following
     * regions: us-west-1):</b> <code> 11.2.0.2.v3 | 11.2.0.2.v4 | 11.2.0.2.v5 |
     * 11.2.0.2.v6 | 11.2.0.2.v7</code></li> <li><b>Version 11.2 (Only available in the
     * following regions: eu-central-1, us-west-1):</b> <code> 11.2.0.3.v1 |
     * 11.2.0.3.v2 | 11.2.0.3.v3 | 11.2.0.4.v1 | 11.2.0.4.v3 | 11.2.0.4.v4</code></li>
     * <li><b>Version 12.1 (Only available in the following regions: eu-central-1,
     * us-west-1):</b> <code> 12.1.0.1.v1 | 12.1.0.1.v2</code></li> </ul>
     * <p><b>PostgreSQL</b></p> <ul> <li><b>Version 9.3 (Only available in the
     * following regions: ap-northeast-1, ap-southeast-1, ap-southeast-2, eu-west-1,
     * sa-east-1, us-west-1, us-west-2):</b> <code> 9.3.1 | 9.3.2</code></li>
     * <li><b>Version 9.3 (Available in all regions):</b> <code> 9.3.3 | 9.3.5 | 9.3.6
     * | 9.3.9 | 9.3.10</code></li> <li><b>Version 9.4 (Available in all regions):</b>
     * <code> 9.4.1 | 9.4.4 | 9.4.5</code></li> </ul> <p><b>Microsoft SQL Server
     * Enterprise Edition (sqlserver-ee)</b></p> <ul> <li><b>Version 10.50 (Available
     * in all regions):</b> <code> 10.50.2789.0.v1</code></li> <li><b>Version 10.50
     ...
     * regions):</b> <code> 11.00.5058.0.v1</code></li> </ul> <p><b>Microsoft SQL
     * Server Express Edition (sqlserver-ex)</b></p> <ul> <li><b>Version 10.50
     ...
     * 12.00.4422.0.v1</code></li> </ul> <p><b>Microsoft SQL Server Standard Edition
     * (sqlserver-se)</b></p> <ul> <li><b>Version 10.50 (Available in all regions):</b>
     * <code> 10.50.2789.0.v1</code></li> <li><b>Version 10.50 (Available in all
     * regions):</b> <code> 10.50.6000.34.v1</code></li> <li><b>Version 11.00
     * (Available in all regions):</b> <code> 11.00.2100.60.v1</code></li>
     * <li><b>Version 11.00 (Available in all regions):</b> <code>
     * 11.00.5058.0.v1</code></li> <li><b>Version 12.00 (Available in all regions):</b>
     * <code> 12.00.4422.0.v1</code></li> </ul> <p><b>Microsoft SQL Server Web Edition
     * (sqlserver-web)</b></p> <ul> <li><b>Version 10.50 (Available in all
     * regions):</b> <code> 10.50.2789.0.v1</code></li> <li><b>Version 10.50 (Available
     * in all regions):</b> <code> 10.50.6000.34.v1</code></li> <li><b>Version 11.00
     * (Available in all regions):</b> <code> 11.00.2100.60.v1</code></li>
     * <li><b>Version 11.00 (Available in all regions):</b> <code>
     * 11.00.5058.0.v1</code></li> <li><b>Version 12.00 (Available in all regions):</b>
     * <code> 12.00.4422.0.v1</code></li> </ul>
     */
     ...
     * option group. </p> <p> Permanent options, such as the TDE option for Oracle
     * Advanced Security TDE, cannot be removed from an option group, and that option
     * group cannot be removed from a DB instance once it is associated with a DB
     * instance </p>
     */
     ...
     * The following list shows the default behavior in each case. </p> <ul> <li>
     * <b>Default VPC:</b> true</li> <li> <b>VPC:</b> false</li> </ul> <p> If no DB
     ...
     * metrics, specify 0. The default is 60.</p> <p>If <code>MonitoringRoleArn</code>
