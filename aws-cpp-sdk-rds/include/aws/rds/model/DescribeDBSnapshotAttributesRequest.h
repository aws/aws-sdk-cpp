...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeDBSnapshotAttributesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeDBSnapshotAttributesRequest>(GetServiceRequestName(), *this);
    }
