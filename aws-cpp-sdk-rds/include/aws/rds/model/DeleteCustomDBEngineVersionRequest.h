...
namespace Model
{
  ...
  /**
   */
  class AWS_RDS_API DeleteCustomDBEngineVersionRequest : public RDSRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteCustomDBEngineVersionRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteCustomDBEngineVersionRequest>(GetServiceRequestName(), *this);
    }
