...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteDBClusterParameterGroupRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteDBClusterParameterGroupRequest>(GetServiceRequestName(), *this);
    }
