...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>The DB cluster identifier. This parameter is stored as a lowercase string.
     ...
     * specified engine will be used. </p> <p> Constraints: </p> <ul> <li>Must be 1 to
     * 255 alphanumeric characters</li> <li>First character must be a letter</li>
     * <li>Cannot end with a hyphen or contain two consecutive hyphens</li> </ul>
     */
    ...
    /**
     * <p> The port number on which the instances in the DB cluster accept connections.
     * </p> <p> Default: <code>3306</code></p>
     */
