...
namespace Model
{
  ...
  /**
   */
  class AWS_RDS_API ModifyCustomDBEngineVersionRequest : public RDSRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ModifyCustomDBEngineVersionRequest> Clone() const
    {
      return Aws::MakeUnique<ModifyCustomDBEngineVersionRequest>(GetServiceRequestName(), *this);
    }
