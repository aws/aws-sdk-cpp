...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AuthorizeDBSecurityGroupIngressRequest> Clone() const
    {
      return Aws::MakeUnique<AuthorizeDBSecurityGroupIngressRequest>(GetServiceRequestName(), *this);
    }
