...
namespace Model
{
  ...
  public:
    ...
    inline RestoreDBClusterFromS3Result& WithDBCluster(DBCluster&& value) { SetDBCluster(value); return *this;}
    ...
    inline RestoreDBClusterFromS3Result& WithResponseMetadata(ResponseMetadata&& value) { SetResponseMetadata(value); return *this;}
