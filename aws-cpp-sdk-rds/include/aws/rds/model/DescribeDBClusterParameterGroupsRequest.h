...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeDBClusterParameterGroupsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeDBClusterParameterGroupsRequest>(GetServiceRequestName(), *this);
    }
