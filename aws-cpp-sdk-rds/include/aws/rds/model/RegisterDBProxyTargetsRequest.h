...
namespace Model
{
  ...
  /**
   */
  class AWS_RDS_API RegisterDBProxyTargetsRequest : public RDSRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<RegisterDBProxyTargetsRequest> Clone() const
    {
      return Aws::MakeUnique<RegisterDBProxyTargetsRequest>(GetServiceRequestName(), *this);
    }
