...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateCustomDBEngineVersionRequest> Clone() const
    {
      return Aws::MakeUnique<CreateCustomDBEngineVersionRequest>(GetServiceRequestName(), *this);
    }
