...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PurchaseReservedDBInstancesOfferingRequest> Clone() const
    {
      return Aws::MakeUnique<PurchaseReservedDBInstancesOfferingRequest>(GetServiceRequestName(), *this);
    }
