...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<StartDBInstanceAutomatedBackupsReplicationRequest> Clone() const
    {
      return Aws::MakeUnique<StartDBInstanceAutomatedBackupsReplicationRequest>(GetServiceRequestName(), *this);
    }
