...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_RDS_API DescribeValidDBInstanceModificationsRequest : public RDSRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeValidDBInstanceModificationsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeValidDBInstanceModificationsRequest>(GetServiceRequestName(), *this);
    }
