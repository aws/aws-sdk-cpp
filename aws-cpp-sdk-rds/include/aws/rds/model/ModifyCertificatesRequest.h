...
namespace Model
{
  ...
  /**
   */
  class AWS_RDS_API ModifyCertificatesRequest : public RDSRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ModifyCertificatesRequest> Clone() const
    {
      return Aws::MakeUnique<ModifyCertificatesRequest>(GetServiceRequestName(), *this);
    }
