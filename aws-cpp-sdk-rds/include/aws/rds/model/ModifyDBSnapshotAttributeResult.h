...
namespace Model
{
  class AWS_RDS_API ModifyDBSnapshotAttributeResult
  {
  public:
    ModifyDBSnapshotAttributeResult();
    ModifyDBSnapshotAttributeResult(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    ModifyDBSnapshotAttributeResult& operator=(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    ...
    inline ModifyDBSnapshotAttributeResult& WithDBSnapshotAttributesResult(DBSnapshotAttributesResult&& value) { SetDBSnapshotAttributesResult(value); return *this;}
    ...
    inline ModifyDBSnapshotAttributeResult& WithResponseMetadata(ResponseMetadata&& value) { SetResponseMetadata(value); return *this;}
