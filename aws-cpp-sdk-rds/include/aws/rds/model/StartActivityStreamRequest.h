...
namespace Model
{
  ...
  /**
   */
  class AWS_RDS_API StartActivityStreamRequest : public RDSRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StartActivityStreamRequest> Clone() const
    {
      return Aws::MakeUnique<StartActivityStreamRequest>(GetServiceRequestName(), *this);
    }
