...
namespace Model
{
  ...
  public:
    ...
    inline CreateDBInstanceReadReplicaResult& WithDBInstance(DBInstance&& value) { SetDBInstance(value); return *this;}
    ...
    inline CreateDBInstanceReadReplicaResult& WithResponseMetadata(ResponseMetadata&& value) { SetResponseMetadata(value); return *this;}
