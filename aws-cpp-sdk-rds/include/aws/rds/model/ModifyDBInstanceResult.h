...
namespace Model
{
  class AWS_RDS_API ModifyDBInstanceResult
  {
  public:
    ModifyDBInstanceResult();
    ModifyDBInstanceResult(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    ModifyDBInstanceResult& operator=(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    ...
    inline ModifyDBInstanceResult& WithDBInstance(DBInstance&& value) { SetDBInstance(value); return *this;}
    ...
    inline ModifyDBInstanceResult& WithResponseMetadata(ResponseMetadata&& value) { SetResponseMetadata(value); return *this;}
