...
namespace Model
{
  ...
  public:
     ...
     * <ul> <li>Must specify a valid option group.</li> <li>If the source option group
     * is in the same region as the copy, specify a valid option group identifier, for
     * example <code>my-option-group</code>, or a valid ARN.</li> <li>If the source
     * option group is in a different region than the copy, specify a valid option
    ...
    /**
     * <p>The identifier for the copied option group. </p> <p>Constraints:</p> <ul>
     ...
     * </ul> <p>Example: <code>my-option-group</code></p>
     */
