  ...
  public:
    ...
    */
    ...
    /*
     <p>The identifier for the copied option group. </p> <p>Constraints:</p> <ul> <li>Cannot be null, empty, or blank</li> <li>Must contain from 1 to 255 alphanumeric characters or hyphens</li> <li>First character must be a letter</li> <li>Cannot end with a hyphen or contain two consecutive hyphens</li> </ul> <p>Example: <code>my-option-group</code></p>
    */
    inline void SetTargetOptionGroupIdentifier(const Aws::String& value) { m_targetOptionGroupIdentifier = value; }

    /*
     <p>The identifier for the copied option group. </p> <p>Constraints:</p> <ul> <li>Cannot be null, empty, or blank</li> <li>Must contain from 1 to 255 alphanumeric characters or hyphens</li> <li>First character must be a letter</li> <li>Cannot end with a hyphen or contain two consecutive hyphens</li> </ul> <p>Example: <code>my-option-group</code></p>
    */
    inline void SetTargetOptionGroupIdentifier(const char* value) { m_targetOptionGroupIdentifier.assign(value); }
    ...
    */
    ...
    /*
     <p>The description for the copied option group. </p>
    */
    inline void SetTargetOptionGroupDescription(const Aws::String& value) { m_targetOptionGroupDescription = value; }

    /*
     <p>The description for the copied option group. </p>
    */
    inline void SetTargetOptionGroupDescription(const char* value) { m_targetOptionGroupDescription.assign(value); }
