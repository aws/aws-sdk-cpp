...
namespace Model
{
   ...
   * </p> <ul> <li><a>CreateDBSnapshot</a></li> <li><a>DeleteDBSnapshot</a></li>
  ...
  public:
    ...
    /**
     * <p> Specifies the the DBInstanceIdentifier of the DB Instance this DB Snapshot
     * was created from. </p>
     */
    ...
    /**
     * <p> Specifies the name of the Availability Zone the DB Instance was located in
     * at the time of the DB Snapshot. </p>
     */
