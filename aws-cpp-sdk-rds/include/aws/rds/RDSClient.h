   ...
   * the Query API</a>.</p> </li> </ul>
    ...
    typedef Aws::Client::AWSXMLClient BASECLASS;
        ...
        */
         ...
         * Database 19c Enterprise Edition with the January 2021 or later RU/RUR.</p>
         ...
         * create multiple RDS Custom instances from any CEV. You can also change the
         * status of a CEV to make it available or inactive.</p>  <p>The MediaImport
         * service that imports files from Amazon S3 to create CEVs isn't integrated with
         * Amazon Web Services CloudTrail. If you turn on data logging for Amazon RDS in
         * CloudTrail, calls to the <code>CreateCustomDbEngineVersion</code> event aren't
         ...
         * </p>  <p>For Aurora, this action only restores the DB cluster, not the DB
