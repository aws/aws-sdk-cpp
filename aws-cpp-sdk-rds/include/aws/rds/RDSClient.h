...
#include <future>
    ...
    namespace Model
    {
        ...
        typedef Aws::Utils::Outcome<NoResult, Aws::Client::AWSError<RDSErrors>> AddRoleToDBClusterOutcome;
        ...
        typedef Aws::Utils::Outcome<NoResult, Aws::Client::AWSError<RDSErrors>> RemoveRoleFromDBClusterOutcome;
   ...
   * the Query API</a>.</p> </li> </ul>
    ...
    typedef Aws::Client::AWSXMLClient BASECLASS;
        ...
        */
         ...
         * Amazon Aurora to Access Other AWS Services On Your Behalf</a>.</p><p><h3>See
         * Also:</h3>   <a
         ...
         * cluster snapshot from another AWS region. In that case, the region where you
         * call the <code>CopyDBClusterSnapshot</code> action is the destination region for
         * the encrypted DB cluster snapshot to be copied to. To copy an encrypted DB
         * cluster snapshot from another region, you must provide the following values:</p>
         * <ul> <li> <p> <code>KmsKeyId</code> - The AWS Key Management System (KMS) key
         * identifier for the key to use to encrypt the copy of the DB cluster snapshot in
         * the destination region.</p> </li> <li> <p> <code>PreSignedUrl</code> - A URL
         * that contains a Signature Version 4 signed request for the
         * <code>CopyDBClusterSnapshot</code> action to be called in the source region
         * where the DB cluster snapshot will be copied from. The pre-signed URL must be a
         * valid request for the <code>CopyDBClusterSnapshot</code> API action that can be
         * executed in the source region that contains the encrypted DB cluster snapshot to
         * be copied.</p> <p>The pre-signed URL request must contain the following
         * parameter values:</p> <ul> <li> <p> <code>KmsKeyId</code> - The KMS key
         * identifier for the key to use to encrypt the copy of the DB cluster snapshot in
         * the destination region. This is the same identifier for both the
         ...
         * <code>DestinationRegion</code> - The name of the region that the DB cluster
         ...
         * of the DB cluster snapshot in the destination region.</p> </li> <li> <p>
         * <code>SourceDBClusterSnapshotIdentifier</code> - The DB cluster snapshot
         * identifier for the encrypted DB cluster snapshot to be copied. This identifier
         * must be in the ARN format for the source region and is the same value as the
         ...
         * information on copying encrypted DB cluster snapshots from one region to
         * another, see <a
         ...
         * <code>KmsKeyId</code> - The AWS Key Management System (KMS) key identifier for
         * the key to use to encrypt the copy of the DB snapshot in the destination
         * region.</p> </li> <li> <p> <code>PreSignedUrl</code> - A URL that contains a
         * Signature Version 4 signed request for the <code>CopyDBSnapshot</code> action to
         * be called in the source region where the DB snapshot will be copied from. The
         ...
         * snapshot to be copied.</p> <p>The presigned URL request must contain the
         ...
         * snapshot from the us-west-2 region to the us-east-1 region, then you will call
         * the <code>CopyDBSnapshot</code> action in the us-east-1 region and provide a
         ...
         * copy of the DB snapshot in the destination region. This identifier is the same
         ...
         * Resource Name (ARN) format for the source region. For example, if you copy an
         * encrypted DB snapshot from the us-west-2 region, then your
         * <code>SourceDBSnapshotIdentifier</code> looks like this example:
         ...
         * DB snapshot in the destination region.</p> </li> <li> <p>
         * <code>SourceDBSnapshotIdentifier</code> - The DB snapshot identifier for the
         * encrypted snapshot to be copied. This identifier must be in the ARN format for
         ...
         * subnet in at least two AZs in the region.</p><p><h3>See Also:</h3>   <a
         ...
         * cannot be associated with any DB instances.</p><p><h3>See Also:</h3>   <a
         ...
         * <a>ModifyDBSnapshotAttribute</a> API action.</p><p><h3>See Also:</h3>   <a
         ...
         * one subnet in at least two AZs in the region.</p><p><h3>See Also:</h3>   <a
         ...
         * rollback activity for in-transit transactions.</p><p><h3>See Also:</h3>   <a
        ...
        /**
         * <p>Disassociates an Identity and Access Management (IAM) role from an Aurora DB
         * cluster. For more information, see <a
         * href="http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Aurora.Authorizing.AWSServices.html">Authorizing
         * Amazon Aurora to Access Other AWS Services On Your Behalf</a>.</p><p><h3>See
         * Also:</h3>   <a
         ...
         * Starting a DB instance in the AWS RDS user guide. </p><p><h3>See Also:</h3>   <a
