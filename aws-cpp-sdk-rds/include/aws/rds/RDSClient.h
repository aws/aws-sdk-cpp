...
namespace Aws
{
   ...
   * the Query API</a>.</p> </li> </ul>
    ...
    static const char* ALLOCATION_TAG;
        ...
        */
        RDSClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                  std::shared_ptr<Endpoint::RDSEndpointProvider> endpointProvider = Aws::MakeShared<RDS::Endpoint::RDSEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
        ...
        std::shared_ptr<Endpoint::RDSEndpointProvider> m_endpointProvider;
    };
  } // namespace RDS
} // namespace Aws
