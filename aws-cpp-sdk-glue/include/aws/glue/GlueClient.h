...
namespace Glue
{
  ...
  class AWS_GLUE_API GlueClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        GlueClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                   std::shared_ptr<Endpoint::GlueEndpointProvider> endpointProvider = Aws::MakeShared<Glue::Endpoint::GlueEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::GlueEndpointProvider> m_endpointProvider;
  };
