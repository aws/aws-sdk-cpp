...
namespace Model
{
  ...
  /**
   */
  class AWS_GLUE_API UpdateColumnStatisticsForPartitionRequest : public GlueRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateColumnStatisticsForPartitionRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateColumnStatisticsForPartitionRequest>(GetServiceRequestName(), *this);
    }
