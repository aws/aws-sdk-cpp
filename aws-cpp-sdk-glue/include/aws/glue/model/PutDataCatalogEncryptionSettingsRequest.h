...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PutDataCatalogEncryptionSettingsRequest> Clone() const
    {
      return Aws::MakeUnique<PutDataCatalogEncryptionSettingsRequest>(GetServiceRequestName(), *this);
    }
