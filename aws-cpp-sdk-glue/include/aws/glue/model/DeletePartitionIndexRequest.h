...
namespace Model
{
  ...
  /**
   */
  class AWS_GLUE_API DeletePartitionIndexRequest : public GlueRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeletePartitionIndexRequest> Clone() const
    {
      return Aws::MakeUnique<DeletePartitionIndexRequest>(GetServiceRequestName(), *this);
    }
