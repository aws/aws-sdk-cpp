...
namespace Model
{
  ...
  /**
   */
  class AWS_GLUE_API DeleteSchemaVersionsRequest : public GlueRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteSchemaVersionsRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteSchemaVersionsRequest>(GetServiceRequestName(), *this);
    }
