...
namespace Model
{
  ...
  /**
   */
  class AWS_GLUE_API UpdateMLTransformRequest : public GlueRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateMLTransformRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateMLTransformRequest>(GetServiceRequestName(), *this);
    }
