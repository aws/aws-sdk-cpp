...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetUnfilteredPartitionsMetadataRequest> Clone() const
    {
      return Aws::MakeUnique<GetUnfilteredPartitionsMetadataRequest>(GetServiceRequestName(), *this);
    }
