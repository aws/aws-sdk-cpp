...
namespace Model
{
  ...
  /**
   */
  class AWS_GLUE_API UpdateColumnStatisticsForTableRequest : public GlueRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateColumnStatisticsForTableRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateColumnStatisticsForTableRequest>(GetServiceRequestName(), *this);
    }
