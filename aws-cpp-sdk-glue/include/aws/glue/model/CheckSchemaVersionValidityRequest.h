...
namespace Model
{
  ...
  /**
   */
  class AWS_GLUE_API CheckSchemaVersionValidityRequest : public GlueRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CheckSchemaVersionValidityRequest> Clone() const
    {
      return Aws::MakeUnique<CheckSchemaVersionValidityRequest>(GetServiceRequestName(), *this);
    }
