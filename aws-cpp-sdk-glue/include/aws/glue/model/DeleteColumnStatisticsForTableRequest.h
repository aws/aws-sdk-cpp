...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteColumnStatisticsForTableRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteColumnStatisticsForTableRequest>(GetServiceRequestName(), *this);
    }
