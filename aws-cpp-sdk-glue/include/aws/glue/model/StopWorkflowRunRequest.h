...
namespace Model
{
  ...
  /**
   */
  class AWS_GLUE_API StopWorkflowRunRequest : public GlueRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StopWorkflowRunRequest> Clone() const
    {
      return Aws::MakeUnique<StopWorkflowRunRequest>(GetServiceRequestName(), *this);
    }
