...
namespace Model
{
  ...
  /**
   */
  class AWS_GLUE_API StartWorkflowRunRequest : public GlueRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StartWorkflowRunRequest> Clone() const
    {
      return Aws::MakeUnique<StartWorkflowRunRequest>(GetServiceRequestName(), *this);
    }
