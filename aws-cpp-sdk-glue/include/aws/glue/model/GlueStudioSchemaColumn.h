...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_GLUE_API GlueStudioSchemaColumn
  {
  public:
    GlueStudioSchemaColumn();
    GlueStudioSchemaColumn(Aws::Utils::Json::JsonView jsonValue);
    GlueStudioSchemaColumn& operator=(Aws::Utils::Json::JsonView jsonValue);
