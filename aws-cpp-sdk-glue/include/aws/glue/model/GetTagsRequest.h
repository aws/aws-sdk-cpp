...
namespace Model
{
  ...
  /**
   */
  class AWS_GLUE_API GetTagsRequest : public GlueRequest
  {
  public:
    GetTagsRequest();
    ...
    */
    virtual Aws::UniquePtr<GetTagsRequest> Clone() const
    {
      return Aws::MakeUnique<GetTagsRequest>(GetServiceRequestName(), *this);
    }
    ...
    /**
     * <p>The Amazon Resource Name (ARN) of the resource for which to retrieve
     * tags.</p>
     */
