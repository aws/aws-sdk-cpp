...
namespace Model
{
  ...
  /**
   */
  class AWS_GLUE_API GetBlueprintRunsRequest : public GlueRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetBlueprintRunsRequest> Clone() const
    {
      return Aws::MakeUnique<GetBlueprintRunsRequest>(GetServiceRequestName(), *this);
    }
