...
namespace Model
{
  ...
  /**
   */
  class AWS_GLUE_API UpdateRegistryRequest : public GlueRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateRegistryRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateRegistryRequest>(GetServiceRequestName(), *this);
    }
