...
namespace Model
{
  ...
  /**
   */
  class AWS_GLUE_API ListMLTransformsRequest : public GlueRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListMLTransformsRequest> Clone() const
    {
      return Aws::MakeUnique<ListMLTransformsRequest>(GetServiceRequestName(), *this);
    }
