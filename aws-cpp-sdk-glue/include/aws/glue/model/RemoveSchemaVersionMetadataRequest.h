...
namespace Model
{
  ...
  /**
   */
  class AWS_GLUE_API RemoveSchemaVersionMetadataRequest : public GlueRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<RemoveSchemaVersionMetadataRequest> Clone() const
    {
      return Aws::MakeUnique<RemoveSchemaVersionMetadataRequest>(GetServiceRequestName(), *this);
    }
