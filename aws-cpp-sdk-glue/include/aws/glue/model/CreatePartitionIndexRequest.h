...
namespace Model
{
  ...
  /**
   */
  class AWS_GLUE_API CreatePartitionIndexRequest : public GlueRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreatePartitionIndexRequest> Clone() const
    {
      return Aws::MakeUnique<CreatePartitionIndexRequest>(GetServiceRequestName(), *this);
    }
