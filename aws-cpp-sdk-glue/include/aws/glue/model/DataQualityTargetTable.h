...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_GLUE_API DataQualityTargetTable
  {
  public:
    DataQualityTargetTable();
    DataQualityTargetTable(Aws::Utils::Json::JsonView jsonValue);
    DataQualityTargetTable& operator=(Aws::Utils::Json::JsonView jsonValue);
