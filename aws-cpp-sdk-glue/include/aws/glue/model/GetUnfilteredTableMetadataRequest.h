...
namespace Model
{
  ...
  /**
   */
  class AWS_GLUE_API GetUnfilteredTableMetadataRequest : public GlueRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetUnfilteredTableMetadataRequest> Clone() const
    {
      return Aws::MakeUnique<GetUnfilteredTableMetadataRequest>(GetServiceRequestName(), *this);
    }
