...
namespace Model
{
  ...
  /**
   */
  class AWS_GLUE_API StartImportLabelsTaskRunRequest : public GlueRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StartImportLabelsTaskRunRequest> Clone() const
    {
      return Aws::MakeUnique<StartImportLabelsTaskRunRequest>(GetServiceRequestName(), *this);
    }
