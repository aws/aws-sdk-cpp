...
namespace Model
{
  ...
  /**
   */
  class AWS_GLUE_API ListCrawlsRequest : public GlueRequest
  {
  public:
    ListCrawlsRequest();
    ...
    */
    virtual Aws::UniquePtr<ListCrawlsRequest> Clone() const
    {
      return Aws::MakeUnique<ListCrawlsRequest>(GetServiceRequestName(), *this);
    }
