...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_GLUE_API DataQualityRuleResult
  {
  public:
    DataQualityRuleResult();
    DataQualityRuleResult(Aws::Utils::Json::JsonView jsonValue);
    DataQualityRuleResult& operator=(Aws::Utils::Json::JsonView jsonValue);
