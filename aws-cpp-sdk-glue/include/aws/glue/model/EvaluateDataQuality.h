...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_GLUE_API EvaluateDataQuality
  {
  public:
    EvaluateDataQuality();
    EvaluateDataQuality(Aws::Utils::Json::JsonView jsonValue);
    EvaluateDataQuality& operator=(Aws::Utils::Json::JsonView jsonValue);
