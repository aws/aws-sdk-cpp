...
namespace Model
{
  ...
  /**
   */
  class AWS_GLUE_API GetCrawlerRequest : public GlueRequest
  {
  public:
    GetCrawlerRequest();
    ...
    */
    virtual Aws::UniquePtr<GetCrawlerRequest> Clone() const
    {
      return Aws::MakeUnique<GetCrawlerRequest>(GetServiceRequestName(), *this);
    }
