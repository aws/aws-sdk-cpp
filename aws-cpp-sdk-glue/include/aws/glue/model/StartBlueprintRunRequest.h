...
namespace Model
{
  ...
  /**
   */
  class AWS_GLUE_API StartBlueprintRunRequest : public GlueRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StartBlueprintRunRequest> Clone() const
    {
      return Aws::MakeUnique<StartBlueprintRunRequest>(GetServiceRequestName(), *this);
    }
