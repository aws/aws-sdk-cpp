...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_GLUE_API TransformConfigParameter
  {
  public:
    TransformConfigParameter();
    TransformConfigParameter(Aws::Utils::Json::JsonView jsonValue);
    TransformConfigParameter& operator=(Aws::Utils::Json::JsonView jsonValue);
