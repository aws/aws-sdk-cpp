...
namespace Model
{
  ...
  /**
   */
  class AWS_GLUE_API GetSchemaVersionRequest : public GlueRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetSchemaVersionRequest> Clone() const
    {
      return Aws::MakeUnique<GetSchemaVersionRequest>(GetServiceRequestName(), *this);
    }
