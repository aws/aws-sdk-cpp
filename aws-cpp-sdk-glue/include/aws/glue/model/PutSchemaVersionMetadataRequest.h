...
namespace Model
{
  ...
  /**
   */
  class AWS_GLUE_API PutSchemaVersionMetadataRequest : public GlueRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutSchemaVersionMetadataRequest> Clone() const
    {
      return Aws::MakeUnique<PutSchemaVersionMetadataRequest>(GetServiceRequestName(), *this);
    }
