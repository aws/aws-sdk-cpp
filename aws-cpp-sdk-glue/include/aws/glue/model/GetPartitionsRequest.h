...
namespace Model
{
  ...
  public:
     ...
     * <p>If an invalid type is encountered, a <code> <a
     * href="https://code.amazon.com/packages/DaylightService/blobs/5820762977ffbdd59f23f4cf349e47189632202f/--/src/com/amazonaws/daylight/core/storage/parsers/query/parser/PredicateFactoryProvider.java#L37">PredicateConstructionException</a>
     * </code> is thrown. </p> <p>The following list shows the valid operators on each
     * type. When you define a crawler, the <code>partitionKey</code> type is created
     * as a <code>STRING</code>, to be compatible with the catalog partitions. </p> <p>
