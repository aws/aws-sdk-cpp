...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetUnfilteredPartitionMetadataRequest> Clone() const
    {
      return Aws::MakeUnique<GetUnfilteredPartitionMetadataRequest>(GetServiceRequestName(), *this);
    }
