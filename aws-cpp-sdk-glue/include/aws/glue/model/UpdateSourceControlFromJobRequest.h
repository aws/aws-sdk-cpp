...
namespace Model
{
  ...
  /**
   */
  class AWS_GLUE_API UpdateSourceControlFromJobRequest : public GlueRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateSourceControlFromJobRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateSourceControlFromJobRequest>(GetServiceRequestName(), *this);
    }
