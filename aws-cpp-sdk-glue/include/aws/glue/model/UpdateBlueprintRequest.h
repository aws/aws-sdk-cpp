...
namespace Model
{
  ...
  /**
   */
  class AWS_GLUE_API UpdateBlueprintRequest : public GlueRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateBlueprintRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateBlueprintRequest>(GetServiceRequestName(), *this);
    }
