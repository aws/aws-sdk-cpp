...
namespace Model
{
  ...
  /**
   */
  class AWS_GLUE_API GetPartitionIndexesRequest : public GlueRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetPartitionIndexesRequest> Clone() const
    {
      return Aws::MakeUnique<GetPartitionIndexesRequest>(GetServiceRequestName(), *this);
    }
