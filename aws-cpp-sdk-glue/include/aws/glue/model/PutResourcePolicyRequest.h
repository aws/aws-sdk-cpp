...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>If a value of <code>MUST_EXIST</code> is used here, the call will fail unless
     * a policy has already been set. If a value of <code>NOT_Exist</code> is used, the
     * call will fail if a policy has already been set. If a value of <code>NONE</code>
     * or a null value is used, the call will not depend on the existence of a
     * policy.</p>
     */
