...
namespace Model
{
  ...
  public:
     ...
     * <p>By using the <b>Grant permissions</b> command on the AWS Management
     * Console.</p> </li> </ul> <p>Must be set to <code>'TRUE'</code> if you have
     * already used the Management Console to grant cross-account access, otherwise the
     * call fails. Default is 'FALSE'.</p>
     */
