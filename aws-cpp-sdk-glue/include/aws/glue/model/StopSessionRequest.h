...
namespace Model
{
  ...
  /**
   */
  class AWS_GLUE_API StopSessionRequest : public GlueRequest
  {
  public:
    StopSessionRequest();
    ...
    */
    virtual Aws::UniquePtr<StopSessionRequest> Clone() const
    {
      return Aws::MakeUnique<StopSessionRequest>(GetServiceRequestName(), *this);
    }
