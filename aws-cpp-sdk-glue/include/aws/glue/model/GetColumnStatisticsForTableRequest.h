...
namespace Model
{
  ...
  /**
   */
  class AWS_GLUE_API GetColumnStatisticsForTableRequest : public GlueRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetColumnStatisticsForTableRequest> Clone() const
    {
      return Aws::MakeUnique<GetColumnStatisticsForTableRequest>(GetServiceRequestName(), *this);
    }
