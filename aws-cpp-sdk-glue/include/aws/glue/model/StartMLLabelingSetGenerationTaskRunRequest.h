...
namespace Model
{
  ...
  /**
   */
  class AWS_GLUE_API StartMLLabelingSetGenerationTaskRunRequest : public GlueRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StartMLLabelingSetGenerationTaskRunRequest> Clone() const
    {
      return Aws::MakeUnique<StartMLLabelingSetGenerationTaskRunRequest>(GetServiceRequestName(), *this);
    }
