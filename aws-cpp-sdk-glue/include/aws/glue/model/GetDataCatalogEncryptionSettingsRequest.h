...
namespace Model
{
  ...
  /**
   */
  class AWS_GLUE_API GetDataCatalogEncryptionSettingsRequest : public GlueRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetDataCatalogEncryptionSettingsRequest> Clone() const
    {
      return Aws::MakeUnique<GetDataCatalogEncryptionSettingsRequest>(GetServiceRequestName(), *this);
    }
