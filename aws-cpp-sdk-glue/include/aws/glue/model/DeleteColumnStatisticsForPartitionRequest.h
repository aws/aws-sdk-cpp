...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteColumnStatisticsForPartitionRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteColumnStatisticsForPartitionRequest>(GetServiceRequestName(), *this);
    }
