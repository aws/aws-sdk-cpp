...
namespace Model
{
  ...
  /**
   */
  class AWS_GLUE_API GetBlueprintRequest : public GlueRequest
  {
  public:
    GetBlueprintRequest();
    ...
    */
    virtual Aws::UniquePtr<GetBlueprintRequest> Clone() const
    {
      return Aws::MakeUnique<GetBlueprintRequest>(GetServiceRequestName(), *this);
    }
