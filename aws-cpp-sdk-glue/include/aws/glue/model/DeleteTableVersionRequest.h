...
namespace Model
{
  ...
  /**
   */
  class AWS_GLUE_API DeleteTableVersionRequest : public GlueRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteTableVersionRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteTableVersionRequest>(GetServiceRequestName(), *this);
    }
