...
namespace Model
{
  ...
  /**
   */
  class AWS_GLUE_API GetSchemaRequest : public GlueRequest
  {
  public:
    GetSchemaRequest();
    ...
    */
    virtual Aws::UniquePtr<GetSchemaRequest> Clone() const
    {
      return Aws::MakeUnique<GetSchemaRequest>(GetServiceRequestName(), *this);
    }
