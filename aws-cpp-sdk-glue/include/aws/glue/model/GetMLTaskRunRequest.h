...
namespace Model
{
  ...
  /**
   */
  class AWS_GLUE_API GetMLTaskRunRequest : public GlueRequest
  {
  public:
    GetMLTaskRunRequest();
    ...
    */
    virtual Aws::UniquePtr<GetMLTaskRunRequest> Clone() const
    {
      return Aws::MakeUnique<GetMLTaskRunRequest>(GetServiceRequestName(), *this);
    }
