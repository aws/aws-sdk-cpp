...
namespace Model
{
  ...
  /**
   */
  class AWS_GLUE_API DeleteUserDefinedFunctionRequest : public GlueRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteUserDefinedFunctionRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteUserDefinedFunctionRequest>(GetServiceRequestName(), *this);
    }
