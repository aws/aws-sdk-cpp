...
namespace Model
{
  ...
  /**
   */
  class AWS_GLUE_API ResumeWorkflowRunRequest : public GlueRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ResumeWorkflowRunRequest> Clone() const
    {
      return Aws::MakeUnique<ResumeWorkflowRunRequest>(GetServiceRequestName(), *this);
    }
