...
namespace Model
{
  ...
  /**
   */
  class AWS_GLUE_API BatchUpdatePartitionRequest : public GlueRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchUpdatePartitionRequest> Clone() const
    {
      return Aws::MakeUnique<BatchUpdatePartitionRequest>(GetServiceRequestName(), *this);
    }
