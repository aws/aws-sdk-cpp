...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_GLUE_API DataQualityRuleRecommendationRunFilter
  {
  public:
    DataQualityRuleRecommendationRunFilter();
    DataQualityRuleRecommendationRunFilter(Aws::Utils::Json::JsonView jsonValue);
    DataQualityRuleRecommendationRunFilter& operator=(Aws::Utils::Json::JsonView jsonValue);
