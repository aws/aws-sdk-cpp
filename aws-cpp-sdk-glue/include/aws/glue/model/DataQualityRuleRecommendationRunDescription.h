...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_GLUE_API DataQualityRuleRecommendationRunDescription
  {
  public:
    DataQualityRuleRecommendationRunDescription();
    DataQualityRuleRecommendationRunDescription(Aws::Utils::Json::JsonView jsonValue);
    DataQualityRuleRecommendationRunDescription& operator=(Aws::Utils::Json::JsonView jsonValue);
