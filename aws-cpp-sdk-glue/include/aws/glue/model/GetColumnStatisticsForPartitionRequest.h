...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetColumnStatisticsForPartitionRequest> Clone() const
    {
      return Aws::MakeUnique<GetColumnStatisticsForPartitionRequest>(GetServiceRequestName(), *this);
    }
