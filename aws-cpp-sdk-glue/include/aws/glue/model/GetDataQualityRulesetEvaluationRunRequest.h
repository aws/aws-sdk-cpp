...
namespace Model
{
  ...
  /**
   */
  class AWS_GLUE_API GetDataQualityRulesetEvaluationRunRequest : public GlueRequest
  {
  public:
    ...
    inline virtual const char* GetServiceRequestName() const override { return "GetDataQualityRulesetEvaluationRun"; }
