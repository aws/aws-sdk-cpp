...
Aws::String GlueEndpointRules::GetRulesAsString()
{
    return Aws::String(GlueEndpointRules::Rules.begin(), GlueEndpointRules::Rules.end());
}

const Aws::Vector<char> GlueEndpointRules::Rules = {
...
'u','e','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i',
...
'/','g','l','u','e','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n',
