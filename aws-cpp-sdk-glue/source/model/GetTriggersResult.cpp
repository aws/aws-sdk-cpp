...
GetTriggersResult::GetTriggersResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

GetTriggersResult& GetTriggersResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
