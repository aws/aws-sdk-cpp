...
Aws::Http::HeaderValueCollection ListSchemaVersionsRequest::GetRequestSpecificHeaders() const
{
  Aws::Http::HeaderValueCollection headers;
  headers.insert(Aws::Http::HeaderValuePair("X-Amz-Target", "AWSGlue.ListSchemaVersions"));
  return headers;
