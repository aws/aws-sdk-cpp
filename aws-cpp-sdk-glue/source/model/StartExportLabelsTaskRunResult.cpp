...
StartExportLabelsTaskRunResult::StartExportLabelsTaskRunResult()
{
}

StartExportLabelsTaskRunResult::StartExportLabelsTaskRunResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
