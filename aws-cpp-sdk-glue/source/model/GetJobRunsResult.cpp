...
GetJobRunsResult::GetJobRunsResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

GetJobRunsResult& GetJobRunsResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
