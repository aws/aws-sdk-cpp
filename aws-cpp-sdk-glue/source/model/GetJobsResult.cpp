...
GetJobsResult::GetJobsResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

GetJobsResult& GetJobsResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
