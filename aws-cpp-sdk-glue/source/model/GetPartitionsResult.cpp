...
GetPartitionsResult::GetPartitionsResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

GetPartitionsResult& GetPartitionsResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
