...
GetConnectionsResult::GetConnectionsResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

GetConnectionsResult& GetConnectionsResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
