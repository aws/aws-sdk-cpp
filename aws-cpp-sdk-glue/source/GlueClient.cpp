...
using ResolveEndpointOutcome = Aws::Glue::Endpoint::GlueEndpointProvider::GlueResolveEndpointOutcome;
...
GlueClient::GlueClient(const Client::ClientConfiguration& clientConfiguration,
                       std::shared_ptr<Endpoint::GlueEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<GlueErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<Glue::Endpoint::GlueEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
