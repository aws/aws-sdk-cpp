...
using SESV2ResolveEndpointOutcome = Aws::SESV2::Endpoint::SESV2EndpointProvider::SESV2ResolveEndpointOutcome;
...
void ValidateOutcome(const SESV2ResolveEndpointOutcome& outcome, const SESV2EndpointProviderEndpointTestCase::Expect& expect)
{
