...
using PricingResolveEndpointOutcome = Aws::Pricing::Endpoint::PricingEndpointProvider::PricingResolveEndpointOutcome;
...
void ValidateOutcome(const PricingResolveEndpointOutcome& outcome, const PricingEndpointProviderEndpointTestCase::Expect& expect)
{
