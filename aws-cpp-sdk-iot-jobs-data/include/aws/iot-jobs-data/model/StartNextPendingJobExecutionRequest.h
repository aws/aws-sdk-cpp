...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<StartNextPendingJobExecutionRequest> Clone() const
    {
      return Aws::MakeUnique<StartNextPendingJobExecutionRequest>(GetServiceRequestName(), *this);
    }
