...
{
const size_t IoTJobsDataPlaneEndpointRules::RulesBlobStrLen = 3482;
const size_t IoTJobsDataPlaneEndpointRules::RulesBlobSize = 3483;

using RulesBlobT = Aws::Array<const char, IoTJobsDataPlaneEndpointRules::RulesBlobSize>;
...
't','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','d','a','t','a','.','j',
'o','b','s','.','i','o','t','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a',
...
't','t','p','s',':','/','/','d','a','t','a','.','j','o','b','s','.','i','o','t','-','f','i','p','s',
...
':','"','h','t','t','p','s',':','/','/','d','a','t','a','.','j','o','b','s','.','i','o','t','.','{',
...
':','/','/','d','a','t','a','.','j','o','b','s','.','i','o','t','.','{','R','e','g','i','o','n','}',
...
const char* IoTJobsDataPlaneEndpointRules::GetRulesBlob()
{
