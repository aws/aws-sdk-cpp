...
Aws::String IoTJobsDataPlaneEndpointRules::GetRulesAsString()
{
    return Aws::String(IoTJobsDataPlaneEndpointRules::Rules.begin(), IoTJobsDataPlaneEndpointRules::Rules.end());
}

const Aws::Vector<char> IoTJobsDataPlaneEndpointRules::Rules = {
...
'"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','d','a','t','a','.','j','o',
'b','s','.','i','o','t','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r',
...
't','p','s',':','/','/','d','a','t','a','.','j','o','b','s','.','i','o','t','-','f','i','p','s','.',
...
'"','h','t','t','p','s',':','/','/','d','a','t','a','.','j','o','b','s','.','i','o','t','.','{','R',
