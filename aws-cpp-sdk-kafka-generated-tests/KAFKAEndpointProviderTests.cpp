...
using KafkaResolveEndpointOutcome = Aws::Kafka::Endpoint::KafkaEndpointProvider::KafkaResolveEndpointOutcome;
...
void ValidateOutcome(const KafkaResolveEndpointOutcome& outcome, const KafkaEndpointProviderEndpointTestCase::Expect& expect)
{
