...
using IoTResolveEndpointOutcome = Aws::IoT::Endpoint::IoTEndpointProvider::IoTResolveEndpointOutcome;
...
void ValidateOutcome(const IoTResolveEndpointOutcome& outcome, const IoTEndpointProviderEndpointTestCase::Expect& expect)
{
