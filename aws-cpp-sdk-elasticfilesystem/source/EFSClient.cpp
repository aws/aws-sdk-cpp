...
using ResolveEndpointOutcome = Aws::EFS::Endpoint::EFSEndpointProvider::EFSResolveEndpointOutcome;
...
EFSClient::EFSClient(const Client::ClientConfiguration& clientConfiguration,
                     std::shared_ptr<Endpoint::EFSEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<EFSErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<EFS::Endpoint::EFSEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
