...
namespace EFS
{
const size_t EFSEndpointRules::RulesBlobStrLen = 3436;
const size_t EFSEndpointRules::RulesBlobSize = 3437;

using RulesBlobT = Aws::Array<const char, EFSEndpointRules::RulesBlobSize>;
...
't','t','p','s',':','/','/','e','l','a','s','t','i','c','f','i','l','e','s','y','s','t','e','m','-',
...
'l','a','s','t','i','c','f','i','l','e','s','y','s','t','e','m','-','f','i','p','s','.','{','R','e',
...
't','p','s',':','/','/','e','l','a','s','t','i','c','f','i','l','e','s','y','s','t','e','m','.','{',
...
':','/','/','e','l','a','s','t','i','c','f','i','l','e','s','y','s','t','e','m','.','{','R','e','g',
...
const char* EFSEndpointRules::GetRulesBlob()
{
