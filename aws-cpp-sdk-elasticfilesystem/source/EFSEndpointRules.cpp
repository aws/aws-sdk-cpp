...
Aws::String EFSEndpointRules::GetRulesAsString()
{
    return Aws::String(EFSEndpointRules::Rules.begin(), EFSEndpointRules::Rules.end());
}

const Aws::Vector<char> EFSEndpointRules::Rules = {
