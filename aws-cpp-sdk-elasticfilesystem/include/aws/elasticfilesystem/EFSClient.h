...
namespace EFS
{
  ...
  class AWS_EFS_API EFSClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        EFSClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                  std::shared_ptr<Endpoint::EFSEndpointProvider> endpointProvider = Aws::MakeShared<EFS::Endpoint::EFSEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::EFSEndpointProvider> m_endpointProvider;
  };
