...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateReplicationConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<CreateReplicationConfigurationRequest>(GetServiceRequestName(), *this);
    }
