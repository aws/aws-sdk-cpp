...
namespace Model
{
  ...
  /**
   */
  class AWS_EFS_API DescribeAccountPreferencesRequest : public EFSRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeAccountPreferencesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeAccountPreferencesRequest>(GetServiceRequestName(), *this);
    }
