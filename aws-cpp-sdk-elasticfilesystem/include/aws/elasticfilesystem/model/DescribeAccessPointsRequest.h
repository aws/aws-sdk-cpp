...
namespace Model
{
  ...
  /**
   */
  class AWS_EFS_API DescribeAccessPointsRequest : public EFSRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeAccessPointsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeAccessPointsRequest>(GetServiceRequestName(), *this);
    }
