...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteReplicationConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteReplicationConfigurationRequest>(GetServiceRequestName(), *this);
    }
