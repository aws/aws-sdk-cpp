...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeLifecycleConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeLifecycleConfigurationRequest>(GetServiceRequestName(), *this);
    }
