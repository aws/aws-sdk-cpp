  ...
  */
  ...
  public:
    ...
    */
    ...
    /*
     <p>A valid IPv4 address within the address range of the specified subnet.</p>
    */
    ...
    */
    ...
    /*
     <p> Up to 5 VPC security group IDs, of the form "sg-xxxxxxxx". These must be for the same VPC as subnet specified. </p>
    */
