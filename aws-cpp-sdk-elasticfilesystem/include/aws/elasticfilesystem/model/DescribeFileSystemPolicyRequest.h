...
namespace Model
{
  ...
  /**
   */
  class AWS_EFS_API DescribeFileSystemPolicyRequest : public EFSRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeFileSystemPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeFileSystemPolicyRequest>(GetServiceRequestName(), *this);
    }
