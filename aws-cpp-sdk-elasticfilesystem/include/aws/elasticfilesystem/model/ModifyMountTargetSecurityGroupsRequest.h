...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ModifyMountTargetSecurityGroupsRequest> Clone() const
    {
      return Aws::MakeUnique<ModifyMountTargetSecurityGroupsRequest>(GetServiceRequestName(), *this);
    }
