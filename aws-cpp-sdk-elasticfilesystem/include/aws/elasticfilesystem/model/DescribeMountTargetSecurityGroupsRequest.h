...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeMountTargetSecurityGroupsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeMountTargetSecurityGroupsRequest>(GetServiceRequestName(), *this);
    }
