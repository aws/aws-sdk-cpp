...
namespace Model
{
  ...
  */
  ...
  public:
    ...
    /*
     <p>A string, present if provided by caller in the request.</p>
    */
    ...
    */
    ...
    /*
     <p>A string, present if there are more file systems than returned in the response. You can use the <code>NextMarker</code> in the subsequent request to fetch the descriptions.</p>
    */
