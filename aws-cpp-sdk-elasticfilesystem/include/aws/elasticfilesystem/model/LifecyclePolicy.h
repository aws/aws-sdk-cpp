...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>A value that indicates how long it takes to transition to the IA storage
     * class. Currently, the only possible value is <code>AFTER_30_DAYS</code>.</p> <p>
     * <code>AFTER_30_DAYS</code> indicates files that have not been read from or
     * written to for 30 days are transitioned from the Standard storage class to the
     * IA storage class. Metadata operations such as listing the contents of a
     * directory don't count as a file access event.</p>
     */
