...
namespace Model
{
  ...
  /**
   */
  class AWS_EFS_API DescribeBackupPolicyRequest : public EFSRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeBackupPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeBackupPolicyRequest>(GetServiceRequestName(), *this);
    }
