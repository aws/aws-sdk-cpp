...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>Specifies the KMS key you want to use to encrypt the destination file system.
     * If you do not specify a KMS key, EFS uses your default KMS key for Amazon EFS,
     * <code>/aws/elasticfilesystem</code>. This ID can be in one of the following
     * formats:</p> <ul> <li> <p>Key ID - A unique identifier of the key, for example
