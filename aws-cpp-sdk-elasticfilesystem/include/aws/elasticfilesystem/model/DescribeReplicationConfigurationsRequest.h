...
namespace Model
{
  ...
  /**
   */
  class AWS_EFS_API DescribeReplicationConfigurationsRequest : public EFSRequest
  {
  public:
    ...
    /**
     * <p>You can retrieve replication configurations for a specific file system by
     * providing a file system ID.</p>
     */
     ...
     * <code>NextMarker</code> in a subsequent request to fetch the next page of
     * output.</p>
     */
    ...
    /**
     * <p>(Optional) You can optionally specify the <code>MaxItems</code> parameter to
