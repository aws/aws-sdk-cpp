...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeReplicationConfigurationsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeReplicationConfigurationsRequest>(GetServiceRequestName(), *this);
    }
