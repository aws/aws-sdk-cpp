  ...
  */
  ...
  public:
    ...
    */
    ...
    /*
     <p>Optional. String. Opaque pagination token returned from a previous <code>DescribeTags</code> operation. If present, it specifies to continue the list from where the previous call left off.</p>
    */
