...
namespace Model
{
  ...
  {
  public:
    AWS_EFS_API TooManyRequests();
    AWS_EFS_API TooManyRequests(Aws::Utils::Json::JsonView jsonValue);
    AWS_EFS_API TooManyRequests& operator=(Aws::Utils::Json::JsonView jsonValue);
