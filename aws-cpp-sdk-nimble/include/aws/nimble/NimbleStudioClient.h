...
namespace NimbleStudio
{
  ...
  class AWS_NIMBLESTUDIO_API NimbleStudioClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        NimbleStudioClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                           std::shared_ptr<Endpoint::NimbleStudioEndpointProvider> endpointProvider = Aws::MakeShared<NimbleStudio::Endpoint::NimbleStudioEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::NimbleStudioEndpointProvider> m_endpointProvider;
  };
