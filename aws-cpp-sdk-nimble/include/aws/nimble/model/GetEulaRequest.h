...
namespace Model
{
  ...
  /**
   */
  class AWS_NIMBLESTUDIO_API GetEulaRequest : public NimbleStudioRequest
  {
  public:
    GetEulaRequest();
    ...
    */
    virtual Aws::UniquePtr<GetEulaRequest> Clone() const
    {
      return Aws::MakeUnique<GetEulaRequest>(GetServiceRequestName(), *this);
    }
