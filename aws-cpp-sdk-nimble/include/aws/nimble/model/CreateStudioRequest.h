...
namespace Model
{
  ...
  /**
   * <p>A collection of studio resources.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/nimble-2020-08-01/CreateStudioRequest">AWS
   * API Reference</a></p>
   */
  class AWS_NIMBLESTUDIO_API CreateStudioRequest : public NimbleStudioRequest
  {
  public:
    CreateStudioRequest();
