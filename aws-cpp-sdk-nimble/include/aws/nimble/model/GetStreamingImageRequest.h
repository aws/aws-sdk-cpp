...
namespace Model
{
  ...
  /**
   */
  class AWS_NIMBLESTUDIO_API GetStreamingImageRequest : public NimbleStudioRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetStreamingImageRequest> Clone() const
    {
      return Aws::MakeUnique<GetStreamingImageRequest>(GetServiceRequestName(), *this);
    }
