...
namespace Model
{
  ...
  /**
   */
  class AWS_NIMBLESTUDIO_API GetStudioComponentRequest : public NimbleStudioRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetStudioComponentRequest> Clone() const
    {
      return Aws::MakeUnique<GetStudioComponentRequest>(GetServiceRequestName(), *this);
    }
