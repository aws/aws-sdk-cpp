...
namespace Model
{
  ...
  /**
   */
  class AWS_NIMBLESTUDIO_API GetStreamingSessionRequest : public NimbleStudioRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetStreamingSessionRequest> Clone() const
    {
      return Aws::MakeUnique<GetStreamingSessionRequest>(GetServiceRequestName(), *this);
    }
