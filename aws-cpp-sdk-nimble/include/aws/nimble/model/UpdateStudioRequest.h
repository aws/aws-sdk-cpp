...
namespace Model
{
  ...
  /**
   * <p>The studio ID.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/nimble-2020-08-01/UpdateStudioRequest">AWS
   * API Reference</a></p>
   */
  class AWS_NIMBLESTUDIO_API UpdateStudioRequest : public NimbleStudioRequest
  {
  public:
    UpdateStudioRequest();
