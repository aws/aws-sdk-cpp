...
namespace Model
{
  ...
  /**
   */
  class AWS_NIMBLESTUDIO_API GetStreamingSessionStreamRequest : public NimbleStudioRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetStreamingSessionStreamRequest> Clone() const
    {
      return Aws::MakeUnique<GetStreamingSessionStreamRequest>(GetServiceRequestName(), *this);
    }
