...
namespace Model
{
  ...
  /**
   */
  class AWS_NIMBLESTUDIO_API StopStreamingSessionRequest : public NimbleStudioRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StopStreamingSessionRequest> Clone() const
    {
      return Aws::MakeUnique<StopStreamingSessionRequest>(GetServiceRequestName(), *this);
    }
