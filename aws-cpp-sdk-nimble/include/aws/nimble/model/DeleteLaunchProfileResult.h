...
namespace Model
{
  class DeleteLaunchProfileResult
  {
  public:
    AWS_NIMBLESTUDIO_API DeleteLaunchProfileResult();
    AWS_NIMBLESTUDIO_API DeleteLaunchProfileResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
