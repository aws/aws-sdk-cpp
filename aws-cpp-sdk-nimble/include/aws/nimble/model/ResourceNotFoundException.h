...
namespace Model
{
  ...
  {
  public:
    AWS_NIMBLESTUDIO_API ResourceNotFoundException();
    AWS_NIMBLESTUDIO_API ResourceNotFoundException(Aws::Utils::Json::JsonView jsonValue);
    AWS_NIMBLESTUDIO_API ResourceNotFoundException& operator=(Aws::Utils::Json::JsonView jsonValue);
