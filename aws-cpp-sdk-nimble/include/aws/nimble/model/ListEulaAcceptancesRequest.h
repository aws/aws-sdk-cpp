...
namespace Model
{
  ...
  /**
   */
  class AWS_NIMBLESTUDIO_API ListEulaAcceptancesRequest : public NimbleStudioRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListEulaAcceptancesRequest> Clone() const
    {
      return Aws::MakeUnique<ListEulaAcceptancesRequest>(GetServiceRequestName(), *this);
    }
