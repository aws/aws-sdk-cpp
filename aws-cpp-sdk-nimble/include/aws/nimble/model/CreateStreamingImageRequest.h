...
namespace Model
{
  ...
  /**
   * <p>A collection of streaming images.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/nimble-2020-08-01/CreateStreamingImageRequest">AWS
   * API Reference</a></p>
   */
  class AWS_NIMBLESTUDIO_API CreateStreamingImageRequest : public NimbleStudioRequest
  {
  public:
