...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateStreamingSessionStreamRequest> Clone() const
    {
      return Aws::MakeUnique<CreateStreamingSessionStreamRequest>(GetServiceRequestName(), *this);
    }
