...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<StartStudioSSOConfigurationRepairRequest> Clone() const
    {
      return Aws::MakeUnique<StartStudioSSOConfigurationRepairRequest>(GetServiceRequestName(), *this);
    }
