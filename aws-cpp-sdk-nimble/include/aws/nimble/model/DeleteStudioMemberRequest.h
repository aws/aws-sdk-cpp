...
namespace Model
{
  ...
  /**
   */
  class AWS_NIMBLESTUDIO_API DeleteStudioMemberRequest : public NimbleStudioRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteStudioMemberRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteStudioMemberRequest>(GetServiceRequestName(), *this);
    }
