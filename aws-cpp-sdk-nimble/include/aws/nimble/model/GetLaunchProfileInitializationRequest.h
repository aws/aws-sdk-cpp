...
namespace Model
{
  ...
  /**
   */
  class AWS_NIMBLESTUDIO_API GetLaunchProfileInitializationRequest : public NimbleStudioRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetLaunchProfileInitializationRequest> Clone() const
    {
      return Aws::MakeUnique<GetLaunchProfileInitializationRequest>(GetServiceRequestName(), *this);
    }
