...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>The folder path in Linux workstations where files are uploaded. The default
     * path is <code>$HOME/Downloads</code>.</p>
     */
    ...
    /**
     * <p>The folder path in Windows workstations where files are uploaded. The default
     * path is <code>%HOMEPATH%\Downloads</code>.</p>
     */
