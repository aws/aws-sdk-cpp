...
namespace Model
{
  ...
  /**
   */
  class AWS_NIMBLESTUDIO_API GetLaunchProfileMemberRequest : public NimbleStudioRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetLaunchProfileMemberRequest> Clone() const
    {
      return Aws::MakeUnique<GetLaunchProfileMemberRequest>(GetServiceRequestName(), *this);
    }
