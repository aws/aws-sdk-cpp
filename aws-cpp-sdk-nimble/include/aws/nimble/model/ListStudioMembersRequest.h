...
namespace Model
{
  ...
  /**
   */
  class AWS_NIMBLESTUDIO_API ListStudioMembersRequest : public NimbleStudioRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListStudioMembersRequest> Clone() const
    {
      return Aws::MakeUnique<ListStudioMembersRequest>(GetServiceRequestName(), *this);
    }
