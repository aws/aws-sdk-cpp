...
namespace Model
{
  ...
  /**
   */
  class AWS_NIMBLESTUDIO_API DeleteStudioComponentRequest : public NimbleStudioRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteStudioComponentRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteStudioComponentRequest>(GetServiceRequestName(), *this);
    }
