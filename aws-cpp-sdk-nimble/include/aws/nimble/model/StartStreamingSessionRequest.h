...
namespace Model
{
  ...
  /**
   */
  class AWS_NIMBLESTUDIO_API StartStreamingSessionRequest : public NimbleStudioRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StartStreamingSessionRequest> Clone() const
    {
      return Aws::MakeUnique<StartStreamingSessionRequest>(GetServiceRequestName(), *this);
    }
