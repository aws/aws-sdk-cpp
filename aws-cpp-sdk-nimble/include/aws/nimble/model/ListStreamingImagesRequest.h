...
namespace Model
{
  ...
  /**
   */
  class AWS_NIMBLESTUDIO_API ListStreamingImagesRequest : public NimbleStudioRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListStreamingImagesRequest> Clone() const
    {
      return Aws::MakeUnique<ListStreamingImagesRequest>(GetServiceRequestName(), *this);
    }
