...
namespace Model
{
  ...
  /**
   */
  class AWS_NIMBLESTUDIO_API UpdateStreamingImageRequest : public NimbleStudioRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateStreamingImageRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateStreamingImageRequest>(GetServiceRequestName(), *this);
    }
