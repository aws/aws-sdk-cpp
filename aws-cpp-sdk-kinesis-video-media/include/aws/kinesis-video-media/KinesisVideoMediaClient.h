...
namespace KinesisVideoMedia
{
  ...
  class AWS_KINESISVIDEOMEDIA_API KinesisVideoMediaClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        KinesisVideoMediaClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                std::shared_ptr<Endpoint::KinesisVideoMediaEndpointProvider> endpointProvider = Aws::MakeShared<KinesisVideoMedia::Endpoint::KinesisVideoMediaEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::KinesisVideoMediaEndpointProvider> m_endpointProvider;
  };
