    ...
    public:
      typedef Aws::Client::AWSJsonClient BASECLASS;
        ...
        */
         ...
         * is called a "chunk." For more information, see . The <code>GetMedia</code> API
         * returns a stream of these chunks starting from the chunk that you specify in the
         * request. </p> <p>The following limits apply when using the <code>GetMedia</code>
         * API:</p> <ul> <li> <p>A client can call <code>GetMedia</code> up to five times
         * per second per stream. </p> </li> <li> <p>Kinesis Video Streams sends media data
         * at a rate of up to 25 megabytes per second (or 200 megabits per second) during a
         * <code>GetMedia</code> session. </p> </li> </ul><p><h3>See Also:</h3>   <a
