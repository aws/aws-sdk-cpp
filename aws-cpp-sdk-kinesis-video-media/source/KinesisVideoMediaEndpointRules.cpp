...
Aws::String KinesisVideoMediaEndpointRules::GetRulesAsString()
{
    return Aws::String(KinesisVideoMediaEndpointRules::Rules.begin(), KinesisVideoMediaEndpointRules::Rules.end());
}

const Aws::Vector<char> KinesisVideoMediaEndpointRules::Rules = {
...
'v','i','d','e','o','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t',
...
'p','s',':','/','/','k','i','n','e','s','i','s','v','i','d','e','o','-','f','i','p','s','.','{','R',
...
't','t','p','s',':','/','/','k','i','n','e','s','i','s','v','i','d','e','o','.','{','R','e','g','i',
...
'd','p','o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','k',
'i','n','e','s','i','s','v','i','d','e','o','.','{','R','e','g','i','o','n','}','.','{','P','a','r',
