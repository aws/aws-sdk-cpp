...
namespace MediaConnect
{
  ...
  class AWS_MEDIACONNECT_API MediaConnectClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        MediaConnectClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                           std::shared_ptr<Endpoint::MediaConnectEndpointProvider> endpointProvider = Aws::MakeShared<MediaConnect::Endpoint::MediaConnectEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::MediaConnectEndpointProvider> m_endpointProvider;
  };
