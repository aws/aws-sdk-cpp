...
namespace Model
{
  ...
  /**
   */
  class AWS_MEDIACONNECT_API RemoveFlowMediaStreamRequest : public MediaConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<RemoveFlowMediaStreamRequest> Clone() const
    {
      return Aws::MakeUnique<RemoveFlowMediaStreamRequest>(GetServiceRequestName(), *this);
    }
