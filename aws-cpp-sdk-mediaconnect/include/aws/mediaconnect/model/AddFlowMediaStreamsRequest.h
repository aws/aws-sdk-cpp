...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_MEDIACONNECT_API AddFlowMediaStreamsRequest : public MediaConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AddFlowMediaStreamsRequest> Clone() const
    {
      return Aws::MakeUnique<AddFlowMediaStreamsRequest>(GetServiceRequestName(), *this);
    }
