...
namespace Model
{
  ...
  /**
   */
  class AWS_MEDIACONNECT_API ListReservationsRequest : public MediaConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListReservationsRequest> Clone() const
    {
      return Aws::MakeUnique<ListReservationsRequest>(GetServiceRequestName(), *this);
    }
