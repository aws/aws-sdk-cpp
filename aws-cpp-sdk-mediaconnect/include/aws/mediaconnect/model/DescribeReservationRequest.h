...
namespace Model
{
  ...
  /**
   */
  class AWS_MEDIACONNECT_API DescribeReservationRequest : public MediaConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeReservationRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeReservationRequest>(GetServiceRequestName(), *this);
    }
