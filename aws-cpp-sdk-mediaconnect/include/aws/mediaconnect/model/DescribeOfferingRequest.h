...
namespace Model
{
  ...
  /**
   */
  class AWS_MEDIACONNECT_API DescribeOfferingRequest : public MediaConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeOfferingRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeOfferingRequest>(GetServiceRequestName(), *this);
    }
