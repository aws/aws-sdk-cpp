...
Aws::String MediaConnectEndpointRules::GetRulesAsString()
{
    return Aws::String(MediaConnectEndpointRules::Rules.begin(), MediaConnectEndpointRules::Rules.end());
}

const Aws::Vector<char> MediaConnectEndpointRules::Rules = {
...
'p','s',':','/','/','m','e','d','i','a','c','o','n','n','e','c','t','-','f','i','p','s','.','{','R',
...
'd','p','o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','m',
'e','d','i','a','c','o','n','n','e','c','t','.','{','R','e','g','i','o','n','}','.','{','P','a','r',
