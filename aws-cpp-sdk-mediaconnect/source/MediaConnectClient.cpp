...
using ResolveEndpointOutcome = Aws::MediaConnect::Endpoint::MediaConnectEndpointProvider::MediaConnectResolveEndpointOutcome;
...
MediaConnectClient::MediaConnectClient(const Client::ClientConfiguration& clientConfiguration,
                                       std::shared_ptr<Endpoint::MediaConnectEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<MediaConnectErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<MediaConnect::Endpoint::MediaConnectEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
