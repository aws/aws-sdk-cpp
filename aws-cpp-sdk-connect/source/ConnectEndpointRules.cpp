...
Aws::String ConnectEndpointRules::GetRulesAsString()
{
    return Aws::String(ConnectEndpointRules::Rules.begin(), ConnectEndpointRules::Rules.end());
}

const Aws::Vector<char> ConnectEndpointRules::Rules = {
