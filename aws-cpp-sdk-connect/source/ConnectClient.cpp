...
using ResolveEndpointOutcome = Aws::Connect::Endpoint::ConnectEndpointProvider::ConnectResolveEndpointOutcome;
...
ConnectClient::ConnectClient(const Client::ClientConfiguration& clientConfiguration,
                             std::shared_ptr<Endpoint::ConnectEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<ConnectErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<Connect::Endpoint::ConnectEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
