...
namespace Connect
{
  ...
  class AWS_CONNECT_API ConnectClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        ConnectClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                      std::shared_ptr<Endpoint::ConnectEndpointProvider> endpointProvider = Aws::MakeShared<Connect::Endpoint::ConnectEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::ConnectEndpointProvider> m_endpointProvider;
  };
