...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CONNECT_API TaskActionDefinition
  {
  public:
    TaskActionDefinition();
    TaskActionDefinition(Aws::Utils::Json::JsonView jsonValue);
    TaskActionDefinition& operator=(Aws::Utils::Json::JsonView jsonValue);
