...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API UpdateContactFlowModuleMetadataRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateContactFlowModuleMetadataRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateContactFlowModuleMetadataRequest>(GetServiceRequestName(), *this);
    }
