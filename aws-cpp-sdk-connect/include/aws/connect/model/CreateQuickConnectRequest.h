...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API CreateQuickConnectRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateQuickConnectRequest> Clone() const
    {
      return Aws::MakeUnique<CreateQuickConnectRequest>(GetServiceRequestName(), *this);
    }
