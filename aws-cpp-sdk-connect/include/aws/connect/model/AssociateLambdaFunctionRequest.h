...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API AssociateLambdaFunctionRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateLambdaFunctionRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateLambdaFunctionRequest>(GetServiceRequestName(), *this);
    }
