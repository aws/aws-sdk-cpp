...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API CreateContactFlowRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateContactFlowRequest> Clone() const
    {
      return Aws::MakeUnique<CreateContactFlowRequest>(GetServiceRequestName(), *this);
    }
