...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API StartContactStreamingRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StartContactStreamingRequest> Clone() const
    {
      return Aws::MakeUnique<StartContactStreamingRequest>(GetServiceRequestName(), *this);
    }
