...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CONNECT_API HierarchyLevelUpdate
  {
  public:
    HierarchyLevelUpdate();
    HierarchyLevelUpdate(Aws::Utils::Json::JsonView jsonValue);
    HierarchyLevelUpdate& operator=(Aws::Utils::Json::JsonView jsonValue);
