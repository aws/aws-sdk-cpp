...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API AssociateInstanceStorageConfigRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateInstanceStorageConfigRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateInstanceStorageConfigRequest>(GetServiceRequestName(), *this);
    }
