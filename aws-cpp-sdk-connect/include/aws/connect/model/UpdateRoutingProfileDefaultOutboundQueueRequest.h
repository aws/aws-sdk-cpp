...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API UpdateRoutingProfileDefaultOutboundQueueRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateRoutingProfileDefaultOutboundQueueRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateRoutingProfileDefaultOutboundQueueRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "UpdateRoutingProfileDefaultOutboundQueue"; }
