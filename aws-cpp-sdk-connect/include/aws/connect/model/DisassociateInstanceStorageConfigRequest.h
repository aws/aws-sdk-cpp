...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateInstanceStorageConfigRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateInstanceStorageConfigRequest>(GetServiceRequestName(), *this);
    }
