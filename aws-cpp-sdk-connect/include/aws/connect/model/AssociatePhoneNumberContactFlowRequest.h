...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API AssociatePhoneNumberContactFlowRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociatePhoneNumberContactFlowRequest> Clone() const
    {
      return Aws::MakeUnique<AssociatePhoneNumberContactFlowRequest>(GetServiceRequestName(), *this);
    }
