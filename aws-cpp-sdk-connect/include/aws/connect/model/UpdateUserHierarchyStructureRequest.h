...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateUserHierarchyStructureRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateUserHierarchyStructureRequest>(GetServiceRequestName(), *this);
    }
