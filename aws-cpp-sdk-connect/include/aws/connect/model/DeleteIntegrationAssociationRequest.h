...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API DeleteIntegrationAssociationRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteIntegrationAssociationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteIntegrationAssociationRequest>(GetServiceRequestName(), *this);
    }
