...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API GetTaskTemplateRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetTaskTemplateRequest> Clone() const
    {
      return Aws::MakeUnique<GetTaskTemplateRequest>(GetServiceRequestName(), *this);
    }
