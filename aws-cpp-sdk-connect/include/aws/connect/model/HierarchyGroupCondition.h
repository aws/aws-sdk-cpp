...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CONNECT_API HierarchyGroupCondition
  {
  public:
    HierarchyGroupCondition();
    HierarchyGroupCondition(Aws::Utils::Json::JsonView jsonValue);
    HierarchyGroupCondition& operator=(Aws::Utils::Json::JsonView jsonValue);
