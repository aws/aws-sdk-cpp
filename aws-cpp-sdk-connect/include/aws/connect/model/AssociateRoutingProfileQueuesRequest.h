...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API AssociateRoutingProfileQueuesRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateRoutingProfileQueuesRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateRoutingProfileQueuesRequest>(GetServiceRequestName(), *this);
    }
