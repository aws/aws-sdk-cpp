...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API UpdateRoutingProfileConcurrencyRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateRoutingProfileConcurrencyRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateRoutingProfileConcurrencyRequest>(GetServiceRequestName(), *this);
    }
