...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API SearchAvailablePhoneNumbersRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<SearchAvailablePhoneNumbersRequest> Clone() const
    {
      return Aws::MakeUnique<SearchAvailablePhoneNumbersRequest>(GetServiceRequestName(), *this);
    }
