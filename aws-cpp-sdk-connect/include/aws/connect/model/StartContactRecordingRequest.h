...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API StartContactRecordingRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StartContactRecordingRequest> Clone() const
    {
      return Aws::MakeUnique<StartContactRecordingRequest>(GetServiceRequestName(), *this);
    }
