...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API CreateQueueRequest : public ConnectRequest
  {
  public:
    CreateQueueRequest();
    ...
    */
    virtual Aws::UniquePtr<CreateQueueRequest> Clone() const
    {
      return Aws::MakeUnique<CreateQueueRequest>(GetServiceRequestName(), *this);
    }
