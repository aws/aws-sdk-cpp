...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API UpdateTrafficDistributionRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateTrafficDistributionRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateTrafficDistributionRequest>(GetServiceRequestName(), *this);
    }
