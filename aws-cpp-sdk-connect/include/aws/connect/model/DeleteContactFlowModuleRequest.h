...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API DeleteContactFlowModuleRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteContactFlowModuleRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteContactFlowModuleRequest>(GetServiceRequestName(), *this);
    }
