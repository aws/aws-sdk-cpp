...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateQueueQuickConnectsRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateQueueQuickConnectsRequest>(GetServiceRequestName(), *this);
    }
