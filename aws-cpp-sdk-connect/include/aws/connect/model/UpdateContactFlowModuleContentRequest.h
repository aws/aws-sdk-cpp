...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API UpdateContactFlowModuleContentRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateContactFlowModuleContentRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateContactFlowModuleContentRequest>(GetServiceRequestName(), *this);
    }
