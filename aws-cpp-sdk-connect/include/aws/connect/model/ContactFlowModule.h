...
namespace Model
{
  ...
  /**
   * <p>Contains information about a contact flow module.</p><p><h3>See Also:</h3>  
   * <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/connect-2017-08-08/ContactFlowModule">AWS
   * API Reference</a></p>
   */
  class AWS_CONNECT_API ContactFlowModule
  {
  public:
    ContactFlowModule();
    ContactFlowModule(Aws::Utils::Json::JsonView jsonValue);
    ContactFlowModule& operator=(Aws::Utils::Json::JsonView jsonValue);
