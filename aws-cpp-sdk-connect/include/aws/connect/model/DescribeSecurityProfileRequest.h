...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API DescribeSecurityProfileRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeSecurityProfileRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeSecurityProfileRequest>(GetServiceRequestName(), *this);
    }
