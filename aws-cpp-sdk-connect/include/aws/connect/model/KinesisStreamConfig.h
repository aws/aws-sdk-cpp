...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CONNECT_API KinesisStreamConfig
  {
  public:
    KinesisStreamConfig();
    KinesisStreamConfig(Aws::Utils::Json::JsonView jsonValue);
    KinesisStreamConfig& operator=(Aws::Utils::Json::JsonView jsonValue);
