...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API UpdateQueueHoursOfOperationRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateQueueHoursOfOperationRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateQueueHoursOfOperationRequest>(GetServiceRequestName(), *this);
    }
