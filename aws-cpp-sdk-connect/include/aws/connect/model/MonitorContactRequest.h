...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API MonitorContactRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<MonitorContactRequest> Clone() const
    {
      return Aws::MakeUnique<MonitorContactRequest>(GetServiceRequestName(), *this);
    }
