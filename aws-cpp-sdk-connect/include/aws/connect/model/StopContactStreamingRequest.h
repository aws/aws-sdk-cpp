...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API StopContactStreamingRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StopContactStreamingRequest> Clone() const
    {
      return Aws::MakeUnique<StopContactStreamingRequest>(GetServiceRequestName(), *this);
    }
