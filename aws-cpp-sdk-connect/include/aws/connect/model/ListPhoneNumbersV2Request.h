...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API ListPhoneNumbersV2Request : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListPhoneNumbersV2Request> Clone() const
    {
      return Aws::MakeUnique<ListPhoneNumbersV2Request>(GetServiceRequestName(), *this);
    }
