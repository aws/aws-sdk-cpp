...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API UpdateAgentStatusRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateAgentStatusRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateAgentStatusRequest>(GetServiceRequestName(), *this);
    }
