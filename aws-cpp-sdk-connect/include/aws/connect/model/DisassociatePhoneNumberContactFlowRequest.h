...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API DisassociatePhoneNumberContactFlowRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociatePhoneNumberContactFlowRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociatePhoneNumberContactFlowRequest>(GetServiceRequestName(), *this);
    }
