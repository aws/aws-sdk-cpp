...
namespace Model
{
  ...
  /**
   * <p>The contact flow is not valid.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/connect-2017-08-08/InvalidContactFlowException">AWS
   * API Reference</a></p>
   */
  class AWS_CONNECT_API InvalidContactFlowException
  {
  public:
    InvalidContactFlowException();
    InvalidContactFlowException(Aws::Utils::Json::JsonView jsonValue);
    InvalidContactFlowException& operator=(Aws::Utils::Json::JsonView jsonValue);
