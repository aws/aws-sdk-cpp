...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateInstanceStorageConfigRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateInstanceStorageConfigRequest>(GetServiceRequestName(), *this);
    }
