...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API ClaimPhoneNumberRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ClaimPhoneNumberRequest> Clone() const
    {
      return Aws::MakeUnique<ClaimPhoneNumberRequest>(GetServiceRequestName(), *this);
    }
