...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CONNECT_API NotificationRecipientType
  {
  public:
    NotificationRecipientType();
    NotificationRecipientType(Aws::Utils::Json::JsonView jsonValue);
    NotificationRecipientType& operator=(Aws::Utils::Json::JsonView jsonValue);
