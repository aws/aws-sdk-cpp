...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API DescribeAgentStatusRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeAgentStatusRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeAgentStatusRequest>(GetServiceRequestName(), *this);
    }
