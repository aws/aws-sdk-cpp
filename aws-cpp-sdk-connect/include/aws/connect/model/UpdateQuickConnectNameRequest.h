...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API UpdateQuickConnectNameRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateQuickConnectNameRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateQuickConnectNameRequest>(GetServiceRequestName(), *this);
    }
