...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API DescribeInstanceStorageConfigRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeInstanceStorageConfigRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeInstanceStorageConfigRequest>(GetServiceRequestName(), *this);
    }
