...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API AssociateApprovedOriginRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateApprovedOriginRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateApprovedOriginRequest>(GetServiceRequestName(), *this);
    }
