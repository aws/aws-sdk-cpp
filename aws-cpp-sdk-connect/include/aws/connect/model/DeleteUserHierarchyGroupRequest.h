...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API DeleteUserHierarchyGroupRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteUserHierarchyGroupRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteUserHierarchyGroupRequest>(GetServiceRequestName(), *this);
    }
