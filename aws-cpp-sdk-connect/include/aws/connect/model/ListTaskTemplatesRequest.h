...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API ListTaskTemplatesRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListTaskTemplatesRequest> Clone() const
    {
      return Aws::MakeUnique<ListTaskTemplatesRequest>(GetServiceRequestName(), *this);
    }
