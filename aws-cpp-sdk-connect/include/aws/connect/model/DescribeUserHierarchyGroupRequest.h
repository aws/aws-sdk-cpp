...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API DescribeUserHierarchyGroupRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeUserHierarchyGroupRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeUserHierarchyGroupRequest>(GetServiceRequestName(), *this);
    }
