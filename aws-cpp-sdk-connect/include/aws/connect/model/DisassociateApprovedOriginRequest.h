...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API DisassociateApprovedOriginRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateApprovedOriginRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateApprovedOriginRequest>(GetServiceRequestName(), *this);
    }
