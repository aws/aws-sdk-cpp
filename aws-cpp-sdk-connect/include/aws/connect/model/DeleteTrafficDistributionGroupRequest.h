...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API DeleteTrafficDistributionGroupRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteTrafficDistributionGroupRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteTrafficDistributionGroupRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "DeleteTrafficDistributionGroup"; }
