...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API ListRoutingProfileQueuesRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListRoutingProfileQueuesRequest> Clone() const
    {
      return Aws::MakeUnique<ListRoutingProfileQueuesRequest>(GetServiceRequestName(), *this);
    }
