...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API SuspendContactRecordingRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<SuspendContactRecordingRequest> Clone() const
    {
      return Aws::MakeUnique<SuspendContactRecordingRequest>(GetServiceRequestName(), *this);
    }
