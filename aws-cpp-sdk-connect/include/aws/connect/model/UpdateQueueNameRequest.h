...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API UpdateQueueNameRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateQueueNameRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateQueueNameRequest>(GetServiceRequestName(), *this);
    }
