...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateIntegrationAssociationRequest> Clone() const
    {
      return Aws::MakeUnique<CreateIntegrationAssociationRequest>(GetServiceRequestName(), *this);
    }
