...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API CreateTaskTemplateRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateTaskTemplateRequest> Clone() const
    {
      return Aws::MakeUnique<CreateTaskTemplateRequest>(GetServiceRequestName(), *this);
    }
