...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API DeleteTaskTemplateRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteTaskTemplateRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteTaskTemplateRequest>(GetServiceRequestName(), *this);
    }
