...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API DescribePhoneNumberRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribePhoneNumberRequest> Clone() const
    {
      return Aws::MakeUnique<DescribePhoneNumberRequest>(GetServiceRequestName(), *this);
    }
