...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API DismissUserContactRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DismissUserContactRequest> Clone() const
    {
      return Aws::MakeUnique<DismissUserContactRequest>(GetServiceRequestName(), *this);
    }
