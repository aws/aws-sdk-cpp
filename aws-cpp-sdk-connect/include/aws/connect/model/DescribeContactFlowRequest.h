...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API DescribeContactFlowRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeContactFlowRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeContactFlowRequest>(GetServiceRequestName(), *this);
    }
