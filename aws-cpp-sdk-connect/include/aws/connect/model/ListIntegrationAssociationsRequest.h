...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListIntegrationAssociationsRequest> Clone() const
    {
      return Aws::MakeUnique<ListIntegrationAssociationsRequest>(GetServiceRequestName(), *this);
    }
