...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API UpdateRoutingProfileQueuesRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateRoutingProfileQueuesRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateRoutingProfileQueuesRequest>(GetServiceRequestName(), *this);
    }
