...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API DescribeTrafficDistributionGroupRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeTrafficDistributionGroupRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeTrafficDistributionGroupRequest>(GetServiceRequestName(), *this);
    }
