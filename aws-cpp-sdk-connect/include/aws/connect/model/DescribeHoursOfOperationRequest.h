...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API DescribeHoursOfOperationRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeHoursOfOperationRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeHoursOfOperationRequest>(GetServiceRequestName(), *this);
    }
