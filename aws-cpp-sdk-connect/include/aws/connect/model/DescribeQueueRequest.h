...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API DescribeQueueRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeQueueRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeQueueRequest>(GetServiceRequestName(), *this);
    }
