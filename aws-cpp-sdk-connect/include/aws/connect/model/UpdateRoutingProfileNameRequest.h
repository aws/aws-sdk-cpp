...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API UpdateRoutingProfileNameRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateRoutingProfileNameRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateRoutingProfileNameRequest>(GetServiceRequestName(), *this);
    }
