...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API AssociateBotRequest : public ConnectRequest
  {
  public:
    AssociateBotRequest();
    ...
    */
    virtual Aws::UniquePtr<AssociateBotRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateBotRequest>(GetServiceRequestName(), *this);
    }
