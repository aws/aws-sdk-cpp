...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API ListInstancesRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListInstancesRequest> Clone() const
    {
      return Aws::MakeUnique<ListInstancesRequest>(GetServiceRequestName(), *this);
    }
