...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API UpdateUserHierarchyGroupNameRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateUserHierarchyGroupNameRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateUserHierarchyGroupNameRequest>(GetServiceRequestName(), *this);
    }
