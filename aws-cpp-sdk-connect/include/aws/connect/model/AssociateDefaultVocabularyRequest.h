...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API AssociateDefaultVocabularyRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateDefaultVocabularyRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateDefaultVocabularyRequest>(GetServiceRequestName(), *this);
    }
