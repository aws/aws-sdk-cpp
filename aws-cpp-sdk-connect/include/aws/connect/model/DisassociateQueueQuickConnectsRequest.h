...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API DisassociateQueueQuickConnectsRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateQueueQuickConnectsRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateQueueQuickConnectsRequest>(GetServiceRequestName(), *this);
    }
