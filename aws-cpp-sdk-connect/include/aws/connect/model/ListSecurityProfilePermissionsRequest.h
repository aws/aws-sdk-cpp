...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListSecurityProfilePermissionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListSecurityProfilePermissionsRequest>(GetServiceRequestName(), *this);
    }
