...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetCurrentUserDataRequest> Clone() const
    {
      return Aws::MakeUnique<GetCurrentUserDataRequest>(GetServiceRequestName(), *this);
    }
     ...
     * <p>The maximum number of results to return per page.</p>
     */
    inline GetCurrentUserDataRequest& WithMaxResults(int value) { SetMaxResults(value); return *this;}
