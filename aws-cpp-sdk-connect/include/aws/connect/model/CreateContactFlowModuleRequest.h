...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API CreateContactFlowModuleRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateContactFlowModuleRequest> Clone() const
    {
      return Aws::MakeUnique<CreateContactFlowModuleRequest>(GetServiceRequestName(), *this);
    }
