...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API UpdateQueueMaxContactsRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateQueueMaxContactsRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateQueueMaxContactsRequest>(GetServiceRequestName(), *this);
    }
