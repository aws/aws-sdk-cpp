...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API UpdateContactFlowNameRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateContactFlowNameRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateContactFlowNameRequest>(GetServiceRequestName(), *this);
    }
