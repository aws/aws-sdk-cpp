...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API DeleteHoursOfOperationRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteHoursOfOperationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteHoursOfOperationRequest>(GetServiceRequestName(), *this);
    }
