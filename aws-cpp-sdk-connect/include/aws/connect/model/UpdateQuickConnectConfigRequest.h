...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API UpdateQuickConnectConfigRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateQuickConnectConfigRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateQuickConnectConfigRequest>(GetServiceRequestName(), *this);
    }
