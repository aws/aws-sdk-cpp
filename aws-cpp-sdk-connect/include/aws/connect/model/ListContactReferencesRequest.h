...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API ListContactReferencesRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListContactReferencesRequest> Clone() const
    {
      return Aws::MakeUnique<ListContactReferencesRequest>(GetServiceRequestName(), *this);
    }
