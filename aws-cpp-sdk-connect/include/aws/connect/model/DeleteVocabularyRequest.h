...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API DeleteVocabularyRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteVocabularyRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteVocabularyRequest>(GetServiceRequestName(), *this);
    }
