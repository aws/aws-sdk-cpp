...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API DescribeInstanceAttributeRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeInstanceAttributeRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeInstanceAttributeRequest>(GetServiceRequestName(), *this);
    }
