...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CONNECT_API KinesisFirehoseConfig
  {
  public:
    KinesisFirehoseConfig();
    KinesisFirehoseConfig(Aws::Utils::Json::JsonView jsonValue);
    KinesisFirehoseConfig& operator=(Aws::Utils::Json::JsonView jsonValue);
