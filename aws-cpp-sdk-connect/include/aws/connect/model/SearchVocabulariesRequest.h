...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API SearchVocabulariesRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<SearchVocabulariesRequest> Clone() const
    {
      return Aws::MakeUnique<SearchVocabulariesRequest>(GetServiceRequestName(), *this);
    }
