...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API DisassociateRoutingProfileQueuesRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateRoutingProfileQueuesRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateRoutingProfileQueuesRequest>(GetServiceRequestName(), *this);
    }
