...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API DescribeVocabularyRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeVocabularyRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeVocabularyRequest>(GetServiceRequestName(), *this);
    }
