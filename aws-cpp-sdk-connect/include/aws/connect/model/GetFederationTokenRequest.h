...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API GetFederationTokenRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetFederationTokenRequest> Clone() const
    {
      return Aws::MakeUnique<GetFederationTokenRequest>(GetServiceRequestName(), *this);
    }
