...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API SearchQueuesRequest : public ConnectRequest
  {
  public:
    SearchQueuesRequest();
    ...
    */
    virtual Aws::UniquePtr<SearchQueuesRequest> Clone() const
    {
      return Aws::MakeUnique<SearchQueuesRequest>(GetServiceRequestName(), *this);
    }
