...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CONNECT_API AttachmentReference
  {
  public:
    AttachmentReference();
    AttachmentReference(Aws::Utils::Json::JsonView jsonValue);
    AttachmentReference& operator=(Aws::Utils::Json::JsonView jsonValue);
