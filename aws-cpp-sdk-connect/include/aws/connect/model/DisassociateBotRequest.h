...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API DisassociateBotRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateBotRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateBotRequest>(GetServiceRequestName(), *this);
    }
