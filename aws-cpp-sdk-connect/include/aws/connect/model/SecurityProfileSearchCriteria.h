...
namespace Model
{
  ...
  /**
   * <p>The search criteria to be used to return security profiles.</p><p><h3>See
   * Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/connect-2017-08-08/SecurityProfileSearchCriteria">AWS
   * API Reference</a></p>
   */
  class AWS_CONNECT_API SecurityProfileSearchCriteria
  {
  public:
    SecurityProfileSearchCriteria();
    SecurityProfileSearchCriteria(Aws::Utils::Json::JsonView jsonValue);
    SecurityProfileSearchCriteria& operator=(Aws::Utils::Json::JsonView jsonValue);
