...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API PutUserStatusRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutUserStatusRequest> Clone() const
    {
      return Aws::MakeUnique<PutUserStatusRequest>(GetServiceRequestName(), *this);
    }
