...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CONNECT_API TaskTemplateDefaultFieldValue
  {
  public:
    TaskTemplateDefaultFieldValue();
    TaskTemplateDefaultFieldValue(Aws::Utils::Json::JsonView jsonValue);
    TaskTemplateDefaultFieldValue& operator=(Aws::Utils::Json::JsonView jsonValue);
