...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CONNECT_API TaskTemplateMetadata
  {
  public:
    TaskTemplateMetadata();
    TaskTemplateMetadata(Aws::Utils::Json::JsonView jsonValue);
    TaskTemplateMetadata& operator=(Aws::Utils::Json::JsonView jsonValue);
