...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API ReplicateInstanceRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ReplicateInstanceRequest> Clone() const
    {
      return Aws::MakeUnique<ReplicateInstanceRequest>(GetServiceRequestName(), *this);
    }
