...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateQueueOutboundCallerConfigRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateQueueOutboundCallerConfigRequest>(GetServiceRequestName(), *this);
    }
