...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeUserHierarchyStructureRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeUserHierarchyStructureRequest>(GetServiceRequestName(), *this);
    }
