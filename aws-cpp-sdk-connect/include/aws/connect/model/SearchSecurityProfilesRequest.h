...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECT_API SearchSecurityProfilesRequest : public ConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<SearchSecurityProfilesRequest> Clone() const
    {
      return Aws::MakeUnique<SearchSecurityProfilesRequest>(GetServiceRequestName(), *this);
    }
