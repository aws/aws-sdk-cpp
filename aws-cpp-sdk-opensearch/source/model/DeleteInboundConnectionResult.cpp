...
DeleteInboundConnectionResult::DeleteInboundConnectionResult()
{
}

DeleteInboundConnectionResult::DeleteInboundConnectionResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
