...
Aws::String OpenSearchServiceEndpointRules::GetRulesAsString()
{
    return Aws::String(OpenSearchServiceEndpointRules::Rules.begin(), OpenSearchServiceEndpointRules::Rules.end());
}

const Aws::Vector<char> OpenSearchServiceEndpointRules::Rules = {
