...
{
const size_t OpenSearchServiceEndpointRules::RulesBlobStrLen = 3438;
const size_t OpenSearchServiceEndpointRules::RulesBlobSize = 3439;

using RulesBlobT = Aws::Array<const char, OpenSearchServiceEndpointRules::RulesBlobSize>;
...
const char* OpenSearchServiceEndpointRules::GetRulesBlob()
{
