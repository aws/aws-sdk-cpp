...
namespace OpenSearchService
{
  ...
  class AWS_OPENSEARCHSERVICE_API OpenSearchServiceClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        OpenSearchServiceClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                std::shared_ptr<Endpoint::OpenSearchServiceEndpointProvider> endpointProvider = Aws::MakeShared<OpenSearchService::Endpoint::OpenSearchServiceEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::OpenSearchServiceEndpointProvider> m_endpointProvider;
  };
