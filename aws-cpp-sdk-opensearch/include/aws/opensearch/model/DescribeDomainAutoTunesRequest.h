...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_OPENSEARCHSERVICE_API DescribeDomainAutoTunesRequest : public OpenSearchServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeDomainAutoTunesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeDomainAutoTunesRequest>(GetServiceRequestName(), *this);
    }
