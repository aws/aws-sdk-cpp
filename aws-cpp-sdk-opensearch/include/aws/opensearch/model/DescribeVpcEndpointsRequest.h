...
namespace Model
{
  ...
  /**
   */
  class AWS_OPENSEARCHSERVICE_API DescribeVpcEndpointsRequest : public OpenSearchServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeVpcEndpointsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeVpcEndpointsRequest>(GetServiceRequestName(), *this);
    }
