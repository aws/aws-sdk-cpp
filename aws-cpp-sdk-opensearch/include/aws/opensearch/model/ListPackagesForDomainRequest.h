...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_OPENSEARCHSERVICE_API ListPackagesForDomainRequest : public OpenSearchServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListPackagesForDomainRequest> Clone() const
    {
      return Aws::MakeUnique<ListPackagesForDomainRequest>(GetServiceRequestName(), *this);
    }
