...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_OPENSEARCHSERVICE_API DeleteInboundConnectionRequest : public OpenSearchServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteInboundConnectionRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteInboundConnectionRequest>(GetServiceRequestName(), *this);
    }
