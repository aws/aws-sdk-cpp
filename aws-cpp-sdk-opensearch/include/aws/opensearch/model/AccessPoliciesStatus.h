...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_OPENSEARCHSERVICE_API AccessPoliciesStatus
  {
  public:
    ...
    /**
     * <p>The status of the access policy for the domain. See <code>OptionStatus</code>
     * for the status information that's included. </p>
     */
