...
namespace Model
{
  ...
  /**
   */
  class AWS_OPENSEARCHSERVICE_API UpdateVpcEndpointRequest : public OpenSearchServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateVpcEndpointRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateVpcEndpointRequest>(GetServiceRequestName(), *this);
    }
