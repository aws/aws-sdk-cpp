...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_OPENSEARCHSERVICE_API RejectInboundConnectionRequest : public OpenSearchServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<RejectInboundConnectionRequest> Clone() const
    {
      return Aws::MakeUnique<RejectInboundConnectionRequest>(GetServiceRequestName(), *this);
    }
