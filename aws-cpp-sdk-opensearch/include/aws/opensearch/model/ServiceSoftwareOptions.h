...
namespace Model
{
  ...
  /**
   * <p>The current options of an domain service software options.</p><p><h3>See
   * Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/opensearch-2021-01-01/ServiceSoftwareOptions">AWS
   * API Reference</a></p>
   */
  class AWS_OPENSEARCHSERVICE_API ServiceSoftwareOptions
  {
  public:
    ...
    /**
     * <p> <code>True</code> if you're able to update your service software version.
     * <code>False</code> if you can't update your service software version. </p>
     */
    ...
    /**
     * <p> <code>True</code> if you're able to cancel your service software version
