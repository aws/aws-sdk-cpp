...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeOutboundConnectionsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeOutboundConnectionsRequest>(GetServiceRequestName(), *this);
    }
