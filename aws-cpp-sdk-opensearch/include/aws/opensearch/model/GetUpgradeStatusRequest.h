...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_OPENSEARCHSERVICE_API GetUpgradeStatusRequest : public OpenSearchServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetUpgradeStatusRequest> Clone() const
    {
      return Aws::MakeUnique<GetUpgradeStatusRequest>(GetServiceRequestName(), *this);
    }
