...
namespace Model
{
  ...
  /**
   */
  class AWS_OPENSEARCHSERVICE_API RevokeVpcEndpointAccessRequest : public OpenSearchServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<RevokeVpcEndpointAccessRequest> Clone() const
    {
      return Aws::MakeUnique<RevokeVpcEndpointAccessRequest>(GetServiceRequestName(), *this);
    }
