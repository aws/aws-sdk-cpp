...
namespace Model
{
  ...
  /**
   */
  class AWS_OPENSEARCHSERVICE_API ListVpcEndpointAccessRequest : public OpenSearchServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListVpcEndpointAccessRequest> Clone() const
    {
      return Aws::MakeUnique<ListVpcEndpointAccessRequest>(GetServiceRequestName(), *this);
    }
     ...
     * subsequent <code>ListVpcEndpointAccess</code> operations, which returns results
     * in the next page.</p>
     */
