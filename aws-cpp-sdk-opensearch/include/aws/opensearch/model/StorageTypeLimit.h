...
namespace Model
{
  ...
  /**
   * <p>Limits that are applicable for the given storage type. </p><p><h3>See
   * Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/opensearch-2021-01-01/StorageTypeLimit">AWS
   * API Reference</a></p>
   */
  class AWS_OPENSEARCHSERVICE_API StorageTypeLimit
  {
  public:
    StorageTypeLimit();
     ...
     * <code> <a>StorageType</a> </code> is "ebs", the following storage options are
     * applicable: <ol> <li>MinimumVolumeSize</li> Minimum amount of volume size that
     * is applicable for the given storage type. Can be empty if not applicable.
     * <li>MaximumVolumeSize</li> Maximum amount of volume size that is applicable for
     * the given storage type. Can be empty if not applicable. <li>MaximumIops</li>
     * Maximum amount of Iops that is applicable for given the storage type. Can be
     * empty if not applicable. <li>MinimumIops</li> Minimum amount of Iops that is
     * applicable for given the storage type. Can be empty if not applicable. </ol>
     * </p>
     */
