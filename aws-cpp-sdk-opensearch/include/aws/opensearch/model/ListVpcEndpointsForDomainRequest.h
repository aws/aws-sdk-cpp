...
namespace Model
{
  ...
  /**
   */
  class AWS_OPENSEARCHSERVICE_API ListVpcEndpointsForDomainRequest : public OpenSearchServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListVpcEndpointsForDomainRequest> Clone() const
    {
      return Aws::MakeUnique<ListVpcEndpointsForDomainRequest>(GetServiceRequestName(), *this);
    }
