...
namespace Model
{
  ...
  /**
   * <p> Container for the request parameters to the <code> <a>GetUpgradeHistory</a>
   ...
   * API Reference</a></p>
   */
  class AWS_OPENSEARCHSERVICE_API GetUpgradeHistoryRequest : public OpenSearchServiceRequest
  {
  public:
