...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeReservedInstanceOfferingsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeReservedInstanceOfferingsRequest>(GetServiceRequestName(), *this);
    }
