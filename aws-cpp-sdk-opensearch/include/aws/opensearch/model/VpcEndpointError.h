...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_OPENSEARCHSERVICE_API VpcEndpointError
  {
  public:
    VpcEndpointError();
    VpcEndpointError(Aws::Utils::Json::JsonView jsonValue);
    VpcEndpointError& operator=(Aws::Utils::Json::JsonView jsonValue);
