...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_OPENSEARCHSERVICE_API ListDomainsForPackageRequest : public OpenSearchServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListDomainsForPackageRequest> Clone() const
    {
      return Aws::MakeUnique<ListDomainsForPackageRequest>(GetServiceRequestName(), *this);
    }
