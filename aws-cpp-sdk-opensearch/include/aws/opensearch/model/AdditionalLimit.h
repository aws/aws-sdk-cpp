...
namespace Model
{
  ...
  /**
   * <p> List of limits that are specific to a given InstanceType and for each of its
   * <code> <a>InstanceRole</a> </code> . </p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/opensearch-2021-01-01/AdditionalLimit">AWS
   * API Reference</a></p>
   */
  class AWS_OPENSEARCHSERVICE_API AdditionalLimit
  {
  public:
    AdditionalLimit();
    ...
    /**
     * <p> Additional limit is specific to a given InstanceType and for each of its
     * <code> <a>InstanceRole</a> </code> etc. <br/> Attributes and their details:
     * <br/> <ul> <li>MaximumNumberOfDataNodesSupported</li> This attribute is present
     * on the master node only to specify how much data nodes up to which given <code>
     * <a>ESPartitionInstanceType</a> </code> can support as master node.
     * <li>MaximumNumberOfDataNodesWithoutMasterNode</li> This attribute is present on
     * data node only to specify how much data nodes of given <code>
    ...
    /**
     * <p> Value for a given <code> <a>AdditionalLimit$LimitName</a> </code> . </p>
     */
