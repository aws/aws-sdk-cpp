...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_OPENSEARCHSERVICE_API AcceptInboundConnectionRequest : public OpenSearchServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AcceptInboundConnectionRequest> Clone() const
    {
      return Aws::MakeUnique<AcceptInboundConnectionRequest>(GetServiceRequestName(), *this);
    }
