...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_OPENSEARCHSERVICE_API DescribeDomainChangeProgressRequest : public OpenSearchServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeDomainChangeProgressRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeDomainChangeProgressRequest>(GetServiceRequestName(), *this);
    }
