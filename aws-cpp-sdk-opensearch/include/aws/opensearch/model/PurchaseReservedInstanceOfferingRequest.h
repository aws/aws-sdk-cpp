...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PurchaseReservedInstanceOfferingRequest> Clone() const
    {
      return Aws::MakeUnique<PurchaseReservedInstanceOfferingRequest>(GetServiceRequestName(), *this);
    }
