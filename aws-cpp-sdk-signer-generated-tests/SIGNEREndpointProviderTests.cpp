...
using SignerResolveEndpointOutcome = Aws::signer::Endpoint::SignerEndpointProvider::SignerResolveEndpointOutcome;
...
void ValidateOutcome(const SignerResolveEndpointOutcome& outcome, const SignerEndpointProviderEndpointTestCase::Expect& expect)
{
