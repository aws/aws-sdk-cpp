...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListAvailableResourceMetricsRequest> Clone() const
    {
      return Aws::MakeUnique<ListAvailableResourceMetricsRequest>(GetServiceRequestName(), *this);
    }
