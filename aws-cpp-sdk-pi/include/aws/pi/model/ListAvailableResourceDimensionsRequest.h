...
namespace Model
{
  ...
  /**
   */
  class AWS_PI_API ListAvailableResourceDimensionsRequest : public PIRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListAvailableResourceDimensionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListAvailableResourceDimensionsRequest>(GetServiceRequestName(), *this);
    }
