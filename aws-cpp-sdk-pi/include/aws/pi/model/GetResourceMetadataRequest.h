...
namespace Model
{
  ...
  /**
   */
  class AWS_PI_API GetResourceMetadataRequest : public PIRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetResourceMetadataRequest> Clone() const
    {
      return Aws::MakeUnique<GetResourceMetadataRequest>(GetServiceRequestName(), *this);
    }
