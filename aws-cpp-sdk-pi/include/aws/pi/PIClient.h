...
namespace PI
{
  ...
  class AWS_PI_API PIClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        PIClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                 std::shared_ptr<Endpoint::PIEndpointProvider> endpointProvider = Aws::MakeShared<PI::Endpoint::PIEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::PIEndpointProvider> m_endpointProvider;
  };
