...
Aws::String PIEndpointRules::GetRulesAsString()
{
    return Aws::String(PIEndpointRules::Rules.begin(), PIEndpointRules::Rules.end());
}

const Aws::Vector<char> PIEndpointRules::Rules = {
