...
Aws::String SagemakerEdgeManagerEndpointRules::GetRulesAsString()
{
    return Aws::String(SagemakerEdgeManagerEndpointRules::Rules.begin(), SagemakerEdgeManagerEndpointRules::Rules.end());
}

const Aws::Vector<char> SagemakerEdgeManagerEndpointRules::Rules = {
