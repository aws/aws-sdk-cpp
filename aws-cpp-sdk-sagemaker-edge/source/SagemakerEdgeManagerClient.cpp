...
using ResolveEndpointOutcome = Aws::SagemakerEdgeManager::Endpoint::SagemakerEdgeManagerEndpointProvider::SagemakerEdgeManagerResolveEndpointOutcome;
...
SagemakerEdgeManagerClient::SagemakerEdgeManagerClient(const Client::ClientConfiguration& clientConfiguration,
                                                       std::shared_ptr<Endpoint::SagemakerEdgeManagerEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<SagemakerEdgeManagerErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<SagemakerEdgeManager::Endpoint::SagemakerEdgeManagerEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
