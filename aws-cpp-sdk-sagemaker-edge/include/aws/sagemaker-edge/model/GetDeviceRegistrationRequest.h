...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKEREDGEMANAGER_API GetDeviceRegistrationRequest : public SagemakerEdgeManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetDeviceRegistrationRequest> Clone() const
    {
      return Aws::MakeUnique<GetDeviceRegistrationRequest>(GetServiceRequestName(), *this);
    }
     ...
     * <p>The name of the fleet that the device belongs to.</p>
     */
    inline GetDeviceRegistrationRequest& WithDeviceFleetName(const char* value) { SetDeviceFleetName(value); return *this;}
