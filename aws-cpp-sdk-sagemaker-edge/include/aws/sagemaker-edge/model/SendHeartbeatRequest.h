...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKEREDGEMANAGER_API SendHeartbeatRequest : public SagemakerEdgeManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<SendHeartbeatRequest> Clone() const
    {
      return Aws::MakeUnique<SendHeartbeatRequest>(GetServiceRequestName(), *this);
    }
