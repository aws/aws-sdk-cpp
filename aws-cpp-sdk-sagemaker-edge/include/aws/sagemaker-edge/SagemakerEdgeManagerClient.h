...
namespace SagemakerEdgeManager
{
  ...
  class AWS_SAGEMAKEREDGEMANAGER_API SagemakerEdgeManagerClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        SagemakerEdgeManagerClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                   std::shared_ptr<Endpoint::SagemakerEdgeManagerEndpointProvider> endpointProvider = Aws::MakeShared<SagemakerEdgeManager::Endpoint::SagemakerEdgeManagerEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::SagemakerEdgeManagerEndpointProvider> m_endpointProvider;
  };
