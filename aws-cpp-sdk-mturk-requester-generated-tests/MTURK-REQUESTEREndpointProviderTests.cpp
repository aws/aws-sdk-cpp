...
using MTurkResolveEndpointOutcome = Aws::MTurk::Endpoint::MTurkEndpointProvider::MTurkResolveEndpointOutcome;
...
void ValidateOutcome(const MTurkResolveEndpointOutcome& outcome, const MTurkEndpointProviderEndpointTestCase::Expect& expect)
{
