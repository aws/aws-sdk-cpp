...
namespace ResourceGroups
{
  ...
  class AWS_RESOURCEGROUPS_API ResourceGroupsClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        ResourceGroupsClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                             std::shared_ptr<Endpoint::ResourceGroupsEndpointProvider> endpointProvider = Aws::MakeShared<ResourceGroups::Endpoint::ResourceGroupsEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::ResourceGroupsEndpointProvider> m_endpointProvider;
  };
