...
namespace Model
{
  ...
  /**
   */
  class AWS_RESOURCEGROUPS_API GetGroupConfigurationRequest : public ResourceGroupsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetGroupConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<GetGroupConfigurationRequest>(GetServiceRequestName(), *this);
    }
