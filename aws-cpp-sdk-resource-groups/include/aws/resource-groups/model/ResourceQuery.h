...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>The type of the query. The valid values in this release are the
     * following:</p> <ul> <li> <p> <i> <code>TAG_FILTERS_1_0:</code> </i> A JSON
     * syntax that lets you specify a collection of simple tag filters for resource
     * types and tags, as supported by the AWS Tagging API <a
     ...
     * not return the following results, however. The following EC2 instance does not
     * have all tag keys specified in the filter, so it is rejected. The RDS database
     * has all of the tag keys, but no values that match at least one of the specified
     * tag key values in the filter.</p> <ul> <li> <p>An EC2 instance that has only the
     * following tag: <code>{"Key":"Stage","Value":"Deploy"}</code>.</p> </li> <li>
     * <p>An RDS database that has the following two tags:
     * <code>{"Key":"Stage","Value":"Archived"}</code>, and
     * <code>{"Key":"Version","Value":"4"}</code> </p> </li> </ul> </li> <li> <p> <i>
     * <code>CLOUDFORMATION_STACK_1_0:</code> </i> A JSON syntax that lets you specify
     * a CloudFormation stack ARN.</p> </li> </ul>
     */
