...
using ResolveEndpointOutcome = Aws::ResourceGroups::Endpoint::ResourceGroupsEndpointProvider::ResourceGroupsResolveEndpointOutcome;
...
ResourceGroupsClient::ResourceGroupsClient(const Client::ClientConfiguration& clientConfiguration,
                                           std::shared_ptr<Endpoint::ResourceGroupsEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<ResourceGroupsErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<ResourceGroups::Endpoint::ResourceGroupsEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
