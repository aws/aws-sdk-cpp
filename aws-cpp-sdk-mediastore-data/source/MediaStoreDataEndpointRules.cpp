...
Aws::String MediaStoreDataEndpointRules::GetRulesAsString()
{
    return Aws::String(MediaStoreDataEndpointRules::Rules.begin(), MediaStoreDataEndpointRules::Rules.end());
}

const Aws::Vector<char> MediaStoreDataEndpointRules::Rules = {
...
'"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','d','a','t','a','.','m','e',
'd','i','a','s','t','o','r','e','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P',
...
'h','t','t','p','s',':','/','/','d','a','t','a','.','m','e','d','i','a','s','t','o','r','e','-','f',
...
'r','l','"',':','"','h','t','t','p','s',':','/','/','d','a','t','a','.','m','e','d','i','a','s','t',
'o','r','e','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R','e',
