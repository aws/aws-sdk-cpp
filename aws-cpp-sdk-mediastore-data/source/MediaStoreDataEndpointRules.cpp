...
{
const size_t MediaStoreDataEndpointRules::RulesBlobStrLen = 3490;
const size_t MediaStoreDataEndpointRules::RulesBlobSize = 3491;

using RulesBlobT = Aws::Array<const char, MediaStoreDataEndpointRules::RulesBlobSize>;
...
't','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','d','a','t','a','.','m',
'e','d','i','a','s','t','o','r','e','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{',
...
'"','h','t','t','p','s',':','/','/','d','a','t','a','.','m','e','d','i','a','s','t','o','r','e','-',
...
'u','r','l','"',':','"','h','t','t','p','s',':','/','/','d','a','t','a','.','m','e','d','i','a','s',
't','o','r','e','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R',
...
const char* MediaStoreDataEndpointRules::GetRulesBlob()
{
