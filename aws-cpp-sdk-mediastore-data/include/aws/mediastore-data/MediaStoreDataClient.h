...
namespace MediaStoreData
{
  ...
  class AWS_MEDIASTOREDATA_API MediaStoreDataClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        MediaStoreDataClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                             std::shared_ptr<Endpoint::MediaStoreDataEndpointProvider> endpointProvider = Aws::MakeShared<MediaStoreData::Endpoint::MediaStoreDataEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::MediaStoreDataEndpointProvider> m_endpointProvider;
  };
