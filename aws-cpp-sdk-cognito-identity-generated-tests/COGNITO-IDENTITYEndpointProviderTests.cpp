...
static const char* ALLOCATION_TAG = "AWSCognitoIdentityEndpointProviderTests";
using CognitoIdentityEndpointProvider = Aws::CognitoIdentity::Endpoint::CognitoIdentityEndpointProvider;
using EndpointParameters = Aws::Vector<Aws::Endpoint::EndpointParameter>;
using CognitoIdentityResolveEndpointOutcome = Aws::CognitoIdentity::Endpoint::CognitoIdentityEndpointProvider::CognitoIdentityResolveEndpointOutcome;
...
class CognitoIdentityEndpointProviderTests :public ::testing::TestWithParam<size_t>
{
public:
...
struct CognitoIdentityEndpointProviderEndpointTestCase
{
...
static const Aws::Vector<CognitoIdentityEndpointProviderEndpointTestCase> TEST_CASES = {
  /*TEST CASE 0*/
  {"For region ap-south-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity-fips.ap-south-1.api.aws",
       {/*properties*/},
  ...
  {"For region ap-south-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity-fips.ap-south-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-south-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity.ap-south-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-south-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity.ap-south-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ca-central-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity-fips.ca-central-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ca-central-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity-fips.ca-central-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ca-central-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity.ca-central-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ca-central-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity.ca-central-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-central-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity-fips.eu-central-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-central-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity-fips.eu-central-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-central-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity.eu-central-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-central-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity.eu-central-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-west-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity-fips.us-west-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-west-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity-fips.us-west-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-west-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity.us-west-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-west-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity.us-west-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-west-2 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity-fips.us-west-2.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-west-2 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity-fips.us-west-2.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-west-2 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity.us-west-2.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-west-2 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity.us-west-2.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-north-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity-fips.eu-north-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-north-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity-fips.eu-north-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-north-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity.eu-north-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-north-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity.eu-north-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-west-3 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity-fips.eu-west-3.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-west-3 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity-fips.eu-west-3.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-west-3 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity.eu-west-3.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-west-3 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity.eu-west-3.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-west-2 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity-fips.eu-west-2.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-west-2 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity-fips.eu-west-2.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-west-2 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity.eu-west-2.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-west-2 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity.eu-west-2.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-west-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity-fips.eu-west-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-west-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity-fips.eu-west-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-west-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity.eu-west-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region eu-west-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity.eu-west-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-northeast-2 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity-fips.ap-northeast-2.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-northeast-2 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity-fips.ap-northeast-2.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-northeast-2 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity.ap-northeast-2.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-northeast-2 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity.ap-northeast-2.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-northeast-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity-fips.ap-northeast-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-northeast-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity-fips.ap-northeast-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-northeast-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity.ap-northeast-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-northeast-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity.ap-northeast-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region me-south-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity-fips.me-south-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region me-south-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity-fips.me-south-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region me-south-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity.me-south-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region me-south-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity.me-south-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region sa-east-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity-fips.sa-east-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region sa-east-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity-fips.sa-east-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region sa-east-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity.sa-east-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region sa-east-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity.sa-east-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region cn-north-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity-fips.cn-north-1.api.amazonwebservices.com.cn",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region cn-north-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity-fips.cn-north-1.amazonaws.com.cn",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region cn-north-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity.cn-north-1.api.amazonwebservices.com.cn",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region cn-north-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity.cn-north-1.amazonaws.com.cn",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-gov-west-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity-fips.us-gov-west-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-gov-west-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity-fips.us-gov-west-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-gov-west-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity.us-gov-west-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-gov-west-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity.us-gov-west-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-southeast-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity-fips.ap-southeast-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-southeast-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity-fips.ap-southeast-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-southeast-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity.ap-southeast-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-southeast-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity.ap-southeast-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-southeast-2 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity-fips.ap-southeast-2.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-southeast-2 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity-fips.ap-southeast-2.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-southeast-2 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity.ap-southeast-2.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region ap-southeast-2 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity.ap-southeast-2.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-east-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity-fips.us-east-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-east-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity-fips.us-east-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-east-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity.us-east-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-east-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity.us-east-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-east-2 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity-fips.us-east-2.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-east-2 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity-fips.us-east-2.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-east-2 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity.us-east-2.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-east-2 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://cognito-identity.us-east-2.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
...
void ValidateOutcome(const CognitoIdentityResolveEndpointOutcome& outcome, const CognitoIdentityEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(CognitoIdentityEndpointProviderTests, EndpointProviderTest)
{
    ...
    const CognitoIdentityEndpointProviderEndpointTestCase& TEST_CASE = TEST_CASES.at(TEST_CASE_IDX);
    SCOPED_TRACE(Aws::String("\nTEST CASE # ") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX) + ": " + TEST_CASE.documentation);

    std::shared_ptr<CognitoIdentityEndpointProvider> endpointProvider = Aws::MakeShared<CognitoIdentityEndpointProvider>(ALLOCATION_TAG);
    ASSERT_TRUE(endpointProvider) << "Failed to allocate/initialize CognitoIdentityEndpointProvider";
    ...
    for(const auto& operation : TEST_CASE.operationInput)
    {
         ...
         */
        const Aws::Vector<std::reference_wrapper<const CognitoIdentityEndpointProviderEndpointTestCase::OperationParamsFromTest>>
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         CognitoIdentityEndpointProviderTests,
