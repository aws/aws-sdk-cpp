...
{
  AWS_MAKE_CALLABLE_OPERATION(AssociateRepository, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(AssociateRepository, request, handler, context, m_executor.get());
}
...
{
  AWS_MAKE_CALLABLE_OPERATION(CreateCodeReview, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(CreateCodeReview, request, handler, context, m_executor.get());
}
...
{
  AWS_MAKE_CALLABLE_OPERATION(DescribeCodeReview, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(DescribeCodeReview, request, handler, context, m_executor.get());
}
...
{
  AWS_MAKE_CALLABLE_OPERATION(DescribeRecommendationFeedback, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(DescribeRecommendationFeedback, request, handler, context, m_executor.get());
}
...
{
  AWS_MAKE_CALLABLE_OPERATION(DescribeRepositoryAssociation, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(DescribeRepositoryAssociation, request, handler, context, m_executor.get());
}
...
{
  AWS_MAKE_CALLABLE_OPERATION(DisassociateRepository, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(DisassociateRepository, request, handler, context, m_executor.get());
}
...
{
  AWS_MAKE_CALLABLE_OPERATION(ListCodeReviews, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(ListCodeReviews, request, handler, context, m_executor.get());
}
...
{
  AWS_MAKE_CALLABLE_OPERATION(ListRecommendationFeedback, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(ListRecommendationFeedback, request, handler, context, m_executor.get());
}
...
{
  AWS_MAKE_CALLABLE_OPERATION(ListRepositoryAssociations, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(ListRepositoryAssociations, request, handler, context, m_executor.get());
}
...
{
  AWS_MAKE_CALLABLE_OPERATION(PutRecommendationFeedback, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(PutRecommendationFeedback, request, handler, context, m_executor.get());
}
