...
using ResolveEndpointOutcome = Aws::CodeGuruReviewer::Endpoint::CodeGuruReviewerEndpointProvider::CodeGuruReviewerResolveEndpointOutcome;
...
CodeGuruReviewerClient::CodeGuruReviewerClient(const Client::ClientConfiguration& clientConfiguration,
                                               std::shared_ptr<Endpoint::CodeGuruReviewerEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<CodeGuruReviewerErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<CodeGuruReviewer::Endpoint::CodeGuruReviewerEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
