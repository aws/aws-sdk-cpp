...
namespace Model
{
  ...
  /**
   */
  class AWS_CODEGURUREVIEWER_API CreateCodeReviewRequest : public CodeGuruReviewerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateCodeReviewRequest> Clone() const
    {
      return Aws::MakeUnique<CreateCodeReviewRequest>(GetServiceRequestName(), *this);
    }
