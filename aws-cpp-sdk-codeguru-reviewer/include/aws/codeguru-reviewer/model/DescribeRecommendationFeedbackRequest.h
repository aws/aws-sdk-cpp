...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeRecommendationFeedbackRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeRecommendationFeedbackRequest>(GetServiceRequestName(), *this);
    }
