...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeRepositoryAssociationRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeRepositoryAssociationRequest>(GetServiceRequestName(), *this);
    }
