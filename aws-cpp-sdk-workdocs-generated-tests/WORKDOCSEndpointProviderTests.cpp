...
using WorkDocsResolveEndpointOutcome = Aws::WorkDocs::Endpoint::WorkDocsEndpointProvider::WorkDocsResolveEndpointOutcome;
...
void ValidateOutcome(const WorkDocsResolveEndpointOutcome& outcome, const WorkDocsEndpointProviderEndpointTestCase::Expect& expect)
{
