...
static const char* ALLOCATION_TAG = "AWSGlobalAcceleratorEndpointProviderTests";
using GlobalAcceleratorEndpointProvider = Aws::GlobalAccelerator::Endpoint::GlobalAcceleratorEndpointProvider;
using EndpointParameters = Aws::Vector<Aws::Endpoint::EndpointParameter>;
using GlobalAcceleratorResolveEndpointOutcome = Aws::GlobalAccelerator::Endpoint::GlobalAcceleratorEndpointProvider::GlobalAcceleratorResolveEndpointOutcome;
...
class GlobalAcceleratorEndpointProviderTests :public ::testing::TestWithParam<size_t>
{
public:
...
struct GlobalAcceleratorEndpointProviderEndpointTestCase
{
...
static const Aws::Vector<GlobalAcceleratorEndpointProviderEndpointTestCase> TEST_CASES = {
  /*TEST CASE 0*/
...
void ValidateOutcome(const GlobalAcceleratorResolveEndpointOutcome& outcome, const GlobalAcceleratorEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(GlobalAcceleratorEndpointProviderTests, EndpointProviderTest)
{
    ...
    const GlobalAcceleratorEndpointProviderEndpointTestCase& TEST_CASE = TEST_CASES.at(TEST_CASE_IDX);
    SCOPED_TRACE(Aws::String("\nTEST CASE # ") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX) + ": " + TEST_CASE.documentation);

    std::shared_ptr<GlobalAcceleratorEndpointProvider> endpointProvider = Aws::MakeShared<GlobalAcceleratorEndpointProvider>(ALLOCATION_TAG);
    ASSERT_TRUE(endpointProvider) << "Failed to allocate/initialize GlobalAcceleratorEndpointProvider";
    ...
    for(const auto& operation : TEST_CASE.operationInput)
    {
         ...
         */
        const Aws::Vector<std::reference_wrapper<const GlobalAcceleratorEndpointProviderEndpointTestCase::OperationParamsFromTest>>
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         GlobalAcceleratorEndpointProviderTests,
