...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SSM_API RegistrationMetadataItem
  {
  public:
    RegistrationMetadataItem();
    RegistrationMetadataItem(Aws::Utils::Json::JsonView jsonValue);
    RegistrationMetadataItem& operator=(Aws::Utils::Json::JsonView jsonValue);
