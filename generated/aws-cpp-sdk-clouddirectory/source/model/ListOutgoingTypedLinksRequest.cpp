...
Aws::String ListOutgoingTypedLinksRequest::SerializePayload() const
{
  JsonValue payload;
...
Aws::Http::HeaderValueCollection ListOutgoingTypedLinksRequest::GetRequestSpecificHeaders() const
{
