...
namespace Model
{
  ...
  public:
    ...
    inline ModifyReplicationGroupShardConfigurationResult& WithReplicationGroup(const ReplicationGroup& value) { SetReplicationGroup(value); return *this;}

    
    inline ModifyReplicationGroupShardConfigurationResult& WithReplicationGroup(ReplicationGroup&& value) { SetReplicationGroup(std::move(value)); return *this;}
    ...
    inline ModifyReplicationGroupShardConfigurationResult& WithResponseMetadata(const ResponseMetadata& value) { SetResponseMetadata(value); return *this;}

    
    inline ModifyReplicationGroupShardConfigurationResult& WithResponseMetadata(ResponseMetadata&& value) { SetResponseMetadata(std::move(value)); return *this;}
