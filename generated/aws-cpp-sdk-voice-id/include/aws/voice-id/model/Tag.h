...
namespace Model
{
  ...
  /**
   * <p>A tag that can be assigned to a Voice ID resource.</p><p><h3>See Also:</h3>  
   * <a href="http://docs.aws.amazon.com/goto/WebAPI/voice-id-2021-09-27/Tag">AWS API
   * Reference</a></p>
   */
  class AWS_VOICEID_API Tag
  {
  public:
    Tag();
