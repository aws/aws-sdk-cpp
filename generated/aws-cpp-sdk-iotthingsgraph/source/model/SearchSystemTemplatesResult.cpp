...
SearchSystemTemplatesResult::SearchSystemTemplatesResult()
{
}

SearchSystemTemplatesResult::SearchSystemTemplatesResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

SearchSystemTemplatesResult& SearchSystemTemplatesResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
