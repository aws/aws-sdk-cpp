...
DisableDelegatedAdminAccountResult::DisableDelegatedAdminAccountResult()
{
}

DisableDelegatedAdminAccountResult::DisableDelegatedAdminAccountResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
