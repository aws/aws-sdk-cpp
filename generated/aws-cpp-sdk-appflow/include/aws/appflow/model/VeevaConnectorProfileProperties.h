...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_APPFLOW_API VeevaConnectorProfileProperties
  {
  public:
    VeevaConnectorProfileProperties();
    VeevaConnectorProfileProperties(Aws::Utils::Json::JsonView jsonValue);
    VeevaConnectorProfileProperties& operator=(Aws::Utils::Json::JsonView jsonValue);
