...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_GUARDDUTY_API KubernetesApiCallAction
  {
  public:
    KubernetesApiCallAction();
    KubernetesApiCallAction(Aws::Utils::Json::JsonView jsonValue);
    KubernetesApiCallAction& operator=(Aws::Utils::Json::JsonView jsonValue);
