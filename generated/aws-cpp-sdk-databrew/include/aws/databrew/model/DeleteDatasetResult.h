...
namespace Model
{
  ...
  public:
     ...
     * <p>The name of the dataset that you deleted.</p>
     */
    inline DeleteDatasetResult& WithName(const Aws::String& value) { SetName(value); return *this;}

    /**
     * <p>The name of the dataset that you deleted.</p>
     */
    inline DeleteDatasetResult& WithName(Aws::String&& value) { SetName(std::move(value)); return *this;}

    /**
     * <p>The name of the dataset that you deleted.</p>
     */
    inline DeleteDatasetResult& WithName(const char* value) { SetName(value); return *this;}
