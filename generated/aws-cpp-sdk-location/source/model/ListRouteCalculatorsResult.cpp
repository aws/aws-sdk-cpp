...
ListRouteCalculatorsResult::ListRouteCalculatorsResult()
{
}

ListRouteCalculatorsResult::ListRouteCalculatorsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
