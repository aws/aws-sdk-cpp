...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SECURITYHUB_API AwsRdsDbSubnetGroupSubnet
  {
  public:
    AwsRdsDbSubnetGroupSubnet();
    AwsRdsDbSubnetGroupSubnet(Aws::Utils::Json::JsonView jsonValue);
    AwsRdsDbSubnetGroupSubnet& operator=(Aws::Utils::Json::JsonView jsonValue);
