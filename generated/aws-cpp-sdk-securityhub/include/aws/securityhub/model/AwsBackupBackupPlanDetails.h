...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SECURITYHUB_API AwsBackupBackupPlanDetails
  {
  public:
    AwsBackupBackupPlanDetails();
    AwsBackupBackupPlanDetails(Aws::Utils::Json::JsonView jsonValue);
    AwsBackupBackupPlanDetails& operator=(Aws::Utils::Json::JsonView jsonValue);
