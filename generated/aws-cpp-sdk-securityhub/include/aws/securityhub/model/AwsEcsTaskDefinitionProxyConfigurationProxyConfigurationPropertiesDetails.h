...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SECURITYHUB_API AwsEcsTaskDefinitionProxyConfigurationProxyConfigurationPropertiesDetails
  {
  public:
    AwsEcsTaskDefinitionProxyConfigurationProxyConfigurationPropertiesDetails();
    AwsEcsTaskDefinitionProxyConfigurationProxyConfigurationPropertiesDetails(Aws::Utils::Json::JsonView jsonValue);
    AwsEcsTaskDefinitionProxyConfigurationProxyConfigurationPropertiesDetails& operator=(Aws::Utils::Json::JsonView jsonValue);
