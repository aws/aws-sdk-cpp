...
namespace Model
{
   ...
   * <code>UpdateFindings</code> - <code>RateLimit</code> of 1 request per second.
   * <code>BurstLimit</code> of 5 requests per second.</p> </li> <li> <p>
    ...
    public:
      typedef Aws::Client::AWSJsonClient BASECLASS;
        ...
        */
         ...
         * the following:</p> <ul> <li> <p>The account that is associated with the
         * findings. The identifier of the associated account is the value of the
         * <code>AwsAccountId</code> attribute for the finding.</p> </li> <li> <p>An
         * account that is allow-listed for an official Security Hub partner
         * integration.</p> </li> </ul> <p>The maximum allowed size for a finding is 240
         * Kb. An error is returned for any finding larger than 240 Kb.</p> <p>After a
