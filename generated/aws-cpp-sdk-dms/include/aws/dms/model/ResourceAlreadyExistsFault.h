...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_DATABASEMIGRATIONSERVICE_API ResourceAlreadyExistsFault
  {
  public:
    ResourceAlreadyExistsFault();
    ResourceAlreadyExistsFault(Aws::Utils::Json::JsonView jsonValue);
    ResourceAlreadyExistsFault& operator=(Aws::Utils::Json::JsonView jsonValue);
