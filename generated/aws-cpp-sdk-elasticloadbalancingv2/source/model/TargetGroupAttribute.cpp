...
TargetGroupAttribute& TargetGroupAttribute::operator =(const XmlNode& xmlNode)
{
...
void TargetGroupAttribute::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const
{
  if(m_keyHasBeenSet)
  {
...
void TargetGroupAttribute::OutputToStream(Aws::OStream& oStream, const char* location) const
{
  if(m_keyHasBeenSet)
  {
