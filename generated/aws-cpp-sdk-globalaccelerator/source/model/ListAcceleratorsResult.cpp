...
ListAcceleratorsResult::ListAcceleratorsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListAcceleratorsResult& ListAcceleratorsResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
