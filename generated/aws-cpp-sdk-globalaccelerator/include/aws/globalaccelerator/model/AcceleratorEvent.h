...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_GLOBALACCELERATOR_API AcceleratorEvent
  {
  public:
    AcceleratorEvent();
    AcceleratorEvent(Aws::Utils::Json::JsonView jsonValue);
    AcceleratorEvent& operator=(Aws::Utils::Json::JsonView jsonValue);
