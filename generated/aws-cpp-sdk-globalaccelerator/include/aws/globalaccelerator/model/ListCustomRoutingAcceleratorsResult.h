...
namespace Model
{
  class AWS_GLOBALACCELERATOR_API ListCustomRoutingAcceleratorsResult
  {
  public:
    ListCustomRoutingAcceleratorsResult();
    ListCustomRoutingAcceleratorsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ListCustomRoutingAcceleratorsResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
