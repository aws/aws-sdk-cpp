...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_APPSYNC_API DomainNameConfig
  {
  public:
    DomainNameConfig();
    DomainNameConfig(Aws::Utils::Json::JsonView jsonValue);
    DomainNameConfig& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  private:
    ...
    bool m_appsyncDomainNameHasBeenSet;
