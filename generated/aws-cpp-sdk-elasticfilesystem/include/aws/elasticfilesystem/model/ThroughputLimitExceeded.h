...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EFS_API ThroughputLimitExceeded
  {
  public:
    ThroughputLimitExceeded();
    ThroughputLimitExceeded(Aws::Utils::Json::JsonView jsonValue);
    ThroughputLimitExceeded& operator=(Aws::Utils::Json::JsonView jsonValue);
