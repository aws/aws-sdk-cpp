...
namespace Model
{
  ...
  /**
   * <p>Provides information about your Amazon Web Services account.</p><p><h3>See
   * Also:</h3>   <a
  ...
  public:
    ...
    /**
     * <p>The identifier of the Amazon Web Services account that is assigned to the
     * user.</p>
     */
    ...
    /**
     * <p>The display name of the Amazon Web Services account that is assigned to the
     * user.</p>
     */
    ...
    /**
     * <p>The email address of the Amazon Web Services account that is assigned to the
     * user.</p>
     */
