...
DisassociateConnectPeerResult::DisassociateConnectPeerResult()
{
}

DisassociateConnectPeerResult::DisassociateConnectPeerResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
