...
Aws::String ExportLambdaFunctionRecommendationsRequest::SerializePayload() const
{
  JsonValue payload;
  ...
  if(m_fieldsToExportHasBeenSet)
  {
   ...
   {
     fieldsToExportJsonList[fieldsToExportIndex].AsString(ExportableLambdaFunctionFieldMapper::GetNameForExportableLambdaFunctionField(m_fieldsToExport[fieldsToExportIndex]));
   }
...
Aws::Http::HeaderValueCollection ExportLambdaFunctionRecommendationsRequest::GetRequestSpecificHeaders() const
{
  Aws::Http::HeaderValueCollection headers;
  headers.insert(Aws::Http::HeaderValuePair("X-Amz-Target", "ComputeOptimizerService.ExportLambdaFunctionRecommendations"));
  return headers;
