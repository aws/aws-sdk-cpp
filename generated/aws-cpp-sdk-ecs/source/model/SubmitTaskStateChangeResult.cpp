...
SubmitTaskStateChangeResult::SubmitTaskStateChangeResult()
{
}

SubmitTaskStateChangeResult::SubmitTaskStateChangeResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
