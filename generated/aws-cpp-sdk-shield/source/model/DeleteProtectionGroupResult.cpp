...
DeleteProtectionGroupResult::DeleteProtectionGroupResult()
{
}

DeleteProtectionGroupResult::DeleteProtectionGroupResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
