...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_KINESISANALYTICSV2_API ApplicationMaintenanceConfigurationUpdate
  {
  public:
    ApplicationMaintenanceConfigurationUpdate();
    ApplicationMaintenanceConfigurationUpdate(Aws::Utils::Json::JsonView jsonValue);
    ApplicationMaintenanceConfigurationUpdate& operator=(Aws::Utils::Json::JsonView jsonValue);
