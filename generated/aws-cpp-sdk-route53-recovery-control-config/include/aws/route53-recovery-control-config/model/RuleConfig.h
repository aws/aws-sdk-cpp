...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_ROUTE53RECOVERYCONTROLCONFIG_API RuleConfig
  {
  public:
    RuleConfig();
    RuleConfig(Aws::Utils::Json::JsonView jsonValue);
    RuleConfig& operator=(Aws::Utils::Json::JsonView jsonValue);
