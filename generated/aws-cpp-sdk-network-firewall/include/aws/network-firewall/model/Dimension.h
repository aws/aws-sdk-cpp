...
namespace Model
{
   ...
   * </p> <p>AWS Network Firewall sets the dimension name to
   * <code>CustomAction</code> and you provide the dimension value. </p> <p>For more
   * information about CloudWatch custom metric dimensions, see <a
