...
namespace Model
{
  ...
  /**
   */
  class AWS_WAFV2_API PutPermissionPolicyRequest : public WAFV2Request
  {
  public:
     ...
     * <code>wafv2:PutFirewallManagerRuleGroups</code>. WAF rejects any extra actions
     * or wildcard actions in the policy.</p> </li> <li> <p>The policy must not include
     * a <code>Resource</code> parameter.</p> </li> </ul> <p>For more information, see
     * <a
