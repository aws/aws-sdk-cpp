...
namespace Model
{
  ...
  /**
   */
  class AWS_LOOKOUTFORVISION_API ListModelsRequest : public LookoutforVisionRequest
  {
  public:
    ListModelsRequest();
    ...
    /**
     * <p>The name of the project that contains the model versions that you want to
     * list.</p>
     */
     ...
     * You can use this pagination token to retrieve the next set of models.</p>
     */
