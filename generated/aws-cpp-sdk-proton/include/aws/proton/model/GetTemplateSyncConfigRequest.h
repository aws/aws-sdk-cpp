...
namespace Model
{
  ...
  /**
   */
  class AWS_PROTON_API GetTemplateSyncConfigRequest : public ProtonRequest
  {
  public:
    ...
    inline virtual const char* GetServiceRequestName() const override { return "GetTemplateSyncConfig"; }
