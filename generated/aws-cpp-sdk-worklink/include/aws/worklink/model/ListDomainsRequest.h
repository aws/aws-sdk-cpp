...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKLINK_API ListDomainsRequest : public WorkLinkRequest
  {
  public:
    ListDomainsRequest();
     ...
     * <p>The ARN of the fleet.</p>
     */
    inline ListDomainsRequest& WithFleetArn(const Aws::String& value) { SetFleetArn(value); return *this;}

    /**
     * <p>The ARN of the fleet.</p>
     */
    inline ListDomainsRequest& WithFleetArn(Aws::String&& value) { SetFleetArn(std::move(value)); return *this;}

    /**
     * <p>The ARN of the fleet.</p>
     */
    inline ListDomainsRequest& WithFleetArn(const char* value) { SetFleetArn(value); return *this;}
