...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_DEVOPSGURU_API LogAnomalyShowcase
  {
  public:
    LogAnomalyShowcase();
    LogAnomalyShowcase(Aws::Utils::Json::JsonView jsonValue);
    LogAnomalyShowcase& operator=(Aws::Utils::Json::JsonView jsonValue);
