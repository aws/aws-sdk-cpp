...
Aws::String DescribeAggregateComplianceByConformancePacksRequest::SerializePayload() const
{
  JsonValue payload;
...
Aws::Http::HeaderValueCollection DescribeAggregateComplianceByConformancePacksRequest::GetRequestSpecificHeaders() const
{
  Aws::Http::HeaderValueCollection headers;
  headers.insert(Aws::Http::HeaderValuePair("X-Amz-Target", "StarlingDoveService.DescribeAggregateComplianceByConformancePacks"));
  return headers;
