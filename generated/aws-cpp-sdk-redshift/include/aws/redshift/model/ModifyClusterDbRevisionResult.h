...
namespace Model
{
  class AWS_REDSHIFT_API ModifyClusterDbRevisionResult
  {
  public:
    ModifyClusterDbRevisionResult();
    ModifyClusterDbRevisionResult(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    ModifyClusterDbRevisionResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
