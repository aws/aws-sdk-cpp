...
namespace Model
{
  class AWS_CLOUDFRONT_API DescribeFunction2020_05_31Result
  {
  public:
    DescribeFunction2020_05_31Result();
    DescribeFunction2020_05_31Result(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    DescribeFunction2020_05_31Result& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
