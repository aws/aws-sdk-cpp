...
namespace Model
{
  class AWS_CLOUDFRONT_API CreateMonitoringSubscription2020_05_31Result
  {
  public:
    CreateMonitoringSubscription2020_05_31Result();
    CreateMonitoringSubscription2020_05_31Result(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    CreateMonitoringSubscription2020_05_31Result& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
