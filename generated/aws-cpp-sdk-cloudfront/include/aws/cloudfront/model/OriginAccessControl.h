...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CLOUDFRONT_API OriginAccessControl
  {
  public:
    OriginAccessControl();
    OriginAccessControl(const Aws::Utils::Xml::XmlNode& xmlNode);
    OriginAccessControl& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
