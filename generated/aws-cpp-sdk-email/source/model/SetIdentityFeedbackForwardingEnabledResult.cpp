...
SetIdentityFeedbackForwardingEnabledResult::SetIdentityFeedbackForwardingEnabledResult()
{
}
...
SetIdentityFeedbackForwardingEnabledResult& SetIdentityFeedbackForwardingEnabledResult::operator =(const Aws::AmazonWebServiceResult<XmlDocument>& result)
{
  ...
  if (!rootNode.IsNull() && (rootNode.GetName() != "SetIdentityFeedbackForwardingEnabledResult"))
  {
