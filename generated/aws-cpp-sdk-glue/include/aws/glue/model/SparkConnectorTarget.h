...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_GLUE_API SparkConnectorTarget
  {
  public:
    SparkConnectorTarget();
    SparkConnectorTarget(Aws::Utils::Json::JsonView jsonValue);
    SparkConnectorTarget& operator=(Aws::Utils::Json::JsonView jsonValue);
