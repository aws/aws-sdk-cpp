...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDWATCHLOGS_API TagLogGroupRequest : public CloudWatchLogsRequest
  {
  public:
    TagLogGroupRequest();
    ...
    inline virtual const char* GetServiceRequestName() const override { return "TagLogGroup"; }
     ...
     * <p>The name of the log group.</p>
     */
    inline TagLogGroupRequest& WithLogGroupName(const Aws::String& value) { SetLogGroupName(value); return *this;}
     ...
     * <p>The name of the log group.</p>
     */
    inline TagLogGroupRequest& WithLogGroupName(const char* value) { SetLogGroupName(value); return *this;}
     ...
     * <p>The key-value pairs to use for the tags.</p>
     */
    inline TagLogGroupRequest& WithTags(const Aws::Map<Aws::String, Aws::String>& value) { SetTags(value); return *this;}
