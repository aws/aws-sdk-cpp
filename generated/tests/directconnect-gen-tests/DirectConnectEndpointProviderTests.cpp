...
protected:
    static Aws::Vector<DirectConnectEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<DirectConnectEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<DirectConnectEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<DirectConnectEndpointProviderEndpointTestCase>> DirectConnectEndpointProviderTests::TEST_CASES;
const size_t DirectConnectEndpointProviderTests::TEST_CASES_SZ = 48;

Aws::Vector<DirectConnectEndpointProviderEndpointTestCase> DirectConnectEndpointProviderTests::getTestCase() {

  Aws::Vector<DirectConnectEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
TEST_P(DirectConnectEndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/DirectConnectEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, DirectConnectEndpointProviderTests::TEST_CASES_SZ));
