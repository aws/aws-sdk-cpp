...
const size_t ECRPublicEndpointProviderTests::TEST_CASES_SZ = 5;
...
Aws::Vector<ECRPublicEndpointProviderEndpointTestCase> ECRPublicEndpointProviderTests::getTestCase() {
  ...
  /*TEST CASE 0*/
  {"Valid with dualstack and FIPS disabled. i.e, IPv4 Only stack with no FIPS, with special prefix", // documentation
  ...
  /*TEST CASE 1*/
  {"Valid with dualstack enabled", // documentation
  ...
  /*TEST CASE 2*/
  {"Invalid with FIPS set, dualstack disabled", // documentation
    {EpParam("UseFIPS", true), EpParam("Region", "us-east-1"), EpParam("UseDualStack", false)}, // params
    {}, // tags
    {{/*No endpoint expected*/}, /*error*/"ECR Public does not support FIPS"} // expect
  },
  /*TEST CASE 3*/
  {"Invalid with both dualstack and FIPS enabled", // documentation
    {EpParam("UseFIPS", true), EpParam("Region", "us-east-1"), EpParam("UseDualStack", true)}, // params
    {}, // tags
    {{/*No endpoint expected*/}, /*error*/"ECR Public does not support FIPS"} // expect
  },
  /*TEST CASE 4*/
  {"Invalid with DualStack enabled and partition does not support Dualstack", // documentation
    {EpParam("Region", "us-isob-east-1"), EpParam("UseDualStack", true)}, // params
    {}, // tags
