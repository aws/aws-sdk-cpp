...
static const char* ALLOCATION_TAG = "AWSKendraRankingEndpointProviderTests";
...
struct KendraRankingEndpointProviderEndpointTestCase
{
...
protected:
    static Aws::Vector<KendraRankingEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<KendraRankingEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<KendraRankingEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<KendraRankingEndpointProviderEndpointTestCase>> KendraRankingEndpointProviderTests::TEST_CASES;
const size_t KendraRankingEndpointProviderTests::TEST_CASES_SZ = 10;

Aws::Vector<KendraRankingEndpointProviderEndpointTestCase> KendraRankingEndpointProviderTests::getTestCase() {

  Aws::Vector<KendraRankingEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
void ValidateOutcome(const ResolveEndpointOutcome& outcome, const KendraRankingEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(KendraRankingEndpointProviderTests, EndpointProviderTest)
{
    ...
    const KendraRankingEndpointProviderEndpointTestCase& TEST_CASE = TEST_CASES->at(TEST_CASE_IDX);
    SCOPED_TRACE(Aws::String("\nTEST CASE # ") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX) + ": " + TEST_CASE.documentation);
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/KendraRankingEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));

    std::shared_ptr<KendraRankingEndpointProvider> endpointProvider = Aws::MakeShared<KendraRankingEndpointProvider>(ALLOCATION_TAG);
    ASSERT_TRUE(endpointProvider) << "Failed to allocate/initialize KendraRankingEndpointProvider";
    ...
    for(const auto& operation : TEST_CASE.operationInput)
    {
         ...
         */
        const Aws::Vector<std::reference_wrapper<const KendraRankingEndpointProviderEndpointTestCase::OperationParamsFromTest>>
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         KendraRankingEndpointProviderTests,
                         ::testing::Range((size_t) 0u, KendraRankingEndpointProviderTests::TEST_CASES_SZ));
