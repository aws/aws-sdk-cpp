...
protected:
    static Aws::Vector<ECSEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<ECSEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<ECSEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<ECSEndpointProviderEndpointTestCase>> ECSEndpointProviderTests::TEST_CASES;
const size_t ECSEndpointProviderTests::TEST_CASES_SZ = 53;

Aws::Vector<ECSEndpointProviderEndpointTestCase> ECSEndpointProviderTests::getTestCase() {

  Aws::Vector<ECSEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
TEST_P(ECSEndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/ECSEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, ECSEndpointProviderTests::TEST_CASES_SZ));
