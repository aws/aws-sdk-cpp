...
protected:
    static Aws::Vector<CloudWatchEventsEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<CloudWatchEventsEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<CloudWatchEventsEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<CloudWatchEventsEndpointProviderEndpointTestCase>> CloudWatchEventsEndpointProviderTests::TEST_CASES;
const size_t CloudWatchEventsEndpointProviderTests::TEST_CASES_SZ = 53;

Aws::Vector<CloudWatchEventsEndpointProviderEndpointTestCase> CloudWatchEventsEndpointProviderTests::getTestCase() {

  Aws::Vector<CloudWatchEventsEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
TEST_P(CloudWatchEventsEndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/CloudWatchEventsEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, CloudWatchEventsEndpointProviderTests::TEST_CASES_SZ));
