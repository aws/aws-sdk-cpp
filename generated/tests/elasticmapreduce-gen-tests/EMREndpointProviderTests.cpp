...
protected:
    static Aws::Vector<EMREndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<EMREndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<EMREndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<EMREndpointProviderEndpointTestCase>> EMREndpointProviderTests::TEST_CASES;
const size_t EMREndpointProviderTests::TEST_CASES_SZ = 54;

Aws::Vector<EMREndpointProviderEndpointTestCase> EMREndpointProviderTests::getTestCase() {

  Aws::Vector<EMREndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
void ValidateOutcome(const ResolveEndpointOutcome& outcome, const EMREndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(EMREndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/EMREndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, EMREndpointProviderTests::TEST_CASES_SZ));
