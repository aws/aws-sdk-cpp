...
protected:
    static Aws::Vector<FirehoseEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<FirehoseEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<FirehoseEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<FirehoseEndpointProviderEndpointTestCase>> FirehoseEndpointProviderTests::TEST_CASES;
const size_t FirehoseEndpointProviderTests::TEST_CASES_SZ = 48;

Aws::Vector<FirehoseEndpointProviderEndpointTestCase> FirehoseEndpointProviderTests::getTestCase() {

  Aws::Vector<FirehoseEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
void ValidateOutcome(const ResolveEndpointOutcome& outcome, const FirehoseEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(FirehoseEndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/FirehoseEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, FirehoseEndpointProviderTests::TEST_CASES_SZ));
