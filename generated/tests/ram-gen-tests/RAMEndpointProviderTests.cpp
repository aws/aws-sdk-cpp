...
protected:
    static Aws::Vector<RAMEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<RAMEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<RAMEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<RAMEndpointProviderEndpointTestCase>> RAMEndpointProviderTests::TEST_CASES;
const size_t RAMEndpointProviderTests::TEST_CASES_SZ = 53;

Aws::Vector<RAMEndpointProviderEndpointTestCase> RAMEndpointProviderTests::getTestCase() {

  Aws::Vector<RAMEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
void ValidateOutcome(const ResolveEndpointOutcome& outcome, const RAMEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(RAMEndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/RAMEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, RAMEndpointProviderTests::TEST_CASES_SZ));
