...
protected:
    static Aws::Vector<CodeArtifactEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<CodeArtifactEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<CodeArtifactEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<CodeArtifactEndpointProviderEndpointTestCase>> CodeArtifactEndpointProviderTests::TEST_CASES;
const size_t CodeArtifactEndpointProviderTests::TEST_CASES_SZ = 37;

Aws::Vector<CodeArtifactEndpointProviderEndpointTestCase> CodeArtifactEndpointProviderTests::getTestCase() {

  Aws::Vector<CodeArtifactEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
TEST_P(CodeArtifactEndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/CodeArtifactEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, CodeArtifactEndpointProviderTests::TEST_CASES_SZ));
