...
protected:
    static Aws::Vector<AthenaEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<AthenaEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<AthenaEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<AthenaEndpointProviderEndpointTestCase>> AthenaEndpointProviderTests::TEST_CASES;
const size_t AthenaEndpointProviderTests::TEST_CASES_SZ = 47;

Aws::Vector<AthenaEndpointProviderEndpointTestCase> AthenaEndpointProviderTests::getTestCase() {

  Aws::Vector<AthenaEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
void ValidateOutcome(const ResolveEndpointOutcome& outcome, const AthenaEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(AthenaEndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/AthenaEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, AthenaEndpointProviderTests::TEST_CASES_SZ));
