...
protected:
    static Aws::Vector<ARCZonalShiftEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<ARCZonalShiftEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<ARCZonalShiftEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<ARCZonalShiftEndpointProviderEndpointTestCase>> ARCZonalShiftEndpointProviderTests::TEST_CASES;
const size_t ARCZonalShiftEndpointProviderTests::TEST_CASES_SZ = 21;

Aws::Vector<ARCZonalShiftEndpointProviderEndpointTestCase> ARCZonalShiftEndpointProviderTests::getTestCase() {

  Aws::Vector<ARCZonalShiftEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
TEST_P(ARCZonalShiftEndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/ARCZonalShiftEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, ARCZonalShiftEndpointProviderTests::TEST_CASES_SZ));
