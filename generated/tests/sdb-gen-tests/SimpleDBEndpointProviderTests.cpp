...
protected:
    static Aws::Vector<SimpleDBEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<SimpleDBEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<SimpleDBEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<SimpleDBEndpointProviderEndpointTestCase>> SimpleDBEndpointProviderTests::TEST_CASES;
const size_t SimpleDBEndpointProviderTests::TEST_CASES_SZ = 35;

Aws::Vector<SimpleDBEndpointProviderEndpointTestCase> SimpleDBEndpointProviderTests::getTestCase() {

  Aws::Vector<SimpleDBEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
TEST_P(SimpleDBEndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/SimpleDBEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, SimpleDBEndpointProviderTests::TEST_CASES_SZ));
