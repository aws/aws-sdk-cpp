...
protected:
    static Aws::Vector<ACMPCAEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<ACMPCAEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<ACMPCAEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<ACMPCAEndpointProviderEndpointTestCase>> ACMPCAEndpointProviderTests::TEST_CASES;
const size_t ACMPCAEndpointProviderTests::TEST_CASES_SZ = 48;

Aws::Vector<ACMPCAEndpointProviderEndpointTestCase> ACMPCAEndpointProviderTests::getTestCase() {

  Aws::Vector<ACMPCAEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
void ValidateOutcome(const ResolveEndpointOutcome& outcome, const ACMPCAEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(ACMPCAEndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/ACMPCAEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, ACMPCAEndpointProviderTests::TEST_CASES_SZ));
