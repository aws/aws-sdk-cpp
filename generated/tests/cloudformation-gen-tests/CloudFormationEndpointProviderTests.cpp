...
protected:
    static Aws::Vector<CloudFormationEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<CloudFormationEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<CloudFormationEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<CloudFormationEndpointProviderEndpointTestCase>> CloudFormationEndpointProviderTests::TEST_CASES;
const size_t CloudFormationEndpointProviderTests::TEST_CASES_SZ = 49;

Aws::Vector<CloudFormationEndpointProviderEndpointTestCase> CloudFormationEndpointProviderTests::getTestCase() {

  Aws::Vector<CloudFormationEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
TEST_P(CloudFormationEndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/CloudFormationEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, CloudFormationEndpointProviderTests::TEST_CASES_SZ));
