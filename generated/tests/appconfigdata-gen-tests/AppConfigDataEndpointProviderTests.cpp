...
protected:
    static Aws::Vector<AppConfigDataEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<AppConfigDataEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<AppConfigDataEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<AppConfigDataEndpointProviderEndpointTestCase>> AppConfigDataEndpointProviderTests::TEST_CASES;
const size_t AppConfigDataEndpointProviderTests::TEST_CASES_SZ = 48;

Aws::Vector<AppConfigDataEndpointProviderEndpointTestCase> AppConfigDataEndpointProviderTests::getTestCase() {

  Aws::Vector<AppConfigDataEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
TEST_P(AppConfigDataEndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/AppConfigDataEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, AppConfigDataEndpointProviderTests::TEST_CASES_SZ));
