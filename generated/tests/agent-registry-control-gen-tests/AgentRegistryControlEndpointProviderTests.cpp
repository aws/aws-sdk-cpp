...
static const char* ALLOCATION_TAG = "AWSAgentRegistryControlEndpointProviderTests";
...
struct AgentRegistryControlEndpointProviderEndpointTestCase
{
...
class AgentRegistryControlEndpointProviderTests : public ::testing::TestWithParam<size_t>
{
public:
    static const size_t TEST_CASES_SZ;
protected:
    static Aws::Vector<AgentRegistryControlEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<AgentRegistryControlEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<AgentRegistryControlEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<AgentRegistryControlEndpointProviderEndpointTestCase>> AgentRegistryControlEndpointProviderTests::TEST_CASES;
const size_t AgentRegistryControlEndpointProviderTests::TEST_CASES_SZ = 3;

Aws::Vector<AgentRegistryControlEndpointProviderEndpointTestCase> AgentRegistryControlEndpointProviderTests::getTestCase() {

  Aws::Vector<AgentRegistryControlEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
  {"Region us-west-2 -> region-based prod host.", // documentation
    {EpParam("Region", "us-west-2")}, // params
    {}, // tags
    {{/*epUrl*/"https://agent-registry-control.us-west-2.api.aws",
       {/*authScheme*/}, 
       {/*properties*/},
  ...
  {"Region us-east-1 -> region-based prod host.", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://agent-registry-control.us-east-1.api.aws",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
...
void ValidateOutcome(const ResolveEndpointOutcome& outcome, const AgentRegistryControlEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(AgentRegistryControlEndpointProviderTests, EndpointProviderTest)
{
    ...
    const AgentRegistryControlEndpointProviderEndpointTestCase& TEST_CASE = TEST_CASES->at(TEST_CASE_IDX);
    SCOPED_TRACE(Aws::String("\nTEST CASE # ") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX) + ": " + TEST_CASE.documentation);
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/AgentRegistryControlEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));

    std::shared_ptr<AgentRegistryControlEndpointProvider> endpointProvider = Aws::MakeShared<AgentRegistryControlEndpointProvider>(ALLOCATION_TAG);
    ASSERT_TRUE(endpointProvider) << "Failed to allocate/initialize AgentRegistryControlEndpointProvider";
    ...
    for(const auto& operation : TEST_CASE.operationInput)
    {
         ...
         */
        const Aws::Vector<std::reference_wrapper<const AgentRegistryControlEndpointProviderEndpointTestCase::OperationParamsFromTest>>
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         AgentRegistryControlEndpointProviderTests,
                         ::testing::Range((size_t) 0u, AgentRegistryControlEndpointProviderTests::TEST_CASES_SZ));
