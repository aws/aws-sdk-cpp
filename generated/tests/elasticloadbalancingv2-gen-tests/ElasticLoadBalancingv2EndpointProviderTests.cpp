...
static const char* ALLOCATION_TAG = "AWSElasticLoadBalancingv2EndpointProviderTests";
...
struct ElasticLoadBalancingv2EndpointProviderEndpointTestCase
{
...
class ElasticLoadBalancingv2EndpointProviderTests : public ::testing::TestWithParam<size_t>
{
public:
    static const size_t TEST_CASES_SZ;
protected:
    static Aws::Vector<ElasticLoadBalancingv2EndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<ElasticLoadBalancingv2EndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<ElasticLoadBalancingv2EndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<ElasticLoadBalancingv2EndpointProviderEndpointTestCase>> ElasticLoadBalancingv2EndpointProviderTests::TEST_CASES;
const size_t ElasticLoadBalancingv2EndpointProviderTests::TEST_CASES_SZ = 49;

Aws::Vector<ElasticLoadBalancingv2EndpointProviderEndpointTestCase> ElasticLoadBalancingv2EndpointProviderTests::getTestCase() {

  Aws::Vector<ElasticLoadBalancingv2EndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
void ValidateOutcome(const ResolveEndpointOutcome& outcome, const ElasticLoadBalancingv2EndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(ElasticLoadBalancingv2EndpointProviderTests, EndpointProviderTest)
{
    ...
    const ElasticLoadBalancingv2EndpointProviderEndpointTestCase& TEST_CASE = TEST_CASES->at(TEST_CASE_IDX);
    SCOPED_TRACE(Aws::String("\nTEST CASE # ") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX) + ": " + TEST_CASE.documentation);
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/ElasticLoadBalancingv2EndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));

    std::shared_ptr<ElasticLoadBalancingv2EndpointProvider> endpointProvider = Aws::MakeShared<ElasticLoadBalancingv2EndpointProvider>(ALLOCATION_TAG);
    ASSERT_TRUE(endpointProvider) << "Failed to allocate/initialize ElasticLoadBalancingv2EndpointProvider";
    ...
    for(const auto& operation : TEST_CASE.operationInput)
    {
         ...
         */
        const Aws::Vector<std::reference_wrapper<const ElasticLoadBalancingv2EndpointProviderEndpointTestCase::OperationParamsFromTest>>
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ElasticLoadBalancingv2EndpointProviderTests,
                         ::testing::Range((size_t) 0u, ElasticLoadBalancingv2EndpointProviderTests::TEST_CASES_SZ));
