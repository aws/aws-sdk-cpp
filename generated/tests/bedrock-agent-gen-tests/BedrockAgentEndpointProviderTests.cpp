...
static const char* ALLOCATION_TAG = "AWSBedrockAgentEndpointProviderTests";
...
struct BedrockAgentEndpointProviderEndpointTestCase
{
...
class BedrockAgentEndpointProviderTests : public ::testing::TestWithParam<size_t>
{
public:
    static const size_t TEST_CASES_SZ;
protected:
    static Aws::Vector<BedrockAgentEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<BedrockAgentEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<BedrockAgentEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<BedrockAgentEndpointProviderEndpointTestCase>> BedrockAgentEndpointProviderTests::TEST_CASES;
const size_t BedrockAgentEndpointProviderTests::TEST_CASES_SZ = 21;

Aws::Vector<BedrockAgentEndpointProviderEndpointTestCase> BedrockAgentEndpointProviderTests::getTestCase() {

  Aws::Vector<BedrockAgentEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
  {"For region us-east-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://bedrock-agent-fips.us-east-1.api.aws",
       {/*authScheme*/}, 
       {/*properties*/},
  ...
  {"For region us-east-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://bedrock-agent-fips.us-east-1.amazonaws.com",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region us-east-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://bedrock-agent.us-east-1.api.aws",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region us-east-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://bedrock-agent.us-east-1.amazonaws.com",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region cn-north-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://bedrock-agent-fips.cn-north-1.api.amazonwebservices.com.cn",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region cn-north-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://bedrock-agent-fips.cn-north-1.amazonaws.com.cn",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region cn-north-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://bedrock-agent.cn-north-1.api.amazonwebservices.com.cn",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region cn-north-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://bedrock-agent.cn-north-1.amazonaws.com.cn",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region us-gov-east-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://bedrock-agent-fips.us-gov-east-1.api.aws",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region us-gov-east-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://bedrock-agent-fips.us-gov-east-1.amazonaws.com",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region us-gov-east-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://bedrock-agent.us-gov-east-1.api.aws",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region us-gov-east-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://bedrock-agent.us-gov-east-1.amazonaws.com",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region us-iso-east-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://bedrock-agent-fips.us-iso-east-1.c2s.ic.gov",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region us-iso-east-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://bedrock-agent.us-iso-east-1.c2s.ic.gov",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region us-isob-east-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://bedrock-agent-fips.us-isob-east-1.sc2s.sgov.gov",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region us-isob-east-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://bedrock-agent.us-isob-east-1.sc2s.sgov.gov",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
...
void ValidateOutcome(const ResolveEndpointOutcome& outcome, const BedrockAgentEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(BedrockAgentEndpointProviderTests, EndpointProviderTest)
{
    ...
    const BedrockAgentEndpointProviderEndpointTestCase& TEST_CASE = TEST_CASES->at(TEST_CASE_IDX);
    SCOPED_TRACE(Aws::String("\nTEST CASE # ") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX) + ": " + TEST_CASE.documentation);
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/BedrockAgentEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));

    std::shared_ptr<BedrockAgentEndpointProvider> endpointProvider = Aws::MakeShared<BedrockAgentEndpointProvider>(ALLOCATION_TAG);
    ASSERT_TRUE(endpointProvider) << "Failed to allocate/initialize BedrockAgentEndpointProvider";
    ...
    for(const auto& operation : TEST_CASE.operationInput)
    {
         ...
         */
        const Aws::Vector<std::reference_wrapper<const BedrockAgentEndpointProviderEndpointTestCase::OperationParamsFromTest>>
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         BedrockAgentEndpointProviderTests,
                         ::testing::Range((size_t) 0u, BedrockAgentEndpointProviderTests::TEST_CASES_SZ));
