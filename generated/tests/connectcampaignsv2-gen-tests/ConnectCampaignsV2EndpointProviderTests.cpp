...
static const char* ALLOCATION_TAG = "AWSConnectCampaignsV2EndpointProviderTests";
...
struct ConnectCampaignsV2EndpointProviderEndpointTestCase
{
...
class ConnectCampaignsV2EndpointProviderTests : public ::testing::TestWithParam<size_t>
{
public:
    static const size_t TEST_CASES_SZ;
protected:
    static Aws::Vector<ConnectCampaignsV2EndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<ConnectCampaignsV2EndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<ConnectCampaignsV2EndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<ConnectCampaignsV2EndpointProviderEndpointTestCase>> ConnectCampaignsV2EndpointProviderTests::TEST_CASES;
const size_t ConnectCampaignsV2EndpointProviderTests::TEST_CASES_SZ = 21;

Aws::Vector<ConnectCampaignsV2EndpointProviderEndpointTestCase> ConnectCampaignsV2EndpointProviderTests::getTestCase() {

  Aws::Vector<ConnectCampaignsV2EndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
void ValidateOutcome(const ResolveEndpointOutcome& outcome, const ConnectCampaignsV2EndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(ConnectCampaignsV2EndpointProviderTests, EndpointProviderTest)
{
    ...
    const ConnectCampaignsV2EndpointProviderEndpointTestCase& TEST_CASE = TEST_CASES->at(TEST_CASE_IDX);
    SCOPED_TRACE(Aws::String("\nTEST CASE # ") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX) + ": " + TEST_CASE.documentation);
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/ConnectCampaignsV2EndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));

    std::shared_ptr<ConnectCampaignsV2EndpointProvider> endpointProvider = Aws::MakeShared<ConnectCampaignsV2EndpointProvider>(ALLOCATION_TAG);
    ASSERT_TRUE(endpointProvider) << "Failed to allocate/initialize ConnectCampaignsV2EndpointProvider";
    ...
    for(const auto& operation : TEST_CASE.operationInput)
    {
         ...
         */
        const Aws::Vector<std::reference_wrapper<const ConnectCampaignsV2EndpointProviderEndpointTestCase::OperationParamsFromTest>>
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ConnectCampaignsV2EndpointProviderTests,
                         ::testing::Range((size_t) 0u, ConnectCampaignsV2EndpointProviderTests::TEST_CASES_SZ));
