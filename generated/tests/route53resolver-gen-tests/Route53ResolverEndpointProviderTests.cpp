...
protected:
    static Aws::Vector<Route53ResolverEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<Route53ResolverEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<Route53ResolverEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<Route53ResolverEndpointProviderEndpointTestCase>> Route53ResolverEndpointProviderTests::TEST_CASES;
const size_t Route53ResolverEndpointProviderTests::TEST_CASES_SZ = 49;

Aws::Vector<Route53ResolverEndpointProviderEndpointTestCase> Route53ResolverEndpointProviderTests::getTestCase() {

  Aws::Vector<Route53ResolverEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
void ValidateOutcome(const ResolveEndpointOutcome& outcome, const Route53ResolverEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(Route53ResolverEndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/Route53ResolverEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, Route53ResolverEndpointProviderTests::TEST_CASES_SZ));
