...
static const char* ALLOCATION_TAG = "AWSLambdaMicrovmsEndpointProviderTests";
...
struct LambdaMicrovmsEndpointProviderEndpointTestCase
{
...
class LambdaMicrovmsEndpointProviderTests : public ::testing::TestWithParam<size_t>
{
public:
    static const size_t TEST_CASES_SZ;
protected:
    static Aws::Vector<LambdaMicrovmsEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<LambdaMicrovmsEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<LambdaMicrovmsEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<LambdaMicrovmsEndpointProviderEndpointTestCase>> LambdaMicrovmsEndpointProviderTests::TEST_CASES;
const size_t LambdaMicrovmsEndpointProviderTests::TEST_CASES_SZ = 21;

Aws::Vector<LambdaMicrovmsEndpointProviderEndpointTestCase> LambdaMicrovmsEndpointProviderTests::getTestCase() {

  Aws::Vector<LambdaMicrovmsEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
void ValidateOutcome(const ResolveEndpointOutcome& outcome, const LambdaMicrovmsEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(LambdaMicrovmsEndpointProviderTests, EndpointProviderTest)
{
    ...
    const LambdaMicrovmsEndpointProviderEndpointTestCase& TEST_CASE = TEST_CASES->at(TEST_CASE_IDX);
    SCOPED_TRACE(Aws::String("\nTEST CASE # ") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX) + ": " + TEST_CASE.documentation);
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/LambdaMicrovmsEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));

    std::shared_ptr<LambdaMicrovmsEndpointProvider> endpointProvider = Aws::MakeShared<LambdaMicrovmsEndpointProvider>(ALLOCATION_TAG);
    ASSERT_TRUE(endpointProvider) << "Failed to allocate/initialize LambdaMicrovmsEndpointProvider";
    ...
    for(const auto& operation : TEST_CASE.operationInput)
    {
         ...
         */
        const Aws::Vector<std::reference_wrapper<const LambdaMicrovmsEndpointProviderEndpointTestCase::OperationParamsFromTest>>
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         LambdaMicrovmsEndpointProviderTests,
                         ::testing::Range((size_t) 0u, LambdaMicrovmsEndpointProviderTests::TEST_CASES_SZ));
