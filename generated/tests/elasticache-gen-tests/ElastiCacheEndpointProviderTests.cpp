...
protected:
    static Aws::Vector<ElastiCacheEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<ElastiCacheEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<ElastiCacheEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<ElastiCacheEndpointProviderEndpointTestCase>> ElastiCacheEndpointProviderTests::TEST_CASES;
const size_t ElastiCacheEndpointProviderTests::TEST_CASES_SZ = 49;

Aws::Vector<ElastiCacheEndpointProviderEndpointTestCase> ElastiCacheEndpointProviderTests::getTestCase() {

  Aws::Vector<ElastiCacheEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
void ValidateOutcome(const ResolveEndpointOutcome& outcome, const ElastiCacheEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(ElastiCacheEndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/ElastiCacheEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, ElastiCacheEndpointProviderTests::TEST_CASES_SZ));
