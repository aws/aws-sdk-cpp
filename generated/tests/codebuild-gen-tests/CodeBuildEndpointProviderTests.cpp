...
protected:
    static Aws::Vector<CodeBuildEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<CodeBuildEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<CodeBuildEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<CodeBuildEndpointProviderEndpointTestCase>> CodeBuildEndpointProviderTests::TEST_CASES;
const size_t CodeBuildEndpointProviderTests::TEST_CASES_SZ = 48;

Aws::Vector<CodeBuildEndpointProviderEndpointTestCase> CodeBuildEndpointProviderTests::getTestCase() {

  Aws::Vector<CodeBuildEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
TEST_P(CodeBuildEndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/CodeBuildEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, CodeBuildEndpointProviderTests::TEST_CASES_SZ));
