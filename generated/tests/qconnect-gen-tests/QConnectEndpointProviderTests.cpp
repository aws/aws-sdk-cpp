...
static const char* ALLOCATION_TAG = "AWSQConnectEndpointProviderTests";
...
struct QConnectEndpointProviderEndpointTestCase
{
...
class QConnectEndpointProviderTests : public ::testing::TestWithParam<size_t>
{
public:
    static const size_t TEST_CASES_SZ;
protected:
    static Aws::Vector<QConnectEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<QConnectEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<QConnectEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<QConnectEndpointProviderEndpointTestCase>> QConnectEndpointProviderTests::TEST_CASES;
const size_t QConnectEndpointProviderTests::TEST_CASES_SZ = 21;

Aws::Vector<QConnectEndpointProviderEndpointTestCase> QConnectEndpointProviderTests::getTestCase() {

  Aws::Vector<QConnectEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
void ValidateOutcome(const ResolveEndpointOutcome& outcome, const QConnectEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(QConnectEndpointProviderTests, EndpointProviderTest)
{
    ...
    const QConnectEndpointProviderEndpointTestCase& TEST_CASE = TEST_CASES->at(TEST_CASE_IDX);
    SCOPED_TRACE(Aws::String("\nTEST CASE # ") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX) + ": " + TEST_CASE.documentation);
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/QConnectEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));

    std::shared_ptr<QConnectEndpointProvider> endpointProvider = Aws::MakeShared<QConnectEndpointProvider>(ALLOCATION_TAG);
    ASSERT_TRUE(endpointProvider) << "Failed to allocate/initialize QConnectEndpointProvider";
    ...
    for(const auto& operation : TEST_CASE.operationInput)
    {
         ...
         */
        const Aws::Vector<std::reference_wrapper<const QConnectEndpointProviderEndpointTestCase::OperationParamsFromTest>>
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         QConnectEndpointProviderTests,
                         ::testing::Range((size_t) 0u, QConnectEndpointProviderTests::TEST_CASES_SZ));
