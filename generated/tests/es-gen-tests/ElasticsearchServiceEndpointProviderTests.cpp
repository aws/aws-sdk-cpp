...
protected:
    static Aws::Vector<ElasticsearchServiceEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<ElasticsearchServiceEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<ElasticsearchServiceEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<ElasticsearchServiceEndpointProviderEndpointTestCase>> ElasticsearchServiceEndpointProviderTests::TEST_CASES;
const size_t ElasticsearchServiceEndpointProviderTests::TEST_CASES_SZ = 53;

Aws::Vector<ElasticsearchServiceEndpointProviderEndpointTestCase> ElasticsearchServiceEndpointProviderTests::getTestCase() {

  Aws::Vector<ElasticsearchServiceEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
void ValidateOutcome(const ResolveEndpointOutcome& outcome, const ElasticsearchServiceEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(ElasticsearchServiceEndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/ElasticsearchServiceEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, ElasticsearchServiceEndpointProviderTests::TEST_CASES_SZ));
