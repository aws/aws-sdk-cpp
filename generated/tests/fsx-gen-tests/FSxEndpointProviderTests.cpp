...
protected:
    static Aws::Vector<FSxEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<FSxEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<FSxEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<FSxEndpointProviderEndpointTestCase>> FSxEndpointProviderTests::TEST_CASES;
const size_t FSxEndpointProviderTests::TEST_CASES_SZ = 52;

Aws::Vector<FSxEndpointProviderEndpointTestCase> FSxEndpointProviderTests::getTestCase() {

  Aws::Vector<FSxEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
TEST_P(FSxEndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/FSxEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, FSxEndpointProviderTests::TEST_CASES_SZ));
