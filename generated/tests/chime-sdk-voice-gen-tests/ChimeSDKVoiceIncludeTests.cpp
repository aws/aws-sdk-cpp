...
using ChimeSDKVoiceIncludeTest = ::testing::Test;

TEST_F(ChimeSDKVoiceIncludeTest, TestClientCompiles)
{
  Aws::Client::ClientConfigurationInitValues cfgInit;
  cfgInit.shouldDisableIMDS = true;
  Aws::Client::ClientConfiguration config(cfgInit);
  auto pClient = Aws::MakeUnique<Aws::ChimeSDKVoice::ChimeSDKVoiceClient>("ChimeSDKVoiceIncludeTest", config);
