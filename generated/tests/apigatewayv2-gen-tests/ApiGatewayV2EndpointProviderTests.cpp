...
protected:
    static Aws::Vector<ApiGatewayV2EndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<ApiGatewayV2EndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<ApiGatewayV2EndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<ApiGatewayV2EndpointProviderEndpointTestCase>> ApiGatewayV2EndpointProviderTests::TEST_CASES;
const size_t ApiGatewayV2EndpointProviderTests::TEST_CASES_SZ = 47;

Aws::Vector<ApiGatewayV2EndpointProviderEndpointTestCase> ApiGatewayV2EndpointProviderTests::getTestCase() {

  Aws::Vector<ApiGatewayV2EndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
void ValidateOutcome(const ResolveEndpointOutcome& outcome, const ApiGatewayV2EndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(ApiGatewayV2EndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/ApiGatewayV2EndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, ApiGatewayV2EndpointProviderTests::TEST_CASES_SZ));
