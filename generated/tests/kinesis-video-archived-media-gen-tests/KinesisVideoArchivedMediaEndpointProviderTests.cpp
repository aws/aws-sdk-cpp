...
protected:
    static Aws::Vector<KinesisVideoArchivedMediaEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<KinesisVideoArchivedMediaEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<KinesisVideoArchivedMediaEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<KinesisVideoArchivedMediaEndpointProviderEndpointTestCase>> KinesisVideoArchivedMediaEndpointProviderTests::TEST_CASES;
const size_t KinesisVideoArchivedMediaEndpointProviderTests::TEST_CASES_SZ = 40;

Aws::Vector<KinesisVideoArchivedMediaEndpointProviderEndpointTestCase> KinesisVideoArchivedMediaEndpointProviderTests::getTestCase() {

  Aws::Vector<KinesisVideoArchivedMediaEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
TEST_P(KinesisVideoArchivedMediaEndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/KinesisVideoArchivedMediaEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, KinesisVideoArchivedMediaEndpointProviderTests::TEST_CASES_SZ));
