...
static const Aws::Vector<SupportEndpointProviderEndpointTestCase> TEST_CASES = {
  /*TEST CASE 0*/
  {"For region aws-global with FIPS disabled and DualStack disabled", // documentation
    ...
    {{/*epUrl*/"https://support.us-east-1.amazonaws.com",
       {/*properties*/{"authSchemes", {EpProp("signingRegion", "us-east-1"), EpProp("name", "sigv4"), EpProp("signingName", "support")}}},
  ...
  {"For region aws-cn-global with FIPS disabled and DualStack disabled", // documentation
    ...
    {{/*epUrl*/"https://support.cn-north-1.amazonaws.com.cn",
       {/*properties*/{"authSchemes", {EpProp("signingRegion", "cn-north-1"), EpProp("name", "sigv4"), EpProp("signingName", "support")}}},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  /*TEST CASE 6*/
  ...
  {"For region aws-us-gov-global with FIPS disabled and DualStack disabled", // documentation
    ...
    {{/*epUrl*/"https://support.us-gov-west-1.amazonaws.com",
       {/*properties*/{"authSchemes", {EpProp("signingRegion", "us-gov-west-1"), EpProp("name", "sigv4"), EpProp("signingName", "support")}}},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  /*TEST CASE 11*/
  ...
  {"For region aws-iso-global with FIPS disabled and DualStack disabled", // documentation
    ...
    {{/*epUrl*/"https://support.us-iso-east-1.c2s.ic.gov",
       {/*properties*/{"authSchemes", {EpProp("signingRegion", "us-iso-east-1"), EpProp("name", "sigv4"), EpProp("signingName", "support")}}},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  /*TEST CASE 16*/
  ...
  {"For region aws-iso-b-global with FIPS disabled and DualStack disabled", // documentation
    ...
    {{/*epUrl*/"https://support.us-isob-east-1.sc2s.sgov.gov",
       {/*properties*/{"authSchemes", {EpProp("signingRegion", "us-isob-east-1"), EpProp("name", "sigv4"), EpProp("signingName", "support")}}},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  /*TEST CASE 21*/
