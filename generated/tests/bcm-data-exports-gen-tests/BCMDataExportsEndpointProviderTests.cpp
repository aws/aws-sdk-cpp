...
static const char* ALLOCATION_TAG = "AWSBCMDataExportsEndpointProviderTests";
...
struct BCMDataExportsEndpointProviderEndpointTestCase
{
...
class BCMDataExportsEndpointProviderTests : public ::testing::TestWithParam<size_t>
{
public:
    static const size_t TEST_CASES_SZ;
protected:
    static Aws::Vector<BCMDataExportsEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<BCMDataExportsEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<BCMDataExportsEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::Vector<BCMDataExportsEndpointProviderEndpointTestCase> BCMDataExportsEndpointProviderTests::getTestCase() {
  ...
  {"For region us-east-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://bcm-data-exports-fips.us-east-1.api.aws",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
...
void ValidateOutcome(const ResolveEndpointOutcome& outcome, const BCMDataExportsEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(BCMDataExportsEndpointProviderTests, EndpointProviderTest)
{
    ...
    const BCMDataExportsEndpointProviderEndpointTestCase& TEST_CASE = TEST_CASES->at(TEST_CASE_IDX);
    SCOPED_TRACE(Aws::String("\nTEST CASE # ") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX) + ": " + TEST_CASE.documentation);
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/BCMDataExportsEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));

    std::shared_ptr<BCMDataExportsEndpointProvider> endpointProvider = Aws::MakeShared<BCMDataExportsEndpointProvider>(ALLOCATION_TAG);
    ASSERT_TRUE(endpointProvider) << "Failed to allocate/initialize BCMDataExportsEndpointProvider";
    ...
    for(const auto& operation : TEST_CASE.operationInput)
    {
         ...
         */
        const Aws::Vector<std::reference_wrapper<const BCMDataExportsEndpointProviderEndpointTestCase::OperationParamsFromTest>>
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         BCMDataExportsEndpointProviderTests,
                         ::testing::Range((size_t) 0u, BCMDataExportsEndpointProviderTests::TEST_CASES_SZ));
