...
static const Aws::Vector<BCMDataExportsEndpointProviderEndpointTestCase> TEST_CASES = {
  /*TEST CASE 0*/
  {"For region aws-global with FIPS disabled and DualStack enabled", // documentation
    ...
    {{/*epUrl*/"https://bcm-data-exports.us-east-1.api.aws",
       {/*properties*/{"authSchemes", {{EpProp("signingRegion", "us-east-1"), EpProp("name", "sigv4"), EpProp("signingName", "bcm-data-exports")}}}},
