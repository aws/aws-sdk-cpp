...
static const char* ALLOCATION_TAG = "AWSChimeSDKIdentityEndpointProviderTests";
...
struct ChimeSDKIdentityEndpointProviderEndpointTestCase
{
...
class ChimeSDKIdentityEndpointProviderTests : public ::testing::TestWithParam<size_t>
{
public:
    static const size_t TEST_CASES_SZ;
protected:
    static Aws::Vector<ChimeSDKIdentityEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<ChimeSDKIdentityEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<ChimeSDKIdentityEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<ChimeSDKIdentityEndpointProviderEndpointTestCase>> ChimeSDKIdentityEndpointProviderTests::TEST_CASES;
const size_t ChimeSDKIdentityEndpointProviderTests::TEST_CASES_SZ = 26;

Aws::Vector<ChimeSDKIdentityEndpointProviderEndpointTestCase> ChimeSDKIdentityEndpointProviderTests::getTestCase() {

  Aws::Vector<ChimeSDKIdentityEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
  {"For region eu-central-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://identity-chime.eu-central-1.amazonaws.com",
       {/*authScheme*/}, 
       {/*properties*/},
  ...
  {"For region us-east-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://identity-chime.us-east-1.amazonaws.com",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region us-east-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://identity-chime-fips.us-east-1.amazonaws.com",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region us-east-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://identity-chime-fips.us-east-1.api.aws",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region us-east-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://identity-chime.us-east-1.api.aws",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region cn-north-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://identity-chime-fips.cn-north-1.api.amazonwebservices.com.cn",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region cn-north-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://identity-chime-fips.cn-north-1.amazonaws.com.cn",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region cn-north-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://identity-chime.cn-north-1.api.amazonwebservices.com.cn",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region cn-north-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://identity-chime.cn-north-1.amazonaws.com.cn",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region us-gov-east-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://identity-chime-fips.us-gov-east-1.api.aws",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region us-gov-east-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://identity-chime-fips.us-gov-east-1.amazonaws.com",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region us-gov-east-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://identity-chime.us-gov-east-1.api.aws",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region us-gov-east-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://identity-chime.us-gov-east-1.amazonaws.com",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region us-iso-east-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://identity-chime-fips.us-iso-east-1.c2s.ic.gov",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region us-iso-east-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://identity-chime.us-iso-east-1.c2s.ic.gov",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region us-isob-east-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://identity-chime-fips.us-isob-east-1.sc2s.sgov.gov",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region us-isob-east-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://identity-chime.us-isob-east-1.sc2s.sgov.gov",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
...
void ValidateOutcome(const ResolveEndpointOutcome& outcome, const ChimeSDKIdentityEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(ChimeSDKIdentityEndpointProviderTests, EndpointProviderTest)
{
    ...
    const ChimeSDKIdentityEndpointProviderEndpointTestCase& TEST_CASE = TEST_CASES->at(TEST_CASE_IDX);
    SCOPED_TRACE(Aws::String("\nTEST CASE # ") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX) + ": " + TEST_CASE.documentation);
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/ChimeSDKIdentityEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));

    std::shared_ptr<ChimeSDKIdentityEndpointProvider> endpointProvider = Aws::MakeShared<ChimeSDKIdentityEndpointProvider>(ALLOCATION_TAG);
    ASSERT_TRUE(endpointProvider) << "Failed to allocate/initialize ChimeSDKIdentityEndpointProvider";
    ...
    for(const auto& operation : TEST_CASE.operationInput)
    {
         ...
         */
        const Aws::Vector<std::reference_wrapper<const ChimeSDKIdentityEndpointProviderEndpointTestCase::OperationParamsFromTest>>
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ChimeSDKIdentityEndpointProviderTests,
                         ::testing::Range((size_t) 0u, ChimeSDKIdentityEndpointProviderTests::TEST_CASES_SZ));
