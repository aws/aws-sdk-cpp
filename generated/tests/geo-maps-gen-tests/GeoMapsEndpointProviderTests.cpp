...
const size_t GeoMapsEndpointProviderTests::TEST_CASES_SZ = 32;
...
Aws::Vector<GeoMapsEndpointProviderEndpointTestCase> GeoMapsEndpointProviderTests::getTestCase() {
  ...
  {"For region us-gov-west-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://maps.geo-fips.us-gov-west-1.us-gov.api.aws/v2",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region us-gov-west-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://maps.geo-fips.us-gov-west-1.us-gov.amazonaws.com/v2",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region us-gov-west-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://maps.geo.us-gov-west-1.us-gov.api.aws/v2",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region us-gov-west-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://maps.geo.us-gov-west-1.us-gov.amazonaws.com/v2",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
