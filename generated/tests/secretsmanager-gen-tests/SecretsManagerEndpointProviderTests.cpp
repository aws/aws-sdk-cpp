...
protected:
    static Aws::Vector<SecretsManagerEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<SecretsManagerEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<SecretsManagerEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<SecretsManagerEndpointProviderEndpointTestCase>> SecretsManagerEndpointProviderTests::TEST_CASES;
const size_t SecretsManagerEndpointProviderTests::TEST_CASES_SZ = 53;

Aws::Vector<SecretsManagerEndpointProviderEndpointTestCase> SecretsManagerEndpointProviderTests::getTestCase() {

  Aws::Vector<SecretsManagerEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
TEST_P(SecretsManagerEndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/SecretsManagerEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, SecretsManagerEndpointProviderTests::TEST_CASES_SZ));
