...
static const char* ALLOCATION_TAG = "AWSLambdaCoreEndpointProviderTests";
...
struct LambdaCoreEndpointProviderEndpointTestCase
{
...
class LambdaCoreEndpointProviderTests : public ::testing::TestWithParam<size_t>
{
public:
    static const size_t TEST_CASES_SZ;
protected:
    static Aws::Vector<LambdaCoreEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<LambdaCoreEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<LambdaCoreEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<LambdaCoreEndpointProviderEndpointTestCase>> LambdaCoreEndpointProviderTests::TEST_CASES;
const size_t LambdaCoreEndpointProviderTests::TEST_CASES_SZ = 21;

Aws::Vector<LambdaCoreEndpointProviderEndpointTestCase> LambdaCoreEndpointProviderTests::getTestCase() {

  Aws::Vector<LambdaCoreEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
void ValidateOutcome(const ResolveEndpointOutcome& outcome, const LambdaCoreEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(LambdaCoreEndpointProviderTests, EndpointProviderTest)
{
    ...
    const LambdaCoreEndpointProviderEndpointTestCase& TEST_CASE = TEST_CASES->at(TEST_CASE_IDX);
    SCOPED_TRACE(Aws::String("\nTEST CASE # ") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX) + ": " + TEST_CASE.documentation);
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/LambdaCoreEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));

    std::shared_ptr<LambdaCoreEndpointProvider> endpointProvider = Aws::MakeShared<LambdaCoreEndpointProvider>(ALLOCATION_TAG);
    ASSERT_TRUE(endpointProvider) << "Failed to allocate/initialize LambdaCoreEndpointProvider";
    ...
    for(const auto& operation : TEST_CASE.operationInput)
    {
         ...
         */
        const Aws::Vector<std::reference_wrapper<const LambdaCoreEndpointProviderEndpointTestCase::OperationParamsFromTest>>
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         LambdaCoreEndpointProviderTests,
                         ::testing::Range((size_t) 0u, LambdaCoreEndpointProviderTests::TEST_CASES_SZ));
