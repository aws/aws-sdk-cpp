...
static const char* ALLOCATION_TAG = "AWSKinesisVideoEndpointProviderTests";
...
struct KinesisVideoEndpointProviderEndpointTestCase
{
...
class KinesisVideoEndpointProviderTests : public ::testing::TestWithParam<size_t>
{
public:
    static const size_t TEST_CASES_SZ;
protected:
    static Aws::Vector<KinesisVideoEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<KinesisVideoEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<KinesisVideoEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<KinesisVideoEndpointProviderEndpointTestCase>> KinesisVideoEndpointProviderTests::TEST_CASES;
const size_t KinesisVideoEndpointProviderTests::TEST_CASES_SZ = 40;

Aws::Vector<KinesisVideoEndpointProviderEndpointTestCase> KinesisVideoEndpointProviderTests::getTestCase() {

  Aws::Vector<KinesisVideoEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
void ValidateOutcome(const ResolveEndpointOutcome& outcome, const KinesisVideoEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(KinesisVideoEndpointProviderTests, EndpointProviderTest)
{
    ...
    const KinesisVideoEndpointProviderEndpointTestCase& TEST_CASE = TEST_CASES->at(TEST_CASE_IDX);
    SCOPED_TRACE(Aws::String("\nTEST CASE # ") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX) + ": " + TEST_CASE.documentation);
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/KinesisVideoEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));

    std::shared_ptr<KinesisVideoEndpointProvider> endpointProvider = Aws::MakeShared<KinesisVideoEndpointProvider>(ALLOCATION_TAG);
    ASSERT_TRUE(endpointProvider) << "Failed to allocate/initialize KinesisVideoEndpointProvider";
    ...
    for(const auto& operation : TEST_CASE.operationInput)
    {
         ...
         */
        const Aws::Vector<std::reference_wrapper<const KinesisVideoEndpointProviderEndpointTestCase::OperationParamsFromTest>>
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         KinesisVideoEndpointProviderTests,
                         ::testing::Range((size_t) 0u, KinesisVideoEndpointProviderTests::TEST_CASES_SZ));
