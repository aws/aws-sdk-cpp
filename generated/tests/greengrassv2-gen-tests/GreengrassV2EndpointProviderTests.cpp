...
static const char* ALLOCATION_TAG = "AWSGreengrassV2EndpointProviderTests";
...
struct GreengrassV2EndpointProviderEndpointTestCase
{
...
class GreengrassV2EndpointProviderTests : public ::testing::TestWithParam<size_t>
{
public:
    static const size_t TEST_CASES_SZ;
protected:
    static Aws::Vector<GreengrassV2EndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<GreengrassV2EndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<GreengrassV2EndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<GreengrassV2EndpointProviderEndpointTestCase>> GreengrassV2EndpointProviderTests::TEST_CASES;
const size_t GreengrassV2EndpointProviderTests::TEST_CASES_SZ = 40;

Aws::Vector<GreengrassV2EndpointProviderEndpointTestCase> GreengrassV2EndpointProviderTests::getTestCase() {

  Aws::Vector<GreengrassV2EndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
void ValidateOutcome(const ResolveEndpointOutcome& outcome, const GreengrassV2EndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(GreengrassV2EndpointProviderTests, EndpointProviderTest)
{
    ...
    const GreengrassV2EndpointProviderEndpointTestCase& TEST_CASE = TEST_CASES->at(TEST_CASE_IDX);
    SCOPED_TRACE(Aws::String("\nTEST CASE # ") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX) + ": " + TEST_CASE.documentation);
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/GreengrassV2EndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));

    std::shared_ptr<GreengrassV2EndpointProvider> endpointProvider = Aws::MakeShared<GreengrassV2EndpointProvider>(ALLOCATION_TAG);
    ASSERT_TRUE(endpointProvider) << "Failed to allocate/initialize GreengrassV2EndpointProvider";
    ...
    for(const auto& operation : TEST_CASE.operationInput)
    {
         ...
         */
        const Aws::Vector<std::reference_wrapper<const GreengrassV2EndpointProviderEndpointTestCase::OperationParamsFromTest>>
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         GreengrassV2EndpointProviderTests,
                         ::testing::Range((size_t) 0u, GreengrassV2EndpointProviderTests::TEST_CASES_SZ));
