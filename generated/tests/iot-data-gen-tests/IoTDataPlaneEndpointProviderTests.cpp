...
protected:
    static Aws::Vector<IoTDataPlaneEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<IoTDataPlaneEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<IoTDataPlaneEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<IoTDataPlaneEndpointProviderEndpointTestCase>> IoTDataPlaneEndpointProviderTests::TEST_CASES;
const size_t IoTDataPlaneEndpointProviderTests::TEST_CASES_SZ = 49;

Aws::Vector<IoTDataPlaneEndpointProviderEndpointTestCase> IoTDataPlaneEndpointProviderTests::getTestCase() {

  Aws::Vector<IoTDataPlaneEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
TEST_P(IoTDataPlaneEndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/IoTDataPlaneEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, IoTDataPlaneEndpointProviderTests::TEST_CASES_SZ));
