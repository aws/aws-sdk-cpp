...
protected:
    static Aws::Vector<ConfigServiceEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<ConfigServiceEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<ConfigServiceEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<ConfigServiceEndpointProviderEndpointTestCase>> ConfigServiceEndpointProviderTests::TEST_CASES;
const size_t ConfigServiceEndpointProviderTests::TEST_CASES_SZ = 53;

Aws::Vector<ConfigServiceEndpointProviderEndpointTestCase> ConfigServiceEndpointProviderTests::getTestCase() {

  Aws::Vector<ConfigServiceEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
void ValidateOutcome(const ResolveEndpointOutcome& outcome, const ConfigServiceEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(ConfigServiceEndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/ConfigServiceEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, ConfigServiceEndpointProviderTests::TEST_CASES_SZ));
