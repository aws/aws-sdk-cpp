...
protected:
    static Aws::Vector<ACMEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<ACMEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<ACMEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
const size_t ACMEndpointProviderTests::TEST_CASES_SZ = 52;
...
void ValidateOutcome(const ResolveEndpointOutcome& outcome, const ACMEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(ACMEndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/ACMEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, ACMEndpointProviderTests::TEST_CASES_SZ));
