...
protected:
    static Aws::Vector<EKSEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<EKSEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<EKSEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<EKSEndpointProviderEndpointTestCase>> EKSEndpointProviderTests::TEST_CASES;
const size_t EKSEndpointProviderTests::TEST_CASES_SZ = 52;

Aws::Vector<EKSEndpointProviderEndpointTestCase> EKSEndpointProviderTests::getTestCase() {

  Aws::Vector<EKSEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
void ValidateOutcome(const ResolveEndpointOutcome& outcome, const EKSEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(EKSEndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/EKSEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, EKSEndpointProviderTests::TEST_CASES_SZ));
