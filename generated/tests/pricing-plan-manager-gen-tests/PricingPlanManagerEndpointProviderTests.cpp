...
static const char* ALLOCATION_TAG = "AWSPricingPlanManagerEndpointProviderTests";
...
struct PricingPlanManagerEndpointProviderEndpointTestCase
{
...
class PricingPlanManagerEndpointProviderTests : public ::testing::TestWithParam<size_t>
{
public:
    static const size_t TEST_CASES_SZ;
protected:
    static Aws::Vector<PricingPlanManagerEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<PricingPlanManagerEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<PricingPlanManagerEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<PricingPlanManagerEndpointProviderEndpointTestCase>> PricingPlanManagerEndpointProviderTests::TEST_CASES;
const size_t PricingPlanManagerEndpointProviderTests::TEST_CASES_SZ = 3;

Aws::Vector<PricingPlanManagerEndpointProviderEndpointTestCase> PricingPlanManagerEndpointProviderTests::getTestCase() {

  Aws::Vector<PricingPlanManagerEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
  {"Resolves the us-east-1 endpoint and signs for us-east-1.", // documentation
    {EpParam("Region", "us-east-1")}, // params
    {}, // tags
    {{/*epUrl*/"https://pricingplanmanager.us-east-1.api.aws",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  /*TEST CASE 1*/
  {"Routes any other region to the us-east-1 endpoint and still signs for us-east-1.", // documentation
  ...
  /*TEST CASE 2*/
  {"A custom endpoint override wins over region resolution and signs for us-east-1.", // documentation
    {EpParam("Endpoint", "https://pricingplanmanager.us-east-1.api.aws"), EpParam("Region", "us-west-2")}, // params
    {}, // tags
    {{/*epUrl*/"https://pricingplanmanager.us-east-1.api.aws",
       {/*authScheme*/}, 
       {/*properties*/},
...
void ValidateOutcome(const ResolveEndpointOutcome& outcome, const PricingPlanManagerEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(PricingPlanManagerEndpointProviderTests, EndpointProviderTest)
{
    ...
    const PricingPlanManagerEndpointProviderEndpointTestCase& TEST_CASE = TEST_CASES->at(TEST_CASE_IDX);
    SCOPED_TRACE(Aws::String("\nTEST CASE # ") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX) + ": " + TEST_CASE.documentation);
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/PricingPlanManagerEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));

    std::shared_ptr<PricingPlanManagerEndpointProvider> endpointProvider = Aws::MakeShared<PricingPlanManagerEndpointProvider>(ALLOCATION_TAG);
    ASSERT_TRUE(endpointProvider) << "Failed to allocate/initialize PricingPlanManagerEndpointProvider";
    ...
    for(const auto& operation : TEST_CASE.operationInput)
    {
         ...
         */
        const Aws::Vector<std::reference_wrapper<const PricingPlanManagerEndpointProviderEndpointTestCase::OperationParamsFromTest>>
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, PricingPlanManagerEndpointProviderTests::TEST_CASES_SZ));
