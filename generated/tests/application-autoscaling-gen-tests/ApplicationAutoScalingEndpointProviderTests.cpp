...
protected:
    static Aws::Vector<ApplicationAutoScalingEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<ApplicationAutoScalingEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<ApplicationAutoScalingEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<ApplicationAutoScalingEndpointProviderEndpointTestCase>> ApplicationAutoScalingEndpointProviderTests::TEST_CASES;
const size_t ApplicationAutoScalingEndpointProviderTests::TEST_CASES_SZ = 46;

Aws::Vector<ApplicationAutoScalingEndpointProviderEndpointTestCase> ApplicationAutoScalingEndpointProviderTests::getTestCase() {

  Aws::Vector<ApplicationAutoScalingEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
TEST_P(ApplicationAutoScalingEndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/ApplicationAutoScalingEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, ApplicationAutoScalingEndpointProviderTests::TEST_CASES_SZ));
