...
static const char* ALLOCATION_TAG = "AWSKinesisVideoWebRTCStorageEndpointProviderTests";
...
struct KinesisVideoWebRTCStorageEndpointProviderEndpointTestCase
{
...
class KinesisVideoWebRTCStorageEndpointProviderTests : public ::testing::TestWithParam<size_t>
{
public:
    static const size_t TEST_CASES_SZ;
protected:
    static Aws::Vector<KinesisVideoWebRTCStorageEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<KinesisVideoWebRTCStorageEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<KinesisVideoWebRTCStorageEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<KinesisVideoWebRTCStorageEndpointProviderEndpointTestCase>> KinesisVideoWebRTCStorageEndpointProviderTests::TEST_CASES;
const size_t KinesisVideoWebRTCStorageEndpointProviderTests::TEST_CASES_SZ = 25;

Aws::Vector<KinesisVideoWebRTCStorageEndpointProviderEndpointTestCase> KinesisVideoWebRTCStorageEndpointProviderTests::getTestCase() {

  Aws::Vector<KinesisVideoWebRTCStorageEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
void ValidateOutcome(const ResolveEndpointOutcome& outcome, const KinesisVideoWebRTCStorageEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(KinesisVideoWebRTCStorageEndpointProviderTests, EndpointProviderTest)
{
    ...
    const KinesisVideoWebRTCStorageEndpointProviderEndpointTestCase& TEST_CASE = TEST_CASES->at(TEST_CASE_IDX);
    SCOPED_TRACE(Aws::String("\nTEST CASE # ") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX) + ": " + TEST_CASE.documentation);
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/KinesisVideoWebRTCStorageEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));

    std::shared_ptr<KinesisVideoWebRTCStorageEndpointProvider> endpointProvider = Aws::MakeShared<KinesisVideoWebRTCStorageEndpointProvider>(ALLOCATION_TAG);
    ASSERT_TRUE(endpointProvider) << "Failed to allocate/initialize KinesisVideoWebRTCStorageEndpointProvider";
    ...
    for(const auto& operation : TEST_CASE.operationInput)
    {
         ...
         */
        const Aws::Vector<std::reference_wrapper<const KinesisVideoWebRTCStorageEndpointProviderEndpointTestCase::OperationParamsFromTest>>
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         KinesisVideoWebRTCStorageEndpointProviderTests,
                         ::testing::Range((size_t) 0u, KinesisVideoWebRTCStorageEndpointProviderTests::TEST_CASES_SZ));
