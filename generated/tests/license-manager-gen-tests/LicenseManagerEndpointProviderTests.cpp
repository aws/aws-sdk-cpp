...
protected:
    static Aws::Vector<LicenseManagerEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<LicenseManagerEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<LicenseManagerEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<LicenseManagerEndpointProviderEndpointTestCase>> LicenseManagerEndpointProviderTests::TEST_CASES;
const size_t LicenseManagerEndpointProviderTests::TEST_CASES_SZ = 52;

Aws::Vector<LicenseManagerEndpointProviderEndpointTestCase> LicenseManagerEndpointProviderTests::getTestCase() {

  Aws::Vector<LicenseManagerEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
void ValidateOutcome(const ResolveEndpointOutcome& outcome, const LicenseManagerEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(LicenseManagerEndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/LicenseManagerEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, LicenseManagerEndpointProviderTests::TEST_CASES_SZ));
