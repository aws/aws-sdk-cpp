...
static const char* ALLOCATION_TAG = "AWSAreallylongverboseservicenamethatwillcreatealongpathEndpointProviderTests";
...
struct AreallylongverboseservicenamethatwillcreatealongpathEndpointProviderEndpointTestCase
{
...
class AreallylongverboseservicenamethatwillcreatealongpathEndpointProviderTests : public ::testing::TestWithParam<size_t>
{
public:
    static const size_t TEST_CASES_SZ;
protected:
    static Aws::Vector<AreallylongverboseservicenamethatwillcreatealongpathEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<AreallylongverboseservicenamethatwillcreatealongpathEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<AreallylongverboseservicenamethatwillcreatealongpathEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<AreallylongverboseservicenamethatwillcreatealongpathEndpointProviderEndpointTestCase>> AreallylongverboseservicenamethatwillcreatealongpathEndpointProviderTests::TEST_CASES;
const size_t AreallylongverboseservicenamethatwillcreatealongpathEndpointProviderTests::TEST_CASES_SZ = 17;

Aws::Vector<AreallylongverboseservicenamethatwillcreatealongpathEndpointProviderEndpointTestCase> AreallylongverboseservicenamethatwillcreatealongpathEndpointProviderTests::getTestCase() {

  Aws::Vector<AreallylongverboseservicenamethatwillcreatealongpathEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
  ...
  {"For region us-east-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://areallylongverboseservicenamethatwillcreatealongpath-fips.us-east-1.api.aws",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region us-east-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://areallylongverboseservicenamethatwillcreatealongpath.us-east-1.api.aws",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region cn-northwest-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://areallylongverboseservicenamethatwillcreatealongpath-fips.cn-northwest-1.api.amazonwebservices.com.cn",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region cn-northwest-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://areallylongverboseservicenamethatwillcreatealongpath.cn-northwest-1.api.amazonwebservices.com.cn",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region us-gov-west-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://areallylongverboseservicenamethatwillcreatealongpath-fips.us-gov-west-1.api.aws",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region us-gov-west-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://areallylongverboseservicenamethatwillcreatealongpath.us-gov-west-1.api.aws",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region us-iso-east-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://areallylongverboseservicenamethatwillcreatealongpath-fips.us-iso-east-1.c2s.ic.gov",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region us-iso-east-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://areallylongverboseservicenamethatwillcreatealongpath.us-iso-east-1.c2s.ic.gov",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region us-isob-east-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://areallylongverboseservicenamethatwillcreatealongpath-fips.us-isob-east-1.sc2s.sgov.gov",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region us-isob-east-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://areallylongverboseservicenamethatwillcreatealongpath.us-isob-east-1.sc2s.sgov.gov",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region eu-isoe-west-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://areallylongverboseservicenamethatwillcreatealongpath-fips.eu-isoe-west-1.cloud.adc-e.uk",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region eu-isoe-west-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://areallylongverboseservicenamethatwillcreatealongpath.eu-isoe-west-1.cloud.adc-e.uk",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region us-isof-south-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://areallylongverboseservicenamethatwillcreatealongpath-fips.us-isof-south-1.csp.hci.ic.gov",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region us-isof-south-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://areallylongverboseservicenamethatwillcreatealongpath.us-isof-south-1.csp.hci.ic.gov",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
...
void ValidateOutcome(const ResolveEndpointOutcome& outcome, const AreallylongverboseservicenamethatwillcreatealongpathEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(AreallylongverboseservicenamethatwillcreatealongpathEndpointProviderTests, EndpointProviderTest)
{
    ...
    const AreallylongverboseservicenamethatwillcreatealongpathEndpointProviderEndpointTestCase& TEST_CASE = TEST_CASES->at(TEST_CASE_IDX);
    SCOPED_TRACE(Aws::String("\nTEST CASE # ") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX) + ": " + TEST_CASE.documentation);
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/AreallylongverboseservicenamethatwillcreatealongpathEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));

    std::shared_ptr<AreallylongverboseservicenamethatwillcreatealongpathEndpointProvider> endpointProvider = Aws::MakeShared<AreallylongverboseservicenamethatwillcreatealongpathEndpointProvider>(ALLOCATION_TAG);
    ASSERT_TRUE(endpointProvider) << "Failed to allocate/initialize AreallylongverboseservicenamethatwillcreatealongpathEndpointProvider";
    ...
    for(const auto& operation : TEST_CASE.operationInput)
    {
         ...
         */
        const Aws::Vector<std::reference_wrapper<const AreallylongverboseservicenamethatwillcreatealongpathEndpointProviderEndpointTestCase::OperationParamsFromTest>>
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         AreallylongverboseservicenamethatwillcreatealongpathEndpointProviderTests,
                         ::testing::Range((size_t) 0u, AreallylongverboseservicenamethatwillcreatealongpathEndpointProviderTests::TEST_CASES_SZ));
