...
protected:
    static Aws::Vector<CloudTrailEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<CloudTrailEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<CloudTrailEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<CloudTrailEndpointProviderEndpointTestCase>> CloudTrailEndpointProviderTests::TEST_CASES;
const size_t CloudTrailEndpointProviderTests::TEST_CASES_SZ = 49;

Aws::Vector<CloudTrailEndpointProviderEndpointTestCase> CloudTrailEndpointProviderTests::getTestCase() {

  Aws::Vector<CloudTrailEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
TEST_P(CloudTrailEndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/CloudTrailEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, CloudTrailEndpointProviderTests::TEST_CASES_SZ));
