...
protected:
    static Aws::Vector<SNSEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<SNSEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<SNSEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<SNSEndpointProviderEndpointTestCase>> SNSEndpointProviderTests::TEST_CASES;
const size_t SNSEndpointProviderTests::TEST_CASES_SZ = 49;

Aws::Vector<SNSEndpointProviderEndpointTestCase> SNSEndpointProviderTests::getTestCase() {

  Aws::Vector<SNSEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
TEST_P(SNSEndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/SNSEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, SNSEndpointProviderTests::TEST_CASES_SZ));
