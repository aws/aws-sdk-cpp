...
static const char* ALLOCATION_TAG = "AWSPartnerCentralRevenueMeasurementEndpointProviderTests";
using PartnerCentralRevenueMeasurementEndpointProvider = Aws::PartnerCentralRevenueMeasurement::Endpoint::PartnerCentralRevenueMeasurementEndpointProvider;
...
struct PartnerCentralRevenueMeasurementEndpointProviderEndpointTestCase
{
...
class PartnerCentralRevenueMeasurementEndpointProviderTests : public ::testing::TestWithParam<size_t>
{
public:
    static const size_t TEST_CASES_SZ;
protected:
    static Aws::Vector<PartnerCentralRevenueMeasurementEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<PartnerCentralRevenueMeasurementEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<PartnerCentralRevenueMeasurementEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<PartnerCentralRevenueMeasurementEndpointProviderEndpointTestCase>> PartnerCentralRevenueMeasurementEndpointProviderTests::TEST_CASES;
const size_t PartnerCentralRevenueMeasurementEndpointProviderTests::TEST_CASES_SZ = 9;

Aws::Vector<PartnerCentralRevenueMeasurementEndpointProviderEndpointTestCase> PartnerCentralRevenueMeasurementEndpointProviderTests::getTestCase() {

  Aws::Vector<PartnerCentralRevenueMeasurementEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
  ...
  {"For region us-east-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://partnercentral-prm-fips.global.api.aws",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region us-east-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://partnercentral-prm.global.api.aws",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region cn-northwest-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://partnercentral-prm-fips.global.api.amazonwebservices.com.cn",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region cn-northwest-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://partnercentral-prm.global.api.amazonwebservices.com.cn",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region us-gov-west-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://partnercentral-prm-fips.us-gov.api.aws",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region us-gov-west-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://partnercentral-prm.us-gov.api.aws",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
...
void ValidateOutcome(const ResolveEndpointOutcome& outcome, const PartnerCentralRevenueMeasurementEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(PartnerCentralRevenueMeasurementEndpointProviderTests, EndpointProviderTest)
{
    ...
    const PartnerCentralRevenueMeasurementEndpointProviderEndpointTestCase& TEST_CASE = TEST_CASES->at(TEST_CASE_IDX);
    SCOPED_TRACE(Aws::String("\nTEST CASE # ") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX) + ": " + TEST_CASE.documentation);
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/PartnerCentralRevenueMeasurementEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));

    std::shared_ptr<PartnerCentralRevenueMeasurementEndpointProvider> endpointProvider = Aws::MakeShared<PartnerCentralRevenueMeasurementEndpointProvider>(ALLOCATION_TAG);
    ASSERT_TRUE(endpointProvider) << "Failed to allocate/initialize PartnerCentralRevenueMeasurementEndpointProvider";
    ...
    for(const auto& operation : TEST_CASE.operationInput)
    {
         ...
         */
        const Aws::Vector<std::reference_wrapper<const PartnerCentralRevenueMeasurementEndpointProviderEndpointTestCase::OperationParamsFromTest>>
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         PartnerCentralRevenueMeasurementEndpointProviderTests,
                         ::testing::Range((size_t) 0u, PartnerCentralRevenueMeasurementEndpointProviderTests::TEST_CASES_SZ));
