...
protected:
    static Aws::Vector<DocDBEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<DocDBEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<DocDBEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<DocDBEndpointProviderEndpointTestCase>> DocDBEndpointProviderTests::TEST_CASES;
const size_t DocDBEndpointProviderTests::TEST_CASES_SZ = 54;

Aws::Vector<DocDBEndpointProviderEndpointTestCase> DocDBEndpointProviderTests::getTestCase() {

  Aws::Vector<DocDBEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
void ValidateOutcome(const ResolveEndpointOutcome& outcome, const DocDBEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(DocDBEndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/DocDBEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, DocDBEndpointProviderTests::TEST_CASES_SZ));
