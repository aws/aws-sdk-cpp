...
static const char* ALLOCATION_TAG = "AWSAgentRegistryEndpointProviderTests";
...
struct AgentRegistryEndpointProviderEndpointTestCase
{
...
class AgentRegistryEndpointProviderTests : public ::testing::TestWithParam<size_t>
{
public:
    static const size_t TEST_CASES_SZ;
protected:
    static Aws::Vector<AgentRegistryEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<AgentRegistryEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<AgentRegistryEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<AgentRegistryEndpointProviderEndpointTestCase>> AgentRegistryEndpointProviderTests::TEST_CASES;
const size_t AgentRegistryEndpointProviderTests::TEST_CASES_SZ = 3;

Aws::Vector<AgentRegistryEndpointProviderEndpointTestCase> AgentRegistryEndpointProviderTests::getTestCase() {

  Aws::Vector<AgentRegistryEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
  {"Region us-west-2 -> region-based prod host.", // documentation
    {EpParam("Region", "us-west-2")}, // params
    {}, // tags
    {{/*epUrl*/"https://agent-registry.us-west-2.api.aws",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  /*TEST CASE 1*/
  {"Region us-east-1 -> region-based prod host.", // documentation
    {EpParam("Region", "us-east-1")}, // params
    {}, // tags
    {{/*epUrl*/"https://agent-registry.us-east-1.api.aws",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  /*TEST CASE 2*/
  {"Endpoint override wins over region.", // documentation
    {EpParam("Endpoint", "https://custom.example.aws.dev"), EpParam("Region", "us-west-2")}, // params
    {}, // tags
    {{/*epUrl*/"https://custom.example.aws.dev",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  }
...
void ValidateOutcome(const ResolveEndpointOutcome& outcome, const AgentRegistryEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(AgentRegistryEndpointProviderTests, EndpointProviderTest)
{
    ...
    const AgentRegistryEndpointProviderEndpointTestCase& TEST_CASE = TEST_CASES->at(TEST_CASE_IDX);
    SCOPED_TRACE(Aws::String("\nTEST CASE # ") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX) + ": " + TEST_CASE.documentation);
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/AgentRegistryEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));

    std::shared_ptr<AgentRegistryEndpointProvider> endpointProvider = Aws::MakeShared<AgentRegistryEndpointProvider>(ALLOCATION_TAG);
    ASSERT_TRUE(endpointProvider) << "Failed to allocate/initialize AgentRegistryEndpointProvider";
    ...
    for(const auto& operation : TEST_CASE.operationInput)
    {
         ...
         */
        const Aws::Vector<std::reference_wrapper<const AgentRegistryEndpointProviderEndpointTestCase::OperationParamsFromTest>>
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         AgentRegistryEndpointProviderTests,
                         ::testing::Range((size_t) 0u, AgentRegistryEndpointProviderTests::TEST_CASES_SZ));
