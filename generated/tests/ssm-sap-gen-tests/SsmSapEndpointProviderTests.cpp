...
protected:
    static Aws::Vector<SsmSapEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<SsmSapEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<SsmSapEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<SsmSapEndpointProviderEndpointTestCase>> SsmSapEndpointProviderTests::TEST_CASES;
const size_t SsmSapEndpointProviderTests::TEST_CASES_SZ = 21;

Aws::Vector<SsmSapEndpointProviderEndpointTestCase> SsmSapEndpointProviderTests::getTestCase() {

  Aws::Vector<SsmSapEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
TEST_P(SsmSapEndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/SsmSapEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, SsmSapEndpointProviderTests::TEST_CASES_SZ));
