...
static const char* ALLOCATION_TAG = "AWSResiliencehubv2EndpointProviderTests";
...
struct Resiliencehubv2EndpointProviderEndpointTestCase
{
...
class Resiliencehubv2EndpointProviderTests : public ::testing::TestWithParam<size_t>
{
public:
    static const size_t TEST_CASES_SZ;
protected:
    static Aws::Vector<Resiliencehubv2EndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<Resiliencehubv2EndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<Resiliencehubv2EndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<Resiliencehubv2EndpointProviderEndpointTestCase>> Resiliencehubv2EndpointProviderTests::TEST_CASES;
const size_t Resiliencehubv2EndpointProviderTests::TEST_CASES_SZ = 21;

Aws::Vector<Resiliencehubv2EndpointProviderEndpointTestCase> Resiliencehubv2EndpointProviderTests::getTestCase() {

  Aws::Vector<Resiliencehubv2EndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
void ValidateOutcome(const ResolveEndpointOutcome& outcome, const Resiliencehubv2EndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(Resiliencehubv2EndpointProviderTests, EndpointProviderTest)
{
    ...
    const Resiliencehubv2EndpointProviderEndpointTestCase& TEST_CASE = TEST_CASES->at(TEST_CASE_IDX);
    SCOPED_TRACE(Aws::String("\nTEST CASE # ") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX) + ": " + TEST_CASE.documentation);
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/Resiliencehubv2EndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));

    std::shared_ptr<Resiliencehubv2EndpointProvider> endpointProvider = Aws::MakeShared<Resiliencehubv2EndpointProvider>(ALLOCATION_TAG);
    ASSERT_TRUE(endpointProvider) << "Failed to allocate/initialize Resiliencehubv2EndpointProvider";
    ...
    for(const auto& operation : TEST_CASE.operationInput)
    {
         ...
         */
        const Aws::Vector<std::reference_wrapper<const Resiliencehubv2EndpointProviderEndpointTestCase::OperationParamsFromTest>>
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         Resiliencehubv2EndpointProviderTests,
                         ::testing::Range((size_t) 0u, Resiliencehubv2EndpointProviderTests::TEST_CASES_SZ));
