...
const size_t ECREndpointProviderTests::TEST_CASES_SZ = 7;
...
Aws::Vector<ECREndpointProviderEndpointTestCase> ECREndpointProviderTests::getTestCase() {
  ...
  /*TEST CASE 2*/
  {"Valid with FIPS set, dualstack disabled", // documentation
  ...
  /*TEST CASE 3*/
  {"Valid with both dualstack and FIPS enabled", // documentation
  ...
  /*TEST CASE 4*/
  {"Valid with both dualstack and FIPS disabled (Govcloud)", // documentation
  ...
  /*TEST CASE 6*/
  {"Invalid with DualStack enabled and FIPS enabled and partition does not support one/either", // documentation
