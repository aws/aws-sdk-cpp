...
protected:
    static Aws::Vector<IoTJobsDataPlaneEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<IoTJobsDataPlaneEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<IoTJobsDataPlaneEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<IoTJobsDataPlaneEndpointProviderEndpointTestCase>> IoTJobsDataPlaneEndpointProviderTests::TEST_CASES;
const size_t IoTJobsDataPlaneEndpointProviderTests::TEST_CASES_SZ = 49;

Aws::Vector<IoTJobsDataPlaneEndpointProviderEndpointTestCase> IoTJobsDataPlaneEndpointProviderTests::getTestCase() {

  Aws::Vector<IoTJobsDataPlaneEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
void ValidateOutcome(const ResolveEndpointOutcome& outcome, const IoTJobsDataPlaneEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(IoTJobsDataPlaneEndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/IoTJobsDataPlaneEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, IoTJobsDataPlaneEndpointProviderTests::TEST_CASES_SZ));
