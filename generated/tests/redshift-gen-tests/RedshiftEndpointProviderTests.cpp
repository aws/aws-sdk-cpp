...
protected:
    static Aws::Vector<RedshiftEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<RedshiftEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<RedshiftEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<RedshiftEndpointProviderEndpointTestCase>> RedshiftEndpointProviderTests::TEST_CASES;
const size_t RedshiftEndpointProviderTests::TEST_CASES_SZ = 50;

Aws::Vector<RedshiftEndpointProviderEndpointTestCase> RedshiftEndpointProviderTests::getTestCase() {

  Aws::Vector<RedshiftEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
TEST_P(RedshiftEndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/RedshiftEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, RedshiftEndpointProviderTests::TEST_CASES_SZ));
