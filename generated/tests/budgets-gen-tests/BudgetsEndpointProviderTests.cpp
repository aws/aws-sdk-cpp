...
static const Aws::Vector<BudgetsEndpointProviderEndpointTestCase> TEST_CASES = {
  ...
  {"For region us-east-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://budgets.us-east-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  /*TEST CASE 4*/
...
void ValidateOutcome(const ResolveEndpointOutcome& outcome, const BudgetsEndpointProviderEndpointTestCase::Expect& expect)
{
