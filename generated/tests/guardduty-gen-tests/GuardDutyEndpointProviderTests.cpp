...
protected:
    static Aws::Vector<GuardDutyEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<GuardDutyEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<GuardDutyEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<GuardDutyEndpointProviderEndpointTestCase>> GuardDutyEndpointProviderTests::TEST_CASES;
const size_t GuardDutyEndpointProviderTests::TEST_CASES_SZ = 48;

Aws::Vector<GuardDutyEndpointProviderEndpointTestCase> GuardDutyEndpointProviderTests::getTestCase() {

  Aws::Vector<GuardDutyEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
TEST_P(GuardDutyEndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/GuardDutyEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, GuardDutyEndpointProviderTests::TEST_CASES_SZ));
