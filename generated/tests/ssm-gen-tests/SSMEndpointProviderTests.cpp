...
protected:
    static Aws::Vector<SSMEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<SSMEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<SSMEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<SSMEndpointProviderEndpointTestCase>> SSMEndpointProviderTests::TEST_CASES;
const size_t SSMEndpointProviderTests::TEST_CASES_SZ = 49;

Aws::Vector<SSMEndpointProviderEndpointTestCase> SSMEndpointProviderTests::getTestCase() {

  Aws::Vector<SSMEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
TEST_P(SSMEndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/SSMEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, SSMEndpointProviderTests::TEST_CASES_SZ));
