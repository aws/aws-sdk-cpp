...
protected:
    static Aws::Vector<SQSEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<SQSEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<SQSEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<SQSEndpointProviderEndpointTestCase>> SQSEndpointProviderTests::TEST_CASES;
const size_t SQSEndpointProviderTests::TEST_CASES_SZ = 48;

Aws::Vector<SQSEndpointProviderEndpointTestCase> SQSEndpointProviderTests::getTestCase() {

  Aws::Vector<SQSEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
void ValidateOutcome(const ResolveEndpointOutcome& outcome, const SQSEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(SQSEndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/SQSEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, SQSEndpointProviderTests::TEST_CASES_SZ));
