...
protected:
    static Aws::Vector<CodeDeployEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<CodeDeployEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<CodeDeployEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<CodeDeployEndpointProviderEndpointTestCase>> CodeDeployEndpointProviderTests::TEST_CASES;
const size_t CodeDeployEndpointProviderTests::TEST_CASES_SZ = 49;

Aws::Vector<CodeDeployEndpointProviderEndpointTestCase> CodeDeployEndpointProviderTests::getTestCase() {

  Aws::Vector<CodeDeployEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
void ValidateOutcome(const ResolveEndpointOutcome& outcome, const CodeDeployEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(CodeDeployEndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/CodeDeployEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, CodeDeployEndpointProviderTests::TEST_CASES_SZ));
