...
protected:
    static Aws::Vector<GlueEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<GlueEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<GlueEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<GlueEndpointProviderEndpointTestCase>> GlueEndpointProviderTests::TEST_CASES;
const size_t GlueEndpointProviderTests::TEST_CASES_SZ = 51;

Aws::Vector<GlueEndpointProviderEndpointTestCase> GlueEndpointProviderTests::getTestCase() {

  Aws::Vector<GlueEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
TEST_P(GlueEndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/GlueEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, GlueEndpointProviderTests::TEST_CASES_SZ));
