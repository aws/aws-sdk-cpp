...
protected:
    static Aws::Vector<EC2EndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<EC2EndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<EC2EndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<EC2EndpointProviderEndpointTestCase>> EC2EndpointProviderTests::TEST_CASES;
const size_t EC2EndpointProviderTests::TEST_CASES_SZ = 54;

Aws::Vector<EC2EndpointProviderEndpointTestCase> EC2EndpointProviderTests::getTestCase() {

  Aws::Vector<EC2EndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
void ValidateOutcome(const ResolveEndpointOutcome& outcome, const EC2EndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(EC2EndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/EC2EndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, EC2EndpointProviderTests::TEST_CASES_SZ));
