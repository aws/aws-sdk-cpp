...
protected:
    static Aws::Vector<SFNEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<SFNEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<SFNEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<SFNEndpointProviderEndpointTestCase>> SFNEndpointProviderTests::TEST_CASES;
const size_t SFNEndpointProviderTests::TEST_CASES_SZ = 49;

Aws::Vector<SFNEndpointProviderEndpointTestCase> SFNEndpointProviderTests::getTestCase() {

  Aws::Vector<SFNEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
TEST_P(SFNEndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/SFNEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, SFNEndpointProviderTests::TEST_CASES_SZ));
