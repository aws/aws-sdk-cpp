...
protected:
    static Aws::Vector<SignerEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<SignerEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<SignerEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<SignerEndpointProviderEndpointTestCase>> SignerEndpointProviderTests::TEST_CASES;
const size_t SignerEndpointProviderTests::TEST_CASES_SZ = 21;

Aws::Vector<SignerEndpointProviderEndpointTestCase> SignerEndpointProviderTests::getTestCase() {

  Aws::Vector<SignerEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
  ...
  {"For region us-iso-east-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://signer-fips.us-iso-east-1.c2s.ic.gov",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region us-iso-east-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://signer.us-iso-east-1.c2s.ic.gov",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region us-isob-east-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://signer-fips.us-isob-east-1.sc2s.sgov.gov",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region us-isob-east-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://signer.us-isob-east-1.sc2s.sgov.gov",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
...
TEST_P(SignerEndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/SignerEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, SignerEndpointProviderTests::TEST_CASES_SZ));
