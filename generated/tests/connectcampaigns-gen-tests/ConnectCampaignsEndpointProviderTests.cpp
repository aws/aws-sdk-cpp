...
protected:
    static Aws::Vector<ConnectCampaignsEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<ConnectCampaignsEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<ConnectCampaignsEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<ConnectCampaignsEndpointProviderEndpointTestCase>> ConnectCampaignsEndpointProviderTests::TEST_CASES;
const size_t ConnectCampaignsEndpointProviderTests::TEST_CASES_SZ = 24;

Aws::Vector<ConnectCampaignsEndpointProviderEndpointTestCase> ConnectCampaignsEndpointProviderTests::getTestCase() {

  Aws::Vector<ConnectCampaignsEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
TEST_P(ConnectCampaignsEndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/ConnectCampaignsEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, ConnectCampaignsEndpointProviderTests::TEST_CASES_SZ));
