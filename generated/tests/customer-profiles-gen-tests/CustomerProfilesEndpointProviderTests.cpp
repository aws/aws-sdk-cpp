...
protected:
    static Aws::Vector<CustomerProfilesEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<CustomerProfilesEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<CustomerProfilesEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<CustomerProfilesEndpointProviderEndpointTestCase>> CustomerProfilesEndpointProviderTests::TEST_CASES;
const size_t CustomerProfilesEndpointProviderTests::TEST_CASES_SZ = 30;

Aws::Vector<CustomerProfilesEndpointProviderEndpointTestCase> CustomerProfilesEndpointProviderTests::getTestCase() {

  Aws::Vector<CustomerProfilesEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
void ValidateOutcome(const ResolveEndpointOutcome& outcome, const CustomerProfilesEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(CustomerProfilesEndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/CustomerProfilesEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, CustomerProfilesEndpointProviderTests::TEST_CASES_SZ));
