...
protected:
    static Aws::Vector<ElasticLoadBalancingEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<ElasticLoadBalancingEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<ElasticLoadBalancingEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<ElasticLoadBalancingEndpointProviderEndpointTestCase>> ElasticLoadBalancingEndpointProviderTests::TEST_CASES;
const size_t ElasticLoadBalancingEndpointProviderTests::TEST_CASES_SZ = 53;

Aws::Vector<ElasticLoadBalancingEndpointProviderEndpointTestCase> ElasticLoadBalancingEndpointProviderTests::getTestCase() {

  Aws::Vector<ElasticLoadBalancingEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
TEST_P(ElasticLoadBalancingEndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/ElasticLoadBalancingEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, ElasticLoadBalancingEndpointProviderTests::TEST_CASES_SZ));
