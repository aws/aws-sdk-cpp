...
protected:
    static Aws::Vector<BackupEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<BackupEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<BackupEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<BackupEndpointProviderEndpointTestCase>> BackupEndpointProviderTests::TEST_CASES;
const size_t BackupEndpointProviderTests::TEST_CASES_SZ = 48;

Aws::Vector<BackupEndpointProviderEndpointTestCase> BackupEndpointProviderTests::getTestCase() {

  Aws::Vector<BackupEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
void ValidateOutcome(const ResolveEndpointOutcome& outcome, const BackupEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(BackupEndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/BackupEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, BackupEndpointProviderTests::TEST_CASES_SZ));
