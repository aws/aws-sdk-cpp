...
protected:
    static Aws::Vector<DataSyncEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<DataSyncEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<DataSyncEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<DataSyncEndpointProviderEndpointTestCase>> DataSyncEndpointProviderTests::TEST_CASES;
const size_t DataSyncEndpointProviderTests::TEST_CASES_SZ = 48;

Aws::Vector<DataSyncEndpointProviderEndpointTestCase> DataSyncEndpointProviderTests::getTestCase() {

  Aws::Vector<DataSyncEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
TEST_P(DataSyncEndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/DataSyncEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, DataSyncEndpointProviderTests::TEST_CASES_SZ));
