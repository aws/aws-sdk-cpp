...
protected:
    static Aws::Vector<KinesisAnalyticsV2EndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<KinesisAnalyticsV2EndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<KinesisAnalyticsV2EndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<KinesisAnalyticsV2EndpointProviderEndpointTestCase>> KinesisAnalyticsV2EndpointProviderTests::TEST_CASES;
const size_t KinesisAnalyticsV2EndpointProviderTests::TEST_CASES_SZ = 43;

Aws::Vector<KinesisAnalyticsV2EndpointProviderEndpointTestCase> KinesisAnalyticsV2EndpointProviderTests::getTestCase() {

  Aws::Vector<KinesisAnalyticsV2EndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
void ValidateOutcome(const ResolveEndpointOutcome& outcome, const KinesisAnalyticsV2EndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(KinesisAnalyticsV2EndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/KinesisAnalyticsV2EndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, KinesisAnalyticsV2EndpointProviderTests::TEST_CASES_SZ));
