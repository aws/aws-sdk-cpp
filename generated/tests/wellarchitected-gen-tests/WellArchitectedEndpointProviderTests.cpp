...
protected:
    static Aws::Vector<WellArchitectedEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<WellArchitectedEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<WellArchitectedEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<WellArchitectedEndpointProviderEndpointTestCase>> WellArchitectedEndpointProviderTests::TEST_CASES;
const size_t WellArchitectedEndpointProviderTests::TEST_CASES_SZ = 33;

Aws::Vector<WellArchitectedEndpointProviderEndpointTestCase> WellArchitectedEndpointProviderTests::getTestCase() {

  Aws::Vector<WellArchitectedEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
  ...
  {"For region cn-northwest-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://wellarchitected-fips.cn-northwest-1.api.amazonwebservices.com.cn",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region cn-northwest-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://wellarchitected-fips.cn-northwest-1.amazonaws.com.cn",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region cn-northwest-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://wellarchitected.cn-northwest-1.api.amazonwebservices.com.cn",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region cn-northwest-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://wellarchitected.cn-northwest-1.amazonaws.com.cn",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region eusc-de-east-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://wellarchitected-fips.eusc-de-east-1.amazonaws.eu",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region eusc-de-east-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://wellarchitected.eusc-de-east-1.amazonaws.eu",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region us-iso-east-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://wellarchitected-fips.us-iso-east-1.c2s.ic.gov",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region us-iso-east-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://wellarchitected.us-iso-east-1.c2s.ic.gov",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region us-isob-east-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://wellarchitected-fips.us-isob-east-1.sc2s.sgov.gov",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region us-isob-east-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://wellarchitected.us-isob-east-1.sc2s.sgov.gov",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region eu-isoe-west-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://wellarchitected-fips.eu-isoe-west-1.cloud.adc-e.uk",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region eu-isoe-west-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://wellarchitected.eu-isoe-west-1.cloud.adc-e.uk",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region us-isof-south-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://wellarchitected-fips.us-isof-south-1.csp.hci.ic.gov",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region us-isof-south-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://wellarchitected.us-isof-south-1.csp.hci.ic.gov",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  /*TEST CASE 26*/
  {"AGENT case: standard region, no FIPS, no DualStack -> amazonaws.com", // documentation
    {EpParam("UseFIPS", false), EpParam("Region", "us-east-1"), EpParam("SubServiceType", "AGENT"), EpParam("UseDualStack", false)}, // params
    {}, // tags
    {{/*epUrl*/"https://wellarchitected-agent.us-east-1.amazonaws.com",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  /*TEST CASE 27*/
  {"AGENT case: FIPS enabled -> amazonaws.com with -fips", // documentation
    {EpParam("UseFIPS", true), EpParam("Region", "us-east-1"), EpParam("SubServiceType", "AGENT"), EpParam("UseDualStack", false)}, // params
    {}, // tags
    {{/*epUrl*/"https://wellarchitected-agent-fips.us-east-1.amazonaws.com",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  /*TEST CASE 28*/
  {"AGENT case: DualStack enabled -> api.aws", // documentation
    {EpParam("UseFIPS", false), EpParam("Region", "us-west-2"), EpParam("SubServiceType", "AGENT"), EpParam("UseDualStack", true)}, // params
    {}, // tags
    {{/*epUrl*/"https://wellarchitected-agent.us-west-2.api.aws",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  /*TEST CASE 29*/
  {"AGENT case: FIPS + DualStack -> api.aws with -fips", // documentation
    {EpParam("UseFIPS", true), EpParam("Region", "us-east-1"), EpParam("SubServiceType", "AGENT"), EpParam("UseDualStack", true)}, // params
    {}, // tags
    {{/*epUrl*/"https://wellarchitected-agent-fips.us-east-1.api.aws",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  /*TEST CASE 30*/
  {"AGENT case: us-west-2 standard -> amazonaws.com", // documentation
    {EpParam("UseFIPS", false), EpParam("Region", "us-west-2"), EpParam("SubServiceType", "AGENT"), EpParam("UseDualStack", false)}, // params
    {}, // tags
    {{/*epUrl*/"https://wellarchitected-agent.us-west-2.amazonaws.com",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  /*TEST CASE 31*/
  {"AGENT case: custom endpoint override still works", // documentation
    {EpParam("UseFIPS", false), EpParam("Endpoint", "https://custom.endpoint.example.com"), EpParam("Region", "us-east-1"), EpParam("SubServiceType", "AGENT"),
     EpParam("UseDualStack", false)}, // params
    {}, // tags
    {{/*epUrl*/"https://custom.endpoint.example.com",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  /*TEST CASE 32*/
  {"Non-AGENT SubServiceType falls through to the base WA endpoint", // documentation
    {EpParam("UseFIPS", false), EpParam("Region", "us-east-1"), EpParam("SubServiceType", "SOMETHING-ELSE"), EpParam("UseDualStack", false)}, // params
    {}, // tags
    {{/*epUrl*/"https://wellarchitected.us-east-1.amazonaws.com",
       {/*authScheme*/}, 
       {/*properties*/},
...
void ValidateOutcome(const ResolveEndpointOutcome& outcome, const WellArchitectedEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(WellArchitectedEndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/WellArchitectedEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, WellArchitectedEndpointProviderTests::TEST_CASES_SZ));
