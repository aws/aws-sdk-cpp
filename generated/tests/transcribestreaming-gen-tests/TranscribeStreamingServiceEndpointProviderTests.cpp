...
protected:
    static Aws::Vector<TranscribeStreamingServiceEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<TranscribeStreamingServiceEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<TranscribeStreamingServiceEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<TranscribeStreamingServiceEndpointProviderEndpointTestCase>> TranscribeStreamingServiceEndpointProviderTests::TEST_CASES;
const size_t TranscribeStreamingServiceEndpointProviderTests::TEST_CASES_SZ = 33;

Aws::Vector<TranscribeStreamingServiceEndpointProviderEndpointTestCase> TranscribeStreamingServiceEndpointProviderTests::getTestCase() {

  Aws::Vector<TranscribeStreamingServiceEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
  ...
  {"For region us-isob-east-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://transcribestreaming-fips.us-isob-east-1.sc2s.sgov.gov",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  ...
  {"For region us-isob-east-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://transcribestreaming.us-isob-east-1.sc2s.sgov.gov",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
...
TEST_P(TranscribeStreamingServiceEndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/TranscribeStreamingServiceEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, TranscribeStreamingServiceEndpointProviderTests::TEST_CASES_SZ));
