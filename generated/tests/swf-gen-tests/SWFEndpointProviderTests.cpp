...
protected:
    static Aws::Vector<SWFEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<SWFEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<SWFEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<SWFEndpointProviderEndpointTestCase>> SWFEndpointProviderTests::TEST_CASES;
const size_t SWFEndpointProviderTests::TEST_CASES_SZ = 49;

Aws::Vector<SWFEndpointProviderEndpointTestCase> SWFEndpointProviderTests::getTestCase() {

  Aws::Vector<SWFEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
TEST_P(SWFEndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/SWFEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, SWFEndpointProviderTests::TEST_CASES_SZ));
