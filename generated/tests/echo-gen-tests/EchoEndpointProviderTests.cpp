...
static const char* ALLOCATION_TAG = "AWSEchoEndpointProviderTests";
...
struct EchoEndpointProviderEndpointTestCase
{
...
class EchoEndpointProviderTests : public ::testing::TestWithParam<size_t>
{
public:
    static const size_t TEST_CASES_SZ;
protected:
    static Aws::Vector<EchoEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<EchoEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<EchoEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<EchoEndpointProviderEndpointTestCase>> EchoEndpointProviderTests::TEST_CASES;
const size_t EchoEndpointProviderTests::TEST_CASES_SZ = 22;

Aws::Vector<EchoEndpointProviderEndpointTestCase> EchoEndpointProviderTests::getTestCase() {

  Aws::Vector<EchoEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
void ValidateOutcome(const ResolveEndpointOutcome& outcome, const EchoEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(EchoEndpointProviderTests, EndpointProviderTest)
{
    ...
    const EchoEndpointProviderEndpointTestCase& TEST_CASE = TEST_CASES->at(TEST_CASE_IDX);
    SCOPED_TRACE(Aws::String("\nTEST CASE # ") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX) + ": " + TEST_CASE.documentation);
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/EchoEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));

    std::shared_ptr<EchoEndpointProvider> endpointProvider = Aws::MakeShared<EchoEndpointProvider>(ALLOCATION_TAG);
    ASSERT_TRUE(endpointProvider) << "Failed to allocate/initialize EchoEndpointProvider";
    ...
    for(const auto& operation : TEST_CASE.operationInput)
    {
         ...
         */
        const Aws::Vector<std::reference_wrapper<const EchoEndpointProviderEndpointTestCase::OperationParamsFromTest>>
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         EchoEndpointProviderTests,
                         ::testing::Range((size_t) 0u, EchoEndpointProviderTests::TEST_CASES_SZ));
