...
protected:
    static Aws::Vector<DirectoryServiceEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<DirectoryServiceEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<DirectoryServiceEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<DirectoryServiceEndpointProviderEndpointTestCase>> DirectoryServiceEndpointProviderTests::TEST_CASES;
const size_t DirectoryServiceEndpointProviderTests::TEST_CASES_SZ = 52;

Aws::Vector<DirectoryServiceEndpointProviderEndpointTestCase> DirectoryServiceEndpointProviderTests::getTestCase() {

  Aws::Vector<DirectoryServiceEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
void ValidateOutcome(const ResolveEndpointOutcome& outcome, const DirectoryServiceEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(DirectoryServiceEndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/DirectoryServiceEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, DirectoryServiceEndpointProviderTests::TEST_CASES_SZ));
