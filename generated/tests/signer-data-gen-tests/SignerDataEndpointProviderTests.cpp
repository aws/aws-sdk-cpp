...
static const char* ALLOCATION_TAG = "AWSSignerDataEndpointProviderTests";
...
struct SignerDataEndpointProviderEndpointTestCase
{
...
class SignerDataEndpointProviderTests : public ::testing::TestWithParam<size_t>
{
public:
    static const size_t TEST_CASES_SZ;
protected:
    static Aws::Vector<SignerDataEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<SignerDataEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<SignerDataEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<SignerDataEndpointProviderEndpointTestCase>> SignerDataEndpointProviderTests::TEST_CASES;
const size_t SignerDataEndpointProviderTests::TEST_CASES_SZ = 5;

Aws::Vector<SignerDataEndpointProviderEndpointTestCase> SignerDataEndpointProviderTests::getTestCase() {

  Aws::Vector<SignerDataEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
  {"Standard region endpoint", // documentation
    {EpParam("Region", "us-east-1")}, // params
    {}, // tags
    {{/*epUrl*/"https://data-signer.us-east-1.amazonaws.com",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  /*TEST CASE 1*/
  {"European Sovereign Cloud region endpoint", // documentation
    {EpParam("Region", "eusc-de-east-1")}, // params
    {}, // tags
    {{/*epUrl*/"https://data-signer.eusc-de-east-1.amazonaws.eu",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  /*TEST CASE 2*/
  {"Custom endpoint override", // documentation
    {EpParam("Endpoint", "https://vpce-123.data-signer.us-east-1.vpce.amazonaws.com"), EpParam("Region", "us-east-1")}, // params
    {}, // tags
    {{/*epUrl*/"https://vpce-123.data-signer.us-east-1.vpce.amazonaws.com",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  /*TEST CASE 3*/
  {"FIPS endpoint", // documentation
    {EpParam("UseFIPS", true), EpParam("Region", "us-east-1")}, // params
    {}, // tags
    {{/*epUrl*/"https://data-signer-fips.us-east-1.amazonaws.com",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  /*TEST CASE 4*/
  {"Dual-stack endpoint", // documentation
    {EpParam("Region", "us-east-1"), EpParam("UseDualStack", true)}, // params
    {}, // tags
    {{/*epUrl*/"https://data-signer.us-east-1.api.aws",
       {/*authScheme*/}, 
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}} // expect
  }
...
void ValidateOutcome(const ResolveEndpointOutcome& outcome, const SignerDataEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(SignerDataEndpointProviderTests, EndpointProviderTest)
{
    ...
    const SignerDataEndpointProviderEndpointTestCase& TEST_CASE = TEST_CASES->at(TEST_CASE_IDX);
    SCOPED_TRACE(Aws::String("\nTEST CASE # ") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX) + ": " + TEST_CASE.documentation);
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/SignerDataEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));

    std::shared_ptr<SignerDataEndpointProvider> endpointProvider = Aws::MakeShared<SignerDataEndpointProvider>(ALLOCATION_TAG);
    ASSERT_TRUE(endpointProvider) << "Failed to allocate/initialize SignerDataEndpointProvider";
    ...
    for(const auto& operation : TEST_CASE.operationInput)
    {
         ...
         */
        const Aws::Vector<std::reference_wrapper<const SignerDataEndpointProviderEndpointTestCase::OperationParamsFromTest>>
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         SignerDataEndpointProviderTests,
                         ::testing::Range((size_t) 0u, SignerDataEndpointProviderTests::TEST_CASES_SZ));
