...
static const Aws::Vector<GreengrassEndpointProviderEndpointTestCase> TEST_CASES = {
  ...
  {"For region dataplane-us-gov-east-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {{/*epUrl*/"https://greengrass-ats.iot.us-gov-east-1.amazonaws.com",
       {/*properties*/{"authSchemes", {EpProp("signingRegion", "us-gov-east-1"), EpProp("name", "sigv4"), EpProp("signingName", "greengrass")}}},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  /*TEST CASE 20*/
  {"For region dataplane-us-gov-west-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {{/*epUrl*/"https://greengrass-ats.iot.us-gov-west-1.amazonaws.com",
       {/*properties*/{"authSchemes", {EpProp("signingRegion", "us-gov-west-1"), EpProp("name", "sigv4"), EpProp("signingName", "greengrass")}}},
       {/*headers*/}}, {/*No error*/}} // expect
  },
  /*TEST CASE 21*/
