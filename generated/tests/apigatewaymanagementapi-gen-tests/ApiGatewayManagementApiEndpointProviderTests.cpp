...
protected:
    static Aws::Vector<ApiGatewayManagementApiEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<ApiGatewayManagementApiEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<ApiGatewayManagementApiEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<ApiGatewayManagementApiEndpointProviderEndpointTestCase>> ApiGatewayManagementApiEndpointProviderTests::TEST_CASES;
const size_t ApiGatewayManagementApiEndpointProviderTests::TEST_CASES_SZ = 25;

Aws::Vector<ApiGatewayManagementApiEndpointProviderEndpointTestCase> ApiGatewayManagementApiEndpointProviderTests::getTestCase() {

  Aws::Vector<ApiGatewayManagementApiEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
TEST_P(ApiGatewayManagementApiEndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/ApiGatewayManagementApiEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, ApiGatewayManagementApiEndpointProviderTests::TEST_CASES_SZ));
