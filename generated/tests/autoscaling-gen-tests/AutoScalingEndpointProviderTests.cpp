...
protected:
    static Aws::Vector<AutoScalingEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<AutoScalingEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<AutoScalingEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<AutoScalingEndpointProviderEndpointTestCase>> AutoScalingEndpointProviderTests::TEST_CASES;
const size_t AutoScalingEndpointProviderTests::TEST_CASES_SZ = 45;

Aws::Vector<AutoScalingEndpointProviderEndpointTestCase> AutoScalingEndpointProviderTests::getTestCase() {

  Aws::Vector<AutoScalingEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
void ValidateOutcome(const ResolveEndpointOutcome& outcome, const AutoScalingEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(AutoScalingEndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/AutoScalingEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, AutoScalingEndpointProviderTests::TEST_CASES_SZ));
