...
protected:
    static Aws::Vector<MQEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<MQEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<MQEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<MQEndpointProviderEndpointTestCase>> MQEndpointProviderTests::TEST_CASES;
const size_t MQEndpointProviderTests::TEST_CASES_SZ = 52;

Aws::Vector<MQEndpointProviderEndpointTestCase> MQEndpointProviderTests::getTestCase() {

  Aws::Vector<MQEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
void ValidateOutcome(const ResolveEndpointOutcome& outcome, const MQEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(MQEndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/MQEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, MQEndpointProviderTests::TEST_CASES_SZ));
