...
protected:
    static Aws::Vector<CloudWatchLogsEndpointProviderEndpointTestCase> getTestCase();
    static Aws::UniquePtrSafeDeleted<Aws::Vector<CloudWatchLogsEndpointProviderEndpointTestCase>> TEST_CASES;
    static void SetUpTestSuite()
    {
        TEST_CASES = Aws::MakeUniqueSafeDeleted<Aws::Vector<CloudWatchLogsEndpointProviderEndpointTestCase>>(ALLOCATION_TAG, getTestCase());
...
Aws::UniquePtrSafeDeleted<Aws::Vector<CloudWatchLogsEndpointProviderEndpointTestCase>> CloudWatchLogsEndpointProviderTests::TEST_CASES;
const size_t CloudWatchLogsEndpointProviderTests::TEST_CASES_SZ = 53;

Aws::Vector<CloudWatchLogsEndpointProviderEndpointTestCase> CloudWatchLogsEndpointProviderTests::getTestCase() {

  Aws::Vector<CloudWatchLogsEndpointProviderEndpointTestCase> test_cases = {
  /*TEST CASE 0*/
...
void ValidateOutcome(const ResolveEndpointOutcome& outcome, const CloudWatchLogsEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(CloudWatchLogsEndpointProviderTests, EndpointProviderTest)
{
    ...
    SCOPED_TRACE(Aws::String("\n--gtest_filter=EndpointTestsFromModel/CloudWatchLogsEndpointProviderTests.EndpointProviderTest/") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX));
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         ...
                         ::testing::Range((size_t) 0u, CloudWatchLogsEndpointProviderTests::TEST_CASES_SZ));
