...
Aws::String DescribeCustomAvailabilityZonesRequest::SerializePayload() const
{
  Aws::StringStream ss;
  ss << "Action=DescribeCustomAvailabilityZones&";
...
void  DescribeCustomAvailabilityZonesRequest::DumpBodyToUrl(Aws::Http::URI& uri ) const
{
