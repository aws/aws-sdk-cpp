...
Aws::String DescribeInstallationMediaRequest::SerializePayload() const
{
  Aws::StringStream ss;
  ss << "Action=DescribeInstallationMedia&";
...
void  DescribeInstallationMediaRequest::DumpBodyToUrl(Aws::Http::URI& uri ) const
{
