...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_LEXMODELSV2_API CustomVocabularyImportSpecification
  {
  public:
    CustomVocabularyImportSpecification();
    CustomVocabularyImportSpecification(Aws::Utils::Json::JsonView jsonValue);
    CustomVocabularyImportSpecification& operator=(Aws::Utils::Json::JsonView jsonValue);
