...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CHIMESDKMEDIAPIPELINES_API GridViewConfiguration
  {
  public:
    GridViewConfiguration();
    GridViewConfiguration(Aws::Utils::Json::JsonView jsonValue);
    GridViewConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
