...
CreateEndpointConfigResult::CreateEndpointConfigResult()
{
}

CreateEndpointConfigResult::CreateEndpointConfigResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
