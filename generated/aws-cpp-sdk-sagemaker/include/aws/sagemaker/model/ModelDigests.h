...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SAGEMAKER_API ModelDigests
  {
  public:
    ModelDigests();
    ModelDigests(Aws::Utils::Json::JsonView jsonValue);
    ModelDigests& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  private:
    ...
    bool m_artifactDigestHasBeenSet;
  };
