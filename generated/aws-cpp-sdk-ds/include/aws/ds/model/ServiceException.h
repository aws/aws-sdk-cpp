...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_DIRECTORYSERVICE_API ServiceException
  {
  public:
    ServiceException();
    ...
    inline ServiceException& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ServiceException& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ServiceException& WithRequestId(const char* value) { SetRequestId(value); return *this;}
