...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SNOWDEVICEMANAGEMENT_API SoftwareInformation
  {
  public:
    SoftwareInformation();
    SoftwareInformation(Aws::Utils::Json::JsonView jsonValue);
    SoftwareInformation& operator=(Aws::Utils::Json::JsonView jsonValue);
