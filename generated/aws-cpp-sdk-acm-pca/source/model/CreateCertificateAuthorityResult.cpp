...
CreateCertificateAuthorityResult::CreateCertificateAuthorityResult()
{
}

CreateCertificateAuthorityResult::CreateCertificateAuthorityResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
