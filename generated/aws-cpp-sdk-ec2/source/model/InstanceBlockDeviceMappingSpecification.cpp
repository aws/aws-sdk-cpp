...
InstanceBlockDeviceMappingSpecification& InstanceBlockDeviceMappingSpecification::operator =(const XmlNode& xmlNode)
{
...
void InstanceBlockDeviceMappingSpecification::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const
{
...
void InstanceBlockDeviceMappingSpecification::OutputToStream(Aws::OStream& oStream, const char* location) const
{
  if(m_deviceNameHasBeenSet)
  {
