...
VCpuCountRange& VCpuCountRange::operator =(const XmlNode& xmlNode)
{
...
void VCpuCountRange::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const
{
  if(m_minHasBeenSet)
  {
...
void VCpuCountRange::OutputToStream(Aws::OStream& oStream, const char* location) const
{
  if(m_minHasBeenSet)
  {
