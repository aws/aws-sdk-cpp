...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsRequest : public EC2Request
  {
  public:
  ...
  private:
    ...
    bool m_localGatewayRouteTableVirtualInterfaceGroupAssociationIdsHasBeenSet;
