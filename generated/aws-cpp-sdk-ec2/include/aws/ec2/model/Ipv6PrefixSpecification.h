...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API Ipv6PrefixSpecification
  {
  public:
    Ipv6PrefixSpecification();
    Ipv6PrefixSpecification(const Aws::Utils::Xml::XmlNode& xmlNode);
    Ipv6PrefixSpecification& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
