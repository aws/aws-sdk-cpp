...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API InstanceMaintenanceOptionsRequest
  {
  public:
    InstanceMaintenanceOptionsRequest();
    InstanceMaintenanceOptionsRequest(const Aws::Utils::Xml::XmlNode& xmlNode);
    InstanceMaintenanceOptionsRequest& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
