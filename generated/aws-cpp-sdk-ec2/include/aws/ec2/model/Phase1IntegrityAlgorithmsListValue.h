...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API Phase1IntegrityAlgorithmsListValue
  {
  public:
    Phase1IntegrityAlgorithmsListValue();
    Phase1IntegrityAlgorithmsListValue(const Aws::Utils::Xml::XmlNode& xmlNode);
    Phase1IntegrityAlgorithmsListValue& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
