...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CLOUDWATCHEVIDENTLY_API MetricMonitor
  {
  public:
    MetricMonitor();
    MetricMonitor(Aws::Utils::Json::JsonView jsonValue);
    MetricMonitor& operator=(Aws::Utils::Json::JsonView jsonValue);
