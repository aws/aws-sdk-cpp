...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CLOUDWATCHEVIDENTLY_API MetricMonitorConfig
  {
  public:
    MetricMonitorConfig();
    MetricMonitorConfig(Aws::Utils::Json::JsonView jsonValue);
    MetricMonitorConfig& operator=(Aws::Utils::Json::JsonView jsonValue);
