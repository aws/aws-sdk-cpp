...
namespace JSONRPC10
{
const size_t JSONRPC10EndpointRules::RulesBlobStrLen = 1086;
const size_t JSONRPC10EndpointRules::RulesBlobSize = 1087;
...
const char* JSONRPC10EndpointRules::GetRulesBlob()
{
