...
MyUnion::MyUnion() : 
    ...
    m_intEnumValue(0),
    m_intEnumValueHasBeenSet(false),
...
MyUnion& MyUnion::operator =(JsonView jsonValue)
{
  ...
  if(jsonValue.ValueExists("intEnumValue"))
  {
    m_intEnumValue = jsonValue.GetInteger("intEnumValue");
...
JsonValue MyUnion::Jsonize() const
{
  ...
  if(m_intEnumValueHasBeenSet)
  {
   payload.WithInteger("intEnumValue", m_intEnumValue);
