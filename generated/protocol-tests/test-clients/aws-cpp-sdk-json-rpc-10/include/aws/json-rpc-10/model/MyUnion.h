...
namespace Model
{
  ...
  public:
    ...
    inline void SetIntEnumValue(int value) { m_intEnumValueHasBeenSet = true; m_intEnumValue = value; }
    inline MyUnion& WithIntEnumValue(int value) { SetIntEnumValue(value); return *this;}
    ///@}
