...
{
const size_t JsonProtocolEndpointRules::RulesBlobStrLen = 1086;
const size_t JsonProtocolEndpointRules::RulesBlobSize = 1087;
...
const char* JsonProtocolEndpointRules::GetRulesBlob()
{
