...
namespace Model
{
   ...
   * Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/json-protocol-2018-01-01/MyUnion">AWS
   * API Reference</a></p>
   */
  class MyUnion
  {
  public:
    AWS_JSONPROTOCOL_API MyUnion() = default;
    AWS_JSONPROTOCOL_API MyUnion(Aws::Utils::Json::JsonView jsonValue);
    ...
    template<typename StringValueT = Aws::String>
    MyUnion& WithStringValue(StringValueT&& value) { SetStringValue(std::forward<StringValueT>(value)); return *this;}
    ///@}
    ...
    template<typename BlobValueT = Aws::Utils::ByteBuffer>
    MyUnion& WithBlobValue(BlobValueT&& value) { SetBlobValue(std::forward<BlobValueT>(value)); return *this;}
    ///@}
    ...
    void SetTimestampValue(TimestampValueT&& value) { m_timestampValueHasBeenSet = true; m_timestampValue = std::forward<TimestampValueT>(value); }
    template<typename TimestampValueT = Aws::Utils::DateTime>
    MyUnion& WithTimestampValue(TimestampValueT&& value) { SetTimestampValue(std::forward<TimestampValueT>(value)); return *this;}
    ///@}
    ...
    inline void SetEnumValue(FooEnum value) { m_enumValueHasBeenSet = true; m_enumValue = value; }
    inline MyUnion& WithEnumValue(FooEnum value) { SetEnumValue(value); return *this;}
    ///@}
    ...
    template<typename ListValueT = Aws::Vector<Aws::String>>
    MyUnion& WithListValue(ListValueT&& value) { SetListValue(std::forward<ListValueT>(value)); return *this;}
    template<typename ListValueT = Aws::String>
    MyUnion& AddListValue(ListValueT&& value) { m_listValueHasBeenSet = true; m_listValue.emplace_back(std::forward<ListValueT>(value)); return *this; }
    ///@}
    ...
    template<typename MapValueT = Aws::Map<Aws::String, Aws::String>>
    MyUnion& WithMapValue(MapValueT&& value) { SetMapValue(std::forward<MapValueT>(value)); return *this;}
    ...
    void SetStructureValue(StructureValueT&& value) { m_structureValueHasBeenSet = true; m_structureValue = std::forward<StructureValueT>(value); }
    template<typename StructureValueT = GreetingStruct>
    MyUnion& WithStructureValue(StructureValueT&& value) { SetStructureValue(std::forward<StructureValueT>(value)); return *this;}
    ///@}
  private:
