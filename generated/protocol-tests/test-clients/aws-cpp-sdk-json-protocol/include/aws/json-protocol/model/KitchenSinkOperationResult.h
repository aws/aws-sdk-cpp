...
namespace Model
{
  ...
  public:
    ...
    void SetBlob(BlobT&& value) { m_blob = std::forward<BlobT>(value); }
    template<typename BlobT = Aws::Utils::ByteBuffer>
    KitchenSinkOperationResult& WithBlob(BlobT&& value) { SetBlob(std::forward<BlobT>(value)); return *this;}
    ///@}
    ...
    void SetEmptyStruct(EmptyStructT&& value) { m_emptyStruct = std::forward<EmptyStructT>(value); }
    template<typename EmptyStructT = EmptyStruct>
    KitchenSinkOperationResult& WithEmptyStruct(EmptyStructT&& value) { SetEmptyStruct(std::forward<EmptyStructT>(value)); return *this;}
    ///@}
    ...
    void SetHttpdateTimestamp(HttpdateTimestampT&& value) { m_httpdateTimestamp = std::forward<HttpdateTimestampT>(value); }
    template<typename HttpdateTimestampT = Aws::Utils::DateTime>
    KitchenSinkOperationResult& WithHttpdateTimestamp(HttpdateTimestampT&& value) { SetHttpdateTimestamp(std::forward<HttpdateTimestampT>(value)); return *this;}
    ///@}
    ...
    void SetIso8601Timestamp(Iso8601TimestampT&& value) { m_iso8601Timestamp = std::forward<Iso8601TimestampT>(value); }
    template<typename Iso8601TimestampT = Aws::Utils::DateTime>
    KitchenSinkOperationResult& WithIso8601Timestamp(Iso8601TimestampT&& value) { SetIso8601Timestamp(std::forward<Iso8601TimestampT>(value)); return *this;}
    ///@}
    ...
    void SetJsonValue(JsonValueT&& value) { m_jsonValue = std::forward<JsonValueT>(value); }
    template<typename JsonValueT = Aws::String>
    KitchenSinkOperationResult& WithJsonValue(JsonValueT&& value) { SetJsonValue(std::forward<JsonValueT>(value)); return *this;}
    ///@}
    ...
    void SetListOfLists(ListOfListsT&& value) { m_listOfLists = std::forward<ListOfListsT>(value); }
    template<typename ListOfListsT = Aws::Vector<Aws::Vector<Aws::String>>>
    KitchenSinkOperationResult& WithListOfLists(ListOfListsT&& value) { SetListOfLists(std::forward<ListOfListsT>(value)); return *this;}
    template<typename ListOfListsT = Aws::Vector<Aws::String>>
    KitchenSinkOperationResult& AddListOfLists(ListOfListsT&& value) { m_listOfLists.emplace_back(std::forward<ListOfListsT>(value)); return *this; }
    ///@}
    ...
    void SetListOfMapsOfStrings(ListOfMapsOfStringsT&& value) { m_listOfMapsOfStrings = std::forward<ListOfMapsOfStringsT>(value); }
    template<typename ListOfMapsOfStringsT = Aws::Vector<Aws::Map<Aws::String, Aws::String>>>
    KitchenSinkOperationResult& WithListOfMapsOfStrings(ListOfMapsOfStringsT&& value) { SetListOfMapsOfStrings(std::forward<ListOfMapsOfStringsT>(value)); return *this;}
    template<typename ListOfMapsOfStringsT = Aws::Map<Aws::String, Aws::String>>
    KitchenSinkOperationResult& AddListOfMapsOfStrings(ListOfMapsOfStringsT&& value) { m_listOfMapsOfStrings.emplace_back(std::forward<ListOfMapsOfStringsT>(value)); return *this; }
    ///@}
    ...
    void SetListOfStrings(ListOfStringsT&& value) { m_listOfStrings = std::forward<ListOfStringsT>(value); }
    template<typename ListOfStringsT = Aws::Vector<Aws::String>>
    KitchenSinkOperationResult& WithListOfStrings(ListOfStringsT&& value) { SetListOfStrings(std::forward<ListOfStringsT>(value)); return *this;}
    template<typename ListOfStringsT = Aws::String>
    KitchenSinkOperationResult& AddListOfStrings(ListOfStringsT&& value) { m_listOfStrings.emplace_back(std::forward<ListOfStringsT>(value)); return *this; }
    ///@}
    ...
    void SetListOfStructs(ListOfStructsT&& value) { m_listOfStructs = std::forward<ListOfStructsT>(value); }
    template<typename ListOfStructsT = Aws::Vector<SimpleStruct>>
    KitchenSinkOperationResult& WithListOfStructs(ListOfStructsT&& value) { SetListOfStructs(std::forward<ListOfStructsT>(value)); return *this;}
    template<typename ListOfStructsT = SimpleStruct>
    KitchenSinkOperationResult& AddListOfStructs(ListOfStructsT&& value) { m_listOfStructs.emplace_back(std::forward<ListOfStructsT>(value)); return *this; }
    ///@}
    ...
    void SetMapOfListsOfStrings(MapOfListsOfStringsT&& value) { m_mapOfListsOfStrings = std::forward<MapOfListsOfStringsT>(value); }
    template<typename MapOfListsOfStringsT = Aws::Map<Aws::String, Aws::Vector<Aws::String>>>
    KitchenSinkOperationResult& WithMapOfListsOfStrings(MapOfListsOfStringsT&& value) { SetMapOfListsOfStrings(std::forward<MapOfListsOfStringsT>(value)); return *this;}
    ...
    KitchenSinkOperationResult& AddMapOfListsOfStrings(MapOfListsOfStringsKeyT&& key, MapOfListsOfStringsValueT&& value) {
      m_mapOfListsOfStrings.emplace(std::forward<MapOfListsOfStringsKeyT>(key), std::forward<MapOfListsOfStringsValueT>(value)); return *this;
    }
    ///@}
    ...
    void SetMapOfMaps(MapOfMapsT&& value) { m_mapOfMaps = std::forward<MapOfMapsT>(value); }
    template<typename MapOfMapsT = Aws::Map<Aws::String, Aws::Map<Aws::String, Aws::String>>>
    KitchenSinkOperationResult& WithMapOfMaps(MapOfMapsT&& value) { SetMapOfMaps(std::forward<MapOfMapsT>(value)); return *this;}
    ...
    KitchenSinkOperationResult& AddMapOfMaps(MapOfMapsKeyT&& key, MapOfMapsValueT&& value) {
      m_mapOfMaps.emplace(std::forward<MapOfMapsKeyT>(key), std::forward<MapOfMapsValueT>(value)); return *this;
    }
    ///@}
    ...
    void SetMapOfStrings(MapOfStringsT&& value) { m_mapOfStrings = std::forward<MapOfStringsT>(value); }
    template<typename MapOfStringsT = Aws::Map<Aws::String, Aws::String>>
    KitchenSinkOperationResult& WithMapOfStrings(MapOfStringsT&& value) { SetMapOfStrings(std::forward<MapOfStringsT>(value)); return *this;}
    ...
    KitchenSinkOperationResult& AddMapOfStrings(MapOfStringsKeyT&& key, MapOfStringsValueT&& value) {
      m_mapOfStrings.emplace(std::forward<MapOfStringsKeyT>(key), std::forward<MapOfStringsValueT>(value)); return *this;
    }
    ///@}
    ...
    void SetMapOfStructs(MapOfStructsT&& value) { m_mapOfStructs = std::forward<MapOfStructsT>(value); }
    template<typename MapOfStructsT = Aws::Map<Aws::String, SimpleStruct>>
    KitchenSinkOperationResult& WithMapOfStructs(MapOfStructsT&& value) { SetMapOfStructs(std::forward<MapOfStructsT>(value)); return *this;}
    ...
    KitchenSinkOperationResult& AddMapOfStructs(MapOfStructsKeyT&& key, MapOfStructsValueT&& value) {
      m_mapOfStructs.emplace(std::forward<MapOfStructsKeyT>(key), std::forward<MapOfStructsValueT>(value)); return *this;
    }
    ///@}
    ...
    void SetRecursiveList(RecursiveListT&& value) { m_recursiveList = std::forward<RecursiveListT>(value); }
    template<typename RecursiveListT = Aws::Vector<KitchenSink>>
    KitchenSinkOperationResult& WithRecursiveList(RecursiveListT&& value) { SetRecursiveList(std::forward<RecursiveListT>(value)); return *this;}
    template<typename RecursiveListT = KitchenSink>
    KitchenSinkOperationResult& AddRecursiveList(RecursiveListT&& value) { m_recursiveList.emplace_back(std::forward<RecursiveListT>(value)); return *this; }
    ///@}
    ...
    void SetRecursiveMap(RecursiveMapT&& value) { m_recursiveMap = std::forward<RecursiveMapT>(value); }
    template<typename RecursiveMapT = Aws::Map<Aws::String, KitchenSink>>
    KitchenSinkOperationResult& WithRecursiveMap(RecursiveMapT&& value) { SetRecursiveMap(std::forward<RecursiveMapT>(value)); return *this;}
    ...
    KitchenSinkOperationResult& AddRecursiveMap(RecursiveMapKeyT&& key, RecursiveMapValueT&& value) {
      m_recursiveMap.emplace(std::forward<RecursiveMapKeyT>(key), std::forward<RecursiveMapValueT>(value)); return *this;
    }
    ///@}
    ...
    void SetRecursiveStruct(RecursiveStructT&& value) { m_recursiveStruct = std::forward<RecursiveStructT>(value); }
    template<typename RecursiveStructT = KitchenSink>
    KitchenSinkOperationResult& WithRecursiveStruct(RecursiveStructT&& value) { SetRecursiveStruct(std::forward<RecursiveStructT>(value)); return *this;}
    ///@}
    ...
    void SetSimpleStruct(SimpleStructT&& value) { m_simpleStruct = std::forward<SimpleStructT>(value); }
    template<typename SimpleStructT = SimpleStruct>
    KitchenSinkOperationResult& WithSimpleStruct(SimpleStructT&& value) { SetSimpleStruct(std::forward<SimpleStructT>(value)); return *this;}
    ///@}
    ...
    template<typename StringT = Aws::String>
    KitchenSinkOperationResult& WithString(StringT&& value) { SetString(std::forward<StringT>(value)); return *this;}
    ///@}
    ...
    void SetStructWithJsonName(StructWithJsonNameT&& value) { m_structWithJsonName = std::forward<StructWithJsonNameT>(value); }
    template<typename StructWithJsonNameT = StructWithJsonName>
    KitchenSinkOperationResult& WithStructWithJsonName(StructWithJsonNameT&& value) { SetStructWithJsonName(std::forward<StructWithJsonNameT>(value)); return *this;}
    ///@}
    ...
    void SetTimestamp(TimestampT&& value) { m_timestamp = std::forward<TimestampT>(value); }
    template<typename TimestampT = Aws::Utils::DateTime>
    KitchenSinkOperationResult& WithTimestamp(TimestampT&& value) { SetTimestamp(std::forward<TimestampT>(value)); return *this;}
    ///@}
    ...
    void SetUnixTimestamp(UnixTimestampT&& value) { m_unixTimestamp = std::forward<UnixTimestampT>(value); }
    template<typename UnixTimestampT = Aws::Utils::DateTime>
    KitchenSinkOperationResult& WithUnixTimestamp(UnixTimestampT&& value) { SetUnixTimestamp(std::forward<UnixTimestampT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    KitchenSinkOperationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
