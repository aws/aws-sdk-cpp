...
namespace Model
{
  ...
  public:
    ...
    template<typename IntEnumListT = Aws::Vector<int>>
    JsonIntEnumsResult& WithIntEnumList(IntEnumListT&& value) { SetIntEnumList(std::forward<IntEnumListT>(value)); return *this;}
    inline JsonIntEnumsResult& AddIntEnumList(int value) { m_intEnumListHasBeenSet = true; m_intEnumList.push_back(value); return *this; }
    ///@}
    ...
    template<typename IntEnumSetT = Aws::Vector<int>>
    JsonIntEnumsResult& WithIntEnumSet(IntEnumSetT&& value) { SetIntEnumSet(std::forward<IntEnumSetT>(value)); return *this;}
    inline JsonIntEnumsResult& AddIntEnumSet(int value) { m_intEnumSetHasBeenSet = true; m_intEnumSet.push_back(value); return *this; }
    ///@}
    ...
    template<typename IntEnumMapT = Aws::Map<Aws::String, int>>
    JsonIntEnumsResult& WithIntEnumMap(IntEnumMapT&& value) { SetIntEnumMap(std::forward<IntEnumMapT>(value)); return *this;}
    ...
    template<typename RequestIdT = Aws::String>
    JsonIntEnumsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
