...
namespace Model
{
  ...
  /**
   */
  class JsonEnumsRequest : public JsonProtocolRequest
  {
  public:
    AWS_JSONPROTOCOL_API JsonEnumsRequest() = default;
    ...
    inline JsonEnumsRequest& WithFooEnum1(FooEnum value) { SetFooEnum1(value); return *this;}
    ///@}
    ...
    inline JsonEnumsRequest& WithFooEnum2(FooEnum value) { SetFooEnum2(value); return *this;}
    ///@}
    ...
    inline JsonEnumsRequest& WithFooEnum3(FooEnum value) { SetFooEnum3(value); return *this;}
    ///@}
    ...
    template<typename FooEnumListT = Aws::Vector<FooEnum>>
    JsonEnumsRequest& WithFooEnumList(FooEnumListT&& value) { SetFooEnumList(std::forward<FooEnumListT>(value)); return *this;}
    inline JsonEnumsRequest& AddFooEnumList(FooEnum value) { m_fooEnumListHasBeenSet = true; m_fooEnumList.push_back(value); return *this; }
    ///@}
    ...
    template<typename FooEnumSetT = Aws::Vector<FooEnum>>
    JsonEnumsRequest& WithFooEnumSet(FooEnumSetT&& value) { SetFooEnumSet(std::forward<FooEnumSetT>(value)); return *this;}
    inline JsonEnumsRequest& AddFooEnumSet(FooEnum value) { m_fooEnumSetHasBeenSet = true; m_fooEnumSet.push_back(value); return *this; }
    ///@}
    ...
    template<typename FooEnumMapT = Aws::Map<Aws::String, FooEnum>>
    JsonEnumsRequest& WithFooEnumMap(FooEnumMapT&& value) { SetFooEnumMap(std::forward<FooEnumMapT>(value)); return *this;}
    ...
    template<typename RequestIdT = Aws::String>
    JsonEnumsRequest& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
