...
namespace Model
{
  ...
  public:
    ...
    template<typename BlobT = Aws::Utils::ByteBuffer>
    KitchenSink& WithBlob(BlobT&& value) { SetBlob(std::forward<BlobT>(value)); return *this;}
    ///@}
    ...
    void SetEmptyStruct(EmptyStructT&& value) { m_emptyStructHasBeenSet = true; m_emptyStruct = std::forward<EmptyStructT>(value); }
    template<typename EmptyStructT = EmptyStruct>
    KitchenSink& WithEmptyStruct(EmptyStructT&& value) { SetEmptyStruct(std::forward<EmptyStructT>(value)); return *this;}
    ///@}
    ...
    void SetHttpdateTimestamp(HttpdateTimestampT&& value) { m_httpdateTimestampHasBeenSet = true; m_httpdateTimestamp = std::forward<HttpdateTimestampT>(value); }
    template<typename HttpdateTimestampT = Aws::Utils::DateTime>
    KitchenSink& WithHttpdateTimestamp(HttpdateTimestampT&& value) { SetHttpdateTimestamp(std::forward<HttpdateTimestampT>(value)); return *this;}
    ///@}
    ...
    void SetIso8601Timestamp(Iso8601TimestampT&& value) { m_iso8601TimestampHasBeenSet = true; m_iso8601Timestamp = std::forward<Iso8601TimestampT>(value); }
    template<typename Iso8601TimestampT = Aws::Utils::DateTime>
    KitchenSink& WithIso8601Timestamp(Iso8601TimestampT&& value) { SetIso8601Timestamp(std::forward<Iso8601TimestampT>(value)); return *this;}
    ///@}
    ...
    void SetJsonValue(JsonValueT&& value) { m_jsonValueHasBeenSet = true; m_jsonValue = std::forward<JsonValueT>(value); }
    template<typename JsonValueT = Aws::String>
    KitchenSink& WithJsonValue(JsonValueT&& value) { SetJsonValue(std::forward<JsonValueT>(value)); return *this;}
    ///@}
    ...
    void SetListOfLists(ListOfListsT&& value) { m_listOfListsHasBeenSet = true; m_listOfLists = std::forward<ListOfListsT>(value); }
    template<typename ListOfListsT = Aws::Vector<Aws::Vector<Aws::String>>>
    KitchenSink& WithListOfLists(ListOfListsT&& value) { SetListOfLists(std::forward<ListOfListsT>(value)); return *this;}
    template<typename ListOfListsT = Aws::Vector<Aws::String>>
    KitchenSink& AddListOfLists(ListOfListsT&& value) { m_listOfListsHasBeenSet = true; m_listOfLists.emplace_back(std::forward<ListOfListsT>(value)); return *this; }
    ///@}
    ...
    void SetListOfMapsOfStrings(ListOfMapsOfStringsT&& value) { m_listOfMapsOfStringsHasBeenSet = true; m_listOfMapsOfStrings = std::forward<ListOfMapsOfStringsT>(value); }
    template<typename ListOfMapsOfStringsT = Aws::Vector<Aws::Map<Aws::String, Aws::String>>>
    KitchenSink& WithListOfMapsOfStrings(ListOfMapsOfStringsT&& value) { SetListOfMapsOfStrings(std::forward<ListOfMapsOfStringsT>(value)); return *this;}
    template<typename ListOfMapsOfStringsT = Aws::Map<Aws::String, Aws::String>>
    KitchenSink& AddListOfMapsOfStrings(ListOfMapsOfStringsT&& value) { m_listOfMapsOfStringsHasBeenSet = true; m_listOfMapsOfStrings.emplace_back(std::forward<ListOfMapsOfStringsT>(value)); return *this; }
    ///@}
    ...
    void SetListOfStrings(ListOfStringsT&& value) { m_listOfStringsHasBeenSet = true; m_listOfStrings = std::forward<ListOfStringsT>(value); }
    template<typename ListOfStringsT = Aws::Vector<Aws::String>>
    KitchenSink& WithListOfStrings(ListOfStringsT&& value) { SetListOfStrings(std::forward<ListOfStringsT>(value)); return *this;}
    template<typename ListOfStringsT = Aws::String>
    KitchenSink& AddListOfStrings(ListOfStringsT&& value) { m_listOfStringsHasBeenSet = true; m_listOfStrings.emplace_back(std::forward<ListOfStringsT>(value)); return *this; }
    ///@}
    ...
    void SetListOfStructs(ListOfStructsT&& value) { m_listOfStructsHasBeenSet = true; m_listOfStructs = std::forward<ListOfStructsT>(value); }
    template<typename ListOfStructsT = Aws::Vector<SimpleStruct>>
    KitchenSink& WithListOfStructs(ListOfStructsT&& value) { SetListOfStructs(std::forward<ListOfStructsT>(value)); return *this;}
    template<typename ListOfStructsT = SimpleStruct>
    KitchenSink& AddListOfStructs(ListOfStructsT&& value) { m_listOfStructsHasBeenSet = true; m_listOfStructs.emplace_back(std::forward<ListOfStructsT>(value)); return *this; }
    ///@}
    ...
    void SetMapOfListsOfStrings(MapOfListsOfStringsT&& value) { m_mapOfListsOfStringsHasBeenSet = true; m_mapOfListsOfStrings = std::forward<MapOfListsOfStringsT>(value); }
    template<typename MapOfListsOfStringsT = Aws::Map<Aws::String, Aws::Vector<Aws::String>>>
    KitchenSink& WithMapOfListsOfStrings(MapOfListsOfStringsT&& value) { SetMapOfListsOfStrings(std::forward<MapOfListsOfStringsT>(value)); return *this;}
    ...
    KitchenSink& AddMapOfListsOfStrings(MapOfListsOfStringsKeyT&& key, MapOfListsOfStringsValueT&& value) {
      m_mapOfListsOfStringsHasBeenSet = true; m_mapOfListsOfStrings.emplace(std::forward<MapOfListsOfStringsKeyT>(key), std::forward<MapOfListsOfStringsValueT>(value)); return *this;
    }
    ///@}
    ...
    void SetMapOfMaps(MapOfMapsT&& value) { m_mapOfMapsHasBeenSet = true; m_mapOfMaps = std::forward<MapOfMapsT>(value); }
    template<typename MapOfMapsT = Aws::Map<Aws::String, Aws::Map<Aws::String, Aws::String>>>
    KitchenSink& WithMapOfMaps(MapOfMapsT&& value) { SetMapOfMaps(std::forward<MapOfMapsT>(value)); return *this;}
    ...
    KitchenSink& AddMapOfMaps(MapOfMapsKeyT&& key, MapOfMapsValueT&& value) {
      m_mapOfMapsHasBeenSet = true; m_mapOfMaps.emplace(std::forward<MapOfMapsKeyT>(key), std::forward<MapOfMapsValueT>(value)); return *this;
    }
    ///@}
    ...
    void SetMapOfStrings(MapOfStringsT&& value) { m_mapOfStringsHasBeenSet = true; m_mapOfStrings = std::forward<MapOfStringsT>(value); }
    template<typename MapOfStringsT = Aws::Map<Aws::String, Aws::String>>
    KitchenSink& WithMapOfStrings(MapOfStringsT&& value) { SetMapOfStrings(std::forward<MapOfStringsT>(value)); return *this;}
    ...
    KitchenSink& AddMapOfStrings(MapOfStringsKeyT&& key, MapOfStringsValueT&& value) {
      m_mapOfStringsHasBeenSet = true; m_mapOfStrings.emplace(std::forward<MapOfStringsKeyT>(key), std::forward<MapOfStringsValueT>(value)); return *this;
    }
    ///@}
    ...
    void SetMapOfStructs(MapOfStructsT&& value) { m_mapOfStructsHasBeenSet = true; m_mapOfStructs = std::forward<MapOfStructsT>(value); }
    template<typename MapOfStructsT = Aws::Map<Aws::String, SimpleStruct>>
    KitchenSink& WithMapOfStructs(MapOfStructsT&& value) { SetMapOfStructs(std::forward<MapOfStructsT>(value)); return *this;}
    ...
    KitchenSink& AddMapOfStructs(MapOfStructsKeyT&& key, MapOfStructsValueT&& value) {
      m_mapOfStructsHasBeenSet = true; m_mapOfStructs.emplace(std::forward<MapOfStructsKeyT>(key), std::forward<MapOfStructsValueT>(value)); return *this;
    }
    ///@}
    ...
    void SetRecursiveList(RecursiveListT&& value) { m_recursiveListHasBeenSet = true; m_recursiveList = std::forward<RecursiveListT>(value); }
    template<typename RecursiveListT = Aws::Vector<KitchenSink>>
    KitchenSink& WithRecursiveList(RecursiveListT&& value) { SetRecursiveList(std::forward<RecursiveListT>(value)); return *this;}
    template<typename RecursiveListT = KitchenSink>
    KitchenSink& AddRecursiveList(RecursiveListT&& value) { m_recursiveListHasBeenSet = true; m_recursiveList.emplace_back(std::forward<RecursiveListT>(value)); return *this; }
    ///@}
    ...
    void SetRecursiveMap(RecursiveMapT&& value) { m_recursiveMapHasBeenSet = true; m_recursiveMap = std::forward<RecursiveMapT>(value); }
    template<typename RecursiveMapT = Aws::Map<Aws::String, KitchenSink>>
    KitchenSink& WithRecursiveMap(RecursiveMapT&& value) { SetRecursiveMap(std::forward<RecursiveMapT>(value)); return *this;}
    ...
    KitchenSink& AddRecursiveMap(RecursiveMapKeyT&& key, RecursiveMapValueT&& value) {
      m_recursiveMapHasBeenSet = true; m_recursiveMap.emplace(std::forward<RecursiveMapKeyT>(key), std::forward<RecursiveMapValueT>(value)); return *this;
    }
    ///@}

    ///@{
    
    inline const KitchenSink& GetRecursiveStruct() const{
      assert(m_recursiveStruct); return *m_recursiveStruct;
    }
    ...
    template<typename RecursiveStructT = KitchenSink>
    KitchenSink& WithRecursiveStruct(RecursiveStructT&& value) { SetRecursiveStruct(std::forward<RecursiveStructT>(value)); return *this;}
    ///@}
    ...
    void SetSimpleStruct(SimpleStructT&& value) { m_simpleStructHasBeenSet = true; m_simpleStruct = std::forward<SimpleStructT>(value); }
    template<typename SimpleStructT = SimpleStruct>
    KitchenSink& WithSimpleStruct(SimpleStructT&& value) { SetSimpleStruct(std::forward<SimpleStructT>(value)); return *this;}
    ///@}
    ...
    template<typename StringT = Aws::String>
    KitchenSink& WithString(StringT&& value) { SetString(std::forward<StringT>(value)); return *this;}
    ///@}
    ...
    void SetStructWithJsonName(StructWithJsonNameT&& value) { m_structWithJsonNameHasBeenSet = true; m_structWithJsonName = std::forward<StructWithJsonNameT>(value); }
    template<typename StructWithJsonNameT = StructWithJsonName>
    KitchenSink& WithStructWithJsonName(StructWithJsonNameT&& value) { SetStructWithJsonName(std::forward<StructWithJsonNameT>(value)); return *this;}
    ///@}
    ...
    template<typename TimestampT = Aws::Utils::DateTime>
    KitchenSink& WithTimestamp(TimestampT&& value) { SetTimestamp(std::forward<TimestampT>(value)); return *this;}
    ///@}
    ...
    void SetUnixTimestamp(UnixTimestampT&& value) { m_unixTimestampHasBeenSet = true; m_unixTimestamp = std::forward<UnixTimestampT>(value); }
    template<typename UnixTimestampT = Aws::Utils::DateTime>
    KitchenSink& WithUnixTimestamp(UnixTimestampT&& value) { SetUnixTimestamp(std::forward<UnixTimestampT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    KitchenSink& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
