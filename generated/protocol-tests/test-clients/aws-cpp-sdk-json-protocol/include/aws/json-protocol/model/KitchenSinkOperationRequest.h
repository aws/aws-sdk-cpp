...
namespace Model
{
  ...
  {
  public:
    AWS_JSONPROTOCOL_API KitchenSinkOperationRequest() = default;
    ...
    template<typename BlobT = Aws::Utils::ByteBuffer>
    KitchenSinkOperationRequest& WithBlob(BlobT&& value) { SetBlob(std::forward<BlobT>(value)); return *this;}
    ///@}
    ...
    template<typename EmptyStructT = EmptyStruct>
    KitchenSinkOperationRequest& WithEmptyStruct(EmptyStructT&& value) { SetEmptyStruct(std::forward<EmptyStructT>(value)); return *this;}
    ///@}
    ...
    template<typename HttpdateTimestampT = Aws::Utils::DateTime>
    KitchenSinkOperationRequest& WithHttpdateTimestamp(HttpdateTimestampT&& value) { SetHttpdateTimestamp(std::forward<HttpdateTimestampT>(value)); return *this;}
    ///@}
    ...
    template<typename Iso8601TimestampT = Aws::Utils::DateTime>
    KitchenSinkOperationRequest& WithIso8601Timestamp(Iso8601TimestampT&& value) { SetIso8601Timestamp(std::forward<Iso8601TimestampT>(value)); return *this;}
    ///@}
    ...
    template<typename JsonValueT = Aws::String>
    KitchenSinkOperationRequest& WithJsonValue(JsonValueT&& value) { SetJsonValue(std::forward<JsonValueT>(value)); return *this;}
    ///@}
    ...
    template<typename ListOfListsT = Aws::Vector<Aws::Vector<Aws::String>>>
    KitchenSinkOperationRequest& WithListOfLists(ListOfListsT&& value) { SetListOfLists(std::forward<ListOfListsT>(value)); return *this;}
    template<typename ListOfListsT = Aws::Vector<Aws::String>>
    KitchenSinkOperationRequest& AddListOfLists(ListOfListsT&& value) { m_listOfListsHasBeenSet = true; m_listOfLists.emplace_back(std::forward<ListOfListsT>(value)); return *this; }
    ///@}
    ...
    template<typename ListOfMapsOfStringsT = Aws::Vector<Aws::Map<Aws::String, Aws::String>>>
    KitchenSinkOperationRequest& WithListOfMapsOfStrings(ListOfMapsOfStringsT&& value) { SetListOfMapsOfStrings(std::forward<ListOfMapsOfStringsT>(value)); return *this;}
    template<typename ListOfMapsOfStringsT = Aws::Map<Aws::String, Aws::String>>
    KitchenSinkOperationRequest& AddListOfMapsOfStrings(ListOfMapsOfStringsT&& value) { m_listOfMapsOfStringsHasBeenSet = true; m_listOfMapsOfStrings.emplace_back(std::forward<ListOfMapsOfStringsT>(value)); return *this; }
    ///@}
    ...
    template<typename ListOfStringsT = Aws::Vector<Aws::String>>
    KitchenSinkOperationRequest& WithListOfStrings(ListOfStringsT&& value) { SetListOfStrings(std::forward<ListOfStringsT>(value)); return *this;}
    template<typename ListOfStringsT = Aws::String>
    KitchenSinkOperationRequest& AddListOfStrings(ListOfStringsT&& value) { m_listOfStringsHasBeenSet = true; m_listOfStrings.emplace_back(std::forward<ListOfStringsT>(value)); return *this; }
    ///@}
    ...
    template<typename ListOfStructsT = Aws::Vector<SimpleStruct>>
    KitchenSinkOperationRequest& WithListOfStructs(ListOfStructsT&& value) { SetListOfStructs(std::forward<ListOfStructsT>(value)); return *this;}
    template<typename ListOfStructsT = SimpleStruct>
    KitchenSinkOperationRequest& AddListOfStructs(ListOfStructsT&& value) { m_listOfStructsHasBeenSet = true; m_listOfStructs.emplace_back(std::forward<ListOfStructsT>(value)); return *this; }
    ///@}
    ...
    template<typename MapOfListsOfStringsT = Aws::Map<Aws::String, Aws::Vector<Aws::String>>>
    KitchenSinkOperationRequest& WithMapOfListsOfStrings(MapOfListsOfStringsT&& value) { SetMapOfListsOfStrings(std::forward<MapOfListsOfStringsT>(value)); return *this;}
    template<typename MapOfListsOfStringsKeyT = Aws::String, typename MapOfListsOfStringsValueT = Aws::Vector<Aws::String>>
    KitchenSinkOperationRequest& AddMapOfListsOfStrings(MapOfListsOfStringsKeyT&& key, MapOfListsOfStringsValueT&& value) {
    ...
    template<typename MapOfMapsT = Aws::Map<Aws::String, Aws::Map<Aws::String, Aws::String>>>
    KitchenSinkOperationRequest& WithMapOfMaps(MapOfMapsT&& value) { SetMapOfMaps(std::forward<MapOfMapsT>(value)); return *this;}
    template<typename MapOfMapsKeyT = Aws::String, typename MapOfMapsValueT = Aws::Map<Aws::String, Aws::String>>
    KitchenSinkOperationRequest& AddMapOfMaps(MapOfMapsKeyT&& key, MapOfMapsValueT&& value) {
    ...
    template<typename MapOfStringsT = Aws::Map<Aws::String, Aws::String>>
    KitchenSinkOperationRequest& WithMapOfStrings(MapOfStringsT&& value) { SetMapOfStrings(std::forward<MapOfStringsT>(value)); return *this;}
    template<typename MapOfStringsKeyT = Aws::String, typename MapOfStringsValueT = Aws::String>
    KitchenSinkOperationRequest& AddMapOfStrings(MapOfStringsKeyT&& key, MapOfStringsValueT&& value) {
    ...
    template<typename MapOfStructsT = Aws::Map<Aws::String, SimpleStruct>>
    KitchenSinkOperationRequest& WithMapOfStructs(MapOfStructsT&& value) { SetMapOfStructs(std::forward<MapOfStructsT>(value)); return *this;}
    template<typename MapOfStructsKeyT = Aws::String, typename MapOfStructsValueT = SimpleStruct>
    KitchenSinkOperationRequest& AddMapOfStructs(MapOfStructsKeyT&& key, MapOfStructsValueT&& value) {
    ...
    template<typename RecursiveListT = Aws::Vector<KitchenSink>>
    KitchenSinkOperationRequest& WithRecursiveList(RecursiveListT&& value) { SetRecursiveList(std::forward<RecursiveListT>(value)); return *this;}
    template<typename RecursiveListT = KitchenSink>
    KitchenSinkOperationRequest& AddRecursiveList(RecursiveListT&& value) { m_recursiveListHasBeenSet = true; m_recursiveList.emplace_back(std::forward<RecursiveListT>(value)); return *this; }
    ///@}
    ...
    template<typename RecursiveMapT = Aws::Map<Aws::String, KitchenSink>>
    KitchenSinkOperationRequest& WithRecursiveMap(RecursiveMapT&& value) { SetRecursiveMap(std::forward<RecursiveMapT>(value)); return *this;}
    template<typename RecursiveMapKeyT = Aws::String, typename RecursiveMapValueT = KitchenSink>
    KitchenSinkOperationRequest& AddRecursiveMap(RecursiveMapKeyT&& key, RecursiveMapValueT&& value) {
    ...
    template<typename RecursiveStructT = KitchenSink>
    KitchenSinkOperationRequest& WithRecursiveStruct(RecursiveStructT&& value) { SetRecursiveStruct(std::forward<RecursiveStructT>(value)); return *this;}
    ///@}
    ...
    template<typename SimpleStructT = SimpleStruct>
    KitchenSinkOperationRequest& WithSimpleStruct(SimpleStructT&& value) { SetSimpleStruct(std::forward<SimpleStructT>(value)); return *this;}
    ///@}
    ...
    template<typename StringT = Aws::String>
    KitchenSinkOperationRequest& WithString(StringT&& value) { SetString(std::forward<StringT>(value)); return *this;}
    ///@}
    ...
    template<typename StructWithJsonNameT = StructWithJsonName>
    KitchenSinkOperationRequest& WithStructWithJsonName(StructWithJsonNameT&& value) { SetStructWithJsonName(std::forward<StructWithJsonNameT>(value)); return *this;}
    ///@}
    ...
    template<typename TimestampT = Aws::Utils::DateTime>
    KitchenSinkOperationRequest& WithTimestamp(TimestampT&& value) { SetTimestamp(std::forward<TimestampT>(value)); return *this;}
    ///@}
    ...
    template<typename UnixTimestampT = Aws::Utils::DateTime>
    KitchenSinkOperationRequest& WithUnixTimestamp(UnixTimestampT&& value) { SetUnixTimestamp(std::forward<UnixTimestampT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    KitchenSinkOperationRequest& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
