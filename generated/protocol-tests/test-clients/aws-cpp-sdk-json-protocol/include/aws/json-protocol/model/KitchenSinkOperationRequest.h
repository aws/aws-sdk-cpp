...
class KitchenSinkOperationRequest : public JsonProtocolRequest {
 public:
  ...
  template <typename BlobT = Aws::Utils::ByteBuffer>
  KitchenSinkOperationRequest& WithBlob(BlobT&& value) {
  ...
  inline KitchenSinkOperationRequest& WithBoolean(bool value) {
    SetBoolean(value);
    return *this;
  }
  ///@}
  ...
  inline KitchenSinkOperationRequest& WithDouble(double value) {
    SetDouble(value);
    return *this;
  }
  ///@}
  ...
  template <typename EmptyStructT = EmptyStruct>
  KitchenSinkOperationRequest& WithEmptyStruct(EmptyStructT&& value) {
  ...
  inline KitchenSinkOperationRequest& WithFloat(double value) {
    SetFloat(value);
    return *this;
  }
  ///@}
  ...
  template <typename HttpdateTimestampT = Aws::Utils::DateTime>
  KitchenSinkOperationRequest& WithHttpdateTimestamp(HttpdateTimestampT&& value) {
  ...
  inline KitchenSinkOperationRequest& WithInteger(int value) {
    SetInteger(value);
    return *this;
  }
  ///@}
  ...
  template <typename Iso8601TimestampT = Aws::Utils::DateTime>
  KitchenSinkOperationRequest& WithIso8601Timestamp(Iso8601TimestampT&& value) {
  ...
  template <typename JsonValueT = Aws::String>
  KitchenSinkOperationRequest& WithJsonValue(JsonValueT&& value) {
  ...
  template <typename ListOfListsT = Aws::Vector<Aws::Vector<Aws::String>>>
  KitchenSinkOperationRequest& WithListOfLists(ListOfListsT&& value) {
    SetListOfLists(std::forward<ListOfListsT>(value));
    return *this;
  }
  template <typename ListOfListsT = Aws::Vector<Aws::String>>
  KitchenSinkOperationRequest& AddListOfLists(ListOfListsT&& value) {
    m_listOfListsHasBeenSet = true;
  ...
  template <typename ListOfMapsOfStringsT = Aws::Vector<Aws::Map<Aws::String, Aws::String>>>
  KitchenSinkOperationRequest& WithListOfMapsOfStrings(ListOfMapsOfStringsT&& value) {
  ...
  KitchenSinkOperationRequest& AddListOfMapsOfStrings(ListOfMapsOfStringsT&& value) {
    m_listOfMapsOfStringsHasBeenSet = true;
  ...
  template <typename ListOfStringsT = Aws::Vector<Aws::String>>
  KitchenSinkOperationRequest& WithListOfStrings(ListOfStringsT&& value) {
    SetListOfStrings(std::forward<ListOfStringsT>(value));
    return *this;
  }
  template <typename ListOfStringsT = Aws::String>
  KitchenSinkOperationRequest& AddListOfStrings(ListOfStringsT&& value) {
    m_listOfStringsHasBeenSet = true;
  ...
  template <typename ListOfStructsT = Aws::Vector<SimpleStruct>>
  KitchenSinkOperationRequest& WithListOfStructs(ListOfStructsT&& value) {
    SetListOfStructs(std::forward<ListOfStructsT>(value));
    return *this;
  }
  template <typename ListOfStructsT = SimpleStruct>
  KitchenSinkOperationRequest& AddListOfStructs(ListOfStructsT&& value) {
    m_listOfStructsHasBeenSet = true;
  ...
  inline KitchenSinkOperationRequest& WithLong(long long value) {
    SetLong(value);
    return *this;
  }
  ///@}
  ...
  template <typename MapOfListsOfStringsT = Aws::Map<Aws::String, Aws::Vector<Aws::String>>>
  KitchenSinkOperationRequest& WithMapOfListsOfStrings(MapOfListsOfStringsT&& value) {
  ...
  template <typename MapOfMapsT = Aws::Map<Aws::String, Aws::Map<Aws::String, Aws::String>>>
  KitchenSinkOperationRequest& WithMapOfMaps(MapOfMapsT&& value) {
  ...
  template <typename MapOfStringsT = Aws::Map<Aws::String, Aws::String>>
  KitchenSinkOperationRequest& WithMapOfStrings(MapOfStringsT&& value) {
  ...
  template <typename MapOfStructsT = Aws::Map<Aws::String, SimpleStruct>>
  KitchenSinkOperationRequest& WithMapOfStructs(MapOfStructsT&& value) {
  ...
  template <typename RecursiveListT = Aws::Vector<KitchenSink>>
  KitchenSinkOperationRequest& WithRecursiveList(RecursiveListT&& value) {
    SetRecursiveList(std::forward<RecursiveListT>(value));
    return *this;
  }
  template <typename RecursiveListT = KitchenSink>
  KitchenSinkOperationRequest& AddRecursiveList(RecursiveListT&& value) {
    m_recursiveListHasBeenSet = true;
  ...
  template <typename RecursiveMapT = Aws::Map<Aws::String, KitchenSink>>
  KitchenSinkOperationRequest& WithRecursiveMap(RecursiveMapT&& value) {
  ...
  template <typename RecursiveStructT = KitchenSink>
  KitchenSinkOperationRequest& WithRecursiveStruct(RecursiveStructT&& value) {
  ...
  template <typename SimpleStructT = SimpleStruct>
  KitchenSinkOperationRequest& WithSimpleStruct(SimpleStructT&& value) {
  ...
  template <typename StringT = Aws::String>
  KitchenSinkOperationRequest& WithString(StringT&& value) {
  ...
  template <typename StructWithJsonNameT = StructWithJsonName>
  KitchenSinkOperationRequest& WithStructWithJsonName(StructWithJsonNameT&& value) {
  ...
  template <typename TimestampT = Aws::Utils::DateTime>
  KitchenSinkOperationRequest& WithTimestamp(TimestampT&& value) {
  ...
  template <typename UnixTimestampT = Aws::Utils::DateTime>
  KitchenSinkOperationRequest& WithUnixTimestamp(UnixTimestampT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  KitchenSinkOperationRequest& WithRequestId(RequestIdT&& value) {
