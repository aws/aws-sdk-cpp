  ...
  class AWS_JSONPROTOCOL_API JsonProtocolClient : public Aws::Client::AWSJsonClient, public Aws::Client::ClientWithAsyncTemplateMethods<JsonProtocolClient>
  {
    public:
      ...
      typedef JsonProtocolEndpointProvider EndpointProviderType;
        ...
        */
        JsonProtocolClient(const Aws::JsonProtocol::JsonProtocolClientConfiguration& clientConfiguration = Aws::JsonProtocol::JsonProtocolClientConfiguration(),
        ...
        * is not specified, it will be initialized to default values.
        */
        JsonProtocolClient(const Aws::Auth::AWSCredentials& credentials,
                           std::shared_ptr<JsonProtocolEndpointProviderBase> endpointProvider = nullptr,
        ...
        */
        ...
        /**
         * An Async wrapper for EmptyOperation that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename EmptyOperationRequestT = Model::EmptyOperationRequest>
        void EmptyOperationAsync(const EmptyOperationResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const EmptyOperationRequestT& request = {}) const
        {
        ...
        /**
         * A Callable wrapper for KitchenSinkOperation that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for KitchenSinkOperation that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename KitchenSinkOperationRequestT = Model::KitchenSinkOperationRequest>
        void KitchenSinkOperationAsync(const KitchenSinkOperationResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const KitchenSinkOperationRequestT& request = {}) const
        {
        ...
        /**
         * An Async wrapper for NullOperation that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename NullOperationRequestT = Model::NullOperationRequest>
        void NullOperationAsync(const NullOperationResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const NullOperationRequestT& request = {}) const
        {
         ...
         * 
         */
        virtual Model::OperationWithOptionalInputOutputOutcome OperationWithOptionalInputOutput(const Model::OperationWithOptionalInputOutputRequest& request = {}) const;

        /**
         * A Callable wrapper for OperationWithOptionalInputOutput that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        template<typename OperationWithOptionalInputOutputRequestT = Model::OperationWithOptionalInputOutputRequest>
        Model::OperationWithOptionalInputOutputOutcomeCallable OperationWithOptionalInputOutputCallable(const OperationWithOptionalInputOutputRequestT& request = {}) const
        {
            return SubmitCallable(&JsonProtocolClient::OperationWithOptionalInputOutput, request);
        }

        /**
         * An Async wrapper for OperationWithOptionalInputOutput that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename OperationWithOptionalInputOutputRequestT = Model::OperationWithOptionalInputOutputRequest>
        void OperationWithOptionalInputOutputAsync(const OperationWithOptionalInputOutputResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const OperationWithOptionalInputOutputRequestT& request = {}) const
        {
        ...
        /**
         * A Callable wrapper for PutAndGetInlineDocuments that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        template<typename PutAndGetInlineDocumentsRequestT = Model::PutAndGetInlineDocumentsRequest>
        Model::PutAndGetInlineDocumentsOutcomeCallable PutAndGetInlineDocumentsCallable(const PutAndGetInlineDocumentsRequestT& request = {}) const
        {
            return SubmitCallable(&JsonProtocolClient::PutAndGetInlineDocuments, request);
        }

        /**
         * An Async wrapper for PutAndGetInlineDocuments that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename PutAndGetInlineDocumentsRequestT = Model::PutAndGetInlineDocumentsRequest>
        void PutAndGetInlineDocumentsAsync(const PutAndGetInlineDocumentsResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const PutAndGetInlineDocumentsRequestT& request = {}) const
        {
