...
class AWS_JSONPROTOCOL_API JsonProtocolError : public Aws::Client::AWSError<JsonProtocolErrors> {
 public:
  ...
  JsonProtocolError(const Aws::Client::AWSError<JsonProtocolErrors>& rhs) : Aws::Client::AWSError<JsonProtocolErrors>(rhs) {}
  JsonProtocolError(Aws::Client::AWSError<JsonProtocolErrors>&& rhs) : Aws::Client::AWSError<JsonProtocolErrors>(rhs) {}
