...
namespace Aws
{
  ...
  namespace JsonProtocol
  {
    ...
    typedef std::function<void(const JsonProtocolClient*, const Model::ContentTypeParametersRequest&, const Model::ContentTypeParametersOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > ContentTypeParametersResponseReceivedHandler;
    typedef std::function<void(const JsonProtocolClient*, const Model::DatetimeOffsetsRequest&, const Model::DatetimeOffsetsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > DatetimeOffsetsResponseReceivedHandler;
    typedef std::function<void(const JsonProtocolClient*, const Model::EmptyOperationRequest&, const Model::EmptyOperationOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > EmptyOperationResponseReceivedHandler;
    typedef std::function<void(const JsonProtocolClient*, const Model::EndpointOperationRequest&, const Model::EndpointOperationOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > EndpointOperationResponseReceivedHandler;
    typedef std::function<void(const JsonProtocolClient*, const Model::EndpointWithHostLabelOperationRequest&, const Model::EndpointWithHostLabelOperationOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > EndpointWithHostLabelOperationResponseReceivedHandler;
    typedef std::function<void(const JsonProtocolClient*, const Model::FractionalSecondsRequest&, const Model::FractionalSecondsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > FractionalSecondsResponseReceivedHandler;
    typedef std::function<void(const JsonProtocolClient*, const Model::GreetingWithErrorsRequest&, const Model::GreetingWithErrorsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > GreetingWithErrorsResponseReceivedHandler;
    typedef std::function<void(const JsonProtocolClient*, const Model::HostWithPathOperationRequest&, const Model::HostWithPathOperationOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > HostWithPathOperationResponseReceivedHandler;
    typedef std::function<void(const JsonProtocolClient*, const Model::JsonEnumsRequest&, const Model::JsonEnumsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > JsonEnumsResponseReceivedHandler;
    typedef std::function<void(const JsonProtocolClient*, const Model::JsonIntEnumsRequest&, const Model::JsonIntEnumsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > JsonIntEnumsResponseReceivedHandler;
    typedef std::function<void(const JsonProtocolClient*, const Model::JsonUnionsRequest&, const Model::JsonUnionsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > JsonUnionsResponseReceivedHandler;
    typedef std::function<void(const JsonProtocolClient*, const Model::KitchenSinkOperationRequest&, const Model::KitchenSinkOperationOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > KitchenSinkOperationResponseReceivedHandler;
    typedef std::function<void(const JsonProtocolClient*, const Model::NullOperationRequest&, const Model::NullOperationOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > NullOperationResponseReceivedHandler;
    typedef std::function<void(const JsonProtocolClient*, const Model::OperationWithOptionalInputOutputRequest&, const Model::OperationWithOptionalInputOutputOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > OperationWithOptionalInputOutputResponseReceivedHandler;
    typedef std::function<void(const JsonProtocolClient*, const Model::PutAndGetInlineDocumentsRequest&, const Model::PutAndGetInlineDocumentsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > PutAndGetInlineDocumentsResponseReceivedHandler;
    typedef std::function<void(const JsonProtocolClient*, const Model::PutWithContentEncodingRequest&, const Model::PutWithContentEncodingOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > PutWithContentEncodingResponseReceivedHandler;
    typedef std::function<void(const JsonProtocolClient*, const Model::SimpleScalarPropertiesRequest&, const Model::SimpleScalarPropertiesOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > SimpleScalarPropertiesResponseReceivedHandler;
