...
{
class AWS_RPCV2PROTOCOL_API RpcV2ProtocolClient : public Aws::Client::AWSRpcV2CborClient, public Aws::Client::ClientWithAsyncTemplateMethods<RpcV2ProtocolClient>
{
public:
...
static const char* GetAllocationTag();
      ...
      typedef RpcV2ProtocolEndpointProvider EndpointProviderType;
        ...
        */
        RpcV2ProtocolClient(const Aws::RpcV2Protocol::RpcV2ProtocolClientConfiguration& clientConfiguration = Aws::RpcV2Protocol::RpcV2ProtocolClientConfiguration(),
        ...
        */
        RpcV2ProtocolClient(const Aws::Auth::AWSCredentials& credentials,
                            std::shared_ptr<RpcV2ProtocolEndpointProviderBase> endpointProvider = nullptr,
                            const Aws::RpcV2Protocol::RpcV2ProtocolClientConfiguration& clientConfiguration = Aws::RpcV2Protocol::RpcV2ProtocolClientConfiguration());
        ...
        */
        ...
        /**
         * A Callable wrapper for EmptyInputOutput that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for EmptyInputOutput that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename EmptyInputOutputRequestT = Model::EmptyInputOutputRequest>
        void EmptyInputOutputAsync(const EmptyInputOutputResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const EmptyInputOutputRequestT& request = {}) const
        {
        ...
        /**
         * An Async wrapper for Float16 that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename Float16RequestT = Model::Float16Request>
        void Float16Async(const Float16ResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const Float16RequestT& request = {}) const
        {
        ...
        /**
         * An Async wrapper for NoInputOutput that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename NoInputOutputRequestT = Model::NoInputOutputRequest>
        void NoInputOutputAsync(const NoInputOutputResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const NoInputOutputRequestT& request = {}) const
        {
        ...
        /**
         * A Callable wrapper for OptionalInputOutput that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for OptionalInputOutput that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename OptionalInputOutputRequestT = Model::OptionalInputOutputRequest>
        void OptionalInputOutputAsync(const OptionalInputOutputResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const OptionalInputOutputRequestT& request = {}) const
        {
        ...
        /**
         * An Async wrapper for RecursiveShapes that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename RecursiveShapesRequestT = Model::RecursiveShapesRequest>
        void RecursiveShapesAsync(const RecursiveShapesResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const RecursiveShapesRequestT& request = {}) const
        {
        ...
        /**
         * A Callable wrapper for RpcV2CborDenseMaps that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for RpcV2CborDenseMaps that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename RpcV2CborDenseMapsRequestT = Model::RpcV2CborDenseMapsRequest>
        void RpcV2CborDenseMapsAsync(const RpcV2CborDenseMapsResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const RpcV2CborDenseMapsRequestT& request = {}) const
        {
        ...
        /**
         * An Async wrapper for RpcV2CborLists that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename RpcV2CborListsRequestT = Model::RpcV2CborListsRequest>
        void RpcV2CborListsAsync(const RpcV2CborListsResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const RpcV2CborListsRequestT& request = {}) const
        {
