...
namespace Aws
{
  ...
  namespace RpcV2Protocol
  {
    ...
    typedef std::function<void(const RpcV2ProtocolClient*, const Model::EmptyInputOutputRequest&, const Model::EmptyInputOutputOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > EmptyInputOutputResponseReceivedHandler;
    typedef std::function<void(const RpcV2ProtocolClient*, const Model::Float16Request&, const Model::Float16Outcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > Float16ResponseReceivedHandler;
    typedef std::function<void(const RpcV2ProtocolClient*, const Model::FractionalSecondsRequest&, const Model::FractionalSecondsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > FractionalSecondsResponseReceivedHandler;
    typedef std::function<void(const RpcV2ProtocolClient*, const Model::GreetingWithErrorsRequest&, const Model::GreetingWithErrorsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > GreetingWithErrorsResponseReceivedHandler;
    typedef std::function<void(const RpcV2ProtocolClient*, const Model::NoInputOutputRequest&, const Model::NoInputOutputOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > NoInputOutputResponseReceivedHandler;
    typedef std::function<void(const RpcV2ProtocolClient*, const Model::OptionalInputOutputRequest&, const Model::OptionalInputOutputOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > OptionalInputOutputResponseReceivedHandler;
    typedef std::function<void(const RpcV2ProtocolClient*, const Model::RecursiveShapesRequest&, const Model::RecursiveShapesOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > RecursiveShapesResponseReceivedHandler;
    typedef std::function<void(const RpcV2ProtocolClient*, const Model::RpcV2CborDenseMapsRequest&, const Model::RpcV2CborDenseMapsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > RpcV2CborDenseMapsResponseReceivedHandler;
    typedef std::function<void(const RpcV2ProtocolClient*, const Model::RpcV2CborListsRequest&, const Model::RpcV2CborListsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > RpcV2CborListsResponseReceivedHandler;
    typedef std::function<void(const RpcV2ProtocolClient*, const Model::SimpleScalarPropertiesRequest&, const Model::SimpleScalarPropertiesOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > SimpleScalarPropertiesResponseReceivedHandler;
