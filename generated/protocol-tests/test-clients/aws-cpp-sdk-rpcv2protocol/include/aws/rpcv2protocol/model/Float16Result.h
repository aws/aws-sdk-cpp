...
template<typename RESULT_TYPE>
    ...
    inline Float16Result& WithValue(double value) { SetValue(value); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    Float16Result& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
