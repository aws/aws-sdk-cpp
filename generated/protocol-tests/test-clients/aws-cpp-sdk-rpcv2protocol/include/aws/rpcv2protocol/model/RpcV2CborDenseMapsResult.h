...
template<typename RESULT_TYPE>
    ...
    template<typename DenseStructMapT = Aws::Map<Aws::String, GreetingStruct>>
    RpcV2CborDenseMapsResult& WithDenseStructMap(DenseStructMapT&& value) { SetDenseStructMap(std::forward<DenseStructMapT>(value)); return *this;}
    ...
    template<typename DenseBooleanMapT = Aws::Map<Aws::String, bool>>
    RpcV2CborDenseMapsResult& WithDenseBooleanMap(DenseBooleanMapT&& value) { SetDenseBooleanMap(std::forward<DenseBooleanMapT>(value)); return *this;}
    ...
    template<typename DenseStringMapT = Aws::Map<Aws::String, Aws::String>>
    RpcV2CborDenseMapsResult& WithDenseStringMap(DenseStringMapT&& value) { SetDenseStringMap(std::forward<DenseStringMapT>(value)); return *this;}
    ...
    template<typename DenseSetMapT = Aws::Map<Aws::String, Aws::Vector<Aws::String>>>
    RpcV2CborDenseMapsResult& WithDenseSetMap(DenseSetMapT&& value) { SetDenseSetMap(std::forward<DenseSetMapT>(value)); return *this;}
    ...
    template<typename RequestIdT = Aws::String>
    RpcV2CborDenseMapsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
