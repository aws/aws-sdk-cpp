...
namespace Model
{
  ...
  public:
    ...
    template<typename DenseStructMapT = Aws::Map<Aws::String, GreetingStruct>>
    RpcV2CborDenseMapsRequest& WithDenseStructMap(DenseStructMapT&& value) { SetDenseStructMap(std::forward<DenseStructMapT>(value)); return *this;}
    ...
    template<typename DenseNumberMapT = Aws::Map<Aws::String, int>>
    RpcV2CborDenseMapsRequest& WithDenseNumberMap(DenseNumberMapT&& value) { SetDenseNumberMap(std::forward<DenseNumberMapT>(value)); return *this;}
    ...
    template<typename DenseBooleanMapT = Aws::Map<Aws::String, bool>>
    RpcV2CborDenseMapsRequest& WithDenseBooleanMap(DenseBooleanMapT&& value) { SetDenseBooleanMap(std::forward<DenseBooleanMapT>(value)); return *this;}
    ...
    template<typename DenseStringMapT = Aws::Map<Aws::String, Aws::String>>
    RpcV2CborDenseMapsRequest& WithDenseStringMap(DenseStringMapT&& value) { SetDenseStringMap(std::forward<DenseStringMapT>(value)); return *this;}
    ...
    template<typename DenseSetMapT = Aws::Map<Aws::String, Aws::Vector<Aws::String>>>
    RpcV2CborDenseMapsRequest& WithDenseSetMap(DenseSetMapT&& value) { SetDenseSetMap(std::forward<DenseSetMapT>(value)); return *this;}
    ...
    template<typename RequestIdT = Aws::String>
    RpcV2CborDenseMapsRequest& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
