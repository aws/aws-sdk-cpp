...
template<typename RESULT_TYPE>
    ...
    {
    public:
    AWS_RPCV2PROTOCOL_API FractionalSecondsResult() = default;
    AWS_RPCV2PROTOCOL_API FractionalSecondsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
    AWS_RPCV2PROTOCOL_API FractionalSecondsResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
