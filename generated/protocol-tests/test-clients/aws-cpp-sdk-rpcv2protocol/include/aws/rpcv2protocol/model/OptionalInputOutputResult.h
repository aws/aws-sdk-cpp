...
template<typename RESULT_TYPE>
    ...
    template<typename ValueT = Aws::String>
    OptionalInputOutputResult& WithValue(ValueT&& value) { SetValue(std::forward<ValueT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    OptionalInputOutputResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
