...
namespace Model
{
  ...
  public:
    ...
    template<typename StringListT = Aws::Vector<Aws::String>>
    RpcV2CborListsRequest& WithStringList(StringListT&& value) { SetStringList(std::forward<StringListT>(value)); return *this;}
    template<typename StringListT = Aws::String>
    RpcV2CborListsRequest& AddStringList(StringListT&& value) { m_stringListHasBeenSet = true; m_stringList.emplace_back(std::forward<StringListT>(value)); return *this; }
    ///@}
    ...
    template<typename StringSetT = Aws::Vector<Aws::String>>
    RpcV2CborListsRequest& WithStringSet(StringSetT&& value) { SetStringSet(std::forward<StringSetT>(value)); return *this;}
    template<typename StringSetT = Aws::String>
    RpcV2CborListsRequest& AddStringSet(StringSetT&& value) { m_stringSetHasBeenSet = true; m_stringSet.emplace_back(std::forward<StringSetT>(value)); return *this; }
    ///@}
    ...
    template<typename IntegerListT = Aws::Vector<int>>
    RpcV2CborListsRequest& WithIntegerList(IntegerListT&& value) { SetIntegerList(std::forward<IntegerListT>(value)); return *this;}
    inline RpcV2CborListsRequest& AddIntegerList(int value) { m_integerListHasBeenSet = true; m_integerList.push_back(value); return *this; }
    ///@}
    ...
    template<typename BooleanListT = Aws::Vector<bool>>
    RpcV2CborListsRequest& WithBooleanList(BooleanListT&& value) { SetBooleanList(std::forward<BooleanListT>(value)); return *this;}
    inline RpcV2CborListsRequest& AddBooleanList(bool value) { m_booleanListHasBeenSet = true; m_booleanList.push_back(value); return *this; }
    ///@}
    ...
    template<typename TimestampListT = Aws::Vector<Aws::Utils::DateTime>>
    RpcV2CborListsRequest& WithTimestampList(TimestampListT&& value) { SetTimestampList(std::forward<TimestampListT>(value)); return *this;}
    template<typename TimestampListT = Aws::Utils::DateTime>
    RpcV2CborListsRequest& AddTimestampList(TimestampListT&& value) { m_timestampListHasBeenSet = true; m_timestampList.emplace_back(std::forward<TimestampListT>(value)); return *this; }
    ///@}
    ...
    template<typename EnumListT = Aws::Vector<FooEnum>>
    RpcV2CborListsRequest& WithEnumList(EnumListT&& value) { SetEnumList(std::forward<EnumListT>(value)); return *this;}
    inline RpcV2CborListsRequest& AddEnumList(FooEnum value) { m_enumListHasBeenSet = true; m_enumList.push_back(value); return *this; }
    ///@}
    ...
    template<typename IntEnumListT = Aws::Vector<int>>
    RpcV2CborListsRequest& WithIntEnumList(IntEnumListT&& value) { SetIntEnumList(std::forward<IntEnumListT>(value)); return *this;}
    inline RpcV2CborListsRequest& AddIntEnumList(int value) { m_intEnumListHasBeenSet = true; m_intEnumList.push_back(value); return *this; }
    ///@}
    ...
    template<typename NestedStringListT = Aws::Vector<Aws::Vector<Aws::String>>>
    RpcV2CborListsRequest& WithNestedStringList(NestedStringListT&& value) { SetNestedStringList(std::forward<NestedStringListT>(value)); return *this;}
    template<typename NestedStringListT = Aws::Vector<Aws::String>>
    RpcV2CborListsRequest& AddNestedStringList(NestedStringListT&& value) { m_nestedStringListHasBeenSet = true; m_nestedStringList.emplace_back(std::forward<NestedStringListT>(value)); return *this; }
    ///@}
    ...
    template<typename StructureListT = Aws::Vector<StructureListMember>>
    RpcV2CborListsRequest& WithStructureList(StructureListT&& value) { SetStructureList(std::forward<StructureListT>(value)); return *this;}
    template<typename StructureListT = StructureListMember>
    RpcV2CborListsRequest& AddStructureList(StructureListT&& value) { m_structureListHasBeenSet = true; m_structureList.emplace_back(std::forward<StructureListT>(value)); return *this; }
    ///@}
    ...
    void SetBlobList(BlobListT&& value) { m_blobListHasBeenSet = true; m_blobList = std::forward<BlobListT>(value); }
    template<typename BlobListT = Aws::Vector<Aws::Utils::ByteBuffer>>
    RpcV2CborListsRequest& WithBlobList(BlobListT&& value) { SetBlobList(std::forward<BlobListT>(value)); return *this;}
    template<typename BlobListT = Aws::Utils::ByteBuffer>
    RpcV2CborListsRequest& AddBlobList(BlobListT&& value) { m_blobListHasBeenSet = true; m_blobList.emplace_back(std::forward<BlobListT>(value)); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    RpcV2CborListsRequest& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
