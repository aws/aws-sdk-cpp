...
class SparseNullsOperationResult {
 public:
  AWS_RPCV2PROTOCOL_API SparseNullsOperationResult() = default;
  AWS_RPCV2PROTOCOL_API SparseNullsOperationResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_RPCV2PROTOCOL_API SparseNullsOperationResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
