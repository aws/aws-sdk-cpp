...
using namespace Aws;
  ...
  RecursiveShapesResult::RecursiveShapesResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result)
    {
  *this = result;
  }
...
else
{
  ...
  decoder->ConsumeNextWholeDataItem();
                        ...
                        if((decoder->LastError() != AWS_ERROR_UNKNOWN)){
                            AWS_LOG_ERROR("RecursiveShapesResult", "Invalid data received for %s", initialKeyStr.c_str());
                            break;
                        }
                    }
                }
