...
namespace Model
{
  ...
  public:
    ...
    template<typename FooT = Aws::String>
    XmlAttributesPayloadRequest& WithFoo(FooT&& value) { SetFoo(std::forward<FooT>(value)); return *this;}
    ///@}
    ...
    template<typename AttrT = Aws::String>
    XmlAttributesPayloadRequest& WithAttr(AttrT&& value) { SetAttr(std::forward<AttrT>(value)); return *this;}
    ///@}
  private:
