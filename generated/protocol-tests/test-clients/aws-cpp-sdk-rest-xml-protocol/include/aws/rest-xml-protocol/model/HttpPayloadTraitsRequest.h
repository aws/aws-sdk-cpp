...
namespace Model
{
  ...
  {
  public:
    AWS_RESTXMLPROTOCOL_API HttpPayloadTraitsRequest() = default;
    ...
    template<typename FooT = Aws::String>
    HttpPayloadTraitsRequest& WithFoo(FooT&& value) { SetFoo(std::forward<FooT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    HttpPayloadTraitsRequest& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
