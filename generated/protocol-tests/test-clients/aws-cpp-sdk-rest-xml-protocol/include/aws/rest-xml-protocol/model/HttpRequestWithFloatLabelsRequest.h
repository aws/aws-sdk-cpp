...
namespace Model
{
  ...
  {
  public:
    AWS_RESTXMLPROTOCOL_API HttpRequestWithFloatLabelsRequest();
    ...
    inline HttpRequestWithFloatLabelsRequest& WithFloat(double value) { SetFloat(value); return *this;}
    ///@}
    ...
    inline HttpRequestWithFloatLabelsRequest& WithDouble(double value) { SetDouble(value); return *this;}
    ///@}
  private:
