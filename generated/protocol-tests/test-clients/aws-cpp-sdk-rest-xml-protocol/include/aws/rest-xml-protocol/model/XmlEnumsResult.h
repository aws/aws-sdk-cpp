...
namespace Model
{
  ...
  public:
    ...
    inline XmlEnumsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}
    inline XmlEnumsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}
    inline XmlEnumsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
    ///@}
  private:
