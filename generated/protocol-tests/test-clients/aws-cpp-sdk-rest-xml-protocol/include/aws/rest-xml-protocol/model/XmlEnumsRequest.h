...
namespace Model
{
  ...
  public:
    ...
    inline XmlEnumsRequest& WithFooEnum1(FooEnum value) { SetFooEnum1(value); return *this;}
    ///@}
    ...
    inline XmlEnumsRequest& WithFooEnum2(FooEnum value) { SetFooEnum2(value); return *this;}
    ///@}
    ...
    inline XmlEnumsRequest& WithFooEnum3(FooEnum value) { SetFooEnum3(value); return *this;}
    ///@}
    ...
    template<typename FooEnumListT = Aws::Vector<FooEnum>>
    XmlEnumsRequest& WithFooEnumList(FooEnumListT&& value) { SetFooEnumList(std::forward<FooEnumListT>(value)); return *this;}
    inline XmlEnumsRequest& AddFooEnumList(FooEnum value) { m_fooEnumListHasBeenSet = true; m_fooEnumList.push_back(value); return *this; }
    ///@}
    ...
    template<typename FooEnumSetT = Aws::Vector<FooEnum>>
    XmlEnumsRequest& WithFooEnumSet(FooEnumSetT&& value) { SetFooEnumSet(std::forward<FooEnumSetT>(value)); return *this;}
    inline XmlEnumsRequest& AddFooEnumSet(FooEnum value) { m_fooEnumSetHasBeenSet = true; m_fooEnumSet.push_back(value); return *this; }
    ///@}
    ...
    template<typename FooEnumMapT = Aws::Map<Aws::String, FooEnum>>
    XmlEnumsRequest& WithFooEnumMap(FooEnumMapT&& value) { SetFooEnumMap(std::forward<FooEnumMapT>(value)); return *this;}
