...
class XmlIntEnumsRequest : public RestXmlProtocolRequest {
 public:
  ...
  inline XmlIntEnumsRequest& WithIntEnum1(int value) {
    SetIntEnum1(value);
    return *this;
  }
  ///@}
  ...
  inline XmlIntEnumsRequest& WithIntEnum2(int value) {
    SetIntEnum2(value);
    return *this;
  }
  ///@}
  ...
  inline XmlIntEnumsRequest& WithIntEnum3(int value) {
    SetIntEnum3(value);
    return *this;
  }
  ///@}
  ...
  template <typename IntEnumListT = Aws::Vector<int>>
  XmlIntEnumsRequest& WithIntEnumList(IntEnumListT&& value) {
    SetIntEnumList(std::forward<IntEnumListT>(value));
    return *this;
  }
  inline XmlIntEnumsRequest& AddIntEnumList(int value) {
    m_intEnumListHasBeenSet = true;
  ...
  template <typename IntEnumSetT = Aws::Vector<int>>
  XmlIntEnumsRequest& WithIntEnumSet(IntEnumSetT&& value) {
    SetIntEnumSet(std::forward<IntEnumSetT>(value));
    return *this;
  }
  inline XmlIntEnumsRequest& AddIntEnumSet(int value) {
    m_intEnumSetHasBeenSet = true;
  ...
  template <typename IntEnumMapT = Aws::Map<Aws::String, int>>
  XmlIntEnumsRequest& WithIntEnumMap(IntEnumMapT&& value) {
