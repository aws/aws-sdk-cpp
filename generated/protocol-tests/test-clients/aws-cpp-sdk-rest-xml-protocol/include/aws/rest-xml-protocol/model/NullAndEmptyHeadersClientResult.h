...
namespace Model
{
  ...
  public:
    ...
    void SetA(AT&& value) { m_a = std::forward<AT>(value); }
    template<typename AT = Aws::String>
    ...
    void SetB(BT&& value) { m_b = std::forward<BT>(value); }
    template<typename BT = Aws::String>
    ...
    void SetC(CT&& value) { m_c = std::forward<CT>(value); }
    template<typename CT = Aws::Vector<Aws::String>>
    NullAndEmptyHeadersClientResult& WithC(CT&& value) { SetC(std::forward<CT>(value)); return *this;}
    template<typename CT = Aws::String>
    NullAndEmptyHeadersClientResult& AddC(CT&& value) { m_c.emplace_back(std::forward<CT>(value)); return *this; }
    ///@}
