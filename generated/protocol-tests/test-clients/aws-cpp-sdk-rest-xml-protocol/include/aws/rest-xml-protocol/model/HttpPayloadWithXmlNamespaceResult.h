...
class HttpPayloadWithXmlNamespaceResult {
 public:
  ...
  AWS_RESTXMLPROTOCOL_API HttpPayloadWithXmlNamespaceResult& operator=(
  ...
  template <typename NestedT = PayloadWithXmlNamespace>
  HttpPayloadWithXmlNamespaceResult& WithNested(NestedT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  HttpPayloadWithXmlNamespaceResult& WithRequestId(RequestIdT&& value) {
