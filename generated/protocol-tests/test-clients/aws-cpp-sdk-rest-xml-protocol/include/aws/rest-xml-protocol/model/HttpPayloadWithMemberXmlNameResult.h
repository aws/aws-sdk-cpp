...
class HttpPayloadWithMemberXmlNameResult {
 public:
  ...
  AWS_RESTXMLPROTOCOL_API HttpPayloadWithMemberXmlNameResult& operator=(
  ...
  template <typename NestedT = PayloadWithXmlName>
  HttpPayloadWithMemberXmlNameResult& WithNested(NestedT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  HttpPayloadWithMemberXmlNameResult& WithRequestId(RequestIdT&& value) {
