...
namespace Model
{
  ...
  public:
    ...
    void SetPayload(PayloadT&& value) { m_payload = std::forward<PayloadT>(value); }
    template<typename PayloadT = XmlAttributesPayloadResponse>
    XmlAttributesOnPayloadResult& WithPayload(PayloadT&& value) { SetPayload(std::forward<PayloadT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    XmlAttributesOnPayloadResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
