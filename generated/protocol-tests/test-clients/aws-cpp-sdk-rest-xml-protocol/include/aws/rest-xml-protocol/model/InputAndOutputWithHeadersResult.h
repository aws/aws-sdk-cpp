...
namespace Model
{
  ...
  public:
    ...
    void SetHeaderString(HeaderStringT&& value) { m_headerString = std::forward<HeaderStringT>(value); }
    template<typename HeaderStringT = Aws::String>
    ...
    void SetHeaderStringList(HeaderStringListT&& value) { m_headerStringList = std::forward<HeaderStringListT>(value); }
    template<typename HeaderStringListT = Aws::Vector<Aws::String>>
    ...
    InputAndOutputWithHeadersResult& AddHeaderStringList(HeaderStringListT&& value) { m_headerStringList.emplace_back(std::forward<HeaderStringListT>(value)); return *this; }
    ///@}
    ...
    void SetHeaderStringSet(HeaderStringSetT&& value) { m_headerStringSet = std::forward<HeaderStringSetT>(value); }
    template<typename HeaderStringSetT = Aws::Vector<Aws::String>>
    ...
    InputAndOutputWithHeadersResult& AddHeaderStringSet(HeaderStringSetT&& value) { m_headerStringSet.emplace_back(std::forward<HeaderStringSetT>(value)); return *this; }
    ///@}
    ...
    void SetHeaderIntegerList(HeaderIntegerListT&& value) { m_headerIntegerList = std::forward<HeaderIntegerListT>(value); }
    template<typename HeaderIntegerListT = Aws::Vector<int>>
    ...
    void SetHeaderBooleanList(HeaderBooleanListT&& value) { m_headerBooleanList = std::forward<HeaderBooleanListT>(value); }
    template<typename HeaderBooleanListT = Aws::Vector<bool>>
    ...
    void SetHeaderTimestampList(HeaderTimestampListT&& value) { m_headerTimestampList = std::forward<HeaderTimestampListT>(value); }
    template<typename HeaderTimestampListT = Aws::Vector<Aws::Utils::DateTime>>
    ...
    InputAndOutputWithHeadersResult& AddHeaderTimestampList(HeaderTimestampListT&& value) { m_headerTimestampList.emplace_back(std::forward<HeaderTimestampListT>(value)); return *this; }
    ///@}

    ///@{
    
    inline FooEnum GetHeaderEnum() const { return m_headerEnum; }
    inline void SetHeaderEnum(FooEnum value) { m_headerEnum = value; }
    ...
    void SetHeaderEnumList(HeaderEnumListT&& value) { m_headerEnumList = std::forward<HeaderEnumListT>(value); }
    template<typename HeaderEnumListT = Aws::Vector<FooEnum>>
    ...
    inline InputAndOutputWithHeadersResult& AddHeaderEnumList(FooEnum value) { m_headerEnumList.push_back(value); return *this; }
    ///@}
