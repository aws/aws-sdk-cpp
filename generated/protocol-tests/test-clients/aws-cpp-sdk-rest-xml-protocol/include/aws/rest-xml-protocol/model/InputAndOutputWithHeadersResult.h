...
namespace Model
{
  ...
  {
  public:
    AWS_RESTXMLPROTOCOL_API InputAndOutputWithHeadersResult() = default;
    AWS_RESTXMLPROTOCOL_API InputAndOutputWithHeadersResult(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    AWS_RESTXMLPROTOCOL_API InputAndOutputWithHeadersResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    ...
    void SetHeaderString(HeaderStringT&& value) { m_headerStringHasBeenSet = true; m_headerString = std::forward<HeaderStringT>(value); }
    template<typename HeaderStringT = Aws::String>
    InputAndOutputWithHeadersResult& WithHeaderString(HeaderStringT&& value) { SetHeaderString(std::forward<HeaderStringT>(value)); return *this;}
    ///@}
    ...
    void SetHeaderStringList(HeaderStringListT&& value) { m_headerStringListHasBeenSet = true; m_headerStringList = std::forward<HeaderStringListT>(value); }
    template<typename HeaderStringListT = Aws::Vector<Aws::String>>
    InputAndOutputWithHeadersResult& WithHeaderStringList(HeaderStringListT&& value) { SetHeaderStringList(std::forward<HeaderStringListT>(value)); return *this;}
    template<typename HeaderStringListT = Aws::String>
    InputAndOutputWithHeadersResult& AddHeaderStringList(HeaderStringListT&& value) { m_headerStringListHasBeenSet = true; m_headerStringList.emplace_back(std::forward<HeaderStringListT>(value)); return *this; }
    ///@}
    ...
    void SetHeaderStringSet(HeaderStringSetT&& value) { m_headerStringSetHasBeenSet = true; m_headerStringSet = std::forward<HeaderStringSetT>(value); }
    template<typename HeaderStringSetT = Aws::Vector<Aws::String>>
    InputAndOutputWithHeadersResult& WithHeaderStringSet(HeaderStringSetT&& value) { SetHeaderStringSet(std::forward<HeaderStringSetT>(value)); return *this;}
    template<typename HeaderStringSetT = Aws::String>
    InputAndOutputWithHeadersResult& AddHeaderStringSet(HeaderStringSetT&& value) { m_headerStringSetHasBeenSet = true; m_headerStringSet.emplace_back(std::forward<HeaderStringSetT>(value)); return *this; }
    ///@}
    ...
    void SetHeaderIntegerList(HeaderIntegerListT&& value) { m_headerIntegerListHasBeenSet = true; m_headerIntegerList = std::forward<HeaderIntegerListT>(value); }
    template<typename HeaderIntegerListT = Aws::Vector<int>>
    InputAndOutputWithHeadersResult& WithHeaderIntegerList(HeaderIntegerListT&& value) { SetHeaderIntegerList(std::forward<HeaderIntegerListT>(value)); return *this;}
    inline InputAndOutputWithHeadersResult& AddHeaderIntegerList(int value) { m_headerIntegerListHasBeenSet = true; m_headerIntegerList.push_back(value); return *this; }
    ///@}
    ...
    void SetHeaderBooleanList(HeaderBooleanListT&& value) { m_headerBooleanListHasBeenSet = true; m_headerBooleanList = std::forward<HeaderBooleanListT>(value); }
    template<typename HeaderBooleanListT = Aws::Vector<bool>>
    InputAndOutputWithHeadersResult& WithHeaderBooleanList(HeaderBooleanListT&& value) { SetHeaderBooleanList(std::forward<HeaderBooleanListT>(value)); return *this;}
    inline InputAndOutputWithHeadersResult& AddHeaderBooleanList(bool value) { m_headerBooleanListHasBeenSet = true; m_headerBooleanList.push_back(value); return *this; }
    ///@}
    ...
    void SetHeaderTimestampList(HeaderTimestampListT&& value) { m_headerTimestampListHasBeenSet = true; m_headerTimestampList = std::forward<HeaderTimestampListT>(value); }
    template<typename HeaderTimestampListT = Aws::Vector<Aws::Utils::DateTime>>
    InputAndOutputWithHeadersResult& WithHeaderTimestampList(HeaderTimestampListT&& value) { SetHeaderTimestampList(std::forward<HeaderTimestampListT>(value)); return *this;}
    template<typename HeaderTimestampListT = Aws::Utils::DateTime>
    InputAndOutputWithHeadersResult& AddHeaderTimestampList(HeaderTimestampListT&& value) { m_headerTimestampListHasBeenSet = true; m_headerTimestampList.emplace_back(std::forward<HeaderTimestampListT>(value)); return *this; }
    ///@}

    ///@{
    
    inline FooEnum GetHeaderEnum() const { return m_headerEnum; }
    inline void SetHeaderEnum(FooEnum value) { m_headerEnumHasBeenSet = true; m_headerEnum = value; }
    inline InputAndOutputWithHeadersResult& WithHeaderEnum(FooEnum value) { SetHeaderEnum(value); return *this;}
    ///@}
    ...
    void SetHeaderEnumList(HeaderEnumListT&& value) { m_headerEnumListHasBeenSet = true; m_headerEnumList = std::forward<HeaderEnumListT>(value); }
    template<typename HeaderEnumListT = Aws::Vector<FooEnum>>
    InputAndOutputWithHeadersResult& WithHeaderEnumList(HeaderEnumListT&& value) { SetHeaderEnumList(std::forward<HeaderEnumListT>(value)); return *this;}
    inline InputAndOutputWithHeadersResult& AddHeaderEnumList(FooEnum value) { m_headerEnumListHasBeenSet = true; m_headerEnumList.push_back(value); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    InputAndOutputWithHeadersResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
