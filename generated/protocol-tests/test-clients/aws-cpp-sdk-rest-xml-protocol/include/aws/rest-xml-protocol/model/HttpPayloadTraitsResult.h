...
class HttpPayloadTraitsResult {
 public:
  AWS_RESTXMLPROTOCOL_API HttpPayloadTraitsResult() = default;
  AWS_RESTXMLPROTOCOL_API HttpPayloadTraitsResult(HttpPayloadTraitsResult&&) = default;
  AWS_RESTXMLPROTOCOL_API HttpPayloadTraitsResult& operator=(HttpPayloadTraitsResult&&) = default;
