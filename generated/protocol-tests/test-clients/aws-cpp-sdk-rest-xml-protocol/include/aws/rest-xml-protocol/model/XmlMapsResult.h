...
namespace Model
{
  ...
  {
  public:
    AWS_RESTXMLPROTOCOL_API XmlMapsResult() = default;
    ...
    void SetMyMap(MyMapT&& value) { m_myMap = std::forward<MyMapT>(value); }
    template<typename MyMapT = Aws::Map<Aws::String, GreetingStruct>>
    XmlMapsResult& WithMyMap(MyMapT&& value) { SetMyMap(std::forward<MyMapT>(value)); return *this;}
    template<typename MyMapKeyT = Aws::String, typename MyMapValueT = GreetingStruct>
    XmlMapsResult& AddMyMap(MyMapKeyT&& key, MyMapValueT&& value) {
      m_myMap.emplace(std::forward<MyMapKeyT>(key), std::forward<MyMapValueT>(value)); return *this;
    }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    XmlMapsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
