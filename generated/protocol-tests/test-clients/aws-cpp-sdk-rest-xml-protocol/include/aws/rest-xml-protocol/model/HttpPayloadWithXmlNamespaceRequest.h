...
namespace Model
{
  ...
  public:
    ...
    template<typename NestedT = PayloadWithXmlNamespace>
    HttpPayloadWithXmlNamespaceRequest& WithNested(NestedT&& value) { SetNested(std::forward<NestedT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    HttpPayloadWithXmlNamespaceRequest& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
