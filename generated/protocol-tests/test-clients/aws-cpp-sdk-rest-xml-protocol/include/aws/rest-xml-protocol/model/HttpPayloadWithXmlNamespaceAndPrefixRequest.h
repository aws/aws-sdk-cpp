...
namespace Model
{
  ...
  public:
    ...
    template<typename NestedT = PayloadWithXmlNamespaceAndPrefix>
    HttpPayloadWithXmlNamespaceAndPrefixRequest& WithNested(NestedT&& value) { SetNested(std::forward<NestedT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    HttpPayloadWithXmlNamespaceAndPrefixRequest& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
