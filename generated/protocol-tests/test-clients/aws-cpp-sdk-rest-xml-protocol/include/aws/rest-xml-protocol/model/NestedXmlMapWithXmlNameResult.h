...
namespace Model
{
  ...
  public:
    ...
    void SetNestedXmlMapWithXmlNameMap(NestedXmlMapWithXmlNameMapT&& value) { m_nestedXmlMapWithXmlNameMap = std::forward<NestedXmlMapWithXmlNameMapT>(value); }
    template<typename NestedXmlMapWithXmlNameMapT = Aws::Map<Aws::String, Aws::Map<Aws::String, Aws::String>>>
    ...
    NestedXmlMapWithXmlNameResult& AddNestedXmlMapWithXmlNameMap(NestedXmlMapWithXmlNameMapKeyT&& key, NestedXmlMapWithXmlNameMapValueT&& value) {
      m_nestedXmlMapWithXmlNameMap.emplace(std::forward<NestedXmlMapWithXmlNameMapKeyT>(key), std::forward<NestedXmlMapWithXmlNameMapValueT>(value)); return *this;
    }
    ///@}
