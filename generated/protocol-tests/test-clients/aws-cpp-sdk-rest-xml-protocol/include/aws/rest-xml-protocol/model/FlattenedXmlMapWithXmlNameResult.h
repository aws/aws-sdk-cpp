...
class FlattenedXmlMapWithXmlNameResult {
 public:
  ...
  AWS_RESTXMLPROTOCOL_API FlattenedXmlMapWithXmlNameResult& operator=(
  ...
  template <typename MyMapT = Aws::Map<Aws::String, Aws::String>>
  FlattenedXmlMapWithXmlNameResult& WithMyMap(MyMapT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  FlattenedXmlMapWithXmlNameResult& WithRequestId(RequestIdT&& value) {
