...
namespace Model
{
  ...
  public:
    ...
    template<typename NestedT = PayloadWithXmlName>
    BodyWithXmlNameResult& WithNested(NestedT&& value) { SetNested(std::forward<NestedT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    BodyWithXmlNameResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
