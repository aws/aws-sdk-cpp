...
namespace Model
{
  ...
  {
  public:
    AWS_RESTXMLPROTOCOL_API XmlListsRequest() = default;
    ...
    template<typename StringListT = Aws::Vector<Aws::String>>
    XmlListsRequest& WithStringList(StringListT&& value) { SetStringList(std::forward<StringListT>(value)); return *this;}
    template<typename StringListT = Aws::String>
    XmlListsRequest& AddStringList(StringListT&& value) { m_stringListHasBeenSet = true; m_stringList.emplace_back(std::forward<StringListT>(value)); return *this; }
    ///@}
    ...
    template<typename StringSetT = Aws::Vector<Aws::String>>
    XmlListsRequest& WithStringSet(StringSetT&& value) { SetStringSet(std::forward<StringSetT>(value)); return *this;}
    template<typename StringSetT = Aws::String>
    XmlListsRequest& AddStringSet(StringSetT&& value) { m_stringSetHasBeenSet = true; m_stringSet.emplace_back(std::forward<StringSetT>(value)); return *this; }
    ///@}
    ...
    template<typename IntegerListT = Aws::Vector<int>>
    XmlListsRequest& WithIntegerList(IntegerListT&& value) { SetIntegerList(std::forward<IntegerListT>(value)); return *this;}
    ...
    template<typename BooleanListT = Aws::Vector<bool>>
    XmlListsRequest& WithBooleanList(BooleanListT&& value) { SetBooleanList(std::forward<BooleanListT>(value)); return *this;}
    ...
    template<typename TimestampListT = Aws::Vector<Aws::Utils::DateTime>>
    XmlListsRequest& WithTimestampList(TimestampListT&& value) { SetTimestampList(std::forward<TimestampListT>(value)); return *this;}
    template<typename TimestampListT = Aws::Utils::DateTime>
    XmlListsRequest& AddTimestampList(TimestampListT&& value) { m_timestampListHasBeenSet = true; m_timestampList.emplace_back(std::forward<TimestampListT>(value)); return *this; }
    ///@}
    ...
    template<typename EnumListT = Aws::Vector<FooEnum>>
    XmlListsRequest& WithEnumList(EnumListT&& value) { SetEnumList(std::forward<EnumListT>(value)); return *this;}
    inline XmlListsRequest& AddEnumList(FooEnum value) { m_enumListHasBeenSet = true; m_enumList.push_back(value); return *this; }
    ///@}
    ...
    template<typename IntEnumListT = Aws::Vector<int>>
    XmlListsRequest& WithIntEnumList(IntEnumListT&& value) { SetIntEnumList(std::forward<IntEnumListT>(value)); return *this;}
    ...
    template<typename NestedStringListT = Aws::Vector<Aws::Vector<Aws::String>>>
    XmlListsRequest& WithNestedStringList(NestedStringListT&& value) { SetNestedStringList(std::forward<NestedStringListT>(value)); return *this;}
    template<typename NestedStringListT = Aws::Vector<Aws::String>>
    XmlListsRequest& AddNestedStringList(NestedStringListT&& value) { m_nestedStringListHasBeenSet = true; m_nestedStringList.emplace_back(std::forward<NestedStringListT>(value)); return *this; }
    ///@}
    ...
    template<typename RenamedListMembersT = Aws::Vector<Aws::String>>
    XmlListsRequest& WithRenamedListMembers(RenamedListMembersT&& value) { SetRenamedListMembers(std::forward<RenamedListMembersT>(value)); return *this;}
    template<typename RenamedListMembersT = Aws::String>
    XmlListsRequest& AddRenamedListMembers(RenamedListMembersT&& value) { m_renamedListMembersHasBeenSet = true; m_renamedListMembers.emplace_back(std::forward<RenamedListMembersT>(value)); return *this; }
    ///@}
    ...
    template<typename FlattenedListT = Aws::Vector<Aws::String>>
    XmlListsRequest& WithFlattenedList(FlattenedListT&& value) { SetFlattenedList(std::forward<FlattenedListT>(value)); return *this;}
    template<typename FlattenedListT = Aws::String>
    XmlListsRequest& AddFlattenedList(FlattenedListT&& value) { m_flattenedListHasBeenSet = true; m_flattenedList.emplace_back(std::forward<FlattenedListT>(value)); return *this; }
    ///@}
    ...
    template<typename FlattenedList2T = Aws::Vector<Aws::String>>
    XmlListsRequest& WithFlattenedList2(FlattenedList2T&& value) { SetFlattenedList2(std::forward<FlattenedList2T>(value)); return *this;}
    template<typename FlattenedList2T = Aws::String>
    XmlListsRequest& AddFlattenedList2(FlattenedList2T&& value) { m_flattenedList2HasBeenSet = true; m_flattenedList2.emplace_back(std::forward<FlattenedList2T>(value)); return *this; }
    ///@}
    ...
    template<typename FlattenedListWithMemberNamespaceT = Aws::Vector<Aws::String>>
    XmlListsRequest& WithFlattenedListWithMemberNamespace(FlattenedListWithMemberNamespaceT&& value) { SetFlattenedListWithMemberNamespace(std::forward<FlattenedListWithMemberNamespaceT>(value)); return *this;}
    template<typename FlattenedListWithMemberNamespaceT = Aws::String>
    XmlListsRequest& AddFlattenedListWithMemberNamespace(FlattenedListWithMemberNamespaceT&& value) { m_flattenedListWithMemberNamespaceHasBeenSet = true; m_flattenedListWithMemberNamespace.emplace_back(std::forward<FlattenedListWithMemberNamespaceT>(value)); return *this; }
    ///@}
    ...
    template<typename FlattenedListWithNamespaceT = Aws::Vector<Aws::String>>
    XmlListsRequest& WithFlattenedListWithNamespace(FlattenedListWithNamespaceT&& value) { SetFlattenedListWithNamespace(std::forward<FlattenedListWithNamespaceT>(value)); return *this;}
    template<typename FlattenedListWithNamespaceT = Aws::String>
    XmlListsRequest& AddFlattenedListWithNamespace(FlattenedListWithNamespaceT&& value) { m_flattenedListWithNamespaceHasBeenSet = true; m_flattenedListWithNamespace.emplace_back(std::forward<FlattenedListWithNamespaceT>(value)); return *this; }
    ///@}
    ...
    template<typename StructureListT = Aws::Vector<StructureListMember>>
    XmlListsRequest& WithStructureList(StructureListT&& value) { SetStructureList(std::forward<StructureListT>(value)); return *this;}
    template<typename StructureListT = StructureListMember>
    XmlListsRequest& AddStructureList(StructureListT&& value) { m_structureListHasBeenSet = true; m_structureList.emplace_back(std::forward<StructureListT>(value)); return *this; }
    ///@}
    ...
    template<typename FlattenedStructureListT = Aws::Vector<StructureListMember>>
    XmlListsRequest& WithFlattenedStructureList(FlattenedStructureListT&& value) { SetFlattenedStructureList(std::forward<FlattenedStructureListT>(value)); return *this;}
    template<typename FlattenedStructureListT = StructureListMember>
    XmlListsRequest& AddFlattenedStructureList(FlattenedStructureListT&& value) { m_flattenedStructureListHasBeenSet = true; m_flattenedStructureList.emplace_back(std::forward<FlattenedStructureListT>(value)); return *this; }
    ///@}
  private:
