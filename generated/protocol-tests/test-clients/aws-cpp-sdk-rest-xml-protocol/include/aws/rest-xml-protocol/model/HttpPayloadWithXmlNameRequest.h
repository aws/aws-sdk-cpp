...
namespace Model
{
  ...
  {
  public:
    AWS_RESTXMLPROTOCOL_API HttpPayloadWithXmlNameRequest() = default;
    ...
    template<typename NestedT = PayloadWithXmlName>
    HttpPayloadWithXmlNameRequest& WithNested(NestedT&& value) { SetNested(std::forward<NestedT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    HttpPayloadWithXmlNameRequest& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
