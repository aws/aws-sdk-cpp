...
namespace Model
{
  ...
  public:
    ...
    void SetNestedMap(NestedMapT&& value) { m_nestedMap = std::forward<NestedMapT>(value); }
    template<typename NestedMapT = Aws::Map<Aws::String, Aws::Map<Aws::String, FooEnum>>>
    NestedXmlMapsResult& WithNestedMap(NestedMapT&& value) { SetNestedMap(std::forward<NestedMapT>(value)); return *this;}
    ...
    NestedXmlMapsResult& AddNestedMap(NestedMapKeyT&& key, NestedMapValueT&& value) {
      m_nestedMap.emplace(std::forward<NestedMapKeyT>(key), std::forward<NestedMapValueT>(value)); return *this;
    }
    ///@}
    ...
    void SetFlatNestedMap(FlatNestedMapT&& value) { m_flatNestedMap = std::forward<FlatNestedMapT>(value); }
    template<typename FlatNestedMapT = Aws::Map<Aws::String, Aws::Map<Aws::String, FooEnum>>>
    NestedXmlMapsResult& WithFlatNestedMap(FlatNestedMapT&& value) { SetFlatNestedMap(std::forward<FlatNestedMapT>(value)); return *this;}
    ...
    NestedXmlMapsResult& AddFlatNestedMap(FlatNestedMapKeyT&& key, FlatNestedMapValueT&& value) {
      m_flatNestedMap.emplace(std::forward<FlatNestedMapKeyT>(key), std::forward<FlatNestedMapValueT>(value)); return *this;
    }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    NestedXmlMapsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
