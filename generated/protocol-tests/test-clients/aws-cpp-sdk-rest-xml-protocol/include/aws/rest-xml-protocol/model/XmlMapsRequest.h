...
namespace Model
{
  ...
  {
  public:
    AWS_RESTXMLPROTOCOL_API XmlMapsRequest() = default;
    ...
    template<typename MyMapT = Aws::Map<Aws::String, GreetingStruct>>
    XmlMapsRequest& WithMyMap(MyMapT&& value) { SetMyMap(std::forward<MyMapT>(value)); return *this;}
    template<typename MyMapKeyT = Aws::String, typename MyMapValueT = GreetingStruct>
    XmlMapsRequest& AddMyMap(MyMapKeyT&& key, MyMapValueT&& value) {
