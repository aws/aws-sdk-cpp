...
namespace Model
{
  ...
  {
  public:
    AWS_RESTXMLPROTOCOL_API XmlMapsXmlNameResult();
    AWS_RESTXMLPROTOCOL_API XmlMapsXmlNameResult(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    AWS_RESTXMLPROTOCOL_API XmlMapsXmlNameResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    ...
    inline XmlMapsXmlNameResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}
    inline XmlMapsXmlNameResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}
    inline XmlMapsXmlNameResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
    ///@}
  private:
