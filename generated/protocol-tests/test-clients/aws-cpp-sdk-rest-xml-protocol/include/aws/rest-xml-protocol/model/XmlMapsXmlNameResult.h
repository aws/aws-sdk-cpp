...
namespace Model
{
  ...
  {
  public:
    AWS_RESTXMLPROTOCOL_API XmlMapsXmlNameResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    XmlMapsXmlNameResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
