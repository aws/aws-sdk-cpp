...
namespace Model
{
  ...
  public:
    ...
    template<typename NormalT = Aws::Utils::DateTime>
    XmlTimestampsRequest& WithNormal(NormalT&& value) { SetNormal(std::forward<NormalT>(value)); return *this;}
    ///@}
    ...
    template<typename DateTimeT = Aws::Utils::DateTime>
    XmlTimestampsRequest& WithDateTime(DateTimeT&& value) { SetDateTime(std::forward<DateTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename DateTimeOnTargetT = Aws::Utils::DateTime>
    XmlTimestampsRequest& WithDateTimeOnTarget(DateTimeOnTargetT&& value) { SetDateTimeOnTarget(std::forward<DateTimeOnTargetT>(value)); return *this;}
    ///@}
    ...
    template<typename EpochSecondsT = Aws::Utils::DateTime>
    XmlTimestampsRequest& WithEpochSeconds(EpochSecondsT&& value) { SetEpochSeconds(std::forward<EpochSecondsT>(value)); return *this;}
    ///@}
    ...
    template<typename EpochSecondsOnTargetT = Aws::Utils::DateTime>
    XmlTimestampsRequest& WithEpochSecondsOnTarget(EpochSecondsOnTargetT&& value) { SetEpochSecondsOnTarget(std::forward<EpochSecondsOnTargetT>(value)); return *this;}
    ///@}
    ...
    template<typename HttpDateT = Aws::Utils::DateTime>
    XmlTimestampsRequest& WithHttpDate(HttpDateT&& value) { SetHttpDate(std::forward<HttpDateT>(value)); return *this;}
    ///@}
    ...
    template<typename HttpDateOnTargetT = Aws::Utils::DateTime>
    XmlTimestampsRequest& WithHttpDateOnTarget(HttpDateOnTargetT&& value) { SetHttpDateOnTarget(std::forward<HttpDateOnTargetT>(value)); return *this;}
    ///@}
  private:
