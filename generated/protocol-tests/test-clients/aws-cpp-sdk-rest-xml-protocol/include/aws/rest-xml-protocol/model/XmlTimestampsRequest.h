...
namespace Model
{
  ...
  {
  public:
    AWS_RESTXMLPROTOCOL_API XmlTimestampsRequest();
    ...
    inline XmlTimestampsRequest& WithNormal(const Aws::Utils::DateTime& value) { SetNormal(value); return *this;}
    inline XmlTimestampsRequest& WithNormal(Aws::Utils::DateTime&& value) { SetNormal(std::move(value)); return *this;}
    ///@}
    ...
    inline XmlTimestampsRequest& WithDateTime(const Aws::Utils::DateTime& value) { SetDateTime(value); return *this;}
    inline XmlTimestampsRequest& WithDateTime(Aws::Utils::DateTime&& value) { SetDateTime(std::move(value)); return *this;}
    ///@}
    ...
    inline XmlTimestampsRequest& WithDateTimeOnTarget(const Aws::Utils::DateTime& value) { SetDateTimeOnTarget(value); return *this;}
    inline XmlTimestampsRequest& WithDateTimeOnTarget(Aws::Utils::DateTime&& value) { SetDateTimeOnTarget(std::move(value)); return *this;}
    ///@}
    ...
    inline XmlTimestampsRequest& WithEpochSeconds(const Aws::Utils::DateTime& value) { SetEpochSeconds(value); return *this;}
    inline XmlTimestampsRequest& WithEpochSeconds(Aws::Utils::DateTime&& value) { SetEpochSeconds(std::move(value)); return *this;}
    ///@}
    ...
    inline XmlTimestampsRequest& WithEpochSecondsOnTarget(const Aws::Utils::DateTime& value) { SetEpochSecondsOnTarget(value); return *this;}
    inline XmlTimestampsRequest& WithEpochSecondsOnTarget(Aws::Utils::DateTime&& value) { SetEpochSecondsOnTarget(std::move(value)); return *this;}
    ///@}
    ...
    inline XmlTimestampsRequest& WithHttpDate(const Aws::Utils::DateTime& value) { SetHttpDate(value); return *this;}
    inline XmlTimestampsRequest& WithHttpDate(Aws::Utils::DateTime&& value) { SetHttpDate(std::move(value)); return *this;}
    ///@}
    ...
    inline XmlTimestampsRequest& WithHttpDateOnTarget(const Aws::Utils::DateTime& value) { SetHttpDateOnTarget(value); return *this;}
    inline XmlTimestampsRequest& WithHttpDateOnTarget(Aws::Utils::DateTime&& value) { SetHttpDateOnTarget(std::move(value)); return *this;}
    ///@}
  private:
