...
class XmlEmptyListsResult {
 public:
  ...
  template <typename FlattenedStructureListT = Aws::Vector<StructureListMember>>
  XmlEmptyListsResult& WithFlattenedStructureList(FlattenedStructureListT&& value) {
  ...
  XmlEmptyListsResult& AddFlattenedStructureList(FlattenedStructureListT&& value) {
    m_flattenedStructureListHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  XmlEmptyListsResult& WithRequestId(RequestIdT&& value) {
