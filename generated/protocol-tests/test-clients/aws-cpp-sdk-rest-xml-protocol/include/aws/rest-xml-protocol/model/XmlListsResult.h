...
namespace Model
{
  ...
  public:
    ...
    XmlListsResult& AddFlattenedStructureList(FlattenedStructureListT&& value) { m_flattenedStructureList.emplace_back(std::forward<FlattenedStructureListT>(value)); return *this; }
    ///@}
