...
namespace Model
{
  ...
  public:
    ...
    void SetQueryParamsMapOfStrings(QueryParamsMapOfStringsT&& value) { m_queryParamsMapOfStringsHasBeenSet = true; m_queryParamsMapOfStrings = std::forward<QueryParamsMapOfStringsT>(value); }
    template<typename QueryParamsMapOfStringsT = Aws::Map<Aws::String, Aws::String>>
    AllQueryStringTypesRequest& WithQueryParamsMapOfStrings(QueryParamsMapOfStringsT&& value) { SetQueryParamsMapOfStrings(std::forward<QueryParamsMapOfStringsT>(value)); return *this;}
    ...
    AllQueryStringTypesRequest& AddQueryParamsMapOfStrings(QueryParamsMapOfStringsKeyT&& key, QueryParamsMapOfStringsValueT&& value) {
      m_queryParamsMapOfStringsHasBeenSet = true; m_queryParamsMapOfStrings.emplace(std::forward<QueryParamsMapOfStringsKeyT>(key), std::forward<QueryParamsMapOfStringsValueT>(value)); return *this;
    }
    ///@}
  private:
