...
namespace Model
{
  ...
  public:
    ...
    template<typename FooT = Aws::String>
    HttpRequestWithGreedyLabelInPathRequest& WithFoo(FooT&& value) { SetFoo(std::forward<FooT>(value)); return *this;}
    ///@}
    ...
    template<typename BazT = Aws::String>
    HttpRequestWithGreedyLabelInPathRequest& WithBaz(BazT&& value) { SetBaz(std::forward<BazT>(value)); return *this;}
    ///@}
  private:
