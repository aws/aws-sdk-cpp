...
namespace Model
{
  ...
  public:
    ...
    template<typename FooT = Aws::String>
    XmlAttributesRequest& WithFoo(FooT&& value) { SetFoo(std::forward<FooT>(value)); return *this;}
    ///@}
    ...
    template<typename AttrT = Aws::String>
    XmlAttributesRequest& WithAttr(AttrT&& value) { SetAttr(std::forward<AttrT>(value)); return *this;}
    ///@}
  private:
