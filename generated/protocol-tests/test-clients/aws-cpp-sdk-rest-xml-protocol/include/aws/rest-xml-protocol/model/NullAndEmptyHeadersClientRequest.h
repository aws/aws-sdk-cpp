...
namespace Model
{
  ...
  {
  public:
    AWS_RESTXMLPROTOCOL_API NullAndEmptyHeadersClientRequest() = default;
    ...
    template<typename AT = Aws::String>
    NullAndEmptyHeadersClientRequest& WithA(AT&& value) { SetA(std::forward<AT>(value)); return *this;}
    ///@}
    ...
    template<typename BT = Aws::String>
    NullAndEmptyHeadersClientRequest& WithB(BT&& value) { SetB(std::forward<BT>(value)); return *this;}
    ///@}
    ...
    template<typename CT = Aws::Vector<Aws::String>>
    NullAndEmptyHeadersClientRequest& WithC(CT&& value) { SetC(std::forward<CT>(value)); return *this;}
    template<typename CT = Aws::String>
    NullAndEmptyHeadersClientRequest& AddC(CT&& value) { m_cHasBeenSet = true; m_c.emplace_back(std::forward<CT>(value)); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    NullAndEmptyHeadersClientRequest& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
