...
class NullAndEmptyHeadersClientRequest : public RestXmlProtocolRequest {
 public:
  ...
  template <typename AT = Aws::String>
  NullAndEmptyHeadersClientRequest& WithA(AT&& value) {
  ...
  template <typename BT = Aws::String>
  NullAndEmptyHeadersClientRequest& WithB(BT&& value) {
  ...
  template <typename CT = Aws::Vector<Aws::String>>
  NullAndEmptyHeadersClientRequest& WithC(CT&& value) {
    SetC(std::forward<CT>(value));
    return *this;
  }
  template <typename CT = Aws::String>
  NullAndEmptyHeadersClientRequest& AddC(CT&& value) {
    m_cHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  NullAndEmptyHeadersClientRequest& WithRequestId(RequestIdT&& value) {
