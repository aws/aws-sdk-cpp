...
namespace Model
{
  ...
  public:
    ...
    void SetEmptyString(EmptyStringT&& value) { m_emptyString = std::forward<EmptyStringT>(value); }
    template<typename EmptyStringT = Aws::String>
    XmlEmptyStringsResult& WithEmptyString(EmptyStringT&& value) { SetEmptyString(std::forward<EmptyStringT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    XmlEmptyStringsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
