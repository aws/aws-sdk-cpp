...
namespace Model
{
  ...
  public:
    ...
    template<typename MyMapT = Aws::Map<Aws::String, Aws::String>>
    XmlMapWithXmlNamespaceResult& WithMyMap(MyMapT&& value) { SetMyMap(std::forward<MyMapT>(value)); return *this;}
    ...
    template<typename RequestIdT = Aws::String>
    XmlMapWithXmlNamespaceResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
