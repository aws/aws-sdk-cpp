...
namespace Model
{
  ...
  {
  public:
    AWS_RESTXMLPROTOCOL_API XmlIntEnumsResult() = default;
    ...
    template<typename IntEnumListT = Aws::Vector<int>>
    XmlIntEnumsResult& WithIntEnumList(IntEnumListT&& value) { SetIntEnumList(std::forward<IntEnumListT>(value)); return *this;}
    inline XmlIntEnumsResult& AddIntEnumList(int value) { m_intEnumListHasBeenSet = true; m_intEnumList.push_back(value); return *this; }
    ///@}
    ...
    template<typename IntEnumSetT = Aws::Vector<int>>
    XmlIntEnumsResult& WithIntEnumSet(IntEnumSetT&& value) { SetIntEnumSet(std::forward<IntEnumSetT>(value)); return *this;}
    inline XmlIntEnumsResult& AddIntEnumSet(int value) { m_intEnumSetHasBeenSet = true; m_intEnumSet.push_back(value); return *this; }
    ///@}
    ...
    template<typename IntEnumMapT = Aws::Map<Aws::String, int>>
    XmlIntEnumsResult& WithIntEnumMap(IntEnumMapT&& value) { SetIntEnumMap(std::forward<IntEnumMapT>(value)); return *this;}
    ...
    template<typename RequestIdT = Aws::String>
    XmlIntEnumsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
