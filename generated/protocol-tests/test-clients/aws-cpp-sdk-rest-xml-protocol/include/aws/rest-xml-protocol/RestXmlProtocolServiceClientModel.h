...
namespace Aws
{
  ...
  namespace RestXmlProtocol
  {
    ...
    typedef std::function<void(const RestXmlProtocolClient*, const Model::AllQueryStringTypesRequest&, const Model::AllQueryStringTypesOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > AllQueryStringTypesResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::BodyWithXmlNameRequest&, const Model::BodyWithXmlNameOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > BodyWithXmlNameResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::ConstantAndVariableQueryStringRequest&, const Model::ConstantAndVariableQueryStringOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > ConstantAndVariableQueryStringResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::ConstantQueryStringRequest&, const Model::ConstantQueryStringOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > ConstantQueryStringResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::ContentTypeParametersRequest&, const Model::ContentTypeParametersOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > ContentTypeParametersResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::DatetimeOffsetsRequest&, const Model::DatetimeOffsetsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > DatetimeOffsetsResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::EmptyInputAndEmptyOutputRequest&, const Model::EmptyInputAndEmptyOutputOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > EmptyInputAndEmptyOutputResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::EndpointOperationRequest&, const Model::EndpointOperationOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > EndpointOperationResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::EndpointWithHostLabelHeaderOperationRequest&, const Model::EndpointWithHostLabelHeaderOperationOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > EndpointWithHostLabelHeaderOperationResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::EndpointWithHostLabelOperationRequest&, const Model::EndpointWithHostLabelOperationOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > EndpointWithHostLabelOperationResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::FlattenedXmlMapRequest&, const Model::FlattenedXmlMapOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > FlattenedXmlMapResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::FlattenedXmlMapWithXmlNameRequest&, const Model::FlattenedXmlMapWithXmlNameOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > FlattenedXmlMapWithXmlNameResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::FlattenedXmlMapWithXmlNamespaceRequest&, const Model::FlattenedXmlMapWithXmlNamespaceOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > FlattenedXmlMapWithXmlNamespaceResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::FractionalSecondsRequest&, const Model::FractionalSecondsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > FractionalSecondsResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::GreetingWithErrorsRequest&, const Model::GreetingWithErrorsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > GreetingWithErrorsResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::HttpEnumPayloadRequest&, const Model::HttpEnumPayloadOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > HttpEnumPayloadResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::HttpPayloadTraitsRequest&, Model::HttpPayloadTraitsOutcome, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > HttpPayloadTraitsResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::HttpPayloadWithMemberXmlNameRequest&, const Model::HttpPayloadWithMemberXmlNameOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > HttpPayloadWithMemberXmlNameResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::HttpPayloadWithStructureRequest&, const Model::HttpPayloadWithStructureOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > HttpPayloadWithStructureResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::HttpPayloadWithUnionRequest&, const Model::HttpPayloadWithUnionOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > HttpPayloadWithUnionResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::HttpPayloadWithXmlNameRequest&, const Model::HttpPayloadWithXmlNameOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > HttpPayloadWithXmlNameResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::HttpPayloadWithXmlNamespaceRequest&, const Model::HttpPayloadWithXmlNamespaceOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > HttpPayloadWithXmlNamespaceResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::HttpPayloadWithXmlNamespaceAndPrefixRequest&, const Model::HttpPayloadWithXmlNamespaceAndPrefixOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > HttpPayloadWithXmlNamespaceAndPrefixResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::HttpPrefixHeadersRequest&, const Model::HttpPrefixHeadersOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > HttpPrefixHeadersResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::HttpRequestWithFloatLabelsRequest&, const Model::HttpRequestWithFloatLabelsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > HttpRequestWithFloatLabelsResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::HttpRequestWithGreedyLabelInPathRequest&, const Model::HttpRequestWithGreedyLabelInPathOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > HttpRequestWithGreedyLabelInPathResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::HttpRequestWithLabelsRequest&, const Model::HttpRequestWithLabelsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > HttpRequestWithLabelsResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::HttpRequestWithLabelsAndTimestampFormatRequest&, const Model::HttpRequestWithLabelsAndTimestampFormatOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > HttpRequestWithLabelsAndTimestampFormatResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::HttpResponseCodeRequest&, const Model::HttpResponseCodeOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > HttpResponseCodeResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::HttpStringPayloadRequest&, Model::HttpStringPayloadOutcome, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > HttpStringPayloadResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::IgnoreQueryParamsInResponseRequest&, const Model::IgnoreQueryParamsInResponseOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > IgnoreQueryParamsInResponseResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::InputAndOutputWithHeadersRequest&, const Model::InputAndOutputWithHeadersOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > InputAndOutputWithHeadersResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::NestedXmlMapWithXmlNameRequest&, const Model::NestedXmlMapWithXmlNameOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > NestedXmlMapWithXmlNameResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::NestedXmlMapsRequest&, const Model::NestedXmlMapsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > NestedXmlMapsResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::NoInputAndNoOutputRequest&, const Model::NoInputAndNoOutputOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > NoInputAndNoOutputResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::NoInputAndOutputRequest&, const Model::NoInputAndOutputOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > NoInputAndOutputResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::NullAndEmptyHeadersClientRequest&, const Model::NullAndEmptyHeadersClientOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > NullAndEmptyHeadersClientResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::NullAndEmptyHeadersServerRequest&, const Model::NullAndEmptyHeadersServerOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > NullAndEmptyHeadersServerResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::OmitsNullSerializesEmptyStringRequest&, const Model::OmitsNullSerializesEmptyStringOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > OmitsNullSerializesEmptyStringResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::PutWithContentEncodingRequest&, const Model::PutWithContentEncodingOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > PutWithContentEncodingResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::QueryIdempotencyTokenAutoFillRequest&, const Model::QueryIdempotencyTokenAutoFillOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > QueryIdempotencyTokenAutoFillResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::QueryParamsAsStringListMapRequest&, const Model::QueryParamsAsStringListMapOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > QueryParamsAsStringListMapResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::QueryPrecedenceRequest&, const Model::QueryPrecedenceOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > QueryPrecedenceResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::RecursiveShapesRequest&, const Model::RecursiveShapesOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > RecursiveShapesResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::SimpleScalarPropertiesRequest&, const Model::SimpleScalarPropertiesOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > SimpleScalarPropertiesResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::TimestampFormatHeadersRequest&, const Model::TimestampFormatHeadersOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > TimestampFormatHeadersResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::XmlAttributesRequest&, const Model::XmlAttributesOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > XmlAttributesResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::XmlAttributesOnPayloadRequest&, const Model::XmlAttributesOnPayloadOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > XmlAttributesOnPayloadResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::XmlBlobsRequest&, const Model::XmlBlobsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > XmlBlobsResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::XmlEmptyBlobsRequest&, const Model::XmlEmptyBlobsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > XmlEmptyBlobsResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::XmlEmptyListsRequest&, const Model::XmlEmptyListsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > XmlEmptyListsResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::XmlEmptyMapsRequest&, const Model::XmlEmptyMapsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > XmlEmptyMapsResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::XmlEmptyStringsRequest&, const Model::XmlEmptyStringsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > XmlEmptyStringsResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::XmlEnumsRequest&, const Model::XmlEnumsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > XmlEnumsResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::XmlIntEnumsRequest&, const Model::XmlIntEnumsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > XmlIntEnumsResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::XmlListsRequest&, const Model::XmlListsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > XmlListsResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::XmlMapWithXmlNamespaceRequest&, const Model::XmlMapWithXmlNamespaceOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > XmlMapWithXmlNamespaceResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::XmlMapsRequest&, const Model::XmlMapsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > XmlMapsResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::XmlMapsXmlNameRequest&, const Model::XmlMapsXmlNameOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > XmlMapsXmlNameResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::XmlNamespacesRequest&, const Model::XmlNamespacesOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > XmlNamespacesResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::XmlTimestampsRequest&, const Model::XmlTimestampsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > XmlTimestampsResponseReceivedHandler;
    typedef std::function<void(const RestXmlProtocolClient*, const Model::XmlUnionsRequest&, const Model::XmlUnionsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > XmlUnionsResponseReceivedHandler;
