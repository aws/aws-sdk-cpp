...
namespace RestXmlProtocol
{
   ...
   */
  class AWS_RESTXMLPROTOCOL_API RestXmlProtocolClient : public Aws::Client::AWSXMLClient, public Aws::Client::ClientWithAsyncTemplateMethods<RestXmlProtocolClient>
  {
    public:
      ...
      typedef RestXmlProtocolEndpointProvider EndpointProviderType;
        ...
        */
        RestXmlProtocolClient(const Aws::RestXmlProtocol::RestXmlProtocolClientConfiguration& clientConfiguration = Aws::RestXmlProtocol::RestXmlProtocolClientConfiguration(),
        ...
        */
        RestXmlProtocolClient(const Aws::Auth::AWSCredentials& credentials,
                              std::shared_ptr<RestXmlProtocolEndpointProviderBase> endpointProvider = nullptr,
                              const Aws::RestXmlProtocol::RestXmlProtocolClientConfiguration& clientConfiguration = Aws::RestXmlProtocol::RestXmlProtocolClientConfiguration());
        ...
        */
        ...
        /**
         * A Callable wrapper for AllQueryStringTypes that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for AllQueryStringTypes that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename AllQueryStringTypesRequestT = Model::AllQueryStringTypesRequest>
        void AllQueryStringTypesAsync(const AllQueryStringTypesResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const AllQueryStringTypesRequestT& request = {}) const
        {
        ...
        /**
         * An Async wrapper for BodyWithXmlName that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename BodyWithXmlNameRequestT = Model::BodyWithXmlNameRequest>
        void BodyWithXmlNameAsync(const BodyWithXmlNameResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const BodyWithXmlNameRequestT& request = {}) const
        {
         ...
         * API Reference</a></p>
         */
        virtual Model::ConstantAndVariableQueryStringOutcome ConstantAndVariableQueryString(const Model::ConstantAndVariableQueryStringRequest& request = {}) const;

        /**
         * A Callable wrapper for ConstantAndVariableQueryString that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        template<typename ConstantAndVariableQueryStringRequestT = Model::ConstantAndVariableQueryStringRequest>
        Model::ConstantAndVariableQueryStringOutcomeCallable ConstantAndVariableQueryStringCallable(const ConstantAndVariableQueryStringRequestT& request = {}) const
        {
            return SubmitCallable(&RestXmlProtocolClient::ConstantAndVariableQueryString, request);
        }

        /**
         * An Async wrapper for ConstantAndVariableQueryString that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename ConstantAndVariableQueryStringRequestT = Model::ConstantAndVariableQueryStringRequest>
        void ConstantAndVariableQueryStringAsync(const ConstantAndVariableQueryStringResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const ConstantAndVariableQueryStringRequestT& request = {}) const
        {
        ...
        /**
         * A Callable wrapper for ConstantQueryString that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for ConstantQueryString that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename ConstantQueryStringRequestT = Model::ConstantQueryStringRequest>
        void ConstantQueryStringAsync(const ConstantQueryStringRequestT& request, const ConstantQueryStringResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const
        {
        ...
        /**
         * A Callable wrapper for ContentTypeParameters that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for ContentTypeParameters that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename ContentTypeParametersRequestT = Model::ContentTypeParametersRequest>
        void ContentTypeParametersAsync(const ContentTypeParametersResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const ContentTypeParametersRequestT& request = {}) const
        {
         ...
         * 
         */
        virtual Model::EndpointWithHostLabelHeaderOperationOutcome EndpointWithHostLabelHeaderOperation(const Model::EndpointWithHostLabelHeaderOperationRequest& request) const;

        /**
         * A Callable wrapper for EndpointWithHostLabelHeaderOperation that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        template<typename EndpointWithHostLabelHeaderOperationRequestT = Model::EndpointWithHostLabelHeaderOperationRequest>
        Model::EndpointWithHostLabelHeaderOperationOutcomeCallable EndpointWithHostLabelHeaderOperationCallable(const EndpointWithHostLabelHeaderOperationRequestT& request) const
        {
            return SubmitCallable(&RestXmlProtocolClient::EndpointWithHostLabelHeaderOperation, request);
        }

        /**
         * An Async wrapper for EndpointWithHostLabelHeaderOperation that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename EndpointWithHostLabelHeaderOperationRequestT = Model::EndpointWithHostLabelHeaderOperationRequest>
        void EndpointWithHostLabelHeaderOperationAsync(const EndpointWithHostLabelHeaderOperationRequestT& request, const EndpointWithHostLabelHeaderOperationResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const
        {
        ...
        /**
         * An Async wrapper for HttpEnumPayload that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename HttpEnumPayloadRequestT = Model::HttpEnumPayloadRequest>
        void HttpEnumPayloadAsync(const HttpEnumPayloadResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const HttpEnumPayloadRequestT& request = {}) const
        {
        ...
        /**
         * A Callable wrapper for HttpPayloadTraits that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for HttpPayloadTraits that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename HttpPayloadTraitsRequestT = Model::HttpPayloadTraitsRequest>
        void HttpPayloadTraitsAsync(const HttpPayloadTraitsResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const HttpPayloadTraitsRequestT& request = {}) const
        {
         ...
         * API Reference</a></p>
         */
        virtual Model::HttpPayloadWithMemberXmlNameOutcome HttpPayloadWithMemberXmlName(const Model::HttpPayloadWithMemberXmlNameRequest& request = {}) const;

        /**
         * A Callable wrapper for HttpPayloadWithMemberXmlName that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        template<typename HttpPayloadWithMemberXmlNameRequestT = Model::HttpPayloadWithMemberXmlNameRequest>
        Model::HttpPayloadWithMemberXmlNameOutcomeCallable HttpPayloadWithMemberXmlNameCallable(const HttpPayloadWithMemberXmlNameRequestT& request = {}) const
        {
            return SubmitCallable(&RestXmlProtocolClient::HttpPayloadWithMemberXmlName, request);
        }

        /**
         * An Async wrapper for HttpPayloadWithMemberXmlName that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename HttpPayloadWithMemberXmlNameRequestT = Model::HttpPayloadWithMemberXmlNameRequest>
        void HttpPayloadWithMemberXmlNameAsync(const HttpPayloadWithMemberXmlNameResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const HttpPayloadWithMemberXmlNameRequestT& request = {}) const
        {
        ...
        /**
         * A Callable wrapper for HttpPayloadWithStructure that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        template<typename HttpPayloadWithStructureRequestT = Model::HttpPayloadWithStructureRequest>
        Model::HttpPayloadWithStructureOutcomeCallable HttpPayloadWithStructureCallable(const HttpPayloadWithStructureRequestT& request = {}) const
        {
            return SubmitCallable(&RestXmlProtocolClient::HttpPayloadWithStructure, request);
        }

        /**
         * An Async wrapper for HttpPayloadWithStructure that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename HttpPayloadWithStructureRequestT = Model::HttpPayloadWithStructureRequest>
        void HttpPayloadWithStructureAsync(const HttpPayloadWithStructureResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const HttpPayloadWithStructureRequestT& request = {}) const
        {
        ...
        /**
         * A Callable wrapper for HttpPayloadWithUnion that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for HttpPayloadWithUnion that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename HttpPayloadWithUnionRequestT = Model::HttpPayloadWithUnionRequest>
        void HttpPayloadWithUnionAsync(const HttpPayloadWithUnionResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const HttpPayloadWithUnionRequestT& request = {}) const
        {
        ...
        /**
         * A Callable wrapper for HttpPayloadWithXmlName that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for HttpPayloadWithXmlName that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename HttpPayloadWithXmlNameRequestT = Model::HttpPayloadWithXmlNameRequest>
        void HttpPayloadWithXmlNameAsync(const HttpPayloadWithXmlNameResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const HttpPayloadWithXmlNameRequestT& request = {}) const
        {
         ...
         * API Reference</a></p>
         */
        virtual Model::HttpPayloadWithXmlNamespaceOutcome HttpPayloadWithXmlNamespace(const Model::HttpPayloadWithXmlNamespaceRequest& request = {}) const;

        /**
         * A Callable wrapper for HttpPayloadWithXmlNamespace that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        template<typename HttpPayloadWithXmlNamespaceRequestT = Model::HttpPayloadWithXmlNamespaceRequest>
        Model::HttpPayloadWithXmlNamespaceOutcomeCallable HttpPayloadWithXmlNamespaceCallable(const HttpPayloadWithXmlNamespaceRequestT& request = {}) const
        {
            return SubmitCallable(&RestXmlProtocolClient::HttpPayloadWithXmlNamespace, request);
        }

        /**
         * An Async wrapper for HttpPayloadWithXmlNamespace that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename HttpPayloadWithXmlNamespaceRequestT = Model::HttpPayloadWithXmlNamespaceRequest>
        void HttpPayloadWithXmlNamespaceAsync(const HttpPayloadWithXmlNamespaceResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const HttpPayloadWithXmlNamespaceRequestT& request = {}) const
        {
         ...
         * API Reference</a></p>
         */
        virtual Model::HttpPayloadWithXmlNamespaceAndPrefixOutcome HttpPayloadWithXmlNamespaceAndPrefix(const Model::HttpPayloadWithXmlNamespaceAndPrefixRequest& request = {}) const;

        /**
         * A Callable wrapper for HttpPayloadWithXmlNamespaceAndPrefix that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        template<typename HttpPayloadWithXmlNamespaceAndPrefixRequestT = Model::HttpPayloadWithXmlNamespaceAndPrefixRequest>
        Model::HttpPayloadWithXmlNamespaceAndPrefixOutcomeCallable HttpPayloadWithXmlNamespaceAndPrefixCallable(const HttpPayloadWithXmlNamespaceAndPrefixRequestT& request = {}) const
        {
            return SubmitCallable(&RestXmlProtocolClient::HttpPayloadWithXmlNamespaceAndPrefix, request);
        }

        /**
         * An Async wrapper for HttpPayloadWithXmlNamespaceAndPrefix that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename HttpPayloadWithXmlNamespaceAndPrefixRequestT = Model::HttpPayloadWithXmlNamespaceAndPrefixRequest>
        void HttpPayloadWithXmlNamespaceAndPrefixAsync(const HttpPayloadWithXmlNamespaceAndPrefixResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const HttpPayloadWithXmlNamespaceAndPrefixRequestT& request = {}) const
        {
        ...
        /**
         * A Callable wrapper for HttpPrefixHeaders that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for HttpPrefixHeaders that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename HttpPrefixHeadersRequestT = Model::HttpPrefixHeadersRequest>
        void HttpPrefixHeadersAsync(const HttpPrefixHeadersResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const HttpPrefixHeadersRequestT& request = {}) const
        {
         ...
         * 
         */
        virtual Model::HttpRequestWithFloatLabelsOutcome HttpRequestWithFloatLabels(const Model::HttpRequestWithFloatLabelsRequest& request) const;

        /**
         * A Callable wrapper for HttpRequestWithFloatLabels that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        template<typename HttpRequestWithFloatLabelsRequestT = Model::HttpRequestWithFloatLabelsRequest>
        Model::HttpRequestWithFloatLabelsOutcomeCallable HttpRequestWithFloatLabelsCallable(const HttpRequestWithFloatLabelsRequestT& request) const
        {
            return SubmitCallable(&RestXmlProtocolClient::HttpRequestWithFloatLabels, request);
        }

        /**
         * An Async wrapper for HttpRequestWithFloatLabels that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename HttpRequestWithFloatLabelsRequestT = Model::HttpRequestWithFloatLabelsRequest>
        void HttpRequestWithFloatLabelsAsync(const HttpRequestWithFloatLabelsRequestT& request, const HttpRequestWithFloatLabelsResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const
        {
         ...
         * 
         */
        virtual Model::HttpRequestWithGreedyLabelInPathOutcome HttpRequestWithGreedyLabelInPath(const Model::HttpRequestWithGreedyLabelInPathRequest& request) const;

        /**
         * A Callable wrapper for HttpRequestWithGreedyLabelInPath that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        template<typename HttpRequestWithGreedyLabelInPathRequestT = Model::HttpRequestWithGreedyLabelInPathRequest>
        Model::HttpRequestWithGreedyLabelInPathOutcomeCallable HttpRequestWithGreedyLabelInPathCallable(const HttpRequestWithGreedyLabelInPathRequestT& request) const
        {
            return SubmitCallable(&RestXmlProtocolClient::HttpRequestWithGreedyLabelInPath, request);
        }

        /**
         * An Async wrapper for HttpRequestWithGreedyLabelInPath that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename HttpRequestWithGreedyLabelInPathRequestT = Model::HttpRequestWithGreedyLabelInPathRequest>
        void HttpRequestWithGreedyLabelInPathAsync(const HttpRequestWithGreedyLabelInPathRequestT& request, const HttpRequestWithGreedyLabelInPathResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const
        {
        ...
        /**
         * A Callable wrapper for HttpRequestWithLabels that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for HttpRequestWithLabels that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename HttpRequestWithLabelsRequestT = Model::HttpRequestWithLabelsRequest>
        void HttpRequestWithLabelsAsync(const HttpRequestWithLabelsRequestT& request, const HttpRequestWithLabelsResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const
        {
         ...
         * API Reference</a></p>
         */
        virtual Model::HttpRequestWithLabelsAndTimestampFormatOutcome HttpRequestWithLabelsAndTimestampFormat(const Model::HttpRequestWithLabelsAndTimestampFormatRequest& request) const;

        /**
         * A Callable wrapper for HttpRequestWithLabelsAndTimestampFormat that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        template<typename HttpRequestWithLabelsAndTimestampFormatRequestT = Model::HttpRequestWithLabelsAndTimestampFormatRequest>
        Model::HttpRequestWithLabelsAndTimestampFormatOutcomeCallable HttpRequestWithLabelsAndTimestampFormatCallable(const HttpRequestWithLabelsAndTimestampFormatRequestT& request) const
        {
            return SubmitCallable(&RestXmlProtocolClient::HttpRequestWithLabelsAndTimestampFormat, request);
        }

        /**
         * An Async wrapper for HttpRequestWithLabelsAndTimestampFormat that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename HttpRequestWithLabelsAndTimestampFormatRequestT = Model::HttpRequestWithLabelsAndTimestampFormatRequest>
        void HttpRequestWithLabelsAndTimestampFormatAsync(const HttpRequestWithLabelsAndTimestampFormatRequestT& request, const HttpRequestWithLabelsAndTimestampFormatResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const
        {
        ...
        /**
         * A Callable wrapper for HttpResponseCode that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for HttpResponseCode that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename HttpResponseCodeRequestT = Model::HttpResponseCodeRequest>
        void HttpResponseCodeAsync(const HttpResponseCodeResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const HttpResponseCodeRequestT& request = {}) const
        {
        ...
        /**
         * A Callable wrapper for HttpStringPayload that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for HttpStringPayload that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename HttpStringPayloadRequestT = Model::HttpStringPayloadRequest>
        void HttpStringPayloadAsync(const HttpStringPayloadResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const HttpStringPayloadRequestT& request = {}) const
        {
         ...
         * API Reference</a></p>
         */
        virtual Model::IgnoreQueryParamsInResponseOutcome IgnoreQueryParamsInResponse(const Model::IgnoreQueryParamsInResponseRequest& request = {}) const;

        /**
         * A Callable wrapper for IgnoreQueryParamsInResponse that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        template<typename IgnoreQueryParamsInResponseRequestT = Model::IgnoreQueryParamsInResponseRequest>
        Model::IgnoreQueryParamsInResponseOutcomeCallable IgnoreQueryParamsInResponseCallable(const IgnoreQueryParamsInResponseRequestT& request = {}) const
        {
            return SubmitCallable(&RestXmlProtocolClient::IgnoreQueryParamsInResponse, request);
        }

        /**
         * An Async wrapper for IgnoreQueryParamsInResponse that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename IgnoreQueryParamsInResponseRequestT = Model::IgnoreQueryParamsInResponseRequest>
        void IgnoreQueryParamsInResponseAsync(const IgnoreQueryParamsInResponseResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const IgnoreQueryParamsInResponseRequestT& request = {}) const
        {
         ...
         * API Reference</a></p>
         */
        virtual Model::InputAndOutputWithHeadersOutcome InputAndOutputWithHeaders(const Model::InputAndOutputWithHeadersRequest& request = {}) const;

        /**
         * A Callable wrapper for InputAndOutputWithHeaders that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        template<typename InputAndOutputWithHeadersRequestT = Model::InputAndOutputWithHeadersRequest>
        Model::InputAndOutputWithHeadersOutcomeCallable InputAndOutputWithHeadersCallable(const InputAndOutputWithHeadersRequestT& request = {}) const
        {
            return SubmitCallable(&RestXmlProtocolClient::InputAndOutputWithHeaders, request);
        }

        /**
         * An Async wrapper for InputAndOutputWithHeaders that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename InputAndOutputWithHeadersRequestT = Model::InputAndOutputWithHeadersRequest>
        void InputAndOutputWithHeadersAsync(const InputAndOutputWithHeadersResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const InputAndOutputWithHeadersRequestT& request = {}) const
        {
        ...
        /**
         * A Callable wrapper for NestedXmlMapWithXmlName that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for NestedXmlMapWithXmlName that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename NestedXmlMapWithXmlNameRequestT = Model::NestedXmlMapWithXmlNameRequest>
        void NestedXmlMapWithXmlNameAsync(const NestedXmlMapWithXmlNameResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const NestedXmlMapWithXmlNameRequestT& request = {}) const
        {
        ...
        /**
         * An Async wrapper for NestedXmlMaps that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename NestedXmlMapsRequestT = Model::NestedXmlMapsRequest>
        void NestedXmlMapsAsync(const NestedXmlMapsResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const NestedXmlMapsRequestT& request = {}) const
        {
         ...
         * API Reference</a></p>
         */
        virtual Model::NullAndEmptyHeadersClientOutcome NullAndEmptyHeadersClient(const Model::NullAndEmptyHeadersClientRequest& request = {}) const;

        /**
         * A Callable wrapper for NullAndEmptyHeadersClient that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        template<typename NullAndEmptyHeadersClientRequestT = Model::NullAndEmptyHeadersClientRequest>
        Model::NullAndEmptyHeadersClientOutcomeCallable NullAndEmptyHeadersClientCallable(const NullAndEmptyHeadersClientRequestT& request = {}) const
        {
            return SubmitCallable(&RestXmlProtocolClient::NullAndEmptyHeadersClient, request);
        }

        /**
         * An Async wrapper for NullAndEmptyHeadersClient that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename NullAndEmptyHeadersClientRequestT = Model::NullAndEmptyHeadersClientRequest>
        void NullAndEmptyHeadersClientAsync(const NullAndEmptyHeadersClientResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const NullAndEmptyHeadersClientRequestT& request = {}) const
        {
         ...
         * API Reference</a></p>
         */
        virtual Model::NullAndEmptyHeadersServerOutcome NullAndEmptyHeadersServer(const Model::NullAndEmptyHeadersServerRequest& request = {}) const;

        /**
         * A Callable wrapper for NullAndEmptyHeadersServer that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        template<typename NullAndEmptyHeadersServerRequestT = Model::NullAndEmptyHeadersServerRequest>
        Model::NullAndEmptyHeadersServerOutcomeCallable NullAndEmptyHeadersServerCallable(const NullAndEmptyHeadersServerRequestT& request = {}) const
        {
            return SubmitCallable(&RestXmlProtocolClient::NullAndEmptyHeadersServer, request);
        }

        /**
         * An Async wrapper for NullAndEmptyHeadersServer that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename NullAndEmptyHeadersServerRequestT = Model::NullAndEmptyHeadersServerRequest>
        void NullAndEmptyHeadersServerAsync(const NullAndEmptyHeadersServerResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const NullAndEmptyHeadersServerRequestT& request = {}) const
        {
         ...
         * API Reference</a></p>
         */
        virtual Model::OmitsNullSerializesEmptyStringOutcome OmitsNullSerializesEmptyString(const Model::OmitsNullSerializesEmptyStringRequest& request = {}) const;

        /**
         * A Callable wrapper for OmitsNullSerializesEmptyString that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        template<typename OmitsNullSerializesEmptyStringRequestT = Model::OmitsNullSerializesEmptyStringRequest>
        Model::OmitsNullSerializesEmptyStringOutcomeCallable OmitsNullSerializesEmptyStringCallable(const OmitsNullSerializesEmptyStringRequestT& request = {}) const
        {
            return SubmitCallable(&RestXmlProtocolClient::OmitsNullSerializesEmptyString, request);
        }

        /**
         * An Async wrapper for OmitsNullSerializesEmptyString that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename OmitsNullSerializesEmptyStringRequestT = Model::OmitsNullSerializesEmptyStringRequest>
        void OmitsNullSerializesEmptyStringAsync(const OmitsNullSerializesEmptyStringResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const OmitsNullSerializesEmptyStringRequestT& request = {}) const
        {
         ...
         * 
         */
        virtual Model::QueryParamsAsStringListMapOutcome QueryParamsAsStringListMap(const Model::QueryParamsAsStringListMapRequest& request = {}) const;

        /**
         * A Callable wrapper for QueryParamsAsStringListMap that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        template<typename QueryParamsAsStringListMapRequestT = Model::QueryParamsAsStringListMapRequest>
        Model::QueryParamsAsStringListMapOutcomeCallable QueryParamsAsStringListMapCallable(const QueryParamsAsStringListMapRequestT& request = {}) const
        {
            return SubmitCallable(&RestXmlProtocolClient::QueryParamsAsStringListMap, request);
        }

        /**
         * An Async wrapper for QueryParamsAsStringListMap that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename QueryParamsAsStringListMapRequestT = Model::QueryParamsAsStringListMapRequest>
        void QueryParamsAsStringListMapAsync(const QueryParamsAsStringListMapResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const QueryParamsAsStringListMapRequestT& request = {}) const
        {
        ...
        /**
         * An Async wrapper for QueryPrecedence that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename QueryPrecedenceRequestT = Model::QueryPrecedenceRequest>
        void QueryPrecedenceAsync(const QueryPrecedenceResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const QueryPrecedenceRequestT& request = {}) const
        {
        ...
        /**
         * A Callable wrapper for TimestampFormatHeaders that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for TimestampFormatHeaders that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename TimestampFormatHeadersRequestT = Model::TimestampFormatHeadersRequest>
        void TimestampFormatHeadersAsync(const TimestampFormatHeadersResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const TimestampFormatHeadersRequestT& request = {}) const
        {
        ...
        /**
         * An Async wrapper for XmlAttributes that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename XmlAttributesRequestT = Model::XmlAttributesRequest>
        void XmlAttributesAsync(const XmlAttributesResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const XmlAttributesRequestT& request = {}) const
        {
        ...
        /**
         * A Callable wrapper for XmlAttributesOnPayload that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for XmlAttributesOnPayload that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename XmlAttributesOnPayloadRequestT = Model::XmlAttributesOnPayloadRequest>
        void XmlAttributesOnPayloadAsync(const XmlAttributesOnPayloadResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const XmlAttributesOnPayloadRequestT& request = {}) const
        {
        ...
        /**
         * An Async wrapper for XmlEmptyStrings that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename XmlEmptyStringsRequestT = Model::XmlEmptyStringsRequest>
        void XmlEmptyStringsAsync(const XmlEmptyStringsResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const XmlEmptyStringsRequestT& request = {}) const
        {
        ...
        /**
         * A Callable wrapper for XmlMapWithXmlNamespace that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for XmlMapWithXmlNamespace that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename XmlMapWithXmlNamespaceRequestT = Model::XmlMapWithXmlNamespaceRequest>
        void XmlMapWithXmlNamespaceAsync(const XmlMapWithXmlNamespaceResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const XmlMapWithXmlNamespaceRequestT& request = {}) const
        {
        ...
        /**
         * An Async wrapper for XmlUnions that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename XmlUnionsRequestT = Model::XmlUnionsRequest>
        void XmlUnionsAsync(const XmlUnionsResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const XmlUnionsRequestT& request = {}) const
        {
