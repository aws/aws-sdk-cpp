...
class AWS_RESTXMLPROTOCOL_API RestXmlProtocolError : public Aws::Client::AWSError<RestXmlProtocolErrors> {
 public:
  ...
  RestXmlProtocolError(const Aws::Client::AWSError<RestXmlProtocolErrors>& rhs) : Aws::Client::AWSError<RestXmlProtocolErrors>(rhs) {}
  RestXmlProtocolError(Aws::Client::AWSError<RestXmlProtocolErrors>&& rhs) : Aws::Client::AWSError<RestXmlProtocolErrors>(rhs) {}
