...
{
const size_t RestXmlProtocolEndpointRules::RulesBlobStrLen = 1086;
const size_t RestXmlProtocolEndpointRules::RulesBlobSize = 1087;
...
const char* RestXmlProtocolEndpointRules::GetRulesBlob()
{
