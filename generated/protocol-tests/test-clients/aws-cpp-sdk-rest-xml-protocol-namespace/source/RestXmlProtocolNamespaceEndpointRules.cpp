...
{
const size_t RestXmlProtocolNamespaceEndpointRules::RulesBlobStrLen = 1086;
const size_t RestXmlProtocolNamespaceEndpointRules::RulesBlobSize = 1087;

using RulesBlobT = Aws::Array<const char, RestXmlProtocolNamespaceEndpointRules::RulesBlobSize>;
...
const char* RestXmlProtocolNamespaceEndpointRules::GetRulesBlob()
{
