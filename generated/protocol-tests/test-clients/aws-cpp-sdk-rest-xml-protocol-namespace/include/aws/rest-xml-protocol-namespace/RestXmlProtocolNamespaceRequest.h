...
{
  class AWS_RESTXMLPROTOCOLNAMESPACE_API RestXmlProtocolNamespaceRequest : public Aws::AmazonSerializableWebServiceRequest
  {
  public:
    using EndpointParameter = Aws::Endpoint::EndpointParameter;
    using EndpointParameters = Aws::Endpoint::EndpointParameters;

    virtual ~RestXmlProtocolNamespaceRequest () {}
