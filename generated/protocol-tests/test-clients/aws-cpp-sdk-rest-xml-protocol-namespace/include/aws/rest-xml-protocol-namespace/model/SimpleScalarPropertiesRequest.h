...
#include <aws/rest-xml-protocol-namespace/RestXmlProtocolNamespaceRequest.h>
...
namespace Model
{
  ...
  /**
   */
  class SimpleScalarPropertiesRequest : public RestXmlProtocolNamespaceRequest
  {
  public:
    AWS_RESTXMLPROTOCOLNAMESPACE_API SimpleScalarPropertiesRequest();
    ...
    AWS_RESTXMLPROTOCOLNAMESPACE_API Aws::String SerializePayload() const override;

    AWS_RESTXMLPROTOCOLNAMESPACE_API Aws::Http::HeaderValueCollection GetRequestSpecificHeaders() const override;
    ...
    inline void SetNested(const NestedWithNamespace& value) { m_nestedHasBeenSet = true; m_nested = value; }
    inline void SetNested(NestedWithNamespace&& value) { m_nestedHasBeenSet = true; m_nested = std::move(value); }
    inline SimpleScalarPropertiesRequest& WithNested(const NestedWithNamespace& value) { SetNested(value); return *this;}
    inline SimpleScalarPropertiesRequest& WithNested(NestedWithNamespace&& value) { SetNested(std::move(value)); return *this;}
    ///@}
