...
namespace Model
{
  ...
  {
  public:
    AWS_RESTXMLPROTOCOLNAMESPACE_API SimpleScalarPropertiesRequest() = default;
    ...
    template<typename NestedT = NestedWithNamespace>
    SimpleScalarPropertiesRequest& WithNested(NestedT&& value) { SetNested(std::forward<NestedT>(value)); return *this;}
    ///@}
