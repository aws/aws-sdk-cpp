...
namespace Aws
{
  ...
  namespace QueryCompatibleJSONRPC10
  {
    ...
    typedef std::function<void(const QueryCompatibleJSONRPC10Client*, const Model::QueryCompatibleOperationRequest&, const Model::QueryCompatibleOperationOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > QueryCompatibleOperationResponseReceivedHandler;
