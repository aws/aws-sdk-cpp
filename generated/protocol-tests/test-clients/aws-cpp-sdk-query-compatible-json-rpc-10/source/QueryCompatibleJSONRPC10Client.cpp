...
QueryCompatibleJSONRPC10Client::QueryCompatibleJSONRPC10Client(const QueryCompatibleJSONRPC10::QueryCompatibleJSONRPC10ClientConfiguration& clientConfiguration,
  ...
  m_endpointProvider(endpointProvider ? std::move(endpointProvider) : Aws::MakeShared<QueryCompatibleJSONRPC10EndpointProvider>(ALLOCATION_TAG))
{
...
QueryCompatibleOperationOutcome QueryCompatibleJSONRPC10Client::QueryCompatibleOperation(const QueryCompatibleOperationRequest& request) const
{
  ...
  return TracingUtils::MakeCallWithTiming<QueryCompatibleOperationOutcome>(
    [&]()-> QueryCompatibleOperationOutcome {
      ...
      AWS_OPERATION_CHECK_SUCCESS(endpointResolutionOutcome, QueryCompatibleOperation, CoreErrors, CoreErrors::ENDPOINT_RESOLUTION_FAILURE, endpointResolutionOutcome.GetError().GetMessage());
      return QueryCompatibleOperationOutcome(MakeRequest(request, endpointResolutionOutcome.GetResult(), Aws::Http::HttpMethod::HTTP_POST, Aws::Auth::SIGV4_SIGNER));
    },
