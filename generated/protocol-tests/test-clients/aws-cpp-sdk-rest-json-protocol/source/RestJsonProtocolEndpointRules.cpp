...
{
const size_t RestJsonProtocolEndpointRules::RulesBlobStrLen = 1086;
const size_t RestJsonProtocolEndpointRules::RulesBlobSize = 1087;

using RulesBlobT = Aws::Array<const char, RestJsonProtocolEndpointRules::RulesBlobSize>;
...
'g','N','a','m','e','"',':','"','t','e','s','t','-','s','e','r','v','i','c','e','"','}',']','}',',',
'"','h','e','a','d','e','r','s','"',':','{','}','}',',','"','t','y','p','e','"',':','"','e','n','d',
'p','o','i','n','t','"','}',']','}',']','}','\0'
}};

const char* RestJsonProtocolEndpointRules::GetRulesBlob()
{
