...
HttpChecksumRequiredResult::HttpChecksumRequiredResult()
{
}

HttpChecksumRequiredResult::HttpChecksumRequiredResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
