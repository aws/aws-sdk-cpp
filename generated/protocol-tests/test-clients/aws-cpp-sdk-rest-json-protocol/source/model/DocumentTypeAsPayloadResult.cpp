...
DocumentTypeAsPayloadResult::DocumentTypeAsPayloadResult()
{
}

DocumentTypeAsPayloadResult::DocumentTypeAsPayloadResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
