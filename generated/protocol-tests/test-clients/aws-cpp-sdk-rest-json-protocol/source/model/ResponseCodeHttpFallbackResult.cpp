...
ResponseCodeHttpFallbackResult::ResponseCodeHttpFallbackResult()
{
}

ResponseCodeHttpFallbackResult::ResponseCodeHttpFallbackResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
