...
class AWS_RESTJSONPROTOCOL_API RestJsonProtocolRequest : public Aws::AmazonSerializableWebServiceRequest {
 public:
  using EndpointParameter = Aws::Endpoint::EndpointParameter;
  using EndpointParameters = Aws::Endpoint::EndpointParameters;

  virtual ~RestJsonProtocolRequest() {}
...
typedef Aws::AmazonStreamingWebServiceRequest StreamingRestJsonProtocolRequest;
