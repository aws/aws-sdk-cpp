...
namespace Aws
{
  ...
  namespace RestJsonProtocol
  {
    ...
    typedef std::function<void(const RestJsonProtocolClient*, const Model::AllQueryStringTypesRequest&, const Model::AllQueryStringTypesOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > AllQueryStringTypesResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::ConstantAndVariableQueryStringRequest&, const Model::ConstantAndVariableQueryStringOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > ConstantAndVariableQueryStringResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::ConstantQueryStringRequest&, const Model::ConstantQueryStringOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > ConstantQueryStringResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::ContentTypeParametersRequest&, const Model::ContentTypeParametersOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > ContentTypeParametersResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::DatetimeOffsetsRequest&, const Model::DatetimeOffsetsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > DatetimeOffsetsResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::DocumentTypeRequest&, const Model::DocumentTypeOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > DocumentTypeResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::DocumentTypeAsMapValueRequest&, const Model::DocumentTypeAsMapValueOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > DocumentTypeAsMapValueResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::DocumentTypeAsPayloadRequest&, const Model::DocumentTypeAsPayloadOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > DocumentTypeAsPayloadResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::EmptyInputAndEmptyOutputRequest&, const Model::EmptyInputAndEmptyOutputOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > EmptyInputAndEmptyOutputResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::EndpointOperationRequest&, const Model::EndpointOperationOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > EndpointOperationResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::EndpointWithHostLabelOperationRequest&, const Model::EndpointWithHostLabelOperationOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > EndpointWithHostLabelOperationResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::FractionalSecondsRequest&, const Model::FractionalSecondsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > FractionalSecondsResponseReceivedHandler;
    ...
    typedef std::function<void(const RestJsonProtocolClient*, const Model::HttpPrefixHeadersRequest&, const Model::HttpPrefixHeadersOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > HttpPrefixHeadersResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::HttpPrefixHeadersInResponseRequest&, const Model::HttpPrefixHeadersInResponseOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > HttpPrefixHeadersInResponseResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::HttpRequestWithFloatLabelsRequest&, const Model::HttpRequestWithFloatLabelsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > HttpRequestWithFloatLabelsResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::HttpRequestWithGreedyLabelInPathRequest&, const Model::HttpRequestWithGreedyLabelInPathOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > HttpRequestWithGreedyLabelInPathResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::HttpRequestWithLabelsRequest&, const Model::HttpRequestWithLabelsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > HttpRequestWithLabelsResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::HttpRequestWithLabelsAndTimestampFormatRequest&, const Model::HttpRequestWithLabelsAndTimestampFormatOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > HttpRequestWithLabelsAndTimestampFormatResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::HttpRequestWithRegexLiteralRequest&, const Model::HttpRequestWithRegexLiteralOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > HttpRequestWithRegexLiteralResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::HttpResponseCodeRequest&, const Model::HttpResponseCodeOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > HttpResponseCodeResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::HttpStringPayloadRequest&, Model::HttpStringPayloadOutcome, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > HttpStringPayloadResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::IgnoreQueryParamsInResponseRequest&, const Model::IgnoreQueryParamsInResponseOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > IgnoreQueryParamsInResponseResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::InputAndOutputWithHeadersRequest&, const Model::InputAndOutputWithHeadersOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > InputAndOutputWithHeadersResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::JsonBlobsRequest&, const Model::JsonBlobsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > JsonBlobsResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::JsonEnumsRequest&, const Model::JsonEnumsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > JsonEnumsResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::JsonIntEnumsRequest&, const Model::JsonIntEnumsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > JsonIntEnumsResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::JsonListsRequest&, const Model::JsonListsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > JsonListsResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::JsonMapsRequest&, const Model::JsonMapsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > JsonMapsResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::JsonTimestampsRequest&, const Model::JsonTimestampsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > JsonTimestampsResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::JsonUnionsRequest&, const Model::JsonUnionsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > JsonUnionsResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::MediaTypeHeaderRequest&, const Model::MediaTypeHeaderOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > MediaTypeHeaderResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::NoInputAndNoOutputRequest&, const Model::NoInputAndNoOutputOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > NoInputAndNoOutputResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::NoInputAndOutputRequest&, const Model::NoInputAndOutputOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > NoInputAndOutputResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::NullAndEmptyHeadersClientRequest&, const Model::NullAndEmptyHeadersClientOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > NullAndEmptyHeadersClientResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::NullAndEmptyHeadersServerRequest&, const Model::NullAndEmptyHeadersServerOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > NullAndEmptyHeadersServerResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::OmitsNullSerializesEmptyStringRequest&, const Model::OmitsNullSerializesEmptyStringOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > OmitsNullSerializesEmptyStringResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::OmitsSerializingEmptyListsRequest&, const Model::OmitsSerializingEmptyListsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > OmitsSerializingEmptyListsResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::PostUnionWithJsonNameRequest&, const Model::PostUnionWithJsonNameOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > PostUnionWithJsonNameResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::PutWithContentEncodingRequest&, const Model::PutWithContentEncodingOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > PutWithContentEncodingResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::QueryIdempotencyTokenAutoFillRequest&, const Model::QueryIdempotencyTokenAutoFillOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > QueryIdempotencyTokenAutoFillResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::QueryParamsAsStringListMapRequest&, const Model::QueryParamsAsStringListMapOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > QueryParamsAsStringListMapResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::QueryPrecedenceRequest&, const Model::QueryPrecedenceOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > QueryPrecedenceResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::RecursiveShapesRequest&, const Model::RecursiveShapesOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > RecursiveShapesResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::ResponseCodeHttpFallbackRequest&, const Model::ResponseCodeHttpFallbackOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > ResponseCodeHttpFallbackResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::ResponseCodeRequiredRequest&, const Model::ResponseCodeRequiredOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > ResponseCodeRequiredResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::SimpleScalarPropertiesRequest&, const Model::SimpleScalarPropertiesOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > SimpleScalarPropertiesResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::TestBodyStructureRequest&, const Model::TestBodyStructureOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > TestBodyStructureResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::TestGetNoInputNoPayloadRequest&, const Model::TestGetNoInputNoPayloadOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > TestGetNoInputNoPayloadResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::TestGetNoPayloadRequest&, const Model::TestGetNoPayloadOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > TestGetNoPayloadResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::TestPayloadBlobRequest&, Model::TestPayloadBlobOutcome, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > TestPayloadBlobResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::TestPayloadStructureRequest&, const Model::TestPayloadStructureOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > TestPayloadStructureResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::TestPostNoInputNoPayloadRequest&, const Model::TestPostNoInputNoPayloadOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > TestPostNoInputNoPayloadResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::TestPostNoPayloadRequest&, const Model::TestPostNoPayloadOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > TestPostNoPayloadResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::TimestampFormatHeadersRequest&, const Model::TimestampFormatHeadersOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > TimestampFormatHeadersResponseReceivedHandler;
    typedef std::function<void(const RestJsonProtocolClient*, const Model::UnitInputAndOutputRequest&, const Model::UnitInputAndOutputOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > UnitInputAndOutputResponseReceivedHandler;
