...
namespace Model
{
  ...
  public:
    ...
    template<typename TestIdT = Aws::String>
    TestPostNoPayloadRequest& WithTestId(TestIdT&& value) { SetTestId(std::forward<TestIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    TestPostNoPayloadRequest& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
