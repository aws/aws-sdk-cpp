...
class JsonEnumsResult {
 public:
  AWS_RESTJSONPROTOCOL_API JsonEnumsResult() = default;
  AWS_RESTJSONPROTOCOL_API JsonEnumsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_RESTJSONPROTOCOL_API JsonEnumsResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  inline JsonEnumsResult& WithFooEnum1(FooEnum value) {
    SetFooEnum1(value);
    return *this;
  }
  ///@}
  ...
  inline JsonEnumsResult& WithFooEnum2(FooEnum value) {
    SetFooEnum2(value);
    return *this;
  }
  ///@}
  ...
  inline JsonEnumsResult& WithFooEnum3(FooEnum value) {
    SetFooEnum3(value);
    return *this;
  }
  ///@}
  ...
  template <typename FooEnumListT = Aws::Vector<FooEnum>>
  JsonEnumsResult& WithFooEnumList(FooEnumListT&& value) {
    SetFooEnumList(std::forward<FooEnumListT>(value));
    return *this;
  }
  inline JsonEnumsResult& AddFooEnumList(FooEnum value) {
    m_fooEnumListHasBeenSet = true;
  ...
  template <typename FooEnumSetT = Aws::Vector<FooEnum>>
  JsonEnumsResult& WithFooEnumSet(FooEnumSetT&& value) {
    SetFooEnumSet(std::forward<FooEnumSetT>(value));
    return *this;
  }
  inline JsonEnumsResult& AddFooEnumSet(FooEnum value) {
    m_fooEnumSetHasBeenSet = true;
  ...
  template <typename FooEnumMapT = Aws::Map<Aws::String, FooEnum>>
  JsonEnumsResult& WithFooEnumMap(FooEnumMapT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  JsonEnumsResult& WithRequestId(RequestIdT&& value) {
