...
namespace Model
{
  ...
  public:
    ...
    JsonListsResult& AddStringList(StringListT&& value) { m_stringList.emplace_back(std::forward<StringListT>(value)); return *this; }
    ///@}
    ...
    JsonListsResult& AddStringSet(StringSetT&& value) { m_stringSet.emplace_back(std::forward<StringSetT>(value)); return *this; }
    ///@}
    ...
    JsonListsResult& AddTimestampList(TimestampListT&& value) { m_timestampList.emplace_back(std::forward<TimestampListT>(value)); return *this; }
    ///@}
    ...
    inline JsonListsResult& AddEnumList(FooEnum value) { m_enumList.push_back(value); return *this; }
    ///@}
    ...
    JsonListsResult& AddNestedStringList(NestedStringListT&& value) { m_nestedStringList.emplace_back(std::forward<NestedStringListT>(value)); return *this; }
    ///@}
    ...
    JsonListsResult& AddStructureList(StructureListT&& value) { m_structureList.emplace_back(std::forward<StructureListT>(value)); return *this; }
    ///@}
