...
namespace Model
{
  ...
  public:
    ...
    AWS_RESTJSONPROTOCOL_API HttpPayloadWithStructureResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ...
    template<typename NestedT = NestedPayload>
    HttpPayloadWithStructureResult& WithNested(NestedT&& value) { SetNested(std::forward<NestedT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    HttpPayloadWithStructureResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
