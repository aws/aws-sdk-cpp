...
namespace Model
{
  ...
  {
  public:
    AWS_RESTJSONPROTOCOL_API HttpChecksumRequiredRequest() = default;
    ...
    template<typename FooT = Aws::String>
    HttpChecksumRequiredRequest& WithFoo(FooT&& value) { SetFoo(std::forward<FooT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    HttpChecksumRequiredRequest& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
