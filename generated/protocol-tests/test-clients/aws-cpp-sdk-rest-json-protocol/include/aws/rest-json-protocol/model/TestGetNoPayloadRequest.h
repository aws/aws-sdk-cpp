...
namespace Model
{
  ...
  {
  public:
    AWS_RESTJSONPROTOCOL_API TestGetNoPayloadRequest() = default;
    ...
    template<typename TestIdT = Aws::String>
    TestGetNoPayloadRequest& WithTestId(TestIdT&& value) { SetTestId(std::forward<TestIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    TestGetNoPayloadRequest& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
