...
class TestPayloadStructureRequest : public RestJsonProtocolRequest {
 public:
  ...
  template <typename TestIdT = Aws::String>
  TestPayloadStructureRequest& WithTestId(TestIdT&& value) {
  ...
  template <typename PayloadConfigT = PayloadConfig>
  TestPayloadStructureRequest& WithPayloadConfig(PayloadConfigT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  TestPayloadStructureRequest& WithRequestId(RequestIdT&& value) {
