...
namespace Model
{
  ...
  public:
    ...
    void SetIntegerEnumList(IntegerEnumListT&& value) { m_integerEnumListHasBeenSet = true; m_integerEnumList = std::forward<IntegerEnumListT>(value); }
    template<typename IntegerEnumListT = Aws::Vector<int>>
    JsonIntEnumsRequest& WithIntegerEnumList(IntegerEnumListT&& value) { SetIntegerEnumList(std::forward<IntegerEnumListT>(value)); return *this;}
    ...
    void SetIntegerEnumSet(IntegerEnumSetT&& value) { m_integerEnumSetHasBeenSet = true; m_integerEnumSet = std::forward<IntegerEnumSetT>(value); }
    template<typename IntegerEnumSetT = Aws::Vector<int>>
    JsonIntEnumsRequest& WithIntegerEnumSet(IntegerEnumSetT&& value) { SetIntegerEnumSet(std::forward<IntegerEnumSetT>(value)); return *this;}
    ...
    void SetIntegerEnumMap(IntegerEnumMapT&& value) { m_integerEnumMapHasBeenSet = true; m_integerEnumMap = std::forward<IntegerEnumMapT>(value); }
    template<typename IntegerEnumMapT = Aws::Map<Aws::String, int>>
    JsonIntEnumsRequest& WithIntegerEnumMap(IntegerEnumMapT&& value) { SetIntegerEnumMap(std::forward<IntegerEnumMapT>(value)); return *this;}
    inline JsonIntEnumsRequest& AddIntegerEnumMap(Aws::String key, int value) {
      m_integerEnumMapHasBeenSet = true; m_integerEnumMap.emplace(key, value); return *this;
    }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    JsonIntEnumsRequest& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
