...
namespace Model
{
  ...
  {
  public:
    AWS_RESTJSONPROTOCOL_API NullAndEmptyHeadersServerResult() = default;
    ...
    template<typename AT = Aws::String>
    NullAndEmptyHeadersServerResult& WithA(AT&& value) { SetA(std::forward<AT>(value)); return *this;}
    ///@}
    ...
    template<typename BT = Aws::String>
    NullAndEmptyHeadersServerResult& WithB(BT&& value) { SetB(std::forward<BT>(value)); return *this;}
    ///@}
    ...
    template<typename CT = Aws::Vector<Aws::String>>
    NullAndEmptyHeadersServerResult& WithC(CT&& value) { SetC(std::forward<CT>(value)); return *this;}
    template<typename CT = Aws::String>
    NullAndEmptyHeadersServerResult& AddC(CT&& value) { m_cHasBeenSet = true; m_c.emplace_back(std::forward<CT>(value)); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    NullAndEmptyHeadersServerResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
