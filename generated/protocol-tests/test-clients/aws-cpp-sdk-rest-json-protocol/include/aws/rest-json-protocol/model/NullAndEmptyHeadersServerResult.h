...
class NullAndEmptyHeadersServerResult {
 public:
  ...
  AWS_RESTJSONPROTOCOL_API NullAndEmptyHeadersServerResult& operator=(
  ...
  template <typename AT = Aws::String>
  NullAndEmptyHeadersServerResult& WithA(AT&& value) {
  ...
  template <typename BT = Aws::String>
  NullAndEmptyHeadersServerResult& WithB(BT&& value) {
  ...
  template <typename CT = Aws::Vector<Aws::String>>
  NullAndEmptyHeadersServerResult& WithC(CT&& value) {
    SetC(std::forward<CT>(value));
    return *this;
  }
  template <typename CT = Aws::String>
  NullAndEmptyHeadersServerResult& AddC(CT&& value) {
    m_cHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  NullAndEmptyHeadersServerResult& WithRequestId(RequestIdT&& value) {
