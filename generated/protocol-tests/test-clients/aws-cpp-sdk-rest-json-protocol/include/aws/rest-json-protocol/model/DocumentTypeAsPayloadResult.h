...
namespace Model
{
  ...
  public:
    ...
    void SetDocumentValue(DocumentValueT&& value) { m_documentValue = std::forward<DocumentValueT>(value); }
    template<typename DocumentValueT = Aws::Utils::Document>
    DocumentTypeAsPayloadResult& WithDocumentValue(DocumentValueT&& value) { SetDocumentValue(std::forward<DocumentValueT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DocumentTypeAsPayloadResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
