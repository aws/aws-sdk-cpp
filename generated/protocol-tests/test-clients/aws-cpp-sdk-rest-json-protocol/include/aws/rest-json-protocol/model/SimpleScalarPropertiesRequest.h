...
namespace Model
{
  ...
  public:
    ...
    template<typename FooT = Aws::String>
    SimpleScalarPropertiesRequest& WithFoo(FooT&& value) { SetFoo(std::forward<FooT>(value)); return *this;}
    ///@}
    ...
    template<typename StringValueT = Aws::String>
    SimpleScalarPropertiesRequest& WithStringValue(StringValueT&& value) { SetStringValue(std::forward<StringValueT>(value)); return *this;}
    ///@}
