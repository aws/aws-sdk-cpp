...
namespace Model
{
  ...
  {
  public:
    AWS_RESTJSONPROTOCOL_API TestGetNoPayloadResult() = default;
    ...
    template<typename TestIdT = Aws::String>
    TestGetNoPayloadResult& WithTestId(TestIdT&& value) { SetTestId(std::forward<TestIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    TestGetNoPayloadResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
