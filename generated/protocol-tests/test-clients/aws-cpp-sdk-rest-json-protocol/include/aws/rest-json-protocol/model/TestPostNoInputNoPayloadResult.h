...
class TestPostNoInputNoPayloadResult {
 public:
  ...
  AWS_RESTJSONPROTOCOL_API TestPostNoInputNoPayloadResult& operator=(
  ...
  template <typename TestIdT = Aws::String>
  TestPostNoInputNoPayloadResult& WithTestId(TestIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  TestPostNoInputNoPayloadResult& WithRequestId(RequestIdT&& value) {
