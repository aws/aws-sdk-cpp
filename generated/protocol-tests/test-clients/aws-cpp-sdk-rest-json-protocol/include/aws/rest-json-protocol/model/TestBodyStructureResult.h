...
namespace Model
{
  ...
  public:
    ...
    void SetTestId(TestIdT&& value) { m_testId = std::forward<TestIdT>(value); }
    template<typename TestIdT = Aws::String>
    TestBodyStructureResult& WithTestId(TestIdT&& value) { SetTestId(std::forward<TestIdT>(value)); return *this;}
    ///@}
    ...
    void SetTestConfig(TestConfigT&& value) { m_testConfig = std::forward<TestConfigT>(value); }
    template<typename TestConfigT = TestConfig>
    TestBodyStructureResult& WithTestConfig(TestConfigT&& value) { SetTestConfig(std::forward<TestConfigT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    TestBodyStructureResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
