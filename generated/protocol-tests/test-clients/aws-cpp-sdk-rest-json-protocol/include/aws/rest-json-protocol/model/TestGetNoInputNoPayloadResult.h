...
namespace Model
{
  ...
  public:
    ...
    template<typename TestIdT = Aws::String>
    TestGetNoInputNoPayloadResult& WithTestId(TestIdT&& value) { SetTestId(std::forward<TestIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    TestGetNoInputNoPayloadResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
