...
namespace Model
{
  ...
  /**
   */
  class AllQueryStringTypesRequest : public RestJsonProtocolRequest
  {
  public:
    AWS_RESTJSONPROTOCOL_API AllQueryStringTypesRequest() = default;
    ...
    template<typename QueryStringT = Aws::String>
    AllQueryStringTypesRequest& WithQueryString(QueryStringT&& value) { SetQueryString(std::forward<QueryStringT>(value)); return *this;}
    ///@}
    ...
    template<typename QueryStringListT = Aws::Vector<Aws::String>>
    AllQueryStringTypesRequest& WithQueryStringList(QueryStringListT&& value) { SetQueryStringList(std::forward<QueryStringListT>(value)); return *this;}
    template<typename QueryStringListT = Aws::String>
    AllQueryStringTypesRequest& AddQueryStringList(QueryStringListT&& value) { m_queryStringListHasBeenSet = true; m_queryStringList.emplace_back(std::forward<QueryStringListT>(value)); return *this; }
    ///@}
    ...
    void SetQueryStringSet(QueryStringSetT&& value) { m_queryStringSetHasBeenSet = true; m_queryStringSet = std::forward<QueryStringSetT>(value); }
    template<typename QueryStringSetT = Aws::Vector<Aws::String>>
    AllQueryStringTypesRequest& WithQueryStringSet(QueryStringSetT&& value) { SetQueryStringSet(std::forward<QueryStringSetT>(value)); return *this;}
    template<typename QueryStringSetT = Aws::String>
    AllQueryStringTypesRequest& AddQueryStringSet(QueryStringSetT&& value) { m_queryStringSetHasBeenSet = true; m_queryStringSet.emplace_back(std::forward<QueryStringSetT>(value)); return *this; }
    ///@}
    ...
    template<typename QueryIntegerListT = Aws::Vector<int>>
    AllQueryStringTypesRequest& WithQueryIntegerList(QueryIntegerListT&& value) { SetQueryIntegerList(std::forward<QueryIntegerListT>(value)); return *this;}
    ...
    void SetQueryIntegerSet(QueryIntegerSetT&& value) { m_queryIntegerSetHasBeenSet = true; m_queryIntegerSet = std::forward<QueryIntegerSetT>(value); }
    template<typename QueryIntegerSetT = Aws::Vector<int>>
    AllQueryStringTypesRequest& WithQueryIntegerSet(QueryIntegerSetT&& value) { SetQueryIntegerSet(std::forward<QueryIntegerSetT>(value)); return *this;}
    ...
    template<typename QueryDoubleListT = Aws::Vector<double>>
    AllQueryStringTypesRequest& WithQueryDoubleList(QueryDoubleListT&& value) { SetQueryDoubleList(std::forward<QueryDoubleListT>(value)); return *this;}
    ...
    template<typename QueryBooleanListT = Aws::Vector<bool>>
    AllQueryStringTypesRequest& WithQueryBooleanList(QueryBooleanListT&& value) { SetQueryBooleanList(std::forward<QueryBooleanListT>(value)); return *this;}
    ...
    void SetQueryTimestamp(QueryTimestampT&& value) { m_queryTimestampHasBeenSet = true; m_queryTimestamp = std::forward<QueryTimestampT>(value); }
    template<typename QueryTimestampT = Aws::Utils::DateTime>
    AllQueryStringTypesRequest& WithQueryTimestamp(QueryTimestampT&& value) { SetQueryTimestamp(std::forward<QueryTimestampT>(value)); return *this;}
    ///@}
    ...
    template<typename QueryTimestampListT = Aws::Vector<Aws::Utils::DateTime>>
    AllQueryStringTypesRequest& WithQueryTimestampList(QueryTimestampListT&& value) { SetQueryTimestampList(std::forward<QueryTimestampListT>(value)); return *this;}
    template<typename QueryTimestampListT = Aws::Utils::DateTime>
    AllQueryStringTypesRequest& AddQueryTimestampList(QueryTimestampListT&& value) { m_queryTimestampListHasBeenSet = true; m_queryTimestampList.emplace_back(std::forward<QueryTimestampListT>(value)); return *this; }
    ///@}
    ...
    inline void SetQueryEnum(FooEnum value) { m_queryEnumHasBeenSet = true; m_queryEnum = value; }
    inline AllQueryStringTypesRequest& WithQueryEnum(FooEnum value) { SetQueryEnum(value); return *this;}
    ///@}
    ...
    template<typename QueryEnumListT = Aws::Vector<FooEnum>>
    AllQueryStringTypesRequest& WithQueryEnumList(QueryEnumListT&& value) { SetQueryEnumList(std::forward<QueryEnumListT>(value)); return *this;}
    inline AllQueryStringTypesRequest& AddQueryEnumList(FooEnum value) { m_queryEnumListHasBeenSet = true; m_queryEnumList.push_back(value); return *this; }
    ///@}
    ...
    template<typename QueryIntegerEnumListT = Aws::Vector<int>>
    AllQueryStringTypesRequest& WithQueryIntegerEnumList(QueryIntegerEnumListT&& value) { SetQueryIntegerEnumList(std::forward<QueryIntegerEnumListT>(value)); return *this;}
    ...
    inline const Aws::Map<Aws::String, Aws::Vector<Aws::String>>& GetQueryParamsMapOfStringList() const { return m_queryParamsMapOfStringList; }
    inline bool QueryParamsMapOfStringListHasBeenSet() const { return m_queryParamsMapOfStringListHasBeenSet; }
    template<typename QueryParamsMapOfStringListT = Aws::Map<Aws::String, Aws::Vector<Aws::String>>>
    void SetQueryParamsMapOfStringList(QueryParamsMapOfStringListT&& value) { m_queryParamsMapOfStringListHasBeenSet = true; m_queryParamsMapOfStringList = std::forward<QueryParamsMapOfStringListT>(value); }
    template<typename QueryParamsMapOfStringListT = Aws::Map<Aws::String, Aws::Vector<Aws::String>>>
    AllQueryStringTypesRequest& WithQueryParamsMapOfStringList(QueryParamsMapOfStringListT&& value) { SetQueryParamsMapOfStringList(std::forward<QueryParamsMapOfStringListT>(value)); return *this;}
    template<typename QueryParamsMapOfStringListKeyT = Aws::String, typename QueryParamsMapOfStringListValueT = Aws::Vector<Aws::String>>
    AllQueryStringTypesRequest& AddQueryParamsMapOfStringList(QueryParamsMapOfStringListKeyT&& key, QueryParamsMapOfStringListValueT&& value) {
      m_queryParamsMapOfStringListHasBeenSet = true; m_queryParamsMapOfStringList.emplace(std::forward<QueryParamsMapOfStringListKeyT>(key), std::forward<QueryParamsMapOfStringListValueT>(value)); return *this;
    }
    ///@}
  private:
