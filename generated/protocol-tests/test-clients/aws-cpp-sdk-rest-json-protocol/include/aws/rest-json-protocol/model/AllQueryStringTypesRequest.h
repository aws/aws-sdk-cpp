...
class AllQueryStringTypesRequest : public RestJsonProtocolRequest {
 public:
  ...
  inline const Aws::Map<Aws::String, Aws::Vector<Aws::String>>& GetQueryParamsMapOfStringList() const {
    return m_queryParamsMapOfStringList;
  }
  ...
  void SetQueryParamsMapOfStringList(QueryParamsMapOfStringListT&& value) {
    m_queryParamsMapOfStringListHasBeenSet = true;
    m_queryParamsMapOfStringList = std::forward<QueryParamsMapOfStringListT>(value);
  }
  template <typename QueryParamsMapOfStringListT = Aws::Map<Aws::String, Aws::Vector<Aws::String>>>
  AllQueryStringTypesRequest& WithQueryParamsMapOfStringList(QueryParamsMapOfStringListT&& value) {
    SetQueryParamsMapOfStringList(std::forward<QueryParamsMapOfStringListT>(value));
    return *this;
  }
  ...
  AllQueryStringTypesRequest& AddQueryParamsMapOfStringList(QueryParamsMapOfStringListKeyT&& key,
                                                            QueryParamsMapOfStringListValueT&& value) {
    m_queryParamsMapOfStringListHasBeenSet = true;
    m_queryParamsMapOfStringList.emplace(std::forward<QueryParamsMapOfStringListKeyT>(key),
                                         std::forward<QueryParamsMapOfStringListValueT>(value));
    return *this;
  }
  ///@}
 private:
