...
namespace Model
{
  ...
  {
  public:
    AWS_RESTJSONPROTOCOL_API AllQueryStringTypesRequest();
    ...
    inline void SetQueryParamsMapOfStringList(const Aws::Map<Aws::String, Aws::Vector<Aws::String>>& value) { m_queryParamsMapOfStringListHasBeenSet = true; m_queryParamsMapOfStringList = value; }
    inline void SetQueryParamsMapOfStringList(Aws::Map<Aws::String, Aws::Vector<Aws::String>>&& value) { m_queryParamsMapOfStringListHasBeenSet = true; m_queryParamsMapOfStringList = std::move(value); }
    inline AllQueryStringTypesRequest& WithQueryParamsMapOfStringList(const Aws::Map<Aws::String, Aws::Vector<Aws::String>>& value) { SetQueryParamsMapOfStringList(value); return *this;}
    inline AllQueryStringTypesRequest& WithQueryParamsMapOfStringList(Aws::Map<Aws::String, Aws::Vector<Aws::String>>&& value) { SetQueryParamsMapOfStringList(std::move(value)); return *this;}
    inline AllQueryStringTypesRequest& AddQueryParamsMapOfStringList(const Aws::String& key, const Aws::Vector<Aws::String>& value) { m_queryParamsMapOfStringListHasBeenSet = true; m_queryParamsMapOfStringList.emplace(key, value); return *this; }
    inline AllQueryStringTypesRequest& AddQueryParamsMapOfStringList(Aws::String&& key, const Aws::Vector<Aws::String>& value) { m_queryParamsMapOfStringListHasBeenSet = true; m_queryParamsMapOfStringList.emplace(std::move(key), value); return *this; }
    inline AllQueryStringTypesRequest& AddQueryParamsMapOfStringList(const Aws::String& key, Aws::Vector<Aws::String>&& value) { m_queryParamsMapOfStringListHasBeenSet = true; m_queryParamsMapOfStringList.emplace(key, std::move(value)); return *this; }
    inline AllQueryStringTypesRequest& AddQueryParamsMapOfStringList(Aws::String&& key, Aws::Vector<Aws::String>&& value) { m_queryParamsMapOfStringListHasBeenSet = true; m_queryParamsMapOfStringList.emplace(std::move(key), std::move(value)); return *this; }
    inline AllQueryStringTypesRequest& AddQueryParamsMapOfStringList(const char* key, Aws::Vector<Aws::String>&& value) { m_queryParamsMapOfStringListHasBeenSet = true; m_queryParamsMapOfStringList.emplace(key, std::move(value)); return *this; }
    inline AllQueryStringTypesRequest& AddQueryParamsMapOfStringList(const char* key, const Aws::Vector<Aws::String>& value) { m_queryParamsMapOfStringListHasBeenSet = true; m_queryParamsMapOfStringList.emplace(key, value); return *this; }
    ///@}
  private:
