...
class MyUnion {
 public:
  ...
  void SetRenamedStructureValue(RenamedStructureValueT&& value) {
    m_renamedStructureValueHasBeenSet = true;
    m_renamedStructureValue = std::forward<RenamedStructureValueT>(value);
  }
  template <typename RenamedStructureValueT = RenamedGreeting>
  MyUnion& WithRenamedStructureValue(RenamedStructureValueT&& value) {
    SetRenamedStructureValue(std::forward<RenamedStructureValueT>(value));
    return *this;
  }
  ///@}
 private:
