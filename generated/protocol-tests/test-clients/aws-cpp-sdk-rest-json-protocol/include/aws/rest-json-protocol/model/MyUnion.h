...
namespace Model
{
  ...
  {
  public:
    AWS_RESTJSONPROTOCOL_API MyUnion() = default;
    ...
    template<typename RenamedStructureValueT = RenamedGreeting>
    void SetRenamedStructureValue(RenamedStructureValueT&& value) { m_renamedStructureValueHasBeenSet = true; m_renamedStructureValue = std::forward<RenamedStructureValueT>(value); }
    template<typename RenamedStructureValueT = RenamedGreeting>
    MyUnion& WithRenamedStructureValue(RenamedStructureValueT&& value) { SetRenamedStructureValue(std::forward<RenamedStructureValueT>(value)); return *this;}
    ///@}
  private:
