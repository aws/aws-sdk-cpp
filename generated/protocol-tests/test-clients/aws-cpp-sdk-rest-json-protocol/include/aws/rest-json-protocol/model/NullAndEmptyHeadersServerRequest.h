...
namespace Model
{
  ...
  public:
    ...
    template<typename AT = Aws::String>
    NullAndEmptyHeadersServerRequest& WithA(AT&& value) { SetA(std::forward<AT>(value)); return *this;}
    ///@}
    ...
    template<typename BT = Aws::String>
    NullAndEmptyHeadersServerRequest& WithB(BT&& value) { SetB(std::forward<BT>(value)); return *this;}
    ///@}
    ...
    template<typename CT = Aws::Vector<Aws::String>>
    NullAndEmptyHeadersServerRequest& WithC(CT&& value) { SetC(std::forward<CT>(value)); return *this;}
    template<typename CT = Aws::String>
    NullAndEmptyHeadersServerRequest& AddC(CT&& value) { m_cHasBeenSet = true; m_c.emplace_back(std::forward<CT>(value)); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    NullAndEmptyHeadersServerRequest& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
