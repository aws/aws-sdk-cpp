...
namespace Model
{
  ...
  {
  public:
    AWS_RESTJSONPROTOCOL_API HttpRequestWithLabelsRequest() = default;
    ...
    template<typename StringT = Aws::String>
    HttpRequestWithLabelsRequest& WithString(StringT&& value) { SetString(std::forward<StringT>(value)); return *this;}
    ///@}
    ...
    template<typename TimestampT = Aws::Utils::DateTime>
    HttpRequestWithLabelsRequest& WithTimestamp(TimestampT&& value) { SetTimestamp(std::forward<TimestampT>(value)); return *this;}
    ///@}
  private:
