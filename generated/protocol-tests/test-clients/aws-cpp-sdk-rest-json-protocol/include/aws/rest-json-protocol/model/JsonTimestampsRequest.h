...
namespace Model
{
  ...
  public:
    ...
    template<typename NormalT = Aws::Utils::DateTime>
    JsonTimestampsRequest& WithNormal(NormalT&& value) { SetNormal(std::forward<NormalT>(value)); return *this;}
    ///@}
    ...
    template<typename DateTimeT = Aws::Utils::DateTime>
    JsonTimestampsRequest& WithDateTime(DateTimeT&& value) { SetDateTime(std::forward<DateTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename DateTimeOnTargetT = Aws::Utils::DateTime>
    JsonTimestampsRequest& WithDateTimeOnTarget(DateTimeOnTargetT&& value) { SetDateTimeOnTarget(std::forward<DateTimeOnTargetT>(value)); return *this;}
    ///@}
    ...
    template<typename EpochSecondsT = Aws::Utils::DateTime>
    JsonTimestampsRequest& WithEpochSeconds(EpochSecondsT&& value) { SetEpochSeconds(std::forward<EpochSecondsT>(value)); return *this;}
    ///@}
    ...
    template<typename EpochSecondsOnTargetT = Aws::Utils::DateTime>
    JsonTimestampsRequest& WithEpochSecondsOnTarget(EpochSecondsOnTargetT&& value) { SetEpochSecondsOnTarget(std::forward<EpochSecondsOnTargetT>(value)); return *this;}
    ///@}
    ...
    template<typename HttpDateT = Aws::Utils::DateTime>
    JsonTimestampsRequest& WithHttpDate(HttpDateT&& value) { SetHttpDate(std::forward<HttpDateT>(value)); return *this;}
    ///@}
    ...
    template<typename HttpDateOnTargetT = Aws::Utils::DateTime>
    JsonTimestampsRequest& WithHttpDateOnTarget(HttpDateOnTargetT&& value) { SetHttpDateOnTarget(std::forward<HttpDateOnTargetT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    JsonTimestampsRequest& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
