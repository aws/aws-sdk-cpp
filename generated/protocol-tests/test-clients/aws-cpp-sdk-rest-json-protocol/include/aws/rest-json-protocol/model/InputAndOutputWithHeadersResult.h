...
namespace Model
{
  ...
  public:
    ...
    template<typename HeaderIntegerEnumListT = Aws::Vector<int>>
    InputAndOutputWithHeadersResult& WithHeaderIntegerEnumList(HeaderIntegerEnumListT&& value) { SetHeaderIntegerEnumList(std::forward<HeaderIntegerEnumListT>(value)); return *this;}
    inline InputAndOutputWithHeadersResult& AddHeaderIntegerEnumList(int value) { m_headerIntegerEnumListHasBeenSet = true; m_headerIntegerEnumList.push_back(value); return *this; }
    ///@}
