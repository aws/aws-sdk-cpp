...
namespace Model
{
  ...
  public:
    ...
    void SetPrefixHeaders(PrefixHeadersT&& value) { m_prefixHeaders = std::forward<PrefixHeadersT>(value); }
    template<typename PrefixHeadersT = Aws::Map<Aws::String, Aws::String>>
    ...
    HttpPrefixHeadersInResponseResult& AddPrefixHeaders(PrefixHeadersKeyT&& key, PrefixHeadersValueT&& value) {
      m_prefixHeaders.emplace(std::forward<PrefixHeadersKeyT>(key), std::forward<PrefixHeadersValueT>(value)); return *this;
    }
    ///@}
