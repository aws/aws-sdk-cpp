...
namespace Model
{
  ...
  public:
    ...
    template<typename NormalT = Aws::Utils::DateTime>
    JsonTimestampsResult& WithNormal(NormalT&& value) { SetNormal(std::forward<NormalT>(value)); return *this;}
    ///@}
    ...
    template<typename DateTimeT = Aws::Utils::DateTime>
    JsonTimestampsResult& WithDateTime(DateTimeT&& value) { SetDateTime(std::forward<DateTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename DateTimeOnTargetT = Aws::Utils::DateTime>
    JsonTimestampsResult& WithDateTimeOnTarget(DateTimeOnTargetT&& value) { SetDateTimeOnTarget(std::forward<DateTimeOnTargetT>(value)); return *this;}
    ///@}
    ...
    template<typename EpochSecondsT = Aws::Utils::DateTime>
    JsonTimestampsResult& WithEpochSeconds(EpochSecondsT&& value) { SetEpochSeconds(std::forward<EpochSecondsT>(value)); return *this;}
    ///@}
    ...
    template<typename EpochSecondsOnTargetT = Aws::Utils::DateTime>
    JsonTimestampsResult& WithEpochSecondsOnTarget(EpochSecondsOnTargetT&& value) { SetEpochSecondsOnTarget(std::forward<EpochSecondsOnTargetT>(value)); return *this;}
    ///@}
    ...
    template<typename HttpDateT = Aws::Utils::DateTime>
    JsonTimestampsResult& WithHttpDate(HttpDateT&& value) { SetHttpDate(std::forward<HttpDateT>(value)); return *this;}
    ///@}
    ...
    template<typename HttpDateOnTargetT = Aws::Utils::DateTime>
    JsonTimestampsResult& WithHttpDateOnTarget(HttpDateOnTargetT&& value) { SetHttpDateOnTarget(std::forward<HttpDateOnTargetT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    JsonTimestampsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
