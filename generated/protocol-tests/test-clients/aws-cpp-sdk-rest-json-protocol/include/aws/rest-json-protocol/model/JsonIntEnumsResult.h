...
namespace Model
{
  ...
  public:
    ...
    void SetIntegerEnumList(IntegerEnumListT&& value) { m_integerEnumList = std::forward<IntegerEnumListT>(value); }
    template<typename IntegerEnumListT = Aws::Vector<int>>
    JsonIntEnumsResult& WithIntegerEnumList(IntegerEnumListT&& value) { SetIntegerEnumList(std::forward<IntegerEnumListT>(value)); return *this;}
    ...
    void SetIntegerEnumSet(IntegerEnumSetT&& value) { m_integerEnumSet = std::forward<IntegerEnumSetT>(value); }
    template<typename IntegerEnumSetT = Aws::Vector<int>>
    JsonIntEnumsResult& WithIntegerEnumSet(IntegerEnumSetT&& value) { SetIntegerEnumSet(std::forward<IntegerEnumSetT>(value)); return *this;}
    ...
    void SetIntegerEnumMap(IntegerEnumMapT&& value) { m_integerEnumMap = std::forward<IntegerEnumMapT>(value); }
    template<typename IntegerEnumMapT = Aws::Map<Aws::String, int>>
    JsonIntEnumsResult& WithIntegerEnumMap(IntegerEnumMapT&& value) { SetIntegerEnumMap(std::forward<IntegerEnumMapT>(value)); return *this;}
    inline JsonIntEnumsResult& AddIntegerEnumMap(Aws::String key, int value) {
      m_integerEnumMap.emplace(key, value); return *this;
    }
    ///@}
