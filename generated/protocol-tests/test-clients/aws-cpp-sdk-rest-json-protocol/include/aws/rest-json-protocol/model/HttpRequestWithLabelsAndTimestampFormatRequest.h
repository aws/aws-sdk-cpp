...
namespace Model
{
  ...
  {
  public:
    AWS_RESTJSONPROTOCOL_API HttpRequestWithLabelsAndTimestampFormatRequest() = default;
    ...
    template<typename MemberEpochSecondsT = Aws::Utils::DateTime>
    HttpRequestWithLabelsAndTimestampFormatRequest& WithMemberEpochSeconds(MemberEpochSecondsT&& value) { SetMemberEpochSeconds(std::forward<MemberEpochSecondsT>(value)); return *this;}
    ///@}
    ...
    template<typename MemberHttpDateT = Aws::Utils::DateTime>
    HttpRequestWithLabelsAndTimestampFormatRequest& WithMemberHttpDate(MemberHttpDateT&& value) { SetMemberHttpDate(std::forward<MemberHttpDateT>(value)); return *this;}
    ///@}
    ...
    template<typename MemberDateTimeT = Aws::Utils::DateTime>
    HttpRequestWithLabelsAndTimestampFormatRequest& WithMemberDateTime(MemberDateTimeT&& value) { SetMemberDateTime(std::forward<MemberDateTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename DefaultFormatT = Aws::Utils::DateTime>
    HttpRequestWithLabelsAndTimestampFormatRequest& WithDefaultFormat(DefaultFormatT&& value) { SetDefaultFormat(std::forward<DefaultFormatT>(value)); return *this;}
    ///@}
    ...
    template<typename TargetEpochSecondsT = Aws::Utils::DateTime>
    HttpRequestWithLabelsAndTimestampFormatRequest& WithTargetEpochSeconds(TargetEpochSecondsT&& value) { SetTargetEpochSeconds(std::forward<TargetEpochSecondsT>(value)); return *this;}
    ///@}
    ...
    template<typename TargetHttpDateT = Aws::Utils::DateTime>
    HttpRequestWithLabelsAndTimestampFormatRequest& WithTargetHttpDate(TargetHttpDateT&& value) { SetTargetHttpDate(std::forward<TargetHttpDateT>(value)); return *this;}
    ///@}
    ...
    template<typename TargetDateTimeT = Aws::Utils::DateTime>
    HttpRequestWithLabelsAndTimestampFormatRequest& WithTargetDateTime(TargetDateTimeT&& value) { SetTargetDateTime(std::forward<TargetDateTimeT>(value)); return *this;}
    ///@}
  private:
