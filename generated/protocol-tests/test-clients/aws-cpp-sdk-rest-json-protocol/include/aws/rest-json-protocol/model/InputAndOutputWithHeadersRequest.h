...
namespace Model
{
  ...
  public:
    ...
    void SetHeaderIntegerEnumList(HeaderIntegerEnumListT&& value) { m_headerIntegerEnumListHasBeenSet = true; m_headerIntegerEnumList = std::forward<HeaderIntegerEnumListT>(value); }
    template<typename HeaderIntegerEnumListT = Aws::Vector<int>>
    InputAndOutputWithHeadersRequest& WithHeaderIntegerEnumList(HeaderIntegerEnumListT&& value) { SetHeaderIntegerEnumList(std::forward<HeaderIntegerEnumListT>(value)); return *this;}
