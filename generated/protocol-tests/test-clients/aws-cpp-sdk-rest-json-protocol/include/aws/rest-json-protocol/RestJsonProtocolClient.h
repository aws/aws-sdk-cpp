    ...
    Aws::Client::ClientWithAsyncTemplateMethods<RestJsonProtocolClient>
  {
    public:
      ...
      typedef RestJsonProtocolEndpointProvider EndpointProviderType;
        ...
        */
        RestJsonProtocolClient(const Aws::RestJsonProtocol::RestJsonProtocolClientConfiguration& clientConfiguration = Aws::RestJsonProtocol::RestJsonProtocolClientConfiguration(),
        ...
        */
        RestJsonProtocolClient(const Aws::Auth::AWSCredentials& credentials,
                               std::shared_ptr<RestJsonProtocolEndpointProviderBase> endpointProvider = nullptr,
                               const Aws::RestJsonProtocol::RestJsonProtocolClientConfiguration& clientConfiguration = Aws::RestJsonProtocol::RestJsonProtocolClientConfiguration());
        ...
        */
        ...
        /**
         * An Async wrapper for DocumentType that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename DocumentTypeRequestT = Model::DocumentTypeRequest>
        void DocumentTypeAsync(const DocumentTypeResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const DocumentTypeRequestT& request = {}) const
        {
        ...
        /**
         * A Callable wrapper for DocumentTypeAsMapValue that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for DocumentTypeAsMapValue that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename DocumentTypeAsMapValueRequestT = Model::DocumentTypeAsMapValueRequest>
        void DocumentTypeAsMapValueAsync(const DocumentTypeAsMapValueResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const DocumentTypeAsMapValueRequestT& request = {}) const
        {
        ...
        /**
         * A Callable wrapper for DocumentTypeAsPayload that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for DocumentTypeAsPayload that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename DocumentTypeAsPayloadRequestT = Model::DocumentTypeAsPayloadRequest>
        void DocumentTypeAsPayloadAsync(const DocumentTypeAsPayloadResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const DocumentTypeAsPayloadRequestT& request = {}) const
        {
        ...
        /**
         * A Callable wrapper for HttpChecksumRequired that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for HttpChecksumRequired that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename HttpChecksumRequiredRequestT = Model::HttpChecksumRequiredRequest>
        void HttpChecksumRequiredAsync(const HttpChecksumRequiredResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const HttpChecksumRequiredRequestT& request = {}) const
        {
         ...
         * API Reference</a></p>
         */
        virtual Model::HttpPrefixHeadersInResponseOutcome HttpPrefixHeadersInResponse(const Model::HttpPrefixHeadersInResponseRequest& request = {}) const;

        /**
         * A Callable wrapper for HttpPrefixHeadersInResponse that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        template<typename HttpPrefixHeadersInResponseRequestT = Model::HttpPrefixHeadersInResponseRequest>
        Model::HttpPrefixHeadersInResponseOutcomeCallable HttpPrefixHeadersInResponseCallable(const HttpPrefixHeadersInResponseRequestT& request = {}) const
        {
            return SubmitCallable(&RestJsonProtocolClient::HttpPrefixHeadersInResponse, request);
        }

        /**
         * An Async wrapper for HttpPrefixHeadersInResponse that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename HttpPrefixHeadersInResponseRequestT = Model::HttpPrefixHeadersInResponseRequest>
        void HttpPrefixHeadersInResponseAsync(const HttpPrefixHeadersInResponseResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const HttpPrefixHeadersInResponseRequestT& request = {}) const
        {
         ...
         * 
         */
        virtual Model::HttpRequestWithRegexLiteralOutcome HttpRequestWithRegexLiteral(const Model::HttpRequestWithRegexLiteralRequest& request) const;

        /**
         * A Callable wrapper for HttpRequestWithRegexLiteral that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        template<typename HttpRequestWithRegexLiteralRequestT = Model::HttpRequestWithRegexLiteralRequest>
        Model::HttpRequestWithRegexLiteralOutcomeCallable HttpRequestWithRegexLiteralCallable(const HttpRequestWithRegexLiteralRequestT& request) const
        {
            return SubmitCallable(&RestJsonProtocolClient::HttpRequestWithRegexLiteral, request);
        }

        /**
         * An Async wrapper for HttpRequestWithRegexLiteral that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename HttpRequestWithRegexLiteralRequestT = Model::HttpRequestWithRegexLiteralRequest>
        void HttpRequestWithRegexLiteralAsync(const HttpRequestWithRegexLiteralRequestT& request, const HttpRequestWithRegexLiteralResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const
        {
        ...
        /**
         * An Async wrapper for JsonBlobs that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename JsonBlobsRequestT = Model::JsonBlobsRequest>
        void JsonBlobsAsync(const JsonBlobsResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const JsonBlobsRequestT& request = {}) const
        {
        ...
        /**
         * An Async wrapper for JsonEnums that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename JsonEnumsRequestT = Model::JsonEnumsRequest>
        void JsonEnumsAsync(const JsonEnumsResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const JsonEnumsRequestT& request = {}) const
        {
        ...
        /**
         * An Async wrapper for JsonIntEnums that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename JsonIntEnumsRequestT = Model::JsonIntEnumsRequest>
        void JsonIntEnumsAsync(const JsonIntEnumsResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const JsonIntEnumsRequestT& request = {}) const
        {
        ...
        /**
         * An Async wrapper for JsonLists that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename JsonListsRequestT = Model::JsonListsRequest>
        void JsonListsAsync(const JsonListsResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const JsonListsRequestT& request = {}) const
        {
        ...
        /**
         * An Async wrapper for JsonMaps that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename JsonMapsRequestT = Model::JsonMapsRequest>
        void JsonMapsAsync(const JsonMapsResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const JsonMapsRequestT& request = {}) const
        {
        ...
        /**
         * An Async wrapper for JsonTimestamps that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename JsonTimestampsRequestT = Model::JsonTimestampsRequest>
        void JsonTimestampsAsync(const JsonTimestampsResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const JsonTimestampsRequestT& request = {}) const
        {
        ...
        /**
         * An Async wrapper for MediaTypeHeader that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename MediaTypeHeaderRequestT = Model::MediaTypeHeaderRequest>
        void MediaTypeHeaderAsync(const MediaTypeHeaderResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const MediaTypeHeaderRequestT& request = {}) const
        {
         ...
         * API Reference</a></p>
         */
        virtual Model::OmitsSerializingEmptyListsOutcome OmitsSerializingEmptyLists(const Model::OmitsSerializingEmptyListsRequest& request = {}) const;

        /**
         * A Callable wrapper for OmitsSerializingEmptyLists that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        template<typename OmitsSerializingEmptyListsRequestT = Model::OmitsSerializingEmptyListsRequest>
        Model::OmitsSerializingEmptyListsOutcomeCallable OmitsSerializingEmptyListsCallable(const OmitsSerializingEmptyListsRequestT& request = {}) const
        {
            return SubmitCallable(&RestJsonProtocolClient::OmitsSerializingEmptyLists, request);
        }

        /**
         * An Async wrapper for OmitsSerializingEmptyLists that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename OmitsSerializingEmptyListsRequestT = Model::OmitsSerializingEmptyListsRequest>
        void OmitsSerializingEmptyListsAsync(const OmitsSerializingEmptyListsResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const OmitsSerializingEmptyListsRequestT& request = {}) const
        {
        ...
        /**
         * A Callable wrapper for PostUnionWithJsonName that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for PostUnionWithJsonName that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename PostUnionWithJsonNameRequestT = Model::PostUnionWithJsonNameRequest>
        void PostUnionWithJsonNameAsync(const PostUnionWithJsonNameResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const PostUnionWithJsonNameRequestT& request = {}) const
        {
        ...
        /**
         * A Callable wrapper for ResponseCodeHttpFallback that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        template<typename ResponseCodeHttpFallbackRequestT = Model::ResponseCodeHttpFallbackRequest>
        Model::ResponseCodeHttpFallbackOutcomeCallable ResponseCodeHttpFallbackCallable(const ResponseCodeHttpFallbackRequestT& request = {}) const
        {
            return SubmitCallable(&RestJsonProtocolClient::ResponseCodeHttpFallback, request);
        }

        /**
         * An Async wrapper for ResponseCodeHttpFallback that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename ResponseCodeHttpFallbackRequestT = Model::ResponseCodeHttpFallbackRequest>
        void ResponseCodeHttpFallbackAsync(const ResponseCodeHttpFallbackResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const ResponseCodeHttpFallbackRequestT& request = {}) const
        {
        ...
        /**
         * A Callable wrapper for ResponseCodeRequired that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for ResponseCodeRequired that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename ResponseCodeRequiredRequestT = Model::ResponseCodeRequiredRequest>
        void ResponseCodeRequiredAsync(const ResponseCodeRequiredResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const ResponseCodeRequiredRequestT& request = {}) const
        {
        ...
        /**
         * A Callable wrapper for TestBodyStructure that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for TestBodyStructure that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename TestBodyStructureRequestT = Model::TestBodyStructureRequest>
        void TestBodyStructureAsync(const TestBodyStructureResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const TestBodyStructureRequestT& request = {}) const
        {
        ...
        /**
         * A Callable wrapper for TestGetNoInputNoPayload that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for TestGetNoInputNoPayload that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename TestGetNoInputNoPayloadRequestT = Model::TestGetNoInputNoPayloadRequest>
        void TestGetNoInputNoPayloadAsync(const TestGetNoInputNoPayloadResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const TestGetNoInputNoPayloadRequestT& request = {}) const
        {
        ...
        /**
         * A Callable wrapper for TestGetNoPayload that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for TestGetNoPayload that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename TestGetNoPayloadRequestT = Model::TestGetNoPayloadRequest>
        void TestGetNoPayloadAsync(const TestGetNoPayloadResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const TestGetNoPayloadRequestT& request = {}) const
        {
        ...
        /**
         * An Async wrapper for TestPayloadBlob that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename TestPayloadBlobRequestT = Model::TestPayloadBlobRequest>
        void TestPayloadBlobAsync(const TestPayloadBlobResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const TestPayloadBlobRequestT& request = {}) const
        {
        ...
        /**
         * A Callable wrapper for TestPayloadStructure that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for TestPayloadStructure that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename TestPayloadStructureRequestT = Model::TestPayloadStructureRequest>
        void TestPayloadStructureAsync(const TestPayloadStructureResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const TestPayloadStructureRequestT& request = {}) const
        {
        ...
        /**
         * A Callable wrapper for TestPostNoInputNoPayload that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        template<typename TestPostNoInputNoPayloadRequestT = Model::TestPostNoInputNoPayloadRequest>
        Model::TestPostNoInputNoPayloadOutcomeCallable TestPostNoInputNoPayloadCallable(const TestPostNoInputNoPayloadRequestT& request = {}) const
        {
            return SubmitCallable(&RestJsonProtocolClient::TestPostNoInputNoPayload, request);
        }

        /**
         * An Async wrapper for TestPostNoInputNoPayload that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename TestPostNoInputNoPayloadRequestT = Model::TestPostNoInputNoPayloadRequest>
        void TestPostNoInputNoPayloadAsync(const TestPostNoInputNoPayloadResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const TestPostNoInputNoPayloadRequestT& request = {}) const
        {
        ...
        /**
         * A Callable wrapper for TestPostNoPayload that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for TestPostNoPayload that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename TestPostNoPayloadRequestT = Model::TestPostNoPayloadRequest>
        void TestPostNoPayloadAsync(const TestPostNoPayloadResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const TestPostNoPayloadRequestT& request = {}) const
        {
        ...
        /**
         * A Callable wrapper for UnitInputAndOutput that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for UnitInputAndOutput that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename UnitInputAndOutputRequestT = Model::UnitInputAndOutputRequest>
        void UnitInputAndOutputAsync(const UnitInputAndOutputResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const UnitInputAndOutputRequestT& request = {}) const
        {
