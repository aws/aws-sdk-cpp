...
namespace Model
{
  ...
  public:
    ...
    inline SetNextResponseRequest& WithStatusCode(int value) { SetStatusCode(value); return *this;}
    ///@}
    ...
    template<typename RequestBodyT = Aws::String>
    SetNextResponseRequest& WithRequestBody(RequestBodyT&& value) { SetRequestBody(std::forward<RequestBodyT>(value)); return *this;}
    ///@}
    ...
    template<typename HeaderValuesT = Aws::Vector<HttpHeader>>
    SetNextResponseRequest& WithHeaderValues(HeaderValuesT&& value) { SetHeaderValues(std::forward<HeaderValuesT>(value)); return *this;}
    template<typename HeaderValuesT = HttpHeader>
    SetNextResponseRequest& AddHeaderValues(HeaderValuesT&& value) { m_headerValuesHasBeenSet = true; m_headerValues.emplace_back(std::forward<HeaderValuesT>(value)); return *this; }
    ///@}
  private:
