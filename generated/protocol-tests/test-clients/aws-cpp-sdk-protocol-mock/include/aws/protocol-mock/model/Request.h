...
namespace Model
{
  ...
  public:
    ...
    template<typename TimestampT = Aws::Utils::DateTime>
    Request& WithTimestamp(TimestampT&& value) { SetTimestamp(std::forward<TimestampT>(value)); return *this;}
    ///@}
    ...
    template<typename MethodT = Aws::String>
    Request& WithMethod(MethodT&& value) { SetMethod(std::forward<MethodT>(value)); return *this;}
    ///@}
    ...
    template<typename BodyT = Aws::String>
    Request& WithBody(BodyT&& value) { SetBody(std::forward<BodyT>(value)); return *this;}
    ///@}
    ...
    template<typename UriT = Aws::String>
    Request& WithUri(UriT&& value) { SetUri(std::forward<UriT>(value)); return *this;}
    ///@}
    ...
    template<typename HostT = Aws::String>
    Request& WithHost(HostT&& value) { SetHost(std::forward<HostT>(value)); return *this;}
    ///@}
    ...
    template<typename HeadersT = Aws::Vector<HttpHeader>>
    Request& WithHeaders(HeadersT&& value) { SetHeaders(std::forward<HeadersT>(value)); return *this;}
    template<typename HeadersT = HttpHeader>
    Request& AddHeaders(HeadersT&& value) { m_headersHasBeenSet = true; m_headers.emplace_back(std::forward<HeadersT>(value)); return *this; }
    ///@}
  private:
