...
namespace Model
{
  ...
  public:
    ...
    template<typename KeyT = Aws::String>
    HttpHeader& WithKey(KeyT&& value) { SetKey(std::forward<KeyT>(value)); return *this;}
    ///@}
    ...
    void SetVal(ValT&& value) { m_valHasBeenSet = true; m_val = std::forward<ValT>(value); }
    template<typename ValT = Aws::String>
    HttpHeader& WithVal(ValT&& value) { SetVal(std::forward<ValT>(value)); return *this;}
    ///@}
  private:
