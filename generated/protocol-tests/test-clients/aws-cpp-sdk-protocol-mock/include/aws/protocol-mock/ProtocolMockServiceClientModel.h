...
namespace Aws
{
  ...
  namespace ProtocolMock
  {
    ...
    typedef std::function<void(const ProtocolMockClient*, const Model::GetRequestsReceivedRequest&, const Model::GetRequestsReceivedOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > GetRequestsReceivedResponseReceivedHandler;
    typedef std::function<void(const ProtocolMockClient*, const Model::PingRequest&, const Model::PingOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > PingResponseReceivedHandler;
    typedef std::function<void(const ProtocolMockClient*, const Model::ResetRequest&, const Model::ResetOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > ResetResponseReceivedHandler;
    typedef std::function<void(const ProtocolMockClient*, const Model::SetNextResponseRequest&, const Model::SetNextResponseOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > SetNextResponseResponseReceivedHandler;
    typedef std::function<void(const ProtocolMockClient*, const Model::TerminateRequest&, const Model::TerminateOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > TerminateResponseReceivedHandler;
