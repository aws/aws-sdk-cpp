...
namespace ProtocolMock
{
   ...
   */
  class AWS_PROTOCOLMOCK_API ProtocolMockClient : public Aws::Client::AWSJsonClient, public Aws::Client::ClientWithAsyncTemplateMethods<ProtocolMockClient>
  {
    public:
      ...
      typedef ProtocolMockEndpointProvider EndpointProviderType;
        ...
        */
        ProtocolMockClient(const Aws::ProtocolMock::ProtocolMockClientConfiguration& clientConfiguration = Aws::ProtocolMock::ProtocolMockClientConfiguration(),
        ...
        * is not specified, it will be initialized to default values.
        */
        ProtocolMockClient(const Aws::Auth::AWSCredentials& credentials,
                           std::shared_ptr<ProtocolMockEndpointProviderBase> endpointProvider = nullptr,
        ...
        */
        ...
        /**
         * A Callable wrapper for GetRequestsReceived that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for GetRequestsReceived that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename GetRequestsReceivedRequestT = Model::GetRequestsReceivedRequest>
        void GetRequestsReceivedAsync(const GetRequestsReceivedResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const GetRequestsReceivedRequestT& request = {}) const
        {
         ...
         */
        template<typename ResetRequestT = Model::ResetRequest>
        void ResetAsync(const ResetResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const ResetRequestT& request = {}) const
        {
        ...
        /**
         * An Async wrapper for SetNextResponse that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename SetNextResponseRequestT = Model::SetNextResponseRequest>
        void SetNextResponseAsync(const SetNextResponseResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const SetNextResponseRequestT& request = {}) const
        {
        ...
        /**
         * An Async wrapper for Terminate that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename TerminateRequestT = Model::TerminateRequest>
        void TerminateAsync(const TerminateResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const TerminateRequestT& request = {}) const
        {
