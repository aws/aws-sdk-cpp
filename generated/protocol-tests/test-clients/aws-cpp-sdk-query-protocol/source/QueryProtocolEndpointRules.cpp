...
{
const size_t QueryProtocolEndpointRules::RulesBlobStrLen = 1086;
const size_t QueryProtocolEndpointRules::RulesBlobSize = 1087;
...
const char* QueryProtocolEndpointRules::GetRulesBlob()
{
