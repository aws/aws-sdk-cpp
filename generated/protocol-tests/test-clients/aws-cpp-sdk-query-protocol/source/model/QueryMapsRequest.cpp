...
Aws::String QueryMapsRequest::SerializePayload() const
{
  ...
  if(m_mapArgHasBeenSet)
  {
    ...
    {
      ss << "MapArg.entry." << mapArgCount << ".key="
          << StringUtils::URLEncode(item.first.c_str()) << "&";
      ss << "MapArg.entry." << mapArgCount << ".value="
  ...
  if(m_renamedMapArgHasBeenSet)
  {
    ...
    {
      ss << "Foo." << renamedMapArgCount << ".key="
          << StringUtils::URLEncode(item.first.c_str()) << "&";
      ss << "Foo." << renamedMapArgCount << ".value="
          << StringUtils::URLEncode(item.second.c_str()) << "&";
      renamedMapArgCount++;
    }
  }
  ...
  if(m_complexMapArgHasBeenSet)
  {
    ...
    {
      ss << "ComplexMapArg.entry." << complexMapArgCount << ".key="
          << StringUtils::URLEncode(item.first.c_str()) << "&";
  ...
  if(m_mapWithXmlMemberNameHasBeenSet)
  {
    ...
    {
      ss << "MapWithXmlMemberName.entry." << mapWithXmlMemberNameCount << ".K="
          << StringUtils::URLEncode(item.first.c_str()) << "&";
      ss << "MapWithXmlMemberName.entry." << mapWithXmlMemberNameCount << ".V="
          << StringUtils::URLEncode(item.second.c_str()) << "&";
  ...
  if(m_flattenedMapHasBeenSet)
  {
    ...
    {
      ss << "FlattenedMap.entry." << flattenedMapCount << ".key="
          << StringUtils::URLEncode(item.first.c_str()) << "&";
      ss << "FlattenedMap.entry." << flattenedMapCount << ".value="
          << StringUtils::URLEncode(item.second.c_str()) << "&";
      flattenedMapCount++;
    }
  }
  ...
  if(m_flattenedMapWithXmlNameHasBeenSet)
  {
    ...
    {
      ss << "Hi." << flattenedMapWithXmlNameCount << ".K="
          << StringUtils::URLEncode(item.first.c_str()) << "&";
      ss << "Hi." << flattenedMapWithXmlNameCount << ".V="
          << StringUtils::URLEncode(item.second.c_str()) << "&";
...
void  QueryMapsRequest::DumpBodyToUrl(Aws::Http::URI& uri ) const
{
