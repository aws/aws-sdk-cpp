...
IgnoresWrappingXmlNameResult::IgnoresWrappingXmlNameResult()
{
}

IgnoresWrappingXmlNameResult::IgnoresWrappingXmlNameResult(const Aws::AmazonWebServiceResult<XmlDocument>& result)
{
  *this = result;
}
...
IgnoresWrappingXmlNameResult& IgnoresWrappingXmlNameResult::operator =(const Aws::AmazonWebServiceResult<XmlDocument>& result)
{
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::QueryProtocol::Model::IgnoresWrappingXmlNameResult", "x-amzn-request-id: " << m_responseMetadata.GetRequestId() );
  }
  return *this;
}
