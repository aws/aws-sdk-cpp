...
namespace Aws
{
  ...
  namespace QueryProtocol
  {
    ...
    typedef std::function<void(const QueryProtocolClient*, const Model::DatetimeOffsetsRequest&, const Model::DatetimeOffsetsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > DatetimeOffsetsResponseReceivedHandler;
    typedef std::function<void(const QueryProtocolClient*, const Model::EmptyInputAndEmptyOutputRequest&, const Model::EmptyInputAndEmptyOutputOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > EmptyInputAndEmptyOutputResponseReceivedHandler;
    typedef std::function<void(const QueryProtocolClient*, const Model::EndpointOperationRequest&, const Model::EndpointOperationOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > EndpointOperationResponseReceivedHandler;
    typedef std::function<void(const QueryProtocolClient*, const Model::EndpointWithHostLabelOperationRequest&, const Model::EndpointWithHostLabelOperationOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > EndpointWithHostLabelOperationResponseReceivedHandler;
    typedef std::function<void(const QueryProtocolClient*, const Model::FlattenedXmlMapRequest&, const Model::FlattenedXmlMapOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > FlattenedXmlMapResponseReceivedHandler;
    typedef std::function<void(const QueryProtocolClient*, const Model::FlattenedXmlMapWithXmlNameRequest&, const Model::FlattenedXmlMapWithXmlNameOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > FlattenedXmlMapWithXmlNameResponseReceivedHandler;
    typedef std::function<void(const QueryProtocolClient*, const Model::FlattenedXmlMapWithXmlNamespaceRequest&, const Model::FlattenedXmlMapWithXmlNamespaceOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > FlattenedXmlMapWithXmlNamespaceResponseReceivedHandler;
    typedef std::function<void(const QueryProtocolClient*, const Model::FractionalSecondsRequest&, const Model::FractionalSecondsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > FractionalSecondsResponseReceivedHandler;
    typedef std::function<void(const QueryProtocolClient*, const Model::GreetingWithErrorsRequest&, const Model::GreetingWithErrorsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > GreetingWithErrorsResponseReceivedHandler;
    typedef std::function<void(const QueryProtocolClient*, const Model::HostWithPathOperationRequest&, const Model::HostWithPathOperationOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > HostWithPathOperationResponseReceivedHandler;
    typedef std::function<void(const QueryProtocolClient*, const Model::IgnoresWrappingXmlNameRequest&, const Model::IgnoresWrappingXmlNameOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > IgnoresWrappingXmlNameResponseReceivedHandler;
    typedef std::function<void(const QueryProtocolClient*, const Model::NestedStructuresRequest&, const Model::NestedStructuresOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > NestedStructuresResponseReceivedHandler;
    typedef std::function<void(const QueryProtocolClient*, const Model::NoInputAndNoOutputRequest&, const Model::NoInputAndNoOutputOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > NoInputAndNoOutputResponseReceivedHandler;
    typedef std::function<void(const QueryProtocolClient*, const Model::NoInputAndOutputRequest&, const Model::NoInputAndOutputOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > NoInputAndOutputResponseReceivedHandler;
    typedef std::function<void(const QueryProtocolClient*, const Model::PutWithContentEncodingRequest&, const Model::PutWithContentEncodingOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > PutWithContentEncodingResponseReceivedHandler;
    typedef std::function<void(const QueryProtocolClient*, const Model::QueryIdempotencyTokenAutoFillRequest&, const Model::QueryIdempotencyTokenAutoFillOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > QueryIdempotencyTokenAutoFillResponseReceivedHandler;
    typedef std::function<void(const QueryProtocolClient*, const Model::QueryListsRequest&, const Model::QueryListsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > QueryListsResponseReceivedHandler;
    typedef std::function<void(const QueryProtocolClient*, const Model::QueryMapsRequest&, const Model::QueryMapsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > QueryMapsResponseReceivedHandler;
    typedef std::function<void(const QueryProtocolClient*, const Model::QueryTimestampsRequest&, const Model::QueryTimestampsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > QueryTimestampsResponseReceivedHandler;
    typedef std::function<void(const QueryProtocolClient*, const Model::RecursiveXmlShapesRequest&, const Model::RecursiveXmlShapesOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > RecursiveXmlShapesResponseReceivedHandler;
    typedef std::function<void(const QueryProtocolClient*, const Model::SimpleInputParamsRequest&, const Model::SimpleInputParamsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > SimpleInputParamsResponseReceivedHandler;
    typedef std::function<void(const QueryProtocolClient*, const Model::SimpleScalarXmlPropertiesRequest&, const Model::SimpleScalarXmlPropertiesOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > SimpleScalarXmlPropertiesResponseReceivedHandler;
    typedef std::function<void(const QueryProtocolClient*, const Model::XmlBlobsRequest&, const Model::XmlBlobsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > XmlBlobsResponseReceivedHandler;
    typedef std::function<void(const QueryProtocolClient*, const Model::XmlEmptyBlobsRequest&, const Model::XmlEmptyBlobsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > XmlEmptyBlobsResponseReceivedHandler;
    typedef std::function<void(const QueryProtocolClient*, const Model::XmlEmptyListsRequest&, const Model::XmlEmptyListsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > XmlEmptyListsResponseReceivedHandler;
    typedef std::function<void(const QueryProtocolClient*, const Model::XmlEmptyMapsRequest&, const Model::XmlEmptyMapsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > XmlEmptyMapsResponseReceivedHandler;
    typedef std::function<void(const QueryProtocolClient*, const Model::XmlEnumsRequest&, const Model::XmlEnumsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > XmlEnumsResponseReceivedHandler;
    typedef std::function<void(const QueryProtocolClient*, const Model::XmlIntEnumsRequest&, const Model::XmlIntEnumsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > XmlIntEnumsResponseReceivedHandler;
    typedef std::function<void(const QueryProtocolClient*, const Model::XmlListsRequest&, const Model::XmlListsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > XmlListsResponseReceivedHandler;
    typedef std::function<void(const QueryProtocolClient*, const Model::XmlMapsRequest&, const Model::XmlMapsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > XmlMapsResponseReceivedHandler;
    typedef std::function<void(const QueryProtocolClient*, const Model::XmlMapsXmlNameRequest&, const Model::XmlMapsXmlNameOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > XmlMapsXmlNameResponseReceivedHandler;
    typedef std::function<void(const QueryProtocolClient*, const Model::XmlNamespacesRequest&, const Model::XmlNamespacesOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > XmlNamespacesResponseReceivedHandler;
    typedef std::function<void(const QueryProtocolClient*, const Model::XmlTimestampsRequest&, const Model::XmlTimestampsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > XmlTimestampsResponseReceivedHandler;
