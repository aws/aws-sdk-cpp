...
namespace Model
{
  ...
  public:
    ...
    void SetNormal(NormalT&& value) { m_normal = std::forward<NormalT>(value); }
    template<typename NormalT = Aws::Utils::DateTime>
    ...
    void SetDateTime(DateTimeT&& value) { m_dateTime = std::forward<DateTimeT>(value); }
    template<typename DateTimeT = Aws::Utils::DateTime>
    ...
    void SetDateTimeOnTarget(DateTimeOnTargetT&& value) { m_dateTimeOnTarget = std::forward<DateTimeOnTargetT>(value); }
    template<typename DateTimeOnTargetT = Aws::Utils::DateTime>
    ...
    void SetEpochSeconds(EpochSecondsT&& value) { m_epochSeconds = std::forward<EpochSecondsT>(value); }
    template<typename EpochSecondsT = Aws::Utils::DateTime>
    ...
    void SetEpochSecondsOnTarget(EpochSecondsOnTargetT&& value) { m_epochSecondsOnTarget = std::forward<EpochSecondsOnTargetT>(value); }
    template<typename EpochSecondsOnTargetT = Aws::Utils::DateTime>
    ...
    void SetHttpDate(HttpDateT&& value) { m_httpDate = std::forward<HttpDateT>(value); }
    template<typename HttpDateT = Aws::Utils::DateTime>
    ...
    void SetHttpDateOnTarget(HttpDateOnTargetT&& value) { m_httpDateOnTarget = std::forward<HttpDateOnTargetT>(value); }
    template<typename HttpDateOnTargetT = Aws::Utils::DateTime>
    ...
    void SetResponseMetadata(ResponseMetadataT&& value) { m_responseMetadata = std::forward<ResponseMetadataT>(value); }
    template<typename ResponseMetadataT = ResponseMetadata>
