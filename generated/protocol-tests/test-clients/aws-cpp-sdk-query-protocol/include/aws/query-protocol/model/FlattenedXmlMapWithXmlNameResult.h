...
namespace Model
{
  ...
  {
  public:
    AWS_QUERYPROTOCOL_API FlattenedXmlMapWithXmlNameResult() = default;
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    FlattenedXmlMapWithXmlNameResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
