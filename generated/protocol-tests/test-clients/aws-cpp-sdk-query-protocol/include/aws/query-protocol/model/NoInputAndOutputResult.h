...
namespace Model
{
  ...
  {
  public:
    AWS_QUERYPROTOCOL_API NoInputAndOutputResult();
    ...
    inline NoInputAndOutputResult& WithResponseMetadata(const ResponseMetadata& value) { SetResponseMetadata(value); return *this;}
    inline NoInputAndOutputResult& WithResponseMetadata(ResponseMetadata&& value) { SetResponseMetadata(std::move(value)); return *this;}
    ///@}
  private:
