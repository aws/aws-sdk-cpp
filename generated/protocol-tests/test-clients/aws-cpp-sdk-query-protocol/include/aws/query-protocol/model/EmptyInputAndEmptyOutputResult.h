...
namespace Model
{
  ...
  {
  public:
    AWS_QUERYPROTOCOL_API EmptyInputAndEmptyOutputResult() = default;
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    EmptyInputAndEmptyOutputResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
