...
namespace Model
{
  ...
  public:
    ...
    template<typename MyMapT = Aws::Map<Aws::String, GreetingStruct>>
    XmlEmptyMapsResult& WithMyMap(MyMapT&& value) { SetMyMap(std::forward<MyMapT>(value)); return *this;}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    XmlEmptyMapsResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
