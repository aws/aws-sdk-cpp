...
namespace Model
{
  ...
  {
  public:
    AWS_QUERYPROTOCOL_API XmlIntEnumsResult();
    ...
    inline XmlIntEnumsResult& WithResponseMetadata(const ResponseMetadata& value) { SetResponseMetadata(value); return *this;}
    inline XmlIntEnumsResult& WithResponseMetadata(ResponseMetadata&& value) { SetResponseMetadata(std::move(value)); return *this;}
    ///@}
  private:
