...
namespace Model
{
  ...
  {
  public:
    AWS_QUERYPROTOCOL_API XmlMapsXmlNameResult() = default;
    ...
    template<typename MyMapT = Aws::Map<Aws::String, GreetingStruct>>
    XmlMapsXmlNameResult& WithMyMap(MyMapT&& value) { SetMyMap(std::forward<MyMapT>(value)); return *this;}
    template<typename MyMapKeyT = Aws::String, typename MyMapValueT = GreetingStruct>
    XmlMapsXmlNameResult& AddMyMap(MyMapKeyT&& key, MyMapValueT&& value) {
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    XmlMapsXmlNameResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
