...
namespace Model
{
  ...
  public:
    ...
    template<typename MyMapT = Aws::Map<Aws::String, FooEnum>>
    FlattenedXmlMapResult& WithMyMap(MyMapT&& value) { SetMyMap(std::forward<MyMapT>(value)); return *this;}
    inline FlattenedXmlMapResult& AddMyMap(Aws::String key, FooEnum value) {
      m_myMapHasBeenSet = true; m_myMap.emplace(key, value); return *this;
    }
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    FlattenedXmlMapResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
