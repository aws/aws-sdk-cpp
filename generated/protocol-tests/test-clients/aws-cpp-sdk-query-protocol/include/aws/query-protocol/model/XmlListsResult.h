...
namespace Model
{
  ...
  public:
    ...
    XmlListsResult& AddStringList(StringListT&& value) { m_stringList.emplace_back(std::forward<StringListT>(value)); return *this; }
    ///@}
    ...
    XmlListsResult& AddStringSet(StringSetT&& value) { m_stringSet.emplace_back(std::forward<StringSetT>(value)); return *this; }
    ///@}
    ...
    XmlListsResult& AddTimestampList(TimestampListT&& value) { m_timestampList.emplace_back(std::forward<TimestampListT>(value)); return *this; }
    ///@}
    ...
    inline XmlListsResult& AddEnumList(FooEnum value) { m_enumList.push_back(value); return *this; }
    ///@}
    ...
    XmlListsResult& AddNestedStringList(NestedStringListT&& value) { m_nestedStringList.emplace_back(std::forward<NestedStringListT>(value)); return *this; }
    ///@}
    ...
    XmlListsResult& AddRenamedListMembers(RenamedListMembersT&& value) { m_renamedListMembers.emplace_back(std::forward<RenamedListMembersT>(value)); return *this; }
    ///@}
    ...
    XmlListsResult& AddFlattenedList(FlattenedListT&& value) { m_flattenedList.emplace_back(std::forward<FlattenedListT>(value)); return *this; }
    ///@}
    ...
    XmlListsResult& AddFlattenedList2(FlattenedList2T&& value) { m_flattenedList2.emplace_back(std::forward<FlattenedList2T>(value)); return *this; }
    ///@}
    ...
    XmlListsResult& AddFlattenedListWithMemberNamespace(FlattenedListWithMemberNamespaceT&& value) { m_flattenedListWithMemberNamespace.emplace_back(std::forward<FlattenedListWithMemberNamespaceT>(value)); return *this; }
    ///@}
    ...
    XmlListsResult& AddFlattenedListWithNamespace(FlattenedListWithNamespaceT&& value) { m_flattenedListWithNamespace.emplace_back(std::forward<FlattenedListWithNamespaceT>(value)); return *this; }
    ///@}
    ...
    XmlListsResult& AddStructureList(StructureListT&& value) { m_structureList.emplace_back(std::forward<StructureListT>(value)); return *this; }
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    XmlListsResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
