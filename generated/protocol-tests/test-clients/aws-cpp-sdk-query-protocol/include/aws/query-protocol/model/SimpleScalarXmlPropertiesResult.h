...
namespace Model
{
  ...
  public:
    ...
    template<typename StringValueT = Aws::String>
    SimpleScalarXmlPropertiesResult& WithStringValue(StringValueT&& value) { SetStringValue(std::forward<StringValueT>(value)); return *this;}
    ///@}
    ...
    template<typename EmptyStringValueT = Aws::String>
    SimpleScalarXmlPropertiesResult& WithEmptyStringValue(EmptyStringValueT&& value) { SetEmptyStringValue(std::forward<EmptyStringValueT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    SimpleScalarXmlPropertiesResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
