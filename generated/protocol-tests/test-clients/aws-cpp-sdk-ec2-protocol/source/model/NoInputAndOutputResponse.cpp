...
NoInputAndOutputResponse::NoInputAndOutputResponse()
{
}

NoInputAndOutputResponse::NoInputAndOutputResponse(const Aws::AmazonWebServiceResult<XmlDocument>& result)
{
  *this = result;
}
