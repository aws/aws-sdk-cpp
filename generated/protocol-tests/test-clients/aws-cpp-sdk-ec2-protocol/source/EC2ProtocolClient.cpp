...
EC2ProtocolClient::EC2ProtocolClient(const AWSCredentials& credentials,
                                     std::shared_ptr<EC2ProtocolEndpointProviderBase> endpointProvider,
...
EC2ProtocolClient::~EC2ProtocolClient()
{
  ShutdownSdkClient(this, -1);
}

std::shared_ptr<EC2ProtocolEndpointProviderBase>& EC2ProtocolClient::accessEndpointProvider()
{
...
EndpointWithHostLabelOperationOutcome EC2ProtocolClient::EndpointWithHostLabelOperation(const EndpointWithHostLabelOperationRequest& request) const
{
...
QueryIdempotencyTokenAutoFillOutcome EC2ProtocolClient::QueryIdempotencyTokenAutoFill(const QueryIdempotencyTokenAutoFillRequest& request) const
{
