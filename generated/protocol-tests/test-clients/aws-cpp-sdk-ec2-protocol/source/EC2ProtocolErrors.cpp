...
template <>
AWS_EC2PROTOCOL_API ComplexError EC2ProtocolError::GetModeledError() {
...
static const int ACTIVE_VPC_PEERING_CONNECTION_PER_VPC_LIMIT_EXCEEDED_HASH =
    HashingUtils::HashString("ActiveVpcPeeringConnectionPerVpcLimitExceeded");
...
static const int INVALID_CUSTOMER_GATEWAY__DUPLICATE_IP_ADDRESS_HASH =
    HashingUtils::HashString("InvalidCustomerGateway.DuplicateIpAddress");
...
static const int INVALID_NETWORK_INTERFACE_ATTACHMENT_I_D__MALFORMED_HASH =
    HashingUtils::HashString("InvalidNetworkInterfaceAttachmentID.Malformed");
...
static const int OUTSTANDING_VPC_PEERING_CONNECTION_LIMIT_EXCEEDED_HASH =
    HashingUtils::HashString("OutstandingVpcPeeringConnectionLimitExceeded");
...
static bool GetErrorForNameHelper0(int hashCode, AWSError<CoreErrors>& error) {
  if (hashCode == DRY_RUN_OPERATION_HASH) {
    ...
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::INVALID_VPN_CONNECTION_I_D__NOT_FOUND),
    ...
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::RESERVED_INSTANCES_LIMIT_EXCEEDED), RetryableType::NOT_RETRYABLE);
    return true;
  } else if (hashCode == INVALID_VPC_ENDPOINT_ID__NOT_FOUND_HASH) {
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::INVALID_VPC_ENDPOINT_ID__NOT_FOUND), RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::INVALID_NETWORK_INTERFACE_ID__MALFORMED),
                                 RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::VPC_PEERING_CONNECTION_ALREADY_EXISTS),
                                 RetryableType::NOT_RETRYABLE);
    return true;
  } else if (hashCode == INVALID_VPC_ENDPOINT_ID__MALFORMED_HASH) {
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::INVALID_VPC_ENDPOINT_ID__MALFORMED), RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::INVALID_RESERVED_INSTANCES_OFFERING_ID),
                                 RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::INVALID_VOLUME_I_D__ZONE_MISMATCH), RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::INVALID_SPOT_FLEET_REQUEST_ID__MALFORMED),
                                 RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::INVALID_RESERVATION_I_D__MALFORMED), RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::INVALID_SECURITY__REQUEST_HAS_EXPIRED),
                                 RetryableType::NOT_RETRYABLE);
    return true;
  } else if (hashCode == INVALID_SPOT_INSTANCE_REQUEST_I_D__MALFORMED_HASH) {
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::INVALID_SPOT_INSTANCE_REQUEST_I_D__MALFORMED),
                                 RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::INVALID_ATTACHMENT_I_D__NOT_FOUND), RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::ACTIVE_VPC_PEERING_CONNECTION_PER_VPC_LIMIT_EXCEEDED),
                                 RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::INVALID_DHCP_OPTION_I_D__NOT_FOUND), RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::INVALID_PREFIX_LIST_ID__MALFORMED), RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::VOLUME_TYPE_NOT_AVAILABLE_IN_ZONE), RetryableType::NOT_RETRYABLE);
    return true;
  } else if (hashCode == INSUFFICIENT_FREE_ADDRESSES_IN_SUBNET_HASH) {
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::INSUFFICIENT_FREE_ADDRESSES_IN_SUBNET),
                                 RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::INVALID_A_M_I_ATTRIBUTE_ITEM_VALUE), RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::INVALID_SPOT_DATAFEED__NOT_FOUND), RetryableType::NOT_RETRYABLE);
    return true;
  } else if (hashCode == INSUFFICIENT_RESERVED_INSTANCES_CAPACITY_HASH) {
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::INSUFFICIENT_RESERVED_INSTANCES_CAPACITY),
                                 RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::INVALID_ROUTE_TABLE_ID__MALFORMED), RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::INVALID_VPC_PEERING_CONNECTION_ID__MALFORMED),
                                 RetryableType::NOT_RETRYABLE);
    return true;
  } else if (hashCode == PRIVATE_IP_ADDRESS_LIMIT_EXCEEDED_HASH) {
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::PRIVATE_IP_ADDRESS_LIMIT_EXCEEDED), RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::CONCURRENT_SNAPSHOT_LIMIT_EXCEEDED), RetryableType::NOT_RETRYABLE);
    return true;
  } else if (hashCode == SECURITY_GROUPS_PER_INSTANCE_LIMIT_EXCEEDED_HASH) {
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::SECURITY_GROUPS_PER_INSTANCE_LIMIT_EXCEEDED),
                                 RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::INVALID_ROUTE_TABLE_I_D__NOT_FOUND), RetryableType::NOT_RETRYABLE);
    return true;
  } else if (hashCode == INVALID_SECURITY_GROUP_I_D__NOT_FOUND_HASH) {
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::INVALID_SECURITY_GROUP_I_D__NOT_FOUND),
                                 RetryableType::NOT_RETRYABLE);
    return true;
  } else if (hashCode == INVALID_PLACEMENT_GROUP__UNKNOWN_HASH) {
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::INVALID_PLACEMENT_GROUP__UNKNOWN), RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::INVALID_CUSTOMER_GATEWAY__DUPLICATE_IP_ADDRESS),
                                 RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::INVALID_INSTANCE_ATTRIBUTE_VALUE), RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::INVALID_ASSOCIATION_I_D__NOT_FOUND), RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::MAX_SPOT_FLEET_REQUEST_COUNT_EXCEEDED),
                                 RetryableType::NOT_RETRYABLE);
    return true;
  } else if (hashCode == INVALID_ALLOCATION_I_D__NOT_FOUND_HASH) {
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::INVALID_ALLOCATION_I_D__NOT_FOUND), RetryableType::NOT_RETRYABLE);
    return true;
  } else if (hashCode == INVALID_CUSTOMER_GATEWAY_I_D__NOT_FOUND_HASH) {
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::INVALID_CUSTOMER_GATEWAY_I_D__NOT_FOUND),
                                 RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::INVALID_SPOT_FLEET_REQUEST_ID__NOT_FOUND),
                                 RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::VPN_GATEWAY_ATTACHMENT_LIMIT_EXCEEDED),
                                 RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::INVALID_SPOT_FLEET_REQUEST_CONFIG), RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::SECURITY_GROUPS_PER_INTERFACE_LIMIT_EXCEEDED),
                                 RetryableType::NOT_RETRYABLE);
    return true;
  } else if (hashCode == MAX_SPOT_INSTANCE_COUNT_EXCEEDED_HASH) {
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::MAX_SPOT_INSTANCE_COUNT_EXCEEDED), RetryableType::NOT_RETRYABLE);
    return true;
  }
  return false;
}
...
static bool GetErrorForNameHelper1(int hashCode, AWSError<CoreErrors>& error) {
  if (hashCode == INVALID_ADDRESS__MALFORMED_HASH) {
    ...
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::INVALID_DHCP_OPTIONS_ID__MALFORMED), RetryableType::NOT_RETRYABLE);
    return true;
  } else if (hashCode == NETWORK_ACL_ENTRY_ALREADY_EXISTS_HASH) {
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::NETWORK_ACL_ENTRY_ALREADY_EXISTS), RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::INVALID_PREFIX_LIST_ID__NOT_FOUND), RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::INVALID_DHCP_OPTIONS_I_D__NOT_FOUND), RetryableType::NOT_RETRYABLE);
    return true;
  } else if (hashCode == NETWORK_ACL_ENTRY_LIMIT_EXCEEDED_HASH) {
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::NETWORK_ACL_ENTRY_LIMIT_EXCEEDED), RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::INVALID_NETWORK_INTERFACE_I_D__NOT_FOUND),
                                 RetryableType::NOT_RETRYABLE);
    return true;
  } else if (hashCode == INVALID_VPN_GATEWAY_I_D__NOT_FOUND_HASH) {
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::INVALID_VPN_GATEWAY_I_D__NOT_FOUND), RetryableType::NOT_RETRYABLE);
    return true;
  } else if (hashCode == INVALID_SPOT_INSTANCE_REQUEST_I_D__NOT_FOUND_HASH) {
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::INVALID_SPOT_INSTANCE_REQUEST_I_D__NOT_FOUND),
                                 RetryableType::NOT_RETRYABLE);
    return true;
  } else if (hashCode == RULES_PER_SECURITY_GROUP_LIMIT_EXCEEDED_HASH) {
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::RULES_PER_SECURITY_GROUP_LIMIT_EXCEEDED),
                                 RetryableType::NOT_RETRYABLE);
    return true;
  } else if (hashCode == INVALID_PLACEMENT_GROUP__DUPLICATE_HASH) {
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::INVALID_PLACEMENT_GROUP__DUPLICATE), RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::INVALID_EXPORT_TASK_I_D__NOT_FOUND), RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::INVALID_NETWORK_ACL_ENTRY__NOT_FOUND),
                                 RetryableType::NOT_RETRYABLE);
    return true;
  } else if (hashCode == INVALID_VPC_PEERING_CONNECTION_I_D__NOT_FOUND_HASH) {
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::INVALID_VPC_PEERING_CONNECTION_I_D__NOT_FOUND),
                                 RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::INVALID_INSTANCE_I_D__NOT_LINKABLE), RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::INVALID_INTERNET_GATEWAY_I_D__NOT_FOUND),
                                 RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::INVALID_NETWORK_INTERFACE_ATTACHMENT_I_D__MALFORMED),
                                 RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::INVALID_VPN_GATEWAY_ATTACHMENT__NOT_FOUND),
                                 RetryableType::NOT_RETRYABLE);
    return true;
  } else if (hashCode == OUTSTANDING_VPC_PEERING_CONNECTION_LIMIT_EXCEEDED_HASH) {
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::OUTSTANDING_VPC_PEERING_CONNECTION_LIMIT_EXCEEDED),
                                 RetryableType::NOT_RETRYABLE);
    return true;
  } else if (hashCode == INVALID_CUSTOMER_GATEWAY_ID__MALFORMED_HASH) {
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::INVALID_CUSTOMER_GATEWAY_ID__MALFORMED),
                                 RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::INVALID_INTERFACE__IP_ADDRESS_LIMIT_EXCEEDED),
                                 RetryableType::NOT_RETRYABLE);
    return true;
  } else if (hashCode == INVALID_NETWORK_ACL_I_D__NOT_FOUND_HASH) {
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::INVALID_NETWORK_ACL_I_D__NOT_FOUND), RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(EC2ProtocolErrors::INVALID_RESERVATION_I_D__NOT_FOUND), RetryableType::NOT_RETRYABLE);
    return true;
