...
{
const size_t EC2ProtocolEndpointRules::RulesBlobStrLen = 1086;
const size_t EC2ProtocolEndpointRules::RulesBlobSize = 1087;
...
const char* EC2ProtocolEndpointRules::GetRulesBlob()
{
