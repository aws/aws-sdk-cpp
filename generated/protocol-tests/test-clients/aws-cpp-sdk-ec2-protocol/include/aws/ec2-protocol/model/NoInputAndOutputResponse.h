...
namespace Model
{
  ...
  {
  public:
    AWS_EC2PROTOCOL_API NoInputAndOutputResponse();
    ...
    inline NoInputAndOutputResponse& WithResponseMetadata(const ResponseMetadata& value) { SetResponseMetadata(value); return *this;}
    inline NoInputAndOutputResponse& WithResponseMetadata(ResponseMetadata&& value) { SetResponseMetadata(std::move(value)); return *this;}
    ///@}
  private:
