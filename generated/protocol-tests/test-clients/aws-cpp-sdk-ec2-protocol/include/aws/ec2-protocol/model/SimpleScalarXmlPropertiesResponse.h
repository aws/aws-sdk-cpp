...
class SimpleScalarXmlPropertiesResponse {
 public:
  AWS_EC2PROTOCOL_API SimpleScalarXmlPropertiesResponse() = default;
  ...
  template <typename StringValueT = Aws::String>
  SimpleScalarXmlPropertiesResponse& WithStringValue(StringValueT&& value) {
  ...
  template <typename EmptyStringValueT = Aws::String>
  SimpleScalarXmlPropertiesResponse& WithEmptyStringValue(EmptyStringValueT&& value) {
  ...
  inline SimpleScalarXmlPropertiesResponse& WithTrueBooleanValue(bool value) {
  ...
  inline SimpleScalarXmlPropertiesResponse& WithFalseBooleanValue(bool value) {
  ...
  inline SimpleScalarXmlPropertiesResponse& WithByteValue(int value) {
    SetByteValue(value);
    return *this;
  }
  ///@}
  ...
  inline SimpleScalarXmlPropertiesResponse& WithShortValue(int value) {
    SetShortValue(value);
    return *this;
  }
  ///@}
  ...
  inline SimpleScalarXmlPropertiesResponse& WithIntegerValue(int value) {
  ...
  inline SimpleScalarXmlPropertiesResponse& WithLongValue(long long value) {
    SetLongValue(value);
    return *this;
  }
  ///@}
  ...
  inline SimpleScalarXmlPropertiesResponse& WithFloatValue(double value) {
    SetFloatValue(value);
    return *this;
  }
  ///@}
  ...
  inline SimpleScalarXmlPropertiesResponse& WithDoubleValue(double value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  SimpleScalarXmlPropertiesResponse& WithResponseMetadata(ResponseMetadataT&& value) {
