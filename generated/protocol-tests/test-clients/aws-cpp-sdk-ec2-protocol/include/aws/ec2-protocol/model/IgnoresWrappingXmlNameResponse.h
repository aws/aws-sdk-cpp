...
namespace Model
{
  ...
  public:
    ...
    template<typename FooT = Aws::String>
    IgnoresWrappingXmlNameResponse& WithFoo(FooT&& value) { SetFoo(std::forward<FooT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    IgnoresWrappingXmlNameResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
