...
namespace Model
{
  ...
  public:
    ...
    template<typename DatetimeT = Aws::Utils::DateTime>
    FractionalSecondsResponse& WithDatetime(DatetimeT&& value) { SetDatetime(std::forward<DatetimeT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    FractionalSecondsResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
