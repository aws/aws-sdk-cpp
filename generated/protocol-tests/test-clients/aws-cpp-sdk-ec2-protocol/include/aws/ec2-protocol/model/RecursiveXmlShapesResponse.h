...
namespace Model
{
  ...
  public:
    ...
    void SetNested(NestedT&& value) { m_nested = std::forward<NestedT>(value); }
    template<typename NestedT = RecursiveXmlShapesOutputNested1>
    RecursiveXmlShapesResponse& WithNested(NestedT&& value) { SetNested(std::forward<NestedT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    RecursiveXmlShapesResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
