...
namespace Model
{
  ...
  public:
    ...
    template<typename DataT = Aws::Utils::ByteBuffer>
    XmlEmptyBlobsResponse& WithData(DataT&& value) { SetData(std::forward<DataT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    XmlEmptyBlobsResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
