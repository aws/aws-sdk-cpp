...
namespace Model
{
  ...
  {
  public:
    AWS_EC2PROTOCOL_API EmptyInputAndEmptyOutputResponse() = default;
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    EmptyInputAndEmptyOutputResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
