...
namespace Model
{
  ...
  public:
    ...
    template<typename FooT = Aws::String>
    SimpleInputParamsRequest& WithFoo(FooT&& value) { SetFoo(std::forward<FooT>(value)); return *this;}
    ///@}
    ...
    template<typename BarT = Aws::String>
    SimpleInputParamsRequest& WithBar(BarT&& value) { SetBar(std::forward<BarT>(value)); return *this;}
    ///@}
    ...
    template<typename QuxT = Aws::Utils::ByteBuffer>
    SimpleInputParamsRequest& WithQux(QuxT&& value) { SetQux(std::forward<QuxT>(value)); return *this;}
    ///@}
    ...
    inline void SetFooEnum(FooEnum value) { m_fooEnumHasBeenSet = true; m_fooEnum = value; }
    inline SimpleInputParamsRequest& WithFooEnum(FooEnum value) { SetFooEnum(value); return *this;}
    ///@}
    ...
    void SetHasQueryName(HasQueryNameT&& value) { m_hasQueryNameHasBeenSet = true; m_hasQueryName = std::forward<HasQueryNameT>(value); }
    template<typename HasQueryNameT = Aws::String>
    SimpleInputParamsRequest& WithHasQueryName(HasQueryNameT&& value) { SetHasQueryName(std::forward<HasQueryNameT>(value)); return *this;}
    ///@}
    ...
    void SetHasQueryAndXmlName(HasQueryAndXmlNameT&& value) { m_hasQueryAndXmlNameHasBeenSet = true; m_hasQueryAndXmlName = std::forward<HasQueryAndXmlNameT>(value); }
    template<typename HasQueryAndXmlNameT = Aws::String>
    SimpleInputParamsRequest& WithHasQueryAndXmlName(HasQueryAndXmlNameT&& value) { SetHasQueryAndXmlName(std::forward<HasQueryAndXmlNameT>(value)); return *this;}
    ///@}
    ...
    void SetUsesXmlName(UsesXmlNameT&& value) { m_usesXmlNameHasBeenSet = true; m_usesXmlName = std::forward<UsesXmlNameT>(value); }
    template<typename UsesXmlNameT = Aws::String>
    SimpleInputParamsRequest& WithUsesXmlName(UsesXmlNameT&& value) { SetUsesXmlName(std::forward<UsesXmlNameT>(value)); return *this;}
    ///@}
  private:
