...
namespace Model
{
  ...
  {
  public:
    AWS_EC2PROTOCOL_API StructArg() = default;
    AWS_EC2PROTOCOL_API StructArg(const Aws::Utils::Xml::XmlNode& xmlNode);
    AWS_EC2PROTOCOL_API StructArg& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
    ...
    void SetStringArg(StringArgT&& value) { m_stringArgHasBeenSet = true; m_stringArg = std::forward<StringArgT>(value); }
    template<typename StringArgT = Aws::String>
    StructArg& WithStringArg(StringArgT&& value) { SetStringArg(std::forward<StringArgT>(value)); return *this;}
    ///@}
    ...
    inline const StructArg& GetRecursiveArg() const{
      assert(m_recursiveArg); return *m_recursiveArg;
    }
    ...
    template<typename RecursiveArgT = StructArg>
    StructArg& WithRecursiveArg(RecursiveArgT&& value) { SetRecursiveArg(std::forward<RecursiveArgT>(value)); return *this;}
    ///@}
  private:
