...
namespace Model
{
  ...
  public:
    ...
    AWS_EC2PROTOCOL_API const StructArg& GetRecursiveArg() const;
    AWS_EC2PROTOCOL_API bool RecursiveArgHasBeenSet() const;
    AWS_EC2PROTOCOL_API void SetRecursiveArg(const StructArg& value);
    AWS_EC2PROTOCOL_API void SetRecursiveArg(StructArg&& value);
    AWS_EC2PROTOCOL_API StructArg& WithRecursiveArg(const StructArg& value);
    AWS_EC2PROTOCOL_API StructArg& WithRecursiveArg(StructArg&& value);
    ///@}
  private:
