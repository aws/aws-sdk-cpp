...
namespace Model
{
  ...
  public:
    ...
    inline XmlEnumsResponse& AddFooEnumList(FooEnum value) { m_fooEnumList.push_back(value); return *this; }
    ///@}
    ...
    inline XmlEnumsResponse& AddFooEnumSet(FooEnum value) { m_fooEnumSet.push_back(value); return *this; }
    ///@}
