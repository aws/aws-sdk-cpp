...
namespace Model
{
  ...
  public:
    ...
    template<typename NormalT = Aws::Utils::DateTime>
    XmlTimestampsResponse& WithNormal(NormalT&& value) { SetNormal(std::forward<NormalT>(value)); return *this;}
    ///@}
    ...
    template<typename DateTimeT = Aws::Utils::DateTime>
    XmlTimestampsResponse& WithDateTime(DateTimeT&& value) { SetDateTime(std::forward<DateTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename DateTimeOnTargetT = Aws::Utils::DateTime>
    XmlTimestampsResponse& WithDateTimeOnTarget(DateTimeOnTargetT&& value) { SetDateTimeOnTarget(std::forward<DateTimeOnTargetT>(value)); return *this;}
    ///@}
    ...
    template<typename EpochSecondsT = Aws::Utils::DateTime>
    XmlTimestampsResponse& WithEpochSeconds(EpochSecondsT&& value) { SetEpochSeconds(std::forward<EpochSecondsT>(value)); return *this;}
    ///@}
    ...
    template<typename EpochSecondsOnTargetT = Aws::Utils::DateTime>
    XmlTimestampsResponse& WithEpochSecondsOnTarget(EpochSecondsOnTargetT&& value) { SetEpochSecondsOnTarget(std::forward<EpochSecondsOnTargetT>(value)); return *this;}
    ///@}
    ...
    template<typename HttpDateT = Aws::Utils::DateTime>
    XmlTimestampsResponse& WithHttpDate(HttpDateT&& value) { SetHttpDate(std::forward<HttpDateT>(value)); return *this;}
    ///@}
    ...
    template<typename HttpDateOnTargetT = Aws::Utils::DateTime>
    XmlTimestampsResponse& WithHttpDateOnTarget(HttpDateOnTargetT&& value) { SetHttpDateOnTarget(std::forward<HttpDateOnTargetT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    XmlTimestampsResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
