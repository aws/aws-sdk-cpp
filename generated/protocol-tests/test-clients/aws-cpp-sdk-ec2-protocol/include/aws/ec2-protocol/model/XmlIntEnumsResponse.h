...
namespace Model
{
  ...
  public:
    ...
    inline XmlIntEnumsResponse& AddIntEnumList(int value) { m_intEnumListHasBeenSet = true; m_intEnumList.push_back(value); return *this; }
    ///@}
    ...
    inline XmlIntEnumsResponse& AddIntEnumSet(int value) { m_intEnumSetHasBeenSet = true; m_intEnumSet.push_back(value); return *this; }
    ///@}
