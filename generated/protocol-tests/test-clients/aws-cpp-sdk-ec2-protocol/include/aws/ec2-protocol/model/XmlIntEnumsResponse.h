...
namespace Model
{
  ...
  public:
    ...
    template<typename IntEnumListT = Aws::Vector<int>>
    XmlIntEnumsResponse& WithIntEnumList(IntEnumListT&& value) { SetIntEnumList(std::forward<IntEnumListT>(value)); return *this;}
    ...
    void SetIntEnumSet(IntEnumSetT&& value) { m_intEnumSet = std::forward<IntEnumSetT>(value); }
    template<typename IntEnumSetT = Aws::Vector<int>>
    XmlIntEnumsResponse& WithIntEnumSet(IntEnumSetT&& value) { SetIntEnumSet(std::forward<IntEnumSetT>(value)); return *this;}
    ...
    void SetIntEnumMap(IntEnumMapT&& value) { m_intEnumMap = std::forward<IntEnumMapT>(value); }
    template<typename IntEnumMapT = Aws::Map<Aws::String, int>>
    XmlIntEnumsResponse& WithIntEnumMap(IntEnumMapT&& value) { SetIntEnumMap(std::forward<IntEnumMapT>(value)); return *this;}
    inline XmlIntEnumsResponse& AddIntEnumMap(Aws::String key, int value) {
      m_intEnumMap.emplace(key, value); return *this;
    }
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    XmlIntEnumsResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
