...
AWS_PROTOCOL_TEST(RpcV2CborLists, RpcV2CborLists) {
  ...
  request.SetTimestampList({ Aws::Utils::DateTime(static_cast<uint64_t>(1398796238)),  Aws::Utils::DateTime(static_cast<uint64_t>(1398796238))});
  ...
  /* expectedResult = R"( {"stringList":["foo","bar"],"stringSet":["foo","bar"],"integerList":[1,2],"booleanList":[true,false],"timestampList":[1398796238,1398796238],"enumList":["Foo","0"],"intEnumList":[1,2],"nestedStringList":[["foo","bar"],["baz","qux"]],"structureList":[{"a":"1","b":"2"},{"a":"3","b":"4"}],"blobList":["foo","bar"]} )" */
