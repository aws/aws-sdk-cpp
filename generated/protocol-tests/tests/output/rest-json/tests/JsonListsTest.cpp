...
AWS_PROTOCOL_TEST(JsonLists, RestJsonLists) {
  ...
  ValidateRequestSent([&result](const ExpectedRequest&, const Aws::ProtocolMock::Model::Request&) -> void {
    ...
    EXPECT_EQ(Aws::Utils::DateTime(static_cast<double>(1398796238)), resultTimestampListItem.at(0));
    EXPECT_EQ(Aws::Utils::DateTime(static_cast<double>(1398796238)), resultTimestampListItem.at(1));
