...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_FIS_API ExperimentLogConfiguration
  {
  public:
    ExperimentLogConfiguration();
    ExperimentLogConfiguration(Aws::Utils::Json::JsonView jsonValue);
    ExperimentLogConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
