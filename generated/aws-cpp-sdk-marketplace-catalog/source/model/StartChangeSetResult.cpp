...
StartChangeSetResult::StartChangeSetResult()
{
}

StartChangeSetResult::StartChangeSetResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

StartChangeSetResult& StartChangeSetResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
