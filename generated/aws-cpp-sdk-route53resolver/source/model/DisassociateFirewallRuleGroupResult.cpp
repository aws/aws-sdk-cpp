...
DisassociateFirewallRuleGroupResult::DisassociateFirewallRuleGroupResult()
{
}

DisassociateFirewallRuleGroupResult::DisassociateFirewallRuleGroupResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
