...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>The Amazon Connect attributes. These attributes can be accessed in contact
     * flows just like any other contact attributes.</p> <p>You can have up to 32,768
     * UTF-8 bytes across all attributes for a contact. Attribute keys can include only
