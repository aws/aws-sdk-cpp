...
namespace Model
{
  ...
  /**
   */
  class AWS_SSOADMIN_API CreateInstanceAccessControlAttributeConfigurationRequest : public SSOAdminRequest
  {
  public:
    ...
    /**
     * <p>Specifies the Amazon Web Services SSO identity store attributes to add to
