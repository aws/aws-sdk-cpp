...
DeleteVirtualGatewayResult::DeleteVirtualGatewayResult()
{
}

DeleteVirtualGatewayResult::DeleteVirtualGatewayResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
