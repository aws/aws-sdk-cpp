...
namespace Model
{
  ...
  public:
     ...
     * with the same name as an existing vocabulary filter, you get a
    ...
    /**
     * <p>Use this parameter if you want to create your vocabulary filter by including
     ...
     * custom vocabulary filter at the time you create this new filter.</p> <p>To learn
