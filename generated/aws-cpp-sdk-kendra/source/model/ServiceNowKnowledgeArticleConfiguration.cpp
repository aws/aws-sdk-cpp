...
ServiceNowKnowledgeArticleConfiguration& ServiceNowKnowledgeArticleConfiguration::operator =(JsonView jsonValue)
{
...
JsonValue ServiceNowKnowledgeArticleConfiguration::Jsonize() const
{
  JsonValue payload;
