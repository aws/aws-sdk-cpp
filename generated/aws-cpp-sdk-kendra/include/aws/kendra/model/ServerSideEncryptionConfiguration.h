...
namespace Model
{
  ...
  /**
   * <p>Provides the identifier of the KMScustomer master key (CMK) used to encrypt
  ...
  public:
    ...
    /**
     * <p>The identifier of the KMScustomer master key (CMK). Amazon Kendra doesn't
     * support asymmetric CMKs.</p>
     */
