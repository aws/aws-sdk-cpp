...
namespace Model
{
  ...
  public:
     ...
     * <p>Filters on the name of the job.</p>
     */
    inline SentimentDetectionJobFilter& WithJobName(const Aws::String& value) { SetJobName(value); return *this;}

    /**
     * <p>Filters on the name of the job.</p>
     */
    inline SentimentDetectionJobFilter& WithJobName(Aws::String&& value) { SetJobName(std::move(value)); return *this;}

    /**
     * <p>Filters on the name of the job.</p>
     */
    inline SentimentDetectionJobFilter& WithJobName(const char* value) { SetJobName(value); return *this;}
     ...
     * specified status.</p>
     */
    inline SentimentDetectionJobFilter& WithJobStatus(const JobStatus& value) { SetJobStatus(value); return *this;}

    /**
     * <p>Filters the list of jobs based on job status. Returns only jobs with the
     * specified status.</p>
     */
    inline SentimentDetectionJobFilter& WithJobStatus(JobStatus&& value) { SetJobStatus(std::move(value)); return *this;}
     ...
     * returned in ascending order, oldest to newest.</p>
     */
    inline SentimentDetectionJobFilter& WithSubmitTimeBefore(const Aws::Utils::DateTime& value) { SetSubmitTimeBefore(value); return *this;}
     ...
     * returned in ascending order, oldest to newest.</p>
     */
    inline SentimentDetectionJobFilter& WithSubmitTimeBefore(Aws::Utils::DateTime&& value) { SetSubmitTimeBefore(std::move(value)); return *this;}
     ...
     * returned in descending order, newest to oldest.</p>
     */
    inline SentimentDetectionJobFilter& WithSubmitTimeAfter(const Aws::Utils::DateTime& value) { SetSubmitTimeAfter(value); return *this;}
     ...
     * returned in descending order, newest to oldest.</p>
     */
    inline SentimentDetectionJobFilter& WithSubmitTimeAfter(Aws::Utils::DateTime&& value) { SetSubmitTimeAfter(std::move(value)); return *this;}
