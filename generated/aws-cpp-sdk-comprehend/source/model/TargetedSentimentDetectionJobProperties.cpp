...
TargetedSentimentDetectionJobProperties::TargetedSentimentDetectionJobProperties(JsonView jsonValue) : 
    m_jobIdHasBeenSet(false),
    m_jobArnHasBeenSet(false),
    m_jobNameHasBeenSet(false),
    m_jobStatus(JobStatus::NOT_SET),
...
TargetedSentimentDetectionJobProperties& TargetedSentimentDetectionJobProperties::operator =(JsonView jsonValue)
{
...
JsonValue TargetedSentimentDetectionJobProperties::Jsonize() const
{
  JsonValue payload;
