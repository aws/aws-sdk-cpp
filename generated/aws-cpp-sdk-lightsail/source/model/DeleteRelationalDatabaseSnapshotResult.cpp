...
DeleteRelationalDatabaseSnapshotResult::DeleteRelationalDatabaseSnapshotResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

DeleteRelationalDatabaseSnapshotResult& DeleteRelationalDatabaseSnapshotResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
