...
namespace Model
{
  class AWS_LIGHTSAIL_API DeleteCertificateResult
  {
  public:
     ...
     * by the request.</p>
     */
    inline DeleteCertificateResult& WithOperations(const Aws::Vector<Operation>& value) { SetOperations(value); return *this;}
     ...
     * by the request.</p>
     */
    inline DeleteCertificateResult& WithOperations(Aws::Vector<Operation>&& value) { SetOperations(std::move(value)); return *this;}
     ...
     * by the request.</p>
     */
    inline DeleteCertificateResult& AddOperations(const Operation& value) { m_operations.push_back(value); return *this; }
     ...
     * by the request.</p>
     */
    inline DeleteCertificateResult& AddOperations(Operation&& value) { m_operations.push_back(std::move(value)); return *this; }
