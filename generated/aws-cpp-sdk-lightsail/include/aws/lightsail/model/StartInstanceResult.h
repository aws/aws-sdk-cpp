...
namespace Model
{
  class AWS_LIGHTSAIL_API StartInstanceResult
  {
  public:
    StartInstanceResult();
     ...
     * by the request.</p>
     */
    inline StartInstanceResult& WithOperations(const Aws::Vector<Operation>& value) { SetOperations(value); return *this;}
     ...
     * by the request.</p>
     */
    inline StartInstanceResult& WithOperations(Aws::Vector<Operation>&& value) { SetOperations(std::move(value)); return *this;}
     ...
     * by the request.</p>
     */
    inline StartInstanceResult& AddOperations(const Operation& value) { m_operations.push_back(value); return *this; }
