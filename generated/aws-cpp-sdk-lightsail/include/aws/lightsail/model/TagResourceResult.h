...
namespace Model
{
  class AWS_LIGHTSAIL_API TagResourceResult
  {
  public:
    TagResourceResult();
     ...
     * by the request.</p>
     */
    inline TagResourceResult& WithOperations(const Aws::Vector<Operation>& value) { SetOperations(value); return *this;}
     ...
     * by the request.</p>
     */
    inline TagResourceResult& WithOperations(Aws::Vector<Operation>&& value) { SetOperations(std::move(value)); return *this;}
     ...
     * by the request.</p>
     */
    inline TagResourceResult& AddOperations(const Operation& value) { m_operations.push_back(value); return *this; }
     ...
     * by the request.</p>
     */
    inline TagResourceResult& AddOperations(Operation&& value) { m_operations.push_back(std::move(value)); return *this; }
