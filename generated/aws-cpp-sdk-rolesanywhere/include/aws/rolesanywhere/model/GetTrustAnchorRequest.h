...
namespace Model
{
  ...
  /**
   */
  class AWS_ROLESANYWHERE_API GetTrustAnchorRequest : public RolesAnywhereRequest
  {
  public:
    ...
    inline virtual const char* GetServiceRequestName() const override { return "GetTrustAnchor"; }
