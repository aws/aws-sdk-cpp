...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_PINPOINTSMSVOICEV2_API OptedOutFilter
  {
  public:
    OptedOutFilter();
    OptedOutFilter(Aws::Utils::Json::JsonView jsonValue);
    OptedOutFilter& operator=(Aws::Utils::Json::JsonView jsonValue);
