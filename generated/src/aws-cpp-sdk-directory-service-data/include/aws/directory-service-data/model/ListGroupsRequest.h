...
/**
 */
class ListGroupsRequest : public DirectoryServiceDataRequest {
 public:
  AWS_DIRECTORYSERVICEDATA_API ListGroupsRequest() = default;
  ...
  template <typename DirectoryIdT = Aws::String>
  ListGroupsRequest& WithDirectoryId(DirectoryIdT&& value) {
  ...
  ///@{
  /**
   * <p> The domain name associated with the directory. </p>  <p> This
  ...
  template <typename RealmT = Aws::String>
  ListGroupsRequest& WithRealm(RealmT&& value) {
