...
class SearchUsersRequest : public DirectoryServiceDataRequest {
 public:
  ...
  template <typename DirectoryIdT = Aws::String>
  SearchUsersRequest& WithDirectoryId(DirectoryIdT&& value) {
  ...
  inline SearchUsersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  SearchUsersRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RealmT = Aws::String>
  SearchUsersRequest& WithRealm(RealmT&& value) {
  ...
  void SetSearchAttributes(SearchAttributesT&& value) {
    m_searchAttributesHasBeenSet = true;
    m_searchAttributes = std::forward<SearchAttributesT>(value);
  }
  template <typename SearchAttributesT = Aws::Vector<Aws::String>>
  SearchUsersRequest& WithSearchAttributes(SearchAttributesT&& value) {
    SetSearchAttributes(std::forward<SearchAttributesT>(value));
    return *this;
  }
  template <typename SearchAttributesT = Aws::String>
  SearchUsersRequest& AddSearchAttributes(SearchAttributesT&& value) {
    m_searchAttributesHasBeenSet = true;
    m_searchAttributes.emplace_back(std::forward<SearchAttributesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename SearchStringT = Aws::String>
  SearchUsersRequest& WithSearchString(SearchStringT&& value) {
