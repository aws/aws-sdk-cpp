...
class User {
 public:
  ...
  template <typename DistinguishedNameT = Aws::String>
  User& WithDistinguishedName(DistinguishedNameT&& value) {
  ...
  template <typename OtherAttributesT = Aws::Map<Aws::String, AttributeValue>>
  User& WithOtherAttributes(OtherAttributesT&& value) {
  ...
  template <typename SAMAccountNameT = Aws::String>
  User& WithSAMAccountName(SAMAccountNameT&& value) {
  ...
  template <typename UserPrincipalNameT = Aws::String>
  User& WithUserPrincipalName(UserPrincipalNameT&& value) {
