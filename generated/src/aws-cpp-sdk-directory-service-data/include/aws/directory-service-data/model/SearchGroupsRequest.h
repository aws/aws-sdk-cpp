...
namespace Model
{
  ...
  {
  public:
    AWS_DIRECTORYSERVICEDATA_API SearchGroupsRequest() = default;
    ...
    template<typename DirectoryIdT = Aws::String>
    SearchGroupsRequest& WithDirectoryId(DirectoryIdT&& value) { SetDirectoryId(std::forward<DirectoryIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    SearchGroupsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename RealmT = Aws::String>
    SearchGroupsRequest& WithRealm(RealmT&& value) { SetRealm(std::forward<RealmT>(value)); return *this;}
    ///@}
    ...
    template<typename SearchAttributesT = Aws::Vector<Aws::String>>
    SearchGroupsRequest& WithSearchAttributes(SearchAttributesT&& value) { SetSearchAttributes(std::forward<SearchAttributesT>(value)); return *this;}
    template<typename SearchAttributesT = Aws::String>
    SearchGroupsRequest& AddSearchAttributes(SearchAttributesT&& value) { m_searchAttributesHasBeenSet = true; m_searchAttributes.emplace_back(std::forward<SearchAttributesT>(value)); return *this; }
    ///@}
    ...
    template<typename SearchStringT = Aws::String>
    SearchGroupsRequest& WithSearchString(SearchStringT&& value) { SetSearchString(std::forward<SearchStringT>(value)); return *this;}
    ///@}
  private:
