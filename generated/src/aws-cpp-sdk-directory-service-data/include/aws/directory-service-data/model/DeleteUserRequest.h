...
class DeleteUserRequest : public DirectoryServiceDataRequest {
 public:
  ...
  template <typename ClientTokenT = Aws::String>
  DeleteUserRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename DirectoryIdT = Aws::String>
  DeleteUserRequest& WithDirectoryId(DirectoryIdT&& value) {
  ...
  template <typename SAMAccountNameT = Aws::String>
  DeleteUserRequest& WithSAMAccountName(SAMAccountNameT&& value) {
