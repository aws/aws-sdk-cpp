...
class AddGroupMemberRequest : public DirectoryServiceDataRequest {
 public:
  ...
  template <typename ClientTokenT = Aws::String>
  AddGroupMemberRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename DirectoryIdT = Aws::String>
  AddGroupMemberRequest& WithDirectoryId(DirectoryIdT&& value) {
  ...
  template <typename GroupNameT = Aws::String>
  AddGroupMemberRequest& WithGroupName(GroupNameT&& value) {
  ...
  void SetMemberName(MemberNameT&& value) {
    ...
    m_memberName = std::forward<MemberNameT>(value);
  }
  template <typename MemberNameT = Aws::String>
  AddGroupMemberRequest& WithMemberName(MemberNameT&& value) {
    SetMemberName(std::forward<MemberNameT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename MemberRealmT = Aws::String>
  AddGroupMemberRequest& WithMemberRealm(MemberRealmT&& value) {
