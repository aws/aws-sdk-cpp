...
class DisableUserRequest : public DirectoryServiceDataRequest {
 public:
  ...
  template <typename ClientTokenT = Aws::String>
  DisableUserRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename DirectoryIdT = Aws::String>
  DisableUserRequest& WithDirectoryId(DirectoryIdT&& value) {
  ...
  template <typename SAMAccountNameT = Aws::String>
  DisableUserRequest& WithSAMAccountName(SAMAccountNameT&& value) {
