...
class CreateUserRequest : public DirectoryServiceDataRequest {
 public:
  ...
  template <typename ClientTokenT = Aws::String>
  CreateUserRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename DirectoryIdT = Aws::String>
  CreateUserRequest& WithDirectoryId(DirectoryIdT&& value) {
  ...
  template <typename OtherAttributesT = Aws::Map<Aws::String, AttributeValue>>
  CreateUserRequest& WithOtherAttributes(OtherAttributesT&& value) {
  ...
  template <typename SAMAccountNameT = Aws::String>
  CreateUserRequest& WithSAMAccountName(SAMAccountNameT&& value) {
