...
namespace Model
{
  ...
  {
  public:
    AWS_DIRECTORYSERVICEDATA_API AddGroupMemberResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    AddGroupMemberResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
