...
class UpdateGroupRequest : public DirectoryServiceDataRequest {
 public:
  ...
  template <typename ClientTokenT = Aws::String>
  UpdateGroupRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename DirectoryIdT = Aws::String>
  UpdateGroupRequest& WithDirectoryId(DirectoryIdT&& value) {
  ...
  inline UpdateGroupRequest& WithGroupScope(GroupScope value) {
    SetGroupScope(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateGroupRequest& WithGroupType(GroupType value) {
    SetGroupType(value);
    return *this;
  }
  ///@}
  ...
  template <typename OtherAttributesT = Aws::Map<Aws::String, AttributeValue>>
  UpdateGroupRequest& WithOtherAttributes(OtherAttributesT&& value) {
  ...
  template <typename SAMAccountNameT = Aws::String>
  UpdateGroupRequest& WithSAMAccountName(SAMAccountNameT&& value) {
  ...
  inline UpdateGroupRequest& WithUpdateType(UpdateType value) {
    SetUpdateType(value);
    return *this;
  }
  ///@}
