...
class SearchGroupsResult {
 public:
  ...
  template <typename DirectoryIdT = Aws::String>
  SearchGroupsResult& WithDirectoryId(DirectoryIdT&& value) {
  ...
  template <typename GroupsT = Aws::Vector<Group>>
  SearchGroupsResult& WithGroups(GroupsT&& value) {
    SetGroups(std::forward<GroupsT>(value));
    return *this;
  }
  template <typename GroupsT = Group>
  SearchGroupsResult& AddGroups(GroupsT&& value) {
    m_groupsHasBeenSet = true;
  ...
  template <typename RealmT = Aws::String>
  SearchGroupsResult& WithRealm(RealmT&& value) {
