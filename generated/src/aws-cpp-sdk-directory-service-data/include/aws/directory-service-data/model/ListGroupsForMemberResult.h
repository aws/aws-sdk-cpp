...
class ListGroupsForMemberResult {
 public:
  ...
  template <typename DirectoryIdT = Aws::String>
  ListGroupsForMemberResult& WithDirectoryId(DirectoryIdT&& value) {
  ...
  template <typename GroupsT = Aws::Vector<GroupSummary>>
  ListGroupsForMemberResult& WithGroups(GroupsT&& value) {
    SetGroups(std::forward<GroupsT>(value));
    return *this;
  }
  template <typename GroupsT = GroupSummary>
  ListGroupsForMemberResult& AddGroups(GroupsT&& value) {
    m_groupsHasBeenSet = true;
  ...
  template <typename MemberRealmT = Aws::String>
  ListGroupsForMemberResult& WithMemberRealm(MemberRealmT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListGroupsForMemberResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RealmT = Aws::String>
  ListGroupsForMemberResult& WithRealm(RealmT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListGroupsForMemberResult& WithRequestId(RequestIdT&& value) {
