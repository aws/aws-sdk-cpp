...
namespace Model
{
  ...
  {
  public:
    AWS_DIRECTORYSERVICEDATA_API RemoveGroupMemberRequest() = default;
    ...
    template<typename ClientTokenT = Aws::String>
    RemoveGroupMemberRequest& WithClientToken(ClientTokenT&& value) { SetClientToken(std::forward<ClientTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename DirectoryIdT = Aws::String>
    RemoveGroupMemberRequest& WithDirectoryId(DirectoryIdT&& value) { SetDirectoryId(std::forward<DirectoryIdT>(value)); return *this;}
    ///@}
    ...
    template<typename GroupNameT = Aws::String>
    RemoveGroupMemberRequest& WithGroupName(GroupNameT&& value) { SetGroupName(std::forward<GroupNameT>(value)); return *this;}
    ///@}
    ...
    template<typename MemberNameT = Aws::String>
    RemoveGroupMemberRequest& WithMemberName(MemberNameT&& value) { SetMemberName(std::forward<MemberNameT>(value)); return *this;}
    ///@}
    ...
    template<typename MemberRealmT = Aws::String>
    RemoveGroupMemberRequest& WithMemberRealm(MemberRealmT&& value) { SetMemberRealm(std::forward<MemberRealmT>(value)); return *this;}
    ///@}
  private:
