...
class SearchUsersResult {
 public:
  ...
  template <typename DirectoryIdT = Aws::String>
  SearchUsersResult& WithDirectoryId(DirectoryIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  SearchUsersResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RealmT = Aws::String>
  SearchUsersResult& WithRealm(RealmT&& value) {
  ...
  template <typename UsersT = Aws::Vector<User>>
  SearchUsersResult& WithUsers(UsersT&& value) {
    SetUsers(std::forward<UsersT>(value));
    return *this;
  }
  template <typename UsersT = User>
  SearchUsersResult& AddUsers(UsersT&& value) {
    m_usersHasBeenSet = true;
