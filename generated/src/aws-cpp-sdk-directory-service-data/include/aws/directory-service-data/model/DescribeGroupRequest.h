...
class DescribeGroupRequest : public DirectoryServiceDataRequest {
 public:
  ...
  template <typename DirectoryIdT = Aws::String>
  DescribeGroupRequest& WithDirectoryId(DirectoryIdT&& value) {
  ...
  template <typename OtherAttributesT = Aws::Vector<Aws::String>>
  DescribeGroupRequest& WithOtherAttributes(OtherAttributesT&& value) {
    SetOtherAttributes(std::forward<OtherAttributesT>(value));
    return *this;
  }
  template <typename OtherAttributesT = Aws::String>
  DescribeGroupRequest& AddOtherAttributes(OtherAttributesT&& value) {
    m_otherAttributesHasBeenSet = true;
  ...
  template <typename RealmT = Aws::String>
  DescribeGroupRequest& WithRealm(RealmT&& value) {
  ...
  template <typename SAMAccountNameT = Aws::String>
  DescribeGroupRequest& WithSAMAccountName(SAMAccountNameT&& value) {
