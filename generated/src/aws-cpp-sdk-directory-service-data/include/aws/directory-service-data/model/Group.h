...
class Group {
 public:
  ...
  template <typename DistinguishedNameT = Aws::String>
  Group& WithDistinguishedName(DistinguishedNameT&& value) {
  ...
  inline Group& WithGroupScope(GroupScope value) {
    SetGroupScope(value);
    return *this;
  }
  ///@}
  ...
  inline Group& WithGroupType(GroupType value) {
    SetGroupType(value);
    return *this;
  }
  ///@}
  ...
  template <typename OtherAttributesT = Aws::Map<Aws::String, AttributeValue>>
  Group& WithOtherAttributes(OtherAttributesT&& value) {
  ...
  template <typename SAMAccountNameT = Aws::String>
  Group& WithSAMAccountName(SAMAccountNameT&& value) {
