...
class DeleteGroupRequest : public DirectoryServiceDataRequest {
 public:
  ...
  template <typename ClientTokenT = Aws::String>
  DeleteGroupRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename DirectoryIdT = Aws::String>
  DeleteGroupRequest& WithDirectoryId(DirectoryIdT&& value) {
  ...
  template <typename SAMAccountNameT = Aws::String>
  DeleteGroupRequest& WithSAMAccountName(SAMAccountNameT&& value) {
