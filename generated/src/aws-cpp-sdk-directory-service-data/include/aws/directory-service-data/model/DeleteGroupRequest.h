...
namespace Model
{
  ...
  {
  public:
    AWS_DIRECTORYSERVICEDATA_API DeleteGroupRequest() = default;
    ...
    template<typename ClientTokenT = Aws::String>
    DeleteGroupRequest& WithClientToken(ClientTokenT&& value) { SetClientToken(std::forward<ClientTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename DirectoryIdT = Aws::String>
    DeleteGroupRequest& WithDirectoryId(DirectoryIdT&& value) { SetDirectoryId(std::forward<DirectoryIdT>(value)); return *this;}
    ///@}
    ...
    template<typename SAMAccountNameT = Aws::String>
    DeleteGroupRequest& WithSAMAccountName(SAMAccountNameT&& value) { SetSAMAccountName(std::forward<SAMAccountNameT>(value)); return *this;}
    ///@}
  private:
