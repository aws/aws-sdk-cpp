...
namespace Model
{
  ...
  /**
   */
  class DeleteGroupRequest : public DirectoryServiceDataRequest
  {
  public:
    AWS_DIRECTORYSERVICEDATA_API DeleteGroupRequest();
    ...
    inline DeleteGroupRequest& WithClientToken(const Aws::String& value) { SetClientToken(value); return *this;}
    inline DeleteGroupRequest& WithClientToken(Aws::String&& value) { SetClientToken(std::move(value)); return *this;}
    inline DeleteGroupRequest& WithClientToken(const char* value) { SetClientToken(value); return *this;}
    ///@}
    ...
    inline DeleteGroupRequest& WithDirectoryId(const Aws::String& value) { SetDirectoryId(value); return *this;}
    inline DeleteGroupRequest& WithDirectoryId(Aws::String&& value) { SetDirectoryId(std::move(value)); return *this;}
    inline DeleteGroupRequest& WithDirectoryId(const char* value) { SetDirectoryId(value); return *this;}
    ///@}
    ...
    inline DeleteGroupRequest& WithSAMAccountName(const Aws::String& value) { SetSAMAccountName(value); return *this;}
    inline DeleteGroupRequest& WithSAMAccountName(Aws::String&& value) { SetSAMAccountName(std::move(value)); return *this;}
    inline DeleteGroupRequest& WithSAMAccountName(const char* value) { SetSAMAccountName(value); return *this;}
    ///@}
  private:
