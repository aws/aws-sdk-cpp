...
class DirectoryUnavailableException {
 public:
  ...
  template <typename MessageT = Aws::String>
  DirectoryUnavailableException& WithMessage(MessageT&& value) {
  ...
  inline void SetReason(DirectoryUnavailableReason value) {
    m_reasonHasBeenSet = true;
    m_reason = value;
  }
  inline DirectoryUnavailableException& WithReason(DirectoryUnavailableReason value) {
    SetReason(value);
    return *this;
  }
  ///@}
