...
class ListGroupsForMemberRequest : public DirectoryServiceDataRequest {
 public:
  ...
  template <typename DirectoryIdT = Aws::String>
  ListGroupsForMemberRequest& WithDirectoryId(DirectoryIdT&& value) {
  ...
  inline ListGroupsForMemberRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename MemberRealmT = Aws::String>
  ListGroupsForMemberRequest& WithMemberRealm(MemberRealmT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListGroupsForMemberRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RealmT = Aws::String>
  ListGroupsForMemberRequest& WithRealm(RealmT&& value) {
  ...
  template <typename SAMAccountNameT = Aws::String>
  ListGroupsForMemberRequest& WithSAMAccountName(SAMAccountNameT&& value) {
