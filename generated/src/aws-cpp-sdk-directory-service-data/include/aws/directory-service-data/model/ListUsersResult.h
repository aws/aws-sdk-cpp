...
namespace Model
{
  ...
  {
  public:
    AWS_DIRECTORYSERVICEDATA_API ListUsersResult() = default;
    ...
    template<typename DirectoryIdT = Aws::String>
    ListUsersResult& WithDirectoryId(DirectoryIdT&& value) { SetDirectoryId(std::forward<DirectoryIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RealmT = Aws::String>
    ListUsersResult& WithRealm(RealmT&& value) { SetRealm(std::forward<RealmT>(value)); return *this;}
    ///@}
