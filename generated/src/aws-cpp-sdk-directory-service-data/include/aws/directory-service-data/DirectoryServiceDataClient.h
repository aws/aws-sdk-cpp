...
class AWS_DIRECTORYSERVICEDATA_API DirectoryServiceDataClient
 ...
 public:
   ...
   */
  DirectoryServiceDataClient(const Aws::DirectoryServiceData::DirectoryServiceDataClientConfiguration& clientConfiguration =
  ...
  DirectoryServiceDataClient(const Aws::Auth::AWSCredentials& credentials,
                             std::shared_ptr<DirectoryServiceDataEndpointProviderBase> endpointProvider = nullptr,
                             const Aws::DirectoryServiceData::DirectoryServiceDataClientConfiguration& clientConfiguration =
                                 Aws::DirectoryServiceData::DirectoryServiceDataClientConfiguration());
   ...
   * is not specified, it will be initialized to default values.
   */
  DirectoryServiceDataClient(const Aws::Auth::AWSCredentials& credentials, const Aws::Client::ClientConfiguration& clientConfiguration);
  ...
  /**
   * An Async wrapper for AddGroupMember that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename AddGroupMemberRequestT = Model::AddGroupMemberRequest>
  void AddGroupMemberAsync(const AddGroupMemberRequestT& request, const AddGroupMemberResponseReceivedHandler& handler,
  ...
  /**
   * An Async wrapper for DescribeGroup that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeGroupRequestT = Model::DescribeGroupRequest>
  void DescribeGroupAsync(const DescribeGroupRequestT& request, const DescribeGroupResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListGroupMembers that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListGroupMembers that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListGroupMembersRequestT = Model::ListGroupMembersRequest>
  void ListGroupMembersAsync(const ListGroupMembersRequestT& request, const ListGroupMembersResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListGroupsForMember that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListGroupsForMember that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListGroupsForMemberRequestT = Model::ListGroupsForMemberRequest>
  void ListGroupsForMemberAsync(const ListGroupsForMemberRequestT& request, const ListGroupsForMemberResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RemoveGroupMember that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RemoveGroupMember that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename RemoveGroupMemberRequestT = Model::RemoveGroupMemberRequest>
  void RemoveGroupMemberAsync(const RemoveGroupMemberRequestT& request, const RemoveGroupMemberResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for SearchGroups that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename SearchGroupsRequestT = Model::SearchGroupsRequest>
  ...
  /**
   * An Async wrapper for SearchUsers that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename SearchUsersRequestT = Model::SearchUsersRequest>
  void SearchUsersAsync(const SearchUsersRequestT& request, const SearchUsersResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateGroup that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateGroupRequestT = Model::UpdateGroupRequest>
  ...
  virtual std::shared_ptr<DirectoryServiceDataEndpointProviderBase>& accessEndpointProvider();
