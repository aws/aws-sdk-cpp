...
'"','h','t','t','p','s',':','/','/','d','s','-','d','a','t','a','-','f','i','p','s','.','{','R','e',
...
'p','s',':','/','/','d','s','-','d','a','t','a','.','{','R','e','g','i','o','n','}','.','{','P','a',
...
'l','"',':','"','h','t','t','p','s',':','/','/','d','s','-','d','a','t','a','.','{','R','e','g','i',
...
const char* DirectoryServiceDataEndpointRules::GetRulesBlob()
{
