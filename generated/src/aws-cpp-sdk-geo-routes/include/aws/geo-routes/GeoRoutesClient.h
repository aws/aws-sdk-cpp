...
namespace GeoRoutes {
/**
 * <p>With the Routes API you can calculate routes and estimate travel time based
 * on up-to-date road network and live traffic information. Key features
 * include:</p> <ul> <li> <p>Point-to-point routing with estimated travel time,
 * distance, and turn-by-turn directions. See <a
 * href="https://docs.aws.amazon.com/location/latest/APIReference/API_CalculateRoutes.html">CalculateRoutes</a>.</p>
 * </li> <li> <p>Multi-point route optimization to minimize travel time or
 * distance. See <a
 * href="https://docs.aws.amazon.com/location/latest/APIReference/API_OptimizeWaypoints.html">OptimizeWaypoints</a>.</p>
 * </li> <li> <p>Route matrices for efficient multi-destination planning. See <a
 * href="https://docs.aws.amazon.com/location/latest/APIReference/API_CalculateRouteMatrix.html">CalculateRouteMatrix</a>.</p>
 * </li> <li> <p>Isoline calculations to determine reachable areas within specified
 * time or distance thresholds. See <a
 * href="https://docs.aws.amazon.com/location/latest/APIReference/API_CalculateIsolines.html">CalculateIsolines</a>.</p>
 * </li> <li> <p>Map-matching to align GPS traces with the road network. See <a
 * href="https://docs.aws.amazon.com/location/latest/APIReference/API_SnapToRoads.html">SnapToRoads</a>.</p>
 * </li> </ul>
 */
class AWS_GEOROUTES_API GeoRoutesClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  GeoRoutesClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<GeoRoutesEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * A Callable wrapper for CalculateIsolines that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CalculateIsolines that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CalculateIsolinesRequestT = Model::CalculateIsolinesRequest>
  void CalculateIsolinesAsync(const CalculateIsolinesRequestT& request, const CalculateIsolinesResponseReceivedHandler& handler,
  ...
  /**
   * An Async wrapper for CalculateRoutes that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CalculateRoutesRequestT = Model::CalculateRoutesRequest>
  void CalculateRoutesAsync(const CalculateRoutesRequestT& request, const CalculateRoutesResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for OptimizeWaypoints that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for OptimizeWaypoints that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename OptimizeWaypointsRequestT = Model::OptimizeWaypointsRequest>
  void OptimizeWaypointsAsync(const OptimizeWaypointsRequestT& request, const OptimizeWaypointsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for SnapToRoads that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename SnapToRoadsRequestT = Model::SnapToRoadsRequest>
  void SnapToRoadsAsync(const SnapToRoadsRequestT& request, const SnapToRoadsResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
