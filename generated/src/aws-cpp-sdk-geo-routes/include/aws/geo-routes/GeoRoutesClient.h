...
namespace GeoRoutes
{
   ...
   */
  class AWS_GEOROUTES_API GeoRoutesClient : Aws::Client::ClientWithAsyncTemplateMethods<GeoRoutesClient>,
    smithy::client::AwsSmithyClientT<Aws::GeoRoutes::SERVICE_NAME,
