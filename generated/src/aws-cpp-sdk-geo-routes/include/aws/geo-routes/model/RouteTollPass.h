...
class RouteTollPass {
 public:
  ...
  inline void SetIncludesReturnTrip(bool value) {
    m_includesReturnTripHasBeenSet = true;
    m_includesReturnTrip = value;
  }
  inline RouteTollPass& WithIncludesReturnTrip(bool value) {
    SetIncludesReturnTrip(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSeniorPass(bool value) {
    m_seniorPassHasBeenSet = true;
    m_seniorPass = value;
  }
  inline RouteTollPass& WithSeniorPass(bool value) {
    SetSeniorPass(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTransferCount(int value) {
    m_transferCountHasBeenSet = true;
    m_transferCount = value;
  }
  inline RouteTollPass& WithTransferCount(int value) {
  ...
  inline void SetTripCount(int value) {
    m_tripCountHasBeenSet = true;
    m_tripCount = value;
  }
  inline RouteTollPass& WithTripCount(int value) {
    SetTripCount(value);
    return *this;
  }
  ///@}
  ...
  void SetValidityPeriod(ValidityPeriodT&& value) {
    ...
    m_validityPeriod = std::forward<ValidityPeriodT>(value);
  }
  template <typename ValidityPeriodT = RouteTollPassValidityPeriod>
  RouteTollPass& WithValidityPeriod(ValidityPeriodT&& value) {
    SetValidityPeriod(std::forward<ValidityPeriodT>(value));
    return *this;
  }
  ///@}
 private:
