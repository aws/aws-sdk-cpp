...
class RouteMatchingOptions {
 public:
  ...
  inline RouteMatchingOptions& WithOnRoadThreshold(long long value) {
  ...
  inline RouteMatchingOptions& WithRadius(long long value) {
    SetRadius(value);
    return *this;
  }
  ///@}
  ...
  inline RouteMatchingOptions& WithStrategy(MatchingStrategy value) {
    SetStrategy(value);
    return *this;
  }
  ///@}
