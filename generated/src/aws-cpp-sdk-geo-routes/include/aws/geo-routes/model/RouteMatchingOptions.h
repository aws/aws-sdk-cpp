...
namespace Model
{
  ...
  /**
   * <p>Options related to route matching.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/geo-routes-2020-11-19/RouteMatchingOptions">AWS
   * API Reference</a></p>
   */
  ...
  public:
    ...
    inline RouteMatchingOptions& WithNameHint(const Aws::String& value) { SetNameHint(value); return *this;}
    inline RouteMatchingOptions& WithNameHint(Aws::String&& value) { SetNameHint(std::move(value)); return *this;}
    inline RouteMatchingOptions& WithNameHint(const char* value) { SetNameHint(value); return *this;}
    ///@}
    ...
    inline RouteMatchingOptions& WithOnRoadThreshold(long long value) { SetOnRoadThreshold(value); return *this;}
    ///@}
    ...
    inline RouteMatchingOptions& WithRadius(long long value) { SetRadius(value); return *this;}
    ///@}
    ...
    inline RouteMatchingOptions& WithStrategy(const MatchingStrategy& value) { SetStrategy(value); return *this;}
    inline RouteMatchingOptions& WithStrategy(MatchingStrategy&& value) { SetStrategy(std::move(value)); return *this;}
    ///@}
  private:
