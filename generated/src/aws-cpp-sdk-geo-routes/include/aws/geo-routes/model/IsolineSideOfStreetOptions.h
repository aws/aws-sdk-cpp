...
namespace Model
{
  ...
  public:
    ...
    template<typename PositionT = Aws::Vector<double>>
    IsolineSideOfStreetOptions& WithPosition(PositionT&& value) { SetPosition(std::forward<PositionT>(value)); return *this;}
    ...
    inline IsolineSideOfStreetOptions& WithUseWith(SideOfStreetMatchingStrategy value) { SetUseWith(value); return *this;}
    ///@}
  private:
