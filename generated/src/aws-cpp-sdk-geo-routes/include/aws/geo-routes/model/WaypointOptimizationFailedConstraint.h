...
class WaypointOptimizationFailedConstraint {
 public:
  ...
  inline void SetConstraint(WaypointOptimizationConstraint value) {
    m_constraintHasBeenSet = true;
    m_constraint = value;
  }
  inline WaypointOptimizationFailedConstraint& WithConstraint(WaypointOptimizationConstraint value) {
    SetConstraint(value);
    return *this;
  }
  ///@}
