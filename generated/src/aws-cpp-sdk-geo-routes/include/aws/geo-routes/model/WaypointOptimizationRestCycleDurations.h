...
class WaypointOptimizationRestCycleDurations {
 public:
  ...
  inline WaypointOptimizationRestCycleDurations& WithRestDuration(long long value) {
  ...
  inline void SetWorkDuration(long long value) {
    m_workDurationHasBeenSet = true;
    m_workDuration = value;
  }
  inline WaypointOptimizationRestCycleDurations& WithWorkDuration(long long value) {
