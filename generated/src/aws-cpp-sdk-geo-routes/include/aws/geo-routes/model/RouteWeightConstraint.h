...
class RouteWeightConstraint {
 public:
  ...
  inline void SetType(RouteWeightConstraintType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline RouteWeightConstraint& WithType(RouteWeightConstraintType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline RouteWeightConstraint& WithValue(long long value) {
    SetValue(value);
    return *this;
  }
  ///@}
