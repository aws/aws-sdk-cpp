...
namespace Model
{
  ...
  public:
     ...
     */
    inline const RouteWeightConstraintType& GetType() const{ return m_type; }
    inline bool TypeHasBeenSet() const { return m_typeHasBeenSet; }
    inline void SetType(const RouteWeightConstraintType& value) { m_typeHasBeenSet = true; m_type = value; }
    inline void SetType(RouteWeightConstraintType&& value) { m_typeHasBeenSet = true; m_type = std::move(value); }
    inline RouteWeightConstraint& WithType(const RouteWeightConstraintType& value) { SetType(value); return *this;}
    inline RouteWeightConstraint& WithType(RouteWeightConstraintType&& value) { SetType(std::move(value)); return *this;}
    ///@}
  ...
  private:
    ...
    RouteWeightConstraintType m_type;
