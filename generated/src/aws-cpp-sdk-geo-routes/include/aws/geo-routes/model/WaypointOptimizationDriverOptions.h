...
class WaypointOptimizationDriverOptions {
 public:
  ...
  void SetRestCycles(RestCyclesT&& value) {
    ...
    m_restCycles = std::forward<RestCyclesT>(value);
  }
  template <typename RestCyclesT = WaypointOptimizationRestCycles>
  WaypointOptimizationDriverOptions& WithRestCycles(RestCyclesT&& value) {
    SetRestCycles(std::forward<RestCyclesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRestProfile(RestProfileT&& value) {
    ...
    m_restProfile = std::forward<RestProfileT>(value);
  }
  template <typename RestProfileT = WaypointOptimizationRestProfile>
  WaypointOptimizationDriverOptions& WithRestProfile(RestProfileT&& value) {
    SetRestProfile(std::forward<RestProfileT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTreatServiceTimeAs(WaypointOptimizationServiceTimeTreatment value) {
    m_treatServiceTimeAsHasBeenSet = true;
    m_treatServiceTimeAs = value;
  }
  inline WaypointOptimizationDriverOptions& WithTreatServiceTimeAs(WaypointOptimizationServiceTimeTreatment value) {
    SetTreatServiceTimeAs(value);
    return *this;
  }
  ///@}
 private:
