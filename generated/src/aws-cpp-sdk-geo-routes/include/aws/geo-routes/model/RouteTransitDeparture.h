 ...
 * <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/geo-routes-2020-11-19/RouteTransitDeparture">AWS
 * API Reference</a></p>
 */
class RouteTransitDeparture {
 public:
  AWS_GEOROUTES_API RouteTransitDeparture() = default;
  AWS_GEOROUTES_API RouteTransitDeparture(Aws::Utils::Json::JsonView jsonValue);
  AWS_GEOROUTES_API RouteTransitDeparture& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  inline RouteTransitDeparture& WithDelay(long long value) {
    SetDelay(value);
    return *this;
  }
  ///@}
  ...
  template <typename PlaceT = RouteTransitPlace>
  RouteTransitDeparture& WithPlace(PlaceT&& value) {
  ...
  inline RouteTransitDeparture& WithStatus(RouteTransitTripStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename TimeT = Aws::String>
  RouteTransitDeparture& WithTime(TimeT&& value) {
