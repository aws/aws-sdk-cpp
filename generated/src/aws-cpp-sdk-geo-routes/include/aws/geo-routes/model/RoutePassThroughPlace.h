...
class RoutePassThroughPlace {
 public:
  ...
  inline RoutePassThroughPlace& AddOriginalPosition(double value) {
    m_originalPositionHasBeenSet = true;
  ...
  inline RoutePassThroughPlace& AddPosition(double value) {
    m_positionHasBeenSet = true;
  ...
  inline RoutePassThroughPlace& WithWaypointIndex(int value) {
