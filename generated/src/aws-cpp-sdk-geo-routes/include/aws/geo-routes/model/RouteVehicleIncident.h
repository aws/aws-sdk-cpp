...
class RouteVehicleIncident {
 public:
  ...
  inline void SetSeverity(RouteVehicleIncidentSeverity value) {
    m_severityHasBeenSet = true;
    m_severity = value;
  }
  inline RouteVehicleIncident& WithSeverity(RouteVehicleIncidentSeverity value) {
    SetSeverity(value);
    return *this;
  }
  ///@}
  ...
  inline void SetType(RouteVehicleIncidentType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline RouteVehicleIncident& WithType(RouteVehicleIncidentType value) {
    SetType(value);
    return *this;
  }
  ///@}
