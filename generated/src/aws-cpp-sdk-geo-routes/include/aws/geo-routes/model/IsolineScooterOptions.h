...
namespace Model
{
  ...
  public:
    ...
    inline IsolineScooterOptions& WithEngineType(const IsolineEngineType& value) { SetEngineType(value); return *this;}
    inline IsolineScooterOptions& WithEngineType(IsolineEngineType&& value) { SetEngineType(std::move(value)); return *this;}
    ///@}
    ...
    inline IsolineScooterOptions& WithLicensePlate(const IsolineVehicleLicensePlate& value) { SetLicensePlate(value); return *this;}
    inline IsolineScooterOptions& WithLicensePlate(IsolineVehicleLicensePlate&& value) { SetLicensePlate(std::move(value)); return *this;}
    ///@}
