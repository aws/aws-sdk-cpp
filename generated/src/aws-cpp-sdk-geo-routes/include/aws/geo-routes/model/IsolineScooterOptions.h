...
/**
 * <p>Vehicle characteristics that affect which roads and paths can be used when
 * calculating reachable areas for scooters. This includes areas such as bike
 * lanes, shared paths, and roads where scooters are permitted.</p><p><h3>See
 * Also:</h3>   <a
...
class IsolineScooterOptions {
 public:
  ...
  inline IsolineScooterOptions& WithEngineType(IsolineEngineType value) {
    SetEngineType(value);
    return *this;
  }
  ///@}
  ...
  inline IsolineScooterOptions& WithMaxSpeed(double value) {
    SetMaxSpeed(value);
    return *this;
  }
  ///@}
  ...
  inline IsolineScooterOptions& WithOccupancy(int value) {
    SetOccupancy(value);
    return *this;
  }
  ///@}
