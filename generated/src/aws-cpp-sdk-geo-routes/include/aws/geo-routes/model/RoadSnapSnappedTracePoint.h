...
class RoadSnapSnappedTracePoint {
 public:
  ...
  inline RoadSnapSnappedTracePoint& WithConfidence(double value) {
    SetConfidence(value);
    return *this;
  }
  ///@}
  ...
  inline RoadSnapSnappedTracePoint& AddOriginalPosition(double value) {
    m_originalPositionHasBeenSet = true;
  ...
  void SetSnappedPosition(SnappedPositionT&& value) {
    m_snappedPositionHasBeenSet = true;
    m_snappedPosition = std::forward<SnappedPositionT>(value);
  }
  template <typename SnappedPositionT = Aws::Vector<double>>
  RoadSnapSnappedTracePoint& WithSnappedPosition(SnappedPositionT&& value) {
    SetSnappedPosition(std::forward<SnappedPositionT>(value));
    return *this;
  }
  inline RoadSnapSnappedTracePoint& AddSnappedPosition(double value) {
    m_snappedPositionHasBeenSet = true;
    m_snappedPosition.push_back(value);
    return *this;
  }
  ///@}
 private:
