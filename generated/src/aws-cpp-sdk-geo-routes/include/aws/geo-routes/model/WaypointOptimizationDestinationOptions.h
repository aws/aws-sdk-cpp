...
class WaypointOptimizationDestinationOptions {
 public:
  ...
  inline WaypointOptimizationDestinationOptions& WithHeading(double value) {
    SetHeading(value);
    return *this;
  }
  ///@}
  ...
  inline WaypointOptimizationDestinationOptions& WithServiceDuration(long long value) {
