...
class IsolineTravelModeOptions {
 public:
  ...
  void SetCar(CarT&& value) {
    ...
    m_car = std::forward<CarT>(value);
  }
  template <typename CarT = IsolineCarOptions>
  IsolineTravelModeOptions& WithCar(CarT&& value) {
    SetCar(std::forward<CarT>(value));
    return *this;
  }
  ///@}
  ...
  void SetScooter(ScooterT&& value) {
    ...
    m_scooter = std::forward<ScooterT>(value);
  }
  template <typename ScooterT = IsolineScooterOptions>
  IsolineTravelModeOptions& WithScooter(ScooterT&& value) {
    SetScooter(std::forward<ScooterT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTruck(TruckT&& value) {
    ...
    m_truck = std::forward<TruckT>(value);
  }
  template <typename TruckT = IsolineTruckOptions>
  IsolineTravelModeOptions& WithTruck(TruckT&& value) {
    SetTruck(std::forward<TruckT>(value));
    return *this;
  }
  ///@}
 private:
