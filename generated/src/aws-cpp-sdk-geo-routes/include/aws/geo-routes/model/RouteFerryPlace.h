...
class RouteFerryPlace {
 public:
  ...
  template <typename NameT = Aws::String>
  RouteFerryPlace& WithName(NameT&& value) {
  ...
  template <typename OriginalPositionT = Aws::Vector<double>>
  RouteFerryPlace& WithOriginalPosition(OriginalPositionT&& value) {
    SetOriginalPosition(std::forward<OriginalPositionT>(value));
    return *this;
  }
  inline RouteFerryPlace& AddOriginalPosition(double value) {
    m_originalPositionHasBeenSet = true;
  ...
  template <typename PositionT = Aws::Vector<double>>
  RouteFerryPlace& WithPosition(PositionT&& value) {
    SetPosition(std::forward<PositionT>(value));
    return *this;
  }
  inline RouteFerryPlace& AddPosition(double value) {
    m_positionHasBeenSet = true;
  ...
  inline RouteFerryPlace& WithWaypointIndex(int value) {
