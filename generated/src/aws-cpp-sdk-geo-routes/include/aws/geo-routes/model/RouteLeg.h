...
class RouteLeg {
 public:
  ...
  void SetFerryLegDetails(FerryLegDetailsT&& value) {
    ...
    m_ferryLegDetails = std::forward<FerryLegDetailsT>(value);
  }
  template <typename FerryLegDetailsT = RouteFerryLegDetails>
  RouteLeg& WithFerryLegDetails(FerryLegDetailsT&& value) {
    SetFerryLegDetails(std::forward<FerryLegDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPedestrianLegDetails(PedestrianLegDetailsT&& value) {
    ...
    m_pedestrianLegDetails = std::forward<PedestrianLegDetailsT>(value);
  }
  template <typename PedestrianLegDetailsT = RoutePedestrianLegDetails>
  RouteLeg& WithPedestrianLegDetails(PedestrianLegDetailsT&& value) {
    SetPedestrianLegDetails(std::forward<PedestrianLegDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTravelMode(RouteLegTravelMode value) {
    m_travelModeHasBeenSet = true;
    m_travelMode = value;
  }
  inline RouteLeg& WithTravelMode(RouteLegTravelMode value) {
    SetTravelMode(value);
    return *this;
  }
  ///@}
  ...
  inline void SetType(RouteLegType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline RouteLeg& WithType(RouteLegType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetVehicleLegDetails(VehicleLegDetailsT&& value) {
    ...
    m_vehicleLegDetails = std::forward<VehicleLegDetailsT>(value);
  }
  template <typename VehicleLegDetailsT = RouteVehicleLegDetails>
  RouteLeg& WithVehicleLegDetails(VehicleLegDetailsT&& value) {
    SetVehicleLegDetails(std::forward<VehicleLegDetailsT>(value));
    return *this;
  }
  ///@}
 private:
