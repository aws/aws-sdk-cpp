...
class Route {
 public:
  ...
  void SetMajorRoadLabels(MajorRoadLabelsT&& value) {
    ...
    m_majorRoadLabels = std::forward<MajorRoadLabelsT>(value);
  }
  template <typename MajorRoadLabelsT = Aws::Vector<RouteMajorRoadLabel>>
  Route& WithMajorRoadLabels(MajorRoadLabelsT&& value) {
    SetMajorRoadLabels(std::forward<MajorRoadLabelsT>(value));
    return *this;
  }
  template <typename MajorRoadLabelsT = RouteMajorRoadLabel>
  Route& AddMajorRoadLabels(MajorRoadLabelsT&& value) {
    m_majorRoadLabelsHasBeenSet = true;
    m_majorRoadLabels.emplace_back(std::forward<MajorRoadLabelsT>(value));
    return *this;
  }
  ///@}
