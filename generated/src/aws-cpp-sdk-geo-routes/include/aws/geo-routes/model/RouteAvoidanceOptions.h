...
class RouteAvoidanceOptions {
 public:
  ...
  inline RouteAvoidanceOptions& WithCarShuttleTrains(bool value) {
  ...
  inline RouteAvoidanceOptions& WithControlledAccessHighways(bool value) {
  ...
  inline RouteAvoidanceOptions& WithDirtRoads(bool value) {
    SetDirtRoads(value);
    return *this;
  }
  ///@}
  ...
  inline RouteAvoidanceOptions& WithFerries(bool value) {
    SetFerries(value);
    return *this;
  }
  ///@}
  ...
  inline RouteAvoidanceOptions& WithSeasonalClosure(bool value) {
  ...
  inline RouteAvoidanceOptions& WithTollRoads(bool value) {
    SetTollRoads(value);
    return *this;
  }
  ///@}
  ...
  inline RouteAvoidanceOptions& WithTollTransponders(bool value) {
  ...
  inline RouteAvoidanceOptions& WithTunnels(bool value) {
    SetTunnels(value);
    return *this;
  }
  ///@}
  ...
  inline RouteAvoidanceOptions& WithUTurns(bool value) {
    SetUTurns(value);
    return *this;
  }
  ///@}
