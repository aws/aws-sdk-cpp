...
class RouteUTurnStepDetails {
 public:
  ...
  inline RouteUTurnStepDetails& WithSteeringDirection(RouteSteeringDirection value) {
  ...
  inline RouteUTurnStepDetails& WithTurnAngle(double value) {
    SetTurnAngle(value);
    return *this;
  }
  ///@}
  ...
  inline RouteUTurnStepDetails& WithTurnIntensity(RouteTurnIntensity value) {
