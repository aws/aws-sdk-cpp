...
class RouteMatrixDestinationOptions {
 public:
  ...
  inline RouteMatrixDestinationOptions& WithAvoidActionsForDistance(long long value) {
  ...
  inline RouteMatrixDestinationOptions& WithHeading(double value) {
    SetHeading(value);
    return *this;
  }
  ///@}
  ...
  template <typename MatchingT = RouteMatrixMatchingOptions>
  RouteMatrixDestinationOptions& WithMatching(MatchingT&& value) {
  ...
  template <typename SideOfStreetT = RouteMatrixSideOfStreetOptions>
  RouteMatrixDestinationOptions& WithSideOfStreet(SideOfStreetT&& value) {
