...
class RoadSnapNotice {
 public:
  ...
  inline void SetCode(RoadSnapNoticeCode value) {
    m_codeHasBeenSet = true;
    m_code = value;
  }
  inline RoadSnapNotice& WithCode(RoadSnapNoticeCode value) {
    SetCode(value);
    return *this;
  }
  ///@}
  ...
  void SetTracePointIndexes(TracePointIndexesT&& value) {
    ...
    m_tracePointIndexes = std::forward<TracePointIndexesT>(value);
  }
  template <typename TracePointIndexesT = Aws::Vector<int>>
  RoadSnapNotice& WithTracePointIndexes(TracePointIndexesT&& value) {
    SetTracePointIndexes(std::forward<TracePointIndexesT>(value));
    return *this;
  }
  inline RoadSnapNotice& AddTracePointIndexes(int value) {
    m_tracePointIndexesHasBeenSet = true;
    m_tracePointIndexes.push_back(value);
    return *this;
  }
  ///@}
 private:
