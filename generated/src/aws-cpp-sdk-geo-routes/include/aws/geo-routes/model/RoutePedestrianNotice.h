...
class RoutePedestrianNotice {
 public:
  ...
  inline void SetCode(RoutePedestrianNoticeCode value) {
    m_codeHasBeenSet = true;
    m_code = value;
  }
  inline RoutePedestrianNotice& WithCode(RoutePedestrianNoticeCode value) {
    SetCode(value);
    return *this;
  }
  ///@}
  ...
  inline RoutePedestrianNotice& WithImpact(RouteNoticeImpact value) {
    SetImpact(value);
    return *this;
  }
  ///@}
