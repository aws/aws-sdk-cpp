...
class RouteFerryBeforeTravelStep {
 public:
  ...
  inline RouteFerryBeforeTravelStep& WithDuration(long long value) {
    SetDuration(value);
    return *this;
  }
  ///@}
  ...
  inline void SetType(RouteFerryBeforeTravelStepType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline RouteFerryBeforeTravelStep& WithType(RouteFerryBeforeTravelStepType value) {
    SetType(value);
    return *this;
  }
  ///@}
