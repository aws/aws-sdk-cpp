...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/geo-routes-2020-11-19/RoadSnapTrailerOptions">AWS
   * API Reference</a></p>
   */
  class RoadSnapTrailerOptions
  {
  public:
    AWS_GEOROUTES_API RoadSnapTrailerOptions() = default;
    AWS_GEOROUTES_API RoadSnapTrailerOptions(Aws::Utils::Json::JsonView jsonValue);
    AWS_GEOROUTES_API RoadSnapTrailerOptions& operator=(Aws::Utils::Json::JsonView jsonValue);
    ...
    inline RoadSnapTrailerOptions& WithTrailerCount(int value) { SetTrailerCount(value); return *this;}
    ///@}
  private:
