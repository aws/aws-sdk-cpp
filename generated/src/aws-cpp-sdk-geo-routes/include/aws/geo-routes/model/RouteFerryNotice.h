 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/geo-routes-2020-11-19/RouteFerryNotice">AWS
 * API Reference</a></p>
 */
class RouteFerryNotice {
 public:
  ...
  inline void SetCode(RouteFerryNoticeCode value) {
    m_codeHasBeenSet = true;
    m_code = value;
  }
  inline RouteFerryNotice& WithCode(RouteFerryNoticeCode value) {
    SetCode(value);
    return *this;
  }
  ///@}
  ...
  inline RouteFerryNotice& WithImpact(RouteNoticeImpact value) {
    SetImpact(value);
    return *this;
  }
  ///@}
