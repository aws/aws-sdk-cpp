...
class RouteVehicleOverviewSummary {
 public:
  ...
  inline void SetBestCaseDuration(long long value) {
    m_bestCaseDurationHasBeenSet = true;
    m_bestCaseDuration = value;
  }
  inline RouteVehicleOverviewSummary& WithBestCaseDuration(long long value) {
    SetBestCaseDuration(value);
    return *this;
  }
  ///@}
  ...
  inline RouteVehicleOverviewSummary& WithDistance(long long value) {
    SetDistance(value);
    return *this;
  }
  ///@}
  ...
  inline RouteVehicleOverviewSummary& WithDuration(long long value) {
    SetDuration(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTypicalDuration(long long value) {
    m_typicalDurationHasBeenSet = true;
    m_typicalDuration = value;
  }
  inline RouteVehicleOverviewSummary& WithTypicalDuration(long long value) {
    SetTypicalDuration(value);
    return *this;
  }
  ///@}
 private:
