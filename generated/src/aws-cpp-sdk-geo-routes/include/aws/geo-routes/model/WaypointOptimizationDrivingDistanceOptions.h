...
class WaypointOptimizationDrivingDistanceOptions {
 public:
  ...
  inline void SetDrivingDistance(long long value) {
    m_drivingDistanceHasBeenSet = true;
    m_drivingDistance = value;
  }
  inline WaypointOptimizationDrivingDistanceOptions& WithDrivingDistance(long long value) {
