...
class RouteDriverScheduleInterval {
 public:
  ...
  inline void SetDriveDuration(long long value) {
    m_driveDurationHasBeenSet = true;
    m_driveDuration = value;
  }
  inline RouteDriverScheduleInterval& WithDriveDuration(long long value) {
    SetDriveDuration(value);
    return *this;
  }
  ///@}
  ...
  inline RouteDriverScheduleInterval& WithRestDuration(long long value) {
