...
/**
 * <p>A step that must be performed after the travel portion of the
 * leg.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/geo-routes-2020-11-19/RouteTransitAfterTravelStep">AWS
 * API Reference</a></p>
 */
class RouteTransitAfterTravelStep {
 public:
  ...
  inline RouteTransitAfterTravelStep& WithDuration(long long value) {
    SetDuration(value);
    return *this;
  }
  ///@}
   ...
   */
  inline RouteTransitAfterTravelStepType GetType() const { return m_type; }
  inline bool TypeHasBeenSet() const { return m_typeHasBeenSet; }
  inline void SetType(RouteTransitAfterTravelStepType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline RouteTransitAfterTravelStep& WithType(RouteTransitAfterTravelStepType value) {
    SetType(value);
    return *this;
  }
  ///@}
 private:
  ...
  RouteTransitAfterTravelStepType m_type{RouteTransitAfterTravelStepType::NOT_SET};
