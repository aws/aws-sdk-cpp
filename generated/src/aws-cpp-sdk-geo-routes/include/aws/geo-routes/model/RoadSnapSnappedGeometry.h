...
namespace Model
{
  ...
  {
  public:
    AWS_GEOROUTES_API RoadSnapSnappedGeometry();
    ...
    inline RoadSnapSnappedGeometry& WithLineString(const Aws::Vector<Aws::Vector<double>>& value) { SetLineString(value); return *this;}
    inline RoadSnapSnappedGeometry& WithLineString(Aws::Vector<Aws::Vector<double>>&& value) { SetLineString(std::move(value)); return *this;}
    inline RoadSnapSnappedGeometry& AddLineString(const Aws::Vector<double>& value) { m_lineStringHasBeenSet = true; m_lineString.push_back(value); return *this; }
    inline RoadSnapSnappedGeometry& AddLineString(Aws::Vector<double>&& value) { m_lineStringHasBeenSet = true; m_lineString.push_back(std::move(value)); return *this; }
    ///@}
    ...
    inline RoadSnapSnappedGeometry& WithPolyline(const Aws::String& value) { SetPolyline(value); return *this;}
    inline RoadSnapSnappedGeometry& WithPolyline(Aws::String&& value) { SetPolyline(std::move(value)); return *this;}
    inline RoadSnapSnappedGeometry& WithPolyline(const char* value) { SetPolyline(value); return *this;}
    ///@}
  private:
