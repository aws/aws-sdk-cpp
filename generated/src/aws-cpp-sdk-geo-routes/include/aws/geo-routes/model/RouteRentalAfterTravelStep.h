 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/geo-routes-2020-11-19/RouteRentalAfterTravelStep">AWS
 * API Reference</a></p>
 */
class RouteRentalAfterTravelStep {
 public:
  ...
  inline RouteRentalAfterTravelStep& WithDuration(long long value) {
    SetDuration(value);
    return *this;
  }
  ///@}
   ...
   */
  inline RouteRentalAfterTravelStepType GetType() const { return m_type; }
  inline bool TypeHasBeenSet() const { return m_typeHasBeenSet; }
  inline void SetType(RouteRentalAfterTravelStepType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline RouteRentalAfterTravelStep& WithType(RouteRentalAfterTravelStepType value) {
    SetType(value);
    return *this;
  }
  ///@}
 private:
  ...
  RouteRentalAfterTravelStepType m_type{RouteRentalAfterTravelStepType::NOT_SET};
