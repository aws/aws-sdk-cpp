...
class RouteRoad {
 public:
  ...
  void SetRoadName(RoadNameT&& value) {
    ...
    m_roadName = std::forward<RoadNameT>(value);
  }
  template <typename RoadNameT = Aws::Vector<LocalizedString>>
  RouteRoad& WithRoadName(RoadNameT&& value) {
    SetRoadName(std::forward<RoadNameT>(value));
    return *this;
  }
  template <typename RoadNameT = LocalizedString>
  RouteRoad& AddRoadName(RoadNameT&& value) {
    m_roadNameHasBeenSet = true;
    m_roadName.emplace_back(std::forward<RoadNameT>(value));
    return *this;
  }
  ///@}
  ...
  RouteRoad& AddRouteNumber(RouteNumberT&& value) {
    m_routeNumberHasBeenSet = true;
    m_routeNumber.emplace_back(std::forward<RouteNumberT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTowards(TowardsT&& value) {
    ...
    m_towards = std::forward<TowardsT>(value);
  }
  template <typename TowardsT = Aws::Vector<LocalizedString>>
  RouteRoad& WithTowards(TowardsT&& value) {
    SetTowards(std::forward<TowardsT>(value));
    return *this;
  }
  template <typename TowardsT = LocalizedString>
  RouteRoad& AddTowards(TowardsT&& value) {
    m_towardsHasBeenSet = true;
    m_towards.emplace_back(std::forward<TowardsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetType(RouteRoadType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline RouteRoad& WithType(RouteRoadType value) {
    SetType(value);
    return *this;
  }
  ///@}
