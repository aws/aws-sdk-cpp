...
/**
 * <p>Options for the transit leg of the intermodal route.</p><p><h3>See Also:</h3>
 * <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/geo-routes-2020-11-19/RouteIntermodalTransitOptions">AWS
 * API Reference</a></p>
 */
class RouteIntermodalTransitOptions {
 public:
  ...
  inline RouteIntermodalTransitOptions& AddAllowedModes(RouteTransitMode value) {
    m_allowedModesHasBeenSet = true;
  ...
  inline RouteIntermodalTransitOptions& AddEnabledFor(RouteIntermodalEnabledLegs value) {
    m_enabledForHasBeenSet = true;
  ...
  inline RouteIntermodalTransitOptions& AddExcludedModes(RouteTransitMode value) {
    m_excludedModesHasBeenSet = true;
