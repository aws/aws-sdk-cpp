...
namespace Model
{
  ...
  public:
    ...
    inline IsolineTruckOptions& WithEngineType(const IsolineEngineType& value) { SetEngineType(value); return *this;}
    inline IsolineTruckOptions& WithEngineType(IsolineEngineType&& value) { SetEngineType(std::move(value)); return *this;}
    ///@}
    ...
    inline void SetHazardousCargos(const Aws::Vector<IsolineHazardousCargoType>& value) { m_hazardousCargosHasBeenSet = true; m_hazardousCargos = value; }
    inline void SetHazardousCargos(Aws::Vector<IsolineHazardousCargoType>&& value) { m_hazardousCargosHasBeenSet = true; m_hazardousCargos = std::move(value); }
    inline IsolineTruckOptions& WithHazardousCargos(const Aws::Vector<IsolineHazardousCargoType>& value) { SetHazardousCargos(value); return *this;}
    inline IsolineTruckOptions& WithHazardousCargos(Aws::Vector<IsolineHazardousCargoType>&& value) { SetHazardousCargos(std::move(value)); return *this;}
    inline IsolineTruckOptions& AddHazardousCargos(const IsolineHazardousCargoType& value) { m_hazardousCargosHasBeenSet = true; m_hazardousCargos.push_back(value); return *this; }
    inline IsolineTruckOptions& AddHazardousCargos(IsolineHazardousCargoType&& value) { m_hazardousCargosHasBeenSet = true; m_hazardousCargos.push_back(std::move(value)); return *this; }
    ///@}
    ...
    inline IsolineTruckOptions& WithLicensePlate(const IsolineVehicleLicensePlate& value) { SetLicensePlate(value); return *this;}
    inline IsolineTruckOptions& WithLicensePlate(IsolineVehicleLicensePlate&& value) { SetLicensePlate(std::move(value)); return *this;}
    ///@}
    ...
    inline void SetTrailer(const IsolineTrailerOptions& value) { m_trailerHasBeenSet = true; m_trailer = value; }
    inline void SetTrailer(IsolineTrailerOptions&& value) { m_trailerHasBeenSet = true; m_trailer = std::move(value); }
    inline IsolineTruckOptions& WithTrailer(const IsolineTrailerOptions& value) { SetTrailer(value); return *this;}
    inline IsolineTruckOptions& WithTrailer(IsolineTrailerOptions&& value) { SetTrailer(std::move(value)); return *this;}
    ///@}
     ...
     */
    inline const IsolineTruckType& GetTruckType() const{ return m_truckType; }
    inline bool TruckTypeHasBeenSet() const { return m_truckTypeHasBeenSet; }
    inline void SetTruckType(const IsolineTruckType& value) { m_truckTypeHasBeenSet = true; m_truckType = value; }
    inline void SetTruckType(IsolineTruckType&& value) { m_truckTypeHasBeenSet = true; m_truckType = std::move(value); }
    inline IsolineTruckOptions& WithTruckType(const IsolineTruckType& value) { SetTruckType(value); return *this;}
    inline IsolineTruckOptions& WithTruckType(IsolineTruckType&& value) { SetTruckType(std::move(value)); return *this;}
    ///@}
    ...
    inline IsolineTruckOptions& WithTunnelRestrictionCode(const Aws::String& value) { SetTunnelRestrictionCode(value); return *this;}
    inline IsolineTruckOptions& WithTunnelRestrictionCode(Aws::String&& value) { SetTunnelRestrictionCode(std::move(value)); return *this;}
    inline IsolineTruckOptions& WithTunnelRestrictionCode(const char* value) { SetTunnelRestrictionCode(value); return *this;}
    ///@}
    ...
    inline IsolineTruckOptions& WithWeightPerAxleGroup(const WeightPerAxleGroup& value) { SetWeightPerAxleGroup(value); return *this;}
    inline IsolineTruckOptions& WithWeightPerAxleGroup(WeightPerAxleGroup&& value) { SetWeightPerAxleGroup(std::move(value)); return *this;}
    ///@}
