...
namespace Model
{
  ...
  /**
   * <p>Options for the property.</p><p><h3>See Also:</h3>   <a
  ...
  {
  public:
    AWS_GEOROUTES_API IsolineOriginOptions();
    ...
    inline IsolineOriginOptions& WithAvoidActionsForDistance(long long value) { SetAvoidActionsForDistance(value); return *this;}
    ///@}
    ...
    inline IsolineOriginOptions& WithHeading(double value) { SetHeading(value); return *this;}
    ///@}
    ...
    inline IsolineOriginOptions& WithMatching(const IsolineMatchingOptions& value) { SetMatching(value); return *this;}
    inline IsolineOriginOptions& WithMatching(IsolineMatchingOptions&& value) { SetMatching(std::move(value)); return *this;}
    ///@}
    ...
    inline IsolineOriginOptions& WithSideOfStreet(const IsolineSideOfStreetOptions& value) { SetSideOfStreet(value); return *this;}
    inline IsolineOriginOptions& WithSideOfStreet(IsolineSideOfStreetOptions&& value) { SetSideOfStreet(std::move(value)); return *this;}
    ///@}
  private:
