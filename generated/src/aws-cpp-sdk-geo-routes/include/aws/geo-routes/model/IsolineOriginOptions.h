...
namespace Model
{
  ...
  public:
    ...
    template<typename MatchingT = IsolineMatchingOptions>
    IsolineOriginOptions& WithMatching(MatchingT&& value) { SetMatching(std::forward<MatchingT>(value)); return *this;}
    ///@}
    ...
    template<typename SideOfStreetT = IsolineSideOfStreetOptions>
    IsolineOriginOptions& WithSideOfStreet(SideOfStreetT&& value) { SetSideOfStreet(std::forward<SideOfStreetT>(value)); return *this;}
    ///@}
  private:
