...
namespace Model
{
  ...
  {
  public:
    AWS_GEOROUTES_API RouteContinueHighwayStepDetails() = default;
    ...
    template<typename IntersectionT = Aws::Vector<LocalizedString>>
    RouteContinueHighwayStepDetails& WithIntersection(IntersectionT&& value) { SetIntersection(std::forward<IntersectionT>(value)); return *this;}
    template<typename IntersectionT = LocalizedString>
    RouteContinueHighwayStepDetails& AddIntersection(IntersectionT&& value) { m_intersectionHasBeenSet = true; m_intersection.emplace_back(std::forward<IntersectionT>(value)); return *this; }
    ///@}
    ...
    inline RouteContinueHighwayStepDetails& WithSteeringDirection(RouteSteeringDirection value) { SetSteeringDirection(value); return *this;}
    ///@}
    ...
    inline RouteContinueHighwayStepDetails& WithTurnIntensity(RouteTurnIntensity value) { SetTurnIntensity(value); return *this;}
    ///@}
  private:
