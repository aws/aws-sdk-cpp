...
namespace Model
{
  ...
  /**
   * <p>Details related to the continue highway step.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/geo-routes-2020-11-19/RouteContinueHighwayStepDetails">AWS
   * API Reference</a></p>
   */
  class RouteContinueHighwayStepDetails
  {
  public:
    AWS_GEOROUTES_API RouteContinueHighwayStepDetails();
    AWS_GEOROUTES_API RouteContinueHighwayStepDetails(Aws::Utils::Json::JsonView jsonValue);
    AWS_GEOROUTES_API RouteContinueHighwayStepDetails& operator=(Aws::Utils::Json::JsonView jsonValue);
    ...
    inline RouteContinueHighwayStepDetails& WithIntersection(const Aws::Vector<LocalizedString>& value) { SetIntersection(value); return *this;}
    inline RouteContinueHighwayStepDetails& WithIntersection(Aws::Vector<LocalizedString>&& value) { SetIntersection(std::move(value)); return *this;}
    inline RouteContinueHighwayStepDetails& AddIntersection(const LocalizedString& value) { m_intersectionHasBeenSet = true; m_intersection.push_back(value); return *this; }
    inline RouteContinueHighwayStepDetails& AddIntersection(LocalizedString&& value) { m_intersectionHasBeenSet = true; m_intersection.push_back(std::move(value)); return *this; }
    ///@}
    ...
    inline RouteContinueHighwayStepDetails& WithSteeringDirection(const RouteSteeringDirection& value) { SetSteeringDirection(value); return *this;}
    inline RouteContinueHighwayStepDetails& WithSteeringDirection(RouteSteeringDirection&& value) { SetSteeringDirection(std::move(value)); return *this;}
    ///@}
    ...
    inline RouteContinueHighwayStepDetails& WithTurnAngle(double value) { SetTurnAngle(value); return *this;}
    ///@}
    ...
    inline RouteContinueHighwayStepDetails& WithTurnIntensity(const RouteTurnIntensity& value) { SetTurnIntensity(value); return *this;}
    inline RouteContinueHighwayStepDetails& WithTurnIntensity(RouteTurnIntensity&& value) { SetTurnIntensity(std::move(value)); return *this;}
    ///@}
  private:
