...
class RouteContinueHighwayStepDetails {
 public:
  ...
  template <typename IntersectionT = Aws::Vector<LocalizedString>>
  RouteContinueHighwayStepDetails& WithIntersection(IntersectionT&& value) {
    SetIntersection(std::forward<IntersectionT>(value));
    return *this;
  }
  template <typename IntersectionT = LocalizedString>
  RouteContinueHighwayStepDetails& AddIntersection(IntersectionT&& value) {
    m_intersectionHasBeenSet = true;
  ...
  inline RouteContinueHighwayStepDetails& WithSteeringDirection(RouteSteeringDirection value) {
  ...
  inline RouteContinueHighwayStepDetails& WithTurnAngle(double value) {
    SetTurnAngle(value);
    return *this;
  }
  ///@}
  ...
  inline RouteContinueHighwayStepDetails& WithTurnIntensity(RouteTurnIntensity value) {
