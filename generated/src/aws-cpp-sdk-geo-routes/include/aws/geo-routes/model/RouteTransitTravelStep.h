 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/geo-routes-2020-11-19/RouteTransitTravelStep">AWS
 * API Reference</a></p>
 */
class RouteTransitTravelStep {
 public:
  ...
  inline RouteTransitTravelStep& WithDistance(long long value) {
    SetDistance(value);
    return *this;
  }
  ///@}
  ...
  inline RouteTransitTravelStep& WithDuration(long long value) {
    SetDuration(value);
    return *this;
  }
  ///@}
  ...
  inline RouteTransitTravelStep& WithGeometryOffset(int value) {
   ...
   */
  inline RouteTransitTravelStepType GetType() const { return m_type; }
  inline bool TypeHasBeenSet() const { return m_typeHasBeenSet; }
  inline void SetType(RouteTransitTravelStepType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline RouteTransitTravelStep& WithType(RouteTransitTravelStepType value) {
    SetType(value);
    return *this;
  }
  ///@}
 private:
  ...
  RouteTransitTravelStepType m_type{RouteTransitTravelStepType::NOT_SET};
