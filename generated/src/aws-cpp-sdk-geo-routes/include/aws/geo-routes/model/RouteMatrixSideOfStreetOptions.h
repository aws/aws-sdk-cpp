...
namespace Model
{
  ...
  {
  public:
    AWS_GEOROUTES_API RouteMatrixSideOfStreetOptions();
    ...
    inline RouteMatrixSideOfStreetOptions& WithPosition(const Aws::Vector<double>& value) { SetPosition(value); return *this;}
    inline RouteMatrixSideOfStreetOptions& WithPosition(Aws::Vector<double>&& value) { SetPosition(std::move(value)); return *this;}
    ...
    inline RouteMatrixSideOfStreetOptions& WithUseWith(const SideOfStreetMatchingStrategy& value) { SetUseWith(value); return *this;}
    inline RouteMatrixSideOfStreetOptions& WithUseWith(SideOfStreetMatchingStrategy&& value) { SetUseWith(std::move(value)); return *this;}
    ///@}
  private:
