...
namespace Model
{
  ...
  public:
    ...
    inline void SetMatching(const RouteMatrixMatchingOptions& value) { m_matchingHasBeenSet = true; m_matching = value; }
    inline void SetMatching(RouteMatrixMatchingOptions&& value) { m_matchingHasBeenSet = true; m_matching = std::move(value); }
    inline RouteMatrixOriginOptions& WithMatching(const RouteMatrixMatchingOptions& value) { SetMatching(value); return *this;}
    inline RouteMatrixOriginOptions& WithMatching(RouteMatrixMatchingOptions&& value) { SetMatching(std::move(value)); return *this;}
    ///@}
    ...
    inline void SetSideOfStreet(const RouteMatrixSideOfStreetOptions& value) { m_sideOfStreetHasBeenSet = true; m_sideOfStreet = value; }
    inline void SetSideOfStreet(RouteMatrixSideOfStreetOptions&& value) { m_sideOfStreetHasBeenSet = true; m_sideOfStreet = std::move(value); }
    inline RouteMatrixOriginOptions& WithSideOfStreet(const RouteMatrixSideOfStreetOptions& value) { SetSideOfStreet(value); return *this;}
    inline RouteMatrixOriginOptions& WithSideOfStreet(RouteMatrixSideOfStreetOptions&& value) { SetSideOfStreet(std::move(value)); return *this;}
    ///@}
  private:
