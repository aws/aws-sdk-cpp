...
class RouteFerryTravelStep {
 public:
  ...
  inline RouteFerryTravelStep& WithDistance(long long value) {
    SetDistance(value);
    return *this;
  }
  ///@}
  ...
  inline RouteFerryTravelStep& WithDuration(long long value) {
    SetDuration(value);
    return *this;
  }
  ///@}
  ...
  inline RouteFerryTravelStep& WithGeometryOffset(int value) {
  ...
  inline void SetType(RouteFerryTravelStepType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline RouteFerryTravelStep& WithType(RouteFerryTravelStepType value) {
    SetType(value);
    return *this;
  }
  ///@}
