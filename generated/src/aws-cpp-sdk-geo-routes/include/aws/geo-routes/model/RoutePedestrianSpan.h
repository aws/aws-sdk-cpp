...
class RoutePedestrianSpan {
 public:
  ...
  inline RoutePedestrianSpan& WithBestCaseDuration(long long value) {
  ...
  inline RoutePedestrianSpan& WithDistance(long long value) {
    SetDistance(value);
    return *this;
  }
  ///@}
  ...
  inline RoutePedestrianSpan& WithDuration(long long value) {
    SetDuration(value);
    return *this;
  }
  ///@}
  ...
  inline RoutePedestrianSpan& WithFunctionalClassification(int value) {
  ...
  inline RoutePedestrianSpan& WithGeometryOffset(int value) {
  ...
  inline RoutePedestrianSpan& AddIncidents(int value) {
    m_incidentsHasBeenSet = true;
  ...
  void SetPedestrianAccess(PedestrianAccessT&& value) {
    ...
    m_pedestrianAccess = std::forward<PedestrianAccessT>(value);
  }
  template <typename PedestrianAccessT = Aws::Vector<RouteSpanPedestrianAccessAttribute>>
  RoutePedestrianSpan& WithPedestrianAccess(PedestrianAccessT&& value) {
    SetPedestrianAccess(std::forward<PedestrianAccessT>(value));
    return *this;
  }
  inline RoutePedestrianSpan& AddPedestrianAccess(RouteSpanPedestrianAccessAttribute value) {
    m_pedestrianAccessHasBeenSet = true;
    m_pedestrianAccess.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline RoutePedestrianSpan& AddRoadAttributes(RouteSpanRoadAttribute value) {
    m_roadAttributesHasBeenSet = true;
  ...
  inline RoutePedestrianSpan& WithTypicalDuration(long long value) {
