...
class RouteResponseNotice {
 public:
  ...
  inline void SetCode(RouteResponseNoticeCode value) {
    m_codeHasBeenSet = true;
    m_code = value;
  }
  inline RouteResponseNotice& WithCode(RouteResponseNoticeCode value) {
    SetCode(value);
    return *this;
  }
  ///@}
  ...
  inline RouteResponseNotice& WithImpact(RouteNoticeImpact value) {
    SetImpact(value);
    return *this;
  }
  ///@}
