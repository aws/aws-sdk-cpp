...
class RouteExitStepDetails {
 public:
  ...
  inline RouteExitStepDetails& WithRelativeExit(int value) {
  ...
  inline RouteExitStepDetails& WithSteeringDirection(RouteSteeringDirection value) {
  ...
  inline RouteExitStepDetails& WithTurnAngle(double value) {
    SetTurnAngle(value);
    return *this;
  }
  ///@}
  ...
  inline RouteExitStepDetails& WithTurnIntensity(RouteTurnIntensity value) {
