...
class RouteEnterHighwayStepDetails {
 public:
  ...
  inline RouteEnterHighwayStepDetails& WithSteeringDirection(RouteSteeringDirection value) {
  ...
  inline RouteEnterHighwayStepDetails& WithTurnAngle(double value) {
    SetTurnAngle(value);
    return *this;
  }
  ///@}
  ...
  inline RouteEnterHighwayStepDetails& WithTurnIntensity(RouteTurnIntensity value) {
