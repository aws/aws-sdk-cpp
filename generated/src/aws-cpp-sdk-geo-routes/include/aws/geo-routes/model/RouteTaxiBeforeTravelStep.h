 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/geo-routes-2020-11-19/RouteTaxiBeforeTravelStep">AWS
 * API Reference</a></p>
 */
class RouteTaxiBeforeTravelStep {
 public:
  AWS_GEOROUTES_API RouteTaxiBeforeTravelStep() = default;
  AWS_GEOROUTES_API RouteTaxiBeforeTravelStep(Aws::Utils::Json::JsonView jsonValue);
  AWS_GEOROUTES_API RouteTaxiBeforeTravelStep& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  inline RouteTaxiBeforeTravelStep& WithDuration(long long value) {
    SetDuration(value);
    return *this;
  }
  ///@}
  ...
  template <typename InstructionT = Aws::String>
  RouteTaxiBeforeTravelStep& WithInstruction(InstructionT&& value) {
   ...
   */
  inline RouteTaxiBeforeTravelStepType GetType() const { return m_type; }
  inline bool TypeHasBeenSet() const { return m_typeHasBeenSet; }
  inline void SetType(RouteTaxiBeforeTravelStepType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline RouteTaxiBeforeTravelStep& WithType(RouteTaxiBeforeTravelStepType value) {
    SetType(value);
    return *this;
  }
  ///@}
 private:
  ...
  RouteTaxiBeforeTravelStepType m_type{RouteTaxiBeforeTravelStepType::NOT_SET};
