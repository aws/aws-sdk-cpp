...
class RouteSpanDynamicSpeedDetails {
 public:
  ...
  inline void SetBestCaseSpeed(double value) {
    m_bestCaseSpeedHasBeenSet = true;
    m_bestCaseSpeed = value;
  }
  inline RouteSpanDynamicSpeedDetails& WithBestCaseSpeed(double value) {
    SetBestCaseSpeed(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTurnDuration(long long value) {
    m_turnDurationHasBeenSet = true;
    m_turnDuration = value;
  }
  inline RouteSpanDynamicSpeedDetails& WithTurnDuration(long long value) {
  ...
  inline void SetTypicalSpeed(double value) {
    m_typicalSpeedHasBeenSet = true;
    m_typicalSpeed = value;
  }
  inline RouteSpanDynamicSpeedDetails& WithTypicalSpeed(double value) {
    SetTypicalSpeed(value);
    return *this;
  }
  ///@}
 private:
