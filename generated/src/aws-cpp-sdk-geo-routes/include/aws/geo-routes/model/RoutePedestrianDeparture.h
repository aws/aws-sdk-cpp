...
namespace Model
{
  ...
  /**
   * <p>Details corresponding to the departure for a leg.</p> <p>Time
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/geo-routes-2020-11-19/RoutePedestrianDeparture">AWS
   * API Reference</a></p>
   */
