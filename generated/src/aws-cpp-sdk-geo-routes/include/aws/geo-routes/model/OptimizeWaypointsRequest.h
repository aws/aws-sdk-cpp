...
class OptimizeWaypointsRequest : public GeoRoutesRequest {
 public:
  ...
  void SetClustering(ClusteringT&& value) {
    m_clusteringHasBeenSet = true;
    m_clustering = std::forward<ClusteringT>(value);
  }
  template <typename ClusteringT = WaypointOptimizationClusteringOptions>
  OptimizeWaypointsRequest& WithClustering(ClusteringT&& value) {
    SetClustering(std::forward<ClusteringT>(value));
    return *this;
  }
  ///@}
  ...
  inline OptimizeWaypointsRequest& AddDestination(double value) {
    m_destinationHasBeenSet = true;
  ...
  void SetDriver(DriverT&& value) {
    ...
    m_driver = std::forward<DriverT>(value);
  }
  template <typename DriverT = WaypointOptimizationDriverOptions>
  OptimizeWaypointsRequest& WithDriver(DriverT&& value) {
    SetDriver(std::forward<DriverT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetOptimizeSequencingFor(WaypointOptimizationSequencingObjective value) {
    m_optimizeSequencingForHasBeenSet = true;
    m_optimizeSequencingFor = value;
  }
  inline OptimizeWaypointsRequest& WithOptimizeSequencingFor(WaypointOptimizationSequencingObjective value) {
    SetOptimizeSequencingFor(value);
    return *this;
  }
  ///@}
  ...
  inline OptimizeWaypointsRequest& AddOrigin(double value) {
    m_originHasBeenSet = true;
  ...
  inline void SetTravelMode(WaypointOptimizationTravelMode value) {
    m_travelModeHasBeenSet = true;
    m_travelMode = value;
  }
  inline OptimizeWaypointsRequest& WithTravelMode(WaypointOptimizationTravelMode value) {
    SetTravelMode(value);
    return *this;
  }
  ///@}
