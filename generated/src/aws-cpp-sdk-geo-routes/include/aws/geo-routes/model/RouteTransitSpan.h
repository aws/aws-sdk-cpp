 ...
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/geo-routes-2020-11-19/RouteTransitSpan">AWS
 * API Reference</a></p>
 */
class RouteTransitSpan {
 public:
  AWS_GEOROUTES_API RouteTransitSpan() = default;
  AWS_GEOROUTES_API RouteTransitSpan(Aws::Utils::Json::JsonView jsonValue);
  AWS_GEOROUTES_API RouteTransitSpan& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename CountryT = Aws::String>
  RouteTransitSpan& WithCountry(CountryT&& value) {
  ...
  inline RouteTransitSpan& WithDistance(long long value) {
    SetDistance(value);
    return *this;
  }
  ///@}
  ...
  inline RouteTransitSpan& WithDuration(long long value) {
    SetDuration(value);
    return *this;
  }
  ///@}
  ...
  inline RouteTransitSpan& WithGeometryOffset(int value) {
  ...
  template <typename NamesT = Aws::Vector<LocalizedString>>
  RouteTransitSpan& WithNames(NamesT&& value) {
    SetNames(std::forward<NamesT>(value));
    return *this;
  }
  template <typename NamesT = LocalizedString>
  RouteTransitSpan& AddNames(NamesT&& value) {
    m_namesHasBeenSet = true;
  ...
  template <typename RegionT = Aws::String>
  RouteTransitSpan& WithRegion(RegionT&& value) {
