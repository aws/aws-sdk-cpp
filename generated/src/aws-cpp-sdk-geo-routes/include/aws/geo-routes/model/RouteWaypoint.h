...
class RouteWaypoint {
 public:
  ...
  inline RouteWaypoint& WithAvoidActionsForDistance(long long value) {
  ...
  inline void SetAvoidUTurns(bool value) {
    m_avoidUTurnsHasBeenSet = true;
    m_avoidUTurns = value;
  }
  inline RouteWaypoint& WithAvoidUTurns(bool value) {
    SetAvoidUTurns(value);
    return *this;
  }
  ///@}
  ...
  inline RouteWaypoint& WithHeading(double value) {
    SetHeading(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPassThrough(bool value) {
    m_passThroughHasBeenSet = true;
    m_passThrough = value;
  }
  inline RouteWaypoint& WithPassThrough(bool value) {
  ...
  inline RouteWaypoint& AddPosition(double value) {
    m_positionHasBeenSet = true;
  ...
  inline void SetStopDuration(long long value) {
    m_stopDurationHasBeenSet = true;
    m_stopDuration = value;
  }
  inline RouteWaypoint& WithStopDuration(long long value) {
