...
class RouteRoundaboutPassStepDetails {
 public:
  ...
  template <typename IntersectionT = Aws::Vector<LocalizedString>>
  RouteRoundaboutPassStepDetails& WithIntersection(IntersectionT&& value) {
    SetIntersection(std::forward<IntersectionT>(value));
    return *this;
  }
  template <typename IntersectionT = LocalizedString>
  RouteRoundaboutPassStepDetails& AddIntersection(IntersectionT&& value) {
    m_intersectionHasBeenSet = true;
  ...
  inline RouteRoundaboutPassStepDetails& WithSteeringDirection(RouteSteeringDirection value) {
  ...
  inline RouteRoundaboutPassStepDetails& WithTurnAngle(double value) {
    SetTurnAngle(value);
    return *this;
  }
  ///@}
  ...
  inline RouteRoundaboutPassStepDetails& WithTurnIntensity(RouteTurnIntensity value) {
