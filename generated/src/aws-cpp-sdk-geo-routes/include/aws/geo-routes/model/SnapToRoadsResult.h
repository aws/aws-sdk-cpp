...
class SnapToRoadsResult {
 public:
  ...
  void SetSnappedGeometry(SnappedGeometryT&& value) {
    ...
    m_snappedGeometry = std::forward<SnappedGeometryT>(value);
  }
  template <typename SnappedGeometryT = RoadSnapSnappedGeometry>
  SnapToRoadsResult& WithSnappedGeometry(SnappedGeometryT&& value) {
    SetSnappedGeometry(std::forward<SnappedGeometryT>(value));
    return *this;
  }
  ///@}
  ...
  inline SnapToRoadsResult& WithSnappedGeometryFormat(GeometryFormat value) {
  ...
  void SetSnappedTracePoints(SnappedTracePointsT&& value) {
    ...
    m_snappedTracePoints = std::forward<SnappedTracePointsT>(value);
  }
  template <typename SnappedTracePointsT = Aws::Vector<RoadSnapSnappedTracePoint>>
  SnapToRoadsResult& WithSnappedTracePoints(SnappedTracePointsT&& value) {
    SetSnappedTracePoints(std::forward<SnappedTracePointsT>(value));
    return *this;
  }
  ...
  SnapToRoadsResult& AddSnappedTracePoints(SnappedTracePointsT&& value) {
    m_snappedTracePointsHasBeenSet = true;
    m_snappedTracePoints.emplace_back(std::forward<SnappedTracePointsT>(value));
    return *this;
  }
  ///@}
