...
class RouteRoundaboutEnterStepDetails {
 public:
  ...
  template <typename IntersectionT = Aws::Vector<LocalizedString>>
  RouteRoundaboutEnterStepDetails& WithIntersection(IntersectionT&& value) {
    SetIntersection(std::forward<IntersectionT>(value));
    return *this;
  }
  template <typename IntersectionT = LocalizedString>
  RouteRoundaboutEnterStepDetails& AddIntersection(IntersectionT&& value) {
    m_intersectionHasBeenSet = true;
  ...
  inline RouteRoundaboutEnterStepDetails& WithSteeringDirection(RouteSteeringDirection value) {
  ...
  inline RouteRoundaboutEnterStepDetails& WithTurnAngle(double value) {
    SetTurnAngle(value);
    return *this;
  }
  ///@}
  ...
  inline RouteRoundaboutEnterStepDetails& WithTurnIntensity(RouteTurnIntensity value) {
