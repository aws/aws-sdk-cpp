...
namespace Model
{
  ...
  /**
   * <p>Options related to the car.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/geo-routes-2020-11-19/RouteMatrixCarOptions">AWS
   * API Reference</a></p>
   */
  ...
  public:
    ...
    inline RouteMatrixCarOptions& WithLicensePlate(const RouteMatrixVehicleLicensePlate& value) { SetLicensePlate(value); return *this;}
    inline RouteMatrixCarOptions& WithLicensePlate(RouteMatrixVehicleLicensePlate&& value) { SetLicensePlate(std::move(value)); return *this;}
    ///@}
    ...
    inline RouteMatrixCarOptions& WithMaxSpeed(double value) { SetMaxSpeed(value); return *this;}
    ///@}
    ...
    inline RouteMatrixCarOptions& WithOccupancy(int value) { SetOccupancy(value); return *this;}
    ///@}
  private:
