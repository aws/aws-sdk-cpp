...
class WaypointOptimizationOptimizedWaypoint {
 public:
  ...
  inline void SetClusterIndex(int value) {
    m_clusterIndexHasBeenSet = true;
    m_clusterIndex = value;
  }
  inline WaypointOptimizationOptimizedWaypoint& WithClusterIndex(int value) {
  ...
  inline WaypointOptimizationOptimizedWaypoint& AddPosition(double value) {
    m_positionHasBeenSet = true;
