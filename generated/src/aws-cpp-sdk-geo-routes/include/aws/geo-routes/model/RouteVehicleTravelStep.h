...
class RouteVehicleTravelStep {
 public:
  ...
  void SetContinueHighwayStepDetails(ContinueHighwayStepDetailsT&& value) {
    ...
    m_continueHighwayStepDetails = std::forward<ContinueHighwayStepDetailsT>(value);
  }
  template <typename ContinueHighwayStepDetailsT = RouteContinueHighwayStepDetails>
  RouteVehicleTravelStep& WithContinueHighwayStepDetails(ContinueHighwayStepDetailsT&& value) {
    SetContinueHighwayStepDetails(std::forward<ContinueHighwayStepDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCurrentRoad(CurrentRoadT&& value) {
    ...
    m_currentRoad = std::forward<CurrentRoadT>(value);
  }
  template <typename CurrentRoadT = RouteRoad>
  RouteVehicleTravelStep& WithCurrentRoad(CurrentRoadT&& value) {
    SetCurrentRoad(std::forward<CurrentRoadT>(value));
    return *this;
  }
  ///@}
  ...
  inline RouteVehicleTravelStep& WithDistance(long long value) {
    SetDistance(value);
    return *this;
  }
  ///@}
  ...
  inline RouteVehicleTravelStep& WithDuration(long long value) {
    SetDuration(value);
    return *this;
  }
  ///@}
  ...
  void SetEnterHighwayStepDetails(EnterHighwayStepDetailsT&& value) {
    ...
    m_enterHighwayStepDetails = std::forward<EnterHighwayStepDetailsT>(value);
  }
  template <typename EnterHighwayStepDetailsT = RouteEnterHighwayStepDetails>
  RouteVehicleTravelStep& WithEnterHighwayStepDetails(EnterHighwayStepDetailsT&& value) {
    SetEnterHighwayStepDetails(std::forward<EnterHighwayStepDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  inline RouteVehicleTravelStep& WithGeometryOffset(int value) {
  ...
  void SetNextRoad(NextRoadT&& value) {
    ...
    m_nextRoad = std::forward<NextRoadT>(value);
  }
  template <typename NextRoadT = RouteRoad>
  RouteVehicleTravelStep& WithNextRoad(NextRoadT&& value) {
    SetNextRoad(std::forward<NextRoadT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSignpost(SignpostT&& value) {
    ...
    m_signpost = std::forward<SignpostT>(value);
  }
  template <typename SignpostT = RouteSignpost>
  RouteVehicleTravelStep& WithSignpost(SignpostT&& value) {
    SetSignpost(std::forward<SignpostT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetType(RouteVehicleTravelStepType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline RouteVehicleTravelStep& WithType(RouteVehicleTravelStepType value) {
    SetType(value);
    return *this;
  }
  ///@}
