...
class WaypointOptimizationRestCycles {
 public:
  ...
  void SetLongCycle(LongCycleT&& value) {
    ...
    m_longCycle = std::forward<LongCycleT>(value);
  }
  template <typename LongCycleT = WaypointOptimizationRestCycleDurations>
  WaypointOptimizationRestCycles& WithLongCycle(LongCycleT&& value) {
    SetLongCycle(std::forward<LongCycleT>(value));
    return *this;
  }
  ///@}
  ...
  void SetShortCycle(ShortCycleT&& value) {
    ...
    m_shortCycle = std::forward<ShortCycleT>(value);
  }
  template <typename ShortCycleT = WaypointOptimizationRestCycleDurations>
  WaypointOptimizationRestCycles& WithShortCycle(ShortCycleT&& value) {
    SetShortCycle(std::forward<ShortCycleT>(value));
    return *this;
  }
  ///@}
 private:
