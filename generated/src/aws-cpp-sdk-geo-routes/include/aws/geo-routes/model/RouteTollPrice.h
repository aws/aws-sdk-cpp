...
class RouteTollPrice {
 public:
  ...
  inline RouteTollPrice& WithEstimate(bool value) {
    SetEstimate(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPerDuration(long long value) {
    m_perDurationHasBeenSet = true;
    m_perDuration = value;
  }
  inline RouteTollPrice& WithPerDuration(long long value) {
    SetPerDuration(value);
    return *this;
  }
  ///@}
  ...
  inline RouteTollPrice& WithRange(bool value) {
    SetRange(value);
    return *this;
  }
  ///@}
  ...
  inline RouteTollPrice& WithValue(double value) {
    SetValue(value);
    return *this;
  }
  ///@}
