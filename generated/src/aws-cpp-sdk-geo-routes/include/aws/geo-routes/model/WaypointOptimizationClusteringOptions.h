...
class WaypointOptimizationClusteringOptions {
 public:
  ...
  inline void SetAlgorithm(WaypointOptimizationClusteringAlgorithm value) {
    m_algorithmHasBeenSet = true;
    m_algorithm = value;
  }
  inline WaypointOptimizationClusteringOptions& WithAlgorithm(WaypointOptimizationClusteringAlgorithm value) {
    SetAlgorithm(value);
    return *this;
  }
  ///@}
  ...
  void SetDrivingDistanceOptions(DrivingDistanceOptionsT&& value) {
    ...
    m_drivingDistanceOptions = std::forward<DrivingDistanceOptionsT>(value);
  }
  template <typename DrivingDistanceOptionsT = WaypointOptimizationDrivingDistanceOptions>
  WaypointOptimizationClusteringOptions& WithDrivingDistanceOptions(DrivingDistanceOptionsT&& value) {
    SetDrivingDistanceOptions(std::forward<DrivingDistanceOptionsT>(value));
    return *this;
  }
  ///@}
 private:
