...
class RouteNumber {
 public:
  ...
  inline void SetDirection(RouteDirection value) {
    m_directionHasBeenSet = true;
    m_direction = value;
  }
  inline RouteNumber& WithDirection(RouteDirection value) {
    SetDirection(value);
    return *this;
  }
  ///@}
  ...
  template <typename LanguageT = Aws::String>
  RouteNumber& WithLanguage(LanguageT&& value) {
  ...
  template <typename ValueT = Aws::String>
  RouteNumber& WithValue(ValueT&& value) {
