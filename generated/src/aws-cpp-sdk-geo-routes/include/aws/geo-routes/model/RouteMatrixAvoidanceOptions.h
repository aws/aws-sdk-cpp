...
class RouteMatrixAvoidanceOptions {
 public:
  ...
  inline RouteMatrixAvoidanceOptions& WithCarShuttleTrains(bool value) {
  ...
  inline RouteMatrixAvoidanceOptions& WithControlledAccessHighways(bool value) {
  ...
  inline RouteMatrixAvoidanceOptions& WithDirtRoads(bool value) {
    SetDirtRoads(value);
    return *this;
  }
  ///@}
  ...
  inline RouteMatrixAvoidanceOptions& WithFerries(bool value) {
    SetFerries(value);
    return *this;
  }
  ///@}
  ...
  inline RouteMatrixAvoidanceOptions& WithTollRoads(bool value) {
    SetTollRoads(value);
    return *this;
  }
  ///@}
  ...
  inline RouteMatrixAvoidanceOptions& WithTollTransponders(bool value) {
  ...
  inline RouteMatrixAvoidanceOptions& WithTunnels(bool value) {
    SetTunnels(value);
    return *this;
  }
  ///@}
  ...
  inline RouteMatrixAvoidanceOptions& WithUTurns(bool value) {
    SetUTurns(value);
    return *this;
  }
  ///@}
