 ...
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/geo-routes-2020-11-19/RouteTaxiPlace">AWS
 * API Reference</a></p>
 */
class RouteTaxiPlace {
 public:
  ...
  inline RouteTaxiPlace& AddOriginalPosition(double value) {
    m_originalPositionHasBeenSet = true;
  ...
  inline RouteTaxiPlace& AddPosition(double value) {
    m_positionHasBeenSet = true;
   ...
   */
  inline RouteTaxiPlaceType GetType() const { return m_type; }
  inline bool TypeHasBeenSet() const { return m_typeHasBeenSet; }
  inline void SetType(RouteTaxiPlaceType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline RouteTaxiPlace& WithType(RouteTaxiPlaceType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline RouteTaxiPlace& WithWaypointIndex(int value) {
 ...
 private:
  ...
  RouteTaxiPlaceType m_type{RouteTaxiPlaceType::NOT_SET};
