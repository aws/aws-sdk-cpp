...
class RouteViolatedConstraints {
 public:
  ...
  void SetAxleCount(AxleCountT&& value) {
    ...
    m_axleCount = std::forward<AxleCountT>(value);
  }
  template <typename AxleCountT = RouteNoticeDetailRange>
  RouteViolatedConstraints& WithAxleCount(AxleCountT&& value) {
    SetAxleCount(std::forward<AxleCountT>(value));
    return *this;
  }
  ///@}
  ...
  inline RouteViolatedConstraints& AddHazardousCargos(RouteHazardousCargoType value) {
    m_hazardousCargosHasBeenSet = true;
  ...
  inline void SetMaxHeight(long long value) {
    m_maxHeightHasBeenSet = true;
    m_maxHeight = value;
  }
  inline RouteViolatedConstraints& WithMaxHeight(long long value) {
    SetMaxHeight(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxKpraLength(long long value) {
    m_maxKpraLengthHasBeenSet = true;
    m_maxKpraLength = value;
  }
  inline RouteViolatedConstraints& WithMaxKpraLength(long long value) {
    SetMaxKpraLength(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxLength(long long value) {
    m_maxLengthHasBeenSet = true;
    m_maxLength = value;
  }
  inline RouteViolatedConstraints& WithMaxLength(long long value) {
    SetMaxLength(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxPayloadCapacity(long long value) {
    m_maxPayloadCapacityHasBeenSet = true;
    m_maxPayloadCapacity = value;
  }
  inline RouteViolatedConstraints& WithMaxPayloadCapacity(long long value) {
    SetMaxPayloadCapacity(value);
    return *this;
  }
  ///@}
  ...
  void SetMaxWeight(MaxWeightT&& value) {
    ...
    m_maxWeight = std::forward<MaxWeightT>(value);
  }
  template <typename MaxWeightT = RouteWeightConstraint>
  RouteViolatedConstraints& WithMaxWeight(MaxWeightT&& value) {
    SetMaxWeight(std::forward<MaxWeightT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetMaxWeightPerAxle(long long value) {
    m_maxWeightPerAxleHasBeenSet = true;
    m_maxWeightPerAxle = value;
  }
  inline RouteViolatedConstraints& WithMaxWeightPerAxle(long long value) {
    SetMaxWeightPerAxle(value);
    return *this;
  }
  ///@}
  ...
  void SetMaxWeightPerAxleGroup(MaxWeightPerAxleGroupT&& value) {
    ...
    m_maxWeightPerAxleGroup = std::forward<MaxWeightPerAxleGroupT>(value);
  }
  template <typename MaxWeightPerAxleGroupT = WeightPerAxleGroup>
  RouteViolatedConstraints& WithMaxWeightPerAxleGroup(MaxWeightPerAxleGroupT&& value) {
    SetMaxWeightPerAxleGroup(std::forward<MaxWeightPerAxleGroupT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetMaxWidth(long long value) {
    m_maxWidthHasBeenSet = true;
    m_maxWidth = value;
  }
  inline RouteViolatedConstraints& WithMaxWidth(long long value) {
    SetMaxWidth(value);
    return *this;
  }
  ///@}
  ...
  void SetOccupancy(OccupancyT&& value) {
    ...
    m_occupancy = std::forward<OccupancyT>(value);
  }
  template <typename OccupancyT = RouteNoticeDetailRange>
  RouteViolatedConstraints& WithOccupancy(OccupancyT&& value) {
    SetOccupancy(std::forward<OccupancyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRestrictedTimes(RestrictedTimesT&& value) {
    ...
    m_restrictedTimes = std::forward<RestrictedTimesT>(value);
  }
  template <typename RestrictedTimesT = Aws::String>
  RouteViolatedConstraints& WithRestrictedTimes(RestrictedTimesT&& value) {
    SetRestrictedTimes(std::forward<RestrictedTimesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTimeDependent(bool value) {
    m_timeDependentHasBeenSet = true;
    m_timeDependent = value;
  }
  inline RouteViolatedConstraints& WithTimeDependent(bool value) {
    SetTimeDependent(value);
    return *this;
  }
  ///@}
  ...
  void SetTrailerCount(TrailerCountT&& value) {
    ...
    m_trailerCount = std::forward<TrailerCountT>(value);
  }
  template <typename TrailerCountT = RouteNoticeDetailRange>
  RouteViolatedConstraints& WithTrailerCount(TrailerCountT&& value) {
    SetTrailerCount(std::forward<TrailerCountT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTravelMode(bool value) {
    m_travelModeHasBeenSet = true;
    m_travelMode = value;
  }
  inline RouteViolatedConstraints& WithTravelMode(bool value) {
    SetTravelMode(value);
    return *this;
  }
  ///@}
  ...
  void SetTruckRoadType(TruckRoadTypeT&& value) {
    ...
    m_truckRoadType = std::forward<TruckRoadTypeT>(value);
  }
  template <typename TruckRoadTypeT = Aws::String>
  RouteViolatedConstraints& WithTruckRoadType(TruckRoadTypeT&& value) {
    SetTruckRoadType(std::forward<TruckRoadTypeT>(value));
    return *this;
  }
  ///@}
  ...
  inline RouteViolatedConstraints& WithTruckType(RouteTruckType value) {
    SetTruckType(value);
    return *this;
  }
  ///@}
