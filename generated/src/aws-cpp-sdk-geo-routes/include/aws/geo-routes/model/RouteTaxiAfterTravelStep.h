 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/geo-routes-2020-11-19/RouteTaxiAfterTravelStep">AWS
 * API Reference</a></p>
 */
class RouteTaxiAfterTravelStep {
 public:
  ...
  inline RouteTaxiAfterTravelStep& WithDuration(long long value) {
    SetDuration(value);
    return *this;
  }
  ///@}
   ...
   */
  inline RouteTaxiAfterTravelStepType GetType() const { return m_type; }
  inline bool TypeHasBeenSet() const { return m_typeHasBeenSet; }
  inline void SetType(RouteTaxiAfterTravelStepType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline RouteTaxiAfterTravelStep& WithType(RouteTaxiAfterTravelStepType value) {
    SetType(value);
    return *this;
  }
  ///@}
 private:
  ...
  RouteTaxiAfterTravelStepType m_type{RouteTaxiAfterTravelStepType::NOT_SET};
