...
class RouteMatrixMatchingOptions {
 public:
  ...
  template <typename NameHintT = Aws::String>
  RouteMatrixMatchingOptions& WithNameHint(NameHintT&& value) {
  ...
  inline RouteMatrixMatchingOptions& WithOnRoadThreshold(long long value) {
  ...
  inline RouteMatrixMatchingOptions& WithRadius(long long value) {
    SetRadius(value);
    return *this;
  }
  ///@}
  ...
  inline RouteMatrixMatchingOptions& WithStrategy(MatchingStrategy value) {
    SetStrategy(value);
    return *this;
  }
  ///@}
