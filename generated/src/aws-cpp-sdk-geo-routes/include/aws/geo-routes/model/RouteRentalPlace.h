 ...
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/geo-routes-2020-11-19/RouteRentalPlace">AWS
 * API Reference</a></p>
 */
class RouteRentalPlace {
 public:
  ...
  inline RouteRentalPlace& AddOriginalPosition(double value) {
    m_originalPositionHasBeenSet = true;
  ...
  inline RouteRentalPlace& AddPosition(double value) {
    m_positionHasBeenSet = true;
   ...
   */
  inline RouteRentalPlaceType GetType() const { return m_type; }
  inline bool TypeHasBeenSet() const { return m_typeHasBeenSet; }
  inline void SetType(RouteRentalPlaceType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline RouteRentalPlace& WithType(RouteRentalPlaceType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline RouteRentalPlace& WithWaypointIndex(int value) {
 ...
 private:
  ...
  RouteRentalPlaceType m_type{RouteRentalPlaceType::NOT_SET};
