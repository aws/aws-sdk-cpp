...
class RouteTurnStepDetails {
 public:
  ...
  template <typename IntersectionT = Aws::Vector<LocalizedString>>
  RouteTurnStepDetails& WithIntersection(IntersectionT&& value) {
    SetIntersection(std::forward<IntersectionT>(value));
    return *this;
  }
  template <typename IntersectionT = LocalizedString>
  RouteTurnStepDetails& AddIntersection(IntersectionT&& value) {
    m_intersectionHasBeenSet = true;
  ...
  inline RouteTurnStepDetails& WithSteeringDirection(RouteSteeringDirection value) {
  ...
  inline RouteTurnStepDetails& WithTurnAngle(double value) {
    SetTurnAngle(value);
    return *this;
  }
  ///@}
  ...
  inline RouteTurnStepDetails& WithTurnIntensity(RouteTurnIntensity value) {
