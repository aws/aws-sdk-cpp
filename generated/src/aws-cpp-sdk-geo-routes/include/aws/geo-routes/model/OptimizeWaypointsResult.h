...
class OptimizeWaypointsResult {
 public:
  ...
  inline OptimizeWaypointsResult& WithDistance(long long value) {
    SetDistance(value);
    return *this;
  }
  ///@}
  ...
  inline OptimizeWaypointsResult& WithDuration(long long value) {
    SetDuration(value);
    return *this;
  }
  ///@}
  ...
  void SetImpedingWaypoints(ImpedingWaypointsT&& value) {
    ...
    m_impedingWaypoints = std::forward<ImpedingWaypointsT>(value);
  }
  template <typename ImpedingWaypointsT = Aws::Vector<WaypointOptimizationImpedingWaypoint>>
  OptimizeWaypointsResult& WithImpedingWaypoints(ImpedingWaypointsT&& value) {
    SetImpedingWaypoints(std::forward<ImpedingWaypointsT>(value));
    return *this;
  }
  ...
  OptimizeWaypointsResult& AddImpedingWaypoints(ImpedingWaypointsT&& value) {
    m_impedingWaypointsHasBeenSet = true;
    m_impedingWaypoints.emplace_back(std::forward<ImpedingWaypointsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOptimizedWaypoints(OptimizedWaypointsT&& value) {
    ...
    m_optimizedWaypoints = std::forward<OptimizedWaypointsT>(value);
  }
  template <typename OptimizedWaypointsT = Aws::Vector<WaypointOptimizationOptimizedWaypoint>>
  OptimizeWaypointsResult& WithOptimizedWaypoints(OptimizedWaypointsT&& value) {
    SetOptimizedWaypoints(std::forward<OptimizedWaypointsT>(value));
    return *this;
  }
  ...
  OptimizeWaypointsResult& AddOptimizedWaypoints(OptimizedWaypointsT&& value) {
    m_optimizedWaypointsHasBeenSet = true;
    m_optimizedWaypoints.emplace_back(std::forward<OptimizedWaypointsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTimeBreakdown(TimeBreakdownT&& value) {
    ...
    m_timeBreakdown = std::forward<TimeBreakdownT>(value);
  }
  template <typename TimeBreakdownT = WaypointOptimizationTimeBreakdown>
  OptimizeWaypointsResult& WithTimeBreakdown(TimeBreakdownT&& value) {
    SetTimeBreakdown(std::forward<TimeBreakdownT>(value));
    return *this;
  }
  ///@}
