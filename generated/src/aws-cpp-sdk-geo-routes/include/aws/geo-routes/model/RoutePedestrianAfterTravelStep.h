 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/geo-routes-2020-11-19/RoutePedestrianAfterTravelStep">AWS
 * API Reference</a></p>
 */
class RoutePedestrianAfterTravelStep {
 public:
  ...
  inline RoutePedestrianAfterTravelStep& WithDuration(long long value) {
    SetDuration(value);
    return *this;
  }
  ///@}
   ...
   */
  inline RoutePedestrianAfterTravelStepType GetType() const { return m_type; }
  inline bool TypeHasBeenSet() const { return m_typeHasBeenSet; }
  inline void SetType(RoutePedestrianAfterTravelStepType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline RoutePedestrianAfterTravelStep& WithType(RoutePedestrianAfterTravelStepType value) {
    SetType(value);
    return *this;
  }
  ///@}
 private:
  ...
  RoutePedestrianAfterTravelStepType m_type{RoutePedestrianAfterTravelStepType::NOT_SET};
