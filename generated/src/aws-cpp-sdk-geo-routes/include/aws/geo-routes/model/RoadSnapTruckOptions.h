...
class RoadSnapTruckOptions {
 public:
  ...
  inline RoadSnapTruckOptions& WithGrossWeight(long long value) {
  ...
  inline RoadSnapTruckOptions& AddHazardousCargos(RoadSnapHazardousCargoType value) {
    m_hazardousCargosHasBeenSet = true;
  ...
  inline RoadSnapTruckOptions& WithHeight(long long value) {
    SetHeight(value);
    return *this;
  }
  ///@}
  ...
  inline RoadSnapTruckOptions& WithLength(long long value) {
    SetLength(value);
    return *this;
  }
  ///@}
  ...
  inline RoadSnapTruckOptions& WithWidth(long long value) {
    SetWidth(value);
    return *this;
  }
  ///@}
