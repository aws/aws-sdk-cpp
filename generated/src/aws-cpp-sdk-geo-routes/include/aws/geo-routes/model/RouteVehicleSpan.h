...
class RouteVehicleSpan {
 public:
  ...
  inline RouteVehicleSpan& WithBestCaseDuration(long long value) {
  ...
  void SetCarAccess(CarAccessT&& value) {
    ...
    m_carAccess = std::forward<CarAccessT>(value);
  }
  template <typename CarAccessT = Aws::Vector<RouteSpanCarAccessAttribute>>
  RouteVehicleSpan& WithCarAccess(CarAccessT&& value) {
    SetCarAccess(std::forward<CarAccessT>(value));
    return *this;
  }
  inline RouteVehicleSpan& AddCarAccess(RouteSpanCarAccessAttribute value) {
    m_carAccessHasBeenSet = true;
    m_carAccess.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline RouteVehicleSpan& WithDistance(long long value) {
    SetDistance(value);
    return *this;
  }
  ///@}
  ...
  inline RouteVehicleSpan& WithDuration(long long value) {
    SetDuration(value);
    return *this;
  }
  ///@}
  ...
  void SetDynamicSpeed(DynamicSpeedT&& value) {
    ...
    m_dynamicSpeed = std::forward<DynamicSpeedT>(value);
  }
  template <typename DynamicSpeedT = RouteSpanDynamicSpeedDetails>
  RouteVehicleSpan& WithDynamicSpeed(DynamicSpeedT&& value) {
    SetDynamicSpeed(std::forward<DynamicSpeedT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetFunctionalClassification(int value) {
    m_functionalClassificationHasBeenSet = true;
    m_functionalClassification = value;
  }
  inline RouteVehicleSpan& WithFunctionalClassification(int value) {
    SetFunctionalClassification(value);
    return *this;
  }
  ///@}
  ...
  inline void SetGate(RouteSpanGateAttribute value) {
    m_gateHasBeenSet = true;
    m_gate = value;
  }
  inline RouteVehicleSpan& WithGate(RouteSpanGateAttribute value) {
    SetGate(value);
    return *this;
  }
  ///@}
  ...
  inline RouteVehicleSpan& WithGeometryOffset(int value) {
  ...
  inline RouteVehicleSpan& AddIncidents(int value) {
    m_incidentsHasBeenSet = true;
    m_incidents.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline RouteVehicleSpan& AddNotices(int value) {
    m_noticesHasBeenSet = true;
    m_notices.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRailwayCrossing(RouteSpanRailwayCrossingAttribute value) {
    m_railwayCrossingHasBeenSet = true;
    m_railwayCrossing = value;
  }
  inline RouteVehicleSpan& WithRailwayCrossing(RouteSpanRailwayCrossingAttribute value) {
    SetRailwayCrossing(value);
    return *this;
  }
  ///@}
  ...
  void SetRoadAttributes(RoadAttributesT&& value) {
    ...
    m_roadAttributes = std::forward<RoadAttributesT>(value);
  }
  template <typename RoadAttributesT = Aws::Vector<RouteSpanRoadAttribute>>
  RouteVehicleSpan& WithRoadAttributes(RoadAttributesT&& value) {
    SetRoadAttributes(std::forward<RoadAttributesT>(value));
    return *this;
  }
  inline RouteVehicleSpan& AddRoadAttributes(RouteSpanRoadAttribute value) {
    m_roadAttributesHasBeenSet = true;
    m_roadAttributes.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetRouteNumbers(RouteNumbersT&& value) {
    ...
    m_routeNumbers = std::forward<RouteNumbersT>(value);
  }
  template <typename RouteNumbersT = Aws::Vector<RouteNumber>>
  RouteVehicleSpan& WithRouteNumbers(RouteNumbersT&& value) {
    SetRouteNumbers(std::forward<RouteNumbersT>(value));
    return *this;
  }
  template <typename RouteNumbersT = RouteNumber>
  RouteVehicleSpan& AddRouteNumbers(RouteNumbersT&& value) {
    m_routeNumbersHasBeenSet = true;
    m_routeNumbers.emplace_back(std::forward<RouteNumbersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetScooterAccess(ScooterAccessT&& value) {
    ...
    m_scooterAccess = std::forward<ScooterAccessT>(value);
  }
  template <typename ScooterAccessT = Aws::Vector<RouteSpanScooterAccessAttribute>>
  RouteVehicleSpan& WithScooterAccess(ScooterAccessT&& value) {
    SetScooterAccess(std::forward<ScooterAccessT>(value));
    return *this;
  }
  inline RouteVehicleSpan& AddScooterAccess(RouteSpanScooterAccessAttribute value) {
    m_scooterAccessHasBeenSet = true;
    m_scooterAccess.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetSpeedLimit(SpeedLimitT&& value) {
    ...
    m_speedLimit = std::forward<SpeedLimitT>(value);
  }
  template <typename SpeedLimitT = RouteSpanSpeedLimitDetails>
  RouteVehicleSpan& WithSpeedLimit(SpeedLimitT&& value) {
    SetSpeedLimit(std::forward<SpeedLimitT>(value));
    return *this;
  }
  ///@}
  ...
  inline RouteVehicleSpan& AddTollSystems(int value) {
    m_tollSystemsHasBeenSet = true;
    m_tollSystems.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetTruckAccess(TruckAccessT&& value) {
    ...
    m_truckAccess = std::forward<TruckAccessT>(value);
  }
  template <typename TruckAccessT = Aws::Vector<RouteSpanTruckAccessAttribute>>
  RouteVehicleSpan& WithTruckAccess(TruckAccessT&& value) {
    SetTruckAccess(std::forward<TruckAccessT>(value));
    return *this;
  }
  inline RouteVehicleSpan& AddTruckAccess(RouteSpanTruckAccessAttribute value) {
    m_truckAccessHasBeenSet = true;
    m_truckAccess.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline RouteVehicleSpan& AddTruckRoadTypes(int value) {
    m_truckRoadTypesHasBeenSet = true;
    m_truckRoadTypes.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline RouteVehicleSpan& WithTypicalDuration(long long value) {
  ...
  inline RouteVehicleSpan& AddZones(int value) {
    m_zonesHasBeenSet = true;
    m_zones.push_back(value);
    return *this;
  }
  ///@}
 private:
