...
class WaypointOptimizationWaypoint {
 public:
  ...
  void SetAccessHours(AccessHoursT&& value) {
    ...
    m_accessHours = std::forward<AccessHoursT>(value);
  }
  template <typename AccessHoursT = WaypointOptimizationAccessHours>
  WaypointOptimizationWaypoint& WithAccessHours(AccessHoursT&& value) {
    SetAccessHours(std::forward<AccessHoursT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAppointmentTime(AppointmentTimeT&& value) {
    ...
    m_appointmentTime = std::forward<AppointmentTimeT>(value);
  }
  template <typename AppointmentTimeT = Aws::String>
  WaypointOptimizationWaypoint& WithAppointmentTime(AppointmentTimeT&& value) {
    SetAppointmentTime(std::forward<AppointmentTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBefore(BeforeT&& value) {
    ...
    m_before = std::forward<BeforeT>(value);
  }
  template <typename BeforeT = Aws::Vector<int>>
  WaypointOptimizationWaypoint& WithBefore(BeforeT&& value) {
    SetBefore(std::forward<BeforeT>(value));
    return *this;
  }
  inline WaypointOptimizationWaypoint& AddBefore(int value) {
    m_beforeHasBeenSet = true;
    m_before.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline WaypointOptimizationWaypoint& WithHeading(double value) {
    SetHeading(value);
    return *this;
  }
  ///@}
  ...
  inline WaypointOptimizationWaypoint& AddPosition(double value) {
    m_positionHasBeenSet = true;
  ...
  inline void SetServiceDuration(long long value) {
    m_serviceDurationHasBeenSet = true;
    m_serviceDuration = value;
  }
  inline WaypointOptimizationWaypoint& WithServiceDuration(long long value) {
