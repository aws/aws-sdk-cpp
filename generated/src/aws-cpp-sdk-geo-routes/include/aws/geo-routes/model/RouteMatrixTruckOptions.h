...
class RouteMatrixTruckOptions {
 public:
  ...
  inline RouteMatrixTruckOptions& WithAxleCount(int value) {
    SetAxleCount(value);
    return *this;
  }
  ///@}
  ...
  inline RouteMatrixTruckOptions& WithGrossWeight(long long value) {
  ...
  inline RouteMatrixTruckOptions& AddHazardousCargos(RouteMatrixHazardousCargoType value) {
    m_hazardousCargosHasBeenSet = true;
  ...
  inline RouteMatrixTruckOptions& WithHeight(long long value) {
    SetHeight(value);
    return *this;
  }
  ///@}
  ...
  inline RouteMatrixTruckOptions& WithKpraLength(long long value) {
    SetKpraLength(value);
    return *this;
  }
  ///@}
  ...
  inline RouteMatrixTruckOptions& WithLength(long long value) {
    SetLength(value);
    return *this;
  }
  ///@}
  ...
  inline RouteMatrixTruckOptions& WithMaxSpeed(double value) {
    SetMaxSpeed(value);
    return *this;
  }
  ///@}
  ...
  inline RouteMatrixTruckOptions& WithOccupancy(int value) {
    SetOccupancy(value);
    return *this;
  }
  ///@}
  ...
  inline RouteMatrixTruckOptions& WithPayloadCapacity(long long value) {
  ...
  inline void SetTruckType(RouteMatrixTruckType value) {
    m_truckTypeHasBeenSet = true;
    m_truckType = value;
  }
  inline RouteMatrixTruckOptions& WithTruckType(RouteMatrixTruckType value) {
    SetTruckType(value);
    return *this;
  }
  ///@}
  ...
  inline RouteMatrixTruckOptions& WithWeightPerAxle(long long value) {
  ...
  inline RouteMatrixTruckOptions& WithWidth(long long value) {
    SetWidth(value);
    return *this;
  }
  ///@}
