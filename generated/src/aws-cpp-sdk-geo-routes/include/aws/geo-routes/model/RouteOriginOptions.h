...
class RouteOriginOptions {
 public:
  ...
  inline RouteOriginOptions& WithAvoidActionsForDistance(long long value) {
  ...
  inline RouteOriginOptions& WithAvoidUTurns(bool value) {
  ...
  inline RouteOriginOptions& WithHeading(double value) {
    SetHeading(value);
    return *this;
  }
  ///@}
