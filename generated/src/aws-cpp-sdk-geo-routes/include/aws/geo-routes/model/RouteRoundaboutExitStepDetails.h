...
class RouteRoundaboutExitStepDetails {
 public:
  ...
  inline void SetRelativeExit(int value) {
    m_relativeExitHasBeenSet = true;
    m_relativeExit = value;
  }
  inline RouteRoundaboutExitStepDetails& WithRelativeExit(int value) {
    SetRelativeExit(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRoundaboutAngle(double value) {
    m_roundaboutAngleHasBeenSet = true;
    m_roundaboutAngle = value;
  }
  inline RouteRoundaboutExitStepDetails& WithRoundaboutAngle(double value) {
    SetRoundaboutAngle(value);
    return *this;
  }
  ///@}
  ...
  inline RouteRoundaboutExitStepDetails& WithSteeringDirection(RouteSteeringDirection value) {
