 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/geo-routes-2020-11-19/RouteTaxiTravelStep">AWS
 * API Reference</a></p>
 */
class RouteTaxiTravelStep {
 public:
  ...
  inline RouteTaxiTravelStep& WithDistance(long long value) {
    SetDistance(value);
    return *this;
  }
  ///@}
  ...
  inline RouteTaxiTravelStep& WithDuration(long long value) {
    SetDuration(value);
    return *this;
  }
  ///@}
  ...
  inline RouteTaxiTravelStep& WithGeometryOffset(int value) {
   ...
   */
  inline RouteTaxiTravelStepType GetType() const { return m_type; }
  inline bool TypeHasBeenSet() const { return m_typeHasBeenSet; }
  inline void SetType(RouteTaxiTravelStepType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline RouteTaxiTravelStep& WithType(RouteTaxiTravelStepType value) {
    SetType(value);
    return *this;
  }
  ///@}
 ...
 private:
  ...
  RouteTaxiTravelStepType m_type{RouteTaxiTravelStepType::NOT_SET};
