...
class CalculateRouteMatrixRequest : public GeoRoutesRequest {
 public:
  ...
  inline CalculateRouteMatrixRequest& WithOptimizeRoutingFor(RoutingObjective value) {
  ...
  inline void SetTravelMode(RouteMatrixTravelMode value) {
    m_travelModeHasBeenSet = true;
    m_travelMode = value;
  }
  inline CalculateRouteMatrixRequest& WithTravelMode(RouteMatrixTravelMode value) {
    SetTravelMode(value);
    return *this;
  }
  ///@}
