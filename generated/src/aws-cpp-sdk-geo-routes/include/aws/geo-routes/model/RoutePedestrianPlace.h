...
class RoutePedestrianPlace {
 public:
  ...
  inline RoutePedestrianPlace& AddOriginalPosition(double value) {
    m_originalPositionHasBeenSet = true;
  ...
  inline RoutePedestrianPlace& AddPosition(double value) {
    m_positionHasBeenSet = true;
  ...
  inline RoutePedestrianPlace& WithSideOfStreet(RouteSideOfStreet value) {
  ...
  inline RoutePedestrianPlace& WithWaypointIndex(int value) {
