...
class RouteToll {
 public:
  ...
  void SetPaymentSites(PaymentSitesT&& value) {
    ...
    m_paymentSites = std::forward<PaymentSitesT>(value);
  }
  template <typename PaymentSitesT = Aws::Vector<RouteTollPaymentSite>>
  RouteToll& WithPaymentSites(PaymentSitesT&& value) {
    SetPaymentSites(std::forward<PaymentSitesT>(value));
    return *this;
  }
  template <typename PaymentSitesT = RouteTollPaymentSite>
  RouteToll& AddPaymentSites(PaymentSitesT&& value) {
    m_paymentSitesHasBeenSet = true;
    m_paymentSites.emplace_back(std::forward<PaymentSitesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRates(RatesT&& value) {
    ...
    m_rates = std::forward<RatesT>(value);
  }
  template <typename RatesT = Aws::Vector<RouteTollRate>>
  RouteToll& WithRates(RatesT&& value) {
    SetRates(std::forward<RatesT>(value));
    return *this;
  }
  template <typename RatesT = RouteTollRate>
  RouteToll& AddRates(RatesT&& value) {
    m_ratesHasBeenSet = true;
    m_rates.emplace_back(std::forward<RatesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSystems(SystemsT&& value) {
    ...
    m_systems = std::forward<SystemsT>(value);
  }
  template <typename SystemsT = Aws::Vector<int>>
  RouteToll& WithSystems(SystemsT&& value) {
    SetSystems(std::forward<SystemsT>(value));
    return *this;
  }
  inline RouteToll& AddSystems(int value) {
    m_systemsHasBeenSet = true;
    m_systems.push_back(value);
    return *this;
  }
  ///@}
 private:
