...
class RouteRampStepDetails {
 public:
  ...
  inline void SetSteeringDirection(RouteSteeringDirection value) {
    m_steeringDirectionHasBeenSet = true;
    m_steeringDirection = value;
  }
  inline RouteRampStepDetails& WithSteeringDirection(RouteSteeringDirection value) {
  ...
  inline RouteRampStepDetails& WithTurnAngle(double value) {
    SetTurnAngle(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTurnIntensity(RouteTurnIntensity value) {
    m_turnIntensityHasBeenSet = true;
    m_turnIntensity = value;
  }
  inline RouteRampStepDetails& WithTurnIntensity(RouteTurnIntensity value) {
    SetTurnIntensity(value);
    return *this;
  }
  ///@}
 private:
