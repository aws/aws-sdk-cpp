...
class RouteMatrixEntry {
 public:
  ...
  inline RouteMatrixEntry& WithDistance(long long value) {
    SetDistance(value);
    return *this;
  }
  ///@}
  ...
  inline RouteMatrixEntry& WithDuration(long long value) {
    SetDuration(value);
    return *this;
  }
  ///@}
  ...
  inline void SetError(RouteMatrixErrorCode value) {
    m_errorHasBeenSet = true;
    m_error = value;
  }
  inline RouteMatrixEntry& WithError(RouteMatrixErrorCode value) {
    SetError(value);
    return *this;
  }
  ///@}
