...
class RouteTollPassValidityPeriod {
 public:
  ...
  inline void SetPeriod(RouteTollPassValidityPeriodType value) {
    m_periodHasBeenSet = true;
    m_period = value;
  }
  inline RouteTollPassValidityPeriod& WithPeriod(RouteTollPassValidityPeriodType value) {
    SetPeriod(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPeriodCount(int value) {
    m_periodCountHasBeenSet = true;
    m_periodCount = value;
  }
  inline RouteTollPassValidityPeriod& WithPeriodCount(int value) {
