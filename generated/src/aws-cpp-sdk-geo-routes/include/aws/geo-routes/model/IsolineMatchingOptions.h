...
namespace Model
{
  ...
  public:
    ...
    template<typename NameHintT = Aws::String>
    IsolineMatchingOptions& WithNameHint(NameHintT&& value) { SetNameHint(std::forward<NameHintT>(value)); return *this;}
    ///@}
    ...
    inline IsolineMatchingOptions& WithStrategy(MatchingStrategy value) { SetStrategy(value); return *this;}
    ///@}
  private:
