...
namespace Model
{
  ...
  public:
    ...
    inline IsolineMatchingOptions& WithNameHint(const Aws::String& value) { SetNameHint(value); return *this;}
    inline IsolineMatchingOptions& WithNameHint(Aws::String&& value) { SetNameHint(std::move(value)); return *this;}
    inline IsolineMatchingOptions& WithNameHint(const char* value) { SetNameHint(value); return *this;}
    ///@}
    ...
    inline IsolineMatchingOptions& WithOnRoadThreshold(long long value) { SetOnRoadThreshold(value); return *this;}
    ///@}
    ...
    inline IsolineMatchingOptions& WithRadius(long long value) { SetRadius(value); return *this;}
    ///@}
    ...
    inline IsolineMatchingOptions& WithStrategy(const MatchingStrategy& value) { SetStrategy(value); return *this;}
    inline IsolineMatchingOptions& WithStrategy(MatchingStrategy&& value) { SetStrategy(std::move(value)); return *this;}
    ///@}
  private:
