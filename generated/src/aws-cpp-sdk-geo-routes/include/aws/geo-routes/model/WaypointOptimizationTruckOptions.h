...
class WaypointOptimizationTruckOptions {
 public:
  ...
  inline WaypointOptimizationTruckOptions& WithGrossWeight(long long value) {
  ...
  inline WaypointOptimizationTruckOptions& AddHazardousCargos(WaypointOptimizationHazardousCargoType value) {
    m_hazardousCargosHasBeenSet = true;
  ...
  inline WaypointOptimizationTruckOptions& WithHeight(long long value) {
    SetHeight(value);
    return *this;
  }
  ///@}
  ...
  inline WaypointOptimizationTruckOptions& WithLength(long long value) {
    SetLength(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTruckType(WaypointOptimizationTruckType value) {
    m_truckTypeHasBeenSet = true;
    m_truckType = value;
  }
  inline WaypointOptimizationTruckOptions& WithTruckType(WaypointOptimizationTruckType value) {
    SetTruckType(value);
    return *this;
  }
  ///@}
  ...
  inline WaypointOptimizationTruckOptions& WithWeightPerAxle(long long value) {
  ...
  inline WaypointOptimizationTruckOptions& WithWidth(long long value) {
    SetWidth(value);
    return *this;
  }
  ///@}
