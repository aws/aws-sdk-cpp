...
namespace Model
{
  ...
  {
  public:
    AWS_GEOROUTES_API WaypointOptimizationExclusionOptions() = default;
    ...
    template<typename CountriesT = Aws::Vector<Aws::String>>
    WaypointOptimizationExclusionOptions& WithCountries(CountriesT&& value) { SetCountries(std::forward<CountriesT>(value)); return *this;}
    template<typename CountriesT = Aws::String>
    WaypointOptimizationExclusionOptions& AddCountries(CountriesT&& value) { m_countriesHasBeenSet = true; m_countries.emplace_back(std::forward<CountriesT>(value)); return *this; }
    ///@}
  private:
