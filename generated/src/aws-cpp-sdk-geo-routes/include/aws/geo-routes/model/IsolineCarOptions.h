...
namespace Model
{
  ...
  public:
    ...
    inline IsolineCarOptions& WithEngineType(IsolineEngineType value) { SetEngineType(value); return *this;}
    ///@}
    ...
    template<typename LicensePlateT = IsolineVehicleLicensePlate>
    IsolineCarOptions& WithLicensePlate(LicensePlateT&& value) { SetLicensePlate(std::forward<LicensePlateT>(value)); return *this;}
    ///@}
