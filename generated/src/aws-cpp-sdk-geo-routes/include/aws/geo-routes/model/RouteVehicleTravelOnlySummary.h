...
class RouteVehicleTravelOnlySummary {
 public:
  ...
  inline RouteVehicleTravelOnlySummary& WithBestCaseDuration(long long value) {
  ...
  inline RouteVehicleTravelOnlySummary& WithDuration(long long value) {
    SetDuration(value);
    return *this;
  }
  ///@}
  ...
  inline RouteVehicleTravelOnlySummary& WithTypicalDuration(long long value) {
