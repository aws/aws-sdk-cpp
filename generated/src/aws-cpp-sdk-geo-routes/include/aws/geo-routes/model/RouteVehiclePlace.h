...
class RouteVehiclePlace {
 public:
  ...
  inline RouteVehiclePlace& AddOriginalPosition(double value) {
    m_originalPositionHasBeenSet = true;
  ...
  inline RouteVehiclePlace& AddPosition(double value) {
    m_positionHasBeenSet = true;
  ...
  inline void SetSideOfStreet(RouteSideOfStreet value) {
    m_sideOfStreetHasBeenSet = true;
    m_sideOfStreet = value;
  }
  inline RouteVehiclePlace& WithSideOfStreet(RouteSideOfStreet value) {
    SetSideOfStreet(value);
    return *this;
  }
  ///@}
  ...
  inline RouteVehiclePlace& WithWaypointIndex(int value) {
