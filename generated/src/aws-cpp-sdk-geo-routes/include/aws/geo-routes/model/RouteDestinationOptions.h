...
namespace Model
{
  ...
  public:
    ...
    inline RouteDestinationOptions& WithMatching(const RouteMatchingOptions& value) { SetMatching(value); return *this;}
    inline RouteDestinationOptions& WithMatching(RouteMatchingOptions&& value) { SetMatching(std::move(value)); return *this;}
    ///@}
    ...
    inline RouteDestinationOptions& WithSideOfStreet(const RouteSideOfStreetOptions& value) { SetSideOfStreet(value); return *this;}
    inline RouteDestinationOptions& WithSideOfStreet(RouteSideOfStreetOptions&& value) { SetSideOfStreet(std::move(value)); return *this;}
    ///@}
