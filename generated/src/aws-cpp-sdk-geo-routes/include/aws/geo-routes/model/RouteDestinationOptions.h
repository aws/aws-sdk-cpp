...
class RouteDestinationOptions {
 public:
  ...
  inline RouteDestinationOptions& WithAvoidActionsForDistance(long long value) {
  ...
  inline RouteDestinationOptions& WithAvoidUTurns(bool value) {
  ...
  inline RouteDestinationOptions& WithHeading(double value) {
    SetHeading(value);
    return *this;
  }
  ///@}
  ...
  inline RouteDestinationOptions& WithStopDuration(long long value) {
