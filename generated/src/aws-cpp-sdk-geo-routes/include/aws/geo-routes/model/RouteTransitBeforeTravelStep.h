 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/geo-routes-2020-11-19/RouteTransitBeforeTravelStep">AWS
 * API Reference</a></p>
 */
class RouteTransitBeforeTravelStep {
 public:
  AWS_GEOROUTES_API RouteTransitBeforeTravelStep() = default;
  AWS_GEOROUTES_API RouteTransitBeforeTravelStep(Aws::Utils::Json::JsonView jsonValue);
  AWS_GEOROUTES_API RouteTransitBeforeTravelStep& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  inline RouteTransitBeforeTravelStep& WithDuration(long long value) {
    SetDuration(value);
    return *this;
  }
  ///@}
  ...
  template <typename InstructionT = Aws::String>
  RouteTransitBeforeTravelStep& WithInstruction(InstructionT&& value) {
   ...
   */
  inline RouteTransitBeforeTravelStepType GetType() const { return m_type; }
  inline bool TypeHasBeenSet() const { return m_typeHasBeenSet; }
  inline void SetType(RouteTransitBeforeTravelStepType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline RouteTransitBeforeTravelStep& WithType(RouteTransitBeforeTravelStepType value) {
    SetType(value);
    return *this;
  }
  ///@}
 private:
  ...
  RouteTransitBeforeTravelStepType m_type{RouteTransitBeforeTravelStepType::NOT_SET};
