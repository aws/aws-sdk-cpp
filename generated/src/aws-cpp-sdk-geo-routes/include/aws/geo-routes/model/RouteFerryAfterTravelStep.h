...
class RouteFerryAfterTravelStep {
 public:
  ...
  inline RouteFerryAfterTravelStep& WithDuration(long long value) {
    SetDuration(value);
    return *this;
  }
  ///@}
  ...
  inline void SetType(RouteFerryAfterTravelStepType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline RouteFerryAfterTravelStep& WithType(RouteFerryAfterTravelStepType value) {
    SetType(value);
    return *this;
  }
  ///@}
