...
class WeightPerAxleGroup {
 public:
  ...
  inline void SetSingle(long long value) {
    m_singleHasBeenSet = true;
    m_single = value;
  }
  inline WeightPerAxleGroup& WithSingle(long long value) {
    SetSingle(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTandem(long long value) {
    m_tandemHasBeenSet = true;
    m_tandem = value;
  }
  inline WeightPerAxleGroup& WithTandem(long long value) {
    SetTandem(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTriple(long long value) {
    m_tripleHasBeenSet = true;
    m_triple = value;
  }
  inline WeightPerAxleGroup& WithTriple(long long value) {
    SetTriple(value);
    return *this;
  }
  ///@}
  ...
  inline void SetQuad(long long value) {
    m_quadHasBeenSet = true;
    m_quad = value;
  }
  inline WeightPerAxleGroup& WithQuad(long long value) {
    SetQuad(value);
    return *this;
  }
  ///@}
  ...
  inline void SetQuint(long long value) {
    m_quintHasBeenSet = true;
    m_quint = value;
  }
  inline WeightPerAxleGroup& WithQuint(long long value) {
    SetQuint(value);
    return *this;
  }
  ///@}
