...
class CalculateRouteMatrixResult {
 public:
  ...
  inline CalculateRouteMatrixResult& WithErrorCount(int value) {
    SetErrorCount(value);
    return *this;
  }
  ///@}
  ...
  void SetRoutingBoundary(RoutingBoundaryT&& value) {
    ...
    m_routingBoundary = std::forward<RoutingBoundaryT>(value);
  }
  template <typename RoutingBoundaryT = RouteMatrixBoundary>
  CalculateRouteMatrixResult& WithRoutingBoundary(RoutingBoundaryT&& value) {
    SetRoutingBoundary(std::forward<RoutingBoundaryT>(value));
    return *this;
  }
  ///@}
