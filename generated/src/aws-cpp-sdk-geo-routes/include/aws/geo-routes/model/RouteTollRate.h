...
class RouteTollRate {
 public:
  ...
  void SetApplicableTimes(ApplicableTimesT&& value) {
    ...
    m_applicableTimes = std::forward<ApplicableTimesT>(value);
  }
  template <typename ApplicableTimesT = Aws::String>
  RouteTollRate& WithApplicableTimes(ApplicableTimesT&& value) {
    SetApplicableTimes(std::forward<ApplicableTimesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetConvertedPrice(ConvertedPriceT&& value) {
    ...
    m_convertedPrice = std::forward<ConvertedPriceT>(value);
  }
  template <typename ConvertedPriceT = RouteTollPrice>
  RouteTollRate& WithConvertedPrice(ConvertedPriceT&& value) {
    SetConvertedPrice(std::forward<ConvertedPriceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLocalPrice(LocalPriceT&& value) {
    ...
    m_localPrice = std::forward<LocalPriceT>(value);
  }
  template <typename LocalPriceT = RouteTollPrice>
  RouteTollRate& WithLocalPrice(LocalPriceT&& value) {
    SetLocalPrice(std::forward<LocalPriceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPass(PassT&& value) {
    ...
    m_pass = std::forward<PassT>(value);
  }
  template <typename PassT = RouteTollPass>
  RouteTollRate& WithPass(PassT&& value) {
    SetPass(std::forward<PassT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPaymentMethods(PaymentMethodsT&& value) {
    ...
    m_paymentMethods = std::forward<PaymentMethodsT>(value);
  }
  template <typename PaymentMethodsT = Aws::Vector<RouteTollPaymentMethod>>
  RouteTollRate& WithPaymentMethods(PaymentMethodsT&& value) {
    SetPaymentMethods(std::forward<PaymentMethodsT>(value));
    return *this;
  }
  inline RouteTollRate& AddPaymentMethods(RouteTollPaymentMethod value) {
    m_paymentMethodsHasBeenSet = true;
    m_paymentMethods.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetTransponders(TranspondersT&& value) {
    ...
    m_transponders = std::forward<TranspondersT>(value);
  }
  template <typename TranspondersT = Aws::Vector<RouteTransponder>>
  RouteTollRate& WithTransponders(TranspondersT&& value) {
    SetTransponders(std::forward<TranspondersT>(value));
    return *this;
  }
  template <typename TranspondersT = RouteTransponder>
  RouteTollRate& AddTransponders(TranspondersT&& value) {
    m_transpondersHasBeenSet = true;
    m_transponders.emplace_back(std::forward<TranspondersT>(value));
    return *this;
  }
  ///@}
 private:
