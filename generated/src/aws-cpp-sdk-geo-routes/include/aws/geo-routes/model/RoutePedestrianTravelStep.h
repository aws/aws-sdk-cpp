...
class RoutePedestrianTravelStep {
 public:
  ...
  inline RoutePedestrianTravelStep& WithDistance(long long value) {
    SetDistance(value);
    return *this;
  }
  ///@}
  ...
  inline RoutePedestrianTravelStep& WithDuration(long long value) {
    SetDuration(value);
    return *this;
  }
  ///@}
  ...
  inline RoutePedestrianTravelStep& WithGeometryOffset(int value) {
  ...
  inline void SetType(RoutePedestrianTravelStepType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline RoutePedestrianTravelStep& WithType(RoutePedestrianTravelStepType value) {
    SetType(value);
    return *this;
  }
  ///@}
