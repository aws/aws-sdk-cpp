...
class WaypointOptimizationAvoidanceOptions {
 public:
  ...
  inline WaypointOptimizationAvoidanceOptions& WithCarShuttleTrains(bool value) {
  ...
  inline WaypointOptimizationAvoidanceOptions& WithControlledAccessHighways(bool value) {
  ...
  inline WaypointOptimizationAvoidanceOptions& WithDirtRoads(bool value) {
    SetDirtRoads(value);
    return *this;
  }
  ///@}
  ...
  inline WaypointOptimizationAvoidanceOptions& WithFerries(bool value) {
    SetFerries(value);
    return *this;
  }
  ///@}
  ...
  inline WaypointOptimizationAvoidanceOptions& WithTollRoads(bool value) {
    SetTollRoads(value);
    return *this;
  }
  ///@}
  ...
  inline WaypointOptimizationAvoidanceOptions& WithTunnels(bool value) {
    SetTunnels(value);
    return *this;
  }
  ///@}
  ...
  inline WaypointOptimizationAvoidanceOptions& WithUTurns(bool value) {
    SetUTurns(value);
    return *this;
  }
  ///@}
