...
/**
 * <p>Options for the rental leg of the intermodal route.</p><p><h3>See Also:</h3>
 * <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/geo-routes-2020-11-19/RouteIntermodalRentalOptions">AWS
 * API Reference</a></p>
 */
class RouteIntermodalRentalOptions {
 public:
  ...
  ///@{
  /**
   * <p>Allowed rental transport modes when calculating the route. By default, all
   * transport modes are allowed. Cannot be used together with
   * <code>ExcludedModes</code>.</p>
   */
  inline const Aws::Vector<RouteRentalMode>& GetAllowedModes() const { return m_allowedModes; }
  inline bool AllowedModesHasBeenSet() const { return m_allowedModesHasBeenSet; }
  template <typename AllowedModesT = Aws::Vector<RouteRentalMode>>
  ...
  inline RouteIntermodalRentalOptions& AddAllowedModes(RouteRentalMode value) {
    m_allowedModesHasBeenSet = true;
  ...
  inline RouteIntermodalRentalOptions& AddEnabledFor(RouteIntermodalEnabledLegs value) {
    m_enabledForHasBeenSet = true;
  ...
  ///@{
  /**
   * <p>Excluded rental transport modes when calculating the route. By default, all
   * transport modes are allowed. Cannot be used together with
   * <code>AllowedModes</code>.</p>
   */
  inline const Aws::Vector<RouteRentalMode>& GetExcludedModes() const { return m_excludedModes; }
  inline bool ExcludedModesHasBeenSet() const { return m_excludedModesHasBeenSet; }
  template <typename ExcludedModesT = Aws::Vector<RouteRentalMode>>
  ...
  inline RouteIntermodalRentalOptions& AddExcludedModes(RouteRentalMode value) {
    m_excludedModesHasBeenSet = true;
  ...
  ///@}
 private:
  Aws::Vector<RouteRentalMode> m_allowedModes;

  Aws::Vector<RouteIntermodalEnabledLegs> m_enabledFor;

  Aws::Vector<RouteRentalMode> m_excludedModes;
