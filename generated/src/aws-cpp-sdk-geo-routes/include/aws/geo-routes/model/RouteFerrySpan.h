...
class RouteFerrySpan {
 public:
  ...
  inline RouteFerrySpan& WithDistance(long long value) {
    SetDistance(value);
    return *this;
  }
  ///@}
  ...
  inline RouteFerrySpan& WithDuration(long long value) {
    SetDuration(value);
    return *this;
  }
  ///@}
  ...
  inline RouteFerrySpan& WithGeometryOffset(int value) {
