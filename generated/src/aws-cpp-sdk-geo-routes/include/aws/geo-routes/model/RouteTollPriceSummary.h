...
class RouteTollPriceSummary {
 public:
  ...
  inline void SetEstimate(bool value) {
    m_estimateHasBeenSet = true;
    m_estimate = value;
  }
  inline RouteTollPriceSummary& WithEstimate(bool value) {
    SetEstimate(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRange(bool value) {
    m_rangeHasBeenSet = true;
    m_range = value;
  }
  inline RouteTollPriceSummary& WithRange(bool value) {
    SetRange(value);
    return *this;
  }
  ///@}
  ...
  void SetRangeValue(RangeValueT&& value) {
    ...
    m_rangeValue = std::forward<RangeValueT>(value);
  }
  template <typename RangeValueT = RouteTollPriceValueRange>
  RouteTollPriceSummary& WithRangeValue(RangeValueT&& value) {
    SetRangeValue(std::forward<RangeValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline RouteTollPriceSummary& WithValue(double value) {
    SetValue(value);
    return *this;
  }
  ///@}
