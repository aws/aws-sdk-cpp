...
class WaypointOptimizationTimeBreakdown {
 public:
  ...
  inline WaypointOptimizationTimeBreakdown& WithRestDuration(long long value) {
  ...
  inline WaypointOptimizationTimeBreakdown& WithServiceDuration(long long value) {
  ...
  inline WaypointOptimizationTimeBreakdown& WithTravelDuration(long long value) {
  ...
  inline WaypointOptimizationTimeBreakdown& WithWaitDuration(long long value) {
