...
class RouteKeepStepDetails {
 public:
  ...
  inline RouteKeepStepDetails& WithSteeringDirection(RouteSteeringDirection value) {
  ...
  inline RouteKeepStepDetails& WithTurnAngle(double value) {
    SetTurnAngle(value);
    return *this;
  }
  ///@}
  ...
  inline RouteKeepStepDetails& WithTurnIntensity(RouteTurnIntensity value) {
