...
class WaypointOptimizationImpedingWaypoint {
 public:
  ...
  void SetFailedConstraints(FailedConstraintsT&& value) {
    m_failedConstraintsHasBeenSet = true;
    m_failedConstraints = std::forward<FailedConstraintsT>(value);
  }
  template <typename FailedConstraintsT = Aws::Vector<WaypointOptimizationFailedConstraint>>
  WaypointOptimizationImpedingWaypoint& WithFailedConstraints(FailedConstraintsT&& value) {
    SetFailedConstraints(std::forward<FailedConstraintsT>(value));
    return *this;
  }
  template <typename FailedConstraintsT = WaypointOptimizationFailedConstraint>
  WaypointOptimizationImpedingWaypoint& AddFailedConstraints(FailedConstraintsT&& value) {
    m_failedConstraintsHasBeenSet = true;
    m_failedConstraints.emplace_back(std::forward<FailedConstraintsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename IdT = Aws::String>
  WaypointOptimizationImpedingWaypoint& WithId(IdT&& value) {
  ...
  template <typename PositionT = Aws::Vector<double>>
  WaypointOptimizationImpedingWaypoint& WithPosition(PositionT&& value) {
    SetPosition(std::forward<PositionT>(value));
    return *this;
  }
  inline WaypointOptimizationImpedingWaypoint& AddPosition(double value) {
    m_positionHasBeenSet = true;
