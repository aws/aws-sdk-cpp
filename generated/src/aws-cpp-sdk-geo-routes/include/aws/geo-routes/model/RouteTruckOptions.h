...
namespace Model
{
  ...
  public:
    ...
    inline RouteTruckOptions& WithEngineType(RouteEngineType value) { SetEngineType(value); return *this;}
    ///@}
    ...
    template<typename HazardousCargosT = Aws::Vector<RouteHazardousCargoType>>
    RouteTruckOptions& WithHazardousCargos(HazardousCargosT&& value) { SetHazardousCargos(std::forward<HazardousCargosT>(value)); return *this;}
    inline RouteTruckOptions& AddHazardousCargos(RouteHazardousCargoType value) { m_hazardousCargosHasBeenSet = true; m_hazardousCargos.push_back(value); return *this; }
    ///@}
    ...
    template<typename LicensePlateT = RouteVehicleLicensePlate>
    RouteTruckOptions& WithLicensePlate(LicensePlateT&& value) { SetLicensePlate(std::forward<LicensePlateT>(value)); return *this;}
    ///@}
    ...
    template<typename TrailerT = RouteTrailerOptions>
    void SetTrailer(TrailerT&& value) { m_trailerHasBeenSet = true; m_trailer = std::forward<TrailerT>(value); }
    template<typename TrailerT = RouteTrailerOptions>
    RouteTruckOptions& WithTrailer(TrailerT&& value) { SetTrailer(std::forward<TrailerT>(value)); return *this;}
    ///@}
    ...
    inline RouteTruckOptions& WithTruckType(RouteTruckType value) { SetTruckType(value); return *this;}
    ///@}
    ...
    template<typename TunnelRestrictionCodeT = Aws::String>
    RouteTruckOptions& WithTunnelRestrictionCode(TunnelRestrictionCodeT&& value) { SetTunnelRestrictionCode(std::forward<TunnelRestrictionCodeT>(value)); return *this;}
    ///@}
    ...
    template<typename WeightPerAxleGroupT = WeightPerAxleGroup>
    RouteTruckOptions& WithWeightPerAxleGroup(WeightPerAxleGroupT&& value) { SetWeightPerAxleGroup(std::forward<WeightPerAxleGroupT>(value)); return *this;}
    ///@}
