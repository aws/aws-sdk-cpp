...
class RouteTruckOptions {
 public:
  ...
  inline RouteTruckOptions& WithAxleCount(int value) {
    SetAxleCount(value);
    return *this;
  }
  ///@}
  ...
  inline RouteTruckOptions& WithEngineType(RouteEngineType value) {
    SetEngineType(value);
    return *this;
  }
  ///@}
  ...
  inline RouteTruckOptions& WithGrossWeight(long long value) {
  ...
  inline RouteTruckOptions& AddHazardousCargos(RouteHazardousCargoType value) {
    m_hazardousCargosHasBeenSet = true;
  ...
  inline RouteTruckOptions& WithHeight(long long value) {
    SetHeight(value);
    return *this;
  }
  ///@}
  ...
  inline RouteTruckOptions& WithHeightAboveFirstAxle(long long value) {
  ...
  inline RouteTruckOptions& WithKpraLength(long long value) {
    SetKpraLength(value);
    return *this;
  }
  ///@}
  ...
  inline RouteTruckOptions& WithLength(long long value) {
    SetLength(value);
    return *this;
  }
  ///@}
  ...
  inline RouteTruckOptions& WithMaxSpeed(double value) {
    SetMaxSpeed(value);
    return *this;
  }
  ///@}
  ...
  inline RouteTruckOptions& WithOccupancy(int value) {
    SetOccupancy(value);
    return *this;
  }
  ///@}
  ...
  inline RouteTruckOptions& WithPayloadCapacity(long long value) {
  ...
  inline RouteTruckOptions& WithTireCount(int value) {
    SetTireCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTruckType(RouteTruckType value) {
    m_truckTypeHasBeenSet = true;
    m_truckType = value;
  }
  inline RouteTruckOptions& WithTruckType(RouteTruckType value) {
    SetTruckType(value);
    return *this;
  }
  ///@}
  ...
  inline RouteTruckOptions& WithWeightPerAxle(long long value) {
  ...
  inline RouteTruckOptions& WithWidth(long long value) {
    SetWidth(value);
    return *this;
  }
  ///@}
