...
RouteRentalDeparture::RouteRentalDeparture(JsonView jsonValue) { *this = jsonValue; }

RouteRentalDeparture& RouteRentalDeparture::operator=(JsonView jsonValue) {
...
JsonValue RouteRentalDeparture::Jsonize() const {
  JsonValue payload;
