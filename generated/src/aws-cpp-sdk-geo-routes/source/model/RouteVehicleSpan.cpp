...
RouteVehicleSpan::RouteVehicleSpan(JsonView jsonValue) { *this = jsonValue; }
...
RouteVehicleSpan& RouteVehicleSpan::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("CarAccess")) {
    ...
    for (unsigned carAccessIndex = 0; carAccessIndex < carAccessJsonList.GetLength(); ++carAccessIndex) {
      m_carAccess.push_back(
          RouteSpanCarAccessAttributeMapper::GetRouteSpanCarAccessAttributeForName(carAccessJsonList[carAccessIndex].AsString()));
    }
  ...
  if (jsonValue.ValueExists("RailwayCrossing")) {
    m_railwayCrossing =
        RouteSpanRailwayCrossingAttributeMapper::GetRouteSpanRailwayCrossingAttributeForName(jsonValue.GetString("RailwayCrossing"));
  ...
  if (jsonValue.ValueExists("RoadAttributes")) {
    ...
    for (unsigned roadAttributesIndex = 0; roadAttributesIndex < roadAttributesJsonList.GetLength(); ++roadAttributesIndex) {
      m_roadAttributes.push_back(
          RouteSpanRoadAttributeMapper::GetRouteSpanRoadAttributeForName(roadAttributesJsonList[roadAttributesIndex].AsString()));
    }
  ...
  if (jsonValue.ValueExists("ScooterAccess")) {
    ...
    for (unsigned scooterAccessIndex = 0; scooterAccessIndex < scooterAccessJsonList.GetLength(); ++scooterAccessIndex) {
      m_scooterAccess.push_back(RouteSpanScooterAccessAttributeMapper::GetRouteSpanScooterAccessAttributeForName(
          scooterAccessJsonList[scooterAccessIndex].AsString()));
    }
  ...
  if (jsonValue.ValueExists("TruckAccess")) {
    ...
    for (unsigned truckAccessIndex = 0; truckAccessIndex < truckAccessJsonList.GetLength(); ++truckAccessIndex) {
      m_truckAccess.push_back(
          RouteSpanTruckAccessAttributeMapper::GetRouteSpanTruckAccessAttributeForName(truckAccessJsonList[truckAccessIndex].AsString()));
    }
...
JsonValue RouteVehicleSpan::Jsonize() const {
  ...
  if (m_carAccessHasBeenSet) {
    ...
    for (unsigned carAccessIndex = 0; carAccessIndex < carAccessJsonList.GetLength(); ++carAccessIndex) {
      carAccessJsonList[carAccessIndex].AsString(
          RouteSpanCarAccessAttributeMapper::GetNameForRouteSpanCarAccessAttribute(m_carAccess[carAccessIndex]));
    }
  ...
  if (m_railwayCrossingHasBeenSet) {
    payload.WithString("RailwayCrossing",
                       RouteSpanRailwayCrossingAttributeMapper::GetNameForRouteSpanRailwayCrossingAttribute(m_railwayCrossing));
  }
  ...
  if (m_roadAttributesHasBeenSet) {
    ...
    for (unsigned roadAttributesIndex = 0; roadAttributesIndex < roadAttributesJsonList.GetLength(); ++roadAttributesIndex) {
      roadAttributesJsonList[roadAttributesIndex].AsString(
          RouteSpanRoadAttributeMapper::GetNameForRouteSpanRoadAttribute(m_roadAttributes[roadAttributesIndex]));
    }
  ...
  if (m_scooterAccessHasBeenSet) {
    ...
    for (unsigned scooterAccessIndex = 0; scooterAccessIndex < scooterAccessJsonList.GetLength(); ++scooterAccessIndex) {
      scooterAccessJsonList[scooterAccessIndex].AsString(
          RouteSpanScooterAccessAttributeMapper::GetNameForRouteSpanScooterAccessAttribute(m_scooterAccess[scooterAccessIndex]));
    }
  ...
  if (m_truckAccessHasBeenSet) {
    ...
    for (unsigned truckAccessIndex = 0; truckAccessIndex < truckAccessJsonList.GetLength(); ++truckAccessIndex) {
      truckAccessJsonList[truckAccessIndex].AsString(
          RouteSpanTruckAccessAttributeMapper::GetNameForRouteSpanTruckAccessAttribute(m_truckAccess[truckAccessIndex]));
    }
