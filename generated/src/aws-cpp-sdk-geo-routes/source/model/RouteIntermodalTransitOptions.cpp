...
RouteIntermodalTransitOptions::RouteIntermodalTransitOptions(JsonView jsonValue) { *this = jsonValue; }

RouteIntermodalTransitOptions& RouteIntermodalTransitOptions::operator=(JsonView jsonValue) {
...
JsonValue RouteIntermodalTransitOptions::Jsonize() const {
  JsonValue payload;
