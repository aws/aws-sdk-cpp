...
RouteTaxiTravelStep::RouteTaxiTravelStep(JsonView jsonValue) { *this = jsonValue; }

RouteTaxiTravelStep& RouteTaxiTravelStep::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("Type")) {
    m_type = RouteTaxiTravelStepTypeMapper::GetRouteTaxiTravelStepTypeForName(jsonValue.GetString("Type"));
...
JsonValue RouteTaxiTravelStep::Jsonize() const {
  JsonValue payload;
  ...
  if (m_typeHasBeenSet) {
    payload.WithString("Type", RouteTaxiTravelStepTypeMapper::GetNameForRouteTaxiTravelStepType(m_type));
  }
