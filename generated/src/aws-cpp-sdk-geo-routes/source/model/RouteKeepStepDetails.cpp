...
RouteKeepStepDetails::RouteKeepStepDetails() : 
...
RouteKeepStepDetails::RouteKeepStepDetails(JsonView jsonValue)
  : RouteKeepStepDetails()
{
  *this = jsonValue;
}

RouteKeepStepDetails& RouteKeepStepDetails::operator =(JsonView jsonValue)
{
...
JsonValue RouteKeepStepDetails::Jsonize() const
{
  JsonValue payload;
