...
RouteContinueHighwayStepDetails::RouteContinueHighwayStepDetails() : 
...
RouteContinueHighwayStepDetails::RouteContinueHighwayStepDetails(JsonView jsonValue)
  : RouteContinueHighwayStepDetails()
{
  *this = jsonValue;
}

RouteContinueHighwayStepDetails& RouteContinueHighwayStepDetails::operator =(JsonView jsonValue)
{
...
JsonValue RouteContinueHighwayStepDetails::Jsonize() const
{
  JsonValue payload;
