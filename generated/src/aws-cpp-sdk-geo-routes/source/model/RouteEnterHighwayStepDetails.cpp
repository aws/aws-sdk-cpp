...
RouteEnterHighwayStepDetails::RouteEnterHighwayStepDetails(JsonView jsonValue) { *this = jsonValue; }

RouteEnterHighwayStepDetails& RouteEnterHighwayStepDetails::operator=(JsonView jsonValue) {
...
JsonValue RouteEnterHighwayStepDetails::Jsonize() const {
  JsonValue payload;
