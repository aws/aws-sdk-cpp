...
RouteIntermodalPedestrianOptions::RouteIntermodalPedestrianOptions(JsonView jsonValue) { *this = jsonValue; }

RouteIntermodalPedestrianOptions& RouteIntermodalPedestrianOptions::operator=(JsonView jsonValue) {
...
JsonValue RouteIntermodalPedestrianOptions::Jsonize() const {
  JsonValue payload;
