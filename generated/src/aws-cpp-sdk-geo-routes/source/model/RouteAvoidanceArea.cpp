...
RouteAvoidanceArea::RouteAvoidanceArea(JsonView jsonValue) { *this = jsonValue; }

RouteAvoidanceArea& RouteAvoidanceArea::operator=(JsonView jsonValue) {
...
JsonValue RouteAvoidanceArea::Jsonize() const {
  JsonValue payload;
