...
RouteTaxiSummary::RouteTaxiSummary(JsonView jsonValue) { *this = jsonValue; }

RouteTaxiSummary& RouteTaxiSummary::operator=(JsonView jsonValue) {
...
JsonValue RouteTaxiSummary::Jsonize() const {
  JsonValue payload;
