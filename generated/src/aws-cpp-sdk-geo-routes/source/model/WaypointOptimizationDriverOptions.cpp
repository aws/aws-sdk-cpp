...
WaypointOptimizationDriverOptions::WaypointOptimizationDriverOptions(JsonView jsonValue) { *this = jsonValue; }
...
WaypointOptimizationDriverOptions& WaypointOptimizationDriverOptions::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("TreatServiceTimeAs")) {
    m_treatServiceTimeAs = WaypointOptimizationServiceTimeTreatmentMapper::GetWaypointOptimizationServiceTimeTreatmentForName(
        jsonValue.GetString("TreatServiceTimeAs"));
...
JsonValue WaypointOptimizationDriverOptions::Jsonize() const {
  ...
  if (m_treatServiceTimeAsHasBeenSet) {
    payload.WithString(
        "TreatServiceTimeAs",
        WaypointOptimizationServiceTimeTreatmentMapper::GetNameForWaypointOptimizationServiceTimeTreatment(m_treatServiceTimeAs));
  }
