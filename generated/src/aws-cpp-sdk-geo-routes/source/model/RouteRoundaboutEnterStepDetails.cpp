...
RouteRoundaboutEnterStepDetails::RouteRoundaboutEnterStepDetails() : 
...
RouteRoundaboutEnterStepDetails::RouteRoundaboutEnterStepDetails(JsonView jsonValue)
  : RouteRoundaboutEnterStepDetails()
{
  *this = jsonValue;
}

RouteRoundaboutEnterStepDetails& RouteRoundaboutEnterStepDetails::operator =(JsonView jsonValue)
{
...
JsonValue RouteRoundaboutEnterStepDetails::Jsonize() const
{
  JsonValue payload;
