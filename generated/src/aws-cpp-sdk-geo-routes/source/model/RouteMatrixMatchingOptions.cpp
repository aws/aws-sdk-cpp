...
RouteMatrixMatchingOptions::RouteMatrixMatchingOptions(JsonView jsonValue) { *this = jsonValue; }

RouteMatrixMatchingOptions& RouteMatrixMatchingOptions::operator=(JsonView jsonValue) {
...
JsonValue RouteMatrixMatchingOptions::Jsonize() const {
  JsonValue payload;
