...
RouteTurnStepDetails::RouteTurnStepDetails() : 
...
RouteTurnStepDetails::RouteTurnStepDetails(JsonView jsonValue)
  : RouteTurnStepDetails()
{
  *this = jsonValue;
}

RouteTurnStepDetails& RouteTurnStepDetails::operator =(JsonView jsonValue)
{
...
JsonValue RouteTurnStepDetails::Jsonize() const
{
  JsonValue payload;
