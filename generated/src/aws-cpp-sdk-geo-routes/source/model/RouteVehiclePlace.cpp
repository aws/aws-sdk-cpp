...
RouteVehiclePlace::RouteVehiclePlace(JsonView jsonValue) { *this = jsonValue; }

RouteVehiclePlace& RouteVehiclePlace::operator=(JsonView jsonValue) {
...
JsonValue RouteVehiclePlace::Jsonize() const {
  JsonValue payload;
