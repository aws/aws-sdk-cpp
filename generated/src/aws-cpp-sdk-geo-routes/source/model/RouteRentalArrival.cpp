...
RouteRentalArrival::RouteRentalArrival(JsonView jsonValue) { *this = jsonValue; }

RouteRentalArrival& RouteRentalArrival::operator=(JsonView jsonValue) {
...
JsonValue RouteRentalArrival::Jsonize() const {
  JsonValue payload;
