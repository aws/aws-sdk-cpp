...
RouteUTurnStepDetails::RouteUTurnStepDetails() : 
...
RouteUTurnStepDetails::RouteUTurnStepDetails(JsonView jsonValue)
  : RouteUTurnStepDetails()
{
  *this = jsonValue;
}

RouteUTurnStepDetails& RouteUTurnStepDetails::operator =(JsonView jsonValue)
{
...
JsonValue RouteUTurnStepDetails::Jsonize() const
{
  JsonValue payload;
