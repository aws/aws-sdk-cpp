...
RouteTaxiLegDetails::RouteTaxiLegDetails(JsonView jsonValue) { *this = jsonValue; }

RouteTaxiLegDetails& RouteTaxiLegDetails::operator=(JsonView jsonValue) {
...
JsonValue RouteTaxiLegDetails::Jsonize() const {
  JsonValue payload;
