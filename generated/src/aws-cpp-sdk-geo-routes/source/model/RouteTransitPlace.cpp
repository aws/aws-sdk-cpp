...
RouteTransitPlace::RouteTransitPlace(JsonView jsonValue) { *this = jsonValue; }

RouteTransitPlace& RouteTransitPlace::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("Type")) {
    m_type = RouteTransitPlaceTypeMapper::GetRouteTransitPlaceTypeForName(jsonValue.GetString("Type"));
...
JsonValue RouteTransitPlace::Jsonize() const {
  JsonValue payload;
  ...
  if (m_typeHasBeenSet) {
    payload.WithString("Type", RouteTransitPlaceTypeMapper::GetNameForRouteTransitPlaceType(m_type));
  }
