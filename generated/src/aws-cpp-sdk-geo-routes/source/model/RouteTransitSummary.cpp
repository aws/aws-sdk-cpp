...
RouteTransitSummary::RouteTransitSummary(JsonView jsonValue) { *this = jsonValue; }

RouteTransitSummary& RouteTransitSummary::operator=(JsonView jsonValue) {
...
JsonValue RouteTransitSummary::Jsonize() const {
  JsonValue payload;
