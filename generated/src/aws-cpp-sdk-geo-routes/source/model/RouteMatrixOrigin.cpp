...
RouteMatrixOrigin::RouteMatrixOrigin(JsonView jsonValue) { *this = jsonValue; }

RouteMatrixOrigin& RouteMatrixOrigin::operator=(JsonView jsonValue) {
...
JsonValue RouteMatrixOrigin::Jsonize() const {
  JsonValue payload;
