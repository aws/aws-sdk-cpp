...
RoutePedestrianArrival::RoutePedestrianArrival(JsonView jsonValue) { *this = jsonValue; }

RoutePedestrianArrival& RoutePedestrianArrival::operator=(JsonView jsonValue) {
...
JsonValue RoutePedestrianArrival::Jsonize() const {
  JsonValue payload;
