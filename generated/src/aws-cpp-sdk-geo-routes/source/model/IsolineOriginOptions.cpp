...
IsolineOriginOptions::IsolineOriginOptions() : 
...
IsolineOriginOptions::IsolineOriginOptions(JsonView jsonValue)
  : IsolineOriginOptions()
{
  *this = jsonValue;
}

IsolineOriginOptions& IsolineOriginOptions::operator =(JsonView jsonValue)
{
...
JsonValue IsolineOriginOptions::Jsonize() const
{
  JsonValue payload;
