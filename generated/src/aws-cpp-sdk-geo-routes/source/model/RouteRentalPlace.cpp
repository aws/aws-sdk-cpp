...
RouteRentalPlace::RouteRentalPlace(JsonView jsonValue) { *this = jsonValue; }

RouteRentalPlace& RouteRentalPlace::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("Type")) {
    m_type = RouteRentalPlaceTypeMapper::GetRouteRentalPlaceTypeForName(jsonValue.GetString("Type"));
...
JsonValue RouteRentalPlace::Jsonize() const {
  JsonValue payload;
  ...
  if (m_typeHasBeenSet) {
    payload.WithString("Type", RouteRentalPlaceTypeMapper::GetNameForRouteRentalPlaceType(m_type));
  }
