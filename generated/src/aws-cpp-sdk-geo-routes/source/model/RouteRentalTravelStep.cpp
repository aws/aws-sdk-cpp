...
RouteRentalTravelStep::RouteRentalTravelStep(JsonView jsonValue) { *this = jsonValue; }

RouteRentalTravelStep& RouteRentalTravelStep::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("Type")) {
    m_type = RouteRentalTravelStepTypeMapper::GetRouteRentalTravelStepTypeForName(jsonValue.GetString("Type"));
...
JsonValue RouteRentalTravelStep::Jsonize() const {
  JsonValue payload;
  ...
  if (m_typeHasBeenSet) {
    payload.WithString("Type", RouteRentalTravelStepTypeMapper::GetNameForRouteRentalTravelStepType(m_type));
  }
