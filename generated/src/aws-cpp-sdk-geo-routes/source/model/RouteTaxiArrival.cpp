...
RouteTaxiArrival::RouteTaxiArrival(JsonView jsonValue) { *this = jsonValue; }

RouteTaxiArrival& RouteTaxiArrival::operator=(JsonView jsonValue) {
...
JsonValue RouteTaxiArrival::Jsonize() const {
  JsonValue payload;
