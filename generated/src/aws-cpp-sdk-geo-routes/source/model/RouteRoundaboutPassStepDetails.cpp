...
RouteRoundaboutPassStepDetails::RouteRoundaboutPassStepDetails() : 
...
RouteRoundaboutPassStepDetails::RouteRoundaboutPassStepDetails(JsonView jsonValue)
  : RouteRoundaboutPassStepDetails()
{
  *this = jsonValue;
}

RouteRoundaboutPassStepDetails& RouteRoundaboutPassStepDetails::operator =(JsonView jsonValue)
{
...
JsonValue RouteRoundaboutPassStepDetails::Jsonize() const
{
  JsonValue payload;
