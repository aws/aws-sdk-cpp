...
RouteMatrixOriginOptions::RouteMatrixOriginOptions(JsonView jsonValue) { *this = jsonValue; }

RouteMatrixOriginOptions& RouteMatrixOriginOptions::operator=(JsonView jsonValue) {
...
JsonValue RouteMatrixOriginOptions::Jsonize() const {
  JsonValue payload;
