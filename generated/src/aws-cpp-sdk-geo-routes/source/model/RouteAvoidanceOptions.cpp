...
RouteAvoidanceOptions::RouteAvoidanceOptions() : 
...
RouteAvoidanceOptions::RouteAvoidanceOptions(JsonView jsonValue)
  : RouteAvoidanceOptions()
{
  *this = jsonValue;
}

RouteAvoidanceOptions& RouteAvoidanceOptions::operator =(JsonView jsonValue)
{
...
JsonValue RouteAvoidanceOptions::Jsonize() const
{
  JsonValue payload;
