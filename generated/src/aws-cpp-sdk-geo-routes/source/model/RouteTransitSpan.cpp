...
RouteTransitSpan::RouteTransitSpan(JsonView jsonValue) { *this = jsonValue; }

RouteTransitSpan& RouteTransitSpan::operator=(JsonView jsonValue) {
...
JsonValue RouteTransitSpan::Jsonize() const {
  JsonValue payload;
