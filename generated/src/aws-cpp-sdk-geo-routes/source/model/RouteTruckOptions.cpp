...
RouteTruckOptions::RouteTruckOptions(JsonView jsonValue) { *this = jsonValue; }
  ...
  if (jsonValue.ValueExists("HazardousCargos")) {
    ...
    for (unsigned hazardousCargosIndex = 0; hazardousCargosIndex < hazardousCargosJsonList.GetLength(); ++hazardousCargosIndex) {
      m_hazardousCargos.push_back(
          RouteHazardousCargoTypeMapper::GetRouteHazardousCargoTypeForName(hazardousCargosJsonList[hazardousCargosIndex].AsString()));
    }
  ...
  if (m_hazardousCargosHasBeenSet) {
    ...
    for (unsigned hazardousCargosIndex = 0; hazardousCargosIndex < hazardousCargosJsonList.GetLength(); ++hazardousCargosIndex) {
      hazardousCargosJsonList[hazardousCargosIndex].AsString(
          RouteHazardousCargoTypeMapper::GetNameForRouteHazardousCargoType(m_hazardousCargos[hazardousCargosIndex]));
    }
