...
RoutePassThroughPlace::RoutePassThroughPlace(JsonView jsonValue) { *this = jsonValue; }

RoutePassThroughPlace& RoutePassThroughPlace::operator=(JsonView jsonValue) {
...
JsonValue RoutePassThroughPlace::Jsonize() const {
  JsonValue payload;
