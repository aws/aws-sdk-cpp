...
RouteMatrixTruckOptions::RouteMatrixTruckOptions() : 
    ...
    m_truckType(RouteMatrixTruckType::NOT_SET),
...
RouteMatrixTruckOptions::RouteMatrixTruckOptions(JsonView jsonValue)
  : RouteMatrixTruckOptions()
{
  *this = jsonValue;
}

RouteMatrixTruckOptions& RouteMatrixTruckOptions::operator =(JsonView jsonValue)
{
  ...
  if(jsonValue.ValueExists("HazardousCargos"))
  {
    ...
    {
      m_hazardousCargos.push_back(RouteMatrixHazardousCargoTypeMapper::GetRouteMatrixHazardousCargoTypeForName(hazardousCargosJsonList[hazardousCargosIndex].AsString()));
    }
  ...
  {
    m_truckType = RouteMatrixTruckTypeMapper::GetRouteMatrixTruckTypeForName(jsonValue.GetString("TruckType"));
...
JsonValue RouteMatrixTruckOptions::Jsonize() const
{
  JsonValue payload;
  ...
  if(m_hazardousCargosHasBeenSet)
  {
   ...
   for(unsigned hazardousCargosIndex = 0; hazardousCargosIndex < hazardousCargosJsonList.GetLength(); ++hazardousCargosIndex)
   {
     hazardousCargosJsonList[hazardousCargosIndex].AsString(RouteMatrixHazardousCargoTypeMapper::GetNameForRouteMatrixHazardousCargoType(m_hazardousCargos[hazardousCargosIndex]));
   }
  ...
  {
   payload.WithString("TruckType", RouteMatrixTruckTypeMapper::GetNameForRouteMatrixTruckType(m_truckType));
  }
