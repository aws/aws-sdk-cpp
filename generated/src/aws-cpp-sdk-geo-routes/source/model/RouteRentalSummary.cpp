...
RouteRentalSummary::RouteRentalSummary(JsonView jsonValue) { *this = jsonValue; }

RouteRentalSummary& RouteRentalSummary::operator=(JsonView jsonValue) {
...
JsonValue RouteRentalSummary::Jsonize() const {
  JsonValue payload;
