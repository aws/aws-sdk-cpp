...
IsolineMatchingOptions::IsolineMatchingOptions() : 
...
IsolineMatchingOptions::IsolineMatchingOptions(JsonView jsonValue)
  : IsolineMatchingOptions()
{
  *this = jsonValue;
}

IsolineMatchingOptions& IsolineMatchingOptions::operator =(JsonView jsonValue)
{
...
JsonValue IsolineMatchingOptions::Jsonize() const
{
  JsonValue payload;
