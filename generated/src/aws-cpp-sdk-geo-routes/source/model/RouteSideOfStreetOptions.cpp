...
RouteSideOfStreetOptions::RouteSideOfStreetOptions() : 
...
RouteSideOfStreetOptions::RouteSideOfStreetOptions(JsonView jsonValue)
  : RouteSideOfStreetOptions()
{
  *this = jsonValue;
}

RouteSideOfStreetOptions& RouteSideOfStreetOptions::operator =(JsonView jsonValue)
{
...
JsonValue RouteSideOfStreetOptions::Jsonize() const
{
  JsonValue payload;
