...
RouteTollPriceSummary::RouteTollPriceSummary(JsonView jsonValue) { *this = jsonValue; }

RouteTollPriceSummary& RouteTollPriceSummary::operator=(JsonView jsonValue) {
...
JsonValue RouteTollPriceSummary::Jsonize() const {
  JsonValue payload;
