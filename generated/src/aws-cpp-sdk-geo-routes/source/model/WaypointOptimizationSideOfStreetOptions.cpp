...
WaypointOptimizationSideOfStreetOptions::WaypointOptimizationSideOfStreetOptions(JsonView jsonValue) { *this = jsonValue; }

WaypointOptimizationSideOfStreetOptions& WaypointOptimizationSideOfStreetOptions::operator=(JsonView jsonValue) {
...
JsonValue WaypointOptimizationSideOfStreetOptions::Jsonize() const {
  JsonValue payload;
