...
RouteTaxiPlace::RouteTaxiPlace(JsonView jsonValue) { *this = jsonValue; }

RouteTaxiPlace& RouteTaxiPlace::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("Type")) {
    m_type = RouteTaxiPlaceTypeMapper::GetRouteTaxiPlaceTypeForName(jsonValue.GetString("Type"));
...
JsonValue RouteTaxiPlace::Jsonize() const {
  JsonValue payload;
  ...
  if (m_typeHasBeenSet) {
    payload.WithString("Type", RouteTaxiPlaceTypeMapper::GetNameForRouteTaxiPlaceType(m_type));
  }
