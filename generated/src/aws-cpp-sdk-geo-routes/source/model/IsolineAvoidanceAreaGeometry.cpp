...
IsolineAvoidanceAreaGeometry::IsolineAvoidanceAreaGeometry(JsonView jsonValue) { *this = jsonValue; }

IsolineAvoidanceAreaGeometry& IsolineAvoidanceAreaGeometry::operator=(JsonView jsonValue) {
...
JsonValue IsolineAvoidanceAreaGeometry::Jsonize() const {
  JsonValue payload;
  ...
  if (m_corridorHasBeenSet) {
    payload.WithObject("Corridor", m_corridor.Jsonize());
  }
  ...
  if (m_polylineCorridorHasBeenSet) {
    payload.WithObject("PolylineCorridor", m_polylineCorridor.Jsonize());
  }
