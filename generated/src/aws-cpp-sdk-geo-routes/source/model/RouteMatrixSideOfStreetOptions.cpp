...
RouteMatrixSideOfStreetOptions::RouteMatrixSideOfStreetOptions() : 
...
RouteMatrixSideOfStreetOptions::RouteMatrixSideOfStreetOptions(JsonView jsonValue)
  : RouteMatrixSideOfStreetOptions()
{
  *this = jsonValue;
}

RouteMatrixSideOfStreetOptions& RouteMatrixSideOfStreetOptions::operator =(JsonView jsonValue)
{
...
JsonValue RouteMatrixSideOfStreetOptions::Jsonize() const
{
  JsonValue payload;
