...
RouteTransitDeparture::RouteTransitDeparture(JsonView jsonValue) { *this = jsonValue; }

RouteTransitDeparture& RouteTransitDeparture::operator=(JsonView jsonValue) {
...
JsonValue RouteTransitDeparture::Jsonize() const {
  JsonValue payload;
