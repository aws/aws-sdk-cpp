...
WaypointOptimizationClusteringOptions::WaypointOptimizationClusteringOptions(JsonView jsonValue) { *this = jsonValue; }
...
WaypointOptimizationClusteringOptions& WaypointOptimizationClusteringOptions::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("Algorithm")) {
    m_algorithm =
        WaypointOptimizationClusteringAlgorithmMapper::GetWaypointOptimizationClusteringAlgorithmForName(jsonValue.GetString("Algorithm"));
...
JsonValue WaypointOptimizationClusteringOptions::Jsonize() const {
  ...
  if (m_algorithmHasBeenSet) {
    payload.WithString("Algorithm",
                       WaypointOptimizationClusteringAlgorithmMapper::GetNameForWaypointOptimizationClusteringAlgorithm(m_algorithm));
  }
