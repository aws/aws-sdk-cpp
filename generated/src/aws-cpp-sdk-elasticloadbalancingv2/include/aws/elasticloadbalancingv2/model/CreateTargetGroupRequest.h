...
class CreateTargetGroupRequest : public ElasticLoadBalancingv2Request {
 ...
 public:
  ...
  inline CreateTargetGroupRequest& WithProtocol(ProtocolEnum value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
  ...
  inline CreateTargetGroupRequest& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  inline void SetHealthCheckProtocol(ProtocolEnum value) {
    m_healthCheckProtocolHasBeenSet = true;
    m_healthCheckProtocol = value;
  }
  inline CreateTargetGroupRequest& WithHealthCheckProtocol(ProtocolEnum value) {
  ...
  inline void SetHealthCheckEnabled(bool value) {
    m_healthCheckEnabledHasBeenSet = true;
    m_healthCheckEnabled = value;
  }
  inline CreateTargetGroupRequest& WithHealthCheckEnabled(bool value) {
  ...
  inline CreateTargetGroupRequest& WithHealthCheckIntervalSeconds(int value) {
  ...
  inline CreateTargetGroupRequest& WithHealthCheckTimeoutSeconds(int value) {
  ...
  inline CreateTargetGroupRequest& WithHealthyThresholdCount(int value) {
  ...
  inline CreateTargetGroupRequest& WithUnhealthyThresholdCount(int value) {
  ...
  inline void SetTargetType(TargetTypeEnum value) {
    m_targetTypeHasBeenSet = true;
    m_targetType = value;
  }
  inline CreateTargetGroupRequest& WithTargetType(TargetTypeEnum value) {
    SetTargetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIpAddressType(TargetGroupIpAddressTypeEnum value) {
    m_ipAddressTypeHasBeenSet = true;
    m_ipAddressType = value;
  }
  inline CreateTargetGroupRequest& WithIpAddressType(TargetGroupIpAddressTypeEnum value) {
