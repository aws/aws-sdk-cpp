...
namespace Model
{
  ...
  public:
    ...
    inline void SetType(TransformTypeEnum value) { m_typeHasBeenSet = true; m_type = value; }
    inline RuleTransform& WithType(TransformTypeEnum value) { SetType(value); return *this;}
    ///@}
    ...
    void SetHostHeaderRewriteConfig(HostHeaderRewriteConfigT&& value) { m_hostHeaderRewriteConfigHasBeenSet = true; m_hostHeaderRewriteConfig = std::forward<HostHeaderRewriteConfigT>(value); }
    template<typename HostHeaderRewriteConfigT = HostHeaderRewriteConfig>
    RuleTransform& WithHostHeaderRewriteConfig(HostHeaderRewriteConfigT&& value) { SetHostHeaderRewriteConfig(std::forward<HostHeaderRewriteConfigT>(value)); return *this;}
    ///@}
    ...
    void SetUrlRewriteConfig(UrlRewriteConfigT&& value) { m_urlRewriteConfigHasBeenSet = true; m_urlRewriteConfig = std::forward<UrlRewriteConfigT>(value); }
    template<typename UrlRewriteConfigT = UrlRewriteConfig>
    RuleTransform& WithUrlRewriteConfig(UrlRewriteConfigT&& value) { SetUrlRewriteConfig(std::forward<UrlRewriteConfigT>(value)); return *this;}
    ///@}
  private:
