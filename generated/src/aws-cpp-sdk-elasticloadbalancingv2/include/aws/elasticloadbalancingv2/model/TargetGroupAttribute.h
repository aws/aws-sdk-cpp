...
namespace Model
{
  ...
  public:
    ...
    template<typename KeyT = Aws::String>
    TargetGroupAttribute& WithKey(KeyT&& value) { SetKey(std::forward<KeyT>(value)); return *this;}
    ///@}
    ...
    template<typename ValueT = Aws::String>
    TargetGroupAttribute& WithValue(ValueT&& value) { SetValue(std::forward<ValueT>(value)); return *this;}
    ///@}
  private:
