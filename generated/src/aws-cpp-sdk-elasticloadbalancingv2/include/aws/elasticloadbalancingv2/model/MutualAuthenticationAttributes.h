...
class MutualAuthenticationAttributes {
 public:
  ...
  inline void SetIgnoreClientCertificateExpiry(bool value) {
    m_ignoreClientCertificateExpiryHasBeenSet = true;
    m_ignoreClientCertificateExpiry = value;
  }
  inline MutualAuthenticationAttributes& WithIgnoreClientCertificateExpiry(bool value) {
    SetIgnoreClientCertificateExpiry(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTrustStoreAssociationStatus(TrustStoreAssociationStatusEnum value) {
    m_trustStoreAssociationStatusHasBeenSet = true;
    m_trustStoreAssociationStatus = value;
  }
  inline MutualAuthenticationAttributes& WithTrustStoreAssociationStatus(TrustStoreAssociationStatusEnum value) {
    SetTrustStoreAssociationStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAdvertiseTrustStoreCaNames(AdvertiseTrustStoreCaNamesEnum value) {
    m_advertiseTrustStoreCaNamesHasBeenSet = true;
    m_advertiseTrustStoreCaNames = value;
  }
  inline MutualAuthenticationAttributes& WithAdvertiseTrustStoreCaNames(AdvertiseTrustStoreCaNamesEnum value) {
