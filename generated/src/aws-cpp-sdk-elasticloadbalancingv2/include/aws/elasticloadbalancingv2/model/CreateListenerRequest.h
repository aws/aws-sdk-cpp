...
class CreateListenerRequest : public ElasticLoadBalancingv2Request {
 ...
 public:
  ...
  template <typename LoadBalancerArnT = Aws::String>
  CreateListenerRequest& WithLoadBalancerArn(LoadBalancerArnT&& value) {
   ...
   * Network Load Balancers, the supported protocols are TCP, TLS, UDP, TCP_UDP,
   * QUIC, and TCP_QUIC. You can’t specify the UDP, TCP_UDP, QUIC, or TCP_QUIC
   * protocol if dual-stack mode is enabled. You can't specify a protocol for a
   * Gateway Load Balancer.</p>
   */
  inline ProtocolEnum GetProtocol() const { return m_protocol; }
  inline bool ProtocolHasBeenSet() const { return m_protocolHasBeenSet; }
  inline void SetProtocol(ProtocolEnum value) {
    m_protocolHasBeenSet = true;
    m_protocol = value;
  }
  inline CreateListenerRequest& WithProtocol(ProtocolEnum value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
  ...
  inline CreateListenerRequest& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  void SetSslPolicy(SslPolicyT&& value) {
    ...
    m_sslPolicy = std::forward<SslPolicyT>(value);
  }
  template <typename SslPolicyT = Aws::String>
  CreateListenerRequest& WithSslPolicy(SslPolicyT&& value) {
    SetSslPolicy(std::forward<SslPolicyT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename CertificatesT = Aws::Vector<Certificate>>
  CreateListenerRequest& WithCertificates(CertificatesT&& value) {
    SetCertificates(std::forward<CertificatesT>(value));
    return *this;
  }
  template <typename CertificatesT = Certificate>
  CreateListenerRequest& AddCertificates(CertificatesT&& value) {
    m_certificatesHasBeenSet = true;
  ...
  void SetDefaultActions(DefaultActionsT&& value) {
    ...
    m_defaultActions = std::forward<DefaultActionsT>(value);
  }
  template <typename DefaultActionsT = Aws::Vector<Action>>
  CreateListenerRequest& WithDefaultActions(DefaultActionsT&& value) {
    SetDefaultActions(std::forward<DefaultActionsT>(value));
    return *this;
  }
  template <typename DefaultActionsT = Action>
  CreateListenerRequest& AddDefaultActions(DefaultActionsT&& value) {
    m_defaultActionsHasBeenSet = true;
    m_defaultActions.emplace_back(std::forward<DefaultActionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAlpnPolicy(AlpnPolicyT&& value) {
    ...
    m_alpnPolicy = std::forward<AlpnPolicyT>(value);
  }
  template <typename AlpnPolicyT = Aws::Vector<Aws::String>>
  CreateListenerRequest& WithAlpnPolicy(AlpnPolicyT&& value) {
    SetAlpnPolicy(std::forward<AlpnPolicyT>(value));
    return *this;
  }
  template <typename AlpnPolicyT = Aws::String>
  CreateListenerRequest& AddAlpnPolicy(AlpnPolicyT&& value) {
    m_alpnPolicyHasBeenSet = true;
    m_alpnPolicy.emplace_back(std::forward<AlpnPolicyT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateListenerRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateListenerRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  void SetMutualAuthentication(MutualAuthenticationT&& value) {
    ...
    m_mutualAuthentication = std::forward<MutualAuthenticationT>(value);
  }
  template <typename MutualAuthenticationT = MutualAuthenticationAttributes>
  CreateListenerRequest& WithMutualAuthentication(MutualAuthenticationT&& value) {
    SetMutualAuthentication(std::forward<MutualAuthenticationT>(value));
    return *this;
  }
  ///@}
 private:
