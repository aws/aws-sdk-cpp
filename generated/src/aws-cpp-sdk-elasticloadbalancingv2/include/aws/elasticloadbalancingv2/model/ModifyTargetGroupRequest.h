...
class ModifyTargetGroupRequest : public ElasticLoadBalancingv2Request {
 ...
 public:
  ...
  inline ModifyTargetGroupRequest& WithHealthCheckProtocol(ProtocolEnum value) {
  ...
  inline ModifyTargetGroupRequest& WithHealthCheckEnabled(bool value) {
  ...
  inline ModifyTargetGroupRequest& WithHealthCheckIntervalSeconds(int value) {
  ...
  inline ModifyTargetGroupRequest& WithHealthCheckTimeoutSeconds(int value) {
  ...
  inline ModifyTargetGroupRequest& WithHealthyThresholdCount(int value) {
  ...
  inline ModifyTargetGroupRequest& WithUnhealthyThresholdCount(int value) {
