...
class DescribeTrustStoreAssociationsRequest : public ElasticLoadBalancingv2Request {
 ...
 public:
  ...
  template <typename TrustStoreArnT = Aws::String>
  DescribeTrustStoreAssociationsRequest& WithTrustStoreArn(TrustStoreArnT&& value) {
  ...
  template <typename MarkerT = Aws::String>
  DescribeTrustStoreAssociationsRequest& WithMarker(MarkerT&& value) {
  ...
  inline DescribeTrustStoreAssociationsRequest& WithPageSize(int value) {
    SetPageSize(value);
    return *this;
  }
  ///@}
