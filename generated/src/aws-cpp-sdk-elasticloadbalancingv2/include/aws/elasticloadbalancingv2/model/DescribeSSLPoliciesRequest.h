...
class DescribeSSLPoliciesRequest : public ElasticLoadBalancingv2Request {
 ...
 public:
  ...
  template <typename NamesT = Aws::Vector<Aws::String>>
  DescribeSSLPoliciesRequest& WithNames(NamesT&& value) {
    SetNames(std::forward<NamesT>(value));
    return *this;
  }
  template <typename NamesT = Aws::String>
  DescribeSSLPoliciesRequest& AddNames(NamesT&& value) {
    m_namesHasBeenSet = true;
  ...
  template <typename MarkerT = Aws::String>
  DescribeSSLPoliciesRequest& WithMarker(MarkerT&& value) {
  ...
  inline DescribeSSLPoliciesRequest& WithPageSize(int value) {
    SetPageSize(value);
    return *this;
  }
  ///@}
  ...
  inline void SetLoadBalancerType(LoadBalancerTypeEnum value) {
    m_loadBalancerTypeHasBeenSet = true;
    m_loadBalancerType = value;
  }
  inline DescribeSSLPoliciesRequest& WithLoadBalancerType(LoadBalancerTypeEnum value) {
    SetLoadBalancerType(value);
    return *this;
  }
  ///@}
 private:
