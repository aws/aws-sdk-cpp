...
class Listener {
 public:
  ...
  template <typename ListenerArnT = Aws::String>
  Listener& WithListenerArn(ListenerArnT&& value) {
  ...
  template <typename LoadBalancerArnT = Aws::String>
  Listener& WithLoadBalancerArn(LoadBalancerArnT&& value) {
  ...
  inline Listener& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  inline Listener& WithProtocol(ProtocolEnum value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
  ...
  template <typename SslPolicyT = Aws::String>
  Listener& WithSslPolicy(SslPolicyT&& value) {
  ...
  template <typename DefaultActionsT = Aws::Vector<Action>>
  Listener& WithDefaultActions(DefaultActionsT&& value) {
    SetDefaultActions(std::forward<DefaultActionsT>(value));
    return *this;
  }
  template <typename DefaultActionsT = Action>
  Listener& AddDefaultActions(DefaultActionsT&& value) {
    m_defaultActionsHasBeenSet = true;
  ...
  template <typename MutualAuthenticationT = MutualAuthenticationAttributes>
  Listener& WithMutualAuthentication(MutualAuthenticationT&& value) {
