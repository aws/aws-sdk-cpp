...
class DescribeListenerCertificatesRequest : public ElasticLoadBalancingv2Request {
 ...
 public:
  ...
  template <typename ListenerArnT = Aws::String>
  DescribeListenerCertificatesRequest& WithListenerArn(ListenerArnT&& value) {
  ...
  template <typename MarkerT = Aws::String>
  DescribeListenerCertificatesRequest& WithMarker(MarkerT&& value) {
  ...
  inline DescribeListenerCertificatesRequest& WithPageSize(int value) {
    SetPageSize(value);
    return *this;
  }
  ///@}
