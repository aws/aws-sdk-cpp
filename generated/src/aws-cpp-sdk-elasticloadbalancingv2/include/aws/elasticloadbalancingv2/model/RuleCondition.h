 ...
 * a condition can't be empty.</p> <p>For Network Load Balancer listener rules, the
 * only supported condition is <code>source-ip</code>. Use
 * <code>SourceIpConfig</code> with <code>IpAddressType</code> to match on the IP
 * address type of the source traffic (<code>ipv4</code> or <code>ipv6</code>).</p>
...
class RuleCondition {
 public:
  ...
  ///@{
  /**
   * <p>The name of the field. The possible values are:</p> <ul> <li> <p>
   * <code>http-header</code> – [ALB] Matches on an HTTP header field.</p> </li> <li>
   * <p> <code>http-request-method</code> – [ALB] Matches on the HTTP request
   * method.</p> </li> <li> <p> <code>host-header</code> – [ALB] Matches on the host
   * header.</p> </li> <li> <p> <code>path-pattern</code> – [ALB] Matches on the URL
   * path of the request.</p> </li> <li> <p> <code>query-string</code> – [ALB]
   * Matches on a query string parameter.</p> </li> <li> <p> <code>source-ip</code> –
   * [ALB, NLB] Matches on the source IP address. For ALB, use
   * <code>SourceIpConfig</code> with <code>Values</code> to specify CIDR ranges. For
   * NLB, use <code>SourceIpConfig</code> with <code>IpAddressType</code> to match
   * the IP address type (<code>ipv4</code> or <code>ipv6</code>).</p> </li> </ul>
   */
  ...
  void SetHostHeaderConfig(HostHeaderConfigT&& value) {
    ...
    m_hostHeaderConfig = std::forward<HostHeaderConfigT>(value);
  }
  template <typename HostHeaderConfigT = HostHeaderConditionConfig>
  RuleCondition& WithHostHeaderConfig(HostHeaderConfigT&& value) {
    SetHostHeaderConfig(std::forward<HostHeaderConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPathPatternConfig(PathPatternConfigT&& value) {
    ...
    m_pathPatternConfig = std::forward<PathPatternConfigT>(value);
  }
  template <typename PathPatternConfigT = PathPatternConditionConfig>
  RuleCondition& WithPathPatternConfig(PathPatternConfigT&& value) {
    SetPathPatternConfig(std::forward<PathPatternConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetHttpHeaderConfig(HttpHeaderConfigT&& value) {
    ...
    m_httpHeaderConfig = std::forward<HttpHeaderConfigT>(value);
  }
  template <typename HttpHeaderConfigT = HttpHeaderConditionConfig>
  RuleCondition& WithHttpHeaderConfig(HttpHeaderConfigT&& value) {
    SetHttpHeaderConfig(std::forward<HttpHeaderConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetQueryStringConfig(QueryStringConfigT&& value) {
    ...
    m_queryStringConfig = std::forward<QueryStringConfigT>(value);
  }
  template <typename QueryStringConfigT = QueryStringConditionConfig>
  RuleCondition& WithQueryStringConfig(QueryStringConfigT&& value) {
    SetQueryStringConfig(std::forward<QueryStringConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetHttpRequestMethodConfig(HttpRequestMethodConfigT&& value) {
    ...
    m_httpRequestMethodConfig = std::forward<HttpRequestMethodConfigT>(value);
  }
  template <typename HttpRequestMethodConfigT = HttpRequestMethodConditionConfig>
  RuleCondition& WithHttpRequestMethodConfig(HttpRequestMethodConfigT&& value) {
    SetHttpRequestMethodConfig(std::forward<HttpRequestMethodConfigT>(value));
    return *this;
  }
  ///@}
