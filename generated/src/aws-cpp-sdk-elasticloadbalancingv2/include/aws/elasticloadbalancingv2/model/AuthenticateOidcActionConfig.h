...
class AuthenticateOidcActionConfig {
 public:
  ...
  inline AuthenticateOidcActionConfig& WithSessionTimeout(long long value) {
  ...
  AuthenticateOidcActionConfig& AddAuthenticationRequestExtraParams(AuthenticationRequestExtraParamsKeyT&& key,
  ...
  inline void SetOnUnauthenticatedRequest(AuthenticateOidcActionConditionalBehaviorEnum value) {
    m_onUnauthenticatedRequestHasBeenSet = true;
    m_onUnauthenticatedRequest = value;
  }
  inline AuthenticateOidcActionConfig& WithOnUnauthenticatedRequest(AuthenticateOidcActionConditionalBehaviorEnum value) {
  ...
  inline void SetUseExistingClientSecret(bool value) {
    m_useExistingClientSecretHasBeenSet = true;
    m_useExistingClientSecret = value;
  }
  inline AuthenticateOidcActionConfig& WithUseExistingClientSecret(bool value) {
    SetUseExistingClientSecret(value);
    return *this;
  }
  ///@}
 private:
