...
namespace Model
{
  ...
  {
  public:
    AWS_ELASTICLOADBALANCINGV2_API GetTrustStoreCaCertificatesBundleRequest() = default;
  ...
  public:
    ...
    template<typename TrustStoreArnT = Aws::String>
    GetTrustStoreCaCertificatesBundleRequest& WithTrustStoreArn(TrustStoreArnT&& value) { SetTrustStoreArn(std::forward<TrustStoreArnT>(value)); return *this;}
    ///@}
  private:
