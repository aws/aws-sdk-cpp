...
class SetSubnetsRequest : public ElasticLoadBalancingv2Request {
 ...
 public:
  ...
  inline SetSubnetsRequest& WithIpAddressType(IpAddressType value) {
  ...
  inline SetSubnetsRequest& WithEnablePrefixForIpv6SourceNat(EnablePrefixForIpv6SourceNatEnum value) {
