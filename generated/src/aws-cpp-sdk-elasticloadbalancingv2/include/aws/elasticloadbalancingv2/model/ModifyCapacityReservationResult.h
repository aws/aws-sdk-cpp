...
class ModifyCapacityReservationResult {
 public:
  ...
  AWS_ELASTICLOADBALANCINGV2_API ModifyCapacityReservationResult& operator=(
  ...
  template <typename LastModifiedTimeT = Aws::Utils::DateTime>
  ModifyCapacityReservationResult& WithLastModifiedTime(LastModifiedTimeT&& value) {
  ...
  inline ModifyCapacityReservationResult& WithDecreaseRequestsRemaining(int value) {
  ...
  template <typename MinimumLoadBalancerCapacityT = MinimumLoadBalancerCapacity>
  ModifyCapacityReservationResult& WithMinimumLoadBalancerCapacity(MinimumLoadBalancerCapacityT&& value) {
  ...
  template <typename CapacityReservationStateT = Aws::Vector<ZonalCapacityReservationState>>
  ModifyCapacityReservationResult& WithCapacityReservationState(CapacityReservationStateT&& value) {
  ...
  ModifyCapacityReservationResult& AddCapacityReservationState(CapacityReservationStateT&& value) {
    m_capacityReservationStateHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ModifyCapacityReservationResult& WithResponseMetadata(ResponseMetadataT&& value) {
