...
class SetSubnetsResult {
 public:
  ...
  template <typename AvailabilityZonesT = Aws::Vector<AvailabilityZone>>
  SetSubnetsResult& WithAvailabilityZones(AvailabilityZonesT&& value) {
    SetAvailabilityZones(std::forward<AvailabilityZonesT>(value));
    return *this;
  }
  template <typename AvailabilityZonesT = AvailabilityZone>
  SetSubnetsResult& AddAvailabilityZones(AvailabilityZonesT&& value) {
    m_availabilityZonesHasBeenSet = true;
  ...
  inline SetSubnetsResult& WithIpAddressType(IpAddressType value) {
  ...
  inline SetSubnetsResult& WithEnablePrefixForIpv6SourceNat(EnablePrefixForIpv6SourceNatEnum value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  SetSubnetsResult& WithResponseMetadata(ResponseMetadataT&& value) {
