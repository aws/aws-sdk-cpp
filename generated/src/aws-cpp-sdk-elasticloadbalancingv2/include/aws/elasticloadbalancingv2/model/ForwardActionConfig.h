...
class ForwardActionConfig {
 public:
  ...
  void SetTargetGroupStickinessConfig(TargetGroupStickinessConfigT&& value) {
    ...
    m_targetGroupStickinessConfig = std::forward<TargetGroupStickinessConfigT>(value);
  }
  template <typename TargetGroupStickinessConfigT = TargetGroupStickinessConfig>
  ForwardActionConfig& WithTargetGroupStickinessConfig(TargetGroupStickinessConfigT&& value) {
    SetTargetGroupStickinessConfig(std::forward<TargetGroupStickinessConfigT>(value));
    return *this;
  }
  ///@}
 private:
