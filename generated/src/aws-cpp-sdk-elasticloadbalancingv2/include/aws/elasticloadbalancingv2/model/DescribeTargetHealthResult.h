...
class DescribeTargetHealthResult {
 public:
  ...
  AWS_ELASTICLOADBALANCINGV2_API DescribeTargetHealthResult& operator=(
  ...
  void SetTargetHealthDescriptions(TargetHealthDescriptionsT&& value) {
    ...
    m_targetHealthDescriptions = std::forward<TargetHealthDescriptionsT>(value);
  }
  template <typename TargetHealthDescriptionsT = Aws::Vector<TargetHealthDescription>>
  DescribeTargetHealthResult& WithTargetHealthDescriptions(TargetHealthDescriptionsT&& value) {
    SetTargetHealthDescriptions(std::forward<TargetHealthDescriptionsT>(value));
    return *this;
  }
  ...
  DescribeTargetHealthResult& AddTargetHealthDescriptions(TargetHealthDescriptionsT&& value) {
    m_targetHealthDescriptionsHasBeenSet = true;
    m_targetHealthDescriptions.emplace_back(std::forward<TargetHealthDescriptionsT>(value));
    return *this;
  }
  ///@}
