...
class AdministrativeOverride {
 public:
  ...
  inline void SetState(TargetAdministrativeOverrideStateEnum value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline AdministrativeOverride& WithState(TargetAdministrativeOverrideStateEnum value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline void SetReason(TargetAdministrativeOverrideReasonEnum value) {
    m_reasonHasBeenSet = true;
    m_reason = value;
  }
  inline AdministrativeOverride& WithReason(TargetAdministrativeOverrideReasonEnum value) {
    SetReason(value);
    return *this;
  }
  ///@}
  ...
  template <typename DescriptionT = Aws::String>
  AdministrativeOverride& WithDescription(DescriptionT&& value) {
