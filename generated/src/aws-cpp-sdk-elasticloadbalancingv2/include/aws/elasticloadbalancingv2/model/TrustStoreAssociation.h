...
/**
 * <p>Information about the resources a trust store is associated
 * with.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/elasticloadbalancingv2-2015-12-01/TrustStoreAssociation">AWS
 * API Reference</a></p>
 */
class TrustStoreAssociation {
 public:
  ...
  template <typename ResourceArnT = Aws::String>
  TrustStoreAssociation& WithResourceArn(ResourceArnT&& value) {
