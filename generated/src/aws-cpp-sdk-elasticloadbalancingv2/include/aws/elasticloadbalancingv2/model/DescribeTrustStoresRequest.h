...
class DescribeTrustStoresRequest : public ElasticLoadBalancingv2Request {
 ...
 public:
  ...
  void SetTrustStoreArns(TrustStoreArnsT&& value) {
    m_trustStoreArnsHasBeenSet = true;
    m_trustStoreArns = std::forward<TrustStoreArnsT>(value);
  }
  template <typename TrustStoreArnsT = Aws::Vector<Aws::String>>
  DescribeTrustStoresRequest& WithTrustStoreArns(TrustStoreArnsT&& value) {
    SetTrustStoreArns(std::forward<TrustStoreArnsT>(value));
    return *this;
  }
  template <typename TrustStoreArnsT = Aws::String>
  DescribeTrustStoresRequest& AddTrustStoreArns(TrustStoreArnsT&& value) {
    m_trustStoreArnsHasBeenSet = true;
    m_trustStoreArns.emplace_back(std::forward<TrustStoreArnsT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeTrustStoresRequest& WithPageSize(int value) {
    SetPageSize(value);
    return *this;
  }
  ///@}
