...
class AddListenerCertificatesRequest : public ElasticLoadBalancingv2Request {
 ...
 public:
  ...
  template <typename ListenerArnT = Aws::String>
  AddListenerCertificatesRequest& WithListenerArn(ListenerArnT&& value) {
  ...
  template <typename CertificatesT = Aws::Vector<Certificate>>
  AddListenerCertificatesRequest& WithCertificates(CertificatesT&& value) {
    SetCertificates(std::forward<CertificatesT>(value));
    return *this;
  }
  template <typename CertificatesT = Certificate>
  AddListenerCertificatesRequest& AddCertificates(CertificatesT&& value) {
    m_certificatesHasBeenSet = true;
