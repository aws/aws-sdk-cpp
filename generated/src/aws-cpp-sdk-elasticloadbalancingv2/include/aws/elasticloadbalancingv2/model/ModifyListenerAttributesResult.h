...
class ModifyListenerAttributesResult {
 public:
  ...
  AWS_ELASTICLOADBALANCINGV2_API ModifyListenerAttributesResult& operator=(
  ...
  template <typename AttributesT = Aws::Vector<ListenerAttribute>>
  ModifyListenerAttributesResult& WithAttributes(AttributesT&& value) {
    SetAttributes(std::forward<AttributesT>(value));
    return *this;
  }
  template <typename AttributesT = ListenerAttribute>
  ModifyListenerAttributesResult& AddAttributes(AttributesT&& value) {
    m_attributesHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ModifyListenerAttributesResult& WithResponseMetadata(ResponseMetadataT&& value) {
