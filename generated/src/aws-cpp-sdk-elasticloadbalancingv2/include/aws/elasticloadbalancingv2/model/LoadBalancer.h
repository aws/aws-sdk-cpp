...
class LoadBalancer {
 public:
  ...
  void SetCanonicalHostedZoneId(CanonicalHostedZoneIdT&& value) {
    ...
    m_canonicalHostedZoneId = std::forward<CanonicalHostedZoneIdT>(value);
  }
  template <typename CanonicalHostedZoneIdT = Aws::String>
  LoadBalancer& WithCanonicalHostedZoneId(CanonicalHostedZoneIdT&& value) {
    SetCanonicalHostedZoneId(std::forward<CanonicalHostedZoneIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline LoadBalancer& WithScheme(LoadBalancerSchemeEnum value) {
    SetScheme(value);
    return *this;
  }
  ///@}
  ...
  inline LoadBalancer& WithType(LoadBalancerTypeEnum value) {
    SetType(value);
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::String& GetEnforceSecurityGroupInboundRulesOnPrivateLinkTraffic() const {
    return m_enforceSecurityGroupInboundRulesOnPrivateLinkTraffic;
  }
  inline bool EnforceSecurityGroupInboundRulesOnPrivateLinkTrafficHasBeenSet() const {
    return m_enforceSecurityGroupInboundRulesOnPrivateLinkTrafficHasBeenSet;
  }
  ...
  void SetEnforceSecurityGroupInboundRulesOnPrivateLinkTraffic(EnforceSecurityGroupInboundRulesOnPrivateLinkTrafficT&& value) {
    ...
    m_enforceSecurityGroupInboundRulesOnPrivateLinkTraffic = std::forward<EnforceSecurityGroupInboundRulesOnPrivateLinkTrafficT>(value);
  }
  template <typename EnforceSecurityGroupInboundRulesOnPrivateLinkTrafficT = Aws::String>
  LoadBalancer& WithEnforceSecurityGroupInboundRulesOnPrivateLinkTraffic(EnforceSecurityGroupInboundRulesOnPrivateLinkTrafficT&& value) {
    SetEnforceSecurityGroupInboundRulesOnPrivateLinkTraffic(std::forward<EnforceSecurityGroupInboundRulesOnPrivateLinkTrafficT>(value));
    return *this;
  }
  ///@}
  ...
  inline LoadBalancer& WithEnablePrefixForIpv6SourceNat(EnablePrefixForIpv6SourceNatEnum value) {
