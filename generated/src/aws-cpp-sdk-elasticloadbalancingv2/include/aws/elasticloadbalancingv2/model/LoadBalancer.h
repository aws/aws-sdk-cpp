...
namespace Model
{
  ...
  public:
    ...
    inline LoadBalancer& WithIpamPools(const IpamPools& value) { SetIpamPools(value); return *this;}
    inline LoadBalancer& WithIpamPools(IpamPools&& value) { SetIpamPools(std::move(value)); return *this;}
    ///@}
  private:
