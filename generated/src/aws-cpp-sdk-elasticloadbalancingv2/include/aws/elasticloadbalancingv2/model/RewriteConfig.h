...
namespace Model
{
  ...
  public:
    ...
    template<typename RegexT = Aws::String>
    RewriteConfig& WithRegex(RegexT&& value) { SetRegex(std::forward<RegexT>(value)); return *this;}
    ///@}
    ...
    void SetReplace(ReplaceT&& value) { m_replaceHasBeenSet = true; m_replace = std::forward<ReplaceT>(value); }
    template<typename ReplaceT = Aws::String>
    RewriteConfig& WithReplace(ReplaceT&& value) { SetReplace(std::forward<ReplaceT>(value)); return *this;}
    ///@}
  private:
