...
class CreateListenerResult {
 public:
  ...
  template <typename ListenersT = Aws::Vector<Listener>>
  CreateListenerResult& WithListeners(ListenersT&& value) {
    SetListeners(std::forward<ListenersT>(value));
    return *this;
  }
  template <typename ListenersT = Listener>
  CreateListenerResult& AddListeners(ListenersT&& value) {
    m_listenersHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateListenerResult& WithResponseMetadata(ResponseMetadataT&& value) {
