...
class TargetHealth {
 public:
  ...
  inline void SetState(TargetHealthStateEnum value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline TargetHealth& WithState(TargetHealthStateEnum value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline void SetReason(TargetHealthReasonEnum value) {
    m_reasonHasBeenSet = true;
    m_reason = value;
  }
  inline TargetHealth& WithReason(TargetHealthReasonEnum value) {
    SetReason(value);
    return *this;
  }
  ///@}
