...
class AnomalyDetection {
 public:
  ...
  inline void SetResult(AnomalyResultEnum value) {
    m_resultHasBeenSet = true;
    m_result = value;
  }
  inline AnomalyDetection& WithResult(AnomalyResultEnum value) {
    SetResult(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMitigationInEffect(MitigationInEffectEnum value) {
    m_mitigationInEffectHasBeenSet = true;
    m_mitigationInEffect = value;
  }
  inline AnomalyDetection& WithMitigationInEffect(MitigationInEffectEnum value) {
    SetMitigationInEffect(value);
    return *this;
  }
  ///@}
 private:
