...
namespace Model
{
  ...
  public:
    ...
    template<typename LocationT = Aws::String>
    GetTrustStoreRevocationContentResult& WithLocation(LocationT&& value) { SetLocation(std::forward<LocationT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    GetTrustStoreRevocationContentResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
