...
namespace Model
{
  ...
  public:
    ...
    template<typename RewritesT = Aws::Vector<RewriteConfig>>
    HostHeaderRewriteConfig& WithRewrites(RewritesT&& value) { SetRewrites(std::forward<RewritesT>(value)); return *this;}
    template<typename RewritesT = RewriteConfig>
    HostHeaderRewriteConfig& AddRewrites(RewritesT&& value) { m_rewritesHasBeenSet = true; m_rewrites.emplace_back(std::forward<RewritesT>(value)); return *this; }
    ///@}
  private:
