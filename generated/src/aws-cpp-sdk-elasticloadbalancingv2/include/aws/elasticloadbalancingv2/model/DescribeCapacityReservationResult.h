...
namespace Model
{
  ...
  public:
    ...
    template<typename LastModifiedTimeT = Aws::Utils::DateTime>
    DescribeCapacityReservationResult& WithLastModifiedTime(LastModifiedTimeT&& value) { SetLastModifiedTime(std::forward<LastModifiedTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename MinimumLoadBalancerCapacityT = MinimumLoadBalancerCapacity>
    DescribeCapacityReservationResult& WithMinimumLoadBalancerCapacity(MinimumLoadBalancerCapacityT&& value) { SetMinimumLoadBalancerCapacity(std::forward<MinimumLoadBalancerCapacityT>(value)); return *this;}
    ///@}
    ...
    template<typename CapacityReservationStateT = Aws::Vector<ZonalCapacityReservationState>>
    DescribeCapacityReservationResult& WithCapacityReservationState(CapacityReservationStateT&& value) { SetCapacityReservationState(std::forward<CapacityReservationStateT>(value)); return *this;}
    template<typename CapacityReservationStateT = ZonalCapacityReservationState>
    DescribeCapacityReservationResult& AddCapacityReservationState(CapacityReservationStateT&& value) { m_capacityReservationStateHasBeenSet = true; m_capacityReservationState.emplace_back(std::forward<CapacityReservationStateT>(value)); return *this; }
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    DescribeCapacityReservationResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
