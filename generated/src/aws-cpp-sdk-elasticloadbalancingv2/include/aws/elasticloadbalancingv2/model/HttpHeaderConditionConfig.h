...
class HttpHeaderConditionConfig {
 public:
  ...
  void SetHttpHeaderName(HttpHeaderNameT&& value) {
    m_httpHeaderNameHasBeenSet = true;
    m_httpHeaderName = std::forward<HttpHeaderNameT>(value);
  }
  template <typename HttpHeaderNameT = Aws::String>
  HttpHeaderConditionConfig& WithHttpHeaderName(HttpHeaderNameT&& value) {
    SetHttpHeaderName(std::forward<HttpHeaderNameT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  HttpHeaderConditionConfig& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  HttpHeaderConditionConfig& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
