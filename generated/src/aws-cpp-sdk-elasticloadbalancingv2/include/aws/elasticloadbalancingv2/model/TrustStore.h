...
class TrustStore {
 public:
  ...
  inline TrustStore& WithStatus(TrustStoreStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline TrustStore& WithNumberOfCaCertificates(int value) {
  ...
  inline void SetTotalRevokedEntries(long long value) {
    m_totalRevokedEntriesHasBeenSet = true;
    m_totalRevokedEntries = value;
  }
  inline TrustStore& WithTotalRevokedEntries(long long value) {
    SetTotalRevokedEntries(value);
    return *this;
  }
  ///@}
 private:
