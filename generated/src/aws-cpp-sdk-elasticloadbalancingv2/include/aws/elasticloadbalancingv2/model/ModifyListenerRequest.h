...
class ModifyListenerRequest : public ElasticLoadBalancingv2Request {
 ...
 public:
  ...
  template <typename ListenerArnT = Aws::String>
  ModifyListenerRequest& WithListenerArn(ListenerArnT&& value) {
  ...
  inline ModifyListenerRequest& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  inline ModifyListenerRequest& WithProtocol(ProtocolEnum value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
  ...
  template <typename SslPolicyT = Aws::String>
  ModifyListenerRequest& WithSslPolicy(SslPolicyT&& value) {
  ...
  template <typename CertificatesT = Aws::Vector<Certificate>>
  ModifyListenerRequest& WithCertificates(CertificatesT&& value) {
    SetCertificates(std::forward<CertificatesT>(value));
    return *this;
  }
  template <typename CertificatesT = Certificate>
  ModifyListenerRequest& AddCertificates(CertificatesT&& value) {
    m_certificatesHasBeenSet = true;
  ...
  template <typename DefaultActionsT = Aws::Vector<Action>>
  ModifyListenerRequest& WithDefaultActions(DefaultActionsT&& value) {
    SetDefaultActions(std::forward<DefaultActionsT>(value));
    return *this;
  }
  template <typename DefaultActionsT = Action>
  ModifyListenerRequest& AddDefaultActions(DefaultActionsT&& value) {
    m_defaultActionsHasBeenSet = true;
  ...
  template <typename AlpnPolicyT = Aws::Vector<Aws::String>>
  ModifyListenerRequest& WithAlpnPolicy(AlpnPolicyT&& value) {
    SetAlpnPolicy(std::forward<AlpnPolicyT>(value));
    return *this;
  }
  template <typename AlpnPolicyT = Aws::String>
  ModifyListenerRequest& AddAlpnPolicy(AlpnPolicyT&& value) {
    m_alpnPolicyHasBeenSet = true;
  ...
  template <typename MutualAuthenticationT = MutualAuthenticationAttributes>
  ModifyListenerRequest& WithMutualAuthentication(MutualAuthenticationT&& value) {
