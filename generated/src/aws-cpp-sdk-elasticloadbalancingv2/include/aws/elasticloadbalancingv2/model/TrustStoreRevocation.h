...
class TrustStoreRevocation {
 public:
  ...
  inline TrustStoreRevocation& WithRevocationId(long long value) {
  ...
  inline TrustStoreRevocation& WithRevocationType(RevocationType value) {
  ...
  inline TrustStoreRevocation& WithNumberOfRevokedEntries(long long value) {
