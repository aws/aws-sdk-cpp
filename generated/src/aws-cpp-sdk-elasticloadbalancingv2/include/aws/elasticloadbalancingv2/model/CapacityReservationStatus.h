...
class CapacityReservationStatus {
 public:
  ...
  inline void SetCode(CapacityReservationStateEnum value) {
    m_codeHasBeenSet = true;
    m_code = value;
  }
  inline CapacityReservationStatus& WithCode(CapacityReservationStateEnum value) {
    SetCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename ReasonT = Aws::String>
  CapacityReservationStatus& WithReason(ReasonT&& value) {
