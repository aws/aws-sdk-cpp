...
class AddListenerCertificatesResult {
 public:
  ...
  AWS_ELASTICLOADBALANCINGV2_API AddListenerCertificatesResult& operator=(
  ...
  template <typename CertificatesT = Aws::Vector<Certificate>>
  AddListenerCertificatesResult& WithCertificates(CertificatesT&& value) {
    SetCertificates(std::forward<CertificatesT>(value));
    return *this;
  }
  template <typename CertificatesT = Certificate>
  AddListenerCertificatesResult& AddCertificates(CertificatesT&& value) {
    m_certificatesHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  AddListenerCertificatesResult& WithResponseMetadata(ResponseMetadataT&& value) {
