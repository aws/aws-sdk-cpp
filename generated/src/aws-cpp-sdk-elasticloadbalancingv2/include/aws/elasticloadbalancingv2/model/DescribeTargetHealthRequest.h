...
class DescribeTargetHealthRequest : public ElasticLoadBalancingv2Request {
 ...
 public:
  ...
  template <typename TargetGroupArnT = Aws::String>
  DescribeTargetHealthRequest& WithTargetGroupArn(TargetGroupArnT&& value) {
  ...
  template <typename TargetsT = Aws::Vector<TargetDescription>>
  DescribeTargetHealthRequest& WithTargets(TargetsT&& value) {
    SetTargets(std::forward<TargetsT>(value));
    return *this;
  }
  template <typename TargetsT = TargetDescription>
  DescribeTargetHealthRequest& AddTargets(TargetsT&& value) {
    m_targetsHasBeenSet = true;
  ...
  template <typename IncludeT = Aws::Vector<DescribeTargetHealthInputIncludeEnum>>
  DescribeTargetHealthRequest& WithInclude(IncludeT&& value) {
    SetInclude(std::forward<IncludeT>(value));
    return *this;
  }
  inline DescribeTargetHealthRequest& AddInclude(DescribeTargetHealthInputIncludeEnum value) {
    m_includeHasBeenSet = true;
