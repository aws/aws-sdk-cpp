...
class DescribeLoadBalancersRequest : public ElasticLoadBalancingv2Request {
 ...
 public:
  ...
  template <typename NamesT = Aws::Vector<Aws::String>>
  DescribeLoadBalancersRequest& WithNames(NamesT&& value) {
    SetNames(std::forward<NamesT>(value));
    return *this;
  }
  template <typename NamesT = Aws::String>
  DescribeLoadBalancersRequest& AddNames(NamesT&& value) {
    m_namesHasBeenSet = true;
  ...
  inline DescribeLoadBalancersRequest& WithPageSize(int value) {
    SetPageSize(value);
    return *this;
  }
  ///@}
