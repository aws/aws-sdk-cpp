...
class RemoveTagsRequest : public ElasticLoadBalancingv2Request {
 public:
  AWS_ELASTICLOADBALANCINGV2_API RemoveTagsRequest() = default;
 ...
 public:
  ...
  template <typename ResourceArnsT = Aws::Vector<Aws::String>>
  RemoveTagsRequest& WithResourceArns(ResourceArnsT&& value) {
    SetResourceArns(std::forward<ResourceArnsT>(value));
    return *this;
  }
  template <typename ResourceArnsT = Aws::String>
  RemoveTagsRequest& AddResourceArns(ResourceArnsT&& value) {
    m_resourceArnsHasBeenSet = true;
