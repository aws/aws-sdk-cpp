...
class SslPolicy {
 public:
  ...
  void SetSslProtocols(SslProtocolsT&& value) {
    ...
    m_sslProtocols = std::forward<SslProtocolsT>(value);
  }
  template <typename SslProtocolsT = Aws::Vector<Aws::String>>
  SslPolicy& WithSslProtocols(SslProtocolsT&& value) {
    SetSslProtocols(std::forward<SslProtocolsT>(value));
    return *this;
  }
  template <typename SslProtocolsT = Aws::String>
  SslPolicy& AddSslProtocols(SslProtocolsT&& value) {
    m_sslProtocolsHasBeenSet = true;
    m_sslProtocols.emplace_back(std::forward<SslProtocolsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSupportedLoadBalancerTypes(SupportedLoadBalancerTypesT&& value) {
    ...
    m_supportedLoadBalancerTypes = std::forward<SupportedLoadBalancerTypesT>(value);
  }
  template <typename SupportedLoadBalancerTypesT = Aws::Vector<Aws::String>>
  SslPolicy& WithSupportedLoadBalancerTypes(SupportedLoadBalancerTypesT&& value) {
    SetSupportedLoadBalancerTypes(std::forward<SupportedLoadBalancerTypesT>(value));
    return *this;
  }
  ...
  SslPolicy& AddSupportedLoadBalancerTypes(SupportedLoadBalancerTypesT&& value) {
    m_supportedLoadBalancerTypesHasBeenSet = true;
    m_supportedLoadBalancerTypes.emplace_back(std::forward<SupportedLoadBalancerTypesT>(value));
    return *this;
  }
  ///@}
 private:
