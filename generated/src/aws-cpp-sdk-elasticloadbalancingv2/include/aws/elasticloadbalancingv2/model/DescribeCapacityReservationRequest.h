...
namespace Model
{
  ...
  {
  public:
    AWS_ELASTICLOADBALANCINGV2_API DescribeCapacityReservationRequest() = default;
  ...
  public:
    ...
    template<typename LoadBalancerArnT = Aws::String>
    DescribeCapacityReservationRequest& WithLoadBalancerArn(LoadBalancerArnT&& value) { SetLoadBalancerArn(std::forward<LoadBalancerArnT>(value)); return *this;}
    ///@}
  private:
