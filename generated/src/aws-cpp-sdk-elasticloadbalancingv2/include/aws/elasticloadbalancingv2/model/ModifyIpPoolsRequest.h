...
class ModifyIpPoolsRequest : public ElasticLoadBalancingv2Request {
 ...
 public:
  ...
  template <typename LoadBalancerArnT = Aws::String>
  ModifyIpPoolsRequest& WithLoadBalancerArn(LoadBalancerArnT&& value) {
  ...
  template <typename IpamPoolsT = IpamPools>
  ModifyIpPoolsRequest& WithIpamPools(IpamPoolsT&& value) {
  ...
  void SetRemoveIpamPools(RemoveIpamPoolsT&& value) {
    m_removeIpamPoolsHasBeenSet = true;
    m_removeIpamPools = std::forward<RemoveIpamPoolsT>(value);
  }
  template <typename RemoveIpamPoolsT = Aws::Vector<RemoveIpamPoolEnum>>
  ModifyIpPoolsRequest& WithRemoveIpamPools(RemoveIpamPoolsT&& value) {
    SetRemoveIpamPools(std::forward<RemoveIpamPoolsT>(value));
    return *this;
  }
  inline ModifyIpPoolsRequest& AddRemoveIpamPools(RemoveIpamPoolEnum value) {
    m_removeIpamPoolsHasBeenSet = true;
    m_removeIpamPools.push_back(value);
    return *this;
  }
  ///@}
 private:
