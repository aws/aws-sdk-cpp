...
class DescribeTrustStoreAssociationsResult {
 public:
  ...
  AWS_ELASTICLOADBALANCINGV2_API DescribeTrustStoreAssociationsResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  ...
  void SetTrustStoreAssociations(TrustStoreAssociationsT&& value) {
    m_trustStoreAssociationsHasBeenSet = true;
    m_trustStoreAssociations = std::forward<TrustStoreAssociationsT>(value);
  }
  template <typename TrustStoreAssociationsT = Aws::Vector<TrustStoreAssociation>>
  DescribeTrustStoreAssociationsResult& WithTrustStoreAssociations(TrustStoreAssociationsT&& value) {
    SetTrustStoreAssociations(std::forward<TrustStoreAssociationsT>(value));
    return *this;
  }
  template <typename TrustStoreAssociationsT = TrustStoreAssociation>
  DescribeTrustStoreAssociationsResult& AddTrustStoreAssociations(TrustStoreAssociationsT&& value) {
    m_trustStoreAssociationsHasBeenSet = true;
    m_trustStoreAssociations.emplace_back(std::forward<TrustStoreAssociationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextMarkerT = Aws::String>
  DescribeTrustStoreAssociationsResult& WithNextMarker(NextMarkerT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeTrustStoreAssociationsResult& WithResponseMetadata(ResponseMetadataT&& value) {
