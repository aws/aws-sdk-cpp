...
class ModifyCapacityReservationRequest : public ElasticLoadBalancingv2Request {
 ...
 public:
  ...
  inline void SetResetCapacityReservation(bool value) {
    m_resetCapacityReservationHasBeenSet = true;
    m_resetCapacityReservation = value;
  }
  inline ModifyCapacityReservationRequest& WithResetCapacityReservation(bool value) {
    SetResetCapacityReservation(value);
    return *this;
  }
  ///@}
 private:
