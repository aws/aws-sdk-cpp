...
class TargetHealthDescription {
 public:
  ...
  void SetHealthCheckPort(HealthCheckPortT&& value) {
    ...
    m_healthCheckPort = std::forward<HealthCheckPortT>(value);
  }
  template <typename HealthCheckPortT = Aws::String>
  TargetHealthDescription& WithHealthCheckPort(HealthCheckPortT&& value) {
    SetHealthCheckPort(std::forward<HealthCheckPortT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAnomalyDetection(AnomalyDetectionT&& value) {
    ...
    m_anomalyDetection = std::forward<AnomalyDetectionT>(value);
  }
  template <typename AnomalyDetectionT = AnomalyDetection>
  TargetHealthDescription& WithAnomalyDetection(AnomalyDetectionT&& value) {
    SetAnomalyDetection(std::forward<AnomalyDetectionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAdministrativeOverride(AdministrativeOverrideT&& value) {
    ...
    m_administrativeOverride = std::forward<AdministrativeOverrideT>(value);
  }
  template <typename AdministrativeOverrideT = AdministrativeOverride>
  TargetHealthDescription& WithAdministrativeOverride(AdministrativeOverrideT&& value) {
    SetAdministrativeOverride(std::forward<AdministrativeOverrideT>(value));
    return *this;
  }
  ///@}
 private:
