...
class AuthenticateCognitoActionConfig {
 public:
  ...
  void SetUserPoolClientId(UserPoolClientIdT&& value) {
    m_userPoolClientIdHasBeenSet = true;
    m_userPoolClientId = std::forward<UserPoolClientIdT>(value);
  }
  template <typename UserPoolClientIdT = Aws::String>
  AuthenticateCognitoActionConfig& WithUserPoolClientId(UserPoolClientIdT&& value) {
    SetUserPoolClientId(std::forward<UserPoolClientIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSessionCookieName(SessionCookieNameT&& value) {
    ...
    m_sessionCookieName = std::forward<SessionCookieNameT>(value);
  }
  template <typename SessionCookieNameT = Aws::String>
  AuthenticateCognitoActionConfig& WithSessionCookieName(SessionCookieNameT&& value) {
    SetSessionCookieName(std::forward<SessionCookieNameT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ScopeT = Aws::String>
  AuthenticateCognitoActionConfig& WithScope(ScopeT&& value) {
  ...
  inline void SetSessionTimeout(long long value) {
    m_sessionTimeoutHasBeenSet = true;
    m_sessionTimeout = value;
  }
  inline AuthenticateCognitoActionConfig& WithSessionTimeout(long long value) {
   ...
   */
  inline const Aws::Map<Aws::String, Aws::String>& GetAuthenticationRequestExtraParams() const {
    return m_authenticationRequestExtraParams;
  }
  ...
  void SetAuthenticationRequestExtraParams(AuthenticationRequestExtraParamsT&& value) {
    ...
    m_authenticationRequestExtraParams = std::forward<AuthenticationRequestExtraParamsT>(value);
  }
  template <typename AuthenticationRequestExtraParamsT = Aws::Map<Aws::String, Aws::String>>
  AuthenticateCognitoActionConfig& WithAuthenticationRequestExtraParams(AuthenticationRequestExtraParamsT&& value) {
    SetAuthenticationRequestExtraParams(std::forward<AuthenticationRequestExtraParamsT>(value));
    return *this;
  }
  ...
  AuthenticateCognitoActionConfig& AddAuthenticationRequestExtraParams(AuthenticationRequestExtraParamsKeyT&& key,
                                                                       AuthenticationRequestExtraParamsValueT&& value) {
    m_authenticationRequestExtraParamsHasBeenSet = true;
    m_authenticationRequestExtraParams.emplace(std::forward<AuthenticationRequestExtraParamsKeyT>(key),
                                               std::forward<AuthenticationRequestExtraParamsValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetOnUnauthenticatedRequest(AuthenticateCognitoActionConditionalBehaviorEnum value) {
    m_onUnauthenticatedRequestHasBeenSet = true;
    m_onUnauthenticatedRequest = value;
  }
  inline AuthenticateCognitoActionConfig& WithOnUnauthenticatedRequest(AuthenticateCognitoActionConditionalBehaviorEnum value) {
    SetOnUnauthenticatedRequest(value);
    return *this;
  }
  ///@}
 private:
