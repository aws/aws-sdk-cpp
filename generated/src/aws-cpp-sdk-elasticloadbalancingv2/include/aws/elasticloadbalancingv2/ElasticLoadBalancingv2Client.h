...
#include <aws/elasticloadbalancingv2/ElasticLoadBalancingv2Waiter.h>
 ...
 */
class AWS_ELASTICLOADBALANCINGV2_API ElasticLoadBalancingv2Client
    : public Aws::Client::AWSXMLClient,
      public Aws::Client::ClientWithAsyncTemplateMethods<ElasticLoadBalancingv2Client>,
      public ElasticLoadBalancingv2PaginationBase<ElasticLoadBalancingv2Client>,
      public ElasticLoadBalancingv2Waiter<ElasticLoadBalancingv2Client> {
 public:
   ...
   */
  ElasticLoadBalancingv2Client(const Aws::ElasticLoadBalancingv2::ElasticLoadBalancingv2ClientConfiguration& clientConfiguration =
                                   Aws::ElasticLoadBalancingv2::ElasticLoadBalancingv2ClientConfiguration(),
  ...
  ElasticLoadBalancingv2Client(const Aws::Auth::AWSCredentials& credentials,
                               std::shared_ptr<ElasticLoadBalancingv2EndpointProviderBase> endpointProvider = nullptr,
                               const Aws::ElasticLoadBalancingv2::ElasticLoadBalancingv2ClientConfiguration& clientConfiguration =
                                   Aws::ElasticLoadBalancingv2::ElasticLoadBalancingv2ClientConfiguration());
  ...
  /**
   * A Callable wrapper for AddListenerCertificates that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AddListenerCertificates that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AddListenerCertificatesRequestT = Model::AddListenerCertificatesRequest>
  void AddListenerCertificatesAsync(const AddListenerCertificatesRequestT& request,
  ...
  /**
   * A Callable wrapper for AddTrustStoreRevocations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AddTrustStoreRevocations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AddTrustStoreRevocationsRequestT = Model::AddTrustStoreRevocationsRequest>
  void AddTrustStoreRevocationsAsync(const AddTrustStoreRevocationsRequestT& request,
                                     const AddTrustStoreRevocationsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateLoadBalancer that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateLoadBalancer that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateLoadBalancerRequestT = Model::CreateLoadBalancerRequest>
  void CreateLoadBalancerAsync(const CreateLoadBalancerRequestT& request, const CreateLoadBalancerResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * with an Application Load Balancer or a dual-stack Network Load Balancer.</p>
   * <p>Each rule consists of a priority, one or more actions, and one or more
   ...
   * rule are performed. For more information, see <a
   ...
   * rules</a> in the <i>Application Load Balancers Guide</i> or <a
   * href="https://docs.aws.amazon.com/elasticloadbalancing/latest/network/load-balancer-listeners.html#listener-rules">Listener
   * rules</a> in the <i>Network Load Balancers Guide</i>.</p><p><h3>See Also:</h3>
   * <a
  ...
  /**
   * A Callable wrapper for DeleteLoadBalancer that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteLoadBalancer that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteLoadBalancerRequestT = Model::DeleteLoadBalancerRequest>
  void DeleteLoadBalancerAsync(const DeleteLoadBalancerRequestT& request, const DeleteLoadBalancerResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteSharedTrustStoreAssociationOutcome DeleteSharedTrustStoreAssociation(
      const Model::DeleteSharedTrustStoreAssociationRequest& request) const;

  /**
   * A Callable wrapper for DeleteSharedTrustStoreAssociation that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DeleteSharedTrustStoreAssociationRequestT = Model::DeleteSharedTrustStoreAssociationRequest>
  Model::DeleteSharedTrustStoreAssociationOutcomeCallable DeleteSharedTrustStoreAssociationCallable(
      const DeleteSharedTrustStoreAssociationRequestT& request) const {
    return SubmitCallable(&ElasticLoadBalancingv2Client::DeleteSharedTrustStoreAssociation, request);
  }

  /**
   * An Async wrapper for DeleteSharedTrustStoreAssociation that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteSharedTrustStoreAssociationRequestT = Model::DeleteSharedTrustStoreAssociationRequest>
  void DeleteSharedTrustStoreAssociationAsync(const DeleteSharedTrustStoreAssociationRequestT& request,
                                              const DeleteSharedTrustStoreAssociationResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeCapacityReservationOutcome DescribeCapacityReservation(
      const Model::DescribeCapacityReservationRequest& request) const;

  /**
   * A Callable wrapper for DescribeCapacityReservation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeCapacityReservationRequestT = Model::DescribeCapacityReservationRequest>
  Model::DescribeCapacityReservationOutcomeCallable DescribeCapacityReservationCallable(
      const DescribeCapacityReservationRequestT& request) const {
    return SubmitCallable(&ElasticLoadBalancingv2Client::DescribeCapacityReservation, request);
  }

  /**
   * An Async wrapper for DescribeCapacityReservation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeCapacityReservationRequestT = Model::DescribeCapacityReservationRequest>
  void DescribeCapacityReservationAsync(const DescribeCapacityReservationRequestT& request,
                                        const DescribeCapacityReservationResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::DescribeListenerAttributesOutcome DescribeListenerAttributes(
      const Model::DescribeListenerAttributesRequest& request) const;

  /**
   * A Callable wrapper for DescribeListenerAttributes that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeListenerAttributesRequestT = Model::DescribeListenerAttributesRequest>
  Model::DescribeListenerAttributesOutcomeCallable DescribeListenerAttributesCallable(
      const DescribeListenerAttributesRequestT& request) const {
    return SubmitCallable(&ElasticLoadBalancingv2Client::DescribeListenerAttributes, request);
  }

  /**
   * An Async wrapper for DescribeListenerAttributes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeListenerAttributesRequestT = Model::DescribeListenerAttributesRequest>
  void DescribeListenerAttributesAsync(const DescribeListenerAttributesRequestT& request,
                                       const DescribeListenerAttributesResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeListenerCertificatesOutcome DescribeListenerCertificates(
      const Model::DescribeListenerCertificatesRequest& request) const;

  /**
   * A Callable wrapper for DescribeListenerCertificates that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeListenerCertificatesRequestT = Model::DescribeListenerCertificatesRequest>
  Model::DescribeListenerCertificatesOutcomeCallable DescribeListenerCertificatesCallable(
      const DescribeListenerCertificatesRequestT& request) const {
    return SubmitCallable(&ElasticLoadBalancingv2Client::DescribeListenerCertificates, request);
  }

  /**
   * An Async wrapper for DescribeListenerCertificates that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeListenerCertificatesRequestT = Model::DescribeListenerCertificatesRequest>
  void DescribeListenerCertificatesAsync(const DescribeListenerCertificatesRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeListeners that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeListeners that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeListenersRequestT = Model::DescribeListenersRequest>
  void DescribeListenersAsync(const DescribeListenersResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const DescribeListenersRequestT& request = {}) const {
  ...
  virtual Model::DescribeLoadBalancerAttributesOutcome DescribeLoadBalancerAttributes(
      const Model::DescribeLoadBalancerAttributesRequest& request) const;

  /**
   * A Callable wrapper for DescribeLoadBalancerAttributes that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeLoadBalancerAttributesRequestT = Model::DescribeLoadBalancerAttributesRequest>
  Model::DescribeLoadBalancerAttributesOutcomeCallable DescribeLoadBalancerAttributesCallable(
      const DescribeLoadBalancerAttributesRequestT& request) const {
    return SubmitCallable(&ElasticLoadBalancingv2Client::DescribeLoadBalancerAttributes, request);
  }

  /**
   * An Async wrapper for DescribeLoadBalancerAttributes that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeLoadBalancerAttributesRequestT = Model::DescribeLoadBalancerAttributesRequest>
  void DescribeLoadBalancerAttributesAsync(const DescribeLoadBalancerAttributesRequestT& request,
   ...
   */
  template <typename DescribeLoadBalancersRequestT = Model::DescribeLoadBalancersRequest>
  void DescribeLoadBalancersAsync(const DescribeLoadBalancersResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const DescribeLoadBalancersRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for DescribeRules that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeRulesRequestT = Model::DescribeRulesRequest>
  void DescribeRulesAsync(const DescribeRulesResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                          const DescribeRulesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeSSLPolicies that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeSSLPolicies that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeSSLPoliciesRequestT = Model::DescribeSSLPoliciesRequest>
  void DescribeSSLPoliciesAsync(const DescribeSSLPoliciesResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const DescribeSSLPoliciesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeTargetGroupAttributesOutcome DescribeTargetGroupAttributes(
      const Model::DescribeTargetGroupAttributesRequest& request) const;

  /**
   * A Callable wrapper for DescribeTargetGroupAttributes that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeTargetGroupAttributesRequestT = Model::DescribeTargetGroupAttributesRequest>
  Model::DescribeTargetGroupAttributesOutcomeCallable DescribeTargetGroupAttributesCallable(
      const DescribeTargetGroupAttributesRequestT& request) const {
    return SubmitCallable(&ElasticLoadBalancingv2Client::DescribeTargetGroupAttributes, request);
  }

  /**
   * An Async wrapper for DescribeTargetGroupAttributes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeTargetGroupAttributesRequestT = Model::DescribeTargetGroupAttributesRequest>
  void DescribeTargetGroupAttributesAsync(const DescribeTargetGroupAttributesRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeTargetGroups that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeTargetGroups that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeTargetGroupsRequestT = Model::DescribeTargetGroupsRequest>
  void DescribeTargetGroupsAsync(const DescribeTargetGroupsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const DescribeTargetGroupsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeTargetHealth that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeTargetHealth that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeTargetHealthRequestT = Model::DescribeTargetHealthRequest>
  void DescribeTargetHealthAsync(const DescribeTargetHealthRequestT& request, const DescribeTargetHealthResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeTrustStoreAssociationsOutcome DescribeTrustStoreAssociations(
      const Model::DescribeTrustStoreAssociationsRequest& request) const;

  /**
   * A Callable wrapper for DescribeTrustStoreAssociations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeTrustStoreAssociationsRequestT = Model::DescribeTrustStoreAssociationsRequest>
  Model::DescribeTrustStoreAssociationsOutcomeCallable DescribeTrustStoreAssociationsCallable(
      const DescribeTrustStoreAssociationsRequestT& request) const {
    return SubmitCallable(&ElasticLoadBalancingv2Client::DescribeTrustStoreAssociations, request);
  }

  /**
   * An Async wrapper for DescribeTrustStoreAssociations that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeTrustStoreAssociationsRequestT = Model::DescribeTrustStoreAssociationsRequest>
  void DescribeTrustStoreAssociationsAsync(const DescribeTrustStoreAssociationsRequestT& request,
                                           const DescribeTrustStoreAssociationsResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeTrustStoreRevocationsOutcome DescribeTrustStoreRevocations(
      const Model::DescribeTrustStoreRevocationsRequest& request) const;

  /**
   * A Callable wrapper for DescribeTrustStoreRevocations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeTrustStoreRevocationsRequestT = Model::DescribeTrustStoreRevocationsRequest>
  Model::DescribeTrustStoreRevocationsOutcomeCallable DescribeTrustStoreRevocationsCallable(
      const DescribeTrustStoreRevocationsRequestT& request) const {
    return SubmitCallable(&ElasticLoadBalancingv2Client::DescribeTrustStoreRevocations, request);
  }

  /**
   * An Async wrapper for DescribeTrustStoreRevocations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeTrustStoreRevocationsRequestT = Model::DescribeTrustStoreRevocationsRequest>
  void DescribeTrustStoreRevocationsAsync(const DescribeTrustStoreRevocationsRequestT& request,
                                          const DescribeTrustStoreRevocationsResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeTrustStores that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeTrustStores that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeTrustStoresRequestT = Model::DescribeTrustStoresRequest>
  void DescribeTrustStoresAsync(const DescribeTrustStoresResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const DescribeTrustStoresRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetTrustStoreCaCertificatesBundleOutcome GetTrustStoreCaCertificatesBundle(
      const Model::GetTrustStoreCaCertificatesBundleRequest& request) const;

  /**
   * A Callable wrapper for GetTrustStoreCaCertificatesBundle that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename GetTrustStoreCaCertificatesBundleRequestT = Model::GetTrustStoreCaCertificatesBundleRequest>
  Model::GetTrustStoreCaCertificatesBundleOutcomeCallable GetTrustStoreCaCertificatesBundleCallable(
      const GetTrustStoreCaCertificatesBundleRequestT& request) const {
    return SubmitCallable(&ElasticLoadBalancingv2Client::GetTrustStoreCaCertificatesBundle, request);
  }

  /**
   * An Async wrapper for GetTrustStoreCaCertificatesBundle that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetTrustStoreCaCertificatesBundleRequestT = Model::GetTrustStoreCaCertificatesBundleRequest>
  void GetTrustStoreCaCertificatesBundleAsync(const GetTrustStoreCaCertificatesBundleRequestT& request,
                                              const GetTrustStoreCaCertificatesBundleResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetTrustStoreRevocationContentOutcome GetTrustStoreRevocationContent(
      const Model::GetTrustStoreRevocationContentRequest& request) const;

  /**
   * A Callable wrapper for GetTrustStoreRevocationContent that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetTrustStoreRevocationContentRequestT = Model::GetTrustStoreRevocationContentRequest>
  Model::GetTrustStoreRevocationContentOutcomeCallable GetTrustStoreRevocationContentCallable(
      const GetTrustStoreRevocationContentRequestT& request) const {
    return SubmitCallable(&ElasticLoadBalancingv2Client::GetTrustStoreRevocationContent, request);
  }

  /**
   * An Async wrapper for GetTrustStoreRevocationContent that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetTrustStoreRevocationContentRequestT = Model::GetTrustStoreRevocationContentRequest>
  void GetTrustStoreRevocationContentAsync(const GetTrustStoreRevocationContentRequestT& request,
                                           const GetTrustStoreRevocationContentResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ModifyCapacityReservation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ModifyCapacityReservationRequestT = Model::ModifyCapacityReservationRequest>
  Model::ModifyCapacityReservationOutcomeCallable ModifyCapacityReservationCallable(
      const ModifyCapacityReservationRequestT& request) const {
    return SubmitCallable(&ElasticLoadBalancingv2Client::ModifyCapacityReservation, request);
  }

  /**
   * An Async wrapper for ModifyCapacityReservation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ModifyCapacityReservationRequestT = Model::ModifyCapacityReservationRequest>
  void ModifyCapacityReservationAsync(const ModifyCapacityReservationRequestT& request,
                                      const ModifyCapacityReservationResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ModifyIpPools that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ModifyIpPoolsRequestT = Model::ModifyIpPoolsRequest>
  void ModifyIpPoolsAsync(const ModifyIpPoolsRequestT& request, const ModifyIpPoolsResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ModifyListener that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ModifyListenerRequestT = Model::ModifyListenerRequest>
  void ModifyListenerAsync(const ModifyListenerRequestT& request, const ModifyListenerResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ModifyListenerAttributes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ModifyListenerAttributes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ModifyListenerAttributesRequestT = Model::ModifyListenerAttributesRequest>
  void ModifyListenerAttributesAsync(const ModifyListenerAttributesRequestT& request,
                                     const ModifyListenerAttributesResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ModifyLoadBalancerAttributesOutcome ModifyLoadBalancerAttributes(
      const Model::ModifyLoadBalancerAttributesRequest& request) const;

  /**
   * A Callable wrapper for ModifyLoadBalancerAttributes that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ModifyLoadBalancerAttributesRequestT = Model::ModifyLoadBalancerAttributesRequest>
  Model::ModifyLoadBalancerAttributesOutcomeCallable ModifyLoadBalancerAttributesCallable(
      const ModifyLoadBalancerAttributesRequestT& request) const {
    return SubmitCallable(&ElasticLoadBalancingv2Client::ModifyLoadBalancerAttributes, request);
  }

  /**
   * An Async wrapper for ModifyLoadBalancerAttributes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ModifyLoadBalancerAttributesRequestT = Model::ModifyLoadBalancerAttributesRequest>
  void ModifyLoadBalancerAttributesAsync(const ModifyLoadBalancerAttributesRequestT& request,
  ...
  /**
   * An Async wrapper for ModifyRule that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ModifyRuleRequestT = Model::ModifyRuleRequest>
  void ModifyRuleAsync(const ModifyRuleRequestT& request, const ModifyRuleResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ModifyTargetGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ModifyTargetGroup that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ModifyTargetGroupRequestT = Model::ModifyTargetGroupRequest>
  void ModifyTargetGroupAsync(const ModifyTargetGroupRequestT& request, const ModifyTargetGroupResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ModifyTargetGroupAttributesOutcome ModifyTargetGroupAttributes(
      const Model::ModifyTargetGroupAttributesRequest& request) const;

  /**
   * A Callable wrapper for ModifyTargetGroupAttributes that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ModifyTargetGroupAttributesRequestT = Model::ModifyTargetGroupAttributesRequest>
  Model::ModifyTargetGroupAttributesOutcomeCallable ModifyTargetGroupAttributesCallable(
      const ModifyTargetGroupAttributesRequestT& request) const {
    return SubmitCallable(&ElasticLoadBalancingv2Client::ModifyTargetGroupAttributes, request);
  }

  /**
   * An Async wrapper for ModifyTargetGroupAttributes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ModifyTargetGroupAttributesRequestT = Model::ModifyTargetGroupAttributesRequest>
  void ModifyTargetGroupAttributesAsync(const ModifyTargetGroupAttributesRequestT& request,
  ...
  /**
   * A Callable wrapper for ModifyTrustStore that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ModifyTrustStore that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ModifyTrustStoreRequestT = Model::ModifyTrustStoreRequest>
  void ModifyTrustStoreAsync(const ModifyTrustStoreRequestT& request, const ModifyTrustStoreResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::RemoveListenerCertificatesOutcome RemoveListenerCertificates(
      const Model::RemoveListenerCertificatesRequest& request) const;

  /**
   * A Callable wrapper for RemoveListenerCertificates that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename RemoveListenerCertificatesRequestT = Model::RemoveListenerCertificatesRequest>
  Model::RemoveListenerCertificatesOutcomeCallable RemoveListenerCertificatesCallable(
      const RemoveListenerCertificatesRequestT& request) const {
    return SubmitCallable(&ElasticLoadBalancingv2Client::RemoveListenerCertificates, request);
  }

  /**
   * An Async wrapper for RemoveListenerCertificates that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RemoveListenerCertificatesRequestT = Model::RemoveListenerCertificatesRequest>
  void RemoveListenerCertificatesAsync(const RemoveListenerCertificatesRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::RemoveTrustStoreRevocationsOutcome RemoveTrustStoreRevocations(
      const Model::RemoveTrustStoreRevocationsRequest& request) const;

  /**
   * A Callable wrapper for RemoveTrustStoreRevocations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename RemoveTrustStoreRevocationsRequestT = Model::RemoveTrustStoreRevocationsRequest>
  Model::RemoveTrustStoreRevocationsOutcomeCallable RemoveTrustStoreRevocationsCallable(
      const RemoveTrustStoreRevocationsRequestT& request) const {
    return SubmitCallable(&ElasticLoadBalancingv2Client::RemoveTrustStoreRevocations, request);
  }

  /**
   * An Async wrapper for RemoveTrustStoreRevocations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RemoveTrustStoreRevocationsRequestT = Model::RemoveTrustStoreRevocationsRequest>
  void RemoveTrustStoreRevocationsAsync(const RemoveTrustStoreRevocationsRequestT& request,
                                        const RemoveTrustStoreRevocationsResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SetIpAddressType that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SetIpAddressType that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename SetIpAddressTypeRequestT = Model::SetIpAddressTypeRequest>
  void SetIpAddressTypeAsync(const SetIpAddressTypeRequestT& request, const SetIpAddressTypeResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SetRulePriorities that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SetRulePriorities that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename SetRulePrioritiesRequestT = Model::SetRulePrioritiesRequest>
  void SetRulePrioritiesAsync(const SetRulePrioritiesRequestT& request, const SetRulePrioritiesResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SetSecurityGroups that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SetSecurityGroups that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename SetSecurityGroupsRequestT = Model::SetSecurityGroupsRequest>
  void SetSecurityGroupsAsync(const SetSecurityGroupsRequestT& request, const SetSecurityGroupsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for SetSubnets that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename SetSubnetsRequestT = Model::SetSubnetsRequest>
  void SetSubnetsAsync(const SetSubnetsRequestT& request, const SetSubnetsResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
