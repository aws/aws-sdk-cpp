...
DescribeTrustStoreRevocation::DescribeTrustStoreRevocation(const XmlNode& xmlNode) { *this = xmlNode; }
...
void DescribeTrustStoreRevocation::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
