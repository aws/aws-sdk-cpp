...
QueryStringConditionConfig::QueryStringConditionConfig(const XmlNode& xmlNode) { *this = xmlNode; }
...
void QueryStringConditionConfig::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
