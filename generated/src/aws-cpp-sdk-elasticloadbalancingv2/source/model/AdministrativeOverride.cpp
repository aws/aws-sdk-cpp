...
AdministrativeOverride::AdministrativeOverride(const XmlNode& xmlNode) { *this = xmlNode; }
...
AdministrativeOverride& AdministrativeOverride::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!stateNode.IsNull()) {
      m_state = TargetAdministrativeOverrideStateEnumMapper::GetTargetAdministrativeOverrideStateEnumForName(
    ...
    if (!reasonNode.IsNull()) {
      m_reason = TargetAdministrativeOverrideReasonEnumMapper::GetTargetAdministrativeOverrideReasonEnumForName(
...
void AdministrativeOverride::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  if (m_stateHasBeenSet) {
    oStream << location << index << locationValue << ".State="
            << StringUtils::URLEncode(TargetAdministrativeOverrideStateEnumMapper::GetNameForTargetAdministrativeOverrideStateEnum(m_state))
            << "&";
  }

  if (m_reasonHasBeenSet) {
    oStream << location << index << locationValue << ".Reason="
            << StringUtils::URLEncode(
                   TargetAdministrativeOverrideReasonEnumMapper::GetNameForTargetAdministrativeOverrideReasonEnum(m_reason))
            << "&";
  }
