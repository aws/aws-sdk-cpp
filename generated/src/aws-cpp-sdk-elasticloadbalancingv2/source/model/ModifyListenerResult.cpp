...
ModifyListenerResult::ModifyListenerResult(const Aws::AmazonWebServiceResult<XmlDocument>& result) { *this = result; }
...
ModifyListenerResult& ModifyListenerResult::operator=(const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::ElasticLoadBalancingv2::Model::ModifyListenerResult",
