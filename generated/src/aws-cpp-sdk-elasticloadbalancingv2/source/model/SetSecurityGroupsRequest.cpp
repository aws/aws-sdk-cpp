...
Aws::String SetSecurityGroupsRequest::SerializePayload() const {
  ...
  if (m_enforceSecurityGroupInboundRulesOnPrivateLinkTrafficHasBeenSet) {
    ss << "EnforceSecurityGroupInboundRulesOnPrivateLinkTraffic="
       << StringUtils::URLEncode(EnforceSecurityGroupInboundRulesOnPrivateLinkTrafficEnumMapper::
                                     GetNameForEnforceSecurityGroupInboundRulesOnPrivateLinkTrafficEnum(
...
void SetSecurityGroupsRequest::DumpBodyToUrl(Aws::Http::URI& uri) const { uri.SetQueryString(SerializePayload()); }
