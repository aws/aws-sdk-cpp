...
FixedResponseActionConfig::FixedResponseActionConfig(const XmlNode& xmlNode) { *this = xmlNode; }
...
void FixedResponseActionConfig::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
