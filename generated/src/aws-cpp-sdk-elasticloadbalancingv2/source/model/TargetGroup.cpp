...
TargetGroup& TargetGroup::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!protocolNode.IsNull()) {
      m_protocol = ProtocolEnumMapper::GetProtocolEnumForName(
    ...
    if (!healthCheckProtocolNode.IsNull()) {
      m_healthCheckProtocol = ProtocolEnumMapper::GetProtocolEnumForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(healthCheckProtocolNode.GetText()).c_str()));
    ...
    if (!healthCheckEnabledNode.IsNull()) {
      m_healthCheckEnabled = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(healthCheckEnabledNode.GetText()).c_str()).c_str());
    ...
    if (!healthCheckIntervalSecondsNode.IsNull()) {
      m_healthCheckIntervalSeconds = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(healthCheckIntervalSecondsNode.GetText()).c_str()).c_str());
    ...
    if (!healthCheckTimeoutSecondsNode.IsNull()) {
      m_healthCheckTimeoutSeconds = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(healthCheckTimeoutSecondsNode.GetText()).c_str()).c_str());
    ...
    if (!healthyThresholdCountNode.IsNull()) {
      m_healthyThresholdCount = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(healthyThresholdCountNode.GetText()).c_str()).c_str());
    ...
    if (!unhealthyThresholdCountNode.IsNull()) {
      m_unhealthyThresholdCount = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(unhealthyThresholdCountNode.GetText()).c_str()).c_str());
    ...
    if (!targetTypeNode.IsNull()) {
      m_targetType = TargetTypeEnumMapper::GetTargetTypeEnumForName(
    ...
    if (!ipAddressTypeNode.IsNull()) {
      m_ipAddressType = TargetGroupIpAddressTypeEnumMapper::GetTargetGroupIpAddressTypeEnumForName(
...
void TargetGroup::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_protocolHasBeenSet) {
    oStream << location << index << locationValue
            << ".Protocol=" << StringUtils::URLEncode(ProtocolEnumMapper::GetNameForProtocolEnum(m_protocol)) << "&";
  }
  ...
  if (m_healthCheckProtocolHasBeenSet) {
    oStream << location << index << locationValue
            << ".HealthCheckProtocol=" << StringUtils::URLEncode(ProtocolEnumMapper::GetNameForProtocolEnum(m_healthCheckProtocol)) << "&";
  }
  ...
  if (m_loadBalancerArnsHasBeenSet) {
    ...
    for (auto& item : m_loadBalancerArns) {
      oStream << location << index << locationValue << ".LoadBalancerArns.member." << loadBalancerArnsIdx++ << "="
  ...
  if (m_targetTypeHasBeenSet) {
    oStream << location << index << locationValue
            << ".TargetType=" << StringUtils::URLEncode(TargetTypeEnumMapper::GetNameForTargetTypeEnum(m_targetType)) << "&";
  }
