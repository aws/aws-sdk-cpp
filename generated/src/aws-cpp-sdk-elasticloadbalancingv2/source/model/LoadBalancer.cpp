...
LoadBalancer::LoadBalancer(const XmlNode& xmlNode) { *this = xmlNode; }
...
LoadBalancer& LoadBalancer::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!schemeNode.IsNull()) {
      m_scheme = LoadBalancerSchemeEnumMapper::GetLoadBalancerSchemeEnumForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(schemeNode.GetText()).c_str()));
    ...
    if (!typeNode.IsNull()) {
      m_type = LoadBalancerTypeEnumMapper::GetLoadBalancerTypeEnumForName(
    ...
    XmlNode enforceSecurityGroupInboundRulesOnPrivateLinkTrafficNode =
        resultNode.FirstChild("EnforceSecurityGroupInboundRulesOnPrivateLinkTraffic");
    if (!enforceSecurityGroupInboundRulesOnPrivateLinkTrafficNode.IsNull()) {
      m_enforceSecurityGroupInboundRulesOnPrivateLinkTraffic =
          Aws::Utils::Xml::DecodeEscapedXmlText(enforceSecurityGroupInboundRulesOnPrivateLinkTrafficNode.GetText());
    ...
    if (!enablePrefixForIpv6SourceNatNode.IsNull()) {
      m_enablePrefixForIpv6SourceNat = EnablePrefixForIpv6SourceNatEnumMapper::GetEnablePrefixForIpv6SourceNatEnumForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(enablePrefixForIpv6SourceNatNode.GetText()).c_str()));
...
void LoadBalancer::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_createdTimeHasBeenSet) {
    oStream << location << index << locationValue
            << ".CreatedTime=" << StringUtils::URLEncode(m_createdTime.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }
  ...
  if (m_schemeHasBeenSet) {
    oStream << location << index << locationValue
            << ".Scheme=" << StringUtils::URLEncode(LoadBalancerSchemeEnumMapper::GetNameForLoadBalancerSchemeEnum(m_scheme)) << "&";
  }
  ...
  if (m_typeHasBeenSet) {
    oStream << location << index << locationValue
            << ".Type=" << StringUtils::URLEncode(LoadBalancerTypeEnumMapper::GetNameForLoadBalancerTypeEnum(m_type)) << "&";
  }
  ...
  if (m_securityGroupsHasBeenSet) {
    ...
    for (auto& item : m_securityGroups) {
      oStream << location << index << locationValue << ".SecurityGroups.member." << securityGroupsIdx++ << "="
  ...
  if (m_ipAddressTypeHasBeenSet) {
    oStream << location << index << locationValue
            << ".IpAddressType=" << StringUtils::URLEncode(IpAddressTypeMapper::GetNameForIpAddressType(m_ipAddressType)) << "&";
  }
  ...
  if (m_enforceSecurityGroupInboundRulesOnPrivateLinkTrafficHasBeenSet) {
    oStream << location << index << locationValue << ".EnforceSecurityGroupInboundRulesOnPrivateLinkTraffic="
            << StringUtils::URLEncode(m_enforceSecurityGroupInboundRulesOnPrivateLinkTraffic.c_str()) << "&";
  }

  if (m_enablePrefixForIpv6SourceNatHasBeenSet) {
    oStream << location << index << locationValue << ".EnablePrefixForIpv6SourceNat="
            << StringUtils::URLEncode(
                   EnablePrefixForIpv6SourceNatEnumMapper::GetNameForEnablePrefixForIpv6SourceNatEnum(m_enablePrefixForIpv6SourceNat))
            << "&";
  }
...
void LoadBalancer::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_enforceSecurityGroupInboundRulesOnPrivateLinkTrafficHasBeenSet) {
    oStream << location << ".EnforceSecurityGroupInboundRulesOnPrivateLinkTraffic="
            << StringUtils::URLEncode(m_enforceSecurityGroupInboundRulesOnPrivateLinkTraffic.c_str()) << "&";
  }
  if (m_enablePrefixForIpv6SourceNatHasBeenSet) {
    oStream << location << ".EnablePrefixForIpv6SourceNat="
            << StringUtils::URLEncode(
                   EnablePrefixForIpv6SourceNatEnumMapper::GetNameForEnablePrefixForIpv6SourceNatEnum(m_enablePrefixForIpv6SourceNat))
            << "&";
  }
