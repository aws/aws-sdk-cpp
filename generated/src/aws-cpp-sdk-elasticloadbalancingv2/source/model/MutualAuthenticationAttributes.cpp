...
MutualAuthenticationAttributes::MutualAuthenticationAttributes(const XmlNode& xmlNode) { *this = xmlNode; }
...
MutualAuthenticationAttributes& MutualAuthenticationAttributes::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!ignoreClientCertificateExpiryNode.IsNull()) {
      m_ignoreClientCertificateExpiry = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(ignoreClientCertificateExpiryNode.GetText()).c_str()).c_str());
    ...
    if (!trustStoreAssociationStatusNode.IsNull()) {
      m_trustStoreAssociationStatus = TrustStoreAssociationStatusEnumMapper::GetTrustStoreAssociationStatusEnumForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(trustStoreAssociationStatusNode.GetText()).c_str()));
    ...
    if (!advertiseTrustStoreCaNamesNode.IsNull()) {
      m_advertiseTrustStoreCaNames = AdvertiseTrustStoreCaNamesEnumMapper::GetAdvertiseTrustStoreCaNamesEnumForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(advertiseTrustStoreCaNamesNode.GetText()).c_str()));
...
void MutualAuthenticationAttributes::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
  ...
  if (m_trustStoreAssociationStatusHasBeenSet) {
    oStream << location << index << locationValue << ".TrustStoreAssociationStatus="
            << StringUtils::URLEncode(
                   TrustStoreAssociationStatusEnumMapper::GetNameForTrustStoreAssociationStatusEnum(m_trustStoreAssociationStatus))
            << "&";
  }

  if (m_advertiseTrustStoreCaNamesHasBeenSet) {
    oStream << location << index << locationValue << ".AdvertiseTrustStoreCaNames="
            << StringUtils::URLEncode(
                   AdvertiseTrustStoreCaNamesEnumMapper::GetNameForAdvertiseTrustStoreCaNamesEnum(m_advertiseTrustStoreCaNames))
            << "&";
  }
}
...
void MutualAuthenticationAttributes::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_trustStoreAssociationStatusHasBeenSet) {
    oStream << location << ".TrustStoreAssociationStatus="
            << StringUtils::URLEncode(
                   TrustStoreAssociationStatusEnumMapper::GetNameForTrustStoreAssociationStatusEnum(m_trustStoreAssociationStatus))
            << "&";
  }
  if (m_advertiseTrustStoreCaNamesHasBeenSet) {
    oStream << location << ".AdvertiseTrustStoreCaNames="
            << StringUtils::URLEncode(
                   AdvertiseTrustStoreCaNamesEnumMapper::GetNameForAdvertiseTrustStoreCaNamesEnum(m_advertiseTrustStoreCaNames))
            << "&";
  }
