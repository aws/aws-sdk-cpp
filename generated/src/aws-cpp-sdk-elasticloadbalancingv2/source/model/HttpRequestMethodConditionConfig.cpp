...
HttpRequestMethodConditionConfig::HttpRequestMethodConditionConfig(const XmlNode& xmlNode) { *this = xmlNode; }
...
void HttpRequestMethodConditionConfig::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
