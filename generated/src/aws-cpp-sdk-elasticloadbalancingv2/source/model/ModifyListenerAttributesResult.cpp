...
ModifyListenerAttributesResult::ModifyListenerAttributesResult(const Aws::AmazonWebServiceResult<XmlDocument>& result) { *this = result; }

ModifyListenerAttributesResult& ModifyListenerAttributesResult::operator=(const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::ElasticLoadBalancingv2::Model::ModifyListenerAttributesResult",
