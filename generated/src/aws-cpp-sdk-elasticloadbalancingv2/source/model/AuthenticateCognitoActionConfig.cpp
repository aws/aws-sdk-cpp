...
AuthenticateCognitoActionConfig::AuthenticateCognitoActionConfig(const XmlNode& xmlNode) { *this = xmlNode; }
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!onUnauthenticatedRequestNode.IsNull()) {
      m_onUnauthenticatedRequest =
          AuthenticateCognitoActionConditionalBehaviorEnumMapper::GetAuthenticateCognitoActionConditionalBehaviorEnumForName(
...
void AuthenticateCognitoActionConfig::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
  ...
  if (m_onUnauthenticatedRequestHasBeenSet) {
    oStream << location << index << locationValue << ".OnUnauthenticatedRequest="
            << StringUtils::URLEncode(
                   AuthenticateCognitoActionConditionalBehaviorEnumMapper::GetNameForAuthenticateCognitoActionConditionalBehaviorEnum(
                       m_onUnauthenticatedRequest))
            << "&";
  }
}
