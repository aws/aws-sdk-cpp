...
DescribeTrustStoreRevocationsResult& DescribeTrustStoreRevocationsResult::operator=(
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::ElasticLoadBalancingv2::Model::DescribeTrustStoreRevocationsResult",
