...
{
const size_t ElasticLoadBalancingv2EndpointRules::RulesBlobStrLen = 4020;
const size_t ElasticLoadBalancingv2EndpointRules::RulesBlobSize = 4021;
...
'o','a','d','b','a','l','a','n','c','i','n','g','.','{','R','e','g','i','o','n','}','.','a','m','a',
