...
class ProjectArtifacts {
 public:
  ...
  inline ProjectArtifacts& WithType(ArtifactsType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNamespaceType(ArtifactNamespace value) {
    m_namespaceTypeHasBeenSet = true;
    m_namespaceType = value;
  }
  inline ProjectArtifacts& WithNamespaceType(ArtifactNamespace value) {
  ...
  inline void SetPackaging(ArtifactPackaging value) {
    m_packagingHasBeenSet = true;
    m_packaging = value;
  }
  inline ProjectArtifacts& WithPackaging(ArtifactPackaging value) {
    SetPackaging(value);
    return *this;
  }
  ///@}
  ...
  inline ProjectArtifacts& WithOverrideArtifactName(bool value) {
  ...
  inline ProjectArtifacts& WithEncryptionDisabled(bool value) {
  ...
  inline ProjectArtifacts& WithBucketOwnerAccess(BucketOwnerAccess value) {
