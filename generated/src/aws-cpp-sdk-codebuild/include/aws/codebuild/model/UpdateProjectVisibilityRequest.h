...
class UpdateProjectVisibilityRequest : public CodeBuildRequest {
 public:
  ...
  template <typename ProjectArnT = Aws::String>
  UpdateProjectVisibilityRequest& WithProjectArn(ProjectArnT&& value) {
  ...
  inline UpdateProjectVisibilityRequest& WithProjectVisibility(ProjectVisibilityType value) {
  ...
  void SetResourceAccessRole(ResourceAccessRoleT&& value) {
    ...
    m_resourceAccessRole = std::forward<ResourceAccessRoleT>(value);
  }
  template <typename ResourceAccessRoleT = Aws::String>
  UpdateProjectVisibilityRequest& WithResourceAccessRole(ResourceAccessRoleT&& value) {
    SetResourceAccessRole(std::forward<ResourceAccessRoleT>(value));
    return *this;
  }
  ///@}
 private:
