...
class BuildBatch {
 public:
  ...
  inline void SetBuildBatchStatus(StatusType value) {
    m_buildBatchStatusHasBeenSet = true;
    m_buildBatchStatus = value;
  }
  inline BuildBatch& WithBuildBatchStatus(StatusType value) {
    SetBuildBatchStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetBuildTimeoutInMinutes(int value) {
    m_buildTimeoutInMinutesHasBeenSet = true;
    m_buildTimeoutInMinutes = value;
  }
  inline BuildBatch& WithBuildTimeoutInMinutes(int value) {
    SetBuildTimeoutInMinutes(value);
    return *this;
  }
  ///@}
  ...
  inline BuildBatch& WithQueuedTimeoutInMinutes(int value) {
  ...
  inline void SetComplete(bool value) {
    m_completeHasBeenSet = true;
    m_complete = value;
  }
  inline BuildBatch& WithComplete(bool value) {
    SetComplete(value);
    return *this;
  }
  ///@}
  ...
  inline void SetBuildBatchNumber(long long value) {
    m_buildBatchNumberHasBeenSet = true;
    m_buildBatchNumber = value;
  }
  inline BuildBatch& WithBuildBatchNumber(long long value) {
    SetBuildBatchNumber(value);
    return *this;
  }
  ///@}
  ...
  void SetBuildGroups(BuildGroupsT&& value) {
    ...
    m_buildGroups = std::forward<BuildGroupsT>(value);
  }
  template <typename BuildGroupsT = Aws::Vector<BuildGroup>>
  BuildBatch& WithBuildGroups(BuildGroupsT&& value) {
    SetBuildGroups(std::forward<BuildGroupsT>(value));
    return *this;
  }
  template <typename BuildGroupsT = BuildGroup>
  BuildBatch& AddBuildGroups(BuildGroupsT&& value) {
    m_buildGroupsHasBeenSet = true;
    m_buildGroups.emplace_back(std::forward<BuildGroupsT>(value));
    return *this;
  }
  ///@}
  ...
  inline BuildBatch& WithDebugSessionEnabled(bool value) {
