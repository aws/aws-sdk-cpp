...
class ListReportsForReportGroupResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListReportsForReportGroupResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ReportsT = Aws::Vector<Aws::String>>
  ListReportsForReportGroupResult& WithReports(ReportsT&& value) {
    SetReports(std::forward<ReportsT>(value));
    return *this;
  }
  template <typename ReportsT = Aws::String>
  ListReportsForReportGroupResult& AddReports(ReportsT&& value) {
    m_reportsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListReportsForReportGroupResult& WithRequestId(RequestIdT&& value) {
