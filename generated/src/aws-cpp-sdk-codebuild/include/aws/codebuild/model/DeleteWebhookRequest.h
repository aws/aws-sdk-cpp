...
/**
 */
class DeleteWebhookRequest : public CodeBuildRequest {
 public:
  AWS_CODEBUILD_API DeleteWebhookRequest() = default;
  ...
  template <typename ProjectNameT = Aws::String>
  DeleteWebhookRequest& WithProjectName(ProjectNameT&& value) {
