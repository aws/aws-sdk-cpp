...
class ComputeConfiguration {
 public:
  ...
  inline void SetVCpu(long long value) {
    m_vCpuHasBeenSet = true;
    m_vCpu = value;
  }
  inline ComputeConfiguration& WithVCpu(long long value) {
    SetVCpu(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMemory(long long value) {
    m_memoryHasBeenSet = true;
    m_memory = value;
  }
  inline ComputeConfiguration& WithMemory(long long value) {
    SetMemory(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDisk(long long value) {
    m_diskHasBeenSet = true;
    m_disk = value;
  }
  inline ComputeConfiguration& WithDisk(long long value) {
    SetDisk(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMachineType(MachineType value) {
    m_machineTypeHasBeenSet = true;
    m_machineType = value;
  }
  inline ComputeConfiguration& WithMachineType(MachineType value) {
