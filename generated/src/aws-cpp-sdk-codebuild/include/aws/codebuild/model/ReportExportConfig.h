...
class ReportExportConfig {
 public:
  ...
  inline void SetExportConfigType(ReportExportConfigType value) {
    m_exportConfigTypeHasBeenSet = true;
    m_exportConfigType = value;
  }
  inline ReportExportConfig& WithExportConfigType(ReportExportConfigType value) {
    SetExportConfigType(value);
    return *this;
  }
  ///@}
