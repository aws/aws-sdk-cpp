...
class ProjectSource {
 public:
  ...
  inline void SetType(SourceType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline ProjectSource& WithType(SourceType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetGitCloneDepth(int value) {
    m_gitCloneDepthHasBeenSet = true;
    m_gitCloneDepth = value;
  }
  inline ProjectSource& WithGitCloneDepth(int value) {
    SetGitCloneDepth(value);
    return *this;
  }
  ///@}
  ...
  void SetGitSubmodulesConfig(GitSubmodulesConfigT&& value) {
    ...
    m_gitSubmodulesConfig = std::forward<GitSubmodulesConfigT>(value);
  }
  template <typename GitSubmodulesConfigT = GitSubmodulesConfig>
  ProjectSource& WithGitSubmodulesConfig(GitSubmodulesConfigT&& value) {
    SetGitSubmodulesConfig(std::forward<GitSubmodulesConfigT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetReportBuildStatus(bool value) {
    m_reportBuildStatusHasBeenSet = true;
    m_reportBuildStatus = value;
  }
  inline ProjectSource& WithReportBuildStatus(bool value) {
    SetReportBuildStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetBuildStatusConfig(BuildStatusConfigT&& value) {
    ...
    m_buildStatusConfig = std::forward<BuildStatusConfigT>(value);
  }
  template <typename BuildStatusConfigT = BuildStatusConfig>
  ProjectSource& WithBuildStatusConfig(BuildStatusConfigT&& value) {
    SetBuildStatusConfig(std::forward<BuildStatusConfigT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetInsecureSsl(bool value) {
    m_insecureSslHasBeenSet = true;
    m_insecureSsl = value;
  }
  inline ProjectSource& WithInsecureSsl(bool value) {
    SetInsecureSsl(value);
    return *this;
  }
  ///@}
