...
class StartBuildBatchResult {
 public:
  ...
  void SetBuildBatch(BuildBatchT&& value) {
    m_buildBatchHasBeenSet = true;
    m_buildBatch = std::forward<BuildBatchT>(value);
  }
  template <typename BuildBatchT = BuildBatch>
  StartBuildBatchResult& WithBuildBatch(BuildBatchT&& value) {
    SetBuildBatch(std::forward<BuildBatchT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  StartBuildBatchResult& WithRequestId(RequestIdT&& value) {
