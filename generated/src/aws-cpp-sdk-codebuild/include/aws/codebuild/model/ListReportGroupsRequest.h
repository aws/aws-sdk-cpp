...
class ListReportGroupsRequest : public CodeBuildRequest {
 public:
  ...
  inline ListReportGroupsRequest& WithSortOrder(SortOrderType value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSortBy(ReportGroupSortByType value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ListReportGroupsRequest& WithSortBy(ReportGroupSortByType value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListReportGroupsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListReportGroupsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
