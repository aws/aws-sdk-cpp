...
class ListBuildsForProjectResult {
 public:
  ...
  template <typename IdsT = Aws::Vector<Aws::String>>
  ListBuildsForProjectResult& WithIds(IdsT&& value) {
    SetIds(std::forward<IdsT>(value));
    return *this;
  }
  template <typename IdsT = Aws::String>
  ListBuildsForProjectResult& AddIds(IdsT&& value) {
    m_idsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListBuildsForProjectResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListBuildsForProjectResult& WithRequestId(RequestIdT&& value) {
