...
class ListReportsForReportGroupRequest : public CodeBuildRequest {
 public:
  ...
  template <typename ReportGroupArnT = Aws::String>
  ListReportsForReportGroupRequest& WithReportGroupArn(ReportGroupArnT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListReportsForReportGroupRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListReportsForReportGroupRequest& WithSortOrder(SortOrderType value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  inline ListReportsForReportGroupRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename FilterT = ReportFilter>
  ListReportsForReportGroupRequest& WithFilter(FilterT&& value) {
