...
class CreateFleetRequest : public CodeBuildRequest {
 public:
  ...
  inline CreateFleetRequest& WithBaseCapacity(int value) {
  ...
  inline CreateFleetRequest& WithEnvironmentType(EnvironmentType value) {
  ...
  inline CreateFleetRequest& WithComputeType(ComputeType value) {
  ...
  inline CreateFleetRequest& WithOverflowBehavior(FleetOverflowBehavior value) {
