...
class BatchGetBuildBatchesResult {
 public:
  ...
  void SetBuildBatchesNotFound(BuildBatchesNotFoundT&& value) {
    ...
    m_buildBatchesNotFound = std::forward<BuildBatchesNotFoundT>(value);
  }
  template <typename BuildBatchesNotFoundT = Aws::Vector<Aws::String>>
  BatchGetBuildBatchesResult& WithBuildBatchesNotFound(BuildBatchesNotFoundT&& value) {
    SetBuildBatchesNotFound(std::forward<BuildBatchesNotFoundT>(value));
    return *this;
  }
  ...
  BatchGetBuildBatchesResult& AddBuildBatchesNotFound(BuildBatchesNotFoundT&& value) {
    m_buildBatchesNotFoundHasBeenSet = true;
    m_buildBatchesNotFound.emplace_back(std::forward<BuildBatchesNotFoundT>(value));
    return *this;
  }
  ///@}
