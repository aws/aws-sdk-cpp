...
class UpdateProjectRequest : public CodeBuildRequest {
 public:
  ...
  inline UpdateProjectRequest& WithTimeoutInMinutes(int value) {
  ...
  inline UpdateProjectRequest& WithQueuedTimeoutInMinutes(int value) {
  ...
  inline UpdateProjectRequest& WithBadgeEnabled(bool value) {
  ...
  inline UpdateProjectRequest& WithConcurrentBuildLimit(int value) {
  ...
  inline UpdateProjectRequest& WithAutoRetryLimit(int value) {
