...
class SandboxSessionPhase {
 public:
  ...
  void SetPhaseType(PhaseTypeT&& value) {
    ...
    m_phaseType = std::forward<PhaseTypeT>(value);
  }
  template <typename PhaseTypeT = Aws::String>
  SandboxSessionPhase& WithPhaseType(PhaseTypeT&& value) {
    SetPhaseType(std::forward<PhaseTypeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetPhaseStatus(StatusType value) {
    m_phaseStatusHasBeenSet = true;
    m_phaseStatus = value;
  }
  inline SandboxSessionPhase& WithPhaseStatus(StatusType value) {
  ...
  inline void SetDurationInSeconds(long long value) {
    m_durationInSecondsHasBeenSet = true;
    m_durationInSeconds = value;
  }
  inline SandboxSessionPhase& WithDurationInSeconds(long long value) {
