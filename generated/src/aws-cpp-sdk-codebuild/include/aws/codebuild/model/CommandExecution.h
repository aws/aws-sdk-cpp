...
class CommandExecution {
 public:
  ...
  inline void SetType(CommandType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline CommandExecution& WithType(CommandType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetExitCode(ExitCodeT&& value) {
    ...
    m_exitCode = std::forward<ExitCodeT>(value);
  }
  template <typename ExitCodeT = Aws::String>
  CommandExecution& WithExitCode(ExitCodeT&& value) {
    SetExitCode(std::forward<ExitCodeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStandardOutputContent(StandardOutputContentT&& value) {
    ...
    m_standardOutputContent = std::forward<StandardOutputContentT>(value);
  }
  template <typename StandardOutputContentT = Aws::String>
  CommandExecution& WithStandardOutputContent(StandardOutputContentT&& value) {
    SetStandardOutputContent(std::forward<StandardOutputContentT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStandardErrContent(StandardErrContentT&& value) {
    ...
    m_standardErrContent = std::forward<StandardErrContentT>(value);
  }
  template <typename StandardErrContentT = Aws::String>
  CommandExecution& WithStandardErrContent(StandardErrContentT&& value) {
    SetStandardErrContent(std::forward<StandardErrContentT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSandboxArn(SandboxArnT&& value) {
    ...
    m_sandboxArn = std::forward<SandboxArnT>(value);
  }
  template <typename SandboxArnT = Aws::String>
  CommandExecution& WithSandboxArn(SandboxArnT&& value) {
    SetSandboxArn(std::forward<SandboxArnT>(value));
    return *this;
  }
  ///@}
 private:
