...
class DeleteReportGroupRequest : public CodeBuildRequest {
 public:
  ...
  template <typename ArnT = Aws::String>
  DeleteReportGroupRequest& WithArn(ArnT&& value) {
  ...
  inline void SetDeleteReports(bool value) {
    m_deleteReportsHasBeenSet = true;
    m_deleteReports = value;
  }
  inline DeleteReportGroupRequest& WithDeleteReports(bool value) {
    SetDeleteReports(value);
    return *this;
  }
  ///@}
 private:
