...
class Webhook {
 public:
  ...
  void SetPayloadUrl(PayloadUrlT&& value) {
    ...
    m_payloadUrl = std::forward<PayloadUrlT>(value);
  }
  template <typename PayloadUrlT = Aws::String>
  Webhook& WithPayloadUrl(PayloadUrlT&& value) {
    SetPayloadUrl(std::forward<PayloadUrlT>(value));
    return *this;
  }
  ///@}
  ...
  inline Webhook& WithBuildType(WebhookBuildType value) {
    SetBuildType(value);
    return *this;
  }
  ///@}
  ...
  inline Webhook& WithManualCreation(bool value) {
  ...
  void SetLastModifiedSecret(LastModifiedSecretT&& value) {
    ...
    m_lastModifiedSecret = std::forward<LastModifiedSecretT>(value);
  }
  template <typename LastModifiedSecretT = Aws::Utils::DateTime>
  Webhook& WithLastModifiedSecret(LastModifiedSecretT&& value) {
    SetLastModifiedSecret(std::forward<LastModifiedSecretT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(WebhookStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline Webhook& WithStatus(WebhookStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
