...
class ListSourceCredentialsResult {
 public:
  ...
  void SetSourceCredentialsInfos(SourceCredentialsInfosT&& value) {
    m_sourceCredentialsInfosHasBeenSet = true;
    m_sourceCredentialsInfos = std::forward<SourceCredentialsInfosT>(value);
  }
  template <typename SourceCredentialsInfosT = Aws::Vector<SourceCredentialsInfo>>
  ListSourceCredentialsResult& WithSourceCredentialsInfos(SourceCredentialsInfosT&& value) {
    SetSourceCredentialsInfos(std::forward<SourceCredentialsInfosT>(value));
    return *this;
  }
  template <typename SourceCredentialsInfosT = SourceCredentialsInfo>
  ListSourceCredentialsResult& AddSourceCredentialsInfos(SourceCredentialsInfosT&& value) {
    m_sourceCredentialsInfosHasBeenSet = true;
    m_sourceCredentialsInfos.emplace_back(std::forward<SourceCredentialsInfosT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListSourceCredentialsResult& WithRequestId(RequestIdT&& value) {
