...
class Report {
 public:
  ...
  inline Report& WithType(ReportType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetReportGroupArn(ReportGroupArnT&& value) {
    ...
    m_reportGroupArn = std::forward<ReportGroupArnT>(value);
  }
  template <typename ReportGroupArnT = Aws::String>
  Report& WithReportGroupArn(ReportGroupArnT&& value) {
    SetReportGroupArn(std::forward<ReportGroupArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline Report& WithStatus(ReportStatusType value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline Report& WithTruncated(bool value) {
    SetTruncated(value);
    return *this;
  }
  ///@}
  ...
  void SetTestSummary(TestSummaryT&& value) {
    ...
    m_testSummary = std::forward<TestSummaryT>(value);
  }
  template <typename TestSummaryT = TestReportSummary>
  Report& WithTestSummary(TestSummaryT&& value) {
    SetTestSummary(std::forward<TestSummaryT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCodeCoverageSummary(CodeCoverageSummaryT&& value) {
    ...
    m_codeCoverageSummary = std::forward<CodeCoverageSummaryT>(value);
  }
  template <typename CodeCoverageSummaryT = CodeCoverageReportSummary>
  Report& WithCodeCoverageSummary(CodeCoverageSummaryT&& value) {
    SetCodeCoverageSummary(std::forward<CodeCoverageSummaryT>(value));
    return *this;
  }
  ///@}
 private:
