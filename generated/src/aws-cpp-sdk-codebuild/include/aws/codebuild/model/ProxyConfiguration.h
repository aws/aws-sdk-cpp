...
class ProxyConfiguration {
 public:
  ...
  inline void SetDefaultBehavior(FleetProxyRuleBehavior value) {
    m_defaultBehaviorHasBeenSet = true;
    m_defaultBehavior = value;
  }
  inline ProxyConfiguration& WithDefaultBehavior(FleetProxyRuleBehavior value) {
  ...
  void SetOrderedProxyRules(OrderedProxyRulesT&& value) {
    m_orderedProxyRulesHasBeenSet = true;
    m_orderedProxyRules = std::forward<OrderedProxyRulesT>(value);
  }
  template <typename OrderedProxyRulesT = Aws::Vector<FleetProxyRule>>
  ProxyConfiguration& WithOrderedProxyRules(OrderedProxyRulesT&& value) {
    SetOrderedProxyRules(std::forward<OrderedProxyRulesT>(value));
    return *this;
  }
  template <typename OrderedProxyRulesT = FleetProxyRule>
  ProxyConfiguration& AddOrderedProxyRules(OrderedProxyRulesT&& value) {
    m_orderedProxyRulesHasBeenSet = true;
    m_orderedProxyRules.emplace_back(std::forward<OrderedProxyRulesT>(value));
    return *this;
  }
  ///@}
 private:
