...
namespace Model
{
  ...
  {
  public:
    AWS_CODEBUILD_API InvalidateProjectCacheResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    InvalidateProjectCacheResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
