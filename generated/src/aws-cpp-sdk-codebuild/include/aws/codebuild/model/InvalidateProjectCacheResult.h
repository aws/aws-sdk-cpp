...
namespace Model
{
  ...
  public:
    ...
    inline InvalidateProjectCacheResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline InvalidateProjectCacheResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline InvalidateProjectCacheResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
