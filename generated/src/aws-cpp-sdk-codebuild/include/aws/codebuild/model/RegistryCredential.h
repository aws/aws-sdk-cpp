...
class RegistryCredential {
 public:
  ...
  inline void SetCredentialProvider(CredentialProviderType value) {
    m_credentialProviderHasBeenSet = true;
    m_credentialProvider = value;
  }
  inline RegistryCredential& WithCredentialProvider(CredentialProviderType value) {
    SetCredentialProvider(value);
    return *this;
  }
  ///@}
 private:
