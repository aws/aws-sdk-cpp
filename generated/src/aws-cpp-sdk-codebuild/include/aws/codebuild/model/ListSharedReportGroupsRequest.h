...
/**
 */
class ListSharedReportGroupsRequest : public CodeBuildRequest {
 public:
  AWS_CODEBUILD_API ListSharedReportGroupsRequest() = default;
  ...
  inline ListSharedReportGroupsRequest& WithSortOrder(SortOrderType value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSortBy(SharedResourceSortByType value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ListSharedReportGroupsRequest& WithSortBy(SharedResourceSortByType value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListSharedReportGroupsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListSharedReportGroupsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
