...
class UpdateWebhookRequest : public CodeBuildRequest {
 public:
  ...
  void SetBranchFilter(BranchFilterT&& value) {
    ...
    m_branchFilter = std::forward<BranchFilterT>(value);
  }
  template <typename BranchFilterT = Aws::String>
  UpdateWebhookRequest& WithBranchFilter(BranchFilterT&& value) {
    SetBranchFilter(std::forward<BranchFilterT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetRotateSecret(bool value) {
    m_rotateSecretHasBeenSet = true;
    m_rotateSecret = value;
  }
  inline UpdateWebhookRequest& WithRotateSecret(bool value) {
    SetRotateSecret(value);
    return *this;
  }
  ///@}
  ...
  inline void SetBuildType(WebhookBuildType value) {
    m_buildTypeHasBeenSet = true;
    m_buildType = value;
  }
  inline UpdateWebhookRequest& WithBuildType(WebhookBuildType value) {
    SetBuildType(value);
    return *this;
  }
  ///@}
  ...
  void SetPullRequestBuildPolicy(PullRequestBuildPolicyT&& value) {
    ...
    m_pullRequestBuildPolicy = std::forward<PullRequestBuildPolicyT>(value);
  }
  template <typename PullRequestBuildPolicyT = PullRequestBuildPolicy>
  UpdateWebhookRequest& WithPullRequestBuildPolicy(PullRequestBuildPolicyT&& value) {
    SetPullRequestBuildPolicy(std::forward<PullRequestBuildPolicyT>(value));
    return *this;
  }
  ///@}
 private:
