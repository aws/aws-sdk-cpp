...
namespace Model
{
  ...
  {
  public:
    AWS_CODEBUILD_API DeleteReportGroupResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteReportGroupResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
