...
class WebhookFilter {
 public:
  ...
  inline void SetType(WebhookFilterType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline WebhookFilter& WithType(WebhookFilterType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename PatternT = Aws::String>
  WebhookFilter& WithPattern(PatternT&& value) {
  ...
  inline void SetExcludeMatchedPattern(bool value) {
    m_excludeMatchedPatternHasBeenSet = true;
    m_excludeMatchedPattern = value;
  }
  inline WebhookFilter& WithExcludeMatchedPattern(bool value) {
    SetExcludeMatchedPattern(value);
    return *this;
  }
  ///@}
 private:
