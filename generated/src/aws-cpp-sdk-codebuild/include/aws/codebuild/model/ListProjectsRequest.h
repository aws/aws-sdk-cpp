...
class ListProjectsRequest : public CodeBuildRequest {
 public:
  ...
  inline void SetSortBy(ProjectSortByType value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ListProjectsRequest& WithSortBy(ProjectSortByType value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListProjectsRequest& WithSortOrder(SortOrderType value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
