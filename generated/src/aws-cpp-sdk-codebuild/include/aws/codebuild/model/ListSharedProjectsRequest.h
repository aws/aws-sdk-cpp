...
class ListSharedProjectsRequest : public CodeBuildRequest {
 public:
  ...
  inline ListSharedProjectsRequest& WithSortBy(SharedResourceSortByType value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListSharedProjectsRequest& WithSortOrder(SortOrderType value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  inline ListSharedProjectsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListSharedProjectsRequest& WithNextToken(NextTokenT&& value) {
