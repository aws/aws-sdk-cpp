...
class AutoRetryConfig {
 public:
  ...
  inline AutoRetryConfig& WithAutoRetryLimit(int value) {
  ...
  inline void SetAutoRetryNumber(int value) {
    m_autoRetryNumberHasBeenSet = true;
    m_autoRetryNumber = value;
  }
  inline AutoRetryConfig& WithAutoRetryNumber(int value) {
    SetAutoRetryNumber(value);
    return *this;
  }
  ///@}
  ...
  void SetNextAutoRetry(NextAutoRetryT&& value) {
    ...
    m_nextAutoRetry = std::forward<NextAutoRetryT>(value);
  }
  template <typename NextAutoRetryT = Aws::String>
  AutoRetryConfig& WithNextAutoRetry(NextAutoRetryT&& value) {
    SetNextAutoRetry(std::forward<NextAutoRetryT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPreviousAutoRetry(PreviousAutoRetryT&& value) {
    ...
    m_previousAutoRetry = std::forward<PreviousAutoRetryT>(value);
  }
  template <typename PreviousAutoRetryT = Aws::String>
  AutoRetryConfig& WithPreviousAutoRetry(PreviousAutoRetryT&& value) {
    SetPreviousAutoRetry(std::forward<PreviousAutoRetryT>(value));
    return *this;
  }
  ///@}
 private:
