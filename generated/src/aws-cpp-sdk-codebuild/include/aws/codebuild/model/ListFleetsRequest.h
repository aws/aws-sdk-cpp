...
class ListFleetsRequest : public CodeBuildRequest {
 public:
  ...
  inline ListFleetsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline ListFleetsRequest& WithSortOrder(SortOrderType value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSortBy(FleetSortByType value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ListFleetsRequest& WithSortBy(FleetSortByType value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
