...
class ListReportGroupsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListReportGroupsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ReportGroupsT = Aws::Vector<Aws::String>>
  ListReportGroupsResult& WithReportGroups(ReportGroupsT&& value) {
    SetReportGroups(std::forward<ReportGroupsT>(value));
    return *this;
  }
  template <typename ReportGroupsT = Aws::String>
  ListReportGroupsResult& AddReportGroups(ReportGroupsT&& value) {
    m_reportGroupsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListReportGroupsResult& WithRequestId(RequestIdT&& value) {
