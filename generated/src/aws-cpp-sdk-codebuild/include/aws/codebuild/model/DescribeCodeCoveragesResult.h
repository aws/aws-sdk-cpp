...
namespace Model
{
  ...
  public:
    ...
    template<typename NextTokenT = Aws::String>
    DescribeCodeCoveragesResult& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    void SetCodeCoverages(CodeCoveragesT&& value) { m_codeCoveragesHasBeenSet = true; m_codeCoverages = std::forward<CodeCoveragesT>(value); }
    template<typename CodeCoveragesT = Aws::Vector<CodeCoverage>>
    DescribeCodeCoveragesResult& WithCodeCoverages(CodeCoveragesT&& value) { SetCodeCoverages(std::forward<CodeCoveragesT>(value)); return *this;}
    template<typename CodeCoveragesT = CodeCoverage>
    DescribeCodeCoveragesResult& AddCodeCoverages(CodeCoveragesT&& value) { m_codeCoveragesHasBeenSet = true; m_codeCoverages.emplace_back(std::forward<CodeCoveragesT>(value)); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DescribeCodeCoveragesResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
