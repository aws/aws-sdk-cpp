...
namespace Model
{
  ...
  public:
    ...
    inline DescribeCodeCoveragesResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DescribeCodeCoveragesResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DescribeCodeCoveragesResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
