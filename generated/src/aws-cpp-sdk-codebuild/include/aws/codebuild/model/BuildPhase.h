...
class BuildPhase {
 public:
  ...
  inline void SetPhaseType(BuildPhaseType value) {
    m_phaseTypeHasBeenSet = true;
    m_phaseType = value;
  }
  inline BuildPhase& WithPhaseType(BuildPhaseType value) {
    SetPhaseType(value);
    return *this;
  }
  ///@}
  ...
  inline BuildPhase& WithPhaseStatus(StatusType value) {
  ...
  inline BuildPhase& WithDurationInSeconds(long long value) {
