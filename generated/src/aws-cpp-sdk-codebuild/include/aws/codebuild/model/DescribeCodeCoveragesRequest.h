...
class DescribeCodeCoveragesRequest : public CodeBuildRequest {
 public:
  ...
  inline DescribeCodeCoveragesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeCodeCoveragesRequest& WithSortOrder(SortOrderType value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSortBy(ReportCodeCoverageSortByType value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline DescribeCodeCoveragesRequest& WithSortBy(ReportCodeCoverageSortByType value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMinLineCoveragePercentage(double value) {
    m_minLineCoveragePercentageHasBeenSet = true;
    m_minLineCoveragePercentage = value;
  }
  inline DescribeCodeCoveragesRequest& WithMinLineCoveragePercentage(double value) {
    SetMinLineCoveragePercentage(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxLineCoveragePercentage(double value) {
    m_maxLineCoveragePercentageHasBeenSet = true;
    m_maxLineCoveragePercentage = value;
  }
  inline DescribeCodeCoveragesRequest& WithMaxLineCoveragePercentage(double value) {
    SetMaxLineCoveragePercentage(value);
    return *this;
  }
  ///@}
 private:
