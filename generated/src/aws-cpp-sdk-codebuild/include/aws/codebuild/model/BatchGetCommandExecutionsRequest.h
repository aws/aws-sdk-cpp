...
class BatchGetCommandExecutionsRequest : public CodeBuildRequest {
 public:
  ...
  void SetCommandExecutionIds(CommandExecutionIdsT&& value) {
    m_commandExecutionIdsHasBeenSet = true;
    m_commandExecutionIds = std::forward<CommandExecutionIdsT>(value);
  }
  template <typename CommandExecutionIdsT = Aws::Vector<Aws::String>>
  BatchGetCommandExecutionsRequest& WithCommandExecutionIds(CommandExecutionIdsT&& value) {
    SetCommandExecutionIds(std::forward<CommandExecutionIdsT>(value));
    return *this;
  }
  ...
  BatchGetCommandExecutionsRequest& AddCommandExecutionIds(CommandExecutionIdsT&& value) {
    m_commandExecutionIdsHasBeenSet = true;
    m_commandExecutionIds.emplace_back(std::forward<CommandExecutionIdsT>(value));
    return *this;
  }
  ///@}
 private:
