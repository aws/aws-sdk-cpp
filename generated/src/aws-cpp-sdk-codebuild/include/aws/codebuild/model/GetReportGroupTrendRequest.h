...
class GetReportGroupTrendRequest : public CodeBuildRequest {
 public:
  ...
  inline void SetNumOfReports(int value) {
    m_numOfReportsHasBeenSet = true;
    m_numOfReports = value;
  }
  inline GetReportGroupTrendRequest& WithNumOfReports(int value) {
  ...
  inline void SetTrendField(ReportGroupTrendFieldType value) {
    m_trendFieldHasBeenSet = true;
    m_trendField = value;
  }
  inline GetReportGroupTrendRequest& WithTrendField(ReportGroupTrendFieldType value) {
    SetTrendField(value);
    return *this;
  }
  ///@}
