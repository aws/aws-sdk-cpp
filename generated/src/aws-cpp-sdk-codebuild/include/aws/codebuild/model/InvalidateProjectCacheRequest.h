...
/**
 */
class InvalidateProjectCacheRequest : public CodeBuildRequest {
 public:
  AWS_CODEBUILD_API InvalidateProjectCacheRequest() = default;
  ...
  template <typename ProjectNameT = Aws::String>
  InvalidateProjectCacheRequest& WithProjectName(ProjectNameT&& value) {
