...
class CreateWebhookRequest : public CodeBuildRequest {
 public:
  ...
  inline CreateWebhookRequest& WithBuildType(WebhookBuildType value) {
    SetBuildType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetManualCreation(bool value) {
    m_manualCreationHasBeenSet = true;
    m_manualCreation = value;
  }
  inline CreateWebhookRequest& WithManualCreation(bool value) {
    SetManualCreation(value);
    return *this;
  }
  ///@}
  ...
  template <typename PullRequestBuildPolicyT = PullRequestBuildPolicy>
  CreateWebhookRequest& WithPullRequestBuildPolicy(PullRequestBuildPolicyT&& value) {
