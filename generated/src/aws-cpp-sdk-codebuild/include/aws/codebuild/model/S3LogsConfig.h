...
class S3LogsConfig {
 public:
  ...
  inline S3LogsConfig& WithStatus(LogsConfigStatusType value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline S3LogsConfig& WithEncryptionDisabled(bool value) {
  ...
  inline S3LogsConfig& WithBucketOwnerAccess(BucketOwnerAccess value) {
