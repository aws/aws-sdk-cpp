...
class ReportGroup {
 public:
  ...
  inline void SetType(ReportType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline ReportGroup& WithType(ReportType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(ReportGroupStatusType value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ReportGroup& WithStatus(ReportGroupStatusType value) {
    SetStatus(value);
    return *this;
  }
  ///@}
