...
class DockerServer {
 public:
  ...
  inline DockerServer& WithComputeType(ComputeType value) {
  ...
  template <typename SecurityGroupIdsT = Aws::Vector<Aws::String>>
  DockerServer& WithSecurityGroupIds(SecurityGroupIdsT&& value) {
    SetSecurityGroupIds(std::forward<SecurityGroupIdsT>(value));
    return *this;
  }
  template <typename SecurityGroupIdsT = Aws::String>
  DockerServer& AddSecurityGroupIds(SecurityGroupIdsT&& value) {
    m_securityGroupIdsHasBeenSet = true;
  ...
  template <typename StatusT = DockerServerStatus>
  DockerServer& WithStatus(StatusT&& value) {
