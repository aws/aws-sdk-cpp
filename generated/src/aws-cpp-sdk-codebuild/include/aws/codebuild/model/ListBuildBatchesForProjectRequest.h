...
class ListBuildBatchesForProjectRequest : public CodeBuildRequest {
 public:
  ...
  template <typename ProjectNameT = Aws::String>
  ListBuildBatchesForProjectRequest& WithProjectName(ProjectNameT&& value) {
  ...
  template <typename FilterT = BuildBatchFilter>
  ListBuildBatchesForProjectRequest& WithFilter(FilterT&& value) {
  ...
  inline ListBuildBatchesForProjectRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline ListBuildBatchesForProjectRequest& WithSortOrder(SortOrderType value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListBuildBatchesForProjectRequest& WithNextToken(NextTokenT&& value) {
