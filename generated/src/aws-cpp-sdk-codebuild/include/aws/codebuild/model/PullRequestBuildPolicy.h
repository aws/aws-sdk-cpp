...
class PullRequestBuildPolicy {
 public:
  ...
  inline void SetRequiresCommentApproval(PullRequestBuildCommentApproval value) {
    m_requiresCommentApprovalHasBeenSet = true;
    m_requiresCommentApproval = value;
  }
  inline PullRequestBuildPolicy& WithRequiresCommentApproval(PullRequestBuildCommentApproval value) {
    SetRequiresCommentApproval(value);
    return *this;
  }
  ///@}
  ...
  void SetApproverRoles(ApproverRolesT&& value) {
    m_approverRolesHasBeenSet = true;
    m_approverRoles = std::forward<ApproverRolesT>(value);
  }
  template <typename ApproverRolesT = Aws::Vector<PullRequestBuildApproverRole>>
  PullRequestBuildPolicy& WithApproverRoles(ApproverRolesT&& value) {
    SetApproverRoles(std::forward<ApproverRolesT>(value));
    return *this;
  }
  inline PullRequestBuildPolicy& AddApproverRoles(PullRequestBuildApproverRole value) {
    m_approverRolesHasBeenSet = true;
    m_approverRoles.push_back(value);
    return *this;
  }
  ///@}
 private:
