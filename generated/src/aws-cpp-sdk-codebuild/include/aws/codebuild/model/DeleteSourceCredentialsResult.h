...
namespace Model
{
  ...
  {
  public:
    AWS_CODEBUILD_API DeleteSourceCredentialsResult() = default;
    ...
    template<typename ArnT = Aws::String>
    DeleteSourceCredentialsResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DeleteSourceCredentialsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
