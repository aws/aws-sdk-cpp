...
class ListBuildBatchesForProjectResult {
 public:
  ...
  template <typename IdsT = Aws::Vector<Aws::String>>
  ListBuildBatchesForProjectResult& WithIds(IdsT&& value) {
    SetIds(std::forward<IdsT>(value));
    return *this;
  }
  template <typename IdsT = Aws::String>
  ListBuildBatchesForProjectResult& AddIds(IdsT&& value) {
    m_idsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListBuildBatchesForProjectResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListBuildBatchesForProjectResult& WithRequestId(RequestIdT&& value) {
