...
namespace Model
{
  ...
  /**
   */
  class ListCommandExecutionsForSandboxRequest : public CodeBuildRequest
  {
  public:
    AWS_CODEBUILD_API ListCommandExecutionsForSandboxRequest() = default;

    // Service request name is the Operation name which will send this request out,
    // each operation should has unique request name, so that we can get operation's name from this request.
    // Note: this is not true for response, multiple operations may have the same response name,
    // so we can not get operation's name from response.
    inline virtual const char* GetServiceRequestName() const override { return "ListCommandExecutionsForSandbox"; }
    ...
    template<typename SandboxIdT = Aws::String>
    ListCommandExecutionsForSandboxRequest& WithSandboxId(SandboxIdT&& value) { SetSandboxId(std::forward<SandboxIdT>(value)); return *this;}
    ///@}
    ...
    inline ListCommandExecutionsForSandboxRequest& WithMaxResults(int value) { SetMaxResults(value); return *this;}
    ///@}
    ...
    inline ListCommandExecutionsForSandboxRequest& WithSortOrder(SortOrderType value) { SetSortOrder(value); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListCommandExecutionsForSandboxRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
