...
Build::Build(JsonView jsonValue) { *this = jsonValue; }
...
Build& Build::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("exportedEnvironmentVariables")) {
    ...
    for (unsigned exportedEnvironmentVariablesIndex = 0;
         exportedEnvironmentVariablesIndex < exportedEnvironmentVariablesJsonList.GetLength(); ++exportedEnvironmentVariablesIndex) {
...
JsonValue Build::Jsonize() const {
  ...
  if (m_exportedEnvironmentVariablesHasBeenSet) {
    ...
    for (unsigned exportedEnvironmentVariablesIndex = 0;
         exportedEnvironmentVariablesIndex < exportedEnvironmentVariablesJsonList.GetLength(); ++exportedEnvironmentVariablesIndex) {
      exportedEnvironmentVariablesJsonList[exportedEnvironmentVariablesIndex].AsObject(
          m_exportedEnvironmentVariables[exportedEnvironmentVariablesIndex].Jsonize());
    }
