...
ProjectEnvironment::ProjectEnvironment(JsonView jsonValue) { *this = jsonValue; }
...
ProjectEnvironment& ProjectEnvironment::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("imagePullCredentialsType")) {
    m_imagePullCredentialsType =
        ImagePullCredentialsTypeMapper::GetImagePullCredentialsTypeForName(jsonValue.GetString("imagePullCredentialsType"));
...
JsonValue ProjectEnvironment::Jsonize() const {
  ...
  if (m_imagePullCredentialsTypeHasBeenSet) {
    payload.WithString("imagePullCredentialsType",
                       ImagePullCredentialsTypeMapper::GetNameForImagePullCredentialsType(m_imagePullCredentialsType));
  }
