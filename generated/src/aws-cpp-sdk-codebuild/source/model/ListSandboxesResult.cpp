...
ListSandboxesResult::ListSandboxesResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

ListSandboxesResult& ListSandboxesResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
