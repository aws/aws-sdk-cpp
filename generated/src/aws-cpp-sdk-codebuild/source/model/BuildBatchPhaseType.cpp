  ...
  namespace CodeBuild
  {
    namespace Model
    {
      namespace BuildBatchPhaseTypeMapper
      {
        ...
        static constexpr uint32_t DOWNLOAD_BATCHSPEC_HASH = ConstExprHashingUtils::HashString("DOWNLOAD_BATCHSPEC");
        static constexpr uint32_t IN_PROGRESS_HASH = ConstExprHashingUtils::HashString("IN_PROGRESS");
        static constexpr uint32_t COMBINE_ARTIFACTS_HASH = ConstExprHashingUtils::HashString("COMBINE_ARTIFACTS");
