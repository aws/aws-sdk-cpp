...
'"','h','t','t','p','s',':','/','/','c','o','d','e','b','u','i','l','d','-','f','i','p','s','.','{',
...
't','p','s',':','/','/','c','o','d','e','b','u','i','l','d','.','{','R','e','g','i','o','n','}','.',
...
'd','e','b','u','i','l','d','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i',
...
const char* CodeBuildEndpointRules::GetRulesBlob()
{
