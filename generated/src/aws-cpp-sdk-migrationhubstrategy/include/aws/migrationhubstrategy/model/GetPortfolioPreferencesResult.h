...
class GetPortfolioPreferencesResult {
 public:
  ...
  AWS_MIGRATIONHUBSTRATEGYRECOMMENDATIONS_API GetPortfolioPreferencesResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  inline GetPortfolioPreferencesResult& WithApplicationMode(ApplicationMode value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetPortfolioPreferencesResult& WithRequestId(RequestIdT&& value) {
