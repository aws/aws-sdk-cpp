...
class StartImportFileTaskResult {
 public:
  ...
  AWS_MIGRATIONHUBSTRATEGYRECOMMENDATIONS_API StartImportFileTaskResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename IdT = Aws::String>
  StartImportFileTaskResult& WithId(IdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StartImportFileTaskResult& WithRequestId(RequestIdT&& value) {
