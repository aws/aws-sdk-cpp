...
class Result {
 public:
  ...
  void SetAnalysisStatus(AnalysisStatusT&& value) {
    ...
    m_analysisStatus = std::forward<AnalysisStatusT>(value);
  }
  template <typename AnalysisStatusT = AnalysisStatusUnion>
  Result& WithAnalysisStatus(AnalysisStatusT&& value) {
    SetAnalysisStatus(std::forward<AnalysisStatusT>(value));
    return *this;
  }
  ///@}
  ...
  inline Result& WithAnalysisType(AnalysisType value) {
  ...
  void SetAntipatternReportResultList(AntipatternReportResultListT&& value) {
    ...
    m_antipatternReportResultList = std::forward<AntipatternReportResultListT>(value);
  }
  template <typename AntipatternReportResultListT = Aws::Vector<AntipatternReportResult>>
  Result& WithAntipatternReportResultList(AntipatternReportResultListT&& value) {
    SetAntipatternReportResultList(std::forward<AntipatternReportResultListT>(value));
    return *this;
  }
  ...
  Result& AddAntipatternReportResultList(AntipatternReportResultListT&& value) {
    m_antipatternReportResultListHasBeenSet = true;
    m_antipatternReportResultList.emplace_back(std::forward<AntipatternReportResultListT>(value));
    return *this;
  }
  ///@}
