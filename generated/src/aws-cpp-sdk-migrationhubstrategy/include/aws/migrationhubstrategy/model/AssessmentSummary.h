...
class AssessmentSummary {
 public:
  ...
  inline AssessmentSummary& WithAntipatternReportStatus(AntipatternReportStatus value) {
   ...
   */
  inline const Aws::Vector<ApplicationComponentStatusSummary>& GetListApplicationComponentStatusSummary() const {
    return m_listApplicationComponentStatusSummary;
  }
  ...
  void SetListApplicationComponentStatusSummary(ListApplicationComponentStatusSummaryT&& value) {
    ...
    m_listApplicationComponentStatusSummary = std::forward<ListApplicationComponentStatusSummaryT>(value);
  }
  template <typename ListApplicationComponentStatusSummaryT = Aws::Vector<ApplicationComponentStatusSummary>>
  AssessmentSummary& WithListApplicationComponentStatusSummary(ListApplicationComponentStatusSummaryT&& value) {
    SetListApplicationComponentStatusSummary(std::forward<ListApplicationComponentStatusSummaryT>(value));
    return *this;
  }
  ...
  AssessmentSummary& AddListApplicationComponentStatusSummary(ListApplicationComponentStatusSummaryT&& value) {
    m_listApplicationComponentStatusSummaryHasBeenSet = true;
    m_listApplicationComponentStatusSummary.emplace_back(std::forward<ListApplicationComponentStatusSummaryT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::Vector<StrategySummary>& GetListApplicationComponentStrategySummary() const {
    return m_listApplicationComponentStrategySummary;
  }
  ...
  void SetListApplicationComponentStrategySummary(ListApplicationComponentStrategySummaryT&& value) {
    ...
    m_listApplicationComponentStrategySummary = std::forward<ListApplicationComponentStrategySummaryT>(value);
  }
  template <typename ListApplicationComponentStrategySummaryT = Aws::Vector<StrategySummary>>
  AssessmentSummary& WithListApplicationComponentStrategySummary(ListApplicationComponentStrategySummaryT&& value) {
    SetListApplicationComponentStrategySummary(std::forward<ListApplicationComponentStrategySummaryT>(value));
    return *this;
  }
  ...
  AssessmentSummary& AddListApplicationComponentStrategySummary(ListApplicationComponentStrategySummaryT&& value) {
    m_listApplicationComponentStrategySummaryHasBeenSet = true;
    m_listApplicationComponentStrategySummary.emplace_back(std::forward<ListApplicationComponentStrategySummaryT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::Vector<ApplicationComponentSummary>& GetListApplicationComponentSummary() const {
    return m_listApplicationComponentSummary;
  }
  ...
  void SetListApplicationComponentSummary(ListApplicationComponentSummaryT&& value) {
    ...
    m_listApplicationComponentSummary = std::forward<ListApplicationComponentSummaryT>(value);
  }
  template <typename ListApplicationComponentSummaryT = Aws::Vector<ApplicationComponentSummary>>
  AssessmentSummary& WithListApplicationComponentSummary(ListApplicationComponentSummaryT&& value) {
    SetListApplicationComponentSummary(std::forward<ListApplicationComponentSummaryT>(value));
    return *this;
  }
  ...
  AssessmentSummary& AddListApplicationComponentSummary(ListApplicationComponentSummaryT&& value) {
    m_listApplicationComponentSummaryHasBeenSet = true;
    m_listApplicationComponentSummary.emplace_back(std::forward<ListApplicationComponentSummaryT>(value));
    return *this;
  }
  ///@}
  ...
  void SetListServerStatusSummary(ListServerStatusSummaryT&& value) {
    ...
    m_listServerStatusSummary = std::forward<ListServerStatusSummaryT>(value);
  }
  template <typename ListServerStatusSummaryT = Aws::Vector<ServerStatusSummary>>
  AssessmentSummary& WithListServerStatusSummary(ListServerStatusSummaryT&& value) {
    SetListServerStatusSummary(std::forward<ListServerStatusSummaryT>(value));
    return *this;
  }
  ...
  AssessmentSummary& AddListServerStatusSummary(ListServerStatusSummaryT&& value) {
    m_listServerStatusSummaryHasBeenSet = true;
    m_listServerStatusSummary.emplace_back(std::forward<ListServerStatusSummaryT>(value));
    return *this;
  }
  ///@}
  ...
  void SetListServerStrategySummary(ListServerStrategySummaryT&& value) {
    ...
    m_listServerStrategySummary = std::forward<ListServerStrategySummaryT>(value);
  }
  template <typename ListServerStrategySummaryT = Aws::Vector<StrategySummary>>
  AssessmentSummary& WithListServerStrategySummary(ListServerStrategySummaryT&& value) {
    SetListServerStrategySummary(std::forward<ListServerStrategySummaryT>(value));
    return *this;
  }
  ...
  AssessmentSummary& AddListServerStrategySummary(ListServerStrategySummaryT&& value) {
    m_listServerStrategySummaryHasBeenSet = true;
    m_listServerStrategySummary.emplace_back(std::forward<ListServerStrategySummaryT>(value));
    return *this;
  }
  ///@}
  ...
  void SetListServerSummary(ListServerSummaryT&& value) {
    ...
    m_listServerSummary = std::forward<ListServerSummaryT>(value);
  }
  template <typename ListServerSummaryT = Aws::Vector<ServerSummary>>
  AssessmentSummary& WithListServerSummary(ListServerSummaryT&& value) {
    SetListServerSummary(std::forward<ListServerSummaryT>(value));
    return *this;
  }
  template <typename ListServerSummaryT = ServerSummary>
  AssessmentSummary& AddListServerSummary(ListServerSummaryT&& value) {
    m_listServerSummaryHasBeenSet = true;
    m_listServerSummary.emplace_back(std::forward<ListServerSummaryT>(value));
    return *this;
  }
  ///@}
 private:
