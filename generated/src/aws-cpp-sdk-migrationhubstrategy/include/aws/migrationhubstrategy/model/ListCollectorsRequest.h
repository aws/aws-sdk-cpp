...
namespace Model
{
  ...
  {
  public:
    AWS_MIGRATIONHUBSTRATEGYRECOMMENDATIONS_API ListCollectorsRequest() = default;
    ...
    template<typename NextTokenT = Aws::String>
    ListCollectorsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
