...
class GetImportFileTaskResult {
 public:
  ...
  AWS_MIGRATIONHUBSTRATEGYRECOMMENDATIONS_API GetImportFileTaskResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  inline GetImportFileTaskResult& WithNumberOfRecordsFailed(int value) {
  ...
  inline GetImportFileTaskResult& WithNumberOfRecordsSuccess(int value) {
  ...
  inline GetImportFileTaskResult& WithStatus(ImportFileTaskStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
