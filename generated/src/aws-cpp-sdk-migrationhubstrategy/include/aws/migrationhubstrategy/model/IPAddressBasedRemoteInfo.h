...
class IPAddressBasedRemoteInfo {
 public:
  ...
  inline IPAddressBasedRemoteInfo& WithAuthType(AuthType value) {
    SetAuthType(value);
    return *this;
  }
  ///@}
  ...
  void SetIpAddressConfigurationTimeStamp(IpAddressConfigurationTimeStampT&& value) {
    ...
    m_ipAddressConfigurationTimeStamp = std::forward<IpAddressConfigurationTimeStampT>(value);
  }
  template <typename IpAddressConfigurationTimeStampT = Aws::String>
  IPAddressBasedRemoteInfo& WithIpAddressConfigurationTimeStamp(IpAddressConfigurationTimeStampT&& value) {
    SetIpAddressConfigurationTimeStamp(std::forward<IpAddressConfigurationTimeStampT>(value));
    return *this;
  }
  ///@}
  ...
  inline IPAddressBasedRemoteInfo& WithOsType(OSType value) {
    SetOsType(value);
    return *this;
  }
  ///@}
