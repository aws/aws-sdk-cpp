...
class AnalysisStatusUnion {
 public:
  ...
  inline void SetRuntimeAnalysisStatus(RuntimeAnalysisStatus value) {
    m_runtimeAnalysisStatusHasBeenSet = true;
    m_runtimeAnalysisStatus = value;
  }
  inline AnalysisStatusUnion& WithRuntimeAnalysisStatus(RuntimeAnalysisStatus value) {
    SetRuntimeAnalysisStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSrcCodeOrDbAnalysisStatus(SrcCodeOrDbAnalysisStatus value) {
    m_srcCodeOrDbAnalysisStatusHasBeenSet = true;
    m_srcCodeOrDbAnalysisStatus = value;
  }
  inline AnalysisStatusUnion& WithSrcCodeOrDbAnalysisStatus(SrcCodeOrDbAnalysisStatus value) {
    SetSrcCodeOrDbAnalysisStatus(value);
    return *this;
  }
  ///@}
 private:
