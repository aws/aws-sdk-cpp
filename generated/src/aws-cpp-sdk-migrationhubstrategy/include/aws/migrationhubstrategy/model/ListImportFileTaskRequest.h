...
/**
 */
class ListImportFileTaskRequest : public MigrationHubStrategyRecommendationsRequest {
 public:
  AWS_MIGRATIONHUBSTRATEGYRECOMMENDATIONS_API ListImportFileTaskRequest() = default;
  ...
  inline ListImportFileTaskRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListImportFileTaskRequest& WithNextToken(NextTokenT&& value) {
