...
namespace Model
{
  ...
  public:
    ...
    inline GetServerDetailsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline GetServerDetailsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline GetServerDetailsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
