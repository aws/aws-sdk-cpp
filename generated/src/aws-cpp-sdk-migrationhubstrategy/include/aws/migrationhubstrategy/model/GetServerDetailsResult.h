...
class GetServerDetailsResult {
 public:
  ...
  AWS_MIGRATIONHUBSTRATEGYRECOMMENDATIONS_API GetServerDetailsResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename NextTokenT = Aws::String>
  GetServerDetailsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetServerDetail(ServerDetailT&& value) {
    m_serverDetailHasBeenSet = true;
    m_serverDetail = std::forward<ServerDetailT>(value);
  }
  template <typename ServerDetailT = ServerDetail>
  GetServerDetailsResult& WithServerDetail(ServerDetailT&& value) {
    SetServerDetail(std::forward<ServerDetailT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetServerDetailsResult& WithRequestId(RequestIdT&& value) {
