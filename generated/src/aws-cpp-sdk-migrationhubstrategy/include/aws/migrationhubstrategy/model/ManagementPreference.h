...
class ManagementPreference {
 public:
  ...
  void SetAwsManagedResources(AwsManagedResourcesT&& value) {
    ...
    m_awsManagedResources = std::forward<AwsManagedResourcesT>(value);
  }
  template <typename AwsManagedResourcesT = AwsManagedResources>
  ManagementPreference& WithAwsManagedResources(AwsManagedResourcesT&& value) {
    SetAwsManagedResources(std::forward<AwsManagedResourcesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSelfManageResources(SelfManageResourcesT&& value) {
    ...
    m_selfManageResources = std::forward<SelfManageResourcesT>(value);
  }
  template <typename SelfManageResourcesT = SelfManageResources>
  ManagementPreference& WithSelfManageResources(SelfManageResourcesT&& value) {
    SetSelfManageResources(std::forward<SelfManageResourcesT>(value));
    return *this;
  }
  ///@}
 private:
