...
class AwsManagedResources {
 public:
  ...
  void SetTargetDestination(TargetDestinationT&& value) {
    ...
    m_targetDestination = std::forward<TargetDestinationT>(value);
  }
  template <typename TargetDestinationT = Aws::Vector<AwsManagedTargetDestination>>
  AwsManagedResources& WithTargetDestination(TargetDestinationT&& value) {
    SetTargetDestination(std::forward<TargetDestinationT>(value));
    return *this;
  }
  inline AwsManagedResources& AddTargetDestination(AwsManagedTargetDestination value) {
    m_targetDestinationHasBeenSet = true;
    m_targetDestination.push_back(value);
    return *this;
  }
  ///@}
 private:
