...
class TransformationTool {
 public:
  ...
  template <typename DescriptionT = Aws::String>
  TransformationTool& WithDescription(DescriptionT&& value) {
  ...
  inline void SetName(TransformationToolName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline TransformationTool& WithName(TransformationToolName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  void SetTranformationToolInstallationLink(TranformationToolInstallationLinkT&& value) {
    m_tranformationToolInstallationLinkHasBeenSet = true;
    m_tranformationToolInstallationLink = std::forward<TranformationToolInstallationLinkT>(value);
  }
  template <typename TranformationToolInstallationLinkT = Aws::String>
  TransformationTool& WithTranformationToolInstallationLink(TranformationToolInstallationLinkT&& value) {
    SetTranformationToolInstallationLink(std::forward<TranformationToolInstallationLinkT>(value));
    return *this;
  }
  ///@}
 private:
