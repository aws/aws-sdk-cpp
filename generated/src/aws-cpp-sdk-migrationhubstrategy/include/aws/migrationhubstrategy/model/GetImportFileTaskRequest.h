...
namespace Model
{
  ...
  {
  public:
    AWS_MIGRATIONHUBSTRATEGYRECOMMENDATIONS_API GetImportFileTaskRequest() = default;
    ...
    template<typename IdT = Aws::String>
    GetImportFileTaskRequest& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
  private:
