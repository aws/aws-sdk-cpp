...
class GetAssessmentResult {
 public:
  ...
  AWS_MIGRATIONHUBSTRATEGYRECOMMENDATIONS_API GetAssessmentResult& operator=(
  ...
  template <typename AssessmentTargetsT = Aws::Vector<AssessmentTarget>>
  GetAssessmentResult& WithAssessmentTargets(AssessmentTargetsT&& value) {
    SetAssessmentTargets(std::forward<AssessmentTargetsT>(value));
    return *this;
  }
  template <typename AssessmentTargetsT = AssessmentTarget>
  GetAssessmentResult& AddAssessmentTargets(AssessmentTargetsT&& value) {
    m_assessmentTargetsHasBeenSet = true;
  ...
  void SetDataCollectionDetails(DataCollectionDetailsT&& value) {
    m_dataCollectionDetailsHasBeenSet = true;
    m_dataCollectionDetails = std::forward<DataCollectionDetailsT>(value);
  }
  template <typename DataCollectionDetailsT = DataCollectionDetails>
  GetAssessmentResult& WithDataCollectionDetails(DataCollectionDetailsT&& value) {
    SetDataCollectionDetails(std::forward<DataCollectionDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename IdT = Aws::String>
  GetAssessmentResult& WithId(IdT&& value) {
