...
class DatabaseMigrationPreference {
 public:
  ...
  void SetHeterogeneous(HeterogeneousT&& value) {
    ...
    m_heterogeneous = std::forward<HeterogeneousT>(value);
  }
  template <typename HeterogeneousT = Heterogeneous>
  DatabaseMigrationPreference& WithHeterogeneous(HeterogeneousT&& value) {
    SetHeterogeneous(std::forward<HeterogeneousT>(value));
    return *this;
  }
  ///@}
  ...
  void SetHomogeneous(HomogeneousT&& value) {
    ...
    m_homogeneous = std::forward<HomogeneousT>(value);
  }
  template <typename HomogeneousT = Homogeneous>
  DatabaseMigrationPreference& WithHomogeneous(HomogeneousT&& value) {
    SetHomogeneous(std::forward<HomogeneousT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNoPreference(NoPreferenceT&& value) {
    ...
    m_noPreference = std::forward<NoPreferenceT>(value);
  }
  template <typename NoPreferenceT = NoDatabaseMigrationPreference>
  DatabaseMigrationPreference& WithNoPreference(NoPreferenceT&& value) {
    SetNoPreference(std::forward<NoPreferenceT>(value));
    return *this;
  }
  ///@}
 private:
