...
class ListServersRequest : public MigrationHubStrategyRecommendationsRequest {
 public:
  ...
  template <typename FilterValueT = Aws::String>
  ListServersRequest& WithFilterValue(FilterValueT&& value) {
  ...
  template <typename GroupIdFilterT = Aws::Vector<Group>>
  ListServersRequest& WithGroupIdFilter(GroupIdFilterT&& value) {
    SetGroupIdFilter(std::forward<GroupIdFilterT>(value));
    return *this;
  }
  template <typename GroupIdFilterT = Group>
  ListServersRequest& AddGroupIdFilter(GroupIdFilterT&& value) {
    m_groupIdFilterHasBeenSet = true;
  ...
  inline ListServersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListServersRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline void SetServerCriteria(ServerCriteria value) {
    m_serverCriteriaHasBeenSet = true;
    m_serverCriteria = value;
  }
  inline ListServersRequest& WithServerCriteria(ServerCriteria value) {
    SetServerCriteria(value);
    return *this;
  }
  ///@}
  ...
  inline ListServersRequest& WithSort(SortOrder value) {
    SetSort(value);
    return *this;
  }
  ///@}
