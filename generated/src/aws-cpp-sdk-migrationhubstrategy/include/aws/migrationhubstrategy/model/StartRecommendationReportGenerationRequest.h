...
class StartRecommendationReportGenerationRequest : public MigrationHubStrategyRecommendationsRequest {
 public:
  ...
  template <typename GroupIdFilterT = Aws::Vector<Group>>
  StartRecommendationReportGenerationRequest& WithGroupIdFilter(GroupIdFilterT&& value) {
    SetGroupIdFilter(std::forward<GroupIdFilterT>(value));
    return *this;
  }
  template <typename GroupIdFilterT = Group>
  StartRecommendationReportGenerationRequest& AddGroupIdFilter(GroupIdFilterT&& value) {
    m_groupIdFilterHasBeenSet = true;
  ...
  inline StartRecommendationReportGenerationRequest& WithOutputFormat(OutputFormat value) {
