...
class ListImportFileTaskResult {
 public:
  ...
  AWS_MIGRATIONHUBSTRATEGYRECOMMENDATIONS_API ListImportFileTaskResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename NextTokenT = Aws::String>
  ListImportFileTaskResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetTaskInfos(TaskInfosT&& value) {
    m_taskInfosHasBeenSet = true;
    m_taskInfos = std::forward<TaskInfosT>(value);
  }
  template <typename TaskInfosT = Aws::Vector<ImportFileTaskInformation>>
  ListImportFileTaskResult& WithTaskInfos(TaskInfosT&& value) {
    SetTaskInfos(std::forward<TaskInfosT>(value));
    return *this;
  }
  template <typename TaskInfosT = ImportFileTaskInformation>
  ListImportFileTaskResult& AddTaskInfos(TaskInfosT&& value) {
    m_taskInfosHasBeenSet = true;
    m_taskInfos.emplace_back(std::forward<TaskInfosT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListImportFileTaskResult& WithRequestId(RequestIdT&& value) {
