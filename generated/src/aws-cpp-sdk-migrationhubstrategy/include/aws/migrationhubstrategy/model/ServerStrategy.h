...
class ServerStrategy {
 public:
  ...
  inline ServerStrategy& WithIsPreferred(bool value) {
  ...
  inline void SetNumberOfApplicationComponents(int value) {
    m_numberOfApplicationComponentsHasBeenSet = true;
    m_numberOfApplicationComponents = value;
  }
  inline ServerStrategy& WithNumberOfApplicationComponents(int value) {
    SetNumberOfApplicationComponents(value);
    return *this;
  }
  ///@}
  ...
  inline ServerStrategy& WithStatus(StrategyRecommendation value) {
    SetStatus(value);
    return *this;
  }
  ///@}
