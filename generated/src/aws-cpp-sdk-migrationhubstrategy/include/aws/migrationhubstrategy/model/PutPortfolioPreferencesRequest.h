...
class PutPortfolioPreferencesRequest : public MigrationHubStrategyRecommendationsRequest {
 public:
  ...
  inline PutPortfolioPreferencesRequest& WithApplicationMode(ApplicationMode value) {
  ...
  void SetApplicationPreferences(ApplicationPreferencesT&& value) {
    m_applicationPreferencesHasBeenSet = true;
    m_applicationPreferences = std::forward<ApplicationPreferencesT>(value);
  }
  template <typename ApplicationPreferencesT = ApplicationPreferences>
  PutPortfolioPreferencesRequest& WithApplicationPreferences(ApplicationPreferencesT&& value) {
    SetApplicationPreferences(std::forward<ApplicationPreferencesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDatabasePreferences(DatabasePreferencesT&& value) {
    m_databasePreferencesHasBeenSet = true;
    m_databasePreferences = std::forward<DatabasePreferencesT>(value);
  }
  template <typename DatabasePreferencesT = DatabasePreferences>
  PutPortfolioPreferencesRequest& WithDatabasePreferences(DatabasePreferencesT&& value) {
    SetDatabasePreferences(std::forward<DatabasePreferencesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPrioritizeBusinessGoals(PrioritizeBusinessGoalsT&& value) {
    m_prioritizeBusinessGoalsHasBeenSet = true;
    m_prioritizeBusinessGoals = std::forward<PrioritizeBusinessGoalsT>(value);
  }
  template <typename PrioritizeBusinessGoalsT = PrioritizeBusinessGoals>
  PutPortfolioPreferencesRequest& WithPrioritizeBusinessGoals(PrioritizeBusinessGoalsT&& value) {
    SetPrioritizeBusinessGoals(std::forward<PrioritizeBusinessGoalsT>(value));
    return *this;
  }
  ///@}
 private:
