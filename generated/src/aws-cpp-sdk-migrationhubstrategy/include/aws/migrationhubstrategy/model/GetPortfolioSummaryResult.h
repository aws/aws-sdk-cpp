...
class GetPortfolioSummaryResult {
 public:
  ...
  AWS_MIGRATIONHUBSTRATEGYRECOMMENDATIONS_API GetPortfolioSummaryResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  void SetAssessmentSummary(AssessmentSummaryT&& value) {
    m_assessmentSummaryHasBeenSet = true;
    m_assessmentSummary = std::forward<AssessmentSummaryT>(value);
  }
  template <typename AssessmentSummaryT = AssessmentSummary>
  GetPortfolioSummaryResult& WithAssessmentSummary(AssessmentSummaryT&& value) {
    SetAssessmentSummary(std::forward<AssessmentSummaryT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetPortfolioSummaryResult& WithRequestId(RequestIdT&& value) {
