...
class ApplicationComponentDetail {
 public:
  ...
  inline void SetAnalysisStatus(SrcCodeOrDbAnalysisStatus value) {
    m_analysisStatusHasBeenSet = true;
    m_analysisStatus = value;
  }
  inline ApplicationComponentDetail& WithAnalysisStatus(SrcCodeOrDbAnalysisStatus value) {
  ...
  inline ApplicationComponentDetail& WithAntipatternReportStatus(AntipatternReportStatus value) {
  ...
  inline ApplicationComponentDetail& WithAppType(AppType value) {
    SetAppType(value);
    return *this;
  }
  ///@}
  ...
  void SetAppUnitError(AppUnitErrorT&& value) {
    ...
    m_appUnitError = std::forward<AppUnitErrorT>(value);
  }
  template <typename AppUnitErrorT = AppUnitError>
  ApplicationComponentDetail& WithAppUnitError(AppUnitErrorT&& value) {
    SetAppUnitError(std::forward<AppUnitErrorT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAssociatedServerId(AssociatedServerIdT&& value) {
    ...
    m_associatedServerId = std::forward<AssociatedServerIdT>(value);
  }
  template <typename AssociatedServerIdT = Aws::String>
  ApplicationComponentDetail& WithAssociatedServerId(AssociatedServerIdT&& value) {
    SetAssociatedServerId(std::forward<AssociatedServerIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDatabaseConfigDetail(DatabaseConfigDetailT&& value) {
    ...
    m_databaseConfigDetail = std::forward<DatabaseConfigDetailT>(value);
  }
  template <typename DatabaseConfigDetailT = DatabaseConfigDetail>
  ApplicationComponentDetail& WithDatabaseConfigDetail(DatabaseConfigDetailT&& value) {
    SetDatabaseConfigDetail(std::forward<DatabaseConfigDetailT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetInclusionStatus(InclusionStatus value) {
    m_inclusionStatusHasBeenSet = true;
    m_inclusionStatus = value;
  }
  inline ApplicationComponentDetail& WithInclusionStatus(InclusionStatus value) {
    SetInclusionStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMoreServerAssociationExists(bool value) {
    m_moreServerAssociationExistsHasBeenSet = true;
    m_moreServerAssociationExists = value;
  }
  inline ApplicationComponentDetail& WithMoreServerAssociationExists(bool value) {
    SetMoreServerAssociationExists(value);
    return *this;
  }
  ///@}
  ...
  void SetOsDriver(OsDriverT&& value) {
    ...
    m_osDriver = std::forward<OsDriverT>(value);
  }
  template <typename OsDriverT = Aws::String>
  ApplicationComponentDetail& WithOsDriver(OsDriverT&& value) {
    SetOsDriver(std::forward<OsDriverT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetResourceSubType(ResourceSubType value) {
    m_resourceSubTypeHasBeenSet = true;
    m_resourceSubType = value;
  }
  inline ApplicationComponentDetail& WithResourceSubType(ResourceSubType value) {
    SetResourceSubType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRuntimeStatus(RuntimeAnalysisStatus value) {
    m_runtimeStatusHasBeenSet = true;
    m_runtimeStatus = value;
  }
  inline ApplicationComponentDetail& WithRuntimeStatus(RuntimeAnalysisStatus value) {
  ...
  void SetRuntimeStatusMessage(RuntimeStatusMessageT&& value) {
    ...
    m_runtimeStatusMessage = std::forward<RuntimeStatusMessageT>(value);
  }
  template <typename RuntimeStatusMessageT = Aws::String>
  ApplicationComponentDetail& WithRuntimeStatusMessage(RuntimeStatusMessageT&& value) {
    SetRuntimeStatusMessage(std::forward<RuntimeStatusMessageT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSourceCodeRepositories(SourceCodeRepositoriesT&& value) {
    ...
    m_sourceCodeRepositories = std::forward<SourceCodeRepositoriesT>(value);
  }
  template <typename SourceCodeRepositoriesT = Aws::Vector<SourceCodeRepository>>
  ApplicationComponentDetail& WithSourceCodeRepositories(SourceCodeRepositoriesT&& value) {
    SetSourceCodeRepositories(std::forward<SourceCodeRepositoriesT>(value));
    return *this;
  }
  ...
  ApplicationComponentDetail& AddSourceCodeRepositories(SourceCodeRepositoriesT&& value) {
    m_sourceCodeRepositoriesHasBeenSet = true;
    m_sourceCodeRepositories.emplace_back(std::forward<SourceCodeRepositoriesT>(value));
    return *this;
  }
  ///@}
