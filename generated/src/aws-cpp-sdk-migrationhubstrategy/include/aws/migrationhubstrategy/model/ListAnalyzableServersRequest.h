...
class ListAnalyzableServersRequest : public MigrationHubStrategyRecommendationsRequest {
 public:
  ...
  inline ListAnalyzableServersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAnalyzableServersRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListAnalyzableServersRequest& WithSort(SortOrder value) {
    SetSort(value);
    return *this;
  }
  ///@}
