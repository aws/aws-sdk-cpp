...
class ListApplicationComponentsRequest : public MigrationHubStrategyRecommendationsRequest {
 public:
  ...
  inline void SetApplicationComponentCriteria(ApplicationComponentCriteria value) {
    m_applicationComponentCriteriaHasBeenSet = true;
    m_applicationComponentCriteria = value;
  }
  inline ListApplicationComponentsRequest& WithApplicationComponentCriteria(ApplicationComponentCriteria value) {
    SetApplicationComponentCriteria(value);
    return *this;
  }
  ///@}
  ...
  template <typename FilterValueT = Aws::String>
  ListApplicationComponentsRequest& WithFilterValue(FilterValueT&& value) {
  ...
  template <typename GroupIdFilterT = Aws::Vector<Group>>
  ListApplicationComponentsRequest& WithGroupIdFilter(GroupIdFilterT&& value) {
    SetGroupIdFilter(std::forward<GroupIdFilterT>(value));
    return *this;
  }
  template <typename GroupIdFilterT = Group>
  ListApplicationComponentsRequest& AddGroupIdFilter(GroupIdFilterT&& value) {
    m_groupIdFilterHasBeenSet = true;
  ...
  inline ListApplicationComponentsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListApplicationComponentsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListApplicationComponentsRequest& WithSort(SortOrder value) {
    SetSort(value);
    return *this;
  }
  ///@}
