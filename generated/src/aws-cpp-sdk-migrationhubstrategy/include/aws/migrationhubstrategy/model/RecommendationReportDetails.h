...
class RecommendationReportDetails {
 public:
  ...
  inline void SetStatus(RecommendationReportStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline RecommendationReportDetails& WithStatus(RecommendationReportStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
