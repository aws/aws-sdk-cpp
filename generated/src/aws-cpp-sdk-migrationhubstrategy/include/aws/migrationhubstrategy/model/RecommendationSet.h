...
class RecommendationSet {
 public:
  ...
  inline void SetStrategy(Strategy value) {
    m_strategyHasBeenSet = true;
    m_strategy = value;
  }
  inline RecommendationSet& WithStrategy(Strategy value) {
    SetStrategy(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTargetDestination(TargetDestination value) {
    m_targetDestinationHasBeenSet = true;
    m_targetDestination = value;
  }
  inline RecommendationSet& WithTargetDestination(TargetDestination value) {
    SetTargetDestination(value);
    return *this;
  }
  ///@}
  ...
  void SetTransformationTool(TransformationToolT&& value) {
    ...
    m_transformationTool = std::forward<TransformationToolT>(value);
  }
  template <typename TransformationToolT = TransformationTool>
  RecommendationSet& WithTransformationTool(TransformationToolT&& value) {
    SetTransformationTool(std::forward<TransformationToolT>(value));
    return *this;
  }
  ///@}
 private:
