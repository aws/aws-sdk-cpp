...
class ServerDetail {
 public:
  ...
  void SetAntipatternReportS3Object(AntipatternReportS3ObjectT&& value) {
    ...
    m_antipatternReportS3Object = std::forward<AntipatternReportS3ObjectT>(value);
  }
  template <typename AntipatternReportS3ObjectT = S3Object>
  ServerDetail& WithAntipatternReportS3Object(AntipatternReportS3ObjectT&& value) {
    SetAntipatternReportS3Object(std::forward<AntipatternReportS3ObjectT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAntipatternReportStatus(AntipatternReportStatus value) {
    m_antipatternReportStatusHasBeenSet = true;
    m_antipatternReportStatus = value;
  }
  inline ServerDetail& WithAntipatternReportStatus(AntipatternReportStatus value) {
    SetAntipatternReportStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetAntipatternReportStatusMessage(AntipatternReportStatusMessageT&& value) {
    ...
    m_antipatternReportStatusMessage = std::forward<AntipatternReportStatusMessageT>(value);
  }
  template <typename AntipatternReportStatusMessageT = Aws::String>
  ServerDetail& WithAntipatternReportStatusMessage(AntipatternReportStatusMessageT&& value) {
    SetAntipatternReportStatusMessage(std::forward<AntipatternReportStatusMessageT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::Vector<StrategySummary>& GetApplicationComponentStrategySummary() const {
    return m_applicationComponentStrategySummary;
  }
  ...
  void SetApplicationComponentStrategySummary(ApplicationComponentStrategySummaryT&& value) {
    ...
    m_applicationComponentStrategySummary = std::forward<ApplicationComponentStrategySummaryT>(value);
  }
  template <typename ApplicationComponentStrategySummaryT = Aws::Vector<StrategySummary>>
  ServerDetail& WithApplicationComponentStrategySummary(ApplicationComponentStrategySummaryT&& value) {
    SetApplicationComponentStrategySummary(std::forward<ApplicationComponentStrategySummaryT>(value));
    return *this;
  }
  ...
  ServerDetail& AddApplicationComponentStrategySummary(ApplicationComponentStrategySummaryT&& value) {
    m_applicationComponentStrategySummaryHasBeenSet = true;
    m_applicationComponentStrategySummary.emplace_back(std::forward<ApplicationComponentStrategySummaryT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetDataCollectionStatus(RunTimeAssessmentStatus value) {
    m_dataCollectionStatusHasBeenSet = true;
    m_dataCollectionStatus = value;
  }
  inline ServerDetail& WithDataCollectionStatus(RunTimeAssessmentStatus value) {
    SetDataCollectionStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetLastAnalyzedTimestamp(LastAnalyzedTimestampT&& value) {
    ...
    m_lastAnalyzedTimestamp = std::forward<LastAnalyzedTimestampT>(value);
  }
  template <typename LastAnalyzedTimestampT = Aws::Utils::DateTime>
  ServerDetail& WithLastAnalyzedTimestamp(LastAnalyzedTimestampT&& value) {
    SetLastAnalyzedTimestamp(std::forward<LastAnalyzedTimestampT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::Vector<AntipatternSeveritySummary>& GetListAntipatternSeveritySummary() const {
    return m_listAntipatternSeveritySummary;
  }
  ...
  void SetListAntipatternSeveritySummary(ListAntipatternSeveritySummaryT&& value) {
    ...
    m_listAntipatternSeveritySummary = std::forward<ListAntipatternSeveritySummaryT>(value);
  }
  template <typename ListAntipatternSeveritySummaryT = Aws::Vector<AntipatternSeveritySummary>>
  ServerDetail& WithListAntipatternSeveritySummary(ListAntipatternSeveritySummaryT&& value) {
    SetListAntipatternSeveritySummary(std::forward<ListAntipatternSeveritySummaryT>(value));
    return *this;
  }
  ...
  ServerDetail& AddListAntipatternSeveritySummary(ListAntipatternSeveritySummaryT&& value) {
    m_listAntipatternSeveritySummaryHasBeenSet = true;
    m_listAntipatternSeveritySummary.emplace_back(std::forward<ListAntipatternSeveritySummaryT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRecommendationSet(RecommendationSetT&& value) {
    ...
    m_recommendationSet = std::forward<RecommendationSetT>(value);
  }
  template <typename RecommendationSetT = RecommendationSet>
  ServerDetail& WithRecommendationSet(RecommendationSetT&& value) {
    SetRecommendationSet(std::forward<RecommendationSetT>(value));
    return *this;
  }
  ///@}
  ...
  void SetServerError(ServerErrorT&& value) {
    ...
    m_serverError = std::forward<ServerErrorT>(value);
  }
  template <typename ServerErrorT = ServerError>
  ServerDetail& WithServerError(ServerErrorT&& value) {
    SetServerError(std::forward<ServerErrorT>(value));
    return *this;
  }
  ///@}
  ...
  void SetServerType(ServerTypeT&& value) {
    ...
    m_serverType = std::forward<ServerTypeT>(value);
  }
  template <typename ServerTypeT = Aws::String>
  ServerDetail& WithServerType(ServerTypeT&& value) {
    SetServerType(std::forward<ServerTypeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSystemInfo(SystemInfoT&& value) {
    ...
    m_systemInfo = std::forward<SystemInfoT>(value);
  }
  template <typename SystemInfoT = SystemInfo>
  ServerDetail& WithSystemInfo(SystemInfoT&& value) {
    SetSystemInfo(std::forward<SystemInfoT>(value));
    return *this;
  }
  ///@}
 private:
