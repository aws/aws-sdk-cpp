...
class VersionControlInfo {
 public:
  ...
  void SetVersionControlConfigurationTimeStamp(VersionControlConfigurationTimeStampT&& value) {
    ...
    m_versionControlConfigurationTimeStamp = std::forward<VersionControlConfigurationTimeStampT>(value);
  }
  template <typename VersionControlConfigurationTimeStampT = Aws::String>
  VersionControlInfo& WithVersionControlConfigurationTimeStamp(VersionControlConfigurationTimeStampT&& value) {
    SetVersionControlConfigurationTimeStamp(std::forward<VersionControlConfigurationTimeStampT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetVersionControlType(VersionControlType value) {
    m_versionControlTypeHasBeenSet = true;
    m_versionControlType = value;
  }
  inline VersionControlInfo& WithVersionControlType(VersionControlType value) {
    SetVersionControlType(value);
    return *this;
  }
  ///@}
 private:
