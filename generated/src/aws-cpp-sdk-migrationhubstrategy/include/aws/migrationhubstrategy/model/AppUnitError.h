...
class AppUnitError {
 public:
  ...
  inline void SetAppUnitErrorCategory(AppUnitErrorCategory value) {
    m_appUnitErrorCategoryHasBeenSet = true;
    m_appUnitErrorCategory = value;
  }
  inline AppUnitError& WithAppUnitErrorCategory(AppUnitErrorCategory value) {
    SetAppUnitErrorCategory(value);
    return *this;
  }
  ///@}
 private:
