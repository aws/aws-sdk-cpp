...
class VcenterBasedRemoteInfo {
 public:
  ...
  inline void SetOsType(OSType value) {
    m_osTypeHasBeenSet = true;
    m_osType = value;
  }
  inline VcenterBasedRemoteInfo& WithOsType(OSType value) {
    SetOsType(value);
    return *this;
  }
  ///@}
  ...
  void SetVcenterConfigurationTimeStamp(VcenterConfigurationTimeStampT&& value) {
    m_vcenterConfigurationTimeStampHasBeenSet = true;
    m_vcenterConfigurationTimeStamp = std::forward<VcenterConfigurationTimeStampT>(value);
  }
  template <typename VcenterConfigurationTimeStampT = Aws::String>
  VcenterBasedRemoteInfo& WithVcenterConfigurationTimeStamp(VcenterConfigurationTimeStampT&& value) {
    SetVcenterConfigurationTimeStamp(std::forward<VcenterConfigurationTimeStampT>(value));
    return *this;
  }
  ///@}
 private:
