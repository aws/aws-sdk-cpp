...
namespace Model
{
  ...
  public:
    ...
    inline UpdateApplicationComponentConfigResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateApplicationComponentConfigResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateApplicationComponentConfigResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
