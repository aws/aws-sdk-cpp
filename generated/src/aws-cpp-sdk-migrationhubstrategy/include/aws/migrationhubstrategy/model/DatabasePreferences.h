...
class DatabasePreferences {
 public:
  ...
  inline void SetDatabaseManagementPreference(DatabaseManagementPreference value) {
    m_databaseManagementPreferenceHasBeenSet = true;
    m_databaseManagementPreference = value;
  }
  inline DatabasePreferences& WithDatabaseManagementPreference(DatabaseManagementPreference value) {
    SetDatabaseManagementPreference(value);
    return *this;
  }
  ///@}
  ...
  void SetDatabaseMigrationPreference(DatabaseMigrationPreferenceT&& value) {
    ...
    m_databaseMigrationPreference = std::forward<DatabaseMigrationPreferenceT>(value);
  }
  template <typename DatabaseMigrationPreferenceT = DatabaseMigrationPreference>
  DatabasePreferences& WithDatabaseMigrationPreference(DatabaseMigrationPreferenceT&& value) {
    SetDatabaseMigrationPreference(std::forward<DatabaseMigrationPreferenceT>(value));
    return *this;
  }
  ///@}
 private:
