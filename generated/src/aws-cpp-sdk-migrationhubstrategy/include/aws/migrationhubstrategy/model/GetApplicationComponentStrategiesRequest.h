...
class GetApplicationComponentStrategiesRequest : public MigrationHubStrategyRecommendationsRequest {
 public:
  ...
  void SetApplicationComponentId(ApplicationComponentIdT&& value) {
    m_applicationComponentIdHasBeenSet = true;
    m_applicationComponentId = std::forward<ApplicationComponentIdT>(value);
  }
  template <typename ApplicationComponentIdT = Aws::String>
  GetApplicationComponentStrategiesRequest& WithApplicationComponentId(ApplicationComponentIdT&& value) {
    SetApplicationComponentId(std::forward<ApplicationComponentIdT>(value));
    return *this;
  }
  ///@}
 private:
