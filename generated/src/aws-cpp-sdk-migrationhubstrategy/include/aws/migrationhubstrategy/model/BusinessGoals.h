...
class BusinessGoals {
 public:
  ...
  inline void SetLicenseCostReduction(int value) {
    m_licenseCostReductionHasBeenSet = true;
    m_licenseCostReduction = value;
  }
  inline BusinessGoals& WithLicenseCostReduction(int value) {
    SetLicenseCostReduction(value);
    return *this;
  }
  ///@}
  ...
  inline bool ModernizeInfrastructureWithCloudNativeTechnologiesHasBeenSet() const {
    return m_modernizeInfrastructureWithCloudNativeTechnologiesHasBeenSet;
  }
  inline void SetModernizeInfrastructureWithCloudNativeTechnologies(int value) {
    m_modernizeInfrastructureWithCloudNativeTechnologiesHasBeenSet = true;
    m_modernizeInfrastructureWithCloudNativeTechnologies = value;
  }
  inline BusinessGoals& WithModernizeInfrastructureWithCloudNativeTechnologies(int value) {
    SetModernizeInfrastructureWithCloudNativeTechnologies(value);
    return *this;
  }
  ///@}
  ...
  inline bool ReduceOperationalOverheadWithManagedServicesHasBeenSet() const {
    return m_reduceOperationalOverheadWithManagedServicesHasBeenSet;
  }
  inline void SetReduceOperationalOverheadWithManagedServices(int value) {
    m_reduceOperationalOverheadWithManagedServicesHasBeenSet = true;
    m_reduceOperationalOverheadWithManagedServices = value;
  }
  inline BusinessGoals& WithReduceOperationalOverheadWithManagedServices(int value) {
    SetReduceOperationalOverheadWithManagedServices(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSpeedOfMigration(int value) {
    m_speedOfMigrationHasBeenSet = true;
    m_speedOfMigration = value;
  }
  inline BusinessGoals& WithSpeedOfMigration(int value) {
    SetSpeedOfMigration(value);
    return *this;
  }
  ///@}
 private:
