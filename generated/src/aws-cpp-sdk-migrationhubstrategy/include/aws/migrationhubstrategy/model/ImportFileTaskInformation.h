...
class ImportFileTaskInformation {
 public:
  ...
  template <typename CompletionTimeT = Aws::Utils::DateTime>
  ImportFileTaskInformation& WithCompletionTime(CompletionTimeT&& value) {
  ...
  template <typename IdT = Aws::String>
  ImportFileTaskInformation& WithId(IdT&& value) {
  ...
  void SetImportName(ImportNameT&& value) {
    ...
    m_importName = std::forward<ImportNameT>(value);
  }
  template <typename ImportNameT = Aws::String>
  ImportFileTaskInformation& WithImportName(ImportNameT&& value) {
    SetImportName(std::forward<ImportNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInputS3Bucket(InputS3BucketT&& value) {
    ...
    m_inputS3Bucket = std::forward<InputS3BucketT>(value);
  }
  template <typename InputS3BucketT = Aws::String>
  ImportFileTaskInformation& WithInputS3Bucket(InputS3BucketT&& value) {
    SetInputS3Bucket(std::forward<InputS3BucketT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInputS3Key(InputS3KeyT&& value) {
    ...
    m_inputS3Key = std::forward<InputS3KeyT>(value);
  }
  template <typename InputS3KeyT = Aws::String>
  ImportFileTaskInformation& WithInputS3Key(InputS3KeyT&& value) {
    SetInputS3Key(std::forward<InputS3KeyT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetNumberOfRecordsFailed(int value) {
    m_numberOfRecordsFailedHasBeenSet = true;
    m_numberOfRecordsFailed = value;
  }
  inline ImportFileTaskInformation& WithNumberOfRecordsFailed(int value) {
    SetNumberOfRecordsFailed(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNumberOfRecordsSuccess(int value) {
    m_numberOfRecordsSuccessHasBeenSet = true;
    m_numberOfRecordsSuccess = value;
  }
  inline ImportFileTaskInformation& WithNumberOfRecordsSuccess(int value) {
    SetNumberOfRecordsSuccess(value);
    return *this;
  }
  ///@}
  ...
  template <typename StartTimeT = Aws::Utils::DateTime>
  ImportFileTaskInformation& WithStartTime(StartTimeT&& value) {
  ...
  inline void SetStatus(ImportFileTaskStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ImportFileTaskInformation& WithStatus(ImportFileTaskStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetStatusReportS3Bucket(StatusReportS3BucketT&& value) {
    ...
    m_statusReportS3Bucket = std::forward<StatusReportS3BucketT>(value);
  }
  template <typename StatusReportS3BucketT = Aws::String>
  ImportFileTaskInformation& WithStatusReportS3Bucket(StatusReportS3BucketT&& value) {
    SetStatusReportS3Bucket(std::forward<StatusReportS3BucketT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStatusReportS3Key(StatusReportS3KeyT&& value) {
    ...
    m_statusReportS3Key = std::forward<StatusReportS3KeyT>(value);
  }
  template <typename StatusReportS3KeyT = Aws::String>
  ImportFileTaskInformation& WithStatusReportS3Key(StatusReportS3KeyT&& value) {
    SetStatusReportS3Key(std::forward<StatusReportS3KeyT>(value));
    return *this;
  }
  ///@}
 private:
