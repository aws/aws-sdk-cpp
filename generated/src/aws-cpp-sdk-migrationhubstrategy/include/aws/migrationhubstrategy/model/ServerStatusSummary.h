...
class ServerStatusSummary {
 public:
  ...
  inline ServerStatusSummary& WithCount(int value) {
    SetCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRunTimeAssessmentStatus(RunTimeAssessmentStatus value) {
    m_runTimeAssessmentStatusHasBeenSet = true;
    m_runTimeAssessmentStatus = value;
  }
  inline ServerStatusSummary& WithRunTimeAssessmentStatus(RunTimeAssessmentStatus value) {
    SetRunTimeAssessmentStatus(value);
    return *this;
  }
  ///@}
 private:
