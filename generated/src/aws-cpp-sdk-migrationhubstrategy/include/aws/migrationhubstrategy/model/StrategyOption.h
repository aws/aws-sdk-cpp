...
class StrategyOption {
 public:
  ...
  inline StrategyOption& WithIsPreferred(bool value) {
  ...
  inline StrategyOption& WithStrategy(Strategy value) {
    SetStrategy(value);
    return *this;
  }
  ///@}
  ...
  inline StrategyOption& WithTargetDestination(TargetDestination value) {
  ...
  inline void SetToolName(TransformationToolName value) {
    m_toolNameHasBeenSet = true;
    m_toolName = value;
  }
  inline StrategyOption& WithToolName(TransformationToolName value) {
    SetToolName(value);
    return *this;
  }
  ///@}
