...
class ServerError {
 public:
  ...
  inline void SetServerErrorCategory(ServerErrorCategory value) {
    m_serverErrorCategoryHasBeenSet = true;
    m_serverErrorCategory = value;
  }
  inline ServerError& WithServerErrorCategory(ServerErrorCategory value) {
    SetServerErrorCategory(value);
    return *this;
  }
  ///@}
 private:
