...
class UpdateApplicationComponentConfigRequest : public MigrationHubStrategyRecommendationsRequest {
 public:
  ...
  inline UpdateApplicationComponentConfigRequest& WithAppType(AppType value) {
    SetAppType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetConfigureOnly(bool value) {
    m_configureOnlyHasBeenSet = true;
    m_configureOnly = value;
  }
  inline UpdateApplicationComponentConfigRequest& WithConfigureOnly(bool value) {
    SetConfigureOnly(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateApplicationComponentConfigRequest& WithInclusionStatus(InclusionStatus value) {
  ...
  void SetSecretsManagerKey(SecretsManagerKeyT&& value) {
    m_secretsManagerKeyHasBeenSet = true;
    m_secretsManagerKey = std::forward<SecretsManagerKeyT>(value);
  }
  template <typename SecretsManagerKeyT = Aws::String>
  UpdateApplicationComponentConfigRequest& WithSecretsManagerKey(SecretsManagerKeyT&& value) {
    SetSecretsManagerKey(std::forward<SecretsManagerKeyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSourceCodeList(SourceCodeListT&& value) {
    m_sourceCodeListHasBeenSet = true;
    m_sourceCodeList = std::forward<SourceCodeListT>(value);
  }
  template <typename SourceCodeListT = Aws::Vector<SourceCode>>
  UpdateApplicationComponentConfigRequest& WithSourceCodeList(SourceCodeListT&& value) {
    SetSourceCodeList(std::forward<SourceCodeListT>(value));
    return *this;
  }
  ...
  UpdateApplicationComponentConfigRequest& AddSourceCodeList(SourceCodeListT&& value) {
    m_sourceCodeListHasBeenSet = true;
    m_sourceCodeList.emplace_back(std::forward<SourceCodeListT>(value));
    return *this;
  }
  ///@}
