...
class ServerSummary {
 public:
  ...
  inline void SetServerOsType(ServerOsType value) {
    m_serverOsTypeHasBeenSet = true;
    m_serverOsType = value;
  }
  inline ServerSummary& WithServerOsType(ServerOsType value) {
    SetServerOsType(value);
    return *this;
  }
  ///@}
  ...
  inline ServerSummary& WithCount(int value) {
    SetCount(value);
    return *this;
  }
  ///@}
