...
class GetServerDetailsRequest : public MigrationHubStrategyRecommendationsRequest {
 public:
  ...
  inline GetServerDetailsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetServerDetailsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ServerIdT = Aws::String>
  GetServerDetailsRequest& WithServerId(ServerIdT&& value) {
