...
namespace MigrationHubStrategyRecommendations
{
   ...
   * SDKs</a>.</p></p>
   */
  class AWS_MIGRATIONHUBSTRATEGYRECOMMENDATIONS_API MigrationHubStrategyRecommendationsClient : smithy::client::AwsSmithyClientT<Aws::MigrationHubStrategyRecommendations::SERVICE_NAME,
    ...
    Aws::Client::ClientWithAsyncTemplateMethods<MigrationHubStrategyRecommendationsClient>
  {
    public:
