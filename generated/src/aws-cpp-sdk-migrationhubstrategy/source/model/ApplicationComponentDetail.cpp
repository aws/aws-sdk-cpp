...
ApplicationComponentDetail::ApplicationComponentDetail(JsonView jsonValue) { *this = jsonValue; }
...
ApplicationComponentDetail& ApplicationComponentDetail::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("sourceCodeRepositories")) {
    ...
    for (unsigned sourceCodeRepositoriesIndex = 0; sourceCodeRepositoriesIndex < sourceCodeRepositoriesJsonList.GetLength();
         ++sourceCodeRepositoriesIndex) {
