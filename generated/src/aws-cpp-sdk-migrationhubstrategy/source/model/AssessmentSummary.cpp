...
AssessmentSummary& AssessmentSummary::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("antipatternReportStatus")) {
    m_antipatternReportStatus =
        AntipatternReportStatusMapper::GetAntipatternReportStatusForName(jsonValue.GetString("antipatternReportStatus"));
  ...
  if (jsonValue.ValueExists("listAntipatternSeveritySummary")) {
    ...
    for (unsigned listAntipatternSeveritySummaryIndex = 0;
         listAntipatternSeveritySummaryIndex < listAntipatternSeveritySummaryJsonList.GetLength(); ++listAntipatternSeveritySummaryIndex) {
  ...
  if (jsonValue.ValueExists("listApplicationComponentStatusSummary")) {
    ...
    for (unsigned listApplicationComponentStatusSummaryIndex = 0;
         listApplicationComponentStatusSummaryIndex < listApplicationComponentStatusSummaryJsonList.GetLength();
         ++listApplicationComponentStatusSummaryIndex) {
      m_listApplicationComponentStatusSummary.push_back(
          listApplicationComponentStatusSummaryJsonList[listApplicationComponentStatusSummaryIndex].AsObject());
    }
    m_listApplicationComponentStatusSummaryHasBeenSet = true;
  }
  if (jsonValue.ValueExists("listApplicationComponentStrategySummary")) {
    Aws::Utils::Array<JsonView> listApplicationComponentStrategySummaryJsonList =
        jsonValue.GetArray("listApplicationComponentStrategySummary");
    for (unsigned listApplicationComponentStrategySummaryIndex = 0;
         listApplicationComponentStrategySummaryIndex < listApplicationComponentStrategySummaryJsonList.GetLength();
         ++listApplicationComponentStrategySummaryIndex) {
      m_listApplicationComponentStrategySummary.push_back(
          listApplicationComponentStrategySummaryJsonList[listApplicationComponentStrategySummaryIndex].AsObject());
    }
  ...
  if (jsonValue.ValueExists("listApplicationComponentSummary")) {
    ...
    for (unsigned listApplicationComponentSummaryIndex = 0;
         listApplicationComponentSummaryIndex < listApplicationComponentSummaryJsonList.GetLength();
         ++listApplicationComponentSummaryIndex) {
  ...
  if (jsonValue.ValueExists("listServerStatusSummary")) {
    ...
    for (unsigned listServerStatusSummaryIndex = 0; listServerStatusSummaryIndex < listServerStatusSummaryJsonList.GetLength();
         ++listServerStatusSummaryIndex) {
  ...
  if (jsonValue.ValueExists("listServerStrategySummary")) {
    ...
    for (unsigned listServerStrategySummaryIndex = 0; listServerStrategySummaryIndex < listServerStrategySummaryJsonList.GetLength();
         ++listServerStrategySummaryIndex) {
...
JsonValue AssessmentSummary::Jsonize() const {
  ...
  if (m_antipatternReportStatusHasBeenSet) {
    payload.WithString("antipatternReportStatus",
                       AntipatternReportStatusMapper::GetNameForAntipatternReportStatus(m_antipatternReportStatus));
  }
  ...
  if (m_listAntipatternSeveritySummaryHasBeenSet) {
    ...
    for (unsigned listAntipatternSeveritySummaryIndex = 0;
         listAntipatternSeveritySummaryIndex < listAntipatternSeveritySummaryJsonList.GetLength(); ++listAntipatternSeveritySummaryIndex) {
      listAntipatternSeveritySummaryJsonList[listAntipatternSeveritySummaryIndex].AsObject(
          m_listAntipatternSeveritySummary[listAntipatternSeveritySummaryIndex].Jsonize());
    }
  ...
  if (m_listApplicationComponentStatusSummaryHasBeenSet) {
    ...
    for (unsigned listApplicationComponentStatusSummaryIndex = 0;
         ...
         ++listApplicationComponentStatusSummaryIndex) {
      listApplicationComponentStatusSummaryJsonList[listApplicationComponentStatusSummaryIndex].AsObject(
          m_listApplicationComponentStatusSummary[listApplicationComponentStatusSummaryIndex].Jsonize());
    }
  ...
  if (m_listApplicationComponentStrategySummaryHasBeenSet) {
    ...
    for (unsigned listApplicationComponentStrategySummaryIndex = 0;
         ...
         ++listApplicationComponentStrategySummaryIndex) {
      listApplicationComponentStrategySummaryJsonList[listApplicationComponentStrategySummaryIndex].AsObject(
          m_listApplicationComponentStrategySummary[listApplicationComponentStrategySummaryIndex].Jsonize());
    }
  ...
  if (m_listApplicationComponentSummaryHasBeenSet) {
    ...
    for (unsigned listApplicationComponentSummaryIndex = 0;
         listApplicationComponentSummaryIndex < listApplicationComponentSummaryJsonList.GetLength();
         ++listApplicationComponentSummaryIndex) {
      listApplicationComponentSummaryJsonList[listApplicationComponentSummaryIndex].AsObject(
          m_listApplicationComponentSummary[listApplicationComponentSummaryIndex].Jsonize());
    }
  ...
  if (m_listServerStatusSummaryHasBeenSet) {
    ...
    for (unsigned listServerStatusSummaryIndex = 0; listServerStatusSummaryIndex < listServerStatusSummaryJsonList.GetLength();
         ++listServerStatusSummaryIndex) {
      listServerStatusSummaryJsonList[listServerStatusSummaryIndex].AsObject(
          m_listServerStatusSummary[listServerStatusSummaryIndex].Jsonize());
    }
  ...
  if (m_listServerStrategySummaryHasBeenSet) {
    ...
    for (unsigned listServerStrategySummaryIndex = 0; listServerStrategySummaryIndex < listServerStrategySummaryJsonList.GetLength();
         ++listServerStrategySummaryIndex) {
      listServerStrategySummaryJsonList[listServerStrategySummaryIndex].AsObject(
          m_listServerStrategySummary[listServerStrategySummaryIndex].Jsonize());
    }
