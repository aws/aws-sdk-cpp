...
AnalyzerNameUnion::AnalyzerNameUnion(JsonView jsonValue) { *this = jsonValue; }
...
AnalyzerNameUnion& AnalyzerNameUnion::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("sourceCodeAnalyzerName")) {
    m_sourceCodeAnalyzerName =
        SourceCodeAnalyzerNameMapper::GetSourceCodeAnalyzerNameForName(jsonValue.GetString("sourceCodeAnalyzerName"));
