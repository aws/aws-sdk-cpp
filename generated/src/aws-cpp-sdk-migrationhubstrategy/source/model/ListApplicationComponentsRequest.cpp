...
Aws::String ListApplicationComponentsRequest::SerializePayload() const {
  ...
  if (m_applicationComponentCriteriaHasBeenSet) {
    payload.WithString("applicationComponentCriteria",
                       ApplicationComponentCriteriaMapper::GetNameForApplicationComponentCriteria(m_applicationComponentCriteria));
  }
