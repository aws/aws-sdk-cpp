...
ServerDetail::ServerDetail(JsonView jsonValue) { *this = jsonValue; }
...
ServerDetail& ServerDetail::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("applicationComponentStrategySummary")) {
    ...
    for (unsigned applicationComponentStrategySummaryIndex = 0;
         applicationComponentStrategySummaryIndex < applicationComponentStrategySummaryJsonList.GetLength();
         ++applicationComponentStrategySummaryIndex) {
      m_applicationComponentStrategySummary.push_back(
          applicationComponentStrategySummaryJsonList[applicationComponentStrategySummaryIndex].AsObject());
    }
...
JsonValue ServerDetail::Jsonize() const {
  ...
  if (m_applicationComponentStrategySummaryHasBeenSet) {
    ...
    for (unsigned applicationComponentStrategySummaryIndex = 0;
         ...
         ++applicationComponentStrategySummaryIndex) {
      applicationComponentStrategySummaryJsonList[applicationComponentStrategySummaryIndex].AsObject(
          m_applicationComponentStrategySummary[applicationComponentStrategySummaryIndex].Jsonize());
    }
