...
GetApplicationComponentStrategiesResult& GetApplicationComponentStrategiesResult::operator=(
  ...
  if (jsonValue.ValueExists("applicationComponentStrategies")) {
    ...
    for (unsigned applicationComponentStrategiesIndex = 0;
         applicationComponentStrategiesIndex < applicationComponentStrategiesJsonList.GetLength(); ++applicationComponentStrategiesIndex) {
