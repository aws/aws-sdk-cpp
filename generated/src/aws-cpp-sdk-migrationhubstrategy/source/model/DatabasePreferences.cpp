...
DatabasePreferences::DatabasePreferences(JsonView jsonValue) { *this = jsonValue; }

DatabasePreferences& DatabasePreferences::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("databaseManagementPreference")) {
    m_databaseManagementPreference =
        DatabaseManagementPreferenceMapper::GetDatabaseManagementPreferenceForName(jsonValue.GetString("databaseManagementPreference"));
...
JsonValue DatabasePreferences::Jsonize() const {
  ...
  if (m_databaseManagementPreferenceHasBeenSet) {
    payload.WithString("databaseManagementPreference",
                       DatabaseManagementPreferenceMapper::GetNameForDatabaseManagementPreference(m_databaseManagementPreference));
  }
