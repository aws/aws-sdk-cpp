...
NoDatabaseMigrationPreference::NoDatabaseMigrationPreference(JsonView jsonValue) { *this = jsonValue; }
...
NoDatabaseMigrationPreference& NoDatabaseMigrationPreference::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("targetDatabaseEngine")) {
    ...
    for (unsigned targetDatabaseEngineIndex = 0; targetDatabaseEngineIndex < targetDatabaseEngineJsonList.GetLength();
      ...
      m_targetDatabaseEngine.push_back(
          TargetDatabaseEngineMapper::GetTargetDatabaseEngineForName(targetDatabaseEngineJsonList[targetDatabaseEngineIndex].AsString()));
    }
  ...
  if (m_targetDatabaseEngineHasBeenSet) {
    ...
    for (unsigned targetDatabaseEngineIndex = 0; targetDatabaseEngineIndex < targetDatabaseEngineJsonList.GetLength();
      ...
      targetDatabaseEngineJsonList[targetDatabaseEngineIndex].AsString(
          TargetDatabaseEngineMapper::GetNameForTargetDatabaseEngine(m_targetDatabaseEngine[targetDatabaseEngineIndex]));
    }
