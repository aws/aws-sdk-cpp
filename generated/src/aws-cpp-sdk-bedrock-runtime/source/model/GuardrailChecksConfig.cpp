...
GuardrailChecksConfig::GuardrailChecksConfig(JsonView jsonValue) { *this = jsonValue; }

GuardrailChecksConfig& GuardrailChecksConfig::operator=(JsonView jsonValue) {
...
JsonValue GuardrailChecksConfig::Jsonize() const {
  JsonValue payload;
