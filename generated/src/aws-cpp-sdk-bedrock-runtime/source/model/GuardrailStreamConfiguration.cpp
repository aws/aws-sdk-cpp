...
GuardrailStreamConfiguration::GuardrailStreamConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
GuardrailStreamConfiguration& GuardrailStreamConfiguration::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("streamProcessingMode")) {
    m_streamProcessingMode =
        GuardrailStreamProcessingModeMapper::GetGuardrailStreamProcessingModeForName(jsonValue.GetString("streamProcessingMode"));
...
JsonValue GuardrailStreamConfiguration::Jsonize() const {
  ...
  if (m_streamProcessingModeHasBeenSet) {
    payload.WithString("streamProcessingMode",
                       GuardrailStreamProcessingModeMapper::GetNameForGuardrailStreamProcessingMode(m_streamProcessingMode));
  }
