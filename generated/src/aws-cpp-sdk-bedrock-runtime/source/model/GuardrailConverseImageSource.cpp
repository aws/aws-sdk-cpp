...
GuardrailConverseImageSource::GuardrailConverseImageSource(JsonView jsonValue) { *this = jsonValue; }

GuardrailConverseImageSource& GuardrailConverseImageSource::operator=(JsonView jsonValue) {
...
JsonValue GuardrailConverseImageSource::Jsonize() const {
  JsonValue payload;
