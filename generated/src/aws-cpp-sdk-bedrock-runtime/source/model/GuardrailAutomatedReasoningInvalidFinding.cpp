...
GuardrailAutomatedReasoningInvalidFinding::GuardrailAutomatedReasoningInvalidFinding(JsonView jsonValue) { *this = jsonValue; }

GuardrailAutomatedReasoningInvalidFinding& GuardrailAutomatedReasoningInvalidFinding::operator=(JsonView jsonValue) {
...
JsonValue GuardrailAutomatedReasoningInvalidFinding::Jsonize() const {
  JsonValue payload;
