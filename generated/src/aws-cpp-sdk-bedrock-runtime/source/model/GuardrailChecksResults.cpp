...
GuardrailChecksResults::GuardrailChecksResults(JsonView jsonValue) { *this = jsonValue; }

GuardrailChecksResults& GuardrailChecksResults::operator=(JsonView jsonValue) {
...
JsonValue GuardrailChecksResults::Jsonize() const {
  JsonValue payload;
