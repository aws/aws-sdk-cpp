...
DocumentPageLocation::DocumentPageLocation(JsonView jsonValue) { *this = jsonValue; }

DocumentPageLocation& DocumentPageLocation::operator=(JsonView jsonValue) {
...
JsonValue DocumentPageLocation::Jsonize() const {
  JsonValue payload;
