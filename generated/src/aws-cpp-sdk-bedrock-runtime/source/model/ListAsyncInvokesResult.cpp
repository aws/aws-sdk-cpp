...
ListAsyncInvokesResult::ListAsyncInvokesResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListAsyncInvokesResult& ListAsyncInvokesResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("asyncInvokeSummaries")) {
    ...
    for (unsigned asyncInvokeSummariesIndex = 0; asyncInvokeSummariesIndex < asyncInvokeSummariesJsonList.GetLength();
         ++asyncInvokeSummariesIndex) {
