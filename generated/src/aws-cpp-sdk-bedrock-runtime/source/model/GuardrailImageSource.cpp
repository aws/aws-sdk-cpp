...
GuardrailImageSource::GuardrailImageSource(JsonView jsonValue) { *this = jsonValue; }

GuardrailImageSource& GuardrailImageSource::operator=(JsonView jsonValue) {
...
JsonValue GuardrailImageSource::Jsonize() const {
  JsonValue payload;
