...
GuardrailChecksPromptAttackConfig::GuardrailChecksPromptAttackConfig(JsonView jsonValue) { *this = jsonValue; }

GuardrailChecksPromptAttackConfig& GuardrailChecksPromptAttackConfig::operator=(JsonView jsonValue) {
...
JsonValue GuardrailChecksPromptAttackConfig::Jsonize() const {
  JsonValue payload;
