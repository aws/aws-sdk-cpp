...
GuardrailAutomatedReasoningLogicWarning::GuardrailAutomatedReasoningLogicWarning(JsonView jsonValue)
{
  *this = jsonValue;
}
...
GuardrailAutomatedReasoningLogicWarning& GuardrailAutomatedReasoningLogicWarning::operator =(JsonView jsonValue)
{
  ...
  {
    m_type = GuardrailAutomatedReasoningLogicWarningTypeMapper::GetGuardrailAutomatedReasoningLogicWarningTypeForName(jsonValue.GetString("type"));
...
JsonValue GuardrailAutomatedReasoningLogicWarning::Jsonize() const
{
  ...
  if(m_typeHasBeenSet)
  {
   payload.WithString("type", GuardrailAutomatedReasoningLogicWarningTypeMapper::GetNameForGuardrailAutomatedReasoningLogicWarningType(m_type));
  }
