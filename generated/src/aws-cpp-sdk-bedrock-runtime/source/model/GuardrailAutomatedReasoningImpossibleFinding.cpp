...
GuardrailAutomatedReasoningImpossibleFinding::GuardrailAutomatedReasoningImpossibleFinding(JsonView jsonValue) { *this = jsonValue; }

GuardrailAutomatedReasoningImpossibleFinding& GuardrailAutomatedReasoningImpossibleFinding::operator=(JsonView jsonValue) {
...
JsonValue GuardrailAutomatedReasoningImpossibleFinding::Jsonize() const {
  JsonValue payload;
