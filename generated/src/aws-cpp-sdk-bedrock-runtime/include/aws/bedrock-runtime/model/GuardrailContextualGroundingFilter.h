...
class GuardrailContextualGroundingFilter {
 public:
  ...
  inline GuardrailContextualGroundingFilter& WithScore(double value) {
    SetScore(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAction(GuardrailContextualGroundingPolicyAction value) {
    m_actionHasBeenSet = true;
    m_action = value;
  }
  inline GuardrailContextualGroundingFilter& WithAction(GuardrailContextualGroundingPolicyAction value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  inline GuardrailContextualGroundingFilter& WithDetected(bool value) {
    SetDetected(value);
    return *this;
  }
  ///@}
