...
namespace Model {
enum class InvokeModelWithResponseStreamEventType { INITIAL_RESPONSE, CHUNK, UNKNOWN };
...
class InvokeModelWithResponseStreamHandler : public Aws::Utils::Event::EventStreamHandler {
  ...
  typedef std::function<void(const InvokeModelWithResponseStreamInitialResponse&, const Utils::Event::InitialResponseType)>
      InvokeModelWithResponseStreamInitialResponseCallbackEx;
 ...
 public:
   ...
   * @param callback
   */
  inline void SetInitialResponseCallbackEx(const InvokeModelWithResponseStreamInitialResponseCallbackEx& callback) {
  ...
  inline void SetInitialResponseCallback(const InvokeModelWithResponseStreamInitialResponseCallback& noArgCallback) {
    m_onInitialResponse = [noArgCallback](const InvokeModelWithResponseStreamInitialResponse& rs, const Utils::Event::InitialResponseType) {
