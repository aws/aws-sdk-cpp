...
class GuardrailAutomatedReasoningLogicWarning {
 public:
  ...
  inline void SetType(GuardrailAutomatedReasoningLogicWarningType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline GuardrailAutomatedReasoningLogicWarning& WithType(GuardrailAutomatedReasoningLogicWarningType value) {
    SetType(value);
    return *this;
  }
  ///@}
