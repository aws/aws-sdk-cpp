...
class GuardrailTraceAssessment {
 public:
  ...
  void SetInputAssessment(InputAssessmentT&& value) {
    m_inputAssessmentHasBeenSet = true;
    m_inputAssessment = std::forward<InputAssessmentT>(value);
  }
  template <typename InputAssessmentT = Aws::Map<Aws::String, GuardrailAssessment>>
  GuardrailTraceAssessment& WithInputAssessment(InputAssessmentT&& value) {
    SetInputAssessment(std::forward<InputAssessmentT>(value));
    return *this;
  }
  ...
  GuardrailTraceAssessment& AddInputAssessment(InputAssessmentKeyT&& key, InputAssessmentValueT&& value) {
    m_inputAssessmentHasBeenSet = true;
    m_inputAssessment.emplace(std::forward<InputAssessmentKeyT>(key), std::forward<InputAssessmentValueT>(value));
    return *this;
  }
  ///@}
  ...
  GuardrailTraceAssessment& AddOutputAssessments(OutputAssessmentsKeyT&& key, OutputAssessmentsValueT&& value) {
    m_outputAssessmentsHasBeenSet = true;
    m_outputAssessments.emplace(std::forward<OutputAssessmentsKeyT>(key), std::forward<OutputAssessmentsValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetActionReason(ActionReasonT&& value) {
    m_actionReasonHasBeenSet = true;
    m_actionReason = std::forward<ActionReasonT>(value);
  }
  template <typename ActionReasonT = Aws::String>
  GuardrailTraceAssessment& WithActionReason(ActionReasonT&& value) {
    SetActionReason(std::forward<ActionReasonT>(value));
    return *this;
  }
  ///@}
 private:
