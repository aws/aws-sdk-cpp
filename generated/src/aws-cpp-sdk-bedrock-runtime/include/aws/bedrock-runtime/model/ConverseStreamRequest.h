...
class ConverseStreamRequest : public BedrockRuntimeRequest {
 public:
   ...
   * Underlying Event Stream Handler which is used to define callback functions.
   */
  inline void SetEventStreamHandler(const ConverseStreamHandler& value) {
    m_handler = value;
   ...
   * Underlying Event Stream Handler which is used to define callback functions.
   */
  inline ConverseStreamRequest& WithEventStreamHandler(const ConverseStreamHandler& value) {
  ...
  void SetGuardrailConfig(GuardrailConfigT&& value) {
    m_guardrailConfigHasBeenSet = true;
    m_guardrailConfig = std::forward<GuardrailConfigT>(value);
  }
  template <typename GuardrailConfigT = GuardrailStreamConfiguration>
  ConverseStreamRequest& WithGuardrailConfig(GuardrailConfigT&& value) {
    SetGuardrailConfig(std::forward<GuardrailConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPromptVariables(PromptVariablesT&& value) {
    ...
    m_promptVariables = std::forward<PromptVariablesT>(value);
  }
  template <typename PromptVariablesT = Aws::Map<Aws::String, PromptVariableValues>>
  ConverseStreamRequest& WithPromptVariables(PromptVariablesT&& value) {
    SetPromptVariables(std::forward<PromptVariablesT>(value));
    return *this;
  }
  ...
  ConverseStreamRequest& AddPromptVariables(PromptVariablesKeyT&& key, PromptVariablesValueT&& value) {
    m_promptVariablesHasBeenSet = true;
    m_promptVariables.emplace(std::forward<PromptVariablesKeyT>(key), std::forward<PromptVariablesValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAdditionalModelResponseFieldPaths(AdditionalModelResponseFieldPathsT&& value) {
    m_additionalModelResponseFieldPathsHasBeenSet = true;
    m_additionalModelResponseFieldPaths = std::forward<AdditionalModelResponseFieldPathsT>(value);
  }
  template <typename AdditionalModelResponseFieldPathsT = Aws::Vector<Aws::String>>
  ConverseStreamRequest& WithAdditionalModelResponseFieldPaths(AdditionalModelResponseFieldPathsT&& value) {
    SetAdditionalModelResponseFieldPaths(std::forward<AdditionalModelResponseFieldPathsT>(value));
    return *this;
  }
  ...
  ConverseStreamRequest& AddAdditionalModelResponseFieldPaths(AdditionalModelResponseFieldPathsT&& value) {
    m_additionalModelResponseFieldPathsHasBeenSet = true;
    m_additionalModelResponseFieldPaths.emplace_back(std::forward<AdditionalModelResponseFieldPathsT>(value));
    return *this;
  }
  ///@}
  ...
  ConverseStreamRequest& AddRequestMetadata(RequestMetadataKeyT&& key, RequestMetadataValueT&& value) {
    m_requestMetadataHasBeenSet = true;
    m_requestMetadata.emplace(std::forward<RequestMetadataKeyT>(key), std::forward<RequestMetadataValueT>(value));
    return *this;
  }
  ///@}
