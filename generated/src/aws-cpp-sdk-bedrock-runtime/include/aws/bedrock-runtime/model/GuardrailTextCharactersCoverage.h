...
class GuardrailTextCharactersCoverage {
 public:
  ...
  inline void SetGuarded(int value) {
    m_guardedHasBeenSet = true;
    m_guarded = value;
  }
  inline GuardrailTextCharactersCoverage& WithGuarded(int value) {
    SetGuarded(value);
    return *this;
  }
  ///@}
  ...
  inline GuardrailTextCharactersCoverage& WithTotal(int value) {
    SetTotal(value);
    return *this;
  }
  ///@}
