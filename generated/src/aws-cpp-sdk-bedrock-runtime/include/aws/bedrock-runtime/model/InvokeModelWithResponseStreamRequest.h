...
class InvokeModelWithResponseStreamRequest : public StreamingBedrockRuntimeRequest {
 public:
   ...
   * Underlying Event Stream Handler which is used to define callback functions.
   */
  inline void SetEventStreamHandler(const InvokeModelWithResponseStreamHandler& value) {
    m_handler = value;
   ...
   * Underlying Event Stream Handler which is used to define callback functions.
   */
  inline InvokeModelWithResponseStreamRequest& WithEventStreamHandler(const InvokeModelWithResponseStreamHandler& value) {
  ...
  inline void SetTrace(Trace value) {
    m_traceHasBeenSet = true;
    m_trace = value;
  }
  inline InvokeModelWithResponseStreamRequest& WithTrace(Trace value) {
    SetTrace(value);
    return *this;
  }
  ///@}
  ...
  inline InvokeModelWithResponseStreamRequest& WithPerformanceConfigLatency(PerformanceConfigLatency value) {
  ...
  template <typename RequestMetadataT = Aws::String>
  InvokeModelWithResponseStreamRequest& WithRequestMetadata(RequestMetadataT&& value) {
