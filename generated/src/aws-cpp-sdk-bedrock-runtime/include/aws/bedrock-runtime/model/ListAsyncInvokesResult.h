...
class ListAsyncInvokesResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListAsyncInvokesResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetAsyncInvokeSummaries(AsyncInvokeSummariesT&& value) {
    m_asyncInvokeSummariesHasBeenSet = true;
    m_asyncInvokeSummaries = std::forward<AsyncInvokeSummariesT>(value);
  }
  template <typename AsyncInvokeSummariesT = Aws::Vector<AsyncInvokeSummary>>
  ListAsyncInvokesResult& WithAsyncInvokeSummaries(AsyncInvokeSummariesT&& value) {
    SetAsyncInvokeSummaries(std::forward<AsyncInvokeSummariesT>(value));
    return *this;
  }
  template <typename AsyncInvokeSummariesT = AsyncInvokeSummary>
  ListAsyncInvokesResult& AddAsyncInvokeSummaries(AsyncInvokeSummariesT&& value) {
    m_asyncInvokeSummariesHasBeenSet = true;
    m_asyncInvokeSummaries.emplace_back(std::forward<AsyncInvokeSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListAsyncInvokesResult& WithRequestId(RequestIdT&& value) {
