...
class GuardrailInvocationMetrics {
 public:
  ...
  inline void SetGuardrailProcessingLatency(long long value) {
    m_guardrailProcessingLatencyHasBeenSet = true;
    m_guardrailProcessingLatency = value;
  }
  inline GuardrailInvocationMetrics& WithGuardrailProcessingLatency(long long value) {
    SetGuardrailProcessingLatency(value);
    return *this;
  }
  ///@}
  ...
  void SetGuardrailCoverage(GuardrailCoverageT&& value) {
    ...
    m_guardrailCoverage = std::forward<GuardrailCoverageT>(value);
  }
  template <typename GuardrailCoverageT = GuardrailCoverage>
  GuardrailInvocationMetrics& WithGuardrailCoverage(GuardrailCoverageT&& value) {
    SetGuardrailCoverage(std::forward<GuardrailCoverageT>(value));
    return *this;
  }
  ///@}
 private:
