...
class GuardrailAutomatedReasoningTranslation {
 public:
   ...
   */
  inline const Aws::Vector<GuardrailAutomatedReasoningInputTextReference>& GetUntranslatedPremises() const {
    return m_untranslatedPremises;
  }
  ...
  inline GuardrailAutomatedReasoningTranslation& WithConfidence(double value) {
    SetConfidence(value);
    return *this;
  }
  ///@}
