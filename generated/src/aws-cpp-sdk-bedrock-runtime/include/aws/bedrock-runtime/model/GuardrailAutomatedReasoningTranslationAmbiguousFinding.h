...
class GuardrailAutomatedReasoningTranslationAmbiguousFinding {
 public:
  ...
  template <typename OptionsT = Aws::Vector<GuardrailAutomatedReasoningTranslationOption>>
  GuardrailAutomatedReasoningTranslationAmbiguousFinding& WithOptions(OptionsT&& value) {
    SetOptions(std::forward<OptionsT>(value));
    return *this;
  }
  template <typename OptionsT = GuardrailAutomatedReasoningTranslationOption>
  GuardrailAutomatedReasoningTranslationAmbiguousFinding& AddOptions(OptionsT&& value) {
    m_optionsHasBeenSet = true;
  ...
  template <typename DifferenceScenariosT = Aws::Vector<GuardrailAutomatedReasoningScenario>>
  GuardrailAutomatedReasoningTranslationAmbiguousFinding& WithDifferenceScenarios(DifferenceScenariosT&& value) {
  ...
  GuardrailAutomatedReasoningTranslationAmbiguousFinding& AddDifferenceScenarios(DifferenceScenariosT&& value) {
    m_differenceScenariosHasBeenSet = true;
