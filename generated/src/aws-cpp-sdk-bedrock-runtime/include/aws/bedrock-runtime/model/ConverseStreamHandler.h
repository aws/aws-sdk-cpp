...
class ConverseStreamHandler : public Aws::Utils::Event::EventStreamHandler {
  ...
  typedef std::function<void(const ConverseStreamInitialResponse&, const Utils::Event::InitialResponseType)>
      ConverseStreamInitialResponseCallbackEx;
 ...
 public:
  ...
  inline void SetInitialResponseCallback(const ConverseStreamInitialResponseCallback& noArgCallback) {
    m_onInitialResponse = [noArgCallback](const ConverseStreamInitialResponse& rs, const Utils::Event::InitialResponseType) {
  ...
  inline void SetConverseStreamMetadataEventCallback(const ConverseStreamMetadataEventCallback& callback) {
    m_onConverseStreamMetadataEvent = callback;
  }
