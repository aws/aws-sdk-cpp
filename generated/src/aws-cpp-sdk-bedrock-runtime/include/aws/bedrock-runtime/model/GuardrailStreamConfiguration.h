...
class GuardrailStreamConfiguration {
 public:
  ...
  inline void SetTrace(GuardrailTrace value) {
    m_traceHasBeenSet = true;
    m_trace = value;
  }
  inline GuardrailStreamConfiguration& WithTrace(GuardrailTrace value) {
    SetTrace(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStreamProcessingMode(GuardrailStreamProcessingMode value) {
    m_streamProcessingModeHasBeenSet = true;
    m_streamProcessingMode = value;
  }
  inline GuardrailStreamConfiguration& WithStreamProcessingMode(GuardrailStreamProcessingMode value) {
    SetStreamProcessingMode(value);
    return *this;
  }
  ///@}
 private:
