...
class DocumentChunkLocation {
 public:
  ...
  inline DocumentChunkLocation& WithDocumentIndex(int value) {
  ...
  inline DocumentChunkLocation& WithStart(int value) {
    SetStart(value);
    return *this;
  }
  ///@}
  ...
  inline DocumentChunkLocation& WithEnd(int value) {
    SetEnd(value);
    return *this;
  }
  ///@}
