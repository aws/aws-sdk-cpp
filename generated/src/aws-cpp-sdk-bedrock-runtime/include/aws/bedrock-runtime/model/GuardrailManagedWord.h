...
class GuardrailManagedWord {
 public:
  ...
  inline void SetType(GuardrailManagedWordType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline GuardrailManagedWord& WithType(GuardrailManagedWordType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline GuardrailManagedWord& WithDetected(bool value) {
    SetDetected(value);
    return *this;
  }
  ///@}
