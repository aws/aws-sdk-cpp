...
class GuardrailAssessment {
 public:
  ...
  void SetContentPolicy(ContentPolicyT&& value) {
    ...
    m_contentPolicy = std::forward<ContentPolicyT>(value);
  }
  template <typename ContentPolicyT = GuardrailContentPolicyAssessment>
  ...
  void SetSensitiveInformationPolicy(SensitiveInformationPolicyT&& value) {
    ...
    m_sensitiveInformationPolicy = std::forward<SensitiveInformationPolicyT>(value);
  }
  template <typename SensitiveInformationPolicyT = GuardrailSensitiveInformationPolicyAssessment>
  GuardrailAssessment& WithSensitiveInformationPolicy(SensitiveInformationPolicyT&& value) {
    SetSensitiveInformationPolicy(std::forward<SensitiveInformationPolicyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetContextualGroundingPolicy(ContextualGroundingPolicyT&& value) {
    ...
    m_contextualGroundingPolicy = std::forward<ContextualGroundingPolicyT>(value);
  }
  template <typename ContextualGroundingPolicyT = GuardrailContextualGroundingPolicyAssessment>
  GuardrailAssessment& WithContextualGroundingPolicy(ContextualGroundingPolicyT&& value) {
    SetContextualGroundingPolicy(std::forward<ContextualGroundingPolicyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAutomatedReasoningPolicy(AutomatedReasoningPolicyT&& value) {
    ...
    m_automatedReasoningPolicy = std::forward<AutomatedReasoningPolicyT>(value);
  }
  template <typename AutomatedReasoningPolicyT = GuardrailAutomatedReasoningPolicyAssessment>
  GuardrailAssessment& WithAutomatedReasoningPolicy(AutomatedReasoningPolicyT&& value) {
    SetAutomatedReasoningPolicy(std::forward<AutomatedReasoningPolicyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInvocationMetrics(InvocationMetricsT&& value) {
    ...
    m_invocationMetrics = std::forward<InvocationMetricsT>(value);
  }
  template <typename InvocationMetricsT = GuardrailInvocationMetrics>
  GuardrailAssessment& WithInvocationMetrics(InvocationMetricsT&& value) {
    SetInvocationMetrics(std::forward<InvocationMetricsT>(value));
    return *this;
  }
  ///@}
 private:
