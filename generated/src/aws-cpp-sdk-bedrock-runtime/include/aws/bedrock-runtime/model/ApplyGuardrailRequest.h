...
class ApplyGuardrailRequest : public BedrockRuntimeRequest {
 public:
  ...
  inline void SetSource(GuardrailContentSource value) {
    m_sourceHasBeenSet = true;
    m_source = value;
  }
  inline ApplyGuardrailRequest& WithSource(GuardrailContentSource value) {
    SetSource(value);
    return *this;
  }
  ///@}
  ...
  inline void SetOutputScope(GuardrailOutputScope value) {
    m_outputScopeHasBeenSet = true;
    m_outputScope = value;
  }
  inline ApplyGuardrailRequest& WithOutputScope(GuardrailOutputScope value) {
