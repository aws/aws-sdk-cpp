...
class GuardrailContentFilter {
 public:
  ...
  inline void SetConfidence(GuardrailContentFilterConfidence value) {
    m_confidenceHasBeenSet = true;
    m_confidence = value;
  }
  inline GuardrailContentFilter& WithConfidence(GuardrailContentFilterConfidence value) {
    SetConfidence(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFilterStrength(GuardrailContentFilterStrength value) {
    m_filterStrengthHasBeenSet = true;
    m_filterStrength = value;
  }
  inline GuardrailContentFilter& WithFilterStrength(GuardrailContentFilterStrength value) {
  ...
  inline GuardrailContentFilter& WithDetected(bool value) {
    SetDetected(value);
    return *this;
  }
  ///@}
