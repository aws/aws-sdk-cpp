...
class InvokeModelWithBidirectionalStreamRequest : public BedrockRuntimeRequest {
 public:
   ...
   * Underlying Event Stream Handler which is used to define callback functions.
   */
  inline void SetEventStreamHandler(const InvokeModelWithBidirectionalStreamHandler& value) {
    m_handler = value;
   ...
   * Underlying Event Stream Handler which is used to define callback functions.
   */
  inline InvokeModelWithBidirectionalStreamRequest& WithEventStreamHandler(const InvokeModelWithBidirectionalStreamHandler& value) {
  ...
  AWS_BEDROCKRUNTIME_API InvokeModelWithBidirectionalStreamRequest& WithBody(
      const std::shared_ptr<InvokeModelWithBidirectionalStreamInput>& value) {
    SetBody(value);
    return *this;
  }
