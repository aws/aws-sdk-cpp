...
class CountTokensInput {
 public:
  ...
  void SetInvokeModel(InvokeModelT&& value) {
    m_invokeModelHasBeenSet = true;
    m_invokeModel = std::forward<InvokeModelT>(value);
  }
  template <typename InvokeModelT = InvokeModelTokensRequest>
  CountTokensInput& WithInvokeModel(InvokeModelT&& value) {
    SetInvokeModel(std::forward<InvokeModelT>(value));
    return *this;
  }
  ///@}
  ...
  void SetConverse(ConverseT&& value) {
    m_converseHasBeenSet = true;
    m_converse = std::forward<ConverseT>(value);
  }
  template <typename ConverseT = ConverseTokensRequest>
  CountTokensInput& WithConverse(ConverseT&& value) {
    SetConverse(std::forward<ConverseT>(value));
    return *this;
  }
  ///@}
 private:
