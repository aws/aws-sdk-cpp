...
namespace BedrockRuntime
{
   ...
   * models.</p>
   */
  class AWS_BEDROCKRUNTIME_API BedrockRuntimeClient : Aws::Client::ClientWithAsyncTemplateMethods<BedrockRuntimeClient>,
    smithy::client::AwsSmithyClientT<Aws::BedrockRuntime::SERVICE_NAME,
