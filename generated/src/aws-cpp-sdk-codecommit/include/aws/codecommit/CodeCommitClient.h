...
namespace CodeCommit
{
   ...
   * User Guide</a>.</p>
   */
  class AWS_CODECOMMIT_API CodeCommitClient : Aws::Client::ClientWithAsyncTemplateMethods<CodeCommitClient>,
    smithy::client::AwsSmithyClientT<Aws::CodeCommit::SERVICE_NAME,
