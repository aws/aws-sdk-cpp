...
class AWS_CODECOMMIT_API CodeCommitClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  CodeCommitClient(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<CodeCommitEndpointProviderBase> endpointProvider = nullptr,
      const Aws::CodeCommit::CodeCommitClientConfiguration& clientConfiguration = Aws::CodeCommit::CodeCommitClientConfiguration());
  ...
  virtual Model::AssociateApprovalRuleTemplateWithRepositoryOutcome AssociateApprovalRuleTemplateWithRepository(
      const Model::AssociateApprovalRuleTemplateWithRepositoryRequest& request) const;

  /**
   * A Callable wrapper for AssociateApprovalRuleTemplateWithRepository that returns a future to the operation so that it can be executed in
  ...
  Model::AssociateApprovalRuleTemplateWithRepositoryOutcomeCallable AssociateApprovalRuleTemplateWithRepositoryCallable(
      const AssociateApprovalRuleTemplateWithRepositoryRequestT& request) const {
    return SubmitCallable(&CodeCommitClient::AssociateApprovalRuleTemplateWithRepository, request);
  }

  /**
   * An Async wrapper for AssociateApprovalRuleTemplateWithRepository that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename AssociateApprovalRuleTemplateWithRepositoryRequestT = Model::AssociateApprovalRuleTemplateWithRepositoryRequest>
  void AssociateApprovalRuleTemplateWithRepositoryAsync(
      const AssociateApprovalRuleTemplateWithRepositoryRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchAssociateApprovalRuleTemplateWithRepositoriesOutcome BatchAssociateApprovalRuleTemplateWithRepositories(
      const Model::BatchAssociateApprovalRuleTemplateWithRepositoriesRequest& request) const;

  /**
   * A Callable wrapper for BatchAssociateApprovalRuleTemplateWithRepositories that returns a future to the operation so that it can be
   * executed in parallel to other requests.
   */
  template <typename BatchAssociateApprovalRuleTemplateWithRepositoriesRequestT =
                Model::BatchAssociateApprovalRuleTemplateWithRepositoriesRequest>
  Model::BatchAssociateApprovalRuleTemplateWithRepositoriesOutcomeCallable BatchAssociateApprovalRuleTemplateWithRepositoriesCallable(
      const BatchAssociateApprovalRuleTemplateWithRepositoriesRequestT& request) const {
    return SubmitCallable(&CodeCommitClient::BatchAssociateApprovalRuleTemplateWithRepositories, request);
  }

  /**
   * An Async wrapper for BatchAssociateApprovalRuleTemplateWithRepositories that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename BatchAssociateApprovalRuleTemplateWithRepositoriesRequestT =
                Model::BatchAssociateApprovalRuleTemplateWithRepositoriesRequest>
  void BatchAssociateApprovalRuleTemplateWithRepositoriesAsync(
      const BatchAssociateApprovalRuleTemplateWithRepositoriesRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchDescribeMergeConflictsOutcome BatchDescribeMergeConflicts(
      const Model::BatchDescribeMergeConflictsRequest& request) const;

  /**
   * A Callable wrapper for BatchDescribeMergeConflicts that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename BatchDescribeMergeConflictsRequestT = Model::BatchDescribeMergeConflictsRequest>
  Model::BatchDescribeMergeConflictsOutcomeCallable BatchDescribeMergeConflictsCallable(
      const BatchDescribeMergeConflictsRequestT& request) const {
    return SubmitCallable(&CodeCommitClient::BatchDescribeMergeConflicts, request);
  }

  /**
   * An Async wrapper for BatchDescribeMergeConflicts that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchDescribeMergeConflictsRequestT = Model::BatchDescribeMergeConflictsRequest>
  void BatchDescribeMergeConflictsAsync(const BatchDescribeMergeConflictsRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchDisassociateApprovalRuleTemplateFromRepositoriesOutcome BatchDisassociateApprovalRuleTemplateFromRepositories(
      const Model::BatchDisassociateApprovalRuleTemplateFromRepositoriesRequest& request) const;

  /**
   * A Callable wrapper for BatchDisassociateApprovalRuleTemplateFromRepositories that returns a future to the operation so that it can be
   * executed in parallel to other requests.
   */
  template <typename BatchDisassociateApprovalRuleTemplateFromRepositoriesRequestT =
                Model::BatchDisassociateApprovalRuleTemplateFromRepositoriesRequest>
  Model::BatchDisassociateApprovalRuleTemplateFromRepositoriesOutcomeCallable BatchDisassociateApprovalRuleTemplateFromRepositoriesCallable(
      const BatchDisassociateApprovalRuleTemplateFromRepositoriesRequestT& request) const {
    return SubmitCallable(&CodeCommitClient::BatchDisassociateApprovalRuleTemplateFromRepositories, request);
  }

  /**
   * An Async wrapper for BatchDisassociateApprovalRuleTemplateFromRepositories that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename BatchDisassociateApprovalRuleTemplateFromRepositoriesRequestT =
                Model::BatchDisassociateApprovalRuleTemplateFromRepositoriesRequest>
  void BatchDisassociateApprovalRuleTemplateFromRepositoriesAsync(
      const BatchDisassociateApprovalRuleTemplateFromRepositoriesRequestT& request,
  ...
  /**
   * An Async wrapper for BatchGetCommits that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename BatchGetCommitsRequestT = Model::BatchGetCommitsRequest>
  void BatchGetCommitsAsync(const BatchGetCommitsRequestT& request, const BatchGetCommitsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchGetRepositories that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchGetRepositories that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchGetRepositoriesRequestT = Model::BatchGetRepositoriesRequest>
  void BatchGetRepositoriesAsync(const BatchGetRepositoriesRequestT& request, const BatchGetRepositoriesResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::CreateApprovalRuleTemplateOutcome CreateApprovalRuleTemplate(
      const Model::CreateApprovalRuleTemplateRequest& request) const;

  /**
   * A Callable wrapper for CreateApprovalRuleTemplate that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateApprovalRuleTemplateRequestT = Model::CreateApprovalRuleTemplateRequest>
  Model::CreateApprovalRuleTemplateOutcomeCallable CreateApprovalRuleTemplateCallable(
      const CreateApprovalRuleTemplateRequestT& request) const {
    return SubmitCallable(&CodeCommitClient::CreateApprovalRuleTemplate, request);
  }

  /**
   * An Async wrapper for CreateApprovalRuleTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateApprovalRuleTemplateRequestT = Model::CreateApprovalRuleTemplateRequest>
  void CreateApprovalRuleTemplateAsync(const CreateApprovalRuleTemplateRequestT& request,
  ...
  /**
   * An Async wrapper for CreateBranch that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateBranchRequestT = Model::CreateBranchRequest>
  void CreateBranchAsync(const CreateBranchRequestT& request, const CreateBranchResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateCommit that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateCommitRequestT = Model::CreateCommitRequest>
  void CreateCommitAsync(const CreateCommitRequestT& request, const CreateCommitResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreatePullRequest that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreatePullRequest that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreatePullRequestRequestT = Model::CreatePullRequestRequest>
  void CreatePullRequestAsync(const CreatePullRequestRequestT& request, const CreatePullRequestResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreatePullRequestApprovalRuleOutcome CreatePullRequestApprovalRule(
      const Model::CreatePullRequestApprovalRuleRequest& request) const;

  /**
   * A Callable wrapper for CreatePullRequestApprovalRule that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreatePullRequestApprovalRuleRequestT = Model::CreatePullRequestApprovalRuleRequest>
  Model::CreatePullRequestApprovalRuleOutcomeCallable CreatePullRequestApprovalRuleCallable(
      const CreatePullRequestApprovalRuleRequestT& request) const {
    return SubmitCallable(&CodeCommitClient::CreatePullRequestApprovalRule, request);
  }

  /**
   * An Async wrapper for CreatePullRequestApprovalRule that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreatePullRequestApprovalRuleRequestT = Model::CreatePullRequestApprovalRuleRequest>
  void CreatePullRequestApprovalRuleAsync(const CreatePullRequestApprovalRuleRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateUnreferencedMergeCommitOutcome CreateUnreferencedMergeCommit(
      const Model::CreateUnreferencedMergeCommitRequest& request) const;

  /**
   * A Callable wrapper for CreateUnreferencedMergeCommit that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateUnreferencedMergeCommitRequestT = Model::CreateUnreferencedMergeCommitRequest>
  Model::CreateUnreferencedMergeCommitOutcomeCallable CreateUnreferencedMergeCommitCallable(
      const CreateUnreferencedMergeCommitRequestT& request) const {
    return SubmitCallable(&CodeCommitClient::CreateUnreferencedMergeCommit, request);
  }

  /**
   * An Async wrapper for CreateUnreferencedMergeCommit that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateUnreferencedMergeCommitRequestT = Model::CreateUnreferencedMergeCommitRequest>
  void CreateUnreferencedMergeCommitAsync(const CreateUnreferencedMergeCommitRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteApprovalRuleTemplateOutcome DeleteApprovalRuleTemplate(
      const Model::DeleteApprovalRuleTemplateRequest& request) const;

  /**
   * A Callable wrapper for DeleteApprovalRuleTemplate that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteApprovalRuleTemplateRequestT = Model::DeleteApprovalRuleTemplateRequest>
  Model::DeleteApprovalRuleTemplateOutcomeCallable DeleteApprovalRuleTemplateCallable(
      const DeleteApprovalRuleTemplateRequestT& request) const {
    return SubmitCallable(&CodeCommitClient::DeleteApprovalRuleTemplate, request);
  }

  /**
   * An Async wrapper for DeleteApprovalRuleTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteApprovalRuleTemplateRequestT = Model::DeleteApprovalRuleTemplateRequest>
  void DeleteApprovalRuleTemplateAsync(const DeleteApprovalRuleTemplateRequestT& request,
  ...
  /**
   * An Async wrapper for DeleteBranch that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteBranchRequestT = Model::DeleteBranchRequest>
  void DeleteBranchAsync(const DeleteBranchRequestT& request, const DeleteBranchResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteCommentContent that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteCommentContent that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteCommentContentRequestT = Model::DeleteCommentContentRequest>
  void DeleteCommentContentAsync(const DeleteCommentContentRequestT& request, const DeleteCommentContentResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteFile that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteFileRequestT = Model::DeleteFileRequest>
  void DeleteFileAsync(const DeleteFileRequestT& request, const DeleteFileResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::DeletePullRequestApprovalRuleOutcome DeletePullRequestApprovalRule(
      const Model::DeletePullRequestApprovalRuleRequest& request) const;

  /**
   * A Callable wrapper for DeletePullRequestApprovalRule that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeletePullRequestApprovalRuleRequestT = Model::DeletePullRequestApprovalRuleRequest>
  Model::DeletePullRequestApprovalRuleOutcomeCallable DeletePullRequestApprovalRuleCallable(
      const DeletePullRequestApprovalRuleRequestT& request) const {
    return SubmitCallable(&CodeCommitClient::DeletePullRequestApprovalRule, request);
  }

  /**
   * An Async wrapper for DeletePullRequestApprovalRule that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeletePullRequestApprovalRuleRequestT = Model::DeletePullRequestApprovalRuleRequest>
  void DeletePullRequestApprovalRuleAsync(const DeletePullRequestApprovalRuleRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeMergeConflicts that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeMergeConflicts that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeMergeConflictsRequestT = Model::DescribeMergeConflictsRequest>
  void DescribeMergeConflictsAsync(const DescribeMergeConflictsRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribePullRequestEvents that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribePullRequestEventsRequestT = Model::DescribePullRequestEventsRequest>
  Model::DescribePullRequestEventsOutcomeCallable DescribePullRequestEventsCallable(
      const DescribePullRequestEventsRequestT& request) const {
    return SubmitCallable(&CodeCommitClient::DescribePullRequestEvents, request);
  }

  /**
   * An Async wrapper for DescribePullRequestEvents that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribePullRequestEventsRequestT = Model::DescribePullRequestEventsRequest>
  void DescribePullRequestEventsAsync(const DescribePullRequestEventsRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateApprovalRuleTemplateFromRepositoryOutcome DisassociateApprovalRuleTemplateFromRepository(
      const Model::DisassociateApprovalRuleTemplateFromRepositoryRequest& request) const;

  /**
   * A Callable wrapper for DisassociateApprovalRuleTemplateFromRepository that returns a future to the operation so that it can be executed
  ...
  Model::DisassociateApprovalRuleTemplateFromRepositoryOutcomeCallable DisassociateApprovalRuleTemplateFromRepositoryCallable(
      const DisassociateApprovalRuleTemplateFromRepositoryRequestT& request) const {
    return SubmitCallable(&CodeCommitClient::DisassociateApprovalRuleTemplateFromRepository, request);
  }

  /**
   * An Async wrapper for DisassociateApprovalRuleTemplateFromRepository that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename DisassociateApprovalRuleTemplateFromRepositoryRequestT = Model::DisassociateApprovalRuleTemplateFromRepositoryRequest>
  void DisassociateApprovalRuleTemplateFromRepositoryAsync(
      const DisassociateApprovalRuleTemplateFromRepositoryRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::EvaluatePullRequestApprovalRulesOutcome EvaluatePullRequestApprovalRules(
      const Model::EvaluatePullRequestApprovalRulesRequest& request) const;

  /**
   * A Callable wrapper for EvaluatePullRequestApprovalRules that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename EvaluatePullRequestApprovalRulesRequestT = Model::EvaluatePullRequestApprovalRulesRequest>
  Model::EvaluatePullRequestApprovalRulesOutcomeCallable EvaluatePullRequestApprovalRulesCallable(
      const EvaluatePullRequestApprovalRulesRequestT& request) const {
    return SubmitCallable(&CodeCommitClient::EvaluatePullRequestApprovalRules, request);
  }

  /**
   * An Async wrapper for EvaluatePullRequestApprovalRules that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename EvaluatePullRequestApprovalRulesRequestT = Model::EvaluatePullRequestApprovalRulesRequest>
  void EvaluatePullRequestApprovalRulesAsync(const EvaluatePullRequestApprovalRulesRequestT& request,
  ...
  /**
   * A Callable wrapper for GetApprovalRuleTemplate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetApprovalRuleTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetApprovalRuleTemplateRequestT = Model::GetApprovalRuleTemplateRequest>
  void GetApprovalRuleTemplateAsync(const GetApprovalRuleTemplateRequestT& request,
  ...
  /**
   * An Async wrapper for GetBlob that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetBlobRequestT = Model::GetBlobRequest>
  void GetBlobAsync(const GetBlobRequestT& request, const GetBlobResponseReceivedHandler& handler,
                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetBranch that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetBranchRequestT = Model::GetBranchRequest>
  void GetBranchAsync(const GetBranchResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                      const GetBranchRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetComment that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetCommentRequestT = Model::GetCommentRequest>
  void GetCommentAsync(const GetCommentRequestT& request, const GetCommentResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetCommentReactions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetCommentReactions that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetCommentReactionsRequestT = Model::GetCommentReactionsRequest>
  void GetCommentReactionsAsync(const GetCommentReactionsRequestT& request, const GetCommentReactionsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetCommentsForComparedCommitOutcome GetCommentsForComparedCommit(
      const Model::GetCommentsForComparedCommitRequest& request) const;

  /**
   * A Callable wrapper for GetCommentsForComparedCommit that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetCommentsForComparedCommitRequestT = Model::GetCommentsForComparedCommitRequest>
  Model::GetCommentsForComparedCommitOutcomeCallable GetCommentsForComparedCommitCallable(
      const GetCommentsForComparedCommitRequestT& request) const {
    return SubmitCallable(&CodeCommitClient::GetCommentsForComparedCommit, request);
  }

  /**
   * An Async wrapper for GetCommentsForComparedCommit that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetCommentsForComparedCommitRequestT = Model::GetCommentsForComparedCommitRequest>
  void GetCommentsForComparedCommitAsync(const GetCommentsForComparedCommitRequestT& request,
  ...
  /**
   * A Callable wrapper for GetCommentsForPullRequest that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename GetCommentsForPullRequestRequestT = Model::GetCommentsForPullRequestRequest>
  Model::GetCommentsForPullRequestOutcomeCallable GetCommentsForPullRequestCallable(
      const GetCommentsForPullRequestRequestT& request) const {
    return SubmitCallable(&CodeCommitClient::GetCommentsForPullRequest, request);
  }

  /**
   * An Async wrapper for GetCommentsForPullRequest that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetCommentsForPullRequestRequestT = Model::GetCommentsForPullRequestRequest>
  void GetCommentsForPullRequestAsync(const GetCommentsForPullRequestRequestT& request,
  ...
  /**
   * An Async wrapper for GetCommit that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetCommitRequestT = Model::GetCommitRequest>
  void GetCommitAsync(const GetCommitRequestT& request, const GetCommitResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetDifferences that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetDifferencesRequestT = Model::GetDifferencesRequest>
  void GetDifferencesAsync(const GetDifferencesRequestT& request, const GetDifferencesResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetFile that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetFileRequestT = Model::GetFileRequest>
  void GetFileAsync(const GetFileRequestT& request, const GetFileResponseReceivedHandler& handler,
                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetFolder that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetFolderRequestT = Model::GetFolderRequest>
  void GetFolderAsync(const GetFolderRequestT& request, const GetFolderResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetMergeCommit that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetMergeCommitRequestT = Model::GetMergeCommitRequest>
  void GetMergeCommitAsync(const GetMergeCommitRequestT& request, const GetMergeCommitResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetMergeConflicts that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetMergeConflicts that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetMergeConflictsRequestT = Model::GetMergeConflictsRequest>
  void GetMergeConflictsAsync(const GetMergeConflictsRequestT& request, const GetMergeConflictsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetMergeOptions that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetMergeOptionsRequestT = Model::GetMergeOptionsRequest>
  void GetMergeOptionsAsync(const GetMergeOptionsRequestT& request, const GetMergeOptionsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetPullRequest that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetPullRequestRequestT = Model::GetPullRequestRequest>
  void GetPullRequestAsync(const GetPullRequestRequestT& request, const GetPullRequestResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetPullRequestApprovalStatesOutcome GetPullRequestApprovalStates(
      const Model::GetPullRequestApprovalStatesRequest& request) const;

  /**
   * A Callable wrapper for GetPullRequestApprovalStates that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetPullRequestApprovalStatesRequestT = Model::GetPullRequestApprovalStatesRequest>
  Model::GetPullRequestApprovalStatesOutcomeCallable GetPullRequestApprovalStatesCallable(
      const GetPullRequestApprovalStatesRequestT& request) const {
    return SubmitCallable(&CodeCommitClient::GetPullRequestApprovalStates, request);
  }

  /**
   * An Async wrapper for GetPullRequestApprovalStates that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetPullRequestApprovalStatesRequestT = Model::GetPullRequestApprovalStatesRequest>
  void GetPullRequestApprovalStatesAsync(const GetPullRequestApprovalStatesRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetPullRequestOverrideStateOutcome GetPullRequestOverrideState(
      const Model::GetPullRequestOverrideStateRequest& request) const;

  /**
   * A Callable wrapper for GetPullRequestOverrideState that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetPullRequestOverrideStateRequestT = Model::GetPullRequestOverrideStateRequest>
  Model::GetPullRequestOverrideStateOutcomeCallable GetPullRequestOverrideStateCallable(
      const GetPullRequestOverrideStateRequestT& request) const {
    return SubmitCallable(&CodeCommitClient::GetPullRequestOverrideState, request);
  }

  /**
   * An Async wrapper for GetPullRequestOverrideState that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetPullRequestOverrideStateRequestT = Model::GetPullRequestOverrideStateRequest>
  void GetPullRequestOverrideStateAsync(const GetPullRequestOverrideStateRequestT& request,
  ...
  /**
   * An Async wrapper for GetRepository that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetRepositoryRequestT = Model::GetRepositoryRequest>
  void GetRepositoryAsync(const GetRepositoryRequestT& request, const GetRepositoryResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetRepositoryTriggers that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetRepositoryTriggers that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetRepositoryTriggersRequestT = Model::GetRepositoryTriggersRequest>
  void GetRepositoryTriggersAsync(const GetRepositoryTriggersRequestT& request, const GetRepositoryTriggersResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListApprovalRuleTemplatesOutcome ListApprovalRuleTemplates(
      const Model::ListApprovalRuleTemplatesRequest& request = {}) const;

  /**
   * A Callable wrapper for ListApprovalRuleTemplates that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListApprovalRuleTemplatesRequestT = Model::ListApprovalRuleTemplatesRequest>
  Model::ListApprovalRuleTemplatesOutcomeCallable ListApprovalRuleTemplatesCallable(
      const ListApprovalRuleTemplatesRequestT& request = {}) const {
    return SubmitCallable(&CodeCommitClient::ListApprovalRuleTemplates, request);
  }

  /**
   * An Async wrapper for ListApprovalRuleTemplates that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListApprovalRuleTemplatesRequestT = Model::ListApprovalRuleTemplatesRequest>
  void ListApprovalRuleTemplatesAsync(const ListApprovalRuleTemplatesResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const ListApprovalRuleTemplatesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListAssociatedApprovalRuleTemplatesForRepositoryOutcome ListAssociatedApprovalRuleTemplatesForRepository(
      const Model::ListAssociatedApprovalRuleTemplatesForRepositoryRequest& request) const;

  /**
   * A Callable wrapper for ListAssociatedApprovalRuleTemplatesForRepository that returns a future to the operation so that it can be
   * executed in parallel to other requests.
   */
  template <
      typename ListAssociatedApprovalRuleTemplatesForRepositoryRequestT = Model::ListAssociatedApprovalRuleTemplatesForRepositoryRequest>
  Model::ListAssociatedApprovalRuleTemplatesForRepositoryOutcomeCallable ListAssociatedApprovalRuleTemplatesForRepositoryCallable(
      const ListAssociatedApprovalRuleTemplatesForRepositoryRequestT& request) const {
    return SubmitCallable(&CodeCommitClient::ListAssociatedApprovalRuleTemplatesForRepository, request);
  }

  /**
   * An Async wrapper for ListAssociatedApprovalRuleTemplatesForRepository that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <
      typename ListAssociatedApprovalRuleTemplatesForRepositoryRequestT = Model::ListAssociatedApprovalRuleTemplatesForRepositoryRequest>
  void ListAssociatedApprovalRuleTemplatesForRepositoryAsync(
      const ListAssociatedApprovalRuleTemplatesForRepositoryRequestT& request,
  ...
  /**
   * An Async wrapper for ListBranches that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListBranchesRequestT = Model::ListBranchesRequest>
  void ListBranchesAsync(const ListBranchesRequestT& request, const ListBranchesResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListFileCommitHistory that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListFileCommitHistory that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListFileCommitHistoryRequestT = Model::ListFileCommitHistoryRequest>
  void ListFileCommitHistoryAsync(const ListFileCommitHistoryRequestT& request, const ListFileCommitHistoryResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListPullRequests that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListPullRequests that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListPullRequestsRequestT = Model::ListPullRequestsRequest>
  void ListPullRequestsAsync(const ListPullRequestsRequestT& request, const ListPullRequestsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListRepositories that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListRepositories that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListRepositoriesRequestT = Model::ListRepositoriesRequest>
  void ListRepositoriesAsync(const ListRepositoriesResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const ListRepositoriesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListRepositoriesForApprovalRuleTemplateOutcome ListRepositoriesForApprovalRuleTemplate(
      const Model::ListRepositoriesForApprovalRuleTemplateRequest& request) const;

  /**
   * A Callable wrapper for ListRepositoriesForApprovalRuleTemplate that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListRepositoriesForApprovalRuleTemplateRequestT = Model::ListRepositoriesForApprovalRuleTemplateRequest>
  Model::ListRepositoriesForApprovalRuleTemplateOutcomeCallable ListRepositoriesForApprovalRuleTemplateCallable(
      const ListRepositoriesForApprovalRuleTemplateRequestT& request) const {
    return SubmitCallable(&CodeCommitClient::ListRepositoriesForApprovalRuleTemplate, request);
  }

  /**
   * An Async wrapper for ListRepositoriesForApprovalRuleTemplate that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListRepositoriesForApprovalRuleTemplateRequestT = Model::ListRepositoriesForApprovalRuleTemplateRequest>
  void ListRepositoriesForApprovalRuleTemplateAsync(const ListRepositoriesForApprovalRuleTemplateRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::MergeBranchesByFastForwardOutcome MergeBranchesByFastForward(
      const Model::MergeBranchesByFastForwardRequest& request) const;

  /**
   * A Callable wrapper for MergeBranchesByFastForward that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename MergeBranchesByFastForwardRequestT = Model::MergeBranchesByFastForwardRequest>
  Model::MergeBranchesByFastForwardOutcomeCallable MergeBranchesByFastForwardCallable(
      const MergeBranchesByFastForwardRequestT& request) const {
    return SubmitCallable(&CodeCommitClient::MergeBranchesByFastForward, request);
  }

  /**
   * An Async wrapper for MergeBranchesByFastForward that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename MergeBranchesByFastForwardRequestT = Model::MergeBranchesByFastForwardRequest>
  void MergeBranchesByFastForwardAsync(const MergeBranchesByFastForwardRequestT& request,
  ...
  /**
   * A Callable wrapper for MergeBranchesBySquash that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for MergeBranchesBySquash that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename MergeBranchesBySquashRequestT = Model::MergeBranchesBySquashRequest>
  void MergeBranchesBySquashAsync(const MergeBranchesBySquashRequestT& request, const MergeBranchesBySquashResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for MergeBranchesByThreeWay that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for MergeBranchesByThreeWay that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename MergeBranchesByThreeWayRequestT = Model::MergeBranchesByThreeWayRequest>
  void MergeBranchesByThreeWayAsync(const MergeBranchesByThreeWayRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::MergePullRequestByFastForwardOutcome MergePullRequestByFastForward(
      const Model::MergePullRequestByFastForwardRequest& request) const;

  /**
   * A Callable wrapper for MergePullRequestByFastForward that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename MergePullRequestByFastForwardRequestT = Model::MergePullRequestByFastForwardRequest>
  Model::MergePullRequestByFastForwardOutcomeCallable MergePullRequestByFastForwardCallable(
      const MergePullRequestByFastForwardRequestT& request) const {
    return SubmitCallable(&CodeCommitClient::MergePullRequestByFastForward, request);
  }

  /**
   * An Async wrapper for MergePullRequestByFastForward that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename MergePullRequestByFastForwardRequestT = Model::MergePullRequestByFastForwardRequest>
  void MergePullRequestByFastForwardAsync(const MergePullRequestByFastForwardRequestT& request,
  ...
  /**
   * A Callable wrapper for MergePullRequestBySquash that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for MergePullRequestBySquash that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename MergePullRequestBySquashRequestT = Model::MergePullRequestBySquashRequest>
  void MergePullRequestBySquashAsync(const MergePullRequestBySquashRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::MergePullRequestByThreeWayOutcome MergePullRequestByThreeWay(
      const Model::MergePullRequestByThreeWayRequest& request) const;

  /**
   * A Callable wrapper for MergePullRequestByThreeWay that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename MergePullRequestByThreeWayRequestT = Model::MergePullRequestByThreeWayRequest>
  Model::MergePullRequestByThreeWayOutcomeCallable MergePullRequestByThreeWayCallable(
      const MergePullRequestByThreeWayRequestT& request) const {
    return SubmitCallable(&CodeCommitClient::MergePullRequestByThreeWay, request);
  }

  /**
   * An Async wrapper for MergePullRequestByThreeWay that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename MergePullRequestByThreeWayRequestT = Model::MergePullRequestByThreeWayRequest>
  void MergePullRequestByThreeWayAsync(const MergePullRequestByThreeWayRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::OverridePullRequestApprovalRulesOutcome OverridePullRequestApprovalRules(
      const Model::OverridePullRequestApprovalRulesRequest& request) const;

  /**
   * A Callable wrapper for OverridePullRequestApprovalRules that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename OverridePullRequestApprovalRulesRequestT = Model::OverridePullRequestApprovalRulesRequest>
  Model::OverridePullRequestApprovalRulesOutcomeCallable OverridePullRequestApprovalRulesCallable(
      const OverridePullRequestApprovalRulesRequestT& request) const {
    return SubmitCallable(&CodeCommitClient::OverridePullRequestApprovalRules, request);
  }

  /**
   * An Async wrapper for OverridePullRequestApprovalRules that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename OverridePullRequestApprovalRulesRequestT = Model::OverridePullRequestApprovalRulesRequest>
  void OverridePullRequestApprovalRulesAsync(const OverridePullRequestApprovalRulesRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::PostCommentForComparedCommitOutcome PostCommentForComparedCommit(
      const Model::PostCommentForComparedCommitRequest& request) const;

  /**
   * A Callable wrapper for PostCommentForComparedCommit that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PostCommentForComparedCommitRequestT = Model::PostCommentForComparedCommitRequest>
  Model::PostCommentForComparedCommitOutcomeCallable PostCommentForComparedCommitCallable(
      const PostCommentForComparedCommitRequestT& request) const {
    return SubmitCallable(&CodeCommitClient::PostCommentForComparedCommit, request);
  }

  /**
   * An Async wrapper for PostCommentForComparedCommit that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PostCommentForComparedCommitRequestT = Model::PostCommentForComparedCommitRequest>
  void PostCommentForComparedCommitAsync(const PostCommentForComparedCommitRequestT& request,
  ...
  /**
   * A Callable wrapper for PostCommentForPullRequest that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename PostCommentForPullRequestRequestT = Model::PostCommentForPullRequestRequest>
  Model::PostCommentForPullRequestOutcomeCallable PostCommentForPullRequestCallable(
      const PostCommentForPullRequestRequestT& request) const {
    return SubmitCallable(&CodeCommitClient::PostCommentForPullRequest, request);
  }

  /**
   * An Async wrapper for PostCommentForPullRequest that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PostCommentForPullRequestRequestT = Model::PostCommentForPullRequestRequest>
  void PostCommentForPullRequestAsync(const PostCommentForPullRequestRequestT& request,
  ...
  /**
   * A Callable wrapper for PostCommentReply that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PostCommentReply that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PostCommentReplyRequestT = Model::PostCommentReplyRequest>
  void PostCommentReplyAsync(const PostCommentReplyRequestT& request, const PostCommentReplyResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutCommentReaction that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutCommentReaction that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PutCommentReactionRequestT = Model::PutCommentReactionRequest>
  void PutCommentReactionAsync(const PutCommentReactionRequestT& request, const PutCommentReactionResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for PutFile that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutFileRequestT = Model::PutFileRequest>
  void PutFileAsync(const PutFileRequestT& request, const PutFileResponseReceivedHandler& handler,
                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutRepositoryTriggers that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutRepositoryTriggers that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutRepositoryTriggersRequestT = Model::PutRepositoryTriggersRequest>
  void PutRepositoryTriggersAsync(const PutRepositoryTriggersRequestT& request, const PutRepositoryTriggersResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for TestRepositoryTriggers that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for TestRepositoryTriggers that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename TestRepositoryTriggersRequestT = Model::TestRepositoryTriggersRequest>
  void TestRepositoryTriggersAsync(const TestRepositoryTriggersRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateApprovalRuleTemplateContentOutcome UpdateApprovalRuleTemplateContent(
      const Model::UpdateApprovalRuleTemplateContentRequest& request) const;

  /**
   * A Callable wrapper for UpdateApprovalRuleTemplateContent that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename UpdateApprovalRuleTemplateContentRequestT = Model::UpdateApprovalRuleTemplateContentRequest>
  Model::UpdateApprovalRuleTemplateContentOutcomeCallable UpdateApprovalRuleTemplateContentCallable(
      const UpdateApprovalRuleTemplateContentRequestT& request) const {
    return SubmitCallable(&CodeCommitClient::UpdateApprovalRuleTemplateContent, request);
  }

  /**
   * An Async wrapper for UpdateApprovalRuleTemplateContent that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateApprovalRuleTemplateContentRequestT = Model::UpdateApprovalRuleTemplateContentRequest>
  void UpdateApprovalRuleTemplateContentAsync(const UpdateApprovalRuleTemplateContentRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateApprovalRuleTemplateDescriptionOutcome UpdateApprovalRuleTemplateDescription(
      const Model::UpdateApprovalRuleTemplateDescriptionRequest& request) const;

  /**
   * A Callable wrapper for UpdateApprovalRuleTemplateDescription that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename UpdateApprovalRuleTemplateDescriptionRequestT = Model::UpdateApprovalRuleTemplateDescriptionRequest>
  Model::UpdateApprovalRuleTemplateDescriptionOutcomeCallable UpdateApprovalRuleTemplateDescriptionCallable(
      const UpdateApprovalRuleTemplateDescriptionRequestT& request) const {
    return SubmitCallable(&CodeCommitClient::UpdateApprovalRuleTemplateDescription, request);
  }

  /**
   * An Async wrapper for UpdateApprovalRuleTemplateDescription that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename UpdateApprovalRuleTemplateDescriptionRequestT = Model::UpdateApprovalRuleTemplateDescriptionRequest>
  void UpdateApprovalRuleTemplateDescriptionAsync(const UpdateApprovalRuleTemplateDescriptionRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateApprovalRuleTemplateNameOutcome UpdateApprovalRuleTemplateName(
      const Model::UpdateApprovalRuleTemplateNameRequest& request) const;

  /**
   * A Callable wrapper for UpdateApprovalRuleTemplateName that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateApprovalRuleTemplateNameRequestT = Model::UpdateApprovalRuleTemplateNameRequest>
  Model::UpdateApprovalRuleTemplateNameOutcomeCallable UpdateApprovalRuleTemplateNameCallable(
      const UpdateApprovalRuleTemplateNameRequestT& request) const {
    return SubmitCallable(&CodeCommitClient::UpdateApprovalRuleTemplateName, request);
  }

  /**
   * An Async wrapper for UpdateApprovalRuleTemplateName that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateApprovalRuleTemplateNameRequestT = Model::UpdateApprovalRuleTemplateNameRequest>
  void UpdateApprovalRuleTemplateNameAsync(const UpdateApprovalRuleTemplateNameRequestT& request,
  ...
  /**
   * An Async wrapper for UpdateComment that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateCommentRequestT = Model::UpdateCommentRequest>
  void UpdateCommentAsync(const UpdateCommentRequestT& request, const UpdateCommentResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateDefaultBranch that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateDefaultBranch that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateDefaultBranchRequestT = Model::UpdateDefaultBranchRequest>
  void UpdateDefaultBranchAsync(const UpdateDefaultBranchRequestT& request, const UpdateDefaultBranchResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdatePullRequestApprovalRuleContentOutcome UpdatePullRequestApprovalRuleContent(
      const Model::UpdatePullRequestApprovalRuleContentRequest& request) const;

  /**
   * A Callable wrapper for UpdatePullRequestApprovalRuleContent that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename UpdatePullRequestApprovalRuleContentRequestT = Model::UpdatePullRequestApprovalRuleContentRequest>
  Model::UpdatePullRequestApprovalRuleContentOutcomeCallable UpdatePullRequestApprovalRuleContentCallable(
      const UpdatePullRequestApprovalRuleContentRequestT& request) const {
    return SubmitCallable(&CodeCommitClient::UpdatePullRequestApprovalRuleContent, request);
  }

  /**
   * An Async wrapper for UpdatePullRequestApprovalRuleContent that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename UpdatePullRequestApprovalRuleContentRequestT = Model::UpdatePullRequestApprovalRuleContentRequest>
  void UpdatePullRequestApprovalRuleContentAsync(const UpdatePullRequestApprovalRuleContentRequestT& request,
  ...
  virtual Model::UpdatePullRequestApprovalStateOutcome UpdatePullRequestApprovalState(
      const Model::UpdatePullRequestApprovalStateRequest& request) const;

  /**
   * A Callable wrapper for UpdatePullRequestApprovalState that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdatePullRequestApprovalStateRequestT = Model::UpdatePullRequestApprovalStateRequest>
  Model::UpdatePullRequestApprovalStateOutcomeCallable UpdatePullRequestApprovalStateCallable(
      const UpdatePullRequestApprovalStateRequestT& request) const {
    return SubmitCallable(&CodeCommitClient::UpdatePullRequestApprovalState, request);
  }

  /**
   * An Async wrapper for UpdatePullRequestApprovalState that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdatePullRequestApprovalStateRequestT = Model::UpdatePullRequestApprovalStateRequest>
  void UpdatePullRequestApprovalStateAsync(const UpdatePullRequestApprovalStateRequestT& request,
  ...
  virtual Model::UpdatePullRequestDescriptionOutcome UpdatePullRequestDescription(
      const Model::UpdatePullRequestDescriptionRequest& request) const;

  /**
   * A Callable wrapper for UpdatePullRequestDescription that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdatePullRequestDescriptionRequestT = Model::UpdatePullRequestDescriptionRequest>
  Model::UpdatePullRequestDescriptionOutcomeCallable UpdatePullRequestDescriptionCallable(
      const UpdatePullRequestDescriptionRequestT& request) const {
    return SubmitCallable(&CodeCommitClient::UpdatePullRequestDescription, request);
  }

  /**
   * An Async wrapper for UpdatePullRequestDescription that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdatePullRequestDescriptionRequestT = Model::UpdatePullRequestDescriptionRequest>
  void UpdatePullRequestDescriptionAsync(const UpdatePullRequestDescriptionRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdatePullRequestStatus that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdatePullRequestStatus that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdatePullRequestStatusRequestT = Model::UpdatePullRequestStatusRequest>
  void UpdatePullRequestStatusAsync(const UpdatePullRequestStatusRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdatePullRequestTitle that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdatePullRequestTitle that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdatePullRequestTitleRequestT = Model::UpdatePullRequestTitleRequest>
  void UpdatePullRequestTitleAsync(const UpdatePullRequestTitleRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateRepositoryDescriptionOutcome UpdateRepositoryDescription(
      const Model::UpdateRepositoryDescriptionRequest& request) const;

  /**
   * A Callable wrapper for UpdateRepositoryDescription that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateRepositoryDescriptionRequestT = Model::UpdateRepositoryDescriptionRequest>
  Model::UpdateRepositoryDescriptionOutcomeCallable UpdateRepositoryDescriptionCallable(
      const UpdateRepositoryDescriptionRequestT& request) const {
    return SubmitCallable(&CodeCommitClient::UpdateRepositoryDescription, request);
  }

  /**
   * An Async wrapper for UpdateRepositoryDescription that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateRepositoryDescriptionRequestT = Model::UpdateRepositoryDescriptionRequest>
  void UpdateRepositoryDescriptionAsync(const UpdateRepositoryDescriptionRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateRepositoryEncryptionKeyOutcome UpdateRepositoryEncryptionKey(
      const Model::UpdateRepositoryEncryptionKeyRequest& request) const;

  /**
   * A Callable wrapper for UpdateRepositoryEncryptionKey that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateRepositoryEncryptionKeyRequestT = Model::UpdateRepositoryEncryptionKeyRequest>
  Model::UpdateRepositoryEncryptionKeyOutcomeCallable UpdateRepositoryEncryptionKeyCallable(
      const UpdateRepositoryEncryptionKeyRequestT& request) const {
    return SubmitCallable(&CodeCommitClient::UpdateRepositoryEncryptionKey, request);
  }

  /**
   * An Async wrapper for UpdateRepositoryEncryptionKey that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateRepositoryEncryptionKeyRequestT = Model::UpdateRepositoryEncryptionKeyRequest>
  void UpdateRepositoryEncryptionKeyAsync(const UpdateRepositoryEncryptionKeyRequestT& request,
                                          const UpdateRepositoryEncryptionKeyResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateRepositoryName that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateRepositoryName that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateRepositoryNameRequestT = Model::UpdateRepositoryNameRequest>
  void UpdateRepositoryNameAsync(const UpdateRepositoryNameRequestT& request, const UpdateRepositoryNameResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
