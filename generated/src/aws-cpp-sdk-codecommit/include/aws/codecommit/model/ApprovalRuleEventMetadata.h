...
class ApprovalRuleEventMetadata {
 public:
  ...
  void SetApprovalRuleName(ApprovalRuleNameT&& value) {
    ...
    m_approvalRuleName = std::forward<ApprovalRuleNameT>(value);
  }
  template <typename ApprovalRuleNameT = Aws::String>
  ApprovalRuleEventMetadata& WithApprovalRuleName(ApprovalRuleNameT&& value) {
    SetApprovalRuleName(std::forward<ApprovalRuleNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetApprovalRuleContent(ApprovalRuleContentT&& value) {
    ...
    m_approvalRuleContent = std::forward<ApprovalRuleContentT>(value);
  }
  template <typename ApprovalRuleContentT = Aws::String>
  ApprovalRuleEventMetadata& WithApprovalRuleContent(ApprovalRuleContentT&& value) {
    SetApprovalRuleContent(std::forward<ApprovalRuleContentT>(value));
    return *this;
  }
  ///@}
 private:
