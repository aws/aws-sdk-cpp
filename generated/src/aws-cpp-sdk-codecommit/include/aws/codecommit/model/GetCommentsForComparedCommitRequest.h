...
class GetCommentsForComparedCommitRequest : public CodeCommitRequest {
 public:
  ...
  template <typename RepositoryNameT = Aws::String>
  GetCommentsForComparedCommitRequest& WithRepositoryName(RepositoryNameT&& value) {
  ...
  template <typename BeforeCommitIdT = Aws::String>
  GetCommentsForComparedCommitRequest& WithBeforeCommitId(BeforeCommitIdT&& value) {
  ...
  template <typename AfterCommitIdT = Aws::String>
  GetCommentsForComparedCommitRequest& WithAfterCommitId(AfterCommitIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  GetCommentsForComparedCommitRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline GetCommentsForComparedCommitRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
