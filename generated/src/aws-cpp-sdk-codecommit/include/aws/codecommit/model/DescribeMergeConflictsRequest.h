...
class DescribeMergeConflictsRequest : public CodeCommitRequest {
 public:
  ...
  inline DescribeMergeConflictsRequest& WithMergeOption(MergeOptionTypeEnum value) {
  ...
  inline void SetMaxMergeHunks(int value) {
    m_maxMergeHunksHasBeenSet = true;
    m_maxMergeHunks = value;
  }
  inline DescribeMergeConflictsRequest& WithMaxMergeHunks(int value) {
    SetMaxMergeHunks(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeMergeConflictsRequest& WithConflictDetailLevel(ConflictDetailLevelTypeEnum value) {
  ...
  inline DescribeMergeConflictsRequest& WithConflictResolutionStrategy(ConflictResolutionStrategyTypeEnum value) {
