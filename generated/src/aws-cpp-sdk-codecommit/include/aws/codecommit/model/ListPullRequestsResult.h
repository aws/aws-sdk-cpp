...
class ListPullRequestsResult {
 public:
  ...
  void SetPullRequestIds(PullRequestIdsT&& value) {
    m_pullRequestIdsHasBeenSet = true;
    m_pullRequestIds = std::forward<PullRequestIdsT>(value);
  }
  template <typename PullRequestIdsT = Aws::Vector<Aws::String>>
  ListPullRequestsResult& WithPullRequestIds(PullRequestIdsT&& value) {
    SetPullRequestIds(std::forward<PullRequestIdsT>(value));
    return *this;
  }
  template <typename PullRequestIdsT = Aws::String>
  ListPullRequestsResult& AddPullRequestIds(PullRequestIdsT&& value) {
    m_pullRequestIdsHasBeenSet = true;
    m_pullRequestIds.emplace_back(std::forward<PullRequestIdsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListPullRequestsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListPullRequestsResult& WithRequestId(RequestIdT&& value) {
