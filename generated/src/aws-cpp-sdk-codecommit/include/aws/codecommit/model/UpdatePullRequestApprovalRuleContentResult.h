...
class UpdatePullRequestApprovalRuleContentResult {
 public:
  AWS_CODECOMMIT_API UpdatePullRequestApprovalRuleContentResult() = default;
  ...
  AWS_CODECOMMIT_API UpdatePullRequestApprovalRuleContentResult& operator=(
  ...
  void SetApprovalRule(ApprovalRuleT&& value) {
    m_approvalRuleHasBeenSet = true;
    m_approvalRule = std::forward<ApprovalRuleT>(value);
  }
  template <typename ApprovalRuleT = ApprovalRule>
  UpdatePullRequestApprovalRuleContentResult& WithApprovalRule(ApprovalRuleT&& value) {
    SetApprovalRule(std::forward<ApprovalRuleT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  UpdatePullRequestApprovalRuleContentResult& WithRequestId(RequestIdT&& value) {
