...
class PostCommentForPullRequestResult {
 public:
  ...
  template <typename RepositoryNameT = Aws::String>
  PostCommentForPullRequestResult& WithRepositoryName(RepositoryNameT&& value) {
  ...
  template <typename PullRequestIdT = Aws::String>
  PostCommentForPullRequestResult& WithPullRequestId(PullRequestIdT&& value) {
  ...
  template <typename BeforeCommitIdT = Aws::String>
  PostCommentForPullRequestResult& WithBeforeCommitId(BeforeCommitIdT&& value) {
  ...
  template <typename AfterCommitIdT = Aws::String>
  PostCommentForPullRequestResult& WithAfterCommitId(AfterCommitIdT&& value) {
  ...
  template <typename BeforeBlobIdT = Aws::String>
  PostCommentForPullRequestResult& WithBeforeBlobId(BeforeBlobIdT&& value) {
  ...
  template <typename AfterBlobIdT = Aws::String>
  PostCommentForPullRequestResult& WithAfterBlobId(AfterBlobIdT&& value) {
  ...
  template <typename LocationT = Location>
  PostCommentForPullRequestResult& WithLocation(LocationT&& value) {
  ...
  template <typename CommentT = Comment>
  PostCommentForPullRequestResult& WithComment(CommentT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  PostCommentForPullRequestResult& WithRequestId(RequestIdT&& value) {
