...
namespace Model
{
  ...
  public:
    ...
    template<typename RepositoryNameT = Aws::String>
    MergeBranchesBySquashRequest& WithRepositoryName(RepositoryNameT&& value) { SetRepositoryName(std::forward<RepositoryNameT>(value)); return *this;}
    ///@}
    ...
    template<typename SourceCommitSpecifierT = Aws::String>
    MergeBranchesBySquashRequest& WithSourceCommitSpecifier(SourceCommitSpecifierT&& value) { SetSourceCommitSpecifier(std::forward<SourceCommitSpecifierT>(value)); return *this;}
    ///@}
    ...
    template<typename DestinationCommitSpecifierT = Aws::String>
    MergeBranchesBySquashRequest& WithDestinationCommitSpecifier(DestinationCommitSpecifierT&& value) { SetDestinationCommitSpecifier(std::forward<DestinationCommitSpecifierT>(value)); return *this;}
    ///@}
    ...
    template<typename TargetBranchT = Aws::String>
    MergeBranchesBySquashRequest& WithTargetBranch(TargetBranchT&& value) { SetTargetBranch(std::forward<TargetBranchT>(value)); return *this;}
    ///@}
    ...
    inline MergeBranchesBySquashRequest& WithConflictDetailLevel(ConflictDetailLevelTypeEnum value) { SetConflictDetailLevel(value); return *this;}
    ///@}
    ...
    inline MergeBranchesBySquashRequest& WithConflictResolutionStrategy(ConflictResolutionStrategyTypeEnum value) { SetConflictResolutionStrategy(value); return *this;}
    ///@}
    ...
    template<typename AuthorNameT = Aws::String>
    MergeBranchesBySquashRequest& WithAuthorName(AuthorNameT&& value) { SetAuthorName(std::forward<AuthorNameT>(value)); return *this;}
    ///@}
    ...
    template<typename EmailT = Aws::String>
    MergeBranchesBySquashRequest& WithEmail(EmailT&& value) { SetEmail(std::forward<EmailT>(value)); return *this;}
    ///@}
    ...
    template<typename CommitMessageT = Aws::String>
    MergeBranchesBySquashRequest& WithCommitMessage(CommitMessageT&& value) { SetCommitMessage(std::forward<CommitMessageT>(value)); return *this;}
    ///@}
    ...
    template<typename ConflictResolutionT = ConflictResolution>
    MergeBranchesBySquashRequest& WithConflictResolution(ConflictResolutionT&& value) { SetConflictResolution(std::forward<ConflictResolutionT>(value)); return *this;}
    ///@}
  private:
