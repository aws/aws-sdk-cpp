...
class MergeBranchesBySquashRequest : public CodeCommitRequest {
 public:
  ...
  inline MergeBranchesBySquashRequest& WithConflictDetailLevel(ConflictDetailLevelTypeEnum value) {
  ...
  inline MergeBranchesBySquashRequest& WithConflictResolutionStrategy(ConflictResolutionStrategyTypeEnum value) {
  ...
  inline MergeBranchesBySquashRequest& WithKeepEmptyFolders(bool value) {
