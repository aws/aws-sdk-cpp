...
class BatchAssociateApprovalRuleTemplateWithRepositoriesRequest : public CodeCommitRequest {
 public:
  ...
  template <typename ApprovalRuleTemplateNameT = Aws::String>
  BatchAssociateApprovalRuleTemplateWithRepositoriesRequest& WithApprovalRuleTemplateName(ApprovalRuleTemplateNameT&& value) {
  ...
  template <typename RepositoryNamesT = Aws::Vector<Aws::String>>
  BatchAssociateApprovalRuleTemplateWithRepositoriesRequest& WithRepositoryNames(RepositoryNamesT&& value) {
    SetRepositoryNames(std::forward<RepositoryNamesT>(value));
    return *this;
  }
  template <typename RepositoryNamesT = Aws::String>
  BatchAssociateApprovalRuleTemplateWithRepositoriesRequest& AddRepositoryNames(RepositoryNamesT&& value) {
    m_repositoryNamesHasBeenSet = true;
