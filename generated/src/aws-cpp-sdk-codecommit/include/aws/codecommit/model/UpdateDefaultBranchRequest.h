...
class UpdateDefaultBranchRequest : public CodeCommitRequest {
 public:
  ...
  template <typename RepositoryNameT = Aws::String>
  UpdateDefaultBranchRequest& WithRepositoryName(RepositoryNameT&& value) {
  ...
  void SetDefaultBranchName(DefaultBranchNameT&& value) {
    m_defaultBranchNameHasBeenSet = true;
    m_defaultBranchName = std::forward<DefaultBranchNameT>(value);
  }
  template <typename DefaultBranchNameT = Aws::String>
  UpdateDefaultBranchRequest& WithDefaultBranchName(DefaultBranchNameT&& value) {
    SetDefaultBranchName(std::forward<DefaultBranchNameT>(value));
    return *this;
  }
  ///@}
 private:
