...
class BatchDisassociateApprovalRuleTemplateFromRepositoriesRequest : public CodeCommitRequest {
 public:
  ...
  template <typename ApprovalRuleTemplateNameT = Aws::String>
  BatchDisassociateApprovalRuleTemplateFromRepositoriesRequest& WithApprovalRuleTemplateName(ApprovalRuleTemplateNameT&& value) {
  ...
  void SetRepositoryNames(RepositoryNamesT&& value) {
    m_repositoryNamesHasBeenSet = true;
    m_repositoryNames = std::forward<RepositoryNamesT>(value);
  }
  template <typename RepositoryNamesT = Aws::Vector<Aws::String>>
  BatchDisassociateApprovalRuleTemplateFromRepositoriesRequest& WithRepositoryNames(RepositoryNamesT&& value) {
    SetRepositoryNames(std::forward<RepositoryNamesT>(value));
    return *this;
  }
  template <typename RepositoryNamesT = Aws::String>
  BatchDisassociateApprovalRuleTemplateFromRepositoriesRequest& AddRepositoryNames(RepositoryNamesT&& value) {
    m_repositoryNamesHasBeenSet = true;
    m_repositoryNames.emplace_back(std::forward<RepositoryNamesT>(value));
    return *this;
  }
  ///@}
 private:
