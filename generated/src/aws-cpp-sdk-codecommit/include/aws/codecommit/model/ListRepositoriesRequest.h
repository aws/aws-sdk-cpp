...
class ListRepositoriesRequest : public CodeCommitRequest {
 public:
  ...
  inline void SetSortBy(SortByEnum value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ListRepositoriesRequest& WithSortBy(SortByEnum value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline void SetOrder(OrderEnum value) {
    m_orderHasBeenSet = true;
    m_order = value;
  }
  inline ListRepositoriesRequest& WithOrder(OrderEnum value) {
    SetOrder(value);
    return *this;
  }
  ///@}
