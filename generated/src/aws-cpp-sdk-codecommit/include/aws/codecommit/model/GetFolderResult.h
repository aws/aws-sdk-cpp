...
class GetFolderResult {
 public:
  ...
  void SetSubFolders(SubFoldersT&& value) {
    ...
    m_subFolders = std::forward<SubFoldersT>(value);
  }
  template <typename SubFoldersT = Aws::Vector<Folder>>
  GetFolderResult& WithSubFolders(SubFoldersT&& value) {
    SetSubFolders(std::forward<SubFoldersT>(value));
    return *this;
  }
  template <typename SubFoldersT = Folder>
  GetFolderResult& AddSubFolders(SubFoldersT&& value) {
    m_subFoldersHasBeenSet = true;
    m_subFolders.emplace_back(std::forward<SubFoldersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSymbolicLinks(SymbolicLinksT&& value) {
    ...
    m_symbolicLinks = std::forward<SymbolicLinksT>(value);
  }
  template <typename SymbolicLinksT = Aws::Vector<SymbolicLink>>
  GetFolderResult& WithSymbolicLinks(SymbolicLinksT&& value) {
    SetSymbolicLinks(std::forward<SymbolicLinksT>(value));
    return *this;
  }
  template <typename SymbolicLinksT = SymbolicLink>
  GetFolderResult& AddSymbolicLinks(SymbolicLinksT&& value) {
    m_symbolicLinksHasBeenSet = true;
    m_symbolicLinks.emplace_back(std::forward<SymbolicLinksT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSubModules(SubModulesT&& value) {
    ...
    m_subModules = std::forward<SubModulesT>(value);
  }
  template <typename SubModulesT = Aws::Vector<SubModule>>
  GetFolderResult& WithSubModules(SubModulesT&& value) {
    SetSubModules(std::forward<SubModulesT>(value));
    return *this;
  }
  template <typename SubModulesT = SubModule>
  GetFolderResult& AddSubModules(SubModulesT&& value) {
    m_subModulesHasBeenSet = true;
    m_subModules.emplace_back(std::forward<SubModulesT>(value));
    return *this;
  }
  ///@}
