...
class ListRepositoriesForApprovalRuleTemplateRequest : public CodeCommitRequest {
 public:
  ...
  template <typename ApprovalRuleTemplateNameT = Aws::String>
  ListRepositoriesForApprovalRuleTemplateRequest& WithApprovalRuleTemplateName(ApprovalRuleTemplateNameT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListRepositoriesForApprovalRuleTemplateRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListRepositoriesForApprovalRuleTemplateRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
