...
class FileSizes {
 public:
  ...
  inline void SetSource(long long value) {
    m_sourceHasBeenSet = true;
    m_source = value;
  }
  inline FileSizes& WithSource(long long value) {
    SetSource(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDestination(long long value) {
    m_destinationHasBeenSet = true;
    m_destination = value;
  }
  inline FileSizes& WithDestination(long long value) {
  ...
  inline void SetBase(long long value) {
    m_baseHasBeenSet = true;
    m_base = value;
  }
  inline FileSizes& WithBase(long long value) {
    SetBase(value);
    return *this;
  }
  ///@}
