...
class BatchAssociateApprovalRuleTemplateWithRepositoriesResult {
 public:
  ...
  AWS_CODECOMMIT_API BatchAssociateApprovalRuleTemplateWithRepositoriesResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  void SetAssociatedRepositoryNames(AssociatedRepositoryNamesT&& value) {
    m_associatedRepositoryNamesHasBeenSet = true;
    m_associatedRepositoryNames = std::forward<AssociatedRepositoryNamesT>(value);
  }
  template <typename AssociatedRepositoryNamesT = Aws::Vector<Aws::String>>
  BatchAssociateApprovalRuleTemplateWithRepositoriesResult& WithAssociatedRepositoryNames(AssociatedRepositoryNamesT&& value) {
    SetAssociatedRepositoryNames(std::forward<AssociatedRepositoryNamesT>(value));
    return *this;
  }
  template <typename AssociatedRepositoryNamesT = Aws::String>
  BatchAssociateApprovalRuleTemplateWithRepositoriesResult& AddAssociatedRepositoryNames(AssociatedRepositoryNamesT&& value) {
    m_associatedRepositoryNamesHasBeenSet = true;
    m_associatedRepositoryNames.emplace_back(std::forward<AssociatedRepositoryNamesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ErrorsT = Aws::Vector<BatchAssociateApprovalRuleTemplateWithRepositoriesError>>
  BatchAssociateApprovalRuleTemplateWithRepositoriesResult& WithErrors(ErrorsT&& value) {
    SetErrors(std::forward<ErrorsT>(value));
    return *this;
  }
  template <typename ErrorsT = BatchAssociateApprovalRuleTemplateWithRepositoriesError>
  BatchAssociateApprovalRuleTemplateWithRepositoriesResult& AddErrors(ErrorsT&& value) {
    m_errorsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  BatchAssociateApprovalRuleTemplateWithRepositoriesResult& WithRequestId(RequestIdT&& value) {
