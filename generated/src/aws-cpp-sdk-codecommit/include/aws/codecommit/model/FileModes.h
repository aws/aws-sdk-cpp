...
class FileModes {
 public:
  ...
  inline void SetSource(FileModeTypeEnum value) {
    m_sourceHasBeenSet = true;
    m_source = value;
  }
  inline FileModes& WithSource(FileModeTypeEnum value) {
    SetSource(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDestination(FileModeTypeEnum value) {
    m_destinationHasBeenSet = true;
    m_destination = value;
  }
  inline FileModes& WithDestination(FileModeTypeEnum value) {
  ...
  inline void SetBase(FileModeTypeEnum value) {
    m_baseHasBeenSet = true;
    m_base = value;
  }
  inline FileModes& WithBase(FileModeTypeEnum value) {
    SetBase(value);
    return *this;
  }
  ///@}
