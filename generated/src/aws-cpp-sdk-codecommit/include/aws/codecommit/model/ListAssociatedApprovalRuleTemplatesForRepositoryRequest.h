...
class ListAssociatedApprovalRuleTemplatesForRepositoryRequest : public CodeCommitRequest {
 public:
  AWS_CODECOMMIT_API ListAssociatedApprovalRuleTemplatesForRepositoryRequest() = default;
  ...
  template <typename RepositoryNameT = Aws::String>
  ListAssociatedApprovalRuleTemplatesForRepositoryRequest& WithRepositoryName(RepositoryNameT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListAssociatedApprovalRuleTemplatesForRepositoryRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListAssociatedApprovalRuleTemplatesForRepositoryRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
