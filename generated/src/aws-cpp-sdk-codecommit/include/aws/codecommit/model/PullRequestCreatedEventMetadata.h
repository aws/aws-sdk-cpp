...
class PullRequestCreatedEventMetadata {
 public:
  ...
  template <typename RepositoryNameT = Aws::String>
  PullRequestCreatedEventMetadata& WithRepositoryName(RepositoryNameT&& value) {
  ...
  template <typename SourceCommitIdT = Aws::String>
  PullRequestCreatedEventMetadata& WithSourceCommitId(SourceCommitIdT&& value) {
  ...
  template <typename DestinationCommitIdT = Aws::String>
  PullRequestCreatedEventMetadata& WithDestinationCommitId(DestinationCommitIdT&& value) {
  ...
  template <typename MergeBaseT = Aws::String>
  PullRequestCreatedEventMetadata& WithMergeBase(MergeBaseT&& value) {
