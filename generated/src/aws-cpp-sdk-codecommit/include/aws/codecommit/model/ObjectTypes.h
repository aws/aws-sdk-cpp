...
class ObjectTypes {
 public:
  ...
  inline void SetSource(ObjectTypeEnum value) {
    m_sourceHasBeenSet = true;
    m_source = value;
  }
  inline ObjectTypes& WithSource(ObjectTypeEnum value) {
    SetSource(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDestination(ObjectTypeEnum value) {
    m_destinationHasBeenSet = true;
    m_destination = value;
  }
  inline ObjectTypes& WithDestination(ObjectTypeEnum value) {
  ...
  inline void SetBase(ObjectTypeEnum value) {
    m_baseHasBeenSet = true;
    m_base = value;
  }
  inline ObjectTypes& WithBase(ObjectTypeEnum value) {
    SetBase(value);
    return *this;
  }
  ///@}
