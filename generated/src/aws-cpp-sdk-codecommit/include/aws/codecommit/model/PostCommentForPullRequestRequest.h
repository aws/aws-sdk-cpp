...
class PostCommentForPullRequestRequest : public CodeCommitRequest {
 public:
  ...
  template <typename PullRequestIdT = Aws::String>
  PostCommentForPullRequestRequest& WithPullRequestId(PullRequestIdT&& value) {
  ...
  template <typename RepositoryNameT = Aws::String>
  PostCommentForPullRequestRequest& WithRepositoryName(RepositoryNameT&& value) {
  ...
  template <typename BeforeCommitIdT = Aws::String>
  PostCommentForPullRequestRequest& WithBeforeCommitId(BeforeCommitIdT&& value) {
  ...
  template <typename AfterCommitIdT = Aws::String>
  PostCommentForPullRequestRequest& WithAfterCommitId(AfterCommitIdT&& value) {
  ...
  template <typename LocationT = Location>
  PostCommentForPullRequestRequest& WithLocation(LocationT&& value) {
  ...
  template <typename ContentT = Aws::String>
  PostCommentForPullRequestRequest& WithContent(ContentT&& value) {
  ...
  template <typename ClientRequestTokenT = Aws::String>
  PostCommentForPullRequestRequest& WithClientRequestToken(ClientRequestTokenT&& value) {
