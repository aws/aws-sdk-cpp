...
class GetFileRequest : public CodeCommitRequest {
 public:
  ...
  template <typename RepositoryNameT = Aws::String>
  GetFileRequest& WithRepositoryName(RepositoryNameT&& value) {
  ...
  template <typename CommitSpecifierT = Aws::String>
  GetFileRequest& WithCommitSpecifier(CommitSpecifierT&& value) {
  ...
  template <typename FilePathT = Aws::String>
  GetFileRequest& WithFilePath(FilePathT&& value) {
