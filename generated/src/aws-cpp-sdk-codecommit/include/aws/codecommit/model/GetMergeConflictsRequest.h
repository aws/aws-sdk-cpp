...
class GetMergeConflictsRequest : public CodeCommitRequest {
 public:
  ...
  template <typename RepositoryNameT = Aws::String>
  GetMergeConflictsRequest& WithRepositoryName(RepositoryNameT&& value) {
  ...
  template <typename DestinationCommitSpecifierT = Aws::String>
  GetMergeConflictsRequest& WithDestinationCommitSpecifier(DestinationCommitSpecifierT&& value) {
  ...
  template <typename SourceCommitSpecifierT = Aws::String>
  GetMergeConflictsRequest& WithSourceCommitSpecifier(SourceCommitSpecifierT&& value) {
  ...
  inline GetMergeConflictsRequest& WithMergeOption(MergeOptionTypeEnum value) {
  ...
  inline GetMergeConflictsRequest& WithConflictDetailLevel(ConflictDetailLevelTypeEnum value) {
  ...
  inline GetMergeConflictsRequest& WithMaxConflictFiles(int value) {
  ...
  inline GetMergeConflictsRequest& WithConflictResolutionStrategy(ConflictResolutionStrategyTypeEnum value) {
  ...
  template <typename NextTokenT = Aws::String>
  GetMergeConflictsRequest& WithNextToken(NextTokenT&& value) {
