...
class GetMergeCommitRequest : public CodeCommitRequest {
 public:
  ...
  template <typename RepositoryNameT = Aws::String>
  GetMergeCommitRequest& WithRepositoryName(RepositoryNameT&& value) {
  ...
  template <typename SourceCommitSpecifierT = Aws::String>
  GetMergeCommitRequest& WithSourceCommitSpecifier(SourceCommitSpecifierT&& value) {
  ...
  template <typename DestinationCommitSpecifierT = Aws::String>
  GetMergeCommitRequest& WithDestinationCommitSpecifier(DestinationCommitSpecifierT&& value) {
  ...
  inline GetMergeCommitRequest& WithConflictDetailLevel(ConflictDetailLevelTypeEnum value) {
  ...
  inline GetMergeCommitRequest& WithConflictResolutionStrategy(ConflictResolutionStrategyTypeEnum value) {
