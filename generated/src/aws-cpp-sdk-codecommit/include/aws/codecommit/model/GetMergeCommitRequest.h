...
namespace Model
{
  ...
  {
  public:
    AWS_CODECOMMIT_API GetMergeCommitRequest() = default;
    ...
    template<typename RepositoryNameT = Aws::String>
    GetMergeCommitRequest& WithRepositoryName(RepositoryNameT&& value) { SetRepositoryName(std::forward<RepositoryNameT>(value)); return *this;}
    ///@}
    ...
    template<typename SourceCommitSpecifierT = Aws::String>
    GetMergeCommitRequest& WithSourceCommitSpecifier(SourceCommitSpecifierT&& value) { SetSourceCommitSpecifier(std::forward<SourceCommitSpecifierT>(value)); return *this;}
    ///@}
    ...
    template<typename DestinationCommitSpecifierT = Aws::String>
    GetMergeCommitRequest& WithDestinationCommitSpecifier(DestinationCommitSpecifierT&& value) { SetDestinationCommitSpecifier(std::forward<DestinationCommitSpecifierT>(value)); return *this;}
    ///@}
    ...
    inline GetMergeCommitRequest& WithConflictDetailLevel(ConflictDetailLevelTypeEnum value) { SetConflictDetailLevel(value); return *this;}
    ///@}
    ...
    inline GetMergeCommitRequest& WithConflictResolutionStrategy(ConflictResolutionStrategyTypeEnum value) { SetConflictResolutionStrategy(value); return *this;}
    ///@}
  private:
