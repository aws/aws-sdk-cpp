...
class PostCommentForComparedCommitResult {
 public:
  ...
  template <typename RepositoryNameT = Aws::String>
  PostCommentForComparedCommitResult& WithRepositoryName(RepositoryNameT&& value) {
  ...
  template <typename BeforeCommitIdT = Aws::String>
  PostCommentForComparedCommitResult& WithBeforeCommitId(BeforeCommitIdT&& value) {
  ...
  template <typename AfterCommitIdT = Aws::String>
  PostCommentForComparedCommitResult& WithAfterCommitId(AfterCommitIdT&& value) {
  ...
  template <typename BeforeBlobIdT = Aws::String>
  PostCommentForComparedCommitResult& WithBeforeBlobId(BeforeBlobIdT&& value) {
  ...
  template <typename AfterBlobIdT = Aws::String>
  PostCommentForComparedCommitResult& WithAfterBlobId(AfterBlobIdT&& value) {
  ...
  template <typename LocationT = Location>
  PostCommentForComparedCommitResult& WithLocation(LocationT&& value) {
  ...
  template <typename CommentT = Comment>
  PostCommentForComparedCommitResult& WithComment(CommentT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  PostCommentForComparedCommitResult& WithRequestId(RequestIdT&& value) {
