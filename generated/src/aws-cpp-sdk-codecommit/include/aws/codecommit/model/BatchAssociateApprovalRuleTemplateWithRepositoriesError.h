...
class BatchAssociateApprovalRuleTemplateWithRepositoriesError {
 public:
  ...
  template <typename RepositoryNameT = Aws::String>
  BatchAssociateApprovalRuleTemplateWithRepositoriesError& WithRepositoryName(RepositoryNameT&& value) {
  ...
  template <typename ErrorCodeT = Aws::String>
  BatchAssociateApprovalRuleTemplateWithRepositoriesError& WithErrorCode(ErrorCodeT&& value) {
  ...
  template <typename ErrorMessageT = Aws::String>
  BatchAssociateApprovalRuleTemplateWithRepositoriesError& WithErrorMessage(ErrorMessageT&& value) {
