...
namespace Model
{
  ...
  {
  public:
    AWS_CODECOMMIT_API BatchAssociateApprovalRuleTemplateWithRepositoriesError() = default;
    ...
    template<typename RepositoryNameT = Aws::String>
    BatchAssociateApprovalRuleTemplateWithRepositoriesError& WithRepositoryName(RepositoryNameT&& value) { SetRepositoryName(std::forward<RepositoryNameT>(value)); return *this;}
    ///@}
    ...
    template<typename ErrorCodeT = Aws::String>
    BatchAssociateApprovalRuleTemplateWithRepositoriesError& WithErrorCode(ErrorCodeT&& value) { SetErrorCode(std::forward<ErrorCodeT>(value)); return *this;}
    ///@}
    ...
    template<typename ErrorMessageT = Aws::String>
    BatchAssociateApprovalRuleTemplateWithRepositoriesError& WithErrorMessage(ErrorMessageT&& value) { SetErrorMessage(std::forward<ErrorMessageT>(value)); return *this;}
    ///@}
  private:
