...
class GetCommentsForComparedCommitResult {
 public:
  ...
  void SetCommentsForComparedCommitData(CommentsForComparedCommitDataT&& value) {
    m_commentsForComparedCommitDataHasBeenSet = true;
    m_commentsForComparedCommitData = std::forward<CommentsForComparedCommitDataT>(value);
  }
  template <typename CommentsForComparedCommitDataT = Aws::Vector<CommentsForComparedCommit>>
  GetCommentsForComparedCommitResult& WithCommentsForComparedCommitData(CommentsForComparedCommitDataT&& value) {
    SetCommentsForComparedCommitData(std::forward<CommentsForComparedCommitDataT>(value));
    return *this;
  }
  template <typename CommentsForComparedCommitDataT = CommentsForComparedCommit>
  GetCommentsForComparedCommitResult& AddCommentsForComparedCommitData(CommentsForComparedCommitDataT&& value) {
    m_commentsForComparedCommitDataHasBeenSet = true;
    m_commentsForComparedCommitData.emplace_back(std::forward<CommentsForComparedCommitDataT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetCommentsForComparedCommitResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetCommentsForComparedCommitResult& WithRequestId(RequestIdT&& value) {
