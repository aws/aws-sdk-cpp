...
class EvaluatePullRequestApprovalRulesResult {
 public:
  ...
  AWS_CODECOMMIT_API EvaluatePullRequestApprovalRulesResult& operator=(
  ...
  template <typename EvaluationT = Evaluation>
  EvaluatePullRequestApprovalRulesResult& WithEvaluation(EvaluationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  EvaluatePullRequestApprovalRulesResult& WithRequestId(RequestIdT&& value) {
