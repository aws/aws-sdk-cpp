...
class PutRepositoryTriggersRequest : public CodeCommitRequest {
 public:
  ...
  template <typename RepositoryNameT = Aws::String>
  PutRepositoryTriggersRequest& WithRepositoryName(RepositoryNameT&& value) {
  ...
  template <typename TriggersT = Aws::Vector<RepositoryTrigger>>
  PutRepositoryTriggersRequest& WithTriggers(TriggersT&& value) {
    SetTriggers(std::forward<TriggersT>(value));
    return *this;
  }
  template <typename TriggersT = RepositoryTrigger>
  PutRepositoryTriggersRequest& AddTriggers(TriggersT&& value) {
    m_triggersHasBeenSet = true;
