...
class Evaluation {
 public:
  ...
  inline Evaluation& WithApproved(bool value) {
    SetApproved(value);
    return *this;
  }
  ///@}
  ...
  inline Evaluation& WithOverridden(bool value) {
    SetOverridden(value);
    return *this;
  }
  ///@}
  ...
  void SetApprovalRulesSatisfied(ApprovalRulesSatisfiedT&& value) {
    ...
    m_approvalRulesSatisfied = std::forward<ApprovalRulesSatisfiedT>(value);
  }
  template <typename ApprovalRulesSatisfiedT = Aws::Vector<Aws::String>>
  Evaluation& WithApprovalRulesSatisfied(ApprovalRulesSatisfiedT&& value) {
    SetApprovalRulesSatisfied(std::forward<ApprovalRulesSatisfiedT>(value));
    return *this;
  }
  template <typename ApprovalRulesSatisfiedT = Aws::String>
  Evaluation& AddApprovalRulesSatisfied(ApprovalRulesSatisfiedT&& value) {
    m_approvalRulesSatisfiedHasBeenSet = true;
    m_approvalRulesSatisfied.emplace_back(std::forward<ApprovalRulesSatisfiedT>(value));
    return *this;
  }
  ///@}
  ...
  void SetApprovalRulesNotSatisfied(ApprovalRulesNotSatisfiedT&& value) {
    ...
    m_approvalRulesNotSatisfied = std::forward<ApprovalRulesNotSatisfiedT>(value);
  }
  template <typename ApprovalRulesNotSatisfiedT = Aws::Vector<Aws::String>>
  Evaluation& WithApprovalRulesNotSatisfied(ApprovalRulesNotSatisfiedT&& value) {
    SetApprovalRulesNotSatisfied(std::forward<ApprovalRulesNotSatisfiedT>(value));
    return *this;
  }
  ...
  Evaluation& AddApprovalRulesNotSatisfied(ApprovalRulesNotSatisfiedT&& value) {
    m_approvalRulesNotSatisfiedHasBeenSet = true;
    m_approvalRulesNotSatisfied.emplace_back(std::forward<ApprovalRulesNotSatisfiedT>(value));
    return *this;
  }
  ///@}
 private:
