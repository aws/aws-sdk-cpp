...
namespace Model
{
  ...
  {
  public:
    AWS_CODECOMMIT_API UpdateApprovalRuleTemplateDescriptionResult() = default;
    ...
    template<typename ApprovalRuleTemplateT = ApprovalRuleTemplate>
    UpdateApprovalRuleTemplateDescriptionResult& WithApprovalRuleTemplate(ApprovalRuleTemplateT&& value) { SetApprovalRuleTemplate(std::forward<ApprovalRuleTemplateT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateApprovalRuleTemplateDescriptionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
