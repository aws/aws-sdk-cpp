...
class GetMergeConflictsResult {
 public:
  ...
  inline void SetMergeable(bool value) {
    m_mergeableHasBeenSet = true;
    m_mergeable = value;
  }
  inline GetMergeConflictsResult& WithMergeable(bool value) {
    SetMergeable(value);
    return *this;
  }
  ///@}
  ...
  void SetDestinationCommitId(DestinationCommitIdT&& value) {
    ...
    m_destinationCommitId = std::forward<DestinationCommitIdT>(value);
  }
  template <typename DestinationCommitIdT = Aws::String>
  GetMergeConflictsResult& WithDestinationCommitId(DestinationCommitIdT&& value) {
    SetDestinationCommitId(std::forward<DestinationCommitIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBaseCommitId(BaseCommitIdT&& value) {
    ...
    m_baseCommitId = std::forward<BaseCommitIdT>(value);
  }
  template <typename BaseCommitIdT = Aws::String>
  GetMergeConflictsResult& WithBaseCommitId(BaseCommitIdT&& value) {
    SetBaseCommitId(std::forward<BaseCommitIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetConflictMetadataList(ConflictMetadataListT&& value) {
    ...
    m_conflictMetadataList = std::forward<ConflictMetadataListT>(value);
  }
  template <typename ConflictMetadataListT = Aws::Vector<ConflictMetadata>>
  GetMergeConflictsResult& WithConflictMetadataList(ConflictMetadataListT&& value) {
    SetConflictMetadataList(std::forward<ConflictMetadataListT>(value));
    return *this;
  }
  ...
  GetMergeConflictsResult& AddConflictMetadataList(ConflictMetadataListT&& value) {
    m_conflictMetadataListHasBeenSet = true;
    m_conflictMetadataList.emplace_back(std::forward<ConflictMetadataListT>(value));
    return *this;
  }
  ///@}
