...
class GetCommentsForPullRequestResult {
 public:
  ...
  void SetCommentsForPullRequestData(CommentsForPullRequestDataT&& value) {
    m_commentsForPullRequestDataHasBeenSet = true;
    m_commentsForPullRequestData = std::forward<CommentsForPullRequestDataT>(value);
  }
  template <typename CommentsForPullRequestDataT = Aws::Vector<CommentsForPullRequest>>
  GetCommentsForPullRequestResult& WithCommentsForPullRequestData(CommentsForPullRequestDataT&& value) {
    SetCommentsForPullRequestData(std::forward<CommentsForPullRequestDataT>(value));
    return *this;
  }
  template <typename CommentsForPullRequestDataT = CommentsForPullRequest>
  GetCommentsForPullRequestResult& AddCommentsForPullRequestData(CommentsForPullRequestDataT&& value) {
    m_commentsForPullRequestDataHasBeenSet = true;
    m_commentsForPullRequestData.emplace_back(std::forward<CommentsForPullRequestDataT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetCommentsForPullRequestResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetCommentsForPullRequestResult& WithRequestId(RequestIdT&& value) {
