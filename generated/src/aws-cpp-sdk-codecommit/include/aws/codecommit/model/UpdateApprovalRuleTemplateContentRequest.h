...
class UpdateApprovalRuleTemplateContentRequest : public CodeCommitRequest {
 public:
  ...
  void SetNewRuleContent(NewRuleContentT&& value) {
    m_newRuleContentHasBeenSet = true;
    m_newRuleContent = std::forward<NewRuleContentT>(value);
  }
  template <typename NewRuleContentT = Aws::String>
  UpdateApprovalRuleTemplateContentRequest& WithNewRuleContent(NewRuleContentT&& value) {
    SetNewRuleContent(std::forward<NewRuleContentT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExistingRuleContentSha256(ExistingRuleContentSha256T&& value) {
    m_existingRuleContentSha256HasBeenSet = true;
    m_existingRuleContentSha256 = std::forward<ExistingRuleContentSha256T>(value);
  }
  template <typename ExistingRuleContentSha256T = Aws::String>
  UpdateApprovalRuleTemplateContentRequest& WithExistingRuleContentSha256(ExistingRuleContentSha256T&& value) {
    SetExistingRuleContentSha256(std::forward<ExistingRuleContentSha256T>(value));
    return *this;
  }
  ///@}
 private:
