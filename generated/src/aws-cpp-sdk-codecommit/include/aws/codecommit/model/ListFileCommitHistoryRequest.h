...
class ListFileCommitHistoryRequest : public CodeCommitRequest {
 public:
  ...
  template <typename RepositoryNameT = Aws::String>
  ListFileCommitHistoryRequest& WithRepositoryName(RepositoryNameT&& value) {
  ...
  template <typename CommitSpecifierT = Aws::String>
  ListFileCommitHistoryRequest& WithCommitSpecifier(CommitSpecifierT&& value) {
  ...
  template <typename FilePathT = Aws::String>
  ListFileCommitHistoryRequest& WithFilePath(FilePathT&& value) {
  ...
  inline ListFileCommitHistoryRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListFileCommitHistoryRequest& WithNextToken(NextTokenT&& value) {
