...
class Conflict {
 public:
  ...
  void SetConflictMetadata(ConflictMetadataT&& value) {
    ...
    m_conflictMetadata = std::forward<ConflictMetadataT>(value);
  }
  template <typename ConflictMetadataT = ConflictMetadata>
  Conflict& WithConflictMetadata(ConflictMetadataT&& value) {
    SetConflictMetadata(std::forward<ConflictMetadataT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMergeHunks(MergeHunksT&& value) {
    ...
    m_mergeHunks = std::forward<MergeHunksT>(value);
  }
  template <typename MergeHunksT = Aws::Vector<MergeHunk>>
  Conflict& WithMergeHunks(MergeHunksT&& value) {
    SetMergeHunks(std::forward<MergeHunksT>(value));
    return *this;
  }
  template <typename MergeHunksT = MergeHunk>
  Conflict& AddMergeHunks(MergeHunksT&& value) {
    m_mergeHunksHasBeenSet = true;
    m_mergeHunks.emplace_back(std::forward<MergeHunksT>(value));
    return *this;
  }
  ///@}
 private:
