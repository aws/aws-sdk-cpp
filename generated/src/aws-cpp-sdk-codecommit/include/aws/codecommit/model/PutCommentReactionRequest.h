...
class PutCommentReactionRequest : public CodeCommitRequest {
 public:
  ...
  void SetReactionValue(ReactionValueT&& value) {
    m_reactionValueHasBeenSet = true;
    m_reactionValue = std::forward<ReactionValueT>(value);
  }
  template <typename ReactionValueT = Aws::String>
  PutCommentReactionRequest& WithReactionValue(ReactionValueT&& value) {
    SetReactionValue(std::forward<ReactionValueT>(value));
    return *this;
  }
  ///@}
 private:
