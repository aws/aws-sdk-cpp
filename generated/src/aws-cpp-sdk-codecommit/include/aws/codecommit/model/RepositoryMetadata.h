...
class RepositoryMetadata {
 public:
  ...
  void SetCloneUrlHttp(CloneUrlHttpT&& value) {
    m_cloneUrlHttpHasBeenSet = true;
    m_cloneUrlHttp = std::forward<CloneUrlHttpT>(value);
  }
  template <typename CloneUrlHttpT = Aws::String>
  RepositoryMetadata& WithCloneUrlHttp(CloneUrlHttpT&& value) {
    SetCloneUrlHttp(std::forward<CloneUrlHttpT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCloneUrlSsh(CloneUrlSshT&& value) {
    m_cloneUrlSshHasBeenSet = true;
    m_cloneUrlSsh = std::forward<CloneUrlSshT>(value);
  }
  template <typename CloneUrlSshT = Aws::String>
  RepositoryMetadata& WithCloneUrlSsh(CloneUrlSshT&& value) {
    SetCloneUrlSsh(std::forward<CloneUrlSshT>(value));
    return *this;
  }
  ///@}
