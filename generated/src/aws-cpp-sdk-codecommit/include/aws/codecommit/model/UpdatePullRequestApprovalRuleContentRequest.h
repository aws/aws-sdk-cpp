...
class UpdatePullRequestApprovalRuleContentRequest : public CodeCommitRequest {
 public:
  ...
  template <typename PullRequestIdT = Aws::String>
  UpdatePullRequestApprovalRuleContentRequest& WithPullRequestId(PullRequestIdT&& value) {
  ...
  template <typename ApprovalRuleNameT = Aws::String>
  UpdatePullRequestApprovalRuleContentRequest& WithApprovalRuleName(ApprovalRuleNameT&& value) {
  ...
  template <typename ExistingRuleContentSha256T = Aws::String>
  UpdatePullRequestApprovalRuleContentRequest& WithExistingRuleContentSha256(ExistingRuleContentSha256T&& value) {
  ...
  template <typename NewRuleContentT = Aws::String>
  UpdatePullRequestApprovalRuleContentRequest& WithNewRuleContent(NewRuleContentT&& value) {
