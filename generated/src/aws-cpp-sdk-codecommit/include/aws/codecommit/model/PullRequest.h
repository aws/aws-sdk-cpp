...
class PullRequest {
 public:
  ...
  void SetLastActivityDate(LastActivityDateT&& value) {
    ...
    m_lastActivityDate = std::forward<LastActivityDateT>(value);
  }
  template <typename LastActivityDateT = Aws::Utils::DateTime>
  PullRequest& WithLastActivityDate(LastActivityDateT&& value) {
    SetLastActivityDate(std::forward<LastActivityDateT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetPullRequestStatus(PullRequestStatusEnum value) {
    m_pullRequestStatusHasBeenSet = true;
    m_pullRequestStatus = value;
  }
  inline PullRequest& WithPullRequestStatus(PullRequestStatusEnum value) {
    SetPullRequestStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetAuthorArn(AuthorArnT&& value) {
    ...
    m_authorArn = std::forward<AuthorArnT>(value);
  }
  template <typename AuthorArnT = Aws::String>
  PullRequest& WithAuthorArn(AuthorArnT&& value) {
    SetAuthorArn(std::forward<AuthorArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPullRequestTargets(PullRequestTargetsT&& value) {
    ...
    m_pullRequestTargets = std::forward<PullRequestTargetsT>(value);
  }
  template <typename PullRequestTargetsT = Aws::Vector<PullRequestTarget>>
  PullRequest& WithPullRequestTargets(PullRequestTargetsT&& value) {
    SetPullRequestTargets(std::forward<PullRequestTargetsT>(value));
    return *this;
  }
  template <typename PullRequestTargetsT = PullRequestTarget>
  PullRequest& AddPullRequestTargets(PullRequestTargetsT&& value) {
    m_pullRequestTargetsHasBeenSet = true;
    m_pullRequestTargets.emplace_back(std::forward<PullRequestTargetsT>(value));
    return *this;
  }
  ///@}
  ...
  PullRequest& AddApprovalRules(ApprovalRulesT&& value) {
    m_approvalRulesHasBeenSet = true;
    m_approvalRules.emplace_back(std::forward<ApprovalRulesT>(value));
    return *this;
  }
  ///@}
 private:
