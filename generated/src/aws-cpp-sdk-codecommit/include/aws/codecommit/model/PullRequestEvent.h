...
class PullRequestEvent {
 public:
  ...
  inline void SetPullRequestEventType(PullRequestEventType value) {
    m_pullRequestEventTypeHasBeenSet = true;
    m_pullRequestEventType = value;
  }
  inline PullRequestEvent& WithPullRequestEventType(PullRequestEventType value) {
    SetPullRequestEventType(value);
    return *this;
  }
  ///@}
  ...
  void SetActorArn(ActorArnT&& value) {
    m_actorArnHasBeenSet = true;
    m_actorArn = std::forward<ActorArnT>(value);
  }
  template <typename ActorArnT = Aws::String>
  PullRequestEvent& WithActorArn(ActorArnT&& value) {
    SetActorArn(std::forward<ActorArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPullRequestCreatedEventMetadata(PullRequestCreatedEventMetadataT&& value) {
    ...
    m_pullRequestCreatedEventMetadata = std::forward<PullRequestCreatedEventMetadataT>(value);
  }
  template <typename PullRequestCreatedEventMetadataT = PullRequestCreatedEventMetadata>
  PullRequestEvent& WithPullRequestCreatedEventMetadata(PullRequestCreatedEventMetadataT&& value) {
    SetPullRequestCreatedEventMetadata(std::forward<PullRequestCreatedEventMetadataT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const PullRequestStatusChangedEventMetadata& GetPullRequestStatusChangedEventMetadata() const {
    return m_pullRequestStatusChangedEventMetadata;
  }
  ...
  void SetPullRequestStatusChangedEventMetadata(PullRequestStatusChangedEventMetadataT&& value) {
    ...
    m_pullRequestStatusChangedEventMetadata = std::forward<PullRequestStatusChangedEventMetadataT>(value);
  }
  template <typename PullRequestStatusChangedEventMetadataT = PullRequestStatusChangedEventMetadata>
  PullRequestEvent& WithPullRequestStatusChangedEventMetadata(PullRequestStatusChangedEventMetadataT&& value) {
    SetPullRequestStatusChangedEventMetadata(std::forward<PullRequestStatusChangedEventMetadataT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const PullRequestSourceReferenceUpdatedEventMetadata& GetPullRequestSourceReferenceUpdatedEventMetadata() const {
    return m_pullRequestSourceReferenceUpdatedEventMetadata;
  }
  inline bool PullRequestSourceReferenceUpdatedEventMetadataHasBeenSet() const {
    return m_pullRequestSourceReferenceUpdatedEventMetadataHasBeenSet;
  }
  ...
  void SetPullRequestSourceReferenceUpdatedEventMetadata(PullRequestSourceReferenceUpdatedEventMetadataT&& value) {
    ...
    m_pullRequestSourceReferenceUpdatedEventMetadata = std::forward<PullRequestSourceReferenceUpdatedEventMetadataT>(value);
  }
  template <typename PullRequestSourceReferenceUpdatedEventMetadataT = PullRequestSourceReferenceUpdatedEventMetadata>
  PullRequestEvent& WithPullRequestSourceReferenceUpdatedEventMetadata(PullRequestSourceReferenceUpdatedEventMetadataT&& value) {
    SetPullRequestSourceReferenceUpdatedEventMetadata(std::forward<PullRequestSourceReferenceUpdatedEventMetadataT>(value));
    return *this;
  }
  ///@}
   ...
   * event.</p>
   */
  inline const PullRequestMergedStateChangedEventMetadata& GetPullRequestMergedStateChangedEventMetadata() const {
    return m_pullRequestMergedStateChangedEventMetadata;
  }
  inline bool PullRequestMergedStateChangedEventMetadataHasBeenSet() const {
    return m_pullRequestMergedStateChangedEventMetadataHasBeenSet;
  }
  ...
  void SetPullRequestMergedStateChangedEventMetadata(PullRequestMergedStateChangedEventMetadataT&& value) {
    ...
    m_pullRequestMergedStateChangedEventMetadata = std::forward<PullRequestMergedStateChangedEventMetadataT>(value);
  }
  template <typename PullRequestMergedStateChangedEventMetadataT = PullRequestMergedStateChangedEventMetadata>
  PullRequestEvent& WithPullRequestMergedStateChangedEventMetadata(PullRequestMergedStateChangedEventMetadataT&& value) {
    SetPullRequestMergedStateChangedEventMetadata(std::forward<PullRequestMergedStateChangedEventMetadataT>(value));
    return *this;
  }
  ///@}
  ...
  void SetApprovalRuleEventMetadata(ApprovalRuleEventMetadataT&& value) {
    ...
    m_approvalRuleEventMetadata = std::forward<ApprovalRuleEventMetadataT>(value);
  }
  template <typename ApprovalRuleEventMetadataT = ApprovalRuleEventMetadata>
  PullRequestEvent& WithApprovalRuleEventMetadata(ApprovalRuleEventMetadataT&& value) {
    SetApprovalRuleEventMetadata(std::forward<ApprovalRuleEventMetadataT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const ApprovalStateChangedEventMetadata& GetApprovalStateChangedEventMetadata() const {
    return m_approvalStateChangedEventMetadata;
  }
  ...
  void SetApprovalStateChangedEventMetadata(ApprovalStateChangedEventMetadataT&& value) {
    ...
    m_approvalStateChangedEventMetadata = std::forward<ApprovalStateChangedEventMetadataT>(value);
  }
  template <typename ApprovalStateChangedEventMetadataT = ApprovalStateChangedEventMetadata>
  PullRequestEvent& WithApprovalStateChangedEventMetadata(ApprovalStateChangedEventMetadataT&& value) {
    SetApprovalStateChangedEventMetadata(std::forward<ApprovalStateChangedEventMetadataT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const ApprovalRuleOverriddenEventMetadata& GetApprovalRuleOverriddenEventMetadata() const {
    return m_approvalRuleOverriddenEventMetadata;
  }
  ...
  void SetApprovalRuleOverriddenEventMetadata(ApprovalRuleOverriddenEventMetadataT&& value) {
    ...
    m_approvalRuleOverriddenEventMetadata = std::forward<ApprovalRuleOverriddenEventMetadataT>(value);
  }
  template <typename ApprovalRuleOverriddenEventMetadataT = ApprovalRuleOverriddenEventMetadata>
  PullRequestEvent& WithApprovalRuleOverriddenEventMetadata(ApprovalRuleOverriddenEventMetadataT&& value) {
    SetApprovalRuleOverriddenEventMetadata(std::forward<ApprovalRuleOverriddenEventMetadataT>(value));
    return *this;
  }
  ///@}
 private:
