...
class MergeBranchesByFastForwardResult {
 public:
  ...
  template <typename CommitIdT = Aws::String>
  MergeBranchesByFastForwardResult& WithCommitId(CommitIdT&& value) {
  ...
  template <typename TreeIdT = Aws::String>
  MergeBranchesByFastForwardResult& WithTreeId(TreeIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  MergeBranchesByFastForwardResult& WithRequestId(RequestIdT&& value) {
