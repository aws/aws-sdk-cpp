...
class RepositoryTrigger {
 public:
  ...
  void SetCustomData(CustomDataT&& value) {
    ...
    m_customData = std::forward<CustomDataT>(value);
  }
  template <typename CustomDataT = Aws::String>
  RepositoryTrigger& WithCustomData(CustomDataT&& value) {
    SetCustomData(std::forward<CustomDataT>(value));
    return *this;
  }
  ///@}
  ...
  inline RepositoryTrigger& AddEvents(RepositoryTriggerEventEnum value) {
    m_eventsHasBeenSet = true;
