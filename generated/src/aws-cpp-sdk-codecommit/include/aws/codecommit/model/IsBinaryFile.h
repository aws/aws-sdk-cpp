...
class IsBinaryFile {
 public:
  ...
  inline void SetSource(bool value) {
    m_sourceHasBeenSet = true;
    m_source = value;
  }
  inline IsBinaryFile& WithSource(bool value) {
    SetSource(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDestination(bool value) {
    m_destinationHasBeenSet = true;
    m_destination = value;
  }
  inline IsBinaryFile& WithDestination(bool value) {
  ...
  inline void SetBase(bool value) {
    m_baseHasBeenSet = true;
    m_base = value;
  }
  inline IsBinaryFile& WithBase(bool value) {
    SetBase(value);
    return *this;
  }
  ///@}
