...
class DescribePullRequestEventsRequest : public CodeCommitRequest {
 public:
  ...
  inline DescribePullRequestEventsRequest& WithPullRequestEventType(PullRequestEventType value) {
  ...
  inline DescribePullRequestEventsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
