...
class ApprovalStateChangedEventMetadata {
 public:
  ...
  template <typename RevisionIdT = Aws::String>
  ApprovalStateChangedEventMetadata& WithRevisionId(RevisionIdT&& value) {
  ...
  inline void SetApprovalStatus(ApprovalState value) {
    m_approvalStatusHasBeenSet = true;
    m_approvalStatus = value;
  }
  inline ApprovalStateChangedEventMetadata& WithApprovalStatus(ApprovalState value) {
