...
class ListApprovalRuleTemplatesResult {
 public:
  ...
  template <typename ApprovalRuleTemplateNamesT = Aws::Vector<Aws::String>>
  ListApprovalRuleTemplatesResult& WithApprovalRuleTemplateNames(ApprovalRuleTemplateNamesT&& value) {
  ...
  ListApprovalRuleTemplatesResult& AddApprovalRuleTemplateNames(ApprovalRuleTemplateNamesT&& value) {
    m_approvalRuleTemplateNamesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListApprovalRuleTemplatesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListApprovalRuleTemplatesResult& WithRequestId(RequestIdT&& value) {
