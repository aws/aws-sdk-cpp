...
class TestRepositoryTriggersRequest : public CodeCommitRequest {
 public:
  ...
  template <typename RepositoryNameT = Aws::String>
  TestRepositoryTriggersRequest& WithRepositoryName(RepositoryNameT&& value) {
  ...
  template <typename TriggersT = Aws::Vector<RepositoryTrigger>>
  TestRepositoryTriggersRequest& WithTriggers(TriggersT&& value) {
    SetTriggers(std::forward<TriggersT>(value));
    return *this;
  }
  template <typename TriggersT = RepositoryTrigger>
  TestRepositoryTriggersRequest& AddTriggers(TriggersT&& value) {
    m_triggersHasBeenSet = true;
