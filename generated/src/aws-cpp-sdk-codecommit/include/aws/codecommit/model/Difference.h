...
class Difference {
 public:
  ...
  void SetBeforeBlob(BeforeBlobT&& value) {
    ...
    m_beforeBlob = std::forward<BeforeBlobT>(value);
  }
  template <typename BeforeBlobT = BlobMetadata>
  Difference& WithBeforeBlob(BeforeBlobT&& value) {
    SetBeforeBlob(std::forward<BeforeBlobT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAfterBlob(AfterBlobT&& value) {
    ...
    m_afterBlob = std::forward<AfterBlobT>(value);
  }
  template <typename AfterBlobT = BlobMetadata>
  Difference& WithAfterBlob(AfterBlobT&& value) {
    SetAfterBlob(std::forward<AfterBlobT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetChangeType(ChangeTypeEnum value) {
    m_changeTypeHasBeenSet = true;
    m_changeType = value;
  }
  inline Difference& WithChangeType(ChangeTypeEnum value) {
    SetChangeType(value);
    return *this;
  }
  ///@}
