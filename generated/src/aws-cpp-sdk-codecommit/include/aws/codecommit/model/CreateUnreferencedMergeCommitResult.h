...
class CreateUnreferencedMergeCommitResult {
 public:
  AWS_CODECOMMIT_API CreateUnreferencedMergeCommitResult() = default;
  ...
  template <typename CommitIdT = Aws::String>
  CreateUnreferencedMergeCommitResult& WithCommitId(CommitIdT&& value) {
  ...
  template <typename TreeIdT = Aws::String>
  CreateUnreferencedMergeCommitResult& WithTreeId(TreeIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateUnreferencedMergeCommitResult& WithRequestId(RequestIdT&& value) {
