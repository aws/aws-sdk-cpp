...
class MergePullRequestBySquashRequest : public CodeCommitRequest {
 public:
  ...
  inline MergePullRequestBySquashRequest& WithConflictDetailLevel(ConflictDetailLevelTypeEnum value) {
  ...
  inline MergePullRequestBySquashRequest& WithConflictResolutionStrategy(ConflictResolutionStrategyTypeEnum value) {
  ...
  inline MergePullRequestBySquashRequest& WithKeepEmptyFolders(bool value) {
