...
namespace Model
{
  ...
  {
  public:
    AWS_CODECOMMIT_API DeleteCommentContentResult() = default;
    ...
    template<typename CommentT = Comment>
    DeleteCommentContentResult& WithComment(CommentT&& value) { SetComment(std::forward<CommentT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DeleteCommentContentResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
