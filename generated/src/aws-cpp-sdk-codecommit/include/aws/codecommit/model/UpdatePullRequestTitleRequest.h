...
class UpdatePullRequestTitleRequest : public CodeCommitRequest {
 public:
  AWS_CODECOMMIT_API UpdatePullRequestTitleRequest() = default;
  ...
  template <typename PullRequestIdT = Aws::String>
  UpdatePullRequestTitleRequest& WithPullRequestId(PullRequestIdT&& value) {
  ...
  template <typename TitleT = Aws::String>
  UpdatePullRequestTitleRequest& WithTitle(TitleT&& value) {
