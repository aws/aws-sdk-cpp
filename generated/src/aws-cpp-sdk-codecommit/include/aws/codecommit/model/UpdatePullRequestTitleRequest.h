...
namespace Model
{
  ...
  public:
    ...
    template<typename PullRequestIdT = Aws::String>
    UpdatePullRequestTitleRequest& WithPullRequestId(PullRequestIdT&& value) { SetPullRequestId(std::forward<PullRequestIdT>(value)); return *this;}
    ///@}
    ...
    template<typename TitleT = Aws::String>
    UpdatePullRequestTitleRequest& WithTitle(TitleT&& value) { SetTitle(std::forward<TitleT>(value)); return *this;}
    ///@}
  private:
