...
class ReactionValueFormats {
 public:
  ...
  void SetEmoji(EmojiT&& value) {
    m_emojiHasBeenSet = true;
    m_emoji = std::forward<EmojiT>(value);
  }
  template <typename EmojiT = Aws::String>
  ReactionValueFormats& WithEmoji(EmojiT&& value) {
    SetEmoji(std::forward<EmojiT>(value));
    return *this;
  }
  ///@}
  ...
  void SetShortCode(ShortCodeT&& value) {
    ...
    m_shortCode = std::forward<ShortCodeT>(value);
  }
  template <typename ShortCodeT = Aws::String>
  ReactionValueFormats& WithShortCode(ShortCodeT&& value) {
    SetShortCode(std::forward<ShortCodeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUnicode(UnicodeT&& value) {
    m_unicodeHasBeenSet = true;
    m_unicode = std::forward<UnicodeT>(value);
  }
  template <typename UnicodeT = Aws::String>
  ReactionValueFormats& WithUnicode(UnicodeT&& value) {
    SetUnicode(std::forward<UnicodeT>(value));
    return *this;
  }
  ///@}
 private:
