...
namespace Model
{
  ...
  public:
    ...
    inline MergeBranchesByThreeWayResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline MergeBranchesByThreeWayResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline MergeBranchesByThreeWayResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
