...
namespace Model
{
  ...
  {
  public:
    AWS_CODECOMMIT_API MergeBranchesByThreeWayResult() = default;
    ...
    template<typename CommitIdT = Aws::String>
    MergeBranchesByThreeWayResult& WithCommitId(CommitIdT&& value) { SetCommitId(std::forward<CommitIdT>(value)); return *this;}
    ///@}
    ...
    template<typename TreeIdT = Aws::String>
    MergeBranchesByThreeWayResult& WithTreeId(TreeIdT&& value) { SetTreeId(std::forward<TreeIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    MergeBranchesByThreeWayResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
