...
class MergeBranchesByThreeWayResult {
 public:
  ...
  template <typename CommitIdT = Aws::String>
  MergeBranchesByThreeWayResult& WithCommitId(CommitIdT&& value) {
  ...
  template <typename TreeIdT = Aws::String>
  MergeBranchesByThreeWayResult& WithTreeId(TreeIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  MergeBranchesByThreeWayResult& WithRequestId(RequestIdT&& value) {
