...
class ConflictMetadata {
 public:
  ...
  void SetFileSizes(FileSizesT&& value) {
    m_fileSizesHasBeenSet = true;
    m_fileSizes = std::forward<FileSizesT>(value);
  }
  template <typename FileSizesT = FileSizes>
  ConflictMetadata& WithFileSizes(FileSizesT&& value) {
    SetFileSizes(std::forward<FileSizesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFileModes(FileModesT&& value) {
    m_fileModesHasBeenSet = true;
    m_fileModes = std::forward<FileModesT>(value);
  }
  template <typename FileModesT = FileModes>
  ConflictMetadata& WithFileModes(FileModesT&& value) {
    SetFileModes(std::forward<FileModesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetObjectTypes(ObjectTypesT&& value) {
    ...
    m_objectTypes = std::forward<ObjectTypesT>(value);
  }
  template <typename ObjectTypesT = ObjectTypes>
  ConflictMetadata& WithObjectTypes(ObjectTypesT&& value) {
    SetObjectTypes(std::forward<ObjectTypesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetNumberOfConflicts(int value) {
    m_numberOfConflictsHasBeenSet = true;
    m_numberOfConflicts = value;
  }
  inline ConflictMetadata& WithNumberOfConflicts(int value) {
    SetNumberOfConflicts(value);
    return *this;
  }
  ///@}
  ...
  void SetIsBinaryFile(IsBinaryFileT&& value) {
    ...
    m_isBinaryFile = std::forward<IsBinaryFileT>(value);
  }
  template <typename IsBinaryFileT = IsBinaryFile>
  ConflictMetadata& WithIsBinaryFile(IsBinaryFileT&& value) {
    SetIsBinaryFile(std::forward<IsBinaryFileT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetContentConflict(bool value) {
    m_contentConflictHasBeenSet = true;
    m_contentConflict = value;
  }
  inline ConflictMetadata& WithContentConflict(bool value) {
    SetContentConflict(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFileModeConflict(bool value) {
    m_fileModeConflictHasBeenSet = true;
    m_fileModeConflict = value;
  }
  inline ConflictMetadata& WithFileModeConflict(bool value) {
    SetFileModeConflict(value);
    return *this;
  }
  ///@}
  ...
  inline void SetObjectTypeConflict(bool value) {
    m_objectTypeConflictHasBeenSet = true;
    m_objectTypeConflict = value;
  }
  inline ConflictMetadata& WithObjectTypeConflict(bool value) {
    SetObjectTypeConflict(value);
    return *this;
  }
  ///@}
  ...
  void SetMergeOperations(MergeOperationsT&& value) {
    ...
    m_mergeOperations = std::forward<MergeOperationsT>(value);
  }
  template <typename MergeOperationsT = MergeOperations>
  ConflictMetadata& WithMergeOperations(MergeOperationsT&& value) {
    SetMergeOperations(std::forward<MergeOperationsT>(value));
    return *this;
  }
  ///@}
 private:
