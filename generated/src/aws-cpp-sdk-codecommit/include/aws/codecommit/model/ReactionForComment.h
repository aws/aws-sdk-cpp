...
class ReactionForComment {
 public:
  ...
  void SetReaction(ReactionT&& value) {
    m_reactionHasBeenSet = true;
    m_reaction = std::forward<ReactionT>(value);
  }
  template <typename ReactionT = ReactionValueFormats>
  ReactionForComment& WithReaction(ReactionT&& value) {
    SetReaction(std::forward<ReactionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReactionUsers(ReactionUsersT&& value) {
    ...
    m_reactionUsers = std::forward<ReactionUsersT>(value);
  }
  template <typename ReactionUsersT = Aws::Vector<Aws::String>>
  ReactionForComment& WithReactionUsers(ReactionUsersT&& value) {
    SetReactionUsers(std::forward<ReactionUsersT>(value));
    return *this;
  }
  template <typename ReactionUsersT = Aws::String>
  ReactionForComment& AddReactionUsers(ReactionUsersT&& value) {
    m_reactionUsersHasBeenSet = true;
    m_reactionUsers.emplace_back(std::forward<ReactionUsersT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetReactionsFromDeletedUsersCount(int value) {
    m_reactionsFromDeletedUsersCountHasBeenSet = true;
    m_reactionsFromDeletedUsersCount = value;
  }
  inline ReactionForComment& WithReactionsFromDeletedUsersCount(int value) {
    SetReactionsFromDeletedUsersCount(value);
    return *this;
  }
  ///@}
 private:
