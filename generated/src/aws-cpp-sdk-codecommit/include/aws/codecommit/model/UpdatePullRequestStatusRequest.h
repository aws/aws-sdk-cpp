...
class UpdatePullRequestStatusRequest : public CodeCommitRequest {
 public:
  ...
  template <typename PullRequestIdT = Aws::String>
  UpdatePullRequestStatusRequest& WithPullRequestId(PullRequestIdT&& value) {
  ...
  inline UpdatePullRequestStatusRequest& WithPullRequestStatus(PullRequestStatusEnum value) {
