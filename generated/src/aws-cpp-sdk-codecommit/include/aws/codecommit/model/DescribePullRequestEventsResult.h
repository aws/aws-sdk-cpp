...
class DescribePullRequestEventsResult {
 public:
  ...
  void SetPullRequestEvents(PullRequestEventsT&& value) {
    m_pullRequestEventsHasBeenSet = true;
    m_pullRequestEvents = std::forward<PullRequestEventsT>(value);
  }
  template <typename PullRequestEventsT = Aws::Vector<PullRequestEvent>>
  DescribePullRequestEventsResult& WithPullRequestEvents(PullRequestEventsT&& value) {
    SetPullRequestEvents(std::forward<PullRequestEventsT>(value));
    return *this;
  }
  template <typename PullRequestEventsT = PullRequestEvent>
  DescribePullRequestEventsResult& AddPullRequestEvents(PullRequestEventsT&& value) {
    m_pullRequestEventsHasBeenSet = true;
    m_pullRequestEvents.emplace_back(std::forward<PullRequestEventsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribePullRequestEventsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribePullRequestEventsResult& WithRequestId(RequestIdT&& value) {
