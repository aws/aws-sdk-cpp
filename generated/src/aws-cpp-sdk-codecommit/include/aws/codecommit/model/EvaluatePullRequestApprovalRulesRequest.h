...
class EvaluatePullRequestApprovalRulesRequest : public CodeCommitRequest {
 public:
  ...
  template <typename PullRequestIdT = Aws::String>
  EvaluatePullRequestApprovalRulesRequest& WithPullRequestId(PullRequestIdT&& value) {
  ...
  template <typename RevisionIdT = Aws::String>
  EvaluatePullRequestApprovalRulesRequest& WithRevisionId(RevisionIdT&& value) {
