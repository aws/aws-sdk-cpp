...
class BatchDescribeMergeConflictsRequest : public CodeCommitRequest {
 public:
  ...
  inline BatchDescribeMergeConflictsRequest& WithMergeOption(MergeOptionTypeEnum value) {
  ...
  inline BatchDescribeMergeConflictsRequest& WithMaxMergeHunks(int value) {
  ...
  inline void SetMaxConflictFiles(int value) {
    m_maxConflictFilesHasBeenSet = true;
    m_maxConflictFiles = value;
  }
  inline BatchDescribeMergeConflictsRequest& WithMaxConflictFiles(int value) {
    SetMaxConflictFiles(value);
    return *this;
  }
  ///@}
  ...
  inline BatchDescribeMergeConflictsRequest& WithConflictDetailLevel(ConflictDetailLevelTypeEnum value) {
  ...
  inline BatchDescribeMergeConflictsRequest& WithConflictResolutionStrategy(ConflictResolutionStrategyTypeEnum value) {
