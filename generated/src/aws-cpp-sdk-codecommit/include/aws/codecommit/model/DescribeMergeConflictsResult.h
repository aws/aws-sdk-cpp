...
class DescribeMergeConflictsResult {
 public:
  ...
  template <typename ConflictMetadataT = ConflictMetadata>
  DescribeMergeConflictsResult& WithConflictMetadata(ConflictMetadataT&& value) {
  ...
  template <typename MergeHunksT = Aws::Vector<MergeHunk>>
  DescribeMergeConflictsResult& WithMergeHunks(MergeHunksT&& value) {
    SetMergeHunks(std::forward<MergeHunksT>(value));
    return *this;
  }
  template <typename MergeHunksT = MergeHunk>
  DescribeMergeConflictsResult& AddMergeHunks(MergeHunksT&& value) {
    m_mergeHunksHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeMergeConflictsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename DestinationCommitIdT = Aws::String>
  DescribeMergeConflictsResult& WithDestinationCommitId(DestinationCommitIdT&& value) {
  ...
  template <typename SourceCommitIdT = Aws::String>
  DescribeMergeConflictsResult& WithSourceCommitId(SourceCommitIdT&& value) {
  ...
  template <typename BaseCommitIdT = Aws::String>
  DescribeMergeConflictsResult& WithBaseCommitId(BaseCommitIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeMergeConflictsResult& WithRequestId(RequestIdT&& value) {
