...
class BatchDisassociateApprovalRuleTemplateFromRepositoriesError {
 public:
  ...
  template <typename RepositoryNameT = Aws::String>
  BatchDisassociateApprovalRuleTemplateFromRepositoriesError& WithRepositoryName(RepositoryNameT&& value) {
  ...
  template <typename ErrorCodeT = Aws::String>
  BatchDisassociateApprovalRuleTemplateFromRepositoriesError& WithErrorCode(ErrorCodeT&& value) {
  ...
  template <typename ErrorMessageT = Aws::String>
  BatchDisassociateApprovalRuleTemplateFromRepositoriesError& WithErrorMessage(ErrorMessageT&& value) {
