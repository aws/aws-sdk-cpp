...
class ApprovalRuleOverriddenEventMetadata {
 public:
  ...
  template <typename RevisionIdT = Aws::String>
  ApprovalRuleOverriddenEventMetadata& WithRevisionId(RevisionIdT&& value) {
  ...
  inline ApprovalRuleOverriddenEventMetadata& WithOverrideStatus(OverrideStatus value) {
