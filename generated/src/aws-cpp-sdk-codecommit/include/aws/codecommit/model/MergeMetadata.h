...
class MergeMetadata {
 public:
  ...
  inline void SetIsMerged(bool value) {
    m_isMergedHasBeenSet = true;
    m_isMerged = value;
  }
  inline MergeMetadata& WithIsMerged(bool value) {
    SetIsMerged(value);
    return *this;
  }
  ///@}
  ...
  void SetMergedBy(MergedByT&& value) {
    m_mergedByHasBeenSet = true;
    m_mergedBy = std::forward<MergedByT>(value);
  }
  template <typename MergedByT = Aws::String>
  MergeMetadata& WithMergedBy(MergedByT&& value) {
    SetMergedBy(std::forward<MergedByT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMergeCommitId(MergeCommitIdT&& value) {
    m_mergeCommitIdHasBeenSet = true;
    m_mergeCommitId = std::forward<MergeCommitIdT>(value);
  }
  template <typename MergeCommitIdT = Aws::String>
  MergeMetadata& WithMergeCommitId(MergeCommitIdT&& value) {
    SetMergeCommitId(std::forward<MergeCommitIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline MergeMetadata& WithMergeOption(MergeOptionTypeEnum value) {
