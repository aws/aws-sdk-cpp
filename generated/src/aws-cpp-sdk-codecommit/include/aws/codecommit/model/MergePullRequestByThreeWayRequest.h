...
class MergePullRequestByThreeWayRequest : public CodeCommitRequest {
 public:
  ...
  template <typename PullRequestIdT = Aws::String>
  MergePullRequestByThreeWayRequest& WithPullRequestId(PullRequestIdT&& value) {
  ...
  template <typename RepositoryNameT = Aws::String>
  MergePullRequestByThreeWayRequest& WithRepositoryName(RepositoryNameT&& value) {
  ...
  template <typename SourceCommitIdT = Aws::String>
  MergePullRequestByThreeWayRequest& WithSourceCommitId(SourceCommitIdT&& value) {
  ...
  inline MergePullRequestByThreeWayRequest& WithConflictDetailLevel(ConflictDetailLevelTypeEnum value) {
  ...
  inline MergePullRequestByThreeWayRequest& WithConflictResolutionStrategy(ConflictResolutionStrategyTypeEnum value) {
  ...
  template <typename CommitMessageT = Aws::String>
  MergePullRequestByThreeWayRequest& WithCommitMessage(CommitMessageT&& value) {
  ...
  template <typename AuthorNameT = Aws::String>
  MergePullRequestByThreeWayRequest& WithAuthorName(AuthorNameT&& value) {
  ...
  template <typename EmailT = Aws::String>
  MergePullRequestByThreeWayRequest& WithEmail(EmailT&& value) {
  ...
  inline MergePullRequestByThreeWayRequest& WithKeepEmptyFolders(bool value) {
  ...
  template <typename ConflictResolutionT = ConflictResolution>
  MergePullRequestByThreeWayRequest& WithConflictResolution(ConflictResolutionT&& value) {
