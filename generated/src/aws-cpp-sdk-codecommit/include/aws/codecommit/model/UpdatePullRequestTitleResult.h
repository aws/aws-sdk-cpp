...
namespace Model
{
  ...
  {
  public:
    AWS_CODECOMMIT_API UpdatePullRequestTitleResult() = default;
    ...
    template<typename PullRequestT = PullRequest>
    UpdatePullRequestTitleResult& WithPullRequest(PullRequestT&& value) { SetPullRequest(std::forward<PullRequestT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdatePullRequestTitleResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
