...
class BatchGetRepositoriesError {
 public:
  ...
  template <typename RepositoryIdT = Aws::String>
  BatchGetRepositoriesError& WithRepositoryId(RepositoryIdT&& value) {
  ...
  template <typename RepositoryNameT = Aws::String>
  BatchGetRepositoriesError& WithRepositoryName(RepositoryNameT&& value) {
  ...
  inline void SetErrorCode(BatchGetRepositoriesErrorCodeEnum value) {
    m_errorCodeHasBeenSet = true;
    m_errorCode = value;
  }
  inline BatchGetRepositoriesError& WithErrorCode(BatchGetRepositoriesErrorCodeEnum value) {
    SetErrorCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename ErrorMessageT = Aws::String>
  BatchGetRepositoriesError& WithErrorMessage(ErrorMessageT&& value) {
