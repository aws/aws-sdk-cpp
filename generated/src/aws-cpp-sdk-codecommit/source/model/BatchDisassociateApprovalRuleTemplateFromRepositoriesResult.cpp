...
BatchDisassociateApprovalRuleTemplateFromRepositoriesResult& BatchDisassociateApprovalRuleTemplateFromRepositoriesResult::operator=(
  ...
  if (jsonValue.ValueExists("disassociatedRepositoryNames")) {
    ...
    for (unsigned disassociatedRepositoryNamesIndex = 0;
         disassociatedRepositoryNamesIndex < disassociatedRepositoryNamesJsonList.GetLength(); ++disassociatedRepositoryNamesIndex) {
      m_disassociatedRepositoryNames.push_back(disassociatedRepositoryNamesJsonList[disassociatedRepositoryNamesIndex].AsString());
    }
    m_disassociatedRepositoryNamesHasBeenSet = true;
  }
