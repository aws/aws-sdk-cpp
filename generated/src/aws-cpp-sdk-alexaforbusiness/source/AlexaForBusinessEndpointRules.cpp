...
{
const size_t AlexaForBusinessEndpointRules::RulesBlobStrLen = 3712;
const size_t AlexaForBusinessEndpointRules::RulesBlobSize = 3713;
...
't','p','s',':','/','/','a','4','b','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i',
