...
{
const size_t AlexaForBusinessEndpointRules::RulesBlobStrLen = 3460;
const size_t AlexaForBusinessEndpointRules::RulesBlobSize = 3461;

using RulesBlobT = Aws::Array<const char, AlexaForBusinessEndpointRules::RulesBlobSize>;
...
'"','h','t','t','p','s',':','/','/','a','4','b','-','f','i','p','s','.','{','R','e','g','i','o','n',
...
'a','4','b','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R','e',
...
'h','t','t','p','s',':','/','/','a','4','b','.','{','R','e','g','i','o','n','}','.','{','P','a','r',
...
const char* AlexaForBusinessEndpointRules::GetRulesBlob()
{
