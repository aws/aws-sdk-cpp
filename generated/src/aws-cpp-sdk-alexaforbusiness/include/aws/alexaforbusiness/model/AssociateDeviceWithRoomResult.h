...
namespace Model
{
  ...
  public:
    ...
    inline AssociateDeviceWithRoomResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline AssociateDeviceWithRoomResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline AssociateDeviceWithRoomResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
