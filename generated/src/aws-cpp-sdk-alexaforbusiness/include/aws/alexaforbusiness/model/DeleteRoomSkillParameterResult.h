...
namespace Model
{
  ...
  public:
    ...
    inline DeleteRoomSkillParameterResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeleteRoomSkillParameterResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeleteRoomSkillParameterResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
