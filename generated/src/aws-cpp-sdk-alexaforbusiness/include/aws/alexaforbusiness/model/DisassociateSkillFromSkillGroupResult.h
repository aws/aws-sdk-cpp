...
namespace Model
{
  ...
  public:
    ...
    inline DisassociateSkillFromSkillGroupResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DisassociateSkillFromSkillGroupResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DisassociateSkillFromSkillGroupResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
