...
namespace Model
{
  ...
  public:
    ...
    inline DisassociateDeviceFromRoomResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DisassociateDeviceFromRoomResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DisassociateDeviceFromRoomResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
