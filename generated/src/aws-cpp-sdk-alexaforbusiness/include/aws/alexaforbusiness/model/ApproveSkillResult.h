...
namespace Model
{
  ...
  public:
    ...
    inline ApproveSkillResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ApproveSkillResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ApproveSkillResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
