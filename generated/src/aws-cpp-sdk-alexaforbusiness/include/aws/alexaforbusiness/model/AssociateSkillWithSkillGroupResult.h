...
namespace Model
{
  ...
  public:
    ...
    inline AssociateSkillWithSkillGroupResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline AssociateSkillWithSkillGroupResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline AssociateSkillWithSkillGroupResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
