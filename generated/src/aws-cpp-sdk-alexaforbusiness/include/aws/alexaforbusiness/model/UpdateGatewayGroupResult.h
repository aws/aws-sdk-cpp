...
namespace Model
{
  ...
  public:
    ...
    inline UpdateGatewayGroupResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateGatewayGroupResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateGatewayGroupResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
