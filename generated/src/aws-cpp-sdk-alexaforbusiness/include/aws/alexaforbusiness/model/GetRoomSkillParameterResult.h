...
namespace Model
{
  ...
  public:
    ...
    inline GetRoomSkillParameterResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline GetRoomSkillParameterResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline GetRoomSkillParameterResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
