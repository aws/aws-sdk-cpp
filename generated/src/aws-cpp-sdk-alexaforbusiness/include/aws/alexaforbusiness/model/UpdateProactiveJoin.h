...
namespace Model
{
  ...
  {
  public:
    AWS_ALEXAFORBUSINESS_API UpdateProactiveJoin();
    AWS_ALEXAFORBUSINESS_API UpdateProactiveJoin(Aws::Utils::Json::JsonView jsonValue);
    AWS_ALEXAFORBUSINESS_API UpdateProactiveJoin& operator=(Aws::Utils::Json::JsonView jsonValue);
    ...
    inline UpdateProactiveJoin& WithEnabledByMotion(bool value) { SetEnabledByMotion(value); return *this;}
