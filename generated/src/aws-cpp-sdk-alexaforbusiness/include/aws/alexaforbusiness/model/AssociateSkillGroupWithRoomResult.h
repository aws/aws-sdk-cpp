...
namespace Model
{
  ...
  public:
    ...
    inline AssociateSkillGroupWithRoomResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline AssociateSkillGroupWithRoomResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline AssociateSkillGroupWithRoomResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
