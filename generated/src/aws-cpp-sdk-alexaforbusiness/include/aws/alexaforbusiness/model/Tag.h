...
namespace Model
{
  ...
  {
  public:
    AWS_ALEXAFORBUSINESS_API Tag();
    AWS_ALEXAFORBUSINESS_API Tag(Aws::Utils::Json::JsonView jsonValue);
    AWS_ALEXAFORBUSINESS_API Tag& operator=(Aws::Utils::Json::JsonView jsonValue);
