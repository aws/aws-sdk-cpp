...
namespace Model
{
  ...
  public:
    ...
    inline ListConferenceProvidersResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ListConferenceProvidersResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ListConferenceProvidersResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
