...
namespace Model
{
  ...
  public:
    ...
    inline ForgetSmartHomeAppliancesResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ForgetSmartHomeAppliancesResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ForgetSmartHomeAppliancesResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
