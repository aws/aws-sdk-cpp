...
namespace Model
{
  ...
  /**
   */
  class SearchProfilesRequest : public AlexaForBusinessRequest
  {
  public:
    AWS_ALEXAFORBUSINESS_API SearchProfilesRequest();
     ...
     * keys are ProfileName and Address. Required. </p>
     */
    inline SearchProfilesRequest& WithFilters(const Aws::Vector<Filter>& value) { SetFilters(value); return *this;}

    /**
     * <p>The filters to use to list a specified set of room profiles. Supported filter
     * keys are ProfileName and Address. Required. </p>
     */
    inline SearchProfilesRequest& WithFilters(Aws::Vector<Filter>&& value) { SetFilters(std::move(value)); return *this;}

    /**
     * <p>The filters to use to list a specified set of room profiles. Supported filter
     * keys are ProfileName and Address. Required. </p>
     */
    inline SearchProfilesRequest& AddFilters(const Filter& value) { m_filtersHasBeenSet = true; m_filters.push_back(value); return *this; }

    /**
     * <p>The filters to use to list a specified set of room profiles. Supported filter
     * keys are ProfileName and Address. Required. </p>
     */
    inline SearchProfilesRequest& AddFilters(Filter&& value) { m_filtersHasBeenSet = true; m_filters.push_back(std::move(value)); return *this; }
     ...
     * Supported sort keys are ProfileName and Address.</p>
     */
    inline SearchProfilesRequest& WithSortCriteria(const Aws::Vector<Sort>& value) { SetSortCriteria(value); return *this;}

    /**
     * <p>The sort order to use in listing the specified set of room profiles.
     * Supported sort keys are ProfileName and Address.</p>
     */
    inline SearchProfilesRequest& WithSortCriteria(Aws::Vector<Sort>&& value) { SetSortCriteria(std::move(value)); return *this;}

    /**
     * <p>The sort order to use in listing the specified set of room profiles.
     * Supported sort keys are ProfileName and Address.</p>
     */
    inline SearchProfilesRequest& AddSortCriteria(const Sort& value) { m_sortCriteriaHasBeenSet = true; m_sortCriteria.push_back(value); return *this; }

    /**
     * <p>The sort order to use in listing the specified set of room profiles.
     * Supported sort keys are ProfileName and Address.</p>
     */
    inline SearchProfilesRequest& AddSortCriteria(Sort&& value) { m_sortCriteriaHasBeenSet = true; m_sortCriteria.push_back(std::move(value)); return *this; }
