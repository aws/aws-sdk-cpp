...
namespace Model
{
  ...
  public:
    ...
    inline AssociateContactWithAddressBookResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline AssociateContactWithAddressBookResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline AssociateContactWithAddressBookResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
