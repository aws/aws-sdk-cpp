...
namespace Model
{
  class ResolveRoomResult
  {
  public:
    AWS_ALEXAFORBUSINESS_API ResolveRoomResult();
    AWS_ALEXAFORBUSINESS_API ResolveRoomResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_ALEXAFORBUSINESS_API ResolveRoomResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ...
    inline ResolveRoomResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ResolveRoomResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ResolveRoomResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
