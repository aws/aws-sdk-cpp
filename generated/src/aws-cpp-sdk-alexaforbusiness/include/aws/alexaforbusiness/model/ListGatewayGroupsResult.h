...
namespace Model
{
  ...
  public:
    ...
    inline ListGatewayGroupsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ListGatewayGroupsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ListGatewayGroupsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
