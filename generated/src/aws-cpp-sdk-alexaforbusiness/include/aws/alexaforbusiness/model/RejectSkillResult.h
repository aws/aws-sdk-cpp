...
namespace Model
{
  ...
  public:
    ...
    inline RejectSkillResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline RejectSkillResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline RejectSkillResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
