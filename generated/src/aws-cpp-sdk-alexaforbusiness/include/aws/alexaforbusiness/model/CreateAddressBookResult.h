...
namespace Model
{
  ...
  public:
    ...
    inline CreateAddressBookResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline CreateAddressBookResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline CreateAddressBookResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
