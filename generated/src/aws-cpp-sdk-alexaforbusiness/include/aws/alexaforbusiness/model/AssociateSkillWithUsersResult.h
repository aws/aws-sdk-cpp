...
namespace Model
{
  ...
  public:
    ...
    inline AssociateSkillWithUsersResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline AssociateSkillWithUsersResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline AssociateSkillWithUsersResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
