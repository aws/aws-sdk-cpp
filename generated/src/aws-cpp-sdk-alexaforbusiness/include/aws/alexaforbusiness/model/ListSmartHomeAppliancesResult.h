...
namespace Model
{
  ...
  public:
    ...
    inline ListSmartHomeAppliancesResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ListSmartHomeAppliancesResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ListSmartHomeAppliancesResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
