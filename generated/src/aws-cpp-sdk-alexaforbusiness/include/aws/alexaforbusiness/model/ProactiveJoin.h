...
namespace Model
{
  ...
  {
  public:
    AWS_ALEXAFORBUSINESS_API ProactiveJoin();
    AWS_ALEXAFORBUSINESS_API ProactiveJoin(Aws::Utils::Json::JsonView jsonValue);
    AWS_ALEXAFORBUSINESS_API ProactiveJoin& operator=(Aws::Utils::Json::JsonView jsonValue);
    ...
    inline ProactiveJoin& WithEnabledByMotion(bool value) { SetEnabledByMotion(value); return *this;}
