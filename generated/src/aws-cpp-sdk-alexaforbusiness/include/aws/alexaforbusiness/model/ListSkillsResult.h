...
namespace Model
{
  ...
  public:
    ...
    inline ListSkillsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ListSkillsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ListSkillsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
