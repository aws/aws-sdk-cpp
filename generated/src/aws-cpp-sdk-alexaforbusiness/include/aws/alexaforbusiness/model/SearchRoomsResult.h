...
namespace Model
{
  ...
  public:
    ...
    inline SearchRoomsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline SearchRoomsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline SearchRoomsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
