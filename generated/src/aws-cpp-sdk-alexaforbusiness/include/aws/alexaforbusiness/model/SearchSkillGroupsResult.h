...
namespace Model
{
  ...
  public:
    ...
    inline SearchSkillGroupsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline SearchSkillGroupsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline SearchSkillGroupsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
