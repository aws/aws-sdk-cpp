...
namespace Model
{
  ...
  public:
    ...
    inline ListBusinessReportSchedulesResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ListBusinessReportSchedulesResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ListBusinessReportSchedulesResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
