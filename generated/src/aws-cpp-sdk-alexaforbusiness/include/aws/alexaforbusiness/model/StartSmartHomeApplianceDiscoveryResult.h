...
namespace Model
{
  ...
  public:
    ...
    inline StartSmartHomeApplianceDiscoveryResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline StartSmartHomeApplianceDiscoveryResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline StartSmartHomeApplianceDiscoveryResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
