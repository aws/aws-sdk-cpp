...
namespace Model
{
  ...
  public:
    ...
    inline StartDeviceSyncResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline StartDeviceSyncResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline StartDeviceSyncResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
