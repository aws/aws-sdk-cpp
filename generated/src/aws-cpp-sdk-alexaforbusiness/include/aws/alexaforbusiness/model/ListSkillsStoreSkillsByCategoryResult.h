...
namespace Model
{
  ...
  public:
    ...
    inline ListSkillsStoreSkillsByCategoryResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ListSkillsStoreSkillsByCategoryResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ListSkillsStoreSkillsByCategoryResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
