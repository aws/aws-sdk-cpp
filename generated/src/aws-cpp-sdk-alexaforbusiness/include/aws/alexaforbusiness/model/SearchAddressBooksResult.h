...
namespace Model
{
  ...
  public:
    ...
    inline SearchAddressBooksResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline SearchAddressBooksResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline SearchAddressBooksResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
