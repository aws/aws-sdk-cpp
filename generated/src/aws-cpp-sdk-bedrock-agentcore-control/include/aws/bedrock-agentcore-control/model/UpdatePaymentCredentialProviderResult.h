...
namespace Model {
class UpdatePaymentCredentialProviderResult {
 public:
  AWS_BEDROCKAGENTCORECONTROL_API UpdatePaymentCredentialProviderResult() = default;
  AWS_BEDROCKAGENTCORECONTROL_API UpdatePaymentCredentialProviderResult(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_BEDROCKAGENTCORECONTROL_API UpdatePaymentCredentialProviderResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename NameT = Aws::String>
  UpdatePaymentCredentialProviderResult& WithName(NameT&& value) {
  ...
  inline UpdatePaymentCredentialProviderResult& WithCredentialProviderVendor(PaymentCredentialProviderVendorType value) {
  ...
  ///@{
  /**
   * <p>The Amazon Resource Name (ARN) of the updated payment credential
   * provider.</p>
   */
  ...
  template <typename CredentialProviderArnT = Aws::String>
  UpdatePaymentCredentialProviderResult& WithCredentialProviderArn(CredentialProviderArnT&& value) {
  ...
  template <typename ProviderConfigurationOutputT = PaymentProviderConfigurationOutput>
  UpdatePaymentCredentialProviderResult& WithProviderConfigurationOutput(ProviderConfigurationOutputT&& value) {
  ...
  template <typename CreatedTimeT = Aws::Utils::DateTime>
  UpdatePaymentCredentialProviderResult& WithCreatedTime(CreatedTimeT&& value) {
  ...
  template <typename LastUpdatedTimeT = Aws::Utils::DateTime>
  UpdatePaymentCredentialProviderResult& WithLastUpdatedTime(LastUpdatedTimeT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdatePaymentCredentialProviderResult& WithRequestId(RequestIdT&& value) {
