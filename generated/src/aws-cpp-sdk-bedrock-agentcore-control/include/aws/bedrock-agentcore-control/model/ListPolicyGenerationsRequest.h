...
/**
 */
class ListPolicyGenerationsRequest : public BedrockAgentCoreControlRequest {
 public:
  AWS_BEDROCKAGENTCORECONTROL_API ListPolicyGenerationsRequest() = default;
  ...
  ///@{
  /**
   * <p>A pagination token for retrieving additional policy generations when results
   * are paginated.</p>
   */
  ...
  template <typename PolicyEngineIdT = Aws::String>
  ListPolicyGenerationsRequest& WithPolicyEngineId(PolicyEngineIdT&& value) {
