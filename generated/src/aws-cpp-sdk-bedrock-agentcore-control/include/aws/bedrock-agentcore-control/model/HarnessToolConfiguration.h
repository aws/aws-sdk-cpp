 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/bedrock-agentcore-control-2023-06-05/HarnessToolConfiguration">AWS
 * API Reference</a></p>
 */
class HarnessToolConfiguration {
 public:
  AWS_BEDROCKAGENTCORECONTROL_API HarnessToolConfiguration() = default;
  AWS_BEDROCKAGENTCORECONTROL_API HarnessToolConfiguration(Aws::Utils::Json::JsonView jsonValue);
  AWS_BEDROCKAGENTCORECONTROL_API HarnessToolConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
