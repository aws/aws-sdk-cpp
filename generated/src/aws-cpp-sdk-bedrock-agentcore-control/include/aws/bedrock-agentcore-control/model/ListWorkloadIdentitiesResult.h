...
class ListWorkloadIdentitiesResult {
 public:
  ...
  AWS_BEDROCKAGENTCORECONTROL_API ListWorkloadIdentitiesResult& operator=(
  ...
  template <typename WorkloadIdentitiesT = Aws::Vector<WorkloadIdentityType>>
  ListWorkloadIdentitiesResult& WithWorkloadIdentities(WorkloadIdentitiesT&& value) {
    SetWorkloadIdentities(std::forward<WorkloadIdentitiesT>(value));
    return *this;
  }
  template <typename WorkloadIdentitiesT = WorkloadIdentityType>
  ListWorkloadIdentitiesResult& AddWorkloadIdentities(WorkloadIdentitiesT&& value) {
    m_workloadIdentitiesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListWorkloadIdentitiesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListWorkloadIdentitiesResult& WithRequestId(RequestIdT&& value) {
