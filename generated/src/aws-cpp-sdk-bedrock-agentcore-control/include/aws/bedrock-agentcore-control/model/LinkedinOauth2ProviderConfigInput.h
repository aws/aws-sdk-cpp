...
class LinkedinOauth2ProviderConfigInput {
 public:
  ...
  template <typename ClientSecretConfigT = SecretReference>
  LinkedinOauth2ProviderConfigInput& WithClientSecretConfig(ClientSecretConfigT&& value) {
  ...
  inline LinkedinOauth2ProviderConfigInput& WithClientSecretSource(SecretSourceType value) {
