...
namespace Model
{
  ...
  public:
    ...
    template<typename ClientIdT = Aws::String>
    SalesforceOauth2ProviderConfigInput& WithClientId(ClientIdT&& value) { SetClientId(std::forward<ClientIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ClientSecretT = Aws::String>
    SalesforceOauth2ProviderConfigInput& WithClientSecret(ClientSecretT&& value) { SetClientSecret(std::forward<ClientSecretT>(value)); return *this;}
    ///@}
  private:
