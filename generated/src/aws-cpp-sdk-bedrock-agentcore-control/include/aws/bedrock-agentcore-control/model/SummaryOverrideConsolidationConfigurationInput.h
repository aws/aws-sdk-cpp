...
class SummaryOverrideConsolidationConfigurationInput {
 public:
  ...
  template <typename AppendToPromptT = Aws::String>
  SummaryOverrideConsolidationConfigurationInput& WithAppendToPrompt(AppendToPromptT&& value) {
  ...
  template <typename ModelIdT = Aws::String>
  SummaryOverrideConsolidationConfigurationInput& WithModelId(ModelIdT&& value) {
