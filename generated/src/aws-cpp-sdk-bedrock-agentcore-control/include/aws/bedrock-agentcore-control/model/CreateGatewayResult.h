...
class CreateGatewayResult {
 public:
  ...
  template <typename GatewayUrlT = Aws::String>
  CreateGatewayResult& WithGatewayUrl(GatewayUrlT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  CreateGatewayResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  CreateGatewayResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  inline CreateGatewayResult& WithStatus(GatewayStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonsT = Aws::Vector<Aws::String>>
  CreateGatewayResult& WithStatusReasons(StatusReasonsT&& value) {
    SetStatusReasons(std::forward<StatusReasonsT>(value));
    return *this;
  }
  template <typename StatusReasonsT = Aws::String>
  CreateGatewayResult& AddStatusReasons(StatusReasonsT&& value) {
    m_statusReasonsHasBeenSet = true;
  ...
  template <typename NameT = Aws::String>
  CreateGatewayResult& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateGatewayResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename RoleArnT = Aws::String>
  CreateGatewayResult& WithRoleArn(RoleArnT&& value) {
  ...
  inline CreateGatewayResult& WithProtocolType(GatewayProtocolType value) {
  ...
  template <typename ProtocolConfigurationT = GatewayProtocolConfiguration>
  CreateGatewayResult& WithProtocolConfiguration(ProtocolConfigurationT&& value) {
  ...
  inline CreateGatewayResult& WithAuthorizerType(AuthorizerType value) {
  ...
  template <typename AuthorizerConfigurationT = AuthorizerConfiguration>
  CreateGatewayResult& WithAuthorizerConfiguration(AuthorizerConfigurationT&& value) {
  ...
  template <typename KmsKeyArnT = Aws::String>
  CreateGatewayResult& WithKmsKeyArn(KmsKeyArnT&& value) {
  ...
  template <typename CustomTransformConfigurationT = CustomTransformConfiguration>
  CreateGatewayResult& WithCustomTransformConfiguration(CustomTransformConfigurationT&& value) {
  ...
  template <typename PolicyEngineConfigurationT = GatewayPolicyEngineConfiguration>
  CreateGatewayResult& WithPolicyEngineConfiguration(PolicyEngineConfigurationT&& value) {
  ...
  template <typename WorkloadIdentityDetailsT = WorkloadIdentityDetails>
  CreateGatewayResult& WithWorkloadIdentityDetails(WorkloadIdentityDetailsT&& value) {
  ...
  inline CreateGatewayResult& WithExceptionLevel(ExceptionLevel value) {
  ...
  template <typename WebAclArnT = Aws::String>
  CreateGatewayResult& WithWebAclArn(WebAclArnT&& value) {
  ...
  template <typename WafConfigurationT = WafConfiguration>
  CreateGatewayResult& WithWafConfiguration(WafConfigurationT&& value) {
