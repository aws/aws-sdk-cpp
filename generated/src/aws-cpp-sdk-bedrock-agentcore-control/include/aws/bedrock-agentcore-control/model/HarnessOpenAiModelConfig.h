 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/bedrock-agentcore-control-2023-06-05/HarnessOpenAiModelConfig">AWS
 * API Reference</a></p>
 */
class HarnessOpenAiModelConfig {
 public:
  AWS_BEDROCKAGENTCORECONTROL_API HarnessOpenAiModelConfig() = default;
  AWS_BEDROCKAGENTCORECONTROL_API HarnessOpenAiModelConfig(Aws::Utils::Json::JsonView jsonValue);
  AWS_BEDROCKAGENTCORECONTROL_API HarnessOpenAiModelConfig& operator=(Aws::Utils::Json::JsonView jsonValue);
