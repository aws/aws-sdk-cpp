...
class ApiKeyCredentialProviderItem {
 public:
  ...
  template <typename NameT = Aws::String>
  ApiKeyCredentialProviderItem& WithName(NameT&& value) {
  ...
  template <typename CredentialProviderArnT = Aws::String>
  ApiKeyCredentialProviderItem& WithCredentialProviderArn(CredentialProviderArnT&& value) {
  ...
  template <typename CreatedTimeT = Aws::Utils::DateTime>
  ApiKeyCredentialProviderItem& WithCreatedTime(CreatedTimeT&& value) {
  ...
  template <typename LastUpdatedTimeT = Aws::Utils::DateTime>
  ApiKeyCredentialProviderItem& WithLastUpdatedTime(LastUpdatedTimeT&& value) {
