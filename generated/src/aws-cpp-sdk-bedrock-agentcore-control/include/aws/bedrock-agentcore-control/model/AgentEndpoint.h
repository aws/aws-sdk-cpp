...
namespace Model
{
   ...
   * <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/bedrock-agentcore-control-2023-06-05/AgentEndpoint">AWS
   * API Reference</a></p>
   */
  class AgentEndpoint
  {
  public:
    AWS_BEDROCKAGENTCORECONTROL_API AgentEndpoint() = default;
    AWS_BEDROCKAGENTCORECONTROL_API AgentEndpoint(Aws::Utils::Json::JsonView jsonValue);
    AWS_BEDROCKAGENTCORECONTROL_API AgentEndpoint& operator=(Aws::Utils::Json::JsonView jsonValue);
    ...
    template<typename NameT = Aws::String>
    AgentEndpoint& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename LiveVersionT = Aws::String>
    AgentEndpoint& WithLiveVersion(LiveVersionT&& value) { SetLiveVersion(std::forward<LiveVersionT>(value)); return *this;}
    ///@}
    ...
    template<typename TargetVersionT = Aws::String>
    AgentEndpoint& WithTargetVersion(TargetVersionT&& value) { SetTargetVersion(std::forward<TargetVersionT>(value)); return *this;}
    ///@}
    ...
    template<typename AgentRuntimeEndpointArnT = Aws::String>
    AgentEndpoint& WithAgentRuntimeEndpointArn(AgentRuntimeEndpointArnT&& value) { SetAgentRuntimeEndpointArn(std::forward<AgentRuntimeEndpointArnT>(value)); return *this;}
    ///@}
    ...
    template<typename AgentRuntimeArnT = Aws::String>
    AgentEndpoint& WithAgentRuntimeArn(AgentRuntimeArnT&& value) { SetAgentRuntimeArn(std::forward<AgentRuntimeArnT>(value)); return *this;}
    ///@}
    ...
    inline AgentEndpoint& WithStatus(AgentEndpointStatus value) { SetStatus(value); return *this;}
    ///@}
    ...
    template<typename IdT = Aws::String>
    AgentEndpoint& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    AgentEndpoint& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename CreatedAtT = Aws::Utils::DateTime>
    AgentEndpoint& WithCreatedAt(CreatedAtT&& value) { SetCreatedAt(std::forward<CreatedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename LastUpdatedAtT = Aws::Utils::DateTime>
    AgentEndpoint& WithLastUpdatedAt(LastUpdatedAtT&& value) { SetLastUpdatedAt(std::forward<LastUpdatedAtT>(value)); return *this;}
    ///@}
  private:
