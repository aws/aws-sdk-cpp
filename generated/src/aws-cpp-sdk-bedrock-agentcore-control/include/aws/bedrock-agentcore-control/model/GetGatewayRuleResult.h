 ...
 * <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/bedrock-agentcore-control-2023-06-05/GetGatewayRuleResponse">AWS
 * API Reference</a></p>
 */
class GetGatewayRuleResult {
 public:
  AWS_BEDROCKAGENTCORECONTROL_API GetGatewayRuleResult() = default;
  AWS_BEDROCKAGENTCORECONTROL_API GetGatewayRuleResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_BEDROCKAGENTCORECONTROL_API GetGatewayRuleResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename RuleIdT = Aws::String>
  GetGatewayRuleResult& WithRuleId(RuleIdT&& value) {
  ...
  template <typename GatewayArnT = Aws::String>
  GetGatewayRuleResult& WithGatewayArn(GatewayArnT&& value) {
  ...
  inline GetGatewayRuleResult& WithPriority(int value) {
    SetPriority(value);
    return *this;
  }
  ///@}
  ...
  template <typename ConditionsT = Aws::Vector<Condition>>
  GetGatewayRuleResult& WithConditions(ConditionsT&& value) {
    SetConditions(std::forward<ConditionsT>(value));
    return *this;
  }
  template <typename ConditionsT = Condition>
  GetGatewayRuleResult& AddConditions(ConditionsT&& value) {
    m_conditionsHasBeenSet = true;
  ...
  template <typename ActionsT = Aws::Vector<Action>>
  GetGatewayRuleResult& WithActions(ActionsT&& value) {
    SetActions(std::forward<ActionsT>(value));
    return *this;
  }
  template <typename ActionsT = Action>
  GetGatewayRuleResult& AddActions(ActionsT&& value) {
    m_actionsHasBeenSet = true;
  ...
  template <typename DescriptionT = Aws::String>
  GetGatewayRuleResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  GetGatewayRuleResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  inline GetGatewayRuleResult& WithStatus(GatewayRuleStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename SystemT = SystemManagedBlock>
  GetGatewayRuleResult& WithSystem(SystemT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  GetGatewayRuleResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetGatewayRuleResult& WithRequestId(RequestIdT&& value) {
