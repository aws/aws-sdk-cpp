...
class CreateApiKeyCredentialProviderResult {
 public:
  ...
  AWS_BEDROCKAGENTCORECONTROL_API CreateApiKeyCredentialProviderResult(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_BEDROCKAGENTCORECONTROL_API CreateApiKeyCredentialProviderResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ApiKeySecretArnT = Secret>
  CreateApiKeyCredentialProviderResult& WithApiKeySecretArn(ApiKeySecretArnT&& value) {
  ...
  template <typename ApiKeySecretJsonKeyT = Aws::String>
  CreateApiKeyCredentialProviderResult& WithApiKeySecretJsonKey(ApiKeySecretJsonKeyT&& value) {
  ...
  inline CreateApiKeyCredentialProviderResult& WithApiKeySecretSource(SecretSourceType value) {
  ...
  template <typename NameT = Aws::String>
  CreateApiKeyCredentialProviderResult& WithName(NameT&& value) {
  ...
  template <typename CredentialProviderArnT = Aws::String>
  CreateApiKeyCredentialProviderResult& WithCredentialProviderArn(CredentialProviderArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateApiKeyCredentialProviderResult& WithRequestId(RequestIdT&& value) {
