...
namespace Model
{
  ...
  public:
    ...
    void SetMemories(MemoriesT&& value) { m_memoriesHasBeenSet = true; m_memories = std::forward<MemoriesT>(value); }
    template<typename MemoriesT = Aws::Vector<MemorySummary>>
    ListMemoriesResult& WithMemories(MemoriesT&& value) { SetMemories(std::forward<MemoriesT>(value)); return *this;}
    template<typename MemoriesT = MemorySummary>
    ListMemoriesResult& AddMemories(MemoriesT&& value) { m_memoriesHasBeenSet = true; m_memories.emplace_back(std::forward<MemoriesT>(value)); return *this; }
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListMemoriesResult& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ListMemoriesResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
