...
/**
 * <p>Input configuration for a Slack OAuth2 provider.</p><p><h3>See Also:</h3>
 * <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/bedrock-agentcore-control-2023-06-05/SlackOauth2ProviderConfigInput">AWS
 * API Reference</a></p>
 */
class SlackOauth2ProviderConfigInput {
 public:
  AWS_BEDROCKAGENTCORECONTROL_API SlackOauth2ProviderConfigInput() = default;
  AWS_BEDROCKAGENTCORECONTROL_API SlackOauth2ProviderConfigInput(Aws::Utils::Json::JsonView jsonValue);
  AWS_BEDROCKAGENTCORECONTROL_API SlackOauth2ProviderConfigInput& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename ClientIdT = Aws::String>
  SlackOauth2ProviderConfigInput& WithClientId(ClientIdT&& value) {
  ...
  template <typename ClientSecretT = Aws::String>
  SlackOauth2ProviderConfigInput& WithClientSecret(ClientSecretT&& value) {
  ...
  template <typename ClientSecretConfigT = SecretReference>
  SlackOauth2ProviderConfigInput& WithClientSecretConfig(ClientSecretConfigT&& value) {
  ...
  inline SlackOauth2ProviderConfigInput& WithClientSecretSource(SecretSourceType value) {
