...
/**
 */
class GetDatasetRequest : public BedrockAgentCoreControlRequest {
 public:
  AWS_BEDROCKAGENTCORECONTROL_API GetDatasetRequest() = default;
  ...
  template <typename DatasetVersionT = Aws::String>
  GetDatasetRequest& WithDatasetVersion(DatasetVersionT&& value) {
