...
/**
 * <p>Input configuration for a Google OAuth2 provider.</p><p><h3>See Also:</h3>
 * <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/bedrock-agentcore-control-2023-06-05/GoogleOauth2ProviderConfigInput">AWS
 * API Reference</a></p>
 */
class GoogleOauth2ProviderConfigInput {
 public:
  AWS_BEDROCKAGENTCORECONTROL_API GoogleOauth2ProviderConfigInput() = default;
  AWS_BEDROCKAGENTCORECONTROL_API GoogleOauth2ProviderConfigInput(Aws::Utils::Json::JsonView jsonValue);
  AWS_BEDROCKAGENTCORECONTROL_API GoogleOauth2ProviderConfigInput& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename ClientIdT = Aws::String>
  GoogleOauth2ProviderConfigInput& WithClientId(ClientIdT&& value) {
  ...
  template <typename ClientSecretT = Aws::String>
  GoogleOauth2ProviderConfigInput& WithClientSecret(ClientSecretT&& value) {
  ...
  template <typename ClientSecretConfigT = SecretReference>
  GoogleOauth2ProviderConfigInput& WithClientSecretConfig(ClientSecretConfigT&& value) {
  ...
  inline GoogleOauth2ProviderConfigInput& WithClientSecretSource(SecretSourceType value) {
