...
class CreateAgentRuntimeResult {
 public:
  ...
  AWS_BEDROCKAGENTCORECONTROL_API CreateAgentRuntimeResult& operator=(
  ...
  template <typename AgentRuntimeArnT = Aws::String>
  CreateAgentRuntimeResult& WithAgentRuntimeArn(AgentRuntimeArnT&& value) {
  ...
  template <typename WorkloadIdentityDetailsT = WorkloadIdentityDetails>
  CreateAgentRuntimeResult& WithWorkloadIdentityDetails(WorkloadIdentityDetailsT&& value) {
  ...
  template <typename AgentRuntimeIdT = Aws::String>
  CreateAgentRuntimeResult& WithAgentRuntimeId(AgentRuntimeIdT&& value) {
  ...
  template <typename AgentRuntimeVersionT = Aws::String>
  CreateAgentRuntimeResult& WithAgentRuntimeVersion(AgentRuntimeVersionT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  CreateAgentRuntimeResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  inline CreateAgentRuntimeResult& WithStatus(AgentRuntimeStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  CreateAgentRuntimeResult& WithRequestId(RequestIdT&& value) {
