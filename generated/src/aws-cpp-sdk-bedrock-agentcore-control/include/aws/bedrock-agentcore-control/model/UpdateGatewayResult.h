...
namespace Model
{
  ...
  {
  public:
    AWS_BEDROCKAGENTCORECONTROL_API UpdateGatewayResult() = default;
    AWS_BEDROCKAGENTCORECONTROL_API UpdateGatewayResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_BEDROCKAGENTCORECONTROL_API UpdateGatewayResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ...
    template<typename GatewayArnT = Aws::String>
    UpdateGatewayResult& WithGatewayArn(GatewayArnT&& value) { SetGatewayArn(std::forward<GatewayArnT>(value)); return *this;}
    ///@}
    ...
    template<typename GatewayIdT = Aws::String>
    UpdateGatewayResult& WithGatewayId(GatewayIdT&& value) { SetGatewayId(std::forward<GatewayIdT>(value)); return *this;}
    ///@}
    ...
    template<typename GatewayUrlT = Aws::String>
    UpdateGatewayResult& WithGatewayUrl(GatewayUrlT&& value) { SetGatewayUrl(std::forward<GatewayUrlT>(value)); return *this;}
    ///@}
    ...
    template<typename CreatedAtT = Aws::Utils::DateTime>
    UpdateGatewayResult& WithCreatedAt(CreatedAtT&& value) { SetCreatedAt(std::forward<CreatedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename UpdatedAtT = Aws::Utils::DateTime>
    UpdateGatewayResult& WithUpdatedAt(UpdatedAtT&& value) { SetUpdatedAt(std::forward<UpdatedAtT>(value)); return *this;}
    ///@}
    ...
    inline UpdateGatewayResult& WithStatus(GatewayStatus value) { SetStatus(value); return *this;}
    ///@}
    ...
    template<typename StatusReasonsT = Aws::Vector<Aws::String>>
    UpdateGatewayResult& WithStatusReasons(StatusReasonsT&& value) { SetStatusReasons(std::forward<StatusReasonsT>(value)); return *this;}
    template<typename StatusReasonsT = Aws::String>
    UpdateGatewayResult& AddStatusReasons(StatusReasonsT&& value) { m_statusReasonsHasBeenSet = true; m_statusReasons.emplace_back(std::forward<StatusReasonsT>(value)); return *this; }
    ///@}
    ...
    template<typename NameT = Aws::String>
    UpdateGatewayResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    UpdateGatewayResult& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename RoleArnT = Aws::String>
    UpdateGatewayResult& WithRoleArn(RoleArnT&& value) { SetRoleArn(std::forward<RoleArnT>(value)); return *this;}
    ///@}
    ...
    inline UpdateGatewayResult& WithProtocolType(GatewayProtocolType value) { SetProtocolType(value); return *this;}
    ///@}
    ...
    template<typename ProtocolConfigurationT = GatewayProtocolConfiguration>
    UpdateGatewayResult& WithProtocolConfiguration(ProtocolConfigurationT&& value) { SetProtocolConfiguration(std::forward<ProtocolConfigurationT>(value)); return *this;}
    ///@}
    ...
    inline UpdateGatewayResult& WithAuthorizerType(AuthorizerType value) { SetAuthorizerType(value); return *this;}
    ///@}
    ...
    template<typename AuthorizerConfigurationT = AuthorizerConfiguration>
    UpdateGatewayResult& WithAuthorizerConfiguration(AuthorizerConfigurationT&& value) { SetAuthorizerConfiguration(std::forward<AuthorizerConfigurationT>(value)); return *this;}
    ///@}
    ...
    template<typename KmsKeyArnT = Aws::String>
    UpdateGatewayResult& WithKmsKeyArn(KmsKeyArnT&& value) { SetKmsKeyArn(std::forward<KmsKeyArnT>(value)); return *this;}
    ///@}
    ...
    template<typename WorkloadIdentityDetailsT = WorkloadIdentityDetails>
    UpdateGatewayResult& WithWorkloadIdentityDetails(WorkloadIdentityDetailsT&& value) { SetWorkloadIdentityDetails(std::forward<WorkloadIdentityDetailsT>(value)); return *this;}
    ///@}
    ...
    inline UpdateGatewayResult& WithExceptionLevel(ExceptionLevel value) { SetExceptionLevel(value); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateGatewayResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
