...
class UpdateGatewayResult {
 public:
  ...
  template <typename GatewayArnT = Aws::String>
  UpdateGatewayResult& WithGatewayArn(GatewayArnT&& value) {
  ...
  template <typename GatewayIdT = Aws::String>
  UpdateGatewayResult& WithGatewayId(GatewayIdT&& value) {
  ...
  template <typename GatewayUrlT = Aws::String>
  UpdateGatewayResult& WithGatewayUrl(GatewayUrlT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  UpdateGatewayResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  UpdateGatewayResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  inline UpdateGatewayResult& WithStatus(GatewayStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonsT = Aws::Vector<Aws::String>>
  UpdateGatewayResult& WithStatusReasons(StatusReasonsT&& value) {
    SetStatusReasons(std::forward<StatusReasonsT>(value));
    return *this;
  }
  template <typename StatusReasonsT = Aws::String>
  UpdateGatewayResult& AddStatusReasons(StatusReasonsT&& value) {
    m_statusReasonsHasBeenSet = true;
  ...
  template <typename NameT = Aws::String>
  UpdateGatewayResult& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateGatewayResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename RoleArnT = Aws::String>
  UpdateGatewayResult& WithRoleArn(RoleArnT&& value) {
  ...
  inline UpdateGatewayResult& WithProtocolType(GatewayProtocolType value) {
  ...
  template <typename ProtocolConfigurationT = GatewayProtocolConfiguration>
  UpdateGatewayResult& WithProtocolConfiguration(ProtocolConfigurationT&& value) {
  ...
  inline UpdateGatewayResult& WithAuthorizerType(AuthorizerType value) {
  ...
  template <typename AuthorizerConfigurationT = AuthorizerConfiguration>
  UpdateGatewayResult& WithAuthorizerConfiguration(AuthorizerConfigurationT&& value) {
  ...
  template <typename KmsKeyArnT = Aws::String>
  UpdateGatewayResult& WithKmsKeyArn(KmsKeyArnT&& value) {
  ...
  template <typename InterceptorConfigurationsT = Aws::Vector<GatewayInterceptorConfiguration>>
  UpdateGatewayResult& WithInterceptorConfigurations(InterceptorConfigurationsT&& value) {
  ...
  UpdateGatewayResult& AddInterceptorConfigurations(InterceptorConfigurationsT&& value) {
    m_interceptorConfigurationsHasBeenSet = true;
  ...
  template <typename PolicyEngineConfigurationT = GatewayPolicyEngineConfiguration>
  UpdateGatewayResult& WithPolicyEngineConfiguration(PolicyEngineConfigurationT&& value) {
  ...
  template <typename WorkloadIdentityDetailsT = WorkloadIdentityDetails>
  UpdateGatewayResult& WithWorkloadIdentityDetails(WorkloadIdentityDetailsT&& value) {
  ...
  inline UpdateGatewayResult& WithExceptionLevel(ExceptionLevel value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateGatewayResult& WithRequestId(RequestIdT&& value) {
