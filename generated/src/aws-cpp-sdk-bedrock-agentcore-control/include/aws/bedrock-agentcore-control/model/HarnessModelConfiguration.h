 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/bedrock-agentcore-control-2023-06-05/HarnessModelConfiguration">AWS
 * API Reference</a></p>
 */
class HarnessModelConfiguration {
 public:
  AWS_BEDROCKAGENTCORECONTROL_API HarnessModelConfiguration() = default;
  AWS_BEDROCKAGENTCORECONTROL_API HarnessModelConfiguration(Aws::Utils::Json::JsonView jsonValue);
  AWS_BEDROCKAGENTCORECONTROL_API HarnessModelConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
