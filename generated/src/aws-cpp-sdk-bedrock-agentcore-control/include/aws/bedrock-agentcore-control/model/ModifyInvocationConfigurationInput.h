...
namespace Model
{
  ...
  public:
    ...
    template<typename TopicArnT = Aws::String>
    ModifyInvocationConfigurationInput& WithTopicArn(TopicArnT&& value) { SetTopicArn(std::forward<TopicArnT>(value)); return *this;}
    ///@}
    ...
    template<typename PayloadDeliveryBucketNameT = Aws::String>
    ModifyInvocationConfigurationInput& WithPayloadDeliveryBucketName(PayloadDeliveryBucketNameT&& value) { SetPayloadDeliveryBucketName(std::forward<PayloadDeliveryBucketNameT>(value)); return *this;}
    ///@}
  private:
