...
class UpdateRegistryRecordResult {
 public:
  AWS_BEDROCKAGENTCORECONTROL_API UpdateRegistryRecordResult() = default;
  AWS_BEDROCKAGENTCORECONTROL_API UpdateRegistryRecordResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_BEDROCKAGENTCORECONTROL_API UpdateRegistryRecordResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);

  ///@{
  /**
   * <p>The Amazon Resource Name (ARN) of the registry that contains the updated
   * record.</p>
   */
  ...
  ///@{
  /**
   * <p>The descriptor type of the updated registry record. Possible values are
  ...
  inline UpdateRegistryRecordResult& WithDescriptorType(DescriptorType value) {
  ...
  ///@{
  /**
   * <p>The descriptor-type-specific configuration of the updated registry record.
   * For details, see the <code>Descriptors</code> data type.</p>
   */
  ...
  ///@{
  /**
   * <p>The current status of the updated registry record. Possible values include
  ...
  inline UpdateRegistryRecordResult& WithSynchronizationType(SynchronizationType value) {
  ...
  template <typename SynchronizationConfigurationT = SynchronizationConfiguration>
  UpdateRegistryRecordResult& WithSynchronizationConfiguration(SynchronizationConfigurationT&& value) {
