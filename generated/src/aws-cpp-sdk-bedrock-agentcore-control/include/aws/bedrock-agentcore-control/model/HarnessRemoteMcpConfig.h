 ...
 * <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/bedrock-agentcore-control-2023-06-05/HarnessRemoteMcpConfig">AWS
 * API Reference</a></p>
 */
class HarnessRemoteMcpConfig {
 public:
  AWS_BEDROCKAGENTCORECONTROL_API HarnessRemoteMcpConfig() = default;
  AWS_BEDROCKAGENTCORECONTROL_API HarnessRemoteMcpConfig(Aws::Utils::Json::JsonView jsonValue);
  AWS_BEDROCKAGENTCORECONTROL_API HarnessRemoteMcpConfig& operator=(Aws::Utils::Json::JsonView jsonValue);
