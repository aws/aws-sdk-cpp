...
namespace Model
{
  ...
  public:
    ...
    template<typename AgentRuntimeIdT = Aws::String>
    DeleteAgentRuntimeEndpointResult& WithAgentRuntimeId(AgentRuntimeIdT&& value) { SetAgentRuntimeId(std::forward<AgentRuntimeIdT>(value)); return *this;}
    ///@}
    ...
    template<typename EndpointNameT = Aws::String>
    DeleteAgentRuntimeEndpointResult& WithEndpointName(EndpointNameT&& value) { SetEndpointName(std::forward<EndpointNameT>(value)); return *this;}
    ///@}
