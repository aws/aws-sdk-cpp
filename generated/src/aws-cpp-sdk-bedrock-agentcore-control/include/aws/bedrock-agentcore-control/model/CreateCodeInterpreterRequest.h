...
class CreateCodeInterpreterRequest : public BedrockAgentCoreControlRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  CreateCodeInterpreterRequest& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateCodeInterpreterRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename ExecutionRoleArnT = Aws::String>
  CreateCodeInterpreterRequest& WithExecutionRoleArn(ExecutionRoleArnT&& value) {
  ...
  template <typename NetworkConfigurationT = CodeInterpreterNetworkConfiguration>
  CreateCodeInterpreterRequest& WithNetworkConfiguration(NetworkConfigurationT&& value) {
  ...
  ///@{
  /**
   * <p>The file system configurations to mount into the code interpreter. Use these
  ...
  template <typename FilesystemConfigurationsT = Aws::Vector<ToolsFileSystemConfiguration>>
  CreateCodeInterpreterRequest& WithFilesystemConfigurations(FilesystemConfigurationsT&& value) {
  ...
  CreateCodeInterpreterRequest& AddFilesystemConfigurations(FilesystemConfigurationsT&& value) {
    m_filesystemConfigurationsHasBeenSet = true;
  ...
  template <typename ClientTokenT = Aws::String>
  CreateCodeInterpreterRequest& WithClientToken(ClientTokenT&& value) {
  ...
  ///@{
  /**
   * <p>A map of tag keys and values to assign to the code interpreter. Tags enable
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateCodeInterpreterRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsKeyT = Aws::String, typename TagsValueT = Aws::String>
  CreateCodeInterpreterRequest& AddTags(TagsKeyT&& key, TagsValueT&& value) {
    m_tagsHasBeenSet = true;
