...
namespace Model
{
  ...
  public:
    ...
    void SetMessageBasedTrigger(MessageBasedTriggerT&& value) { m_messageBasedTriggerHasBeenSet = true; m_messageBasedTrigger = std::forward<MessageBasedTriggerT>(value); }
    template<typename MessageBasedTriggerT = MessageBasedTrigger>
    TriggerCondition& WithMessageBasedTrigger(MessageBasedTriggerT&& value) { SetMessageBasedTrigger(std::forward<MessageBasedTriggerT>(value)); return *this;}
    ///@}
    ...
    void SetTokenBasedTrigger(TokenBasedTriggerT&& value) { m_tokenBasedTriggerHasBeenSet = true; m_tokenBasedTrigger = std::forward<TokenBasedTriggerT>(value); }
    template<typename TokenBasedTriggerT = TokenBasedTrigger>
    TriggerCondition& WithTokenBasedTrigger(TokenBasedTriggerT&& value) { SetTokenBasedTrigger(std::forward<TokenBasedTriggerT>(value)); return *this;}
    ///@}
    ...
    void SetTimeBasedTrigger(TimeBasedTriggerT&& value) { m_timeBasedTriggerHasBeenSet = true; m_timeBasedTrigger = std::forward<TimeBasedTriggerT>(value); }
    template<typename TimeBasedTriggerT = TimeBasedTrigger>
    TriggerCondition& WithTimeBasedTrigger(TimeBasedTriggerT&& value) { SetTimeBasedTrigger(std::forward<TimeBasedTriggerT>(value)); return *this;}
    ///@}
  private:
