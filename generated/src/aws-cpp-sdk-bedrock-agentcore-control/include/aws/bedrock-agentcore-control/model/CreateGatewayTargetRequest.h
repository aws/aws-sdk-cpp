...
class CreateGatewayTargetRequest : public BedrockAgentCoreControlRequest {
 public:
  ...
  template <typename GatewayIdentifierT = Aws::String>
  CreateGatewayTargetRequest& WithGatewayIdentifier(GatewayIdentifierT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateGatewayTargetRequest& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateGatewayTargetRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  CreateGatewayTargetRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename TargetConfigurationT = TargetConfiguration>
  CreateGatewayTargetRequest& WithTargetConfiguration(TargetConfigurationT&& value) {
  ...
  template <typename CredentialProviderConfigurationsT = Aws::Vector<CredentialProviderConfiguration>>
  CreateGatewayTargetRequest& WithCredentialProviderConfigurations(CredentialProviderConfigurationsT&& value) {
  ...
  CreateGatewayTargetRequest& AddCredentialProviderConfigurations(CredentialProviderConfigurationsT&& value) {
    m_credentialProviderConfigurationsHasBeenSet = true;
  ...
  ///@{
  /**
   * <p>Optional configuration for HTTP header and query parameter propagation to and
   * from the gateway target.</p>
   */
  ...
  template <typename MetadataConfigurationT = MetadataConfiguration>
  CreateGatewayTargetRequest& WithMetadataConfiguration(MetadataConfigurationT&& value) {
  ...
  template <typename PrivateEndpointT = PrivateEndpoint>
  CreateGatewayTargetRequest& WithPrivateEndpoint(PrivateEndpointT&& value) {
