...
class UpdateGatewayTargetResult {
 public:
  ...
  AWS_BEDROCKAGENTCORECONTROL_API UpdateGatewayTargetResult& operator=(
  ...
  template <typename GatewayArnT = Aws::String>
  UpdateGatewayTargetResult& WithGatewayArn(GatewayArnT&& value) {
  ...
  template <typename TargetIdT = Aws::String>
  UpdateGatewayTargetResult& WithTargetId(TargetIdT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  UpdateGatewayTargetResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  UpdateGatewayTargetResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  inline UpdateGatewayTargetResult& WithStatus(TargetStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonsT = Aws::Vector<Aws::String>>
  UpdateGatewayTargetResult& WithStatusReasons(StatusReasonsT&& value) {
    SetStatusReasons(std::forward<StatusReasonsT>(value));
    return *this;
  }
  template <typename StatusReasonsT = Aws::String>
  UpdateGatewayTargetResult& AddStatusReasons(StatusReasonsT&& value) {
    m_statusReasonsHasBeenSet = true;
  ...
  template <typename NameT = Aws::String>
  UpdateGatewayTargetResult& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateGatewayTargetResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename TargetConfigurationT = TargetConfiguration>
  UpdateGatewayTargetResult& WithTargetConfiguration(TargetConfigurationT&& value) {
  ...
  template <typename CredentialProviderConfigurationsT = Aws::Vector<CredentialProviderConfiguration>>
  UpdateGatewayTargetResult& WithCredentialProviderConfigurations(CredentialProviderConfigurationsT&& value) {
  ...
  UpdateGatewayTargetResult& AddCredentialProviderConfigurations(CredentialProviderConfigurationsT&& value) {
    m_credentialProviderConfigurationsHasBeenSet = true;
  ...
  template <typename LastSynchronizedAtT = Aws::Utils::DateTime>
  UpdateGatewayTargetResult& WithLastSynchronizedAt(LastSynchronizedAtT&& value) {
  ...
  template <typename PrivateEndpointT = PrivateEndpoint>
  UpdateGatewayTargetResult& WithPrivateEndpoint(PrivateEndpointT&& value) {
  ...
  template <typename PrivateEndpointManagedResourcesT = Aws::Vector<ManagedResourceDetails>>
  UpdateGatewayTargetResult& WithPrivateEndpointManagedResources(PrivateEndpointManagedResourcesT&& value) {
  ...
  UpdateGatewayTargetResult& AddPrivateEndpointManagedResources(PrivateEndpointManagedResourcesT&& value) {
    m_privateEndpointManagedResourcesHasBeenSet = true;
  ...
  ///@{
  /**
   * <p>OAuth2 authorization data for the updated gateway target. This data is
  ...
  template <typename AuthorizationDataT = AuthorizationData>
  UpdateGatewayTargetResult& WithAuthorizationData(AuthorizationDataT&& value) {
  ...
  inline UpdateGatewayTargetResult& WithProtocolType(TargetProtocolType value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateGatewayTargetResult& WithRequestId(RequestIdT&& value) {
