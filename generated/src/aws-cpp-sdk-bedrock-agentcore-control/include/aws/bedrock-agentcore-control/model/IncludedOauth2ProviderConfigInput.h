...
class IncludedOauth2ProviderConfigInput {
 public:
  ...
  template <typename ClientSecretConfigT = SecretReference>
  IncludedOauth2ProviderConfigInput& WithClientSecretConfig(ClientSecretConfigT&& value) {
  ...
  inline IncludedOauth2ProviderConfigInput& WithClientSecretSource(SecretSourceType value) {
