...
namespace Model
{
  ...
  public:
    ...
    template<typename ClientIdT = Aws::String>
    IncludedOauth2ProviderConfigInput& WithClientId(ClientIdT&& value) { SetClientId(std::forward<ClientIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ClientSecretT = Aws::String>
    IncludedOauth2ProviderConfigInput& WithClientSecret(ClientSecretT&& value) { SetClientSecret(std::forward<ClientSecretT>(value)); return *this;}
    ///@}
    ...
    template<typename IssuerT = Aws::String>
    IncludedOauth2ProviderConfigInput& WithIssuer(IssuerT&& value) { SetIssuer(std::forward<IssuerT>(value)); return *this;}
    ///@}
    ...
    template<typename AuthorizationEndpointT = Aws::String>
    IncludedOauth2ProviderConfigInput& WithAuthorizationEndpoint(AuthorizationEndpointT&& value) { SetAuthorizationEndpoint(std::forward<AuthorizationEndpointT>(value)); return *this;}
    ///@}
    ...
    template<typename TokenEndpointT = Aws::String>
    IncludedOauth2ProviderConfigInput& WithTokenEndpoint(TokenEndpointT&& value) { SetTokenEndpoint(std::forward<TokenEndpointT>(value)); return *this;}
    ///@}
  private:
