...
/**
 */
class PutResourcePolicyRequest : public BedrockAgentCoreControlRequest {
 public:
  AWS_BEDROCKAGENTCORECONTROL_API PutResourcePolicyRequest() = default;
  ...
  ///@{
  /**
   * <p>The Amazon Resource Name (ARN) of the resource for which to create or update
