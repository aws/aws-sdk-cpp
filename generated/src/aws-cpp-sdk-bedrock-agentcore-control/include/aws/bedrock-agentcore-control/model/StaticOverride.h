...
/**
 * <p>A static configuration bundle override.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/bedrock-agentcore-control-2023-06-05/StaticOverride">AWS
 * API Reference</a></p>
 */
class StaticOverride {
 public:
  AWS_BEDROCKAGENTCORECONTROL_API StaticOverride() = default;
  AWS_BEDROCKAGENTCORECONTROL_API StaticOverride(Aws::Utils::Json::JsonView jsonValue);
  AWS_BEDROCKAGENTCORECONTROL_API StaticOverride& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename BundleArnT = Aws::String>
  StaticOverride& WithBundleArn(BundleArnT&& value) {
  ...
  template <typename BundleVersionT = Aws::String>
  StaticOverride& WithBundleVersion(BundleVersionT&& value) {
