...
/**
 */
class UpdateAgentRuntimeEndpointRequest : public BedrockAgentCoreControlRequest {
 public:
  AWS_BEDROCKAGENTCORECONTROL_API UpdateAgentRuntimeEndpointRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "UpdateAgentRuntimeEndpoint"; }
  ...
  template <typename AgentRuntimeIdT = Aws::String>
  UpdateAgentRuntimeEndpointRequest& WithAgentRuntimeId(AgentRuntimeIdT&& value) {
  ...
  template <typename EndpointNameT = Aws::String>
  UpdateAgentRuntimeEndpointRequest& WithEndpointName(EndpointNameT&& value) {
  ...
  template <typename AgentRuntimeVersionT = Aws::String>
  UpdateAgentRuntimeEndpointRequest& WithAgentRuntimeVersion(AgentRuntimeVersionT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateAgentRuntimeEndpointRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  UpdateAgentRuntimeEndpointRequest& WithClientToken(ClientTokenT&& value) {
