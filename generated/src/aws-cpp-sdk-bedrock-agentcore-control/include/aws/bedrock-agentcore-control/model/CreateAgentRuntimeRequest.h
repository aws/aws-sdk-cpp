...
class CreateAgentRuntimeRequest : public BedrockAgentCoreControlRequest {
 public:
  ...
  template <typename AgentRuntimeNameT = Aws::String>
  CreateAgentRuntimeRequest& WithAgentRuntimeName(AgentRuntimeNameT&& value) {
  ...
  template <typename AgentRuntimeArtifactT = AgentRuntimeArtifact>
  CreateAgentRuntimeRequest& WithAgentRuntimeArtifact(AgentRuntimeArtifactT&& value) {
  ...
  template <typename RoleArnT = Aws::String>
  CreateAgentRuntimeRequest& WithRoleArn(RoleArnT&& value) {
  ...
  template <typename NetworkConfigurationT = NetworkConfiguration>
  CreateAgentRuntimeRequest& WithNetworkConfiguration(NetworkConfigurationT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  CreateAgentRuntimeRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateAgentRuntimeRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename AuthorizerConfigurationT = AuthorizerConfiguration>
  CreateAgentRuntimeRequest& WithAuthorizerConfiguration(AuthorizerConfigurationT&& value) {
  ...
  template <typename RequestHeaderConfigurationT = RequestHeaderConfiguration>
  CreateAgentRuntimeRequest& WithRequestHeaderConfiguration(RequestHeaderConfigurationT&& value) {
  ...
  template <typename ProtocolConfigurationT = ProtocolConfiguration>
  CreateAgentRuntimeRequest& WithProtocolConfiguration(ProtocolConfigurationT&& value) {
  ...
  template <typename LifecycleConfigurationT = LifecycleConfiguration>
  CreateAgentRuntimeRequest& WithLifecycleConfiguration(LifecycleConfigurationT&& value) {
  ...
  template <typename EnvironmentVariablesT = Aws::Map<Aws::String, Aws::String>>
  CreateAgentRuntimeRequest& WithEnvironmentVariables(EnvironmentVariablesT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateAgentRuntimeRequest& WithTags(TagsT&& value) {
