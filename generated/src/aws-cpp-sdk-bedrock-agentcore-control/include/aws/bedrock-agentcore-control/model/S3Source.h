...
class S3Source {
 public:
  AWS_BEDROCKAGENTCORECONTROL_API S3Source() = default;
  AWS_BEDROCKAGENTCORECONTROL_API S3Source(Aws::Utils::Json::JsonView jsonValue);
  AWS_BEDROCKAGENTCORECONTROL_API S3Source& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename S3UriT = Aws::String>
  S3Source& WithS3Uri(S3UriT&& value) {
