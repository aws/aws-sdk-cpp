...
class SummaryMemoryStrategyInput {
 public:
  ...
  template <typename NameT = Aws::String>
  SummaryMemoryStrategyInput& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  SummaryMemoryStrategyInput& WithDescription(DescriptionT&& value) {
  ...
  template <typename NamespaceTemplatesT = Aws::Vector<Aws::String>>
  SummaryMemoryStrategyInput& WithNamespaceTemplates(NamespaceTemplatesT&& value) {
    SetNamespaceTemplates(std::forward<NamespaceTemplatesT>(value));
    return *this;
  }
  template <typename NamespaceTemplatesT = Aws::String>
  SummaryMemoryStrategyInput& AddNamespaceTemplates(NamespaceTemplatesT&& value) {
    m_namespaceTemplatesHasBeenSet = true;
