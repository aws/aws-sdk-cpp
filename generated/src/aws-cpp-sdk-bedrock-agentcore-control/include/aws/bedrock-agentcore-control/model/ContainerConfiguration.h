...
class ContainerConfiguration {
 public:
  ...
  void SetContainerUri(ContainerUriT&& value) {
    m_containerUriHasBeenSet = true;
    m_containerUri = std::forward<ContainerUriT>(value);
  }
  template <typename ContainerUriT = Aws::String>
  ContainerConfiguration& WithContainerUri(ContainerUriT&& value) {
    SetContainerUri(std::forward<ContainerUriT>(value));
    return *this;
  }
  ///@}
 private:
