...
/**
 */
class ListPolicyGenerationSummariesRequest : public BedrockAgentCoreControlRequest {
 public:
  AWS_BEDROCKAGENTCORECONTROL_API ListPolicyGenerationSummariesRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "ListPolicyGenerationSummaries"; }
  ...
  template <typename NextTokenT = Aws::String>
  ListPolicyGenerationSummariesRequest& WithNextToken(NextTokenT&& value) {
  ...
  ///@{
  /**
   * <p>The maximum number of policy generation summaries to return in a single
   * response.</p>
   */
  ...
  inline ListPolicyGenerationSummariesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  ///@{
  /**
   * <p>The identifier of the policy engine whose policy generation summaries to
   * retrieve.</p>
   */
  ...
  template <typename PolicyEngineIdT = Aws::String>
  ListPolicyGenerationSummariesRequest& WithPolicyEngineId(PolicyEngineIdT&& value) {
