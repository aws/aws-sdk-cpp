...
class CreateCodeInterpreterResult {
 public:
  ...
  AWS_BEDROCKAGENTCORECONTROL_API CreateCodeInterpreterResult& operator=(
  ...
  template <typename CodeInterpreterIdT = Aws::String>
  CreateCodeInterpreterResult& WithCodeInterpreterId(CodeInterpreterIdT&& value) {
  ...
  template <typename CodeInterpreterArnT = Aws::String>
  CreateCodeInterpreterResult& WithCodeInterpreterArn(CodeInterpreterArnT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  CreateCodeInterpreterResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  inline CreateCodeInterpreterResult& WithStatus(CodeInterpreterStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  CreateCodeInterpreterResult& WithRequestId(RequestIdT&& value) {
