...
namespace Model
{
  ...
  public:
    ...
    template<typename OauthDiscoveryT = Oauth2Discovery>
    CustomOauth2ProviderConfigOutput& WithOauthDiscovery(OauthDiscoveryT&& value) { SetOauthDiscovery(std::forward<OauthDiscoveryT>(value)); return *this;}
    ///@}
    ...
    template<typename ClientIdT = Aws::String>
    CustomOauth2ProviderConfigOutput& WithClientId(ClientIdT&& value) { SetClientId(std::forward<ClientIdT>(value)); return *this;}
    ///@}
  private:
