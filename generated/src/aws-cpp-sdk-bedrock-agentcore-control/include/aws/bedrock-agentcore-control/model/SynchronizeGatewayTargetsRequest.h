...
namespace Model
{
  ...
  public:
    ...
    template<typename GatewayIdentifierT = Aws::String>
    SynchronizeGatewayTargetsRequest& WithGatewayIdentifier(GatewayIdentifierT&& value) { SetGatewayIdentifier(std::forward<GatewayIdentifierT>(value)); return *this;}
    ///@}
    ...
    void SetTargetIdList(TargetIdListT&& value) { m_targetIdListHasBeenSet = true; m_targetIdList = std::forward<TargetIdListT>(value); }
    template<typename TargetIdListT = Aws::Vector<Aws::String>>
    SynchronizeGatewayTargetsRequest& WithTargetIdList(TargetIdListT&& value) { SetTargetIdList(std::forward<TargetIdListT>(value)); return *this;}
    template<typename TargetIdListT = Aws::String>
    SynchronizeGatewayTargetsRequest& AddTargetIdList(TargetIdListT&& value) { m_targetIdListHasBeenSet = true; m_targetIdList.emplace_back(std::forward<TargetIdListT>(value)); return *this; }
    ///@}
  private:
