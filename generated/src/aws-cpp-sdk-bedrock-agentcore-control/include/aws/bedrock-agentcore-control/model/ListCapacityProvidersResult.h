...
class ListCapacityProvidersResult {
 public:
  AWS_BEDROCKAGENTCORECONTROL_API ListCapacityProvidersResult() = default;
  AWS_BEDROCKAGENTCORECONTROL_API ListCapacityProvidersResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_BEDROCKAGENTCORECONTROL_API ListCapacityProvidersResult& operator=(
   ...
   */
  inline const Aws::Vector<CapacityProviderSummary>& GetCapacityProviders() const { return m_capacityProviders; }
  template <typename CapacityProvidersT = Aws::Vector<CapacityProviderSummary>>
  ...
  template <typename CapacityProvidersT = CapacityProviderSummary>
  ...
  template <typename NextTokenT = Aws::String>
  ListCapacityProvidersResult& WithNextToken(NextTokenT&& value) {
 ...
 private:
  Aws::Vector<CapacityProviderSummary> m_capacityProviders;
