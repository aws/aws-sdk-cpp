...
namespace Model
{
  ...
  public:
    ...
    AWS_BEDROCKAGENTCORECONTROL_API SynchronizeGatewayTargetsResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ...
    template<typename TargetsT = Aws::Vector<GatewayTarget>>
    SynchronizeGatewayTargetsResult& WithTargets(TargetsT&& value) { SetTargets(std::forward<TargetsT>(value)); return *this;}
    template<typename TargetsT = GatewayTarget>
    SynchronizeGatewayTargetsResult& AddTargets(TargetsT&& value) { m_targetsHasBeenSet = true; m_targets.emplace_back(std::forward<TargetsT>(value)); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    SynchronizeGatewayTargetsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
