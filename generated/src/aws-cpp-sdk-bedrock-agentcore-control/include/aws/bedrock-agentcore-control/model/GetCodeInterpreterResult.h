...
class GetCodeInterpreterResult {
 public:
  ...
  AWS_BEDROCKAGENTCORECONTROL_API GetCodeInterpreterResult& operator=(
  ...
  template <typename CodeInterpreterIdT = Aws::String>
  GetCodeInterpreterResult& WithCodeInterpreterId(CodeInterpreterIdT&& value) {
  ...
  template <typename CodeInterpreterArnT = Aws::String>
  GetCodeInterpreterResult& WithCodeInterpreterArn(CodeInterpreterArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  GetCodeInterpreterResult& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  GetCodeInterpreterResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename ExecutionRoleArnT = Aws::String>
  GetCodeInterpreterResult& WithExecutionRoleArn(ExecutionRoleArnT&& value) {
  ...
  template <typename NetworkConfigurationT = CodeInterpreterNetworkConfiguration>
  GetCodeInterpreterResult& WithNetworkConfiguration(NetworkConfigurationT&& value) {
  ...
  inline GetCodeInterpreterResult& WithStatus(CodeInterpreterStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename FailureReasonT = Aws::String>
  GetCodeInterpreterResult& WithFailureReason(FailureReasonT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  GetCodeInterpreterResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename LastUpdatedAtT = Aws::Utils::DateTime>
  GetCodeInterpreterResult& WithLastUpdatedAt(LastUpdatedAtT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetCodeInterpreterResult& WithRequestId(RequestIdT&& value) {
