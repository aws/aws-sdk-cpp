...
class MicrosoftOauth2ProviderConfigInput {
 public:
  ...
  template <typename ClientSecretConfigT = SecretReference>
  MicrosoftOauth2ProviderConfigInput& WithClientSecretConfig(ClientSecretConfigT&& value) {
  ...
  inline MicrosoftOauth2ProviderConfigInput& WithClientSecretSource(SecretSourceType value) {
