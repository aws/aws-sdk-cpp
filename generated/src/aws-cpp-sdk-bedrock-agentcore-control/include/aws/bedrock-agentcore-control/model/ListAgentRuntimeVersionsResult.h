...
class ListAgentRuntimeVersionsResult {
 public:
  ...
  AWS_BEDROCKAGENTCORECONTROL_API ListAgentRuntimeVersionsResult& operator=(
  ...
  template <typename AgentRuntimesT = Aws::Vector<AgentRuntime>>
  ListAgentRuntimeVersionsResult& WithAgentRuntimes(AgentRuntimesT&& value) {
    SetAgentRuntimes(std::forward<AgentRuntimesT>(value));
    return *this;
  }
  template <typename AgentRuntimesT = AgentRuntime>
  ListAgentRuntimeVersionsResult& AddAgentRuntimes(AgentRuntimesT&& value) {
    m_agentRuntimesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListAgentRuntimeVersionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAgentRuntimeVersionsResult& WithRequestId(RequestIdT&& value) {
