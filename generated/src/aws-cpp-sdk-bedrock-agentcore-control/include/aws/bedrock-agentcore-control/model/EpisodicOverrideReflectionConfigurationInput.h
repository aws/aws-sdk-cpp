...
class EpisodicOverrideReflectionConfigurationInput {
 public:
  ...
  ///@{
  /**
   * <p>The namespaceTemplates to use for episodic reflection. Can be less nested
  ...
  template <typename NamespaceTemplatesT = Aws::Vector<Aws::String>>
  EpisodicOverrideReflectionConfigurationInput& WithNamespaceTemplates(NamespaceTemplatesT&& value) {
    SetNamespaceTemplates(std::forward<NamespaceTemplatesT>(value));
    return *this;
  }
  template <typename NamespaceTemplatesT = Aws::String>
  EpisodicOverrideReflectionConfigurationInput& AddNamespaceTemplates(NamespaceTemplatesT&& value) {
    m_namespaceTemplatesHasBeenSet = true;
