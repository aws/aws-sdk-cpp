 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/bedrock-agentcore-control-2023-06-05/EfsConfiguration">AWS
 * API Reference</a></p>
 */
class EfsConfiguration {
 public:
  AWS_BEDROCKAGENTCORECONTROL_API EfsConfiguration() = default;
  AWS_BEDROCKAGENTCORECONTROL_API EfsConfiguration(Aws::Utils::Json::JsonView jsonValue);
  AWS_BEDROCKAGENTCORECONTROL_API EfsConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
