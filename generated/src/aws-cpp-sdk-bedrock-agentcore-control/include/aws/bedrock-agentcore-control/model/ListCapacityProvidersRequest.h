...
/**
 */
class ListCapacityProvidersRequest : public BedrockAgentCoreControlRequest {
 public:
  AWS_BEDROCKAGENTCORECONTROL_API ListCapacityProvidersRequest() = default;
  ...
  inline ListCapacityProvidersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListCapacityProvidersRequest& WithNextToken(NextTokenT&& value) {
