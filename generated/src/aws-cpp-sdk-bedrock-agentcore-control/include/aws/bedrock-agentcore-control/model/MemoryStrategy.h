...
class MemoryStrategy {
 public:
  ...
  template <typename StrategyIdT = Aws::String>
  MemoryStrategy& WithStrategyId(StrategyIdT&& value) {
  ...
  template <typename NameT = Aws::String>
  MemoryStrategy& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  MemoryStrategy& WithDescription(DescriptionT&& value) {
  ...
  template <typename ConfigurationT = StrategyConfiguration>
  MemoryStrategy& WithConfiguration(ConfigurationT&& value) {
  ...
  inline void SetType(MemoryStrategyType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline MemoryStrategy& WithType(MemoryStrategyType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename NamespaceTemplatesT = Aws::Vector<Aws::String>>
  MemoryStrategy& WithNamespaceTemplates(NamespaceTemplatesT&& value) {
    SetNamespaceTemplates(std::forward<NamespaceTemplatesT>(value));
    return *this;
  }
  template <typename NamespaceTemplatesT = Aws::String>
  MemoryStrategy& AddNamespaceTemplates(NamespaceTemplatesT&& value) {
    m_namespaceTemplatesHasBeenSet = true;
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  MemoryStrategy& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  MemoryStrategy& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  inline void SetStatus(MemoryStrategyStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline MemoryStrategy& WithStatus(MemoryStrategyStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
