...
namespace Model
{
  ...
  public:
    ...
    inline void SetIdleSessionTimeout(int value) { m_idleSessionTimeoutHasBeenSet = true; m_idleSessionTimeout = value; }
    inline TimeBasedTriggerInput& WithIdleSessionTimeout(int value) { SetIdleSessionTimeout(value); return *this;}
    ///@}
  private:
