...
class ListCodeInterpretersResult {
 public:
  ...
  AWS_BEDROCKAGENTCORECONTROL_API ListCodeInterpretersResult& operator=(
  ...
  void SetCodeInterpreterSummaries(CodeInterpreterSummariesT&& value) {
    m_codeInterpreterSummariesHasBeenSet = true;
    m_codeInterpreterSummaries = std::forward<CodeInterpreterSummariesT>(value);
  }
  template <typename CodeInterpreterSummariesT = Aws::Vector<CodeInterpreterSummary>>
  ListCodeInterpretersResult& WithCodeInterpreterSummaries(CodeInterpreterSummariesT&& value) {
    SetCodeInterpreterSummaries(std::forward<CodeInterpreterSummariesT>(value));
    return *this;
  }
  template <typename CodeInterpreterSummariesT = CodeInterpreterSummary>
  ListCodeInterpretersResult& AddCodeInterpreterSummaries(CodeInterpreterSummariesT&& value) {
    m_codeInterpreterSummariesHasBeenSet = true;
    m_codeInterpreterSummaries.emplace_back(std::forward<CodeInterpreterSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListCodeInterpretersResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListCodeInterpretersResult& WithRequestId(RequestIdT&& value) {
