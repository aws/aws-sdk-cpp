...
class ListGatewayTargetsResult {
 public:
  ...
  AWS_BEDROCKAGENTCORECONTROL_API ListGatewayTargetsResult& operator=(
  ...
  template <typename ItemsT = Aws::Vector<TargetSummary>>
  ListGatewayTargetsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = TargetSummary>
  ListGatewayTargetsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListGatewayTargetsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListGatewayTargetsResult& WithRequestId(RequestIdT&& value) {
