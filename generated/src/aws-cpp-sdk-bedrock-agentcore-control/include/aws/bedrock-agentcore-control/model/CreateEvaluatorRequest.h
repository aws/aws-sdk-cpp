...
/**
 */
class CreateEvaluatorRequest : public BedrockAgentCoreControlRequest {
 public:
  AWS_BEDROCKAGENTCORECONTROL_API CreateEvaluatorRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "CreateEvaluator"; }
  ...
  template <typename ClientTokenT = Aws::String>
  CreateEvaluatorRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename EvaluatorNameT = Aws::String>
  CreateEvaluatorRequest& WithEvaluatorName(EvaluatorNameT&& value) {
  ...
  ///@{
  /**
   * <p> The description of the evaluator that explains its purpose and evaluation
   * criteria. </p>
   */
  ...
  template <typename DescriptionT = Aws::String>
  CreateEvaluatorRequest& WithDescription(DescriptionT&& value) {
  ...
  ///@{
  /**
   * <p> The configuration for the evaluator, including LLM-as-a-Judge settings with
   * instructions, rating scale, and model configuration. </p>
   */
  ...
  template <typename EvaluatorConfigT = EvaluatorConfig>
  CreateEvaluatorRequest& WithEvaluatorConfig(EvaluatorConfigT&& value) {
  ...
  ///@{
  /**
   * <p> The evaluation level that determines the scope of evaluation. Valid values
   * are <code>TOOL_CALL</code> for individual tool invocations, <code>TRACE</code>
   * for single request-response interactions, or <code>SESSION</code> for entire
  ...
  inline CreateEvaluatorRequest& WithLevel(EvaluatorLevel value) {
    SetLevel(value);
    return *this;
  }
  ///@}
