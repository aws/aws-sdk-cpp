...
class AgentRuntime {
 public:
  ...
  template <typename AgentRuntimeArnT = Aws::String>
  AgentRuntime& WithAgentRuntimeArn(AgentRuntimeArnT&& value) {
  ...
  template <typename AgentRuntimeIdT = Aws::String>
  AgentRuntime& WithAgentRuntimeId(AgentRuntimeIdT&& value) {
  ...
  template <typename AgentRuntimeVersionT = Aws::String>
  AgentRuntime& WithAgentRuntimeVersion(AgentRuntimeVersionT&& value) {
  ...
  template <typename AgentRuntimeNameT = Aws::String>
  AgentRuntime& WithAgentRuntimeName(AgentRuntimeNameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  AgentRuntime& WithDescription(DescriptionT&& value) {
  ...
  template <typename LastUpdatedAtT = Aws::Utils::DateTime>
  AgentRuntime& WithLastUpdatedAt(LastUpdatedAtT&& value) {
  ...
  inline AgentRuntime& WithStatus(AgentRuntimeStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
