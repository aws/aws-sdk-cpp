...
class ModifyExtractionConfiguration {
 public:
  ...
  void SetCustomExtractionConfiguration(CustomExtractionConfigurationT&& value) {
    m_customExtractionConfigurationHasBeenSet = true;
    m_customExtractionConfiguration = std::forward<CustomExtractionConfigurationT>(value);
  }
  template <typename CustomExtractionConfigurationT = CustomExtractionConfigurationInput>
  ModifyExtractionConfiguration& WithCustomExtractionConfiguration(CustomExtractionConfigurationT&& value) {
    SetCustomExtractionConfiguration(std::forward<CustomExtractionConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
