...
class ListAgentRuntimesResult {
 public:
  ...
  AWS_BEDROCKAGENTCORECONTROL_API ListAgentRuntimesResult& operator=(
  ...
  template <typename AgentRuntimesT = Aws::Vector<AgentRuntime>>
  ListAgentRuntimesResult& WithAgentRuntimes(AgentRuntimesT&& value) {
    SetAgentRuntimes(std::forward<AgentRuntimesT>(value));
    return *this;
  }
  template <typename AgentRuntimesT = AgentRuntime>
  ListAgentRuntimesResult& AddAgentRuntimes(AgentRuntimesT&& value) {
    m_agentRuntimesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListAgentRuntimesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAgentRuntimesResult& WithRequestId(RequestIdT&& value) {
