 ...
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/bedrock-agentcore-control-2023-06-05/HarnessInlineFunctionConfig">AWS
 * API Reference</a></p>
 */
class HarnessInlineFunctionConfig {
 public:
  AWS_BEDROCKAGENTCORECONTROL_API HarnessInlineFunctionConfig() = default;
  AWS_BEDROCKAGENTCORECONTROL_API HarnessInlineFunctionConfig(Aws::Utils::Json::JsonView jsonValue);
  AWS_BEDROCKAGENTCORECONTROL_API HarnessInlineFunctionConfig& operator=(Aws::Utils::Json::JsonView jsonValue);
