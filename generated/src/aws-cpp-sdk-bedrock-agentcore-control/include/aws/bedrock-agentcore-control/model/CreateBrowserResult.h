...
class CreateBrowserResult {
 public:
  ...
  template <typename BrowserIdT = Aws::String>
  CreateBrowserResult& WithBrowserId(BrowserIdT&& value) {
  ...
  template <typename BrowserArnT = Aws::String>
  CreateBrowserResult& WithBrowserArn(BrowserArnT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  CreateBrowserResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  inline void SetStatus(BrowserStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline CreateBrowserResult& WithStatus(BrowserStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  CreateBrowserResult& WithRequestId(RequestIdT&& value) {
