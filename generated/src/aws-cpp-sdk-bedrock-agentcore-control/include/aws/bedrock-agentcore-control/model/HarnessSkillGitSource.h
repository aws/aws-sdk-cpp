 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/bedrock-agentcore-control-2023-06-05/HarnessSkillGitSource">AWS
 * API Reference</a></p>
 */
class HarnessSkillGitSource {
 public:
  AWS_BEDROCKAGENTCORECONTROL_API HarnessSkillGitSource() = default;
  AWS_BEDROCKAGENTCORECONTROL_API HarnessSkillGitSource(Aws::Utils::Json::JsonView jsonValue);
  AWS_BEDROCKAGENTCORECONTROL_API HarnessSkillGitSource& operator=(Aws::Utils::Json::JsonView jsonValue);
