...
class ListAgentRuntimeEndpointsRequest : public BedrockAgentCoreControlRequest {
 public:
  ...
  template <typename AgentRuntimeIdT = Aws::String>
  ListAgentRuntimeEndpointsRequest& WithAgentRuntimeId(AgentRuntimeIdT&& value) {
  ...
  inline ListAgentRuntimeEndpointsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAgentRuntimeEndpointsRequest& WithNextToken(NextTokenT&& value) {
