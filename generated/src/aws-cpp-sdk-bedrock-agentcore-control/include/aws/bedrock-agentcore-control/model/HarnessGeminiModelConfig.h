 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/bedrock-agentcore-control-2023-06-05/HarnessGeminiModelConfig">AWS
 * API Reference</a></p>
 */
class HarnessGeminiModelConfig {
 public:
  AWS_BEDROCKAGENTCORECONTROL_API HarnessGeminiModelConfig() = default;
  AWS_BEDROCKAGENTCORECONTROL_API HarnessGeminiModelConfig(Aws::Utils::Json::JsonView jsonValue);
  AWS_BEDROCKAGENTCORECONTROL_API HarnessGeminiModelConfig& operator=(Aws::Utils::Json::JsonView jsonValue);
