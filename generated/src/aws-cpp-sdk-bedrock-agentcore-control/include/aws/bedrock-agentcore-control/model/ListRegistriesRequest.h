...
/**
 */
class ListRegistriesRequest : public BedrockAgentCoreControlRequest {
 public:
  AWS_BEDROCKAGENTCORECONTROL_API ListRegistriesRequest() = default;
  ...
  ///@{
  /**
   * <p>Filter registries by their current status. Possible values include
  ...
  inline ListRegistriesRequest& WithStatus(RegistryStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
