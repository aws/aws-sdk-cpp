...
class NetworkConfiguration {
 public:
  ...
  inline NetworkConfiguration& WithNetworkMode(NetworkMode value) {
  ...
  void SetNetworkModeConfig(NetworkModeConfigT&& value) {
    m_networkModeConfigHasBeenSet = true;
    m_networkModeConfig = std::forward<NetworkModeConfigT>(value);
  }
  template <typename NetworkModeConfigT = VpcConfig>
  NetworkConfiguration& WithNetworkModeConfig(NetworkModeConfigT&& value) {
    SetNetworkModeConfig(std::forward<NetworkModeConfigT>(value));
    return *this;
  }
  ///@}
 private:
