...
/**
 */
class CreatePaymentManagerRequest : public BedrockAgentCoreControlRequest {
 public:
  AWS_BEDROCKAGENTCORECONTROL_API CreatePaymentManagerRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "CreatePaymentManager"; }
  ...
  template <typename NameT = Aws::String>
  CreatePaymentManagerRequest& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreatePaymentManagerRequest& WithDescription(DescriptionT&& value) {
  ...
  ///@{
  /**
   * <p>The type of authorizer to use for the payment manager.</p> <ul> <li> <p>
  ...
  inline CreatePaymentManagerRequest& WithAuthorizerType(PaymentsAuthorizerType value) {
  ...
  template <typename AuthorizerConfigurationT = AuthorizerConfiguration>
  CreatePaymentManagerRequest& WithAuthorizerConfiguration(AuthorizerConfigurationT&& value) {
  ...
  ///@{
  /**
   * <p>The Amazon Resource Name (ARN) of the IAM role that the payment manager
   * assumes to access resources on your behalf.</p>
   */
  ...
  template <typename RoleArnT = Aws::String>
  CreatePaymentManagerRequest& WithRoleArn(RoleArnT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  CreatePaymentManagerRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreatePaymentManagerRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsKeyT = Aws::String, typename TagsValueT = Aws::String>
  CreatePaymentManagerRequest& AddTags(TagsKeyT&& key, TagsValueT&& value) {
    m_tagsHasBeenSet = true;
   ...
   * the data is encrypted with an Amazon Web Services owned key.</p>
   */
  ...
  template <typename KmsKeyArnT = Aws::String>
  CreatePaymentManagerRequest& WithKmsKeyArn(KmsKeyArnT&& value) {
