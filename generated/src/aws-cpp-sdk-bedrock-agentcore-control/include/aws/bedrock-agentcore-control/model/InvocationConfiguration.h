...
namespace Model
{
  ...
  public:
    ...
    template<typename TopicArnT = Aws::String>
    InvocationConfiguration& WithTopicArn(TopicArnT&& value) { SetTopicArn(std::forward<TopicArnT>(value)); return *this;}
    ///@}
    ...
    template<typename PayloadDeliveryBucketNameT = Aws::String>
    InvocationConfiguration& WithPayloadDeliveryBucketName(PayloadDeliveryBucketNameT&& value) { SetPayloadDeliveryBucketName(std::forward<PayloadDeliveryBucketNameT>(value)); return *this;}
    ///@}
  private:
