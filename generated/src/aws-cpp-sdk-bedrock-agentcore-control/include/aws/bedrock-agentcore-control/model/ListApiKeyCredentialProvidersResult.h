...
class ListApiKeyCredentialProvidersResult {
 public:
  ...
  AWS_BEDROCKAGENTCORECONTROL_API ListApiKeyCredentialProvidersResult(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_BEDROCKAGENTCORECONTROL_API ListApiKeyCredentialProvidersResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename CredentialProvidersT = Aws::Vector<ApiKeyCredentialProviderItem>>
  ListApiKeyCredentialProvidersResult& WithCredentialProviders(CredentialProvidersT&& value) {
  ...
  ListApiKeyCredentialProvidersResult& AddCredentialProviders(CredentialProvidersT&& value) {
    m_credentialProvidersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListApiKeyCredentialProvidersResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListApiKeyCredentialProvidersResult& WithRequestId(RequestIdT&& value) {
