...
namespace Model {
class GetConsentPortalResult {
 public:
  AWS_BEDROCKAGENTCORECONTROL_API GetConsentPortalResult() = default;
  AWS_BEDROCKAGENTCORECONTROL_API GetConsentPortalResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_BEDROCKAGENTCORECONTROL_API GetConsentPortalResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename SourcesT = Aws::Vector<ConsentPortalSource>>
  GetConsentPortalResult& WithSources(SourcesT&& value) {
    SetSources(std::forward<SourcesT>(value));
    return *this;
  }
  template <typename SourcesT = ConsentPortalSource>
  GetConsentPortalResult& AddSources(SourcesT&& value) {
    m_sourcesHasBeenSet = true;
  ...
  template <typename ConsentPortalArnT = Aws::String>
  GetConsentPortalResult& WithConsentPortalArn(ConsentPortalArnT&& value) {
  ...
  template <typename ConsentPortalIdT = Aws::String>
  GetConsentPortalResult& WithConsentPortalId(ConsentPortalIdT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  GetConsentPortalResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  GetConsentPortalResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename ExecutionRoleArnT = Aws::String>
  GetConsentPortalResult& WithExecutionRoleArn(ExecutionRoleArnT&& value) {
  ...
  template <typename IdpConfigT = ConsentPortalIdpConfig>
  GetConsentPortalResult& WithIdpConfig(IdpConfigT&& value) {
  ...
  template <typename NameT = Aws::String>
  GetConsentPortalResult& WithName(NameT&& value) {
  ...
  template <typename PortalUrlT = Aws::String>
  GetConsentPortalResult& WithPortalUrl(PortalUrlT&& value) {
  ...
  inline GetConsentPortalResult& WithStatus(ConsentPortalStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonT = Aws::String>
  GetConsentPortalResult& WithStatusReason(StatusReasonT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  GetConsentPortalResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetConsentPortalResult& WithRequestId(RequestIdT&& value) {
