 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/bedrock-agentcore-control-2023-06-05/CreateGatewayRateLimitResponse">AWS
 * API Reference</a></p>
 */
class CreateGatewayRateLimitResult {
 public:
  AWS_BEDROCKAGENTCORECONTROL_API CreateGatewayRateLimitResult() = default;
  AWS_BEDROCKAGENTCORECONTROL_API CreateGatewayRateLimitResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_BEDROCKAGENTCORECONTROL_API CreateGatewayRateLimitResult& operator=(
  ...
  template <typename RateLimitIdT = Aws::String>
  CreateGatewayRateLimitResult& WithRateLimitId(RateLimitIdT&& value) {
  ...
  template <typename GatewayIdentifierT = Aws::String>
  CreateGatewayRateLimitResult& WithGatewayIdentifier(GatewayIdentifierT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateGatewayRateLimitResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename DimensionKeysT = Aws::Vector<Aws::String>>
  CreateGatewayRateLimitResult& WithDimensionKeys(DimensionKeysT&& value) {
    SetDimensionKeys(std::forward<DimensionKeysT>(value));
    return *this;
  }
  template <typename DimensionKeysT = Aws::String>
  CreateGatewayRateLimitResult& AddDimensionKeys(DimensionKeysT&& value) {
    m_dimensionKeysHasBeenSet = true;
  ...
  template <typename EntriesT = Aws::Vector<LimitEntry>>
  CreateGatewayRateLimitResult& WithEntries(EntriesT&& value) {
    SetEntries(std::forward<EntriesT>(value));
    return *this;
  }
  template <typename EntriesT = LimitEntry>
  CreateGatewayRateLimitResult& AddEntries(EntriesT&& value) {
    m_entriesHasBeenSet = true;
  ...
  inline CreateGatewayRateLimitResult& WithStatus(GatewayRateLimitStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  CreateGatewayRateLimitResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  CreateGatewayRateLimitResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateGatewayRateLimitResult& WithRequestId(RequestIdT&& value) {
