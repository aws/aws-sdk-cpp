...
class ListCodeInterpretersRequest : public BedrockAgentCoreControlRequest {
 public:
  ...
  inline ListCodeInterpretersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListCodeInterpretersRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListCodeInterpretersRequest& WithType(ResourceType value) {
    SetType(value);
    return *this;
  }
  ///@}
