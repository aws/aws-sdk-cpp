...
class LifecycleConfiguration {
 public:
  ...
  inline void SetIdleRuntimeSessionTimeout(int value) {
    m_idleRuntimeSessionTimeoutHasBeenSet = true;
    m_idleRuntimeSessionTimeout = value;
  }
  inline LifecycleConfiguration& WithIdleRuntimeSessionTimeout(int value) {
    SetIdleRuntimeSessionTimeout(value);
    return *this;
  }
  ///@}
  ...
  inline LifecycleConfiguration& WithMaxLifetime(int value) {
