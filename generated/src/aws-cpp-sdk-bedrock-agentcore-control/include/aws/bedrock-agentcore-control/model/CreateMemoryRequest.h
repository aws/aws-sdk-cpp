...
class CreateMemoryRequest : public BedrockAgentCoreControlRequest {
 public:
  ...
  template <typename ClientTokenT = Aws::String>
  CreateMemoryRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateMemoryRequest& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateMemoryRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename EncryptionKeyArnT = Aws::String>
  CreateMemoryRequest& WithEncryptionKeyArn(EncryptionKeyArnT&& value) {
  ...
  template <typename MemoryExecutionRoleArnT = Aws::String>
  CreateMemoryRequest& WithMemoryExecutionRoleArn(MemoryExecutionRoleArnT&& value) {
  ...
  inline CreateMemoryRequest& WithEventExpiryDuration(int value) {
  ...
  template <typename MemoryStrategiesT = Aws::Vector<MemoryStrategyInput>>
  CreateMemoryRequest& WithMemoryStrategies(MemoryStrategiesT&& value) {
    SetMemoryStrategies(std::forward<MemoryStrategiesT>(value));
    return *this;
  }
  template <typename MemoryStrategiesT = MemoryStrategyInput>
  CreateMemoryRequest& AddMemoryStrategies(MemoryStrategiesT&& value) {
    m_memoryStrategiesHasBeenSet = true;
    m_memoryStrategies.emplace_back(std::forward<MemoryStrategiesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateMemoryRequest& WithTags(TagsT&& value) {
