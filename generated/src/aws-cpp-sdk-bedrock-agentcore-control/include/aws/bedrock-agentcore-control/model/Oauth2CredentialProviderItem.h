...
class Oauth2CredentialProviderItem {
 public:
  ...
  template <typename NameT = Aws::String>
  Oauth2CredentialProviderItem& WithName(NameT&& value) {
  ...
  inline Oauth2CredentialProviderItem& WithCredentialProviderVendor(CredentialProviderVendorType value) {
  ...
  template <typename CredentialProviderArnT = Aws::String>
  Oauth2CredentialProviderItem& WithCredentialProviderArn(CredentialProviderArnT&& value) {
  ...
  template <typename CreatedTimeT = Aws::Utils::DateTime>
  Oauth2CredentialProviderItem& WithCreatedTime(CreatedTimeT&& value) {
  ...
  template <typename LastUpdatedTimeT = Aws::Utils::DateTime>
  Oauth2CredentialProviderItem& WithLastUpdatedTime(LastUpdatedTimeT&& value) {
