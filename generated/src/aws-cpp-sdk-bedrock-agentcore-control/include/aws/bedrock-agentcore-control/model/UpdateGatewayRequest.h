...
class UpdateGatewayRequest : public BedrockAgentCoreControlRequest {
 public:
  ...
  template <typename GatewayIdentifierT = Aws::String>
  UpdateGatewayRequest& WithGatewayIdentifier(GatewayIdentifierT&& value) {
  ...
  template <typename NameT = Aws::String>
  UpdateGatewayRequest& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateGatewayRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename RoleArnT = Aws::String>
  UpdateGatewayRequest& WithRoleArn(RoleArnT&& value) {
  ...
  inline UpdateGatewayRequest& WithProtocolType(GatewayProtocolType value) {
  ...
  template <typename ProtocolConfigurationT = GatewayProtocolConfiguration>
  UpdateGatewayRequest& WithProtocolConfiguration(ProtocolConfigurationT&& value) {
  ...
  inline UpdateGatewayRequest& WithAuthorizerType(AuthorizerType value) {
  ...
  template <typename AuthorizerConfigurationT = AuthorizerConfiguration>
  UpdateGatewayRequest& WithAuthorizerConfiguration(AuthorizerConfigurationT&& value) {
  ...
  template <typename KmsKeyArnT = Aws::String>
  UpdateGatewayRequest& WithKmsKeyArn(KmsKeyArnT&& value) {
  ...
  ///@{
  /**
   * <p>The updated policy engine configuration for the gateway. A policy engine is a
  ...
  template <typename PolicyEngineConfigurationT = GatewayPolicyEngineConfiguration>
  UpdateGatewayRequest& WithPolicyEngineConfiguration(PolicyEngineConfigurationT&& value) {
  ...
  inline UpdateGatewayRequest& WithExceptionLevel(ExceptionLevel value) {
