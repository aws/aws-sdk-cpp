...
class ListAgentRuntimeVersionsRequest : public BedrockAgentCoreControlRequest {
 public:
  ...
  template <typename AgentRuntimeIdT = Aws::String>
  ListAgentRuntimeVersionsRequest& WithAgentRuntimeId(AgentRuntimeIdT&& value) {
  ...
  inline ListAgentRuntimeVersionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAgentRuntimeVersionsRequest& WithNextToken(NextTokenT&& value) {
