...
class CreateBrowserRequest : public BedrockAgentCoreControlRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  CreateBrowserRequest& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateBrowserRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename ExecutionRoleArnT = Aws::String>
  CreateBrowserRequest& WithExecutionRoleArn(ExecutionRoleArnT&& value) {
  ...
  template <typename NetworkConfigurationT = BrowserNetworkConfiguration>
  CreateBrowserRequest& WithNetworkConfiguration(NetworkConfigurationT&& value) {
  ...
  void SetRecording(RecordingT&& value) {
    m_recordingHasBeenSet = true;
    m_recording = std::forward<RecordingT>(value);
  }
  template <typename RecordingT = RecordingConfig>
  CreateBrowserRequest& WithRecording(RecordingT&& value) {
    SetRecording(std::forward<RecordingT>(value));
    return *this;
  }
  ///@}
  ...
  ///@{
  /**
   * <p>The file system configurations to mount into the browser. Use these
   ...
   * access your data. If you don't specify this field, no file systems are
   * mounted.</p>
   */
  ...
  template <typename FilesystemConfigurationsT = Aws::Vector<ToolsFileSystemConfiguration>>
  CreateBrowserRequest& WithFilesystemConfigurations(FilesystemConfigurationsT&& value) {
  ...
  CreateBrowserRequest& AddFilesystemConfigurations(FilesystemConfigurationsT&& value) {
    m_filesystemConfigurationsHasBeenSet = true;
  ...
  template <typename ClientTokenT = Aws::String>
  CreateBrowserRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateBrowserRequest& WithTags(TagsT&& value) {
