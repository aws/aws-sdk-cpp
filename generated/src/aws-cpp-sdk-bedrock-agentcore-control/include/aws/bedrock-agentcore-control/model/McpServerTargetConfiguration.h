...
class McpServerTargetConfiguration {
 public:
  ...
  ///@{
  /**
   * <p>A static tool list for the MCP server target. It is supported for all
   * credential providers. Dynamic tool discovery/synchronization will be disabled
   * when a target is configured with mcpToolSchema.</p>
   */
