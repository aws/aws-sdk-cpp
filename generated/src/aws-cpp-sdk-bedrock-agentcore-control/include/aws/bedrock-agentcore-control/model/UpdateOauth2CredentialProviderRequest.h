...
class UpdateOauth2CredentialProviderRequest : public BedrockAgentCoreControlRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  UpdateOauth2CredentialProviderRequest& WithName(NameT&& value) {
  ...
  inline UpdateOauth2CredentialProviderRequest& WithCredentialProviderVendor(CredentialProviderVendorType value) {
  ...
  template <typename Oauth2ProviderConfigInputT = Oauth2ProviderConfigInput>
  UpdateOauth2CredentialProviderRequest& WithOauth2ProviderConfigInput(Oauth2ProviderConfigInputT&& value) {
