...
namespace Model
{
  ...
  public:
    ...
    inline void SetMessageCount(int value) { m_messageCountHasBeenSet = true; m_messageCount = value; }
    inline MessageBasedTrigger& WithMessageCount(int value) { SetMessageCount(value); return *this;}
    ///@}
  private:
