...
class TargetSummary {
 public:
  ...
  template <typename TargetIdT = Aws::String>
  TargetSummary& WithTargetId(TargetIdT&& value) {
  ...
  template <typename NameT = Aws::String>
  TargetSummary& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  TargetSummary& WithDescription(DescriptionT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  TargetSummary& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  TargetSummary& WithUpdatedAt(UpdatedAtT&& value) {
