...
class UserPreferenceOverrideExtractionConfigurationInput {
 public:
  ...
  template <typename AppendToPromptT = Aws::String>
  UserPreferenceOverrideExtractionConfigurationInput& WithAppendToPrompt(AppendToPromptT&& value) {
  ...
  template <typename ModelIdT = Aws::String>
  UserPreferenceOverrideExtractionConfigurationInput& WithModelId(ModelIdT&& value) {
