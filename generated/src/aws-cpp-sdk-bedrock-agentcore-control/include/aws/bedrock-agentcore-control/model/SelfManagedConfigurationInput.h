...
namespace Model
{
  ...
  public:
    ...
    template<typename TriggerConditionsT = Aws::Vector<TriggerConditionInput>>
    SelfManagedConfigurationInput& WithTriggerConditions(TriggerConditionsT&& value) { SetTriggerConditions(std::forward<TriggerConditionsT>(value)); return *this;}
    template<typename TriggerConditionsT = TriggerConditionInput>
    SelfManagedConfigurationInput& AddTriggerConditions(TriggerConditionsT&& value) { m_triggerConditionsHasBeenSet = true; m_triggerConditions.emplace_back(std::forward<TriggerConditionsT>(value)); return *this; }
    ///@}
    ...
    template<typename InvocationConfigurationT = InvocationConfigurationInput>
    SelfManagedConfigurationInput& WithInvocationConfiguration(InvocationConfigurationT&& value) { SetInvocationConfiguration(std::forward<InvocationConfigurationT>(value)); return *this;}
    ///@}
    ...
    inline SelfManagedConfigurationInput& WithHistoricalContextWindowSize(int value) { SetHistoricalContextWindowSize(value); return *this;}
    ///@}
  private:
