...
class BrowserSummary {
 public:
  ...
  template <typename BrowserIdT = Aws::String>
  BrowserSummary& WithBrowserId(BrowserIdT&& value) {
  ...
  template <typename BrowserArnT = Aws::String>
  BrowserSummary& WithBrowserArn(BrowserArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  BrowserSummary& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  BrowserSummary& WithDescription(DescriptionT&& value) {
  ...
  inline BrowserSummary& WithStatus(BrowserStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  BrowserSummary& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename LastUpdatedAtT = Aws::Utils::DateTime>
  BrowserSummary& WithLastUpdatedAt(LastUpdatedAtT&& value) {
