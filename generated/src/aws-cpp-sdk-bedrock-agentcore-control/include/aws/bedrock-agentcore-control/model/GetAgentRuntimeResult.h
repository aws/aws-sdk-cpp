...
class GetAgentRuntimeResult {
 public:
  ...
  template <typename AgentRuntimeArnT = Aws::String>
  GetAgentRuntimeResult& WithAgentRuntimeArn(AgentRuntimeArnT&& value) {
  ...
  template <typename AgentRuntimeNameT = Aws::String>
  GetAgentRuntimeResult& WithAgentRuntimeName(AgentRuntimeNameT&& value) {
  ...
  template <typename AgentRuntimeIdT = Aws::String>
  GetAgentRuntimeResult& WithAgentRuntimeId(AgentRuntimeIdT&& value) {
  ...
  template <typename AgentRuntimeVersionT = Aws::String>
  GetAgentRuntimeResult& WithAgentRuntimeVersion(AgentRuntimeVersionT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  GetAgentRuntimeResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename LastUpdatedAtT = Aws::Utils::DateTime>
  GetAgentRuntimeResult& WithLastUpdatedAt(LastUpdatedAtT&& value) {
  ...
  template <typename RoleArnT = Aws::String>
  GetAgentRuntimeResult& WithRoleArn(RoleArnT&& value) {
  ...
  template <typename NetworkConfigurationT = NetworkConfiguration>
  GetAgentRuntimeResult& WithNetworkConfiguration(NetworkConfigurationT&& value) {
  ...
  inline GetAgentRuntimeResult& WithStatus(AgentRuntimeStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename LifecycleConfigurationT = LifecycleConfiguration>
  GetAgentRuntimeResult& WithLifecycleConfiguration(LifecycleConfigurationT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  GetAgentRuntimeResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename WorkloadIdentityDetailsT = WorkloadIdentityDetails>
  GetAgentRuntimeResult& WithWorkloadIdentityDetails(WorkloadIdentityDetailsT&& value) {
  ...
  template <typename AgentRuntimeArtifactT = AgentRuntimeArtifact>
  GetAgentRuntimeResult& WithAgentRuntimeArtifact(AgentRuntimeArtifactT&& value) {
  ...
  template <typename ProtocolConfigurationT = ProtocolConfiguration>
  GetAgentRuntimeResult& WithProtocolConfiguration(ProtocolConfigurationT&& value) {
  ...
  template <typename EnvironmentVariablesT = Aws::Map<Aws::String, Aws::String>>
  GetAgentRuntimeResult& WithEnvironmentVariables(EnvironmentVariablesT&& value) {
  ...
  template <typename AuthorizerConfigurationT = AuthorizerConfiguration>
  GetAgentRuntimeResult& WithAuthorizerConfiguration(AuthorizerConfigurationT&& value) {
  ...
  template <typename RequestHeaderConfigurationT = RequestHeaderConfiguration>
  GetAgentRuntimeResult& WithRequestHeaderConfiguration(RequestHeaderConfigurationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetAgentRuntimeResult& WithRequestId(RequestIdT&& value) {
