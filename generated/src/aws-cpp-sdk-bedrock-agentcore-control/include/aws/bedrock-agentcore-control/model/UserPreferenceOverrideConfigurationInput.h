...
namespace Model
{
  ...
  public:
    ...
    template<typename ExtractionT = UserPreferenceOverrideExtractionConfigurationInput>
    UserPreferenceOverrideConfigurationInput& WithExtraction(ExtractionT&& value) { SetExtraction(std::forward<ExtractionT>(value)); return *this;}
    ///@}
    ...
    template<typename ConsolidationT = UserPreferenceOverrideConsolidationConfigurationInput>
    UserPreferenceOverrideConfigurationInput& WithConsolidation(ConsolidationT&& value) { SetConsolidation(std::forward<ConsolidationT>(value)); return *this;}
    ///@}
  private:
