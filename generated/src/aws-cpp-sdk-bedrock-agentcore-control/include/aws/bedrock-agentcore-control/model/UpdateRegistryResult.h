...
class UpdateRegistryResult {
 public:
  AWS_BEDROCKAGENTCORECONTROL_API UpdateRegistryResult() = default;
  AWS_BEDROCKAGENTCORECONTROL_API UpdateRegistryResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_BEDROCKAGENTCORECONTROL_API UpdateRegistryResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  ///@{
  /**
   * <p>The type of authorizer used by the updated registry. This controls the
   * authorization method for the Search and Invoke APIs used by consumers.</p> <ul>
   * <li> <p> <code>CUSTOM_JWT</code> - Authorize with a bearer token.</p> </li> <li>
   * <p> <code>AWS_IAM</code> - Authorize with your Amazon Web Services IAM
   * credentials.</p> </li> </ul>
   */
  ...
  inline UpdateRegistryResult& WithAuthorizerType(RegistryAuthorizerType value) {
  ...
  ///@{
  /**
   * <p>The authorizer configuration for the updated registry. For details, see the
  ...
  template <typename AuthorizerConfigurationT = AuthorizerConfiguration>
  UpdateRegistryResult& WithAuthorizerConfiguration(AuthorizerConfigurationT&& value) {
  ...
  ///@{
  /**
   * <p>The approval configuration for the updated registry. For details, see the
  ...
  ///@{
  /**
   * <p>The current status of the updated registry. Possible values include
  ...
  inline UpdateRegistryResult& WithStatus(RegistryStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
