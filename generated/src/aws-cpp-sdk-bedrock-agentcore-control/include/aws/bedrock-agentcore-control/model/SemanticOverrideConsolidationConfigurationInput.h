...
class SemanticOverrideConsolidationConfigurationInput {
 public:
  ...
  template <typename AppendToPromptT = Aws::String>
  SemanticOverrideConsolidationConfigurationInput& WithAppendToPrompt(AppendToPromptT&& value) {
  ...
  template <typename ModelIdT = Aws::String>
  SemanticOverrideConsolidationConfigurationInput& WithModelId(ModelIdT&& value) {
