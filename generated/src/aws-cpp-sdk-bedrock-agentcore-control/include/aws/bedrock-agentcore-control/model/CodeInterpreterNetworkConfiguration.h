...
class CodeInterpreterNetworkConfiguration {
 public:
  ...
  inline void SetNetworkMode(CodeInterpreterNetworkMode value) {
    m_networkModeHasBeenSet = true;
    m_networkMode = value;
  }
  inline CodeInterpreterNetworkConfiguration& WithNetworkMode(CodeInterpreterNetworkMode value) {
  ...
  template <typename VpcConfigT = VpcConfig>
  CodeInterpreterNetworkConfiguration& WithVpcConfig(VpcConfigT&& value) {
