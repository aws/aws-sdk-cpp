...
class ListAgentRuntimeEndpointsResult {
 public:
  ...
  AWS_BEDROCKAGENTCORECONTROL_API ListAgentRuntimeEndpointsResult& operator=(
  ...
  void SetRuntimeEndpoints(RuntimeEndpointsT&& value) {
    m_runtimeEndpointsHasBeenSet = true;
    m_runtimeEndpoints = std::forward<RuntimeEndpointsT>(value);
  }
  template <typename RuntimeEndpointsT = Aws::Vector<AgentRuntimeEndpoint>>
  ListAgentRuntimeEndpointsResult& WithRuntimeEndpoints(RuntimeEndpointsT&& value) {
    SetRuntimeEndpoints(std::forward<RuntimeEndpointsT>(value));
    return *this;
  }
  template <typename RuntimeEndpointsT = AgentRuntimeEndpoint>
  ListAgentRuntimeEndpointsResult& AddRuntimeEndpoints(RuntimeEndpointsT&& value) {
    m_runtimeEndpointsHasBeenSet = true;
    m_runtimeEndpoints.emplace_back(std::forward<RuntimeEndpointsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAgentRuntimeEndpointsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAgentRuntimeEndpointsResult& WithRequestId(RequestIdT&& value) {
