...
class AgentRuntimeEndpoint {
 public:
  ...
  template <typename NameT = Aws::String>
  AgentRuntimeEndpoint& WithName(NameT&& value) {
  ...
  template <typename LiveVersionT = Aws::String>
  AgentRuntimeEndpoint& WithLiveVersion(LiveVersionT&& value) {
  ...
  template <typename TargetVersionT = Aws::String>
  AgentRuntimeEndpoint& WithTargetVersion(TargetVersionT&& value) {
  ...
  template <typename AgentRuntimeEndpointArnT = Aws::String>
  AgentRuntimeEndpoint& WithAgentRuntimeEndpointArn(AgentRuntimeEndpointArnT&& value) {
  ...
  template <typename AgentRuntimeArnT = Aws::String>
  AgentRuntimeEndpoint& WithAgentRuntimeArn(AgentRuntimeArnT&& value) {
  ...
  inline AgentRuntimeEndpoint& WithStatus(AgentRuntimeEndpointStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename IdT = Aws::String>
  AgentRuntimeEndpoint& WithId(IdT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  AgentRuntimeEndpoint& WithDescription(DescriptionT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  AgentRuntimeEndpoint& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename LastUpdatedAtT = Aws::Utils::DateTime>
  AgentRuntimeEndpoint& WithLastUpdatedAt(LastUpdatedAtT&& value) {
