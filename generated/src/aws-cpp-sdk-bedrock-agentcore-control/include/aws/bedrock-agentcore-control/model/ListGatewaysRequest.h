...
/**
 */
class ListGatewaysRequest : public BedrockAgentCoreControlRequest {
 public:
  AWS_BEDROCKAGENTCORECONTROL_API ListGatewaysRequest() = default;
  ...
  inline ListGatewaysRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListGatewaysRequest& WithNextToken(NextTokenT&& value) {
