...
/**
 * <p>Contains summary information about a payment credential
 * provider.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/bedrock-agentcore-control-2023-06-05/PaymentCredentialProviderItem">AWS
 * API Reference</a></p>
 */
class PaymentCredentialProviderItem {
 public:
  AWS_BEDROCKAGENTCORECONTROL_API PaymentCredentialProviderItem() = default;
  AWS_BEDROCKAGENTCORECONTROL_API PaymentCredentialProviderItem(Aws::Utils::Json::JsonView jsonValue);
  AWS_BEDROCKAGENTCORECONTROL_API PaymentCredentialProviderItem& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename NameT = Aws::String>
  PaymentCredentialProviderItem& WithName(NameT&& value) {
  ...
  inline PaymentCredentialProviderItem& WithCredentialProviderVendor(PaymentCredentialProviderVendorType value) {
  ...
  template <typename CredentialProviderArnT = Aws::String>
  PaymentCredentialProviderItem& WithCredentialProviderArn(CredentialProviderArnT&& value) {
  ...
  template <typename CreatedTimeT = Aws::Utils::DateTime>
  PaymentCredentialProviderItem& WithCreatedTime(CreatedTimeT&& value) {
  ...
  template <typename LastUpdatedTimeT = Aws::Utils::DateTime>
  PaymentCredentialProviderItem& WithLastUpdatedTime(LastUpdatedTimeT&& value) {
