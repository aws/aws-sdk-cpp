...
namespace Model {
class UpdatePaymentConnectorResult {
 public:
  AWS_BEDROCKAGENTCORECONTROL_API UpdatePaymentConnectorResult() = default;
  AWS_BEDROCKAGENTCORECONTROL_API UpdatePaymentConnectorResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_BEDROCKAGENTCORECONTROL_API UpdatePaymentConnectorResult& operator=(
  ...
  template <typename PaymentConnectorIdT = Aws::String>
  UpdatePaymentConnectorResult& WithPaymentConnectorId(PaymentConnectorIdT&& value) {
  ...
  template <typename PaymentManagerIdT = Aws::String>
  UpdatePaymentConnectorResult& WithPaymentManagerId(PaymentManagerIdT&& value) {
  ...
  template <typename NameT = Aws::String>
  UpdatePaymentConnectorResult& WithName(NameT&& value) {
  ...
  inline UpdatePaymentConnectorResult& WithType(PaymentConnectorType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename CredentialProviderConfigurationsT = Aws::Vector<CredentialsProviderConfiguration>>
  UpdatePaymentConnectorResult& WithCredentialProviderConfigurations(CredentialProviderConfigurationsT&& value) {
  ...
  UpdatePaymentConnectorResult& AddCredentialProviderConfigurations(CredentialProviderConfigurationsT&& value) {
    m_credentialProviderConfigurationsHasBeenSet = true;
  ...
  template <typename LastUpdatedAtT = Aws::Utils::DateTime>
  UpdatePaymentConnectorResult& WithLastUpdatedAt(LastUpdatedAtT&& value) {
  ...
  ///@{
  /**
   * <p>The current status of the updated payment connector. Possible values include
  ...
  inline UpdatePaymentConnectorResult& WithStatus(PaymentConnectorStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename AuthorizationUrlT = Aws::String>
  UpdatePaymentConnectorResult& WithAuthorizationUrl(AuthorizationUrlT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdatePaymentConnectorResult& WithRequestId(RequestIdT&& value) {
