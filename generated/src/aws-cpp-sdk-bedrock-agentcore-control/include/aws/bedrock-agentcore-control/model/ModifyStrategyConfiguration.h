...
class ModifyStrategyConfiguration {
 public:
  ...
  template <typename ExtractionT = ModifyExtractionConfiguration>
  ModifyStrategyConfiguration& WithExtraction(ExtractionT&& value) {
  ...
  template <typename ConsolidationT = ModifyConsolidationConfiguration>
  ModifyStrategyConfiguration& WithConsolidation(ConsolidationT&& value) {
  ...
  template <typename SelfManagedConfigurationT = ModifySelfManagedConfiguration>
  ModifyStrategyConfiguration& WithSelfManagedConfiguration(SelfManagedConfigurationT&& value) {
