...
class GetBrowserResult {
 public:
  ...
  template <typename BrowserIdT = Aws::String>
  GetBrowserResult& WithBrowserId(BrowserIdT&& value) {
  ...
  template <typename BrowserArnT = Aws::String>
  GetBrowserResult& WithBrowserArn(BrowserArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  GetBrowserResult& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  GetBrowserResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename ExecutionRoleArnT = Aws::String>
  GetBrowserResult& WithExecutionRoleArn(ExecutionRoleArnT&& value) {
  ...
  template <typename NetworkConfigurationT = BrowserNetworkConfiguration>
  GetBrowserResult& WithNetworkConfiguration(NetworkConfigurationT&& value) {
  ...
  template <typename RecordingT = RecordingConfig>
  GetBrowserResult& WithRecording(RecordingT&& value) {
  ...
  inline GetBrowserResult& WithStatus(BrowserStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename FailureReasonT = Aws::String>
  GetBrowserResult& WithFailureReason(FailureReasonT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  GetBrowserResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename LastUpdatedAtT = Aws::Utils::DateTime>
  GetBrowserResult& WithLastUpdatedAt(LastUpdatedAtT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetBrowserResult& WithRequestId(RequestIdT&& value) {
