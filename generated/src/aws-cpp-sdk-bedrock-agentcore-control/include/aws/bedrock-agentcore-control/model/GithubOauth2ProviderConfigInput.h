...
class GithubOauth2ProviderConfigInput {
 public:
  ...
  template <typename ClientIdT = Aws::String>
  GithubOauth2ProviderConfigInput& WithClientId(ClientIdT&& value) {
  ...
  template <typename ClientSecretT = Aws::String>
  GithubOauth2ProviderConfigInput& WithClientSecret(ClientSecretT&& value) {
  ...
  template <typename ClientSecretConfigT = SecretReference>
  GithubOauth2ProviderConfigInput& WithClientSecretConfig(ClientSecretConfigT&& value) {
  ...
  inline GithubOauth2ProviderConfigInput& WithClientSecretSource(SecretSourceType value) {
