...
class DeleteAgentRuntimeEndpointRequest : public BedrockAgentCoreControlRequest {
 public:
  ...
  template <typename AgentRuntimeIdT = Aws::String>
  DeleteAgentRuntimeEndpointRequest& WithAgentRuntimeId(AgentRuntimeIdT&& value) {
  ...
  template <typename EndpointNameT = Aws::String>
  DeleteAgentRuntimeEndpointRequest& WithEndpointName(EndpointNameT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  DeleteAgentRuntimeEndpointRequest& WithClientToken(ClientTokenT&& value) {
