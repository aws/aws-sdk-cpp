...
class GetAgentRuntimeEndpointResult {
 public:
  ...
  AWS_BEDROCKAGENTCORECONTROL_API GetAgentRuntimeEndpointResult& operator=(
  ...
  template <typename LiveVersionT = Aws::String>
  GetAgentRuntimeEndpointResult& WithLiveVersion(LiveVersionT&& value) {
  ...
  template <typename TargetVersionT = Aws::String>
  GetAgentRuntimeEndpointResult& WithTargetVersion(TargetVersionT&& value) {
  ...
  template <typename AgentRuntimeEndpointArnT = Aws::String>
  GetAgentRuntimeEndpointResult& WithAgentRuntimeEndpointArn(AgentRuntimeEndpointArnT&& value) {
  ...
  template <typename AgentRuntimeArnT = Aws::String>
  GetAgentRuntimeEndpointResult& WithAgentRuntimeArn(AgentRuntimeArnT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  GetAgentRuntimeEndpointResult& WithDescription(DescriptionT&& value) {
  ...
  inline GetAgentRuntimeEndpointResult& WithStatus(AgentRuntimeEndpointStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  GetAgentRuntimeEndpointResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename LastUpdatedAtT = Aws::Utils::DateTime>
  GetAgentRuntimeEndpointResult& WithLastUpdatedAt(LastUpdatedAtT&& value) {
  ...
  template <typename FailureReasonT = Aws::String>
  GetAgentRuntimeEndpointResult& WithFailureReason(FailureReasonT&& value) {
  ...
  template <typename NameT = Aws::String>
  GetAgentRuntimeEndpointResult& WithName(NameT&& value) {
  ...
  template <typename IdT = Aws::String>
  GetAgentRuntimeEndpointResult& WithId(IdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetAgentRuntimeEndpointResult& WithRequestId(RequestIdT&& value) {
