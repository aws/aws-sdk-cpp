 ...
 * API Reference</a></p>
 */
class UpdateGatewayRateLimitResult {
 public:
  AWS_BEDROCKAGENTCORECONTROL_API UpdateGatewayRateLimitResult() = default;
  AWS_BEDROCKAGENTCORECONTROL_API UpdateGatewayRateLimitResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_BEDROCKAGENTCORECONTROL_API UpdateGatewayRateLimitResult& operator=(
  ...
  template <typename RateLimitIdT = Aws::String>
  UpdateGatewayRateLimitResult& WithRateLimitId(RateLimitIdT&& value) {
  ...
  template <typename GatewayIdentifierT = Aws::String>
  UpdateGatewayRateLimitResult& WithGatewayIdentifier(GatewayIdentifierT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateGatewayRateLimitResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename DimensionKeysT = Aws::Vector<Aws::String>>
  UpdateGatewayRateLimitResult& WithDimensionKeys(DimensionKeysT&& value) {
    SetDimensionKeys(std::forward<DimensionKeysT>(value));
    return *this;
  }
  template <typename DimensionKeysT = Aws::String>
  UpdateGatewayRateLimitResult& AddDimensionKeys(DimensionKeysT&& value) {
    m_dimensionKeysHasBeenSet = true;
  ...
  template <typename EntriesT = Aws::Vector<LimitEntry>>
  UpdateGatewayRateLimitResult& WithEntries(EntriesT&& value) {
    SetEntries(std::forward<EntriesT>(value));
    return *this;
  }
  template <typename EntriesT = LimitEntry>
  UpdateGatewayRateLimitResult& AddEntries(EntriesT&& value) {
    m_entriesHasBeenSet = true;
  ...
  inline UpdateGatewayRateLimitResult& WithStatus(GatewayRateLimitStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  UpdateGatewayRateLimitResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  UpdateGatewayRateLimitResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateGatewayRateLimitResult& WithRequestId(RequestIdT&& value) {
