...
namespace Model {
class CreateConsentPortalResult {
 public:
  AWS_BEDROCKAGENTCORECONTROL_API CreateConsentPortalResult() = default;
  AWS_BEDROCKAGENTCORECONTROL_API CreateConsentPortalResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_BEDROCKAGENTCORECONTROL_API CreateConsentPortalResult& operator=(
  ...
  template <typename SourcesT = Aws::Vector<ConsentPortalSource>>
  CreateConsentPortalResult& WithSources(SourcesT&& value) {
    SetSources(std::forward<SourcesT>(value));
    return *this;
  }
  template <typename SourcesT = ConsentPortalSource>
  CreateConsentPortalResult& AddSources(SourcesT&& value) {
    m_sourcesHasBeenSet = true;
  ...
  template <typename ConsentPortalArnT = Aws::String>
  CreateConsentPortalResult& WithConsentPortalArn(ConsentPortalArnT&& value) {
  ...
  template <typename ConsentPortalIdT = Aws::String>
  CreateConsentPortalResult& WithConsentPortalId(ConsentPortalIdT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  CreateConsentPortalResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateConsentPortalResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename ExecutionRoleArnT = Aws::String>
  CreateConsentPortalResult& WithExecutionRoleArn(ExecutionRoleArnT&& value) {
  ...
  template <typename IdpConfigT = ConsentPortalIdpConfig>
  CreateConsentPortalResult& WithIdpConfig(IdpConfigT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateConsentPortalResult& WithName(NameT&& value) {
  ...
  template <typename PortalUrlT = Aws::String>
  CreateConsentPortalResult& WithPortalUrl(PortalUrlT&& value) {
  ...
  inline CreateConsentPortalResult& WithStatus(ConsentPortalStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonT = Aws::String>
  CreateConsentPortalResult& WithStatusReason(StatusReasonT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  CreateConsentPortalResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateConsentPortalResult& WithRequestId(RequestIdT&& value) {
