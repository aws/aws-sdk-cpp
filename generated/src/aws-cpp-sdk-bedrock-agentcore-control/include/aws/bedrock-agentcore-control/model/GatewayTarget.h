...
class GatewayTarget {
 public:
  ...
  template <typename GatewayArnT = Aws::String>
  GatewayTarget& WithGatewayArn(GatewayArnT&& value) {
  ...
  template <typename TargetIdT = Aws::String>
  GatewayTarget& WithTargetId(TargetIdT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  GatewayTarget& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  GatewayTarget& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  inline GatewayTarget& WithStatus(TargetStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonsT = Aws::Vector<Aws::String>>
  GatewayTarget& WithStatusReasons(StatusReasonsT&& value) {
    SetStatusReasons(std::forward<StatusReasonsT>(value));
    return *this;
  }
  template <typename StatusReasonsT = Aws::String>
  GatewayTarget& AddStatusReasons(StatusReasonsT&& value) {
    m_statusReasonsHasBeenSet = true;
  ...
  template <typename NameT = Aws::String>
  GatewayTarget& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  GatewayTarget& WithDescription(DescriptionT&& value) {
  ...
  template <typename TargetConfigurationT = TargetConfiguration>
  GatewayTarget& WithTargetConfiguration(TargetConfigurationT&& value) {
  ...
  template <typename CredentialProviderConfigurationsT = Aws::Vector<CredentialProviderConfiguration>>
  GatewayTarget& WithCredentialProviderConfigurations(CredentialProviderConfigurationsT&& value) {
  ...
  GatewayTarget& AddCredentialProviderConfigurations(CredentialProviderConfigurationsT&& value) {
    m_credentialProviderConfigurationsHasBeenSet = true;
  ...
  template <typename LastSynchronizedAtT = Aws::Utils::DateTime>
  GatewayTarget& WithLastSynchronizedAt(LastSynchronizedAtT&& value) {
  ...
  ///@{
  /**
   * <p>The metadata configuration for HTTP header and query parameter propagation to
   * and from this gateway target.</p>
   */
  ...
  template <typename MetadataConfigurationT = MetadataConfiguration>
  GatewayTarget& WithMetadataConfiguration(MetadataConfigurationT&& value) {
  ...
  template <typename PrivateEndpointT = PrivateEndpoint>
  GatewayTarget& WithPrivateEndpoint(PrivateEndpointT&& value) {
  ...
  ///@{
  /**
   * <p>A list of managed resources created by the gateway for private endpoint
   * connectivity. These resources are created in your account when you use a managed
   * VPC Lattice resource configuration.</p>
   */
  ...
  inline bool PrivateEndpointManagedResourcesHasBeenSet() const { return m_privateEndpointManagedResourcesHasBeenSet; }
  ...
  template <typename PrivateEndpointManagedResourcesT = Aws::Vector<ManagedResourceDetails>>
  GatewayTarget& WithPrivateEndpointManagedResources(PrivateEndpointManagedResourcesT&& value) {
  ...
  GatewayTarget& AddPrivateEndpointManagedResources(PrivateEndpointManagedResourcesT&& value) {
    m_privateEndpointManagedResourcesHasBeenSet = true;
  ...
  template <typename AuthorizationDataT = AuthorizationData>
  GatewayTarget& WithAuthorizationData(AuthorizationDataT&& value) {
