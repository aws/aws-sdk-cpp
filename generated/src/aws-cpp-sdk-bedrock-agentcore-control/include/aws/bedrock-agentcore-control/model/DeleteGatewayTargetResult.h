...
class DeleteGatewayTargetResult {
 public:
  ...
  AWS_BEDROCKAGENTCORECONTROL_API DeleteGatewayTargetResult& operator=(
  ...
  template <typename GatewayArnT = Aws::String>
  DeleteGatewayTargetResult& WithGatewayArn(GatewayArnT&& value) {
  ...
  template <typename TargetIdT = Aws::String>
  DeleteGatewayTargetResult& WithTargetId(TargetIdT&& value) {
  ...
  inline DeleteGatewayTargetResult& WithStatus(TargetStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonsT = Aws::Vector<Aws::String>>
  DeleteGatewayTargetResult& WithStatusReasons(StatusReasonsT&& value) {
    SetStatusReasons(std::forward<StatusReasonsT>(value));
    return *this;
  }
  template <typename StatusReasonsT = Aws::String>
  DeleteGatewayTargetResult& AddStatusReasons(StatusReasonsT&& value) {
    m_statusReasonsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DeleteGatewayTargetResult& WithRequestId(RequestIdT&& value) {
