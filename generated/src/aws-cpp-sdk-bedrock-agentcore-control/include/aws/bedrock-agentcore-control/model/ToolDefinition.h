...
class ToolDefinition {
 public:
  ...
  template <typename NameT = Aws::String>
  ToolDefinition& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  ToolDefinition& WithDescription(DescriptionT&& value) {
  ...
  template <typename InputSchemaT = SchemaDefinition>
  ToolDefinition& WithInputSchema(InputSchemaT&& value) {
  ...
  template <typename OutputSchemaT = SchemaDefinition>
  ToolDefinition& WithOutputSchema(OutputSchemaT&& value) {
