...
class UpdateWorkloadIdentityResult {
 public:
  ...
  AWS_BEDROCKAGENTCORECONTROL_API UpdateWorkloadIdentityResult& operator=(
  ...
  template <typename NameT = Aws::String>
  UpdateWorkloadIdentityResult& WithName(NameT&& value) {
  ...
  template <typename WorkloadIdentityArnT = Aws::String>
  UpdateWorkloadIdentityResult& WithWorkloadIdentityArn(WorkloadIdentityArnT&& value) {
  ...
  template <typename AllowedResourceOauth2ReturnUrlsT = Aws::Vector<Aws::String>>
  UpdateWorkloadIdentityResult& WithAllowedResourceOauth2ReturnUrls(AllowedResourceOauth2ReturnUrlsT&& value) {
  ...
  UpdateWorkloadIdentityResult& AddAllowedResourceOauth2ReturnUrls(AllowedResourceOauth2ReturnUrlsT&& value) {
    m_allowedResourceOauth2ReturnUrlsHasBeenSet = true;
  ...
  template <typename CreatedTimeT = Aws::Utils::DateTime>
  UpdateWorkloadIdentityResult& WithCreatedTime(CreatedTimeT&& value) {
  ...
  template <typename LastUpdatedTimeT = Aws::Utils::DateTime>
  UpdateWorkloadIdentityResult& WithLastUpdatedTime(LastUpdatedTimeT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateWorkloadIdentityResult& WithRequestId(RequestIdT&& value) {
