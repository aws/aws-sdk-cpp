...
class GetConfigurationBundleResult {
 public:
  AWS_BEDROCKAGENTCORECONTROL_API GetConfigurationBundleResult() = default;
  AWS_BEDROCKAGENTCORECONTROL_API GetConfigurationBundleResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_BEDROCKAGENTCORECONTROL_API GetConfigurationBundleResult& operator=(
  ...
  template <typename BundleArnT = Aws::String>
  GetConfigurationBundleResult& WithBundleArn(BundleArnT&& value) {
  ...
  template <typename BundleIdT = Aws::String>
  GetConfigurationBundleResult& WithBundleId(BundleIdT&& value) {
  ...
  template <typename BundleNameT = Aws::String>
  GetConfigurationBundleResult& WithBundleName(BundleNameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  GetConfigurationBundleResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename VersionIdT = Aws::String>
  GetConfigurationBundleResult& WithVersionId(VersionIdT&& value) {
  ...
  template <typename ComponentsT = Aws::Map<Aws::String, ComponentConfiguration>>
  GetConfigurationBundleResult& WithComponents(ComponentsT&& value) {
  ...
  GetConfigurationBundleResult& AddComponents(ComponentsKeyT&& key, ComponentsValueT&& value) {
    m_componentsHasBeenSet = true;
  ...
  template <typename LineageMetadataT = VersionLineageMetadata>
  GetConfigurationBundleResult& WithLineageMetadata(LineageMetadataT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  GetConfigurationBundleResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  GetConfigurationBundleResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetConfigurationBundleResult& WithRequestId(RequestIdT&& value) {
