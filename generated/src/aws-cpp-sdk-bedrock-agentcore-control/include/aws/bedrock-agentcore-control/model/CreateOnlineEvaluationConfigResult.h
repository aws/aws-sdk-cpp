...
namespace Model {
class CreateOnlineEvaluationConfigResult {
 public:
  AWS_BEDROCKAGENTCORECONTROL_API CreateOnlineEvaluationConfigResult() = default;
  AWS_BEDROCKAGENTCORECONTROL_API CreateOnlineEvaluationConfigResult(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_BEDROCKAGENTCORECONTROL_API CreateOnlineEvaluationConfigResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);

  ///@{
  /**
   * <p> The Amazon Resource Name (ARN) of the created online evaluation
   * configuration. </p>
   */
  ...
  template <typename OnlineEvaluationConfigArnT = Aws::String>
  CreateOnlineEvaluationConfigResult& WithOnlineEvaluationConfigArn(OnlineEvaluationConfigArnT&& value) {
  ...
  template <typename OnlineEvaluationConfigIdT = Aws::String>
  CreateOnlineEvaluationConfigResult& WithOnlineEvaluationConfigId(OnlineEvaluationConfigIdT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  CreateOnlineEvaluationConfigResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename OutputConfigT = OutputConfig>
  CreateOnlineEvaluationConfigResult& WithOutputConfig(OutputConfigT&& value) {
  ...
  inline CreateOnlineEvaluationConfigResult& WithStatus(OnlineEvaluationConfigStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline CreateOnlineEvaluationConfigResult& WithExecutionStatus(OnlineEvaluationExecutionStatus value) {
  ...
  ///@{
  /**
   * <p> The reason for failure if the online evaluation configuration creation or
   * execution failed. </p>
   */
  ...
  template <typename FailureReasonT = Aws::String>
  CreateOnlineEvaluationConfigResult& WithFailureReason(FailureReasonT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateOnlineEvaluationConfigResult& WithRequestId(RequestIdT&& value) {
