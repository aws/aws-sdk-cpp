...
class MCPGatewayConfiguration {
 public:
  ...
  template <typename SupportedVersionsT = Aws::Vector<Aws::String>>
  MCPGatewayConfiguration& WithSupportedVersions(SupportedVersionsT&& value) {
    SetSupportedVersions(std::forward<SupportedVersionsT>(value));
    return *this;
  }
  template <typename SupportedVersionsT = Aws::String>
  MCPGatewayConfiguration& AddSupportedVersions(SupportedVersionsT&& value) {
    m_supportedVersionsHasBeenSet = true;
  ...
  template <typename InstructionsT = Aws::String>
  MCPGatewayConfiguration& WithInstructions(InstructionsT&& value) {
  ...
  inline MCPGatewayConfiguration& WithSearchType(SearchType value) {
    SetSearchType(value);
    return *this;
  }
  ///@}
