...
/**
 */
class ListPolicySummariesRequest : public BedrockAgentCoreControlRequest {
 public:
  AWS_BEDROCKAGENTCORECONTROL_API ListPolicySummariesRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "ListPolicySummaries"; }
  ...
  template <typename NextTokenT = Aws::String>
  ListPolicySummariesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListPolicySummariesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename PolicyEngineIdT = Aws::String>
  ListPolicySummariesRequest& WithPolicyEngineId(PolicyEngineIdT&& value) {
  ...
  ///@{
  /**
   * <p>Optional filter to list policy summaries that apply to a specific resource
  ...
  template <typename TargetResourceScopeT = Aws::String>
  ListPolicySummariesRequest& WithTargetResourceScope(TargetResourceScopeT&& value) {
