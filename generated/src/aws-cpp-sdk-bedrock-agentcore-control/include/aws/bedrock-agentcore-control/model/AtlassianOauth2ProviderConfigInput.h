...
class AtlassianOauth2ProviderConfigInput {
 public:
  ...
  template <typename ClientIdT = Aws::String>
  AtlassianOauth2ProviderConfigInput& WithClientId(ClientIdT&& value) {
  ...
  template <typename ClientSecretT = Aws::String>
  AtlassianOauth2ProviderConfigInput& WithClientSecret(ClientSecretT&& value) {
  ...
  template <typename ClientSecretConfigT = SecretReference>
  AtlassianOauth2ProviderConfigInput& WithClientSecretConfig(ClientSecretConfigT&& value) {
  ...
  ///@{
  /**
   * <p>The source type of the client secret for the Atlassian OAuth2 provider. Use
  ...
  inline AtlassianOauth2ProviderConfigInput& WithClientSecretSource(SecretSourceType value) {
