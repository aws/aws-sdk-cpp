...
namespace Model {
/**
 * <p>Create response excludes updatedAt (redundant on create). Get/Update
 * responses include it via their own output structures.</p><p><h3>See Also:</h3>
 * <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/bedrock-agentcore-control-2023-06-05/UpdateGatewayRuleResponse">AWS
 * API Reference</a></p>
 */
class UpdateGatewayRuleResult {
 public:
  AWS_BEDROCKAGENTCORECONTROL_API UpdateGatewayRuleResult() = default;
  AWS_BEDROCKAGENTCORECONTROL_API UpdateGatewayRuleResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_BEDROCKAGENTCORECONTROL_API UpdateGatewayRuleResult& operator=(
  ...
  template <typename RuleIdT = Aws::String>
  UpdateGatewayRuleResult& WithRuleId(RuleIdT&& value) {
  ...
  template <typename GatewayArnT = Aws::String>
  UpdateGatewayRuleResult& WithGatewayArn(GatewayArnT&& value) {
  ...
  inline UpdateGatewayRuleResult& WithPriority(int value) {
    SetPriority(value);
    return *this;
  }
  ///@}
  ...
  template <typename ConditionsT = Aws::Vector<Condition>>
  UpdateGatewayRuleResult& WithConditions(ConditionsT&& value) {
    SetConditions(std::forward<ConditionsT>(value));
    return *this;
  }
  template <typename ConditionsT = Condition>
  UpdateGatewayRuleResult& AddConditions(ConditionsT&& value) {
    m_conditionsHasBeenSet = true;
  ...
  template <typename ActionsT = Aws::Vector<Action>>
  UpdateGatewayRuleResult& WithActions(ActionsT&& value) {
    SetActions(std::forward<ActionsT>(value));
    return *this;
  }
  template <typename ActionsT = Action>
  UpdateGatewayRuleResult& AddActions(ActionsT&& value) {
    m_actionsHasBeenSet = true;
  ...
  template <typename DescriptionT = Aws::String>
  UpdateGatewayRuleResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  UpdateGatewayRuleResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  inline UpdateGatewayRuleResult& WithStatus(GatewayRuleStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename SystemT = SystemManagedBlock>
  UpdateGatewayRuleResult& WithSystem(SystemT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  UpdateGatewayRuleResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateGatewayRuleResult& WithRequestId(RequestIdT&& value) {
