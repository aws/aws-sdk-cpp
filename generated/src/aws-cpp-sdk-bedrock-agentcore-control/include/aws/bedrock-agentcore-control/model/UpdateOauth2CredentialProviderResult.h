...
class UpdateOauth2CredentialProviderResult {
 public:
  ...
  AWS_BEDROCKAGENTCORECONTROL_API UpdateOauth2CredentialProviderResult(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_BEDROCKAGENTCORECONTROL_API UpdateOauth2CredentialProviderResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename NameT = Aws::String>
  UpdateOauth2CredentialProviderResult& WithName(NameT&& value) {
  ...
  inline UpdateOauth2CredentialProviderResult& WithCredentialProviderVendor(CredentialProviderVendorType value) {
  ...
  template <typename CredentialProviderArnT = Aws::String>
  UpdateOauth2CredentialProviderResult& WithCredentialProviderArn(CredentialProviderArnT&& value) {
  ...
  template <typename CallbackUrlT = Aws::String>
  UpdateOauth2CredentialProviderResult& WithCallbackUrl(CallbackUrlT&& value) {
  ...
  template <typename Oauth2ProviderConfigOutputT = Oauth2ProviderConfigOutput>
  UpdateOauth2CredentialProviderResult& WithOauth2ProviderConfigOutput(Oauth2ProviderConfigOutputT&& value) {
  ...
  template <typename CreatedTimeT = Aws::Utils::DateTime>
  UpdateOauth2CredentialProviderResult& WithCreatedTime(CreatedTimeT&& value) {
  ...
  template <typename LastUpdatedTimeT = Aws::Utils::DateTime>
  UpdateOauth2CredentialProviderResult& WithLastUpdatedTime(LastUpdatedTimeT&& value) {
  ...
  inline UpdateOauth2CredentialProviderResult& WithStatus(Status value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  UpdateOauth2CredentialProviderResult& WithRequestId(RequestIdT&& value) {
