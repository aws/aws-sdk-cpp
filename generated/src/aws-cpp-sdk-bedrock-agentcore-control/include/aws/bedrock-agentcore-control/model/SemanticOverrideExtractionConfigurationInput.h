...
class SemanticOverrideExtractionConfigurationInput {
 public:
  ...
  template <typename AppendToPromptT = Aws::String>
  SemanticOverrideExtractionConfigurationInput& WithAppendToPrompt(AppendToPromptT&& value) {
  ...
  template <typename ModelIdT = Aws::String>
  SemanticOverrideExtractionConfigurationInput& WithModelId(ModelIdT&& value) {
