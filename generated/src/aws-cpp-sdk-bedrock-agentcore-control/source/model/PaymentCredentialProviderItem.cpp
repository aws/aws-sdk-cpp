...
PaymentCredentialProviderItem::PaymentCredentialProviderItem(JsonView jsonValue) { *this = jsonValue; }

PaymentCredentialProviderItem& PaymentCredentialProviderItem::operator=(JsonView jsonValue) {
...
JsonValue PaymentCredentialProviderItem::Jsonize() const {
  JsonValue payload;
