...
SelfManagedConfigurationInput::SelfManagedConfigurationInput(JsonView jsonValue) { *this = jsonValue; }

SelfManagedConfigurationInput& SelfManagedConfigurationInput::operator=(JsonView jsonValue) {
...
JsonValue SelfManagedConfigurationInput::Jsonize() const {
  JsonValue payload;
