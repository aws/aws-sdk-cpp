...
McpToolSchemaConfiguration::McpToolSchemaConfiguration(JsonView jsonValue) { *this = jsonValue; }

McpToolSchemaConfiguration& McpToolSchemaConfiguration::operator=(JsonView jsonValue) {
...
JsonValue McpToolSchemaConfiguration::Jsonize() const {
  JsonValue payload;
