...
UpdatePaymentManagerResult::UpdatePaymentManagerResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

UpdatePaymentManagerResult& UpdatePaymentManagerResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
