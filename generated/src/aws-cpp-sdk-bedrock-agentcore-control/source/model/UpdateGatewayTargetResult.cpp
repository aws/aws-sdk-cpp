...
UpdateGatewayTargetResult::UpdateGatewayTargetResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

UpdateGatewayTargetResult& UpdateGatewayTargetResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
