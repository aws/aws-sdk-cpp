...
EpisodicConsolidationOverride::EpisodicConsolidationOverride(JsonView jsonValue) { *this = jsonValue; }

EpisodicConsolidationOverride& EpisodicConsolidationOverride::operator=(JsonView jsonValue) {
...
JsonValue EpisodicConsolidationOverride::Jsonize() const {
  JsonValue payload;
