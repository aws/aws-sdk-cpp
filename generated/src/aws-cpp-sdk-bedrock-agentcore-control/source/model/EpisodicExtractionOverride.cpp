...
EpisodicExtractionOverride::EpisodicExtractionOverride(JsonView jsonValue) { *this = jsonValue; }

EpisodicExtractionOverride& EpisodicExtractionOverride::operator=(JsonView jsonValue) {
...
JsonValue EpisodicExtractionOverride::Jsonize() const {
  JsonValue payload;
