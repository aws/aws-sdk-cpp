...
ModifyInvocationConfigurationInput::ModifyInvocationConfigurationInput(JsonView jsonValue) { *this = jsonValue; }

ModifyInvocationConfigurationInput& ModifyInvocationConfigurationInput::operator=(JsonView jsonValue) {
...
JsonValue ModifyInvocationConfigurationInput::Jsonize() const {
  JsonValue payload;
