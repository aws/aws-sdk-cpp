...
GetPolicyGenerationSummaryResult::GetPolicyGenerationSummaryResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

GetPolicyGenerationSummaryResult& GetPolicyGenerationSummaryResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
