...
DeleteConfigurationBundleResult::DeleteConfigurationBundleResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
DeleteConfigurationBundleResult& DeleteConfigurationBundleResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("status")) {
    m_status = ConfigurationBundleStatusMapper::GetConfigurationBundleStatusForName(jsonValue.GetString("status"));
