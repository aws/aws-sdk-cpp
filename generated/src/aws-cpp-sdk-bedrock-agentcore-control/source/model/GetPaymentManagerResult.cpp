...
GetPaymentManagerResult::GetPaymentManagerResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

GetPaymentManagerResult& GetPaymentManagerResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
