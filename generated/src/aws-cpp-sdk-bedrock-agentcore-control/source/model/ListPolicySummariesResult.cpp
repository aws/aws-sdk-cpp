...
ListPolicySummariesResult::ListPolicySummariesResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

ListPolicySummariesResult& ListPolicySummariesResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
