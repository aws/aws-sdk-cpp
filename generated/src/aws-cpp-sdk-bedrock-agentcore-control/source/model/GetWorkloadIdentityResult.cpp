...
GetWorkloadIdentityResult::GetWorkloadIdentityResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

GetWorkloadIdentityResult& GetWorkloadIdentityResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
