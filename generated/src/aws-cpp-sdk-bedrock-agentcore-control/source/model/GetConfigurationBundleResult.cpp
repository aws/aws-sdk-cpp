...
GetConfigurationBundleResult::GetConfigurationBundleResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

GetConfigurationBundleResult& GetConfigurationBundleResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
