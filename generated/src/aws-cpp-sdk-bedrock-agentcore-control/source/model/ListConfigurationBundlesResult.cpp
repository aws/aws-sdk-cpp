...
ListConfigurationBundlesResult::ListConfigurationBundlesResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

ListConfigurationBundlesResult& ListConfigurationBundlesResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
