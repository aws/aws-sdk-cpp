...
ConfigurationBundleReference::ConfigurationBundleReference(JsonView jsonValue) { *this = jsonValue; }

ConfigurationBundleReference& ConfigurationBundleReference::operator=(JsonView jsonValue) {
...
JsonValue ConfigurationBundleReference::Jsonize() const {
  JsonValue payload;
