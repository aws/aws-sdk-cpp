...
UpdatedSkillDefinition::UpdatedSkillDefinition(JsonView jsonValue) { *this = jsonValue; }

UpdatedSkillDefinition& UpdatedSkillDefinition::operator=(JsonView jsonValue) {
...
JsonValue UpdatedSkillDefinition::Jsonize() const {
  JsonValue payload;
