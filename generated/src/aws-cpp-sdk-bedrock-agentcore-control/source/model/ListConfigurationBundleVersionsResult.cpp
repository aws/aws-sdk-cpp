...
ListConfigurationBundleVersionsResult::ListConfigurationBundleVersionsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

ListConfigurationBundleVersionsResult& ListConfigurationBundleVersionsResult::operator=(
