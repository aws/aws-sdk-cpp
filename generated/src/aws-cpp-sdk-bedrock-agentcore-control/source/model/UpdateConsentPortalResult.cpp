...
UpdateConsentPortalResult::UpdateConsentPortalResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

UpdateConsentPortalResult& UpdateConsentPortalResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
