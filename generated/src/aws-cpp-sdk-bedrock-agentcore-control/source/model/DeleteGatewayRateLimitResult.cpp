...
DeleteGatewayRateLimitResult::DeleteGatewayRateLimitResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

DeleteGatewayRateLimitResult& DeleteGatewayRateLimitResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
