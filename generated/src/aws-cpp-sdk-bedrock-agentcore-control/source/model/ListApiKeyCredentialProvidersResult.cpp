...
ListApiKeyCredentialProvidersResult::ListApiKeyCredentialProvidersResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
...
ListApiKeyCredentialProvidersResult& ListApiKeyCredentialProvidersResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  ...
  if(jsonValue.ValueExists("credentialProviders"))
  {
    ...
    for(unsigned credentialProvidersIndex = 0; credentialProvidersIndex < credentialProvidersJsonList.GetLength(); ++credentialProvidersIndex)
    {
