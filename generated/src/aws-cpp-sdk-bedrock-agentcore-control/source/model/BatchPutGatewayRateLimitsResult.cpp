...
BatchPutGatewayRateLimitsResult::BatchPutGatewayRateLimitsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

BatchPutGatewayRateLimitsResult& BatchPutGatewayRateLimitsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
