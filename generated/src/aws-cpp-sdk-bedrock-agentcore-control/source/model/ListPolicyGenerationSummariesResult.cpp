...
ListPolicyGenerationSummariesResult::ListPolicyGenerationSummariesResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

ListPolicyGenerationSummariesResult& ListPolicyGenerationSummariesResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
