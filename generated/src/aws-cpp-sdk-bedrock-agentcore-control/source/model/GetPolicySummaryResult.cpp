...
GetPolicySummaryResult::GetPolicySummaryResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

GetPolicySummaryResult& GetPolicySummaryResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
