...
SemanticMemoryStrategyInput::SemanticMemoryStrategyInput(JsonView jsonValue) { *this = jsonValue; }

SemanticMemoryStrategyInput& SemanticMemoryStrategyInput::operator=(JsonView jsonValue) {
...
JsonValue SemanticMemoryStrategyInput::Jsonize() const {
  JsonValue payload;
