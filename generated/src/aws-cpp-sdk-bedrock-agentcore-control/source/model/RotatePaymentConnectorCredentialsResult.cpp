...
RotatePaymentConnectorCredentialsResult::RotatePaymentConnectorCredentialsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

RotatePaymentConnectorCredentialsResult& RotatePaymentConnectorCredentialsResult::operator=(
