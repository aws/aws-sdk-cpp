...
UpdatedServerDefinition::UpdatedServerDefinition(JsonView jsonValue) { *this = jsonValue; }

UpdatedServerDefinition& UpdatedServerDefinition::operator=(JsonView jsonValue) {
...
JsonValue UpdatedServerDefinition::Jsonize() const {
  JsonValue payload;
