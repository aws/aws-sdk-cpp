...
CreateGatewayResult::CreateGatewayResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

CreateGatewayResult& CreateGatewayResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
