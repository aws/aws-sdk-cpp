...
GetGatewayRateLimitResult::GetGatewayRateLimitResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

GetGatewayRateLimitResult& GetGatewayRateLimitResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
