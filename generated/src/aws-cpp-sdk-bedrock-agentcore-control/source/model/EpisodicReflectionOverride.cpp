...
EpisodicReflectionOverride::EpisodicReflectionOverride(JsonView jsonValue) { *this = jsonValue; }

EpisodicReflectionOverride& EpisodicReflectionOverride::operator=(JsonView jsonValue) {
...
JsonValue EpisodicReflectionOverride::Jsonize() const {
  JsonValue payload;
