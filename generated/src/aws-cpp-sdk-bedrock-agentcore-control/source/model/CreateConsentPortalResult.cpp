...
CreateConsentPortalResult::CreateConsentPortalResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

CreateConsentPortalResult& CreateConsentPortalResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
