...
CreateGatewayRateLimitResult::CreateGatewayRateLimitResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

CreateGatewayRateLimitResult& CreateGatewayRateLimitResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
