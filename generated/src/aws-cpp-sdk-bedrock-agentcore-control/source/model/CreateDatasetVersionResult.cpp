...
CreateDatasetVersionResult::CreateDatasetVersionResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

CreateDatasetVersionResult& CreateDatasetVersionResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
