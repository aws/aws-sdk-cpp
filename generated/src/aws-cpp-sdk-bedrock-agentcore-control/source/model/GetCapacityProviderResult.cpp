...
GetCapacityProviderResult& GetCapacityProviderResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("statusCode")) {
    m_statusCode = CapacityProviderStatusCodeMapper::GetCapacityProviderStatusCodeForName(jsonValue.GetString("statusCode"));
  ...
  if (jsonValue.ValueExists("permissionsConfiguration")) {
    m_permissionsConfiguration = jsonValue.GetObject("permissionsConfiguration");
