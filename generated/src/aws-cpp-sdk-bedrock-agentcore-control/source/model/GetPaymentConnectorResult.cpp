...
GetPaymentConnectorResult::GetPaymentConnectorResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

GetPaymentConnectorResult& GetPaymentConnectorResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
