...
DeletePaymentConnectorResult::DeletePaymentConnectorResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

DeletePaymentConnectorResult& DeletePaymentConnectorResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
