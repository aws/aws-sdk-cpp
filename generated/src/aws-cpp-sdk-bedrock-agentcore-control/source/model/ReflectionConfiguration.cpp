...
ReflectionConfiguration::ReflectionConfiguration(JsonView jsonValue) { *this = jsonValue; }

ReflectionConfiguration& ReflectionConfiguration::operator=(JsonView jsonValue) {
...
JsonValue ReflectionConfiguration::Jsonize() const {
  JsonValue payload;
