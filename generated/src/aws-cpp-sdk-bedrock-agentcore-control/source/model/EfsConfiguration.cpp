...
EfsConfiguration::EfsConfiguration(JsonView jsonValue) { *this = jsonValue; }

EfsConfiguration& EfsConfiguration::operator=(JsonView jsonValue) {
...
JsonValue EfsConfiguration::Jsonize() const {
  JsonValue payload;
