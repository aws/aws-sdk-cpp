...
UpdateGatewayRuleResult::UpdateGatewayRuleResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

UpdateGatewayRuleResult& UpdateGatewayRuleResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
