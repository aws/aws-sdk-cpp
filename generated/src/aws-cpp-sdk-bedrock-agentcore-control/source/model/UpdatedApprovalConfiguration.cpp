...
UpdatedApprovalConfiguration::UpdatedApprovalConfiguration(JsonView jsonValue) { *this = jsonValue; }

UpdatedApprovalConfiguration& UpdatedApprovalConfiguration::operator=(JsonView jsonValue) {
...
JsonValue UpdatedApprovalConfiguration::Jsonize() const {
  JsonValue payload;
