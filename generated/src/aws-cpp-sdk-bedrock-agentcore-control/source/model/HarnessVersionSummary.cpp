...
HarnessVersionSummary::HarnessVersionSummary(JsonView jsonValue) { *this = jsonValue; }

HarnessVersionSummary& HarnessVersionSummary::operator=(JsonView jsonValue) {
...
JsonValue HarnessVersionSummary::Jsonize() const {
  JsonValue payload;
