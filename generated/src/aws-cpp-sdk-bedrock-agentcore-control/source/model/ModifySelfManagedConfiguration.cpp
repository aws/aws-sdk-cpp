...
ModifySelfManagedConfiguration::ModifySelfManagedConfiguration(JsonView jsonValue) { *this = jsonValue; }

ModifySelfManagedConfiguration& ModifySelfManagedConfiguration::operator=(JsonView jsonValue) {
...
JsonValue ModifySelfManagedConfiguration::Jsonize() const {
  JsonValue payload;
