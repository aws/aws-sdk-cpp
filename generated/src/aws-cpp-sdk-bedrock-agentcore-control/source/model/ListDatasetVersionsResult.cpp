...
ListDatasetVersionsResult::ListDatasetVersionsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

ListDatasetVersionsResult& ListDatasetVersionsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
