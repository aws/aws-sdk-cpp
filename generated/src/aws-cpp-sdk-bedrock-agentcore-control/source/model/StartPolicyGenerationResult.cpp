...
StartPolicyGenerationResult::StartPolicyGenerationResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

StartPolicyGenerationResult& StartPolicyGenerationResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
