...
DeletePaymentManagerResult::DeletePaymentManagerResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

DeletePaymentManagerResult& DeletePaymentManagerResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
