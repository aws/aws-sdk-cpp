...
WeightedRoute::WeightedRoute(JsonView jsonValue) { *this = jsonValue; }

WeightedRoute& WeightedRoute::operator=(JsonView jsonValue) {
...
JsonValue WeightedRoute::Jsonize() const {
  JsonValue payload;
