...
HttpConnectorSource::HttpConnectorSource(JsonView jsonValue) { *this = jsonValue; }

HttpConnectorSource& HttpConnectorSource::operator=(JsonView jsonValue) {
...
JsonValue HttpConnectorSource::Jsonize() const {
  JsonValue payload;
