...
GetPolicyEngineSummaryResult::GetPolicyEngineSummaryResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

GetPolicyEngineSummaryResult& GetPolicyEngineSummaryResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
