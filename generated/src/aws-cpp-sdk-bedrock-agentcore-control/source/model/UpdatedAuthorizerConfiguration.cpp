...
UpdatedAuthorizerConfiguration::UpdatedAuthorizerConfiguration(JsonView jsonValue) { *this = jsonValue; }

UpdatedAuthorizerConfiguration& UpdatedAuthorizerConfiguration::operator=(JsonView jsonValue) {
...
JsonValue UpdatedAuthorizerConfiguration::Jsonize() const {
  JsonValue payload;
