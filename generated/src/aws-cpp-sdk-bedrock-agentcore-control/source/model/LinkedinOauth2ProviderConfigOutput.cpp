...
LinkedinOauth2ProviderConfigOutput::LinkedinOauth2ProviderConfigOutput(JsonView jsonValue) { *this = jsonValue; }

LinkedinOauth2ProviderConfigOutput& LinkedinOauth2ProviderConfigOutput::operator=(JsonView jsonValue) {
...
JsonValue LinkedinOauth2ProviderConfigOutput::Jsonize() const {
  JsonValue payload;
