...
ListHarnessEndpointsResult::ListHarnessEndpointsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

ListHarnessEndpointsResult& ListHarnessEndpointsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
