...
EpisodicMemoryStrategyInput::EpisodicMemoryStrategyInput(JsonView jsonValue) { *this = jsonValue; }

EpisodicMemoryStrategyInput& EpisodicMemoryStrategyInput::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("reflectionConfiguration")) {
...
JsonValue EpisodicMemoryStrategyInput::Jsonize() const {
  JsonValue payload;
