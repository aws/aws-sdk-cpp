...
GetPaymentCredentialProviderResult::GetPaymentCredentialProviderResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

GetPaymentCredentialProviderResult& GetPaymentCredentialProviderResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
