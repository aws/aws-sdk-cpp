...
HarnessRemoteMcpConfig::HarnessRemoteMcpConfig(JsonView jsonValue) { *this = jsonValue; }

HarnessRemoteMcpConfig& HarnessRemoteMcpConfig::operator=(JsonView jsonValue) {
...
JsonValue HarnessRemoteMcpConfig::Jsonize() const {
  JsonValue payload;
