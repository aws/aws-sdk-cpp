...
TargetTrafficSplitEntry::TargetTrafficSplitEntry(JsonView jsonValue) { *this = jsonValue; }

TargetTrafficSplitEntry& TargetTrafficSplitEntry::operator=(JsonView jsonValue) {
...
JsonValue TargetTrafficSplitEntry::Jsonize() const {
  JsonValue payload;
