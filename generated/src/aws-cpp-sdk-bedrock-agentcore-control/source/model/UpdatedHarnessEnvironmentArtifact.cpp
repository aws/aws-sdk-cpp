...
UpdatedHarnessEnvironmentArtifact::UpdatedHarnessEnvironmentArtifact(JsonView jsonValue) { *this = jsonValue; }

UpdatedHarnessEnvironmentArtifact& UpdatedHarnessEnvironmentArtifact::operator=(JsonView jsonValue) {
...
JsonValue UpdatedHarnessEnvironmentArtifact::Jsonize() const {
  JsonValue payload;
