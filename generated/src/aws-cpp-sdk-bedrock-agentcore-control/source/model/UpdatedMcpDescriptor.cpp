...
UpdatedMcpDescriptor::UpdatedMcpDescriptor(JsonView jsonValue) { *this = jsonValue; }

UpdatedMcpDescriptor& UpdatedMcpDescriptor::operator=(JsonView jsonValue) {
...
JsonValue UpdatedMcpDescriptor::Jsonize() const {
  JsonValue payload;
