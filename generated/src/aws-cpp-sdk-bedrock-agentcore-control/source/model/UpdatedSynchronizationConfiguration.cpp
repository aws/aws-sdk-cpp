...
UpdatedSynchronizationConfiguration::UpdatedSynchronizationConfiguration(JsonView jsonValue) { *this = jsonValue; }

UpdatedSynchronizationConfiguration& UpdatedSynchronizationConfiguration::operator=(JsonView jsonValue) {
...
JsonValue UpdatedSynchronizationConfiguration::Jsonize() const {
  JsonValue payload;
