...
HarnessEnvironmentProviderRequest::HarnessEnvironmentProviderRequest(JsonView jsonValue) { *this = jsonValue; }

HarnessEnvironmentProviderRequest& HarnessEnvironmentProviderRequest::operator=(JsonView jsonValue) {
...
JsonValue HarnessEnvironmentProviderRequest::Jsonize() const {
  JsonValue payload;
