...
GetGatewayRuleResult::GetGatewayRuleResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

GetGatewayRuleResult& GetGatewayRuleResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
