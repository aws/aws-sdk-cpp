...
template <>
AWS_BEDROCKAGENTCORECONTROL_API ValidationException BedrockAgentCoreControlError::GetModeledError() {
...
AWSError<CoreErrors> GetErrorForName(const char* errorName) {
  ...
  if (hashCode == CONFLICT_HASH) {
    ...
    return AWSError<CoreErrors>(static_cast<CoreErrors>(BedrockAgentCoreControlErrors::SERVICE_QUOTA_EXCEEDED),
    ...
    return AWSError<CoreErrors>(static_cast<CoreErrors>(BedrockAgentCoreControlErrors::RESOURCE_LIMIT_EXCEEDED),
                                RetryableType::NOT_RETRYABLE);
    ...
    return AWSError<CoreErrors>(static_cast<CoreErrors>(BedrockAgentCoreControlErrors::CONCURRENT_MODIFICATION),
                                RetryableType::NOT_RETRYABLE);
