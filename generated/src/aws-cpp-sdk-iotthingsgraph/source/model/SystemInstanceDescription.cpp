...
SystemInstanceDescription::SystemInstanceDescription(JsonView jsonValue) { *this = jsonValue; }
...
SystemInstanceDescription& SystemInstanceDescription::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("validatedDependencyRevisions")) {
    ...
    for (unsigned validatedDependencyRevisionsIndex = 0;
         validatedDependencyRevisionsIndex < validatedDependencyRevisionsJsonList.GetLength(); ++validatedDependencyRevisionsIndex) {
...
JsonValue SystemInstanceDescription::Jsonize() const {
  ...
  if (m_validatedDependencyRevisionsHasBeenSet) {
    ...
    for (unsigned validatedDependencyRevisionsIndex = 0;
         validatedDependencyRevisionsIndex < validatedDependencyRevisionsJsonList.GetLength(); ++validatedDependencyRevisionsIndex) {
      validatedDependencyRevisionsJsonList[validatedDependencyRevisionsIndex].AsObject(
          m_validatedDependencyRevisions[validatedDependencyRevisionsIndex].Jsonize());
    }
