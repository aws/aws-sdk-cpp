...
IoTThingsGraphClient::IoTThingsGraphClient(const Aws::Client::ClientConfiguration& clientConfiguration)
    : BASECLASS(clientConfiguration,
                Aws::MakeShared<AWSAuthV4Signer>(
                    ALLOCATION_TAG,
                    Aws::MakeShared<DefaultAWSCredentialsProviderChain>(ALLOCATION_TAG, clientConfiguration.credentialProviderConfig),
...
IoTThingsGraphClient::IoTThingsGraphClient(const AWSCredentials& credentials, const Aws::Client::ClientConfiguration& clientConfiguration)
    : BASECLASS(clientConfiguration,
                Aws::MakeShared<AWSAuthV4Signer>(ALLOCATION_TAG, Aws::MakeShared<SimpleAWSCredentialsProvider>(ALLOCATION_TAG, credentials),
                                                 SERVICE_NAME, Aws::Region::ComputeSignerRegion(clientConfiguration.region)),
                Aws::MakeShared<IoTThingsGraphErrorMarshaller>(ALLOCATION_TAG)),
...
IoTThingsGraphClient::~IoTThingsGraphClient() { ShutdownSdkClient(this, -1); }

std::shared_ptr<IoTThingsGraphEndpointProviderBase>& IoTThingsGraphClient::accessEndpointProvider() { return m_endpointProvider; }
...
void IoTThingsGraphClient::init(const IoTThingsGraph::IoTThingsGraphClientConfiguration& config) {
  ...
  m_endpointProvider->InitBuiltInParameters(config, "iotthingsgraph");
}
...
IoTThingsGraphClient::InvokeOperationOutcome IoTThingsGraphClient::InvokeServiceOperation(const AmazonWebServiceRequest& request,
