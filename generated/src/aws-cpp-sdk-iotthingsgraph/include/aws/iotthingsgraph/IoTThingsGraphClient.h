...
namespace IoTThingsGraph
{
   ...
   */
  class AWS_IOTTHINGSGRAPH_API IoTThingsGraphClient : Aws::Client::ClientWithAsyncTemplateMethods<IoTThingsGraphClient>,
    smithy::client::AwsSmithyClientT<Aws::IoTThingsGraph::SERVICE_NAME,
