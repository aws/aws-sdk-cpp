...
class AWS_IOTTHINGSGRAPH_API IoTThingsGraphClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  IoTThingsGraphClient(const Aws::IoTThingsGraph::IoTThingsGraphClientConfiguration& clientConfiguration =
  ...
  IoTThingsGraphClient(const Aws::Auth::AWSCredentials& credentials,
                       std::shared_ptr<IoTThingsGraphEndpointProviderBase> endpointProvider = nullptr,
                       const Aws::IoTThingsGraph::IoTThingsGraphClientConfiguration& clientConfiguration =
                           Aws::IoTThingsGraph::IoTThingsGraphClientConfiguration());
