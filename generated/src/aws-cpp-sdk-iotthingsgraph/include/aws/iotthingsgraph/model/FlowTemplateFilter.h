...
class FlowTemplateFilter {
 public:
  ...
  inline void SetName(FlowTemplateFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline FlowTemplateFilter& WithName(FlowTemplateFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValueT = Aws::Vector<Aws::String>>
  FlowTemplateFilter& WithValue(ValueT&& value) {
    SetValue(std::forward<ValueT>(value));
    return *this;
  }
  template <typename ValueT = Aws::String>
  FlowTemplateFilter& AddValue(ValueT&& value) {
    m_valueHasBeenSet = true;
