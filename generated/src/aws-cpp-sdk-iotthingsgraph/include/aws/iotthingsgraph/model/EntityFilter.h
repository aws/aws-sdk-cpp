...
class EntityFilter {
 public:
  ...
  inline void SetName(EntityFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline EntityFilter& WithName(EntityFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValueT = Aws::Vector<Aws::String>>
  EntityFilter& WithValue(ValueT&& value) {
    SetValue(std::forward<ValueT>(value));
    return *this;
  }
  template <typename ValueT = Aws::String>
  EntityFilter& AddValue(ValueT&& value) {
    m_valueHasBeenSet = true;
