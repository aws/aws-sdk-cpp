...
class MetricsConfiguration {
 public:
  ...
  inline void SetCloudMetricEnabled(bool value) {
    m_cloudMetricEnabledHasBeenSet = true;
    m_cloudMetricEnabled = value;
  }
  inline MetricsConfiguration& WithCloudMetricEnabled(bool value) {
    SetCloudMetricEnabled(value);
    return *this;
  }
  ///@}
  ...
  void SetMetricRuleRoleArn(MetricRuleRoleArnT&& value) {
    ...
    m_metricRuleRoleArn = std::forward<MetricRuleRoleArnT>(value);
  }
  template <typename MetricRuleRoleArnT = Aws::String>
  MetricsConfiguration& WithMetricRuleRoleArn(MetricRuleRoleArnT&& value) {
    SetMetricRuleRoleArn(std::forward<MetricRuleRoleArnT>(value));
    return *this;
  }
  ///@}
 private:
