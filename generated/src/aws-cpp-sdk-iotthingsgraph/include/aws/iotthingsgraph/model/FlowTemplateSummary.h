...
class FlowTemplateSummary {
 public:
  AWS_IOTTHINGSGRAPH_API FlowTemplateSummary() = default;
  ...
  template <typename IdT = Aws::String>
  FlowTemplateSummary& WithId(IdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  FlowTemplateSummary& WithArn(ArnT&& value) {
  ...
  inline FlowTemplateSummary& WithRevisionNumber(long long value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  FlowTemplateSummary& WithCreatedAt(CreatedAtT&& value) {
