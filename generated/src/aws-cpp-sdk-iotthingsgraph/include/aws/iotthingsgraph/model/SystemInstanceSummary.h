...
class SystemInstanceSummary {
 public:
  ...
  inline void SetStatus(SystemInstanceDeploymentStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline SystemInstanceSummary& WithStatus(SystemInstanceDeploymentStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTarget(DeploymentTarget value) {
    m_targetHasBeenSet = true;
    m_target = value;
  }
  inline SystemInstanceSummary& WithTarget(DeploymentTarget value) {
    SetTarget(value);
    return *this;
  }
  ///@}
  ...
  void SetGreengrassGroupName(GreengrassGroupNameT&& value) {
    ...
    m_greengrassGroupName = std::forward<GreengrassGroupNameT>(value);
  }
  template <typename GreengrassGroupNameT = Aws::String>
  SystemInstanceSummary& WithGreengrassGroupName(GreengrassGroupNameT&& value) {
    SetGreengrassGroupName(std::forward<GreengrassGroupNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGreengrassGroupId(GreengrassGroupIdT&& value) {
    ...
    m_greengrassGroupId = std::forward<GreengrassGroupIdT>(value);
  }
  template <typename GreengrassGroupIdT = Aws::String>
  SystemInstanceSummary& WithGreengrassGroupId(GreengrassGroupIdT&& value) {
    SetGreengrassGroupId(std::forward<GreengrassGroupIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGreengrassGroupVersionId(GreengrassGroupVersionIdT&& value) {
    ...
    m_greengrassGroupVersionId = std::forward<GreengrassGroupVersionIdT>(value);
  }
  template <typename GreengrassGroupVersionIdT = Aws::String>
  SystemInstanceSummary& WithGreengrassGroupVersionId(GreengrassGroupVersionIdT&& value) {
    SetGreengrassGroupVersionId(std::forward<GreengrassGroupVersionIdT>(value));
    return *this;
  }
  ///@}
 private:
