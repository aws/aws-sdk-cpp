...
class SystemTemplateFilter {
 public:
  ...
  inline void SetName(SystemTemplateFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline SystemTemplateFilter& WithName(SystemTemplateFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValueT = Aws::Vector<Aws::String>>
  SystemTemplateFilter& WithValue(ValueT&& value) {
    SetValue(std::forward<ValueT>(value));
    return *this;
  }
  template <typename ValueT = Aws::String>
  SystemTemplateFilter& AddValue(ValueT&& value) {
    m_valueHasBeenSet = true;
