...
class SystemInstanceDescription {
 public:
  ...
  void SetMetricsConfiguration(MetricsConfigurationT&& value) {
    ...
    m_metricsConfiguration = std::forward<MetricsConfigurationT>(value);
  }
  template <typename MetricsConfigurationT = MetricsConfiguration>
  SystemInstanceDescription& WithMetricsConfiguration(MetricsConfigurationT&& value) {
    SetMetricsConfiguration(std::forward<MetricsConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetValidatedNamespaceVersion(long long value) {
    m_validatedNamespaceVersionHasBeenSet = true;
    m_validatedNamespaceVersion = value;
  }
  inline SystemInstanceDescription& WithValidatedNamespaceVersion(long long value) {
    SetValidatedNamespaceVersion(value);
    return *this;
  }
  ///@}
  ...
  void SetValidatedDependencyRevisions(ValidatedDependencyRevisionsT&& value) {
    ...
    m_validatedDependencyRevisions = std::forward<ValidatedDependencyRevisionsT>(value);
  }
  template <typename ValidatedDependencyRevisionsT = Aws::Vector<DependencyRevision>>
  SystemInstanceDescription& WithValidatedDependencyRevisions(ValidatedDependencyRevisionsT&& value) {
    SetValidatedDependencyRevisions(std::forward<ValidatedDependencyRevisionsT>(value));
    return *this;
  }
  ...
  SystemInstanceDescription& AddValidatedDependencyRevisions(ValidatedDependencyRevisionsT&& value) {
    m_validatedDependencyRevisionsHasBeenSet = true;
    m_validatedDependencyRevisions.emplace_back(std::forward<ValidatedDependencyRevisionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFlowActionsRoleArn(FlowActionsRoleArnT&& value) {
    ...
    m_flowActionsRoleArn = std::forward<FlowActionsRoleArnT>(value);
  }
  template <typename FlowActionsRoleArnT = Aws::String>
  SystemInstanceDescription& WithFlowActionsRoleArn(FlowActionsRoleArnT&& value) {
    SetFlowActionsRoleArn(std::forward<FlowActionsRoleArnT>(value));
    return *this;
  }
  ///@}
 private:
