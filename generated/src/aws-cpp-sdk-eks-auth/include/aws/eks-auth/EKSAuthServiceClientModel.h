...
typedef std::function<void(const EKSAuthClient*, const Model::AssumeRoleForPodIdentityRequest&,
                           const Model::AssumeRoleForPodIdentityOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    AssumeRoleForPodIdentityResponseReceivedHandler;
