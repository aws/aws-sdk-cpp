...
public:
  ...
  EKSAuthError(const Aws::Client::AWSError<EKSAuthErrors>& rhs) : Aws::Client::AWSError<EKSAuthErrors>(rhs) {}
  EKSAuthError(Aws::Client::AWSError<EKSAuthErrors>&& rhs) : Aws::Client::AWSError<EKSAuthErrors>(rhs) {}
