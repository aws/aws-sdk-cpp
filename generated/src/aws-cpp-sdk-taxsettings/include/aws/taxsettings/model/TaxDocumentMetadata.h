...
class TaxDocumentMetadata {
 public:
  ...
  void SetTaxDocumentAccessToken(TaxDocumentAccessTokenT&& value) {
    ...
    m_taxDocumentAccessToken = std::forward<TaxDocumentAccessTokenT>(value);
  }
  template <typename TaxDocumentAccessTokenT = Aws::String>
  TaxDocumentMetadata& WithTaxDocumentAccessToken(TaxDocumentAccessTokenT&& value) {
    SetTaxDocumentAccessToken(std::forward<TaxDocumentAccessTokenT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTaxDocumentName(TaxDocumentNameT&& value) {
    ...
    m_taxDocumentName = std::forward<TaxDocumentNameT>(value);
  }
  template <typename TaxDocumentNameT = Aws::String>
  TaxDocumentMetadata& WithTaxDocumentName(TaxDocumentNameT&& value) {
    SetTaxDocumentName(std::forward<TaxDocumentNameT>(value));
    return *this;
  }
  ///@}
 private:
