...
class BrazilAdditionalInfo {
 public:
  ...
  void SetCcmCode(CcmCodeT&& value) {
    ...
    m_ccmCode = std::forward<CcmCodeT>(value);
  }
  template <typename CcmCodeT = Aws::String>
  BrazilAdditionalInfo& WithCcmCode(CcmCodeT&& value) {
    SetCcmCode(std::forward<CcmCodeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLegalNatureCode(LegalNatureCodeT&& value) {
    ...
    m_legalNatureCode = std::forward<LegalNatureCodeT>(value);
  }
  template <typename LegalNatureCodeT = Aws::String>
  BrazilAdditionalInfo& WithLegalNatureCode(LegalNatureCodeT&& value) {
    SetLegalNatureCode(std::forward<LegalNatureCodeT>(value));
    return *this;
  }
  ///@}
 private:
