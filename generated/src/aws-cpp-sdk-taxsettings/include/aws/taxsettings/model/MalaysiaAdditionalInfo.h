...
class MalaysiaAdditionalInfo {
 public:
  ...
  void SetServiceTaxCodes(ServiceTaxCodesT&& value) {
    ...
    m_serviceTaxCodes = std::forward<ServiceTaxCodesT>(value);
  }
  template <typename ServiceTaxCodesT = Aws::Vector<MalaysiaServiceTaxCode>>
  MalaysiaAdditionalInfo& WithServiceTaxCodes(ServiceTaxCodesT&& value) {
    SetServiceTaxCodes(std::forward<ServiceTaxCodesT>(value));
    return *this;
  }
  inline MalaysiaAdditionalInfo& AddServiceTaxCodes(MalaysiaServiceTaxCode value) {
    m_serviceTaxCodesHasBeenSet = true;
    m_serviceTaxCodes.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetTaxInformationNumber(TaxInformationNumberT&& value) {
    ...
    m_taxInformationNumber = std::forward<TaxInformationNumberT>(value);
  }
  template <typename TaxInformationNumberT = Aws::String>
  MalaysiaAdditionalInfo& WithTaxInformationNumber(TaxInformationNumberT&& value) {
    SetTaxInformationNumber(std::forward<TaxInformationNumberT>(value));
    return *this;
  }
  ///@}
 private:
