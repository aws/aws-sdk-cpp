...
class TaxRegistration {
 public:
  ...
  inline TaxRegistration& WithRegistrationType(TaxRegistrationType value) {
  ...
  inline TaxRegistration& WithSector(Sector value) {
    SetSector(value);
    return *this;
  }
  ///@}
  ...
  inline TaxRegistration& WithStatus(TaxRegistrationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetTaxDocumentMetadatas(TaxDocumentMetadatasT&& value) {
    ...
    m_taxDocumentMetadatas = std::forward<TaxDocumentMetadatasT>(value);
  }
  template <typename TaxDocumentMetadatasT = Aws::Vector<TaxDocumentMetadata>>
  TaxRegistration& WithTaxDocumentMetadatas(TaxDocumentMetadatasT&& value) {
    SetTaxDocumentMetadatas(std::forward<TaxDocumentMetadatasT>(value));
    return *this;
  }
  ...
  TaxRegistration& AddTaxDocumentMetadatas(TaxDocumentMetadatasT&& value) {
    m_taxDocumentMetadatasHasBeenSet = true;
    m_taxDocumentMetadatas.emplace_back(std::forward<TaxDocumentMetadatasT>(value));
    return *this;
  }
  ///@}
 private:
