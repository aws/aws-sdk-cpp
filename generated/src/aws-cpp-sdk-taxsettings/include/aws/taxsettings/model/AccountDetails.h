...
class AccountDetails {
 public:
  ...
  void SetTaxInheritanceDetails(TaxInheritanceDetailsT&& value) {
    m_taxInheritanceDetailsHasBeenSet = true;
    m_taxInheritanceDetails = std::forward<TaxInheritanceDetailsT>(value);
  }
  template <typename TaxInheritanceDetailsT = TaxInheritanceDetails>
  AccountDetails& WithTaxInheritanceDetails(TaxInheritanceDetailsT&& value) {
    SetTaxInheritanceDetails(std::forward<TaxInheritanceDetailsT>(value));
    return *this;
  }
  ///@}
