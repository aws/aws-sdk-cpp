...
class RomaniaAdditionalInfo {
 public:
  ...
  inline void SetTaxRegistrationNumberType(TaxRegistrationNumberType value) {
    m_taxRegistrationNumberTypeHasBeenSet = true;
    m_taxRegistrationNumberType = value;
  }
  inline RomaniaAdditionalInfo& WithTaxRegistrationNumberType(TaxRegistrationNumberType value) {
