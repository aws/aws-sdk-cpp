...
class EgyptAdditionalInfo {
 public:
  ...
  void SetUniqueIdentificationNumber(UniqueIdentificationNumberT&& value) {
    m_uniqueIdentificationNumberHasBeenSet = true;
    m_uniqueIdentificationNumber = std::forward<UniqueIdentificationNumberT>(value);
  }
  template <typename UniqueIdentificationNumberT = Aws::String>
  EgyptAdditionalInfo& WithUniqueIdentificationNumber(UniqueIdentificationNumberT&& value) {
    SetUniqueIdentificationNumber(std::forward<UniqueIdentificationNumberT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUniqueIdentificationNumberExpirationDate(UniqueIdentificationNumberExpirationDateT&& value) {
    m_uniqueIdentificationNumberExpirationDateHasBeenSet = true;
    m_uniqueIdentificationNumberExpirationDate = std::forward<UniqueIdentificationNumberExpirationDateT>(value);
  }
  template <typename UniqueIdentificationNumberExpirationDateT = Aws::String>
  EgyptAdditionalInfo& WithUniqueIdentificationNumberExpirationDate(UniqueIdentificationNumberExpirationDateT&& value) {
    SetUniqueIdentificationNumberExpirationDate(std::forward<UniqueIdentificationNumberExpirationDateT>(value));
    return *this;
  }
  ///@}
 private:
