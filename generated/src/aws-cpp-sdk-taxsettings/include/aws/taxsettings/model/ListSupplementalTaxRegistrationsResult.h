...
class ListSupplementalTaxRegistrationsResult {
 public:
  ...
  AWS_TAXSETTINGS_API ListSupplementalTaxRegistrationsResult& operator=(
  ...
  template <typename NextTokenT = Aws::String>
  ListSupplementalTaxRegistrationsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetTaxRegistrations(TaxRegistrationsT&& value) {
    m_taxRegistrationsHasBeenSet = true;
    m_taxRegistrations = std::forward<TaxRegistrationsT>(value);
  }
  template <typename TaxRegistrationsT = Aws::Vector<SupplementalTaxRegistration>>
  ListSupplementalTaxRegistrationsResult& WithTaxRegistrations(TaxRegistrationsT&& value) {
    SetTaxRegistrations(std::forward<TaxRegistrationsT>(value));
    return *this;
  }
  template <typename TaxRegistrationsT = SupplementalTaxRegistration>
  ListSupplementalTaxRegistrationsResult& AddTaxRegistrations(TaxRegistrationsT&& value) {
    m_taxRegistrationsHasBeenSet = true;
    m_taxRegistrations.emplace_back(std::forward<TaxRegistrationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListSupplementalTaxRegistrationsResult& WithRequestId(RequestIdT&& value) {
