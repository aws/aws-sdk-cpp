...
namespace Model
{
  ...
  {
  public:
    AWS_TAXSETTINGS_API DeleteTaxRegistrationResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteTaxRegistrationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
