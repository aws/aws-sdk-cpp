...
class UzbekistanAdditionalInfo {
 public:
  ...
  inline void SetTaxRegistrationNumberType(UzbekistanTaxRegistrationNumberType value) {
    m_taxRegistrationNumberTypeHasBeenSet = true;
    m_taxRegistrationNumberType = value;
  }
  inline UzbekistanAdditionalInfo& WithTaxRegistrationNumberType(UzbekistanTaxRegistrationNumberType value) {
  ...
  void SetVatRegistrationNumber(VatRegistrationNumberT&& value) {
    m_vatRegistrationNumberHasBeenSet = true;
    m_vatRegistrationNumber = std::forward<VatRegistrationNumberT>(value);
  }
  template <typename VatRegistrationNumberT = Aws::String>
  UzbekistanAdditionalInfo& WithVatRegistrationNumber(VatRegistrationNumberT&& value) {
    SetVatRegistrationNumber(std::forward<VatRegistrationNumberT>(value));
    return *this;
  }
  ///@}
 private:
