...
class TurkeyAdditionalInfo {
 public:
  ...
  void SetKepEmailId(KepEmailIdT&& value) {
    ...
    m_kepEmailId = std::forward<KepEmailIdT>(value);
  }
  template <typename KepEmailIdT = Aws::String>
  TurkeyAdditionalInfo& WithKepEmailId(KepEmailIdT&& value) {
    SetKepEmailId(std::forward<KepEmailIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSecondaryTaxId(SecondaryTaxIdT&& value) {
    ...
    m_secondaryTaxId = std::forward<SecondaryTaxIdT>(value);
  }
  template <typename SecondaryTaxIdT = Aws::String>
  TurkeyAdditionalInfo& WithSecondaryTaxId(SecondaryTaxIdT&& value) {
    SetSecondaryTaxId(std::forward<SecondaryTaxIdT>(value));
    return *this;
  }
  ///@}
