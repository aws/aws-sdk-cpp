...
class ItalyAdditionalInfo {
 public:
  ...
  void SetCigNumber(CigNumberT&& value) {
    ...
    m_cigNumber = std::forward<CigNumberT>(value);
  }
  template <typename CigNumberT = Aws::String>
  ItalyAdditionalInfo& WithCigNumber(CigNumberT&& value) {
    SetCigNumber(std::forward<CigNumberT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCupNumber(CupNumberT&& value) {
    ...
    m_cupNumber = std::forward<CupNumberT>(value);
  }
  template <typename CupNumberT = Aws::String>
  ItalyAdditionalInfo& WithCupNumber(CupNumberT&& value) {
    SetCupNumber(std::forward<CupNumberT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTaxCode(TaxCodeT&& value) {
    ...
    m_taxCode = std::forward<TaxCodeT>(value);
  }
  template <typename TaxCodeT = Aws::String>
  ItalyAdditionalInfo& WithTaxCode(TaxCodeT&& value) {
    SetTaxCode(std::forward<TaxCodeT>(value));
    return *this;
  }
  ///@}
 private:
