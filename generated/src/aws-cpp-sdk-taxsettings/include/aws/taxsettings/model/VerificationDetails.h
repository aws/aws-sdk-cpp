...
class VerificationDetails {
 public:
  ...
  void SetTaxRegistrationDocuments(TaxRegistrationDocumentsT&& value) {
    ...
    m_taxRegistrationDocuments = std::forward<TaxRegistrationDocumentsT>(value);
  }
  template <typename TaxRegistrationDocumentsT = Aws::Vector<TaxRegistrationDocument>>
  VerificationDetails& WithTaxRegistrationDocuments(TaxRegistrationDocumentsT&& value) {
    SetTaxRegistrationDocuments(std::forward<TaxRegistrationDocumentsT>(value));
    return *this;
  }
  ...
  VerificationDetails& AddTaxRegistrationDocuments(TaxRegistrationDocumentsT&& value) {
    m_taxRegistrationDocumentsHasBeenSet = true;
    m_taxRegistrationDocuments.emplace_back(std::forward<TaxRegistrationDocumentsT>(value));
    return *this;
  }
  ///@}
 private:
