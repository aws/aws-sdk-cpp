...
class SupplementalTaxRegistration {
 public:
  ...
  inline void SetRegistrationType(SupplementalTaxRegistrationType value) {
    m_registrationTypeHasBeenSet = true;
    m_registrationType = value;
  }
  inline SupplementalTaxRegistration& WithRegistrationType(SupplementalTaxRegistrationType value) {
  ...
  inline SupplementalTaxRegistration& WithStatus(TaxRegistrationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
