...
class GetTaxExemptionTypesResult {
 public:
  ...
  void SetTaxExemptionTypes(TaxExemptionTypesT&& value) {
    m_taxExemptionTypesHasBeenSet = true;
    m_taxExemptionTypes = std::forward<TaxExemptionTypesT>(value);
  }
  template <typename TaxExemptionTypesT = Aws::Vector<TaxExemptionType>>
  GetTaxExemptionTypesResult& WithTaxExemptionTypes(TaxExemptionTypesT&& value) {
    SetTaxExemptionTypes(std::forward<TaxExemptionTypesT>(value));
    return *this;
  }
  template <typename TaxExemptionTypesT = TaxExemptionType>
  GetTaxExemptionTypesResult& AddTaxExemptionTypes(TaxExemptionTypesT&& value) {
    m_taxExemptionTypesHasBeenSet = true;
    m_taxExemptionTypes.emplace_back(std::forward<TaxExemptionTypesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetTaxExemptionTypesResult& WithRequestId(RequestIdT&& value) {
