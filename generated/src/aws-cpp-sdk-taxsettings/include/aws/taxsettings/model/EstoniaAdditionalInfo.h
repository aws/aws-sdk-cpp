...
class EstoniaAdditionalInfo {
 public:
  ...
  void SetRegistryCommercialCode(RegistryCommercialCodeT&& value) {
    m_registryCommercialCodeHasBeenSet = true;
    m_registryCommercialCode = std::forward<RegistryCommercialCodeT>(value);
  }
  template <typename RegistryCommercialCodeT = Aws::String>
  EstoniaAdditionalInfo& WithRegistryCommercialCode(RegistryCommercialCodeT&& value) {
    SetRegistryCommercialCode(std::forward<RegistryCommercialCodeT>(value));
    return *this;
  }
  ///@}
 private:
