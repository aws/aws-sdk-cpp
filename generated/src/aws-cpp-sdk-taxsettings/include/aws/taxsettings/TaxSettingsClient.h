...
namespace TaxSettings
{
   ...
   */
  class AWS_TAXSETTINGS_API TaxSettingsClient : Aws::Client::ClientWithAsyncTemplateMethods<TaxSettingsClient>,
    smithy::client::AwsSmithyClientT<Aws::TaxSettings::SERVICE_NAME,
