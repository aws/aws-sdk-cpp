...
class AWS_TAXSETTINGS_API TaxSettingsClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  TaxSettingsClient(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<TaxSettingsEndpointProviderBase> endpointProvider = nullptr,
      const Aws::TaxSettings::TaxSettingsClientConfiguration& clientConfiguration = Aws::TaxSettings::TaxSettingsClientConfiguration());
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchDeleteTaxRegistrationOutcome BatchDeleteTaxRegistration(
      const Model::BatchDeleteTaxRegistrationRequest& request) const;

  /**
   * A Callable wrapper for BatchDeleteTaxRegistration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename BatchDeleteTaxRegistrationRequestT = Model::BatchDeleteTaxRegistrationRequest>
  Model::BatchDeleteTaxRegistrationOutcomeCallable BatchDeleteTaxRegistrationCallable(
      const BatchDeleteTaxRegistrationRequestT& request) const {
    return SubmitCallable(&TaxSettingsClient::BatchDeleteTaxRegistration, request);
  }

  /**
   * An Async wrapper for BatchDeleteTaxRegistration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchDeleteTaxRegistrationRequestT = Model::BatchDeleteTaxRegistrationRequest>
  void BatchDeleteTaxRegistrationAsync(const BatchDeleteTaxRegistrationRequestT& request,
                                       const BatchDeleteTaxRegistrationResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for BatchGetTaxExemptions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchGetTaxExemptions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchGetTaxExemptionsRequestT = Model::BatchGetTaxExemptionsRequest>
  void BatchGetTaxExemptionsAsync(const BatchGetTaxExemptionsRequestT& request, const BatchGetTaxExemptionsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchPutTaxRegistration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchPutTaxRegistration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchPutTaxRegistrationRequestT = Model::BatchPutTaxRegistrationRequest>
  void BatchPutTaxRegistrationAsync(const BatchPutTaxRegistrationRequestT& request,
                                    const BatchPutTaxRegistrationResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteSupplementalTaxRegistrationOutcome DeleteSupplementalTaxRegistration(
      const Model::DeleteSupplementalTaxRegistrationRequest& request) const;

  /**
   * A Callable wrapper for DeleteSupplementalTaxRegistration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DeleteSupplementalTaxRegistrationRequestT = Model::DeleteSupplementalTaxRegistrationRequest>
  Model::DeleteSupplementalTaxRegistrationOutcomeCallable DeleteSupplementalTaxRegistrationCallable(
      const DeleteSupplementalTaxRegistrationRequestT& request) const {
    return SubmitCallable(&TaxSettingsClient::DeleteSupplementalTaxRegistration, request);
  }

  /**
   * An Async wrapper for DeleteSupplementalTaxRegistration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteSupplementalTaxRegistrationRequestT = Model::DeleteSupplementalTaxRegistrationRequest>
  void DeleteSupplementalTaxRegistrationAsync(const DeleteSupplementalTaxRegistrationRequestT& request,
                                              const DeleteSupplementalTaxRegistrationResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteTaxRegistration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteTaxRegistration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteTaxRegistrationRequestT = Model::DeleteTaxRegistrationRequest>
  void DeleteTaxRegistrationAsync(const DeleteTaxRegistrationResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const DeleteTaxRegistrationRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetTaxExemptionTypes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetTaxExemptionTypes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetTaxExemptionTypesRequestT = Model::GetTaxExemptionTypesRequest>
  void GetTaxExemptionTypesAsync(const GetTaxExemptionTypesResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const GetTaxExemptionTypesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetTaxInheritance that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetTaxInheritance that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetTaxInheritanceRequestT = Model::GetTaxInheritanceRequest>
  void GetTaxInheritanceAsync(const GetTaxInheritanceResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const GetTaxInheritanceRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetTaxRegistration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetTaxRegistration that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetTaxRegistrationRequestT = Model::GetTaxRegistrationRequest>
  void GetTaxRegistrationAsync(const GetTaxRegistrationResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const GetTaxRegistrationRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetTaxRegistrationDocumentOutcome GetTaxRegistrationDocument(
      const Model::GetTaxRegistrationDocumentRequest& request) const;

  /**
   * A Callable wrapper for GetTaxRegistrationDocument that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetTaxRegistrationDocumentRequestT = Model::GetTaxRegistrationDocumentRequest>
  Model::GetTaxRegistrationDocumentOutcomeCallable GetTaxRegistrationDocumentCallable(
      const GetTaxRegistrationDocumentRequestT& request) const {
    return SubmitCallable(&TaxSettingsClient::GetTaxRegistrationDocument, request);
  }

  /**
   * An Async wrapper for GetTaxRegistrationDocument that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetTaxRegistrationDocumentRequestT = Model::GetTaxRegistrationDocumentRequest>
  void GetTaxRegistrationDocumentAsync(const GetTaxRegistrationDocumentRequestT& request,
                                       const GetTaxRegistrationDocumentResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListSupplementalTaxRegistrationsOutcome ListSupplementalTaxRegistrations(
      const Model::ListSupplementalTaxRegistrationsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListSupplementalTaxRegistrations that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListSupplementalTaxRegistrationsRequestT = Model::ListSupplementalTaxRegistrationsRequest>
  Model::ListSupplementalTaxRegistrationsOutcomeCallable ListSupplementalTaxRegistrationsCallable(
      const ListSupplementalTaxRegistrationsRequestT& request = {}) const {
    return SubmitCallable(&TaxSettingsClient::ListSupplementalTaxRegistrations, request);
  }

  /**
   * An Async wrapper for ListSupplementalTaxRegistrations that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListSupplementalTaxRegistrationsRequestT = Model::ListSupplementalTaxRegistrationsRequest>
  void ListSupplementalTaxRegistrationsAsync(const ListSupplementalTaxRegistrationsResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                             const ListSupplementalTaxRegistrationsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListTaxExemptions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListTaxExemptions that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListTaxExemptionsRequestT = Model::ListTaxExemptionsRequest>
  void ListTaxExemptionsAsync(const ListTaxExemptionsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const ListTaxExemptionsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListTaxRegistrations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListTaxRegistrations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListTaxRegistrationsRequestT = Model::ListTaxRegistrationsRequest>
  void ListTaxRegistrationsAsync(const ListTaxRegistrationsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const ListTaxRegistrationsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::PutSupplementalTaxRegistrationOutcome PutSupplementalTaxRegistration(
      const Model::PutSupplementalTaxRegistrationRequest& request) const;

  /**
   * A Callable wrapper for PutSupplementalTaxRegistration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PutSupplementalTaxRegistrationRequestT = Model::PutSupplementalTaxRegistrationRequest>
  Model::PutSupplementalTaxRegistrationOutcomeCallable PutSupplementalTaxRegistrationCallable(
      const PutSupplementalTaxRegistrationRequestT& request) const {
    return SubmitCallable(&TaxSettingsClient::PutSupplementalTaxRegistration, request);
  }

  /**
   * An Async wrapper for PutSupplementalTaxRegistration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename PutSupplementalTaxRegistrationRequestT = Model::PutSupplementalTaxRegistrationRequest>
  void PutSupplementalTaxRegistrationAsync(const PutSupplementalTaxRegistrationRequestT& request,
                                           const PutSupplementalTaxRegistrationResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for PutTaxExemption that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutTaxExemptionRequestT = Model::PutTaxExemptionRequest>
  void PutTaxExemptionAsync(const PutTaxExemptionRequestT& request, const PutTaxExemptionResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutTaxInheritance that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutTaxInheritance that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PutTaxInheritanceRequestT = Model::PutTaxInheritanceRequest>
  void PutTaxInheritanceAsync(const PutTaxInheritanceResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const PutTaxInheritanceRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for PutTaxRegistration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutTaxRegistration that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PutTaxRegistrationRequestT = Model::PutTaxRegistrationRequest>
  void PutTaxRegistrationAsync(const PutTaxRegistrationRequestT& request, const PutTaxRegistrationResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
