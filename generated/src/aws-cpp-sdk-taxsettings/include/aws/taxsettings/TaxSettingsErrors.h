...
public:
  ...
  TaxSettingsError(const Aws::Client::AWSError<TaxSettingsErrors>& rhs) : Aws::Client::AWSError<TaxSettingsErrors>(rhs) {}
  TaxSettingsError(Aws::Client::AWSError<TaxSettingsErrors>&& rhs) : Aws::Client::AWSError<TaxSettingsErrors>(rhs) {}
