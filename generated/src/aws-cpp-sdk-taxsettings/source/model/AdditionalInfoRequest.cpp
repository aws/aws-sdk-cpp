...
AdditionalInfoRequest::AdditionalInfoRequest(JsonView jsonValue) { *this = jsonValue; }

AdditionalInfoRequest& AdditionalInfoRequest::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("philippinesAdditionalInfo")) {
    m_philippinesAdditionalInfo = jsonValue.GetObject("philippinesAdditionalInfo");
    m_philippinesAdditionalInfoHasBeenSet = true;
  }
  if (jsonValue.ValueExists("belgiumAdditionalInfo")) {
    m_belgiumAdditionalInfo = jsonValue.GetObject("belgiumAdditionalInfo");
    m_belgiumAdditionalInfoHasBeenSet = true;
  }
  if (jsonValue.ValueExists("chileAdditionalInfo")) {
    m_chileAdditionalInfo = jsonValue.GetObject("chileAdditionalInfo");
    m_chileAdditionalInfoHasBeenSet = true;
  }
  if (jsonValue.ValueExists("franceAdditionalInfo")) {
...
JsonValue AdditionalInfoRequest::Jsonize() const {
  JsonValue payload;
  ...
  if (m_philippinesAdditionalInfoHasBeenSet) {
    payload.WithObject("philippinesAdditionalInfo", m_philippinesAdditionalInfo.Jsonize());
  }

  if (m_belgiumAdditionalInfoHasBeenSet) {
    payload.WithObject("belgiumAdditionalInfo", m_belgiumAdditionalInfo.Jsonize());
  }

  if (m_chileAdditionalInfoHasBeenSet) {
    payload.WithObject("chileAdditionalInfo", m_chileAdditionalInfo.Jsonize());
  }
