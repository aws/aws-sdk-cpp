...
UzbekistanAdditionalInfo::UzbekistanAdditionalInfo(JsonView jsonValue) { *this = jsonValue; }
...
UzbekistanAdditionalInfo& UzbekistanAdditionalInfo::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("taxRegistrationNumberType")) {
    m_taxRegistrationNumberType = UzbekistanTaxRegistrationNumberTypeMapper::GetUzbekistanTaxRegistrationNumberTypeForName(
...
JsonValue UzbekistanAdditionalInfo::Jsonize() const {
  ...
  if (m_taxRegistrationNumberTypeHasBeenSet) {
    payload.WithString(
        ...
        UzbekistanTaxRegistrationNumberTypeMapper::GetNameForUzbekistanTaxRegistrationNumberType(m_taxRegistrationNumberType));
  }
