...
RomaniaAdditionalInfo::RomaniaAdditionalInfo(JsonView jsonValue) { *this = jsonValue; }
...
RomaniaAdditionalInfo& RomaniaAdditionalInfo::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("taxRegistrationNumberType")) {
    m_taxRegistrationNumberType =
        TaxRegistrationNumberTypeMapper::GetTaxRegistrationNumberTypeForName(jsonValue.GetString("taxRegistrationNumberType"));
...
JsonValue RomaniaAdditionalInfo::Jsonize() const {
  ...
  if (m_taxRegistrationNumberTypeHasBeenSet) {
    payload.WithString("taxRegistrationNumberType",
                       TaxRegistrationNumberTypeMapper::GetNameForTaxRegistrationNumberType(m_taxRegistrationNumberType));
  }
