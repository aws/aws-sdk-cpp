...
{
const size_t TaxSettingsEndpointRules::RulesBlobStrLen = 3712;
const size_t TaxSettingsEndpointRules::RulesBlobSize = 3713;
...
'"','h','t','t','p','s',':','/','/','t','a','x','-','f','i','p','s','.','{','R','e','g','i','o','n',
...
'u','r','l','"',':','"','h','t','t','p','s',':','/','/','t','a','x','-','f','i','p','s','.','{','R',
...
't','a','x','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R','e',
