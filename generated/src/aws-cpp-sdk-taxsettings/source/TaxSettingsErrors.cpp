...
template <>
AWS_TAXSETTINGS_API ConflictException TaxSettingsError::GetModeledError() {
  assert(this->GetErrorType() == TaxSettingsErrors::CONFLICT);
  return ConflictException(this->GetJsonPayload().View());
}

template <>
AWS_TAXSETTINGS_API InternalServerException TaxSettingsError::GetModeledError() {
  assert(this->GetErrorType() == TaxSettingsErrors::INTERNAL_SERVER);
  return InternalServerException(this->GetJsonPayload().View());
}

template <>
AWS_TAXSETTINGS_API ResourceNotFoundException TaxSettingsError::GetModeledError() {
  assert(this->GetErrorType() == TaxSettingsErrors::RESOURCE_NOT_FOUND);
  return ResourceNotFoundException(this->GetJsonPayload().View());
}

template <>
AWS_TAXSETTINGS_API ValidationException TaxSettingsError::GetModeledError() {
