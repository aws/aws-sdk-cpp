...
class UpdateGameSessionRequest : public GameLiftRequest {
 public:
   ...
   * update. The value is always a full ARN in the following format: For Home Region
   * game session - <code>arn:aws:gamelift:&lt;home_region&gt;::gamesession/&lt;fleet
  ...
  inline UpdateGameSessionRequest& WithMaximumPlayerSessionCount(int value) {
  ...
  inline UpdateGameSessionRequest& WithPlayerSessionCreationPolicy(PlayerSessionCreationPolicy value) {
  ...
  inline UpdateGameSessionRequest& WithProtectionPolicy(ProtectionPolicy value) {
   ...
   * the value of a game property</a>. </p>  <ul> <li> <p>Avoid using periods
