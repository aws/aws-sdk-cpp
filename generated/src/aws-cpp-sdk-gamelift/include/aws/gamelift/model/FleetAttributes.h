...
class FleetAttributes {
 public:
  ...
  inline FleetAttributes& WithFleetType(FleetType value) {
    SetFleetType(value);
    return *this;
  }
  ///@}
  ...
  inline FleetAttributes& WithInstanceType(EC2InstanceType value) {
  ...
  inline FleetAttributes& WithStatus(FleetStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetScriptArn(ScriptArnT&& value) {
    ...
    m_scriptArn = std::forward<ScriptArnT>(value);
  }
  template <typename ScriptArnT = Aws::String>
  FleetAttributes& WithScriptArn(ScriptArnT&& value) {
    SetScriptArn(std::forward<ScriptArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline FleetAttributes& WithNewGameSessionProtectionPolicy(ProtectionPolicy value) {
   ...
   * on 6/30/2026. See more details in the <a
  ...
  inline FleetAttributes& WithOperatingSystem(OperatingSystem value) {
  ...
  void SetStoppedActions(StoppedActionsT&& value) {
    ...
    m_stoppedActions = std::forward<StoppedActionsT>(value);
  }
  template <typename StoppedActionsT = Aws::Vector<FleetAction>>
  FleetAttributes& WithStoppedActions(StoppedActionsT&& value) {
    SetStoppedActions(std::forward<StoppedActionsT>(value));
    return *this;
  }
  inline FleetAttributes& AddStoppedActions(FleetAction value) {
    m_stoppedActionsHasBeenSet = true;
    m_stoppedActions.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline FleetAttributes& WithComputeType(ComputeType value) {
  ...
  inline FleetAttributes& WithInstanceRoleCredentialsProvider(InstanceRoleCredentialsProvider value) {
