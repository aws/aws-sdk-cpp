...
class LocationAttributes {
 public:
  ...
  void SetLocationState(LocationStateT&& value) {
    ...
    m_locationState = std::forward<LocationStateT>(value);
  }
  template <typename LocationStateT = LocationState>
  LocationAttributes& WithLocationState(LocationStateT&& value) {
    SetLocationState(std::forward<LocationStateT>(value));
    return *this;
  }
  ///@}
  ...
  inline LocationAttributes& AddStoppedActions(FleetAction value) {
    m_stoppedActionsHasBeenSet = true;
  ...
  inline LocationAttributes& WithUpdateStatus(LocationUpdateStatus value) {
