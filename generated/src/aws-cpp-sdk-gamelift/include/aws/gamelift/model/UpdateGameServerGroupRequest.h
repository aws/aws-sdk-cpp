...
class UpdateGameServerGroupRequest : public GameLiftRequest {
 public:
  ...
  inline UpdateGameServerGroupRequest& WithGameServerProtectionPolicy(GameServerProtectionPolicy value) {
  ...
  inline UpdateGameServerGroupRequest& WithBalancingStrategy(BalancingStrategy value) {
