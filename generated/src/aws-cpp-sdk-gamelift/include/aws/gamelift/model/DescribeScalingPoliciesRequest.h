...
class DescribeScalingPoliciesRequest : public GameLiftRequest {
 public:
  ...
  inline void SetStatusFilter(ScalingStatusType value) {
    m_statusFilterHasBeenSet = true;
    m_statusFilter = value;
  }
  inline DescribeScalingPoliciesRequest& WithStatusFilter(ScalingStatusType value) {
  ...
  inline DescribeScalingPoliciesRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
