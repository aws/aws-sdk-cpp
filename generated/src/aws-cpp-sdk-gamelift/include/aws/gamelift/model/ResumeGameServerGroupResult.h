...
class ResumeGameServerGroupResult {
 public:
  ...
  AWS_GAMELIFT_API ResumeGameServerGroupResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_GAMELIFT_API ResumeGameServerGroupResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  template <typename GameServerGroupT = GameServerGroup>
  ResumeGameServerGroupResult& WithGameServerGroup(GameServerGroupT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ResumeGameServerGroupResult& WithRequestId(RequestIdT&& value) {
