...
class DescribeFleetPortSettingsResult {
 public:
  ...
  AWS_GAMELIFT_API DescribeFleetPortSettingsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_GAMELIFT_API DescribeFleetPortSettingsResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  template <typename FleetIdT = Aws::String>
  DescribeFleetPortSettingsResult& WithFleetId(FleetIdT&& value) {
  ...
  template <typename FleetArnT = Aws::String>
  DescribeFleetPortSettingsResult& WithFleetArn(FleetArnT&& value) {
  ...
  void SetInboundPermissions(InboundPermissionsT&& value) {
    m_inboundPermissionsHasBeenSet = true;
    m_inboundPermissions = std::forward<InboundPermissionsT>(value);
  }
  template <typename InboundPermissionsT = Aws::Vector<IpPermission>>
  DescribeFleetPortSettingsResult& WithInboundPermissions(InboundPermissionsT&& value) {
    SetInboundPermissions(std::forward<InboundPermissionsT>(value));
    return *this;
  }
  template <typename InboundPermissionsT = IpPermission>
  DescribeFleetPortSettingsResult& AddInboundPermissions(InboundPermissionsT&& value) {
    m_inboundPermissionsHasBeenSet = true;
    m_inboundPermissions.emplace_back(std::forward<InboundPermissionsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetUpdateStatus(LocationUpdateStatus value) {
    m_updateStatusHasBeenSet = true;
    m_updateStatus = value;
  }
  inline DescribeFleetPortSettingsResult& WithUpdateStatus(LocationUpdateStatus value) {
  ...
  template <typename LocationT = Aws::String>
  DescribeFleetPortSettingsResult& WithLocation(LocationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeFleetPortSettingsResult& WithRequestId(RequestIdT&& value) {
