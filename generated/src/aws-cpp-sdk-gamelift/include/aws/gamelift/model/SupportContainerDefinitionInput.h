...
class SupportContainerDefinitionInput {
 public:
  ...
  inline SupportContainerDefinitionInput& WithEssential(bool value) {
    SetEssential(value);
    return *this;
  }
  ///@}
  ...
  inline SupportContainerDefinitionInput& WithMemoryHardLimitMebibytes(int64_t value) {
  ...
  inline SupportContainerDefinitionInput& WithVcpu(double value) {
    SetVcpu(value);
    return *this;
  }
  ///@}
