...
class UpdateFleetPortSettingsResult {
 public:
  AWS_GAMELIFT_API UpdateFleetPortSettingsResult() = default;
  AWS_GAMELIFT_API UpdateFleetPortSettingsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_GAMELIFT_API UpdateFleetPortSettingsResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  template <typename FleetIdT = Aws::String>
  UpdateFleetPortSettingsResult& WithFleetId(FleetIdT&& value) {
  ...
  template <typename FleetArnT = Aws::String>
  UpdateFleetPortSettingsResult& WithFleetArn(FleetArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateFleetPortSettingsResult& WithRequestId(RequestIdT&& value) {
