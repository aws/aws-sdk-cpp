...
class ValidateMatchmakingRuleSetResult {
 public:
  ...
  AWS_GAMELIFT_API ValidateMatchmakingRuleSetResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_GAMELIFT_API ValidateMatchmakingRuleSetResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  inline ValidateMatchmakingRuleSetResult& WithValid(bool value) {
    SetValid(value);
    return *this;
  }
  ///@}
