...
class ListComputeRequest : public GameLiftRequest {
 public:
  ...
  void SetContainerGroupDefinitionName(ContainerGroupDefinitionNameT&& value) {
    ...
    m_containerGroupDefinitionName = std::forward<ContainerGroupDefinitionNameT>(value);
  }
  template <typename ContainerGroupDefinitionNameT = Aws::String>
  ListComputeRequest& WithContainerGroupDefinitionName(ContainerGroupDefinitionNameT&& value) {
    SetContainerGroupDefinitionName(std::forward<ContainerGroupDefinitionNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetComputeStatus(ListComputeInputStatus value) {
    m_computeStatusHasBeenSet = true;
    m_computeStatus = value;
  }
  inline ListComputeRequest& WithComputeStatus(ListComputeInputStatus value) {
  ...
  inline ListComputeRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
