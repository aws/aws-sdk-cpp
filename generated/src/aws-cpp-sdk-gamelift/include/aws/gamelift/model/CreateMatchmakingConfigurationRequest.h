...
class CreateMatchmakingConfigurationRequest : public GameLiftRequest {
 public:
  ...
  void SetGameSessionQueueArns(GameSessionQueueArnsT&& value) {
    ...
    m_gameSessionQueueArns = std::forward<GameSessionQueueArnsT>(value);
  }
  template <typename GameSessionQueueArnsT = Aws::Vector<Aws::String>>
  CreateMatchmakingConfigurationRequest& WithGameSessionQueueArns(GameSessionQueueArnsT&& value) {
    SetGameSessionQueueArns(std::forward<GameSessionQueueArnsT>(value));
    return *this;
  }
  ...
  CreateMatchmakingConfigurationRequest& AddGameSessionQueueArns(GameSessionQueueArnsT&& value) {
    m_gameSessionQueueArnsHasBeenSet = true;
    m_gameSessionQueueArns.emplace_back(std::forward<GameSessionQueueArnsT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateMatchmakingConfigurationRequest& WithRequestTimeoutSeconds(int value) {
  ...
  inline CreateMatchmakingConfigurationRequest& WithAcceptanceTimeoutSeconds(int value) {
  ...
  inline void SetAcceptanceRequired(bool value) {
    m_acceptanceRequiredHasBeenSet = true;
    m_acceptanceRequired = value;
  }
  inline CreateMatchmakingConfigurationRequest& WithAcceptanceRequired(bool value) {
  ...
  inline CreateMatchmakingConfigurationRequest& WithAdditionalPlayerCount(int value) {
  ...
  void SetGameProperties(GamePropertiesT&& value) {
    ...
    m_gameProperties = std::forward<GamePropertiesT>(value);
  }
  template <typename GamePropertiesT = Aws::Vector<GameProperty>>
  CreateMatchmakingConfigurationRequest& WithGameProperties(GamePropertiesT&& value) {
    SetGameProperties(std::forward<GamePropertiesT>(value));
    return *this;
  }
  ...
  CreateMatchmakingConfigurationRequest& AddGameProperties(GamePropertiesT&& value) {
    m_gamePropertiesHasBeenSet = true;
    m_gameProperties.emplace_back(std::forward<GamePropertiesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGameSessionData(GameSessionDataT&& value) {
    ...
    m_gameSessionData = std::forward<GameSessionDataT>(value);
  }
  template <typename GameSessionDataT = Aws::String>
  CreateMatchmakingConfigurationRequest& WithGameSessionData(GameSessionDataT&& value) {
    SetGameSessionData(std::forward<GameSessionDataT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetBackfillMode(BackfillMode value) {
    m_backfillModeHasBeenSet = true;
    m_backfillMode = value;
  }
  inline CreateMatchmakingConfigurationRequest& WithBackfillMode(BackfillMode value) {
    SetBackfillMode(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFlexMatchMode(FlexMatchMode value) {
    m_flexMatchModeHasBeenSet = true;
    m_flexMatchMode = value;
  }
  inline CreateMatchmakingConfigurationRequest& WithFlexMatchMode(FlexMatchMode value) {
    SetFlexMatchMode(value);
    return *this;
  }
  ///@}
