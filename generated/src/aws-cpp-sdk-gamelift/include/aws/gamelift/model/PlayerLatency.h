...
class PlayerLatency {
 public:
  ...
  void SetRegionIdentifier(RegionIdentifierT&& value) {
    ...
    m_regionIdentifier = std::forward<RegionIdentifierT>(value);
  }
  template <typename RegionIdentifierT = Aws::String>
  PlayerLatency& WithRegionIdentifier(RegionIdentifierT&& value) {
    SetRegionIdentifier(std::forward<RegionIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetLatencyInMilliseconds(double value) {
    m_latencyInMillisecondsHasBeenSet = true;
    m_latencyInMilliseconds = value;
  }
  inline PlayerLatency& WithLatencyInMilliseconds(double value) {
    SetLatencyInMilliseconds(value);
    return *this;
  }
  ///@}
 private:
