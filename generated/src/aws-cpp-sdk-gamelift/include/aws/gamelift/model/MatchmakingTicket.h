...
class MatchmakingTicket {
 public:
  ...
  void SetTicketId(TicketIdT&& value) {
    ...
    m_ticketId = std::forward<TicketIdT>(value);
  }
  template <typename TicketIdT = Aws::String>
  MatchmakingTicket& WithTicketId(TicketIdT&& value) {
    SetTicketId(std::forward<TicketIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(MatchmakingConfigurationStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline MatchmakingTicket& WithStatus(MatchmakingConfigurationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetPlayers(PlayersT&& value) {
    ...
    m_players = std::forward<PlayersT>(value);
  }
  template <typename PlayersT = Aws::Vector<Player>>
  MatchmakingTicket& WithPlayers(PlayersT&& value) {
    SetPlayers(std::forward<PlayersT>(value));
    return *this;
  }
  template <typename PlayersT = Player>
  MatchmakingTicket& AddPlayers(PlayersT&& value) {
    m_playersHasBeenSet = true;
    m_players.emplace_back(std::forward<PlayersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGameSessionConnectionInfo(GameSessionConnectionInfoT&& value) {
    ...
    m_gameSessionConnectionInfo = std::forward<GameSessionConnectionInfoT>(value);
  }
  template <typename GameSessionConnectionInfoT = GameSessionConnectionInfo>
  MatchmakingTicket& WithGameSessionConnectionInfo(GameSessionConnectionInfoT&& value) {
    SetGameSessionConnectionInfo(std::forward<GameSessionConnectionInfoT>(value));
    return *this;
  }
  ///@}
