...
namespace Model
{
  ...
  public:
    ...
    template<typename FleetIdT = Aws::String>
    DescribeFleetLocationCapacityRequest& WithFleetId(FleetIdT&& value) { SetFleetId(std::forward<FleetIdT>(value)); return *this;}
    ///@}
    ...
    template<typename LocationT = Aws::String>
    DescribeFleetLocationCapacityRequest& WithLocation(LocationT&& value) { SetLocation(std::forward<LocationT>(value)); return *this;}
    ///@}
  private:
