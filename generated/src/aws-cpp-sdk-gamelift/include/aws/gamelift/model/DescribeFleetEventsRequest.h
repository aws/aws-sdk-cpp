...
class DescribeFleetEventsRequest : public GameLiftRequest {
 public:
  AWS_GAMELIFT_API DescribeFleetEventsRequest() = default;
  ...
  template <typename FleetIdT = Aws::String>
  DescribeFleetEventsRequest& WithFleetId(FleetIdT&& value) {
  ...
  template <typename StartTimeT = Aws::Utils::DateTime>
  DescribeFleetEventsRequest& WithStartTime(StartTimeT&& value) {
  ...
  template <typename EndTimeT = Aws::Utils::DateTime>
  DescribeFleetEventsRequest& WithEndTime(EndTimeT&& value) {
  ...
  inline DescribeFleetEventsRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeFleetEventsRequest& WithNextToken(NextTokenT&& value) {
