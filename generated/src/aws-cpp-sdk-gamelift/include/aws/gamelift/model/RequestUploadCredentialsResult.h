...
class RequestUploadCredentialsResult {
 public:
  ...
  AWS_GAMELIFT_API RequestUploadCredentialsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_GAMELIFT_API RequestUploadCredentialsResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  void SetUploadCredentials(UploadCredentialsT&& value) {
    ...
    m_uploadCredentials = std::forward<UploadCredentialsT>(value);
  }
  template <typename UploadCredentialsT = AwsCredentials>
  RequestUploadCredentialsResult& WithUploadCredentials(UploadCredentialsT&& value) {
    SetUploadCredentials(std::forward<UploadCredentialsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename StorageLocationT = S3Location>
  RequestUploadCredentialsResult& WithStorageLocation(StorageLocationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  RequestUploadCredentialsResult& WithRequestId(RequestIdT&& value) {
