...
class AttributeValue {
 public:
  ...
  AWS_GAMELIFT_API AttributeValue(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_GAMELIFT_API AttributeValue& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline void SetN(double value) {
    m_nHasBeenSet = true;
    m_n = value;
  }
  inline AttributeValue& WithN(double value) {
    SetN(value);
    return *this;
  }
  ///@}
  ...
  void SetSL(SLT&& value) {
    m_sLHasBeenSet = true;
    m_sL = std::forward<SLT>(value);
  }
  template <typename SLT = Aws::Vector<Aws::String>>
  AttributeValue& WithSL(SLT&& value) {
    SetSL(std::forward<SLT>(value));
    return *this;
  }
  template <typename SLT = Aws::String>
  AttributeValue& AddSL(SLT&& value) {
    m_sLHasBeenSet = true;
    m_sL.emplace_back(std::forward<SLT>(value));
    return *this;
  }
  ///@}
