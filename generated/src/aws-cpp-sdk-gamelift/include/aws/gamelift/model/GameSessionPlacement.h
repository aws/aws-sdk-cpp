...
class GameSessionPlacement {
 public:
  ...
  inline void SetStatus(GameSessionPlacementState value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline GameSessionPlacement& WithStatus(GameSessionPlacementState value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetGameSessionRegion(GameSessionRegionT&& value) {
    ...
    m_gameSessionRegion = std::forward<GameSessionRegionT>(value);
  }
  template <typename GameSessionRegionT = Aws::String>
  GameSessionPlacement& WithGameSessionRegion(GameSessionRegionT&& value) {
    SetGameSessionRegion(std::forward<GameSessionRegionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPlacedPlayerSessions(PlacedPlayerSessionsT&& value) {
    ...
    m_placedPlayerSessions = std::forward<PlacedPlayerSessionsT>(value);
  }
  template <typename PlacedPlayerSessionsT = Aws::Vector<PlacedPlayerSession>>
  GameSessionPlacement& WithPlacedPlayerSessions(PlacedPlayerSessionsT&& value) {
    SetPlacedPlayerSessions(std::forward<PlacedPlayerSessionsT>(value));
    return *this;
  }
  ...
  GameSessionPlacement& AddPlacedPlayerSessions(PlacedPlayerSessionsT&& value) {
    m_placedPlayerSessionsHasBeenSet = true;
    m_placedPlayerSessions.emplace_back(std::forward<PlacedPlayerSessionsT>(value));
    return *this;
  }
  ///@}
