...
class StopFleetActionsResult {
 public:
  AWS_GAMELIFT_API StopFleetActionsResult() = default;
  AWS_GAMELIFT_API StopFleetActionsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_GAMELIFT_API StopFleetActionsResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  template <typename FleetIdT = Aws::String>
  StopFleetActionsResult& WithFleetId(FleetIdT&& value) {
  ...
  template <typename FleetArnT = Aws::String>
  StopFleetActionsResult& WithFleetArn(FleetArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StopFleetActionsResult& WithRequestId(RequestIdT&& value) {
