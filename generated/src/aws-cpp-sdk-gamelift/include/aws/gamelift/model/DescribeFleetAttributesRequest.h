...
class DescribeFleetAttributesRequest : public GameLiftRequest {
 public:
  ...
  template <typename FleetIdsT = Aws::Vector<Aws::String>>
  DescribeFleetAttributesRequest& WithFleetIds(FleetIdsT&& value) {
    SetFleetIds(std::forward<FleetIdsT>(value));
    return *this;
  }
  template <typename FleetIdsT = Aws::String>
  DescribeFleetAttributesRequest& AddFleetIds(FleetIdsT&& value) {
    m_fleetIdsHasBeenSet = true;
  ...
  inline DescribeFleetAttributesRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeFleetAttributesRequest& WithNextToken(NextTokenT&& value) {
