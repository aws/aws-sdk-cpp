...
class UpdateFleetAttributesResult {
 public:
  AWS_GAMELIFT_API UpdateFleetAttributesResult() = default;
  AWS_GAMELIFT_API UpdateFleetAttributesResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_GAMELIFT_API UpdateFleetAttributesResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  template <typename FleetIdT = Aws::String>
  UpdateFleetAttributesResult& WithFleetId(FleetIdT&& value) {
  ...
  template <typename FleetArnT = Aws::String>
  UpdateFleetAttributesResult& WithFleetArn(FleetArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateFleetAttributesResult& WithRequestId(RequestIdT&& value) {
