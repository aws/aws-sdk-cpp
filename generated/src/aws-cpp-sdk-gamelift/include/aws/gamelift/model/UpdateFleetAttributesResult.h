...
namespace Model
{
  ...
  public:
    ...
    template<typename FleetIdT = Aws::String>
    UpdateFleetAttributesResult& WithFleetId(FleetIdT&& value) { SetFleetId(std::forward<FleetIdT>(value)); return *this;}
    ///@}
    ...
    template<typename FleetArnT = Aws::String>
    UpdateFleetAttributesResult& WithFleetArn(FleetArnT&& value) { SetFleetArn(std::forward<FleetArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateFleetAttributesResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
