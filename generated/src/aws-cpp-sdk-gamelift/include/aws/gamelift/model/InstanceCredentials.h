...
class InstanceCredentials {
 public:
  ...
  AWS_GAMELIFT_API InstanceCredentials(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_GAMELIFT_API InstanceCredentials& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
