...
class MatchmakingRuleSet {
 public:
  ...
  AWS_GAMELIFT_API MatchmakingRuleSet(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_GAMELIFT_API MatchmakingRuleSet& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  void SetRuleSetArn(RuleSetArnT&& value) {
    ...
    m_ruleSetArn = std::forward<RuleSetArnT>(value);
  }
  template <typename RuleSetArnT = Aws::String>
  MatchmakingRuleSet& WithRuleSetArn(RuleSetArnT&& value) {
    SetRuleSetArn(std::forward<RuleSetArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRuleSetBody(RuleSetBodyT&& value) {
    ...
    m_ruleSetBody = std::forward<RuleSetBodyT>(value);
  }
  template <typename RuleSetBodyT = Aws::String>
  MatchmakingRuleSet& WithRuleSetBody(RuleSetBodyT&& value) {
    SetRuleSetBody(std::forward<RuleSetBodyT>(value));
    return *this;
  }
  ///@}
