...
class Build {
 public:
  ...
  AWS_GAMELIFT_API Build(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_GAMELIFT_API Build& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  void SetBuildArn(BuildArnT&& value) {
    ...
    m_buildArn = std::forward<BuildArnT>(value);
  }
  template <typename BuildArnT = Aws::String>
  Build& WithBuildArn(BuildArnT&& value) {
    SetBuildArn(std::forward<BuildArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline Build& WithStatus(BuildStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSizeOnDisk(long long value) {
    m_sizeOnDiskHasBeenSet = true;
    m_sizeOnDisk = value;
  }
  inline Build& WithSizeOnDisk(long long value) {
    SetSizeOnDisk(value);
    return *this;
  }
  ///@}
  ...
  inline Build& WithOperatingSystem(OperatingSystem value) {
