...
class StartMatchmakingResult {
 public:
  ...
  AWS_GAMELIFT_API StartMatchmakingResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_GAMELIFT_API StartMatchmakingResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  void SetMatchmakingTicket(MatchmakingTicketT&& value) {
    ...
    m_matchmakingTicket = std::forward<MatchmakingTicketT>(value);
  }
  template <typename MatchmakingTicketT = MatchmakingTicket>
  StartMatchmakingResult& WithMatchmakingTicket(MatchmakingTicketT&& value) {
    SetMatchmakingTicket(std::forward<MatchmakingTicketT>(value));
    return *this;
  }
  ///@}
