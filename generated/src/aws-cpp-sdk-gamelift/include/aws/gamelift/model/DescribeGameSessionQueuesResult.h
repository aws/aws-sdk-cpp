...
class DescribeGameSessionQueuesResult {
 public:
  ...
  AWS_GAMELIFT_API DescribeGameSessionQueuesResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_GAMELIFT_API DescribeGameSessionQueuesResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  void SetGameSessionQueues(GameSessionQueuesT&& value) {
    ...
    m_gameSessionQueues = std::forward<GameSessionQueuesT>(value);
  }
  template <typename GameSessionQueuesT = Aws::Vector<GameSessionQueue>>
  DescribeGameSessionQueuesResult& WithGameSessionQueues(GameSessionQueuesT&& value) {
    SetGameSessionQueues(std::forward<GameSessionQueuesT>(value));
    return *this;
  }
  ...
  DescribeGameSessionQueuesResult& AddGameSessionQueues(GameSessionQueuesT&& value) {
    m_gameSessionQueuesHasBeenSet = true;
    m_gameSessionQueues.emplace_back(std::forward<GameSessionQueuesT>(value));
    return *this;
  }
  ///@}
