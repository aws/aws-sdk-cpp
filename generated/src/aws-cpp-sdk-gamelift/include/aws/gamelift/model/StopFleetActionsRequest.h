...
class StopFleetActionsRequest : public GameLiftRequest {
 public:
  ...
  template <typename FleetIdT = Aws::String>
  StopFleetActionsRequest& WithFleetId(FleetIdT&& value) {
  ...
  template <typename ActionsT = Aws::Vector<FleetAction>>
  StopFleetActionsRequest& WithActions(ActionsT&& value) {
    SetActions(std::forward<ActionsT>(value));
    return *this;
  }
  inline StopFleetActionsRequest& AddActions(FleetAction value) {
    m_actionsHasBeenSet = true;
  ...
  template <typename LocationT = Aws::String>
  StopFleetActionsRequest& WithLocation(LocationT&& value) {
