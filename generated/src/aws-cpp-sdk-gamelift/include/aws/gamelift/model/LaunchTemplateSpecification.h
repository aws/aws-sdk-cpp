...
class LaunchTemplateSpecification {
 public:
  ...
  AWS_GAMELIFT_API LaunchTemplateSpecification(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_GAMELIFT_API LaunchTemplateSpecification& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
