...
class LogConfiguration {
 public:
  ...
  inline void SetLogDestination(LogDestination value) {
    m_logDestinationHasBeenSet = true;
    m_logDestination = value;
  }
  inline LogConfiguration& WithLogDestination(LogDestination value) {
    SetLogDestination(value);
    return *this;
  }
  ///@}
