...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFT_API DescribeRuntimeConfigurationRequest() = default;
    ...
    template<typename FleetIdT = Aws::String>
    DescribeRuntimeConfigurationRequest& WithFleetId(FleetIdT&& value) { SetFleetId(std::forward<FleetIdT>(value)); return *this;}
    ///@}
  private:
