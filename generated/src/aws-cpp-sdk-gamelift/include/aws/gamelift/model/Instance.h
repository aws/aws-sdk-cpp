...
class Instance {
 public:
  ...
  AWS_GAMELIFT_API Instance(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_GAMELIFT_API Instance& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline Instance& WithOperatingSystem(OperatingSystem value) {
  ...
  inline Instance& WithType(EC2InstanceType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline Instance& WithStatus(InstanceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
