...
class UpdateFleetCapacityRequest : public GameLiftRequest {
 public:
  ...
  inline UpdateFleetCapacityRequest& WithDesiredInstances(int value) {
  ...
  inline UpdateFleetCapacityRequest& WithMinSize(int value) {
    SetMinSize(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateFleetCapacityRequest& WithMaxSize(int value) {
    SetMaxSize(value);
    return *this;
  }
  ///@}
