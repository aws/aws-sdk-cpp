...
class UpdateFleetPortSettingsRequest : public GameLiftRequest {
 public:
  ...
  template <typename FleetIdT = Aws::String>
  UpdateFleetPortSettingsRequest& WithFleetId(FleetIdT&& value) {
  ...
  void SetInboundPermissionAuthorizations(InboundPermissionAuthorizationsT&& value) {
    m_inboundPermissionAuthorizationsHasBeenSet = true;
    m_inboundPermissionAuthorizations = std::forward<InboundPermissionAuthorizationsT>(value);
  }
  template <typename InboundPermissionAuthorizationsT = Aws::Vector<IpPermission>>
  UpdateFleetPortSettingsRequest& WithInboundPermissionAuthorizations(InboundPermissionAuthorizationsT&& value) {
    SetInboundPermissionAuthorizations(std::forward<InboundPermissionAuthorizationsT>(value));
    return *this;
  }
  template <typename InboundPermissionAuthorizationsT = IpPermission>
  UpdateFleetPortSettingsRequest& AddInboundPermissionAuthorizations(InboundPermissionAuthorizationsT&& value) {
    m_inboundPermissionAuthorizationsHasBeenSet = true;
    m_inboundPermissionAuthorizations.emplace_back(std::forward<InboundPermissionAuthorizationsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInboundPermissionRevocations(InboundPermissionRevocationsT&& value) {
    m_inboundPermissionRevocationsHasBeenSet = true;
    m_inboundPermissionRevocations = std::forward<InboundPermissionRevocationsT>(value);
  }
  template <typename InboundPermissionRevocationsT = Aws::Vector<IpPermission>>
  UpdateFleetPortSettingsRequest& WithInboundPermissionRevocations(InboundPermissionRevocationsT&& value) {
    SetInboundPermissionRevocations(std::forward<InboundPermissionRevocationsT>(value));
    return *this;
  }
  template <typename InboundPermissionRevocationsT = IpPermission>
  UpdateFleetPortSettingsRequest& AddInboundPermissionRevocations(InboundPermissionRevocationsT&& value) {
    m_inboundPermissionRevocationsHasBeenSet = true;
    m_inboundPermissionRevocations.emplace_back(std::forward<InboundPermissionRevocationsT>(value));
    return *this;
  }
  ///@}
 private:
