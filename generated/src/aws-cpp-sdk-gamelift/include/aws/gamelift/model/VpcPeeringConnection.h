...
class VpcPeeringConnection {
 public:
  ...
  AWS_GAMELIFT_API VpcPeeringConnection(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_GAMELIFT_API VpcPeeringConnection& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  void SetGameLiftVpcId(GameLiftVpcIdT&& value) {
    m_gameLiftVpcIdHasBeenSet = true;
    m_gameLiftVpcId = std::forward<GameLiftVpcIdT>(value);
  }
  template <typename GameLiftVpcIdT = Aws::String>
  VpcPeeringConnection& WithGameLiftVpcId(GameLiftVpcIdT&& value) {
    SetGameLiftVpcId(std::forward<GameLiftVpcIdT>(value));
    return *this;
  }
  ///@}
 private:
