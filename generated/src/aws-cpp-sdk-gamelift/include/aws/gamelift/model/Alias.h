...
class Alias {
 public:
  ...
  AWS_GAMELIFT_API Alias(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_GAMELIFT_API Alias& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
