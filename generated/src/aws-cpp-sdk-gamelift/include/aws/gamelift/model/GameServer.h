...
class GameServer {
 public:
  ...
  AWS_GAMELIFT_API GameServer(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_GAMELIFT_API GameServer& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  void SetGameServerGroupArn(GameServerGroupArnT&& value) {
    ...
    m_gameServerGroupArn = std::forward<GameServerGroupArnT>(value);
  }
  template <typename GameServerGroupArnT = Aws::String>
  GameServer& WithGameServerGroupArn(GameServerGroupArnT&& value) {
    SetGameServerGroupArn(std::forward<GameServerGroupArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetConnectionInfo(ConnectionInfoT&& value) {
    ...
    m_connectionInfo = std::forward<ConnectionInfoT>(value);
  }
  template <typename ConnectionInfoT = Aws::String>
  GameServer& WithConnectionInfo(ConnectionInfoT&& value) {
    SetConnectionInfo(std::forward<ConnectionInfoT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGameServerData(GameServerDataT&& value) {
    ...
    m_gameServerData = std::forward<GameServerDataT>(value);
  }
  template <typename GameServerDataT = Aws::String>
  GameServer& WithGameServerData(GameServerDataT&& value) {
    SetGameServerData(std::forward<GameServerDataT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetClaimStatus(GameServerClaimStatus value) {
    m_claimStatusHasBeenSet = true;
    m_claimStatus = value;
  }
  inline GameServer& WithClaimStatus(GameServerClaimStatus value) {
  ...
  inline void SetUtilizationStatus(GameServerUtilizationStatus value) {
    m_utilizationStatusHasBeenSet = true;
    m_utilizationStatus = value;
  }
  inline GameServer& WithUtilizationStatus(GameServerUtilizationStatus value) {
    SetUtilizationStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetRegistrationTime(RegistrationTimeT&& value) {
    ...
    m_registrationTime = std::forward<RegistrationTimeT>(value);
  }
  template <typename RegistrationTimeT = Aws::Utils::DateTime>
  GameServer& WithRegistrationTime(RegistrationTimeT&& value) {
    SetRegistrationTime(std::forward<RegistrationTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastClaimTime(LastClaimTimeT&& value) {
    ...
    m_lastClaimTime = std::forward<LastClaimTimeT>(value);
  }
  template <typename LastClaimTimeT = Aws::Utils::DateTime>
  GameServer& WithLastClaimTime(LastClaimTimeT&& value) {
    SetLastClaimTime(std::forward<LastClaimTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastHealthCheckTime(LastHealthCheckTimeT&& value) {
    ...
    m_lastHealthCheckTime = std::forward<LastHealthCheckTimeT>(value);
  }
  template <typename LastHealthCheckTimeT = Aws::Utils::DateTime>
  GameServer& WithLastHealthCheckTime(LastHealthCheckTimeT&& value) {
    SetLastHealthCheckTime(std::forward<LastHealthCheckTimeT>(value));
    return *this;
  }
  ///@}
 private:
