...
class DescribeComputeResult {
 public:
  ...
  AWS_GAMELIFT_API DescribeComputeResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_GAMELIFT_API DescribeComputeResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  template <typename ComputeT = Compute>
  DescribeComputeResult& WithCompute(ComputeT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeComputeResult& WithRequestId(RequestIdT&& value) {
