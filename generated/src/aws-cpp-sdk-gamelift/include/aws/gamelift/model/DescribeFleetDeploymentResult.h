...
class DescribeFleetDeploymentResult {
 public:
  ...
  AWS_GAMELIFT_API DescribeFleetDeploymentResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_GAMELIFT_API DescribeFleetDeploymentResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  void SetFleetDeployment(FleetDeploymentT&& value) {
    ...
    m_fleetDeployment = std::forward<FleetDeploymentT>(value);
  }
  template <typename FleetDeploymentT = FleetDeployment>
  DescribeFleetDeploymentResult& WithFleetDeployment(FleetDeploymentT&& value) {
    SetFleetDeployment(std::forward<FleetDeploymentT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLocationalDeployments(LocationalDeploymentsT&& value) {
    ...
    m_locationalDeployments = std::forward<LocationalDeploymentsT>(value);
  }
  template <typename LocationalDeploymentsT = Aws::Map<Aws::String, LocationalDeployment>>
  DescribeFleetDeploymentResult& WithLocationalDeployments(LocationalDeploymentsT&& value) {
    SetLocationalDeployments(std::forward<LocationalDeploymentsT>(value));
    return *this;
  }
  ...
  DescribeFleetDeploymentResult& AddLocationalDeployments(LocationalDeploymentsKeyT&& key, LocationalDeploymentsValueT&& value) {
    m_locationalDeploymentsHasBeenSet = true;
    m_locationalDeployments.emplace(std::forward<LocationalDeploymentsKeyT>(key), std::forward<LocationalDeploymentsValueT>(value));
    return *this;
  }
  ///@}
