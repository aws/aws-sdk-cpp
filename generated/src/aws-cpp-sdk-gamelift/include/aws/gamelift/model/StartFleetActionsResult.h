...
class StartFleetActionsResult {
 public:
  AWS_GAMELIFT_API StartFleetActionsResult() = default;
  AWS_GAMELIFT_API StartFleetActionsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_GAMELIFT_API StartFleetActionsResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  template <typename FleetIdT = Aws::String>
  StartFleetActionsResult& WithFleetId(FleetIdT&& value) {
  ...
  template <typename FleetArnT = Aws::String>
  StartFleetActionsResult& WithFleetArn(FleetArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StartFleetActionsResult& WithRequestId(RequestIdT&& value) {
