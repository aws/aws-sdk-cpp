...
namespace Model
{
  ...
  public:
    ...
    template<typename FleetIdT = Aws::String>
    StartFleetActionsResult& WithFleetId(FleetIdT&& value) { SetFleetId(std::forward<FleetIdT>(value)); return *this;}
    ///@}
    ...
    template<typename FleetArnT = Aws::String>
    StartFleetActionsResult& WithFleetArn(FleetArnT&& value) { SetFleetArn(std::forward<FleetArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    StartFleetActionsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
