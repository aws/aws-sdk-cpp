...
class DeleteContainerGroupDefinitionRequest : public GameLiftRequest {
 public:
  ...
  inline DeleteContainerGroupDefinitionRequest& WithVersionNumber(int value) {
  ...
  inline void SetVersionCountToRetain(int value) {
    m_versionCountToRetainHasBeenSet = true;
    m_versionCountToRetain = value;
  }
  inline DeleteContainerGroupDefinitionRequest& WithVersionCountToRetain(int value) {
    SetVersionCountToRetain(value);
    return *this;
  }
  ///@}
 private:
