...
class DeleteGameServerGroupRequest : public GameLiftRequest {
 public:
  ...
  inline void SetDeleteOption(GameServerGroupDeleteOption value) {
    m_deleteOptionHasBeenSet = true;
    m_deleteOption = value;
  }
  inline DeleteGameServerGroupRequest& WithDeleteOption(GameServerGroupDeleteOption value) {
