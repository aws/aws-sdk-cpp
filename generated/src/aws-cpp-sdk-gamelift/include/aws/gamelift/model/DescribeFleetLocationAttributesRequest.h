...
namespace Model
{
  ...
  public:
    ...
    template<typename FleetIdT = Aws::String>
    DescribeFleetLocationAttributesRequest& WithFleetId(FleetIdT&& value) { SetFleetId(std::forward<FleetIdT>(value)); return *this;}
    ///@}
    ...
    template<typename LocationsT = Aws::Vector<Aws::String>>
    DescribeFleetLocationAttributesRequest& WithLocations(LocationsT&& value) { SetLocations(std::forward<LocationsT>(value)); return *this;}
    template<typename LocationsT = Aws::String>
    DescribeFleetLocationAttributesRequest& AddLocations(LocationsT&& value) { m_locationsHasBeenSet = true; m_locations.emplace_back(std::forward<LocationsT>(value)); return *this; }
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    DescribeFleetLocationAttributesRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
