...
class ContainerPortConfiguration {
 public:
  ...
  void SetContainerPortRanges(ContainerPortRangesT&& value) {
    ...
    m_containerPortRanges = std::forward<ContainerPortRangesT>(value);
  }
  template <typename ContainerPortRangesT = Aws::Vector<ContainerPortRange>>
  ContainerPortConfiguration& WithContainerPortRanges(ContainerPortRangesT&& value) {
    SetContainerPortRanges(std::forward<ContainerPortRangesT>(value));
    return *this;
  }
  ...
  ContainerPortConfiguration& AddContainerPortRanges(ContainerPortRangesT&& value) {
    m_containerPortRangesHasBeenSet = true;
    m_containerPortRanges.emplace_back(std::forward<ContainerPortRangesT>(value));
    return *this;
  }
  ///@}
 private:
