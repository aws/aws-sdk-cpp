...
class UpdateContainerFleetRequest : public GameLiftRequest {
 public:
  ...
  void SetGameServerContainerGroupDefinitionName(GameServerContainerGroupDefinitionNameT&& value) {
    ...
    m_gameServerContainerGroupDefinitionName = std::forward<GameServerContainerGroupDefinitionNameT>(value);
  }
  template <typename GameServerContainerGroupDefinitionNameT = Aws::String>
  UpdateContainerFleetRequest& WithGameServerContainerGroupDefinitionName(GameServerContainerGroupDefinitionNameT&& value) {
    SetGameServerContainerGroupDefinitionName(std::forward<GameServerContainerGroupDefinitionNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPerInstanceContainerGroupDefinitionName(PerInstanceContainerGroupDefinitionNameT&& value) {
    ...
    m_perInstanceContainerGroupDefinitionName = std::forward<PerInstanceContainerGroupDefinitionNameT>(value);
  }
  template <typename PerInstanceContainerGroupDefinitionNameT = Aws::String>
  UpdateContainerFleetRequest& WithPerInstanceContainerGroupDefinitionName(PerInstanceContainerGroupDefinitionNameT&& value) {
    SetPerInstanceContainerGroupDefinitionName(std::forward<PerInstanceContainerGroupDefinitionNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline UpdateContainerFleetRequest& WithGameServerContainerGroupsPerInstance(int value) {
  ...
  void SetInstanceConnectionPortRange(InstanceConnectionPortRangeT&& value) {
    ...
    m_instanceConnectionPortRange = std::forward<InstanceConnectionPortRangeT>(value);
  }
  template <typename InstanceConnectionPortRangeT = ConnectionPortRange>
  UpdateContainerFleetRequest& WithInstanceConnectionPortRange(InstanceConnectionPortRangeT&& value) {
    SetInstanceConnectionPortRange(std::forward<InstanceConnectionPortRangeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInstanceInboundPermissionAuthorizations(InstanceInboundPermissionAuthorizationsT&& value) {
    m_instanceInboundPermissionAuthorizationsHasBeenSet = true;
    m_instanceInboundPermissionAuthorizations = std::forward<InstanceInboundPermissionAuthorizationsT>(value);
  }
  template <typename InstanceInboundPermissionAuthorizationsT = Aws::Vector<IpPermission>>
  UpdateContainerFleetRequest& WithInstanceInboundPermissionAuthorizations(InstanceInboundPermissionAuthorizationsT&& value) {
    SetInstanceInboundPermissionAuthorizations(std::forward<InstanceInboundPermissionAuthorizationsT>(value));
    return *this;
  }
  ...
  UpdateContainerFleetRequest& AddInstanceInboundPermissionAuthorizations(InstanceInboundPermissionAuthorizationsT&& value) {
    m_instanceInboundPermissionAuthorizationsHasBeenSet = true;
    m_instanceInboundPermissionAuthorizations.emplace_back(std::forward<InstanceInboundPermissionAuthorizationsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInstanceInboundPermissionRevocations(InstanceInboundPermissionRevocationsT&& value) {
    m_instanceInboundPermissionRevocationsHasBeenSet = true;
    m_instanceInboundPermissionRevocations = std::forward<InstanceInboundPermissionRevocationsT>(value);
  }
  template <typename InstanceInboundPermissionRevocationsT = Aws::Vector<IpPermission>>
  UpdateContainerFleetRequest& WithInstanceInboundPermissionRevocations(InstanceInboundPermissionRevocationsT&& value) {
    SetInstanceInboundPermissionRevocations(std::forward<InstanceInboundPermissionRevocationsT>(value));
    return *this;
  }
  ...
  UpdateContainerFleetRequest& AddInstanceInboundPermissionRevocations(InstanceInboundPermissionRevocationsT&& value) {
    m_instanceInboundPermissionRevocationsHasBeenSet = true;
    m_instanceInboundPermissionRevocations.emplace_back(std::forward<InstanceInboundPermissionRevocationsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetNewGameSessionProtectionPolicy(ProtectionPolicy value) {
    m_newGameSessionProtectionPolicyHasBeenSet = true;
    m_newGameSessionProtectionPolicy = value;
  }
  inline UpdateContainerFleetRequest& WithNewGameSessionProtectionPolicy(ProtectionPolicy value) {
    SetNewGameSessionProtectionPolicy(value);
    return *this;
  }
  ///@}
  ...
  void SetGameSessionCreationLimitPolicy(GameSessionCreationLimitPolicyT&& value) {
    ...
    m_gameSessionCreationLimitPolicy = std::forward<GameSessionCreationLimitPolicyT>(value);
  }
  template <typename GameSessionCreationLimitPolicyT = GameSessionCreationLimitPolicy>
  UpdateContainerFleetRequest& WithGameSessionCreationLimitPolicy(GameSessionCreationLimitPolicyT&& value) {
    SetGameSessionCreationLimitPolicy(std::forward<GameSessionCreationLimitPolicyT>(value));
    return *this;
  }
  ///@}
  ...
  inline UpdateContainerFleetRequest& AddRemoveAttributes(ContainerFleetRemoveAttribute value) {
    m_removeAttributesHasBeenSet = true;
