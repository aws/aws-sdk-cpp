...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFT_API DescribeVpcPeeringConnectionsRequest() = default;
    ...
    template<typename FleetIdT = Aws::String>
    DescribeVpcPeeringConnectionsRequest& WithFleetId(FleetIdT&& value) { SetFleetId(std::forward<FleetIdT>(value)); return *this;}
    ///@}
  private:
