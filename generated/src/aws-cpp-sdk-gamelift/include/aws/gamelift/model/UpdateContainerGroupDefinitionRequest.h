...
class UpdateContainerGroupDefinitionRequest : public GameLiftRequest {
 public:
  ...
  void SetGameServerContainerDefinition(GameServerContainerDefinitionT&& value) {
    ...
    m_gameServerContainerDefinition = std::forward<GameServerContainerDefinitionT>(value);
  }
  template <typename GameServerContainerDefinitionT = GameServerContainerDefinitionInput>
  UpdateContainerGroupDefinitionRequest& WithGameServerContainerDefinition(GameServerContainerDefinitionT&& value) {
    SetGameServerContainerDefinition(std::forward<GameServerContainerDefinitionT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::Vector<SupportContainerDefinitionInput>& GetSupportContainerDefinitions() const {
    return m_supportContainerDefinitions;
  }
  ...
  void SetSupportContainerDefinitions(SupportContainerDefinitionsT&& value) {
    ...
    m_supportContainerDefinitions = std::forward<SupportContainerDefinitionsT>(value);
  }
  template <typename SupportContainerDefinitionsT = Aws::Vector<SupportContainerDefinitionInput>>
  UpdateContainerGroupDefinitionRequest& WithSupportContainerDefinitions(SupportContainerDefinitionsT&& value) {
    SetSupportContainerDefinitions(std::forward<SupportContainerDefinitionsT>(value));
    return *this;
  }
  ...
  UpdateContainerGroupDefinitionRequest& AddSupportContainerDefinitions(SupportContainerDefinitionsT&& value) {
    m_supportContainerDefinitionsHasBeenSet = true;
    m_supportContainerDefinitions.emplace_back(std::forward<SupportContainerDefinitionsT>(value));
    return *this;
  }
  ///@}
  ...
  inline UpdateContainerGroupDefinitionRequest& WithTotalMemoryLimitMebibytes(int value) {
  ...
  inline void SetTotalVcpuLimit(double value) {
    m_totalVcpuLimitHasBeenSet = true;
    m_totalVcpuLimit = value;
  }
  inline UpdateContainerGroupDefinitionRequest& WithTotalVcpuLimit(double value) {
    SetTotalVcpuLimit(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSourceVersionNumber(int value) {
    m_sourceVersionNumberHasBeenSet = true;
    m_sourceVersionNumber = value;
  }
  inline UpdateContainerGroupDefinitionRequest& WithSourceVersionNumber(int value) {
    SetSourceVersionNumber(value);
    return *this;
  }
  ///@}
  ...
  inline void SetOperatingSystem(ContainerOperatingSystem value) {
    m_operatingSystemHasBeenSet = true;
    m_operatingSystem = value;
  }
  inline UpdateContainerGroupDefinitionRequest& WithOperatingSystem(ContainerOperatingSystem value) {
