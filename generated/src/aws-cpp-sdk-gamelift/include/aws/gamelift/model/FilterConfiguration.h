...
class FilterConfiguration {
 public:
  ...
  AWS_GAMELIFT_API FilterConfiguration(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_GAMELIFT_API FilterConfiguration& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  void SetAllowedLocations(AllowedLocationsT&& value) {
    m_allowedLocationsHasBeenSet = true;
    m_allowedLocations = std::forward<AllowedLocationsT>(value);
  }
  template <typename AllowedLocationsT = Aws::Vector<Aws::String>>
  FilterConfiguration& WithAllowedLocations(AllowedLocationsT&& value) {
    SetAllowedLocations(std::forward<AllowedLocationsT>(value));
    return *this;
  }
  template <typename AllowedLocationsT = Aws::String>
  FilterConfiguration& AddAllowedLocations(AllowedLocationsT&& value) {
    m_allowedLocationsHasBeenSet = true;
    m_allowedLocations.emplace_back(std::forward<AllowedLocationsT>(value));
    return *this;
  }
  ///@}
 private:
