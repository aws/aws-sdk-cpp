...
class UpdateRuntimeConfigurationResult {
 public:
  ...
  AWS_GAMELIFT_API UpdateRuntimeConfigurationResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_GAMELIFT_API UpdateRuntimeConfigurationResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  template <typename RuntimeConfigurationT = RuntimeConfiguration>
  UpdateRuntimeConfigurationResult& WithRuntimeConfiguration(RuntimeConfigurationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateRuntimeConfigurationResult& WithRequestId(RequestIdT&& value) {
