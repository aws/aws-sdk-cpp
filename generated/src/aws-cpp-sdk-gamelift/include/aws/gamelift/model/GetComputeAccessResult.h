...
class GetComputeAccessResult {
 public:
  ...
  AWS_GAMELIFT_API GetComputeAccessResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_GAMELIFT_API GetComputeAccessResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  void SetContainerIdentifiers(ContainerIdentifiersT&& value) {
    ...
    m_containerIdentifiers = std::forward<ContainerIdentifiersT>(value);
  }
  template <typename ContainerIdentifiersT = Aws::Vector<ContainerIdentifier>>
  GetComputeAccessResult& WithContainerIdentifiers(ContainerIdentifiersT&& value) {
    SetContainerIdentifiers(std::forward<ContainerIdentifiersT>(value));
    return *this;
  }
  ...
  GetComputeAccessResult& AddContainerIdentifiers(ContainerIdentifiersT&& value) {
    m_containerIdentifiersHasBeenSet = true;
    m_containerIdentifiers.emplace_back(std::forward<ContainerIdentifiersT>(value));
    return *this;
  }
  ///@}
