...
class TerminateGameSessionRequest : public GameLiftRequest {
 public:
  ...
  ///@{
  /**
   * <p>An identifier for the game session that is unique across all regions to be
  ...
  inline void SetTerminationMode(TerminationMode value) {
    m_terminationModeHasBeenSet = true;
    m_terminationMode = value;
  }
  inline TerminateGameSessionRequest& WithTerminationMode(TerminationMode value) {
    SetTerminationMode(value);
    return *this;
  }
  ///@}
 private:
