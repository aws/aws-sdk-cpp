...
class CreateContainerFleetRequest : public GameLiftRequest {
 public:
  ...
  void SetFleetRoleArn(FleetRoleArnT&& value) {
    ...
    m_fleetRoleArn = std::forward<FleetRoleArnT>(value);
  }
  template <typename FleetRoleArnT = Aws::String>
  CreateContainerFleetRequest& WithFleetRoleArn(FleetRoleArnT&& value) {
    SetFleetRoleArn(std::forward<FleetRoleArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInstanceInboundPermissions(InstanceInboundPermissionsT&& value) {
    ...
    m_instanceInboundPermissions = std::forward<InstanceInboundPermissionsT>(value);
  }
  template <typename InstanceInboundPermissionsT = Aws::Vector<IpPermission>>
  CreateContainerFleetRequest& WithInstanceInboundPermissions(InstanceInboundPermissionsT&& value) {
    SetInstanceInboundPermissions(std::forward<InstanceInboundPermissionsT>(value));
    return *this;
  }
  ...
  CreateContainerFleetRequest& AddInstanceInboundPermissions(InstanceInboundPermissionsT&& value) {
    m_instanceInboundPermissionsHasBeenSet = true;
    m_instanceInboundPermissions.emplace_back(std::forward<InstanceInboundPermissionsT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateContainerFleetRequest& WithGameServerContainerGroupsPerInstance(int value) {
  ...
  inline void SetBillingType(ContainerFleetBillingType value) {
    m_billingTypeHasBeenSet = true;
    m_billingType = value;
  }
  inline CreateContainerFleetRequest& WithBillingType(ContainerFleetBillingType value) {
  ...
  inline CreateContainerFleetRequest& WithNewGameSessionProtectionPolicy(ProtectionPolicy value) {
