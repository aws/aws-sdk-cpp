...
class CreateGameSessionRequest : public GameLiftRequest {
 public:
  ...
  inline CreateGameSessionRequest& WithMaximumPlayerSessionCount(int value) {
   ...
   * a game session with custom properties</a>. </p>  <ul> <li> <p>Avoid using
   * periods (".") in property keys if you plan to search for game sessions by
   * properties. Property keys containing periods cannot be searched and will be
   * filtered out from search results due to search index limitations.</p> </li> <li>
   * <p>If you use SearchGameSessions API, there is a limit of 500 game property keys
   ...
   * session's ID. The value is always a full ARN in the following format:
   * <code>arn:aws:gamelift:&lt;location&gt;::gamesession/&lt;fleet ID&gt;/&lt;ID
   * string&gt;</code>. Idempotency tokens remain in use for 30 days after a game
   * session has ended; game session objects are retained for this time period and
   * then deleted.</p>
   */
