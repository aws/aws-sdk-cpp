...
class CreateGameSessionRequest : public GameLiftRequest {
 public:
   ...
   * session's ID. The value is always a full ARN in the following format: For Home
   * Region game session -
   ...
   * ID&gt;/&lt;location&gt;/&lt;ID string&gt;</code>. Idempotency tokens remain in
   * use for 30 days after a game session has ended; game session objects are
   * retained for this time period and then deleted.</p>
   */
