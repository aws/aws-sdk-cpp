...
class GameSessionDetail {
 public:
  ...
  inline void SetProtectionPolicy(ProtectionPolicy value) {
    m_protectionPolicyHasBeenSet = true;
    m_protectionPolicy = value;
  }
  inline GameSessionDetail& WithProtectionPolicy(ProtectionPolicy value) {
    SetProtectionPolicy(value);
    return *this;
  }
  ///@}
 private:
