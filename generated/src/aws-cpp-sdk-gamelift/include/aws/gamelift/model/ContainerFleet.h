...
class ContainerFleet {
 public:
  ...
  void SetPerInstanceContainerGroupDefinitionArn(PerInstanceContainerGroupDefinitionArnT&& value) {
    ...
    m_perInstanceContainerGroupDefinitionArn = std::forward<PerInstanceContainerGroupDefinitionArnT>(value);
  }
  template <typename PerInstanceContainerGroupDefinitionArnT = Aws::String>
  ContainerFleet& WithPerInstanceContainerGroupDefinitionArn(PerInstanceContainerGroupDefinitionArnT&& value) {
    SetPerInstanceContainerGroupDefinitionArn(std::forward<PerInstanceContainerGroupDefinitionArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline ContainerFleet& WithBillingType(ContainerFleetBillingType value) {
  ...
  inline ContainerFleet& WithNewGameSessionProtectionPolicy(ProtectionPolicy value) {
  ...
  inline void SetStatus(ContainerFleetStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ContainerFleet& WithStatus(ContainerFleetStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetDeploymentDetails(DeploymentDetailsT&& value) {
    ...
    m_deploymentDetails = std::forward<DeploymentDetailsT>(value);
  }
  template <typename DeploymentDetailsT = DeploymentDetails>
  ContainerFleet& WithDeploymentDetails(DeploymentDetailsT&& value) {
    SetDeploymentDetails(std::forward<DeploymentDetailsT>(value));
    return *this;
  }
  ///@}
