...
class RoutingStrategy {
 public:
  ...
  AWS_GAMELIFT_API RoutingStrategy(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_GAMELIFT_API RoutingStrategy& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline void SetType(RoutingStrategyType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline RoutingStrategy& WithType(RoutingStrategyType value) {
    SetType(value);
    return *this;
  }
  ///@}
