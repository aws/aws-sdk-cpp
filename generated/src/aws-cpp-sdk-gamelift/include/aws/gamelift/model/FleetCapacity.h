...
class FleetCapacity {
 public:
  ...
  AWS_GAMELIFT_API FleetCapacity(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_GAMELIFT_API FleetCapacity& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  template <typename FleetIdT = Aws::String>
  FleetCapacity& WithFleetId(FleetIdT&& value) {
  ...
  template <typename FleetArnT = Aws::String>
  FleetCapacity& WithFleetArn(FleetArnT&& value) {
  ...
  inline void SetInstanceType(EC2InstanceType value) {
    m_instanceTypeHasBeenSet = true;
    m_instanceType = value;
  }
  inline FleetCapacity& WithInstanceType(EC2InstanceType value) {
  ...
  void SetInstanceCounts(InstanceCountsT&& value) {
    ...
    m_instanceCounts = std::forward<InstanceCountsT>(value);
  }
  template <typename InstanceCountsT = EC2InstanceCounts>
  FleetCapacity& WithInstanceCounts(InstanceCountsT&& value) {
    SetInstanceCounts(std::forward<InstanceCountsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename LocationT = Aws::String>
  FleetCapacity& WithLocation(LocationT&& value) {
  ...
  void SetGameServerContainerGroupCounts(GameServerContainerGroupCountsT&& value) {
    m_gameServerContainerGroupCountsHasBeenSet = true;
    m_gameServerContainerGroupCounts = std::forward<GameServerContainerGroupCountsT>(value);
  }
  template <typename GameServerContainerGroupCountsT = GameServerContainerGroupCounts>
  FleetCapacity& WithGameServerContainerGroupCounts(GameServerContainerGroupCountsT&& value) {
    SetGameServerContainerGroupCounts(std::forward<GameServerContainerGroupCountsT>(value));
    return *this;
  }
  ///@}
