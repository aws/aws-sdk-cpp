...
class CreateFleetRequest : public GameLiftRequest {
 public:
  ...
  void SetServerLaunchPath(ServerLaunchPathT&& value) {
    ...
    m_serverLaunchPath = std::forward<ServerLaunchPathT>(value);
  }
  template <typename ServerLaunchPathT = Aws::String>
  CreateFleetRequest& WithServerLaunchPath(ServerLaunchPathT&& value) {
    SetServerLaunchPath(std::forward<ServerLaunchPathT>(value));
    return *this;
  }
  ///@}
  ...
  void SetServerLaunchParameters(ServerLaunchParametersT&& value) {
    ...
    m_serverLaunchParameters = std::forward<ServerLaunchParametersT>(value);
  }
  template <typename ServerLaunchParametersT = Aws::String>
  CreateFleetRequest& WithServerLaunchParameters(ServerLaunchParametersT&& value) {
    SetServerLaunchParameters(std::forward<ServerLaunchParametersT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetEC2InstanceType(EC2InstanceType value) {
    m_eC2InstanceTypeHasBeenSet = true;
    m_eC2InstanceType = value;
  }
  inline CreateFleetRequest& WithEC2InstanceType(EC2InstanceType value) {
  ...
  void SetEC2InboundPermissions(EC2InboundPermissionsT&& value) {
    m_eC2InboundPermissionsHasBeenSet = true;
    m_eC2InboundPermissions = std::forward<EC2InboundPermissionsT>(value);
  }
  template <typename EC2InboundPermissionsT = Aws::Vector<IpPermission>>
  CreateFleetRequest& WithEC2InboundPermissions(EC2InboundPermissionsT&& value) {
    SetEC2InboundPermissions(std::forward<EC2InboundPermissionsT>(value));
    return *this;
  }
  ...
  CreateFleetRequest& AddEC2InboundPermissions(EC2InboundPermissionsT&& value) {
    m_eC2InboundPermissionsHasBeenSet = true;
    m_eC2InboundPermissions.emplace_back(std::forward<EC2InboundPermissionsT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateFleetRequest& WithNewGameSessionProtectionPolicy(ProtectionPolicy value) {
  ...
  void SetResourceCreationLimitPolicy(ResourceCreationLimitPolicyT&& value) {
    ...
    m_resourceCreationLimitPolicy = std::forward<ResourceCreationLimitPolicyT>(value);
  }
  template <typename ResourceCreationLimitPolicyT = ResourceCreationLimitPolicy>
  CreateFleetRequest& WithResourceCreationLimitPolicy(ResourceCreationLimitPolicyT&& value) {
    SetResourceCreationLimitPolicy(std::forward<ResourceCreationLimitPolicyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPeerVpcAwsAccountId(PeerVpcAwsAccountIdT&& value) {
    ...
    m_peerVpcAwsAccountId = std::forward<PeerVpcAwsAccountIdT>(value);
  }
  template <typename PeerVpcAwsAccountIdT = Aws::String>
  CreateFleetRequest& WithPeerVpcAwsAccountId(PeerVpcAwsAccountIdT&& value) {
    SetPeerVpcAwsAccountId(std::forward<PeerVpcAwsAccountIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetFleetType(FleetType value) {
    m_fleetTypeHasBeenSet = true;
    m_fleetType = value;
  }
  inline CreateFleetRequest& WithFleetType(FleetType value) {
    SetFleetType(value);
    return *this;
  }
  ///@}
  ...
  void SetCertificateConfiguration(CertificateConfigurationT&& value) {
    ...
    m_certificateConfiguration = std::forward<CertificateConfigurationT>(value);
  }
  template <typename CertificateConfigurationT = CertificateConfiguration>
  CreateFleetRequest& WithCertificateConfiguration(CertificateConfigurationT&& value) {
    SetCertificateConfiguration(std::forward<CertificateConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAnywhereConfiguration(AnywhereConfigurationT&& value) {
    ...
    m_anywhereConfiguration = std::forward<AnywhereConfigurationT>(value);
  }
  template <typename AnywhereConfigurationT = AnywhereConfiguration>
  CreateFleetRequest& WithAnywhereConfiguration(AnywhereConfigurationT&& value) {
    SetAnywhereConfiguration(std::forward<AnywhereConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetInstanceRoleCredentialsProvider(InstanceRoleCredentialsProvider value) {
    m_instanceRoleCredentialsProviderHasBeenSet = true;
    m_instanceRoleCredentialsProvider = value;
  }
  inline CreateFleetRequest& WithInstanceRoleCredentialsProvider(InstanceRoleCredentialsProvider value) {
    SetInstanceRoleCredentialsProvider(value);
    return *this;
  }
  ///@}
 private:
