...
namespace Model
{
  ...
  public:
    ...
    template<typename GameServerT = GameServer>
    RegisterGameServerResult& WithGameServer(GameServerT&& value) { SetGameServer(std::forward<GameServerT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    RegisterGameServerResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
