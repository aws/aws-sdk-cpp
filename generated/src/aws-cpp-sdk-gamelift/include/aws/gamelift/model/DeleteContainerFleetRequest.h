...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFT_API DeleteContainerFleetRequest() = default;
    ...
    template<typename FleetIdT = Aws::String>
    DeleteContainerFleetRequest& WithFleetId(FleetIdT&& value) { SetFleetId(std::forward<FleetIdT>(value)); return *this;}
    ///@}
  private:
