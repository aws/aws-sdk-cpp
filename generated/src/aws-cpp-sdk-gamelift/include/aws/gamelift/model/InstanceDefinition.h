...
class InstanceDefinition {
 public:
  ...
  AWS_GAMELIFT_API InstanceDefinition(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_GAMELIFT_API InstanceDefinition& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline void SetInstanceType(GameServerGroupInstanceType value) {
    m_instanceTypeHasBeenSet = true;
    m_instanceType = value;
  }
  inline InstanceDefinition& WithInstanceType(GameServerGroupInstanceType value) {
