...
class DescribeScriptResult {
 public:
  ...
  AWS_GAMELIFT_API DescribeScriptResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_GAMELIFT_API DescribeScriptResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  template <typename ScriptT = Script>
  DescribeScriptResult& WithScript(ScriptT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeScriptResult& WithRequestId(RequestIdT&& value) {
