...
namespace Model
{
  ...
  public:
    ...
    template<typename GameSessionT = GameSession>
    UpdateGameSessionResult& WithGameSession(GameSessionT&& value) { SetGameSession(std::forward<GameSessionT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateGameSessionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
