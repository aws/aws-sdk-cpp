...
class UpdateGameSessionResult {
 public:
  AWS_GAMELIFT_API UpdateGameSessionResult() = default;
  AWS_GAMELIFT_API UpdateGameSessionResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_GAMELIFT_API UpdateGameSessionResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  template <typename GameSessionT = GameSession>
  UpdateGameSessionResult& WithGameSession(GameSessionT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateGameSessionResult& WithRequestId(RequestIdT&& value) {
