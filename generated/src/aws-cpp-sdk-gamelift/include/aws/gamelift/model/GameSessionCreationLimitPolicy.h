...
class GameSessionCreationLimitPolicy {
 public:
  ...
  inline GameSessionCreationLimitPolicy& WithNewGameSessionsPerCreator(int value) {
  ...
  inline GameSessionCreationLimitPolicy& WithPolicyPeriodInMinutes(int value) {
