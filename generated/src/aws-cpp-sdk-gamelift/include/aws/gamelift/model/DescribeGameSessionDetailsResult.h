...
class DescribeGameSessionDetailsResult {
 public:
  ...
  AWS_GAMELIFT_API DescribeGameSessionDetailsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_GAMELIFT_API DescribeGameSessionDetailsResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  void SetGameSessionDetails(GameSessionDetailsT&& value) {
    ...
    m_gameSessionDetails = std::forward<GameSessionDetailsT>(value);
  }
  template <typename GameSessionDetailsT = Aws::Vector<GameSessionDetail>>
  DescribeGameSessionDetailsResult& WithGameSessionDetails(GameSessionDetailsT&& value) {
    SetGameSessionDetails(std::forward<GameSessionDetailsT>(value));
    return *this;
  }
  ...
  DescribeGameSessionDetailsResult& AddGameSessionDetails(GameSessionDetailsT&& value) {
    m_gameSessionDetailsHasBeenSet = true;
    m_gameSessionDetails.emplace_back(std::forward<GameSessionDetailsT>(value));
    return *this;
  }
  ///@}
