...
class MatchmakingConfiguration {
 public:
  ...
  inline MatchmakingConfiguration& WithAcceptanceRequired(bool value) {
  ...
  inline MatchmakingConfiguration& WithBackfillMode(BackfillMode value) {
  ...
  inline MatchmakingConfiguration& WithFlexMatchMode(FlexMatchMode value) {
