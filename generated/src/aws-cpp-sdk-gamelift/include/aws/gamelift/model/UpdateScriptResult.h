...
class UpdateScriptResult {
 public:
  AWS_GAMELIFT_API UpdateScriptResult() = default;
  AWS_GAMELIFT_API UpdateScriptResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_GAMELIFT_API UpdateScriptResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  template <typename ScriptT = Script>
  UpdateScriptResult& WithScript(ScriptT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateScriptResult& WithRequestId(RequestIdT&& value) {
