...
class DescribeFleetLocationAttributesResult {
 public:
  ...
  AWS_GAMELIFT_API DescribeFleetLocationAttributesResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_GAMELIFT_API DescribeFleetLocationAttributesResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  void SetLocationAttributes(LocationAttributesT&& value) {
    ...
    m_locationAttributes = std::forward<LocationAttributesT>(value);
  }
  template <typename LocationAttributesT = Aws::Vector<LocationAttributes>>
  DescribeFleetLocationAttributesResult& WithLocationAttributes(LocationAttributesT&& value) {
    SetLocationAttributes(std::forward<LocationAttributesT>(value));
    return *this;
  }
  ...
  DescribeFleetLocationAttributesResult& AddLocationAttributes(LocationAttributesT&& value) {
    m_locationAttributesHasBeenSet = true;
    m_locationAttributes.emplace_back(std::forward<LocationAttributesT>(value));
    return *this;
  }
  ///@}
