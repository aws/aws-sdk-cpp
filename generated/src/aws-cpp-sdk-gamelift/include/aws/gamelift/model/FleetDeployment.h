...
class FleetDeployment {
 public:
  ...
  AWS_GAMELIFT_API FleetDeployment(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_GAMELIFT_API FleetDeployment& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  void SetGameServerBinaryArn(GameServerBinaryArnT&& value) {
    ...
    m_gameServerBinaryArn = std::forward<GameServerBinaryArnT>(value);
  }
  template <typename GameServerBinaryArnT = Aws::String>
  FleetDeployment& WithGameServerBinaryArn(GameServerBinaryArnT&& value) {
    SetGameServerBinaryArn(std::forward<GameServerBinaryArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRollbackGameServerBinaryArn(RollbackGameServerBinaryArnT&& value) {
    ...
    m_rollbackGameServerBinaryArn = std::forward<RollbackGameServerBinaryArnT>(value);
  }
  template <typename RollbackGameServerBinaryArnT = Aws::String>
  FleetDeployment& WithRollbackGameServerBinaryArn(RollbackGameServerBinaryArnT&& value) {
    SetRollbackGameServerBinaryArn(std::forward<RollbackGameServerBinaryArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPerInstanceBinaryArn(PerInstanceBinaryArnT&& value) {
    ...
    m_perInstanceBinaryArn = std::forward<PerInstanceBinaryArnT>(value);
  }
  template <typename PerInstanceBinaryArnT = Aws::String>
  FleetDeployment& WithPerInstanceBinaryArn(PerInstanceBinaryArnT&& value) {
    SetPerInstanceBinaryArn(std::forward<PerInstanceBinaryArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRollbackPerInstanceBinaryArn(RollbackPerInstanceBinaryArnT&& value) {
    ...
    m_rollbackPerInstanceBinaryArn = std::forward<RollbackPerInstanceBinaryArnT>(value);
  }
  template <typename RollbackPerInstanceBinaryArnT = Aws::String>
  FleetDeployment& WithRollbackPerInstanceBinaryArn(RollbackPerInstanceBinaryArnT&& value) {
    SetRollbackPerInstanceBinaryArn(std::forward<RollbackPerInstanceBinaryArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline FleetDeployment& WithDeploymentStatus(DeploymentStatus value) {
