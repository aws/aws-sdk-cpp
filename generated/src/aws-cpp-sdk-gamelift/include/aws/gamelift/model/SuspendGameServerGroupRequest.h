...
class SuspendGameServerGroupRequest : public GameLiftRequest {
 public:
  ...
  void SetSuspendActions(SuspendActionsT&& value) {
    m_suspendActionsHasBeenSet = true;
    m_suspendActions = std::forward<SuspendActionsT>(value);
  }
  template <typename SuspendActionsT = Aws::Vector<GameServerGroupAction>>
  SuspendGameServerGroupRequest& WithSuspendActions(SuspendActionsT&& value) {
    SetSuspendActions(std::forward<SuspendActionsT>(value));
    return *this;
  }
  inline SuspendGameServerGroupRequest& AddSuspendActions(GameServerGroupAction value) {
    m_suspendActionsHasBeenSet = true;
    m_suspendActions.push_back(value);
    return *this;
  }
  ///@}
 private:
