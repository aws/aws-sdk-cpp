...
class ListAliasesRequest : public GameLiftRequest {
 public:
  ...
  inline void SetRoutingStrategyType(RoutingStrategyType value) {
    m_routingStrategyTypeHasBeenSet = true;
    m_routingStrategyType = value;
  }
  inline ListAliasesRequest& WithRoutingStrategyType(RoutingStrategyType value) {
    SetRoutingStrategyType(value);
    return *this;
  }
  ///@}
