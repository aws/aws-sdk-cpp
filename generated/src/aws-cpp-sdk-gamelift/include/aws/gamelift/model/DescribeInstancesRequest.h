...
namespace Model
{
  ...
  public:
    ...
    template<typename FleetIdT = Aws::String>
    DescribeInstancesRequest& WithFleetId(FleetIdT&& value) { SetFleetId(std::forward<FleetIdT>(value)); return *this;}
    ///@}
    ...
    template<typename InstanceIdT = Aws::String>
    DescribeInstancesRequest& WithInstanceId(InstanceIdT&& value) { SetInstanceId(std::forward<InstanceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename LocationT = Aws::String>
    DescribeInstancesRequest& WithLocation(LocationT&& value) { SetLocation(std::forward<LocationT>(value)); return *this;}
    ///@}
  private:
