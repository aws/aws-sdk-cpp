...
class GameServerInstance {
 public:
  ...
  AWS_GAMELIFT_API GameServerInstance(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_GAMELIFT_API GameServerInstance& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  template <typename GameServerGroupNameT = Aws::String>
  GameServerInstance& WithGameServerGroupName(GameServerGroupNameT&& value) {
  ...
  template <typename GameServerGroupArnT = Aws::String>
  GameServerInstance& WithGameServerGroupArn(GameServerGroupArnT&& value) {
  ...
  template <typename InstanceIdT = Aws::String>
  GameServerInstance& WithInstanceId(InstanceIdT&& value) {
  ...
  inline void SetInstanceStatus(GameServerInstanceStatus value) {
    m_instanceStatusHasBeenSet = true;
    m_instanceStatus = value;
  }
  inline GameServerInstance& WithInstanceStatus(GameServerInstanceStatus value) {
