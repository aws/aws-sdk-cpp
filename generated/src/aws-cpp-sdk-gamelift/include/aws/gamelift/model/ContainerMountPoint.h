...
class ContainerMountPoint {
 public:
  ...
  void SetInstancePath(InstancePathT&& value) {
    ...
    m_instancePath = std::forward<InstancePathT>(value);
  }
  template <typename InstancePathT = Aws::String>
  ContainerMountPoint& WithInstancePath(InstancePathT&& value) {
    SetInstancePath(std::forward<InstancePathT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAccessLevel(ContainerMountPointAccessLevel value) {
    m_accessLevelHasBeenSet = true;
    m_accessLevel = value;
  }
  inline ContainerMountPoint& WithAccessLevel(ContainerMountPointAccessLevel value) {
