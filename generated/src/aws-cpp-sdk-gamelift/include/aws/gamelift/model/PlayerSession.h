...
class PlayerSession {
 public:
  ...
  void SetTerminationTime(TerminationTimeT&& value) {
    ...
    m_terminationTime = std::forward<TerminationTimeT>(value);
  }
  template <typename TerminationTimeT = Aws::Utils::DateTime>
  PlayerSession& WithTerminationTime(TerminationTimeT&& value) {
    SetTerminationTime(std::forward<TerminationTimeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(PlayerSessionStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline PlayerSession& WithStatus(PlayerSessionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
