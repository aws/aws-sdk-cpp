...
class InstanceAccess {
 public:
  ...
  AWS_GAMELIFT_API InstanceAccess(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_GAMELIFT_API InstanceAccess& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline InstanceAccess& WithOperatingSystem(OperatingSystem value) {
