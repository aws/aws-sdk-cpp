...
class TerminateGameSessionResult {
 public:
  ...
  AWS_GAMELIFT_API TerminateGameSessionResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_GAMELIFT_API TerminateGameSessionResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
