...
class GetPlayerConnectionDetailsResult {
 public:
  ...
  AWS_GAMELIFT_API GetPlayerConnectionDetailsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_GAMELIFT_API GetPlayerConnectionDetailsResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
