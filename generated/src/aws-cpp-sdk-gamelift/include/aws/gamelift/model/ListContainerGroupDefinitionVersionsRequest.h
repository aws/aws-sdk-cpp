...
class ListContainerGroupDefinitionVersionsRequest : public GameLiftRequest {
 public:
  AWS_GAMELIFT_API ListContainerGroupDefinitionVersionsRequest() = default;
  ...
  template <typename NameT = Aws::String>
  ListContainerGroupDefinitionVersionsRequest& WithName(NameT&& value) {
  ...
  inline ListContainerGroupDefinitionVersionsRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListContainerGroupDefinitionVersionsRequest& WithNextToken(NextTokenT&& value) {
