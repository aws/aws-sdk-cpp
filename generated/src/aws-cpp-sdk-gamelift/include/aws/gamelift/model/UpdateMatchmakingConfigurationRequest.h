...
namespace Model
{
  ...
  public:
    ...
    template<typename NameT = Aws::String>
    UpdateMatchmakingConfigurationRequest& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    UpdateMatchmakingConfigurationRequest& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename GameSessionQueueArnsT = Aws::Vector<Aws::String>>
    UpdateMatchmakingConfigurationRequest& WithGameSessionQueueArns(GameSessionQueueArnsT&& value) { SetGameSessionQueueArns(std::forward<GameSessionQueueArnsT>(value)); return *this;}
    template<typename GameSessionQueueArnsT = Aws::String>
    UpdateMatchmakingConfigurationRequest& AddGameSessionQueueArns(GameSessionQueueArnsT&& value) { m_gameSessionQueueArnsHasBeenSet = true; m_gameSessionQueueArns.emplace_back(std::forward<GameSessionQueueArnsT>(value)); return *this; }
    ///@}
    ...
    template<typename RuleSetNameT = Aws::String>
    UpdateMatchmakingConfigurationRequest& WithRuleSetName(RuleSetNameT&& value) { SetRuleSetName(std::forward<RuleSetNameT>(value)); return *this;}
    ///@}
    ...
    template<typename NotificationTargetT = Aws::String>
    UpdateMatchmakingConfigurationRequest& WithNotificationTarget(NotificationTargetT&& value) { SetNotificationTarget(std::forward<NotificationTargetT>(value)); return *this;}
    ///@}
    ...
    template<typename CustomEventDataT = Aws::String>
    UpdateMatchmakingConfigurationRequest& WithCustomEventData(CustomEventDataT&& value) { SetCustomEventData(std::forward<CustomEventDataT>(value)); return *this;}
    ///@}
    ...
    template<typename GamePropertiesT = Aws::Vector<GameProperty>>
    UpdateMatchmakingConfigurationRequest& WithGameProperties(GamePropertiesT&& value) { SetGameProperties(std::forward<GamePropertiesT>(value)); return *this;}
    template<typename GamePropertiesT = GameProperty>
    UpdateMatchmakingConfigurationRequest& AddGameProperties(GamePropertiesT&& value) { m_gamePropertiesHasBeenSet = true; m_gameProperties.emplace_back(std::forward<GamePropertiesT>(value)); return *this; }
    ///@}
    ...
    template<typename GameSessionDataT = Aws::String>
    UpdateMatchmakingConfigurationRequest& WithGameSessionData(GameSessionDataT&& value) { SetGameSessionData(std::forward<GameSessionDataT>(value)); return *this;}
    ///@}
    ...
    inline UpdateMatchmakingConfigurationRequest& WithBackfillMode(BackfillMode value) { SetBackfillMode(value); return *this;}
    ///@}
    ...
    inline UpdateMatchmakingConfigurationRequest& WithFlexMatchMode(FlexMatchMode value) { SetFlexMatchMode(value); return *this;}
    ///@}
  private:
