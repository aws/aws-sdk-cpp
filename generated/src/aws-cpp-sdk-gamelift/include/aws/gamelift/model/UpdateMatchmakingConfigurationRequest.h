...
class UpdateMatchmakingConfigurationRequest : public GameLiftRequest {
 public:
  ...
  inline UpdateMatchmakingConfigurationRequest& WithRequestTimeoutSeconds(int value) {
  ...
  inline UpdateMatchmakingConfigurationRequest& WithAcceptanceTimeoutSeconds(int value) {
  ...
  inline UpdateMatchmakingConfigurationRequest& WithAcceptanceRequired(bool value) {
  ...
  inline UpdateMatchmakingConfigurationRequest& WithAdditionalPlayerCount(int value) {
  ...
  inline UpdateMatchmakingConfigurationRequest& WithBackfillMode(BackfillMode value) {
  ...
  inline UpdateMatchmakingConfigurationRequest& WithFlexMatchMode(FlexMatchMode value) {
