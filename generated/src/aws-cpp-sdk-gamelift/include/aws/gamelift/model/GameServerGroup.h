...
/**
 * <p>Properties that describe a game server group resource. A game server group
 * manages certain properties related to a corresponding Amazon EC2 Auto Scaling
 * group. </p> <p>A game server group is created by a successful call to
...
class GameServerGroup {
 public:
  ...
  AWS_GAMELIFT_API GameServerGroup(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_GAMELIFT_API GameServerGroup& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline GameServerGroup& WithBalancingStrategy(BalancingStrategy value) {
  ...
  inline GameServerGroup& WithGameServerProtectionPolicy(GameServerProtectionPolicy value) {
  ...
  inline void SetStatus(GameServerGroupStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline GameServerGroup& WithStatus(GameServerGroupStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetSuspendedActions(SuspendedActionsT&& value) {
    ...
    m_suspendedActions = std::forward<SuspendedActionsT>(value);
  }
  template <typename SuspendedActionsT = Aws::Vector<GameServerGroupAction>>
  GameServerGroup& WithSuspendedActions(SuspendedActionsT&& value) {
    SetSuspendedActions(std::forward<SuspendedActionsT>(value));
    return *this;
  }
  inline GameServerGroup& AddSuspendedActions(GameServerGroupAction value) {
    m_suspendedActionsHasBeenSet = true;
    m_suspendedActions.push_back(value);
    return *this;
  }
  ///@}
