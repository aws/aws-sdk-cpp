...
namespace Model
{
  ...
  public:
    ...
    template<typename GameServerGroupNameT = Aws::String>
    DeregisterGameServerRequest& WithGameServerGroupName(GameServerGroupNameT&& value) { SetGameServerGroupName(std::forward<GameServerGroupNameT>(value)); return *this;}
    ///@}
    ...
    template<typename GameServerIdT = Aws::String>
    DeregisterGameServerRequest& WithGameServerId(GameServerIdT&& value) { SetGameServerId(std::forward<GameServerIdT>(value)); return *this;}
    ///@}
  private:
