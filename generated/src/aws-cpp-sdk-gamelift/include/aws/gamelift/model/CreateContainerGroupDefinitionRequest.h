...
class CreateContainerGroupDefinitionRequest : public GameLiftRequest {
 public:
  ...
  inline CreateContainerGroupDefinitionRequest& WithContainerGroupType(ContainerGroupType value) {
  ...
  inline CreateContainerGroupDefinitionRequest& WithTotalMemoryLimitMebibytes(int value) {
  ...
  inline CreateContainerGroupDefinitionRequest& WithTotalVcpuLimit(double value) {
   ...
   * end of support on 6/30/2026. See more details in the <a
  ...
  inline CreateContainerGroupDefinitionRequest& WithOperatingSystem(ContainerOperatingSystem value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateContainerGroupDefinitionRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateContainerGroupDefinitionRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
