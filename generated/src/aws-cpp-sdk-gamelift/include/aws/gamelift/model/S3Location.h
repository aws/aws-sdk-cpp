...
class S3Location {
 public:
  ...
  AWS_GAMELIFT_API S3Location(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_GAMELIFT_API S3Location& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
