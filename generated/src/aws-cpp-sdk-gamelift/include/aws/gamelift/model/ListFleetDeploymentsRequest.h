...
class ListFleetDeploymentsRequest : public GameLiftRequest {
 public:
  ...
  template <typename FleetIdT = Aws::String>
  ListFleetDeploymentsRequest& WithFleetId(FleetIdT&& value) {
  ...
  inline ListFleetDeploymentsRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListFleetDeploymentsRequest& WithNextToken(NextTokenT&& value) {
