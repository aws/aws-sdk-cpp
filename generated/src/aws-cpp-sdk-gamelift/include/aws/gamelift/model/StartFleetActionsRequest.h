...
namespace Model
{
  ...
  public:
    ...
    template<typename FleetIdT = Aws::String>
    StartFleetActionsRequest& WithFleetId(FleetIdT&& value) { SetFleetId(std::forward<FleetIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ActionsT = Aws::Vector<FleetAction>>
    StartFleetActionsRequest& WithActions(ActionsT&& value) { SetActions(std::forward<ActionsT>(value)); return *this;}
    inline StartFleetActionsRequest& AddActions(FleetAction value) { m_actionsHasBeenSet = true; m_actions.push_back(value); return *this; }
    ///@}
    ...
    template<typename LocationT = Aws::String>
    StartFleetActionsRequest& WithLocation(LocationT&& value) { SetLocation(std::forward<LocationT>(value)); return *this;}
    ///@}
  private:
