...
class GetGameSessionLogUrlResult {
 public:
  ...
  AWS_GAMELIFT_API GetGameSessionLogUrlResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_GAMELIFT_API GetGameSessionLogUrlResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  template <typename PreSignedUrlT = Aws::String>
  GetGameSessionLogUrlResult& WithPreSignedUrl(PreSignedUrlT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetGameSessionLogUrlResult& WithRequestId(RequestIdT&& value) {
