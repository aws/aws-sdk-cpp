...
class SupportContainerDefinition {
 public:
  ...
  void SetEnvironmentOverride(EnvironmentOverrideT&& value) {
    ...
    m_environmentOverride = std::forward<EnvironmentOverrideT>(value);
  }
  template <typename EnvironmentOverrideT = Aws::Vector<ContainerEnvironment>>
  SupportContainerDefinition& WithEnvironmentOverride(EnvironmentOverrideT&& value) {
    SetEnvironmentOverride(std::forward<EnvironmentOverrideT>(value));
    return *this;
  }
  ...
  SupportContainerDefinition& AddEnvironmentOverride(EnvironmentOverrideT&& value) {
    m_environmentOverrideHasBeenSet = true;
    m_environmentOverride.emplace_back(std::forward<EnvironmentOverrideT>(value));
    return *this;
  }
  ///@}
  ...
  inline SupportContainerDefinition& WithEssential(bool value) {
    SetEssential(value);
    return *this;
  }
  ///@}
  ...
  void SetPortConfiguration(PortConfigurationT&& value) {
    ...
    m_portConfiguration = std::forward<PortConfigurationT>(value);
  }
  template <typename PortConfigurationT = ContainerPortConfiguration>
  SupportContainerDefinition& WithPortConfiguration(PortConfigurationT&& value) {
    SetPortConfiguration(std::forward<PortConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetResolvedImageDigest(ResolvedImageDigestT&& value) {
    ...
    m_resolvedImageDigest = std::forward<ResolvedImageDigestT>(value);
  }
  template <typename ResolvedImageDigestT = Aws::String>
  SupportContainerDefinition& WithResolvedImageDigest(ResolvedImageDigestT&& value) {
    SetResolvedImageDigest(std::forward<ResolvedImageDigestT>(value));
    return *this;
  }
  ///@}
  ...
  inline SupportContainerDefinition& WithVcpu(double value) {
    SetVcpu(value);
    return *this;
  }
  ///@}
