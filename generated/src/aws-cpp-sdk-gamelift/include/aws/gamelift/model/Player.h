...
class Player {
 public:
  ...
  void SetPlayerAttributes(PlayerAttributesT&& value) {
    ...
    m_playerAttributes = std::forward<PlayerAttributesT>(value);
  }
  template <typename PlayerAttributesT = Aws::Map<Aws::String, AttributeValue>>
  Player& WithPlayerAttributes(PlayerAttributesT&& value) {
    SetPlayerAttributes(std::forward<PlayerAttributesT>(value));
    return *this;
  }
  ...
  Player& AddPlayerAttributes(PlayerAttributesKeyT&& key, PlayerAttributesValueT&& value) {
    m_playerAttributesHasBeenSet = true;
    m_playerAttributes.emplace(std::forward<PlayerAttributesKeyT>(key), std::forward<PlayerAttributesValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTeam(TeamT&& value) {
    ...
    m_team = std::forward<TeamT>(value);
  }
  template <typename TeamT = Aws::String>
  Player& WithTeam(TeamT&& value) {
    SetTeam(std::forward<TeamT>(value));
    return *this;
  }
  ///@}
