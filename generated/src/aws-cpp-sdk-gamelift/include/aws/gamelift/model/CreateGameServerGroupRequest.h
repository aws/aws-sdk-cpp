...
class CreateGameServerGroupRequest : public GameLiftRequest {
 public:
  ...
  inline CreateGameServerGroupRequest& WithMinSize(int value) {
    SetMinSize(value);
    return *this;
  }
  ///@}
  ...
  inline CreateGameServerGroupRequest& WithMaxSize(int value) {
    SetMaxSize(value);
    return *this;
  }
  ///@}
  ...
  void SetInstanceDefinitions(InstanceDefinitionsT&& value) {
    ...
    m_instanceDefinitions = std::forward<InstanceDefinitionsT>(value);
  }
  template <typename InstanceDefinitionsT = Aws::Vector<InstanceDefinition>>
  CreateGameServerGroupRequest& WithInstanceDefinitions(InstanceDefinitionsT&& value) {
    SetInstanceDefinitions(std::forward<InstanceDefinitionsT>(value));
    return *this;
  }
  ...
  CreateGameServerGroupRequest& AddInstanceDefinitions(InstanceDefinitionsT&& value) {
    m_instanceDefinitionsHasBeenSet = true;
    m_instanceDefinitions.emplace_back(std::forward<InstanceDefinitionsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetBalancingStrategy(BalancingStrategy value) {
    m_balancingStrategyHasBeenSet = true;
    m_balancingStrategy = value;
  }
  inline CreateGameServerGroupRequest& WithBalancingStrategy(BalancingStrategy value) {
    SetBalancingStrategy(value);
    return *this;
  }
  ///@}
  ...
  inline void SetGameServerProtectionPolicy(GameServerProtectionPolicy value) {
    m_gameServerProtectionPolicyHasBeenSet = true;
    m_gameServerProtectionPolicy = value;
  }
  inline CreateGameServerGroupRequest& WithGameServerProtectionPolicy(GameServerProtectionPolicy value) {
    SetGameServerProtectionPolicy(value);
    return *this;
  }
  ///@}
  ...
  void SetVpcSubnets(VpcSubnetsT&& value) {
    m_vpcSubnetsHasBeenSet = true;
    m_vpcSubnets = std::forward<VpcSubnetsT>(value);
  }
  template <typename VpcSubnetsT = Aws::Vector<Aws::String>>
  CreateGameServerGroupRequest& WithVpcSubnets(VpcSubnetsT&& value) {
    SetVpcSubnets(std::forward<VpcSubnetsT>(value));
    return *this;
  }
  template <typename VpcSubnetsT = Aws::String>
  CreateGameServerGroupRequest& AddVpcSubnets(VpcSubnetsT&& value) {
    m_vpcSubnetsHasBeenSet = true;
    m_vpcSubnets.emplace_back(std::forward<VpcSubnetsT>(value));
    return *this;
  }
  ///@}
