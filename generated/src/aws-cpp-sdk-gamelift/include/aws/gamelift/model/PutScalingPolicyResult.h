...
class PutScalingPolicyResult {
 public:
  ...
  AWS_GAMELIFT_API PutScalingPolicyResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_GAMELIFT_API PutScalingPolicyResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
