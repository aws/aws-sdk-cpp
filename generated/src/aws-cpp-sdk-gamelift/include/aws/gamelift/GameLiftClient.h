...
namespace GameLift
{
   ...
   */
  class AWS_GAMELIFT_API GameLiftClient : Aws::Client::ClientWithAsyncTemplateMethods<GameLiftClient>,
    smithy::client::AwsSmithyClientT<Aws::GameLift::SERVICE_NAME,
