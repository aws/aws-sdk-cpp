...
DeploymentConfiguration& DeploymentConfiguration::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("ProtectionStrategy")) {
    m_protectionStrategy =
        DeploymentProtectionStrategyMapper::GetDeploymentProtectionStrategyForName(jsonValue.GetString("ProtectionStrategy"));
  ...
  if (jsonValue.ValueExists("ImpairmentStrategy")) {
    m_impairmentStrategy =
        DeploymentImpairmentStrategyMapper::GetDeploymentImpairmentStrategyForName(jsonValue.GetString("ImpairmentStrategy"));
...
JsonValue DeploymentConfiguration::Jsonize() const {
  ...
  if (m_protectionStrategyHasBeenSet) {
    payload.WithString("ProtectionStrategy",
                       DeploymentProtectionStrategyMapper::GetNameForDeploymentProtectionStrategy(m_protectionStrategy));
  }
  ...
  if (m_impairmentStrategyHasBeenSet) {
    payload.WithString("ImpairmentStrategy",
                       DeploymentImpairmentStrategyMapper::GetNameForDeploymentImpairmentStrategy(m_impairmentStrategy));
  }
