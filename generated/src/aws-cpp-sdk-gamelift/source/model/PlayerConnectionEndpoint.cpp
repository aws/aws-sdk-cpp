...
PlayerConnectionEndpoint::PlayerConnectionEndpoint(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder) { *this = decoder; }

PlayerConnectionEndpoint& PlayerConnectionEndpoint::operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder) {
  if (decoder != nullptr) {
          ...
          for (size_t i = 0; i < mapSize.value(); ++i) {
            ...
            if (initialKey.has_value()) {
              ...
              if ((decoder->LastError() != AWS_ERROR_UNKNOWN)) {
                AWS_LOG_ERROR("PlayerConnectionEndpoint", "Invalid data received for %s", initialKeyStr.c_str());
                break;
              }
            }
          }
...
void PlayerConnectionEndpoint::CborEncode(Aws::Crt::Cbor::CborEncoder& encoder) const {
  // Calculate map size
  size_t mapSize = 0;
