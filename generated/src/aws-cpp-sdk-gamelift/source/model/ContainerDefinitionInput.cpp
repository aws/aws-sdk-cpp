...
ContainerDefinitionInput::ContainerDefinitionInput() : 
...
ContainerDefinitionInput::ContainerDefinitionInput(JsonView jsonValue) : 
    m_containerNameHasBeenSet(false),
    m_imageUriHasBeenSet(false),
    m_memoryLimitsHasBeenSet(false),
    m_portConfigurationHasBeenSet(false),
...
ContainerDefinitionInput& ContainerDefinitionInput::operator =(JsonView jsonValue)
{
...
JsonValue ContainerDefinitionInput::Jsonize() const
{
  JsonValue payload;
