...
ContainerPortConfiguration::ContainerPortConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
ContainerPortConfiguration& ContainerPortConfiguration::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("ContainerPortRanges")) {
    ...
    for (unsigned containerPortRangesIndex = 0; containerPortRangesIndex < containerPortRangesJsonList.GetLength();
         ++containerPortRangesIndex) {
