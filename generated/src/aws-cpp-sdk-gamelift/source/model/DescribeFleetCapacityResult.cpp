...
DescribeFleetCapacityResult::DescribeFleetCapacityResult()
{
}

DescribeFleetCapacityResult::DescribeFleetCapacityResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
