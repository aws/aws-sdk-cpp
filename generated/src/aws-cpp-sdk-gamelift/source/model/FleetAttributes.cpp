...
FleetAttributes::FleetAttributes(JsonView jsonValue) { *this = jsonValue; }
...
FleetAttributes& FleetAttributes::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("NewGameSessionProtectionPolicy")) {
    m_newGameSessionProtectionPolicy =
        ProtectionPolicyMapper::GetProtectionPolicyForName(jsonValue.GetString("NewGameSessionProtectionPolicy"));
