...
DescribeContainerGroupPortMappingsResult::DescribeContainerGroupPortMappingsResult(
    const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result) {
  *this = result;
}

DescribeContainerGroupPortMappingsResult& DescribeContainerGroupPortMappingsResult::operator=(
    const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result) {
        ...
        if (mapSize.has_value()) {
          for (size_t i = 0; i < mapSize.value(); ++i) {
            ...
            if (initialKey.has_value()) {
              ...
              else if (initialKeyStr == "ContainerGroupDefinitionArn") {
                auto peekType = decoder->PeekType();
                if (peekType.has_value()) {
                  if (peekType.value() == Aws::Crt::Cbor::CborType::Text) {
                    auto val = decoder->PopNextTextVal();
              ...
              else if (initialKeyStr == "ContainerGroupPortMappings") {
                  ...
                  if (peekType_0.value() == CborType::ArrayStart) {
                    ...
                    if (listSize_0.has_value()) {
                      for (size_t j_0 = 0; j_0 < listSize_0.value(); j_0++) {
                        m_containerGroupPortMappings.push_back(ContainerGroupPortMapping(decoder));
                      }
                    }
              ...
              if ((decoder->LastError() != AWS_ERROR_UNKNOWN)) {
                AWS_LOG_ERROR("DescribeContainerGroupPortMappingsResult", "Invalid data received for %s", initialKeyStr.c_str());
                break;
              }
            }
          }
