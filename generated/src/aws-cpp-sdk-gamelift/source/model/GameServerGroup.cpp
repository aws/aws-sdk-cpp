...
GameServerGroup::GameServerGroup(JsonView jsonValue) { *this = jsonValue; }
...
GameServerGroup& GameServerGroup::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("GameServerProtectionPolicy")) {
    m_gameServerProtectionPolicy =
        GameServerProtectionPolicyMapper::GetGameServerProtectionPolicyForName(jsonValue.GetString("GameServerProtectionPolicy"));
  ...
  if (jsonValue.ValueExists("SuspendedActions")) {
    ...
    for (unsigned suspendedActionsIndex = 0; suspendedActionsIndex < suspendedActionsJsonList.GetLength(); ++suspendedActionsIndex) {
      m_suspendedActions.push_back(
          GameServerGroupActionMapper::GetGameServerGroupActionForName(suspendedActionsJsonList[suspendedActionsIndex].AsString()));
    }
...
JsonValue GameServerGroup::Jsonize() const {
  ...
  if (m_suspendedActionsHasBeenSet) {
    ...
    for (unsigned suspendedActionsIndex = 0; suspendedActionsIndex < suspendedActionsJsonList.GetLength(); ++suspendedActionsIndex) {
      suspendedActionsJsonList[suspendedActionsIndex].AsString(
          GameServerGroupActionMapper::GetNameForGameServerGroupAction(m_suspendedActions[suspendedActionsIndex]));
    }
