...
ListContainerGroupDefinitionVersionsResult& ListContainerGroupDefinitionVersionsResult::operator=(
  ...
  if (jsonValue.ValueExists("ContainerGroupDefinitions")) {
    ...
    for (unsigned containerGroupDefinitionsIndex = 0; containerGroupDefinitionsIndex < containerGroupDefinitionsJsonList.GetLength();
         ++containerGroupDefinitionsIndex) {
