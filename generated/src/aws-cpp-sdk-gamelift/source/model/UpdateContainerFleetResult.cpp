...
UpdateContainerFleetResult::UpdateContainerFleetResult()
{
}

UpdateContainerFleetResult::UpdateContainerFleetResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
