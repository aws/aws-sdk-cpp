...
DescribeFleetLocationCapacityResult& DescribeFleetLocationCapacityResult::operator=(
    const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result) {
          ...
          for (size_t i = 0; i < mapSize.value(); ++i) {
            ...
            if (initialKey.has_value()) {
              ...
              if (initialKeyStr == "FleetCapacity") {
                m_fleetCapacity = FleetCapacity(decoder);
              ...
              if ((decoder->LastError() != AWS_ERROR_UNKNOWN)) {
                AWS_LOG_ERROR("DescribeFleetLocationCapacityResult", "Invalid data received for %s", initialKeyStr.c_str());
                break;
              }
            }
          }
