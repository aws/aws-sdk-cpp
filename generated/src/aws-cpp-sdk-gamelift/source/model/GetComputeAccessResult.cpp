...
GetComputeAccessResult::GetComputeAccessResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
GetComputeAccessResult& GetComputeAccessResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("ContainerIdentifiers")) {
    ...
    for (unsigned containerIdentifiersIndex = 0; containerIdentifiersIndex < containerIdentifiersJsonList.GetLength();
         ++containerIdentifiersIndex) {
