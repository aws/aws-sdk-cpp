...
Aws::String CreateContainerFleetRequest::SerializePayload() const {
  ...
  if (m_instanceInboundPermissionsHasBeenSet) {
    ...
    for (unsigned instanceInboundPermissionsIndex = 0; instanceInboundPermissionsIndex < instanceInboundPermissionsJsonList.GetLength();
         ++instanceInboundPermissionsIndex) {
      instanceInboundPermissionsJsonList[instanceInboundPermissionsIndex].AsObject(
          m_instanceInboundPermissions[instanceInboundPermissionsIndex].Jsonize());
    }
