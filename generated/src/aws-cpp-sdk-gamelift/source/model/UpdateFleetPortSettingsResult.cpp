...
UpdateFleetPortSettingsResult::UpdateFleetPortSettingsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result) {
  *this = result;
}

UpdateFleetPortSettingsResult& UpdateFleetPortSettingsResult::operator=(
          ...
          for (size_t i = 0; i < mapSize.value(); ++i) {
            ...
            if (initialKey.has_value()) {
              ...
              if ((decoder->LastError() != AWS_ERROR_UNKNOWN)) {
                AWS_LOG_ERROR("UpdateFleetPortSettingsResult", "Invalid data received for %s", initialKeyStr.c_str());
                break;
              }
            }
          }
