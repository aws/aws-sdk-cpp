...
UpdateFleetAttributesResult::UpdateFleetAttributesResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result) {
  *this = result;
}

UpdateFleetAttributesResult& UpdateFleetAttributesResult::operator=(
          ...
          for (size_t i = 0; i < mapSize.value(); ++i) {
            ...
            if (initialKey.has_value()) {
              ...
              if ((decoder->LastError() != AWS_ERROR_UNKNOWN)) {
                AWS_LOG_ERROR("UpdateFleetAttributesResult", "Invalid data received for %s", initialKeyStr.c_str());
                break;
              }
            }
          }
