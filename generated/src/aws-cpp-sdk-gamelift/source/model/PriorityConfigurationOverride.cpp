...
PriorityConfigurationOverride::PriorityConfigurationOverride(JsonView jsonValue) { *this = jsonValue; }
...
PriorityConfigurationOverride& PriorityConfigurationOverride::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("PlacementFallbackStrategy")) {
    m_placementFallbackStrategy =
        PlacementFallbackStrategyMapper::GetPlacementFallbackStrategyForName(jsonValue.GetString("PlacementFallbackStrategy"));
...
JsonValue PriorityConfigurationOverride::Jsonize() const {
  ...
  if (m_placementFallbackStrategyHasBeenSet) {
    payload.WithString("PlacementFallbackStrategy",
                       PlacementFallbackStrategyMapper::GetNameForPlacementFallbackStrategy(m_placementFallbackStrategy));
  }
