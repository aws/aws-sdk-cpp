...
MatchmakingConfiguration::MatchmakingConfiguration(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder) { *this = decoder; }

MatchmakingConfiguration& MatchmakingConfiguration::operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder) {
  if (decoder != nullptr) {
        ...
        if (mapSize.has_value()) {
          for (size_t i = 0; i < mapSize.value(); ++i) {
            ...
            if (initialKey.has_value()) {
              ...
              else if (initialKeyStr == "GameSessionQueueArns") {
                      ...
                      for (size_t j_0 = 0; j_0 < listSize_0.value(); j_0++) {
                        ...
                        if (peekType_1.has_value()) {
                          if (peekType_1.value() == Aws::Crt::Cbor::CborType::Text) {
                            auto val = decoder->PopNextTextVal();
                            if (val.has_value()) {
                              m_gameSessionQueueArns.push_back(
                            ...
                            m_gameSessionQueueArns.push_back(ss_1.str());
                            ss_1.clear();
                          }
                        }
                      }
                    ...
                    while (decoder->LastError() == AWS_ERROR_UNKNOWN) {
                      ...
                      if (peekType_1.has_value()) {
                        if (peekType_1.value() == Aws::Crt::Cbor::CborType::Text) {
                          auto val = decoder->PopNextTextVal();
                          if (val.has_value()) {
                            m_gameSessionQueueArns.push_back(Aws::String(reinterpret_cast<const char*>(val.value().ptr), val.value().len));
                          }
                        } else {
                          decoder->ConsumeNextSingleElement();
                          Aws::StringStream ss_1;
              ...
              else if (initialKeyStr == "RequestTimeoutSeconds") {
                auto peekType = decoder->PeekType();
                if (peekType.has_value()) {
                  if (peekType.value() == Aws::Crt::Cbor::CborType::UInt) {
                    auto val = decoder->PopNextUnsignedIntVal();
                    if (val.has_value()) {
                      m_requestTimeoutSeconds = static_cast<int64_t>(val.value());
                    }
                  } else {
                    auto val = decoder->PopNextNegativeIntVal();
                    if (val.has_value()) {
                      m_requestTimeoutSeconds = static_cast<int64_t>(1 - val.value());
                    }
                  }
                }
              ...
              else if (initialKeyStr == "AcceptanceTimeoutSeconds") {
                auto peekType = decoder->PeekType();
                if (peekType.has_value()) {
                  if (peekType.value() == Aws::Crt::Cbor::CborType::UInt) {
                    auto val = decoder->PopNextUnsignedIntVal();
                    if (val.has_value()) {
                      m_acceptanceTimeoutSeconds = static_cast<int64_t>(val.value());
                    }
                  } else {
                    auto val = decoder->PopNextNegativeIntVal();
                    if (val.has_value()) {
                      m_acceptanceTimeoutSeconds = static_cast<int64_t>(1 - val.value());
                    }
                  }
                }
              ...
              else if (initialKeyStr == "AcceptanceRequired") {
                auto val = decoder->PopNextBooleanVal();
                if (val.has_value()) {
                  m_acceptanceRequired = val.value();
                }
                m_acceptanceRequiredHasBeenSet = true;
              }

              else if (initialKeyStr == "RuleSetName") {
                auto peekType = decoder->PeekType();
                if (peekType.has_value()) {
                  if (peekType.value() == Aws::Crt::Cbor::CborType::Text) {
                    auto val = decoder->PopNextTextVal();
                    if (val.has_value()) {
                      m_ruleSetName = Aws::String(reinterpret_cast<const char*>(val.value().ptr), val.value().len);
                    }
                  } else {
                    decoder->ConsumeNextSingleElement();
                    Aws::StringStream ss;
                    ...
                    m_ruleSetName = ss.str();
                  }
                }
                m_ruleSetNameHasBeenSet = true;
              }

              else if (initialKeyStr == "RuleSetArn") {
                auto peekType = decoder->PeekType();
                if (peekType.has_value()) {
                  if (peekType.value() == Aws::Crt::Cbor::CborType::Text) {
                    auto val = decoder->PopNextTextVal();
                    if (val.has_value()) {
                      m_ruleSetArn = Aws::String(reinterpret_cast<const char*>(val.value().ptr), val.value().len);
                    }
                  } else {
                    decoder->ConsumeNextSingleElement();
                    Aws::StringStream ss;
              ...
              else if (initialKeyStr == "NotificationTarget") {
                auto peekType = decoder->PeekType();
                if (peekType.has_value()) {
                  if (peekType.value() == Aws::Crt::Cbor::CborType::Text) {
                    auto val = decoder->PopNextTextVal();
                    if (val.has_value()) {
                      m_notificationTarget = Aws::String(reinterpret_cast<const char*>(val.value().ptr), val.value().len);
                    }
                  } else {
                    decoder->ConsumeNextSingleElement();
                    Aws::StringStream ss;
                    ...
                    m_notificationTarget = ss.str();
                  }
                }
                m_notificationTargetHasBeenSet = true;
              }

              else if (initialKeyStr == "AdditionalPlayerCount") {
                auto peekType = decoder->PeekType();
                if (peekType.has_value()) {
                  if (peekType.value() == Aws::Crt::Cbor::CborType::UInt) {
                    auto val = decoder->PopNextUnsignedIntVal();
                    if (val.has_value()) {
                      m_additionalPlayerCount = static_cast<int64_t>(val.value());
                    }
                  } else {
                    auto val = decoder->PopNextNegativeIntVal();
                    if (val.has_value()) {
                      m_additionalPlayerCount = static_cast<int64_t>(1 - val.value());
                    }
                  }
                }
              ...
              else if (initialKeyStr == "CustomEventData") {
                auto peekType = decoder->PeekType();
                if (peekType.has_value()) {
                  if (peekType.value() == Aws::Crt::Cbor::CborType::Text) {
                    auto val = decoder->PopNextTextVal();
                    if (val.has_value()) {
                      m_customEventData = Aws::String(reinterpret_cast<const char*>(val.value().ptr), val.value().len);
                    }
                  } else {
                    decoder->ConsumeNextSingleElement();
                    Aws::StringStream ss;
              ...
              else if (initialKeyStr == "BackfillMode") {
                auto val = decoder->PopNextTextVal();
                if (val.has_value()) {
                  m_backfillMode = BackfillModeMapper::GetBackfillModeForName(
                      Aws::String(reinterpret_cast<const char*>(val.value().ptr), val.value().len));
                }
                m_backfillModeHasBeenSet = true;
              }

              else if (initialKeyStr == "FlexMatchMode") {
                auto val = decoder->PopNextTextVal();
                if (val.has_value()) {
                  m_flexMatchMode = FlexMatchModeMapper::GetFlexMatchModeForName(
                      Aws::String(reinterpret_cast<const char*>(val.value().ptr), val.value().len));
                }
              ...
              if ((decoder->LastError() != AWS_ERROR_UNKNOWN)) {
                AWS_LOG_ERROR("MatchmakingConfiguration", "Invalid data received for %s", initialKeyStr.c_str());
                break;
              }
            }
          }
...
void MatchmakingConfiguration::CborEncode(Aws::Crt::Cbor::CborEncoder& encoder) const {
  // Calculate map size
  size_t mapSize = 0;
  if (m_nameHasBeenSet) {
    mapSize++;
  ...
  if (m_ruleSetArnHasBeenSet) {
    encoder.WriteText(Aws::Crt::ByteCursorFromCString("RuleSetArn"));
    encoder.WriteText(Aws::Crt::ByteCursorFromCString(m_ruleSetArn.c_str()));
  }
