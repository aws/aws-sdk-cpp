...
UpdateRuntimeConfigurationResult::UpdateRuntimeConfigurationResult()
{
}

UpdateRuntimeConfigurationResult::UpdateRuntimeConfigurationResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
