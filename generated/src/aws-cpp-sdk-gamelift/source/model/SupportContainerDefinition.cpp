...
SupportContainerDefinition::SupportContainerDefinition(JsonView jsonValue) { *this = jsonValue; }

SupportContainerDefinition& SupportContainerDefinition::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("EnvironmentOverride")) {
    ...
    for (unsigned environmentOverrideIndex = 0; environmentOverrideIndex < environmentOverrideJsonList.GetLength();
         ++environmentOverrideIndex) {
...
JsonValue SupportContainerDefinition::Jsonize() const {
  JsonValue payload;
