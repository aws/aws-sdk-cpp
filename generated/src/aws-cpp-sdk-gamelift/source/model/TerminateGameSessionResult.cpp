...
TerminateGameSessionResult::TerminateGameSessionResult()
{
}

TerminateGameSessionResult::TerminateGameSessionResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
