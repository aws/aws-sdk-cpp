  ...
  namespace GameLift
  {
    namespace Model
    {
      namespace EC2InstanceTypeMapper
      {
        ...
        */
        static bool GetEnumForNameHelper0(uint32_t hashCode, EC2InstanceType& enumValue)
        {
        ...
        static bool GetEnumForNameHelper1(uint32_t hashCode, EC2InstanceType& enumValue)
        {
