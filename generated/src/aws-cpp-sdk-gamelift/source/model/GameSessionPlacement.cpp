...
GameSessionPlacement::GameSessionPlacement(JsonView jsonValue) { *this = jsonValue; }
...
GameSessionPlacement& GameSessionPlacement::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("PlacedPlayerSessions")) {
    ...
    for (unsigned placedPlayerSessionsIndex = 0; placedPlayerSessionsIndex < placedPlayerSessionsJsonList.GetLength();
         ++placedPlayerSessionsIndex) {
