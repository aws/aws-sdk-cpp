...
GameSessionPlacement::GameSessionPlacement(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder) { *this = decoder; }

GameSessionPlacement& GameSessionPlacement::operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder) {
  if (decoder != nullptr) {
        ...
        if (mapSize.has_value()) {
          for (size_t i = 0; i < mapSize.value(); ++i) {
            ...
            if (initialKey.has_value()) {
              ...
              if (initialKeyStr == "PlacementId") {
                auto peekType = decoder->PeekType();
                if (peekType.has_value()) {
                  if (peekType.value() == Aws::Crt::Cbor::CborType::Text) {
                    auto val = decoder->PopNextTextVal();
                    if (val.has_value()) {
                      m_placementId = Aws::String(reinterpret_cast<const char*>(val.value().ptr), val.value().len);
                    }
                  } else {
                    ...
                    m_placementId = ss.str();
                  }
                }
                m_placementIdHasBeenSet = true;
              }

              else if (initialKeyStr == "GameSessionQueueName") {
                auto peekType = decoder->PeekType();
                if (peekType.has_value()) {
                  if (peekType.value() == Aws::Crt::Cbor::CborType::Text) {
                    auto val = decoder->PopNextTextVal();
                    if (val.has_value()) {
                      m_gameSessionQueueName = Aws::String(reinterpret_cast<const char*>(val.value().ptr), val.value().len);
                    }
                  } else {
                    decoder->ConsumeNextSingleElement();
                    Aws::StringStream ss;
                ...
                auto val = decoder->PopNextTextVal();
                if (val.has_value()) {
                  m_status = GameSessionPlacementStateMapper::GetGameSessionPlacementStateForName(
              ...
              else if (initialKeyStr == "GameSessionName") {
                auto peekType = decoder->PeekType();
                if (peekType.has_value()) {
                  if (peekType.value() == Aws::Crt::Cbor::CborType::Text) {
                    auto val = decoder->PopNextTextVal();
                    if (val.has_value()) {
                      m_gameSessionName = Aws::String(reinterpret_cast<const char*>(val.value().ptr), val.value().len);
                    }
                  } else {
                    decoder->ConsumeNextSingleElement();
                    Aws::StringStream ss;
              ...
              else if (initialKeyStr == "GameSessionArn") {
                auto peekType = decoder->PeekType();
                if (peekType.has_value()) {
                  if (peekType.value() == Aws::Crt::Cbor::CborType::Text) {
                    auto val = decoder->PopNextTextVal();
              ...
              else if (initialKeyStr == "GameSessionRegion") {
                auto peekType = decoder->PeekType();
                if (peekType.has_value()) {
                  if (peekType.value() == Aws::Crt::Cbor::CborType::Text) {
                    auto val = decoder->PopNextTextVal();
                    if (val.has_value()) {
                      m_gameSessionRegion = Aws::String(reinterpret_cast<const char*>(val.value().ptr), val.value().len);
                    }
                  } else {
                    decoder->ConsumeNextSingleElement();
                    Aws::StringStream ss;
                    ...
                    m_gameSessionRegion = ss.str();
                  }
                }
                m_gameSessionRegionHasBeenSet = true;
              }

              else if (initialKeyStr == "PlayerLatencies") {
                auto peekType_0 = decoder->PeekType();
                if (peekType_0.has_value() &&
                    (peekType_0.value() == CborType::ArrayStart || peekType_0.value() == CborType::IndefArrayStart)) {
                  if (peekType_0.value() == CborType::ArrayStart) {
                    ...
                    if (listSize_0.has_value()) {
                      for (size_t j_0 = 0; j_0 < listSize_0.value(); j_0++) {
                        m_playerLatencies.push_back(PlayerLatency(decoder));
                      }
                    }
                  } else  // IndefArrayStart
                  {
              ...
              else if (initialKeyStr == "PlacedPlayerSessions") {
                auto peekType_0 = decoder->PeekType();
                if (peekType_0.has_value() &&
                    (peekType_0.value() == CborType::ArrayStart || peekType_0.value() == CborType::IndefArrayStart)) {
                  if (peekType_0.value() == CborType::ArrayStart) {
                    ...
                    if (listSize_0.has_value()) {
                      for (size_t j_0 = 0; j_0 < listSize_0.value(); j_0++) {
                        m_placedPlayerSessions.push_back(PlacedPlayerSession(decoder));
                      }
                    }
                  } else  // IndefArrayStart
                  {
              ...
              else if (initialKeyStr == "PriorityConfigurationOverride") {
                m_priorityConfigurationOverride = PriorityConfigurationOverride(decoder);
              ...
              if ((decoder->LastError() != AWS_ERROR_UNKNOWN)) {
                AWS_LOG_ERROR("GameSessionPlacement", "Invalid data received for %s", initialKeyStr.c_str());
                break;
              }
            }
          }
...
void GameSessionPlacement::CborEncode(Aws::Crt::Cbor::CborEncoder& encoder) const {
  // Calculate map size
  size_t mapSize = 0;
  ...
  if (m_statusHasBeenSet) {
    ...
    encoder.WriteText(
        Aws::Crt::ByteCursorFromCString(GameSessionPlacementStateMapper::GetNameForGameSessionPlacementState(m_status).c_str()));
  }
  ...
  if (m_gameSessionRegionHasBeenSet) {
    encoder.WriteText(Aws::Crt::ByteCursorFromCString("GameSessionRegion"));
    encoder.WriteText(Aws::Crt::ByteCursorFromCString(m_gameSessionRegion.c_str()));
  }
  ...
  if (m_placedPlayerSessionsHasBeenSet) {
    encoder.WriteText(Aws::Crt::ByteCursorFromCString("PlacedPlayerSessions"));
    encoder.WriteArrayStart(m_placedPlayerSessions.size());
    for (const auto& item_0 : m_placedPlayerSessions) {
      item_0.CborEncode(encoder);
    }
  }
