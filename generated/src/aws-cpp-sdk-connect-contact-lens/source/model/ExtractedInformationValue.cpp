...
ExtractedInformationValue::ExtractedInformationValue(JsonView jsonValue) { *this = jsonValue; }

ExtractedInformationValue& ExtractedInformationValue::operator=(JsonView jsonValue) {
...
JsonValue ExtractedInformationValue::Jsonize() const {
  JsonValue payload;
