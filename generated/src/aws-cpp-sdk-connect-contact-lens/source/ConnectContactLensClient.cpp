...
ConnectContactLensClient::ConnectContactLensClient(const Aws::Client::ClientConfiguration& clientConfiguration)
    : BASECLASS(clientConfiguration,
                Aws::MakeShared<AWSAuthV4Signer>(
                    ALLOCATION_TAG,
                    Aws::MakeShared<DefaultAWSCredentialsProviderChain>(ALLOCATION_TAG, clientConfiguration.credentialProviderConfig),
...
ConnectContactLensClient::~ConnectContactLensClient() { ShutdownSdkClient(this, -1); }

std::shared_ptr<ConnectContactLensEndpointProviderBase>& ConnectContactLensClient::accessEndpointProvider() { return m_endpointProvider; }
...
ConnectContactLensClient::InvokeOperationOutcome ConnectContactLensClient::InvokeServiceOperation(
  ...
  return TracingUtils::MakeCallWithTiming<InvokeOperationOutcome>(
      [&]() -> InvokeOperationOutcome {
        ...
        AWS_OPERATION_CHECK_SUCCESS(endpointResolutionOutcome, ListRealtimeContactAnalysisSegments, CoreErrors,
        ...
        return result.IsSuccess()
                   ? ListRealtimeContactAnalysisSegmentsOutcome(ListRealtimeContactAnalysisSegmentsResult(result.GetResultWithOwnership()))
                   : ListRealtimeContactAnalysisSegmentsOutcome(result.GetError());
      },
      TracingUtils::SMITHY_CLIENT_DURATION_METRIC, *meter,
      {{TracingUtils::SMITHY_METHOD_DIMENSION, operationName}, {TracingUtils::SMITHY_SERVICE_DIMENSION, serviceName}});
}

ListRealtimeContactAnalysisSegmentsOutcome ConnectContactLensClient::ListRealtimeContactAnalysisSegments(
    const ListRealtimeContactAnalysisSegmentsRequest& request) const {
