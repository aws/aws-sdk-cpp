...
namespace ConnectContactLens
{
   ...
   * Guide</i>. </p>
   */
  class AWS_CONNECTCONTACTLENS_API ConnectContactLensClient : Aws::Client::ClientWithAsyncTemplateMethods<ConnectContactLensClient>,
    smithy::client::AwsSmithyClientT<Aws::ConnectContactLens::SERVICE_NAME,
