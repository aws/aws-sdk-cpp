...
class Categories {
 public:
  ...
  void SetMatchedCategories(MatchedCategoriesT&& value) {
    ...
    m_matchedCategories = std::forward<MatchedCategoriesT>(value);
  }
  template <typename MatchedCategoriesT = Aws::Vector<Aws::String>>
  Categories& WithMatchedCategories(MatchedCategoriesT&& value) {
    SetMatchedCategories(std::forward<MatchedCategoriesT>(value));
    return *this;
  }
  template <typename MatchedCategoriesT = Aws::String>
  Categories& AddMatchedCategories(MatchedCategoriesT&& value) {
    m_matchedCategoriesHasBeenSet = true;
    m_matchedCategories.emplace_back(std::forward<MatchedCategoriesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMatchedDetails(MatchedDetailsT&& value) {
    ...
    m_matchedDetails = std::forward<MatchedDetailsT>(value);
  }
  template <typename MatchedDetailsT = Aws::Map<Aws::String, CategoryDetails>>
  Categories& WithMatchedDetails(MatchedDetailsT&& value) {
    SetMatchedDetails(std::forward<MatchedDetailsT>(value));
    return *this;
  }
  ...
  Categories& AddMatchedDetails(MatchedDetailsKeyT&& key, MatchedDetailsValueT&& value) {
    m_matchedDetailsHasBeenSet = true;
    m_matchedDetails.emplace(std::forward<MatchedDetailsKeyT>(key), std::forward<MatchedDetailsValueT>(value));
    return *this;
  }
  ///@}
 private:
