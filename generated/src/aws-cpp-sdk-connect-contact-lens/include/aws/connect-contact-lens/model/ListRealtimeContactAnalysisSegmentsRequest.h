...
namespace Model
{
  ...
  public:
    ...
    template<typename InstanceIdT = Aws::String>
    ListRealtimeContactAnalysisSegmentsRequest& WithInstanceId(InstanceIdT&& value) { SetInstanceId(std::forward<InstanceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ContactIdT = Aws::String>
    ListRealtimeContactAnalysisSegmentsRequest& WithContactId(ContactIdT&& value) { SetContactId(std::forward<ContactIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListRealtimeContactAnalysisSegmentsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
