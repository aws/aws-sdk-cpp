...
class ListRealtimeContactAnalysisSegmentsRequest : public ConnectContactLensRequest {
 public:
  AWS_CONNECTCONTACTLENS_API ListRealtimeContactAnalysisSegmentsRequest() = default;
  ...
  template <typename InstanceIdT = Aws::String>
  ListRealtimeContactAnalysisSegmentsRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename ContactIdT = Aws::String>
  ListRealtimeContactAnalysisSegmentsRequest& WithContactId(ContactIdT&& value) {
  ...
  inline ListRealtimeContactAnalysisSegmentsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListRealtimeContactAnalysisSegmentsRequest& WithNextToken(NextTokenT&& value) {
