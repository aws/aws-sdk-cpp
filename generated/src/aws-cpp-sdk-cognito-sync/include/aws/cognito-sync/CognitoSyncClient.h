...
namespace CognitoSync
{
   ...
   * Guide for iOS</a>.</p>
   */
  class AWS_COGNITOSYNC_API CognitoSyncClient : Aws::Client::ClientWithAsyncTemplateMethods<CognitoSyncClient>,
    smithy::client::AwsSmithyClientT<Aws::CognitoSync::SERVICE_NAME,
