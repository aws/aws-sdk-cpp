...
class AWS_COGNITOSYNC_API CognitoSyncClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  CognitoSyncClient(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<CognitoSyncEndpointProviderBase> endpointProvider = nullptr,
      const Aws::CognitoSync::CognitoSyncClientConfiguration& clientConfiguration = Aws::CognitoSync::CognitoSyncClientConfiguration());
  ...
  /**
   * An Async wrapper for BulkPublish that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename BulkPublishRequestT = Model::BulkPublishRequest>
  void BulkPublishAsync(const BulkPublishRequestT& request, const BulkPublishResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for DescribeIdentityPoolUsage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeIdentityPoolUsageRequestT = Model::DescribeIdentityPoolUsageRequest>
  Model::DescribeIdentityPoolUsageOutcomeCallable DescribeIdentityPoolUsageCallable(
      const DescribeIdentityPoolUsageRequestT& request) const {
    return SubmitCallable(&CognitoSyncClient::DescribeIdentityPoolUsage, request);
  }

  /**
   * An Async wrapper for DescribeIdentityPoolUsage that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeIdentityPoolUsageRequestT = Model::DescribeIdentityPoolUsageRequest>
  void DescribeIdentityPoolUsageAsync(const DescribeIdentityPoolUsageRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeIdentityUsage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeIdentityUsage that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeIdentityUsageRequestT = Model::DescribeIdentityUsageRequest>
  void DescribeIdentityUsageAsync(const DescribeIdentityUsageRequestT& request, const DescribeIdentityUsageResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetBulkPublishDetails that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetBulkPublishDetails that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetBulkPublishDetailsRequestT = Model::GetBulkPublishDetailsRequest>
  void GetBulkPublishDetailsAsync(const GetBulkPublishDetailsRequestT& request, const GetBulkPublishDetailsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetCognitoEvents that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetCognitoEvents that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetCognitoEventsRequestT = Model::GetCognitoEventsRequest>
  void GetCognitoEventsAsync(const GetCognitoEventsRequestT& request, const GetCognitoEventsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetIdentityPoolConfigurationOutcome GetIdentityPoolConfiguration(
      const Model::GetIdentityPoolConfigurationRequest& request) const;

  /**
   * A Callable wrapper for GetIdentityPoolConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetIdentityPoolConfigurationRequestT = Model::GetIdentityPoolConfigurationRequest>
  Model::GetIdentityPoolConfigurationOutcomeCallable GetIdentityPoolConfigurationCallable(
      const GetIdentityPoolConfigurationRequestT& request) const {
    return SubmitCallable(&CognitoSyncClient::GetIdentityPoolConfiguration, request);
  }

  /**
   * An Async wrapper for GetIdentityPoolConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetIdentityPoolConfigurationRequestT = Model::GetIdentityPoolConfigurationRequest>
  void GetIdentityPoolConfigurationAsync(const GetIdentityPoolConfigurationRequestT& request,
  ...
  /**
   * A Callable wrapper for ListIdentityPoolUsage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListIdentityPoolUsage that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListIdentityPoolUsageRequestT = Model::ListIdentityPoolUsageRequest>
  void ListIdentityPoolUsageAsync(const ListIdentityPoolUsageResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const ListIdentityPoolUsageRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for RegisterDevice that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename RegisterDeviceRequestT = Model::RegisterDeviceRequest>
  void RegisterDeviceAsync(const RegisterDeviceRequestT& request, const RegisterDeviceResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SetCognitoEvents that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SetCognitoEvents that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename SetCognitoEventsRequestT = Model::SetCognitoEventsRequest>
  void SetCognitoEventsAsync(const SetCognitoEventsRequestT& request, const SetCognitoEventsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::SetIdentityPoolConfigurationOutcome SetIdentityPoolConfiguration(
      const Model::SetIdentityPoolConfigurationRequest& request) const;

  /**
   * A Callable wrapper for SetIdentityPoolConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename SetIdentityPoolConfigurationRequestT = Model::SetIdentityPoolConfigurationRequest>
  Model::SetIdentityPoolConfigurationOutcomeCallable SetIdentityPoolConfigurationCallable(
      const SetIdentityPoolConfigurationRequestT& request) const {
    return SubmitCallable(&CognitoSyncClient::SetIdentityPoolConfiguration, request);
  }

  /**
   * An Async wrapper for SetIdentityPoolConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SetIdentityPoolConfigurationRequestT = Model::SetIdentityPoolConfigurationRequest>
  void SetIdentityPoolConfigurationAsync(const SetIdentityPoolConfigurationRequestT& request,
  ...
  /**
   * A Callable wrapper for SubscribeToDataset that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SubscribeToDataset that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename SubscribeToDatasetRequestT = Model::SubscribeToDatasetRequest>
  void SubscribeToDatasetAsync(const SubscribeToDatasetRequestT& request, const SubscribeToDatasetResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UnsubscribeFromDataset that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UnsubscribeFromDataset that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UnsubscribeFromDatasetRequestT = Model::UnsubscribeFromDatasetRequest>
  void UnsubscribeFromDatasetAsync(const UnsubscribeFromDatasetRequestT& request,
  ...
  /**
   * An Async wrapper for UpdateRecords that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateRecordsRequestT = Model::UpdateRecordsRequest>
  void UpdateRecordsAsync(const UpdateRecordsRequestT& request, const UpdateRecordsResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
