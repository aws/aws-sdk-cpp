...
class GetBulkPublishDetailsResult {
 public:
  ...
  void SetBulkPublishStartTime(BulkPublishStartTimeT&& value) {
    m_bulkPublishStartTimeHasBeenSet = true;
    m_bulkPublishStartTime = std::forward<BulkPublishStartTimeT>(value);
  }
  template <typename BulkPublishStartTimeT = Aws::Utils::DateTime>
  GetBulkPublishDetailsResult& WithBulkPublishStartTime(BulkPublishStartTimeT&& value) {
    SetBulkPublishStartTime(std::forward<BulkPublishStartTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBulkPublishCompleteTime(BulkPublishCompleteTimeT&& value) {
    ...
    m_bulkPublishCompleteTime = std::forward<BulkPublishCompleteTimeT>(value);
  }
  template <typename BulkPublishCompleteTimeT = Aws::Utils::DateTime>
  GetBulkPublishDetailsResult& WithBulkPublishCompleteTime(BulkPublishCompleteTimeT&& value) {
    SetBulkPublishCompleteTime(std::forward<BulkPublishCompleteTimeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetBulkPublishStatus(BulkPublishStatus value) {
    m_bulkPublishStatusHasBeenSet = true;
    m_bulkPublishStatus = value;
  }
  inline GetBulkPublishDetailsResult& WithBulkPublishStatus(BulkPublishStatus value) {
    SetBulkPublishStatus(value);
    return *this;
  }
  ///@}
