...
class DescribeIdentityUsageResult {
 public:
  ...
  void SetIdentityUsage(IdentityUsageT&& value) {
    m_identityUsageHasBeenSet = true;
    m_identityUsage = std::forward<IdentityUsageT>(value);
  }
  template <typename IdentityUsageT = IdentityUsage>
  DescribeIdentityUsageResult& WithIdentityUsage(IdentityUsageT&& value) {
    SetIdentityUsage(std::forward<IdentityUsageT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeIdentityUsageResult& WithRequestId(RequestIdT&& value) {
