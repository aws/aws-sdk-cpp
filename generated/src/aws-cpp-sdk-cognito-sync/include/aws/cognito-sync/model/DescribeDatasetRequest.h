 ...
 * API Reference</a></p>
 */
class DescribeDatasetRequest : public CognitoSyncRequest {
 public:
  AWS_COGNITOSYNC_API DescribeDatasetRequest() = default;
  ...
  template <typename IdentityPoolIdT = Aws::String>
  DescribeDatasetRequest& WithIdentityPoolId(IdentityPoolIdT&& value) {
  ...
  template <typename IdentityIdT = Aws::String>
  DescribeDatasetRequest& WithIdentityId(IdentityIdT&& value) {
  ...
  template <typename DatasetNameT = Aws::String>
  DescribeDatasetRequest& WithDatasetName(DatasetNameT&& value) {
