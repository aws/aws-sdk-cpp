...
class SubscribeToDatasetRequest : public CognitoSyncRequest {
 public:
  AWS_COGNITOSYNC_API SubscribeToDatasetRequest() = default;
  ...
  template <typename IdentityPoolIdT = Aws::String>
  SubscribeToDatasetRequest& WithIdentityPoolId(IdentityPoolIdT&& value) {
  ...
  template <typename IdentityIdT = Aws::String>
  SubscribeToDatasetRequest& WithIdentityId(IdentityIdT&& value) {
  ...
  template <typename DatasetNameT = Aws::String>
  SubscribeToDatasetRequest& WithDatasetName(DatasetNameT&& value) {
  ...
  template <typename DeviceIdT = Aws::String>
  SubscribeToDatasetRequest& WithDeviceId(DeviceIdT&& value) {
