...
class ListRecordsRequest : public CognitoSyncRequest {
 public:
  ...
  template <typename IdentityPoolIdT = Aws::String>
  ListRecordsRequest& WithIdentityPoolId(IdentityPoolIdT&& value) {
  ...
  template <typename IdentityIdT = Aws::String>
  ListRecordsRequest& WithIdentityId(IdentityIdT&& value) {
  ...
  template <typename DatasetNameT = Aws::String>
  ListRecordsRequest& WithDatasetName(DatasetNameT&& value) {
  ...
  inline void SetLastSyncCount(long long value) {
    m_lastSyncCountHasBeenSet = true;
    m_lastSyncCount = value;
  }
  inline ListRecordsRequest& WithLastSyncCount(long long value) {
    SetLastSyncCount(value);
    return *this;
  }
  ///@}
  ...
  void SetSyncSessionToken(SyncSessionTokenT&& value) {
    ...
    m_syncSessionToken = std::forward<SyncSessionTokenT>(value);
  }
  template <typename SyncSessionTokenT = Aws::String>
  ListRecordsRequest& WithSyncSessionToken(SyncSessionTokenT&& value) {
    SetSyncSessionToken(std::forward<SyncSessionTokenT>(value));
    return *this;
  }
  ///@}
 private:
