...
class UpdateRecordsRequest : public CognitoSyncRequest {
 public:
  ...
  void SetRecordPatches(RecordPatchesT&& value) {
    m_recordPatchesHasBeenSet = true;
    m_recordPatches = std::forward<RecordPatchesT>(value);
  }
  template <typename RecordPatchesT = Aws::Vector<RecordPatch>>
  UpdateRecordsRequest& WithRecordPatches(RecordPatchesT&& value) {
    SetRecordPatches(std::forward<RecordPatchesT>(value));
    return *this;
  }
  template <typename RecordPatchesT = RecordPatch>
  UpdateRecordsRequest& AddRecordPatches(RecordPatchesT&& value) {
    m_recordPatchesHasBeenSet = true;
    m_recordPatches.emplace_back(std::forward<RecordPatchesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetClientContext(ClientContextT&& value) {
    ...
    m_clientContext = std::forward<ClientContextT>(value);
  }
  template <typename ClientContextT = Aws::String>
  UpdateRecordsRequest& WithClientContext(ClientContextT&& value) {
    SetClientContext(std::forward<ClientContextT>(value));
    return *this;
  }
  ///@}
 private:
