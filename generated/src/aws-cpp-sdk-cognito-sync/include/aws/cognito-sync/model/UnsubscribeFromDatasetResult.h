...
namespace Model
{
  ...
  {
  public:
    AWS_COGNITOSYNC_API UnsubscribeFromDatasetResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UnsubscribeFromDatasetResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
