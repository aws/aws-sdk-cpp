...
class UnsubscribeFromDatasetRequest : public CognitoSyncRequest {
 public:
  AWS_COGNITOSYNC_API UnsubscribeFromDatasetRequest() = default;
  ...
  template <typename IdentityPoolIdT = Aws::String>
  UnsubscribeFromDatasetRequest& WithIdentityPoolId(IdentityPoolIdT&& value) {
  ...
  template <typename IdentityIdT = Aws::String>
  UnsubscribeFromDatasetRequest& WithIdentityId(IdentityIdT&& value) {
  ...
  template <typename DatasetNameT = Aws::String>
  UnsubscribeFromDatasetRequest& WithDatasetName(DatasetNameT&& value) {
  ...
  template <typename DeviceIdT = Aws::String>
  UnsubscribeFromDatasetRequest& WithDeviceId(DeviceIdT&& value) {
