...
UpdateRecordsResult::UpdateRecordsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

UpdateRecordsResult& UpdateRecordsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
