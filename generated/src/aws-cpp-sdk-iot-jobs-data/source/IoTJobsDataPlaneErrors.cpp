...
template <>
AWS_IOTJOBSDATAPLANE_API ConflictException IoTJobsDataPlaneError::GetModeledError() {
  assert(this->GetErrorType() == IoTJobsDataPlaneErrors::CONFLICT);
  return ConflictException(this->GetJsonPayload().View());
}

template <>
AWS_IOTJOBSDATAPLANE_API ThrottlingException IoTJobsDataPlaneError::GetModeledError() {
