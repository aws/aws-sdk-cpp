...
namespace IoTJobsDataPlane
{
   ...
   */
  class AWS_IOTJOBSDATAPLANE_API IoTJobsDataPlaneClient : Aws::Client::ClientWithAsyncTemplateMethods<IoTJobsDataPlaneClient>,
    smithy::client::AwsSmithyClientT<Aws::IoTJobsDataPlane::SERVICE_NAME,
    ...
    public:
      ...
      typedef IoTJobsDataPlaneEndpointProvider EndpointProviderType;
        ...
        */
         ...
         */
        template<typename GetPendingJobExecutionsRequestT = Model::GetPendingJobExecutionsRequest>
        void GetPendingJobExecutionsAsync(const GetPendingJobExecutionsRequestT& request, const GetPendingJobExecutionsResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const
        {
        ...
        Model::StartNextPendingJobExecutionOutcomeCallable StartNextPendingJobExecutionCallable(const StartNextPendingJobExecutionRequestT& request) const
        {
         ...
         */
        template<typename StartNextPendingJobExecutionRequestT = Model::StartNextPendingJobExecutionRequest>
        void StartNextPendingJobExecutionAsync(const StartNextPendingJobExecutionRequestT& request, const StartNextPendingJobExecutionResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const
        {
         ...
         */
        template<typename UpdateJobExecutionRequestT = Model::UpdateJobExecutionRequest>
        void UpdateJobExecutionAsync(const UpdateJobExecutionRequestT& request, const UpdateJobExecutionResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const
        {
