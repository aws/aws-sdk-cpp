...
class UpdateJobExecutionResult {
 public:
  ...
  void SetExecutionState(ExecutionStateT&& value) {
    m_executionStateHasBeenSet = true;
    m_executionState = std::forward<ExecutionStateT>(value);
  }
  template <typename ExecutionStateT = JobExecutionState>
  UpdateJobExecutionResult& WithExecutionState(ExecutionStateT&& value) {
    SetExecutionState(std::forward<ExecutionStateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetJobDocument(JobDocumentT&& value) {
    m_jobDocumentHasBeenSet = true;
    m_jobDocument = std::forward<JobDocumentT>(value);
  }
  template <typename JobDocumentT = Aws::String>
  UpdateJobExecutionResult& WithJobDocument(JobDocumentT&& value) {
    SetJobDocument(std::forward<JobDocumentT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  UpdateJobExecutionResult& WithRequestId(RequestIdT&& value) {
