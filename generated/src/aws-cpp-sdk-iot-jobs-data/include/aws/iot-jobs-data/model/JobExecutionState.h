...
class JobExecutionState {
 public:
  ...
  inline JobExecutionState& WithStatus(JobExecutionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusDetailsT = Aws::Map<Aws::String, Aws::String>>
  JobExecutionState& WithStatusDetails(StatusDetailsT&& value) {
  ...
  inline JobExecutionState& WithVersionNumber(long long value) {
