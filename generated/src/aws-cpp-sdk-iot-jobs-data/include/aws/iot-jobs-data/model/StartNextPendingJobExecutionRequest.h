...
class StartNextPendingJobExecutionRequest : public IoTJobsDataPlaneRequest {
 public:
  ...
  template <typename ThingNameT = Aws::String>
  StartNextPendingJobExecutionRequest& WithThingName(ThingNameT&& value) {
  ...
  template <typename StatusDetailsT = Aws::Map<Aws::String, Aws::String>>
  StartNextPendingJobExecutionRequest& WithStatusDetails(StatusDetailsT&& value) {
  ...
  inline StartNextPendingJobExecutionRequest& WithStepTimeoutInMinutes(long long value) {
