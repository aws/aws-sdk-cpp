...
class JobExecutionSummary {
 public:
  ...
  template <typename JobIdT = Aws::String>
  JobExecutionSummary& WithJobId(JobIdT&& value) {
  ...
  inline void SetQueuedAt(long long value) {
    m_queuedAtHasBeenSet = true;
    m_queuedAt = value;
  }
  inline JobExecutionSummary& WithQueuedAt(long long value) {
    SetQueuedAt(value);
    return *this;
  }
  ///@}
  ...
  inline JobExecutionSummary& WithStartedAt(long long value) {
    SetStartedAt(value);
    return *this;
  }
  ///@}
  ...
  inline JobExecutionSummary& WithLastUpdatedAt(long long value) {
  ...
  inline JobExecutionSummary& WithVersionNumber(long long value) {
  ...
  inline JobExecutionSummary& WithExecutionNumber(long long value) {
