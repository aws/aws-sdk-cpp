...
class StartCommandExecutionRequest : public IoTJobsDataPlaneRequest {
 public:
  ...
  template <typename TargetArnT = Aws::String>
  StartCommandExecutionRequest& WithTargetArn(TargetArnT&& value) {
  ...
  template <typename CommandArnT = Aws::String>
  StartCommandExecutionRequest& WithCommandArn(CommandArnT&& value) {
  ...
  template <typename ParametersT = Aws::Map<Aws::String, CommandParameterValue>>
  StartCommandExecutionRequest& WithParameters(ParametersT&& value) {
  ...
  inline StartCommandExecutionRequest& WithExecutionTimeoutSeconds(long long value) {
  ...
  template <typename ClientTokenT = Aws::String>
  StartCommandExecutionRequest& WithClientToken(ClientTokenT&& value) {
