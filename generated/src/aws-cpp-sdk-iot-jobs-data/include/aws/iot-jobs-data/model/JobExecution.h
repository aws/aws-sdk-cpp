...
class JobExecution {
 public:
  ...
  template <typename ThingNameT = Aws::String>
  JobExecution& WithThingName(ThingNameT&& value) {
  ...
  inline JobExecution& WithStatus(JobExecutionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline JobExecution& WithQueuedAt(long long value) {
    SetQueuedAt(value);
    return *this;
  }
  ///@}
  ...
  inline JobExecution& WithStartedAt(long long value) {
    SetStartedAt(value);
    return *this;
  }
  ///@}
  ...
  inline JobExecution& WithLastUpdatedAt(long long value) {
  ...
  inline void SetApproximateSecondsBeforeTimedOut(long long value) {
    m_approximateSecondsBeforeTimedOutHasBeenSet = true;
    m_approximateSecondsBeforeTimedOut = value;
  }
  inline JobExecution& WithApproximateSecondsBeforeTimedOut(long long value) {
    SetApproximateSecondsBeforeTimedOut(value);
    return *this;
  }
  ///@}
  ...
  inline JobExecution& WithVersionNumber(long long value) {
  ...
  inline JobExecution& WithExecutionNumber(long long value) {
  ...
  template <typename JobDocumentT = Aws::String>
  JobExecution& WithJobDocument(JobDocumentT&& value) {
