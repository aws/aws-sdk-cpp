...
class StartNextPendingJobExecutionResult {
 public:
  ...
  AWS_IOTJOBSDATAPLANE_API StartNextPendingJobExecutionResult& operator=(
  ...
  template <typename ExecutionT = JobExecution>
  StartNextPendingJobExecutionResult& WithExecution(ExecutionT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StartNextPendingJobExecutionResult& WithRequestId(RequestIdT&& value) {
