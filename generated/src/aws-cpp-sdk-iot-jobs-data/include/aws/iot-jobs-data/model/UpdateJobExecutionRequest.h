...
class UpdateJobExecutionRequest : public IoTJobsDataPlaneRequest {
 public:
  ...
  template <typename JobIdT = Aws::String>
  UpdateJobExecutionRequest& WithJobId(JobIdT&& value) {
  ...
  template <typename ThingNameT = Aws::String>
  UpdateJobExecutionRequest& WithThingName(ThingNameT&& value) {
  ...
  inline UpdateJobExecutionRequest& WithStatus(JobExecutionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusDetailsT = Aws::Map<Aws::String, Aws::String>>
  UpdateJobExecutionRequest& WithStatusDetails(StatusDetailsT&& value) {
  ...
  inline void SetStepTimeoutInMinutes(long long value) {
    m_stepTimeoutInMinutesHasBeenSet = true;
    m_stepTimeoutInMinutes = value;
  }
  inline UpdateJobExecutionRequest& WithStepTimeoutInMinutes(long long value) {
    SetStepTimeoutInMinutes(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateJobExecutionRequest& WithExpectedVersion(long long value) {
  ...
  inline void SetIncludeJobExecutionState(bool value) {
    m_includeJobExecutionStateHasBeenSet = true;
    m_includeJobExecutionState = value;
  }
  inline UpdateJobExecutionRequest& WithIncludeJobExecutionState(bool value) {
    SetIncludeJobExecutionState(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIncludeJobDocument(bool value) {
    m_includeJobDocumentHasBeenSet = true;
    m_includeJobDocument = value;
  }
  inline UpdateJobExecutionRequest& WithIncludeJobDocument(bool value) {
    SetIncludeJobDocument(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateJobExecutionRequest& WithExecutionNumber(long long value) {
