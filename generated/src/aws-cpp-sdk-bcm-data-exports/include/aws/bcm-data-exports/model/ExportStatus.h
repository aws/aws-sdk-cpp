...
class ExportStatus {
 public:
  ...
  inline void SetStatusCode(ExportStatusCode value) {
    m_statusCodeHasBeenSet = true;
    m_statusCode = value;
  }
  inline ExportStatus& WithStatusCode(ExportStatusCode value) {
    SetStatusCode(value);
    return *this;
  }
  ///@}
  ...
  inline ExportStatus& WithStatusReason(ExecutionStatusReason value) {
