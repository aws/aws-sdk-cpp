...
class ExportReference {
 public:
  ...
  template <typename ExportArnT = Aws::String>
  ExportReference& WithExportArn(ExportArnT&& value) {
  ...
  void SetExportName(ExportNameT&& value) {
    ...
    m_exportName = std::forward<ExportNameT>(value);
  }
  template <typename ExportNameT = Aws::String>
  ExportReference& WithExportName(ExportNameT&& value) {
    SetExportName(std::forward<ExportNameT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ExportStatusT = ExportStatus>
  ExportReference& WithExportStatus(ExportStatusT&& value) {
