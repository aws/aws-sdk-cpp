...
namespace Model
{
  ...
  /**
   * <p>The specified Amazon Resource Name (ARN) in the request doesn't
   * exist.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/bcm-data-exports-2023-11-26/ResourceNotFoundException">AWS
   * API Reference</a></p>
   */
  class ResourceNotFoundException
  {
  public:
    AWS_BCMDATAEXPORTS_API ResourceNotFoundException() = default;
    AWS_BCMDATAEXPORTS_API ResourceNotFoundException(Aws::Utils::Json::JsonView jsonValue);
    AWS_BCMDATAEXPORTS_API ResourceNotFoundException& operator=(Aws::Utils::Json::JsonView jsonValue);
