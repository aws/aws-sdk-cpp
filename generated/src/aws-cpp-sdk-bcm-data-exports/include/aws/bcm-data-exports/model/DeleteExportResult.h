...
namespace Model
{
  ...
  {
  public:
    AWS_BCMDATAEXPORTS_API DeleteExportResult() = default;
    ...
    template<typename ExportArnT = Aws::String>
    DeleteExportResult& WithExportArn(ExportArnT&& value) { SetExportArn(std::forward<ExportArnT>(value)); return *this;}
    ///@}
