...
class Export {
 public:
  ...
  void SetRefreshCadence(RefreshCadenceT&& value) {
    m_refreshCadenceHasBeenSet = true;
    m_refreshCadence = std::forward<RefreshCadenceT>(value);
  }
  template <typename RefreshCadenceT = RefreshCadence>
  Export& WithRefreshCadence(RefreshCadenceT&& value) {
    SetRefreshCadence(std::forward<RefreshCadenceT>(value));
    return *this;
  }
  ///@}
 private:
