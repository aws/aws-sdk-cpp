...
class DataQuery {
 public:
  ...
  template <typename QueryStatementT = Aws::String>
  DataQuery& WithQueryStatement(QueryStatementT&& value) {
  ...
  void SetTableConfigurations(TableConfigurationsT&& value) {
    m_tableConfigurationsHasBeenSet = true;
    m_tableConfigurations = std::forward<TableConfigurationsT>(value);
  }
  template <typename TableConfigurationsT = Aws::Map<Aws::String, Aws::Map<Aws::String, Aws::String>>>
  DataQuery& WithTableConfigurations(TableConfigurationsT&& value) {
    SetTableConfigurations(std::forward<TableConfigurationsT>(value));
    return *this;
  }
  ...
  DataQuery& AddTableConfigurations(TableConfigurationsKeyT&& key, TableConfigurationsValueT&& value) {
    m_tableConfigurationsHasBeenSet = true;
    m_tableConfigurations.emplace(std::forward<TableConfigurationsKeyT>(key), std::forward<TableConfigurationsValueT>(value));
    return *this;
  }
  ///@}
 private:
