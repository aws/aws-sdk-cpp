...
class S3OutputConfigurations {
 public:
  ...
  inline void SetFormat(FormatOption value) {
    m_formatHasBeenSet = true;
    m_format = value;
  }
  inline S3OutputConfigurations& WithFormat(FormatOption value) {
    SetFormat(value);
    return *this;
  }
  ///@}
  ...
  inline void SetOverwrite(OverwriteOption value) {
    m_overwriteHasBeenSet = true;
    m_overwrite = value;
  }
  inline S3OutputConfigurations& WithOverwrite(OverwriteOption value) {
    SetOverwrite(value);
    return *this;
  }
  ///@}
