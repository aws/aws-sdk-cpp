...
namespace Model
{
  ...
  {
  public:
    AWS_BCMDATAEXPORTS_API CreateExportResult() = default;
    ...
    template<typename ExportArnT = Aws::String>
    CreateExportResult& WithExportArn(ExportArnT&& value) { SetExportArn(std::forward<ExportArnT>(value)); return *this;}
    ///@}
