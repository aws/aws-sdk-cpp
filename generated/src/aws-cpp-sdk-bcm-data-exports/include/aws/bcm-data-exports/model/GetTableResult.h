...
class GetTableResult {
 public:
  ...
  void SetTableProperties(TablePropertiesT&& value) {
    m_tablePropertiesHasBeenSet = true;
    m_tableProperties = std::forward<TablePropertiesT>(value);
  }
  template <typename TablePropertiesT = Aws::Map<Aws::String, Aws::String>>
  GetTableResult& WithTableProperties(TablePropertiesT&& value) {
    SetTableProperties(std::forward<TablePropertiesT>(value));
    return *this;
  }
  ...
  GetTableResult& AddTableProperties(TablePropertiesKeyT&& key, TablePropertiesValueT&& value) {
    m_tablePropertiesHasBeenSet = true;
    m_tableProperties.emplace(std::forward<TablePropertiesKeyT>(key), std::forward<TablePropertiesValueT>(value));
    return *this;
  }
  ///@}
