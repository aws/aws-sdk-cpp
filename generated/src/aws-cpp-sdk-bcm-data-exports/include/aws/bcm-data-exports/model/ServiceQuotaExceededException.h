...
namespace Model
{
  ...
  /**
   * <p>You've reached the limit on the number of resources you can create, or
   * exceeded the size of an individual resource.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/bcm-data-exports-2023-11-26/ServiceQuotaExceededException">AWS
   * API Reference</a></p>
   */
  class ServiceQuotaExceededException
  {
  public:
    AWS_BCMDATAEXPORTS_API ServiceQuotaExceededException() = default;
    AWS_BCMDATAEXPORTS_API ServiceQuotaExceededException(Aws::Utils::Json::JsonView jsonValue);
    AWS_BCMDATAEXPORTS_API ServiceQuotaExceededException& operator=(Aws::Utils::Json::JsonView jsonValue);
