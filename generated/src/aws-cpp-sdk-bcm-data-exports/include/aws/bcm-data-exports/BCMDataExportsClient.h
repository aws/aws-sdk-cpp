...
namespace BCMDataExports
{
   ...
   */
  class AWS_BCMDATAEXPORTS_API BCMDataExportsClient : Aws::Client::ClientWithAsyncTemplateMethods<BCMDataExportsClient>,
    smithy::client::AwsSmithyClientT<Aws::BCMDataExports::SERVICE_NAME,
