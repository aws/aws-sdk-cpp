...
template <>
AWS_BCMDATAEXPORTS_API ServiceQuotaExceededException BCMDataExportsError::GetModeledError() {
  assert(this->GetErrorType() == BCMDataExportsErrors::SERVICE_QUOTA_EXCEEDED);
  return ServiceQuotaExceededException(this->GetJsonPayload().View());
}

template <>
AWS_BCMDATAEXPORTS_API ThrottlingException BCMDataExportsError::GetModeledError() {
  assert(this->GetErrorType() == BCMDataExportsErrors::THROTTLING);
  return ThrottlingException(this->GetJsonPayload().View());
}

template <>
AWS_BCMDATAEXPORTS_API ResourceNotFoundException BCMDataExportsError::GetModeledError() {
  assert(this->GetErrorType() == BCMDataExportsErrors::RESOURCE_NOT_FOUND);
  return ResourceNotFoundException(this->GetJsonPayload().View());
}

template <>
AWS_BCMDATAEXPORTS_API ValidationException BCMDataExportsError::GetModeledError() {
