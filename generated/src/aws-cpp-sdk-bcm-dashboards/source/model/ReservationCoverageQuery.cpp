...
ReservationCoverageQuery::ReservationCoverageQuery(JsonView jsonValue) { *this = jsonValue; }

ReservationCoverageQuery& ReservationCoverageQuery::operator=(JsonView jsonValue) {
...
JsonValue ReservationCoverageQuery::Jsonize() const {
  JsonValue payload;
