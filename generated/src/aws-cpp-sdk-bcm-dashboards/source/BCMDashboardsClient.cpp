...
const char SERVICE_NAME[] = "bcm-dashboards";
const char ALLOCATION_TAG[] = "BCMDashboardsClient";
}  // namespace BCMDashboards
}  // namespace Aws
const char* BCMDashboardsClient::GetServiceName() { return SERVICE_NAME; }
const char* BCMDashboardsClient::GetAllocationTag() { return ALLOCATION_TAG; }

BCMDashboardsClient::BCMDashboardsClient(const BCMDashboards::BCMDashboardsClientConfiguration& clientConfiguration,
                                         std::shared_ptr<BCMDashboardsEndpointProviderBase> endpointProvider)
    : BASECLASS(clientConfiguration,
      ...
      m_endpointProvider(endpointProvider ? std::move(endpointProvider) : Aws::MakeShared<BCMDashboardsEndpointProvider>(ALLOCATION_TAG)) {
  init(m_clientConfiguration);
}

BCMDashboardsClient::BCMDashboardsClient(const AWSCredentials& credentials,
                                         std::shared_ptr<BCMDashboardsEndpointProviderBase> endpointProvider,
                                         const BCMDashboards::BCMDashboardsClientConfiguration& clientConfiguration)
    : BASECLASS(clientConfiguration,
...
BCMDashboardsClient::BCMDashboardsClient(const std::shared_ptr<AWSCredentialsProvider>& credentialsProvider,
                                         std::shared_ptr<BCMDashboardsEndpointProviderBase> endpointProvider,
                                         const BCMDashboards::BCMDashboardsClientConfiguration& clientConfiguration)
    : BASECLASS(clientConfiguration,
...
BCMDashboardsClient::BCMDashboardsClient(const Aws::Client::ClientConfiguration& clientConfiguration)
    : BASECLASS(clientConfiguration,
                Aws::MakeShared<AWSAuthV4Signer>(
                    ALLOCATION_TAG,
                    Aws::MakeShared<DefaultAWSCredentialsProviderChain>(ALLOCATION_TAG, clientConfiguration.credentialProviderConfig),
                ...
                Aws::MakeShared<BCMDashboardsErrorMarshaller>(ALLOCATION_TAG)),
      m_clientConfiguration(clientConfiguration),
      m_endpointProvider(Aws::MakeShared<BCMDashboardsEndpointProvider>(ALLOCATION_TAG)) {
  init(m_clientConfiguration);
}

BCMDashboardsClient::BCMDashboardsClient(const AWSCredentials& credentials, const Aws::Client::ClientConfiguration& clientConfiguration)
    : BASECLASS(clientConfiguration,
                Aws::MakeShared<AWSAuthV4Signer>(ALLOCATION_TAG, Aws::MakeShared<SimpleAWSCredentialsProvider>(ALLOCATION_TAG, credentials),
                                                 SERVICE_NAME, Aws::Region::ComputeSignerRegion(clientConfiguration.region)),
                Aws::MakeShared<BCMDashboardsErrorMarshaller>(ALLOCATION_TAG)),
...
BCMDashboardsClient::~BCMDashboardsClient() { ShutdownSdkClient(this, -1); }

std::shared_ptr<BCMDashboardsEndpointProviderBase>& BCMDashboardsClient::accessEndpointProvider() { return m_endpointProvider; }

void BCMDashboardsClient::init(const BCMDashboards::BCMDashboardsClientConfiguration& config) {
  AWSClient::SetServiceClientName("BCM Dashboards");
  ...
  m_endpointProvider->InitBuiltInParameters(config, "bcm-dashboards");
}
...
BCMDashboardsClient::InvokeOperationOutcome BCMDashboardsClient::InvokeServiceOperation(const AmazonWebServiceRequest& request,
