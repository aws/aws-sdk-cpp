...
namespace Model
{
  ...
  /**
   * <p>Specifies tag-based filtering options for cost and usage
   * queries.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/bcm-dashboards-2025-08-18/TagValues">AWS
   * API Reference</a></p>
   */
  class TagValues
  {
  public:
    AWS_BCMDASHBOARDS_API TagValues() = default;
    AWS_BCMDASHBOARDS_API TagValues(Aws::Utils::Json::JsonView jsonValue);
    AWS_BCMDASHBOARDS_API TagValues& operator=(Aws::Utils::Json::JsonView jsonValue);
    ...
    ///@{
    /**
     * <p>The match options for tag values, such as <code>EQUALS</code>,
