...
class SavingsPlansCoverageQuery {
 public:
  ...
  template <typename TimeRangeT = DateTimeRange>
  SavingsPlansCoverageQuery& WithTimeRange(TimeRangeT&& value) {
  ...
  template <typename MetricsT = Aws::Vector<MetricName>>
  SavingsPlansCoverageQuery& WithMetrics(MetricsT&& value) {
    SetMetrics(std::forward<MetricsT>(value));
    return *this;
  }
  inline SavingsPlansCoverageQuery& AddMetrics(MetricName value) {
    m_metricsHasBeenSet = true;
  ...
  inline SavingsPlansCoverageQuery& WithGranularity(Granularity value) {
  ...
  template <typename GroupByT = Aws::Vector<GroupDefinition>>
  SavingsPlansCoverageQuery& WithGroupBy(GroupByT&& value) {
    SetGroupBy(std::forward<GroupByT>(value));
    return *this;
  }
  template <typename GroupByT = GroupDefinition>
  SavingsPlansCoverageQuery& AddGroupBy(GroupByT&& value) {
    m_groupByHasBeenSet = true;
  ...
  template <typename FilterT = Expression>
  SavingsPlansCoverageQuery& WithFilter(FilterT&& value) {
