...
class CreateDashboardRequest : public BCMDashboardsRequest {
 public:
  ...
  template <typename DescriptionT = Aws::String>
  CreateDashboardRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename ResourceTagsT = Aws::Vector<ResourceTag>>
  CreateDashboardRequest& WithResourceTags(ResourceTagsT&& value) {
    SetResourceTags(std::forward<ResourceTagsT>(value));
    return *this;
  }
  template <typename ResourceTagsT = ResourceTag>
  CreateDashboardRequest& AddResourceTags(ResourceTagsT&& value) {
    m_resourceTagsHasBeenSet = true;
