...
class GetDashboardResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  GetDashboardResult& WithArn(ArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  GetDashboardResult& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  GetDashboardResult& WithDescription(DescriptionT&& value) {
  ...
  inline GetDashboardResult& WithType(DashboardType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  GetDashboardResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  GetDashboardResult& WithUpdatedAt(UpdatedAtT&& value) {
