...
class CostAndUsageQuery {
 public:
  ...
  template <typename MetricsT = Aws::Vector<MetricName>>
  CostAndUsageQuery& WithMetrics(MetricsT&& value) {
    SetMetrics(std::forward<MetricsT>(value));
    return *this;
  }
  inline CostAndUsageQuery& AddMetrics(MetricName value) {
    m_metricsHasBeenSet = true;
  ...
  template <typename TimeRangeT = DateTimeRange>
  CostAndUsageQuery& WithTimeRange(TimeRangeT&& value) {
  ...
  inline CostAndUsageQuery& WithGranularity(Granularity value) {
  ...
  template <typename GroupByT = Aws::Vector<GroupDefinition>>
  CostAndUsageQuery& WithGroupBy(GroupByT&& value) {
    SetGroupBy(std::forward<GroupByT>(value));
    return *this;
  }
  template <typename GroupByT = GroupDefinition>
  CostAndUsageQuery& AddGroupBy(GroupByT&& value) {
    m_groupByHasBeenSet = true;
  ...
  template <typename FilterT = Expression>
  CostAndUsageQuery& WithFilter(FilterT&& value) {
