...
class Widget {
 public:
  ...
  template <typename DescriptionT = Aws::String>
  Widget& WithDescription(DescriptionT&& value) {
  ...
  inline Widget& WithWidth(int value) {
    SetWidth(value);
    return *this;
  }
  ///@}
  ...
  inline Widget& WithHeight(int value) {
    SetHeight(value);
    return *this;
  }
  ///@}
  ...
  inline void SetHorizontalOffset(int value) {
    m_horizontalOffsetHasBeenSet = true;
    m_horizontalOffset = value;
  }
  inline Widget& WithHorizontalOffset(int value) {
  ...
  template <typename ConfigsT = Aws::Vector<WidgetConfig>>
  Widget& WithConfigs(ConfigsT&& value) {
    SetConfigs(std::forward<ConfigsT>(value));
    return *this;
  }
  template <typename ConfigsT = WidgetConfig>
  Widget& AddConfigs(ConfigsT&& value) {
    m_configsHasBeenSet = true;
    m_configs.emplace_back(std::forward<ConfigsT>(value));
    return *this;
  }
  ///@}
 private:
