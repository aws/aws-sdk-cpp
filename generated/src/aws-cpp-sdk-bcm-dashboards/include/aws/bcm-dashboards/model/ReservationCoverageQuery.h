...
class ReservationCoverageQuery {
 public:
  ...
  template <typename TimeRangeT = DateTimeRange>
  ReservationCoverageQuery& WithTimeRange(TimeRangeT&& value) {
  ...
  template <typename GroupByT = Aws::Vector<GroupDefinition>>
  ReservationCoverageQuery& WithGroupBy(GroupByT&& value) {
    SetGroupBy(std::forward<GroupByT>(value));
    return *this;
  }
  template <typename GroupByT = GroupDefinition>
  ReservationCoverageQuery& AddGroupBy(GroupByT&& value) {
    m_groupByHasBeenSet = true;
  ...
  inline ReservationCoverageQuery& WithGranularity(Granularity value) {
  ...
  template <typename FilterT = Expression>
  ReservationCoverageQuery& WithFilter(FilterT&& value) {
  ...
  template <typename MetricsT = Aws::Vector<MetricName>>
  ReservationCoverageQuery& WithMetrics(MetricsT&& value) {
    SetMetrics(std::forward<MetricsT>(value));
    return *this;
  }
  inline ReservationCoverageQuery& AddMetrics(MetricName value) {
    m_metricsHasBeenSet = true;
