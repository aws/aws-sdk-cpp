...
class RevokePipelineEndpointConnectionsRequest : public OSISRequest {
 public:
  ...
  template <typename PipelineArnT = Aws::String>
  RevokePipelineEndpointConnectionsRequest& WithPipelineArn(PipelineArnT&& value) {
  ...
  template <typename EndpointIdsT = Aws::Vector<Aws::String>>
  RevokePipelineEndpointConnectionsRequest& WithEndpointIds(EndpointIdsT&& value) {
    SetEndpointIds(std::forward<EndpointIdsT>(value));
    return *this;
  }
  template <typename EndpointIdsT = Aws::String>
  RevokePipelineEndpointConnectionsRequest& AddEndpointIds(EndpointIdsT&& value) {
    m_endpointIdsHasBeenSet = true;
