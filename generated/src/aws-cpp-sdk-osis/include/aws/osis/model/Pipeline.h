...
class Pipeline {
 public:
  ...
  inline Pipeline& WithMinUnits(int value) {
    SetMinUnits(value);
    return *this;
  }
  ///@}
  ...
  inline Pipeline& WithMaxUnits(int value) {
    SetMaxUnits(value);
    return *this;
  }
  ///@}
  ...
  inline Pipeline& WithStatus(PipelineStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetIngestEndpointUrls(IngestEndpointUrlsT&& value) {
    ...
    m_ingestEndpointUrls = std::forward<IngestEndpointUrlsT>(value);
  }
  template <typename IngestEndpointUrlsT = Aws::Vector<Aws::String>>
  Pipeline& WithIngestEndpointUrls(IngestEndpointUrlsT&& value) {
    SetIngestEndpointUrls(std::forward<IngestEndpointUrlsT>(value));
    return *this;
  }
  template <typename IngestEndpointUrlsT = Aws::String>
  Pipeline& AddIngestEndpointUrls(IngestEndpointUrlsT&& value) {
    m_ingestEndpointUrlsHasBeenSet = true;
    m_ingestEndpointUrls.emplace_back(std::forward<IngestEndpointUrlsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetServiceVpcEndpoints(ServiceVpcEndpointsT&& value) {
    ...
    m_serviceVpcEndpoints = std::forward<ServiceVpcEndpointsT>(value);
  }
  template <typename ServiceVpcEndpointsT = Aws::Vector<ServiceVpcEndpoint>>
  Pipeline& WithServiceVpcEndpoints(ServiceVpcEndpointsT&& value) {
    SetServiceVpcEndpoints(std::forward<ServiceVpcEndpointsT>(value));
    return *this;
  }
  template <typename ServiceVpcEndpointsT = ServiceVpcEndpoint>
  Pipeline& AddServiceVpcEndpoints(ServiceVpcEndpointsT&& value) {
    m_serviceVpcEndpointsHasBeenSet = true;
    m_serviceVpcEndpoints.emplace_back(std::forward<ServiceVpcEndpointsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename PipelineRoleArnT = Aws::String>
  Pipeline& WithPipelineRoleArn(PipelineRoleArnT&& value) {
