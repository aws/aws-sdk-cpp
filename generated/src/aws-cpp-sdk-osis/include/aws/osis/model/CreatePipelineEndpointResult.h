...
class CreatePipelineEndpointResult {
 public:
  ...
  template <typename PipelineArnT = Aws::String>
  CreatePipelineEndpointResult& WithPipelineArn(PipelineArnT&& value) {
  ...
  template <typename EndpointIdT = Aws::String>
  CreatePipelineEndpointResult& WithEndpointId(EndpointIdT&& value) {
  ...
  inline CreatePipelineEndpointResult& WithStatus(PipelineEndpointStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename VpcIdT = Aws::String>
  CreatePipelineEndpointResult& WithVpcId(VpcIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreatePipelineEndpointResult& WithRequestId(RequestIdT&& value) {
