...
class ChangeProgressStatus {
 public:
  ...
  inline void SetStatus(ChangeProgressStatuses value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ChangeProgressStatus& WithStatus(ChangeProgressStatuses value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline ChangeProgressStatus& WithTotalNumberOfStages(int value) {
