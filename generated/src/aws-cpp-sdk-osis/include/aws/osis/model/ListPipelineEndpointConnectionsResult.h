...
class ListPipelineEndpointConnectionsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListPipelineEndpointConnectionsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetPipelineEndpointConnections(PipelineEndpointConnectionsT&& value) {
    m_pipelineEndpointConnectionsHasBeenSet = true;
    m_pipelineEndpointConnections = std::forward<PipelineEndpointConnectionsT>(value);
  }
  template <typename PipelineEndpointConnectionsT = Aws::Vector<PipelineEndpointConnection>>
  ListPipelineEndpointConnectionsResult& WithPipelineEndpointConnections(PipelineEndpointConnectionsT&& value) {
    SetPipelineEndpointConnections(std::forward<PipelineEndpointConnectionsT>(value));
    return *this;
  }
  template <typename PipelineEndpointConnectionsT = PipelineEndpointConnection>
  ListPipelineEndpointConnectionsResult& AddPipelineEndpointConnections(PipelineEndpointConnectionsT&& value) {
    m_pipelineEndpointConnectionsHasBeenSet = true;
    m_pipelineEndpointConnections.emplace_back(std::forward<PipelineEndpointConnectionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListPipelineEndpointConnectionsResult& WithRequestId(RequestIdT&& value) {
