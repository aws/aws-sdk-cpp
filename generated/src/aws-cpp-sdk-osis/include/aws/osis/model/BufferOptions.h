...
class BufferOptions {
 public:
  ...
  inline void SetPersistentBufferEnabled(bool value) {
    m_persistentBufferEnabledHasBeenSet = true;
    m_persistentBufferEnabled = value;
  }
  inline BufferOptions& WithPersistentBufferEnabled(bool value) {
    SetPersistentBufferEnabled(value);
    return *this;
  }
  ///@}
 private:
