...
class ChangeProgressStage {
 public:
  ...
  template <typename NameT = Aws::String>
  ChangeProgressStage& WithName(NameT&& value) {
  ...
  inline void SetStatus(ChangeProgressStageStatuses value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ChangeProgressStage& WithStatus(ChangeProgressStageStatuses value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename DescriptionT = Aws::String>
  ChangeProgressStage& WithDescription(DescriptionT&& value) {
  ...
  template <typename LastUpdatedAtT = Aws::Utils::DateTime>
  ChangeProgressStage& WithLastUpdatedAt(LastUpdatedAtT&& value) {
