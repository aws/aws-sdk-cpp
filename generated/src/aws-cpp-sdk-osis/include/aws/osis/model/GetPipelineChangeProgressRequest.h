...
namespace Model
{
  ...
  {
  public:
    AWS_OSIS_API GetPipelineChangeProgressRequest() = default;
    ...
    template<typename PipelineNameT = Aws::String>
    GetPipelineChangeProgressRequest& WithPipelineName(PipelineNameT&& value) { SetPipelineName(std::forward<PipelineNameT>(value)); return *this;}
    ///@}
  private:
