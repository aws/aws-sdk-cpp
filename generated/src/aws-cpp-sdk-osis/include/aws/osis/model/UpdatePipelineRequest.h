...
class UpdatePipelineRequest : public OSISRequest {
 public:
  ...
  inline void SetMinUnits(int value) {
    m_minUnitsHasBeenSet = true;
    m_minUnits = value;
  }
  inline UpdatePipelineRequest& WithMinUnits(int value) {
    SetMinUnits(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxUnits(int value) {
    m_maxUnitsHasBeenSet = true;
    m_maxUnits = value;
  }
  inline UpdatePipelineRequest& WithMaxUnits(int value) {
    SetMaxUnits(value);
    return *this;
  }
  ///@}
  ...
  void SetBufferOptions(BufferOptionsT&& value) {
    ...
    m_bufferOptions = std::forward<BufferOptionsT>(value);
  }
  template <typename BufferOptionsT = BufferOptions>
  UpdatePipelineRequest& WithBufferOptions(BufferOptionsT&& value) {
    SetBufferOptions(std::forward<BufferOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPipelineRoleArn(PipelineRoleArnT&& value) {
    m_pipelineRoleArnHasBeenSet = true;
    m_pipelineRoleArn = std::forward<PipelineRoleArnT>(value);
  }
  template <typename PipelineRoleArnT = Aws::String>
  UpdatePipelineRequest& WithPipelineRoleArn(PipelineRoleArnT&& value) {
    SetPipelineRoleArn(std::forward<PipelineRoleArnT>(value));
    return *this;
  }
  ///@}
 private:
