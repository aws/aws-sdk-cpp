...
class ListPipelineEndpointsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListPipelineEndpointsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetPipelineEndpoints(PipelineEndpointsT&& value) {
    m_pipelineEndpointsHasBeenSet = true;
    m_pipelineEndpoints = std::forward<PipelineEndpointsT>(value);
  }
  template <typename PipelineEndpointsT = Aws::Vector<PipelineEndpoint>>
  ListPipelineEndpointsResult& WithPipelineEndpoints(PipelineEndpointsT&& value) {
    SetPipelineEndpoints(std::forward<PipelineEndpointsT>(value));
    return *this;
  }
  template <typename PipelineEndpointsT = PipelineEndpoint>
  ListPipelineEndpointsResult& AddPipelineEndpoints(PipelineEndpointsT&& value) {
    m_pipelineEndpointsHasBeenSet = true;
    m_pipelineEndpoints.emplace_back(std::forward<PipelineEndpointsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListPipelineEndpointsResult& WithRequestId(RequestIdT&& value) {
