...
class VpcOptions {
 public:
  ...
  void SetVpcAttachmentOptions(VpcAttachmentOptionsT&& value) {
    ...
    m_vpcAttachmentOptions = std::forward<VpcAttachmentOptionsT>(value);
  }
  template <typename VpcAttachmentOptionsT = VpcAttachmentOptions>
  VpcOptions& WithVpcAttachmentOptions(VpcAttachmentOptionsT&& value) {
    SetVpcAttachmentOptions(std::forward<VpcAttachmentOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetVpcEndpointManagement(VpcEndpointManagement value) {
    m_vpcEndpointManagementHasBeenSet = true;
    m_vpcEndpointManagement = value;
  }
  inline VpcOptions& WithVpcEndpointManagement(VpcEndpointManagement value) {
    SetVpcEndpointManagement(value);
    return *this;
  }
  ///@}
 private:
