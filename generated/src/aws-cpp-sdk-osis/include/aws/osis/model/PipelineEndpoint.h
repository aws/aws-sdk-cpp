...
class PipelineEndpoint {
 public:
  ...
  template <typename PipelineArnT = Aws::String>
  PipelineEndpoint& WithPipelineArn(PipelineArnT&& value) {
  ...
  template <typename EndpointIdT = Aws::String>
  PipelineEndpoint& WithEndpointId(EndpointIdT&& value) {
  ...
  inline void SetStatus(PipelineEndpointStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline PipelineEndpoint& WithStatus(PipelineEndpointStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename VpcIdT = Aws::String>
  PipelineEndpoint& WithVpcId(VpcIdT&& value) {
  ...
  template <typename VpcOptionsT = PipelineEndpointVpcOptions>
  PipelineEndpoint& WithVpcOptions(VpcOptionsT&& value) {
  ...
  void SetIngestEndpointUrl(IngestEndpointUrlT&& value) {
    m_ingestEndpointUrlHasBeenSet = true;
    m_ingestEndpointUrl = std::forward<IngestEndpointUrlT>(value);
  }
  template <typename IngestEndpointUrlT = Aws::String>
  PipelineEndpoint& WithIngestEndpointUrl(IngestEndpointUrlT&& value) {
    SetIngestEndpointUrl(std::forward<IngestEndpointUrlT>(value));
    return *this;
  }
  ///@}
 private:
