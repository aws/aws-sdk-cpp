...
class CreatePipelineRequest : public OSISRequest {
 public:
  ...
  inline CreatePipelineRequest& WithMinUnits(int value) {
    SetMinUnits(value);
    return *this;
  }
  ///@}
  ...
  inline CreatePipelineRequest& WithMaxUnits(int value) {
    SetMaxUnits(value);
    return *this;
  }
  ///@}
  ...
  template <typename PipelineRoleArnT = Aws::String>
  CreatePipelineRequest& WithPipelineRoleArn(PipelineRoleArnT&& value) {
