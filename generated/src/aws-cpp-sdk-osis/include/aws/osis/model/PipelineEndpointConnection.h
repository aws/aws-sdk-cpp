...
class PipelineEndpointConnection {
 public:
  ...
  template <typename PipelineArnT = Aws::String>
  PipelineEndpointConnection& WithPipelineArn(PipelineArnT&& value) {
  ...
  template <typename EndpointIdT = Aws::String>
  PipelineEndpointConnection& WithEndpointId(EndpointIdT&& value) {
  ...
  inline PipelineEndpointConnection& WithStatus(PipelineEndpointStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename VpcEndpointOwnerT = Aws::String>
  PipelineEndpointConnection& WithVpcEndpointOwner(VpcEndpointOwnerT&& value) {
