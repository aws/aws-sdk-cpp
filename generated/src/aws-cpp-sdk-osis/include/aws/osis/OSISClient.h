...
class AWS_OSIS_API OSISClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  OSISClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<OSISEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * A Callable wrapper for CreatePipelineEndpoint that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreatePipelineEndpoint that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreatePipelineEndpointRequestT = Model::CreatePipelineEndpointRequest>
  void CreatePipelineEndpointAsync(const CreatePipelineEndpointRequestT& request,
                                   const CreatePipelineEndpointResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeletePipelineEndpoint that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeletePipelineEndpoint that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeletePipelineEndpointRequestT = Model::DeletePipelineEndpointRequest>
  void DeletePipelineEndpointAsync(const DeletePipelineEndpointRequestT& request,
                                   const DeletePipelineEndpointResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetPipelineBlueprint that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetPipelineBlueprint that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetPipelineBlueprintRequestT = Model::GetPipelineBlueprintRequest>
  void GetPipelineBlueprintAsync(const GetPipelineBlueprintRequestT& request, const GetPipelineBlueprintResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetPipelineChangeProgress that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename GetPipelineChangeProgressRequestT = Model::GetPipelineChangeProgressRequest>
  Model::GetPipelineChangeProgressOutcomeCallable GetPipelineChangeProgressCallable(
      const GetPipelineChangeProgressRequestT& request) const {
    return SubmitCallable(&OSISClient::GetPipelineChangeProgress, request);
  }

  /**
   * An Async wrapper for GetPipelineChangeProgress that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetPipelineChangeProgressRequestT = Model::GetPipelineChangeProgressRequest>
  void GetPipelineChangeProgressAsync(const GetPipelineChangeProgressRequestT& request,
                                      const GetPipelineChangeProgressResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListPipelineBlueprints that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListPipelineBlueprints that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListPipelineBlueprintsRequestT = Model::ListPipelineBlueprintsRequest>
  void ListPipelineBlueprintsAsync(const ListPipelineBlueprintsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const ListPipelineBlueprintsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListPipelineEndpointConnectionsOutcome ListPipelineEndpointConnections(
      const Model::ListPipelineEndpointConnectionsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListPipelineEndpointConnections that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListPipelineEndpointConnectionsRequestT = Model::ListPipelineEndpointConnectionsRequest>
  Model::ListPipelineEndpointConnectionsOutcomeCallable ListPipelineEndpointConnectionsCallable(
      const ListPipelineEndpointConnectionsRequestT& request = {}) const {
    return SubmitCallable(&OSISClient::ListPipelineEndpointConnections, request);
  }

  /**
   * An Async wrapper for ListPipelineEndpointConnections that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListPipelineEndpointConnectionsRequestT = Model::ListPipelineEndpointConnectionsRequest>
  void ListPipelineEndpointConnectionsAsync(const ListPipelineEndpointConnectionsResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                            const ListPipelineEndpointConnectionsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListPipelineEndpoints that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListPipelineEndpoints that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListPipelineEndpointsRequestT = Model::ListPipelineEndpointsRequest>
  void ListPipelineEndpointsAsync(const ListPipelineEndpointsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const ListPipelineEndpointsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::RevokePipelineEndpointConnectionsOutcome RevokePipelineEndpointConnections(
      const Model::RevokePipelineEndpointConnectionsRequest& request) const;

  /**
   * A Callable wrapper for RevokePipelineEndpointConnections that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename RevokePipelineEndpointConnectionsRequestT = Model::RevokePipelineEndpointConnectionsRequest>
  Model::RevokePipelineEndpointConnectionsOutcomeCallable RevokePipelineEndpointConnectionsCallable(
      const RevokePipelineEndpointConnectionsRequestT& request) const {
    return SubmitCallable(&OSISClient::RevokePipelineEndpointConnections, request);
  }

  /**
   * An Async wrapper for RevokePipelineEndpointConnections that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename RevokePipelineEndpointConnectionsRequestT = Model::RevokePipelineEndpointConnectionsRequest>
  void RevokePipelineEndpointConnectionsAsync(const RevokePipelineEndpointConnectionsRequestT& request,
                                              const RevokePipelineEndpointConnectionsResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StartPipeline that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StartPipelineRequestT = Model::StartPipelineRequest>
  void StartPipelineAsync(const StartPipelineRequestT& request, const StartPipelineResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StopPipeline that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StopPipelineRequestT = Model::StopPipelineRequest>
  void StopPipelineAsync(const StopPipelineRequestT& request, const StopPipelineResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ValidatePipeline that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ValidatePipeline that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ValidatePipelineRequestT = Model::ValidatePipelineRequest>
  void ValidatePipelineAsync(const ValidatePipelineRequestT& request, const ValidatePipelineResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&OSISClient::ValidatePipeline, request, handler, context);
  }

  virtual void OverrideEndpoint(const Aws::String& endpoint);
  virtual std::shared_ptr<OSISEndpointProviderBase>& accessEndpointProvider();
