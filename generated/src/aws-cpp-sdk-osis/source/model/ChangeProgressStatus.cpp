...
ChangeProgressStatus::ChangeProgressStatus(JsonView jsonValue) { *this = jsonValue; }
...
ChangeProgressStatus& ChangeProgressStatus::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("ChangeProgressStages")) {
    ...
    for (unsigned changeProgressStagesIndex = 0; changeProgressStagesIndex < changeProgressStagesJsonList.GetLength();
         ++changeProgressStagesIndex) {
