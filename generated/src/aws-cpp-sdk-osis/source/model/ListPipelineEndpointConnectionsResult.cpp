...
ListPipelineEndpointConnectionsResult& ListPipelineEndpointConnectionsResult::operator=(
  ...
  if (jsonValue.ValueExists("PipelineEndpointConnections")) {
    ...
    for (unsigned pipelineEndpointConnectionsIndex = 0; pipelineEndpointConnectionsIndex < pipelineEndpointConnectionsJsonList.GetLength();
         ++pipelineEndpointConnectionsIndex) {
