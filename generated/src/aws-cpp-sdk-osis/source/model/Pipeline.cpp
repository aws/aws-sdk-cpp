...
Pipeline& Pipeline::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("IngestEndpointUrls")) {
    ...
    for (unsigned ingestEndpointUrlsIndex = 0; ingestEndpointUrlsIndex < ingestEndpointUrlsJsonList.GetLength();
         ++ingestEndpointUrlsIndex) {
  ...
  if (jsonValue.ValueExists("ServiceVpcEndpoints")) {
    ...
    for (unsigned serviceVpcEndpointsIndex = 0; serviceVpcEndpointsIndex < serviceVpcEndpointsJsonList.GetLength();
         ++serviceVpcEndpointsIndex) {
