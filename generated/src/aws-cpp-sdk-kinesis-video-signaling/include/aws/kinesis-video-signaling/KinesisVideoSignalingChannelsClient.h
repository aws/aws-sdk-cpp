...
class AWS_KINESISVIDEOSIGNALINGCHANNELS_API KinesisVideoSignalingChannelsClient
 ...
 public:
  ...
  KinesisVideoSignalingChannelsClient(
      const Aws::KinesisVideoSignalingChannels::KinesisVideoSignalingChannelsClientConfiguration& clientConfiguration =
          Aws::KinesisVideoSignalingChannels::KinesisVideoSignalingChannelsClientConfiguration(),
  ...
  /**
   * A Callable wrapper for GetIceServerConfig that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename GetIceServerConfigRequestT = Model::GetIceServerConfigRequest>
  ...
  /**
   * An Async wrapper for GetIceServerConfig that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetIceServerConfigRequestT = Model::GetIceServerConfigRequest>
  void GetIceServerConfigAsync(const GetIceServerConfigRequestT& request, const GetIceServerConfigResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for SendAlexaOfferToMaster that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename SendAlexaOfferToMasterRequestT = Model::SendAlexaOfferToMasterRequest>
  ...
  /**
   * An Async wrapper for SendAlexaOfferToMaster that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SendAlexaOfferToMasterRequestT = Model::SendAlexaOfferToMasterRequest>
  void SendAlexaOfferToMasterAsync(const SendAlexaOfferToMasterRequestT& request,
                                   const SendAlexaOfferToMasterResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&KinesisVideoSignalingChannelsClient::SendAlexaOfferToMaster, request, handler, context);
  }

  virtual void OverrideEndpoint(const Aws::String& endpoint);
  virtual std::shared_ptr<KinesisVideoSignalingChannelsEndpointProviderBase>& accessEndpointProvider();
