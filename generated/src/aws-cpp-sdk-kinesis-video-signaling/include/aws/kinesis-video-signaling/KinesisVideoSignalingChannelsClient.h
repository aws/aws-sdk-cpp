...
namespace KinesisVideoSignalingChannels
{
   ...
   * technology.</p>
   */
  class AWS_KINESISVIDEOSIGNALINGCHANNELS_API KinesisVideoSignalingChannelsClient : Aws::Client::ClientWithAsyncTemplateMethods<KinesisVideoSignalingChannelsClient>,
    smithy::client::AwsSmithyClientT<Aws::KinesisVideoSignalingChannels::SERVICE_NAME,
