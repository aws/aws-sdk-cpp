...
LicenseConfiguration& LicenseConfiguration::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("ConsumedLicenseSummaryList")) {
    ...
    for (unsigned consumedLicenseSummaryListIndex = 0; consumedLicenseSummaryListIndex < consumedLicenseSummaryListJsonList.GetLength();
  ...
  if (jsonValue.ValueExists("ManagedResourceSummaryList")) {
    ...
    for (unsigned managedResourceSummaryListIndex = 0; managedResourceSummaryListIndex < managedResourceSummaryListJsonList.GetLength();
         ++managedResourceSummaryListIndex) {
...
JsonValue LicenseConfiguration::Jsonize() const {
  ...
  if (m_consumedLicenseSummaryListHasBeenSet) {
    ...
    for (unsigned consumedLicenseSummaryListIndex = 0; consumedLicenseSummaryListIndex < consumedLicenseSummaryListJsonList.GetLength();
         ++consumedLicenseSummaryListIndex) {
      consumedLicenseSummaryListJsonList[consumedLicenseSummaryListIndex].AsObject(
          m_consumedLicenseSummaryList[consumedLicenseSummaryListIndex].Jsonize());
    }
  ...
  if (m_managedResourceSummaryListHasBeenSet) {
    ...
    for (unsigned managedResourceSummaryListIndex = 0; managedResourceSummaryListIndex < managedResourceSummaryListJsonList.GetLength();
         ++managedResourceSummaryListIndex) {
      managedResourceSummaryListJsonList[managedResourceSummaryListIndex].AsObject(
          m_managedResourceSummaryList[managedResourceSummaryListIndex].Jsonize());
    }
