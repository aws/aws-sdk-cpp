...
AndRuleStatement::AndRuleStatement(JsonView jsonValue) { *this = jsonValue; }

AndRuleStatement& AndRuleStatement::operator=(JsonView jsonValue) {
...
JsonValue AndRuleStatement::Jsonize() const {
  JsonValue payload;
