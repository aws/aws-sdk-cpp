...
ProductInformationFilter::ProductInformationFilter(JsonView jsonValue) { *this = jsonValue; }
...
ProductInformationFilter& ProductInformationFilter::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("ProductInformationFilterValue")) {
    ...
    for (unsigned productInformationFilterValueIndex = 0;
         productInformationFilterValueIndex < productInformationFilterValueJsonList.GetLength(); ++productInformationFilterValueIndex) {
...
JsonValue ProductInformationFilter::Jsonize() const {
  ...
  if (m_productInformationFilterValueHasBeenSet) {
    ...
    for (unsigned productInformationFilterValueIndex = 0;
         productInformationFilterValueIndex < productInformationFilterValueJsonList.GetLength(); ++productInformationFilterValueIndex) {
      productInformationFilterValueJsonList[productInformationFilterValueIndex].AsString(
          m_productInformationFilterValue[productInformationFilterValueIndex]);
    }
