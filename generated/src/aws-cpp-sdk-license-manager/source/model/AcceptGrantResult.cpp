...
AcceptGrantResult::AcceptGrantResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

AcceptGrantResult& AcceptGrantResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
