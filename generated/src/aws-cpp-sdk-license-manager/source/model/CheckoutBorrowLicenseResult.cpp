...
CheckoutBorrowLicenseResult::CheckoutBorrowLicenseResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
CheckoutBorrowLicenseResult& CheckoutBorrowLicenseResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("EntitlementsAllowed")) {
    ...
    for (unsigned entitlementsAllowedIndex = 0; entitlementsAllowedIndex < entitlementsAllowedJsonList.GetLength();
         ++entitlementsAllowedIndex) {
