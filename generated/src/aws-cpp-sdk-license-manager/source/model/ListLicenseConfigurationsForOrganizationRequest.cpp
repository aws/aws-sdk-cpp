...
Aws::String ListLicenseConfigurationsForOrganizationRequest::SerializePayload() const {
  JsonValue payload;
...
Aws::Http::HeaderValueCollection ListLicenseConfigurationsForOrganizationRequest::GetRequestSpecificHeaders() const {
  Aws::Http::HeaderValueCollection headers;
  headers.insert(Aws::Http::HeaderValuePair("X-Amz-Target", "AWSLicenseManager.ListLicenseConfigurationsForOrganization"));
  return headers;
}
