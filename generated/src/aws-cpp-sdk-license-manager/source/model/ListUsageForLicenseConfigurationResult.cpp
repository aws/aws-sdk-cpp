...
ListUsageForLicenseConfigurationResult& ListUsageForLicenseConfigurationResult::operator=(
  ...
  if (jsonValue.ValueExists("LicenseConfigurationUsageList")) {
    ...
    for (unsigned licenseConfigurationUsageListIndex = 0;
         licenseConfigurationUsageListIndex < licenseConfigurationUsageListJsonList.GetLength(); ++licenseConfigurationUsageListIndex) {
