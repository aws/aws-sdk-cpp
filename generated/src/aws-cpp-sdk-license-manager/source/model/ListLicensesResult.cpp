...
ListLicensesResult::ListLicensesResult()
{
}

ListLicensesResult::ListLicensesResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListLicensesResult& ListLicensesResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
