...
LicenseConfigurationRuleStatement::LicenseConfigurationRuleStatement(JsonView jsonValue) { *this = jsonValue; }

LicenseConfigurationRuleStatement& LicenseConfigurationRuleStatement::operator=(JsonView jsonValue) {
...
JsonValue LicenseConfigurationRuleStatement::Jsonize() const {
  JsonValue payload;
