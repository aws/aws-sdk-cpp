...
class ManagedResourceSummary {
 public:
  ...
  inline ManagedResourceSummary& WithResourceType(ResourceType value) {
  ...
  inline void SetAssociationCount(long long value) {
    m_associationCountHasBeenSet = true;
    m_associationCount = value;
  }
  inline ManagedResourceSummary& WithAssociationCount(long long value) {
