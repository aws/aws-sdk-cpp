...
class ListTokensRequest : public LicenseManagerRequest {
 public:
  ...
  void SetTokenIds(TokenIdsT&& value) {
    m_tokenIdsHasBeenSet = true;
    m_tokenIds = std::forward<TokenIdsT>(value);
  }
  template <typename TokenIdsT = Aws::Vector<Aws::String>>
  ListTokensRequest& WithTokenIds(TokenIdsT&& value) {
    SetTokenIds(std::forward<TokenIdsT>(value));
    return *this;
  }
  template <typename TokenIdsT = Aws::String>
  ListTokensRequest& AddTokenIds(TokenIdsT&& value) {
    m_tokenIdsHasBeenSet = true;
    m_tokenIds.emplace_back(std::forward<TokenIdsT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListTokensRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
