...
class ListReceivedLicensesResult {
 public:
  ...
  template <typename LicensesT = Aws::Vector<GrantedLicense>>
  ListReceivedLicensesResult& WithLicenses(LicensesT&& value) {
    SetLicenses(std::forward<LicensesT>(value));
    return *this;
  }
  template <typename LicensesT = GrantedLicense>
  ListReceivedLicensesResult& AddLicenses(LicensesT&& value) {
    m_licensesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListReceivedLicensesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListReceivedLicensesResult& WithRequestId(RequestIdT&& value) {
