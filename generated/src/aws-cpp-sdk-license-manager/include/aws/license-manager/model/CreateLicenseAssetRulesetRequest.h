...
/**
 */
class CreateLicenseAssetRulesetRequest : public LicenseManagerRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "CreateLicenseAssetRuleset"; }
