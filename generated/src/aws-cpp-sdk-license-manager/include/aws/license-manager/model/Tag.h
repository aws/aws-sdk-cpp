...
namespace Model
{
  ...
  {
  public:
    AWS_LICENSEMANAGER_API Tag() = default;
    AWS_LICENSEMANAGER_API Tag(Aws::Utils::Json::JsonView jsonValue);
    AWS_LICENSEMANAGER_API Tag& operator=(Aws::Utils::Json::JsonView jsonValue);
