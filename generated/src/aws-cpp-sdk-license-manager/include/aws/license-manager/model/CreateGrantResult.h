...
class CreateGrantResult {
 public:
  AWS_LICENSEMANAGER_API CreateGrantResult() = default;
  ...
  template <typename GrantArnT = Aws::String>
  CreateGrantResult& WithGrantArn(GrantArnT&& value) {
  ...
  inline CreateGrantResult& WithStatus(GrantStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename VersionT = Aws::String>
  CreateGrantResult& WithVersion(VersionT&& value) {
