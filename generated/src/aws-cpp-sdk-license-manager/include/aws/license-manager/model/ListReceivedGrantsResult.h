...
class ListReceivedGrantsResult {
 public:
  ...
  template <typename GrantsT = Aws::Vector<Grant>>
  ListReceivedGrantsResult& WithGrants(GrantsT&& value) {
    SetGrants(std::forward<GrantsT>(value));
    return *this;
  }
  template <typename GrantsT = Grant>
  ListReceivedGrantsResult& AddGrants(GrantsT&& value) {
    m_grantsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListReceivedGrantsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListReceivedGrantsResult& WithRequestId(RequestIdT&& value) {
