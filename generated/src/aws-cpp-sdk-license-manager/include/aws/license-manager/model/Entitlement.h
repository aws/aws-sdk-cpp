...
class Entitlement {
 public:
  ...
  inline void SetMaxCount(long long value) {
    m_maxCountHasBeenSet = true;
    m_maxCount = value;
  }
  inline Entitlement& WithMaxCount(long long value) {
    SetMaxCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetOverage(bool value) {
    m_overageHasBeenSet = true;
    m_overage = value;
  }
  inline Entitlement& WithOverage(bool value) {
    SetOverage(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUnit(EntitlementUnit value) {
    m_unitHasBeenSet = true;
    m_unit = value;
  }
  inline Entitlement& WithUnit(EntitlementUnit value) {
    SetUnit(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAllowCheckIn(bool value) {
    m_allowCheckInHasBeenSet = true;
    m_allowCheckIn = value;
  }
  inline Entitlement& WithAllowCheckIn(bool value) {
    SetAllowCheckIn(value);
    return *this;
  }
  ///@}
 private:
