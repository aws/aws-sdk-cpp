...
class ListLicenseVersionsRequest : public LicenseManagerRequest {
 public:
  ...
  template <typename LicenseArnT = Aws::String>
  ListLicenseVersionsRequest& WithLicenseArn(LicenseArnT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListLicenseVersionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListLicenseVersionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
