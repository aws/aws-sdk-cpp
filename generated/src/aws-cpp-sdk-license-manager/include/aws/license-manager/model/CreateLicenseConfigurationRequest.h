...
class CreateLicenseConfigurationRequest : public LicenseManagerRequest {
 public:
  ...
  inline CreateLicenseConfigurationRequest& WithLicenseCountingType(LicenseCountingType value) {
  ...
  inline CreateLicenseConfigurationRequest& WithLicenseCount(long long value) {
  ...
  inline CreateLicenseConfigurationRequest& WithLicenseCountHardLimit(bool value) {
  ...
  inline CreateLicenseConfigurationRequest& WithDisassociateWhenNotFound(bool value) {
