...
class UpdateLicenseSpecificationsForResourceRequest : public LicenseManagerRequest {
 public:
  ...
  template <typename ResourceArnT = Aws::String>
  UpdateLicenseSpecificationsForResourceRequest& WithResourceArn(ResourceArnT&& value) {
  ...
  void SetAddLicenseSpecifications(AddLicenseSpecificationsT&& value) {
    m_addLicenseSpecificationsHasBeenSet = true;
    m_addLicenseSpecifications = std::forward<AddLicenseSpecificationsT>(value);
  }
  template <typename AddLicenseSpecificationsT = Aws::Vector<LicenseSpecification>>
  UpdateLicenseSpecificationsForResourceRequest& WithAddLicenseSpecifications(AddLicenseSpecificationsT&& value) {
    SetAddLicenseSpecifications(std::forward<AddLicenseSpecificationsT>(value));
    return *this;
  }
  template <typename AddLicenseSpecificationsT = LicenseSpecification>
  UpdateLicenseSpecificationsForResourceRequest& AddAddLicenseSpecifications(AddLicenseSpecificationsT&& value) {
    m_addLicenseSpecificationsHasBeenSet = true;
    m_addLicenseSpecifications.emplace_back(std::forward<AddLicenseSpecificationsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRemoveLicenseSpecifications(RemoveLicenseSpecificationsT&& value) {
    m_removeLicenseSpecificationsHasBeenSet = true;
    m_removeLicenseSpecifications = std::forward<RemoveLicenseSpecificationsT>(value);
  }
  template <typename RemoveLicenseSpecificationsT = Aws::Vector<LicenseSpecification>>
  UpdateLicenseSpecificationsForResourceRequest& WithRemoveLicenseSpecifications(RemoveLicenseSpecificationsT&& value) {
    SetRemoveLicenseSpecifications(std::forward<RemoveLicenseSpecificationsT>(value));
    return *this;
  }
  template <typename RemoveLicenseSpecificationsT = LicenseSpecification>
  UpdateLicenseSpecificationsForResourceRequest& AddRemoveLicenseSpecifications(RemoveLicenseSpecificationsT&& value) {
    m_removeLicenseSpecificationsHasBeenSet = true;
    m_removeLicenseSpecifications.emplace_back(std::forward<RemoveLicenseSpecificationsT>(value));
    return *this;
  }
  ///@}
 private:
