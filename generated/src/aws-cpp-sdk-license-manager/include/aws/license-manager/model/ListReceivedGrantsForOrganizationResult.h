...
class ListReceivedGrantsForOrganizationResult {
 public:
  ...
  AWS_LICENSEMANAGER_API ListReceivedGrantsForOrganizationResult& operator=(
  ...
  template <typename GrantsT = Aws::Vector<Grant>>
  ListReceivedGrantsForOrganizationResult& WithGrants(GrantsT&& value) {
    SetGrants(std::forward<GrantsT>(value));
    return *this;
  }
  template <typename GrantsT = Grant>
  ListReceivedGrantsForOrganizationResult& AddGrants(GrantsT&& value) {
    m_grantsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListReceivedGrantsForOrganizationResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListReceivedGrantsForOrganizationResult& WithRequestId(RequestIdT&& value) {
