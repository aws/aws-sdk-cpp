...
class RejectGrantResult {
 public:
  ...
  template <typename GrantArnT = Aws::String>
  RejectGrantResult& WithGrantArn(GrantArnT&& value) {
  ...
  inline RejectGrantResult& WithStatus(GrantStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename VersionT = Aws::String>
  RejectGrantResult& WithVersion(VersionT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  RejectGrantResult& WithRequestId(RequestIdT&& value) {
