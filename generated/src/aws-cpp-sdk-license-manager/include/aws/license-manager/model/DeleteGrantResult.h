...
class DeleteGrantResult {
 public:
  ...
  template <typename GrantArnT = Aws::String>
  DeleteGrantResult& WithGrantArn(GrantArnT&& value) {
  ...
  inline DeleteGrantResult& WithStatus(GrantStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename VersionT = Aws::String>
  DeleteGrantResult& WithVersion(VersionT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteGrantResult& WithRequestId(RequestIdT&& value) {
