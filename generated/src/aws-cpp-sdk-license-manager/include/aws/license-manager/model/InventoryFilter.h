...
class InventoryFilter {
 public:
  ...
  template <typename NameT = Aws::String>
  InventoryFilter& WithName(NameT&& value) {
  ...
  inline void SetCondition(InventoryFilterCondition value) {
    m_conditionHasBeenSet = true;
    m_condition = value;
  }
  inline InventoryFilter& WithCondition(InventoryFilterCondition value) {
    SetCondition(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValueT = Aws::String>
  InventoryFilter& WithValue(ValueT&& value) {
