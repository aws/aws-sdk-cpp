...
class AcceptGrantResult {
 public:
  ...
  template <typename GrantArnT = Aws::String>
  AcceptGrantResult& WithGrantArn(GrantArnT&& value) {
  ...
  inline AcceptGrantResult& WithStatus(GrantStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename VersionT = Aws::String>
  AcceptGrantResult& WithVersion(VersionT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  AcceptGrantResult& WithRequestId(RequestIdT&& value) {
