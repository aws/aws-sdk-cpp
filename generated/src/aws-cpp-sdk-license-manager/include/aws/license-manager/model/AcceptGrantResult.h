...
namespace Model
{
  ...
  {
  public:
    AWS_LICENSEMANAGER_API AcceptGrantResult() = default;
    ...
    template<typename GrantArnT = Aws::String>
    AcceptGrantResult& WithGrantArn(GrantArnT&& value) { SetGrantArn(std::forward<GrantArnT>(value)); return *this;}
    ///@}
    ...
    inline AcceptGrantResult& WithStatus(GrantStatus value) { SetStatus(value); return *this;}
    ///@}
    ...
    template<typename VersionT = Aws::String>
    AcceptGrantResult& WithVersion(VersionT&& value) { SetVersion(std::forward<VersionT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    AcceptGrantResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
