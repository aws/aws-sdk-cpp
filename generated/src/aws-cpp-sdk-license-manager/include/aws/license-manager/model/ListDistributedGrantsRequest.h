...
class ListDistributedGrantsRequest : public LicenseManagerRequest {
 public:
  ...
  void SetGrantArns(GrantArnsT&& value) {
    m_grantArnsHasBeenSet = true;
    m_grantArns = std::forward<GrantArnsT>(value);
  }
  template <typename GrantArnsT = Aws::Vector<Aws::String>>
  ListDistributedGrantsRequest& WithGrantArns(GrantArnsT&& value) {
    SetGrantArns(std::forward<GrantArnsT>(value));
    return *this;
  }
  template <typename GrantArnsT = Aws::String>
  ListDistributedGrantsRequest& AddGrantArns(GrantArnsT&& value) {
    m_grantArnsHasBeenSet = true;
    m_grantArns.emplace_back(std::forward<GrantArnsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  ListDistributedGrantsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  ListDistributedGrantsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListDistributedGrantsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListDistributedGrantsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
