...
class UpdateLicenseManagerReportGeneratorRequest : public LicenseManagerRequest {
 public:
  ...
  template <typename LicenseManagerReportGeneratorArnT = Aws::String>
  UpdateLicenseManagerReportGeneratorRequest& WithLicenseManagerReportGeneratorArn(LicenseManagerReportGeneratorArnT&& value) {
  ...
  template <typename ReportGeneratorNameT = Aws::String>
  UpdateLicenseManagerReportGeneratorRequest& WithReportGeneratorName(ReportGeneratorNameT&& value) {
  ...
  template <typename TypeT = Aws::Vector<ReportType>>
  UpdateLicenseManagerReportGeneratorRequest& WithType(TypeT&& value) {
    SetType(std::forward<TypeT>(value));
    return *this;
  }
  inline UpdateLicenseManagerReportGeneratorRequest& AddType(ReportType value) {
    m_typeHasBeenSet = true;
  ...
  template <typename ReportContextT = ReportContext>
  UpdateLicenseManagerReportGeneratorRequest& WithReportContext(ReportContextT&& value) {
  ...
  template <typename ReportFrequencyT = ReportFrequency>
  UpdateLicenseManagerReportGeneratorRequest& WithReportFrequency(ReportFrequencyT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  UpdateLicenseManagerReportGeneratorRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateLicenseManagerReportGeneratorRequest& WithDescription(DescriptionT&& value) {
