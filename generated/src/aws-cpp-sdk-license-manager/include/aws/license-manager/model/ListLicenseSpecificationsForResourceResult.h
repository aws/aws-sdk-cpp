...
class ListLicenseSpecificationsForResourceResult {
 public:
  ...
  AWS_LICENSEMANAGER_API ListLicenseSpecificationsForResourceResult& operator=(
  ...
  template <typename LicenseSpecificationsT = Aws::Vector<LicenseSpecification>>
  ListLicenseSpecificationsForResourceResult& WithLicenseSpecifications(LicenseSpecificationsT&& value) {
  ...
  ListLicenseSpecificationsForResourceResult& AddLicenseSpecifications(LicenseSpecificationsT&& value) {
    m_licenseSpecificationsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListLicenseSpecificationsForResourceResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListLicenseSpecificationsForResourceResult& WithRequestId(RequestIdT&& value) {
