...
namespace Model
{
  ...
  public:
    ...
    template<typename LicenseConfigurationArnT = Aws::String>
    ListFailuresForLicenseConfigurationOperationsRequest& WithLicenseConfigurationArn(LicenseConfigurationArnT&& value) { SetLicenseConfigurationArn(std::forward<LicenseConfigurationArnT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListFailuresForLicenseConfigurationOperationsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
