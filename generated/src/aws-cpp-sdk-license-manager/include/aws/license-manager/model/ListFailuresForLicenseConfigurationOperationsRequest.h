...
class ListFailuresForLicenseConfigurationOperationsRequest : public LicenseManagerRequest {
 public:
  AWS_LICENSEMANAGER_API ListFailuresForLicenseConfigurationOperationsRequest() = default;
  ...
  template <typename LicenseConfigurationArnT = Aws::String>
  ListFailuresForLicenseConfigurationOperationsRequest& WithLicenseConfigurationArn(LicenseConfigurationArnT&& value) {
  ...
  inline ListFailuresForLicenseConfigurationOperationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListFailuresForLicenseConfigurationOperationsRequest& WithNextToken(NextTokenT&& value) {
