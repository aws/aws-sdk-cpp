...
class ListDistributedGrantsResult {
 public:
  ...
  template <typename GrantsT = Aws::Vector<Grant>>
  ListDistributedGrantsResult& WithGrants(GrantsT&& value) {
    SetGrants(std::forward<GrantsT>(value));
    return *this;
  }
  template <typename GrantsT = Grant>
  ListDistributedGrantsResult& AddGrants(GrantsT&& value) {
    m_grantsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListDistributedGrantsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDistributedGrantsResult& WithRequestId(RequestIdT&& value) {
