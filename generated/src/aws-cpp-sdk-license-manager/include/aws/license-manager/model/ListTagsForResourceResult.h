...
namespace Model
{
  ...
  {
  public:
    AWS_LICENSEMANAGER_API ListTagsForResourceResult() = default;
    AWS_LICENSEMANAGER_API ListTagsForResourceResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_LICENSEMANAGER_API ListTagsForResourceResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
