...
class ReportGenerator {
 public:
  ...
  void SetReportGeneratorName(ReportGeneratorNameT&& value) {
    ...
    m_reportGeneratorName = std::forward<ReportGeneratorNameT>(value);
  }
  template <typename ReportGeneratorNameT = Aws::String>
  ReportGenerator& WithReportGeneratorName(ReportGeneratorNameT&& value) {
    SetReportGeneratorName(std::forward<ReportGeneratorNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline ReportGenerator& AddReportType(ReportType value) {
    m_reportTypeHasBeenSet = true;
    m_reportType.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetReportContext(ReportContextT&& value) {
    ...
    m_reportContext = std::forward<ReportContextT>(value);
  }
  template <typename ReportContextT = ReportContext>
  ReportGenerator& WithReportContext(ReportContextT&& value) {
    SetReportContext(std::forward<ReportContextT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReportFrequency(ReportFrequencyT&& value) {
    ...
    m_reportFrequency = std::forward<ReportFrequencyT>(value);
  }
  template <typename ReportFrequencyT = ReportFrequency>
  ReportGenerator& WithReportFrequency(ReportFrequencyT&& value) {
    SetReportFrequency(std::forward<ReportFrequencyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastRunStatus(LastRunStatusT&& value) {
    ...
    m_lastRunStatus = std::forward<LastRunStatusT>(value);
  }
  template <typename LastRunStatusT = Aws::String>
  ReportGenerator& WithLastRunStatus(LastRunStatusT&& value) {
    SetLastRunStatus(std::forward<LastRunStatusT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastRunFailureReason(LastRunFailureReasonT&& value) {
    ...
    m_lastRunFailureReason = std::forward<LastRunFailureReasonT>(value);
  }
  template <typename LastRunFailureReasonT = Aws::String>
  ReportGenerator& WithLastRunFailureReason(LastRunFailureReasonT&& value) {
    SetLastRunFailureReason(std::forward<LastRunFailureReasonT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastReportGenerationTime(LastReportGenerationTimeT&& value) {
    ...
    m_lastReportGenerationTime = std::forward<LastReportGenerationTimeT>(value);
  }
  template <typename LastReportGenerationTimeT = Aws::String>
  ReportGenerator& WithLastReportGenerationTime(LastReportGenerationTimeT&& value) {
    SetLastReportGenerationTime(std::forward<LastReportGenerationTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReportCreatorAccount(ReportCreatorAccountT&& value) {
    ...
    m_reportCreatorAccount = std::forward<ReportCreatorAccountT>(value);
  }
  template <typename ReportCreatorAccountT = Aws::String>
  ReportGenerator& WithReportCreatorAccount(ReportCreatorAccountT&& value) {
    SetReportCreatorAccount(std::forward<ReportCreatorAccountT>(value));
    return *this;
  }
  ///@}
