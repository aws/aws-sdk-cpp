...
class LicenseConfiguration {
 public:
  ...
  void SetLicenseConfigurationId(LicenseConfigurationIdT&& value) {
    ...
    m_licenseConfigurationId = std::forward<LicenseConfigurationIdT>(value);
  }
  template <typename LicenseConfigurationIdT = Aws::String>
  LicenseConfiguration& WithLicenseConfigurationId(LicenseConfigurationIdT&& value) {
    SetLicenseConfigurationId(std::forward<LicenseConfigurationIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetLicenseCountingType(LicenseCountingType value) {
    m_licenseCountingTypeHasBeenSet = true;
    m_licenseCountingType = value;
  }
  inline LicenseConfiguration& WithLicenseCountingType(LicenseCountingType value) {
    SetLicenseCountingType(value);
    return *this;
  }
  ///@}
  ...
  inline LicenseConfiguration& WithLicenseCount(long long value) {
  ...
  inline LicenseConfiguration& WithLicenseCountHardLimit(bool value) {
  ...
  inline LicenseConfiguration& WithDisassociateWhenNotFound(bool value) {
  ...
  inline void SetConsumedLicenses(long long value) {
    m_consumedLicensesHasBeenSet = true;
    m_consumedLicenses = value;
  }
  inline LicenseConfiguration& WithConsumedLicenses(long long value) {
    SetConsumedLicenses(value);
    return *this;
  }
  ///@}
  ...
  void SetConsumedLicenseSummaryList(ConsumedLicenseSummaryListT&& value) {
    ...
    m_consumedLicenseSummaryList = std::forward<ConsumedLicenseSummaryListT>(value);
  }
  template <typename ConsumedLicenseSummaryListT = Aws::Vector<ConsumedLicenseSummary>>
  LicenseConfiguration& WithConsumedLicenseSummaryList(ConsumedLicenseSummaryListT&& value) {
    SetConsumedLicenseSummaryList(std::forward<ConsumedLicenseSummaryListT>(value));
    return *this;
  }
  ...
  LicenseConfiguration& AddConsumedLicenseSummaryList(ConsumedLicenseSummaryListT&& value) {
    m_consumedLicenseSummaryListHasBeenSet = true;
    m_consumedLicenseSummaryList.emplace_back(std::forward<ConsumedLicenseSummaryListT>(value));
    return *this;
  }
  ///@}
  ...
  void SetManagedResourceSummaryList(ManagedResourceSummaryListT&& value) {
    ...
    m_managedResourceSummaryList = std::forward<ManagedResourceSummaryListT>(value);
  }
  template <typename ManagedResourceSummaryListT = Aws::Vector<ManagedResourceSummary>>
  LicenseConfiguration& WithManagedResourceSummaryList(ManagedResourceSummaryListT&& value) {
    SetManagedResourceSummaryList(std::forward<ManagedResourceSummaryListT>(value));
    return *this;
  }
  ...
  LicenseConfiguration& AddManagedResourceSummaryList(ManagedResourceSummaryListT&& value) {
    m_managedResourceSummaryListHasBeenSet = true;
    m_managedResourceSummaryList.emplace_back(std::forward<ManagedResourceSummaryListT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAutomatedDiscoveryInformation(AutomatedDiscoveryInformationT&& value) {
    ...
    m_automatedDiscoveryInformation = std::forward<AutomatedDiscoveryInformationT>(value);
  }
  template <typename AutomatedDiscoveryInformationT = AutomatedDiscoveryInformation>
  LicenseConfiguration& WithAutomatedDiscoveryInformation(AutomatedDiscoveryInformationT&& value) {
    SetAutomatedDiscoveryInformation(std::forward<AutomatedDiscoveryInformationT>(value));
    return *this;
  }
  ///@}
  ...
  inline LicenseConfiguration& WithLicenseExpiry(long long value) {
