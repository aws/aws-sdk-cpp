...
class ConsumptionConfiguration {
 public:
  ...
  inline void SetRenewType(RenewType value) {
    m_renewTypeHasBeenSet = true;
    m_renewType = value;
  }
  inline ConsumptionConfiguration& WithRenewType(RenewType value) {
    SetRenewType(value);
    return *this;
  }
  ///@}
  ...
  void SetProvisionalConfiguration(ProvisionalConfigurationT&& value) {
    ...
    m_provisionalConfiguration = std::forward<ProvisionalConfigurationT>(value);
  }
  template <typename ProvisionalConfigurationT = ProvisionalConfiguration>
  ConsumptionConfiguration& WithProvisionalConfiguration(ProvisionalConfigurationT&& value) {
    SetProvisionalConfiguration(std::forward<ProvisionalConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBorrowConfiguration(BorrowConfigurationT&& value) {
    ...
    m_borrowConfiguration = std::forward<BorrowConfigurationT>(value);
  }
  template <typename BorrowConfigurationT = BorrowConfiguration>
  ConsumptionConfiguration& WithBorrowConfiguration(BorrowConfigurationT&& value) {
    SetBorrowConfiguration(std::forward<BorrowConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
