...
class GetLicenseConfigurationResult {
 public:
  ...
  inline GetLicenseConfigurationResult& WithLicenseCountingType(LicenseCountingType value) {
  ...
  inline GetLicenseConfigurationResult& WithLicenseCount(long long value) {
  ...
  inline GetLicenseConfigurationResult& WithLicenseCountHardLimit(bool value) {
  ...
  inline GetLicenseConfigurationResult& WithConsumedLicenses(long long value) {
  ...
  inline GetLicenseConfigurationResult& WithDisassociateWhenNotFound(bool value) {
