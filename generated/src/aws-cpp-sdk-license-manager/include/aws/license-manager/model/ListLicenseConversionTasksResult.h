...
class ListLicenseConversionTasksResult {
 public:
  ...
  AWS_LICENSEMANAGER_API ListLicenseConversionTasksResult& operator=(
  ...
  void SetLicenseConversionTasks(LicenseConversionTasksT&& value) {
    m_licenseConversionTasksHasBeenSet = true;
    m_licenseConversionTasks = std::forward<LicenseConversionTasksT>(value);
  }
  template <typename LicenseConversionTasksT = Aws::Vector<LicenseConversionTask>>
  ListLicenseConversionTasksResult& WithLicenseConversionTasks(LicenseConversionTasksT&& value) {
    SetLicenseConversionTasks(std::forward<LicenseConversionTasksT>(value));
    return *this;
  }
  template <typename LicenseConversionTasksT = LicenseConversionTask>
  ListLicenseConversionTasksResult& AddLicenseConversionTasks(LicenseConversionTasksT&& value) {
    m_licenseConversionTasksHasBeenSet = true;
    m_licenseConversionTasks.emplace_back(std::forward<LicenseConversionTasksT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListLicenseConversionTasksResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListLicenseConversionTasksResult& WithRequestId(RequestIdT&& value) {
