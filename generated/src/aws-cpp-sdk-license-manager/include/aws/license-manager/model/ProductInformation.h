...
class ProductInformation {
 public:
  ...
  template <typename ResourceTypeT = Aws::String>
  ProductInformation& WithResourceType(ResourceTypeT&& value) {
  ...
  void SetProductInformationFilterList(ProductInformationFilterListT&& value) {
    m_productInformationFilterListHasBeenSet = true;
    m_productInformationFilterList = std::forward<ProductInformationFilterListT>(value);
  }
  template <typename ProductInformationFilterListT = Aws::Vector<ProductInformationFilter>>
  ProductInformation& WithProductInformationFilterList(ProductInformationFilterListT&& value) {
    SetProductInformationFilterList(std::forward<ProductInformationFilterListT>(value));
    return *this;
  }
  template <typename ProductInformationFilterListT = ProductInformationFilter>
  ProductInformation& AddProductInformationFilterList(ProductInformationFilterListT&& value) {
    m_productInformationFilterListHasBeenSet = true;
    m_productInformationFilterList.emplace_back(std::forward<ProductInformationFilterListT>(value));
    return *this;
  }
  ///@}
 private:
