...
class Grant {
 public:
  ...
  void SetParentArn(ParentArnT&& value) {
    ...
    m_parentArn = std::forward<ParentArnT>(value);
  }
  template <typename ParentArnT = Aws::String>
  Grant& WithParentArn(ParentArnT&& value) {
    SetParentArn(std::forward<ParentArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGranteePrincipalArn(GranteePrincipalArnT&& value) {
    ...
    m_granteePrincipalArn = std::forward<GranteePrincipalArnT>(value);
  }
  template <typename GranteePrincipalArnT = Aws::String>
  Grant& WithGranteePrincipalArn(GranteePrincipalArnT&& value) {
    SetGranteePrincipalArn(std::forward<GranteePrincipalArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetGrantStatus(GrantStatus value) {
    m_grantStatusHasBeenSet = true;
    m_grantStatus = value;
  }
  inline Grant& WithGrantStatus(GrantStatus value) {
  ...
  void SetGrantedOperations(GrantedOperationsT&& value) {
    ...
    m_grantedOperations = std::forward<GrantedOperationsT>(value);
  }
  template <typename GrantedOperationsT = Aws::Vector<AllowedOperation>>
  Grant& WithGrantedOperations(GrantedOperationsT&& value) {
    SetGrantedOperations(std::forward<GrantedOperationsT>(value));
    return *this;
  }
  inline Grant& AddGrantedOperations(AllowedOperation value) {
    m_grantedOperationsHasBeenSet = true;
    m_grantedOperations.push_back(value);
    return *this;
  }
  ///@}
