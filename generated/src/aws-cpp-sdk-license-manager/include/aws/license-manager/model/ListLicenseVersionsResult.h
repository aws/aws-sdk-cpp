...
class ListLicenseVersionsResult {
 public:
  ...
  template <typename LicensesT = Aws::Vector<License>>
  ListLicenseVersionsResult& WithLicenses(LicensesT&& value) {
    SetLicenses(std::forward<LicensesT>(value));
    return *this;
  }
  template <typename LicensesT = License>
  ListLicenseVersionsResult& AddLicenses(LicensesT&& value) {
    m_licensesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListLicenseVersionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListLicenseVersionsResult& WithRequestId(RequestIdT&& value) {
