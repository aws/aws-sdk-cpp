...
class ListAssociationsForLicenseConfigurationRequest : public LicenseManagerRequest {
 public:
  ...
  template <typename LicenseConfigurationArnT = Aws::String>
  ListAssociationsForLicenseConfigurationRequest& WithLicenseConfigurationArn(LicenseConfigurationArnT&& value) {
  ...
  inline ListAssociationsForLicenseConfigurationRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAssociationsForLicenseConfigurationRequest& WithNextToken(NextTokenT&& value) {
