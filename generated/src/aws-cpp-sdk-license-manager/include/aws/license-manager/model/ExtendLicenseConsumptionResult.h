...
class ExtendLicenseConsumptionResult {
 public:
  ...
  void SetLicenseConsumptionToken(LicenseConsumptionTokenT&& value) {
    ...
    m_licenseConsumptionToken = std::forward<LicenseConsumptionTokenT>(value);
  }
  template <typename LicenseConsumptionTokenT = Aws::String>
  ExtendLicenseConsumptionResult& WithLicenseConsumptionToken(LicenseConsumptionTokenT&& value) {
    SetLicenseConsumptionToken(std::forward<LicenseConsumptionTokenT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ExpirationT = Aws::String>
  ExtendLicenseConsumptionResult& WithExpiration(ExpirationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ExtendLicenseConsumptionResult& WithRequestId(RequestIdT&& value) {
