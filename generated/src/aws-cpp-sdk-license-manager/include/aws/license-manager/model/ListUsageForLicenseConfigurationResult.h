...
class ListUsageForLicenseConfigurationResult {
 public:
  ...
  AWS_LICENSEMANAGER_API ListUsageForLicenseConfigurationResult& operator=(
  ...
  void SetLicenseConfigurationUsageList(LicenseConfigurationUsageListT&& value) {
    m_licenseConfigurationUsageListHasBeenSet = true;
    m_licenseConfigurationUsageList = std::forward<LicenseConfigurationUsageListT>(value);
  }
  template <typename LicenseConfigurationUsageListT = Aws::Vector<LicenseConfigurationUsage>>
  ListUsageForLicenseConfigurationResult& WithLicenseConfigurationUsageList(LicenseConfigurationUsageListT&& value) {
    SetLicenseConfigurationUsageList(std::forward<LicenseConfigurationUsageListT>(value));
    return *this;
  }
  template <typename LicenseConfigurationUsageListT = LicenseConfigurationUsage>
  ListUsageForLicenseConfigurationResult& AddLicenseConfigurationUsageList(LicenseConfigurationUsageListT&& value) {
    m_licenseConfigurationUsageListHasBeenSet = true;
    m_licenseConfigurationUsageList.emplace_back(std::forward<LicenseConfigurationUsageListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListUsageForLicenseConfigurationResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListUsageForLicenseConfigurationResult& WithRequestId(RequestIdT&& value) {
