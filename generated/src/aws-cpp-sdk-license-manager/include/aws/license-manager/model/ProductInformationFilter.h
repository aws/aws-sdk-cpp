...
class ProductInformationFilter {
 public:
  ...
  void SetProductInformationFilterName(ProductInformationFilterNameT&& value) {
    m_productInformationFilterNameHasBeenSet = true;
    m_productInformationFilterName = std::forward<ProductInformationFilterNameT>(value);
  }
  template <typename ProductInformationFilterNameT = Aws::String>
  ProductInformationFilter& WithProductInformationFilterName(ProductInformationFilterNameT&& value) {
    SetProductInformationFilterName(std::forward<ProductInformationFilterNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetProductInformationFilterValue(ProductInformationFilterValueT&& value) {
    m_productInformationFilterValueHasBeenSet = true;
    m_productInformationFilterValue = std::forward<ProductInformationFilterValueT>(value);
  }
  template <typename ProductInformationFilterValueT = Aws::Vector<Aws::String>>
  ProductInformationFilter& WithProductInformationFilterValue(ProductInformationFilterValueT&& value) {
    SetProductInformationFilterValue(std::forward<ProductInformationFilterValueT>(value));
    return *this;
  }
  template <typename ProductInformationFilterValueT = Aws::String>
  ProductInformationFilter& AddProductInformationFilterValue(ProductInformationFilterValueT&& value) {
    m_productInformationFilterValueHasBeenSet = true;
    m_productInformationFilterValue.emplace_back(std::forward<ProductInformationFilterValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetProductInformationFilterComparator(ProductInformationFilterComparatorT&& value) {
    m_productInformationFilterComparatorHasBeenSet = true;
    m_productInformationFilterComparator = std::forward<ProductInformationFilterComparatorT>(value);
  }
  template <typename ProductInformationFilterComparatorT = Aws::String>
  ProductInformationFilter& WithProductInformationFilterComparator(ProductInformationFilterComparatorT&& value) {
    SetProductInformationFilterComparator(std::forward<ProductInformationFilterComparatorT>(value));
    return *this;
  }
  ///@}
 private:
