...
class ListReceivedLicensesRequest : public LicenseManagerRequest {
 public:
  ...
  void SetLicenseArns(LicenseArnsT&& value) {
    ...
    m_licenseArns = std::forward<LicenseArnsT>(value);
  }
  template <typename LicenseArnsT = Aws::Vector<Aws::String>>
  ListReceivedLicensesRequest& WithLicenseArns(LicenseArnsT&& value) {
    SetLicenseArns(std::forward<LicenseArnsT>(value));
    return *this;
  }
  template <typename LicenseArnsT = Aws::String>
  ListReceivedLicensesRequest& AddLicenseArns(LicenseArnsT&& value) {
    m_licenseArnsHasBeenSet = true;
    m_licenseArns.emplace_back(std::forward<LicenseArnsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  ListReceivedLicensesRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  ListReceivedLicensesRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListReceivedLicensesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListReceivedLicensesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
