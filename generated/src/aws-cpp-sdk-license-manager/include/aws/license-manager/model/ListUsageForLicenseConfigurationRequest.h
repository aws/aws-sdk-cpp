...
class ListUsageForLicenseConfigurationRequest : public LicenseManagerRequest {
 public:
  ...
  template <typename LicenseConfigurationArnT = Aws::String>
  ListUsageForLicenseConfigurationRequest& WithLicenseConfigurationArn(LicenseConfigurationArnT&& value) {
  ...
  inline ListUsageForLicenseConfigurationRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListUsageForLicenseConfigurationRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  ListUsageForLicenseConfigurationRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  ListUsageForLicenseConfigurationRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
