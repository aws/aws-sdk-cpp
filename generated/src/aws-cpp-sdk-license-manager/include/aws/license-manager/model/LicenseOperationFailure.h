...
class LicenseOperationFailure {
 public:
  ...
  inline LicenseOperationFailure& WithResourceType(ResourceType value) {
  ...
  void SetFailureTime(FailureTimeT&& value) {
    m_failureTimeHasBeenSet = true;
    m_failureTime = std::forward<FailureTimeT>(value);
  }
  template <typename FailureTimeT = Aws::Utils::DateTime>
  LicenseOperationFailure& WithFailureTime(FailureTimeT&& value) {
    SetFailureTime(std::forward<FailureTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOperationRequestedBy(OperationRequestedByT&& value) {
    ...
    m_operationRequestedBy = std::forward<OperationRequestedByT>(value);
  }
  template <typename OperationRequestedByT = Aws::String>
  LicenseOperationFailure& WithOperationRequestedBy(OperationRequestedByT&& value) {
    SetOperationRequestedBy(std::forward<OperationRequestedByT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMetadataList(MetadataListT&& value) {
    m_metadataListHasBeenSet = true;
    m_metadataList = std::forward<MetadataListT>(value);
  }
  template <typename MetadataListT = Aws::Vector<Metadata>>
  LicenseOperationFailure& WithMetadataList(MetadataListT&& value) {
    SetMetadataList(std::forward<MetadataListT>(value));
    return *this;
  }
  template <typename MetadataListT = Metadata>
  LicenseOperationFailure& AddMetadataList(MetadataListT&& value) {
    m_metadataListHasBeenSet = true;
    m_metadataList.emplace_back(std::forward<MetadataListT>(value));
    return *this;
  }
  ///@}
 private:
