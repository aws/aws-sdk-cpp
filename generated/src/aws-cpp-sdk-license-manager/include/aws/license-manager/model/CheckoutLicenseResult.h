...
class CheckoutLicenseResult {
 public:
  ...
  inline void SetCheckoutType(CheckoutType value) {
    m_checkoutTypeHasBeenSet = true;
    m_checkoutType = value;
  }
  inline CheckoutLicenseResult& WithCheckoutType(CheckoutType value) {
  ...
  void SetEntitlementsAllowed(EntitlementsAllowedT&& value) {
    ...
    m_entitlementsAllowed = std::forward<EntitlementsAllowedT>(value);
  }
  template <typename EntitlementsAllowedT = Aws::Vector<EntitlementData>>
  CheckoutLicenseResult& WithEntitlementsAllowed(EntitlementsAllowedT&& value) {
    SetEntitlementsAllowed(std::forward<EntitlementsAllowedT>(value));
    return *this;
  }
  ...
  CheckoutLicenseResult& AddEntitlementsAllowed(EntitlementsAllowedT&& value) {
    m_entitlementsAllowedHasBeenSet = true;
    m_entitlementsAllowed.emplace_back(std::forward<EntitlementsAllowedT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSignedToken(SignedTokenT&& value) {
    ...
    m_signedToken = std::forward<SignedTokenT>(value);
  }
  template <typename SignedTokenT = Aws::String>
  CheckoutLicenseResult& WithSignedToken(SignedTokenT&& value) {
    SetSignedToken(std::forward<SignedTokenT>(value));
    return *this;
  }
  ///@}
