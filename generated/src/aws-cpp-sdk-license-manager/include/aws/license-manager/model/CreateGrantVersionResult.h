...
namespace Model
{
  ...
  public:
    ...
    template<typename GrantArnT = Aws::String>
    CreateGrantVersionResult& WithGrantArn(GrantArnT&& value) { SetGrantArn(std::forward<GrantArnT>(value)); return *this;}
    ///@}
    ...
    inline CreateGrantVersionResult& WithStatus(GrantStatus value) { SetStatus(value); return *this;}
    ///@}
    ...
    template<typename VersionT = Aws::String>
    CreateGrantVersionResult& WithVersion(VersionT&& value) { SetVersion(std::forward<VersionT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateGrantVersionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
