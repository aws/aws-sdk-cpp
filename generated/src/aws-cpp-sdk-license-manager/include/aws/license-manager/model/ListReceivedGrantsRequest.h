...
class ListReceivedGrantsRequest : public LicenseManagerRequest {
 public:
  AWS_LICENSEMANAGER_API ListReceivedGrantsRequest() = default;
  ...
  template <typename GrantArnsT = Aws::Vector<Aws::String>>
  ListReceivedGrantsRequest& WithGrantArns(GrantArnsT&& value) {
    SetGrantArns(std::forward<GrantArnsT>(value));
    return *this;
  }
  template <typename GrantArnsT = Aws::String>
  ListReceivedGrantsRequest& AddGrantArns(GrantArnsT&& value) {
    m_grantArnsHasBeenSet = true;
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  ListReceivedGrantsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  ListReceivedGrantsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListReceivedGrantsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListReceivedGrantsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
