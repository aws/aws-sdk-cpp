...
class BorrowConfiguration {
 public:
  ...
  inline void SetAllowEarlyCheckIn(bool value) {
    m_allowEarlyCheckInHasBeenSet = true;
    m_allowEarlyCheckIn = value;
  }
  inline BorrowConfiguration& WithAllowEarlyCheckIn(bool value) {
    SetAllowEarlyCheckIn(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxTimeToLiveInMinutes(int value) {
    m_maxTimeToLiveInMinutesHasBeenSet = true;
    m_maxTimeToLiveInMinutes = value;
  }
  inline BorrowConfiguration& WithMaxTimeToLiveInMinutes(int value) {
    SetMaxTimeToLiveInMinutes(value);
    return *this;
  }
  ///@}
 private:
