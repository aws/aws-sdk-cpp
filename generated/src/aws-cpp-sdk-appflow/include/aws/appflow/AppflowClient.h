...
class AWS_APPFLOW_API AppflowClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  AppflowClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<AppflowEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * A Callable wrapper for CancelFlowExecutions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CancelFlowExecutions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CancelFlowExecutionsRequestT = Model::CancelFlowExecutionsRequest>
  void CancelFlowExecutionsAsync(const CancelFlowExecutionsRequestT& request, const CancelFlowExecutionsResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for CreateConnectorProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateConnectorProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateConnectorProfileRequestT = Model::CreateConnectorProfileRequest>
  void CreateConnectorProfileAsync(const CreateConnectorProfileRequestT& request,
                                   const CreateConnectorProfileResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteConnectorProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteConnectorProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteConnectorProfileRequestT = Model::DeleteConnectorProfileRequest>
  void DeleteConnectorProfileAsync(const DeleteConnectorProfileRequestT& request,
                                   const DeleteConnectorProfileResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeConnectorEntity that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeConnectorEntity that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeConnectorEntityRequestT = Model::DescribeConnectorEntityRequest>
  void DescribeConnectorEntityAsync(const DescribeConnectorEntityRequestT& request,
                                    const DescribeConnectorEntityResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::DescribeConnectorProfilesOutcome DescribeConnectorProfiles(
      const Model::DescribeConnectorProfilesRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeConnectorProfiles that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeConnectorProfilesRequestT = Model::DescribeConnectorProfilesRequest>
  Model::DescribeConnectorProfilesOutcomeCallable DescribeConnectorProfilesCallable(
      const DescribeConnectorProfilesRequestT& request = {}) const {
    return SubmitCallable(&AppflowClient::DescribeConnectorProfiles, request);
  }

  /**
   * An Async wrapper for DescribeConnectorProfiles that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeConnectorProfilesRequestT = Model::DescribeConnectorProfilesRequest>
  void DescribeConnectorProfilesAsync(const DescribeConnectorProfilesResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for DescribeConnectors that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeConnectors that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeConnectorsRequestT = Model::DescribeConnectorsRequest>
  void DescribeConnectorsAsync(const DescribeConnectorsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const DescribeConnectorsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeFlowExecutionRecordsOutcome DescribeFlowExecutionRecords(
      const Model::DescribeFlowExecutionRecordsRequest& request) const;

  /**
   * A Callable wrapper for DescribeFlowExecutionRecords that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeFlowExecutionRecordsRequestT = Model::DescribeFlowExecutionRecordsRequest>
  Model::DescribeFlowExecutionRecordsOutcomeCallable DescribeFlowExecutionRecordsCallable(
      const DescribeFlowExecutionRecordsRequestT& request) const {
    return SubmitCallable(&AppflowClient::DescribeFlowExecutionRecords, request);
  }

  /**
   * An Async wrapper for DescribeFlowExecutionRecords that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeFlowExecutionRecordsRequestT = Model::DescribeFlowExecutionRecordsRequest>
  void DescribeFlowExecutionRecordsAsync(const DescribeFlowExecutionRecordsRequestT& request,
                                         const DescribeFlowExecutionRecordsResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListConnectorEntities that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListConnectorEntities that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListConnectorEntitiesRequestT = Model::ListConnectorEntitiesRequest>
  void ListConnectorEntitiesAsync(const ListConnectorEntitiesResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const ListConnectorEntitiesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for RegisterConnector that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RegisterConnector that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename RegisterConnectorRequestT = Model::RegisterConnectorRequest>
  void RegisterConnectorAsync(const RegisterConnectorResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const RegisterConnectorRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ResetConnectorMetadataCacheOutcome ResetConnectorMetadataCache(
      const Model::ResetConnectorMetadataCacheRequest& request = {}) const;

  /**
   * A Callable wrapper for ResetConnectorMetadataCache that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ResetConnectorMetadataCacheRequestT = Model::ResetConnectorMetadataCacheRequest>
  Model::ResetConnectorMetadataCacheOutcomeCallable ResetConnectorMetadataCacheCallable(
      const ResetConnectorMetadataCacheRequestT& request = {}) const {
    return SubmitCallable(&AppflowClient::ResetConnectorMetadataCache, request);
  }

  /**
   * An Async wrapper for ResetConnectorMetadataCache that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ResetConnectorMetadataCacheRequestT = Model::ResetConnectorMetadataCacheRequest>
  void ResetConnectorMetadataCacheAsync(const ResetConnectorMetadataCacheResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                        const ResetConnectorMetadataCacheRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for UnregisterConnector that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UnregisterConnector that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UnregisterConnectorRequestT = Model::UnregisterConnectorRequest>
  void UnregisterConnectorAsync(const UnregisterConnectorRequestT& request, const UnregisterConnectorResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateConnectorProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateConnectorProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateConnectorProfileRequestT = Model::UpdateConnectorProfileRequest>
  void UpdateConnectorProfileAsync(const UpdateConnectorProfileRequestT& request,
                                   const UpdateConnectorProfileResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateConnectorRegistrationOutcome UpdateConnectorRegistration(
      const Model::UpdateConnectorRegistrationRequest& request) const;

  /**
   * A Callable wrapper for UpdateConnectorRegistration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateConnectorRegistrationRequestT = Model::UpdateConnectorRegistrationRequest>
  Model::UpdateConnectorRegistrationOutcomeCallable UpdateConnectorRegistrationCallable(
      const UpdateConnectorRegistrationRequestT& request) const {
    return SubmitCallable(&AppflowClient::UpdateConnectorRegistration, request);
  }

  /**
   * An Async wrapper for UpdateConnectorRegistration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateConnectorRegistrationRequestT = Model::UpdateConnectorRegistrationRequest>
  void UpdateConnectorRegistrationAsync(const UpdateConnectorRegistrationRequestT& request,
                                        const UpdateConnectorRegistrationResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
