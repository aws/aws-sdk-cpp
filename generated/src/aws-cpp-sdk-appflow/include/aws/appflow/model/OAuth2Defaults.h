...
class OAuth2Defaults {
 public:
  ...
  void SetTokenUrls(TokenUrlsT&& value) {
    ...
    m_tokenUrls = std::forward<TokenUrlsT>(value);
  }
  template <typename TokenUrlsT = Aws::Vector<Aws::String>>
  OAuth2Defaults& WithTokenUrls(TokenUrlsT&& value) {
    SetTokenUrls(std::forward<TokenUrlsT>(value));
    return *this;
  }
  template <typename TokenUrlsT = Aws::String>
  OAuth2Defaults& AddTokenUrls(TokenUrlsT&& value) {
    m_tokenUrlsHasBeenSet = true;
    m_tokenUrls.emplace_back(std::forward<TokenUrlsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAuthCodeUrls(AuthCodeUrlsT&& value) {
    ...
    m_authCodeUrls = std::forward<AuthCodeUrlsT>(value);
  }
  template <typename AuthCodeUrlsT = Aws::Vector<Aws::String>>
  OAuth2Defaults& WithAuthCodeUrls(AuthCodeUrlsT&& value) {
    SetAuthCodeUrls(std::forward<AuthCodeUrlsT>(value));
    return *this;
  }
  template <typename AuthCodeUrlsT = Aws::String>
  OAuth2Defaults& AddAuthCodeUrls(AuthCodeUrlsT&& value) {
    m_authCodeUrlsHasBeenSet = true;
    m_authCodeUrls.emplace_back(std::forward<AuthCodeUrlsT>(value));
    return *this;
  }
  ///@}
  ...
  inline OAuth2Defaults& AddOauth2GrantTypesSupported(OAuth2GrantType value) {
    m_oauth2GrantTypesSupportedHasBeenSet = true;
  ...
  void SetOauth2CustomProperties(Oauth2CustomPropertiesT&& value) {
    ...
    m_oauth2CustomProperties = std::forward<Oauth2CustomPropertiesT>(value);
  }
  template <typename Oauth2CustomPropertiesT = Aws::Vector<OAuth2CustomParameter>>
  OAuth2Defaults& WithOauth2CustomProperties(Oauth2CustomPropertiesT&& value) {
    SetOauth2CustomProperties(std::forward<Oauth2CustomPropertiesT>(value));
    return *this;
  }
  ...
  OAuth2Defaults& AddOauth2CustomProperties(Oauth2CustomPropertiesT&& value) {
    m_oauth2CustomPropertiesHasBeenSet = true;
    m_oauth2CustomProperties.emplace_back(std::forward<Oauth2CustomPropertiesT>(value));
    return *this;
  }
  ///@}
 private:
