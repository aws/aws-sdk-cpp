...
class ScheduledTriggerProperties {
 public:
  ...
  inline void SetDataPullMode(DataPullMode value) {
    m_dataPullModeHasBeenSet = true;
    m_dataPullMode = value;
  }
  inline ScheduledTriggerProperties& WithDataPullMode(DataPullMode value) {
    SetDataPullMode(value);
    return *this;
  }
  ///@}
  ...
  void SetScheduleStartTime(ScheduleStartTimeT&& value) {
    ...
    m_scheduleStartTime = std::forward<ScheduleStartTimeT>(value);
  }
  template <typename ScheduleStartTimeT = Aws::Utils::DateTime>
  ScheduledTriggerProperties& WithScheduleStartTime(ScheduleStartTimeT&& value) {
    SetScheduleStartTime(std::forward<ScheduleStartTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetScheduleEndTime(ScheduleEndTimeT&& value) {
    ...
    m_scheduleEndTime = std::forward<ScheduleEndTimeT>(value);
  }
  template <typename ScheduleEndTimeT = Aws::Utils::DateTime>
  ScheduledTriggerProperties& WithScheduleEndTime(ScheduleEndTimeT&& value) {
    SetScheduleEndTime(std::forward<ScheduleEndTimeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetScheduleOffset(long long value) {
    m_scheduleOffsetHasBeenSet = true;
    m_scheduleOffset = value;
  }
  inline ScheduledTriggerProperties& WithScheduleOffset(long long value) {
  ...
  inline void SetFlowErrorDeactivationThreshold(int value) {
    m_flowErrorDeactivationThresholdHasBeenSet = true;
    m_flowErrorDeactivationThreshold = value;
  }
  inline ScheduledTriggerProperties& WithFlowErrorDeactivationThreshold(int value) {
    SetFlowErrorDeactivationThreshold(value);
    return *this;
  }
  ///@}
 private:
