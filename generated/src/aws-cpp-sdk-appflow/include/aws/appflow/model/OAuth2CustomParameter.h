...
class OAuth2CustomParameter {
 public:
  ...
  inline OAuth2CustomParameter& WithIsRequired(bool value) {
    SetIsRequired(value);
    return *this;
  }
  ///@}
  ...
  inline OAuth2CustomParameter& WithIsSensitiveField(bool value) {
  ...
  inline void SetType(OAuth2CustomPropType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline OAuth2CustomParameter& WithType(OAuth2CustomPropType value) {
    SetType(value);
    return *this;
  }
  ///@}
