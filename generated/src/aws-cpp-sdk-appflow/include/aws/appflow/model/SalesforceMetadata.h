...
class SalesforceMetadata {
 public:
  ...
  SalesforceMetadata& AddOAuthScopes(OAuthScopesT&& value) {
    m_oAuthScopesHasBeenSet = true;
    m_oAuthScopes.emplace_back(std::forward<OAuthScopesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDataTransferApis(DataTransferApisT&& value) {
    ...
    m_dataTransferApis = std::forward<DataTransferApisT>(value);
  }
  template <typename DataTransferApisT = Aws::Vector<SalesforceDataTransferApi>>
  SalesforceMetadata& WithDataTransferApis(DataTransferApisT&& value) {
    SetDataTransferApis(std::forward<DataTransferApisT>(value));
    return *this;
  }
  inline SalesforceMetadata& AddDataTransferApis(SalesforceDataTransferApi value) {
    m_dataTransferApisHasBeenSet = true;
    m_dataTransferApis.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetOauth2GrantTypesSupported(Oauth2GrantTypesSupportedT&& value) {
    ...
    m_oauth2GrantTypesSupported = std::forward<Oauth2GrantTypesSupportedT>(value);
  }
  template <typename Oauth2GrantTypesSupportedT = Aws::Vector<OAuth2GrantType>>
  SalesforceMetadata& WithOauth2GrantTypesSupported(Oauth2GrantTypesSupportedT&& value) {
    SetOauth2GrantTypesSupported(std::forward<Oauth2GrantTypesSupportedT>(value));
    return *this;
  }
  inline SalesforceMetadata& AddOauth2GrantTypesSupported(OAuth2GrantType value) {
    m_oauth2GrantTypesSupportedHasBeenSet = true;
    m_oauth2GrantTypesSupported.push_back(value);
    return *this;
  }
  ///@}
 private:
