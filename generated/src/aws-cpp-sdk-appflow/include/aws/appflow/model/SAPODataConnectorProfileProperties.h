...
class SAPODataConnectorProfileProperties {
 public:
  ...
  void SetApplicationHostUrl(ApplicationHostUrlT&& value) {
    m_applicationHostUrlHasBeenSet = true;
    m_applicationHostUrl = std::forward<ApplicationHostUrlT>(value);
  }
  template <typename ApplicationHostUrlT = Aws::String>
  SAPODataConnectorProfileProperties& WithApplicationHostUrl(ApplicationHostUrlT&& value) {
    SetApplicationHostUrl(std::forward<ApplicationHostUrlT>(value));
    return *this;
  }
  ///@}
  ...
  void SetApplicationServicePath(ApplicationServicePathT&& value) {
    m_applicationServicePathHasBeenSet = true;
    m_applicationServicePath = std::forward<ApplicationServicePathT>(value);
  }
  template <typename ApplicationServicePathT = Aws::String>
  SAPODataConnectorProfileProperties& WithApplicationServicePath(ApplicationServicePathT&& value) {
    SetApplicationServicePath(std::forward<ApplicationServicePathT>(value));
    return *this;
  }
  ///@}
  ...
  inline SAPODataConnectorProfileProperties& WithPortNumber(int value) {
    SetPortNumber(value);
    return *this;
  }
  ///@}
  ...
  void SetClientNumber(ClientNumberT&& value) {
    m_clientNumberHasBeenSet = true;
    m_clientNumber = std::forward<ClientNumberT>(value);
  }
  template <typename ClientNumberT = Aws::String>
  SAPODataConnectorProfileProperties& WithClientNumber(ClientNumberT&& value) {
    SetClientNumber(std::forward<ClientNumberT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLogonLanguage(LogonLanguageT&& value) {
    m_logonLanguageHasBeenSet = true;
    m_logonLanguage = std::forward<LogonLanguageT>(value);
  }
  template <typename LogonLanguageT = Aws::String>
  SAPODataConnectorProfileProperties& WithLogonLanguage(LogonLanguageT&& value) {
    SetLogonLanguage(std::forward<LogonLanguageT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename PrivateLinkServiceNameT = Aws::String>
  SAPODataConnectorProfileProperties& WithPrivateLinkServiceName(PrivateLinkServiceNameT&& value) {
  ...
  void SetOAuthProperties(OAuthPropertiesT&& value) {
    m_oAuthPropertiesHasBeenSet = true;
    m_oAuthProperties = std::forward<OAuthPropertiesT>(value);
  }
  template <typename OAuthPropertiesT = OAuthProperties>
  SAPODataConnectorProfileProperties& WithOAuthProperties(OAuthPropertiesT&& value) {
    SetOAuthProperties(std::forward<OAuthPropertiesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetDisableSSO(bool value) {
    m_disableSSOHasBeenSet = true;
    m_disableSSO = value;
  }
  inline SAPODataConnectorProfileProperties& WithDisableSSO(bool value) {
    SetDisableSSO(value);
    return *this;
  }
  ///@}
