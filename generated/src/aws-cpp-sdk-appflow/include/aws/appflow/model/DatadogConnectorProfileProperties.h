...
namespace Model
{
  ...
  {
  public:
    AWS_APPFLOW_API DatadogConnectorProfileProperties() = default;
    ...
    template<typename InstanceUrlT = Aws::String>
    DatadogConnectorProfileProperties& WithInstanceUrl(InstanceUrlT&& value) { SetInstanceUrl(std::forward<InstanceUrlT>(value)); return *this;}
    ///@}
  private:
