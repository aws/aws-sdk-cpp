...
class UpdateConnectorRegistrationResult {
 public:
  AWS_APPFLOW_API UpdateConnectorRegistrationResult() = default;
  ...
  template <typename ConnectorArnT = Aws::String>
  UpdateConnectorRegistrationResult& WithConnectorArn(ConnectorArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateConnectorRegistrationResult& WithRequestId(RequestIdT&& value) {
