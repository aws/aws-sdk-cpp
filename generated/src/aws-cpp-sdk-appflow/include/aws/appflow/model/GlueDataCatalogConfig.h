...
class GlueDataCatalogConfig {
 public:
  ...
  template <typename RoleArnT = Aws::String>
  GlueDataCatalogConfig& WithRoleArn(RoleArnT&& value) {
  ...
  template <typename DatabaseNameT = Aws::String>
  GlueDataCatalogConfig& WithDatabaseName(DatabaseNameT&& value) {
  ...
  template <typename TablePrefixT = Aws::String>
  GlueDataCatalogConfig& WithTablePrefix(TablePrefixT&& value) {
