...
namespace Model
{
  ...
  /**
   * <p> The connector-specific profile properties required when using Trend Micro.
   * </p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/appflow-2020-08-23/TrendmicroConnectorProfileProperties">AWS
   * API Reference</a></p>
   */
