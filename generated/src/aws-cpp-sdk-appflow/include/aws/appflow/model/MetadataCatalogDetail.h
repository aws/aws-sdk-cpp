...
class MetadataCatalogDetail {
 public:
  ...
  inline void SetCatalogType(CatalogType value) {
    m_catalogTypeHasBeenSet = true;
    m_catalogType = value;
  }
  inline MetadataCatalogDetail& WithCatalogType(CatalogType value) {
  ...
  void SetTableRegistrationOutput(TableRegistrationOutputT&& value) {
    ...
    m_tableRegistrationOutput = std::forward<TableRegistrationOutputT>(value);
  }
  template <typename TableRegistrationOutputT = RegistrationOutput>
  MetadataCatalogDetail& WithTableRegistrationOutput(TableRegistrationOutputT&& value) {
    SetTableRegistrationOutput(std::forward<TableRegistrationOutputT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPartitionRegistrationOutput(PartitionRegistrationOutputT&& value) {
    ...
    m_partitionRegistrationOutput = std::forward<PartitionRegistrationOutputT>(value);
  }
  template <typename PartitionRegistrationOutputT = RegistrationOutput>
  MetadataCatalogDetail& WithPartitionRegistrationOutput(PartitionRegistrationOutputT&& value) {
    SetPartitionRegistrationOutput(std::forward<PartitionRegistrationOutputT>(value));
    return *this;
  }
  ///@}
 private:
