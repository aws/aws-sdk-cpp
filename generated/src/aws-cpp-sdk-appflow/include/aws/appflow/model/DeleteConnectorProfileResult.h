...
namespace Model
{
  ...
  {
  public:
    AWS_APPFLOW_API DeleteConnectorProfileResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteConnectorProfileResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
