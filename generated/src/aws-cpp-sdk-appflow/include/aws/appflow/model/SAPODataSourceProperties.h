...
class SAPODataSourceProperties {
 public:
  ...
  template <typename ObjectPathT = Aws::String>
  SAPODataSourceProperties& WithObjectPath(ObjectPathT&& value) {
  ...
  void SetParallelismConfig(ParallelismConfigT&& value) {
    m_parallelismConfigHasBeenSet = true;
    m_parallelismConfig = std::forward<ParallelismConfigT>(value);
  }
  template <typename ParallelismConfigT = SAPODataParallelismConfig>
  SAPODataSourceProperties& WithParallelismConfig(ParallelismConfigT&& value) {
    SetParallelismConfig(std::forward<ParallelismConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPaginationConfig(PaginationConfigT&& value) {
    m_paginationConfigHasBeenSet = true;
    m_paginationConfig = std::forward<PaginationConfigT>(value);
  }
  template <typename PaginationConfigT = SAPODataPaginationConfig>
  SAPODataSourceProperties& WithPaginationConfig(PaginationConfigT&& value) {
    SetPaginationConfig(std::forward<PaginationConfigT>(value));
    return *this;
  }
  ///@}
 private:
