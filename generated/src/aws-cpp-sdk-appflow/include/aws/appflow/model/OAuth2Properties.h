...
class OAuth2Properties {
 public:
  ...
  void SetTokenUrlCustomProperties(TokenUrlCustomPropertiesT&& value) {
    ...
    m_tokenUrlCustomProperties = std::forward<TokenUrlCustomPropertiesT>(value);
  }
  template <typename TokenUrlCustomPropertiesT = Aws::Map<Aws::String, Aws::String>>
  OAuth2Properties& WithTokenUrlCustomProperties(TokenUrlCustomPropertiesT&& value) {
    SetTokenUrlCustomProperties(std::forward<TokenUrlCustomPropertiesT>(value));
    return *this;
  }
  ...
  OAuth2Properties& AddTokenUrlCustomProperties(TokenUrlCustomPropertiesKeyT&& key, TokenUrlCustomPropertiesValueT&& value) {
    m_tokenUrlCustomPropertiesHasBeenSet = true;
    m_tokenUrlCustomProperties.emplace(std::forward<TokenUrlCustomPropertiesKeyT>(key),
                                       std::forward<TokenUrlCustomPropertiesValueT>(value));
    return *this;
  }
  ///@}
 private:
