...
namespace Model
{
  ...
  {
  public:
    AWS_APPFLOW_API UpdateConnectorProfileResult() = default;
    ...
    template<typename ConnectorProfileArnT = Aws::String>
    UpdateConnectorProfileResult& WithConnectorProfileArn(ConnectorProfileArnT&& value) { SetConnectorProfileArn(std::forward<ConnectorProfileArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateConnectorProfileResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
