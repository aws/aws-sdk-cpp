...
class DestinationFieldProperties {
 public:
  ...
  inline void SetIsCreatable(bool value) {
    m_isCreatableHasBeenSet = true;
    m_isCreatable = value;
  }
  inline DestinationFieldProperties& WithIsCreatable(bool value) {
    SetIsCreatable(value);
    return *this;
  }
  ///@}
  ...
  inline DestinationFieldProperties& WithIsNullable(bool value) {
    SetIsNullable(value);
    return *this;
  }
  ///@}
  ...
  inline DestinationFieldProperties& WithIsUpsertable(bool value) {
  ...
  inline DestinationFieldProperties& WithIsUpdatable(bool value) {
  ...
  inline void SetIsDefaultedOnCreate(bool value) {
    m_isDefaultedOnCreateHasBeenSet = true;
    m_isDefaultedOnCreate = value;
  }
  inline DestinationFieldProperties& WithIsDefaultedOnCreate(bool value) {
    SetIsDefaultedOnCreate(value);
    return *this;
  }
  ///@}
  ...
  void SetSupportedWriteOperations(SupportedWriteOperationsT&& value) {
    ...
    m_supportedWriteOperations = std::forward<SupportedWriteOperationsT>(value);
  }
  template <typename SupportedWriteOperationsT = Aws::Vector<WriteOperationType>>
  DestinationFieldProperties& WithSupportedWriteOperations(SupportedWriteOperationsT&& value) {
    SetSupportedWriteOperations(std::forward<SupportedWriteOperationsT>(value));
    return *this;
  }
  inline DestinationFieldProperties& AddSupportedWriteOperations(WriteOperationType value) {
    m_supportedWriteOperationsHasBeenSet = true;
    m_supportedWriteOperations.push_back(value);
    return *this;
  }
  ///@}
 private:
