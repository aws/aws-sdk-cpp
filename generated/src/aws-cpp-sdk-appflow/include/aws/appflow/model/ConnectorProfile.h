...
class ConnectorProfile {
 public:
  ...
  void SetConnectorProfileArn(ConnectorProfileArnT&& value) {
    ...
    m_connectorProfileArn = std::forward<ConnectorProfileArnT>(value);
  }
  template <typename ConnectorProfileArnT = Aws::String>
  ConnectorProfile& WithConnectorProfileArn(ConnectorProfileArnT&& value) {
    SetConnectorProfileArn(std::forward<ConnectorProfileArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline ConnectorProfile& WithConnectorType(ConnectorType value) {
  ...
  inline ConnectorProfile& WithConnectionMode(ConnectionMode value) {
  ...
  void SetConnectorProfileProperties(ConnectorProfilePropertiesT&& value) {
    ...
    m_connectorProfileProperties = std::forward<ConnectorProfilePropertiesT>(value);
  }
  template <typename ConnectorProfilePropertiesT = ConnectorProfileProperties>
  ConnectorProfile& WithConnectorProfileProperties(ConnectorProfilePropertiesT&& value) {
    SetConnectorProfileProperties(std::forward<ConnectorProfilePropertiesT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const PrivateConnectionProvisioningState& GetPrivateConnectionProvisioningState() const {
    return m_privateConnectionProvisioningState;
  }
  ...
  void SetPrivateConnectionProvisioningState(PrivateConnectionProvisioningStateT&& value) {
    ...
    m_privateConnectionProvisioningState = std::forward<PrivateConnectionProvisioningStateT>(value);
  }
  template <typename PrivateConnectionProvisioningStateT = PrivateConnectionProvisioningState>
  ConnectorProfile& WithPrivateConnectionProvisioningState(PrivateConnectionProvisioningStateT&& value) {
    SetPrivateConnectionProvisioningState(std::forward<PrivateConnectionProvisioningStateT>(value));
    return *this;
  }
  ///@}
 private:
