...
class CustomConnectorProfileCredentials {
 public:
  ...
  inline CustomConnectorProfileCredentials& WithAuthenticationType(AuthenticationType value) {
  ...
  void SetBasic(BasicT&& value) {
    ...
    m_basic = std::forward<BasicT>(value);
  }
  template <typename BasicT = BasicAuthCredentials>
  CustomConnectorProfileCredentials& WithBasic(BasicT&& value) {
    SetBasic(std::forward<BasicT>(value));
    return *this;
  }
  ///@}
