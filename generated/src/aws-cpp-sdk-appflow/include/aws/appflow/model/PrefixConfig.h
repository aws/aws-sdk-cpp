...
class PrefixConfig {
 public:
  ...
  inline void SetPrefixType(PrefixType value) {
    m_prefixTypeHasBeenSet = true;
    m_prefixType = value;
  }
  inline PrefixConfig& WithPrefixType(PrefixType value) {
    SetPrefixType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPrefixFormat(PrefixFormat value) {
    m_prefixFormatHasBeenSet = true;
    m_prefixFormat = value;
  }
  inline PrefixConfig& WithPrefixFormat(PrefixFormat value) {
    SetPrefixFormat(value);
    return *this;
  }
  ///@}
  ...
  void SetPathPrefixHierarchy(PathPrefixHierarchyT&& value) {
    ...
    m_pathPrefixHierarchy = std::forward<PathPrefixHierarchyT>(value);
  }
  template <typename PathPrefixHierarchyT = Aws::Vector<PathPrefix>>
  PrefixConfig& WithPathPrefixHierarchy(PathPrefixHierarchyT&& value) {
    SetPathPrefixHierarchy(std::forward<PathPrefixHierarchyT>(value));
    return *this;
  }
  inline PrefixConfig& AddPathPrefixHierarchy(PathPrefix value) {
    m_pathPrefixHierarchyHasBeenSet = true;
    m_pathPrefixHierarchy.push_back(value);
    return *this;
  }
  ///@}
 private:
