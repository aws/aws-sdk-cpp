...
class DestinationFlowConfig {
 public:
  ...
  inline DestinationFlowConfig& WithConnectorType(ConnectorType value) {
  ...
  void SetDestinationConnectorProperties(DestinationConnectorPropertiesT&& value) {
    ...
    m_destinationConnectorProperties = std::forward<DestinationConnectorPropertiesT>(value);
  }
  template <typename DestinationConnectorPropertiesT = DestinationConnectorProperties>
  DestinationFlowConfig& WithDestinationConnectorProperties(DestinationConnectorPropertiesT&& value) {
    SetDestinationConnectorProperties(std::forward<DestinationConnectorPropertiesT>(value));
    return *this;
  }
  ///@}
 private:
