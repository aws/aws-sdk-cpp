...
namespace Model
{
  ...
  {
  public:
    AWS_APPFLOW_API UnregisterConnectorResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UnregisterConnectorResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
