...
class AuthenticationConfig {
 public:
  ...
  inline void SetIsBasicAuthSupported(bool value) {
    m_isBasicAuthSupportedHasBeenSet = true;
    m_isBasicAuthSupported = value;
  }
  inline AuthenticationConfig& WithIsBasicAuthSupported(bool value) {
    SetIsBasicAuthSupported(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIsApiKeyAuthSupported(bool value) {
    m_isApiKeyAuthSupportedHasBeenSet = true;
    m_isApiKeyAuthSupported = value;
  }
  inline AuthenticationConfig& WithIsApiKeyAuthSupported(bool value) {
    SetIsApiKeyAuthSupported(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIsOAuth2Supported(bool value) {
    m_isOAuth2SupportedHasBeenSet = true;
    m_isOAuth2Supported = value;
  }
  inline AuthenticationConfig& WithIsOAuth2Supported(bool value) {
    SetIsOAuth2Supported(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIsCustomAuthSupported(bool value) {
    m_isCustomAuthSupportedHasBeenSet = true;
    m_isCustomAuthSupported = value;
  }
  inline AuthenticationConfig& WithIsCustomAuthSupported(bool value) {
    SetIsCustomAuthSupported(value);
    return *this;
  }
  ///@}
  ...
  void SetOAuth2Defaults(OAuth2DefaultsT&& value) {
    ...
    m_oAuth2Defaults = std::forward<OAuth2DefaultsT>(value);
  }
  template <typename OAuth2DefaultsT = OAuth2Defaults>
  AuthenticationConfig& WithOAuth2Defaults(OAuth2DefaultsT&& value) {
    SetOAuth2Defaults(std::forward<OAuth2DefaultsT>(value));
    return *this;
  }
  ///@}
