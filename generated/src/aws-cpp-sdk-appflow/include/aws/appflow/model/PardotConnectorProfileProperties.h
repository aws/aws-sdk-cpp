...
class PardotConnectorProfileProperties {
 public:
  ...
  inline PardotConnectorProfileProperties& WithIsSandboxEnvironment(bool value) {
  ...
  void SetBusinessUnitId(BusinessUnitIdT&& value) {
    ...
    m_businessUnitId = std::forward<BusinessUnitIdT>(value);
  }
  template <typename BusinessUnitIdT = Aws::String>
  PardotConnectorProfileProperties& WithBusinessUnitId(BusinessUnitIdT&& value) {
    SetBusinessUnitId(std::forward<BusinessUnitIdT>(value));
    return *this;
  }
  ///@}
 private:
