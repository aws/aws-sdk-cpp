...
namespace Model
{
  ...
  {
  public:
    AWS_APPFLOW_API PardotSourceProperties();
     ...
     * <p>The object specified in the Salesforce Pardot flow source.</p>
     */
    inline PardotSourceProperties& WithObject(const Aws::String& value) { SetObject(value); return *this;}

    /**
     * <p>The object specified in the Salesforce Pardot flow source.</p>
     */
    inline PardotSourceProperties& WithObject(Aws::String&& value) { SetObject(std::move(value)); return *this;}

    /**
     * <p>The object specified in the Salesforce Pardot flow source.</p>
     */
    inline PardotSourceProperties& WithObject(const char* value) { SetObject(value); return *this;}
