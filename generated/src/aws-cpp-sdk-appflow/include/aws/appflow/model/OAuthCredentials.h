...
namespace Model
{
  ...
  public:
    ...
    template<typename ClientIdT = Aws::String>
    OAuthCredentials& WithClientId(ClientIdT&& value) { SetClientId(std::forward<ClientIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ClientSecretT = Aws::String>
    OAuthCredentials& WithClientSecret(ClientSecretT&& value) { SetClientSecret(std::forward<ClientSecretT>(value)); return *this;}
    ///@}
    ...
    template<typename AccessTokenT = Aws::String>
    OAuthCredentials& WithAccessToken(AccessTokenT&& value) { SetAccessToken(std::forward<AccessTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename RefreshTokenT = Aws::String>
    OAuthCredentials& WithRefreshToken(RefreshTokenT&& value) { SetRefreshToken(std::forward<RefreshTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename OAuthRequestT = ConnectorOAuthRequest>
    OAuthCredentials& WithOAuthRequest(OAuthRequestT&& value) { SetOAuthRequest(std::forward<OAuthRequestT>(value)); return *this;}
    ///@}
  private:
