...
class Task {
 public:
  ...
  void SetSourceFields(SourceFieldsT&& value) {
    ...
    m_sourceFields = std::forward<SourceFieldsT>(value);
  }
  template <typename SourceFieldsT = Aws::Vector<Aws::String>>
  Task& WithSourceFields(SourceFieldsT&& value) {
    SetSourceFields(std::forward<SourceFieldsT>(value));
    return *this;
  }
  template <typename SourceFieldsT = Aws::String>
  Task& AddSourceFields(SourceFieldsT&& value) {
    m_sourceFieldsHasBeenSet = true;
    m_sourceFields.emplace_back(std::forward<SourceFieldsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetConnectorOperator(ConnectorOperatorT&& value) {
    ...
    m_connectorOperator = std::forward<ConnectorOperatorT>(value);
  }
  template <typename ConnectorOperatorT = ConnectorOperator>
  Task& WithConnectorOperator(ConnectorOperatorT&& value) {
    SetConnectorOperator(std::forward<ConnectorOperatorT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDestinationField(DestinationFieldT&& value) {
    ...
    m_destinationField = std::forward<DestinationFieldT>(value);
  }
  template <typename DestinationFieldT = Aws::String>
  Task& WithDestinationField(DestinationFieldT&& value) {
    SetDestinationField(std::forward<DestinationFieldT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTaskProperties(TaskPropertiesT&& value) {
    ...
    m_taskProperties = std::forward<TaskPropertiesT>(value);
  }
  template <typename TaskPropertiesT = Aws::Map<OperatorPropertiesKeys, Aws::String>>
  Task& WithTaskProperties(TaskPropertiesT&& value) {
    SetTaskProperties(std::forward<TaskPropertiesT>(value));
    return *this;
  }
  inline Task& AddTaskProperties(OperatorPropertiesKeys key, Aws::String value) {
    m_taskPropertiesHasBeenSet = true;
    m_taskProperties.emplace(key, value);
    return *this;
  }
  ///@}
 private:
