...
class InforNexusConnectorProfileCredentials {
 public:
  ...
  template <typename AccessKeyIdT = Aws::String>
  InforNexusConnectorProfileCredentials& WithAccessKeyId(AccessKeyIdT&& value) {
  ...
  template <typename UserIdT = Aws::String>
  InforNexusConnectorProfileCredentials& WithUserId(UserIdT&& value) {
  ...
  template <typename SecretAccessKeyT = Aws::String>
  InforNexusConnectorProfileCredentials& WithSecretAccessKey(SecretAccessKeyT&& value) {
  ...
  void SetDatakey(DatakeyT&& value) {
    m_datakeyHasBeenSet = true;
    m_datakey = std::forward<DatakeyT>(value);
  }
  template <typename DatakeyT = Aws::String>
  InforNexusConnectorProfileCredentials& WithDatakey(DatakeyT&& value) {
    SetDatakey(std::forward<DatakeyT>(value));
    return *this;
  }
  ///@}
 private:
