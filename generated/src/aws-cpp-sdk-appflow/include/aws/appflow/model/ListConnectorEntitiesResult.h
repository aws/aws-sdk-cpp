...
class ListConnectorEntitiesResult {
 public:
  ...
  void SetConnectorEntityMap(ConnectorEntityMapT&& value) {
    m_connectorEntityMapHasBeenSet = true;
    m_connectorEntityMap = std::forward<ConnectorEntityMapT>(value);
  }
  template <typename ConnectorEntityMapT = Aws::Map<Aws::String, Aws::Vector<ConnectorEntity>>>
  ListConnectorEntitiesResult& WithConnectorEntityMap(ConnectorEntityMapT&& value) {
    SetConnectorEntityMap(std::forward<ConnectorEntityMapT>(value));
    return *this;
  }
  ...
  ListConnectorEntitiesResult& AddConnectorEntityMap(ConnectorEntityMapKeyT&& key, ConnectorEntityMapValueT&& value) {
    m_connectorEntityMapHasBeenSet = true;
    m_connectorEntityMap.emplace(std::forward<ConnectorEntityMapKeyT>(key), std::forward<ConnectorEntityMapValueT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListConnectorEntitiesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListConnectorEntitiesResult& WithRequestId(RequestIdT&& value) {
