...
namespace Model
{
  ...
  public:
    ...
    template<typename UsernameT = Aws::String>
    SnowflakeConnectorProfileCredentials& WithUsername(UsernameT&& value) { SetUsername(std::forward<UsernameT>(value)); return *this;}
    ///@}
    ...
    template<typename PasswordT = Aws::String>
    SnowflakeConnectorProfileCredentials& WithPassword(PasswordT&& value) { SetPassword(std::forward<PasswordT>(value)); return *this;}
    ///@}
  private:
