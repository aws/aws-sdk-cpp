...
class SalesforceConnectorProfileProperties {
 public:
  ...
  template <typename InstanceUrlT = Aws::String>
  SalesforceConnectorProfileProperties& WithInstanceUrl(InstanceUrlT&& value) {
  ...
  inline void SetIsSandboxEnvironment(bool value) {
    m_isSandboxEnvironmentHasBeenSet = true;
    m_isSandboxEnvironment = value;
  }
  inline SalesforceConnectorProfileProperties& WithIsSandboxEnvironment(bool value) {
    SetIsSandboxEnvironment(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUsePrivateLinkForMetadataAndAuthorization(bool value) {
    m_usePrivateLinkForMetadataAndAuthorizationHasBeenSet = true;
    m_usePrivateLinkForMetadataAndAuthorization = value;
  }
  inline SalesforceConnectorProfileProperties& WithUsePrivateLinkForMetadataAndAuthorization(bool value) {
    SetUsePrivateLinkForMetadataAndAuthorization(value);
    return *this;
  }
  ///@}
 private:
