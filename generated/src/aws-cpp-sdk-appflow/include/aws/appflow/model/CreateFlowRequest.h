...
class CreateFlowRequest : public AppflowRequest {
 public:
  ...
  void SetKmsArn(KmsArnT&& value) {
    ...
    m_kmsArn = std::forward<KmsArnT>(value);
  }
  template <typename KmsArnT = Aws::String>
  ...
  void SetTriggerConfig(TriggerConfigT&& value) {
    ...
    m_triggerConfig = std::forward<TriggerConfigT>(value);
  }
  template <typename TriggerConfigT = TriggerConfig>
  CreateFlowRequest& WithTriggerConfig(TriggerConfigT&& value) {
    SetTriggerConfig(std::forward<TriggerConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSourceFlowConfig(SourceFlowConfigT&& value) {
    ...
    m_sourceFlowConfig = std::forward<SourceFlowConfigT>(value);
  }
  template <typename SourceFlowConfigT = SourceFlowConfig>
  CreateFlowRequest& WithSourceFlowConfig(SourceFlowConfigT&& value) {
    SetSourceFlowConfig(std::forward<SourceFlowConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDestinationFlowConfigList(DestinationFlowConfigListT&& value) {
    ...
    m_destinationFlowConfigList = std::forward<DestinationFlowConfigListT>(value);
  }
  template <typename DestinationFlowConfigListT = Aws::Vector<DestinationFlowConfig>>
  CreateFlowRequest& WithDestinationFlowConfigList(DestinationFlowConfigListT&& value) {
    SetDestinationFlowConfigList(std::forward<DestinationFlowConfigListT>(value));
    return *this;
  }
  ...
  CreateFlowRequest& AddDestinationFlowConfigList(DestinationFlowConfigListT&& value) {
    m_destinationFlowConfigListHasBeenSet = true;
    m_destinationFlowConfigList.emplace_back(std::forward<DestinationFlowConfigListT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMetadataCatalogConfig(MetadataCatalogConfigT&& value) {
    ...
    m_metadataCatalogConfig = std::forward<MetadataCatalogConfigT>(value);
  }
  template <typename MetadataCatalogConfigT = MetadataCatalogConfig>
  CreateFlowRequest& WithMetadataCatalogConfig(MetadataCatalogConfigT&& value) {
    SetMetadataCatalogConfig(std::forward<MetadataCatalogConfigT>(value));
    return *this;
  }
  ///@}
