...
namespace Model
{
  ...
  public:
    ...
    template<typename ClientIdT = Aws::String>
    SlackConnectorProfileCredentials& WithClientId(ClientIdT&& value) { SetClientId(std::forward<ClientIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ClientSecretT = Aws::String>
    SlackConnectorProfileCredentials& WithClientSecret(ClientSecretT&& value) { SetClientSecret(std::forward<ClientSecretT>(value)); return *this;}
    ///@}
    ...
    template<typename AccessTokenT = Aws::String>
    SlackConnectorProfileCredentials& WithAccessToken(AccessTokenT&& value) { SetAccessToken(std::forward<AccessTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename OAuthRequestT = ConnectorOAuthRequest>
    SlackConnectorProfileCredentials& WithOAuthRequest(OAuthRequestT&& value) { SetOAuthRequest(std::forward<OAuthRequestT>(value)); return *this;}
    ///@}
  private:
