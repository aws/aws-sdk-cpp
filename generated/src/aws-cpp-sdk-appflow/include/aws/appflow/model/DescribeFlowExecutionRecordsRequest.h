...
class DescribeFlowExecutionRecordsRequest : public AppflowRequest {
 public:
  ...
  template <typename FlowNameT = Aws::String>
  DescribeFlowExecutionRecordsRequest& WithFlowName(FlowNameT&& value) {
  ...
  inline DescribeFlowExecutionRecordsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeFlowExecutionRecordsRequest& WithNextToken(NextTokenT&& value) {
