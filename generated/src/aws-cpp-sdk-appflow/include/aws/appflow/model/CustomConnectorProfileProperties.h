...
class CustomConnectorProfileProperties {
 public:
  ...
  void SetProfileProperties(ProfilePropertiesT&& value) {
    ...
    m_profileProperties = std::forward<ProfilePropertiesT>(value);
  }
  template <typename ProfilePropertiesT = Aws::Map<Aws::String, Aws::String>>
  CustomConnectorProfileProperties& WithProfileProperties(ProfilePropertiesT&& value) {
    SetProfileProperties(std::forward<ProfilePropertiesT>(value));
    return *this;
  }
  ...
  CustomConnectorProfileProperties& AddProfileProperties(ProfilePropertiesKeyT&& key, ProfilePropertiesValueT&& value) {
    m_profilePropertiesHasBeenSet = true;
    m_profileProperties.emplace(std::forward<ProfilePropertiesKeyT>(key), std::forward<ProfilePropertiesValueT>(value));
    return *this;
  }
  ///@}
