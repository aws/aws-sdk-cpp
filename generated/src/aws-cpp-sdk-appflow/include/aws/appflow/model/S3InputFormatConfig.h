...
class S3InputFormatConfig {
 public:
  ...
  inline void SetS3InputFileType(S3InputFileType value) {
    m_s3InputFileTypeHasBeenSet = true;
    m_s3InputFileType = value;
  }
  inline S3InputFormatConfig& WithS3InputFileType(S3InputFileType value) {
    SetS3InputFileType(value);
    return *this;
  }
  ///@}
 private:
