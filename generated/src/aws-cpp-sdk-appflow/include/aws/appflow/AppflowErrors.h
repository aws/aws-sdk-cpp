...
public:
  ...
  AppflowError(const Aws::Client::AWSError<AppflowErrors>& rhs) : Aws::Client::AWSError<AppflowErrors>(rhs) {}
  AppflowError(Aws::Client::AWSError<AppflowErrors>&& rhs) : Aws::Client::AWSError<AppflowErrors>(rhs) {}
