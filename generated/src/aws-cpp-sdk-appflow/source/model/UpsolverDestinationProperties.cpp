...
UpsolverDestinationProperties::UpsolverDestinationProperties(JsonView jsonValue) { *this = jsonValue; }

UpsolverDestinationProperties& UpsolverDestinationProperties::operator=(JsonView jsonValue) {
...
JsonValue UpsolverDestinationProperties::Jsonize() const {
  JsonValue payload;
