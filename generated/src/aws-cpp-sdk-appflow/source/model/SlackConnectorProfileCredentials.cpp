...
SlackConnectorProfileCredentials::SlackConnectorProfileCredentials(JsonView jsonValue) { *this = jsonValue; }

SlackConnectorProfileCredentials& SlackConnectorProfileCredentials::operator=(JsonView jsonValue) {
...
JsonValue SlackConnectorProfileCredentials::Jsonize() const {
  JsonValue payload;
