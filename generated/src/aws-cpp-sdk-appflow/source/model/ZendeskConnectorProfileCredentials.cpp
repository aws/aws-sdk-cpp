...
ZendeskConnectorProfileCredentials::ZendeskConnectorProfileCredentials(JsonView jsonValue) { *this = jsonValue; }

ZendeskConnectorProfileCredentials& ZendeskConnectorProfileCredentials::operator=(JsonView jsonValue) {
...
JsonValue ZendeskConnectorProfileCredentials::Jsonize() const {
  JsonValue payload;
