...
DescribeFlowResult& DescribeFlowResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("lastRunMetadataCatalogDetails")) {
    ...
    for (unsigned lastRunMetadataCatalogDetailsIndex = 0;
         lastRunMetadataCatalogDetailsIndex < lastRunMetadataCatalogDetailsJsonList.GetLength(); ++lastRunMetadataCatalogDetailsIndex) {
