...
namespace Appflow
{
const size_t AppflowEndpointRules::RulesBlobStrLen = 3728;
const size_t AppflowEndpointRules::RulesBlobSize = 3729;
...
'/','/','a','p','p','f','l','o','w','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{',
...
'u','r','l','"',':','"','h','t','t','p','s',':','/','/','a','p','p','f','l','o','w','.','{','R','e',
