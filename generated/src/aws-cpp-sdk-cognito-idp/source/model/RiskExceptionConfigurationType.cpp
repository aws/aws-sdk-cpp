...
RiskExceptionConfigurationType::RiskExceptionConfigurationType(JsonView jsonValue) { *this = jsonValue; }
...
RiskExceptionConfigurationType& RiskExceptionConfigurationType::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("BlockedIPRangeList")) {
    ...
    for (unsigned blockedIPRangeListIndex = 0; blockedIPRangeListIndex < blockedIPRangeListJsonList.GetLength();
         ++blockedIPRangeListIndex) {
  ...
  if (jsonValue.ValueExists("SkippedIPRangeList")) {
    ...
    for (unsigned skippedIPRangeListIndex = 0; skippedIPRangeListIndex < skippedIPRangeListJsonList.GetLength();
         ++skippedIPRangeListIndex) {
