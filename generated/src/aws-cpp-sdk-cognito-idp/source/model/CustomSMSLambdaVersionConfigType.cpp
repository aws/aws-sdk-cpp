...
CustomSMSLambdaVersionConfigType::CustomSMSLambdaVersionConfigType(JsonView jsonValue) { *this = jsonValue; }
...
CustomSMSLambdaVersionConfigType& CustomSMSLambdaVersionConfigType::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("LambdaVersion")) {
    m_lambdaVersion =
        CustomSMSSenderLambdaVersionTypeMapper::GetCustomSMSSenderLambdaVersionTypeForName(jsonValue.GetString("LambdaVersion"));
...
JsonValue CustomSMSLambdaVersionConfigType::Jsonize() const {
  ...
  if (m_lambdaVersionHasBeenSet) {
    payload.WithString("LambdaVersion",
                       CustomSMSSenderLambdaVersionTypeMapper::GetNameForCustomSMSSenderLambdaVersionType(m_lambdaVersion));
  }
