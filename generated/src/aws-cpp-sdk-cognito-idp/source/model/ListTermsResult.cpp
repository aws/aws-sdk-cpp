...
ListTermsResult::ListTermsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

ListTermsResult& ListTermsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
