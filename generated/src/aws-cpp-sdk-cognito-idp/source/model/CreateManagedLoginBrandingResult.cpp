...
CreateManagedLoginBrandingResult::CreateManagedLoginBrandingResult()
{
}

CreateManagedLoginBrandingResult::CreateManagedLoginBrandingResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
