...
{
const size_t CognitoIdentityProviderEndpointRules::RulesBlobStrLen = 3492;
const size_t CognitoIdentityProviderEndpointRules::RulesBlobSize = 3493;
...
'p','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o',
...
'"',':','"','h','t','t','p','s',':','/','/','c','o','g','n','i','t','o','-','i','d','p','-','f','i',
