...
'o','g','n','i','t','o','-','i','d','p','-','f','i','p','s','.','u','s','-','e','a','s','t','-','1',
...
'-','i','d','p','-','f','i','p','s','.','u','s','-','e','a','s','t','-','2','.','a','m','a','z','o',
...
'"',':','[','{','"','r','e','f','"',':','"','R','e','g','i','o','n','"','}',',','"','u','s','-','w',
'e','s','t','-','1','"',']','}',']',',','"','e','n','d','p','o','i','n','t','"',':','{','"','u','r',
'l','"',':','"','h','t','t','p','s',':','/','/','c','o','g','n','i','t','o','-','i','d','p','-','f',
'i','p','s','.','u','s','-','w','e','s','t','-','1','.','a','m','a','z','o','n','a','w','s','.','c',
...
't','p','s',':','/','/','c','o','g','n','i','t','o','-','i','d','p','-','f','i','p','s','.','u','s',
...
'd','p','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i',
...
's',':','/','/','c','o','g','n','i','t','o','-','i','d','p','.','{','R','e','g','i','o','n','}','.',
...
const char* CognitoIdentityProviderEndpointRules::GetRulesBlob()
{
