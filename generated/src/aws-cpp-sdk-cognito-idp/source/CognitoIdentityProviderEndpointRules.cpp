...
{
const size_t CognitoIdentityProviderEndpointRules::RulesBlobStrLen = 3474;
const size_t CognitoIdentityProviderEndpointRules::RulesBlobSize = 3475;
...
'o','-','i','d','p','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t',
...
'p','s',':','/','/','c','o','g','n','i','t','o','-','i','d','p','-','f','i','p','s','.','{','R','e',
