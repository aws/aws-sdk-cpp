...
class DeleteManagedLoginBrandingRequest : public CognitoIdentityProviderRequest {
 public:
  ...
  template <typename ManagedLoginBrandingIdT = Aws::String>
  DeleteManagedLoginBrandingRequest& WithManagedLoginBrandingId(ManagedLoginBrandingIdT&& value) {
  ...
  template <typename UserPoolIdT = Aws::String>
  DeleteManagedLoginBrandingRequest& WithUserPoolId(UserPoolIdT&& value) {
