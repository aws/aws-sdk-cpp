...
namespace Model
{
  ...
  public:
    ...
    template<typename UserPoolIdT = Aws::String>
    AdminSetUserSettingsRequest& WithUserPoolId(UserPoolIdT&& value) { SetUserPoolId(std::forward<UserPoolIdT>(value)); return *this;}
    ///@}
    ...
    template<typename UsernameT = Aws::String>
    AdminSetUserSettingsRequest& WithUsername(UsernameT&& value) { SetUsername(std::forward<UsernameT>(value)); return *this;}
    ///@}
    ...
    template<typename MFAOptionsT = Aws::Vector<MFAOptionType>>
    AdminSetUserSettingsRequest& WithMFAOptions(MFAOptionsT&& value) { SetMFAOptions(std::forward<MFAOptionsT>(value)); return *this;}
    template<typename MFAOptionsT = MFAOptionType>
    AdminSetUserSettingsRequest& AddMFAOptions(MFAOptionsT&& value) { m_mFAOptionsHasBeenSet = true; m_mFAOptions.emplace_back(std::forward<MFAOptionsT>(value)); return *this; }
    ///@}
  private:
