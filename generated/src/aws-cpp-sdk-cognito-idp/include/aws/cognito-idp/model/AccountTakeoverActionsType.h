...
class AccountTakeoverActionsType {
 public:
  ...
  void SetLowAction(LowActionT&& value) {
    m_lowActionHasBeenSet = true;
    m_lowAction = std::forward<LowActionT>(value);
  }
  template <typename LowActionT = AccountTakeoverActionType>
  AccountTakeoverActionsType& WithLowAction(LowActionT&& value) {
    SetLowAction(std::forward<LowActionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMediumAction(MediumActionT&& value) {
    m_mediumActionHasBeenSet = true;
    m_mediumAction = std::forward<MediumActionT>(value);
  }
  template <typename MediumActionT = AccountTakeoverActionType>
  AccountTakeoverActionsType& WithMediumAction(MediumActionT&& value) {
    SetMediumAction(std::forward<MediumActionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetHighAction(HighActionT&& value) {
    m_highActionHasBeenSet = true;
    m_highAction = std::forward<HighActionT>(value);
  }
  template <typename HighActionT = AccountTakeoverActionType>
  AccountTakeoverActionsType& WithHighAction(HighActionT&& value) {
    SetHighAction(std::forward<HighActionT>(value));
    return *this;
  }
  ///@}
 private:
