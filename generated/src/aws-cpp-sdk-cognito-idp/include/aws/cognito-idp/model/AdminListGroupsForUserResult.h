...
class AdminListGroupsForUserResult {
 public:
  AWS_COGNITOIDENTITYPROVIDER_API AdminListGroupsForUserResult() = default;
  ...
  AWS_COGNITOIDENTITYPROVIDER_API AdminListGroupsForUserResult& operator=(
  ...
  template <typename GroupsT = Aws::Vector<GroupType>>
  AdminListGroupsForUserResult& WithGroups(GroupsT&& value) {
    SetGroups(std::forward<GroupsT>(value));
    return *this;
  }
  template <typename GroupsT = GroupType>
  AdminListGroupsForUserResult& AddGroups(GroupsT&& value) {
    m_groupsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  AdminListGroupsForUserResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  AdminListGroupsForUserResult& WithRequestId(RequestIdT&& value) {
