...
class ListWebAuthnCredentialsResult {
 public:
  ...
  AWS_COGNITOIDENTITYPROVIDER_API ListWebAuthnCredentialsResult& operator=(
  ...
  template <typename CredentialsT = Aws::Vector<WebAuthnCredentialDescription>>
  ListWebAuthnCredentialsResult& WithCredentials(CredentialsT&& value) {
    SetCredentials(std::forward<CredentialsT>(value));
    return *this;
  }
  template <typename CredentialsT = WebAuthnCredentialDescription>
  ListWebAuthnCredentialsResult& AddCredentials(CredentialsT&& value) {
    m_credentialsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListWebAuthnCredentialsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListWebAuthnCredentialsResult& WithRequestId(RequestIdT&& value) {
