...
class GetUserResult {
 public:
  ...
  template <typename UserAttributesT = Aws::Vector<AttributeType>>
  GetUserResult& WithUserAttributes(UserAttributesT&& value) {
    SetUserAttributes(std::forward<UserAttributesT>(value));
    return *this;
  }
  template <typename UserAttributesT = AttributeType>
  GetUserResult& AddUserAttributes(UserAttributesT&& value) {
    m_userAttributesHasBeenSet = true;
  ...
  template <typename MFAOptionsT = Aws::Vector<MFAOptionType>>
  GetUserResult& WithMFAOptions(MFAOptionsT&& value) {
    SetMFAOptions(std::forward<MFAOptionsT>(value));
    return *this;
  }
  template <typename MFAOptionsT = MFAOptionType>
  GetUserResult& AddMFAOptions(MFAOptionsT&& value) {
    m_mFAOptionsHasBeenSet = true;
  ...
  template <typename PreferredMfaSettingT = Aws::String>
  GetUserResult& WithPreferredMfaSetting(PreferredMfaSettingT&& value) {
  ...
  template <typename UserMFASettingListT = Aws::Vector<Aws::String>>
  GetUserResult& WithUserMFASettingList(UserMFASettingListT&& value) {
    SetUserMFASettingList(std::forward<UserMFASettingListT>(value));
    return *this;
  }
  template <typename UserMFASettingListT = Aws::String>
  GetUserResult& AddUserMFASettingList(UserMFASettingListT&& value) {
    m_userMFASettingListHasBeenSet = true;
