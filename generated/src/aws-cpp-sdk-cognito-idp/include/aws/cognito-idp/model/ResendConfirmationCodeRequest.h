...
class ResendConfirmationCodeRequest : public CognitoIdentityProviderRequest {
 public:
  ...
  template <typename ClientIdT = Aws::String>
  ResendConfirmationCodeRequest& WithClientId(ClientIdT&& value) {
  ...
  template <typename SecretHashT = Aws::String>
  ResendConfirmationCodeRequest& WithSecretHash(SecretHashT&& value) {
  ...
  template <typename UserContextDataT = UserContextDataType>
  ResendConfirmationCodeRequest& WithUserContextData(UserContextDataT&& value) {
  ...
  template <typename UsernameT = Aws::String>
  ResendConfirmationCodeRequest& WithUsername(UsernameT&& value) {
  ...
  template <typename AnalyticsMetadataT = AnalyticsMetadataType>
  ResendConfirmationCodeRequest& WithAnalyticsMetadata(AnalyticsMetadataT&& value) {
  ...
  template <typename ClientMetadataT = Aws::Map<Aws::String, Aws::String>>
  ResendConfirmationCodeRequest& WithClientMetadata(ClientMetadataT&& value) {
