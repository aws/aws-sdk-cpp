...
namespace Model
{
  ...
  {
  public:
    AWS_COGNITOIDENTITYPROVIDER_API ResendConfirmationCodeRequest() = default;
    ...
    template<typename ClientIdT = Aws::String>
    ResendConfirmationCodeRequest& WithClientId(ClientIdT&& value) { SetClientId(std::forward<ClientIdT>(value)); return *this;}
    ///@}
    ...
    template<typename SecretHashT = Aws::String>
    ResendConfirmationCodeRequest& WithSecretHash(SecretHashT&& value) { SetSecretHash(std::forward<SecretHashT>(value)); return *this;}
    ///@}
    ...
    template<typename UserContextDataT = UserContextDataType>
    ResendConfirmationCodeRequest& WithUserContextData(UserContextDataT&& value) { SetUserContextData(std::forward<UserContextDataT>(value)); return *this;}
    ///@}
    ...
    template<typename UsernameT = Aws::String>
    ResendConfirmationCodeRequest& WithUsername(UsernameT&& value) { SetUsername(std::forward<UsernameT>(value)); return *this;}
    ///@}
    ...
    template<typename AnalyticsMetadataT = AnalyticsMetadataType>
    ResendConfirmationCodeRequest& WithAnalyticsMetadata(AnalyticsMetadataT&& value) { SetAnalyticsMetadata(std::forward<AnalyticsMetadataT>(value)); return *this;}
    ///@}
    ...
    template<typename ClientMetadataT = Aws::Map<Aws::String, Aws::String>>
    ResendConfirmationCodeRequest& WithClientMetadata(ClientMetadataT&& value) { SetClientMetadata(std::forward<ClientMetadataT>(value)); return *this;}
    template<typename ClientMetadataKeyT = Aws::String, typename ClientMetadataValueT = Aws::String>
    ResendConfirmationCodeRequest& AddClientMetadata(ClientMetadataKeyT&& key, ClientMetadataValueT&& value) {
