...
class ConfirmForgotPasswordResult {
 public:
  AWS_COGNITOIDENTITYPROVIDER_API ConfirmForgotPasswordResult() = default;
  ...
  AWS_COGNITOIDENTITYPROVIDER_API ConfirmForgotPasswordResult& operator=(
  ...
  template <typename RequestIdT = Aws::String>
  ConfirmForgotPasswordResult& WithRequestId(RequestIdT&& value) {
