...
class CreateManagedLoginBrandingResult {
 public:
  ...
  AWS_COGNITOIDENTITYPROVIDER_API CreateManagedLoginBrandingResult& operator=(
  ...
  template <typename ManagedLoginBrandingT = ManagedLoginBrandingType>
  CreateManagedLoginBrandingResult& WithManagedLoginBranding(ManagedLoginBrandingT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateManagedLoginBrandingResult& WithRequestId(RequestIdT&& value) {
