...
class RefreshTokenRotationType {
 public:
  ...
  inline void SetFeature(FeatureType value) {
    m_featureHasBeenSet = true;
    m_feature = value;
  }
  inline RefreshTokenRotationType& WithFeature(FeatureType value) {
    SetFeature(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRetryGracePeriodSeconds(int value) {
    m_retryGracePeriodSecondsHasBeenSet = true;
    m_retryGracePeriodSeconds = value;
  }
  inline RefreshTokenRotationType& WithRetryGracePeriodSeconds(int value) {
    SetRetryGracePeriodSeconds(value);
    return *this;
  }
  ///@}
 private:
