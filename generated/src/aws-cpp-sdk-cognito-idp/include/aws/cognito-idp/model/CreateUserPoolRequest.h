...
class CreateUserPoolRequest : public CognitoIdentityProviderRequest {
 public:
  ...
  inline CreateUserPoolRequest& WithDeletionProtection(DeletionProtectionType value) {
  ...
  inline CreateUserPoolRequest& AddAutoVerifiedAttributes(VerifiedAttributeType value) {
    m_autoVerifiedAttributesHasBeenSet = true;
  ...
  void SetAliasAttributes(AliasAttributesT&& value) {
    ...
    m_aliasAttributes = std::forward<AliasAttributesT>(value);
  }
  template <typename AliasAttributesT = Aws::Vector<AliasAttributeType>>
  CreateUserPoolRequest& WithAliasAttributes(AliasAttributesT&& value) {
    SetAliasAttributes(std::forward<AliasAttributesT>(value));
    return *this;
  }
  inline CreateUserPoolRequest& AddAliasAttributes(AliasAttributeType value) {
    m_aliasAttributesHasBeenSet = true;
    m_aliasAttributes.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetUsernameAttributes(UsernameAttributesT&& value) {
    ...
    m_usernameAttributes = std::forward<UsernameAttributesT>(value);
  }
  template <typename UsernameAttributesT = Aws::Vector<UsernameAttributeType>>
  CreateUserPoolRequest& WithUsernameAttributes(UsernameAttributesT&& value) {
    SetUsernameAttributes(std::forward<UsernameAttributesT>(value));
    return *this;
  }
  inline CreateUserPoolRequest& AddUsernameAttributes(UsernameAttributeType value) {
    m_usernameAttributesHasBeenSet = true;
    m_usernameAttributes.push_back(value);
    return *this;
  }
  ///@}
   ...
   * preferred MFA factor.</p> <p>The <code>CreateUserPool</code> operation supports
   * only SMS MFA configuration. If you set <code>MfaConfiguration</code> to either
   * of these values, include an <code>SmsConfiguration</code> in the same
   * request:</p> <ul> <li> <p> <code>ON</code> – Requires MFA for all users</p>
   * </li> <li> <p> <code>OPTIONAL</code> – Makes MFA optional for each user</p>
   * </li> </ul> <p>If you omit <code>SmsConfiguration</code>, the operation returns
   * an <code>InvalidParameterException</code>. To configure TOTP or email MFA, use
   * the <a
   ...
   * operation. You can also use <code>SetUserPoolMfaConfig</code> to add MFA factors
   * later.</p>
   */
  ...
  inline CreateUserPoolRequest& WithMfaConfiguration(UserPoolMfaType value) {
  ...
  void SetUsernameConfiguration(UsernameConfigurationT&& value) {
    ...
    m_usernameConfiguration = std::forward<UsernameConfigurationT>(value);
  }
  template <typename UsernameConfigurationT = UsernameConfigurationType>
  CreateUserPoolRequest& WithUsernameConfiguration(UsernameConfigurationT&& value) {
    SetUsernameConfiguration(std::forward<UsernameConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateUserPoolRequest& WithUserPoolTier(UserPoolTierType value) {
  ...
  ///@{
  /**
   * <p>The key configuration for the user pool. Specifies the key type and KMS key
   * ARN for encryption.</p>
   */
  ...
  ///@{
  /**
   * <p>The issuer configuration for the user pool. Specifies the issuer type for
   * token generation.</p>
   */
