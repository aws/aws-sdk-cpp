...
class StartWebAuthnRegistrationResult {
 public:
  ...
  AWS_COGNITOIDENTITYPROVIDER_API StartWebAuthnRegistrationResult& operator=(
  ...
  void SetCredentialCreationOptions(CredentialCreationOptionsT&& value) {
    m_credentialCreationOptionsHasBeenSet = true;
    m_credentialCreationOptions = std::forward<CredentialCreationOptionsT>(value);
  }
  template <typename CredentialCreationOptionsT = Aws::Utils::Document>
  StartWebAuthnRegistrationResult& WithCredentialCreationOptions(CredentialCreationOptionsT&& value) {
    SetCredentialCreationOptions(std::forward<CredentialCreationOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  StartWebAuthnRegistrationResult& WithRequestId(RequestIdT&& value) {
