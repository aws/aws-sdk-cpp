...
class InitiateAuthRequest : public CognitoIdentityProviderRequest {
 public:
  ...
  inline InitiateAuthRequest& WithAuthFlow(AuthFlowType value) {
    SetAuthFlow(value);
    return *this;
  }
  ///@}
   ...
   * (required)</p> </li> </ul> </dd> <dt>USER_PASSWORD_AUTH</dt> <dd> <ul> <li> <p>
   * <code>USERNAME</code> (required)</p> </li> <li> <p> <code>PASSWORD</code>
   * (required)</p> </li> </ul> </dd> <dt>REFRESH_TOKEN_AUTH/REFRESH_TOKEN</dt> <dd>
   * <ul> <li> <p> <code>REFRESH_TOKEN</code>(required)</p> </li> </ul> </dd>
   * <dt>CUSTOM_AUTH</dt> <dd> <ul> <li> <p> <code>USERNAME</code> (required)</p>
   * </li> <li> <p> <code>ChallengeName: SRP_A</code> (when doing SRP authentication
   * before custom challenges)</p> </li> <li> <p> <code>SRP_A: (An SRP_A
   * value)</code> (when doing SRP authentication before custom challenges)</p> </li>
   * </ul> </dd> </dl> <p>For more information about <code>SECRET_HASH</code>, see <a
  ...
  template <typename SessionT = Aws::String>
  InitiateAuthRequest& WithSession(SessionT&& value) {
