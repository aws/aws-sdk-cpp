...
class ListWebAuthnCredentialsRequest : public CognitoIdentityProviderRequest {
 public:
  ...
  template <typename AccessTokenT = Aws::String>
  ListWebAuthnCredentialsRequest& WithAccessToken(AccessTokenT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListWebAuthnCredentialsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListWebAuthnCredentialsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
