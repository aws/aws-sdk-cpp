...
class AdminConfirmSignUpRequest : public CognitoIdentityProviderRequest {
 public:
  ...
  template <typename UserPoolIdT = Aws::String>
  AdminConfirmSignUpRequest& WithUserPoolId(UserPoolIdT&& value) {
  ...
  template <typename UsernameT = Aws::String>
  AdminConfirmSignUpRequest& WithUsername(UsernameT&& value) {
  ...
  template <typename ClientMetadataT = Aws::Map<Aws::String, Aws::String>>
  AdminConfirmSignUpRequest& WithClientMetadata(ClientMetadataT&& value) {
