...
class EventFeedbackType {
 public:
  ...
  inline void SetFeedbackValue(FeedbackValueType value) {
    m_feedbackValueHasBeenSet = true;
    m_feedbackValue = value;
  }
  inline EventFeedbackType& WithFeedbackValue(FeedbackValueType value) {
  ...
  template <typename ProviderT = Aws::String>
  EventFeedbackType& WithProvider(ProviderT&& value) {
  ...
  void SetFeedbackDate(FeedbackDateT&& value) {
    m_feedbackDateHasBeenSet = true;
    m_feedbackDate = std::forward<FeedbackDateT>(value);
  }
  template <typename FeedbackDateT = Aws::Utils::DateTime>
  EventFeedbackType& WithFeedbackDate(FeedbackDateT&& value) {
    SetFeedbackDate(std::forward<FeedbackDateT>(value));
    return *this;
  }
  ///@}
 private:
