...
class SignUpResult {
 public:
  ...
  inline void SetUserConfirmed(bool value) {
    m_userConfirmedHasBeenSet = true;
    m_userConfirmed = value;
  }
  inline SignUpResult& WithUserConfirmed(bool value) {
  ...
  void SetUserSub(UserSubT&& value) {
    m_userSubHasBeenSet = true;
    m_userSub = std::forward<UserSubT>(value);
  }
  template <typename UserSubT = Aws::String>
  SignUpResult& WithUserSub(UserSubT&& value) {
    SetUserSub(std::forward<UserSubT>(value));
    return *this;
  }
  ///@}
