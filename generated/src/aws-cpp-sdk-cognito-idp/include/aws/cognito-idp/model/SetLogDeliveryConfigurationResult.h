...
class SetLogDeliveryConfigurationResult {
 public:
  ...
  AWS_COGNITOIDENTITYPROVIDER_API SetLogDeliveryConfigurationResult& operator=(
  ...
  template <typename LogDeliveryConfigurationT = LogDeliveryConfigurationType>
  SetLogDeliveryConfigurationResult& WithLogDeliveryConfiguration(LogDeliveryConfigurationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  SetLogDeliveryConfigurationResult& WithRequestId(RequestIdT&& value) {
