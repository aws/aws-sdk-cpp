...
class VerifyUserAttributeRequest : public CognitoIdentityProviderRequest {
 public:
  ...
  template <typename AccessTokenT = Aws::String>
  VerifyUserAttributeRequest& WithAccessToken(AccessTokenT&& value) {
  ...
  template <typename AttributeNameT = Aws::String>
  VerifyUserAttributeRequest& WithAttributeName(AttributeNameT&& value) {
  ...
  template <typename CodeT = Aws::String>
  VerifyUserAttributeRequest& WithCode(CodeT&& value) {
