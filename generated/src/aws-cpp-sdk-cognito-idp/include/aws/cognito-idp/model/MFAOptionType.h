...
class MFAOptionType {
 public:
  ...
  inline void SetDeliveryMedium(DeliveryMediumType value) {
    m_deliveryMediumHasBeenSet = true;
    m_deliveryMedium = value;
  }
  inline MFAOptionType& WithDeliveryMedium(DeliveryMediumType value) {
    SetDeliveryMedium(value);
    return *this;
  }
  ///@}
  ...
  template <typename AttributeNameT = Aws::String>
  MFAOptionType& WithAttributeName(AttributeNameT&& value) {
