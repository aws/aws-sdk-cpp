...
class TermsType {
 public:
  ...
  template <typename TermsIdT = Aws::String>
  TermsType& WithTermsId(TermsIdT&& value) {
  ...
  template <typename UserPoolIdT = Aws::String>
  TermsType& WithUserPoolId(UserPoolIdT&& value) {
  ...
  template <typename ClientIdT = Aws::String>
  TermsType& WithClientId(ClientIdT&& value) {
  ...
  template <typename TermsNameT = Aws::String>
  TermsType& WithTermsName(TermsNameT&& value) {
  ...
  inline void SetTermsSource(TermsSourceType value) {
    m_termsSourceHasBeenSet = true;
    m_termsSource = value;
  }
  inline TermsType& WithTermsSource(TermsSourceType value) {
    SetTermsSource(value);
    return *this;
  }
  ///@}
  ...
  inline TermsType& WithEnforcement(TermsEnforcementType value) {
  ...
  template <typename LinksT = Aws::Map<Aws::String, Aws::String>>
  TermsType& WithLinks(LinksT&& value) {
  ...
  TermsType& AddLinks(LinksKeyT&& key, LinksValueT&& value) {
    m_linksHasBeenSet = true;
    m_links.emplace(std::forward<LinksKeyT>(key), std::forward<LinksValueT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename CreationDateT = Aws::Utils::DateTime>
  TermsType& WithCreationDate(CreationDateT&& value) {
  ...
  template <typename LastModifiedDateT = Aws::Utils::DateTime>
  TermsType& WithLastModifiedDate(LastModifiedDateT&& value) {
