...
class VerifyUserAttributeResult {
 public:
  AWS_COGNITOIDENTITYPROVIDER_API VerifyUserAttributeResult() = default;
  ...
  AWS_COGNITOIDENTITYPROVIDER_API VerifyUserAttributeResult& operator=(
  ...
  template <typename RequestIdT = Aws::String>
  VerifyUserAttributeResult& WithRequestId(RequestIdT&& value) {
