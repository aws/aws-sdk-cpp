...
class PreTokenGenerationVersionConfigType {
 public:
  ...
  inline void SetLambdaVersion(PreTokenGenerationLambdaVersionType value) {
    m_lambdaVersionHasBeenSet = true;
    m_lambdaVersion = value;
  }
  inline PreTokenGenerationVersionConfigType& WithLambdaVersion(PreTokenGenerationLambdaVersionType value) {
  ...
  template <typename LambdaArnT = Aws::String>
  PreTokenGenerationVersionConfigType& WithLambdaArn(LambdaArnT&& value) {
