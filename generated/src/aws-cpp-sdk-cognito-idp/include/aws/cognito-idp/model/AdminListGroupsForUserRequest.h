...
class AdminListGroupsForUserRequest : public CognitoIdentityProviderRequest {
 public:
  ...
  template <typename UsernameT = Aws::String>
  AdminListGroupsForUserRequest& WithUsername(UsernameT&& value) {
  ...
  template <typename UserPoolIdT = Aws::String>
  AdminListGroupsForUserRequest& WithUserPoolId(UserPoolIdT&& value) {
  ...
  inline AdminListGroupsForUserRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  AdminListGroupsForUserRequest& WithNextToken(NextTokenT&& value) {
