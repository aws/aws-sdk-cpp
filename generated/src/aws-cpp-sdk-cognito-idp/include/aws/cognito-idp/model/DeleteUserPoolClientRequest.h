...
namespace Model
{
  ...
  {
  public:
    AWS_COGNITOIDENTITYPROVIDER_API DeleteUserPoolClientRequest() = default;
    ...
    template<typename UserPoolIdT = Aws::String>
    DeleteUserPoolClientRequest& WithUserPoolId(UserPoolIdT&& value) { SetUserPoolId(std::forward<UserPoolIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ClientIdT = Aws::String>
    DeleteUserPoolClientRequest& WithClientId(ClientIdT&& value) { SetClientId(std::forward<ClientIdT>(value)); return *this;}
    ///@}
  private:
