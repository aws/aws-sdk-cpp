...
class ListResourceServersResult {
 public:
  ...
  AWS_COGNITOIDENTITYPROVIDER_API ListResourceServersResult& operator=(
  ...
  void SetResourceServers(ResourceServersT&& value) {
    m_resourceServersHasBeenSet = true;
    m_resourceServers = std::forward<ResourceServersT>(value);
  }
  template <typename ResourceServersT = Aws::Vector<ResourceServerType>>
  ListResourceServersResult& WithResourceServers(ResourceServersT&& value) {
    SetResourceServers(std::forward<ResourceServersT>(value));
    return *this;
  }
  template <typename ResourceServersT = ResourceServerType>
  ListResourceServersResult& AddResourceServers(ResourceServersT&& value) {
    m_resourceServersHasBeenSet = true;
    m_resourceServers.emplace_back(std::forward<ResourceServersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListResourceServersResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListResourceServersResult& WithRequestId(RequestIdT&& value) {
