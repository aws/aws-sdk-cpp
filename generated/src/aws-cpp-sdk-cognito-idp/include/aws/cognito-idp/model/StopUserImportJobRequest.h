...
class StopUserImportJobRequest : public CognitoIdentityProviderRequest {
 public:
  AWS_COGNITOIDENTITYPROVIDER_API StopUserImportJobRequest() = default;
  ...
  template <typename UserPoolIdT = Aws::String>
  StopUserImportJobRequest& WithUserPoolId(UserPoolIdT&& value) {
  ...
  template <typename JobIdT = Aws::String>
  StopUserImportJobRequest& WithJobId(JobIdT&& value) {
