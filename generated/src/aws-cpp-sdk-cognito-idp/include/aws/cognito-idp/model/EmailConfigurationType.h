...
class EmailConfigurationType {
 public:
  ...
  template <typename SourceArnT = Aws::String>
  EmailConfigurationType& WithSourceArn(SourceArnT&& value) {
  ...
  void SetReplyToEmailAddress(ReplyToEmailAddressT&& value) {
    m_replyToEmailAddressHasBeenSet = true;
    m_replyToEmailAddress = std::forward<ReplyToEmailAddressT>(value);
  }
  template <typename ReplyToEmailAddressT = Aws::String>
  EmailConfigurationType& WithReplyToEmailAddress(ReplyToEmailAddressT&& value) {
    SetReplyToEmailAddress(std::forward<ReplyToEmailAddressT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetEmailSendingAccount(EmailSendingAccountType value) {
    m_emailSendingAccountHasBeenSet = true;
    m_emailSendingAccount = value;
  }
  inline EmailConfigurationType& WithEmailSendingAccount(EmailSendingAccountType value) {
    SetEmailSendingAccount(value);
    return *this;
  }
  ///@}
  ...
  template <typename FromT = Aws::String>
  EmailConfigurationType& WithFrom(FromT&& value) {
  ...
  template <typename ConfigurationSetT = Aws::String>
  EmailConfigurationType& WithConfigurationSet(ConfigurationSetT&& value) {
