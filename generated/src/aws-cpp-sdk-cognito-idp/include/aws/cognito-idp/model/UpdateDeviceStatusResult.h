...
class UpdateDeviceStatusResult {
 public:
  AWS_COGNITOIDENTITYPROVIDER_API UpdateDeviceStatusResult() = default;
  ...
  AWS_COGNITOIDENTITYPROVIDER_API UpdateDeviceStatusResult& operator=(
  ...
  template <typename RequestIdT = Aws::String>
  UpdateDeviceStatusResult& WithRequestId(RequestIdT&& value) {
