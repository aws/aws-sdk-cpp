...
class CodeDeliveryDetailsType {
 public:
  ...
  template <typename DestinationT = Aws::String>
  CodeDeliveryDetailsType& WithDestination(DestinationT&& value) {
  ...
  inline CodeDeliveryDetailsType& WithDeliveryMedium(DeliveryMediumType value) {
  ...
  template <typename AttributeNameT = Aws::String>
  CodeDeliveryDetailsType& WithAttributeName(AttributeNameT&& value) {
