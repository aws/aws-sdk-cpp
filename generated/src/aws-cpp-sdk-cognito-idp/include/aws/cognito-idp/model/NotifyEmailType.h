...
class NotifyEmailType {
 public:
  ...
  template <typename SubjectT = Aws::String>
  NotifyEmailType& WithSubject(SubjectT&& value) {
  ...
  void SetHtmlBody(HtmlBodyT&& value) {
    m_htmlBodyHasBeenSet = true;
    m_htmlBody = std::forward<HtmlBodyT>(value);
  }
  template <typename HtmlBodyT = Aws::String>
  NotifyEmailType& WithHtmlBody(HtmlBodyT&& value) {
    SetHtmlBody(std::forward<HtmlBodyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTextBody(TextBodyT&& value) {
    m_textBodyHasBeenSet = true;
    m_textBody = std::forward<TextBodyT>(value);
  }
  template <typename TextBodyT = Aws::String>
  NotifyEmailType& WithTextBody(TextBodyT&& value) {
    SetTextBody(std::forward<TextBodyT>(value));
    return *this;
  }
  ///@}
 private:
