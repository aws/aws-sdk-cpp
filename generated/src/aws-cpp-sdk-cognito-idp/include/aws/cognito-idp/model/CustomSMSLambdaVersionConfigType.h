...
class CustomSMSLambdaVersionConfigType {
 public:
  ...
  inline void SetLambdaVersion(CustomSMSSenderLambdaVersionType value) {
    m_lambdaVersionHasBeenSet = true;
    m_lambdaVersion = value;
  }
  inline CustomSMSLambdaVersionConfigType& WithLambdaVersion(CustomSMSSenderLambdaVersionType value) {
  ...
  template <typename LambdaArnT = Aws::String>
  CustomSMSLambdaVersionConfigType& WithLambdaArn(LambdaArnT&& value) {
