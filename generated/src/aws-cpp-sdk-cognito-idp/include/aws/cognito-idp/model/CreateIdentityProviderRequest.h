...
class CreateIdentityProviderRequest : public CognitoIdentityProviderRequest {
 public:
  ...
  inline CreateIdentityProviderRequest& WithProviderType(IdentityProviderTypeType value) {
  ...
  void SetProviderDetails(ProviderDetailsT&& value) {
    ...
    m_providerDetails = std::forward<ProviderDetailsT>(value);
  }
  template <typename ProviderDetailsT = Aws::Map<Aws::String, Aws::String>>
  CreateIdentityProviderRequest& WithProviderDetails(ProviderDetailsT&& value) {
    SetProviderDetails(std::forward<ProviderDetailsT>(value));
    return *this;
  }
  ...
  CreateIdentityProviderRequest& AddProviderDetails(ProviderDetailsKeyT&& key, ProviderDetailsValueT&& value) {
    m_providerDetailsHasBeenSet = true;
    m_providerDetails.emplace(std::forward<ProviderDetailsKeyT>(key), std::forward<ProviderDetailsValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAttributeMapping(AttributeMappingT&& value) {
    ...
    m_attributeMapping = std::forward<AttributeMappingT>(value);
  }
  template <typename AttributeMappingT = Aws::Map<Aws::String, Aws::String>>
  CreateIdentityProviderRequest& WithAttributeMapping(AttributeMappingT&& value) {
    SetAttributeMapping(std::forward<AttributeMappingT>(value));
    return *this;
  }
  ...
  CreateIdentityProviderRequest& AddAttributeMapping(AttributeMappingKeyT&& key, AttributeMappingValueT&& value) {
    m_attributeMappingHasBeenSet = true;
    m_attributeMapping.emplace(std::forward<AttributeMappingKeyT>(key), std::forward<AttributeMappingValueT>(value));
    return *this;
  }
  ///@}
