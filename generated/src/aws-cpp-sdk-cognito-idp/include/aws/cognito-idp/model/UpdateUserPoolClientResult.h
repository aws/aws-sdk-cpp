...
class UpdateUserPoolClientResult {
 public:
  ...
  AWS_COGNITOIDENTITYPROVIDER_API UpdateUserPoolClientResult& operator=(
  ...
  template <typename UserPoolClientT = UserPoolClientType>
  UpdateUserPoolClientResult& WithUserPoolClient(UserPoolClientT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateUserPoolClientResult& WithRequestId(RequestIdT&& value) {
