...
namespace Model
{
  ...
  {
  public:
    AWS_COGNITOIDENTITYPROVIDER_API GetSigningCertificateRequest() = default;
    ...
    template<typename UserPoolIdT = Aws::String>
    GetSigningCertificateRequest& WithUserPoolId(UserPoolIdT&& value) { SetUserPoolId(std::forward<UserPoolIdT>(value)); return *this;}
    ///@}
  private:
