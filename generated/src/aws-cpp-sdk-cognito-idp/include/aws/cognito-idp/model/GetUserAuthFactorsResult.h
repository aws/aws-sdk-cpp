...
class GetUserAuthFactorsResult {
 public:
  ...
  AWS_COGNITOIDENTITYPROVIDER_API GetUserAuthFactorsResult& operator=(
  ...
  template <typename UsernameT = Aws::String>
  GetUserAuthFactorsResult& WithUsername(UsernameT&& value) {
  ...
  template <typename PreferredMfaSettingT = Aws::String>
  GetUserAuthFactorsResult& WithPreferredMfaSetting(PreferredMfaSettingT&& value) {
  ...
  template <typename UserMFASettingListT = Aws::Vector<Aws::String>>
  GetUserAuthFactorsResult& WithUserMFASettingList(UserMFASettingListT&& value) {
    SetUserMFASettingList(std::forward<UserMFASettingListT>(value));
    return *this;
  }
  template <typename UserMFASettingListT = Aws::String>
  GetUserAuthFactorsResult& AddUserMFASettingList(UserMFASettingListT&& value) {
    m_userMFASettingListHasBeenSet = true;
  ...
  template <typename ConfiguredUserAuthFactorsT = Aws::Vector<AuthFactorType>>
  GetUserAuthFactorsResult& WithConfiguredUserAuthFactors(ConfiguredUserAuthFactorsT&& value) {
    SetConfiguredUserAuthFactors(std::forward<ConfiguredUserAuthFactorsT>(value));
    return *this;
  }
  inline GetUserAuthFactorsResult& AddConfiguredUserAuthFactors(AuthFactorType value) {
    m_configuredUserAuthFactorsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetUserAuthFactorsResult& WithRequestId(RequestIdT&& value) {
