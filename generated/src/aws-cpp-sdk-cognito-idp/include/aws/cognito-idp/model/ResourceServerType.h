...
class ResourceServerType {
 public:
  AWS_COGNITOIDENTITYPROVIDER_API ResourceServerType() = default;
  ...
  template <typename UserPoolIdT = Aws::String>
  ResourceServerType& WithUserPoolId(UserPoolIdT&& value) {
  ...
  template <typename IdentifierT = Aws::String>
  ResourceServerType& WithIdentifier(IdentifierT&& value) {
  ...
  template <typename NameT = Aws::String>
  ResourceServerType& WithName(NameT&& value) {
  ...
  template <typename ScopesT = Aws::Vector<ResourceServerScopeType>>
  ResourceServerType& WithScopes(ScopesT&& value) {
    SetScopes(std::forward<ScopesT>(value));
    return *this;
  }
  template <typename ScopesT = ResourceServerScopeType>
  ResourceServerType& AddScopes(ScopesT&& value) {
    m_scopesHasBeenSet = true;
