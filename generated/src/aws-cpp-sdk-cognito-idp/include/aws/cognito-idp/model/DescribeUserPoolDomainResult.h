...
class DescribeUserPoolDomainResult {
 public:
  ...
  AWS_COGNITOIDENTITYPROVIDER_API DescribeUserPoolDomainResult& operator=(
  ...
  void SetDomainDescription(DomainDescriptionT&& value) {
    m_domainDescriptionHasBeenSet = true;
    m_domainDescription = std::forward<DomainDescriptionT>(value);
  }
  template <typename DomainDescriptionT = DomainDescriptionType>
  DescribeUserPoolDomainResult& WithDomainDescription(DomainDescriptionT&& value) {
    SetDomainDescription(std::forward<DomainDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeUserPoolDomainResult& WithRequestId(RequestIdT&& value) {
