...
class DescribeManagedLoginBrandingRequest : public CognitoIdentityProviderRequest {
 public:
  ...
  template <typename UserPoolIdT = Aws::String>
  DescribeManagedLoginBrandingRequest& WithUserPoolId(UserPoolIdT&& value) {
  ...
  template <typename ManagedLoginBrandingIdT = Aws::String>
  DescribeManagedLoginBrandingRequest& WithManagedLoginBrandingId(ManagedLoginBrandingIdT&& value) {
  ...
  inline DescribeManagedLoginBrandingRequest& WithReturnMergedResources(bool value) {
