...
class SchemaAttributeType {
 public:
  ...
  template <typename NameT = Aws::String>
  SchemaAttributeType& WithName(NameT&& value) {
  ...
  inline void SetAttributeDataType(AttributeDataType value) {
    m_attributeDataTypeHasBeenSet = true;
    m_attributeDataType = value;
  }
  inline SchemaAttributeType& WithAttributeDataType(AttributeDataType value) {
  ...
  inline void SetDeveloperOnlyAttribute(bool value) {
    m_developerOnlyAttributeHasBeenSet = true;
    m_developerOnlyAttribute = value;
  }
  inline SchemaAttributeType& WithDeveloperOnlyAttribute(bool value) {
    SetDeveloperOnlyAttribute(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMutable(bool value) {
    m_mutableHasBeenSet = true;
    m_mutable = value;
  }
  inline SchemaAttributeType& WithMutable(bool value) {
    SetMutable(value);
    return *this;
  }
  ///@}
  ...
  inline SchemaAttributeType& WithRequired(bool value) {
    SetRequired(value);
    return *this;
  }
  ///@}
  ...
  void SetNumberAttributeConstraints(NumberAttributeConstraintsT&& value) {
    m_numberAttributeConstraintsHasBeenSet = true;
    m_numberAttributeConstraints = std::forward<NumberAttributeConstraintsT>(value);
  }
  template <typename NumberAttributeConstraintsT = NumberAttributeConstraintsType>
  SchemaAttributeType& WithNumberAttributeConstraints(NumberAttributeConstraintsT&& value) {
    SetNumberAttributeConstraints(std::forward<NumberAttributeConstraintsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStringAttributeConstraints(StringAttributeConstraintsT&& value) {
    m_stringAttributeConstraintsHasBeenSet = true;
    m_stringAttributeConstraints = std::forward<StringAttributeConstraintsT>(value);
  }
  template <typename StringAttributeConstraintsT = StringAttributeConstraintsType>
  SchemaAttributeType& WithStringAttributeConstraints(StringAttributeConstraintsT&& value) {
    SetStringAttributeConstraints(std::forward<StringAttributeConstraintsT>(value));
    return *this;
  }
  ///@}
 private:
