...
class LambdaConfigType {
 public:
  ...
  void SetPreSignUp(PreSignUpT&& value) {
    m_preSignUpHasBeenSet = true;
    m_preSignUp = std::forward<PreSignUpT>(value);
  }
  template <typename PreSignUpT = Aws::String>
  LambdaConfigType& WithPreSignUp(PreSignUpT&& value) {
    SetPreSignUp(std::forward<PreSignUpT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCustomMessage(CustomMessageT&& value) {
    ...
    m_customMessage = std::forward<CustomMessageT>(value);
  }
  template <typename CustomMessageT = Aws::String>
  LambdaConfigType& WithCustomMessage(CustomMessageT&& value) {
    SetCustomMessage(std::forward<CustomMessageT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPostConfirmation(PostConfirmationT&& value) {
    m_postConfirmationHasBeenSet = true;
    m_postConfirmation = std::forward<PostConfirmationT>(value);
  }
  template <typename PostConfirmationT = Aws::String>
  LambdaConfigType& WithPostConfirmation(PostConfirmationT&& value) {
    SetPostConfirmation(std::forward<PostConfirmationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPreAuthentication(PreAuthenticationT&& value) {
    m_preAuthenticationHasBeenSet = true;
    m_preAuthentication = std::forward<PreAuthenticationT>(value);
  }
  template <typename PreAuthenticationT = Aws::String>
  LambdaConfigType& WithPreAuthentication(PreAuthenticationT&& value) {
    SetPreAuthentication(std::forward<PreAuthenticationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPostAuthentication(PostAuthenticationT&& value) {
    m_postAuthenticationHasBeenSet = true;
    m_postAuthentication = std::forward<PostAuthenticationT>(value);
  }
  template <typename PostAuthenticationT = Aws::String>
  LambdaConfigType& WithPostAuthentication(PostAuthenticationT&& value) {
    SetPostAuthentication(std::forward<PostAuthenticationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDefineAuthChallenge(DefineAuthChallengeT&& value) {
    m_defineAuthChallengeHasBeenSet = true;
    m_defineAuthChallenge = std::forward<DefineAuthChallengeT>(value);
  }
  template <typename DefineAuthChallengeT = Aws::String>
  LambdaConfigType& WithDefineAuthChallenge(DefineAuthChallengeT&& value) {
    SetDefineAuthChallenge(std::forward<DefineAuthChallengeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCreateAuthChallenge(CreateAuthChallengeT&& value) {
    m_createAuthChallengeHasBeenSet = true;
    m_createAuthChallenge = std::forward<CreateAuthChallengeT>(value);
  }
  template <typename CreateAuthChallengeT = Aws::String>
  LambdaConfigType& WithCreateAuthChallenge(CreateAuthChallengeT&& value) {
    SetCreateAuthChallenge(std::forward<CreateAuthChallengeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVerifyAuthChallengeResponse(VerifyAuthChallengeResponseT&& value) {
    m_verifyAuthChallengeResponseHasBeenSet = true;
    m_verifyAuthChallengeResponse = std::forward<VerifyAuthChallengeResponseT>(value);
  }
  template <typename VerifyAuthChallengeResponseT = Aws::String>
  LambdaConfigType& WithVerifyAuthChallengeResponse(VerifyAuthChallengeResponseT&& value) {
    SetVerifyAuthChallengeResponse(std::forward<VerifyAuthChallengeResponseT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPreTokenGeneration(PreTokenGenerationT&& value) {
    m_preTokenGenerationHasBeenSet = true;
    m_preTokenGeneration = std::forward<PreTokenGenerationT>(value);
  }
  template <typename PreTokenGenerationT = Aws::String>
  LambdaConfigType& WithPreTokenGeneration(PreTokenGenerationT&& value) {
    SetPreTokenGeneration(std::forward<PreTokenGenerationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUserMigration(UserMigrationT&& value) {
    m_userMigrationHasBeenSet = true;
    m_userMigration = std::forward<UserMigrationT>(value);
  }
  template <typename UserMigrationT = Aws::String>
  LambdaConfigType& WithUserMigration(UserMigrationT&& value) {
    SetUserMigration(std::forward<UserMigrationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPreTokenGenerationConfig(PreTokenGenerationConfigT&& value) {
    m_preTokenGenerationConfigHasBeenSet = true;
    m_preTokenGenerationConfig = std::forward<PreTokenGenerationConfigT>(value);
  }
  template <typename PreTokenGenerationConfigT = PreTokenGenerationVersionConfigType>
  LambdaConfigType& WithPreTokenGenerationConfig(PreTokenGenerationConfigT&& value) {
    SetPreTokenGenerationConfig(std::forward<PreTokenGenerationConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCustomSMSSender(CustomSMSSenderT&& value) {
    m_customSMSSenderHasBeenSet = true;
    m_customSMSSender = std::forward<CustomSMSSenderT>(value);
  }
  template <typename CustomSMSSenderT = CustomSMSLambdaVersionConfigType>
  LambdaConfigType& WithCustomSMSSender(CustomSMSSenderT&& value) {
    SetCustomSMSSender(std::forward<CustomSMSSenderT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCustomEmailSender(CustomEmailSenderT&& value) {
    m_customEmailSenderHasBeenSet = true;
    m_customEmailSender = std::forward<CustomEmailSenderT>(value);
  }
  template <typename CustomEmailSenderT = CustomEmailLambdaVersionConfigType>
  LambdaConfigType& WithCustomEmailSender(CustomEmailSenderT&& value) {
    SetCustomEmailSender(std::forward<CustomEmailSenderT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename KMSKeyIDT = Aws::String>
  LambdaConfigType& WithKMSKeyID(KMSKeyIDT&& value) {
