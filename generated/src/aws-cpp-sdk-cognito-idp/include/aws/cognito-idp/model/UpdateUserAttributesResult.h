...
class UpdateUserAttributesResult {
 public:
  ...
  AWS_COGNITOIDENTITYPROVIDER_API UpdateUserAttributesResult& operator=(
  ...
  void SetCodeDeliveryDetailsList(CodeDeliveryDetailsListT&& value) {
    m_codeDeliveryDetailsListHasBeenSet = true;
    m_codeDeliveryDetailsList = std::forward<CodeDeliveryDetailsListT>(value);
  }
  template <typename CodeDeliveryDetailsListT = Aws::Vector<CodeDeliveryDetailsType>>
  UpdateUserAttributesResult& WithCodeDeliveryDetailsList(CodeDeliveryDetailsListT&& value) {
    SetCodeDeliveryDetailsList(std::forward<CodeDeliveryDetailsListT>(value));
    return *this;
  }
  template <typename CodeDeliveryDetailsListT = CodeDeliveryDetailsType>
  UpdateUserAttributesResult& AddCodeDeliveryDetailsList(CodeDeliveryDetailsListT&& value) {
    m_codeDeliveryDetailsListHasBeenSet = true;
    m_codeDeliveryDetailsList.emplace_back(std::forward<CodeDeliveryDetailsListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  UpdateUserAttributesResult& WithRequestId(RequestIdT&& value) {
