...
class AnalyticsConfigurationType {
 public:
  ...
  template <typename ApplicationIdT = Aws::String>
  AnalyticsConfigurationType& WithApplicationId(ApplicationIdT&& value) {
  ...
  template <typename ApplicationArnT = Aws::String>
  AnalyticsConfigurationType& WithApplicationArn(ApplicationArnT&& value) {
  ...
  template <typename RoleArnT = Aws::String>
  AnalyticsConfigurationType& WithRoleArn(RoleArnT&& value) {
  ...
  template <typename ExternalIdT = Aws::String>
  AnalyticsConfigurationType& WithExternalId(ExternalIdT&& value) {
  ...
  inline void SetUserDataShared(bool value) {
    m_userDataSharedHasBeenSet = true;
    m_userDataShared = value;
  }
  inline AnalyticsConfigurationType& WithUserDataShared(bool value) {
    SetUserDataShared(value);
    return *this;
  }
  ///@}
 private:
