...
class IdentityProviderType {
 public:
  ...
  template <typename UserPoolIdT = Aws::String>
  IdentityProviderType& WithUserPoolId(UserPoolIdT&& value) {
  ...
  template <typename ProviderNameT = Aws::String>
  IdentityProviderType& WithProviderName(ProviderNameT&& value) {
  ...
  inline IdentityProviderType& WithProviderType(IdentityProviderTypeType value) {
  ...
  template <typename ProviderDetailsT = Aws::Map<Aws::String, Aws::String>>
  IdentityProviderType& WithProviderDetails(ProviderDetailsT&& value) {
  ...
  template <typename AttributeMappingT = Aws::Map<Aws::String, Aws::String>>
  IdentityProviderType& WithAttributeMapping(AttributeMappingT&& value) {
  ...
  template <typename IdpIdentifiersT = Aws::Vector<Aws::String>>
  IdentityProviderType& WithIdpIdentifiers(IdpIdentifiersT&& value) {
    SetIdpIdentifiers(std::forward<IdpIdentifiersT>(value));
    return *this;
  }
  template <typename IdpIdentifiersT = Aws::String>
  IdentityProviderType& AddIdpIdentifiers(IdpIdentifiersT&& value) {
    m_idpIdentifiersHasBeenSet = true;
  ...
  template <typename LastModifiedDateT = Aws::Utils::DateTime>
  IdentityProviderType& WithLastModifiedDate(LastModifiedDateT&& value) {
  ...
  template <typename CreationDateT = Aws::Utils::DateTime>
  IdentityProviderType& WithCreationDate(CreationDateT&& value) {
