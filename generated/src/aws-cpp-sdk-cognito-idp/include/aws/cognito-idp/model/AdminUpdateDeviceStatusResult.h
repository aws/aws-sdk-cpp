...
class AdminUpdateDeviceStatusResult {
 public:
  AWS_COGNITOIDENTITYPROVIDER_API AdminUpdateDeviceStatusResult() = default;
  ...
  AWS_COGNITOIDENTITYPROVIDER_API AdminUpdateDeviceStatusResult& operator=(
  ...
  template <typename RequestIdT = Aws::String>
  AdminUpdateDeviceStatusResult& WithRequestId(RequestIdT&& value) {
