...
class RiskExceptionConfigurationType {
 public:
  ...
  void SetBlockedIPRangeList(BlockedIPRangeListT&& value) {
    m_blockedIPRangeListHasBeenSet = true;
    m_blockedIPRangeList = std::forward<BlockedIPRangeListT>(value);
  }
  template <typename BlockedIPRangeListT = Aws::Vector<Aws::String>>
  RiskExceptionConfigurationType& WithBlockedIPRangeList(BlockedIPRangeListT&& value) {
    SetBlockedIPRangeList(std::forward<BlockedIPRangeListT>(value));
    return *this;
  }
  template <typename BlockedIPRangeListT = Aws::String>
  RiskExceptionConfigurationType& AddBlockedIPRangeList(BlockedIPRangeListT&& value) {
    m_blockedIPRangeListHasBeenSet = true;
    m_blockedIPRangeList.emplace_back(std::forward<BlockedIPRangeListT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSkippedIPRangeList(SkippedIPRangeListT&& value) {
    m_skippedIPRangeListHasBeenSet = true;
    m_skippedIPRangeList = std::forward<SkippedIPRangeListT>(value);
  }
  template <typename SkippedIPRangeListT = Aws::Vector<Aws::String>>
  RiskExceptionConfigurationType& WithSkippedIPRangeList(SkippedIPRangeListT&& value) {
    SetSkippedIPRangeList(std::forward<SkippedIPRangeListT>(value));
    return *this;
  }
  template <typename SkippedIPRangeListT = Aws::String>
  RiskExceptionConfigurationType& AddSkippedIPRangeList(SkippedIPRangeListT&& value) {
    m_skippedIPRangeListHasBeenSet = true;
    m_skippedIPRangeList.emplace_back(std::forward<SkippedIPRangeListT>(value));
    return *this;
  }
  ///@}
 private:
