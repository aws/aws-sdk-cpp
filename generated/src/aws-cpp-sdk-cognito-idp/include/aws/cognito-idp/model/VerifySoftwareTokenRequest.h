...
class VerifySoftwareTokenRequest : public CognitoIdentityProviderRequest {
 public:
  ...
  void SetFriendlyDeviceName(FriendlyDeviceNameT&& value) {
    m_friendlyDeviceNameHasBeenSet = true;
    m_friendlyDeviceName = std::forward<FriendlyDeviceNameT>(value);
  }
  template <typename FriendlyDeviceNameT = Aws::String>
  VerifySoftwareTokenRequest& WithFriendlyDeviceName(FriendlyDeviceNameT&& value) {
    SetFriendlyDeviceName(std::forward<FriendlyDeviceNameT>(value));
    return *this;
  }
  ///@}
 private:
