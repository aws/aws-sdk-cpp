...
class AdminSetUserMFAPreferenceRequest : public CognitoIdentityProviderRequest {
 public:
  ...
  void SetSMSMfaSettings(SMSMfaSettingsT&& value) {
    m_sMSMfaSettingsHasBeenSet = true;
    m_sMSMfaSettings = std::forward<SMSMfaSettingsT>(value);
  }
  template <typename SMSMfaSettingsT = SMSMfaSettingsType>
  AdminSetUserMFAPreferenceRequest& WithSMSMfaSettings(SMSMfaSettingsT&& value) {
    SetSMSMfaSettings(std::forward<SMSMfaSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSoftwareTokenMfaSettings(SoftwareTokenMfaSettingsT&& value) {
    m_softwareTokenMfaSettingsHasBeenSet = true;
    m_softwareTokenMfaSettings = std::forward<SoftwareTokenMfaSettingsT>(value);
  }
  template <typename SoftwareTokenMfaSettingsT = SoftwareTokenMfaSettingsType>
  AdminSetUserMFAPreferenceRequest& WithSoftwareTokenMfaSettings(SoftwareTokenMfaSettingsT&& value) {
    SetSoftwareTokenMfaSettings(std::forward<SoftwareTokenMfaSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEmailMfaSettings(EmailMfaSettingsT&& value) {
    m_emailMfaSettingsHasBeenSet = true;
    m_emailMfaSettings = std::forward<EmailMfaSettingsT>(value);
  }
  template <typename EmailMfaSettingsT = EmailMfaSettingsType>
  AdminSetUserMFAPreferenceRequest& WithEmailMfaSettings(EmailMfaSettingsT&& value) {
    SetEmailMfaSettings(std::forward<EmailMfaSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename UsernameT = Aws::String>
  AdminSetUserMFAPreferenceRequest& WithUsername(UsernameT&& value) {
  ...
  template <typename UserPoolIdT = Aws::String>
  AdminSetUserMFAPreferenceRequest& WithUserPoolId(UserPoolIdT&& value) {
