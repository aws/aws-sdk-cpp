...
class NotifyConfigurationType {
 public:
  ...
  template <typename FromT = Aws::String>
  NotifyConfigurationType& WithFrom(FromT&& value) {
  ...
  void SetReplyTo(ReplyToT&& value) {
    m_replyToHasBeenSet = true;
    m_replyTo = std::forward<ReplyToT>(value);
  }
  template <typename ReplyToT = Aws::String>
  NotifyConfigurationType& WithReplyTo(ReplyToT&& value) {
    SetReplyTo(std::forward<ReplyToT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename SourceArnT = Aws::String>
  NotifyConfigurationType& WithSourceArn(SourceArnT&& value) {
  ...
  void SetBlockEmail(BlockEmailT&& value) {
    m_blockEmailHasBeenSet = true;
    m_blockEmail = std::forward<BlockEmailT>(value);
  }
  template <typename BlockEmailT = NotifyEmailType>
  NotifyConfigurationType& WithBlockEmail(BlockEmailT&& value) {
    SetBlockEmail(std::forward<BlockEmailT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNoActionEmail(NoActionEmailT&& value) {
    m_noActionEmailHasBeenSet = true;
    m_noActionEmail = std::forward<NoActionEmailT>(value);
  }
  template <typename NoActionEmailT = NotifyEmailType>
  NotifyConfigurationType& WithNoActionEmail(NoActionEmailT&& value) {
    SetNoActionEmail(std::forward<NoActionEmailT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMfaEmail(MfaEmailT&& value) {
    m_mfaEmailHasBeenSet = true;
    m_mfaEmail = std::forward<MfaEmailT>(value);
  }
  template <typename MfaEmailT = NotifyEmailType>
  NotifyConfigurationType& WithMfaEmail(MfaEmailT&& value) {
    SetMfaEmail(std::forward<MfaEmailT>(value));
    return *this;
  }
  ///@}
 private:
