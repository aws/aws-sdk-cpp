...
class AdminSetUserSettingsResult {
 public:
  AWS_COGNITOIDENTITYPROVIDER_API AdminSetUserSettingsResult() = default;
  ...
  AWS_COGNITOIDENTITYPROVIDER_API AdminSetUserSettingsResult& operator=(
  ...
  template <typename RequestIdT = Aws::String>
  AdminSetUserSettingsResult& WithRequestId(RequestIdT&& value) {
