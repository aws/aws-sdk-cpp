...
class AdminCreateUserRequest : public CognitoIdentityProviderRequest {
 public:
  ...
  void SetValidationData(ValidationDataT&& value) {
    m_validationDataHasBeenSet = true;
    m_validationData = std::forward<ValidationDataT>(value);
  }
  template <typename ValidationDataT = Aws::Vector<AttributeType>>
  AdminCreateUserRequest& WithValidationData(ValidationDataT&& value) {
    SetValidationData(std::forward<ValidationDataT>(value));
    return *this;
  }
  template <typename ValidationDataT = AttributeType>
  AdminCreateUserRequest& AddValidationData(ValidationDataT&& value) {
    m_validationDataHasBeenSet = true;
    m_validationData.emplace_back(std::forward<ValidationDataT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTemporaryPassword(TemporaryPasswordT&& value) {
    m_temporaryPasswordHasBeenSet = true;
    m_temporaryPassword = std::forward<TemporaryPasswordT>(value);
  }
  template <typename TemporaryPasswordT = Aws::String>
  AdminCreateUserRequest& WithTemporaryPassword(TemporaryPasswordT&& value) {
    SetTemporaryPassword(std::forward<TemporaryPasswordT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetForceAliasCreation(bool value) {
    m_forceAliasCreationHasBeenSet = true;
    m_forceAliasCreation = value;
  }
  inline AdminCreateUserRequest& WithForceAliasCreation(bool value) {
    SetForceAliasCreation(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMessageAction(MessageActionType value) {
    m_messageActionHasBeenSet = true;
    m_messageAction = value;
  }
  inline AdminCreateUserRequest& WithMessageAction(MessageActionType value) {
  ...
  void SetDesiredDeliveryMediums(DesiredDeliveryMediumsT&& value) {
    m_desiredDeliveryMediumsHasBeenSet = true;
    m_desiredDeliveryMediums = std::forward<DesiredDeliveryMediumsT>(value);
  }
  template <typename DesiredDeliveryMediumsT = Aws::Vector<DeliveryMediumType>>
  AdminCreateUserRequest& WithDesiredDeliveryMediums(DesiredDeliveryMediumsT&& value) {
    SetDesiredDeliveryMediums(std::forward<DesiredDeliveryMediumsT>(value));
    return *this;
  }
  inline AdminCreateUserRequest& AddDesiredDeliveryMediums(DeliveryMediumType value) {
    m_desiredDeliveryMediumsHasBeenSet = true;
    m_desiredDeliveryMediums.push_back(value);
    return *this;
  }
  ///@}
