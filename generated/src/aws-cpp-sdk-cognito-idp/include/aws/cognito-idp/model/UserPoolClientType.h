...
class UserPoolClientType {
 public:
  ...
  template <typename UserPoolIdT = Aws::String>
  UserPoolClientType& WithUserPoolId(UserPoolIdT&& value) {
  ...
  template <typename ClientNameT = Aws::String>
  UserPoolClientType& WithClientName(ClientNameT&& value) {
  ...
  template <typename ClientIdT = Aws::String>
  UserPoolClientType& WithClientId(ClientIdT&& value) {
  ...
  template <typename ClientSecretT = Aws::String>
  UserPoolClientType& WithClientSecret(ClientSecretT&& value) {
  ...
  template <typename LastModifiedDateT = Aws::Utils::DateTime>
  UserPoolClientType& WithLastModifiedDate(LastModifiedDateT&& value) {
  ...
  template <typename CreationDateT = Aws::Utils::DateTime>
  UserPoolClientType& WithCreationDate(CreationDateT&& value) {
  ...
  inline UserPoolClientType& WithRefreshTokenValidity(int value) {
  ...
  inline UserPoolClientType& WithAccessTokenValidity(int value) {
  ...
  inline UserPoolClientType& WithIdTokenValidity(int value) {
  ...
  template <typename TokenValidityUnitsT = TokenValidityUnitsType>
  UserPoolClientType& WithTokenValidityUnits(TokenValidityUnitsT&& value) {
  ...
  template <typename ReadAttributesT = Aws::Vector<Aws::String>>
  UserPoolClientType& WithReadAttributes(ReadAttributesT&& value) {
    SetReadAttributes(std::forward<ReadAttributesT>(value));
    return *this;
  }
  template <typename ReadAttributesT = Aws::String>
  UserPoolClientType& AddReadAttributes(ReadAttributesT&& value) {
    m_readAttributesHasBeenSet = true;
  ...
  template <typename WriteAttributesT = Aws::Vector<Aws::String>>
  UserPoolClientType& WithWriteAttributes(WriteAttributesT&& value) {
    SetWriteAttributes(std::forward<WriteAttributesT>(value));
    return *this;
  }
  template <typename WriteAttributesT = Aws::String>
  UserPoolClientType& AddWriteAttributes(WriteAttributesT&& value) {
    m_writeAttributesHasBeenSet = true;
  ...
  template <typename ExplicitAuthFlowsT = Aws::Vector<ExplicitAuthFlowsType>>
  UserPoolClientType& WithExplicitAuthFlows(ExplicitAuthFlowsT&& value) {
    SetExplicitAuthFlows(std::forward<ExplicitAuthFlowsT>(value));
    return *this;
  }
  inline UserPoolClientType& AddExplicitAuthFlows(ExplicitAuthFlowsType value) {
    m_explicitAuthFlowsHasBeenSet = true;
  ...
  template <typename SupportedIdentityProvidersT = Aws::Vector<Aws::String>>
  UserPoolClientType& WithSupportedIdentityProviders(SupportedIdentityProvidersT&& value) {
  ...
  UserPoolClientType& AddSupportedIdentityProviders(SupportedIdentityProvidersT&& value) {
    m_supportedIdentityProvidersHasBeenSet = true;
  ...
  template <typename CallbackURLsT = Aws::Vector<Aws::String>>
  UserPoolClientType& WithCallbackURLs(CallbackURLsT&& value) {
    SetCallbackURLs(std::forward<CallbackURLsT>(value));
    return *this;
  }
  template <typename CallbackURLsT = Aws::String>
  UserPoolClientType& AddCallbackURLs(CallbackURLsT&& value) {
    m_callbackURLsHasBeenSet = true;
  ...
  template <typename LogoutURLsT = Aws::Vector<Aws::String>>
  UserPoolClientType& WithLogoutURLs(LogoutURLsT&& value) {
    SetLogoutURLs(std::forward<LogoutURLsT>(value));
    return *this;
  }
  template <typename LogoutURLsT = Aws::String>
  UserPoolClientType& AddLogoutURLs(LogoutURLsT&& value) {
    m_logoutURLsHasBeenSet = true;
  ...
  template <typename DefaultRedirectURIT = Aws::String>
  UserPoolClientType& WithDefaultRedirectURI(DefaultRedirectURIT&& value) {
  ...
  template <typename AllowedOAuthFlowsT = Aws::Vector<OAuthFlowType>>
  UserPoolClientType& WithAllowedOAuthFlows(AllowedOAuthFlowsT&& value) {
    SetAllowedOAuthFlows(std::forward<AllowedOAuthFlowsT>(value));
    return *this;
  }
  inline UserPoolClientType& AddAllowedOAuthFlows(OAuthFlowType value) {
    m_allowedOAuthFlowsHasBeenSet = true;
  ...
  template <typename AllowedOAuthScopesT = Aws::Vector<Aws::String>>
  UserPoolClientType& WithAllowedOAuthScopes(AllowedOAuthScopesT&& value) {
    SetAllowedOAuthScopes(std::forward<AllowedOAuthScopesT>(value));
    return *this;
  }
  template <typename AllowedOAuthScopesT = Aws::String>
  UserPoolClientType& AddAllowedOAuthScopes(AllowedOAuthScopesT&& value) {
    m_allowedOAuthScopesHasBeenSet = true;
  ...
  inline UserPoolClientType& WithAllowedOAuthFlowsUserPoolClient(bool value) {
  ...
  template <typename AnalyticsConfigurationT = AnalyticsConfigurationType>
  UserPoolClientType& WithAnalyticsConfiguration(AnalyticsConfigurationT&& value) {
  ...
  inline UserPoolClientType& WithPreventUserExistenceErrors(PreventUserExistenceErrorTypes value) {
  ...
  inline UserPoolClientType& WithEnableTokenRevocation(bool value) {
  ...
  inline UserPoolClientType& WithEnablePropagateAdditionalUserContextData(bool value) {
  ...
  inline UserPoolClientType& WithAuthSessionValidity(int value) {
  ...
  template <typename RefreshTokenRotationT = RefreshTokenRotationType>
  UserPoolClientType& WithRefreshTokenRotation(RefreshTokenRotationT&& value) {
