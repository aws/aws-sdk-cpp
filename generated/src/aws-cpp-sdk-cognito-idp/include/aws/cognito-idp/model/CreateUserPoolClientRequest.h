...
class CreateUserPoolClientRequest : public CognitoIdentityProviderRequest {
 public:
   ...
   * secrets are used with server-side and machine-to-machine applications. Client
   * secrets are automatically generated; you can't specify a secret value. For more
   * information, see <a
  ...
  inline void SetGenerateSecret(bool value) {
    m_generateSecretHasBeenSet = true;
    m_generateSecret = value;
  }
  inline CreateUserPoolClientRequest& WithGenerateSecret(bool value) {
    SetGenerateSecret(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRefreshTokenValidity(int value) {
    m_refreshTokenValidityHasBeenSet = true;
    m_refreshTokenValidity = value;
  }
  inline CreateUserPoolClientRequest& WithRefreshTokenValidity(int value) {
  ...
  inline void SetAccessTokenValidity(int value) {
    m_accessTokenValidityHasBeenSet = true;
    m_accessTokenValidity = value;
  }
  inline CreateUserPoolClientRequest& WithAccessTokenValidity(int value) {
  ...
  inline void SetIdTokenValidity(int value) {
    m_idTokenValidityHasBeenSet = true;
    m_idTokenValidity = value;
  }
  inline CreateUserPoolClientRequest& WithIdTokenValidity(int value) {
    SetIdTokenValidity(value);
    return *this;
  }
  ///@}
  ...
  void SetTokenValidityUnits(TokenValidityUnitsT&& value) {
    ...
    m_tokenValidityUnits = std::forward<TokenValidityUnitsT>(value);
  }
  template <typename TokenValidityUnitsT = TokenValidityUnitsType>
  CreateUserPoolClientRequest& WithTokenValidityUnits(TokenValidityUnitsT&& value) {
    SetTokenValidityUnits(std::forward<TokenValidityUnitsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExplicitAuthFlows(ExplicitAuthFlowsT&& value) {
    ...
    m_explicitAuthFlows = std::forward<ExplicitAuthFlowsT>(value);
  }
  template <typename ExplicitAuthFlowsT = Aws::Vector<ExplicitAuthFlowsType>>
  CreateUserPoolClientRequest& WithExplicitAuthFlows(ExplicitAuthFlowsT&& value) {
    SetExplicitAuthFlows(std::forward<ExplicitAuthFlowsT>(value));
    return *this;
  }
  inline CreateUserPoolClientRequest& AddExplicitAuthFlows(ExplicitAuthFlowsType value) {
    m_explicitAuthFlowsHasBeenSet = true;
    m_explicitAuthFlows.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetSupportedIdentityProviders(SupportedIdentityProvidersT&& value) {
    ...
    m_supportedIdentityProviders = std::forward<SupportedIdentityProvidersT>(value);
  }
  template <typename SupportedIdentityProvidersT = Aws::Vector<Aws::String>>
  CreateUserPoolClientRequest& WithSupportedIdentityProviders(SupportedIdentityProvidersT&& value) {
    SetSupportedIdentityProviders(std::forward<SupportedIdentityProvidersT>(value));
    return *this;
  }
  ...
  CreateUserPoolClientRequest& AddSupportedIdentityProviders(SupportedIdentityProvidersT&& value) {
    m_supportedIdentityProvidersHasBeenSet = true;
    m_supportedIdentityProviders.emplace_back(std::forward<SupportedIdentityProvidersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDefaultRedirectURI(DefaultRedirectURIT&& value) {
    ...
    m_defaultRedirectURI = std::forward<DefaultRedirectURIT>(value);
  }
  template <typename DefaultRedirectURIT = Aws::String>
  CreateUserPoolClientRequest& WithDefaultRedirectURI(DefaultRedirectURIT&& value) {
    SetDefaultRedirectURI(std::forward<DefaultRedirectURIT>(value));
    return *this;
  }
  ///@}
  ...
  ///@{
  /**
   * <p>The OAuth grant types that you want your app client to generate for clients
   * in managed login authentication. To create an app client that generates client
   * credentials grants, you must add <code>client_credentials</code> as the only
   * allowed OAuth flow.</p> <dl> <dt>code</dt> <dd> <p>Use a code grant flow, which
   * provides an authorization code as the response. This code can be exchanged for
   * access tokens with the <code>/oauth2/token</code> endpoint.</p> </dd>
   * <dt>implicit</dt> <dd> <p>Issue the access token, and the ID token when scopes
   * like <code>openid</code> and <code>profile</code> are requested, directly to
   * your user.</p> </dd> <dt>client_credentials</dt> <dd> <p>Issue the access token
   * from the <code>/oauth2/token</code> endpoint directly to a non-person user,
   * authorized by a combination of the client ID and client secret.</p> </dd> </dl>
   */
  ...
  void SetAllowedOAuthFlows(AllowedOAuthFlowsT&& value) {
    ...
    m_allowedOAuthFlows = std::forward<AllowedOAuthFlowsT>(value);
  }
  template <typename AllowedOAuthFlowsT = Aws::Vector<OAuthFlowType>>
  CreateUserPoolClientRequest& WithAllowedOAuthFlows(AllowedOAuthFlowsT&& value) {
    SetAllowedOAuthFlows(std::forward<AllowedOAuthFlowsT>(value));
    return *this;
  }
  inline CreateUserPoolClientRequest& AddAllowedOAuthFlows(OAuthFlowType value) {
    m_allowedOAuthFlowsHasBeenSet = true;
    m_allowedOAuthFlows.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetAllowedOAuthScopes(AllowedOAuthScopesT&& value) {
    ...
    m_allowedOAuthScopes = std::forward<AllowedOAuthScopesT>(value);
  }
  template <typename AllowedOAuthScopesT = Aws::Vector<Aws::String>>
  CreateUserPoolClientRequest& WithAllowedOAuthScopes(AllowedOAuthScopesT&& value) {
    SetAllowedOAuthScopes(std::forward<AllowedOAuthScopesT>(value));
    return *this;
  }
  ...
  CreateUserPoolClientRequest& AddAllowedOAuthScopes(AllowedOAuthScopesT&& value) {
    m_allowedOAuthScopesHasBeenSet = true;
    m_allowedOAuthScopes.emplace_back(std::forward<AllowedOAuthScopesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAllowedOAuthFlowsUserPoolClient(bool value) {
    m_allowedOAuthFlowsUserPoolClientHasBeenSet = true;
    m_allowedOAuthFlowsUserPoolClient = value;
  }
  inline CreateUserPoolClientRequest& WithAllowedOAuthFlowsUserPoolClient(bool value) {
    SetAllowedOAuthFlowsUserPoolClient(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPreventUserExistenceErrors(PreventUserExistenceErrorTypes value) {
    m_preventUserExistenceErrorsHasBeenSet = true;
    m_preventUserExistenceErrors = value;
  }
  inline CreateUserPoolClientRequest& WithPreventUserExistenceErrors(PreventUserExistenceErrorTypes value) {
    SetPreventUserExistenceErrors(value);
    return *this;
  }
  ///@}
   ...
   * revocation</a> in the target app client.</p> <p>If you don't include this
   * parameter, token revocation is automatically activated for the new user pool
   * client.</p>
   */
  ...
  inline void SetEnableTokenRevocation(bool value) {
    m_enableTokenRevocationHasBeenSet = true;
    m_enableTokenRevocation = value;
  }
  inline CreateUserPoolClientRequest& WithEnableTokenRevocation(bool value) {
    SetEnableTokenRevocation(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEnablePropagateAdditionalUserContextData(bool value) {
    ...
    m_enablePropagateAdditionalUserContextData = value;
  }
  inline CreateUserPoolClientRequest& WithEnablePropagateAdditionalUserContextData(bool value) {
    SetEnablePropagateAdditionalUserContextData(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAuthSessionValidity(int value) {
    m_authSessionValidityHasBeenSet = true;
    m_authSessionValidity = value;
  }
  inline CreateUserPoolClientRequest& WithAuthSessionValidity(int value) {
    SetAuthSessionValidity(value);
    return *this;
  }
  ///@}
  ...
  void SetRefreshTokenRotation(RefreshTokenRotationT&& value) {
    ...
    m_refreshTokenRotation = std::forward<RefreshTokenRotationT>(value);
  }
  template <typename RefreshTokenRotationT = RefreshTokenRotationType>
  CreateUserPoolClientRequest& WithRefreshTokenRotation(RefreshTokenRotationT&& value) {
    SetRefreshTokenRotation(std::forward<RefreshTokenRotationT>(value));
    return *this;
  }
  ///@}
 private:
