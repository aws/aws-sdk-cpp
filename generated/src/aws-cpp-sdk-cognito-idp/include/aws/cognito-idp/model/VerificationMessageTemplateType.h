...
class VerificationMessageTemplateType {
 public:
  ...
  template <typename SmsMessageT = Aws::String>
  VerificationMessageTemplateType& WithSmsMessage(SmsMessageT&& value) {
  ...
  template <typename EmailMessageT = Aws::String>
  VerificationMessageTemplateType& WithEmailMessage(EmailMessageT&& value) {
  ...
  template <typename EmailSubjectT = Aws::String>
  VerificationMessageTemplateType& WithEmailSubject(EmailSubjectT&& value) {
  ...
  void SetEmailMessageByLink(EmailMessageByLinkT&& value) {
    m_emailMessageByLinkHasBeenSet = true;
    m_emailMessageByLink = std::forward<EmailMessageByLinkT>(value);
  }
  template <typename EmailMessageByLinkT = Aws::String>
  VerificationMessageTemplateType& WithEmailMessageByLink(EmailMessageByLinkT&& value) {
    SetEmailMessageByLink(std::forward<EmailMessageByLinkT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEmailSubjectByLink(EmailSubjectByLinkT&& value) {
    m_emailSubjectByLinkHasBeenSet = true;
    m_emailSubjectByLink = std::forward<EmailSubjectByLinkT>(value);
  }
  template <typename EmailSubjectByLinkT = Aws::String>
  VerificationMessageTemplateType& WithEmailSubjectByLink(EmailSubjectByLinkT&& value) {
    SetEmailSubjectByLink(std::forward<EmailSubjectByLinkT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetDefaultEmailOption(DefaultEmailOptionType value) {
    m_defaultEmailOptionHasBeenSet = true;
    m_defaultEmailOption = value;
  }
  inline VerificationMessageTemplateType& WithDefaultEmailOption(DefaultEmailOptionType value) {
    SetDefaultEmailOption(value);
    return *this;
  }
  ///@}
 private:
