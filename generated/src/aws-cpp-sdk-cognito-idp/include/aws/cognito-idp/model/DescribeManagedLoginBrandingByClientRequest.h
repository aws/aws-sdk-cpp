...
class DescribeManagedLoginBrandingByClientRequest : public CognitoIdentityProviderRequest {
 public:
  ...
  template <typename UserPoolIdT = Aws::String>
  DescribeManagedLoginBrandingByClientRequest& WithUserPoolId(UserPoolIdT&& value) {
  ...
  template <typename ClientIdT = Aws::String>
  DescribeManagedLoginBrandingByClientRequest& WithClientId(ClientIdT&& value) {
  ...
  inline void SetReturnMergedResources(bool value) {
    m_returnMergedResourcesHasBeenSet = true;
    m_returnMergedResources = value;
  }
  inline DescribeManagedLoginBrandingByClientRequest& WithReturnMergedResources(bool value) {
    SetReturnMergedResources(value);
    return *this;
  }
  ///@}
 private:
