...
class AdminUserGlobalSignOutResult {
 public:
  AWS_COGNITOIDENTITYPROVIDER_API AdminUserGlobalSignOutResult() = default;
  ...
  AWS_COGNITOIDENTITYPROVIDER_API AdminUserGlobalSignOutResult& operator=(
  ...
  template <typename RequestIdT = Aws::String>
  AdminUserGlobalSignOutResult& WithRequestId(RequestIdT&& value) {
