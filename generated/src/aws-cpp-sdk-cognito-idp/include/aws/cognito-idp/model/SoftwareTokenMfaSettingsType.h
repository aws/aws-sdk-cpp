...
class SoftwareTokenMfaSettingsType {
 public:
  ...
  inline SoftwareTokenMfaSettingsType& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPreferredMfa(bool value) {
    m_preferredMfaHasBeenSet = true;
    m_preferredMfa = value;
  }
  inline SoftwareTokenMfaSettingsType& WithPreferredMfa(bool value) {
