...
class AdminDeleteUserAttributesRequest : public CognitoIdentityProviderRequest {
 public:
  ...
  void SetUserAttributeNames(UserAttributeNamesT&& value) {
    m_userAttributeNamesHasBeenSet = true;
    m_userAttributeNames = std::forward<UserAttributeNamesT>(value);
  }
  template <typename UserAttributeNamesT = Aws::Vector<Aws::String>>
  AdminDeleteUserAttributesRequest& WithUserAttributeNames(UserAttributeNamesT&& value) {
    SetUserAttributeNames(std::forward<UserAttributeNamesT>(value));
    return *this;
  }
  ...
  AdminDeleteUserAttributesRequest& AddUserAttributeNames(UserAttributeNamesT&& value) {
    m_userAttributeNamesHasBeenSet = true;
    m_userAttributeNames.emplace_back(std::forward<UserAttributeNamesT>(value));
    return *this;
  }
  ///@}
 private:
