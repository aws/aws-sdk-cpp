...
class GetLogDeliveryConfigurationResult {
 public:
  ...
  AWS_COGNITOIDENTITYPROVIDER_API GetLogDeliveryConfigurationResult& operator=(
  ...
  template <typename LogDeliveryConfigurationT = LogDeliveryConfigurationType>
  GetLogDeliveryConfigurationResult& WithLogDeliveryConfiguration(LogDeliveryConfigurationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetLogDeliveryConfigurationResult& WithRequestId(RequestIdT&& value) {
