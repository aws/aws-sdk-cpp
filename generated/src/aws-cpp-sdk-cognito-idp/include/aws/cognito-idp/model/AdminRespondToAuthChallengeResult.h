...
class AdminRespondToAuthChallengeResult {
 public:
  ...
  AWS_COGNITOIDENTITYPROVIDER_API AdminRespondToAuthChallengeResult& operator=(
  ...
  inline AdminRespondToAuthChallengeResult& WithChallengeName(ChallengeNameType value) {
