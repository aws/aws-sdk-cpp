...
namespace Model
{
  ...
  public:
    ...
    template<typename SessionT = Aws::String>
    AdminRespondToAuthChallengeResult& WithSession(SessionT&& value) { SetSession(std::forward<SessionT>(value)); return *this;}
    ///@}
    ...
    template<typename ChallengeParametersT = Aws::Map<Aws::String, Aws::String>>
    AdminRespondToAuthChallengeResult& WithChallengeParameters(ChallengeParametersT&& value) { SetChallengeParameters(std::forward<ChallengeParametersT>(value)); return *this;}
    ...
    template<typename AuthenticationResultT = AuthenticationResultType>
    AdminRespondToAuthChallengeResult& WithAuthenticationResult(AuthenticationResultT&& value) { SetAuthenticationResult(std::forward<AuthenticationResultT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    AdminRespondToAuthChallengeResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
