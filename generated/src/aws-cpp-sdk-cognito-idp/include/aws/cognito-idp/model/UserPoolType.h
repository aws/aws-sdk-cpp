...
class UserPoolType {
 public:
  ...
  template <typename NameT = Aws::String>
  UserPoolType& WithName(NameT&& value) {
  ...
  template <typename PoliciesT = UserPoolPolicyType>
  UserPoolType& WithPolicies(PoliciesT&& value) {
  ...
  inline UserPoolType& WithDeletionProtection(DeletionProtectionType value) {
  ...
  template <typename LambdaConfigT = LambdaConfigType>
  UserPoolType& WithLambdaConfig(LambdaConfigT&& value) {
  ...
  template <typename LastModifiedDateT = Aws::Utils::DateTime>
  UserPoolType& WithLastModifiedDate(LastModifiedDateT&& value) {
  ...
  template <typename CreationDateT = Aws::Utils::DateTime>
  UserPoolType& WithCreationDate(CreationDateT&& value) {
  ...
  void SetSchemaAttributes(SchemaAttributesT&& value) {
    m_schemaAttributesHasBeenSet = true;
    m_schemaAttributes = std::forward<SchemaAttributesT>(value);
  }
  template <typename SchemaAttributesT = Aws::Vector<SchemaAttributeType>>
  UserPoolType& WithSchemaAttributes(SchemaAttributesT&& value) {
    SetSchemaAttributes(std::forward<SchemaAttributesT>(value));
    return *this;
  }
  template <typename SchemaAttributesT = SchemaAttributeType>
  UserPoolType& AddSchemaAttributes(SchemaAttributesT&& value) {
    m_schemaAttributesHasBeenSet = true;
    m_schemaAttributes.emplace_back(std::forward<SchemaAttributesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename AutoVerifiedAttributesT = Aws::Vector<VerifiedAttributeType>>
  UserPoolType& WithAutoVerifiedAttributes(AutoVerifiedAttributesT&& value) {
    SetAutoVerifiedAttributes(std::forward<AutoVerifiedAttributesT>(value));
    return *this;
  }
  inline UserPoolType& AddAutoVerifiedAttributes(VerifiedAttributeType value) {
    m_autoVerifiedAttributesHasBeenSet = true;
  ...
  template <typename AliasAttributesT = Aws::Vector<AliasAttributeType>>
  UserPoolType& WithAliasAttributes(AliasAttributesT&& value) {
    SetAliasAttributes(std::forward<AliasAttributesT>(value));
    return *this;
  }
  inline UserPoolType& AddAliasAttributes(AliasAttributeType value) {
    m_aliasAttributesHasBeenSet = true;
  ...
  template <typename UsernameAttributesT = Aws::Vector<UsernameAttributeType>>
  UserPoolType& WithUsernameAttributes(UsernameAttributesT&& value) {
    SetUsernameAttributes(std::forward<UsernameAttributesT>(value));
    return *this;
  }
  inline UserPoolType& AddUsernameAttributes(UsernameAttributeType value) {
    m_usernameAttributesHasBeenSet = true;
  ...
  template <typename SmsVerificationMessageT = Aws::String>
  UserPoolType& WithSmsVerificationMessage(SmsVerificationMessageT&& value) {
  ...
  template <typename EmailVerificationMessageT = Aws::String>
  UserPoolType& WithEmailVerificationMessage(EmailVerificationMessageT&& value) {
  ...
  template <typename EmailVerificationSubjectT = Aws::String>
  UserPoolType& WithEmailVerificationSubject(EmailVerificationSubjectT&& value) {
  ...
  template <typename VerificationMessageTemplateT = VerificationMessageTemplateType>
  UserPoolType& WithVerificationMessageTemplate(VerificationMessageTemplateT&& value) {
  ...
  template <typename SmsAuthenticationMessageT = Aws::String>
  UserPoolType& WithSmsAuthenticationMessage(SmsAuthenticationMessageT&& value) {
  ...
  template <typename UserAttributeUpdateSettingsT = UserAttributeUpdateSettingsType>
  UserPoolType& WithUserAttributeUpdateSettings(UserAttributeUpdateSettingsT&& value) {
  ...
  inline UserPoolType& WithMfaConfiguration(UserPoolMfaType value) {
  ...
  template <typename DeviceConfigurationT = DeviceConfigurationType>
  UserPoolType& WithDeviceConfiguration(DeviceConfigurationT&& value) {
  ...
  inline void SetEstimatedNumberOfUsers(int value) {
    m_estimatedNumberOfUsersHasBeenSet = true;
    m_estimatedNumberOfUsers = value;
  }
  inline UserPoolType& WithEstimatedNumberOfUsers(int value) {
    SetEstimatedNumberOfUsers(value);
    return *this;
  }
  ///@}
  ...
  template <typename EmailConfigurationT = EmailConfigurationType>
  UserPoolType& WithEmailConfiguration(EmailConfigurationT&& value) {
  ...
  template <typename SmsConfigurationT = SmsConfigurationType>
  UserPoolType& WithSmsConfiguration(SmsConfigurationT&& value) {
  ...
  template <typename UserPoolTagsT = Aws::Map<Aws::String, Aws::String>>
  UserPoolType& WithUserPoolTags(UserPoolTagsT&& value) {
  ...
  void SetSmsConfigurationFailure(SmsConfigurationFailureT&& value) {
    m_smsConfigurationFailureHasBeenSet = true;
    m_smsConfigurationFailure = std::forward<SmsConfigurationFailureT>(value);
  }
  template <typename SmsConfigurationFailureT = Aws::String>
  UserPoolType& WithSmsConfigurationFailure(SmsConfigurationFailureT&& value) {
    SetSmsConfigurationFailure(std::forward<SmsConfigurationFailureT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEmailConfigurationFailure(EmailConfigurationFailureT&& value) {
    m_emailConfigurationFailureHasBeenSet = true;
    m_emailConfigurationFailure = std::forward<EmailConfigurationFailureT>(value);
  }
  template <typename EmailConfigurationFailureT = Aws::String>
  UserPoolType& WithEmailConfigurationFailure(EmailConfigurationFailureT&& value) {
    SetEmailConfigurationFailure(std::forward<EmailConfigurationFailureT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename DomainT = Aws::String>
  UserPoolType& WithDomain(DomainT&& value) {
  ...
  template <typename CustomDomainT = Aws::String>
  UserPoolType& WithCustomDomain(CustomDomainT&& value) {
  ...
  template <typename AdminCreateUserConfigT = AdminCreateUserConfigType>
  UserPoolType& WithAdminCreateUserConfig(AdminCreateUserConfigT&& value) {
  ...
  template <typename UserPoolAddOnsT = UserPoolAddOnsType>
  UserPoolType& WithUserPoolAddOns(UserPoolAddOnsT&& value) {
  ...
  template <typename UsernameConfigurationT = UsernameConfigurationType>
  UserPoolType& WithUsernameConfiguration(UsernameConfigurationT&& value) {
  ...
  template <typename ArnT = Aws::String>
  UserPoolType& WithArn(ArnT&& value) {
  ...
  template <typename AccountRecoverySettingT = AccountRecoverySettingType>
  UserPoolType& WithAccountRecoverySetting(AccountRecoverySettingT&& value) {
  ...
  inline UserPoolType& WithUserPoolTier(UserPoolTierType value) {
