...
class NewDeviceMetadataType {
 public:
  ...
  template <typename DeviceKeyT = Aws::String>
  NewDeviceMetadataType& WithDeviceKey(DeviceKeyT&& value) {
  ...
  void SetDeviceGroupKey(DeviceGroupKeyT&& value) {
    m_deviceGroupKeyHasBeenSet = true;
    m_deviceGroupKey = std::forward<DeviceGroupKeyT>(value);
  }
  template <typename DeviceGroupKeyT = Aws::String>
  NewDeviceMetadataType& WithDeviceGroupKey(DeviceGroupKeyT&& value) {
    SetDeviceGroupKey(std::forward<DeviceGroupKeyT>(value));
    return *this;
  }
  ///@}
 private:
