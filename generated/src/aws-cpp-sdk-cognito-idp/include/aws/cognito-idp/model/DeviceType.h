...
class DeviceType {
 public:
  ...
  template <typename DeviceKeyT = Aws::String>
  DeviceType& WithDeviceKey(DeviceKeyT&& value) {
  ...
  void SetDeviceAttributes(DeviceAttributesT&& value) {
    m_deviceAttributesHasBeenSet = true;
    m_deviceAttributes = std::forward<DeviceAttributesT>(value);
  }
  template <typename DeviceAttributesT = Aws::Vector<AttributeType>>
  DeviceType& WithDeviceAttributes(DeviceAttributesT&& value) {
    SetDeviceAttributes(std::forward<DeviceAttributesT>(value));
    return *this;
  }
  template <typename DeviceAttributesT = AttributeType>
  DeviceType& AddDeviceAttributes(DeviceAttributesT&& value) {
    m_deviceAttributesHasBeenSet = true;
    m_deviceAttributes.emplace_back(std::forward<DeviceAttributesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDeviceCreateDate(DeviceCreateDateT&& value) {
    m_deviceCreateDateHasBeenSet = true;
    m_deviceCreateDate = std::forward<DeviceCreateDateT>(value);
  }
  template <typename DeviceCreateDateT = Aws::Utils::DateTime>
  DeviceType& WithDeviceCreateDate(DeviceCreateDateT&& value) {
    SetDeviceCreateDate(std::forward<DeviceCreateDateT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename DeviceLastModifiedDateT = Aws::Utils::DateTime>
  DeviceType& WithDeviceLastModifiedDate(DeviceLastModifiedDateT&& value) {
  ...
  void SetDeviceLastAuthenticatedDate(DeviceLastAuthenticatedDateT&& value) {
    m_deviceLastAuthenticatedDateHasBeenSet = true;
    m_deviceLastAuthenticatedDate = std::forward<DeviceLastAuthenticatedDateT>(value);
  }
  template <typename DeviceLastAuthenticatedDateT = Aws::Utils::DateTime>
  DeviceType& WithDeviceLastAuthenticatedDate(DeviceLastAuthenticatedDateT&& value) {
    SetDeviceLastAuthenticatedDate(std::forward<DeviceLastAuthenticatedDateT>(value));
    return *this;
  }
  ///@}
 private:
