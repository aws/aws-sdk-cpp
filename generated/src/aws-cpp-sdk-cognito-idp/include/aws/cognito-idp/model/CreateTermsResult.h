...
namespace Model
{
  ...
  public:
    ...
    template<typename TermsT = TermsType>
    CreateTermsResult& WithTerms(TermsT&& value) { SetTerms(std::forward<TermsT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateTermsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
