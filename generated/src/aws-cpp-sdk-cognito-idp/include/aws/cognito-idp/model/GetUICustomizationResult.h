...
class GetUICustomizationResult {
 public:
  ...
  AWS_COGNITOIDENTITYPROVIDER_API GetUICustomizationResult& operator=(
  ...
  template <typename UICustomizationT = UICustomizationType>
  GetUICustomizationResult& WithUICustomization(UICustomizationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetUICustomizationResult& WithRequestId(RequestIdT&& value) {
