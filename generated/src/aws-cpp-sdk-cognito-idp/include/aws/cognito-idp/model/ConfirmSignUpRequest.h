...
class ConfirmSignUpRequest : public CognitoIdentityProviderRequest {
 public:
  ...
  template <typename ClientIdT = Aws::String>
  ConfirmSignUpRequest& WithClientId(ClientIdT&& value) {
  ...
  template <typename SecretHashT = Aws::String>
  ConfirmSignUpRequest& WithSecretHash(SecretHashT&& value) {
  ...
  template <typename UsernameT = Aws::String>
  ConfirmSignUpRequest& WithUsername(UsernameT&& value) {
  ...
  template <typename ConfirmationCodeT = Aws::String>
  ConfirmSignUpRequest& WithConfirmationCode(ConfirmationCodeT&& value) {
  ...
  inline ConfirmSignUpRequest& WithForceAliasCreation(bool value) {
  ...
  template <typename AnalyticsMetadataT = AnalyticsMetadataType>
  ConfirmSignUpRequest& WithAnalyticsMetadata(AnalyticsMetadataT&& value) {
  ...
  template <typename UserContextDataT = UserContextDataType>
  ConfirmSignUpRequest& WithUserContextData(UserContextDataT&& value) {
  ...
  template <typename ClientMetadataT = Aws::Map<Aws::String, Aws::String>>
  ConfirmSignUpRequest& WithClientMetadata(ClientMetadataT&& value) {
  ...
  template <typename SessionT = Aws::String>
  ConfirmSignUpRequest& WithSession(SessionT&& value) {
