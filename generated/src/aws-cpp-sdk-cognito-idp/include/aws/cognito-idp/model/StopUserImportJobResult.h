...
namespace Model
{
  ...
  {
  public:
    AWS_COGNITOIDENTITYPROVIDER_API StopUserImportJobResult() = default;
    ...
    template<typename UserImportJobT = UserImportJobType>
    StopUserImportJobResult& WithUserImportJob(UserImportJobT&& value) { SetUserImportJob(std::forward<UserImportJobT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    StopUserImportJobResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
