...
class UpdateDeviceStatusRequest : public CognitoIdentityProviderRequest {
 public:
  ...
  template <typename AccessTokenT = Aws::String>
  UpdateDeviceStatusRequest& WithAccessToken(AccessTokenT&& value) {
  ...
  template <typename DeviceKeyT = Aws::String>
  UpdateDeviceStatusRequest& WithDeviceKey(DeviceKeyT&& value) {
  ...
  inline void SetDeviceRememberedStatus(DeviceRememberedStatusType value) {
    m_deviceRememberedStatusHasBeenSet = true;
    m_deviceRememberedStatus = value;
  }
  inline UpdateDeviceStatusRequest& WithDeviceRememberedStatus(DeviceRememberedStatusType value) {
    SetDeviceRememberedStatus(value);
    return *this;
  }
  ///@}
 private:
