...
namespace Model
{
  ...
  {
  public:
    AWS_COGNITOIDENTITYPROVIDER_API ConfirmForgotPasswordRequest() = default;
    ...
    ///@{
    /**
     * <p>The ID of the app client where the user wants to reset their password. This
    ...
    template<typename ClientIdT = Aws::String>
    ConfirmForgotPasswordRequest& WithClientId(ClientIdT&& value) { SetClientId(std::forward<ClientIdT>(value)); return *this;}
    ///@}
    ...
    template<typename SecretHashT = Aws::String>
    ConfirmForgotPasswordRequest& WithSecretHash(SecretHashT&& value) { SetSecretHash(std::forward<SecretHashT>(value)); return *this;}
    ///@}
    ...
    template<typename UsernameT = Aws::String>
    ConfirmForgotPasswordRequest& WithUsername(UsernameT&& value) { SetUsername(std::forward<UsernameT>(value)); return *this;}
    ///@}

    ///@{
    /**
     * <p>The confirmation code that your user pool delivered when your user requested
    ...
    template<typename ConfirmationCodeT = Aws::String>
    ConfirmForgotPasswordRequest& WithConfirmationCode(ConfirmationCodeT&& value) { SetConfirmationCode(std::forward<ConfirmationCodeT>(value)); return *this;}
    ///@}
    ...
    template<typename PasswordT = Aws::String>
    ConfirmForgotPasswordRequest& WithPassword(PasswordT&& value) { SetPassword(std::forward<PasswordT>(value)); return *this;}
    ///@}
    ...
    template<typename AnalyticsMetadataT = AnalyticsMetadataType>
    ConfirmForgotPasswordRequest& WithAnalyticsMetadata(AnalyticsMetadataT&& value) { SetAnalyticsMetadata(std::forward<AnalyticsMetadataT>(value)); return *this;}
    ///@}
    ...
    template<typename UserContextDataT = UserContextDataType>
    ConfirmForgotPasswordRequest& WithUserContextData(UserContextDataT&& value) { SetUserContextData(std::forward<UserContextDataT>(value)); return *this;}
    ///@}
    ...
    template<typename ClientMetadataT = Aws::Map<Aws::String, Aws::String>>
    ConfirmForgotPasswordRequest& WithClientMetadata(ClientMetadataT&& value) { SetClientMetadata(std::forward<ClientMetadataT>(value)); return *this;}
    template<typename ClientMetadataKeyT = Aws::String, typename ClientMetadataValueT = Aws::String>
    ConfirmForgotPasswordRequest& AddClientMetadata(ClientMetadataKeyT&& key, ClientMetadataValueT&& value) {
