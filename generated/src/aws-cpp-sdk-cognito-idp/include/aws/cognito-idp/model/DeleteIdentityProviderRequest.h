...
namespace Model
{
  ...
  {
  public:
    AWS_COGNITOIDENTITYPROVIDER_API DeleteIdentityProviderRequest() = default;
    ...
    template<typename UserPoolIdT = Aws::String>
    DeleteIdentityProviderRequest& WithUserPoolId(UserPoolIdT&& value) { SetUserPoolId(std::forward<UserPoolIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ProviderNameT = Aws::String>
    DeleteIdentityProviderRequest& WithProviderName(ProviderNameT&& value) { SetProviderName(std::forward<ProviderNameT>(value)); return *this;}
    ///@}
  private:
