...
class ListUsersInGroupRequest : public CognitoIdentityProviderRequest {
 public:
  AWS_COGNITOIDENTITYPROVIDER_API ListUsersInGroupRequest() = default;
  ...
  ///@{
  /**
   * <p>The ID of the user pool where you want to view the membership of the
   * requested group.</p>
   */
  ...
  template <typename UserPoolIdT = Aws::String>
  ListUsersInGroupRequest& WithUserPoolId(UserPoolIdT&& value) {
  ...
  template <typename GroupNameT = Aws::String>
  ListUsersInGroupRequest& WithGroupName(GroupNameT&& value) {
  ...
  inline ListUsersInGroupRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListUsersInGroupRequest& WithNextToken(NextTokenT&& value) {
