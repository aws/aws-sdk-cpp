...
class RecoveryOptionType {
 public:
  ...
  inline RecoveryOptionType& WithPriority(int value) {
    SetPriority(value);
    return *this;
  }
  ///@}
  ...
  inline void SetName(RecoveryOptionNameType value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline RecoveryOptionType& WithName(RecoveryOptionNameType value) {
    SetName(value);
    return *this;
  }
  ///@}
