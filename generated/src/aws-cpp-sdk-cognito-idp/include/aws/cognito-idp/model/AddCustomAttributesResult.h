...
class AddCustomAttributesResult {
 public:
  AWS_COGNITOIDENTITYPROVIDER_API AddCustomAttributesResult() = default;
  ...
  AWS_COGNITOIDENTITYPROVIDER_API AddCustomAttributesResult& operator=(
  ...
  template <typename RequestIdT = Aws::String>
  AddCustomAttributesResult& WithRequestId(RequestIdT&& value) {
