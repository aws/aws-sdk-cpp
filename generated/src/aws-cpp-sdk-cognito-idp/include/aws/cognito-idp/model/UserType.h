...
class UserType {
 public:
  ...
  template <typename UsernameT = Aws::String>
  UserType& WithUsername(UsernameT&& value) {
  ...
  void SetUserCreateDate(UserCreateDateT&& value) {
    ...
    m_userCreateDate = std::forward<UserCreateDateT>(value);
  }
  template <typename UserCreateDateT = Aws::Utils::DateTime>
  UserType& WithUserCreateDate(UserCreateDateT&& value) {
    SetUserCreateDate(std::forward<UserCreateDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUserLastModifiedDate(UserLastModifiedDateT&& value) {
    ...
    m_userLastModifiedDate = std::forward<UserLastModifiedDateT>(value);
  }
  template <typename UserLastModifiedDateT = Aws::Utils::DateTime>
  UserType& WithUserLastModifiedDate(UserLastModifiedDateT&& value) {
    SetUserLastModifiedDate(std::forward<UserLastModifiedDateT>(value));
    return *this;
  }
  ///@}
  ...
  inline UserType& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUserStatus(UserStatusType value) {
    m_userStatusHasBeenSet = true;
    m_userStatus = value;
  }
  inline UserType& WithUserStatus(UserStatusType value) {
    SetUserStatus(value);
    return *this;
  }
  ///@}
