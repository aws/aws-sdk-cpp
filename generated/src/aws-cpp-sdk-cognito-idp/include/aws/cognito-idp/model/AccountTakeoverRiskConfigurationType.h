...
class AccountTakeoverRiskConfigurationType {
 public:
  ...
  void SetNotifyConfiguration(NotifyConfigurationT&& value) {
    m_notifyConfigurationHasBeenSet = true;
    m_notifyConfiguration = std::forward<NotifyConfigurationT>(value);
  }
  template <typename NotifyConfigurationT = NotifyConfigurationType>
  AccountTakeoverRiskConfigurationType& WithNotifyConfiguration(NotifyConfigurationT&& value) {
    SetNotifyConfiguration(std::forward<NotifyConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ActionsT = AccountTakeoverActionsType>
  AccountTakeoverRiskConfigurationType& WithActions(ActionsT&& value) {
