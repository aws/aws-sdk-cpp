...
class UserPoolDescriptionType {
 public:
  ...
  template <typename IdT = Aws::String>
  UserPoolDescriptionType& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  UserPoolDescriptionType& WithName(NameT&& value) {
  ...
  template <typename LambdaConfigT = LambdaConfigType>
  UserPoolDescriptionType& WithLambdaConfig(LambdaConfigT&& value) {
  ...
  template <typename LastModifiedDateT = Aws::Utils::DateTime>
  UserPoolDescriptionType& WithLastModifiedDate(LastModifiedDateT&& value) {
  ...
  template <typename CreationDateT = Aws::Utils::DateTime>
  UserPoolDescriptionType& WithCreationDate(CreationDateT&& value) {
