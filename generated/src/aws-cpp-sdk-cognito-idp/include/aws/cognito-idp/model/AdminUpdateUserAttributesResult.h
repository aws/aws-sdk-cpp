...
class AdminUpdateUserAttributesResult {
 public:
  AWS_COGNITOIDENTITYPROVIDER_API AdminUpdateUserAttributesResult() = default;
  ...
  AWS_COGNITOIDENTITYPROVIDER_API AdminUpdateUserAttributesResult& operator=(
  ...
  template <typename RequestIdT = Aws::String>
  AdminUpdateUserAttributesResult& WithRequestId(RequestIdT&& value) {
