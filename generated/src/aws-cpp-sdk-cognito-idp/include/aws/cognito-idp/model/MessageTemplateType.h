...
class MessageTemplateType {
 public:
  ...
  template <typename SMSMessageT = Aws::String>
  MessageTemplateType& WithSMSMessage(SMSMessageT&& value) {
  ...
  template <typename EmailMessageT = Aws::String>
  MessageTemplateType& WithEmailMessage(EmailMessageT&& value) {
  ...
  template <typename EmailSubjectT = Aws::String>
  MessageTemplateType& WithEmailSubject(EmailSubjectT&& value) {
