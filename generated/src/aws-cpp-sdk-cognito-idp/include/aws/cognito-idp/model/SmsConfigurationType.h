...
class SmsConfigurationType {
 public:
  ...
  void SetSnsCallerArn(SnsCallerArnT&& value) {
    m_snsCallerArnHasBeenSet = true;
    m_snsCallerArn = std::forward<SnsCallerArnT>(value);
  }
  template <typename SnsCallerArnT = Aws::String>
  SmsConfigurationType& WithSnsCallerArn(SnsCallerArnT&& value) {
    SetSnsCallerArn(std::forward<SnsCallerArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ExternalIdT = Aws::String>
  SmsConfigurationType& WithExternalId(ExternalIdT&& value) {
  ...
  void SetSnsRegion(SnsRegionT&& value) {
    m_snsRegionHasBeenSet = true;
    m_snsRegion = std::forward<SnsRegionT>(value);
  }
  template <typename SnsRegionT = Aws::String>
  SmsConfigurationType& WithSnsRegion(SnsRegionT&& value) {
    SetSnsRegion(std::forward<SnsRegionT>(value));
    return *this;
  }
  ///@}
 private:
