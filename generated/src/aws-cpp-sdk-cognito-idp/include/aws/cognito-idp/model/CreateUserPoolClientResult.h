...
class CreateUserPoolClientResult {
 public:
  ...
  AWS_COGNITOIDENTITYPROVIDER_API CreateUserPoolClientResult& operator=(
  ...
  template <typename UserPoolClientT = UserPoolClientType>
  CreateUserPoolClientResult& WithUserPoolClient(UserPoolClientT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateUserPoolClientResult& WithRequestId(RequestIdT&& value) {
