...
class PasswordPolicyType {
 public:
  ...
  inline void SetMinimumLength(int value) {
    m_minimumLengthHasBeenSet = true;
    m_minimumLength = value;
  }
  inline PasswordPolicyType& WithMinimumLength(int value) {
  ...
  inline void SetRequireUppercase(bool value) {
    m_requireUppercaseHasBeenSet = true;
    m_requireUppercase = value;
  }
  inline PasswordPolicyType& WithRequireUppercase(bool value) {
    SetRequireUppercase(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRequireLowercase(bool value) {
    m_requireLowercaseHasBeenSet = true;
    m_requireLowercase = value;
  }
  inline PasswordPolicyType& WithRequireLowercase(bool value) {
    SetRequireLowercase(value);
    return *this;
  }
  ///@}
  ...
  inline PasswordPolicyType& WithRequireNumbers(bool value) {
  ...
  inline PasswordPolicyType& WithRequireSymbols(bool value) {
  ...
  inline void SetPasswordHistorySize(int value) {
    m_passwordHistorySizeHasBeenSet = true;
    m_passwordHistorySize = value;
  }
  inline PasswordPolicyType& WithPasswordHistorySize(int value) {
    SetPasswordHistorySize(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTemporaryPasswordValidityDays(int value) {
    m_temporaryPasswordValidityDaysHasBeenSet = true;
    m_temporaryPasswordValidityDays = value;
  }
  inline PasswordPolicyType& WithTemporaryPasswordValidityDays(int value) {
    SetTemporaryPasswordValidityDays(value);
    return *this;
  }
  ///@}
 private:
