...
class SetUserMFAPreferenceRequest : public CognitoIdentityProviderRequest {
 public:
  ...
  template <typename SMSMfaSettingsT = SMSMfaSettingsType>
  SetUserMFAPreferenceRequest& WithSMSMfaSettings(SMSMfaSettingsT&& value) {
  ...
  template <typename SoftwareTokenMfaSettingsT = SoftwareTokenMfaSettingsType>
  SetUserMFAPreferenceRequest& WithSoftwareTokenMfaSettings(SoftwareTokenMfaSettingsT&& value) {
  ...
  template <typename EmailMfaSettingsT = EmailMfaSettingsType>
  SetUserMFAPreferenceRequest& WithEmailMfaSettings(EmailMfaSettingsT&& value) {
  ...
  template <typename AccessTokenT = Aws::String>
  SetUserMFAPreferenceRequest& WithAccessToken(AccessTokenT&& value) {
