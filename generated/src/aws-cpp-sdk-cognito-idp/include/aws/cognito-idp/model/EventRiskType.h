...
class EventRiskType {
 public:
  ...
  inline void SetRiskDecision(RiskDecisionType value) {
    m_riskDecisionHasBeenSet = true;
    m_riskDecision = value;
  }
  inline EventRiskType& WithRiskDecision(RiskDecisionType value) {
    SetRiskDecision(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRiskLevel(RiskLevelType value) {
    m_riskLevelHasBeenSet = true;
    m_riskLevel = value;
  }
  inline EventRiskType& WithRiskLevel(RiskLevelType value) {
    SetRiskLevel(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCompromisedCredentialsDetected(bool value) {
    m_compromisedCredentialsDetectedHasBeenSet = true;
    m_compromisedCredentialsDetected = value;
  }
  inline EventRiskType& WithCompromisedCredentialsDetected(bool value) {
    SetCompromisedCredentialsDetected(value);
    return *this;
  }
  ///@}
 private:
