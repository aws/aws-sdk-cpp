...
class DescribeIdentityProviderResult {
 public:
  ...
  AWS_COGNITOIDENTITYPROVIDER_API DescribeIdentityProviderResult& operator=(
  ...
  template <typename IdentityProviderT = IdentityProviderType>
  DescribeIdentityProviderResult& WithIdentityProvider(IdentityProviderT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeIdentityProviderResult& WithRequestId(RequestIdT&& value) {
