...
class DeleteUserAttributesResult {
 public:
  AWS_COGNITOIDENTITYPROVIDER_API DeleteUserAttributesResult() = default;
  ...
  AWS_COGNITOIDENTITYPROVIDER_API DeleteUserAttributesResult& operator=(
  ...
  template <typename RequestIdT = Aws::String>
  DeleteUserAttributesResult& WithRequestId(RequestIdT&& value) {
