...
class AdminResetUserPasswordResult {
 public:
  AWS_COGNITOIDENTITYPROVIDER_API AdminResetUserPasswordResult() = default;
  ...
  AWS_COGNITOIDENTITYPROVIDER_API AdminResetUserPasswordResult& operator=(
  ...
  template <typename RequestIdT = Aws::String>
  AdminResetUserPasswordResult& WithRequestId(RequestIdT&& value) {
