...
class TokenValidityUnitsType {
 public:
  ...
  inline void SetAccessToken(TimeUnitsType value) {
    m_accessTokenHasBeenSet = true;
    m_accessToken = value;
  }
  inline TokenValidityUnitsType& WithAccessToken(TimeUnitsType value) {
  ...
  inline void SetIdToken(TimeUnitsType value) {
    m_idTokenHasBeenSet = true;
    m_idToken = value;
  }
  inline TokenValidityUnitsType& WithIdToken(TimeUnitsType value) {
    SetIdToken(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRefreshToken(TimeUnitsType value) {
    m_refreshTokenHasBeenSet = true;
    m_refreshToken = value;
  }
  inline TokenValidityUnitsType& WithRefreshToken(TimeUnitsType value) {
