...
class AnalyticsMetadataType {
 public:
  ...
  void SetAnalyticsEndpointId(AnalyticsEndpointIdT&& value) {
    m_analyticsEndpointIdHasBeenSet = true;
    m_analyticsEndpointId = std::forward<AnalyticsEndpointIdT>(value);
  }
  template <typename AnalyticsEndpointIdT = Aws::String>
  AnalyticsMetadataType& WithAnalyticsEndpointId(AnalyticsEndpointIdT&& value) {
    SetAnalyticsEndpointId(std::forward<AnalyticsEndpointIdT>(value));
    return *this;
  }
  ///@}
 private:
