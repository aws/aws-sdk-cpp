...
class AdminRespondToAuthChallengeRequest : public CognitoIdentityProviderRequest {
 public:
  ...
  template <typename UserPoolIdT = Aws::String>
  AdminRespondToAuthChallengeRequest& WithUserPoolId(UserPoolIdT&& value) {
  ...
  template <typename ClientIdT = Aws::String>
  AdminRespondToAuthChallengeRequest& WithClientId(ClientIdT&& value) {
  ...
  inline AdminRespondToAuthChallengeRequest& WithChallengeName(ChallengeNameType value) {
  ...
  template <typename ChallengeResponsesT = Aws::Map<Aws::String, Aws::String>>
  AdminRespondToAuthChallengeRequest& WithChallengeResponses(ChallengeResponsesT&& value) {
  ...
  template <typename SessionT = Aws::String>
  AdminRespondToAuthChallengeRequest& WithSession(SessionT&& value) {
  ...
  template <typename AnalyticsMetadataT = AnalyticsMetadataType>
  AdminRespondToAuthChallengeRequest& WithAnalyticsMetadata(AnalyticsMetadataT&& value) {
  ...
  template <typename ContextDataT = ContextDataType>
  AdminRespondToAuthChallengeRequest& WithContextData(ContextDataT&& value) {
  ...
  template <typename ClientMetadataT = Aws::Map<Aws::String, Aws::String>>
  AdminRespondToAuthChallengeRequest& WithClientMetadata(ClientMetadataT&& value) {
