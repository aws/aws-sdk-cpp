...
class UpdateIdentityProviderResult {
 public:
  AWS_COGNITOIDENTITYPROVIDER_API UpdateIdentityProviderResult() = default;
  ...
  AWS_COGNITOIDENTITYPROVIDER_API UpdateIdentityProviderResult& operator=(
  ...
  template <typename IdentityProviderT = IdentityProviderType>
  UpdateIdentityProviderResult& WithIdentityProvider(IdentityProviderT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateIdentityProviderResult& WithRequestId(RequestIdT&& value) {
