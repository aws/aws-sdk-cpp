...
class DomainDescriptionType {
 public:
  ...
  template <typename UserPoolIdT = Aws::String>
  DomainDescriptionType& WithUserPoolId(UserPoolIdT&& value) {
  ...
  template <typename AWSAccountIdT = Aws::String>
  DomainDescriptionType& WithAWSAccountId(AWSAccountIdT&& value) {
  ...
  template <typename DomainT = Aws::String>
  DomainDescriptionType& WithDomain(DomainT&& value) {
  ...
  template <typename S3BucketT = Aws::String>
  DomainDescriptionType& WithS3Bucket(S3BucketT&& value) {
  ...
  void SetCloudFrontDistribution(CloudFrontDistributionT&& value) {
    m_cloudFrontDistributionHasBeenSet = true;
    m_cloudFrontDistribution = std::forward<CloudFrontDistributionT>(value);
  }
  template <typename CloudFrontDistributionT = Aws::String>
  DomainDescriptionType& WithCloudFrontDistribution(CloudFrontDistributionT&& value) {
    SetCloudFrontDistribution(std::forward<CloudFrontDistributionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename VersionT = Aws::String>
  DomainDescriptionType& WithVersion(VersionT&& value) {
  ...
  inline void SetStatus(DomainStatusType value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline DomainDescriptionType& WithStatus(DomainStatusType value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CustomDomainConfigT = CustomDomainConfigType>
  DomainDescriptionType& WithCustomDomainConfig(CustomDomainConfigT&& value) {
  ...
  inline DomainDescriptionType& WithManagedLoginVersion(int value) {
