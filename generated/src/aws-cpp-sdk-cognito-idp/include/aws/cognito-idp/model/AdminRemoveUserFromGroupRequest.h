...
class AdminRemoveUserFromGroupRequest : public CognitoIdentityProviderRequest {
 public:
  ...
  template <typename UserPoolIdT = Aws::String>
  AdminRemoveUserFromGroupRequest& WithUserPoolId(UserPoolIdT&& value) {
  ...
  template <typename UsernameT = Aws::String>
  AdminRemoveUserFromGroupRequest& WithUsername(UsernameT&& value) {
  ...
  template <typename GroupNameT = Aws::String>
  AdminRemoveUserFromGroupRequest& WithGroupName(GroupNameT&& value) {
