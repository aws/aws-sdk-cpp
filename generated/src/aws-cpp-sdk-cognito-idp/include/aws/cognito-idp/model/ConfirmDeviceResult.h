...
class ConfirmDeviceResult {
 public:
  ...
  inline void SetUserConfirmationNecessary(bool value) {
    m_userConfirmationNecessaryHasBeenSet = true;
    m_userConfirmationNecessary = value;
  }
  inline ConfirmDeviceResult& WithUserConfirmationNecessary(bool value) {
    SetUserConfirmationNecessary(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ConfirmDeviceResult& WithRequestId(RequestIdT&& value) {
