...
class AdminInitiateAuthRequest : public CognitoIdentityProviderRequest {
 public:
  ...
  template <typename ClientIdT = Aws::String>
  AdminInitiateAuthRequest& WithClientId(ClientIdT&& value) {
  ...
  inline void SetAuthFlow(AuthFlowType value) {
    m_authFlowHasBeenSet = true;
    m_authFlow = value;
  }
  inline AdminInitiateAuthRequest& WithAuthFlow(AuthFlowType value) {
    SetAuthFlow(value);
    return *this;
  }
  ///@}
  ...
  AdminInitiateAuthRequest& AddAuthParameters(AuthParametersKeyT&& key, AuthParametersValueT&& value) {
    m_authParametersHasBeenSet = true;
    m_authParameters.emplace(std::forward<AuthParametersKeyT>(key), std::forward<AuthParametersValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetContextData(ContextDataT&& value) {
    m_contextDataHasBeenSet = true;
    m_contextData = std::forward<ContextDataT>(value);
  }
  template <typename ContextDataT = ContextDataType>
  AdminInitiateAuthRequest& WithContextData(ContextDataT&& value) {
    SetContextData(std::forward<ContextDataT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename SessionT = Aws::String>
  AdminInitiateAuthRequest& WithSession(SessionT&& value) {
