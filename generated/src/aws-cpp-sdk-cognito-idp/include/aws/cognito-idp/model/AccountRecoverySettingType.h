...
class AccountRecoverySettingType {
 public:
  ...
  void SetRecoveryMechanisms(RecoveryMechanismsT&& value) {
    m_recoveryMechanismsHasBeenSet = true;
    m_recoveryMechanisms = std::forward<RecoveryMechanismsT>(value);
  }
  template <typename RecoveryMechanismsT = Aws::Vector<RecoveryOptionType>>
  AccountRecoverySettingType& WithRecoveryMechanisms(RecoveryMechanismsT&& value) {
    SetRecoveryMechanisms(std::forward<RecoveryMechanismsT>(value));
    return *this;
  }
  template <typename RecoveryMechanismsT = RecoveryOptionType>
  AccountRecoverySettingType& AddRecoveryMechanisms(RecoveryMechanismsT&& value) {
    m_recoveryMechanismsHasBeenSet = true;
    m_recoveryMechanisms.emplace_back(std::forward<RecoveryMechanismsT>(value));
    return *this;
  }
  ///@}
 private:
