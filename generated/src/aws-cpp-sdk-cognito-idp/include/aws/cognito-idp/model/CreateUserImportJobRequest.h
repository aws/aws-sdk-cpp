...
class CreateUserImportJobRequest : public CognitoIdentityProviderRequest {
 public:
  ...
  template <typename JobNameT = Aws::String>
  CreateUserImportJobRequest& WithJobName(JobNameT&& value) {
  ...
  template <typename UserPoolIdT = Aws::String>
  CreateUserImportJobRequest& WithUserPoolId(UserPoolIdT&& value) {
  ...
  template <typename CloudWatchLogsRoleArnT = Aws::String>
  CreateUserImportJobRequest& WithCloudWatchLogsRoleArn(CloudWatchLogsRoleArnT&& value) {
