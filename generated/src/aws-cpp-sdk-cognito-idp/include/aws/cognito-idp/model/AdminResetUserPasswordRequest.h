...
class AdminResetUserPasswordRequest : public CognitoIdentityProviderRequest {
 public:
  ...
  template <typename UserPoolIdT = Aws::String>
  AdminResetUserPasswordRequest& WithUserPoolId(UserPoolIdT&& value) {
  ...
  template <typename UsernameT = Aws::String>
  AdminResetUserPasswordRequest& WithUsername(UsernameT&& value) {
  ...
  template <typename ClientMetadataT = Aws::Map<Aws::String, Aws::String>>
  AdminResetUserPasswordRequest& WithClientMetadata(ClientMetadataT&& value) {
