...
class GetIdentityProviderByIdentifierResult {
 public:
  ...
  AWS_COGNITOIDENTITYPROVIDER_API GetIdentityProviderByIdentifierResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename IdentityProviderT = IdentityProviderType>
  GetIdentityProviderByIdentifierResult& WithIdentityProvider(IdentityProviderT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetIdentityProviderByIdentifierResult& WithRequestId(RequestIdT&& value) {
