...
class AdminForgetDeviceRequest : public CognitoIdentityProviderRequest {
 public:
  ...
  template <typename UserPoolIdT = Aws::String>
  AdminForgetDeviceRequest& WithUserPoolId(UserPoolIdT&& value) {
  ...
  template <typename UsernameT = Aws::String>
  AdminForgetDeviceRequest& WithUsername(UsernameT&& value) {
  ...
  template <typename DeviceKeyT = Aws::String>
  AdminForgetDeviceRequest& WithDeviceKey(DeviceKeyT&& value) {
