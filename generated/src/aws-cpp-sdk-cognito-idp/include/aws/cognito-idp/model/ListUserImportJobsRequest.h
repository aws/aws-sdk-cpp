...
class ListUserImportJobsRequest : public CognitoIdentityProviderRequest {
 public:
  ...
  template <typename UserPoolIdT = Aws::String>
  ListUserImportJobsRequest& WithUserPoolId(UserPoolIdT&& value) {
  ...
  inline ListUserImportJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename PaginationTokenT = Aws::String>
  ListUserImportJobsRequest& WithPaginationToken(PaginationTokenT&& value) {
