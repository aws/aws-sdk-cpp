...
class UserImportJobType {
 public:
  ...
  template <typename JobNameT = Aws::String>
  UserImportJobType& WithJobName(JobNameT&& value) {
  ...
  template <typename JobIdT = Aws::String>
  UserImportJobType& WithJobId(JobIdT&& value) {
  ...
  template <typename UserPoolIdT = Aws::String>
  UserImportJobType& WithUserPoolId(UserPoolIdT&& value) {
  ...
  template <typename PreSignedUrlT = Aws::String>
  UserImportJobType& WithPreSignedUrl(PreSignedUrlT&& value) {
  ...
  template <typename CreationDateT = Aws::Utils::DateTime>
  UserImportJobType& WithCreationDate(CreationDateT&& value) {
  ...
  template <typename StartDateT = Aws::Utils::DateTime>
  UserImportJobType& WithStartDate(StartDateT&& value) {
  ...
  template <typename CompletionDateT = Aws::Utils::DateTime>
  UserImportJobType& WithCompletionDate(CompletionDateT&& value) {
  ...
  inline void SetStatus(UserImportJobStatusType value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline UserImportJobType& WithStatus(UserImportJobStatusType value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetCloudWatchLogsRoleArn(CloudWatchLogsRoleArnT&& value) {
    ...
    m_cloudWatchLogsRoleArn = std::forward<CloudWatchLogsRoleArnT>(value);
  }
  template <typename CloudWatchLogsRoleArnT = Aws::String>
  UserImportJobType& WithCloudWatchLogsRoleArn(CloudWatchLogsRoleArnT&& value) {
    SetCloudWatchLogsRoleArn(std::forward<CloudWatchLogsRoleArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetImportedUsers(long long value) {
    m_importedUsersHasBeenSet = true;
    m_importedUsers = value;
  }
  inline UserImportJobType& WithImportedUsers(long long value) {
    SetImportedUsers(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSkippedUsers(long long value) {
    m_skippedUsersHasBeenSet = true;
    m_skippedUsers = value;
  }
  inline UserImportJobType& WithSkippedUsers(long long value) {
    SetSkippedUsers(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFailedUsers(long long value) {
    m_failedUsersHasBeenSet = true;
    m_failedUsers = value;
  }
  inline UserImportJobType& WithFailedUsers(long long value) {
    SetFailedUsers(value);
    return *this;
  }
  ///@}
  ...
  void SetCompletionMessage(CompletionMessageT&& value) {
    m_completionMessageHasBeenSet = true;
    m_completionMessage = std::forward<CompletionMessageT>(value);
  }
  template <typename CompletionMessageT = Aws::String>
  UserImportJobType& WithCompletionMessage(CompletionMessageT&& value) {
    SetCompletionMessage(std::forward<CompletionMessageT>(value));
    return *this;
  }
  ///@}
  ...
  inline UserImportJobType& WithPasswordHashingAlgorithm(PasswordHashingAlgorithmType value) {
