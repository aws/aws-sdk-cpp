...
class AdminDeleteUserAttributesResult {
 public:
  AWS_COGNITOIDENTITYPROVIDER_API AdminDeleteUserAttributesResult() = default;
  ...
  AWS_COGNITOIDENTITYPROVIDER_API AdminDeleteUserAttributesResult& operator=(
  ...
  template <typename RequestIdT = Aws::String>
  AdminDeleteUserAttributesResult& WithRequestId(RequestIdT&& value) {
