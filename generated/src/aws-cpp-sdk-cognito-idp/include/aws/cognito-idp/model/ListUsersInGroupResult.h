...
class ListUsersInGroupResult {
 public:
  ...
  template <typename UsersT = Aws::Vector<UserType>>
  ListUsersInGroupResult& WithUsers(UsersT&& value) {
    SetUsers(std::forward<UsersT>(value));
    return *this;
  }
  template <typename UsersT = UserType>
  ListUsersInGroupResult& AddUsers(UsersT&& value) {
    m_usersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListUsersInGroupResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListUsersInGroupResult& WithRequestId(RequestIdT&& value) {
