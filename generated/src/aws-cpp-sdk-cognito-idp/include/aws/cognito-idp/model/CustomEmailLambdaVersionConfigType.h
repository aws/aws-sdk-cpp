...
class CustomEmailLambdaVersionConfigType {
 public:
  ...
  inline void SetLambdaVersion(CustomEmailSenderLambdaVersionType value) {
    m_lambdaVersionHasBeenSet = true;
    m_lambdaVersion = value;
  }
  inline CustomEmailLambdaVersionConfigType& WithLambdaVersion(CustomEmailSenderLambdaVersionType value) {
  ...
  template <typename LambdaArnT = Aws::String>
  CustomEmailLambdaVersionConfigType& WithLambdaArn(LambdaArnT&& value) {
