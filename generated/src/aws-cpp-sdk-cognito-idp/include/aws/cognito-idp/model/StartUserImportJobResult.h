...
class StartUserImportJobResult {
 public:
  ...
  AWS_COGNITOIDENTITYPROVIDER_API StartUserImportJobResult& operator=(
  ...
  template <typename UserImportJobT = UserImportJobType>
  StartUserImportJobResult& WithUserImportJob(UserImportJobT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StartUserImportJobResult& WithRequestId(RequestIdT&& value) {
