...
class ChallengeResponseType {
 public:
  ...
  inline void SetChallengeName(ChallengeName value) {
    m_challengeNameHasBeenSet = true;
    m_challengeName = value;
  }
  inline ChallengeResponseType& WithChallengeName(ChallengeName value) {
  ...
  inline void SetChallengeResponse(ChallengeResponse value) {
    m_challengeResponseHasBeenSet = true;
    m_challengeResponse = value;
  }
  inline ChallengeResponseType& WithChallengeResponse(ChallengeResponse value) {
