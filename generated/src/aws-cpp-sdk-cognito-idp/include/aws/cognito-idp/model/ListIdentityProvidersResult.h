...
class ListIdentityProvidersResult {
 public:
  ...
  AWS_COGNITOIDENTITYPROVIDER_API ListIdentityProvidersResult& operator=(
  ...
  template <typename ProvidersT = Aws::Vector<ProviderDescription>>
  ListIdentityProvidersResult& WithProviders(ProvidersT&& value) {
    SetProviders(std::forward<ProvidersT>(value));
    return *this;
  }
  template <typename ProvidersT = ProviderDescription>
  ListIdentityProvidersResult& AddProviders(ProvidersT&& value) {
    m_providersHasBeenSet = true;
    m_providers.emplace_back(std::forward<ProvidersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListIdentityProvidersResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListIdentityProvidersResult& WithRequestId(RequestIdT&& value) {
