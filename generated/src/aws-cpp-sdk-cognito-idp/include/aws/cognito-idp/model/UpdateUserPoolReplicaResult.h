...
namespace Model {
class UpdateUserPoolReplicaResult {
 public:
  AWS_COGNITOIDENTITYPROVIDER_API UpdateUserPoolReplicaResult() = default;
  AWS_COGNITOIDENTITYPROVIDER_API UpdateUserPoolReplicaResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_COGNITOIDENTITYPROVIDER_API UpdateUserPoolReplicaResult& operator=(
  ...
  template <typename UserPoolReplicaT = UserPoolReplicaType>
  UpdateUserPoolReplicaResult& WithUserPoolReplica(UserPoolReplicaT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateUserPoolReplicaResult& WithRequestId(RequestIdT&& value) {
