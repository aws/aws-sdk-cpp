...
class CreateUserPoolDomainResult {
 public:
  ...
  AWS_COGNITOIDENTITYPROVIDER_API CreateUserPoolDomainResult& operator=(
  ...
  inline CreateUserPoolDomainResult& WithManagedLoginVersion(int value) {
  ...
  template <typename CloudFrontDomainT = Aws::String>
  CreateUserPoolDomainResult& WithCloudFrontDomain(CloudFrontDomainT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateUserPoolDomainResult& WithRequestId(RequestIdT&& value) {
