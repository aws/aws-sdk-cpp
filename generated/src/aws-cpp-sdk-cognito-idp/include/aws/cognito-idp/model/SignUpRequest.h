...
class SignUpRequest : public CognitoIdentityProviderRequest {
 public:
  ...
  template <typename ClientIdT = Aws::String>
  SignUpRequest& WithClientId(ClientIdT&& value) {
  ...
  void SetSecretHash(SecretHashT&& value) {
    m_secretHashHasBeenSet = true;
    m_secretHash = std::forward<SecretHashT>(value);
  }
  template <typename SecretHashT = Aws::String>
  SignUpRequest& WithSecretHash(SecretHashT&& value) {
    SetSecretHash(std::forward<SecretHashT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename UsernameT = Aws::String>
  SignUpRequest& WithUsername(UsernameT&& value) {
  ...
  template <typename PasswordT = Aws::String>
  SignUpRequest& WithPassword(PasswordT&& value) {
  ...
  template <typename UserAttributesT = Aws::Vector<AttributeType>>
  SignUpRequest& WithUserAttributes(UserAttributesT&& value) {
    SetUserAttributes(std::forward<UserAttributesT>(value));
    return *this;
  }
  template <typename UserAttributesT = AttributeType>
  SignUpRequest& AddUserAttributes(UserAttributesT&& value) {
    m_userAttributesHasBeenSet = true;
  ...
  template <typename ValidationDataT = Aws::Vector<AttributeType>>
  SignUpRequest& WithValidationData(ValidationDataT&& value) {
    SetValidationData(std::forward<ValidationDataT>(value));
    return *this;
  }
  template <typename ValidationDataT = AttributeType>
  SignUpRequest& AddValidationData(ValidationDataT&& value) {
    m_validationDataHasBeenSet = true;
  ...
  template <typename AnalyticsMetadataT = AnalyticsMetadataType>
  SignUpRequest& WithAnalyticsMetadata(AnalyticsMetadataT&& value) {
  ...
  template <typename UserContextDataT = UserContextDataType>
  SignUpRequest& WithUserContextData(UserContextDataT&& value) {
  ...
  template <typename ClientMetadataT = Aws::Map<Aws::String, Aws::String>>
  SignUpRequest& WithClientMetadata(ClientMetadataT&& value) {
