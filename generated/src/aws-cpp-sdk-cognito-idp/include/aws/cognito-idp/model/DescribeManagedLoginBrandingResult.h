...
class DescribeManagedLoginBrandingResult {
 public:
  ...
  AWS_COGNITOIDENTITYPROVIDER_API DescribeManagedLoginBrandingResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ManagedLoginBrandingT = ManagedLoginBrandingType>
  DescribeManagedLoginBrandingResult& WithManagedLoginBranding(ManagedLoginBrandingT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeManagedLoginBrandingResult& WithRequestId(RequestIdT&& value) {
