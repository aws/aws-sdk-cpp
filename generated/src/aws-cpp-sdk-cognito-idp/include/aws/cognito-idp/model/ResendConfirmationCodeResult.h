...
class ResendConfirmationCodeResult {
 public:
  ...
  AWS_COGNITOIDENTITYPROVIDER_API ResendConfirmationCodeResult& operator=(
  ...
  template <typename CodeDeliveryDetailsT = CodeDeliveryDetailsType>
  ResendConfirmationCodeResult& WithCodeDeliveryDetails(CodeDeliveryDetailsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ResendConfirmationCodeResult& WithRequestId(RequestIdT&& value) {
