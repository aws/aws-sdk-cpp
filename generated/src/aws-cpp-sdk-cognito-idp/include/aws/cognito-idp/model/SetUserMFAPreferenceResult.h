...
namespace Model
{
  ...
  public:
    ...
    inline SetUserMFAPreferenceResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline SetUserMFAPreferenceResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline SetUserMFAPreferenceResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
