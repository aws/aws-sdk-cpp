...
class RespondToAuthChallengeRequest : public CognitoIdentityProviderRequest {
 public:
  AWS_COGNITOIDENTITYPROVIDER_API RespondToAuthChallengeRequest() = default;
  ...
  template <typename ClientIdT = Aws::String>
  RespondToAuthChallengeRequest& WithClientId(ClientIdT&& value) {
  ...
  ///@{
  /**
   * <p>The name of the challenge that you are responding to.</p>  <p>You can't
   * respond to an <code>ADMIN_NO_SRP_AUTH</code> challenge with this operation.</p>
   *  <p>Possible challenges include the following:</p>  <p>All of the
   * following challenges require <code>USERNAME</code> and, when the app client has
   * a client secret, <code>SECRET_HASH</code> in the parameters. Include a
   * <code>DEVICE_KEY</code> for device authentication.</p>  <ul> <li> <p>
  ...
  inline RespondToAuthChallengeRequest& WithChallengeName(ChallengeNameType value) {
  ...
  template <typename SessionT = Aws::String>
  RespondToAuthChallengeRequest& WithSession(SessionT&& value) {
  ...
  void SetChallengeResponses(ChallengeResponsesT&& value) {
    m_challengeResponsesHasBeenSet = true;
    m_challengeResponses = std::forward<ChallengeResponsesT>(value);
  }
  template <typename ChallengeResponsesT = Aws::Map<Aws::String, Aws::String>>
  RespondToAuthChallengeRequest& WithChallengeResponses(ChallengeResponsesT&& value) {
    SetChallengeResponses(std::forward<ChallengeResponsesT>(value));
    return *this;
  }
  template <typename ChallengeResponsesKeyT = Aws::String, typename ChallengeResponsesValueT = Aws::String>
  RespondToAuthChallengeRequest& AddChallengeResponses(ChallengeResponsesKeyT&& key, ChallengeResponsesValueT&& value) {
    m_challengeResponsesHasBeenSet = true;
    m_challengeResponses.emplace(std::forward<ChallengeResponsesKeyT>(key), std::forward<ChallengeResponsesValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAnalyticsMetadata(AnalyticsMetadataT&& value) {
    m_analyticsMetadataHasBeenSet = true;
    m_analyticsMetadata = std::forward<AnalyticsMetadataT>(value);
  }
  template <typename AnalyticsMetadataT = AnalyticsMetadataType>
  RespondToAuthChallengeRequest& WithAnalyticsMetadata(AnalyticsMetadataT&& value) {
    SetAnalyticsMetadata(std::forward<AnalyticsMetadataT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUserContextData(UserContextDataT&& value) {
    m_userContextDataHasBeenSet = true;
    m_userContextData = std::forward<UserContextDataT>(value);
  }
  template <typename UserContextDataT = UserContextDataType>
  RespondToAuthChallengeRequest& WithUserContextData(UserContextDataT&& value) {
    SetUserContextData(std::forward<UserContextDataT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ClientMetadataT = Aws::Map<Aws::String, Aws::String>>
  RespondToAuthChallengeRequest& WithClientMetadata(ClientMetadataT&& value) {
  ...
  RespondToAuthChallengeRequest& AddClientMetadata(ClientMetadataKeyT&& key, ClientMetadataValueT&& value) {
    m_clientMetadataHasBeenSet = true;
