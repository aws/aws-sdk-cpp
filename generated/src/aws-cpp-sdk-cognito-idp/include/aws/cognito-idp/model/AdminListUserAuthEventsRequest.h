...
namespace Model
{
  ...
  public:
    ...
    template<typename UserPoolIdT = Aws::String>
    AdminListUserAuthEventsRequest& WithUserPoolId(UserPoolIdT&& value) { SetUserPoolId(std::forward<UserPoolIdT>(value)); return *this;}
    ///@}
    ...
    template<typename UsernameT = Aws::String>
    AdminListUserAuthEventsRequest& WithUsername(UsernameT&& value) { SetUsername(std::forward<UsernameT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    AdminListUserAuthEventsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
