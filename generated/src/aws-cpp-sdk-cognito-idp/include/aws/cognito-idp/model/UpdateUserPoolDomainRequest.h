...
class UpdateUserPoolDomainRequest : public CognitoIdentityProviderRequest {
 public:
  ...
  inline UpdateUserPoolDomainRequest& WithManagedLoginVersion(int value) {
  ...
  ///@{
  /**
   * <p>The routing configuration for the user pool domain. Specifies failover
   * settings for multi-region deployments.</p>
   */
  ...
  template <typename RoutingT = RoutingType>
  UpdateUserPoolDomainRequest& WithRouting(RoutingT&& value) {
