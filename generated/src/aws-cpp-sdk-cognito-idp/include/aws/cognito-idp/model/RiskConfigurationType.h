...
class RiskConfigurationType {
 public:
  ...
  template <typename UserPoolIdT = Aws::String>
  RiskConfigurationType& WithUserPoolId(UserPoolIdT&& value) {
  ...
  template <typename ClientIdT = Aws::String>
  RiskConfigurationType& WithClientId(ClientIdT&& value) {
  ...
  template <typename CompromisedCredentialsRiskConfigurationT = CompromisedCredentialsRiskConfigurationType>
  RiskConfigurationType& WithCompromisedCredentialsRiskConfiguration(CompromisedCredentialsRiskConfigurationT&& value) {
  ...
  template <typename AccountTakeoverRiskConfigurationT = AccountTakeoverRiskConfigurationType>
  RiskConfigurationType& WithAccountTakeoverRiskConfiguration(AccountTakeoverRiskConfigurationT&& value) {
  ...
  template <typename RiskExceptionConfigurationT = RiskExceptionConfigurationType>
  RiskConfigurationType& WithRiskExceptionConfiguration(RiskExceptionConfigurationT&& value) {
  ...
  template <typename LastModifiedDateT = Aws::Utils::DateTime>
  RiskConfigurationType& WithLastModifiedDate(LastModifiedDateT&& value) {
