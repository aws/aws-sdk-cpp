...
class CreateUserImportJobResult {
 public:
  ...
  AWS_COGNITOIDENTITYPROVIDER_API CreateUserImportJobResult& operator=(
  ...
  template <typename UserImportJobT = UserImportJobType>
  CreateUserImportJobResult& WithUserImportJob(UserImportJobT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateUserImportJobResult& WithRequestId(RequestIdT&& value) {
