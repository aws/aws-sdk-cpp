...
class GetCSVHeaderResult {
 public:
  ...
  template <typename UserPoolIdT = Aws::String>
  GetCSVHeaderResult& WithUserPoolId(UserPoolIdT&& value) {
  ...
  void SetCSVHeader(CSVHeaderT&& value) {
    m_cSVHeaderHasBeenSet = true;
    m_cSVHeader = std::forward<CSVHeaderT>(value);
  }
  template <typename CSVHeaderT = Aws::Vector<Aws::String>>
  GetCSVHeaderResult& WithCSVHeader(CSVHeaderT&& value) {
    SetCSVHeader(std::forward<CSVHeaderT>(value));
    return *this;
  }
  template <typename CSVHeaderT = Aws::String>
  GetCSVHeaderResult& AddCSVHeader(CSVHeaderT&& value) {
    m_cSVHeaderHasBeenSet = true;
    m_cSVHeader.emplace_back(std::forward<CSVHeaderT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetCSVHeaderResult& WithRequestId(RequestIdT&& value) {
