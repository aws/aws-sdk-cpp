...
namespace Model
{
  ...
  {
  public:
    AWS_COGNITOIDENTITYPROVIDER_API DescribeIdentityProviderRequest() = default;
    ...
    template<typename UserPoolIdT = Aws::String>
    DescribeIdentityProviderRequest& WithUserPoolId(UserPoolIdT&& value) { SetUserPoolId(std::forward<UserPoolIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ProviderNameT = Aws::String>
    DescribeIdentityProviderRequest& WithProviderName(ProviderNameT&& value) { SetProviderName(std::forward<ProviderNameT>(value)); return *this;}
    ///@}
  private:
