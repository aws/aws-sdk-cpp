...
class StringAttributeConstraintsType {
 public:
  ...
  void SetMinLength(MinLengthT&& value) {
    m_minLengthHasBeenSet = true;
    m_minLength = std::forward<MinLengthT>(value);
  }
  template <typename MinLengthT = Aws::String>
  StringAttributeConstraintsType& WithMinLength(MinLengthT&& value) {
    SetMinLength(std::forward<MinLengthT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMaxLength(MaxLengthT&& value) {
    m_maxLengthHasBeenSet = true;
    m_maxLength = std::forward<MaxLengthT>(value);
  }
  template <typename MaxLengthT = Aws::String>
  StringAttributeConstraintsType& WithMaxLength(MaxLengthT&& value) {
    SetMaxLength(std::forward<MaxLengthT>(value));
    return *this;
  }
  ///@}
 private:
