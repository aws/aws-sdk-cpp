...
class UserAttributeUpdateSettingsType {
 public:
   ...
   */
  inline const Aws::Vector<VerifiedAttributeType>& GetAttributesRequireVerificationBeforeUpdate() const {
    return m_attributesRequireVerificationBeforeUpdate;
  }
  ...
  void SetAttributesRequireVerificationBeforeUpdate(AttributesRequireVerificationBeforeUpdateT&& value) {
    m_attributesRequireVerificationBeforeUpdateHasBeenSet = true;
    m_attributesRequireVerificationBeforeUpdate = std::forward<AttributesRequireVerificationBeforeUpdateT>(value);
  }
  template <typename AttributesRequireVerificationBeforeUpdateT = Aws::Vector<VerifiedAttributeType>>
  UserAttributeUpdateSettingsType& WithAttributesRequireVerificationBeforeUpdate(AttributesRequireVerificationBeforeUpdateT&& value) {
    SetAttributesRequireVerificationBeforeUpdate(std::forward<AttributesRequireVerificationBeforeUpdateT>(value));
    return *this;
  }
  inline UserAttributeUpdateSettingsType& AddAttributesRequireVerificationBeforeUpdate(VerifiedAttributeType value) {
    m_attributesRequireVerificationBeforeUpdateHasBeenSet = true;
    m_attributesRequireVerificationBeforeUpdate.push_back(value);
    return *this;
  }
  ///@}
 private:
