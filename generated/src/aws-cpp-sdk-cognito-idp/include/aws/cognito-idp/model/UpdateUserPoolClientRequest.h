...
class UpdateUserPoolClientRequest : public CognitoIdentityProviderRequest {
 public:
  ...
  inline UpdateUserPoolClientRequest& WithRefreshTokenValidity(int value) {
  ...
  inline UpdateUserPoolClientRequest& WithAccessTokenValidity(int value) {
  ...
  inline UpdateUserPoolClientRequest& WithIdTokenValidity(int value) {
  ...
  inline UpdateUserPoolClientRequest& AddExplicitAuthFlows(ExplicitAuthFlowsType value) {
    m_explicitAuthFlowsHasBeenSet = true;
  ...
  inline UpdateUserPoolClientRequest& AddAllowedOAuthFlows(OAuthFlowType value) {
    m_allowedOAuthFlowsHasBeenSet = true;
  ...
  inline UpdateUserPoolClientRequest& WithAllowedOAuthFlowsUserPoolClient(bool value) {
  ...
  inline UpdateUserPoolClientRequest& WithPreventUserExistenceErrors(PreventUserExistenceErrorTypes value) {
  ...
  inline UpdateUserPoolClientRequest& WithEnableTokenRevocation(bool value) {
  ...
  inline UpdateUserPoolClientRequest& WithEnablePropagateAdditionalUserContextData(bool value) {
  ...
  inline UpdateUserPoolClientRequest& WithAuthSessionValidity(int value) {
