...
class ListResourceServersRequest : public CognitoIdentityProviderRequest {
 public:
  ...
  template <typename UserPoolIdT = Aws::String>
  ListResourceServersRequest& WithUserPoolId(UserPoolIdT&& value) {
  ...
  inline ListResourceServersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListResourceServersRequest& WithNextToken(NextTokenT&& value) {
