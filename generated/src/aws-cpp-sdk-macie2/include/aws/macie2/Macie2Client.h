...
class AWS_MACIE2_API Macie2Client : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  Macie2Client(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<Macie2EndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * A Callable wrapper for AcceptInvitation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AcceptInvitation that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename AcceptInvitationRequestT = Model::AcceptInvitationRequest>
  void AcceptInvitationAsync(const AcceptInvitationRequestT& request, const AcceptInvitationResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchGetCustomDataIdentifiersOutcome BatchGetCustomDataIdentifiers(
      const Model::BatchGetCustomDataIdentifiersRequest& request = {}) const;

  /**
   * A Callable wrapper for BatchGetCustomDataIdentifiers that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename BatchGetCustomDataIdentifiersRequestT = Model::BatchGetCustomDataIdentifiersRequest>
  Model::BatchGetCustomDataIdentifiersOutcomeCallable BatchGetCustomDataIdentifiersCallable(
      const BatchGetCustomDataIdentifiersRequestT& request = {}) const {
    return SubmitCallable(&Macie2Client::BatchGetCustomDataIdentifiers, request);
  }

  /**
   * An Async wrapper for BatchGetCustomDataIdentifiers that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchGetCustomDataIdentifiersRequestT = Model::BatchGetCustomDataIdentifiersRequest>
  void BatchGetCustomDataIdentifiersAsync(const BatchGetCustomDataIdentifiersResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchUpdateAutomatedDiscoveryAccountsOutcome BatchUpdateAutomatedDiscoveryAccounts(
      const Model::BatchUpdateAutomatedDiscoveryAccountsRequest& request = {}) const;

  /**
   * A Callable wrapper for BatchUpdateAutomatedDiscoveryAccounts that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename BatchUpdateAutomatedDiscoveryAccountsRequestT = Model::BatchUpdateAutomatedDiscoveryAccountsRequest>
  Model::BatchUpdateAutomatedDiscoveryAccountsOutcomeCallable BatchUpdateAutomatedDiscoveryAccountsCallable(
      const BatchUpdateAutomatedDiscoveryAccountsRequestT& request = {}) const {
    return SubmitCallable(&Macie2Client::BatchUpdateAutomatedDiscoveryAccounts, request);
  }

  /**
   * An Async wrapper for BatchUpdateAutomatedDiscoveryAccounts that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename BatchUpdateAutomatedDiscoveryAccountsRequestT = Model::BatchUpdateAutomatedDiscoveryAccountsRequest>
  void BatchUpdateAutomatedDiscoveryAccountsAsync(const BatchUpdateAutomatedDiscoveryAccountsResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                  const BatchUpdateAutomatedDiscoveryAccountsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for CreateAllowList that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateAllowListRequestT = Model::CreateAllowListRequest>
  void CreateAllowListAsync(const CreateAllowListRequestT& request, const CreateAllowListResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateClassificationJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateClassificationJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateClassificationJobRequestT = Model::CreateClassificationJobRequest>
  void CreateClassificationJobAsync(const CreateClassificationJobRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateCustomDataIdentifierOutcome CreateCustomDataIdentifier(
      const Model::CreateCustomDataIdentifierRequest& request) const;

  /**
   * A Callable wrapper for CreateCustomDataIdentifier that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateCustomDataIdentifierRequestT = Model::CreateCustomDataIdentifierRequest>
  Model::CreateCustomDataIdentifierOutcomeCallable CreateCustomDataIdentifierCallable(
      const CreateCustomDataIdentifierRequestT& request) const {
    return SubmitCallable(&Macie2Client::CreateCustomDataIdentifier, request);
  }

  /**
   * An Async wrapper for CreateCustomDataIdentifier that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateCustomDataIdentifierRequestT = Model::CreateCustomDataIdentifierRequest>
  void CreateCustomDataIdentifierAsync(const CreateCustomDataIdentifierRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateFindingsFilter that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateFindingsFilter that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateFindingsFilterRequestT = Model::CreateFindingsFilterRequest>
  void CreateFindingsFilterAsync(const CreateFindingsFilterRequestT& request, const CreateFindingsFilterResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateInvitations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateInvitations that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateInvitationsRequestT = Model::CreateInvitationsRequest>
  void CreateInvitationsAsync(const CreateInvitationsRequestT& request, const CreateInvitationsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateMember that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateMemberRequestT = Model::CreateMemberRequest>
  void CreateMemberAsync(const CreateMemberRequestT& request, const CreateMemberResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateSampleFindings that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateSampleFindings that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateSampleFindingsRequestT = Model::CreateSampleFindingsRequest>
  void CreateSampleFindingsAsync(const CreateSampleFindingsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const CreateSampleFindingsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DeclineInvitations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeclineInvitations that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeclineInvitationsRequestT = Model::DeclineInvitationsRequest>
  ...
  /**
   * An Async wrapper for DeleteAllowList that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteAllowListRequestT = Model::DeleteAllowListRequest>
  void DeleteAllowListAsync(const DeleteAllowListRequestT& request, const DeleteAllowListResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteCustomDataIdentifierOutcome DeleteCustomDataIdentifier(
      const Model::DeleteCustomDataIdentifierRequest& request) const;

  /**
   * A Callable wrapper for DeleteCustomDataIdentifier that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteCustomDataIdentifierRequestT = Model::DeleteCustomDataIdentifierRequest>
  Model::DeleteCustomDataIdentifierOutcomeCallable DeleteCustomDataIdentifierCallable(
      const DeleteCustomDataIdentifierRequestT& request) const {
    return SubmitCallable(&Macie2Client::DeleteCustomDataIdentifier, request);
  }

  /**
   * An Async wrapper for DeleteCustomDataIdentifier that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteCustomDataIdentifierRequestT = Model::DeleteCustomDataIdentifierRequest>
  void DeleteCustomDataIdentifierAsync(const DeleteCustomDataIdentifierRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteFindingsFilter that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteFindingsFilter that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteFindingsFilterRequestT = Model::DeleteFindingsFilterRequest>
  void DeleteFindingsFilterAsync(const DeleteFindingsFilterRequestT& request, const DeleteFindingsFilterResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteInvitations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteInvitations that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteInvitationsRequestT = Model::DeleteInvitationsRequest>
  void DeleteInvitationsAsync(const DeleteInvitationsRequestT& request, const DeleteInvitationsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteMember that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteMemberRequestT = Model::DeleteMemberRequest>
  void DeleteMemberAsync(const DeleteMemberRequestT& request, const DeleteMemberResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeBuckets that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeBucketsRequestT = Model::DescribeBucketsRequest>
  void DescribeBucketsAsync(const DescribeBucketsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const DescribeBucketsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeClassificationJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeClassificationJobRequestT = Model::DescribeClassificationJobRequest>
  Model::DescribeClassificationJobOutcomeCallable DescribeClassificationJobCallable(
      const DescribeClassificationJobRequestT& request) const {
    return SubmitCallable(&Macie2Client::DescribeClassificationJob, request);
  }

  /**
   * An Async wrapper for DescribeClassificationJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeClassificationJobRequestT = Model::DescribeClassificationJobRequest>
  void DescribeClassificationJobAsync(const DescribeClassificationJobRequestT& request,
  ...
  virtual Model::DescribeOrganizationConfigurationOutcome DescribeOrganizationConfiguration(
      const Model::DescribeOrganizationConfigurationRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeOrganizationConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeOrganizationConfigurationRequestT = Model::DescribeOrganizationConfigurationRequest>
  Model::DescribeOrganizationConfigurationOutcomeCallable DescribeOrganizationConfigurationCallable(
      const DescribeOrganizationConfigurationRequestT& request = {}) const {
    return SubmitCallable(&Macie2Client::DescribeOrganizationConfiguration, request);
  }

  /**
   * An Async wrapper for DescribeOrganizationConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeOrganizationConfigurationRequestT = Model::DescribeOrganizationConfigurationRequest>
  void DescribeOrganizationConfigurationAsync(const DescribeOrganizationConfigurationResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                              const DescribeOrganizationConfigurationRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for DisableMacie that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DisableMacieRequestT = Model::DisableMacieRequest>
  void DisableMacieAsync(const DisableMacieResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                         const DisableMacieRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisableOrganizationAdminAccountOutcome DisableOrganizationAdminAccount(
      const Model::DisableOrganizationAdminAccountRequest& request) const;

  /**
   * A Callable wrapper for DisableOrganizationAdminAccount that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DisableOrganizationAdminAccountRequestT = Model::DisableOrganizationAdminAccountRequest>
  Model::DisableOrganizationAdminAccountOutcomeCallable DisableOrganizationAdminAccountCallable(
      const DisableOrganizationAdminAccountRequestT& request) const {
    return SubmitCallable(&Macie2Client::DisableOrganizationAdminAccount, request);
  }

  /**
   * An Async wrapper for DisableOrganizationAdminAccount that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DisableOrganizationAdminAccountRequestT = Model::DisableOrganizationAdminAccountRequest>
  void DisableOrganizationAdminAccountAsync(const DisableOrganizationAdminAccountRequestT& request,
  ...
  virtual Model::DisassociateFromAdministratorAccountOutcome DisassociateFromAdministratorAccount(
      const Model::DisassociateFromAdministratorAccountRequest& request = {}) const;

  /**
   * A Callable wrapper for DisassociateFromAdministratorAccount that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DisassociateFromAdministratorAccountRequestT = Model::DisassociateFromAdministratorAccountRequest>
  Model::DisassociateFromAdministratorAccountOutcomeCallable DisassociateFromAdministratorAccountCallable(
      const DisassociateFromAdministratorAccountRequestT& request = {}) const {
    return SubmitCallable(&Macie2Client::DisassociateFromAdministratorAccount, request);
  }

  /**
   * An Async wrapper for DisassociateFromAdministratorAccount that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DisassociateFromAdministratorAccountRequestT = Model::DisassociateFromAdministratorAccountRequest>
  void DisassociateFromAdministratorAccountAsync(const DisassociateFromAdministratorAccountResponseReceivedHandler& handler,
                                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                 const DisassociateFromAdministratorAccountRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateFromMasterAccountOutcome DisassociateFromMasterAccount(
      const Model::DisassociateFromMasterAccountRequest& request = {}) const;

  /**
   * A Callable wrapper for DisassociateFromMasterAccount that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DisassociateFromMasterAccountRequestT = Model::DisassociateFromMasterAccountRequest>
  Model::DisassociateFromMasterAccountOutcomeCallable DisassociateFromMasterAccountCallable(
      const DisassociateFromMasterAccountRequestT& request = {}) const {
    return SubmitCallable(&Macie2Client::DisassociateFromMasterAccount, request);
  }

  /**
   * An Async wrapper for DisassociateFromMasterAccount that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateFromMasterAccountRequestT = Model::DisassociateFromMasterAccountRequest>
  void DisassociateFromMasterAccountAsync(const DisassociateFromMasterAccountResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                          const DisassociateFromMasterAccountRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DisassociateMember that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DisassociateMember that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DisassociateMemberRequestT = Model::DisassociateMemberRequest>
  void DisassociateMemberAsync(const DisassociateMemberRequestT& request, const DisassociateMemberResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for EnableMacie that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename EnableMacieRequestT = Model::EnableMacieRequest>
  void EnableMacieAsync(const EnableMacieResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                        const EnableMacieRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::EnableOrganizationAdminAccountOutcome EnableOrganizationAdminAccount(
      const Model::EnableOrganizationAdminAccountRequest& request) const;

  /**
   * A Callable wrapper for EnableOrganizationAdminAccount that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename EnableOrganizationAdminAccountRequestT = Model::EnableOrganizationAdminAccountRequest>
  Model::EnableOrganizationAdminAccountOutcomeCallable EnableOrganizationAdminAccountCallable(
      const EnableOrganizationAdminAccountRequestT& request) const {
    return SubmitCallable(&Macie2Client::EnableOrganizationAdminAccount, request);
  }

  /**
   * An Async wrapper for EnableOrganizationAdminAccount that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename EnableOrganizationAdminAccountRequestT = Model::EnableOrganizationAdminAccountRequest>
  void EnableOrganizationAdminAccountAsync(const EnableOrganizationAdminAccountRequestT& request,
  ...
  /**
   * A Callable wrapper for GetAdministratorAccount that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetAdministratorAccount that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetAdministratorAccountRequestT = Model::GetAdministratorAccountRequest>
  void GetAdministratorAccountAsync(const GetAdministratorAccountResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const GetAdministratorAccountRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetAllowList that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetAllowListRequestT = Model::GetAllowListRequest>
  void GetAllowListAsync(const GetAllowListRequestT& request, const GetAllowListResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetAutomatedDiscoveryConfigurationOutcome GetAutomatedDiscoveryConfiguration(
      const Model::GetAutomatedDiscoveryConfigurationRequest& request = {}) const;

  /**
   * A Callable wrapper for GetAutomatedDiscoveryConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename GetAutomatedDiscoveryConfigurationRequestT = Model::GetAutomatedDiscoveryConfigurationRequest>
  Model::GetAutomatedDiscoveryConfigurationOutcomeCallable GetAutomatedDiscoveryConfigurationCallable(
      const GetAutomatedDiscoveryConfigurationRequestT& request = {}) const {
    return SubmitCallable(&Macie2Client::GetAutomatedDiscoveryConfiguration, request);
  }

  /**
   * An Async wrapper for GetAutomatedDiscoveryConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetAutomatedDiscoveryConfigurationRequestT = Model::GetAutomatedDiscoveryConfigurationRequest>
  void GetAutomatedDiscoveryConfigurationAsync(const GetAutomatedDiscoveryConfigurationResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                               const GetAutomatedDiscoveryConfigurationRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetBucketStatistics that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetBucketStatistics that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetBucketStatisticsRequestT = Model::GetBucketStatisticsRequest>
  void GetBucketStatisticsAsync(const GetBucketStatisticsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const GetBucketStatisticsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetClassificationExportConfigurationOutcome GetClassificationExportConfiguration(
      const Model::GetClassificationExportConfigurationRequest& request = {}) const;

  /**
   * A Callable wrapper for GetClassificationExportConfiguration that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename GetClassificationExportConfigurationRequestT = Model::GetClassificationExportConfigurationRequest>
  Model::GetClassificationExportConfigurationOutcomeCallable GetClassificationExportConfigurationCallable(
      const GetClassificationExportConfigurationRequestT& request = {}) const {
    return SubmitCallable(&Macie2Client::GetClassificationExportConfiguration, request);
  }

  /**
   * An Async wrapper for GetClassificationExportConfiguration that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetClassificationExportConfigurationRequestT = Model::GetClassificationExportConfigurationRequest>
  void GetClassificationExportConfigurationAsync(const GetClassificationExportConfigurationResponseReceivedHandler& handler,
                                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                 const GetClassificationExportConfigurationRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetClassificationScope that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetClassificationScope that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetClassificationScopeRequestT = Model::GetClassificationScopeRequest>
  void GetClassificationScopeAsync(const GetClassificationScopeRequestT& request,
                                   const GetClassificationScopeResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetCustomDataIdentifier that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetCustomDataIdentifier that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetCustomDataIdentifierRequestT = Model::GetCustomDataIdentifierRequest>
  void GetCustomDataIdentifierAsync(const GetCustomDataIdentifierRequestT& request,
  ...
  /**
   * A Callable wrapper for GetFindingStatistics that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetFindingStatistics that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetFindingStatisticsRequestT = Model::GetFindingStatisticsRequest>
  void GetFindingStatisticsAsync(const GetFindingStatisticsRequestT& request, const GetFindingStatisticsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetFindings that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetFindingsRequestT = Model::GetFindingsRequest>
  void GetFindingsAsync(const GetFindingsRequestT& request, const GetFindingsResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetFindingsFilter that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetFindingsFilter that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetFindingsFilterRequestT = Model::GetFindingsFilterRequest>
  void GetFindingsFilterAsync(const GetFindingsFilterRequestT& request, const GetFindingsFilterResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetFindingsPublicationConfigurationOutcome GetFindingsPublicationConfiguration(
      const Model::GetFindingsPublicationConfigurationRequest& request = {}) const;

  /**
   * A Callable wrapper for GetFindingsPublicationConfiguration that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename GetFindingsPublicationConfigurationRequestT = Model::GetFindingsPublicationConfigurationRequest>
  Model::GetFindingsPublicationConfigurationOutcomeCallable GetFindingsPublicationConfigurationCallable(
      const GetFindingsPublicationConfigurationRequestT& request = {}) const {
    return SubmitCallable(&Macie2Client::GetFindingsPublicationConfiguration, request);
  }

  /**
   * An Async wrapper for GetFindingsPublicationConfiguration that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetFindingsPublicationConfigurationRequestT = Model::GetFindingsPublicationConfigurationRequest>
  void GetFindingsPublicationConfigurationAsync(const GetFindingsPublicationConfigurationResponseReceivedHandler& handler,
                                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                const GetFindingsPublicationConfigurationRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetInvitationsCount that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetInvitationsCount that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetInvitationsCountRequestT = Model::GetInvitationsCountRequest>
  void GetInvitationsCountAsync(const GetInvitationsCountResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const GetInvitationsCountRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetMacieSession that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetMacieSessionRequestT = Model::GetMacieSessionRequest>
  void GetMacieSessionAsync(const GetMacieSessionResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const GetMacieSessionRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetMasterAccount that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetMasterAccount that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetMasterAccountRequestT = Model::GetMasterAccountRequest>
  void GetMasterAccountAsync(const GetMasterAccountResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const GetMasterAccountRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetMember that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetMemberRequestT = Model::GetMemberRequest>
  void GetMemberAsync(const GetMemberRequestT& request, const GetMemberResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetResourceProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetResourceProfile that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetResourceProfileRequestT = Model::GetResourceProfileRequest>
  void GetResourceProfileAsync(const GetResourceProfileRequestT& request, const GetResourceProfileResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetRevealConfiguration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetRevealConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetRevealConfigurationRequestT = Model::GetRevealConfigurationRequest>
  void GetRevealConfigurationAsync(const GetRevealConfigurationResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const GetRevealConfigurationRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetSensitiveDataOccurrencesOutcome GetSensitiveDataOccurrences(
      const Model::GetSensitiveDataOccurrencesRequest& request) const;

  /**
   * A Callable wrapper for GetSensitiveDataOccurrences that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetSensitiveDataOccurrencesRequestT = Model::GetSensitiveDataOccurrencesRequest>
  Model::GetSensitiveDataOccurrencesOutcomeCallable GetSensitiveDataOccurrencesCallable(
      const GetSensitiveDataOccurrencesRequestT& request) const {
    return SubmitCallable(&Macie2Client::GetSensitiveDataOccurrences, request);
  }

  /**
   * An Async wrapper for GetSensitiveDataOccurrences that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetSensitiveDataOccurrencesRequestT = Model::GetSensitiveDataOccurrencesRequest>
  void GetSensitiveDataOccurrencesAsync(const GetSensitiveDataOccurrencesRequestT& request,
                                        const GetSensitiveDataOccurrencesResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetSensitiveDataOccurrencesAvailabilityOutcome GetSensitiveDataOccurrencesAvailability(
      const Model::GetSensitiveDataOccurrencesAvailabilityRequest& request) const;

  /**
   * A Callable wrapper for GetSensitiveDataOccurrencesAvailability that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename GetSensitiveDataOccurrencesAvailabilityRequestT = Model::GetSensitiveDataOccurrencesAvailabilityRequest>
  Model::GetSensitiveDataOccurrencesAvailabilityOutcomeCallable GetSensitiveDataOccurrencesAvailabilityCallable(
      const GetSensitiveDataOccurrencesAvailabilityRequestT& request) const {
    return SubmitCallable(&Macie2Client::GetSensitiveDataOccurrencesAvailability, request);
  }

  /**
   * An Async wrapper for GetSensitiveDataOccurrencesAvailability that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetSensitiveDataOccurrencesAvailabilityRequestT = Model::GetSensitiveDataOccurrencesAvailabilityRequest>
  void GetSensitiveDataOccurrencesAvailabilityAsync(const GetSensitiveDataOccurrencesAvailabilityRequestT& request,
                                                    const GetSensitiveDataOccurrencesAvailabilityResponseReceivedHandler& handler,
                                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetSensitivityInspectionTemplateOutcome GetSensitivityInspectionTemplate(
      const Model::GetSensitivityInspectionTemplateRequest& request) const;

  /**
   * A Callable wrapper for GetSensitivityInspectionTemplate that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename GetSensitivityInspectionTemplateRequestT = Model::GetSensitivityInspectionTemplateRequest>
  Model::GetSensitivityInspectionTemplateOutcomeCallable GetSensitivityInspectionTemplateCallable(
      const GetSensitivityInspectionTemplateRequestT& request) const {
    return SubmitCallable(&Macie2Client::GetSensitivityInspectionTemplate, request);
  }

  /**
   * An Async wrapper for GetSensitivityInspectionTemplate that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetSensitivityInspectionTemplateRequestT = Model::GetSensitivityInspectionTemplateRequest>
  void GetSensitivityInspectionTemplateAsync(const GetSensitivityInspectionTemplateRequestT& request,
                                             const GetSensitivityInspectionTemplateResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetUsageStatistics that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetUsageStatistics that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetUsageStatisticsRequestT = Model::GetUsageStatisticsRequest>
  void GetUsageStatisticsAsync(const GetUsageStatisticsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const GetUsageStatisticsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetUsageTotals that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetUsageTotalsRequestT = Model::GetUsageTotalsRequest>
  void GetUsageTotalsAsync(const GetUsageTotalsResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const GetUsageTotalsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListAllowLists that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListAllowListsRequestT = Model::ListAllowListsRequest>
  void ListAllowListsAsync(const ListAllowListsResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const ListAllowListsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListAutomatedDiscoveryAccountsOutcome ListAutomatedDiscoveryAccounts(
      const Model::ListAutomatedDiscoveryAccountsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListAutomatedDiscoveryAccounts that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListAutomatedDiscoveryAccountsRequestT = Model::ListAutomatedDiscoveryAccountsRequest>
  Model::ListAutomatedDiscoveryAccountsOutcomeCallable ListAutomatedDiscoveryAccountsCallable(
      const ListAutomatedDiscoveryAccountsRequestT& request = {}) const {
    return SubmitCallable(&Macie2Client::ListAutomatedDiscoveryAccounts, request);
  }

  /**
   * An Async wrapper for ListAutomatedDiscoveryAccounts that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListAutomatedDiscoveryAccountsRequestT = Model::ListAutomatedDiscoveryAccountsRequest>
  void ListAutomatedDiscoveryAccountsAsync(const ListAutomatedDiscoveryAccountsResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                           const ListAutomatedDiscoveryAccountsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListClassificationJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListClassificationJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListClassificationJobsRequestT = Model::ListClassificationJobsRequest>
  void ListClassificationJobsAsync(const ListClassificationJobsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const ListClassificationJobsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListClassificationScopes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListClassificationScopesRequestT = Model::ListClassificationScopesRequest>
  Model::ListClassificationScopesOutcomeCallable ListClassificationScopesCallable(
      const ListClassificationScopesRequestT& request = {}) const {
    return SubmitCallable(&Macie2Client::ListClassificationScopes, request);
  }

  /**
   * An Async wrapper for ListClassificationScopes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListClassificationScopesRequestT = Model::ListClassificationScopesRequest>
  void ListClassificationScopesAsync(const ListClassificationScopesResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const ListClassificationScopesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListCustomDataIdentifiersOutcome ListCustomDataIdentifiers(
      const Model::ListCustomDataIdentifiersRequest& request = {}) const;

  /**
   * A Callable wrapper for ListCustomDataIdentifiers that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListCustomDataIdentifiersRequestT = Model::ListCustomDataIdentifiersRequest>
  Model::ListCustomDataIdentifiersOutcomeCallable ListCustomDataIdentifiersCallable(
      const ListCustomDataIdentifiersRequestT& request = {}) const {
    return SubmitCallable(&Macie2Client::ListCustomDataIdentifiers, request);
  }

  /**
   * An Async wrapper for ListCustomDataIdentifiers that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListCustomDataIdentifiersRequestT = Model::ListCustomDataIdentifiersRequest>
  void ListCustomDataIdentifiersAsync(const ListCustomDataIdentifiersResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const ListCustomDataIdentifiersRequestT& request = {}) const {
   ...
   */
  template <typename ListFindingsRequestT = Model::ListFindingsRequest>
  void ListFindingsAsync(const ListFindingsResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                         const ListFindingsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListFindingsFilters that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListFindingsFilters that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListFindingsFiltersRequestT = Model::ListFindingsFiltersRequest>
  void ListFindingsFiltersAsync(const ListFindingsFiltersResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const ListFindingsFiltersRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListInvitations that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListInvitationsRequestT = Model::ListInvitationsRequest>
  void ListInvitationsAsync(const ListInvitationsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const ListInvitationsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListManagedDataIdentifiersOutcome ListManagedDataIdentifiers(
      const Model::ListManagedDataIdentifiersRequest& request = {}) const;

  /**
   * A Callable wrapper for ListManagedDataIdentifiers that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListManagedDataIdentifiersRequestT = Model::ListManagedDataIdentifiersRequest>
  Model::ListManagedDataIdentifiersOutcomeCallable ListManagedDataIdentifiersCallable(
      const ListManagedDataIdentifiersRequestT& request = {}) const {
    return SubmitCallable(&Macie2Client::ListManagedDataIdentifiers, request);
  }

  /**
   * An Async wrapper for ListManagedDataIdentifiers that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListManagedDataIdentifiersRequestT = Model::ListManagedDataIdentifiersRequest>
  void ListManagedDataIdentifiersAsync(const ListManagedDataIdentifiersResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const ListManagedDataIdentifiersRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListMembers that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListMembersRequestT = Model::ListMembersRequest>
  void ListMembersAsync(const ListMembersResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                        const ListMembersRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListOrganizationAdminAccountsOutcome ListOrganizationAdminAccounts(
      const Model::ListOrganizationAdminAccountsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListOrganizationAdminAccounts that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListOrganizationAdminAccountsRequestT = Model::ListOrganizationAdminAccountsRequest>
  Model::ListOrganizationAdminAccountsOutcomeCallable ListOrganizationAdminAccountsCallable(
      const ListOrganizationAdminAccountsRequestT& request = {}) const {
    return SubmitCallable(&Macie2Client::ListOrganizationAdminAccounts, request);
  }

  /**
   * An Async wrapper for ListOrganizationAdminAccounts that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListOrganizationAdminAccountsRequestT = Model::ListOrganizationAdminAccountsRequest>
  void ListOrganizationAdminAccountsAsync(const ListOrganizationAdminAccountsResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                          const ListOrganizationAdminAccountsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListResourceProfileArtifactsOutcome ListResourceProfileArtifacts(
      const Model::ListResourceProfileArtifactsRequest& request) const;

  /**
   * A Callable wrapper for ListResourceProfileArtifacts that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListResourceProfileArtifactsRequestT = Model::ListResourceProfileArtifactsRequest>
  Model::ListResourceProfileArtifactsOutcomeCallable ListResourceProfileArtifactsCallable(
      const ListResourceProfileArtifactsRequestT& request) const {
    return SubmitCallable(&Macie2Client::ListResourceProfileArtifacts, request);
  }

  /**
   * An Async wrapper for ListResourceProfileArtifacts that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListResourceProfileArtifactsRequestT = Model::ListResourceProfileArtifactsRequest>
  void ListResourceProfileArtifactsAsync(const ListResourceProfileArtifactsRequestT& request,
                                         const ListResourceProfileArtifactsResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListResourceProfileDetectionsOutcome ListResourceProfileDetections(
      const Model::ListResourceProfileDetectionsRequest& request) const;

  /**
   * A Callable wrapper for ListResourceProfileDetections that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListResourceProfileDetectionsRequestT = Model::ListResourceProfileDetectionsRequest>
  Model::ListResourceProfileDetectionsOutcomeCallable ListResourceProfileDetectionsCallable(
      const ListResourceProfileDetectionsRequestT& request) const {
    return SubmitCallable(&Macie2Client::ListResourceProfileDetections, request);
  }

  /**
   * An Async wrapper for ListResourceProfileDetections that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListResourceProfileDetectionsRequestT = Model::ListResourceProfileDetectionsRequest>
  void ListResourceProfileDetectionsAsync(const ListResourceProfileDetectionsRequestT& request,
                                          const ListResourceProfileDetectionsResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListSensitivityInspectionTemplatesOutcome ListSensitivityInspectionTemplates(
      const Model::ListSensitivityInspectionTemplatesRequest& request = {}) const;

  /**
   * A Callable wrapper for ListSensitivityInspectionTemplates that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListSensitivityInspectionTemplatesRequestT = Model::ListSensitivityInspectionTemplatesRequest>
  Model::ListSensitivityInspectionTemplatesOutcomeCallable ListSensitivityInspectionTemplatesCallable(
      const ListSensitivityInspectionTemplatesRequestT& request = {}) const {
    return SubmitCallable(&Macie2Client::ListSensitivityInspectionTemplates, request);
  }

  /**
   * An Async wrapper for ListSensitivityInspectionTemplates that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListSensitivityInspectionTemplatesRequestT = Model::ListSensitivityInspectionTemplatesRequest>
  void ListSensitivityInspectionTemplatesAsync(const ListSensitivityInspectionTemplatesResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                               const ListSensitivityInspectionTemplatesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::PutClassificationExportConfigurationOutcome PutClassificationExportConfiguration(
      const Model::PutClassificationExportConfigurationRequest& request) const;

  /**
   * A Callable wrapper for PutClassificationExportConfiguration that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename PutClassificationExportConfigurationRequestT = Model::PutClassificationExportConfigurationRequest>
  Model::PutClassificationExportConfigurationOutcomeCallable PutClassificationExportConfigurationCallable(
      const PutClassificationExportConfigurationRequestT& request) const {
    return SubmitCallable(&Macie2Client::PutClassificationExportConfiguration, request);
  }

  /**
   * An Async wrapper for PutClassificationExportConfiguration that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename PutClassificationExportConfigurationRequestT = Model::PutClassificationExportConfigurationRequest>
  void PutClassificationExportConfigurationAsync(const PutClassificationExportConfigurationRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::PutFindingsPublicationConfigurationOutcome PutFindingsPublicationConfiguration(
      const Model::PutFindingsPublicationConfigurationRequest& request = {}) const;

  /**
   * A Callable wrapper for PutFindingsPublicationConfiguration that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename PutFindingsPublicationConfigurationRequestT = Model::PutFindingsPublicationConfigurationRequest>
  Model::PutFindingsPublicationConfigurationOutcomeCallable PutFindingsPublicationConfigurationCallable(
      const PutFindingsPublicationConfigurationRequestT& request = {}) const {
    return SubmitCallable(&Macie2Client::PutFindingsPublicationConfiguration, request);
  }

  /**
   * An Async wrapper for PutFindingsPublicationConfiguration that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename PutFindingsPublicationConfigurationRequestT = Model::PutFindingsPublicationConfigurationRequest>
  void PutFindingsPublicationConfigurationAsync(const PutFindingsPublicationConfigurationResponseReceivedHandler& handler,
                                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                const PutFindingsPublicationConfigurationRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for SearchResources that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename SearchResourcesRequestT = Model::SearchResourcesRequest>
  void SearchResourcesAsync(const SearchResourcesResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const SearchResourcesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for TestCustomDataIdentifier that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for TestCustomDataIdentifier that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename TestCustomDataIdentifierRequestT = Model::TestCustomDataIdentifierRequest>
  void TestCustomDataIdentifierAsync(const TestCustomDataIdentifierRequestT& request,
  ...
  /**
   * An Async wrapper for UpdateAllowList that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateAllowListRequestT = Model::UpdateAllowListRequest>
  void UpdateAllowListAsync(const UpdateAllowListRequestT& request, const UpdateAllowListResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateAutomatedDiscoveryConfigurationOutcome UpdateAutomatedDiscoveryConfiguration(
      const Model::UpdateAutomatedDiscoveryConfigurationRequest& request) const;

  /**
   * A Callable wrapper for UpdateAutomatedDiscoveryConfiguration that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename UpdateAutomatedDiscoveryConfigurationRequestT = Model::UpdateAutomatedDiscoveryConfigurationRequest>
  Model::UpdateAutomatedDiscoveryConfigurationOutcomeCallable UpdateAutomatedDiscoveryConfigurationCallable(
      const UpdateAutomatedDiscoveryConfigurationRequestT& request) const {
    return SubmitCallable(&Macie2Client::UpdateAutomatedDiscoveryConfiguration, request);
  }

  /**
   * An Async wrapper for UpdateAutomatedDiscoveryConfiguration that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename UpdateAutomatedDiscoveryConfigurationRequestT = Model::UpdateAutomatedDiscoveryConfigurationRequest>
  void UpdateAutomatedDiscoveryConfigurationAsync(const UpdateAutomatedDiscoveryConfigurationRequestT& request,
                                                  const UpdateAutomatedDiscoveryConfigurationResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateClassificationJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateClassificationJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateClassificationJobRequestT = Model::UpdateClassificationJobRequest>
  void UpdateClassificationJobAsync(const UpdateClassificationJobRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateClassificationScope that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename UpdateClassificationScopeRequestT = Model::UpdateClassificationScopeRequest>
  Model::UpdateClassificationScopeOutcomeCallable UpdateClassificationScopeCallable(
      const UpdateClassificationScopeRequestT& request) const {
    return SubmitCallable(&Macie2Client::UpdateClassificationScope, request);
  }

  /**
   * An Async wrapper for UpdateClassificationScope that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateClassificationScopeRequestT = Model::UpdateClassificationScopeRequest>
  void UpdateClassificationScopeAsync(const UpdateClassificationScopeRequestT& request,
                                      const UpdateClassificationScopeResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateFindingsFilter that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateFindingsFilter that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateFindingsFilterRequestT = Model::UpdateFindingsFilterRequest>
  void UpdateFindingsFilterAsync(const UpdateFindingsFilterRequestT& request, const UpdateFindingsFilterResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateMacieSession that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateMacieSession that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateMacieSessionRequestT = Model::UpdateMacieSessionRequest>
  void UpdateMacieSessionAsync(const UpdateMacieSessionResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const UpdateMacieSessionRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for UpdateMemberSession that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateMemberSession that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateMemberSessionRequestT = Model::UpdateMemberSessionRequest>
  void UpdateMemberSessionAsync(const UpdateMemberSessionRequestT& request, const UpdateMemberSessionResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::UpdateOrganizationConfigurationOutcome UpdateOrganizationConfiguration(
      const Model::UpdateOrganizationConfigurationRequest& request) const;

  /**
   * A Callable wrapper for UpdateOrganizationConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateOrganizationConfigurationRequestT = Model::UpdateOrganizationConfigurationRequest>
  Model::UpdateOrganizationConfigurationOutcomeCallable UpdateOrganizationConfigurationCallable(
      const UpdateOrganizationConfigurationRequestT& request) const {
    return SubmitCallable(&Macie2Client::UpdateOrganizationConfiguration, request);
  }

  /**
   * An Async wrapper for UpdateOrganizationConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateOrganizationConfigurationRequestT = Model::UpdateOrganizationConfigurationRequest>
  void UpdateOrganizationConfigurationAsync(const UpdateOrganizationConfigurationRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateResourceProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateResourceProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateResourceProfileRequestT = Model::UpdateResourceProfileRequest>
  void UpdateResourceProfileAsync(const UpdateResourceProfileRequestT& request, const UpdateResourceProfileResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateResourceProfileDetectionsOutcome UpdateResourceProfileDetections(
      const Model::UpdateResourceProfileDetectionsRequest& request) const;

  /**
   * A Callable wrapper for UpdateResourceProfileDetections that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateResourceProfileDetectionsRequestT = Model::UpdateResourceProfileDetectionsRequest>
  Model::UpdateResourceProfileDetectionsOutcomeCallable UpdateResourceProfileDetectionsCallable(
      const UpdateResourceProfileDetectionsRequestT& request) const {
    return SubmitCallable(&Macie2Client::UpdateResourceProfileDetections, request);
  }

  /**
   * An Async wrapper for UpdateResourceProfileDetections that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateResourceProfileDetectionsRequestT = Model::UpdateResourceProfileDetectionsRequest>
  void UpdateResourceProfileDetectionsAsync(const UpdateResourceProfileDetectionsRequestT& request,
                                            const UpdateResourceProfileDetectionsResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateRevealConfiguration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename UpdateRevealConfigurationRequestT = Model::UpdateRevealConfigurationRequest>
  Model::UpdateRevealConfigurationOutcomeCallable UpdateRevealConfigurationCallable(
      const UpdateRevealConfigurationRequestT& request) const {
    return SubmitCallable(&Macie2Client::UpdateRevealConfiguration, request);
  }

  /**
   * An Async wrapper for UpdateRevealConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateRevealConfigurationRequestT = Model::UpdateRevealConfigurationRequest>
  void UpdateRevealConfigurationAsync(const UpdateRevealConfigurationRequestT& request,
                                      const UpdateRevealConfigurationResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateSensitivityInspectionTemplateOutcome UpdateSensitivityInspectionTemplate(
      const Model::UpdateSensitivityInspectionTemplateRequest& request) const;

  /**
   * A Callable wrapper for UpdateSensitivityInspectionTemplate that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename UpdateSensitivityInspectionTemplateRequestT = Model::UpdateSensitivityInspectionTemplateRequest>
  Model::UpdateSensitivityInspectionTemplateOutcomeCallable UpdateSensitivityInspectionTemplateCallable(
      const UpdateSensitivityInspectionTemplateRequestT& request) const {
    return SubmitCallable(&Macie2Client::UpdateSensitivityInspectionTemplate, request);
  }

  /**
   * An Async wrapper for UpdateSensitivityInspectionTemplate that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename UpdateSensitivityInspectionTemplateRequestT = Model::UpdateSensitivityInspectionTemplateRequest>
  void UpdateSensitivityInspectionTemplateAsync(const UpdateSensitivityInspectionTemplateRequestT& request,
                                                const UpdateSensitivityInspectionTemplateResponseReceivedHandler& handler,
                                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
