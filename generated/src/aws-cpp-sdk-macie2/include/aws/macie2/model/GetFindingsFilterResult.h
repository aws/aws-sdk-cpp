...
class GetFindingsFilterResult {
 public:
  ...
  inline void SetAction(FindingsFilterAction value) {
    m_actionHasBeenSet = true;
    m_action = value;
  }
  inline GetFindingsFilterResult& WithAction(FindingsFilterAction value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  template <typename ArnT = Aws::String>
  GetFindingsFilterResult& WithArn(ArnT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  GetFindingsFilterResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename FindingCriteriaT = FindingCriteria>
  GetFindingsFilterResult& WithFindingCriteria(FindingCriteriaT&& value) {
  ...
  template <typename IdT = Aws::String>
  GetFindingsFilterResult& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  GetFindingsFilterResult& WithName(NameT&& value) {
  ...
  inline GetFindingsFilterResult& WithPosition(int value) {
    SetPosition(value);
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  GetFindingsFilterResult& WithTags(TagsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetFindingsFilterResult& WithRequestId(RequestIdT&& value) {
