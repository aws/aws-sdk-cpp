...
class Detection {
 public:
  ...
  inline Detection& WithCount(long long value) {
    SetCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSuppressed(bool value) {
    m_suppressedHasBeenSet = true;
    m_suppressed = value;
  }
  inline Detection& WithSuppressed(bool value) {
    SetSuppressed(value);
    return *this;
  }
  ///@}
  ...
  inline void SetType(DataIdentifierType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline Detection& WithType(DataIdentifierType value) {
    SetType(value);
    return *this;
  }
  ///@}
