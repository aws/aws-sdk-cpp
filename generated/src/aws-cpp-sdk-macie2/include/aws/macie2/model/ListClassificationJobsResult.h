...
class ListClassificationJobsResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<JobSummary>>
  ListClassificationJobsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = JobSummary>
  ListClassificationJobsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListClassificationJobsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListClassificationJobsResult& WithRequestId(RequestIdT&& value) {
