...
class GetResourceProfileResult {
 public:
  ...
  void SetProfileUpdatedAt(ProfileUpdatedAtT&& value) {
    m_profileUpdatedAtHasBeenSet = true;
    m_profileUpdatedAt = std::forward<ProfileUpdatedAtT>(value);
  }
  template <typename ProfileUpdatedAtT = Aws::Utils::DateTime>
  GetResourceProfileResult& WithProfileUpdatedAt(ProfileUpdatedAtT&& value) {
    SetProfileUpdatedAt(std::forward<ProfileUpdatedAtT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetSensitivityScore(int value) {
    m_sensitivityScoreHasBeenSet = true;
    m_sensitivityScore = value;
  }
  inline GetResourceProfileResult& WithSensitivityScore(int value) {
    SetSensitivityScore(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSensitivityScoreOverridden(bool value) {
    m_sensitivityScoreOverriddenHasBeenSet = true;
    m_sensitivityScoreOverridden = value;
  }
  inline GetResourceProfileResult& WithSensitivityScoreOverridden(bool value) {
    SetSensitivityScoreOverridden(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatisticsT = ResourceStatistics>
  GetResourceProfileResult& WithStatistics(StatisticsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetResourceProfileResult& WithRequestId(RequestIdT&& value) {
