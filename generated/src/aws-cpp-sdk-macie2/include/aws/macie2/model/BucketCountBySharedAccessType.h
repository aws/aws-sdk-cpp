...
class BucketCountBySharedAccessType {
 public:
  ...
  inline void SetExternal(long long value) {
    m_externalHasBeenSet = true;
    m_external = value;
  }
  inline BucketCountBySharedAccessType& WithExternal(long long value) {
    SetExternal(value);
    return *this;
  }
  ///@}
  ...
  inline void SetInternal(long long value) {
    m_internalHasBeenSet = true;
    m_internal = value;
  }
  inline BucketCountBySharedAccessType& WithInternal(long long value) {
    SetInternal(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNotShared(long long value) {
    m_notSharedHasBeenSet = true;
    m_notShared = value;
  }
  inline BucketCountBySharedAccessType& WithNotShared(long long value) {
    SetNotShared(value);
    return *this;
  }
  ///@}
  ...
  inline BucketCountBySharedAccessType& WithUnknown(long long value) {
    SetUnknown(value);
    return *this;
  }
  ///@}
