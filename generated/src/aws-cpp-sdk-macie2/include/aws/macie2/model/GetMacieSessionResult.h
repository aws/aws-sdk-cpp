...
namespace Model
{
  ...
  public:
    ...
    inline GetMacieSessionResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline GetMacieSessionResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline GetMacieSessionResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
