...
namespace Model
{
  ...
  public:
    ...
    inline GetAllowListResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline GetAllowListResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline GetAllowListResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
