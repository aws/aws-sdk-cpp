...
class SearchResourcesRequest : public Macie2Request {
 public:
  ...
  void SetBucketCriteria(BucketCriteriaT&& value) {
    ...
    m_bucketCriteria = std::forward<BucketCriteriaT>(value);
  }
  template <typename BucketCriteriaT = SearchResourcesBucketCriteria>
  SearchResourcesRequest& WithBucketCriteria(BucketCriteriaT&& value) {
    SetBucketCriteria(std::forward<BucketCriteriaT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename SortCriteriaT = SearchResourcesSortCriteria>
  SearchResourcesRequest& WithSortCriteria(SortCriteriaT&& value) {
