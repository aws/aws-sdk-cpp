...
namespace Model
{
  ...
  {
  public:
    AWS_MACIE2_API GetBucketStatisticsRequest() = default;
    ...
    template<typename AccountIdT = Aws::String>
    GetBucketStatisticsRequest& WithAccountId(AccountIdT&& value) { SetAccountId(std::forward<AccountIdT>(value)); return *this;}
    ///@}
  private:
