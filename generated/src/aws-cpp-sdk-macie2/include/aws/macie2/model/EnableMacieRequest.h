...
class EnableMacieRequest : public Macie2Request {
 public:
  ...
  template <typename ClientTokenT = Aws::String>
  EnableMacieRequest& WithClientToken(ClientTokenT&& value) {
  ...
  inline EnableMacieRequest& WithFindingPublishingFrequency(FindingPublishingFrequency value) {
  ...
  inline EnableMacieRequest& WithStatus(MacieStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
