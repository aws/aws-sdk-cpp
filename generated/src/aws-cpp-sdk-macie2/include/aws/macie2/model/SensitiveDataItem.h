...
class SensitiveDataItem {
 public:
  ...
  inline void SetCategory(SensitiveDataItemCategory value) {
    m_categoryHasBeenSet = true;
    m_category = value;
  }
  inline SensitiveDataItem& WithCategory(SensitiveDataItemCategory value) {
    SetCategory(value);
    return *this;
  }
  ///@}
  ...
  inline SensitiveDataItem& WithTotalCount(long long value) {
    SetTotalCount(value);
    return *this;
  }
  ///@}
