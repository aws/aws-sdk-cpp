...
namespace Model
{
  ...
  public:
    ...
    template<typename NextTokenT = Aws::String>
    ListSensitivityInspectionTemplatesResult& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    void SetSensitivityInspectionTemplates(SensitivityInspectionTemplatesT&& value) { m_sensitivityInspectionTemplatesHasBeenSet = true; m_sensitivityInspectionTemplates = std::forward<SensitivityInspectionTemplatesT>(value); }
    template<typename SensitivityInspectionTemplatesT = Aws::Vector<SensitivityInspectionTemplatesEntry>>
    ListSensitivityInspectionTemplatesResult& WithSensitivityInspectionTemplates(SensitivityInspectionTemplatesT&& value) { SetSensitivityInspectionTemplates(std::forward<SensitivityInspectionTemplatesT>(value)); return *this;}
    template<typename SensitivityInspectionTemplatesT = SensitivityInspectionTemplatesEntry>
    ListSensitivityInspectionTemplatesResult& AddSensitivityInspectionTemplates(SensitivityInspectionTemplatesT&& value) { m_sensitivityInspectionTemplatesHasBeenSet = true; m_sensitivityInspectionTemplates.emplace_back(std::forward<SensitivityInspectionTemplatesT>(value)); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ListSensitivityInspectionTemplatesResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
