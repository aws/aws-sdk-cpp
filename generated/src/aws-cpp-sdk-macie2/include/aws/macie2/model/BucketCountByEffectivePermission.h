...
class BucketCountByEffectivePermission {
 public:
  ...
  inline void SetPubliclyAccessible(long long value) {
    m_publiclyAccessibleHasBeenSet = true;
    m_publiclyAccessible = value;
  }
  inline BucketCountByEffectivePermission& WithPubliclyAccessible(long long value) {
  ...
  inline void SetPubliclyReadable(long long value) {
    m_publiclyReadableHasBeenSet = true;
    m_publiclyReadable = value;
  }
  inline BucketCountByEffectivePermission& WithPubliclyReadable(long long value) {
    SetPubliclyReadable(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPubliclyWritable(long long value) {
    m_publiclyWritableHasBeenSet = true;
    m_publiclyWritable = value;
  }
  inline BucketCountByEffectivePermission& WithPubliclyWritable(long long value) {
    SetPubliclyWritable(value);
    return *this;
  }
  ///@}
  ...
  inline BucketCountByEffectivePermission& WithUnknown(long long value) {
    SetUnknown(value);
    return *this;
  }
  ///@}
