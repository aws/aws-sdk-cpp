...
class ListSensitivityInspectionTemplatesRequest : public Macie2Request {
 public:
  AWS_MACIE2_API ListSensitivityInspectionTemplatesRequest() = default;
  ...
  inline ListSensitivityInspectionTemplatesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListSensitivityInspectionTemplatesRequest& WithNextToken(NextTokenT&& value) {
