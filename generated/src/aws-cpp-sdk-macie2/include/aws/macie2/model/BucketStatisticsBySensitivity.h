...
class BucketStatisticsBySensitivity {
 public:
  ...
  void SetClassificationError(ClassificationErrorT&& value) {
    ...
    m_classificationError = std::forward<ClassificationErrorT>(value);
  }
  template <typename ClassificationErrorT = SensitivityAggregations>
  BucketStatisticsBySensitivity& WithClassificationError(ClassificationErrorT&& value) {
    SetClassificationError(std::forward<ClassificationErrorT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNotClassified(NotClassifiedT&& value) {
    ...
    m_notClassified = std::forward<NotClassifiedT>(value);
  }
  template <typename NotClassifiedT = SensitivityAggregations>
  BucketStatisticsBySensitivity& WithNotClassified(NotClassifiedT&& value) {
    SetNotClassified(std::forward<NotClassifiedT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNotSensitive(NotSensitiveT&& value) {
    ...
    m_notSensitive = std::forward<NotSensitiveT>(value);
  }
  template <typename NotSensitiveT = SensitivityAggregations>
  BucketStatisticsBySensitivity& WithNotSensitive(NotSensitiveT&& value) {
    SetNotSensitive(std::forward<NotSensitiveT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSensitive(SensitiveT&& value) {
    ...
    m_sensitive = std::forward<SensitiveT>(value);
  }
  template <typename SensitiveT = SensitivityAggregations>
  BucketStatisticsBySensitivity& WithSensitive(SensitiveT&& value) {
    SetSensitive(std::forward<SensitiveT>(value));
    return *this;
  }
  ///@}
 private:
