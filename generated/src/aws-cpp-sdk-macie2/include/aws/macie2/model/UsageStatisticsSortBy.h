...
class UsageStatisticsSortBy {
 public:
  ...
  inline void SetKey(UsageStatisticsSortKey value) {
    m_keyHasBeenSet = true;
    m_key = value;
  }
  inline UsageStatisticsSortBy& WithKey(UsageStatisticsSortKey value) {
    SetKey(value);
    return *this;
  }
  ///@}
  ...
  inline UsageStatisticsSortBy& WithOrderBy(OrderBy value) {
    SetOrderBy(value);
    return *this;
  }
  ///@}
