...
class CreateCustomDataIdentifierRequest : public Macie2Request {
 public:
  ...
  inline CreateCustomDataIdentifierRequest& WithMaximumMatchDistance(int value) {
