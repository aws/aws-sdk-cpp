...
class AutomatedDiscoveryAccountUpdateError {
 public:
  ...
  inline void SetErrorCode(AutomatedDiscoveryAccountUpdateErrorCode value) {
    m_errorCodeHasBeenSet = true;
    m_errorCode = value;
  }
  inline AutomatedDiscoveryAccountUpdateError& WithErrorCode(AutomatedDiscoveryAccountUpdateErrorCode value) {
    SetErrorCode(value);
    return *this;
  }
  ///@}
