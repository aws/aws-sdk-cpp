...
namespace Model
{
  ...
  {
  public:
    AWS_MACIE2_API DisassociateMemberResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DisassociateMemberResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
