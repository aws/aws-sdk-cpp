...
namespace Model
{
  ...
  {
  public:
    AWS_MACIE2_API DisableOrganizationAdminAccountResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DisableOrganizationAdminAccountResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
