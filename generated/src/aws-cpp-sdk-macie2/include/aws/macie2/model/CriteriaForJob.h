...
class CriteriaForJob {
 public:
  ...
  void SetSimpleCriterion(SimpleCriterionT&& value) {
    ...
    m_simpleCriterion = std::forward<SimpleCriterionT>(value);
  }
  template <typename SimpleCriterionT = SimpleCriterionForJob>
  CriteriaForJob& WithSimpleCriterion(SimpleCriterionT&& value) {
    SetSimpleCriterion(std::forward<SimpleCriterionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTagCriterion(TagCriterionT&& value) {
    ...
    m_tagCriterion = std::forward<TagCriterionT>(value);
  }
  template <typename TagCriterionT = TagCriterionForJob>
  CriteriaForJob& WithTagCriterion(TagCriterionT&& value) {
    SetTagCriterion(std::forward<TagCriterionT>(value));
    return *this;
  }
  ///@}
 private:
