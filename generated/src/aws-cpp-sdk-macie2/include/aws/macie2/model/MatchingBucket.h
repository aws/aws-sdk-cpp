...
class MatchingBucket {
 public:
  ...
  inline MatchingBucket& WithAutomatedDiscoveryMonitoringStatus(AutomatedDiscoveryMonitoringStatus value) {
  ...
  inline MatchingBucket& WithClassifiableObjectCount(long long value) {
  ...
  inline MatchingBucket& WithClassifiableSizeInBytes(long long value) {
  ...
  inline MatchingBucket& WithErrorCode(BucketMetadataErrorCode value) {
    SetErrorCode(value);
    return *this;
  }
  ///@}
  ...
  inline MatchingBucket& WithObjectCount(long long value) {
  ...
  inline MatchingBucket& WithSensitivityScore(int value) {
  ...
  inline MatchingBucket& WithSizeInBytes(long long value) {
  ...
  inline MatchingBucket& WithSizeInBytesCompressed(long long value) {
