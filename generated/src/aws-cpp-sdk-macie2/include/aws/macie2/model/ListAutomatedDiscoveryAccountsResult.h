...
class ListAutomatedDiscoveryAccountsResult {
 public:
  AWS_MACIE2_API ListAutomatedDiscoveryAccountsResult() = default;
  ...
  template <typename ItemsT = Aws::Vector<AutomatedDiscoveryAccount>>
  void SetItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
    m_items = std::forward<ItemsT>(value);
  }
  template <typename ItemsT = Aws::Vector<AutomatedDiscoveryAccount>>
  ListAutomatedDiscoveryAccountsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = AutomatedDiscoveryAccount>
  ListAutomatedDiscoveryAccountsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListAutomatedDiscoveryAccountsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAutomatedDiscoveryAccountsResult& WithRequestId(RequestIdT&& value) {
