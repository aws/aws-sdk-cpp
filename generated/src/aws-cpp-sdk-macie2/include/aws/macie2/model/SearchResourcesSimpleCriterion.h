...
class SearchResourcesSimpleCriterion {
 public:
  ...
  inline SearchResourcesSimpleCriterion& WithComparator(SearchResourcesComparator value) {
    SetComparator(value);
    return *this;
  }
  ///@}
  ...
  inline void SetKey(SearchResourcesSimpleCriterionKey value) {
    m_keyHasBeenSet = true;
    m_key = value;
  }
  inline SearchResourcesSimpleCriterion& WithKey(SearchResourcesSimpleCriterionKey value) {
    SetKey(value);
    return *this;
  }
  ///@}
