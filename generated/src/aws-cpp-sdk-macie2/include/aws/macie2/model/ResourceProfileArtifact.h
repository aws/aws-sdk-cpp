...
class ResourceProfileArtifact {
 public:
  ...
  void SetClassificationResultStatus(ClassificationResultStatusT&& value) {
    ...
    m_classificationResultStatus = std::forward<ClassificationResultStatusT>(value);
  }
  template <typename ClassificationResultStatusT = Aws::String>
  ResourceProfileArtifact& WithClassificationResultStatus(ClassificationResultStatusT&& value) {
    SetClassificationResultStatus(std::forward<ClassificationResultStatusT>(value));
    return *this;
  }
  ///@}
  ...
  inline ResourceProfileArtifact& WithSensitive(bool value) {
    SetSensitive(value);
    return *this;
  }
  ///@}
