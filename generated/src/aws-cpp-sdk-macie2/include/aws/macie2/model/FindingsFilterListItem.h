...
class FindingsFilterListItem {
 public:
  ...
  inline FindingsFilterListItem& WithAction(FindingsFilterAction value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  template <typename ArnT = Aws::String>
  FindingsFilterListItem& WithArn(ArnT&& value) {
  ...
  template <typename IdT = Aws::String>
  FindingsFilterListItem& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  FindingsFilterListItem& WithName(NameT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  FindingsFilterListItem& WithTags(TagsT&& value) {
