...
class UpdateResourceProfileDetectionsRequest : public Macie2Request {
 public:
  ...
  void SetSuppressDataIdentifiers(SuppressDataIdentifiersT&& value) {
    m_suppressDataIdentifiersHasBeenSet = true;
    m_suppressDataIdentifiers = std::forward<SuppressDataIdentifiersT>(value);
  }
  template <typename SuppressDataIdentifiersT = Aws::Vector<SuppressDataIdentifier>>
  UpdateResourceProfileDetectionsRequest& WithSuppressDataIdentifiers(SuppressDataIdentifiersT&& value) {
    SetSuppressDataIdentifiers(std::forward<SuppressDataIdentifiersT>(value));
    return *this;
  }
  ...
  UpdateResourceProfileDetectionsRequest& AddSuppressDataIdentifiers(SuppressDataIdentifiersT&& value) {
    m_suppressDataIdentifiersHasBeenSet = true;
    m_suppressDataIdentifiers.emplace_back(std::forward<SuppressDataIdentifiersT>(value));
    return *this;
  }
  ///@}
 private:
