...
class BucketCountByEncryptionType {
 public:
  ...
  inline BucketCountByEncryptionType& WithKmsManaged(long long value) {
    SetKmsManaged(value);
    return *this;
  }
  ///@}
  ...
  inline BucketCountByEncryptionType& WithS3Managed(long long value) {
    SetS3Managed(value);
    return *this;
  }
  ///@}
  ...
  inline BucketCountByEncryptionType& WithUnencrypted(long long value) {
  ...
  inline BucketCountByEncryptionType& WithUnknown(long long value) {
    SetUnknown(value);
    return *this;
  }
  ///@}
