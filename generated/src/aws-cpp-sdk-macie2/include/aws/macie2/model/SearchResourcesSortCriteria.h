...
class SearchResourcesSortCriteria {
 public:
  ...
  inline void SetAttributeName(SearchResourcesSortAttributeName value) {
    m_attributeNameHasBeenSet = true;
    m_attributeName = value;
  }
  inline SearchResourcesSortCriteria& WithAttributeName(SearchResourcesSortAttributeName value) {
  ...
  inline SearchResourcesSortCriteria& WithOrderBy(OrderBy value) {
    SetOrderBy(value);
    return *this;
  }
  ///@}
