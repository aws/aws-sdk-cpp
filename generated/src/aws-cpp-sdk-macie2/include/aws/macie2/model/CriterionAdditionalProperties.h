...
class CriterionAdditionalProperties {
 public:
  ...
  inline void SetGt(long long value) {
    m_gtHasBeenSet = true;
    m_gt = value;
  }
  inline CriterionAdditionalProperties& WithGt(long long value) {
    SetGt(value);
    return *this;
  }
  ///@}
  ...
  inline void SetGte(long long value) {
    m_gteHasBeenSet = true;
    m_gte = value;
  }
  inline CriterionAdditionalProperties& WithGte(long long value) {
    SetGte(value);
    return *this;
  }
  ///@}
  ...
  inline void SetLt(long long value) {
    m_ltHasBeenSet = true;
    m_lt = value;
  }
  inline CriterionAdditionalProperties& WithLt(long long value) {
    SetLt(value);
    return *this;
  }
  ///@}
  ...
  inline void SetLte(long long value) {
    m_lteHasBeenSet = true;
    m_lte = value;
  }
  inline CriterionAdditionalProperties& WithLte(long long value) {
    SetLte(value);
    return *this;
  }
  ///@}
