...
class ListResourceProfileDetectionsResult {
 public:
  ...
  void SetDetections(DetectionsT&& value) {
    ...
    m_detections = std::forward<DetectionsT>(value);
  }
  template <typename DetectionsT = Aws::Vector<Detection>>
  ListResourceProfileDetectionsResult& WithDetections(DetectionsT&& value) {
    SetDetections(std::forward<DetectionsT>(value));
    return *this;
  }
  template <typename DetectionsT = Detection>
  ListResourceProfileDetectionsResult& AddDetections(DetectionsT&& value) {
    m_detectionsHasBeenSet = true;
    m_detections.emplace_back(std::forward<DetectionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListResourceProfileDetectionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListResourceProfileDetectionsResult& WithRequestId(RequestIdT&& value) {
