...
class SimpleCriterionForJob {
 public:
  ...
  inline SimpleCriterionForJob& WithComparator(JobComparator value) {
    SetComparator(value);
    return *this;
  }
  ///@}
  ...
  inline void SetKey(SimpleCriterionKeyForJob value) {
    m_keyHasBeenSet = true;
    m_key = value;
  }
  inline SimpleCriterionForJob& WithKey(SimpleCriterionKeyForJob value) {
    SetKey(value);
    return *this;
  }
  ///@}
