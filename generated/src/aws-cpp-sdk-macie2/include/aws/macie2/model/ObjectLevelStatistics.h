...
class ObjectLevelStatistics {
 public:
  ...
  inline void SetFileType(long long value) {
    m_fileTypeHasBeenSet = true;
    m_fileType = value;
  }
  inline ObjectLevelStatistics& WithFileType(long long value) {
    SetFileType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStorageClass(long long value) {
    m_storageClassHasBeenSet = true;
    m_storageClass = value;
  }
  inline ObjectLevelStatistics& WithStorageClass(long long value) {
  ...
  inline ObjectLevelStatistics& WithTotal(long long value) {
    SetTotal(value);
    return *this;
  }
  ///@}
