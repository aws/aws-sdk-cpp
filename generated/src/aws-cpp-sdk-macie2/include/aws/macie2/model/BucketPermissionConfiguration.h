...
class BucketPermissionConfiguration {
 public:
  ...
  void SetAccountLevelPermissions(AccountLevelPermissionsT&& value) {
    m_accountLevelPermissionsHasBeenSet = true;
    m_accountLevelPermissions = std::forward<AccountLevelPermissionsT>(value);
  }
  template <typename AccountLevelPermissionsT = AccountLevelPermissions>
  BucketPermissionConfiguration& WithAccountLevelPermissions(AccountLevelPermissionsT&& value) {
    SetAccountLevelPermissions(std::forward<AccountLevelPermissionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBucketLevelPermissions(BucketLevelPermissionsT&& value) {
    m_bucketLevelPermissionsHasBeenSet = true;
    m_bucketLevelPermissions = std::forward<BucketLevelPermissionsT>(value);
  }
  template <typename BucketLevelPermissionsT = BucketLevelPermissions>
  BucketPermissionConfiguration& WithBucketLevelPermissions(BucketLevelPermissionsT&& value) {
    SetBucketLevelPermissions(std::forward<BucketLevelPermissionsT>(value));
    return *this;
  }
  ///@}
 private:
