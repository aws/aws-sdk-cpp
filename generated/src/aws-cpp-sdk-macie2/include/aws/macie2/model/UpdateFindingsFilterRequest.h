...
class UpdateFindingsFilterRequest : public Macie2Request {
 public:
  ...
  inline UpdateFindingsFilterRequest& WithAction(FindingsFilterAction value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  template <typename ClientTokenT = Aws::String>
  UpdateFindingsFilterRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateFindingsFilterRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename FindingCriteriaT = FindingCriteria>
  UpdateFindingsFilterRequest& WithFindingCriteria(FindingCriteriaT&& value) {
  ...
  template <typename IdT = Aws::String>
  UpdateFindingsFilterRequest& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  UpdateFindingsFilterRequest& WithName(NameT&& value) {
  ...
  inline UpdateFindingsFilterRequest& WithPosition(int value) {
    SetPosition(value);
    return *this;
  }
  ///@}
