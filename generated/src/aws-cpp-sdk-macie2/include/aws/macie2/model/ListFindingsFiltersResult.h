...
class ListFindingsFiltersResult {
 public:
  ...
  void SetFindingsFilterListItems(FindingsFilterListItemsT&& value) {
    m_findingsFilterListItemsHasBeenSet = true;
    m_findingsFilterListItems = std::forward<FindingsFilterListItemsT>(value);
  }
  template <typename FindingsFilterListItemsT = Aws::Vector<FindingsFilterListItem>>
  ListFindingsFiltersResult& WithFindingsFilterListItems(FindingsFilterListItemsT&& value) {
    SetFindingsFilterListItems(std::forward<FindingsFilterListItemsT>(value));
    return *this;
  }
  template <typename FindingsFilterListItemsT = FindingsFilterListItem>
  ListFindingsFiltersResult& AddFindingsFilterListItems(FindingsFilterListItemsT&& value) {
    m_findingsFilterListItemsHasBeenSet = true;
    m_findingsFilterListItems.emplace_back(std::forward<FindingsFilterListItemsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListFindingsFiltersResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListFindingsFiltersResult& WithRequestId(RequestIdT&& value) {
