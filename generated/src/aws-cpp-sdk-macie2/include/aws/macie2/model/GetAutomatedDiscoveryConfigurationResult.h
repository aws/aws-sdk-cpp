...
class GetAutomatedDiscoveryConfigurationResult {
 public:
  ...
  AWS_MACIE2_API GetAutomatedDiscoveryConfigurationResult& operator=(
  ...
  inline void SetAutoEnableOrganizationMembers(AutoEnableMode value) {
    m_autoEnableOrganizationMembersHasBeenSet = true;
    m_autoEnableOrganizationMembers = value;
  }
  inline GetAutomatedDiscoveryConfigurationResult& WithAutoEnableOrganizationMembers(AutoEnableMode value) {
    SetAutoEnableOrganizationMembers(value);
    return *this;
  }
  ///@}
  ...
  void SetClassificationScopeId(ClassificationScopeIdT&& value) {
    ...
    m_classificationScopeId = std::forward<ClassificationScopeIdT>(value);
  }
  template <typename ClassificationScopeIdT = Aws::String>
  GetAutomatedDiscoveryConfigurationResult& WithClassificationScopeId(ClassificationScopeIdT&& value) {
    SetClassificationScopeId(std::forward<ClassificationScopeIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDisabledAt(DisabledAtT&& value) {
    ...
    m_disabledAt = std::forward<DisabledAtT>(value);
  }
  template <typename DisabledAtT = Aws::Utils::DateTime>
  GetAutomatedDiscoveryConfigurationResult& WithDisabledAt(DisabledAtT&& value) {
    SetDisabledAt(std::forward<DisabledAtT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFirstEnabledAt(FirstEnabledAtT&& value) {
    ...
    m_firstEnabledAt = std::forward<FirstEnabledAtT>(value);
  }
  template <typename FirstEnabledAtT = Aws::Utils::DateTime>
  GetAutomatedDiscoveryConfigurationResult& WithFirstEnabledAt(FirstEnabledAtT&& value) {
    SetFirstEnabledAt(std::forward<FirstEnabledAtT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSensitivityInspectionTemplateId(SensitivityInspectionTemplateIdT&& value) {
    ...
    m_sensitivityInspectionTemplateId = std::forward<SensitivityInspectionTemplateIdT>(value);
  }
  template <typename SensitivityInspectionTemplateIdT = Aws::String>
  GetAutomatedDiscoveryConfigurationResult& WithSensitivityInspectionTemplateId(SensitivityInspectionTemplateIdT&& value) {
    SetSensitivityInspectionTemplateId(std::forward<SensitivityInspectionTemplateIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(AutomatedDiscoveryStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline GetAutomatedDiscoveryConfigurationResult& WithStatus(AutomatedDiscoveryStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
