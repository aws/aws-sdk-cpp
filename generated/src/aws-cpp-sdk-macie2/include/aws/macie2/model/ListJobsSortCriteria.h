...
class ListJobsSortCriteria {
 public:
  ...
  inline void SetAttributeName(ListJobsSortAttributeName value) {
    m_attributeNameHasBeenSet = true;
    m_attributeName = value;
  }
  inline ListJobsSortCriteria& WithAttributeName(ListJobsSortAttributeName value) {
  ...
  inline ListJobsSortCriteria& WithOrderBy(OrderBy value) {
    SetOrderBy(value);
    return *this;
  }
  ///@}
