...
class FindingAction {
 public:
  ...
  inline void SetActionType(FindingActionType value) {
    m_actionTypeHasBeenSet = true;
    m_actionType = value;
  }
  inline FindingAction& WithActionType(FindingActionType value) {
    SetActionType(value);
    return *this;
  }
  ///@}
  ...
  void SetApiCallDetails(ApiCallDetailsT&& value) {
    ...
    m_apiCallDetails = std::forward<ApiCallDetailsT>(value);
  }
  template <typename ApiCallDetailsT = ApiCallDetails>
  FindingAction& WithApiCallDetails(ApiCallDetailsT&& value) {
    SetApiCallDetails(std::forward<ApiCallDetailsT>(value));
    return *this;
  }
  ///@}
 private:
