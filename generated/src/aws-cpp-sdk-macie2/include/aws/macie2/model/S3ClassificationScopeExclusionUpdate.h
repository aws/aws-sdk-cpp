...
class S3ClassificationScopeExclusionUpdate {
 public:
  ...
  inline void SetOperation(ClassificationScopeUpdateOperation value) {
    m_operationHasBeenSet = true;
    m_operation = value;
  }
  inline S3ClassificationScopeExclusionUpdate& WithOperation(ClassificationScopeUpdateOperation value) {
    SetOperation(value);
    return *this;
  }
  ///@}
