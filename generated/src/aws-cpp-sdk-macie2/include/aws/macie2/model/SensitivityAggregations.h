...
class SensitivityAggregations {
 public:
  ...
  inline SensitivityAggregations& WithClassifiableSizeInBytes(long long value) {
  ...
  inline void SetPubliclyAccessibleCount(long long value) {
    m_publiclyAccessibleCountHasBeenSet = true;
    m_publiclyAccessibleCount = value;
  }
  inline SensitivityAggregations& WithPubliclyAccessibleCount(long long value) {
    SetPubliclyAccessibleCount(value);
    return *this;
  }
  ///@}
  ...
  inline SensitivityAggregations& WithTotalCount(long long value) {
    SetTotalCount(value);
    return *this;
  }
  ///@}
  ...
  inline SensitivityAggregations& WithTotalSizeInBytes(long long value) {
