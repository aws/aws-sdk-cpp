...
class SearchResourcesTagCriterion {
 public:
  ...
  inline void SetComparator(SearchResourcesComparator value) {
    m_comparatorHasBeenSet = true;
    m_comparator = value;
  }
  inline SearchResourcesTagCriterion& WithComparator(SearchResourcesComparator value) {
    SetComparator(value);
    return *this;
  }
  ///@}
  ...
  template <typename TagValuesT = Aws::Vector<SearchResourcesTagCriterionPair>>
  SearchResourcesTagCriterion& WithTagValues(TagValuesT&& value) {
    SetTagValues(std::forward<TagValuesT>(value));
    return *this;
  }
  template <typename TagValuesT = SearchResourcesTagCriterionPair>
  SearchResourcesTagCriterion& AddTagValues(TagValuesT&& value) {
    m_tagValuesHasBeenSet = true;
