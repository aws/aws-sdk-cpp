...
class BatchUpdateAutomatedDiscoveryAccountsResult {
 public:
  ...
  AWS_MACIE2_API BatchUpdateAutomatedDiscoveryAccountsResult& operator=(
  ...
  template <typename ErrorsT = Aws::Vector<AutomatedDiscoveryAccountUpdateError>>
  BatchUpdateAutomatedDiscoveryAccountsResult& WithErrors(ErrorsT&& value) {
    SetErrors(std::forward<ErrorsT>(value));
    return *this;
  }
  template <typename ErrorsT = AutomatedDiscoveryAccountUpdateError>
  BatchUpdateAutomatedDiscoveryAccountsResult& AddErrors(ErrorsT&& value) {
    m_errorsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  BatchUpdateAutomatedDiscoveryAccountsResult& WithRequestId(RequestIdT&& value) {
