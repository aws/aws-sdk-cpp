...
class ListJobsFilterCriteria {
 public:
  ...
  template <typename ExcludesT = Aws::Vector<ListJobsFilterTerm>>
  ListJobsFilterCriteria& WithExcludes(ExcludesT&& value) {
    SetExcludes(std::forward<ExcludesT>(value));
    return *this;
  }
  template <typename ExcludesT = ListJobsFilterTerm>
  ListJobsFilterCriteria& AddExcludes(ExcludesT&& value) {
    m_excludesHasBeenSet = true;
  ...
  template <typename IncludesT = Aws::Vector<ListJobsFilterTerm>>
  ListJobsFilterCriteria& WithIncludes(IncludesT&& value) {
    SetIncludes(std::forward<IncludesT>(value));
    return *this;
  }
  template <typename IncludesT = ListJobsFilterTerm>
  ListJobsFilterCriteria& AddIncludes(IncludesT&& value) {
    m_includesHasBeenSet = true;
