...
class ListCustomDataIdentifiersResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<CustomDataIdentifierSummary>>
  ListCustomDataIdentifiersResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = CustomDataIdentifierSummary>
  ListCustomDataIdentifiersResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListCustomDataIdentifiersResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListCustomDataIdentifiersResult& WithRequestId(RequestIdT&& value) {
