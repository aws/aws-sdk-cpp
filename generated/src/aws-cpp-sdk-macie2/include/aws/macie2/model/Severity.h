...
class Severity {
 public:
  ...
  inline void SetDescription(SeverityDescription value) {
    m_descriptionHasBeenSet = true;
    m_description = value;
  }
  inline Severity& WithDescription(SeverityDescription value) {
  ...
  inline void SetScore(long long value) {
    m_scoreHasBeenSet = true;
    m_score = value;
  }
  inline Severity& WithScore(long long value) {
    SetScore(value);
    return *this;
  }
  ///@}
