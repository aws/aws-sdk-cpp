...
class BucketCriteriaAdditionalProperties {
 public:
  ...
  inline BucketCriteriaAdditionalProperties& WithGt(long long value) {
    SetGt(value);
    return *this;
  }
  ///@}
  ...
  inline BucketCriteriaAdditionalProperties& WithGte(long long value) {
    SetGte(value);
    return *this;
  }
  ///@}
  ...
  inline BucketCriteriaAdditionalProperties& WithLt(long long value) {
    SetLt(value);
    return *this;
  }
  ///@}
  ...
  inline BucketCriteriaAdditionalProperties& WithLte(long long value) {
    SetLte(value);
    return *this;
  }
  ///@}
