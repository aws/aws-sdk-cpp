...
class GetUsageTotalsResult {
 public:
  ...
  inline GetUsageTotalsResult& WithTimeRange(TimeRange value) {
    SetTimeRange(value);
    return *this;
  }
  ///@}
  ...
  void SetUsageTotals(UsageTotalsT&& value) {
    m_usageTotalsHasBeenSet = true;
    m_usageTotals = std::forward<UsageTotalsT>(value);
  }
  template <typename UsageTotalsT = Aws::Vector<UsageTotal>>
  GetUsageTotalsResult& WithUsageTotals(UsageTotalsT&& value) {
    SetUsageTotals(std::forward<UsageTotalsT>(value));
    return *this;
  }
  template <typename UsageTotalsT = UsageTotal>
  GetUsageTotalsResult& AddUsageTotals(UsageTotalsT&& value) {
    m_usageTotalsHasBeenSet = true;
    m_usageTotals.emplace_back(std::forward<UsageTotalsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetUsageTotalsResult& WithRequestId(RequestIdT&& value) {
