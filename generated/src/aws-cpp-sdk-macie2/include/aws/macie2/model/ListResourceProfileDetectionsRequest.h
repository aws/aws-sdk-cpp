...
class ListResourceProfileDetectionsRequest : public Macie2Request {
 public:
  AWS_MACIE2_API ListResourceProfileDetectionsRequest() = default;
  ...
  inline ListResourceProfileDetectionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListResourceProfileDetectionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResourceArnT = Aws::String>
  ListResourceProfileDetectionsRequest& WithResourceArn(ResourceArnT&& value) {
