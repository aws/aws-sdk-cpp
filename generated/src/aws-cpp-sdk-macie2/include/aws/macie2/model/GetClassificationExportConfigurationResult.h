...
namespace Model
{
  ...
  {
  public:
    AWS_MACIE2_API GetClassificationExportConfigurationResult() = default;
    ...
    template<typename ConfigurationT = ClassificationExportConfiguration>
    GetClassificationExportConfigurationResult& WithConfiguration(ConfigurationT&& value) { SetConfiguration(std::forward<ConfigurationT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    GetClassificationExportConfigurationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
