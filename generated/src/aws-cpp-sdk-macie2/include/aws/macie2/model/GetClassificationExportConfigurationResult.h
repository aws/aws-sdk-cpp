...
class GetClassificationExportConfigurationResult {
 public:
  ...
  AWS_MACIE2_API GetClassificationExportConfigurationResult& operator=(
  ...
  template <typename ConfigurationT = ClassificationExportConfiguration>
  GetClassificationExportConfigurationResult& WithConfiguration(ConfigurationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetClassificationExportConfigurationResult& WithRequestId(RequestIdT&& value) {
