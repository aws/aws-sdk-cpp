...
class DescribeClassificationJobResult {
 public:
  ...
  inline DescribeClassificationJobResult& WithInitialRun(bool value) {
    SetInitialRun(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeClassificationJobResult& WithJobStatus(JobStatus value) {
    SetJobStatus(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeClassificationJobResult& WithJobType(JobType value) {
    SetJobType(value);
    return *this;
  }
  ///@}
  ...
  void SetLastRunErrorStatus(LastRunErrorStatusT&& value) {
    ...
    m_lastRunErrorStatus = std::forward<LastRunErrorStatusT>(value);
  }
  template <typename LastRunErrorStatusT = LastRunErrorStatus>
  DescribeClassificationJobResult& WithLastRunErrorStatus(LastRunErrorStatusT&& value) {
    SetLastRunErrorStatus(std::forward<LastRunErrorStatusT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeClassificationJobResult& WithManagedDataIdentifierSelector(ManagedDataIdentifierSelector value) {
  ...
  inline DescribeClassificationJobResult& WithSamplingPercentage(int value) {
  ...
  void SetUserPausedDetails(UserPausedDetailsT&& value) {
    ...
    m_userPausedDetails = std::forward<UserPausedDetailsT>(value);
  }
  template <typename UserPausedDetailsT = UserPausedDetails>
  DescribeClassificationJobResult& WithUserPausedDetails(UserPausedDetailsT&& value) {
    SetUserPausedDetails(std::forward<UserPausedDetailsT>(value));
    return *this;
  }
  ///@}
