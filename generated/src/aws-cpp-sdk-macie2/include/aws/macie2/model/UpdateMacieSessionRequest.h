...
class UpdateMacieSessionRequest : public Macie2Request {
 public:
  ...
  inline UpdateMacieSessionRequest& WithFindingPublishingFrequency(FindingPublishingFrequency value) {
  ...
  inline UpdateMacieSessionRequest& WithStatus(MacieStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
