...
class ReplicationDetails {
 public:
  ...
  inline ReplicationDetails& WithReplicated(bool value) {
    SetReplicated(value);
    return *this;
  }
  ///@}
  ...
  inline void SetReplicatedExternally(bool value) {
    m_replicatedExternallyHasBeenSet = true;
    m_replicatedExternally = value;
  }
  inline ReplicationDetails& WithReplicatedExternally(bool value) {
    SetReplicatedExternally(value);
    return *this;
  }
  ///@}
  ...
  void SetReplicationAccounts(ReplicationAccountsT&& value) {
    ...
    m_replicationAccounts = std::forward<ReplicationAccountsT>(value);
  }
  template <typename ReplicationAccountsT = Aws::Vector<Aws::String>>
  ReplicationDetails& WithReplicationAccounts(ReplicationAccountsT&& value) {
    SetReplicationAccounts(std::forward<ReplicationAccountsT>(value));
    return *this;
  }
  template <typename ReplicationAccountsT = Aws::String>
  ReplicationDetails& AddReplicationAccounts(ReplicationAccountsT&& value) {
    m_replicationAccountsHasBeenSet = true;
    m_replicationAccounts.emplace_back(std::forward<ReplicationAccountsT>(value));
    return *this;
  }
  ///@}
 private:
