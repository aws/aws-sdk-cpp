...
namespace Model
{
  ...
  {
  public:
    AWS_MACIE2_API DeleteFindingsFilterResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteFindingsFilterResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
