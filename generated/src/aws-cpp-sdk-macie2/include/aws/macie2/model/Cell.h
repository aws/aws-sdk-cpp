...
class Cell {
 public:
  ...
  void SetCellReference(CellReferenceT&& value) {
    ...
    m_cellReference = std::forward<CellReferenceT>(value);
  }
  template <typename CellReferenceT = Aws::String>
  Cell& WithCellReference(CellReferenceT&& value) {
    SetCellReference(std::forward<CellReferenceT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetColumn(long long value) {
    m_columnHasBeenSet = true;
    m_column = value;
  }
  inline Cell& WithColumn(long long value) {
    SetColumn(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRow(long long value) {
    m_rowHasBeenSet = true;
    m_row = value;
  }
  inline Cell& WithRow(long long value) {
    SetRow(value);
    return *this;
  }
  ///@}
