...
class CreateClassificationJobRequest : public Macie2Request {
 public:
  ...
  void SetCustomDataIdentifierIds(CustomDataIdentifierIdsT&& value) {
    ...
    m_customDataIdentifierIds = std::forward<CustomDataIdentifierIdsT>(value);
  }
  template <typename CustomDataIdentifierIdsT = Aws::Vector<Aws::String>>
  CreateClassificationJobRequest& WithCustomDataIdentifierIds(CustomDataIdentifierIdsT&& value) {
    SetCustomDataIdentifierIds(std::forward<CustomDataIdentifierIdsT>(value));
    return *this;
  }
  ...
  CreateClassificationJobRequest& AddCustomDataIdentifierIds(CustomDataIdentifierIdsT&& value) {
    m_customDataIdentifierIdsHasBeenSet = true;
    m_customDataIdentifierIds.emplace_back(std::forward<CustomDataIdentifierIdsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetInitialRun(bool value) {
    m_initialRunHasBeenSet = true;
    m_initialRun = value;
  }
  inline CreateClassificationJobRequest& WithInitialRun(bool value) {
    SetInitialRun(value);
    return *this;
  }
  ///@}
  ...
  inline CreateClassificationJobRequest& WithJobType(JobType value) {
    SetJobType(value);
    return *this;
  }
  ///@}
  ...
  void SetManagedDataIdentifierIds(ManagedDataIdentifierIdsT&& value) {
    ...
    m_managedDataIdentifierIds = std::forward<ManagedDataIdentifierIdsT>(value);
  }
  template <typename ManagedDataIdentifierIdsT = Aws::Vector<Aws::String>>
  CreateClassificationJobRequest& WithManagedDataIdentifierIds(ManagedDataIdentifierIdsT&& value) {
    SetManagedDataIdentifierIds(std::forward<ManagedDataIdentifierIdsT>(value));
    return *this;
  }
  ...
  CreateClassificationJobRequest& AddManagedDataIdentifierIds(ManagedDataIdentifierIdsT&& value) {
    m_managedDataIdentifierIdsHasBeenSet = true;
    m_managedDataIdentifierIds.emplace_back(std::forward<ManagedDataIdentifierIdsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetManagedDataIdentifierSelector(ManagedDataIdentifierSelector value) {
    m_managedDataIdentifierSelectorHasBeenSet = true;
    m_managedDataIdentifierSelector = value;
  }
  inline CreateClassificationJobRequest& WithManagedDataIdentifierSelector(ManagedDataIdentifierSelector value) {
    SetManagedDataIdentifierSelector(value);
    return *this;
  }
  ///@}
  ...
  void SetS3JobDefinition(S3JobDefinitionT&& value) {
    ...
    m_s3JobDefinition = std::forward<S3JobDefinitionT>(value);
  }
  template <typename S3JobDefinitionT = S3JobDefinition>
  CreateClassificationJobRequest& WithS3JobDefinition(S3JobDefinitionT&& value) {
    SetS3JobDefinition(std::forward<S3JobDefinitionT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetSamplingPercentage(int value) {
    m_samplingPercentageHasBeenSet = true;
    m_samplingPercentage = value;
  }
  inline CreateClassificationJobRequest& WithSamplingPercentage(int value) {
  ...
  void SetScheduleFrequency(ScheduleFrequencyT&& value) {
    ...
    m_scheduleFrequency = std::forward<ScheduleFrequencyT>(value);
  }
  template <typename ScheduleFrequencyT = JobScheduleFrequency>
  CreateClassificationJobRequest& WithScheduleFrequency(ScheduleFrequencyT&& value) {
    SetScheduleFrequency(std::forward<ScheduleFrequencyT>(value));
    return *this;
  }
  ///@}
