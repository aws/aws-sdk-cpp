...
class ListClassificationScopesResult {
 public:
  ...
  void SetClassificationScopes(ClassificationScopesT&& value) {
    ...
    m_classificationScopes = std::forward<ClassificationScopesT>(value);
  }
  template <typename ClassificationScopesT = Aws::Vector<ClassificationScopeSummary>>
  ListClassificationScopesResult& WithClassificationScopes(ClassificationScopesT&& value) {
    SetClassificationScopes(std::forward<ClassificationScopesT>(value));
    return *this;
  }
  ...
  ListClassificationScopesResult& AddClassificationScopes(ClassificationScopesT&& value) {
    m_classificationScopesHasBeenSet = true;
    m_classificationScopes.emplace_back(std::forward<ClassificationScopesT>(value));
    return *this;
  }
  ///@}
