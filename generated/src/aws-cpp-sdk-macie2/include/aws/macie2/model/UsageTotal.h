...
class UsageTotal {
 public:
  ...
  inline UsageTotal& WithCurrency(Currency value) {
    SetCurrency(value);
    return *this;
  }
  ///@}
  ...
  void SetEstimatedCost(EstimatedCostT&& value) {
    ...
    m_estimatedCost = std::forward<EstimatedCostT>(value);
  }
  template <typename EstimatedCostT = Aws::String>
  UsageTotal& WithEstimatedCost(EstimatedCostT&& value) {
    SetEstimatedCost(std::forward<EstimatedCostT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetType(UsageType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline UsageTotal& WithType(UsageType value) {
    SetType(value);
    return *this;
  }
  ///@}
