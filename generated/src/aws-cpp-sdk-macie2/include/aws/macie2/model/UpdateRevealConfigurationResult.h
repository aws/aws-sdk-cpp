...
class UpdateRevealConfigurationResult {
 public:
  ...
  template <typename ConfigurationT = RevealConfiguration>
  UpdateRevealConfigurationResult& WithConfiguration(ConfigurationT&& value) {
  ...
  template <typename RetrievalConfigurationT = RetrievalConfiguration>
  UpdateRevealConfigurationResult& WithRetrievalConfiguration(RetrievalConfigurationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateRevealConfigurationResult& WithRequestId(RequestIdT&& value) {
