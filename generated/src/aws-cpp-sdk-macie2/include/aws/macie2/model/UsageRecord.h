...
class UsageRecord {
 public:
  ...
  void SetAutomatedDiscoveryFreeTrialStartDate(AutomatedDiscoveryFreeTrialStartDateT&& value) {
    ...
    m_automatedDiscoveryFreeTrialStartDate = std::forward<AutomatedDiscoveryFreeTrialStartDateT>(value);
  }
  template <typename AutomatedDiscoveryFreeTrialStartDateT = Aws::Utils::DateTime>
  UsageRecord& WithAutomatedDiscoveryFreeTrialStartDate(AutomatedDiscoveryFreeTrialStartDateT&& value) {
    SetAutomatedDiscoveryFreeTrialStartDate(std::forward<AutomatedDiscoveryFreeTrialStartDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFreeTrialStartDate(FreeTrialStartDateT&& value) {
    ...
    m_freeTrialStartDate = std::forward<FreeTrialStartDateT>(value);
  }
  template <typename FreeTrialStartDateT = Aws::Utils::DateTime>
  UsageRecord& WithFreeTrialStartDate(FreeTrialStartDateT&& value) {
    SetFreeTrialStartDate(std::forward<FreeTrialStartDateT>(value));
    return *this;
  }
  ///@}
  ...
  UsageRecord& AddUsage(UsageT&& value) {
    m_usageHasBeenSet = true;
    m_usage.emplace_back(std::forward<UsageT>(value));
    return *this;
  }
  ///@}
 private:
