...
class SimpleScopeTerm {
 public:
  ...
  inline void SetComparator(JobComparator value) {
    m_comparatorHasBeenSet = true;
    m_comparator = value;
  }
  inline SimpleScopeTerm& WithComparator(JobComparator value) {
    SetComparator(value);
    return *this;
  }
  ///@}
  ...
  inline void SetKey(ScopeFilterKey value) {
    m_keyHasBeenSet = true;
    m_key = value;
  }
  inline SimpleScopeTerm& WithKey(ScopeFilterKey value) {
    SetKey(value);
    return *this;
  }
  ///@}
