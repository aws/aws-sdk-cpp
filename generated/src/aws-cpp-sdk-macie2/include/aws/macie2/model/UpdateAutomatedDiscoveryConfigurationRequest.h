...
class UpdateAutomatedDiscoveryConfigurationRequest : public Macie2Request {
 public:
  ...
  inline UpdateAutomatedDiscoveryConfigurationRequest& WithAutoEnableOrganizationMembers(AutoEnableMode value) {
  ...
  inline UpdateAutomatedDiscoveryConfigurationRequest& WithStatus(AutomatedDiscoveryStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
