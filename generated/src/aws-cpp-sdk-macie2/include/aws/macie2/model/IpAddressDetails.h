...
class IpAddressDetails {
 public:
  ...
  void SetIpCity(IpCityT&& value) {
    ...
    m_ipCity = std::forward<IpCityT>(value);
  }
  template <typename IpCityT = IpCity>
  IpAddressDetails& WithIpCity(IpCityT&& value) {
    SetIpCity(std::forward<IpCityT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIpCountry(IpCountryT&& value) {
    ...
    m_ipCountry = std::forward<IpCountryT>(value);
  }
  template <typename IpCountryT = IpCountry>
  IpAddressDetails& WithIpCountry(IpCountryT&& value) {
    SetIpCountry(std::forward<IpCountryT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIpGeoLocation(IpGeoLocationT&& value) {
    ...
    m_ipGeoLocation = std::forward<IpGeoLocationT>(value);
  }
  template <typename IpGeoLocationT = IpGeoLocation>
  IpAddressDetails& WithIpGeoLocation(IpGeoLocationT&& value) {
    SetIpGeoLocation(std::forward<IpGeoLocationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIpOwner(IpOwnerT&& value) {
    ...
    m_ipOwner = std::forward<IpOwnerT>(value);
  }
  template <typename IpOwnerT = IpOwner>
  IpAddressDetails& WithIpOwner(IpOwnerT&& value) {
    SetIpOwner(std::forward<IpOwnerT>(value));
    return *this;
  }
  ///@}
 private:
