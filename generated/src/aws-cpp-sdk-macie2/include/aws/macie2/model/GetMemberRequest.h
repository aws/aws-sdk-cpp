...
namespace Model
{
  ...
  /**
   */
  class GetMemberRequest : public Macie2Request
  {
  public:
    AWS_MACIE2_API GetMemberRequest() = default;
    ...
    template<typename IdT = Aws::String>
    GetMemberRequest& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
  private:
