...
class CreateCustomDataIdentifierResult {
 public:
  ...
  void SetCustomDataIdentifierId(CustomDataIdentifierIdT&& value) {
    m_customDataIdentifierIdHasBeenSet = true;
    m_customDataIdentifierId = std::forward<CustomDataIdentifierIdT>(value);
  }
  template <typename CustomDataIdentifierIdT = Aws::String>
  CreateCustomDataIdentifierResult& WithCustomDataIdentifierId(CustomDataIdentifierIdT&& value) {
    SetCustomDataIdentifierId(std::forward<CustomDataIdentifierIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  CreateCustomDataIdentifierResult& WithRequestId(RequestIdT&& value) {
