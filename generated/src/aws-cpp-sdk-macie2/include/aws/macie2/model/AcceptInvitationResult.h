...
namespace Model
{
  ...
  {
  public:
    AWS_MACIE2_API AcceptInvitationResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    AcceptInvitationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
