...
class GetBucketStatisticsResult {
 public:
  ...
  inline void SetBucketCount(long long value) {
    m_bucketCountHasBeenSet = true;
    m_bucketCount = value;
  }
  inline GetBucketStatisticsResult& WithBucketCount(long long value) {
  ...
  void SetBucketCountByEffectivePermission(BucketCountByEffectivePermissionT&& value) {
    ...
    m_bucketCountByEffectivePermission = std::forward<BucketCountByEffectivePermissionT>(value);
  }
  template <typename BucketCountByEffectivePermissionT = BucketCountByEffectivePermission>
  GetBucketStatisticsResult& WithBucketCountByEffectivePermission(BucketCountByEffectivePermissionT&& value) {
    SetBucketCountByEffectivePermission(std::forward<BucketCountByEffectivePermissionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBucketCountByEncryptionType(BucketCountByEncryptionTypeT&& value) {
    ...
    m_bucketCountByEncryptionType = std::forward<BucketCountByEncryptionTypeT>(value);
  }
  template <typename BucketCountByEncryptionTypeT = BucketCountByEncryptionType>
  GetBucketStatisticsResult& WithBucketCountByEncryptionType(BucketCountByEncryptionTypeT&& value) {
    SetBucketCountByEncryptionType(std::forward<BucketCountByEncryptionTypeT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const BucketCountPolicyAllowsUnencryptedObjectUploads& GetBucketCountByObjectEncryptionRequirement() const {
    return m_bucketCountByObjectEncryptionRequirement;
  }
  ...
  void SetBucketCountByObjectEncryptionRequirement(BucketCountByObjectEncryptionRequirementT&& value) {
    ...
    m_bucketCountByObjectEncryptionRequirement = std::forward<BucketCountByObjectEncryptionRequirementT>(value);
  }
  template <typename BucketCountByObjectEncryptionRequirementT = BucketCountPolicyAllowsUnencryptedObjectUploads>
  GetBucketStatisticsResult& WithBucketCountByObjectEncryptionRequirement(BucketCountByObjectEncryptionRequirementT&& value) {
    SetBucketCountByObjectEncryptionRequirement(std::forward<BucketCountByObjectEncryptionRequirementT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBucketCountBySharedAccessType(BucketCountBySharedAccessTypeT&& value) {
    ...
    m_bucketCountBySharedAccessType = std::forward<BucketCountBySharedAccessTypeT>(value);
  }
  template <typename BucketCountBySharedAccessTypeT = BucketCountBySharedAccessType>
  GetBucketStatisticsResult& WithBucketCountBySharedAccessType(BucketCountBySharedAccessTypeT&& value) {
    SetBucketCountBySharedAccessType(std::forward<BucketCountBySharedAccessTypeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBucketStatisticsBySensitivity(BucketStatisticsBySensitivityT&& value) {
    ...
    m_bucketStatisticsBySensitivity = std::forward<BucketStatisticsBySensitivityT>(value);
  }
  template <typename BucketStatisticsBySensitivityT = BucketStatisticsBySensitivity>
  GetBucketStatisticsResult& WithBucketStatisticsBySensitivity(BucketStatisticsBySensitivityT&& value) {
    SetBucketStatisticsBySensitivity(std::forward<BucketStatisticsBySensitivityT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetClassifiableObjectCount(long long value) {
    m_classifiableObjectCountHasBeenSet = true;
    m_classifiableObjectCount = value;
  }
  inline GetBucketStatisticsResult& WithClassifiableObjectCount(long long value) {
    SetClassifiableObjectCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetClassifiableSizeInBytes(long long value) {
    m_classifiableSizeInBytesHasBeenSet = true;
    m_classifiableSizeInBytes = value;
  }
  inline GetBucketStatisticsResult& WithClassifiableSizeInBytes(long long value) {
    SetClassifiableSizeInBytes(value);
    return *this;
  }
  ///@}
  ...
  inline void SetObjectCount(long long value) {
    m_objectCountHasBeenSet = true;
    m_objectCount = value;
  }
  inline GetBucketStatisticsResult& WithObjectCount(long long value) {
  ...
  inline GetBucketStatisticsResult& WithSizeInBytes(long long value) {
  ...
  inline void SetSizeInBytesCompressed(long long value) {
    m_sizeInBytesCompressedHasBeenSet = true;
    m_sizeInBytesCompressed = value;
  }
  inline GetBucketStatisticsResult& WithSizeInBytesCompressed(long long value) {
    SetSizeInBytesCompressed(value);
    return *this;
  }
  ///@}
  ...
  void SetUnclassifiableObjectCount(UnclassifiableObjectCountT&& value) {
    ...
    m_unclassifiableObjectCount = std::forward<UnclassifiableObjectCountT>(value);
  }
  template <typename UnclassifiableObjectCountT = ObjectLevelStatistics>
  GetBucketStatisticsResult& WithUnclassifiableObjectCount(UnclassifiableObjectCountT&& value) {
    SetUnclassifiableObjectCount(std::forward<UnclassifiableObjectCountT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUnclassifiableObjectSizeInBytes(UnclassifiableObjectSizeInBytesT&& value) {
    ...
    m_unclassifiableObjectSizeInBytes = std::forward<UnclassifiableObjectSizeInBytesT>(value);
  }
  template <typename UnclassifiableObjectSizeInBytesT = ObjectLevelStatistics>
  GetBucketStatisticsResult& WithUnclassifiableObjectSizeInBytes(UnclassifiableObjectSizeInBytesT&& value) {
    SetUnclassifiableObjectSizeInBytes(std::forward<UnclassifiableObjectSizeInBytesT>(value));
    return *this;
  }
  ///@}
