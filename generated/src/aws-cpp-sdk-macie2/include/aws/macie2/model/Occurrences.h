...
class Occurrences {
 public:
  ...
  void SetLineRanges(LineRangesT&& value) {
    ...
    m_lineRanges = std::forward<LineRangesT>(value);
  }
  template <typename LineRangesT = Aws::Vector<Range>>
  Occurrences& WithLineRanges(LineRangesT&& value) {
    SetLineRanges(std::forward<LineRangesT>(value));
    return *this;
  }
  template <typename LineRangesT = Range>
  Occurrences& AddLineRanges(LineRangesT&& value) {
    m_lineRangesHasBeenSet = true;
    m_lineRanges.emplace_back(std::forward<LineRangesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOffsetRanges(OffsetRangesT&& value) {
    ...
    m_offsetRanges = std::forward<OffsetRangesT>(value);
  }
  template <typename OffsetRangesT = Aws::Vector<Range>>
  Occurrences& WithOffsetRanges(OffsetRangesT&& value) {
    SetOffsetRanges(std::forward<OffsetRangesT>(value));
    return *this;
  }
  template <typename OffsetRangesT = Range>
  Occurrences& AddOffsetRanges(OffsetRangesT&& value) {
    m_offsetRangesHasBeenSet = true;
    m_offsetRanges.emplace_back(std::forward<OffsetRangesT>(value));
    return *this;
  }
  ///@}
