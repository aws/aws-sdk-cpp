...
class SearchResourcesResult {
 public:
  ...
  void SetMatchingResources(MatchingResourcesT&& value) {
    m_matchingResourcesHasBeenSet = true;
    m_matchingResources = std::forward<MatchingResourcesT>(value);
  }
  template <typename MatchingResourcesT = Aws::Vector<MatchingResource>>
  SearchResourcesResult& WithMatchingResources(MatchingResourcesT&& value) {
    SetMatchingResources(std::forward<MatchingResourcesT>(value));
    return *this;
  }
  template <typename MatchingResourcesT = MatchingResource>
  SearchResourcesResult& AddMatchingResources(MatchingResourcesT&& value) {
    m_matchingResourcesHasBeenSet = true;
    m_matchingResources.emplace_back(std::forward<MatchingResourcesT>(value));
    return *this;
  }
  ///@}
