...
class JobScheduleFrequency {
 public:
  ...
  void SetDailySchedule(DailyScheduleT&& value) {
    ...
    m_dailySchedule = std::forward<DailyScheduleT>(value);
  }
  template <typename DailyScheduleT = DailySchedule>
  JobScheduleFrequency& WithDailySchedule(DailyScheduleT&& value) {
    SetDailySchedule(std::forward<DailyScheduleT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMonthlySchedule(MonthlyScheduleT&& value) {
    ...
    m_monthlySchedule = std::forward<MonthlyScheduleT>(value);
  }
  template <typename MonthlyScheduleT = MonthlySchedule>
  JobScheduleFrequency& WithMonthlySchedule(MonthlyScheduleT&& value) {
    SetMonthlySchedule(std::forward<MonthlyScheduleT>(value));
    return *this;
  }
  ///@}
  ...
  void SetWeeklySchedule(WeeklyScheduleT&& value) {
    ...
    m_weeklySchedule = std::forward<WeeklyScheduleT>(value);
  }
  template <typename WeeklyScheduleT = WeeklySchedule>
  JobScheduleFrequency& WithWeeklySchedule(WeeklyScheduleT&& value) {
    SetWeeklySchedule(std::forward<WeeklyScheduleT>(value));
    return *this;
  }
  ///@}
 private:
