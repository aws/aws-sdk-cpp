...
class GetFindingsPublicationConfigurationResult {
 public:
  ...
  AWS_MACIE2_API GetFindingsPublicationConfigurationResult& operator=(
  ...
  template <typename SecurityHubConfigurationT = SecurityHubConfiguration>
  GetFindingsPublicationConfigurationResult& WithSecurityHubConfiguration(SecurityHubConfigurationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetFindingsPublicationConfigurationResult& WithRequestId(RequestIdT&& value) {
