...
class SecurityHubConfiguration {
 public:
  ...
  inline void SetPublishClassificationFindings(bool value) {
    m_publishClassificationFindingsHasBeenSet = true;
    m_publishClassificationFindings = value;
  }
  inline SecurityHubConfiguration& WithPublishClassificationFindings(bool value) {
    SetPublishClassificationFindings(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPublishPolicyFindings(bool value) {
    m_publishPolicyFindingsHasBeenSet = true;
    m_publishPolicyFindings = value;
  }
  inline SecurityHubConfiguration& WithPublishPolicyFindings(bool value) {
    SetPublishPolicyFindings(value);
    return *this;
  }
  ///@}
 private:
