...
class UserPausedDetails {
 public:
  ...
  void SetJobExpiresAt(JobExpiresAtT&& value) {
    m_jobExpiresAtHasBeenSet = true;
    m_jobExpiresAt = std::forward<JobExpiresAtT>(value);
  }
  template <typename JobExpiresAtT = Aws::Utils::DateTime>
  UserPausedDetails& WithJobExpiresAt(JobExpiresAtT&& value) {
    SetJobExpiresAt(std::forward<JobExpiresAtT>(value));
    return *this;
  }
  ///@}
  ...
  void SetJobImminentExpirationHealthEventArn(JobImminentExpirationHealthEventArnT&& value) {
    m_jobImminentExpirationHealthEventArnHasBeenSet = true;
    m_jobImminentExpirationHealthEventArn = std::forward<JobImminentExpirationHealthEventArnT>(value);
  }
  template <typename JobImminentExpirationHealthEventArnT = Aws::String>
  UserPausedDetails& WithJobImminentExpirationHealthEventArn(JobImminentExpirationHealthEventArnT&& value) {
    SetJobImminentExpirationHealthEventArn(std::forward<JobImminentExpirationHealthEventArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetJobPausedAt(JobPausedAtT&& value) {
    m_jobPausedAtHasBeenSet = true;
    m_jobPausedAt = std::forward<JobPausedAtT>(value);
  }
  template <typename JobPausedAtT = Aws::Utils::DateTime>
  UserPausedDetails& WithJobPausedAt(JobPausedAtT&& value) {
    SetJobPausedAt(std::forward<JobPausedAtT>(value));
    return *this;
  }
  ///@}
 private:
