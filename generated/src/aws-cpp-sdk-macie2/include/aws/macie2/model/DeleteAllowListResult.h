...
namespace Model
{
  ...
  {
  public:
    AWS_MACIE2_API DeleteAllowListResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteAllowListResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
