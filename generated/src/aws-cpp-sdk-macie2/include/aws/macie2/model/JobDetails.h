...
class JobDetails {
 public:
  ...
  inline void SetIsDefinedInJob(IsDefinedInJob value) {
    m_isDefinedInJobHasBeenSet = true;
    m_isDefinedInJob = value;
  }
  inline JobDetails& WithIsDefinedInJob(IsDefinedInJob value) {
    SetIsDefinedInJob(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIsMonitoredByJob(IsMonitoredByJob value) {
    m_isMonitoredByJobHasBeenSet = true;
    m_isMonitoredByJob = value;
  }
  inline JobDetails& WithIsMonitoredByJob(IsMonitoredByJob value) {
    SetIsMonitoredByJob(value);
    return *this;
  }
  ///@}
  ...
  void SetLastJobId(LastJobIdT&& value) {
    ...
    m_lastJobId = std::forward<LastJobIdT>(value);
  }
  template <typename LastJobIdT = Aws::String>
  JobDetails& WithLastJobId(LastJobIdT&& value) {
    SetLastJobId(std::forward<LastJobIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastJobRunTime(LastJobRunTimeT&& value) {
    ...
    m_lastJobRunTime = std::forward<LastJobRunTimeT>(value);
  }
  template <typename LastJobRunTimeT = Aws::Utils::DateTime>
  JobDetails& WithLastJobRunTime(LastJobRunTimeT&& value) {
    SetLastJobRunTime(std::forward<LastJobRunTimeT>(value));
    return *this;
  }
  ///@}
 private:
