...
class GetMemberResult {
 public:
  ...
  void SetAdministratorAccountId(AdministratorAccountIdT&& value) {
    ...
    m_administratorAccountId = std::forward<AdministratorAccountIdT>(value);
  }
  template <typename AdministratorAccountIdT = Aws::String>
  GetMemberResult& WithAdministratorAccountId(AdministratorAccountIdT&& value) {
    SetAdministratorAccountId(std::forward<AdministratorAccountIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetMemberResult& WithRelationshipStatus(RelationshipStatus value) {
