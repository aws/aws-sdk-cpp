...
class GetSensitiveDataOccurrencesAvailabilityResult {
 public:
  ...
  AWS_MACIE2_API GetSensitiveDataOccurrencesAvailabilityResult& operator=(
  ...
  inline void SetCode(AvailabilityCode value) {
    m_codeHasBeenSet = true;
    m_code = value;
  }
  inline GetSensitiveDataOccurrencesAvailabilityResult& WithCode(AvailabilityCode value) {
    SetCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename ReasonsT = Aws::Vector<UnavailabilityReasonCode>>
  GetSensitiveDataOccurrencesAvailabilityResult& WithReasons(ReasonsT&& value) {
    SetReasons(std::forward<ReasonsT>(value));
    return *this;
  }
  inline GetSensitiveDataOccurrencesAvailabilityResult& AddReasons(UnavailabilityReasonCode value) {
    m_reasonsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetSensitiveDataOccurrencesAvailabilityResult& WithRequestId(RequestIdT&& value) {
