...
class PutClassificationExportConfigurationResult {
 public:
  ...
  AWS_MACIE2_API PutClassificationExportConfigurationResult& operator=(
  ...
  template <typename ConfigurationT = ClassificationExportConfiguration>
  PutClassificationExportConfigurationResult& WithConfiguration(ConfigurationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  PutClassificationExportConfigurationResult& WithRequestId(RequestIdT&& value) {
