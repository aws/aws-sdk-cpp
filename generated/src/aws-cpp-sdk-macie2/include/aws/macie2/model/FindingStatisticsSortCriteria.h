...
class FindingStatisticsSortCriteria {
 public:
  ...
  inline void SetAttributeName(FindingStatisticsSortAttributeName value) {
    m_attributeNameHasBeenSet = true;
    m_attributeName = value;
  }
  inline FindingStatisticsSortCriteria& WithAttributeName(FindingStatisticsSortAttributeName value) {
  ...
  inline FindingStatisticsSortCriteria& WithOrderBy(OrderBy value) {
    SetOrderBy(value);
    return *this;
  }
  ///@}
