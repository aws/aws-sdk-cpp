...
class TestCustomDataIdentifierRequest : public Macie2Request {
 public:
  ...
  inline void SetMaximumMatchDistance(int value) {
    m_maximumMatchDistanceHasBeenSet = true;
    m_maximumMatchDistance = value;
  }
  inline TestCustomDataIdentifierRequest& WithMaximumMatchDistance(int value) {
    SetMaximumMatchDistance(value);
    return *this;
  }
  ///@}
  ...
  void SetSampleText(SampleTextT&& value) {
    m_sampleTextHasBeenSet = true;
    m_sampleText = std::forward<SampleTextT>(value);
  }
  template <typename SampleTextT = Aws::String>
  TestCustomDataIdentifierRequest& WithSampleText(SampleTextT&& value) {
    SetSampleText(std::forward<SampleTextT>(value));
    return *this;
  }
  ///@}
 private:
