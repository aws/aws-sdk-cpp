...
class UpdateResourceProfileRequest : public Macie2Request {
 public:
  ...
  template <typename ResourceArnT = Aws::String>
  UpdateResourceProfileRequest& WithResourceArn(ResourceArnT&& value) {
  ...
  inline void SetSensitivityScoreOverride(int value) {
    m_sensitivityScoreOverrideHasBeenSet = true;
    m_sensitivityScoreOverride = value;
  }
  inline UpdateResourceProfileRequest& WithSensitivityScoreOverride(int value) {
    SetSensitivityScoreOverride(value);
    return *this;
  }
  ///@}
 private:
