...
class ServiceLimit {
 public:
  ...
  inline void SetIsServiceLimited(bool value) {
    m_isServiceLimitedHasBeenSet = true;
    m_isServiceLimited = value;
  }
  inline ServiceLimit& WithIsServiceLimited(bool value) {
    SetIsServiceLimited(value);
    return *this;
  }
  ///@}
  ...
  inline ServiceLimit& WithUnit(Unit value) {
    SetUnit(value);
    return *this;
  }
  ///@}
  ...
  inline ServiceLimit& WithValue(long long value) {
    SetValue(value);
    return *this;
  }
  ///@}
