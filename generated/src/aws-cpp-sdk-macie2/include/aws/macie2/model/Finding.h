...
class Finding {
 public:
  ...
  inline Finding& WithArchived(bool value) {
    SetArchived(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCategory(FindingCategory value) {
    m_categoryHasBeenSet = true;
    m_category = value;
  }
  inline Finding& WithCategory(FindingCategory value) {
    SetCategory(value);
    return *this;
  }
  ///@}
  ...
  void SetClassificationDetails(ClassificationDetailsT&& value) {
    ...
    m_classificationDetails = std::forward<ClassificationDetailsT>(value);
  }
  template <typename ClassificationDetailsT = ClassificationDetails>
  Finding& WithClassificationDetails(ClassificationDetailsT&& value) {
    SetClassificationDetails(std::forward<ClassificationDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  inline Finding& WithCount(long long value) {
    SetCount(value);
    return *this;
  }
  ///@}
  ...
  void SetResourcesAffected(ResourcesAffectedT&& value) {
    ...
    m_resourcesAffected = std::forward<ResourcesAffectedT>(value);
  }
  template <typename ResourcesAffectedT = ResourcesAffected>
  Finding& WithResourcesAffected(ResourcesAffectedT&& value) {
    SetResourcesAffected(std::forward<ResourcesAffectedT>(value));
    return *this;
  }
  ///@}
  ...
  inline Finding& WithSample(bool value) {
    SetSample(value);
    return *this;
  }
  ///@}
