...
class ListJobsFilterTerm {
 public:
  ...
  inline ListJobsFilterTerm& WithComparator(JobComparator value) {
    SetComparator(value);
    return *this;
  }
  ///@}
  ...
  inline void SetKey(ListJobsFilterKey value) {
    m_keyHasBeenSet = true;
    m_key = value;
  }
  inline ListJobsFilterTerm& WithKey(ListJobsFilterKey value) {
    SetKey(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  ListJobsFilterTerm& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  ListJobsFilterTerm& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
