...
class DeclineInvitationsResult {
 public:
  ...
  template <typename UnprocessedAccountsT = Aws::Vector<UnprocessedAccount>>
  DeclineInvitationsResult& WithUnprocessedAccounts(UnprocessedAccountsT&& value) {
    SetUnprocessedAccounts(std::forward<UnprocessedAccountsT>(value));
    return *this;
  }
  template <typename UnprocessedAccountsT = UnprocessedAccount>
  DeclineInvitationsResult& AddUnprocessedAccounts(UnprocessedAccountsT&& value) {
    m_unprocessedAccountsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DeclineInvitationsResult& WithRequestId(RequestIdT&& value) {
