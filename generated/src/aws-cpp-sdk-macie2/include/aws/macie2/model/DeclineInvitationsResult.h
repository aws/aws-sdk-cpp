...
namespace Model
{
  ...
  {
  public:
    AWS_MACIE2_API DeclineInvitationsResult() = default;
    ...
    template<typename UnprocessedAccountsT = Aws::Vector<UnprocessedAccount>>
    DeclineInvitationsResult& WithUnprocessedAccounts(UnprocessedAccountsT&& value) { SetUnprocessedAccounts(std::forward<UnprocessedAccountsT>(value)); return *this;}
    template<typename UnprocessedAccountsT = UnprocessedAccount>
    DeclineInvitationsResult& AddUnprocessedAccounts(UnprocessedAccountsT&& value) { m_unprocessedAccountsHasBeenSet = true; m_unprocessedAccounts.emplace_back(std::forward<UnprocessedAccountsT>(value)); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DeclineInvitationsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
