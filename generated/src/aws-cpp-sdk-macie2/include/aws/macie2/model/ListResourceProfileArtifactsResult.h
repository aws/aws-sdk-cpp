...
class ListResourceProfileArtifactsResult {
 public:
  ...
  template <typename ArtifactsT = Aws::Vector<ResourceProfileArtifact>>
  ListResourceProfileArtifactsResult& WithArtifacts(ArtifactsT&& value) {
    SetArtifacts(std::forward<ArtifactsT>(value));
    return *this;
  }
  template <typename ArtifactsT = ResourceProfileArtifact>
  ListResourceProfileArtifactsResult& AddArtifacts(ArtifactsT&& value) {
    m_artifactsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListResourceProfileArtifactsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListResourceProfileArtifactsResult& WithRequestId(RequestIdT&& value) {
