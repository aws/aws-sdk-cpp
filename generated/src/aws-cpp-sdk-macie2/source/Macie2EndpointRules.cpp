...
namespace Macie2
{
const size_t Macie2EndpointRules::RulesBlobStrLen = 3392;
const size_t Macie2EndpointRules::RulesBlobSize = 3393;
...
't','t','p','s',':','/','/','m','a','c','i','e','2','-','f','i','p','s','.','{','R','e','g','i','o',
...
'r','l','"',':','"','h','t','t','p','s',':','/','/','m','a','c','i','e','2','-','f','i','p','s','.',
...
'"','h','t','t','p','s',':','/','/','m','a','c','i','e','2','.','{','R','e','g','i','o','n','}','.',
...
const char* Macie2EndpointRules::GetRulesBlob()
{
