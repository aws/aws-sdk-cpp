...
FindingStatisticsSortCriteria::FindingStatisticsSortCriteria(JsonView jsonValue) { *this = jsonValue; }

FindingStatisticsSortCriteria& FindingStatisticsSortCriteria::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("attributeName")) {
    m_attributeName =
        FindingStatisticsSortAttributeNameMapper::GetFindingStatisticsSortAttributeNameForName(jsonValue.GetString("attributeName"));
...
JsonValue FindingStatisticsSortCriteria::Jsonize() const {
  ...
  if (m_attributeNameHasBeenSet) {
    payload.WithString("attributeName",
                       FindingStatisticsSortAttributeNameMapper::GetNameForFindingStatisticsSortAttributeName(m_attributeName));
  }
