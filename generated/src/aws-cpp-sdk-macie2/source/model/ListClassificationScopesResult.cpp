...
ListClassificationScopesResult::ListClassificationScopesResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListClassificationScopesResult& ListClassificationScopesResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("classificationScopes")) {
    ...
    for (unsigned classificationScopesIndex = 0; classificationScopesIndex < classificationScopesJsonList.GetLength();
         ++classificationScopesIndex) {
