...
ListSensitivityInspectionTemplatesResult& ListSensitivityInspectionTemplatesResult::operator=(
  ...
  if (jsonValue.ValueExists("sensitivityInspectionTemplates")) {
    ...
    for (unsigned sensitivityInspectionTemplatesIndex = 0;
         sensitivityInspectionTemplatesIndex < sensitivityInspectionTemplatesJsonList.GetLength(); ++sensitivityInspectionTemplatesIndex) {
