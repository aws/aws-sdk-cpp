...
Aws::String CreateClassificationJobRequest::SerializePayload() const {
  ...
  if (m_customDataIdentifierIdsHasBeenSet) {
    ...
    for (unsigned customDataIdentifierIdsIndex = 0; customDataIdentifierIdsIndex < customDataIdentifierIdsJsonList.GetLength();
         ++customDataIdentifierIdsIndex) {
  ...
  if (m_managedDataIdentifierSelectorHasBeenSet) {
    payload.WithString("managedDataIdentifierSelector",
                       ManagedDataIdentifierSelectorMapper::GetNameForManagedDataIdentifierSelector(m_managedDataIdentifierSelector));
  }
