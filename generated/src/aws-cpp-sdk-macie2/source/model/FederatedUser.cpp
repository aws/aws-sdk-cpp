...
FederatedUser::FederatedUser(JsonView jsonValue) { *this = jsonValue; }

FederatedUser& FederatedUser::operator=(JsonView jsonValue) {
...
JsonValue FederatedUser::Jsonize() const {
  JsonValue payload;
