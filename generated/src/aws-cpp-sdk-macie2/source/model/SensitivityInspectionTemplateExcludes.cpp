...
SensitivityInspectionTemplateExcludes::SensitivityInspectionTemplateExcludes(JsonView jsonValue) { *this = jsonValue; }
...
SensitivityInspectionTemplateExcludes& SensitivityInspectionTemplateExcludes::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("managedDataIdentifierIds")) {
    ...
    for (unsigned managedDataIdentifierIdsIndex = 0; managedDataIdentifierIdsIndex < managedDataIdentifierIdsJsonList.GetLength();
         ++managedDataIdentifierIdsIndex) {
