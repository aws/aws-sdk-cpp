...
class ListTargetGroupsRequest : public VPCLatticeRequest {
 public:
  ...
  inline ListTargetGroupsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTargetGroupType(TargetGroupType value) {
    m_targetGroupTypeHasBeenSet = true;
    m_targetGroupType = value;
  }
  inline ListTargetGroupsRequest& WithTargetGroupType(TargetGroupType value) {
    SetTargetGroupType(value);
    return *this;
  }
  ///@}
 private:
