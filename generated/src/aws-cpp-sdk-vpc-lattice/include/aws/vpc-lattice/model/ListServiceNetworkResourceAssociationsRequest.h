...
class ListServiceNetworkResourceAssociationsRequest : public VPCLatticeRequest {
 public:
  ...
  template <typename ServiceNetworkIdentifierT = Aws::String>
  ListServiceNetworkResourceAssociationsRequest& WithServiceNetworkIdentifier(ServiceNetworkIdentifierT&& value) {
  ...
  template <typename ResourceConfigurationIdentifierT = Aws::String>
  ListServiceNetworkResourceAssociationsRequest& WithResourceConfigurationIdentifier(ResourceConfigurationIdentifierT&& value) {
  ...
  inline ListServiceNetworkResourceAssociationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListServiceNetworkResourceAssociationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListServiceNetworkResourceAssociationsRequest& WithIncludeChildren(bool value) {
