...
class ListServiceNetworkVpcAssociationsRequest : public VPCLatticeRequest {
 public:
  ...
  template <typename ServiceNetworkIdentifierT = Aws::String>
  ListServiceNetworkVpcAssociationsRequest& WithServiceNetworkIdentifier(ServiceNetworkIdentifierT&& value) {
  ...
  template <typename VpcIdentifierT = Aws::String>
  ListServiceNetworkVpcAssociationsRequest& WithVpcIdentifier(VpcIdentifierT&& value) {
  ...
  inline ListServiceNetworkVpcAssociationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListServiceNetworkVpcAssociationsRequest& WithNextToken(NextTokenT&& value) {
