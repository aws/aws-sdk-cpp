...
class GetServiceNetworkResourceAssociationResult {
 public:
  ...
  AWS_VPCLATTICE_API GetServiceNetworkResourceAssociationResult& operator=(
  ...
  template <typename IdT = Aws::String>
  GetServiceNetworkResourceAssociationResult& WithId(IdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  GetServiceNetworkResourceAssociationResult& WithArn(ArnT&& value) {
  ...
  inline GetServiceNetworkResourceAssociationResult& WithStatus(ServiceNetworkResourceAssociationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreatedByT = Aws::String>
  GetServiceNetworkResourceAssociationResult& WithCreatedBy(CreatedByT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  GetServiceNetworkResourceAssociationResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename ResourceConfigurationIdT = Aws::String>
  GetServiceNetworkResourceAssociationResult& WithResourceConfigurationId(ResourceConfigurationIdT&& value) {
  ...
  template <typename ResourceConfigurationArnT = Aws::String>
  GetServiceNetworkResourceAssociationResult& WithResourceConfigurationArn(ResourceConfigurationArnT&& value) {
  ...
  template <typename ResourceConfigurationNameT = Aws::String>
  GetServiceNetworkResourceAssociationResult& WithResourceConfigurationName(ResourceConfigurationNameT&& value) {
  ...
  template <typename ServiceNetworkIdT = Aws::String>
  GetServiceNetworkResourceAssociationResult& WithServiceNetworkId(ServiceNetworkIdT&& value) {
  ...
  template <typename ServiceNetworkArnT = Aws::String>
  GetServiceNetworkResourceAssociationResult& WithServiceNetworkArn(ServiceNetworkArnT&& value) {
  ...
  template <typename ServiceNetworkNameT = Aws::String>
  GetServiceNetworkResourceAssociationResult& WithServiceNetworkName(ServiceNetworkNameT&& value) {
  ...
  template <typename FailureReasonT = Aws::String>
  GetServiceNetworkResourceAssociationResult& WithFailureReason(FailureReasonT&& value) {
  ...
  template <typename FailureCodeT = Aws::String>
  GetServiceNetworkResourceAssociationResult& WithFailureCode(FailureCodeT&& value) {
  ...
  template <typename LastUpdatedAtT = Aws::Utils::DateTime>
  GetServiceNetworkResourceAssociationResult& WithLastUpdatedAt(LastUpdatedAtT&& value) {
  ...
  template <typename PrivateDnsEntryT = DnsEntry>
  GetServiceNetworkResourceAssociationResult& WithPrivateDnsEntry(PrivateDnsEntryT&& value) {
  ...
  template <typename DnsEntryT = DnsEntry>
  GetServiceNetworkResourceAssociationResult& WithDnsEntry(DnsEntryT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetServiceNetworkResourceAssociationResult& WithRequestId(RequestIdT&& value) {
