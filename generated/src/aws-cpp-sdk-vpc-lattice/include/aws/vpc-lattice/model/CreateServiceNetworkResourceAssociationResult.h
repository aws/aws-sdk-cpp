...
class CreateServiceNetworkResourceAssociationResult {
 public:
  ...
  AWS_VPCLATTICE_API CreateServiceNetworkResourceAssociationResult& operator=(
  ...
  template <typename IdT = Aws::String>
  CreateServiceNetworkResourceAssociationResult& WithId(IdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  CreateServiceNetworkResourceAssociationResult& WithArn(ArnT&& value) {
  ...
  inline CreateServiceNetworkResourceAssociationResult& WithStatus(ServiceNetworkResourceAssociationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreatedByT = Aws::String>
  CreateServiceNetworkResourceAssociationResult& WithCreatedBy(CreatedByT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateServiceNetworkResourceAssociationResult& WithRequestId(RequestIdT&& value) {
