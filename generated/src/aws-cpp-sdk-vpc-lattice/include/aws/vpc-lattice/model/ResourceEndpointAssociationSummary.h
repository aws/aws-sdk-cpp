...
class ResourceEndpointAssociationSummary {
 public:
  ...
  void SetResourceConfigurationName(ResourceConfigurationNameT&& value) {
    ...
    m_resourceConfigurationName = std::forward<ResourceConfigurationNameT>(value);
  }
  template <typename ResourceConfigurationNameT = Aws::String>
  ResourceEndpointAssociationSummary& WithResourceConfigurationName(ResourceConfigurationNameT&& value) {
    SetResourceConfigurationName(std::forward<ResourceConfigurationNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVpcEndpointOwner(VpcEndpointOwnerT&& value) {
    ...
    m_vpcEndpointOwner = std::forward<VpcEndpointOwnerT>(value);
  }
  template <typename VpcEndpointOwnerT = Aws::String>
  ResourceEndpointAssociationSummary& WithVpcEndpointOwner(VpcEndpointOwnerT&& value) {
    SetVpcEndpointOwner(std::forward<VpcEndpointOwnerT>(value));
    return *this;
  }
  ///@}
