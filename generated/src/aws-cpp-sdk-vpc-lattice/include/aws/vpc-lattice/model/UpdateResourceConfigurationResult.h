...
class UpdateResourceConfigurationResult {
 public:
  ...
  inline UpdateResourceConfigurationResult& WithType(ResourceConfigurationType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateResourceConfigurationResult& WithAllowAssociationToShareableServiceNetwork(bool value) {
  ...
  inline UpdateResourceConfigurationResult& WithProtocol(ProtocolType value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateResourceConfigurationResult& WithStatus(ResourceConfigurationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
