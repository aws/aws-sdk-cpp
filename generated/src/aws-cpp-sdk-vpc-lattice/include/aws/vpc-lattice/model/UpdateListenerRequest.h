...
class UpdateListenerRequest : public VPCLatticeRequest {
 public:
  ...
  template <typename ServiceIdentifierT = Aws::String>
  UpdateListenerRequest& WithServiceIdentifier(ServiceIdentifierT&& value) {
  ...
  template <typename ListenerIdentifierT = Aws::String>
  UpdateListenerRequest& WithListenerIdentifier(ListenerIdentifierT&& value) {
  ...
  template <typename DefaultActionT = RuleAction>
  UpdateListenerRequest& WithDefaultAction(DefaultActionT&& value) {
