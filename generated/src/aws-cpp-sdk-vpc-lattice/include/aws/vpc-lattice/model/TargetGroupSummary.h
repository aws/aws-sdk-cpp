...
class TargetGroupSummary {
 public:
  ...
  inline TargetGroupSummary& WithType(TargetGroupType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline TargetGroupSummary& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  inline TargetGroupSummary& WithProtocol(TargetGroupProtocol value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
  ...
  inline TargetGroupSummary& WithIpAddressType(IpAddressType value) {
  ...
  inline TargetGroupSummary& WithStatus(TargetGroupStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline TargetGroupSummary& WithLambdaEventStructureVersion(LambdaEventStructureVersion value) {
