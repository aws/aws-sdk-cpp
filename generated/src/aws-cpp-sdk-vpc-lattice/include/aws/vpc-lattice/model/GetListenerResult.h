...
class GetListenerResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  GetListenerResult& WithArn(ArnT&& value) {
  ...
  template <typename IdT = Aws::String>
  GetListenerResult& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  GetListenerResult& WithName(NameT&& value) {
  ...
  inline GetListenerResult& WithProtocol(ListenerProtocol value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
  ...
  inline GetListenerResult& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  template <typename ServiceArnT = Aws::String>
  GetListenerResult& WithServiceArn(ServiceArnT&& value) {
  ...
  template <typename ServiceIdT = Aws::String>
  GetListenerResult& WithServiceId(ServiceIdT&& value) {
  ...
  template <typename DefaultActionT = RuleAction>
  GetListenerResult& WithDefaultAction(DefaultActionT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  GetListenerResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename LastUpdatedAtT = Aws::Utils::DateTime>
  GetListenerResult& WithLastUpdatedAt(LastUpdatedAtT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetListenerResult& WithRequestId(RequestIdT&& value) {
