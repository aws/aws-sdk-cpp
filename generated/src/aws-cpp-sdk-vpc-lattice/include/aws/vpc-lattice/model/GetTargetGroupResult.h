...
class GetTargetGroupResult {
 public:
  ...
  template <typename IdT = Aws::String>
  GetTargetGroupResult& WithId(IdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  GetTargetGroupResult& WithArn(ArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  GetTargetGroupResult& WithName(NameT&& value) {
  ...
  inline GetTargetGroupResult& WithType(TargetGroupType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename ConfigT = TargetGroupConfig>
  GetTargetGroupResult& WithConfig(ConfigT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  GetTargetGroupResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename LastUpdatedAtT = Aws::Utils::DateTime>
  GetTargetGroupResult& WithLastUpdatedAt(LastUpdatedAtT&& value) {
  ...
  inline GetTargetGroupResult& WithStatus(TargetGroupStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ServiceArnsT = Aws::Vector<Aws::String>>
  GetTargetGroupResult& WithServiceArns(ServiceArnsT&& value) {
    SetServiceArns(std::forward<ServiceArnsT>(value));
    return *this;
  }
  template <typename ServiceArnsT = Aws::String>
  GetTargetGroupResult& AddServiceArns(ServiceArnsT&& value) {
    m_serviceArnsHasBeenSet = true;
  ...
  template <typename FailureMessageT = Aws::String>
  GetTargetGroupResult& WithFailureMessage(FailureMessageT&& value) {
  ...
  template <typename FailureCodeT = Aws::String>
  GetTargetGroupResult& WithFailureCode(FailureCodeT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetTargetGroupResult& WithRequestId(RequestIdT&& value) {
