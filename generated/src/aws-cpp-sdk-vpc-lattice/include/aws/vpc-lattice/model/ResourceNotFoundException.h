...
namespace Model
{
   ...
   * Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/vpc-lattice-2022-11-30/ResourceNotFoundException">AWS
   * API Reference</a></p>
   */
  class ResourceNotFoundException
  {
  public:
    AWS_VPCLATTICE_API ResourceNotFoundException() = default;
    AWS_VPCLATTICE_API ResourceNotFoundException(Aws::Utils::Json::JsonView jsonValue);
    AWS_VPCLATTICE_API ResourceNotFoundException& operator=(Aws::Utils::Json::JsonView jsonValue);
