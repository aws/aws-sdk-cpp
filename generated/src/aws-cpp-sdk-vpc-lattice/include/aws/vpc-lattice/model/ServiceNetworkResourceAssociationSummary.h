...
class ServiceNetworkResourceAssociationSummary {
 public:
  ...
  inline ServiceNetworkResourceAssociationSummary& WithStatus(ServiceNetworkResourceAssociationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIsManagedAssociation(bool value) {
    ...
    m_isManagedAssociation = value;
  }
  inline ServiceNetworkResourceAssociationSummary& WithIsManagedAssociation(bool value) {
