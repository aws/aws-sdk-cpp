...
class DeleteServiceNetworkResourceAssociationResult {
 public:
  ...
  AWS_VPCLATTICE_API DeleteServiceNetworkResourceAssociationResult& operator=(
  ...
  template <typename IdT = Aws::String>
  DeleteServiceNetworkResourceAssociationResult& WithId(IdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  DeleteServiceNetworkResourceAssociationResult& WithArn(ArnT&& value) {
  ...
  inline void SetStatus(ServiceNetworkResourceAssociationStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline DeleteServiceNetworkResourceAssociationResult& WithStatus(ServiceNetworkResourceAssociationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DeleteServiceNetworkResourceAssociationResult& WithRequestId(RequestIdT&& value) {
