...
class ServiceNetworkVpcAssociationSummary {
 public:
  ...
  inline ServiceNetworkVpcAssociationSummary& WithStatus(ServiceNetworkVpcAssociationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetServiceNetworkId(ServiceNetworkIdT&& value) {
    ...
    m_serviceNetworkId = std::forward<ServiceNetworkIdT>(value);
  }
  template <typename ServiceNetworkIdT = Aws::String>
  ServiceNetworkVpcAssociationSummary& WithServiceNetworkId(ServiceNetworkIdT&& value) {
    SetServiceNetworkId(std::forward<ServiceNetworkIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetServiceNetworkName(ServiceNetworkNameT&& value) {
    ...
    m_serviceNetworkName = std::forward<ServiceNetworkNameT>(value);
  }
  template <typename ServiceNetworkNameT = Aws::String>
  ServiceNetworkVpcAssociationSummary& WithServiceNetworkName(ServiceNetworkNameT&& value) {
    SetServiceNetworkName(std::forward<ServiceNetworkNameT>(value));
    return *this;
  }
  ///@}
