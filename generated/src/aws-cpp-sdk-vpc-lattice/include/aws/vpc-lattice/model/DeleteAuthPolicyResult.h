...
namespace Model
{
  ...
  {
  public:
    AWS_VPCLATTICE_API DeleteAuthPolicyResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteAuthPolicyResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
