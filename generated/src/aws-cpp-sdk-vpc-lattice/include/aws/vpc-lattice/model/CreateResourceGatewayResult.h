...
class CreateResourceGatewayResult {
 public:
  ...
  template <typename NameT = Aws::String>
  CreateResourceGatewayResult& WithName(NameT&& value) {
  ...
  template <typename IdT = Aws::String>
  CreateResourceGatewayResult& WithId(IdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  CreateResourceGatewayResult& WithArn(ArnT&& value) {
  ...
  inline void SetStatus(ResourceGatewayStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline CreateResourceGatewayResult& WithStatus(ResourceGatewayStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename VpcIdentifierT = Aws::String>
  CreateResourceGatewayResult& WithVpcIdentifier(VpcIdentifierT&& value) {
  ...
  template <typename SubnetIdsT = Aws::Vector<Aws::String>>
  CreateResourceGatewayResult& WithSubnetIds(SubnetIdsT&& value) {
    SetSubnetIds(std::forward<SubnetIdsT>(value));
    return *this;
  }
  template <typename SubnetIdsT = Aws::String>
  CreateResourceGatewayResult& AddSubnetIds(SubnetIdsT&& value) {
    m_subnetIdsHasBeenSet = true;
  ...
  template <typename SecurityGroupIdsT = Aws::Vector<Aws::String>>
  CreateResourceGatewayResult& WithSecurityGroupIds(SecurityGroupIdsT&& value) {
    SetSecurityGroupIds(std::forward<SecurityGroupIdsT>(value));
    return *this;
  }
  template <typename SecurityGroupIdsT = Aws::String>
  CreateResourceGatewayResult& AddSecurityGroupIds(SecurityGroupIdsT&& value) {
    m_securityGroupIdsHasBeenSet = true;
  ...
  inline CreateResourceGatewayResult& WithIpAddressType(ResourceGatewayIpAddressType value) {
  ...
  inline CreateResourceGatewayResult& WithIpv4AddressesPerEni(int value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateResourceGatewayResult& WithRequestId(RequestIdT&& value) {
