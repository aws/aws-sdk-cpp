...
namespace Model
{
  ...
  {
  public:
    AWS_VPCLATTICE_API ListListenersResult() = default;
    ...
    template<typename ItemsT = Aws::Vector<ListenerSummary>>
    void SetItems(ItemsT&& value) { m_itemsHasBeenSet = true; m_items = std::forward<ItemsT>(value); }
    template<typename ItemsT = Aws::Vector<ListenerSummary>>
    ListListenersResult& WithItems(ItemsT&& value) { SetItems(std::forward<ItemsT>(value)); return *this;}
    template<typename ItemsT = ListenerSummary>
    ListListenersResult& AddItems(ItemsT&& value) { m_itemsHasBeenSet = true; m_items.emplace_back(std::forward<ItemsT>(value)); return *this; }
    ///@}
