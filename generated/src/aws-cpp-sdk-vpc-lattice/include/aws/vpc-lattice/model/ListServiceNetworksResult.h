...
class ListServiceNetworksResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<ServiceNetworkSummary>>
  ListServiceNetworksResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = ServiceNetworkSummary>
  ListServiceNetworksResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListServiceNetworksResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListServiceNetworksResult& WithRequestId(RequestIdT&& value) {
