...
class GetResourceConfigurationResult {
 public:
  ...
  inline GetResourceConfigurationResult& WithType(ResourceConfigurationType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline GetResourceConfigurationResult& WithAllowAssociationToShareableServiceNetwork(bool value) {
  ...
  inline GetResourceConfigurationResult& WithProtocol(ProtocolType value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
  ...
  inline GetResourceConfigurationResult& WithStatus(ResourceConfigurationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAmazonManaged(bool value) {
    m_amazonManagedHasBeenSet = true;
    m_amazonManaged = value;
  }
  inline GetResourceConfigurationResult& WithAmazonManaged(bool value) {
    SetAmazonManaged(value);
    return *this;
  }
  ///@}
