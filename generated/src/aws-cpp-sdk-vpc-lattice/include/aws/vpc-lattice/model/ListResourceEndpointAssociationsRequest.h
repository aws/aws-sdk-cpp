...
class ListResourceEndpointAssociationsRequest : public VPCLatticeRequest {
 public:
  ...
  template <typename ResourceConfigurationIdentifierT = Aws::String>
  ListResourceEndpointAssociationsRequest& WithResourceConfigurationIdentifier(ResourceConfigurationIdentifierT&& value) {
  ...
  void SetResourceEndpointAssociationIdentifier(ResourceEndpointAssociationIdentifierT&& value) {
    m_resourceEndpointAssociationIdentifierHasBeenSet = true;
    m_resourceEndpointAssociationIdentifier = std::forward<ResourceEndpointAssociationIdentifierT>(value);
  }
  template <typename ResourceEndpointAssociationIdentifierT = Aws::String>
  ListResourceEndpointAssociationsRequest& WithResourceEndpointAssociationIdentifier(ResourceEndpointAssociationIdentifierT&& value) {
    SetResourceEndpointAssociationIdentifier(std::forward<ResourceEndpointAssociationIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename VpcEndpointIdT = Aws::String>
  ListResourceEndpointAssociationsRequest& WithVpcEndpointId(VpcEndpointIdT&& value) {
  ...
  template <typename VpcEndpointOwnerT = Aws::String>
  ListResourceEndpointAssociationsRequest& WithVpcEndpointOwner(VpcEndpointOwnerT&& value) {
  ...
  inline ListResourceEndpointAssociationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListResourceEndpointAssociationsRequest& WithNextToken(NextTokenT&& value) {
