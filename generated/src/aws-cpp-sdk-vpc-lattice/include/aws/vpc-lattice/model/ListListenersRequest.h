...
class ListListenersRequest : public VPCLatticeRequest {
 public:
  ...
  template <typename ServiceIdentifierT = Aws::String>
  ListListenersRequest& WithServiceIdentifier(ServiceIdentifierT&& value) {
  ...
  inline ListListenersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListListenersRequest& WithNextToken(NextTokenT&& value) {
