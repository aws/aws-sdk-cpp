...
class HealthCheckConfig {
 public:
  ...
  inline HealthCheckConfig& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline HealthCheckConfig& WithProtocol(TargetGroupProtocol value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
  ...
  inline void SetProtocolVersion(HealthCheckProtocolVersion value) {
    m_protocolVersionHasBeenSet = true;
    m_protocolVersion = value;
  }
  inline HealthCheckConfig& WithProtocolVersion(HealthCheckProtocolVersion value) {
  ...
  inline HealthCheckConfig& WithHealthCheckIntervalSeconds(int value) {
  ...
  inline void SetHealthCheckTimeoutSeconds(int value) {
    m_healthCheckTimeoutSecondsHasBeenSet = true;
    m_healthCheckTimeoutSeconds = value;
  }
  inline HealthCheckConfig& WithHealthCheckTimeoutSeconds(int value) {
    SetHealthCheckTimeoutSeconds(value);
    return *this;
  }
  ///@}
  ...
  void SetMatcher(MatcherT&& value) {
    ...
    m_matcher = std::forward<MatcherT>(value);
  }
  template <typename MatcherT = Matcher>
  HealthCheckConfig& WithMatcher(MatcherT&& value) {
    SetMatcher(std::forward<MatcherT>(value));
    return *this;
  }
  ///@}
 private:
