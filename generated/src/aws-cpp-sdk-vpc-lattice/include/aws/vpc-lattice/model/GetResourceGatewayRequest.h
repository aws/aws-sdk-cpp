...
namespace Model
{
  ...
  public:
    ...
    template<typename ResourceGatewayIdentifierT = Aws::String>
    GetResourceGatewayRequest& WithResourceGatewayIdentifier(ResourceGatewayIdentifierT&& value) { SetResourceGatewayIdentifier(std::forward<ResourceGatewayIdentifierT>(value)); return *this;}
    ///@}
  private:
