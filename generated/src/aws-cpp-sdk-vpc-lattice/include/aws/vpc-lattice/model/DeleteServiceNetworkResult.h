...
namespace Model
{
  ...
  {
  public:
    AWS_VPCLATTICE_API DeleteServiceNetworkResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteServiceNetworkResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
