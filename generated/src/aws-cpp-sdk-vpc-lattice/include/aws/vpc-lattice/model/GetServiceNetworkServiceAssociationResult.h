...
class GetServiceNetworkServiceAssociationResult {
 public:
  ...
  AWS_VPCLATTICE_API GetServiceNetworkServiceAssociationResult& operator=(
  ...
  template <typename IdT = Aws::String>
  GetServiceNetworkServiceAssociationResult& WithId(IdT&& value) {
  ...
  inline GetServiceNetworkServiceAssociationResult& WithStatus(ServiceNetworkServiceAssociationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ArnT = Aws::String>
  GetServiceNetworkServiceAssociationResult& WithArn(ArnT&& value) {
  ...
  template <typename CreatedByT = Aws::String>
  GetServiceNetworkServiceAssociationResult& WithCreatedBy(CreatedByT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  GetServiceNetworkServiceAssociationResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename ServiceIdT = Aws::String>
  GetServiceNetworkServiceAssociationResult& WithServiceId(ServiceIdT&& value) {
  ...
  template <typename ServiceNameT = Aws::String>
  GetServiceNetworkServiceAssociationResult& WithServiceName(ServiceNameT&& value) {
  ...
  template <typename ServiceArnT = Aws::String>
  GetServiceNetworkServiceAssociationResult& WithServiceArn(ServiceArnT&& value) {
  ...
  template <typename ServiceNetworkIdT = Aws::String>
  GetServiceNetworkServiceAssociationResult& WithServiceNetworkId(ServiceNetworkIdT&& value) {
  ...
  template <typename ServiceNetworkNameT = Aws::String>
  GetServiceNetworkServiceAssociationResult& WithServiceNetworkName(ServiceNetworkNameT&& value) {
  ...
  template <typename ServiceNetworkArnT = Aws::String>
  GetServiceNetworkServiceAssociationResult& WithServiceNetworkArn(ServiceNetworkArnT&& value) {
  ...
  template <typename DnsEntryT = DnsEntry>
  GetServiceNetworkServiceAssociationResult& WithDnsEntry(DnsEntryT&& value) {
  ...
  template <typename CustomDomainNameT = Aws::String>
  GetServiceNetworkServiceAssociationResult& WithCustomDomainName(CustomDomainNameT&& value) {
  ...
  template <typename FailureMessageT = Aws::String>
  GetServiceNetworkServiceAssociationResult& WithFailureMessage(FailureMessageT&& value) {
  ...
  template <typename FailureCodeT = Aws::String>
  GetServiceNetworkServiceAssociationResult& WithFailureCode(FailureCodeT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetServiceNetworkServiceAssociationResult& WithRequestId(RequestIdT&& value) {
