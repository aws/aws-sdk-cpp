...
class ListAccessLogSubscriptionsResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<AccessLogSubscriptionSummary>>
  ListAccessLogSubscriptionsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = AccessLogSubscriptionSummary>
  ListAccessLogSubscriptionsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListAccessLogSubscriptionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAccessLogSubscriptionsResult& WithRequestId(RequestIdT&& value) {
