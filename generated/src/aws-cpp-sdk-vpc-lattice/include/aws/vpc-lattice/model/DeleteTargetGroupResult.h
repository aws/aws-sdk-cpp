...
class DeleteTargetGroupResult {
 public:
  ...
  template <typename IdT = Aws::String>
  DeleteTargetGroupResult& WithId(IdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  DeleteTargetGroupResult& WithArn(ArnT&& value) {
  ...
  inline DeleteTargetGroupResult& WithStatus(TargetGroupStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DeleteTargetGroupResult& WithRequestId(RequestIdT&& value) {
