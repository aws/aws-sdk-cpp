...
namespace Model
{
  ...
  {
  public:
    AWS_VPCLATTICE_API DeleteAccessLogSubscriptionRequest() = default;
    ...
    template<typename AccessLogSubscriptionIdentifierT = Aws::String>
    DeleteAccessLogSubscriptionRequest& WithAccessLogSubscriptionIdentifier(AccessLogSubscriptionIdentifierT&& value) { SetAccessLogSubscriptionIdentifier(std::forward<AccessLogSubscriptionIdentifierT>(value)); return *this;}
    ///@}
  private:
