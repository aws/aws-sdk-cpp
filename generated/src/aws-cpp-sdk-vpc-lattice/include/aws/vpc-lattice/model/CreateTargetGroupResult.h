...
class CreateTargetGroupResult {
 public:
  ...
  inline void SetType(TargetGroupType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline CreateTargetGroupResult& WithType(TargetGroupType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(TargetGroupStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline CreateTargetGroupResult& WithStatus(TargetGroupStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
