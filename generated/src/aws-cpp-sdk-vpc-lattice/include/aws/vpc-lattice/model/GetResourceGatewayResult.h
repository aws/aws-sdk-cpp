...
class GetResourceGatewayResult {
 public:
  ...
  inline GetResourceGatewayResult& WithStatus(ResourceGatewayStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline GetResourceGatewayResult& WithIpAddressType(ResourceGatewayIpAddressType value) {
