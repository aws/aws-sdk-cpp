...
class CreateServiceNetworkServiceAssociationRequest : public VPCLatticeRequest {
 public:
  ...
  template <typename ClientTokenT = Aws::String>
  CreateServiceNetworkServiceAssociationRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename ServiceIdentifierT = Aws::String>
  CreateServiceNetworkServiceAssociationRequest& WithServiceIdentifier(ServiceIdentifierT&& value) {
  ...
  template <typename ServiceNetworkIdentifierT = Aws::String>
  CreateServiceNetworkServiceAssociationRequest& WithServiceNetworkIdentifier(ServiceNetworkIdentifierT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateServiceNetworkServiceAssociationRequest& WithTags(TagsT&& value) {
