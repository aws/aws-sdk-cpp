...
class UpdateListenerResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  UpdateListenerResult& WithArn(ArnT&& value) {
  ...
  template <typename IdT = Aws::String>
  UpdateListenerResult& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  UpdateListenerResult& WithName(NameT&& value) {
  ...
  inline UpdateListenerResult& WithProtocol(ListenerProtocol value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateListenerResult& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  template <typename ServiceArnT = Aws::String>
  UpdateListenerResult& WithServiceArn(ServiceArnT&& value) {
  ...
  template <typename ServiceIdT = Aws::String>
  UpdateListenerResult& WithServiceId(ServiceIdT&& value) {
  ...
  template <typename DefaultActionT = RuleAction>
  UpdateListenerResult& WithDefaultAction(DefaultActionT&& value) {
