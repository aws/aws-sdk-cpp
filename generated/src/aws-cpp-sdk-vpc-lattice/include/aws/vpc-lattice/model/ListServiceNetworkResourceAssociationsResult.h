...
class ListServiceNetworkResourceAssociationsResult {
 public:
  ...
  AWS_VPCLATTICE_API ListServiceNetworkResourceAssociationsResult& operator=(
  ...
  template <typename ItemsT = Aws::Vector<ServiceNetworkResourceAssociationSummary>>
  ListServiceNetworkResourceAssociationsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = ServiceNetworkResourceAssociationSummary>
  ListServiceNetworkResourceAssociationsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListServiceNetworkResourceAssociationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListServiceNetworkResourceAssociationsResult& WithRequestId(RequestIdT&& value) {
