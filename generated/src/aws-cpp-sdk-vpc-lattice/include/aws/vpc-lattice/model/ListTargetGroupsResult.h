...
class ListTargetGroupsResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<TargetGroupSummary>>
  ListTargetGroupsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = TargetGroupSummary>
  ListTargetGroupsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListTargetGroupsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListTargetGroupsResult& WithRequestId(RequestIdT&& value) {
