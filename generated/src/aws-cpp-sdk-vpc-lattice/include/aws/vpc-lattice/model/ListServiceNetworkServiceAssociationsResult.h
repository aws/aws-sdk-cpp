...
class ListServiceNetworkServiceAssociationsResult {
 public:
  ...
  AWS_VPCLATTICE_API ListServiceNetworkServiceAssociationsResult& operator=(
  ...
  template <typename ItemsT = Aws::Vector<ServiceNetworkServiceAssociationSummary>>
  ListServiceNetworkServiceAssociationsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = ServiceNetworkServiceAssociationSummary>
  ListServiceNetworkServiceAssociationsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListServiceNetworkServiceAssociationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListServiceNetworkServiceAssociationsResult& WithRequestId(RequestIdT&& value) {
