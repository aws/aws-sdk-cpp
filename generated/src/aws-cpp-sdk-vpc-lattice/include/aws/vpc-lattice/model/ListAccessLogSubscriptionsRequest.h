...
class ListAccessLogSubscriptionsRequest : public VPCLatticeRequest {
 public:
  AWS_VPCLATTICE_API ListAccessLogSubscriptionsRequest() = default;
  ...
  template <typename ResourceIdentifierT = Aws::String>
  ListAccessLogSubscriptionsRequest& WithResourceIdentifier(ResourceIdentifierT&& value) {
  ...
  inline ListAccessLogSubscriptionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAccessLogSubscriptionsRequest& WithNextToken(NextTokenT&& value) {
