...
class ListenerSummary {
 public:
  ...
  template <typename ArnT = Aws::String>
  ListenerSummary& WithArn(ArnT&& value) {
  ...
  template <typename IdT = Aws::String>
  ListenerSummary& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  ListenerSummary& WithName(NameT&& value) {
  ...
  inline ListenerSummary& WithProtocol(ListenerProtocol value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
  ...
  inline ListenerSummary& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  ListenerSummary& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename LastUpdatedAtT = Aws::Utils::DateTime>
  ListenerSummary& WithLastUpdatedAt(LastUpdatedAtT&& value) {
