...
class CreateServiceNetworkResult {
 public:
  ...
  void SetSharingConfig(SharingConfigT&& value) {
    ...
    m_sharingConfig = std::forward<SharingConfigT>(value);
  }
  template <typename SharingConfigT = SharingConfig>
  CreateServiceNetworkResult& WithSharingConfig(SharingConfigT&& value) {
    SetSharingConfig(std::forward<SharingConfigT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateServiceNetworkResult& WithAuthType(AuthType value) {
    SetAuthType(value);
    return *this;
  }
  ///@}
