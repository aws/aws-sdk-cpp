...
namespace Model
{
  ...
  {
  public:
    AWS_VPCLATTICE_API ListTargetsResult() = default;
    ...
    template<typename ItemsT = Aws::Vector<TargetSummary>>
    ListTargetsResult& WithItems(ItemsT&& value) { SetItems(std::forward<ItemsT>(value)); return *this;}
    template<typename ItemsT = TargetSummary>
    ListTargetsResult& AddItems(ItemsT&& value) { m_itemsHasBeenSet = true; m_items.emplace_back(std::forward<ItemsT>(value)); return *this; }
    ///@}
