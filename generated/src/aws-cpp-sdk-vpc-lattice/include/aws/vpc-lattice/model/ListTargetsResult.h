...
class ListTargetsResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<TargetSummary>>
  ListTargetsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = TargetSummary>
  ListTargetsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListTargetsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListTargetsResult& WithRequestId(RequestIdT&& value) {
