...
class UpdateAccessLogSubscriptionResult {
 public:
  ...
  template <typename IdT = Aws::String>
  UpdateAccessLogSubscriptionResult& WithId(IdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  UpdateAccessLogSubscriptionResult& WithArn(ArnT&& value) {
  ...
  template <typename ResourceIdT = Aws::String>
  UpdateAccessLogSubscriptionResult& WithResourceId(ResourceIdT&& value) {
  ...
  template <typename ResourceArnT = Aws::String>
  UpdateAccessLogSubscriptionResult& WithResourceArn(ResourceArnT&& value) {
  ...
  template <typename DestinationArnT = Aws::String>
  UpdateAccessLogSubscriptionResult& WithDestinationArn(DestinationArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateAccessLogSubscriptionResult& WithRequestId(RequestIdT&& value) {
