...
namespace Model
{
   ...
   * Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/vpc-lattice-2022-11-30/ServiceQuotaExceededException">AWS
   * API Reference</a></p>
   */
  class ServiceQuotaExceededException
  {
  public:
    AWS_VPCLATTICE_API ServiceQuotaExceededException() = default;
    AWS_VPCLATTICE_API ServiceQuotaExceededException(Aws::Utils::Json::JsonView jsonValue);
    AWS_VPCLATTICE_API ServiceQuotaExceededException& operator=(Aws::Utils::Json::JsonView jsonValue);
