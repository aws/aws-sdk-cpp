...
namespace Model
{
  ...
  {
  public:
    AWS_VPCLATTICE_API DeleteAccessLogSubscriptionResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteAccessLogSubscriptionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
