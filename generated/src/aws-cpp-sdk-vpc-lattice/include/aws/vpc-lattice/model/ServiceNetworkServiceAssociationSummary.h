...
class ServiceNetworkServiceAssociationSummary {
 public:
  ...
  template <typename IdT = Aws::String>
  ServiceNetworkServiceAssociationSummary& WithId(IdT&& value) {
  ...
  ///@{
  /**
   * <p>The status of the service network’s association with the service. If the
   * deletion fails, try to delete again.</p>
   */
  ...
  inline ServiceNetworkServiceAssociationSummary& WithStatus(ServiceNetworkServiceAssociationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ArnT = Aws::String>
  ServiceNetworkServiceAssociationSummary& WithArn(ArnT&& value) {
