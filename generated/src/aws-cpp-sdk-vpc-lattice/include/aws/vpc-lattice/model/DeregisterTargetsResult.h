...
class DeregisterTargetsResult {
 public:
  ...
  template <typename SuccessfulT = Aws::Vector<Target>>
  DeregisterTargetsResult& WithSuccessful(SuccessfulT&& value) {
    SetSuccessful(std::forward<SuccessfulT>(value));
    return *this;
  }
  template <typename SuccessfulT = Target>
  DeregisterTargetsResult& AddSuccessful(SuccessfulT&& value) {
    m_successfulHasBeenSet = true;
  ...
  template <typename UnsuccessfulT = Aws::Vector<TargetFailure>>
  DeregisterTargetsResult& WithUnsuccessful(UnsuccessfulT&& value) {
    SetUnsuccessful(std::forward<UnsuccessfulT>(value));
    return *this;
  }
  template <typename UnsuccessfulT = TargetFailure>
  DeregisterTargetsResult& AddUnsuccessful(UnsuccessfulT&& value) {
    m_unsuccessfulHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DeregisterTargetsResult& WithRequestId(RequestIdT&& value) {
