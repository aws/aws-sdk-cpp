...
class ListServiceNetworkVpcEndpointAssociationsRequest : public VPCLatticeRequest {
 public:
  ...
  template <typename ServiceNetworkIdentifierT = Aws::String>
  ListServiceNetworkVpcEndpointAssociationsRequest& WithServiceNetworkIdentifier(ServiceNetworkIdentifierT&& value) {
  ...
  inline ListServiceNetworkVpcEndpointAssociationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListServiceNetworkVpcEndpointAssociationsRequest& WithNextToken(NextTokenT&& value) {
