...
class ListResourceConfigurationsResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<ResourceConfigurationSummary>>
  ListResourceConfigurationsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = ResourceConfigurationSummary>
  ListResourceConfigurationsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListResourceConfigurationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListResourceConfigurationsResult& WithRequestId(RequestIdT&& value) {
