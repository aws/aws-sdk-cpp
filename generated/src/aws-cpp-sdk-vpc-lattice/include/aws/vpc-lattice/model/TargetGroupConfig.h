...
class TargetGroupConfig {
 public:
  ...
  inline TargetGroupConfig& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  inline void SetProtocol(TargetGroupProtocol value) {
    m_protocolHasBeenSet = true;
    m_protocol = value;
  }
  inline TargetGroupConfig& WithProtocol(TargetGroupProtocol value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
  ...
  inline void SetProtocolVersion(TargetGroupProtocolVersion value) {
    m_protocolVersionHasBeenSet = true;
    m_protocolVersion = value;
  }
  inline TargetGroupConfig& WithProtocolVersion(TargetGroupProtocolVersion value) {
  ...
  inline TargetGroupConfig& WithIpAddressType(IpAddressType value) {
  ...
  inline void SetLambdaEventStructureVersion(LambdaEventStructureVersion value) {
    m_lambdaEventStructureVersionHasBeenSet = true;
    m_lambdaEventStructureVersion = value;
  }
  inline TargetGroupConfig& WithLambdaEventStructureVersion(LambdaEventStructureVersion value) {
    SetLambdaEventStructureVersion(value);
    return *this;
  }
  ///@}
 private:
