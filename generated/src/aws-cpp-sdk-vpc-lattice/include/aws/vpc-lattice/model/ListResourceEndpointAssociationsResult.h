...
class ListResourceEndpointAssociationsResult {
 public:
  ...
  AWS_VPCLATTICE_API ListResourceEndpointAssociationsResult& operator=(
  ...
  template <typename ItemsT = Aws::Vector<ResourceEndpointAssociationSummary>>
  ListResourceEndpointAssociationsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = ResourceEndpointAssociationSummary>
  ListResourceEndpointAssociationsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListResourceEndpointAssociationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListResourceEndpointAssociationsResult& WithRequestId(RequestIdT&& value) {
