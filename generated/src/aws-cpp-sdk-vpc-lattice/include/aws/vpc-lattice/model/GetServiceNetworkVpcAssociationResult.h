...
class GetServiceNetworkVpcAssociationResult {
 public:
  ...
  AWS_VPCLATTICE_API GetServiceNetworkVpcAssociationResult& operator=(
  ...
  template <typename IdT = Aws::String>
  GetServiceNetworkVpcAssociationResult& WithId(IdT&& value) {
  ...
  inline GetServiceNetworkVpcAssociationResult& WithStatus(ServiceNetworkVpcAssociationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ArnT = Aws::String>
  GetServiceNetworkVpcAssociationResult& WithArn(ArnT&& value) {
  ...
  template <typename CreatedByT = Aws::String>
  GetServiceNetworkVpcAssociationResult& WithCreatedBy(CreatedByT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  GetServiceNetworkVpcAssociationResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename ServiceNetworkIdT = Aws::String>
  GetServiceNetworkVpcAssociationResult& WithServiceNetworkId(ServiceNetworkIdT&& value) {
  ...
  template <typename ServiceNetworkNameT = Aws::String>
  GetServiceNetworkVpcAssociationResult& WithServiceNetworkName(ServiceNetworkNameT&& value) {
  ...
  template <typename ServiceNetworkArnT = Aws::String>
  GetServiceNetworkVpcAssociationResult& WithServiceNetworkArn(ServiceNetworkArnT&& value) {
  ...
  template <typename VpcIdT = Aws::String>
  GetServiceNetworkVpcAssociationResult& WithVpcId(VpcIdT&& value) {
  ...
  template <typename SecurityGroupIdsT = Aws::Vector<Aws::String>>
  GetServiceNetworkVpcAssociationResult& WithSecurityGroupIds(SecurityGroupIdsT&& value) {
    SetSecurityGroupIds(std::forward<SecurityGroupIdsT>(value));
    return *this;
  }
  template <typename SecurityGroupIdsT = Aws::String>
  GetServiceNetworkVpcAssociationResult& AddSecurityGroupIds(SecurityGroupIdsT&& value) {
    m_securityGroupIdsHasBeenSet = true;
  ...
  inline GetServiceNetworkVpcAssociationResult& WithPrivateDnsEnabled(bool value) {
  ...
  template <typename FailureMessageT = Aws::String>
  GetServiceNetworkVpcAssociationResult& WithFailureMessage(FailureMessageT&& value) {
  ...
  template <typename FailureCodeT = Aws::String>
  GetServiceNetworkVpcAssociationResult& WithFailureCode(FailureCodeT&& value) {
  ...
  template <typename LastUpdatedAtT = Aws::Utils::DateTime>
  GetServiceNetworkVpcAssociationResult& WithLastUpdatedAt(LastUpdatedAtT&& value) {
  ...
  template <typename DnsOptionsT = DnsOptions>
  GetServiceNetworkVpcAssociationResult& WithDnsOptions(DnsOptionsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetServiceNetworkVpcAssociationResult& WithRequestId(RequestIdT&& value) {
