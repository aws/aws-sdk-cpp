...
class ListResourceGatewaysResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<ResourceGatewaySummary>>
  ListResourceGatewaysResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = ResourceGatewaySummary>
  ListResourceGatewaysResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListResourceGatewaysResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListResourceGatewaysResult& WithRequestId(RequestIdT&& value) {
