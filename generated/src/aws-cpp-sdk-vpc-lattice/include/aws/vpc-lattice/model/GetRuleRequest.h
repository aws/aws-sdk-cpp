...
class GetRuleRequest : public VPCLatticeRequest {
 public:
  ...
  template <typename ServiceIdentifierT = Aws::String>
  GetRuleRequest& WithServiceIdentifier(ServiceIdentifierT&& value) {
  ...
  template <typename ListenerIdentifierT = Aws::String>
  GetRuleRequest& WithListenerIdentifier(ListenerIdentifierT&& value) {
  ...
  template <typename RuleIdentifierT = Aws::String>
  GetRuleRequest& WithRuleIdentifier(RuleIdentifierT&& value) {
