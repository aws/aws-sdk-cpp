...
class DeleteResourceEndpointAssociationResult {
 public:
  ...
  AWS_VPCLATTICE_API DeleteResourceEndpointAssociationResult& operator=(
  ...
  template <typename IdT = Aws::String>
  DeleteResourceEndpointAssociationResult& WithId(IdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  DeleteResourceEndpointAssociationResult& WithArn(ArnT&& value) {
  ...
  template <typename ResourceConfigurationIdT = Aws::String>
  DeleteResourceEndpointAssociationResult& WithResourceConfigurationId(ResourceConfigurationIdT&& value) {
  ...
  template <typename ResourceConfigurationArnT = Aws::String>
  DeleteResourceEndpointAssociationResult& WithResourceConfigurationArn(ResourceConfigurationArnT&& value) {
  ...
  template <typename VpcEndpointIdT = Aws::String>
  DeleteResourceEndpointAssociationResult& WithVpcEndpointId(VpcEndpointIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteResourceEndpointAssociationResult& WithRequestId(RequestIdT&& value) {
