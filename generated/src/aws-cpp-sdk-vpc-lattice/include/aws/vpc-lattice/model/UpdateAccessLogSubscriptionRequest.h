...
class UpdateAccessLogSubscriptionRequest : public VPCLatticeRequest {
 public:
  ...
  void SetAccessLogSubscriptionIdentifier(AccessLogSubscriptionIdentifierT&& value) {
    m_accessLogSubscriptionIdentifierHasBeenSet = true;
    m_accessLogSubscriptionIdentifier = std::forward<AccessLogSubscriptionIdentifierT>(value);
  }
  template <typename AccessLogSubscriptionIdentifierT = Aws::String>
  UpdateAccessLogSubscriptionRequest& WithAccessLogSubscriptionIdentifier(AccessLogSubscriptionIdentifierT&& value) {
    SetAccessLogSubscriptionIdentifier(std::forward<AccessLogSubscriptionIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename DestinationArnT = Aws::String>
  UpdateAccessLogSubscriptionRequest& WithDestinationArn(DestinationArnT&& value) {
