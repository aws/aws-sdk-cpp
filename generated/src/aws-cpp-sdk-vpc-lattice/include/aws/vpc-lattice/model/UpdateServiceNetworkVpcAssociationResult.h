...
class UpdateServiceNetworkVpcAssociationResult {
 public:
  ...
  AWS_VPCLATTICE_API UpdateServiceNetworkVpcAssociationResult& operator=(
  ...
  template <typename IdT = Aws::String>
  UpdateServiceNetworkVpcAssociationResult& WithId(IdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  UpdateServiceNetworkVpcAssociationResult& WithArn(ArnT&& value) {
  ...
  inline UpdateServiceNetworkVpcAssociationResult& WithStatus(ServiceNetworkVpcAssociationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreatedByT = Aws::String>
  UpdateServiceNetworkVpcAssociationResult& WithCreatedBy(CreatedByT&& value) {
  ...
  template <typename SecurityGroupIdsT = Aws::Vector<Aws::String>>
  UpdateServiceNetworkVpcAssociationResult& WithSecurityGroupIds(SecurityGroupIdsT&& value) {
    SetSecurityGroupIds(std::forward<SecurityGroupIdsT>(value));
    return *this;
  }
  template <typename SecurityGroupIdsT = Aws::String>
  UpdateServiceNetworkVpcAssociationResult& AddSecurityGroupIds(SecurityGroupIdsT&& value) {
    m_securityGroupIdsHasBeenSet = true;
  ...
  inline UpdateServiceNetworkVpcAssociationResult& WithPrivateDnsEnabled(bool value) {
  ...
  template <typename DnsOptionsT = DnsOptions>
  UpdateServiceNetworkVpcAssociationResult& WithDnsOptions(DnsOptionsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateServiceNetworkVpcAssociationResult& WithRequestId(RequestIdT&& value) {
