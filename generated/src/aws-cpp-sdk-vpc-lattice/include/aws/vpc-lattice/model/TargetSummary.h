...
class TargetSummary {
 public:
  ...
  template <typename IdT = Aws::String>
  TargetSummary& WithId(IdT&& value) {
  ...
  inline TargetSummary& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  inline TargetSummary& WithStatus(TargetStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ReasonCodeT = Aws::String>
  TargetSummary& WithReasonCode(ReasonCodeT&& value) {
