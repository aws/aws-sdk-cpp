...
class DeleteServiceNetworkVpcAssociationResult {
 public:
  ...
  AWS_VPCLATTICE_API DeleteServiceNetworkVpcAssociationResult& operator=(
  ...
  template <typename IdT = Aws::String>
  DeleteServiceNetworkVpcAssociationResult& WithId(IdT&& value) {
  ...
  inline DeleteServiceNetworkVpcAssociationResult& WithStatus(ServiceNetworkVpcAssociationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ArnT = Aws::String>
  DeleteServiceNetworkVpcAssociationResult& WithArn(ArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteServiceNetworkVpcAssociationResult& WithRequestId(RequestIdT&& value) {
