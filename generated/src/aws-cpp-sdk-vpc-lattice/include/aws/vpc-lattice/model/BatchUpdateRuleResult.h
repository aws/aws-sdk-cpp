...
class BatchUpdateRuleResult {
 public:
  ...
  template <typename SuccessfulT = Aws::Vector<RuleUpdateSuccess>>
  BatchUpdateRuleResult& WithSuccessful(SuccessfulT&& value) {
    SetSuccessful(std::forward<SuccessfulT>(value));
    return *this;
  }
  template <typename SuccessfulT = RuleUpdateSuccess>
  BatchUpdateRuleResult& AddSuccessful(SuccessfulT&& value) {
    m_successfulHasBeenSet = true;
  ...
  template <typename UnsuccessfulT = Aws::Vector<RuleUpdateFailure>>
  BatchUpdateRuleResult& WithUnsuccessful(UnsuccessfulT&& value) {
    SetUnsuccessful(std::forward<UnsuccessfulT>(value));
    return *this;
  }
  template <typename UnsuccessfulT = RuleUpdateFailure>
  BatchUpdateRuleResult& AddUnsuccessful(UnsuccessfulT&& value) {
    m_unsuccessfulHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  BatchUpdateRuleResult& WithRequestId(RequestIdT&& value) {
