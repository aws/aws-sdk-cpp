...
class CreateServiceNetworkResourceAssociationRequest : public VPCLatticeRequest {
 public:
  ...
  template <typename ClientTokenT = Aws::String>
  CreateServiceNetworkResourceAssociationRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename ResourceConfigurationIdentifierT = Aws::String>
  CreateServiceNetworkResourceAssociationRequest& WithResourceConfigurationIdentifier(ResourceConfigurationIdentifierT&& value) {
  ...
  template <typename ServiceNetworkIdentifierT = Aws::String>
  CreateServiceNetworkResourceAssociationRequest& WithServiceNetworkIdentifier(ServiceNetworkIdentifierT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateServiceNetworkResourceAssociationRequest& WithTags(TagsT&& value) {
