...
class ListServiceNetworkVpcAssociationsResult {
 public:
  ...
  AWS_VPCLATTICE_API ListServiceNetworkVpcAssociationsResult& operator=(
  ...
  template <typename ItemsT = Aws::Vector<ServiceNetworkVpcAssociationSummary>>
  ListServiceNetworkVpcAssociationsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = ServiceNetworkVpcAssociationSummary>
  ListServiceNetworkVpcAssociationsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListServiceNetworkVpcAssociationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListServiceNetworkVpcAssociationsResult& WithRequestId(RequestIdT&& value) {
