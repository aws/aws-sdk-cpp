...
namespace VPCLattice
{
   ...
   * User Guide</a> </p>
   */
  class AWS_VPCLATTICE_API VPCLatticeClient : Aws::Client::ClientWithAsyncTemplateMethods<VPCLatticeClient>,
    smithy::client::AwsSmithyClientT<Aws::VPCLattice::SERVICE_NAME,
