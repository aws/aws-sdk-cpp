...
#include <aws/vpc-lattice/VPCLatticeWaiter.h>
...
class AWS_VPCLATTICE_API VPCLatticeClient : public Aws::Client::AWSJsonClient,
                                            ...
                                            public VPCLatticeWaiter<VPCLatticeClient> {
 public:
   ...
   */
  VPCLatticeClient(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<VPCLatticeEndpointProviderBase> endpointProvider = nullptr,
      const Aws::VPCLattice::VPCLatticeClientConfiguration& clientConfiguration = Aws::VPCLattice::VPCLatticeClientConfiguration());
  ...
  /**
   * An Async wrapper for BatchUpdateRule that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename BatchUpdateRuleRequestT = Model::BatchUpdateRuleRequest>
  void BatchUpdateRuleAsync(const BatchUpdateRuleRequestT& request, const BatchUpdateRuleResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateAccessLogSubscriptionOutcome CreateAccessLogSubscription(
      const Model::CreateAccessLogSubscriptionRequest& request) const;

  /**
   * A Callable wrapper for CreateAccessLogSubscription that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateAccessLogSubscriptionRequestT = Model::CreateAccessLogSubscriptionRequest>
  Model::CreateAccessLogSubscriptionOutcomeCallable CreateAccessLogSubscriptionCallable(
      const CreateAccessLogSubscriptionRequestT& request) const {
    return SubmitCallable(&VPCLatticeClient::CreateAccessLogSubscription, request);
  }

  /**
   * An Async wrapper for CreateAccessLogSubscription that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateAccessLogSubscriptionRequestT = Model::CreateAccessLogSubscriptionRequest>
  void CreateAccessLogSubscriptionAsync(const CreateAccessLogSubscriptionRequestT& request,
                                        const CreateAccessLogSubscriptionResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateListener that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateListenerRequestT = Model::CreateListenerRequest>
  void CreateListenerAsync(const CreateListenerRequestT& request, const CreateListenerResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateResourceConfigurationOutcome CreateResourceConfiguration(
      const Model::CreateResourceConfigurationRequest& request) const;

  /**
   * A Callable wrapper for CreateResourceConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateResourceConfigurationRequestT = Model::CreateResourceConfigurationRequest>
  Model::CreateResourceConfigurationOutcomeCallable CreateResourceConfigurationCallable(
      const CreateResourceConfigurationRequestT& request) const {
    return SubmitCallable(&VPCLatticeClient::CreateResourceConfiguration, request);
  }

  /**
   * An Async wrapper for CreateResourceConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateResourceConfigurationRequestT = Model::CreateResourceConfigurationRequest>
  void CreateResourceConfigurationAsync(const CreateResourceConfigurationRequestT& request,
                                        const CreateResourceConfigurationResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&VPCLatticeClient::CreateResourceConfiguration, request, handler, context);
  }

  /**
   * <p>A resource gateway is a point of ingress into the VPC where a resource
   * resides. It spans multiple Availability Zones. For your resource to be
   * accessible from all Availability Zones, you should create your resource gateways
   * to span as many Availability Zones as possible. A VPC can have multiple resource
  ...
  /**
   * A Callable wrapper for CreateResourceGateway that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateResourceGateway that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateResourceGatewayRequestT = Model::CreateResourceGatewayRequest>
  void CreateResourceGatewayAsync(const CreateResourceGatewayRequestT& request, const CreateResourceGatewayResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateServiceNetwork that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateServiceNetwork that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateServiceNetworkRequestT = Model::CreateServiceNetworkRequest>
  void CreateServiceNetworkAsync(const CreateServiceNetworkRequestT& request, const CreateServiceNetworkResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateServiceNetworkResourceAssociationOutcome CreateServiceNetworkResourceAssociation(
      const Model::CreateServiceNetworkResourceAssociationRequest& request) const;

  /**
   * A Callable wrapper for CreateServiceNetworkResourceAssociation that returns a future to the operation so that it can be executed in
  ...
  Model::CreateServiceNetworkResourceAssociationOutcomeCallable CreateServiceNetworkResourceAssociationCallable(
      const CreateServiceNetworkResourceAssociationRequestT& request) const {
    return SubmitCallable(&VPCLatticeClient::CreateServiceNetworkResourceAssociation, request);
  }

  /**
   * An Async wrapper for CreateServiceNetworkResourceAssociation that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename CreateServiceNetworkResourceAssociationRequestT = Model::CreateServiceNetworkResourceAssociationRequest>
  void CreateServiceNetworkResourceAssociationAsync(const CreateServiceNetworkResourceAssociationRequestT& request,
                                                    const CreateServiceNetworkResourceAssociationResponseReceivedHandler& handler,
                                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateServiceNetworkServiceAssociationOutcome CreateServiceNetworkServiceAssociation(
      const Model::CreateServiceNetworkServiceAssociationRequest& request) const;

  /**
   * A Callable wrapper for CreateServiceNetworkServiceAssociation that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename CreateServiceNetworkServiceAssociationRequestT = Model::CreateServiceNetworkServiceAssociationRequest>
  Model::CreateServiceNetworkServiceAssociationOutcomeCallable CreateServiceNetworkServiceAssociationCallable(
      const CreateServiceNetworkServiceAssociationRequestT& request) const {
    return SubmitCallable(&VPCLatticeClient::CreateServiceNetworkServiceAssociation, request);
  }

  /**
   * An Async wrapper for CreateServiceNetworkServiceAssociation that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename CreateServiceNetworkServiceAssociationRequestT = Model::CreateServiceNetworkServiceAssociationRequest>
  void CreateServiceNetworkServiceAssociationAsync(const CreateServiceNetworkServiceAssociationRequestT& request,
                                                   const CreateServiceNetworkServiceAssociationResponseReceivedHandler& handler,
                                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateServiceNetworkVpcAssociationOutcome CreateServiceNetworkVpcAssociation(
      const Model::CreateServiceNetworkVpcAssociationRequest& request) const;

  /**
   * A Callable wrapper for CreateServiceNetworkVpcAssociation that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename CreateServiceNetworkVpcAssociationRequestT = Model::CreateServiceNetworkVpcAssociationRequest>
  Model::CreateServiceNetworkVpcAssociationOutcomeCallable CreateServiceNetworkVpcAssociationCallable(
      const CreateServiceNetworkVpcAssociationRequestT& request) const {
    return SubmitCallable(&VPCLatticeClient::CreateServiceNetworkVpcAssociation, request);
  }

  /**
   * An Async wrapper for CreateServiceNetworkVpcAssociation that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateServiceNetworkVpcAssociationRequestT = Model::CreateServiceNetworkVpcAssociationRequest>
  void CreateServiceNetworkVpcAssociationAsync(const CreateServiceNetworkVpcAssociationRequestT& request,
                                               const CreateServiceNetworkVpcAssociationResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateTargetGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateTargetGroup that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateTargetGroupRequestT = Model::CreateTargetGroupRequest>
  void CreateTargetGroupAsync(const CreateTargetGroupRequestT& request, const CreateTargetGroupResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteAccessLogSubscriptionOutcome DeleteAccessLogSubscription(
      const Model::DeleteAccessLogSubscriptionRequest& request) const;

  /**
   * A Callable wrapper for DeleteAccessLogSubscription that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteAccessLogSubscriptionRequestT = Model::DeleteAccessLogSubscriptionRequest>
  Model::DeleteAccessLogSubscriptionOutcomeCallable DeleteAccessLogSubscriptionCallable(
      const DeleteAccessLogSubscriptionRequestT& request) const {
    return SubmitCallable(&VPCLatticeClient::DeleteAccessLogSubscription, request);
  }

  /**
   * An Async wrapper for DeleteAccessLogSubscription that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteAccessLogSubscriptionRequestT = Model::DeleteAccessLogSubscriptionRequest>
  void DeleteAccessLogSubscriptionAsync(const DeleteAccessLogSubscriptionRequestT& request,
                                        const DeleteAccessLogSubscriptionResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteAuthPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteAuthPolicy that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteAuthPolicyRequestT = Model::DeleteAuthPolicyRequest>
  void DeleteAuthPolicyAsync(const DeleteAuthPolicyRequestT& request, const DeleteAuthPolicyResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteListener that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteListenerRequestT = Model::DeleteListenerRequest>
  void DeleteListenerAsync(const DeleteListenerRequestT& request, const DeleteListenerResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::DeleteResourceConfigurationOutcome DeleteResourceConfiguration(
      const Model::DeleteResourceConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DeleteResourceConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteResourceConfigurationRequestT = Model::DeleteResourceConfigurationRequest>
  Model::DeleteResourceConfigurationOutcomeCallable DeleteResourceConfigurationCallable(
      const DeleteResourceConfigurationRequestT& request) const {
    return SubmitCallable(&VPCLatticeClient::DeleteResourceConfiguration, request);
  }

  /**
   * An Async wrapper for DeleteResourceConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteResourceConfigurationRequestT = Model::DeleteResourceConfigurationRequest>
  void DeleteResourceConfigurationAsync(const DeleteResourceConfigurationRequestT& request,
                                        const DeleteResourceConfigurationResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::DeleteResourceEndpointAssociationOutcome DeleteResourceEndpointAssociation(
      const Model::DeleteResourceEndpointAssociationRequest& request) const;

  /**
   * A Callable wrapper for DeleteResourceEndpointAssociation that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DeleteResourceEndpointAssociationRequestT = Model::DeleteResourceEndpointAssociationRequest>
  Model::DeleteResourceEndpointAssociationOutcomeCallable DeleteResourceEndpointAssociationCallable(
      const DeleteResourceEndpointAssociationRequestT& request) const {
    return SubmitCallable(&VPCLatticeClient::DeleteResourceEndpointAssociation, request);
  }

  /**
   * An Async wrapper for DeleteResourceEndpointAssociation that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteResourceEndpointAssociationRequestT = Model::DeleteResourceEndpointAssociationRequest>
  void DeleteResourceEndpointAssociationAsync(const DeleteResourceEndpointAssociationRequestT& request,
                                              const DeleteResourceEndpointAssociationResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteResourceGateway that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteResourceGateway that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteResourceGatewayRequestT = Model::DeleteResourceGatewayRequest>
  void DeleteResourceGatewayAsync(const DeleteResourceGatewayRequestT& request, const DeleteResourceGatewayResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteServiceNetwork that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteServiceNetwork that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteServiceNetworkRequestT = Model::DeleteServiceNetworkRequest>
  void DeleteServiceNetworkAsync(const DeleteServiceNetworkRequestT& request, const DeleteServiceNetworkResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteServiceNetworkResourceAssociationOutcome DeleteServiceNetworkResourceAssociation(
      const Model::DeleteServiceNetworkResourceAssociationRequest& request) const;

  /**
   * A Callable wrapper for DeleteServiceNetworkResourceAssociation that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DeleteServiceNetworkResourceAssociationRequestT = Model::DeleteServiceNetworkResourceAssociationRequest>
  Model::DeleteServiceNetworkResourceAssociationOutcomeCallable DeleteServiceNetworkResourceAssociationCallable(
      const DeleteServiceNetworkResourceAssociationRequestT& request) const {
    return SubmitCallable(&VPCLatticeClient::DeleteServiceNetworkResourceAssociation, request);
  }

  /**
   * An Async wrapper for DeleteServiceNetworkResourceAssociation that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DeleteServiceNetworkResourceAssociationRequestT = Model::DeleteServiceNetworkResourceAssociationRequest>
  void DeleteServiceNetworkResourceAssociationAsync(const DeleteServiceNetworkResourceAssociationRequestT& request,
                                                    const DeleteServiceNetworkResourceAssociationResponseReceivedHandler& handler,
                                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteServiceNetworkServiceAssociationOutcome DeleteServiceNetworkServiceAssociation(
      const Model::DeleteServiceNetworkServiceAssociationRequest& request) const;

  /**
   * A Callable wrapper for DeleteServiceNetworkServiceAssociation that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DeleteServiceNetworkServiceAssociationRequestT = Model::DeleteServiceNetworkServiceAssociationRequest>
  Model::DeleteServiceNetworkServiceAssociationOutcomeCallable DeleteServiceNetworkServiceAssociationCallable(
      const DeleteServiceNetworkServiceAssociationRequestT& request) const {
    return SubmitCallable(&VPCLatticeClient::DeleteServiceNetworkServiceAssociation, request);
  }

  /**
   * An Async wrapper for DeleteServiceNetworkServiceAssociation that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DeleteServiceNetworkServiceAssociationRequestT = Model::DeleteServiceNetworkServiceAssociationRequest>
  void DeleteServiceNetworkServiceAssociationAsync(const DeleteServiceNetworkServiceAssociationRequestT& request,
                                                   const DeleteServiceNetworkServiceAssociationResponseReceivedHandler& handler,
                                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteServiceNetworkVpcAssociationOutcome DeleteServiceNetworkVpcAssociation(
      const Model::DeleteServiceNetworkVpcAssociationRequest& request) const;

  /**
   * A Callable wrapper for DeleteServiceNetworkVpcAssociation that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DeleteServiceNetworkVpcAssociationRequestT = Model::DeleteServiceNetworkVpcAssociationRequest>
  Model::DeleteServiceNetworkVpcAssociationOutcomeCallable DeleteServiceNetworkVpcAssociationCallable(
      const DeleteServiceNetworkVpcAssociationRequestT& request) const {
    return SubmitCallable(&VPCLatticeClient::DeleteServiceNetworkVpcAssociation, request);
  }

  /**
   * An Async wrapper for DeleteServiceNetworkVpcAssociation that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteServiceNetworkVpcAssociationRequestT = Model::DeleteServiceNetworkVpcAssociationRequest>
  void DeleteServiceNetworkVpcAssociationAsync(const DeleteServiceNetworkVpcAssociationRequestT& request,
                                               const DeleteServiceNetworkVpcAssociationResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteTargetGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteTargetGroup that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteTargetGroupRequestT = Model::DeleteTargetGroupRequest>
  void DeleteTargetGroupAsync(const DeleteTargetGroupRequestT& request, const DeleteTargetGroupResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeregisterTargets that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeregisterTargets that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeregisterTargetsRequestT = Model::DeregisterTargetsRequest>
  void DeregisterTargetsAsync(const DeregisterTargetsRequestT& request, const DeregisterTargetsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetAccessLogSubscription that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetAccessLogSubscription that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetAccessLogSubscriptionRequestT = Model::GetAccessLogSubscriptionRequest>
  void GetAccessLogSubscriptionAsync(const GetAccessLogSubscriptionRequestT& request,
                                     const GetAccessLogSubscriptionResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetAuthPolicy that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetAuthPolicyRequestT = Model::GetAuthPolicyRequest>
  void GetAuthPolicyAsync(const GetAuthPolicyRequestT& request, const GetAuthPolicyResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetListener that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetListenerRequestT = Model::GetListenerRequest>
  void GetListenerAsync(const GetListenerRequestT& request, const GetListenerResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetResourceConfiguration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetResourceConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetResourceConfigurationRequestT = Model::GetResourceConfigurationRequest>
  void GetResourceConfigurationAsync(const GetResourceConfigurationRequestT& request,
                                     const GetResourceConfigurationResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetResourceGateway that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetResourceGateway that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetResourceGatewayRequestT = Model::GetResourceGatewayRequest>
  void GetResourceGatewayAsync(const GetResourceGatewayRequestT& request, const GetResourceGatewayResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetServiceNetwork that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetServiceNetwork that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetServiceNetworkRequestT = Model::GetServiceNetworkRequest>
  void GetServiceNetworkAsync(const GetServiceNetworkRequestT& request, const GetServiceNetworkResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetServiceNetworkResourceAssociationOutcome GetServiceNetworkResourceAssociation(
      const Model::GetServiceNetworkResourceAssociationRequest& request) const;

  /**
   * A Callable wrapper for GetServiceNetworkResourceAssociation that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename GetServiceNetworkResourceAssociationRequestT = Model::GetServiceNetworkResourceAssociationRequest>
  Model::GetServiceNetworkResourceAssociationOutcomeCallable GetServiceNetworkResourceAssociationCallable(
      const GetServiceNetworkResourceAssociationRequestT& request) const {
    return SubmitCallable(&VPCLatticeClient::GetServiceNetworkResourceAssociation, request);
  }

  /**
   * An Async wrapper for GetServiceNetworkResourceAssociation that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetServiceNetworkResourceAssociationRequestT = Model::GetServiceNetworkResourceAssociationRequest>
  void GetServiceNetworkResourceAssociationAsync(const GetServiceNetworkResourceAssociationRequestT& request,
                                                 const GetServiceNetworkResourceAssociationResponseReceivedHandler& handler,
                                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetServiceNetworkServiceAssociationOutcome GetServiceNetworkServiceAssociation(
      const Model::GetServiceNetworkServiceAssociationRequest& request) const;

  /**
   * A Callable wrapper for GetServiceNetworkServiceAssociation that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename GetServiceNetworkServiceAssociationRequestT = Model::GetServiceNetworkServiceAssociationRequest>
  Model::GetServiceNetworkServiceAssociationOutcomeCallable GetServiceNetworkServiceAssociationCallable(
      const GetServiceNetworkServiceAssociationRequestT& request) const {
    return SubmitCallable(&VPCLatticeClient::GetServiceNetworkServiceAssociation, request);
  }

  /**
   * An Async wrapper for GetServiceNetworkServiceAssociation that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetServiceNetworkServiceAssociationRequestT = Model::GetServiceNetworkServiceAssociationRequest>
  void GetServiceNetworkServiceAssociationAsync(const GetServiceNetworkServiceAssociationRequestT& request,
                                                const GetServiceNetworkServiceAssociationResponseReceivedHandler& handler,
                                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetServiceNetworkVpcAssociationOutcome GetServiceNetworkVpcAssociation(
      const Model::GetServiceNetworkVpcAssociationRequest& request) const;

  /**
   * A Callable wrapper for GetServiceNetworkVpcAssociation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetServiceNetworkVpcAssociationRequestT = Model::GetServiceNetworkVpcAssociationRequest>
  Model::GetServiceNetworkVpcAssociationOutcomeCallable GetServiceNetworkVpcAssociationCallable(
      const GetServiceNetworkVpcAssociationRequestT& request) const {
    return SubmitCallable(&VPCLatticeClient::GetServiceNetworkVpcAssociation, request);
  }

  /**
   * An Async wrapper for GetServiceNetworkVpcAssociation that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetServiceNetworkVpcAssociationRequestT = Model::GetServiceNetworkVpcAssociationRequest>
  void GetServiceNetworkVpcAssociationAsync(const GetServiceNetworkVpcAssociationRequestT& request,
                                            const GetServiceNetworkVpcAssociationResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetTargetGroup that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetTargetGroupRequestT = Model::GetTargetGroupRequest>
  void GetTargetGroupAsync(const GetTargetGroupRequestT& request, const GetTargetGroupResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListAccessLogSubscriptionsOutcome ListAccessLogSubscriptions(
      const Model::ListAccessLogSubscriptionsRequest& request) const;

  /**
   * A Callable wrapper for ListAccessLogSubscriptions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListAccessLogSubscriptionsRequestT = Model::ListAccessLogSubscriptionsRequest>
  Model::ListAccessLogSubscriptionsOutcomeCallable ListAccessLogSubscriptionsCallable(
      const ListAccessLogSubscriptionsRequestT& request) const {
    return SubmitCallable(&VPCLatticeClient::ListAccessLogSubscriptions, request);
  }

  /**
   * An Async wrapper for ListAccessLogSubscriptions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAccessLogSubscriptionsRequestT = Model::ListAccessLogSubscriptionsRequest>
  void ListAccessLogSubscriptionsAsync(const ListAccessLogSubscriptionsRequestT& request,
  ...
  /**
   * An Async wrapper for ListListeners that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListListenersRequestT = Model::ListListenersRequest>
  void ListListenersAsync(const ListListenersRequestT& request, const ListListenersResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListResourceConfigurationsOutcome ListResourceConfigurations(
      const Model::ListResourceConfigurationsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListResourceConfigurations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListResourceConfigurationsRequestT = Model::ListResourceConfigurationsRequest>
  Model::ListResourceConfigurationsOutcomeCallable ListResourceConfigurationsCallable(
      const ListResourceConfigurationsRequestT& request = {}) const {
    return SubmitCallable(&VPCLatticeClient::ListResourceConfigurations, request);
  }

  /**
   * An Async wrapper for ListResourceConfigurations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListResourceConfigurationsRequestT = Model::ListResourceConfigurationsRequest>
  void ListResourceConfigurationsAsync(const ListResourceConfigurationsResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const ListResourceConfigurationsRequestT& request = {}) const {
  ...
  virtual Model::ListResourceEndpointAssociationsOutcome ListResourceEndpointAssociations(
      const Model::ListResourceEndpointAssociationsRequest& request) const;

  /**
   * A Callable wrapper for ListResourceEndpointAssociations that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListResourceEndpointAssociationsRequestT = Model::ListResourceEndpointAssociationsRequest>
  Model::ListResourceEndpointAssociationsOutcomeCallable ListResourceEndpointAssociationsCallable(
      const ListResourceEndpointAssociationsRequestT& request) const {
    return SubmitCallable(&VPCLatticeClient::ListResourceEndpointAssociations, request);
  }

  /**
   * An Async wrapper for ListResourceEndpointAssociations that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListResourceEndpointAssociationsRequestT = Model::ListResourceEndpointAssociationsRequest>
  void ListResourceEndpointAssociationsAsync(const ListResourceEndpointAssociationsRequestT& request,
                                             const ListResourceEndpointAssociationsResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListResourceGateways that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListResourceGateways that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListResourceGatewaysRequestT = Model::ListResourceGatewaysRequest>
  void ListResourceGatewaysAsync(const ListResourceGatewaysResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const ListResourceGatewaysRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListServiceNetworkResourceAssociationsOutcome ListServiceNetworkResourceAssociations(
      const Model::ListServiceNetworkResourceAssociationsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListServiceNetworkResourceAssociations that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListServiceNetworkResourceAssociationsRequestT = Model::ListServiceNetworkResourceAssociationsRequest>
  Model::ListServiceNetworkResourceAssociationsOutcomeCallable ListServiceNetworkResourceAssociationsCallable(
      const ListServiceNetworkResourceAssociationsRequestT& request = {}) const {
    return SubmitCallable(&VPCLatticeClient::ListServiceNetworkResourceAssociations, request);
  }

  /**
   * An Async wrapper for ListServiceNetworkResourceAssociations that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListServiceNetworkResourceAssociationsRequestT = Model::ListServiceNetworkResourceAssociationsRequest>
  void ListServiceNetworkResourceAssociationsAsync(const ListServiceNetworkResourceAssociationsResponseReceivedHandler& handler,
                                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                   const ListServiceNetworkResourceAssociationsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListServiceNetworkServiceAssociationsOutcome ListServiceNetworkServiceAssociations(
      const Model::ListServiceNetworkServiceAssociationsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListServiceNetworkServiceAssociations that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListServiceNetworkServiceAssociationsRequestT = Model::ListServiceNetworkServiceAssociationsRequest>
  Model::ListServiceNetworkServiceAssociationsOutcomeCallable ListServiceNetworkServiceAssociationsCallable(
      const ListServiceNetworkServiceAssociationsRequestT& request = {}) const {
    return SubmitCallable(&VPCLatticeClient::ListServiceNetworkServiceAssociations, request);
  }

  /**
   * An Async wrapper for ListServiceNetworkServiceAssociations that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListServiceNetworkServiceAssociationsRequestT = Model::ListServiceNetworkServiceAssociationsRequest>
  void ListServiceNetworkServiceAssociationsAsync(const ListServiceNetworkServiceAssociationsResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                  const ListServiceNetworkServiceAssociationsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListServiceNetworkVpcAssociationsOutcome ListServiceNetworkVpcAssociations(
      const Model::ListServiceNetworkVpcAssociationsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListServiceNetworkVpcAssociations that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListServiceNetworkVpcAssociationsRequestT = Model::ListServiceNetworkVpcAssociationsRequest>
  Model::ListServiceNetworkVpcAssociationsOutcomeCallable ListServiceNetworkVpcAssociationsCallable(
      const ListServiceNetworkVpcAssociationsRequestT& request = {}) const {
    return SubmitCallable(&VPCLatticeClient::ListServiceNetworkVpcAssociations, request);
  }

  /**
   * An Async wrapper for ListServiceNetworkVpcAssociations that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListServiceNetworkVpcAssociationsRequestT = Model::ListServiceNetworkVpcAssociationsRequest>
  void ListServiceNetworkVpcAssociationsAsync(const ListServiceNetworkVpcAssociationsResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                              const ListServiceNetworkVpcAssociationsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListServiceNetworkVpcEndpointAssociationsOutcome ListServiceNetworkVpcEndpointAssociations(
      const Model::ListServiceNetworkVpcEndpointAssociationsRequest& request) const;

  /**
   * A Callable wrapper for ListServiceNetworkVpcEndpointAssociations that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  ...
  Model::ListServiceNetworkVpcEndpointAssociationsOutcomeCallable ListServiceNetworkVpcEndpointAssociationsCallable(
      const ListServiceNetworkVpcEndpointAssociationsRequestT& request) const {
    return SubmitCallable(&VPCLatticeClient::ListServiceNetworkVpcEndpointAssociations, request);
  }

  /**
   * An Async wrapper for ListServiceNetworkVpcEndpointAssociations that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListServiceNetworkVpcEndpointAssociationsRequestT = Model::ListServiceNetworkVpcEndpointAssociationsRequest>
  void ListServiceNetworkVpcEndpointAssociationsAsync(
      const ListServiceNetworkVpcEndpointAssociationsRequestT& request,
      const ListServiceNetworkVpcEndpointAssociationsResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListServiceNetworks that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListServiceNetworks that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListServiceNetworksRequestT = Model::ListServiceNetworksRequest>
  void ListServiceNetworksAsync(const ListServiceNetworksResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const ListServiceNetworksRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListTargetGroups that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListTargetGroups that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListTargetGroupsRequestT = Model::ListTargetGroupsRequest>
  void ListTargetGroupsAsync(const ListTargetGroupsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const ListTargetGroupsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListTargets that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListTargetsRequestT = Model::ListTargetsRequest>
  void ListTargetsAsync(const ListTargetsRequestT& request, const ListTargetsResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for PutAuthPolicy that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutAuthPolicyRequestT = Model::PutAuthPolicyRequest>
  void PutAuthPolicyAsync(const PutAuthPolicyRequestT& request, const PutAuthPolicyResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for RegisterTargets that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename RegisterTargetsRequestT = Model::RegisterTargetsRequest>
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateAccessLogSubscriptionOutcome UpdateAccessLogSubscription(
      const Model::UpdateAccessLogSubscriptionRequest& request) const;

  /**
   * A Callable wrapper for UpdateAccessLogSubscription that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateAccessLogSubscriptionRequestT = Model::UpdateAccessLogSubscriptionRequest>
  Model::UpdateAccessLogSubscriptionOutcomeCallable UpdateAccessLogSubscriptionCallable(
      const UpdateAccessLogSubscriptionRequestT& request) const {
    return SubmitCallable(&VPCLatticeClient::UpdateAccessLogSubscription, request);
  }

  /**
   * An Async wrapper for UpdateAccessLogSubscription that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateAccessLogSubscriptionRequestT = Model::UpdateAccessLogSubscriptionRequest>
  void UpdateAccessLogSubscriptionAsync(const UpdateAccessLogSubscriptionRequestT& request,
                                        const UpdateAccessLogSubscriptionResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateListener that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateListenerRequestT = Model::UpdateListenerRequest>
  void UpdateListenerAsync(const UpdateListenerRequestT& request, const UpdateListenerResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateResourceConfigurationOutcome UpdateResourceConfiguration(
      const Model::UpdateResourceConfigurationRequest& request) const;

  /**
   * A Callable wrapper for UpdateResourceConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateResourceConfigurationRequestT = Model::UpdateResourceConfigurationRequest>
  Model::UpdateResourceConfigurationOutcomeCallable UpdateResourceConfigurationCallable(
      const UpdateResourceConfigurationRequestT& request) const {
    return SubmitCallable(&VPCLatticeClient::UpdateResourceConfiguration, request);
  }

  /**
   * An Async wrapper for UpdateResourceConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateResourceConfigurationRequestT = Model::UpdateResourceConfigurationRequest>
  void UpdateResourceConfigurationAsync(const UpdateResourceConfigurationRequestT& request,
                                        const UpdateResourceConfigurationResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateResourceGateway that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateResourceGateway that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateResourceGatewayRequestT = Model::UpdateResourceGatewayRequest>
  void UpdateResourceGatewayAsync(const UpdateResourceGatewayRequestT& request, const UpdateResourceGatewayResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateServiceNetwork that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateServiceNetwork that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateServiceNetworkRequestT = Model::UpdateServiceNetworkRequest>
  void UpdateServiceNetworkAsync(const UpdateServiceNetworkRequestT& request, const UpdateServiceNetworkResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateServiceNetworkVpcAssociationOutcome UpdateServiceNetworkVpcAssociation(
      const Model::UpdateServiceNetworkVpcAssociationRequest& request) const;

  /**
   * A Callable wrapper for UpdateServiceNetworkVpcAssociation that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename UpdateServiceNetworkVpcAssociationRequestT = Model::UpdateServiceNetworkVpcAssociationRequest>
  Model::UpdateServiceNetworkVpcAssociationOutcomeCallable UpdateServiceNetworkVpcAssociationCallable(
      const UpdateServiceNetworkVpcAssociationRequestT& request) const {
    return SubmitCallable(&VPCLatticeClient::UpdateServiceNetworkVpcAssociation, request);
  }

  /**
   * An Async wrapper for UpdateServiceNetworkVpcAssociation that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateServiceNetworkVpcAssociationRequestT = Model::UpdateServiceNetworkVpcAssociationRequest>
  void UpdateServiceNetworkVpcAssociationAsync(const UpdateServiceNetworkVpcAssociationRequestT& request,
                                               const UpdateServiceNetworkVpcAssociationResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateTargetGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateTargetGroup that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateTargetGroupRequestT = Model::UpdateTargetGroupRequest>
  void UpdateTargetGroupAsync(const UpdateTargetGroupRequestT& request, const UpdateTargetGroupResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
