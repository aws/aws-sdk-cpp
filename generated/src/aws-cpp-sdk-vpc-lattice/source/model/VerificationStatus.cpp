...
static const int VERIFICATION_TIMED_OUT_HASH = HashingUtils::HashString("VERIFICATION_TIMED_OUT");
...
VerificationStatus GetVerificationStatusForName(const Aws::String& name) {
  ...
  } else if (hashCode == VERIFICATION_TIMED_OUT_HASH) {
    return VerificationStatus::VERIFICATION_TIMED_OUT;
  }
...
Aws::String GetNameForVerificationStatus(VerificationStatus enumValue) {
  switch (enumValue) {
    ...
    case VerificationStatus::PENDING:
      return "PENDING";
    case VerificationStatus::VERIFICATION_TIMED_OUT:
