...
DeleteResourceGatewayResult::DeleteResourceGatewayResult() : 
    m_status(ResourceGatewayStatus::NOT_SET)
{
}

DeleteResourceGatewayResult::DeleteResourceGatewayResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
