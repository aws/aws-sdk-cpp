...
ServiceNetworkResourceAssociationSummary::ServiceNetworkResourceAssociationSummary(JsonView jsonValue) { *this = jsonValue; }
...
JsonValue ServiceNetworkResourceAssociationSummary::Jsonize() const {
  ...
  if (m_statusHasBeenSet) {
    payload.WithString("status",
                       ServiceNetworkResourceAssociationStatusMapper::GetNameForServiceNetworkResourceAssociationStatus(m_status));
  }
