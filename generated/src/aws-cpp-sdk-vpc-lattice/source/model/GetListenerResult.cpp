...
GetListenerResult::GetListenerResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

GetListenerResult& GetListenerResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
