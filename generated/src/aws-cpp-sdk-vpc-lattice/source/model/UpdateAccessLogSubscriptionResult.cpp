...
UpdateAccessLogSubscriptionResult::UpdateAccessLogSubscriptionResult()
{
}

UpdateAccessLogSubscriptionResult::UpdateAccessLogSubscriptionResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
