...
StartDomainVerificationResult::StartDomainVerificationResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

StartDomainVerificationResult& StartDomainVerificationResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
