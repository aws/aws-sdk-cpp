...
class StartLiveTailResponseStream {
 public:
  ...
  void SetSessionStart(SessionStartT&& value) {
    m_sessionStartHasBeenSet = true;
    m_sessionStart = std::forward<SessionStartT>(value);
  }
  template <typename SessionStartT = LiveTailSessionStart>
  StartLiveTailResponseStream& WithSessionStart(SessionStartT&& value) {
    SetSessionStart(std::forward<SessionStartT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSessionUpdate(SessionUpdateT&& value) {
    m_sessionUpdateHasBeenSet = true;
    m_sessionUpdate = std::forward<SessionUpdateT>(value);
  }
  template <typename SessionUpdateT = LiveTailSessionUpdate>
  StartLiveTailResponseStream& WithSessionUpdate(SessionUpdateT&& value) {
    SetSessionUpdate(std::forward<SessionUpdateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSessionTimeoutException(SessionTimeoutExceptionT&& value) {
    m_sessionTimeoutExceptionHasBeenSet = true;
    m_sessionTimeoutException = std::forward<SessionTimeoutExceptionT>(value);
  }
  template <typename SessionTimeoutExceptionT = CloudWatchLogsError>
  StartLiveTailResponseStream& WithSessionTimeoutException(SessionTimeoutExceptionT&& value) {
    SetSessionTimeoutException(std::forward<SessionTimeoutExceptionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSessionStreamingException(SessionStreamingExceptionT&& value) {
    m_sessionStreamingExceptionHasBeenSet = true;
    m_sessionStreamingException = std::forward<SessionStreamingExceptionT>(value);
  }
  template <typename SessionStreamingExceptionT = CloudWatchLogsError>
  StartLiveTailResponseStream& WithSessionStreamingException(SessionStreamingExceptionT&& value) {
    SetSessionStreamingException(std::forward<SessionStreamingExceptionT>(value));
    return *this;
  }
  ///@}
 private:
