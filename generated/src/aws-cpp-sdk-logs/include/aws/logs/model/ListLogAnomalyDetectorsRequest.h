...
class ListLogAnomalyDetectorsRequest : public CloudWatchLogsRequest {
 public:
  ...
  void SetFilterLogGroupArn(FilterLogGroupArnT&& value) {
    m_filterLogGroupArnHasBeenSet = true;
    m_filterLogGroupArn = std::forward<FilterLogGroupArnT>(value);
  }
  template <typename FilterLogGroupArnT = Aws::String>
  ListLogAnomalyDetectorsRequest& WithFilterLogGroupArn(FilterLogGroupArnT&& value) {
    SetFilterLogGroupArn(std::forward<FilterLogGroupArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListLogAnomalyDetectorsRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListLogAnomalyDetectorsRequest& WithNextToken(NextTokenT&& value) {
