...
namespace Model
{
  ...
  public:
    ...
    void SetExportTasks(ExportTasksT&& value) { m_exportTasks = std::forward<ExportTasksT>(value); }
    template<typename ExportTasksT = Aws::Vector<ExportTask>>
    ...
    DescribeExportTasksResult& AddExportTasks(ExportTasksT&& value) { m_exportTasks.emplace_back(std::forward<ExportTasksT>(value)); return *this; }
    ///@}
