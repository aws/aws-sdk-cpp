...
namespace Model
{
  ...
  public:
    ...
    void SetConfigurationTemplates(ConfigurationTemplatesT&& value) { m_configurationTemplates = std::forward<ConfigurationTemplatesT>(value); }
    template<typename ConfigurationTemplatesT = Aws::Vector<ConfigurationTemplate>>
    ...
    DescribeConfigurationTemplatesResult& AddConfigurationTemplates(ConfigurationTemplatesT&& value) { m_configurationTemplates.emplace_back(std::forward<ConfigurationTemplatesT>(value)); return *this; }
    ///@}
