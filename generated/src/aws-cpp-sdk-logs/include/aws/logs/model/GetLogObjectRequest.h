...
class GetLogObjectRequest : public CloudWatchLogsRequest {
 public:
   ...
   * Underlying Event Stream Handler which is used to define callback functions.
   */
  inline void SetEventStreamHandler(const GetLogObjectHandler& value) {
    m_handler = value;
   ...
   * Underlying Event Stream Handler which is used to define callback functions.
   */
  inline GetLogObjectRequest& WithEventStreamHandler(const GetLogObjectHandler& value) {
  ...
  inline GetLogObjectRequest& WithUnmask(bool value) {
    SetUnmask(value);
    return *this;
  }
  ///@}
  ...
  void SetLogObjectPointer(LogObjectPointerT&& value) {
    m_logObjectPointerHasBeenSet = true;
    m_logObjectPointer = std::forward<LogObjectPointerT>(value);
  }
  template <typename LogObjectPointerT = Aws::String>
  GetLogObjectRequest& WithLogObjectPointer(LogObjectPointerT&& value) {
    SetLogObjectPointer(std::forward<LogObjectPointerT>(value));
    return *this;
  }
  ///@}
 private:
