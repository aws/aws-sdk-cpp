...
/**
 */
class DeleteLogGroupRequest : public CloudWatchLogsRequest {
 public:
  AWS_CLOUDWATCHLOGS_API DeleteLogGroupRequest() = default;
  ...
  template <typename LogGroupNameT = Aws::String>
  DeleteLogGroupRequest& WithLogGroupName(LogGroupNameT&& value) {
