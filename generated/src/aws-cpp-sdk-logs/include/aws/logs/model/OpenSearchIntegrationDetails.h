...
class OpenSearchIntegrationDetails {
 public:
  ...
  void SetCollection(CollectionT&& value) {
    ...
    m_collection = std::forward<CollectionT>(value);
  }
  template <typename CollectionT = OpenSearchCollection>
  OpenSearchIntegrationDetails& WithCollection(CollectionT&& value) {
    SetCollection(std::forward<CollectionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEncryptionPolicy(EncryptionPolicyT&& value) {
    ...
    m_encryptionPolicy = std::forward<EncryptionPolicyT>(value);
  }
  template <typename EncryptionPolicyT = OpenSearchEncryptionPolicy>
  OpenSearchIntegrationDetails& WithEncryptionPolicy(EncryptionPolicyT&& value) {
    SetEncryptionPolicy(std::forward<EncryptionPolicyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNetworkPolicy(NetworkPolicyT&& value) {
    ...
    m_networkPolicy = std::forward<NetworkPolicyT>(value);
  }
  template <typename NetworkPolicyT = OpenSearchNetworkPolicy>
  OpenSearchIntegrationDetails& WithNetworkPolicy(NetworkPolicyT&& value) {
    SetNetworkPolicy(std::forward<NetworkPolicyT>(value));
    return *this;
  }
  ///@}
