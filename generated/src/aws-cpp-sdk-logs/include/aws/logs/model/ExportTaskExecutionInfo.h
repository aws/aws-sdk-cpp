...
class ExportTaskExecutionInfo {
 public:
  ...
  inline ExportTaskExecutionInfo& WithCreationTime(long long value) {
  ...
  inline void SetCompletionTime(long long value) {
    m_completionTimeHasBeenSet = true;
    m_completionTime = value;
  }
  inline ExportTaskExecutionInfo& WithCompletionTime(long long value) {
