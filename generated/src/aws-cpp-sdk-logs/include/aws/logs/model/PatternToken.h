...
class PatternToken {
 public:
  ...
  inline void SetDynamicTokenPosition(int value) {
    m_dynamicTokenPositionHasBeenSet = true;
    m_dynamicTokenPosition = value;
  }
  inline PatternToken& WithDynamicTokenPosition(int value) {
    SetDynamicTokenPosition(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIsDynamic(bool value) {
    m_isDynamicHasBeenSet = true;
    m_isDynamic = value;
  }
  inline PatternToken& WithIsDynamic(bool value) {
    SetIsDynamic(value);
    return *this;
  }
  ///@}
  ...
  void SetTokenString(TokenStringT&& value) {
    ...
    m_tokenString = std::forward<TokenStringT>(value);
  }
  template <typename TokenStringT = Aws::String>
  PatternToken& WithTokenString(TokenStringT&& value) {
    SetTokenString(std::forward<TokenStringT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEnumerations(EnumerationsT&& value) {
    ...
    m_enumerations = std::forward<EnumerationsT>(value);
  }
  template <typename EnumerationsT = Aws::Map<Aws::String, long long>>
  PatternToken& WithEnumerations(EnumerationsT&& value) {
    SetEnumerations(std::forward<EnumerationsT>(value));
    return *this;
  }
  inline PatternToken& AddEnumerations(Aws::String key, long long value) {
    m_enumerationsHasBeenSet = true;
    m_enumerations.emplace(key, value);
    return *this;
  }
  ///@}
  ...
  void SetInferredTokenName(InferredTokenNameT&& value) {
    ...
    m_inferredTokenName = std::forward<InferredTokenNameT>(value);
  }
  template <typename InferredTokenNameT = Aws::String>
  PatternToken& WithInferredTokenName(InferredTokenNameT&& value) {
    SetInferredTokenName(std::forward<InferredTokenNameT>(value));
    return *this;
  }
  ///@}
 private:
