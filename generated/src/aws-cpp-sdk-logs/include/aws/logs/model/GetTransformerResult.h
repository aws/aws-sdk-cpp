...
namespace Model
{
  ...
  public:
    ...
    void SetLogGroupIdentifier(LogGroupIdentifierT&& value) { m_logGroupIdentifier = std::forward<LogGroupIdentifierT>(value); }
    template<typename LogGroupIdentifierT = Aws::String>
    ...
    void SetTransformerConfig(TransformerConfigT&& value) { m_transformerConfig = std::forward<TransformerConfigT>(value); }
    template<typename TransformerConfigT = Aws::Vector<Processor>>
    ...
    GetTransformerResult& AddTransformerConfig(TransformerConfigT&& value) { m_transformerConfig.emplace_back(std::forward<TransformerConfigT>(value)); return *this; }
    ///@}
