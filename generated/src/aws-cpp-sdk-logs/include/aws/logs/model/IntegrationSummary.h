...
class IntegrationSummary {
 public:
  ...
  template <typename IntegrationNameT = Aws::String>
  IntegrationSummary& WithIntegrationName(IntegrationNameT&& value) {
  ...
  inline IntegrationSummary& WithIntegrationType(IntegrationType value) {
  ...
  inline IntegrationSummary& WithIntegrationStatus(IntegrationStatus value) {
