...
class DeleteQueryDefinitionResult {
 public:
  AWS_CLOUDWATCHLOGS_API DeleteQueryDefinitionResult() = default;
  ...
  inline DeleteQueryDefinitionResult& WithSuccess(bool value) {
    SetSuccess(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DeleteQueryDefinitionResult& WithRequestId(RequestIdT&& value) {
