...
namespace Model
{
  ...
  public:
    ...
    template<typename LogGroupIdentifierT = Aws::String>
    PutDataProtectionPolicyResult& WithLogGroupIdentifier(LogGroupIdentifierT&& value) { SetLogGroupIdentifier(std::forward<LogGroupIdentifierT>(value)); return *this;}
    ///@}
    ...
    void SetPolicyDocument(PolicyDocumentT&& value) { m_policyDocument = std::forward<PolicyDocumentT>(value); }
    template<typename PolicyDocumentT = Aws::String>
    PutDataProtectionPolicyResult& WithPolicyDocument(PolicyDocumentT&& value) { SetPolicyDocument(std::forward<PolicyDocumentT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    PutDataProtectionPolicyResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
