...
namespace Model
{
  ...
  public:
    ...
    void SetNextSequenceToken(NextSequenceTokenT&& value) { m_nextSequenceToken = std::forward<NextSequenceTokenT>(value); }
    template<typename NextSequenceTokenT = Aws::String>
    ...
    void SetRejectedLogEventsInfo(RejectedLogEventsInfoT&& value) { m_rejectedLogEventsInfo = std::forward<RejectedLogEventsInfoT>(value); }
    template<typename RejectedLogEventsInfoT = RejectedLogEventsInfo>
    ...
    void SetRejectedEntityInfo(RejectedEntityInfoT&& value) { m_rejectedEntityInfo = std::forward<RejectedEntityInfoT>(value); }
    template<typename RejectedEntityInfoT = RejectedEntityInfo>
