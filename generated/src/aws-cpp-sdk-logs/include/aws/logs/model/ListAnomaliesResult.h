...
namespace Model
{
  ...
  public:
    ...
    void SetAnomalies(AnomaliesT&& value) { m_anomalies = std::forward<AnomaliesT>(value); }
    template<typename AnomaliesT = Aws::Vector<Anomaly>>
    ...
    ListAnomaliesResult& AddAnomalies(AnomaliesT&& value) { m_anomalies.emplace_back(std::forward<AnomaliesT>(value)); return *this; }
    ///@}
