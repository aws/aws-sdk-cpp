...
namespace Model
{
  ...
  public:
    ...
    void SetQueries(QueriesT&& value) { m_queries = std::forward<QueriesT>(value); }
    template<typename QueriesT = Aws::Vector<QueryInfo>>
    ...
    DescribeQueriesResult& AddQueries(QueriesT&& value) { m_queries.emplace_back(std::forward<QueriesT>(value)); return *this; }
    ///@}
