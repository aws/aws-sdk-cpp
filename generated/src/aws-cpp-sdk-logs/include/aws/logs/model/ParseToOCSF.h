...
class ParseToOCSF {
 public:
  ...
  inline ParseToOCSF& WithEventSource(EventSource value) {
  ...
  inline void SetOcsfVersion(OCSFVersion value) {
    m_ocsfVersionHasBeenSet = true;
    m_ocsfVersion = value;
  }
  inline ParseToOCSF& WithOcsfVersion(OCSFVersion value) {
    SetOcsfVersion(value);
    return *this;
  }
  ///@}
