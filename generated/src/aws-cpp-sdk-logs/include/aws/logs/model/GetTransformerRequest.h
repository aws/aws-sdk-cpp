...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDWATCHLOGS_API GetTransformerRequest() = default;
    ...
    template<typename LogGroupIdentifierT = Aws::String>
    GetTransformerRequest& WithLogGroupIdentifier(LogGroupIdentifierT&& value) { SetLogGroupIdentifier(std::forward<LogGroupIdentifierT>(value)); return *this;}
    ///@}
  private:
