...
class ListLogGroupsForQueryRequest : public CloudWatchLogsRequest {
 public:
  AWS_CLOUDWATCHLOGS_API ListLogGroupsForQueryRequest() = default;
  ...
  template <typename QueryIdT = Aws::String>
  ListLogGroupsForQueryRequest& WithQueryId(QueryIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListLogGroupsForQueryRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListLogGroupsForQueryRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
