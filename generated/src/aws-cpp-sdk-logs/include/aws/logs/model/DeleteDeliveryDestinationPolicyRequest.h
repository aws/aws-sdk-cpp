...
class DeleteDeliveryDestinationPolicyRequest : public CloudWatchLogsRequest {
 public:
  ...
  void SetDeliveryDestinationName(DeliveryDestinationNameT&& value) {
    m_deliveryDestinationNameHasBeenSet = true;
    m_deliveryDestinationName = std::forward<DeliveryDestinationNameT>(value);
  }
  template <typename DeliveryDestinationNameT = Aws::String>
  DeleteDeliveryDestinationPolicyRequest& WithDeliveryDestinationName(DeliveryDestinationNameT&& value) {
    SetDeliveryDestinationName(std::forward<DeliveryDestinationNameT>(value));
    return *this;
  }
  ///@}
 private:
