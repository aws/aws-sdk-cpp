...
class TransformedLogRecord {
 public:
  ...
  inline void SetEventNumber(long long value) {
    m_eventNumberHasBeenSet = true;
    m_eventNumber = value;
  }
  inline TransformedLogRecord& WithEventNumber(long long value) {
  ...
  void SetEventMessage(EventMessageT&& value) {
    m_eventMessageHasBeenSet = true;
    m_eventMessage = std::forward<EventMessageT>(value);
  }
  template <typename EventMessageT = Aws::String>
  TransformedLogRecord& WithEventMessage(EventMessageT&& value) {
    SetEventMessage(std::forward<EventMessageT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTransformedEventMessage(TransformedEventMessageT&& value) {
    m_transformedEventMessageHasBeenSet = true;
    m_transformedEventMessage = std::forward<TransformedEventMessageT>(value);
  }
  template <typename TransformedEventMessageT = Aws::String>
  TransformedLogRecord& WithTransformedEventMessage(TransformedEventMessageT&& value) {
    SetTransformedEventMessage(std::forward<TransformedEventMessageT>(value));
    return *this;
  }
  ///@}
 private:
