...
class PutSubscriptionFilterRequest : public CloudWatchLogsRequest {
 public:
  ...
  template <typename LogGroupNameT = Aws::String>
  PutSubscriptionFilterRequest& WithLogGroupName(LogGroupNameT&& value) {
  ...
  template <typename FilterNameT = Aws::String>
  PutSubscriptionFilterRequest& WithFilterName(FilterNameT&& value) {
  ...
  template <typename FilterPatternT = Aws::String>
  PutSubscriptionFilterRequest& WithFilterPattern(FilterPatternT&& value) {
  ...
  template <typename DestinationArnT = Aws::String>
  PutSubscriptionFilterRequest& WithDestinationArn(DestinationArnT&& value) {
  ...
  template <typename RoleArnT = Aws::String>
  PutSubscriptionFilterRequest& WithRoleArn(RoleArnT&& value) {
  ...
  inline void SetDistribution(Distribution value) {
    m_distributionHasBeenSet = true;
    m_distribution = value;
  }
  inline PutSubscriptionFilterRequest& WithDistribution(Distribution value) {
  ...
  inline void SetApplyOnTransformedLogs(bool value) {
    m_applyOnTransformedLogsHasBeenSet = true;
    m_applyOnTransformedLogs = value;
  }
  inline PutSubscriptionFilterRequest& WithApplyOnTransformedLogs(bool value) {
    SetApplyOnTransformedLogs(value);
    return *this;
  }
  ///@}
  ...
  void SetFieldSelectionCriteria(FieldSelectionCriteriaT&& value) {
    m_fieldSelectionCriteriaHasBeenSet = true;
    m_fieldSelectionCriteria = std::forward<FieldSelectionCriteriaT>(value);
  }
  template <typename FieldSelectionCriteriaT = Aws::String>
  PutSubscriptionFilterRequest& WithFieldSelectionCriteria(FieldSelectionCriteriaT&& value) {
    SetFieldSelectionCriteria(std::forward<FieldSelectionCriteriaT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEmitSystemFields(EmitSystemFieldsT&& value) {
    m_emitSystemFieldsHasBeenSet = true;
    m_emitSystemFields = std::forward<EmitSystemFieldsT>(value);
  }
  template <typename EmitSystemFieldsT = Aws::Vector<Aws::String>>
  PutSubscriptionFilterRequest& WithEmitSystemFields(EmitSystemFieldsT&& value) {
    SetEmitSystemFields(std::forward<EmitSystemFieldsT>(value));
    return *this;
  }
  template <typename EmitSystemFieldsT = Aws::String>
  PutSubscriptionFilterRequest& AddEmitSystemFields(EmitSystemFieldsT&& value) {
    m_emitSystemFieldsHasBeenSet = true;
    m_emitSystemFields.emplace_back(std::forward<EmitSystemFieldsT>(value));
    return *this;
  }
  ///@}
 private:
