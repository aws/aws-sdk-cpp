...
namespace Model {
class CreateLookupTableResult {
 public:
  AWS_CLOUDWATCHLOGS_API CreateLookupTableResult() = default;
  AWS_CLOUDWATCHLOGS_API CreateLookupTableResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_CLOUDWATCHLOGS_API CreateLookupTableResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename LookupTableArnT = Aws::String>
  CreateLookupTableResult& WithLookupTableArn(LookupTableArnT&& value) {
  ...
  ///@{
  /**
   * <p>The time when the lookup table was created, expressed as the number of
  ...
  inline CreateLookupTableResult& WithCreatedAt(long long value) {
    SetCreatedAt(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  CreateLookupTableResult& WithRequestId(RequestIdT&& value) {
