...
class ListIntegrationsRequest : public CloudWatchLogsRequest {
 public:
  ...
  void SetIntegrationNamePrefix(IntegrationNamePrefixT&& value) {
    m_integrationNamePrefixHasBeenSet = true;
    m_integrationNamePrefix = std::forward<IntegrationNamePrefixT>(value);
  }
  template <typename IntegrationNamePrefixT = Aws::String>
  ListIntegrationsRequest& WithIntegrationNamePrefix(IntegrationNamePrefixT&& value) {
    SetIntegrationNamePrefix(std::forward<IntegrationNamePrefixT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListIntegrationsRequest& WithIntegrationStatus(IntegrationStatus value) {
