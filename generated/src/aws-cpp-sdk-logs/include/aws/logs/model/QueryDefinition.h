...
class QueryDefinition {
 public:
  ...
  inline QueryDefinition& WithQueryLanguage(QueryLanguage value) {
  ...
  inline void SetLastModified(long long value) {
    m_lastModifiedHasBeenSet = true;
    m_lastModified = value;
  }
  inline QueryDefinition& WithLastModified(long long value) {
