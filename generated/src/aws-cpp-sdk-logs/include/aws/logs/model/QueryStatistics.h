...
class QueryStatistics {
 public:
  ...
  inline void SetRecordsMatched(double value) {
    m_recordsMatchedHasBeenSet = true;
    m_recordsMatched = value;
  }
  inline QueryStatistics& WithRecordsMatched(double value) {
  ...
  inline void SetRecordsScanned(double value) {
    m_recordsScannedHasBeenSet = true;
    m_recordsScanned = value;
  }
  inline QueryStatistics& WithRecordsScanned(double value) {
  ...
  inline void SetEstimatedRecordsSkipped(double value) {
    m_estimatedRecordsSkippedHasBeenSet = true;
    m_estimatedRecordsSkipped = value;
  }
  inline QueryStatistics& WithEstimatedRecordsSkipped(double value) {
    SetEstimatedRecordsSkipped(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEstimatedBytesSkipped(double value) {
    m_estimatedBytesSkippedHasBeenSet = true;
    m_estimatedBytesSkipped = value;
  }
  inline QueryStatistics& WithEstimatedBytesSkipped(double value) {
    SetEstimatedBytesSkipped(value);
    return *this;
  }
  ///@}
  ...
  inline void SetLogGroupsScanned(double value) {
    m_logGroupsScannedHasBeenSet = true;
    m_logGroupsScanned = value;
  }
  inline QueryStatistics& WithLogGroupsScanned(double value) {
    SetLogGroupsScanned(value);
    return *this;
  }
  ///@}
 private:
