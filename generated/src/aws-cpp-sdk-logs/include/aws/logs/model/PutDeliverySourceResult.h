...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDWATCHLOGS_API PutDeliverySourceResult() = default;
    ...
    void SetDeliverySource(DeliverySourceT&& value) { m_deliverySource = std::forward<DeliverySourceT>(value); }
    template<typename DeliverySourceT = DeliverySource>
    PutDeliverySourceResult& WithDeliverySource(DeliverySourceT&& value) { SetDeliverySource(std::forward<DeliverySourceT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    PutDeliverySourceResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
