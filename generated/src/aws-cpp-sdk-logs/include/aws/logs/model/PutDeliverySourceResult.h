...
class PutDeliverySourceResult {
 public:
  ...
  void SetDeliverySource(DeliverySourceT&& value) {
    m_deliverySourceHasBeenSet = true;
    m_deliverySource = std::forward<DeliverySourceT>(value);
  }
  template <typename DeliverySourceT = DeliverySource>
  PutDeliverySourceResult& WithDeliverySource(DeliverySourceT&& value) {
    SetDeliverySource(std::forward<DeliverySourceT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  PutDeliverySourceResult& WithRequestId(RequestIdT&& value) {
