...
namespace Model
{
  ...
  public:
    ...
    void SetDeliverySources(DeliverySourcesT&& value) { m_deliverySources = std::forward<DeliverySourcesT>(value); }
    template<typename DeliverySourcesT = Aws::Vector<DeliverySource>>
    ...
    DescribeDeliverySourcesResult& AddDeliverySources(DeliverySourcesT&& value) { m_deliverySources.emplace_back(std::forward<DeliverySourcesT>(value)); return *this; }
    ///@}
