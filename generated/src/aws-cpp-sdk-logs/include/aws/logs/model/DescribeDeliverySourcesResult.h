...
class DescribeDeliverySourcesResult {
 public:
  ...
  void SetDeliverySources(DeliverySourcesT&& value) {
    m_deliverySourcesHasBeenSet = true;
    m_deliverySources = std::forward<DeliverySourcesT>(value);
  }
  template <typename DeliverySourcesT = Aws::Vector<DeliverySource>>
  DescribeDeliverySourcesResult& WithDeliverySources(DeliverySourcesT&& value) {
    SetDeliverySources(std::forward<DeliverySourcesT>(value));
    return *this;
  }
  template <typename DeliverySourcesT = DeliverySource>
  DescribeDeliverySourcesResult& AddDeliverySources(DeliverySourcesT&& value) {
    m_deliverySourcesHasBeenSet = true;
    m_deliverySources.emplace_back(std::forward<DeliverySourcesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeDeliverySourcesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeDeliverySourcesResult& WithRequestId(RequestIdT&& value) {
