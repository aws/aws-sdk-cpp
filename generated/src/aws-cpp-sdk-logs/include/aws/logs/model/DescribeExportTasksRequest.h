...
class DescribeExportTasksRequest : public CloudWatchLogsRequest {
 public:
  ...
  inline void SetStatusCode(ExportTaskStatusCode value) {
    m_statusCodeHasBeenSet = true;
    m_statusCode = value;
  }
  inline DescribeExportTasksRequest& WithStatusCode(ExportTaskStatusCode value) {
    SetStatusCode(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeExportTasksRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
