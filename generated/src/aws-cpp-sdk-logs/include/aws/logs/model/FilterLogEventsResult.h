...
namespace Model
{
  ...
  public:
    ...
    void SetEvents(EventsT&& value) { m_events = std::forward<EventsT>(value); }
    template<typename EventsT = Aws::Vector<FilteredLogEvent>>
    ...
    FilterLogEventsResult& AddEvents(EventsT&& value) { m_events.emplace_back(std::forward<EventsT>(value)); return *this; }
    ///@}
    ...
    void SetSearchedLogStreams(SearchedLogStreamsT&& value) { m_searchedLogStreams = std::forward<SearchedLogStreamsT>(value); }
    template<typename SearchedLogStreamsT = Aws::Vector<SearchedLogStream>>
    ...
    FilterLogEventsResult& AddSearchedLogStreams(SearchedLogStreamsT&& value) { m_searchedLogStreams.emplace_back(std::forward<SearchedLogStreamsT>(value)); return *this; }
    ///@}
