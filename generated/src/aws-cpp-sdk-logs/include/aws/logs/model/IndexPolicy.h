...
class IndexPolicy {
 public:
  ...
  inline void SetLastUpdateTime(long long value) {
    m_lastUpdateTimeHasBeenSet = true;
    m_lastUpdateTime = value;
  }
  inline IndexPolicy& WithLastUpdateTime(long long value) {
  ...
  inline void SetSource(IndexSource value) {
    m_sourceHasBeenSet = true;
    m_source = value;
  }
  inline IndexPolicy& WithSource(IndexSource value) {
    SetSource(value);
    return *this;
  }
  ///@}
