...
namespace Model
{
  ...
  public:
    ...
    void SetDeliveries(DeliveriesT&& value) { m_deliveries = std::forward<DeliveriesT>(value); }
    template<typename DeliveriesT = Aws::Vector<Delivery>>
    ...
    DescribeDeliveriesResult& AddDeliveries(DeliveriesT&& value) { m_deliveries.emplace_back(std::forward<DeliveriesT>(value)); return *this; }
    ///@}
