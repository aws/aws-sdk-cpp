...
class OpenSearchResourceStatus {
 public:
  ...
  inline void SetStatus(OpenSearchResourceStatusType value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline OpenSearchResourceStatus& WithStatus(OpenSearchResourceStatusType value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusMessageT = Aws::String>
  OpenSearchResourceStatus& WithStatusMessage(StatusMessageT&& value) {
