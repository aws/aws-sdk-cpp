...
namespace Model {
enum class StartLiveTailEventType { INITIAL_RESPONSE, SESSIONSTART, SESSIONUPDATE, UNKNOWN };
...
class StartLiveTailHandler : public Aws::Utils::Event::EventStreamHandler {
  ...
  typedef std::function<void(const StartLiveTailInitialResponse&, const Utils::Event::InitialResponseType)>
      StartLiveTailInitialResponseCallbackEx;
 ...
 public:
  ...
  inline void SetInitialResponseCallback(const StartLiveTailInitialResponseCallback& noArgCallback) {
    m_onInitialResponse = [noArgCallback](const StartLiveTailInitialResponse& rs, const Utils::Event::InitialResponseType) {
