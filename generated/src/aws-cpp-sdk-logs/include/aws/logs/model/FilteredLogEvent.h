...
class FilteredLogEvent {
 public:
  ...
  template <typename LogStreamNameT = Aws::String>
  FilteredLogEvent& WithLogStreamName(LogStreamNameT&& value) {
  ...
  inline FilteredLogEvent& WithTimestamp(long long value) {
    SetTimestamp(value);
    return *this;
  }
  ///@}
  ...
  template <typename MessageT = Aws::String>
  FilteredLogEvent& WithMessage(MessageT&& value) {
  ...
  inline FilteredLogEvent& WithIngestionTime(long long value) {
  ...
  template <typename EventIdT = Aws::String>
  FilteredLogEvent& WithEventId(EventIdT&& value) {
