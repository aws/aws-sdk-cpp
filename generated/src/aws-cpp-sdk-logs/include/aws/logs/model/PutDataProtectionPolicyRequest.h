...
class PutDataProtectionPolicyRequest : public CloudWatchLogsRequest {
 public:
  ...
  template <typename LogGroupIdentifierT = Aws::String>
  PutDataProtectionPolicyRequest& WithLogGroupIdentifier(LogGroupIdentifierT&& value) {
  ...
  template <typename PolicyDocumentT = Aws::String>
  PutDataProtectionPolicyRequest& WithPolicyDocument(PolicyDocumentT&& value) {
