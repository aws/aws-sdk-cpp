...
class LiveTailSessionUpdate {
 public:
  ...
  template <typename SessionMetadataT = LiveTailSessionMetadata>
  LiveTailSessionUpdate& WithSessionMetadata(SessionMetadataT&& value) {
  ...
  void SetSessionResults(SessionResultsT&& value) {
    m_sessionResultsHasBeenSet = true;
    m_sessionResults = std::forward<SessionResultsT>(value);
  }
  template <typename SessionResultsT = Aws::Vector<LiveTailSessionLogEvent>>
  LiveTailSessionUpdate& WithSessionResults(SessionResultsT&& value) {
    SetSessionResults(std::forward<SessionResultsT>(value));
    return *this;
  }
  template <typename SessionResultsT = LiveTailSessionLogEvent>
  LiveTailSessionUpdate& AddSessionResults(SessionResultsT&& value) {
    m_sessionResultsHasBeenSet = true;
    m_sessionResults.emplace_back(std::forward<SessionResultsT>(value));
    return *this;
  }
  ///@}
 private:
