...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDWATCHLOGS_API ListTagsForResourceResult() = default;
    ...
    void SetTags(TagsT&& value) { m_tags = std::forward<TagsT>(value); }
    template<typename TagsT = Aws::Map<Aws::String, Aws::String>>
    ...
    ListTagsForResourceResult& AddTags(TagsKeyT&& key, TagsValueT&& value) {
      m_tags.emplace(std::forward<TagsKeyT>(key), std::forward<TagsValueT>(value)); return *this;
    }
    ///@}
