...
class GetLogAnomalyDetectorResult {
 public:
  ...
  void SetDetectorName(DetectorNameT&& value) {
    ...
    m_detectorName = std::forward<DetectorNameT>(value);
  }
  template <typename DetectorNameT = Aws::String>
  GetLogAnomalyDetectorResult& WithDetectorName(DetectorNameT&& value) {
    SetDetectorName(std::forward<DetectorNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetLogAnomalyDetectorResult& WithEvaluationFrequency(EvaluationFrequency value) {
  ...
  inline void SetAnomalyDetectorStatus(AnomalyDetectorStatus value) {
    m_anomalyDetectorStatusHasBeenSet = true;
    m_anomalyDetectorStatus = value;
  }
  inline GetLogAnomalyDetectorResult& WithAnomalyDetectorStatus(AnomalyDetectorStatus value) {
    SetAnomalyDetectorStatus(value);
    return *this;
  }
  ///@}
  ...
  inline GetLogAnomalyDetectorResult& WithCreationTimeStamp(long long value) {
  ...
  inline void SetLastModifiedTimeStamp(long long value) {
    m_lastModifiedTimeStampHasBeenSet = true;
    m_lastModifiedTimeStamp = value;
  }
  inline GetLogAnomalyDetectorResult& WithLastModifiedTimeStamp(long long value) {
  ...
  inline GetLogAnomalyDetectorResult& WithAnomalyVisibilityTime(long long value) {
