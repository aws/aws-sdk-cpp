...
namespace Model
{
  ...
  public:
    ...
    void SetDetectorName(DetectorNameT&& value) { m_detectorName = std::forward<DetectorNameT>(value); }
    template<typename DetectorNameT = Aws::String>
    ...
    void SetLogGroupArnList(LogGroupArnListT&& value) { m_logGroupArnList = std::forward<LogGroupArnListT>(value); }
    template<typename LogGroupArnListT = Aws::Vector<Aws::String>>
    ...
    GetLogAnomalyDetectorResult& AddLogGroupArnList(LogGroupArnListT&& value) { m_logGroupArnList.emplace_back(std::forward<LogGroupArnListT>(value)); return *this; }
    ///@}
    ...
    inline void SetEvaluationFrequency(EvaluationFrequency value) { m_evaluationFrequency = value; }
    ...
    void SetFilterPattern(FilterPatternT&& value) { m_filterPattern = std::forward<FilterPatternT>(value); }
    template<typename FilterPatternT = Aws::String>
    ...
    inline void SetAnomalyDetectorStatus(AnomalyDetectorStatus value) { m_anomalyDetectorStatus = value; }
    ...
    void SetKmsKeyId(KmsKeyIdT&& value) { m_kmsKeyId = std::forward<KmsKeyIdT>(value); }
    template<typename KmsKeyIdT = Aws::String>
