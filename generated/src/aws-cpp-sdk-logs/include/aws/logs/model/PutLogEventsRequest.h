...
class PutLogEventsRequest : public CloudWatchLogsRequest {
 public:
  ...
  template <typename LogGroupNameT = Aws::String>
  PutLogEventsRequest& WithLogGroupName(LogGroupNameT&& value) {
  ...
  template <typename LogStreamNameT = Aws::String>
  PutLogEventsRequest& WithLogStreamName(LogStreamNameT&& value) {
  ...
  template <typename LogEventsT = Aws::Vector<InputLogEvent>>
  PutLogEventsRequest& WithLogEvents(LogEventsT&& value) {
    SetLogEvents(std::forward<LogEventsT>(value));
    return *this;
  }
  template <typename LogEventsT = InputLogEvent>
  PutLogEventsRequest& AddLogEvents(LogEventsT&& value) {
    m_logEventsHasBeenSet = true;
  ...
  void SetSequenceToken(SequenceTokenT&& value) {
    m_sequenceTokenHasBeenSet = true;
    m_sequenceToken = std::forward<SequenceTokenT>(value);
  }
  template <typename SequenceTokenT = Aws::String>
  PutLogEventsRequest& WithSequenceToken(SequenceTokenT&& value) {
    SetSequenceToken(std::forward<SequenceTokenT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename EntityT = Entity>
  PutLogEventsRequest& WithEntity(EntityT&& value) {
