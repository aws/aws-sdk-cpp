...
namespace Model
{
  ...
  public:
    ...
    void SetIntegrationName(IntegrationNameT&& value) { m_integrationName = std::forward<IntegrationNameT>(value); }
    template<typename IntegrationNameT = Aws::String>
    ...
    inline void SetIntegrationType(IntegrationType value) { m_integrationType = value; }
    ...
    inline void SetIntegrationStatus(IntegrationStatus value) { m_integrationStatus = value; }
    ...
    void SetIntegrationDetails(IntegrationDetailsT&& value) { m_integrationDetails = std::forward<IntegrationDetailsT>(value); }
    template<typename IntegrationDetailsT = IntegrationDetails>
