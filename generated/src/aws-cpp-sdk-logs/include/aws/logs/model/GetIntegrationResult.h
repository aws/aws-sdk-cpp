...
class GetIntegrationResult {
 public:
  ...
  inline GetIntegrationResult& WithIntegrationType(IntegrationType value) {
  ...
  inline void SetIntegrationStatus(IntegrationStatus value) {
    m_integrationStatusHasBeenSet = true;
    m_integrationStatus = value;
  }
  inline GetIntegrationResult& WithIntegrationStatus(IntegrationStatus value) {
    SetIntegrationStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetIntegrationDetails(IntegrationDetailsT&& value) {
    ...
    m_integrationDetails = std::forward<IntegrationDetailsT>(value);
  }
  template <typename IntegrationDetailsT = IntegrationDetails>
  GetIntegrationResult& WithIntegrationDetails(IntegrationDetailsT&& value) {
    SetIntegrationDetails(std::forward<IntegrationDetailsT>(value));
    return *this;
  }
  ///@}
