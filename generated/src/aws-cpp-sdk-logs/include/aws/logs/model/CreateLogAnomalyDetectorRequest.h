...
class CreateLogAnomalyDetectorRequest : public CloudWatchLogsRequest {
 public:
  ...
  inline CreateLogAnomalyDetectorRequest& WithEvaluationFrequency(EvaluationFrequency value) {
  ...
  inline CreateLogAnomalyDetectorRequest& WithAnomalyVisibilityTime(long long value) {
