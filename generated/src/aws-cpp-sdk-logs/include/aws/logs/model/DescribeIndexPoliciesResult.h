...
namespace Model
{
  ...
  public:
    ...
    void SetIndexPolicies(IndexPoliciesT&& value) { m_indexPolicies = std::forward<IndexPoliciesT>(value); }
    template<typename IndexPoliciesT = Aws::Vector<IndexPolicy>>
    ...
    DescribeIndexPoliciesResult& AddIndexPolicies(IndexPoliciesT&& value) { m_indexPolicies.emplace_back(std::forward<IndexPoliciesT>(value)); return *this; }
    ///@}
