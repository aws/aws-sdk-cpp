...
namespace Model
{
  ...
  public:
    ...
    void SetTransformedLogs(TransformedLogsT&& value) { m_transformedLogs = std::forward<TransformedLogsT>(value); }
    template<typename TransformedLogsT = Aws::Vector<TransformedLogRecord>>
    ...
    TestTransformerResult& AddTransformedLogs(TransformedLogsT&& value) { m_transformedLogs.emplace_back(std::forward<TransformedLogsT>(value)); return *this; }
    ///@}
