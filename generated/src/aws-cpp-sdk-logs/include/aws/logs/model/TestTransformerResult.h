...
class TestTransformerResult {
 public:
  ...
  void SetTransformedLogs(TransformedLogsT&& value) {
    m_transformedLogsHasBeenSet = true;
    m_transformedLogs = std::forward<TransformedLogsT>(value);
  }
  template <typename TransformedLogsT = Aws::Vector<TransformedLogRecord>>
  TestTransformerResult& WithTransformedLogs(TransformedLogsT&& value) {
    SetTransformedLogs(std::forward<TransformedLogsT>(value));
    return *this;
  }
  template <typename TransformedLogsT = TransformedLogRecord>
  TestTransformerResult& AddTransformedLogs(TransformedLogsT&& value) {
    m_transformedLogsHasBeenSet = true;
    m_transformedLogs.emplace_back(std::forward<TransformedLogsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  TestTransformerResult& WithRequestId(RequestIdT&& value) {
