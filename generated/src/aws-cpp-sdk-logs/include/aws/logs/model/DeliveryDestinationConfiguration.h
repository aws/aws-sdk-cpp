...
class DeliveryDestinationConfiguration {
 public:
  ...
  void SetDestinationResourceArn(DestinationResourceArnT&& value) {
    m_destinationResourceArnHasBeenSet = true;
    m_destinationResourceArn = std::forward<DestinationResourceArnT>(value);
  }
  template <typename DestinationResourceArnT = Aws::String>
  DeliveryDestinationConfiguration& WithDestinationResourceArn(DestinationResourceArnT&& value) {
    SetDestinationResourceArn(std::forward<DestinationResourceArnT>(value));
    return *this;
  }
  ///@}
 private:
