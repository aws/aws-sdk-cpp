...
class TestTransformerRequest : public CloudWatchLogsRequest {
 public:
  ...
  void SetTransformerConfig(TransformerConfigT&& value) {
    ...
    m_transformerConfig = std::forward<TransformerConfigT>(value);
  }
  template <typename TransformerConfigT = Aws::Vector<Processor>>
  TestTransformerRequest& WithTransformerConfig(TransformerConfigT&& value) {
    SetTransformerConfig(std::forward<TransformerConfigT>(value));
    return *this;
  }
  template <typename TransformerConfigT = Processor>
  TestTransformerRequest& AddTransformerConfig(TransformerConfigT&& value) {
    m_transformerConfigHasBeenSet = true;
    m_transformerConfig.emplace_back(std::forward<TransformerConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLogEventMessages(LogEventMessagesT&& value) {
    m_logEventMessagesHasBeenSet = true;
    m_logEventMessages = std::forward<LogEventMessagesT>(value);
  }
  template <typename LogEventMessagesT = Aws::Vector<Aws::String>>
  TestTransformerRequest& WithLogEventMessages(LogEventMessagesT&& value) {
    SetLogEventMessages(std::forward<LogEventMessagesT>(value));
    return *this;
  }
  template <typename LogEventMessagesT = Aws::String>
  TestTransformerRequest& AddLogEventMessages(LogEventMessagesT&& value) {
    m_logEventMessagesHasBeenSet = true;
    m_logEventMessages.emplace_back(std::forward<LogEventMessagesT>(value));
    return *this;
  }
  ///@}
 private:
