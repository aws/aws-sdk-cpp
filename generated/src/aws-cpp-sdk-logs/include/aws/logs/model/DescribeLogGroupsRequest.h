...
class DescribeLogGroupsRequest : public CloudWatchLogsRequest {
 public:
  ...
  void SetLogGroupNamePrefix(LogGroupNamePrefixT&& value) {
    m_logGroupNamePrefixHasBeenSet = true;
    m_logGroupNamePrefix = std::forward<LogGroupNamePrefixT>(value);
  }
  template <typename LogGroupNamePrefixT = Aws::String>
  DescribeLogGroupsRequest& WithLogGroupNamePrefix(LogGroupNamePrefixT&& value) {
    SetLogGroupNamePrefix(std::forward<LogGroupNamePrefixT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeLogGroupsRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeLogGroupsRequest& WithIncludeLinkedAccounts(bool value) {
  ...
  inline DescribeLogGroupsRequest& WithLogGroupClass(LogGroupClass value) {
