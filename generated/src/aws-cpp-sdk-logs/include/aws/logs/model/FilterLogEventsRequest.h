...
class FilterLogEventsRequest : public CloudWatchLogsRequest {
 public:
  ...
  template <typename LogGroupNameT = Aws::String>
  FilterLogEventsRequest& WithLogGroupName(LogGroupNameT&& value) {
  ...
  template <typename LogGroupIdentifierT = Aws::String>
  FilterLogEventsRequest& WithLogGroupIdentifier(LogGroupIdentifierT&& value) {
  ...
  template <typename LogStreamNamesT = Aws::Vector<Aws::String>>
  FilterLogEventsRequest& WithLogStreamNames(LogStreamNamesT&& value) {
    SetLogStreamNames(std::forward<LogStreamNamesT>(value));
    return *this;
  }
  template <typename LogStreamNamesT = Aws::String>
  FilterLogEventsRequest& AddLogStreamNames(LogStreamNamesT&& value) {
    m_logStreamNamesHasBeenSet = true;
  ...
  template <typename LogStreamNamePrefixT = Aws::String>
  FilterLogEventsRequest& WithLogStreamNamePrefix(LogStreamNamePrefixT&& value) {
  ...
  inline FilterLogEventsRequest& WithStartTime(long long value) {
    SetStartTime(value);
    return *this;
  }
  ///@}
  ...
  inline FilterLogEventsRequest& WithEndTime(long long value) {
    SetEndTime(value);
    return *this;
  }
  ///@}
  ...
  template <typename FilterPatternT = Aws::String>
  FilterLogEventsRequest& WithFilterPattern(FilterPatternT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  FilterLogEventsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline FilterLogEventsRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUnmask(bool value) {
    m_unmaskHasBeenSet = true;
    m_unmask = value;
  }
  inline FilterLogEventsRequest& WithUnmask(bool value) {
    SetUnmask(value);
    return *this;
  }
  ///@}
