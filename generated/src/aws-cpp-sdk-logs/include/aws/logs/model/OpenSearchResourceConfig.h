...
class OpenSearchResourceConfig {
 public:
  ...
  void SetDataSourceRoleArn(DataSourceRoleArnT&& value) {
    ...
    m_dataSourceRoleArn = std::forward<DataSourceRoleArnT>(value);
  }
  template <typename DataSourceRoleArnT = Aws::String>
  OpenSearchResourceConfig& WithDataSourceRoleArn(DataSourceRoleArnT&& value) {
    SetDataSourceRoleArn(std::forward<DataSourceRoleArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDashboardViewerPrincipals(DashboardViewerPrincipalsT&& value) {
    ...
    m_dashboardViewerPrincipals = std::forward<DashboardViewerPrincipalsT>(value);
  }
  template <typename DashboardViewerPrincipalsT = Aws::Vector<Aws::String>>
  OpenSearchResourceConfig& WithDashboardViewerPrincipals(DashboardViewerPrincipalsT&& value) {
    SetDashboardViewerPrincipals(std::forward<DashboardViewerPrincipalsT>(value));
    return *this;
  }
  ...
  OpenSearchResourceConfig& AddDashboardViewerPrincipals(DashboardViewerPrincipalsT&& value) {
    m_dashboardViewerPrincipalsHasBeenSet = true;
    m_dashboardViewerPrincipals.emplace_back(std::forward<DashboardViewerPrincipalsT>(value));
    return *this;
  }
  ///@}
  ...
  inline OpenSearchResourceConfig& WithRetentionDays(int value) {
