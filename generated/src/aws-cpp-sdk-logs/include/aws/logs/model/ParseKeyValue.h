...
class ParseKeyValue {
 public:
  ...
  void SetKeyValueDelimiter(KeyValueDelimiterT&& value) {
    ...
    m_keyValueDelimiter = std::forward<KeyValueDelimiterT>(value);
  }
  template <typename KeyValueDelimiterT = Aws::String>
  ParseKeyValue& WithKeyValueDelimiter(KeyValueDelimiterT&& value) {
    SetKeyValueDelimiter(std::forward<KeyValueDelimiterT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNonMatchValue(NonMatchValueT&& value) {
    ...
    m_nonMatchValue = std::forward<NonMatchValueT>(value);
  }
  template <typename NonMatchValueT = Aws::String>
  ParseKeyValue& WithNonMatchValue(NonMatchValueT&& value) {
    SetNonMatchValue(std::forward<NonMatchValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline ParseKeyValue& WithOverwriteIfExists(bool value) {
