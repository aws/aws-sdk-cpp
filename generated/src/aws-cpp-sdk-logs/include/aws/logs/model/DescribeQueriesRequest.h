...
class DescribeQueriesRequest : public CloudWatchLogsRequest {
 public:
  ...
  template <typename LogGroupNameT = Aws::String>
  DescribeQueriesRequest& WithLogGroupName(LogGroupNameT&& value) {
  ...
  inline DescribeQueriesRequest& WithStatus(QueryStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeQueriesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeQueriesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeQueriesRequest& WithQueryLanguage(QueryLanguage value) {
