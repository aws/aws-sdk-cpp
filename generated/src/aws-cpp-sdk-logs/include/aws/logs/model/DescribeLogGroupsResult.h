...
namespace Model
{
  ...
  public:
    ...
    void SetLogGroups(LogGroupsT&& value) { m_logGroups = std::forward<LogGroupsT>(value); }
    template<typename LogGroupsT = Aws::Vector<LogGroup>>
    ...
    DescribeLogGroupsResult& AddLogGroups(LogGroupsT&& value) { m_logGroups.emplace_back(std::forward<LogGroupsT>(value)); return *this; }
    ///@}
