...
class SuppressionPeriod {
 public:
  ...
  inline SuppressionPeriod& WithValue(int value) {
    SetValue(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSuppressionUnit(SuppressionUnit value) {
    m_suppressionUnitHasBeenSet = true;
    m_suppressionUnit = value;
  }
  inline SuppressionPeriod& WithSuppressionUnit(SuppressionUnit value) {
    SetSuppressionUnit(value);
    return *this;
  }
  ///@}
 private:
