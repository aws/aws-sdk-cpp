...
namespace Model
{
  ...
  public:
    ...
    inline void SetQueryLanguage(QueryLanguage value) { m_queryLanguage = value; }
    ...
    void SetResults(ResultsT&& value) { m_results = std::forward<ResultsT>(value); }
    template<typename ResultsT = Aws::Vector<Aws::Vector<ResultField>>>
    ...
    GetQueryResultsResult& AddResults(ResultsT&& value) { m_results.emplace_back(std::forward<ResultsT>(value)); return *this; }
    ///@}
    ...
    void SetStatistics(StatisticsT&& value) { m_statistics = std::forward<StatisticsT>(value); }
    template<typename StatisticsT = QueryStatistics>
    ...
    inline void SetStatus(QueryStatus value) { m_status = value; }
    ...
    void SetEncryptionKey(EncryptionKeyT&& value) { m_encryptionKey = std::forward<EncryptionKeyT>(value); }
    template<typename EncryptionKeyT = Aws::String>
