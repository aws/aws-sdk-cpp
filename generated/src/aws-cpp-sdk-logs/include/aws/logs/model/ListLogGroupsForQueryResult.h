...
namespace Model
{
  ...
  public:
    ...
    void SetLogGroupIdentifiers(LogGroupIdentifiersT&& value) { m_logGroupIdentifiers = std::forward<LogGroupIdentifiersT>(value); }
    template<typename LogGroupIdentifiersT = Aws::Vector<Aws::String>>
    ...
    ListLogGroupsForQueryResult& AddLogGroupIdentifiers(LogGroupIdentifiersT&& value) { m_logGroupIdentifiers.emplace_back(std::forward<LogGroupIdentifiersT>(value)); return *this; }
    ///@}
