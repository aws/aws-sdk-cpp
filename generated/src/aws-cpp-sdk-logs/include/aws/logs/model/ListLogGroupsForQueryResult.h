...
class ListLogGroupsForQueryResult {
 public:
  ...
  template <typename LogGroupIdentifiersT = Aws::Vector<Aws::String>>
  ListLogGroupsForQueryResult& WithLogGroupIdentifiers(LogGroupIdentifiersT&& value) {
    SetLogGroupIdentifiers(std::forward<LogGroupIdentifiersT>(value));
    return *this;
  }
  template <typename LogGroupIdentifiersT = Aws::String>
  ListLogGroupsForQueryResult& AddLogGroupIdentifiers(LogGroupIdentifiersT&& value) {
    m_logGroupIdentifiersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListLogGroupsForQueryResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListLogGroupsForQueryResult& WithRequestId(RequestIdT&& value) {
