...
class PutDeliveryDestinationPolicyResult {
 public:
  ...
  AWS_CLOUDWATCHLOGS_API PutDeliveryDestinationPolicyResult& operator=(
  ...
  template <typename PolicyT = Policy>
  PutDeliveryDestinationPolicyResult& WithPolicy(PolicyT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  PutDeliveryDestinationPolicyResult& WithRequestId(RequestIdT&& value) {
