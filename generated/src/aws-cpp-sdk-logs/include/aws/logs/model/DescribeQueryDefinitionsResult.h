...
class DescribeQueryDefinitionsResult {
 public:
  ...
  void SetQueryDefinitions(QueryDefinitionsT&& value) {
    m_queryDefinitionsHasBeenSet = true;
    m_queryDefinitions = std::forward<QueryDefinitionsT>(value);
  }
  template <typename QueryDefinitionsT = Aws::Vector<QueryDefinition>>
  DescribeQueryDefinitionsResult& WithQueryDefinitions(QueryDefinitionsT&& value) {
    SetQueryDefinitions(std::forward<QueryDefinitionsT>(value));
    return *this;
  }
  template <typename QueryDefinitionsT = QueryDefinition>
  DescribeQueryDefinitionsResult& AddQueryDefinitions(QueryDefinitionsT&& value) {
    m_queryDefinitionsHasBeenSet = true;
    m_queryDefinitions.emplace_back(std::forward<QueryDefinitionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeQueryDefinitionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeQueryDefinitionsResult& WithRequestId(RequestIdT&& value) {
