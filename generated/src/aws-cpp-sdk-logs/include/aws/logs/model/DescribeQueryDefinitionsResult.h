...
namespace Model
{
  ...
  public:
    ...
    void SetQueryDefinitions(QueryDefinitionsT&& value) { m_queryDefinitions = std::forward<QueryDefinitionsT>(value); }
    template<typename QueryDefinitionsT = Aws::Vector<QueryDefinition>>
    ...
    DescribeQueryDefinitionsResult& AddQueryDefinitions(QueryDefinitionsT&& value) { m_queryDefinitions.emplace_back(std::forward<QueryDefinitionsT>(value)); return *this; }
    ///@}
