...
class ListToMap {
 public:
  ...
  inline void SetFlatten(bool value) {
    m_flattenHasBeenSet = true;
    m_flatten = value;
  }
  inline ListToMap& WithFlatten(bool value) {
    SetFlatten(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFlattenedElement(FlattenedElement value) {
    m_flattenedElementHasBeenSet = true;
    m_flattenedElement = value;
  }
  inline ListToMap& WithFlattenedElement(FlattenedElement value) {
    SetFlattenedElement(value);
    return *this;
  }
  ///@}
 private:
