...
class DescribeLogStreamsRequest : public CloudWatchLogsRequest {
 public:
  ...
  inline DescribeLogStreamsRequest& WithOrderBy(OrderBy value) {
    SetOrderBy(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDescending(bool value) {
    m_descendingHasBeenSet = true;
    m_descending = value;
  }
  inline DescribeLogStreamsRequest& WithDescending(bool value) {
    SetDescending(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeLogStreamsRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
