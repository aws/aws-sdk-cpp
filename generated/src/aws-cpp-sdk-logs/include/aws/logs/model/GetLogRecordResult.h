...
class GetLogRecordResult {
 public:
  ...
  void SetLogRecord(LogRecordT&& value) {
    m_logRecordHasBeenSet = true;
    m_logRecord = std::forward<LogRecordT>(value);
  }
  template <typename LogRecordT = Aws::Map<Aws::String, Aws::String>>
  GetLogRecordResult& WithLogRecord(LogRecordT&& value) {
    SetLogRecord(std::forward<LogRecordT>(value));
    return *this;
  }
  ...
  GetLogRecordResult& AddLogRecord(LogRecordKeyT&& key, LogRecordValueT&& value) {
    m_logRecordHasBeenSet = true;
    m_logRecord.emplace(std::forward<LogRecordKeyT>(key), std::forward<LogRecordValueT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetLogRecordResult& WithRequestId(RequestIdT&& value) {
