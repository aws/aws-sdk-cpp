...
namespace Model
{
  ...
  public:
    ...
    void SetLogRecord(LogRecordT&& value) { m_logRecord = std::forward<LogRecordT>(value); }
    template<typename LogRecordT = Aws::Map<Aws::String, Aws::String>>
    ...
    GetLogRecordResult& AddLogRecord(LogRecordKeyT&& key, LogRecordValueT&& value) {
      m_logRecord.emplace(std::forward<LogRecordKeyT>(key), std::forward<LogRecordValueT>(value)); return *this;
    }
    ///@}
