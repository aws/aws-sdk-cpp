...
namespace Model
{
  ...
  public:
    ...
    void SetDeliveryDestinations(DeliveryDestinationsT&& value) { m_deliveryDestinations = std::forward<DeliveryDestinationsT>(value); }
    template<typename DeliveryDestinationsT = Aws::Vector<DeliveryDestination>>
    ...
    DescribeDeliveryDestinationsResult& AddDeliveryDestinations(DeliveryDestinationsT&& value) { m_deliveryDestinations.emplace_back(std::forward<DeliveryDestinationsT>(value)); return *this; }
    ///@}
    ...
    void SetNextToken(NextTokenT&& value) { m_nextToken = std::forward<NextTokenT>(value); }
    template<typename NextTokenT = Aws::String>
