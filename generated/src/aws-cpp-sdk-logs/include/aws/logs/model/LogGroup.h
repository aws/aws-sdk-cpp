...
class LogGroup {
 public:
  ...
  inline LogGroup& WithCreationTime(long long value) {
  ...
  inline LogGroup& WithRetentionInDays(int value) {
  ...
  inline void SetMetricFilterCount(int value) {
    m_metricFilterCountHasBeenSet = true;
    m_metricFilterCount = value;
  }
  inline LogGroup& WithMetricFilterCount(int value) {
    SetMetricFilterCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStoredBytes(long long value) {
    m_storedBytesHasBeenSet = true;
    m_storedBytes = value;
  }
  inline LogGroup& WithStoredBytes(long long value) {
    SetStoredBytes(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDataProtectionStatus(DataProtectionStatus value) {
    m_dataProtectionStatusHasBeenSet = true;
    m_dataProtectionStatus = value;
  }
  inline LogGroup& WithDataProtectionStatus(DataProtectionStatus value) {
    SetDataProtectionStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetInheritedProperties(InheritedPropertiesT&& value) {
    ...
    m_inheritedProperties = std::forward<InheritedPropertiesT>(value);
  }
  template <typename InheritedPropertiesT = Aws::Vector<InheritedProperty>>
  LogGroup& WithInheritedProperties(InheritedPropertiesT&& value) {
    SetInheritedProperties(std::forward<InheritedPropertiesT>(value));
    return *this;
  }
  inline LogGroup& AddInheritedProperties(InheritedProperty value) {
    m_inheritedPropertiesHasBeenSet = true;
    m_inheritedProperties.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline LogGroup& WithLogGroupClass(LogGroupClass value) {
