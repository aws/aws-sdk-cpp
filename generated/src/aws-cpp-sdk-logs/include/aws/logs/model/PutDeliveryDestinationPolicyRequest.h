...
class PutDeliveryDestinationPolicyRequest : public CloudWatchLogsRequest {
 public:
  ...
  template <typename DeliveryDestinationNameT = Aws::String>
  PutDeliveryDestinationPolicyRequest& WithDeliveryDestinationName(DeliveryDestinationNameT&& value) {
  ...
  template <typename DeliveryDestinationPolicyT = Aws::String>
  PutDeliveryDestinationPolicyRequest& WithDeliveryDestinationPolicy(DeliveryDestinationPolicyT&& value) {
