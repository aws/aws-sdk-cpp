...
class DescribeFieldIndexesResult {
 public:
  ...
  void SetFieldIndexes(FieldIndexesT&& value) {
    m_fieldIndexesHasBeenSet = true;
    m_fieldIndexes = std::forward<FieldIndexesT>(value);
  }
  template <typename FieldIndexesT = Aws::Vector<FieldIndex>>
  DescribeFieldIndexesResult& WithFieldIndexes(FieldIndexesT&& value) {
    SetFieldIndexes(std::forward<FieldIndexesT>(value));
    return *this;
  }
  template <typename FieldIndexesT = FieldIndex>
  DescribeFieldIndexesResult& AddFieldIndexes(FieldIndexesT&& value) {
    m_fieldIndexesHasBeenSet = true;
    m_fieldIndexes.emplace_back(std::forward<FieldIndexesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeFieldIndexesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeFieldIndexesResult& WithRequestId(RequestIdT&& value) {
