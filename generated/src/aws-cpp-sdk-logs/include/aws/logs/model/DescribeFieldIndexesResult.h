...
namespace Model
{
  ...
  public:
    ...
    void SetFieldIndexes(FieldIndexesT&& value) { m_fieldIndexes = std::forward<FieldIndexesT>(value); }
    template<typename FieldIndexesT = Aws::Vector<FieldIndex>>
    ...
    DescribeFieldIndexesResult& AddFieldIndexes(FieldIndexesT&& value) { m_fieldIndexes.emplace_back(std::forward<FieldIndexesT>(value)); return *this; }
    ///@}
