...
class TestMetricFilterRequest : public CloudWatchLogsRequest {
 public:
  ...
  template <typename FilterPatternT = Aws::String>
  TestMetricFilterRequest& WithFilterPattern(FilterPatternT&& value) {
  ...
  template <typename LogEventMessagesT = Aws::Vector<Aws::String>>
  TestMetricFilterRequest& WithLogEventMessages(LogEventMessagesT&& value) {
    SetLogEventMessages(std::forward<LogEventMessagesT>(value));
    return *this;
  }
  template <typename LogEventMessagesT = Aws::String>
  TestMetricFilterRequest& AddLogEventMessages(LogEventMessagesT&& value) {
    m_logEventMessagesHasBeenSet = true;
