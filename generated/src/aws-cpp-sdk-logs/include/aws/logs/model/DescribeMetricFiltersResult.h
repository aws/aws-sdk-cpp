...
namespace Model
{
  ...
  public:
    ...
    void SetMetricFilters(MetricFiltersT&& value) { m_metricFilters = std::forward<MetricFiltersT>(value); }
    template<typename MetricFiltersT = Aws::Vector<MetricFilter>>
    ...
    DescribeMetricFiltersResult& AddMetricFilters(MetricFiltersT&& value) { m_metricFilters.emplace_back(std::forward<MetricFiltersT>(value)); return *this; }
    ///@}
