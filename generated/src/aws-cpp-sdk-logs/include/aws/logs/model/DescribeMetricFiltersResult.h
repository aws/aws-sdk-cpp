...
class DescribeMetricFiltersResult {
 public:
  ...
  template <typename MetricFiltersT = Aws::Vector<MetricFilter>>
  DescribeMetricFiltersResult& WithMetricFilters(MetricFiltersT&& value) {
    SetMetricFilters(std::forward<MetricFiltersT>(value));
    return *this;
  }
  template <typename MetricFiltersT = MetricFilter>
  DescribeMetricFiltersResult& AddMetricFilters(MetricFiltersT&& value) {
    m_metricFiltersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeMetricFiltersResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeMetricFiltersResult& WithRequestId(RequestIdT&& value) {
