...
namespace Model
{
  ...
  public:
    ...
    void SetLogGroupFields(LogGroupFieldsT&& value) { m_logGroupFields = std::forward<LogGroupFieldsT>(value); }
    template<typename LogGroupFieldsT = Aws::Vector<LogGroupField>>
    ...
    GetLogGroupFieldsResult& AddLogGroupFields(LogGroupFieldsT&& value) { m_logGroupFields.emplace_back(std::forward<LogGroupFieldsT>(value)); return *this; }
    ///@}
