...
class GetLogRecordRequest : public CloudWatchLogsRequest {
 public:
  ...
  void SetLogRecordPointer(LogRecordPointerT&& value) {
    m_logRecordPointerHasBeenSet = true;
    m_logRecordPointer = std::forward<LogRecordPointerT>(value);
  }
  template <typename LogRecordPointerT = Aws::String>
  GetLogRecordRequest& WithLogRecordPointer(LogRecordPointerT&& value) {
    SetLogRecordPointer(std::forward<LogRecordPointerT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetLogRecordRequest& WithUnmask(bool value) {
    SetUnmask(value);
    return *this;
  }
  ///@}
