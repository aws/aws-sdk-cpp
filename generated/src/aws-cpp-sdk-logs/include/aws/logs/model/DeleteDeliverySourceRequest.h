...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDWATCHLOGS_API DeleteDeliverySourceRequest() = default;
    ...
    template<typename NameT = Aws::String>
    DeleteDeliverySourceRequest& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
  private:
