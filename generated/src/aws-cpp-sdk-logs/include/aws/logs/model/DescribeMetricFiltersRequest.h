...
class DescribeMetricFiltersRequest : public CloudWatchLogsRequest {
 public:
  ...
  template <typename LogGroupNameT = Aws::String>
  DescribeMetricFiltersRequest& WithLogGroupName(LogGroupNameT&& value) {
  ...
  void SetFilterNamePrefix(FilterNamePrefixT&& value) {
    m_filterNamePrefixHasBeenSet = true;
    m_filterNamePrefix = std::forward<FilterNamePrefixT>(value);
  }
  template <typename FilterNamePrefixT = Aws::String>
  DescribeMetricFiltersRequest& WithFilterNamePrefix(FilterNamePrefixT&& value) {
    SetFilterNamePrefix(std::forward<FilterNamePrefixT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeMetricFiltersRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeMetricFiltersRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  template <typename MetricNameT = Aws::String>
  DescribeMetricFiltersRequest& WithMetricName(MetricNameT&& value) {
  ...
  template <typename MetricNamespaceT = Aws::String>
  DescribeMetricFiltersRequest& WithMetricNamespace(MetricNamespaceT&& value) {
