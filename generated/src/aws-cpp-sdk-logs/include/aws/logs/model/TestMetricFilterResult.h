...
namespace Model
{
  ...
  public:
    ...
    void SetMatches(MatchesT&& value) { m_matches = std::forward<MatchesT>(value); }
    template<typename MatchesT = Aws::Vector<MetricFilterMatchRecord>>
    ...
    TestMetricFilterResult& AddMatches(MatchesT&& value) { m_matches.emplace_back(std::forward<MatchesT>(value)); return *this; }
    ///@}
