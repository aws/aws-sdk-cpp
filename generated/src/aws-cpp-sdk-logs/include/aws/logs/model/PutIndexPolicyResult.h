...
class PutIndexPolicyResult {
 public:
  ...
  void SetIndexPolicy(IndexPolicyT&& value) {
    m_indexPolicyHasBeenSet = true;
    m_indexPolicy = std::forward<IndexPolicyT>(value);
  }
  template <typename IndexPolicyT = IndexPolicy>
  PutIndexPolicyResult& WithIndexPolicy(IndexPolicyT&& value) {
    SetIndexPolicy(std::forward<IndexPolicyT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  PutIndexPolicyResult& WithRequestId(RequestIdT&& value) {
