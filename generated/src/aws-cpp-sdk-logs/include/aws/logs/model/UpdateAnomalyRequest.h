...
class UpdateAnomalyRequest : public CloudWatchLogsRequest {
 public:
  ...
  inline void SetSuppressionType(SuppressionType value) {
    m_suppressionTypeHasBeenSet = true;
    m_suppressionType = value;
  }
  inline UpdateAnomalyRequest& WithSuppressionType(SuppressionType value) {
    SetSuppressionType(value);
    return *this;
  }
  ///@}
  ...
  void SetSuppressionPeriod(SuppressionPeriodT&& value) {
    m_suppressionPeriodHasBeenSet = true;
    m_suppressionPeriod = std::forward<SuppressionPeriodT>(value);
  }
  template <typename SuppressionPeriodT = SuppressionPeriod>
  UpdateAnomalyRequest& WithSuppressionPeriod(SuppressionPeriodT&& value) {
    SetSuppressionPeriod(std::forward<SuppressionPeriodT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetBaseline(bool value) {
    m_baselineHasBeenSet = true;
    m_baseline = value;
  }
  inline UpdateAnomalyRequest& WithBaseline(bool value) {
    SetBaseline(value);
    return *this;
  }
  ///@}
