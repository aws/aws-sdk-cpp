...
class ResourceConfig {
 public:
  ...
  void SetOpenSearchResourceConfig(OpenSearchResourceConfigT&& value) {
    m_openSearchResourceConfigHasBeenSet = true;
    m_openSearchResourceConfig = std::forward<OpenSearchResourceConfigT>(value);
  }
  template <typename OpenSearchResourceConfigT = OpenSearchResourceConfig>
  ResourceConfig& WithOpenSearchResourceConfig(OpenSearchResourceConfigT&& value) {
    SetOpenSearchResourceConfig(std::forward<OpenSearchResourceConfigT>(value));
    return *this;
  }
  ///@}
 private:
