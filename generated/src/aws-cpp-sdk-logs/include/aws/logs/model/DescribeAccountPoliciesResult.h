...
namespace Model
{
  ...
  public:
    ...
    void SetAccountPolicies(AccountPoliciesT&& value) { m_accountPolicies = std::forward<AccountPoliciesT>(value); }
    template<typename AccountPoliciesT = Aws::Vector<AccountPolicy>>
    ...
    DescribeAccountPoliciesResult& AddAccountPolicies(AccountPoliciesT&& value) { m_accountPolicies.emplace_back(std::forward<AccountPoliciesT>(value)); return *this; }
    ///@}
