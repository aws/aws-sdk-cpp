...
class DescribeAccountPoliciesResult {
 public:
  ...
  void SetAccountPolicies(AccountPoliciesT&& value) {
    m_accountPoliciesHasBeenSet = true;
    m_accountPolicies = std::forward<AccountPoliciesT>(value);
  }
  template <typename AccountPoliciesT = Aws::Vector<AccountPolicy>>
  DescribeAccountPoliciesResult& WithAccountPolicies(AccountPoliciesT&& value) {
    SetAccountPolicies(std::forward<AccountPoliciesT>(value));
    return *this;
  }
  template <typename AccountPoliciesT = AccountPolicy>
  DescribeAccountPoliciesResult& AddAccountPolicies(AccountPoliciesT&& value) {
    m_accountPoliciesHasBeenSet = true;
    m_accountPolicies.emplace_back(std::forward<AccountPoliciesT>(value));
    return *this;
  }
  ///@}
