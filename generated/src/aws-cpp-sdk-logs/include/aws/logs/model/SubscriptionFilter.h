...
class SubscriptionFilter {
 public:
  ...
  template <typename FilterNameT = Aws::String>
  SubscriptionFilter& WithFilterName(FilterNameT&& value) {
  ...
  template <typename LogGroupNameT = Aws::String>
  SubscriptionFilter& WithLogGroupName(LogGroupNameT&& value) {
  ...
  template <typename FilterPatternT = Aws::String>
  SubscriptionFilter& WithFilterPattern(FilterPatternT&& value) {
  ...
  template <typename DestinationArnT = Aws::String>
  SubscriptionFilter& WithDestinationArn(DestinationArnT&& value) {
  ...
  template <typename RoleArnT = Aws::String>
  SubscriptionFilter& WithRoleArn(RoleArnT&& value) {
  ...
  inline SubscriptionFilter& WithDistribution(Distribution value) {
  ...
  inline SubscriptionFilter& WithApplyOnTransformedLogs(bool value) {
  ...
  inline SubscriptionFilter& WithCreationTime(long long value) {
  ...
  template <typename FieldSelectionCriteriaT = Aws::String>
  SubscriptionFilter& WithFieldSelectionCriteria(FieldSelectionCriteriaT&& value) {
  ...
  template <typename EmitSystemFieldsT = Aws::Vector<Aws::String>>
  SubscriptionFilter& WithEmitSystemFields(EmitSystemFieldsT&& value) {
    SetEmitSystemFields(std::forward<EmitSystemFieldsT>(value));
    return *this;
  }
  template <typename EmitSystemFieldsT = Aws::String>
  SubscriptionFilter& AddEmitSystemFields(EmitSystemFieldsT&& value) {
    m_emitSystemFieldsHasBeenSet = true;
