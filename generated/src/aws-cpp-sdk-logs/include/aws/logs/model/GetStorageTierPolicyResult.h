...
class GetStorageTierPolicyResult {
 public:
  AWS_CLOUDWATCHLOGS_API GetStorageTierPolicyResult() = default;
  AWS_CLOUDWATCHLOGS_API GetStorageTierPolicyResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_CLOUDWATCHLOGS_API GetStorageTierPolicyResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  inline GetStorageTierPolicyResult& WithStorageTier(StorageTier value) {
  ...
  inline GetStorageTierPolicyResult& WithLastUpdatedTime(long long value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetStorageTierPolicyResult& WithRequestId(RequestIdT&& value) {
