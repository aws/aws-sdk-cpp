...
namespace Model
{
  ...
  public:
    ...
    template<typename AnomalyDetectorArnT = Aws::String>
    DeleteLogAnomalyDetectorRequest& WithAnomalyDetectorArn(AnomalyDetectorArnT&& value) { SetAnomalyDetectorArn(std::forward<AnomalyDetectorArnT>(value)); return *this;}
    ///@}
  private:
