...
namespace Model
{
  ...
  public:
    ...
    void SetSubscriptionFilters(SubscriptionFiltersT&& value) { m_subscriptionFilters = std::forward<SubscriptionFiltersT>(value); }
    template<typename SubscriptionFiltersT = Aws::Vector<SubscriptionFilter>>
    ...
    DescribeSubscriptionFiltersResult& AddSubscriptionFilters(SubscriptionFiltersT&& value) { m_subscriptionFilters.emplace_back(std::forward<SubscriptionFiltersT>(value)); return *this; }
    ///@}
