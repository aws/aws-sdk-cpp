...
class LogStream {
 public:
  ...
  inline LogStream& WithCreationTime(long long value) {
  ...
  inline void SetFirstEventTimestamp(long long value) {
    m_firstEventTimestampHasBeenSet = true;
    m_firstEventTimestamp = value;
  }
  inline LogStream& WithFirstEventTimestamp(long long value) {
    SetFirstEventTimestamp(value);
    return *this;
  }
  ///@}
  ...
  inline void SetLastEventTimestamp(long long value) {
    m_lastEventTimestampHasBeenSet = true;
    m_lastEventTimestamp = value;
  }
  inline LogStream& WithLastEventTimestamp(long long value) {
    SetLastEventTimestamp(value);
    return *this;
  }
  ///@}
  ...
  inline void SetLastIngestionTime(long long value) {
    m_lastIngestionTimeHasBeenSet = true;
    m_lastIngestionTime = value;
  }
  inline LogStream& WithLastIngestionTime(long long value) {
    SetLastIngestionTime(value);
    return *this;
  }
  ///@}
  ...
  void SetUploadSequenceToken(UploadSequenceTokenT&& value) {
    ...
    m_uploadSequenceToken = std::forward<UploadSequenceTokenT>(value);
  }
  template <typename UploadSequenceTokenT = Aws::String>
  LogStream& WithUploadSequenceToken(UploadSequenceTokenT&& value) {
    SetUploadSequenceToken(std::forward<UploadSequenceTokenT>(value));
    return *this;
  }
  ///@}
