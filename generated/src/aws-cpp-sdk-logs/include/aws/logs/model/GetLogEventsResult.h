...
namespace Model
{
  ...
  public:
    ...
    GetLogEventsResult& AddEvents(EventsT&& value) { m_events.emplace_back(std::forward<EventsT>(value)); return *this; }
    ///@}
    ...
    void SetNextForwardToken(NextForwardTokenT&& value) { m_nextForwardToken = std::forward<NextForwardTokenT>(value); }
    template<typename NextForwardTokenT = Aws::String>
    ...
    void SetNextBackwardToken(NextBackwardTokenT&& value) { m_nextBackwardToken = std::forward<NextBackwardTokenT>(value); }
    template<typename NextBackwardTokenT = Aws::String>
