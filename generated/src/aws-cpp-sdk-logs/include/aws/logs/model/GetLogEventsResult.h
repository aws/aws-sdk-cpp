...
class GetLogEventsResult {
 public:
  ...
  template <typename EventsT = Aws::Vector<OutputLogEvent>>
  GetLogEventsResult& WithEvents(EventsT&& value) {
    SetEvents(std::forward<EventsT>(value));
    return *this;
  }
  template <typename EventsT = OutputLogEvent>
  GetLogEventsResult& AddEvents(EventsT&& value) {
    m_eventsHasBeenSet = true;
  ...
  template <typename NextForwardTokenT = Aws::String>
  GetLogEventsResult& WithNextForwardToken(NextForwardTokenT&& value) {
  ...
  template <typename NextBackwardTokenT = Aws::String>
  GetLogEventsResult& WithNextBackwardToken(NextBackwardTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetLogEventsResult& WithRequestId(RequestIdT&& value) {
