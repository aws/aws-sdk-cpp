...
namespace Model
{
  ...
  public:
    ...
    void SetLogStreams(LogStreamsT&& value) { m_logStreams = std::forward<LogStreamsT>(value); }
    template<typename LogStreamsT = Aws::Vector<LogStream>>
    ...
    DescribeLogStreamsResult& AddLogStreams(LogStreamsT&& value) { m_logStreams.emplace_back(std::forward<LogStreamsT>(value)); return *this; }
    ///@}
