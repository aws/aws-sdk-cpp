...
class PutDeliveryDestinationRequest : public CloudWatchLogsRequest {
 public:
  ...
  inline PutDeliveryDestinationRequest& WithOutputFormat(OutputFormat value) {
  ...
  void SetDeliveryDestinationConfiguration(DeliveryDestinationConfigurationT&& value) {
    ...
    m_deliveryDestinationConfiguration = std::forward<DeliveryDestinationConfigurationT>(value);
  }
  template <typename DeliveryDestinationConfigurationT = DeliveryDestinationConfiguration>
  PutDeliveryDestinationRequest& WithDeliveryDestinationConfiguration(DeliveryDestinationConfigurationT&& value) {
    SetDeliveryDestinationConfiguration(std::forward<DeliveryDestinationConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  inline PutDeliveryDestinationRequest& WithDeliveryDestinationType(DeliveryDestinationType value) {
