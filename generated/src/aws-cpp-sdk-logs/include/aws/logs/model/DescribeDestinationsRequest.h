...
class DescribeDestinationsRequest : public CloudWatchLogsRequest {
 public:
  ...
  void SetDestinationNamePrefix(DestinationNamePrefixT&& value) {
    m_destinationNamePrefixHasBeenSet = true;
    m_destinationNamePrefix = std::forward<DestinationNamePrefixT>(value);
  }
  template <typename DestinationNamePrefixT = Aws::String>
  DescribeDestinationsRequest& WithDestinationNamePrefix(DestinationNamePrefixT&& value) {
    SetDestinationNamePrefix(std::forward<DestinationNamePrefixT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeDestinationsRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
