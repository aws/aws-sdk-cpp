...
class S3DeliveryConfiguration {
 public:
  ...
  void SetSuffixPath(SuffixPathT&& value) {
    ...
    m_suffixPath = std::forward<SuffixPathT>(value);
  }
  template <typename SuffixPathT = Aws::String>
  S3DeliveryConfiguration& WithSuffixPath(SuffixPathT&& value) {
    SetSuffixPath(std::forward<SuffixPathT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetEnableHiveCompatiblePath(bool value) {
    ...
    m_enableHiveCompatiblePath = value;
  }
  inline S3DeliveryConfiguration& WithEnableHiveCompatiblePath(bool value) {
    SetEnableHiveCompatiblePath(value);
    return *this;
  }
  ///@}
 private:
