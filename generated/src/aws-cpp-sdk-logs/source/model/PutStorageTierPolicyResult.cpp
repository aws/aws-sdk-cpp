...
PutStorageTierPolicyResult::PutStorageTierPolicyResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

PutStorageTierPolicyResult& PutStorageTierPolicyResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
