...
Aws::String PutBearerTokenAuthenticationRequest::SerializePayload() const {
  JsonValue payload;
...
Aws::Http::HeaderValueCollection PutBearerTokenAuthenticationRequest::GetRequestSpecificHeaders() const {
  Aws::Http::HeaderValueCollection headers;
  headers.insert(Aws::Http::HeaderValuePair("X-Amz-Target", "Logs_20140328.PutBearerTokenAuthentication"));
  return headers;
}
