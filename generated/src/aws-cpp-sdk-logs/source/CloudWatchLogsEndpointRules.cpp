...
{
const size_t CloudWatchLogsEndpointRules::RulesBlobStrLen = 3764;
const size_t CloudWatchLogsEndpointRules::RulesBlobSize = 3765;
...
't','t','p','s',':','/','/','l','o','g','s','-','f','i','p','s','.','{','R','e','g','i','o','n','}',
...
'o','g','s','.','u','s','-','g','o','v','-','e','a','s','t','-','1','.','a','m','a','z','o','n','a',
...
'u','r','l','"',':','"','h','t','t','p','s',':','/','/','l','o','g','s','.','u','s','-','g','o','v',
...
'{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','l','o','g','s','-','f','i','p','s',
...
const char* CloudWatchLogsEndpointRules::GetRulesBlob()
{
