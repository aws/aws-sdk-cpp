...
class AWS_IOT_API IoTClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  IoTClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<IoTEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * A Callable wrapper for AcceptCertificateTransfer that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename AcceptCertificateTransferRequestT = Model::AcceptCertificateTransferRequest>
  Model::AcceptCertificateTransferOutcomeCallable AcceptCertificateTransferCallable(
      const AcceptCertificateTransferRequestT& request) const {
    return SubmitCallable(&IoTClient::AcceptCertificateTransfer, request);
  }

  /**
   * An Async wrapper for AcceptCertificateTransfer that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AcceptCertificateTransferRequestT = Model::AcceptCertificateTransferRequest>
  void AcceptCertificateTransferAsync(const AcceptCertificateTransferRequestT& request,
  ...
  /**
   * A Callable wrapper for AddThingToBillingGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AddThingToBillingGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AddThingToBillingGroupRequestT = Model::AddThingToBillingGroupRequest>
  void AddThingToBillingGroupAsync(const AddThingToBillingGroupResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const AddThingToBillingGroupRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for AddThingToThingGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AddThingToThingGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AddThingToThingGroupRequestT = Model::AddThingToThingGroupRequest>
  void AddThingToThingGroupAsync(const AddThingToThingGroupResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const AddThingToThingGroupRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::AssociateSbomWithPackageVersionOutcome AssociateSbomWithPackageVersion(
      const Model::AssociateSbomWithPackageVersionRequest& request) const;

  /**
   * A Callable wrapper for AssociateSbomWithPackageVersion that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AssociateSbomWithPackageVersionRequestT = Model::AssociateSbomWithPackageVersionRequest>
  Model::AssociateSbomWithPackageVersionOutcomeCallable AssociateSbomWithPackageVersionCallable(
      const AssociateSbomWithPackageVersionRequestT& request) const {
    return SubmitCallable(&IoTClient::AssociateSbomWithPackageVersion, request);
  }

  /**
   * An Async wrapper for AssociateSbomWithPackageVersion that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename AssociateSbomWithPackageVersionRequestT = Model::AssociateSbomWithPackageVersionRequest>
  void AssociateSbomWithPackageVersionAsync(const AssociateSbomWithPackageVersionRequestT& request,
                                            const AssociateSbomWithPackageVersionResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for AssociateTargetsWithJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssociateTargetsWithJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateTargetsWithJobRequestT = Model::AssociateTargetsWithJobRequest>
  void AssociateTargetsWithJobAsync(const AssociateTargetsWithJobRequestT& request,
  ...
  /**
   *  <p>The IoT Device Defender detect feature will no longer be available to
   * new customers starting August 31, 2026. If you would like to use the detect
   * feature, sign up prior to August 31, 2026. To learn about alternatives to IoT
   * Device Defender detect, see IoT Device Defender detect feature availability
   * change in the IoT Device Defender Developer Guide. There is no change to IoT
   * Device Defender audit availability.</p>  <p>Associates a Device Defender
   * security profile with a thing group or this account. Each thing group or account
   * can have up to five security profiles associated with it.</p> <p>Requires
   * permission to access the <a
  ...
  /**
   * A Callable wrapper for AttachSecurityProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AttachSecurityProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AttachSecurityProfileRequestT = Model::AttachSecurityProfileRequest>
  void AttachSecurityProfileAsync(const AttachSecurityProfileRequestT& request, const AttachSecurityProfileResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for AttachThingPrincipal that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AttachThingPrincipal that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AttachThingPrincipalRequestT = Model::AttachThingPrincipalRequest>
  void AttachThingPrincipalAsync(const AttachThingPrincipalRequestT& request, const AttachThingPrincipalResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CancelAuditMitigationActionsTaskOutcome CancelAuditMitigationActionsTask(
      const Model::CancelAuditMitigationActionsTaskRequest& request) const;

  /**
   * A Callable wrapper for CancelAuditMitigationActionsTask that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename CancelAuditMitigationActionsTaskRequestT = Model::CancelAuditMitigationActionsTaskRequest>
  Model::CancelAuditMitigationActionsTaskOutcomeCallable CancelAuditMitigationActionsTaskCallable(
      const CancelAuditMitigationActionsTaskRequestT& request) const {
    return SubmitCallable(&IoTClient::CancelAuditMitigationActionsTask, request);
  }

  /**
   * An Async wrapper for CancelAuditMitigationActionsTask that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CancelAuditMitigationActionsTaskRequestT = Model::CancelAuditMitigationActionsTaskRequest>
  void CancelAuditMitigationActionsTaskAsync(const CancelAuditMitigationActionsTaskRequestT& request,
  ...
  /**
   * An Async wrapper for CancelAuditTask that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CancelAuditTaskRequestT = Model::CancelAuditTaskRequest>
  void CancelAuditTaskAsync(const CancelAuditTaskRequestT& request, const CancelAuditTaskResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CancelCertificateTransfer that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CancelCertificateTransferRequestT = Model::CancelCertificateTransferRequest>
  Model::CancelCertificateTransferOutcomeCallable CancelCertificateTransferCallable(
      const CancelCertificateTransferRequestT& request) const {
    return SubmitCallable(&IoTClient::CancelCertificateTransfer, request);
  }

  /**
   * An Async wrapper for CancelCertificateTransfer that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CancelCertificateTransferRequestT = Model::CancelCertificateTransferRequest>
  void CancelCertificateTransferAsync(const CancelCertificateTransferRequestT& request,
   ...
   * Device Defender detect, see IoT Device Defender detect feature availability
   * change in the IoT Device Defender Developer Guide. There is no change to IoT
   * Device Defender audit availability.</p>  <p> Cancels a Device Defender ML
   * Detect mitigation action. </p> <p>Requires permission to access the <a
   ...
   * API Reference</a></p>
   */
  virtual Model::CancelDetectMitigationActionsTaskOutcome CancelDetectMitigationActionsTask(
      const Model::CancelDetectMitigationActionsTaskRequest& request) const;

  /**
   * A Callable wrapper for CancelDetectMitigationActionsTask that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename CancelDetectMitigationActionsTaskRequestT = Model::CancelDetectMitigationActionsTaskRequest>
  Model::CancelDetectMitigationActionsTaskOutcomeCallable CancelDetectMitigationActionsTaskCallable(
      const CancelDetectMitigationActionsTaskRequestT& request) const {
    return SubmitCallable(&IoTClient::CancelDetectMitigationActionsTask, request);
  }

  /**
   * An Async wrapper for CancelDetectMitigationActionsTask that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CancelDetectMitigationActionsTaskRequestT = Model::CancelDetectMitigationActionsTaskRequest>
  void CancelDetectMitigationActionsTaskAsync(const CancelDetectMitigationActionsTaskRequestT& request,
  ...
  /**
   * A Callable wrapper for CancelJobExecution that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CancelJobExecution that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CancelJobExecutionRequestT = Model::CancelJobExecutionRequest>
  void CancelJobExecutionAsync(const CancelJobExecutionRequestT& request, const CancelJobExecutionResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ClearDefaultAuthorizer that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ClearDefaultAuthorizer that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ClearDefaultAuthorizerRequestT = Model::ClearDefaultAuthorizerRequest>
  void ClearDefaultAuthorizerAsync(const ClearDefaultAuthorizerResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const ClearDefaultAuthorizerRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ConfirmTopicRuleDestinationOutcome ConfirmTopicRuleDestination(
      const Model::ConfirmTopicRuleDestinationRequest& request) const;

  /**
   * A Callable wrapper for ConfirmTopicRuleDestination that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ConfirmTopicRuleDestinationRequestT = Model::ConfirmTopicRuleDestinationRequest>
  Model::ConfirmTopicRuleDestinationOutcomeCallable ConfirmTopicRuleDestinationCallable(
      const ConfirmTopicRuleDestinationRequestT& request) const {
    return SubmitCallable(&IoTClient::ConfirmTopicRuleDestination, request);
  }

  /**
   * An Async wrapper for ConfirmTopicRuleDestination that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ConfirmTopicRuleDestinationRequestT = Model::ConfirmTopicRuleDestinationRequest>
  void ConfirmTopicRuleDestinationAsync(const ConfirmTopicRuleDestinationRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateAuditSuppression that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateAuditSuppression that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateAuditSuppressionRequestT = Model::CreateAuditSuppressionRequest>
  void CreateAuditSuppressionAsync(const CreateAuditSuppressionRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateCertificateFromCsr that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateCertificateFromCsr that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateCertificateFromCsrRequestT = Model::CreateCertificateFromCsrRequest>
  void CreateCertificateFromCsrAsync(const CreateCertificateFromCsrRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateCertificateProvider that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CreateCertificateProviderRequestT = Model::CreateCertificateProviderRequest>
  Model::CreateCertificateProviderOutcomeCallable CreateCertificateProviderCallable(
      const CreateCertificateProviderRequestT& request) const {
    return SubmitCallable(&IoTClient::CreateCertificateProvider, request);
  }

  /**
   * An Async wrapper for CreateCertificateProvider that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateCertificateProviderRequestT = Model::CreateCertificateProviderRequest>
  void CreateCertificateProviderAsync(const CreateCertificateProviderRequestT& request,
                                      const CreateCertificateProviderResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateCommand that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateCommandRequestT = Model::CreateCommandRequest>
  void CreateCommandAsync(const CreateCommandRequestT& request, const CreateCommandResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * Device Defender detect, see IoT Device Defender detect feature availability
   * change in the IoT Device Defender Developer Guide. There is no change to IoT
   * Device Defender audit availability.</p>  <p> Use this API to define a
   * Custom Metric published by your devices to Device Defender. </p> <p>Requires
   * permission to access the <a
  ...
  /**
   * A Callable wrapper for CreateCustomMetric that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateCustomMetric that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateCustomMetricRequestT = Model::CreateCustomMetricRequest>
  void CreateCustomMetricAsync(const CreateCustomMetricRequestT& request, const CreateCustomMetricResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * Device Defender detect, see IoT Device Defender detect feature availability
   * change in the IoT Device Defender Developer Guide. There is no change to IoT
   * Device Defender audit availability.</p>  <p>Create a dimension that you
   * can use to limit the scope of a metric used in a security profile for IoT Device
   * Defender. For example, using a <code>TOPIC_FILTER</code> dimension, you can
   * narrow down the scope of the metric only to MQTT topics whose name match the
   * pattern specified in the dimension.</p> <p>Requires permission to access the <a
  ...
  /**
   * An Async wrapper for CreateDimension that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateDimensionRequestT = Model::CreateDimensionRequest>
  void CreateDimensionAsync(const CreateDimensionRequestT& request, const CreateDimensionResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateDomainConfiguration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CreateDomainConfigurationRequestT = Model::CreateDomainConfigurationRequest>
  Model::CreateDomainConfigurationOutcomeCallable CreateDomainConfigurationCallable(
      const CreateDomainConfigurationRequestT& request) const {
    return SubmitCallable(&IoTClient::CreateDomainConfiguration, request);
  }

  /**
   * An Async wrapper for CreateDomainConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateDomainConfigurationRequestT = Model::CreateDomainConfigurationRequest>
  void CreateDomainConfigurationAsync(const CreateDomainConfigurationRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateDynamicThingGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateDynamicThingGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateDynamicThingGroupRequestT = Model::CreateDynamicThingGroupRequest>
  void CreateDynamicThingGroupAsync(const CreateDynamicThingGroupRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateFleetMetric that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateFleetMetric that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateFleetMetricRequestT = Model::CreateFleetMetricRequest>
  void CreateFleetMetricAsync(const CreateFleetMetricRequestT& request, const CreateFleetMetricResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateKeysAndCertificate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CreateKeysAndCertificateRequestT = Model::CreateKeysAndCertificateRequest>
  Model::CreateKeysAndCertificateOutcomeCallable CreateKeysAndCertificateCallable(
      const CreateKeysAndCertificateRequestT& request = {}) const {
    return SubmitCallable(&IoTClient::CreateKeysAndCertificate, request);
  }

  /**
   * An Async wrapper for CreateKeysAndCertificate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateKeysAndCertificateRequestT = Model::CreateKeysAndCertificateRequest>
  void CreateKeysAndCertificateAsync(const CreateKeysAndCertificateResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const CreateKeysAndCertificateRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for CreateMitigationAction that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateMitigationAction that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateMitigationActionRequestT = Model::CreateMitigationActionRequest>
  void CreateMitigationActionAsync(const CreateMitigationActionRequestT& request,
  ...
  /**
   * An Async wrapper for CreateOTAUpdate that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateOTAUpdateRequestT = Model::CreateOTAUpdateRequest>
  void CreateOTAUpdateAsync(const CreateOTAUpdateRequestT& request, const CreateOTAUpdateResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreatePackageVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreatePackageVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreatePackageVersionRequestT = Model::CreatePackageVersionRequest>
  void CreatePackageVersionAsync(const CreatePackageVersionRequestT& request, const CreatePackageVersionResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateProvisioningClaim that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateProvisioningClaim that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateProvisioningClaimRequestT = Model::CreateProvisioningClaimRequest>
  void CreateProvisioningClaimAsync(const CreateProvisioningClaimRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateProvisioningTemplateOutcome CreateProvisioningTemplate(
      const Model::CreateProvisioningTemplateRequest& request) const;

  /**
   * A Callable wrapper for CreateProvisioningTemplate that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateProvisioningTemplateRequestT = Model::CreateProvisioningTemplateRequest>
  Model::CreateProvisioningTemplateOutcomeCallable CreateProvisioningTemplateCallable(
      const CreateProvisioningTemplateRequestT& request) const {
    return SubmitCallable(&IoTClient::CreateProvisioningTemplate, request);
  }

  /**
   * An Async wrapper for CreateProvisioningTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateProvisioningTemplateRequestT = Model::CreateProvisioningTemplateRequest>
  void CreateProvisioningTemplateAsync(const CreateProvisioningTemplateRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateProvisioningTemplateVersionOutcome CreateProvisioningTemplateVersion(
      const Model::CreateProvisioningTemplateVersionRequest& request) const;

  /**
   * A Callable wrapper for CreateProvisioningTemplateVersion that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename CreateProvisioningTemplateVersionRequestT = Model::CreateProvisioningTemplateVersionRequest>
  Model::CreateProvisioningTemplateVersionOutcomeCallable CreateProvisioningTemplateVersionCallable(
      const CreateProvisioningTemplateVersionRequestT& request) const {
    return SubmitCallable(&IoTClient::CreateProvisioningTemplateVersion, request);
  }

  /**
   * An Async wrapper for CreateProvisioningTemplateVersion that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateProvisioningTemplateVersionRequestT = Model::CreateProvisioningTemplateVersionRequest>
  void CreateProvisioningTemplateVersionAsync(const CreateProvisioningTemplateVersionRequestT& request,
  ...
  /**
   * An Async wrapper for CreateRoleAlias that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateRoleAliasRequestT = Model::CreateRoleAliasRequest>
  void CreateRoleAliasAsync(const CreateRoleAliasRequestT& request, const CreateRoleAliasResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateScheduledAudit that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateScheduledAudit that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateScheduledAuditRequestT = Model::CreateScheduledAuditRequest>
  void CreateScheduledAuditAsync(const CreateScheduledAuditRequestT& request, const CreateScheduledAuditResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * Device Defender detect, see IoT Device Defender detect feature availability
   * change in the IoT Device Defender Developer Guide. There is no change to IoT
   * Device Defender audit availability.</p>  <p>Creates a Device Defender
  ...
  /**
   * An Async wrapper for CreateThing that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateThingRequestT = Model::CreateThingRequest>
  void CreateThingAsync(const CreateThingRequestT& request, const CreateThingResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateThingGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateThingGroup that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateThingGroupRequestT = Model::CreateThingGroupRequest>
  void CreateThingGroupAsync(const CreateThingGroupRequestT& request, const CreateThingGroupResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateThingType that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateThingTypeRequestT = Model::CreateThingTypeRequest>
  void CreateThingTypeAsync(const CreateThingTypeRequestT& request, const CreateThingTypeResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateTopicRule that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateTopicRuleRequestT = Model::CreateTopicRuleRequest>
  void CreateTopicRuleAsync(const CreateTopicRuleRequestT& request, const CreateTopicRuleResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateTopicRuleDestinationOutcome CreateTopicRuleDestination(
      const Model::CreateTopicRuleDestinationRequest& request) const;

  /**
   * A Callable wrapper for CreateTopicRuleDestination that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateTopicRuleDestinationRequestT = Model::CreateTopicRuleDestinationRequest>
  Model::CreateTopicRuleDestinationOutcomeCallable CreateTopicRuleDestinationCallable(
      const CreateTopicRuleDestinationRequestT& request) const {
    return SubmitCallable(&IoTClient::CreateTopicRuleDestination, request);
  }

  /**
   * An Async wrapper for CreateTopicRuleDestination that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateTopicRuleDestinationRequestT = Model::CreateTopicRuleDestinationRequest>
  void CreateTopicRuleDestinationAsync(const CreateTopicRuleDestinationRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteAccountAuditConfigurationOutcome DeleteAccountAuditConfiguration(
      const Model::DeleteAccountAuditConfigurationRequest& request = {}) const;

  /**
   * A Callable wrapper for DeleteAccountAuditConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteAccountAuditConfigurationRequestT = Model::DeleteAccountAuditConfigurationRequest>
  Model::DeleteAccountAuditConfigurationOutcomeCallable DeleteAccountAuditConfigurationCallable(
      const DeleteAccountAuditConfigurationRequestT& request = {}) const {
    return SubmitCallable(&IoTClient::DeleteAccountAuditConfiguration, request);
  }

  /**
   * An Async wrapper for DeleteAccountAuditConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteAccountAuditConfigurationRequestT = Model::DeleteAccountAuditConfigurationRequest>
  void DeleteAccountAuditConfigurationAsync(const DeleteAccountAuditConfigurationResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                            const DeleteAccountAuditConfigurationRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DeleteAuditSuppression that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteAuditSuppression that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteAuditSuppressionRequestT = Model::DeleteAuditSuppressionRequest>
  void DeleteAuditSuppressionAsync(const DeleteAuditSuppressionRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteCACertificate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteCACertificate that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteCACertificateRequestT = Model::DeleteCACertificateRequest>
  void DeleteCACertificateAsync(const DeleteCACertificateRequestT& request, const DeleteCACertificateResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteCertificateProvider that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DeleteCertificateProviderRequestT = Model::DeleteCertificateProviderRequest>
  Model::DeleteCertificateProviderOutcomeCallable DeleteCertificateProviderCallable(
      const DeleteCertificateProviderRequestT& request) const {
    return SubmitCallable(&IoTClient::DeleteCertificateProvider, request);
  }

  /**
   * An Async wrapper for DeleteCertificateProvider that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteCertificateProviderRequestT = Model::DeleteCertificateProviderRequest>
  void DeleteCertificateProviderAsync(const DeleteCertificateProviderRequestT& request,
                                      const DeleteCertificateProviderResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteCommand that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteCommandRequestT = Model::DeleteCommandRequest>
  void DeleteCommandAsync(const DeleteCommandRequestT& request, const DeleteCommandResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteCommandExecution that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteCommandExecution that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteCommandExecutionRequestT = Model::DeleteCommandExecutionRequest>
  void DeleteCommandExecutionAsync(const DeleteCommandExecutionRequestT& request,
                                   const DeleteCommandExecutionResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * Device Defender detect, see IoT Device Defender detect feature availability
   * change in the IoT Device Defender Developer Guide. There is no change to IoT
   * Device Defender audit availability.</p>  <p> Deletes a Device Defender
   * detect custom metric. </p> <p>Requires permission to access the <a
  ...
  /**
   * A Callable wrapper for DeleteCustomMetric that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteCustomMetric that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteCustomMetricRequestT = Model::DeleteCustomMetricRequest>
  void DeleteCustomMetricAsync(const DeleteCustomMetricRequestT& request, const DeleteCustomMetricResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * Device Defender detect, see IoT Device Defender detect feature availability
   * change in the IoT Device Defender Developer Guide. There is no change to IoT
   * Device Defender audit availability.</p>  <p>Removes the specified
   * dimension from your Amazon Web Services accounts.</p> <p>Requires permission to
   * access the <a
  ...
  /**
   * An Async wrapper for DeleteDimension that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteDimensionRequestT = Model::DeleteDimensionRequest>
  void DeleteDimensionAsync(const DeleteDimensionRequestT& request, const DeleteDimensionResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteDomainConfiguration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DeleteDomainConfigurationRequestT = Model::DeleteDomainConfigurationRequest>
  Model::DeleteDomainConfigurationOutcomeCallable DeleteDomainConfigurationCallable(
      const DeleteDomainConfigurationRequestT& request) const {
    return SubmitCallable(&IoTClient::DeleteDomainConfiguration, request);
  }

  /**
   * An Async wrapper for DeleteDomainConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteDomainConfigurationRequestT = Model::DeleteDomainConfigurationRequest>
  void DeleteDomainConfigurationAsync(const DeleteDomainConfigurationRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteDynamicThingGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteDynamicThingGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteDynamicThingGroupRequestT = Model::DeleteDynamicThingGroupRequest>
  void DeleteDynamicThingGroupAsync(const DeleteDynamicThingGroupRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteFleetMetric that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteFleetMetric that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteFleetMetricRequestT = Model::DeleteFleetMetricRequest>
  void DeleteFleetMetricAsync(const DeleteFleetMetricRequestT& request, const DeleteFleetMetricResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteJobExecution that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteJobExecution that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteJobExecutionRequestT = Model::DeleteJobExecutionRequest>
  void DeleteJobExecutionAsync(const DeleteJobExecutionRequestT& request, const DeleteJobExecutionResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteMitigationAction that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteMitigationAction that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteMitigationActionRequestT = Model::DeleteMitigationActionRequest>
  void DeleteMitigationActionAsync(const DeleteMitigationActionRequestT& request,
  ...
  /**
   * An Async wrapper for DeleteOTAUpdate that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteOTAUpdateRequestT = Model::DeleteOTAUpdateRequest>
  void DeleteOTAUpdateAsync(const DeleteOTAUpdateRequestT& request, const DeleteOTAUpdateResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeletePackageVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeletePackageVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeletePackageVersionRequestT = Model::DeletePackageVersionRequest>
  void DeletePackageVersionAsync(const DeletePackageVersionRequestT& request, const DeletePackageVersionResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::DeleteProvisioningTemplateOutcome DeleteProvisioningTemplate(
      const Model::DeleteProvisioningTemplateRequest& request) const;

  /**
   * A Callable wrapper for DeleteProvisioningTemplate that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteProvisioningTemplateRequestT = Model::DeleteProvisioningTemplateRequest>
  Model::DeleteProvisioningTemplateOutcomeCallable DeleteProvisioningTemplateCallable(
      const DeleteProvisioningTemplateRequestT& request) const {
    return SubmitCallable(&IoTClient::DeleteProvisioningTemplate, request);
  }

  /**
   * An Async wrapper for DeleteProvisioningTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteProvisioningTemplateRequestT = Model::DeleteProvisioningTemplateRequest>
  void DeleteProvisioningTemplateAsync(const DeleteProvisioningTemplateRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteProvisioningTemplateVersionOutcome DeleteProvisioningTemplateVersion(
      const Model::DeleteProvisioningTemplateVersionRequest& request) const;

  /**
   * A Callable wrapper for DeleteProvisioningTemplateVersion that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DeleteProvisioningTemplateVersionRequestT = Model::DeleteProvisioningTemplateVersionRequest>
  Model::DeleteProvisioningTemplateVersionOutcomeCallable DeleteProvisioningTemplateVersionCallable(
      const DeleteProvisioningTemplateVersionRequestT& request) const {
    return SubmitCallable(&IoTClient::DeleteProvisioningTemplateVersion, request);
  }

  /**
   * An Async wrapper for DeleteProvisioningTemplateVersion that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteProvisioningTemplateVersionRequestT = Model::DeleteProvisioningTemplateVersionRequest>
  void DeleteProvisioningTemplateVersionAsync(const DeleteProvisioningTemplateVersionRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteRegistrationCode that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteRegistrationCode that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteRegistrationCodeRequestT = Model::DeleteRegistrationCodeRequest>
  void DeleteRegistrationCodeAsync(const DeleteRegistrationCodeResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const DeleteRegistrationCodeRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for DeleteRoleAlias that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteRoleAliasRequestT = Model::DeleteRoleAliasRequest>
  void DeleteRoleAliasAsync(const DeleteRoleAliasRequestT& request, const DeleteRoleAliasResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteScheduledAudit that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteScheduledAudit that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteScheduledAuditRequestT = Model::DeleteScheduledAuditRequest>
  void DeleteScheduledAuditAsync(const DeleteScheduledAuditRequestT& request, const DeleteScheduledAuditResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteThing that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteThingRequestT = Model::DeleteThingRequest>
  void DeleteThingAsync(const DeleteThingRequestT& request, const DeleteThingResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteThingGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteThingGroup that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteThingGroupRequestT = Model::DeleteThingGroupRequest>
  void DeleteThingGroupAsync(const DeleteThingGroupRequestT& request, const DeleteThingGroupResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteThingType that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteThingTypeRequestT = Model::DeleteThingTypeRequest>
  void DeleteThingTypeAsync(const DeleteThingTypeRequestT& request, const DeleteThingTypeResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteTopicRule that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteTopicRuleRequestT = Model::DeleteTopicRuleRequest>
  void DeleteTopicRuleAsync(const DeleteTopicRuleRequestT& request, const DeleteTopicRuleResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteTopicRuleDestinationOutcome DeleteTopicRuleDestination(
      const Model::DeleteTopicRuleDestinationRequest& request) const;

  /**
   * A Callable wrapper for DeleteTopicRuleDestination that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteTopicRuleDestinationRequestT = Model::DeleteTopicRuleDestinationRequest>
  Model::DeleteTopicRuleDestinationOutcomeCallable DeleteTopicRuleDestinationCallable(
      const DeleteTopicRuleDestinationRequestT& request) const {
    return SubmitCallable(&IoTClient::DeleteTopicRuleDestination, request);
  }

  /**
   * An Async wrapper for DeleteTopicRuleDestination that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteTopicRuleDestinationRequestT = Model::DeleteTopicRuleDestinationRequest>
  void DeleteTopicRuleDestinationAsync(const DeleteTopicRuleDestinationRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteV2LoggingLevel that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteV2LoggingLevel that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteV2LoggingLevelRequestT = Model::DeleteV2LoggingLevelRequest>
  void DeleteV2LoggingLevelAsync(const DeleteV2LoggingLevelRequestT& request, const DeleteV2LoggingLevelResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeprecateThingType that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeprecateThingType that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeprecateThingTypeRequestT = Model::DeprecateThingTypeRequest>
  void DeprecateThingTypeAsync(const DeprecateThingTypeRequestT& request, const DeprecateThingTypeResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeAccountAuditConfigurationOutcome DescribeAccountAuditConfiguration(
      const Model::DescribeAccountAuditConfigurationRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeAccountAuditConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeAccountAuditConfigurationRequestT = Model::DescribeAccountAuditConfigurationRequest>
  Model::DescribeAccountAuditConfigurationOutcomeCallable DescribeAccountAuditConfigurationCallable(
      const DescribeAccountAuditConfigurationRequestT& request = {}) const {
    return SubmitCallable(&IoTClient::DescribeAccountAuditConfiguration, request);
  }

  /**
   * An Async wrapper for DescribeAccountAuditConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeAccountAuditConfigurationRequestT = Model::DescribeAccountAuditConfigurationRequest>
  void DescribeAccountAuditConfigurationAsync(const DescribeAccountAuditConfigurationResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                              const DescribeAccountAuditConfigurationRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeAuditFinding that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeAuditFinding that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeAuditFindingRequestT = Model::DescribeAuditFindingRequest>
  void DescribeAuditFindingAsync(const DescribeAuditFindingRequestT& request, const DescribeAuditFindingResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeAuditMitigationActionsTaskOutcome DescribeAuditMitigationActionsTask(
      const Model::DescribeAuditMitigationActionsTaskRequest& request) const;

  /**
   * A Callable wrapper for DescribeAuditMitigationActionsTask that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeAuditMitigationActionsTaskRequestT = Model::DescribeAuditMitigationActionsTaskRequest>
  Model::DescribeAuditMitigationActionsTaskOutcomeCallable DescribeAuditMitigationActionsTaskCallable(
      const DescribeAuditMitigationActionsTaskRequestT& request) const {
    return SubmitCallable(&IoTClient::DescribeAuditMitigationActionsTask, request);
  }

  /**
   * An Async wrapper for DescribeAuditMitigationActionsTask that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeAuditMitigationActionsTaskRequestT = Model::DescribeAuditMitigationActionsTaskRequest>
  void DescribeAuditMitigationActionsTaskAsync(const DescribeAuditMitigationActionsTaskRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeAuditSuppression that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeAuditSuppression that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeAuditSuppressionRequestT = Model::DescribeAuditSuppressionRequest>
  void DescribeAuditSuppressionAsync(const DescribeAuditSuppressionRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeAuditTask that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeAuditTask that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeAuditTaskRequestT = Model::DescribeAuditTaskRequest>
  void DescribeAuditTaskAsync(const DescribeAuditTaskRequestT& request, const DescribeAuditTaskResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeAuthorizer that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeAuthorizer that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeAuthorizerRequestT = Model::DescribeAuthorizerRequest>
  void DescribeAuthorizerAsync(const DescribeAuthorizerRequestT& request, const DescribeAuthorizerResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeBillingGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeBillingGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeBillingGroupRequestT = Model::DescribeBillingGroupRequest>
  void DescribeBillingGroupAsync(const DescribeBillingGroupRequestT& request, const DescribeBillingGroupResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeCACertificate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeCACertificate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeCACertificateRequestT = Model::DescribeCACertificateRequest>
  void DescribeCACertificateAsync(const DescribeCACertificateRequestT& request, const DescribeCACertificateResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeCertificateProviderOutcome DescribeCertificateProvider(
      const Model::DescribeCertificateProviderRequest& request) const;

  /**
   * A Callable wrapper for DescribeCertificateProvider that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeCertificateProviderRequestT = Model::DescribeCertificateProviderRequest>
  Model::DescribeCertificateProviderOutcomeCallable DescribeCertificateProviderCallable(
      const DescribeCertificateProviderRequestT& request) const {
    return SubmitCallable(&IoTClient::DescribeCertificateProvider, request);
  }

  /**
   * An Async wrapper for DescribeCertificateProvider that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeCertificateProviderRequestT = Model::DescribeCertificateProviderRequest>
  void DescribeCertificateProviderAsync(const DescribeCertificateProviderRequestT& request,
                                        const DescribeCertificateProviderResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * Device Defender detect, see IoT Device Defender detect feature availability
   * change in the IoT Device Defender Developer Guide. There is no change to IoT
   * Device Defender audit availability.</p>  <p> Gets information about a
   * Device Defender detect custom metric. </p> <p>Requires permission to access the
   * <a
  ...
  /**
   * A Callable wrapper for DescribeCustomMetric that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeCustomMetric that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeCustomMetricRequestT = Model::DescribeCustomMetricRequest>
  void DescribeCustomMetricAsync(const DescribeCustomMetricRequestT& request, const DescribeCustomMetricResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeDefaultAuthorizerOutcome DescribeDefaultAuthorizer(
      const Model::DescribeDefaultAuthorizerRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeDefaultAuthorizer that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeDefaultAuthorizerRequestT = Model::DescribeDefaultAuthorizerRequest>
  Model::DescribeDefaultAuthorizerOutcomeCallable DescribeDefaultAuthorizerCallable(
      const DescribeDefaultAuthorizerRequestT& request = {}) const {
    return SubmitCallable(&IoTClient::DescribeDefaultAuthorizer, request);
  }

  /**
   * An Async wrapper for DescribeDefaultAuthorizer that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeDefaultAuthorizerRequestT = Model::DescribeDefaultAuthorizerRequest>
  void DescribeDefaultAuthorizerAsync(const DescribeDefaultAuthorizerResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const DescribeDefaultAuthorizerRequestT& request = {}) const {
   ...
   * change in the IoT Device Defender Developer Guide. There is no change to IoT
   * Device Defender audit availability.</p>  <p> Gets information about a
   * Device Defender ML Detect mitigation action. </p> <p>Requires permission to
   * access the <a
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeDetectMitigationActionsTaskOutcome DescribeDetectMitigationActionsTask(
      const Model::DescribeDetectMitigationActionsTaskRequest& request) const;

  /**
   * A Callable wrapper for DescribeDetectMitigationActionsTask that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DescribeDetectMitigationActionsTaskRequestT = Model::DescribeDetectMitigationActionsTaskRequest>
  Model::DescribeDetectMitigationActionsTaskOutcomeCallable DescribeDetectMitigationActionsTaskCallable(
      const DescribeDetectMitigationActionsTaskRequestT& request) const {
    return SubmitCallable(&IoTClient::DescribeDetectMitigationActionsTask, request);
  }

  /**
   * An Async wrapper for DescribeDetectMitigationActionsTask that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeDetectMitigationActionsTaskRequestT = Model::DescribeDetectMitigationActionsTaskRequest>
  void DescribeDetectMitigationActionsTaskAsync(const DescribeDetectMitigationActionsTaskRequestT& request,
                                                const DescribeDetectMitigationActionsTaskResponseReceivedHandler& handler,
                                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * Device Defender detect, see IoT Device Defender detect feature availability
   * change in the IoT Device Defender Developer Guide. There is no change to IoT
   * Device Defender audit availability.</p>  <p>Provides details about a
   * dimension that is defined in your Amazon Web Services accounts.</p> <p>Requires
   * permission to access the <a
  ...
  /**
   * A Callable wrapper for DescribeDimension that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeDimension that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeDimensionRequestT = Model::DescribeDimensionRequest>
  void DescribeDimensionAsync(const DescribeDimensionRequestT& request, const DescribeDimensionResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeDomainConfigurationOutcome DescribeDomainConfiguration(
      const Model::DescribeDomainConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DescribeDomainConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeDomainConfigurationRequestT = Model::DescribeDomainConfigurationRequest>
  Model::DescribeDomainConfigurationOutcomeCallable DescribeDomainConfigurationCallable(
      const DescribeDomainConfigurationRequestT& request) const {
    return SubmitCallable(&IoTClient::DescribeDomainConfiguration, request);
  }

  /**
   * An Async wrapper for DescribeDomainConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeDomainConfigurationRequestT = Model::DescribeDomainConfigurationRequest>
  void DescribeDomainConfigurationAsync(const DescribeDomainConfigurationRequestT& request,
                                        const DescribeDomainConfigurationResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * <a
   * href="https://docs.aws.amazon.com/iot/latest/developerguide/encryption-at-rest.html">Data
   * encryption at rest</a> in the <i>Amazon Web Services IoT Core Developer
   * Guide</i>.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/iot-2015-05-28/DescribeEncryptionConfiguration">AWS
   * API Reference</a></p>
   */
  virtual Model::DescribeEncryptionConfigurationOutcome DescribeEncryptionConfiguration(
      const Model::DescribeEncryptionConfigurationRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeEncryptionConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeEncryptionConfigurationRequestT = Model::DescribeEncryptionConfigurationRequest>
  Model::DescribeEncryptionConfigurationOutcomeCallable DescribeEncryptionConfigurationCallable(
      const DescribeEncryptionConfigurationRequestT& request = {}) const {
    return SubmitCallable(&IoTClient::DescribeEncryptionConfiguration, request);
  }

  /**
   * An Async wrapper for DescribeEncryptionConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeEncryptionConfigurationRequestT = Model::DescribeEncryptionConfigurationRequest>
  void DescribeEncryptionConfigurationAsync(const DescribeEncryptionConfigurationResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                            const DescribeEncryptionConfigurationRequestT& request = {}) const {
   ...
   */
  template <typename DescribeEndpointRequestT = Model::DescribeEndpointRequest>
  void DescribeEndpointAsync(const DescribeEndpointResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const DescribeEndpointRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeEventConfigurationsOutcome DescribeEventConfigurations(
      const Model::DescribeEventConfigurationsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeEventConfigurations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeEventConfigurationsRequestT = Model::DescribeEventConfigurationsRequest>
  Model::DescribeEventConfigurationsOutcomeCallable DescribeEventConfigurationsCallable(
      const DescribeEventConfigurationsRequestT& request = {}) const {
    return SubmitCallable(&IoTClient::DescribeEventConfigurations, request);
  }

  /**
   * An Async wrapper for DescribeEventConfigurations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeEventConfigurationsRequestT = Model::DescribeEventConfigurationsRequest>
  void DescribeEventConfigurationsAsync(const DescribeEventConfigurationsResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                        const DescribeEventConfigurationsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeFleetMetric that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeFleetMetric that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeFleetMetricRequestT = Model::DescribeFleetMetricRequest>
  void DescribeFleetMetricAsync(const DescribeFleetMetricRequestT& request, const DescribeFleetMetricResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeManagedJobTemplateOutcome DescribeManagedJobTemplate(
      const Model::DescribeManagedJobTemplateRequest& request) const;

  /**
   * A Callable wrapper for DescribeManagedJobTemplate that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeManagedJobTemplateRequestT = Model::DescribeManagedJobTemplateRequest>
  Model::DescribeManagedJobTemplateOutcomeCallable DescribeManagedJobTemplateCallable(
      const DescribeManagedJobTemplateRequestT& request) const {
    return SubmitCallable(&IoTClient::DescribeManagedJobTemplate, request);
  }

  /**
   * An Async wrapper for DescribeManagedJobTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeManagedJobTemplateRequestT = Model::DescribeManagedJobTemplateRequest>
  void DescribeManagedJobTemplateAsync(const DescribeManagedJobTemplateRequestT& request,
                                       const DescribeManagedJobTemplateResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeMitigationAction that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeMitigationAction that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeMitigationActionRequestT = Model::DescribeMitigationActionRequest>
  void DescribeMitigationActionAsync(const DescribeMitigationActionRequestT& request,
                                     const DescribeMitigationActionResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeProvisioningTemplateOutcome DescribeProvisioningTemplate(
      const Model::DescribeProvisioningTemplateRequest& request) const;

  /**
   * A Callable wrapper for DescribeProvisioningTemplate that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeProvisioningTemplateRequestT = Model::DescribeProvisioningTemplateRequest>
  Model::DescribeProvisioningTemplateOutcomeCallable DescribeProvisioningTemplateCallable(
      const DescribeProvisioningTemplateRequestT& request) const {
    return SubmitCallable(&IoTClient::DescribeProvisioningTemplate, request);
  }

  /**
   * An Async wrapper for DescribeProvisioningTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeProvisioningTemplateRequestT = Model::DescribeProvisioningTemplateRequest>
  void DescribeProvisioningTemplateAsync(const DescribeProvisioningTemplateRequestT& request,
                                         const DescribeProvisioningTemplateResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeProvisioningTemplateVersionOutcome DescribeProvisioningTemplateVersion(
      const Model::DescribeProvisioningTemplateVersionRequest& request) const;

  /**
   * A Callable wrapper for DescribeProvisioningTemplateVersion that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DescribeProvisioningTemplateVersionRequestT = Model::DescribeProvisioningTemplateVersionRequest>
  Model::DescribeProvisioningTemplateVersionOutcomeCallable DescribeProvisioningTemplateVersionCallable(
      const DescribeProvisioningTemplateVersionRequestT& request) const {
    return SubmitCallable(&IoTClient::DescribeProvisioningTemplateVersion, request);
  }

  /**
   * An Async wrapper for DescribeProvisioningTemplateVersion that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeProvisioningTemplateVersionRequestT = Model::DescribeProvisioningTemplateVersionRequest>
  void DescribeProvisioningTemplateVersionAsync(const DescribeProvisioningTemplateVersionRequestT& request,
                                                const DescribeProvisioningTemplateVersionResponseReceivedHandler& handler,
                                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeRoleAlias that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeRoleAlias that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeRoleAliasRequestT = Model::DescribeRoleAliasRequest>
  void DescribeRoleAliasAsync(const DescribeRoleAliasRequestT& request, const DescribeRoleAliasResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeScheduledAudit that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeScheduledAudit that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeScheduledAuditRequestT = Model::DescribeScheduledAuditRequest>
  void DescribeScheduledAuditAsync(const DescribeScheduledAuditRequestT& request,
                                   const DescribeScheduledAuditResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * change in the IoT Device Defender Developer Guide. There is no change to IoT
   * Device Defender audit availability.</p>  <p>Gets information about a
   * Device Defender security profile.</p> <p>Requires permission to access the <a
   ...
   */
  template <typename DescribeStreamRequestT = Model::DescribeStreamRequest>
  void DescribeStreamAsync(const DescribeStreamRequestT& request, const DescribeStreamResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeThing that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeThingRequestT = Model::DescribeThingRequest>
  void DescribeThingAsync(const DescribeThingRequestT& request, const DescribeThingResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeThingGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeThingGroup that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeThingGroupRequestT = Model::DescribeThingGroupRequest>
  void DescribeThingGroupAsync(const DescribeThingGroupRequestT& request, const DescribeThingGroupResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeThingRegistrationTaskOutcome DescribeThingRegistrationTask(
      const Model::DescribeThingRegistrationTaskRequest& request) const;

  /**
   * A Callable wrapper for DescribeThingRegistrationTask that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeThingRegistrationTaskRequestT = Model::DescribeThingRegistrationTaskRequest>
  Model::DescribeThingRegistrationTaskOutcomeCallable DescribeThingRegistrationTaskCallable(
      const DescribeThingRegistrationTaskRequestT& request) const {
    return SubmitCallable(&IoTClient::DescribeThingRegistrationTask, request);
  }

  /**
   * An Async wrapper for DescribeThingRegistrationTask that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeThingRegistrationTaskRequestT = Model::DescribeThingRegistrationTaskRequest>
  void DescribeThingRegistrationTaskAsync(const DescribeThingRegistrationTaskRequestT& request,
                                          const DescribeThingRegistrationTaskResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeThingType that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeThingType that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeThingTypeRequestT = Model::DescribeThingTypeRequest>
  void DescribeThingTypeAsync(const DescribeThingTypeRequestT& request, const DescribeThingTypeResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * Device Defender detect, see IoT Device Defender detect feature availability
   * change in the IoT Device Defender Developer Guide. There is no change to IoT
   * Device Defender audit availability.</p>  <p>Disassociates a Device
   * Defender security profile from a thing group or from this account.</p>
   * <p>Requires permission to access the <a
  ...
  /**
   * A Callable wrapper for DetachSecurityProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DetachSecurityProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DetachSecurityProfileRequestT = Model::DetachSecurityProfileRequest>
  void DetachSecurityProfileAsync(const DetachSecurityProfileRequestT& request, const DetachSecurityProfileResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DetachThingPrincipal that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DetachThingPrincipal that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DetachThingPrincipalRequestT = Model::DetachThingPrincipalRequest>
  void DetachThingPrincipalAsync(const DetachThingPrincipalRequestT& request, const DetachThingPrincipalResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DisableTopicRule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DisableTopicRule that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DisableTopicRuleRequestT = Model::DisableTopicRuleRequest>
  void DisableTopicRuleAsync(const DisableTopicRuleRequestT& request, const DisableTopicRuleResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateSbomFromPackageVersionOutcome DisassociateSbomFromPackageVersion(
      const Model::DisassociateSbomFromPackageVersionRequest& request) const;

  /**
   * A Callable wrapper for DisassociateSbomFromPackageVersion that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DisassociateSbomFromPackageVersionRequestT = Model::DisassociateSbomFromPackageVersionRequest>
  Model::DisassociateSbomFromPackageVersionOutcomeCallable DisassociateSbomFromPackageVersionCallable(
      const DisassociateSbomFromPackageVersionRequestT& request) const {
    return SubmitCallable(&IoTClient::DisassociateSbomFromPackageVersion, request);
  }

  /**
   * An Async wrapper for DisassociateSbomFromPackageVersion that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DisassociateSbomFromPackageVersionRequestT = Model::DisassociateSbomFromPackageVersionRequest>
  void DisassociateSbomFromPackageVersionAsync(const DisassociateSbomFromPackageVersionRequestT& request,
                                               const DisassociateSbomFromPackageVersionResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for EnableTopicRule that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename EnableTopicRuleRequestT = Model::EnableTopicRuleRequest>
  void EnableTopicRuleAsync(const EnableTopicRuleRequestT& request, const EnableTopicRuleResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * Device Defender detect, see IoT Device Defender detect feature availability
   * change in the IoT Device Defender Developer Guide. There is no change to IoT
   * Device Defender audit availability.</p>  <p> Returns a Device Defender's
   * ML Detect Security Profile training model's status. </p> <p>Requires permission
   * to access the <a
   ...
   * API Reference</a></p>
   */
  virtual Model::GetBehaviorModelTrainingSummariesOutcome GetBehaviorModelTrainingSummaries(
      const Model::GetBehaviorModelTrainingSummariesRequest& request = {}) const;

  /**
   * A Callable wrapper for GetBehaviorModelTrainingSummaries that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename GetBehaviorModelTrainingSummariesRequestT = Model::GetBehaviorModelTrainingSummariesRequest>
  Model::GetBehaviorModelTrainingSummariesOutcomeCallable GetBehaviorModelTrainingSummariesCallable(
      const GetBehaviorModelTrainingSummariesRequestT& request = {}) const {
    return SubmitCallable(&IoTClient::GetBehaviorModelTrainingSummaries, request);
  }

  /**
   * An Async wrapper for GetBehaviorModelTrainingSummaries that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetBehaviorModelTrainingSummariesRequestT = Model::GetBehaviorModelTrainingSummariesRequest>
  void GetBehaviorModelTrainingSummariesAsync(const GetBehaviorModelTrainingSummariesResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                              const GetBehaviorModelTrainingSummariesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetBucketsAggregation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetBucketsAggregation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetBucketsAggregationRequestT = Model::GetBucketsAggregationRequest>
  void GetBucketsAggregationAsync(const GetBucketsAggregationRequestT& request, const GetBucketsAggregationResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetCardinality that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetCardinalityRequestT = Model::GetCardinalityRequest>
  void GetCardinalityAsync(const GetCardinalityRequestT& request, const GetCardinalityResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetCommand that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetCommandRequestT = Model::GetCommandRequest>
  void GetCommandAsync(const GetCommandRequestT& request, const GetCommandResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetCommandExecution that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetCommandExecution that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetCommandExecutionRequestT = Model::GetCommandExecutionRequest>
  void GetCommandExecutionAsync(const GetCommandExecutionRequestT& request, const GetCommandExecutionResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetEffectivePolicies that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetEffectivePolicies that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetEffectivePoliciesRequestT = Model::GetEffectivePoliciesRequest>
  void GetEffectivePoliciesAsync(const GetEffectivePoliciesResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const GetEffectivePoliciesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetIndexingConfiguration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename GetIndexingConfigurationRequestT = Model::GetIndexingConfigurationRequest>
  Model::GetIndexingConfigurationOutcomeCallable GetIndexingConfigurationCallable(
      const GetIndexingConfigurationRequestT& request = {}) const {
    return SubmitCallable(&IoTClient::GetIndexingConfiguration, request);
  }

  /**
   * An Async wrapper for GetIndexingConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetIndexingConfigurationRequestT = Model::GetIndexingConfigurationRequest>
  void GetIndexingConfigurationAsync(const GetIndexingConfigurationResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const GetIndexingConfigurationRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetJobDocument that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetJobDocumentRequestT = Model::GetJobDocumentRequest>
  void GetJobDocumentAsync(const GetJobDocumentRequestT& request, const GetJobDocumentResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetOTAUpdate that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetOTAUpdateRequestT = Model::GetOTAUpdateRequest>
  void GetOTAUpdateAsync(const GetOTAUpdateRequestT& request, const GetOTAUpdateResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetPackage that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetPackageRequestT = Model::GetPackageRequest>
  void GetPackageAsync(const GetPackageRequestT& request, const GetPackageResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetPackageConfiguration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetPackageConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetPackageConfigurationRequestT = Model::GetPackageConfigurationRequest>
  void GetPackageConfigurationAsync(const GetPackageConfigurationResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const GetPackageConfigurationRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetPackageVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetPackageVersion that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetPackageVersionRequestT = Model::GetPackageVersionRequest>
  void GetPackageVersionAsync(const GetPackageVersionRequestT& request, const GetPackageVersionResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetPercentiles that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetPercentilesRequestT = Model::GetPercentilesRequest>
  void GetPercentilesAsync(const GetPercentilesRequestT& request, const GetPercentilesResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetRegistrationCode that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetRegistrationCode that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetRegistrationCodeRequestT = Model::GetRegistrationCodeRequest>
  void GetRegistrationCodeAsync(const GetRegistrationCodeResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const GetRegistrationCodeRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetStatistics that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetStatisticsRequestT = Model::GetStatisticsRequest>
  void GetStatisticsAsync(const GetStatisticsRequestT& request, const GetStatisticsResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetThingConnectivityData that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetThingConnectivityData that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetThingConnectivityDataRequestT = Model::GetThingConnectivityDataRequest>
  void GetThingConnectivityDataAsync(const GetThingConnectivityDataRequestT& request,
                                     const GetThingConnectivityDataResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetTopicRule that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetTopicRuleRequestT = Model::GetTopicRuleRequest>
  void GetTopicRuleAsync(const GetTopicRuleRequestT& request, const GetTopicRuleResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetTopicRuleDestination that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetTopicRuleDestination that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetTopicRuleDestinationRequestT = Model::GetTopicRuleDestinationRequest>
  void GetTopicRuleDestinationAsync(const GetTopicRuleDestinationRequestT& request,
                                    const GetTopicRuleDestinationResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetV2LoggingOptions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetV2LoggingOptions that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetV2LoggingOptionsRequestT = Model::GetV2LoggingOptionsRequest>
  void GetV2LoggingOptionsAsync(const GetV2LoggingOptionsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const GetV2LoggingOptionsRequestT& request = {}) const {
   ...
   * Device Defender detect, see IoT Device Defender detect feature availability
   * change in the IoT Device Defender Developer Guide. There is no change to IoT
   * Device Defender audit availability.</p>  <p>Lists the active violations
   * for a given Device Defender security profile.</p> <p>Requires permission to
   * access the <a
  ...
  /**
   * A Callable wrapper for ListActiveViolations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListActiveViolations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListActiveViolationsRequestT = Model::ListActiveViolationsRequest>
  void ListActiveViolationsAsync(const ListActiveViolationsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const ListActiveViolationsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListAttachedPolicies that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAttachedPolicies that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAttachedPoliciesRequestT = Model::ListAttachedPoliciesRequest>
  void ListAttachedPoliciesAsync(const ListAttachedPoliciesRequestT& request, const ListAttachedPoliciesResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename ListAuditFindingsRequestT = Model::ListAuditFindingsRequest>
  void ListAuditFindingsAsync(const ListAuditFindingsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const ListAuditFindingsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListAuditMitigationActionsExecutionsOutcome ListAuditMitigationActionsExecutions(
      const Model::ListAuditMitigationActionsExecutionsRequest& request) const;

  /**
   * A Callable wrapper for ListAuditMitigationActionsExecutions that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListAuditMitigationActionsExecutionsRequestT = Model::ListAuditMitigationActionsExecutionsRequest>
  Model::ListAuditMitigationActionsExecutionsOutcomeCallable ListAuditMitigationActionsExecutionsCallable(
      const ListAuditMitigationActionsExecutionsRequestT& request) const {
    return SubmitCallable(&IoTClient::ListAuditMitigationActionsExecutions, request);
  }

  /**
   * An Async wrapper for ListAuditMitigationActionsExecutions that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListAuditMitigationActionsExecutionsRequestT = Model::ListAuditMitigationActionsExecutionsRequest>
  void ListAuditMitigationActionsExecutionsAsync(const ListAuditMitigationActionsExecutionsRequestT& request,
                                                 const ListAuditMitigationActionsExecutionsResponseReceivedHandler& handler,
                                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListAuditMitigationActionsTasksOutcome ListAuditMitigationActionsTasks(
      const Model::ListAuditMitigationActionsTasksRequest& request) const;

  /**
   * A Callable wrapper for ListAuditMitigationActionsTasks that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListAuditMitigationActionsTasksRequestT = Model::ListAuditMitigationActionsTasksRequest>
  Model::ListAuditMitigationActionsTasksOutcomeCallable ListAuditMitigationActionsTasksCallable(
      const ListAuditMitigationActionsTasksRequestT& request) const {
    return SubmitCallable(&IoTClient::ListAuditMitigationActionsTasks, request);
  }

  /**
   * An Async wrapper for ListAuditMitigationActionsTasks that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListAuditMitigationActionsTasksRequestT = Model::ListAuditMitigationActionsTasksRequest>
  void ListAuditMitigationActionsTasksAsync(const ListAuditMitigationActionsTasksRequestT& request,
                                            const ListAuditMitigationActionsTasksResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAuditSuppressions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAuditSuppressions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAuditSuppressionsRequestT = Model::ListAuditSuppressionsRequest>
  void ListAuditSuppressionsAsync(const ListAuditSuppressionsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const ListAuditSuppressionsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListAuditTasks that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListAuditTasksRequestT = Model::ListAuditTasksRequest>
  void ListAuditTasksAsync(const ListAuditTasksRequestT& request, const ListAuditTasksResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListAuthorizers that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListAuthorizersRequestT = Model::ListAuthorizersRequest>
  void ListAuthorizersAsync(const ListAuthorizersResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const ListAuthorizersRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListCACertificates that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListCACertificates that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListCACertificatesRequestT = Model::ListCACertificatesRequest>
  void ListCACertificatesAsync(const ListCACertificatesResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const ListCACertificatesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListCertificateProviders that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListCertificateProvidersRequestT = Model::ListCertificateProvidersRequest>
  Model::ListCertificateProvidersOutcomeCallable ListCertificateProvidersCallable(
      const ListCertificateProvidersRequestT& request = {}) const {
    return SubmitCallable(&IoTClient::ListCertificateProviders, request);
  }

  /**
   * An Async wrapper for ListCertificateProviders that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListCertificateProvidersRequestT = Model::ListCertificateProvidersRequest>
  void ListCertificateProvidersAsync(const ListCertificateProvidersResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const ListCertificateProvidersRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListCertificatesByCA that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListCertificatesByCA that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListCertificatesByCARequestT = Model::ListCertificatesByCARequest>
  void ListCertificatesByCAAsync(const ListCertificatesByCARequestT& request, const ListCertificatesByCAResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListCommandExecutions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListCommandExecutions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListCommandExecutionsRequestT = Model::ListCommandExecutionsRequest>
  void ListCommandExecutionsAsync(const ListCommandExecutionsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const ListCommandExecutionsRequestT& request = {}) const {
   ...
   * Device Defender detect, see IoT Device Defender detect feature availability
   * change in the IoT Device Defender Developer Guide. There is no change to IoT
   * Device Defender audit availability.</p>  <p> Lists your Device Defender
   * detect custom metrics. </p> <p>Requires permission to access the <a
  ...
  /**
   * A Callable wrapper for ListCustomMetrics that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListCustomMetrics that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListCustomMetricsRequestT = Model::ListCustomMetricsRequest>
  void ListCustomMetricsAsync(const ListCustomMetricsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const ListCustomMetricsRequestT& request = {}) const {
   ...
   * Device Defender detect, see IoT Device Defender detect feature availability
   * change in the IoT Device Defender Developer Guide. There is no change to IoT
   * Device Defender audit availability.</p>  <p> Lists mitigation actions
   * executions for a Device Defender ML Detect Security Profile. </p> <p>Requires
   * permission to access the <a
  ...
  virtual Model::ListDetectMitigationActionsExecutionsOutcome ListDetectMitigationActionsExecutions(
      const Model::ListDetectMitigationActionsExecutionsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListDetectMitigationActionsExecutions that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListDetectMitigationActionsExecutionsRequestT = Model::ListDetectMitigationActionsExecutionsRequest>
  Model::ListDetectMitigationActionsExecutionsOutcomeCallable ListDetectMitigationActionsExecutionsCallable(
      const ListDetectMitigationActionsExecutionsRequestT& request = {}) const {
    return SubmitCallable(&IoTClient::ListDetectMitigationActionsExecutions, request);
  }

  /**
   * An Async wrapper for ListDetectMitigationActionsExecutions that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListDetectMitigationActionsExecutionsRequestT = Model::ListDetectMitigationActionsExecutionsRequest>
  void ListDetectMitigationActionsExecutionsAsync(const ListDetectMitigationActionsExecutionsResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                  const ListDetectMitigationActionsExecutionsRequestT& request = {}) const {
   ...
   * Device Defender detect, see IoT Device Defender detect feature availability
   * change in the IoT Device Defender Developer Guide. There is no change to IoT
   * Device Defender audit availability.</p>  <p> List of Device Defender ML
   * Detect mitigation actions tasks. </p> <p>Requires permission to access the <a
   ...
   * API Reference</a></p>
   */
  virtual Model::ListDetectMitigationActionsTasksOutcome ListDetectMitigationActionsTasks(
      const Model::ListDetectMitigationActionsTasksRequest& request) const;

  /**
   * A Callable wrapper for ListDetectMitigationActionsTasks that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListDetectMitigationActionsTasksRequestT = Model::ListDetectMitigationActionsTasksRequest>
  Model::ListDetectMitigationActionsTasksOutcomeCallable ListDetectMitigationActionsTasksCallable(
      const ListDetectMitigationActionsTasksRequestT& request) const {
    return SubmitCallable(&IoTClient::ListDetectMitigationActionsTasks, request);
  }

  /**
   * An Async wrapper for ListDetectMitigationActionsTasks that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListDetectMitigationActionsTasksRequestT = Model::ListDetectMitigationActionsTasksRequest>
  void ListDetectMitigationActionsTasksAsync(const ListDetectMitigationActionsTasksRequestT& request,
                                             const ListDetectMitigationActionsTasksResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * Device Defender detect, see IoT Device Defender detect feature availability
   * change in the IoT Device Defender Developer Guide. There is no change to IoT
   * Device Defender audit availability.</p>  <p>List the set of dimensions
   * that are defined for your Amazon Web Services accounts.</p> <p>Requires
   * permission to access the <a
  ...
  /**
   * An Async wrapper for ListDimensions that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListDimensionsRequestT = Model::ListDimensionsRequest>
  void ListDimensionsAsync(const ListDimensionsResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const ListDimensionsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListDomainConfigurations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListDomainConfigurationsRequestT = Model::ListDomainConfigurationsRequest>
  Model::ListDomainConfigurationsOutcomeCallable ListDomainConfigurationsCallable(
      const ListDomainConfigurationsRequestT& request = {}) const {
    return SubmitCallable(&IoTClient::ListDomainConfigurations, request);
  }

  /**
   * An Async wrapper for ListDomainConfigurations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListDomainConfigurationsRequestT = Model::ListDomainConfigurationsRequest>
  void ListDomainConfigurationsAsync(const ListDomainConfigurationsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const ListDomainConfigurationsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListFleetMetrics that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListFleetMetrics that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListFleetMetricsRequestT = Model::ListFleetMetricsRequest>
  void ListFleetMetricsAsync(const ListFleetMetricsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const ListFleetMetricsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListJobExecutionsForJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListJobExecutionsForJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListJobExecutionsForJobRequestT = Model::ListJobExecutionsForJobRequest>
  void ListJobExecutionsForJobAsync(const ListJobExecutionsForJobRequestT& request,
                                    const ListJobExecutionsForJobResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListJobExecutionsForThing that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListJobExecutionsForThingRequestT = Model::ListJobExecutionsForThingRequest>
  Model::ListJobExecutionsForThingOutcomeCallable ListJobExecutionsForThingCallable(
      const ListJobExecutionsForThingRequestT& request) const {
    return SubmitCallable(&IoTClient::ListJobExecutionsForThing, request);
  }

  /**
   * An Async wrapper for ListJobExecutionsForThing that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListJobExecutionsForThingRequestT = Model::ListJobExecutionsForThingRequest>
  void ListJobExecutionsForThingAsync(const ListJobExecutionsForThingRequestT& request,
                                      const ListJobExecutionsForThingResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListManagedJobTemplates that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListManagedJobTemplates that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListManagedJobTemplatesRequestT = Model::ListManagedJobTemplatesRequest>
  void ListManagedJobTemplatesAsync(const ListManagedJobTemplatesResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const ListManagedJobTemplatesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListMetricValues that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListMetricValues that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListMetricValuesRequestT = Model::ListMetricValuesRequest>
  void ListMetricValuesAsync(const ListMetricValuesRequestT& request, const ListMetricValuesResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListMitigationActions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListMitigationActions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListMitigationActionsRequestT = Model::ListMitigationActionsRequest>
  void ListMitigationActionsAsync(const ListMitigationActionsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const ListMitigationActionsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListOTAUpdates that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListOTAUpdatesRequestT = Model::ListOTAUpdatesRequest>
  void ListOTAUpdatesAsync(const ListOTAUpdatesResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const ListOTAUpdatesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListOutgoingCertificates that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListOutgoingCertificatesRequestT = Model::ListOutgoingCertificatesRequest>
  Model::ListOutgoingCertificatesOutcomeCallable ListOutgoingCertificatesCallable(
      const ListOutgoingCertificatesRequestT& request = {}) const {
    return SubmitCallable(&IoTClient::ListOutgoingCertificates, request);
  }

  /**
   * An Async wrapper for ListOutgoingCertificates that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListOutgoingCertificatesRequestT = Model::ListOutgoingCertificatesRequest>
  void ListOutgoingCertificatesAsync(const ListOutgoingCertificatesResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const ListOutgoingCertificatesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListPrincipalThings that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListPrincipalThings that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListPrincipalThingsRequestT = Model::ListPrincipalThingsRequest>
  void ListPrincipalThingsAsync(const ListPrincipalThingsRequestT& request, const ListPrincipalThingsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListPrincipalThingsV2 that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListPrincipalThingsV2 that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListPrincipalThingsV2RequestT = Model::ListPrincipalThingsV2Request>
  void ListPrincipalThingsV2Async(const ListPrincipalThingsV2RequestT& request, const ListPrincipalThingsV2ResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListProvisioningTemplateVersionsOutcome ListProvisioningTemplateVersions(
      const Model::ListProvisioningTemplateVersionsRequest& request) const;

  /**
   * A Callable wrapper for ListProvisioningTemplateVersions that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListProvisioningTemplateVersionsRequestT = Model::ListProvisioningTemplateVersionsRequest>
  Model::ListProvisioningTemplateVersionsOutcomeCallable ListProvisioningTemplateVersionsCallable(
      const ListProvisioningTemplateVersionsRequestT& request) const {
    return SubmitCallable(&IoTClient::ListProvisioningTemplateVersions, request);
  }

  /**
   * An Async wrapper for ListProvisioningTemplateVersions that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListProvisioningTemplateVersionsRequestT = Model::ListProvisioningTemplateVersionsRequest>
  void ListProvisioningTemplateVersionsAsync(const ListProvisioningTemplateVersionsRequestT& request,
                                             const ListProvisioningTemplateVersionsResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListProvisioningTemplatesOutcome ListProvisioningTemplates(
      const Model::ListProvisioningTemplatesRequest& request = {}) const;

  /**
   * A Callable wrapper for ListProvisioningTemplates that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListProvisioningTemplatesRequestT = Model::ListProvisioningTemplatesRequest>
  Model::ListProvisioningTemplatesOutcomeCallable ListProvisioningTemplatesCallable(
      const ListProvisioningTemplatesRequestT& request = {}) const {
    return SubmitCallable(&IoTClient::ListProvisioningTemplates, request);
  }

  /**
   * An Async wrapper for ListProvisioningTemplates that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListProvisioningTemplatesRequestT = Model::ListProvisioningTemplatesRequest>
  void ListProvisioningTemplatesAsync(const ListProvisioningTemplatesResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const ListProvisioningTemplatesRequestT& request = {}) const {
  ...
  virtual Model::ListRelatedResourcesForAuditFindingOutcome ListRelatedResourcesForAuditFinding(
      const Model::ListRelatedResourcesForAuditFindingRequest& request) const;

  /**
   * A Callable wrapper for ListRelatedResourcesForAuditFinding that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListRelatedResourcesForAuditFindingRequestT = Model::ListRelatedResourcesForAuditFindingRequest>
  Model::ListRelatedResourcesForAuditFindingOutcomeCallable ListRelatedResourcesForAuditFindingCallable(
      const ListRelatedResourcesForAuditFindingRequestT& request) const {
    return SubmitCallable(&IoTClient::ListRelatedResourcesForAuditFinding, request);
  }

  /**
   * An Async wrapper for ListRelatedResourcesForAuditFinding that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListRelatedResourcesForAuditFindingRequestT = Model::ListRelatedResourcesForAuditFindingRequest>
  void ListRelatedResourcesForAuditFindingAsync(const ListRelatedResourcesForAuditFindingRequestT& request,
                                                const ListRelatedResourcesForAuditFindingResponseReceivedHandler& handler,
                                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListRoleAliases that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListRoleAliasesRequestT = Model::ListRoleAliasesRequest>
  void ListRoleAliasesAsync(const ListRoleAliasesResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const ListRoleAliasesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListSbomValidationResults that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListSbomValidationResultsRequestT = Model::ListSbomValidationResultsRequest>
  Model::ListSbomValidationResultsOutcomeCallable ListSbomValidationResultsCallable(
      const ListSbomValidationResultsRequestT& request) const {
    return SubmitCallable(&IoTClient::ListSbomValidationResults, request);
  }

  /**
   * An Async wrapper for ListSbomValidationResults that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListSbomValidationResultsRequestT = Model::ListSbomValidationResultsRequest>
  void ListSbomValidationResultsAsync(const ListSbomValidationResultsRequestT& request,
                                      const ListSbomValidationResultsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListScheduledAudits that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListScheduledAudits that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListScheduledAuditsRequestT = Model::ListScheduledAuditsRequest>
  void ListScheduledAuditsAsync(const ListScheduledAuditsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const ListScheduledAuditsRequestT& request = {}) const {
   ...
   * Device Defender detect, see IoT Device Defender detect feature availability
   * change in the IoT Device Defender Developer Guide. There is no change to IoT
   * Device Defender audit availability.</p>  <p>Lists the Device Defender
   * security profiles you've created. You can filter security profiles by dimension
   * or custom metric.</p> <p>Requires permission to access the <a
   ...
   */
  template <typename ListSecurityProfilesRequestT = Model::ListSecurityProfilesRequest>
  void ListSecurityProfilesAsync(const ListSecurityProfilesResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const ListSecurityProfilesRequestT& request = {}) const {
   ...
   * change in the IoT Device Defender Developer Guide. There is no change to IoT
   * Device Defender audit availability.</p>  <p>Lists the Device Defender
   * security profiles attached to a target (thing group).</p> <p>Requires permission
   * to access the <a
   ...
   * API Reference</a></p>
   */
  virtual Model::ListSecurityProfilesForTargetOutcome ListSecurityProfilesForTarget(
      const Model::ListSecurityProfilesForTargetRequest& request) const;

  /**
   * A Callable wrapper for ListSecurityProfilesForTarget that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListSecurityProfilesForTargetRequestT = Model::ListSecurityProfilesForTargetRequest>
  Model::ListSecurityProfilesForTargetOutcomeCallable ListSecurityProfilesForTargetCallable(
      const ListSecurityProfilesForTargetRequestT& request) const {
    return SubmitCallable(&IoTClient::ListSecurityProfilesForTarget, request);
  }

  /**
   * An Async wrapper for ListSecurityProfilesForTarget that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListSecurityProfilesForTargetRequestT = Model::ListSecurityProfilesForTargetRequest>
  void ListSecurityProfilesForTargetAsync(const ListSecurityProfilesForTargetRequestT& request,
                                          const ListSecurityProfilesForTargetResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListTargetsForPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListTargetsForPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListTargetsForPolicyRequestT = Model::ListTargetsForPolicyRequest>
  void ListTargetsForPolicyAsync(const ListTargetsForPolicyRequestT& request, const ListTargetsForPolicyResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * Device Defender detect, see IoT Device Defender detect feature availability
   * change in the IoT Device Defender Developer Guide. There is no change to IoT
   * Device Defender audit availability.</p>  <p>Lists the targets (thing
   * groups) associated with a given Device Defender security profile.</p>
   * <p>Requires permission to access the <a
   ...
   * API Reference</a></p>
   */
  virtual Model::ListTargetsForSecurityProfileOutcome ListTargetsForSecurityProfile(
      const Model::ListTargetsForSecurityProfileRequest& request) const;

  /**
   * A Callable wrapper for ListTargetsForSecurityProfile that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListTargetsForSecurityProfileRequestT = Model::ListTargetsForSecurityProfileRequest>
  Model::ListTargetsForSecurityProfileOutcomeCallable ListTargetsForSecurityProfileCallable(
      const ListTargetsForSecurityProfileRequestT& request) const {
    return SubmitCallable(&IoTClient::ListTargetsForSecurityProfile, request);
  }

  /**
   * An Async wrapper for ListTargetsForSecurityProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListTargetsForSecurityProfileRequestT = Model::ListTargetsForSecurityProfileRequest>
  void ListTargetsForSecurityProfileAsync(const ListTargetsForSecurityProfileRequestT& request,
                                          const ListTargetsForSecurityProfileResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListThingGroups that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListThingGroupsRequestT = Model::ListThingGroupsRequest>
  void ListThingGroupsAsync(const ListThingGroupsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const ListThingGroupsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListThingGroupsForThing that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListThingGroupsForThing that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListThingGroupsForThingRequestT = Model::ListThingGroupsForThingRequest>
  void ListThingGroupsForThingAsync(const ListThingGroupsForThingRequestT& request,
                                    const ListThingGroupsForThingResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListThingPrincipals that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListThingPrincipals that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListThingPrincipalsRequestT = Model::ListThingPrincipalsRequest>
  void ListThingPrincipalsAsync(const ListThingPrincipalsRequestT& request, const ListThingPrincipalsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListThingPrincipalsV2 that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListThingPrincipalsV2 that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListThingPrincipalsV2RequestT = Model::ListThingPrincipalsV2Request>
  void ListThingPrincipalsV2Async(const ListThingPrincipalsV2RequestT& request, const ListThingPrincipalsV2ResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListThingRegistrationTaskReportsOutcome ListThingRegistrationTaskReports(
      const Model::ListThingRegistrationTaskReportsRequest& request) const;

  /**
   * A Callable wrapper for ListThingRegistrationTaskReports that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListThingRegistrationTaskReportsRequestT = Model::ListThingRegistrationTaskReportsRequest>
  Model::ListThingRegistrationTaskReportsOutcomeCallable ListThingRegistrationTaskReportsCallable(
      const ListThingRegistrationTaskReportsRequestT& request) const {
    return SubmitCallable(&IoTClient::ListThingRegistrationTaskReports, request);
  }

  /**
   * An Async wrapper for ListThingRegistrationTaskReports that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListThingRegistrationTaskReportsRequestT = Model::ListThingRegistrationTaskReportsRequest>
  void ListThingRegistrationTaskReportsAsync(const ListThingRegistrationTaskReportsRequestT& request,
                                             const ListThingRegistrationTaskReportsResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListThingRegistrationTasksOutcome ListThingRegistrationTasks(
      const Model::ListThingRegistrationTasksRequest& request = {}) const;

  /**
   * A Callable wrapper for ListThingRegistrationTasks that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListThingRegistrationTasksRequestT = Model::ListThingRegistrationTasksRequest>
  Model::ListThingRegistrationTasksOutcomeCallable ListThingRegistrationTasksCallable(
      const ListThingRegistrationTasksRequestT& request = {}) const {
    return SubmitCallable(&IoTClient::ListThingRegistrationTasks, request);
  }

  /**
   * An Async wrapper for ListThingRegistrationTasks that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListThingRegistrationTasksRequestT = Model::ListThingRegistrationTasksRequest>
  void ListThingRegistrationTasksAsync(const ListThingRegistrationTasksResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const ListThingRegistrationTasksRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListThingTypes that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListThingTypesRequestT = Model::ListThingTypesRequest>
  void ListThingTypesAsync(const ListThingTypesResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const ListThingTypesRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListThings that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListThingsRequestT = Model::ListThingsRequest>
  void ListThingsAsync(const ListThingsResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                       const ListThingsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListThingsInBillingGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListThingsInBillingGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListThingsInBillingGroupRequestT = Model::ListThingsInBillingGroupRequest>
  void ListThingsInBillingGroupAsync(const ListThingsInBillingGroupRequestT& request,
                                     const ListThingsInBillingGroupResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListThingsInThingGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListThingsInThingGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListThingsInThingGroupRequestT = Model::ListThingsInThingGroupRequest>
  void ListThingsInThingGroupAsync(const ListThingsInThingGroupRequestT& request,
                                   const ListThingsInThingGroupResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListTopicRuleDestinationsOutcome ListTopicRuleDestinations(
      const Model::ListTopicRuleDestinationsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListTopicRuleDestinations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListTopicRuleDestinationsRequestT = Model::ListTopicRuleDestinationsRequest>
  Model::ListTopicRuleDestinationsOutcomeCallable ListTopicRuleDestinationsCallable(
      const ListTopicRuleDestinationsRequestT& request = {}) const {
    return SubmitCallable(&IoTClient::ListTopicRuleDestinations, request);
  }

  /**
   * An Async wrapper for ListTopicRuleDestinations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListTopicRuleDestinationsRequestT = Model::ListTopicRuleDestinationsRequest>
  void ListTopicRuleDestinationsAsync(const ListTopicRuleDestinationsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const ListTopicRuleDestinationsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListTopicRules that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListTopicRulesRequestT = Model::ListTopicRulesRequest>
  void ListTopicRulesAsync(const ListTopicRulesResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const ListTopicRulesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListV2LoggingLevels that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListV2LoggingLevels that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListV2LoggingLevelsRequestT = Model::ListV2LoggingLevelsRequest>
  void ListV2LoggingLevelsAsync(const ListV2LoggingLevelsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const ListV2LoggingLevelsRequestT& request = {}) const {
   ...
   * change in the IoT Device Defender Developer Guide. There is no change to IoT
   * Device Defender audit availability.</p>  <p>Lists the Device Defender
   * security profile violations discovered during the given time period. You can use
   * filters to limit the results to those alerts issued for a particular security
   * profile, behavior, or thing (device).</p> <p>Requires permission to access the
   * <a
  ...
  /**
   * A Callable wrapper for ListViolationEvents that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListViolationEvents that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListViolationEventsRequestT = Model::ListViolationEventsRequest>
  void ListViolationEventsAsync(const ListViolationEventsRequestT& request, const ListViolationEventsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * Device Defender detect, see IoT Device Defender detect feature availability
   * change in the IoT Device Defender Developer Guide. There is no change to IoT
   * Device Defender audit availability.</p>  <p>Set a verification state and
   * provide a description of that verification state on a violation (detect
   * alarm).</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/iot-2015-05-28/PutVerificationStateOnViolation">AWS
   * API Reference</a></p>
   */
  virtual Model::PutVerificationStateOnViolationOutcome PutVerificationStateOnViolation(
      const Model::PutVerificationStateOnViolationRequest& request) const;

  /**
   * A Callable wrapper for PutVerificationStateOnViolation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PutVerificationStateOnViolationRequestT = Model::PutVerificationStateOnViolationRequest>
  Model::PutVerificationStateOnViolationOutcomeCallable PutVerificationStateOnViolationCallable(
      const PutVerificationStateOnViolationRequestT& request) const {
    return SubmitCallable(&IoTClient::PutVerificationStateOnViolation, request);
  }

  /**
   * An Async wrapper for PutVerificationStateOnViolation that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename PutVerificationStateOnViolationRequestT = Model::PutVerificationStateOnViolationRequest>
  void PutVerificationStateOnViolationAsync(const PutVerificationStateOnViolationRequestT& request,
                                            const PutVerificationStateOnViolationResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RegisterCACertificate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RegisterCACertificate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RegisterCACertificateRequestT = Model::RegisterCACertificateRequest>
  void RegisterCACertificateAsync(const RegisterCACertificateRequestT& request, const RegisterCACertificateResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RegisterCertificate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RegisterCertificate that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename RegisterCertificateRequestT = Model::RegisterCertificateRequest>
  void RegisterCertificateAsync(const RegisterCertificateRequestT& request, const RegisterCertificateResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::RegisterCertificateWithoutCAOutcome RegisterCertificateWithoutCA(
      const Model::RegisterCertificateWithoutCARequest& request) const;

  /**
   * A Callable wrapper for RegisterCertificateWithoutCA that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename RegisterCertificateWithoutCARequestT = Model::RegisterCertificateWithoutCARequest>
  Model::RegisterCertificateWithoutCAOutcomeCallable RegisterCertificateWithoutCACallable(
      const RegisterCertificateWithoutCARequestT& request) const {
    return SubmitCallable(&IoTClient::RegisterCertificateWithoutCA, request);
  }

  /**
   * An Async wrapper for RegisterCertificateWithoutCA that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RegisterCertificateWithoutCARequestT = Model::RegisterCertificateWithoutCARequest>
  void RegisterCertificateWithoutCAAsync(const RegisterCertificateWithoutCARequestT& request,
                                         const RegisterCertificateWithoutCAResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for RegisterThing that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename RegisterThingRequestT = Model::RegisterThingRequest>
  void RegisterThingAsync(const RegisterThingRequestT& request, const RegisterThingResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RejectCertificateTransfer that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename RejectCertificateTransferRequestT = Model::RejectCertificateTransferRequest>
  Model::RejectCertificateTransferOutcomeCallable RejectCertificateTransferCallable(
      const RejectCertificateTransferRequestT& request) const {
    return SubmitCallable(&IoTClient::RejectCertificateTransfer, request);
  }

  /**
   * An Async wrapper for RejectCertificateTransfer that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RejectCertificateTransferRequestT = Model::RejectCertificateTransferRequest>
  void RejectCertificateTransferAsync(const RejectCertificateTransferRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::RemoveThingFromBillingGroupOutcome RemoveThingFromBillingGroup(
      const Model::RemoveThingFromBillingGroupRequest& request = {}) const;

  /**
   * A Callable wrapper for RemoveThingFromBillingGroup that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename RemoveThingFromBillingGroupRequestT = Model::RemoveThingFromBillingGroupRequest>
  Model::RemoveThingFromBillingGroupOutcomeCallable RemoveThingFromBillingGroupCallable(
      const RemoveThingFromBillingGroupRequestT& request = {}) const {
    return SubmitCallable(&IoTClient::RemoveThingFromBillingGroup, request);
  }

  /**
   * An Async wrapper for RemoveThingFromBillingGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RemoveThingFromBillingGroupRequestT = Model::RemoveThingFromBillingGroupRequest>
  void RemoveThingFromBillingGroupAsync(const RemoveThingFromBillingGroupResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                        const RemoveThingFromBillingGroupRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::RemoveThingFromThingGroupOutcome RemoveThingFromThingGroup(
      const Model::RemoveThingFromThingGroupRequest& request = {}) const;

  /**
   * A Callable wrapper for RemoveThingFromThingGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename RemoveThingFromThingGroupRequestT = Model::RemoveThingFromThingGroupRequest>
  Model::RemoveThingFromThingGroupOutcomeCallable RemoveThingFromThingGroupCallable(
      const RemoveThingFromThingGroupRequestT& request = {}) const {
    return SubmitCallable(&IoTClient::RemoveThingFromThingGroup, request);
  }

  /**
   * An Async wrapper for RemoveThingFromThingGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RemoveThingFromThingGroupRequestT = Model::RemoveThingFromThingGroupRequest>
  void RemoveThingFromThingGroupAsync(const RemoveThingFromThingGroupResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const RemoveThingFromThingGroupRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ReplaceTopicRule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ReplaceTopicRule that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ReplaceTopicRuleRequestT = Model::ReplaceTopicRuleRequest>
  void ReplaceTopicRuleAsync(const ReplaceTopicRuleRequestT& request, const ReplaceTopicRuleResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for SearchIndex that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename SearchIndexRequestT = Model::SearchIndexRequest>
  void SearchIndexAsync(const SearchIndexRequestT& request, const SearchIndexResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SetDefaultAuthorizer that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SetDefaultAuthorizer that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SetDefaultAuthorizerRequestT = Model::SetDefaultAuthorizerRequest>
  void SetDefaultAuthorizerAsync(const SetDefaultAuthorizerRequestT& request, const SetDefaultAuthorizerResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SetLoggingOptions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SetLoggingOptions that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename SetLoggingOptionsRequestT = Model::SetLoggingOptionsRequest>
  void SetLoggingOptionsAsync(const SetLoggingOptionsRequestT& request, const SetLoggingOptionsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SetV2LoggingLevel that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SetV2LoggingLevel that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename SetV2LoggingLevelRequestT = Model::SetV2LoggingLevelRequest>
  void SetV2LoggingLevelAsync(const SetV2LoggingLevelRequestT& request, const SetV2LoggingLevelResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SetV2LoggingOptions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SetV2LoggingOptions that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename SetV2LoggingOptionsRequestT = Model::SetV2LoggingOptionsRequest>
  void SetV2LoggingOptionsAsync(const SetV2LoggingOptionsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const SetV2LoggingOptionsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartAuditMitigationActionsTaskOutcome StartAuditMitigationActionsTask(
      const Model::StartAuditMitigationActionsTaskRequest& request) const;

  /**
   * A Callable wrapper for StartAuditMitigationActionsTask that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename StartAuditMitigationActionsTaskRequestT = Model::StartAuditMitigationActionsTaskRequest>
  Model::StartAuditMitigationActionsTaskOutcomeCallable StartAuditMitigationActionsTaskCallable(
      const StartAuditMitigationActionsTaskRequestT& request) const {
    return SubmitCallable(&IoTClient::StartAuditMitigationActionsTask, request);
  }

  /**
   * An Async wrapper for StartAuditMitigationActionsTask that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename StartAuditMitigationActionsTaskRequestT = Model::StartAuditMitigationActionsTaskRequest>
  void StartAuditMitigationActionsTaskAsync(const StartAuditMitigationActionsTaskRequestT& request,
                                            const StartAuditMitigationActionsTaskResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * Device Defender detect, see IoT Device Defender detect feature availability
   * change in the IoT Device Defender Developer Guide. There is no change to IoT
   * Device Defender audit availability.</p>  <p> Starts a Device Defender ML
   * Detect mitigation actions task. </p> <p>Requires permission to access the <a
  ...
  virtual Model::StartDetectMitigationActionsTaskOutcome StartDetectMitigationActionsTask(
      const Model::StartDetectMitigationActionsTaskRequest& request) const;

  /**
   * A Callable wrapper for StartDetectMitigationActionsTask that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename StartDetectMitigationActionsTaskRequestT = Model::StartDetectMitigationActionsTaskRequest>
  Model::StartDetectMitigationActionsTaskOutcomeCallable StartDetectMitigationActionsTaskCallable(
      const StartDetectMitigationActionsTaskRequestT& request) const {
    return SubmitCallable(&IoTClient::StartDetectMitigationActionsTask, request);
  }

  /**
   * An Async wrapper for StartDetectMitigationActionsTask that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename StartDetectMitigationActionsTaskRequestT = Model::StartDetectMitigationActionsTaskRequest>
  void StartDetectMitigationActionsTaskAsync(const StartDetectMitigationActionsTaskRequestT& request,
                                             const StartDetectMitigationActionsTaskResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartOnDemandAuditTask that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartOnDemandAuditTask that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartOnDemandAuditTaskRequestT = Model::StartOnDemandAuditTaskRequest>
  void StartOnDemandAuditTaskAsync(const StartOnDemandAuditTaskRequestT& request,
                                   const StartOnDemandAuditTaskResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartThingRegistrationTaskOutcome StartThingRegistrationTask(
      const Model::StartThingRegistrationTaskRequest& request) const;

  /**
   * A Callable wrapper for StartThingRegistrationTask that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename StartThingRegistrationTaskRequestT = Model::StartThingRegistrationTaskRequest>
  Model::StartThingRegistrationTaskOutcomeCallable StartThingRegistrationTaskCallable(
      const StartThingRegistrationTaskRequestT& request) const {
    return SubmitCallable(&IoTClient::StartThingRegistrationTask, request);
  }

  /**
   * An Async wrapper for StartThingRegistrationTask that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartThingRegistrationTaskRequestT = Model::StartThingRegistrationTaskRequest>
  void StartThingRegistrationTaskAsync(const StartThingRegistrationTaskRequestT& request,
                                       const StartThingRegistrationTaskResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StopThingRegistrationTask that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename StopThingRegistrationTaskRequestT = Model::StopThingRegistrationTaskRequest>
  Model::StopThingRegistrationTaskOutcomeCallable StopThingRegistrationTaskCallable(
      const StopThingRegistrationTaskRequestT& request) const {
    return SubmitCallable(&IoTClient::StopThingRegistrationTask, request);
  }

  /**
   * An Async wrapper for StopThingRegistrationTask that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StopThingRegistrationTaskRequestT = Model::StopThingRegistrationTaskRequest>
  void StopThingRegistrationTaskAsync(const StopThingRegistrationTaskRequestT& request,
                                      const StopThingRegistrationTaskResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for TestAuthorization that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for TestAuthorization that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename TestAuthorizationRequestT = Model::TestAuthorizationRequest>
  void TestAuthorizationAsync(const TestAuthorizationRequestT& request, const TestAuthorizationResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for TestInvokeAuthorizer that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for TestInvokeAuthorizer that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename TestInvokeAuthorizerRequestT = Model::TestInvokeAuthorizerRequest>
  void TestInvokeAuthorizerAsync(const TestInvokeAuthorizerRequestT& request, const TestInvokeAuthorizerResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * action.</p> <p>You can cancel the transfer until it is accepted by the
   * recipient.</p> <p>No notification is sent to the transfer destination's account.
   * The caller is responsible for notifying the transfer target.</p> <p>The
   * certificate being transferred must not be in the <code>ACTIVE</code> state. You
   * can use the <a>UpdateCertificate</a> action to deactivate it.</p> <p>The
   * certificate must not have any policies attached to it. You can use the
   * <a>DetachPolicy</a> action to detach them.</p> <p> <b>Customer managed key
   * behavior:</b> When you use a customer managed key to encrypt your data and then
   * transfer the certificate to a customer in a different account using the
   * <code>TransferCertificate</code> operation, the certificates will no longer be
   ...
   * keys.</p> <p>While a certificate is in the <b>PENDING_TRANSFER</b> state, it's
   * always protected by Amazon Web Services IoT Core owned keys, regardless of the
   * customer managed key configuration of either the source or destination account.
   * </p> <p>Once the transfer is completed through <a>AcceptCertificateTransfer</a>,
   ...
   * <p>If the transfer is accepted: The certificate is encrypted by the target
  ...
  /**
   * A Callable wrapper for TransferCertificate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for TransferCertificate that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename TransferCertificateRequestT = Model::TransferCertificateRequest>
  void TransferCertificateAsync(const TransferCertificateRequestT& request, const TransferCertificateResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateAccountAuditConfigurationOutcome UpdateAccountAuditConfiguration(
      const Model::UpdateAccountAuditConfigurationRequest& request = {}) const;

  /**
   * A Callable wrapper for UpdateAccountAuditConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateAccountAuditConfigurationRequestT = Model::UpdateAccountAuditConfigurationRequest>
  Model::UpdateAccountAuditConfigurationOutcomeCallable UpdateAccountAuditConfigurationCallable(
      const UpdateAccountAuditConfigurationRequestT& request = {}) const {
    return SubmitCallable(&IoTClient::UpdateAccountAuditConfiguration, request);
  }

  /**
   * An Async wrapper for UpdateAccountAuditConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateAccountAuditConfigurationRequestT = Model::UpdateAccountAuditConfigurationRequest>
  void UpdateAccountAuditConfigurationAsync(const UpdateAccountAuditConfigurationResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                            const UpdateAccountAuditConfigurationRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for UpdateAuditSuppression that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateAuditSuppression that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateAuditSuppressionRequestT = Model::UpdateAuditSuppressionRequest>
  void UpdateAuditSuppressionAsync(const UpdateAuditSuppressionRequestT& request,
                                   const UpdateAuditSuppressionResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateCACertificate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateCACertificate that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateCACertificateRequestT = Model::UpdateCACertificateRequest>
  void UpdateCACertificateAsync(const UpdateCACertificateRequestT& request, const UpdateCACertificateResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateCertificateProvider that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename UpdateCertificateProviderRequestT = Model::UpdateCertificateProviderRequest>
  Model::UpdateCertificateProviderOutcomeCallable UpdateCertificateProviderCallable(
      const UpdateCertificateProviderRequestT& request) const {
    return SubmitCallable(&IoTClient::UpdateCertificateProvider, request);
  }

  /**
   * An Async wrapper for UpdateCertificateProvider that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateCertificateProviderRequestT = Model::UpdateCertificateProviderRequest>
  void UpdateCertificateProviderAsync(const UpdateCertificateProviderRequestT& request,
                                      const UpdateCertificateProviderResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateCommand that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateCommandRequestT = Model::UpdateCommandRequest>
  void UpdateCommandAsync(const UpdateCommandRequestT& request, const UpdateCommandResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * Device Defender detect, see IoT Device Defender detect feature availability
   * change in the IoT Device Defender Developer Guide. There is no change to IoT
   * Device Defender audit availability.</p>  <p>Updates a Device Defender
   * detect custom metric. </p> <p>Requires permission to access the <a
  ...
  /**
   * A Callable wrapper for UpdateCustomMetric that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateCustomMetric that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateCustomMetricRequestT = Model::UpdateCustomMetricRequest>
  void UpdateCustomMetricAsync(const UpdateCustomMetricRequestT& request, const UpdateCustomMetricResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * Device Defender detect, see IoT Device Defender detect feature availability
   * change in the IoT Device Defender Developer Guide. There is no change to IoT
   * Device Defender audit availability.</p>  <p>Updates the definition for a
   * dimension. You cannot change the type of a dimension after it is created (you
   * can delete it and recreate it).</p> <p>Requires permission to access the <a
  ...
  /**
   * An Async wrapper for UpdateDimension that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateDimensionRequestT = Model::UpdateDimensionRequest>
  void UpdateDimensionAsync(const UpdateDimensionRequestT& request, const UpdateDimensionResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateDomainConfiguration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename UpdateDomainConfigurationRequestT = Model::UpdateDomainConfigurationRequest>
  Model::UpdateDomainConfigurationOutcomeCallable UpdateDomainConfigurationCallable(
      const UpdateDomainConfigurationRequestT& request) const {
    return SubmitCallable(&IoTClient::UpdateDomainConfiguration, request);
  }

  /**
   * An Async wrapper for UpdateDomainConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateDomainConfigurationRequestT = Model::UpdateDomainConfigurationRequest>
  void UpdateDomainConfigurationAsync(const UpdateDomainConfigurationRequestT& request,
                                      const UpdateDomainConfigurationResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateDynamicThingGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateDynamicThingGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateDynamicThingGroupRequestT = Model::UpdateDynamicThingGroupRequest>
  void UpdateDynamicThingGroupAsync(const UpdateDynamicThingGroupRequestT& request,
                                    const UpdateDynamicThingGroupResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&IoTClient::UpdateDynamicThingGroup, request, handler, context);
  }

  /**
   * <p>Updates the encryption configuration. By default, Amazon Web Services IoT
   * Core encrypts your data at rest using Amazon Web Services owned keys. Amazon Web
   ...
   * manage the KMS keys in your Amazon Web Services account. </p> <p>Before using
   * this API, you must set up permissions for Amazon Web Services IoT Core to access
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateEncryptionConfigurationOutcome UpdateEncryptionConfiguration(
      const Model::UpdateEncryptionConfigurationRequest& request) const;

  /**
   * A Callable wrapper for UpdateEncryptionConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateEncryptionConfigurationRequestT = Model::UpdateEncryptionConfigurationRequest>
  Model::UpdateEncryptionConfigurationOutcomeCallable UpdateEncryptionConfigurationCallable(
      const UpdateEncryptionConfigurationRequestT& request) const {
    return SubmitCallable(&IoTClient::UpdateEncryptionConfiguration, request);
  }

  /**
   * An Async wrapper for UpdateEncryptionConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateEncryptionConfigurationRequestT = Model::UpdateEncryptionConfigurationRequest>
  void UpdateEncryptionConfigurationAsync(const UpdateEncryptionConfigurationRequestT& request,
                                          const UpdateEncryptionConfigurationResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateEventConfigurationsOutcome UpdateEventConfigurations(
      const Model::UpdateEventConfigurationsRequest& request = {}) const;

  /**
   * A Callable wrapper for UpdateEventConfigurations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename UpdateEventConfigurationsRequestT = Model::UpdateEventConfigurationsRequest>
  Model::UpdateEventConfigurationsOutcomeCallable UpdateEventConfigurationsCallable(
      const UpdateEventConfigurationsRequestT& request = {}) const {
    return SubmitCallable(&IoTClient::UpdateEventConfigurations, request);
  }

  /**
   * An Async wrapper for UpdateEventConfigurations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateEventConfigurationsRequestT = Model::UpdateEventConfigurationsRequest>
  void UpdateEventConfigurationsAsync(const UpdateEventConfigurationsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const UpdateEventConfigurationsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for UpdateFleetMetric that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateFleetMetric that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateFleetMetricRequestT = Model::UpdateFleetMetricRequest>
  void UpdateFleetMetricAsync(const UpdateFleetMetricRequestT& request, const UpdateFleetMetricResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateIndexingConfigurationOutcome UpdateIndexingConfiguration(
      const Model::UpdateIndexingConfigurationRequest& request = {}) const;

  /**
   * A Callable wrapper for UpdateIndexingConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateIndexingConfigurationRequestT = Model::UpdateIndexingConfigurationRequest>
  Model::UpdateIndexingConfigurationOutcomeCallable UpdateIndexingConfigurationCallable(
      const UpdateIndexingConfigurationRequestT& request = {}) const {
    return SubmitCallable(&IoTClient::UpdateIndexingConfiguration, request);
  }

  /**
   * An Async wrapper for UpdateIndexingConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateIndexingConfigurationRequestT = Model::UpdateIndexingConfigurationRequest>
  void UpdateIndexingConfigurationAsync(const UpdateIndexingConfigurationResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                        const UpdateIndexingConfigurationRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for UpdateMitigationAction that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateMitigationAction that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateMitigationActionRequestT = Model::UpdateMitigationActionRequest>
  void UpdateMitigationActionAsync(const UpdateMitigationActionRequestT& request,
                                   const UpdateMitigationActionResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdatePackageConfigurationOutcome UpdatePackageConfiguration(
      const Model::UpdatePackageConfigurationRequest& request = {}) const;

  /**
   * A Callable wrapper for UpdatePackageConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdatePackageConfigurationRequestT = Model::UpdatePackageConfigurationRequest>
  Model::UpdatePackageConfigurationOutcomeCallable UpdatePackageConfigurationCallable(
      const UpdatePackageConfigurationRequestT& request = {}) const {
    return SubmitCallable(&IoTClient::UpdatePackageConfiguration, request);
  }

  /**
   * An Async wrapper for UpdatePackageConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdatePackageConfigurationRequestT = Model::UpdatePackageConfigurationRequest>
  void UpdatePackageConfigurationAsync(const UpdatePackageConfigurationResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const UpdatePackageConfigurationRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for UpdatePackageVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdatePackageVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdatePackageVersionRequestT = Model::UpdatePackageVersionRequest>
  void UpdatePackageVersionAsync(const UpdatePackageVersionRequestT& request, const UpdatePackageVersionResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateProvisioningTemplateOutcome UpdateProvisioningTemplate(
      const Model::UpdateProvisioningTemplateRequest& request) const;

  /**
   * A Callable wrapper for UpdateProvisioningTemplate that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateProvisioningTemplateRequestT = Model::UpdateProvisioningTemplateRequest>
  Model::UpdateProvisioningTemplateOutcomeCallable UpdateProvisioningTemplateCallable(
      const UpdateProvisioningTemplateRequestT& request) const {
    return SubmitCallable(&IoTClient::UpdateProvisioningTemplate, request);
  }

  /**
   * An Async wrapper for UpdateProvisioningTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateProvisioningTemplateRequestT = Model::UpdateProvisioningTemplateRequest>
  void UpdateProvisioningTemplateAsync(const UpdateProvisioningTemplateRequestT& request,
                                       const UpdateProvisioningTemplateResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateRoleAlias that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateRoleAliasRequestT = Model::UpdateRoleAliasRequest>
  void UpdateRoleAliasAsync(const UpdateRoleAliasRequestT& request, const UpdateRoleAliasResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateScheduledAudit that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateScheduledAudit that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateScheduledAuditRequestT = Model::UpdateScheduledAuditRequest>
  void UpdateScheduledAuditAsync(const UpdateScheduledAuditRequestT& request, const UpdateScheduledAuditResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateThing that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateThingRequestT = Model::UpdateThingRequest>
  void UpdateThingAsync(const UpdateThingRequestT& request, const UpdateThingResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateThingGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateThingGroup that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateThingGroupRequestT = Model::UpdateThingGroupRequest>
  void UpdateThingGroupAsync(const UpdateThingGroupRequestT& request, const UpdateThingGroupResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::UpdateThingGroupsForThingOutcome UpdateThingGroupsForThing(
      const Model::UpdateThingGroupsForThingRequest& request = {}) const;

  /**
   * A Callable wrapper for UpdateThingGroupsForThing that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename UpdateThingGroupsForThingRequestT = Model::UpdateThingGroupsForThingRequest>
  Model::UpdateThingGroupsForThingOutcomeCallable UpdateThingGroupsForThingCallable(
      const UpdateThingGroupsForThingRequestT& request = {}) const {
    return SubmitCallable(&IoTClient::UpdateThingGroupsForThing, request);
  }

  /**
   * An Async wrapper for UpdateThingGroupsForThing that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateThingGroupsForThingRequestT = Model::UpdateThingGroupsForThingRequest>
  void UpdateThingGroupsForThingAsync(const UpdateThingGroupsForThingResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const UpdateThingGroupsForThingRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for UpdateThingType that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateThingTypeRequestT = Model::UpdateThingTypeRequest>
  void UpdateThingTypeAsync(const UpdateThingTypeRequestT& request, const UpdateThingTypeResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateTopicRuleDestinationOutcome UpdateTopicRuleDestination(
      const Model::UpdateTopicRuleDestinationRequest& request) const;

  /**
   * A Callable wrapper for UpdateTopicRuleDestination that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateTopicRuleDestinationRequestT = Model::UpdateTopicRuleDestinationRequest>
  Model::UpdateTopicRuleDestinationOutcomeCallable UpdateTopicRuleDestinationCallable(
      const UpdateTopicRuleDestinationRequestT& request) const {
    return SubmitCallable(&IoTClient::UpdateTopicRuleDestination, request);
  }

  /**
   * An Async wrapper for UpdateTopicRuleDestination that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateTopicRuleDestinationRequestT = Model::UpdateTopicRuleDestinationRequest>
  void UpdateTopicRuleDestinationAsync(const UpdateTopicRuleDestinationRequestT& request,
                                       const UpdateTopicRuleDestinationResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * Device Defender detect, see IoT Device Defender detect feature availability
   * change in the IoT Device Defender Developer Guide. There is no change to IoT
   * Device Defender audit availability.</p>  <p>Validates a Device Defender
   * security profile behaviors specification.</p> <p>Requires permission to access
   * the <a
   ...
   * API Reference</a></p>
   */
  virtual Model::ValidateSecurityProfileBehaviorsOutcome ValidateSecurityProfileBehaviors(
      const Model::ValidateSecurityProfileBehaviorsRequest& request) const;

  /**
   * A Callable wrapper for ValidateSecurityProfileBehaviors that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ValidateSecurityProfileBehaviorsRequestT = Model::ValidateSecurityProfileBehaviorsRequest>
  Model::ValidateSecurityProfileBehaviorsOutcomeCallable ValidateSecurityProfileBehaviorsCallable(
      const ValidateSecurityProfileBehaviorsRequestT& request) const {
    return SubmitCallable(&IoTClient::ValidateSecurityProfileBehaviors, request);
  }

  /**
   * An Async wrapper for ValidateSecurityProfileBehaviors that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ValidateSecurityProfileBehaviorsRequestT = Model::ValidateSecurityProfileBehaviorsRequest>
  void ValidateSecurityProfileBehaviorsAsync(const ValidateSecurityProfileBehaviorsRequestT& request,
                                             const ValidateSecurityProfileBehaviorsResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
