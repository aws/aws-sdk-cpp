 ...
 * <code>GetTopicRuleDestination</code>.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/iot-2015-05-28/InfluxDBDestinationProperties">AWS
 * API Reference</a></p>
 */
class InfluxDBDestinationProperties {
 public:
  ...
  inline InfluxDBDestinationProperties& WithInfluxDBVersion(InfluxDBVersion value) {
  ...
  inline InfluxDBDestinationProperties& WithSecretType(InfluxDBSecretType value) {
    SetSecretType(value);
    return *this;
  }
  ///@}
