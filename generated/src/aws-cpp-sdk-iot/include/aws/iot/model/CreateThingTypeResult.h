...
class CreateThingTypeResult {
 public:
  ...
  template <typename ThingTypeNameT = Aws::String>
  CreateThingTypeResult& WithThingTypeName(ThingTypeNameT&& value) {
  ...
  template <typename ThingTypeArnT = Aws::String>
  CreateThingTypeResult& WithThingTypeArn(ThingTypeArnT&& value) {
  ...
  template <typename ThingTypeIdT = Aws::String>
  CreateThingTypeResult& WithThingTypeId(ThingTypeIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateThingTypeResult& WithRequestId(RequestIdT&& value) {
