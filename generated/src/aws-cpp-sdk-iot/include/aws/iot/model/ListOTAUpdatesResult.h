...
class ListOTAUpdatesResult {
 public:
  ...
  void SetOtaUpdates(OtaUpdatesT&& value) {
    m_otaUpdatesHasBeenSet = true;
    m_otaUpdates = std::forward<OtaUpdatesT>(value);
  }
  template <typename OtaUpdatesT = Aws::Vector<OTAUpdateSummary>>
  ListOTAUpdatesResult& WithOtaUpdates(OtaUpdatesT&& value) {
    SetOtaUpdates(std::forward<OtaUpdatesT>(value));
    return *this;
  }
  template <typename OtaUpdatesT = OTAUpdateSummary>
  ListOTAUpdatesResult& AddOtaUpdates(OtaUpdatesT&& value) {
    m_otaUpdatesHasBeenSet = true;
    m_otaUpdates.emplace_back(std::forward<OtaUpdatesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListOTAUpdatesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListOTAUpdatesResult& WithRequestId(RequestIdT&& value) {
