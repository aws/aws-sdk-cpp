...
class RetryCriteria {
 public:
  ...
  inline void SetFailureType(RetryableFailureType value) {
    m_failureTypeHasBeenSet = true;
    m_failureType = value;
  }
  inline RetryCriteria& WithFailureType(RetryableFailureType value) {
  ...
  inline void SetNumberOfRetries(int value) {
    m_numberOfRetriesHasBeenSet = true;
    m_numberOfRetries = value;
  }
  inline RetryCriteria& WithNumberOfRetries(int value) {
