...
namespace Model
{
  ...
  public:
    ...
    inline ListPrincipalThingsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ListPrincipalThingsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ListPrincipalThingsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
