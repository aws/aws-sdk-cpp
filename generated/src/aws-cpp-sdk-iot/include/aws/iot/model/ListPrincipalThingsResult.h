...
class ListPrincipalThingsResult {
 public:
  ...
  template <typename ThingsT = Aws::Vector<Aws::String>>
  ListPrincipalThingsResult& WithThings(ThingsT&& value) {
    SetThings(std::forward<ThingsT>(value));
    return *this;
  }
  template <typename ThingsT = Aws::String>
  ListPrincipalThingsResult& AddThings(ThingsT&& value) {
    m_thingsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListPrincipalThingsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListPrincipalThingsResult& WithRequestId(RequestIdT&& value) {
