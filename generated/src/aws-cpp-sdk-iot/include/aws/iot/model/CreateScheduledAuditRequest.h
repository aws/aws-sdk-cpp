...
class CreateScheduledAuditRequest : public IoTRequest {
 public:
  ...
  inline CreateScheduledAuditRequest& WithFrequency(AuditFrequency value) {
    SetFrequency(value);
    return *this;
  }
  ///@}
  ...
  inline CreateScheduledAuditRequest& WithDayOfWeek(DayOfWeek value) {
    SetDayOfWeek(value);
    return *this;
  }
  ///@}
