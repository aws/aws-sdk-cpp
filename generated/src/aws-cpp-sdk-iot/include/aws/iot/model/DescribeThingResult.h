...
class DescribeThingResult {
 public:
  ...
  void SetDefaultClientId(DefaultClientIdT&& value) {
    ...
    m_defaultClientId = std::forward<DefaultClientIdT>(value);
  }
  template <typename DefaultClientIdT = Aws::String>
  DescribeThingResult& WithDefaultClientId(DefaultClientIdT&& value) {
    SetDefaultClientId(std::forward<DefaultClientIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeThingResult& WithVersion(long long value) {
    SetVersion(value);
    return *this;
  }
  ///@}
