...
class ResourceIdentifier {
 public:
  ...
  void SetDeviceCertificateId(DeviceCertificateIdT&& value) {
    ...
    m_deviceCertificateId = std::forward<DeviceCertificateIdT>(value);
  }
  template <typename DeviceCertificateIdT = Aws::String>
  ResourceIdentifier& WithDeviceCertificateId(DeviceCertificateIdT&& value) {
    SetDeviceCertificateId(std::forward<DeviceCertificateIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCaCertificateId(CaCertificateIdT&& value) {
    ...
    m_caCertificateId = std::forward<CaCertificateIdT>(value);
  }
  template <typename CaCertificateIdT = Aws::String>
  ResourceIdentifier& WithCaCertificateId(CaCertificateIdT&& value) {
    SetCaCertificateId(std::forward<CaCertificateIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPolicyVersionIdentifier(PolicyVersionIdentifierT&& value) {
    ...
    m_policyVersionIdentifier = std::forward<PolicyVersionIdentifierT>(value);
  }
  template <typename PolicyVersionIdentifierT = PolicyVersionIdentifier>
  ResourceIdentifier& WithPolicyVersionIdentifier(PolicyVersionIdentifierT&& value) {
    SetPolicyVersionIdentifier(std::forward<PolicyVersionIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIssuerCertificateIdentifier(IssuerCertificateIdentifierT&& value) {
    ...
    m_issuerCertificateIdentifier = std::forward<IssuerCertificateIdentifierT>(value);
  }
  template <typename IssuerCertificateIdentifierT = IssuerCertificateIdentifier>
  ResourceIdentifier& WithIssuerCertificateIdentifier(IssuerCertificateIdentifierT&& value) {
    SetIssuerCertificateIdentifier(std::forward<IssuerCertificateIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDeviceCertificateArn(DeviceCertificateArnT&& value) {
    ...
    m_deviceCertificateArn = std::forward<DeviceCertificateArnT>(value);
  }
  template <typename DeviceCertificateArnT = Aws::String>
  ResourceIdentifier& WithDeviceCertificateArn(DeviceCertificateArnT&& value) {
    SetDeviceCertificateArn(std::forward<DeviceCertificateArnT>(value));
    return *this;
  }
  ///@}
 private:
