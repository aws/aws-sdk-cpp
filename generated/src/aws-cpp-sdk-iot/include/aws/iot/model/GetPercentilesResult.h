...
class GetPercentilesResult {
 public:
  ...
  template <typename PercentilesT = Aws::Vector<PercentPair>>
  GetPercentilesResult& WithPercentiles(PercentilesT&& value) {
    SetPercentiles(std::forward<PercentilesT>(value));
    return *this;
  }
  template <typename PercentilesT = PercentPair>
  GetPercentilesResult& AddPercentiles(PercentilesT&& value) {
    m_percentilesHasBeenSet = true;
    m_percentiles.emplace_back(std::forward<PercentilesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetPercentilesResult& WithRequestId(RequestIdT&& value) {
