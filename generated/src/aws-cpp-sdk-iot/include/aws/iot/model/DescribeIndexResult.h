...
class DescribeIndexResult {
 public:
  ...
  template <typename IndexNameT = Aws::String>
  DescribeIndexResult& WithIndexName(IndexNameT&& value) {
  ...
  inline DescribeIndexResult& WithIndexStatus(IndexStatus value) {
  ...
  template <typename SchemaT = Aws::String>
  DescribeIndexResult& WithSchema(SchemaT&& value) {
