...
class CodeSigning {
 public:
  ...
  void SetAwsSignerJobId(AwsSignerJobIdT&& value) {
    ...
    m_awsSignerJobId = std::forward<AwsSignerJobIdT>(value);
  }
  template <typename AwsSignerJobIdT = Aws::String>
  CodeSigning& WithAwsSignerJobId(AwsSignerJobIdT&& value) {
    SetAwsSignerJobId(std::forward<AwsSignerJobIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStartSigningJobParameter(StartSigningJobParameterT&& value) {
    ...
    m_startSigningJobParameter = std::forward<StartSigningJobParameterT>(value);
  }
  template <typename StartSigningJobParameterT = StartSigningJobParameter>
  CodeSigning& WithStartSigningJobParameter(StartSigningJobParameterT&& value) {
    SetStartSigningJobParameter(std::forward<StartSigningJobParameterT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCustomCodeSigning(CustomCodeSigningT&& value) {
    ...
    m_customCodeSigning = std::forward<CustomCodeSigningT>(value);
  }
  template <typename CustomCodeSigningT = CustomCodeSigning>
  CodeSigning& WithCustomCodeSigning(CustomCodeSigningT&& value) {
    SetCustomCodeSigning(std::forward<CustomCodeSigningT>(value));
    return *this;
  }
  ///@}
 private:
