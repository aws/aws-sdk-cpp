...
class GetCommandResult {
 public:
  ...
  inline GetCommandResult& WithNamespace(CommandNamespace value) {
    SetNamespace(value);
    return *this;
  }
  ///@}
  ...
  void SetMandatoryParameters(MandatoryParametersT&& value) {
    ...
    m_mandatoryParameters = std::forward<MandatoryParametersT>(value);
  }
  template <typename MandatoryParametersT = Aws::Vector<CommandParameter>>
  GetCommandResult& WithMandatoryParameters(MandatoryParametersT&& value) {
    SetMandatoryParameters(std::forward<MandatoryParametersT>(value));
    return *this;
  }
  ...
  GetCommandResult& AddMandatoryParameters(MandatoryParametersT&& value) {
    m_mandatoryParametersHasBeenSet = true;
    m_mandatoryParameters.emplace_back(std::forward<MandatoryParametersT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetCommandResult& WithDeprecated(bool value) {
    SetDeprecated(value);
    return *this;
  }
  ///@}
  ...
  inline GetCommandResult& WithPendingDeletion(bool value) {
