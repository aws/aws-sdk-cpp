...
class UpdateAccountAuditConfigurationRequest : public IoTRequest {
 public:
  ...
  template <typename RoleArnT = Aws::String>
  UpdateAccountAuditConfigurationRequest& WithRoleArn(RoleArnT&& value) {
  ...
  template <typename AuditNotificationTargetConfigurationsT = Aws::Map<AuditNotificationType, AuditNotificationTarget>>
  UpdateAccountAuditConfigurationRequest& WithAuditNotificationTargetConfigurations(AuditNotificationTargetConfigurationsT&& value) {
    SetAuditNotificationTargetConfigurations(std::forward<AuditNotificationTargetConfigurationsT>(value));
    return *this;
  }
  inline UpdateAccountAuditConfigurationRequest& AddAuditNotificationTargetConfigurations(AuditNotificationType key,
  ...
  template <typename AuditCheckConfigurationsT = Aws::Map<Aws::String, AuditCheckConfiguration>>
  UpdateAccountAuditConfigurationRequest& WithAuditCheckConfigurations(AuditCheckConfigurationsT&& value) {
  ...
  UpdateAccountAuditConfigurationRequest& AddAuditCheckConfigurations(AuditCheckConfigurationsKeyT&& key,
