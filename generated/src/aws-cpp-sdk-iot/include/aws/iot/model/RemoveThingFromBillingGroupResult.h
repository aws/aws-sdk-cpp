...
namespace Model
{
  ...
  {
  public:
    AWS_IOT_API RemoveThingFromBillingGroupResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    RemoveThingFromBillingGroupResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
