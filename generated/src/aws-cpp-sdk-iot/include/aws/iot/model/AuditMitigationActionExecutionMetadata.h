...
class AuditMitigationActionExecutionMetadata {
 public:
  ...
  inline void SetStatus(AuditMitigationActionsExecutionStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline AuditMitigationActionExecutionMetadata& WithStatus(AuditMitigationActionsExecutionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
