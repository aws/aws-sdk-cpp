...
class DynamoDBAction {
 public:
  ...
  inline void SetHashKeyType(DynamoKeyType value) {
    m_hashKeyTypeHasBeenSet = true;
    m_hashKeyType = value;
  }
  inline DynamoDBAction& WithHashKeyType(DynamoKeyType value) {
    SetHashKeyType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRangeKeyType(DynamoKeyType value) {
    m_rangeKeyTypeHasBeenSet = true;
    m_rangeKeyType = value;
  }
  inline DynamoDBAction& WithRangeKeyType(DynamoKeyType value) {
    SetRangeKeyType(value);
    return *this;
  }
  ///@}
