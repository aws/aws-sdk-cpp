...
class ListV2LoggingLevelsResult {
 public:
  ...
  void SetLogTargetConfigurations(LogTargetConfigurationsT&& value) {
    m_logTargetConfigurationsHasBeenSet = true;
    m_logTargetConfigurations = std::forward<LogTargetConfigurationsT>(value);
  }
  template <typename LogTargetConfigurationsT = Aws::Vector<LogTargetConfiguration>>
  ListV2LoggingLevelsResult& WithLogTargetConfigurations(LogTargetConfigurationsT&& value) {
    SetLogTargetConfigurations(std::forward<LogTargetConfigurationsT>(value));
    return *this;
  }
  template <typename LogTargetConfigurationsT = LogTargetConfiguration>
  ListV2LoggingLevelsResult& AddLogTargetConfigurations(LogTargetConfigurationsT&& value) {
    m_logTargetConfigurationsHasBeenSet = true;
    m_logTargetConfigurations.emplace_back(std::forward<LogTargetConfigurationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListV2LoggingLevelsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListV2LoggingLevelsResult& WithRequestId(RequestIdT&& value) {
