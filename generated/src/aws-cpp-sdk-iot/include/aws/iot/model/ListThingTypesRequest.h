...
class ListThingTypesRequest : public IoTRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListThingTypesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListThingTypesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename ThingTypeNameT = Aws::String>
  ListThingTypesRequest& WithThingTypeName(ThingTypeNameT&& value) {
