...
class CreateOTAUpdateRequest : public IoTRequest {
 public:
  ...
  inline CreateOTAUpdateRequest& AddProtocols(Protocol value) {
    m_protocolsHasBeenSet = true;
  ...
  inline CreateOTAUpdateRequest& WithTargetSelection(TargetSelection value) {
  ...
  void SetAwsJobAbortConfig(AwsJobAbortConfigT&& value) {
    m_awsJobAbortConfigHasBeenSet = true;
    m_awsJobAbortConfig = std::forward<AwsJobAbortConfigT>(value);
  }
  template <typename AwsJobAbortConfigT = AwsJobAbortConfig>
  CreateOTAUpdateRequest& WithAwsJobAbortConfig(AwsJobAbortConfigT&& value) {
    SetAwsJobAbortConfig(std::forward<AwsJobAbortConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAwsJobTimeoutConfig(AwsJobTimeoutConfigT&& value) {
    m_awsJobTimeoutConfigHasBeenSet = true;
    m_awsJobTimeoutConfig = std::forward<AwsJobTimeoutConfigT>(value);
  }
  template <typename AwsJobTimeoutConfigT = AwsJobTimeoutConfig>
  CreateOTAUpdateRequest& WithAwsJobTimeoutConfig(AwsJobTimeoutConfigT&& value) {
    SetAwsJobTimeoutConfig(std::forward<AwsJobTimeoutConfigT>(value));
    return *this;
  }
  ///@}
