...
class CertificateDescription {
 public:
  ...
  inline CertificateDescription& WithStatus(CertificateStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetPreviousOwnedBy(PreviousOwnedByT&& value) {
    ...
    m_previousOwnedBy = std::forward<PreviousOwnedByT>(value);
  }
  template <typename PreviousOwnedByT = Aws::String>
  CertificateDescription& WithPreviousOwnedBy(PreviousOwnedByT&& value) {
    SetPreviousOwnedBy(std::forward<PreviousOwnedByT>(value));
    return *this;
  }
  ///@}
  ...
  inline CertificateDescription& WithCustomerVersion(int value) {
  ...
  void SetTransferData(TransferDataT&& value) {
    ...
    m_transferData = std::forward<TransferDataT>(value);
  }
  template <typename TransferDataT = TransferData>
  CertificateDescription& WithTransferData(TransferDataT&& value) {
    SetTransferData(std::forward<TransferDataT>(value));
    return *this;
  }
  ///@}
  ...
  inline CertificateDescription& WithCertificateMode(CertificateMode value) {
