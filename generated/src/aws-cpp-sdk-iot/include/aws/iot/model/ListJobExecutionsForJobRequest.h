...
namespace Model
{
  ...
  public:
    ...
    template<typename JobIdT = Aws::String>
    ListJobExecutionsForJobRequest& WithJobId(JobIdT&& value) { SetJobId(std::forward<JobIdT>(value)); return *this;}
    ///@}
    ...
    inline ListJobExecutionsForJobRequest& WithStatus(JobExecutionStatus value) { SetStatus(value); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListJobExecutionsForJobRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
