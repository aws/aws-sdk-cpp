...
class UpdateSecurityProfileRequest : public IoTRequest {
 public:
  ...
  inline void SetDeleteBehaviors(bool value) {
    m_deleteBehaviorsHasBeenSet = true;
    m_deleteBehaviors = value;
  }
  inline UpdateSecurityProfileRequest& WithDeleteBehaviors(bool value) {
    SetDeleteBehaviors(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDeleteAlertTargets(bool value) {
    m_deleteAlertTargetsHasBeenSet = true;
    m_deleteAlertTargets = value;
  }
  inline UpdateSecurityProfileRequest& WithDeleteAlertTargets(bool value) {
    SetDeleteAlertTargets(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDeleteAdditionalMetricsToRetain(bool value) {
    m_deleteAdditionalMetricsToRetainHasBeenSet = true;
    m_deleteAdditionalMetricsToRetain = value;
  }
  inline UpdateSecurityProfileRequest& WithDeleteAdditionalMetricsToRetain(bool value) {
    SetDeleteAdditionalMetricsToRetain(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateSecurityProfileRequest& WithExpectedVersion(long long value) {
  ...
  inline void SetDeleteMetricsExportConfig(bool value) {
    m_deleteMetricsExportConfigHasBeenSet = true;
    m_deleteMetricsExportConfig = value;
  }
  inline UpdateSecurityProfileRequest& WithDeleteMetricsExportConfig(bool value) {
    SetDeleteMetricsExportConfig(value);
    return *this;
  }
  ///@}
 private:
