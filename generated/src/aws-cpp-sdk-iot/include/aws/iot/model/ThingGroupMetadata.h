...
class ThingGroupMetadata {
 public:
  ...
  void SetRootToParentThingGroups(RootToParentThingGroupsT&& value) {
    ...
    m_rootToParentThingGroups = std::forward<RootToParentThingGroupsT>(value);
  }
  template <typename RootToParentThingGroupsT = Aws::Vector<GroupNameAndArn>>
  ThingGroupMetadata& WithRootToParentThingGroups(RootToParentThingGroupsT&& value) {
    SetRootToParentThingGroups(std::forward<RootToParentThingGroupsT>(value));
    return *this;
  }
  ...
  ThingGroupMetadata& AddRootToParentThingGroups(RootToParentThingGroupsT&& value) {
    m_rootToParentThingGroupsHasBeenSet = true;
    m_rootToParentThingGroups.emplace_back(std::forward<RootToParentThingGroupsT>(value));
    return *this;
  }
  ///@}
