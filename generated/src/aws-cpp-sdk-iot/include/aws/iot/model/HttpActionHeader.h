...
namespace Model
{
  ...
  {
  public:
    AWS_IOT_API HttpActionHeader() = default;
    ...
    template<typename KeyT = Aws::String>
    HttpActionHeader& WithKey(KeyT&& value) { SetKey(std::forward<KeyT>(value)); return *this;}
    ///@}
    ...
    template<typename ValueT = Aws::String>
    HttpActionHeader& WithValue(ValueT&& value) { SetValue(std::forward<ValueT>(value)); return *this;}
    ///@}
  private:
