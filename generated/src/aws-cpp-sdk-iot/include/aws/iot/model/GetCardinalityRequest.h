...
class GetCardinalityRequest : public IoTRequest {
 public:
  ...
  template <typename IndexNameT = Aws::String>
  GetCardinalityRequest& WithIndexName(IndexNameT&& value) {
  ...
  template <typename QueryStringT = Aws::String>
  GetCardinalityRequest& WithQueryString(QueryStringT&& value) {
  ...
  template <typename AggregationFieldT = Aws::String>
  GetCardinalityRequest& WithAggregationField(AggregationFieldT&& value) {
  ...
  template <typename QueryVersionT = Aws::String>
  GetCardinalityRequest& WithQueryVersion(QueryVersionT&& value) {
