...
class ListCACertificatesResult {
 public:
  ...
  template <typename CertificatesT = Aws::Vector<CACertificate>>
  ListCACertificatesResult& WithCertificates(CertificatesT&& value) {
    SetCertificates(std::forward<CertificatesT>(value));
    return *this;
  }
  template <typename CertificatesT = CACertificate>
  ListCACertificatesResult& AddCertificates(CertificatesT&& value) {
    m_certificatesHasBeenSet = true;
  ...
  template <typename NextMarkerT = Aws::String>
  ListCACertificatesResult& WithNextMarker(NextMarkerT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListCACertificatesResult& WithRequestId(RequestIdT&& value) {
