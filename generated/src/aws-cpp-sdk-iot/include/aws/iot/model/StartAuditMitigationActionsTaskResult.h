...
namespace Model
{
  ...
  {
  public:
    AWS_IOT_API StartAuditMitigationActionsTaskResult() = default;
    ...
    template<typename TaskIdT = Aws::String>
    StartAuditMitigationActionsTaskResult& WithTaskId(TaskIdT&& value) { SetTaskId(std::forward<TaskIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    StartAuditMitigationActionsTaskResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
