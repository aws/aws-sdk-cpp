...
class ListPackageVersionsResult {
 public:
  ...
  void SetPackageVersionSummaries(PackageVersionSummariesT&& value) {
    m_packageVersionSummariesHasBeenSet = true;
    m_packageVersionSummaries = std::forward<PackageVersionSummariesT>(value);
  }
  template <typename PackageVersionSummariesT = Aws::Vector<PackageVersionSummary>>
  ListPackageVersionsResult& WithPackageVersionSummaries(PackageVersionSummariesT&& value) {
    SetPackageVersionSummaries(std::forward<PackageVersionSummariesT>(value));
    return *this;
  }
  template <typename PackageVersionSummariesT = PackageVersionSummary>
  ListPackageVersionsResult& AddPackageVersionSummaries(PackageVersionSummariesT&& value) {
    m_packageVersionSummariesHasBeenSet = true;
    m_packageVersionSummaries.emplace_back(std::forward<PackageVersionSummariesT>(value));
    return *this;
  }
  ///@}
