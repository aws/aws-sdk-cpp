...
namespace Model
{
  ...
  public:
    ...
    template<typename MetricNameT = Aws::String>
    UpdateCustomMetricResult& WithMetricName(MetricNameT&& value) { SetMetricName(std::forward<MetricNameT>(value)); return *this;}
    ///@}
    ...
    template<typename MetricArnT = Aws::String>
    UpdateCustomMetricResult& WithMetricArn(MetricArnT&& value) { SetMetricArn(std::forward<MetricArnT>(value)); return *this;}
    ///@}
    ...
    inline UpdateCustomMetricResult& WithMetricType(CustomMetricType value) { SetMetricType(value); return *this;}
    ///@}
    ...
    template<typename DisplayNameT = Aws::String>
    UpdateCustomMetricResult& WithDisplayName(DisplayNameT&& value) { SetDisplayName(std::forward<DisplayNameT>(value)); return *this;}
    ///@}
    ...
    template<typename CreationDateT = Aws::Utils::DateTime>
    UpdateCustomMetricResult& WithCreationDate(CreationDateT&& value) { SetCreationDate(std::forward<CreationDateT>(value)); return *this;}
    ///@}
    ...
    template<typename LastModifiedDateT = Aws::Utils::DateTime>
    UpdateCustomMetricResult& WithLastModifiedDate(LastModifiedDateT&& value) { SetLastModifiedDate(std::forward<LastModifiedDateT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateCustomMetricResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
