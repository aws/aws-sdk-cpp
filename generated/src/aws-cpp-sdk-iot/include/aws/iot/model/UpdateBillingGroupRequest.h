...
class UpdateBillingGroupRequest : public IoTRequest {
 public:
  ...
  template <typename BillingGroupNameT = Aws::String>
  UpdateBillingGroupRequest& WithBillingGroupName(BillingGroupNameT&& value) {
  ...
  template <typename BillingGroupPropertiesT = BillingGroupProperties>
  UpdateBillingGroupRequest& WithBillingGroupProperties(BillingGroupPropertiesT&& value) {
  ...
  inline UpdateBillingGroupRequest& WithExpectedVersion(long long value) {
