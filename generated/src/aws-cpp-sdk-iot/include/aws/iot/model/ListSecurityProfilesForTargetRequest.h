...
class ListSecurityProfilesForTargetRequest : public IoTRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListSecurityProfilesForTargetRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListSecurityProfilesForTargetRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline ListSecurityProfilesForTargetRequest& WithRecursive(bool value) {
    SetRecursive(value);
    return *this;
  }
  ///@}
  ...
  template <typename SecurityProfileTargetArnT = Aws::String>
  ListSecurityProfilesForTargetRequest& WithSecurityProfileTargetArn(SecurityProfileTargetArnT&& value) {
