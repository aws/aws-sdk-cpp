...
class ListThingGroupsForThingResult {
 public:
  ...
  template <typename ThingGroupsT = Aws::Vector<GroupNameAndArn>>
  ListThingGroupsForThingResult& WithThingGroups(ThingGroupsT&& value) {
    SetThingGroups(std::forward<ThingGroupsT>(value));
    return *this;
  }
  template <typename ThingGroupsT = GroupNameAndArn>
  ListThingGroupsForThingResult& AddThingGroups(ThingGroupsT&& value) {
    m_thingGroupsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListThingGroupsForThingResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListThingGroupsForThingResult& WithRequestId(RequestIdT&& value) {
