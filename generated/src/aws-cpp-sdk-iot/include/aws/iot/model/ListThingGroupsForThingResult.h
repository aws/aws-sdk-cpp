...
namespace Model
{
  ...
  public:
    ...
    inline ListThingGroupsForThingResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}
    inline ListThingGroupsForThingResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}
    inline ListThingGroupsForThingResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
    ///@}
  private:
