...
class GetTopicRuleDestinationResult {
 public:
  AWS_IOT_API GetTopicRuleDestinationResult() = default;
  ...
  void SetTopicRuleDestination(TopicRuleDestinationT&& value) {
    m_topicRuleDestinationHasBeenSet = true;
    m_topicRuleDestination = std::forward<TopicRuleDestinationT>(value);
  }
  template <typename TopicRuleDestinationT = TopicRuleDestination>
  GetTopicRuleDestinationResult& WithTopicRuleDestination(TopicRuleDestinationT&& value) {
    SetTopicRuleDestination(std::forward<TopicRuleDestinationT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetTopicRuleDestinationResult& WithRequestId(RequestIdT&& value) {
