...
class ListTargetsForSecurityProfileRequest : public IoTRequest {
 public:
  ...
  template <typename SecurityProfileNameT = Aws::String>
  ListTargetsForSecurityProfileRequest& WithSecurityProfileName(SecurityProfileNameT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListTargetsForSecurityProfileRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListTargetsForSecurityProfileRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
