...
class AwsJobAbortCriteria {
 public:
  ...
  inline void SetFailureType(AwsJobAbortCriteriaFailureType value) {
    m_failureTypeHasBeenSet = true;
    m_failureType = value;
  }
  inline AwsJobAbortCriteria& WithFailureType(AwsJobAbortCriteriaFailureType value) {
  ...
  inline void SetAction(AwsJobAbortCriteriaAbortAction value) {
    m_actionHasBeenSet = true;
    m_action = value;
  }
  inline AwsJobAbortCriteria& WithAction(AwsJobAbortCriteriaAbortAction value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  inline AwsJobAbortCriteria& WithThresholdPercentage(double value) {
  ...
  inline AwsJobAbortCriteria& WithMinNumberOfExecutedThings(int value) {
