...
class ListCertificateProvidersResult {
 public:
  ...
  void SetCertificateProviders(CertificateProvidersT&& value) {
    m_certificateProvidersHasBeenSet = true;
    m_certificateProviders = std::forward<CertificateProvidersT>(value);
  }
  template <typename CertificateProvidersT = Aws::Vector<CertificateProviderSummary>>
  ListCertificateProvidersResult& WithCertificateProviders(CertificateProvidersT&& value) {
    SetCertificateProviders(std::forward<CertificateProvidersT>(value));
    return *this;
  }
  template <typename CertificateProvidersT = CertificateProviderSummary>
  ListCertificateProvidersResult& AddCertificateProviders(CertificateProvidersT&& value) {
    m_certificateProvidersHasBeenSet = true;
    m_certificateProviders.emplace_back(std::forward<CertificateProvidersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListCertificateProvidersResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListCertificateProvidersResult& WithRequestId(RequestIdT&& value) {
