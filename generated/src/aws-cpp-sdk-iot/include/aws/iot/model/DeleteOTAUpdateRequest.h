...
class DeleteOTAUpdateRequest : public IoTRequest {
 public:
  ...
  template <typename OtaUpdateIdT = Aws::String>
  DeleteOTAUpdateRequest& WithOtaUpdateId(OtaUpdateIdT&& value) {
  ...
  inline void SetDeleteStream(bool value) {
    m_deleteStreamHasBeenSet = true;
    m_deleteStream = value;
  }
  inline DeleteOTAUpdateRequest& WithDeleteStream(bool value) {
    SetDeleteStream(value);
    return *this;
  }
  ///@}
  ...
  inline void SetForceDeleteAWSJob(bool value) {
    m_forceDeleteAWSJobHasBeenSet = true;
    m_forceDeleteAWSJob = value;
  }
  inline DeleteOTAUpdateRequest& WithForceDeleteAWSJob(bool value) {
    SetForceDeleteAWSJob(value);
    return *this;
  }
  ///@}
 private:
