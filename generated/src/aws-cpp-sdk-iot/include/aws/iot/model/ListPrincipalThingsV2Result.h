...
class ListPrincipalThingsV2Result {
 public:
  ...
  void SetPrincipalThingObjects(PrincipalThingObjectsT&& value) {
    m_principalThingObjectsHasBeenSet = true;
    m_principalThingObjects = std::forward<PrincipalThingObjectsT>(value);
  }
  template <typename PrincipalThingObjectsT = Aws::Vector<PrincipalThingObject>>
  ListPrincipalThingsV2Result& WithPrincipalThingObjects(PrincipalThingObjectsT&& value) {
    SetPrincipalThingObjects(std::forward<PrincipalThingObjectsT>(value));
    return *this;
  }
  template <typename PrincipalThingObjectsT = PrincipalThingObject>
  ListPrincipalThingsV2Result& AddPrincipalThingObjects(PrincipalThingObjectsT&& value) {
    m_principalThingObjectsHasBeenSet = true;
    m_principalThingObjects.emplace_back(std::forward<PrincipalThingObjectsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListPrincipalThingsV2Result& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListPrincipalThingsV2Result& WithRequestId(RequestIdT&& value) {
