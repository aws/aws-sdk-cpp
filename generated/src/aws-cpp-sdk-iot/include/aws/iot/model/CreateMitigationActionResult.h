...
class CreateMitigationActionResult {
 public:
  AWS_IOT_API CreateMitigationActionResult() = default;
  ...
  template <typename ActionArnT = Aws::String>
  CreateMitigationActionResult& WithActionArn(ActionArnT&& value) {
  ...
  template <typename ActionIdT = Aws::String>
  CreateMitigationActionResult& WithActionId(ActionIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateMitigationActionResult& WithRequestId(RequestIdT&& value) {
