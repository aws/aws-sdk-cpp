...
namespace Model
{
  ...
  {
  public:
    AWS_IOT_API DetachThingPrincipalResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DetachThingPrincipalResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
