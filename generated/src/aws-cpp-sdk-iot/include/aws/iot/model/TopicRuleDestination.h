...
class TopicRuleDestination {
 public:
  ...
  inline TopicRuleDestination& WithStatus(TopicRuleDestinationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetHttpUrlProperties(HttpUrlPropertiesT&& value) {
    ...
    m_httpUrlProperties = std::forward<HttpUrlPropertiesT>(value);
  }
  template <typename HttpUrlPropertiesT = HttpUrlDestinationProperties>
  TopicRuleDestination& WithHttpUrlProperties(HttpUrlPropertiesT&& value) {
    SetHttpUrlProperties(std::forward<HttpUrlPropertiesT>(value));
    return *this;
  }
  ///@}
