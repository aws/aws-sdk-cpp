...
class BehaviorModelTrainingSummary {
 public:
  ...
  void SetBehaviorName(BehaviorNameT&& value) {
    ...
    m_behaviorName = std::forward<BehaviorNameT>(value);
  }
  template <typename BehaviorNameT = Aws::String>
  BehaviorModelTrainingSummary& WithBehaviorName(BehaviorNameT&& value) {
    SetBehaviorName(std::forward<BehaviorNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTrainingDataCollectionStartDate(TrainingDataCollectionStartDateT&& value) {
    ...
    m_trainingDataCollectionStartDate = std::forward<TrainingDataCollectionStartDateT>(value);
  }
  template <typename TrainingDataCollectionStartDateT = Aws::Utils::DateTime>
  BehaviorModelTrainingSummary& WithTrainingDataCollectionStartDate(TrainingDataCollectionStartDateT&& value) {
    SetTrainingDataCollectionStartDate(std::forward<TrainingDataCollectionStartDateT>(value));
    return *this;
  }
  ///@}
  ...
  inline BehaviorModelTrainingSummary& WithModelStatus(ModelStatus value) {
  ...
  inline void SetDatapointsCollectionPercentage(double value) {
    m_datapointsCollectionPercentageHasBeenSet = true;
    m_datapointsCollectionPercentage = value;
  }
  inline BehaviorModelTrainingSummary& WithDatapointsCollectionPercentage(double value) {
    SetDatapointsCollectionPercentage(value);
    return *this;
  }
  ///@}
  ...
  void SetLastModelRefreshDate(LastModelRefreshDateT&& value) {
    ...
    m_lastModelRefreshDate = std::forward<LastModelRefreshDateT>(value);
  }
  template <typename LastModelRefreshDateT = Aws::Utils::DateTime>
  BehaviorModelTrainingSummary& WithLastModelRefreshDate(LastModelRefreshDateT&& value) {
    SetLastModelRefreshDate(std::forward<LastModelRefreshDateT>(value));
    return *this;
  }
  ///@}
 private:
