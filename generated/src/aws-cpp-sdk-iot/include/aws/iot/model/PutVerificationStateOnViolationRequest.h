...
class PutVerificationStateOnViolationRequest : public IoTRequest {
 public:
  ...
  template <typename ViolationIdT = Aws::String>
  PutVerificationStateOnViolationRequest& WithViolationId(ViolationIdT&& value) {
  ...
  inline PutVerificationStateOnViolationRequest& WithVerificationState(VerificationState value) {
  ...
  template <typename VerificationStateDescriptionT = Aws::String>
  PutVerificationStateOnViolationRequest& WithVerificationStateDescription(VerificationStateDescriptionT&& value) {
