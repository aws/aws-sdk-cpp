...
class DeletePackageVersionRequest : public IoTRequest {
 public:
  ...
  template <typename PackageNameT = Aws::String>
  DeletePackageVersionRequest& WithPackageName(PackageNameT&& value) {
  ...
  template <typename VersionNameT = Aws::String>
  DeletePackageVersionRequest& WithVersionName(VersionNameT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  DeletePackageVersionRequest& WithClientToken(ClientTokenT&& value) {
