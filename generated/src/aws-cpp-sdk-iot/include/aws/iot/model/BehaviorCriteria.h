...
class BehaviorCriteria {
 public:
  ...
  inline BehaviorCriteria& WithComparisonOperator(ComparisonOperator value) {
  ...
  inline BehaviorCriteria& WithDurationSeconds(int value) {
  ...
  inline void SetConsecutiveDatapointsToAlarm(int value) {
    m_consecutiveDatapointsToAlarmHasBeenSet = true;
    m_consecutiveDatapointsToAlarm = value;
  }
  inline BehaviorCriteria& WithConsecutiveDatapointsToAlarm(int value) {
    SetConsecutiveDatapointsToAlarm(value);
    return *this;
  }
  ///@}
  ...
  inline void SetConsecutiveDatapointsToClear(int value) {
    m_consecutiveDatapointsToClearHasBeenSet = true;
    m_consecutiveDatapointsToClear = value;
  }
  inline BehaviorCriteria& WithConsecutiveDatapointsToClear(int value) {
    SetConsecutiveDatapointsToClear(value);
    return *this;
  }
  ///@}
  ...
  void SetStatisticalThreshold(StatisticalThresholdT&& value) {
    ...
    m_statisticalThreshold = std::forward<StatisticalThresholdT>(value);
  }
  template <typename StatisticalThresholdT = StatisticalThreshold>
  BehaviorCriteria& WithStatisticalThreshold(StatisticalThresholdT&& value) {
    SetStatisticalThreshold(std::forward<StatisticalThresholdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMlDetectionConfig(MlDetectionConfigT&& value) {
    ...
    m_mlDetectionConfig = std::forward<MlDetectionConfigT>(value);
  }
  template <typename MlDetectionConfigT = MachineLearningDetectionConfig>
  BehaviorCriteria& WithMlDetectionConfig(MlDetectionConfigT&& value) {
    SetMlDetectionConfig(std::forward<MlDetectionConfigT>(value));
    return *this;
  }
  ///@}
 private:
