...
class IndexingFilter {
 public:
  ...
  void SetNamedShadowNames(NamedShadowNamesT&& value) {
    m_namedShadowNamesHasBeenSet = true;
    m_namedShadowNames = std::forward<NamedShadowNamesT>(value);
  }
  template <typename NamedShadowNamesT = Aws::Vector<Aws::String>>
  IndexingFilter& WithNamedShadowNames(NamedShadowNamesT&& value) {
    SetNamedShadowNames(std::forward<NamedShadowNamesT>(value));
    return *this;
  }
  template <typename NamedShadowNamesT = Aws::String>
  IndexingFilter& AddNamedShadowNames(NamedShadowNamesT&& value) {
    m_namedShadowNamesHasBeenSet = true;
    m_namedShadowNames.emplace_back(std::forward<NamedShadowNamesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGeoLocations(GeoLocationsT&& value) {
    m_geoLocationsHasBeenSet = true;
    m_geoLocations = std::forward<GeoLocationsT>(value);
  }
  template <typename GeoLocationsT = Aws::Vector<GeoLocationTarget>>
  IndexingFilter& WithGeoLocations(GeoLocationsT&& value) {
    SetGeoLocations(std::forward<GeoLocationsT>(value));
    return *this;
  }
  template <typename GeoLocationsT = GeoLocationTarget>
  IndexingFilter& AddGeoLocations(GeoLocationsT&& value) {
    m_geoLocationsHasBeenSet = true;
    m_geoLocations.emplace_back(std::forward<GeoLocationsT>(value));
    return *this;
  }
  ///@}
 private:
