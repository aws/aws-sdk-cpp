...
class ListV2LoggingLevelsRequest : public IoTRequest {
 public:
  AWS_IOT_API ListV2LoggingLevelsRequest() = default;
  ...
  inline void SetTargetType(LogTargetType value) {
    m_targetTypeHasBeenSet = true;
    m_targetType = value;
  }
  inline ListV2LoggingLevelsRequest& WithTargetType(LogTargetType value) {
    SetTargetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListV2LoggingLevelsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListV2LoggingLevelsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
