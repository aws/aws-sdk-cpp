...
namespace Model
{
  ...
  public:
    ...
    inline ListV2LoggingLevelsRequest& WithTargetType(LogTargetType value) { SetTargetType(value); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListV2LoggingLevelsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
