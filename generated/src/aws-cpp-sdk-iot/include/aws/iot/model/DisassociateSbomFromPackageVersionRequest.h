...
class DisassociateSbomFromPackageVersionRequest : public IoTRequest {
 public:
  ...
  template <typename PackageNameT = Aws::String>
  DisassociateSbomFromPackageVersionRequest& WithPackageName(PackageNameT&& value) {
  ...
  template <typename VersionNameT = Aws::String>
  DisassociateSbomFromPackageVersionRequest& WithVersionName(VersionNameT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  DisassociateSbomFromPackageVersionRequest& WithClientToken(ClientTokenT&& value) {
