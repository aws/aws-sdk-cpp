...
class ListMetricValuesRequest : public IoTRequest {
 public:
  ...
  inline void SetDimensionValueOperator(DimensionValueOperator value) {
    m_dimensionValueOperatorHasBeenSet = true;
    m_dimensionValueOperator = value;
  }
  inline ListMetricValuesRequest& WithDimensionValueOperator(DimensionValueOperator value) {
    SetDimensionValueOperator(value);
    return *this;
  }
  ///@}
  ...
  inline ListMetricValuesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
