...
class ListJobExecutionsForThingResult {
 public:
  ...
  template <typename ExecutionSummariesT = Aws::Vector<JobExecutionSummaryForThing>>
  ListJobExecutionsForThingResult& WithExecutionSummaries(ExecutionSummariesT&& value) {
  ...
  ListJobExecutionsForThingResult& AddExecutionSummaries(ExecutionSummariesT&& value) {
    m_executionSummariesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListJobExecutionsForThingResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListJobExecutionsForThingResult& WithRequestId(RequestIdT&& value) {
