...
class CreateDimensionResult {
 public:
  AWS_IOT_API CreateDimensionResult() = default;
  ...
  template <typename NameT = Aws::String>
  CreateDimensionResult& WithName(NameT&& value) {
  ...
  template <typename ArnT = Aws::String>
  CreateDimensionResult& WithArn(ArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateDimensionResult& WithRequestId(RequestIdT&& value) {
