...
class CreateStreamResult {
 public:
  ...
  template <typename StreamIdT = Aws::String>
  CreateStreamResult& WithStreamId(StreamIdT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateStreamResult& WithDescription(DescriptionT&& value) {
  ...
  inline CreateStreamResult& WithStreamVersion(int value) {
