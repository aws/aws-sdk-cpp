...
class UpdateStreamResult {
 public:
  ...
  template <typename StreamIdT = Aws::String>
  UpdateStreamResult& WithStreamId(StreamIdT&& value) {
  ...
  template <typename StreamArnT = Aws::String>
  UpdateStreamResult& WithStreamArn(StreamArnT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateStreamResult& WithDescription(DescriptionT&& value) {
  ...
  inline void SetStreamVersion(int value) {
    m_streamVersionHasBeenSet = true;
    m_streamVersion = value;
  }
  inline UpdateStreamResult& WithStreamVersion(int value) {
    SetStreamVersion(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  UpdateStreamResult& WithRequestId(RequestIdT&& value) {
