...
class ThingIndexingConfiguration {
 public:
  ...
  inline void SetThingIndexingMode(ThingIndexingMode value) {
    m_thingIndexingModeHasBeenSet = true;
    m_thingIndexingMode = value;
  }
  inline ThingIndexingConfiguration& WithThingIndexingMode(ThingIndexingMode value) {
    SetThingIndexingMode(value);
    return *this;
  }
  ///@}
  ...
  inline void SetThingConnectivityIndexingMode(ThingConnectivityIndexingMode value) {
    m_thingConnectivityIndexingModeHasBeenSet = true;
    m_thingConnectivityIndexingMode = value;
  }
  inline ThingIndexingConfiguration& WithThingConnectivityIndexingMode(ThingConnectivityIndexingMode value) {
    SetThingConnectivityIndexingMode(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDeviceDefenderIndexingMode(DeviceDefenderIndexingMode value) {
    m_deviceDefenderIndexingModeHasBeenSet = true;
    m_deviceDefenderIndexingMode = value;
  }
  inline ThingIndexingConfiguration& WithDeviceDefenderIndexingMode(DeviceDefenderIndexingMode value) {
    SetDeviceDefenderIndexingMode(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNamedShadowIndexingMode(NamedShadowIndexingMode value) {
    m_namedShadowIndexingModeHasBeenSet = true;
    m_namedShadowIndexingMode = value;
  }
  inline ThingIndexingConfiguration& WithNamedShadowIndexingMode(NamedShadowIndexingMode value) {
    SetNamedShadowIndexingMode(value);
    return *this;
  }
  ///@}
