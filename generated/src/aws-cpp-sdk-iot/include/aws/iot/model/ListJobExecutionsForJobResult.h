...
class ListJobExecutionsForJobResult {
 public:
  ...
  template <typename ExecutionSummariesT = Aws::Vector<JobExecutionSummaryForJob>>
  ListJobExecutionsForJobResult& WithExecutionSummaries(ExecutionSummariesT&& value) {
  ...
  ListJobExecutionsForJobResult& AddExecutionSummaries(ExecutionSummariesT&& value) {
    m_executionSummariesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListJobExecutionsForJobResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListJobExecutionsForJobResult& WithRequestId(RequestIdT&& value) {
