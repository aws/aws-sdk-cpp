...
class GetOTAUpdateResult {
 public:
  ...
  void SetOtaUpdateInfo(OtaUpdateInfoT&& value) {
    m_otaUpdateInfoHasBeenSet = true;
    m_otaUpdateInfo = std::forward<OtaUpdateInfoT>(value);
  }
  template <typename OtaUpdateInfoT = OTAUpdateInfo>
  GetOTAUpdateResult& WithOtaUpdateInfo(OtaUpdateInfoT&& value) {
    SetOtaUpdateInfo(std::forward<OtaUpdateInfoT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetOTAUpdateResult& WithRequestId(RequestIdT&& value) {
