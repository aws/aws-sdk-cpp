...
class AuditFinding {
 public:
  ...
  void SetFindingTime(FindingTimeT&& value) {
    ...
    m_findingTime = std::forward<FindingTimeT>(value);
  }
  template <typename FindingTimeT = Aws::Utils::DateTime>
  AuditFinding& WithFindingTime(FindingTimeT&& value) {
    SetFindingTime(std::forward<FindingTimeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetSeverity(AuditFindingSeverity value) {
    m_severityHasBeenSet = true;
    m_severity = value;
  }
  inline AuditFinding& WithSeverity(AuditFindingSeverity value) {
    SetSeverity(value);
    return *this;
  }
  ///@}
  ...
  void SetNonCompliantResource(NonCompliantResourceT&& value) {
    ...
    m_nonCompliantResource = std::forward<NonCompliantResourceT>(value);
  }
  template <typename NonCompliantResourceT = NonCompliantResource>
  AuditFinding& WithNonCompliantResource(NonCompliantResourceT&& value) {
    SetNonCompliantResource(std::forward<NonCompliantResourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReasonForNonCompliance(ReasonForNonComplianceT&& value) {
    ...
    m_reasonForNonCompliance = std::forward<ReasonForNonComplianceT>(value);
  }
  template <typename ReasonForNonComplianceT = Aws::String>
  AuditFinding& WithReasonForNonCompliance(ReasonForNonComplianceT&& value) {
    SetReasonForNonCompliance(std::forward<ReasonForNonComplianceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReasonForNonComplianceCode(ReasonForNonComplianceCodeT&& value) {
    ...
    m_reasonForNonComplianceCode = std::forward<ReasonForNonComplianceCodeT>(value);
  }
  template <typename ReasonForNonComplianceCodeT = Aws::String>
  AuditFinding& WithReasonForNonComplianceCode(ReasonForNonComplianceCodeT&& value) {
    SetReasonForNonComplianceCode(std::forward<ReasonForNonComplianceCodeT>(value));
    return *this;
  }
  ///@}
  ...
  inline AuditFinding& WithIsSuppressed(bool value) {
