...
class AggregationType {
 public:
  ...
  inline void SetName(AggregationTypeName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline AggregationType& WithName(AggregationTypeName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  AggregationType& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  AggregationType& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
