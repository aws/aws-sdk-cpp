...
class GetStatisticsRequest : public IoTRequest {
 public:
  ...
  template <typename IndexNameT = Aws::String>
  GetStatisticsRequest& WithIndexName(IndexNameT&& value) {
  ...
  template <typename QueryStringT = Aws::String>
  GetStatisticsRequest& WithQueryString(QueryStringT&& value) {
  ...
  template <typename AggregationFieldT = Aws::String>
  GetStatisticsRequest& WithAggregationField(AggregationFieldT&& value) {
  ...
  template <typename QueryVersionT = Aws::String>
  GetStatisticsRequest& WithQueryVersion(QueryVersionT&& value) {
