...
class AttachSecurityProfileRequest : public IoTRequest {
 public:
  ...
  template <typename SecurityProfileNameT = Aws::String>
  AttachSecurityProfileRequest& WithSecurityProfileName(SecurityProfileNameT&& value) {
  ...
  template <typename SecurityProfileTargetArnT = Aws::String>
  AttachSecurityProfileRequest& WithSecurityProfileTargetArn(SecurityProfileTargetArnT&& value) {
