...
class ListCommandExecutionsRequest : public IoTRequest {
 public:
  ...
  inline ListCommandExecutionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNamespace(CommandNamespace value) {
    m_namespaceHasBeenSet = true;
    m_namespace = value;
  }
  inline ListCommandExecutionsRequest& WithNamespace(CommandNamespace value) {
    SetNamespace(value);
    return *this;
  }
  ///@}
  ...
  inline ListCommandExecutionsRequest& WithStatus(CommandExecutionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline ListCommandExecutionsRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  void SetStartedTimeFilter(StartedTimeFilterT&& value) {
    m_startedTimeFilterHasBeenSet = true;
    m_startedTimeFilter = std::forward<StartedTimeFilterT>(value);
  }
  template <typename StartedTimeFilterT = TimeFilter>
  ListCommandExecutionsRequest& WithStartedTimeFilter(StartedTimeFilterT&& value) {
    SetStartedTimeFilter(std::forward<StartedTimeFilterT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCompletedTimeFilter(CompletedTimeFilterT&& value) {
    m_completedTimeFilterHasBeenSet = true;
    m_completedTimeFilter = std::forward<CompletedTimeFilterT>(value);
  }
  template <typename CompletedTimeFilterT = TimeFilter>
  ListCommandExecutionsRequest& WithCompletedTimeFilter(CompletedTimeFilterT&& value) {
    SetCompletedTimeFilter(std::forward<CompletedTimeFilterT>(value));
    return *this;
  }
  ///@}
