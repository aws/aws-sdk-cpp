...
class ListCertificatesByCARequest : public IoTRequest {
 public:
  ...
  template <typename CaCertificateIdT = Aws::String>
  ListCertificatesByCARequest& WithCaCertificateId(CaCertificateIdT&& value) {
  ...
  inline ListCertificatesByCARequest& WithPageSize(int value) {
    SetPageSize(value);
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  ListCertificatesByCARequest& WithMarker(MarkerT&& value) {
  ...
  inline ListCertificatesByCARequest& WithAscendingOrder(bool value) {
