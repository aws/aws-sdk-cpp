...
namespace Model
{
  ...
  {
  public:
    AWS_IOT_API CancelDetectMitigationActionsTaskResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    CancelDetectMitigationActionsTaskResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
