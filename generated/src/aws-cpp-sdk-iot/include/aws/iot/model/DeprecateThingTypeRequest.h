...
class DeprecateThingTypeRequest : public IoTRequest {
 public:
  ...
  template <typename ThingTypeNameT = Aws::String>
  DeprecateThingTypeRequest& WithThingTypeName(ThingTypeNameT&& value) {
  ...
  inline void SetUndoDeprecate(bool value) {
    m_undoDeprecateHasBeenSet = true;
    m_undoDeprecate = value;
  }
  inline DeprecateThingTypeRequest& WithUndoDeprecate(bool value) {
    SetUndoDeprecate(value);
    return *this;
  }
  ///@}
 private:
