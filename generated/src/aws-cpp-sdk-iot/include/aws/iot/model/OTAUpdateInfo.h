...
class OTAUpdateInfo {
 public:
  ...
  void SetOtaUpdateId(OtaUpdateIdT&& value) {
    ...
    m_otaUpdateId = std::forward<OtaUpdateIdT>(value);
  }
  template <typename OtaUpdateIdT = Aws::String>
  OTAUpdateInfo& WithOtaUpdateId(OtaUpdateIdT&& value) {
    SetOtaUpdateId(std::forward<OtaUpdateIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOtaUpdateArn(OtaUpdateArnT&& value) {
    ...
    m_otaUpdateArn = std::forward<OtaUpdateArnT>(value);
  }
  template <typename OtaUpdateArnT = Aws::String>
  OTAUpdateInfo& WithOtaUpdateArn(OtaUpdateArnT&& value) {
    SetOtaUpdateArn(std::forward<OtaUpdateArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline OTAUpdateInfo& AddProtocols(Protocol value) {
    m_protocolsHasBeenSet = true;
  ...
  void SetAwsJobExecutionsRolloutConfig(AwsJobExecutionsRolloutConfigT&& value) {
    ...
    m_awsJobExecutionsRolloutConfig = std::forward<AwsJobExecutionsRolloutConfigT>(value);
  }
  template <typename AwsJobExecutionsRolloutConfigT = AwsJobExecutionsRolloutConfig>
  OTAUpdateInfo& WithAwsJobExecutionsRolloutConfig(AwsJobExecutionsRolloutConfigT&& value) {
    SetAwsJobExecutionsRolloutConfig(std::forward<AwsJobExecutionsRolloutConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAwsJobPresignedUrlConfig(AwsJobPresignedUrlConfigT&& value) {
    ...
    m_awsJobPresignedUrlConfig = std::forward<AwsJobPresignedUrlConfigT>(value);
  }
  template <typename AwsJobPresignedUrlConfigT = AwsJobPresignedUrlConfig>
  OTAUpdateInfo& WithAwsJobPresignedUrlConfig(AwsJobPresignedUrlConfigT&& value) {
    SetAwsJobPresignedUrlConfig(std::forward<AwsJobPresignedUrlConfigT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTargetSelection(TargetSelection value) {
    m_targetSelectionHasBeenSet = true;
    m_targetSelection = value;
  }
  inline OTAUpdateInfo& WithTargetSelection(TargetSelection value) {
  ...
  void SetOtaUpdateFiles(OtaUpdateFilesT&& value) {
    ...
    m_otaUpdateFiles = std::forward<OtaUpdateFilesT>(value);
  }
  template <typename OtaUpdateFilesT = Aws::Vector<OTAUpdateFile>>
  OTAUpdateInfo& WithOtaUpdateFiles(OtaUpdateFilesT&& value) {
    SetOtaUpdateFiles(std::forward<OtaUpdateFilesT>(value));
    return *this;
  }
  template <typename OtaUpdateFilesT = OTAUpdateFile>
  OTAUpdateInfo& AddOtaUpdateFiles(OtaUpdateFilesT&& value) {
    m_otaUpdateFilesHasBeenSet = true;
    m_otaUpdateFiles.emplace_back(std::forward<OtaUpdateFilesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetOtaUpdateStatus(OTAUpdateStatus value) {
    m_otaUpdateStatusHasBeenSet = true;
    m_otaUpdateStatus = value;
  }
  inline OTAUpdateInfo& WithOtaUpdateStatus(OTAUpdateStatus value) {
    SetOtaUpdateStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetAwsIotJobId(AwsIotJobIdT&& value) {
    ...
    m_awsIotJobId = std::forward<AwsIotJobIdT>(value);
  }
  template <typename AwsIotJobIdT = Aws::String>
  OTAUpdateInfo& WithAwsIotJobId(AwsIotJobIdT&& value) {
    SetAwsIotJobId(std::forward<AwsIotJobIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAwsIotJobArn(AwsIotJobArnT&& value) {
    ...
    m_awsIotJobArn = std::forward<AwsIotJobArnT>(value);
  }
  template <typename AwsIotJobArnT = Aws::String>
  OTAUpdateInfo& WithAwsIotJobArn(AwsIotJobArnT&& value) {
    SetAwsIotJobArn(std::forward<AwsIotJobArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAdditionalParameters(AdditionalParametersT&& value) {
    ...
    m_additionalParameters = std::forward<AdditionalParametersT>(value);
  }
  template <typename AdditionalParametersT = Aws::Map<Aws::String, Aws::String>>
  OTAUpdateInfo& WithAdditionalParameters(AdditionalParametersT&& value) {
    SetAdditionalParameters(std::forward<AdditionalParametersT>(value));
    return *this;
  }
  ...
  OTAUpdateInfo& AddAdditionalParameters(AdditionalParametersKeyT&& key, AdditionalParametersValueT&& value) {
    m_additionalParametersHasBeenSet = true;
    m_additionalParameters.emplace(std::forward<AdditionalParametersKeyT>(key), std::forward<AdditionalParametersValueT>(value));
    return *this;
  }
  ///@}
 private:
