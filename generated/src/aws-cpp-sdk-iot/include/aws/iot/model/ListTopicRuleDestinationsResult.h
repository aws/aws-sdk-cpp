...
class ListTopicRuleDestinationsResult {
 public:
  ...
  void SetDestinationSummaries(DestinationSummariesT&& value) {
    m_destinationSummariesHasBeenSet = true;
    m_destinationSummaries = std::forward<DestinationSummariesT>(value);
  }
  template <typename DestinationSummariesT = Aws::Vector<TopicRuleDestinationSummary>>
  ListTopicRuleDestinationsResult& WithDestinationSummaries(DestinationSummariesT&& value) {
    SetDestinationSummaries(std::forward<DestinationSummariesT>(value));
    return *this;
  }
  template <typename DestinationSummariesT = TopicRuleDestinationSummary>
  ListTopicRuleDestinationsResult& AddDestinationSummaries(DestinationSummariesT&& value) {
    m_destinationSummariesHasBeenSet = true;
    m_destinationSummaries.emplace_back(std::forward<DestinationSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTopicRuleDestinationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListTopicRuleDestinationsResult& WithRequestId(RequestIdT&& value) {
