...
class ListThingGroupsForThingRequest : public IoTRequest {
 public:
  ...
  template <typename ThingNameT = Aws::String>
  ListThingGroupsForThingRequest& WithThingName(ThingNameT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListThingGroupsForThingRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListThingGroupsForThingRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
