...
class CACertificateDescription {
 public:
  ...
  inline void SetStatus(CACertificateStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline CACertificateDescription& WithStatus(CACertificateStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetOwnedBy(OwnedByT&& value) {
    ...
    m_ownedBy = std::forward<OwnedByT>(value);
  }
  template <typename OwnedByT = Aws::String>
  CACertificateDescription& WithOwnedBy(OwnedByT&& value) {
    SetOwnedBy(std::forward<OwnedByT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAutoRegistrationStatus(AutoRegistrationStatus value) {
    m_autoRegistrationStatusHasBeenSet = true;
    m_autoRegistrationStatus = value;
  }
  inline CACertificateDescription& WithAutoRegistrationStatus(AutoRegistrationStatus value) {
    SetAutoRegistrationStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCustomerVersion(int value) {
    m_customerVersionHasBeenSet = true;
    m_customerVersion = value;
  }
  inline CACertificateDescription& WithCustomerVersion(int value) {
    SetCustomerVersion(value);
    return *this;
  }
  ///@}
  ...
  inline CACertificateDescription& WithCertificateMode(CertificateMode value) {
