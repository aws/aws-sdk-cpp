...
class ListThingsInBillingGroupResult {
 public:
  AWS_IOT_API ListThingsInBillingGroupResult() = default;
  ...
  void SetThings(ThingsT&& value) {
    ...
    m_things = std::forward<ThingsT>(value);
  }
  template <typename ThingsT = Aws::Vector<Aws::String>>
  ListThingsInBillingGroupResult& WithThings(ThingsT&& value) {
    SetThings(std::forward<ThingsT>(value));
    return *this;
  }
  template <typename ThingsT = Aws::String>
  ListThingsInBillingGroupResult& AddThings(ThingsT&& value) {
    m_thingsHasBeenSet = true;
    m_things.emplace_back(std::forward<ThingsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListThingsInBillingGroupResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListThingsInBillingGroupResult& WithRequestId(RequestIdT&& value) {
