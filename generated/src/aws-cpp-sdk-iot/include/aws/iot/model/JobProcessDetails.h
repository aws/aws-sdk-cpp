...
class JobProcessDetails {
 public:
  ...
  inline JobProcessDetails& WithNumberOfCanceledThings(int value) {
  ...
  inline JobProcessDetails& WithNumberOfSucceededThings(int value) {
  ...
  inline JobProcessDetails& WithNumberOfFailedThings(int value) {
  ...
  inline JobProcessDetails& WithNumberOfRejectedThings(int value) {
  ...
  inline JobProcessDetails& WithNumberOfQueuedThings(int value) {
  ...
  inline JobProcessDetails& WithNumberOfInProgressThings(int value) {
  ...
  inline JobProcessDetails& WithNumberOfRemovedThings(int value) {
  ...
  inline JobProcessDetails& WithNumberOfTimedOutThings(int value) {
