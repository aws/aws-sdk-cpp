...
class ListRoleAliasesRequest : public IoTRequest {
 public:
  ...
  inline ListRoleAliasesRequest& WithPageSize(int value) {
    SetPageSize(value);
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  ListRoleAliasesRequest& WithMarker(MarkerT&& value) {
  ...
  inline ListRoleAliasesRequest& WithAscendingOrder(bool value) {
