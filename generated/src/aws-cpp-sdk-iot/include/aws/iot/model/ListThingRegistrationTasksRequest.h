...
class ListThingRegistrationTasksRequest : public IoTRequest {
 public:
  AWS_IOT_API ListThingRegistrationTasksRequest() = default;
  ...
  template <typename NextTokenT = Aws::String>
  ListThingRegistrationTasksRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListThingRegistrationTasksRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline ListThingRegistrationTasksRequest& WithStatus(Status value) {
    SetStatus(value);
    return *this;
  }
  ///@}
