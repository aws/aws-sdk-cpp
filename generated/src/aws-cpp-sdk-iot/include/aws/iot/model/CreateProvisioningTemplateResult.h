...
class CreateProvisioningTemplateResult {
 public:
  ...
  template <typename TemplateArnT = Aws::String>
  CreateProvisioningTemplateResult& WithTemplateArn(TemplateArnT&& value) {
  ...
  template <typename TemplateNameT = Aws::String>
  CreateProvisioningTemplateResult& WithTemplateName(TemplateNameT&& value) {
  ...
  inline CreateProvisioningTemplateResult& WithDefaultVersionId(int value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateProvisioningTemplateResult& WithRequestId(RequestIdT&& value) {
