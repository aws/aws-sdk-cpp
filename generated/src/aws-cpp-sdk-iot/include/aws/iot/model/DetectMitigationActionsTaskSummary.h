...
class DetectMitigationActionsTaskSummary {
 public:
  ...
  inline void SetTaskStatus(DetectMitigationActionsTaskStatus value) {
    m_taskStatusHasBeenSet = true;
    m_taskStatus = value;
  }
  inline DetectMitigationActionsTaskSummary& WithTaskStatus(DetectMitigationActionsTaskStatus value) {
    SetTaskStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetViolationEventOccurrenceRange(ViolationEventOccurrenceRangeT&& value) {
    ...
    m_violationEventOccurrenceRange = std::forward<ViolationEventOccurrenceRangeT>(value);
  }
  template <typename ViolationEventOccurrenceRangeT = ViolationEventOccurrenceRange>
  DetectMitigationActionsTaskSummary& WithViolationEventOccurrenceRange(ViolationEventOccurrenceRangeT&& value) {
    SetViolationEventOccurrenceRange(std::forward<ViolationEventOccurrenceRangeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetOnlyActiveViolationsIncluded(bool value) {
    m_onlyActiveViolationsIncludedHasBeenSet = true;
    m_onlyActiveViolationsIncluded = value;
  }
  inline DetectMitigationActionsTaskSummary& WithOnlyActiveViolationsIncluded(bool value) {
    SetOnlyActiveViolationsIncluded(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSuppressedAlertsIncluded(bool value) {
    m_suppressedAlertsIncludedHasBeenSet = true;
    m_suppressedAlertsIncluded = value;
  }
  inline DetectMitigationActionsTaskSummary& WithSuppressedAlertsIncluded(bool value) {
    SetSuppressedAlertsIncluded(value);
    return *this;
  }
  ///@}
