...
class ListCertificateProvidersRequest : public IoTRequest {
 public:
  AWS_IOT_API ListCertificateProvidersRequest() = default;
  ...
  template <typename NextTokenT = Aws::String>
  ListCertificateProvidersRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListCertificateProvidersRequest& WithAscendingOrder(bool value) {
