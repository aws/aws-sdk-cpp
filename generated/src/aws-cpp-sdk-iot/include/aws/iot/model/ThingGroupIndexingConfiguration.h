...
class ThingGroupIndexingConfiguration {
 public:
  ...
  inline void SetThingGroupIndexingMode(ThingGroupIndexingMode value) {
    m_thingGroupIndexingModeHasBeenSet = true;
    m_thingGroupIndexingMode = value;
  }
  inline ThingGroupIndexingConfiguration& WithThingGroupIndexingMode(ThingGroupIndexingMode value) {
    SetThingGroupIndexingMode(value);
    return *this;
  }
  ///@}
