...
class MqttHeaders {
 public:
  ...
  void SetPayloadFormatIndicator(PayloadFormatIndicatorT&& value) {
    ...
    m_payloadFormatIndicator = std::forward<PayloadFormatIndicatorT>(value);
  }
  template <typename PayloadFormatIndicatorT = Aws::String>
  MqttHeaders& WithPayloadFormatIndicator(PayloadFormatIndicatorT&& value) {
    SetPayloadFormatIndicator(std::forward<PayloadFormatIndicatorT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMessageExpiry(MessageExpiryT&& value) {
    ...
    m_messageExpiry = std::forward<MessageExpiryT>(value);
  }
  template <typename MessageExpiryT = Aws::String>
  MqttHeaders& WithMessageExpiry(MessageExpiryT&& value) {
    SetMessageExpiry(std::forward<MessageExpiryT>(value));
    return *this;
  }
  ///@}
  ...
  MqttHeaders& AddUserProperties(UserPropertiesT&& value) {
    m_userPropertiesHasBeenSet = true;
    m_userProperties.emplace_back(std::forward<UserPropertiesT>(value));
    return *this;
  }
  ///@}
 private:
