...
class ThingTypeDefinition {
 public:
  ...
  template <typename ThingTypeNameT = Aws::String>
  ThingTypeDefinition& WithThingTypeName(ThingTypeNameT&& value) {
  ...
  template <typename ThingTypeArnT = Aws::String>
  ThingTypeDefinition& WithThingTypeArn(ThingTypeArnT&& value) {
  ...
  template <typename ThingTypePropertiesT = ThingTypeProperties>
  ThingTypeDefinition& WithThingTypeProperties(ThingTypePropertiesT&& value) {
  ...
  template <typename ThingTypeMetadataT = ThingTypeMetadata>
  ThingTypeDefinition& WithThingTypeMetadata(ThingTypeMetadataT&& value) {
