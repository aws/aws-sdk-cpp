...
namespace Model
{
  ...
  public:
    ...
    inline GetBehaviorModelTrainingSummariesResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}
    inline GetBehaviorModelTrainingSummariesResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}
    inline GetBehaviorModelTrainingSummariesResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
    ///@}
  private:
