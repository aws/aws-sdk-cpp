...
class GetBehaviorModelTrainingSummariesResult {
 public:
  ...
  template <typename SummariesT = Aws::Vector<BehaviorModelTrainingSummary>>
  GetBehaviorModelTrainingSummariesResult& WithSummaries(SummariesT&& value) {
    SetSummaries(std::forward<SummariesT>(value));
    return *this;
  }
  template <typename SummariesT = BehaviorModelTrainingSummary>
  GetBehaviorModelTrainingSummariesResult& AddSummaries(SummariesT&& value) {
    m_summariesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetBehaviorModelTrainingSummariesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetBehaviorModelTrainingSummariesResult& WithRequestId(RequestIdT&& value) {
