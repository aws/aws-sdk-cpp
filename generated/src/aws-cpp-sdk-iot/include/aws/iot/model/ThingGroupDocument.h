...
class ThingGroupDocument {
 public:
  ...
  void SetParentGroupNames(ParentGroupNamesT&& value) {
    ...
    m_parentGroupNames = std::forward<ParentGroupNamesT>(value);
  }
  template <typename ParentGroupNamesT = Aws::Vector<Aws::String>>
  ThingGroupDocument& WithParentGroupNames(ParentGroupNamesT&& value) {
    SetParentGroupNames(std::forward<ParentGroupNamesT>(value));
    return *this;
  }
  template <typename ParentGroupNamesT = Aws::String>
  ThingGroupDocument& AddParentGroupNames(ParentGroupNamesT&& value) {
    m_parentGroupNamesHasBeenSet = true;
    m_parentGroupNames.emplace_back(std::forward<ParentGroupNamesT>(value));
    return *this;
  }
  ///@}
 private:
