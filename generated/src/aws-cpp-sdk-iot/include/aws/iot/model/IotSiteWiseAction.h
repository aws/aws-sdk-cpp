...
class IotSiteWiseAction {
 public:
  ...
  void SetPutAssetPropertyValueEntries(PutAssetPropertyValueEntriesT&& value) {
    m_putAssetPropertyValueEntriesHasBeenSet = true;
    m_putAssetPropertyValueEntries = std::forward<PutAssetPropertyValueEntriesT>(value);
  }
  template <typename PutAssetPropertyValueEntriesT = Aws::Vector<PutAssetPropertyValueEntry>>
  IotSiteWiseAction& WithPutAssetPropertyValueEntries(PutAssetPropertyValueEntriesT&& value) {
    SetPutAssetPropertyValueEntries(std::forward<PutAssetPropertyValueEntriesT>(value));
    return *this;
  }
  template <typename PutAssetPropertyValueEntriesT = PutAssetPropertyValueEntry>
  IotSiteWiseAction& AddPutAssetPropertyValueEntries(PutAssetPropertyValueEntriesT&& value) {
    m_putAssetPropertyValueEntriesHasBeenSet = true;
    m_putAssetPropertyValueEntries.emplace_back(std::forward<PutAssetPropertyValueEntriesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RoleArnT = Aws::String>
  IotSiteWiseAction& WithRoleArn(RoleArnT&& value) {
