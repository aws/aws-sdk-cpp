...
class BillingGroupProperties {
 public:
  ...
  void SetBillingGroupDescription(BillingGroupDescriptionT&& value) {
    m_billingGroupDescriptionHasBeenSet = true;
    m_billingGroupDescription = std::forward<BillingGroupDescriptionT>(value);
  }
  template <typename BillingGroupDescriptionT = Aws::String>
  BillingGroupProperties& WithBillingGroupDescription(BillingGroupDescriptionT&& value) {
    SetBillingGroupDescription(std::forward<BillingGroupDescriptionT>(value));
    return *this;
  }
  ///@}
 private:
