...
class ListDetectMitigationActionsTasksResult {
 public:
  ...
  template <typename TasksT = Aws::Vector<DetectMitigationActionsTaskSummary>>
  ListDetectMitigationActionsTasksResult& WithTasks(TasksT&& value) {
    SetTasks(std::forward<TasksT>(value));
    return *this;
  }
  template <typename TasksT = DetectMitigationActionsTaskSummary>
  ListDetectMitigationActionsTasksResult& AddTasks(TasksT&& value) {
    m_tasksHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListDetectMitigationActionsTasksResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDetectMitigationActionsTasksResult& WithRequestId(RequestIdT&& value) {
