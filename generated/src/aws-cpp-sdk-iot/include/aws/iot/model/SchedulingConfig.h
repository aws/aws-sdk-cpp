...
class SchedulingConfig {
 public:
  ...
  template <typename StartTimeT = Aws::String>
  SchedulingConfig& WithStartTime(StartTimeT&& value) {
  ...
  template <typename EndTimeT = Aws::String>
  SchedulingConfig& WithEndTime(EndTimeT&& value) {
  ...
  inline void SetEndBehavior(JobEndBehavior value) {
    m_endBehaviorHasBeenSet = true;
    m_endBehavior = value;
  }
  inline SchedulingConfig& WithEndBehavior(JobEndBehavior value) {
  ...
  void SetMaintenanceWindows(MaintenanceWindowsT&& value) {
    ...
    m_maintenanceWindows = std::forward<MaintenanceWindowsT>(value);
  }
  template <typename MaintenanceWindowsT = Aws::Vector<MaintenanceWindow>>
  SchedulingConfig& WithMaintenanceWindows(MaintenanceWindowsT&& value) {
    SetMaintenanceWindows(std::forward<MaintenanceWindowsT>(value));
    return *this;
  }
  template <typename MaintenanceWindowsT = MaintenanceWindow>
  SchedulingConfig& AddMaintenanceWindows(MaintenanceWindowsT&& value) {
    m_maintenanceWindowsHasBeenSet = true;
    m_maintenanceWindows.emplace_back(std::forward<MaintenanceWindowsT>(value));
    return *this;
  }
  ///@}
 private:
