...
class ListThingsInThingGroupRequest : public IoTRequest {
 public:
  ...
  template <typename ThingGroupNameT = Aws::String>
  ListThingsInThingGroupRequest& WithThingGroupName(ThingGroupNameT&& value) {
  ...
  inline ListThingsInThingGroupRequest& WithRecursive(bool value) {
    SetRecursive(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListThingsInThingGroupRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListThingsInThingGroupRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
