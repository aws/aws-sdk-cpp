...
class ListAuditMitigationActionsExecutionsRequest : public IoTRequest {
 public:
  ...
  template <typename TaskIdT = Aws::String>
  ListAuditMitigationActionsExecutionsRequest& WithTaskId(TaskIdT&& value) {
  ...
  inline void SetActionStatus(AuditMitigationActionsExecutionStatus value) {
    m_actionStatusHasBeenSet = true;
    m_actionStatus = value;
  }
  inline ListAuditMitigationActionsExecutionsRequest& WithActionStatus(AuditMitigationActionsExecutionStatus value) {
  ...
  template <typename FindingIdT = Aws::String>
  ListAuditMitigationActionsExecutionsRequest& WithFindingId(FindingIdT&& value) {
  ...
  inline ListAuditMitigationActionsExecutionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAuditMitigationActionsExecutionsRequest& WithNextToken(NextTokenT&& value) {
