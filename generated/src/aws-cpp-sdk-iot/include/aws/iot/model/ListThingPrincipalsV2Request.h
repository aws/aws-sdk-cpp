...
class ListThingPrincipalsV2Request : public IoTRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListThingPrincipalsV2Request& WithNextToken(NextTokenT&& value) {
  ...
  inline ListThingPrincipalsV2Request& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename ThingNameT = Aws::String>
  ListThingPrincipalsV2Request& WithThingName(ThingNameT&& value) {
  ...
  inline ListThingPrincipalsV2Request& WithThingPrincipalType(ThingPrincipalType value) {
