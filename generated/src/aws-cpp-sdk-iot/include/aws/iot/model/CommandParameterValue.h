...
class CommandParameterValue {
 public:
  ...
  inline CommandParameterValue& WithB(bool value) {
    SetB(value);
    return *this;
  }
  ///@}
  ...
  inline CommandParameterValue& WithI(int value) {
    SetI(value);
    return *this;
  }
  ///@}
  ...
  inline void SetL(long long value) {
    m_lHasBeenSet = true;
    m_l = value;
  }
  inline CommandParameterValue& WithL(long long value) {
    SetL(value);
    return *this;
  }
  ///@}
  ...
  inline void SetD(double value) {
    m_dHasBeenSet = true;
    m_d = value;
  }
  inline CommandParameterValue& WithD(double value) {
    SetD(value);
    return *this;
  }
  ///@}
  ...
  void SetUL(ULT&& value) {
    m_uLHasBeenSet = true;
    m_uL = std::forward<ULT>(value);
  }
  template <typename ULT = Aws::String>
  CommandParameterValue& WithUL(ULT&& value) {
    SetUL(std::forward<ULT>(value));
    return *this;
  }
  ///@}
 private:
