...
class GetCommandExecutionRequest : public IoTRequest {
 public:
  ...
  inline void SetIncludeResult(bool value) {
    m_includeResultHasBeenSet = true;
    m_includeResult = value;
  }
  inline GetCommandExecutionRequest& WithIncludeResult(bool value) {
    SetIncludeResult(value);
    return *this;
  }
  ///@}
 private:
