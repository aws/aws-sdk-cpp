...
namespace Model
{
  ...
  {
  public:
    AWS_IOT_API CancelJobResult() = default;
    ...
    template<typename JobIdT = Aws::String>
    CancelJobResult& WithJobId(JobIdT&& value) { SetJobId(std::forward<JobIdT>(value)); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    CancelJobResult& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
