...
class MetricValue {
 public:
  ...
  inline MetricValue& WithCount(long long value) {
    SetCount(value);
    return *this;
  }
  ///@}
  ...
  inline MetricValue& AddPorts(int value) {
    m_portsHasBeenSet = true;
  ...
  inline MetricValue& WithNumber(double value) {
    SetNumber(value);
    return *this;
  }
  ///@}
  ...
  inline MetricValue& AddNumbers(double value) {
    m_numbersHasBeenSet = true;
