...
class ListThingRegistrationTaskReportsRequest : public IoTRequest {
 public:
  ...
  template <typename TaskIdT = Aws::String>
  ListThingRegistrationTaskReportsRequest& WithTaskId(TaskIdT&& value) {
  ...
  inline ListThingRegistrationTaskReportsRequest& WithReportType(ReportType value) {
    SetReportType(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListThingRegistrationTaskReportsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListThingRegistrationTaskReportsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
