...
class GetCommandExecutionResult {
 public:
  ...
  inline GetCommandExecutionResult& WithStatus(CommandExecutionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  GetCommandExecutionResult& AddResult(ResultKeyT&& key, ResultValueT&& value) {
    m_resultHasBeenSet = true;
    m_result.emplace(std::forward<ResultKeyT>(key), std::forward<ResultValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetExecutionTimeoutSeconds(long long value) {
    m_executionTimeoutSecondsHasBeenSet = true;
    m_executionTimeoutSeconds = value;
  }
  inline GetCommandExecutionResult& WithExecutionTimeoutSeconds(long long value) {
