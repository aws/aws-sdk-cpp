...
class RegisterCACertificateRequest : public IoTRequest {
 public:
  ...
  void SetVerificationCertificate(VerificationCertificateT&& value) {
    ...
    m_verificationCertificate = std::forward<VerificationCertificateT>(value);
  }
  template <typename VerificationCertificateT = Aws::String>
  RegisterCACertificateRequest& WithVerificationCertificate(VerificationCertificateT&& value) {
    SetVerificationCertificate(std::forward<VerificationCertificateT>(value));
    return *this;
  }
  ///@}
  ...
  inline RegisterCACertificateRequest& WithSetAsActive(bool value) {
  ...
  inline void SetAllowAutoRegistration(bool value) {
    m_allowAutoRegistrationHasBeenSet = true;
    m_allowAutoRegistration = value;
  }
  inline RegisterCACertificateRequest& WithAllowAutoRegistration(bool value) {
    SetAllowAutoRegistration(value);
    return *this;
  }
  ///@}
  ...
  inline RegisterCACertificateRequest& WithCertificateMode(CertificateMode value) {
