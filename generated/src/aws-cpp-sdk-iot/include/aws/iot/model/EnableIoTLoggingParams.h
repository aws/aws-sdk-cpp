...
class EnableIoTLoggingParams {
 public:
  ...
  void SetRoleArnForLogging(RoleArnForLoggingT&& value) {
    ...
    m_roleArnForLogging = std::forward<RoleArnForLoggingT>(value);
  }
  template <typename RoleArnForLoggingT = Aws::String>
  EnableIoTLoggingParams& WithRoleArnForLogging(RoleArnForLoggingT&& value) {
    SetRoleArnForLogging(std::forward<RoleArnForLoggingT>(value));
    return *this;
  }
  ///@}
  ...
  inline EnableIoTLoggingParams& WithLogLevel(LogLevel value) {
    SetLogLevel(value);
    return *this;
  }
  ///@}
