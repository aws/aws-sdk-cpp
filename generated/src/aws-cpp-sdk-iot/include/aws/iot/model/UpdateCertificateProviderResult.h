...
class UpdateCertificateProviderResult {
 public:
  ...
  template <typename CertificateProviderNameT = Aws::String>
  UpdateCertificateProviderResult& WithCertificateProviderName(CertificateProviderNameT&& value) {
  ...
  template <typename CertificateProviderArnT = Aws::String>
  UpdateCertificateProviderResult& WithCertificateProviderArn(CertificateProviderArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateCertificateProviderResult& WithRequestId(RequestIdT&& value) {
