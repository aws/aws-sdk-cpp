...
class GetPackageVersionResult {
 public:
  ...
  void SetPackageVersionArn(PackageVersionArnT&& value) {
    ...
    m_packageVersionArn = std::forward<PackageVersionArnT>(value);
  }
  template <typename PackageVersionArnT = Aws::String>
  GetPackageVersionResult& WithPackageVersionArn(PackageVersionArnT&& value) {
    SetPackageVersionArn(std::forward<PackageVersionArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(PackageVersionStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline GetPackageVersionResult& WithStatus(PackageVersionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSbomValidationStatus(SbomValidationStatus value) {
    m_sbomValidationStatusHasBeenSet = true;
    m_sbomValidationStatus = value;
  }
  inline GetPackageVersionResult& WithSbomValidationStatus(SbomValidationStatus value) {
    SetSbomValidationStatus(value);
    return *this;
  }
  ///@}
