...
class DescribeAuditTaskResult {
 public:
  ...
  inline DescribeAuditTaskResult& WithTaskStatus(AuditTaskStatus value) {
    SetTaskStatus(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeAuditTaskResult& WithTaskType(AuditTaskType value) {
    SetTaskType(value);
    return *this;
  }
  ///@}
  ...
  template <typename TaskStartTimeT = Aws::Utils::DateTime>
  DescribeAuditTaskResult& WithTaskStartTime(TaskStartTimeT&& value) {
  ...
  template <typename TaskStatisticsT = TaskStatistics>
  DescribeAuditTaskResult& WithTaskStatistics(TaskStatisticsT&& value) {
  ...
  template <typename ScheduledAuditNameT = Aws::String>
  DescribeAuditTaskResult& WithScheduledAuditName(ScheduledAuditNameT&& value) {
  ...
  void SetAuditDetails(AuditDetailsT&& value) {
    m_auditDetailsHasBeenSet = true;
    m_auditDetails = std::forward<AuditDetailsT>(value);
  }
  template <typename AuditDetailsT = Aws::Map<Aws::String, AuditCheckDetails>>
  DescribeAuditTaskResult& WithAuditDetails(AuditDetailsT&& value) {
    SetAuditDetails(std::forward<AuditDetailsT>(value));
    return *this;
  }
  ...
  DescribeAuditTaskResult& AddAuditDetails(AuditDetailsKeyT&& key, AuditDetailsValueT&& value) {
    m_auditDetailsHasBeenSet = true;
    m_auditDetails.emplace(std::forward<AuditDetailsKeyT>(key), std::forward<AuditDetailsValueT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeAuditTaskResult& WithRequestId(RequestIdT&& value) {
