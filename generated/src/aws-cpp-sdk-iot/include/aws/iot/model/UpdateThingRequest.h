...
class UpdateThingRequest : public IoTRequest {
 public:
  ...
  void SetAttributePayload(AttributePayloadT&& value) {
    ...
    m_attributePayload = std::forward<AttributePayloadT>(value);
  }
  template <typename AttributePayloadT = AttributePayload>
  UpdateThingRequest& WithAttributePayload(AttributePayloadT&& value) {
    SetAttributePayload(std::forward<AttributePayloadT>(value));
    return *this;
  }
  ///@}
  ...
  inline UpdateThingRequest& WithExpectedVersion(long long value) {
  ...
  inline void SetRemoveThingType(bool value) {
    m_removeThingTypeHasBeenSet = true;
    m_removeThingType = value;
  }
  inline UpdateThingRequest& WithRemoveThingType(bool value) {
    SetRemoveThingType(value);
    return *this;
  }
  ///@}
 private:
