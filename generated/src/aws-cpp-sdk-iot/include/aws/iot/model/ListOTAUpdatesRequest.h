...
class ListOTAUpdatesRequest : public IoTRequest {
 public:
  AWS_IOT_API ListOTAUpdatesRequest() = default;
  ...
  inline ListOTAUpdatesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListOTAUpdatesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListOTAUpdatesRequest& WithOtaUpdateStatus(OTAUpdateStatus value) {
