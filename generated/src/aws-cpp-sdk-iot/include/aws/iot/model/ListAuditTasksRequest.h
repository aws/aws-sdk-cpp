...
class ListAuditTasksRequest : public IoTRequest {
 public:
  ...
  template <typename StartTimeT = Aws::Utils::DateTime>
  ListAuditTasksRequest& WithStartTime(StartTimeT&& value) {
  ...
  template <typename EndTimeT = Aws::Utils::DateTime>
  ListAuditTasksRequest& WithEndTime(EndTimeT&& value) {
  ...
  inline void SetTaskType(AuditTaskType value) {
    m_taskTypeHasBeenSet = true;
    m_taskType = value;
  }
  inline ListAuditTasksRequest& WithTaskType(AuditTaskType value) {
    SetTaskType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTaskStatus(AuditTaskStatus value) {
    m_taskStatusHasBeenSet = true;
    m_taskStatus = value;
  }
  inline ListAuditTasksRequest& WithTaskStatus(AuditTaskStatus value) {
    SetTaskStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAuditTasksRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListAuditTasksRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
