...
class Action {
 public:
  ...
  void SetRepublish(RepublishT&& value) {
    ...
    m_republish = std::forward<RepublishT>(value);
  }
  template <typename RepublishT = RepublishAction>
  Action& WithRepublish(RepublishT&& value) {
    SetRepublish(std::forward<RepublishT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCloudwatchMetric(CloudwatchMetricT&& value) {
    ...
    m_cloudwatchMetric = std::forward<CloudwatchMetricT>(value);
  }
  template <typename CloudwatchMetricT = CloudwatchMetricAction>
  Action& WithCloudwatchMetric(CloudwatchMetricT&& value) {
    SetCloudwatchMetric(std::forward<CloudwatchMetricT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCloudwatchAlarm(CloudwatchAlarmT&& value) {
    ...
    m_cloudwatchAlarm = std::forward<CloudwatchAlarmT>(value);
  }
  template <typename CloudwatchAlarmT = CloudwatchAlarmAction>
  Action& WithCloudwatchAlarm(CloudwatchAlarmT&& value) {
    SetCloudwatchAlarm(std::forward<CloudwatchAlarmT>(value));
    return *this;
  }
  ///@}
  ...
  void SetElasticsearch(ElasticsearchT&& value) {
    ...
    m_elasticsearch = std::forward<ElasticsearchT>(value);
  }
  template <typename ElasticsearchT = ElasticsearchAction>
  Action& WithElasticsearch(ElasticsearchT&& value) {
    SetElasticsearch(std::forward<ElasticsearchT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIotAnalytics(IotAnalyticsT&& value) {
    ...
    m_iotAnalytics = std::forward<IotAnalyticsT>(value);
  }
  template <typename IotAnalyticsT = IotAnalyticsAction>
  Action& WithIotAnalytics(IotAnalyticsT&& value) {
    SetIotAnalytics(std::forward<IotAnalyticsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTimestream(TimestreamT&& value) {
    ...
    m_timestream = std::forward<TimestreamT>(value);
  }
  template <typename TimestreamT = TimestreamAction>
  Action& WithTimestream(TimestreamT&& value) {
    SetTimestream(std::forward<TimestreamT>(value));
    return *this;
  }
  ///@}
  ...
  void SetKafka(KafkaT&& value) {
    ...
    m_kafka = std::forward<KafkaT>(value);
  }
  template <typename KafkaT = KafkaAction>
  Action& WithKafka(KafkaT&& value) {
    SetKafka(std::forward<KafkaT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOpenSearch(OpenSearchT&& value) {
    ...
    m_openSearch = std::forward<OpenSearchT>(value);
  }
  template <typename OpenSearchT = OpenSearchAction>
  Action& WithOpenSearch(OpenSearchT&& value) {
    SetOpenSearch(std::forward<OpenSearchT>(value));
    return *this;
  }
  ///@}
