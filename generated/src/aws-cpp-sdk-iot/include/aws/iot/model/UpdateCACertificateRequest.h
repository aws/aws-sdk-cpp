...
class UpdateCACertificateRequest : public IoTRequest {
 public:
  ...
  inline void SetNewStatus(CACertificateStatus value) {
    m_newStatusHasBeenSet = true;
    m_newStatus = value;
  }
  inline UpdateCACertificateRequest& WithNewStatus(CACertificateStatus value) {
    SetNewStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNewAutoRegistrationStatus(AutoRegistrationStatus value) {
    m_newAutoRegistrationStatusHasBeenSet = true;
    m_newAutoRegistrationStatus = value;
  }
  inline UpdateCACertificateRequest& WithNewAutoRegistrationStatus(AutoRegistrationStatus value) {
    SetNewAutoRegistrationStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetRegistrationConfig(RegistrationConfigT&& value) {
    ...
    m_registrationConfig = std::forward<RegistrationConfigT>(value);
  }
  template <typename RegistrationConfigT = RegistrationConfig>
  UpdateCACertificateRequest& WithRegistrationConfig(RegistrationConfigT&& value) {
    SetRegistrationConfig(std::forward<RegistrationConfigT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetRemoveAutoRegistration(bool value) {
    m_removeAutoRegistrationHasBeenSet = true;
    m_removeAutoRegistration = value;
  }
  inline UpdateCACertificateRequest& WithRemoveAutoRegistration(bool value) {
    SetRemoveAutoRegistration(value);
    return *this;
  }
  ///@}
 private:
