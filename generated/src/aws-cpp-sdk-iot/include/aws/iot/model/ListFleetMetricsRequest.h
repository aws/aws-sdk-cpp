...
class ListFleetMetricsRequest : public IoTRequest {
 public:
  AWS_IOT_API ListFleetMetricsRequest() = default;
  ...
  template <typename NextTokenT = Aws::String>
  ListFleetMetricsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListFleetMetricsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
