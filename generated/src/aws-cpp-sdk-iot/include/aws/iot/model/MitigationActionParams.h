...
class MitigationActionParams {
 public:
  ...
  void SetUpdateDeviceCertificateParams(UpdateDeviceCertificateParamsT&& value) {
    ...
    m_updateDeviceCertificateParams = std::forward<UpdateDeviceCertificateParamsT>(value);
  }
  template <typename UpdateDeviceCertificateParamsT = UpdateDeviceCertificateParams>
  MitigationActionParams& WithUpdateDeviceCertificateParams(UpdateDeviceCertificateParamsT&& value) {
    SetUpdateDeviceCertificateParams(std::forward<UpdateDeviceCertificateParamsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUpdateCACertificateParams(UpdateCACertificateParamsT&& value) {
    ...
    m_updateCACertificateParams = std::forward<UpdateCACertificateParamsT>(value);
  }
  template <typename UpdateCACertificateParamsT = UpdateCACertificateParams>
  MitigationActionParams& WithUpdateCACertificateParams(UpdateCACertificateParamsT&& value) {
    SetUpdateCACertificateParams(std::forward<UpdateCACertificateParamsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAddThingsToThingGroupParams(AddThingsToThingGroupParamsT&& value) {
    ...
    m_addThingsToThingGroupParams = std::forward<AddThingsToThingGroupParamsT>(value);
  }
  template <typename AddThingsToThingGroupParamsT = AddThingsToThingGroupParams>
  MitigationActionParams& WithAddThingsToThingGroupParams(AddThingsToThingGroupParamsT&& value) {
    SetAddThingsToThingGroupParams(std::forward<AddThingsToThingGroupParamsT>(value));
    return *this;
  }
  ///@}
   ...
   * permissions.</p>
   */
  inline const ReplaceDefaultPolicyVersionParams& GetReplaceDefaultPolicyVersionParams() const {
    return m_replaceDefaultPolicyVersionParams;
  }
  ...
  void SetReplaceDefaultPolicyVersionParams(ReplaceDefaultPolicyVersionParamsT&& value) {
    ...
    m_replaceDefaultPolicyVersionParams = std::forward<ReplaceDefaultPolicyVersionParamsT>(value);
  }
  template <typename ReplaceDefaultPolicyVersionParamsT = ReplaceDefaultPolicyVersionParams>
  MitigationActionParams& WithReplaceDefaultPolicyVersionParams(ReplaceDefaultPolicyVersionParamsT&& value) {
    SetReplaceDefaultPolicyVersionParams(std::forward<ReplaceDefaultPolicyVersionParamsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEnableIoTLoggingParams(EnableIoTLoggingParamsT&& value) {
    ...
    m_enableIoTLoggingParams = std::forward<EnableIoTLoggingParamsT>(value);
  }
  template <typename EnableIoTLoggingParamsT = EnableIoTLoggingParams>
  MitigationActionParams& WithEnableIoTLoggingParams(EnableIoTLoggingParamsT&& value) {
    SetEnableIoTLoggingParams(std::forward<EnableIoTLoggingParamsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPublishFindingToSnsParams(PublishFindingToSnsParamsT&& value) {
    ...
    m_publishFindingToSnsParams = std::forward<PublishFindingToSnsParamsT>(value);
  }
  template <typename PublishFindingToSnsParamsT = PublishFindingToSnsParams>
  MitigationActionParams& WithPublishFindingToSnsParams(PublishFindingToSnsParamsT&& value) {
    SetPublishFindingToSnsParams(std::forward<PublishFindingToSnsParamsT>(value));
    return *this;
  }
  ///@}
 private:
