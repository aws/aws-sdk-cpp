...
class JobExecutionSummary {
 public:
  ...
  inline JobExecutionSummary& WithStatus(JobExecutionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetQueuedAt(QueuedAtT&& value) {
    ...
    m_queuedAt = std::forward<QueuedAtT>(value);
  }
  template <typename QueuedAtT = Aws::Utils::DateTime>
  JobExecutionSummary& WithQueuedAt(QueuedAtT&& value) {
    SetQueuedAt(std::forward<QueuedAtT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetRetryAttempt(int value) {
    m_retryAttemptHasBeenSet = true;
    m_retryAttempt = value;
  }
  inline JobExecutionSummary& WithRetryAttempt(int value) {
