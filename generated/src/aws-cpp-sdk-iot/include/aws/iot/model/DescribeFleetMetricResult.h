...
class DescribeFleetMetricResult {
 public:
  ...
  void SetAggregationType(AggregationTypeT&& value) {
    ...
    m_aggregationType = std::forward<AggregationTypeT>(value);
  }
  template <typename AggregationTypeT = AggregationType>
  DescribeFleetMetricResult& WithAggregationType(AggregationTypeT&& value) {
    SetAggregationType(std::forward<AggregationTypeT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeFleetMetricResult& WithPeriod(int value) {
    SetPeriod(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUnit(FleetMetricUnit value) {
    m_unitHasBeenSet = true;
    m_unit = value;
  }
  inline DescribeFleetMetricResult& WithUnit(FleetMetricUnit value) {
    SetUnit(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeFleetMetricResult& WithVersion(long long value) {
    SetVersion(value);
    return *this;
  }
  ///@}
