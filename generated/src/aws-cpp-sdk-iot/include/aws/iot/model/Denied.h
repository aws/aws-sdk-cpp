...
class Denied {
 public:
  ...
  void SetImplicitDeny(ImplicitDenyT&& value) {
    ...
    m_implicitDeny = std::forward<ImplicitDenyT>(value);
  }
  template <typename ImplicitDenyT = ImplicitDeny>
  Denied& WithImplicitDeny(ImplicitDenyT&& value) {
    SetImplicitDeny(std::forward<ImplicitDenyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExplicitDeny(ExplicitDenyT&& value) {
    ...
    m_explicitDeny = std::forward<ExplicitDenyT>(value);
  }
  template <typename ExplicitDenyT = ExplicitDeny>
  Denied& WithExplicitDeny(ExplicitDenyT&& value) {
    SetExplicitDeny(std::forward<ExplicitDenyT>(value));
    return *this;
  }
  ///@}
 private:
