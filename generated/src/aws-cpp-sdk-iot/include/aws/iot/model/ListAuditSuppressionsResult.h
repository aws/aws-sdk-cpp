...
class ListAuditSuppressionsResult {
 public:
  ...
  void SetSuppressions(SuppressionsT&& value) {
    m_suppressionsHasBeenSet = true;
    m_suppressions = std::forward<SuppressionsT>(value);
  }
  template <typename SuppressionsT = Aws::Vector<AuditSuppression>>
  ListAuditSuppressionsResult& WithSuppressions(SuppressionsT&& value) {
    SetSuppressions(std::forward<SuppressionsT>(value));
    return *this;
  }
  template <typename SuppressionsT = AuditSuppression>
  ListAuditSuppressionsResult& AddSuppressions(SuppressionsT&& value) {
    m_suppressionsHasBeenSet = true;
    m_suppressions.emplace_back(std::forward<SuppressionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAuditSuppressionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAuditSuppressionsResult& WithRequestId(RequestIdT&& value) {
