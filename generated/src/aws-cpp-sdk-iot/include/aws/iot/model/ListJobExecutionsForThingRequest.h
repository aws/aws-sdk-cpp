...
class ListJobExecutionsForThingRequest : public IoTRequest {
 public:
  ...
  template <typename ThingNameT = Aws::String>
  ListJobExecutionsForThingRequest& WithThingName(ThingNameT&& value) {
  ...
  inline ListJobExecutionsForThingRequest& WithStatus(JobExecutionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename NamespaceIdT = Aws::String>
  ListJobExecutionsForThingRequest& WithNamespaceId(NamespaceIdT&& value) {
  ...
  inline ListJobExecutionsForThingRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListJobExecutionsForThingRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename JobIdT = Aws::String>
  ListJobExecutionsForThingRequest& WithJobId(JobIdT&& value) {
