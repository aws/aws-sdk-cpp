...
class RelatedResource {
 public:
  ...
  inline RelatedResource& WithResourceType(ResourceType value) {
  ...
  template <typename ResourceIdentifierT = ResourceIdentifier>
  RelatedResource& WithResourceIdentifier(ResourceIdentifierT&& value) {
  ...
  template <typename AdditionalInfoT = Aws::Map<Aws::String, Aws::String>>
  RelatedResource& WithAdditionalInfo(AdditionalInfoT&& value) {
