...
class IotAnalyticsAction {
 public:
  ...
  template <typename ChannelArnT = Aws::String>
  IotAnalyticsAction& WithChannelArn(ChannelArnT&& value) {
  ...
  template <typename ChannelNameT = Aws::String>
  IotAnalyticsAction& WithChannelName(ChannelNameT&& value) {
  ...
  inline void SetBatchMode(bool value) {
    m_batchModeHasBeenSet = true;
    m_batchMode = value;
  }
  inline IotAnalyticsAction& WithBatchMode(bool value) {
    SetBatchMode(value);
    return *this;
  }
  ///@}
  ...
  template <typename RoleArnT = Aws::String>
  IotAnalyticsAction& WithRoleArn(RoleArnT&& value) {
