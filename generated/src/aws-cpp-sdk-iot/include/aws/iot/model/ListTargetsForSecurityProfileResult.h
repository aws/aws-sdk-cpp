...
class ListTargetsForSecurityProfileResult {
 public:
  ...
  void SetSecurityProfileTargets(SecurityProfileTargetsT&& value) {
    m_securityProfileTargetsHasBeenSet = true;
    m_securityProfileTargets = std::forward<SecurityProfileTargetsT>(value);
  }
  template <typename SecurityProfileTargetsT = Aws::Vector<SecurityProfileTarget>>
  ListTargetsForSecurityProfileResult& WithSecurityProfileTargets(SecurityProfileTargetsT&& value) {
    SetSecurityProfileTargets(std::forward<SecurityProfileTargetsT>(value));
    return *this;
  }
  template <typename SecurityProfileTargetsT = SecurityProfileTarget>
  ListTargetsForSecurityProfileResult& AddSecurityProfileTargets(SecurityProfileTargetsT&& value) {
    m_securityProfileTargetsHasBeenSet = true;
    m_securityProfileTargets.emplace_back(std::forward<SecurityProfileTargetsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTargetsForSecurityProfileResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListTargetsForSecurityProfileResult& WithRequestId(RequestIdT&& value) {
