...
namespace Model
{
  ...
  public:
    ...
    template<typename PolicyNameT = Aws::String>
    GetPolicyVersionRequest& WithPolicyName(PolicyNameT&& value) { SetPolicyName(std::forward<PolicyNameT>(value)); return *this;}
    ///@}
    ...
    template<typename PolicyVersionIdT = Aws::String>
    GetPolicyVersionRequest& WithPolicyVersionId(PolicyVersionIdT&& value) { SetPolicyVersionId(std::forward<PolicyVersionIdT>(value)); return *this;}
    ///@}
  private:
