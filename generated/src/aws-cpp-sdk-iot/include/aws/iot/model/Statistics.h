...
class Statistics {
 public:
  ...
  inline Statistics& WithCount(int value) {
    SetCount(value);
    return *this;
  }
  ///@}
  ...
  inline Statistics& WithAverage(double value) {
    SetAverage(value);
    return *this;
  }
  ///@}
  ...
  inline Statistics& WithSum(double value) {
    SetSum(value);
    return *this;
  }
  ///@}
  ...
  inline Statistics& WithMinimum(double value) {
    SetMinimum(value);
    return *this;
  }
  ///@}
  ...
  inline Statistics& WithMaximum(double value) {
    SetMaximum(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSumOfSquares(double value) {
    m_sumOfSquaresHasBeenSet = true;
    m_sumOfSquares = value;
  }
  inline Statistics& WithSumOfSquares(double value) {
  ...
  inline Statistics& WithVariance(double value) {
    SetVariance(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStdDeviation(double value) {
    m_stdDeviationHasBeenSet = true;
    m_stdDeviation = value;
  }
  inline Statistics& WithStdDeviation(double value) {
    SetStdDeviation(value);
    return *this;
  }
  ///@}
 private:
