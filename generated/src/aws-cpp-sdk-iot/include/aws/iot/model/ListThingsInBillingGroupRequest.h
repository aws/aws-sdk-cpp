...
class ListThingsInBillingGroupRequest : public IoTRequest {
 public:
  ...
  template <typename BillingGroupNameT = Aws::String>
  ListThingsInBillingGroupRequest& WithBillingGroupName(BillingGroupNameT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListThingsInBillingGroupRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListThingsInBillingGroupRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
