...
class OTAUpdateFile {
 public:
  ...
  inline void SetFileType(int value) {
    m_fileTypeHasBeenSet = true;
    m_fileType = value;
  }
  inline OTAUpdateFile& WithFileType(int value) {
    SetFileType(value);
    return *this;
  }
  ///@}
  ...
  void SetFileVersion(FileVersionT&& value) {
    ...
    m_fileVersion = std::forward<FileVersionT>(value);
  }
  template <typename FileVersionT = Aws::String>
  OTAUpdateFile& WithFileVersion(FileVersionT&& value) {
    SetFileVersion(std::forward<FileVersionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCodeSigning(CodeSigningT&& value) {
    ...
    m_codeSigning = std::forward<CodeSigningT>(value);
  }
  template <typename CodeSigningT = CodeSigning>
  OTAUpdateFile& WithCodeSigning(CodeSigningT&& value) {
    SetCodeSigning(std::forward<CodeSigningT>(value));
    return *this;
  }
  ///@}
