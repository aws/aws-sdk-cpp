...
class CreateCustomMetricResult {
 public:
  ...
  template <typename MetricNameT = Aws::String>
  CreateCustomMetricResult& WithMetricName(MetricNameT&& value) {
  ...
  template <typename MetricArnT = Aws::String>
  CreateCustomMetricResult& WithMetricArn(MetricArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateCustomMetricResult& WithRequestId(RequestIdT&& value) {
