...
namespace Model
{
  ...
  {
  public:
    AWS_IOT_API DeleteCustomMetricResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteCustomMetricResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
