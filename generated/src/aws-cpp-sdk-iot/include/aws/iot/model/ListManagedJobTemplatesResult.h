...
class ListManagedJobTemplatesResult {
 public:
  ...
  void SetManagedJobTemplates(ManagedJobTemplatesT&& value) {
    m_managedJobTemplatesHasBeenSet = true;
    m_managedJobTemplates = std::forward<ManagedJobTemplatesT>(value);
  }
  template <typename ManagedJobTemplatesT = Aws::Vector<ManagedJobTemplateSummary>>
  ListManagedJobTemplatesResult& WithManagedJobTemplates(ManagedJobTemplatesT&& value) {
    SetManagedJobTemplates(std::forward<ManagedJobTemplatesT>(value));
    return *this;
  }
  template <typename ManagedJobTemplatesT = ManagedJobTemplateSummary>
  ListManagedJobTemplatesResult& AddManagedJobTemplates(ManagedJobTemplatesT&& value) {
    m_managedJobTemplatesHasBeenSet = true;
    m_managedJobTemplates.emplace_back(std::forward<ManagedJobTemplatesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListManagedJobTemplatesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListManagedJobTemplatesResult& WithRequestId(RequestIdT&& value) {
