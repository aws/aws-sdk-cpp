...
class TopicRuleListItem {
 public:
  ...
  void SetTopicPattern(TopicPatternT&& value) {
    ...
    m_topicPattern = std::forward<TopicPatternT>(value);
  }
  template <typename TopicPatternT = Aws::String>
  TopicRuleListItem& WithTopicPattern(TopicPatternT&& value) {
    SetTopicPattern(std::forward<TopicPatternT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetRuleDisabled(bool value) {
    m_ruleDisabledHasBeenSet = true;
    m_ruleDisabled = value;
  }
  inline TopicRuleListItem& WithRuleDisabled(bool value) {
    SetRuleDisabled(value);
    return *this;
  }
  ///@}
 private:
