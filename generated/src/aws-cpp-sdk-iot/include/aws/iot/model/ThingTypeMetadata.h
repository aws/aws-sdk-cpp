...
class ThingTypeMetadata {
 public:
  ...
  inline void SetDeprecated(bool value) {
    m_deprecatedHasBeenSet = true;
    m_deprecated = value;
  }
  inline ThingTypeMetadata& WithDeprecated(bool value) {
    SetDeprecated(value);
    return *this;
  }
  ///@}
  ...
  template <typename DeprecationDateT = Aws::Utils::DateTime>
  ThingTypeMetadata& WithDeprecationDate(DeprecationDateT&& value) {
  ...
  template <typename CreationDateT = Aws::Utils::DateTime>
  ThingTypeMetadata& WithCreationDate(CreationDateT&& value) {
