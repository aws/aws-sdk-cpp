...
namespace Model
{
  ...
  public:
    ...
    template<typename TaskIdT = Aws::String>
    ListDetectMitigationActionsExecutionsRequest& WithTaskId(TaskIdT&& value) { SetTaskId(std::forward<TaskIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ViolationIdT = Aws::String>
    ListDetectMitigationActionsExecutionsRequest& WithViolationId(ViolationIdT&& value) { SetViolationId(std::forward<ViolationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ThingNameT = Aws::String>
    ListDetectMitigationActionsExecutionsRequest& WithThingName(ThingNameT&& value) { SetThingName(std::forward<ThingNameT>(value)); return *this;}
    ///@}
    ...
    template<typename StartTimeT = Aws::Utils::DateTime>
    ListDetectMitigationActionsExecutionsRequest& WithStartTime(StartTimeT&& value) { SetStartTime(std::forward<StartTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename EndTimeT = Aws::Utils::DateTime>
    ListDetectMitigationActionsExecutionsRequest& WithEndTime(EndTimeT&& value) { SetEndTime(std::forward<EndTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListDetectMitigationActionsExecutionsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
