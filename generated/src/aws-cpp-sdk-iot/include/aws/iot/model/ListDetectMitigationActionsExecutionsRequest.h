...
class ListDetectMitigationActionsExecutionsRequest : public IoTRequest {
 public:
  AWS_IOT_API ListDetectMitigationActionsExecutionsRequest() = default;
  ...
  template <typename TaskIdT = Aws::String>
  ListDetectMitigationActionsExecutionsRequest& WithTaskId(TaskIdT&& value) {
  ...
  template <typename ViolationIdT = Aws::String>
  ListDetectMitigationActionsExecutionsRequest& WithViolationId(ViolationIdT&& value) {
  ...
  template <typename ThingNameT = Aws::String>
  ListDetectMitigationActionsExecutionsRequest& WithThingName(ThingNameT&& value) {
  ...
  template <typename StartTimeT = Aws::Utils::DateTime>
  ListDetectMitigationActionsExecutionsRequest& WithStartTime(StartTimeT&& value) {
  ...
  template <typename EndTimeT = Aws::Utils::DateTime>
  ListDetectMitigationActionsExecutionsRequest& WithEndTime(EndTimeT&& value) {
  ...
  inline ListDetectMitigationActionsExecutionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListDetectMitigationActionsExecutionsRequest& WithNextToken(NextTokenT&& value) {
