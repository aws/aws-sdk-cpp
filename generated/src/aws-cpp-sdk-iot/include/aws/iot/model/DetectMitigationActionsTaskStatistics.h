...
class DetectMitigationActionsTaskStatistics {
 public:
  ...
  inline void SetActionsExecuted(long long value) {
    m_actionsExecutedHasBeenSet = true;
    m_actionsExecuted = value;
  }
  inline DetectMitigationActionsTaskStatistics& WithActionsExecuted(long long value) {
    SetActionsExecuted(value);
    return *this;
  }
  ///@}
  ...
  inline void SetActionsSkipped(long long value) {
    m_actionsSkippedHasBeenSet = true;
    m_actionsSkipped = value;
  }
  inline DetectMitigationActionsTaskStatistics& WithActionsSkipped(long long value) {
    SetActionsSkipped(value);
    return *this;
  }
  ///@}
  ...
  inline void SetActionsFailed(long long value) {
    m_actionsFailedHasBeenSet = true;
    m_actionsFailed = value;
  }
  inline DetectMitigationActionsTaskStatistics& WithActionsFailed(long long value) {
    SetActionsFailed(value);
    return *this;
  }
  ///@}
 private:
