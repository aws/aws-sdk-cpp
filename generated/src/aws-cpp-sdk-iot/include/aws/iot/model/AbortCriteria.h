...
class AbortCriteria {
 public:
  ...
  inline void SetFailureType(JobExecutionFailureType value) {
    m_failureTypeHasBeenSet = true;
    m_failureType = value;
  }
  inline AbortCriteria& WithFailureType(JobExecutionFailureType value) {
  ...
  inline void SetAction(AbortAction value) {
    m_actionHasBeenSet = true;
    m_action = value;
  }
  inline AbortCriteria& WithAction(AbortAction value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  inline AbortCriteria& WithThresholdPercentage(double value) {
  ...
  inline AbortCriteria& WithMinNumberOfExecutedThings(int value) {
