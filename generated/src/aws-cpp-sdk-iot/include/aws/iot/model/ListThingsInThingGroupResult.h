...
class ListThingsInThingGroupResult {
 public:
  ...
  template <typename ThingsT = Aws::Vector<Aws::String>>
  ListThingsInThingGroupResult& WithThings(ThingsT&& value) {
    SetThings(std::forward<ThingsT>(value));
    return *this;
  }
  template <typename ThingsT = Aws::String>
  ListThingsInThingGroupResult& AddThings(ThingsT&& value) {
    m_thingsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListThingsInThingGroupResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListThingsInThingGroupResult& WithRequestId(RequestIdT&& value) {
