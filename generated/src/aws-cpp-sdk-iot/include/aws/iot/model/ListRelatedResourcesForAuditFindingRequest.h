...
class ListRelatedResourcesForAuditFindingRequest : public IoTRequest {
 public:
  ...
  template <typename FindingIdT = Aws::String>
  ListRelatedResourcesForAuditFindingRequest& WithFindingId(FindingIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListRelatedResourcesForAuditFindingRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListRelatedResourcesForAuditFindingRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
