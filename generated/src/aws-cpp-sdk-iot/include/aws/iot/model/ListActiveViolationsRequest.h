...
class ListActiveViolationsRequest : public IoTRequest {
 public:
  ...
  inline void SetBehaviorCriteriaType(BehaviorCriteriaType value) {
    m_behaviorCriteriaTypeHasBeenSet = true;
    m_behaviorCriteriaType = value;
  }
  inline ListActiveViolationsRequest& WithBehaviorCriteriaType(BehaviorCriteriaType value) {
    SetBehaviorCriteriaType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetListSuppressedAlerts(bool value) {
    m_listSuppressedAlertsHasBeenSet = true;
    m_listSuppressedAlerts = value;
  }
  inline ListActiveViolationsRequest& WithListSuppressedAlerts(bool value) {
    SetListSuppressedAlerts(value);
    return *this;
  }
  ///@}
  ...
  inline ListActiveViolationsRequest& WithVerificationState(VerificationState value) {
  ...
  inline ListActiveViolationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
