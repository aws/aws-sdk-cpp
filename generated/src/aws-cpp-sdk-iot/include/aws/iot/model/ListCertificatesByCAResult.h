...
class ListCertificatesByCAResult {
 public:
  ...
  template <typename CertificatesT = Aws::Vector<Certificate>>
  ListCertificatesByCAResult& WithCertificates(CertificatesT&& value) {
    SetCertificates(std::forward<CertificatesT>(value));
    return *this;
  }
  template <typename CertificatesT = Certificate>
  ListCertificatesByCAResult& AddCertificates(CertificatesT&& value) {
    m_certificatesHasBeenSet = true;
  ...
  template <typename NextMarkerT = Aws::String>
  ListCertificatesByCAResult& WithNextMarker(NextMarkerT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListCertificatesByCAResult& WithRequestId(RequestIdT&& value) {
