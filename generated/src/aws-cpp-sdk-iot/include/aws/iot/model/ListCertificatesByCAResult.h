...
namespace Model
{
  ...
  {
  public:
    AWS_IOT_API ListCertificatesByCAResult() = default;
    ...
    template<typename CertificatesT = Aws::Vector<Certificate>>
    ListCertificatesByCAResult& WithCertificates(CertificatesT&& value) { SetCertificates(std::forward<CertificatesT>(value)); return *this;}
    template<typename CertificatesT = Certificate>
    ListCertificatesByCAResult& AddCertificates(CertificatesT&& value) { m_certificatesHasBeenSet = true; m_certificates.emplace_back(std::forward<CertificatesT>(value)); return *this; }
    ///@}
    ...
    template<typename NextMarkerT = Aws::String>
    ListCertificatesByCAResult& WithNextMarker(NextMarkerT&& value) { SetNextMarker(std::forward<NextMarkerT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ListCertificatesByCAResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
