...
class AwsJobAbortConfig {
 public:
  ...
  void SetAbortCriteriaList(AbortCriteriaListT&& value) {
    m_abortCriteriaListHasBeenSet = true;
    m_abortCriteriaList = std::forward<AbortCriteriaListT>(value);
  }
  template <typename AbortCriteriaListT = Aws::Vector<AwsJobAbortCriteria>>
  AwsJobAbortConfig& WithAbortCriteriaList(AbortCriteriaListT&& value) {
    SetAbortCriteriaList(std::forward<AbortCriteriaListT>(value));
    return *this;
  }
  template <typename AbortCriteriaListT = AwsJobAbortCriteria>
  AwsJobAbortConfig& AddAbortCriteriaList(AbortCriteriaListT&& value) {
    m_abortCriteriaListHasBeenSet = true;
    m_abortCriteriaList.emplace_back(std::forward<AbortCriteriaListT>(value));
    return *this;
  }
  ///@}
 private:
