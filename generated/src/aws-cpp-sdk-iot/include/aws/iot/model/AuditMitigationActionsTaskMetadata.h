...
class AuditMitigationActionsTaskMetadata {
 public:
  ...
  template <typename TaskIdT = Aws::String>
  AuditMitigationActionsTaskMetadata& WithTaskId(TaskIdT&& value) {
  ...
  template <typename StartTimeT = Aws::Utils::DateTime>
  AuditMitigationActionsTaskMetadata& WithStartTime(StartTimeT&& value) {
  ...
  inline AuditMitigationActionsTaskMetadata& WithTaskStatus(AuditMitigationActionsTaskStatus value) {
    SetTaskStatus(value);
    return *this;
  }
  ///@}
