...
class ListDetectMitigationActionsTasksRequest : public IoTRequest {
 public:
  AWS_IOT_API ListDetectMitigationActionsTasksRequest() = default;
  ...
  inline ListDetectMitigationActionsTasksRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListDetectMitigationActionsTasksRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename StartTimeT = Aws::Utils::DateTime>
  ListDetectMitigationActionsTasksRequest& WithStartTime(StartTimeT&& value) {
  ...
  template <typename EndTimeT = Aws::Utils::DateTime>
  ListDetectMitigationActionsTasksRequest& WithEndTime(EndTimeT&& value) {
