...
class AlertTarget {
 public:
  ...
  void SetAlertTargetArn(AlertTargetArnT&& value) {
    m_alertTargetArnHasBeenSet = true;
    m_alertTargetArn = std::forward<AlertTargetArnT>(value);
  }
  template <typename AlertTargetArnT = Aws::String>
  AlertTarget& WithAlertTargetArn(AlertTargetArnT&& value) {
    SetAlertTargetArn(std::forward<AlertTargetArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RoleArnT = Aws::String>
  AlertTarget& WithRoleArn(RoleArnT&& value) {
