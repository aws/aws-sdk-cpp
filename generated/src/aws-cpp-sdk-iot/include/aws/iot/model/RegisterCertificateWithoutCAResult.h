...
namespace Model
{
  ...
  public:
    ...
    template<typename CertificateArnT = Aws::String>
    RegisterCertificateWithoutCAResult& WithCertificateArn(CertificateArnT&& value) { SetCertificateArn(std::forward<CertificateArnT>(value)); return *this;}
    ///@}
    ...
    template<typename CertificateIdT = Aws::String>
    RegisterCertificateWithoutCAResult& WithCertificateId(CertificateIdT&& value) { SetCertificateId(std::forward<CertificateIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    RegisterCertificateWithoutCAResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
