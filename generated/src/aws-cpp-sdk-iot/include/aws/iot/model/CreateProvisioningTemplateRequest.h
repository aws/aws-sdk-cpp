...
class CreateProvisioningTemplateRequest : public IoTRequest {
 public:
  ...
  inline CreateProvisioningTemplateRequest& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  void SetPreProvisioningHook(PreProvisioningHookT&& value) {
    ...
    m_preProvisioningHook = std::forward<PreProvisioningHookT>(value);
  }
  template <typename PreProvisioningHookT = ProvisioningHook>
  CreateProvisioningTemplateRequest& WithPreProvisioningHook(PreProvisioningHookT&& value) {
    SetPreProvisioningHook(std::forward<PreProvisioningHookT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetType(TemplateType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline CreateProvisioningTemplateRequest& WithType(TemplateType value) {
    SetType(value);
    return *this;
  }
  ///@}
