...
namespace Model
{
  ...
  public:
    ...
    inline ListScheduledAuditsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ListScheduledAuditsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ListScheduledAuditsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
