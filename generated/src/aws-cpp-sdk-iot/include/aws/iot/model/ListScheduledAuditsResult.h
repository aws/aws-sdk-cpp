...
class ListScheduledAuditsResult {
 public:
  ...
  void SetScheduledAudits(ScheduledAuditsT&& value) {
    m_scheduledAuditsHasBeenSet = true;
    m_scheduledAudits = std::forward<ScheduledAuditsT>(value);
  }
  template <typename ScheduledAuditsT = Aws::Vector<ScheduledAuditMetadata>>
  ListScheduledAuditsResult& WithScheduledAudits(ScheduledAuditsT&& value) {
    SetScheduledAudits(std::forward<ScheduledAuditsT>(value));
    return *this;
  }
  template <typename ScheduledAuditsT = ScheduledAuditMetadata>
  ListScheduledAuditsResult& AddScheduledAudits(ScheduledAuditsT&& value) {
    m_scheduledAuditsHasBeenSet = true;
    m_scheduledAudits.emplace_back(std::forward<ScheduledAuditsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListScheduledAuditsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListScheduledAuditsResult& WithRequestId(RequestIdT&& value) {
