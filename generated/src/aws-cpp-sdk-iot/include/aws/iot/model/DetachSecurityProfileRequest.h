...
class DetachSecurityProfileRequest : public IoTRequest {
 public:
  ...
  template <typename SecurityProfileNameT = Aws::String>
  DetachSecurityProfileRequest& WithSecurityProfileName(SecurityProfileNameT&& value) {
  ...
  void SetSecurityProfileTargetArn(SecurityProfileTargetArnT&& value) {
    m_securityProfileTargetArnHasBeenSet = true;
    m_securityProfileTargetArn = std::forward<SecurityProfileTargetArnT>(value);
  }
  template <typename SecurityProfileTargetArnT = Aws::String>
  DetachSecurityProfileRequest& WithSecurityProfileTargetArn(SecurityProfileTargetArnT&& value) {
    SetSecurityProfileTargetArn(std::forward<SecurityProfileTargetArnT>(value));
    return *this;
  }
  ///@}
 private:
