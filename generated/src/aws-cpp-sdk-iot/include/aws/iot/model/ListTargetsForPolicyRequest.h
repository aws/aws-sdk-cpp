...
class ListTargetsForPolicyRequest : public IoTRequest {
 public:
  AWS_IOT_API ListTargetsForPolicyRequest() = default;
  ...
  template <typename PolicyNameT = Aws::String>
  ListTargetsForPolicyRequest& WithPolicyName(PolicyNameT&& value) {
  ...
  template <typename MarkerT = Aws::String>
  ListTargetsForPolicyRequest& WithMarker(MarkerT&& value) {
  ...
  inline ListTargetsForPolicyRequest& WithPageSize(int value) {
    SetPageSize(value);
    return *this;
  }
  ///@}
