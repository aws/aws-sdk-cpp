...
class ThingTypeProperties {
 public:
  ...
  void SetThingTypeDescription(ThingTypeDescriptionT&& value) {
    m_thingTypeDescriptionHasBeenSet = true;
    m_thingTypeDescription = std::forward<ThingTypeDescriptionT>(value);
  }
  template <typename ThingTypeDescriptionT = Aws::String>
  ThingTypeProperties& WithThingTypeDescription(ThingTypeDescriptionT&& value) {
    SetThingTypeDescription(std::forward<ThingTypeDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSearchableAttributes(SearchableAttributesT&& value) {
    m_searchableAttributesHasBeenSet = true;
    m_searchableAttributes = std::forward<SearchableAttributesT>(value);
  }
  template <typename SearchableAttributesT = Aws::Vector<Aws::String>>
  ThingTypeProperties& WithSearchableAttributes(SearchableAttributesT&& value) {
    SetSearchableAttributes(std::forward<SearchableAttributesT>(value));
    return *this;
  }
  template <typename SearchableAttributesT = Aws::String>
  ThingTypeProperties& AddSearchableAttributes(SearchableAttributesT&& value) {
    m_searchableAttributesHasBeenSet = true;
    m_searchableAttributes.emplace_back(std::forward<SearchableAttributesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMqtt5Configuration(Mqtt5ConfigurationT&& value) {
    m_mqtt5ConfigurationHasBeenSet = true;
    m_mqtt5Configuration = std::forward<Mqtt5ConfigurationT>(value);
  }
  template <typename Mqtt5ConfigurationT = Mqtt5Configuration>
  ThingTypeProperties& WithMqtt5Configuration(Mqtt5ConfigurationT&& value) {
    SetMqtt5Configuration(std::forward<Mqtt5ConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
