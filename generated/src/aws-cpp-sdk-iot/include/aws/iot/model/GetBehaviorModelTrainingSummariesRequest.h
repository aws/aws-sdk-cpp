...
class GetBehaviorModelTrainingSummariesRequest : public IoTRequest {
 public:
  ...
  template <typename SecurityProfileNameT = Aws::String>
  GetBehaviorModelTrainingSummariesRequest& WithSecurityProfileName(SecurityProfileNameT&& value) {
  ...
  inline GetBehaviorModelTrainingSummariesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetBehaviorModelTrainingSummariesRequest& WithNextToken(NextTokenT&& value) {
