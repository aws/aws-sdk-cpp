...
class PropagatingAttribute {
 public:
  ...
  void SetUserPropertyKey(UserPropertyKeyT&& value) {
    ...
    m_userPropertyKey = std::forward<UserPropertyKeyT>(value);
  }
  template <typename UserPropertyKeyT = Aws::String>
  PropagatingAttribute& WithUserPropertyKey(UserPropertyKeyT&& value) {
    SetUserPropertyKey(std::forward<UserPropertyKeyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetThingAttribute(ThingAttributeT&& value) {
    ...
    m_thingAttribute = std::forward<ThingAttributeT>(value);
  }
  template <typename ThingAttributeT = Aws::String>
  PropagatingAttribute& WithThingAttribute(ThingAttributeT&& value) {
    SetThingAttribute(std::forward<ThingAttributeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetConnectionAttribute(ConnectionAttributeT&& value) {
    ...
    m_connectionAttribute = std::forward<ConnectionAttributeT>(value);
  }
  template <typename ConnectionAttributeT = Aws::String>
  PropagatingAttribute& WithConnectionAttribute(ConnectionAttributeT&& value) {
    SetConnectionAttribute(std::forward<ConnectionAttributeT>(value));
    return *this;
  }
  ///@}
 private:
