...
class CreateAuthorizerRequest : public IoTRequest {
 public:
  ...
  inline CreateAuthorizerRequest& WithStatus(AuthorizerStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline CreateAuthorizerRequest& WithSigningDisabled(bool value) {
  ...
  inline CreateAuthorizerRequest& WithEnableCachingForHttp(bool value) {
