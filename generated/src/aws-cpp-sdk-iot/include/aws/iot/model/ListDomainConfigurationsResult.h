...
class ListDomainConfigurationsResult {
 public:
  ...
  void SetDomainConfigurations(DomainConfigurationsT&& value) {
    ...
    m_domainConfigurations = std::forward<DomainConfigurationsT>(value);
  }
  template <typename DomainConfigurationsT = Aws::Vector<DomainConfigurationSummary>>
  ListDomainConfigurationsResult& WithDomainConfigurations(DomainConfigurationsT&& value) {
    SetDomainConfigurations(std::forward<DomainConfigurationsT>(value));
    return *this;
  }
  ...
  ListDomainConfigurationsResult& AddDomainConfigurations(DomainConfigurationsT&& value) {
    m_domainConfigurationsHasBeenSet = true;
    m_domainConfigurations.emplace_back(std::forward<DomainConfigurationsT>(value));
    return *this;
  }
  ///@}
