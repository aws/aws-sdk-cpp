...
class AuditMitigationActionsTaskTarget {
 public:
  ...
  void SetAuditTaskId(AuditTaskIdT&& value) {
    m_auditTaskIdHasBeenSet = true;
    m_auditTaskId = std::forward<AuditTaskIdT>(value);
  }
  template <typename AuditTaskIdT = Aws::String>
  AuditMitigationActionsTaskTarget& WithAuditTaskId(AuditTaskIdT&& value) {
    SetAuditTaskId(std::forward<AuditTaskIdT>(value));
    return *this;
  }
  ///@}
   ...
   * apply.</p>
   */
  inline const Aws::Map<Aws::String, Aws::Vector<Aws::String>>& GetAuditCheckToReasonCodeFilter() const {
    return m_auditCheckToReasonCodeFilter;
  }
  ...
  void SetAuditCheckToReasonCodeFilter(AuditCheckToReasonCodeFilterT&& value) {
    ...
    m_auditCheckToReasonCodeFilter = std::forward<AuditCheckToReasonCodeFilterT>(value);
  }
  template <typename AuditCheckToReasonCodeFilterT = Aws::Map<Aws::String, Aws::Vector<Aws::String>>>
  AuditMitigationActionsTaskTarget& WithAuditCheckToReasonCodeFilter(AuditCheckToReasonCodeFilterT&& value) {
    SetAuditCheckToReasonCodeFilter(std::forward<AuditCheckToReasonCodeFilterT>(value));
    return *this;
  }
  ...
  AuditMitigationActionsTaskTarget& AddAuditCheckToReasonCodeFilter(AuditCheckToReasonCodeFilterKeyT&& key,
                                                                    AuditCheckToReasonCodeFilterValueT&& value) {
    m_auditCheckToReasonCodeFilterHasBeenSet = true;
    m_auditCheckToReasonCodeFilter.emplace(std::forward<AuditCheckToReasonCodeFilterKeyT>(key),
                                           std::forward<AuditCheckToReasonCodeFilterValueT>(value));
    return *this;
  }
  ///@}
 private:
