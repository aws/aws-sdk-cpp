...
class ListAuditTasksResult {
 public:
  ...
  template <typename TasksT = Aws::Vector<AuditTaskMetadata>>
  ListAuditTasksResult& WithTasks(TasksT&& value) {
    SetTasks(std::forward<TasksT>(value));
    return *this;
  }
  template <typename TasksT = AuditTaskMetadata>
  ListAuditTasksResult& AddTasks(TasksT&& value) {
    m_tasksHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListAuditTasksResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAuditTasksResult& WithRequestId(RequestIdT&& value) {
