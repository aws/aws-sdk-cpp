...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class GetTopicRuleRequest : public IoTRequest
  {
  public:
    AWS_IOT_API GetTopicRuleRequest() = default;
    ...
    template<typename RuleNameT = Aws::String>
    GetTopicRuleRequest& WithRuleName(RuleNameT&& value) { SetRuleName(std::forward<RuleNameT>(value)); return *this;}
    ///@}
  private:
