...
class ListPackagesResult {
 public:
  ...
  void SetPackageSummaries(PackageSummariesT&& value) {
    m_packageSummariesHasBeenSet = true;
    m_packageSummaries = std::forward<PackageSummariesT>(value);
  }
  template <typename PackageSummariesT = Aws::Vector<PackageSummary>>
  ListPackagesResult& WithPackageSummaries(PackageSummariesT&& value) {
    SetPackageSummaries(std::forward<PackageSummariesT>(value));
    return *this;
  }
  template <typename PackageSummariesT = PackageSummary>
  ListPackagesResult& AddPackageSummaries(PackageSummariesT&& value) {
    m_packageSummariesHasBeenSet = true;
    m_packageSummaries.emplace_back(std::forward<PackageSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListPackagesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListPackagesResult& WithRequestId(RequestIdT&& value) {
