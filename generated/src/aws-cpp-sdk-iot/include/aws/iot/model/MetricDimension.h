...
class MetricDimension {
 public:
  ...
  template <typename DimensionNameT = Aws::String>
  MetricDimension& WithDimensionName(DimensionNameT&& value) {
  ...
  inline void SetOperator(DimensionValueOperator value) {
    m_operatorHasBeenSet = true;
    m_operator = value;
  }
  inline MetricDimension& WithOperator(DimensionValueOperator value) {
    SetOperator(value);
    return *this;
  }
  ///@}
