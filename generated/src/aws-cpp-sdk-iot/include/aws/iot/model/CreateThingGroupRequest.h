...
class CreateThingGroupRequest : public IoTRequest {
 public:
  ...
  void SetParentGroupName(ParentGroupNameT&& value) {
    ...
    m_parentGroupName = std::forward<ParentGroupNameT>(value);
  }
  template <typename ParentGroupNameT = Aws::String>
  CreateThingGroupRequest& WithParentGroupName(ParentGroupNameT&& value) {
    SetParentGroupName(std::forward<ParentGroupNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetThingGroupProperties(ThingGroupPropertiesT&& value) {
    ...
    m_thingGroupProperties = std::forward<ThingGroupPropertiesT>(value);
  }
  template <typename ThingGroupPropertiesT = ThingGroupProperties>
  CreateThingGroupRequest& WithThingGroupProperties(ThingGroupPropertiesT&& value) {
    SetThingGroupProperties(std::forward<ThingGroupPropertiesT>(value));
    return *this;
  }
  ///@}
