...
class ListViolationEventsResult {
 public:
  ...
  void SetViolationEvents(ViolationEventsT&& value) {
    m_violationEventsHasBeenSet = true;
    m_violationEvents = std::forward<ViolationEventsT>(value);
  }
  template <typename ViolationEventsT = Aws::Vector<ViolationEvent>>
  ListViolationEventsResult& WithViolationEvents(ViolationEventsT&& value) {
    SetViolationEvents(std::forward<ViolationEventsT>(value));
    return *this;
  }
  template <typename ViolationEventsT = ViolationEvent>
  ListViolationEventsResult& AddViolationEvents(ViolationEventsT&& value) {
    m_violationEventsHasBeenSet = true;
    m_violationEvents.emplace_back(std::forward<ViolationEventsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListViolationEventsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListViolationEventsResult& WithRequestId(RequestIdT&& value) {
