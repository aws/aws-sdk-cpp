...
class CreateRoleAliasResult {
 public:
  ...
  template <typename RoleAliasT = Aws::String>
  CreateRoleAliasResult& WithRoleAlias(RoleAliasT&& value) {
  ...
  template <typename RoleAliasArnT = Aws::String>
  CreateRoleAliasResult& WithRoleAliasArn(RoleAliasArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateRoleAliasResult& WithRequestId(RequestIdT&& value) {
