...
namespace Model
{
  ...
  {
  public:
    AWS_IOT_API ConfirmTopicRuleDestinationResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    ConfirmTopicRuleDestinationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
