...
class UpdateThingGroupsForThingRequest : public IoTRequest {
 public:
  ...
  template <typename ThingNameT = Aws::String>
  UpdateThingGroupsForThingRequest& WithThingName(ThingNameT&& value) {
  ...
  void SetThingGroupsToAdd(ThingGroupsToAddT&& value) {
    m_thingGroupsToAddHasBeenSet = true;
    m_thingGroupsToAdd = std::forward<ThingGroupsToAddT>(value);
  }
  template <typename ThingGroupsToAddT = Aws::Vector<Aws::String>>
  UpdateThingGroupsForThingRequest& WithThingGroupsToAdd(ThingGroupsToAddT&& value) {
    SetThingGroupsToAdd(std::forward<ThingGroupsToAddT>(value));
    return *this;
  }
  template <typename ThingGroupsToAddT = Aws::String>
  UpdateThingGroupsForThingRequest& AddThingGroupsToAdd(ThingGroupsToAddT&& value) {
    m_thingGroupsToAddHasBeenSet = true;
    m_thingGroupsToAdd.emplace_back(std::forward<ThingGroupsToAddT>(value));
    return *this;
  }
  ///@}
  ...
  void SetThingGroupsToRemove(ThingGroupsToRemoveT&& value) {
    m_thingGroupsToRemoveHasBeenSet = true;
    m_thingGroupsToRemove = std::forward<ThingGroupsToRemoveT>(value);
  }
  template <typename ThingGroupsToRemoveT = Aws::Vector<Aws::String>>
  UpdateThingGroupsForThingRequest& WithThingGroupsToRemove(ThingGroupsToRemoveT&& value) {
    SetThingGroupsToRemove(std::forward<ThingGroupsToRemoveT>(value));
    return *this;
  }
  template <typename ThingGroupsToRemoveT = Aws::String>
  UpdateThingGroupsForThingRequest& AddThingGroupsToRemove(ThingGroupsToRemoveT&& value) {
    m_thingGroupsToRemoveHasBeenSet = true;
    m_thingGroupsToRemove.emplace_back(std::forward<ThingGroupsToRemoveT>(value));
    return *this;
  }
  ///@}
  ...
  inline UpdateThingGroupsForThingRequest& WithOverrideDynamicGroups(bool value) {
