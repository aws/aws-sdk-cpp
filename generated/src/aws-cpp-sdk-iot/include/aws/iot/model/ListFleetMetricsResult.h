...
class ListFleetMetricsResult {
 public:
  ...
  void SetFleetMetrics(FleetMetricsT&& value) {
    m_fleetMetricsHasBeenSet = true;
    m_fleetMetrics = std::forward<FleetMetricsT>(value);
  }
  template <typename FleetMetricsT = Aws::Vector<FleetMetricNameAndArn>>
  ListFleetMetricsResult& WithFleetMetrics(FleetMetricsT&& value) {
    SetFleetMetrics(std::forward<FleetMetricsT>(value));
    return *this;
  }
  template <typename FleetMetricsT = FleetMetricNameAndArn>
  ListFleetMetricsResult& AddFleetMetrics(FleetMetricsT&& value) {
    m_fleetMetricsHasBeenSet = true;
    m_fleetMetrics.emplace_back(std::forward<FleetMetricsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListFleetMetricsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListFleetMetricsResult& WithRequestId(RequestIdT&& value) {
