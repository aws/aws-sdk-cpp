...
class DescribeThingTypeResult {
 public:
  ...
  template <typename ThingTypeNameT = Aws::String>
  DescribeThingTypeResult& WithThingTypeName(ThingTypeNameT&& value) {
  ...
  void SetThingTypeId(ThingTypeIdT&& value) {
    m_thingTypeIdHasBeenSet = true;
    m_thingTypeId = std::forward<ThingTypeIdT>(value);
  }
  template <typename ThingTypeIdT = Aws::String>
  DescribeThingTypeResult& WithThingTypeId(ThingTypeIdT&& value) {
    SetThingTypeId(std::forward<ThingTypeIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetThingTypeArn(ThingTypeArnT&& value) {
    m_thingTypeArnHasBeenSet = true;
    m_thingTypeArn = std::forward<ThingTypeArnT>(value);
  }
  template <typename ThingTypeArnT = Aws::String>
  DescribeThingTypeResult& WithThingTypeArn(ThingTypeArnT&& value) {
    SetThingTypeArn(std::forward<ThingTypeArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ThingTypePropertiesT = ThingTypeProperties>
  DescribeThingTypeResult& WithThingTypeProperties(ThingTypePropertiesT&& value) {
  ...
  void SetThingTypeMetadata(ThingTypeMetadataT&& value) {
    m_thingTypeMetadataHasBeenSet = true;
    m_thingTypeMetadata = std::forward<ThingTypeMetadataT>(value);
  }
  template <typename ThingTypeMetadataT = ThingTypeMetadata>
  DescribeThingTypeResult& WithThingTypeMetadata(ThingTypeMetadataT&& value) {
    SetThingTypeMetadata(std::forward<ThingTypeMetadataT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeThingTypeResult& WithRequestId(RequestIdT&& value) {
