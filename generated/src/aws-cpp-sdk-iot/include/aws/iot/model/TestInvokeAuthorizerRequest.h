...
class TestInvokeAuthorizerRequest : public IoTRequest {
 public:
  ...
  void SetTokenSignature(TokenSignatureT&& value) {
    m_tokenSignatureHasBeenSet = true;
    m_tokenSignature = std::forward<TokenSignatureT>(value);
  }
  template <typename TokenSignatureT = Aws::String>
  TestInvokeAuthorizerRequest& WithTokenSignature(TokenSignatureT&& value) {
    SetTokenSignature(std::forward<TokenSignatureT>(value));
    return *this;
  }
  ///@}
  ...
  void SetHttpContext(HttpContextT&& value) {
    m_httpContextHasBeenSet = true;
    m_httpContext = std::forward<HttpContextT>(value);
  }
  template <typename HttpContextT = HttpContext>
  TestInvokeAuthorizerRequest& WithHttpContext(HttpContextT&& value) {
    SetHttpContext(std::forward<HttpContextT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMqttContext(MqttContextT&& value) {
    m_mqttContextHasBeenSet = true;
    m_mqttContext = std::forward<MqttContextT>(value);
  }
  template <typename MqttContextT = MqttContext>
  TestInvokeAuthorizerRequest& WithMqttContext(MqttContextT&& value) {
    SetMqttContext(std::forward<MqttContextT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTlsContext(TlsContextT&& value) {
    m_tlsContextHasBeenSet = true;
    m_tlsContext = std::forward<TlsContextT>(value);
  }
  template <typename TlsContextT = TlsContext>
  TestInvokeAuthorizerRequest& WithTlsContext(TlsContextT&& value) {
    SetTlsContext(std::forward<TlsContextT>(value));
    return *this;
  }
  ///@}
 private:
