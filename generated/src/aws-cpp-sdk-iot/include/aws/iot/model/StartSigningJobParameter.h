...
class StartSigningJobParameter {
 public:
  ...
  void SetSigningProfileParameter(SigningProfileParameterT&& value) {
    ...
    m_signingProfileParameter = std::forward<SigningProfileParameterT>(value);
  }
  template <typename SigningProfileParameterT = SigningProfileParameter>
  StartSigningJobParameter& WithSigningProfileParameter(SigningProfileParameterT&& value) {
    SetSigningProfileParameter(std::forward<SigningProfileParameterT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSigningProfileName(SigningProfileNameT&& value) {
    ...
    m_signingProfileName = std::forward<SigningProfileNameT>(value);
  }
  template <typename SigningProfileNameT = Aws::String>
  StartSigningJobParameter& WithSigningProfileName(SigningProfileNameT&& value) {
    SetSigningProfileName(std::forward<SigningProfileNameT>(value));
    return *this;
  }
  ///@}
