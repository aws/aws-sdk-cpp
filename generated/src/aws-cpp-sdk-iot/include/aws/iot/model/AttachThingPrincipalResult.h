...
namespace Model
{
  ...
  {
  public:
    AWS_IOT_API AttachThingPrincipalResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    AttachThingPrincipalResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
