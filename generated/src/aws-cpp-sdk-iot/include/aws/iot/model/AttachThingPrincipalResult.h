...
namespace Model
{
  ...
  public:
    ...
    inline AttachThingPrincipalResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline AttachThingPrincipalResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline AttachThingPrincipalResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
