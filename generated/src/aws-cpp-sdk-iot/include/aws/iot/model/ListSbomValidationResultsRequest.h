...
class ListSbomValidationResultsRequest : public IoTRequest {
 public:
  ...
  template <typename PackageNameT = Aws::String>
  ListSbomValidationResultsRequest& WithPackageName(PackageNameT&& value) {
  ...
  template <typename VersionNameT = Aws::String>
  ListSbomValidationResultsRequest& WithVersionName(VersionNameT&& value) {
  ...
  inline void SetValidationResult(SbomValidationResult value) {
    m_validationResultHasBeenSet = true;
    m_validationResult = value;
  }
  inline ListSbomValidationResultsRequest& WithValidationResult(SbomValidationResult value) {
  ...
  inline ListSbomValidationResultsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListSbomValidationResultsRequest& WithNextToken(NextTokenT&& value) {
