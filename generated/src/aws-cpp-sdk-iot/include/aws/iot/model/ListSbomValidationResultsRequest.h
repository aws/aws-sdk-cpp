...
namespace Model
{
  ...
  {
  public:
    AWS_IOT_API ListSbomValidationResultsRequest() = default;
    ...
    template<typename PackageNameT = Aws::String>
    ListSbomValidationResultsRequest& WithPackageName(PackageNameT&& value) { SetPackageName(std::forward<PackageNameT>(value)); return *this;}
    ///@}
    ...
    template<typename VersionNameT = Aws::String>
    ListSbomValidationResultsRequest& WithVersionName(VersionNameT&& value) { SetVersionName(std::forward<VersionNameT>(value)); return *this;}
    ///@}
    ...
    inline ListSbomValidationResultsRequest& WithValidationResult(SbomValidationResult value) { SetValidationResult(value); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListSbomValidationResultsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
