...
class TransferCertificateResult {
 public:
  ...
  void SetTransferredCertificateArn(TransferredCertificateArnT&& value) {
    m_transferredCertificateArnHasBeenSet = true;
    m_transferredCertificateArn = std::forward<TransferredCertificateArnT>(value);
  }
  template <typename TransferredCertificateArnT = Aws::String>
  TransferCertificateResult& WithTransferredCertificateArn(TransferredCertificateArnT&& value) {
    SetTransferredCertificateArn(std::forward<TransferredCertificateArnT>(value));
    return *this;
  }
  ///@}
