...
class TopicRulePayload {
 public:
  ...
  inline TopicRulePayload& WithRuleDisabled(bool value) {
  ...
  void SetAwsIotSqlVersion(AwsIotSqlVersionT&& value) {
    ...
    m_awsIotSqlVersion = std::forward<AwsIotSqlVersionT>(value);
  }
  template <typename AwsIotSqlVersionT = Aws::String>
  TopicRulePayload& WithAwsIotSqlVersion(AwsIotSqlVersionT&& value) {
    SetAwsIotSqlVersion(std::forward<AwsIotSqlVersionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetErrorAction(ErrorActionT&& value) {
    ...
    m_errorAction = std::forward<ErrorActionT>(value);
  }
  template <typename ErrorActionT = Action>
  TopicRulePayload& WithErrorAction(ErrorActionT&& value) {
    SetErrorAction(std::forward<ErrorActionT>(value));
    return *this;
  }
  ///@}
 private:
