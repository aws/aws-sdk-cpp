 ...
 * <code>ListTopicRuleDestinations</code>. For the full set of destination
 * properties, see <code>InfluxDBDestinationProperties</code>.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/iot-2015-05-28/InfluxDBDestinationSummary">AWS
 * API Reference</a></p>
 */
class InfluxDBDestinationSummary {
 public:
  ...
  inline InfluxDBDestinationSummary& WithInfluxDBVersion(InfluxDBVersion value) {
  ...
  inline InfluxDBDestinationSummary& WithSecretType(InfluxDBSecretType value) {
    SetSecretType(value);
    return *this;
  }
  ///@}
