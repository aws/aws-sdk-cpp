...
namespace Model
{
  ...
  {
  public:
    AWS_IOT_API DeleteSecurityProfileResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteSecurityProfileResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
