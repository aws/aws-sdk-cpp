...
class IssuerCertificateIdentifier {
 public:
  ...
  void SetIssuerCertificateSubject(IssuerCertificateSubjectT&& value) {
    m_issuerCertificateSubjectHasBeenSet = true;
    m_issuerCertificateSubject = std::forward<IssuerCertificateSubjectT>(value);
  }
  template <typename IssuerCertificateSubjectT = Aws::String>
  IssuerCertificateIdentifier& WithIssuerCertificateSubject(IssuerCertificateSubjectT&& value) {
    SetIssuerCertificateSubject(std::forward<IssuerCertificateSubjectT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIssuerId(IssuerIdT&& value) {
    m_issuerIdHasBeenSet = true;
    m_issuerId = std::forward<IssuerIdT>(value);
  }
  template <typename IssuerIdT = Aws::String>
  IssuerCertificateIdentifier& WithIssuerId(IssuerIdT&& value) {
    SetIssuerId(std::forward<IssuerIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIssuerCertificateSerialNumber(IssuerCertificateSerialNumberT&& value) {
    m_issuerCertificateSerialNumberHasBeenSet = true;
    m_issuerCertificateSerialNumber = std::forward<IssuerCertificateSerialNumberT>(value);
  }
  template <typename IssuerCertificateSerialNumberT = Aws::String>
  IssuerCertificateIdentifier& WithIssuerCertificateSerialNumber(IssuerCertificateSerialNumberT&& value) {
    SetIssuerCertificateSerialNumber(std::forward<IssuerCertificateSerialNumberT>(value));
    return *this;
  }
  ///@}
 private:
