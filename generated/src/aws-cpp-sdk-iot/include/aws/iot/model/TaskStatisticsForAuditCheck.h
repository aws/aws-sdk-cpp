...
class TaskStatisticsForAuditCheck {
 public:
  ...
  inline void SetTotalFindingsCount(long long value) {
    m_totalFindingsCountHasBeenSet = true;
    m_totalFindingsCount = value;
  }
  inline TaskStatisticsForAuditCheck& WithTotalFindingsCount(long long value) {
    SetTotalFindingsCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFailedFindingsCount(long long value) {
    m_failedFindingsCountHasBeenSet = true;
    m_failedFindingsCount = value;
  }
  inline TaskStatisticsForAuditCheck& WithFailedFindingsCount(long long value) {
    SetFailedFindingsCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSucceededFindingsCount(long long value) {
    m_succeededFindingsCountHasBeenSet = true;
    m_succeededFindingsCount = value;
  }
  inline TaskStatisticsForAuditCheck& WithSucceededFindingsCount(long long value) {
    SetSucceededFindingsCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSkippedFindingsCount(long long value) {
    m_skippedFindingsCountHasBeenSet = true;
    m_skippedFindingsCount = value;
  }
  inline TaskStatisticsForAuditCheck& WithSkippedFindingsCount(long long value) {
    SetSkippedFindingsCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCanceledFindingsCount(long long value) {
    m_canceledFindingsCountHasBeenSet = true;
    m_canceledFindingsCount = value;
  }
  inline TaskStatisticsForAuditCheck& WithCanceledFindingsCount(long long value) {
    SetCanceledFindingsCount(value);
    return *this;
  }
  ///@}
 private:
