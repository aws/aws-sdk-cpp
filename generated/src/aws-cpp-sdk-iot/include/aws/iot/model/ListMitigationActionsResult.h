...
namespace Model
{
  ...
  {
  public:
    AWS_IOT_API ListMitigationActionsResult();
    ...
    inline ListMitigationActionsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}
    inline ListMitigationActionsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}
    inline ListMitigationActionsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
    ///@}
  private:
