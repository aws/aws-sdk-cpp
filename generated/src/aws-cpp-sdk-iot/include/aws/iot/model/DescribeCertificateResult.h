...
class DescribeCertificateResult {
 public:
  ...
  void SetCertificateDescription(CertificateDescriptionT&& value) {
    m_certificateDescriptionHasBeenSet = true;
    m_certificateDescription = std::forward<CertificateDescriptionT>(value);
  }
  template <typename CertificateDescriptionT = CertificateDescription>
  DescribeCertificateResult& WithCertificateDescription(CertificateDescriptionT&& value) {
    SetCertificateDescription(std::forward<CertificateDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeCertificateResult& WithRequestId(RequestIdT&& value) {
