...
namespace Model
{
  ...
  public:
    ...
    template<typename SecurityProfileNameT = Aws::String>
    DescribeSecurityProfileResult& WithSecurityProfileName(SecurityProfileNameT&& value) { SetSecurityProfileName(std::forward<SecurityProfileNameT>(value)); return *this;}
    ///@}
    ...
    template<typename SecurityProfileArnT = Aws::String>
    DescribeSecurityProfileResult& WithSecurityProfileArn(SecurityProfileArnT&& value) { SetSecurityProfileArn(std::forward<SecurityProfileArnT>(value)); return *this;}
    ///@}
    ...
    template<typename SecurityProfileDescriptionT = Aws::String>
    DescribeSecurityProfileResult& WithSecurityProfileDescription(SecurityProfileDescriptionT&& value) { SetSecurityProfileDescription(std::forward<SecurityProfileDescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename BehaviorsT = Aws::Vector<Behavior>>
    DescribeSecurityProfileResult& WithBehaviors(BehaviorsT&& value) { SetBehaviors(std::forward<BehaviorsT>(value)); return *this;}
    template<typename BehaviorsT = Behavior>
    DescribeSecurityProfileResult& AddBehaviors(BehaviorsT&& value) { m_behaviorsHasBeenSet = true; m_behaviors.emplace_back(std::forward<BehaviorsT>(value)); return *this; }
    ///@}
    ...
    template<typename AlertTargetsT = Aws::Map<AlertTargetType, AlertTarget>>
    DescribeSecurityProfileResult& WithAlertTargets(AlertTargetsT&& value) { SetAlertTargets(std::forward<AlertTargetsT>(value)); return *this;}
    inline DescribeSecurityProfileResult& AddAlertTargets(AlertTargetType key, AlertTarget value) {
    ...
    template<typename AdditionalMetricsToRetainV2T = Aws::Vector<MetricToRetain>>
    DescribeSecurityProfileResult& WithAdditionalMetricsToRetainV2(AdditionalMetricsToRetainV2T&& value) { SetAdditionalMetricsToRetainV2(std::forward<AdditionalMetricsToRetainV2T>(value)); return *this;}
    template<typename AdditionalMetricsToRetainV2T = MetricToRetain>
    DescribeSecurityProfileResult& AddAdditionalMetricsToRetainV2(AdditionalMetricsToRetainV2T&& value) { m_additionalMetricsToRetainV2HasBeenSet = true; m_additionalMetricsToRetainV2.emplace_back(std::forward<AdditionalMetricsToRetainV2T>(value)); return *this; }
    ///@}
    ...
    template<typename CreationDateT = Aws::Utils::DateTime>
    DescribeSecurityProfileResult& WithCreationDate(CreationDateT&& value) { SetCreationDate(std::forward<CreationDateT>(value)); return *this;}
    ///@}
    ...
    template<typename LastModifiedDateT = Aws::Utils::DateTime>
    DescribeSecurityProfileResult& WithLastModifiedDate(LastModifiedDateT&& value) { SetLastModifiedDate(std::forward<LastModifiedDateT>(value)); return *this;}
    ///@}
    ...
    template<typename MetricsExportConfigT = MetricsExportConfig>
    DescribeSecurityProfileResult& WithMetricsExportConfig(MetricsExportConfigT&& value) { SetMetricsExportConfig(std::forward<MetricsExportConfigT>(value)); return *this;}
    ///@}
