...
class ListMitigationActionsRequest : public IoTRequest {
 public:
  ...
  inline void SetActionType(MitigationActionType value) {
    m_actionTypeHasBeenSet = true;
    m_actionType = value;
  }
  inline ListMitigationActionsRequest& WithActionType(MitigationActionType value) {
    SetActionType(value);
    return *this;
  }
  ///@}
  ...
  inline ListMitigationActionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
