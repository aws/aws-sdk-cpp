...
class ServerCertificateSummary {
 public:
  ...
  inline void SetServerCertificateStatus(ServerCertificateStatus value) {
    m_serverCertificateStatusHasBeenSet = true;
    m_serverCertificateStatus = value;
  }
  inline ServerCertificateSummary& WithServerCertificateStatus(ServerCertificateStatus value) {
    SetServerCertificateStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetServerCertificateStatusDetail(ServerCertificateStatusDetailT&& value) {
    ...
    m_serverCertificateStatusDetail = std::forward<ServerCertificateStatusDetailT>(value);
  }
  template <typename ServerCertificateStatusDetailT = Aws::String>
  ServerCertificateSummary& WithServerCertificateStatusDetail(ServerCertificateStatusDetailT&& value) {
    SetServerCertificateStatusDetail(std::forward<ServerCertificateStatusDetailT>(value));
    return *this;
  }
  ///@}
 private:
