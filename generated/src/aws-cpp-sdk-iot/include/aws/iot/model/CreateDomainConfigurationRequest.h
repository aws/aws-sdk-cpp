...
class CreateDomainConfigurationRequest : public IoTRequest {
 public:
  ...
  void SetServerCertificateArns(ServerCertificateArnsT&& value) {
    m_serverCertificateArnsHasBeenSet = true;
    m_serverCertificateArns = std::forward<ServerCertificateArnsT>(value);
  }
  template <typename ServerCertificateArnsT = Aws::Vector<Aws::String>>
  CreateDomainConfigurationRequest& WithServerCertificateArns(ServerCertificateArnsT&& value) {
    SetServerCertificateArns(std::forward<ServerCertificateArnsT>(value));
    return *this;
  }
  ...
  CreateDomainConfigurationRequest& AddServerCertificateArns(ServerCertificateArnsT&& value) {
    m_serverCertificateArnsHasBeenSet = true;
    m_serverCertificateArns.emplace_back(std::forward<ServerCertificateArnsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetValidationCertificateArn(ValidationCertificateArnT&& value) {
    m_validationCertificateArnHasBeenSet = true;
    m_validationCertificateArn = std::forward<ValidationCertificateArnT>(value);
  }
  template <typename ValidationCertificateArnT = Aws::String>
  CreateDomainConfigurationRequest& WithValidationCertificateArn(ValidationCertificateArnT&& value) {
    SetValidationCertificateArn(std::forward<ValidationCertificateArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateDomainConfigurationRequest& WithServiceType(ServiceType value) {
  ...
  inline CreateDomainConfigurationRequest& WithAuthenticationType(AuthenticationType value) {
  ...
  inline CreateDomainConfigurationRequest& WithApplicationProtocol(ApplicationProtocol value) {
