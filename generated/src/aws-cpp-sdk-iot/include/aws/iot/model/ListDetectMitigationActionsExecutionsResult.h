...
class ListDetectMitigationActionsExecutionsResult {
 public:
  ...
  AWS_IOT_API ListDetectMitigationActionsExecutionsResult& operator=(
  ...
  template <typename ActionsExecutionsT = Aws::Vector<DetectMitigationActionExecution>>
  ListDetectMitigationActionsExecutionsResult& WithActionsExecutions(ActionsExecutionsT&& value) {
  ...
  ListDetectMitigationActionsExecutionsResult& AddActionsExecutions(ActionsExecutionsT&& value) {
    m_actionsExecutionsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListDetectMitigationActionsExecutionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDetectMitigationActionsExecutionsResult& WithRequestId(RequestIdT&& value) {
