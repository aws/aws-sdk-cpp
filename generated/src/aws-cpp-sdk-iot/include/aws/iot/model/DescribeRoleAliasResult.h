...
class DescribeRoleAliasResult {
 public:
  ...
  void SetRoleAliasDescription(RoleAliasDescriptionT&& value) {
    m_roleAliasDescriptionHasBeenSet = true;
    m_roleAliasDescription = std::forward<RoleAliasDescriptionT>(value);
  }
  template <typename RoleAliasDescriptionT = RoleAliasDescription>
  DescribeRoleAliasResult& WithRoleAliasDescription(RoleAliasDescriptionT&& value) {
    SetRoleAliasDescription(std::forward<RoleAliasDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeRoleAliasResult& WithRequestId(RequestIdT&& value) {
