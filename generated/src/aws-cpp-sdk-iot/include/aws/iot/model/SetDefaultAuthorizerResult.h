...
class SetDefaultAuthorizerResult {
 public:
  ...
  template <typename AuthorizerNameT = Aws::String>
  SetDefaultAuthorizerResult& WithAuthorizerName(AuthorizerNameT&& value) {
  ...
  template <typename AuthorizerArnT = Aws::String>
  SetDefaultAuthorizerResult& WithAuthorizerArn(AuthorizerArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  SetDefaultAuthorizerResult& WithRequestId(RequestIdT&& value) {
