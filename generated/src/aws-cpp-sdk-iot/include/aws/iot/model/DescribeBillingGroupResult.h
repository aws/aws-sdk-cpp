...
class DescribeBillingGroupResult {
 public:
  ...
  template <typename BillingGroupNameT = Aws::String>
  DescribeBillingGroupResult& WithBillingGroupName(BillingGroupNameT&& value) {
  ...
  void SetBillingGroupId(BillingGroupIdT&& value) {
    ...
    m_billingGroupId = std::forward<BillingGroupIdT>(value);
  }
  template <typename BillingGroupIdT = Aws::String>
  DescribeBillingGroupResult& WithBillingGroupId(BillingGroupIdT&& value) {
    SetBillingGroupId(std::forward<BillingGroupIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename BillingGroupArnT = Aws::String>
  DescribeBillingGroupResult& WithBillingGroupArn(BillingGroupArnT&& value) {
  ...
  inline DescribeBillingGroupResult& WithVersion(long long value) {
    SetVersion(value);
    return *this;
  }
  ///@}
  ...
  void SetBillingGroupProperties(BillingGroupPropertiesT&& value) {
    m_billingGroupPropertiesHasBeenSet = true;
    m_billingGroupProperties = std::forward<BillingGroupPropertiesT>(value);
  }
  template <typename BillingGroupPropertiesT = BillingGroupProperties>
  DescribeBillingGroupResult& WithBillingGroupProperties(BillingGroupPropertiesT&& value) {
    SetBillingGroupProperties(std::forward<BillingGroupPropertiesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBillingGroupMetadata(BillingGroupMetadataT&& value) {
    m_billingGroupMetadataHasBeenSet = true;
    m_billingGroupMetadata = std::forward<BillingGroupMetadataT>(value);
  }
  template <typename BillingGroupMetadataT = BillingGroupMetadata>
  DescribeBillingGroupResult& WithBillingGroupMetadata(BillingGroupMetadataT&& value) {
    SetBillingGroupMetadata(std::forward<BillingGroupMetadataT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeBillingGroupResult& WithRequestId(RequestIdT&& value) {
