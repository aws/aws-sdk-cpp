...
class ListAuditMitigationActionsExecutionsResult {
 public:
  ...
  void SetActionsExecutions(ActionsExecutionsT&& value) {
    m_actionsExecutionsHasBeenSet = true;
    m_actionsExecutions = std::forward<ActionsExecutionsT>(value);
  }
  template <typename ActionsExecutionsT = Aws::Vector<AuditMitigationActionExecutionMetadata>>
  ListAuditMitigationActionsExecutionsResult& WithActionsExecutions(ActionsExecutionsT&& value) {
    SetActionsExecutions(std::forward<ActionsExecutionsT>(value));
    return *this;
  }
  template <typename ActionsExecutionsT = AuditMitigationActionExecutionMetadata>
  ListAuditMitigationActionsExecutionsResult& AddActionsExecutions(ActionsExecutionsT&& value) {
    m_actionsExecutionsHasBeenSet = true;
    m_actionsExecutions.emplace_back(std::forward<ActionsExecutionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAuditMitigationActionsExecutionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAuditMitigationActionsExecutionsResult& WithRequestId(RequestIdT&& value) {
