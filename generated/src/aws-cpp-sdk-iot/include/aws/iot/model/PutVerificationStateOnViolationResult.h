...
namespace Model
{
  ...
  {
  public:
    AWS_IOT_API PutVerificationStateOnViolationResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    PutVerificationStateOnViolationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
