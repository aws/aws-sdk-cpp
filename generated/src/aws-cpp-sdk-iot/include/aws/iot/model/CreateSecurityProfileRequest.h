...
class CreateSecurityProfileRequest : public IoTRequest {
 public:
  ...
  template <typename SecurityProfileDescriptionT = Aws::String>
  CreateSecurityProfileRequest& WithSecurityProfileDescription(SecurityProfileDescriptionT&& value) {
  ...
  template <typename BehaviorsT = Aws::Vector<Behavior>>
  CreateSecurityProfileRequest& WithBehaviors(BehaviorsT&& value) {
    SetBehaviors(std::forward<BehaviorsT>(value));
    return *this;
  }
  template <typename BehaviorsT = Behavior>
  CreateSecurityProfileRequest& AddBehaviors(BehaviorsT&& value) {
    m_behaviorsHasBeenSet = true;
  ...
  template <typename AlertTargetsT = Aws::Map<AlertTargetType, AlertTarget>>
  CreateSecurityProfileRequest& WithAlertTargets(AlertTargetsT&& value) {
  ...
  template <typename AdditionalMetricsToRetainV2T = Aws::Vector<MetricToRetain>>
  CreateSecurityProfileRequest& WithAdditionalMetricsToRetainV2(AdditionalMetricsToRetainV2T&& value) {
  ...
  CreateSecurityProfileRequest& AddAdditionalMetricsToRetainV2(AdditionalMetricsToRetainV2T&& value) {
    m_additionalMetricsToRetainV2HasBeenSet = true;
  ...
  CreateSecurityProfileRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename MetricsExportConfigT = MetricsExportConfig>
  CreateSecurityProfileRequest& WithMetricsExportConfig(MetricsExportConfigT&& value) {
