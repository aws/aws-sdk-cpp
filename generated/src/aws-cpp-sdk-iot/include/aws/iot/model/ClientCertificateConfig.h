...
class ClientCertificateConfig {
 public:
  ...
  void SetClientCertificateCallbackArn(ClientCertificateCallbackArnT&& value) {
    m_clientCertificateCallbackArnHasBeenSet = true;
    m_clientCertificateCallbackArn = std::forward<ClientCertificateCallbackArnT>(value);
  }
  template <typename ClientCertificateCallbackArnT = Aws::String>
  ClientCertificateConfig& WithClientCertificateCallbackArn(ClientCertificateCallbackArnT&& value) {
    SetClientCertificateCallbackArn(std::forward<ClientCertificateCallbackArnT>(value));
    return *this;
  }
  ///@}
 private:
