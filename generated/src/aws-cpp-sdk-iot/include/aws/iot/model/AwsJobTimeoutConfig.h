 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/iot-2015-05-28/AwsJobTimeoutConfig">AWS
 * API Reference</a></p>
 */
class AwsJobTimeoutConfig {
 public:
  AWS_IOT_API AwsJobTimeoutConfig() = default;
  AWS_IOT_API AwsJobTimeoutConfig(Aws::Utils::Json::JsonView jsonValue);
  AWS_IOT_API AwsJobTimeoutConfig& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  inline void SetInProgressTimeoutInMinutes(long long value) {
    m_inProgressTimeoutInMinutesHasBeenSet = true;
    m_inProgressTimeoutInMinutes = value;
  }
  inline AwsJobTimeoutConfig& WithInProgressTimeoutInMinutes(long long value) {
    SetInProgressTimeoutInMinutes(value);
    return *this;
  }
  ///@}
 private:
