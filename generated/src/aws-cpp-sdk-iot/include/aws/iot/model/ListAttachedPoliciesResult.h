...
class ListAttachedPoliciesResult {
 public:
  ...
  template <typename PoliciesT = Aws::Vector<Policy>>
  ListAttachedPoliciesResult& WithPolicies(PoliciesT&& value) {
    SetPolicies(std::forward<PoliciesT>(value));
    return *this;
  }
  template <typename PoliciesT = Policy>
  ListAttachedPoliciesResult& AddPolicies(PoliciesT&& value) {
    m_policiesHasBeenSet = true;
  ...
  template <typename NextMarkerT = Aws::String>
  ListAttachedPoliciesResult& WithNextMarker(NextMarkerT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAttachedPoliciesResult& WithRequestId(RequestIdT&& value) {
