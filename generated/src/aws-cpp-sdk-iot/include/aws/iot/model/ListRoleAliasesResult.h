...
class ListRoleAliasesResult {
 public:
  ...
  void SetRoleAliases(RoleAliasesT&& value) {
    m_roleAliasesHasBeenSet = true;
    m_roleAliases = std::forward<RoleAliasesT>(value);
  }
  template <typename RoleAliasesT = Aws::Vector<Aws::String>>
  ListRoleAliasesResult& WithRoleAliases(RoleAliasesT&& value) {
    SetRoleAliases(std::forward<RoleAliasesT>(value));
    return *this;
  }
  template <typename RoleAliasesT = Aws::String>
  ListRoleAliasesResult& AddRoleAliases(RoleAliasesT&& value) {
    m_roleAliasesHasBeenSet = true;
    m_roleAliases.emplace_back(std::forward<RoleAliasesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextMarkerT = Aws::String>
  ListRoleAliasesResult& WithNextMarker(NextMarkerT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListRoleAliasesResult& WithRequestId(RequestIdT&& value) {
