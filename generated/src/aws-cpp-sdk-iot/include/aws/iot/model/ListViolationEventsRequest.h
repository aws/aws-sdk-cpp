...
class ListViolationEventsRequest : public IoTRequest {
 public:
  ...
  inline ListViolationEventsRequest& WithBehaviorCriteriaType(BehaviorCriteriaType value) {
  ...
  inline ListViolationEventsRequest& WithListSuppressedAlerts(bool value) {
  ...
  inline ListViolationEventsRequest& WithVerificationState(VerificationState value) {
  ...
  inline ListViolationEventsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
