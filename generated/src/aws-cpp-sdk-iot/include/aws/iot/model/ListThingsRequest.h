...
class ListThingsRequest : public IoTRequest {
 public:
  ...
  inline ListThingsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUsePrefixAttributeValue(bool value) {
    m_usePrefixAttributeValueHasBeenSet = true;
    m_usePrefixAttributeValue = value;
  }
  inline ListThingsRequest& WithUsePrefixAttributeValue(bool value) {
    SetUsePrefixAttributeValue(value);
    return *this;
  }
  ///@}
 private:
