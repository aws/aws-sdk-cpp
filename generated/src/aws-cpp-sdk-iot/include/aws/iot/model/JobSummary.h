...
class JobSummary {
 public:
  ...
  inline JobSummary& WithTargetSelection(TargetSelection value) {
  ...
  inline void SetIsConcurrent(bool value) {
    m_isConcurrentHasBeenSet = true;
    m_isConcurrent = value;
  }
  inline JobSummary& WithIsConcurrent(bool value) {
    SetIsConcurrent(value);
    return *this;
  }
  ///@}
 private:
