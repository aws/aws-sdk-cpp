...
class UpdateDynamicThingGroupResult {
 public:
  AWS_IOT_API UpdateDynamicThingGroupResult() = default;
  ...
  inline UpdateDynamicThingGroupResult& WithVersion(long long value) {
    SetVersion(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  UpdateDynamicThingGroupResult& WithRequestId(RequestIdT&& value) {
