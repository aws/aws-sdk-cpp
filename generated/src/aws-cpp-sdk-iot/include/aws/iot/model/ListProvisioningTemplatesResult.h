...
class ListProvisioningTemplatesResult {
 public:
  ...
  template <typename TemplatesT = Aws::Vector<ProvisioningTemplateSummary>>
  ListProvisioningTemplatesResult& WithTemplates(TemplatesT&& value) {
    SetTemplates(std::forward<TemplatesT>(value));
    return *this;
  }
  template <typename TemplatesT = ProvisioningTemplateSummary>
  ListProvisioningTemplatesResult& AddTemplates(TemplatesT&& value) {
    m_templatesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListProvisioningTemplatesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListProvisioningTemplatesResult& WithRequestId(RequestIdT&& value) {
