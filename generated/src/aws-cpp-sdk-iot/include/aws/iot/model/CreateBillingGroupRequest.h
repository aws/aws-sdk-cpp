...
class CreateBillingGroupRequest : public IoTRequest {
 public:
  ...
  template <typename BillingGroupNameT = Aws::String>
  CreateBillingGroupRequest& WithBillingGroupName(BillingGroupNameT&& value) {
  ...
  template <typename BillingGroupPropertiesT = BillingGroupProperties>
  CreateBillingGroupRequest& WithBillingGroupProperties(BillingGroupPropertiesT&& value) {
  ...
  CreateBillingGroupRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
