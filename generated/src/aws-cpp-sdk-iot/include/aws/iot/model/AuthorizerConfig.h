...
class AuthorizerConfig {
 public:
  ...
  void SetDefaultAuthorizerName(DefaultAuthorizerNameT&& value) {
    ...
    m_defaultAuthorizerName = std::forward<DefaultAuthorizerNameT>(value);
  }
  template <typename DefaultAuthorizerNameT = Aws::String>
  AuthorizerConfig& WithDefaultAuthorizerName(DefaultAuthorizerNameT&& value) {
    SetDefaultAuthorizerName(std::forward<DefaultAuthorizerNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAllowAuthorizerOverride(bool value) {
    m_allowAuthorizerOverrideHasBeenSet = true;
    m_allowAuthorizerOverride = value;
  }
  inline AuthorizerConfig& WithAllowAuthorizerOverride(bool value) {
    SetAllowAuthorizerOverride(value);
    return *this;
  }
  ///@}
 private:
