 ...
 * API Reference</a></p>
 */
class ListPoliciesRequest : public IoTRequest {
 public:
  AWS_IOT_API ListPoliciesRequest() = default;
  ...
  inline ListPoliciesRequest& WithPageSize(int value) {
    SetPageSize(value);
    return *this;
  }
  ///@}
  ...
  inline ListPoliciesRequest& WithAscendingOrder(bool value) {
