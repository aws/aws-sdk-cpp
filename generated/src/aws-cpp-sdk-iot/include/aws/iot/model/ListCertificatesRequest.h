...
class ListCertificatesRequest : public IoTRequest {
 public:
  AWS_IOT_API ListCertificatesRequest() = default;
  ...
  inline ListCertificatesRequest& WithPageSize(int value) {
    SetPageSize(value);
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  ListCertificatesRequest& WithMarker(MarkerT&& value) {
  ...
  inline ListCertificatesRequest& WithAscendingOrder(bool value) {
