...
class ListAuthorizersRequest : public IoTRequest {
 public:
  ...
  inline ListAuthorizersRequest& WithPageSize(int value) {
    SetPageSize(value);
    return *this;
  }
  ///@}
  ...
  inline ListAuthorizersRequest& WithAscendingOrder(bool value) {
  ...
  inline ListAuthorizersRequest& WithStatus(AuthorizerStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
