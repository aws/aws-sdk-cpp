...
class TransferCertificateRequest : public IoTRequest {
 public:
  ...
  template <typename CertificateIdT = Aws::String>
  TransferCertificateRequest& WithCertificateId(CertificateIdT&& value) {
  ...
  void SetTargetAwsAccount(TargetAwsAccountT&& value) {
    m_targetAwsAccountHasBeenSet = true;
    m_targetAwsAccount = std::forward<TargetAwsAccountT>(value);
  }
  template <typename TargetAwsAccountT = Aws::String>
  TransferCertificateRequest& WithTargetAwsAccount(TargetAwsAccountT&& value) {
    SetTargetAwsAccount(std::forward<TargetAwsAccountT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TransferMessageT = Aws::String>
  TransferCertificateRequest& WithTransferMessage(TransferMessageT&& value) {
