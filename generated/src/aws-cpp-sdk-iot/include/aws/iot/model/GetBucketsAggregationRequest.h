...
class GetBucketsAggregationRequest : public IoTRequest {
 public:
  ...
  void SetBucketsAggregationType(BucketsAggregationTypeT&& value) {
    m_bucketsAggregationTypeHasBeenSet = true;
    m_bucketsAggregationType = std::forward<BucketsAggregationTypeT>(value);
  }
  template <typename BucketsAggregationTypeT = BucketsAggregationType>
  GetBucketsAggregationRequest& WithBucketsAggregationType(BucketsAggregationTypeT&& value) {
    SetBucketsAggregationType(std::forward<BucketsAggregationTypeT>(value));
    return *this;
  }
  ///@}
 private:
