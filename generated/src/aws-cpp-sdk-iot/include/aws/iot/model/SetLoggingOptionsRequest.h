...
class SetLoggingOptionsRequest : public IoTRequest {
 public:
  ...
  void SetLoggingOptionsPayload(LoggingOptionsPayloadT&& value) {
    m_loggingOptionsPayloadHasBeenSet = true;
    m_loggingOptionsPayload = std::forward<LoggingOptionsPayloadT>(value);
  }
  template <typename LoggingOptionsPayloadT = LoggingOptionsPayload>
  SetLoggingOptionsRequest& WithLoggingOptionsPayload(LoggingOptionsPayloadT&& value) {
    SetLoggingOptionsPayload(std::forward<LoggingOptionsPayloadT>(value));
    return *this;
  }
  ///@}
 private:
