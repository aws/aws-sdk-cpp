...
namespace Model
{
  ...
  {
  public:
    AWS_IOT_API ClearDefaultAuthorizerResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    ClearDefaultAuthorizerResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
