...
class ListManagedJobTemplatesRequest : public IoTRequest {
 public:
  ...
  template <typename TemplateNameT = Aws::String>
  ListManagedJobTemplatesRequest& WithTemplateName(TemplateNameT&& value) {
  ...
  inline ListManagedJobTemplatesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListManagedJobTemplatesRequest& WithNextToken(NextTokenT&& value) {
