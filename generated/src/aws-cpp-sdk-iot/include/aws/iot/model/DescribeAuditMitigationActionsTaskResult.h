...
class DescribeAuditMitigationActionsTaskResult {
 public:
  ...
  inline void SetTaskStatus(AuditMitigationActionsTaskStatus value) {
    m_taskStatusHasBeenSet = true;
    m_taskStatus = value;
  }
  inline DescribeAuditMitigationActionsTaskResult& WithTaskStatus(AuditMitigationActionsTaskStatus value) {
    SetTaskStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetTaskStatistics(TaskStatisticsT&& value) {
    ...
    m_taskStatistics = std::forward<TaskStatisticsT>(value);
  }
  template <typename TaskStatisticsT = Aws::Map<Aws::String, TaskStatisticsForAuditCheck>>
  DescribeAuditMitigationActionsTaskResult& WithTaskStatistics(TaskStatisticsT&& value) {
    SetTaskStatistics(std::forward<TaskStatisticsT>(value));
    return *this;
  }
  ...
  DescribeAuditMitigationActionsTaskResult& AddTaskStatistics(TaskStatisticsKeyT&& key, TaskStatisticsValueT&& value) {
    m_taskStatisticsHasBeenSet = true;
    m_taskStatistics.emplace(std::forward<TaskStatisticsKeyT>(key), std::forward<TaskStatisticsValueT>(value));
    return *this;
  }
  ///@}
   ...
   * checks.</p>
   */
  inline const Aws::Map<Aws::String, Aws::Vector<Aws::String>>& GetAuditCheckToActionsMapping() const {
    return m_auditCheckToActionsMapping;
  }
  ...
  void SetAuditCheckToActionsMapping(AuditCheckToActionsMappingT&& value) {
    ...
    m_auditCheckToActionsMapping = std::forward<AuditCheckToActionsMappingT>(value);
  }
  template <typename AuditCheckToActionsMappingT = Aws::Map<Aws::String, Aws::Vector<Aws::String>>>
  DescribeAuditMitigationActionsTaskResult& WithAuditCheckToActionsMapping(AuditCheckToActionsMappingT&& value) {
    SetAuditCheckToActionsMapping(std::forward<AuditCheckToActionsMappingT>(value));
    return *this;
  }
  ...
  DescribeAuditMitigationActionsTaskResult& AddAuditCheckToActionsMapping(AuditCheckToActionsMappingKeyT&& key,
                                                                          AuditCheckToActionsMappingValueT&& value) {
    m_auditCheckToActionsMappingHasBeenSet = true;
    m_auditCheckToActionsMapping.emplace(std::forward<AuditCheckToActionsMappingKeyT>(key),
                                         std::forward<AuditCheckToActionsMappingValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetActionsDefinition(ActionsDefinitionT&& value) {
    ...
    m_actionsDefinition = std::forward<ActionsDefinitionT>(value);
  }
  template <typename ActionsDefinitionT = Aws::Vector<MitigationAction>>
  DescribeAuditMitigationActionsTaskResult& WithActionsDefinition(ActionsDefinitionT&& value) {
    SetActionsDefinition(std::forward<ActionsDefinitionT>(value));
    return *this;
  }
  ...
  DescribeAuditMitigationActionsTaskResult& AddActionsDefinition(ActionsDefinitionT&& value) {
    m_actionsDefinitionHasBeenSet = true;
    m_actionsDefinition.emplace_back(std::forward<ActionsDefinitionT>(value));
    return *this;
  }
  ///@}
