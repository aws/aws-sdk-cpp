...
class ListCommandsRequest : public IoTRequest {
 public:
  ...
  inline ListCommandsRequest& WithNamespace(CommandNamespace value) {
    SetNamespace(value);
    return *this;
  }
  ///@}
  ...
  void SetCommandParameterName(CommandParameterNameT&& value) {
    m_commandParameterNameHasBeenSet = true;
    m_commandParameterName = std::forward<CommandParameterNameT>(value);
  }
  template <typename CommandParameterNameT = Aws::String>
  ListCommandsRequest& WithCommandParameterName(CommandParameterNameT&& value) {
    SetCommandParameterName(std::forward<CommandParameterNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListCommandsRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
