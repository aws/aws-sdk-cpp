...
class ServerCertificateConfig {
 public:
  ...
  inline void SetEnableOCSPCheck(bool value) {
    m_enableOCSPCheckHasBeenSet = true;
    m_enableOCSPCheck = value;
  }
  inline ServerCertificateConfig& WithEnableOCSPCheck(bool value) {
    SetEnableOCSPCheck(value);
    return *this;
  }
  ///@}
  ...
  void SetOcspLambdaArn(OcspLambdaArnT&& value) {
    m_ocspLambdaArnHasBeenSet = true;
    m_ocspLambdaArn = std::forward<OcspLambdaArnT>(value);
  }
  template <typename OcspLambdaArnT = Aws::String>
  ServerCertificateConfig& WithOcspLambdaArn(OcspLambdaArnT&& value) {
    SetOcspLambdaArn(std::forward<OcspLambdaArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOcspAuthorizedResponderArn(OcspAuthorizedResponderArnT&& value) {
    ...
    m_ocspAuthorizedResponderArn = std::forward<OcspAuthorizedResponderArnT>(value);
  }
  template <typename OcspAuthorizedResponderArnT = Aws::String>
  ServerCertificateConfig& WithOcspAuthorizedResponderArn(OcspAuthorizedResponderArnT&& value) {
    SetOcspAuthorizedResponderArn(std::forward<OcspAuthorizedResponderArnT>(value));
    return *this;
  }
  ///@}
 private:
