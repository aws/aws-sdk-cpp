...
namespace IoT
{
const size_t IoTEndpointRules::RulesBlobStrLen = 4373;
const size_t IoTEndpointRules::RulesBlobSize = 4374;
...
't','p','s',':','/','/','i','o','t','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i',
