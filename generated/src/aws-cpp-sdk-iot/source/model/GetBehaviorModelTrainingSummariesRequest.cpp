...
Aws::String GetBehaviorModelTrainingSummariesRequest::SerializePayload() const { return {}; }

void GetBehaviorModelTrainingSummariesRequest::AddQueryStringParameters(URI& uri) const {
  Aws::StringStream ss;
