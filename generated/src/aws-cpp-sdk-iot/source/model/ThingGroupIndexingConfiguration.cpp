...
ThingGroupIndexingConfiguration::ThingGroupIndexingConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
ThingGroupIndexingConfiguration& ThingGroupIndexingConfiguration::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("thingGroupIndexingMode")) {
    m_thingGroupIndexingMode =
        ThingGroupIndexingModeMapper::GetThingGroupIndexingModeForName(jsonValue.GetString("thingGroupIndexingMode"));
