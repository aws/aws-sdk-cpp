...
ThingGroupMetadata::ThingGroupMetadata(JsonView jsonValue) { *this = jsonValue; }
...
ThingGroupMetadata& ThingGroupMetadata::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("rootToParentThingGroups")) {
    ...
    for (unsigned rootToParentThingGroupsIndex = 0; rootToParentThingGroupsIndex < rootToParentThingGroupsJsonList.GetLength();
         ++rootToParentThingGroupsIndex) {
...
JsonValue ThingGroupMetadata::Jsonize() const {
  ...
  if (m_rootToParentThingGroupsHasBeenSet) {
    ...
    for (unsigned rootToParentThingGroupsIndex = 0; rootToParentThingGroupsIndex < rootToParentThingGroupsJsonList.GetLength();
         ++rootToParentThingGroupsIndex) {
      rootToParentThingGroupsJsonList[rootToParentThingGroupsIndex].AsObject(
          m_rootToParentThingGroups[rootToParentThingGroupsIndex].Jsonize());
    }
