...
Aws::String UpdateAccountAuditConfigurationRequest::SerializePayload() const {
  ...
  if (m_auditNotificationTargetConfigurationsHasBeenSet) {
    ...
    for (auto& auditNotificationTargetConfigurationsItem : m_auditNotificationTargetConfigurations) {
      auditNotificationTargetConfigurationsJsonMap.WithObject(
          AuditNotificationTypeMapper::GetNameForAuditNotificationType(auditNotificationTargetConfigurationsItem.first),
          auditNotificationTargetConfigurationsItem.second.Jsonize());
    }
