...
ListSecurityProfilesForTargetResult& ListSecurityProfilesForTargetResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("securityProfileTargetMappings")) {
    ...
    for (unsigned securityProfileTargetMappingsIndex = 0;
         securityProfileTargetMappingsIndex < securityProfileTargetMappingsJsonList.GetLength(); ++securityProfileTargetMappingsIndex) {
    ...
    m_securityProfileTargetMappingsHasBeenSet = true;
  }
