...
ListDomainConfigurationsResult::ListDomainConfigurationsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListDomainConfigurationsResult& ListDomainConfigurationsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("domainConfigurations")) {
    ...
    for (unsigned domainConfigurationsIndex = 0; domainConfigurationsIndex < domainConfigurationsJsonList.GetLength();
         ++domainConfigurationsIndex) {
