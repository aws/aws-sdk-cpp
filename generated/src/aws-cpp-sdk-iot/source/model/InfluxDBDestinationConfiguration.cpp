...
InfluxDBDestinationConfiguration::InfluxDBDestinationConfiguration(JsonView jsonValue) { *this = jsonValue; }

InfluxDBDestinationConfiguration& InfluxDBDestinationConfiguration::operator=(JsonView jsonValue) {
...
JsonValue InfluxDBDestinationConfiguration::Jsonize() const {
  JsonValue payload;
