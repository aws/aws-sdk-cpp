...
Aws::String UpdateEncryptionConfigurationRequest::SerializePayload() const {
  JsonValue payload;
  ...
  if (m_kmsAccessRoleArnHasBeenSet) {
    payload.WithString("kmsAccessRoleArn", m_kmsAccessRoleArn);
  }
