...
ThingIndexingConfiguration::ThingIndexingConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
ThingIndexingConfiguration& ThingIndexingConfiguration::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("thingConnectivityIndexingMode")) {
    m_thingConnectivityIndexingMode =
        ThingConnectivityIndexingModeMapper::GetThingConnectivityIndexingModeForName(jsonValue.GetString("thingConnectivityIndexingMode"));
    m_thingConnectivityIndexingModeHasBeenSet = true;
  }
  if (jsonValue.ValueExists("deviceDefenderIndexingMode")) {
    m_deviceDefenderIndexingMode =
        DeviceDefenderIndexingModeMapper::GetDeviceDefenderIndexingModeForName(jsonValue.GetString("deviceDefenderIndexingMode"));
    m_deviceDefenderIndexingModeHasBeenSet = true;
  }
  if (jsonValue.ValueExists("namedShadowIndexingMode")) {
    m_namedShadowIndexingMode =
        NamedShadowIndexingModeMapper::GetNamedShadowIndexingModeForName(jsonValue.GetString("namedShadowIndexingMode"));
...
JsonValue ThingIndexingConfiguration::Jsonize() const {
  ...
  if (m_thingConnectivityIndexingModeHasBeenSet) {
    payload.WithString("thingConnectivityIndexingMode",
                       ThingConnectivityIndexingModeMapper::GetNameForThingConnectivityIndexingMode(m_thingConnectivityIndexingMode));
  }

  if (m_deviceDefenderIndexingModeHasBeenSet) {
    payload.WithString("deviceDefenderIndexingMode",
                       DeviceDefenderIndexingModeMapper::GetNameForDeviceDefenderIndexingMode(m_deviceDefenderIndexingMode));
  }

  if (m_namedShadowIndexingModeHasBeenSet) {
    payload.WithString("namedShadowIndexingMode",
                       NamedShadowIndexingModeMapper::GetNameForNamedShadowIndexingMode(m_namedShadowIndexingMode));
  }
