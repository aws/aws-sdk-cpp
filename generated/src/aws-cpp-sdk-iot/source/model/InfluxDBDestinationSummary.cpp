...
InfluxDBDestinationSummary::InfluxDBDestinationSummary(JsonView jsonValue) { *this = jsonValue; }

InfluxDBDestinationSummary& InfluxDBDestinationSummary::operator=(JsonView jsonValue) {
...
JsonValue InfluxDBDestinationSummary::Jsonize() const {
  JsonValue payload;
