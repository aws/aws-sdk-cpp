...
class AWS_REPOSTSPACE_API RepostspaceClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  RepostspaceClient(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<RepostspaceEndpointProviderBase> endpointProvider = nullptr,
      const Aws::repostspace::RepostspaceClientConfiguration& clientConfiguration = Aws::repostspace::RepostspaceClientConfiguration());
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchAddChannelRoleToAccessorsOutcome BatchAddChannelRoleToAccessors(
      const Model::BatchAddChannelRoleToAccessorsRequest& request) const;

  /**
   * A Callable wrapper for BatchAddChannelRoleToAccessors that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename BatchAddChannelRoleToAccessorsRequestT = Model::BatchAddChannelRoleToAccessorsRequest>
  Model::BatchAddChannelRoleToAccessorsOutcomeCallable BatchAddChannelRoleToAccessorsCallable(
      const BatchAddChannelRoleToAccessorsRequestT& request) const {
    return SubmitCallable(&RepostspaceClient::BatchAddChannelRoleToAccessors, request);
  }

  /**
   * An Async wrapper for BatchAddChannelRoleToAccessors that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename BatchAddChannelRoleToAccessorsRequestT = Model::BatchAddChannelRoleToAccessorsRequest>
  void BatchAddChannelRoleToAccessorsAsync(const BatchAddChannelRoleToAccessorsRequestT& request,
                                           const BatchAddChannelRoleToAccessorsResponseReceivedHandler& handler,
  ...
  /**
   * An Async wrapper for BatchAddRole that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename BatchAddRoleRequestT = Model::BatchAddRoleRequest>
  void BatchAddRoleAsync(const BatchAddRoleRequestT& request, const BatchAddRoleResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchRemoveChannelRoleFromAccessorsOutcome BatchRemoveChannelRoleFromAccessors(
      const Model::BatchRemoveChannelRoleFromAccessorsRequest& request) const;

  /**
   * A Callable wrapper for BatchRemoveChannelRoleFromAccessors that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename BatchRemoveChannelRoleFromAccessorsRequestT = Model::BatchRemoveChannelRoleFromAccessorsRequest>
  Model::BatchRemoveChannelRoleFromAccessorsOutcomeCallable BatchRemoveChannelRoleFromAccessorsCallable(
      const BatchRemoveChannelRoleFromAccessorsRequestT& request) const {
    return SubmitCallable(&RepostspaceClient::BatchRemoveChannelRoleFromAccessors, request);
  }

  /**
   * An Async wrapper for BatchRemoveChannelRoleFromAccessors that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename BatchRemoveChannelRoleFromAccessorsRequestT = Model::BatchRemoveChannelRoleFromAccessorsRequest>
  void BatchRemoveChannelRoleFromAccessorsAsync(const BatchRemoveChannelRoleFromAccessorsRequestT& request,
                                                const BatchRemoveChannelRoleFromAccessorsResponseReceivedHandler& handler,
                                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for BatchRemoveRole that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename BatchRemoveRoleRequestT = Model::BatchRemoveRoleRequest>
  void BatchRemoveRoleAsync(const BatchRemoveRoleRequestT& request, const BatchRemoveRoleResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeregisterAdmin that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeregisterAdminRequestT = Model::DeregisterAdminRequest>
  void DeregisterAdminAsync(const DeregisterAdminRequestT& request, const DeregisterAdminResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for RegisterAdmin that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename RegisterAdminRequestT = Model::RegisterAdminRequest>
  void RegisterAdminAsync(const RegisterAdminRequestT& request, const RegisterAdminResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for SendInvites that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename SendInvitesRequestT = Model::SendInvitesRequest>
  void SendInvitesAsync(const SendInvitesRequestT& request, const SendInvitesResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
