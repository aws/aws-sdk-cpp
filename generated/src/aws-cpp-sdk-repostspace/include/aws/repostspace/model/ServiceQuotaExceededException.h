...
namespace Model
{
   ...
   * <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/repostspace-2022-05-13/ServiceQuotaExceededException">AWS
   * API Reference</a></p>
   */
  class ServiceQuotaExceededException
  {
  public:
    AWS_REPOSTSPACE_API ServiceQuotaExceededException() = default;
    AWS_REPOSTSPACE_API ServiceQuotaExceededException(Aws::Utils::Json::JsonView jsonValue);
