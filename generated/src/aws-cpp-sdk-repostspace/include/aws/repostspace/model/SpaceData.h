...
class SpaceData {
 public:
  ...
  inline SpaceData& WithConfigurationStatus(ConfigurationStatus value) {
  ...
  inline SpaceData& WithVanityDomainStatus(VanityDomainStatus value) {
  ...
  inline SpaceData& WithTier(TierLevel value) {
    SetTier(value);
    return *this;
  }
  ///@}
  ...
  inline SpaceData& WithStorageLimit(long long value) {
  ...
  inline SpaceData& WithUserCount(int value) {
    SetUserCount(value);
    return *this;
  }
  ///@}
  ...
  inline SpaceData& WithContentSize(long long value) {
