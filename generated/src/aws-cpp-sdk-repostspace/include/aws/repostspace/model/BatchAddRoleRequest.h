...
class BatchAddRoleRequest : public RepostspaceRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "BatchAddRole"; }
  ...
  template <typename SpaceIdT = Aws::String>
  BatchAddRoleRequest& WithSpaceId(SpaceIdT&& value) {
  ...
  void SetAccessorIds(AccessorIdsT&& value) {
    m_accessorIdsHasBeenSet = true;
    m_accessorIds = std::forward<AccessorIdsT>(value);
  }
  template <typename AccessorIdsT = Aws::Vector<Aws::String>>
  BatchAddRoleRequest& WithAccessorIds(AccessorIdsT&& value) {
    SetAccessorIds(std::forward<AccessorIdsT>(value));
    return *this;
  }
  template <typename AccessorIdsT = Aws::String>
  BatchAddRoleRequest& AddAccessorIds(AccessorIdsT&& value) {
    m_accessorIdsHasBeenSet = true;
    m_accessorIds.emplace_back(std::forward<AccessorIdsT>(value));
    return *this;
  }
  ///@}
  ...
  inline BatchAddRoleRequest& WithRole(Role value) {
    SetRole(value);
    return *this;
  }
  ///@}
