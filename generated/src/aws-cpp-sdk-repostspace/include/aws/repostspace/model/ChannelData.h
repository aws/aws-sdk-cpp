...
class ChannelData {
 public:
  ...
  inline ChannelData& WithChannelStatus(ChannelStatus value) {
  ...
  inline ChannelData& WithUserCount(int value) {
    SetUserCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetGroupCount(int value) {
    m_groupCountHasBeenSet = true;
    m_groupCount = value;
  }
  inline ChannelData& WithGroupCount(int value) {
    SetGroupCount(value);
    return *this;
  }
  ///@}
