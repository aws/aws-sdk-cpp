...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/repostspace-2022-05-13/ConflictException">AWS
   * API Reference</a></p>
   */
  class ConflictException
  {
  public:
    AWS_REPOSTSPACE_API ConflictException() = default;
    AWS_REPOSTSPACE_API ConflictException(Aws::Utils::Json::JsonView jsonValue);
