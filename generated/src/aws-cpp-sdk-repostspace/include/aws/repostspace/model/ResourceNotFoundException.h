...
namespace Model
{
   ...
   * <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/repostspace-2022-05-13/ResourceNotFoundException">AWS
   * API Reference</a></p>
   */
  class ResourceNotFoundException
  {
  public:
    AWS_REPOSTSPACE_API ResourceNotFoundException() = default;
    AWS_REPOSTSPACE_API ResourceNotFoundException(Aws::Utils::Json::JsonView jsonValue);
    AWS_REPOSTSPACE_API ResourceNotFoundException& operator=(Aws::Utils::Json::JsonView jsonValue);
