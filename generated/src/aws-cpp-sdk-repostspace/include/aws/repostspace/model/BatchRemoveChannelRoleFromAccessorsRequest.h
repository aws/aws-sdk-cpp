...
namespace Model
{
  ...
  /**
   */
  class BatchRemoveChannelRoleFromAccessorsRequest : public RepostspaceRequest
  {
  public:
    AWS_REPOSTSPACE_API BatchRemoveChannelRoleFromAccessorsRequest() = default;

    // Service request name is the Operation name which will send this request out,
    // each operation should has unique request name, so that we can get operation's name from this request.
    // Note: this is not true for response, multiple operations may have the same response name,
    // so we can not get operation's name from response.
    inline virtual const char* GetServiceRequestName() const override { return "BatchRemoveChannelRoleFromAccessors"; }
    ...
    template<typename SpaceIdT = Aws::String>
    BatchRemoveChannelRoleFromAccessorsRequest& WithSpaceId(SpaceIdT&& value) { SetSpaceId(std::forward<SpaceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ChannelIdT = Aws::String>
    BatchRemoveChannelRoleFromAccessorsRequest& WithChannelId(ChannelIdT&& value) { SetChannelId(std::forward<ChannelIdT>(value)); return *this;}
    ///@}
    ...
    template<typename AccessorIdsT = Aws::Vector<Aws::String>>
    BatchRemoveChannelRoleFromAccessorsRequest& WithAccessorIds(AccessorIdsT&& value) { SetAccessorIds(std::forward<AccessorIdsT>(value)); return *this;}
    template<typename AccessorIdsT = Aws::String>
    BatchRemoveChannelRoleFromAccessorsRequest& AddAccessorIds(AccessorIdsT&& value) { m_accessorIdsHasBeenSet = true; m_accessorIds.emplace_back(std::forward<AccessorIdsT>(value)); return *this; }
    ///@}
    ...
    inline BatchRemoveChannelRoleFromAccessorsRequest& WithChannelRole(ChannelRole value) { SetChannelRole(value); return *this;}
    ///@}
  private:
