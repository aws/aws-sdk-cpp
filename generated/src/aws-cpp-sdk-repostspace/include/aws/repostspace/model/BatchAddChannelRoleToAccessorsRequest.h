...
class BatchAddChannelRoleToAccessorsRequest : public RepostspaceRequest {
 public:
  ...
  template <typename SpaceIdT = Aws::String>
  BatchAddChannelRoleToAccessorsRequest& WithSpaceId(SpaceIdT&& value) {
  ...
  template <typename ChannelIdT = Aws::String>
  BatchAddChannelRoleToAccessorsRequest& WithChannelId(ChannelIdT&& value) {
  ...
  template <typename AccessorIdsT = Aws::Vector<Aws::String>>
  BatchAddChannelRoleToAccessorsRequest& WithAccessorIds(AccessorIdsT&& value) {
    SetAccessorIds(std::forward<AccessorIdsT>(value));
    return *this;
  }
  template <typename AccessorIdsT = Aws::String>
  BatchAddChannelRoleToAccessorsRequest& AddAccessorIds(AccessorIdsT&& value) {
    m_accessorIdsHasBeenSet = true;
  ...
  inline void SetChannelRole(ChannelRole value) {
    m_channelRoleHasBeenSet = true;
    m_channelRole = value;
  }
  inline BatchAddChannelRoleToAccessorsRequest& WithChannelRole(ChannelRole value) {
    SetChannelRole(value);
    return *this;
  }
  ///@}
 private:
