...
{
const size_t RepostspaceEndpointRules::RulesBlobStrLen = 3744;
const size_t RepostspaceEndpointRules::RulesBlobSize = 3745;
...
'"','h','t','t','p','s',':','/','/','r','e','p','o','s','t','s','p','a','c','e','-','f','i','p','s',
...
'o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','r','e','p',
'o','s','t','s','p','a','c','e','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P',
...
'r','l','"',':','"','h','t','t','p','s',':','/','/','r','e','p','o','s','t','s','p','a','c','e','.',
...
'e','p','o','s','t','s','p','a','c','e','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t',
...
const char* RepostspaceEndpointRules::GetRulesBlob()
{
