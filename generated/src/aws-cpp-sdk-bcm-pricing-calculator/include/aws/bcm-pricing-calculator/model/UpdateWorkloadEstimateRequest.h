...
class UpdateWorkloadEstimateRequest : public BCMPricingCalculatorRequest {
 public:
  ...
  template <typename IdentifierT = Aws::String>
  UpdateWorkloadEstimateRequest& WithIdentifier(IdentifierT&& value) {
  ...
  template <typename NameT = Aws::String>
  UpdateWorkloadEstimateRequest& WithName(NameT&& value) {
  ...
  template <typename ExpiresAtT = Aws::Utils::DateTime>
  UpdateWorkloadEstimateRequest& WithExpiresAt(ExpiresAtT&& value) {
