...
class BillScenarioCommitmentModificationAction {
 public:
  ...
  void SetAddReservedInstanceAction(AddReservedInstanceActionT&& value) {
    m_addReservedInstanceActionHasBeenSet = true;
    m_addReservedInstanceAction = std::forward<AddReservedInstanceActionT>(value);
  }
  template <typename AddReservedInstanceActionT = AddReservedInstanceAction>
  BillScenarioCommitmentModificationAction& WithAddReservedInstanceAction(AddReservedInstanceActionT&& value) {
    SetAddReservedInstanceAction(std::forward<AddReservedInstanceActionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAddSavingsPlanAction(AddSavingsPlanActionT&& value) {
    m_addSavingsPlanActionHasBeenSet = true;
    m_addSavingsPlanAction = std::forward<AddSavingsPlanActionT>(value);
  }
  template <typename AddSavingsPlanActionT = AddSavingsPlanAction>
  BillScenarioCommitmentModificationAction& WithAddSavingsPlanAction(AddSavingsPlanActionT&& value) {
    SetAddSavingsPlanAction(std::forward<AddSavingsPlanActionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNegateReservedInstanceAction(NegateReservedInstanceActionT&& value) {
    m_negateReservedInstanceActionHasBeenSet = true;
    m_negateReservedInstanceAction = std::forward<NegateReservedInstanceActionT>(value);
  }
  template <typename NegateReservedInstanceActionT = NegateReservedInstanceAction>
  BillScenarioCommitmentModificationAction& WithNegateReservedInstanceAction(NegateReservedInstanceActionT&& value) {
    SetNegateReservedInstanceAction(std::forward<NegateReservedInstanceActionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNegateSavingsPlanAction(NegateSavingsPlanActionT&& value) {
    m_negateSavingsPlanActionHasBeenSet = true;
    m_negateSavingsPlanAction = std::forward<NegateSavingsPlanActionT>(value);
  }
  template <typename NegateSavingsPlanActionT = NegateSavingsPlanAction>
  BillScenarioCommitmentModificationAction& WithNegateSavingsPlanAction(NegateSavingsPlanActionT&& value) {
    SetNegateSavingsPlanAction(std::forward<NegateSavingsPlanActionT>(value));
    return *this;
  }
  ///@}
 private:
