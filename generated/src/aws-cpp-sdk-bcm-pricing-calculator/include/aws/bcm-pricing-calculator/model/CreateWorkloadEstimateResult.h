...
class CreateWorkloadEstimateResult {
 public:
  ...
  AWS_BCMPRICINGCALCULATOR_API CreateWorkloadEstimateResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_BCMPRICINGCALCULATOR_API CreateWorkloadEstimateResult& operator=(
  ...
  template <typename IdT = Aws::String>
  CreateWorkloadEstimateResult& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateWorkloadEstimateResult& WithName(NameT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  CreateWorkloadEstimateResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename ExpiresAtT = Aws::Utils::DateTime>
  CreateWorkloadEstimateResult& WithExpiresAt(ExpiresAtT&& value) {
  ...
  inline CreateWorkloadEstimateResult& WithRateType(WorkloadEstimateRateType value) {
    SetRateType(value);
    return *this;
  }
  ///@}
  ...
  template <typename RateTimestampT = Aws::Utils::DateTime>
  CreateWorkloadEstimateResult& WithRateTimestamp(RateTimestampT&& value) {
  ...
  inline CreateWorkloadEstimateResult& WithStatus(WorkloadEstimateStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline CreateWorkloadEstimateResult& WithTotalCost(double value) {
    SetTotalCost(value);
    return *this;
  }
  ///@}
  ...
  inline CreateWorkloadEstimateResult& WithCostCurrency(CurrencyCode value) {
  ...
  template <typename FailureMessageT = Aws::String>
  CreateWorkloadEstimateResult& WithFailureMessage(FailureMessageT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateWorkloadEstimateResult& WithRequestId(RequestIdT&& value) {
