...
class UpdateBillEstimateRequest : public BCMPricingCalculatorRequest {
 public:
  ...
  template <typename IdentifierT = Aws::String>
  UpdateBillEstimateRequest& WithIdentifier(IdentifierT&& value) {
  ...
  template <typename NameT = Aws::String>
  UpdateBillEstimateRequest& WithName(NameT&& value) {
  ...
  template <typename ExpiresAtT = Aws::Utils::DateTime>
  UpdateBillEstimateRequest& WithExpiresAt(ExpiresAtT&& value) {
