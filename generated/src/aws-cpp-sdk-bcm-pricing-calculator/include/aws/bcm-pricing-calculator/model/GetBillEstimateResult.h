...
class GetBillEstimateResult {
 public:
  AWS_BCMPRICINGCALCULATOR_API GetBillEstimateResult() = default;
  AWS_BCMPRICINGCALCULATOR_API GetBillEstimateResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_BCMPRICINGCALCULATOR_API GetBillEstimateResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  template <typename IdT = Aws::String>
  GetBillEstimateResult& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  GetBillEstimateResult& WithName(NameT&& value) {
  ...
  inline GetBillEstimateResult& WithStatus(BillEstimateStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename FailureMessageT = Aws::String>
  GetBillEstimateResult& WithFailureMessage(FailureMessageT&& value) {
  ...
  template <typename BillIntervalT = BillInterval>
  GetBillEstimateResult& WithBillInterval(BillIntervalT&& value) {
  ...
  template <typename CostSummaryT = BillEstimateCostSummary>
  GetBillEstimateResult& WithCostSummary(CostSummaryT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  GetBillEstimateResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename ExpiresAtT = Aws::Utils::DateTime>
  GetBillEstimateResult& WithExpiresAt(ExpiresAtT&& value) {
  ...
  inline GetBillEstimateResult& WithGroupSharingPreference(GroupSharingPreferenceEnum value) {
  ...
  template <typename CostCategoryGroupSharingPreferenceArnT = Aws::String>
  GetBillEstimateResult& WithCostCategoryGroupSharingPreferenceArn(CostCategoryGroupSharingPreferenceArnT&& value) {
  ...
  template <typename CostCategoryGroupSharingPreferenceEffectiveDateT = Aws::Utils::DateTime>
  GetBillEstimateResult& WithCostCategoryGroupSharingPreferenceEffectiveDate(CostCategoryGroupSharingPreferenceEffectiveDateT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetBillEstimateResult& WithRequestId(RequestIdT&& value) {
