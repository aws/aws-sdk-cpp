...
namespace Model
{
  ...
  public:
    ...
    AWS_BCMPRICINGCALCULATOR_API ServiceQuotaExceededException(Aws::Utils::Json::JsonView jsonValue);
    AWS_BCMPRICINGCALCULATOR_API ServiceQuotaExceededException& operator=(Aws::Utils::Json::JsonView jsonValue);
