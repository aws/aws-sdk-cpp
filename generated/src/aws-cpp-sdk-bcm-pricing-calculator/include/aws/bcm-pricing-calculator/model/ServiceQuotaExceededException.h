...
/**
 * <p> The request would cause you to exceed your service quota. </p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/bcm-pricing-calculator-2024-06-19/ServiceQuotaExceededException">AWS
 * API Reference</a></p>
 */
class ServiceQuotaExceededException {
 public:
  AWS_BCMPRICINGCALCULATOR_API ServiceQuotaExceededException() = default;
  AWS_BCMPRICINGCALCULATOR_API ServiceQuotaExceededException(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_BCMPRICINGCALCULATOR_API ServiceQuotaExceededException& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
