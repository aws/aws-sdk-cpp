...
class ListBillScenariosResult {
 public:
  ...
  AWS_BCMPRICINGCALCULATOR_API ListBillScenariosResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_BCMPRICINGCALCULATOR_API ListBillScenariosResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  template <typename ItemsT = Aws::Vector<BillScenarioSummary>>
  ListBillScenariosResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = BillScenarioSummary>
  ListBillScenariosResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListBillScenariosResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListBillScenariosResult& WithRequestId(RequestIdT&& value) {
