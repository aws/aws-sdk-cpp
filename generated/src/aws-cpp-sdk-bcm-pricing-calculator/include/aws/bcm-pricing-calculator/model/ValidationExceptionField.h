...
namespace Model
{
  ...
  /**
   * <p> Represents a field that failed validation in a request. </p><p><h3>See
   * Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/bcm-pricing-calculator-2024-06-19/ValidationExceptionField">AWS
   * API Reference</a></p>
   */
  class ValidationExceptionField
  {
  public:
    AWS_BCMPRICINGCALCULATOR_API ValidationExceptionField();
