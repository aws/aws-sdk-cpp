...
class BatchUpdateBillScenarioUsageModificationRequest : public BCMPricingCalculatorRequest {
 public:
  ...
  template <typename BillScenarioIdT = Aws::String>
  BatchUpdateBillScenarioUsageModificationRequest& WithBillScenarioId(BillScenarioIdT&& value) {
  ...
  void SetUsageModifications(UsageModificationsT&& value) {
    m_usageModificationsHasBeenSet = true;
    m_usageModifications = std::forward<UsageModificationsT>(value);
  }
  template <typename UsageModificationsT = Aws::Vector<BatchUpdateBillScenarioUsageModificationEntry>>
  BatchUpdateBillScenarioUsageModificationRequest& WithUsageModifications(UsageModificationsT&& value) {
    SetUsageModifications(std::forward<UsageModificationsT>(value));
    return *this;
  }
  template <typename UsageModificationsT = BatchUpdateBillScenarioUsageModificationEntry>
  BatchUpdateBillScenarioUsageModificationRequest& AddUsageModifications(UsageModificationsT&& value) {
    m_usageModificationsHasBeenSet = true;
    m_usageModifications.emplace_back(std::forward<UsageModificationsT>(value));
    return *this;
  }
  ///@}
 private:
