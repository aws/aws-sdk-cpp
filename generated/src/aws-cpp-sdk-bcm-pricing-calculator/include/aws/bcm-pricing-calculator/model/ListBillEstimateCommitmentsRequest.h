...
namespace Model
{
  ...
  {
  public:
    AWS_BCMPRICINGCALCULATOR_API ListBillEstimateCommitmentsRequest();
    ...
    inline ListBillEstimateCommitmentsRequest& WithBillEstimateId(const Aws::String& value) { SetBillEstimateId(value); return *this;}
    inline ListBillEstimateCommitmentsRequest& WithBillEstimateId(Aws::String&& value) { SetBillEstimateId(std::move(value)); return *this;}
    inline ListBillEstimateCommitmentsRequest& WithBillEstimateId(const char* value) { SetBillEstimateId(value); return *this;}
    ///@}
    ...
    inline ListBillEstimateCommitmentsRequest& WithNextToken(const Aws::String& value) { SetNextToken(value); return *this;}
    inline ListBillEstimateCommitmentsRequest& WithNextToken(Aws::String&& value) { SetNextToken(std::move(value)); return *this;}
    inline ListBillEstimateCommitmentsRequest& WithNextToken(const char* value) { SetNextToken(value); return *this;}
    ///@}
