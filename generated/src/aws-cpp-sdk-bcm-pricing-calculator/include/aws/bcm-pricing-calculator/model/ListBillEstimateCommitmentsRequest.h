...
class ListBillEstimateCommitmentsRequest : public BCMPricingCalculatorRequest {
 public:
  ...
  template <typename BillEstimateIdT = Aws::String>
  ListBillEstimateCommitmentsRequest& WithBillEstimateId(BillEstimateIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListBillEstimateCommitmentsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListBillEstimateCommitmentsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
