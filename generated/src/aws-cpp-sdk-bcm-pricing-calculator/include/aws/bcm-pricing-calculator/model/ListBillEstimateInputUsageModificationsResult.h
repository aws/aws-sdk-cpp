...
class ListBillEstimateInputUsageModificationsResult {
 public:
  ...
  AWS_BCMPRICINGCALCULATOR_API ListBillEstimateInputUsageModificationsResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ItemsT = Aws::Vector<BillEstimateInputUsageModificationSummary>>
  ListBillEstimateInputUsageModificationsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = BillEstimateInputUsageModificationSummary>
  ListBillEstimateInputUsageModificationsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListBillEstimateInputUsageModificationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListBillEstimateInputUsageModificationsResult& WithRequestId(RequestIdT&& value) {
