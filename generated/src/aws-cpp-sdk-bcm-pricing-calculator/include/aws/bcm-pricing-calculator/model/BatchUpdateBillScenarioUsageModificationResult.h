...
class BatchUpdateBillScenarioUsageModificationResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<BillScenarioUsageModificationItem>>
  BatchUpdateBillScenarioUsageModificationResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = BillScenarioUsageModificationItem>
  BatchUpdateBillScenarioUsageModificationResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename ErrorsT = Aws::Vector<BatchUpdateBillScenarioUsageModificationError>>
  BatchUpdateBillScenarioUsageModificationResult& WithErrors(ErrorsT&& value) {
    SetErrors(std::forward<ErrorsT>(value));
    return *this;
  }
  template <typename ErrorsT = BatchUpdateBillScenarioUsageModificationError>
  BatchUpdateBillScenarioUsageModificationResult& AddErrors(ErrorsT&& value) {
    m_errorsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  BatchUpdateBillScenarioUsageModificationResult& WithRequestId(RequestIdT&& value) {
