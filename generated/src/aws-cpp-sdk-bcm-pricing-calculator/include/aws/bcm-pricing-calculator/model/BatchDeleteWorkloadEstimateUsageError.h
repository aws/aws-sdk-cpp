...
namespace Model
{
  ...
  public:
    ...
    template<typename IdT = Aws::String>
    BatchDeleteWorkloadEstimateUsageError& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename ErrorMessageT = Aws::String>
    BatchDeleteWorkloadEstimateUsageError& WithErrorMessage(ErrorMessageT&& value) { SetErrorMessage(std::forward<ErrorMessageT>(value)); return *this;}
    ///@}
    ...
    inline BatchDeleteWorkloadEstimateUsageError& WithErrorCode(WorkloadEstimateUpdateUsageErrorCode value) { SetErrorCode(value); return *this;}
    ///@}
  private:
