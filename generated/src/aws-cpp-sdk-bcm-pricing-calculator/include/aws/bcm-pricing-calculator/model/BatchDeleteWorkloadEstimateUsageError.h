...
class BatchDeleteWorkloadEstimateUsageError {
 public:
  ...
  AWS_BCMPRICINGCALCULATOR_API BatchDeleteWorkloadEstimateUsageError(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  template <typename IdT = Aws::String>
  BatchDeleteWorkloadEstimateUsageError& WithId(IdT&& value) {
  ...
  template <typename ErrorMessageT = Aws::String>
  BatchDeleteWorkloadEstimateUsageError& WithErrorMessage(ErrorMessageT&& value) {
  ...
  inline void SetErrorCode(WorkloadEstimateUpdateUsageErrorCode value) {
    m_errorCodeHasBeenSet = true;
    m_errorCode = value;
  }
  inline BatchDeleteWorkloadEstimateUsageError& WithErrorCode(WorkloadEstimateUpdateUsageErrorCode value) {
    SetErrorCode(value);
    return *this;
  }
  ///@}
