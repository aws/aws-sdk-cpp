...
class ListBillEstimateLineItemsRequest : public BCMPricingCalculatorRequest {
 public:
  ...
  void SetBillEstimateId(BillEstimateIdT&& value) {
    m_billEstimateIdHasBeenSet = true;
    m_billEstimateId = std::forward<BillEstimateIdT>(value);
  }
  template <typename BillEstimateIdT = Aws::String>
  ListBillEstimateLineItemsRequest& WithBillEstimateId(BillEstimateIdT&& value) {
    SetBillEstimateId(std::forward<BillEstimateIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<ListBillEstimateLineItemsFilter>>
  ListBillEstimateLineItemsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = ListBillEstimateLineItemsFilter>
  ListBillEstimateLineItemsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListBillEstimateLineItemsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListBillEstimateLineItemsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
