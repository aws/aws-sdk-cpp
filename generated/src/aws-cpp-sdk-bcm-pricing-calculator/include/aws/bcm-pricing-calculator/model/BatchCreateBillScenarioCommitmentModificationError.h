...
class BatchCreateBillScenarioCommitmentModificationError {
 public:
  ...
  template <typename KeyT = Aws::String>
  BatchCreateBillScenarioCommitmentModificationError& WithKey(KeyT&& value) {
  ...
  template <typename ErrorMessageT = Aws::String>
  BatchCreateBillScenarioCommitmentModificationError& WithErrorMessage(ErrorMessageT&& value) {
  ...
  inline void SetErrorCode(BatchCreateBillScenarioCommitmentModificationErrorCode value) {
    m_errorCodeHasBeenSet = true;
    m_errorCode = value;
  }
  inline BatchCreateBillScenarioCommitmentModificationError& WithErrorCode(BatchCreateBillScenarioCommitmentModificationErrorCode value) {
    SetErrorCode(value);
    return *this;
  }
  ///@}
