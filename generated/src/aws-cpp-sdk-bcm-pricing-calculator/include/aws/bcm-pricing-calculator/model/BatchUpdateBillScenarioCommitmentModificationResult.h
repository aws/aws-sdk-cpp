...
class BatchUpdateBillScenarioCommitmentModificationResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<BillScenarioCommitmentModificationItem>>
  BatchUpdateBillScenarioCommitmentModificationResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = BillScenarioCommitmentModificationItem>
  BatchUpdateBillScenarioCommitmentModificationResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename ErrorsT = Aws::Vector<BatchUpdateBillScenarioCommitmentModificationError>>
  BatchUpdateBillScenarioCommitmentModificationResult& WithErrors(ErrorsT&& value) {
    SetErrors(std::forward<ErrorsT>(value));
    return *this;
  }
  template <typename ErrorsT = BatchUpdateBillScenarioCommitmentModificationError>
  BatchUpdateBillScenarioCommitmentModificationResult& AddErrors(ErrorsT&& value) {
    m_errorsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  BatchUpdateBillScenarioCommitmentModificationResult& WithRequestId(RequestIdT&& value) {
