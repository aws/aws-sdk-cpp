...
namespace Model
{
  ...
  public:
    ...
    template<typename IdT = Aws::String>
    BatchDeleteBillScenarioUsageModificationError& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename ErrorMessageT = Aws::String>
    BatchDeleteBillScenarioUsageModificationError& WithErrorMessage(ErrorMessageT&& value) { SetErrorMessage(std::forward<ErrorMessageT>(value)); return *this;}
    ///@}
     ...
     */
    inline BatchDeleteBillScenarioUsageModificationErrorCode GetErrorCode() const { return m_errorCode; }
    inline bool ErrorCodeHasBeenSet() const { return m_errorCodeHasBeenSet; }
    inline void SetErrorCode(BatchDeleteBillScenarioUsageModificationErrorCode value) { m_errorCodeHasBeenSet = true; m_errorCode = value; }
    inline BatchDeleteBillScenarioUsageModificationError& WithErrorCode(BatchDeleteBillScenarioUsageModificationErrorCode value) { SetErrorCode(value); return *this;}
    ///@}
  private:
