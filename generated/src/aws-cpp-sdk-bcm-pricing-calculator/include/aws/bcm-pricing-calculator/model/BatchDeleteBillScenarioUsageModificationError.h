...
class BatchDeleteBillScenarioUsageModificationError {
 public:
  ...
  AWS_BCMPRICINGCALCULATOR_API BatchDeleteBillScenarioUsageModificationError(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  template <typename IdT = Aws::String>
  BatchDeleteBillScenarioUsageModificationError& WithId(IdT&& value) {
  ...
  template <typename ErrorMessageT = Aws::String>
  BatchDeleteBillScenarioUsageModificationError& WithErrorMessage(ErrorMessageT&& value) {
  ...
  inline void SetErrorCode(BatchDeleteBillScenarioUsageModificationErrorCode value) {
    m_errorCodeHasBeenSet = true;
    m_errorCode = value;
  }
  inline BatchDeleteBillScenarioUsageModificationError& WithErrorCode(BatchDeleteBillScenarioUsageModificationErrorCode value) {
    SetErrorCode(value);
    return *this;
  }
  ///@}
