...
class BatchDeleteBillScenarioCommitmentModificationError {
 public:
  ...
  template <typename IdT = Aws::String>
  BatchDeleteBillScenarioCommitmentModificationError& WithId(IdT&& value) {
  ...
  inline void SetErrorCode(BatchDeleteBillScenarioCommitmentModificationErrorCode value) {
    m_errorCodeHasBeenSet = true;
    m_errorCode = value;
  }
  inline BatchDeleteBillScenarioCommitmentModificationError& WithErrorCode(BatchDeleteBillScenarioCommitmentModificationErrorCode value) {
    SetErrorCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename ErrorMessageT = Aws::String>
  BatchDeleteBillScenarioCommitmentModificationError& WithErrorMessage(ErrorMessageT&& value) {
