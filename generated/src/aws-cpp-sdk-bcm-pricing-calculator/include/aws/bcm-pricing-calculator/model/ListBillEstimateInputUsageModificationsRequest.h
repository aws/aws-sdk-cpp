...
class ListBillEstimateInputUsageModificationsRequest : public BCMPricingCalculatorRequest {
 public:
  ...
  template <typename BillEstimateIdT = Aws::String>
  ListBillEstimateInputUsageModificationsRequest& WithBillEstimateId(BillEstimateIdT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<ListUsageFilter>>
  ListBillEstimateInputUsageModificationsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = ListUsageFilter>
  ListBillEstimateInputUsageModificationsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListBillEstimateInputUsageModificationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListBillEstimateInputUsageModificationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
