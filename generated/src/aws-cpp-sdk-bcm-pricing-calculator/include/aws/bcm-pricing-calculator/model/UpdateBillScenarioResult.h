...
class UpdateBillScenarioResult {
 public:
  ...
  AWS_BCMPRICINGCALCULATOR_API UpdateBillScenarioResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_BCMPRICINGCALCULATOR_API UpdateBillScenarioResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
