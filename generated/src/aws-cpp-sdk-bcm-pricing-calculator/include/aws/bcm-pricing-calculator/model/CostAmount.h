...
class CostAmount {
 public:
  ...
  AWS_BCMPRICINGCALCULATOR_API CostAmount(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_BCMPRICINGCALCULATOR_API CostAmount& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline CostAmount& WithAmount(double value) {
    SetAmount(value);
    return *this;
  }
  ///@}
  ...
  inline CostAmount& WithCurrency(CurrencyCode value) {
    SetCurrency(value);
    return *this;
  }
  ///@}
