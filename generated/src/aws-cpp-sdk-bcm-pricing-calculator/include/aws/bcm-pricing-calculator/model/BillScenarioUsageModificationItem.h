...
class BillScenarioUsageModificationItem {
 public:
  ...
  AWS_BCMPRICINGCALCULATOR_API BillScenarioUsageModificationItem(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_BCMPRICINGCALCULATOR_API BillScenarioUsageModificationItem& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  template <typename ServiceCodeT = Aws::String>
  BillScenarioUsageModificationItem& WithServiceCode(ServiceCodeT&& value) {
  ...
  template <typename UsageTypeT = Aws::String>
  BillScenarioUsageModificationItem& WithUsageType(UsageTypeT&& value) {
  ...
  template <typename OperationT = Aws::String>
  BillScenarioUsageModificationItem& WithOperation(OperationT&& value) {
  ...
  template <typename LocationT = Aws::String>
  BillScenarioUsageModificationItem& WithLocation(LocationT&& value) {
  ...
  template <typename AvailabilityZoneT = Aws::String>
  BillScenarioUsageModificationItem& WithAvailabilityZone(AvailabilityZoneT&& value) {
  ...
  template <typename IdT = Aws::String>
  BillScenarioUsageModificationItem& WithId(IdT&& value) {
  ...
  template <typename GroupT = Aws::String>
  BillScenarioUsageModificationItem& WithGroup(GroupT&& value) {
  ...
  template <typename UsageAccountIdT = Aws::String>
  BillScenarioUsageModificationItem& WithUsageAccountId(UsageAccountIdT&& value) {
  ...
  template <typename QuantitiesT = Aws::Vector<UsageQuantity>>
  BillScenarioUsageModificationItem& WithQuantities(QuantitiesT&& value) {
    SetQuantities(std::forward<QuantitiesT>(value));
    return *this;
  }
  template <typename QuantitiesT = UsageQuantity>
  BillScenarioUsageModificationItem& AddQuantities(QuantitiesT&& value) {
    m_quantitiesHasBeenSet = true;
  ...
  template <typename HistoricalUsageT = HistoricalUsageEntity>
  BillScenarioUsageModificationItem& WithHistoricalUsage(HistoricalUsageT&& value) {
