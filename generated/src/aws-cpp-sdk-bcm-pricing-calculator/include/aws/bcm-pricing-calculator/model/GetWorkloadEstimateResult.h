...
class GetWorkloadEstimateResult {
 public:
  ...
  template <typename IdT = Aws::String>
  GetWorkloadEstimateResult& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  GetWorkloadEstimateResult& WithName(NameT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  GetWorkloadEstimateResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename ExpiresAtT = Aws::Utils::DateTime>
  GetWorkloadEstimateResult& WithExpiresAt(ExpiresAtT&& value) {
  ...
  inline void SetRateType(WorkloadEstimateRateType value) {
    m_rateTypeHasBeenSet = true;
    m_rateType = value;
  }
  inline GetWorkloadEstimateResult& WithRateType(WorkloadEstimateRateType value) {
    SetRateType(value);
    return *this;
  }
  ///@}
  ...
  void SetRateTimestamp(RateTimestampT&& value) {
    m_rateTimestampHasBeenSet = true;
    m_rateTimestamp = std::forward<RateTimestampT>(value);
  }
  template <typename RateTimestampT = Aws::Utils::DateTime>
  GetWorkloadEstimateResult& WithRateTimestamp(RateTimestampT&& value) {
    SetRateTimestamp(std::forward<RateTimestampT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(WorkloadEstimateStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline GetWorkloadEstimateResult& WithStatus(WorkloadEstimateStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTotalCost(double value) {
    m_totalCostHasBeenSet = true;
    m_totalCost = value;
  }
  inline GetWorkloadEstimateResult& WithTotalCost(double value) {
    SetTotalCost(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCostCurrency(CurrencyCode value) {
    m_costCurrencyHasBeenSet = true;
    m_costCurrency = value;
  }
  inline GetWorkloadEstimateResult& WithCostCurrency(CurrencyCode value) {
  ...
  template <typename FailureMessageT = Aws::String>
  GetWorkloadEstimateResult& WithFailureMessage(FailureMessageT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetWorkloadEstimateResult& WithRequestId(RequestIdT&& value) {
