...
namespace Model
{
  ...
  public:
    ...
    template<typename IdT = Aws::String>
    GetWorkloadEstimateResult& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    GetWorkloadEstimateResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename CreatedAtT = Aws::Utils::DateTime>
    GetWorkloadEstimateResult& WithCreatedAt(CreatedAtT&& value) { SetCreatedAt(std::forward<CreatedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename ExpiresAtT = Aws::Utils::DateTime>
    GetWorkloadEstimateResult& WithExpiresAt(ExpiresAtT&& value) { SetExpiresAt(std::forward<ExpiresAtT>(value)); return *this;}
    ///@}
    ...
    inline GetWorkloadEstimateResult& WithRateType(WorkloadEstimateRateType value) { SetRateType(value); return *this;}
    ///@}
    ...
    template<typename RateTimestampT = Aws::Utils::DateTime>
    GetWorkloadEstimateResult& WithRateTimestamp(RateTimestampT&& value) { SetRateTimestamp(std::forward<RateTimestampT>(value)); return *this;}
    ///@}
    ...
    inline GetWorkloadEstimateResult& WithStatus(WorkloadEstimateStatus value) { SetStatus(value); return *this;}
    ///@}
    ...
    inline GetWorkloadEstimateResult& WithCostCurrency(CurrencyCode value) { SetCostCurrency(value); return *this;}
    ///@}
    ...
    template<typename FailureMessageT = Aws::String>
    GetWorkloadEstimateResult& WithFailureMessage(FailureMessageT&& value) { SetFailureMessage(std::forward<FailureMessageT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    GetWorkloadEstimateResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
