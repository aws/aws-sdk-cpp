...
class ListBillEstimateCommitmentsResult {
 public:
  ...
  AWS_BCMPRICINGCALCULATOR_API ListBillEstimateCommitmentsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_BCMPRICINGCALCULATOR_API ListBillEstimateCommitmentsResult& operator=(
  ...
  template <typename ItemsT = Aws::Vector<BillEstimateCommitmentSummary>>
  ListBillEstimateCommitmentsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = BillEstimateCommitmentSummary>
  ListBillEstimateCommitmentsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListBillEstimateCommitmentsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListBillEstimateCommitmentsResult& WithRequestId(RequestIdT&& value) {
