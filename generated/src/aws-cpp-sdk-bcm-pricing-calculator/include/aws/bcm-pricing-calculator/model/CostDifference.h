...
class CostDifference {
 public:
  ...
  AWS_BCMPRICINGCALCULATOR_API CostDifference(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_BCMPRICINGCALCULATOR_API CostDifference& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  template <typename HistoricalCostT = CostAmount>
  CostDifference& WithHistoricalCost(HistoricalCostT&& value) {
  ...
  template <typename EstimatedCostT = CostAmount>
  CostDifference& WithEstimatedCost(EstimatedCostT&& value) {
