...
class ListBillEstimateLineItemsFilter {
 public:
  ...
  AWS_BCMPRICINGCALCULATOR_API ListBillEstimateLineItemsFilter(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_BCMPRICINGCALCULATOR_API ListBillEstimateLineItemsFilter& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
