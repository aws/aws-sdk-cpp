...
class FilterTimestamp {
 public:
  ...
  AWS_BCMPRICINGCALCULATOR_API FilterTimestamp(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_BCMPRICINGCALCULATOR_API FilterTimestamp& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  void SetAfterTimestamp(AfterTimestampT&& value) {
    ...
    m_afterTimestamp = std::forward<AfterTimestampT>(value);
  }
  template <typename AfterTimestampT = Aws::Utils::DateTime>
  FilterTimestamp& WithAfterTimestamp(AfterTimestampT&& value) {
    SetAfterTimestamp(std::forward<AfterTimestampT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBeforeTimestamp(BeforeTimestampT&& value) {
    ...
    m_beforeTimestamp = std::forward<BeforeTimestampT>(value);
  }
  template <typename BeforeTimestampT = Aws::Utils::DateTime>
  FilterTimestamp& WithBeforeTimestamp(BeforeTimestampT&& value) {
