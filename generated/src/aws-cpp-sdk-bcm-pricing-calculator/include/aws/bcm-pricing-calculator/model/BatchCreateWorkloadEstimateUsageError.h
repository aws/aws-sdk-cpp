...
class BatchCreateWorkloadEstimateUsageError {
 public:
  ...
  AWS_BCMPRICINGCALCULATOR_API BatchCreateWorkloadEstimateUsageError(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  template <typename KeyT = Aws::String>
  BatchCreateWorkloadEstimateUsageError& WithKey(KeyT&& value) {
  ...
  inline void SetErrorCode(BatchCreateWorkloadEstimateUsageCode value) {
    m_errorCodeHasBeenSet = true;
    m_errorCode = value;
  }
  inline BatchCreateWorkloadEstimateUsageError& WithErrorCode(BatchCreateWorkloadEstimateUsageCode value) {
    SetErrorCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename ErrorMessageT = Aws::String>
  BatchCreateWorkloadEstimateUsageError& WithErrorMessage(ErrorMessageT&& value) {
