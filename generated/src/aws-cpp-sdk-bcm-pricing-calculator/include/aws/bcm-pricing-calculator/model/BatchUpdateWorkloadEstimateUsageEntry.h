...
class BatchUpdateWorkloadEstimateUsageEntry {
 public:
  ...
  AWS_BCMPRICINGCALCULATOR_API BatchUpdateWorkloadEstimateUsageEntry(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  template <typename IdT = Aws::String>
  BatchUpdateWorkloadEstimateUsageEntry& WithId(IdT&& value) {
  ...
  template <typename GroupT = Aws::String>
  BatchUpdateWorkloadEstimateUsageEntry& WithGroup(GroupT&& value) {
  ...
  inline BatchUpdateWorkloadEstimateUsageEntry& WithAmount(double value) {
    SetAmount(value);
    return *this;
  }
  ///@}
