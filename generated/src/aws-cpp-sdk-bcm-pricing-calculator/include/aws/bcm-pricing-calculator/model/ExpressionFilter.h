...
class ExpressionFilter {
 public:
  ...
  AWS_BCMPRICINGCALCULATOR_API ExpressionFilter(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_BCMPRICINGCALCULATOR_API ExpressionFilter& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  template <typename KeyT = Aws::String>
  ExpressionFilter& WithKey(KeyT&& value) {
  ...
  template <typename MatchOptionsT = Aws::Vector<Aws::String>>
  ExpressionFilter& WithMatchOptions(MatchOptionsT&& value) {
    SetMatchOptions(std::forward<MatchOptionsT>(value));
    return *this;
  }
  template <typename MatchOptionsT = Aws::String>
  ExpressionFilter& AddMatchOptions(MatchOptionsT&& value) {
    m_matchOptionsHasBeenSet = true;
    m_matchOptions.emplace_back(std::forward<MatchOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  ExpressionFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  ExpressionFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
