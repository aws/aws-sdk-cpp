...
class UsageAmount {
 public:
  ...
  AWS_BCMPRICINGCALCULATOR_API UsageAmount(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_BCMPRICINGCALCULATOR_API UsageAmount& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  template <typename StartHourT = Aws::Utils::DateTime>
  UsageAmount& WithStartHour(StartHourT&& value) {
  ...
  inline UsageAmount& WithAmount(double value) {
    SetAmount(value);
    return *this;
  }
  ///@}
