...
class BillEstimateCostSummary {
 public:
  ...
  AWS_BCMPRICINGCALCULATOR_API BillEstimateCostSummary(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_BCMPRICINGCALCULATOR_API BillEstimateCostSummary& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  void SetTotalCostDifference(TotalCostDifferenceT&& value) {
    m_totalCostDifferenceHasBeenSet = true;
    m_totalCostDifference = std::forward<TotalCostDifferenceT>(value);
  }
  template <typename TotalCostDifferenceT = CostDifference>
  BillEstimateCostSummary& WithTotalCostDifference(TotalCostDifferenceT&& value) {
    SetTotalCostDifference(std::forward<TotalCostDifferenceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetServiceCostDifferences(ServiceCostDifferencesT&& value) {
    m_serviceCostDifferencesHasBeenSet = true;
    m_serviceCostDifferences = std::forward<ServiceCostDifferencesT>(value);
  }
  template <typename ServiceCostDifferencesT = Aws::Map<Aws::String, CostDifference>>
  BillEstimateCostSummary& WithServiceCostDifferences(ServiceCostDifferencesT&& value) {
    SetServiceCostDifferences(std::forward<ServiceCostDifferencesT>(value));
    return *this;
  }
  ...
  BillEstimateCostSummary& AddServiceCostDifferences(ServiceCostDifferencesKeyT&& key, ServiceCostDifferencesValueT&& value) {
    m_serviceCostDifferencesHasBeenSet = true;
    m_serviceCostDifferences.emplace(std::forward<ServiceCostDifferencesKeyT>(key), std::forward<ServiceCostDifferencesValueT>(value));
    return *this;
  }
  ///@}
 private:
