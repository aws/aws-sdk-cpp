...
class BatchCreateBillScenarioCommitmentModificationResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<BatchCreateBillScenarioCommitmentModificationItem>>
  BatchCreateBillScenarioCommitmentModificationResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = BatchCreateBillScenarioCommitmentModificationItem>
  BatchCreateBillScenarioCommitmentModificationResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename ErrorsT = Aws::Vector<BatchCreateBillScenarioCommitmentModificationError>>
  BatchCreateBillScenarioCommitmentModificationResult& WithErrors(ErrorsT&& value) {
    SetErrors(std::forward<ErrorsT>(value));
    return *this;
  }
  template <typename ErrorsT = BatchCreateBillScenarioCommitmentModificationError>
  BatchCreateBillScenarioCommitmentModificationResult& AddErrors(ErrorsT&& value) {
    m_errorsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  BatchCreateBillScenarioCommitmentModificationResult& WithRequestId(RequestIdT&& value) {
