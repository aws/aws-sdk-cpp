...
class NegateSavingsPlanAction {
 public:
  ...
  AWS_BCMPRICINGCALCULATOR_API NegateSavingsPlanAction(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_BCMPRICINGCALCULATOR_API NegateSavingsPlanAction& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  template <typename SavingsPlanIdT = Aws::String>
  NegateSavingsPlanAction& WithSavingsPlanId(SavingsPlanIdT&& value) {
