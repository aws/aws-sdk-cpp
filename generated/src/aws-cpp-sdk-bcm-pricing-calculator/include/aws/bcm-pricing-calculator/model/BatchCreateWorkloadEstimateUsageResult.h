...
class BatchCreateWorkloadEstimateUsageResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<BatchCreateWorkloadEstimateUsageItem>>
  BatchCreateWorkloadEstimateUsageResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = BatchCreateWorkloadEstimateUsageItem>
  BatchCreateWorkloadEstimateUsageResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename ErrorsT = Aws::Vector<BatchCreateWorkloadEstimateUsageError>>
  BatchCreateWorkloadEstimateUsageResult& WithErrors(ErrorsT&& value) {
    SetErrors(std::forward<ErrorsT>(value));
    return *this;
  }
  template <typename ErrorsT = BatchCreateWorkloadEstimateUsageError>
  BatchCreateWorkloadEstimateUsageResult& AddErrors(ErrorsT&& value) {
    m_errorsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  BatchCreateWorkloadEstimateUsageResult& WithRequestId(RequestIdT&& value) {
