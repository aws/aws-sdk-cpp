...
/**
 * <p> Summarizes an input commitment modification for a bill estimate.
 * </p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/bcm-pricing-calculator-2024-06-19/BillEstimateInputCommitmentModificationSummary">AWS
 * API Reference</a></p>
 */
class BillEstimateInputCommitmentModificationSummary {
 public:
  ...
  AWS_BCMPRICINGCALCULATOR_API BillEstimateInputCommitmentModificationSummary(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  template <typename IdT = Aws::String>
  BillEstimateInputCommitmentModificationSummary& WithId(IdT&& value) {
  ...
  template <typename GroupT = Aws::String>
  BillEstimateInputCommitmentModificationSummary& WithGroup(GroupT&& value) {
  ...
  template <typename UsageAccountIdT = Aws::String>
  BillEstimateInputCommitmentModificationSummary& WithUsageAccountId(UsageAccountIdT&& value) {
  ...
  void SetCommitmentAction(CommitmentActionT&& value) {
    m_commitmentActionHasBeenSet = true;
    m_commitmentAction = std::forward<CommitmentActionT>(value);
  }
  template <typename CommitmentActionT = BillScenarioCommitmentModificationAction>
  BillEstimateInputCommitmentModificationSummary& WithCommitmentAction(CommitmentActionT&& value) {
    SetCommitmentAction(std::forward<CommitmentActionT>(value));
    return *this;
  }
  ///@}
 private:
