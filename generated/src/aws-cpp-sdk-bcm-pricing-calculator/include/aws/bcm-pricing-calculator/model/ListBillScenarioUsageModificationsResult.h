...
namespace Model
{
  ...
  {
  public:
    AWS_BCMPRICINGCALCULATOR_API ListBillScenarioUsageModificationsResult() = default;
    ...
    template<typename ItemsT = Aws::Vector<BillScenarioUsageModificationItem>>
    ListBillScenarioUsageModificationsResult& WithItems(ItemsT&& value) { SetItems(std::forward<ItemsT>(value)); return *this;}
    template<typename ItemsT = BillScenarioUsageModificationItem>
    ListBillScenarioUsageModificationsResult& AddItems(ItemsT&& value) { m_itemsHasBeenSet = true; m_items.emplace_back(std::forward<ItemsT>(value)); return *this; }
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListBillScenarioUsageModificationsResult& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ListBillScenarioUsageModificationsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
