...
class ListBillScenarioUsageModificationsResult {
 public:
  ...
  AWS_BCMPRICINGCALCULATOR_API ListBillScenarioUsageModificationsResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ItemsT = Aws::Vector<BillScenarioUsageModificationItem>>
  ListBillScenarioUsageModificationsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = BillScenarioUsageModificationItem>
  ListBillScenarioUsageModificationsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListBillScenarioUsageModificationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListBillScenarioUsageModificationsResult& WithRequestId(RequestIdT&& value) {
