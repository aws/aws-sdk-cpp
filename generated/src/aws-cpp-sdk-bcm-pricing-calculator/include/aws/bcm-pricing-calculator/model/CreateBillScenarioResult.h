...
class CreateBillScenarioResult {
 public:
  ...
  AWS_BCMPRICINGCALCULATOR_API CreateBillScenarioResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_BCMPRICINGCALCULATOR_API CreateBillScenarioResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  template <typename IdT = Aws::String>
  CreateBillScenarioResult& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateBillScenarioResult& WithName(NameT&& value) {
  ...
  template <typename BillIntervalT = BillInterval>
  CreateBillScenarioResult& WithBillInterval(BillIntervalT&& value) {
  ...
  inline CreateBillScenarioResult& WithStatus(BillScenarioStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  CreateBillScenarioResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename ExpiresAtT = Aws::Utils::DateTime>
  CreateBillScenarioResult& WithExpiresAt(ExpiresAtT&& value) {
  ...
  template <typename FailureMessageT = Aws::String>
  CreateBillScenarioResult& WithFailureMessage(FailureMessageT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateBillScenarioResult& WithRequestId(RequestIdT&& value) {
