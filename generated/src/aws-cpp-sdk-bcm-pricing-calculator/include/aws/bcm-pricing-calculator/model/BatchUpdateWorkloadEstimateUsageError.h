...
class BatchUpdateWorkloadEstimateUsageError {
 public:
  ...
  AWS_BCMPRICINGCALCULATOR_API BatchUpdateWorkloadEstimateUsageError(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  template <typename IdT = Aws::String>
  BatchUpdateWorkloadEstimateUsageError& WithId(IdT&& value) {
  ...
  template <typename ErrorMessageT = Aws::String>
  BatchUpdateWorkloadEstimateUsageError& WithErrorMessage(ErrorMessageT&& value) {
  ...
  inline BatchUpdateWorkloadEstimateUsageError& WithErrorCode(WorkloadEstimateUpdateUsageErrorCode value) {
    SetErrorCode(value);
    return *this;
  }
  ///@}
