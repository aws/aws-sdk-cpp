...
class BatchDeleteWorkloadEstimateUsageResult {
 public:
  ...
  template <typename ErrorsT = Aws::Vector<BatchDeleteWorkloadEstimateUsageError>>
  BatchDeleteWorkloadEstimateUsageResult& WithErrors(ErrorsT&& value) {
    SetErrors(std::forward<ErrorsT>(value));
    return *this;
  }
  template <typename ErrorsT = BatchDeleteWorkloadEstimateUsageError>
  BatchDeleteWorkloadEstimateUsageResult& AddErrors(ErrorsT&& value) {
    m_errorsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  BatchDeleteWorkloadEstimateUsageResult& WithRequestId(RequestIdT&& value) {
