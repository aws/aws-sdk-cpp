...
class ListBillEstimatesFilter {
 public:
  ...
  AWS_BCMPRICINGCALCULATOR_API ListBillEstimatesFilter(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_BCMPRICINGCALCULATOR_API ListBillEstimatesFilter& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline void SetName(ListBillEstimatesFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline ListBillEstimatesFilter& WithName(ListBillEstimatesFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  ListBillEstimatesFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  ListBillEstimatesFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
  ...
  inline ListBillEstimatesFilter& WithMatchOption(MatchOption value) {
