...
class UpdatePreferencesRequest : public BCMPricingCalculatorRequest {
 public:
  ...
  template <typename ManagementAccountRateTypeSelectionsT = Aws::Vector<RateType>>
  UpdatePreferencesRequest& WithManagementAccountRateTypeSelections(ManagementAccountRateTypeSelectionsT&& value) {
    SetManagementAccountRateTypeSelections(std::forward<ManagementAccountRateTypeSelectionsT>(value));
    return *this;
  }
  inline UpdatePreferencesRequest& AddManagementAccountRateTypeSelections(RateType value) {
    m_managementAccountRateTypeSelectionsHasBeenSet = true;
  ...
  template <typename MemberAccountRateTypeSelectionsT = Aws::Vector<RateType>>
  UpdatePreferencesRequest& WithMemberAccountRateTypeSelections(MemberAccountRateTypeSelectionsT&& value) {
    SetMemberAccountRateTypeSelections(std::forward<MemberAccountRateTypeSelectionsT>(value));
    return *this;
  }
  inline UpdatePreferencesRequest& AddMemberAccountRateTypeSelections(RateType value) {
    m_memberAccountRateTypeSelectionsHasBeenSet = true;
  ...
  template <typename StandaloneAccountRateTypeSelectionsT = Aws::Vector<RateType>>
  UpdatePreferencesRequest& WithStandaloneAccountRateTypeSelections(StandaloneAccountRateTypeSelectionsT&& value) {
    SetStandaloneAccountRateTypeSelections(std::forward<StandaloneAccountRateTypeSelectionsT>(value));
    return *this;
  }
  inline UpdatePreferencesRequest& AddStandaloneAccountRateTypeSelections(RateType value) {
    m_standaloneAccountRateTypeSelectionsHasBeenSet = true;
