...
class BillScenarioCommitmentModificationItem {
 public:
  ...
  AWS_BCMPRICINGCALCULATOR_API BillScenarioCommitmentModificationItem(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_BCMPRICINGCALCULATOR_API BillScenarioCommitmentModificationItem& operator=(
  ...
  template <typename IdT = Aws::String>
  BillScenarioCommitmentModificationItem& WithId(IdT&& value) {
  ...
  template <typename UsageAccountIdT = Aws::String>
  BillScenarioCommitmentModificationItem& WithUsageAccountId(UsageAccountIdT&& value) {
  ...
  template <typename GroupT = Aws::String>
  BillScenarioCommitmentModificationItem& WithGroup(GroupT&& value) {
  ...
  template <typename CommitmentActionT = BillScenarioCommitmentModificationAction>
  BillScenarioCommitmentModificationItem& WithCommitmentAction(CommitmentActionT&& value) {
