...
class Expression {
 public:
  ...
  AWS_BCMPRICINGCALCULATOR_API Expression(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_BCMPRICINGCALCULATOR_API Expression& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
   ...
   */
  inline const Expression& GetNot() const { return *m_not; }
