...
/**
 * <p> Summarizes an input usage modification for a bill estimate. </p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/bcm-pricing-calculator-2024-06-19/BillEstimateInputUsageModificationSummary">AWS
 * API Reference</a></p>
 */
class BillEstimateInputUsageModificationSummary {
 public:
  ...
  AWS_BCMPRICINGCALCULATOR_API BillEstimateInputUsageModificationSummary(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_BCMPRICINGCALCULATOR_API BillEstimateInputUsageModificationSummary& operator=(
  ...
  template <typename ServiceCodeT = Aws::String>
  BillEstimateInputUsageModificationSummary& WithServiceCode(ServiceCodeT&& value) {
  ...
  template <typename UsageTypeT = Aws::String>
  BillEstimateInputUsageModificationSummary& WithUsageType(UsageTypeT&& value) {
  ...
  template <typename OperationT = Aws::String>
  BillEstimateInputUsageModificationSummary& WithOperation(OperationT&& value) {
  ...
  template <typename LocationT = Aws::String>
  BillEstimateInputUsageModificationSummary& WithLocation(LocationT&& value) {
  ...
  template <typename AvailabilityZoneT = Aws::String>
  BillEstimateInputUsageModificationSummary& WithAvailabilityZone(AvailabilityZoneT&& value) {
  ...
  template <typename IdT = Aws::String>
  BillEstimateInputUsageModificationSummary& WithId(IdT&& value) {
  ...
  template <typename GroupT = Aws::String>
  BillEstimateInputUsageModificationSummary& WithGroup(GroupT&& value) {
  ...
  template <typename UsageAccountIdT = Aws::String>
  BillEstimateInputUsageModificationSummary& WithUsageAccountId(UsageAccountIdT&& value) {
  ...
  template <typename QuantitiesT = Aws::Vector<UsageQuantity>>
  BillEstimateInputUsageModificationSummary& WithQuantities(QuantitiesT&& value) {
    SetQuantities(std::forward<QuantitiesT>(value));
    return *this;
  }
  template <typename QuantitiesT = UsageQuantity>
  BillEstimateInputUsageModificationSummary& AddQuantities(QuantitiesT&& value) {
    m_quantitiesHasBeenSet = true;
  ...
  template <typename HistoricalUsageT = HistoricalUsageEntity>
  BillEstimateInputUsageModificationSummary& WithHistoricalUsage(HistoricalUsageT&& value) {
