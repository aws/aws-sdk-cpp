...
class ListWorkloadEstimatesRequest : public BCMPricingCalculatorRequest {
 public:
  AWS_BCMPRICINGCALCULATOR_API ListWorkloadEstimatesRequest() = default;
  ...
  template <typename CreatedAtFilterT = FilterTimestamp>
  ListWorkloadEstimatesRequest& WithCreatedAtFilter(CreatedAtFilterT&& value) {
  ...
  template <typename ExpiresAtFilterT = FilterTimestamp>
  ListWorkloadEstimatesRequest& WithExpiresAtFilter(ExpiresAtFilterT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<ListWorkloadEstimatesFilter>>
  void SetFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
    m_filters = std::forward<FiltersT>(value);
  }
  template <typename FiltersT = Aws::Vector<ListWorkloadEstimatesFilter>>
  ListWorkloadEstimatesRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = ListWorkloadEstimatesFilter>
  ListWorkloadEstimatesRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListWorkloadEstimatesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListWorkloadEstimatesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
