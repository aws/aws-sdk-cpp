...
namespace Model
{
  ...
  public:
    ...
    AWS_BCMPRICINGCALCULATOR_API ConflictException(Aws::Utils::Json::JsonView jsonValue);
    AWS_BCMPRICINGCALCULATOR_API ConflictException& operator=(Aws::Utils::Json::JsonView jsonValue);
