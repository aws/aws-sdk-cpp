 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/bcm-pricing-calculator-2024-06-19/ConflictException">AWS
 * API Reference</a></p>
 */
class ConflictException {
 public:
  AWS_BCMPRICINGCALCULATOR_API ConflictException() = default;
  AWS_BCMPRICINGCALCULATOR_API ConflictException(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_BCMPRICINGCALCULATOR_API ConflictException& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
