...
class WorkloadEstimateUsageItem {
 public:
  ...
  AWS_BCMPRICINGCALCULATOR_API WorkloadEstimateUsageItem(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_BCMPRICINGCALCULATOR_API WorkloadEstimateUsageItem& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  template <typename ServiceCodeT = Aws::String>
  WorkloadEstimateUsageItem& WithServiceCode(ServiceCodeT&& value) {
  ...
  template <typename UsageTypeT = Aws::String>
  WorkloadEstimateUsageItem& WithUsageType(UsageTypeT&& value) {
  ...
  template <typename OperationT = Aws::String>
  WorkloadEstimateUsageItem& WithOperation(OperationT&& value) {
  ...
  template <typename LocationT = Aws::String>
  WorkloadEstimateUsageItem& WithLocation(LocationT&& value) {
  ...
  template <typename IdT = Aws::String>
  WorkloadEstimateUsageItem& WithId(IdT&& value) {
  ...
  template <typename UsageAccountIdT = Aws::String>
  WorkloadEstimateUsageItem& WithUsageAccountId(UsageAccountIdT&& value) {
  ...
  template <typename GroupT = Aws::String>
  WorkloadEstimateUsageItem& WithGroup(GroupT&& value) {
  ...
  template <typename QuantityT = WorkloadEstimateUsageQuantity>
  WorkloadEstimateUsageItem& WithQuantity(QuantityT&& value) {
  ...
  inline WorkloadEstimateUsageItem& WithCost(double value) {
    SetCost(value);
    return *this;
  }
  ///@}
  ...
  inline WorkloadEstimateUsageItem& WithCurrency(CurrencyCode value) {
    SetCurrency(value);
    return *this;
  }
  ///@}
  ...
  inline WorkloadEstimateUsageItem& WithStatus(WorkloadEstimateCostStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename HistoricalUsageT = HistoricalUsageEntity>
  WorkloadEstimateUsageItem& WithHistoricalUsage(HistoricalUsageT&& value) {
