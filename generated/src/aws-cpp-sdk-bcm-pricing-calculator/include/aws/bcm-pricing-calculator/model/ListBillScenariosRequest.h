...
class ListBillScenariosRequest : public BCMPricingCalculatorRequest {
 public:
  ...
  template <typename FiltersT = Aws::Vector<ListBillScenariosFilter>>
  ListBillScenariosRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = ListBillScenariosFilter>
  ListBillScenariosRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename CreatedAtFilterT = FilterTimestamp>
  ListBillScenariosRequest& WithCreatedAtFilter(CreatedAtFilterT&& value) {
  ...
  template <typename ExpiresAtFilterT = FilterTimestamp>
  ListBillScenariosRequest& WithExpiresAtFilter(ExpiresAtFilterT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListBillScenariosRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListBillScenariosRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
