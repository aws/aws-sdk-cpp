...
class ListWorkloadEstimateUsageResult {
 public:
  ...
  AWS_BCMPRICINGCALCULATOR_API ListWorkloadEstimateUsageResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_BCMPRICINGCALCULATOR_API ListWorkloadEstimateUsageResult& operator=(
  ...
  template <typename ItemsT = Aws::Vector<WorkloadEstimateUsageItem>>
  ListWorkloadEstimateUsageResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = WorkloadEstimateUsageItem>
  ListWorkloadEstimateUsageResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListWorkloadEstimateUsageResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListWorkloadEstimateUsageResult& WithRequestId(RequestIdT&& value) {
