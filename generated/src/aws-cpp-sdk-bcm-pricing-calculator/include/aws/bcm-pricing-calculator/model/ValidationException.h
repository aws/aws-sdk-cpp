...
class ValidationException {
 public:
  ...
  AWS_BCMPRICINGCALCULATOR_API ValidationException(Aws::Utils::Json::JsonView jsonValue);
  AWS_BCMPRICINGCALCULATOR_API ValidationException& operator=(Aws::Utils::Json::JsonView jsonValue);
