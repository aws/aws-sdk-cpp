...
/**
 * <p> The input provided fails to satisfy the constraints specified by an Amazon
 * Web Services service. </p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/bcm-pricing-calculator-2024-06-19/ValidationException">AWS
 * API Reference</a></p>
 */
class ValidationException {
 public:
  AWS_BCMPRICINGCALCULATOR_API ValidationException() = default;
  AWS_BCMPRICINGCALCULATOR_API ValidationException(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_BCMPRICINGCALCULATOR_API ValidationException& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
