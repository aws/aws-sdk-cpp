...
class UsageQuantity {
 public:
  ...
  AWS_BCMPRICINGCALCULATOR_API UsageQuantity(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_BCMPRICINGCALCULATOR_API UsageQuantity& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  void SetStartHour(StartHourT&& value) {
    m_startHourHasBeenSet = true;
    m_startHour = std::forward<StartHourT>(value);
  }
  template <typename StartHourT = Aws::Utils::DateTime>
  UsageQuantity& WithStartHour(StartHourT&& value) {
    SetStartHour(std::forward<StartHourT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename UnitT = Aws::String>
  UsageQuantity& WithUnit(UnitT&& value) {
  ...
  inline UsageQuantity& WithAmount(double value) {
    SetAmount(value);
    return *this;
  }
  ///@}
