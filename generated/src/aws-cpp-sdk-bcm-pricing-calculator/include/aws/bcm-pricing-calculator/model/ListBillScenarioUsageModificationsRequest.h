...
class ListBillScenarioUsageModificationsRequest : public BCMPricingCalculatorRequest {
 public:
  ...
  template <typename BillScenarioIdT = Aws::String>
  ListBillScenarioUsageModificationsRequest& WithBillScenarioId(BillScenarioIdT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<ListUsageFilter>>
  ListBillScenarioUsageModificationsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = ListUsageFilter>
  ListBillScenarioUsageModificationsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListBillScenarioUsageModificationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListBillScenarioUsageModificationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
