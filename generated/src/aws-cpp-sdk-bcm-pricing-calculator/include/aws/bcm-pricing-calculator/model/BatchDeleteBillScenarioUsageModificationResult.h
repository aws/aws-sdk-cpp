...
class BatchDeleteBillScenarioUsageModificationResult {
 public:
  ...
  template <typename ErrorsT = Aws::Vector<BatchDeleteBillScenarioUsageModificationError>>
  BatchDeleteBillScenarioUsageModificationResult& WithErrors(ErrorsT&& value) {
    SetErrors(std::forward<ErrorsT>(value));
    return *this;
  }
  template <typename ErrorsT = BatchDeleteBillScenarioUsageModificationError>
  BatchDeleteBillScenarioUsageModificationResult& AddErrors(ErrorsT&& value) {
    m_errorsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  BatchDeleteBillScenarioUsageModificationResult& WithRequestId(RequestIdT&& value) {
