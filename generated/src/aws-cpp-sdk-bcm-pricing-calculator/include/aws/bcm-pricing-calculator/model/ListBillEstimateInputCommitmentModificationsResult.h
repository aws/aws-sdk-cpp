...
class ListBillEstimateInputCommitmentModificationsResult {
 public:
  ...
  AWS_BCMPRICINGCALCULATOR_API ListBillEstimateInputCommitmentModificationsResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ItemsT = Aws::Vector<BillEstimateInputCommitmentModificationSummary>>
  ListBillEstimateInputCommitmentModificationsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = BillEstimateInputCommitmentModificationSummary>
  ListBillEstimateInputCommitmentModificationsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListBillEstimateInputCommitmentModificationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListBillEstimateInputCommitmentModificationsResult& WithRequestId(RequestIdT&& value) {
