...
class BillEstimateCommitmentSummary {
 public:
  ...
  AWS_BCMPRICINGCALCULATOR_API BillEstimateCommitmentSummary(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_BCMPRICINGCALCULATOR_API BillEstimateCommitmentSummary& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  template <typename IdT = Aws::String>
  BillEstimateCommitmentSummary& WithId(IdT&& value) {
  ...
  inline void SetPurchaseAgreementType(PurchaseAgreementType value) {
    m_purchaseAgreementTypeHasBeenSet = true;
    m_purchaseAgreementType = value;
  }
  inline BillEstimateCommitmentSummary& WithPurchaseAgreementType(PurchaseAgreementType value) {
    SetPurchaseAgreementType(value);
    return *this;
  }
  ///@}
  ...
  template <typename OfferingIdT = Aws::String>
  BillEstimateCommitmentSummary& WithOfferingId(OfferingIdT&& value) {
  ...
  template <typename UsageAccountIdT = Aws::String>
  BillEstimateCommitmentSummary& WithUsageAccountId(UsageAccountIdT&& value) {
  ...
  template <typename RegionT = Aws::String>
  BillEstimateCommitmentSummary& WithRegion(RegionT&& value) {
  ...
  void SetTermLength(TermLengthT&& value) {
    m_termLengthHasBeenSet = true;
    m_termLength = std::forward<TermLengthT>(value);
  }
  template <typename TermLengthT = Aws::String>
  BillEstimateCommitmentSummary& WithTermLength(TermLengthT&& value) {
    SetTermLength(std::forward<TermLengthT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename PaymentOptionT = Aws::String>
  BillEstimateCommitmentSummary& WithPaymentOption(PaymentOptionT&& value) {
  ...
  void SetUpfrontPayment(UpfrontPaymentT&& value) {
    m_upfrontPaymentHasBeenSet = true;
    m_upfrontPayment = std::forward<UpfrontPaymentT>(value);
  }
  template <typename UpfrontPaymentT = CostAmount>
  BillEstimateCommitmentSummary& WithUpfrontPayment(UpfrontPaymentT&& value) {
    SetUpfrontPayment(std::forward<UpfrontPaymentT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMonthlyPayment(MonthlyPaymentT&& value) {
    m_monthlyPaymentHasBeenSet = true;
    m_monthlyPayment = std::forward<MonthlyPaymentT>(value);
  }
  template <typename MonthlyPaymentT = CostAmount>
  BillEstimateCommitmentSummary& WithMonthlyPayment(MonthlyPaymentT&& value) {
    SetMonthlyPayment(std::forward<MonthlyPaymentT>(value));
    return *this;
  }
  ///@}
 private:
