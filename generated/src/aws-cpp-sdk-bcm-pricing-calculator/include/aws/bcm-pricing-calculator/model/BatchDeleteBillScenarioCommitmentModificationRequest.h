...
class BatchDeleteBillScenarioCommitmentModificationRequest : public BCMPricingCalculatorRequest {
 public:
  ...
  template <typename BillScenarioIdT = Aws::String>
  BatchDeleteBillScenarioCommitmentModificationRequest& WithBillScenarioId(BillScenarioIdT&& value) {
  ...
  template <typename IdsT = Aws::Vector<Aws::String>>
  BatchDeleteBillScenarioCommitmentModificationRequest& WithIds(IdsT&& value) {
    SetIds(std::forward<IdsT>(value));
    return *this;
  }
  template <typename IdsT = Aws::String>
  BatchDeleteBillScenarioCommitmentModificationRequest& AddIds(IdsT&& value) {
    m_idsHasBeenSet = true;
