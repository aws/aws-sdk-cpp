...
class BatchCreateBillScenarioCommitmentModificationRequest : public BCMPricingCalculatorRequest {
 public:
  ...
  template <typename BillScenarioIdT = Aws::String>
  BatchCreateBillScenarioCommitmentModificationRequest& WithBillScenarioId(BillScenarioIdT&& value) {
   ...
   */
  inline const Aws::Vector<BatchCreateBillScenarioCommitmentModificationEntry>& GetCommitmentModifications() const {
    return m_commitmentModifications;
  }
  ...
  void SetCommitmentModifications(CommitmentModificationsT&& value) {
    m_commitmentModificationsHasBeenSet = true;
    m_commitmentModifications = std::forward<CommitmentModificationsT>(value);
  }
  template <typename CommitmentModificationsT = Aws::Vector<BatchCreateBillScenarioCommitmentModificationEntry>>
  BatchCreateBillScenarioCommitmentModificationRequest& WithCommitmentModifications(CommitmentModificationsT&& value) {
    SetCommitmentModifications(std::forward<CommitmentModificationsT>(value));
    return *this;
  }
  template <typename CommitmentModificationsT = BatchCreateBillScenarioCommitmentModificationEntry>
  BatchCreateBillScenarioCommitmentModificationRequest& AddCommitmentModifications(CommitmentModificationsT&& value) {
    m_commitmentModificationsHasBeenSet = true;
    m_commitmentModifications.emplace_back(std::forward<CommitmentModificationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ClientTokenT = Aws::String>
  BatchCreateBillScenarioCommitmentModificationRequest& WithClientToken(ClientTokenT&& value) {
