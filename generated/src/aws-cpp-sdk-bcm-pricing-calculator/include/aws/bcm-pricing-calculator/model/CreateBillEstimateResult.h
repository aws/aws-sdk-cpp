...
class CreateBillEstimateResult {
 public:
  ...
  AWS_BCMPRICINGCALCULATOR_API CreateBillEstimateResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_BCMPRICINGCALCULATOR_API CreateBillEstimateResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  template <typename IdT = Aws::String>
  CreateBillEstimateResult& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateBillEstimateResult& WithName(NameT&& value) {
  ...
  inline CreateBillEstimateResult& WithStatus(BillEstimateStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename FailureMessageT = Aws::String>
  CreateBillEstimateResult& WithFailureMessage(FailureMessageT&& value) {
  ...
  template <typename BillIntervalT = BillInterval>
  CreateBillEstimateResult& WithBillInterval(BillIntervalT&& value) {
  ...
  template <typename CostSummaryT = BillEstimateCostSummary>
  CreateBillEstimateResult& WithCostSummary(CostSummaryT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  CreateBillEstimateResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename ExpiresAtT = Aws::Utils::DateTime>
  CreateBillEstimateResult& WithExpiresAt(ExpiresAtT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateBillEstimateResult& WithRequestId(RequestIdT&& value) {
