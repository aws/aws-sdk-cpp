...
class UsageQuantityResult {
 public:
  ...
  AWS_BCMPRICINGCALCULATOR_API UsageQuantityResult(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_BCMPRICINGCALCULATOR_API UsageQuantityResult& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline UsageQuantityResult& WithAmount(double value) {
    SetAmount(value);
    return *this;
  }
  ///@}
  ...
  template <typename UnitT = Aws::String>
  UsageQuantityResult& WithUnit(UnitT&& value) {
