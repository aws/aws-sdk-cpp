...
class BatchCreateBillScenarioUsageModificationRequest : public BCMPricingCalculatorRequest {
 public:
  ...
  template <typename BillScenarioIdT = Aws::String>
  BatchCreateBillScenarioUsageModificationRequest& WithBillScenarioId(BillScenarioIdT&& value) {
  ...
  template <typename UsageModificationsT = Aws::Vector<BatchCreateBillScenarioUsageModificationEntry>>
  BatchCreateBillScenarioUsageModificationRequest& WithUsageModifications(UsageModificationsT&& value) {
  ...
  BatchCreateBillScenarioUsageModificationRequest& AddUsageModifications(UsageModificationsT&& value) {
    m_usageModificationsHasBeenSet = true;
  ...
  template <typename ClientTokenT = Aws::String>
  BatchCreateBillScenarioUsageModificationRequest& WithClientToken(ClientTokenT&& value) {
