...
class BillEstimateSummary {
 public:
  ...
  AWS_BCMPRICINGCALCULATOR_API BillEstimateSummary(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_BCMPRICINGCALCULATOR_API BillEstimateSummary& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  template <typename IdT = Aws::String>
  BillEstimateSummary& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  BillEstimateSummary& WithName(NameT&& value) {
  ...
  inline BillEstimateSummary& WithStatus(BillEstimateStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename BillIntervalT = BillInterval>
  BillEstimateSummary& WithBillInterval(BillIntervalT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  BillEstimateSummary& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename ExpiresAtT = Aws::Utils::DateTime>
  BillEstimateSummary& WithExpiresAt(ExpiresAtT&& value) {
