...
class BatchCreateBillScenarioUsageModificationItem {
 public:
  ...
  template <typename ServiceCodeT = Aws::String>
  BatchCreateBillScenarioUsageModificationItem& WithServiceCode(ServiceCodeT&& value) {
  ...
  template <typename UsageTypeT = Aws::String>
  BatchCreateBillScenarioUsageModificationItem& WithUsageType(UsageTypeT&& value) {
  ...
  template <typename OperationT = Aws::String>
  BatchCreateBillScenarioUsageModificationItem& WithOperation(OperationT&& value) {
  ...
  template <typename LocationT = Aws::String>
  BatchCreateBillScenarioUsageModificationItem& WithLocation(LocationT&& value) {
  ...
  template <typename AvailabilityZoneT = Aws::String>
  BatchCreateBillScenarioUsageModificationItem& WithAvailabilityZone(AvailabilityZoneT&& value) {
  ...
  template <typename IdT = Aws::String>
  BatchCreateBillScenarioUsageModificationItem& WithId(IdT&& value) {
  ...
  template <typename GroupT = Aws::String>
  BatchCreateBillScenarioUsageModificationItem& WithGroup(GroupT&& value) {
  ...
  template <typename UsageAccountIdT = Aws::String>
  BatchCreateBillScenarioUsageModificationItem& WithUsageAccountId(UsageAccountIdT&& value) {
  ...
  void SetQuantities(QuantitiesT&& value) {
    m_quantitiesHasBeenSet = true;
    m_quantities = std::forward<QuantitiesT>(value);
  }
  template <typename QuantitiesT = Aws::Vector<UsageQuantity>>
  BatchCreateBillScenarioUsageModificationItem& WithQuantities(QuantitiesT&& value) {
    SetQuantities(std::forward<QuantitiesT>(value));
    return *this;
  }
  template <typename QuantitiesT = UsageQuantity>
  BatchCreateBillScenarioUsageModificationItem& AddQuantities(QuantitiesT&& value) {
    m_quantitiesHasBeenSet = true;
    m_quantities.emplace_back(std::forward<QuantitiesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename HistoricalUsageT = HistoricalUsageEntity>
  BatchCreateBillScenarioUsageModificationItem& WithHistoricalUsage(HistoricalUsageT&& value) {
  ...
  template <typename KeyT = Aws::String>
  BatchCreateBillScenarioUsageModificationItem& WithKey(KeyT&& value) {
