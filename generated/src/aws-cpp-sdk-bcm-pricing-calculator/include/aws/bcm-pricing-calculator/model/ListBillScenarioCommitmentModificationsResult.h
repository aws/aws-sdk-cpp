...
class ListBillScenarioCommitmentModificationsResult {
 public:
  ...
  AWS_BCMPRICINGCALCULATOR_API ListBillScenarioCommitmentModificationsResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ItemsT = Aws::Vector<BillScenarioCommitmentModificationItem>>
  ListBillScenarioCommitmentModificationsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = BillScenarioCommitmentModificationItem>
  ListBillScenarioCommitmentModificationsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListBillScenarioCommitmentModificationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListBillScenarioCommitmentModificationsResult& WithRequestId(RequestIdT&& value) {
