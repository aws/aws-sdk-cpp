...
class ListWorkloadEstimateUsageRequest : public BCMPricingCalculatorRequest {
 public:
  ...
  void SetWorkloadEstimateId(WorkloadEstimateIdT&& value) {
    m_workloadEstimateIdHasBeenSet = true;
    m_workloadEstimateId = std::forward<WorkloadEstimateIdT>(value);
  }
  template <typename WorkloadEstimateIdT = Aws::String>
  ListWorkloadEstimateUsageRequest& WithWorkloadEstimateId(WorkloadEstimateIdT&& value) {
    SetWorkloadEstimateId(std::forward<WorkloadEstimateIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<ListUsageFilter>>
  ListWorkloadEstimateUsageRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = ListUsageFilter>
  ListWorkloadEstimateUsageRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListWorkloadEstimateUsageRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListWorkloadEstimateUsageRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
