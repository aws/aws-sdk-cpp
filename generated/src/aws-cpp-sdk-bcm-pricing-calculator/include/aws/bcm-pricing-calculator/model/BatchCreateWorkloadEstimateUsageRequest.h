...
class BatchCreateWorkloadEstimateUsageRequest : public BCMPricingCalculatorRequest {
 public:
  ...
  template <typename WorkloadEstimateIdT = Aws::String>
  BatchCreateWorkloadEstimateUsageRequest& WithWorkloadEstimateId(WorkloadEstimateIdT&& value) {
  ...
  template <typename UsageT = Aws::Vector<BatchCreateWorkloadEstimateUsageEntry>>
  BatchCreateWorkloadEstimateUsageRequest& WithUsage(UsageT&& value) {
    SetUsage(std::forward<UsageT>(value));
    return *this;
  }
  template <typename UsageT = BatchCreateWorkloadEstimateUsageEntry>
  BatchCreateWorkloadEstimateUsageRequest& AddUsage(UsageT&& value) {
    m_usageHasBeenSet = true;
  ...
  template <typename ClientTokenT = Aws::String>
  BatchCreateWorkloadEstimateUsageRequest& WithClientToken(ClientTokenT&& value) {
