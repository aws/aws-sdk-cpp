...
class GetBillScenarioResult {
 public:
  ...
  AWS_BCMPRICINGCALCULATOR_API GetBillScenarioResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_BCMPRICINGCALCULATOR_API GetBillScenarioResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
