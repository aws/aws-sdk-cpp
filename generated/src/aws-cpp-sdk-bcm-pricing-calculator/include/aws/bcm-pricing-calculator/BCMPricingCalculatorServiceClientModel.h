...
typedef Aws::Utils::Outcome<BatchCreateBillScenarioCommitmentModificationResult, BCMPricingCalculatorError>
    BatchCreateBillScenarioCommitmentModificationOutcome;
typedef Aws::Utils::Outcome<BatchCreateBillScenarioUsageModificationResult, BCMPricingCalculatorError>
...
typedef Aws::Utils::Outcome<BatchDeleteBillScenarioCommitmentModificationResult, BCMPricingCalculatorError>
    BatchDeleteBillScenarioCommitmentModificationOutcome;
typedef Aws::Utils::Outcome<BatchDeleteBillScenarioUsageModificationResult, BCMPricingCalculatorError>
...
typedef Aws::Utils::Outcome<BatchUpdateBillScenarioCommitmentModificationResult, BCMPricingCalculatorError>
    BatchUpdateBillScenarioCommitmentModificationOutcome;
typedef Aws::Utils::Outcome<BatchUpdateBillScenarioUsageModificationResult, BCMPricingCalculatorError>
...
typedef Aws::Utils::Outcome<ListBillEstimateInputCommitmentModificationsResult, BCMPricingCalculatorError>
    ListBillEstimateInputCommitmentModificationsOutcome;
typedef Aws::Utils::Outcome<ListBillEstimateInputUsageModificationsResult, BCMPricingCalculatorError>
...
typedef Aws::Utils::Outcome<ListBillScenarioCommitmentModificationsResult, BCMPricingCalculatorError>
...
typedef std::function<void(const BCMPricingCalculatorClient*, const Model::BatchCreateBillScenarioCommitmentModificationRequest&,
                           const Model::BatchCreateBillScenarioCommitmentModificationOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    BatchCreateBillScenarioCommitmentModificationResponseReceivedHandler;
typedef std::function<void(const BCMPricingCalculatorClient*, const Model::BatchCreateBillScenarioUsageModificationRequest&,
                           const Model::BatchCreateBillScenarioUsageModificationOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    BatchCreateBillScenarioUsageModificationResponseReceivedHandler;
typedef std::function<void(const BCMPricingCalculatorClient*, const Model::BatchCreateWorkloadEstimateUsageRequest&,
                           const Model::BatchCreateWorkloadEstimateUsageOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    BatchCreateWorkloadEstimateUsageResponseReceivedHandler;
typedef std::function<void(const BCMPricingCalculatorClient*, const Model::BatchDeleteBillScenarioCommitmentModificationRequest&,
                           const Model::BatchDeleteBillScenarioCommitmentModificationOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    BatchDeleteBillScenarioCommitmentModificationResponseReceivedHandler;
typedef std::function<void(const BCMPricingCalculatorClient*, const Model::BatchDeleteBillScenarioUsageModificationRequest&,
                           const Model::BatchDeleteBillScenarioUsageModificationOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    BatchDeleteBillScenarioUsageModificationResponseReceivedHandler;
typedef std::function<void(const BCMPricingCalculatorClient*, const Model::BatchDeleteWorkloadEstimateUsageRequest&,
                           const Model::BatchDeleteWorkloadEstimateUsageOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    BatchDeleteWorkloadEstimateUsageResponseReceivedHandler;
typedef std::function<void(const BCMPricingCalculatorClient*, const Model::BatchUpdateBillScenarioCommitmentModificationRequest&,
                           const Model::BatchUpdateBillScenarioCommitmentModificationOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    BatchUpdateBillScenarioCommitmentModificationResponseReceivedHandler;
typedef std::function<void(const BCMPricingCalculatorClient*, const Model::BatchUpdateBillScenarioUsageModificationRequest&,
                           const Model::BatchUpdateBillScenarioUsageModificationOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    BatchUpdateBillScenarioUsageModificationResponseReceivedHandler;
typedef std::function<void(const BCMPricingCalculatorClient*, const Model::BatchUpdateWorkloadEstimateUsageRequest&,
                           const Model::BatchUpdateWorkloadEstimateUsageOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    BatchUpdateWorkloadEstimateUsageResponseReceivedHandler;
typedef std::function<void(const BCMPricingCalculatorClient*, const Model::CreateBillEstimateRequest&,
                           const Model::CreateBillEstimateOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CreateBillEstimateResponseReceivedHandler;
typedef std::function<void(const BCMPricingCalculatorClient*, const Model::CreateBillScenarioRequest&,
                           const Model::CreateBillScenarioOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CreateBillScenarioResponseReceivedHandler;
typedef std::function<void(const BCMPricingCalculatorClient*, const Model::CreateWorkloadEstimateRequest&,
                           const Model::CreateWorkloadEstimateOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CreateWorkloadEstimateResponseReceivedHandler;
typedef std::function<void(const BCMPricingCalculatorClient*, const Model::DeleteBillEstimateRequest&,
                           const Model::DeleteBillEstimateOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteBillEstimateResponseReceivedHandler;
typedef std::function<void(const BCMPricingCalculatorClient*, const Model::DeleteBillScenarioRequest&,
                           const Model::DeleteBillScenarioOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteBillScenarioResponseReceivedHandler;
typedef std::function<void(const BCMPricingCalculatorClient*, const Model::DeleteWorkloadEstimateRequest&,
                           const Model::DeleteWorkloadEstimateOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteWorkloadEstimateResponseReceivedHandler;
typedef std::function<void(const BCMPricingCalculatorClient*, const Model::GetBillEstimateRequest&, const Model::GetBillEstimateOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetBillEstimateResponseReceivedHandler;
typedef std::function<void(const BCMPricingCalculatorClient*, const Model::GetBillScenarioRequest&, const Model::GetBillScenarioOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetBillScenarioResponseReceivedHandler;
typedef std::function<void(const BCMPricingCalculatorClient*, const Model::GetPreferencesRequest&, const Model::GetPreferencesOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetPreferencesResponseReceivedHandler;
typedef std::function<void(const BCMPricingCalculatorClient*, const Model::GetWorkloadEstimateRequest&,
                           const Model::GetWorkloadEstimateOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetWorkloadEstimateResponseReceivedHandler;
typedef std::function<void(const BCMPricingCalculatorClient*, const Model::ListBillEstimateCommitmentsRequest&,
                           const Model::ListBillEstimateCommitmentsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListBillEstimateCommitmentsResponseReceivedHandler;
typedef std::function<void(const BCMPricingCalculatorClient*, const Model::ListBillEstimateInputCommitmentModificationsRequest&,
                           const Model::ListBillEstimateInputCommitmentModificationsOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListBillEstimateInputCommitmentModificationsResponseReceivedHandler;
typedef std::function<void(const BCMPricingCalculatorClient*, const Model::ListBillEstimateInputUsageModificationsRequest&,
                           const Model::ListBillEstimateInputUsageModificationsOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListBillEstimateInputUsageModificationsResponseReceivedHandler;
typedef std::function<void(const BCMPricingCalculatorClient*, const Model::ListBillEstimateLineItemsRequest&,
                           const Model::ListBillEstimateLineItemsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListBillEstimateLineItemsResponseReceivedHandler;
typedef std::function<void(const BCMPricingCalculatorClient*, const Model::ListBillEstimatesRequest&,
                           const Model::ListBillEstimatesOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListBillEstimatesResponseReceivedHandler;
typedef std::function<void(const BCMPricingCalculatorClient*, const Model::ListBillScenarioCommitmentModificationsRequest&,
                           const Model::ListBillScenarioCommitmentModificationsOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListBillScenarioCommitmentModificationsResponseReceivedHandler;
typedef std::function<void(const BCMPricingCalculatorClient*, const Model::ListBillScenarioUsageModificationsRequest&,
                           const Model::ListBillScenarioUsageModificationsOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListBillScenarioUsageModificationsResponseReceivedHandler;
typedef std::function<void(const BCMPricingCalculatorClient*, const Model::ListBillScenariosRequest&,
                           const Model::ListBillScenariosOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListBillScenariosResponseReceivedHandler;
typedef std::function<void(const BCMPricingCalculatorClient*, const Model::ListTagsForResourceRequest&,
                           const Model::ListTagsForResourceOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListTagsForResourceResponseReceivedHandler;
typedef std::function<void(const BCMPricingCalculatorClient*, const Model::ListWorkloadEstimateUsageRequest&,
                           const Model::ListWorkloadEstimateUsageOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListWorkloadEstimateUsageResponseReceivedHandler;
typedef std::function<void(const BCMPricingCalculatorClient*, const Model::ListWorkloadEstimatesRequest&,
                           const Model::ListWorkloadEstimatesOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListWorkloadEstimatesResponseReceivedHandler;
typedef std::function<void(const BCMPricingCalculatorClient*, const Model::TagResourceRequest&, const Model::TagResourceOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    TagResourceResponseReceivedHandler;
typedef std::function<void(const BCMPricingCalculatorClient*, const Model::UntagResourceRequest&, const Model::UntagResourceOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    UntagResourceResponseReceivedHandler;
typedef std::function<void(const BCMPricingCalculatorClient*, const Model::UpdateBillEstimateRequest&,
                           const Model::UpdateBillEstimateOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    UpdateBillEstimateResponseReceivedHandler;
typedef std::function<void(const BCMPricingCalculatorClient*, const Model::UpdateBillScenarioRequest&,
                           const Model::UpdateBillScenarioOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    UpdateBillScenarioResponseReceivedHandler;
typedef std::function<void(const BCMPricingCalculatorClient*, const Model::UpdatePreferencesRequest&,
                           const Model::UpdatePreferencesOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    UpdatePreferencesResponseReceivedHandler;
typedef std::function<void(const BCMPricingCalculatorClient*, const Model::UpdateWorkloadEstimateRequest&,
                           const Model::UpdateWorkloadEstimateOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    UpdateWorkloadEstimateResponseReceivedHandler;
