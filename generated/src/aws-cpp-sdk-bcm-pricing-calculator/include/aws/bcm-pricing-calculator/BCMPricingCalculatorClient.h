...
namespace BCMPricingCalculator
{
   ...
   */
  class AWS_BCMPRICINGCALCULATOR_API BCMPricingCalculatorClient : Aws::Client::ClientWithAsyncTemplateMethods<BCMPricingCalculatorClient>,
    smithy::client::AwsSmithyClientT<Aws::BCMPricingCalculator::SERVICE_NAME,
