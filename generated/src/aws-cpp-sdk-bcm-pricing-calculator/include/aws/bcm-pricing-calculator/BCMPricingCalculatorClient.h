...
class AWS_BCMPRICINGCALCULATOR_API BCMPricingCalculatorClient
 ...
 public:
   ...
   */
  BCMPricingCalculatorClient(const Aws::BCMPricingCalculator::BCMPricingCalculatorClientConfiguration& clientConfiguration =
  ...
  BCMPricingCalculatorClient(const Aws::Auth::AWSCredentials& credentials,
                             std::shared_ptr<BCMPricingCalculatorEndpointProviderBase> endpointProvider = nullptr,
                             const Aws::BCMPricingCalculator::BCMPricingCalculatorClientConfiguration& clientConfiguration =
                                 Aws::BCMPricingCalculator::BCMPricingCalculatorClientConfiguration());
   ...
   * is not specified, it will be initialized to default values.
   */
  BCMPricingCalculatorClient(const Aws::Auth::AWSCredentials& credentials, const Aws::Client::ClientConfiguration& clientConfiguration);
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchCreateBillScenarioCommitmentModificationOutcome BatchCreateBillScenarioCommitmentModification(
      const Model::BatchCreateBillScenarioCommitmentModificationRequest& request) const;

  /**
   * A Callable wrapper for BatchCreateBillScenarioCommitmentModification that returns a future to the operation so that it can be executed
  ...
  Model::BatchCreateBillScenarioCommitmentModificationOutcomeCallable BatchCreateBillScenarioCommitmentModificationCallable(
      const BatchCreateBillScenarioCommitmentModificationRequestT& request) const {
    return SubmitCallable(&BCMPricingCalculatorClient::BatchCreateBillScenarioCommitmentModification, request);
  }

  /**
   * An Async wrapper for BatchCreateBillScenarioCommitmentModification that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename BatchCreateBillScenarioCommitmentModificationRequestT = Model::BatchCreateBillScenarioCommitmentModificationRequest>
  void BatchCreateBillScenarioCommitmentModificationAsync(
      const BatchCreateBillScenarioCommitmentModificationRequestT& request,
      const BatchCreateBillScenarioCommitmentModificationResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchCreateBillScenarioUsageModificationOutcome BatchCreateBillScenarioUsageModification(
      const Model::BatchCreateBillScenarioUsageModificationRequest& request) const;

  /**
   * A Callable wrapper for BatchCreateBillScenarioUsageModification that returns a future to the operation so that it can be executed in
  ...
  Model::BatchCreateBillScenarioUsageModificationOutcomeCallable BatchCreateBillScenarioUsageModificationCallable(
      const BatchCreateBillScenarioUsageModificationRequestT& request) const {
    return SubmitCallable(&BCMPricingCalculatorClient::BatchCreateBillScenarioUsageModification, request);
  }

  /**
   * An Async wrapper for BatchCreateBillScenarioUsageModification that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename BatchCreateBillScenarioUsageModificationRequestT = Model::BatchCreateBillScenarioUsageModificationRequest>
  void BatchCreateBillScenarioUsageModificationAsync(
      const BatchCreateBillScenarioUsageModificationRequestT& request,
      const BatchCreateBillScenarioUsageModificationResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchCreateWorkloadEstimateUsageOutcome BatchCreateWorkloadEstimateUsage(
      const Model::BatchCreateWorkloadEstimateUsageRequest& request) const;

  /**
   * A Callable wrapper for BatchCreateWorkloadEstimateUsage that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename BatchCreateWorkloadEstimateUsageRequestT = Model::BatchCreateWorkloadEstimateUsageRequest>
  Model::BatchCreateWorkloadEstimateUsageOutcomeCallable BatchCreateWorkloadEstimateUsageCallable(
      const BatchCreateWorkloadEstimateUsageRequestT& request) const {
    return SubmitCallable(&BCMPricingCalculatorClient::BatchCreateWorkloadEstimateUsage, request);
  }

  /**
   * An Async wrapper for BatchCreateWorkloadEstimateUsage that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename BatchCreateWorkloadEstimateUsageRequestT = Model::BatchCreateWorkloadEstimateUsageRequest>
  void BatchCreateWorkloadEstimateUsageAsync(const BatchCreateWorkloadEstimateUsageRequestT& request,
                                             const BatchCreateWorkloadEstimateUsageResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchDeleteBillScenarioCommitmentModificationOutcome BatchDeleteBillScenarioCommitmentModification(
      const Model::BatchDeleteBillScenarioCommitmentModificationRequest& request) const;

  /**
   * A Callable wrapper for BatchDeleteBillScenarioCommitmentModification that returns a future to the operation so that it can be executed
   * in parallel to other requests.
   */
  ...
  Model::BatchDeleteBillScenarioCommitmentModificationOutcomeCallable BatchDeleteBillScenarioCommitmentModificationCallable(
      const BatchDeleteBillScenarioCommitmentModificationRequestT& request) const {
    return SubmitCallable(&BCMPricingCalculatorClient::BatchDeleteBillScenarioCommitmentModification, request);
  }

  /**
   * An Async wrapper for BatchDeleteBillScenarioCommitmentModification that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename BatchDeleteBillScenarioCommitmentModificationRequestT = Model::BatchDeleteBillScenarioCommitmentModificationRequest>
  void BatchDeleteBillScenarioCommitmentModificationAsync(
      const BatchDeleteBillScenarioCommitmentModificationRequestT& request,
      const BatchDeleteBillScenarioCommitmentModificationResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchDeleteBillScenarioUsageModificationOutcome BatchDeleteBillScenarioUsageModification(
      const Model::BatchDeleteBillScenarioUsageModificationRequest& request) const;

  /**
   * A Callable wrapper for BatchDeleteBillScenarioUsageModification that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename BatchDeleteBillScenarioUsageModificationRequestT = Model::BatchDeleteBillScenarioUsageModificationRequest>
  Model::BatchDeleteBillScenarioUsageModificationOutcomeCallable BatchDeleteBillScenarioUsageModificationCallable(
      const BatchDeleteBillScenarioUsageModificationRequestT& request) const {
    return SubmitCallable(&BCMPricingCalculatorClient::BatchDeleteBillScenarioUsageModification, request);
  }

  /**
   * An Async wrapper for BatchDeleteBillScenarioUsageModification that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename BatchDeleteBillScenarioUsageModificationRequestT = Model::BatchDeleteBillScenarioUsageModificationRequest>
  void BatchDeleteBillScenarioUsageModificationAsync(
      const BatchDeleteBillScenarioUsageModificationRequestT& request,
      const BatchDeleteBillScenarioUsageModificationResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchDeleteWorkloadEstimateUsageOutcome BatchDeleteWorkloadEstimateUsage(
      const Model::BatchDeleteWorkloadEstimateUsageRequest& request) const;

  /**
   * A Callable wrapper for BatchDeleteWorkloadEstimateUsage that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename BatchDeleteWorkloadEstimateUsageRequestT = Model::BatchDeleteWorkloadEstimateUsageRequest>
  Model::BatchDeleteWorkloadEstimateUsageOutcomeCallable BatchDeleteWorkloadEstimateUsageCallable(
      const BatchDeleteWorkloadEstimateUsageRequestT& request) const {
    return SubmitCallable(&BCMPricingCalculatorClient::BatchDeleteWorkloadEstimateUsage, request);
  }

  /**
   * An Async wrapper for BatchDeleteWorkloadEstimateUsage that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename BatchDeleteWorkloadEstimateUsageRequestT = Model::BatchDeleteWorkloadEstimateUsageRequest>
  void BatchDeleteWorkloadEstimateUsageAsync(const BatchDeleteWorkloadEstimateUsageRequestT& request,
                                             const BatchDeleteWorkloadEstimateUsageResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchUpdateBillScenarioCommitmentModificationOutcome BatchUpdateBillScenarioCommitmentModification(
      const Model::BatchUpdateBillScenarioCommitmentModificationRequest& request) const;

  /**
   * A Callable wrapper for BatchUpdateBillScenarioCommitmentModification that returns a future to the operation so that it can be executed
   * in parallel to other requests.
   */
  ...
  Model::BatchUpdateBillScenarioCommitmentModificationOutcomeCallable BatchUpdateBillScenarioCommitmentModificationCallable(
      const BatchUpdateBillScenarioCommitmentModificationRequestT& request) const {
    return SubmitCallable(&BCMPricingCalculatorClient::BatchUpdateBillScenarioCommitmentModification, request);
  }

  /**
   * An Async wrapper for BatchUpdateBillScenarioCommitmentModification that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename BatchUpdateBillScenarioCommitmentModificationRequestT = Model::BatchUpdateBillScenarioCommitmentModificationRequest>
  void BatchUpdateBillScenarioCommitmentModificationAsync(
      const BatchUpdateBillScenarioCommitmentModificationRequestT& request,
      const BatchUpdateBillScenarioCommitmentModificationResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchUpdateBillScenarioUsageModificationOutcome BatchUpdateBillScenarioUsageModification(
      const Model::BatchUpdateBillScenarioUsageModificationRequest& request) const;

  /**
   * A Callable wrapper for BatchUpdateBillScenarioUsageModification that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename BatchUpdateBillScenarioUsageModificationRequestT = Model::BatchUpdateBillScenarioUsageModificationRequest>
  Model::BatchUpdateBillScenarioUsageModificationOutcomeCallable BatchUpdateBillScenarioUsageModificationCallable(
      const BatchUpdateBillScenarioUsageModificationRequestT& request) const {
    return SubmitCallable(&BCMPricingCalculatorClient::BatchUpdateBillScenarioUsageModification, request);
  }

  /**
   * An Async wrapper for BatchUpdateBillScenarioUsageModification that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename BatchUpdateBillScenarioUsageModificationRequestT = Model::BatchUpdateBillScenarioUsageModificationRequest>
  void BatchUpdateBillScenarioUsageModificationAsync(
      const BatchUpdateBillScenarioUsageModificationRequestT& request,
      const BatchUpdateBillScenarioUsageModificationResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchUpdateWorkloadEstimateUsageOutcome BatchUpdateWorkloadEstimateUsage(
      const Model::BatchUpdateWorkloadEstimateUsageRequest& request) const;

  /**
   * A Callable wrapper for BatchUpdateWorkloadEstimateUsage that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename BatchUpdateWorkloadEstimateUsageRequestT = Model::BatchUpdateWorkloadEstimateUsageRequest>
  Model::BatchUpdateWorkloadEstimateUsageOutcomeCallable BatchUpdateWorkloadEstimateUsageCallable(
      const BatchUpdateWorkloadEstimateUsageRequestT& request) const {
    return SubmitCallable(&BCMPricingCalculatorClient::BatchUpdateWorkloadEstimateUsage, request);
  }

  /**
   * An Async wrapper for BatchUpdateWorkloadEstimateUsage that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename BatchUpdateWorkloadEstimateUsageRequestT = Model::BatchUpdateWorkloadEstimateUsageRequest>
  void BatchUpdateWorkloadEstimateUsageAsync(const BatchUpdateWorkloadEstimateUsageRequestT& request,
                                             const BatchUpdateWorkloadEstimateUsageResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateBillEstimate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateBillEstimate that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateBillEstimateRequestT = Model::CreateBillEstimateRequest>
  void CreateBillEstimateAsync(const CreateBillEstimateRequestT& request, const CreateBillEstimateResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateBillScenario that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateBillScenario that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateBillScenarioRequestT = Model::CreateBillScenarioRequest>
  void CreateBillScenarioAsync(const CreateBillScenarioRequestT& request, const CreateBillScenarioResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateWorkloadEstimate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateWorkloadEstimate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateWorkloadEstimateRequestT = Model::CreateWorkloadEstimateRequest>
  void CreateWorkloadEstimateAsync(const CreateWorkloadEstimateRequestT& request,
                                   const CreateWorkloadEstimateResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteBillEstimate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteBillEstimate that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteBillEstimateRequestT = Model::DeleteBillEstimateRequest>
  void DeleteBillEstimateAsync(const DeleteBillEstimateRequestT& request, const DeleteBillEstimateResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteBillScenario that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteBillScenario that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteBillScenarioRequestT = Model::DeleteBillScenarioRequest>
  void DeleteBillScenarioAsync(const DeleteBillScenarioRequestT& request, const DeleteBillScenarioResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteWorkloadEstimate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteWorkloadEstimate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteWorkloadEstimateRequestT = Model::DeleteWorkloadEstimateRequest>
  void DeleteWorkloadEstimateAsync(const DeleteWorkloadEstimateRequestT& request,
                                   const DeleteWorkloadEstimateResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetBillEstimate that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetBillEstimateRequestT = Model::GetBillEstimateRequest>
  void GetBillEstimateAsync(const GetBillEstimateRequestT& request, const GetBillEstimateResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetBillScenario that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetBillScenarioRequestT = Model::GetBillScenarioRequest>
  void GetBillScenarioAsync(const GetBillScenarioRequestT& request, const GetBillScenarioResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetWorkloadEstimate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetWorkloadEstimate that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetWorkloadEstimateRequestT = Model::GetWorkloadEstimateRequest>
  void GetWorkloadEstimateAsync(const GetWorkloadEstimateRequestT& request, const GetWorkloadEstimateResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListBillEstimateCommitmentsOutcome ListBillEstimateCommitments(
      const Model::ListBillEstimateCommitmentsRequest& request) const;

  /**
   * A Callable wrapper for ListBillEstimateCommitments that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListBillEstimateCommitmentsRequestT = Model::ListBillEstimateCommitmentsRequest>
  Model::ListBillEstimateCommitmentsOutcomeCallable ListBillEstimateCommitmentsCallable(
      const ListBillEstimateCommitmentsRequestT& request) const {
    return SubmitCallable(&BCMPricingCalculatorClient::ListBillEstimateCommitments, request);
  }

  /**
   * An Async wrapper for ListBillEstimateCommitments that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListBillEstimateCommitmentsRequestT = Model::ListBillEstimateCommitmentsRequest>
  void ListBillEstimateCommitmentsAsync(const ListBillEstimateCommitmentsRequestT& request,
                                        const ListBillEstimateCommitmentsResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListBillEstimateInputCommitmentModificationsOutcome ListBillEstimateInputCommitmentModifications(
      const Model::ListBillEstimateInputCommitmentModificationsRequest& request) const;

  /**
   * A Callable wrapper for ListBillEstimateInputCommitmentModifications that returns a future to the operation so that it can be executed
   * in parallel to other requests.
   */
  ...
  Model::ListBillEstimateInputCommitmentModificationsOutcomeCallable ListBillEstimateInputCommitmentModificationsCallable(
      const ListBillEstimateInputCommitmentModificationsRequestT& request) const {
    return SubmitCallable(&BCMPricingCalculatorClient::ListBillEstimateInputCommitmentModifications, request);
  }

  /**
   * An Async wrapper for ListBillEstimateInputCommitmentModifications that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename ListBillEstimateInputCommitmentModificationsRequestT = Model::ListBillEstimateInputCommitmentModificationsRequest>
  void ListBillEstimateInputCommitmentModificationsAsync(
      const ListBillEstimateInputCommitmentModificationsRequestT& request,
      const ListBillEstimateInputCommitmentModificationsResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListBillEstimateInputUsageModificationsOutcome ListBillEstimateInputUsageModifications(
      const Model::ListBillEstimateInputUsageModificationsRequest& request) const;

  /**
   * A Callable wrapper for ListBillEstimateInputUsageModifications that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListBillEstimateInputUsageModificationsRequestT = Model::ListBillEstimateInputUsageModificationsRequest>
  Model::ListBillEstimateInputUsageModificationsOutcomeCallable ListBillEstimateInputUsageModificationsCallable(
      const ListBillEstimateInputUsageModificationsRequestT& request) const {
    return SubmitCallable(&BCMPricingCalculatorClient::ListBillEstimateInputUsageModifications, request);
  }

  /**
   * An Async wrapper for ListBillEstimateInputUsageModifications that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListBillEstimateInputUsageModificationsRequestT = Model::ListBillEstimateInputUsageModificationsRequest>
  void ListBillEstimateInputUsageModificationsAsync(const ListBillEstimateInputUsageModificationsRequestT& request,
                                                    const ListBillEstimateInputUsageModificationsResponseReceivedHandler& handler,
                                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListBillEstimateLineItems that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListBillEstimateLineItemsRequestT = Model::ListBillEstimateLineItemsRequest>
  Model::ListBillEstimateLineItemsOutcomeCallable ListBillEstimateLineItemsCallable(
      const ListBillEstimateLineItemsRequestT& request) const {
    return SubmitCallable(&BCMPricingCalculatorClient::ListBillEstimateLineItems, request);
  }

  /**
   * An Async wrapper for ListBillEstimateLineItems that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListBillEstimateLineItemsRequestT = Model::ListBillEstimateLineItemsRequest>
  void ListBillEstimateLineItemsAsync(const ListBillEstimateLineItemsRequestT& request,
                                      const ListBillEstimateLineItemsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListBillEstimates that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListBillEstimates that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListBillEstimatesRequestT = Model::ListBillEstimatesRequest>
  void ListBillEstimatesAsync(const ListBillEstimatesResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const ListBillEstimatesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListBillScenarioCommitmentModificationsOutcome ListBillScenarioCommitmentModifications(
      const Model::ListBillScenarioCommitmentModificationsRequest& request) const;

  /**
   * A Callable wrapper for ListBillScenarioCommitmentModifications that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListBillScenarioCommitmentModificationsRequestT = Model::ListBillScenarioCommitmentModificationsRequest>
  Model::ListBillScenarioCommitmentModificationsOutcomeCallable ListBillScenarioCommitmentModificationsCallable(
      const ListBillScenarioCommitmentModificationsRequestT& request) const {
    return SubmitCallable(&BCMPricingCalculatorClient::ListBillScenarioCommitmentModifications, request);
  }

  /**
   * An Async wrapper for ListBillScenarioCommitmentModifications that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListBillScenarioCommitmentModificationsRequestT = Model::ListBillScenarioCommitmentModificationsRequest>
  void ListBillScenarioCommitmentModificationsAsync(const ListBillScenarioCommitmentModificationsRequestT& request,
                                                    const ListBillScenarioCommitmentModificationsResponseReceivedHandler& handler,
                                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListBillScenarioUsageModificationsOutcome ListBillScenarioUsageModifications(
      const Model::ListBillScenarioUsageModificationsRequest& request) const;

  /**
   * A Callable wrapper for ListBillScenarioUsageModifications that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListBillScenarioUsageModificationsRequestT = Model::ListBillScenarioUsageModificationsRequest>
  Model::ListBillScenarioUsageModificationsOutcomeCallable ListBillScenarioUsageModificationsCallable(
      const ListBillScenarioUsageModificationsRequestT& request) const {
    return SubmitCallable(&BCMPricingCalculatorClient::ListBillScenarioUsageModifications, request);
  }

  /**
   * An Async wrapper for ListBillScenarioUsageModifications that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListBillScenarioUsageModificationsRequestT = Model::ListBillScenarioUsageModificationsRequest>
  void ListBillScenarioUsageModificationsAsync(const ListBillScenarioUsageModificationsRequestT& request,
                                               const ListBillScenarioUsageModificationsResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListBillScenarios that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListBillScenarios that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListBillScenariosRequestT = Model::ListBillScenariosRequest>
  void ListBillScenariosAsync(const ListBillScenariosResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const ListBillScenariosRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListWorkloadEstimateUsage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListWorkloadEstimateUsageRequestT = Model::ListWorkloadEstimateUsageRequest>
  Model::ListWorkloadEstimateUsageOutcomeCallable ListWorkloadEstimateUsageCallable(
      const ListWorkloadEstimateUsageRequestT& request) const {
    return SubmitCallable(&BCMPricingCalculatorClient::ListWorkloadEstimateUsage, request);
  }

  /**
   * An Async wrapper for ListWorkloadEstimateUsage that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListWorkloadEstimateUsageRequestT = Model::ListWorkloadEstimateUsageRequest>
  void ListWorkloadEstimateUsageAsync(const ListWorkloadEstimateUsageRequestT& request,
                                      const ListWorkloadEstimateUsageResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListWorkloadEstimates that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListWorkloadEstimates that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListWorkloadEstimatesRequestT = Model::ListWorkloadEstimatesRequest>
  void ListWorkloadEstimatesAsync(const ListWorkloadEstimatesResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const ListWorkloadEstimatesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for UpdateBillEstimate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateBillEstimate that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateBillEstimateRequestT = Model::UpdateBillEstimateRequest>
  void UpdateBillEstimateAsync(const UpdateBillEstimateRequestT& request, const UpdateBillEstimateResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateBillScenario that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateBillScenario that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateBillScenarioRequestT = Model::UpdateBillScenarioRequest>
  void UpdateBillScenarioAsync(const UpdateBillScenarioRequestT& request, const UpdateBillScenarioResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateWorkloadEstimate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateWorkloadEstimate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateWorkloadEstimateRequestT = Model::UpdateWorkloadEstimateRequest>
  void UpdateWorkloadEstimateAsync(const UpdateWorkloadEstimateRequestT& request,
                                   const UpdateWorkloadEstimateResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
