...
BillEstimateCommitmentSummary::BillEstimateCommitmentSummary() : 
    m_idHasBeenSet(false),
    m_purchaseAgreementType(PurchaseAgreementType::NOT_SET),
    m_purchaseAgreementTypeHasBeenSet(false),
    m_offeringIdHasBeenSet(false),
    m_usageAccountIdHasBeenSet(false),
    m_regionHasBeenSet(false),
    m_termLengthHasBeenSet(false),
    m_paymentOptionHasBeenSet(false),
    m_upfrontPaymentHasBeenSet(false),
    m_monthlyPaymentHasBeenSet(false)
{
}
