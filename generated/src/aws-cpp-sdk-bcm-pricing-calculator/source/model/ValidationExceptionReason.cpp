  ...
  namespace BCMPricingCalculator
  {
    namespace Model
    {
      namespace ValidationExceptionReasonMapper
      {
        ...
        static const int invalidRequestFromMember_HASH = HashingUtils::HashString("invalidRequestFromMember");
        static const int disallowedRate_HASH = HashingUtils::HashString("disallowedRate");
        ...
        ValidationExceptionReason GetValidationExceptionReasonForName(const Aws::String& name)
        {
          ...
          else if (hashCode == invalidRequestFromMember_HASH)
          {
            return ValidationExceptionReason::invalidRequestFromMember;
          }
          else if (hashCode == disallowedRate_HASH)
          {
            return ValidationExceptionReason::disallowedRate;
          }
        ...
        Aws::String GetNameForValidationExceptionReason(ValidationExceptionReason enumValue)
        {
          ...
          case ValidationExceptionReason::invalidRequestFromMember:
            return "invalidRequestFromMember";
          case ValidationExceptionReason::disallowedRate:
            return "disallowedRate";
