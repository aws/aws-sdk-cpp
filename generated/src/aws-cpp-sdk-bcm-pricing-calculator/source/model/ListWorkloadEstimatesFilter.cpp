...
ListWorkloadEstimatesFilter::ListWorkloadEstimatesFilter(JsonView jsonValue) { *this = jsonValue; }

ListWorkloadEstimatesFilter& ListWorkloadEstimatesFilter::operator=(JsonView jsonValue) {
...
JsonValue ListWorkloadEstimatesFilter::Jsonize() const {
  JsonValue payload;

  if (m_nameHasBeenSet) {
    payload.WithString("name", ListWorkloadEstimatesFilterNameMapper::GetNameForListWorkloadEstimatesFilterName(m_name));
  }
