...
BatchCreateBillScenarioUsageModificationError::BatchCreateBillScenarioUsageModificationError(JsonView jsonValue) { *this = jsonValue; }
...
BatchCreateBillScenarioUsageModificationError& BatchCreateBillScenarioUsageModificationError::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("errorCode")) {
    m_errorCode = BatchCreateBillScenarioUsageModificationErrorCodeMapper::GetBatchCreateBillScenarioUsageModificationErrorCodeForName(
