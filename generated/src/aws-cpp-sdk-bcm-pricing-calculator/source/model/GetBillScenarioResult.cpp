...
GetBillScenarioResult::GetBillScenarioResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

GetBillScenarioResult& GetBillScenarioResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
