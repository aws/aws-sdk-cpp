...
BatchDeleteBillScenarioCommitmentModificationError::BatchDeleteBillScenarioCommitmentModificationError(
    const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder) {
  *this = decoder;
}

BatchDeleteBillScenarioCommitmentModificationError& BatchDeleteBillScenarioCommitmentModificationError::operator=(
    const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder) {
  if (decoder != nullptr) {
          ...
          for (size_t i = 0; i < mapSize.value(); ++i) {
            ...
            if (initialKey.has_value()) {
              ...
              if (initialKeyStr == "id") {
                ...
                if (val.has_value()) {
                  m_errorCode = BatchDeleteBillScenarioCommitmentModificationErrorCodeMapper::
                      GetBatchDeleteBillScenarioCommitmentModificationErrorCodeForName(
              ...
              if ((decoder->LastError() != AWS_ERROR_UNKNOWN)) {
                AWS_LOG_ERROR("BatchDeleteBillScenarioCommitmentModificationError", "Invalid data received for %s", initialKeyStr.c_str());
                break;
              }
            }
          }
...
void BatchDeleteBillScenarioCommitmentModificationError::CborEncode(Aws::Crt::Cbor::CborEncoder& encoder) const {
  // Calculate map size
  size_t mapSize = 0;
  if (m_idHasBeenSet) {
    mapSize++;
