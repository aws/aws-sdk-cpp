...
BatchDeleteBillScenarioCommitmentModificationErrorCode GetBatchDeleteBillScenarioCommitmentModificationErrorCodeForName(
...
Aws::String GetNameForBatchDeleteBillScenarioCommitmentModificationErrorCode(
    BatchDeleteBillScenarioCommitmentModificationErrorCode enumValue) {
  switch (enumValue) {
