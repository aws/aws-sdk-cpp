...
GetWorkloadEstimateResult::GetWorkloadEstimateResult() : 
...
GetWorkloadEstimateResult::GetWorkloadEstimateResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
  : GetWorkloadEstimateResult()
{
  *this = result;
}

GetWorkloadEstimateResult& GetWorkloadEstimateResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
