...
UpdateBillEstimateResult::UpdateBillEstimateResult() : 
    m_status(BillEstimateStatus::NOT_SET)
{
}

UpdateBillEstimateResult::UpdateBillEstimateResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
  : UpdateBillEstimateResult()
{
  *this = result;
}

UpdateBillEstimateResult& UpdateBillEstimateResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
