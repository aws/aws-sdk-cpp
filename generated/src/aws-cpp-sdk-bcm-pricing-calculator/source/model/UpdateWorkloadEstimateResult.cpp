...
UpdateWorkloadEstimateResult::UpdateWorkloadEstimateResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

UpdateWorkloadEstimateResult& UpdateWorkloadEstimateResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
