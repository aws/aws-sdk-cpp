...
BatchDeleteWorkloadEstimateUsageError::BatchDeleteWorkloadEstimateUsageError(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder) {
  *this = decoder;
}

BatchDeleteWorkloadEstimateUsageError& BatchDeleteWorkloadEstimateUsageError::operator=(
          ...
          for (size_t i = 0; i < mapSize.value(); ++i) {
            ...
            if (initialKey.has_value()) {
              ...
              if (initialKeyStr == "id") {
                ...
                auto val = decoder->PopNextTextVal();
                if (val.has_value()) {
                  m_errorCode = WorkloadEstimateUpdateUsageErrorCodeMapper::GetWorkloadEstimateUpdateUsageErrorCodeForName(
              ...
              if ((decoder->LastError() != AWS_ERROR_UNKNOWN)) {
                AWS_LOG_ERROR("BatchDeleteWorkloadEstimateUsageError", "Invalid data received for %s", initialKeyStr.c_str());
                break;
              }
            }
          }
...
void BatchDeleteWorkloadEstimateUsageError::CborEncode(Aws::Crt::Cbor::CborEncoder& encoder) const {
  // Calculate map size
  size_t mapSize = 0;
  if (m_idHasBeenSet) {
    mapSize++;
  ...
  if (m_errorCodeHasBeenSet) {
    ...
    encoder.WriteText(Aws::Crt::ByteCursorFromCString(
        WorkloadEstimateUpdateUsageErrorCodeMapper::GetNameForWorkloadEstimateUpdateUsageErrorCode(m_errorCode).c_str()));
  }
}
