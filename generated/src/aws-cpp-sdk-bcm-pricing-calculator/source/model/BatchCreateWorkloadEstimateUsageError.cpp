...
BatchCreateWorkloadEstimateUsageError::BatchCreateWorkloadEstimateUsageError(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder) {
  *this = decoder;
}

BatchCreateWorkloadEstimateUsageError& BatchCreateWorkloadEstimateUsageError::operator=(
          ...
          for (size_t i = 0; i < mapSize.value(); ++i) {
            ...
            if (initialKey.has_value()) {
              ...
              if (initialKeyStr == "key") {
                ...
                auto val = decoder->PopNextTextVal();
                if (val.has_value()) {
                  m_errorCode = BatchCreateWorkloadEstimateUsageCodeMapper::GetBatchCreateWorkloadEstimateUsageCodeForName(
              ...
              if ((decoder->LastError() != AWS_ERROR_UNKNOWN)) {
                AWS_LOG_ERROR("BatchCreateWorkloadEstimateUsageError", "Invalid data received for %s", initialKeyStr.c_str());
                break;
              }
            }
          }
...
void BatchCreateWorkloadEstimateUsageError::CborEncode(Aws::Crt::Cbor::CborEncoder& encoder) const {
  // Calculate map size
  size_t mapSize = 0;
  if (m_keyHasBeenSet) {
    mapSize++;
  ...
  if (m_errorCodeHasBeenSet) {
    ...
    encoder.WriteText(Aws::Crt::ByteCursorFromCString(
        BatchCreateWorkloadEstimateUsageCodeMapper::GetNameForBatchCreateWorkloadEstimateUsageCode(m_errorCode).c_str()));
  }
