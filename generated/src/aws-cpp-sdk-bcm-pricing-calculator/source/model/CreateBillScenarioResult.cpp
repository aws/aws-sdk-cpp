...
CreateBillScenarioResult::CreateBillScenarioResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

CreateBillScenarioResult& CreateBillScenarioResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
