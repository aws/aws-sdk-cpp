...
'u','r','l','"',':','"','h','t','t','p','s',':','/','/','b','c','m','-','p','r','i','c','i','n','g',
'-','c','a','l','c','u','l','a','t','o','r','-','f','i','p','s','.','{','P','a','r','t','i','t','i',
...
'/','b','c','m','-','p','r','i','c','i','n','g','-','c','a','l','c','u','l','a','t','o','r','.','{',
...
const char* BCMPricingCalculatorEndpointRules::GetRulesBlob()
{
