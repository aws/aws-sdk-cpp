...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTSTREAMS_API DeleteApplicationRequest();
    ...
    inline DeleteApplicationRequest& WithIdentifier(const Aws::String& value) { SetIdentifier(value); return *this;}
    inline DeleteApplicationRequest& WithIdentifier(Aws::String&& value) { SetIdentifier(std::move(value)); return *this;}
    inline DeleteApplicationRequest& WithIdentifier(const char* value) { SetIdentifier(value); return *this;}
    ///@}
  private:
