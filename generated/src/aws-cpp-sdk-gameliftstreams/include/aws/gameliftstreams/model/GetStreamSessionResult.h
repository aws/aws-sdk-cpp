...
class GetStreamSessionResult {
 public:
  ...
  void SetStreamGroupId(StreamGroupIdT&& value) {
    ...
    m_streamGroupId = std::forward<StreamGroupIdT>(value);
  }
  template <typename StreamGroupIdT = Aws::String>
  GetStreamSessionResult& WithStreamGroupId(StreamGroupIdT&& value) {
    SetStreamGroupId(std::forward<StreamGroupIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetStreamSessionResult& WithStatus(StreamSessionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline GetStreamSessionResult& WithStatusReason(StreamSessionStatusReason value) {
  ...
  inline GetStreamSessionResult& WithProtocol(Protocol value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
  ...
  void SetSignalResponse(SignalResponseT&& value) {
    ...
    m_signalResponse = std::forward<SignalResponseT>(value);
  }
  template <typename SignalResponseT = Aws::String>
  GetStreamSessionResult& WithSignalResponse(SignalResponseT&& value) {
    SetSignalResponse(std::forward<SignalResponseT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetStreamSessionResult& WithConnectionTimeoutSeconds(int value) {
  ...
  inline GetStreamSessionResult& WithSessionLengthSeconds(int value) {
  ...
  GetStreamSessionResult& AddAdditionalEnvironmentVariables(AdditionalEnvironmentVariablesKeyT&& key,
  ...
  void SetLogFileLocationUri(LogFileLocationUriT&& value) {
    ...
    m_logFileLocationUri = std::forward<LogFileLocationUriT>(value);
  }
  template <typename LogFileLocationUriT = Aws::String>
  GetStreamSessionResult& WithLogFileLocationUri(LogFileLocationUriT&& value) {
    SetLogFileLocationUri(std::forward<LogFileLocationUriT>(value));
    return *this;
  }
  ///@}
  ...
  void SetWebSdkProtocolUrl(WebSdkProtocolUrlT&& value) {
    ...
    m_webSdkProtocolUrl = std::forward<WebSdkProtocolUrlT>(value);
  }
  template <typename WebSdkProtocolUrlT = Aws::String>
  GetStreamSessionResult& WithWebSdkProtocolUrl(WebSdkProtocolUrlT&& value) {
    SetWebSdkProtocolUrl(std::forward<WebSdkProtocolUrlT>(value));
    return *this;
  }
  ///@}
