...
namespace Model
{
  ...
  public:
    ...
    template<typename ArnT = Aws::String>
    GetStreamSessionResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    GetStreamSessionResult& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename StreamGroupIdT = Aws::String>
    GetStreamSessionResult& WithStreamGroupId(StreamGroupIdT&& value) { SetStreamGroupId(std::forward<StreamGroupIdT>(value)); return *this;}
    ///@}
    ...
    template<typename UserIdT = Aws::String>
    GetStreamSessionResult& WithUserId(UserIdT&& value) { SetUserId(std::forward<UserIdT>(value)); return *this;}
    ///@}
    ...
    inline GetStreamSessionResult& WithStatus(StreamSessionStatus value) { SetStatus(value); return *this;}
    ///@}

    ///@{
    /**
     * <p>A short description of the reason the stream session is in <code>ERROR</code>
     * status.</p> <ul> <li> <p> <code>internalError</code>: An internal service error
     * occurred. Start a new stream session to continue streaming.</p> </li> <li> <p>
     ...
     * capacity becomes available.</p> </li> <li> <p>
     * <code>applicationLogS3DestinationError</code>: Could not write the application
     * log to the Amazon S3 bucket that is configured for the streaming application.
     * Make sure the bucket still exists.</p> </li> </ul>
     */
    ...
    inline GetStreamSessionResult& WithStatusReason(StreamSessionStatusReason value) { SetStatusReason(value); return *this;}
    ///@}
    ...
    inline GetStreamSessionResult& WithProtocol(Protocol value) { SetProtocol(value); return *this;}
    ///@}
    ...
    template<typename LocationT = Aws::String>
    GetStreamSessionResult& WithLocation(LocationT&& value) { SetLocation(std::forward<LocationT>(value)); return *this;}
    ///@}
    ...
    template<typename SignalRequestT = Aws::String>
    GetStreamSessionResult& WithSignalRequest(SignalRequestT&& value) { SetSignalRequest(std::forward<SignalRequestT>(value)); return *this;}
    ///@}
    ...
    template<typename SignalResponseT = Aws::String>
    GetStreamSessionResult& WithSignalResponse(SignalResponseT&& value) { SetSignalResponse(std::forward<SignalResponseT>(value)); return *this;}
    ///@}
    ...
    template<typename AdditionalLaunchArgsT = Aws::Vector<Aws::String>>
    GetStreamSessionResult& WithAdditionalLaunchArgs(AdditionalLaunchArgsT&& value) { SetAdditionalLaunchArgs(std::forward<AdditionalLaunchArgsT>(value)); return *this;}
    template<typename AdditionalLaunchArgsT = Aws::String>
    GetStreamSessionResult& AddAdditionalLaunchArgs(AdditionalLaunchArgsT&& value) { m_additionalLaunchArgsHasBeenSet = true; m_additionalLaunchArgs.emplace_back(std::forward<AdditionalLaunchArgsT>(value)); return *this; }
    ///@}
    ...
    template<typename AdditionalEnvironmentVariablesT = Aws::Map<Aws::String, Aws::String>>
    GetStreamSessionResult& WithAdditionalEnvironmentVariables(AdditionalEnvironmentVariablesT&& value) { SetAdditionalEnvironmentVariables(std::forward<AdditionalEnvironmentVariablesT>(value)); return *this;}
    ...
    template<typename LogFileLocationUriT = Aws::String>
    GetStreamSessionResult& WithLogFileLocationUri(LogFileLocationUriT&& value) { SetLogFileLocationUri(std::forward<LogFileLocationUriT>(value)); return *this;}
    ///@}
    ...
    template<typename WebSdkProtocolUrlT = Aws::String>
    GetStreamSessionResult& WithWebSdkProtocolUrl(WebSdkProtocolUrlT&& value) { SetWebSdkProtocolUrl(std::forward<WebSdkProtocolUrlT>(value)); return *this;}
    ///@}
    ...
    template<typename LastUpdatedAtT = Aws::Utils::DateTime>
    GetStreamSessionResult& WithLastUpdatedAt(LastUpdatedAtT&& value) { SetLastUpdatedAt(std::forward<LastUpdatedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename CreatedAtT = Aws::Utils::DateTime>
    GetStreamSessionResult& WithCreatedAt(CreatedAtT&& value) { SetCreatedAt(std::forward<CreatedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename ApplicationArnT = Aws::String>
    GetStreamSessionResult& WithApplicationArn(ApplicationArnT&& value) { SetApplicationArn(std::forward<ApplicationArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ExportFilesMetadataT = ExportFilesMetadata>
    GetStreamSessionResult& WithExportFilesMetadata(ExportFilesMetadataT&& value) { SetExportFilesMetadata(std::forward<ExportFilesMetadataT>(value)); return *this;}
    ///@}
