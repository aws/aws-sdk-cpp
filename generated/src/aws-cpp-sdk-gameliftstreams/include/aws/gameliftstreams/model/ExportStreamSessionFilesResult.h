...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTSTREAMS_API ExportStreamSessionFilesResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    ExportStreamSessionFilesResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
