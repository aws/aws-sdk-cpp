...
class ListStreamSessionsRequest : public GameLiftStreamsRequest {
 public:
  ...
  inline ListStreamSessionsRequest& WithStatus(StreamSessionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetExportFilesStatus(ExportFilesStatus value) {
    m_exportFilesStatusHasBeenSet = true;
    m_exportFilesStatus = value;
  }
  inline ListStreamSessionsRequest& WithExportFilesStatus(ExportFilesStatus value) {
    SetExportFilesStatus(value);
    return *this;
  }
  ///@}
  ...
  inline ListStreamSessionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
