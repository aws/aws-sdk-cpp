...
class ExportFilesMetadata {
 public:
  ...
  inline void SetStatus(ExportFilesStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ExportFilesMetadata& WithStatus(ExportFilesStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonT = Aws::String>
  ExportFilesMetadata& WithStatusReason(StatusReasonT&& value) {
  ...
  template <typename OutputUriT = Aws::String>
  ExportFilesMetadata& WithOutputUri(OutputUriT&& value) {
