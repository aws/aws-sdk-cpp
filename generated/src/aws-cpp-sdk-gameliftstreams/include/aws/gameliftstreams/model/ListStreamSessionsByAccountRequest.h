...
class ListStreamSessionsByAccountRequest : public GameLiftStreamsRequest {
 public:
  ...
  inline ListStreamSessionsByAccountRequest& WithStatus(StreamSessionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline ListStreamSessionsByAccountRequest& WithExportFilesStatus(ExportFilesStatus value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListStreamSessionsByAccountRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListStreamSessionsByAccountRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
