...
/**
 */
class TagResourceRequest : public GameLiftStreamsRequest {
 public:
  AWS_GAMELIFTSTREAMS_API TagResourceRequest() = default;
  ...
  ///@{
  /**
   * <p>A list of tags, in the form of key-value pairs, to assign to the specified
   * Amazon GameLift Streams resource.</p>
   */
