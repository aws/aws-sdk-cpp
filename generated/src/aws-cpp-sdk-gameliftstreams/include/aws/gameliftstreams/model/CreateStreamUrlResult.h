...
class CreateStreamUrlResult {
 public:
  ...
  inline CreateStreamUrlResult& WithStatus(StreamUrlStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline CreateStreamUrlResult& WithStatusReason(StreamUrlStatusReason value) {
  ...
  inline CreateStreamUrlResult& WithUsageLimit(int value) {
    SetUsageLimit(value);
    return *this;
  }
  ///@}
  ...
  inline CreateStreamUrlResult& WithRemainingUses(int value) {
  ...
  inline CreateStreamUrlResult& WithProtocol(Protocol value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
  ...
  inline CreateStreamUrlResult& WithSessionLengthSeconds(int value) {
  ...
  CreateStreamUrlResult& AddAdditionalEnvironmentVariables(AdditionalEnvironmentVariablesKeyT&& key,
