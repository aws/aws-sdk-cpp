...
class ListStreamGroupsRequest : public GameLiftStreamsRequest {
 public:
  AWS_GAMELIFTSTREAMS_API ListStreamGroupsRequest() = default;
  ...
  template <typename NextTokenT = Aws::String>
  ListStreamGroupsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListStreamGroupsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
