...
class StartStreamSessionResult {
 public:
  ...
  inline StartStreamSessionResult& WithStatus(StreamSessionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline StartStreamSessionResult& WithStatusReason(StreamSessionStatusReason value) {
  ...
  inline StartStreamSessionResult& WithProtocol(Protocol value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
  ...
  inline StartStreamSessionResult& WithConnectionTimeoutSeconds(int value) {
  ...
  inline StartStreamSessionResult& WithSessionLengthSeconds(int value) {
  ...
  StartStreamSessionResult& AddAdditionalEnvironmentVariables(AdditionalEnvironmentVariablesKeyT&& key,
  ...
  template <typename DisplayConfigurationT = DisplayConfiguration>
  StartStreamSessionResult& WithDisplayConfiguration(DisplayConfigurationT&& value) {
