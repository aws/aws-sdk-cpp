...
class StartStreamSessionRequest : public GameLiftStreamsRequest {
 public:
  ...
  inline StartStreamSessionRequest& WithProtocol(Protocol value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
  ...
  inline void SetConnectionTimeoutSeconds(int value) {
    m_connectionTimeoutSecondsHasBeenSet = true;
    m_connectionTimeoutSeconds = value;
  }
  inline StartStreamSessionRequest& WithConnectionTimeoutSeconds(int value) {
  ...
  inline StartStreamSessionRequest& WithSessionLengthSeconds(int value) {
  ...
  StartStreamSessionRequest& AddAdditionalEnvironmentVariables(AdditionalEnvironmentVariablesKeyT&& key,
