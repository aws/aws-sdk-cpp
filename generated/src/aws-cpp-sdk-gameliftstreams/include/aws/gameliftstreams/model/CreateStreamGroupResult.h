...
class CreateStreamGroupResult {
 public:
   ...
   * stream session</p> </li> </ul> </li> <li> <p> <b> <code>gen6n_pro</code>
   * (NVIDIA, pro)</b> Supports applications with extremely high 3D scene complexity
   * which require maximum resources. Uses dedicated NVIDIA L4 Tensor Core GPU.</p>
   ...
   * </ul> </li> <li> <p> <b> <code>gen6n_ultra_win2022</code> (NVIDIA, ultra)</b>
   * Supports applications with high 3D scene complexity. Runs applications on
   ...
   * anti-cheat technology. Uses NVIDIA L4 Tensor Core GPU.</p> <ul> <li>
   ...
   * VRAM</p> </li> <li> <p>Tenancy: Supports 1 concurrent stream session</p> </li>
   * </ul> </li> <li> <p> <b> <code>gen6n_ultra</code> (NVIDIA, ultra)</b> Supports
   * applications with high 3D scene complexity. Uses dedicated NVIDIA L4 Tensor Core
   ...
   * session</p> </li> </ul> </li> <li> <p> <b> <code>gen6n_high</code> (NVIDIA,
   * high)</b> Supports applications with moderate to high 3D scene complexity. Uses
   * NVIDIA L4 Tensor Core GPU.</p> <ul> <li> <p>Reference resolution: 1080p</p>
   ...
   * <code>gen6n_medium</code> (NVIDIA, medium)</b> Supports applications with
   * moderate 3D scene complexity. Uses NVIDIA L4 Tensor Core GPU.</p> <ul> <li>
   * <p>Reference resolution: 1080p</p> </li> <li> <p>Reference frame rate: 60
   * fps</p> </li> <li> <p>Workload specifications: 2 vCPUs, 8 GB RAM, 6 GB VRAM</p>
   * </li> <li> <p>Tenancy: Supports up to 4 concurrent stream sessions</p> </li>
   * </ul> </li> <li> <p> <b> <code>gen6n_small</code> (NVIDIA, small)</b> Supports
   * applications with lightweight 3D scene complexity and low CPU usage. Uses NVIDIA
   * L4 Tensor Core GPU.</p> <ul> <li> <p>Reference resolution: 1080p</p> </li> <li>
   ...
   * with low 3D scene complexity. Uses NVIDIA L4 Tensor Core GPU.</p> <ul> <li>
   * <p>Reference resolution: 1080p</p> </li> <li> <p>Reference frame rate: 60
   ...
   * applications with low 3D scene complexity. Uses NVIDIA L4 Tensor Core GPU.</p>
   * <ul> <li> <p>Reference resolution: 1080p</p> </li> <li> <p>Reference frame rate:
   * 60 fps</p> </li> <li> <p>Workload specifications: 2 vCPUs, 8 GB RAM, 3 GB
   * VRAM</p> </li> <li> <p>Tenancy: Supports 1 concurrent stream session</p> </li>
   ...
   * Microsoft Windows Server 2022 Base and supports DirectX 12. Compatible with
   * Unreal Engine versions up through 5.6, 32 and 64-bit applications, and
   * anti-cheat technology. Uses NVIDIA A10G Tensor Core GPU.</p> <ul> <li>
   * <p>Reference resolution: 1080p</p> </li> <li> <p>Reference frame rate: 60
   * fps</p> </li> <li> <p>Workload specifications: 8 vCPUs, 32 GB RAM, 24 GB
   * VRAM</p> </li> <li> <p>Tenancy: Supports 1 concurrent stream session</p> </li>
