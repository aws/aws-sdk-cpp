...
class UpdateApplicationResult {
 public:
   ...
   * (<code>Type=WINDOWS, Version=2022</code>)</p> </li> <li> <p>Proton 10.0-4
   * (<code>Type=PROTON, Version=20260204</code>)</p> </li> <li> <p>Proton 9.0-2
  ...
  void SetRuntimeEnvironment(RuntimeEnvironmentT&& value) {
    ...
    m_runtimeEnvironment = std::forward<RuntimeEnvironmentT>(value);
  }
  template <typename RuntimeEnvironmentT = RuntimeEnvironment>
  UpdateApplicationResult& WithRuntimeEnvironment(RuntimeEnvironmentT&& value) {
    SetRuntimeEnvironment(std::forward<RuntimeEnvironmentT>(value));
    return *this;
  }
  ///@}
  ...
  void SetApplicationLogPaths(ApplicationLogPathsT&& value) {
    ...
    m_applicationLogPaths = std::forward<ApplicationLogPathsT>(value);
  }
  template <typename ApplicationLogPathsT = Aws::Vector<Aws::String>>
  UpdateApplicationResult& WithApplicationLogPaths(ApplicationLogPathsT&& value) {
    SetApplicationLogPaths(std::forward<ApplicationLogPathsT>(value));
    return *this;
  }
  ...
  UpdateApplicationResult& AddApplicationLogPaths(ApplicationLogPathsT&& value) {
    m_applicationLogPathsHasBeenSet = true;
    m_applicationLogPaths.emplace_back(std::forward<ApplicationLogPathsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetApplicationLogOutputUri(ApplicationLogOutputUriT&& value) {
    ...
    m_applicationLogOutputUri = std::forward<ApplicationLogOutputUriT>(value);
  }
  template <typename ApplicationLogOutputUriT = Aws::String>
  UpdateApplicationResult& WithApplicationLogOutputUri(ApplicationLogOutputUriT&& value) {
    SetApplicationLogOutputUri(std::forward<ApplicationLogOutputUriT>(value));
    return *this;
  }
  ///@}
  ...
  void SetApplicationSourceUri(ApplicationSourceUriT&& value) {
    ...
    m_applicationSourceUri = std::forward<ApplicationSourceUriT>(value);
  }
  template <typename ApplicationSourceUriT = Aws::String>
  UpdateApplicationResult& WithApplicationSourceUri(ApplicationSourceUriT&& value) {
    SetApplicationSourceUri(std::forward<ApplicationSourceUriT>(value));
    return *this;
  }
  ///@}
  ...
  inline UpdateApplicationResult& WithStatus(ApplicationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatusReason(ApplicationStatusReason value) {
    m_statusReasonHasBeenSet = true;
    m_statusReason = value;
  }
  inline UpdateApplicationResult& WithStatusReason(ApplicationStatusReason value) {
  ...
  void SetReplicationStatuses(ReplicationStatusesT&& value) {
    ...
    m_replicationStatuses = std::forward<ReplicationStatusesT>(value);
  }
  template <typename ReplicationStatusesT = Aws::Vector<ReplicationStatus>>
  UpdateApplicationResult& WithReplicationStatuses(ReplicationStatusesT&& value) {
    SetReplicationStatuses(std::forward<ReplicationStatusesT>(value));
    return *this;
  }
  ...
  UpdateApplicationResult& AddReplicationStatuses(ReplicationStatusesT&& value) {
    m_replicationStatusesHasBeenSet = true;
    m_replicationStatuses.emplace_back(std::forward<ReplicationStatusesT>(value));
    return *this;
  }
  ///@}
