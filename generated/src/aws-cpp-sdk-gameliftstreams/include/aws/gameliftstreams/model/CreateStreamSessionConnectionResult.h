...
class CreateStreamSessionConnectionResult {
 public:
  ...
  AWS_GAMELIFTSTREAMS_API CreateStreamSessionConnectionResult& operator=(
  ...
  template <typename SignalResponseT = Aws::String>
  CreateStreamSessionConnectionResult& WithSignalResponse(SignalResponseT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateStreamSessionConnectionResult& WithRequestId(RequestIdT&& value) {
