...
class UpdateStreamGroupResult {
 public:
  ...
  inline UpdateStreamGroupResult& WithStreamClass(StreamClass value) {
  ...
  inline UpdateStreamGroupResult& WithStatus(StreamGroupStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateStreamGroupResult& WithStatusReason(StreamGroupStatusReason value) {
