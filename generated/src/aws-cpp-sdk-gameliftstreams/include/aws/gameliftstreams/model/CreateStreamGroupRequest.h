...
class CreateStreamGroupRequest : public GameLiftStreamsRequest {
 public:
   ...
   * frame rate: 60 fps</p> </li> <li> <p>Workload specifications: 16 vCPUs, 64 GB
   * RAM, 24 GB VRAM</p> </li> <li> <p>Tenancy: Supports 1 concurrent stream
   * session</p> </li> </ul> </li> <li> <p> <b> <code>gen6n_pro</code> (NVIDIA,
   * pro)</b> Supports applications with extremely high 3D scene complexity which
   * require maximum resources. Powered by NVIDIA L4 Tensor Core GPUs.</p> <ul> <li>
   * <p>Reference resolution: 1080p</p> </li> <li> <p>Reference frame rate: 60
   * fps</p> </li> <li> <p>Workload specifications: 16 vCPUs, 64 GB RAM, 24 GB
   ...
   * anti-cheat technology. Powered by NVIDIA L4 Tensor Core GPUs.</p> <ul> <li>
   * <p>Reference resolution: 1080p</p> </li> <li> <p>Reference frame rate: 60
   * fps</p> </li> <li> <p>Workload specifications: 8 vCPUs, 32 GB RAM, 24 GB
   * VRAM</p> </li> <li> <p>Tenancy: Supports 1 concurrent stream session</p> </li>
   * </ul> </li> <li> <p> <b> <code>gen6n_ultra</code> (NVIDIA, ultra)</b> Supports
   * applications with high 3D scene complexity. Powered by NVIDIA L4 Tensor Core
   * GPUs.</p> <ul> <li> <p>Reference resolution: 1080p</p> </li> <li> <p>Reference
   * frame rate: 60 fps</p> </li> <li> <p>Workload specifications: 8 vCPUs, 32 GB
   * RAM, 24 GB VRAM</p> </li> <li> <p>Tenancy: Supports 1 concurrent stream
   * session</p> </li> </ul> </li> <li> <p> <b> <code>gen6n_high</code> (NVIDIA,
   * high)</b> Supports applications with moderate to high 3D scene complexity.
   * Powered by NVIDIA L4 Tensor Core GPUs.</p> <ul> <li> <p>Reference resolution:
   ...
   * moderate 3D scene complexity. Powered by NVIDIA L4 Tensor Core GPUs.</p> <ul>
   ...
   * applications with lightweight 3D scene complexity and low CPU usage. Powered by
   * NVIDIA L4 Tensor Core GPUs.</p> <ul> <li> <p>Reference resolution: 1080p</p>
   * </li> <li> <p>Reference frame rate: 60 fps</p> </li> <li> <p>Workload
   * specifications: 1 vCPUs, 4 GB RAM, 2 GB VRAM</p> </li> <li> <p>Tenancy: Supports
   * up to 12 concurrent stream sessions</p> </li> </ul> </li> <li> <p> <b>
  ...
  inline CreateStreamGroupRequest& WithStreamClass(StreamClass value) {
  ...
  void SetDefaultApplicationIdentifier(DefaultApplicationIdentifierT&& value) {
    m_defaultApplicationIdentifierHasBeenSet = true;
    m_defaultApplicationIdentifier = std::forward<DefaultApplicationIdentifierT>(value);
  }
  template <typename DefaultApplicationIdentifierT = Aws::String>
  CreateStreamGroupRequest& WithDefaultApplicationIdentifier(DefaultApplicationIdentifierT&& value) {
    SetDefaultApplicationIdentifier(std::forward<DefaultApplicationIdentifierT>(value));
    return *this;
  }
  ///@}
