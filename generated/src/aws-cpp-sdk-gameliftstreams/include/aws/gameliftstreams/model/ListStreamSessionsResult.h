...
class ListStreamSessionsResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<StreamSessionSummary>>
  ListStreamSessionsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = StreamSessionSummary>
  ListStreamSessionsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListStreamSessionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListStreamSessionsResult& WithRequestId(RequestIdT&& value) {
