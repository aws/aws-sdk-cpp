...
namespace Model
{
  ...
  public:
    ...
    template<typename ArnT = Aws::String>
    GetStreamGroupResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    GetStreamGroupResult& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename DefaultApplicationT = DefaultApplication>
    GetStreamGroupResult& WithDefaultApplication(DefaultApplicationT&& value) { SetDefaultApplication(std::forward<DefaultApplicationT>(value)); return *this;}
    ///@}
    ...
    template<typename LocationStatesT = Aws::Vector<LocationState>>
    GetStreamGroupResult& WithLocationStates(LocationStatesT&& value) { SetLocationStates(std::forward<LocationStatesT>(value)); return *this;}
    template<typename LocationStatesT = LocationState>
    GetStreamGroupResult& AddLocationStates(LocationStatesT&& value) { m_locationStatesHasBeenSet = true; m_locationStates.emplace_back(std::forward<LocationStatesT>(value)); return *this; }
    ///@}
    ...
    inline GetStreamGroupResult& WithStreamClass(StreamClass value) { SetStreamClass(value); return *this;}
    ///@}
    ...
    template<typename IdT = Aws::String>
    GetStreamGroupResult& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    inline GetStreamGroupResult& WithStatus(StreamGroupStatus value) { SetStatus(value); return *this;}
    ///@}
    ...
    inline GetStreamGroupResult& WithStatusReason(StreamGroupStatusReason value) { SetStatusReason(value); return *this;}
    ///@}
    ...
    template<typename LastUpdatedAtT = Aws::Utils::DateTime>
    GetStreamGroupResult& WithLastUpdatedAt(LastUpdatedAtT&& value) { SetLastUpdatedAt(std::forward<LastUpdatedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename CreatedAtT = Aws::Utils::DateTime>
    GetStreamGroupResult& WithCreatedAt(CreatedAtT&& value) { SetCreatedAt(std::forward<CreatedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename AssociatedApplicationsT = Aws::Vector<Aws::String>>
    GetStreamGroupResult& WithAssociatedApplications(AssociatedApplicationsT&& value) { SetAssociatedApplications(std::forward<AssociatedApplicationsT>(value)); return *this;}
    template<typename AssociatedApplicationsT = Aws::String>
    GetStreamGroupResult& AddAssociatedApplications(AssociatedApplicationsT&& value) { m_associatedApplicationsHasBeenSet = true; m_associatedApplications.emplace_back(std::forward<AssociatedApplicationsT>(value)); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    GetStreamGroupResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
