...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTSTREAMS_API GetStreamGroupResult();
    ...
    inline GetStreamGroupResult& WithArn(const Aws::String& value) { SetArn(value); return *this;}
    inline GetStreamGroupResult& WithArn(Aws::String&& value) { SetArn(std::move(value)); return *this;}
    inline GetStreamGroupResult& WithArn(const char* value) { SetArn(value); return *this;}
    ///@}
    ...
    inline GetStreamGroupResult& WithAssociatedApplications(const Aws::Vector<Aws::String>& value) { SetAssociatedApplications(value); return *this;}
    inline GetStreamGroupResult& WithAssociatedApplications(Aws::Vector<Aws::String>&& value) { SetAssociatedApplications(std::move(value)); return *this;}
    inline GetStreamGroupResult& AddAssociatedApplications(const Aws::String& value) { m_associatedApplications.push_back(value); return *this; }
    inline GetStreamGroupResult& AddAssociatedApplications(Aws::String&& value) { m_associatedApplications.push_back(std::move(value)); return *this; }
    inline GetStreamGroupResult& AddAssociatedApplications(const char* value) { m_associatedApplications.push_back(value); return *this; }
    ///@}
    ...
    inline GetStreamGroupResult& WithCreatedAt(const Aws::Utils::DateTime& value) { SetCreatedAt(value); return *this;}
    inline GetStreamGroupResult& WithCreatedAt(Aws::Utils::DateTime&& value) { SetCreatedAt(std::move(value)); return *this;}
    ///@}
    ...
    inline GetStreamGroupResult& WithDefaultApplication(const DefaultApplication& value) { SetDefaultApplication(value); return *this;}
    inline GetStreamGroupResult& WithDefaultApplication(DefaultApplication&& value) { SetDefaultApplication(std::move(value)); return *this;}
    ///@}
    ...
    inline GetStreamGroupResult& WithDescription(const Aws::String& value) { SetDescription(value); return *this;}
    inline GetStreamGroupResult& WithDescription(Aws::String&& value) { SetDescription(std::move(value)); return *this;}
    inline GetStreamGroupResult& WithDescription(const char* value) { SetDescription(value); return *this;}
    ///@}
    ...
    inline GetStreamGroupResult& WithId(const Aws::String& value) { SetId(value); return *this;}
    inline GetStreamGroupResult& WithId(Aws::String&& value) { SetId(std::move(value)); return *this;}
    inline GetStreamGroupResult& WithId(const char* value) { SetId(value); return *this;}
    ///@}
    ...
    inline GetStreamGroupResult& WithLastUpdatedAt(const Aws::Utils::DateTime& value) { SetLastUpdatedAt(value); return *this;}
    inline GetStreamGroupResult& WithLastUpdatedAt(Aws::Utils::DateTime&& value) { SetLastUpdatedAt(std::move(value)); return *this;}
    ///@}
    ...
    inline GetStreamGroupResult& WithLocationStates(const Aws::Vector<LocationState>& value) { SetLocationStates(value); return *this;}
    inline GetStreamGroupResult& WithLocationStates(Aws::Vector<LocationState>&& value) { SetLocationStates(std::move(value)); return *this;}
    inline GetStreamGroupResult& AddLocationStates(const LocationState& value) { m_locationStates.push_back(value); return *this; }
    inline GetStreamGroupResult& AddLocationStates(LocationState&& value) { m_locationStates.push_back(std::move(value)); return *this; }
    ///@}
    ...
    inline GetStreamGroupResult& WithStatus(const StreamGroupStatus& value) { SetStatus(value); return *this;}
    inline GetStreamGroupResult& WithStatus(StreamGroupStatus&& value) { SetStatus(std::move(value)); return *this;}
    ///@}
    ...
    inline GetStreamGroupResult& WithStatusReason(const StreamGroupStatusReason& value) { SetStatusReason(value); return *this;}
    inline GetStreamGroupResult& WithStatusReason(StreamGroupStatusReason&& value) { SetStatusReason(std::move(value)); return *this;}
    ///@}
    ...
    inline GetStreamGroupResult& WithStreamClass(const StreamClass& value) { SetStreamClass(value); return *this;}
    inline GetStreamGroupResult& WithStreamClass(StreamClass&& value) { SetStreamClass(std::move(value)); return *this;}
    ///@}
    ...
    inline GetStreamGroupResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}
    inline GetStreamGroupResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}
    inline GetStreamGroupResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
    ///@}
  private:
