...
class GetStreamGroupResult {
 public:
  ...
  inline GetStreamGroupResult& WithStreamClass(StreamClass value) {
  ...
  inline GetStreamGroupResult& WithStatus(StreamGroupStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline GetStreamGroupResult& WithStatusReason(StreamGroupStatusReason value) {
