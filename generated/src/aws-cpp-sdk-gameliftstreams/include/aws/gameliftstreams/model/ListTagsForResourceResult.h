...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTSTREAMS_API ListTagsForResourceResult() = default;
    AWS_GAMELIFTSTREAMS_API ListTagsForResourceResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_GAMELIFTSTREAMS_API ListTagsForResourceResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
