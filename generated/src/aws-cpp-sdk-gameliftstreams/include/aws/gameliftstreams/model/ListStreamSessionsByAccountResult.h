...
class ListStreamSessionsByAccountResult {
 public:
  ...
  AWS_GAMELIFTSTREAMS_API ListStreamSessionsByAccountResult& operator=(
  ...
  template <typename ItemsT = Aws::Vector<StreamSessionSummary>>
  ListStreamSessionsByAccountResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = StreamSessionSummary>
  ListStreamSessionsByAccountResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListStreamSessionsByAccountResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListStreamSessionsByAccountResult& WithRequestId(RequestIdT&& value) {
