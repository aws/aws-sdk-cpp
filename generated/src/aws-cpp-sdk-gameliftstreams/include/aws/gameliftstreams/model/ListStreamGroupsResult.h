...
class ListStreamGroupsResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<StreamGroupSummary>>
  ListStreamGroupsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = StreamGroupSummary>
  ListStreamGroupsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListStreamGroupsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListStreamGroupsResult& WithRequestId(RequestIdT&& value) {
