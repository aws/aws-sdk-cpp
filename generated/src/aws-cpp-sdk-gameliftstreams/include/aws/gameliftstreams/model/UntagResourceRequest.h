...
namespace Model
{
  ...
  /**
   */
  class UntagResourceRequest : public GameLiftStreamsRequest
  {
  public:
    AWS_GAMELIFTSTREAMS_API UntagResourceRequest() = default;
    ...
    ///@{
    /**
     * <p>A list of tag keys to remove from the specified Amazon GameLift Streams
     * resource.</p>
     */
