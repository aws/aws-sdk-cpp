...
'u','r','l','"',':','"','h','t','t','p','s',':','/','/','g','a','m','e','l','i','f','t','s','t','r',
'e','a','m','s','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i',
...
'g','a','m','e','l','i','f','t','s','t','r','e','a','m','s','.','{','R','e','g','i','o','n','}','.',
...
const char* GameLiftStreamsEndpointRules::GetRulesBlob()
{
