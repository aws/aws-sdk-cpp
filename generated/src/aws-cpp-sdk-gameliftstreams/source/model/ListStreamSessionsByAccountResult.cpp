...
ListStreamSessionsByAccountResult::ListStreamSessionsByAccountResult()
{
}

ListStreamSessionsByAccountResult::ListStreamSessionsByAccountResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
