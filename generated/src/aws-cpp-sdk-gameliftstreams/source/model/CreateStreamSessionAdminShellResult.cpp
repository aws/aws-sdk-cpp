...
CreateStreamSessionAdminShellResult::CreateStreamSessionAdminShellResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

CreateStreamSessionAdminShellResult& CreateStreamSessionAdminShellResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
