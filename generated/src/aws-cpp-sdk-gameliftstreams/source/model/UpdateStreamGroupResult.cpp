...
UpdateStreamGroupResult::UpdateStreamGroupResult() : 
...
UpdateStreamGroupResult::UpdateStreamGroupResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
  : UpdateStreamGroupResult()
{
  *this = result;
}

UpdateStreamGroupResult& UpdateStreamGroupResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
