...
AgentAccessConfigForUpdate::AgentAccessConfigForUpdate(JsonView jsonValue) { *this = jsonValue; }

AgentAccessConfigForUpdate& AgentAccessConfigForUpdate::operator=(JsonView jsonValue) {
...
JsonValue AgentAccessConfigForUpdate::Jsonize() const {
  JsonValue payload;
