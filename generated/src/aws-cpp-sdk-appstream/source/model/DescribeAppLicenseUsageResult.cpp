...
DescribeAppLicenseUsageResult::DescribeAppLicenseUsageResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
...
DescribeAppLicenseUsageResult& DescribeAppLicenseUsageResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  ...
  if(jsonValue.ValueExists("AppLicenseUsages"))
  {
    ...
    for(unsigned appLicenseUsagesIndex = 0; appLicenseUsagesIndex < appLicenseUsagesJsonList.GetLength(); ++appLicenseUsagesIndex)
    {
      m_appLicenseUsages.push_back(appLicenseUsagesJsonList[appLicenseUsagesIndex].AsObject());
    }
