...
UpdateThemeForStackResult::UpdateThemeForStackResult()
{
}

UpdateThemeForStackResult::UpdateThemeForStackResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
