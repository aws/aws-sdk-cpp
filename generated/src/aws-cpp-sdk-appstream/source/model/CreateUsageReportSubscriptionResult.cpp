...
CreateUsageReportSubscriptionResult& CreateUsageReportSubscriptionResult::operator=(
    const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result) {
          ...
          for (size_t i = 0; i < mapSize.value(); ++i) {
            ...
            if (initialKey.has_value()) {
              ...
              if (initialKeyStr == "S3BucketName") {
                ...
                auto val = decoder->PopNextTextVal();
                if (val.has_value()) {
                  m_schedule = UsageReportScheduleMapper::GetUsageReportScheduleForName(
              ...
              if ((decoder->LastError() != AWS_ERROR_UNKNOWN)) {
                AWS_LOG_ERROR("CreateUsageReportSubscriptionResult", "Invalid data received for %s", initialKeyStr.c_str());
                break;
              }
            }
          }
