...
StartAppBlockBuilderResult::StartAppBlockBuilderResult()
{
}

StartAppBlockBuilderResult::StartAppBlockBuilderResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
