...
Aws::String ListExportImageTasksRequest::SerializePayload() const {
...
Aws::Http::HeaderValueCollection ListExportImageTasksRequest::GetRequestSpecificHeaders() const {
