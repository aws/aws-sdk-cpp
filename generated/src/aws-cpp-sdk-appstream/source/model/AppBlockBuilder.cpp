...
AppBlockBuilder::AppBlockBuilder(JsonView jsonValue) { *this = jsonValue; }
...
AppBlockBuilder& AppBlockBuilder::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("AppBlockBuilderErrors")) {
    ...
    for (unsigned appBlockBuilderErrorsIndex = 0; appBlockBuilderErrorsIndex < appBlockBuilderErrorsJsonList.GetLength();
         ++appBlockBuilderErrorsIndex) {
