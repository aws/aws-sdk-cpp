...
DeleteThemeForStackResult::DeleteThemeForStackResult()
{
}

DeleteThemeForStackResult::DeleteThemeForStackResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
