...
ExportImageTask::ExportImageTask(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder) { *this = decoder; }

ExportImageTask& ExportImageTask::operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder) {
  if (decoder != nullptr) {
        ...
        if (mapSize.has_value()) {
          for (size_t i = 0; i < mapSize.value(); ++i) {
            ...
            if (initialKey.has_value()) {
              ...
              if (initialKeyStr == "TaskId") {
                auto peekType = decoder->PeekType();
                if (peekType.has_value()) {
                  if (peekType.value() == Aws::Crt::Cbor::CborType::Text) {
                    auto val = decoder->PopNextTextVal();
                    if (val.has_value()) {
                      m_taskId = Aws::String(reinterpret_cast<const char*>(val.value().ptr), val.value().len);
                    }
                  } else {
              ...
              else if (initialKeyStr == "AmiName") {
                auto peekType = decoder->PeekType();
                if (peekType.has_value()) {
                  if (peekType.value() == Aws::Crt::Cbor::CborType::Text) {
                    auto val = decoder->PopNextTextVal();
                    if (val.has_value()) {
                      m_amiName = Aws::String(reinterpret_cast<const char*>(val.value().ptr), val.value().len);
                    }
                  } else {
                    decoder->ConsumeNextSingleElement();
                    Aws::StringStream ss;
              ...
              else if (initialKeyStr == "AmiDescription") {
                auto peekType = decoder->PeekType();
                if (peekType.has_value()) {
                  if (peekType.value() == Aws::Crt::Cbor::CborType::Text) {
                    auto val = decoder->PopNextTextVal();
                    if (val.has_value()) {
                      m_amiDescription = Aws::String(reinterpret_cast<const char*>(val.value().ptr), val.value().len);
                    }
                  } else {
                    decoder->ConsumeNextSingleElement();
                    Aws::StringStream ss;
                ...
                auto val = decoder->PopNextTextVal();
                if (val.has_value()) {
                  m_state = ExportImageTaskStateMapper::GetExportImageTaskStateForName(
                      Aws::String(reinterpret_cast<const char*>(val.value().ptr), val.value().len));
                }
                m_stateHasBeenSet = true;
              }

              else if (initialKeyStr == "AmiId") {
                auto peekType = decoder->PeekType();
                if (peekType.has_value()) {
                  if (peekType.value() == Aws::Crt::Cbor::CborType::Text) {
                    auto val = decoder->PopNextTextVal();
                        ...
                        if (key_1.has_value()) {
                          ...
                          if (peekType_1) {
                            if (peekType_1.value() == Aws::Crt::Cbor::CborType::Text) {
                              ...
                              m_tagSpecifications[keyStr_1] = ss_1.str();
                              ss_1.clear();
                            }
                          }
                        }
                      ...
                      if (key_1.has_value()) {
                        ...
                        if (peekType_1) {
                          if (peekType_1.value() == Aws::Crt::Cbor::CborType::Text) {
                            auto val = decoder->PopNextTextVal();
                            if (val.has_value()) {
                              m_tagSpecifications[keyStr_1] = Aws::String(reinterpret_cast<const char*>(val.value().ptr), val.value().len);
                            }
                          } else {
                            decoder->ConsumeNextSingleElement();
                            Aws::StringStream ss_1;
              ...
              else if (initialKeyStr == "ErrorDetails") {
                auto peekType_0 = decoder->PeekType();
                  ...
                  if (peekType_0.value() == CborType::ArrayStart) {
                    ...
                    if (listSize_0.has_value()) {
                      for (size_t j_0 = 0; j_0 < listSize_0.value(); j_0++) {
                        m_errorDetails.push_back(ErrorDetails(decoder));
                      }
                    }
              ...
              if ((decoder->LastError() != AWS_ERROR_UNKNOWN)) {
                AWS_LOG_ERROR("ExportImageTask", "Invalid data received for %s", initialKeyStr.c_str());
                break;
              }
            }
          }
...
void ExportImageTask::CborEncode(Aws::Crt::Cbor::CborEncoder& encoder) const {
  // Calculate map size
  size_t mapSize = 0;
  ...
  if (m_taskIdHasBeenSet) {
    encoder.WriteText(Aws::Crt::ByteCursorFromCString("TaskId"));
    encoder.WriteText(Aws::Crt::ByteCursorFromCString(m_taskId.c_str()));
  }
  ...
  if (m_stateHasBeenSet) {
    ...
    encoder.WriteText(Aws::Crt::ByteCursorFromCString(ExportImageTaskStateMapper::GetNameForExportImageTaskState(m_state).c_str()));
  }
  ...
  if (m_errorDetailsHasBeenSet) {
    encoder.WriteText(Aws::Crt::ByteCursorFromCString("ErrorDetails"));
    encoder.WriteArrayStart(m_errorDetails.size());
    for (const auto& item_0 : m_errorDetails) {
