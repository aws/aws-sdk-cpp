...
class CreateEntitlementResult {
 public:
  ...
  AWS_APPSTREAM_API CreateEntitlementResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_APPSTREAM_API CreateEntitlementResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  template <typename EntitlementT = Entitlement>
  CreateEntitlementResult& WithEntitlement(EntitlementT&& value) {
