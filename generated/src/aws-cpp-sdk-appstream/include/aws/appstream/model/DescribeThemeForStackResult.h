...
class DescribeThemeForStackResult {
 public:
  ...
  AWS_APPSTREAM_API DescribeThemeForStackResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_APPSTREAM_API DescribeThemeForStackResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  template <typename ThemeT = Theme>
  DescribeThemeForStackResult& WithTheme(ThemeT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeThemeForStackResult& WithRequestId(RequestIdT&& value) {
