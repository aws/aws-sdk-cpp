...
class DescribeAppBlocksRequest : public AppStreamRequest {
 public:
  ...
  template <typename ArnsT = Aws::Vector<Aws::String>>
  DescribeAppBlocksRequest& WithArns(ArnsT&& value) {
    SetArns(std::forward<ArnsT>(value));
    return *this;
  }
  template <typename ArnsT = Aws::String>
  DescribeAppBlocksRequest& AddArns(ArnsT&& value) {
    m_arnsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeAppBlocksRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeAppBlocksRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
