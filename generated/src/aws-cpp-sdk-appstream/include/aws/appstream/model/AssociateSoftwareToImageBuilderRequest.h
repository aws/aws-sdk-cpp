...
class AssociateSoftwareToImageBuilderRequest : public AppStreamRequest {
 public:
  ...
  template <typename ImageBuilderNameT = Aws::String>
  AssociateSoftwareToImageBuilderRequest& WithImageBuilderName(ImageBuilderNameT&& value) {
  ...
  template <typename SoftwareNamesT = Aws::Vector<Aws::String>>
  AssociateSoftwareToImageBuilderRequest& WithSoftwareNames(SoftwareNamesT&& value) {
    SetSoftwareNames(std::forward<SoftwareNamesT>(value));
    return *this;
  }
  template <typename SoftwareNamesT = Aws::String>
  AssociateSoftwareToImageBuilderRequest& AddSoftwareNames(SoftwareNamesT&& value) {
    m_softwareNamesHasBeenSet = true;
