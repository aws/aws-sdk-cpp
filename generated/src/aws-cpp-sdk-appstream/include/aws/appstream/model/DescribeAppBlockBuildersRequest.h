...
class DescribeAppBlockBuildersRequest : public AppStreamRequest {
 public:
  ...
  template <typename NamesT = Aws::Vector<Aws::String>>
  DescribeAppBlockBuildersRequest& WithNames(NamesT&& value) {
    SetNames(std::forward<NamesT>(value));
    return *this;
  }
  template <typename NamesT = Aws::String>
  DescribeAppBlockBuildersRequest& AddNames(NamesT&& value) {
    m_namesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeAppBlockBuildersRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeAppBlockBuildersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
