...
namespace Model
{
  ...
  {
  public:
    AWS_APPSTREAM_API DescribeAppBlockBuildersRequest() = default;
    ...
    template<typename NamesT = Aws::Vector<Aws::String>>
    DescribeAppBlockBuildersRequest& WithNames(NamesT&& value) { SetNames(std::forward<NamesT>(value)); return *this;}
    template<typename NamesT = Aws::String>
    DescribeAppBlockBuildersRequest& AddNames(NamesT&& value) { m_namesHasBeenSet = true; m_names.emplace_back(std::forward<NamesT>(value)); return *this; }
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    DescribeAppBlockBuildersRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
