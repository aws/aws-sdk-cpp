...
class CopyImageRequest : public AppStreamRequest {
 public:
  ...
  void SetSourceImageName(SourceImageNameT&& value) {
    m_sourceImageNameHasBeenSet = true;
    m_sourceImageName = std::forward<SourceImageNameT>(value);
  }
  template <typename SourceImageNameT = Aws::String>
  CopyImageRequest& WithSourceImageName(SourceImageNameT&& value) {
    SetSourceImageName(std::forward<SourceImageNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDestinationImageDescription(DestinationImageDescriptionT&& value) {
    m_destinationImageDescriptionHasBeenSet = true;
    m_destinationImageDescription = std::forward<DestinationImageDescriptionT>(value);
  }
  template <typename DestinationImageDescriptionT = Aws::String>
  CopyImageRequest& WithDestinationImageDescription(DestinationImageDescriptionT&& value) {
    SetDestinationImageDescription(std::forward<DestinationImageDescriptionT>(value));
    return *this;
  }
  ///@}
 private:
