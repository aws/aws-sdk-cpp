...
class DescribeImagePermissionsRequest : public AppStreamRequest {
 public:
  ...
  inline DescribeImagePermissionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  void SetSharedAwsAccountIds(SharedAwsAccountIdsT&& value) {
    m_sharedAwsAccountIdsHasBeenSet = true;
    m_sharedAwsAccountIds = std::forward<SharedAwsAccountIdsT>(value);
  }
  template <typename SharedAwsAccountIdsT = Aws::Vector<Aws::String>>
  DescribeImagePermissionsRequest& WithSharedAwsAccountIds(SharedAwsAccountIdsT&& value) {
    SetSharedAwsAccountIds(std::forward<SharedAwsAccountIdsT>(value));
    return *this;
  }
  ...
  DescribeImagePermissionsRequest& AddSharedAwsAccountIds(SharedAwsAccountIdsT&& value) {
    m_sharedAwsAccountIdsHasBeenSet = true;
    m_sharedAwsAccountIds.emplace_back(std::forward<SharedAwsAccountIdsT>(value));
    return *this;
  }
  ///@}
