...
class ThemeFooterLink {
 public:
  ...
  AWS_APPSTREAM_API ThemeFooterLink(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_APPSTREAM_API ThemeFooterLink& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  template <typename DisplayNameT = Aws::String>
  ThemeFooterLink& WithDisplayName(DisplayNameT&& value) {
  ...
  void SetFooterLinkURL(FooterLinkURLT&& value) {
    m_footerLinkURLHasBeenSet = true;
    m_footerLinkURL = std::forward<FooterLinkURLT>(value);
  }
  template <typename FooterLinkURLT = Aws::String>
  ThemeFooterLink& WithFooterLinkURL(FooterLinkURLT&& value) {
    SetFooterLinkURL(std::forward<FooterLinkURLT>(value));
    return *this;
  }
  ///@}
 private:
