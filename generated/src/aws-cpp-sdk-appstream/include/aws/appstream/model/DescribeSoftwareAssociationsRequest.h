...
namespace Model
{
  ...
  public:
    ...
    template<typename AssociatedResourceT = Aws::String>
    DescribeSoftwareAssociationsRequest& WithAssociatedResource(AssociatedResourceT&& value) { SetAssociatedResource(std::forward<AssociatedResourceT>(value)); return *this;}
    ///@}
    ...
    inline DescribeSoftwareAssociationsRequest& WithMaxResults(int value) { SetMaxResults(value); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    DescribeSoftwareAssociationsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
