...
class CreateExportImageTaskResult {
 public:
  ...
  AWS_APPSTREAM_API CreateExportImageTaskResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_APPSTREAM_API CreateExportImageTaskResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
