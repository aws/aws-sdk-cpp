...
class BatchDisassociateUserStackResult {
 public:
  ...
  AWS_APPSTREAM_API BatchDisassociateUserStackResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_APPSTREAM_API BatchDisassociateUserStackResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
