...
class UpdateAppBlockBuilderRequest : public AppStreamRequest {
 public:
  ...
  inline UpdateAppBlockBuilderRequest& WithPlatform(PlatformType value) {
    SetPlatform(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateAppBlockBuilderRequest& WithEnableDefaultInternetAccess(bool value) {
  ...
  inline UpdateAppBlockBuilderRequest& AddAttributesToDelete(AppBlockBuilderAttribute value) {
    m_attributesToDeleteHasBeenSet = true;
