...
namespace Model
{
  ...
  public:
    ...
    void SetAppLicenseUsages(AppLicenseUsagesT&& value) { m_appLicenseUsagesHasBeenSet = true; m_appLicenseUsages = std::forward<AppLicenseUsagesT>(value); }
    template<typename AppLicenseUsagesT = Aws::Vector<AdminAppLicenseUsageRecord>>
    DescribeAppLicenseUsageResult& WithAppLicenseUsages(AppLicenseUsagesT&& value) { SetAppLicenseUsages(std::forward<AppLicenseUsagesT>(value)); return *this;}
    template<typename AppLicenseUsagesT = AdminAppLicenseUsageRecord>
    DescribeAppLicenseUsageResult& AddAppLicenseUsages(AppLicenseUsagesT&& value) { m_appLicenseUsagesHasBeenSet = true; m_appLicenseUsages.emplace_back(std::forward<AppLicenseUsagesT>(value)); return *this; }
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    DescribeAppLicenseUsageResult& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DescribeAppLicenseUsageResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
