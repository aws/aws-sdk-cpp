...
class DescribeAppLicenseUsageResult {
 public:
  ...
  AWS_APPSTREAM_API DescribeAppLicenseUsageResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_APPSTREAM_API DescribeAppLicenseUsageResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
