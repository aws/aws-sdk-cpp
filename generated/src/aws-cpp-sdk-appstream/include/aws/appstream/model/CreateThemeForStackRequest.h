...
class CreateThemeForStackRequest : public AppStreamRequest {
 public:
  ...
  void SetFooterLinks(FooterLinksT&& value) {
    m_footerLinksHasBeenSet = true;
    m_footerLinks = std::forward<FooterLinksT>(value);
  }
  template <typename FooterLinksT = Aws::Vector<ThemeFooterLink>>
  CreateThemeForStackRequest& WithFooterLinks(FooterLinksT&& value) {
    SetFooterLinks(std::forward<FooterLinksT>(value));
    return *this;
  }
  template <typename FooterLinksT = ThemeFooterLink>
  CreateThemeForStackRequest& AddFooterLinks(FooterLinksT&& value) {
    m_footerLinksHasBeenSet = true;
    m_footerLinks.emplace_back(std::forward<FooterLinksT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTitleText(TitleTextT&& value) {
    m_titleTextHasBeenSet = true;
    m_titleText = std::forward<TitleTextT>(value);
  }
  template <typename TitleTextT = Aws::String>
  CreateThemeForStackRequest& WithTitleText(TitleTextT&& value) {
    SetTitleText(std::forward<TitleTextT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateThemeForStackRequest& WithThemeStyling(ThemeStyling value) {
  ...
  void SetOrganizationLogoS3Location(OrganizationLogoS3LocationT&& value) {
    m_organizationLogoS3LocationHasBeenSet = true;
    m_organizationLogoS3Location = std::forward<OrganizationLogoS3LocationT>(value);
  }
  template <typename OrganizationLogoS3LocationT = S3Location>
  CreateThemeForStackRequest& WithOrganizationLogoS3Location(OrganizationLogoS3LocationT&& value) {
    SetOrganizationLogoS3Location(std::forward<OrganizationLogoS3LocationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFaviconS3Location(FaviconS3LocationT&& value) {
    m_faviconS3LocationHasBeenSet = true;
    m_faviconS3Location = std::forward<FaviconS3LocationT>(value);
  }
  template <typename FaviconS3LocationT = S3Location>
  CreateThemeForStackRequest& WithFaviconS3Location(FaviconS3LocationT&& value) {
    SetFaviconS3Location(std::forward<FaviconS3LocationT>(value));
    return *this;
  }
  ///@}
 private:
