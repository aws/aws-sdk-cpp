...
namespace Model
{
  ...
  public:
    ...
    template<typename AppBlockBuilderT = AppBlockBuilder>
    StopAppBlockBuilderResult& WithAppBlockBuilder(AppBlockBuilderT&& value) { SetAppBlockBuilder(std::forward<AppBlockBuilderT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    StopAppBlockBuilderResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
