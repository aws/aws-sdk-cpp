...
class StopAppBlockBuilderResult {
 public:
  ...
  AWS_APPSTREAM_API StopAppBlockBuilderResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_APPSTREAM_API StopAppBlockBuilderResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
