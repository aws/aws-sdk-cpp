...
class CreateAppBlockResult {
 public:
  ...
  AWS_APPSTREAM_API CreateAppBlockResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_APPSTREAM_API CreateAppBlockResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  void SetAppBlock(AppBlockT&& value) {
    ...
    m_appBlock = std::forward<AppBlockT>(value);
  }
  template <typename AppBlockT = AppBlock>
  CreateAppBlockResult& WithAppBlock(AppBlockT&& value) {
    SetAppBlock(std::forward<AppBlockT>(value));
    return *this;
  }
  ///@}
