...
namespace Model
{
  ...
  public:
    ...
    template<typename NameT = Aws::String>
    UpdateEntitlementRequest& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename StackNameT = Aws::String>
    UpdateEntitlementRequest& WithStackName(StackNameT&& value) { SetStackName(std::forward<StackNameT>(value)); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    UpdateEntitlementRequest& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    inline UpdateEntitlementRequest& WithAppVisibility(AppVisibility value) { SetAppVisibility(value); return *this;}
    ///@}
    ...
    template<typename AttributesT = Aws::Vector<EntitlementAttribute>>
    UpdateEntitlementRequest& WithAttributes(AttributesT&& value) { SetAttributes(std::forward<AttributesT>(value)); return *this;}
    template<typename AttributesT = EntitlementAttribute>
    UpdateEntitlementRequest& AddAttributes(AttributesT&& value) { m_attributesHasBeenSet = true; m_attributes.emplace_back(std::forward<AttributesT>(value)); return *this; }
    ///@}
  private:
