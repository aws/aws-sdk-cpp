...
namespace Model
{
  ...
  /**
   */
  class DisassociateSoftwareFromImageBuilderRequest : public AppStreamRequest
  {
  public:
    AWS_APPSTREAM_API DisassociateSoftwareFromImageBuilderRequest() = default;

    // Service request name is the Operation name which will send this request out,
    // each operation should has unique request name, so that we can get operation's name from this request.
    // Note: this is not true for response, multiple operations may have the same response name,
    // so we can not get operation's name from response.
    inline virtual const char* GetServiceRequestName() const override { return "DisassociateSoftwareFromImageBuilder"; }
    ...
    template<typename ImageBuilderNameT = Aws::String>
    DisassociateSoftwareFromImageBuilderRequest& WithImageBuilderName(ImageBuilderNameT&& value) { SetImageBuilderName(std::forward<ImageBuilderNameT>(value)); return *this;}
    ///@}

    ///@{
    /**
     * <p>The list of license included applications to disassociate from the image
    ...
    template<typename SoftwareNamesT = Aws::Vector<Aws::String>>
    DisassociateSoftwareFromImageBuilderRequest& WithSoftwareNames(SoftwareNamesT&& value) { SetSoftwareNames(std::forward<SoftwareNamesT>(value)); return *this;}
    template<typename SoftwareNamesT = Aws::String>
    DisassociateSoftwareFromImageBuilderRequest& AddSoftwareNames(SoftwareNamesT&& value) { m_softwareNamesHasBeenSet = true; m_softwareNames.emplace_back(std::forward<SoftwareNamesT>(value)); return *this; }
    ///@}
  private:
