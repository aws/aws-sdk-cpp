...
class CreateApplicationResult {
 public:
  AWS_APPSTREAM_API CreateApplicationResult() = default;
  AWS_APPSTREAM_API CreateApplicationResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_APPSTREAM_API CreateApplicationResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  template <typename ApplicationT = Application>
  CreateApplicationResult& WithApplication(ApplicationT&& value) {
