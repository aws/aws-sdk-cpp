...
class ApplicationConfig {
 public:
  ...
  AWS_APPSTREAM_API ApplicationConfig(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_APPSTREAM_API ApplicationConfig& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
