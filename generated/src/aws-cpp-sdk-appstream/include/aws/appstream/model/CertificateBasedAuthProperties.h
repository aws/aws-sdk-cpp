...
class CertificateBasedAuthProperties {
 public:
  ...
  AWS_APPSTREAM_API CertificateBasedAuthProperties(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_APPSTREAM_API CertificateBasedAuthProperties& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline void SetStatus(CertificateBasedAuthStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline CertificateBasedAuthProperties& WithStatus(CertificateBasedAuthStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
