...
class DescribeAppBlockBuilderAppBlockAssociationsRequest : public AppStreamRequest {
 public:
  ...
  template <typename AppBlockArnT = Aws::String>
  DescribeAppBlockBuilderAppBlockAssociationsRequest& WithAppBlockArn(AppBlockArnT&& value) {
  ...
  template <typename AppBlockBuilderNameT = Aws::String>
  DescribeAppBlockBuilderAppBlockAssociationsRequest& WithAppBlockBuilderName(AppBlockBuilderNameT&& value) {
  ...
  inline DescribeAppBlockBuilderAppBlockAssociationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeAppBlockBuilderAppBlockAssociationsRequest& WithNextToken(NextTokenT&& value) {
