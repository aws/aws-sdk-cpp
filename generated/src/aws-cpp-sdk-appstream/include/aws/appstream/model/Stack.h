...
class Stack {
 public:
  ...
  AWS_APPSTREAM_API Stack(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_APPSTREAM_API Stack& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
