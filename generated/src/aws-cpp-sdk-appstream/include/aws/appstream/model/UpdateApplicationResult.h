...
class UpdateApplicationResult {
 public:
  ...
  AWS_APPSTREAM_API UpdateApplicationResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_APPSTREAM_API UpdateApplicationResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
