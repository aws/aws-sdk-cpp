...
class UpdateEntitlementResult {
 public:
  ...
  AWS_APPSTREAM_API UpdateEntitlementResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_APPSTREAM_API UpdateEntitlementResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  template <typename EntitlementT = Entitlement>
  UpdateEntitlementResult& WithEntitlement(EntitlementT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateEntitlementResult& WithRequestId(RequestIdT&& value) {
