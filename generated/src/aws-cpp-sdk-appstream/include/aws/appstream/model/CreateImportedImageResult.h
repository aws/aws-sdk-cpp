...
class CreateImportedImageResult {
 public:
  ...
  AWS_APPSTREAM_API CreateImportedImageResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_APPSTREAM_API CreateImportedImageResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
