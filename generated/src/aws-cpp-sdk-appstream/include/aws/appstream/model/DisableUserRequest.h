...
namespace Model
{
  ...
  public:
    ...
    template<typename UserNameT = Aws::String>
    DisableUserRequest& WithUserName(UserNameT&& value) { SetUserName(std::forward<UserNameT>(value)); return *this;}
    ///@}
    ...
    inline DisableUserRequest& WithAuthenticationType(AuthenticationType value) { SetAuthenticationType(value); return *this;}
    ///@}
  private:
