...
class ImagePermissions {
 public:
  ...
  inline void SetAllowFleet(bool value) {
    m_allowFleetHasBeenSet = true;
    m_allowFleet = value;
  }
  inline ImagePermissions& WithAllowFleet(bool value) {
    SetAllowFleet(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAllowImageBuilder(bool value) {
    m_allowImageBuilderHasBeenSet = true;
    m_allowImageBuilder = value;
  }
  inline ImagePermissions& WithAllowImageBuilder(bool value) {
    SetAllowImageBuilder(value);
    return *this;
  }
  ///@}
 private:
