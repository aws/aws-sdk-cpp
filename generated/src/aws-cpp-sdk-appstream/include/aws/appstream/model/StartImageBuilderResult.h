...
class StartImageBuilderResult {
 public:
  AWS_APPSTREAM_API StartImageBuilderResult() = default;
  AWS_APPSTREAM_API StartImageBuilderResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_APPSTREAM_API StartImageBuilderResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  template <typename ImageBuilderT = ImageBuilder>
  StartImageBuilderResult& WithImageBuilder(ImageBuilderT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StartImageBuilderResult& WithRequestId(RequestIdT&& value) {
