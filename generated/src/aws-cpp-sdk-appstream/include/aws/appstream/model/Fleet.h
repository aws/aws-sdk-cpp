...
class Fleet {
 public:
  ...
  inline Fleet& WithFleetType(FleetType value) {
    SetFleetType(value);
    return *this;
  }
  ///@}
  ...
  void SetComputeCapacityStatus(ComputeCapacityStatusT&& value) {
    ...
    m_computeCapacityStatus = std::forward<ComputeCapacityStatusT>(value);
  }
  template <typename ComputeCapacityStatusT = ComputeCapacityStatus>
  Fleet& WithComputeCapacityStatus(ComputeCapacityStatusT&& value) {
    SetComputeCapacityStatus(std::forward<ComputeCapacityStatusT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetState(FleetState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline Fleet& WithState(FleetState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  void SetFleetErrors(FleetErrorsT&& value) {
    ...
    m_fleetErrors = std::forward<FleetErrorsT>(value);
  }
  template <typename FleetErrorsT = Aws::Vector<FleetError>>
  Fleet& WithFleetErrors(FleetErrorsT&& value) {
    SetFleetErrors(std::forward<FleetErrorsT>(value));
    return *this;
  }
  template <typename FleetErrorsT = FleetError>
  Fleet& AddFleetErrors(FleetErrorsT&& value) {
    m_fleetErrorsHasBeenSet = true;
    m_fleetErrors.emplace_back(std::forward<FleetErrorsT>(value));
    return *this;
  }
  ///@}
  ...
  inline Fleet& WithEnableDefaultInternetAccess(bool value) {
  ...
  inline Fleet& WithStreamView(StreamView value) {
    SetStreamView(value);
    return *this;
  }
  ///@}
  ...
  inline Fleet& WithPlatform(PlatformType value) {
    SetPlatform(value);
    return *this;
  }
  ///@}
  ...
  ///@{
  /**
   * <p>The current configuration of the root volume for fleet instances, including
