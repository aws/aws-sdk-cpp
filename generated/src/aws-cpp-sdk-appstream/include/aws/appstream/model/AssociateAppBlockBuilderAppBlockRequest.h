...
class AssociateAppBlockBuilderAppBlockRequest : public AppStreamRequest {
 public:
  ...
  template <typename AppBlockArnT = Aws::String>
  AssociateAppBlockBuilderAppBlockRequest& WithAppBlockArn(AppBlockArnT&& value) {
  ...
  template <typename AppBlockBuilderNameT = Aws::String>
  AssociateAppBlockBuilderAppBlockRequest& WithAppBlockBuilderName(AppBlockBuilderNameT&& value) {
