...
class StartAppBlockBuilderResult {
 public:
  AWS_APPSTREAM_API StartAppBlockBuilderResult() = default;
  AWS_APPSTREAM_API StartAppBlockBuilderResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_APPSTREAM_API StartAppBlockBuilderResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  template <typename AppBlockBuilderT = AppBlockBuilder>
  StartAppBlockBuilderResult& WithAppBlockBuilder(AppBlockBuilderT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StartAppBlockBuilderResult& WithRequestId(RequestIdT&& value) {
