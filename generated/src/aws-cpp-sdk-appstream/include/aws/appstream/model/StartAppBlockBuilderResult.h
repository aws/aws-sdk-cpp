...
namespace Model
{
  ...
  public:
    ...
    template<typename AppBlockBuilderT = AppBlockBuilder>
    StartAppBlockBuilderResult& WithAppBlockBuilder(AppBlockBuilderT&& value) { SetAppBlockBuilder(std::forward<AppBlockBuilderT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    StartAppBlockBuilderResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
