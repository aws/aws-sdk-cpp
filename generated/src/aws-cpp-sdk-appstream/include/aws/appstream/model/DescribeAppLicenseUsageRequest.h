...
namespace Model
{
  ...
  public:
    ...
    template<typename BillingPeriodT = Aws::String>
    DescribeAppLicenseUsageRequest& WithBillingPeriod(BillingPeriodT&& value) { SetBillingPeriod(std::forward<BillingPeriodT>(value)); return *this;}
    ///@}
    ...
    inline DescribeAppLicenseUsageRequest& WithMaxResults(int value) { SetMaxResults(value); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    DescribeAppLicenseUsageRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
