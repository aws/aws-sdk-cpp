...
class StopImageBuilderResult {
 public:
  ...
  AWS_APPSTREAM_API StopImageBuilderResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_APPSTREAM_API StopImageBuilderResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  template <typename ImageBuilderT = ImageBuilder>
  StopImageBuilderResult& WithImageBuilder(ImageBuilderT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StopImageBuilderResult& WithRequestId(RequestIdT&& value) {
