...
class UserStackAssociationError {
 public:
  ...
  void SetUserStackAssociation(UserStackAssociationT&& value) {
    ...
    m_userStackAssociation = std::forward<UserStackAssociationT>(value);
  }
  template <typename UserStackAssociationT = UserStackAssociation>
  UserStackAssociationError& WithUserStackAssociation(UserStackAssociationT&& value) {
    SetUserStackAssociation(std::forward<UserStackAssociationT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetErrorCode(UserStackAssociationErrorCode value) {
    m_errorCodeHasBeenSet = true;
    m_errorCode = value;
  }
  inline UserStackAssociationError& WithErrorCode(UserStackAssociationErrorCode value) {
    SetErrorCode(value);
    return *this;
  }
  ///@}
