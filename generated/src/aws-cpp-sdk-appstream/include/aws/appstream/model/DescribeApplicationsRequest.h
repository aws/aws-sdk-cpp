...
namespace Model
{
  ...
  public:
    ...
    template<typename ArnsT = Aws::Vector<Aws::String>>
    DescribeApplicationsRequest& WithArns(ArnsT&& value) { SetArns(std::forward<ArnsT>(value)); return *this;}
    template<typename ArnsT = Aws::String>
    DescribeApplicationsRequest& AddArns(ArnsT&& value) { m_arnsHasBeenSet = true; m_arns.emplace_back(std::forward<ArnsT>(value)); return *this; }
    ///@}
