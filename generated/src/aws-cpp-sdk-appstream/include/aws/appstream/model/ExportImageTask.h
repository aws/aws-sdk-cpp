...
class ExportImageTask {
 public:
  ...
  AWS_APPSTREAM_API ExportImageTask(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_APPSTREAM_API ExportImageTask& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
