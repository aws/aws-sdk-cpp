...
class AppBlockBuilderStateChangeReason {
 public:
  ...
  AWS_APPSTREAM_API AppBlockBuilderStateChangeReason(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_APPSTREAM_API AppBlockBuilderStateChangeReason& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline void SetCode(AppBlockBuilderStateChangeReasonCode value) {
    m_codeHasBeenSet = true;
    m_code = value;
  }
  inline AppBlockBuilderStateChangeReason& WithCode(AppBlockBuilderStateChangeReasonCode value) {
    SetCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename MessageT = Aws::String>
  AppBlockBuilderStateChangeReason& WithMessage(MessageT&& value) {
