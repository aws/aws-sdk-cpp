...
class ImageStateChangeReason {
 public:
  ...
  AWS_APPSTREAM_API ImageStateChangeReason(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_APPSTREAM_API ImageStateChangeReason& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline void SetCode(ImageStateChangeReasonCode value) {
    m_codeHasBeenSet = true;
    m_code = value;
  }
  inline ImageStateChangeReason& WithCode(ImageStateChangeReasonCode value) {
    SetCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename MessageT = Aws::String>
  ImageStateChangeReason& WithMessage(MessageT&& value) {
