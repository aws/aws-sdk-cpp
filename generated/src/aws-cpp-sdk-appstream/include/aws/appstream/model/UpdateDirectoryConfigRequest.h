...
class UpdateDirectoryConfigRequest : public AppStreamRequest {
 public:
  AWS_APPSTREAM_API UpdateDirectoryConfigRequest() = default;
  ...
  template <typename DirectoryNameT = Aws::String>
  UpdateDirectoryConfigRequest& WithDirectoryName(DirectoryNameT&& value) {
  ...
  void SetOrganizationalUnitDistinguishedNames(OrganizationalUnitDistinguishedNamesT&& value) {
    m_organizationalUnitDistinguishedNamesHasBeenSet = true;
    m_organizationalUnitDistinguishedNames = std::forward<OrganizationalUnitDistinguishedNamesT>(value);
  }
  template <typename OrganizationalUnitDistinguishedNamesT = Aws::Vector<Aws::String>>
  UpdateDirectoryConfigRequest& WithOrganizationalUnitDistinguishedNames(OrganizationalUnitDistinguishedNamesT&& value) {
    SetOrganizationalUnitDistinguishedNames(std::forward<OrganizationalUnitDistinguishedNamesT>(value));
    return *this;
  }
  template <typename OrganizationalUnitDistinguishedNamesT = Aws::String>
  UpdateDirectoryConfigRequest& AddOrganizationalUnitDistinguishedNames(OrganizationalUnitDistinguishedNamesT&& value) {
    m_organizationalUnitDistinguishedNamesHasBeenSet = true;
    m_organizationalUnitDistinguishedNames.emplace_back(std::forward<OrganizationalUnitDistinguishedNamesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetServiceAccountCredentials(ServiceAccountCredentialsT&& value) {
    m_serviceAccountCredentialsHasBeenSet = true;
    m_serviceAccountCredentials = std::forward<ServiceAccountCredentialsT>(value);
  }
  template <typename ServiceAccountCredentialsT = ServiceAccountCredentials>
  UpdateDirectoryConfigRequest& WithServiceAccountCredentials(ServiceAccountCredentialsT&& value) {
    SetServiceAccountCredentials(std::forward<ServiceAccountCredentialsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename CertificateBasedAuthPropertiesT = CertificateBasedAuthProperties>
  UpdateDirectoryConfigRequest& WithCertificateBasedAuthProperties(CertificateBasedAuthPropertiesT&& value) {
