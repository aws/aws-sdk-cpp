...
class DisassociateAppBlockBuilderAppBlockRequest : public AppStreamRequest {
 public:
  ...
  template <typename AppBlockArnT = Aws::String>
  DisassociateAppBlockBuilderAppBlockRequest& WithAppBlockArn(AppBlockArnT&& value) {
  ...
  template <typename AppBlockBuilderNameT = Aws::String>
  DisassociateAppBlockBuilderAppBlockRequest& WithAppBlockBuilderName(AppBlockBuilderNameT&& value) {
