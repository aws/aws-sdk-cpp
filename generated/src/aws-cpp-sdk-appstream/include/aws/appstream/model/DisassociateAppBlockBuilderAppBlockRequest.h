...
namespace Model
{
  ...
  {
  public:
    AWS_APPSTREAM_API DisassociateAppBlockBuilderAppBlockRequest() = default;
    ...
    template<typename AppBlockArnT = Aws::String>
    DisassociateAppBlockBuilderAppBlockRequest& WithAppBlockArn(AppBlockArnT&& value) { SetAppBlockArn(std::forward<AppBlockArnT>(value)); return *this;}
    ///@}
    ...
    template<typename AppBlockBuilderNameT = Aws::String>
    DisassociateAppBlockBuilderAppBlockRequest& WithAppBlockBuilderName(AppBlockBuilderNameT&& value) { SetAppBlockBuilderName(std::forward<AppBlockBuilderNameT>(value)); return *this;}
    ///@}
  private:
