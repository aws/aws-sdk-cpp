...
class UpdateAppBlockBuilderResult {
 public:
  ...
  AWS_APPSTREAM_API UpdateAppBlockBuilderResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_APPSTREAM_API UpdateAppBlockBuilderResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  template <typename AppBlockBuilderT = AppBlockBuilder>
  UpdateAppBlockBuilderResult& WithAppBlockBuilder(AppBlockBuilderT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateAppBlockBuilderResult& WithRequestId(RequestIdT&& value) {
