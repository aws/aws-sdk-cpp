...
namespace Model
{
  ...
  public:
    ...
    template<typename UserStackAssociationsT = Aws::Vector<UserStackAssociation>>
    BatchDisassociateUserStackRequest& WithUserStackAssociations(UserStackAssociationsT&& value) { SetUserStackAssociations(std::forward<UserStackAssociationsT>(value)); return *this;}
    template<typename UserStackAssociationsT = UserStackAssociation>
    BatchDisassociateUserStackRequest& AddUserStackAssociations(UserStackAssociationsT&& value) { m_userStackAssociationsHasBeenSet = true; m_userStackAssociations.emplace_back(std::forward<UserStackAssociationsT>(value)); return *this; }
    ///@}
  private:
