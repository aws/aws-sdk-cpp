...
class BatchDisassociateUserStackRequest : public AppStreamRequest {
 public:
  AWS_APPSTREAM_API BatchDisassociateUserStackRequest() = default;
  ...
  template <typename UserStackAssociationsT = Aws::Vector<UserStackAssociation>>
  BatchDisassociateUserStackRequest& WithUserStackAssociations(UserStackAssociationsT&& value) {
  ...
  BatchDisassociateUserStackRequest& AddUserStackAssociations(UserStackAssociationsT&& value) {
    m_userStackAssociationsHasBeenSet = true;
