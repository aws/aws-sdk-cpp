...
class Image {
 public:
  ...
  AWS_APPSTREAM_API Image(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_APPSTREAM_API Image& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
