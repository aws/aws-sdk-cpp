...
class ApplicationSettings {
 public:
  ...
  AWS_APPSTREAM_API ApplicationSettings(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_APPSTREAM_API ApplicationSettings& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline ApplicationSettings& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  template <typename SettingsGroupT = Aws::String>
  ApplicationSettings& WithSettingsGroup(SettingsGroupT&& value) {
