...
class DirectoryConfig {
 public:
  ...
  AWS_APPSTREAM_API DirectoryConfig(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_APPSTREAM_API DirectoryConfig& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  template <typename DirectoryNameT = Aws::String>
  DirectoryConfig& WithDirectoryName(DirectoryNameT&& value) {
  ...
  template <typename OrganizationalUnitDistinguishedNamesT = Aws::Vector<Aws::String>>
  DirectoryConfig& WithOrganizationalUnitDistinguishedNames(OrganizationalUnitDistinguishedNamesT&& value) {
  ...
  DirectoryConfig& AddOrganizationalUnitDistinguishedNames(OrganizationalUnitDistinguishedNamesT&& value) {
    m_organizationalUnitDistinguishedNamesHasBeenSet = true;
  ...
  template <typename ServiceAccountCredentialsT = ServiceAccountCredentials>
  DirectoryConfig& WithServiceAccountCredentials(ServiceAccountCredentialsT&& value) {
  ...
  template <typename CreatedTimeT = Aws::Utils::DateTime>
  DirectoryConfig& WithCreatedTime(CreatedTimeT&& value) {
  ...
  template <typename CertificateBasedAuthPropertiesT = CertificateBasedAuthProperties>
  DirectoryConfig& WithCertificateBasedAuthProperties(CertificateBasedAuthPropertiesT&& value) {
