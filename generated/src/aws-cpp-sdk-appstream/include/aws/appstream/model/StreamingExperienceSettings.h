...
class StreamingExperienceSettings {
 public:
  ...
  AWS_APPSTREAM_API StreamingExperienceSettings(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_APPSTREAM_API StreamingExperienceSettings& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline void SetPreferredProtocol(PreferredProtocol value) {
    m_preferredProtocolHasBeenSet = true;
    m_preferredProtocol = value;
  }
  inline StreamingExperienceSettings& WithPreferredProtocol(PreferredProtocol value) {
    SetPreferredProtocol(value);
    return *this;
  }
  ///@}
 private:
