...
class LastReportGenerationExecutionError {
 public:
  ...
  AWS_APPSTREAM_API LastReportGenerationExecutionError(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_APPSTREAM_API LastReportGenerationExecutionError& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline void SetErrorCode(UsageReportExecutionErrorCode value) {
    m_errorCodeHasBeenSet = true;
    m_errorCode = value;
  }
  inline LastReportGenerationExecutionError& WithErrorCode(UsageReportExecutionErrorCode value) {
    SetErrorCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename ErrorMessageT = Aws::String>
  LastReportGenerationExecutionError& WithErrorMessage(ErrorMessageT&& value) {
