...
class DescribeDirectoryConfigsRequest : public AppStreamRequest {
 public:
  ...
  void SetDirectoryNames(DirectoryNamesT&& value) {
    m_directoryNamesHasBeenSet = true;
    m_directoryNames = std::forward<DirectoryNamesT>(value);
  }
  template <typename DirectoryNamesT = Aws::Vector<Aws::String>>
  DescribeDirectoryConfigsRequest& WithDirectoryNames(DirectoryNamesT&& value) {
    SetDirectoryNames(std::forward<DirectoryNamesT>(value));
    return *this;
  }
  template <typename DirectoryNamesT = Aws::String>
  DescribeDirectoryConfigsRequest& AddDirectoryNames(DirectoryNamesT&& value) {
    m_directoryNamesHasBeenSet = true;
    m_directoryNames.emplace_back(std::forward<DirectoryNamesT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeDirectoryConfigsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
