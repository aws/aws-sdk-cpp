...
class AppBlockBuilderAppBlockAssociation {
 public:
  ...
  AWS_APPSTREAM_API AppBlockBuilderAppBlockAssociation(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_APPSTREAM_API AppBlockBuilderAppBlockAssociation& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  void SetAppBlockArn(AppBlockArnT&& value) {
    ...
    m_appBlockArn = std::forward<AppBlockArnT>(value);
  }
  template <typename AppBlockArnT = Aws::String>
  AppBlockBuilderAppBlockAssociation& WithAppBlockArn(AppBlockArnT&& value) {
    SetAppBlockArn(std::forward<AppBlockArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAppBlockBuilderName(AppBlockBuilderNameT&& value) {
    m_appBlockBuilderNameHasBeenSet = true;
    m_appBlockBuilderName = std::forward<AppBlockBuilderNameT>(value);
  }
  template <typename AppBlockBuilderNameT = Aws::String>
  AppBlockBuilderAppBlockAssociation& WithAppBlockBuilderName(AppBlockBuilderNameT&& value) {
    SetAppBlockBuilderName(std::forward<AppBlockBuilderNameT>(value));
    return *this;
  }
  ///@}
 private:
