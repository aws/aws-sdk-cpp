...
class VpcConfig {
 public:
  ...
  AWS_APPSTREAM_API VpcConfig(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_APPSTREAM_API VpcConfig& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
