...
class CreateFleetRequest : public AppStreamRequest {
 public:
  ...
  inline CreateFleetRequest& WithMaxUserDurationInSeconds(int value) {
  ...
  inline CreateFleetRequest& WithDisconnectTimeoutInSeconds(int value) {
  ...
  inline CreateFleetRequest& WithEnableDefaultInternetAccess(bool value) {
  ...
  inline CreateFleetRequest& WithIdleDisconnectTimeoutInSeconds(int value) {
  ...
  inline CreateFleetRequest& WithStreamView(StreamView value) {
    SetStreamView(value);
    return *this;
  }
  ///@}
  ...
  inline CreateFleetRequest& WithPlatform(PlatformType value) {
    SetPlatform(value);
    return *this;
  }
  ///@}
  ...
  inline CreateFleetRequest& WithMaxConcurrentSessions(int value) {
  ...
  inline CreateFleetRequest& WithMaxSessionsPerInstance(int value) {
  ...
  inline CreateFleetRequest& WithDisableIMDSV1(bool value) {
