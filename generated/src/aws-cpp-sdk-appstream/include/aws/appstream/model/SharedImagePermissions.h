...
class SharedImagePermissions {
 public:
  ...
  AWS_APPSTREAM_API SharedImagePermissions(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_APPSTREAM_API SharedImagePermissions& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  template <typename SharedAccountIdT = Aws::String>
  SharedImagePermissions& WithSharedAccountId(SharedAccountIdT&& value) {
  ...
  template <typename ImagePermissionsT = ImagePermissions>
  SharedImagePermissions& WithImagePermissions(ImagePermissionsT&& value) {
