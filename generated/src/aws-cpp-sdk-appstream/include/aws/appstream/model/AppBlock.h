...
class AppBlock {
 public:
  ...
  inline AppBlock& WithPackagingType(PackagingType value) {
  ...
  inline void SetState(AppBlockState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline AppBlock& WithState(AppBlockState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  void SetAppBlockErrors(AppBlockErrorsT&& value) {
    ...
    m_appBlockErrors = std::forward<AppBlockErrorsT>(value);
  }
  template <typename AppBlockErrorsT = Aws::Vector<ErrorDetails>>
  AppBlock& WithAppBlockErrors(AppBlockErrorsT&& value) {
    SetAppBlockErrors(std::forward<AppBlockErrorsT>(value));
    return *this;
  }
  template <typename AppBlockErrorsT = ErrorDetails>
  AppBlock& AddAppBlockErrors(AppBlockErrorsT&& value) {
    m_appBlockErrorsHasBeenSet = true;
    m_appBlockErrors.emplace_back(std::forward<AppBlockErrorsT>(value));
    return *this;
  }
  ///@}
 private:
