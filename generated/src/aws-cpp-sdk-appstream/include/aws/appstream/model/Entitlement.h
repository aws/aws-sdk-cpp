...
class Entitlement {
 public:
  ...
  AWS_APPSTREAM_API Entitlement(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_APPSTREAM_API Entitlement& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
