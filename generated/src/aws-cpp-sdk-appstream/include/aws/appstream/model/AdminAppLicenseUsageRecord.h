...
namespace Model
{
  ...
  public:
    ...
    template<typename UserArnT = Aws::String>
    AdminAppLicenseUsageRecord& WithUserArn(UserArnT&& value) { SetUserArn(std::forward<UserArnT>(value)); return *this;}
    ///@}
    ...
    template<typename BillingPeriodT = Aws::String>
    AdminAppLicenseUsageRecord& WithBillingPeriod(BillingPeriodT&& value) { SetBillingPeriod(std::forward<BillingPeriodT>(value)); return *this;}
    ///@}
    ...
    void SetOwnerAWSAccountId(OwnerAWSAccountIdT&& value) { m_ownerAWSAccountIdHasBeenSet = true; m_ownerAWSAccountId = std::forward<OwnerAWSAccountIdT>(value); }
    template<typename OwnerAWSAccountIdT = Aws::String>
    AdminAppLicenseUsageRecord& WithOwnerAWSAccountId(OwnerAWSAccountIdT&& value) { SetOwnerAWSAccountId(std::forward<OwnerAWSAccountIdT>(value)); return *this;}
    ///@}
    ...
    void SetSubscriptionFirstUsedDate(SubscriptionFirstUsedDateT&& value) { m_subscriptionFirstUsedDateHasBeenSet = true; m_subscriptionFirstUsedDate = std::forward<SubscriptionFirstUsedDateT>(value); }
    template<typename SubscriptionFirstUsedDateT = Aws::Utils::DateTime>
    AdminAppLicenseUsageRecord& WithSubscriptionFirstUsedDate(SubscriptionFirstUsedDateT&& value) { SetSubscriptionFirstUsedDate(std::forward<SubscriptionFirstUsedDateT>(value)); return *this;}
    ///@}
    ...
    void SetSubscriptionLastUsedDate(SubscriptionLastUsedDateT&& value) { m_subscriptionLastUsedDateHasBeenSet = true; m_subscriptionLastUsedDate = std::forward<SubscriptionLastUsedDateT>(value); }
    template<typename SubscriptionLastUsedDateT = Aws::Utils::DateTime>
    AdminAppLicenseUsageRecord& WithSubscriptionLastUsedDate(SubscriptionLastUsedDateT&& value) { SetSubscriptionLastUsedDate(std::forward<SubscriptionLastUsedDateT>(value)); return *this;}
    ///@}
    ...
    template<typename LicenseTypeT = Aws::String>
    AdminAppLicenseUsageRecord& WithLicenseType(LicenseTypeT&& value) { SetLicenseType(std::forward<LicenseTypeT>(value)); return *this;}
    ///@}
    ...
    template<typename UserIdT = Aws::String>
    AdminAppLicenseUsageRecord& WithUserId(UserIdT&& value) { SetUserId(std::forward<UserIdT>(value)); return *this;}
    ///@}
  private:
