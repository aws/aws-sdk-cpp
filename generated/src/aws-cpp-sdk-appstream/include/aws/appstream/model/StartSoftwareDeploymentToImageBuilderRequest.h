...
namespace Model
{
  ...
  public:
    ...
    template<typename ImageBuilderNameT = Aws::String>
    StartSoftwareDeploymentToImageBuilderRequest& WithImageBuilderName(ImageBuilderNameT&& value) { SetImageBuilderName(std::forward<ImageBuilderNameT>(value)); return *this;}
    ///@}
    ...
    inline void SetRetryFailedDeployments(bool value) { m_retryFailedDeploymentsHasBeenSet = true; m_retryFailedDeployments = value; }
    inline StartSoftwareDeploymentToImageBuilderRequest& WithRetryFailedDeployments(bool value) { SetRetryFailedDeployments(value); return *this;}
    ///@}
  private:
