...
class CreateThemeForStackResult {
 public:
  ...
  AWS_APPSTREAM_API CreateThemeForStackResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_APPSTREAM_API CreateThemeForStackResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
