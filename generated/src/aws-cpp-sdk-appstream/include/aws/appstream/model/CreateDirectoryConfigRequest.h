...
class CreateDirectoryConfigRequest : public AppStreamRequest {
 public:
  ...
  template <typename DirectoryNameT = Aws::String>
  CreateDirectoryConfigRequest& WithDirectoryName(DirectoryNameT&& value) {
  ...
  template <typename OrganizationalUnitDistinguishedNamesT = Aws::Vector<Aws::String>>
  CreateDirectoryConfigRequest& WithOrganizationalUnitDistinguishedNames(OrganizationalUnitDistinguishedNamesT&& value) {
  ...
  CreateDirectoryConfigRequest& AddOrganizationalUnitDistinguishedNames(OrganizationalUnitDistinguishedNamesT&& value) {
    m_organizationalUnitDistinguishedNamesHasBeenSet = true;
  ...
  template <typename ServiceAccountCredentialsT = ServiceAccountCredentials>
  CreateDirectoryConfigRequest& WithServiceAccountCredentials(ServiceAccountCredentialsT&& value) {
  ...
  template <typename CertificateBasedAuthPropertiesT = CertificateBasedAuthProperties>
  CreateDirectoryConfigRequest& WithCertificateBasedAuthProperties(CertificateBasedAuthPropertiesT&& value) {
