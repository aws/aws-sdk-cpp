...
class DescribeEntitlementsResult {
 public:
  AWS_APPSTREAM_API DescribeEntitlementsResult() = default;
  AWS_APPSTREAM_API DescribeEntitlementsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_APPSTREAM_API DescribeEntitlementsResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  template <typename EntitlementsT = Aws::Vector<Entitlement>>
  DescribeEntitlementsResult& WithEntitlements(EntitlementsT&& value) {
    SetEntitlements(std::forward<EntitlementsT>(value));
    return *this;
  }
  template <typename EntitlementsT = Entitlement>
  DescribeEntitlementsResult& AddEntitlements(EntitlementsT&& value) {
    m_entitlementsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeEntitlementsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeEntitlementsResult& WithRequestId(RequestIdT&& value) {
