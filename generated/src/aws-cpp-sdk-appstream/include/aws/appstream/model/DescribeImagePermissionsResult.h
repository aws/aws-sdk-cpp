...
class DescribeImagePermissionsResult {
 public:
  ...
  AWS_APPSTREAM_API DescribeImagePermissionsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_APPSTREAM_API DescribeImagePermissionsResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  void SetSharedImagePermissionsList(SharedImagePermissionsListT&& value) {
    ...
    m_sharedImagePermissionsList = std::forward<SharedImagePermissionsListT>(value);
  }
  template <typename SharedImagePermissionsListT = Aws::Vector<SharedImagePermissions>>
  DescribeImagePermissionsResult& WithSharedImagePermissionsList(SharedImagePermissionsListT&& value) {
    SetSharedImagePermissionsList(std::forward<SharedImagePermissionsListT>(value));
    return *this;
  }
  ...
  DescribeImagePermissionsResult& AddSharedImagePermissionsList(SharedImagePermissionsListT&& value) {
    m_sharedImagePermissionsListHasBeenSet = true;
    m_sharedImagePermissionsList.emplace_back(std::forward<SharedImagePermissionsListT>(value));
    return *this;
  }
  ///@}
