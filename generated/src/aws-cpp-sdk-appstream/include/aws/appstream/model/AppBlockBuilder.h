...
class AppBlockBuilder {
 public:
  ...
  AWS_APPSTREAM_API AppBlockBuilder(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_APPSTREAM_API AppBlockBuilder& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline AppBlockBuilder& WithPlatform(AppBlockBuilderPlatformType value) {
    SetPlatform(value);
    return *this;
  }
  ///@}
  ...
  inline AppBlockBuilder& WithEnableDefaultInternetAccess(bool value) {
  ...
  inline void SetState(AppBlockBuilderState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline AppBlockBuilder& WithState(AppBlockBuilderState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  void SetAppBlockBuilderErrors(AppBlockBuilderErrorsT&& value) {
    ...
    m_appBlockBuilderErrors = std::forward<AppBlockBuilderErrorsT>(value);
  }
  template <typename AppBlockBuilderErrorsT = Aws::Vector<ResourceError>>
  AppBlockBuilder& WithAppBlockBuilderErrors(AppBlockBuilderErrorsT&& value) {
    SetAppBlockBuilderErrors(std::forward<AppBlockBuilderErrorsT>(value));
    return *this;
  }
  ...
  AppBlockBuilder& AddAppBlockBuilderErrors(AppBlockBuilderErrorsT&& value) {
    m_appBlockBuilderErrorsHasBeenSet = true;
    m_appBlockBuilderErrors.emplace_back(std::forward<AppBlockBuilderErrorsT>(value));
    return *this;
  }
  ///@}
