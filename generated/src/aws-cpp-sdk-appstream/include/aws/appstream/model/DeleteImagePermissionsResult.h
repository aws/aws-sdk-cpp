...
namespace Model
{
  ...
  public:
    ...
    inline DeleteImagePermissionsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeleteImagePermissionsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeleteImagePermissionsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
