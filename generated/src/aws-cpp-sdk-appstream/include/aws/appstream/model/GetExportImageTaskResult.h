...
class GetExportImageTaskResult {
 public:
  ...
  AWS_APPSTREAM_API GetExportImageTaskResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_APPSTREAM_API GetExportImageTaskResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
