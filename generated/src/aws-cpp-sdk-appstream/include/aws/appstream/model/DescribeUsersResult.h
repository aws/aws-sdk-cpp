...
class DescribeUsersResult {
 public:
  ...
  AWS_APPSTREAM_API DescribeUsersResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_APPSTREAM_API DescribeUsersResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  template <typename NextTokenT = Aws::String>
  DescribeUsersResult& WithNextToken(NextTokenT&& value) {
