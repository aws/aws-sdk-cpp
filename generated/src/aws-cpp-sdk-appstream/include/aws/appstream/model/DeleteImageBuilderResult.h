...
class DeleteImageBuilderResult {
 public:
  AWS_APPSTREAM_API DeleteImageBuilderResult() = default;
  AWS_APPSTREAM_API DeleteImageBuilderResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_APPSTREAM_API DeleteImageBuilderResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  template <typename ImageBuilderT = ImageBuilder>
  DeleteImageBuilderResult& WithImageBuilder(ImageBuilderT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteImageBuilderResult& WithRequestId(RequestIdT&& value) {
