...
class NetworkAccessConfiguration {
 public:
  ...
  AWS_APPSTREAM_API NetworkAccessConfiguration(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_APPSTREAM_API NetworkAccessConfiguration& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
