...
class DescribeImagesResult {
 public:
  ...
  AWS_APPSTREAM_API DescribeImagesResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_APPSTREAM_API DescribeImagesResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  template <typename ImagesT = Aws::Vector<Image>>
  DescribeImagesResult& WithImages(ImagesT&& value) {
    SetImages(std::forward<ImagesT>(value));
    return *this;
  }
  template <typename ImagesT = Image>
  DescribeImagesResult& AddImages(ImagesT&& value) {
    m_imagesHasBeenSet = true;
