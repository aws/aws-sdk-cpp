...
class DescribeStacksResult {
 public:
  ...
  AWS_APPSTREAM_API DescribeStacksResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_APPSTREAM_API DescribeStacksResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  template <typename NextTokenT = Aws::String>
  DescribeStacksResult& WithNextToken(NextTokenT&& value) {
