...
class ListExportImageTasksResult {
 public:
  ...
  AWS_APPSTREAM_API ListExportImageTasksResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_APPSTREAM_API ListExportImageTasksResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
