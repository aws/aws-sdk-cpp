...
class StorageConnector {
 public:
  ...
  AWS_APPSTREAM_API StorageConnector(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_APPSTREAM_API StorageConnector& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline void SetConnectorType(StorageConnectorType value) {
    m_connectorTypeHasBeenSet = true;
    m_connectorType = value;
  }
  inline StorageConnector& WithConnectorType(StorageConnectorType value) {
  ...
  void SetDomainsRequireAdminConsent(DomainsRequireAdminConsentT&& value) {
    ...
    m_domainsRequireAdminConsent = std::forward<DomainsRequireAdminConsentT>(value);
  }
  template <typename DomainsRequireAdminConsentT = Aws::Vector<Aws::String>>
  StorageConnector& WithDomainsRequireAdminConsent(DomainsRequireAdminConsentT&& value) {
    SetDomainsRequireAdminConsent(std::forward<DomainsRequireAdminConsentT>(value));
    return *this;
  }
  ...
  StorageConnector& AddDomainsRequireAdminConsent(DomainsRequireAdminConsentT&& value) {
    m_domainsRequireAdminConsentHasBeenSet = true;
    m_domainsRequireAdminConsent.emplace_back(std::forward<DomainsRequireAdminConsentT>(value));
    return *this;
  }
  ///@}
 private:
