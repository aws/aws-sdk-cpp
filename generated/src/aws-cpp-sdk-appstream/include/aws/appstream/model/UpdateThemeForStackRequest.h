...
class UpdateThemeForStackRequest : public AppStreamRequest {
 public:
  ...
  inline UpdateThemeForStackRequest& WithThemeStyling(ThemeStyling value) {
  ...
  inline UpdateThemeForStackRequest& WithState(ThemeState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateThemeForStackRequest& AddAttributesToDelete(ThemeAttribute value) {
    m_attributesToDeleteHasBeenSet = true;
