...
class DomainJoinInfo {
 public:
  ...
  AWS_APPSTREAM_API DomainJoinInfo(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_APPSTREAM_API DomainJoinInfo& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  template <typename DirectoryNameT = Aws::String>
  DomainJoinInfo& WithDirectoryName(DirectoryNameT&& value) {
  ...
  template <typename OrganizationalUnitDistinguishedNameT = Aws::String>
  DomainJoinInfo& WithOrganizationalUnitDistinguishedName(OrganizationalUnitDistinguishedNameT&& value) {
