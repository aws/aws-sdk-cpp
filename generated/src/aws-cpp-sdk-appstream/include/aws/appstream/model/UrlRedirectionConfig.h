...
class UrlRedirectionConfig {
 public:
  ...
  AWS_APPSTREAM_API UrlRedirectionConfig(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_APPSTREAM_API UrlRedirectionConfig& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
