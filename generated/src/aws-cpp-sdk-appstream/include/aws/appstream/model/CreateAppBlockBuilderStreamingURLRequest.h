...
class CreateAppBlockBuilderStreamingURLRequest : public AppStreamRequest {
 public:
  ...
  template <typename AppBlockBuilderNameT = Aws::String>
  CreateAppBlockBuilderStreamingURLRequest& WithAppBlockBuilderName(AppBlockBuilderNameT&& value) {
  ...
  inline CreateAppBlockBuilderStreamingURLRequest& WithValidity(long long value) {
    SetValidity(value);
    return *this;
  }
  ///@}
