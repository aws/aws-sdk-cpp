...
namespace Model
{
  ...
  public:
    ...
    template<typename AssociatedResourceT = Aws::String>
    DescribeSoftwareAssociationsResult& WithAssociatedResource(AssociatedResourceT&& value) { SetAssociatedResource(std::forward<AssociatedResourceT>(value)); return *this;}
    ///@}
    ...
    void SetSoftwareAssociations(SoftwareAssociationsT&& value) { m_softwareAssociationsHasBeenSet = true; m_softwareAssociations = std::forward<SoftwareAssociationsT>(value); }
    template<typename SoftwareAssociationsT = Aws::Vector<SoftwareAssociations>>
    DescribeSoftwareAssociationsResult& WithSoftwareAssociations(SoftwareAssociationsT&& value) { SetSoftwareAssociations(std::forward<SoftwareAssociationsT>(value)); return *this;}
    template<typename SoftwareAssociationsT = SoftwareAssociations>
    DescribeSoftwareAssociationsResult& AddSoftwareAssociations(SoftwareAssociationsT&& value) { m_softwareAssociationsHasBeenSet = true; m_softwareAssociations.emplace_back(std::forward<SoftwareAssociationsT>(value)); return *this; }
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    DescribeSoftwareAssociationsResult& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DescribeSoftwareAssociationsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
