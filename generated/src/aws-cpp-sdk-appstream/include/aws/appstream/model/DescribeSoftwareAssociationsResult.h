...
class DescribeSoftwareAssociationsResult {
 public:
  ...
  AWS_APPSTREAM_API DescribeSoftwareAssociationsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_APPSTREAM_API DescribeSoftwareAssociationsResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
