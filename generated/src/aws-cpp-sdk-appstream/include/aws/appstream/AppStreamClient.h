...
namespace AppStream
{
   ...
   */
  class AWS_APPSTREAM_API AppStreamClient : Aws::Client::ClientWithAsyncTemplateMethods<AppStreamClient>,
    smithy::client::AwsSmithyClientT<Aws::AppStream::SERVICE_NAME,
