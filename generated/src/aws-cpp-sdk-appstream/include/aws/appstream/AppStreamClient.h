...
class AWS_APPSTREAM_API AppStreamClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  AppStreamClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<AppStreamEndpointProviderBase> endpointProvider = nullptr,
   ...
   * API Reference</a></p>
   */
  virtual Model::AssociateAppBlockBuilderAppBlockOutcome AssociateAppBlockBuilderAppBlock(
      const Model::AssociateAppBlockBuilderAppBlockRequest& request) const;

  /**
   * A Callable wrapper for AssociateAppBlockBuilderAppBlock that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename AssociateAppBlockBuilderAppBlockRequestT = Model::AssociateAppBlockBuilderAppBlockRequest>
  Model::AssociateAppBlockBuilderAppBlockOutcomeCallable AssociateAppBlockBuilderAppBlockCallable(
      const AssociateAppBlockBuilderAppBlockRequestT& request) const {
    return SubmitCallable(&AppStreamClient::AssociateAppBlockBuilderAppBlock, request);
  }

  /**
   * An Async wrapper for AssociateAppBlockBuilderAppBlock that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename AssociateAppBlockBuilderAppBlockRequestT = Model::AssociateAppBlockBuilderAppBlockRequest>
  void AssociateAppBlockBuilderAppBlockAsync(const AssociateAppBlockBuilderAppBlockRequestT& request,
                                             const AssociateAppBlockBuilderAppBlockResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for AssociateApplicationFleet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename AssociateApplicationFleetRequestT = Model::AssociateApplicationFleetRequest>
  Model::AssociateApplicationFleetOutcomeCallable AssociateApplicationFleetCallable(
      const AssociateApplicationFleetRequestT& request) const {
    return SubmitCallable(&AppStreamClient::AssociateApplicationFleet, request);
  }

  /**
   * An Async wrapper for AssociateApplicationFleet that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateApplicationFleetRequestT = Model::AssociateApplicationFleetRequest>
  void AssociateApplicationFleetAsync(const AssociateApplicationFleetRequestT& request,
                                      const AssociateApplicationFleetResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::AssociateApplicationToEntitlementOutcome AssociateApplicationToEntitlement(
      const Model::AssociateApplicationToEntitlementRequest& request) const;

  /**
   * A Callable wrapper for AssociateApplicationToEntitlement that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename AssociateApplicationToEntitlementRequestT = Model::AssociateApplicationToEntitlementRequest>
  Model::AssociateApplicationToEntitlementOutcomeCallable AssociateApplicationToEntitlementCallable(
      const AssociateApplicationToEntitlementRequestT& request) const {
    return SubmitCallable(&AppStreamClient::AssociateApplicationToEntitlement, request);
  }

  /**
   * An Async wrapper for AssociateApplicationToEntitlement that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename AssociateApplicationToEntitlementRequestT = Model::AssociateApplicationToEntitlementRequest>
  void AssociateApplicationToEntitlementAsync(const AssociateApplicationToEntitlementRequestT& request,
                                              const AssociateApplicationToEntitlementResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for AssociateFleet that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename AssociateFleetRequestT = Model::AssociateFleetRequest>
  void AssociateFleetAsync(const AssociateFleetRequestT& request, const AssociateFleetResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::AssociateSoftwareToImageBuilderOutcome AssociateSoftwareToImageBuilder(
      const Model::AssociateSoftwareToImageBuilderRequest& request) const;

  /**
   * A Callable wrapper for AssociateSoftwareToImageBuilder that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AssociateSoftwareToImageBuilderRequestT = Model::AssociateSoftwareToImageBuilderRequest>
  Model::AssociateSoftwareToImageBuilderOutcomeCallable AssociateSoftwareToImageBuilderCallable(
      const AssociateSoftwareToImageBuilderRequestT& request) const {
    return SubmitCallable(&AppStreamClient::AssociateSoftwareToImageBuilder, request);
  }

  /**
   * An Async wrapper for AssociateSoftwareToImageBuilder that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename AssociateSoftwareToImageBuilderRequestT = Model::AssociateSoftwareToImageBuilderRequest>
  void AssociateSoftwareToImageBuilderAsync(const AssociateSoftwareToImageBuilderRequestT& request,
                                            const AssociateSoftwareToImageBuilderResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchAssociateUserStack that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchAssociateUserStack that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchAssociateUserStackRequestT = Model::BatchAssociateUserStackRequest>
  void BatchAssociateUserStackAsync(const BatchAssociateUserStackRequestT& request,
                                    const BatchAssociateUserStackResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchDisassociateUserStackOutcome BatchDisassociateUserStack(
      const Model::BatchDisassociateUserStackRequest& request) const;

  /**
   * A Callable wrapper for BatchDisassociateUserStack that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename BatchDisassociateUserStackRequestT = Model::BatchDisassociateUserStackRequest>
  Model::BatchDisassociateUserStackOutcomeCallable BatchDisassociateUserStackCallable(
      const BatchDisassociateUserStackRequestT& request) const {
    return SubmitCallable(&AppStreamClient::BatchDisassociateUserStack, request);
  }

  /**
   * An Async wrapper for BatchDisassociateUserStack that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchDisassociateUserStackRequestT = Model::BatchDisassociateUserStackRequest>
  void BatchDisassociateUserStackAsync(const BatchDisassociateUserStackRequestT& request,
                                       const BatchDisassociateUserStackResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CopyImage that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CopyImageRequestT = Model::CopyImageRequest>
  void CopyImageAsync(const CopyImageRequestT& request, const CopyImageResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateAppBlock that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateAppBlockRequestT = Model::CreateAppBlockRequest>
  void CreateAppBlockAsync(const CreateAppBlockRequestT& request, const CreateAppBlockResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateAppBlockBuilder that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateAppBlockBuilder that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateAppBlockBuilderRequestT = Model::CreateAppBlockBuilderRequest>
  void CreateAppBlockBuilderAsync(const CreateAppBlockBuilderRequestT& request, const CreateAppBlockBuilderResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::CreateAppBlockBuilderStreamingURLOutcome CreateAppBlockBuilderStreamingURL(
      const Model::CreateAppBlockBuilderStreamingURLRequest& request) const;

  /**
   * A Callable wrapper for CreateAppBlockBuilderStreamingURL that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename CreateAppBlockBuilderStreamingURLRequestT = Model::CreateAppBlockBuilderStreamingURLRequest>
  Model::CreateAppBlockBuilderStreamingURLOutcomeCallable CreateAppBlockBuilderStreamingURLCallable(
      const CreateAppBlockBuilderStreamingURLRequestT& request) const {
    return SubmitCallable(&AppStreamClient::CreateAppBlockBuilderStreamingURL, request);
  }

  /**
   * An Async wrapper for CreateAppBlockBuilderStreamingURL that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateAppBlockBuilderStreamingURLRequestT = Model::CreateAppBlockBuilderStreamingURLRequest>
  void CreateAppBlockBuilderStreamingURLAsync(const CreateAppBlockBuilderStreamingURLRequestT& request,
                                              const CreateAppBlockBuilderStreamingURLResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateDirectoryConfig that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateDirectoryConfig that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateDirectoryConfigRequestT = Model::CreateDirectoryConfigRequest>
  void CreateDirectoryConfigAsync(const CreateDirectoryConfigRequestT& request, const CreateDirectoryConfigResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateFleet that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateFleetRequestT = Model::CreateFleetRequest>
  void CreateFleetAsync(const CreateFleetRequestT& request, const CreateFleetResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateImageBuilder that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateImageBuilder that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateImageBuilderRequestT = Model::CreateImageBuilderRequest>
  void CreateImageBuilderAsync(const CreateImageBuilderRequestT& request, const CreateImageBuilderResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateImageBuilderStreamingURLOutcome CreateImageBuilderStreamingURL(
      const Model::CreateImageBuilderStreamingURLRequest& request) const;

  /**
   * A Callable wrapper for CreateImageBuilderStreamingURL that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateImageBuilderStreamingURLRequestT = Model::CreateImageBuilderStreamingURLRequest>
  Model::CreateImageBuilderStreamingURLOutcomeCallable CreateImageBuilderStreamingURLCallable(
      const CreateImageBuilderStreamingURLRequestT& request) const {
    return SubmitCallable(&AppStreamClient::CreateImageBuilderStreamingURL, request);
  }

  /**
   * An Async wrapper for CreateImageBuilderStreamingURL that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateImageBuilderStreamingURLRequestT = Model::CreateImageBuilderStreamingURLRequest>
  void CreateImageBuilderStreamingURLAsync(const CreateImageBuilderStreamingURLRequestT& request,
                                           const CreateImageBuilderStreamingURLResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateStack that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateStackRequestT = Model::CreateStackRequest>
  void CreateStackAsync(const CreateStackRequestT& request, const CreateStackResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateStreamingURL that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateStreamingURL that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateStreamingURLRequestT = Model::CreateStreamingURLRequest>
  void CreateStreamingURLAsync(const CreateStreamingURLRequestT& request, const CreateStreamingURLResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateThemeForStack that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateThemeForStack that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateThemeForStackRequestT = Model::CreateThemeForStackRequest>
  void CreateThemeForStackAsync(const CreateThemeForStackRequestT& request, const CreateThemeForStackResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateUpdatedImage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateUpdatedImage that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateUpdatedImageRequestT = Model::CreateUpdatedImageRequest>
  void CreateUpdatedImageAsync(const CreateUpdatedImageRequestT& request, const CreateUpdatedImageResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::CreateUsageReportSubscriptionOutcome CreateUsageReportSubscription(
      const Model::CreateUsageReportSubscriptionRequest& request = {}) const;

  /**
   * A Callable wrapper for CreateUsageReportSubscription that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateUsageReportSubscriptionRequestT = Model::CreateUsageReportSubscriptionRequest>
  Model::CreateUsageReportSubscriptionOutcomeCallable CreateUsageReportSubscriptionCallable(
      const CreateUsageReportSubscriptionRequestT& request = {}) const {
    return SubmitCallable(&AppStreamClient::CreateUsageReportSubscription, request);
  }

  /**
   * An Async wrapper for CreateUsageReportSubscription that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateUsageReportSubscriptionRequestT = Model::CreateUsageReportSubscriptionRequest>
  void CreateUsageReportSubscriptionAsync(const CreateUsageReportSubscriptionResponseReceivedHandler& handler,
  ...
  /**
   * An Async wrapper for DeleteAppBlock that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteAppBlockRequestT = Model::DeleteAppBlockRequest>
  void DeleteAppBlockAsync(const DeleteAppBlockRequestT& request, const DeleteAppBlockResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteAppBlockBuilder that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteAppBlockBuilder that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteAppBlockBuilderRequestT = Model::DeleteAppBlockBuilderRequest>
  void DeleteAppBlockBuilderAsync(const DeleteAppBlockBuilderRequestT& request, const DeleteAppBlockBuilderResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteDirectoryConfig that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteDirectoryConfig that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteDirectoryConfigRequestT = Model::DeleteDirectoryConfigRequest>
  void DeleteDirectoryConfigAsync(const DeleteDirectoryConfigRequestT& request, const DeleteDirectoryConfigResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteFleet that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteFleetRequestT = Model::DeleteFleetRequest>
  void DeleteFleetAsync(const DeleteFleetRequestT& request, const DeleteFleetResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteImage that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteImageRequestT = Model::DeleteImageRequest>
  void DeleteImageAsync(const DeleteImageRequestT& request, const DeleteImageResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteImageBuilder that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteImageBuilder that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteImageBuilderRequestT = Model::DeleteImageBuilderRequest>
  void DeleteImageBuilderAsync(const DeleteImageBuilderRequestT& request, const DeleteImageBuilderResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteImagePermissions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteImagePermissions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteImagePermissionsRequestT = Model::DeleteImagePermissionsRequest>
  void DeleteImagePermissionsAsync(const DeleteImagePermissionsRequestT& request,
                                   const DeleteImagePermissionsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteStack that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteStackRequestT = Model::DeleteStackRequest>
  void DeleteStackAsync(const DeleteStackRequestT& request, const DeleteStackResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteThemeForStack that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteThemeForStack that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteThemeForStackRequestT = Model::DeleteThemeForStackRequest>
  void DeleteThemeForStackAsync(const DeleteThemeForStackRequestT& request, const DeleteThemeForStackResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteUsageReportSubscriptionOutcome DeleteUsageReportSubscription(
      const Model::DeleteUsageReportSubscriptionRequest& request = {}) const;

  /**
   * A Callable wrapper for DeleteUsageReportSubscription that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteUsageReportSubscriptionRequestT = Model::DeleteUsageReportSubscriptionRequest>
  Model::DeleteUsageReportSubscriptionOutcomeCallable DeleteUsageReportSubscriptionCallable(
      const DeleteUsageReportSubscriptionRequestT& request = {}) const {
    return SubmitCallable(&AppStreamClient::DeleteUsageReportSubscription, request);
  }

  /**
   * An Async wrapper for DeleteUsageReportSubscription that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteUsageReportSubscriptionRequestT = Model::DeleteUsageReportSubscriptionRequest>
  void DeleteUsageReportSubscriptionAsync(const DeleteUsageReportSubscriptionResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                          const DeleteUsageReportSubscriptionRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeAppBlockBuilderAppBlockAssociationsOutcome DescribeAppBlockBuilderAppBlockAssociations(
      const Model::DescribeAppBlockBuilderAppBlockAssociationsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeAppBlockBuilderAppBlockAssociations that returns a future to the operation so that it can be executed in
  ...
  Model::DescribeAppBlockBuilderAppBlockAssociationsOutcomeCallable DescribeAppBlockBuilderAppBlockAssociationsCallable(
      const DescribeAppBlockBuilderAppBlockAssociationsRequestT& request = {}) const {
    return SubmitCallable(&AppStreamClient::DescribeAppBlockBuilderAppBlockAssociations, request);
  }

  /**
   * An Async wrapper for DescribeAppBlockBuilderAppBlockAssociations that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeAppBlockBuilderAppBlockAssociationsRequestT = Model::DescribeAppBlockBuilderAppBlockAssociationsRequest>
  void DescribeAppBlockBuilderAppBlockAssociationsAsync(const DescribeAppBlockBuilderAppBlockAssociationsResponseReceivedHandler& handler,
                                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                        const DescribeAppBlockBuilderAppBlockAssociationsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeAppBlockBuilders that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeAppBlockBuildersRequestT = Model::DescribeAppBlockBuildersRequest>
  Model::DescribeAppBlockBuildersOutcomeCallable DescribeAppBlockBuildersCallable(
      const DescribeAppBlockBuildersRequestT& request = {}) const {
    return SubmitCallable(&AppStreamClient::DescribeAppBlockBuilders, request);
  }

  /**
   * An Async wrapper for DescribeAppBlockBuilders that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeAppBlockBuildersRequestT = Model::DescribeAppBlockBuildersRequest>
  void DescribeAppBlockBuildersAsync(const DescribeAppBlockBuildersResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const DescribeAppBlockBuildersRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeAppBlocks that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeAppBlocks that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeAppBlocksRequestT = Model::DescribeAppBlocksRequest>
  void DescribeAppBlocksAsync(const DescribeAppBlocksResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const DescribeAppBlocksRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeAppLicenseUsage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeAppLicenseUsage that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeAppLicenseUsageRequestT = Model::DescribeAppLicenseUsageRequest>
  void DescribeAppLicenseUsageAsync(const DescribeAppLicenseUsageRequestT& request,
                                    const DescribeAppLicenseUsageResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeApplicationFleetAssociationsOutcome DescribeApplicationFleetAssociations(
      const Model::DescribeApplicationFleetAssociationsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeApplicationFleetAssociations that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DescribeApplicationFleetAssociationsRequestT = Model::DescribeApplicationFleetAssociationsRequest>
  Model::DescribeApplicationFleetAssociationsOutcomeCallable DescribeApplicationFleetAssociationsCallable(
      const DescribeApplicationFleetAssociationsRequestT& request = {}) const {
    return SubmitCallable(&AppStreamClient::DescribeApplicationFleetAssociations, request);
  }

  /**
   * An Async wrapper for DescribeApplicationFleetAssociations that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeApplicationFleetAssociationsRequestT = Model::DescribeApplicationFleetAssociationsRequest>
  void DescribeApplicationFleetAssociationsAsync(const DescribeApplicationFleetAssociationsResponseReceivedHandler& handler,
                                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                 const DescribeApplicationFleetAssociationsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeApplications that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeApplications that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeApplicationsRequestT = Model::DescribeApplicationsRequest>
  void DescribeApplicationsAsync(const DescribeApplicationsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const DescribeApplicationsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeDirectoryConfigs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeDirectoryConfigsRequestT = Model::DescribeDirectoryConfigsRequest>
  Model::DescribeDirectoryConfigsOutcomeCallable DescribeDirectoryConfigsCallable(
      const DescribeDirectoryConfigsRequestT& request = {}) const {
    return SubmitCallable(&AppStreamClient::DescribeDirectoryConfigs, request);
  }

  /**
   * An Async wrapper for DescribeDirectoryConfigs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeDirectoryConfigsRequestT = Model::DescribeDirectoryConfigsRequest>
  void DescribeDirectoryConfigsAsync(const DescribeDirectoryConfigsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const DescribeDirectoryConfigsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeEntitlements that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeEntitlements that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeEntitlementsRequestT = Model::DescribeEntitlementsRequest>
  void DescribeEntitlementsAsync(const DescribeEntitlementsRequestT& request, const DescribeEntitlementsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeFleets that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeFleetsRequestT = Model::DescribeFleetsRequest>
  void DescribeFleetsAsync(const DescribeFleetsResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const DescribeFleetsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeImageBuilders that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeImageBuilders that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeImageBuildersRequestT = Model::DescribeImageBuildersRequest>
  void DescribeImageBuildersAsync(const DescribeImageBuildersResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const DescribeImageBuildersRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeImagePermissions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeImagePermissions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeImagePermissionsRequestT = Model::DescribeImagePermissionsRequest>
  void DescribeImagePermissionsAsync(const DescribeImagePermissionsRequestT& request,
                                     const DescribeImagePermissionsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeImages that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeImagesRequestT = Model::DescribeImagesRequest>
  void DescribeImagesAsync(const DescribeImagesResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const DescribeImagesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeSessions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeSessions that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeSessionsRequestT = Model::DescribeSessionsRequest>
  void DescribeSessionsAsync(const DescribeSessionsRequestT& request, const DescribeSessionsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeSoftwareAssociationsOutcome DescribeSoftwareAssociations(
      const Model::DescribeSoftwareAssociationsRequest& request) const;

  /**
   * A Callable wrapper for DescribeSoftwareAssociations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeSoftwareAssociationsRequestT = Model::DescribeSoftwareAssociationsRequest>
  Model::DescribeSoftwareAssociationsOutcomeCallable DescribeSoftwareAssociationsCallable(
      const DescribeSoftwareAssociationsRequestT& request) const {
    return SubmitCallable(&AppStreamClient::DescribeSoftwareAssociations, request);
  }

  /**
   * An Async wrapper for DescribeSoftwareAssociations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeSoftwareAssociationsRequestT = Model::DescribeSoftwareAssociationsRequest>
  void DescribeSoftwareAssociationsAsync(const DescribeSoftwareAssociationsRequestT& request,
                                         const DescribeSoftwareAssociationsResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeStacks that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeStacksRequestT = Model::DescribeStacksRequest>
  void DescribeStacksAsync(const DescribeStacksResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const DescribeStacksRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeThemeForStack that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeThemeForStack that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeThemeForStackRequestT = Model::DescribeThemeForStackRequest>
  void DescribeThemeForStackAsync(const DescribeThemeForStackRequestT& request, const DescribeThemeForStackResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeUsageReportSubscriptionsOutcome DescribeUsageReportSubscriptions(
      const Model::DescribeUsageReportSubscriptionsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeUsageReportSubscriptions that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeUsageReportSubscriptionsRequestT = Model::DescribeUsageReportSubscriptionsRequest>
  Model::DescribeUsageReportSubscriptionsOutcomeCallable DescribeUsageReportSubscriptionsCallable(
      const DescribeUsageReportSubscriptionsRequestT& request = {}) const {
    return SubmitCallable(&AppStreamClient::DescribeUsageReportSubscriptions, request);
  }

  /**
   * An Async wrapper for DescribeUsageReportSubscriptions that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeUsageReportSubscriptionsRequestT = Model::DescribeUsageReportSubscriptionsRequest>
  void DescribeUsageReportSubscriptionsAsync(const DescribeUsageReportSubscriptionsResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                             const DescribeUsageReportSubscriptionsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeUserStackAssociationsOutcome DescribeUserStackAssociations(
      const Model::DescribeUserStackAssociationsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeUserStackAssociations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeUserStackAssociationsRequestT = Model::DescribeUserStackAssociationsRequest>
  Model::DescribeUserStackAssociationsOutcomeCallable DescribeUserStackAssociationsCallable(
      const DescribeUserStackAssociationsRequestT& request = {}) const {
    return SubmitCallable(&AppStreamClient::DescribeUserStackAssociations, request);
  }

  /**
   * An Async wrapper for DescribeUserStackAssociations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeUserStackAssociationsRequestT = Model::DescribeUserStackAssociationsRequest>
  void DescribeUserStackAssociationsAsync(const DescribeUserStackAssociationsResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                          const DescribeUserStackAssociationsRequestT& request = {}) const {
   ...
   */
  template <typename DescribeUsersRequestT = Model::DescribeUsersRequest>
  void DescribeUsersAsync(const DescribeUsersRequestT& request, const DescribeUsersResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DisableUser that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DisableUserRequestT = Model::DisableUserRequest>
  void DisableUserAsync(const DisableUserRequestT& request, const DisableUserResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::DisassociateAppBlockBuilderAppBlockOutcome DisassociateAppBlockBuilderAppBlock(
      const Model::DisassociateAppBlockBuilderAppBlockRequest& request) const;

  /**
   * A Callable wrapper for DisassociateAppBlockBuilderAppBlock that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DisassociateAppBlockBuilderAppBlockRequestT = Model::DisassociateAppBlockBuilderAppBlockRequest>
  Model::DisassociateAppBlockBuilderAppBlockOutcomeCallable DisassociateAppBlockBuilderAppBlockCallable(
      const DisassociateAppBlockBuilderAppBlockRequestT& request) const {
    return SubmitCallable(&AppStreamClient::DisassociateAppBlockBuilderAppBlock, request);
  }

  /**
   * An Async wrapper for DisassociateAppBlockBuilderAppBlock that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DisassociateAppBlockBuilderAppBlockRequestT = Model::DisassociateAppBlockBuilderAppBlockRequest>
  void DisassociateAppBlockBuilderAppBlockAsync(const DisassociateAppBlockBuilderAppBlockRequestT& request,
                                                const DisassociateAppBlockBuilderAppBlockResponseReceivedHandler& handler,
                                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateApplicationFleetOutcome DisassociateApplicationFleet(
      const Model::DisassociateApplicationFleetRequest& request) const;

  /**
   * A Callable wrapper for DisassociateApplicationFleet that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DisassociateApplicationFleetRequestT = Model::DisassociateApplicationFleetRequest>
  Model::DisassociateApplicationFleetOutcomeCallable DisassociateApplicationFleetCallable(
      const DisassociateApplicationFleetRequestT& request) const {
    return SubmitCallable(&AppStreamClient::DisassociateApplicationFleet, request);
  }

  /**
   * An Async wrapper for DisassociateApplicationFleet that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateApplicationFleetRequestT = Model::DisassociateApplicationFleetRequest>
  void DisassociateApplicationFleetAsync(const DisassociateApplicationFleetRequestT& request,
                                         const DisassociateApplicationFleetResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateApplicationFromEntitlementOutcome DisassociateApplicationFromEntitlement(
      const Model::DisassociateApplicationFromEntitlementRequest& request) const;

  /**
   * A Callable wrapper for DisassociateApplicationFromEntitlement that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DisassociateApplicationFromEntitlementRequestT = Model::DisassociateApplicationFromEntitlementRequest>
  Model::DisassociateApplicationFromEntitlementOutcomeCallable DisassociateApplicationFromEntitlementCallable(
      const DisassociateApplicationFromEntitlementRequestT& request) const {
    return SubmitCallable(&AppStreamClient::DisassociateApplicationFromEntitlement, request);
  }

  /**
   * An Async wrapper for DisassociateApplicationFromEntitlement that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DisassociateApplicationFromEntitlementRequestT = Model::DisassociateApplicationFromEntitlementRequest>
  void DisassociateApplicationFromEntitlementAsync(const DisassociateApplicationFromEntitlementRequestT& request,
                                                   const DisassociateApplicationFromEntitlementResponseReceivedHandler& handler,
                                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DisassociateFleet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DisassociateFleet that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DisassociateFleetRequestT = Model::DisassociateFleetRequest>
  void DisassociateFleetAsync(const DisassociateFleetRequestT& request, const DisassociateFleetResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateSoftwareFromImageBuilderOutcome DisassociateSoftwareFromImageBuilder(
      const Model::DisassociateSoftwareFromImageBuilderRequest& request) const;

  /**
   * A Callable wrapper for DisassociateSoftwareFromImageBuilder that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DisassociateSoftwareFromImageBuilderRequestT = Model::DisassociateSoftwareFromImageBuilderRequest>
  Model::DisassociateSoftwareFromImageBuilderOutcomeCallable DisassociateSoftwareFromImageBuilderCallable(
      const DisassociateSoftwareFromImageBuilderRequestT& request) const {
    return SubmitCallable(&AppStreamClient::DisassociateSoftwareFromImageBuilder, request);
  }

  /**
   * An Async wrapper for DisassociateSoftwareFromImageBuilder that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DisassociateSoftwareFromImageBuilderRequestT = Model::DisassociateSoftwareFromImageBuilderRequest>
  void DisassociateSoftwareFromImageBuilderAsync(const DisassociateSoftwareFromImageBuilderRequestT& request,
                                                 const DisassociateSoftwareFromImageBuilderResponseReceivedHandler& handler,
                                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for EnableUser that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename EnableUserRequestT = Model::EnableUserRequest>
  void EnableUserAsync(const EnableUserRequestT& request, const EnableUserResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ExpireSession that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ExpireSessionRequestT = Model::ExpireSessionRequest>
  ...
  /**
   * A Callable wrapper for ListAssociatedFleets that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAssociatedFleets that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAssociatedFleetsRequestT = Model::ListAssociatedFleetsRequest>
  void ListAssociatedFleetsAsync(const ListAssociatedFleetsRequestT& request, const ListAssociatedFleetsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAssociatedStacks that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAssociatedStacks that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAssociatedStacksRequestT = Model::ListAssociatedStacksRequest>
  void ListAssociatedStacksAsync(const ListAssociatedStacksRequestT& request, const ListAssociatedStacksResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListEntitledApplications that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListEntitledApplications that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListEntitledApplicationsRequestT = Model::ListEntitledApplicationsRequest>
  void ListEntitledApplicationsAsync(const ListEntitledApplicationsRequestT& request,
                                     const ListEntitledApplicationsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartAppBlockBuilder that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartAppBlockBuilder that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartAppBlockBuilderRequestT = Model::StartAppBlockBuilderRequest>
  void StartAppBlockBuilderAsync(const StartAppBlockBuilderRequestT& request, const StartAppBlockBuilderResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StartFleet that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StartFleetRequestT = Model::StartFleetRequest>
  void StartFleetAsync(const StartFleetRequestT& request, const StartFleetResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartImageBuilder that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartImageBuilder that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StartImageBuilderRequestT = Model::StartImageBuilderRequest>
  void StartImageBuilderAsync(const StartImageBuilderRequestT& request, const StartImageBuilderResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartSoftwareDeploymentToImageBuilderOutcome StartSoftwareDeploymentToImageBuilder(
      const Model::StartSoftwareDeploymentToImageBuilderRequest& request) const;

  /**
   * A Callable wrapper for StartSoftwareDeploymentToImageBuilder that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename StartSoftwareDeploymentToImageBuilderRequestT = Model::StartSoftwareDeploymentToImageBuilderRequest>
  Model::StartSoftwareDeploymentToImageBuilderOutcomeCallable StartSoftwareDeploymentToImageBuilderCallable(
      const StartSoftwareDeploymentToImageBuilderRequestT& request) const {
    return SubmitCallable(&AppStreamClient::StartSoftwareDeploymentToImageBuilder, request);
  }

  /**
   * An Async wrapper for StartSoftwareDeploymentToImageBuilder that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename StartSoftwareDeploymentToImageBuilderRequestT = Model::StartSoftwareDeploymentToImageBuilderRequest>
  void StartSoftwareDeploymentToImageBuilderAsync(const StartSoftwareDeploymentToImageBuilderRequestT& request,
                                                  const StartSoftwareDeploymentToImageBuilderResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StopAppBlockBuilder that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopAppBlockBuilder that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StopAppBlockBuilderRequestT = Model::StopAppBlockBuilderRequest>
  void StopAppBlockBuilderAsync(const StopAppBlockBuilderRequestT& request, const StopAppBlockBuilderResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StopFleet that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StopFleetRequestT = Model::StopFleetRequest>
  void StopFleetAsync(const StopFleetRequestT& request, const StopFleetResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StopImageBuilder that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopImageBuilder that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StopImageBuilderRequestT = Model::StopImageBuilderRequest>
  void StopImageBuilderAsync(const StopImageBuilderRequestT& request, const StopImageBuilderResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateAppBlockBuilder that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateAppBlockBuilder that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateAppBlockBuilderRequestT = Model::UpdateAppBlockBuilderRequest>
  void UpdateAppBlockBuilderAsync(const UpdateAppBlockBuilderRequestT& request, const UpdateAppBlockBuilderResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateDirectoryConfig that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateDirectoryConfig that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateDirectoryConfigRequestT = Model::UpdateDirectoryConfigRequest>
  void UpdateDirectoryConfigAsync(const UpdateDirectoryConfigRequestT& request, const UpdateDirectoryConfigResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateEntitlement that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateEntitlement that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateEntitlementRequestT = Model::UpdateEntitlementRequest>
  void UpdateEntitlementAsync(const UpdateEntitlementRequestT& request, const UpdateEntitlementResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateFleet that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateFleetRequestT = Model::UpdateFleetRequest>
  void UpdateFleetAsync(const UpdateFleetResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                        const UpdateFleetRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for UpdateImagePermissions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateImagePermissions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateImagePermissionsRequestT = Model::UpdateImagePermissionsRequest>
  void UpdateImagePermissionsAsync(const UpdateImagePermissionsRequestT& request,
                                   const UpdateImagePermissionsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateStack that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateStackRequestT = Model::UpdateStackRequest>
  void UpdateStackAsync(const UpdateStackRequestT& request, const UpdateStackResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateThemeForStack that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateThemeForStack that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateThemeForStackRequestT = Model::UpdateThemeForStackRequest>
  void UpdateThemeForStackAsync(const UpdateThemeForStackRequestT& request, const UpdateThemeForStackResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
