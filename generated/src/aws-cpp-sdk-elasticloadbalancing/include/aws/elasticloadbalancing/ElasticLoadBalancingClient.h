...
class AWS_ELASTICLOADBALANCING_API ElasticLoadBalancingClient
 ...
 public:
   ...
   */
  ElasticLoadBalancingClient(const Aws::ElasticLoadBalancing::ElasticLoadBalancingClientConfiguration& clientConfiguration =
                                 Aws::ElasticLoadBalancing::ElasticLoadBalancingClientConfiguration(),
  ...
  ElasticLoadBalancingClient(const Aws::Auth::AWSCredentials& credentials,
                             std::shared_ptr<ElasticLoadBalancingEndpointProviderBase> endpointProvider = nullptr,
                             const Aws::ElasticLoadBalancing::ElasticLoadBalancingClientConfiguration& clientConfiguration =
                                 Aws::ElasticLoadBalancing::ElasticLoadBalancingClientConfiguration());
  ...
  virtual Model::ApplySecurityGroupsToLoadBalancerOutcome ApplySecurityGroupsToLoadBalancer(
      const Model::ApplySecurityGroupsToLoadBalancerRequest& request) const;

  /**
   * A Callable wrapper for ApplySecurityGroupsToLoadBalancer that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ApplySecurityGroupsToLoadBalancerRequestT = Model::ApplySecurityGroupsToLoadBalancerRequest>
  Model::ApplySecurityGroupsToLoadBalancerOutcomeCallable ApplySecurityGroupsToLoadBalancerCallable(
      const ApplySecurityGroupsToLoadBalancerRequestT& request) const {
    return SubmitCallable(&ElasticLoadBalancingClient::ApplySecurityGroupsToLoadBalancer, request);
  }

  /**
   * An Async wrapper for ApplySecurityGroupsToLoadBalancer that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ApplySecurityGroupsToLoadBalancerRequestT = Model::ApplySecurityGroupsToLoadBalancerRequest>
  void ApplySecurityGroupsToLoadBalancerAsync(const ApplySecurityGroupsToLoadBalancerRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::AttachLoadBalancerToSubnetsOutcome AttachLoadBalancerToSubnets(
      const Model::AttachLoadBalancerToSubnetsRequest& request) const;

  /**
   * A Callable wrapper for AttachLoadBalancerToSubnets that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AttachLoadBalancerToSubnetsRequestT = Model::AttachLoadBalancerToSubnetsRequest>
  Model::AttachLoadBalancerToSubnetsOutcomeCallable AttachLoadBalancerToSubnetsCallable(
      const AttachLoadBalancerToSubnetsRequestT& request) const {
    return SubmitCallable(&ElasticLoadBalancingClient::AttachLoadBalancerToSubnets, request);
  }

  /**
   * An Async wrapper for AttachLoadBalancerToSubnets that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AttachLoadBalancerToSubnetsRequestT = Model::AttachLoadBalancerToSubnetsRequest>
  void AttachLoadBalancerToSubnetsAsync(const AttachLoadBalancerToSubnetsRequestT& request,
  ...
  /**
   * A Callable wrapper for ConfigureHealthCheck that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ConfigureHealthCheck that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ConfigureHealthCheckRequestT = Model::ConfigureHealthCheckRequest>
  void ConfigureHealthCheckAsync(const ConfigureHealthCheckRequestT& request, const ConfigureHealthCheckResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateAppCookieStickinessPolicyOutcome CreateAppCookieStickinessPolicy(
      const Model::CreateAppCookieStickinessPolicyRequest& request) const;

  /**
   * A Callable wrapper for CreateAppCookieStickinessPolicy that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateAppCookieStickinessPolicyRequestT = Model::CreateAppCookieStickinessPolicyRequest>
  Model::CreateAppCookieStickinessPolicyOutcomeCallable CreateAppCookieStickinessPolicyCallable(
      const CreateAppCookieStickinessPolicyRequestT& request) const {
    return SubmitCallable(&ElasticLoadBalancingClient::CreateAppCookieStickinessPolicy, request);
  }

  /**
   * An Async wrapper for CreateAppCookieStickinessPolicy that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateAppCookieStickinessPolicyRequestT = Model::CreateAppCookieStickinessPolicyRequest>
  void CreateAppCookieStickinessPolicyAsync(const CreateAppCookieStickinessPolicyRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateLBCookieStickinessPolicyOutcome CreateLBCookieStickinessPolicy(
      const Model::CreateLBCookieStickinessPolicyRequest& request) const;

  /**
   * A Callable wrapper for CreateLBCookieStickinessPolicy that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateLBCookieStickinessPolicyRequestT = Model::CreateLBCookieStickinessPolicyRequest>
  Model::CreateLBCookieStickinessPolicyOutcomeCallable CreateLBCookieStickinessPolicyCallable(
      const CreateLBCookieStickinessPolicyRequestT& request) const {
    return SubmitCallable(&ElasticLoadBalancingClient::CreateLBCookieStickinessPolicy, request);
  }

  /**
   * An Async wrapper for CreateLBCookieStickinessPolicy that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateLBCookieStickinessPolicyRequestT = Model::CreateLBCookieStickinessPolicyRequest>
  void CreateLBCookieStickinessPolicyAsync(const CreateLBCookieStickinessPolicyRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateLoadBalancerListenersOutcome CreateLoadBalancerListeners(
      const Model::CreateLoadBalancerListenersRequest& request) const;

  /**
   * A Callable wrapper for CreateLoadBalancerListeners that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateLoadBalancerListenersRequestT = Model::CreateLoadBalancerListenersRequest>
  Model::CreateLoadBalancerListenersOutcomeCallable CreateLoadBalancerListenersCallable(
      const CreateLoadBalancerListenersRequestT& request) const {
    return SubmitCallable(&ElasticLoadBalancingClient::CreateLoadBalancerListeners, request);
  }

  /**
   * An Async wrapper for CreateLoadBalancerListeners that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateLoadBalancerListenersRequestT = Model::CreateLoadBalancerListenersRequest>
  void CreateLoadBalancerListenersAsync(const CreateLoadBalancerListenersRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateLoadBalancerPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateLoadBalancerPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateLoadBalancerPolicyRequestT = Model::CreateLoadBalancerPolicyRequest>
  void CreateLoadBalancerPolicyAsync(const CreateLoadBalancerPolicyRequestT& request,
  ...
  virtual Model::DeleteLoadBalancerListenersOutcome DeleteLoadBalancerListeners(
      const Model::DeleteLoadBalancerListenersRequest& request) const;

  /**
   * A Callable wrapper for DeleteLoadBalancerListeners that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteLoadBalancerListenersRequestT = Model::DeleteLoadBalancerListenersRequest>
  Model::DeleteLoadBalancerListenersOutcomeCallable DeleteLoadBalancerListenersCallable(
      const DeleteLoadBalancerListenersRequestT& request) const {
    return SubmitCallable(&ElasticLoadBalancingClient::DeleteLoadBalancerListeners, request);
  }

  /**
   * An Async wrapper for DeleteLoadBalancerListeners that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteLoadBalancerListenersRequestT = Model::DeleteLoadBalancerListenersRequest>
  void DeleteLoadBalancerListenersAsync(const DeleteLoadBalancerListenersRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteLoadBalancerPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteLoadBalancerPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteLoadBalancerPolicyRequestT = Model::DeleteLoadBalancerPolicyRequest>
  void DeleteLoadBalancerPolicyAsync(const DeleteLoadBalancerPolicyRequestT& request,
  ...
  virtual Model::DeregisterInstancesFromLoadBalancerOutcome DeregisterInstancesFromLoadBalancer(
      const Model::DeregisterInstancesFromLoadBalancerRequest& request) const;

  /**
   * A Callable wrapper for DeregisterInstancesFromLoadBalancer that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DeregisterInstancesFromLoadBalancerRequestT = Model::DeregisterInstancesFromLoadBalancerRequest>
  Model::DeregisterInstancesFromLoadBalancerOutcomeCallable DeregisterInstancesFromLoadBalancerCallable(
      const DeregisterInstancesFromLoadBalancerRequestT& request) const {
    return SubmitCallable(&ElasticLoadBalancingClient::DeregisterInstancesFromLoadBalancer, request);
  }

  /**
   * An Async wrapper for DeregisterInstancesFromLoadBalancer that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DeregisterInstancesFromLoadBalancerRequestT = Model::DeregisterInstancesFromLoadBalancerRequest>
  void DeregisterInstancesFromLoadBalancerAsync(const DeregisterInstancesFromLoadBalancerRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeInstanceHealth that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeInstanceHealth that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeInstanceHealthRequestT = Model::DescribeInstanceHealthRequest>
  void DescribeInstanceHealthAsync(const DescribeInstanceHealthRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeLoadBalancerPoliciesOutcome DescribeLoadBalancerPolicies(
      const Model::DescribeLoadBalancerPoliciesRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeLoadBalancerPolicies that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeLoadBalancerPoliciesRequestT = Model::DescribeLoadBalancerPoliciesRequest>
  Model::DescribeLoadBalancerPoliciesOutcomeCallable DescribeLoadBalancerPoliciesCallable(
      const DescribeLoadBalancerPoliciesRequestT& request = {}) const {
    return SubmitCallable(&ElasticLoadBalancingClient::DescribeLoadBalancerPolicies, request);
  }

  /**
   * An Async wrapper for DescribeLoadBalancerPolicies that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeLoadBalancerPoliciesRequestT = Model::DescribeLoadBalancerPoliciesRequest>
  void DescribeLoadBalancerPoliciesAsync(const DescribeLoadBalancerPoliciesResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                         const DescribeLoadBalancerPoliciesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeLoadBalancerPolicyTypesOutcome DescribeLoadBalancerPolicyTypes(
      const Model::DescribeLoadBalancerPolicyTypesRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeLoadBalancerPolicyTypes that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeLoadBalancerPolicyTypesRequestT = Model::DescribeLoadBalancerPolicyTypesRequest>
  Model::DescribeLoadBalancerPolicyTypesOutcomeCallable DescribeLoadBalancerPolicyTypesCallable(
      const DescribeLoadBalancerPolicyTypesRequestT& request = {}) const {
    return SubmitCallable(&ElasticLoadBalancingClient::DescribeLoadBalancerPolicyTypes, request);
  }

  /**
   * An Async wrapper for DescribeLoadBalancerPolicyTypes that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeLoadBalancerPolicyTypesRequestT = Model::DescribeLoadBalancerPolicyTypesRequest>
  void DescribeLoadBalancerPolicyTypesAsync(const DescribeLoadBalancerPolicyTypesResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                            const DescribeLoadBalancerPolicyTypesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DetachLoadBalancerFromSubnetsOutcome DetachLoadBalancerFromSubnets(
      const Model::DetachLoadBalancerFromSubnetsRequest& request) const;

  /**
   * A Callable wrapper for DetachLoadBalancerFromSubnets that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DetachLoadBalancerFromSubnetsRequestT = Model::DetachLoadBalancerFromSubnetsRequest>
  Model::DetachLoadBalancerFromSubnetsOutcomeCallable DetachLoadBalancerFromSubnetsCallable(
      const DetachLoadBalancerFromSubnetsRequestT& request) const {
    return SubmitCallable(&ElasticLoadBalancingClient::DetachLoadBalancerFromSubnets, request);
  }

  /**
   * An Async wrapper for DetachLoadBalancerFromSubnets that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DetachLoadBalancerFromSubnetsRequestT = Model::DetachLoadBalancerFromSubnetsRequest>
  void DetachLoadBalancerFromSubnetsAsync(const DetachLoadBalancerFromSubnetsRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DisableAvailabilityZonesForLoadBalancerOutcome DisableAvailabilityZonesForLoadBalancer(
      const Model::DisableAvailabilityZonesForLoadBalancerRequest& request) const;

  /**
   * A Callable wrapper for DisableAvailabilityZonesForLoadBalancer that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DisableAvailabilityZonesForLoadBalancerRequestT = Model::DisableAvailabilityZonesForLoadBalancerRequest>
  Model::DisableAvailabilityZonesForLoadBalancerOutcomeCallable DisableAvailabilityZonesForLoadBalancerCallable(
      const DisableAvailabilityZonesForLoadBalancerRequestT& request) const {
    return SubmitCallable(&ElasticLoadBalancingClient::DisableAvailabilityZonesForLoadBalancer, request);
  }

  /**
   * An Async wrapper for DisableAvailabilityZonesForLoadBalancer that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DisableAvailabilityZonesForLoadBalancerRequestT = Model::DisableAvailabilityZonesForLoadBalancerRequest>
  void DisableAvailabilityZonesForLoadBalancerAsync(const DisableAvailabilityZonesForLoadBalancerRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::EnableAvailabilityZonesForLoadBalancerOutcome EnableAvailabilityZonesForLoadBalancer(
      const Model::EnableAvailabilityZonesForLoadBalancerRequest& request) const;

  /**
   * A Callable wrapper for EnableAvailabilityZonesForLoadBalancer that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename EnableAvailabilityZonesForLoadBalancerRequestT = Model::EnableAvailabilityZonesForLoadBalancerRequest>
  Model::EnableAvailabilityZonesForLoadBalancerOutcomeCallable EnableAvailabilityZonesForLoadBalancerCallable(
      const EnableAvailabilityZonesForLoadBalancerRequestT& request) const {
    return SubmitCallable(&ElasticLoadBalancingClient::EnableAvailabilityZonesForLoadBalancer, request);
  }

  /**
   * An Async wrapper for EnableAvailabilityZonesForLoadBalancer that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename EnableAvailabilityZonesForLoadBalancerRequestT = Model::EnableAvailabilityZonesForLoadBalancerRequest>
  void EnableAvailabilityZonesForLoadBalancerAsync(const EnableAvailabilityZonesForLoadBalancerRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::RegisterInstancesWithLoadBalancerOutcome RegisterInstancesWithLoadBalancer(
      const Model::RegisterInstancesWithLoadBalancerRequest& request) const;

  /**
   * A Callable wrapper for RegisterInstancesWithLoadBalancer that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename RegisterInstancesWithLoadBalancerRequestT = Model::RegisterInstancesWithLoadBalancerRequest>
  Model::RegisterInstancesWithLoadBalancerOutcomeCallable RegisterInstancesWithLoadBalancerCallable(
      const RegisterInstancesWithLoadBalancerRequestT& request) const {
    return SubmitCallable(&ElasticLoadBalancingClient::RegisterInstancesWithLoadBalancer, request);
  }

  /**
   * An Async wrapper for RegisterInstancesWithLoadBalancer that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename RegisterInstancesWithLoadBalancerRequestT = Model::RegisterInstancesWithLoadBalancerRequest>
  void RegisterInstancesWithLoadBalancerAsync(const RegisterInstancesWithLoadBalancerRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::SetLoadBalancerListenerSSLCertificateOutcome SetLoadBalancerListenerSSLCertificate(
      const Model::SetLoadBalancerListenerSSLCertificateRequest& request) const;

  /**
   * A Callable wrapper for SetLoadBalancerListenerSSLCertificate that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename SetLoadBalancerListenerSSLCertificateRequestT = Model::SetLoadBalancerListenerSSLCertificateRequest>
  Model::SetLoadBalancerListenerSSLCertificateOutcomeCallable SetLoadBalancerListenerSSLCertificateCallable(
      const SetLoadBalancerListenerSSLCertificateRequestT& request) const {
    return SubmitCallable(&ElasticLoadBalancingClient::SetLoadBalancerListenerSSLCertificate, request);
  }

  /**
   * An Async wrapper for SetLoadBalancerListenerSSLCertificate that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename SetLoadBalancerListenerSSLCertificateRequestT = Model::SetLoadBalancerListenerSSLCertificateRequest>
  void SetLoadBalancerListenerSSLCertificateAsync(const SetLoadBalancerListenerSSLCertificateRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::SetLoadBalancerPoliciesForBackendServerOutcome SetLoadBalancerPoliciesForBackendServer(
      const Model::SetLoadBalancerPoliciesForBackendServerRequest& request) const;

  /**
   * A Callable wrapper for SetLoadBalancerPoliciesForBackendServer that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename SetLoadBalancerPoliciesForBackendServerRequestT = Model::SetLoadBalancerPoliciesForBackendServerRequest>
  Model::SetLoadBalancerPoliciesForBackendServerOutcomeCallable SetLoadBalancerPoliciesForBackendServerCallable(
      const SetLoadBalancerPoliciesForBackendServerRequestT& request) const {
    return SubmitCallable(&ElasticLoadBalancingClient::SetLoadBalancerPoliciesForBackendServer, request);
  }

  /**
   * An Async wrapper for SetLoadBalancerPoliciesForBackendServer that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename SetLoadBalancerPoliciesForBackendServerRequestT = Model::SetLoadBalancerPoliciesForBackendServerRequest>
  void SetLoadBalancerPoliciesForBackendServerAsync(const SetLoadBalancerPoliciesForBackendServerRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::SetLoadBalancerPoliciesOfListenerOutcome SetLoadBalancerPoliciesOfListener(
      const Model::SetLoadBalancerPoliciesOfListenerRequest& request) const;

  /**
   * A Callable wrapper for SetLoadBalancerPoliciesOfListener that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename SetLoadBalancerPoliciesOfListenerRequestT = Model::SetLoadBalancerPoliciesOfListenerRequest>
  Model::SetLoadBalancerPoliciesOfListenerOutcomeCallable SetLoadBalancerPoliciesOfListenerCallable(
      const SetLoadBalancerPoliciesOfListenerRequestT& request) const {
    return SubmitCallable(&ElasticLoadBalancingClient::SetLoadBalancerPoliciesOfListener, request);
  }

  /**
   * An Async wrapper for SetLoadBalancerPoliciesOfListener that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename SetLoadBalancerPoliciesOfListenerRequestT = Model::SetLoadBalancerPoliciesOfListenerRequest>
  void SetLoadBalancerPoliciesOfListenerAsync(const SetLoadBalancerPoliciesOfListenerRequestT& request,
