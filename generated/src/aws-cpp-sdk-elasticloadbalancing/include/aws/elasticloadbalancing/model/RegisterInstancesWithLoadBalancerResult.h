...
class RegisterInstancesWithLoadBalancerResult {
 public:
  ...
  AWS_ELASTICLOADBALANCING_API RegisterInstancesWithLoadBalancerResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  ...
  template <typename InstancesT = Aws::Vector<Instance>>
  RegisterInstancesWithLoadBalancerResult& WithInstances(InstancesT&& value) {
    SetInstances(std::forward<InstancesT>(value));
    return *this;
  }
  template <typename InstancesT = Instance>
  RegisterInstancesWithLoadBalancerResult& AddInstances(InstancesT&& value) {
    m_instancesHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  RegisterInstancesWithLoadBalancerResult& WithResponseMetadata(ResponseMetadataT&& value) {
