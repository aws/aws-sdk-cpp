...
class ApplySecurityGroupsToLoadBalancerRequest : public ElasticLoadBalancingRequest {
 ...
 public:
  ...
  template <typename LoadBalancerNameT = Aws::String>
  ApplySecurityGroupsToLoadBalancerRequest& WithLoadBalancerName(LoadBalancerNameT&& value) {
  ...
  template <typename SecurityGroupsT = Aws::Vector<Aws::String>>
  ApplySecurityGroupsToLoadBalancerRequest& WithSecurityGroups(SecurityGroupsT&& value) {
    SetSecurityGroups(std::forward<SecurityGroupsT>(value));
    return *this;
  }
  template <typename SecurityGroupsT = Aws::String>
  ApplySecurityGroupsToLoadBalancerRequest& AddSecurityGroups(SecurityGroupsT&& value) {
    m_securityGroupsHasBeenSet = true;
