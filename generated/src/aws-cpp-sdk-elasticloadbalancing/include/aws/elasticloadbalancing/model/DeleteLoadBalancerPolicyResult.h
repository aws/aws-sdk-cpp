...
namespace Model
{
  ...
  {
  public:
    AWS_ELASTICLOADBALANCING_API DeleteLoadBalancerPolicyResult();
    ...
    inline DeleteLoadBalancerPolicyResult& WithResponseMetadata(const ResponseMetadata& value) { SetResponseMetadata(value); return *this;}
    inline DeleteLoadBalancerPolicyResult& WithResponseMetadata(ResponseMetadata&& value) { SetResponseMetadata(std::move(value)); return *this;}
    ///@}
  private:
