...
class DisableAvailabilityZonesForLoadBalancerRequest : public ElasticLoadBalancingRequest {
 ...
 public:
  ...
  template <typename LoadBalancerNameT = Aws::String>
  DisableAvailabilityZonesForLoadBalancerRequest& WithLoadBalancerName(LoadBalancerNameT&& value) {
  ...
  template <typename AvailabilityZonesT = Aws::Vector<Aws::String>>
  DisableAvailabilityZonesForLoadBalancerRequest& WithAvailabilityZones(AvailabilityZonesT&& value) {
    SetAvailabilityZones(std::forward<AvailabilityZonesT>(value));
    return *this;
  }
  template <typename AvailabilityZonesT = Aws::String>
  DisableAvailabilityZonesForLoadBalancerRequest& AddAvailabilityZones(AvailabilityZonesT&& value) {
    m_availabilityZonesHasBeenSet = true;
