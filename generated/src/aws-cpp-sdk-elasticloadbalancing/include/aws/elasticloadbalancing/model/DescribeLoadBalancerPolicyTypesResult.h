...
class DescribeLoadBalancerPolicyTypesResult {
 public:
  ...
  AWS_ELASTICLOADBALANCING_API DescribeLoadBalancerPolicyTypesResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  ...
  void SetPolicyTypeDescriptions(PolicyTypeDescriptionsT&& value) {
    m_policyTypeDescriptionsHasBeenSet = true;
    m_policyTypeDescriptions = std::forward<PolicyTypeDescriptionsT>(value);
  }
  template <typename PolicyTypeDescriptionsT = Aws::Vector<PolicyTypeDescription>>
  DescribeLoadBalancerPolicyTypesResult& WithPolicyTypeDescriptions(PolicyTypeDescriptionsT&& value) {
    SetPolicyTypeDescriptions(std::forward<PolicyTypeDescriptionsT>(value));
    return *this;
  }
  template <typename PolicyTypeDescriptionsT = PolicyTypeDescription>
  DescribeLoadBalancerPolicyTypesResult& AddPolicyTypeDescriptions(PolicyTypeDescriptionsT&& value) {
    m_policyTypeDescriptionsHasBeenSet = true;
    m_policyTypeDescriptions.emplace_back(std::forward<PolicyTypeDescriptionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeLoadBalancerPolicyTypesResult& WithResponseMetadata(ResponseMetadataT&& value) {
