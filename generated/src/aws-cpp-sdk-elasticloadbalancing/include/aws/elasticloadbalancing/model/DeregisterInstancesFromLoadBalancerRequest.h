...
class DeregisterInstancesFromLoadBalancerRequest : public ElasticLoadBalancingRequest {
 ...
 public:
  ...
  template <typename LoadBalancerNameT = Aws::String>
  DeregisterInstancesFromLoadBalancerRequest& WithLoadBalancerName(LoadBalancerNameT&& value) {
  ...
  template <typename InstancesT = Aws::Vector<Instance>>
  DeregisterInstancesFromLoadBalancerRequest& WithInstances(InstancesT&& value) {
    SetInstances(std::forward<InstancesT>(value));
    return *this;
  }
  template <typename InstancesT = Instance>
  DeregisterInstancesFromLoadBalancerRequest& AddInstances(InstancesT&& value) {
    m_instancesHasBeenSet = true;
