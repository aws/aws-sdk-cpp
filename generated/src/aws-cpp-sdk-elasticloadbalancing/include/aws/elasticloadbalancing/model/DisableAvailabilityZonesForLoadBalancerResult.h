...
class DisableAvailabilityZonesForLoadBalancerResult {
 public:
  ...
  AWS_ELASTICLOADBALANCING_API DisableAvailabilityZonesForLoadBalancerResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  ...
  template <typename AvailabilityZonesT = Aws::Vector<Aws::String>>
  DisableAvailabilityZonesForLoadBalancerResult& WithAvailabilityZones(AvailabilityZonesT&& value) {
    SetAvailabilityZones(std::forward<AvailabilityZonesT>(value));
    return *this;
  }
  template <typename AvailabilityZonesT = Aws::String>
  DisableAvailabilityZonesForLoadBalancerResult& AddAvailabilityZones(AvailabilityZonesT&& value) {
    m_availabilityZonesHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DisableAvailabilityZonesForLoadBalancerResult& WithResponseMetadata(ResponseMetadataT&& value) {
