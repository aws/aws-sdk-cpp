...
class DescribeInstanceHealthRequest : public ElasticLoadBalancingRequest {
 ...
 public:
  ...
  template <typename LoadBalancerNameT = Aws::String>
  DescribeInstanceHealthRequest& WithLoadBalancerName(LoadBalancerNameT&& value) {
  ...
  template <typename InstancesT = Aws::Vector<Instance>>
  DescribeInstanceHealthRequest& WithInstances(InstancesT&& value) {
    SetInstances(std::forward<InstancesT>(value));
    return *this;
  }
  template <typename InstancesT = Instance>
  DescribeInstanceHealthRequest& AddInstances(InstancesT&& value) {
    m_instancesHasBeenSet = true;
