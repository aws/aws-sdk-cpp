...
class CreateLBCookieStickinessPolicyRequest : public ElasticLoadBalancingRequest {
 ...
 public:
  ...
  template <typename LoadBalancerNameT = Aws::String>
  CreateLBCookieStickinessPolicyRequest& WithLoadBalancerName(LoadBalancerNameT&& value) {
  ...
  template <typename PolicyNameT = Aws::String>
  CreateLBCookieStickinessPolicyRequest& WithPolicyName(PolicyNameT&& value) {
  ...
  inline void SetCookieExpirationPeriod(long long value) {
    m_cookieExpirationPeriodHasBeenSet = true;
    m_cookieExpirationPeriod = value;
  }
  inline CreateLBCookieStickinessPolicyRequest& WithCookieExpirationPeriod(long long value) {
    SetCookieExpirationPeriod(value);
    return *this;
  }
  ///@}
 private:
