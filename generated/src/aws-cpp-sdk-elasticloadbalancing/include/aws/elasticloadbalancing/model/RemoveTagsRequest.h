...
class RemoveTagsRequest : public ElasticLoadBalancingRequest {
 ...
 public:
  ...
  template <typename LoadBalancerNamesT = Aws::Vector<Aws::String>>
  RemoveTagsRequest& WithLoadBalancerNames(LoadBalancerNamesT&& value) {
    SetLoadBalancerNames(std::forward<LoadBalancerNamesT>(value));
    return *this;
  }
  template <typename LoadBalancerNamesT = Aws::String>
  RemoveTagsRequest& AddLoadBalancerNames(LoadBalancerNamesT&& value) {
    m_loadBalancerNamesHasBeenSet = true;
  ...
  template <typename TagsT = Aws::Vector<TagKeyOnly>>
  RemoveTagsRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = TagKeyOnly>
  RemoveTagsRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
