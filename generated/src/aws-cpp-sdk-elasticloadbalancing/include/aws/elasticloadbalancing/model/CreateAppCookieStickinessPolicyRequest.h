...
class CreateAppCookieStickinessPolicyRequest : public ElasticLoadBalancingRequest {
 ...
 public:
  ...
  template <typename LoadBalancerNameT = Aws::String>
  CreateAppCookieStickinessPolicyRequest& WithLoadBalancerName(LoadBalancerNameT&& value) {
  ...
  template <typename PolicyNameT = Aws::String>
  CreateAppCookieStickinessPolicyRequest& WithPolicyName(PolicyNameT&& value) {
  ...
  template <typename CookieNameT = Aws::String>
  CreateAppCookieStickinessPolicyRequest& WithCookieName(CookieNameT&& value) {
