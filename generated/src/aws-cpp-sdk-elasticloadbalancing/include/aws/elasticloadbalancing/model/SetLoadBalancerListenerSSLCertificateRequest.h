...
class SetLoadBalancerListenerSSLCertificateRequest : public ElasticLoadBalancingRequest {
 ...
 public:
  ...
  template <typename LoadBalancerNameT = Aws::String>
  SetLoadBalancerListenerSSLCertificateRequest& WithLoadBalancerName(LoadBalancerNameT&& value) {
  ...
  inline SetLoadBalancerListenerSSLCertificateRequest& WithLoadBalancerPort(int value) {
  ...
  template <typename SSLCertificateIdT = Aws::String>
  SetLoadBalancerListenerSSLCertificateRequest& WithSSLCertificateId(SSLCertificateIdT&& value) {
