...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class RegisterInstancesWithLoadBalancerRequest : public ElasticLoadBalancingRequest
  {
  public:
    AWS_ELASTICLOADBALANCING_API RegisterInstancesWithLoadBalancerRequest() = default;
  ...
  public:
    ...
    template<typename LoadBalancerNameT = Aws::String>
    RegisterInstancesWithLoadBalancerRequest& WithLoadBalancerName(LoadBalancerNameT&& value) { SetLoadBalancerName(std::forward<LoadBalancerNameT>(value)); return *this;}
    ///@}
    ...
    template<typename InstancesT = Aws::Vector<Instance>>
    RegisterInstancesWithLoadBalancerRequest& WithInstances(InstancesT&& value) { SetInstances(std::forward<InstancesT>(value)); return *this;}
    template<typename InstancesT = Instance>
    RegisterInstancesWithLoadBalancerRequest& AddInstances(InstancesT&& value) { m_instancesHasBeenSet = true; m_instances.emplace_back(std::forward<InstancesT>(value)); return *this; }
    ///@}
  private:
