...
class RegisterInstancesWithLoadBalancerRequest : public ElasticLoadBalancingRequest {
 ...
 public:
  ...
  template <typename LoadBalancerNameT = Aws::String>
  RegisterInstancesWithLoadBalancerRequest& WithLoadBalancerName(LoadBalancerNameT&& value) {
  ...
  template <typename InstancesT = Aws::Vector<Instance>>
  RegisterInstancesWithLoadBalancerRequest& WithInstances(InstancesT&& value) {
    SetInstances(std::forward<InstancesT>(value));
    return *this;
  }
  template <typename InstancesT = Instance>
  RegisterInstancesWithLoadBalancerRequest& AddInstances(InstancesT&& value) {
    m_instancesHasBeenSet = true;
