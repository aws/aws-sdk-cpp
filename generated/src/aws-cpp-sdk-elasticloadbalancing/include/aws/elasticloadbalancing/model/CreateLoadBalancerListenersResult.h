...
{
  /**
   * <p>Contains the parameters for CreateLoadBalancerListener.</p><p><h3>See
   * Also:</h3>   <a
  ...
  public:
    ...
    inline CreateLoadBalancerListenersResult& WithResponseMetadata(const ResponseMetadata& value) { SetResponseMetadata(value); return *this;}
    inline CreateLoadBalancerListenersResult& WithResponseMetadata(ResponseMetadata&& value) { SetResponseMetadata(std::move(value)); return *this;}
    ///@}
  private:
