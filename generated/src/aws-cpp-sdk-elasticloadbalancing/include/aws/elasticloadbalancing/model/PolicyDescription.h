...
class PolicyDescription {
 public:
  ...
  template <typename PolicyNameT = Aws::String>
  PolicyDescription& WithPolicyName(PolicyNameT&& value) {
  ...
  template <typename PolicyTypeNameT = Aws::String>
  PolicyDescription& WithPolicyTypeName(PolicyTypeNameT&& value) {
  ...
  void SetPolicyAttributeDescriptions(PolicyAttributeDescriptionsT&& value) {
    m_policyAttributeDescriptionsHasBeenSet = true;
    m_policyAttributeDescriptions = std::forward<PolicyAttributeDescriptionsT>(value);
  }
  template <typename PolicyAttributeDescriptionsT = Aws::Vector<PolicyAttributeDescription>>
  PolicyDescription& WithPolicyAttributeDescriptions(PolicyAttributeDescriptionsT&& value) {
    SetPolicyAttributeDescriptions(std::forward<PolicyAttributeDescriptionsT>(value));
    return *this;
  }
  template <typename PolicyAttributeDescriptionsT = PolicyAttributeDescription>
  PolicyDescription& AddPolicyAttributeDescriptions(PolicyAttributeDescriptionsT&& value) {
    m_policyAttributeDescriptionsHasBeenSet = true;
    m_policyAttributeDescriptions.emplace_back(std::forward<PolicyAttributeDescriptionsT>(value));
    return *this;
  }
  ///@}
 private:
