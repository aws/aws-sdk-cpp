...
class AccessLog {
 public:
  ...
  inline AccessLog& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  template <typename S3BucketNameT = Aws::String>
  AccessLog& WithS3BucketName(S3BucketNameT&& value) {
  ...
  inline void SetEmitInterval(int value) {
    m_emitIntervalHasBeenSet = true;
    m_emitInterval = value;
  }
  inline AccessLog& WithEmitInterval(int value) {
    SetEmitInterval(value);
    return *this;
  }
  ///@}
  ...
  template <typename S3BucketPrefixT = Aws::String>
  AccessLog& WithS3BucketPrefix(S3BucketPrefixT&& value) {
