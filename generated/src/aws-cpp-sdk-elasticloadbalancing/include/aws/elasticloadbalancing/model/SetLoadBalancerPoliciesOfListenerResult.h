...
class SetLoadBalancerPoliciesOfListenerResult {
 public:
  AWS_ELASTICLOADBALANCING_API SetLoadBalancerPoliciesOfListenerResult() = default;
  AWS_ELASTICLOADBALANCING_API SetLoadBalancerPoliciesOfListenerResult(
      const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  AWS_ELASTICLOADBALANCING_API SetLoadBalancerPoliciesOfListenerResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  SetLoadBalancerPoliciesOfListenerResult& WithResponseMetadata(ResponseMetadataT&& value) {
