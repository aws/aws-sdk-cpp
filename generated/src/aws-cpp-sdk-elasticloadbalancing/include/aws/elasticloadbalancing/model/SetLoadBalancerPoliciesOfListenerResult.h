...
namespace Model
{
  ...
  public:
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    SetLoadBalancerPoliciesOfListenerResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
