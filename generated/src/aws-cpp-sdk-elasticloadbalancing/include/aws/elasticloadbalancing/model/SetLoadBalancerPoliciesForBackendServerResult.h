...
class SetLoadBalancerPoliciesForBackendServerResult {
 public:
  AWS_ELASTICLOADBALANCING_API SetLoadBalancerPoliciesForBackendServerResult() = default;
  AWS_ELASTICLOADBALANCING_API SetLoadBalancerPoliciesForBackendServerResult(
      const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  AWS_ELASTICLOADBALANCING_API SetLoadBalancerPoliciesForBackendServerResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  SetLoadBalancerPoliciesForBackendServerResult& WithResponseMetadata(ResponseMetadataT&& value) {
