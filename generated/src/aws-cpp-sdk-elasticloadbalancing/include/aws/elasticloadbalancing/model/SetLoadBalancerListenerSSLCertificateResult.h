...
class SetLoadBalancerListenerSSLCertificateResult {
 public:
  ...
  AWS_ELASTICLOADBALANCING_API SetLoadBalancerListenerSSLCertificateResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  SetLoadBalancerListenerSSLCertificateResult& WithResponseMetadata(ResponseMetadataT&& value) {
