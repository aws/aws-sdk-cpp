...
class PolicyTypeDescription {
 public:
  ...
  template <typename PolicyTypeNameT = Aws::String>
  PolicyTypeDescription& WithPolicyTypeName(PolicyTypeNameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  PolicyTypeDescription& WithDescription(DescriptionT&& value) {
   ...
   */
  inline const Aws::Vector<PolicyAttributeTypeDescription>& GetPolicyAttributeTypeDescriptions() const {
    return m_policyAttributeTypeDescriptions;
  }
  ...
  void SetPolicyAttributeTypeDescriptions(PolicyAttributeTypeDescriptionsT&& value) {
    m_policyAttributeTypeDescriptionsHasBeenSet = true;
    m_policyAttributeTypeDescriptions = std::forward<PolicyAttributeTypeDescriptionsT>(value);
  }
  template <typename PolicyAttributeTypeDescriptionsT = Aws::Vector<PolicyAttributeTypeDescription>>
  PolicyTypeDescription& WithPolicyAttributeTypeDescriptions(PolicyAttributeTypeDescriptionsT&& value) {
    SetPolicyAttributeTypeDescriptions(std::forward<PolicyAttributeTypeDescriptionsT>(value));
    return *this;
  }
  template <typename PolicyAttributeTypeDescriptionsT = PolicyAttributeTypeDescription>
  PolicyTypeDescription& AddPolicyAttributeTypeDescriptions(PolicyAttributeTypeDescriptionsT&& value) {
    m_policyAttributeTypeDescriptionsHasBeenSet = true;
    m_policyAttributeTypeDescriptions.emplace_back(std::forward<PolicyAttributeTypeDescriptionsT>(value));
    return *this;
  }
  ///@}
 private:
