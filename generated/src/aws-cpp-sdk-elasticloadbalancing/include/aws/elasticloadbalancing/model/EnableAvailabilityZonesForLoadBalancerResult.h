...
class EnableAvailabilityZonesForLoadBalancerResult {
 public:
  ...
  AWS_ELASTICLOADBALANCING_API EnableAvailabilityZonesForLoadBalancerResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  ...
  template <typename AvailabilityZonesT = Aws::Vector<Aws::String>>
  EnableAvailabilityZonesForLoadBalancerResult& WithAvailabilityZones(AvailabilityZonesT&& value) {
    SetAvailabilityZones(std::forward<AvailabilityZonesT>(value));
    return *this;
  }
  template <typename AvailabilityZonesT = Aws::String>
  EnableAvailabilityZonesForLoadBalancerResult& AddAvailabilityZones(AvailabilityZonesT&& value) {
    m_availabilityZonesHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  EnableAvailabilityZonesForLoadBalancerResult& WithResponseMetadata(ResponseMetadataT&& value) {
