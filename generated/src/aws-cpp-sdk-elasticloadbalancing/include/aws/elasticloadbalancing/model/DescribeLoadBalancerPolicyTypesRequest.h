...
class DescribeLoadBalancerPolicyTypesRequest : public ElasticLoadBalancingRequest {
 ...
 public:
  ...
  void SetPolicyTypeNames(PolicyTypeNamesT&& value) {
    m_policyTypeNamesHasBeenSet = true;
    m_policyTypeNames = std::forward<PolicyTypeNamesT>(value);
  }
  template <typename PolicyTypeNamesT = Aws::Vector<Aws::String>>
  DescribeLoadBalancerPolicyTypesRequest& WithPolicyTypeNames(PolicyTypeNamesT&& value) {
    SetPolicyTypeNames(std::forward<PolicyTypeNamesT>(value));
    return *this;
  }
  template <typename PolicyTypeNamesT = Aws::String>
  DescribeLoadBalancerPolicyTypesRequest& AddPolicyTypeNames(PolicyTypeNamesT&& value) {
    m_policyTypeNamesHasBeenSet = true;
    m_policyTypeNames.emplace_back(std::forward<PolicyTypeNamesT>(value));
    return *this;
  }
  ///@}
 private:
