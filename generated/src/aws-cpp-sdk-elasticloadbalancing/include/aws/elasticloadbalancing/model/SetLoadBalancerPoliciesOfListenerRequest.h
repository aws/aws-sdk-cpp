...
class SetLoadBalancerPoliciesOfListenerRequest : public ElasticLoadBalancingRequest {
 ...
 public:
  ...
  template <typename LoadBalancerNameT = Aws::String>
  SetLoadBalancerPoliciesOfListenerRequest& WithLoadBalancerName(LoadBalancerNameT&& value) {
  ...
  inline SetLoadBalancerPoliciesOfListenerRequest& WithLoadBalancerPort(int value) {
  ...
  template <typename PolicyNamesT = Aws::Vector<Aws::String>>
  SetLoadBalancerPoliciesOfListenerRequest& WithPolicyNames(PolicyNamesT&& value) {
    SetPolicyNames(std::forward<PolicyNamesT>(value));
    return *this;
  }
  template <typename PolicyNamesT = Aws::String>
  SetLoadBalancerPoliciesOfListenerRequest& AddPolicyNames(PolicyNamesT&& value) {
    m_policyNamesHasBeenSet = true;
