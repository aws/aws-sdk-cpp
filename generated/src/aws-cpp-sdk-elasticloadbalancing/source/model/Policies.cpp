...
Policies::Policies(const XmlNode& xmlNode) { *this = xmlNode; }
...
void Policies::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  if (m_appCookieStickinessPoliciesHasBeenSet) {
    ...
    for (auto& item : m_appCookieStickinessPolicies) {
      ...
      appCookieStickinessPoliciesSs << location << index << locationValue << ".AppCookieStickinessPolicies.member."
                                    << appCookieStickinessPoliciesIdx++;
  ...
  if (m_lBCookieStickinessPoliciesHasBeenSet) {
    ...
    for (auto& item : m_lBCookieStickinessPolicies) {
      ...
      lBCookieStickinessPoliciesSs << location << index << locationValue << ".LBCookieStickinessPolicies.member."
                                   << lBCookieStickinessPoliciesIdx++;
  ...
  if (m_otherPoliciesHasBeenSet) {
    ...
    for (auto& item : m_otherPolicies) {
      oStream << location << index << locationValue << ".OtherPolicies.member." << otherPoliciesIdx++ << "="
