...
PolicyAttributeTypeDescription::PolicyAttributeTypeDescription(const XmlNode& xmlNode) { *this = xmlNode; }
...
void PolicyAttributeTypeDescription::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
