...
PolicyAttributeDescription::PolicyAttributeDescription(const XmlNode& xmlNode) { *this = xmlNode; }
...
void PolicyAttributeDescription::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
