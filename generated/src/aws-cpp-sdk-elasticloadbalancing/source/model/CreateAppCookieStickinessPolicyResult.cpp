...
CreateAppCookieStickinessPolicyResult& CreateAppCookieStickinessPolicyResult::operator=(
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::ElasticLoadBalancing::Model::CreateAppCookieStickinessPolicyResult",
