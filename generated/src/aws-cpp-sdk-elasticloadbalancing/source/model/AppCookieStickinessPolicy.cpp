...
AppCookieStickinessPolicy::AppCookieStickinessPolicy(const XmlNode& xmlNode) { *this = xmlNode; }
...
void AppCookieStickinessPolicy::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
