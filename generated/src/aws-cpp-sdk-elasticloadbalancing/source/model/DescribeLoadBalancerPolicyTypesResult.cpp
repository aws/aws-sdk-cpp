...
DescribeLoadBalancerPolicyTypesResult& DescribeLoadBalancerPolicyTypesResult::operator=(
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!policyTypeDescriptionsNode.IsNull()) {
      ...
      m_policyTypeDescriptionsHasBeenSet = !policyTypeDescriptionsMember.IsNull();
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::ElasticLoadBalancing::Model::DescribeLoadBalancerPolicyTypesResult",
