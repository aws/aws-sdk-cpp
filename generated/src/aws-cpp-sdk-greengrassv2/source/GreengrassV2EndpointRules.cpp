...
{
const size_t GreengrassV2EndpointRules::RulesBlobStrLen = 3940;
const size_t GreengrassV2EndpointRules::RulesBlobSize = 3941;
...
'r','a','s','s','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i',
...
's',':','/','/','g','r','e','e','n','g','r','a','s','s','-','f','i','p','s','.','{','R','e','g','i',
...
',','"','d','a','t','a','p','l','a','n','e','-','u','s','-','g','o','v','-','e','a','s','t','-','1',
'"',']','}',']',',','"','e','n','d','p','o','i','n','t','"',':','{','"','u','r','l','"',':','"','h',
't','t','p','s',':','/','/','g','r','e','e','n','g','r','a','s','s','-','a','t','s','.','i','o','t',
