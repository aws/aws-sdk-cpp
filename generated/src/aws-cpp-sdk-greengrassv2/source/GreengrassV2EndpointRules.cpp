...
{
const size_t GreengrassV2EndpointRules::RulesBlobStrLen = 4742;
const size_t GreengrassV2EndpointRules::RulesBlobSize = 4743;
...
'"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','g','r','e','e','n','g','r',
'a','s','s','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t',
...
'"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','g','r','e','e','n','g','r',
'a','s','s','.','u','s','-','g','o','v','-','e','a','s','t','-','1','.','a','m','a','z','o','n','a',
...
'o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','g','r','e',
'e','n','g','r','a','s','s','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a',
...
'l','"',':','"','h','t','t','p','s',':','/','/','g','r','e','e','n','g','r','a','s','s','.','{','R',
...
const char* GreengrassV2EndpointRules::GetRulesBlob()
{
