...
LambdaExecutionParameters::LambdaExecutionParameters(JsonView jsonValue) { *this = jsonValue; }
...
LambdaExecutionParameters& LambdaExecutionParameters::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("inputPayloadEncodingType")) {
    m_inputPayloadEncodingType =
        LambdaInputPayloadEncodingTypeMapper::GetLambdaInputPayloadEncodingTypeForName(jsonValue.GetString("inputPayloadEncodingType"));
...
JsonValue LambdaExecutionParameters::Jsonize() const {
  ...
  if (m_inputPayloadEncodingTypeHasBeenSet) {
    payload.WithString("inputPayloadEncodingType",
                       LambdaInputPayloadEncodingTypeMapper::GetNameForLambdaInputPayloadEncodingType(m_inputPayloadEncodingType));
  }
