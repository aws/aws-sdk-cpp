...
EffectiveDeployment::EffectiveDeployment(JsonView jsonValue) { *this = jsonValue; }
...
EffectiveDeployment& EffectiveDeployment::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("coreDeviceExecutionStatus")) {
    m_coreDeviceExecutionStatus = EffectiveDeploymentExecutionStatusMapper::GetEffectiveDeploymentExecutionStatusForName(
        jsonValue.GetString("coreDeviceExecutionStatus"));
...
JsonValue EffectiveDeployment::Jsonize() const {
  ...
  if (m_coreDeviceExecutionStatusHasBeenSet) {
    payload.WithString("coreDeviceExecutionStatus",
                       EffectiveDeploymentExecutionStatusMapper::GetNameForEffectiveDeploymentExecutionStatus(m_coreDeviceExecutionStatus));
  }
