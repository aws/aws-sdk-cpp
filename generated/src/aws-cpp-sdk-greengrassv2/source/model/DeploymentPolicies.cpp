...
DeploymentPolicies::DeploymentPolicies(JsonView jsonValue) { *this = jsonValue; }
...
DeploymentPolicies& DeploymentPolicies::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("failureHandlingPolicy")) {
    m_failureHandlingPolicy =
        DeploymentFailureHandlingPolicyMapper::GetDeploymentFailureHandlingPolicyForName(jsonValue.GetString("failureHandlingPolicy"));
...
JsonValue DeploymentPolicies::Jsonize() const {
  ...
  if (m_failureHandlingPolicyHasBeenSet) {
    payload.WithString("failureHandlingPolicy",
                       DeploymentFailureHandlingPolicyMapper::GetNameForDeploymentFailureHandlingPolicy(m_failureHandlingPolicy));
  }
