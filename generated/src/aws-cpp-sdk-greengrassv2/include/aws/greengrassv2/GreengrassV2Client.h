...
#include <aws/greengrassv2/GreengrassV2Waiter.h>
...
class AWS_GREENGRASSV2_API GreengrassV2Client : public Aws::Client::AWSJsonClient,
                                                ...
                                                public GreengrassV2Waiter<GreengrassV2Client> {
 public:
   ...
   */
  GreengrassV2Client(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<GreengrassV2EndpointProviderBase> endpointProvider = nullptr,
      const Aws::GreengrassV2::GreengrassV2ClientConfiguration& clientConfiguration = Aws::GreengrassV2::GreengrassV2ClientConfiguration());
   ...
   * API Reference</a></p>
   */
  virtual Model::AssociateServiceRoleToAccountOutcome AssociateServiceRoleToAccount(
      const Model::AssociateServiceRoleToAccountRequest& request) const;

  /**
   * A Callable wrapper for AssociateServiceRoleToAccount that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AssociateServiceRoleToAccountRequestT = Model::AssociateServiceRoleToAccountRequest>
  Model::AssociateServiceRoleToAccountOutcomeCallable AssociateServiceRoleToAccountCallable(
      const AssociateServiceRoleToAccountRequestT& request) const {
    return SubmitCallable(&GreengrassV2Client::AssociateServiceRoleToAccount, request);
  }

  /**
   * An Async wrapper for AssociateServiceRoleToAccount that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateServiceRoleToAccountRequestT = Model::AssociateServiceRoleToAccountRequest>
  void AssociateServiceRoleToAccountAsync(const AssociateServiceRoleToAccountRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchAssociateClientDeviceWithCoreDeviceOutcome BatchAssociateClientDeviceWithCoreDevice(
      const Model::BatchAssociateClientDeviceWithCoreDeviceRequest& request) const;

  /**
   * A Callable wrapper for BatchAssociateClientDeviceWithCoreDevice that returns a future to the operation so that it can be executed in
  ...
  Model::BatchAssociateClientDeviceWithCoreDeviceOutcomeCallable BatchAssociateClientDeviceWithCoreDeviceCallable(
      const BatchAssociateClientDeviceWithCoreDeviceRequestT& request) const {
    return SubmitCallable(&GreengrassV2Client::BatchAssociateClientDeviceWithCoreDevice, request);
  }

  /**
   * An Async wrapper for BatchAssociateClientDeviceWithCoreDevice that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename BatchAssociateClientDeviceWithCoreDeviceRequestT = Model::BatchAssociateClientDeviceWithCoreDeviceRequest>
  void BatchAssociateClientDeviceWithCoreDeviceAsync(
      const BatchAssociateClientDeviceWithCoreDeviceRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchDisassociateClientDeviceFromCoreDeviceOutcome BatchDisassociateClientDeviceFromCoreDevice(
      const Model::BatchDisassociateClientDeviceFromCoreDeviceRequest& request) const;

  /**
   * A Callable wrapper for BatchDisassociateClientDeviceFromCoreDevice that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  ...
  Model::BatchDisassociateClientDeviceFromCoreDeviceOutcomeCallable BatchDisassociateClientDeviceFromCoreDeviceCallable(
      const BatchDisassociateClientDeviceFromCoreDeviceRequestT& request) const {
    return SubmitCallable(&GreengrassV2Client::BatchDisassociateClientDeviceFromCoreDevice, request);
  }

  /**
   * An Async wrapper for BatchDisassociateClientDeviceFromCoreDevice that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename BatchDisassociateClientDeviceFromCoreDeviceRequestT = Model::BatchDisassociateClientDeviceFromCoreDeviceRequest>
  void BatchDisassociateClientDeviceFromCoreDeviceAsync(
      const BatchDisassociateClientDeviceFromCoreDeviceRequestT& request,
  ...
  /**
   * A Callable wrapper for CancelDeployment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CancelDeployment that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CancelDeploymentRequestT = Model::CancelDeploymentRequest>
  void CancelDeploymentAsync(const CancelDeploymentRequestT& request, const CancelDeploymentResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateComponentVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateComponentVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateComponentVersionRequestT = Model::CreateComponentVersionRequest>
  void CreateComponentVersionAsync(const CreateComponentVersionResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const CreateComponentVersionRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DeleteCoreDevice that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteCoreDevice that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteCoreDeviceRequestT = Model::DeleteCoreDeviceRequest>
  void DeleteCoreDeviceAsync(const DeleteCoreDeviceRequestT& request, const DeleteCoreDeviceResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateServiceRoleFromAccountOutcome DisassociateServiceRoleFromAccount(
      const Model::DisassociateServiceRoleFromAccountRequest& request = {}) const;

  /**
   * A Callable wrapper for DisassociateServiceRoleFromAccount that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DisassociateServiceRoleFromAccountRequestT = Model::DisassociateServiceRoleFromAccountRequest>
  Model::DisassociateServiceRoleFromAccountOutcomeCallable DisassociateServiceRoleFromAccountCallable(
      const DisassociateServiceRoleFromAccountRequestT& request = {}) const {
    return SubmitCallable(&GreengrassV2Client::DisassociateServiceRoleFromAccount, request);
  }

  /**
   * An Async wrapper for DisassociateServiceRoleFromAccount that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DisassociateServiceRoleFromAccountRequestT = Model::DisassociateServiceRoleFromAccountRequest>
  void DisassociateServiceRoleFromAccountAsync(const DisassociateServiceRoleFromAccountResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                               const DisassociateServiceRoleFromAccountRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetComponentVersionArtifactOutcome GetComponentVersionArtifact(
      const Model::GetComponentVersionArtifactRequest& request) const;

  /**
   * A Callable wrapper for GetComponentVersionArtifact that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetComponentVersionArtifactRequestT = Model::GetComponentVersionArtifactRequest>
  Model::GetComponentVersionArtifactOutcomeCallable GetComponentVersionArtifactCallable(
      const GetComponentVersionArtifactRequestT& request) const {
    return SubmitCallable(&GreengrassV2Client::GetComponentVersionArtifact, request);
  }

  /**
   * An Async wrapper for GetComponentVersionArtifact that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetComponentVersionArtifactRequestT = Model::GetComponentVersionArtifactRequest>
  void GetComponentVersionArtifactAsync(const GetComponentVersionArtifactRequestT& request,
  ...
  /**
   * A Callable wrapper for GetConnectivityInfo that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetConnectivityInfo that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetConnectivityInfoRequestT = Model::GetConnectivityInfoRequest>
  void GetConnectivityInfoAsync(const GetConnectivityInfoRequestT& request, const GetConnectivityInfoResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetCoreDevice that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetCoreDeviceRequestT = Model::GetCoreDeviceRequest>
  void GetCoreDeviceAsync(const GetCoreDeviceRequestT& request, const GetCoreDeviceResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetServiceRoleForAccount that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename GetServiceRoleForAccountRequestT = Model::GetServiceRoleForAccountRequest>
  Model::GetServiceRoleForAccountOutcomeCallable GetServiceRoleForAccountCallable(
      const GetServiceRoleForAccountRequestT& request = {}) const {
    return SubmitCallable(&GreengrassV2Client::GetServiceRoleForAccount, request);
  }

  /**
   * An Async wrapper for GetServiceRoleForAccount that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetServiceRoleForAccountRequestT = Model::GetServiceRoleForAccountRequest>
  void GetServiceRoleForAccountAsync(const GetServiceRoleForAccountResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const GetServiceRoleForAccountRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListClientDevicesAssociatedWithCoreDeviceOutcome ListClientDevicesAssociatedWithCoreDevice(
      const Model::ListClientDevicesAssociatedWithCoreDeviceRequest& request) const;

  /**
   * A Callable wrapper for ListClientDevicesAssociatedWithCoreDevice that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  ...
  Model::ListClientDevicesAssociatedWithCoreDeviceOutcomeCallable ListClientDevicesAssociatedWithCoreDeviceCallable(
      const ListClientDevicesAssociatedWithCoreDeviceRequestT& request) const {
    return SubmitCallable(&GreengrassV2Client::ListClientDevicesAssociatedWithCoreDevice, request);
  }

  /**
   * An Async wrapper for ListClientDevicesAssociatedWithCoreDevice that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListClientDevicesAssociatedWithCoreDeviceRequestT = Model::ListClientDevicesAssociatedWithCoreDeviceRequest>
  void ListClientDevicesAssociatedWithCoreDeviceAsync(
      const ListClientDevicesAssociatedWithCoreDeviceRequestT& request,
  ...
  /**
   * A Callable wrapper for ListComponentVersions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListComponentVersions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListComponentVersionsRequestT = Model::ListComponentVersionsRequest>
  void ListComponentVersionsAsync(const ListComponentVersionsRequestT& request, const ListComponentVersionsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename ListComponentsRequestT = Model::ListComponentsRequest>
  void ListComponentsAsync(const ListComponentsResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const ListComponentsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListCoreDevices that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListCoreDevicesRequestT = Model::ListCoreDevicesRequest>
  void ListCoreDevicesAsync(const ListCoreDevicesResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const ListCoreDevicesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListEffectiveDeployments that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListEffectiveDeployments that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListEffectiveDeploymentsRequestT = Model::ListEffectiveDeploymentsRequest>
  void ListEffectiveDeploymentsAsync(const ListEffectiveDeploymentsRequestT& request,
  ...
  /**
   * A Callable wrapper for ListInstalledComponents that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListInstalledComponents that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListInstalledComponentsRequestT = Model::ListInstalledComponentsRequest>
  void ListInstalledComponentsAsync(const ListInstalledComponentsRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::ResolveComponentCandidatesOutcome ResolveComponentCandidates(
      const Model::ResolveComponentCandidatesRequest& request = {}) const;

  /**
   * A Callable wrapper for ResolveComponentCandidates that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ResolveComponentCandidatesRequestT = Model::ResolveComponentCandidatesRequest>
  Model::ResolveComponentCandidatesOutcomeCallable ResolveComponentCandidatesCallable(
      const ResolveComponentCandidatesRequestT& request = {}) const {
    return SubmitCallable(&GreengrassV2Client::ResolveComponentCandidates, request);
  }

  /**
   * An Async wrapper for ResolveComponentCandidates that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ResolveComponentCandidatesRequestT = Model::ResolveComponentCandidatesRequest>
  void ResolveComponentCandidatesAsync(const ResolveComponentCandidatesResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const ResolveComponentCandidatesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for UpdateConnectivityInfo that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateConnectivityInfo that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateConnectivityInfoRequestT = Model::UpdateConnectivityInfoRequest>
  void UpdateConnectivityInfoAsync(const UpdateConnectivityInfoRequestT& request,
  ...
  virtual std::shared_ptr<GreengrassV2EndpointProviderBase>& accessEndpointProvider();
 ...
 private:
  ...
  typedef Aws::Utils::Outcome<Aws::AmazonWebServiceResult<RESPONSE>, GreengrassV2Error> InvokeOperationOutcome;
