...
class LambdaContainerParams {
 public:
  ...
  inline void SetMemorySizeInKB(int value) {
    m_memorySizeInKBHasBeenSet = true;
    m_memorySizeInKB = value;
  }
  inline LambdaContainerParams& WithMemorySizeInKB(int value) {
    SetMemorySizeInKB(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMountROSysfs(bool value) {
    m_mountROSysfsHasBeenSet = true;
    m_mountROSysfs = value;
  }
  inline LambdaContainerParams& WithMountROSysfs(bool value) {
    SetMountROSysfs(value);
    return *this;
  }
  ///@}
