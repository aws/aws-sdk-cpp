...
class GetConnectivityInfoResult {
 public:
  ...
  template <typename ConnectivityInfoT = Aws::Vector<ConnectivityInfo>>
  GetConnectivityInfoResult& WithConnectivityInfo(ConnectivityInfoT&& value) {
    SetConnectivityInfo(std::forward<ConnectivityInfoT>(value));
    return *this;
  }
  template <typename ConnectivityInfoT = ConnectivityInfo>
  GetConnectivityInfoResult& AddConnectivityInfo(ConnectivityInfoT&& value) {
    m_connectivityInfoHasBeenSet = true;
  ...
  template <typename MessageT = Aws::String>
  GetConnectivityInfoResult& WithMessage(MessageT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetConnectivityInfoResult& WithRequestId(RequestIdT&& value) {
