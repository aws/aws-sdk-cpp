...
class Deployment {
 public:
  ...
  inline void SetIsLatestForTarget(bool value) {
    m_isLatestForTargetHasBeenSet = true;
    m_isLatestForTarget = value;
  }
  inline Deployment& WithIsLatestForTarget(bool value) {
  ...
  void SetParentTargetArn(ParentTargetArnT&& value) {
    ...
    m_parentTargetArn = std::forward<ParentTargetArnT>(value);
  }
  template <typename ParentTargetArnT = Aws::String>
  Deployment& WithParentTargetArn(ParentTargetArnT&& value) {
    SetParentTargetArn(std::forward<ParentTargetArnT>(value));
    return *this;
  }
  ///@}
 private:
