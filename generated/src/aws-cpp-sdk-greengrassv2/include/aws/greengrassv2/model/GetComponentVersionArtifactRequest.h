...
class GetComponentVersionArtifactRequest : public GreengrassV2Request {
 public:
  ...
  inline void SetS3EndpointType(S3EndpointType value) {
    m_s3EndpointTypeHasBeenSet = true;
    m_s3EndpointType = value;
  }
  inline GetComponentVersionArtifactRequest& WithS3EndpointType(S3EndpointType value) {
    SetS3EndpointType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIotEndpointType(IotEndpointType value) {
    m_iotEndpointTypeHasBeenSet = true;
    m_iotEndpointType = value;
  }
  inline GetComponentVersionArtifactRequest& WithIotEndpointType(IotEndpointType value) {
    SetIotEndpointType(value);
    return *this;
  }
  ///@}
 private:
