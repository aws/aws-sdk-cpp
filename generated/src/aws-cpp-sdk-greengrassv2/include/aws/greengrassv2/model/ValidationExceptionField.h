...
namespace Model
{
  ...
  {
  public:
    AWS_GREENGRASSV2_API ValidationExceptionField() = default;
    AWS_GREENGRASSV2_API ValidationExceptionField(Aws::Utils::Json::JsonView jsonValue);
    AWS_GREENGRASSV2_API ValidationExceptionField& operator=(Aws::Utils::Json::JsonView jsonValue);
