...
class ResolveComponentCandidatesResult {
 public:
  ...
  void SetResolvedComponentVersions(ResolvedComponentVersionsT&& value) {
    m_resolvedComponentVersionsHasBeenSet = true;
    m_resolvedComponentVersions = std::forward<ResolvedComponentVersionsT>(value);
  }
  template <typename ResolvedComponentVersionsT = Aws::Vector<ResolvedComponentVersion>>
  ResolveComponentCandidatesResult& WithResolvedComponentVersions(ResolvedComponentVersionsT&& value) {
    SetResolvedComponentVersions(std::forward<ResolvedComponentVersionsT>(value));
    return *this;
  }
  template <typename ResolvedComponentVersionsT = ResolvedComponentVersion>
  ResolveComponentCandidatesResult& AddResolvedComponentVersions(ResolvedComponentVersionsT&& value) {
    m_resolvedComponentVersionsHasBeenSet = true;
    m_resolvedComponentVersions.emplace_back(std::forward<ResolvedComponentVersionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ResolveComponentCandidatesResult& WithRequestId(RequestIdT&& value) {
