...
class CloudComponentStatus {
 public:
  ...
  inline void SetComponentState(CloudComponentState value) {
    m_componentStateHasBeenSet = true;
    m_componentState = value;
  }
  inline CloudComponentStatus& WithComponentState(CloudComponentState value) {
  ...
  inline CloudComponentStatus& WithVendorGuidance(VendorGuidance value) {
  ...
  void SetVendorGuidanceMessage(VendorGuidanceMessageT&& value) {
    ...
    m_vendorGuidanceMessage = std::forward<VendorGuidanceMessageT>(value);
  }
  template <typename VendorGuidanceMessageT = Aws::String>
  CloudComponentStatus& WithVendorGuidanceMessage(VendorGuidanceMessageT&& value) {
    SetVendorGuidanceMessage(std::forward<VendorGuidanceMessageT>(value));
    return *this;
  }
  ///@}
 private:
