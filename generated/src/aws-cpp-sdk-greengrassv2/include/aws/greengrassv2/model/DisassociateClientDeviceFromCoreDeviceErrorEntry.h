...
class DisassociateClientDeviceFromCoreDeviceErrorEntry {
 public:
  ...
  template <typename ThingNameT = Aws::String>
  DisassociateClientDeviceFromCoreDeviceErrorEntry& WithThingName(ThingNameT&& value) {
  ...
  template <typename CodeT = Aws::String>
  DisassociateClientDeviceFromCoreDeviceErrorEntry& WithCode(CodeT&& value) {
  ...
  template <typename MessageT = Aws::String>
  DisassociateClientDeviceFromCoreDeviceErrorEntry& WithMessage(MessageT&& value) {
