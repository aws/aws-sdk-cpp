...
class ComponentDeploymentSpecification {
 public:
  ...
  void SetConfigurationUpdate(ConfigurationUpdateT&& value) {
    ...
    m_configurationUpdate = std::forward<ConfigurationUpdateT>(value);
  }
  template <typename ConfigurationUpdateT = ComponentConfigurationUpdate>
  ComponentDeploymentSpecification& WithConfigurationUpdate(ConfigurationUpdateT&& value) {
    SetConfigurationUpdate(std::forward<ConfigurationUpdateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRunWith(RunWithT&& value) {
    ...
    m_runWith = std::forward<RunWithT>(value);
  }
  template <typename RunWithT = ComponentRunWith>
  ComponentDeploymentSpecification& WithRunWith(RunWithT&& value) {
    SetRunWith(std::forward<RunWithT>(value));
    return *this;
  }
  ///@}
 private:
