...
class ListEffectiveDeploymentsResult {
 public:
  ...
  void SetEffectiveDeployments(EffectiveDeploymentsT&& value) {
    m_effectiveDeploymentsHasBeenSet = true;
    m_effectiveDeployments = std::forward<EffectiveDeploymentsT>(value);
  }
  template <typename EffectiveDeploymentsT = Aws::Vector<EffectiveDeployment>>
  ListEffectiveDeploymentsResult& WithEffectiveDeployments(EffectiveDeploymentsT&& value) {
    SetEffectiveDeployments(std::forward<EffectiveDeploymentsT>(value));
    return *this;
  }
  template <typename EffectiveDeploymentsT = EffectiveDeployment>
  ListEffectiveDeploymentsResult& AddEffectiveDeployments(EffectiveDeploymentsT&& value) {
    m_effectiveDeploymentsHasBeenSet = true;
    m_effectiveDeployments.emplace_back(std::forward<EffectiveDeploymentsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListEffectiveDeploymentsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListEffectiveDeploymentsResult& WithRequestId(RequestIdT&& value) {
