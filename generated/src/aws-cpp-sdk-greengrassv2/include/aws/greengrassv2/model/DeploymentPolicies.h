...
class DeploymentPolicies {
 public:
  ...
  inline void SetFailureHandlingPolicy(DeploymentFailureHandlingPolicy value) {
    m_failureHandlingPolicyHasBeenSet = true;
    m_failureHandlingPolicy = value;
  }
  inline DeploymentPolicies& WithFailureHandlingPolicy(DeploymentFailureHandlingPolicy value) {
  ...
  void SetComponentUpdatePolicy(ComponentUpdatePolicyT&& value) {
    ...
    m_componentUpdatePolicy = std::forward<ComponentUpdatePolicyT>(value);
  }
  template <typename ComponentUpdatePolicyT = DeploymentComponentUpdatePolicy>
  DeploymentPolicies& WithComponentUpdatePolicy(ComponentUpdatePolicyT&& value) {
    SetComponentUpdatePolicy(std::forward<ComponentUpdatePolicyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetConfigurationValidationPolicy(ConfigurationValidationPolicyT&& value) {
    ...
    m_configurationValidationPolicy = std::forward<ConfigurationValidationPolicyT>(value);
  }
  template <typename ConfigurationValidationPolicyT = DeploymentConfigurationValidationPolicy>
  DeploymentPolicies& WithConfigurationValidationPolicy(ConfigurationValidationPolicyT&& value) {
    SetConfigurationValidationPolicy(std::forward<ConfigurationValidationPolicyT>(value));
    return *this;
  }
  ///@}
 private:
