...
class ListComponentVersionsResult {
 public:
  ...
  template <typename ComponentVersionsT = Aws::Vector<ComponentVersionListItem>>
  ListComponentVersionsResult& WithComponentVersions(ComponentVersionsT&& value) {
    SetComponentVersions(std::forward<ComponentVersionsT>(value));
    return *this;
  }
  template <typename ComponentVersionsT = ComponentVersionListItem>
  ListComponentVersionsResult& AddComponentVersions(ComponentVersionsT&& value) {
    m_componentVersionsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListComponentVersionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListComponentVersionsResult& WithRequestId(RequestIdT&& value) {
