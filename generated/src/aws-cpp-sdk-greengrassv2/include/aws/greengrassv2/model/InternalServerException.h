...
namespace Model
{
  ...
  {
  public:
    AWS_GREENGRASSV2_API InternalServerException() = default;
    AWS_GREENGRASSV2_API InternalServerException(Aws::Utils::Json::JsonView jsonValue);
    AWS_GREENGRASSV2_API InternalServerException& operator=(Aws::Utils::Json::JsonView jsonValue);
