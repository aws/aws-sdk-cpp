...
class ListCoreDevicesRequest : public GreengrassV2Request {
 public:
  ...
  template <typename ThingGroupArnT = Aws::String>
  ListCoreDevicesRequest& WithThingGroupArn(ThingGroupArnT&& value) {
  ...
  inline ListCoreDevicesRequest& WithStatus(CoreDeviceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline ListCoreDevicesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListCoreDevicesRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RuntimeT = Aws::String>
  ListCoreDevicesRequest& WithRuntime(RuntimeT&& value) {
