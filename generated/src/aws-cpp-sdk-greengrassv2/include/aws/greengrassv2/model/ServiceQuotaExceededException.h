...
namespace Model
{
  ...
  {
  public:
    AWS_GREENGRASSV2_API ServiceQuotaExceededException() = default;
    AWS_GREENGRASSV2_API ServiceQuotaExceededException(Aws::Utils::Json::JsonView jsonValue);
    AWS_GREENGRASSV2_API ServiceQuotaExceededException& operator=(Aws::Utils::Json::JsonView jsonValue);
