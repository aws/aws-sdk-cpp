...
class ListInstalledComponentsRequest : public GreengrassV2Request {
 public:
  ...
  inline ListInstalledComponentsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTopologyFilter(InstalledComponentTopologyFilter value) {
    m_topologyFilterHasBeenSet = true;
    m_topologyFilter = value;
  }
  inline ListInstalledComponentsRequest& WithTopologyFilter(InstalledComponentTopologyFilter value) {
