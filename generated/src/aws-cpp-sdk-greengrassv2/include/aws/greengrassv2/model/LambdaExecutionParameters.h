...
class LambdaExecutionParameters {
 public:
  ...
  inline void SetMaxQueueSize(int value) {
    m_maxQueueSizeHasBeenSet = true;
    m_maxQueueSize = value;
  }
  inline LambdaExecutionParameters& WithMaxQueueSize(int value) {
  ...
  inline void SetMaxInstancesCount(int value) {
    m_maxInstancesCountHasBeenSet = true;
    m_maxInstancesCount = value;
  }
  inline LambdaExecutionParameters& WithMaxInstancesCount(int value) {
    SetMaxInstancesCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxIdleTimeInSeconds(int value) {
    m_maxIdleTimeInSecondsHasBeenSet = true;
    m_maxIdleTimeInSeconds = value;
  }
  inline LambdaExecutionParameters& WithMaxIdleTimeInSeconds(int value) {
    SetMaxIdleTimeInSeconds(value);
    return *this;
  }
  ///@}
  ...
  inline LambdaExecutionParameters& WithTimeoutInSeconds(int value) {
  ...
  inline void SetStatusTimeoutInSeconds(int value) {
    m_statusTimeoutInSecondsHasBeenSet = true;
    m_statusTimeoutInSeconds = value;
  }
  inline LambdaExecutionParameters& WithStatusTimeoutInSeconds(int value) {
    SetStatusTimeoutInSeconds(value);
    return *this;
  }
  ///@}
  ...
  inline LambdaExecutionParameters& WithPinned(bool value) {
    SetPinned(value);
    return *this;
  }
  ///@}
  ...
  inline void SetInputPayloadEncodingType(LambdaInputPayloadEncodingType value) {
    m_inputPayloadEncodingTypeHasBeenSet = true;
    m_inputPayloadEncodingType = value;
  }
  inline LambdaExecutionParameters& WithInputPayloadEncodingType(LambdaInputPayloadEncodingType value) {
    SetInputPayloadEncodingType(value);
    return *this;
  }
  ///@}
  ...
  LambdaExecutionParameters& AddExecArgs(ExecArgsT&& value) {
    m_execArgsHasBeenSet = true;
    m_execArgs.emplace_back(std::forward<ExecArgsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLinuxProcessParams(LinuxProcessParamsT&& value) {
    ...
    m_linuxProcessParams = std::forward<LinuxProcessParamsT>(value);
  }
  template <typename LinuxProcessParamsT = LambdaLinuxProcessParams>
  LambdaExecutionParameters& WithLinuxProcessParams(LinuxProcessParamsT&& value) {
    SetLinuxProcessParams(std::forward<LinuxProcessParamsT>(value));
    return *this;
  }
  ///@}
 private:
