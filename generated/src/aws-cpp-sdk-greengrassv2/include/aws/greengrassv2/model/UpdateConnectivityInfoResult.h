...
class UpdateConnectivityInfoResult {
 public:
  ...
  template <typename VersionT = Aws::String>
  UpdateConnectivityInfoResult& WithVersion(VersionT&& value) {
  ...
  template <typename MessageT = Aws::String>
  UpdateConnectivityInfoResult& WithMessage(MessageT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateConnectivityInfoResult& WithRequestId(RequestIdT&& value) {
