...
namespace Model
{
  ...
  {
  public:
    AWS_GREENGRASSV2_API CancelDeploymentRequest() = default;
    ...
    template<typename DeploymentIdT = Aws::String>
    CancelDeploymentRequest& WithDeploymentId(DeploymentIdT&& value) { SetDeploymentId(std::forward<DeploymentIdT>(value)); return *this;}
    ///@}
  private:
