...
class BatchAssociateClientDeviceWithCoreDeviceResult {
 public:
  ...
  AWS_GREENGRASSV2_API BatchAssociateClientDeviceWithCoreDeviceResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ErrorEntriesT = Aws::Vector<AssociateClientDeviceWithCoreDeviceErrorEntry>>
  BatchAssociateClientDeviceWithCoreDeviceResult& WithErrorEntries(ErrorEntriesT&& value) {
  ...
  BatchAssociateClientDeviceWithCoreDeviceResult& AddErrorEntries(ErrorEntriesT&& value) {
    m_errorEntriesHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  BatchAssociateClientDeviceWithCoreDeviceResult& WithRequestId(RequestIdT&& value) {
