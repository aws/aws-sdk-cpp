...
class LambdaLinuxProcessParams {
 public:
  ...
  inline void SetIsolationMode(LambdaIsolationMode value) {
    m_isolationModeHasBeenSet = true;
    m_isolationMode = value;
  }
  inline LambdaLinuxProcessParams& WithIsolationMode(LambdaIsolationMode value) {
  ...
  void SetContainerParams(ContainerParamsT&& value) {
    ...
    m_containerParams = std::forward<ContainerParamsT>(value);
  }
  template <typename ContainerParamsT = LambdaContainerParams>
  LambdaLinuxProcessParams& WithContainerParams(ContainerParamsT&& value) {
    SetContainerParams(std::forward<ContainerParamsT>(value));
    return *this;
  }
  ///@}
 private:
