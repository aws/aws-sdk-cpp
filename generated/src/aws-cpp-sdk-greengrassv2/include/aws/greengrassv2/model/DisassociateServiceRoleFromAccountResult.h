...
class DisassociateServiceRoleFromAccountResult {
 public:
  ...
  AWS_GREENGRASSV2_API DisassociateServiceRoleFromAccountResult& operator=(
  ...
  template <typename DisassociatedAtT = Aws::String>
  DisassociateServiceRoleFromAccountResult& WithDisassociatedAt(DisassociatedAtT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DisassociateServiceRoleFromAccountResult& WithRequestId(RequestIdT&& value) {
