...
class InstalledComponent {
 public:
  ...
  inline void SetLifecycleState(InstalledComponentLifecycleState value) {
    m_lifecycleStateHasBeenSet = true;
    m_lifecycleState = value;
  }
  inline InstalledComponent& WithLifecycleState(InstalledComponentLifecycleState value) {
  ...
  void SetLifecycleStateDetails(LifecycleStateDetailsT&& value) {
    ...
    m_lifecycleStateDetails = std::forward<LifecycleStateDetailsT>(value);
  }
  template <typename LifecycleStateDetailsT = Aws::String>
  InstalledComponent& WithLifecycleStateDetails(LifecycleStateDetailsT&& value) {
    SetLifecycleStateDetails(std::forward<LifecycleStateDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  inline InstalledComponent& WithIsRoot(bool value) {
    SetIsRoot(value);
    return *this;
  }
  ///@}
  ...
  void SetLastStatusChangeTimestamp(LastStatusChangeTimestampT&& value) {
    ...
    m_lastStatusChangeTimestamp = std::forward<LastStatusChangeTimestampT>(value);
  }
  template <typename LastStatusChangeTimestampT = Aws::Utils::DateTime>
  InstalledComponent& WithLastStatusChangeTimestamp(LastStatusChangeTimestampT&& value) {
    SetLastStatusChangeTimestamp(std::forward<LastStatusChangeTimestampT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastReportedTimestamp(LastReportedTimestampT&& value) {
    ...
    m_lastReportedTimestamp = std::forward<LastReportedTimestampT>(value);
  }
  template <typename LastReportedTimestampT = Aws::Utils::DateTime>
  InstalledComponent& WithLastReportedTimestamp(LastReportedTimestampT&& value) {
    SetLastReportedTimestamp(std::forward<LastReportedTimestampT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastInstallationSource(LastInstallationSourceT&& value) {
    ...
    m_lastInstallationSource = std::forward<LastInstallationSourceT>(value);
  }
  template <typename LastInstallationSourceT = Aws::String>
  InstalledComponent& WithLastInstallationSource(LastInstallationSourceT&& value) {
    SetLastInstallationSource(std::forward<LastInstallationSourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLifecycleStatusCodes(LifecycleStatusCodesT&& value) {
    ...
    m_lifecycleStatusCodes = std::forward<LifecycleStatusCodesT>(value);
  }
  template <typename LifecycleStatusCodesT = Aws::Vector<Aws::String>>
  InstalledComponent& WithLifecycleStatusCodes(LifecycleStatusCodesT&& value) {
    SetLifecycleStatusCodes(std::forward<LifecycleStatusCodesT>(value));
    return *this;
  }
  template <typename LifecycleStatusCodesT = Aws::String>
  InstalledComponent& AddLifecycleStatusCodes(LifecycleStatusCodesT&& value) {
    m_lifecycleStatusCodesHasBeenSet = true;
    m_lifecycleStatusCodes.emplace_back(std::forward<LifecycleStatusCodesT>(value));
    return *this;
  }
  ///@}
 private:
