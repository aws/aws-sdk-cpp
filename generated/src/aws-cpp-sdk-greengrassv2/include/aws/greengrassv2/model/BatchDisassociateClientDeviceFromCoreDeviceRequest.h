...
class BatchDisassociateClientDeviceFromCoreDeviceRequest : public GreengrassV2Request {
 public:
  ...
  template <typename EntriesT = Aws::Vector<DisassociateClientDeviceFromCoreDeviceEntry>>
  BatchDisassociateClientDeviceFromCoreDeviceRequest& WithEntries(EntriesT&& value) {
    SetEntries(std::forward<EntriesT>(value));
    return *this;
  }
  template <typename EntriesT = DisassociateClientDeviceFromCoreDeviceEntry>
  BatchDisassociateClientDeviceFromCoreDeviceRequest& AddEntries(EntriesT&& value) {
    m_entriesHasBeenSet = true;
  ...
  template <typename CoreDeviceThingNameT = Aws::String>
  BatchDisassociateClientDeviceFromCoreDeviceRequest& WithCoreDeviceThingName(CoreDeviceThingNameT&& value) {
