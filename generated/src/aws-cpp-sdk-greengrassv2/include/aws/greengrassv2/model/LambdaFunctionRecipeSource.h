...
class LambdaFunctionRecipeSource {
 public:
  ...
  void SetComponentPlatforms(ComponentPlatformsT&& value) {
    ...
    m_componentPlatforms = std::forward<ComponentPlatformsT>(value);
  }
  template <typename ComponentPlatformsT = Aws::Vector<ComponentPlatform>>
  LambdaFunctionRecipeSource& WithComponentPlatforms(ComponentPlatformsT&& value) {
    SetComponentPlatforms(std::forward<ComponentPlatformsT>(value));
    return *this;
  }
  ...
  LambdaFunctionRecipeSource& AddComponentPlatforms(ComponentPlatformsT&& value) {
    m_componentPlatformsHasBeenSet = true;
    m_componentPlatforms.emplace_back(std::forward<ComponentPlatformsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetComponentDependencies(ComponentDependenciesT&& value) {
    ...
    m_componentDependencies = std::forward<ComponentDependenciesT>(value);
  }
  template <typename ComponentDependenciesT = Aws::Map<Aws::String, ComponentDependencyRequirement>>
  LambdaFunctionRecipeSource& WithComponentDependencies(ComponentDependenciesT&& value) {
    SetComponentDependencies(std::forward<ComponentDependenciesT>(value));
    return *this;
  }
  ...
  LambdaFunctionRecipeSource& AddComponentDependencies(ComponentDependenciesKeyT&& key, ComponentDependenciesValueT&& value) {
    m_componentDependenciesHasBeenSet = true;
    m_componentDependencies.emplace(std::forward<ComponentDependenciesKeyT>(key), std::forward<ComponentDependenciesValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetComponentLambdaParameters(ComponentLambdaParametersT&& value) {
    ...
    m_componentLambdaParameters = std::forward<ComponentLambdaParametersT>(value);
  }
  template <typename ComponentLambdaParametersT = LambdaExecutionParameters>
  LambdaFunctionRecipeSource& WithComponentLambdaParameters(ComponentLambdaParametersT&& value) {
    SetComponentLambdaParameters(std::forward<ComponentLambdaParametersT>(value));
    return *this;
  }
  ///@}
 private:
