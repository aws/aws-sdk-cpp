...
class AssociateClientDeviceWithCoreDeviceErrorEntry {
 public:
  ...
  template <typename ThingNameT = Aws::String>
  AssociateClientDeviceWithCoreDeviceErrorEntry& WithThingName(ThingNameT&& value) {
  ...
  template <typename CodeT = Aws::String>
  AssociateClientDeviceWithCoreDeviceErrorEntry& WithCode(CodeT&& value) {
  ...
  template <typename MessageT = Aws::String>
  AssociateClientDeviceWithCoreDeviceErrorEntry& WithMessage(MessageT&& value) {
