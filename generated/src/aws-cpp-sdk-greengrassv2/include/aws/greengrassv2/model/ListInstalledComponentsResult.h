...
class ListInstalledComponentsResult {
 public:
  ...
  void SetInstalledComponents(InstalledComponentsT&& value) {
    m_installedComponentsHasBeenSet = true;
    m_installedComponents = std::forward<InstalledComponentsT>(value);
  }
  template <typename InstalledComponentsT = Aws::Vector<InstalledComponent>>
  ListInstalledComponentsResult& WithInstalledComponents(InstalledComponentsT&& value) {
    SetInstalledComponents(std::forward<InstalledComponentsT>(value));
    return *this;
  }
  ...
  ListInstalledComponentsResult& AddInstalledComponents(InstalledComponentsT&& value) {
    m_installedComponentsHasBeenSet = true;
    m_installedComponents.emplace_back(std::forward<InstalledComponentsT>(value));
    return *this;
  }
  ///@}
