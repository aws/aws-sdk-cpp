...
namespace Model
{
  ...
  {
  public:
    AWS_GREENGRASSV2_API ResourceNotFoundException() = default;
    AWS_GREENGRASSV2_API ResourceNotFoundException(Aws::Utils::Json::JsonView jsonValue);
    AWS_GREENGRASSV2_API ResourceNotFoundException& operator=(Aws::Utils::Json::JsonView jsonValue);
