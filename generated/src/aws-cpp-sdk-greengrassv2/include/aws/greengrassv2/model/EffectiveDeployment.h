...
class EffectiveDeployment {
 public:
  ...
  inline void SetCoreDeviceExecutionStatus(EffectiveDeploymentExecutionStatus value) {
    m_coreDeviceExecutionStatusHasBeenSet = true;
    m_coreDeviceExecutionStatus = value;
  }
  inline EffectiveDeployment& WithCoreDeviceExecutionStatus(EffectiveDeploymentExecutionStatus value) {
    SetCoreDeviceExecutionStatus(value);
    return *this;
  }
  ///@}
