...
class IoTJobAbortCriteria {
 public:
  ...
  inline void SetFailureType(IoTJobExecutionFailureType value) {
    m_failureTypeHasBeenSet = true;
    m_failureType = value;
  }
  inline IoTJobAbortCriteria& WithFailureType(IoTJobExecutionFailureType value) {
  ...
  inline void SetAction(IoTJobAbortAction value) {
    m_actionHasBeenSet = true;
    m_action = value;
  }
  inline IoTJobAbortCriteria& WithAction(IoTJobAbortAction value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  inline void SetThresholdPercentage(double value) {
    m_thresholdPercentageHasBeenSet = true;
    m_thresholdPercentage = value;
  }
  inline IoTJobAbortCriteria& WithThresholdPercentage(double value) {
  ...
  inline void SetMinNumberOfExecutedThings(int value) {
    m_minNumberOfExecutedThingsHasBeenSet = true;
    m_minNumberOfExecutedThings = value;
  }
  inline IoTJobAbortCriteria& WithMinNumberOfExecutedThings(int value) {
    SetMinNumberOfExecutedThings(value);
    return *this;
  }
  ///@}
 private:
