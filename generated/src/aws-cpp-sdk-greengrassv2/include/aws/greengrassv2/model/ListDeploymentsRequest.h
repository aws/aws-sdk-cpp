...
class ListDeploymentsRequest : public GreengrassV2Request {
 public:
  ...
  inline void SetHistoryFilter(DeploymentHistoryFilter value) {
    m_historyFilterHasBeenSet = true;
    m_historyFilter = value;
  }
  inline ListDeploymentsRequest& WithHistoryFilter(DeploymentHistoryFilter value) {
