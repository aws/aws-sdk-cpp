...
class ResolveComponentCandidatesRequest : public GreengrassV2Request {
 public:
  ...
  template <typename PlatformT = ComponentPlatform>
  ResolveComponentCandidatesRequest& WithPlatform(PlatformT&& value) {
  ...
  void SetComponentCandidates(ComponentCandidatesT&& value) {
    m_componentCandidatesHasBeenSet = true;
    m_componentCandidates = std::forward<ComponentCandidatesT>(value);
  }
  template <typename ComponentCandidatesT = Aws::Vector<ComponentCandidate>>
  ResolveComponentCandidatesRequest& WithComponentCandidates(ComponentCandidatesT&& value) {
    SetComponentCandidates(std::forward<ComponentCandidatesT>(value));
    return *this;
  }
  template <typename ComponentCandidatesT = ComponentCandidate>
  ResolveComponentCandidatesRequest& AddComponentCandidates(ComponentCandidatesT&& value) {
    m_componentCandidatesHasBeenSet = true;
    m_componentCandidates.emplace_back(std::forward<ComponentCandidatesT>(value));
    return *this;
  }
  ///@}
 private:
