...
class ListClientDevicesAssociatedWithCoreDeviceRequest : public GreengrassV2Request {
 public:
  ...
  template <typename CoreDeviceThingNameT = Aws::String>
  ListClientDevicesAssociatedWithCoreDeviceRequest& WithCoreDeviceThingName(CoreDeviceThingNameT&& value) {
  ...
  inline ListClientDevicesAssociatedWithCoreDeviceRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListClientDevicesAssociatedWithCoreDeviceRequest& WithNextToken(NextTokenT&& value) {
