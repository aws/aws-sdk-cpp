...
namespace Model
{
  ...
  {
  public:
    AWS_GREENGRASSV2_API ListClientDevicesAssociatedWithCoreDeviceRequest() = default;
    ...
    template<typename CoreDeviceThingNameT = Aws::String>
    ListClientDevicesAssociatedWithCoreDeviceRequest& WithCoreDeviceThingName(CoreDeviceThingNameT&& value) { SetCoreDeviceThingName(std::forward<CoreDeviceThingNameT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListClientDevicesAssociatedWithCoreDeviceRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
