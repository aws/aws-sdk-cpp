...
class ListComponentsRequest : public GreengrassV2Request {
 public:
  ...
  inline void SetScope(ComponentVisibilityScope value) {
    m_scopeHasBeenSet = true;
    m_scope = value;
  }
  inline ListComponentsRequest& WithScope(ComponentVisibilityScope value) {
    SetScope(value);
    return *this;
  }
  ///@}
  ...
  inline ListComponentsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
