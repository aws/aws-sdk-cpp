...
class GetDeploymentResult {
 public:
  ...
  inline GetDeploymentResult& WithDeploymentStatus(DeploymentStatus value) {
  ...
  void SetIotJobId(IotJobIdT&& value) {
    ...
    m_iotJobId = std::forward<IotJobIdT>(value);
  }
  template <typename IotJobIdT = Aws::String>
  GetDeploymentResult& WithIotJobId(IotJobIdT&& value) {
    SetIotJobId(std::forward<IotJobIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIotJobArn(IotJobArnT&& value) {
    ...
    m_iotJobArn = std::forward<IotJobArnT>(value);
  }
  template <typename IotJobArnT = Aws::String>
  GetDeploymentResult& WithIotJobArn(IotJobArnT&& value) {
    SetIotJobArn(std::forward<IotJobArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDeploymentPolicies(DeploymentPoliciesT&& value) {
    ...
    m_deploymentPolicies = std::forward<DeploymentPoliciesT>(value);
  }
  template <typename DeploymentPoliciesT = DeploymentPolicies>
  GetDeploymentResult& WithDeploymentPolicies(DeploymentPoliciesT&& value) {
    SetDeploymentPolicies(std::forward<DeploymentPoliciesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIotJobConfiguration(IotJobConfigurationT&& value) {
    ...
    m_iotJobConfiguration = std::forward<IotJobConfigurationT>(value);
  }
  template <typename IotJobConfigurationT = DeploymentIoTJobConfiguration>
  GetDeploymentResult& WithIotJobConfiguration(IotJobConfigurationT&& value) {
    SetIotJobConfiguration(std::forward<IotJobConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetDeploymentResult& WithIsLatestForTarget(bool value) {
