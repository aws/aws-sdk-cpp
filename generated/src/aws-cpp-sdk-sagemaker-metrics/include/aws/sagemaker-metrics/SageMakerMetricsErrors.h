...
class AWS_SAGEMAKERMETRICS_API SageMakerMetricsError : public Aws::Client::AWSError<SageMakerMetricsErrors> {
 public:
  ...
  SageMakerMetricsError(const Aws::Client::AWSError<SageMakerMetricsErrors>& rhs) : Aws::Client::AWSError<SageMakerMetricsErrors>(rhs) {}
  SageMakerMetricsError(Aws::Client::AWSError<SageMakerMetricsErrors>&& rhs) : Aws::Client::AWSError<SageMakerMetricsErrors>(rhs) {}
