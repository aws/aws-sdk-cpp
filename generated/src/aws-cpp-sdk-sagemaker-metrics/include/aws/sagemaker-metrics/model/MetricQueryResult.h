...
class MetricQueryResult {
 public:
  ...
  inline void SetStatus(MetricQueryResultStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline MetricQueryResult& WithStatus(MetricQueryResultStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename MessageT = Aws::String>
  MetricQueryResult& WithMessage(MessageT&& value) {
  ...
  void SetXAxisValues(XAxisValuesT&& value) {
    m_xAxisValuesHasBeenSet = true;
    m_xAxisValues = std::forward<XAxisValuesT>(value);
  }
  template <typename XAxisValuesT = Aws::Vector<long long>>
  MetricQueryResult& WithXAxisValues(XAxisValuesT&& value) {
    SetXAxisValues(std::forward<XAxisValuesT>(value));
    return *this;
  }
  inline MetricQueryResult& AddXAxisValues(long long value) {
    m_xAxisValuesHasBeenSet = true;
    m_xAxisValues.push_back(value);
    return *this;
  }
  ///@}
  ...
  template <typename MetricValuesT = Aws::Vector<double>>
  MetricQueryResult& WithMetricValues(MetricValuesT&& value) {
    SetMetricValues(std::forward<MetricValuesT>(value));
    return *this;
  }
  inline MetricQueryResult& AddMetricValues(double value) {
    m_metricValuesHasBeenSet = true;
