...
class BatchPutMetricsError {
 public:
  ...
  inline void SetCode(PutMetricsErrorCode value) {
    m_codeHasBeenSet = true;
    m_code = value;
  }
  inline BatchPutMetricsError& WithCode(PutMetricsErrorCode value) {
    SetCode(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMetricIndex(int value) {
    m_metricIndexHasBeenSet = true;
    m_metricIndex = value;
  }
  inline BatchPutMetricsError& WithMetricIndex(int value) {
