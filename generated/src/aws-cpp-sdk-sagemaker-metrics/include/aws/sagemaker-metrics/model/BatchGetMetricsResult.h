...
class BatchGetMetricsResult {
 public:
  ...
  void SetMetricQueryResults(MetricQueryResultsT&& value) {
    m_metricQueryResultsHasBeenSet = true;
    m_metricQueryResults = std::forward<MetricQueryResultsT>(value);
  }
  template <typename MetricQueryResultsT = Aws::Vector<MetricQueryResult>>
  BatchGetMetricsResult& WithMetricQueryResults(MetricQueryResultsT&& value) {
    SetMetricQueryResults(std::forward<MetricQueryResultsT>(value));
    return *this;
  }
  template <typename MetricQueryResultsT = MetricQueryResult>
  BatchGetMetricsResult& AddMetricQueryResults(MetricQueryResultsT&& value) {
    m_metricQueryResultsHasBeenSet = true;
    m_metricQueryResults.emplace_back(std::forward<MetricQueryResultsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  BatchGetMetricsResult& WithRequestId(RequestIdT&& value) {
