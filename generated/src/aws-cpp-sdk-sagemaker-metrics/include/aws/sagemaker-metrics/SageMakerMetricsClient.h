...
class AWS_SAGEMAKERMETRICS_API SageMakerMetricsClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  SageMakerMetricsClient(const Aws::SageMakerMetrics::SageMakerMetricsClientConfiguration& clientConfiguration =
  ...
  SageMakerMetricsClient(const Aws::Auth::AWSCredentials& credentials,
                         std::shared_ptr<SageMakerMetricsEndpointProviderBase> endpointProvider = nullptr,
                         const Aws::SageMakerMetrics::SageMakerMetricsClientConfiguration& clientConfiguration =
                             Aws::SageMakerMetrics::SageMakerMetricsClientConfiguration());
  ...
  /**
   * An Async wrapper for BatchGetMetrics that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename BatchGetMetricsRequestT = Model::BatchGetMetricsRequest>
  void BatchGetMetricsAsync(const BatchGetMetricsRequestT& request, const BatchGetMetricsResponseReceivedHandler& handler,
  ...
  /**
   * An Async wrapper for BatchPutMetrics that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename BatchPutMetricsRequestT = Model::BatchPutMetricsRequest>
  void BatchPutMetricsAsync(const BatchPutMetricsRequestT& request, const BatchPutMetricsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
