...
namespace SageMakerMetrics
{
   ...
   * </p> </li> </ul>
   */
  class AWS_SAGEMAKERMETRICS_API SageMakerMetricsClient : Aws::Client::ClientWithAsyncTemplateMethods<SageMakerMetricsClient>,
    smithy::client::AwsSmithyClientT<Aws::SageMakerMetrics::SERVICE_NAME,
