...
SyncConfiguration::SyncConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
SyncConfiguration& SyncConfiguration::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("PublishDeploymentStatus")) {
    m_publishDeploymentStatus =
        PublishDeploymentStatusMapper::GetPublishDeploymentStatusForName(jsonValue.GetString("PublishDeploymentStatus"));
    m_publishDeploymentStatusHasBeenSet = true;
  }
  if (jsonValue.ValueExists("TriggerResourceUpdateOn")) {
    m_triggerResourceUpdateOn =
        TriggerResourceUpdateOnMapper::GetTriggerResourceUpdateOnForName(jsonValue.GetString("TriggerResourceUpdateOn"));
