...
UpdateRepositoryLinkResult::UpdateRepositoryLinkResult()
{
}

UpdateRepositoryLinkResult::UpdateRepositoryLinkResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
