...
class CreateRepositoryLinkRequest : public CodeConnectionsRequest {
 public:
  AWS_CODECONNECTIONS_API CreateRepositoryLinkRequest() = default;
  ...
  template <typename ConnectionArnT = Aws::String>
  CreateRepositoryLinkRequest& WithConnectionArn(ConnectionArnT&& value) {
  ...
  template <typename OwnerIdT = Aws::String>
  CreateRepositoryLinkRequest& WithOwnerId(OwnerIdT&& value) {
  ...
  template <typename RepositoryNameT = Aws::String>
  CreateRepositoryLinkRequest& WithRepositoryName(RepositoryNameT&& value) {
  ...
  template <typename EncryptionKeyArnT = Aws::String>
  CreateRepositoryLinkRequest& WithEncryptionKeyArn(EncryptionKeyArnT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateRepositoryLinkRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateRepositoryLinkRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
