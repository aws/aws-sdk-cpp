...
class CreateSyncConfigurationRequest : public CodeConnectionsRequest {
 public:
  ...
  inline CreateSyncConfigurationRequest& WithSyncType(SyncConfigurationType value) {
    SetSyncType(value);
    return *this;
  }
  ///@}
  ...
  inline CreateSyncConfigurationRequest& WithPublishDeploymentStatus(PublishDeploymentStatus value) {
  ...
  inline CreateSyncConfigurationRequest& WithTriggerResourceUpdateOn(TriggerResourceUpdateOn value) {
  ...
  inline void SetPullRequestComment(PullRequestComment value) {
    m_pullRequestCommentHasBeenSet = true;
    m_pullRequestComment = value;
  }
  inline CreateSyncConfigurationRequest& WithPullRequestComment(PullRequestComment value) {
    SetPullRequestComment(value);
    return *this;
  }
  ///@}
 private:
