...
namespace Model
{
  ...
  {
  public:
    AWS_CODECONNECTIONS_API ListTagsForResourceResult() = default;
    AWS_CODECONNECTIONS_API ListTagsForResourceResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_CODECONNECTIONS_API ListTagsForResourceResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
