...
class ListRepositoryLinksResult {
 public:
  ...
  void SetRepositoryLinks(RepositoryLinksT&& value) {
    m_repositoryLinksHasBeenSet = true;
    m_repositoryLinks = std::forward<RepositoryLinksT>(value);
  }
  template <typename RepositoryLinksT = Aws::Vector<RepositoryLinkInfo>>
  ListRepositoryLinksResult& WithRepositoryLinks(RepositoryLinksT&& value) {
    SetRepositoryLinks(std::forward<RepositoryLinksT>(value));
    return *this;
  }
  template <typename RepositoryLinksT = RepositoryLinkInfo>
  ListRepositoryLinksResult& AddRepositoryLinks(RepositoryLinksT&& value) {
    m_repositoryLinksHasBeenSet = true;
    m_repositoryLinks.emplace_back(std::forward<RepositoryLinksT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListRepositoryLinksResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListRepositoryLinksResult& WithRequestId(RequestIdT&& value) {
