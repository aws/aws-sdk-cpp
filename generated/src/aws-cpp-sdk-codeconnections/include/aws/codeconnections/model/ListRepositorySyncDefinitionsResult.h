...
class ListRepositorySyncDefinitionsResult {
 public:
  ...
  void SetRepositorySyncDefinitions(RepositorySyncDefinitionsT&& value) {
    m_repositorySyncDefinitionsHasBeenSet = true;
    m_repositorySyncDefinitions = std::forward<RepositorySyncDefinitionsT>(value);
  }
  template <typename RepositorySyncDefinitionsT = Aws::Vector<RepositorySyncDefinition>>
  ListRepositorySyncDefinitionsResult& WithRepositorySyncDefinitions(RepositorySyncDefinitionsT&& value) {
    SetRepositorySyncDefinitions(std::forward<RepositorySyncDefinitionsT>(value));
    return *this;
  }
  template <typename RepositorySyncDefinitionsT = RepositorySyncDefinition>
  ListRepositorySyncDefinitionsResult& AddRepositorySyncDefinitions(RepositorySyncDefinitionsT&& value) {
    m_repositorySyncDefinitionsHasBeenSet = true;
    m_repositorySyncDefinitions.emplace_back(std::forward<RepositorySyncDefinitionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListRepositorySyncDefinitionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListRepositorySyncDefinitionsResult& WithRequestId(RequestIdT&& value) {
