...
/**
 */
class ListRepositoryLinksRequest : public CodeConnectionsRequest {
 public:
  AWS_CODECONNECTIONS_API ListRepositoryLinksRequest() = default;
  ...
  inline ListRepositoryLinksRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListRepositoryLinksRequest& WithNextToken(NextTokenT&& value) {
