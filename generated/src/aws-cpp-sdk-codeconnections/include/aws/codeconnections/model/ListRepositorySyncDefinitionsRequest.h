...
class ListRepositorySyncDefinitionsRequest : public CodeConnectionsRequest {
 public:
  AWS_CODECONNECTIONS_API ListRepositorySyncDefinitionsRequest() = default;
  ...
  template <typename RepositoryLinkIdT = Aws::String>
  ListRepositorySyncDefinitionsRequest& WithRepositoryLinkId(RepositoryLinkIdT&& value) {
  ...
  inline ListRepositorySyncDefinitionsRequest& WithSyncType(SyncConfigurationType value) {
    SetSyncType(value);
    return *this;
  }
  ///@}
