...
class AWS_CODECONNECTIONS_API CodeConnectionsClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  CodeConnectionsClient(const Aws::CodeConnections::CodeConnectionsClientConfiguration& clientConfiguration =
  ...
  CodeConnectionsClient(const Aws::Auth::AWSCredentials& credentials,
                        std::shared_ptr<CodeConnectionsEndpointProviderBase> endpointProvider = nullptr,
                        const Aws::CodeConnections::CodeConnectionsClientConfiguration& clientConfiguration =
                            Aws::CodeConnections::CodeConnectionsClientConfiguration());
