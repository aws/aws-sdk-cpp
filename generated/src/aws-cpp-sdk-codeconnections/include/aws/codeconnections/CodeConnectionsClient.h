...
namespace CodeConnections
{
   ...
   */
  class AWS_CODECONNECTIONS_API CodeConnectionsClient : Aws::Client::ClientWithAsyncTemplateMethods<CodeConnectionsClient>,
    smithy::client::AwsSmithyClientT<Aws::CodeConnections::SERVICE_NAME,
