...
BatchCreateUserRequestItem::BatchCreateUserRequestItem(JsonView jsonValue) { *this = jsonValue; }

BatchCreateUserRequestItem& BatchCreateUserRequestItem::operator=(JsonView jsonValue) {
...
JsonValue BatchCreateUserRequestItem::Jsonize() const {
  JsonValue payload;
