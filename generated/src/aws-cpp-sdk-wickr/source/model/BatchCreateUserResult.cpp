...
BatchCreateUserResult::BatchCreateUserResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

BatchCreateUserResult& BatchCreateUserResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
