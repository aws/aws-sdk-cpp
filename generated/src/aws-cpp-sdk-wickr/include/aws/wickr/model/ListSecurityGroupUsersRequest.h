...
/**
 */
class ListSecurityGroupUsersRequest : public WickrRequest {
 public:
  AWS_WICKR_API ListSecurityGroupUsersRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "ListSecurityGroupUsers"; }
  ...
  template <typename NetworkIdT = Aws::String>
  ListSecurityGroupUsersRequest& WithNetworkId(NetworkIdT&& value) {
  ...
  template <typename GroupIdT = Aws::String>
  ListSecurityGroupUsersRequest& WithGroupId(GroupIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListSecurityGroupUsersRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListSecurityGroupUsersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  ///@{
  /**
   * <p>The field to sort users by. Multiple fields can be specified by separating
  ...
  template <typename SortFieldsT = Aws::String>
  ListSecurityGroupUsersRequest& WithSortFields(SortFieldsT&& value) {
  ...
  inline ListSecurityGroupUsersRequest& WithSortDirection(SortDirection value) {
