...
namespace Wickr {
namespace Model {
class RegisterOpentdfConfigResult {
 public:
  AWS_WICKR_API RegisterOpentdfConfigResult() = default;
  AWS_WICKR_API RegisterOpentdfConfigResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_WICKR_API RegisterOpentdfConfigResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ClientIdT = Aws::String>
  RegisterOpentdfConfigResult& WithClientId(ClientIdT&& value) {
  ...
  template <typename DomainT = Aws::String>
  RegisterOpentdfConfigResult& WithDomain(DomainT&& value) {
  ...
  template <typename ClientSecretT = Aws::String>
  RegisterOpentdfConfigResult& WithClientSecret(ClientSecretT&& value) {
  ...
  template <typename ProviderT = Aws::String>
  RegisterOpentdfConfigResult& WithProvider(ProviderT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  RegisterOpentdfConfigResult& WithRequestId(RequestIdT&& value) {
