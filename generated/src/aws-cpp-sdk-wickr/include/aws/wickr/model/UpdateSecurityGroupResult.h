...
namespace Wickr {
namespace Model {
class UpdateSecurityGroupResult {
 public:
  AWS_WICKR_API UpdateSecurityGroupResult() = default;
  AWS_WICKR_API UpdateSecurityGroupResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_WICKR_API UpdateSecurityGroupResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename SecurityGroupT = SecurityGroup>
  UpdateSecurityGroupResult& WithSecurityGroup(SecurityGroupT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateSecurityGroupResult& WithRequestId(RequestIdT&& value) {
