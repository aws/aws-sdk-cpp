...
/**
 */
class GetNetworkSettingsRequest : public WickrRequest {
 public:
  AWS_WICKR_API GetNetworkSettingsRequest() = default;
  ...
  template <typename NetworkIdT = Aws::String>
  GetNetworkSettingsRequest& WithNetworkId(NetworkIdT&& value) {
