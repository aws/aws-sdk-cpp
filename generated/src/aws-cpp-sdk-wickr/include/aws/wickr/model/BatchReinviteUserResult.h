...
namespace Wickr {
namespace Model {
class BatchReinviteUserResult {
 public:
  AWS_WICKR_API BatchReinviteUserResult() = default;
  AWS_WICKR_API BatchReinviteUserResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_WICKR_API BatchReinviteUserResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);

  ///@{
  /**
   * <p>A message indicating the overall result of the batch reinvitation
   * operation.</p>
   */
  ...
  template <typename MessageT = Aws::String>
  BatchReinviteUserResult& WithMessage(MessageT&& value) {
  ...
  template <typename SuccessfulT = Aws::Vector<BatchUserSuccessResponseItem>>
  BatchReinviteUserResult& WithSuccessful(SuccessfulT&& value) {
    SetSuccessful(std::forward<SuccessfulT>(value));
    return *this;
  }
  template <typename SuccessfulT = BatchUserSuccessResponseItem>
  BatchReinviteUserResult& AddSuccessful(SuccessfulT&& value) {
    m_successfulHasBeenSet = true;
  ...
  ///@{
  /**
   * <p>A list of reinvitation attempts that failed, including error details
   * explaining why each user could not be reinvited.</p>
   */
  ...
  template <typename FailedT = Aws::Vector<BatchUserErrorResponseItem>>
  BatchReinviteUserResult& WithFailed(FailedT&& value) {
    SetFailed(std::forward<FailedT>(value));
    return *this;
  }
  template <typename FailedT = BatchUserErrorResponseItem>
  BatchReinviteUserResult& AddFailed(FailedT&& value) {
    m_failedHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  BatchReinviteUserResult& WithRequestId(RequestIdT&& value) {
