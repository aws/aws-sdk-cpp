...
/**
 */
class ListGuestUsersRequest : public WickrRequest {
 public:
  AWS_WICKR_API ListGuestUsersRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "ListGuestUsers"; }
  ...
  template <typename NetworkIdT = Aws::String>
  ListGuestUsersRequest& WithNetworkId(NetworkIdT&& value) {
  ...
  ///@{
  /**
   * <p>The maximum number of guest users to return in a single page. Valid range is
  ...
  inline ListGuestUsersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline ListGuestUsersRequest& WithSortDirection(SortDirection value) {
  ...
  ///@{
  /**
   * <p>The field to sort guest users by. Accepted values include 'username' and
   * 'billingPeriod'.</p>
   */
  ...
  template <typename SortFieldsT = Aws::String>
  ListGuestUsersRequest& WithSortFields(SortFieldsT&& value) {
  ...
  ///@{
  /**
   * <p>Filter results to only include guest users with usernames matching this
   * value.</p>
   */
  ...
  template <typename UsernameT = Aws::String>
  ListGuestUsersRequest& WithUsername(UsernameT&& value) {
  ...
  ///@{
  /**
   * <p>Filter results to only include guest users from this billing period (e.g.,
   * '2024-01').</p>
   */
  ...
  template <typename BillingPeriodT = Aws::String>
  ListGuestUsersRequest& WithBillingPeriod(BillingPeriodT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListGuestUsersRequest& WithNextToken(NextTokenT&& value) {
