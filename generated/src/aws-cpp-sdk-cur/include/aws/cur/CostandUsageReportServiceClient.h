...
namespace CostandUsageReportService
{
   ...
   */
  class AWS_COSTANDUSAGEREPORTSERVICE_API CostandUsageReportServiceClient : Aws::Client::ClientWithAsyncTemplateMethods<CostandUsageReportServiceClient>,
    smithy::client::AwsSmithyClientT<Aws::CostandUsageReportService::SERVICE_NAME,
