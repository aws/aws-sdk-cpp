...
class DeleteReportDefinitionResult {
 public:
  ...
  AWS_COSTANDUSAGEREPORTSERVICE_API DeleteReportDefinitionResult& operator=(
  ...
  void SetResponseMessage(ResponseMessageT&& value) {
    m_responseMessageHasBeenSet = true;
    m_responseMessage = std::forward<ResponseMessageT>(value);
  }
  template <typename ResponseMessageT = Aws::String>
  DeleteReportDefinitionResult& WithResponseMessage(ResponseMessageT&& value) {
    SetResponseMessage(std::forward<ResponseMessageT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DeleteReportDefinitionResult& WithRequestId(RequestIdT&& value) {
