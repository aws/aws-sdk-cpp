...
class ReportDefinition {
 public:
  ...
  template <typename ReportNameT = Aws::String>
  ReportDefinition& WithReportName(ReportNameT&& value) {
  ...
  inline ReportDefinition& WithTimeUnit(TimeUnit value) {
    SetTimeUnit(value);
    return *this;
  }
  ///@}
  ...
  inline ReportDefinition& WithFormat(ReportFormat value) {
    SetFormat(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCompression(CompressionFormat value) {
    m_compressionHasBeenSet = true;
    m_compression = value;
  }
  inline ReportDefinition& WithCompression(CompressionFormat value) {
  ...
  void SetAdditionalSchemaElements(AdditionalSchemaElementsT&& value) {
    m_additionalSchemaElementsHasBeenSet = true;
    m_additionalSchemaElements = std::forward<AdditionalSchemaElementsT>(value);
  }
  template <typename AdditionalSchemaElementsT = Aws::Vector<SchemaElement>>
  ReportDefinition& WithAdditionalSchemaElements(AdditionalSchemaElementsT&& value) {
    SetAdditionalSchemaElements(std::forward<AdditionalSchemaElementsT>(value));
    return *this;
  }
  inline ReportDefinition& AddAdditionalSchemaElements(SchemaElement value) {
    m_additionalSchemaElementsHasBeenSet = true;
    m_additionalSchemaElements.push_back(value);
    return *this;
  }
  ///@}
  ...
  template <typename S3BucketT = Aws::String>
  ReportDefinition& WithS3Bucket(S3BucketT&& value) {
  ...
  template <typename S3PrefixT = Aws::String>
  ReportDefinition& WithS3Prefix(S3PrefixT&& value) {
  ...
  inline void SetS3Region(AWSRegion value) {
    m_s3RegionHasBeenSet = true;
    m_s3Region = value;
  }
  inline ReportDefinition& WithS3Region(AWSRegion value) {
    SetS3Region(value);
    return *this;
  }
  ///@}
  ...
  template <typename AdditionalArtifactsT = Aws::Vector<AdditionalArtifact>>
  ReportDefinition& WithAdditionalArtifacts(AdditionalArtifactsT&& value) {
    SetAdditionalArtifacts(std::forward<AdditionalArtifactsT>(value));
    return *this;
  }
  inline ReportDefinition& AddAdditionalArtifacts(AdditionalArtifact value) {
    m_additionalArtifactsHasBeenSet = true;
    m_additionalArtifacts.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRefreshClosedReports(bool value) {
    m_refreshClosedReportsHasBeenSet = true;
    m_refreshClosedReports = value;
  }
  inline ReportDefinition& WithRefreshClosedReports(bool value) {
    SetRefreshClosedReports(value);
    return *this;
  }
  ///@}
  ...
  inline void SetReportVersioning(ReportVersioning value) {
    m_reportVersioningHasBeenSet = true;
    m_reportVersioning = value;
  }
  inline ReportDefinition& WithReportVersioning(ReportVersioning value) {
    SetReportVersioning(value);
    return *this;
  }
  ///@}
  ...
  template <typename BillingViewArnT = Aws::String>
  ReportDefinition& WithBillingViewArn(BillingViewArnT&& value) {
  ...
  void SetReportStatus(ReportStatusT&& value) {
    m_reportStatusHasBeenSet = true;
    m_reportStatus = std::forward<ReportStatusT>(value);
  }
  template <typename ReportStatusT = ReportStatus>
  ReportDefinition& WithReportStatus(ReportStatusT&& value) {
    SetReportStatus(std::forward<ReportStatusT>(value));
    return *this;
  }
  ///@}
 private:
