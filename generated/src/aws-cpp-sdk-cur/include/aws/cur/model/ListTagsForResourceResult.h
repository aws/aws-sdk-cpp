...
namespace Model
{
  ...
  {
  public:
    AWS_COSTANDUSAGEREPORTSERVICE_API ListTagsForResourceResult() = default;
    AWS_COSTANDUSAGEREPORTSERVICE_API ListTagsForResourceResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_COSTANDUSAGEREPORTSERVICE_API ListTagsForResourceResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
