...
class DescribeReportDefinitionsResult {
 public:
  ...
  AWS_COSTANDUSAGEREPORTSERVICE_API DescribeReportDefinitionsResult& operator=(
  ...
  void SetReportDefinitions(ReportDefinitionsT&& value) {
    m_reportDefinitionsHasBeenSet = true;
    m_reportDefinitions = std::forward<ReportDefinitionsT>(value);
  }
  template <typename ReportDefinitionsT = Aws::Vector<ReportDefinition>>
  DescribeReportDefinitionsResult& WithReportDefinitions(ReportDefinitionsT&& value) {
    SetReportDefinitions(std::forward<ReportDefinitionsT>(value));
    return *this;
  }
  template <typename ReportDefinitionsT = ReportDefinition>
  DescribeReportDefinitionsResult& AddReportDefinitions(ReportDefinitionsT&& value) {
    m_reportDefinitionsHasBeenSet = true;
    m_reportDefinitions.emplace_back(std::forward<ReportDefinitionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeReportDefinitionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeReportDefinitionsResult& WithRequestId(RequestIdT&& value) {
