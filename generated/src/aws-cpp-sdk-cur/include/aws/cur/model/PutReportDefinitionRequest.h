...
class PutReportDefinitionRequest : public CostandUsageReportServiceRequest {
 public:
  ...
  void SetReportDefinition(ReportDefinitionT&& value) {
    m_reportDefinitionHasBeenSet = true;
    m_reportDefinition = std::forward<ReportDefinitionT>(value);
  }
  template <typename ReportDefinitionT = ReportDefinition>
  PutReportDefinitionRequest& WithReportDefinition(ReportDefinitionT&& value) {
    SetReportDefinition(std::forward<ReportDefinitionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  PutReportDefinitionRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  PutReportDefinitionRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
