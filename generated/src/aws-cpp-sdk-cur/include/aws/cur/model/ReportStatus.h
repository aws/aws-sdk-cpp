...
class ReportStatus {
 public:
  ...
  void SetLastDelivery(LastDeliveryT&& value) {
    m_lastDeliveryHasBeenSet = true;
    m_lastDelivery = std::forward<LastDeliveryT>(value);
  }
  template <typename LastDeliveryT = Aws::String>
  ReportStatus& WithLastDelivery(LastDeliveryT&& value) {
    SetLastDelivery(std::forward<LastDeliveryT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetLastStatus(LastStatus value) {
    m_lastStatusHasBeenSet = true;
    m_lastStatus = value;
  }
  inline ReportStatus& WithLastStatus(LastStatus value) {
    SetLastStatus(value);
    return *this;
  }
  ///@}
