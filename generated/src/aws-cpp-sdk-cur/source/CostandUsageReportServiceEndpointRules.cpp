...
{
const size_t CostandUsageReportServiceEndpointRules::RulesBlobStrLen = 3442;
const size_t CostandUsageReportServiceEndpointRules::RulesBlobSize = 3443;
...
'"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','c','u','r','.','{','R','e','g','i','o',
