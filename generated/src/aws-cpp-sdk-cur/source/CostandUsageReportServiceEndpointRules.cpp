...
{
const size_t CostandUsageReportServiceEndpointRules::RulesBlobStrLen = 3712;
const size_t CostandUsageReportServiceEndpointRules::RulesBlobSize = 3713;
...
't','p','s',':','/','/','c','u','r','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i',
