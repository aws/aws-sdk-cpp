...
{
const size_t CostandUsageReportServiceEndpointRules::RulesBlobStrLen = 3460;
const size_t CostandUsageReportServiceEndpointRules::RulesBlobSize = 3461;
...
'"','h','t','t','p','s',':','/','/','c','u','r','-','f','i','p','s','.','{','R','e','g','i','o','n',
...
'c','u','r','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R','e',
...
'h','t','t','p','s',':','/','/','c','u','r','.','{','R','e','g','i','o','n','}','.','{','P','a','r',
...
const char* CostandUsageReportServiceEndpointRules::GetRulesBlob()
{
