...
DescribeRegionsResult::DescribeRegionsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
DescribeRegionsResult& DescribeRegionsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("RegionsDescription")) {
    ...
    for (unsigned regionsDescriptionIndex = 0; regionsDescriptionIndex < regionsDescriptionJsonList.GetLength();
         ++regionsDescriptionIndex) {
