...
HybridUpdateValue::HybridUpdateValue(JsonView jsonValue) { *this = jsonValue; }

HybridUpdateValue& HybridUpdateValue::operator=(JsonView jsonValue) {
...
JsonValue HybridUpdateValue::Jsonize() const {
  JsonValue payload;
