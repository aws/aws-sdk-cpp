...
DescribeClientAuthenticationSettingsResult& DescribeClientAuthenticationSettingsResult::operator=(
  ...
  if (jsonValue.ValueExists("ClientAuthenticationSettingsInfo")) {
    ...
    for (unsigned clientAuthenticationSettingsInfoIndex = 0;
         clientAuthenticationSettingsInfoIndex < clientAuthenticationSettingsInfoJsonList.GetLength();
         ++clientAuthenticationSettingsInfoIndex) {
      m_clientAuthenticationSettingsInfo.push_back(
          clientAuthenticationSettingsInfoJsonList[clientAuthenticationSettingsInfoIndex].AsObject());
    }
