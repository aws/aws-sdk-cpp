...
SettingEntry::SettingEntry(JsonView jsonValue) { *this = jsonValue; }
...
SettingEntry& SettingEntry::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("RequestDetailedStatus")) {
    ...
    for (auto& requestDetailedStatusItem : requestDetailedStatusJsonMap) {
      m_requestDetailedStatus[requestDetailedStatusItem.first] =
          DirectoryConfigurationStatusMapper::GetDirectoryConfigurationStatusForName(requestDetailedStatusItem.second.AsString());
    }
...
JsonValue SettingEntry::Jsonize() const {
  ...
  if (m_requestDetailedStatusHasBeenSet) {
    ...
    for (auto& requestDetailedStatusItem : m_requestDetailedStatus) {
      requestDetailedStatusJsonMap.WithString(
          requestDetailedStatusItem.first,
          DirectoryConfigurationStatusMapper::GetNameForDirectoryConfigurationStatus(requestDetailedStatusItem.second));
    }
