...
HybridSettingsDescription::HybridSettingsDescription(JsonView jsonValue) { *this = jsonValue; }
...
HybridSettingsDescription& HybridSettingsDescription::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("SelfManagedDnsIpAddrs")) {
    ...
    for (unsigned selfManagedDnsIpAddrsIndex = 0; selfManagedDnsIpAddrsIndex < selfManagedDnsIpAddrsJsonList.GetLength();
         ++selfManagedDnsIpAddrsIndex) {
  ...
  if (jsonValue.ValueExists("SelfManagedInstanceIds")) {
    ...
    for (unsigned selfManagedInstanceIdsIndex = 0; selfManagedInstanceIdsIndex < selfManagedInstanceIdsJsonList.GetLength();
         ++selfManagedInstanceIdsIndex) {
