...
DescribeCAEnrollmentPolicyResult::DescribeCAEnrollmentPolicyResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
DescribeCAEnrollmentPolicyResult& DescribeCAEnrollmentPolicyResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("CaEnrollmentPolicyStatus")) {
    m_caEnrollmentPolicyStatus =
        CaEnrollmentPolicyStatusMapper::GetCaEnrollmentPolicyStatusForName(jsonValue.GetString("CaEnrollmentPolicyStatus"));
