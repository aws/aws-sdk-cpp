...
RadiusSettings::RadiusSettings(JsonView jsonValue) { *this = jsonValue; }
...
RadiusSettings& RadiusSettings::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("AuthenticationProtocol")) {
    m_authenticationProtocol =
        RadiusAuthenticationProtocolMapper::GetRadiusAuthenticationProtocolForName(jsonValue.GetString("AuthenticationProtocol"));
...
JsonValue RadiusSettings::Jsonize() const {
  ...
  if (m_authenticationProtocolHasBeenSet) {
    payload.WithString("AuthenticationProtocol",
                       RadiusAuthenticationProtocolMapper::GetNameForRadiusAuthenticationProtocol(m_authenticationProtocol));
  }
