...
class AssessmentReport {
 public:
  ...
  void SetDomainControllerIp(DomainControllerIpT&& value) {
    m_domainControllerIpHasBeenSet = true;
    m_domainControllerIp = std::forward<DomainControllerIpT>(value);
  }
  template <typename DomainControllerIpT = Aws::String>
  AssessmentReport& WithDomainControllerIp(DomainControllerIpT&& value) {
    SetDomainControllerIp(std::forward<DomainControllerIpT>(value));
    return *this;
  }
  ///@}
  ...
  void SetValidations(ValidationsT&& value) {
    ...
    m_validations = std::forward<ValidationsT>(value);
  }
  template <typename ValidationsT = Aws::Vector<AssessmentValidation>>
  AssessmentReport& WithValidations(ValidationsT&& value) {
    SetValidations(std::forward<ValidationsT>(value));
    return *this;
  }
  template <typename ValidationsT = AssessmentValidation>
  AssessmentReport& AddValidations(ValidationsT&& value) {
    m_validationsHasBeenSet = true;
    m_validations.emplace_back(std::forward<ValidationsT>(value));
    return *this;
  }
  ///@}
 private:
