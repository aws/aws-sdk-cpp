...
class RadiusSettings {
 public:
  ...
  void SetRadiusServers(RadiusServersT&& value) {
    ...
    m_radiusServers = std::forward<RadiusServersT>(value);
  }
  template <typename RadiusServersT = Aws::Vector<Aws::String>>
  RadiusSettings& WithRadiusServers(RadiusServersT&& value) {
    SetRadiusServers(std::forward<RadiusServersT>(value));
    return *this;
  }
  template <typename RadiusServersT = Aws::String>
  RadiusSettings& AddRadiusServers(RadiusServersT&& value) {
    m_radiusServersHasBeenSet = true;
    m_radiusServers.emplace_back(std::forward<RadiusServersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRadiusServersIpv6(RadiusServersIpv6T&& value) {
    ...
    m_radiusServersIpv6 = std::forward<RadiusServersIpv6T>(value);
  }
  template <typename RadiusServersIpv6T = Aws::Vector<Aws::String>>
  RadiusSettings& WithRadiusServersIpv6(RadiusServersIpv6T&& value) {
    SetRadiusServersIpv6(std::forward<RadiusServersIpv6T>(value));
    return *this;
  }
  template <typename RadiusServersIpv6T = Aws::String>
  RadiusSettings& AddRadiusServersIpv6(RadiusServersIpv6T&& value) {
    m_radiusServersIpv6HasBeenSet = true;
    m_radiusServersIpv6.emplace_back(std::forward<RadiusServersIpv6T>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetRadiusPort(int value) {
    m_radiusPortHasBeenSet = true;
    m_radiusPort = value;
  }
  inline RadiusSettings& WithRadiusPort(int value) {
    SetRadiusPort(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRadiusTimeout(int value) {
    m_radiusTimeoutHasBeenSet = true;
    m_radiusTimeout = value;
  }
  inline RadiusSettings& WithRadiusTimeout(int value) {
    SetRadiusTimeout(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRadiusRetries(int value) {
    m_radiusRetriesHasBeenSet = true;
    m_radiusRetries = value;
  }
  inline RadiusSettings& WithRadiusRetries(int value) {
    SetRadiusRetries(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAuthenticationProtocol(RadiusAuthenticationProtocol value) {
    m_authenticationProtocolHasBeenSet = true;
    m_authenticationProtocol = value;
  }
  inline RadiusSettings& WithAuthenticationProtocol(RadiusAuthenticationProtocol value) {
    SetAuthenticationProtocol(value);
    return *this;
  }
  ///@}
  ...
  void SetDisplayLabel(DisplayLabelT&& value) {
    ...
    m_displayLabel = std::forward<DisplayLabelT>(value);
  }
  template <typename DisplayLabelT = Aws::String>
  RadiusSettings& WithDisplayLabel(DisplayLabelT&& value) {
    SetDisplayLabel(std::forward<DisplayLabelT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetUseSameUsername(bool value) {
    m_useSameUsernameHasBeenSet = true;
    m_useSameUsername = value;
  }
  inline RadiusSettings& WithUseSameUsername(bool value) {
    SetUseSameUsername(value);
    return *this;
  }
  ///@}
 private:
