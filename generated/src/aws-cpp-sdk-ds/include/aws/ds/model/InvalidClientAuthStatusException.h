...
namespace Model
{
  ...
  {
  public:
    AWS_DIRECTORYSERVICE_API InvalidClientAuthStatusException() = default;
    ...
    template<typename MessageT = Aws::String>
    InvalidClientAuthStatusException& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    InvalidClientAuthStatusException& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
