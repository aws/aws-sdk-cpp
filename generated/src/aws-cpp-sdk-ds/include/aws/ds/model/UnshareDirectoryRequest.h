...
class UnshareDirectoryRequest : public DirectoryServiceRequest {
 public:
  ...
  void SetUnshareTarget(UnshareTargetT&& value) {
    m_unshareTargetHasBeenSet = true;
    m_unshareTarget = std::forward<UnshareTargetT>(value);
  }
  template <typename UnshareTargetT = UnshareTarget>
  UnshareDirectoryRequest& WithUnshareTarget(UnshareTargetT&& value) {
    SetUnshareTarget(std::forward<UnshareTargetT>(value));
    return *this;
  }
  ///@}
 private:
