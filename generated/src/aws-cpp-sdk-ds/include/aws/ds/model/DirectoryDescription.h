...
class DirectoryDescription {
 public:
  ...
  inline DirectoryDescription& WithSize(DirectorySize value) {
    SetSize(value);
    return *this;
  }
  ///@}
  ...
  inline DirectoryDescription& WithEdition(DirectoryEdition value) {
    SetEdition(value);
    return *this;
  }
  ///@}
  ...
  void SetAccessUrl(AccessUrlT&& value) {
    ...
    m_accessUrl = std::forward<AccessUrlT>(value);
  }
  template <typename AccessUrlT = Aws::String>
  DirectoryDescription& WithAccessUrl(AccessUrlT&& value) {
    SetAccessUrl(std::forward<AccessUrlT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStage(DirectoryStage value) {
    m_stageHasBeenSet = true;
    m_stage = value;
  }
  inline DirectoryDescription& WithStage(DirectoryStage value) {
    SetStage(value);
    return *this;
  }
  ///@}
  ...
  inline void SetShareStatus(ShareStatus value) {
    m_shareStatusHasBeenSet = true;
    m_shareStatus = value;
  }
  inline DirectoryDescription& WithShareStatus(ShareStatus value) {
  ...
  inline void SetShareMethod(ShareMethod value) {
    m_shareMethodHasBeenSet = true;
    m_shareMethod = value;
  }
  inline DirectoryDescription& WithShareMethod(ShareMethod value) {
  ...
  void SetShareNotes(ShareNotesT&& value) {
    ...
    m_shareNotes = std::forward<ShareNotesT>(value);
  }
  template <typename ShareNotesT = Aws::String>
  DirectoryDescription& WithShareNotes(ShareNotesT&& value) {
    SetShareNotes(std::forward<ShareNotesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStageLastUpdatedDateTime(StageLastUpdatedDateTimeT&& value) {
    ...
    m_stageLastUpdatedDateTime = std::forward<StageLastUpdatedDateTimeT>(value);
  }
  template <typename StageLastUpdatedDateTimeT = Aws::Utils::DateTime>
  DirectoryDescription& WithStageLastUpdatedDateTime(StageLastUpdatedDateTimeT&& value) {
    SetStageLastUpdatedDateTime(std::forward<StageLastUpdatedDateTimeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetType(DirectoryType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline DirectoryDescription& WithType(DirectoryType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetConnectSettings(ConnectSettingsT&& value) {
    ...
    m_connectSettings = std::forward<ConnectSettingsT>(value);
  }
  template <typename ConnectSettingsT = DirectoryConnectSettingsDescription>
  DirectoryDescription& WithConnectSettings(ConnectSettingsT&& value) {
    SetConnectSettings(std::forward<ConnectSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRadiusSettings(RadiusSettingsT&& value) {
    ...
    m_radiusSettings = std::forward<RadiusSettingsT>(value);
  }
  template <typename RadiusSettingsT = RadiusSettings>
  DirectoryDescription& WithRadiusSettings(RadiusSettingsT&& value) {
    SetRadiusSettings(std::forward<RadiusSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetRadiusStatus(RadiusStatus value) {
    m_radiusStatusHasBeenSet = true;
    m_radiusStatus = value;
  }
  inline DirectoryDescription& WithRadiusStatus(RadiusStatus value) {
    SetRadiusStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetStageReason(StageReasonT&& value) {
    ...
    m_stageReason = std::forward<StageReasonT>(value);
  }
  template <typename StageReasonT = Aws::String>
  DirectoryDescription& WithStageReason(StageReasonT&& value) {
    SetStageReason(std::forward<StageReasonT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetSsoEnabled(bool value) {
    m_ssoEnabledHasBeenSet = true;
    m_ssoEnabled = value;
  }
  inline DirectoryDescription& WithSsoEnabled(bool value) {
    SetSsoEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline DirectoryDescription& WithDesiredNumberOfDomainControllers(int value) {
  ...
  void SetOwnerDirectoryDescription(OwnerDirectoryDescriptionT&& value) {
    ...
    m_ownerDirectoryDescription = std::forward<OwnerDirectoryDescriptionT>(value);
  }
  template <typename OwnerDirectoryDescriptionT = OwnerDirectoryDescription>
  DirectoryDescription& WithOwnerDirectoryDescription(OwnerDirectoryDescriptionT&& value) {
    SetOwnerDirectoryDescription(std::forward<OwnerDirectoryDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRegionsInfo(RegionsInfoT&& value) {
    ...
    m_regionsInfo = std::forward<RegionsInfoT>(value);
  }
  template <typename RegionsInfoT = RegionsInfo>
  DirectoryDescription& WithRegionsInfo(RegionsInfoT&& value) {
    SetRegionsInfo(std::forward<RegionsInfoT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetOsVersion(OSVersion value) {
    m_osVersionHasBeenSet = true;
    m_osVersion = value;
  }
  inline DirectoryDescription& WithOsVersion(OSVersion value) {
    SetOsVersion(value);
    return *this;
  }
  ///@}
  ...
  void SetHybridSettings(HybridSettingsT&& value) {
    ...
    m_hybridSettings = std::forward<HybridSettingsT>(value);
  }
  template <typename HybridSettingsT = HybridSettingsDescription>
  DirectoryDescription& WithHybridSettings(HybridSettingsT&& value) {
    SetHybridSettings(std::forward<HybridSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  inline DirectoryDescription& WithNetworkType(NetworkType value) {
