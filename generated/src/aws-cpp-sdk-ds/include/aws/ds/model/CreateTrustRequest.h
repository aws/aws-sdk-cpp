...
class CreateTrustRequest : public DirectoryServiceRequest {
 public:
  ...
  void SetTrustPassword(TrustPasswordT&& value) {
    m_trustPasswordHasBeenSet = true;
    m_trustPassword = std::forward<TrustPasswordT>(value);
  }
  template <typename TrustPasswordT = Aws::String>
  CreateTrustRequest& WithTrustPassword(TrustPasswordT&& value) {
    SetTrustPassword(std::forward<TrustPasswordT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTrustDirection(TrustDirection value) {
    m_trustDirectionHasBeenSet = true;
    m_trustDirection = value;
  }
  inline CreateTrustRequest& WithTrustDirection(TrustDirection value) {
    SetTrustDirection(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTrustType(TrustType value) {
    m_trustTypeHasBeenSet = true;
    m_trustType = value;
  }
  inline CreateTrustRequest& WithTrustType(TrustType value) {
    SetTrustType(value);
    return *this;
  }
  ///@}
  ...
  void SetConditionalForwarderIpAddrs(ConditionalForwarderIpAddrsT&& value) {
    m_conditionalForwarderIpAddrsHasBeenSet = true;
    m_conditionalForwarderIpAddrs = std::forward<ConditionalForwarderIpAddrsT>(value);
  }
  template <typename ConditionalForwarderIpAddrsT = Aws::Vector<Aws::String>>
  CreateTrustRequest& WithConditionalForwarderIpAddrs(ConditionalForwarderIpAddrsT&& value) {
    SetConditionalForwarderIpAddrs(std::forward<ConditionalForwarderIpAddrsT>(value));
    return *this;
  }
  ...
  CreateTrustRequest& AddConditionalForwarderIpAddrs(ConditionalForwarderIpAddrsT&& value) {
    m_conditionalForwarderIpAddrsHasBeenSet = true;
    m_conditionalForwarderIpAddrs.emplace_back(std::forward<ConditionalForwarderIpAddrsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetConditionalForwarderIpv6Addrs(ConditionalForwarderIpv6AddrsT&& value) {
    m_conditionalForwarderIpv6AddrsHasBeenSet = true;
    m_conditionalForwarderIpv6Addrs = std::forward<ConditionalForwarderIpv6AddrsT>(value);
  }
  template <typename ConditionalForwarderIpv6AddrsT = Aws::Vector<Aws::String>>
  CreateTrustRequest& WithConditionalForwarderIpv6Addrs(ConditionalForwarderIpv6AddrsT&& value) {
    SetConditionalForwarderIpv6Addrs(std::forward<ConditionalForwarderIpv6AddrsT>(value));
    return *this;
  }
  ...
  CreateTrustRequest& AddConditionalForwarderIpv6Addrs(ConditionalForwarderIpv6AddrsT&& value) {
    m_conditionalForwarderIpv6AddrsHasBeenSet = true;
    m_conditionalForwarderIpv6Addrs.emplace_back(std::forward<ConditionalForwarderIpv6AddrsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetSelectiveAuth(SelectiveAuth value) {
    m_selectiveAuthHasBeenSet = true;
    m_selectiveAuth = value;
  }
  inline CreateTrustRequest& WithSelectiveAuth(SelectiveAuth value) {
    SetSelectiveAuth(value);
    return *this;
  }
  ///@}
 private:
