...
class Computer {
 public:
  ...
  void SetComputerId(ComputerIdT&& value) {
    ...
    m_computerId = std::forward<ComputerIdT>(value);
  }
  template <typename ComputerIdT = Aws::String>
  Computer& WithComputerId(ComputerIdT&& value) {
    SetComputerId(std::forward<ComputerIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetComputerAttributes(ComputerAttributesT&& value) {
    ...
    m_computerAttributes = std::forward<ComputerAttributesT>(value);
  }
  template <typename ComputerAttributesT = Aws::Vector<Attribute>>
  Computer& WithComputerAttributes(ComputerAttributesT&& value) {
    SetComputerAttributes(std::forward<ComputerAttributesT>(value));
    return *this;
  }
  template <typename ComputerAttributesT = Attribute>
  Computer& AddComputerAttributes(ComputerAttributesT&& value) {
    m_computerAttributesHasBeenSet = true;
    m_computerAttributes.emplace_back(std::forward<ComputerAttributesT>(value));
    return *this;
  }
  ///@}
 private:
