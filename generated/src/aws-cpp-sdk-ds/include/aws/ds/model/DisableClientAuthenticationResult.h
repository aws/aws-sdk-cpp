...
namespace Model
{
  ...
  public:
    ...
    inline DisableClientAuthenticationResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DisableClientAuthenticationResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DisableClientAuthenticationResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
