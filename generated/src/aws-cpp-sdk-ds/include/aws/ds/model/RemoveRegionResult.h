...
namespace Model
{
  ...
  {
  public:
    AWS_DIRECTORYSERVICE_API RemoveRegionResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    RemoveRegionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
