...
namespace Model
{
  ...
  public:
    ...
    inline RemoveRegionResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline RemoveRegionResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline RemoveRegionResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
