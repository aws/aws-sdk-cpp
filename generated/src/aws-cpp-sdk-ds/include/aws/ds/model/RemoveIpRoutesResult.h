...
namespace Model
{
  ...
  {
  public:
    AWS_DIRECTORYSERVICE_API RemoveIpRoutesResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    RemoveIpRoutesResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
