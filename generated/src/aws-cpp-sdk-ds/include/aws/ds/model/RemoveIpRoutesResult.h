...
namespace Model
{
  ...
  public:
    ...
    inline RemoveIpRoutesResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline RemoveIpRoutesResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline RemoveIpRoutesResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
