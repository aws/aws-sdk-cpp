...
namespace Model
{
  ...
  {
  public:
    AWS_DIRECTORYSERVICE_API CreateMicrosoftADResult();
    AWS_DIRECTORYSERVICE_API CreateMicrosoftADResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_DIRECTORYSERVICE_API CreateMicrosoftADResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ...
    inline CreateMicrosoftADResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline CreateMicrosoftADResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline CreateMicrosoftADResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
