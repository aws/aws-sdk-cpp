...
class GetDirectoryLimitsResult {
 public:
  ...
  void SetDirectoryLimits(DirectoryLimitsT&& value) {
    m_directoryLimitsHasBeenSet = true;
    m_directoryLimits = std::forward<DirectoryLimitsT>(value);
  }
  template <typename DirectoryLimitsT = DirectoryLimits>
  GetDirectoryLimitsResult& WithDirectoryLimits(DirectoryLimitsT&& value) {
    SetDirectoryLimits(std::forward<DirectoryLimitsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetDirectoryLimitsResult& WithRequestId(RequestIdT&& value) {
