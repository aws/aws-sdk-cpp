...
class CreateHybridADRequest : public DirectoryServiceRequest {
 public:
  ...
  template <typename SecretArnT = Aws::String>
  CreateHybridADRequest& WithSecretArn(SecretArnT&& value) {
  ...
  template <typename AssessmentIdT = Aws::String>
  CreateHybridADRequest& WithAssessmentId(AssessmentIdT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateHybridADRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateHybridADRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
