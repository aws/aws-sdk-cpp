...
namespace Model
{
  ...
  {
  public:
    AWS_DIRECTORYSERVICE_API AddIpRoutesResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    AddIpRoutesResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
