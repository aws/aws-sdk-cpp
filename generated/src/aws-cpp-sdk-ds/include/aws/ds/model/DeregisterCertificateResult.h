...
namespace Model
{
  ...
  {
  public:
    AWS_DIRECTORYSERVICE_API DeregisterCertificateResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeregisterCertificateResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
