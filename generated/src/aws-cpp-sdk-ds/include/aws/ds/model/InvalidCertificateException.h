...
namespace Model
{
  ...
  {
  public:
    AWS_DIRECTORYSERVICE_API InvalidCertificateException() = default;
    ...
    template<typename MessageT = Aws::String>
    InvalidCertificateException& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    InvalidCertificateException& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
