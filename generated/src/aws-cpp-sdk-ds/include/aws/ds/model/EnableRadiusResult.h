...
namespace Model
{
  ...
  public:
    ...
    inline EnableRadiusResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline EnableRadiusResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline EnableRadiusResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
