...
namespace Model
{
  ...
  {
  public:
    AWS_DIRECTORYSERVICE_API EnableRadiusResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    EnableRadiusResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
