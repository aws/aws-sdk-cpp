...
class HybridSettingsDescription {
 public:
  ...
  void SetSelfManagedDnsIpAddrs(SelfManagedDnsIpAddrsT&& value) {
    m_selfManagedDnsIpAddrsHasBeenSet = true;
    m_selfManagedDnsIpAddrs = std::forward<SelfManagedDnsIpAddrsT>(value);
  }
  template <typename SelfManagedDnsIpAddrsT = Aws::Vector<Aws::String>>
  HybridSettingsDescription& WithSelfManagedDnsIpAddrs(SelfManagedDnsIpAddrsT&& value) {
    SetSelfManagedDnsIpAddrs(std::forward<SelfManagedDnsIpAddrsT>(value));
    return *this;
  }
  template <typename SelfManagedDnsIpAddrsT = Aws::String>
  HybridSettingsDescription& AddSelfManagedDnsIpAddrs(SelfManagedDnsIpAddrsT&& value) {
    m_selfManagedDnsIpAddrsHasBeenSet = true;
    m_selfManagedDnsIpAddrs.emplace_back(std::forward<SelfManagedDnsIpAddrsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename SelfManagedInstanceIdsT = Aws::Vector<Aws::String>>
  HybridSettingsDescription& WithSelfManagedInstanceIds(SelfManagedInstanceIdsT&& value) {
    SetSelfManagedInstanceIds(std::forward<SelfManagedInstanceIdsT>(value));
    return *this;
  }
  template <typename SelfManagedInstanceIdsT = Aws::String>
  HybridSettingsDescription& AddSelfManagedInstanceIds(SelfManagedInstanceIdsT&& value) {
    m_selfManagedInstanceIdsHasBeenSet = true;
