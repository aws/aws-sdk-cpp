...
class ShareDirectoryRequest : public DirectoryServiceRequest {
 public:
  ...
  template <typename DirectoryIdT = Aws::String>
  ShareDirectoryRequest& WithDirectoryId(DirectoryIdT&& value) {
  ...
  template <typename ShareNotesT = Aws::String>
  ShareDirectoryRequest& WithShareNotes(ShareNotesT&& value) {
  ...
  void SetShareTarget(ShareTargetT&& value) {
    m_shareTargetHasBeenSet = true;
    m_shareTarget = std::forward<ShareTargetT>(value);
  }
  template <typename ShareTargetT = ShareTarget>
  ShareDirectoryRequest& WithShareTarget(ShareTargetT&& value) {
    SetShareTarget(std::forward<ShareTargetT>(value));
    return *this;
  }
  ///@}
  ...
  inline ShareDirectoryRequest& WithShareMethod(ShareMethod value) {
