...
class SchemaExtensionInfo {
 public:
  ...
  inline void SetSchemaExtensionStatus(SchemaExtensionStatus value) {
    m_schemaExtensionStatusHasBeenSet = true;
    m_schemaExtensionStatus = value;
  }
  inline SchemaExtensionInfo& WithSchemaExtensionStatus(SchemaExtensionStatus value) {
    SetSchemaExtensionStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetSchemaExtensionStatusReason(SchemaExtensionStatusReasonT&& value) {
    ...
    m_schemaExtensionStatusReason = std::forward<SchemaExtensionStatusReasonT>(value);
  }
  template <typename SchemaExtensionStatusReasonT = Aws::String>
  SchemaExtensionInfo& WithSchemaExtensionStatusReason(SchemaExtensionStatusReasonT&& value) {
    SetSchemaExtensionStatusReason(std::forward<SchemaExtensionStatusReasonT>(value));
    return *this;
  }
  ///@}
