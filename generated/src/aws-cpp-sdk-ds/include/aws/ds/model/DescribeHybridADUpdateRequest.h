...
class DescribeHybridADUpdateRequest : public DirectoryServiceRequest {
 public:
  ...
  template <typename DirectoryIdT = Aws::String>
  DescribeHybridADUpdateRequest& WithDirectoryId(DirectoryIdT&& value) {
  ...
  inline void SetUpdateType(HybridUpdateType value) {
    m_updateTypeHasBeenSet = true;
    m_updateType = value;
  }
  inline DescribeHybridADUpdateRequest& WithUpdateType(HybridUpdateType value) {
    SetUpdateType(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeHybridADUpdateRequest& WithNextToken(NextTokenT&& value) {
