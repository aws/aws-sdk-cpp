...
class ListCertificatesResult {
 public:
  ...
  void SetCertificatesInfo(CertificatesInfoT&& value) {
    m_certificatesInfoHasBeenSet = true;
    m_certificatesInfo = std::forward<CertificatesInfoT>(value);
  }
  template <typename CertificatesInfoT = Aws::Vector<CertificateInfo>>
  ListCertificatesResult& WithCertificatesInfo(CertificatesInfoT&& value) {
    SetCertificatesInfo(std::forward<CertificatesInfoT>(value));
    return *this;
  }
  template <typename CertificatesInfoT = CertificateInfo>
  ListCertificatesResult& AddCertificatesInfo(CertificatesInfoT&& value) {
    m_certificatesInfoHasBeenSet = true;
    m_certificatesInfo.emplace_back(std::forward<CertificatesInfoT>(value));
    return *this;
  }
  ///@}
