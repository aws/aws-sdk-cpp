...
namespace Model
{
  ...
  {
  public:
    AWS_DIRECTORYSERVICE_API UnsupportedSettingsException() = default;
    ...
    template<typename MessageT = Aws::String>
    UnsupportedSettingsException& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UnsupportedSettingsException& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
