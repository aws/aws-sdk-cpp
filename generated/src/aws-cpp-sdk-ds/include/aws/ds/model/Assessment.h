...
class Assessment {
 public:
  ...
  void SetCustomerDnsIps(CustomerDnsIpsT&& value) {
    ...
    m_customerDnsIps = std::forward<CustomerDnsIpsT>(value);
  }
  template <typename CustomerDnsIpsT = Aws::Vector<Aws::String>>
  Assessment& WithCustomerDnsIps(CustomerDnsIpsT&& value) {
    SetCustomerDnsIps(std::forward<CustomerDnsIpsT>(value));
    return *this;
  }
  template <typename CustomerDnsIpsT = Aws::String>
  Assessment& AddCustomerDnsIps(CustomerDnsIpsT&& value) {
    m_customerDnsIpsHasBeenSet = true;
    m_customerDnsIps.emplace_back(std::forward<CustomerDnsIpsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSelfManagedInstanceIds(SelfManagedInstanceIdsT&& value) {
    ...
    m_selfManagedInstanceIds = std::forward<SelfManagedInstanceIdsT>(value);
  }
  template <typename SelfManagedInstanceIdsT = Aws::Vector<Aws::String>>
  Assessment& WithSelfManagedInstanceIds(SelfManagedInstanceIdsT&& value) {
    SetSelfManagedInstanceIds(std::forward<SelfManagedInstanceIdsT>(value));
    return *this;
  }
  template <typename SelfManagedInstanceIdsT = Aws::String>
  Assessment& AddSelfManagedInstanceIds(SelfManagedInstanceIdsT&& value) {
    m_selfManagedInstanceIdsHasBeenSet = true;
    m_selfManagedInstanceIds.emplace_back(std::forward<SelfManagedInstanceIdsT>(value));
    return *this;
  }
  ///@}
