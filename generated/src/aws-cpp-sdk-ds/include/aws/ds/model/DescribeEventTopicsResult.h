...
class DescribeEventTopicsResult {
 public:
  ...
  void SetEventTopics(EventTopicsT&& value) {
    m_eventTopicsHasBeenSet = true;
    m_eventTopics = std::forward<EventTopicsT>(value);
  }
  template <typename EventTopicsT = Aws::Vector<EventTopic>>
  DescribeEventTopicsResult& WithEventTopics(EventTopicsT&& value) {
    SetEventTopics(std::forward<EventTopicsT>(value));
    return *this;
  }
  template <typename EventTopicsT = EventTopic>
  DescribeEventTopicsResult& AddEventTopics(EventTopicsT&& value) {
    m_eventTopicsHasBeenSet = true;
    m_eventTopics.emplace_back(std::forward<EventTopicsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeEventTopicsResult& WithRequestId(RequestIdT&& value) {
