...
class RegionsInfo {
 public:
  ...
  void SetAdditionalRegions(AdditionalRegionsT&& value) {
    ...
    m_additionalRegions = std::forward<AdditionalRegionsT>(value);
  }
  template <typename AdditionalRegionsT = Aws::Vector<Aws::String>>
  RegionsInfo& WithAdditionalRegions(AdditionalRegionsT&& value) {
    SetAdditionalRegions(std::forward<AdditionalRegionsT>(value));
    return *this;
  }
  template <typename AdditionalRegionsT = Aws::String>
  RegionsInfo& AddAdditionalRegions(AdditionalRegionsT&& value) {
    m_additionalRegionsHasBeenSet = true;
    m_additionalRegions.emplace_back(std::forward<AdditionalRegionsT>(value));
    return *this;
  }
  ///@}
 private:
