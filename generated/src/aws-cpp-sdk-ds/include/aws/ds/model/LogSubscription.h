...
class LogSubscription {
 public:
  ...
  void SetSubscriptionCreatedDateTime(SubscriptionCreatedDateTimeT&& value) {
    ...
    m_subscriptionCreatedDateTime = std::forward<SubscriptionCreatedDateTimeT>(value);
  }
  template <typename SubscriptionCreatedDateTimeT = Aws::Utils::DateTime>
  LogSubscription& WithSubscriptionCreatedDateTime(SubscriptionCreatedDateTimeT&& value) {
    SetSubscriptionCreatedDateTime(std::forward<SubscriptionCreatedDateTimeT>(value));
    return *this;
  }
  ///@}
 private:
