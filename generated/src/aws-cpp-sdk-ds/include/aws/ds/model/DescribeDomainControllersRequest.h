...
class DescribeDomainControllersRequest : public DirectoryServiceRequest {
 public:
  ...
  void SetDomainControllerIds(DomainControllerIdsT&& value) {
    m_domainControllerIdsHasBeenSet = true;
    m_domainControllerIds = std::forward<DomainControllerIdsT>(value);
  }
  template <typename DomainControllerIdsT = Aws::Vector<Aws::String>>
  DescribeDomainControllersRequest& WithDomainControllerIds(DomainControllerIdsT&& value) {
    SetDomainControllerIds(std::forward<DomainControllerIdsT>(value));
    return *this;
  }
  ...
  DescribeDomainControllersRequest& AddDomainControllerIds(DomainControllerIdsT&& value) {
    m_domainControllerIdsHasBeenSet = true;
    m_domainControllerIds.emplace_back(std::forward<DomainControllerIdsT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeDomainControllersRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
