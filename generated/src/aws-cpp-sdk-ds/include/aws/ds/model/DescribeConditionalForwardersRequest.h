...
class DescribeConditionalForwardersRequest : public DirectoryServiceRequest {
 public:
  ...
  template <typename DirectoryIdT = Aws::String>
  DescribeConditionalForwardersRequest& WithDirectoryId(DirectoryIdT&& value) {
  ...
  void SetRemoteDomainNames(RemoteDomainNamesT&& value) {
    m_remoteDomainNamesHasBeenSet = true;
    m_remoteDomainNames = std::forward<RemoteDomainNamesT>(value);
  }
  template <typename RemoteDomainNamesT = Aws::Vector<Aws::String>>
  DescribeConditionalForwardersRequest& WithRemoteDomainNames(RemoteDomainNamesT&& value) {
    SetRemoteDomainNames(std::forward<RemoteDomainNamesT>(value));
    return *this;
  }
  template <typename RemoteDomainNamesT = Aws::String>
  DescribeConditionalForwardersRequest& AddRemoteDomainNames(RemoteDomainNamesT&& value) {
    m_remoteDomainNamesHasBeenSet = true;
    m_remoteDomainNames.emplace_back(std::forward<RemoteDomainNamesT>(value));
    return *this;
  }
  ///@}
 private:
