...
class ListLogSubscriptionsRequest : public DirectoryServiceRequest {
 public:
  AWS_DIRECTORYSERVICE_API ListLogSubscriptionsRequest() = default;
  ...
  template <typename DirectoryIdT = Aws::String>
  ListLogSubscriptionsRequest& WithDirectoryId(DirectoryIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListLogSubscriptionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListLogSubscriptionsRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
