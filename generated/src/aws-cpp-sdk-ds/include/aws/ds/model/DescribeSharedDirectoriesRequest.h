...
class DescribeSharedDirectoriesRequest : public DirectoryServiceRequest {
 public:
  ...
  void SetOwnerDirectoryId(OwnerDirectoryIdT&& value) {
    ...
    m_ownerDirectoryId = std::forward<OwnerDirectoryIdT>(value);
  }
  template <typename OwnerDirectoryIdT = Aws::String>
  DescribeSharedDirectoriesRequest& WithOwnerDirectoryId(OwnerDirectoryIdT&& value) {
    SetOwnerDirectoryId(std::forward<OwnerDirectoryIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSharedDirectoryIds(SharedDirectoryIdsT&& value) {
    m_sharedDirectoryIdsHasBeenSet = true;
    m_sharedDirectoryIds = std::forward<SharedDirectoryIdsT>(value);
  }
  template <typename SharedDirectoryIdsT = Aws::Vector<Aws::String>>
  DescribeSharedDirectoriesRequest& WithSharedDirectoryIds(SharedDirectoryIdsT&& value) {
    SetSharedDirectoryIds(std::forward<SharedDirectoryIdsT>(value));
    return *this;
  }
  template <typename SharedDirectoryIdsT = Aws::String>
  DescribeSharedDirectoriesRequest& AddSharedDirectoryIds(SharedDirectoryIdsT&& value) {
    m_sharedDirectoryIdsHasBeenSet = true;
    m_sharedDirectoryIds.emplace_back(std::forward<SharedDirectoryIdsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeSharedDirectoriesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeSharedDirectoriesRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
