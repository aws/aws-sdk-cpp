...
class CreateConditionalForwarderResult {
 public:
  AWS_DIRECTORYSERVICE_API CreateConditionalForwarderResult() = default;
  ...
  AWS_DIRECTORYSERVICE_API CreateConditionalForwarderResult& operator=(
  ...
  template <typename RequestIdT = Aws::String>
  CreateConditionalForwarderResult& WithRequestId(RequestIdT&& value) {
