...
namespace Model
{
  ...
  public:
    ...
    inline CreateConditionalForwarderResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline CreateConditionalForwarderResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline CreateConditionalForwarderResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
