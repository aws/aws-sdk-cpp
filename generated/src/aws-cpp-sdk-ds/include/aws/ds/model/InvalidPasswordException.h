...
namespace Model
{
  ...
  public:
    ...
    template<typename MessageT = Aws::String>
    InvalidPasswordException& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    InvalidPasswordException& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
