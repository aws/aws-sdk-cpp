...
class AcceptSharedDirectoryResult {
 public:
  ...
  void SetSharedDirectory(SharedDirectoryT&& value) {
    m_sharedDirectoryHasBeenSet = true;
    m_sharedDirectory = std::forward<SharedDirectoryT>(value);
  }
  template <typename SharedDirectoryT = SharedDirectory>
  AcceptSharedDirectoryResult& WithSharedDirectory(SharedDirectoryT&& value) {
    SetSharedDirectory(std::forward<SharedDirectoryT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  AcceptSharedDirectoryResult& WithRequestId(RequestIdT&& value) {
