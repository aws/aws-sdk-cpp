...
class CreateLogSubscriptionRequest : public DirectoryServiceRequest {
 public:
  AWS_DIRECTORYSERVICE_API CreateLogSubscriptionRequest() = default;
  ...
  template <typename DirectoryIdT = Aws::String>
  CreateLogSubscriptionRequest& WithDirectoryId(DirectoryIdT&& value) {
  ...
  template <typename LogGroupNameT = Aws::String>
  CreateLogSubscriptionRequest& WithLogGroupName(LogGroupNameT&& value) {
