...
namespace Model
{
  ...
  {
  public:
    AWS_DIRECTORYSERVICE_API DirectoryInDesiredStateException() = default;
    ...
    template<typename MessageT = Aws::String>
    DirectoryInDesiredStateException& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DirectoryInDesiredStateException& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
