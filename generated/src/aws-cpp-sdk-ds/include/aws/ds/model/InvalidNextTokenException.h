...
namespace Model
{
  ...
  {
  public:
    AWS_DIRECTORYSERVICE_API InvalidNextTokenException() = default;
    ...
    template<typename MessageT = Aws::String>
    InvalidNextTokenException& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    InvalidNextTokenException& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
