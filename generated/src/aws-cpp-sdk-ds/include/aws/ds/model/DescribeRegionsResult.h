...
class DescribeRegionsResult {
 public:
  ...
  void SetRegionsDescription(RegionsDescriptionT&& value) {
    m_regionsDescriptionHasBeenSet = true;
    m_regionsDescription = std::forward<RegionsDescriptionT>(value);
  }
  template <typename RegionsDescriptionT = Aws::Vector<RegionDescription>>
  DescribeRegionsResult& WithRegionsDescription(RegionsDescriptionT&& value) {
    SetRegionsDescription(std::forward<RegionsDescriptionT>(value));
    return *this;
  }
  template <typename RegionsDescriptionT = RegionDescription>
  DescribeRegionsResult& AddRegionsDescription(RegionsDescriptionT&& value) {
    m_regionsDescriptionHasBeenSet = true;
    m_regionsDescription.emplace_back(std::forward<RegionsDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeRegionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeRegionsResult& WithRequestId(RequestIdT&& value) {
