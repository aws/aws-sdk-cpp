...
namespace Model
{
  ...
  {
  public:
    AWS_DIRECTORYSERVICE_API SnapshotLimitExceededException() = default;
    ...
    template<typename MessageT = Aws::String>
    SnapshotLimitExceededException& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    SnapshotLimitExceededException& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
