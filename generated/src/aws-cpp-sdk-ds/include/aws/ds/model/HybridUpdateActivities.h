...
class HybridUpdateActivities {
 public:
  ...
  void SetSelfManagedInstances(SelfManagedInstancesT&& value) {
    ...
    m_selfManagedInstances = std::forward<SelfManagedInstancesT>(value);
  }
  template <typename SelfManagedInstancesT = Aws::Vector<HybridUpdateInfoEntry>>
  HybridUpdateActivities& WithSelfManagedInstances(SelfManagedInstancesT&& value) {
    SetSelfManagedInstances(std::forward<SelfManagedInstancesT>(value));
    return *this;
  }
  ...
  HybridUpdateActivities& AddSelfManagedInstances(SelfManagedInstancesT&& value) {
    m_selfManagedInstancesHasBeenSet = true;
    m_selfManagedInstances.emplace_back(std::forward<SelfManagedInstancesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetHybridAdministratorAccount(HybridAdministratorAccountT&& value) {
    ...
    m_hybridAdministratorAccount = std::forward<HybridAdministratorAccountT>(value);
  }
  template <typename HybridAdministratorAccountT = Aws::Vector<HybridUpdateInfoEntry>>
  HybridUpdateActivities& WithHybridAdministratorAccount(HybridAdministratorAccountT&& value) {
    SetHybridAdministratorAccount(std::forward<HybridAdministratorAccountT>(value));
    return *this;
  }
  ...
  HybridUpdateActivities& AddHybridAdministratorAccount(HybridAdministratorAccountT&& value) {
    m_hybridAdministratorAccountHasBeenSet = true;
    m_hybridAdministratorAccount.emplace_back(std::forward<HybridAdministratorAccountT>(value));
    return *this;
  }
  ///@}
 private:
