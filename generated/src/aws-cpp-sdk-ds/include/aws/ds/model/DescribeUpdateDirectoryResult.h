...
class DescribeUpdateDirectoryResult {
 public:
  ...
  void SetUpdateActivities(UpdateActivitiesT&& value) {
    m_updateActivitiesHasBeenSet = true;
    m_updateActivities = std::forward<UpdateActivitiesT>(value);
  }
  template <typename UpdateActivitiesT = Aws::Vector<UpdateInfoEntry>>
  DescribeUpdateDirectoryResult& WithUpdateActivities(UpdateActivitiesT&& value) {
    SetUpdateActivities(std::forward<UpdateActivitiesT>(value));
    return *this;
  }
  template <typename UpdateActivitiesT = UpdateInfoEntry>
  DescribeUpdateDirectoryResult& AddUpdateActivities(UpdateActivitiesT&& value) {
    m_updateActivitiesHasBeenSet = true;
    m_updateActivities.emplace_back(std::forward<UpdateActivitiesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeUpdateDirectoryResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeUpdateDirectoryResult& WithRequestId(RequestIdT&& value) {
