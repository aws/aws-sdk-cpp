...
class DescribeLDAPSSettingsResult {
 public:
  ...
  void SetLDAPSSettingsInfo(LDAPSSettingsInfoT&& value) {
    m_lDAPSSettingsInfoHasBeenSet = true;
    m_lDAPSSettingsInfo = std::forward<LDAPSSettingsInfoT>(value);
  }
  template <typename LDAPSSettingsInfoT = Aws::Vector<LDAPSSettingInfo>>
  DescribeLDAPSSettingsResult& WithLDAPSSettingsInfo(LDAPSSettingsInfoT&& value) {
    SetLDAPSSettingsInfo(std::forward<LDAPSSettingsInfoT>(value));
    return *this;
  }
  template <typename LDAPSSettingsInfoT = LDAPSSettingInfo>
  DescribeLDAPSSettingsResult& AddLDAPSSettingsInfo(LDAPSSettingsInfoT&& value) {
    m_lDAPSSettingsInfoHasBeenSet = true;
    m_lDAPSSettingsInfo.emplace_back(std::forward<LDAPSSettingsInfoT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeLDAPSSettingsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeLDAPSSettingsResult& WithRequestId(RequestIdT&& value) {
