...
namespace Model
{
  ...
  public:
    ...
    inline DeregisterEventTopicResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeregisterEventTopicResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeregisterEventTopicResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
