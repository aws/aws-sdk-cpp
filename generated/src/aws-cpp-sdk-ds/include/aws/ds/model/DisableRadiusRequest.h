...
namespace Model
{
  ...
  {
  public:
    AWS_DIRECTORYSERVICE_API DisableRadiusRequest() = default;
    ...
    template<typename DirectoryIdT = Aws::String>
    DisableRadiusRequest& WithDirectoryId(DirectoryIdT&& value) { SetDirectoryId(std::forward<DirectoryIdT>(value)); return *this;}
    ///@}
  private:
