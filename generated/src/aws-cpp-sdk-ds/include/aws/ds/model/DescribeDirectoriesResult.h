...
class DescribeDirectoriesResult {
 public:
  ...
  void SetDirectoryDescriptions(DirectoryDescriptionsT&& value) {
    m_directoryDescriptionsHasBeenSet = true;
    m_directoryDescriptions = std::forward<DirectoryDescriptionsT>(value);
  }
  template <typename DirectoryDescriptionsT = Aws::Vector<DirectoryDescription>>
  DescribeDirectoriesResult& WithDirectoryDescriptions(DirectoryDescriptionsT&& value) {
    SetDirectoryDescriptions(std::forward<DirectoryDescriptionsT>(value));
    return *this;
  }
  template <typename DirectoryDescriptionsT = DirectoryDescription>
  DescribeDirectoriesResult& AddDirectoryDescriptions(DirectoryDescriptionsT&& value) {
    m_directoryDescriptionsHasBeenSet = true;
    m_directoryDescriptions.emplace_back(std::forward<DirectoryDescriptionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeDirectoriesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeDirectoriesResult& WithRequestId(RequestIdT&& value) {
