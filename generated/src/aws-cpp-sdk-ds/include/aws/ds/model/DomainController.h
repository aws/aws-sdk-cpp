...
class DomainController {
 public:
  ...
  void SetDomainControllerId(DomainControllerIdT&& value) {
    ...
    m_domainControllerId = std::forward<DomainControllerIdT>(value);
  }
  template <typename DomainControllerIdT = Aws::String>
  DomainController& WithDomainControllerId(DomainControllerIdT&& value) {
    SetDomainControllerId(std::forward<DomainControllerIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDnsIpAddr(DnsIpAddrT&& value) {
    ...
    m_dnsIpAddr = std::forward<DnsIpAddrT>(value);
  }
  template <typename DnsIpAddrT = Aws::String>
  DomainController& WithDnsIpAddr(DnsIpAddrT&& value) {
    SetDnsIpAddr(std::forward<DnsIpAddrT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDnsIpv6Addr(DnsIpv6AddrT&& value) {
    ...
    m_dnsIpv6Addr = std::forward<DnsIpv6AddrT>(value);
  }
  template <typename DnsIpv6AddrT = Aws::String>
  DomainController& WithDnsIpv6Addr(DnsIpv6AddrT&& value) {
    SetDnsIpv6Addr(std::forward<DnsIpv6AddrT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(DomainControllerStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline DomainController& WithStatus(DomainControllerStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
