...
namespace Model
{
  ...
  {
  public:
    AWS_DIRECTORYSERVICE_API DirectoryLimitExceededException() = default;
    ...
    template<typename MessageT = Aws::String>
    DirectoryLimitExceededException& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DirectoryLimitExceededException& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
