...
class EnableCAEnrollmentPolicyRequest : public DirectoryServiceRequest {
 public:
  ...
  template <typename DirectoryIdT = Aws::String>
  EnableCAEnrollmentPolicyRequest& WithDirectoryId(DirectoryIdT&& value) {
  ...
  void SetPcaConnectorArn(PcaConnectorArnT&& value) {
    m_pcaConnectorArnHasBeenSet = true;
    m_pcaConnectorArn = std::forward<PcaConnectorArnT>(value);
  }
  template <typename PcaConnectorArnT = Aws::String>
  EnableCAEnrollmentPolicyRequest& WithPcaConnectorArn(PcaConnectorArnT&& value) {
    SetPcaConnectorArn(std::forward<PcaConnectorArnT>(value));
    return *this;
  }
  ///@}
 private:
