...
class ClientAuthenticationSettingInfo {
 public:
  ...
  inline ClientAuthenticationSettingInfo& WithType(ClientAuthenticationType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(ClientAuthenticationStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ClientAuthenticationSettingInfo& WithStatus(ClientAuthenticationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
