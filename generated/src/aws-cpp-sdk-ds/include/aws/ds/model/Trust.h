...
class Trust {
 public:
  ...
  inline Trust& WithTrustType(TrustType value) {
    SetTrustType(value);
    return *this;
  }
  ///@}
  ...
  inline Trust& WithTrustDirection(TrustDirection value) {
  ...
  inline void SetTrustState(TrustState value) {
    m_trustStateHasBeenSet = true;
    m_trustState = value;
  }
  inline Trust& WithTrustState(TrustState value) {
    SetTrustState(value);
    return *this;
  }
  ///@}
  ...
  void SetStateLastUpdatedDateTime(StateLastUpdatedDateTimeT&& value) {
    ...
    m_stateLastUpdatedDateTime = std::forward<StateLastUpdatedDateTimeT>(value);
  }
  template <typename StateLastUpdatedDateTimeT = Aws::Utils::DateTime>
  Trust& WithStateLastUpdatedDateTime(StateLastUpdatedDateTimeT&& value) {
    SetStateLastUpdatedDateTime(std::forward<StateLastUpdatedDateTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTrustStateReason(TrustStateReasonT&& value) {
    ...
    m_trustStateReason = std::forward<TrustStateReasonT>(value);
  }
  template <typename TrustStateReasonT = Aws::String>
  Trust& WithTrustStateReason(TrustStateReasonT&& value) {
    SetTrustStateReason(std::forward<TrustStateReasonT>(value));
    return *this;
  }
  ///@}
  ...
  inline Trust& WithSelectiveAuth(SelectiveAuth value) {
