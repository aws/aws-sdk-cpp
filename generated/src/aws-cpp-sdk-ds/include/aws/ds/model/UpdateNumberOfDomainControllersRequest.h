...
class UpdateNumberOfDomainControllersRequest : public DirectoryServiceRequest {
 public:
  ...
  template <typename DirectoryIdT = Aws::String>
  UpdateNumberOfDomainControllersRequest& WithDirectoryId(DirectoryIdT&& value) {
  ...
  inline void SetDesiredNumber(int value) {
    m_desiredNumberHasBeenSet = true;
    m_desiredNumber = value;
  }
  inline UpdateNumberOfDomainControllersRequest& WithDesiredNumber(int value) {
