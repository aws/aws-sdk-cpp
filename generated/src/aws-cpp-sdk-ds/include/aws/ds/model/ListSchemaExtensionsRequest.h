...
/**
 */
class ListSchemaExtensionsRequest : public DirectoryServiceRequest {
 public:
  AWS_DIRECTORYSERVICE_API ListSchemaExtensionsRequest() = default;
  ...
  template <typename DirectoryIdT = Aws::String>
  ListSchemaExtensionsRequest& WithDirectoryId(DirectoryIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListSchemaExtensionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListSchemaExtensionsRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
