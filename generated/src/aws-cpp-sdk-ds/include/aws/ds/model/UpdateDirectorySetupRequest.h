...
class UpdateDirectorySetupRequest : public DirectoryServiceRequest {
 public:
  ...
  inline UpdateDirectorySetupRequest& WithUpdateType(UpdateType value) {
    SetUpdateType(value);
    return *this;
  }
  ///@}
  ...
  void SetDirectorySizeUpdateSettings(DirectorySizeUpdateSettingsT&& value) {
    m_directorySizeUpdateSettingsHasBeenSet = true;
    m_directorySizeUpdateSettings = std::forward<DirectorySizeUpdateSettingsT>(value);
  }
  template <typename DirectorySizeUpdateSettingsT = DirectorySizeUpdateSettings>
  UpdateDirectorySetupRequest& WithDirectorySizeUpdateSettings(DirectorySizeUpdateSettingsT&& value) {
    SetDirectorySizeUpdateSettings(std::forward<DirectorySizeUpdateSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNetworkUpdateSettings(NetworkUpdateSettingsT&& value) {
    m_networkUpdateSettingsHasBeenSet = true;
    m_networkUpdateSettings = std::forward<NetworkUpdateSettingsT>(value);
  }
  template <typename NetworkUpdateSettingsT = NetworkUpdateSettings>
  UpdateDirectorySetupRequest& WithNetworkUpdateSettings(NetworkUpdateSettingsT&& value) {
    SetNetworkUpdateSettings(std::forward<NetworkUpdateSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetCreateSnapshotBeforeUpdate(bool value) {
    m_createSnapshotBeforeUpdateHasBeenSet = true;
    m_createSnapshotBeforeUpdate = value;
  }
  inline UpdateDirectorySetupRequest& WithCreateSnapshotBeforeUpdate(bool value) {
    SetCreateSnapshotBeforeUpdate(value);
    return *this;
  }
  ///@}
 private:
