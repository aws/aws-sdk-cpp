...
class DescribeHybridADUpdateResult {
 public:
  ...
  template <typename UpdateActivitiesT = HybridUpdateActivities>
  DescribeHybridADUpdateResult& WithUpdateActivities(UpdateActivitiesT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  DescribeHybridADUpdateResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeHybridADUpdateResult& WithRequestId(RequestIdT&& value) {
