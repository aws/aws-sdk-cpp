...
class AddIpRoutesRequest : public DirectoryServiceRequest {
 public:
  ...
  void SetIpRoutes(IpRoutesT&& value) {
    m_ipRoutesHasBeenSet = true;
    m_ipRoutes = std::forward<IpRoutesT>(value);
  }
  template <typename IpRoutesT = Aws::Vector<IpRoute>>
  AddIpRoutesRequest& WithIpRoutes(IpRoutesT&& value) {
    SetIpRoutes(std::forward<IpRoutesT>(value));
    return *this;
  }
  template <typename IpRoutesT = IpRoute>
  AddIpRoutesRequest& AddIpRoutes(IpRoutesT&& value) {
    m_ipRoutesHasBeenSet = true;
    m_ipRoutes.emplace_back(std::forward<IpRoutesT>(value));
    return *this;
  }
  ///@}
  ...
  inline bool UpdateSecurityGroupForDirectoryControllersHasBeenSet() const {
    return m_updateSecurityGroupForDirectoryControllersHasBeenSet;
  }
  inline void SetUpdateSecurityGroupForDirectoryControllers(bool value) {
    m_updateSecurityGroupForDirectoryControllersHasBeenSet = true;
    m_updateSecurityGroupForDirectoryControllers = value;
  }
  inline AddIpRoutesRequest& WithUpdateSecurityGroupForDirectoryControllers(bool value) {
    SetUpdateSecurityGroupForDirectoryControllers(value);
    return *this;
  }
  ///@}
 private:
