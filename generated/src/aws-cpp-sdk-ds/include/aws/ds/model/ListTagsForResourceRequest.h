...
class ListTagsForResourceRequest : public DirectoryServiceRequest {
 public:
  AWS_DIRECTORYSERVICE_API ListTagsForResourceRequest() = default;
  ...
  template <typename ResourceIdT = Aws::String>
  ListTagsForResourceRequest& WithResourceId(ResourceIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListTagsForResourceRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListTagsForResourceRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
