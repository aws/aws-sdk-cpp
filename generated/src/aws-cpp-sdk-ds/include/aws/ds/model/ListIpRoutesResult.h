...
class ListIpRoutesResult {
 public:
  ...
  void SetIpRoutesInfo(IpRoutesInfoT&& value) {
    m_ipRoutesInfoHasBeenSet = true;
    m_ipRoutesInfo = std::forward<IpRoutesInfoT>(value);
  }
  template <typename IpRoutesInfoT = Aws::Vector<IpRouteInfo>>
  ListIpRoutesResult& WithIpRoutesInfo(IpRoutesInfoT&& value) {
    SetIpRoutesInfo(std::forward<IpRoutesInfoT>(value));
    return *this;
  }
  template <typename IpRoutesInfoT = IpRouteInfo>
  ListIpRoutesResult& AddIpRoutesInfo(IpRoutesInfoT&& value) {
    m_ipRoutesInfoHasBeenSet = true;
    m_ipRoutesInfo.emplace_back(std::forward<IpRoutesInfoT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListIpRoutesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListIpRoutesResult& WithRequestId(RequestIdT&& value) {
