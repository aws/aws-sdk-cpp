...
class UpdateConditionalForwarderResult {
 public:
  AWS_DIRECTORYSERVICE_API UpdateConditionalForwarderResult() = default;
  ...
  AWS_DIRECTORYSERVICE_API UpdateConditionalForwarderResult& operator=(
  ...
  template <typename RequestIdT = Aws::String>
  UpdateConditionalForwarderResult& WithRequestId(RequestIdT&& value) {
