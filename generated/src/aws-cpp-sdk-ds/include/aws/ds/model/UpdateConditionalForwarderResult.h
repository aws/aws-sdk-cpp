...
namespace Model
{
  ...
  public:
    ...
    inline UpdateConditionalForwarderResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateConditionalForwarderResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateConditionalForwarderResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
