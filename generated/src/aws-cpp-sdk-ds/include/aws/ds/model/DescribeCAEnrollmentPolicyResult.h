...
class DescribeCAEnrollmentPolicyResult {
 public:
  ...
  AWS_DIRECTORYSERVICE_API DescribeCAEnrollmentPolicyResult& operator=(
  ...
  template <typename DirectoryIdT = Aws::String>
  DescribeCAEnrollmentPolicyResult& WithDirectoryId(DirectoryIdT&& value) {
  ...
  template <typename PcaConnectorArnT = Aws::String>
  DescribeCAEnrollmentPolicyResult& WithPcaConnectorArn(PcaConnectorArnT&& value) {
  ...
  inline void SetCaEnrollmentPolicyStatus(CaEnrollmentPolicyStatus value) {
    m_caEnrollmentPolicyStatusHasBeenSet = true;
    m_caEnrollmentPolicyStatus = value;
  }
  inline DescribeCAEnrollmentPolicyResult& WithCaEnrollmentPolicyStatus(CaEnrollmentPolicyStatus value) {
    SetCaEnrollmentPolicyStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename LastUpdatedDateTimeT = Aws::Utils::DateTime>
  DescribeCAEnrollmentPolicyResult& WithLastUpdatedDateTime(LastUpdatedDateTimeT&& value) {
  ...
  void SetCaEnrollmentPolicyStatusReason(CaEnrollmentPolicyStatusReasonT&& value) {
    m_caEnrollmentPolicyStatusReasonHasBeenSet = true;
    m_caEnrollmentPolicyStatusReason = std::forward<CaEnrollmentPolicyStatusReasonT>(value);
  }
  template <typename CaEnrollmentPolicyStatusReasonT = Aws::String>
  DescribeCAEnrollmentPolicyResult& WithCaEnrollmentPolicyStatusReason(CaEnrollmentPolicyStatusReasonT&& value) {
    SetCaEnrollmentPolicyStatusReason(std::forward<CaEnrollmentPolicyStatusReasonT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeCAEnrollmentPolicyResult& WithRequestId(RequestIdT&& value) {
