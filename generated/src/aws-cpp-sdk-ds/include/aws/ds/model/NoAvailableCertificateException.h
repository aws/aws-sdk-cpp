...
namespace Model
{
  ...
  {
  public:
    AWS_DIRECTORYSERVICE_API NoAvailableCertificateException() = default;
    ...
    template<typename MessageT = Aws::String>
    NoAvailableCertificateException& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    NoAvailableCertificateException& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
