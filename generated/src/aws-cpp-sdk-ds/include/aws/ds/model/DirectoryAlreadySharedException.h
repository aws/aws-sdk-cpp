...
/**
 * <p>The specified directory has already been shared with this Amazon Web Services
...
class DirectoryAlreadySharedException {
 public:
  ...
  template <typename MessageT = Aws::String>
  DirectoryAlreadySharedException& WithMessage(MessageT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DirectoryAlreadySharedException& WithRequestId(RequestIdT&& value) {
