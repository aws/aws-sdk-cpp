...
class DeleteTrustRequest : public DirectoryServiceRequest {
 public:
  ...
  template <typename TrustIdT = Aws::String>
  DeleteTrustRequest& WithTrustId(TrustIdT&& value) {
  ...
  inline void SetDeleteAssociatedConditionalForwarder(bool value) {
    m_deleteAssociatedConditionalForwarderHasBeenSet = true;
    m_deleteAssociatedConditionalForwarder = value;
  }
  inline DeleteTrustRequest& WithDeleteAssociatedConditionalForwarder(bool value) {
