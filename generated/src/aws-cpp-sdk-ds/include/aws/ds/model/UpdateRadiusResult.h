...
namespace Model
{
  ...
  public:
    ...
    inline UpdateRadiusResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateRadiusResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateRadiusResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
