...
class ListIpRoutesRequest : public DirectoryServiceRequest {
 public:
  ...
  template <typename DirectoryIdT = Aws::String>
  ListIpRoutesRequest& WithDirectoryId(DirectoryIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListIpRoutesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListIpRoutesRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
