...
class DescribeTrustsResult {
 public:
  ...
  void SetTrusts(TrustsT&& value) {
    m_trustsHasBeenSet = true;
    m_trusts = std::forward<TrustsT>(value);
  }
  template <typename TrustsT = Aws::Vector<Trust>>
  DescribeTrustsResult& WithTrusts(TrustsT&& value) {
    SetTrusts(std::forward<TrustsT>(value));
    return *this;
  }
  template <typename TrustsT = Trust>
  DescribeTrustsResult& AddTrusts(TrustsT&& value) {
    m_trustsHasBeenSet = true;
    m_trusts.emplace_back(std::forward<TrustsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeTrustsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeTrustsResult& WithRequestId(RequestIdT&& value) {
