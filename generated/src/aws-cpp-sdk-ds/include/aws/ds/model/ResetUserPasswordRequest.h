...
class ResetUserPasswordRequest : public DirectoryServiceRequest {
 public:
  AWS_DIRECTORYSERVICE_API ResetUserPasswordRequest() = default;
  ...
  template <typename DirectoryIdT = Aws::String>
  ResetUserPasswordRequest& WithDirectoryId(DirectoryIdT&& value) {
  ...
  template <typename UserNameT = Aws::String>
  ResetUserPasswordRequest& WithUserName(UserNameT&& value) {
  ...
  template <typename NewPasswordT = Aws::String>
  ResetUserPasswordRequest& WithNewPassword(NewPasswordT&& value) {
