...
namespace Model
{
  ...
  public:
    ...
    inline UpdateNumberOfDomainControllersResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateNumberOfDomainControllersResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateNumberOfDomainControllersResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
