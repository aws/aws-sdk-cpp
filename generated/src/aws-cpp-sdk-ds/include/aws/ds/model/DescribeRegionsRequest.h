...
class DescribeRegionsRequest : public DirectoryServiceRequest {
 public:
  ...
  template <typename DirectoryIdT = Aws::String>
  DescribeRegionsRequest& WithDirectoryId(DirectoryIdT&& value) {
  ...
  template <typename RegionNameT = Aws::String>
  DescribeRegionsRequest& WithRegionName(RegionNameT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  DescribeRegionsRequest& WithNextToken(NextTokenT&& value) {
