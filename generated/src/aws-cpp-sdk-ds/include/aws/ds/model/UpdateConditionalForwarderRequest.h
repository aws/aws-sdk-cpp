...
class UpdateConditionalForwarderRequest : public DirectoryServiceRequest {
 public:
  ...
  template <typename DirectoryIdT = Aws::String>
  UpdateConditionalForwarderRequest& WithDirectoryId(DirectoryIdT&& value) {
  ...
  template <typename RemoteDomainNameT = Aws::String>
  UpdateConditionalForwarderRequest& WithRemoteDomainName(RemoteDomainNameT&& value) {
  ...
  template <typename DnsIpAddrsT = Aws::Vector<Aws::String>>
  UpdateConditionalForwarderRequest& WithDnsIpAddrs(DnsIpAddrsT&& value) {
    SetDnsIpAddrs(std::forward<DnsIpAddrsT>(value));
    return *this;
  }
  template <typename DnsIpAddrsT = Aws::String>
  UpdateConditionalForwarderRequest& AddDnsIpAddrs(DnsIpAddrsT&& value) {
    m_dnsIpAddrsHasBeenSet = true;
  ...
  template <typename DnsIpv6AddrsT = Aws::Vector<Aws::String>>
  UpdateConditionalForwarderRequest& WithDnsIpv6Addrs(DnsIpv6AddrsT&& value) {
    SetDnsIpv6Addrs(std::forward<DnsIpv6AddrsT>(value));
    return *this;
  }
  template <typename DnsIpv6AddrsT = Aws::String>
  UpdateConditionalForwarderRequest& AddDnsIpv6Addrs(DnsIpv6AddrsT&& value) {
    m_dnsIpv6AddrsHasBeenSet = true;
