...
class DescribeSharedDirectoriesResult {
 public:
  ...
  AWS_DIRECTORYSERVICE_API DescribeSharedDirectoriesResult& operator=(
  ...
  void SetSharedDirectories(SharedDirectoriesT&& value) {
    m_sharedDirectoriesHasBeenSet = true;
    m_sharedDirectories = std::forward<SharedDirectoriesT>(value);
  }
  template <typename SharedDirectoriesT = Aws::Vector<SharedDirectory>>
  DescribeSharedDirectoriesResult& WithSharedDirectories(SharedDirectoriesT&& value) {
    SetSharedDirectories(std::forward<SharedDirectoriesT>(value));
    return *this;
  }
  template <typename SharedDirectoriesT = SharedDirectory>
  DescribeSharedDirectoriesResult& AddSharedDirectories(SharedDirectoriesT&& value) {
    m_sharedDirectoriesHasBeenSet = true;
    m_sharedDirectories.emplace_back(std::forward<SharedDirectoriesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeSharedDirectoriesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeSharedDirectoriesResult& WithRequestId(RequestIdT&& value) {
