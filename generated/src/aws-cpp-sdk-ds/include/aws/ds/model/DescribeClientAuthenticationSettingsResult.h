...
class DescribeClientAuthenticationSettingsResult {
 public:
  ...
  AWS_DIRECTORYSERVICE_API DescribeClientAuthenticationSettingsResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
   ...
   * authentication.</p>
   */
  inline const Aws::Vector<ClientAuthenticationSettingInfo>& GetClientAuthenticationSettingsInfo() const {
    return m_clientAuthenticationSettingsInfo;
  }
  ...
  void SetClientAuthenticationSettingsInfo(ClientAuthenticationSettingsInfoT&& value) {
    ...
    m_clientAuthenticationSettingsInfo = std::forward<ClientAuthenticationSettingsInfoT>(value);
  }
  template <typename ClientAuthenticationSettingsInfoT = Aws::Vector<ClientAuthenticationSettingInfo>>
  DescribeClientAuthenticationSettingsResult& WithClientAuthenticationSettingsInfo(ClientAuthenticationSettingsInfoT&& value) {
    SetClientAuthenticationSettingsInfo(std::forward<ClientAuthenticationSettingsInfoT>(value));
    return *this;
  }
  ...
  DescribeClientAuthenticationSettingsResult& AddClientAuthenticationSettingsInfo(ClientAuthenticationSettingsInfoT&& value) {
    m_clientAuthenticationSettingsInfoHasBeenSet = true;
    m_clientAuthenticationSettingsInfo.emplace_back(std::forward<ClientAuthenticationSettingsInfoT>(value));
    return *this;
  }
  ///@}
