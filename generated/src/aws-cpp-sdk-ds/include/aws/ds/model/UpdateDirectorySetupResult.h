...
namespace Model
{
  ...
  public:
    ...
    inline UpdateDirectorySetupResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateDirectorySetupResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateDirectorySetupResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
