...
namespace Model
{
  ...
  {
  public:
    AWS_DIRECTORYSERVICE_API UpdateDirectorySetupResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateDirectorySetupResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
