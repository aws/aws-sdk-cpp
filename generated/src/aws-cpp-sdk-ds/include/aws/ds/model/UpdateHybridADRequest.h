...
class UpdateHybridADRequest : public DirectoryServiceRequest {
 public:
  ...
  template <typename DirectoryIdT = Aws::String>
  UpdateHybridADRequest& WithDirectoryId(DirectoryIdT&& value) {
  ...
  void SetHybridAdministratorAccountUpdate(HybridAdministratorAccountUpdateT&& value) {
    m_hybridAdministratorAccountUpdateHasBeenSet = true;
    m_hybridAdministratorAccountUpdate = std::forward<HybridAdministratorAccountUpdateT>(value);
  }
  template <typename HybridAdministratorAccountUpdateT = HybridAdministratorAccountUpdate>
  UpdateHybridADRequest& WithHybridAdministratorAccountUpdate(HybridAdministratorAccountUpdateT&& value) {
    SetHybridAdministratorAccountUpdate(std::forward<HybridAdministratorAccountUpdateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSelfManagedInstancesSettings(SelfManagedInstancesSettingsT&& value) {
    m_selfManagedInstancesSettingsHasBeenSet = true;
    m_selfManagedInstancesSettings = std::forward<SelfManagedInstancesSettingsT>(value);
  }
  template <typename SelfManagedInstancesSettingsT = HybridCustomerInstancesSettings>
  UpdateHybridADRequest& WithSelfManagedInstancesSettings(SelfManagedInstancesSettingsT&& value) {
    SetSelfManagedInstancesSettings(std::forward<SelfManagedInstancesSettingsT>(value));
    return *this;
  }
  ///@}
 private:
