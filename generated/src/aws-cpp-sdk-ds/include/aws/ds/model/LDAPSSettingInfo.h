...
class LDAPSSettingInfo {
 public:
  ...
  inline void SetLDAPSStatus(LDAPSStatus value) {
    m_lDAPSStatusHasBeenSet = true;
    m_lDAPSStatus = value;
  }
  inline LDAPSSettingInfo& WithLDAPSStatus(LDAPSStatus value) {
    SetLDAPSStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetLDAPSStatusReason(LDAPSStatusReasonT&& value) {
    m_lDAPSStatusReasonHasBeenSet = true;
    m_lDAPSStatusReason = std::forward<LDAPSStatusReasonT>(value);
  }
  template <typename LDAPSStatusReasonT = Aws::String>
  LDAPSSettingInfo& WithLDAPSStatusReason(LDAPSStatusReasonT&& value) {
    SetLDAPSStatusReason(std::forward<LDAPSStatusReasonT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename LastUpdatedDateTimeT = Aws::Utils::DateTime>
  LDAPSSettingInfo& WithLastUpdatedDateTime(LastUpdatedDateTimeT&& value) {
