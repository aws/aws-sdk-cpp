...
class StartADAssessmentRequest : public DirectoryServiceRequest {
 public:
  ...
  void SetAssessmentConfiguration(AssessmentConfigurationT&& value) {
    m_assessmentConfigurationHasBeenSet = true;
    m_assessmentConfiguration = std::forward<AssessmentConfigurationT>(value);
  }
  template <typename AssessmentConfigurationT = AssessmentConfiguration>
  StartADAssessmentRequest& WithAssessmentConfiguration(AssessmentConfigurationT&& value) {
    SetAssessmentConfiguration(std::forward<AssessmentConfigurationT>(value));
    return *this;
  }
  ///@}
