...
namespace Model
{
  ...
  {
  public:
    AWS_DIRECTORYSERVICE_API EnableLDAPSResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    EnableLDAPSResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
