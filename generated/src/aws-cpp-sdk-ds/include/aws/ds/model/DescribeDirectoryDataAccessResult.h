...
class DescribeDirectoryDataAccessResult {
 public:
  ...
  AWS_DIRECTORYSERVICE_API DescribeDirectoryDataAccessResult& operator=(
  ...
  inline void SetDataAccessStatus(DataAccessStatus value) {
    m_dataAccessStatusHasBeenSet = true;
    m_dataAccessStatus = value;
  }
  inline DescribeDirectoryDataAccessResult& WithDataAccessStatus(DataAccessStatus value) {
    SetDataAccessStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeDirectoryDataAccessResult& WithRequestId(RequestIdT&& value) {
