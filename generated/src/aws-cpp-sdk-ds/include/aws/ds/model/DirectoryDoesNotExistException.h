...
namespace Model
{
  ...
  {
  public:
    AWS_DIRECTORYSERVICE_API DirectoryDoesNotExistException() = default;
    ...
    template<typename MessageT = Aws::String>
    DirectoryDoesNotExistException& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DirectoryDoesNotExistException& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
