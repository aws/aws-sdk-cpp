...
class DescribeLDAPSSettingsRequest : public DirectoryServiceRequest {
 public:
  ...
  template <typename DirectoryIdT = Aws::String>
  DescribeLDAPSSettingsRequest& WithDirectoryId(DirectoryIdT&& value) {
  ...
  inline void SetType(LDAPSType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline DescribeLDAPSSettingsRequest& WithType(LDAPSType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeLDAPSSettingsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeLDAPSSettingsRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
