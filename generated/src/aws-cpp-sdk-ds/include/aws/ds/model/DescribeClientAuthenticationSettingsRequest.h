...
class DescribeClientAuthenticationSettingsRequest : public DirectoryServiceRequest {
 public:
  ...
  inline DescribeClientAuthenticationSettingsRequest& WithType(ClientAuthenticationType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeClientAuthenticationSettingsRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
