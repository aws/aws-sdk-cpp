...
class ConnectDirectoryResult {
 public:
  AWS_DIRECTORYSERVICE_API ConnectDirectoryResult() = default;
  ...
  template <typename DirectoryIdT = Aws::String>
  ConnectDirectoryResult& WithDirectoryId(DirectoryIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ConnectDirectoryResult& WithRequestId(RequestIdT&& value) {
