...
namespace Model
{
  ...
  public:
    ...
    template<typename DirectoryIdT = Aws::String>
    ConnectDirectoryResult& WithDirectoryId(DirectoryIdT&& value) { SetDirectoryId(std::forward<DirectoryIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ConnectDirectoryResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
