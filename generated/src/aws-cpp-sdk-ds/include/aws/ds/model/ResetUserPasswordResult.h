...
namespace Model
{
  ...
  {
  public:
    AWS_DIRECTORYSERVICE_API ResetUserPasswordResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    ResetUserPasswordResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
