...
class DeleteConditionalForwarderResult {
 public:
  AWS_DIRECTORYSERVICE_API DeleteConditionalForwarderResult() = default;
  ...
  AWS_DIRECTORYSERVICE_API DeleteConditionalForwarderResult& operator=(
  ...
  template <typename RequestIdT = Aws::String>
  DeleteConditionalForwarderResult& WithRequestId(RequestIdT&& value) {
