...
class AWS_DIRECTORYSERVICE_API DirectoryServiceClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  DirectoryServiceClient(const Aws::DirectoryService::DirectoryServiceClientConfiguration& clientConfiguration =
  ...
  DirectoryServiceClient(const Aws::Auth::AWSCredentials& credentials,
                         std::shared_ptr<DirectoryServiceEndpointProviderBase> endpointProvider = nullptr,
                         const Aws::DirectoryService::DirectoryServiceClientConfiguration& clientConfiguration =
                             Aws::DirectoryService::DirectoryServiceClientConfiguration());
  ...
  /**
   * A Callable wrapper for AcceptSharedDirectory that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AcceptSharedDirectory that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AcceptSharedDirectoryRequestT = Model::AcceptSharedDirectoryRequest>
  void AcceptSharedDirectoryAsync(const AcceptSharedDirectoryRequestT& request, const AcceptSharedDirectoryResponseReceivedHandler& handler,
  ...
  /**
   * An Async wrapper for AddIpRoutes that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename AddIpRoutesRequestT = Model::AddIpRoutesRequest>
  void AddIpRoutesAsync(const AddIpRoutesRequestT& request, const AddIpRoutesResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CancelSchemaExtension that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CancelSchemaExtension that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CancelSchemaExtensionRequestT = Model::CancelSchemaExtensionRequest>
  void CancelSchemaExtensionAsync(const CancelSchemaExtensionRequestT& request, const CancelSchemaExtensionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ConnectDirectory that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ConnectDirectory that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ConnectDirectoryRequestT = Model::ConnectDirectoryRequest>
  void ConnectDirectoryAsync(const ConnectDirectoryRequestT& request, const ConnectDirectoryResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateComputer that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateComputerRequestT = Model::CreateComputerRequest>
  void CreateComputerAsync(const CreateComputerRequestT& request, const CreateComputerResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateConditionalForwarderOutcome CreateConditionalForwarder(
      const Model::CreateConditionalForwarderRequest& request) const;

  /**
   * A Callable wrapper for CreateConditionalForwarder that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateConditionalForwarderRequestT = Model::CreateConditionalForwarderRequest>
  Model::CreateConditionalForwarderOutcomeCallable CreateConditionalForwarderCallable(
      const CreateConditionalForwarderRequestT& request) const {
    return SubmitCallable(&DirectoryServiceClient::CreateConditionalForwarder, request);
  }

  /**
   * An Async wrapper for CreateConditionalForwarder that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateConditionalForwarderRequestT = Model::CreateConditionalForwarderRequest>
  void CreateConditionalForwarderAsync(const CreateConditionalForwarderRequestT& request,
  ...
  /**
   * An Async wrapper for CreateHybridAD that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateHybridADRequestT = Model::CreateHybridADRequest>
  void CreateHybridADAsync(const CreateHybridADRequestT& request, const CreateHybridADResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateLogSubscription that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateLogSubscription that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateLogSubscriptionRequestT = Model::CreateLogSubscriptionRequest>
  void CreateLogSubscriptionAsync(const CreateLogSubscriptionRequestT& request, const CreateLogSubscriptionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateMicrosoftAD that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateMicrosoftAD that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateMicrosoftADRequestT = Model::CreateMicrosoftADRequest>
  void CreateMicrosoftADAsync(const CreateMicrosoftADRequestT& request, const CreateMicrosoftADResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateTrust that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateTrustRequestT = Model::CreateTrustRequest>
  void CreateTrustAsync(const CreateTrustRequestT& request, const CreateTrustResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteADAssessment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteADAssessment that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteADAssessmentRequestT = Model::DeleteADAssessmentRequest>
  void DeleteADAssessmentAsync(const DeleteADAssessmentRequestT& request, const DeleteADAssessmentResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteConditionalForwarderOutcome DeleteConditionalForwarder(
      const Model::DeleteConditionalForwarderRequest& request) const;

  /**
   * A Callable wrapper for DeleteConditionalForwarder that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteConditionalForwarderRequestT = Model::DeleteConditionalForwarderRequest>
  Model::DeleteConditionalForwarderOutcomeCallable DeleteConditionalForwarderCallable(
      const DeleteConditionalForwarderRequestT& request) const {
    return SubmitCallable(&DirectoryServiceClient::DeleteConditionalForwarder, request);
  }

  /**
   * An Async wrapper for DeleteConditionalForwarder that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteConditionalForwarderRequestT = Model::DeleteConditionalForwarderRequest>
  void DeleteConditionalForwarderAsync(const DeleteConditionalForwarderRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteLogSubscription that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteLogSubscription that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteLogSubscriptionRequestT = Model::DeleteLogSubscriptionRequest>
  void DeleteLogSubscriptionAsync(const DeleteLogSubscriptionRequestT& request, const DeleteLogSubscriptionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteTrust that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteTrustRequestT = Model::DeleteTrustRequest>
  void DeleteTrustAsync(const DeleteTrustRequestT& request, const DeleteTrustResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeregisterCertificate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeregisterCertificate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeregisterCertificateRequestT = Model::DeregisterCertificateRequest>
  void DeregisterCertificateAsync(const DeregisterCertificateRequestT& request, const DeregisterCertificateResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeregisterEventTopic that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeregisterEventTopic that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeregisterEventTopicRequestT = Model::DeregisterEventTopicRequest>
  void DeregisterEventTopicAsync(const DeregisterEventTopicRequestT& request, const DeregisterEventTopicResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeADAssessment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeADAssessment that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeADAssessmentRequestT = Model::DescribeADAssessmentRequest>
  void DescribeADAssessmentAsync(const DescribeADAssessmentRequestT& request, const DescribeADAssessmentResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeCAEnrollmentPolicyOutcome DescribeCAEnrollmentPolicy(
      const Model::DescribeCAEnrollmentPolicyRequest& request) const;

  /**
   * A Callable wrapper for DescribeCAEnrollmentPolicy that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeCAEnrollmentPolicyRequestT = Model::DescribeCAEnrollmentPolicyRequest>
  Model::DescribeCAEnrollmentPolicyOutcomeCallable DescribeCAEnrollmentPolicyCallable(
      const DescribeCAEnrollmentPolicyRequestT& request) const {
    return SubmitCallable(&DirectoryServiceClient::DescribeCAEnrollmentPolicy, request);
  }

  /**
   * An Async wrapper for DescribeCAEnrollmentPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeCAEnrollmentPolicyRequestT = Model::DescribeCAEnrollmentPolicyRequest>
  void DescribeCAEnrollmentPolicyAsync(const DescribeCAEnrollmentPolicyRequestT& request,
                                       const DescribeCAEnrollmentPolicyResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeClientAuthenticationSettingsOutcome DescribeClientAuthenticationSettings(
      const Model::DescribeClientAuthenticationSettingsRequest& request) const;

  /**
   * A Callable wrapper for DescribeClientAuthenticationSettings that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DescribeClientAuthenticationSettingsRequestT = Model::DescribeClientAuthenticationSettingsRequest>
  Model::DescribeClientAuthenticationSettingsOutcomeCallable DescribeClientAuthenticationSettingsCallable(
      const DescribeClientAuthenticationSettingsRequestT& request) const {
    return SubmitCallable(&DirectoryServiceClient::DescribeClientAuthenticationSettings, request);
  }

  /**
   * An Async wrapper for DescribeClientAuthenticationSettings that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeClientAuthenticationSettingsRequestT = Model::DescribeClientAuthenticationSettingsRequest>
  void DescribeClientAuthenticationSettingsAsync(const DescribeClientAuthenticationSettingsRequestT& request,
                                                 const DescribeClientAuthenticationSettingsResponseReceivedHandler& handler,
                                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeConditionalForwardersOutcome DescribeConditionalForwarders(
      const Model::DescribeConditionalForwardersRequest& request) const;

  /**
   * A Callable wrapper for DescribeConditionalForwarders that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeConditionalForwardersRequestT = Model::DescribeConditionalForwardersRequest>
  Model::DescribeConditionalForwardersOutcomeCallable DescribeConditionalForwardersCallable(
      const DescribeConditionalForwardersRequestT& request) const {
    return SubmitCallable(&DirectoryServiceClient::DescribeConditionalForwarders, request);
  }

  /**
   * An Async wrapper for DescribeConditionalForwarders that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeConditionalForwardersRequestT = Model::DescribeConditionalForwardersRequest>
  void DescribeConditionalForwardersAsync(const DescribeConditionalForwardersRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeDirectories that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeDirectories that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeDirectoriesRequestT = Model::DescribeDirectoriesRequest>
  void DescribeDirectoriesAsync(const DescribeDirectoriesResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const DescribeDirectoriesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeDirectoryDataAccessOutcome DescribeDirectoryDataAccess(
      const Model::DescribeDirectoryDataAccessRequest& request) const;

  /**
   * A Callable wrapper for DescribeDirectoryDataAccess that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeDirectoryDataAccessRequestT = Model::DescribeDirectoryDataAccessRequest>
  Model::DescribeDirectoryDataAccessOutcomeCallable DescribeDirectoryDataAccessCallable(
      const DescribeDirectoryDataAccessRequestT& request) const {
    return SubmitCallable(&DirectoryServiceClient::DescribeDirectoryDataAccess, request);
  }

  /**
   * An Async wrapper for DescribeDirectoryDataAccess that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeDirectoryDataAccessRequestT = Model::DescribeDirectoryDataAccessRequest>
  void DescribeDirectoryDataAccessAsync(const DescribeDirectoryDataAccessRequestT& request,
                                        const DescribeDirectoryDataAccessResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeDomainControllers that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeDomainControllersRequestT = Model::DescribeDomainControllersRequest>
  Model::DescribeDomainControllersOutcomeCallable DescribeDomainControllersCallable(
      const DescribeDomainControllersRequestT& request) const {
    return SubmitCallable(&DirectoryServiceClient::DescribeDomainControllers, request);
  }

  /**
   * An Async wrapper for DescribeDomainControllers that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeDomainControllersRequestT = Model::DescribeDomainControllersRequest>
  void DescribeDomainControllersAsync(const DescribeDomainControllersRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeEventTopics that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeEventTopics that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeEventTopicsRequestT = Model::DescribeEventTopicsRequest>
  void DescribeEventTopicsAsync(const DescribeEventTopicsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const DescribeEventTopicsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeHybridADUpdate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeHybridADUpdate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeHybridADUpdateRequestT = Model::DescribeHybridADUpdateRequest>
  void DescribeHybridADUpdateAsync(const DescribeHybridADUpdateRequestT& request,
                                   const DescribeHybridADUpdateResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeLDAPSSettings that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeLDAPSSettings that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeLDAPSSettingsRequestT = Model::DescribeLDAPSSettingsRequest>
  void DescribeLDAPSSettingsAsync(const DescribeLDAPSSettingsRequestT& request, const DescribeLDAPSSettingsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeRegions that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeRegionsRequestT = Model::DescribeRegionsRequest>
  void DescribeRegionsAsync(const DescribeRegionsRequestT& request, const DescribeRegionsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeSettings that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeSettings that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeSettingsRequestT = Model::DescribeSettingsRequest>
  void DescribeSettingsAsync(const DescribeSettingsRequestT& request, const DescribeSettingsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeSharedDirectories that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeSharedDirectoriesRequestT = Model::DescribeSharedDirectoriesRequest>
  Model::DescribeSharedDirectoriesOutcomeCallable DescribeSharedDirectoriesCallable(
      const DescribeSharedDirectoriesRequestT& request) const {
    return SubmitCallable(&DirectoryServiceClient::DescribeSharedDirectories, request);
  }

  /**
   * An Async wrapper for DescribeSharedDirectories that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeSharedDirectoriesRequestT = Model::DescribeSharedDirectoriesRequest>
  void DescribeSharedDirectoriesAsync(const DescribeSharedDirectoriesRequestT& request,
  ...
  /**
   * An Async wrapper for DescribeTrusts that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeTrustsRequestT = Model::DescribeTrustsRequest>
  void DescribeTrustsAsync(const DescribeTrustsResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const DescribeTrustsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeUpdateDirectory that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeUpdateDirectory that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeUpdateDirectoryRequestT = Model::DescribeUpdateDirectoryRequest>
  void DescribeUpdateDirectoryAsync(const DescribeUpdateDirectoryRequestT& request,
                                    const DescribeUpdateDirectoryResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DisableCAEnrollmentPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DisableCAEnrollmentPolicyRequestT = Model::DisableCAEnrollmentPolicyRequest>
  Model::DisableCAEnrollmentPolicyOutcomeCallable DisableCAEnrollmentPolicyCallable(
      const DisableCAEnrollmentPolicyRequestT& request) const {
    return SubmitCallable(&DirectoryServiceClient::DisableCAEnrollmentPolicy, request);
  }

  /**
   * An Async wrapper for DisableCAEnrollmentPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisableCAEnrollmentPolicyRequestT = Model::DisableCAEnrollmentPolicyRequest>
  void DisableCAEnrollmentPolicyAsync(const DisableCAEnrollmentPolicyRequestT& request,
                                      const DisableCAEnrollmentPolicyResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisableClientAuthenticationOutcome DisableClientAuthentication(
      const Model::DisableClientAuthenticationRequest& request) const;

  /**
   * A Callable wrapper for DisableClientAuthentication that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DisableClientAuthenticationRequestT = Model::DisableClientAuthenticationRequest>
  Model::DisableClientAuthenticationOutcomeCallable DisableClientAuthenticationCallable(
      const DisableClientAuthenticationRequestT& request) const {
    return SubmitCallable(&DirectoryServiceClient::DisableClientAuthentication, request);
  }

  /**
   * An Async wrapper for DisableClientAuthentication that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisableClientAuthenticationRequestT = Model::DisableClientAuthenticationRequest>
  void DisableClientAuthenticationAsync(const DisableClientAuthenticationRequestT& request,
                                        const DisableClientAuthenticationResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisableDirectoryDataAccessOutcome DisableDirectoryDataAccess(
      const Model::DisableDirectoryDataAccessRequest& request) const;

  /**
   * A Callable wrapper for DisableDirectoryDataAccess that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DisableDirectoryDataAccessRequestT = Model::DisableDirectoryDataAccessRequest>
  Model::DisableDirectoryDataAccessOutcomeCallable DisableDirectoryDataAccessCallable(
      const DisableDirectoryDataAccessRequestT& request) const {
    return SubmitCallable(&DirectoryServiceClient::DisableDirectoryDataAccess, request);
  }

  /**
   * An Async wrapper for DisableDirectoryDataAccess that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisableDirectoryDataAccessRequestT = Model::DisableDirectoryDataAccessRequest>
  void DisableDirectoryDataAccessAsync(const DisableDirectoryDataAccessRequestT& request,
                                       const DisableDirectoryDataAccessResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DisableLDAPS that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DisableLDAPSRequestT = Model::DisableLDAPSRequest>
  void DisableLDAPSAsync(const DisableLDAPSRequestT& request, const DisableLDAPSResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DisableRadius that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DisableRadiusRequestT = Model::DisableRadiusRequest>
  void DisableRadiusAsync(const DisableRadiusRequestT& request, const DisableRadiusResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DisableSso that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DisableSsoRequestT = Model::DisableSsoRequest>
  void DisableSsoAsync(const DisableSsoRequestT& request, const DisableSsoResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for EnableCAEnrollmentPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for EnableCAEnrollmentPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename EnableCAEnrollmentPolicyRequestT = Model::EnableCAEnrollmentPolicyRequest>
  void EnableCAEnrollmentPolicyAsync(const EnableCAEnrollmentPolicyRequestT& request,
                                     const EnableCAEnrollmentPolicyResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::EnableClientAuthenticationOutcome EnableClientAuthentication(
      const Model::EnableClientAuthenticationRequest& request) const;

  /**
   * A Callable wrapper for EnableClientAuthentication that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename EnableClientAuthenticationRequestT = Model::EnableClientAuthenticationRequest>
  Model::EnableClientAuthenticationOutcomeCallable EnableClientAuthenticationCallable(
      const EnableClientAuthenticationRequestT& request) const {
    return SubmitCallable(&DirectoryServiceClient::EnableClientAuthentication, request);
  }

  /**
   * An Async wrapper for EnableClientAuthentication that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename EnableClientAuthenticationRequestT = Model::EnableClientAuthenticationRequest>
  void EnableClientAuthenticationAsync(const EnableClientAuthenticationRequestT& request,
                                       const EnableClientAuthenticationResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for EnableDirectoryDataAccess that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename EnableDirectoryDataAccessRequestT = Model::EnableDirectoryDataAccessRequest>
  Model::EnableDirectoryDataAccessOutcomeCallable EnableDirectoryDataAccessCallable(
      const EnableDirectoryDataAccessRequestT& request) const {
    return SubmitCallable(&DirectoryServiceClient::EnableDirectoryDataAccess, request);
  }

  /**
   * An Async wrapper for EnableDirectoryDataAccess that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename EnableDirectoryDataAccessRequestT = Model::EnableDirectoryDataAccessRequest>
  void EnableDirectoryDataAccessAsync(const EnableDirectoryDataAccessRequestT& request,
                                      const EnableDirectoryDataAccessResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for EnableLDAPS that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename EnableLDAPSRequestT = Model::EnableLDAPSRequest>
  void EnableLDAPSAsync(const EnableLDAPSRequestT& request, const EnableLDAPSResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for EnableRadius that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename EnableRadiusRequestT = Model::EnableRadiusRequest>
  void EnableRadiusAsync(const EnableRadiusRequestT& request, const EnableRadiusResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for EnableSso that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename EnableSsoRequestT = Model::EnableSsoRequest>
  void EnableSsoAsync(const EnableSsoRequestT& request, const EnableSsoResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetDirectoryLimits that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetDirectoryLimits that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetDirectoryLimitsRequestT = Model::GetDirectoryLimitsRequest>
  void GetDirectoryLimitsAsync(const GetDirectoryLimitsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const GetDirectoryLimitsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetSnapshotLimits that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetSnapshotLimits that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetSnapshotLimitsRequestT = Model::GetSnapshotLimitsRequest>
  void GetSnapshotLimitsAsync(const GetSnapshotLimitsRequestT& request, const GetSnapshotLimitsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListADAssessments that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListADAssessments that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListADAssessmentsRequestT = Model::ListADAssessmentsRequest>
  void ListADAssessmentsAsync(const ListADAssessmentsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const ListADAssessmentsRequestT& request = {}) const {
   ...
   */
  template <typename ListCertificatesRequestT = Model::ListCertificatesRequest>
  void ListCertificatesAsync(const ListCertificatesRequestT& request, const ListCertificatesResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListIpRoutes that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListIpRoutesRequestT = Model::ListIpRoutesRequest>
  void ListIpRoutesAsync(const ListIpRoutesRequestT& request, const ListIpRoutesResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListLogSubscriptions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListLogSubscriptions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListLogSubscriptionsRequestT = Model::ListLogSubscriptionsRequest>
  void ListLogSubscriptionsAsync(const ListLogSubscriptionsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const ListLogSubscriptionsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListSchemaExtensions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListSchemaExtensions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListSchemaExtensionsRequestT = Model::ListSchemaExtensionsRequest>
  void ListSchemaExtensionsAsync(const ListSchemaExtensionsRequestT& request, const ListSchemaExtensionsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RegisterEventTopic that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RegisterEventTopic that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename RegisterEventTopicRequestT = Model::RegisterEventTopicRequest>
  void RegisterEventTopicAsync(const RegisterEventTopicRequestT& request, const RegisterEventTopicResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RejectSharedDirectory that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RejectSharedDirectory that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RejectSharedDirectoryRequestT = Model::RejectSharedDirectoryRequest>
  void RejectSharedDirectoryAsync(const RejectSharedDirectoryRequestT& request, const RejectSharedDirectoryResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for RemoveIpRoutes that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename RemoveIpRoutesRequestT = Model::RemoveIpRoutesRequest>
  void RemoveIpRoutesAsync(const RemoveIpRoutesRequestT& request, const RemoveIpRoutesResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ResetUserPassword that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ResetUserPassword that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ResetUserPasswordRequestT = Model::ResetUserPasswordRequest>
  void ResetUserPasswordAsync(const ResetUserPasswordRequestT& request, const ResetUserPasswordResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ShareDirectory that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ShareDirectoryRequestT = Model::ShareDirectoryRequest>
  void ShareDirectoryAsync(const ShareDirectoryRequestT& request, const ShareDirectoryResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartADAssessment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartADAssessment that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StartADAssessmentRequestT = Model::StartADAssessmentRequest>
  void StartADAssessmentAsync(const StartADAssessmentResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const StartADAssessmentRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for StartSchemaExtension that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartSchemaExtension that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartSchemaExtensionRequestT = Model::StartSchemaExtensionRequest>
  void StartSchemaExtensionAsync(const StartSchemaExtensionRequestT& request, const StartSchemaExtensionResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UnshareDirectory that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UnshareDirectory that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UnshareDirectoryRequestT = Model::UnshareDirectoryRequest>
  void UnshareDirectoryAsync(const UnshareDirectoryRequestT& request, const UnshareDirectoryResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateConditionalForwarderOutcome UpdateConditionalForwarder(
      const Model::UpdateConditionalForwarderRequest& request) const;

  /**
   * A Callable wrapper for UpdateConditionalForwarder that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateConditionalForwarderRequestT = Model::UpdateConditionalForwarderRequest>
  Model::UpdateConditionalForwarderOutcomeCallable UpdateConditionalForwarderCallable(
      const UpdateConditionalForwarderRequestT& request) const {
    return SubmitCallable(&DirectoryServiceClient::UpdateConditionalForwarder, request);
  }

  /**
   * An Async wrapper for UpdateConditionalForwarder that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateConditionalForwarderRequestT = Model::UpdateConditionalForwarderRequest>
  void UpdateConditionalForwarderAsync(const UpdateConditionalForwarderRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateDirectorySetup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateDirectorySetup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateDirectorySetupRequestT = Model::UpdateDirectorySetupRequest>
  void UpdateDirectorySetupAsync(const UpdateDirectorySetupRequestT& request, const UpdateDirectorySetupResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateHybridAD that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateHybridADRequestT = Model::UpdateHybridADRequest>
  void UpdateHybridADAsync(const UpdateHybridADRequestT& request, const UpdateHybridADResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateNumberOfDomainControllersOutcome UpdateNumberOfDomainControllers(
      const Model::UpdateNumberOfDomainControllersRequest& request) const;

  /**
   * A Callable wrapper for UpdateNumberOfDomainControllers that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateNumberOfDomainControllersRequestT = Model::UpdateNumberOfDomainControllersRequest>
  Model::UpdateNumberOfDomainControllersOutcomeCallable UpdateNumberOfDomainControllersCallable(
      const UpdateNumberOfDomainControllersRequestT& request) const {
    return SubmitCallable(&DirectoryServiceClient::UpdateNumberOfDomainControllers, request);
  }

  /**
   * An Async wrapper for UpdateNumberOfDomainControllers that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateNumberOfDomainControllersRequestT = Model::UpdateNumberOfDomainControllersRequest>
  void UpdateNumberOfDomainControllersAsync(const UpdateNumberOfDomainControllersRequestT& request,
  ...
  /**
   * An Async wrapper for UpdateRadius that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateRadiusRequestT = Model::UpdateRadiusRequest>
  void UpdateRadiusAsync(const UpdateRadiusRequestT& request, const UpdateRadiusResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename UpdateSettingsRequestT = Model::UpdateSettingsRequest>
  void UpdateSettingsAsync(const UpdateSettingsRequestT& request, const UpdateSettingsResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateTrust that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateTrustRequestT = Model::UpdateTrustRequest>
  void UpdateTrustAsync(const UpdateTrustRequestT& request, const UpdateTrustResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for VerifyTrust that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename VerifyTrustRequestT = Model::VerifyTrustRequest>
  void VerifyTrustAsync(const VerifyTrustRequestT& request, const VerifyTrustResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
