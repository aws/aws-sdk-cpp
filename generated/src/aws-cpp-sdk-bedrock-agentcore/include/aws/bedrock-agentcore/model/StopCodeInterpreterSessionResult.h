...
class StopCodeInterpreterSessionResult {
 public:
  ...
  AWS_BEDROCKAGENTCORE_API StopCodeInterpreterSessionResult& operator=(
  ...
  template <typename CodeInterpreterIdentifierT = Aws::String>
  StopCodeInterpreterSessionResult& WithCodeInterpreterIdentifier(CodeInterpreterIdentifierT&& value) {
  ...
  template <typename SessionIdT = Aws::String>
  StopCodeInterpreterSessionResult& WithSessionId(SessionIdT&& value) {
  ...
  template <typename LastUpdatedAtT = Aws::Utils::DateTime>
  StopCodeInterpreterSessionResult& WithLastUpdatedAt(LastUpdatedAtT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StopCodeInterpreterSessionResult& WithRequestId(RequestIdT&& value) {
