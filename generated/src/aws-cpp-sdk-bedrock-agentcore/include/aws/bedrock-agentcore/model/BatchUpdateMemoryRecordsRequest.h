...
namespace Model
{
  ...
  public:
    ...
    template<typename MemoryIdT = Aws::String>
    BatchUpdateMemoryRecordsRequest& WithMemoryId(MemoryIdT&& value) { SetMemoryId(std::forward<MemoryIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RecordsT = Aws::Vector<MemoryRecordUpdateInput>>
    BatchUpdateMemoryRecordsRequest& WithRecords(RecordsT&& value) { SetRecords(std::forward<RecordsT>(value)); return *this;}
    template<typename RecordsT = MemoryRecordUpdateInput>
    BatchUpdateMemoryRecordsRequest& AddRecords(RecordsT&& value) { m_recordsHasBeenSet = true; m_records.emplace_back(std::forward<RecordsT>(value)); return *this; }
    ///@}
  private:
