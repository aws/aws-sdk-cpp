 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/bedrock-agentcore-2024-02-28/BrowserEnterprisePolicy">AWS
 * API Reference</a></p>
 */
class BrowserEnterprisePolicy {
 public:
  AWS_BEDROCKAGENTCORE_API BrowserEnterprisePolicy() = default;
  AWS_BEDROCKAGENTCORE_API BrowserEnterprisePolicy(Aws::Utils::Json::JsonView jsonValue);
  AWS_BEDROCKAGENTCORE_API BrowserEnterprisePolicy& operator=(Aws::Utils::Json::JsonView jsonValue);
