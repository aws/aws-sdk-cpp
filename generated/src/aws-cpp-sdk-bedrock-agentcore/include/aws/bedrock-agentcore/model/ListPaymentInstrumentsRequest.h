 ...
 * API Reference</a></p>
 */
class ListPaymentInstrumentsRequest : public BedrockAgentCoreRequest {
 public:
  AWS_BEDROCKAGENTCORE_API ListPaymentInstrumentsRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "ListPaymentInstruments"; }
  ...
  template <typename UserIdT = Aws::String>
  ListPaymentInstrumentsRequest& WithUserId(UserIdT&& value) {
  ...
  template <typename AgentNameT = Aws::String>
  ListPaymentInstrumentsRequest& WithAgentName(AgentNameT&& value) {
  ...
  template <typename PaymentManagerArnT = Aws::String>
  ListPaymentInstrumentsRequest& WithPaymentManagerArn(PaymentManagerArnT&& value) {
  ...
  template <typename PaymentConnectorIdT = Aws::String>
  ListPaymentInstrumentsRequest& WithPaymentConnectorId(PaymentConnectorIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListPaymentInstrumentsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListPaymentInstrumentsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
