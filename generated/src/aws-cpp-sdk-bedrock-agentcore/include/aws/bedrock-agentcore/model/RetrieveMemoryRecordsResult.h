...
class RetrieveMemoryRecordsResult {
 public:
  ...
  void SetMemoryRecordSummaries(MemoryRecordSummariesT&& value) {
    m_memoryRecordSummariesHasBeenSet = true;
    m_memoryRecordSummaries = std::forward<MemoryRecordSummariesT>(value);
  }
  template <typename MemoryRecordSummariesT = Aws::Vector<MemoryRecordSummary>>
  RetrieveMemoryRecordsResult& WithMemoryRecordSummaries(MemoryRecordSummariesT&& value) {
    SetMemoryRecordSummaries(std::forward<MemoryRecordSummariesT>(value));
    return *this;
  }
  template <typename MemoryRecordSummariesT = MemoryRecordSummary>
  RetrieveMemoryRecordsResult& AddMemoryRecordSummaries(MemoryRecordSummariesT&& value) {
    m_memoryRecordSummariesHasBeenSet = true;
    m_memoryRecordSummaries.emplace_back(std::forward<MemoryRecordSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  RetrieveMemoryRecordsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  RetrieveMemoryRecordsResult& WithRequestId(RequestIdT&& value) {
