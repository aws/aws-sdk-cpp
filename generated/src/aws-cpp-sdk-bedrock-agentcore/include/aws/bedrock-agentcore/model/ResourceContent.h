...
class ResourceContent {
 public:
  ...
  inline void SetType(ResourceContentType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline ResourceContent& WithType(ResourceContentType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename UriT = Aws::String>
  ResourceContent& WithUri(UriT&& value) {
  ...
  template <typename MimeTypeT = Aws::String>
  ResourceContent& WithMimeType(MimeTypeT&& value) {
  ...
  template <typename TextT = Aws::String>
  ResourceContent& WithText(TextT&& value) {
  ...
  template <typename BlobT = Aws::Utils::ByteBuffer>
  ResourceContent& WithBlob(BlobT&& value) {
