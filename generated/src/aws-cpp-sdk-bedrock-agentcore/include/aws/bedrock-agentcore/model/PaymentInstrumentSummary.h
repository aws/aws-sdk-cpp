...
class PaymentInstrumentSummary {
 public:
  AWS_BEDROCKAGENTCORE_API PaymentInstrumentSummary() = default;
  AWS_BEDROCKAGENTCORE_API PaymentInstrumentSummary(Aws::Utils::Json::JsonView jsonValue);
  AWS_BEDROCKAGENTCORE_API PaymentInstrumentSummary& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename PaymentInstrumentIdT = Aws::String>
  PaymentInstrumentSummary& WithPaymentInstrumentId(PaymentInstrumentIdT&& value) {
  ...
  template <typename PaymentManagerArnT = Aws::String>
  PaymentInstrumentSummary& WithPaymentManagerArn(PaymentManagerArnT&& value) {
  ...
  template <typename PaymentConnectorIdT = Aws::String>
  PaymentInstrumentSummary& WithPaymentConnectorId(PaymentConnectorIdT&& value) {
  ...
  template <typename UserIdT = Aws::String>
  PaymentInstrumentSummary& WithUserId(UserIdT&& value) {
  ...
  inline PaymentInstrumentSummary& WithPaymentInstrumentType(PaymentInstrumentType value) {
  ...
  inline PaymentInstrumentSummary& WithStatus(PaymentInstrumentStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  PaymentInstrumentSummary& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  PaymentInstrumentSummary& WithUpdatedAt(UpdatedAtT&& value) {
