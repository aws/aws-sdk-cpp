...
class GetWorkloadAccessTokenForJWTResult {
 public:
  ...
  AWS_BEDROCKAGENTCORE_API GetWorkloadAccessTokenForJWTResult& operator=(
  ...
  void SetWorkloadAccessToken(WorkloadAccessTokenT&& value) {
    m_workloadAccessTokenHasBeenSet = true;
    m_workloadAccessToken = std::forward<WorkloadAccessTokenT>(value);
  }
  template <typename WorkloadAccessTokenT = Aws::String>
  GetWorkloadAccessTokenForJWTResult& WithWorkloadAccessToken(WorkloadAccessTokenT&& value) {
    SetWorkloadAccessToken(std::forward<WorkloadAccessTokenT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetWorkloadAccessTokenForJWTResult& WithRequestId(RequestIdT&& value) {
