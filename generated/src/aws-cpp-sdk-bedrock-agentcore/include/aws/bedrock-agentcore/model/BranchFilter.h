...
class BranchFilter {
 public:
  ...
  template <typename NameT = Aws::String>
  BranchFilter& WithName(NameT&& value) {
  ...
  inline void SetIncludeParentBranches(bool value) {
    m_includeParentBranchesHasBeenSet = true;
    m_includeParentBranches = value;
  }
  inline BranchFilter& WithIncludeParentBranches(bool value) {
    SetIncludeParentBranches(value);
    return *this;
  }
  ///@}
 private:
