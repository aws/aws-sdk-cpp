...
class UserIdentifier {
 public:
  ...
  void SetUserToken(UserTokenT&& value) {
    m_userTokenHasBeenSet = true;
    m_userToken = std::forward<UserTokenT>(value);
  }
  template <typename UserTokenT = Aws::String>
  UserIdentifier& WithUserToken(UserTokenT&& value) {
    SetUserToken(std::forward<UserTokenT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename UserIdT = Aws::String>
  UserIdentifier& WithUserId(UserIdT&& value) {
