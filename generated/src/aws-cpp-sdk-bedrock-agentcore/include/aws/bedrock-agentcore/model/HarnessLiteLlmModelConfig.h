 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/bedrock-agentcore-2024-02-28/HarnessLiteLlmModelConfig">AWS
 * API Reference</a></p>
 */
class HarnessLiteLlmModelConfig {
 public:
  AWS_BEDROCKAGENTCORE_API HarnessLiteLlmModelConfig() = default;
  AWS_BEDROCKAGENTCORE_API HarnessLiteLlmModelConfig(Aws::Utils::Json::JsonView jsonValue);
  AWS_BEDROCKAGENTCORE_API HarnessLiteLlmModelConfig& operator=(Aws::Utils::Json::JsonView jsonValue);
