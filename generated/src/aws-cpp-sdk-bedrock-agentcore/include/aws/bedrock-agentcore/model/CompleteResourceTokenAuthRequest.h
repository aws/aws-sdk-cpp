...
namespace Model
{
  ...
  public:
    ...
    template<typename UserIdentifierT = UserIdentifier>
    CompleteResourceTokenAuthRequest& WithUserIdentifier(UserIdentifierT&& value) { SetUserIdentifier(std::forward<UserIdentifierT>(value)); return *this;}
    ///@}
    ...
    template<typename SessionUriT = Aws::String>
    CompleteResourceTokenAuthRequest& WithSessionUri(SessionUriT&& value) { SetSessionUri(std::forward<SessionUriT>(value)); return *this;}
    ///@}
  private:
