...
class InvokeAgentRuntimeResult {
 public:
  ...
  template <typename RuntimeSessionIdT = Aws::String>
  InvokeAgentRuntimeResult& WithRuntimeSessionId(RuntimeSessionIdT&& value) {
  ...
  template <typename McpSessionIdT = Aws::String>
  InvokeAgentRuntimeResult& WithMcpSessionId(McpSessionIdT&& value) {
  ...
  template <typename McpProtocolVersionT = Aws::String>
  InvokeAgentRuntimeResult& WithMcpProtocolVersion(McpProtocolVersionT&& value) {
  ...
  template <typename TraceIdT = Aws::String>
  InvokeAgentRuntimeResult& WithTraceId(TraceIdT&& value) {
  ...
  template <typename TraceParentT = Aws::String>
  InvokeAgentRuntimeResult& WithTraceParent(TraceParentT&& value) {
  ...
  template <typename TraceStateT = Aws::String>
  InvokeAgentRuntimeResult& WithTraceState(TraceStateT&& value) {
  ...
  template <typename BaggageT = Aws::String>
  InvokeAgentRuntimeResult& WithBaggage(BaggageT&& value) {
  ...
  template <typename ContentTypeT = Aws::String>
  InvokeAgentRuntimeResult& WithContentType(ContentTypeT&& value) {
  ...
  inline InvokeAgentRuntimeResult& WithStatusCode(int value) {
    SetStatusCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  InvokeAgentRuntimeResult& WithRequestId(RequestIdT&& value) {
