...
namespace Model
{
  ...
  public:
    ...
    template<typename RuntimeSessionIdT = Aws::String>
    GetAgentCardResult& WithRuntimeSessionId(RuntimeSessionIdT&& value) { SetRuntimeSessionId(std::forward<RuntimeSessionIdT>(value)); return *this;}
    ///@}
    ...
    void SetAgentCard(AgentCardT&& value) { m_agentCardHasBeenSet = true; m_agentCard = std::forward<AgentCardT>(value); }
    template<typename AgentCardT = Aws::Utils::Document>
    GetAgentCardResult& WithAgentCard(AgentCardT&& value) { SetAgentCard(std::forward<AgentCardT>(value)); return *this;}
    ///@}
    ...
    inline GetAgentCardResult& WithStatusCode(int value) { SetStatusCode(value); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    GetAgentCardResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
