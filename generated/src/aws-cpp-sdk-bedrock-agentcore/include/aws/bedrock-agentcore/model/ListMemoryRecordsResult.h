...
class ListMemoryRecordsResult {
 public:
  ...
  template <typename MemoryRecordSummariesT = Aws::Vector<MemoryRecordSummary>>
  ListMemoryRecordsResult& WithMemoryRecordSummaries(MemoryRecordSummariesT&& value) {
  ...
  ListMemoryRecordsResult& AddMemoryRecordSummaries(MemoryRecordSummariesT&& value) {
    m_memoryRecordSummariesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListMemoryRecordsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListMemoryRecordsResult& WithRequestId(RequestIdT&& value) {
