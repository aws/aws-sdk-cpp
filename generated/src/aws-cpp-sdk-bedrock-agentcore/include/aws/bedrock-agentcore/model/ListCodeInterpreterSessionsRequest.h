...
class ListCodeInterpreterSessionsRequest : public BedrockAgentCoreRequest {
 public:
  ...
  template <typename CodeInterpreterIdentifierT = Aws::String>
  ListCodeInterpreterSessionsRequest& WithCodeInterpreterIdentifier(CodeInterpreterIdentifierT&& value) {
  ...
  inline ListCodeInterpreterSessionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListCodeInterpreterSessionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListCodeInterpreterSessionsRequest& WithStatus(CodeInterpreterSessionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
