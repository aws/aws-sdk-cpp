...
class StopCodeInterpreterSessionRequest : public BedrockAgentCoreRequest {
 public:
  ...
  template <typename TraceIdT = Aws::String>
  StopCodeInterpreterSessionRequest& WithTraceId(TraceIdT&& value) {
  ...
  template <typename TraceParentT = Aws::String>
  StopCodeInterpreterSessionRequest& WithTraceParent(TraceParentT&& value) {
  ...
  template <typename CodeInterpreterIdentifierT = Aws::String>
  StopCodeInterpreterSessionRequest& WithCodeInterpreterIdentifier(CodeInterpreterIdentifierT&& value) {
  ...
  template <typename SessionIdT = Aws::String>
  StopCodeInterpreterSessionRequest& WithSessionId(SessionIdT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  StopCodeInterpreterSessionRequest& WithClientToken(ClientTokenT&& value) {
