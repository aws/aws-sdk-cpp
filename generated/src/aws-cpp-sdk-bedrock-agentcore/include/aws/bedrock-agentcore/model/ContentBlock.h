...
class ContentBlock {
 public:
  ...
  inline void SetType(ContentBlockType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline ContentBlock& WithType(ContentBlockType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename DataT = Aws::Utils::ByteBuffer>
  ContentBlock& WithData(DataT&& value) {
  ...
  template <typename MimeTypeT = Aws::String>
  ContentBlock& WithMimeType(MimeTypeT&& value) {
  ...
  template <typename UriT = Aws::String>
  ContentBlock& WithUri(UriT&& value) {
  ...
  template <typename NameT = Aws::String>
  ContentBlock& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  ContentBlock& WithDescription(DescriptionT&& value) {
  ...
  inline ContentBlock& WithSize(long long value) {
    SetSize(value);
    return *this;
  }
  ///@}
  ...
  template <typename ResourceT = ResourceContent>
  ContentBlock& WithResource(ResourceT&& value) {
