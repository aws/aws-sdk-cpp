...
class GetWorkloadAccessTokenForUserIdResult {
 public:
  ...
  AWS_BEDROCKAGENTCORE_API GetWorkloadAccessTokenForUserIdResult& operator=(
  ...
  template <typename WorkloadAccessTokenT = Aws::String>
  GetWorkloadAccessTokenForUserIdResult& WithWorkloadAccessToken(WorkloadAccessTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetWorkloadAccessTokenForUserIdResult& WithRequestId(RequestIdT&& value) {
