...
class StartCodeInterpreterSessionResult {
 public:
  ...
  AWS_BEDROCKAGENTCORE_API StartCodeInterpreterSessionResult& operator=(
  ...
  template <typename CodeInterpreterIdentifierT = Aws::String>
  StartCodeInterpreterSessionResult& WithCodeInterpreterIdentifier(CodeInterpreterIdentifierT&& value) {
  ...
  template <typename SessionIdT = Aws::String>
  StartCodeInterpreterSessionResult& WithSessionId(SessionIdT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  StartCodeInterpreterSessionResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StartCodeInterpreterSessionResult& WithRequestId(RequestIdT&& value) {
