...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/bedrock-agentcore-2024-02-28/ValidationExceptionField">AWS
   * API Reference</a></p>
   */
  class ValidationExceptionField
  {
  public:
    AWS_BEDROCKAGENTCORE_API ValidationExceptionField() = default;
    AWS_BEDROCKAGENTCORE_API ValidationExceptionField(Aws::Utils::Json::JsonView jsonValue);
    AWS_BEDROCKAGENTCORE_API ValidationExceptionField& operator=(Aws::Utils::Json::JsonView jsonValue);
