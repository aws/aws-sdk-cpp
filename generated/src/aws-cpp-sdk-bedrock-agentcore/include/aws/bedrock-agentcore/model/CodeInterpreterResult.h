...
class CodeInterpreterResult {
 public:
  ...
  template <typename ContentT = Aws::Vector<ContentBlock>>
  CodeInterpreterResult& WithContent(ContentT&& value) {
    SetContent(std::forward<ContentT>(value));
    return *this;
  }
  template <typename ContentT = ContentBlock>
  CodeInterpreterResult& AddContent(ContentT&& value) {
    m_contentHasBeenSet = true;
  ...
  void SetStructuredContent(StructuredContentT&& value) {
    m_structuredContentHasBeenSet = true;
    m_structuredContent = std::forward<StructuredContentT>(value);
  }
  template <typename StructuredContentT = ToolResultStructuredContent>
  CodeInterpreterResult& WithStructuredContent(StructuredContentT&& value) {
    SetStructuredContent(std::forward<StructuredContentT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetIsError(bool value) {
    m_isErrorHasBeenSet = true;
    m_isError = value;
  }
  inline CodeInterpreterResult& WithIsError(bool value) {
    SetIsError(value);
    return *this;
  }
  ///@}
