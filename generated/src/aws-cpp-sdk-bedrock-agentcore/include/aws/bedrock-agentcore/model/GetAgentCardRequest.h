...
namespace Model
{
  ...
  public:
    ...
    template<typename RuntimeSessionIdT = Aws::String>
    GetAgentCardRequest& WithRuntimeSessionId(RuntimeSessionIdT&& value) { SetRuntimeSessionId(std::forward<RuntimeSessionIdT>(value)); return *this;}
    ///@}
    ...
    template<typename AgentRuntimeArnT = Aws::String>
    GetAgentCardRequest& WithAgentRuntimeArn(AgentRuntimeArnT&& value) { SetAgentRuntimeArn(std::forward<AgentRuntimeArnT>(value)); return *this;}
    ///@}
    ...
    template<typename QualifierT = Aws::String>
    GetAgentCardRequest& WithQualifier(QualifierT&& value) { SetQualifier(std::forward<QualifierT>(value)); return *this;}
    ///@}
  private:
