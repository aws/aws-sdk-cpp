...
class ListEventsRequest : public BedrockAgentCoreRequest {
 public:
  ...
  template <typename MemoryIdT = Aws::String>
  ListEventsRequest& WithMemoryId(MemoryIdT&& value) {
  ...
  template <typename SessionIdT = Aws::String>
  ListEventsRequest& WithSessionId(SessionIdT&& value) {
  ...
  template <typename ActorIdT = Aws::String>
  ListEventsRequest& WithActorId(ActorIdT&& value) {
  ...
  inline void SetIncludePayloads(bool value) {
    m_includePayloadsHasBeenSet = true;
    m_includePayloads = value;
  }
  inline ListEventsRequest& WithIncludePayloads(bool value) {
    SetIncludePayloads(value);
    return *this;
  }
  ///@}
  ...
  template <typename FilterT = FilterInput>
  ListEventsRequest& WithFilter(FilterT&& value) {
  ...
  inline ListEventsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
