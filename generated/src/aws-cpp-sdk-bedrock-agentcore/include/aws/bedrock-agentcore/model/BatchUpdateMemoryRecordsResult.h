...
namespace Model
{
  ...
  public:
    ...
    AWS_BEDROCKAGENTCORE_API BatchUpdateMemoryRecordsResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ...
    template<typename SuccessfulRecordsT = Aws::Vector<MemoryRecordOutput>>
    BatchUpdateMemoryRecordsResult& WithSuccessfulRecords(SuccessfulRecordsT&& value) { SetSuccessfulRecords(std::forward<SuccessfulRecordsT>(value)); return *this;}
    template<typename SuccessfulRecordsT = MemoryRecordOutput>
    BatchUpdateMemoryRecordsResult& AddSuccessfulRecords(SuccessfulRecordsT&& value) { m_successfulRecordsHasBeenSet = true; m_successfulRecords.emplace_back(std::forward<SuccessfulRecordsT>(value)); return *this; }
    ///@}
    ...
    template<typename FailedRecordsT = Aws::Vector<MemoryRecordOutput>>
    BatchUpdateMemoryRecordsResult& WithFailedRecords(FailedRecordsT&& value) { SetFailedRecords(std::forward<FailedRecordsT>(value)); return *this;}
    template<typename FailedRecordsT = MemoryRecordOutput>
    BatchUpdateMemoryRecordsResult& AddFailedRecords(FailedRecordsT&& value) { m_failedRecordsHasBeenSet = true; m_failedRecords.emplace_back(std::forward<FailedRecordsT>(value)); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    BatchUpdateMemoryRecordsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
