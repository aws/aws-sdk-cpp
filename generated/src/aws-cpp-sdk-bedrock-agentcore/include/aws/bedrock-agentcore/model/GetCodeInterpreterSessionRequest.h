...
class GetCodeInterpreterSessionRequest : public BedrockAgentCoreRequest {
 public:
  ...
  template <typename CodeInterpreterIdentifierT = Aws::String>
  GetCodeInterpreterSessionRequest& WithCodeInterpreterIdentifier(CodeInterpreterIdentifierT&& value) {
  ...
  template <typename SessionIdT = Aws::String>
  GetCodeInterpreterSessionRequest& WithSessionId(SessionIdT&& value) {
