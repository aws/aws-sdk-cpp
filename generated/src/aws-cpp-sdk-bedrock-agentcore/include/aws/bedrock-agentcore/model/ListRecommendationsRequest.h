...
/**
 */
class ListRecommendationsRequest : public BedrockAgentCoreRequest {
 public:
  AWS_BEDROCKAGENTCORE_API ListRecommendationsRequest() = default;
   ...
   */
  inline RecommendationStatus GetStatusFilter() const { return m_statusFilter; }
  inline bool StatusFilterHasBeenSet() const { return m_statusFilterHasBeenSet; }
  inline void SetStatusFilter(RecommendationStatus value) {
    m_statusFilterHasBeenSet = true;
    m_statusFilter = value;
  }
  inline ListRecommendationsRequest& WithStatusFilter(RecommendationStatus value) {
 ...
 private:
  ...
  RecommendationStatus m_statusFilter{RecommendationStatus::NOT_SET};
