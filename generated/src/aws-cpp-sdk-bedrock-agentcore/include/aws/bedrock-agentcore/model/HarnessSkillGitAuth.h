 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/bedrock-agentcore-2024-02-28/HarnessSkillGitAuth">AWS
 * API Reference</a></p>
 */
class HarnessSkillGitAuth {
 public:
  AWS_BEDROCKAGENTCORE_API HarnessSkillGitAuth() = default;
  AWS_BEDROCKAGENTCORE_API HarnessSkillGitAuth(Aws::Utils::Json::JsonView jsonValue);
  AWS_BEDROCKAGENTCORE_API HarnessSkillGitAuth& operator=(Aws::Utils::Json::JsonView jsonValue);
