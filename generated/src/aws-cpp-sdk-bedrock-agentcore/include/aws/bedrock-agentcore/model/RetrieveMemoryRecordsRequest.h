...
class RetrieveMemoryRecordsRequest : public BedrockAgentCoreRequest {
 public:
  ...
  ///@{
  /**
   * <p>The identifier of the AgentCore Memory resource from which to retrieve memory
   * records.</p>
   */
  ...
  template <typename MemoryIdT = Aws::String>
  RetrieveMemoryRecordsRequest& WithMemoryId(MemoryIdT&& value) {
  ...
  template <typename NamespaceT = Aws::String>
  RetrieveMemoryRecordsRequest& WithNamespace(NamespaceT&& value) {
  ...
  template <typename NamespacePathT = Aws::String>
  RetrieveMemoryRecordsRequest& WithNamespacePath(NamespacePathT&& value) {
  ...
  template <typename SearchCriteriaT = SearchCriteria>
  RetrieveMemoryRecordsRequest& WithSearchCriteria(SearchCriteriaT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  RetrieveMemoryRecordsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline RetrieveMemoryRecordsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
