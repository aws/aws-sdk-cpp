...
/**
 * <p>The exception that occurs when the input fails to satisfy the constraints
 * specified by the service. Check the error message for details about which input
 * parameter is invalid and correct your request.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/bedrock-agentcore-2024-02-28/ValidationException">AWS
 * API Reference</a></p>
 */
class ValidationException {
 public:
  AWS_BEDROCKAGENTCORE_API ValidationException() = default;
  AWS_BEDROCKAGENTCORE_API ValidationException(Aws::Utils::Json::JsonView jsonValue);
  AWS_BEDROCKAGENTCORE_API ValidationException& operator=(Aws::Utils::Json::JsonView jsonValue);
