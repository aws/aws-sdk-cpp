 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/bedrock-agentcore-2024-02-28/HarnessTool">AWS
 * API Reference</a></p>
 */
class HarnessTool {
 public:
  AWS_BEDROCKAGENTCORE_API HarnessTool() = default;
  AWS_BEDROCKAGENTCORE_API HarnessTool(Aws::Utils::Json::JsonView jsonValue);
  AWS_BEDROCKAGENTCORE_API HarnessTool& operator=(Aws::Utils::Json::JsonView jsonValue);
