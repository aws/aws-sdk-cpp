...
/**
 */
class ListMemoryExtractionJobsRequest : public BedrockAgentCoreRequest {
 public:
  AWS_BEDROCKAGENTCORE_API ListMemoryExtractionJobsRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "ListMemoryExtractionJobs"; }
  ...
  template <typename MemoryIdT = Aws::String>
  ListMemoryExtractionJobsRequest& WithMemoryId(MemoryIdT&& value) {
  ...
  inline ListMemoryExtractionJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
   ...
   */
  inline const ExtractionJobFilterInput& GetFilter() const { return m_filter; }
  inline bool FilterHasBeenSet() const { return m_filterHasBeenSet; }
  template <typename FilterT = ExtractionJobFilterInput>
  void SetFilter(FilterT&& value) {
    m_filterHasBeenSet = true;
    m_filter = std::forward<FilterT>(value);
  }
  template <typename FilterT = ExtractionJobFilterInput>
  ListMemoryExtractionJobsRequest& WithFilter(FilterT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListMemoryExtractionJobsRequest& WithNextToken(NextTokenT&& value) {
