...
/**
 * <p>Configuration for an OpenAI model provider. Requires an API key stored in
 * AgentCore Identity.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/bedrock-agentcore-2024-02-28/HarnessOpenAiModelConfig">AWS
 * API Reference</a></p>
 */
class HarnessOpenAiModelConfig {
 public:
  AWS_BEDROCKAGENTCORE_API HarnessOpenAiModelConfig() = default;
  AWS_BEDROCKAGENTCORE_API HarnessOpenAiModelConfig(Aws::Utils::Json::JsonView jsonValue);
  AWS_BEDROCKAGENTCORE_API HarnessOpenAiModelConfig& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename ModelIdT = Aws::String>
  HarnessOpenAiModelConfig& WithModelId(ModelIdT&& value) {
  ...
  template <typename ApiKeyArnT = Aws::String>
  HarnessOpenAiModelConfig& WithApiKeyArn(ApiKeyArnT&& value) {
  ...
  inline HarnessOpenAiModelConfig& WithMaxTokens(int value) {
    SetMaxTokens(value);
    return *this;
  }
  ///@}
  ...
  inline HarnessOpenAiModelConfig& WithTemperature(double value) {
  ...
  inline HarnessOpenAiModelConfig& WithTopP(double value) {
    SetTopP(value);
    return *this;
  }
  ///@}
