...
class UpdateBrowserStreamResult {
 public:
  ...
  template <typename BrowserIdentifierT = Aws::String>
  UpdateBrowserStreamResult& WithBrowserIdentifier(BrowserIdentifierT&& value) {
  ...
  template <typename SessionIdT = Aws::String>
  UpdateBrowserStreamResult& WithSessionId(SessionIdT&& value) {
  ...
  template <typename StreamsT = BrowserSessionStream>
  UpdateBrowserStreamResult& WithStreams(StreamsT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  UpdateBrowserStreamResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateBrowserStreamResult& WithRequestId(RequestIdT&& value) {
