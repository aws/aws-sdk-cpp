...
class BrowserSessionSummary {
 public:
  ...
  template <typename BrowserIdentifierT = Aws::String>
  BrowserSessionSummary& WithBrowserIdentifier(BrowserIdentifierT&& value) {
  ...
  template <typename SessionIdT = Aws::String>
  BrowserSessionSummary& WithSessionId(SessionIdT&& value) {
  ...
  template <typename NameT = Aws::String>
  BrowserSessionSummary& WithName(NameT&& value) {
  ...
  inline BrowserSessionSummary& WithStatus(BrowserSessionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  BrowserSessionSummary& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename LastUpdatedAtT = Aws::Utils::DateTime>
  BrowserSessionSummary& WithLastUpdatedAt(LastUpdatedAtT&& value) {
