...
class UpdateBrowserStreamRequest : public BedrockAgentCoreRequest {
 public:
  ...
  template <typename BrowserIdentifierT = Aws::String>
  UpdateBrowserStreamRequest& WithBrowserIdentifier(BrowserIdentifierT&& value) {
  ...
  template <typename SessionIdT = Aws::String>
  UpdateBrowserStreamRequest& WithSessionId(SessionIdT&& value) {
  ...
  void SetStreamUpdate(StreamUpdateT&& value) {
    m_streamUpdateHasBeenSet = true;
    m_streamUpdate = std::forward<StreamUpdateT>(value);
  }
  template <typename StreamUpdateT = StreamUpdate>
  UpdateBrowserStreamRequest& WithStreamUpdate(StreamUpdateT&& value) {
    SetStreamUpdate(std::forward<StreamUpdateT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ClientTokenT = Aws::String>
  UpdateBrowserStreamRequest& WithClientToken(ClientTokenT&& value) {
