...
namespace Model
{
  ...
  public:
    ...
    template<typename MemoryIdT = Aws::String>
    GetMemoryRecordRequest& WithMemoryId(MemoryIdT&& value) { SetMemoryId(std::forward<MemoryIdT>(value)); return *this;}
    ///@}
    ...
    template<typename MemoryRecordIdT = Aws::String>
    GetMemoryRecordRequest& WithMemoryRecordId(MemoryRecordIdT&& value) { SetMemoryRecordId(std::forward<MemoryRecordIdT>(value)); return *this;}
    ///@}
  private:
