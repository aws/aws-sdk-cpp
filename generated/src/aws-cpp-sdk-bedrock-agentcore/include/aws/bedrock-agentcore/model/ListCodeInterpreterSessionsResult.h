...
class ListCodeInterpreterSessionsResult {
 public:
  ...
  AWS_BEDROCKAGENTCORE_API ListCodeInterpreterSessionsResult& operator=(
  ...
  template <typename ItemsT = Aws::Vector<CodeInterpreterSessionSummary>>
  ListCodeInterpreterSessionsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = CodeInterpreterSessionSummary>
  ListCodeInterpreterSessionsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListCodeInterpreterSessionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListCodeInterpreterSessionsResult& WithRequestId(RequestIdT&& value) {
