 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/bedrock-agentcore-2024-02-28/S3FilesConfiguration">AWS
 * API Reference</a></p>
 */
class S3FilesConfiguration {
 public:
  AWS_BEDROCKAGENTCORE_API S3FilesConfiguration() = default;
  AWS_BEDROCKAGENTCORE_API S3FilesConfiguration(Aws::Utils::Json::JsonView jsonValue);
  AWS_BEDROCKAGENTCORE_API S3FilesConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
