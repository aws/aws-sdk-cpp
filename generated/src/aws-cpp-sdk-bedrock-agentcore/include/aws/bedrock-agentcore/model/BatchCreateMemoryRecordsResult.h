...
namespace Model
{
  ...
  public:
    ...
    AWS_BEDROCKAGENTCORE_API BatchCreateMemoryRecordsResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ...
    template<typename SuccessfulRecordsT = Aws::Vector<MemoryRecordOutput>>
    BatchCreateMemoryRecordsResult& WithSuccessfulRecords(SuccessfulRecordsT&& value) { SetSuccessfulRecords(std::forward<SuccessfulRecordsT>(value)); return *this;}
    template<typename SuccessfulRecordsT = MemoryRecordOutput>
    BatchCreateMemoryRecordsResult& AddSuccessfulRecords(SuccessfulRecordsT&& value) { m_successfulRecordsHasBeenSet = true; m_successfulRecords.emplace_back(std::forward<SuccessfulRecordsT>(value)); return *this; }
    ///@}
    ...
    template<typename FailedRecordsT = Aws::Vector<MemoryRecordOutput>>
    BatchCreateMemoryRecordsResult& WithFailedRecords(FailedRecordsT&& value) { SetFailedRecords(std::forward<FailedRecordsT>(value)); return *this;}
    template<typename FailedRecordsT = MemoryRecordOutput>
    BatchCreateMemoryRecordsResult& AddFailedRecords(FailedRecordsT&& value) { m_failedRecordsHasBeenSet = true; m_failedRecords.emplace_back(std::forward<FailedRecordsT>(value)); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    BatchCreateMemoryRecordsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
