...
class EventMetadataFilterExpression {
 public:
  ...
  template <typename LeftT = LeftExpression>
  EventMetadataFilterExpression& WithLeft(LeftT&& value) {
  ...
  inline EventMetadataFilterExpression& WithOperator(OperatorType value) {
    SetOperator(value);
    return *this;
  }
  ///@}
  ...
  template <typename RightT = RightExpression>
  EventMetadataFilterExpression& WithRight(RightT&& value) {
