...
namespace Model
{
  ...
  public:
    ...
    template<typename MemoryIdT = Aws::String>
    BatchCreateMemoryRecordsRequest& WithMemoryId(MemoryIdT&& value) { SetMemoryId(std::forward<MemoryIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RecordsT = Aws::Vector<MemoryRecordCreateInput>>
    BatchCreateMemoryRecordsRequest& WithRecords(RecordsT&& value) { SetRecords(std::forward<RecordsT>(value)); return *this;}
    template<typename RecordsT = MemoryRecordCreateInput>
    BatchCreateMemoryRecordsRequest& AddRecords(RecordsT&& value) { m_recordsHasBeenSet = true; m_records.emplace_back(std::forward<RecordsT>(value)); return *this; }
    ///@}
    ...
    template<typename ClientTokenT = Aws::String>
    BatchCreateMemoryRecordsRequest& WithClientToken(ClientTokenT&& value) { SetClientToken(std::forward<ClientTokenT>(value)); return *this;}
    ///@}
  private:
