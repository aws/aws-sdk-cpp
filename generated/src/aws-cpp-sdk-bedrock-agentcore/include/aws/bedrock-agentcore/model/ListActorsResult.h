...
class ListActorsResult {
 public:
  ...
  void SetActorSummaries(ActorSummariesT&& value) {
    m_actorSummariesHasBeenSet = true;
    m_actorSummaries = std::forward<ActorSummariesT>(value);
  }
  template <typename ActorSummariesT = Aws::Vector<ActorSummary>>
  ListActorsResult& WithActorSummaries(ActorSummariesT&& value) {
    SetActorSummaries(std::forward<ActorSummariesT>(value));
    return *this;
  }
  template <typename ActorSummariesT = ActorSummary>
  ListActorsResult& AddActorSummaries(ActorSummariesT&& value) {
    m_actorSummariesHasBeenSet = true;
    m_actorSummaries.emplace_back(std::forward<ActorSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListActorsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListActorsResult& WithRequestId(RequestIdT&& value) {
