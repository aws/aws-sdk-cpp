...
class StopRuntimeSessionResult {
 public:
  ...
  template <typename RuntimeSessionIdT = Aws::String>
  StopRuntimeSessionResult& WithRuntimeSessionId(RuntimeSessionIdT&& value) {
  ...
  inline StopRuntimeSessionResult& WithStatusCode(int value) {
    SetStatusCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  StopRuntimeSessionResult& WithRequestId(RequestIdT&& value) {
