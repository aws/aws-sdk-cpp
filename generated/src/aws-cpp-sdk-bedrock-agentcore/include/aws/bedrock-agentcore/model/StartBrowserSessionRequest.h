...
namespace Model
{
  ...
  public:
    ...
    template<typename TraceIdT = Aws::String>
    StartBrowserSessionRequest& WithTraceId(TraceIdT&& value) { SetTraceId(std::forward<TraceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename TraceParentT = Aws::String>
    StartBrowserSessionRequest& WithTraceParent(TraceParentT&& value) { SetTraceParent(std::forward<TraceParentT>(value)); return *this;}
    ///@}
