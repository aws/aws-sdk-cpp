...
class StopBrowserSessionRequest : public BedrockAgentCoreRequest {
 public:
  ...
  template <typename TraceIdT = Aws::String>
  StopBrowserSessionRequest& WithTraceId(TraceIdT&& value) {
  ...
  template <typename TraceParentT = Aws::String>
  StopBrowserSessionRequest& WithTraceParent(TraceParentT&& value) {
  ...
  template <typename BrowserIdentifierT = Aws::String>
  StopBrowserSessionRequest& WithBrowserIdentifier(BrowserIdentifierT&& value) {
  ...
  template <typename SessionIdT = Aws::String>
  StopBrowserSessionRequest& WithSessionId(SessionIdT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  StopBrowserSessionRequest& WithClientToken(ClientTokenT&& value) {
