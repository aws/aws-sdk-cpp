 ...
 * <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/bedrock-agentcore-2024-02-28/HarnessBedrockModelConfig">AWS
 * API Reference</a></p>
 */
class HarnessBedrockModelConfig {
 public:
  AWS_BEDROCKAGENTCORE_API HarnessBedrockModelConfig() = default;
  AWS_BEDROCKAGENTCORE_API HarnessBedrockModelConfig(Aws::Utils::Json::JsonView jsonValue);
  AWS_BEDROCKAGENTCORE_API HarnessBedrockModelConfig& operator=(Aws::Utils::Json::JsonView jsonValue);
