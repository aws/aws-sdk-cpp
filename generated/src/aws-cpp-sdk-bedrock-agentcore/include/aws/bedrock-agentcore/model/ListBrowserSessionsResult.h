...
class ListBrowserSessionsResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<BrowserSessionSummary>>
  ListBrowserSessionsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = BrowserSessionSummary>
  ListBrowserSessionsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListBrowserSessionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListBrowserSessionsResult& WithRequestId(RequestIdT&& value) {
