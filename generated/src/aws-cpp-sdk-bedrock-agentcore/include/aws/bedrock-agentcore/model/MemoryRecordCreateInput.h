...
namespace Model
{
  ...
  public:
    ...
    template<typename RequestIdentifierT = Aws::String>
    MemoryRecordCreateInput& WithRequestIdentifier(RequestIdentifierT&& value) { SetRequestIdentifier(std::forward<RequestIdentifierT>(value)); return *this;}
    ///@}
    ...
    template<typename NamespacesT = Aws::Vector<Aws::String>>
    MemoryRecordCreateInput& WithNamespaces(NamespacesT&& value) { SetNamespaces(std::forward<NamespacesT>(value)); return *this;}
    template<typename NamespacesT = Aws::String>
    MemoryRecordCreateInput& AddNamespaces(NamespacesT&& value) { m_namespacesHasBeenSet = true; m_namespaces.emplace_back(std::forward<NamespacesT>(value)); return *this; }
    ///@}
    ...
    template<typename ContentT = MemoryContent>
    MemoryRecordCreateInput& WithContent(ContentT&& value) { SetContent(std::forward<ContentT>(value)); return *this;}
    ///@}
    ...
    template<typename TimestampT = Aws::Utils::DateTime>
    MemoryRecordCreateInput& WithTimestamp(TimestampT&& value) { SetTimestamp(std::forward<TimestampT>(value)); return *this;}
    ///@}
    ...
    template<typename MemoryStrategyIdT = Aws::String>
    MemoryRecordCreateInput& WithMemoryStrategyId(MemoryStrategyIdT&& value) { SetMemoryStrategyId(std::forward<MemoryStrategyIdT>(value)); return *this;}
    ///@}
  private:
