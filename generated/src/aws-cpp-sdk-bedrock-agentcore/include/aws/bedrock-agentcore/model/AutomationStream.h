...
class AutomationStream {
 public:
  ...
  template <typename StreamEndpointT = Aws::String>
  AutomationStream& WithStreamEndpoint(StreamEndpointT&& value) {
  ...
  inline void SetStreamStatus(AutomationStreamStatus value) {
    m_streamStatusHasBeenSet = true;
    m_streamStatus = value;
  }
  inline AutomationStream& WithStreamStatus(AutomationStreamStatus value) {
