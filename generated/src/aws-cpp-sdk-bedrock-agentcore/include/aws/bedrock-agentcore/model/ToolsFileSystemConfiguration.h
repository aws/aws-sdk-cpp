 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/bedrock-agentcore-2024-02-28/ToolsFileSystemConfiguration">AWS
 * API Reference</a></p>
 */
class ToolsFileSystemConfiguration {
 public:
  AWS_BEDROCKAGENTCORE_API ToolsFileSystemConfiguration() = default;
  AWS_BEDROCKAGENTCORE_API ToolsFileSystemConfiguration(Aws::Utils::Json::JsonView jsonValue);
  AWS_BEDROCKAGENTCORE_API ToolsFileSystemConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
