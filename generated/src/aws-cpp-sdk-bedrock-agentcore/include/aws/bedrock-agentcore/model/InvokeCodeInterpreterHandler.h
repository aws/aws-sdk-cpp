...
namespace Model {
enum class InvokeCodeInterpreterEventType { INITIAL_RESPONSE, RESULT, UNKNOWN };
...
class InvokeCodeInterpreterHandler : public Aws::Utils::Event::EventStreamHandler {
  ...
  typedef std::function<void(const InvokeCodeInterpreterInitialResponse&, const Utils::Event::InitialResponseType)>
      InvokeCodeInterpreterInitialResponseCallbackEx;
 ...
 public:
   ...
   * @param callback
   */
  inline void SetInitialResponseCallbackEx(const InvokeCodeInterpreterInitialResponseCallbackEx& callback) {
  ...
  inline void SetInitialResponseCallback(const InvokeCodeInterpreterInitialResponseCallback& noArgCallback) {
    m_onInitialResponse = [noArgCallback](const InvokeCodeInterpreterInitialResponse& rs, const Utils::Event::InitialResponseType) {
