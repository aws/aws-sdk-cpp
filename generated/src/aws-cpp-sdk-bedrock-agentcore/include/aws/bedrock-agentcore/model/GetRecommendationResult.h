...
class GetRecommendationResult {
 public:
  AWS_BEDROCKAGENTCORE_API GetRecommendationResult() = default;
  AWS_BEDROCKAGENTCORE_API GetRecommendationResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_BEDROCKAGENTCORE_API GetRecommendationResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename RecommendationArnT = Aws::String>
  GetRecommendationResult& WithRecommendationArn(RecommendationArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  GetRecommendationResult& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  GetRecommendationResult& WithDescription(DescriptionT&& value) {
  ...
  inline GetRecommendationResult& WithType(RecommendationType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename RecommendationConfigT = RecommendationConfig>
  GetRecommendationResult& WithRecommendationConfig(RecommendationConfigT&& value) {
  ...
  inline GetRecommendationResult& WithStatus(RecommendationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  GetRecommendationResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  GetRecommendationResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  ///@{
  /**
   * <p>The result of the recommendation, containing the optimized system prompt or
   * tool descriptions. Only present when the recommendation status is
   * <code>COMPLETED</code>.</p>
   */
  inline const RecommendationResult& GetGetRecommendationResult() const { return m_recommendationResult; }
  template <typename RecommendationResultT = RecommendationResult>
  void SetRecommendationResult(RecommendationResultT&& value) {
    m_recommendationResultHasBeenSet = true;
    m_recommendationResult = std::forward<RecommendationResultT>(value);
  }
  template <typename RecommendationResultT = RecommendationResult>
  GetRecommendationResult& WithRecommendationResult(RecommendationResultT&& value) {
    SetRecommendationResult(std::forward<RecommendationResultT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename KmsKeyArnT = Aws::String>
  GetRecommendationResult& WithKmsKeyArn(KmsKeyArnT&& value) {
 ...
 private:
  ...
  RecommendationResult m_recommendationResult;
  ...
  bool m_recommendationResultHasBeenSet = false;
