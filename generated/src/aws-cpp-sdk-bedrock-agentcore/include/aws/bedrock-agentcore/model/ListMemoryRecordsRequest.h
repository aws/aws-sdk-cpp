...
class ListMemoryRecordsRequest : public BedrockAgentCoreRequest {
 public:
  ...
  template <typename MemoryIdT = Aws::String>
  ListMemoryRecordsRequest& WithMemoryId(MemoryIdT&& value) {
  ...
  template <typename NamespaceT = Aws::String>
  ListMemoryRecordsRequest& WithNamespace(NamespaceT&& value) {
  ...
  template <typename MemoryStrategyIdT = Aws::String>
  ListMemoryRecordsRequest& WithMemoryStrategyId(MemoryStrategyIdT&& value) {
  ...
  inline ListMemoryRecordsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListMemoryRecordsRequest& WithNextToken(NextTokenT&& value) {
