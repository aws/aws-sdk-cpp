...
class ListBrowserSessionsRequest : public BedrockAgentCoreRequest {
 public:
  ...
  template <typename BrowserIdentifierT = Aws::String>
  ListBrowserSessionsRequest& WithBrowserIdentifier(BrowserIdentifierT&& value) {
  ...
  inline ListBrowserSessionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListBrowserSessionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListBrowserSessionsRequest& WithStatus(BrowserSessionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
