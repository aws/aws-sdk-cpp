...
class BrowserSessionStream {
 public:
  ...
  void SetAutomationStream(AutomationStreamT&& value) {
    m_automationStreamHasBeenSet = true;
    m_automationStream = std::forward<AutomationStreamT>(value);
  }
  template <typename AutomationStreamT = AutomationStream>
  BrowserSessionStream& WithAutomationStream(AutomationStreamT&& value) {
    SetAutomationStream(std::forward<AutomationStreamT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLiveViewStream(LiveViewStreamT&& value) {
    m_liveViewStreamHasBeenSet = true;
    m_liveViewStream = std::forward<LiveViewStreamT>(value);
  }
  template <typename LiveViewStreamT = LiveViewStream>
  BrowserSessionStream& WithLiveViewStream(LiveViewStreamT&& value) {
    SetLiveViewStream(std::forward<LiveViewStreamT>(value));
    return *this;
  }
  ///@}
 private:
