...
MouseClickResult::MouseClickResult(JsonView jsonValue) { *this = jsonValue; }

MouseClickResult& MouseClickResult::operator=(JsonView jsonValue) {
...
JsonValue MouseClickResult::Jsonize() const {
  JsonValue payload;
