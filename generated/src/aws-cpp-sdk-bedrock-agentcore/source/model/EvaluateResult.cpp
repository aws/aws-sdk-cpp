...
EvaluateResult::EvaluateResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

EvaluateResult& EvaluateResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
