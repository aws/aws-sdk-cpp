...
Aws::String GetPaymentInstrumentRequest::SerializePayload() const {
  JsonValue payload;
...
Aws::Http::HeaderValueCollection GetPaymentInstrumentRequest::GetRequestSpecificHeaders() const {
