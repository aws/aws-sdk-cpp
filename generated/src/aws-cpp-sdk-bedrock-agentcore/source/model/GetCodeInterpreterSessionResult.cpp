...
GetCodeInterpreterSessionResult::GetCodeInterpreterSessionResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

GetCodeInterpreterSessionResult& GetCodeInterpreterSessionResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
