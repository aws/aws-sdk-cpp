...
KeyShortcutResult::KeyShortcutResult(JsonView jsonValue) { *this = jsonValue; }

KeyShortcutResult& KeyShortcutResult::operator=(JsonView jsonValue) {
...
JsonValue KeyShortcutResult::Jsonize() const {
  JsonValue payload;
