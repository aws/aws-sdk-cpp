...
BrowserAction::BrowserAction(JsonView jsonValue) { *this = jsonValue; }

BrowserAction& BrowserAction::operator=(JsonView jsonValue) {
...
JsonValue BrowserAction::Jsonize() const {
  JsonValue payload;
