...
HarnessContentBlockDelta::HarnessContentBlockDelta(JsonView jsonValue) { *this = jsonValue; }

HarnessContentBlockDelta& HarnessContentBlockDelta::operator=(JsonView jsonValue) {
...
JsonValue HarnessContentBlockDelta::Jsonize() const {
  JsonValue payload;
