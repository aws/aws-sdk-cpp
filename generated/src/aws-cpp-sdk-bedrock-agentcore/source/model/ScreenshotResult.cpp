...
ScreenshotResult::ScreenshotResult(JsonView jsonValue) { *this = jsonValue; }

ScreenshotResult& ScreenshotResult::operator=(JsonView jsonValue) {
...
JsonValue ScreenshotResult::Jsonize() const {
  JsonValue payload;
