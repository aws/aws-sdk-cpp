...
ToolDescriptionTextInput::ToolDescriptionTextInput(JsonView jsonValue) { *this = jsonValue; }

ToolDescriptionTextInput& ToolDescriptionTextInput::operator=(JsonView jsonValue) {
...
JsonValue ToolDescriptionTextInput::Jsonize() const {
  JsonValue payload;
