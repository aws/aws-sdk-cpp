...
UserIntentCluster::UserIntentCluster(JsonView jsonValue) { *this = jsonValue; }

UserIntentCluster& UserIntentCluster::operator=(JsonView jsonValue) {
...
JsonValue UserIntentCluster::Jsonize() const {
  JsonValue payload;
