...
SaveBrowserSessionProfileResult::SaveBrowserSessionProfileResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

SaveBrowserSessionProfileResult& SaveBrowserSessionProfileResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
