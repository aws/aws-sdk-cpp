...
PaymentSession::PaymentSession(JsonView jsonValue) { *this = jsonValue; }

PaymentSession& PaymentSession::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("availableLimits")) {
    m_availableLimits = jsonValue.GetObject("availableLimits");
...
JsonValue PaymentSession::Jsonize() const {
  JsonValue payload;
  ...
  if (m_availableLimitsHasBeenSet) {
    payload.WithObject("availableLimits", m_availableLimits.Jsonize());
  }
