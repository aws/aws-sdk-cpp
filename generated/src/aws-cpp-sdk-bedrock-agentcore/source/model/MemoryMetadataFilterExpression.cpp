...
MemoryMetadataFilterExpression::MemoryMetadataFilterExpression(JsonView jsonValue) { *this = jsonValue; }

MemoryMetadataFilterExpression& MemoryMetadataFilterExpression::operator=(JsonView jsonValue) {
...
JsonValue MemoryMetadataFilterExpression::Jsonize() const {
  JsonValue payload;
