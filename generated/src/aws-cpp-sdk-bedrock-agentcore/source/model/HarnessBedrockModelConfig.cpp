...
HarnessBedrockModelConfig::HarnessBedrockModelConfig(JsonView jsonValue) { *this = jsonValue; }

HarnessBedrockModelConfig& HarnessBedrockModelConfig::operator=(JsonView jsonValue) {
...
JsonValue HarnessBedrockModelConfig::Jsonize() const {
  JsonValue payload;
