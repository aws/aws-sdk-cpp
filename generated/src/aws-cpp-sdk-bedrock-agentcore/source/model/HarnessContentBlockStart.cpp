...
HarnessContentBlockStart::HarnessContentBlockStart(JsonView jsonValue) { *this = jsonValue; }

HarnessContentBlockStart& HarnessContentBlockStart::operator=(JsonView jsonValue) {
...
JsonValue HarnessContentBlockStart::Jsonize() const {
  JsonValue payload;
