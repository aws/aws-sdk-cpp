...
DeleteABTestResult::DeleteABTestResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

DeleteABTestResult& DeleteABTestResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
