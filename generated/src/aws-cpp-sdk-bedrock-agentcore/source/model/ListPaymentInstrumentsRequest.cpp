...
Aws::String ListPaymentInstrumentsRequest::SerializePayload() const {
  JsonValue payload;
...
Aws::Http::HeaderValueCollection ListPaymentInstrumentsRequest::GetRequestSpecificHeaders() const {
