...
AgentCardDefinition::AgentCardDefinition(JsonView jsonValue) { *this = jsonValue; }

AgentCardDefinition& AgentCardDefinition::operator=(JsonView jsonValue) {
...
JsonValue AgentCardDefinition::Jsonize() const {
  JsonValue payload;
