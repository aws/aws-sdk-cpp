...
ListMemoryExtractionJobsResult::ListMemoryExtractionJobsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

ListMemoryExtractionJobsResult& ListMemoryExtractionJobsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
