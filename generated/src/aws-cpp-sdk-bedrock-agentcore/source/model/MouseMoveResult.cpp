...
MouseMoveResult::MouseMoveResult(JsonView jsonValue) { *this = jsonValue; }

MouseMoveResult& MouseMoveResult::operator=(JsonView jsonValue) {
...
JsonValue MouseMoveResult::Jsonize() const {
  JsonValue payload;
