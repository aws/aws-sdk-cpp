...
InvokeCodeInterpreterInitialResponse::InvokeCodeInterpreterInitialResponse(JsonView jsonValue) { *this = jsonValue; }
...
InvokeCodeInterpreterInitialResponse::InvokeCodeInterpreterInitialResponse(const Http::HeaderValueCollection& headers)
    : InvokeCodeInterpreterInitialResponse() {
