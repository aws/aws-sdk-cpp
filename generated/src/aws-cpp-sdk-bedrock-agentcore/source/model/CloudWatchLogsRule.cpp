...
CloudWatchLogsRule::CloudWatchLogsRule(JsonView jsonValue) { *this = jsonValue; }

CloudWatchLogsRule& CloudWatchLogsRule::operator=(JsonView jsonValue) {
...
JsonValue CloudWatchLogsRule::Jsonize() const {
  JsonValue payload;
