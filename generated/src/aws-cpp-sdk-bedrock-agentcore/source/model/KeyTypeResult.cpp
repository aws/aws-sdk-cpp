...
KeyTypeResult::KeyTypeResult(JsonView jsonValue) { *this = jsonValue; }

KeyTypeResult& KeyTypeResult::operator=(JsonView jsonValue) {
...
JsonValue KeyTypeResult::Jsonize() const {
  JsonValue payload;
