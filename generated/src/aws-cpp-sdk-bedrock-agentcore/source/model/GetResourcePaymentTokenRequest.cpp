...
Aws::String GetResourcePaymentTokenRequest::SerializePayload() const {
  JsonValue payload;
  ...
  if (m_paymentTokenRequestHasBeenSet) {
    payload.WithObject("paymentTokenRequest", m_paymentTokenRequest.Jsonize());
  }
