...
Aws::String DeletePaymentSessionRequest::SerializePayload() const {
  JsonValue payload;
...
Aws::Http::HeaderValueCollection DeletePaymentSessionRequest::GetRequestSpecificHeaders() const {
