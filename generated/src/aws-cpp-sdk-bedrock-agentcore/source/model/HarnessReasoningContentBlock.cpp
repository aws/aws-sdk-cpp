...
HarnessReasoningContentBlock::HarnessReasoningContentBlock(JsonView jsonValue) { *this = jsonValue; }

HarnessReasoningContentBlock& HarnessReasoningContentBlock::operator=(JsonView jsonValue) {
...
JsonValue HarnessReasoningContentBlock::Jsonize() const {
  JsonValue payload;
