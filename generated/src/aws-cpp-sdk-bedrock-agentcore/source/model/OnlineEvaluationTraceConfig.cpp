...
OnlineEvaluationTraceConfig::OnlineEvaluationTraceConfig(JsonView jsonValue) { *this = jsonValue; }

OnlineEvaluationTraceConfig& OnlineEvaluationTraceConfig::operator=(JsonView jsonValue) {
...
JsonValue OnlineEvaluationTraceConfig::Jsonize() const {
  JsonValue payload;
