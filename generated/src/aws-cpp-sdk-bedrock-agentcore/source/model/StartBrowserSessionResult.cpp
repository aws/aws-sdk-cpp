...
StartBrowserSessionResult::StartBrowserSessionResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

StartBrowserSessionResult& StartBrowserSessionResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
