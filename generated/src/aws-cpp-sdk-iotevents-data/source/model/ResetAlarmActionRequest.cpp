...
ResetAlarmActionRequest::ResetAlarmActionRequest(JsonView jsonValue) { *this = jsonValue; }

ResetAlarmActionRequest& ResetAlarmActionRequest::operator=(JsonView jsonValue) {
...
JsonValue ResetAlarmActionRequest::Jsonize() const {
  JsonValue payload;
