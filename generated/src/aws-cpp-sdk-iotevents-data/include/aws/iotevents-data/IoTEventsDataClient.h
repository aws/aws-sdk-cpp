...
namespace IoTEventsData
{
   ...
   */
  class AWS_IOTEVENTSDATA_API IoTEventsDataClient : Aws::Client::ClientWithAsyncTemplateMethods<IoTEventsDataClient>,
    smithy::client::AwsSmithyClientT<Aws::IoTEventsData::SERVICE_NAME,
