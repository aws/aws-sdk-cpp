...
class AWS_IOTEVENTSDATA_API IoTEventsDataClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  IoTEventsDataClient(const Aws::IoTEventsData::IoTEventsDataClientConfiguration& clientConfiguration =
  ...
  IoTEventsDataClient(const Aws::Auth::AWSCredentials& credentials,
                      std::shared_ptr<IoTEventsDataEndpointProviderBase> endpointProvider = nullptr,
                      const Aws::IoTEventsData::IoTEventsDataClientConfiguration& clientConfiguration =
                          Aws::IoTEventsData::IoTEventsDataClientConfiguration());
  ...
  /**
   * A Callable wrapper for BatchAcknowledgeAlarm that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchAcknowledgeAlarm that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchAcknowledgeAlarmRequestT = Model::BatchAcknowledgeAlarmRequest>
  void BatchAcknowledgeAlarmAsync(const BatchAcknowledgeAlarmRequestT& request, const BatchAcknowledgeAlarmResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for BatchDeleteDetector that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchDeleteDetector that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename BatchDeleteDetectorRequestT = Model::BatchDeleteDetectorRequest>
  void BatchDeleteDetectorAsync(const BatchDeleteDetectorRequestT& request, const BatchDeleteDetectorResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchDisableAlarm that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchDisableAlarm that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename BatchDisableAlarmRequestT = Model::BatchDisableAlarmRequest>
  void BatchDisableAlarmAsync(const BatchDisableAlarmRequestT& request, const BatchDisableAlarmResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchEnableAlarm that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchEnableAlarm that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename BatchEnableAlarmRequestT = Model::BatchEnableAlarmRequest>
  void BatchEnableAlarmAsync(const BatchEnableAlarmRequestT& request, const BatchEnableAlarmResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for BatchResetAlarm that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename BatchResetAlarmRequestT = Model::BatchResetAlarmRequest>
  void BatchResetAlarmAsync(const BatchResetAlarmRequestT& request, const BatchResetAlarmResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchSnoozeAlarm that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchSnoozeAlarm that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename BatchSnoozeAlarmRequestT = Model::BatchSnoozeAlarmRequest>
  void BatchSnoozeAlarmAsync(const BatchSnoozeAlarmRequestT& request, const BatchSnoozeAlarmResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchUpdateDetector that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchUpdateDetector that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename BatchUpdateDetectorRequestT = Model::BatchUpdateDetectorRequest>
  void BatchUpdateDetectorAsync(const BatchUpdateDetectorRequestT& request, const BatchUpdateDetectorResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeAlarm that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeAlarmRequestT = Model::DescribeAlarmRequest>
  void DescribeAlarmAsync(const DescribeAlarmRequestT& request, const DescribeAlarmResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListAlarms that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListAlarmsRequestT = Model::ListAlarmsRequest>
  void ListAlarmsAsync(const ListAlarmsRequestT& request, const ListAlarmsResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListDetectors that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListDetectorsRequestT = Model::ListDetectorsRequest>
  void ListDetectorsAsync(const ListDetectorsRequestT& request, const ListDetectorsResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&IoTEventsDataClient::ListDetectors, request, handler, context);
  }

  virtual void OverrideEndpoint(const Aws::String& endpoint);
  virtual std::shared_ptr<IoTEventsDataEndpointProviderBase>& accessEndpointProvider();
