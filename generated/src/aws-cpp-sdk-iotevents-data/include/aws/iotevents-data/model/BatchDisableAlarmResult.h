...
namespace Model
{
  ...
  public:
     ...
     * entry that failed.</p>
     */
    inline BatchDisableAlarmResult& WithErrorEntries(const Aws::Vector<BatchAlarmActionErrorEntry>& value) { SetErrorEntries(value); return *this;}
     ...
     * entry that failed.</p>
     */
    inline BatchDisableAlarmResult& WithErrorEntries(Aws::Vector<BatchAlarmActionErrorEntry>&& value) { SetErrorEntries(std::move(value)); return *this;}
     ...
     * entry that failed.</p>
     */
    inline BatchDisableAlarmResult& AddErrorEntries(const BatchAlarmActionErrorEntry& value) { m_errorEntries.push_back(value); return *this; }
     ...
     * entry that failed.</p>
     */
    inline BatchDisableAlarmResult& AddErrorEntries(BatchAlarmActionErrorEntry&& value) { m_errorEntries.push_back(std::move(value)); return *this; }
    ...
    inline BatchDisableAlarmResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline BatchDisableAlarmResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline BatchDisableAlarmResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
