...
class ListAlarmsRequest : public IoTEventsDataRequest {
 public:
  ...
  template <typename AlarmModelNameT = Aws::String>
  ListAlarmsRequest& WithAlarmModelName(AlarmModelNameT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListAlarmsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListAlarmsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
