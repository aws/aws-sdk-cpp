...
class EnableAlarmActionRequest {
 public:
  ...
  template <typename RequestIdT = Aws::String>
  EnableAlarmActionRequest& WithRequestId(RequestIdT&& value) {
  ...
  template <typename AlarmModelNameT = Aws::String>
  EnableAlarmActionRequest& WithAlarmModelName(AlarmModelNameT&& value) {
  ...
  template <typename KeyValueT = Aws::String>
  EnableAlarmActionRequest& WithKeyValue(KeyValueT&& value) {
  ...
  template <typename NoteT = Aws::String>
  EnableAlarmActionRequest& WithNote(NoteT&& value) {
