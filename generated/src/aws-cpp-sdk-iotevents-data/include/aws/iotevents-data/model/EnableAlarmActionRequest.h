...
namespace Model
{
  ...
  {
  public:
    AWS_IOTEVENTSDATA_API EnableAlarmActionRequest() = default;
    ...
    template<typename RequestIdT = Aws::String>
    EnableAlarmActionRequest& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
    ...
    template<typename AlarmModelNameT = Aws::String>
    EnableAlarmActionRequest& WithAlarmModelName(AlarmModelNameT&& value) { SetAlarmModelName(std::forward<AlarmModelNameT>(value)); return *this;}
    ///@}
    ...
    template<typename KeyValueT = Aws::String>
    EnableAlarmActionRequest& WithKeyValue(KeyValueT&& value) { SetKeyValue(std::forward<KeyValueT>(value)); return *this;}
    ///@}
    ...
    template<typename NoteT = Aws::String>
    EnableAlarmActionRequest& WithNote(NoteT&& value) { SetNote(std::forward<NoteT>(value)); return *this;}
    ///@}
  private:
