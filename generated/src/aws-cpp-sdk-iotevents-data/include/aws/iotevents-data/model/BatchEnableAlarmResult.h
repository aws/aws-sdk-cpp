...
namespace Model
{
  ...
  {
  public:
    AWS_IOTEVENTSDATA_API BatchEnableAlarmResult() = default;
    ...
    template<typename ErrorEntriesT = Aws::Vector<BatchAlarmActionErrorEntry>>
    BatchEnableAlarmResult& WithErrorEntries(ErrorEntriesT&& value) { SetErrorEntries(std::forward<ErrorEntriesT>(value)); return *this;}
    template<typename ErrorEntriesT = BatchAlarmActionErrorEntry>
    BatchEnableAlarmResult& AddErrorEntries(ErrorEntriesT&& value) { m_errorEntriesHasBeenSet = true; m_errorEntries.emplace_back(std::forward<ErrorEntriesT>(value)); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    BatchEnableAlarmResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
