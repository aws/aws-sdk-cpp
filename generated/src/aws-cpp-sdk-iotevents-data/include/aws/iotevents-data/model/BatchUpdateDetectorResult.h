...
class BatchUpdateDetectorResult {
 public:
   ...
   */
  inline const Aws::Vector<BatchUpdateDetectorErrorEntry>& GetBatchUpdateDetectorErrorEntries() const {
    return m_batchUpdateDetectorErrorEntries;
  }
  ...
  void SetBatchUpdateDetectorErrorEntries(BatchUpdateDetectorErrorEntriesT&& value) {
    ...
    m_batchUpdateDetectorErrorEntries = std::forward<BatchUpdateDetectorErrorEntriesT>(value);
  }
  template <typename BatchUpdateDetectorErrorEntriesT = Aws::Vector<BatchUpdateDetectorErrorEntry>>
  BatchUpdateDetectorResult& WithBatchUpdateDetectorErrorEntries(BatchUpdateDetectorErrorEntriesT&& value) {
    SetBatchUpdateDetectorErrorEntries(std::forward<BatchUpdateDetectorErrorEntriesT>(value));
    return *this;
  }
  ...
  BatchUpdateDetectorResult& AddBatchUpdateDetectorErrorEntries(BatchUpdateDetectorErrorEntriesT&& value) {
    m_batchUpdateDetectorErrorEntriesHasBeenSet = true;
    m_batchUpdateDetectorErrorEntries.emplace_back(std::forward<BatchUpdateDetectorErrorEntriesT>(value));
    return *this;
  }
  ///@}
