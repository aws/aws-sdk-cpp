...
class BatchDeleteDetectorResult {
 public:
   ...
   */
  inline const Aws::Vector<BatchDeleteDetectorErrorEntry>& GetBatchDeleteDetectorErrorEntries() const {
    return m_batchDeleteDetectorErrorEntries;
  }
  ...
  void SetBatchDeleteDetectorErrorEntries(BatchDeleteDetectorErrorEntriesT&& value) {
    ...
    m_batchDeleteDetectorErrorEntries = std::forward<BatchDeleteDetectorErrorEntriesT>(value);
  }
  template <typename BatchDeleteDetectorErrorEntriesT = Aws::Vector<BatchDeleteDetectorErrorEntry>>
  BatchDeleteDetectorResult& WithBatchDeleteDetectorErrorEntries(BatchDeleteDetectorErrorEntriesT&& value) {
    SetBatchDeleteDetectorErrorEntries(std::forward<BatchDeleteDetectorErrorEntriesT>(value));
    return *this;
  }
  ...
  BatchDeleteDetectorResult& AddBatchDeleteDetectorErrorEntries(BatchDeleteDetectorErrorEntriesT&& value) {
    m_batchDeleteDetectorErrorEntriesHasBeenSet = true;
    m_batchDeleteDetectorErrorEntries.emplace_back(std::forward<BatchDeleteDetectorErrorEntriesT>(value));
    return *this;
  }
  ///@}
