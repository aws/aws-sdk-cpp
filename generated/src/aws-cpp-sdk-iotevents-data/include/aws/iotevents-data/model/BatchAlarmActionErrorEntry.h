...
class BatchAlarmActionErrorEntry {
 public:
  ...
  template <typename RequestIdT = Aws::String>
  BatchAlarmActionErrorEntry& WithRequestId(RequestIdT&& value) {
  ...
  inline BatchAlarmActionErrorEntry& WithErrorCode(ErrorCode value) {
    SetErrorCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename ErrorMessageT = Aws::String>
  BatchAlarmActionErrorEntry& WithErrorMessage(ErrorMessageT&& value) {
