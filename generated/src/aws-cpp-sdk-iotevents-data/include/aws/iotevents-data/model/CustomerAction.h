...
class CustomerAction {
 public:
  ...
  inline void SetActionName(CustomerActionName value) {
    m_actionNameHasBeenSet = true;
    m_actionName = value;
  }
  inline CustomerAction& WithActionName(CustomerActionName value) {
    SetActionName(value);
    return *this;
  }
  ///@}
  ...
  void SetSnoozeActionConfiguration(SnoozeActionConfigurationT&& value) {
    ...
    m_snoozeActionConfiguration = std::forward<SnoozeActionConfigurationT>(value);
  }
  template <typename SnoozeActionConfigurationT = SnoozeActionConfiguration>
  CustomerAction& WithSnoozeActionConfiguration(SnoozeActionConfigurationT&& value) {
    SetSnoozeActionConfiguration(std::forward<SnoozeActionConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEnableActionConfiguration(EnableActionConfigurationT&& value) {
    ...
    m_enableActionConfiguration = std::forward<EnableActionConfigurationT>(value);
  }
  template <typename EnableActionConfigurationT = EnableActionConfiguration>
  CustomerAction& WithEnableActionConfiguration(EnableActionConfigurationT&& value) {
    SetEnableActionConfiguration(std::forward<EnableActionConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDisableActionConfiguration(DisableActionConfigurationT&& value) {
    ...
    m_disableActionConfiguration = std::forward<DisableActionConfigurationT>(value);
  }
  template <typename DisableActionConfigurationT = DisableActionConfiguration>
  CustomerAction& WithDisableActionConfiguration(DisableActionConfigurationT&& value) {
    SetDisableActionConfiguration(std::forward<DisableActionConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAcknowledgeActionConfiguration(AcknowledgeActionConfigurationT&& value) {
    ...
    m_acknowledgeActionConfiguration = std::forward<AcknowledgeActionConfigurationT>(value);
  }
  template <typename AcknowledgeActionConfigurationT = AcknowledgeActionConfiguration>
  CustomerAction& WithAcknowledgeActionConfiguration(AcknowledgeActionConfigurationT&& value) {
    SetAcknowledgeActionConfiguration(std::forward<AcknowledgeActionConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetResetActionConfiguration(ResetActionConfigurationT&& value) {
    ...
    m_resetActionConfiguration = std::forward<ResetActionConfigurationT>(value);
  }
  template <typename ResetActionConfigurationT = ResetActionConfiguration>
  CustomerAction& WithResetActionConfiguration(ResetActionConfigurationT&& value) {
    SetResetActionConfiguration(std::forward<ResetActionConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
