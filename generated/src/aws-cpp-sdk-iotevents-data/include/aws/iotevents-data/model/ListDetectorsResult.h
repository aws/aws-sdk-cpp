...
class ListDetectorsResult {
 public:
  ...
  void SetDetectorSummaries(DetectorSummariesT&& value) {
    m_detectorSummariesHasBeenSet = true;
    m_detectorSummaries = std::forward<DetectorSummariesT>(value);
  }
  template <typename DetectorSummariesT = Aws::Vector<DetectorSummary>>
  ListDetectorsResult& WithDetectorSummaries(DetectorSummariesT&& value) {
    SetDetectorSummaries(std::forward<DetectorSummariesT>(value));
    return *this;
  }
  template <typename DetectorSummariesT = DetectorSummary>
  ListDetectorsResult& AddDetectorSummaries(DetectorSummariesT&& value) {
    m_detectorSummariesHasBeenSet = true;
    m_detectorSummaries.emplace_back(std::forward<DetectorSummariesT>(value));
    return *this;
  }
  ///@}
