...
class ListAlarmsResult {
 public:
  ...
  void SetAlarmSummaries(AlarmSummariesT&& value) {
    m_alarmSummariesHasBeenSet = true;
    m_alarmSummaries = std::forward<AlarmSummariesT>(value);
  }
  template <typename AlarmSummariesT = Aws::Vector<AlarmSummary>>
  ListAlarmsResult& WithAlarmSummaries(AlarmSummariesT&& value) {
    SetAlarmSummaries(std::forward<AlarmSummariesT>(value));
    return *this;
  }
  template <typename AlarmSummariesT = AlarmSummary>
  ListAlarmsResult& AddAlarmSummaries(AlarmSummariesT&& value) {
    m_alarmSummariesHasBeenSet = true;
    m_alarmSummaries.emplace_back(std::forward<AlarmSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAlarmsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAlarmsResult& WithRequestId(RequestIdT&& value) {
