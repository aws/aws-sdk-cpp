...
class AlarmState {
 public:
  ...
  inline AlarmState& WithStateName(AlarmStateName value) {
    SetStateName(value);
    return *this;
  }
  ///@}
  ...
  void SetRuleEvaluation(RuleEvaluationT&& value) {
    ...
    m_ruleEvaluation = std::forward<RuleEvaluationT>(value);
  }
  template <typename RuleEvaluationT = RuleEvaluation>
  AlarmState& WithRuleEvaluation(RuleEvaluationT&& value) {
    SetRuleEvaluation(std::forward<RuleEvaluationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSystemEvent(SystemEventT&& value) {
    ...
    m_systemEvent = std::forward<SystemEventT>(value);
  }
  template <typename SystemEventT = SystemEvent>
  AlarmState& WithSystemEvent(SystemEventT&& value) {
    SetSystemEvent(std::forward<SystemEventT>(value));
    return *this;
  }
  ///@}
 private:
