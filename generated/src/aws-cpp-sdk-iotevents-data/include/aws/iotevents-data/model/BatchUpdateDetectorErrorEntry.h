...
class BatchUpdateDetectorErrorEntry {
 public:
  ...
  template <typename MessageIdT = Aws::String>
  BatchUpdateDetectorErrorEntry& WithMessageId(MessageIdT&& value) {
  ...
  inline BatchUpdateDetectorErrorEntry& WithErrorCode(ErrorCode value) {
    SetErrorCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename ErrorMessageT = Aws::String>
  BatchUpdateDetectorErrorEntry& WithErrorMessage(ErrorMessageT&& value) {
