...
class UpdateDetectorRequest {
 public:
  ...
  template <typename MessageIdT = Aws::String>
  UpdateDetectorRequest& WithMessageId(MessageIdT&& value) {
  ...
  template <typename DetectorModelNameT = Aws::String>
  UpdateDetectorRequest& WithDetectorModelName(DetectorModelNameT&& value) {
  ...
  template <typename KeyValueT = Aws::String>
  UpdateDetectorRequest& WithKeyValue(KeyValueT&& value) {
  ...
  template <typename StateT = DetectorStateDefinition>
  UpdateDetectorRequest& WithState(StateT&& value) {
