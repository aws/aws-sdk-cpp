...
class SystemEvent {
 public:
  ...
  inline SystemEvent& WithEventType(EventType value) {
    SetEventType(value);
    return *this;
  }
  ///@}
  ...
  void SetStateChangeConfiguration(StateChangeConfigurationT&& value) {
    ...
    m_stateChangeConfiguration = std::forward<StateChangeConfigurationT>(value);
  }
  template <typename StateChangeConfigurationT = StateChangeConfiguration>
  SystemEvent& WithStateChangeConfiguration(StateChangeConfigurationT&& value) {
    SetStateChangeConfiguration(std::forward<StateChangeConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
