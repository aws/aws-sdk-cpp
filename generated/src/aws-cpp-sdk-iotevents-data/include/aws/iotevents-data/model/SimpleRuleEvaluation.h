...
class SimpleRuleEvaluation {
 public:
  ...
  void SetInputPropertyValue(InputPropertyValueT&& value) {
    ...
    m_inputPropertyValue = std::forward<InputPropertyValueT>(value);
  }
  template <typename InputPropertyValueT = Aws::String>
  SimpleRuleEvaluation& WithInputPropertyValue(InputPropertyValueT&& value) {
    SetInputPropertyValue(std::forward<InputPropertyValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline SimpleRuleEvaluation& WithOperator(ComparisonOperator value) {
    SetOperator(value);
    return *this;
  }
  ///@}
  ...
  void SetThresholdValue(ThresholdValueT&& value) {
    ...
    m_thresholdValue = std::forward<ThresholdValueT>(value);
  }
  template <typename ThresholdValueT = Aws::String>
  SimpleRuleEvaluation& WithThresholdValue(ThresholdValueT&& value) {
    SetThresholdValue(std::forward<ThresholdValueT>(value));
    return *this;
  }
  ///@}
 private:
