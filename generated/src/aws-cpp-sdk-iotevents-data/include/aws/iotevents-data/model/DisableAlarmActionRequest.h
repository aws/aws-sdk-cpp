...
class DisableAlarmActionRequest {
 public:
  ...
  template <typename RequestIdT = Aws::String>
  DisableAlarmActionRequest& WithRequestId(RequestIdT&& value) {
  ...
  template <typename AlarmModelNameT = Aws::String>
  DisableAlarmActionRequest& WithAlarmModelName(AlarmModelNameT&& value) {
  ...
  template <typename KeyValueT = Aws::String>
  DisableAlarmActionRequest& WithKeyValue(KeyValueT&& value) {
  ...
  template <typename NoteT = Aws::String>
  DisableAlarmActionRequest& WithNote(NoteT&& value) {
