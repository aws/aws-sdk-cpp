...
class RuleEvaluation {
 public:
  ...
  void SetSimpleRuleEvaluation(SimpleRuleEvaluationT&& value) {
    m_simpleRuleEvaluationHasBeenSet = true;
    m_simpleRuleEvaluation = std::forward<SimpleRuleEvaluationT>(value);
  }
  template <typename SimpleRuleEvaluationT = SimpleRuleEvaluation>
  RuleEvaluation& WithSimpleRuleEvaluation(SimpleRuleEvaluationT&& value) {
    SetSimpleRuleEvaluation(std::forward<SimpleRuleEvaluationT>(value));
    return *this;
  }
  ///@}
 private:
