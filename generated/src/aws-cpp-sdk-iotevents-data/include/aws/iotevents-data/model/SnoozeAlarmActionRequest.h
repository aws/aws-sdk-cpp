...
class SnoozeAlarmActionRequest {
 public:
  ...
  template <typename RequestIdT = Aws::String>
  SnoozeAlarmActionRequest& WithRequestId(RequestIdT&& value) {
  ...
  template <typename AlarmModelNameT = Aws::String>
  SnoozeAlarmActionRequest& WithAlarmModelName(AlarmModelNameT&& value) {
  ...
  template <typename KeyValueT = Aws::String>
  SnoozeAlarmActionRequest& WithKeyValue(KeyValueT&& value) {
  ...
  template <typename NoteT = Aws::String>
  SnoozeAlarmActionRequest& WithNote(NoteT&& value) {
  ...
  inline void SetSnoozeDuration(int value) {
    m_snoozeDurationHasBeenSet = true;
    m_snoozeDuration = value;
  }
  inline SnoozeAlarmActionRequest& WithSnoozeDuration(int value) {
