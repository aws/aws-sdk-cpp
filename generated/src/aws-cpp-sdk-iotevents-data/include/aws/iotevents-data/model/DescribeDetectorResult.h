...
class DescribeDetectorResult {
 public:
  ...
  void SetDetector(DetectorT&& value) {
    m_detectorHasBeenSet = true;
    m_detector = std::forward<DetectorT>(value);
  }
  template <typename DetectorT = Detector>
  DescribeDetectorResult& WithDetector(DetectorT&& value) {
    SetDetector(std::forward<DetectorT>(value));
    return *this;
  }
  ///@}
