...
class BatchAcknowledgeAlarmRequest : public IoTEventsDataRequest {
 public:
  ...
  void SetAcknowledgeActionRequests(AcknowledgeActionRequestsT&& value) {
    m_acknowledgeActionRequestsHasBeenSet = true;
    m_acknowledgeActionRequests = std::forward<AcknowledgeActionRequestsT>(value);
  }
  template <typename AcknowledgeActionRequestsT = Aws::Vector<AcknowledgeAlarmActionRequest>>
  BatchAcknowledgeAlarmRequest& WithAcknowledgeActionRequests(AcknowledgeActionRequestsT&& value) {
    SetAcknowledgeActionRequests(std::forward<AcknowledgeActionRequestsT>(value));
    return *this;
  }
  template <typename AcknowledgeActionRequestsT = AcknowledgeAlarmActionRequest>
  BatchAcknowledgeAlarmRequest& AddAcknowledgeActionRequests(AcknowledgeActionRequestsT&& value) {
    m_acknowledgeActionRequestsHasBeenSet = true;
    m_acknowledgeActionRequests.emplace_back(std::forward<AcknowledgeActionRequestsT>(value));
    return *this;
  }
  ///@}
 private:
