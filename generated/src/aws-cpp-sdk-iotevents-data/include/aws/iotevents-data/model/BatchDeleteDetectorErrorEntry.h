...
class BatchDeleteDetectorErrorEntry {
 public:
  ...
  template <typename MessageIdT = Aws::String>
  BatchDeleteDetectorErrorEntry& WithMessageId(MessageIdT&& value) {
  ...
  inline BatchDeleteDetectorErrorEntry& WithErrorCode(ErrorCode value) {
    SetErrorCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename ErrorMessageT = Aws::String>
  BatchDeleteDetectorErrorEntry& WithErrorMessage(ErrorMessageT&& value) {
