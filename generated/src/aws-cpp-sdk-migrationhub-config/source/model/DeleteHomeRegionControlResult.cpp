...
DeleteHomeRegionControlResult::DeleteHomeRegionControlResult()
{
}

DeleteHomeRegionControlResult::DeleteHomeRegionControlResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
