...
class DeleteHomeRegionControlResult {
 public:
  AWS_MIGRATIONHUBCONFIG_API DeleteHomeRegionControlResult() = default;
  ...
  AWS_MIGRATIONHUBCONFIG_API DeleteHomeRegionControlResult& operator=(
  ...
  template <typename RequestIdT = Aws::String>
  DeleteHomeRegionControlResult& WithRequestId(RequestIdT&& value) {
