...
class CreateHomeRegionControlResult {
 public:
  ...
  AWS_MIGRATIONHUBCONFIG_API CreateHomeRegionControlResult& operator=(
  ...
  void SetHomeRegionControl(HomeRegionControlT&& value) {
    m_homeRegionControlHasBeenSet = true;
    m_homeRegionControl = std::forward<HomeRegionControlT>(value);
  }
  template <typename HomeRegionControlT = HomeRegionControl>
  CreateHomeRegionControlResult& WithHomeRegionControl(HomeRegionControlT&& value) {
    SetHomeRegionControl(std::forward<HomeRegionControlT>(value));
    return *this;
  }
  ///@}
