...
namespace MigrationHubConfig
{
   ...
   */
  class AWS_MIGRATIONHUBCONFIG_API MigrationHubConfigClient : Aws::Client::ClientWithAsyncTemplateMethods<MigrationHubConfigClient>,
    smithy::client::AwsSmithyClientT<Aws::MigrationHubConfig::SERVICE_NAME,
