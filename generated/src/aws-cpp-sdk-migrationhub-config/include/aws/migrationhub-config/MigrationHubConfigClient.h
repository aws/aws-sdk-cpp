...
class AWS_MIGRATIONHUBCONFIG_API MigrationHubConfigClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  MigrationHubConfigClient(const Aws::MigrationHubConfig::MigrationHubConfigClientConfiguration& clientConfiguration =
  ...
  MigrationHubConfigClient(const Aws::Auth::AWSCredentials& credentials,
                           std::shared_ptr<MigrationHubConfigEndpointProviderBase> endpointProvider = nullptr,
                           const Aws::MigrationHubConfig::MigrationHubConfigClientConfiguration& clientConfiguration =
                               Aws::MigrationHubConfig::MigrationHubConfigClientConfiguration());
  ...
  /**
   * A Callable wrapper for CreateHomeRegionControl that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateHomeRegionControl that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateHomeRegionControlRequestT = Model::CreateHomeRegionControlRequest>
  void CreateHomeRegionControlAsync(const CreateHomeRegionControlRequestT& request,
                                    const CreateHomeRegionControlResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for DeleteHomeRegionControl that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteHomeRegionControl that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteHomeRegionControlRequestT = Model::DeleteHomeRegionControlRequest>
  void DeleteHomeRegionControlAsync(const DeleteHomeRegionControlRequestT& request,
                                    const DeleteHomeRegionControlResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeHomeRegionControlsOutcome DescribeHomeRegionControls(
      const Model::DescribeHomeRegionControlsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeHomeRegionControls that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeHomeRegionControlsRequestT = Model::DescribeHomeRegionControlsRequest>
  Model::DescribeHomeRegionControlsOutcomeCallable DescribeHomeRegionControlsCallable(
      const DescribeHomeRegionControlsRequestT& request = {}) const {
    return SubmitCallable(&MigrationHubConfigClient::DescribeHomeRegionControls, request);
  }

  /**
   * An Async wrapper for DescribeHomeRegionControls that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeHomeRegionControlsRequestT = Model::DescribeHomeRegionControlsRequest>
  void DescribeHomeRegionControlsAsync(const DescribeHomeRegionControlsResponseReceivedHandler& handler,
  ...
  /**
   * An Async wrapper for GetHomeRegion that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetHomeRegionRequestT = Model::GetHomeRegionRequest>
  void GetHomeRegionAsync(const GetHomeRegionResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                          const GetHomeRegionRequestT& request = {}) const {
