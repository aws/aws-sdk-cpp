...
namespace Echo
{
const size_t EchoEndpointRules::RulesBlobStrLen = 4399;
const size_t EchoEndpointRules::RulesBlobSize = 4400;

using RulesBlobT = Aws::Array<const char, EchoEndpointRules::RulesBlobSize>;
...
const char* EchoEndpointRules::GetRulesBlob()
{
