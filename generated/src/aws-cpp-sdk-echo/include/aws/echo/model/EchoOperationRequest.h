...
namespace Model
{
  ...
  /**
   */
  class EchoOperationRequest : public EchoRequest
  {
  public:
    AWS_ECHO_API EchoOperationRequest() = default;

    // Service request name is the Operation name which will send this request out,
    // each operation should has unique request name, so that we can get operation's name from this request.
    // Note: this is not true for response, multiple operations may have the same response name,
    // so we can not get operation's name from response.
    inline virtual const char* GetServiceRequestName() const override { return "EchoOperation"; }

    AWS_ECHO_API Aws::String SerializePayload() const override;

    AWS_ECHO_API Aws::Http::HeaderValueCollection GetRequestSpecificHeaders() const override;
    ...
    inline EchoOperationRequest& WithBooleanMember(bool value) { SetBooleanMember(value); return *this;}
    ///@}
    ...
    template<typename StringMemberT = Aws::String>
    EchoOperationRequest& WithStringMember(StringMemberT&& value) { SetStringMember(std::forward<StringMemberT>(value)); return *this;}
    ///@}

    ///@{
    
    inline int GetIntegerMember() const { return m_integerMember; }
    inline bool IntegerMemberHasBeenSet() const { return m_integerMemberHasBeenSet; }
    inline void SetIntegerMember(int value) { m_integerMemberHasBeenSet = true; m_integerMember = value; }
    inline EchoOperationRequest& WithIntegerMember(int value) { SetIntegerMember(value); return *this;}
    ///@}
    ...
    inline EchoOperationRequest& WithLongMember(long long value) { SetLongMember(value); return *this;}
    ///@}
    ...
    inline EchoOperationRequest& WithFloatMember(double value) { SetFloatMember(value); return *this;}
    ///@}
    ...
    inline EchoOperationRequest& WithDoubleMember(double value) { SetDoubleMember(value); return *this;}
    ///@}
    ...
    template<typename TimestampMemberT = Aws::Utils::DateTime>
    EchoOperationRequest& WithTimestampMember(TimestampMemberT&& value) { SetTimestampMember(std::forward<TimestampMemberT>(value)); return *this;}
    ///@}
    ...
    template<typename BlobMemberT = Aws::Utils::ByteBuffer>
    EchoOperationRequest& WithBlobMember(BlobMemberT&& value) { SetBlobMember(std::forward<BlobMemberT>(value)); return *this;}
    ///@}
    ...
    template<typename ListOfStringsMemberT = Aws::Vector<Aws::String>>
    EchoOperationRequest& WithListOfStringsMember(ListOfStringsMemberT&& value) { SetListOfStringsMember(std::forward<ListOfStringsMemberT>(value)); return *this;}
    template<typename ListOfStringsMemberT = Aws::String>
    EchoOperationRequest& AddListOfStringsMember(ListOfStringsMemberT&& value) { m_listOfStringsMemberHasBeenSet = true; m_listOfStringsMember.emplace_back(std::forward<ListOfStringsMemberT>(value)); return *this; }
    ///@}
    ...
    template<typename ListOfComplexObjectMemberT = Aws::Vector<ComplexStructure>>
    EchoOperationRequest& WithListOfComplexObjectMember(ListOfComplexObjectMemberT&& value) { SetListOfComplexObjectMember(std::forward<ListOfComplexObjectMemberT>(value)); return *this;}
    template<typename ListOfComplexObjectMemberT = ComplexStructure>
    EchoOperationRequest& AddListOfComplexObjectMember(ListOfComplexObjectMemberT&& value) { m_listOfComplexObjectMemberHasBeenSet = true; m_listOfComplexObjectMember.emplace_back(std::forward<ListOfComplexObjectMemberT>(value)); return *this; }
    ///@}
    ...
    template<typename MapOfStringToStringMemberT = Aws::Map<Aws::String, Aws::String>>
    EchoOperationRequest& WithMapOfStringToStringMember(MapOfStringToStringMemberT&& value) { SetMapOfStringToStringMember(std::forward<MapOfStringToStringMemberT>(value)); return *this;}
    template<typename MapOfStringToStringMemberKeyT = Aws::String, typename MapOfStringToStringMemberValueT = Aws::String>
    EchoOperationRequest& AddMapOfStringToStringMember(MapOfStringToStringMemberKeyT&& key, MapOfStringToStringMemberValueT&& value) {
    ...
    template<typename ComplexStructMemberT = ComplexStructure>
    EchoOperationRequest& WithComplexStructMember(ComplexStructMemberT&& value) { SetComplexStructMember(std::forward<ComplexStructMemberT>(value)); return *this;}
    ///@}
  private:
