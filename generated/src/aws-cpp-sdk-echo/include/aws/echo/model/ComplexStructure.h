...
{
public:
AWS_ECHO_API ComplexStructure() = default;
AWS_ECHO_API ComplexStructure(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
AWS_ECHO_API ComplexStructure& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
AWS_ECHO_API void CborEncode(Aws::Crt::Cbor::CborEncoder& encoder) const;


    ///@{
    
    inline bool GetBooleanMember() const { return m_booleanMember; }
    inline bool BooleanMemberHasBeenSet() const { return m_booleanMemberHasBeenSet; }
    inline void SetBooleanMember(bool value) { m_booleanMemberHasBeenSet = true; m_booleanMember = value; }
    inline ComplexStructure& WithBooleanMember(bool value) { SetBooleanMember(value); return *this;}
    ///@}

    ///@{
    
    inline const Aws::String& GetStringMember() const { return m_stringMember; }
    inline bool StringMemberHasBeenSet() const { return m_stringMemberHasBeenSet; }
    ...
    template<typename StringMemberT = Aws::String>
    ComplexStructure& WithStringMember(StringMemberT&& value) { SetStringMember(std::forward<StringMemberT>(value)); return *this;}
    ///@}

    ///@{
    
    inline int64_t GetIntegerMember() const { return m_integerMember; }
    inline bool IntegerMemberHasBeenSet() const { return m_integerMemberHasBeenSet; }
    inline void SetIntegerMember(int64_t value) { m_integerMemberHasBeenSet = true; m_integerMember = value; }
    inline ComplexStructure& WithIntegerMember(int64_t value) { SetIntegerMember(value); return *this;}
    ///@}

    ///@{
    
    inline long long GetLongMember() const { return m_longMember; }
    inline bool LongMemberHasBeenSet() const { return m_longMemberHasBeenSet; }
    inline void SetLongMember(long long value) { m_longMemberHasBeenSet = true; m_longMember = value; }
    inline ComplexStructure& WithLongMember(long long value) { SetLongMember(value); return *this;}
    ///@}

    ///@{
    
    inline double GetFloatMember() const { return m_floatMember; }
    inline bool FloatMemberHasBeenSet() const { return m_floatMemberHasBeenSet; }
    inline void SetFloatMember(double value) { m_floatMemberHasBeenSet = true; m_floatMember = value; }
    inline ComplexStructure& WithFloatMember(double value) { SetFloatMember(value); return *this;}
    ///@}

    ///@{
    
    inline double GetDoubleMember() const { return m_doubleMember; }
    inline bool DoubleMemberHasBeenSet() const { return m_doubleMemberHasBeenSet; }
    inline void SetDoubleMember(double value) { m_doubleMemberHasBeenSet = true; m_doubleMember = value; }
    inline ComplexStructure& WithDoubleMember(double value) { SetDoubleMember(value); return *this;}
    ///@}

    ///@{
    
    inline const Aws::Utils::DateTime& GetTimestampMember() const { return m_timestampMember; }
    inline bool TimestampMemberHasBeenSet() const { return m_timestampMemberHasBeenSet; }
    ...
    template<typename TimestampMemberT = Aws::Utils::DateTime>
    ComplexStructure& WithTimestampMember(TimestampMemberT&& value) { SetTimestampMember(std::forward<TimestampMemberT>(value)); return *this;}
    ///@}

    ///@{
    
    inline const Aws::Utils::ByteBuffer& GetBlobMember() const { return m_blobMember; }
    inline bool BlobMemberHasBeenSet() const { return m_blobMemberHasBeenSet; }
    ...
    template<typename BlobMemberT = Aws::Utils::ByteBuffer>
    ComplexStructure& WithBlobMember(BlobMemberT&& value) { SetBlobMember(std::forward<BlobMemberT>(value)); return *this;}
    ///@}

    ///@{
    
    inline const Aws::Vector<Aws::String>& GetListOfStringsMember() const { return m_listOfStringsMember; }
    inline bool ListOfStringsMemberHasBeenSet() const { return m_listOfStringsMemberHasBeenSet; }
    ...
    template<typename ListOfStringsMemberT = Aws::Vector<Aws::String>>
    ComplexStructure& WithListOfStringsMember(ListOfStringsMemberT&& value) { SetListOfStringsMember(std::forward<ListOfStringsMemberT>(value)); return *this;}
    template<typename ListOfStringsMemberT = Aws::String>
    ComplexStructure& AddListOfStringsMember(ListOfStringsMemberT&& value) { m_listOfStringsMemberHasBeenSet = true; m_listOfStringsMember.emplace_back(std::forward<ListOfStringsMemberT>(value)); return *this; }
    ///@}

    ///@{
    
    inline const Aws::Vector<ComplexStructure>& GetListOfComplexObjectMember() const { return m_listOfComplexObjectMember; }
    inline bool ListOfComplexObjectMemberHasBeenSet() const { return m_listOfComplexObjectMemberHasBeenSet; }
    ...
    template<typename ListOfComplexObjectMemberT = Aws::Vector<ComplexStructure>>
    ComplexStructure& WithListOfComplexObjectMember(ListOfComplexObjectMemberT&& value) { SetListOfComplexObjectMember(std::forward<ListOfComplexObjectMemberT>(value)); return *this;}
    template<typename ListOfComplexObjectMemberT = ComplexStructure>
    ComplexStructure& AddListOfComplexObjectMember(ListOfComplexObjectMemberT&& value) { m_listOfComplexObjectMemberHasBeenSet = true; m_listOfComplexObjectMember.emplace_back(std::forward<ListOfComplexObjectMemberT>(value)); return *this; }
    ///@}

    ///@{
    
    inline const Aws::Map<Aws::String, Aws::String>& GetMapOfStringToStringMember() const { return m_mapOfStringToStringMember; }
    inline bool MapOfStringToStringMemberHasBeenSet() const { return m_mapOfStringToStringMemberHasBeenSet; }
    ...
    template<typename MapOfStringToStringMemberT = Aws::Map<Aws::String, Aws::String>>
    ComplexStructure& WithMapOfStringToStringMember(MapOfStringToStringMemberT&& value) { SetMapOfStringToStringMember(std::forward<MapOfStringToStringMemberT>(value)); return *this;}
    template<typename MapOfStringToStringMemberKeyT = Aws::String, typename MapOfStringToStringMemberValueT = Aws::String>
    ComplexStructure& AddMapOfStringToStringMember(MapOfStringToStringMemberKeyT&& key, MapOfStringToStringMemberValueT&& value) {
    ...
    inline const ComplexStructure& GetComplexStructMember() const{
      return *m_complexStructMember;
    }
    inline bool ComplexStructMemberHasBeenSet() const { return m_complexStructMemberHasBeenSet; }
    template<typename ComplexStructMemberT = ComplexStructure>
    void SetComplexStructMember(ComplexStructMemberT&& value) {
      m_complexStructMemberHasBeenSet = true; 
      m_complexStructMember = Aws::MakeShared<ComplexStructure>("ComplexStructure", std::forward<ComplexStructMemberT>(value));
    }
    template<typename ComplexStructMemberT = ComplexStructure>
    ComplexStructure& WithComplexStructMember(ComplexStructMemberT&& value) { SetComplexStructMember(std::forward<ComplexStructMemberT>(value)); return *this;}
    ///@}
  private:
    ...
    std::shared_ptr<ComplexStructure> m_complexStructMember;
