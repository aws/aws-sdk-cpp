...
DimensionContribution::DimensionContribution(JsonView jsonValue) { *this = jsonValue; }
...
DimensionContribution& DimensionContribution::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("DimensionValueContributionList")) {
    ...
    for (unsigned dimensionValueContributionListIndex = 0;
         dimensionValueContributionListIndex < dimensionValueContributionListJsonList.GetLength(); ++dimensionValueContributionListIndex) {
...
JsonValue DimensionContribution::Jsonize() const {
  ...
  if (m_dimensionValueContributionListHasBeenSet) {
    ...
    for (unsigned dimensionValueContributionListIndex = 0;
         dimensionValueContributionListIndex < dimensionValueContributionListJsonList.GetLength(); ++dimensionValueContributionListIndex) {
      dimensionValueContributionListJsonList[dimensionValueContributionListIndex].AsObject(
          m_dimensionValueContributionList[dimensionValueContributionListIndex].Jsonize());
    }
