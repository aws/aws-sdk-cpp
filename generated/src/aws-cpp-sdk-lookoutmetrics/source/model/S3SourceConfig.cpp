...
S3SourceConfig::S3SourceConfig(JsonView jsonValue) { *this = jsonValue; }
...
S3SourceConfig& S3SourceConfig::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("HistoricalDataPathList")) {
    ...
    for (unsigned historicalDataPathListIndex = 0; historicalDataPathListIndex < historicalDataPathListJsonList.GetLength();
         ++historicalDataPathListIndex) {
