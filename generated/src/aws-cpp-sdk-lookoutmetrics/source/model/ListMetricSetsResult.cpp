...
ListMetricSetsResult::ListMetricSetsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListMetricSetsResult& ListMetricSetsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("MetricSetSummaryList")) {
    ...
    for (unsigned metricSetSummaryListIndex = 0; metricSetSummaryListIndex < metricSetSummaryListJsonList.GetLength();
         ++metricSetSummaryListIndex) {
