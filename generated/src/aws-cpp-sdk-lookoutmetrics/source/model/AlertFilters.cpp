...
AlertFilters::AlertFilters(JsonView jsonValue) { *this = jsonValue; }
...
AlertFilters& AlertFilters::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("DimensionFilterList")) {
    ...
    for (unsigned dimensionFilterListIndex = 0; dimensionFilterListIndex < dimensionFilterListJsonList.GetLength();
         ++dimensionFilterListIndex) {
