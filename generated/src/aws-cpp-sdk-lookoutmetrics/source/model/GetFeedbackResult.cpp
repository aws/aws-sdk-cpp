...
GetFeedbackResult::GetFeedbackResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
GetFeedbackResult& GetFeedbackResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("AnomalyGroupTimeSeriesFeedback")) {
    ...
    for (unsigned anomalyGroupTimeSeriesFeedbackIndex = 0;
         anomalyGroupTimeSeriesFeedbackIndex < anomalyGroupTimeSeriesFeedbackJsonList.GetLength(); ++anomalyGroupTimeSeriesFeedbackIndex) {
