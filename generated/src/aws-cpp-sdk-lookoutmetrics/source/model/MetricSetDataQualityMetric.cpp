...
MetricSetDataQualityMetric::MetricSetDataQualityMetric(JsonView jsonValue) { *this = jsonValue; }
...
MetricSetDataQualityMetric& MetricSetDataQualityMetric::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("DataQualityMetricList")) {
    ...
    for (unsigned dataQualityMetricListIndex = 0; dataQualityMetricListIndex < dataQualityMetricListJsonList.GetLength();
         ++dataQualityMetricListIndex) {
