...
ListAnomalyGroupRelatedMetricsResult& ListAnomalyGroupRelatedMetricsResult::operator=(
  ...
  if (jsonValue.ValueExists("InterMetricImpactList")) {
    ...
    for (unsigned interMetricImpactListIndex = 0; interMetricImpactListIndex < interMetricImpactListJsonList.GetLength();
         ++interMetricImpactListIndex) {
