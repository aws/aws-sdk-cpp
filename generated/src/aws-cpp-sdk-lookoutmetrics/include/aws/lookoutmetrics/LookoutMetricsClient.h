...
namespace LookoutMetrics
{
   ...
   */
  class AWS_LOOKOUTMETRICS_API LookoutMetricsClient : Aws::Client::ClientWithAsyncTemplateMethods<LookoutMetricsClient>,
    smithy::client::AwsSmithyClientT<Aws::LookoutMetrics::SERVICE_NAME,
