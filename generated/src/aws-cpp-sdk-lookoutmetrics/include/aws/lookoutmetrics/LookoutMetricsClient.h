...
class AWS_LOOKOUTMETRICS_API LookoutMetricsClient : public Aws::Client::AWSJsonClient,
                                                    public Aws::Client::ClientWithAsyncTemplateMethods<LookoutMetricsClient> {
 public:
   ...
   */
  LookoutMetricsClient(const Aws::LookoutMetrics::LookoutMetricsClientConfiguration& clientConfiguration =
  ...
  LookoutMetricsClient(const Aws::Auth::AWSCredentials& credentials,
                       std::shared_ptr<LookoutMetricsEndpointProviderBase> endpointProvider = nullptr,
                       const Aws::LookoutMetrics::LookoutMetricsClientConfiguration& clientConfiguration =
                           Aws::LookoutMetrics::LookoutMetricsClientConfiguration());
  ...
  /**
   * A Callable wrapper for ActivateAnomalyDetector that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ActivateAnomalyDetector that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ActivateAnomalyDetectorRequestT = Model::ActivateAnomalyDetectorRequest>
  void ActivateAnomalyDetectorAsync(const ActivateAnomalyDetectorRequestT& request,
  ...
  /**
   * A Callable wrapper for BackTestAnomalyDetector that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BackTestAnomalyDetector that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BackTestAnomalyDetectorRequestT = Model::BackTestAnomalyDetectorRequest>
  void BackTestAnomalyDetectorAsync(const BackTestAnomalyDetectorRequestT& request,
  ...
  /**
   * An Async wrapper for CreateMetricSet that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateMetricSetRequestT = Model::CreateMetricSetRequest>
  void CreateMetricSetAsync(const CreateMetricSetRequestT& request, const CreateMetricSetResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeactivateAnomalyDetector that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DeactivateAnomalyDetectorRequestT = Model::DeactivateAnomalyDetectorRequest>
  Model::DeactivateAnomalyDetectorOutcomeCallable DeactivateAnomalyDetectorCallable(
      const DeactivateAnomalyDetectorRequestT& request) const {
    return SubmitCallable(&LookoutMetricsClient::DeactivateAnomalyDetector, request);
  }

  /**
   * An Async wrapper for DeactivateAnomalyDetector that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeactivateAnomalyDetectorRequestT = Model::DeactivateAnomalyDetectorRequest>
  void DeactivateAnomalyDetectorAsync(const DeactivateAnomalyDetectorRequestT& request,
                                      const DeactivateAnomalyDetectorResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeAlert that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeAlertRequestT = Model::DescribeAlertRequest>
  void DescribeAlertAsync(const DescribeAlertRequestT& request, const DescribeAlertResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeAnomalyDetectionExecutionsOutcome DescribeAnomalyDetectionExecutions(
      const Model::DescribeAnomalyDetectionExecutionsRequest& request) const;

  /**
   * A Callable wrapper for DescribeAnomalyDetectionExecutions that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeAnomalyDetectionExecutionsRequestT = Model::DescribeAnomalyDetectionExecutionsRequest>
  Model::DescribeAnomalyDetectionExecutionsOutcomeCallable DescribeAnomalyDetectionExecutionsCallable(
      const DescribeAnomalyDetectionExecutionsRequestT& request) const {
    return SubmitCallable(&LookoutMetricsClient::DescribeAnomalyDetectionExecutions, request);
  }

  /**
   * An Async wrapper for DescribeAnomalyDetectionExecutions that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeAnomalyDetectionExecutionsRequestT = Model::DescribeAnomalyDetectionExecutionsRequest>
  void DescribeAnomalyDetectionExecutionsAsync(const DescribeAnomalyDetectionExecutionsRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeMetricSet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeMetricSet that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeMetricSetRequestT = Model::DescribeMetricSetRequest>
  void DescribeMetricSetAsync(const DescribeMetricSetRequestT& request, const DescribeMetricSetResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DetectMetricSetConfig that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DetectMetricSetConfig that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DetectMetricSetConfigRequestT = Model::DetectMetricSetConfigRequest>
  void DetectMetricSetConfigAsync(const DetectMetricSetConfigRequestT& request, const DetectMetricSetConfigResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetAnomalyGroup that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetAnomalyGroupRequestT = Model::GetAnomalyGroupRequest>
  void GetAnomalyGroupAsync(const GetAnomalyGroupRequestT& request, const GetAnomalyGroupResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetDataQualityMetrics that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetDataQualityMetrics that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetDataQualityMetricsRequestT = Model::GetDataQualityMetricsRequest>
  void GetDataQualityMetricsAsync(const GetDataQualityMetricsRequestT& request, const GetDataQualityMetricsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetFeedback that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetFeedbackRequestT = Model::GetFeedbackRequest>
  void GetFeedbackAsync(const GetFeedbackRequestT& request, const GetFeedbackResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetSampleData that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetSampleDataRequestT = Model::GetSampleDataRequest>
  void GetSampleDataAsync(const GetSampleDataResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                          const GetSampleDataRequestT& request = {}) const {
   ...
   */
  template <typename ListAlertsRequestT = Model::ListAlertsRequest>
  void ListAlertsAsync(const ListAlertsResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                       const ListAlertsRequestT& request = {}) const {
   ...
   */
  template <typename ListAnomalyDetectorsRequestT = Model::ListAnomalyDetectorsRequest>
  void ListAnomalyDetectorsAsync(const ListAnomalyDetectorsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const ListAnomalyDetectorsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListAnomalyGroupRelatedMetricsOutcome ListAnomalyGroupRelatedMetrics(
      const Model::ListAnomalyGroupRelatedMetricsRequest& request) const;

  /**
   * A Callable wrapper for ListAnomalyGroupRelatedMetrics that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListAnomalyGroupRelatedMetricsRequestT = Model::ListAnomalyGroupRelatedMetricsRequest>
  Model::ListAnomalyGroupRelatedMetricsOutcomeCallable ListAnomalyGroupRelatedMetricsCallable(
      const ListAnomalyGroupRelatedMetricsRequestT& request) const {
    return SubmitCallable(&LookoutMetricsClient::ListAnomalyGroupRelatedMetrics, request);
  }

  /**
   * An Async wrapper for ListAnomalyGroupRelatedMetrics that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListAnomalyGroupRelatedMetricsRequestT = Model::ListAnomalyGroupRelatedMetricsRequest>
  void ListAnomalyGroupRelatedMetricsAsync(const ListAnomalyGroupRelatedMetricsRequestT& request,
                                           const ListAnomalyGroupRelatedMetricsResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAnomalyGroupSummaries that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListAnomalyGroupSummariesRequestT = Model::ListAnomalyGroupSummariesRequest>
  Model::ListAnomalyGroupSummariesOutcomeCallable ListAnomalyGroupSummariesCallable(
      const ListAnomalyGroupSummariesRequestT& request) const {
    return SubmitCallable(&LookoutMetricsClient::ListAnomalyGroupSummaries, request);
  }

  /**
   * An Async wrapper for ListAnomalyGroupSummaries that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAnomalyGroupSummariesRequestT = Model::ListAnomalyGroupSummariesRequest>
  void ListAnomalyGroupSummariesAsync(const ListAnomalyGroupSummariesRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::ListAnomalyGroupTimeSeriesOutcome ListAnomalyGroupTimeSeries(
      const Model::ListAnomalyGroupTimeSeriesRequest& request) const;

  /**
   * A Callable wrapper for ListAnomalyGroupTimeSeries that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListAnomalyGroupTimeSeriesRequestT = Model::ListAnomalyGroupTimeSeriesRequest>
  Model::ListAnomalyGroupTimeSeriesOutcomeCallable ListAnomalyGroupTimeSeriesCallable(
      const ListAnomalyGroupTimeSeriesRequestT& request) const {
    return SubmitCallable(&LookoutMetricsClient::ListAnomalyGroupTimeSeries, request);
  }

  /**
   * An Async wrapper for ListAnomalyGroupTimeSeries that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAnomalyGroupTimeSeriesRequestT = Model::ListAnomalyGroupTimeSeriesRequest>
  void ListAnomalyGroupTimeSeriesAsync(const ListAnomalyGroupTimeSeriesRequestT& request,
  ...
  /**
   * An Async wrapper for ListMetricSets that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListMetricSetsRequestT = Model::ListMetricSetsRequest>
  void ListMetricSetsAsync(const ListMetricSetsResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const ListMetricSetsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for UpdateAnomalyDetector that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateAnomalyDetector that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateAnomalyDetectorRequestT = Model::UpdateAnomalyDetectorRequest>
  void UpdateAnomalyDetectorAsync(const UpdateAnomalyDetectorRequestT& request, const UpdateAnomalyDetectorResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateMetricSet that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateMetricSetRequestT = Model::UpdateMetricSetRequest>
  void UpdateMetricSetAsync(const UpdateMetricSetRequestT& request, const UpdateMetricSetResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
