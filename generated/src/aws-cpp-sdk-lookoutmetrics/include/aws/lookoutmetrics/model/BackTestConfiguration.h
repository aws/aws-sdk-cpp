...
class BackTestConfiguration {
 public:
  AWS_LOOKOUTMETRICS_API BackTestConfiguration() = default;
  ...
  inline void SetRunBackTestMode(bool value) {
    m_runBackTestModeHasBeenSet = true;
    m_runBackTestMode = value;
  }
  inline BackTestConfiguration& WithRunBackTestMode(bool value) {
    SetRunBackTestMode(value);
    return *this;
  }
  ///@}
 private:
  bool m_runBackTestMode{false};
