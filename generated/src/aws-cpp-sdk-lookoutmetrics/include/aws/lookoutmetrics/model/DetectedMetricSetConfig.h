...
class DetectedMetricSetConfig {
 public:
  ...
  void SetOffset(OffsetT&& value) {
    ...
    m_offset = std::forward<OffsetT>(value);
  }
  template <typename OffsetT = DetectedField>
  DetectedMetricSetConfig& WithOffset(OffsetT&& value) {
    SetOffset(std::forward<OffsetT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMetricSetFrequency(MetricSetFrequencyT&& value) {
    ...
    m_metricSetFrequency = std::forward<MetricSetFrequencyT>(value);
  }
  template <typename MetricSetFrequencyT = DetectedField>
  DetectedMetricSetConfig& WithMetricSetFrequency(MetricSetFrequencyT&& value) {
    SetMetricSetFrequency(std::forward<MetricSetFrequencyT>(value));
    return *this;
  }
  ///@}
