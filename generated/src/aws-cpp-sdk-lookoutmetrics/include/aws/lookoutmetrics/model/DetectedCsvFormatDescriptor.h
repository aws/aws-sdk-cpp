...
class DetectedCsvFormatDescriptor {
 public:
  ...
  void SetFileCompression(FileCompressionT&& value) {
    m_fileCompressionHasBeenSet = true;
    m_fileCompression = std::forward<FileCompressionT>(value);
  }
  template <typename FileCompressionT = DetectedField>
  DetectedCsvFormatDescriptor& WithFileCompression(FileCompressionT&& value) {
    SetFileCompression(std::forward<FileCompressionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetContainsHeader(ContainsHeaderT&& value) {
    m_containsHeaderHasBeenSet = true;
    m_containsHeader = std::forward<ContainsHeaderT>(value);
  }
  template <typename ContainsHeaderT = DetectedField>
  DetectedCsvFormatDescriptor& WithContainsHeader(ContainsHeaderT&& value) {
    SetContainsHeader(std::forward<ContainsHeaderT>(value));
    return *this;
  }
  ///@}
  ...
  void SetHeaderList(HeaderListT&& value) {
    ...
    m_headerList = std::forward<HeaderListT>(value);
  }
  template <typename HeaderListT = DetectedField>
  DetectedCsvFormatDescriptor& WithHeaderList(HeaderListT&& value) {
    SetHeaderList(std::forward<HeaderListT>(value));
    return *this;
  }
  ///@}
