...
class ContributionMatrix {
 public:
  ...
  void SetDimensionContributionList(DimensionContributionListT&& value) {
    m_dimensionContributionListHasBeenSet = true;
    m_dimensionContributionList = std::forward<DimensionContributionListT>(value);
  }
  template <typename DimensionContributionListT = Aws::Vector<DimensionContribution>>
  ContributionMatrix& WithDimensionContributionList(DimensionContributionListT&& value) {
    SetDimensionContributionList(std::forward<DimensionContributionListT>(value));
    return *this;
  }
  template <typename DimensionContributionListT = DimensionContribution>
  ContributionMatrix& AddDimensionContributionList(DimensionContributionListT&& value) {
    m_dimensionContributionListHasBeenSet = true;
    m_dimensionContributionList.emplace_back(std::forward<DimensionContributionListT>(value));
    return *this;
  }
  ///@}
 private:
