...
class DimensionContribution {
 public:
  ...
  template <typename DimensionNameT = Aws::String>
  DimensionContribution& WithDimensionName(DimensionNameT&& value) {
   ...
   */
  inline const Aws::Vector<DimensionValueContribution>& GetDimensionValueContributionList() const {
    return m_dimensionValueContributionList;
  }
  ...
  void SetDimensionValueContributionList(DimensionValueContributionListT&& value) {
    m_dimensionValueContributionListHasBeenSet = true;
    m_dimensionValueContributionList = std::forward<DimensionValueContributionListT>(value);
  }
  template <typename DimensionValueContributionListT = Aws::Vector<DimensionValueContribution>>
  DimensionContribution& WithDimensionValueContributionList(DimensionValueContributionListT&& value) {
    SetDimensionValueContributionList(std::forward<DimensionValueContributionListT>(value));
    return *this;
  }
  template <typename DimensionValueContributionListT = DimensionValueContribution>
  DimensionContribution& AddDimensionValueContributionList(DimensionValueContributionListT&& value) {
    m_dimensionValueContributionListHasBeenSet = true;
    m_dimensionValueContributionList.emplace_back(std::forward<DimensionValueContributionListT>(value));
    return *this;
  }
  ///@}
 private:
