...
namespace Model
{
  ...
  {
  public:
    AWS_LOOKOUTMETRICS_API DeleteAnomalyDetectorRequest() = default;
    ...
    template<typename AnomalyDetectorArnT = Aws::String>
    DeleteAnomalyDetectorRequest& WithAnomalyDetectorArn(AnomalyDetectorArnT&& value) { SetAnomalyDetectorArn(std::forward<AnomalyDetectorArnT>(value)); return *this;}
    ///@}
  private:
