...
class ListAnomalyGroupTimeSeriesResult {
 public:
  ...
  AWS_LOOKOUTMETRICS_API ListAnomalyGroupTimeSeriesResult& operator=(
  ...
  template <typename AnomalyGroupIdT = Aws::String>
  ListAnomalyGroupTimeSeriesResult& WithAnomalyGroupId(AnomalyGroupIdT&& value) {
  ...
  template <typename MetricNameT = Aws::String>
  ListAnomalyGroupTimeSeriesResult& WithMetricName(MetricNameT&& value) {
  ...
  template <typename TimestampListT = Aws::Vector<Aws::String>>
  ListAnomalyGroupTimeSeriesResult& WithTimestampList(TimestampListT&& value) {
    SetTimestampList(std::forward<TimestampListT>(value));
    return *this;
  }
  template <typename TimestampListT = Aws::String>
  ListAnomalyGroupTimeSeriesResult& AddTimestampList(TimestampListT&& value) {
    m_timestampListHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListAnomalyGroupTimeSeriesResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetTimeSeriesList(TimeSeriesListT&& value) {
    m_timeSeriesListHasBeenSet = true;
    m_timeSeriesList = std::forward<TimeSeriesListT>(value);
  }
  template <typename TimeSeriesListT = Aws::Vector<TimeSeries>>
  ListAnomalyGroupTimeSeriesResult& WithTimeSeriesList(TimeSeriesListT&& value) {
    SetTimeSeriesList(std::forward<TimeSeriesListT>(value));
    return *this;
  }
  template <typename TimeSeriesListT = TimeSeries>
  ListAnomalyGroupTimeSeriesResult& AddTimeSeriesList(TimeSeriesListT&& value) {
    m_timeSeriesListHasBeenSet = true;
    m_timeSeriesList.emplace_back(std::forward<TimeSeriesListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListAnomalyGroupTimeSeriesResult& WithRequestId(RequestIdT&& value) {
