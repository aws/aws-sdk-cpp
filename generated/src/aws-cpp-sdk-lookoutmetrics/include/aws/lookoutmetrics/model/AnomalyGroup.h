...
class AnomalyGroup {
 public:
  ...
  inline void SetAnomalyGroupScore(double value) {
    m_anomalyGroupScoreHasBeenSet = true;
    m_anomalyGroupScore = value;
  }
  inline AnomalyGroup& WithAnomalyGroupScore(double value) {
    SetAnomalyGroupScore(value);
    return *this;
  }
  ///@}
  ...
  void SetPrimaryMetricName(PrimaryMetricNameT&& value) {
    ...
    m_primaryMetricName = std::forward<PrimaryMetricNameT>(value);
  }
  template <typename PrimaryMetricNameT = Aws::String>
  AnomalyGroup& WithPrimaryMetricName(PrimaryMetricNameT&& value) {
    SetPrimaryMetricName(std::forward<PrimaryMetricNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMetricLevelImpactList(MetricLevelImpactListT&& value) {
    ...
    m_metricLevelImpactList = std::forward<MetricLevelImpactListT>(value);
  }
  template <typename MetricLevelImpactListT = Aws::Vector<MetricLevelImpact>>
  AnomalyGroup& WithMetricLevelImpactList(MetricLevelImpactListT&& value) {
    SetMetricLevelImpactList(std::forward<MetricLevelImpactListT>(value));
    return *this;
  }
  ...
  AnomalyGroup& AddMetricLevelImpactList(MetricLevelImpactListT&& value) {
    m_metricLevelImpactListHasBeenSet = true;
    m_metricLevelImpactList.emplace_back(std::forward<MetricLevelImpactListT>(value));
    return *this;
  }
  ///@}
 private:
