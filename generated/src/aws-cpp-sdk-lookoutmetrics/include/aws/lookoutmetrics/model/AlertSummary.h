...
class AlertSummary {
 public:
  ...
  inline AlertSummary& WithAlertSensitivityThreshold(int value) {
  ...
  inline AlertSummary& WithAlertType(AlertType value) {
    SetAlertType(value);
    return *this;
  }
  ///@}
  ...
  inline AlertSummary& WithAlertStatus(AlertStatus value) {
