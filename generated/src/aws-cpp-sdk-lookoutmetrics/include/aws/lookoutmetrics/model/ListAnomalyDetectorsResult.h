...
class ListAnomalyDetectorsResult {
 public:
  ...
  void SetAnomalyDetectorSummaryList(AnomalyDetectorSummaryListT&& value) {
    m_anomalyDetectorSummaryListHasBeenSet = true;
    m_anomalyDetectorSummaryList = std::forward<AnomalyDetectorSummaryListT>(value);
  }
  template <typename AnomalyDetectorSummaryListT = Aws::Vector<AnomalyDetectorSummary>>
  ListAnomalyDetectorsResult& WithAnomalyDetectorSummaryList(AnomalyDetectorSummaryListT&& value) {
    SetAnomalyDetectorSummaryList(std::forward<AnomalyDetectorSummaryListT>(value));
    return *this;
  }
  template <typename AnomalyDetectorSummaryListT = AnomalyDetectorSummary>
  ListAnomalyDetectorsResult& AddAnomalyDetectorSummaryList(AnomalyDetectorSummaryListT&& value) {
    m_anomalyDetectorSummaryListHasBeenSet = true;
    m_anomalyDetectorSummaryList.emplace_back(std::forward<AnomalyDetectorSummaryListT>(value));
    return *this;
  }
  ///@}
