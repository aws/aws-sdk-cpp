...
class AnomalyGroupStatistics {
 public:
  ...
  void SetEvaluationStartDate(EvaluationStartDateT&& value) {
    ...
    m_evaluationStartDate = std::forward<EvaluationStartDateT>(value);
  }
  template <typename EvaluationStartDateT = Aws::String>
  AnomalyGroupStatistics& WithEvaluationStartDate(EvaluationStartDateT&& value) {
    SetEvaluationStartDate(std::forward<EvaluationStartDateT>(value));
    return *this;
  }
  ///@}
  ...
  inline AnomalyGroupStatistics& WithTotalCount(int value) {
    SetTotalCount(value);
    return *this;
  }
  ///@}
  ...
  void SetItemizedMetricStatsList(ItemizedMetricStatsListT&& value) {
    ...
    m_itemizedMetricStatsList = std::forward<ItemizedMetricStatsListT>(value);
  }
  template <typename ItemizedMetricStatsListT = Aws::Vector<ItemizedMetricStats>>
  AnomalyGroupStatistics& WithItemizedMetricStatsList(ItemizedMetricStatsListT&& value) {
    SetItemizedMetricStatsList(std::forward<ItemizedMetricStatsListT>(value));
    return *this;
  }
  ...
  AnomalyGroupStatistics& AddItemizedMetricStatsList(ItemizedMetricStatsListT&& value) {
    m_itemizedMetricStatsListHasBeenSet = true;
    m_itemizedMetricStatsList.emplace_back(std::forward<ItemizedMetricStatsListT>(value));
    return *this;
  }
  ///@}
 private:
