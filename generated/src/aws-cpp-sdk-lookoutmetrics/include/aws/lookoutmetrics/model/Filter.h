...
class Filter {
 public:
  ...
  template <typename DimensionValueT = Aws::String>
  Filter& WithDimensionValue(DimensionValueT&& value) {
  ...
  inline void SetFilterOperation(FilterOperation value) {
    m_filterOperationHasBeenSet = true;
    m_filterOperation = value;
  }
  inline Filter& WithFilterOperation(FilterOperation value) {
