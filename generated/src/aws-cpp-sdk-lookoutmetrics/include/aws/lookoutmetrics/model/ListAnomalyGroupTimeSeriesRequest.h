...
class ListAnomalyGroupTimeSeriesRequest : public LookoutMetricsRequest {
 public:
  ...
  template <typename AnomalyDetectorArnT = Aws::String>
  ListAnomalyGroupTimeSeriesRequest& WithAnomalyDetectorArn(AnomalyDetectorArnT&& value) {
  ...
  void SetAnomalyGroupId(AnomalyGroupIdT&& value) {
    ...
    m_anomalyGroupId = std::forward<AnomalyGroupIdT>(value);
  }
  template <typename AnomalyGroupIdT = Aws::String>
  ListAnomalyGroupTimeSeriesRequest& WithAnomalyGroupId(AnomalyGroupIdT&& value) {
    SetAnomalyGroupId(std::forward<AnomalyGroupIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename MetricNameT = Aws::String>
  ListAnomalyGroupTimeSeriesRequest& WithMetricName(MetricNameT&& value) {
  ...
  inline ListAnomalyGroupTimeSeriesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAnomalyGroupTimeSeriesRequest& WithNextToken(NextTokenT&& value) {
