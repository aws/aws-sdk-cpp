...
class DimensionFilter {
 public:
  ...
  template <typename DimensionNameT = Aws::String>
  DimensionFilter& WithDimensionName(DimensionNameT&& value) {
  ...
  void SetDimensionValueList(DimensionValueListT&& value) {
    m_dimensionValueListHasBeenSet = true;
    m_dimensionValueList = std::forward<DimensionValueListT>(value);
  }
  template <typename DimensionValueListT = Aws::Vector<Aws::String>>
  DimensionFilter& WithDimensionValueList(DimensionValueListT&& value) {
    SetDimensionValueList(std::forward<DimensionValueListT>(value));
    return *this;
  }
  template <typename DimensionValueListT = Aws::String>
  DimensionFilter& AddDimensionValueList(DimensionValueListT&& value) {
    m_dimensionValueListHasBeenSet = true;
    m_dimensionValueList.emplace_back(std::forward<DimensionValueListT>(value));
    return *this;
  }
  ///@}
 private:
