...
namespace Model
{
  ...
  public:
    ...
    template<typename AnomalyDetectorArnT = Aws::String>
    BackTestAnomalyDetectorRequest& WithAnomalyDetectorArn(AnomalyDetectorArnT&& value) { SetAnomalyDetectorArn(std::forward<AnomalyDetectorArnT>(value)); return *this;}
    ///@}
  private:
