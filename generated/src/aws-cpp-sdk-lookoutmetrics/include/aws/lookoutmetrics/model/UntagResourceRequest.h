...
namespace Model
{
  ...
  /**
   */
  class UntagResourceRequest : public LookoutMetricsRequest
  {
  public:
    AWS_LOOKOUTMETRICS_API UntagResourceRequest() = default;
    ...
    AWS_LOOKOUTMETRICS_API void AddQueryStringParameters(Aws::Http::URI& uri) const override;
