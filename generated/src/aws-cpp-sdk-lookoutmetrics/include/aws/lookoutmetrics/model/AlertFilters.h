...
class AlertFilters {
 public:
  ...
  template <typename MetricListT = Aws::Vector<Aws::String>>
  AlertFilters& WithMetricList(MetricListT&& value) {
    SetMetricList(std::forward<MetricListT>(value));
    return *this;
  }
  template <typename MetricListT = Aws::String>
  AlertFilters& AddMetricList(MetricListT&& value) {
    m_metricListHasBeenSet = true;
  ...
  template <typename DimensionFilterListT = Aws::Vector<DimensionFilter>>
  AlertFilters& WithDimensionFilterList(DimensionFilterListT&& value) {
    SetDimensionFilterList(std::forward<DimensionFilterListT>(value));
    return *this;
  }
  template <typename DimensionFilterListT = DimensionFilter>
  AlertFilters& AddDimensionFilterList(DimensionFilterListT&& value) {
    m_dimensionFilterListHasBeenSet = true;
