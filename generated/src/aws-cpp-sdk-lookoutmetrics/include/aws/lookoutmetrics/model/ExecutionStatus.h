...
class ExecutionStatus {
 public:
  ...
  template <typename TimestampT = Aws::String>
  ExecutionStatus& WithTimestamp(TimestampT&& value) {
  ...
  inline void SetStatus(AnomalyDetectionTaskStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ExecutionStatus& WithStatus(AnomalyDetectionTaskStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename FailureReasonT = Aws::String>
  ExecutionStatus& WithFailureReason(FailureReasonT&& value) {
