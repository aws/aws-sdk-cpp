...
class ListAlertsResult {
 public:
  ...
  void SetAlertSummaryList(AlertSummaryListT&& value) {
    m_alertSummaryListHasBeenSet = true;
    m_alertSummaryList = std::forward<AlertSummaryListT>(value);
  }
  template <typename AlertSummaryListT = Aws::Vector<AlertSummary>>
  ListAlertsResult& WithAlertSummaryList(AlertSummaryListT&& value) {
    SetAlertSummaryList(std::forward<AlertSummaryListT>(value));
    return *this;
  }
  template <typename AlertSummaryListT = AlertSummary>
  ListAlertsResult& AddAlertSummaryList(AlertSummaryListT&& value) {
    m_alertSummaryListHasBeenSet = true;
    m_alertSummaryList.emplace_back(std::forward<AlertSummaryListT>(value));
    return *this;
  }
  ///@}
