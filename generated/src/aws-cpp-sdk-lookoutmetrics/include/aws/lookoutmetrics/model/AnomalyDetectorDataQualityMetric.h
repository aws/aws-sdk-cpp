...
class AnomalyDetectorDataQualityMetric {
 public:
   ...
   */
  inline const Aws::Vector<MetricSetDataQualityMetric>& GetMetricSetDataQualityMetricList() const {
    return m_metricSetDataQualityMetricList;
  }
  ...
  void SetMetricSetDataQualityMetricList(MetricSetDataQualityMetricListT&& value) {
    ...
    m_metricSetDataQualityMetricList = std::forward<MetricSetDataQualityMetricListT>(value);
  }
  template <typename MetricSetDataQualityMetricListT = Aws::Vector<MetricSetDataQualityMetric>>
  AnomalyDetectorDataQualityMetric& WithMetricSetDataQualityMetricList(MetricSetDataQualityMetricListT&& value) {
    SetMetricSetDataQualityMetricList(std::forward<MetricSetDataQualityMetricListT>(value));
    return *this;
  }
  ...
  AnomalyDetectorDataQualityMetric& AddMetricSetDataQualityMetricList(MetricSetDataQualityMetricListT&& value) {
    m_metricSetDataQualityMetricListHasBeenSet = true;
    m_metricSetDataQualityMetricList.emplace_back(std::forward<MetricSetDataQualityMetricListT>(value));
    return *this;
  }
  ///@}
 private:
