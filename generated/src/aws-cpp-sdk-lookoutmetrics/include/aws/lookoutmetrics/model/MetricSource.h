...
class MetricSource {
 public:
  ...
  void SetS3SourceConfig(S3SourceConfigT&& value) {
    ...
    m_s3SourceConfig = std::forward<S3SourceConfigT>(value);
  }
  template <typename S3SourceConfigT = S3SourceConfig>
  MetricSource& WithS3SourceConfig(S3SourceConfigT&& value) {
    SetS3SourceConfig(std::forward<S3SourceConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAppFlowConfig(AppFlowConfigT&& value) {
    ...
    m_appFlowConfig = std::forward<AppFlowConfigT>(value);
  }
  template <typename AppFlowConfigT = AppFlowConfig>
  MetricSource& WithAppFlowConfig(AppFlowConfigT&& value) {
    SetAppFlowConfig(std::forward<AppFlowConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRDSSourceConfig(RDSSourceConfigT&& value) {
    ...
    m_rDSSourceConfig = std::forward<RDSSourceConfigT>(value);
  }
  template <typename RDSSourceConfigT = RDSSourceConfig>
  MetricSource& WithRDSSourceConfig(RDSSourceConfigT&& value) {
    SetRDSSourceConfig(std::forward<RDSSourceConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRedshiftSourceConfig(RedshiftSourceConfigT&& value) {
    ...
    m_redshiftSourceConfig = std::forward<RedshiftSourceConfigT>(value);
  }
  template <typename RedshiftSourceConfigT = RedshiftSourceConfig>
  MetricSource& WithRedshiftSourceConfig(RedshiftSourceConfigT&& value) {
    SetRedshiftSourceConfig(std::forward<RedshiftSourceConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAthenaSourceConfig(AthenaSourceConfigT&& value) {
    ...
    m_athenaSourceConfig = std::forward<AthenaSourceConfigT>(value);
  }
  template <typename AthenaSourceConfigT = AthenaSourceConfig>
  MetricSource& WithAthenaSourceConfig(AthenaSourceConfigT&& value) {
    SetAthenaSourceConfig(std::forward<AthenaSourceConfigT>(value));
    return *this;
  }
  ///@}
 private:
