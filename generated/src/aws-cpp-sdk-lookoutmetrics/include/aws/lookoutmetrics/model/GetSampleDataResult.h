...
class GetSampleDataResult {
 public:
  ...
  template <typename HeaderValuesT = Aws::Vector<Aws::String>>
  GetSampleDataResult& WithHeaderValues(HeaderValuesT&& value) {
    SetHeaderValues(std::forward<HeaderValuesT>(value));
    return *this;
  }
  template <typename HeaderValuesT = Aws::String>
  GetSampleDataResult& AddHeaderValues(HeaderValuesT&& value) {
    m_headerValuesHasBeenSet = true;
  ...
  void SetSampleRows(SampleRowsT&& value) {
    m_sampleRowsHasBeenSet = true;
    m_sampleRows = std::forward<SampleRowsT>(value);
  }
  template <typename SampleRowsT = Aws::Vector<Aws::Vector<Aws::String>>>
  GetSampleDataResult& WithSampleRows(SampleRowsT&& value) {
    SetSampleRows(std::forward<SampleRowsT>(value));
    return *this;
  }
  template <typename SampleRowsT = Aws::Vector<Aws::String>>
  GetSampleDataResult& AddSampleRows(SampleRowsT&& value) {
    m_sampleRowsHasBeenSet = true;
    m_sampleRows.emplace_back(std::forward<SampleRowsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetSampleDataResult& WithRequestId(RequestIdT&& value) {
