...
class AutoDetectionS3SourceConfig {
 public:
  ...
  void SetHistoricalDataPathList(HistoricalDataPathListT&& value) {
    ...
    m_historicalDataPathList = std::forward<HistoricalDataPathListT>(value);
  }
  template <typename HistoricalDataPathListT = Aws::Vector<Aws::String>>
  AutoDetectionS3SourceConfig& WithHistoricalDataPathList(HistoricalDataPathListT&& value) {
    SetHistoricalDataPathList(std::forward<HistoricalDataPathListT>(value));
    return *this;
  }
  ...
  AutoDetectionS3SourceConfig& AddHistoricalDataPathList(HistoricalDataPathListT&& value) {
    m_historicalDataPathListHasBeenSet = true;
    m_historicalDataPathList.emplace_back(std::forward<HistoricalDataPathListT>(value));
    return *this;
  }
  ///@}
 private:
