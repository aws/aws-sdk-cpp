...
class ListAnomalyGroupRelatedMetricsRequest : public LookoutMetricsRequest {
 public:
  ...
  template <typename AnomalyDetectorArnT = Aws::String>
  ListAnomalyGroupRelatedMetricsRequest& WithAnomalyDetectorArn(AnomalyDetectorArnT&& value) {
  ...
  template <typename AnomalyGroupIdT = Aws::String>
  ListAnomalyGroupRelatedMetricsRequest& WithAnomalyGroupId(AnomalyGroupIdT&& value) {
  ...
  inline void SetRelationshipTypeFilter(RelationshipType value) {
    m_relationshipTypeFilterHasBeenSet = true;
    m_relationshipTypeFilter = value;
  }
  inline ListAnomalyGroupRelatedMetricsRequest& WithRelationshipTypeFilter(RelationshipType value) {
  ...
  inline ListAnomalyGroupRelatedMetricsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAnomalyGroupRelatedMetricsRequest& WithNextToken(NextTokenT&& value) {
