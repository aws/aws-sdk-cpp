...
class MetricSetDataQualityMetric {
 public:
  ...
  void SetMetricSetArn(MetricSetArnT&& value) {
    ...
    m_metricSetArn = std::forward<MetricSetArnT>(value);
  }
  template <typename MetricSetArnT = Aws::String>
  MetricSetDataQualityMetric& WithMetricSetArn(MetricSetArnT&& value) {
    SetMetricSetArn(std::forward<MetricSetArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDataQualityMetricList(DataQualityMetricListT&& value) {
    ...
    m_dataQualityMetricList = std::forward<DataQualityMetricListT>(value);
  }
  template <typename DataQualityMetricListT = Aws::Vector<DataQualityMetric>>
  MetricSetDataQualityMetric& WithDataQualityMetricList(DataQualityMetricListT&& value) {
    SetDataQualityMetricList(std::forward<DataQualityMetricListT>(value));
    return *this;
  }
  ...
  MetricSetDataQualityMetric& AddDataQualityMetricList(DataQualityMetricListT&& value) {
    m_dataQualityMetricListHasBeenSet = true;
    m_dataQualityMetricList.emplace_back(std::forward<DataQualityMetricListT>(value));
    return *this;
  }
  ///@}
 private:
