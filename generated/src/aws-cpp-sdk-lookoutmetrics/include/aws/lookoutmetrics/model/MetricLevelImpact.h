...
class MetricLevelImpact {
 public:
  ...
  inline void SetNumTimeSeries(int value) {
    m_numTimeSeriesHasBeenSet = true;
    m_numTimeSeries = value;
  }
  inline MetricLevelImpact& WithNumTimeSeries(int value) {
    SetNumTimeSeries(value);
    return *this;
  }
  ///@}
  ...
  void SetContributionMatrix(ContributionMatrixT&& value) {
    ...
    m_contributionMatrix = std::forward<ContributionMatrixT>(value);
  }
  template <typename ContributionMatrixT = ContributionMatrix>
  MetricLevelImpact& WithContributionMatrix(ContributionMatrixT&& value) {
    SetContributionMatrix(std::forward<ContributionMatrixT>(value));
    return *this;
  }
  ///@}
 private:
