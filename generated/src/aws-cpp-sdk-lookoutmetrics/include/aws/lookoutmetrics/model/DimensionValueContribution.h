...
class DimensionValueContribution {
 public:
  ...
  template <typename DimensionValueT = Aws::String>
  DimensionValueContribution& WithDimensionValue(DimensionValueT&& value) {
  ...
  inline void SetContributionScore(double value) {
    m_contributionScoreHasBeenSet = true;
    m_contributionScore = value;
  }
  inline DimensionValueContribution& WithContributionScore(double value) {
