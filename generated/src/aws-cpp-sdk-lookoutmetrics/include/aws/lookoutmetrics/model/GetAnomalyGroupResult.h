...
class GetAnomalyGroupResult {
 public:
  ...
  void SetAnomalyGroup(AnomalyGroupT&& value) {
    m_anomalyGroupHasBeenSet = true;
    m_anomalyGroup = std::forward<AnomalyGroupT>(value);
  }
  template <typename AnomalyGroupT = AnomalyGroup>
  GetAnomalyGroupResult& WithAnomalyGroup(AnomalyGroupT&& value) {
    SetAnomalyGroup(std::forward<AnomalyGroupT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetAnomalyGroupResult& WithRequestId(RequestIdT&& value) {
