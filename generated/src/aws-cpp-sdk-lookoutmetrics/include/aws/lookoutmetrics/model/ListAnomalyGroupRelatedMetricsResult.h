...
class ListAnomalyGroupRelatedMetricsResult {
 public:
  ...
  AWS_LOOKOUTMETRICS_API ListAnomalyGroupRelatedMetricsResult& operator=(
  ...
  void SetInterMetricImpactList(InterMetricImpactListT&& value) {
    m_interMetricImpactListHasBeenSet = true;
    m_interMetricImpactList = std::forward<InterMetricImpactListT>(value);
  }
  template <typename InterMetricImpactListT = Aws::Vector<InterMetricImpactDetails>>
  ListAnomalyGroupRelatedMetricsResult& WithInterMetricImpactList(InterMetricImpactListT&& value) {
    SetInterMetricImpactList(std::forward<InterMetricImpactListT>(value));
    return *this;
  }
  template <typename InterMetricImpactListT = InterMetricImpactDetails>
  ListAnomalyGroupRelatedMetricsResult& AddInterMetricImpactList(InterMetricImpactListT&& value) {
    m_interMetricImpactListHasBeenSet = true;
    m_interMetricImpactList.emplace_back(std::forward<InterMetricImpactListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAnomalyGroupRelatedMetricsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAnomalyGroupRelatedMetricsResult& WithRequestId(RequestIdT&& value) {
