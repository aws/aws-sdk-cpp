...
class DetectMetricSetConfigResult {
 public:
  ...
  void SetDetectedMetricSetConfig(DetectedMetricSetConfigT&& value) {
    m_detectedMetricSetConfigHasBeenSet = true;
    m_detectedMetricSetConfig = std::forward<DetectedMetricSetConfigT>(value);
  }
  template <typename DetectedMetricSetConfigT = DetectedMetricSetConfig>
  DetectMetricSetConfigResult& WithDetectedMetricSetConfig(DetectedMetricSetConfigT&& value) {
    SetDetectedMetricSetConfig(std::forward<DetectedMetricSetConfigT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DetectMetricSetConfigResult& WithRequestId(RequestIdT&& value) {
