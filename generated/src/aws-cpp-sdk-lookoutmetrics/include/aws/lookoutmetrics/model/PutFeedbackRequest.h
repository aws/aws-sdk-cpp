...
class PutFeedbackRequest : public LookoutMetricsRequest {
 public:
  ...
  template <typename AnomalyDetectorArnT = Aws::String>
  PutFeedbackRequest& WithAnomalyDetectorArn(AnomalyDetectorArnT&& value) {
  ...
  void SetAnomalyGroupTimeSeriesFeedback(AnomalyGroupTimeSeriesFeedbackT&& value) {
    m_anomalyGroupTimeSeriesFeedbackHasBeenSet = true;
    m_anomalyGroupTimeSeriesFeedback = std::forward<AnomalyGroupTimeSeriesFeedbackT>(value);
  }
  template <typename AnomalyGroupTimeSeriesFeedbackT = AnomalyGroupTimeSeriesFeedback>
  PutFeedbackRequest& WithAnomalyGroupTimeSeriesFeedback(AnomalyGroupTimeSeriesFeedbackT&& value) {
    SetAnomalyGroupTimeSeriesFeedback(std::forward<AnomalyGroupTimeSeriesFeedbackT>(value));
    return *this;
  }
  ///@}
 private:
