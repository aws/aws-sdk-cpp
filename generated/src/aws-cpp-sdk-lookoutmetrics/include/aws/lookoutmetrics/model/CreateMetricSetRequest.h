...
class CreateMetricSetRequest : public LookoutMetricsRequest {
 public:
  ...
  void SetMetricSetName(MetricSetNameT&& value) {
    ...
    m_metricSetName = std::forward<MetricSetNameT>(value);
  }
  template <typename MetricSetNameT = Aws::String>
  CreateMetricSetRequest& WithMetricSetName(MetricSetNameT&& value) {
    SetMetricSetName(std::forward<MetricSetNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMetricSetDescription(MetricSetDescriptionT&& value) {
    ...
    m_metricSetDescription = std::forward<MetricSetDescriptionT>(value);
  }
  template <typename MetricSetDescriptionT = Aws::String>
  CreateMetricSetRequest& WithMetricSetDescription(MetricSetDescriptionT&& value) {
    SetMetricSetDescription(std::forward<MetricSetDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateMetricSetRequest& WithOffset(int value) {
    SetOffset(value);
    return *this;
  }
  ///@}
  ...
  void SetTimestampColumn(TimestampColumnT&& value) {
    ...
    m_timestampColumn = std::forward<TimestampColumnT>(value);
  }
  template <typename TimestampColumnT = TimestampColumn>
  CreateMetricSetRequest& WithTimestampColumn(TimestampColumnT&& value) {
    SetTimestampColumn(std::forward<TimestampColumnT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetMetricSetFrequency(Frequency value) {
    m_metricSetFrequencyHasBeenSet = true;
    m_metricSetFrequency = value;
  }
  inline CreateMetricSetRequest& WithMetricSetFrequency(Frequency value) {
    SetMetricSetFrequency(value);
    return *this;
  }
  ///@}
  ...
  void SetDimensionFilterList(DimensionFilterListT&& value) {
    ...
    m_dimensionFilterList = std::forward<DimensionFilterListT>(value);
  }
  template <typename DimensionFilterListT = Aws::Vector<MetricSetDimensionFilter>>
  CreateMetricSetRequest& WithDimensionFilterList(DimensionFilterListT&& value) {
    SetDimensionFilterList(std::forward<DimensionFilterListT>(value));
    return *this;
  }
  ...
  CreateMetricSetRequest& AddDimensionFilterList(DimensionFilterListT&& value) {
    m_dimensionFilterListHasBeenSet = true;
    m_dimensionFilterList.emplace_back(std::forward<DimensionFilterListT>(value));
    return *this;
  }
  ///@}
 private:
