...
class RedshiftSourceConfig {
 public:
  ...
  void SetDatabaseHost(DatabaseHostT&& value) {
    ...
    m_databaseHost = std::forward<DatabaseHostT>(value);
  }
  template <typename DatabaseHostT = Aws::String>
  RedshiftSourceConfig& WithDatabaseHost(DatabaseHostT&& value) {
    SetDatabaseHost(std::forward<DatabaseHostT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetDatabasePort(int value) {
    m_databasePortHasBeenSet = true;
    m_databasePort = value;
  }
  inline RedshiftSourceConfig& WithDatabasePort(int value) {
  ...
  void SetSecretManagerArn(SecretManagerArnT&& value) {
    ...
    m_secretManagerArn = std::forward<SecretManagerArnT>(value);
  }
  template <typename SecretManagerArnT = Aws::String>
  RedshiftSourceConfig& WithSecretManagerArn(SecretManagerArnT&& value) {
    SetSecretManagerArn(std::forward<SecretManagerArnT>(value));
    return *this;
  }
  ///@}
