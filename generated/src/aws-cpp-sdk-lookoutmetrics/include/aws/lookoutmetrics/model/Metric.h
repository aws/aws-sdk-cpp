...
class Metric {
 public:
  ...
  inline void SetAggregationFunction(AggregationFunction value) {
    m_aggregationFunctionHasBeenSet = true;
    m_aggregationFunction = value;
  }
  inline Metric& WithAggregationFunction(AggregationFunction value) {
