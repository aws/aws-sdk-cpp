...
class ListAnomalyGroupSummariesResult {
 public:
  ...
  void SetAnomalyGroupSummaryList(AnomalyGroupSummaryListT&& value) {
    m_anomalyGroupSummaryListHasBeenSet = true;
    m_anomalyGroupSummaryList = std::forward<AnomalyGroupSummaryListT>(value);
  }
  template <typename AnomalyGroupSummaryListT = Aws::Vector<AnomalyGroupSummary>>
  ListAnomalyGroupSummariesResult& WithAnomalyGroupSummaryList(AnomalyGroupSummaryListT&& value) {
    SetAnomalyGroupSummaryList(std::forward<AnomalyGroupSummaryListT>(value));
    return *this;
  }
  template <typename AnomalyGroupSummaryListT = AnomalyGroupSummary>
  ListAnomalyGroupSummariesResult& AddAnomalyGroupSummaryList(AnomalyGroupSummaryListT&& value) {
    m_anomalyGroupSummaryListHasBeenSet = true;
    m_anomalyGroupSummaryList.emplace_back(std::forward<AnomalyGroupSummaryListT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAnomalyGroupStatistics(AnomalyGroupStatisticsT&& value) {
    m_anomalyGroupStatisticsHasBeenSet = true;
    m_anomalyGroupStatistics = std::forward<AnomalyGroupStatisticsT>(value);
  }
  template <typename AnomalyGroupStatisticsT = AnomalyGroupStatistics>
  ListAnomalyGroupSummariesResult& WithAnomalyGroupStatistics(AnomalyGroupStatisticsT&& value) {
    SetAnomalyGroupStatistics(std::forward<AnomalyGroupStatisticsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAnomalyGroupSummariesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAnomalyGroupSummariesResult& WithRequestId(RequestIdT&& value) {
