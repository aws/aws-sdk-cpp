...
class SNSConfiguration {
 public:
  ...
  template <typename RoleArnT = Aws::String>
  SNSConfiguration& WithRoleArn(RoleArnT&& value) {
  ...
  template <typename SnsTopicArnT = Aws::String>
  SNSConfiguration& WithSnsTopicArn(SnsTopicArnT&& value) {
  ...
  inline void SetSnsFormat(SnsFormat value) {
    m_snsFormatHasBeenSet = true;
    m_snsFormat = value;
  }
  inline SNSConfiguration& WithSnsFormat(SnsFormat value) {
    SetSnsFormat(value);
    return *this;
  }
  ///@}
