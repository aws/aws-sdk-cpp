...
class VpcConfiguration {
 public:
  ...
  template <typename SubnetIdListT = Aws::Vector<Aws::String>>
  VpcConfiguration& WithSubnetIdList(SubnetIdListT&& value) {
    SetSubnetIdList(std::forward<SubnetIdListT>(value));
    return *this;
  }
  template <typename SubnetIdListT = Aws::String>
  VpcConfiguration& AddSubnetIdList(SubnetIdListT&& value) {
    m_subnetIdListHasBeenSet = true;
  ...
  template <typename SecurityGroupIdListT = Aws::Vector<Aws::String>>
  VpcConfiguration& WithSecurityGroupIdList(SecurityGroupIdListT&& value) {
    SetSecurityGroupIdList(std::forward<SecurityGroupIdListT>(value));
    return *this;
  }
  template <typename SecurityGroupIdListT = Aws::String>
  VpcConfiguration& AddSecurityGroupIdList(SecurityGroupIdListT&& value) {
    m_securityGroupIdListHasBeenSet = true;
