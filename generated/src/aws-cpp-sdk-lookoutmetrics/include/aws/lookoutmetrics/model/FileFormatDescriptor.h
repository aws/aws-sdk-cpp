...
class FileFormatDescriptor {
 public:
  ...
  void SetCsvFormatDescriptor(CsvFormatDescriptorT&& value) {
    ...
    m_csvFormatDescriptor = std::forward<CsvFormatDescriptorT>(value);
  }
  template <typename CsvFormatDescriptorT = CsvFormatDescriptor>
  FileFormatDescriptor& WithCsvFormatDescriptor(CsvFormatDescriptorT&& value) {
    SetCsvFormatDescriptor(std::forward<CsvFormatDescriptorT>(value));
    return *this;
  }
  ///@}
  ...
  void SetJsonFormatDescriptor(JsonFormatDescriptorT&& value) {
    ...
    m_jsonFormatDescriptor = std::forward<JsonFormatDescriptorT>(value);
  }
  template <typename JsonFormatDescriptorT = JsonFormatDescriptor>
  FileFormatDescriptor& WithJsonFormatDescriptor(JsonFormatDescriptorT&& value) {
    SetJsonFormatDescriptor(std::forward<JsonFormatDescriptorT>(value));
    return *this;
  }
  ///@}
 private:
