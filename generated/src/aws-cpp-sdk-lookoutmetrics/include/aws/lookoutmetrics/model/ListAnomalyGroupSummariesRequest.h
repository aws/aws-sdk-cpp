...
class ListAnomalyGroupSummariesRequest : public LookoutMetricsRequest {
 public:
  AWS_LOOKOUTMETRICS_API ListAnomalyGroupSummariesRequest() = default;
  ...
  template <typename AnomalyDetectorArnT = Aws::String>
  ListAnomalyGroupSummariesRequest& WithAnomalyDetectorArn(AnomalyDetectorArnT&& value) {
  ...
  inline void SetSensitivityThreshold(int value) {
    m_sensitivityThresholdHasBeenSet = true;
    m_sensitivityThreshold = value;
  }
  inline ListAnomalyGroupSummariesRequest& WithSensitivityThreshold(int value) {
    SetSensitivityThreshold(value);
    return *this;
  }
  ///@}
  ...
  inline ListAnomalyGroupSummariesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAnomalyGroupSummariesRequest& WithNextToken(NextTokenT&& value) {
