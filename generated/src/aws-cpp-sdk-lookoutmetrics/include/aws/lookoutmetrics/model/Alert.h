...
class Alert {
 public:
  ...
  void SetAlertName(AlertNameT&& value) {
    ...
    m_alertName = std::forward<AlertNameT>(value);
  }
  template <typename AlertNameT = Aws::String>
  Alert& WithAlertName(AlertNameT&& value) {
    SetAlertName(std::forward<AlertNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline Alert& WithAlertSensitivityThreshold(int value) {
  ...
  inline void SetAlertType(AlertType value) {
    m_alertTypeHasBeenSet = true;
    m_alertType = value;
  }
  inline Alert& WithAlertType(AlertType value) {
    SetAlertType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAlertStatus(AlertStatus value) {
    m_alertStatusHasBeenSet = true;
    m_alertStatus = value;
  }
  inline Alert& WithAlertStatus(AlertStatus value) {
