...
class CsvFormatDescriptor {
 public:
  ...
  inline void SetFileCompression(CSVFileCompression value) {
    m_fileCompressionHasBeenSet = true;
    m_fileCompression = value;
  }
  inline CsvFormatDescriptor& WithFileCompression(CSVFileCompression value) {
    SetFileCompression(value);
    return *this;
  }
  ///@}
  ...
  inline CsvFormatDescriptor& WithContainsHeader(bool value) {
  ...
  CsvFormatDescriptor& AddHeaderList(HeaderListT&& value) {
    m_headerListHasBeenSet = true;
    m_headerList.emplace_back(std::forward<HeaderListT>(value));
    return *this;
  }
  ///@}
