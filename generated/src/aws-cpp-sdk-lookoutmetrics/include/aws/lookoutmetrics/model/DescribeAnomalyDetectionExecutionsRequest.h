...
class DescribeAnomalyDetectionExecutionsRequest : public LookoutMetricsRequest {
 public:
  ...
  template <typename AnomalyDetectorArnT = Aws::String>
  DescribeAnomalyDetectionExecutionsRequest& WithAnomalyDetectorArn(AnomalyDetectorArnT&& value) {
  ...
  template <typename TimestampT = Aws::String>
  DescribeAnomalyDetectionExecutionsRequest& WithTimestamp(TimestampT&& value) {
  ...
  inline DescribeAnomalyDetectionExecutionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeAnomalyDetectionExecutionsRequest& WithNextToken(NextTokenT&& value) {
