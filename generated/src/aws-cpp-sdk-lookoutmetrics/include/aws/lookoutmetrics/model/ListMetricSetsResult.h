...
class ListMetricSetsResult {
 public:
  ...
  void SetMetricSetSummaryList(MetricSetSummaryListT&& value) {
    m_metricSetSummaryListHasBeenSet = true;
    m_metricSetSummaryList = std::forward<MetricSetSummaryListT>(value);
  }
  template <typename MetricSetSummaryListT = Aws::Vector<MetricSetSummary>>
  ListMetricSetsResult& WithMetricSetSummaryList(MetricSetSummaryListT&& value) {
    SetMetricSetSummaryList(std::forward<MetricSetSummaryListT>(value));
    return *this;
  }
  template <typename MetricSetSummaryListT = MetricSetSummary>
  ListMetricSetsResult& AddMetricSetSummaryList(MetricSetSummaryListT&& value) {
    m_metricSetSummaryListHasBeenSet = true;
    m_metricSetSummaryList.emplace_back(std::forward<MetricSetSummaryListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListMetricSetsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListMetricSetsResult& WithRequestId(RequestIdT&& value) {
