...
namespace Model
{
  ...
  /**
   * <p>The request exceeded the service's quotas. Check the service quotas and try
   * again.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/lookoutmetrics-2017-07-25/ServiceQuotaExceededException">AWS
   * API Reference</a></p>
   */
