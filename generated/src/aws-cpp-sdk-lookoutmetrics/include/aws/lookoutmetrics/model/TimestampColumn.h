...
class TimestampColumn {
 public:
  ...
  template <typename ColumnNameT = Aws::String>
  TimestampColumn& WithColumnName(ColumnNameT&& value) {
  ...
  void SetColumnFormat(ColumnFormatT&& value) {
    m_columnFormatHasBeenSet = true;
    m_columnFormat = std::forward<ColumnFormatT>(value);
  }
  template <typename ColumnFormatT = Aws::String>
  TimestampColumn& WithColumnFormat(ColumnFormatT&& value) {
    SetColumnFormat(std::forward<ColumnFormatT>(value));
    return *this;
  }
  ///@}
 private:
