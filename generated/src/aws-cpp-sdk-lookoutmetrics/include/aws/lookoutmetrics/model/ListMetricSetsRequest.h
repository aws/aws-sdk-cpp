...
namespace Model
{
  ...
  /**
   */
  class ListMetricSetsRequest : public LookoutMetricsRequest
  {
  public:
    ...
    template<typename AnomalyDetectorArnT = Aws::String>
    ListMetricSetsRequest& WithAnomalyDetectorArn(AnomalyDetectorArnT&& value) { SetAnomalyDetectorArn(std::forward<AnomalyDetectorArnT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListMetricSetsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
