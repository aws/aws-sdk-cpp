...
class InterMetricImpactDetails {
 public:
  ...
  inline InterMetricImpactDetails& WithRelationshipType(RelationshipType value) {
  ...
  inline void SetContributionPercentage(double value) {
    m_contributionPercentageHasBeenSet = true;
    m_contributionPercentage = value;
  }
  inline InterMetricImpactDetails& WithContributionPercentage(double value) {
