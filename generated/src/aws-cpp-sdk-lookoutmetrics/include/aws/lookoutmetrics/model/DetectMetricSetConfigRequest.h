...
class DetectMetricSetConfigRequest : public LookoutMetricsRequest {
 public:
  ...
  void SetAutoDetectionMetricSource(AutoDetectionMetricSourceT&& value) {
    m_autoDetectionMetricSourceHasBeenSet = true;
    m_autoDetectionMetricSource = std::forward<AutoDetectionMetricSourceT>(value);
  }
  template <typename AutoDetectionMetricSourceT = AutoDetectionMetricSource>
  DetectMetricSetConfigRequest& WithAutoDetectionMetricSource(AutoDetectionMetricSourceT&& value) {
    SetAutoDetectionMetricSource(std::forward<AutoDetectionMetricSourceT>(value));
    return *this;
  }
  ///@}
 private:
