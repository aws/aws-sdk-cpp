...
class DataQualityMetric {
 public:
  ...
  inline void SetMetricType(DataQualityMetricType value) {
    m_metricTypeHasBeenSet = true;
    m_metricType = value;
  }
  inline DataQualityMetric& WithMetricType(DataQualityMetricType value) {
    SetMetricType(value);
    return *this;
  }
  ///@}
  ...
  void SetMetricDescription(MetricDescriptionT&& value) {
    ...
    m_metricDescription = std::forward<MetricDescriptionT>(value);
  }
  template <typename MetricDescriptionT = Aws::String>
  DataQualityMetric& WithMetricDescription(MetricDescriptionT&& value) {
    SetMetricDescription(std::forward<MetricDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRelatedColumnName(RelatedColumnNameT&& value) {
    ...
    m_relatedColumnName = std::forward<RelatedColumnNameT>(value);
  }
  template <typename RelatedColumnNameT = Aws::String>
  DataQualityMetric& WithRelatedColumnName(RelatedColumnNameT&& value) {
    SetRelatedColumnName(std::forward<RelatedColumnNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline DataQualityMetric& WithMetricValue(double value) {
