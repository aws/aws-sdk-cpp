...
class DescribeAnomalyDetectorResult {
 public:
  ...
  void SetAnomalyDetectorName(AnomalyDetectorNameT&& value) {
    ...
    m_anomalyDetectorName = std::forward<AnomalyDetectorNameT>(value);
  }
  template <typename AnomalyDetectorNameT = Aws::String>
  DescribeAnomalyDetectorResult& WithAnomalyDetectorName(AnomalyDetectorNameT&& value) {
    SetAnomalyDetectorName(std::forward<AnomalyDetectorNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAnomalyDetectorDescription(AnomalyDetectorDescriptionT&& value) {
    ...
    m_anomalyDetectorDescription = std::forward<AnomalyDetectorDescriptionT>(value);
  }
  template <typename AnomalyDetectorDescriptionT = Aws::String>
  DescribeAnomalyDetectorResult& WithAnomalyDetectorDescription(AnomalyDetectorDescriptionT&& value) {
    SetAnomalyDetectorDescription(std::forward<AnomalyDetectorDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAnomalyDetectorConfig(AnomalyDetectorConfigT&& value) {
    ...
    m_anomalyDetectorConfig = std::forward<AnomalyDetectorConfigT>(value);
  }
  template <typename AnomalyDetectorConfigT = AnomalyDetectorConfigSummary>
  DescribeAnomalyDetectorResult& WithAnomalyDetectorConfig(AnomalyDetectorConfigT&& value) {
    SetAnomalyDetectorConfig(std::forward<AnomalyDetectorConfigT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(AnomalyDetectorStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline DescribeAnomalyDetectorResult& WithStatus(AnomalyDetectorStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFailureType(AnomalyDetectorFailureType value) {
    m_failureTypeHasBeenSet = true;
    m_failureType = value;
  }
  inline DescribeAnomalyDetectorResult& WithFailureType(AnomalyDetectorFailureType value) {
