...
class DescribeAnomalyDetectionExecutionsResult {
 public:
  ...
  AWS_LOOKOUTMETRICS_API DescribeAnomalyDetectionExecutionsResult& operator=(
  ...
  void SetExecutionList(ExecutionListT&& value) {
    ...
    m_executionList = std::forward<ExecutionListT>(value);
  }
  template <typename ExecutionListT = Aws::Vector<ExecutionStatus>>
  DescribeAnomalyDetectionExecutionsResult& WithExecutionList(ExecutionListT&& value) {
    SetExecutionList(std::forward<ExecutionListT>(value));
    return *this;
  }
  ...
  DescribeAnomalyDetectionExecutionsResult& AddExecutionList(ExecutionListT&& value) {
    m_executionListHasBeenSet = true;
    m_executionList.emplace_back(std::forward<ExecutionListT>(value));
    return *this;
  }
  ///@}
