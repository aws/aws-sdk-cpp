...
GetTableMaintenanceConfigurationResult& GetTableMaintenanceConfigurationResult::operator=(
  ...
  if (jsonValue.ValueExists("configuration")) {
    ...
    for (auto& configurationItem : configurationJsonMap) {
      m_configuration[TableMaintenanceTypeMapper::GetTableMaintenanceTypeForName(configurationItem.first)] =
