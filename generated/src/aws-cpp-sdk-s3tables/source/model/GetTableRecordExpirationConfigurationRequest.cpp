...
Aws::String GetTableRecordExpirationConfigurationRequest::SerializePayload() const { return {}; }

void GetTableRecordExpirationConfigurationRequest::AddQueryStringParameters(URI& uri) const {
  Aws::StringStream ss;
