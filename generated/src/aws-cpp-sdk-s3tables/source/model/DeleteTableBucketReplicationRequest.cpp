...
Aws::String DeleteTableBucketReplicationRequest::SerializePayload() const { return {}; }

void DeleteTableBucketReplicationRequest::AddQueryStringParameters(URI& uri) const {
  Aws::StringStream ss;
