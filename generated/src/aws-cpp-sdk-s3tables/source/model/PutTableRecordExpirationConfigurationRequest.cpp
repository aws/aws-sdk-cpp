...
Aws::String PutTableRecordExpirationConfigurationRequest::SerializePayload() const {
  JsonValue payload;
...
void PutTableRecordExpirationConfigurationRequest::AddQueryStringParameters(URI& uri) const {
  Aws::StringStream ss;
