...
GetTableBucketMetricsConfigurationResult::GetTableBucketMetricsConfigurationResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

GetTableBucketMetricsConfigurationResult& GetTableBucketMetricsConfigurationResult::operator=(
