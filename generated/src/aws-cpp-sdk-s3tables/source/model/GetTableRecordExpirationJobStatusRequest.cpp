...
Aws::String GetTableRecordExpirationJobStatusRequest::SerializePayload() const { return {}; }

void GetTableRecordExpirationJobStatusRequest::AddQueryStringParameters(URI& uri) const {
  Aws::StringStream ss;
