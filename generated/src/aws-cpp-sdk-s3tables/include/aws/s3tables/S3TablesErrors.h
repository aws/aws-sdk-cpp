...
public:
  ...
  S3TablesError(const Aws::Client::AWSError<S3TablesErrors>& rhs) : Aws::Client::AWSError<S3TablesErrors>(rhs) {}
  S3TablesError(Aws::Client::AWSError<S3TablesErrors>&& rhs) : Aws::Client::AWSError<S3TablesErrors>(rhs) {}
