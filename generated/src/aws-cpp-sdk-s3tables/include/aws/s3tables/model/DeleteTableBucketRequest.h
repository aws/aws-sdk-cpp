...
namespace Model
{
  ...
  {
  public:
    AWS_S3TABLES_API DeleteTableBucketRequest() = default;
    ...
    template<typename TableBucketARNT = Aws::String>
    DeleteTableBucketRequest& WithTableBucketARN(TableBucketARNT&& value) { SetTableBucketARN(std::forward<TableBucketARNT>(value)); return *this;}
    ///@}
  private:
