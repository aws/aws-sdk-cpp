...
class PutTableMaintenanceConfigurationRequest : public S3TablesRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  PutTableMaintenanceConfigurationRequest& WithName(NameT&& value) {
  ...
  inline void SetType(TableMaintenanceType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline PutTableMaintenanceConfigurationRequest& WithType(TableMaintenanceType value) {
    SetType(value);
    return *this;
  }
  ///@}
