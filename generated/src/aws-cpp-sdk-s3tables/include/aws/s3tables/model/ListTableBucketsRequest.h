...
class ListTableBucketsRequest : public S3TablesRequest {
 public:
  ...
  inline void SetMaxBuckets(int value) {
    m_maxBucketsHasBeenSet = true;
    m_maxBuckets = value;
  }
  inline ListTableBucketsRequest& WithMaxBuckets(int value) {
    SetMaxBuckets(value);
    return *this;
  }
  ///@}
  ...
  inline ListTableBucketsRequest& WithType(TableBucketType value) {
    SetType(value);
    return *this;
  }
  ///@}
