...
class IcebergCompactionSettings {
 public:
  ...
  inline void SetTargetFileSizeMB(int value) {
    m_targetFileSizeMBHasBeenSet = true;
    m_targetFileSizeMB = value;
  }
  inline IcebergCompactionSettings& WithTargetFileSizeMB(int value) {
    SetTargetFileSizeMB(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStrategy(IcebergCompactionStrategy value) {
    m_strategyHasBeenSet = true;
    m_strategy = value;
  }
  inline IcebergCompactionSettings& WithStrategy(IcebergCompactionStrategy value) {
    SetStrategy(value);
    return *this;
  }
  ///@}
