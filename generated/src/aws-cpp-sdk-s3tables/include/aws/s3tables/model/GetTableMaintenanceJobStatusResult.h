...
class GetTableMaintenanceJobStatusResult {
 public:
  ...
  template <typename TableARNT = Aws::String>
  GetTableMaintenanceJobStatusResult& WithTableARN(TableARNT&& value) {
  ...
  template <typename StatusT = Aws::Map<TableMaintenanceJobType, TableMaintenanceJobStatusValue>>
  GetTableMaintenanceJobStatusResult& WithStatus(StatusT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetTableMaintenanceJobStatusResult& WithRequestId(RequestIdT&& value) {
