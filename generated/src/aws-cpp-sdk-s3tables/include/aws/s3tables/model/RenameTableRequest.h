...
class RenameTableRequest : public S3TablesRequest {
 public:
  ...
  template <typename TableBucketARNT = Aws::String>
  RenameTableRequest& WithTableBucketARN(TableBucketARNT&& value) {
  ...
  template <typename NamespaceT = Aws::String>
  RenameTableRequest& WithNamespace(NamespaceT&& value) {
  ...
  template <typename NameT = Aws::String>
  RenameTableRequest& WithName(NameT&& value) {
  ...
  void SetNewNamespaceName(NewNamespaceNameT&& value) {
    m_newNamespaceNameHasBeenSet = true;
    m_newNamespaceName = std::forward<NewNamespaceNameT>(value);
  }
  template <typename NewNamespaceNameT = Aws::String>
  RenameTableRequest& WithNewNamespaceName(NewNamespaceNameT&& value) {
    SetNewNamespaceName(std::forward<NewNamespaceNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNewName(NewNameT&& value) {
    m_newNameHasBeenSet = true;
    m_newName = std::forward<NewNameT>(value);
  }
  template <typename NewNameT = Aws::String>
  RenameTableRequest& WithNewName(NewNameT&& value) {
    SetNewName(std::forward<NewNameT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename VersionTokenT = Aws::String>
  RenameTableRequest& WithVersionToken(VersionTokenT&& value) {
