...
class DeleteTablePolicyRequest : public S3TablesRequest {
 public:
  AWS_S3TABLES_API DeleteTablePolicyRequest() = default;
  ...
  template <typename TableBucketARNT = Aws::String>
  DeleteTablePolicyRequest& WithTableBucketARN(TableBucketARNT&& value) {
  ...
  template <typename NamespaceT = Aws::String>
  DeleteTablePolicyRequest& WithNamespace(NamespaceT&& value) {
  ...
  template <typename NameT = Aws::String>
  DeleteTablePolicyRequest& WithName(NameT&& value) {
