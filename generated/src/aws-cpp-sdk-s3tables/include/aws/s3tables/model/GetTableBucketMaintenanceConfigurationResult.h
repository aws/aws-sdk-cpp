...
class GetTableBucketMaintenanceConfigurationResult {
 public:
  ...
  AWS_S3TABLES_API GetTableBucketMaintenanceConfigurationResult& operator=(
   ...
   */
  inline const Aws::Map<TableBucketMaintenanceType, TableBucketMaintenanceConfigurationValue>& GetConfiguration() const {
  ...
  inline GetTableBucketMaintenanceConfigurationResult& AddConfiguration(TableBucketMaintenanceType key,
                                                                        TableBucketMaintenanceConfigurationValue value) {
    m_configurationHasBeenSet = true;
