...
class GetTableMetadataLocationRequest : public S3TablesRequest {
 public:
  ...
  template <typename TableBucketARNT = Aws::String>
  GetTableMetadataLocationRequest& WithTableBucketARN(TableBucketARNT&& value) {
  ...
  template <typename NamespaceT = Aws::String>
  GetTableMetadataLocationRequest& WithNamespace(NamespaceT&& value) {
  ...
  template <typename NameT = Aws::String>
  GetTableMetadataLocationRequest& WithName(NameT&& value) {
