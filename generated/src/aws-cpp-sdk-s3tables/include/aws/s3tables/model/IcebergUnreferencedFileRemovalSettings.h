...
class IcebergUnreferencedFileRemovalSettings {
 public:
  ...
  inline void SetUnreferencedDays(int value) {
    m_unreferencedDaysHasBeenSet = true;
    m_unreferencedDays = value;
  }
  inline IcebergUnreferencedFileRemovalSettings& WithUnreferencedDays(int value) {
    SetUnreferencedDays(value);
    return *this;
  }
  ///@}
  ...
  inline IcebergUnreferencedFileRemovalSettings& WithNonCurrentDays(int value) {
