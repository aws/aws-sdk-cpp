...
namespace Model
{
  ...
  {
  public:
    AWS_S3TABLES_API GetTableBucketRequest() = default;
    ...
    template<typename TableBucketARNT = Aws::String>
    GetTableBucketRequest& WithTableBucketARN(TableBucketARNT&& value) { SetTableBucketARN(std::forward<TableBucketARNT>(value)); return *this;}
    ///@}
  private:
