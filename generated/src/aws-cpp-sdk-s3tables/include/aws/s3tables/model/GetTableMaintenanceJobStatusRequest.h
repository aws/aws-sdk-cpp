...
class GetTableMaintenanceJobStatusRequest : public S3TablesRequest {
 public:
  ...
  template <typename TableBucketARNT = Aws::String>
  GetTableMaintenanceJobStatusRequest& WithTableBucketARN(TableBucketARNT&& value) {
  ...
  template <typename NamespaceT = Aws::String>
  GetTableMaintenanceJobStatusRequest& WithNamespace(NamespaceT&& value) {
  ...
  template <typename NameT = Aws::String>
  GetTableMaintenanceJobStatusRequest& WithName(NameT&& value) {
