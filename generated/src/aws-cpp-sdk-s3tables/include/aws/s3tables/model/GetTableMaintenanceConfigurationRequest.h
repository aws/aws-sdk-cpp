...
class GetTableMaintenanceConfigurationRequest : public S3TablesRequest {
 public:
  ...
  template <typename TableBucketARNT = Aws::String>
  GetTableMaintenanceConfigurationRequest& WithTableBucketARN(TableBucketARNT&& value) {
  ...
  template <typename NamespaceT = Aws::String>
  GetTableMaintenanceConfigurationRequest& WithNamespace(NamespaceT&& value) {
  ...
  template <typename NameT = Aws::String>
  GetTableMaintenanceConfigurationRequest& WithName(NameT&& value) {
