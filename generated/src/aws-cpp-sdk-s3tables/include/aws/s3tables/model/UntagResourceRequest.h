...
/**
 */
class UntagResourceRequest : public S3TablesRequest {
 public:
  AWS_S3TABLES_API UntagResourceRequest() = default;
   ...
   * removing tags from. The tagged resource can be a table bucket or a table. For a
  ...
  ///@{
  /**
   * <p>The array of tag keys that you're removing from the S3 Tables resource. For
