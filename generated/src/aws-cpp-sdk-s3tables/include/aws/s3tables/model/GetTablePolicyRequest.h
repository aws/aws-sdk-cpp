...
class GetTablePolicyRequest : public S3TablesRequest {
 public:
  ...
  template <typename TableBucketARNT = Aws::String>
  GetTablePolicyRequest& WithTableBucketARN(TableBucketARNT&& value) {
  ...
  template <typename NamespaceT = Aws::String>
  GetTablePolicyRequest& WithNamespace(NamespaceT&& value) {
  ...
  template <typename NameT = Aws::String>
  GetTablePolicyRequest& WithName(NameT&& value) {
