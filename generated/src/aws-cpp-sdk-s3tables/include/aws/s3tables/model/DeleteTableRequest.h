...
class DeleteTableRequest : public S3TablesRequest {
 public:
  ...
  template <typename TableBucketARNT = Aws::String>
  DeleteTableRequest& WithTableBucketARN(TableBucketARNT&& value) {
  ...
  template <typename NamespaceT = Aws::String>
  DeleteTableRequest& WithNamespace(NamespaceT&& value) {
  ...
  template <typename VersionTokenT = Aws::String>
  DeleteTableRequest& WithVersionToken(VersionTokenT&& value) {
