...
class ListTableBucketsResult {
 public:
  ...
  void SetTableBuckets(TableBucketsT&& value) {
    m_tableBucketsHasBeenSet = true;
    m_tableBuckets = std::forward<TableBucketsT>(value);
  }
  template <typename TableBucketsT = Aws::Vector<TableBucketSummary>>
  ListTableBucketsResult& WithTableBuckets(TableBucketsT&& value) {
    SetTableBuckets(std::forward<TableBucketsT>(value));
    return *this;
  }
  template <typename TableBucketsT = TableBucketSummary>
  ListTableBucketsResult& AddTableBuckets(TableBucketsT&& value) {
    m_tableBucketsHasBeenSet = true;
    m_tableBuckets.emplace_back(std::forward<TableBucketsT>(value));
    return *this;
  }
  ///@}
