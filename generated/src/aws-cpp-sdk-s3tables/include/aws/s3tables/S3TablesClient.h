...
namespace S3Tables
{
   ...
   */
  class AWS_S3TABLES_API S3TablesClient : Aws::Client::ClientWithAsyncTemplateMethods<S3TablesClient>,
    smithy::client::AwsSmithyClientT<Aws::S3Tables::SERVICE_NAME,
