...
'"','h','t','t','p','s',':','/','/','s','s','m','-','g','u','i','c','o','n','n','e','c','t','-','f',
...
't','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','s','s','m','-','g','u',
'i','c','o','n','n','e','c','t','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t',
...
const char* SSMGuiConnectEndpointRules::GetRulesBlob()
{
