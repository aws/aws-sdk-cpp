...
namespace Model
{
  class UpdateConnectionRecordingPreferencesResult
  {
  public:
    AWS_SSMGUICONNECT_API UpdateConnectionRecordingPreferencesResult() = default;
    AWS_SSMGUICONNECT_API UpdateConnectionRecordingPreferencesResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_SSMGUICONNECT_API UpdateConnectionRecordingPreferencesResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ...
    template<typename ClientTokenT = Aws::String>
    UpdateConnectionRecordingPreferencesResult& WithClientToken(ClientTokenT&& value) { SetClientToken(std::forward<ClientTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename ConnectionRecordingPreferencesT = ConnectionRecordingPreferences>
    UpdateConnectionRecordingPreferencesResult& WithConnectionRecordingPreferences(ConnectionRecordingPreferencesT&& value) { SetConnectionRecordingPreferences(std::forward<ConnectionRecordingPreferencesT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateConnectionRecordingPreferencesResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
