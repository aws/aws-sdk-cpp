...
class DeleteConnectionRecordingPreferencesResult {
 public:
  ...
  AWS_SSMGUICONNECT_API DeleteConnectionRecordingPreferencesResult& operator=(
  ...
  template <typename ClientTokenT = Aws::String>
  DeleteConnectionRecordingPreferencesResult& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteConnectionRecordingPreferencesResult& WithRequestId(RequestIdT&& value) {
