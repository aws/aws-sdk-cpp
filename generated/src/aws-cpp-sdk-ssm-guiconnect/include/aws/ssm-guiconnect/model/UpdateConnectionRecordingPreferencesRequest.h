...
class UpdateConnectionRecordingPreferencesRequest : public SSMGuiConnectRequest {
 public:
  ...
  template <typename ClientTokenT = Aws::String>
  UpdateConnectionRecordingPreferencesRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename ConnectionRecordingPreferencesT = ConnectionRecordingPreferences>
  UpdateConnectionRecordingPreferencesRequest& WithConnectionRecordingPreferences(ConnectionRecordingPreferencesT&& value) {
