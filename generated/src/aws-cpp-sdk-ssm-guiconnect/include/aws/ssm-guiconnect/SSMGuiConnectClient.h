...
class AWS_SSMGUICONNECT_API SSMGuiConnectClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  SSMGuiConnectClient(const Aws::SSMGuiConnect::SSMGuiConnectClientConfiguration& clientConfiguration =
                          Aws::SSMGuiConnect::SSMGuiConnectClientConfiguration(),
  ...
  SSMGuiConnectClient(const Aws::Auth::AWSCredentials& credentials,
                      std::shared_ptr<SSMGuiConnectEndpointProviderBase> endpointProvider = nullptr,
                      const Aws::SSMGuiConnect::SSMGuiConnectClientConfiguration& clientConfiguration =
                          Aws::SSMGuiConnect::SSMGuiConnectClientConfiguration());
   ...
   * is not specified, it will be initialized to default values.
   */
  SSMGuiConnectClient(const Aws::Auth::AWSCredentials& credentials, const Aws::Client::ClientConfiguration& clientConfiguration);
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteConnectionRecordingPreferencesOutcome DeleteConnectionRecordingPreferences(
      const Model::DeleteConnectionRecordingPreferencesRequest& request = {}) const;

  /**
   * A Callable wrapper for DeleteConnectionRecordingPreferences that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DeleteConnectionRecordingPreferencesRequestT = Model::DeleteConnectionRecordingPreferencesRequest>
  Model::DeleteConnectionRecordingPreferencesOutcomeCallable DeleteConnectionRecordingPreferencesCallable(
      const DeleteConnectionRecordingPreferencesRequestT& request = {}) const {
    return SubmitCallable(&SSMGuiConnectClient::DeleteConnectionRecordingPreferences, request);
  }

  /**
   * An Async wrapper for DeleteConnectionRecordingPreferences that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DeleteConnectionRecordingPreferencesRequestT = Model::DeleteConnectionRecordingPreferencesRequest>
  void DeleteConnectionRecordingPreferencesAsync(const DeleteConnectionRecordingPreferencesResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetConnectionRecordingPreferencesOutcome GetConnectionRecordingPreferences(
      const Model::GetConnectionRecordingPreferencesRequest& request = {}) const;

  /**
   * A Callable wrapper for GetConnectionRecordingPreferences that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename GetConnectionRecordingPreferencesRequestT = Model::GetConnectionRecordingPreferencesRequest>
  Model::GetConnectionRecordingPreferencesOutcomeCallable GetConnectionRecordingPreferencesCallable(
      const GetConnectionRecordingPreferencesRequestT& request = {}) const {
    return SubmitCallable(&SSMGuiConnectClient::GetConnectionRecordingPreferences, request);
  }

  /**
   * An Async wrapper for GetConnectionRecordingPreferences that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetConnectionRecordingPreferencesRequestT = Model::GetConnectionRecordingPreferencesRequest>
  void GetConnectionRecordingPreferencesAsync(const GetConnectionRecordingPreferencesResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                              const GetConnectionRecordingPreferencesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateConnectionRecordingPreferencesOutcome UpdateConnectionRecordingPreferences(
      const Model::UpdateConnectionRecordingPreferencesRequest& request) const;

  /**
   * A Callable wrapper for UpdateConnectionRecordingPreferences that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename UpdateConnectionRecordingPreferencesRequestT = Model::UpdateConnectionRecordingPreferencesRequest>
  Model::UpdateConnectionRecordingPreferencesOutcomeCallable UpdateConnectionRecordingPreferencesCallable(
      const UpdateConnectionRecordingPreferencesRequestT& request) const {
    return SubmitCallable(&SSMGuiConnectClient::UpdateConnectionRecordingPreferences, request);
  }

  /**
   * An Async wrapper for UpdateConnectionRecordingPreferences that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename UpdateConnectionRecordingPreferencesRequestT = Model::UpdateConnectionRecordingPreferencesRequest>
  void UpdateConnectionRecordingPreferencesAsync(const UpdateConnectionRecordingPreferencesRequestT& request,
                                                 const UpdateConnectionRecordingPreferencesResponseReceivedHandler& handler,
