...
class ListRoomsRequest : public IvschatRequest {
 public:
  ...
  inline ListRoomsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  void SetMessageReviewHandlerUri(MessageReviewHandlerUriT&& value) {
    m_messageReviewHandlerUriHasBeenSet = true;
    m_messageReviewHandlerUri = std::forward<MessageReviewHandlerUriT>(value);
  }
  template <typename MessageReviewHandlerUriT = Aws::String>
  ListRoomsRequest& WithMessageReviewHandlerUri(MessageReviewHandlerUriT&& value) {
    SetMessageReviewHandlerUri(std::forward<MessageReviewHandlerUriT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLoggingConfigurationIdentifier(LoggingConfigurationIdentifierT&& value) {
    m_loggingConfigurationIdentifierHasBeenSet = true;
    m_loggingConfigurationIdentifier = std::forward<LoggingConfigurationIdentifierT>(value);
  }
  template <typename LoggingConfigurationIdentifierT = Aws::String>
  ListRoomsRequest& WithLoggingConfigurationIdentifier(LoggingConfigurationIdentifierT&& value) {
    SetLoggingConfigurationIdentifier(std::forward<LoggingConfigurationIdentifierT>(value));
    return *this;
  }
  ///@}
 private:
