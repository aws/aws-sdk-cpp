...
class CreateChatTokenResult {
 public:
  ...
  template <typename TokenT = Aws::String>
  CreateChatTokenResult& WithToken(TokenT&& value) {
  ...
  void SetTokenExpirationTime(TokenExpirationTimeT&& value) {
    m_tokenExpirationTimeHasBeenSet = true;
    m_tokenExpirationTime = std::forward<TokenExpirationTimeT>(value);
  }
  template <typename TokenExpirationTimeT = Aws::Utils::DateTime>
  CreateChatTokenResult& WithTokenExpirationTime(TokenExpirationTimeT&& value) {
    SetTokenExpirationTime(std::forward<TokenExpirationTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSessionExpirationTime(SessionExpirationTimeT&& value) {
    m_sessionExpirationTimeHasBeenSet = true;
    m_sessionExpirationTime = std::forward<SessionExpirationTimeT>(value);
  }
  template <typename SessionExpirationTimeT = Aws::Utils::DateTime>
  CreateChatTokenResult& WithSessionExpirationTime(SessionExpirationTimeT&& value) {
    SetSessionExpirationTime(std::forward<SessionExpirationTimeT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  CreateChatTokenResult& WithRequestId(RequestIdT&& value) {
