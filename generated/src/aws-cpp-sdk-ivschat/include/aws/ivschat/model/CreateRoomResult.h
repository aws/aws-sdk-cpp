...
class CreateRoomResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  CreateRoomResult& WithArn(ArnT&& value) {
  ...
  template <typename IdT = Aws::String>
  CreateRoomResult& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateRoomResult& WithName(NameT&& value) {
  ...
  template <typename CreateTimeT = Aws::Utils::DateTime>
  CreateRoomResult& WithCreateTime(CreateTimeT&& value) {
  ...
  template <typename UpdateTimeT = Aws::Utils::DateTime>
  CreateRoomResult& WithUpdateTime(UpdateTimeT&& value) {
  ...
  inline CreateRoomResult& WithMaximumMessageRatePerSecond(int value) {
  ...
  inline CreateRoomResult& WithMaximumMessageLength(int value) {
  ...
  template <typename MessageReviewHandlerT = MessageReviewHandler>
  CreateRoomResult& WithMessageReviewHandler(MessageReviewHandlerT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateRoomResult& WithTags(TagsT&& value) {
  ...
  template <typename LoggingConfigurationIdentifiersT = Aws::Vector<Aws::String>>
  CreateRoomResult& WithLoggingConfigurationIdentifiers(LoggingConfigurationIdentifiersT&& value) {
  ...
  CreateRoomResult& AddLoggingConfigurationIdentifiers(LoggingConfigurationIdentifiersT&& value) {
    m_loggingConfigurationIdentifiersHasBeenSet = true;
