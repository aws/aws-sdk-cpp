...
namespace ivschat
{
const size_t IvschatEndpointRules::RulesBlobStrLen = 3728;
const size_t IvschatEndpointRules::RulesBlobSize = 3729;
...
'/','/','i','v','s','c','h','a','t','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{',
...
'u','r','l','"',':','"','h','t','t','p','s',':','/','/','i','v','s','c','h','a','t','.','{','R','e',
