...
class GraphDataSummary {
 public:
  ...
  inline GraphDataSummary& WithNumNodes(long long value) {
    SetNumNodes(value);
    return *this;
  }
  ///@}
  ...
  inline GraphDataSummary& WithNumEdges(long long value) {
    SetNumEdges(value);
    return *this;
  }
  ///@}
  ...
  inline GraphDataSummary& WithNumNodeLabels(long long value) {
  ...
  inline GraphDataSummary& WithNumEdgeLabels(long long value) {
  ...
  inline GraphDataSummary& WithNumNodeProperties(long long value) {
  ...
  inline GraphDataSummary& WithNumEdgeProperties(long long value) {
  ...
  inline GraphDataSummary& WithTotalNodePropertyValues(long long value) {
  ...
  inline GraphDataSummary& WithTotalEdgePropertyValues(long long value) {
