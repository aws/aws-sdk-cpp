...
class StartImportTaskRequest : public NeptuneGraphRequest {
 public:
  ...
  inline StartImportTaskRequest& WithFailOnError(bool value) {
  ...
  inline StartImportTaskRequest& WithFormat(Format value) {
    SetFormat(value);
    return *this;
  }
  ///@}
  ...
  inline StartImportTaskRequest& WithParquetType(ParquetType value) {
  ...
  inline StartImportTaskRequest& WithBlankNodeHandling(BlankNodeHandling value) {
