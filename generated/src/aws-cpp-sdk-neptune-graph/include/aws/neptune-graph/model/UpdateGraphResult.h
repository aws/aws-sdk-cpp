...
class UpdateGraphResult {
 public:
  ...
  inline UpdateGraphResult& WithStatus(GraphStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateGraphResult& WithProvisionedMemory(int value) {
  ...
  inline UpdateGraphResult& WithPublicConnectivity(bool value) {
  ...
  inline UpdateGraphResult& WithReplicaCount(int value) {
  ...
  inline UpdateGraphResult& WithDeletionProtection(bool value) {
