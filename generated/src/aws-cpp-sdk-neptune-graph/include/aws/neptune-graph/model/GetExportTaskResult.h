...
class GetExportTaskResult {
 public:
  ...
  inline GetExportTaskResult& WithStatus(ExportTaskStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline GetExportTaskResult& WithFormat(ExportFormat value) {
    SetFormat(value);
    return *this;
  }
  ///@}
  ...
  inline GetExportTaskResult& WithParquetType(ParquetType value) {
  ...
  void SetExportTaskDetails(ExportTaskDetailsT&& value) {
    ...
    m_exportTaskDetails = std::forward<ExportTaskDetailsT>(value);
  }
  template <typename ExportTaskDetailsT = ExportTaskDetails>
  GetExportTaskResult& WithExportTaskDetails(ExportTaskDetailsT&& value) {
    SetExportTaskDetails(std::forward<ExportTaskDetailsT>(value));
    return *this;
  }
  ///@}
