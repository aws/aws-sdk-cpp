...
class CreateGraphRequest : public NeptuneGraphRequest {
 public:
  ...
  inline CreateGraphRequest& WithPublicConnectivity(bool value) {
  ...
  inline CreateGraphRequest& WithReplicaCount(int value) {
  ...
  inline CreateGraphRequest& WithDeletionProtection(bool value) {
  ...
  inline CreateGraphRequest& WithProvisionedMemory(int value) {
