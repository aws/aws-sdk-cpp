...
class ListExportTasksResult {
 public:
  AWS_NEPTUNEGRAPH_API ListExportTasksResult() = default;
  ...
  template <typename TasksT = Aws::Vector<ExportTaskSummary>>
  void SetTasks(TasksT&& value) {
    m_tasksHasBeenSet = true;
    m_tasks = std::forward<TasksT>(value);
  }
  template <typename TasksT = Aws::Vector<ExportTaskSummary>>
  ListExportTasksResult& WithTasks(TasksT&& value) {
    SetTasks(std::forward<TasksT>(value));
    return *this;
  }
  template <typename TasksT = ExportTaskSummary>
  ListExportTasksResult& AddTasks(TasksT&& value) {
    m_tasksHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListExportTasksResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListExportTasksResult& WithRequestId(RequestIdT&& value) {
