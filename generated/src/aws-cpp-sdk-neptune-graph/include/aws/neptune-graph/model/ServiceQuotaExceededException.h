...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/neptune-graph-2023-11-29/ServiceQuotaExceededException">AWS
   * API Reference</a></p>
   */
  class ServiceQuotaExceededException
  {
  public:
    AWS_NEPTUNEGRAPH_API ServiceQuotaExceededException() = default;
