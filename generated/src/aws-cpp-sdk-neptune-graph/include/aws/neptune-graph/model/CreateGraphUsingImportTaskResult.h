...
class CreateGraphUsingImportTaskResult {
 public:
  ...
  template <typename GraphIdT = Aws::String>
  CreateGraphUsingImportTaskResult& WithGraphId(GraphIdT&& value) {
  ...
  template <typename TaskIdT = Aws::String>
  CreateGraphUsingImportTaskResult& WithTaskId(TaskIdT&& value) {
  ...
  template <typename SourceT = Aws::String>
  CreateGraphUsingImportTaskResult& WithSource(SourceT&& value) {
  ...
  inline CreateGraphUsingImportTaskResult& WithFormat(Format value) {
    SetFormat(value);
    return *this;
  }
  ///@}
  ...
  inline CreateGraphUsingImportTaskResult& WithParquetType(ParquetType value) {
  ...
  template <typename RoleArnT = Aws::String>
  CreateGraphUsingImportTaskResult& WithRoleArn(RoleArnT&& value) {
  ...
  inline CreateGraphUsingImportTaskResult& WithStatus(ImportTaskStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetImportOptions(ImportOptionsT&& value) {
    ...
    m_importOptions = std::forward<ImportOptionsT>(value);
  }
  template <typename ImportOptionsT = ImportOptions>
  CreateGraphUsingImportTaskResult& WithImportOptions(ImportOptionsT&& value) {
    SetImportOptions(std::forward<ImportOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  CreateGraphUsingImportTaskResult& WithRequestId(RequestIdT&& value) {
