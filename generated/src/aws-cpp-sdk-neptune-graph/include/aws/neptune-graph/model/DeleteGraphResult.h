...
class DeleteGraphResult {
 public:
  ...
  inline DeleteGraphResult& WithStatus(GraphStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline DeleteGraphResult& WithProvisionedMemory(int value) {
  ...
  inline DeleteGraphResult& WithPublicConnectivity(bool value) {
  ...
  inline DeleteGraphResult& WithReplicaCount(int value) {
  ...
  inline DeleteGraphResult& WithDeletionProtection(bool value) {
