...
class ListImportTasksResult {
 public:
  ...
  template <typename TasksT = Aws::Vector<ImportTaskSummary>>
  ListImportTasksResult& WithTasks(TasksT&& value) {
    SetTasks(std::forward<TasksT>(value));
    return *this;
  }
  template <typename TasksT = ImportTaskSummary>
  ListImportTasksResult& AddTasks(TasksT&& value) {
    m_tasksHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListImportTasksResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListImportTasksResult& WithRequestId(RequestIdT&& value) {
