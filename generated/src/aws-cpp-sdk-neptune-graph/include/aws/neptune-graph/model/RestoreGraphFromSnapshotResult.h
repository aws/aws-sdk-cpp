...
class RestoreGraphFromSnapshotResult {
 public:
  ...
  template <typename IdT = Aws::String>
  RestoreGraphFromSnapshotResult& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  RestoreGraphFromSnapshotResult& WithName(NameT&& value) {
  ...
  template <typename ArnT = Aws::String>
  RestoreGraphFromSnapshotResult& WithArn(ArnT&& value) {
  ...
  inline RestoreGraphFromSnapshotResult& WithStatus(GraphStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline RestoreGraphFromSnapshotResult& WithProvisionedMemory(int value) {
  ...
  inline RestoreGraphFromSnapshotResult& WithPublicConnectivity(bool value) {
  ...
  inline RestoreGraphFromSnapshotResult& WithReplicaCount(int value) {
  ...
  inline RestoreGraphFromSnapshotResult& WithDeletionProtection(bool value) {
