...
namespace Model
{
  ...
  {
  public:
    AWS_NEPTUNEGRAPH_API ListImportTasksRequest() = default;
    ...
    template<typename NextTokenT = Aws::String>
    ListImportTasksRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
