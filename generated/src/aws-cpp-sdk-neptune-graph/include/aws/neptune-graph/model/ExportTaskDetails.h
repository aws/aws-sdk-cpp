...
class ExportTaskDetails {
 public:
  ...
  inline ExportTaskDetails& WithTimeElapsedSeconds(long long value) {
  ...
  inline ExportTaskDetails& WithProgressPercentage(int value) {
  ...
  inline void SetNumVerticesWritten(long long value) {
    m_numVerticesWrittenHasBeenSet = true;
    m_numVerticesWritten = value;
  }
  inline ExportTaskDetails& WithNumVerticesWritten(long long value) {
    SetNumVerticesWritten(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNumEdgesWritten(long long value) {
    m_numEdgesWrittenHasBeenSet = true;
    m_numEdgesWritten = value;
  }
  inline ExportTaskDetails& WithNumEdgesWritten(long long value) {
    SetNumEdgesWritten(value);
    return *this;
  }
  ///@}
 private:
