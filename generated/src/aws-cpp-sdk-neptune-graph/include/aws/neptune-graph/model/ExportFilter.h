...
class ExportFilter {
 public:
  ...
  void SetVertexFilter(VertexFilterT&& value) {
    m_vertexFilterHasBeenSet = true;
    m_vertexFilter = std::forward<VertexFilterT>(value);
  }
  template <typename VertexFilterT = Aws::Map<Aws::String, ExportFilterElement>>
  ExportFilter& WithVertexFilter(VertexFilterT&& value) {
    SetVertexFilter(std::forward<VertexFilterT>(value));
    return *this;
  }
  ...
  ExportFilter& AddVertexFilter(VertexFilterKeyT&& key, VertexFilterValueT&& value) {
    m_vertexFilterHasBeenSet = true;
    m_vertexFilter.emplace(std::forward<VertexFilterKeyT>(key), std::forward<VertexFilterValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEdgeFilter(EdgeFilterT&& value) {
    m_edgeFilterHasBeenSet = true;
    m_edgeFilter = std::forward<EdgeFilterT>(value);
  }
  template <typename EdgeFilterT = Aws::Map<Aws::String, ExportFilterElement>>
  ExportFilter& WithEdgeFilter(EdgeFilterT&& value) {
    SetEdgeFilter(std::forward<EdgeFilterT>(value));
    return *this;
  }
  ...
  ExportFilter& AddEdgeFilter(EdgeFilterKeyT&& key, EdgeFilterValueT&& value) {
    m_edgeFilterHasBeenSet = true;
    m_edgeFilter.emplace(std::forward<EdgeFilterKeyT>(key), std::forward<EdgeFilterValueT>(value));
    return *this;
  }
  ///@}
 private:
