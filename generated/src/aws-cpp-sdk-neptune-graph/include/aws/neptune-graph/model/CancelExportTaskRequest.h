...
namespace Model
{
  ...
  /**
   */
  class CancelExportTaskRequest : public NeptuneGraphRequest
  {
  public:
    AWS_NEPTUNEGRAPH_API CancelExportTaskRequest();
    ...
    inline CancelExportTaskRequest& WithTaskIdentifier(const Aws::String& value) { SetTaskIdentifier(value); return *this;}
    inline CancelExportTaskRequest& WithTaskIdentifier(Aws::String&& value) { SetTaskIdentifier(std::move(value)); return *this;}
    inline CancelExportTaskRequest& WithTaskIdentifier(const char* value) { SetTaskIdentifier(value); return *this;}
    ///@}
  private:
