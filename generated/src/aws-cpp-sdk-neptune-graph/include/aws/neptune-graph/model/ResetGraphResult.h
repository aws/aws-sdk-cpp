...
class ResetGraphResult {
 public:
  ...
  inline ResetGraphResult& WithStatus(GraphStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline ResetGraphResult& WithProvisionedMemory(int value) {
  ...
  inline ResetGraphResult& WithPublicConnectivity(bool value) {
  ...
  inline ResetGraphResult& WithReplicaCount(int value) {
  ...
  inline ResetGraphResult& WithDeletionProtection(bool value) {
