...
class GetGraphResult {
 public:
  ...
  inline GetGraphResult& WithStatus(GraphStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline GetGraphResult& WithProvisionedMemory(int value) {
  ...
  inline GetGraphResult& WithPublicConnectivity(bool value) {
  ...
  inline GetGraphResult& WithReplicaCount(int value) {
  ...
  inline GetGraphResult& WithDeletionProtection(bool value) {
