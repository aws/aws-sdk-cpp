...
class ExecuteQueryRequest : public NeptuneGraphRequest {
 public:
  ...
  inline ExecuteQueryRequest& WithLanguage(QueryLanguage value) {
    SetLanguage(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPlanCache(PlanCacheType value) {
    m_planCacheHasBeenSet = true;
    m_planCache = value;
  }
  inline ExecuteQueryRequest& WithPlanCache(PlanCacheType value) {
    SetPlanCache(value);
    return *this;
  }
  ///@}
  ...
  inline void SetExplainMode(ExplainMode value) {
    m_explainModeHasBeenSet = true;
    m_explainMode = value;
  }
  inline ExecuteQueryRequest& WithExplainMode(ExplainMode value) {
  ...
  inline void SetQueryTimeoutMilliseconds(int value) {
    m_queryTimeoutMillisecondsHasBeenSet = true;
    m_queryTimeoutMilliseconds = value;
  }
  inline ExecuteQueryRequest& WithQueryTimeoutMilliseconds(int value) {
    SetQueryTimeoutMilliseconds(value);
    return *this;
  }
  ///@}
 private:
