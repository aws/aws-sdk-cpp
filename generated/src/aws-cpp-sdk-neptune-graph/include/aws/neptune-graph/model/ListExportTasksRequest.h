...
class ListExportTasksRequest : public NeptuneGraphRequest {
 public:
  ...
  template <typename GraphIdentifierT = Aws::String>
  ListExportTasksRequest& WithGraphIdentifier(GraphIdentifierT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListExportTasksRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListExportTasksRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
