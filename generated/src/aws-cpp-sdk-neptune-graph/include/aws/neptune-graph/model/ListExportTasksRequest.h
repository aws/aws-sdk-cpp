...
namespace Model
{
  ...
  {
  public:
    AWS_NEPTUNEGRAPH_API ListExportTasksRequest();
    ...
    inline ListExportTasksRequest& WithNextToken(const Aws::String& value) { SetNextToken(value); return *this;}
    inline ListExportTasksRequest& WithNextToken(Aws::String&& value) { SetNextToken(std::move(value)); return *this;}
    inline ListExportTasksRequest& WithNextToken(const char* value) { SetNextToken(value); return *this;}
    ///@}
