...
namespace Model
{
  ...
  {
  public:
    AWS_NEPTUNEGRAPH_API CancelImportTaskRequest() = default;
    ...
    template<typename TaskIdentifierT = Aws::String>
    CancelImportTaskRequest& WithTaskIdentifier(TaskIdentifierT&& value) { SetTaskIdentifier(std::forward<TaskIdentifierT>(value)); return *this;}
    ///@}
  private:
