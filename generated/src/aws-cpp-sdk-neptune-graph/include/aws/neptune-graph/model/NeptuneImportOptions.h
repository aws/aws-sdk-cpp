...
class NeptuneImportOptions {
 public:
  ...
  void SetS3ExportPath(S3ExportPathT&& value) {
    ...
    m_s3ExportPath = std::forward<S3ExportPathT>(value);
  }
  template <typename S3ExportPathT = Aws::String>
  NeptuneImportOptions& WithS3ExportPath(S3ExportPathT&& value) {
    SetS3ExportPath(std::forward<S3ExportPathT>(value));
    return *this;
  }
  ///@}
  ...
  void SetS3ExportKmsKeyId(S3ExportKmsKeyIdT&& value) {
    ...
    m_s3ExportKmsKeyId = std::forward<S3ExportKmsKeyIdT>(value);
  }
  template <typename S3ExportKmsKeyIdT = Aws::String>
  NeptuneImportOptions& WithS3ExportKmsKeyId(S3ExportKmsKeyIdT&& value) {
    SetS3ExportKmsKeyId(std::forward<S3ExportKmsKeyIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetPreserveDefaultVertexLabels(bool value) {
    m_preserveDefaultVertexLabelsHasBeenSet = true;
    m_preserveDefaultVertexLabels = value;
  }
  inline NeptuneImportOptions& WithPreserveDefaultVertexLabels(bool value) {
    SetPreserveDefaultVertexLabels(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPreserveEdgeIds(bool value) {
    m_preserveEdgeIdsHasBeenSet = true;
    m_preserveEdgeIds = value;
  }
  inline NeptuneImportOptions& WithPreserveEdgeIds(bool value) {
    SetPreserveEdgeIds(value);
    return *this;
  }
  ///@}
 private:
