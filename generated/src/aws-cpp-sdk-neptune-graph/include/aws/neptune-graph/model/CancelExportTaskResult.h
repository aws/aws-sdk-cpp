...
class CancelExportTaskResult {
 public:
  ...
  inline CancelExportTaskResult& WithStatus(ExportTaskStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline CancelExportTaskResult& WithFormat(ExportFormat value) {
    SetFormat(value);
    return *this;
  }
  ///@}
  ...
  inline CancelExportTaskResult& WithParquetType(ParquetType value) {
