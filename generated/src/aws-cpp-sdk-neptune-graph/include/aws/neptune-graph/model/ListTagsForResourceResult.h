...
namespace Model
{
  ...
  {
  public:
    AWS_NEPTUNEGRAPH_API ListTagsForResourceResult() = default;
    AWS_NEPTUNEGRAPH_API ListTagsForResourceResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_NEPTUNEGRAPH_API ListTagsForResourceResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
