...
class ExportTaskSummary {
 public:
  ...
  inline ExportTaskSummary& WithStatus(ExportTaskStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline ExportTaskSummary& WithFormat(ExportFormat value) {
    SetFormat(value);
    return *this;
  }
  ///@}
  ...
  inline ExportTaskSummary& WithParquetType(ParquetType value) {
