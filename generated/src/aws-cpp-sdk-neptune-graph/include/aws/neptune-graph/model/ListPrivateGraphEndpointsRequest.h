...
class ListPrivateGraphEndpointsRequest : public NeptuneGraphRequest {
 public:
  ...
  template <typename GraphIdentifierT = Aws::String>
  ListPrivateGraphEndpointsRequest& WithGraphIdentifier(GraphIdentifierT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListPrivateGraphEndpointsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListPrivateGraphEndpointsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
