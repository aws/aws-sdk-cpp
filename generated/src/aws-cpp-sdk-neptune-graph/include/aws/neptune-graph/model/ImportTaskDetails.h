...
class ImportTaskDetails {
 public:
  ...
  inline void SetTimeElapsedSeconds(long long value) {
    m_timeElapsedSecondsHasBeenSet = true;
    m_timeElapsedSeconds = value;
  }
  inline ImportTaskDetails& WithTimeElapsedSeconds(long long value) {
    SetTimeElapsedSeconds(value);
    return *this;
  }
  ///@}
  ...
  inline ImportTaskDetails& WithProgressPercentage(int value) {
  ...
  inline ImportTaskDetails& WithErrorCount(int value) {
    SetErrorCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatementCount(long long value) {
    m_statementCountHasBeenSet = true;
    m_statementCount = value;
  }
  inline ImportTaskDetails& WithStatementCount(long long value) {
  ...
  inline void SetDictionaryEntryCount(long long value) {
    m_dictionaryEntryCountHasBeenSet = true;
    m_dictionaryEntryCount = value;
  }
  inline ImportTaskDetails& WithDictionaryEntryCount(long long value) {
    SetDictionaryEntryCount(value);
    return *this;
  }
  ///@}
 private:
