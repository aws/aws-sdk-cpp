...
class ImportTaskSummary {
 public:
  ...
  inline ImportTaskSummary& WithFormat(Format value) {
    SetFormat(value);
    return *this;
  }
  ///@}
  ...
  inline ImportTaskSummary& WithParquetType(ParquetType value) {
  ...
  inline ImportTaskSummary& WithStatus(ImportTaskStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
