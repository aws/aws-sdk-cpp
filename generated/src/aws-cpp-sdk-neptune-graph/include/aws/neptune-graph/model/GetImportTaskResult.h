...
class GetImportTaskResult {
 public:
  ...
  inline GetImportTaskResult& WithFormat(Format value) {
    SetFormat(value);
    return *this;
  }
  ///@}
  ...
  inline GetImportTaskResult& WithParquetType(ParquetType value) {
  ...
  inline GetImportTaskResult& WithStatus(ImportTaskStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetImportTaskDetails(ImportTaskDetailsT&& value) {
    m_importTaskDetailsHasBeenSet = true;
    m_importTaskDetails = std::forward<ImportTaskDetailsT>(value);
  }
  template <typename ImportTaskDetailsT = ImportTaskDetails>
  GetImportTaskResult& WithImportTaskDetails(ImportTaskDetailsT&& value) {
    SetImportTaskDetails(std::forward<ImportTaskDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetImportTaskResult& WithAttemptNumber(int value) {
