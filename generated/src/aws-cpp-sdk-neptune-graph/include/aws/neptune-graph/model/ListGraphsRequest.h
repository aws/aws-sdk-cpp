...
namespace Model
{
  ...
  /**
   */
  class ListGraphsRequest : public NeptuneGraphRequest
  {
  public:
    ...
    template<typename NextTokenT = Aws::String>
    ListGraphsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
