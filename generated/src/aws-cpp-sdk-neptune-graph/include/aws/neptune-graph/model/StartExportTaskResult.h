...
class StartExportTaskResult {
 public:
  ...
  inline void SetStatus(ExportTaskStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline StartExportTaskResult& WithStatus(ExportTaskStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline StartExportTaskResult& WithFormat(ExportFormat value) {
    SetFormat(value);
    return *this;
  }
  ///@}
  ...
  inline StartExportTaskResult& WithParquetType(ParquetType value) {
