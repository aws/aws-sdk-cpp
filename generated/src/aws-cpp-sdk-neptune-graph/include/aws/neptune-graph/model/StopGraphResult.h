...
class StopGraphResult {
 public:
  ...
  template <typename IdT = Aws::String>
  StopGraphResult& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  StopGraphResult& WithName(NameT&& value) {
  ...
  template <typename ArnT = Aws::String>
  StopGraphResult& WithArn(ArnT&& value) {
  ...
  inline StopGraphResult& WithStatus(GraphStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonT = Aws::String>
  StopGraphResult& WithStatusReason(StatusReasonT&& value) {
  ...
  template <typename CreateTimeT = Aws::Utils::DateTime>
  StopGraphResult& WithCreateTime(CreateTimeT&& value) {
  ...
  inline StopGraphResult& WithProvisionedMemory(int value) {
  ...
  template <typename EndpointT = Aws::String>
  StopGraphResult& WithEndpoint(EndpointT&& value) {
  ...
  inline StopGraphResult& WithPublicConnectivity(bool value) {
  ...
  template <typename VectorSearchConfigurationT = VectorSearchConfiguration>
  StopGraphResult& WithVectorSearchConfiguration(VectorSearchConfigurationT&& value) {
  ...
  inline StopGraphResult& WithReplicaCount(int value) {
  ...
  template <typename KmsKeyIdentifierT = Aws::String>
  StopGraphResult& WithKmsKeyIdentifier(KmsKeyIdentifierT&& value) {
  ...
  template <typename SourceSnapshotIdT = Aws::String>
  StopGraphResult& WithSourceSnapshotId(SourceSnapshotIdT&& value) {
  ...
  inline StopGraphResult& WithDeletionProtection(bool value) {
  ...
  template <typename BuildNumberT = Aws::String>
  StopGraphResult& WithBuildNumber(BuildNumberT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StopGraphResult& WithRequestId(RequestIdT&& value) {
