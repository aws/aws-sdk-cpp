...
namespace Model
{
  class StopGraphResult
  {
  public:
    AWS_NEPTUNEGRAPH_API StopGraphResult() = default;
    AWS_NEPTUNEGRAPH_API StopGraphResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_NEPTUNEGRAPH_API StopGraphResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ...
    template<typename IdT = Aws::String>
    StopGraphResult& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    StopGraphResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename ArnT = Aws::String>
    StopGraphResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    inline StopGraphResult& WithStatus(GraphStatus value) { SetStatus(value); return *this;}
    ///@}
    ...
    template<typename StatusReasonT = Aws::String>
    StopGraphResult& WithStatusReason(StatusReasonT&& value) { SetStatusReason(std::forward<StatusReasonT>(value)); return *this;}
    ///@}
    ...
    template<typename CreateTimeT = Aws::Utils::DateTime>
    StopGraphResult& WithCreateTime(CreateTimeT&& value) { SetCreateTime(std::forward<CreateTimeT>(value)); return *this;}
    ///@}
    ...
    inline StopGraphResult& WithProvisionedMemory(int value) { SetProvisionedMemory(value); return *this;}
    ///@}
    ...
    template<typename EndpointT = Aws::String>
    StopGraphResult& WithEndpoint(EndpointT&& value) { SetEndpoint(std::forward<EndpointT>(value)); return *this;}
    ///@}
    ...
    inline StopGraphResult& WithPublicConnectivity(bool value) { SetPublicConnectivity(value); return *this;}
    ///@}
    ...
    template<typename VectorSearchConfigurationT = VectorSearchConfiguration>
    StopGraphResult& WithVectorSearchConfiguration(VectorSearchConfigurationT&& value) { SetVectorSearchConfiguration(std::forward<VectorSearchConfigurationT>(value)); return *this;}
    ///@}
    ...
    inline StopGraphResult& WithReplicaCount(int value) { SetReplicaCount(value); return *this;}
    ///@}
    ...
    template<typename KmsKeyIdentifierT = Aws::String>
    StopGraphResult& WithKmsKeyIdentifier(KmsKeyIdentifierT&& value) { SetKmsKeyIdentifier(std::forward<KmsKeyIdentifierT>(value)); return *this;}
    ///@}
    ...
    template<typename SourceSnapshotIdT = Aws::String>
    StopGraphResult& WithSourceSnapshotId(SourceSnapshotIdT&& value) { SetSourceSnapshotId(std::forward<SourceSnapshotIdT>(value)); return *this;}
    ///@}
    ...
    inline StopGraphResult& WithDeletionProtection(bool value) { SetDeletionProtection(value); return *this;}
    ///@}
    ...
    template<typename BuildNumberT = Aws::String>
    StopGraphResult& WithBuildNumber(BuildNumberT&& value) { SetBuildNumber(std::forward<BuildNumberT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    StopGraphResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
