...
class CreateGraphUsingImportTaskRequest : public NeptuneGraphRequest {
 public:
  ...
  template <typename GraphNameT = Aws::String>
  CreateGraphUsingImportTaskRequest& WithGraphName(GraphNameT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateGraphUsingImportTaskRequest& WithTags(TagsT&& value) {
  ...
  inline CreateGraphUsingImportTaskRequest& WithPublicConnectivity(bool value) {
  ...
  template <typename KmsKeyIdentifierT = Aws::String>
  CreateGraphUsingImportTaskRequest& WithKmsKeyIdentifier(KmsKeyIdentifierT&& value) {
  ...
  template <typename VectorSearchConfigurationT = VectorSearchConfiguration>
  CreateGraphUsingImportTaskRequest& WithVectorSearchConfiguration(VectorSearchConfigurationT&& value) {
  ...
  inline CreateGraphUsingImportTaskRequest& WithReplicaCount(int value) {
  ...
  inline CreateGraphUsingImportTaskRequest& WithDeletionProtection(bool value) {
  ...
  template <typename ImportOptionsT = ImportOptions>
  CreateGraphUsingImportTaskRequest& WithImportOptions(ImportOptionsT&& value) {
  ...
  inline void SetMaxProvisionedMemory(int value) {
    m_maxProvisionedMemoryHasBeenSet = true;
    m_maxProvisionedMemory = value;
  }
  inline CreateGraphUsingImportTaskRequest& WithMaxProvisionedMemory(int value) {
    SetMaxProvisionedMemory(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMinProvisionedMemory(int value) {
    m_minProvisionedMemoryHasBeenSet = true;
    m_minProvisionedMemory = value;
  }
  inline CreateGraphUsingImportTaskRequest& WithMinProvisionedMemory(int value) {
    SetMinProvisionedMemory(value);
    return *this;
  }
  ///@}
  ...
  inline CreateGraphUsingImportTaskRequest& WithFailOnError(bool value) {
  ...
  template <typename SourceT = Aws::String>
  CreateGraphUsingImportTaskRequest& WithSource(SourceT&& value) {
  ...
  inline CreateGraphUsingImportTaskRequest& WithFormat(Format value) {
    SetFormat(value);
    return *this;
  }
  ///@}
  ...
  inline CreateGraphUsingImportTaskRequest& WithParquetType(ParquetType value) {
  ...
  inline void SetBlankNodeHandling(BlankNodeHandling value) {
    m_blankNodeHandlingHasBeenSet = true;
    m_blankNodeHandling = value;
  }
  inline CreateGraphUsingImportTaskRequest& WithBlankNodeHandling(BlankNodeHandling value) {
    SetBlankNodeHandling(value);
    return *this;
  }
  ///@}
  ...
  template <typename RoleArnT = Aws::String>
  CreateGraphUsingImportTaskRequest& WithRoleArn(RoleArnT&& value) {
