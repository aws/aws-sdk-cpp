...
class StartImportTaskResult {
 public:
  ...
  inline StartImportTaskResult& WithFormat(Format value) {
    SetFormat(value);
    return *this;
  }
  ///@}
  ...
  inline StartImportTaskResult& WithParquetType(ParquetType value) {
  ...
  inline StartImportTaskResult& WithStatus(ImportTaskStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
