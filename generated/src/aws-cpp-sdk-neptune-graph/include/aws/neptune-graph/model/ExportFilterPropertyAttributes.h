...
class ExportFilterPropertyAttributes {
 public:
  ...
  void SetOutputType(OutputTypeT&& value) {
    ...
    m_outputType = std::forward<OutputTypeT>(value);
  }
  template <typename OutputTypeT = Aws::String>
  ExportFilterPropertyAttributes& WithOutputType(OutputTypeT&& value) {
    SetOutputType(std::forward<OutputTypeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSourcePropertyName(SourcePropertyNameT&& value) {
    m_sourcePropertyNameHasBeenSet = true;
    m_sourcePropertyName = std::forward<SourcePropertyNameT>(value);
  }
  template <typename SourcePropertyNameT = Aws::String>
  ExportFilterPropertyAttributes& WithSourcePropertyName(SourcePropertyNameT&& value) {
    SetSourcePropertyName(std::forward<SourcePropertyNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetMultiValueHandling(MultiValueHandlingType value) {
    m_multiValueHandlingHasBeenSet = true;
    m_multiValueHandling = value;
  }
  inline ExportFilterPropertyAttributes& WithMultiValueHandling(MultiValueHandlingType value) {
    SetMultiValueHandling(value);
    return *this;
  }
  ///@}
 private:
