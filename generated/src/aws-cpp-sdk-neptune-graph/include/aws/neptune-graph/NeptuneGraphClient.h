...
namespace NeptuneGraph
{
   ...
   */
  class AWS_NEPTUNEGRAPH_API NeptuneGraphClient : smithy::client::AwsSmithyClientT<Aws::NeptuneGraph::SERVICE_NAME,
    ...
    Aws::Client::ClientWithAsyncTemplateMethods<NeptuneGraphClient>
  {
    public:
