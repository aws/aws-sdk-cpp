...
class AWS_NEPTUNEGRAPH_API NeptuneGraphClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  NeptuneGraphClient(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<NeptuneGraphEndpointProviderBase> endpointProvider = nullptr,
      const Aws::NeptuneGraph::NeptuneGraphClientConfiguration& clientConfiguration = Aws::NeptuneGraph::NeptuneGraphClientConfiguration());
  ...
  /**
   * A Callable wrapper for CancelExportTask that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CancelExportTask that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CancelExportTaskRequestT = Model::CancelExportTaskRequest>
  void CancelExportTaskAsync(const CancelExportTaskRequestT& request, const CancelExportTaskResponseReceivedHandler& handler,
  ...
  /**
   * An Async wrapper for CreateGraph that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateGraphRequestT = Model::CreateGraphRequest>
  void CreateGraphAsync(const CreateGraphRequestT& request, const CreateGraphResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateGraphSnapshot that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateGraphSnapshot that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateGraphSnapshotRequestT = Model::CreateGraphSnapshotRequest>
  void CreateGraphSnapshotAsync(const CreateGraphSnapshotRequestT& request, const CreateGraphSnapshotResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateGraphUsingImportTaskOutcome CreateGraphUsingImportTask(
      const Model::CreateGraphUsingImportTaskRequest& request) const;

  /**
   * A Callable wrapper for CreateGraphUsingImportTask that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateGraphUsingImportTaskRequestT = Model::CreateGraphUsingImportTaskRequest>
  Model::CreateGraphUsingImportTaskOutcomeCallable CreateGraphUsingImportTaskCallable(
      const CreateGraphUsingImportTaskRequestT& request) const {
    return SubmitCallable(&NeptuneGraphClient::CreateGraphUsingImportTask, request);
  }

  /**
   * An Async wrapper for CreateGraphUsingImportTask that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateGraphUsingImportTaskRequestT = Model::CreateGraphUsingImportTaskRequest>
  void CreateGraphUsingImportTaskAsync(const CreateGraphUsingImportTaskRequestT& request,
                                       const CreateGraphUsingImportTaskResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreatePrivateGraphEndpointOutcome CreatePrivateGraphEndpoint(
      const Model::CreatePrivateGraphEndpointRequest& request) const;

  /**
   * A Callable wrapper for CreatePrivateGraphEndpoint that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreatePrivateGraphEndpointRequestT = Model::CreatePrivateGraphEndpointRequest>
  Model::CreatePrivateGraphEndpointOutcomeCallable CreatePrivateGraphEndpointCallable(
      const CreatePrivateGraphEndpointRequestT& request) const {
    return SubmitCallable(&NeptuneGraphClient::CreatePrivateGraphEndpoint, request);
  }

  /**
   * An Async wrapper for CreatePrivateGraphEndpoint that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreatePrivateGraphEndpointRequestT = Model::CreatePrivateGraphEndpointRequest>
  void CreatePrivateGraphEndpointAsync(const CreatePrivateGraphEndpointRequestT& request,
                                       const CreatePrivateGraphEndpointResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteGraph that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteGraphRequestT = Model::DeleteGraphRequest>
  void DeleteGraphAsync(const DeleteGraphRequestT& request, const DeleteGraphResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteGraphSnapshot that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteGraphSnapshot that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteGraphSnapshotRequestT = Model::DeleteGraphSnapshotRequest>
  void DeleteGraphSnapshotAsync(const DeleteGraphSnapshotRequestT& request, const DeleteGraphSnapshotResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeletePrivateGraphEndpointOutcome DeletePrivateGraphEndpoint(
      const Model::DeletePrivateGraphEndpointRequest& request) const;

  /**
   * A Callable wrapper for DeletePrivateGraphEndpoint that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeletePrivateGraphEndpointRequestT = Model::DeletePrivateGraphEndpointRequest>
  Model::DeletePrivateGraphEndpointOutcomeCallable DeletePrivateGraphEndpointCallable(
      const DeletePrivateGraphEndpointRequestT& request) const {
    return SubmitCallable(&NeptuneGraphClient::DeletePrivateGraphEndpoint, request);
  }

  /**
   * An Async wrapper for DeletePrivateGraphEndpoint that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeletePrivateGraphEndpointRequestT = Model::DeletePrivateGraphEndpointRequest>
  void DeletePrivateGraphEndpointAsync(const DeletePrivateGraphEndpointRequestT& request,
                                       const DeletePrivateGraphEndpointResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetExportTask that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetExportTaskRequestT = Model::GetExportTaskRequest>
  void GetExportTaskAsync(const GetExportTaskRequestT& request, const GetExportTaskResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetGraph that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetGraphRequestT = Model::GetGraphRequest>
  void GetGraphAsync(const GetGraphRequestT& request, const GetGraphResponseReceivedHandler& handler,
                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetGraphSnapshot that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetGraphSnapshot that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetGraphSnapshotRequestT = Model::GetGraphSnapshotRequest>
  void GetGraphSnapshotAsync(const GetGraphSnapshotRequestT& request, const GetGraphSnapshotResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetGraphSummary that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetGraphSummaryRequestT = Model::GetGraphSummaryRequest>
  void GetGraphSummaryAsync(const GetGraphSummaryRequestT& request, const GetGraphSummaryResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetImportTask that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetImportTaskRequestT = Model::GetImportTaskRequest>
  void GetImportTaskAsync(const GetImportTaskRequestT& request, const GetImportTaskResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetPrivateGraphEndpoint that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetPrivateGraphEndpoint that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetPrivateGraphEndpointRequestT = Model::GetPrivateGraphEndpointRequest>
  void GetPrivateGraphEndpointAsync(const GetPrivateGraphEndpointRequestT& request,
                                    const GetPrivateGraphEndpointResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetQuery that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetQueryRequestT = Model::GetQueryRequest>
  void GetQueryAsync(const GetQueryRequestT& request, const GetQueryResponseReceivedHandler& handler,
                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListExportTasks that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListExportTasksRequestT = Model::ListExportTasksRequest>
  void ListExportTasksAsync(const ListExportTasksResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const ListExportTasksRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListGraphSnapshots that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListGraphSnapshots that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListGraphSnapshotsRequestT = Model::ListGraphSnapshotsRequest>
  void ListGraphSnapshotsAsync(const ListGraphSnapshotsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const ListGraphSnapshotsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListGraphs that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListGraphsRequestT = Model::ListGraphsRequest>
  void ListGraphsAsync(const ListGraphsResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                       const ListGraphsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListImportTasks that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListImportTasksRequestT = Model::ListImportTasksRequest>
  void ListImportTasksAsync(const ListImportTasksResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const ListImportTasksRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListPrivateGraphEndpoints that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListPrivateGraphEndpointsRequestT = Model::ListPrivateGraphEndpointsRequest>
  Model::ListPrivateGraphEndpointsOutcomeCallable ListPrivateGraphEndpointsCallable(
      const ListPrivateGraphEndpointsRequestT& request) const {
    return SubmitCallable(&NeptuneGraphClient::ListPrivateGraphEndpoints, request);
  }

  /**
   * An Async wrapper for ListPrivateGraphEndpoints that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListPrivateGraphEndpointsRequestT = Model::ListPrivateGraphEndpointsRequest>
  void ListPrivateGraphEndpointsAsync(const ListPrivateGraphEndpointsRequestT& request,
                                      const ListPrivateGraphEndpointsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ResetGraph that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ResetGraphRequestT = Model::ResetGraphRequest>
  void ResetGraphAsync(const ResetGraphRequestT& request, const ResetGraphResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RestoreGraphFromSnapshot that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RestoreGraphFromSnapshot that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RestoreGraphFromSnapshotRequestT = Model::RestoreGraphFromSnapshotRequest>
  void RestoreGraphFromSnapshotAsync(const RestoreGraphFromSnapshotRequestT& request,
                                     const RestoreGraphFromSnapshotResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StartExportTask that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StartExportTaskRequestT = Model::StartExportTaskRequest>
  void StartExportTaskAsync(const StartExportTaskRequestT& request, const StartExportTaskResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StartGraph that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StartGraphRequestT = Model::StartGraphRequest>
  void StartGraphAsync(const StartGraphRequestT& request, const StartGraphResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StartImportTask that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StartImportTaskRequestT = Model::StartImportTaskRequest>
  void StartImportTaskAsync(const StartImportTaskRequestT& request, const StartImportTaskResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StopGraph that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StopGraphRequestT = Model::StopGraphRequest>
  void StopGraphAsync(const StopGraphRequestT& request, const StopGraphResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateGraph that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateGraphRequestT = Model::UpdateGraphRequest>
  void UpdateGraphAsync(const UpdateGraphRequestT& request, const UpdateGraphResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
