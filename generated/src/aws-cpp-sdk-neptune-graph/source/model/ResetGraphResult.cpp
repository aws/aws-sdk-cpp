...
ResetGraphResult::ResetGraphResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

ResetGraphResult& ResetGraphResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
