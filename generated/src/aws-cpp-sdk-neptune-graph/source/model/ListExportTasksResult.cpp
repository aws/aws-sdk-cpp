...
ListExportTasksResult::ListExportTasksResult()
{
}

ListExportTasksResult::ListExportTasksResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListExportTasksResult& ListExportTasksResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
