...
ListImportTasksResult::ListImportTasksResult()
{
}

ListImportTasksResult::ListImportTasksResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListImportTasksResult& ListImportTasksResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
