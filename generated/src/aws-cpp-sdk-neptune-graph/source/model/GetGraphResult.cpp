...
GetGraphResult::GetGraphResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

GetGraphResult& GetGraphResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
