...
UpdateGraphResult::UpdateGraphResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

UpdateGraphResult& UpdateGraphResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
