...
Aws::String CancelImportTaskRequest::SerializePayload() const { return {}; }

CancelImportTaskRequest::EndpointParameters CancelImportTaskRequest::GetEndpointContextParams() const {
