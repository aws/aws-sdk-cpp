...
void ListPrivateGraphEndpointsRequest::AddQueryStringParameters(URI& uri) const
{
    Aws::StringStream ss;
...
ListPrivateGraphEndpointsRequest::EndpointParameters ListPrivateGraphEndpointsRequest::GetEndpointContextParams() const
{
