...
class DataQualitySummary {
 public:
  ...
  void SetInsufficientSensorData(InsufficientSensorDataT&& value) {
    ...
    m_insufficientSensorData = std::forward<InsufficientSensorDataT>(value);
  }
  template <typename InsufficientSensorDataT = InsufficientSensorData>
  DataQualitySummary& WithInsufficientSensorData(InsufficientSensorDataT&& value) {
    SetInsufficientSensorData(std::forward<InsufficientSensorDataT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMissingSensorData(MissingSensorDataT&& value) {
    ...
    m_missingSensorData = std::forward<MissingSensorDataT>(value);
  }
  template <typename MissingSensorDataT = MissingSensorData>
  DataQualitySummary& WithMissingSensorData(MissingSensorDataT&& value) {
    SetMissingSensorData(std::forward<MissingSensorDataT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInvalidSensorData(InvalidSensorDataT&& value) {
    ...
    m_invalidSensorData = std::forward<InvalidSensorDataT>(value);
  }
  template <typename InvalidSensorDataT = InvalidSensorData>
  DataQualitySummary& WithInvalidSensorData(InvalidSensorDataT&& value) {
    SetInvalidSensorData(std::forward<InvalidSensorDataT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUnsupportedTimestamps(UnsupportedTimestampsT&& value) {
    ...
    m_unsupportedTimestamps = std::forward<UnsupportedTimestampsT>(value);
  }
  template <typename UnsupportedTimestampsT = UnsupportedTimestamps>
  DataQualitySummary& WithUnsupportedTimestamps(UnsupportedTimestampsT&& value) {
    SetUnsupportedTimestamps(std::forward<UnsupportedTimestampsT>(value));
    return *this;
  }
  ///@}
