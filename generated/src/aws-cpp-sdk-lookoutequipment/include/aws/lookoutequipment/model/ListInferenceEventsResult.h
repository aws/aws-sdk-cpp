...
class ListInferenceEventsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListInferenceEventsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetInferenceEventSummaries(InferenceEventSummariesT&& value) {
    m_inferenceEventSummariesHasBeenSet = true;
    m_inferenceEventSummaries = std::forward<InferenceEventSummariesT>(value);
  }
  template <typename InferenceEventSummariesT = Aws::Vector<InferenceEventSummary>>
  ListInferenceEventsResult& WithInferenceEventSummaries(InferenceEventSummariesT&& value) {
    SetInferenceEventSummaries(std::forward<InferenceEventSummariesT>(value));
    return *this;
  }
  template <typename InferenceEventSummariesT = InferenceEventSummary>
  ListInferenceEventsResult& AddInferenceEventSummaries(InferenceEventSummariesT&& value) {
    m_inferenceEventSummariesHasBeenSet = true;
    m_inferenceEventSummaries.emplace_back(std::forward<InferenceEventSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListInferenceEventsResult& WithRequestId(RequestIdT&& value) {
