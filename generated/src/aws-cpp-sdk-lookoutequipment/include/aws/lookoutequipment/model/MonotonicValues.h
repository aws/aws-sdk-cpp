...
class MonotonicValues {
 public:
  ...
  inline MonotonicValues& WithStatus(StatisticalIssueStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMonotonicity(Monotonicity value) {
    m_monotonicityHasBeenSet = true;
    m_monotonicity = value;
  }
  inline MonotonicValues& WithMonotonicity(Monotonicity value) {
    SetMonotonicity(value);
    return *this;
  }
  ///@}
 private:
