...
class ListModelVersionsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListModelVersionsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetModelVersionSummaries(ModelVersionSummariesT&& value) {
    m_modelVersionSummariesHasBeenSet = true;
    m_modelVersionSummaries = std::forward<ModelVersionSummariesT>(value);
  }
  template <typename ModelVersionSummariesT = Aws::Vector<ModelVersionSummary>>
  ListModelVersionsResult& WithModelVersionSummaries(ModelVersionSummariesT&& value) {
    SetModelVersionSummaries(std::forward<ModelVersionSummariesT>(value));
    return *this;
  }
  template <typename ModelVersionSummariesT = ModelVersionSummary>
  ListModelVersionsResult& AddModelVersionSummaries(ModelVersionSummariesT&& value) {
    m_modelVersionSummariesHasBeenSet = true;
    m_modelVersionSummaries.emplace_back(std::forward<ModelVersionSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListModelVersionsResult& WithRequestId(RequestIdT&& value) {
