...
class UpdateInferenceSchedulerRequest : public LookoutEquipmentRequest {
 public:
  ...
  template <typename InferenceSchedulerNameT = Aws::String>
  UpdateInferenceSchedulerRequest& WithInferenceSchedulerName(InferenceSchedulerNameT&& value) {
  ...
  inline UpdateInferenceSchedulerRequest& WithDataDelayOffsetInMinutes(long long value) {
  ...
  inline UpdateInferenceSchedulerRequest& WithDataUploadFrequency(DataUploadFrequency value) {
  ...
  template <typename DataInputConfigurationT = InferenceInputConfiguration>
  UpdateInferenceSchedulerRequest& WithDataInputConfiguration(DataInputConfigurationT&& value) {
  ...
  template <typename DataOutputConfigurationT = InferenceOutputConfiguration>
  UpdateInferenceSchedulerRequest& WithDataOutputConfiguration(DataOutputConfigurationT&& value) {
  ...
  template <typename RoleArnT = Aws::String>
  UpdateInferenceSchedulerRequest& WithRoleArn(RoleArnT&& value) {
