...
class ImportModelVersionResult {
 public:
  ...
  template <typename ModelNameT = Aws::String>
  ImportModelVersionResult& WithModelName(ModelNameT&& value) {
  ...
  template <typename ModelArnT = Aws::String>
  ImportModelVersionResult& WithModelArn(ModelArnT&& value) {
  ...
  void SetModelVersionArn(ModelVersionArnT&& value) {
    ...
    m_modelVersionArn = std::forward<ModelVersionArnT>(value);
  }
  template <typename ModelVersionArnT = Aws::String>
  ImportModelVersionResult& WithModelVersionArn(ModelVersionArnT&& value) {
    SetModelVersionArn(std::forward<ModelVersionArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetModelVersion(long long value) {
    m_modelVersionHasBeenSet = true;
    m_modelVersion = value;
  }
  inline ImportModelVersionResult& WithModelVersion(long long value) {
  ...
  inline void SetStatus(ModelVersionStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ImportModelVersionResult& WithStatus(ModelVersionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ImportModelVersionResult& WithRequestId(RequestIdT&& value) {
