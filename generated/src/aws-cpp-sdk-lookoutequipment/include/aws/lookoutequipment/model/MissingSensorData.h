...
class MissingSensorData {
 public:
  ...
  inline MissingSensorData& WithAffectedSensorCount(int value) {
  ...
  inline void SetTotalNumberOfMissingValues(int value) {
    m_totalNumberOfMissingValuesHasBeenSet = true;
    m_totalNumberOfMissingValues = value;
  }
  inline MissingSensorData& WithTotalNumberOfMissingValues(int value) {
    SetTotalNumberOfMissingValues(value);
    return *this;
  }
  ///@}
 private:
