...
class ImportDatasetResult {
 public:
  ...
  template <typename DatasetNameT = Aws::String>
  ImportDatasetResult& WithDatasetName(DatasetNameT&& value) {
  ...
  template <typename DatasetArnT = Aws::String>
  ImportDatasetResult& WithDatasetArn(DatasetArnT&& value) {
  ...
  inline ImportDatasetResult& WithStatus(DatasetStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename JobIdT = Aws::String>
  ImportDatasetResult& WithJobId(JobIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ImportDatasetResult& WithRequestId(RequestIdT&& value) {
