...
class DataPreProcessingConfiguration {
 public:
  ...
  inline void SetTargetSamplingRate(TargetSamplingRate value) {
    m_targetSamplingRateHasBeenSet = true;
    m_targetSamplingRate = value;
  }
  inline DataPreProcessingConfiguration& WithTargetSamplingRate(TargetSamplingRate value) {
    SetTargetSamplingRate(value);
    return *this;
  }
  ///@}
 private:
