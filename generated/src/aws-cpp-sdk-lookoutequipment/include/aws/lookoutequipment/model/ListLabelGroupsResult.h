...
class ListLabelGroupsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListLabelGroupsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetLabelGroupSummaries(LabelGroupSummariesT&& value) {
    m_labelGroupSummariesHasBeenSet = true;
    m_labelGroupSummaries = std::forward<LabelGroupSummariesT>(value);
  }
  template <typename LabelGroupSummariesT = Aws::Vector<LabelGroupSummary>>
  ListLabelGroupsResult& WithLabelGroupSummaries(LabelGroupSummariesT&& value) {
    SetLabelGroupSummaries(std::forward<LabelGroupSummariesT>(value));
    return *this;
  }
  template <typename LabelGroupSummariesT = LabelGroupSummary>
  ListLabelGroupsResult& AddLabelGroupSummaries(LabelGroupSummariesT&& value) {
    m_labelGroupSummariesHasBeenSet = true;
    m_labelGroupSummaries.emplace_back(std::forward<LabelGroupSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListLabelGroupsResult& WithRequestId(RequestIdT&& value) {
