...
class LargeTimestampGaps {
 public:
  ...
  inline void SetStatus(StatisticalIssueStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline LargeTimestampGaps& WithStatus(StatisticalIssueStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNumberOfLargeTimestampGaps(int value) {
    m_numberOfLargeTimestampGapsHasBeenSet = true;
    m_numberOfLargeTimestampGaps = value;
  }
  inline LargeTimestampGaps& WithNumberOfLargeTimestampGaps(int value) {
    SetNumberOfLargeTimestampGaps(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxTimestampGapInDays(int value) {
    m_maxTimestampGapInDaysHasBeenSet = true;
    m_maxTimestampGapInDays = value;
  }
  inline LargeTimestampGaps& WithMaxTimestampGapInDays(int value) {
    SetMaxTimestampGapInDays(value);
    return *this;
  }
  ///@}
 private:
