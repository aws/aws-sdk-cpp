...
class IngestedFilesSummary {
 public:
  ...
  inline void SetTotalNumberOfFiles(int value) {
    m_totalNumberOfFilesHasBeenSet = true;
    m_totalNumberOfFiles = value;
  }
  inline IngestedFilesSummary& WithTotalNumberOfFiles(int value) {
    SetTotalNumberOfFiles(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIngestedNumberOfFiles(int value) {
    m_ingestedNumberOfFilesHasBeenSet = true;
    m_ingestedNumberOfFiles = value;
  }
  inline IngestedFilesSummary& WithIngestedNumberOfFiles(int value) {
    SetIngestedNumberOfFiles(value);
    return *this;
  }
  ///@}
  ...
  void SetDiscardedFiles(DiscardedFilesT&& value) {
    m_discardedFilesHasBeenSet = true;
    m_discardedFiles = std::forward<DiscardedFilesT>(value);
  }
  template <typename DiscardedFilesT = Aws::Vector<S3Object>>
  IngestedFilesSummary& WithDiscardedFiles(DiscardedFilesT&& value) {
    SetDiscardedFiles(std::forward<DiscardedFilesT>(value));
    return *this;
  }
  template <typename DiscardedFilesT = S3Object>
  IngestedFilesSummary& AddDiscardedFiles(DiscardedFilesT&& value) {
    m_discardedFilesHasBeenSet = true;
    m_discardedFiles.emplace_back(std::forward<DiscardedFilesT>(value));
    return *this;
  }
  ///@}
 private:
