...
class UpdateActiveModelVersionResult {
 public:
  ...
  AWS_LOOKOUTEQUIPMENT_API UpdateActiveModelVersionResult& operator=(
  ...
  template <typename ModelNameT = Aws::String>
  UpdateActiveModelVersionResult& WithModelName(ModelNameT&& value) {
  ...
  template <typename ModelArnT = Aws::String>
  UpdateActiveModelVersionResult& WithModelArn(ModelArnT&& value) {
  ...
  inline void SetCurrentActiveVersion(long long value) {
    m_currentActiveVersionHasBeenSet = true;
    m_currentActiveVersion = value;
  }
  inline UpdateActiveModelVersionResult& WithCurrentActiveVersion(long long value) {
    SetCurrentActiveVersion(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPreviousActiveVersion(long long value) {
    m_previousActiveVersionHasBeenSet = true;
    m_previousActiveVersion = value;
  }
  inline UpdateActiveModelVersionResult& WithPreviousActiveVersion(long long value) {
    SetPreviousActiveVersion(value);
    return *this;
  }
  ///@}
  ...
  void SetCurrentActiveVersionArn(CurrentActiveVersionArnT&& value) {
    m_currentActiveVersionArnHasBeenSet = true;
    m_currentActiveVersionArn = std::forward<CurrentActiveVersionArnT>(value);
  }
  template <typename CurrentActiveVersionArnT = Aws::String>
  UpdateActiveModelVersionResult& WithCurrentActiveVersionArn(CurrentActiveVersionArnT&& value) {
    SetCurrentActiveVersionArn(std::forward<CurrentActiveVersionArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPreviousActiveVersionArn(PreviousActiveVersionArnT&& value) {
    m_previousActiveVersionArnHasBeenSet = true;
    m_previousActiveVersionArn = std::forward<PreviousActiveVersionArnT>(value);
  }
  template <typename PreviousActiveVersionArnT = Aws::String>
  UpdateActiveModelVersionResult& WithPreviousActiveVersionArn(PreviousActiveVersionArnT&& value) {
    SetPreviousActiveVersionArn(std::forward<PreviousActiveVersionArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  UpdateActiveModelVersionResult& WithRequestId(RequestIdT&& value) {
