...
class StartDataIngestionJobResult {
 public:
  ...
  template <typename JobIdT = Aws::String>
  StartDataIngestionJobResult& WithJobId(JobIdT&& value) {
  ...
  inline StartDataIngestionJobResult& WithStatus(IngestionJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  StartDataIngestionJobResult& WithRequestId(RequestIdT&& value) {
