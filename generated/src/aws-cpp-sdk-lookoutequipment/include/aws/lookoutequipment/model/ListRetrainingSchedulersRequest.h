...
class ListRetrainingSchedulersRequest : public LookoutEquipmentRequest {
 public:
  ...
  void SetModelNameBeginsWith(ModelNameBeginsWithT&& value) {
    m_modelNameBeginsWithHasBeenSet = true;
    m_modelNameBeginsWith = std::forward<ModelNameBeginsWithT>(value);
  }
  template <typename ModelNameBeginsWithT = Aws::String>
  ListRetrainingSchedulersRequest& WithModelNameBeginsWith(ModelNameBeginsWithT&& value) {
    SetModelNameBeginsWith(std::forward<ModelNameBeginsWithT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListRetrainingSchedulersRequest& WithStatus(RetrainingSchedulerStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline ListRetrainingSchedulersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
