...
class ListInferenceExecutionsResult {
 public:
  ...
  void SetInferenceExecutionSummaries(InferenceExecutionSummariesT&& value) {
    ...
    m_inferenceExecutionSummaries = std::forward<InferenceExecutionSummariesT>(value);
  }
  template <typename InferenceExecutionSummariesT = Aws::Vector<InferenceExecutionSummary>>
  ListInferenceExecutionsResult& WithInferenceExecutionSummaries(InferenceExecutionSummariesT&& value) {
    SetInferenceExecutionSummaries(std::forward<InferenceExecutionSummariesT>(value));
    return *this;
  }
  ...
  ListInferenceExecutionsResult& AddInferenceExecutionSummaries(InferenceExecutionSummariesT&& value) {
    m_inferenceExecutionSummariesHasBeenSet = true;
    m_inferenceExecutionSummaries.emplace_back(std::forward<InferenceExecutionSummariesT>(value));
    return *this;
  }
  ///@}
