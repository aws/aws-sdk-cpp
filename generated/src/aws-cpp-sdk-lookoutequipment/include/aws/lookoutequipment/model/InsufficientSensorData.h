...
class InsufficientSensorData {
 public:
  ...
  void SetMissingCompleteSensorData(MissingCompleteSensorDataT&& value) {
    ...
    m_missingCompleteSensorData = std::forward<MissingCompleteSensorDataT>(value);
  }
  template <typename MissingCompleteSensorDataT = MissingCompleteSensorData>
  InsufficientSensorData& WithMissingCompleteSensorData(MissingCompleteSensorDataT&& value) {
    SetMissingCompleteSensorData(std::forward<MissingCompleteSensorDataT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSensorsWithShortDateRange(SensorsWithShortDateRangeT&& value) {
    ...
    m_sensorsWithShortDateRange = std::forward<SensorsWithShortDateRangeT>(value);
  }
  template <typename SensorsWithShortDateRangeT = SensorsWithShortDateRange>
  InsufficientSensorData& WithSensorsWithShortDateRange(SensorsWithShortDateRangeT&& value) {
    SetSensorsWithShortDateRange(std::forward<SensorsWithShortDateRangeT>(value));
    return *this;
  }
  ///@}
 private:
