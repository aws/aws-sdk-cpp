...
namespace Model
{
  ...
  {
  public:
    AWS_LOOKOUTEQUIPMENT_API DeleteInferenceSchedulerRequest() = default;
    ...
    template<typename InferenceSchedulerNameT = Aws::String>
    DeleteInferenceSchedulerRequest& WithInferenceSchedulerName(InferenceSchedulerNameT&& value) { SetInferenceSchedulerName(std::forward<InferenceSchedulerNameT>(value)); return *this;}
    ///@}
  private:
