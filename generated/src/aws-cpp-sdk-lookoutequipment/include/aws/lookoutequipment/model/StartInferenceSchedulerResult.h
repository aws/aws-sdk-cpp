...
class StartInferenceSchedulerResult {
 public:
  ...
  template <typename ModelArnT = Aws::String>
  StartInferenceSchedulerResult& WithModelArn(ModelArnT&& value) {
  ...
  template <typename ModelNameT = Aws::String>
  StartInferenceSchedulerResult& WithModelName(ModelNameT&& value) {
  ...
  template <typename InferenceSchedulerNameT = Aws::String>
  StartInferenceSchedulerResult& WithInferenceSchedulerName(InferenceSchedulerNameT&& value) {
  ...
  template <typename InferenceSchedulerArnT = Aws::String>
  StartInferenceSchedulerResult& WithInferenceSchedulerArn(InferenceSchedulerArnT&& value) {
  ...
  inline StartInferenceSchedulerResult& WithStatus(InferenceSchedulerStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  StartInferenceSchedulerResult& WithRequestId(RequestIdT&& value) {
