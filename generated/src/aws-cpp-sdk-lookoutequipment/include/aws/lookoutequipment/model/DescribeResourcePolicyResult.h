...
class DescribeResourcePolicyResult {
 public:
  AWS_LOOKOUTEQUIPMENT_API DescribeResourcePolicyResult() = default;
  ...
  template <typename PolicyRevisionIdT = Aws::String>
  DescribeResourcePolicyResult& WithPolicyRevisionId(PolicyRevisionIdT&& value) {
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  DescribeResourcePolicyResult& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename LastModifiedTimeT = Aws::Utils::DateTime>
  DescribeResourcePolicyResult& WithLastModifiedTime(LastModifiedTimeT&& value) {
