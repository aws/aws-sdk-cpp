...
class ListRetrainingSchedulersResult {
 public:
  ...
  AWS_LOOKOUTEQUIPMENT_API ListRetrainingSchedulersResult& operator=(
  ...
  void SetRetrainingSchedulerSummaries(RetrainingSchedulerSummariesT&& value) {
    m_retrainingSchedulerSummariesHasBeenSet = true;
    m_retrainingSchedulerSummaries = std::forward<RetrainingSchedulerSummariesT>(value);
  }
  template <typename RetrainingSchedulerSummariesT = Aws::Vector<RetrainingSchedulerSummary>>
  ListRetrainingSchedulersResult& WithRetrainingSchedulerSummaries(RetrainingSchedulerSummariesT&& value) {
    SetRetrainingSchedulerSummaries(std::forward<RetrainingSchedulerSummariesT>(value));
    return *this;
  }
  template <typename RetrainingSchedulerSummariesT = RetrainingSchedulerSummary>
  ListRetrainingSchedulersResult& AddRetrainingSchedulerSummaries(RetrainingSchedulerSummariesT&& value) {
    m_retrainingSchedulerSummariesHasBeenSet = true;
    m_retrainingSchedulerSummaries.emplace_back(std::forward<RetrainingSchedulerSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListRetrainingSchedulersResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListRetrainingSchedulersResult& WithRequestId(RequestIdT&& value) {
