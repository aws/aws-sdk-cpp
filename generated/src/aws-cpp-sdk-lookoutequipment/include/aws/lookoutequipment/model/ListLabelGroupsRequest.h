...
class ListLabelGroupsRequest : public LookoutEquipmentRequest {
 public:
  ...
  void SetLabelGroupNameBeginsWith(LabelGroupNameBeginsWithT&& value) {
    m_labelGroupNameBeginsWithHasBeenSet = true;
    m_labelGroupNameBeginsWith = std::forward<LabelGroupNameBeginsWithT>(value);
  }
  template <typename LabelGroupNameBeginsWithT = Aws::String>
  ListLabelGroupsRequest& WithLabelGroupNameBeginsWith(LabelGroupNameBeginsWithT&& value) {
    SetLabelGroupNameBeginsWith(std::forward<LabelGroupNameBeginsWithT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListLabelGroupsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
