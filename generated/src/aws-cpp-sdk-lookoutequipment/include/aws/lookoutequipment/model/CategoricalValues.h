...
class CategoricalValues {
 public:
  ...
  inline CategoricalValues& WithStatus(StatisticalIssueStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNumberOfCategory(int value) {
    m_numberOfCategoryHasBeenSet = true;
    m_numberOfCategory = value;
  }
  inline CategoricalValues& WithNumberOfCategory(int value) {
    SetNumberOfCategory(value);
    return *this;
  }
  ///@}
 private:
