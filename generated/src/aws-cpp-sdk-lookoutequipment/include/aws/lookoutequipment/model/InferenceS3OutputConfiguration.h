...
class InferenceS3OutputConfiguration {
 public:
  AWS_LOOKOUTEQUIPMENT_API InferenceS3OutputConfiguration() = default;
  ...
  template <typename BucketT = Aws::String>
  InferenceS3OutputConfiguration& WithBucket(BucketT&& value) {
  ...
  template <typename PrefixT = Aws::String>
  InferenceS3OutputConfiguration& WithPrefix(PrefixT&& value) {
