...
class DescribeDataIngestionJobResult {
 public:
  ...
  AWS_LOOKOUTEQUIPMENT_API DescribeDataIngestionJobResult& operator=(
  ...
  template <typename JobIdT = Aws::String>
  DescribeDataIngestionJobResult& WithJobId(JobIdT&& value) {
  ...
  inline DescribeDataIngestionJobResult& WithStatus(IngestionJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetDataQualitySummary(DataQualitySummaryT&& value) {
    m_dataQualitySummaryHasBeenSet = true;
    m_dataQualitySummary = std::forward<DataQualitySummaryT>(value);
  }
  template <typename DataQualitySummaryT = DataQualitySummary>
  DescribeDataIngestionJobResult& WithDataQualitySummary(DataQualitySummaryT&& value) {
    SetDataQualitySummary(std::forward<DataQualitySummaryT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIngestedFilesSummary(IngestedFilesSummaryT&& value) {
    ...
    m_ingestedFilesSummary = std::forward<IngestedFilesSummaryT>(value);
  }
  template <typename IngestedFilesSummaryT = IngestedFilesSummary>
  DescribeDataIngestionJobResult& WithIngestedFilesSummary(IngestedFilesSummaryT&& value) {
    SetIngestedFilesSummary(std::forward<IngestedFilesSummaryT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetIngestedDataSize(long long value) {
    m_ingestedDataSizeHasBeenSet = true;
    m_ingestedDataSize = value;
  }
  inline DescribeDataIngestionJobResult& WithIngestedDataSize(long long value) {
    SetIngestedDataSize(value);
    return *this;
  }
  ///@}
  ...
  void SetDataStartTime(DataStartTimeT&& value) {
    ...
    m_dataStartTime = std::forward<DataStartTimeT>(value);
  }
  template <typename DataStartTimeT = Aws::Utils::DateTime>
  DescribeDataIngestionJobResult& WithDataStartTime(DataStartTimeT&& value) {
    SetDataStartTime(std::forward<DataStartTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDataEndTime(DataEndTimeT&& value) {
    ...
    m_dataEndTime = std::forward<DataEndTimeT>(value);
  }
  template <typename DataEndTimeT = Aws::Utils::DateTime>
  DescribeDataIngestionJobResult& WithDataEndTime(DataEndTimeT&& value) {
    SetDataEndTime(std::forward<DataEndTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSourceDatasetArn(SourceDatasetArnT&& value) {
    m_sourceDatasetArnHasBeenSet = true;
    m_sourceDatasetArn = std::forward<SourceDatasetArnT>(value);
  }
  template <typename SourceDatasetArnT = Aws::String>
  DescribeDataIngestionJobResult& WithSourceDatasetArn(SourceDatasetArnT&& value) {
    SetSourceDatasetArn(std::forward<SourceDatasetArnT>(value));
    return *this;
  }
  ///@}
