...
class SensorStatisticsSummary {
 public:
  ...
  void SetSensorName(SensorNameT&& value) {
    ...
    m_sensorName = std::forward<SensorNameT>(value);
  }
  template <typename SensorNameT = Aws::String>
  SensorStatisticsSummary& WithSensorName(SensorNameT&& value) {
    SetSensorName(std::forward<SensorNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetDataExists(bool value) {
    m_dataExistsHasBeenSet = true;
    m_dataExists = value;
  }
  inline SensorStatisticsSummary& WithDataExists(bool value) {
    SetDataExists(value);
    return *this;
  }
  ///@}
  ...
  void SetMissingValues(MissingValuesT&& value) {
    ...
    m_missingValues = std::forward<MissingValuesT>(value);
  }
  template <typename MissingValuesT = CountPercent>
  SensorStatisticsSummary& WithMissingValues(MissingValuesT&& value) {
    SetMissingValues(std::forward<MissingValuesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInvalidValues(InvalidValuesT&& value) {
    ...
    m_invalidValues = std::forward<InvalidValuesT>(value);
  }
  template <typename InvalidValuesT = CountPercent>
  SensorStatisticsSummary& WithInvalidValues(InvalidValuesT&& value) {
    SetInvalidValues(std::forward<InvalidValuesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInvalidDateEntries(InvalidDateEntriesT&& value) {
    ...
    m_invalidDateEntries = std::forward<InvalidDateEntriesT>(value);
  }
  template <typename InvalidDateEntriesT = CountPercent>
  SensorStatisticsSummary& WithInvalidDateEntries(InvalidDateEntriesT&& value) {
    SetInvalidDateEntries(std::forward<InvalidDateEntriesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDuplicateTimestamps(DuplicateTimestampsT&& value) {
    ...
    m_duplicateTimestamps = std::forward<DuplicateTimestampsT>(value);
  }
  template <typename DuplicateTimestampsT = CountPercent>
  SensorStatisticsSummary& WithDuplicateTimestamps(DuplicateTimestampsT&& value) {
    SetDuplicateTimestamps(std::forward<DuplicateTimestampsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCategoricalValues(CategoricalValuesT&& value) {
    ...
    m_categoricalValues = std::forward<CategoricalValuesT>(value);
  }
  template <typename CategoricalValuesT = CategoricalValues>
  SensorStatisticsSummary& WithCategoricalValues(CategoricalValuesT&& value) {
    SetCategoricalValues(std::forward<CategoricalValuesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMultipleOperatingModes(MultipleOperatingModesT&& value) {
    ...
    m_multipleOperatingModes = std::forward<MultipleOperatingModesT>(value);
  }
  template <typename MultipleOperatingModesT = MultipleOperatingModes>
  SensorStatisticsSummary& WithMultipleOperatingModes(MultipleOperatingModesT&& value) {
    SetMultipleOperatingModes(std::forward<MultipleOperatingModesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLargeTimestampGaps(LargeTimestampGapsT&& value) {
    ...
    m_largeTimestampGaps = std::forward<LargeTimestampGapsT>(value);
  }
  template <typename LargeTimestampGapsT = LargeTimestampGaps>
  SensorStatisticsSummary& WithLargeTimestampGaps(LargeTimestampGapsT&& value) {
    SetLargeTimestampGaps(std::forward<LargeTimestampGapsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMonotonicValues(MonotonicValuesT&& value) {
    ...
    m_monotonicValues = std::forward<MonotonicValuesT>(value);
  }
  template <typename MonotonicValuesT = MonotonicValues>
  SensorStatisticsSummary& WithMonotonicValues(MonotonicValuesT&& value) {
    SetMonotonicValues(std::forward<MonotonicValuesT>(value));
    return *this;
  }
  ///@}
