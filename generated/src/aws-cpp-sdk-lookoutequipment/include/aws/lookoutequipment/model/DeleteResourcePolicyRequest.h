...
namespace Model
{
  ...
  /**
   */
  class DeleteResourcePolicyRequest : public LookoutEquipmentRequest
  {
  public:
    AWS_LOOKOUTEQUIPMENT_API DeleteResourcePolicyRequest() = default;
    ...
    ///@{
    /**
     * <p>The Amazon Resource Name (ARN) of the resource for which the resource policy
     * should be deleted.</p>
     */
