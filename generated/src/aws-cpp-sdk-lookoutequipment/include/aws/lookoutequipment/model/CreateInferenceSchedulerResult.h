...
class CreateInferenceSchedulerResult {
 public:
  ...
  AWS_LOOKOUTEQUIPMENT_API CreateInferenceSchedulerResult& operator=(
  ...
  void SetInferenceSchedulerArn(InferenceSchedulerArnT&& value) {
    ...
    m_inferenceSchedulerArn = std::forward<InferenceSchedulerArnT>(value);
  }
  template <typename InferenceSchedulerArnT = Aws::String>
  CreateInferenceSchedulerResult& WithInferenceSchedulerArn(InferenceSchedulerArnT&& value) {
    SetInferenceSchedulerArn(std::forward<InferenceSchedulerArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename InferenceSchedulerNameT = Aws::String>
  CreateInferenceSchedulerResult& WithInferenceSchedulerName(InferenceSchedulerNameT&& value) {
  ...
  inline void SetStatus(InferenceSchedulerStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline CreateInferenceSchedulerResult& WithStatus(InferenceSchedulerStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetModelQuality(ModelQuality value) {
    m_modelQualityHasBeenSet = true;
    m_modelQuality = value;
  }
  inline CreateInferenceSchedulerResult& WithModelQuality(ModelQuality value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateInferenceSchedulerResult& WithRequestId(RequestIdT&& value) {
