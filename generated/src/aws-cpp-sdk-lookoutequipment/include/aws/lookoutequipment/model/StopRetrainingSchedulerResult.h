...
namespace Model
{
  ...
  {
  public:
    AWS_LOOKOUTEQUIPMENT_API StopRetrainingSchedulerResult() = default;
    ...
    template<typename ModelNameT = Aws::String>
    StopRetrainingSchedulerResult& WithModelName(ModelNameT&& value) { SetModelName(std::forward<ModelNameT>(value)); return *this;}
    ///@}
    ...
    template<typename ModelArnT = Aws::String>
    StopRetrainingSchedulerResult& WithModelArn(ModelArnT&& value) { SetModelArn(std::forward<ModelArnT>(value)); return *this;}
    ///@}
    ...
    inline StopRetrainingSchedulerResult& WithStatus(RetrainingSchedulerStatus value) { SetStatus(value); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    StopRetrainingSchedulerResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
