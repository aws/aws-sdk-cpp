...
class StopRetrainingSchedulerResult {
 public:
  ...
  template <typename ModelNameT = Aws::String>
  StopRetrainingSchedulerResult& WithModelName(ModelNameT&& value) {
  ...
  template <typename ModelArnT = Aws::String>
  StopRetrainingSchedulerResult& WithModelArn(ModelArnT&& value) {
  ...
  inline StopRetrainingSchedulerResult& WithStatus(RetrainingSchedulerStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  StopRetrainingSchedulerResult& WithRequestId(RequestIdT&& value) {
