...
class ListLabelsResult {
 public:
  ...
  void SetLabelSummaries(LabelSummariesT&& value) {
    ...
    m_labelSummaries = std::forward<LabelSummariesT>(value);
  }
  template <typename LabelSummariesT = Aws::Vector<LabelSummary>>
  ListLabelsResult& WithLabelSummaries(LabelSummariesT&& value) {
    SetLabelSummaries(std::forward<LabelSummariesT>(value));
    return *this;
  }
  template <typename LabelSummariesT = LabelSummary>
  ListLabelsResult& AddLabelSummaries(LabelSummariesT&& value) {
    m_labelSummariesHasBeenSet = true;
    m_labelSummaries.emplace_back(std::forward<LabelSummariesT>(value));
    return *this;
  }
  ///@}
