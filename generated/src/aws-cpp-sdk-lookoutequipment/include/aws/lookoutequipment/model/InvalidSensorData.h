...
class InvalidSensorData {
 public:
  AWS_LOOKOUTEQUIPMENT_API InvalidSensorData() = default;
  ...
  inline void SetAffectedSensorCount(int value) {
    m_affectedSensorCountHasBeenSet = true;
    m_affectedSensorCount = value;
  }
  inline InvalidSensorData& WithAffectedSensorCount(int value) {
    SetAffectedSensorCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTotalNumberOfInvalidValues(int value) {
    m_totalNumberOfInvalidValuesHasBeenSet = true;
    m_totalNumberOfInvalidValues = value;
  }
  inline InvalidSensorData& WithTotalNumberOfInvalidValues(int value) {
    SetTotalNumberOfInvalidValues(value);
    return *this;
  }
  ///@}
 private:
