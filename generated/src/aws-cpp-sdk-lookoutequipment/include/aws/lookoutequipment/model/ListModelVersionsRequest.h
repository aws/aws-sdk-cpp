...
class ListModelVersionsRequest : public LookoutEquipmentRequest {
 public:
  ...
  inline ListModelVersionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline ListModelVersionsRequest& WithStatus(ModelVersionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline ListModelVersionsRequest& WithSourceType(ModelVersionSourceType value) {
    SetSourceType(value);
    return *this;
  }
  ///@}
  ...
  void SetCreatedAtEndTime(CreatedAtEndTimeT&& value) {
    m_createdAtEndTimeHasBeenSet = true;
    m_createdAtEndTime = std::forward<CreatedAtEndTimeT>(value);
  }
  template <typename CreatedAtEndTimeT = Aws::Utils::DateTime>
  ListModelVersionsRequest& WithCreatedAtEndTime(CreatedAtEndTimeT&& value) {
    SetCreatedAtEndTime(std::forward<CreatedAtEndTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCreatedAtStartTime(CreatedAtStartTimeT&& value) {
    m_createdAtStartTimeHasBeenSet = true;
    m_createdAtStartTime = std::forward<CreatedAtStartTimeT>(value);
  }
  template <typename CreatedAtStartTimeT = Aws::Utils::DateTime>
  ListModelVersionsRequest& WithCreatedAtStartTime(CreatedAtStartTimeT&& value) {
    SetCreatedAtStartTime(std::forward<CreatedAtStartTimeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetMaxModelVersion(long long value) {
    m_maxModelVersionHasBeenSet = true;
    m_maxModelVersion = value;
  }
  inline ListModelVersionsRequest& WithMaxModelVersion(long long value) {
    SetMaxModelVersion(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMinModelVersion(long long value) {
    m_minModelVersionHasBeenSet = true;
    m_minModelVersion = value;
  }
  inline ListModelVersionsRequest& WithMinModelVersion(long long value) {
    SetMinModelVersion(value);
    return *this;
  }
  ///@}
 private:
