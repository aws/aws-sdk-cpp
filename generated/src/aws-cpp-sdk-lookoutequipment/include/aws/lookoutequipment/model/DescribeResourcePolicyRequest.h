...
namespace Model
{
  ...
  /**
   */
  class DescribeResourcePolicyRequest : public LookoutEquipmentRequest
  {
  public:
    AWS_LOOKOUTEQUIPMENT_API DescribeResourcePolicyRequest() = default;
    ...
    ///@{
    /**
     * <p>The Amazon Resource Name (ARN) of the resource that is associated with the
     * resource policy.</p>
     */
