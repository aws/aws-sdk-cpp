...
class StartRetrainingSchedulerResult {
 public:
  ...
  AWS_LOOKOUTEQUIPMENT_API StartRetrainingSchedulerResult& operator=(
  ...
  template <typename ModelNameT = Aws::String>
  StartRetrainingSchedulerResult& WithModelName(ModelNameT&& value) {
  ...
  template <typename ModelArnT = Aws::String>
  StartRetrainingSchedulerResult& WithModelArn(ModelArnT&& value) {
  ...
  inline StartRetrainingSchedulerResult& WithStatus(RetrainingSchedulerStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  StartRetrainingSchedulerResult& WithRequestId(RequestIdT&& value) {
