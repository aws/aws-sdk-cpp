...
class UpdateActiveModelVersionRequest : public LookoutEquipmentRequest {
 public:
  AWS_LOOKOUTEQUIPMENT_API UpdateActiveModelVersionRequest() = default;
  ...
  template <typename ModelNameT = Aws::String>
  UpdateActiveModelVersionRequest& WithModelName(ModelNameT&& value) {
  ...
  inline UpdateActiveModelVersionRequest& WithModelVersion(long long value) {
