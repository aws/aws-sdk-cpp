...
class ImportDatasetRequest : public LookoutEquipmentRequest {
 public:
  ...
  template <typename SourceDatasetArnT = Aws::String>
  ImportDatasetRequest& WithSourceDatasetArn(SourceDatasetArnT&& value) {
  ...
  template <typename DatasetNameT = Aws::String>
  ImportDatasetRequest& WithDatasetName(DatasetNameT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  ImportDatasetRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename ServerSideKmsKeyIdT = Aws::String>
  ImportDatasetRequest& WithServerSideKmsKeyId(ServerSideKmsKeyIdT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  ImportDatasetRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  ImportDatasetRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
