...
class ListLabelsRequest : public LookoutEquipmentRequest {
 public:
  ...
  void SetIntervalStartTime(IntervalStartTimeT&& value) {
    m_intervalStartTimeHasBeenSet = true;
    m_intervalStartTime = std::forward<IntervalStartTimeT>(value);
  }
  template <typename IntervalStartTimeT = Aws::Utils::DateTime>
  ListLabelsRequest& WithIntervalStartTime(IntervalStartTimeT&& value) {
    SetIntervalStartTime(std::forward<IntervalStartTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIntervalEndTime(IntervalEndTimeT&& value) {
    m_intervalEndTimeHasBeenSet = true;
    m_intervalEndTime = std::forward<IntervalEndTimeT>(value);
  }
  template <typename IntervalEndTimeT = Aws::Utils::DateTime>
  ListLabelsRequest& WithIntervalEndTime(IntervalEndTimeT&& value) {
    SetIntervalEndTime(std::forward<IntervalEndTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFaultCode(FaultCodeT&& value) {
    ...
    m_faultCode = std::forward<FaultCodeT>(value);
  }
  template <typename FaultCodeT = Aws::String>
  ListLabelsRequest& WithFaultCode(FaultCodeT&& value) {
    SetFaultCode(std::forward<FaultCodeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEquipment(EquipmentT&& value) {
    ...
    m_equipment = std::forward<EquipmentT>(value);
  }
  template <typename EquipmentT = Aws::String>
  ListLabelsRequest& WithEquipment(EquipmentT&& value) {
    SetEquipment(std::forward<EquipmentT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListLabelsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
