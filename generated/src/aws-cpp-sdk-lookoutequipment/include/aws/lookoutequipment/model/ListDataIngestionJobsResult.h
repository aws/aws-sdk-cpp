...
class ListDataIngestionJobsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListDataIngestionJobsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetDataIngestionJobSummaries(DataIngestionJobSummariesT&& value) {
    m_dataIngestionJobSummariesHasBeenSet = true;
    m_dataIngestionJobSummaries = std::forward<DataIngestionJobSummariesT>(value);
  }
  template <typename DataIngestionJobSummariesT = Aws::Vector<DataIngestionJobSummary>>
  ListDataIngestionJobsResult& WithDataIngestionJobSummaries(DataIngestionJobSummariesT&& value) {
    SetDataIngestionJobSummaries(std::forward<DataIngestionJobSummariesT>(value));
    return *this;
  }
  template <typename DataIngestionJobSummariesT = DataIngestionJobSummary>
  ListDataIngestionJobsResult& AddDataIngestionJobSummaries(DataIngestionJobSummariesT&& value) {
    m_dataIngestionJobSummariesHasBeenSet = true;
    m_dataIngestionJobSummaries.emplace_back(std::forward<DataIngestionJobSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListDataIngestionJobsResult& WithRequestId(RequestIdT&& value) {
