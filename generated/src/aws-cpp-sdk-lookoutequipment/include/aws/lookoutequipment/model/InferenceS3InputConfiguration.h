...
class InferenceS3InputConfiguration {
 public:
  AWS_LOOKOUTEQUIPMENT_API InferenceS3InputConfiguration() = default;
  ...
  template <typename BucketT = Aws::String>
  InferenceS3InputConfiguration& WithBucket(BucketT&& value) {
  ...
  template <typename PrefixT = Aws::String>
  InferenceS3InputConfiguration& WithPrefix(PrefixT&& value) {
