...
namespace LookoutEquipment
{
   ...
   */
  class AWS_LOOKOUTEQUIPMENT_API LookoutEquipmentClient : Aws::Client::ClientWithAsyncTemplateMethods<LookoutEquipmentClient>,
    smithy::client::AwsSmithyClientT<Aws::LookoutEquipment::SERVICE_NAME,
