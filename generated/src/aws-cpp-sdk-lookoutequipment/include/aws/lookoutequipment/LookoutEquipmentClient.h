...
class AWS_LOOKOUTEQUIPMENT_API LookoutEquipmentClient : public Aws::Client::AWSJsonClient,
 ...
 public:
  ...
  LookoutEquipmentClient(const Aws::Auth::AWSCredentials& credentials,
                         std::shared_ptr<LookoutEquipmentEndpointProviderBase> endpointProvider = nullptr,
                         const Aws::LookoutEquipment::LookoutEquipmentClientConfiguration& clientConfiguration =
                             Aws::LookoutEquipment::LookoutEquipmentClientConfiguration());
  ...
  /**
   * A Callable wrapper for CreateInferenceScheduler that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateInferenceScheduler that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateInferenceSchedulerRequestT = Model::CreateInferenceSchedulerRequest>
  void CreateInferenceSchedulerAsync(const CreateInferenceSchedulerRequestT& request,
                                     const CreateInferenceSchedulerResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateLabel that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateLabelRequestT = Model::CreateLabelRequest>
  void CreateLabelAsync(const CreateLabelRequestT& request, const CreateLabelResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateLabelGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateLabelGroup that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateLabelGroupRequestT = Model::CreateLabelGroupRequest>
  void CreateLabelGroupAsync(const CreateLabelGroupRequestT& request, const CreateLabelGroupResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateRetrainingScheduler that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CreateRetrainingSchedulerRequestT = Model::CreateRetrainingSchedulerRequest>
  Model::CreateRetrainingSchedulerOutcomeCallable CreateRetrainingSchedulerCallable(
      const CreateRetrainingSchedulerRequestT& request) const {
    return SubmitCallable(&LookoutEquipmentClient::CreateRetrainingScheduler, request);
  }

  /**
   * An Async wrapper for CreateRetrainingScheduler that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateRetrainingSchedulerRequestT = Model::CreateRetrainingSchedulerRequest>
  void CreateRetrainingSchedulerAsync(const CreateRetrainingSchedulerRequestT& request,
                                      const CreateRetrainingSchedulerResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteInferenceScheduler that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteInferenceScheduler that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteInferenceSchedulerRequestT = Model::DeleteInferenceSchedulerRequest>
  void DeleteInferenceSchedulerAsync(const DeleteInferenceSchedulerRequestT& request,
                                     const DeleteInferenceSchedulerResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteLabel that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteLabelRequestT = Model::DeleteLabelRequest>
  void DeleteLabelAsync(const DeleteLabelRequestT& request, const DeleteLabelResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteLabelGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteLabelGroup that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteLabelGroupRequestT = Model::DeleteLabelGroupRequest>
  void DeleteLabelGroupAsync(const DeleteLabelGroupRequestT& request, const DeleteLabelGroupResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteRetrainingScheduler that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DeleteRetrainingSchedulerRequestT = Model::DeleteRetrainingSchedulerRequest>
  Model::DeleteRetrainingSchedulerOutcomeCallable DeleteRetrainingSchedulerCallable(
      const DeleteRetrainingSchedulerRequestT& request) const {
    return SubmitCallable(&LookoutEquipmentClient::DeleteRetrainingScheduler, request);
  }

  /**
   * An Async wrapper for DeleteRetrainingScheduler that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteRetrainingSchedulerRequestT = Model::DeleteRetrainingSchedulerRequest>
  void DeleteRetrainingSchedulerAsync(const DeleteRetrainingSchedulerRequestT& request,
                                      const DeleteRetrainingSchedulerResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeDataIngestionJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeDataIngestionJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeDataIngestionJobRequestT = Model::DescribeDataIngestionJobRequest>
  void DescribeDataIngestionJobAsync(const DescribeDataIngestionJobRequestT& request,
                                     const DescribeDataIngestionJobResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeInferenceSchedulerOutcome DescribeInferenceScheduler(
      const Model::DescribeInferenceSchedulerRequest& request) const;

  /**
   * A Callable wrapper for DescribeInferenceScheduler that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeInferenceSchedulerRequestT = Model::DescribeInferenceSchedulerRequest>
  Model::DescribeInferenceSchedulerOutcomeCallable DescribeInferenceSchedulerCallable(
      const DescribeInferenceSchedulerRequestT& request) const {
    return SubmitCallable(&LookoutEquipmentClient::DescribeInferenceScheduler, request);
  }

  /**
   * An Async wrapper for DescribeInferenceScheduler that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeInferenceSchedulerRequestT = Model::DescribeInferenceSchedulerRequest>
  void DescribeInferenceSchedulerAsync(const DescribeInferenceSchedulerRequestT& request,
                                       const DescribeInferenceSchedulerResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeLabel that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeLabelRequestT = Model::DescribeLabelRequest>
  void DescribeLabelAsync(const DescribeLabelRequestT& request, const DescribeLabelResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeLabelGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeLabelGroup that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeLabelGroupRequestT = Model::DescribeLabelGroupRequest>
  void DescribeLabelGroupAsync(const DescribeLabelGroupRequestT& request, const DescribeLabelGroupResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeModelVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeModelVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeModelVersionRequestT = Model::DescribeModelVersionRequest>
  void DescribeModelVersionAsync(const DescribeModelVersionRequestT& request, const DescribeModelVersionResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeRetrainingSchedulerOutcome DescribeRetrainingScheduler(
      const Model::DescribeRetrainingSchedulerRequest& request) const;

  /**
   * A Callable wrapper for DescribeRetrainingScheduler that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeRetrainingSchedulerRequestT = Model::DescribeRetrainingSchedulerRequest>
  Model::DescribeRetrainingSchedulerOutcomeCallable DescribeRetrainingSchedulerCallable(
      const DescribeRetrainingSchedulerRequestT& request) const {
    return SubmitCallable(&LookoutEquipmentClient::DescribeRetrainingScheduler, request);
  }

  /**
   * An Async wrapper for DescribeRetrainingScheduler that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeRetrainingSchedulerRequestT = Model::DescribeRetrainingSchedulerRequest>
  void DescribeRetrainingSchedulerAsync(const DescribeRetrainingSchedulerRequestT& request,
                                        const DescribeRetrainingSchedulerResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ImportDataset that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ImportDatasetRequestT = Model::ImportDatasetRequest>
  void ImportDatasetAsync(const ImportDatasetRequestT& request, const ImportDatasetResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ImportModelVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ImportModelVersion that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ImportModelVersionRequestT = Model::ImportModelVersionRequest>
  void ImportModelVersionAsync(const ImportModelVersionRequestT& request, const ImportModelVersionResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListDataIngestionJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListDataIngestionJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListDataIngestionJobsRequestT = Model::ListDataIngestionJobsRequest>
  void ListDataIngestionJobsAsync(const ListDataIngestionJobsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const ListDataIngestionJobsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListInferenceEvents that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListInferenceEvents that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListInferenceEventsRequestT = Model::ListInferenceEventsRequest>
  void ListInferenceEventsAsync(const ListInferenceEventsRequestT& request, const ListInferenceEventsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListInferenceExecutions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListInferenceExecutions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListInferenceExecutionsRequestT = Model::ListInferenceExecutionsRequest>
  void ListInferenceExecutionsAsync(const ListInferenceExecutionsRequestT& request,
                                    const ListInferenceExecutionsResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListInferenceSchedulers that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListInferenceSchedulers that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListInferenceSchedulersRequestT = Model::ListInferenceSchedulersRequest>
  void ListInferenceSchedulersAsync(const ListInferenceSchedulersResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const ListInferenceSchedulersRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListLabelGroups that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListLabelGroupsRequestT = Model::ListLabelGroupsRequest>
  void ListLabelGroupsAsync(const ListLabelGroupsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const ListLabelGroupsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListLabels that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListLabelsRequestT = Model::ListLabelsRequest>
  void ListLabelsAsync(const ListLabelsRequestT& request, const ListLabelsResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListModelVersions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListModelVersions that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListModelVersionsRequestT = Model::ListModelVersionsRequest>
  void ListModelVersionsAsync(const ListModelVersionsRequestT& request, const ListModelVersionsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListRetrainingSchedulers that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListRetrainingSchedulersRequestT = Model::ListRetrainingSchedulersRequest>
  Model::ListRetrainingSchedulersOutcomeCallable ListRetrainingSchedulersCallable(
      const ListRetrainingSchedulersRequestT& request = {}) const {
    return SubmitCallable(&LookoutEquipmentClient::ListRetrainingSchedulers, request);
  }

  /**
   * An Async wrapper for ListRetrainingSchedulers that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListRetrainingSchedulersRequestT = Model::ListRetrainingSchedulersRequest>
  void ListRetrainingSchedulersAsync(const ListRetrainingSchedulersResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const ListRetrainingSchedulersRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListSensorStatistics that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListSensorStatistics that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListSensorStatisticsRequestT = Model::ListSensorStatisticsRequest>
  void ListSensorStatisticsAsync(const ListSensorStatisticsRequestT& request, const ListSensorStatisticsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartDataIngestionJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartDataIngestionJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartDataIngestionJobRequestT = Model::StartDataIngestionJobRequest>
  void StartDataIngestionJobAsync(const StartDataIngestionJobRequestT& request, const StartDataIngestionJobResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartInferenceScheduler that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartInferenceScheduler that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartInferenceSchedulerRequestT = Model::StartInferenceSchedulerRequest>
  void StartInferenceSchedulerAsync(const StartInferenceSchedulerRequestT& request,
                                    const StartInferenceSchedulerResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartRetrainingScheduler that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartRetrainingScheduler that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartRetrainingSchedulerRequestT = Model::StartRetrainingSchedulerRequest>
  void StartRetrainingSchedulerAsync(const StartRetrainingSchedulerRequestT& request,
                                     const StartRetrainingSchedulerResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StopInferenceScheduler that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopInferenceScheduler that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StopInferenceSchedulerRequestT = Model::StopInferenceSchedulerRequest>
  void StopInferenceSchedulerAsync(const StopInferenceSchedulerRequestT& request,
                                   const StopInferenceSchedulerResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StopRetrainingScheduler that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopRetrainingScheduler that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StopRetrainingSchedulerRequestT = Model::StopRetrainingSchedulerRequest>
  void StopRetrainingSchedulerAsync(const StopRetrainingSchedulerRequestT& request,
                                    const StopRetrainingSchedulerResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateActiveModelVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateActiveModelVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateActiveModelVersionRequestT = Model::UpdateActiveModelVersionRequest>
  void UpdateActiveModelVersionAsync(const UpdateActiveModelVersionRequestT& request,
                                     const UpdateActiveModelVersionResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateInferenceScheduler that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateInferenceScheduler that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateInferenceSchedulerRequestT = Model::UpdateInferenceSchedulerRequest>
  void UpdateInferenceSchedulerAsync(const UpdateInferenceSchedulerRequestT& request,
                                     const UpdateInferenceSchedulerResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateLabelGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateLabelGroup that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateLabelGroupRequestT = Model::UpdateLabelGroupRequest>
  void UpdateLabelGroupAsync(const UpdateLabelGroupRequestT& request, const UpdateLabelGroupResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateModel that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateModelRequestT = Model::UpdateModelRequest>
  ...
  /**
   * A Callable wrapper for UpdateRetrainingScheduler that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename UpdateRetrainingSchedulerRequestT = Model::UpdateRetrainingSchedulerRequest>
  Model::UpdateRetrainingSchedulerOutcomeCallable UpdateRetrainingSchedulerCallable(
      const UpdateRetrainingSchedulerRequestT& request) const {
    return SubmitCallable(&LookoutEquipmentClient::UpdateRetrainingScheduler, request);
  }

  /**
   * An Async wrapper for UpdateRetrainingScheduler that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateRetrainingSchedulerRequestT = Model::UpdateRetrainingSchedulerRequest>
  void UpdateRetrainingSchedulerAsync(const UpdateRetrainingSchedulerRequestT& request,
                                      const UpdateRetrainingSchedulerResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
