...
#ifdef AWS_LOOKOUTEQUIPMENT_EXPORTS
#define AWS_LOOKOUTEQUIPMENT_API __declspec(dllexport)
#else
...
#define AWS_LOOKOUTEQUIPMENT_LOCAL
#else  // defined (USE_WINDOWS_DLL_SEMANTICS) || defined (WIN32)
#define AWS_LOOKOUTEQUIPMENT_API
#define AWS_LOOKOUTEQUIPMENT_EXTERN extern
#if __GNUC__ >= 4
#define AWS_LOOKOUTEQUIPMENT_LOCAL __attribute__((visibility("hidden")))
#else
#define AWS_LOOKOUTEQUIPMENT_LOCAL
#endif
