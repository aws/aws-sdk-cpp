...
ListInferenceEventsResult::ListInferenceEventsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListInferenceEventsResult& ListInferenceEventsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("InferenceEventSummaries")) {
    ...
    for (unsigned inferenceEventSummariesIndex = 0; inferenceEventSummariesIndex < inferenceEventSummariesJsonList.GetLength();
         ++inferenceEventSummariesIndex) {
