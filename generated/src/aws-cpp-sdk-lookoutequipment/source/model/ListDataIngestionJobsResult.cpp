...
ListDataIngestionJobsResult::ListDataIngestionJobsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListDataIngestionJobsResult& ListDataIngestionJobsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("DataIngestionJobSummaries")) {
    ...
    for (unsigned dataIngestionJobSummariesIndex = 0; dataIngestionJobSummariesIndex < dataIngestionJobSummariesJsonList.GetLength();
         ++dataIngestionJobSummariesIndex) {
