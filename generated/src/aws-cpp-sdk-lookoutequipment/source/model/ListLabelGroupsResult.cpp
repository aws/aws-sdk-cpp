...
ListLabelGroupsResult::ListLabelGroupsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListLabelGroupsResult& ListLabelGroupsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("LabelGroupSummaries")) {
    ...
    for (unsigned labelGroupSummariesIndex = 0; labelGroupSummariesIndex < labelGroupSummariesJsonList.GetLength();
         ++labelGroupSummariesIndex) {
