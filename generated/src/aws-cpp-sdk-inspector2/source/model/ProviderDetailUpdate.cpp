...
ProviderDetailUpdate::ProviderDetailUpdate(JsonView jsonValue) { *this = jsonValue; }

ProviderDetailUpdate& ProviderDetailUpdate::operator=(JsonView jsonValue) {
...
JsonValue ProviderDetailUpdate::Jsonize() const {
  JsonValue payload;
