...
ProjectCodeSecurityScanConfiguration::ProjectCodeSecurityScanConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
ProjectCodeSecurityScanConfiguration& ProjectCodeSecurityScanConfiguration::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("periodicScanConfigurations")) {
    ...
    for (unsigned periodicScanConfigurationsIndex = 0; periodicScanConfigurationsIndex < periodicScanConfigurationsJsonList.GetLength();
         ++periodicScanConfigurationsIndex) {
  ...
  if (jsonValue.ValueExists("continuousIntegrationScanConfigurations")) {
    Aws::Utils::Array<JsonView> continuousIntegrationScanConfigurationsJsonList =
        jsonValue.GetArray("continuousIntegrationScanConfigurations");
    for (unsigned continuousIntegrationScanConfigurationsIndex = 0;
         continuousIntegrationScanConfigurationsIndex < continuousIntegrationScanConfigurationsJsonList.GetLength();
         ++continuousIntegrationScanConfigurationsIndex) {
      m_continuousIntegrationScanConfigurations.push_back(
          continuousIntegrationScanConfigurationsJsonList[continuousIntegrationScanConfigurationsIndex].AsObject());
    }
...
JsonValue ProjectCodeSecurityScanConfiguration::Jsonize() const {
  ...
  if (m_periodicScanConfigurationsHasBeenSet) {
    ...
    for (unsigned periodicScanConfigurationsIndex = 0; periodicScanConfigurationsIndex < periodicScanConfigurationsJsonList.GetLength();
         ++periodicScanConfigurationsIndex) {
      periodicScanConfigurationsJsonList[periodicScanConfigurationsIndex].AsObject(
          m_periodicScanConfigurations[periodicScanConfigurationsIndex].Jsonize());
    }
  ...
  if (m_continuousIntegrationScanConfigurationsHasBeenSet) {
    ...
    for (unsigned continuousIntegrationScanConfigurationsIndex = 0;
         ...
         ++continuousIntegrationScanConfigurationsIndex) {
      continuousIntegrationScanConfigurationsJsonList[continuousIntegrationScanConfigurationsIndex].AsObject(
          m_continuousIntegrationScanConfigurations[continuousIntegrationScanConfigurationsIndex].Jsonize());
    }
