...
ListCisScansFilterCriteria::ListCisScansFilterCriteria(JsonView jsonValue) { *this = jsonValue; }
...
ListCisScansFilterCriteria& ListCisScansFilterCriteria::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("targetResourceIdFilters")) {
    ...
    for (unsigned targetResourceIdFiltersIndex = 0; targetResourceIdFiltersIndex < targetResourceIdFiltersJsonList.GetLength();
         ++targetResourceIdFiltersIndex) {
  ...
  if (jsonValue.ValueExists("scheduledByFilters")) {
    ...
    for (unsigned scheduledByFiltersIndex = 0; scheduledByFiltersIndex < scheduledByFiltersJsonList.GetLength();
         ++scheduledByFiltersIndex) {
  ...
  if (jsonValue.ValueExists("failedChecksFilters")) {
    ...
    for (unsigned failedChecksFiltersIndex = 0; failedChecksFiltersIndex < failedChecksFiltersJsonList.GetLength();
         ++failedChecksFiltersIndex) {
  ...
  if (jsonValue.ValueExists("targetAccountIdFilters")) {
    ...
    for (unsigned targetAccountIdFiltersIndex = 0; targetAccountIdFiltersIndex < targetAccountIdFiltersJsonList.GetLength();
         ++targetAccountIdFiltersIndex) {
...
JsonValue ListCisScansFilterCriteria::Jsonize() const {
  ...
  if (m_targetResourceIdFiltersHasBeenSet) {
    ...
    for (unsigned targetResourceIdFiltersIndex = 0; targetResourceIdFiltersIndex < targetResourceIdFiltersJsonList.GetLength();
         ++targetResourceIdFiltersIndex) {
      targetResourceIdFiltersJsonList[targetResourceIdFiltersIndex].AsObject(
          m_targetResourceIdFilters[targetResourceIdFiltersIndex].Jsonize());
    }
