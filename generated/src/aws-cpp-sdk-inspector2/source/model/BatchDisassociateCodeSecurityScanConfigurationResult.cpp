...
BatchDisassociateCodeSecurityScanConfigurationResult::BatchDisassociateCodeSecurityScanConfigurationResult(
    const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

BatchDisassociateCodeSecurityScanConfigurationResult& BatchDisassociateCodeSecurityScanConfigurationResult::operator=(
    const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("successfulAssociations")) {
    ...
    for (unsigned successfulAssociationsIndex = 0; successfulAssociationsIndex < successfulAssociationsJsonList.GetLength();
         ++successfulAssociationsIndex) {
