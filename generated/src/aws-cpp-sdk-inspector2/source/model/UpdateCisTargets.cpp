...
UpdateCisTargets::UpdateCisTargets() : 
    m_accountIdsHasBeenSet(false),
    m_targetResourceTagsHasBeenSet(false)
{
}

UpdateCisTargets::UpdateCisTargets(JsonView jsonValue) : 
    m_accountIdsHasBeenSet(false),
    m_targetResourceTagsHasBeenSet(false)
{
  *this = jsonValue;
...
UpdateCisTargets& UpdateCisTargets::operator =(JsonView jsonValue)
{
...
JsonValue UpdateCisTargets::Jsonize() const
{
  JsonValue payload;
