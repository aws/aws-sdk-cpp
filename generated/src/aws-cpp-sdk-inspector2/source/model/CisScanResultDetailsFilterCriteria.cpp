...
CisScanResultDetailsFilterCriteria::CisScanResultDetailsFilterCriteria(JsonView jsonValue) { *this = jsonValue; }
...
CisScanResultDetailsFilterCriteria& CisScanResultDetailsFilterCriteria::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("findingStatusFilters")) {
    ...
    for (unsigned findingStatusFiltersIndex = 0; findingStatusFiltersIndex < findingStatusFiltersJsonList.GetLength();
         ++findingStatusFiltersIndex) {
