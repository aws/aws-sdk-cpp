...
ListCisScanConfigurationsFilterCriteria::ListCisScanConfigurationsFilterCriteria(JsonView jsonValue) { *this = jsonValue; }
...
ListCisScanConfigurationsFilterCriteria& ListCisScanConfigurationsFilterCriteria::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("targetResourceTagFilters")) {
    ...
    for (unsigned targetResourceTagFiltersIndex = 0; targetResourceTagFiltersIndex < targetResourceTagFiltersJsonList.GetLength();
         ++targetResourceTagFiltersIndex) {
  ...
  if (jsonValue.ValueExists("scanConfigurationArnFilters")) {
    ...
    for (unsigned scanConfigurationArnFiltersIndex = 0; scanConfigurationArnFiltersIndex < scanConfigurationArnFiltersJsonList.GetLength();
         ++scanConfigurationArnFiltersIndex) {
...
JsonValue ListCisScanConfigurationsFilterCriteria::Jsonize() const {
  ...
  if (m_targetResourceTagFiltersHasBeenSet) {
    ...
    for (unsigned targetResourceTagFiltersIndex = 0; targetResourceTagFiltersIndex < targetResourceTagFiltersJsonList.GetLength();
         ++targetResourceTagFiltersIndex) {
      targetResourceTagFiltersJsonList[targetResourceTagFiltersIndex].AsObject(
          m_targetResourceTagFilters[targetResourceTagFiltersIndex].Jsonize());
    }
  ...
  if (m_scanConfigurationArnFiltersHasBeenSet) {
    ...
    for (unsigned scanConfigurationArnFiltersIndex = 0; scanConfigurationArnFiltersIndex < scanConfigurationArnFiltersJsonList.GetLength();
         ++scanConfigurationArnFiltersIndex) {
      scanConfigurationArnFiltersJsonList[scanConfigurationArnFiltersIndex].AsObject(
          m_scanConfigurationArnFilters[scanConfigurationArnFiltersIndex].Jsonize());
    }
