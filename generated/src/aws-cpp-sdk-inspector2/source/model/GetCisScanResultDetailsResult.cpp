...
GetCisScanResultDetailsResult::GetCisScanResultDetailsResult()
{
}

GetCisScanResultDetailsResult::GetCisScanResultDetailsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
...
GetCisScanResultDetailsResult& GetCisScanResultDetailsResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  ...
  if(jsonValue.ValueExists("scanResultDetails"))
  {
    ...
    for(unsigned scanResultDetailsIndex = 0; scanResultDetailsIndex < scanResultDetailsJsonList.GetLength(); ++scanResultDetailsIndex)
    {
