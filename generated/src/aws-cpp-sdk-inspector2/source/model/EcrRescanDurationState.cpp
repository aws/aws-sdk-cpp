...
EcrRescanDurationState::EcrRescanDurationState(JsonView jsonValue) { *this = jsonValue; }
...
EcrRescanDurationState& EcrRescanDurationState::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("pullDateRescanDuration")) {
    m_pullDateRescanDuration =
        EcrPullDateRescanDurationMapper::GetEcrPullDateRescanDurationForName(jsonValue.GetString("pullDateRescanDuration"));
...
JsonValue EcrRescanDurationState::Jsonize() const {
  ...
  if (m_pullDateRescanDurationHasBeenSet) {
    payload.WithString("pullDateRescanDuration",
                       EcrPullDateRescanDurationMapper::GetNameForEcrPullDateRescanDuration(m_pullDateRescanDuration));
  }
