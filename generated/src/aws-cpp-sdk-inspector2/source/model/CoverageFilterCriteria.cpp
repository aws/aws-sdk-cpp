...
CoverageFilterCriteria::CoverageFilterCriteria(JsonView jsonValue) { *this = jsonValue; }
...
CoverageFilterCriteria& CoverageFilterCriteria::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("codeRepositoryProviderTypeVisibility")) {
    ...
    for (unsigned codeRepositoryProviderTypeVisibilityIndex = 0;
         codeRepositoryProviderTypeVisibilityIndex < codeRepositoryProviderTypeVisibilityJsonList.GetLength();
         ++codeRepositoryProviderTypeVisibilityIndex) {
      m_codeRepositoryProviderTypeVisibility.push_back(
          codeRepositoryProviderTypeVisibilityJsonList[codeRepositoryProviderTypeVisibilityIndex].AsObject());
    }
  ...
  if (jsonValue.ValueExists("lastScannedCommitId")) {
    ...
    for (unsigned lastScannedCommitIdIndex = 0; lastScannedCommitIdIndex < lastScannedCommitIdJsonList.GetLength();
         ++lastScannedCommitIdIndex) {
...
JsonValue CoverageFilterCriteria::Jsonize() const {
  ...
  if (m_codeRepositoryProviderTypeVisibilityHasBeenSet) {
    ...
    for (unsigned codeRepositoryProviderTypeVisibilityIndex = 0;
         ...
         ++codeRepositoryProviderTypeVisibilityIndex) {
      codeRepositoryProviderTypeVisibilityJsonList[codeRepositoryProviderTypeVisibilityIndex].AsObject(
          m_codeRepositoryProviderTypeVisibility[codeRepositoryProviderTypeVisibilityIndex].Jsonize());
    }
