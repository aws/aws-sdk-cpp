...
ListCodeSecurityScanConfigurationAssociationsResult::ListCodeSecurityScanConfigurationAssociationsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListCodeSecurityScanConfigurationAssociationsResult& ListCodeSecurityScanConfigurationAssociationsResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
