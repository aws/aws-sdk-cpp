...
CisScanResultsAggregatedByTargetResourceFilterCriteria& CisScanResultsAggregatedByTargetResourceFilterCriteria::operator=(
    JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("targetStatusFilters")) {
    ...
    for (unsigned targetStatusFiltersIndex = 0; targetStatusFiltersIndex < targetStatusFiltersJsonList.GetLength();
         ++targetStatusFiltersIndex) {
  ...
  if (jsonValue.ValueExists("targetStatusReasonFilters")) {
    ...
    for (unsigned targetStatusReasonFiltersIndex = 0; targetStatusReasonFiltersIndex < targetStatusReasonFiltersJsonList.GetLength();
         ++targetStatusReasonFiltersIndex) {
...
JsonValue CisScanResultsAggregatedByTargetResourceFilterCriteria::Jsonize() const {
  ...
  if (m_targetStatusReasonFiltersHasBeenSet) {
    ...
    for (unsigned targetStatusReasonFiltersIndex = 0; targetStatusReasonFiltersIndex < targetStatusReasonFiltersJsonList.GetLength();
         ++targetStatusReasonFiltersIndex) {
      targetStatusReasonFiltersJsonList[targetStatusReasonFiltersIndex].AsObject(
          m_targetStatusReasonFilters[targetStatusReasonFiltersIndex].Jsonize());
    }
