...
DeleteCisScanConfigurationResult::DeleteCisScanConfigurationResult()
{
}

DeleteCisScanConfigurationResult::DeleteCisScanConfigurationResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
