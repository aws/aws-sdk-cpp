...
CreateCisTargets::CreateCisTargets(JsonView jsonValue) { *this = jsonValue; }

CreateCisTargets& CreateCisTargets::operator=(JsonView jsonValue) {
...
JsonValue CreateCisTargets::Jsonize() const {
  JsonValue payload;
