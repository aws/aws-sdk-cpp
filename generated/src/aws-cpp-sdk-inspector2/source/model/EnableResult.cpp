...
EnableResult::EnableResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

EnableResult& EnableResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
