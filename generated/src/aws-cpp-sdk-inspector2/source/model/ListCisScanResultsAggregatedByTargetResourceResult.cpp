...
ListCisScanResultsAggregatedByTargetResourceResult& ListCisScanResultsAggregatedByTargetResourceResult::operator=(
    const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("targetResourceAggregations")) {
    ...
    for (unsigned targetResourceAggregationsIndex = 0; targetResourceAggregationsIndex < targetResourceAggregationsJsonList.GetLength();
         ++targetResourceAggregationsIndex) {
