...
BatchAssociateCodeSecurityScanConfigurationResult::BatchAssociateCodeSecurityScanConfigurationResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

BatchAssociateCodeSecurityScanConfigurationResult& BatchAssociateCodeSecurityScanConfigurationResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
