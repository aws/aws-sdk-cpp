...
ProjectContinuousIntegrationScanConfiguration::ProjectContinuousIntegrationScanConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
ProjectContinuousIntegrationScanConfiguration& ProjectContinuousIntegrationScanConfiguration::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("supportedEvent")) {
    m_supportedEvent =
        ContinuousIntegrationScanEventMapper::GetContinuousIntegrationScanEventForName(jsonValue.GetString("supportedEvent"));
