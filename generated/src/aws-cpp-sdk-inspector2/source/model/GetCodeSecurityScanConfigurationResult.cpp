...
GetCodeSecurityScanConfigurationResult::GetCodeSecurityScanConfigurationResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

GetCodeSecurityScanConfigurationResult& GetCodeSecurityScanConfigurationResult::operator=(
