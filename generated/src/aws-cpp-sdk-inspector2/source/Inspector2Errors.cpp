...
template <>
AWS_INSPECTOR2_API ConflictException Inspector2Error::GetModeledError() {
  assert(this->GetErrorType() == Inspector2Errors::CONFLICT);
  return ConflictException(this->GetJsonPayload().View());
}

template <>
AWS_INSPECTOR2_API ServiceQuotaExceededException Inspector2Error::GetModeledError() {
  assert(this->GetErrorType() == Inspector2Errors::SERVICE_QUOTA_EXCEEDED);
  return ServiceQuotaExceededException(this->GetJsonPayload().View());
}

template <>
AWS_INSPECTOR2_API ThrottlingException Inspector2Error::GetModeledError() {
  assert(this->GetErrorType() == Inspector2Errors::THROTTLING);
  return ThrottlingException(this->GetJsonPayload().View());
}

template <>
AWS_INSPECTOR2_API InternalServerException Inspector2Error::GetModeledError() {
  assert(this->GetErrorType() == Inspector2Errors::INTERNAL_SERVER);
  return InternalServerException(this->GetJsonPayload().View());
}

template <>
AWS_INSPECTOR2_API ValidationException Inspector2Error::GetModeledError() {
