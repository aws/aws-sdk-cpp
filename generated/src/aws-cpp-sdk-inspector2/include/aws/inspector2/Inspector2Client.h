...
class AWS_INSPECTOR2_API Inspector2Client : public Aws::Client::AWSJsonClient,
                                            ...
                                            public Inspector2Waiter<Inspector2Client> {
 public:
   ...
   */
  Inspector2Client(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<Inspector2EndpointProviderBase> endpointProvider = nullptr,
      const Aws::Inspector2::Inspector2ClientConfiguration& clientConfiguration = Aws::Inspector2::Inspector2ClientConfiguration());
  ...
  /**
   * An Async wrapper for AssociateMember that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename AssociateMemberRequestT = Model::AssociateMemberRequest>
  void AssociateMemberAsync(const AssociateMemberRequestT& request, const AssociateMemberResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchAssociateCodeSecurityScanConfigurationOutcome BatchAssociateCodeSecurityScanConfiguration(
      const Model::BatchAssociateCodeSecurityScanConfigurationRequest& request) const;

  /**
   * A Callable wrapper for BatchAssociateCodeSecurityScanConfiguration that returns a future to the operation so that it can be executed in
  ...
  Model::BatchAssociateCodeSecurityScanConfigurationOutcomeCallable BatchAssociateCodeSecurityScanConfigurationCallable(
      const BatchAssociateCodeSecurityScanConfigurationRequestT& request) const {
    return SubmitCallable(&Inspector2Client::BatchAssociateCodeSecurityScanConfiguration, request);
  }

  /**
   * An Async wrapper for BatchAssociateCodeSecurityScanConfiguration that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename BatchAssociateCodeSecurityScanConfigurationRequestT = Model::BatchAssociateCodeSecurityScanConfigurationRequest>
  void BatchAssociateCodeSecurityScanConfigurationAsync(
      const BatchAssociateCodeSecurityScanConfigurationRequestT& request,
      const BatchAssociateCodeSecurityScanConfigurationResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchDisassociateCodeSecurityScanConfigurationOutcome BatchDisassociateCodeSecurityScanConfiguration(
      const Model::BatchDisassociateCodeSecurityScanConfigurationRequest& request) const;

  /**
   * A Callable wrapper for BatchDisassociateCodeSecurityScanConfiguration that returns a future to the operation so that it can be executed
  ...
  Model::BatchDisassociateCodeSecurityScanConfigurationOutcomeCallable BatchDisassociateCodeSecurityScanConfigurationCallable(
      const BatchDisassociateCodeSecurityScanConfigurationRequestT& request) const {
    return SubmitCallable(&Inspector2Client::BatchDisassociateCodeSecurityScanConfiguration, request);
  }

  /**
   * An Async wrapper for BatchDisassociateCodeSecurityScanConfiguration that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename BatchDisassociateCodeSecurityScanConfigurationRequestT = Model::BatchDisassociateCodeSecurityScanConfigurationRequest>
  void BatchDisassociateCodeSecurityScanConfigurationAsync(
      const BatchDisassociateCodeSecurityScanConfigurationRequestT& request,
      const BatchDisassociateCodeSecurityScanConfigurationResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchGetAccountStatus that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchGetAccountStatus that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchGetAccountStatusRequestT = Model::BatchGetAccountStatusRequest>
  void BatchGetAccountStatusAsync(const BatchGetAccountStatusResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const BatchGetAccountStatusRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for BatchGetCodeSnippet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchGetCodeSnippet that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename BatchGetCodeSnippetRequestT = Model::BatchGetCodeSnippetRequest>
  void BatchGetCodeSnippetAsync(const BatchGetCodeSnippetRequestT& request, const BatchGetCodeSnippetResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchGetFindingDetails that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchGetFindingDetails that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchGetFindingDetailsRequestT = Model::BatchGetFindingDetailsRequest>
  void BatchGetFindingDetailsAsync(const BatchGetFindingDetailsRequestT& request,
                                   const BatchGetFindingDetailsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchGetFreeTrialInfo that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchGetFreeTrialInfo that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchGetFreeTrialInfoRequestT = Model::BatchGetFreeTrialInfoRequest>
  void BatchGetFreeTrialInfoAsync(const BatchGetFreeTrialInfoRequestT& request, const BatchGetFreeTrialInfoResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchGetMemberEc2DeepInspectionStatusOutcome BatchGetMemberEc2DeepInspectionStatus(
      const Model::BatchGetMemberEc2DeepInspectionStatusRequest& request = {}) const;

  /**
   * A Callable wrapper for BatchGetMemberEc2DeepInspectionStatus that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename BatchGetMemberEc2DeepInspectionStatusRequestT = Model::BatchGetMemberEc2DeepInspectionStatusRequest>
  Model::BatchGetMemberEc2DeepInspectionStatusOutcomeCallable BatchGetMemberEc2DeepInspectionStatusCallable(
      const BatchGetMemberEc2DeepInspectionStatusRequestT& request = {}) const {
    return SubmitCallable(&Inspector2Client::BatchGetMemberEc2DeepInspectionStatus, request);
  }

  /**
   * An Async wrapper for BatchGetMemberEc2DeepInspectionStatus that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename BatchGetMemberEc2DeepInspectionStatusRequestT = Model::BatchGetMemberEc2DeepInspectionStatusRequest>
  void BatchGetMemberEc2DeepInspectionStatusAsync(const BatchGetMemberEc2DeepInspectionStatusResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                  const BatchGetMemberEc2DeepInspectionStatusRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchUpdateMemberEc2DeepInspectionStatusOutcome BatchUpdateMemberEc2DeepInspectionStatus(
      const Model::BatchUpdateMemberEc2DeepInspectionStatusRequest& request) const;

  /**
   * A Callable wrapper for BatchUpdateMemberEc2DeepInspectionStatus that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename BatchUpdateMemberEc2DeepInspectionStatusRequestT = Model::BatchUpdateMemberEc2DeepInspectionStatusRequest>
  Model::BatchUpdateMemberEc2DeepInspectionStatusOutcomeCallable BatchUpdateMemberEc2DeepInspectionStatusCallable(
      const BatchUpdateMemberEc2DeepInspectionStatusRequestT& request) const {
    return SubmitCallable(&Inspector2Client::BatchUpdateMemberEc2DeepInspectionStatus, request);
  }

  /**
   * An Async wrapper for BatchUpdateMemberEc2DeepInspectionStatus that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename BatchUpdateMemberEc2DeepInspectionStatusRequestT = Model::BatchUpdateMemberEc2DeepInspectionStatusRequest>
  void BatchUpdateMemberEc2DeepInspectionStatusAsync(
      const BatchUpdateMemberEc2DeepInspectionStatusRequestT& request,
      const BatchUpdateMemberEc2DeepInspectionStatusResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CancelFindingsReport that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CancelFindingsReport that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CancelFindingsReportRequestT = Model::CancelFindingsReportRequest>
  void CancelFindingsReportAsync(const CancelFindingsReportRequestT& request, const CancelFindingsReportResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CancelSbomExport that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CancelSbomExport that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CancelSbomExportRequestT = Model::CancelSbomExportRequest>
  void CancelSbomExportAsync(const CancelSbomExportRequestT& request, const CancelSbomExportResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateCisScanConfigurationOutcome CreateCisScanConfiguration(
      const Model::CreateCisScanConfigurationRequest& request) const;

  /**
   * A Callable wrapper for CreateCisScanConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateCisScanConfigurationRequestT = Model::CreateCisScanConfigurationRequest>
  Model::CreateCisScanConfigurationOutcomeCallable CreateCisScanConfigurationCallable(
      const CreateCisScanConfigurationRequestT& request) const {
    return SubmitCallable(&Inspector2Client::CreateCisScanConfiguration, request);
  }

  /**
   * An Async wrapper for CreateCisScanConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateCisScanConfigurationRequestT = Model::CreateCisScanConfigurationRequest>
  void CreateCisScanConfigurationAsync(const CreateCisScanConfigurationRequestT& request,
                                       const CreateCisScanConfigurationResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateCodeSecurityIntegrationOutcome CreateCodeSecurityIntegration(
      const Model::CreateCodeSecurityIntegrationRequest& request) const;

  /**
   * A Callable wrapper for CreateCodeSecurityIntegration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateCodeSecurityIntegrationRequestT = Model::CreateCodeSecurityIntegrationRequest>
  Model::CreateCodeSecurityIntegrationOutcomeCallable CreateCodeSecurityIntegrationCallable(
      const CreateCodeSecurityIntegrationRequestT& request) const {
    return SubmitCallable(&Inspector2Client::CreateCodeSecurityIntegration, request);
  }

  /**
   * An Async wrapper for CreateCodeSecurityIntegration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateCodeSecurityIntegrationRequestT = Model::CreateCodeSecurityIntegrationRequest>
  void CreateCodeSecurityIntegrationAsync(const CreateCodeSecurityIntegrationRequestT& request,
                                          const CreateCodeSecurityIntegrationResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateCodeSecurityScanConfigurationOutcome CreateCodeSecurityScanConfiguration(
      const Model::CreateCodeSecurityScanConfigurationRequest& request) const;

  /**
   * A Callable wrapper for CreateCodeSecurityScanConfiguration that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename CreateCodeSecurityScanConfigurationRequestT = Model::CreateCodeSecurityScanConfigurationRequest>
  Model::CreateCodeSecurityScanConfigurationOutcomeCallable CreateCodeSecurityScanConfigurationCallable(
      const CreateCodeSecurityScanConfigurationRequestT& request) const {
    return SubmitCallable(&Inspector2Client::CreateCodeSecurityScanConfiguration, request);
  }

  /**
   * An Async wrapper for CreateCodeSecurityScanConfiguration that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename CreateCodeSecurityScanConfigurationRequestT = Model::CreateCodeSecurityScanConfigurationRequest>
  void CreateCodeSecurityScanConfigurationAsync(const CreateCodeSecurityScanConfigurationRequestT& request,
                                                const CreateCodeSecurityScanConfigurationResponseReceivedHandler& handler,
                                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateFindingsReport that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateFindingsReport that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateFindingsReportRequestT = Model::CreateFindingsReportRequest>
  void CreateFindingsReportAsync(const CreateFindingsReportRequestT& request, const CreateFindingsReportResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateSbomExport that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateSbomExport that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateSbomExportRequestT = Model::CreateSbomExportRequest>
  void CreateSbomExportAsync(const CreateSbomExportRequestT& request, const CreateSbomExportResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteCisScanConfigurationOutcome DeleteCisScanConfiguration(
      const Model::DeleteCisScanConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DeleteCisScanConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteCisScanConfigurationRequestT = Model::DeleteCisScanConfigurationRequest>
  Model::DeleteCisScanConfigurationOutcomeCallable DeleteCisScanConfigurationCallable(
      const DeleteCisScanConfigurationRequestT& request) const {
    return SubmitCallable(&Inspector2Client::DeleteCisScanConfiguration, request);
  }

  /**
   * An Async wrapper for DeleteCisScanConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteCisScanConfigurationRequestT = Model::DeleteCisScanConfigurationRequest>
  void DeleteCisScanConfigurationAsync(const DeleteCisScanConfigurationRequestT& request,
                                       const DeleteCisScanConfigurationResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteCodeSecurityIntegrationOutcome DeleteCodeSecurityIntegration(
      const Model::DeleteCodeSecurityIntegrationRequest& request) const;

  /**
   * A Callable wrapper for DeleteCodeSecurityIntegration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteCodeSecurityIntegrationRequestT = Model::DeleteCodeSecurityIntegrationRequest>
  Model::DeleteCodeSecurityIntegrationOutcomeCallable DeleteCodeSecurityIntegrationCallable(
      const DeleteCodeSecurityIntegrationRequestT& request) const {
    return SubmitCallable(&Inspector2Client::DeleteCodeSecurityIntegration, request);
  }

  /**
   * An Async wrapper for DeleteCodeSecurityIntegration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteCodeSecurityIntegrationRequestT = Model::DeleteCodeSecurityIntegrationRequest>
  void DeleteCodeSecurityIntegrationAsync(const DeleteCodeSecurityIntegrationRequestT& request,
                                          const DeleteCodeSecurityIntegrationResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteCodeSecurityScanConfigurationOutcome DeleteCodeSecurityScanConfiguration(
      const Model::DeleteCodeSecurityScanConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DeleteCodeSecurityScanConfiguration that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DeleteCodeSecurityScanConfigurationRequestT = Model::DeleteCodeSecurityScanConfigurationRequest>
  Model::DeleteCodeSecurityScanConfigurationOutcomeCallable DeleteCodeSecurityScanConfigurationCallable(
      const DeleteCodeSecurityScanConfigurationRequestT& request) const {
    return SubmitCallable(&Inspector2Client::DeleteCodeSecurityScanConfiguration, request);
  }

  /**
   * An Async wrapper for DeleteCodeSecurityScanConfiguration that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DeleteCodeSecurityScanConfigurationRequestT = Model::DeleteCodeSecurityScanConfigurationRequest>
  void DeleteCodeSecurityScanConfigurationAsync(const DeleteCodeSecurityScanConfigurationRequestT& request,
  ...
  /**
   * An Async wrapper for Disable that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DisableRequestT = Model::DisableRequest>
  void DisableAsync(const DisableResponseReceivedHandler& handler,
                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                    const DisableRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisableDelegatedAdminAccountOutcome DisableDelegatedAdminAccount(
      const Model::DisableDelegatedAdminAccountRequest& request) const;

  /**
   * A Callable wrapper for DisableDelegatedAdminAccount that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DisableDelegatedAdminAccountRequestT = Model::DisableDelegatedAdminAccountRequest>
  Model::DisableDelegatedAdminAccountOutcomeCallable DisableDelegatedAdminAccountCallable(
      const DisableDelegatedAdminAccountRequestT& request) const {
    return SubmitCallable(&Inspector2Client::DisableDelegatedAdminAccount, request);
  }

  /**
   * An Async wrapper for DisableDelegatedAdminAccount that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisableDelegatedAdminAccountRequestT = Model::DisableDelegatedAdminAccountRequest>
  void DisableDelegatedAdminAccountAsync(const DisableDelegatedAdminAccountRequestT& request,
                                         const DisableDelegatedAdminAccountResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for Enable that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename EnableRequestT = Model::EnableRequest>
  void EnableAsync(const EnableRequestT& request, const EnableResponseReceivedHandler& handler,
                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::EnableDelegatedAdminAccountOutcome EnableDelegatedAdminAccount(
      const Model::EnableDelegatedAdminAccountRequest& request) const;

  /**
   * A Callable wrapper for EnableDelegatedAdminAccount that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename EnableDelegatedAdminAccountRequestT = Model::EnableDelegatedAdminAccountRequest>
  Model::EnableDelegatedAdminAccountOutcomeCallable EnableDelegatedAdminAccountCallable(
      const EnableDelegatedAdminAccountRequestT& request) const {
    return SubmitCallable(&Inspector2Client::EnableDelegatedAdminAccount, request);
  }

  /**
   * An Async wrapper for EnableDelegatedAdminAccount that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename EnableDelegatedAdminAccountRequestT = Model::EnableDelegatedAdminAccountRequest>
  void EnableDelegatedAdminAccountAsync(const EnableDelegatedAdminAccountRequestT& request,
                                        const EnableDelegatedAdminAccountResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetCisScanReport that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetCisScanReport that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetCisScanReportRequestT = Model::GetCisScanReportRequest>
  void GetCisScanReportAsync(const GetCisScanReportRequestT& request, const GetCisScanReportResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetCisScanResultDetails that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetCisScanResultDetails that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetCisScanResultDetailsRequestT = Model::GetCisScanResultDetailsRequest>
  void GetCisScanResultDetailsAsync(const GetCisScanResultDetailsRequestT& request,
                                    const GetCisScanResultDetailsResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetClustersForImage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetClustersForImage that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetClustersForImageRequestT = Model::GetClustersForImageRequest>
  void GetClustersForImageAsync(const GetClustersForImageRequestT& request, const GetClustersForImageResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetCodeSecurityIntegrationOutcome GetCodeSecurityIntegration(
      const Model::GetCodeSecurityIntegrationRequest& request) const;

  /**
   * A Callable wrapper for GetCodeSecurityIntegration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetCodeSecurityIntegrationRequestT = Model::GetCodeSecurityIntegrationRequest>
  Model::GetCodeSecurityIntegrationOutcomeCallable GetCodeSecurityIntegrationCallable(
      const GetCodeSecurityIntegrationRequestT& request) const {
    return SubmitCallable(&Inspector2Client::GetCodeSecurityIntegration, request);
  }

  /**
   * An Async wrapper for GetCodeSecurityIntegration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetCodeSecurityIntegrationRequestT = Model::GetCodeSecurityIntegrationRequest>
  void GetCodeSecurityIntegrationAsync(const GetCodeSecurityIntegrationRequestT& request,
                                       const GetCodeSecurityIntegrationResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetCodeSecurityScan that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetCodeSecurityScan that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetCodeSecurityScanRequestT = Model::GetCodeSecurityScanRequest>
  void GetCodeSecurityScanAsync(const GetCodeSecurityScanRequestT& request, const GetCodeSecurityScanResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetCodeSecurityScanConfigurationOutcome GetCodeSecurityScanConfiguration(
      const Model::GetCodeSecurityScanConfigurationRequest& request) const;

  /**
   * A Callable wrapper for GetCodeSecurityScanConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename GetCodeSecurityScanConfigurationRequestT = Model::GetCodeSecurityScanConfigurationRequest>
  Model::GetCodeSecurityScanConfigurationOutcomeCallable GetCodeSecurityScanConfigurationCallable(
      const GetCodeSecurityScanConfigurationRequestT& request) const {
    return SubmitCallable(&Inspector2Client::GetCodeSecurityScanConfiguration, request);
  }

  /**
   * An Async wrapper for GetCodeSecurityScanConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetCodeSecurityScanConfigurationRequestT = Model::GetCodeSecurityScanConfigurationRequest>
  void GetCodeSecurityScanConfigurationAsync(const GetCodeSecurityScanConfigurationRequestT& request,
                                             const GetCodeSecurityScanConfigurationResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename GetConfigurationRequestT = Model::GetConfigurationRequest>
  void GetConfigurationAsync(const GetConfigurationResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const GetConfigurationRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetDelegatedAdminAccount that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename GetDelegatedAdminAccountRequestT = Model::GetDelegatedAdminAccountRequest>
  Model::GetDelegatedAdminAccountOutcomeCallable GetDelegatedAdminAccountCallable(
      const GetDelegatedAdminAccountRequestT& request = {}) const {
    return SubmitCallable(&Inspector2Client::GetDelegatedAdminAccount, request);
  }

  /**
   * An Async wrapper for GetDelegatedAdminAccount that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetDelegatedAdminAccountRequestT = Model::GetDelegatedAdminAccountRequest>
  void GetDelegatedAdminAccountAsync(const GetDelegatedAdminAccountResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const GetDelegatedAdminAccountRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetEc2DeepInspectionConfigurationOutcome GetEc2DeepInspectionConfiguration(
      const Model::GetEc2DeepInspectionConfigurationRequest& request = {}) const;

  /**
   * A Callable wrapper for GetEc2DeepInspectionConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename GetEc2DeepInspectionConfigurationRequestT = Model::GetEc2DeepInspectionConfigurationRequest>
  Model::GetEc2DeepInspectionConfigurationOutcomeCallable GetEc2DeepInspectionConfigurationCallable(
      const GetEc2DeepInspectionConfigurationRequestT& request = {}) const {
    return SubmitCallable(&Inspector2Client::GetEc2DeepInspectionConfiguration, request);
  }

  /**
   * An Async wrapper for GetEc2DeepInspectionConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetEc2DeepInspectionConfigurationRequestT = Model::GetEc2DeepInspectionConfigurationRequest>
  void GetEc2DeepInspectionConfigurationAsync(const GetEc2DeepInspectionConfigurationResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                              const GetEc2DeepInspectionConfigurationRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetEncryptionKey that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetEncryptionKey that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetEncryptionKeyRequestT = Model::GetEncryptionKeyRequest>
  void GetEncryptionKeyAsync(const GetEncryptionKeyRequestT& request, const GetEncryptionKeyResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetFindingsReportStatus that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetFindingsReportStatus that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetFindingsReportStatusRequestT = Model::GetFindingsReportStatusRequest>
  void GetFindingsReportStatusAsync(const GetFindingsReportStatusResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const GetFindingsReportStatusRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetSbomExport that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetSbomExportRequestT = Model::GetSbomExportRequest>
  void GetSbomExportAsync(const GetSbomExportRequestT& request, const GetSbomExportResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAccountPermissions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAccountPermissions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAccountPermissionsRequestT = Model::ListAccountPermissionsRequest>
  void ListAccountPermissionsAsync(const ListAccountPermissionsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const ListAccountPermissionsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListCisScanConfigurationsOutcome ListCisScanConfigurations(
      const Model::ListCisScanConfigurationsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListCisScanConfigurations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListCisScanConfigurationsRequestT = Model::ListCisScanConfigurationsRequest>
  Model::ListCisScanConfigurationsOutcomeCallable ListCisScanConfigurationsCallable(
      const ListCisScanConfigurationsRequestT& request = {}) const {
    return SubmitCallable(&Inspector2Client::ListCisScanConfigurations, request);
  }

  /**
   * An Async wrapper for ListCisScanConfigurations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListCisScanConfigurationsRequestT = Model::ListCisScanConfigurationsRequest>
  void ListCisScanConfigurationsAsync(const ListCisScanConfigurationsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const ListCisScanConfigurationsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListCisScanResultsAggregatedByChecksOutcome ListCisScanResultsAggregatedByChecks(
      const Model::ListCisScanResultsAggregatedByChecksRequest& request) const;

  /**
   * A Callable wrapper for ListCisScanResultsAggregatedByChecks that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListCisScanResultsAggregatedByChecksRequestT = Model::ListCisScanResultsAggregatedByChecksRequest>
  Model::ListCisScanResultsAggregatedByChecksOutcomeCallable ListCisScanResultsAggregatedByChecksCallable(
      const ListCisScanResultsAggregatedByChecksRequestT& request) const {
    return SubmitCallable(&Inspector2Client::ListCisScanResultsAggregatedByChecks, request);
  }

  /**
   * An Async wrapper for ListCisScanResultsAggregatedByChecks that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListCisScanResultsAggregatedByChecksRequestT = Model::ListCisScanResultsAggregatedByChecksRequest>
  void ListCisScanResultsAggregatedByChecksAsync(const ListCisScanResultsAggregatedByChecksRequestT& request,
                                                 const ListCisScanResultsAggregatedByChecksResponseReceivedHandler& handler,
                                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListCisScanResultsAggregatedByTargetResourceOutcome ListCisScanResultsAggregatedByTargetResource(
      const Model::ListCisScanResultsAggregatedByTargetResourceRequest& request) const;

  /**
   * A Callable wrapper for ListCisScanResultsAggregatedByTargetResource that returns a future to the operation so that it can be executed
   * in parallel to other requests.
   */
  ...
  Model::ListCisScanResultsAggregatedByTargetResourceOutcomeCallable ListCisScanResultsAggregatedByTargetResourceCallable(
      const ListCisScanResultsAggregatedByTargetResourceRequestT& request) const {
    return SubmitCallable(&Inspector2Client::ListCisScanResultsAggregatedByTargetResource, request);
  }

  /**
   * An Async wrapper for ListCisScanResultsAggregatedByTargetResource that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename ListCisScanResultsAggregatedByTargetResourceRequestT = Model::ListCisScanResultsAggregatedByTargetResourceRequest>
  void ListCisScanResultsAggregatedByTargetResourceAsync(
      const ListCisScanResultsAggregatedByTargetResourceRequestT& request,
      const ListCisScanResultsAggregatedByTargetResourceResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListCisScans that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListCisScansRequestT = Model::ListCisScansRequest>
  void ListCisScansAsync(const ListCisScansResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                         const ListCisScansRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListCodeSecurityIntegrationsOutcome ListCodeSecurityIntegrations(
      const Model::ListCodeSecurityIntegrationsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListCodeSecurityIntegrations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListCodeSecurityIntegrationsRequestT = Model::ListCodeSecurityIntegrationsRequest>
  Model::ListCodeSecurityIntegrationsOutcomeCallable ListCodeSecurityIntegrationsCallable(
      const ListCodeSecurityIntegrationsRequestT& request = {}) const {
    return SubmitCallable(&Inspector2Client::ListCodeSecurityIntegrations, request);
  }

  /**
   * An Async wrapper for ListCodeSecurityIntegrations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListCodeSecurityIntegrationsRequestT = Model::ListCodeSecurityIntegrationsRequest>
  void ListCodeSecurityIntegrationsAsync(const ListCodeSecurityIntegrationsResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                         const ListCodeSecurityIntegrationsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListCodeSecurityScanConfigurationAssociationsOutcome ListCodeSecurityScanConfigurationAssociations(
      const Model::ListCodeSecurityScanConfigurationAssociationsRequest& request) const;

  /**
   * A Callable wrapper for ListCodeSecurityScanConfigurationAssociations that returns a future to the operation so that it can be executed
   * in parallel to other requests.
   */
  ...
  Model::ListCodeSecurityScanConfigurationAssociationsOutcomeCallable ListCodeSecurityScanConfigurationAssociationsCallable(
      const ListCodeSecurityScanConfigurationAssociationsRequestT& request) const {
    return SubmitCallable(&Inspector2Client::ListCodeSecurityScanConfigurationAssociations, request);
  }

  /**
   * An Async wrapper for ListCodeSecurityScanConfigurationAssociations that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename ListCodeSecurityScanConfigurationAssociationsRequestT = Model::ListCodeSecurityScanConfigurationAssociationsRequest>
  void ListCodeSecurityScanConfigurationAssociationsAsync(
      const ListCodeSecurityScanConfigurationAssociationsRequestT& request,
      const ListCodeSecurityScanConfigurationAssociationsResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListCodeSecurityScanConfigurationsOutcome ListCodeSecurityScanConfigurations(
      const Model::ListCodeSecurityScanConfigurationsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListCodeSecurityScanConfigurations that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListCodeSecurityScanConfigurationsRequestT = Model::ListCodeSecurityScanConfigurationsRequest>
  Model::ListCodeSecurityScanConfigurationsOutcomeCallable ListCodeSecurityScanConfigurationsCallable(
  ...
  /**
   * An Async wrapper for ListCodeSecurityScanConfigurations that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListCodeSecurityScanConfigurationsRequestT = Model::ListCodeSecurityScanConfigurationsRequest>
  void ListCodeSecurityScanConfigurationsAsync(const ListCodeSecurityScanConfigurationsResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                               const ListCodeSecurityScanConfigurationsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListCoverage that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListCoverageRequestT = Model::ListCoverageRequest>
  void ListCoverageAsync(const ListCoverageResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                         const ListCoverageRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListCoverageStatistics that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListCoverageStatistics that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListCoverageStatisticsRequestT = Model::ListCoverageStatisticsRequest>
  void ListCoverageStatisticsAsync(const ListCoverageStatisticsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const ListCoverageStatisticsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListDelegatedAdminAccountsOutcome ListDelegatedAdminAccounts(
      const Model::ListDelegatedAdminAccountsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListDelegatedAdminAccounts that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListDelegatedAdminAccountsRequestT = Model::ListDelegatedAdminAccountsRequest>
  Model::ListDelegatedAdminAccountsOutcomeCallable ListDelegatedAdminAccountsCallable(
      const ListDelegatedAdminAccountsRequestT& request = {}) const {
    return SubmitCallable(&Inspector2Client::ListDelegatedAdminAccounts, request);
  }

  /**
   * An Async wrapper for ListDelegatedAdminAccounts that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListDelegatedAdminAccountsRequestT = Model::ListDelegatedAdminAccountsRequest>
  void ListDelegatedAdminAccountsAsync(const ListDelegatedAdminAccountsResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const ListDelegatedAdminAccountsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListFindingAggregations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListFindingAggregations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListFindingAggregationsRequestT = Model::ListFindingAggregationsRequest>
  void ListFindingAggregationsAsync(const ListFindingAggregationsRequestT& request,
                                    const ListFindingAggregationsResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListUsageTotals that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListUsageTotalsRequestT = Model::ListUsageTotalsRequest>
  void ListUsageTotalsAsync(const ListUsageTotalsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const ListUsageTotalsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ResetEncryptionKey that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ResetEncryptionKey that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ResetEncryptionKeyRequestT = Model::ResetEncryptionKeyRequest>
  void ResetEncryptionKeyAsync(const ResetEncryptionKeyRequestT& request, const ResetEncryptionKeyResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SearchVulnerabilities that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SearchVulnerabilities that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SearchVulnerabilitiesRequestT = Model::SearchVulnerabilitiesRequest>
  void SearchVulnerabilitiesAsync(const SearchVulnerabilitiesRequestT& request, const SearchVulnerabilitiesResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SendCisSessionHealth that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SendCisSessionHealth that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SendCisSessionHealthRequestT = Model::SendCisSessionHealthRequest>
  void SendCisSessionHealthAsync(const SendCisSessionHealthRequestT& request, const SendCisSessionHealthResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SendCisSessionTelemetry that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SendCisSessionTelemetry that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SendCisSessionTelemetryRequestT = Model::SendCisSessionTelemetryRequest>
  void SendCisSessionTelemetryAsync(const SendCisSessionTelemetryRequestT& request,
                                    const SendCisSessionTelemetryResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StartCisSession that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StartCisSessionRequestT = Model::StartCisSessionRequest>
  void StartCisSessionAsync(const StartCisSessionRequestT& request, const StartCisSessionResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartCodeSecurityScan that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartCodeSecurityScan that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartCodeSecurityScanRequestT = Model::StartCodeSecurityScanRequest>
  void StartCodeSecurityScanAsync(const StartCodeSecurityScanRequestT& request, const StartCodeSecurityScanResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StopCisSession that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StopCisSessionRequestT = Model::StopCisSessionRequest>
  void StopCisSessionAsync(const StopCisSessionRequestT& request, const StopCisSessionResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateCisScanConfigurationOutcome UpdateCisScanConfiguration(
      const Model::UpdateCisScanConfigurationRequest& request) const;

  /**
   * A Callable wrapper for UpdateCisScanConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateCisScanConfigurationRequestT = Model::UpdateCisScanConfigurationRequest>
  Model::UpdateCisScanConfigurationOutcomeCallable UpdateCisScanConfigurationCallable(
      const UpdateCisScanConfigurationRequestT& request) const {
    return SubmitCallable(&Inspector2Client::UpdateCisScanConfiguration, request);
  }

  /**
   * An Async wrapper for UpdateCisScanConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateCisScanConfigurationRequestT = Model::UpdateCisScanConfigurationRequest>
  void UpdateCisScanConfigurationAsync(const UpdateCisScanConfigurationRequestT& request,
                                       const UpdateCisScanConfigurationResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::UpdateCodeSecurityIntegrationOutcome UpdateCodeSecurityIntegration(
      const Model::UpdateCodeSecurityIntegrationRequest& request) const;

  /**
   * A Callable wrapper for UpdateCodeSecurityIntegration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateCodeSecurityIntegrationRequestT = Model::UpdateCodeSecurityIntegrationRequest>
  Model::UpdateCodeSecurityIntegrationOutcomeCallable UpdateCodeSecurityIntegrationCallable(
      const UpdateCodeSecurityIntegrationRequestT& request) const {
    return SubmitCallable(&Inspector2Client::UpdateCodeSecurityIntegration, request);
  }

  /**
   * An Async wrapper for UpdateCodeSecurityIntegration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateCodeSecurityIntegrationRequestT = Model::UpdateCodeSecurityIntegrationRequest>
  void UpdateCodeSecurityIntegrationAsync(const UpdateCodeSecurityIntegrationRequestT& request,
                                          const UpdateCodeSecurityIntegrationResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateCodeSecurityScanConfigurationOutcome UpdateCodeSecurityScanConfiguration(
      const Model::UpdateCodeSecurityScanConfigurationRequest& request) const;

  /**
   * A Callable wrapper for UpdateCodeSecurityScanConfiguration that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename UpdateCodeSecurityScanConfigurationRequestT = Model::UpdateCodeSecurityScanConfigurationRequest>
  Model::UpdateCodeSecurityScanConfigurationOutcomeCallable UpdateCodeSecurityScanConfigurationCallable(
      const UpdateCodeSecurityScanConfigurationRequestT& request) const {
    return SubmitCallable(&Inspector2Client::UpdateCodeSecurityScanConfiguration, request);
  }

  /**
   * An Async wrapper for UpdateCodeSecurityScanConfiguration that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename UpdateCodeSecurityScanConfigurationRequestT = Model::UpdateCodeSecurityScanConfigurationRequest>
  void UpdateCodeSecurityScanConfigurationAsync(const UpdateCodeSecurityScanConfigurationRequestT& request,
                                                const UpdateCodeSecurityScanConfigurationResponseReceivedHandler& handler,
                                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename UpdateConfigurationRequestT = Model::UpdateConfigurationRequest>
  void UpdateConfigurationAsync(const UpdateConfigurationResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateEc2DeepInspectionConfigurationOutcome UpdateEc2DeepInspectionConfiguration(
      const Model::UpdateEc2DeepInspectionConfigurationRequest& request = {}) const;

  /**
   * A Callable wrapper for UpdateEc2DeepInspectionConfiguration that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename UpdateEc2DeepInspectionConfigurationRequestT = Model::UpdateEc2DeepInspectionConfigurationRequest>
  Model::UpdateEc2DeepInspectionConfigurationOutcomeCallable UpdateEc2DeepInspectionConfigurationCallable(
      const UpdateEc2DeepInspectionConfigurationRequestT& request = {}) const {
    return SubmitCallable(&Inspector2Client::UpdateEc2DeepInspectionConfiguration, request);
  }

  /**
   * An Async wrapper for UpdateEc2DeepInspectionConfiguration that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename UpdateEc2DeepInspectionConfigurationRequestT = Model::UpdateEc2DeepInspectionConfigurationRequest>
  void UpdateEc2DeepInspectionConfigurationAsync(const UpdateEc2DeepInspectionConfigurationResponseReceivedHandler& handler,
                                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                 const UpdateEc2DeepInspectionConfigurationRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for UpdateEncryptionKey that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateEncryptionKey that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateEncryptionKeyRequestT = Model::UpdateEncryptionKeyRequest>
  void UpdateEncryptionKeyAsync(const UpdateEncryptionKeyRequestT& request, const UpdateEncryptionKeyResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateFilter that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateFilterRequestT = Model::UpdateFilterRequest>
  void UpdateFilterAsync(const UpdateFilterRequestT& request, const UpdateFilterResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateOrgEc2DeepInspectionConfigurationOutcome UpdateOrgEc2DeepInspectionConfiguration(
      const Model::UpdateOrgEc2DeepInspectionConfigurationRequest& request) const;

  /**
   * A Callable wrapper for UpdateOrgEc2DeepInspectionConfiguration that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename UpdateOrgEc2DeepInspectionConfigurationRequestT = Model::UpdateOrgEc2DeepInspectionConfigurationRequest>
  Model::UpdateOrgEc2DeepInspectionConfigurationOutcomeCallable UpdateOrgEc2DeepInspectionConfigurationCallable(
      const UpdateOrgEc2DeepInspectionConfigurationRequestT& request) const {
    return SubmitCallable(&Inspector2Client::UpdateOrgEc2DeepInspectionConfiguration, request);
  }

  /**
   * An Async wrapper for UpdateOrgEc2DeepInspectionConfiguration that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename UpdateOrgEc2DeepInspectionConfigurationRequestT = Model::UpdateOrgEc2DeepInspectionConfigurationRequest>
  void UpdateOrgEc2DeepInspectionConfigurationAsync(const UpdateOrgEc2DeepInspectionConfigurationRequestT& request,
                                                    const UpdateOrgEc2DeepInspectionConfigurationResponseReceivedHandler& handler,
                                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
