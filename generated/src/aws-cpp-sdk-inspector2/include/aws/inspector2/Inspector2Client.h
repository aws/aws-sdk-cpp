...
namespace Inspector2
{
   ...
   */
  class AWS_INSPECTOR2_API Inspector2Client : Aws::Client::ClientWithAsyncTemplateMethods<Inspector2Client>,
    smithy::client::AwsSmithyClientT<Aws::Inspector2::SERVICE_NAME,
