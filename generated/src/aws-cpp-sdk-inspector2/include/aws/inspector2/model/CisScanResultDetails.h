...
class CisScanResultDetails {
 public:
  ...
  inline void SetStatus(CisFindingStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline CisScanResultDetails& WithStatus(CisFindingStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline CisScanResultDetails& WithLevel(CisSecurityLevel value) {
    SetLevel(value);
    return *this;
  }
  ///@}
