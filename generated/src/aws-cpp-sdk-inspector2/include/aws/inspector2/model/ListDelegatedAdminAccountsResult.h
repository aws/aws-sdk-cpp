...
class ListDelegatedAdminAccountsResult {
 public:
  ...
  void SetDelegatedAdminAccounts(DelegatedAdminAccountsT&& value) {
    m_delegatedAdminAccountsHasBeenSet = true;
    m_delegatedAdminAccounts = std::forward<DelegatedAdminAccountsT>(value);
  }
  template <typename DelegatedAdminAccountsT = Aws::Vector<DelegatedAdminAccount>>
  ListDelegatedAdminAccountsResult& WithDelegatedAdminAccounts(DelegatedAdminAccountsT&& value) {
    SetDelegatedAdminAccounts(std::forward<DelegatedAdminAccountsT>(value));
    return *this;
  }
  template <typename DelegatedAdminAccountsT = DelegatedAdminAccount>
  ListDelegatedAdminAccountsResult& AddDelegatedAdminAccounts(DelegatedAdminAccountsT&& value) {
    m_delegatedAdminAccountsHasBeenSet = true;
    m_delegatedAdminAccounts.emplace_back(std::forward<DelegatedAdminAccountsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListDelegatedAdminAccountsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDelegatedAdminAccountsResult& WithRequestId(RequestIdT&& value) {
