...
class ListCodeSecurityScanConfigurationsResult {
 public:
  ...
  AWS_INSPECTOR2_API ListCodeSecurityScanConfigurationsResult& operator=(
  ...
  template <typename ConfigurationsT = Aws::Vector<CodeSecurityScanConfigurationSummary>>
  ListCodeSecurityScanConfigurationsResult& WithConfigurations(ConfigurationsT&& value) {
  ...
  ListCodeSecurityScanConfigurationsResult& AddConfigurations(ConfigurationsT&& value) {
    m_configurationsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListCodeSecurityScanConfigurationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListCodeSecurityScanConfigurationsResult& WithRequestId(RequestIdT&& value) {
