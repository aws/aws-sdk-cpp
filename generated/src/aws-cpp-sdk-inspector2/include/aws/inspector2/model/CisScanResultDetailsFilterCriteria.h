...
class CisScanResultDetailsFilterCriteria {
 public:
  ...
  void SetFindingStatusFilters(FindingStatusFiltersT&& value) {
    m_findingStatusFiltersHasBeenSet = true;
    m_findingStatusFilters = std::forward<FindingStatusFiltersT>(value);
  }
  template <typename FindingStatusFiltersT = Aws::Vector<CisFindingStatusFilter>>
  CisScanResultDetailsFilterCriteria& WithFindingStatusFilters(FindingStatusFiltersT&& value) {
    SetFindingStatusFilters(std::forward<FindingStatusFiltersT>(value));
    return *this;
  }
  template <typename FindingStatusFiltersT = CisFindingStatusFilter>
  CisScanResultDetailsFilterCriteria& AddFindingStatusFilters(FindingStatusFiltersT&& value) {
    m_findingStatusFiltersHasBeenSet = true;
    m_findingStatusFilters.emplace_back(std::forward<FindingStatusFiltersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename CheckIdFiltersT = Aws::Vector<CisStringFilter>>
  CisScanResultDetailsFilterCriteria& WithCheckIdFilters(CheckIdFiltersT&& value) {
    SetCheckIdFilters(std::forward<CheckIdFiltersT>(value));
    return *this;
  }
  template <typename CheckIdFiltersT = CisStringFilter>
  CisScanResultDetailsFilterCriteria& AddCheckIdFilters(CheckIdFiltersT&& value) {
    m_checkIdFiltersHasBeenSet = true;
  ...
  template <typename TitleFiltersT = Aws::Vector<CisStringFilter>>
  CisScanResultDetailsFilterCriteria& WithTitleFilters(TitleFiltersT&& value) {
    SetTitleFilters(std::forward<TitleFiltersT>(value));
    return *this;
  }
  template <typename TitleFiltersT = CisStringFilter>
  CisScanResultDetailsFilterCriteria& AddTitleFilters(TitleFiltersT&& value) {
    m_titleFiltersHasBeenSet = true;
  ...
  template <typename SecurityLevelFiltersT = Aws::Vector<CisSecurityLevelFilter>>
  CisScanResultDetailsFilterCriteria& WithSecurityLevelFilters(SecurityLevelFiltersT&& value) {
  ...
  CisScanResultDetailsFilterCriteria& AddSecurityLevelFilters(SecurityLevelFiltersT&& value) {
    m_securityLevelFiltersHasBeenSet = true;
  ...
  void SetFindingArnFilters(FindingArnFiltersT&& value) {
    m_findingArnFiltersHasBeenSet = true;
    m_findingArnFilters = std::forward<FindingArnFiltersT>(value);
  }
  template <typename FindingArnFiltersT = Aws::Vector<CisStringFilter>>
  CisScanResultDetailsFilterCriteria& WithFindingArnFilters(FindingArnFiltersT&& value) {
    SetFindingArnFilters(std::forward<FindingArnFiltersT>(value));
    return *this;
  }
  template <typename FindingArnFiltersT = CisStringFilter>
  CisScanResultDetailsFilterCriteria& AddFindingArnFilters(FindingArnFiltersT&& value) {
    m_findingArnFiltersHasBeenSet = true;
    m_findingArnFilters.emplace_back(std::forward<FindingArnFiltersT>(value));
    return *this;
  }
  ///@}
 private:
