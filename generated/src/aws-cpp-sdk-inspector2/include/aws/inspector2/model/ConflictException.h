...
namespace Model
{
  ...
  {
  public:
    AWS_INSPECTOR2_API ConflictException() = default;
    AWS_INSPECTOR2_API ConflictException(Aws::Utils::Json::JsonView jsonValue);
    AWS_INSPECTOR2_API ConflictException& operator=(Aws::Utils::Json::JsonView jsonValue);
