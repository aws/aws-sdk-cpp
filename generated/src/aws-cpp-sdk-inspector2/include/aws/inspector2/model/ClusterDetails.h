...
class ClusterDetails {
 public:
  ...
  void SetLastInUse(LastInUseT&& value) {
    ...
    m_lastInUse = std::forward<LastInUseT>(value);
  }
  template <typename LastInUseT = Aws::Utils::DateTime>
  ClusterDetails& WithLastInUse(LastInUseT&& value) {
    SetLastInUse(std::forward<LastInUseT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetRunningUnitCount(long long value) {
    m_runningUnitCountHasBeenSet = true;
    m_runningUnitCount = value;
  }
  inline ClusterDetails& WithRunningUnitCount(long long value) {
    SetRunningUnitCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStoppedUnitCount(long long value) {
    m_stoppedUnitCountHasBeenSet = true;
    m_stoppedUnitCount = value;
  }
  inline ClusterDetails& WithStoppedUnitCount(long long value) {
    SetStoppedUnitCount(value);
    return *this;
  }
  ///@}
  ...
  void SetClusterMetadata(ClusterMetadataT&& value) {
    ...
    m_clusterMetadata = std::forward<ClusterMetadataT>(value);
  }
  template <typename ClusterMetadataT = ClusterMetadata>
  ClusterDetails& WithClusterMetadata(ClusterMetadataT&& value) {
    SetClusterMetadata(std::forward<ClusterMetadataT>(value));
    return *this;
  }
  ///@}
 private:
