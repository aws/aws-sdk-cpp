...
class GetCisScanResultDetailsRequest : public Inspector2Request {
 public:
  ...
  void SetScanArn(ScanArnT&& value) {
    ...
    m_scanArn = std::forward<ScanArnT>(value);
  }
  template <typename ScanArnT = Aws::String>
  GetCisScanResultDetailsRequest& WithScanArn(ScanArnT&& value) {
    SetScanArn(std::forward<ScanArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TargetResourceIdT = Aws::String>
  GetCisScanResultDetailsRequest& WithTargetResourceId(TargetResourceIdT&& value) {
  ...
  template <typename AccountIdT = Aws::String>
  GetCisScanResultDetailsRequest& WithAccountId(AccountIdT&& value) {
  ...
  template <typename FilterCriteriaT = CisScanResultDetailsFilterCriteria>
  GetCisScanResultDetailsRequest& WithFilterCriteria(FilterCriteriaT&& value) {
  ...
  inline void SetSortBy(CisScanResultDetailsSortBy value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline GetCisScanResultDetailsRequest& WithSortBy(CisScanResultDetailsSortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSortOrder(CisSortOrder value) {
    m_sortOrderHasBeenSet = true;
    m_sortOrder = value;
  }
  inline GetCisScanResultDetailsRequest& WithSortOrder(CisSortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetCisScanResultDetailsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline GetCisScanResultDetailsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
