...
class PackageAggregationResponse {
 public:
  ...
  template <typename PackageNameT = Aws::String>
  PackageAggregationResponse& WithPackageName(PackageNameT&& value) {
  ...
  template <typename AccountIdT = Aws::String>
  PackageAggregationResponse& WithAccountId(AccountIdT&& value) {
  ...
  template <typename SeverityCountsT = SeverityCounts>
  PackageAggregationResponse& WithSeverityCounts(SeverityCountsT&& value) {
