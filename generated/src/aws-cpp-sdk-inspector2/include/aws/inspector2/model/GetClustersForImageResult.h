...
class GetClustersForImageResult {
 public:
  ...
  template <typename ClusterT = Aws::Vector<ClusterInformation>>
  GetClustersForImageResult& WithCluster(ClusterT&& value) {
    SetCluster(std::forward<ClusterT>(value));
    return *this;
  }
  template <typename ClusterT = ClusterInformation>
  GetClustersForImageResult& AddCluster(ClusterT&& value) {
    m_clusterHasBeenSet = true;
    m_cluster.emplace_back(std::forward<ClusterT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetClustersForImageResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetClustersForImageResult& WithRequestId(RequestIdT&& value) {
