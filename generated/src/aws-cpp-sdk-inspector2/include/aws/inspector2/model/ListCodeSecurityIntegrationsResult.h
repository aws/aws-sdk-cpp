...
class ListCodeSecurityIntegrationsResult {
 public:
  ...
  template <typename IntegrationsT = Aws::Vector<CodeSecurityIntegrationSummary>>
  ListCodeSecurityIntegrationsResult& WithIntegrations(IntegrationsT&& value) {
    SetIntegrations(std::forward<IntegrationsT>(value));
    return *this;
  }
  template <typename IntegrationsT = CodeSecurityIntegrationSummary>
  ListCodeSecurityIntegrationsResult& AddIntegrations(IntegrationsT&& value) {
    m_integrationsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListCodeSecurityIntegrationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListCodeSecurityIntegrationsResult& WithRequestId(RequestIdT&& value) {
