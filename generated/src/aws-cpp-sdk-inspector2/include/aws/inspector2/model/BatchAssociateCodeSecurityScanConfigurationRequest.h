...
class BatchAssociateCodeSecurityScanConfigurationRequest : public Inspector2Request {
 public:
   ...
   * configuration.</p>
   */
  inline const Aws::Vector<AssociateConfigurationRequest>& GetAssociateConfigurationRequests() const {
    return m_associateConfigurationRequests;
  }
  ...
  void SetAssociateConfigurationRequests(AssociateConfigurationRequestsT&& value) {
    m_associateConfigurationRequestsHasBeenSet = true;
    m_associateConfigurationRequests = std::forward<AssociateConfigurationRequestsT>(value);
  }
  template <typename AssociateConfigurationRequestsT = Aws::Vector<AssociateConfigurationRequest>>
  BatchAssociateCodeSecurityScanConfigurationRequest& WithAssociateConfigurationRequests(AssociateConfigurationRequestsT&& value) {
    SetAssociateConfigurationRequests(std::forward<AssociateConfigurationRequestsT>(value));
    return *this;
  }
  template <typename AssociateConfigurationRequestsT = AssociateConfigurationRequest>
  BatchAssociateCodeSecurityScanConfigurationRequest& AddAssociateConfigurationRequests(AssociateConfigurationRequestsT&& value) {
    m_associateConfigurationRequestsHasBeenSet = true;
    m_associateConfigurationRequests.emplace_back(std::forward<AssociateConfigurationRequestsT>(value));
    return *this;
  }
  ///@}
 private:
