...
class CodeSecurityScanConfiguration {
 public:
  ...
  void SetPeriodicScanConfiguration(PeriodicScanConfigurationT&& value) {
    m_periodicScanConfigurationHasBeenSet = true;
    m_periodicScanConfiguration = std::forward<PeriodicScanConfigurationT>(value);
  }
  template <typename PeriodicScanConfigurationT = PeriodicScanConfiguration>
  CodeSecurityScanConfiguration& WithPeriodicScanConfiguration(PeriodicScanConfigurationT&& value) {
    SetPeriodicScanConfiguration(std::forward<PeriodicScanConfigurationT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const ContinuousIntegrationScanConfiguration& GetContinuousIntegrationScanConfiguration() const {
    return m_continuousIntegrationScanConfiguration;
  }
  ...
  void SetContinuousIntegrationScanConfiguration(ContinuousIntegrationScanConfigurationT&& value) {
    m_continuousIntegrationScanConfigurationHasBeenSet = true;
    m_continuousIntegrationScanConfiguration = std::forward<ContinuousIntegrationScanConfigurationT>(value);
  }
  template <typename ContinuousIntegrationScanConfigurationT = ContinuousIntegrationScanConfiguration>
  CodeSecurityScanConfiguration& WithContinuousIntegrationScanConfiguration(ContinuousIntegrationScanConfigurationT&& value) {
    SetContinuousIntegrationScanConfiguration(std::forward<ContinuousIntegrationScanConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RuleSetCategoriesT = Aws::Vector<RuleSetCategory>>
  CodeSecurityScanConfiguration& WithRuleSetCategories(RuleSetCategoriesT&& value) {
    SetRuleSetCategories(std::forward<RuleSetCategoriesT>(value));
    return *this;
  }
  inline CodeSecurityScanConfiguration& AddRuleSetCategories(RuleSetCategory value) {
    m_ruleSetCategoriesHasBeenSet = true;
