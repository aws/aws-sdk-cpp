...
class ListCisScanResultsAggregatedByTargetResourceRequest : public Inspector2Request {
 public:
  ...
  template <typename ScanArnT = Aws::String>
  ListCisScanResultsAggregatedByTargetResourceRequest& WithScanArn(ScanArnT&& value) {
  ...
  template <typename FilterCriteriaT = CisScanResultsAggregatedByTargetResourceFilterCriteria>
  ListCisScanResultsAggregatedByTargetResourceRequest& WithFilterCriteria(FilterCriteriaT&& value) {
  ...
  inline void SetSortBy(CisScanResultsAggregatedByTargetResourceSortBy value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ListCisScanResultsAggregatedByTargetResourceRequest& WithSortBy(CisScanResultsAggregatedByTargetResourceSortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListCisScanResultsAggregatedByTargetResourceRequest& WithSortOrder(CisSortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListCisScanResultsAggregatedByTargetResourceRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListCisScanResultsAggregatedByTargetResourceRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
