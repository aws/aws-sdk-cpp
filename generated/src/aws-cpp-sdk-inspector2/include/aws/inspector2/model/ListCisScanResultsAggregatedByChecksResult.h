...
class ListCisScanResultsAggregatedByChecksResult {
 public:
  ...
  AWS_INSPECTOR2_API ListCisScanResultsAggregatedByChecksResult& operator=(
  ...
  void SetCheckAggregations(CheckAggregationsT&& value) {
    m_checkAggregationsHasBeenSet = true;
    m_checkAggregations = std::forward<CheckAggregationsT>(value);
  }
  template <typename CheckAggregationsT = Aws::Vector<CisCheckAggregation>>
  ListCisScanResultsAggregatedByChecksResult& WithCheckAggregations(CheckAggregationsT&& value) {
    SetCheckAggregations(std::forward<CheckAggregationsT>(value));
    return *this;
  }
  template <typename CheckAggregationsT = CisCheckAggregation>
  ListCisScanResultsAggregatedByChecksResult& AddCheckAggregations(CheckAggregationsT&& value) {
    m_checkAggregationsHasBeenSet = true;
    m_checkAggregations.emplace_back(std::forward<CheckAggregationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListCisScanResultsAggregatedByChecksResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListCisScanResultsAggregatedByChecksResult& WithRequestId(RequestIdT&& value) {
