...
class AwsEksMetadataDetails {
 public:
  ...
  template <typename NamespaceT = Aws::String>
  AwsEksMetadataDetails& WithNamespace(NamespaceT&& value) {
  ...
  void SetWorkloadInfoList(WorkloadInfoListT&& value) {
    m_workloadInfoListHasBeenSet = true;
    m_workloadInfoList = std::forward<WorkloadInfoListT>(value);
  }
  template <typename WorkloadInfoListT = Aws::Vector<AwsEksWorkloadInfo>>
  AwsEksMetadataDetails& WithWorkloadInfoList(WorkloadInfoListT&& value) {
    SetWorkloadInfoList(std::forward<WorkloadInfoListT>(value));
    return *this;
  }
  template <typename WorkloadInfoListT = AwsEksWorkloadInfo>
  AwsEksMetadataDetails& AddWorkloadInfoList(WorkloadInfoListT&& value) {
    m_workloadInfoListHasBeenSet = true;
    m_workloadInfoList.emplace_back(std::forward<WorkloadInfoListT>(value));
    return *this;
  }
  ///@}
 private:
