...
class FailedAccount {
 public:
  ...
  template <typename AccountIdT = Aws::String>
  FailedAccount& WithAccountId(AccountIdT&& value) {
  ...
  inline FailedAccount& WithStatus(Status value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ResourceStatusT = ResourceStatus>
  FailedAccount& WithResourceStatus(ResourceStatusT&& value) {
  ...
  inline FailedAccount& WithErrorCode(ErrorCode value) {
    SetErrorCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename ErrorMessageT = Aws::String>
  FailedAccount& WithErrorMessage(ErrorMessageT&& value) {
