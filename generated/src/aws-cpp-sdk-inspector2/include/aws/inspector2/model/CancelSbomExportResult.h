...
namespace Model
{
  ...
  {
  public:
    AWS_INSPECTOR2_API CancelSbomExportResult() = default;
    ...
    template<typename ReportIdT = Aws::String>
    CancelSbomExportResult& WithReportId(ReportIdT&& value) { SetReportId(std::forward<ReportIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CancelSbomExportResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
