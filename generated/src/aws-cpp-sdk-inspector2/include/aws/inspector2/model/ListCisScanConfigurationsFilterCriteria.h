...
class ListCisScanConfigurationsFilterCriteria {
 public:
  ...
  void SetScanNameFilters(ScanNameFiltersT&& value) {
    m_scanNameFiltersHasBeenSet = true;
    m_scanNameFilters = std::forward<ScanNameFiltersT>(value);
  }
  template <typename ScanNameFiltersT = Aws::Vector<CisStringFilter>>
  ListCisScanConfigurationsFilterCriteria& WithScanNameFilters(ScanNameFiltersT&& value) {
    SetScanNameFilters(std::forward<ScanNameFiltersT>(value));
    return *this;
  }
  template <typename ScanNameFiltersT = CisStringFilter>
  ListCisScanConfigurationsFilterCriteria& AddScanNameFilters(ScanNameFiltersT&& value) {
    m_scanNameFiltersHasBeenSet = true;
    m_scanNameFilters.emplace_back(std::forward<ScanNameFiltersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TargetResourceTagFiltersT = Aws::Vector<TagFilter>>
  ListCisScanConfigurationsFilterCriteria& WithTargetResourceTagFilters(TargetResourceTagFiltersT&& value) {
  ...
  ListCisScanConfigurationsFilterCriteria& AddTargetResourceTagFilters(TargetResourceTagFiltersT&& value) {
    m_targetResourceTagFiltersHasBeenSet = true;
  ...
  void SetScanConfigurationArnFilters(ScanConfigurationArnFiltersT&& value) {
    m_scanConfigurationArnFiltersHasBeenSet = true;
    m_scanConfigurationArnFilters = std::forward<ScanConfigurationArnFiltersT>(value);
  }
  template <typename ScanConfigurationArnFiltersT = Aws::Vector<CisStringFilter>>
  ListCisScanConfigurationsFilterCriteria& WithScanConfigurationArnFilters(ScanConfigurationArnFiltersT&& value) {
    SetScanConfigurationArnFilters(std::forward<ScanConfigurationArnFiltersT>(value));
    return *this;
  }
  template <typename ScanConfigurationArnFiltersT = CisStringFilter>
  ListCisScanConfigurationsFilterCriteria& AddScanConfigurationArnFilters(ScanConfigurationArnFiltersT&& value) {
    m_scanConfigurationArnFiltersHasBeenSet = true;
    m_scanConfigurationArnFilters.emplace_back(std::forward<ScanConfigurationArnFiltersT>(value));
    return *this;
  }
  ///@}
 private:
