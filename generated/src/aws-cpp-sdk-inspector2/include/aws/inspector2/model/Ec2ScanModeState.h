...
class Ec2ScanModeState {
 public:
  ...
  inline void SetScanMode(Ec2ScanMode value) {
    m_scanModeHasBeenSet = true;
    m_scanMode = value;
  }
  inline Ec2ScanModeState& WithScanMode(Ec2ScanMode value) {
    SetScanMode(value);
    return *this;
  }
  ///@}
  ...
  inline void SetScanModeStatus(Ec2ScanModeStatus value) {
    m_scanModeStatusHasBeenSet = true;
    m_scanModeStatus = value;
  }
  inline Ec2ScanModeState& WithScanModeStatus(Ec2ScanModeStatus value) {
    SetScanModeStatus(value);
    return *this;
  }
  ///@}
 private:
