...
class CreateConnectorResult {
 public:
  AWS_INSPECTOR2_API CreateConnectorResult() = default;
  AWS_INSPECTOR2_API CreateConnectorResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_INSPECTOR2_API CreateConnectorResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
