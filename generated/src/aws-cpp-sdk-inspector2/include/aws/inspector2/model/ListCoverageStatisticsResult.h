...
class ListCoverageStatisticsResult {
 public:
  ...
  void SetCountsByGroup(CountsByGroupT&& value) {
    ...
    m_countsByGroup = std::forward<CountsByGroupT>(value);
  }
  template <typename CountsByGroupT = Aws::Vector<Counts>>
  ListCoverageStatisticsResult& WithCountsByGroup(CountsByGroupT&& value) {
    SetCountsByGroup(std::forward<CountsByGroupT>(value));
    return *this;
  }
  template <typename CountsByGroupT = Counts>
  ListCoverageStatisticsResult& AddCountsByGroup(CountsByGroupT&& value) {
    m_countsByGroupHasBeenSet = true;
    m_countsByGroup.emplace_back(std::forward<CountsByGroupT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTotalCounts(long long value) {
    m_totalCountsHasBeenSet = true;
    m_totalCounts = value;
  }
  inline ListCoverageStatisticsResult& WithTotalCounts(long long value) {
    SetTotalCounts(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListCoverageStatisticsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListCoverageStatisticsResult& WithRequestId(RequestIdT&& value) {
