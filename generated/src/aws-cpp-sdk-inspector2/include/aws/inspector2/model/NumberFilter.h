...
class NumberFilter {
 public:
  ...
  inline void SetUpperInclusive(double value) {
    m_upperInclusiveHasBeenSet = true;
    m_upperInclusive = value;
  }
  inline NumberFilter& WithUpperInclusive(double value) {
  ...
  inline void SetLowerInclusive(double value) {
    m_lowerInclusiveHasBeenSet = true;
    m_lowerInclusive = value;
  }
  inline NumberFilter& WithLowerInclusive(double value) {
