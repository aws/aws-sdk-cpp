...
class CisTargetResourceAggregation {
 public:
  ...
  void SetStatusCounts(StatusCountsT&& value) {
    ...
    m_statusCounts = std::forward<StatusCountsT>(value);
  }
  template <typename StatusCountsT = StatusCounts>
  CisTargetResourceAggregation& WithStatusCounts(StatusCountsT&& value) {
    SetStatusCounts(std::forward<StatusCountsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTargetStatus(CisTargetStatus value) {
    m_targetStatusHasBeenSet = true;
    m_targetStatus = value;
  }
  inline CisTargetResourceAggregation& WithTargetStatus(CisTargetStatus value) {
  ...
  inline void SetTargetStatusReason(CisTargetStatusReason value) {
    m_targetStatusReasonHasBeenSet = true;
    m_targetStatusReason = value;
  }
  inline CisTargetResourceAggregation& WithTargetStatusReason(CisTargetStatusReason value) {
    SetTargetStatusReason(value);
    return *this;
  }
  ///@}
 private:
