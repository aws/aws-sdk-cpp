...
namespace Model
{
  ...
  {
  public:
    AWS_INSPECTOR2_API StartCisSessionResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    StartCisSessionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
