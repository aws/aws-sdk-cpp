...
class ListCoverageStatisticsRequest : public Inspector2Request {
 public:
  ...
  template <typename FilterCriteriaT = CoverageFilterCriteria>
  ListCoverageStatisticsRequest& WithFilterCriteria(FilterCriteriaT&& value) {
  ...
  inline void SetGroupBy(GroupKey value) {
    m_groupByHasBeenSet = true;
    m_groupBy = value;
  }
  inline ListCoverageStatisticsRequest& WithGroupBy(GroupKey value) {
    SetGroupBy(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListCoverageStatisticsRequest& WithNextToken(NextTokenT&& value) {
