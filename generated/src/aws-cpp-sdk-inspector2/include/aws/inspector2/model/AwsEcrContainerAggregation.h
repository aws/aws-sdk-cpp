...
class AwsEcrContainerAggregation {
 public:
  ...
  inline AwsEcrContainerAggregation& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSortBy(AwsEcrContainerSortBy value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline AwsEcrContainerAggregation& WithSortBy(AwsEcrContainerSortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
