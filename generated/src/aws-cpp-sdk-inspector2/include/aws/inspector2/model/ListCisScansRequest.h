...
class ListCisScansRequest : public Inspector2Request {
 public:
  ...
  template <typename FilterCriteriaT = ListCisScansFilterCriteria>
  ListCisScansRequest& WithFilterCriteria(FilterCriteriaT&& value) {
  ...
  inline void SetDetailLevel(ListCisScansDetailLevel value) {
    m_detailLevelHasBeenSet = true;
    m_detailLevel = value;
  }
  inline ListCisScansRequest& WithDetailLevel(ListCisScansDetailLevel value) {
  ...
  inline void SetSortBy(ListCisScansSortBy value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ListCisScansRequest& WithSortBy(ListCisScansSortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListCisScansRequest& WithSortOrder(CisSortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListCisScansRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListCisScansRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
