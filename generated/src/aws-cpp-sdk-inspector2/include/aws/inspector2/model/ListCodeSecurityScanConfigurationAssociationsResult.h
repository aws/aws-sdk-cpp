...
class ListCodeSecurityScanConfigurationAssociationsResult {
 public:
  ...
  AWS_INSPECTOR2_API ListCodeSecurityScanConfigurationAssociationsResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename AssociationsT = Aws::Vector<CodeSecurityScanConfigurationAssociationSummary>>
  ListCodeSecurityScanConfigurationAssociationsResult& WithAssociations(AssociationsT&& value) {
  ...
  ListCodeSecurityScanConfigurationAssociationsResult& AddAssociations(AssociationsT&& value) {
    m_associationsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListCodeSecurityScanConfigurationAssociationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListCodeSecurityScanConfigurationAssociationsResult& WithRequestId(RequestIdT&& value) {
