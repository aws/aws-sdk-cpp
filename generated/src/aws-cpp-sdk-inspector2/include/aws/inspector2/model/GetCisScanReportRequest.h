...
class GetCisScanReportRequest : public Inspector2Request {
 public:
  ...
  template <typename ScanArnT = Aws::String>
  GetCisScanReportRequest& WithScanArn(ScanArnT&& value) {
  ...
  void SetTargetAccounts(TargetAccountsT&& value) {
    ...
    m_targetAccounts = std::forward<TargetAccountsT>(value);
  }
  template <typename TargetAccountsT = Aws::Vector<Aws::String>>
  GetCisScanReportRequest& WithTargetAccounts(TargetAccountsT&& value) {
    SetTargetAccounts(std::forward<TargetAccountsT>(value));
    return *this;
  }
  template <typename TargetAccountsT = Aws::String>
  GetCisScanReportRequest& AddTargetAccounts(TargetAccountsT&& value) {
    m_targetAccountsHasBeenSet = true;
    m_targetAccounts.emplace_back(std::forward<TargetAccountsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetReportFormat(CisReportFormat value) {
    m_reportFormatHasBeenSet = true;
    m_reportFormat = value;
  }
  inline GetCisScanReportRequest& WithReportFormat(CisReportFormat value) {
