...
namespace Model
{
  ...
  {
  public:
    AWS_INSPECTOR2_API DisassociateMemberRequest() = default;
    ...
    template<typename AccountIdT = Aws::String>
    DisassociateMemberRequest& WithAccountId(AccountIdT&& value) { SetAccountId(std::forward<AccountIdT>(value)); return *this;}
    ///@}
  private:
