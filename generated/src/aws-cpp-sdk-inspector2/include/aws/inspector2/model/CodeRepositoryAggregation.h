...
class CodeRepositoryAggregation {
 public:
  ...
  inline CodeRepositoryAggregation& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSortBy(CodeRepositorySortBy value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline CodeRepositoryAggregation& WithSortBy(CodeRepositorySortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
