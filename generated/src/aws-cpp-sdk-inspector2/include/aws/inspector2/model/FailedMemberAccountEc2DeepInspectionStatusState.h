...
class FailedMemberAccountEc2DeepInspectionStatusState {
 public:
  ...
  template <typename AccountIdT = Aws::String>
  FailedMemberAccountEc2DeepInspectionStatusState& WithAccountId(AccountIdT&& value) {
  ...
  inline void SetEc2ScanStatus(Status value) {
    m_ec2ScanStatusHasBeenSet = true;
    m_ec2ScanStatus = value;
  }
  inline FailedMemberAccountEc2DeepInspectionStatusState& WithEc2ScanStatus(Status value) {
    SetEc2ScanStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ErrorMessageT = Aws::String>
  FailedMemberAccountEc2DeepInspectionStatusState& WithErrorMessage(ErrorMessageT&& value) {
