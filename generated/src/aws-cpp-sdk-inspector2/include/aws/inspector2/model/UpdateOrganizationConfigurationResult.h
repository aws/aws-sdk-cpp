...
class UpdateOrganizationConfigurationResult {
 public:
  ...
  AWS_INSPECTOR2_API UpdateOrganizationConfigurationResult& operator=(
  ...
  template <typename AutoEnableT = AutoEnable>
  UpdateOrganizationConfigurationResult& WithAutoEnable(AutoEnableT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateOrganizationConfigurationResult& WithRequestId(RequestIdT&& value) {
