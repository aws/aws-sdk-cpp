...
class ListCisScanConfigurationsRequest : public Inspector2Request {
 public:
  ...
  template <typename FilterCriteriaT = ListCisScanConfigurationsFilterCriteria>
  ListCisScanConfigurationsRequest& WithFilterCriteria(FilterCriteriaT&& value) {
  ...
  inline void SetSortBy(CisScanConfigurationsSortBy value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ListCisScanConfigurationsRequest& WithSortBy(CisScanConfigurationsSortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListCisScanConfigurationsRequest& WithSortOrder(CisSortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListCisScanConfigurationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListCisScanConfigurationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
