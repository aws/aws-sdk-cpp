...
class EcrRepositoryMetadata {
 public:
  ...
  template <typename NameT = Aws::String>
  EcrRepositoryMetadata& WithName(NameT&& value) {
  ...
  inline void SetScanFrequency(EcrScanFrequency value) {
    m_scanFrequencyHasBeenSet = true;
    m_scanFrequency = value;
  }
  inline EcrRepositoryMetadata& WithScanFrequency(EcrScanFrequency value) {
