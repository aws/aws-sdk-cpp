...
class LambdaFunctionAggregation {
 public:
  ...
  inline LambdaFunctionAggregation& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSortBy(LambdaFunctionSortBy value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline LambdaFunctionAggregation& WithSortBy(LambdaFunctionSortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
