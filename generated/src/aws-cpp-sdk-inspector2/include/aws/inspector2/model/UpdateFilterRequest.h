...
class UpdateFilterRequest : public Inspector2Request {
 public:
  ...
  template <typename FilterCriteriaT = FilterCriteria>
  UpdateFilterRequest& WithFilterCriteria(FilterCriteriaT&& value) {
  ...
  template <typename NameT = Aws::String>
  UpdateFilterRequest& WithName(NameT&& value) {
  ...
  template <typename FilterArnT = Aws::String>
  UpdateFilterRequest& WithFilterArn(FilterArnT&& value) {
  ...
  template <typename ReasonT = Aws::String>
  UpdateFilterRequest& WithReason(ReasonT&& value) {
