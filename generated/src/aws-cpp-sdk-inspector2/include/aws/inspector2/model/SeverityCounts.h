...
class SeverityCounts {
 public:
  ...
  inline void SetAll(long long value) {
    m_allHasBeenSet = true;
    m_all = value;
  }
  inline SeverityCounts& WithAll(long long value) {
    SetAll(value);
    return *this;
  }
  ///@}
  ...
  inline SeverityCounts& WithMedium(long long value) {
    SetMedium(value);
    return *this;
  }
  ///@}
  ...
  inline SeverityCounts& WithHigh(long long value) {
    SetHigh(value);
    return *this;
  }
  ///@}
  ...
  inline SeverityCounts& WithCritical(long long value) {
    SetCritical(value);
    return *this;
  }
  ///@}
