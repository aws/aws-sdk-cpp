...
class CoverageStringFilter {
 public:
  ...
  inline void SetComparison(CoverageStringComparison value) {
    m_comparisonHasBeenSet = true;
    m_comparison = value;
  }
  inline CoverageStringFilter& WithComparison(CoverageStringComparison value) {
    SetComparison(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValueT = Aws::String>
  CoverageStringFilter& WithValue(ValueT&& value) {
