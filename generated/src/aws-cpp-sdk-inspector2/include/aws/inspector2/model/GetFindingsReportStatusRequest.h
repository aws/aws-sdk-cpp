...
namespace Model
{
  ...
  {
  public:
    AWS_INSPECTOR2_API GetFindingsReportStatusRequest() = default;
    ...
    template<typename ReportIdT = Aws::String>
    GetFindingsReportStatusRequest& WithReportId(ReportIdT&& value) { SetReportId(std::forward<ReportIdT>(value)); return *this;}
    ///@}
  private:
