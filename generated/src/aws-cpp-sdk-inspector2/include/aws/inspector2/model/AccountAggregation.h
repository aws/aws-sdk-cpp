...
class AccountAggregation {
 public:
  ...
  inline AccountAggregation& WithFindingType(AggregationFindingType value) {
  ...
  inline AccountAggregation& WithResourceType(AggregationResourceType value) {
  ...
  inline AccountAggregation& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSortBy(AccountSortBy value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline AccountAggregation& WithSortBy(AccountSortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
