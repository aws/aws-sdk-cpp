...
class EcrConfiguration {
 public:
  ...
  inline void SetRescanDuration(EcrRescanDuration value) {
    m_rescanDurationHasBeenSet = true;
    m_rescanDuration = value;
  }
  inline EcrConfiguration& WithRescanDuration(EcrRescanDuration value) {
    SetRescanDuration(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPullDateRescanDuration(EcrPullDateRescanDuration value) {
    m_pullDateRescanDurationHasBeenSet = true;
    m_pullDateRescanDuration = value;
  }
  inline EcrConfiguration& WithPullDateRescanDuration(EcrPullDateRescanDuration value) {
    SetPullDateRescanDuration(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPullDateRescanMode(EcrPullDateRescanMode value) {
    m_pullDateRescanModeHasBeenSet = true;
    m_pullDateRescanMode = value;
  }
  inline EcrConfiguration& WithPullDateRescanMode(EcrPullDateRescanMode value) {
    SetPullDateRescanMode(value);
    return *this;
  }
  ///@}
 private:
