...
class NetworkReachabilityDetails {
 public:
  ...
  void SetOpenPortRange(OpenPortRangeT&& value) {
    ...
    m_openPortRange = std::forward<OpenPortRangeT>(value);
  }
  template <typename OpenPortRangeT = PortRange>
  NetworkReachabilityDetails& WithOpenPortRange(OpenPortRangeT&& value) {
    SetOpenPortRange(std::forward<OpenPortRangeT>(value));
    return *this;
  }
  ///@}
  ...
  inline NetworkReachabilityDetails& WithProtocol(NetworkProtocol value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
