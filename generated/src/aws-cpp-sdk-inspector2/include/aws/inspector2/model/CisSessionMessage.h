...
class CisSessionMessage {
 public:
  ...
  inline void SetStatus(CisRuleStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline CisSessionMessage& WithStatus(CisRuleStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetCisRuleDetails(CisRuleDetailsT&& value) {
    ...
    m_cisRuleDetails = std::forward<CisRuleDetailsT>(value);
  }
  template <typename CisRuleDetailsT = Aws::Utils::ByteBuffer>
  CisSessionMessage& WithCisRuleDetails(CisRuleDetailsT&& value) {
    SetCisRuleDetails(std::forward<CisRuleDetailsT>(value));
    return *this;
  }
  ///@}
 private:
