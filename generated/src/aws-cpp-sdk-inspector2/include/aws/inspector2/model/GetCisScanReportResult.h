...
class GetCisScanReportResult {
 public:
  ...
  template <typename UrlT = Aws::String>
  GetCisScanReportResult& WithUrl(UrlT&& value) {
  ...
  inline void SetStatus(CisReportStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline GetCisScanReportResult& WithStatus(CisReportStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetCisScanReportResult& WithRequestId(RequestIdT&& value) {
