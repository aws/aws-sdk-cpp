...
class AtigData {
 public:
  ...
  template <typename FirstSeenT = Aws::Utils::DateTime>
  AtigData& WithFirstSeen(FirstSeenT&& value) {
  ...
  template <typename LastSeenT = Aws::Utils::DateTime>
  AtigData& WithLastSeen(LastSeenT&& value) {
