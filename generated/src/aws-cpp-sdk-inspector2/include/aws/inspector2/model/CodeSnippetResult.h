...
class CodeSnippetResult {
 public:
  ...
  template <typename FindingArnT = Aws::String>
  CodeSnippetResult& WithFindingArn(FindingArnT&& value) {
  ...
  inline CodeSnippetResult& WithStartLine(int value) {
    SetStartLine(value);
    return *this;
  }
  ///@}
  ...
  inline CodeSnippetResult& WithEndLine(int value) {
    SetEndLine(value);
    return *this;
  }
  ///@}
  ...
  void SetCodeSnippet(CodeSnippetT&& value) {
    ...
    m_codeSnippet = std::forward<CodeSnippetT>(value);
  }
  template <typename CodeSnippetT = Aws::Vector<CodeLine>>
  CodeSnippetResult& WithCodeSnippet(CodeSnippetT&& value) {
    SetCodeSnippet(std::forward<CodeSnippetT>(value));
    return *this;
  }
  template <typename CodeSnippetT = CodeLine>
  CodeSnippetResult& AddCodeSnippet(CodeSnippetT&& value) {
    m_codeSnippetHasBeenSet = true;
    m_codeSnippet.emplace_back(std::forward<CodeSnippetT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename SuggestedFixesT = Aws::Vector<SuggestedFix>>
  CodeSnippetResult& WithSuggestedFixes(SuggestedFixesT&& value) {
    SetSuggestedFixes(std::forward<SuggestedFixesT>(value));
    return *this;
  }
  template <typename SuggestedFixesT = SuggestedFix>
  CodeSnippetResult& AddSuggestedFixes(SuggestedFixesT&& value) {
    m_suggestedFixesHasBeenSet = true;
