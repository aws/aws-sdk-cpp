...
class CisResultStatusFilter {
 public:
  ...
  inline void SetComparison(CisResultStatusComparison value) {
    m_comparisonHasBeenSet = true;
    m_comparison = value;
  }
  inline CisResultStatusFilter& WithComparison(CisResultStatusComparison value) {
    SetComparison(value);
    return *this;
  }
  ///@}
  ...
  inline void SetValue(CisResultStatus value) {
    m_valueHasBeenSet = true;
    m_value = value;
  }
  inline CisResultStatusFilter& WithValue(CisResultStatus value) {
    SetValue(value);
    return *this;
  }
  ///@}
