...
class PortRangeFilter {
 public:
  ...
  inline void SetBeginInclusive(int value) {
    m_beginInclusiveHasBeenSet = true;
    m_beginInclusive = value;
  }
  inline PortRangeFilter& WithBeginInclusive(int value) {
    SetBeginInclusive(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEndInclusive(int value) {
    m_endInclusiveHasBeenSet = true;
    m_endInclusive = value;
  }
  inline PortRangeFilter& WithEndInclusive(int value) {
    SetEndInclusive(value);
    return *this;
  }
  ///@}
 private:
