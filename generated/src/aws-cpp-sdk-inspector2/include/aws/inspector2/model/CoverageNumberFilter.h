...
class CoverageNumberFilter {
 public:
  ...
  inline void SetUpperInclusive(long long value) {
    m_upperInclusiveHasBeenSet = true;
    m_upperInclusive = value;
  }
  inline CoverageNumberFilter& WithUpperInclusive(long long value) {
    SetUpperInclusive(value);
    return *this;
  }
  ///@}
  ...
  inline void SetLowerInclusive(long long value) {
    m_lowerInclusiveHasBeenSet = true;
    m_lowerInclusive = value;
  }
  inline CoverageNumberFilter& WithLowerInclusive(long long value) {
    SetLowerInclusive(value);
    return *this;
  }
  ///@}
 private:
