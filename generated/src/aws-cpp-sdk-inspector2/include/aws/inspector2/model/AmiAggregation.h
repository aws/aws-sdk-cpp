...
class AmiAggregation {
 public:
  ...
  inline AmiAggregation& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSortBy(AmiSortBy value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline AmiAggregation& WithSortBy(AmiSortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
