...
class ListConnectorsResult {
 public:
  AWS_INSPECTOR2_API ListConnectorsResult() = default;
  AWS_INSPECTOR2_API ListConnectorsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_INSPECTOR2_API ListConnectorsResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
