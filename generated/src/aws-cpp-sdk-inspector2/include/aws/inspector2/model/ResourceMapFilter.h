...
class ResourceMapFilter {
 public:
  ...
  inline void SetComparison(ResourceMapComparison value) {
    m_comparisonHasBeenSet = true;
    m_comparison = value;
  }
  inline ResourceMapFilter& WithComparison(ResourceMapComparison value) {
    SetComparison(value);
    return *this;
  }
  ///@}
  ...
  template <typename KeyT = Aws::String>
  ResourceMapFilter& WithKey(KeyT&& value) {
  ...
  template <typename ValueT = Aws::String>
  ResourceMapFilter& WithValue(ValueT&& value) {
