...
class BatchDisassociateCodeSecurityScanConfigurationResult {
 public:
  ...
  AWS_INSPECTOR2_API BatchDisassociateCodeSecurityScanConfigurationResult(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_INSPECTOR2_API BatchDisassociateCodeSecurityScanConfigurationResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename FailedAssociationsT = Aws::Vector<FailedAssociationResult>>
  BatchDisassociateCodeSecurityScanConfigurationResult& WithFailedAssociations(FailedAssociationsT&& value) {
    SetFailedAssociations(std::forward<FailedAssociationsT>(value));
    return *this;
  }
  template <typename FailedAssociationsT = FailedAssociationResult>
  BatchDisassociateCodeSecurityScanConfigurationResult& AddFailedAssociations(FailedAssociationsT&& value) {
    m_failedAssociationsHasBeenSet = true;
  ...
  void SetSuccessfulAssociations(SuccessfulAssociationsT&& value) {
    m_successfulAssociationsHasBeenSet = true;
    m_successfulAssociations = std::forward<SuccessfulAssociationsT>(value);
  }
  template <typename SuccessfulAssociationsT = Aws::Vector<SuccessfulAssociationResult>>
  BatchDisassociateCodeSecurityScanConfigurationResult& WithSuccessfulAssociations(SuccessfulAssociationsT&& value) {
    SetSuccessfulAssociations(std::forward<SuccessfulAssociationsT>(value));
    return *this;
  }
  template <typename SuccessfulAssociationsT = SuccessfulAssociationResult>
  BatchDisassociateCodeSecurityScanConfigurationResult& AddSuccessfulAssociations(SuccessfulAssociationsT&& value) {
    m_successfulAssociationsHasBeenSet = true;
    m_successfulAssociations.emplace_back(std::forward<SuccessfulAssociationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  BatchDisassociateCodeSecurityScanConfigurationResult& WithRequestId(RequestIdT&& value) {
