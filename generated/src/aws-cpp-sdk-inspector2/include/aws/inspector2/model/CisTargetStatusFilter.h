...
class CisTargetStatusFilter {
 public:
  ...
  inline CisTargetStatusFilter& WithComparison(CisTargetStatusComparison value) {
    SetComparison(value);
    return *this;
  }
  ///@}
  ...
  inline void SetValue(CisTargetStatus value) {
    m_valueHasBeenSet = true;
    m_value = value;
  }
  inline CisTargetStatusFilter& WithValue(CisTargetStatus value) {
    SetValue(value);
    return *this;
  }
  ///@}
