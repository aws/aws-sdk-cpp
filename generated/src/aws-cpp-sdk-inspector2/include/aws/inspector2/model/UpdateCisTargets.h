...
class UpdateCisTargets {
 public:
  AWS_INSPECTOR2_API UpdateCisTargets() = default;
  ...
  template <typename AccountIdsT = Aws::Vector<Aws::String>>
  UpdateCisTargets& WithAccountIds(AccountIdsT&& value) {
    SetAccountIds(std::forward<AccountIdsT>(value));
    return *this;
  }
  template <typename AccountIdsT = Aws::String>
  UpdateCisTargets& AddAccountIds(AccountIdsT&& value) {
    m_accountIdsHasBeenSet = true;
  ...
  void SetTargetResourceTags(TargetResourceTagsT&& value) {
    ...
    m_targetResourceTags = std::forward<TargetResourceTagsT>(value);
  }
  template <typename TargetResourceTagsT = Aws::Map<Aws::String, Aws::Vector<Aws::String>>>
  UpdateCisTargets& WithTargetResourceTags(TargetResourceTagsT&& value) {
    SetTargetResourceTags(std::forward<TargetResourceTagsT>(value));
    return *this;
  }
  template <typename TargetResourceTagsKeyT = Aws::String, typename TargetResourceTagsValueT = Aws::Vector<Aws::String>>
  UpdateCisTargets& AddTargetResourceTags(TargetResourceTagsKeyT&& key, TargetResourceTagsValueT&& value) {
    m_targetResourceTagsHasBeenSet = true;
    m_targetResourceTags.emplace(std::forward<TargetResourceTagsKeyT>(key), std::forward<TargetResourceTagsValueT>(value));
    return *this;
  }
  ///@}
 private:
