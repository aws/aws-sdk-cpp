...
class ListCodeSecurityScanConfigurationAssociationsRequest : public Inspector2Request {
 public:
  ...
  template <typename ScanConfigurationArnT = Aws::String>
  ListCodeSecurityScanConfigurationAssociationsRequest& WithScanConfigurationArn(ScanConfigurationArnT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListCodeSecurityScanConfigurationAssociationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListCodeSecurityScanConfigurationAssociationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
