...
class CodeRepositoryMetadata {
 public:
  ...
  void SetProviderType(ProviderTypeT&& value) {
    ...
    m_providerType = std::forward<ProviderTypeT>(value);
  }
  template <typename ProviderTypeT = Aws::String>
  CodeRepositoryMetadata& WithProviderType(ProviderTypeT&& value) {
    SetProviderType(std::forward<ProviderTypeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetProviderTypeVisibility(ProviderTypeVisibilityT&& value) {
    ...
    m_providerTypeVisibility = std::forward<ProviderTypeVisibilityT>(value);
  }
  template <typename ProviderTypeVisibilityT = Aws::String>
  CodeRepositoryMetadata& WithProviderTypeVisibility(ProviderTypeVisibilityT&& value) {
    SetProviderTypeVisibility(std::forward<ProviderTypeVisibilityT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOnDemandScan(OnDemandScanT&& value) {
    m_onDemandScanHasBeenSet = true;
    m_onDemandScan = std::forward<OnDemandScanT>(value);
  }
  template <typename OnDemandScanT = CodeRepositoryOnDemandScan>
  CodeRepositoryMetadata& WithOnDemandScan(OnDemandScanT&& value) {
    SetOnDemandScan(std::forward<OnDemandScanT>(value));
    return *this;
  }
  ///@}
 private:
