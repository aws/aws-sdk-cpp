...
class GetEc2DeepInspectionConfigurationResult {
 public:
  ...
  AWS_INSPECTOR2_API GetEc2DeepInspectionConfigurationResult& operator=(
  ...
  template <typename PackagePathsT = Aws::Vector<Aws::String>>
  GetEc2DeepInspectionConfigurationResult& WithPackagePaths(PackagePathsT&& value) {
    SetPackagePaths(std::forward<PackagePathsT>(value));
    return *this;
  }
  template <typename PackagePathsT = Aws::String>
  GetEc2DeepInspectionConfigurationResult& AddPackagePaths(PackagePathsT&& value) {
    m_packagePathsHasBeenSet = true;
  ...
  template <typename OrgPackagePathsT = Aws::Vector<Aws::String>>
  GetEc2DeepInspectionConfigurationResult& WithOrgPackagePaths(OrgPackagePathsT&& value) {
    SetOrgPackagePaths(std::forward<OrgPackagePathsT>(value));
    return *this;
  }
  template <typename OrgPackagePathsT = Aws::String>
  GetEc2DeepInspectionConfigurationResult& AddOrgPackagePaths(OrgPackagePathsT&& value) {
    m_orgPackagePathsHasBeenSet = true;
  ...
  inline GetEc2DeepInspectionConfigurationResult& WithStatus(Ec2DeepInspectionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ErrorMessageT = Aws::String>
  GetEc2DeepInspectionConfigurationResult& WithErrorMessage(ErrorMessageT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetEc2DeepInspectionConfigurationResult& WithRequestId(RequestIdT&& value) {
