...
class BatchGetCodeSnippetResult {
 public:
  ...
  void SetCodeSnippetResults(CodeSnippetResultsT&& value) {
    m_codeSnippetResultsHasBeenSet = true;
    m_codeSnippetResults = std::forward<CodeSnippetResultsT>(value);
  }
  template <typename CodeSnippetResultsT = Aws::Vector<CodeSnippetResult>>
  BatchGetCodeSnippetResult& WithCodeSnippetResults(CodeSnippetResultsT&& value) {
    SetCodeSnippetResults(std::forward<CodeSnippetResultsT>(value));
    return *this;
  }
  template <typename CodeSnippetResultsT = CodeSnippetResult>
  BatchGetCodeSnippetResult& AddCodeSnippetResults(CodeSnippetResultsT&& value) {
    m_codeSnippetResultsHasBeenSet = true;
    m_codeSnippetResults.emplace_back(std::forward<CodeSnippetResultsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ErrorsT = Aws::Vector<CodeSnippetError>>
  BatchGetCodeSnippetResult& WithErrors(ErrorsT&& value) {
    SetErrors(std::forward<ErrorsT>(value));
    return *this;
  }
  template <typename ErrorsT = CodeSnippetError>
  BatchGetCodeSnippetResult& AddErrors(ErrorsT&& value) {
    m_errorsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  BatchGetCodeSnippetResult& WithRequestId(RequestIdT&& value) {
