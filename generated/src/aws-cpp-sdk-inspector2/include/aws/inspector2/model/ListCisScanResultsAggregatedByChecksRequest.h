...
class ListCisScanResultsAggregatedByChecksRequest : public Inspector2Request {
 public:
  ...
  template <typename ScanArnT = Aws::String>
  ListCisScanResultsAggregatedByChecksRequest& WithScanArn(ScanArnT&& value) {
  ...
  template <typename FilterCriteriaT = CisScanResultsAggregatedByChecksFilterCriteria>
  ListCisScanResultsAggregatedByChecksRequest& WithFilterCriteria(FilterCriteriaT&& value) {
  ...
  inline void SetSortBy(CisScanResultsAggregatedByChecksSortBy value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ListCisScanResultsAggregatedByChecksRequest& WithSortBy(CisScanResultsAggregatedByChecksSortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListCisScanResultsAggregatedByChecksRequest& WithSortOrder(CisSortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListCisScanResultsAggregatedByChecksRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListCisScanResultsAggregatedByChecksRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
