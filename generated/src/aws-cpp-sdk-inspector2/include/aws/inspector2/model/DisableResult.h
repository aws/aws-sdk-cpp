...
class DisableResult {
 public:
  AWS_INSPECTOR2_API DisableResult() = default;
  ...
  template <typename AccountsT = Aws::Vector<Account>>
  DisableResult& WithAccounts(AccountsT&& value) {
    SetAccounts(std::forward<AccountsT>(value));
    return *this;
  }
  template <typename AccountsT = Account>
  DisableResult& AddAccounts(AccountsT&& value) {
    m_accountsHasBeenSet = true;
  ...
  template <typename FailedAccountsT = Aws::Vector<FailedAccount>>
  DisableResult& WithFailedAccounts(FailedAccountsT&& value) {
    SetFailedAccounts(std::forward<FailedAccountsT>(value));
    return *this;
  }
  template <typename FailedAccountsT = FailedAccount>
  DisableResult& AddFailedAccounts(FailedAccountsT&& value) {
    m_failedAccountsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DisableResult& WithRequestId(RequestIdT&& value) {
