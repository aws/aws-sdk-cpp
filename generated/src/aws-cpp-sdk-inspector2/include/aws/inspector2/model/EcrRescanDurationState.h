...
class EcrRescanDurationState {
 public:
  ...
  inline EcrRescanDurationState& WithRescanDuration(EcrRescanDuration value) {
  ...
  inline void SetStatus(EcrRescanDurationStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline EcrRescanDurationState& WithStatus(EcrRescanDurationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline EcrRescanDurationState& WithPullDateRescanDuration(EcrPullDateRescanDuration value) {
  ...
  inline EcrRescanDurationState& WithPullDateRescanMode(EcrPullDateRescanMode value) {
