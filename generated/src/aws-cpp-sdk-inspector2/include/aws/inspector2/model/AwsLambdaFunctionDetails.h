...
class AwsLambdaFunctionDetails {
 public:
  ...
  inline AwsLambdaFunctionDetails& WithRuntime(Runtime value) {
    SetRuntime(value);
    return *this;
  }
  ///@}
  ...
  inline AwsLambdaFunctionDetails& WithPackageType(PackageType value) {
  ...
  inline AwsLambdaFunctionDetails& AddArchitectures(Architecture value) {
    m_architecturesHasBeenSet = true;
