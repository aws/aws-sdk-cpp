...
class MemberAccountEc2DeepInspectionStatusState {
 public:
  ...
  template <typename AccountIdT = Aws::String>
  MemberAccountEc2DeepInspectionStatusState& WithAccountId(AccountIdT&& value) {
  ...
  inline MemberAccountEc2DeepInspectionStatusState& WithStatus(Ec2DeepInspectionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ErrorMessageT = Aws::String>
  MemberAccountEc2DeepInspectionStatusState& WithErrorMessage(ErrorMessageT&& value) {
