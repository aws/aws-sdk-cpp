...
class ResourceStringFilter {
 public:
  ...
  inline void SetComparison(ResourceStringComparison value) {
    m_comparisonHasBeenSet = true;
    m_comparison = value;
  }
  inline ResourceStringFilter& WithComparison(ResourceStringComparison value) {
    SetComparison(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValueT = Aws::String>
  ResourceStringFilter& WithValue(ValueT&& value) {
