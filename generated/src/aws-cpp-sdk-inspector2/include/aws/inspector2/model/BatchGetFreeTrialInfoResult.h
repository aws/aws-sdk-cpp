...
class BatchGetFreeTrialInfoResult {
 public:
  ...
  template <typename AccountsT = Aws::Vector<FreeTrialAccountInfo>>
  BatchGetFreeTrialInfoResult& WithAccounts(AccountsT&& value) {
    SetAccounts(std::forward<AccountsT>(value));
    return *this;
  }
  template <typename AccountsT = FreeTrialAccountInfo>
  BatchGetFreeTrialInfoResult& AddAccounts(AccountsT&& value) {
    m_accountsHasBeenSet = true;
  ...
  template <typename FailedAccountsT = Aws::Vector<FreeTrialInfoError>>
  BatchGetFreeTrialInfoResult& WithFailedAccounts(FailedAccountsT&& value) {
    SetFailedAccounts(std::forward<FailedAccountsT>(value));
    return *this;
  }
  template <typename FailedAccountsT = FreeTrialInfoError>
  BatchGetFreeTrialInfoResult& AddFailedAccounts(FailedAccountsT&& value) {
    m_failedAccountsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  BatchGetFreeTrialInfoResult& WithRequestId(RequestIdT&& value) {
