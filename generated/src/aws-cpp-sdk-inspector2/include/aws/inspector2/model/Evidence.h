...
class Evidence {
 public:
  ...
  void SetEvidenceRule(EvidenceRuleT&& value) {
    m_evidenceRuleHasBeenSet = true;
    m_evidenceRule = std::forward<EvidenceRuleT>(value);
  }
  template <typename EvidenceRuleT = Aws::String>
  Evidence& WithEvidenceRule(EvidenceRuleT&& value) {
    SetEvidenceRule(std::forward<EvidenceRuleT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEvidenceDetail(EvidenceDetailT&& value) {
    m_evidenceDetailHasBeenSet = true;
    m_evidenceDetail = std::forward<EvidenceDetailT>(value);
  }
  template <typename EvidenceDetailT = Aws::String>
  Evidence& WithEvidenceDetail(EvidenceDetailT&& value) {
    SetEvidenceDetail(std::forward<EvidenceDetailT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename SeverityT = Aws::String>
  Evidence& WithSeverity(SeverityT&& value) {
