...
class ListFindingAggregationsRequest : public Inspector2Request {
 public:
  ...
  inline ListFindingAggregationsRequest& WithAggregationType(AggregationType value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListFindingAggregationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListFindingAggregationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename AccountIdsT = Aws::Vector<StringFilter>>
  ListFindingAggregationsRequest& WithAccountIds(AccountIdsT&& value) {
    SetAccountIds(std::forward<AccountIdsT>(value));
    return *this;
  }
  template <typename AccountIdsT = StringFilter>
  ListFindingAggregationsRequest& AddAccountIds(AccountIdsT&& value) {
    m_accountIdsHasBeenSet = true;
  ...
  void SetAggregationRequest(AggregationRequestT&& value) {
    m_aggregationRequestHasBeenSet = true;
    m_aggregationRequest = std::forward<AggregationRequestT>(value);
  }
  template <typename AggregationRequestT = AggregationRequest>
  ListFindingAggregationsRequest& WithAggregationRequest(AggregationRequestT&& value) {
    SetAggregationRequest(std::forward<AggregationRequestT>(value));
    return *this;
  }
  ///@}
 private:
