...
class FreeTrialInfo {
 public:
  ...
  inline void SetType(FreeTrialType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline FreeTrialInfo& WithType(FreeTrialType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(FreeTrialStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline FreeTrialInfo& WithStatus(FreeTrialStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
