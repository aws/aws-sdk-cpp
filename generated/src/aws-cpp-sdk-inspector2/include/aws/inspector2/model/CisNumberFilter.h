...
class CisNumberFilter {
 public:
  ...
  inline void SetUpperInclusive(int value) {
    m_upperInclusiveHasBeenSet = true;
    m_upperInclusive = value;
  }
  inline CisNumberFilter& WithUpperInclusive(int value) {
  ...
  inline void SetLowerInclusive(int value) {
    m_lowerInclusiveHasBeenSet = true;
    m_lowerInclusive = value;
  }
  inline CisNumberFilter& WithLowerInclusive(int value) {
