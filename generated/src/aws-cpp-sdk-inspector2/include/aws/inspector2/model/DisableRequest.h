...
class DisableRequest : public Inspector2Request {
 public:
  AWS_INSPECTOR2_API DisableRequest() = default;
  ...
  template <typename AccountIdsT = Aws::Vector<Aws::String>>
  DisableRequest& WithAccountIds(AccountIdsT&& value) {
    SetAccountIds(std::forward<AccountIdsT>(value));
    return *this;
  }
  template <typename AccountIdsT = Aws::String>
  DisableRequest& AddAccountIds(AccountIdsT&& value) {
    m_accountIdsHasBeenSet = true;
  ...
  template <typename ResourceTypesT = Aws::Vector<ResourceScanType>>
  void SetResourceTypes(ResourceTypesT&& value) {
    m_resourceTypesHasBeenSet = true;
    m_resourceTypes = std::forward<ResourceTypesT>(value);
  }
  template <typename ResourceTypesT = Aws::Vector<ResourceScanType>>
  DisableRequest& WithResourceTypes(ResourceTypesT&& value) {
    SetResourceTypes(std::forward<ResourceTypesT>(value));
    return *this;
  }
  inline DisableRequest& AddResourceTypes(ResourceScanType value) {
    m_resourceTypesHasBeenSet = true;
