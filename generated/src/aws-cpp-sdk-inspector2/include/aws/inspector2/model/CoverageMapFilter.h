...
class CoverageMapFilter {
 public:
  ...
  inline void SetComparison(CoverageMapComparison value) {
    m_comparisonHasBeenSet = true;
    m_comparison = value;
  }
  inline CoverageMapFilter& WithComparison(CoverageMapComparison value) {
    SetComparison(value);
    return *this;
  }
  ///@}
  ...
  template <typename KeyT = Aws::String>
  CoverageMapFilter& WithKey(KeyT&& value) {
  ...
  template <typename ValueT = Aws::String>
  CoverageMapFilter& WithValue(ValueT&& value) {
