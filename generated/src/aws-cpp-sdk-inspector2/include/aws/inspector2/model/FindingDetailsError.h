...
class FindingDetailsError {
 public:
  ...
  template <typename FindingArnT = Aws::String>
  FindingDetailsError& WithFindingArn(FindingArnT&& value) {
  ...
  inline void SetErrorCode(FindingDetailsErrorCode value) {
    m_errorCodeHasBeenSet = true;
    m_errorCode = value;
  }
  inline FindingDetailsError& WithErrorCode(FindingDetailsErrorCode value) {
    SetErrorCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename ErrorMessageT = Aws::String>
  FindingDetailsError& WithErrorMessage(ErrorMessageT&& value) {
