...
class Finding {
 public:
  ...
  inline Finding& WithSeverity(Severity value) {
    SetSeverity(value);
    return *this;
  }
  ///@}
  ...
  inline void SetInspectorScore(double value) {
    m_inspectorScoreHasBeenSet = true;
    m_inspectorScore = value;
  }
  inline Finding& WithInspectorScore(double value) {
    SetInspectorScore(value);
    return *this;
  }
  ///@}
  ...
  void SetInspectorScoreDetails(InspectorScoreDetailsT&& value) {
    ...
    m_inspectorScoreDetails = std::forward<InspectorScoreDetailsT>(value);
  }
  template <typename InspectorScoreDetailsT = InspectorScoreDetails>
  Finding& WithInspectorScoreDetails(InspectorScoreDetailsT&& value) {
    SetInspectorScoreDetails(std::forward<InspectorScoreDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNetworkReachabilityDetails(NetworkReachabilityDetailsT&& value) {
    ...
    m_networkReachabilityDetails = std::forward<NetworkReachabilityDetailsT>(value);
  }
  template <typename NetworkReachabilityDetailsT = NetworkReachabilityDetails>
  Finding& WithNetworkReachabilityDetails(NetworkReachabilityDetailsT&& value) {
    SetNetworkReachabilityDetails(std::forward<NetworkReachabilityDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPackageVulnerabilityDetails(PackageVulnerabilityDetailsT&& value) {
    ...
    m_packageVulnerabilityDetails = std::forward<PackageVulnerabilityDetailsT>(value);
  }
  template <typename PackageVulnerabilityDetailsT = PackageVulnerabilityDetails>
  Finding& WithPackageVulnerabilityDetails(PackageVulnerabilityDetailsT&& value) {
    SetPackageVulnerabilityDetails(std::forward<PackageVulnerabilityDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetFixAvailable(FixAvailable value) {
    m_fixAvailableHasBeenSet = true;
    m_fixAvailable = value;
  }
  inline Finding& WithFixAvailable(FixAvailable value) {
    SetFixAvailable(value);
    return *this;
  }
  ///@}
  ...
  inline void SetExploitAvailable(ExploitAvailable value) {
    m_exploitAvailableHasBeenSet = true;
    m_exploitAvailable = value;
  }
  inline Finding& WithExploitAvailable(ExploitAvailable value) {
    SetExploitAvailable(value);
    return *this;
  }
  ///@}
  ...
  void SetExploitabilityDetails(ExploitabilityDetailsT&& value) {
    ...
    m_exploitabilityDetails = std::forward<ExploitabilityDetailsT>(value);
  }
  template <typename ExploitabilityDetailsT = ExploitabilityDetails>
  Finding& WithExploitabilityDetails(ExploitabilityDetailsT&& value) {
    SetExploitabilityDetails(std::forward<ExploitabilityDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCodeVulnerabilityDetails(CodeVulnerabilityDetailsT&& value) {
    ...
    m_codeVulnerabilityDetails = std::forward<CodeVulnerabilityDetailsT>(value);
  }
  template <typename CodeVulnerabilityDetailsT = CodeVulnerabilityDetails>
  Finding& WithCodeVulnerabilityDetails(CodeVulnerabilityDetailsT&& value) {
    SetCodeVulnerabilityDetails(std::forward<CodeVulnerabilityDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEpss(EpssT&& value) {
    ...
    m_epss = std::forward<EpssT>(value);
  }
  template <typename EpssT = EpssDetails>
  Finding& WithEpss(EpssT&& value) {
    SetEpss(std::forward<EpssT>(value));
    return *this;
  }
  ///@}
 private:
