...
class AutoEnable {
 public:
  ...
  inline void SetEc2(bool value) {
    m_ec2HasBeenSet = true;
    m_ec2 = value;
  }
  inline AutoEnable& WithEc2(bool value) {
    SetEc2(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEcr(bool value) {
    m_ecrHasBeenSet = true;
    m_ecr = value;
  }
  inline AutoEnable& WithEcr(bool value) {
    SetEcr(value);
    return *this;
  }
  ///@}
  ...
  inline void SetLambda(bool value) {
    m_lambdaHasBeenSet = true;
    m_lambda = value;
  }
  inline AutoEnable& WithLambda(bool value) {
    SetLambda(value);
    return *this;
  }
  ///@}
  ...
  inline void SetLambdaCode(bool value) {
    m_lambdaCodeHasBeenSet = true;
    m_lambdaCode = value;
  }
  inline AutoEnable& WithLambdaCode(bool value) {
    SetLambdaCode(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCodeRepository(bool value) {
    ...
    m_codeRepository = value;
  }
  inline AutoEnable& WithCodeRepository(bool value) {
