...
namespace Model
{
  ...
  {
  public:
    AWS_INSPECTOR2_API BatchGetFindingDetailsRequest() = default;
    ...
    template<typename FindingArnsT = Aws::Vector<Aws::String>>
    BatchGetFindingDetailsRequest& WithFindingArns(FindingArnsT&& value) { SetFindingArns(std::forward<FindingArnsT>(value)); return *this;}
    template<typename FindingArnsT = Aws::String>
    BatchGetFindingDetailsRequest& AddFindingArns(FindingArnsT&& value) { m_findingArnsHasBeenSet = true; m_findingArns.emplace_back(std::forward<FindingArnsT>(value)); return *this; }
    ///@}
  private:
