...
class Ec2InstanceAggregation {
 public:
  ...
  inline Ec2InstanceAggregation& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSortBy(Ec2InstanceSortBy value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline Ec2InstanceAggregation& WithSortBy(Ec2InstanceSortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
