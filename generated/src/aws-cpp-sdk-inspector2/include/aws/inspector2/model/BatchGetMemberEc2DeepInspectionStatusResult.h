...
class BatchGetMemberEc2DeepInspectionStatusResult {
 public:
  ...
  AWS_INSPECTOR2_API BatchGetMemberEc2DeepInspectionStatusResult& operator=(
  ...
  template <typename AccountIdsT = Aws::Vector<MemberAccountEc2DeepInspectionStatusState>>
  BatchGetMemberEc2DeepInspectionStatusResult& WithAccountIds(AccountIdsT&& value) {
    SetAccountIds(std::forward<AccountIdsT>(value));
    return *this;
  }
  template <typename AccountIdsT = MemberAccountEc2DeepInspectionStatusState>
  BatchGetMemberEc2DeepInspectionStatusResult& AddAccountIds(AccountIdsT&& value) {
    m_accountIdsHasBeenSet = true;
  ...
  template <typename FailedAccountIdsT = Aws::Vector<FailedMemberAccountEc2DeepInspectionStatusState>>
  BatchGetMemberEc2DeepInspectionStatusResult& WithFailedAccountIds(FailedAccountIdsT&& value) {
  ...
  BatchGetMemberEc2DeepInspectionStatusResult& AddFailedAccountIds(FailedAccountIdsT&& value) {
    m_failedAccountIdsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  BatchGetMemberEc2DeepInspectionStatusResult& WithRequestId(RequestIdT&& value) {
