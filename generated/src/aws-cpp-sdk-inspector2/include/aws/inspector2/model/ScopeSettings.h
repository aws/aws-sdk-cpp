...
class ScopeSettings {
 public:
  ...
  inline void SetProjectSelectionScope(ProjectSelectionScope value) {
    m_projectSelectionScopeHasBeenSet = true;
    m_projectSelectionScope = value;
  }
  inline ScopeSettings& WithProjectSelectionScope(ProjectSelectionScope value) {
    SetProjectSelectionScope(value);
    return *this;
  }
  ///@}
 private:
