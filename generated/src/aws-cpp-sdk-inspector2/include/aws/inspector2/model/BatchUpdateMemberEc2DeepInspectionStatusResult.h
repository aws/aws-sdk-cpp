...
class BatchUpdateMemberEc2DeepInspectionStatusResult {
 public:
  ...
  AWS_INSPECTOR2_API BatchUpdateMemberEc2DeepInspectionStatusResult& operator=(
  ...
  template <typename AccountIdsT = Aws::Vector<MemberAccountEc2DeepInspectionStatusState>>
  BatchUpdateMemberEc2DeepInspectionStatusResult& WithAccountIds(AccountIdsT&& value) {
    SetAccountIds(std::forward<AccountIdsT>(value));
    return *this;
  }
  template <typename AccountIdsT = MemberAccountEc2DeepInspectionStatusState>
  BatchUpdateMemberEc2DeepInspectionStatusResult& AddAccountIds(AccountIdsT&& value) {
    m_accountIdsHasBeenSet = true;
  ...
  void SetFailedAccountIds(FailedAccountIdsT&& value) {
    m_failedAccountIdsHasBeenSet = true;
    m_failedAccountIds = std::forward<FailedAccountIdsT>(value);
  }
  template <typename FailedAccountIdsT = Aws::Vector<FailedMemberAccountEc2DeepInspectionStatusState>>
  BatchUpdateMemberEc2DeepInspectionStatusResult& WithFailedAccountIds(FailedAccountIdsT&& value) {
    SetFailedAccountIds(std::forward<FailedAccountIdsT>(value));
    return *this;
  }
  template <typename FailedAccountIdsT = FailedMemberAccountEc2DeepInspectionStatusState>
  BatchUpdateMemberEc2DeepInspectionStatusResult& AddFailedAccountIds(FailedAccountIdsT&& value) {
    m_failedAccountIdsHasBeenSet = true;
    m_failedAccountIds.emplace_back(std::forward<FailedAccountIdsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  BatchUpdateMemberEc2DeepInspectionStatusResult& WithRequestId(RequestIdT&& value) {
