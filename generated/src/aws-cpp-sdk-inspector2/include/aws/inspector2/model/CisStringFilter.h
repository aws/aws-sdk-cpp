...
class CisStringFilter {
 public:
  ...
  inline void SetComparison(CisStringComparison value) {
    m_comparisonHasBeenSet = true;
    m_comparison = value;
  }
  inline CisStringFilter& WithComparison(CisStringComparison value) {
    SetComparison(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValueT = Aws::String>
  CisStringFilter& WithValue(ValueT&& value) {
