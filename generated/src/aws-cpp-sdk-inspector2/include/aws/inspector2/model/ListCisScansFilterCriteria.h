...
class ListCisScansFilterCriteria {
 public:
  ...
  template <typename ScanNameFiltersT = Aws::Vector<CisStringFilter>>
  ListCisScansFilterCriteria& WithScanNameFilters(ScanNameFiltersT&& value) {
    SetScanNameFilters(std::forward<ScanNameFiltersT>(value));
    return *this;
  }
  template <typename ScanNameFiltersT = CisStringFilter>
  ListCisScansFilterCriteria& AddScanNameFilters(ScanNameFiltersT&& value) {
    m_scanNameFiltersHasBeenSet = true;
  ...
  template <typename TargetResourceTagFiltersT = Aws::Vector<TagFilter>>
  ListCisScansFilterCriteria& WithTargetResourceTagFilters(TargetResourceTagFiltersT&& value) {
  ...
  ListCisScansFilterCriteria& AddTargetResourceTagFilters(TargetResourceTagFiltersT&& value) {
    m_targetResourceTagFiltersHasBeenSet = true;
  ...
  template <typename TargetResourceIdFiltersT = Aws::Vector<CisStringFilter>>
  ListCisScansFilterCriteria& WithTargetResourceIdFilters(TargetResourceIdFiltersT&& value) {
  ...
  ListCisScansFilterCriteria& AddTargetResourceIdFilters(TargetResourceIdFiltersT&& value) {
    m_targetResourceIdFiltersHasBeenSet = true;
  ...
  void SetScanStatusFilters(ScanStatusFiltersT&& value) {
    m_scanStatusFiltersHasBeenSet = true;
    m_scanStatusFilters = std::forward<ScanStatusFiltersT>(value);
  }
  template <typename ScanStatusFiltersT = Aws::Vector<CisScanStatusFilter>>
  ListCisScansFilterCriteria& WithScanStatusFilters(ScanStatusFiltersT&& value) {
    SetScanStatusFilters(std::forward<ScanStatusFiltersT>(value));
    return *this;
  }
  template <typename ScanStatusFiltersT = CisScanStatusFilter>
  ListCisScansFilterCriteria& AddScanStatusFilters(ScanStatusFiltersT&& value) {
    m_scanStatusFiltersHasBeenSet = true;
    m_scanStatusFilters.emplace_back(std::forward<ScanStatusFiltersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetScanAtFilters(ScanAtFiltersT&& value) {
    m_scanAtFiltersHasBeenSet = true;
    m_scanAtFilters = std::forward<ScanAtFiltersT>(value);
  }
  template <typename ScanAtFiltersT = Aws::Vector<CisDateFilter>>
  ListCisScansFilterCriteria& WithScanAtFilters(ScanAtFiltersT&& value) {
    SetScanAtFilters(std::forward<ScanAtFiltersT>(value));
    return *this;
  }
  template <typename ScanAtFiltersT = CisDateFilter>
  ListCisScansFilterCriteria& AddScanAtFilters(ScanAtFiltersT&& value) {
    m_scanAtFiltersHasBeenSet = true;
    m_scanAtFilters.emplace_back(std::forward<ScanAtFiltersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ScanConfigurationArnFiltersT = Aws::Vector<CisStringFilter>>
  ListCisScansFilterCriteria& WithScanConfigurationArnFilters(ScanConfigurationArnFiltersT&& value) {
  ...
  ListCisScansFilterCriteria& AddScanConfigurationArnFilters(ScanConfigurationArnFiltersT&& value) {
    m_scanConfigurationArnFiltersHasBeenSet = true;
  ...
  void SetScanArnFilters(ScanArnFiltersT&& value) {
    m_scanArnFiltersHasBeenSet = true;
    m_scanArnFilters = std::forward<ScanArnFiltersT>(value);
  }
  template <typename ScanArnFiltersT = Aws::Vector<CisStringFilter>>
  ListCisScansFilterCriteria& WithScanArnFilters(ScanArnFiltersT&& value) {
    SetScanArnFilters(std::forward<ScanArnFiltersT>(value));
    return *this;
  }
  template <typename ScanArnFiltersT = CisStringFilter>
  ListCisScansFilterCriteria& AddScanArnFilters(ScanArnFiltersT&& value) {
    m_scanArnFiltersHasBeenSet = true;
    m_scanArnFilters.emplace_back(std::forward<ScanArnFiltersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetScheduledByFilters(ScheduledByFiltersT&& value) {
    m_scheduledByFiltersHasBeenSet = true;
    m_scheduledByFilters = std::forward<ScheduledByFiltersT>(value);
  }
  template <typename ScheduledByFiltersT = Aws::Vector<CisStringFilter>>
  ListCisScansFilterCriteria& WithScheduledByFilters(ScheduledByFiltersT&& value) {
    SetScheduledByFilters(std::forward<ScheduledByFiltersT>(value));
    return *this;
  }
  template <typename ScheduledByFiltersT = CisStringFilter>
  ListCisScansFilterCriteria& AddScheduledByFilters(ScheduledByFiltersT&& value) {
    m_scheduledByFiltersHasBeenSet = true;
    m_scheduledByFilters.emplace_back(std::forward<ScheduledByFiltersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename FailedChecksFiltersT = Aws::Vector<CisNumberFilter>>
  ListCisScansFilterCriteria& WithFailedChecksFilters(FailedChecksFiltersT&& value) {
    SetFailedChecksFilters(std::forward<FailedChecksFiltersT>(value));
    return *this;
  }
  template <typename FailedChecksFiltersT = CisNumberFilter>
  ListCisScansFilterCriteria& AddFailedChecksFilters(FailedChecksFiltersT&& value) {
    m_failedChecksFiltersHasBeenSet = true;
  ...
  void SetTargetAccountIdFilters(TargetAccountIdFiltersT&& value) {
    m_targetAccountIdFiltersHasBeenSet = true;
    m_targetAccountIdFilters = std::forward<TargetAccountIdFiltersT>(value);
  }
  template <typename TargetAccountIdFiltersT = Aws::Vector<CisStringFilter>>
  ListCisScansFilterCriteria& WithTargetAccountIdFilters(TargetAccountIdFiltersT&& value) {
    SetTargetAccountIdFilters(std::forward<TargetAccountIdFiltersT>(value));
    return *this;
  }
  template <typename TargetAccountIdFiltersT = CisStringFilter>
  ListCisScansFilterCriteria& AddTargetAccountIdFilters(TargetAccountIdFiltersT&& value) {
    m_targetAccountIdFiltersHasBeenSet = true;
    m_targetAccountIdFilters.emplace_back(std::forward<TargetAccountIdFiltersT>(value));
    return *this;
  }
  ///@}
 private:
