...
class Account {
 public:
  ...
  inline Account& WithStatus(Status value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetResourceStatus(ResourceStatusT&& value) {
    m_resourceStatusHasBeenSet = true;
    m_resourceStatus = std::forward<ResourceStatusT>(value);
  }
  template <typename ResourceStatusT = ResourceStatus>
  Account& WithResourceStatus(ResourceStatusT&& value) {
    SetResourceStatus(std::forward<ResourceStatusT>(value));
    return *this;
  }
  ///@}
 private:
