...
class ResourceDetails {
 public:
  ...
  void SetAwsEc2Instance(AwsEc2InstanceT&& value) {
    ...
    m_awsEc2Instance = std::forward<AwsEc2InstanceT>(value);
  }
  template <typename AwsEc2InstanceT = AwsEc2InstanceDetails>
  ResourceDetails& WithAwsEc2Instance(AwsEc2InstanceT&& value) {
    SetAwsEc2Instance(std::forward<AwsEc2InstanceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAwsEcrContainerImage(AwsEcrContainerImageT&& value) {
    ...
    m_awsEcrContainerImage = std::forward<AwsEcrContainerImageT>(value);
  }
  template <typename AwsEcrContainerImageT = AwsEcrContainerImageDetails>
  ResourceDetails& WithAwsEcrContainerImage(AwsEcrContainerImageT&& value) {
    SetAwsEcrContainerImage(std::forward<AwsEcrContainerImageT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAwsLambdaFunction(AwsLambdaFunctionT&& value) {
    ...
    m_awsLambdaFunction = std::forward<AwsLambdaFunctionT>(value);
  }
  template <typename AwsLambdaFunctionT = AwsLambdaFunctionDetails>
  ResourceDetails& WithAwsLambdaFunction(AwsLambdaFunctionT&& value) {
    SetAwsLambdaFunction(std::forward<AwsLambdaFunctionT>(value));
    return *this;
  }
  ///@}
