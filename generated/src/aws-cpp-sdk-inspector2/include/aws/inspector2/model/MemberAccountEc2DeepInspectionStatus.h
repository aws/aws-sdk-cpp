...
class MemberAccountEc2DeepInspectionStatus {
 public:
  ...
  template <typename AccountIdT = Aws::String>
  MemberAccountEc2DeepInspectionStatus& WithAccountId(AccountIdT&& value) {
  ...
  inline void SetActivateDeepInspection(bool value) {
    m_activateDeepInspectionHasBeenSet = true;
    m_activateDeepInspection = value;
  }
  inline MemberAccountEc2DeepInspectionStatus& WithActivateDeepInspection(bool value) {
    SetActivateDeepInspection(value);
    return *this;
  }
  ///@}
 private:
