...
class GetClustersForImageRequest : public Inspector2Request {
 public:
  ...
  template <typename FilterT = ClusterForImageFilterCriteria>
  GetClustersForImageRequest& WithFilter(FilterT&& value) {
  ...
  inline GetClustersForImageRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetClustersForImageRequest& WithNextToken(NextTokenT&& value) {
