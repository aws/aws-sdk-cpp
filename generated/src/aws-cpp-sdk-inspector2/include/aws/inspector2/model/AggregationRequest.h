...
class AggregationRequest {
 public:
  ...
  void SetAmiAggregation(AmiAggregationT&& value) {
    ...
    m_amiAggregation = std::forward<AmiAggregationT>(value);
  }
  template <typename AmiAggregationT = AmiAggregation>
  AggregationRequest& WithAmiAggregation(AmiAggregationT&& value) {
    SetAmiAggregation(std::forward<AmiAggregationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAwsEcrContainerAggregation(AwsEcrContainerAggregationT&& value) {
    ...
    m_awsEcrContainerAggregation = std::forward<AwsEcrContainerAggregationT>(value);
  }
  template <typename AwsEcrContainerAggregationT = AwsEcrContainerAggregation>
  AggregationRequest& WithAwsEcrContainerAggregation(AwsEcrContainerAggregationT&& value) {
    SetAwsEcrContainerAggregation(std::forward<AwsEcrContainerAggregationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEc2InstanceAggregation(Ec2InstanceAggregationT&& value) {
    ...
    m_ec2InstanceAggregation = std::forward<Ec2InstanceAggregationT>(value);
  }
  template <typename Ec2InstanceAggregationT = Ec2InstanceAggregation>
  AggregationRequest& WithEc2InstanceAggregation(Ec2InstanceAggregationT&& value) {
    SetEc2InstanceAggregation(std::forward<Ec2InstanceAggregationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFindingTypeAggregation(FindingTypeAggregationT&& value) {
    ...
    m_findingTypeAggregation = std::forward<FindingTypeAggregationT>(value);
  }
  template <typename FindingTypeAggregationT = FindingTypeAggregation>
  AggregationRequest& WithFindingTypeAggregation(FindingTypeAggregationT&& value) {
    SetFindingTypeAggregation(std::forward<FindingTypeAggregationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetImageLayerAggregation(ImageLayerAggregationT&& value) {
    ...
    m_imageLayerAggregation = std::forward<ImageLayerAggregationT>(value);
  }
  template <typename ImageLayerAggregationT = ImageLayerAggregation>
  AggregationRequest& WithImageLayerAggregation(ImageLayerAggregationT&& value) {
    SetImageLayerAggregation(std::forward<ImageLayerAggregationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPackageAggregation(PackageAggregationT&& value) {
    ...
    m_packageAggregation = std::forward<PackageAggregationT>(value);
  }
  template <typename PackageAggregationT = PackageAggregation>
  AggregationRequest& WithPackageAggregation(PackageAggregationT&& value) {
    SetPackageAggregation(std::forward<PackageAggregationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRepositoryAggregation(RepositoryAggregationT&& value) {
    ...
    m_repositoryAggregation = std::forward<RepositoryAggregationT>(value);
  }
  template <typename RepositoryAggregationT = RepositoryAggregation>
  AggregationRequest& WithRepositoryAggregation(RepositoryAggregationT&& value) {
    SetRepositoryAggregation(std::forward<RepositoryAggregationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTitleAggregation(TitleAggregationT&& value) {
    ...
    m_titleAggregation = std::forward<TitleAggregationT>(value);
  }
  template <typename TitleAggregationT = TitleAggregation>
  AggregationRequest& WithTitleAggregation(TitleAggregationT&& value) {
    SetTitleAggregation(std::forward<TitleAggregationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLambdaLayerAggregation(LambdaLayerAggregationT&& value) {
    ...
    m_lambdaLayerAggregation = std::forward<LambdaLayerAggregationT>(value);
  }
  template <typename LambdaLayerAggregationT = LambdaLayerAggregation>
  AggregationRequest& WithLambdaLayerAggregation(LambdaLayerAggregationT&& value) {
    SetLambdaLayerAggregation(std::forward<LambdaLayerAggregationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLambdaFunctionAggregation(LambdaFunctionAggregationT&& value) {
    ...
    m_lambdaFunctionAggregation = std::forward<LambdaFunctionAggregationT>(value);
  }
  template <typename LambdaFunctionAggregationT = LambdaFunctionAggregation>
  AggregationRequest& WithLambdaFunctionAggregation(LambdaFunctionAggregationT&& value) {
    SetLambdaFunctionAggregation(std::forward<LambdaFunctionAggregationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCodeRepositoryAggregation(CodeRepositoryAggregationT&& value) {
    ...
    m_codeRepositoryAggregation = std::forward<CodeRepositoryAggregationT>(value);
  }
  template <typename CodeRepositoryAggregationT = CodeRepositoryAggregation>
  AggregationRequest& WithCodeRepositoryAggregation(CodeRepositoryAggregationT&& value) {
    SetCodeRepositoryAggregation(std::forward<CodeRepositoryAggregationT>(value));
    return *this;
  }
  ///@}
  ...
  ///@{
  /**
   * <p>An object that contains details about an aggregation request based on virtual
   * machine (VM) instances.</p>
   */
  inline const VmInstanceAggregation& GetVmInstanceAggregation() const { return m_vmInstanceAggregation; }
  inline bool VmInstanceAggregationHasBeenSet() const { return m_vmInstanceAggregationHasBeenSet; }
  template <typename VmInstanceAggregationT = VmInstanceAggregation>
   ...
   * container images.</p>
   */
  inline const ContainerImageAggregation& GetContainerImageAggregation() const { return m_containerImageAggregation; }
  inline bool ContainerImageAggregationHasBeenSet() const { return m_containerImageAggregationHasBeenSet; }
  template <typename ContainerImageAggregationT = ContainerImageAggregation>
   ...
   */
  inline const ServerlessFunctionAggregation& GetServerlessFunctionAggregation() const { return m_serverlessFunctionAggregation; }
  inline bool ServerlessFunctionAggregationHasBeenSet() const { return m_serverlessFunctionAggregationHasBeenSet; }
  template <typename ServerlessFunctionAggregationT = ServerlessFunctionAggregation>
 ...
 private:
  ...
  VmInstanceAggregation m_vmInstanceAggregation;

  ContainerImageAggregation m_containerImageAggregation;

  ServerlessFunctionAggregation m_serverlessFunctionAggregation;
