...
class RepositoryAggregation {
 public:
  ...
  template <typename RepositoriesT = Aws::Vector<StringFilter>>
  RepositoryAggregation& WithRepositories(RepositoriesT&& value) {
    SetRepositories(std::forward<RepositoriesT>(value));
    return *this;
  }
  template <typename RepositoriesT = StringFilter>
  RepositoryAggregation& AddRepositories(RepositoriesT&& value) {
    m_repositoriesHasBeenSet = true;
  ...
  inline RepositoryAggregation& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSortBy(RepositorySortBy value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline RepositoryAggregation& WithSortBy(RepositorySortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
