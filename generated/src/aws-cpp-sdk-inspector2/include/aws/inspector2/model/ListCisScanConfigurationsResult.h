...
class ListCisScanConfigurationsResult {
 public:
  ...
  template <typename ScanConfigurationsT = Aws::Vector<CisScanConfiguration>>
  ListCisScanConfigurationsResult& WithScanConfigurations(ScanConfigurationsT&& value) {
    SetScanConfigurations(std::forward<ScanConfigurationsT>(value));
    return *this;
  }
  template <typename ScanConfigurationsT = CisScanConfiguration>
  ListCisScanConfigurationsResult& AddScanConfigurations(ScanConfigurationsT&& value) {
    m_scanConfigurationsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListCisScanConfigurationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListCisScanConfigurationsResult& WithRequestId(RequestIdT&& value) {
