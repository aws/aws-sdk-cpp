...
class CisFindingStatusFilter {
 public:
  ...
  inline void SetComparison(CisFindingStatusComparison value) {
    m_comparisonHasBeenSet = true;
    m_comparison = value;
  }
  inline CisFindingStatusFilter& WithComparison(CisFindingStatusComparison value) {
    SetComparison(value);
    return *this;
  }
  ///@}
  ...
  inline void SetValue(CisFindingStatus value) {
    m_valueHasBeenSet = true;
    m_value = value;
  }
  inline CisFindingStatusFilter& WithValue(CisFindingStatus value) {
    SetValue(value);
    return *this;
  }
  ///@}
