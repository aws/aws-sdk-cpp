...
class ListCoverageResult {
 public:
  ...
  void SetCoveredResources(CoveredResourcesT&& value) {
    m_coveredResourcesHasBeenSet = true;
    m_coveredResources = std::forward<CoveredResourcesT>(value);
  }
  template <typename CoveredResourcesT = Aws::Vector<CoveredResource>>
  ListCoverageResult& WithCoveredResources(CoveredResourcesT&& value) {
    SetCoveredResources(std::forward<CoveredResourcesT>(value));
    return *this;
  }
  template <typename CoveredResourcesT = CoveredResource>
  ListCoverageResult& AddCoveredResources(CoveredResourcesT&& value) {
    m_coveredResourcesHasBeenSet = true;
    m_coveredResources.emplace_back(std::forward<CoveredResourcesT>(value));
    return *this;
  }
  ///@}
