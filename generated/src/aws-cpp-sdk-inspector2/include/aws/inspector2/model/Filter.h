...
class Filter {
 public:
  AWS_INSPECTOR2_API Filter() = default;
  ...
  template <typename OwnerIdT = Aws::String>
  Filter& WithOwnerId(OwnerIdT&& value) {
  ...
  inline Filter& WithAction(FilterAction value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  Filter& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  Filter& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  Filter& WithDescription(DescriptionT&& value) {
  ...
  template <typename ReasonT = Aws::String>
  Filter& WithReason(ReasonT&& value) {
  ...
  Filter& AddTags(TagsKeyT&& key, TagsValueT&& value) {
    m_tagsHasBeenSet = true;
