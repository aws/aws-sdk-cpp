...
class SearchVulnerabilitiesResult {
 public:
  ...
  template <typename VulnerabilitiesT = Aws::Vector<Vulnerability>>
  SearchVulnerabilitiesResult& WithVulnerabilities(VulnerabilitiesT&& value) {
    SetVulnerabilities(std::forward<VulnerabilitiesT>(value));
    return *this;
  }
  template <typename VulnerabilitiesT = Vulnerability>
  SearchVulnerabilitiesResult& AddVulnerabilities(VulnerabilitiesT&& value) {
    m_vulnerabilitiesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  SearchVulnerabilitiesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  SearchVulnerabilitiesResult& WithRequestId(RequestIdT&& value) {
