...
class CisScanResultsAggregatedByTargetResourceFilterCriteria {
 public:
  ...
  void SetAccountIdFilters(AccountIdFiltersT&& value) {
    m_accountIdFiltersHasBeenSet = true;
    m_accountIdFilters = std::forward<AccountIdFiltersT>(value);
  }
  template <typename AccountIdFiltersT = Aws::Vector<CisStringFilter>>
  CisScanResultsAggregatedByTargetResourceFilterCriteria& WithAccountIdFilters(AccountIdFiltersT&& value) {
    SetAccountIdFilters(std::forward<AccountIdFiltersT>(value));
    return *this;
  }
  template <typename AccountIdFiltersT = CisStringFilter>
  CisScanResultsAggregatedByTargetResourceFilterCriteria& AddAccountIdFilters(AccountIdFiltersT&& value) {
    m_accountIdFiltersHasBeenSet = true;
    m_accountIdFilters.emplace_back(std::forward<AccountIdFiltersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStatusFilters(StatusFiltersT&& value) {
    m_statusFiltersHasBeenSet = true;
    m_statusFilters = std::forward<StatusFiltersT>(value);
  }
  template <typename StatusFiltersT = Aws::Vector<CisResultStatusFilter>>
  CisScanResultsAggregatedByTargetResourceFilterCriteria& WithStatusFilters(StatusFiltersT&& value) {
    SetStatusFilters(std::forward<StatusFiltersT>(value));
    return *this;
  }
  template <typename StatusFiltersT = CisResultStatusFilter>
  CisScanResultsAggregatedByTargetResourceFilterCriteria& AddStatusFilters(StatusFiltersT&& value) {
    m_statusFiltersHasBeenSet = true;
    m_statusFilters.emplace_back(std::forward<StatusFiltersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCheckIdFilters(CheckIdFiltersT&& value) {
    m_checkIdFiltersHasBeenSet = true;
    m_checkIdFilters = std::forward<CheckIdFiltersT>(value);
  }
  template <typename CheckIdFiltersT = Aws::Vector<CisStringFilter>>
  CisScanResultsAggregatedByTargetResourceFilterCriteria& WithCheckIdFilters(CheckIdFiltersT&& value) {
    SetCheckIdFilters(std::forward<CheckIdFiltersT>(value));
    return *this;
  }
  template <typename CheckIdFiltersT = CisStringFilter>
  CisScanResultsAggregatedByTargetResourceFilterCriteria& AddCheckIdFilters(CheckIdFiltersT&& value) {
    m_checkIdFiltersHasBeenSet = true;
    m_checkIdFilters.emplace_back(std::forward<CheckIdFiltersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTargetResourceIdFilters(TargetResourceIdFiltersT&& value) {
    m_targetResourceIdFiltersHasBeenSet = true;
    m_targetResourceIdFilters = std::forward<TargetResourceIdFiltersT>(value);
  }
  template <typename TargetResourceIdFiltersT = Aws::Vector<CisStringFilter>>
  CisScanResultsAggregatedByTargetResourceFilterCriteria& WithTargetResourceIdFilters(TargetResourceIdFiltersT&& value) {
    SetTargetResourceIdFilters(std::forward<TargetResourceIdFiltersT>(value));
    return *this;
  }
  template <typename TargetResourceIdFiltersT = CisStringFilter>
  CisScanResultsAggregatedByTargetResourceFilterCriteria& AddTargetResourceIdFilters(TargetResourceIdFiltersT&& value) {
    m_targetResourceIdFiltersHasBeenSet = true;
    m_targetResourceIdFilters.emplace_back(std::forward<TargetResourceIdFiltersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTargetResourceTagFilters(TargetResourceTagFiltersT&& value) {
    m_targetResourceTagFiltersHasBeenSet = true;
    m_targetResourceTagFilters = std::forward<TargetResourceTagFiltersT>(value);
  }
  template <typename TargetResourceTagFiltersT = Aws::Vector<TagFilter>>
  CisScanResultsAggregatedByTargetResourceFilterCriteria& WithTargetResourceTagFilters(TargetResourceTagFiltersT&& value) {
    SetTargetResourceTagFilters(std::forward<TargetResourceTagFiltersT>(value));
    return *this;
  }
  template <typename TargetResourceTagFiltersT = TagFilter>
  CisScanResultsAggregatedByTargetResourceFilterCriteria& AddTargetResourceTagFilters(TargetResourceTagFiltersT&& value) {
    m_targetResourceTagFiltersHasBeenSet = true;
    m_targetResourceTagFilters.emplace_back(std::forward<TargetResourceTagFiltersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPlatformFilters(PlatformFiltersT&& value) {
    m_platformFiltersHasBeenSet = true;
    m_platformFilters = std::forward<PlatformFiltersT>(value);
  }
  template <typename PlatformFiltersT = Aws::Vector<CisStringFilter>>
  CisScanResultsAggregatedByTargetResourceFilterCriteria& WithPlatformFilters(PlatformFiltersT&& value) {
    SetPlatformFilters(std::forward<PlatformFiltersT>(value));
    return *this;
  }
  template <typename PlatformFiltersT = CisStringFilter>
  CisScanResultsAggregatedByTargetResourceFilterCriteria& AddPlatformFilters(PlatformFiltersT&& value) {
    m_platformFiltersHasBeenSet = true;
    m_platformFilters.emplace_back(std::forward<PlatformFiltersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTargetStatusFilters(TargetStatusFiltersT&& value) {
    m_targetStatusFiltersHasBeenSet = true;
    m_targetStatusFilters = std::forward<TargetStatusFiltersT>(value);
  }
  template <typename TargetStatusFiltersT = Aws::Vector<CisTargetStatusFilter>>
  CisScanResultsAggregatedByTargetResourceFilterCriteria& WithTargetStatusFilters(TargetStatusFiltersT&& value) {
    SetTargetStatusFilters(std::forward<TargetStatusFiltersT>(value));
    return *this;
  }
  template <typename TargetStatusFiltersT = CisTargetStatusFilter>
  CisScanResultsAggregatedByTargetResourceFilterCriteria& AddTargetStatusFilters(TargetStatusFiltersT&& value) {
    m_targetStatusFiltersHasBeenSet = true;
    m_targetStatusFilters.emplace_back(std::forward<TargetStatusFiltersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTargetStatusReasonFilters(TargetStatusReasonFiltersT&& value) {
    m_targetStatusReasonFiltersHasBeenSet = true;
    m_targetStatusReasonFilters = std::forward<TargetStatusReasonFiltersT>(value);
  }
  template <typename TargetStatusReasonFiltersT = Aws::Vector<CisTargetStatusReasonFilter>>
  CisScanResultsAggregatedByTargetResourceFilterCriteria& WithTargetStatusReasonFilters(TargetStatusReasonFiltersT&& value) {
    SetTargetStatusReasonFilters(std::forward<TargetStatusReasonFiltersT>(value));
    return *this;
  }
  template <typename TargetStatusReasonFiltersT = CisTargetStatusReasonFilter>
  CisScanResultsAggregatedByTargetResourceFilterCriteria& AddTargetStatusReasonFilters(TargetStatusReasonFiltersT&& value) {
    m_targetStatusReasonFiltersHasBeenSet = true;
    m_targetStatusReasonFilters.emplace_back(std::forward<TargetStatusReasonFiltersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFailedChecksFilters(FailedChecksFiltersT&& value) {
    m_failedChecksFiltersHasBeenSet = true;
    m_failedChecksFilters = std::forward<FailedChecksFiltersT>(value);
  }
  template <typename FailedChecksFiltersT = Aws::Vector<CisNumberFilter>>
  CisScanResultsAggregatedByTargetResourceFilterCriteria& WithFailedChecksFilters(FailedChecksFiltersT&& value) {
    SetFailedChecksFilters(std::forward<FailedChecksFiltersT>(value));
    return *this;
  }
  template <typename FailedChecksFiltersT = CisNumberFilter>
  CisScanResultsAggregatedByTargetResourceFilterCriteria& AddFailedChecksFilters(FailedChecksFiltersT&& value) {
    m_failedChecksFiltersHasBeenSet = true;
    m_failedChecksFilters.emplace_back(std::forward<FailedChecksFiltersT>(value));
    return *this;
  }
  ///@}
 private:
