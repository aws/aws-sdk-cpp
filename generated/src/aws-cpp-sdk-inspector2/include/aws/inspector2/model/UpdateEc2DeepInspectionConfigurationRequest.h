...
class UpdateEc2DeepInspectionConfigurationRequest : public Inspector2Request {
 public:
  ...
  inline UpdateEc2DeepInspectionConfigurationRequest& WithActivateDeepInspection(bool value) {
  ...
  template <typename PackagePathsT = Aws::Vector<Aws::String>>
  UpdateEc2DeepInspectionConfigurationRequest& WithPackagePaths(PackagePathsT&& value) {
    SetPackagePaths(std::forward<PackagePathsT>(value));
    return *this;
  }
  template <typename PackagePathsT = Aws::String>
  UpdateEc2DeepInspectionConfigurationRequest& AddPackagePaths(PackagePathsT&& value) {
    m_packagePathsHasBeenSet = true;
