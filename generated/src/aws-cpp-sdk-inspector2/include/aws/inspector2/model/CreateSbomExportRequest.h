...
class CreateSbomExportRequest : public Inspector2Request {
 public:
  ...
  void SetResourceFilterCriteria(ResourceFilterCriteriaT&& value) {
    m_resourceFilterCriteriaHasBeenSet = true;
    m_resourceFilterCriteria = std::forward<ResourceFilterCriteriaT>(value);
  }
  template <typename ResourceFilterCriteriaT = ResourceFilterCriteria>
  CreateSbomExportRequest& WithResourceFilterCriteria(ResourceFilterCriteriaT&& value) {
    SetResourceFilterCriteria(std::forward<ResourceFilterCriteriaT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetReportFormat(SbomReportFormat value) {
    m_reportFormatHasBeenSet = true;
    m_reportFormat = value;
  }
  inline CreateSbomExportRequest& WithReportFormat(SbomReportFormat value) {
