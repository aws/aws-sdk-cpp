...
class CisScanResultsAggregatedByChecksFilterCriteria {
 public:
  ...
  template <typename AccountIdFiltersT = Aws::Vector<CisStringFilter>>
  CisScanResultsAggregatedByChecksFilterCriteria& WithAccountIdFilters(AccountIdFiltersT&& value) {
    SetAccountIdFilters(std::forward<AccountIdFiltersT>(value));
    return *this;
  }
  template <typename AccountIdFiltersT = CisStringFilter>
  CisScanResultsAggregatedByChecksFilterCriteria& AddAccountIdFilters(AccountIdFiltersT&& value) {
    m_accountIdFiltersHasBeenSet = true;
  ...
  template <typename CheckIdFiltersT = Aws::Vector<CisStringFilter>>
  CisScanResultsAggregatedByChecksFilterCriteria& WithCheckIdFilters(CheckIdFiltersT&& value) {
    SetCheckIdFilters(std::forward<CheckIdFiltersT>(value));
    return *this;
  }
  template <typename CheckIdFiltersT = CisStringFilter>
  CisScanResultsAggregatedByChecksFilterCriteria& AddCheckIdFilters(CheckIdFiltersT&& value) {
    m_checkIdFiltersHasBeenSet = true;
  ...
  void SetTitleFilters(TitleFiltersT&& value) {
    m_titleFiltersHasBeenSet = true;
    m_titleFilters = std::forward<TitleFiltersT>(value);
  }
  template <typename TitleFiltersT = Aws::Vector<CisStringFilter>>
  CisScanResultsAggregatedByChecksFilterCriteria& WithTitleFilters(TitleFiltersT&& value) {
    SetTitleFilters(std::forward<TitleFiltersT>(value));
    return *this;
  }
  template <typename TitleFiltersT = CisStringFilter>
  CisScanResultsAggregatedByChecksFilterCriteria& AddTitleFilters(TitleFiltersT&& value) {
    m_titleFiltersHasBeenSet = true;
    m_titleFilters.emplace_back(std::forward<TitleFiltersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename PlatformFiltersT = Aws::Vector<CisStringFilter>>
  CisScanResultsAggregatedByChecksFilterCriteria& WithPlatformFilters(PlatformFiltersT&& value) {
    SetPlatformFilters(std::forward<PlatformFiltersT>(value));
    return *this;
  }
  template <typename PlatformFiltersT = CisStringFilter>
  CisScanResultsAggregatedByChecksFilterCriteria& AddPlatformFilters(PlatformFiltersT&& value) {
    m_platformFiltersHasBeenSet = true;
  ...
  void SetFailedResourcesFilters(FailedResourcesFiltersT&& value) {
    m_failedResourcesFiltersHasBeenSet = true;
    m_failedResourcesFilters = std::forward<FailedResourcesFiltersT>(value);
  }
  template <typename FailedResourcesFiltersT = Aws::Vector<CisNumberFilter>>
  CisScanResultsAggregatedByChecksFilterCriteria& WithFailedResourcesFilters(FailedResourcesFiltersT&& value) {
    SetFailedResourcesFilters(std::forward<FailedResourcesFiltersT>(value));
    return *this;
  }
  template <typename FailedResourcesFiltersT = CisNumberFilter>
  CisScanResultsAggregatedByChecksFilterCriteria& AddFailedResourcesFilters(FailedResourcesFiltersT&& value) {
    m_failedResourcesFiltersHasBeenSet = true;
    m_failedResourcesFilters.emplace_back(std::forward<FailedResourcesFiltersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSecurityLevelFilters(SecurityLevelFiltersT&& value) {
    m_securityLevelFiltersHasBeenSet = true;
    m_securityLevelFilters = std::forward<SecurityLevelFiltersT>(value);
  }
  template <typename SecurityLevelFiltersT = Aws::Vector<CisSecurityLevelFilter>>
  CisScanResultsAggregatedByChecksFilterCriteria& WithSecurityLevelFilters(SecurityLevelFiltersT&& value) {
    SetSecurityLevelFilters(std::forward<SecurityLevelFiltersT>(value));
    return *this;
  }
  template <typename SecurityLevelFiltersT = CisSecurityLevelFilter>
  CisScanResultsAggregatedByChecksFilterCriteria& AddSecurityLevelFilters(SecurityLevelFiltersT&& value) {
    m_securityLevelFiltersHasBeenSet = true;
    m_securityLevelFilters.emplace_back(std::forward<SecurityLevelFiltersT>(value));
    return *this;
  }
  ///@}
 private:
