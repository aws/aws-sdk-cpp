...
class PeriodicScanConfiguration {
 public:
  ...
  inline void SetFrequency(PeriodicScanFrequency value) {
    m_frequencyHasBeenSet = true;
    m_frequency = value;
  }
  inline PeriodicScanConfiguration& WithFrequency(PeriodicScanFrequency value) {
    SetFrequency(value);
    return *this;
  }
  ///@}
  ...
  template <typename FrequencyExpressionT = Aws::String>
  PeriodicScanConfiguration& WithFrequencyExpression(FrequencyExpressionT&& value) {
