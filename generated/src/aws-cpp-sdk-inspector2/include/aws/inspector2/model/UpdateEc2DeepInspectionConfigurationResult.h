...
namespace Model
{
  ...
  public:
    ...
    template<typename OrgPackagePathsT = Aws::Vector<Aws::String>>
    UpdateEc2DeepInspectionConfigurationResult& WithOrgPackagePaths(OrgPackagePathsT&& value) { SetOrgPackagePaths(std::forward<OrgPackagePathsT>(value)); return *this;}
    template<typename OrgPackagePathsT = Aws::String>
    UpdateEc2DeepInspectionConfigurationResult& AddOrgPackagePaths(OrgPackagePathsT&& value) { m_orgPackagePathsHasBeenSet = true; m_orgPackagePaths.emplace_back(std::forward<OrgPackagePathsT>(value)); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateEc2DeepInspectionConfigurationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
