...
class CreateGitLabSelfManagedIntegrationDetail {
 public:
  ...
  template <typename InstanceUrlT = Aws::String>
  CreateGitLabSelfManagedIntegrationDetail& WithInstanceUrl(InstanceUrlT&& value) {
  ...
  template <typename AccessTokenT = Aws::String>
  CreateGitLabSelfManagedIntegrationDetail& WithAccessToken(AccessTokenT&& value) {
