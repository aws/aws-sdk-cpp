...
class PackageAggregation {
 public:
  ...
  void SetPackageNames(PackageNamesT&& value) {
    m_packageNamesHasBeenSet = true;
    m_packageNames = std::forward<PackageNamesT>(value);
  }
  template <typename PackageNamesT = Aws::Vector<StringFilter>>
  PackageAggregation& WithPackageNames(PackageNamesT&& value) {
    SetPackageNames(std::forward<PackageNamesT>(value));
    return *this;
  }
  template <typename PackageNamesT = StringFilter>
  PackageAggregation& AddPackageNames(PackageNamesT&& value) {
    m_packageNamesHasBeenSet = true;
    m_packageNames.emplace_back(std::forward<PackageNamesT>(value));
    return *this;
  }
  ///@}
  ...
  inline PackageAggregation& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSortBy(PackageSortBy value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline PackageAggregation& WithSortBy(PackageSortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
