...
class CisScanStatusFilter {
 public:
  ...
  inline void SetComparison(CisScanStatusComparison value) {
    m_comparisonHasBeenSet = true;
    m_comparison = value;
  }
  inline CisScanStatusFilter& WithComparison(CisScanStatusComparison value) {
    SetComparison(value);
    return *this;
  }
  ///@}
  ...
  inline void SetValue(CisScanStatus value) {
    m_valueHasBeenSet = true;
    m_value = value;
  }
  inline CisScanStatusFilter& WithValue(CisScanStatus value) {
    SetValue(value);
    return *this;
  }
  ///@}
