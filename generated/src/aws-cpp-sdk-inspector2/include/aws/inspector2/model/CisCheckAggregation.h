...
class CisCheckAggregation {
 public:
  ...
  void SetCheckDescription(CheckDescriptionT&& value) {
    ...
    m_checkDescription = std::forward<CheckDescriptionT>(value);
  }
  template <typename CheckDescriptionT = Aws::String>
  CisCheckAggregation& WithCheckDescription(CheckDescriptionT&& value) {
    SetCheckDescription(std::forward<CheckDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetLevel(CisSecurityLevel value) {
    m_levelHasBeenSet = true;
    m_level = value;
  }
  inline CisCheckAggregation& WithLevel(CisSecurityLevel value) {
    SetLevel(value);
    return *this;
  }
  ///@}
