...
class GetCodeSecurityIntegrationResult {
 public:
  ...
  inline GetCodeSecurityIntegrationResult& WithType(IntegrationType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline GetCodeSecurityIntegrationResult& WithStatus(IntegrationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetLastUpdateOn(LastUpdateOnT&& value) {
    ...
    m_lastUpdateOn = std::forward<LastUpdateOnT>(value);
  }
  template <typename LastUpdateOnT = Aws::Utils::DateTime>
  GetCodeSecurityIntegrationResult& WithLastUpdateOn(LastUpdateOnT&& value) {
    SetLastUpdateOn(std::forward<LastUpdateOnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  GetCodeSecurityIntegrationResult& WithTags(TagsT&& value) {
