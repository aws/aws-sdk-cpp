...
class BatchDisassociateCodeSecurityScanConfigurationRequest : public Inspector2Request {
 public:
   ...
   * configuration.</p>
   */
  inline const Aws::Vector<DisassociateConfigurationRequest>& GetDisassociateConfigurationRequests() const {
    return m_disassociateConfigurationRequests;
  }
  ...
  void SetDisassociateConfigurationRequests(DisassociateConfigurationRequestsT&& value) {
    m_disassociateConfigurationRequestsHasBeenSet = true;
    m_disassociateConfigurationRequests = std::forward<DisassociateConfigurationRequestsT>(value);
  }
  template <typename DisassociateConfigurationRequestsT = Aws::Vector<DisassociateConfigurationRequest>>
  BatchDisassociateCodeSecurityScanConfigurationRequest& WithDisassociateConfigurationRequests(DisassociateConfigurationRequestsT&& value) {
    SetDisassociateConfigurationRequests(std::forward<DisassociateConfigurationRequestsT>(value));
    return *this;
  }
  template <typename DisassociateConfigurationRequestsT = DisassociateConfigurationRequest>
  BatchDisassociateCodeSecurityScanConfigurationRequest& AddDisassociateConfigurationRequests(DisassociateConfigurationRequestsT&& value) {
    m_disassociateConfigurationRequestsHasBeenSet = true;
    m_disassociateConfigurationRequests.emplace_back(std::forward<DisassociateConfigurationRequestsT>(value));
    return *this;
  }
  ///@}
 private:
