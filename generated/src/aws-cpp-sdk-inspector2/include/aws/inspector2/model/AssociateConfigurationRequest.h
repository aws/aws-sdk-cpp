...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/inspector2-2020-06-08/AssociateConfigurationRequest">AWS
   * API Reference</a></p>
   */
  ...
  public:
    ...
    template<typename ScanConfigurationArnT = Aws::String>
    AssociateConfigurationRequest& WithScanConfigurationArn(ScanConfigurationArnT&& value) { SetScanConfigurationArn(std::forward<ScanConfigurationArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ResourceT = CodeSecurityResource>
    AssociateConfigurationRequest& WithResource(ResourceT&& value) { SetResource(std::forward<ResourceT>(value)); return *this;}
    ///@}
  private:
