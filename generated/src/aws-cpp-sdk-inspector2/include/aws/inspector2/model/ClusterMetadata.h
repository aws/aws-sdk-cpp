...
class ClusterMetadata {
 public:
  ...
  void SetAwsEcsMetadataDetails(AwsEcsMetadataDetailsT&& value) {
    ...
    m_awsEcsMetadataDetails = std::forward<AwsEcsMetadataDetailsT>(value);
  }
  template <typename AwsEcsMetadataDetailsT = AwsEcsMetadataDetails>
  ClusterMetadata& WithAwsEcsMetadataDetails(AwsEcsMetadataDetailsT&& value) {
    SetAwsEcsMetadataDetails(std::forward<AwsEcsMetadataDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAwsEksMetadataDetails(AwsEksMetadataDetailsT&& value) {
    ...
    m_awsEksMetadataDetails = std::forward<AwsEksMetadataDetailsT>(value);
  }
  template <typename AwsEksMetadataDetailsT = AwsEksMetadataDetails>
  ClusterMetadata& WithAwsEksMetadataDetails(AwsEksMetadataDetailsT&& value) {
    SetAwsEksMetadataDetails(std::forward<AwsEksMetadataDetailsT>(value));
    return *this;
  }
  ///@}
 private:
