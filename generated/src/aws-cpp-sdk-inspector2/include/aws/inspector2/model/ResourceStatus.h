...
class ResourceStatus {
 public:
  ...
  inline void SetEc2(Status value) {
    m_ec2HasBeenSet = true;
    m_ec2 = value;
  }
  inline ResourceStatus& WithEc2(Status value) {
    SetEc2(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEcr(Status value) {
    m_ecrHasBeenSet = true;
    m_ecr = value;
  }
  inline ResourceStatus& WithEcr(Status value) {
    SetEcr(value);
    return *this;
  }
  ///@}
  ...
  inline void SetLambda(Status value) {
    m_lambdaHasBeenSet = true;
    m_lambda = value;
  }
  inline ResourceStatus& WithLambda(Status value) {
    SetLambda(value);
    return *this;
  }
  ///@}
  ...
  inline void SetLambdaCode(Status value) {
    m_lambdaCodeHasBeenSet = true;
    m_lambdaCode = value;
  }
  inline ResourceStatus& WithLambdaCode(Status value) {
    SetLambdaCode(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCodeRepository(Status value) {
    m_codeRepositoryHasBeenSet = true;
    m_codeRepository = value;
  }
  inline ResourceStatus& WithCodeRepository(Status value) {
