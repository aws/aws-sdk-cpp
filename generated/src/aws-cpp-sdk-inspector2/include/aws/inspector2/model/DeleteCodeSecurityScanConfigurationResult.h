...
class DeleteCodeSecurityScanConfigurationResult {
 public:
  ...
  AWS_INSPECTOR2_API DeleteCodeSecurityScanConfigurationResult& operator=(
  ...
  template <typename ScanConfigurationArnT = Aws::String>
  DeleteCodeSecurityScanConfigurationResult& WithScanConfigurationArn(ScanConfigurationArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteCodeSecurityScanConfigurationResult& WithRequestId(RequestIdT&& value) {
