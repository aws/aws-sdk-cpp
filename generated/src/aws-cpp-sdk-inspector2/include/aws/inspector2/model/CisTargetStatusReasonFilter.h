...
class CisTargetStatusReasonFilter {
 public:
  ...
  inline void SetComparison(CisTargetStatusComparison value) {
    m_comparisonHasBeenSet = true;
    m_comparison = value;
  }
  inline CisTargetStatusReasonFilter& WithComparison(CisTargetStatusComparison value) {
    SetComparison(value);
    return *this;
  }
  ///@}
  ...
  inline void SetValue(CisTargetStatusReason value) {
    m_valueHasBeenSet = true;
    m_value = value;
  }
  inline CisTargetStatusReasonFilter& WithValue(CisTargetStatusReason value) {
    SetValue(value);
    return *this;
  }
  ///@}
