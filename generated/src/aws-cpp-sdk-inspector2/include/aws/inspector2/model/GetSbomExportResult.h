...
class GetSbomExportResult {
 public:
  ...
  inline void SetFormat(SbomReportFormat value) {
    m_formatHasBeenSet = true;
    m_format = value;
  }
  inline GetSbomExportResult& WithFormat(SbomReportFormat value) {
    SetFormat(value);
    return *this;
  }
  ///@}
  ...
  inline GetSbomExportResult& WithStatus(ExternalReportStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline GetSbomExportResult& WithErrorCode(ReportingErrorCode value) {
    SetErrorCode(value);
    return *this;
  }
  ///@}
