...
class CodeSecurityScanConfigurationSummary {
 public:
  ...
  inline void SetPeriodicScanFrequency(PeriodicScanFrequency value) {
    m_periodicScanFrequencyHasBeenSet = true;
    m_periodicScanFrequency = value;
  }
  inline CodeSecurityScanConfigurationSummary& WithPeriodicScanFrequency(PeriodicScanFrequency value) {
    SetPeriodicScanFrequency(value);
    return *this;
  }
  ///@}
  ...
  void SetFrequencyExpression(FrequencyExpressionT&& value) {
    ...
    m_frequencyExpression = std::forward<FrequencyExpressionT>(value);
  }
  template <typename FrequencyExpressionT = Aws::String>
  CodeSecurityScanConfigurationSummary& WithFrequencyExpression(FrequencyExpressionT&& value) {
    SetFrequencyExpression(std::forward<FrequencyExpressionT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::Vector<ContinuousIntegrationScanEvent>& GetContinuousIntegrationScanSupportedEvents() const {
    return m_continuousIntegrationScanSupportedEvents;
  }
  ...
  void SetContinuousIntegrationScanSupportedEvents(ContinuousIntegrationScanSupportedEventsT&& value) {
    ...
    m_continuousIntegrationScanSupportedEvents = std::forward<ContinuousIntegrationScanSupportedEventsT>(value);
  }
  template <typename ContinuousIntegrationScanSupportedEventsT = Aws::Vector<ContinuousIntegrationScanEvent>>
  CodeSecurityScanConfigurationSummary& WithContinuousIntegrationScanSupportedEvents(ContinuousIntegrationScanSupportedEventsT&& value) {
    SetContinuousIntegrationScanSupportedEvents(std::forward<ContinuousIntegrationScanSupportedEventsT>(value));
    return *this;
  }
  inline CodeSecurityScanConfigurationSummary& AddContinuousIntegrationScanSupportedEvents(ContinuousIntegrationScanEvent value) {
    m_continuousIntegrationScanSupportedEventsHasBeenSet = true;
    m_continuousIntegrationScanSupportedEvents.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetRuleSetCategories(RuleSetCategoriesT&& value) {
    ...
    m_ruleSetCategories = std::forward<RuleSetCategoriesT>(value);
  }
  template <typename RuleSetCategoriesT = Aws::Vector<RuleSetCategory>>
  CodeSecurityScanConfigurationSummary& WithRuleSetCategories(RuleSetCategoriesT&& value) {
    SetRuleSetCategories(std::forward<RuleSetCategoriesT>(value));
    return *this;
  }
  inline CodeSecurityScanConfigurationSummary& AddRuleSetCategories(RuleSetCategory value) {
    m_ruleSetCategoriesHasBeenSet = true;
    m_ruleSetCategories.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetScopeSettings(ScopeSettingsT&& value) {
    ...
    m_scopeSettings = std::forward<ScopeSettingsT>(value);
  }
  template <typename ScopeSettingsT = ScopeSettings>
  CodeSecurityScanConfigurationSummary& WithScopeSettings(ScopeSettingsT&& value) {
    SetScopeSettings(std::forward<ScopeSettingsT>(value));
    return *this;
  }
  ///@}
