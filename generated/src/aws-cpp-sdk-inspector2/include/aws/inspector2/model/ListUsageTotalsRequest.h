...
class ListUsageTotalsRequest : public Inspector2Request {
 public:
  ...
  inline ListUsageTotalsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListUsageTotalsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename AccountIdsT = Aws::Vector<Aws::String>>
  ListUsageTotalsRequest& WithAccountIds(AccountIdsT&& value) {
    SetAccountIds(std::forward<AccountIdsT>(value));
    return *this;
  }
  template <typename AccountIdsT = Aws::String>
  ListUsageTotalsRequest& AddAccountIds(AccountIdsT&& value) {
    m_accountIdsHasBeenSet = true;
