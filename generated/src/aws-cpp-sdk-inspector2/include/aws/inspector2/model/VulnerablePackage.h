...
class VulnerablePackage {
 public:
  ...
  inline VulnerablePackage& WithPackageManager(PackageManager value) {
  ...
  void SetSourceLambdaLayerArn(SourceLambdaLayerArnT&& value) {
    ...
    m_sourceLambdaLayerArn = std::forward<SourceLambdaLayerArnT>(value);
  }
  template <typename SourceLambdaLayerArnT = Aws::String>
  VulnerablePackage& WithSourceLambdaLayerArn(SourceLambdaLayerArnT&& value) {
    SetSourceLambdaLayerArn(std::forward<SourceLambdaLayerArnT>(value));
    return *this;
  }
  ///@}
 private:
