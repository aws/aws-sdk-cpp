...
class CisaData {
 public:
  ...
  void SetDateAdded(DateAddedT&& value) {
    ...
    m_dateAdded = std::forward<DateAddedT>(value);
  }
  template <typename DateAddedT = Aws::Utils::DateTime>
  CisaData& WithDateAdded(DateAddedT&& value) {
    SetDateAdded(std::forward<DateAddedT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDateDue(DateDueT&& value) {
    ...
    m_dateDue = std::forward<DateDueT>(value);
  }
  template <typename DateDueT = Aws::Utils::DateTime>
  CisaData& WithDateDue(DateDueT&& value) {
    SetDateDue(std::forward<DateDueT>(value));
    return *this;
  }
  ///@}
