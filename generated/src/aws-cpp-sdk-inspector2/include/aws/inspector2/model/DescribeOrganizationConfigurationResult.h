...
class DescribeOrganizationConfigurationResult {
 public:
  ...
  AWS_INSPECTOR2_API DescribeOrganizationConfigurationResult& operator=(
  ...
  void SetAutoEnable(AutoEnableT&& value) {
    m_autoEnableHasBeenSet = true;
    m_autoEnable = std::forward<AutoEnableT>(value);
  }
  template <typename AutoEnableT = AutoEnable>
  DescribeOrganizationConfigurationResult& WithAutoEnable(AutoEnableT&& value) {
    SetAutoEnable(std::forward<AutoEnableT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetMaxAccountLimitReached(bool value) {
    m_maxAccountLimitReachedHasBeenSet = true;
    m_maxAccountLimitReached = value;
  }
  inline DescribeOrganizationConfigurationResult& WithMaxAccountLimitReached(bool value) {
    SetMaxAccountLimitReached(value);
    return *this;
  }
  ///@}
