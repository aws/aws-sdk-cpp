...
class ListDelegatedAdminAccountsRequest : public Inspector2Request {
 public:
  AWS_INSPECTOR2_API ListDelegatedAdminAccountsRequest() = default;
  ...
  inline ListDelegatedAdminAccountsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListDelegatedAdminAccountsRequest& WithNextToken(NextTokenT&& value) {
