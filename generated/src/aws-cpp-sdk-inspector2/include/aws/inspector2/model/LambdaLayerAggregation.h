...
class LambdaLayerAggregation {
 public:
  ...
  inline LambdaLayerAggregation& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSortBy(LambdaLayerSortBy value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline LambdaLayerAggregation& WithSortBy(LambdaLayerSortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
