...
class FindingTypeAggregation {
 public:
  ...
  inline FindingTypeAggregation& WithFindingType(AggregationFindingType value) {
  ...
  inline FindingTypeAggregation& WithResourceType(AggregationResourceType value) {
  ...
  inline FindingTypeAggregation& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSortBy(FindingTypeSortBy value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline FindingTypeAggregation& WithSortBy(FindingTypeSortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
