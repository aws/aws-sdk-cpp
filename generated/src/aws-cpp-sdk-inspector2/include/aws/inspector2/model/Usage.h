...
class Usage {
 public:
  ...
  inline Usage& WithType(UsageType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline Usage& WithTotal(double value) {
    SetTotal(value);
    return *this;
  }
  ///@}
  ...
  inline Usage& WithEstimatedMonthlyCost(double value) {
  ...
  inline Usage& WithCurrency(Currency value) {
    SetCurrency(value);
    return *this;
  }
  ///@}
