...
class ProjectContinuousIntegrationScanConfiguration {
 public:
  ...
  inline void SetSupportedEvent(ContinuousIntegrationScanEvent value) {
    m_supportedEventHasBeenSet = true;
    m_supportedEvent = value;
  }
  inline ProjectContinuousIntegrationScanConfiguration& WithSupportedEvent(ContinuousIntegrationScanEvent value) {
    SetSupportedEvent(value);
    return *this;
  }
  ///@}
  ...
  inline ProjectContinuousIntegrationScanConfiguration& AddRuleSetCategories(RuleSetCategory value) {
    m_ruleSetCategoriesHasBeenSet = true;
