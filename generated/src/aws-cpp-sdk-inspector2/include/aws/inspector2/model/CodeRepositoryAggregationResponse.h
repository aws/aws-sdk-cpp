...
class CodeRepositoryAggregationResponse {
 public:
  ...
  inline CodeRepositoryAggregationResponse& WithExploitAvailableActiveFindingsCount(long long value) {
  ...
  inline CodeRepositoryAggregationResponse& WithFixAvailableActiveFindingsCount(long long value) {
