...
namespace Model
{
  ...
  {
  public:
    AWS_INSPECTOR2_API DisassociateMemberResult() = default;
    ...
    template<typename AccountIdT = Aws::String>
    DisassociateMemberResult& WithAccountId(AccountIdT&& value) { SetAccountId(std::forward<AccountIdT>(value)); return *this;}
    ///@}
