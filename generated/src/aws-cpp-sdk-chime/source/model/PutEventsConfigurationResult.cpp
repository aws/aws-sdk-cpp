...
PutEventsConfigurationResult::PutEventsConfigurationResult()
{
}

PutEventsConfigurationResult::PutEventsConfigurationResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
