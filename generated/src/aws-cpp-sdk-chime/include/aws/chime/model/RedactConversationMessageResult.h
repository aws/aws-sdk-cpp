...
namespace Model
{
  ...
  {
  public:
    AWS_CHIME_API RedactConversationMessageResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    RedactConversationMessageResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
