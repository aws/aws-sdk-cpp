...
namespace Model
{
  ...
  public:
    ...
    template<typename RoomMembershipT = RoomMembership>
    CreateRoomMembershipResult& WithRoomMembership(RoomMembershipT&& value) { SetRoomMembership(std::forward<RoomMembershipT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateRoomMembershipResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
