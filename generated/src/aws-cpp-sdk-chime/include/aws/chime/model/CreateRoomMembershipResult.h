...
class CreateRoomMembershipResult {
 public:
  AWS_CHIME_API CreateRoomMembershipResult() = default;
  ...
  void SetRoomMembership(RoomMembershipT&& value) {
    m_roomMembershipHasBeenSet = true;
    m_roomMembership = std::forward<RoomMembershipT>(value);
  }
  template <typename RoomMembershipT = RoomMembership>
  CreateRoomMembershipResult& WithRoomMembership(RoomMembershipT&& value) {
    SetRoomMembership(std::forward<RoomMembershipT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  CreateRoomMembershipResult& WithRequestId(RequestIdT&& value) {
