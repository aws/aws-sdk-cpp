...
namespace Model
{
  ...
  public:
    ...
    inline UpdateChannelMessageResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateChannelMessageResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateChannelMessageResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
