...
class AssociatePhoneNumberWithUserRequest : public ChimeRequest {
 public:
  ...
  template <typename AccountIdT = Aws::String>
  AssociatePhoneNumberWithUserRequest& WithAccountId(AccountIdT&& value) {
  ...
  template <typename UserIdT = Aws::String>
  AssociatePhoneNumberWithUserRequest& WithUserId(UserIdT&& value) {
  ...
  template <typename E164PhoneNumberT = Aws::String>
  AssociatePhoneNumberWithUserRequest& WithE164PhoneNumber(E164PhoneNumberT&& value) {
