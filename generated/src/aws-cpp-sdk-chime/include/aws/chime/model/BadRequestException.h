...
class BadRequestException {
 public:
  AWS_CHIME_API BadRequestException() = default;
  AWS_CHIME_API BadRequestException(Aws::Utils::Json::JsonView jsonValue);
  AWS_CHIME_API BadRequestException& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  inline BadRequestException& WithCode(ErrorCode value) {
    SetCode(value);
    return *this;
  }
  ///@}
