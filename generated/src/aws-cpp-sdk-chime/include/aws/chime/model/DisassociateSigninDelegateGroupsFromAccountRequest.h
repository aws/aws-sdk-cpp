...
class DisassociateSigninDelegateGroupsFromAccountRequest : public ChimeRequest {
 public:
  ...
  template <typename AccountIdT = Aws::String>
  DisassociateSigninDelegateGroupsFromAccountRequest& WithAccountId(AccountIdT&& value) {
  ...
  template <typename GroupNamesT = Aws::Vector<Aws::String>>
  DisassociateSigninDelegateGroupsFromAccountRequest& WithGroupNames(GroupNamesT&& value) {
    SetGroupNames(std::forward<GroupNamesT>(value));
    return *this;
  }
  template <typename GroupNamesT = Aws::String>
  DisassociateSigninDelegateGroupsFromAccountRequest& AddGroupNames(GroupNamesT&& value) {
    m_groupNamesHasBeenSet = true;
