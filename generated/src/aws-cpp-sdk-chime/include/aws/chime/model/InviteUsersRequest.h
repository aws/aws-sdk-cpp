...
class InviteUsersRequest : public ChimeRequest {
 public:
  ...
  void SetUserEmailList(UserEmailListT&& value) {
    m_userEmailListHasBeenSet = true;
    m_userEmailList = std::forward<UserEmailListT>(value);
  }
  template <typename UserEmailListT = Aws::Vector<Aws::String>>
  InviteUsersRequest& WithUserEmailList(UserEmailListT&& value) {
    SetUserEmailList(std::forward<UserEmailListT>(value));
    return *this;
  }
  template <typename UserEmailListT = Aws::String>
  InviteUsersRequest& AddUserEmailList(UserEmailListT&& value) {
    m_userEmailListHasBeenSet = true;
    m_userEmailList.emplace_back(std::forward<UserEmailListT>(value));
    return *this;
  }
  ///@}
  ...
  inline InviteUsersRequest& WithUserType(UserType value) {
    SetUserType(value);
    return *this;
  }
  ///@}
