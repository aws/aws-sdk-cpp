...
namespace Model
{
  ...
  {
  public:
    AWS_CHIME_API RedactRoomMessageResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    RedactRoomMessageResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
