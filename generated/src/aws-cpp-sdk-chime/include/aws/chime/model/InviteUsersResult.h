...
class InviteUsersResult {
 public:
  ...
  void SetInvites(InvitesT&& value) {
    m_invitesHasBeenSet = true;
    m_invites = std::forward<InvitesT>(value);
  }
  template <typename InvitesT = Aws::Vector<Invite>>
  InviteUsersResult& WithInvites(InvitesT&& value) {
    SetInvites(std::forward<InvitesT>(value));
    return *this;
  }
  template <typename InvitesT = Invite>
  InviteUsersResult& AddInvites(InvitesT&& value) {
    m_invitesHasBeenSet = true;
    m_invites.emplace_back(std::forward<InvitesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  InviteUsersResult& WithRequestId(RequestIdT&& value) {
