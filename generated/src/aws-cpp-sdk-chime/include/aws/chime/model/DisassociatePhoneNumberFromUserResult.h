...
namespace Model
{
  ...
  {
  public:
    AWS_CHIME_API DisassociatePhoneNumberFromUserResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DisassociatePhoneNumberFromUserResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
