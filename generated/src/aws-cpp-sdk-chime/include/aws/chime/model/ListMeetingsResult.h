...
namespace Model
{
  ...
  public:
    ...
    inline ListMeetingsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ListMeetingsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ListMeetingsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
