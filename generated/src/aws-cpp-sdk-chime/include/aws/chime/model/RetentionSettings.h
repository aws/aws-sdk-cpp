...
class RetentionSettings {
 public:
  ...
  void SetRoomRetentionSettings(RoomRetentionSettingsT&& value) {
    ...
    m_roomRetentionSettings = std::forward<RoomRetentionSettingsT>(value);
  }
  template <typename RoomRetentionSettingsT = RoomRetentionSettings>
  RetentionSettings& WithRoomRetentionSettings(RoomRetentionSettingsT&& value) {
    SetRoomRetentionSettings(std::forward<RoomRetentionSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetConversationRetentionSettings(ConversationRetentionSettingsT&& value) {
    ...
    m_conversationRetentionSettings = std::forward<ConversationRetentionSettingsT>(value);
  }
  template <typename ConversationRetentionSettingsT = ConversationRetentionSettings>
  RetentionSettings& WithConversationRetentionSettings(ConversationRetentionSettingsT&& value) {
    SetConversationRetentionSettings(std::forward<ConversationRetentionSettingsT>(value));
    return *this;
  }
  ///@}
 private:
