...
namespace Model
{
  ...
  public:
    ...
    template<typename AccountIdT = Aws::String>
    ListUsersRequest& WithAccountId(AccountIdT&& value) { SetAccountId(std::forward<AccountIdT>(value)); return *this;}
    ///@}
    ...
    template<typename UserEmailT = Aws::String>
    ListUsersRequest& WithUserEmail(UserEmailT&& value) { SetUserEmail(std::forward<UserEmailT>(value)); return *this;}
    ///@}
    ...
    inline ListUsersRequest& WithUserType(UserType value) { SetUserType(value); return *this;}
    ///@}
