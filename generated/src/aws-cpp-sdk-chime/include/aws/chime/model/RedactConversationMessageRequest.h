...
class RedactConversationMessageRequest : public ChimeRequest {
 public:
  ...
  template <typename AccountIdT = Aws::String>
  RedactConversationMessageRequest& WithAccountId(AccountIdT&& value) {
  ...
  template <typename ConversationIdT = Aws::String>
  RedactConversationMessageRequest& WithConversationId(ConversationIdT&& value) {
  ...
  template <typename MessageIdT = Aws::String>
  RedactConversationMessageRequest& WithMessageId(MessageIdT&& value) {
