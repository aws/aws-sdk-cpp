...
class BatchUpdateUserRequest : public ChimeRequest {
 public:
  ...
  template <typename AccountIdT = Aws::String>
  BatchUpdateUserRequest& WithAccountId(AccountIdT&& value) {
  ...
  void SetUpdateUserRequestItems(UpdateUserRequestItemsT&& value) {
    m_updateUserRequestItemsHasBeenSet = true;
    m_updateUserRequestItems = std::forward<UpdateUserRequestItemsT>(value);
  }
  template <typename UpdateUserRequestItemsT = Aws::Vector<UpdateUserRequestItem>>
  BatchUpdateUserRequest& WithUpdateUserRequestItems(UpdateUserRequestItemsT&& value) {
    SetUpdateUserRequestItems(std::forward<UpdateUserRequestItemsT>(value));
    return *this;
  }
  template <typename UpdateUserRequestItemsT = UpdateUserRequestItem>
  BatchUpdateUserRequest& AddUpdateUserRequestItems(UpdateUserRequestItemsT&& value) {
    m_updateUserRequestItemsHasBeenSet = true;
    m_updateUserRequestItems.emplace_back(std::forward<UpdateUserRequestItemsT>(value));
    return *this;
  }
  ///@}
 private:
