...
namespace Model
{
  ...
  {
  public:
    AWS_CHIME_API AccessDeniedException() = default;
    AWS_CHIME_API AccessDeniedException(Aws::Utils::Json::JsonView jsonValue);
    AWS_CHIME_API AccessDeniedException& operator=(Aws::Utils::Json::JsonView jsonValue);
    ...
    inline AccessDeniedException& WithCode(ErrorCode value) { SetCode(value); return *this;}
    ///@}
