...
class PutRetentionSettingsResult {
 public:
  ...
  template <typename RetentionSettingsT = RetentionSettings>
  PutRetentionSettingsResult& WithRetentionSettings(RetentionSettingsT&& value) {
  ...
  template <typename InitiateDeletionTimestampT = Aws::Utils::DateTime>
  PutRetentionSettingsResult& WithInitiateDeletionTimestamp(InitiateDeletionTimestampT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  PutRetentionSettingsResult& WithRequestId(RequestIdT&& value) {
