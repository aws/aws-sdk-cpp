...
class AlexaForBusinessMetadata {
 public:
  ...
  inline void SetIsAlexaForBusinessEnabled(bool value) {
    m_isAlexaForBusinessEnabledHasBeenSet = true;
    m_isAlexaForBusinessEnabled = value;
  }
  inline AlexaForBusinessMetadata& WithIsAlexaForBusinessEnabled(bool value) {
    SetIsAlexaForBusinessEnabled(value);
    return *this;
  }
  ///@}
  ...
  void SetAlexaForBusinessRoomArn(AlexaForBusinessRoomArnT&& value) {
    m_alexaForBusinessRoomArnHasBeenSet = true;
    m_alexaForBusinessRoomArn = std::forward<AlexaForBusinessRoomArnT>(value);
  }
  template <typename AlexaForBusinessRoomArnT = Aws::String>
  AlexaForBusinessMetadata& WithAlexaForBusinessRoomArn(AlexaForBusinessRoomArnT&& value) {
    SetAlexaForBusinessRoomArn(std::forward<AlexaForBusinessRoomArnT>(value));
    return *this;
  }
  ///@}
 private:
