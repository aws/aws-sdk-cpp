...
namespace Model
{
  ...
  public:
    ...
    inline AssociateSigninDelegateGroupsWithAccountResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline AssociateSigninDelegateGroupsWithAccountResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline AssociateSigninDelegateGroupsWithAccountResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
