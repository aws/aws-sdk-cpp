...
class UserError {
 public:
  AWS_CHIME_API UserError() = default;
  ...
  template <typename UserIdT = Aws::String>
  UserError& WithUserId(UserIdT&& value) {
  ...
  inline UserError& WithErrorCode(ErrorCode value) {
    SetErrorCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename ErrorMessageT = Aws::String>
  UserError& WithErrorMessage(ErrorMessageT&& value) {
