...
namespace Model
{
  ...
  {
  public:
    AWS_CHIME_API AssociatePhoneNumberWithUserResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    AssociatePhoneNumberWithUserResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
