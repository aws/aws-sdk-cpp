...
class Bot {
 public:
  ...
  inline Bot& WithBotType(BotType value) {
    SetBotType(value);
    return *this;
  }
  ///@}
  ...
  inline Bot& WithDisabled(bool value) {
    SetDisabled(value);
    return *this;
  }
  ///@}
  ...
  void SetBotEmail(BotEmailT&& value) {
    ...
    m_botEmail = std::forward<BotEmailT>(value);
  }
  template <typename BotEmailT = Aws::String>
  Bot& WithBotEmail(BotEmailT&& value) {
    SetBotEmail(std::forward<BotEmailT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSecurityToken(SecurityTokenT&& value) {
    ...
    m_securityToken = std::forward<SecurityTokenT>(value);
  }
  template <typename SecurityTokenT = Aws::String>
  Bot& WithSecurityToken(SecurityTokenT&& value) {
    SetSecurityToken(std::forward<SecurityTokenT>(value));
    return *this;
  }
  ///@}
 private:
