...
class GetPhoneNumberOrderRequest : public ChimeRequest {
 public:
  ...
  void SetPhoneNumberOrderId(PhoneNumberOrderIdT&& value) {
    ...
    m_phoneNumberOrderId = std::forward<PhoneNumberOrderIdT>(value);
  }
  template <typename PhoneNumberOrderIdT = Aws::String>
  GetPhoneNumberOrderRequest& WithPhoneNumberOrderId(PhoneNumberOrderIdT&& value) {
    SetPhoneNumberOrderId(std::forward<PhoneNumberOrderIdT>(value));
    return *this;
  }
  ///@}
 private:
