...
class TelephonySettings {
 public:
  ...
  inline void SetInboundCalling(bool value) {
    m_inboundCallingHasBeenSet = true;
    m_inboundCalling = value;
  }
  inline TelephonySettings& WithInboundCalling(bool value) {
    SetInboundCalling(value);
    return *this;
  }
  ///@}
  ...
  inline void SetOutboundCalling(bool value) {
    m_outboundCallingHasBeenSet = true;
    m_outboundCalling = value;
  }
  inline TelephonySettings& WithOutboundCalling(bool value) {
    SetOutboundCalling(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSMS(bool value) {
    m_sMSHasBeenSet = true;
    m_sMS = value;
  }
  inline TelephonySettings& WithSMS(bool value) {
    SetSMS(value);
    return *this;
  }
  ///@}
