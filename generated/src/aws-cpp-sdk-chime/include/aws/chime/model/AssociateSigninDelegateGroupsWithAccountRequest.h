...
class AssociateSigninDelegateGroupsWithAccountRequest : public ChimeRequest {
 public:
  ...
  template <typename AccountIdT = Aws::String>
  AssociateSigninDelegateGroupsWithAccountRequest& WithAccountId(AccountIdT&& value) {
  ...
  template <typename SigninDelegateGroupsT = Aws::Vector<SigninDelegateGroup>>
  AssociateSigninDelegateGroupsWithAccountRequest& WithSigninDelegateGroups(SigninDelegateGroupsT&& value) {
  ...
  AssociateSigninDelegateGroupsWithAccountRequest& AddSigninDelegateGroups(SigninDelegateGroupsT&& value) {
    m_signinDelegateGroupsHasBeenSet = true;
