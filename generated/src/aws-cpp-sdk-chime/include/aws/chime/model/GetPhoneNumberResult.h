...
namespace Model
{
  ...
  {
  public:
    AWS_CHIME_API GetPhoneNumberResult() = default;
    ...
    template<typename PhoneNumberT = PhoneNumber>
    GetPhoneNumberResult& WithPhoneNumber(PhoneNumberT&& value) { SetPhoneNumber(std::forward<PhoneNumberT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    GetPhoneNumberResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
