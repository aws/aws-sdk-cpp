...
namespace Model
{
  ...
  public:
    ...
    inline ListAttendeeTagsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ListAttendeeTagsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ListAttendeeTagsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
