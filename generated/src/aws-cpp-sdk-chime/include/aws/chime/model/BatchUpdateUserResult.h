...
namespace Model
{
  ...
  public:
    ...
    template<typename UserErrorsT = Aws::Vector<UserError>>
    BatchUpdateUserResult& WithUserErrors(UserErrorsT&& value) { SetUserErrors(std::forward<UserErrorsT>(value)); return *this;}
    template<typename UserErrorsT = UserError>
    BatchUpdateUserResult& AddUserErrors(UserErrorsT&& value) { m_userErrorsHasBeenSet = true; m_userErrors.emplace_back(std::forward<UserErrorsT>(value)); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    BatchUpdateUserResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
