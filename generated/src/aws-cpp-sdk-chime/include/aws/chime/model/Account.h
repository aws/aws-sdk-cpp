...
class Account {
 public:
  ...
  inline Account& WithAccountType(AccountType value) {
  ...
  inline Account& WithDefaultLicense(License value) {
  ...
  void SetSupportedLicenses(SupportedLicensesT&& value) {
    ...
    m_supportedLicenses = std::forward<SupportedLicensesT>(value);
  }
  template <typename SupportedLicensesT = Aws::Vector<License>>
  Account& WithSupportedLicenses(SupportedLicensesT&& value) {
    SetSupportedLicenses(std::forward<SupportedLicensesT>(value));
    return *this;
  }
  inline Account& AddSupportedLicenses(License value) {
    m_supportedLicensesHasBeenSet = true;
    m_supportedLicenses.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAccountStatus(AccountStatus value) {
    m_accountStatusHasBeenSet = true;
    m_accountStatus = value;
  }
  inline Account& WithAccountStatus(AccountStatus value) {
  ...
  void SetSigninDelegateGroups(SigninDelegateGroupsT&& value) {
    ...
    m_signinDelegateGroups = std::forward<SigninDelegateGroupsT>(value);
  }
  template <typename SigninDelegateGroupsT = Aws::Vector<SigninDelegateGroup>>
  Account& WithSigninDelegateGroups(SigninDelegateGroupsT&& value) {
    SetSigninDelegateGroups(std::forward<SigninDelegateGroupsT>(value));
    return *this;
  }
  template <typename SigninDelegateGroupsT = SigninDelegateGroup>
  Account& AddSigninDelegateGroups(SigninDelegateGroupsT&& value) {
    m_signinDelegateGroupsHasBeenSet = true;
    m_signinDelegateGroups.emplace_back(std::forward<SigninDelegateGroupsT>(value));
    return *this;
  }
  ///@}
 private:
