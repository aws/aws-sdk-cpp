...
class BatchCreateRoomMembershipRequest : public ChimeRequest {
 public:
  ...
  template <typename AccountIdT = Aws::String>
  BatchCreateRoomMembershipRequest& WithAccountId(AccountIdT&& value) {
  ...
  template <typename RoomIdT = Aws::String>
  BatchCreateRoomMembershipRequest& WithRoomId(RoomIdT&& value) {
  ...
  void SetMembershipItemList(MembershipItemListT&& value) {
    m_membershipItemListHasBeenSet = true;
    m_membershipItemList = std::forward<MembershipItemListT>(value);
  }
  template <typename MembershipItemListT = Aws::Vector<MembershipItem>>
  BatchCreateRoomMembershipRequest& WithMembershipItemList(MembershipItemListT&& value) {
    SetMembershipItemList(std::forward<MembershipItemListT>(value));
    return *this;
  }
  template <typename MembershipItemListT = MembershipItem>
  BatchCreateRoomMembershipRequest& AddMembershipItemList(MembershipItemListT&& value) {
    m_membershipItemListHasBeenSet = true;
    m_membershipItemList.emplace_back(std::forward<MembershipItemListT>(value));
    return *this;
  }
  ///@}
 private:
