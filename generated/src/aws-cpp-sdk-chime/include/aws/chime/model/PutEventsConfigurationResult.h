...
class PutEventsConfigurationResult {
 public:
  ...
  void SetEventsConfiguration(EventsConfigurationT&& value) {
    ...
    m_eventsConfiguration = std::forward<EventsConfigurationT>(value);
  }
  template <typename EventsConfigurationT = EventsConfiguration>
  PutEventsConfigurationResult& WithEventsConfiguration(EventsConfigurationT&& value) {
    SetEventsConfiguration(std::forward<EventsConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  PutEventsConfigurationResult& WithRequestId(RequestIdT&& value) {
