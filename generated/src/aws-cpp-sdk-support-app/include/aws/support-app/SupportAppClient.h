...
class AWS_SUPPORTAPP_API SupportAppClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  SupportAppClient(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<SupportAppEndpointProviderBase> endpointProvider = nullptr,
      const Aws::SupportApp::SupportAppClientConfiguration& clientConfiguration = Aws::SupportApp::SupportAppClientConfiguration());
   ...
   */
  template <typename DeleteAccountAliasRequestT = Model::DeleteAccountAliasRequest>
  void DeleteAccountAliasAsync(const DeleteAccountAliasResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const DeleteAccountAliasRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteSlackWorkspaceConfigurationOutcome DeleteSlackWorkspaceConfiguration(
      const Model::DeleteSlackWorkspaceConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DeleteSlackWorkspaceConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DeleteSlackWorkspaceConfigurationRequestT = Model::DeleteSlackWorkspaceConfigurationRequest>
  Model::DeleteSlackWorkspaceConfigurationOutcomeCallable DeleteSlackWorkspaceConfigurationCallable(
      const DeleteSlackWorkspaceConfigurationRequestT& request) const {
    return SubmitCallable(&SupportAppClient::DeleteSlackWorkspaceConfiguration, request);
  }

  /**
   * An Async wrapper for DeleteSlackWorkspaceConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteSlackWorkspaceConfigurationRequestT = Model::DeleteSlackWorkspaceConfigurationRequest>
  void DeleteSlackWorkspaceConfigurationAsync(const DeleteSlackWorkspaceConfigurationRequestT& request,
                                              const DeleteSlackWorkspaceConfigurationResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetAccountAlias that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetAccountAliasRequestT = Model::GetAccountAliasRequest>
  void GetAccountAliasAsync(const GetAccountAliasResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const GetAccountAliasRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListSlackChannelConfigurationsOutcome ListSlackChannelConfigurations(
      const Model::ListSlackChannelConfigurationsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListSlackChannelConfigurations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListSlackChannelConfigurationsRequestT = Model::ListSlackChannelConfigurationsRequest>
  Model::ListSlackChannelConfigurationsOutcomeCallable ListSlackChannelConfigurationsCallable(
      const ListSlackChannelConfigurationsRequestT& request = {}) const {
    return SubmitCallable(&SupportAppClient::ListSlackChannelConfigurations, request);
  }

  /**
   * An Async wrapper for ListSlackChannelConfigurations that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListSlackChannelConfigurationsRequestT = Model::ListSlackChannelConfigurationsRequest>
  void ListSlackChannelConfigurationsAsync(const ListSlackChannelConfigurationsResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                           const ListSlackChannelConfigurationsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListSlackWorkspaceConfigurationsOutcome ListSlackWorkspaceConfigurations(
      const Model::ListSlackWorkspaceConfigurationsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListSlackWorkspaceConfigurations that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListSlackWorkspaceConfigurationsRequestT = Model::ListSlackWorkspaceConfigurationsRequest>
  Model::ListSlackWorkspaceConfigurationsOutcomeCallable ListSlackWorkspaceConfigurationsCallable(
      const ListSlackWorkspaceConfigurationsRequestT& request = {}) const {
    return SubmitCallable(&SupportAppClient::ListSlackWorkspaceConfigurations, request);
  }

  /**
   * An Async wrapper for ListSlackWorkspaceConfigurations that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListSlackWorkspaceConfigurationsRequestT = Model::ListSlackWorkspaceConfigurationsRequest>
  void ListSlackWorkspaceConfigurationsAsync(const ListSlackWorkspaceConfigurationsResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                             const ListSlackWorkspaceConfigurationsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for PutAccountAlias that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutAccountAliasRequestT = Model::PutAccountAliasRequest>
  void PutAccountAliasAsync(const PutAccountAliasRequestT& request, const PutAccountAliasResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::RegisterSlackWorkspaceForOrganizationOutcome RegisterSlackWorkspaceForOrganization(
      const Model::RegisterSlackWorkspaceForOrganizationRequest& request) const;

  /**
   * A Callable wrapper for RegisterSlackWorkspaceForOrganization that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename RegisterSlackWorkspaceForOrganizationRequestT = Model::RegisterSlackWorkspaceForOrganizationRequest>
  Model::RegisterSlackWorkspaceForOrganizationOutcomeCallable RegisterSlackWorkspaceForOrganizationCallable(
      const RegisterSlackWorkspaceForOrganizationRequestT& request) const {
    return SubmitCallable(&SupportAppClient::RegisterSlackWorkspaceForOrganization, request);
  }

  /**
   * An Async wrapper for RegisterSlackWorkspaceForOrganization that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename RegisterSlackWorkspaceForOrganizationRequestT = Model::RegisterSlackWorkspaceForOrganizationRequest>
  void RegisterSlackWorkspaceForOrganizationAsync(const RegisterSlackWorkspaceForOrganizationRequestT& request,
                                                  const RegisterSlackWorkspaceForOrganizationResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual std::shared_ptr<SupportAppEndpointProviderBase>& accessEndpointProvider();
