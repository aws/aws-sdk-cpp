...
class UpdateSlackChannelConfigurationResult {
 public:
  ...
  AWS_SUPPORTAPP_API UpdateSlackChannelConfigurationResult& operator=(
  ...
  inline UpdateSlackChannelConfigurationResult& WithNotifyOnAddCorrespondenceToCase(bool value) {
  ...
  inline UpdateSlackChannelConfigurationResult& WithNotifyOnCaseSeverity(NotificationSeverityLevel value) {
  ...
  inline UpdateSlackChannelConfigurationResult& WithNotifyOnCreateOrReopenCase(bool value) {
  ...
  inline UpdateSlackChannelConfigurationResult& WithNotifyOnResolveCase(bool value) {
