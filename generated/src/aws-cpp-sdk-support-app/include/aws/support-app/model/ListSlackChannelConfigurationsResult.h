...
class ListSlackChannelConfigurationsResult {
 public:
  ...
  AWS_SUPPORTAPP_API ListSlackChannelConfigurationsResult& operator=(
  ...
  template <typename NextTokenT = Aws::String>
  ListSlackChannelConfigurationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename SlackChannelConfigurationsT = Aws::Vector<SlackChannelConfiguration>>
  ListSlackChannelConfigurationsResult& WithSlackChannelConfigurations(SlackChannelConfigurationsT&& value) {
  ...
  ListSlackChannelConfigurationsResult& AddSlackChannelConfigurations(SlackChannelConfigurationsT&& value) {
    m_slackChannelConfigurationsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListSlackChannelConfigurationsResult& WithRequestId(RequestIdT&& value) {
