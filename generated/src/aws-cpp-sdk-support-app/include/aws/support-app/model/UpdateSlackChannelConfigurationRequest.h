...
class UpdateSlackChannelConfigurationRequest : public SupportAppRequest {
 public:
  ...
  void SetChannelRoleArn(ChannelRoleArnT&& value) {
    ...
    m_channelRoleArn = std::forward<ChannelRoleArnT>(value);
  }
  template <typename ChannelRoleArnT = Aws::String>
  UpdateSlackChannelConfigurationRequest& WithChannelRoleArn(ChannelRoleArnT&& value) {
    SetChannelRoleArn(std::forward<ChannelRoleArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetNotifyOnAddCorrespondenceToCase(bool value) {
    m_notifyOnAddCorrespondenceToCaseHasBeenSet = true;
    m_notifyOnAddCorrespondenceToCase = value;
  }
  inline UpdateSlackChannelConfigurationRequest& WithNotifyOnAddCorrespondenceToCase(bool value) {
    SetNotifyOnAddCorrespondenceToCase(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNotifyOnCaseSeverity(NotificationSeverityLevel value) {
    m_notifyOnCaseSeverityHasBeenSet = true;
    m_notifyOnCaseSeverity = value;
  }
  inline UpdateSlackChannelConfigurationRequest& WithNotifyOnCaseSeverity(NotificationSeverityLevel value) {
    SetNotifyOnCaseSeverity(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNotifyOnCreateOrReopenCase(bool value) {
    m_notifyOnCreateOrReopenCaseHasBeenSet = true;
    m_notifyOnCreateOrReopenCase = value;
  }
  inline UpdateSlackChannelConfigurationRequest& WithNotifyOnCreateOrReopenCase(bool value) {
    SetNotifyOnCreateOrReopenCase(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNotifyOnResolveCase(bool value) {
    m_notifyOnResolveCaseHasBeenSet = true;
    m_notifyOnResolveCase = value;
  }
  inline UpdateSlackChannelConfigurationRequest& WithNotifyOnResolveCase(bool value) {
    SetNotifyOnResolveCase(value);
    return *this;
  }
  ///@}
