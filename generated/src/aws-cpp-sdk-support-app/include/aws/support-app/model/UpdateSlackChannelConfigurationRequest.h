...
namespace Model
{
  ...
  public:
    ...
    template<typename ChannelIdT = Aws::String>
    UpdateSlackChannelConfigurationRequest& WithChannelId(ChannelIdT&& value) { SetChannelId(std::forward<ChannelIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ChannelNameT = Aws::String>
    UpdateSlackChannelConfigurationRequest& WithChannelName(ChannelNameT&& value) { SetChannelName(std::forward<ChannelNameT>(value)); return *this;}
    ///@}
    ...
    template<typename ChannelRoleArnT = Aws::String>
    UpdateSlackChannelConfigurationRequest& WithChannelRoleArn(ChannelRoleArnT&& value) { SetChannelRoleArn(std::forward<ChannelRoleArnT>(value)); return *this;}
    ///@}
    ...
    inline UpdateSlackChannelConfigurationRequest& WithNotifyOnCaseSeverity(NotificationSeverityLevel value) { SetNotifyOnCaseSeverity(value); return *this;}
    ///@}
    ...
    template<typename TeamIdT = Aws::String>
    UpdateSlackChannelConfigurationRequest& WithTeamId(TeamIdT&& value) { SetTeamId(std::forward<TeamIdT>(value)); return *this;}
    ///@}
  private:
