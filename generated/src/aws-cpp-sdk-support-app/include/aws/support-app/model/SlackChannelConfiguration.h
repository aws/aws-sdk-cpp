...
class SlackChannelConfiguration {
 public:
  ...
  inline SlackChannelConfiguration& WithNotifyOnAddCorrespondenceToCase(bool value) {
  ...
  inline SlackChannelConfiguration& WithNotifyOnCaseSeverity(NotificationSeverityLevel value) {
  ...
  inline SlackChannelConfiguration& WithNotifyOnCreateOrReopenCase(bool value) {
  ...
  inline SlackChannelConfiguration& WithNotifyOnResolveCase(bool value) {
