...
namespace Model
{
  ...
  public:
    ...
    inline DeleteAccountAliasResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeleteAccountAliasResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeleteAccountAliasResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
