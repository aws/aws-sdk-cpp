...
class CreateSlackChannelConfigurationRequest : public SupportAppRequest {
 public:
  ...
  inline CreateSlackChannelConfigurationRequest& WithNotifyOnAddCorrespondenceToCase(bool value) {
  ...
  inline CreateSlackChannelConfigurationRequest& WithNotifyOnCaseSeverity(NotificationSeverityLevel value) {
  ...
  inline CreateSlackChannelConfigurationRequest& WithNotifyOnCreateOrReopenCase(bool value) {
  ...
  inline CreateSlackChannelConfigurationRequest& WithNotifyOnResolveCase(bool value) {
