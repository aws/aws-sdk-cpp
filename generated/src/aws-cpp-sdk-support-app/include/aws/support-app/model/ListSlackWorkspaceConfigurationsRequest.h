...
namespace Model
{
  ...
  {
  public:
    AWS_SUPPORTAPP_API ListSlackWorkspaceConfigurationsRequest() = default;
    ...
    template<typename NextTokenT = Aws::String>
    ListSlackWorkspaceConfigurationsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
