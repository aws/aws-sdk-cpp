...
class SlackWorkspaceConfiguration {
 public:
  ...
  inline void SetAllowOrganizationMemberAccount(bool value) {
    m_allowOrganizationMemberAccountHasBeenSet = true;
    m_allowOrganizationMemberAccount = value;
  }
  inline SlackWorkspaceConfiguration& WithAllowOrganizationMemberAccount(bool value) {
    SetAllowOrganizationMemberAccount(value);
    return *this;
  }
  ///@}
  ...
  template <typename TeamIdT = Aws::String>
  SlackWorkspaceConfiguration& WithTeamId(TeamIdT&& value) {
  ...
  template <typename TeamNameT = Aws::String>
  SlackWorkspaceConfiguration& WithTeamName(TeamNameT&& value) {
