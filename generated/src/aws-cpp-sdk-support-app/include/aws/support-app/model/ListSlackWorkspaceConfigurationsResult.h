...
class ListSlackWorkspaceConfigurationsResult {
 public:
  ...
  AWS_SUPPORTAPP_API ListSlackWorkspaceConfigurationsResult& operator=(
  ...
  template <typename NextTokenT = Aws::String>
  ListSlackWorkspaceConfigurationsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetSlackWorkspaceConfigurations(SlackWorkspaceConfigurationsT&& value) {
    m_slackWorkspaceConfigurationsHasBeenSet = true;
    m_slackWorkspaceConfigurations = std::forward<SlackWorkspaceConfigurationsT>(value);
  }
  template <typename SlackWorkspaceConfigurationsT = Aws::Vector<SlackWorkspaceConfiguration>>
  ListSlackWorkspaceConfigurationsResult& WithSlackWorkspaceConfigurations(SlackWorkspaceConfigurationsT&& value) {
    SetSlackWorkspaceConfigurations(std::forward<SlackWorkspaceConfigurationsT>(value));
    return *this;
  }
  template <typename SlackWorkspaceConfigurationsT = SlackWorkspaceConfiguration>
  ListSlackWorkspaceConfigurationsResult& AddSlackWorkspaceConfigurations(SlackWorkspaceConfigurationsT&& value) {
    m_slackWorkspaceConfigurationsHasBeenSet = true;
    m_slackWorkspaceConfigurations.emplace_back(std::forward<SlackWorkspaceConfigurationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListSlackWorkspaceConfigurationsResult& WithRequestId(RequestIdT&& value) {
