...
#ifdef AWS_SUPPORTAPP_EXPORTS
#define AWS_SUPPORTAPP_API __declspec(dllexport)
#else
...
#define AWS_SUPPORTAPP_LOCAL
#else  // defined (USE_WINDOWS_DLL_SEMANTICS) || defined (WIN32)
#define AWS_SUPPORTAPP_API
#define AWS_SUPPORTAPP_EXTERN extern
#if __GNUC__ >= 4
#define AWS_SUPPORTAPP_LOCAL __attribute__((visibility("hidden")))
#else
#define AWS_SUPPORTAPP_LOCAL
#endif
