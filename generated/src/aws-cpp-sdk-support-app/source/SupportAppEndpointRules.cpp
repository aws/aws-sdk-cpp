...
{
const size_t SupportAppEndpointRules::RulesBlobStrLen = 3428;
const size_t SupportAppEndpointRules::RulesBlobSize = 3429;
...
't','a','p','p','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i',
...
'u','r','l','"',':','"','h','t','t','p','s',':','/','/','s','u','p','p','o','r','t','a','p','p','-',
...
'l','"',':','"','h','t','t','p','s',':','/','/','s','u','p','p','o','r','t','a','p','p','.','{','R',
...
'/','/','s','u','p','p','o','r','t','a','p','p','.','{','R','e','g','i','o','n','}','.','{','P','a',
...
const char* SupportAppEndpointRules::GetRulesBlob()
{
