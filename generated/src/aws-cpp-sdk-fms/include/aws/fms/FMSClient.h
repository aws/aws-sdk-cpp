...
class AWS_FMS_API FMSClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  FMSClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<FMSEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * A Callable wrapper for AssociateAdminAccount that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssociateAdminAccount that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateAdminAccountRequestT = Model::AssociateAdminAccountRequest>
  void AssociateAdminAccountAsync(const AssociateAdminAccountRequestT& request, const AssociateAdminAccountResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::AssociateThirdPartyFirewallOutcome AssociateThirdPartyFirewall(
      const Model::AssociateThirdPartyFirewallRequest& request) const;

  /**
   * A Callable wrapper for AssociateThirdPartyFirewall that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AssociateThirdPartyFirewallRequestT = Model::AssociateThirdPartyFirewallRequest>
  Model::AssociateThirdPartyFirewallOutcomeCallable AssociateThirdPartyFirewallCallable(
      const AssociateThirdPartyFirewallRequestT& request) const {
    return SubmitCallable(&FMSClient::AssociateThirdPartyFirewall, request);
  }

  /**
   * An Async wrapper for AssociateThirdPartyFirewall that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateThirdPartyFirewallRequestT = Model::AssociateThirdPartyFirewallRequest>
  void AssociateThirdPartyFirewallAsync(const AssociateThirdPartyFirewallRequestT& request,
                                        const AssociateThirdPartyFirewallResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchAssociateResource that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchAssociateResource that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchAssociateResourceRequestT = Model::BatchAssociateResourceRequest>
  void BatchAssociateResourceAsync(const BatchAssociateResourceRequestT& request,
                                   const BatchAssociateResourceResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchDisassociateResource that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename BatchDisassociateResourceRequestT = Model::BatchDisassociateResourceRequest>
  Model::BatchDisassociateResourceOutcomeCallable BatchDisassociateResourceCallable(
      const BatchDisassociateResourceRequestT& request) const {
    return SubmitCallable(&FMSClient::BatchDisassociateResource, request);
  }

  /**
   * An Async wrapper for BatchDisassociateResource that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchDisassociateResourceRequestT = Model::BatchDisassociateResourceRequest>
  void BatchDisassociateResourceAsync(const BatchDisassociateResourceRequestT& request,
                                      const BatchDisassociateResourceResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteAppsList that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteAppsListRequestT = Model::DeleteAppsListRequest>
  void DeleteAppsListAsync(const DeleteAppsListRequestT& request, const DeleteAppsListResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteNotificationChannelOutcome DeleteNotificationChannel(
      const Model::DeleteNotificationChannelRequest& request = {}) const;

  /**
   * A Callable wrapper for DeleteNotificationChannel that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DeleteNotificationChannelRequestT = Model::DeleteNotificationChannelRequest>
  Model::DeleteNotificationChannelOutcomeCallable DeleteNotificationChannelCallable(
      const DeleteNotificationChannelRequestT& request = {}) const {
    return SubmitCallable(&FMSClient::DeleteNotificationChannel, request);
  }

  /**
   * An Async wrapper for DeleteNotificationChannel that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteNotificationChannelRequestT = Model::DeleteNotificationChannelRequest>
  void DeleteNotificationChannelAsync(const DeleteNotificationChannelResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for DeleteProtocolsList that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteProtocolsList that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteProtocolsListRequestT = Model::DeleteProtocolsListRequest>
  void DeleteProtocolsListAsync(const DeleteProtocolsListRequestT& request, const DeleteProtocolsListResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteResourceSet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteResourceSet that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteResourceSetRequestT = Model::DeleteResourceSetRequest>
  void DeleteResourceSetAsync(const DeleteResourceSetRequestT& request, const DeleteResourceSetResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DisassociateAdminAccount that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DisassociateAdminAccountRequestT = Model::DisassociateAdminAccountRequest>
  Model::DisassociateAdminAccountOutcomeCallable DisassociateAdminAccountCallable(
      const DisassociateAdminAccountRequestT& request = {}) const {
    return SubmitCallable(&FMSClient::DisassociateAdminAccount, request);
  }

  /**
   * An Async wrapper for DisassociateAdminAccount that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateAdminAccountRequestT = Model::DisassociateAdminAccountRequest>
  void DisassociateAdminAccountAsync(const DisassociateAdminAccountResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const DisassociateAdminAccountRequestT& request = {}) const {
  ...
  virtual Model::DisassociateThirdPartyFirewallOutcome DisassociateThirdPartyFirewall(
      const Model::DisassociateThirdPartyFirewallRequest& request) const;

  /**
   * A Callable wrapper for DisassociateThirdPartyFirewall that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DisassociateThirdPartyFirewallRequestT = Model::DisassociateThirdPartyFirewallRequest>
  Model::DisassociateThirdPartyFirewallOutcomeCallable DisassociateThirdPartyFirewallCallable(
      const DisassociateThirdPartyFirewallRequestT& request) const {
    return SubmitCallable(&FMSClient::DisassociateThirdPartyFirewall, request);
  }

  /**
   * An Async wrapper for DisassociateThirdPartyFirewall that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DisassociateThirdPartyFirewallRequestT = Model::DisassociateThirdPartyFirewallRequest>
  void DisassociateThirdPartyFirewallAsync(const DisassociateThirdPartyFirewallRequestT& request,
                                           const DisassociateThirdPartyFirewallResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename GetAdminAccountRequestT = Model::GetAdminAccountRequest>
  void GetAdminAccountAsync(const GetAdminAccountResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const GetAdminAccountRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetAdminScope that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetAdminScopeRequestT = Model::GetAdminScopeRequest>
  void GetAdminScopeAsync(const GetAdminScopeRequestT& request, const GetAdminScopeResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetAppsList that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetAppsListRequestT = Model::GetAppsListRequest>
  void GetAppsListAsync(const GetAppsListRequestT& request, const GetAppsListResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetComplianceDetail that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetComplianceDetail that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetComplianceDetailRequestT = Model::GetComplianceDetailRequest>
  void GetComplianceDetailAsync(const GetComplianceDetailRequestT& request, const GetComplianceDetailResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetNotificationChannel that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetNotificationChannel that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetNotificationChannelRequestT = Model::GetNotificationChannelRequest>
  void GetNotificationChannelAsync(const GetNotificationChannelResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const GetNotificationChannelRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetProtectionStatus that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetProtectionStatus that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetProtectionStatusRequestT = Model::GetProtectionStatusRequest>
  void GetProtectionStatusAsync(const GetProtectionStatusRequestT& request, const GetProtectionStatusResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetProtocolsList that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetProtocolsList that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetProtocolsListRequestT = Model::GetProtocolsListRequest>
  void GetProtocolsListAsync(const GetProtocolsListRequestT& request, const GetProtocolsListResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetResourceSet that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetResourceSetRequestT = Model::GetResourceSetRequest>
  void GetResourceSetAsync(const GetResourceSetRequestT& request, const GetResourceSetResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetThirdPartyFirewallAssociationStatusOutcome GetThirdPartyFirewallAssociationStatus(
      const Model::GetThirdPartyFirewallAssociationStatusRequest& request) const;

  /**
   * A Callable wrapper for GetThirdPartyFirewallAssociationStatus that returns a future to the operation so that it can be executed in
  ...
  Model::GetThirdPartyFirewallAssociationStatusOutcomeCallable GetThirdPartyFirewallAssociationStatusCallable(
      const GetThirdPartyFirewallAssociationStatusRequestT& request) const {
    return SubmitCallable(&FMSClient::GetThirdPartyFirewallAssociationStatus, request);
  }

  /**
   * An Async wrapper for GetThirdPartyFirewallAssociationStatus that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetThirdPartyFirewallAssociationStatusRequestT = Model::GetThirdPartyFirewallAssociationStatusRequest>
  void GetThirdPartyFirewallAssociationStatusAsync(const GetThirdPartyFirewallAssociationStatusRequestT& request,
                                                   const GetThirdPartyFirewallAssociationStatusResponseReceivedHandler& handler,
                                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetViolationDetails that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetViolationDetails that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetViolationDetailsRequestT = Model::GetViolationDetailsRequest>
  void GetViolationDetailsAsync(const GetViolationDetailsRequestT& request, const GetViolationDetailsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::ListAdminAccountsForOrganizationOutcome ListAdminAccountsForOrganization(
      const Model::ListAdminAccountsForOrganizationRequest& request = {}) const;

  /**
   * A Callable wrapper for ListAdminAccountsForOrganization that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListAdminAccountsForOrganizationRequestT = Model::ListAdminAccountsForOrganizationRequest>
  Model::ListAdminAccountsForOrganizationOutcomeCallable ListAdminAccountsForOrganizationCallable(
      const ListAdminAccountsForOrganizationRequestT& request = {}) const {
    return SubmitCallable(&FMSClient::ListAdminAccountsForOrganization, request);
  }

  /**
   * An Async wrapper for ListAdminAccountsForOrganization that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListAdminAccountsForOrganizationRequestT = Model::ListAdminAccountsForOrganizationRequest>
  void ListAdminAccountsForOrganizationAsync(const ListAdminAccountsForOrganizationResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                             const ListAdminAccountsForOrganizationRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListAdminsManagingAccountOutcome ListAdminsManagingAccount(
      const Model::ListAdminsManagingAccountRequest& request = {}) const;

  /**
   * A Callable wrapper for ListAdminsManagingAccount that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListAdminsManagingAccountRequestT = Model::ListAdminsManagingAccountRequest>
  Model::ListAdminsManagingAccountOutcomeCallable ListAdminsManagingAccountCallable(
      const ListAdminsManagingAccountRequestT& request = {}) const {
    return SubmitCallable(&FMSClient::ListAdminsManagingAccount, request);
  }

  /**
   * An Async wrapper for ListAdminsManagingAccount that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAdminsManagingAccountRequestT = Model::ListAdminsManagingAccountRequest>
  void ListAdminsManagingAccountAsync(const ListAdminsManagingAccountResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const ListAdminsManagingAccountRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListAppsLists that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListAppsListsRequestT = Model::ListAppsListsRequest>
  void ListAppsListsAsync(const ListAppsListsRequestT& request, const ListAppsListsResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListComplianceStatus that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListComplianceStatus that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListComplianceStatusRequestT = Model::ListComplianceStatusRequest>
  void ListComplianceStatusAsync(const ListComplianceStatusRequestT& request, const ListComplianceStatusResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListMemberAccounts that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListMemberAccounts that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListMemberAccountsRequestT = Model::ListMemberAccountsRequest>
  void ListMemberAccountsAsync(const ListMemberAccountsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const ListMemberAccountsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListProtocolsLists that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListProtocolsLists that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListProtocolsListsRequestT = Model::ListProtocolsListsRequest>
  void ListProtocolsListsAsync(const ListProtocolsListsRequestT& request, const ListProtocolsListsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListResourceSetResources that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListResourceSetResources that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListResourceSetResourcesRequestT = Model::ListResourceSetResourcesRequest>
  void ListResourceSetResourcesAsync(const ListResourceSetResourcesRequestT& request,
                                     const ListResourceSetResourcesResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListResourceSets that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListResourceSets that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListResourceSetsRequestT = Model::ListResourceSetsRequest>
  void ListResourceSetsAsync(const ListResourceSetsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const ListResourceSetsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListThirdPartyFirewallFirewallPoliciesOutcome ListThirdPartyFirewallFirewallPolicies(
      const Model::ListThirdPartyFirewallFirewallPoliciesRequest& request) const;

  /**
   * A Callable wrapper for ListThirdPartyFirewallFirewallPolicies that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListThirdPartyFirewallFirewallPoliciesRequestT = Model::ListThirdPartyFirewallFirewallPoliciesRequest>
  Model::ListThirdPartyFirewallFirewallPoliciesOutcomeCallable ListThirdPartyFirewallFirewallPoliciesCallable(
      const ListThirdPartyFirewallFirewallPoliciesRequestT& request) const {
    return SubmitCallable(&FMSClient::ListThirdPartyFirewallFirewallPolicies, request);
  }

  /**
   * An Async wrapper for ListThirdPartyFirewallFirewallPolicies that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListThirdPartyFirewallFirewallPoliciesRequestT = Model::ListThirdPartyFirewallFirewallPoliciesRequest>
  void ListThirdPartyFirewallFirewallPoliciesAsync(const ListThirdPartyFirewallFirewallPoliciesRequestT& request,
                                                   const ListThirdPartyFirewallFirewallPoliciesResponseReceivedHandler& handler,
                                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for PutAppsList that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutAppsListRequestT = Model::PutAppsListRequest>
  void PutAppsListAsync(const PutAppsListRequestT& request, const PutAppsListResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutNotificationChannel that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutNotificationChannel that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutNotificationChannelRequestT = Model::PutNotificationChannelRequest>
  void PutNotificationChannelAsync(const PutNotificationChannelRequestT& request,
                                   const PutNotificationChannelResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutProtocolsList that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutProtocolsList that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PutProtocolsListRequestT = Model::PutProtocolsListRequest>
  void PutProtocolsListAsync(const PutProtocolsListRequestT& request, const PutProtocolsListResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for PutResourceSet that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutResourceSetRequestT = Model::PutResourceSetRequest>
  void PutResourceSetAsync(const PutResourceSetRequestT& request, const PutResourceSetResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
