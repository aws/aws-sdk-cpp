...
namespace Model
{
  ...
  {
  public:
    AWS_FMS_API PutResourceSetResult() = default;
    ...
    template<typename ResourceSetT = ResourceSet>
    PutResourceSetResult& WithResourceSet(ResourceSetT&& value) { SetResourceSet(std::forward<ResourceSetT>(value)); return *this;}
    ///@}
    ...
    template<typename ResourceSetArnT = Aws::String>
    PutResourceSetResult& WithResourceSetArn(ResourceSetArnT&& value) { SetResourceSetArn(std::forward<ResourceSetArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    PutResourceSetResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
