...
class SecurityGroupRuleDescription {
 public:
  ...
  void SetIPV4Range(IPV4RangeT&& value) {
    ...
    m_iPV4Range = std::forward<IPV4RangeT>(value);
  }
  template <typename IPV4RangeT = Aws::String>
  SecurityGroupRuleDescription& WithIPV4Range(IPV4RangeT&& value) {
    SetIPV4Range(std::forward<IPV4RangeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIPV6Range(IPV6RangeT&& value) {
    ...
    m_iPV6Range = std::forward<IPV6RangeT>(value);
  }
  template <typename IPV6RangeT = Aws::String>
  SecurityGroupRuleDescription& WithIPV6Range(IPV6RangeT&& value) {
    SetIPV6Range(std::forward<IPV6RangeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetFromPort(long long value) {
    m_fromPortHasBeenSet = true;
    m_fromPort = value;
  }
  inline SecurityGroupRuleDescription& WithFromPort(long long value) {
    SetFromPort(value);
    return *this;
  }
  ///@}
  ...
  inline void SetToPort(long long value) {
    m_toPortHasBeenSet = true;
    m_toPort = value;
  }
  inline SecurityGroupRuleDescription& WithToPort(long long value) {
    SetToPort(value);
    return *this;
  }
  ///@}
