...
class ThirdPartyFirewallFirewallPolicy {
 public:
  ...
  template <typename FirewallPolicyIdT = Aws::String>
  ThirdPartyFirewallFirewallPolicy& WithFirewallPolicyId(FirewallPolicyIdT&& value) {
  ...
  template <typename FirewallPolicyNameT = Aws::String>
  ThirdPartyFirewallFirewallPolicy& WithFirewallPolicyName(FirewallPolicyNameT&& value) {
