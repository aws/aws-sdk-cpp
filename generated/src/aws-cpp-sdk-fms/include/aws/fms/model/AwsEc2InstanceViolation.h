...
class AwsEc2InstanceViolation {
 public:
   ...
   */
  inline const Aws::Vector<AwsEc2NetworkInterfaceViolation>& GetAwsEc2NetworkInterfaceViolations() const {
    return m_awsEc2NetworkInterfaceViolations;
  }
  ...
  void SetAwsEc2NetworkInterfaceViolations(AwsEc2NetworkInterfaceViolationsT&& value) {
    ...
    m_awsEc2NetworkInterfaceViolations = std::forward<AwsEc2NetworkInterfaceViolationsT>(value);
  }
  template <typename AwsEc2NetworkInterfaceViolationsT = Aws::Vector<AwsEc2NetworkInterfaceViolation>>
  AwsEc2InstanceViolation& WithAwsEc2NetworkInterfaceViolations(AwsEc2NetworkInterfaceViolationsT&& value) {
    SetAwsEc2NetworkInterfaceViolations(std::forward<AwsEc2NetworkInterfaceViolationsT>(value));
    return *this;
  }
  ...
  AwsEc2InstanceViolation& AddAwsEc2NetworkInterfaceViolations(AwsEc2NetworkInterfaceViolationsT&& value) {
    m_awsEc2NetworkInterfaceViolationsHasBeenSet = true;
    m_awsEc2NetworkInterfaceViolations.emplace_back(std::forward<AwsEc2NetworkInterfaceViolationsT>(value));
    return *this;
  }
  ///@}
 private:
