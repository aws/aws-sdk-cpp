...
namespace Model
{
  ...
  public:
     ...
     * <li> <p>Example: <code>WAFV2</code> - Account takeover prevention and Bot
     * Control managed rule groups, and rule action override </p> <p>
     ...
     * </p> <ul> <li> <p>Fraud Control account takeover prevention (ATP) - For
     ...
     * in the <i>WAF API Reference</i>.</p> </li> <li> <p>Bot Control - For information
     * about <code>AWSManagedRulesBotControlRuleSet</code> managed rule groups, see <a
     ...
     * in the <i>WAF API Reference</i>.</p> </li> <li> <p>Rule action overrides -
     * Firewall Manager supports rule action overrides only for managed rule groups. To
     * configure a <code>RuleActionOverrides</code> add the <code>Name</code> of the
     * rule to override, and <code>ActionToUse</code>, which is the new action to use
     * for the rule. For information about using rule action override, see <a
     ...
     * </p> <p>If you update the policy's values for <code>captchaConfig</code>,
     * <code>challengeConfig</code>, or <code>tokenDomains</code>, Firewall Manager
     * will overwrite your local web ACLs to contain the new value(s). However, if you
     * don't update the policy's <code>captchaConfig</code>,
     * <code>challengeConfig</code>, or <code>tokenDomains</code> values, the values in
     * your local web ACLs will remain unchanged. For information about CAPTCHA and
     * Challenge configs, see <a
     ...
     * in the <i>WAF API Reference</i>.</p> </li> <li> <p>Example: <code>WAFV2</code> -
     * Firewall Manager support for WAF managed rule group versioning </p> <p>
