...
class CreateNetworkAclEntriesAction {
 public:
  AWS_FMS_API CreateNetworkAclEntriesAction() = default;
  ...
  template <typename DescriptionT = Aws::String>
  CreateNetworkAclEntriesAction& WithDescription(DescriptionT&& value) {
  ...
  template <typename NetworkAclIdT = ActionTarget>
  CreateNetworkAclEntriesAction& WithNetworkAclId(NetworkAclIdT&& value) {
  ...
  template <typename NetworkAclEntriesToBeCreatedT = Aws::Vector<EntryDescription>>
  void SetNetworkAclEntriesToBeCreated(NetworkAclEntriesToBeCreatedT&& value) {
    m_networkAclEntriesToBeCreatedHasBeenSet = true;
    m_networkAclEntriesToBeCreated = std::forward<NetworkAclEntriesToBeCreatedT>(value);
  }
  template <typename NetworkAclEntriesToBeCreatedT = Aws::Vector<EntryDescription>>
  CreateNetworkAclEntriesAction& WithNetworkAclEntriesToBeCreated(NetworkAclEntriesToBeCreatedT&& value) {
    SetNetworkAclEntriesToBeCreated(std::forward<NetworkAclEntriesToBeCreatedT>(value));
    return *this;
  }
  template <typename NetworkAclEntriesToBeCreatedT = EntryDescription>
  CreateNetworkAclEntriesAction& AddNetworkAclEntriesToBeCreated(NetworkAclEntriesToBeCreatedT&& value) {
    m_networkAclEntriesToBeCreatedHasBeenSet = true;
    m_networkAclEntriesToBeCreated.emplace_back(std::forward<NetworkAclEntriesToBeCreatedT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateNetworkAclEntriesAction& WithFMSCanRemediate(bool value) {
