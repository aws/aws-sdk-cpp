...
class PutProtocolsListResult {
 public:
  ...
  template <typename ProtocolsListT = ProtocolsListData>
  PutProtocolsListResult& WithProtocolsList(ProtocolsListT&& value) {
  ...
  template <typename ProtocolsListArnT = Aws::String>
  PutProtocolsListResult& WithProtocolsListArn(ProtocolsListArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  PutProtocolsListResult& WithRequestId(RequestIdT&& value) {
