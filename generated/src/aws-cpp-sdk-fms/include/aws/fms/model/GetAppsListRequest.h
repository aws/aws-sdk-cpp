...
class GetAppsListRequest : public FMSRequest {
 public:
  ...
  template <typename ListIdT = Aws::String>
  GetAppsListRequest& WithListId(ListIdT&& value) {
  ...
  inline void SetDefaultList(bool value) {
    m_defaultListHasBeenSet = true;
    m_defaultList = value;
  }
  inline GetAppsListRequest& WithDefaultList(bool value) {
