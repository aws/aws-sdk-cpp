...
class AdminScope {
 public:
  ...
  void SetOrganizationalUnitScope(OrganizationalUnitScopeT&& value) {
    ...
    m_organizationalUnitScope = std::forward<OrganizationalUnitScopeT>(value);
  }
  template <typename OrganizationalUnitScopeT = OrganizationalUnitScope>
  AdminScope& WithOrganizationalUnitScope(OrganizationalUnitScopeT&& value) {
    SetOrganizationalUnitScope(std::forward<OrganizationalUnitScopeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRegionScope(RegionScopeT&& value) {
    ...
    m_regionScope = std::forward<RegionScopeT>(value);
  }
  template <typename RegionScopeT = RegionScope>
  AdminScope& WithRegionScope(RegionScopeT&& value) {
    SetRegionScope(std::forward<RegionScopeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPolicyTypeScope(PolicyTypeScopeT&& value) {
    ...
    m_policyTypeScope = std::forward<PolicyTypeScopeT>(value);
  }
  template <typename PolicyTypeScopeT = PolicyTypeScope>
  AdminScope& WithPolicyTypeScope(PolicyTypeScopeT&& value) {
    SetPolicyTypeScope(std::forward<PolicyTypeScopeT>(value));
    return *this;
  }
  ///@}
 private:
