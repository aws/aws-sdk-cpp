...
class ProtocolsListData {
 public:
  ...
  void SetListUpdateToken(ListUpdateTokenT&& value) {
    ...
    m_listUpdateToken = std::forward<ListUpdateTokenT>(value);
  }
  template <typename ListUpdateTokenT = Aws::String>
  ProtocolsListData& WithListUpdateToken(ListUpdateTokenT&& value) {
    SetListUpdateToken(std::forward<ListUpdateTokenT>(value));
    return *this;
  }
  ///@}
  ...
  ProtocolsListData& AddProtocolsList(ProtocolsListT&& value) {
    m_protocolsListHasBeenSet = true;
    m_protocolsList.emplace_back(std::forward<ProtocolsListT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPreviousProtocolsList(PreviousProtocolsListT&& value) {
    ...
    m_previousProtocolsList = std::forward<PreviousProtocolsListT>(value);
  }
  template <typename PreviousProtocolsListT = Aws::Map<Aws::String, Aws::Vector<Aws::String>>>
  ProtocolsListData& WithPreviousProtocolsList(PreviousProtocolsListT&& value) {
    SetPreviousProtocolsList(std::forward<PreviousProtocolsListT>(value));
    return *this;
  }
  ...
  ProtocolsListData& AddPreviousProtocolsList(PreviousProtocolsListKeyT&& key, PreviousProtocolsListValueT&& value) {
    m_previousProtocolsListHasBeenSet = true;
    m_previousProtocolsList.emplace(std::forward<PreviousProtocolsListKeyT>(key), std::forward<PreviousProtocolsListValueT>(value));
    return *this;
  }
  ///@}
 private:
