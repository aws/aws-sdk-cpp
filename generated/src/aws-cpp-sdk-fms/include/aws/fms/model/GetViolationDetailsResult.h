...
class GetViolationDetailsResult {
 public:
  ...
  void SetViolationDetail(ViolationDetailT&& value) {
    m_violationDetailHasBeenSet = true;
    m_violationDetail = std::forward<ViolationDetailT>(value);
  }
  template <typename ViolationDetailT = ViolationDetail>
  GetViolationDetailsResult& WithViolationDetail(ViolationDetailT&& value) {
    SetViolationDetail(std::forward<ViolationDetailT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetViolationDetailsResult& WithRequestId(RequestIdT&& value) {
