...
class NetworkFirewallStatefulRuleGroupOverride {
 public:
  ...
  inline void SetAction(NetworkFirewallOverrideAction value) {
    m_actionHasBeenSet = true;
    m_action = value;
  }
  inline NetworkFirewallStatefulRuleGroupOverride& WithAction(NetworkFirewallOverrideAction value) {
    SetAction(value);
    return *this;
  }
  ///@}
