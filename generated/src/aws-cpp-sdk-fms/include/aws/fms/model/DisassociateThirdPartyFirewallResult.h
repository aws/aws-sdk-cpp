...
class DisassociateThirdPartyFirewallResult {
 public:
  ...
  inline void SetThirdPartyFirewallStatus(ThirdPartyFirewallAssociationStatus value) {
    m_thirdPartyFirewallStatusHasBeenSet = true;
    m_thirdPartyFirewallStatus = value;
  }
  inline DisassociateThirdPartyFirewallResult& WithThirdPartyFirewallStatus(ThirdPartyFirewallAssociationStatus value) {
    SetThirdPartyFirewallStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DisassociateThirdPartyFirewallResult& WithRequestId(RequestIdT&& value) {
