...
class RemediationActionWithOrder {
 public:
  ...
  void SetRemediationAction(RemediationActionT&& value) {
    m_remediationActionHasBeenSet = true;
    m_remediationAction = std::forward<RemediationActionT>(value);
  }
  template <typename RemediationActionT = RemediationAction>
  RemediationActionWithOrder& WithRemediationAction(RemediationActionT&& value) {
    SetRemediationAction(std::forward<RemediationActionT>(value));
    return *this;
  }
  ///@}
