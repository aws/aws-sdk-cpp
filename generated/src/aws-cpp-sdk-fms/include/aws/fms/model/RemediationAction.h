...
class RemediationAction {
 public:
  ...
  void SetEC2CreateRouteAction(EC2CreateRouteActionT&& value) {
    ...
    m_eC2CreateRouteAction = std::forward<EC2CreateRouteActionT>(value);
  }
  template <typename EC2CreateRouteActionT = EC2CreateRouteAction>
  RemediationAction& WithEC2CreateRouteAction(EC2CreateRouteActionT&& value) {
    SetEC2CreateRouteAction(std::forward<EC2CreateRouteActionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEC2ReplaceRouteAction(EC2ReplaceRouteActionT&& value) {
    ...
    m_eC2ReplaceRouteAction = std::forward<EC2ReplaceRouteActionT>(value);
  }
  template <typename EC2ReplaceRouteActionT = EC2ReplaceRouteAction>
  RemediationAction& WithEC2ReplaceRouteAction(EC2ReplaceRouteActionT&& value) {
    SetEC2ReplaceRouteAction(std::forward<EC2ReplaceRouteActionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEC2DeleteRouteAction(EC2DeleteRouteActionT&& value) {
    ...
    m_eC2DeleteRouteAction = std::forward<EC2DeleteRouteActionT>(value);
  }
  template <typename EC2DeleteRouteActionT = EC2DeleteRouteAction>
  RemediationAction& WithEC2DeleteRouteAction(EC2DeleteRouteActionT&& value) {
    SetEC2DeleteRouteAction(std::forward<EC2DeleteRouteActionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEC2CopyRouteTableAction(EC2CopyRouteTableActionT&& value) {
    ...
    m_eC2CopyRouteTableAction = std::forward<EC2CopyRouteTableActionT>(value);
  }
  template <typename EC2CopyRouteTableActionT = EC2CopyRouteTableAction>
  RemediationAction& WithEC2CopyRouteTableAction(EC2CopyRouteTableActionT&& value) {
    SetEC2CopyRouteTableAction(std::forward<EC2CopyRouteTableActionT>(value));
    return *this;
  }
  ///@}
   ...
   * API.</p>
   */
  inline const EC2ReplaceRouteTableAssociationAction& GetEC2ReplaceRouteTableAssociationAction() const {
    return m_eC2ReplaceRouteTableAssociationAction;
  }
  ...
  void SetEC2ReplaceRouteTableAssociationAction(EC2ReplaceRouteTableAssociationActionT&& value) {
    ...
    m_eC2ReplaceRouteTableAssociationAction = std::forward<EC2ReplaceRouteTableAssociationActionT>(value);
  }
  template <typename EC2ReplaceRouteTableAssociationActionT = EC2ReplaceRouteTableAssociationAction>
  RemediationAction& WithEC2ReplaceRouteTableAssociationAction(EC2ReplaceRouteTableAssociationActionT&& value) {
    SetEC2ReplaceRouteTableAssociationAction(std::forward<EC2ReplaceRouteTableAssociationActionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEC2AssociateRouteTableAction(EC2AssociateRouteTableActionT&& value) {
    ...
    m_eC2AssociateRouteTableAction = std::forward<EC2AssociateRouteTableActionT>(value);
  }
  template <typename EC2AssociateRouteTableActionT = EC2AssociateRouteTableAction>
  RemediationAction& WithEC2AssociateRouteTableAction(EC2AssociateRouteTableActionT&& value) {
    SetEC2AssociateRouteTableAction(std::forward<EC2AssociateRouteTableActionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEC2CreateRouteTableAction(EC2CreateRouteTableActionT&& value) {
    ...
    m_eC2CreateRouteTableAction = std::forward<EC2CreateRouteTableActionT>(value);
  }
  template <typename EC2CreateRouteTableActionT = EC2CreateRouteTableAction>
  RemediationAction& WithEC2CreateRouteTableAction(EC2CreateRouteTableActionT&& value) {
    SetEC2CreateRouteTableAction(std::forward<EC2CreateRouteTableActionT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const FMSPolicyUpdateFirewallCreationConfigAction& GetFMSPolicyUpdateFirewallCreationConfigAction() const {
    return m_fMSPolicyUpdateFirewallCreationConfigAction;
  }
  inline bool FMSPolicyUpdateFirewallCreationConfigActionHasBeenSet() const {
    return m_fMSPolicyUpdateFirewallCreationConfigActionHasBeenSet;
  }
  ...
  void SetFMSPolicyUpdateFirewallCreationConfigAction(FMSPolicyUpdateFirewallCreationConfigActionT&& value) {
    ...
    m_fMSPolicyUpdateFirewallCreationConfigAction = std::forward<FMSPolicyUpdateFirewallCreationConfigActionT>(value);
  }
  template <typename FMSPolicyUpdateFirewallCreationConfigActionT = FMSPolicyUpdateFirewallCreationConfigAction>
  RemediationAction& WithFMSPolicyUpdateFirewallCreationConfigAction(FMSPolicyUpdateFirewallCreationConfigActionT&& value) {
    SetFMSPolicyUpdateFirewallCreationConfigAction(std::forward<FMSPolicyUpdateFirewallCreationConfigActionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCreateNetworkAclAction(CreateNetworkAclActionT&& value) {
    ...
    m_createNetworkAclAction = std::forward<CreateNetworkAclActionT>(value);
  }
  template <typename CreateNetworkAclActionT = CreateNetworkAclAction>
  RemediationAction& WithCreateNetworkAclAction(CreateNetworkAclActionT&& value) {
    SetCreateNetworkAclAction(std::forward<CreateNetworkAclActionT>(value));
    return *this;
  }
  ///@}
   ...
   * Amazon EC2. </p>
   */
  inline const ReplaceNetworkAclAssociationAction& GetReplaceNetworkAclAssociationAction() const {
    return m_replaceNetworkAclAssociationAction;
  }
  ...
  void SetReplaceNetworkAclAssociationAction(ReplaceNetworkAclAssociationActionT&& value) {
    ...
    m_replaceNetworkAclAssociationAction = std::forward<ReplaceNetworkAclAssociationActionT>(value);
  }
  template <typename ReplaceNetworkAclAssociationActionT = ReplaceNetworkAclAssociationAction>
  RemediationAction& WithReplaceNetworkAclAssociationAction(ReplaceNetworkAclAssociationActionT&& value) {
    SetReplaceNetworkAclAssociationAction(std::forward<ReplaceNetworkAclAssociationActionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCreateNetworkAclEntriesAction(CreateNetworkAclEntriesActionT&& value) {
    ...
    m_createNetworkAclEntriesAction = std::forward<CreateNetworkAclEntriesActionT>(value);
  }
  template <typename CreateNetworkAclEntriesActionT = CreateNetworkAclEntriesAction>
  RemediationAction& WithCreateNetworkAclEntriesAction(CreateNetworkAclEntriesActionT&& value) {
    SetCreateNetworkAclEntriesAction(std::forward<CreateNetworkAclEntriesActionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDeleteNetworkAclEntriesAction(DeleteNetworkAclEntriesActionT&& value) {
    ...
    m_deleteNetworkAclEntriesAction = std::forward<DeleteNetworkAclEntriesActionT>(value);
  }
  template <typename DeleteNetworkAclEntriesActionT = DeleteNetworkAclEntriesAction>
  RemediationAction& WithDeleteNetworkAclEntriesAction(DeleteNetworkAclEntriesActionT&& value) {
    SetDeleteNetworkAclEntriesAction(std::forward<DeleteNetworkAclEntriesActionT>(value));
    return *this;
  }
  ///@}
 private:
