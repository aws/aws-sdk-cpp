...
class NetworkFirewallInternetTrafficNotInspectedViolation {
 public:
  ...
  template <typename SubnetIdT = Aws::String>
  NetworkFirewallInternetTrafficNotInspectedViolation& WithSubnetId(SubnetIdT&& value) {
  ...
  template <typename SubnetAvailabilityZoneT = Aws::String>
  NetworkFirewallInternetTrafficNotInspectedViolation& WithSubnetAvailabilityZone(SubnetAvailabilityZoneT&& value) {
  ...
  template <typename RouteTableIdT = Aws::String>
  NetworkFirewallInternetTrafficNotInspectedViolation& WithRouteTableId(RouteTableIdT&& value) {
  ...
  template <typename ViolatingRoutesT = Aws::Vector<Route>>
  NetworkFirewallInternetTrafficNotInspectedViolation& WithViolatingRoutes(ViolatingRoutesT&& value) {
    SetViolatingRoutes(std::forward<ViolatingRoutesT>(value));
    return *this;
  }
  template <typename ViolatingRoutesT = Route>
  NetworkFirewallInternetTrafficNotInspectedViolation& AddViolatingRoutes(ViolatingRoutesT&& value) {
    m_violatingRoutesHasBeenSet = true;
  ...
  inline NetworkFirewallInternetTrafficNotInspectedViolation& WithIsRouteTableUsedInDifferentAZ(bool value) {
  ...
  template <typename CurrentFirewallSubnetRouteTableT = Aws::String>
  NetworkFirewallInternetTrafficNotInspectedViolation& WithCurrentFirewallSubnetRouteTable(CurrentFirewallSubnetRouteTableT&& value) {
  ...
  template <typename ExpectedFirewallEndpointT = Aws::String>
  NetworkFirewallInternetTrafficNotInspectedViolation& WithExpectedFirewallEndpoint(ExpectedFirewallEndpointT&& value) {
  ...
  template <typename FirewallSubnetIdT = Aws::String>
  NetworkFirewallInternetTrafficNotInspectedViolation& WithFirewallSubnetId(FirewallSubnetIdT&& value) {
  ...
  template <typename ExpectedFirewallSubnetRoutesT = Aws::Vector<ExpectedRoute>>
  NetworkFirewallInternetTrafficNotInspectedViolation& WithExpectedFirewallSubnetRoutes(ExpectedFirewallSubnetRoutesT&& value) {
  ...
  NetworkFirewallInternetTrafficNotInspectedViolation& AddExpectedFirewallSubnetRoutes(ExpectedFirewallSubnetRoutesT&& value) {
    m_expectedFirewallSubnetRoutesHasBeenSet = true;
  ...
  template <typename ActualFirewallSubnetRoutesT = Aws::Vector<Route>>
  NetworkFirewallInternetTrafficNotInspectedViolation& WithActualFirewallSubnetRoutes(ActualFirewallSubnetRoutesT&& value) {
  ...
  NetworkFirewallInternetTrafficNotInspectedViolation& AddActualFirewallSubnetRoutes(ActualFirewallSubnetRoutesT&& value) {
    m_actualFirewallSubnetRoutesHasBeenSet = true;
  ...
  template <typename InternetGatewayIdT = Aws::String>
  NetworkFirewallInternetTrafficNotInspectedViolation& WithInternetGatewayId(InternetGatewayIdT&& value) {
  ...
  template <typename CurrentInternetGatewayRouteTableT = Aws::String>
  NetworkFirewallInternetTrafficNotInspectedViolation& WithCurrentInternetGatewayRouteTable(CurrentInternetGatewayRouteTableT&& value) {
  ...
  template <typename ExpectedInternetGatewayRoutesT = Aws::Vector<ExpectedRoute>>
  NetworkFirewallInternetTrafficNotInspectedViolation& WithExpectedInternetGatewayRoutes(ExpectedInternetGatewayRoutesT&& value) {
  ...
  NetworkFirewallInternetTrafficNotInspectedViolation& AddExpectedInternetGatewayRoutes(ExpectedInternetGatewayRoutesT&& value) {
    m_expectedInternetGatewayRoutesHasBeenSet = true;
  ...
  template <typename ActualInternetGatewayRoutesT = Aws::Vector<Route>>
  NetworkFirewallInternetTrafficNotInspectedViolation& WithActualInternetGatewayRoutes(ActualInternetGatewayRoutesT&& value) {
  ...
  NetworkFirewallInternetTrafficNotInspectedViolation& AddActualInternetGatewayRoutes(ActualInternetGatewayRoutesT&& value) {
    m_actualInternetGatewayRoutesHasBeenSet = true;
  ...
  template <typename VpcIdT = Aws::String>
  NetworkFirewallInternetTrafficNotInspectedViolation& WithVpcId(VpcIdT&& value) {
