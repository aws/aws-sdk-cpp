...
class DnsRuleGroupPriorityConflictViolation {
 public:
  ...
  template <typename ViolationTargetT = Aws::String>
  DnsRuleGroupPriorityConflictViolation& WithViolationTarget(ViolationTargetT&& value) {
  ...
  void SetViolationTargetDescription(ViolationTargetDescriptionT&& value) {
    ...
    m_violationTargetDescription = std::forward<ViolationTargetDescriptionT>(value);
  }
  template <typename ViolationTargetDescriptionT = Aws::String>
  DnsRuleGroupPriorityConflictViolation& WithViolationTargetDescription(ViolationTargetDescriptionT&& value) {
    SetViolationTargetDescription(std::forward<ViolationTargetDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetConflictingPolicyId(ConflictingPolicyIdT&& value) {
    m_conflictingPolicyIdHasBeenSet = true;
    m_conflictingPolicyId = std::forward<ConflictingPolicyIdT>(value);
  }
  template <typename ConflictingPolicyIdT = Aws::String>
  DnsRuleGroupPriorityConflictViolation& WithConflictingPolicyId(ConflictingPolicyIdT&& value) {
    SetConflictingPolicyId(std::forward<ConflictingPolicyIdT>(value));
    return *this;
  }
  ///@}
