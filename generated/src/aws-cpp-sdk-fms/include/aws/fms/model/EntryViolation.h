...
class EntryViolation {
 public:
  ...
  void SetExpectedEntry(ExpectedEntryT&& value) {
    ...
    m_expectedEntry = std::forward<ExpectedEntryT>(value);
  }
  template <typename ExpectedEntryT = EntryDescription>
  EntryViolation& WithExpectedEntry(ExpectedEntryT&& value) {
    SetExpectedEntry(std::forward<ExpectedEntryT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExpectedEvaluationOrder(ExpectedEvaluationOrderT&& value) {
    ...
    m_expectedEvaluationOrder = std::forward<ExpectedEvaluationOrderT>(value);
  }
  template <typename ExpectedEvaluationOrderT = Aws::String>
  EntryViolation& WithExpectedEvaluationOrder(ExpectedEvaluationOrderT&& value) {
    SetExpectedEvaluationOrder(std::forward<ExpectedEvaluationOrderT>(value));
    return *this;
  }
  ///@}
  ...
  void SetActualEvaluationOrder(ActualEvaluationOrderT&& value) {
    ...
    m_actualEvaluationOrder = std::forward<ActualEvaluationOrderT>(value);
  }
  template <typename ActualEvaluationOrderT = Aws::String>
  EntryViolation& WithActualEvaluationOrder(ActualEvaluationOrderT&& value) {
    SetActualEvaluationOrder(std::forward<ActualEvaluationOrderT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEntryAtExpectedEvaluationOrder(EntryAtExpectedEvaluationOrderT&& value) {
    ...
    m_entryAtExpectedEvaluationOrder = std::forward<EntryAtExpectedEvaluationOrderT>(value);
  }
  template <typename EntryAtExpectedEvaluationOrderT = EntryDescription>
  EntryViolation& WithEntryAtExpectedEvaluationOrder(EntryAtExpectedEvaluationOrderT&& value) {
    SetEntryAtExpectedEvaluationOrder(std::forward<EntryAtExpectedEvaluationOrderT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEntriesWithConflicts(EntriesWithConflictsT&& value) {
    ...
    m_entriesWithConflicts = std::forward<EntriesWithConflictsT>(value);
  }
  template <typename EntriesWithConflictsT = Aws::Vector<EntryDescription>>
  EntryViolation& WithEntriesWithConflicts(EntriesWithConflictsT&& value) {
    SetEntriesWithConflicts(std::forward<EntriesWithConflictsT>(value));
    return *this;
  }
  ...
  EntryViolation& AddEntriesWithConflicts(EntriesWithConflictsT&& value) {
    m_entriesWithConflictsHasBeenSet = true;
    m_entriesWithConflicts.emplace_back(std::forward<EntriesWithConflictsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEntryViolationReasons(EntryViolationReasonsT&& value) {
    ...
    m_entryViolationReasons = std::forward<EntryViolationReasonsT>(value);
  }
  template <typename EntryViolationReasonsT = Aws::Vector<EntryViolationReason>>
  EntryViolation& WithEntryViolationReasons(EntryViolationReasonsT&& value) {
    SetEntryViolationReasons(std::forward<EntryViolationReasonsT>(value));
    return *this;
  }
  inline EntryViolation& AddEntryViolationReasons(EntryViolationReason value) {
    m_entryViolationReasonsHasBeenSet = true;
    m_entryViolationReasons.push_back(value);
    return *this;
  }
  ///@}
 private:
