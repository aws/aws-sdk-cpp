...
class DeleteNetworkAclEntriesAction {
 public:
  ...
  void SetNetworkAclEntriesToBeDeleted(NetworkAclEntriesToBeDeletedT&& value) {
    ...
    m_networkAclEntriesToBeDeleted = std::forward<NetworkAclEntriesToBeDeletedT>(value);
  }
  template <typename NetworkAclEntriesToBeDeletedT = Aws::Vector<EntryDescription>>
  DeleteNetworkAclEntriesAction& WithNetworkAclEntriesToBeDeleted(NetworkAclEntriesToBeDeletedT&& value) {
    SetNetworkAclEntriesToBeDeleted(std::forward<NetworkAclEntriesToBeDeletedT>(value));
    return *this;
  }
  ...
  DeleteNetworkAclEntriesAction& AddNetworkAclEntriesToBeDeleted(NetworkAclEntriesToBeDeletedT&& value) {
    m_networkAclEntriesToBeDeletedHasBeenSet = true;
    m_networkAclEntriesToBeDeleted.emplace_back(std::forward<NetworkAclEntriesToBeDeletedT>(value));
    return *this;
  }
  ///@}
  ...
  inline DeleteNetworkAclEntriesAction& WithFMSCanRemediate(bool value) {
