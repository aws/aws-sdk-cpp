...
namespace Model
{
  ...
  {
  public:
    AWS_FMS_API ListAdminsManagingAccountRequest();
     ...
     * prior request in your next request.</p>
     */
    inline ListAdminsManagingAccountRequest& WithNextToken(const Aws::String& value) { SetNextToken(value); return *this;}
     ...
     * prior request in your next request.</p>
     */
    inline ListAdminsManagingAccountRequest& WithNextToken(Aws::String&& value) { SetNextToken(std::move(value)); return *this;}
     ...
     * prior request in your next request.</p>
     */
    inline ListAdminsManagingAccountRequest& WithNextToken(const char* value) { SetNextToken(value); return *this;}
