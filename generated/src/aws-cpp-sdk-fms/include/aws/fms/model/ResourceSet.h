...
class ResourceSet {
 public:
  ...
  void SetResourceTypeList(ResourceTypeListT&& value) {
    ...
    m_resourceTypeList = std::forward<ResourceTypeListT>(value);
  }
  template <typename ResourceTypeListT = Aws::Vector<Aws::String>>
  ResourceSet& WithResourceTypeList(ResourceTypeListT&& value) {
    SetResourceTypeList(std::forward<ResourceTypeListT>(value));
    return *this;
  }
  template <typename ResourceTypeListT = Aws::String>
  ResourceSet& AddResourceTypeList(ResourceTypeListT&& value) {
    m_resourceTypeListHasBeenSet = true;
    m_resourceTypeList.emplace_back(std::forward<ResourceTypeListT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetResourceSetStatus(ResourceSetStatus value) {
    m_resourceSetStatusHasBeenSet = true;
    m_resourceSetStatus = value;
  }
  inline ResourceSet& WithResourceSetStatus(ResourceSetStatus value) {
    SetResourceSetStatus(value);
    return *this;
  }
  ///@}
 private:
