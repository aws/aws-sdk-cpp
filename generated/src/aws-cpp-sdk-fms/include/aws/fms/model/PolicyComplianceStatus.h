...
class PolicyComplianceStatus {
 public:
  ...
  void SetPolicyOwner(PolicyOwnerT&& value) {
    ...
    m_policyOwner = std::forward<PolicyOwnerT>(value);
  }
  template <typename PolicyOwnerT = Aws::String>
  PolicyComplianceStatus& WithPolicyOwner(PolicyOwnerT&& value) {
    SetPolicyOwner(std::forward<PolicyOwnerT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename PolicyIdT = Aws::String>
  PolicyComplianceStatus& WithPolicyId(PolicyIdT&& value) {
  ...
  template <typename PolicyNameT = Aws::String>
  PolicyComplianceStatus& WithPolicyName(PolicyNameT&& value) {
  ...
  void SetMemberAccount(MemberAccountT&& value) {
    ...
    m_memberAccount = std::forward<MemberAccountT>(value);
  }
  template <typename MemberAccountT = Aws::String>
  PolicyComplianceStatus& WithMemberAccount(MemberAccountT&& value) {
    SetMemberAccount(std::forward<MemberAccountT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename EvaluationResultsT = Aws::Vector<EvaluationResult>>
  PolicyComplianceStatus& WithEvaluationResults(EvaluationResultsT&& value) {
    SetEvaluationResults(std::forward<EvaluationResultsT>(value));
    return *this;
  }
  template <typename EvaluationResultsT = EvaluationResult>
  PolicyComplianceStatus& AddEvaluationResults(EvaluationResultsT&& value) {
    m_evaluationResultsHasBeenSet = true;
  ...
  template <typename LastUpdatedT = Aws::Utils::DateTime>
  PolicyComplianceStatus& WithLastUpdated(LastUpdatedT&& value) {
  ...
  void SetIssueInfoMap(IssueInfoMapT&& value) {
    ...
    m_issueInfoMap = std::forward<IssueInfoMapT>(value);
  }
  template <typename IssueInfoMapT = Aws::Map<DependentServiceName, Aws::String>>
  PolicyComplianceStatus& WithIssueInfoMap(IssueInfoMapT&& value) {
    SetIssueInfoMap(std::forward<IssueInfoMapT>(value));
    return *this;
  }
  inline PolicyComplianceStatus& AddIssueInfoMap(DependentServiceName key, Aws::String value) {
    m_issueInfoMapHasBeenSet = true;
    m_issueInfoMap.emplace(key, value);
    return *this;
  }
  ///@}
 private:
