...
class ThirdPartyFirewallMissingSubnetViolation {
 public:
  ...
  template <typename ViolationTargetT = Aws::String>
  ThirdPartyFirewallMissingSubnetViolation& WithViolationTarget(ViolationTargetT&& value) {
  ...
  template <typename VPCT = Aws::String>
  ThirdPartyFirewallMissingSubnetViolation& WithVPC(VPCT&& value) {
  ...
  template <typename AvailabilityZoneT = Aws::String>
  ThirdPartyFirewallMissingSubnetViolation& WithAvailabilityZone(AvailabilityZoneT&& value) {
  ...
  template <typename TargetViolationReasonT = Aws::String>
  ThirdPartyFirewallMissingSubnetViolation& WithTargetViolationReason(TargetViolationReasonT&& value) {
