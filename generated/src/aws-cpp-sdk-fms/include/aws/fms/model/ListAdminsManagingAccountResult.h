...
class ListAdminsManagingAccountResult {
 public:
  ...
  template <typename AdminAccountsT = Aws::Vector<Aws::String>>
  ListAdminsManagingAccountResult& WithAdminAccounts(AdminAccountsT&& value) {
    SetAdminAccounts(std::forward<AdminAccountsT>(value));
    return *this;
  }
  template <typename AdminAccountsT = Aws::String>
  ListAdminsManagingAccountResult& AddAdminAccounts(AdminAccountsT&& value) {
    m_adminAccountsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListAdminsManagingAccountResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAdminsManagingAccountResult& WithRequestId(RequestIdT&& value) {
