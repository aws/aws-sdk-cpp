...
class ExpectedRoute {
 public:
  ...
  void SetIpV4Cidr(IpV4CidrT&& value) {
    ...
    m_ipV4Cidr = std::forward<IpV4CidrT>(value);
  }
  template <typename IpV4CidrT = Aws::String>
  ExpectedRoute& WithIpV4Cidr(IpV4CidrT&& value) {
    SetIpV4Cidr(std::forward<IpV4CidrT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIpV6Cidr(IpV6CidrT&& value) {
    ...
    m_ipV6Cidr = std::forward<IpV6CidrT>(value);
  }
  template <typename IpV6CidrT = Aws::String>
  ExpectedRoute& WithIpV6Cidr(IpV6CidrT&& value) {
    SetIpV6Cidr(std::forward<IpV6CidrT>(value));
    return *this;
  }
  ///@}
  ...
  void SetContributingSubnets(ContributingSubnetsT&& value) {
    ...
    m_contributingSubnets = std::forward<ContributingSubnetsT>(value);
  }
  template <typename ContributingSubnetsT = Aws::Vector<Aws::String>>
  ExpectedRoute& WithContributingSubnets(ContributingSubnetsT&& value) {
    SetContributingSubnets(std::forward<ContributingSubnetsT>(value));
    return *this;
  }
  template <typename ContributingSubnetsT = Aws::String>
  ExpectedRoute& AddContributingSubnets(ContributingSubnetsT&& value) {
    m_contributingSubnetsHasBeenSet = true;
    m_contributingSubnets.emplace_back(std::forward<ContributingSubnetsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAllowedTargets(AllowedTargetsT&& value) {
    ...
    m_allowedTargets = std::forward<AllowedTargetsT>(value);
  }
  template <typename AllowedTargetsT = Aws::Vector<Aws::String>>
  ExpectedRoute& WithAllowedTargets(AllowedTargetsT&& value) {
    SetAllowedTargets(std::forward<AllowedTargetsT>(value));
    return *this;
  }
  template <typename AllowedTargetsT = Aws::String>
  ExpectedRoute& AddAllowedTargets(AllowedTargetsT&& value) {
    m_allowedTargetsHasBeenSet = true;
    m_allowedTargets.emplace_back(std::forward<AllowedTargetsT>(value));
    return *this;
  }
  ///@}
