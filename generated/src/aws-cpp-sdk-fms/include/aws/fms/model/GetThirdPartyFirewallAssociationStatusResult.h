...
class GetThirdPartyFirewallAssociationStatusResult {
 public:
  ...
  AWS_FMS_API GetThirdPartyFirewallAssociationStatusResult& operator=(
  ...
  inline GetThirdPartyFirewallAssociationStatusResult& WithThirdPartyFirewallStatus(ThirdPartyFirewallAssociationStatus value) {
  ...
  inline void SetMarketplaceOnboardingStatus(MarketplaceSubscriptionOnboardingStatus value) {
    m_marketplaceOnboardingStatusHasBeenSet = true;
    m_marketplaceOnboardingStatus = value;
  }
  inline GetThirdPartyFirewallAssociationStatusResult& WithMarketplaceOnboardingStatus(MarketplaceSubscriptionOnboardingStatus value) {
    SetMarketplaceOnboardingStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetThirdPartyFirewallAssociationStatusResult& WithRequestId(RequestIdT&& value) {
