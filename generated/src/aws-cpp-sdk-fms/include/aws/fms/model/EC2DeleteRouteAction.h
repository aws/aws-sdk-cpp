...
class EC2DeleteRouteAction {
 public:
  ...
  template <typename DescriptionT = Aws::String>
  EC2DeleteRouteAction& WithDescription(DescriptionT&& value) {
  ...
  template <typename DestinationCidrBlockT = Aws::String>
  EC2DeleteRouteAction& WithDestinationCidrBlock(DestinationCidrBlockT&& value) {
  ...
  template <typename DestinationPrefixListIdT = Aws::String>
  EC2DeleteRouteAction& WithDestinationPrefixListId(DestinationPrefixListIdT&& value) {
  ...
  template <typename DestinationIpv6CidrBlockT = Aws::String>
  EC2DeleteRouteAction& WithDestinationIpv6CidrBlock(DestinationIpv6CidrBlockT&& value) {
  ...
  template <typename RouteTableIdT = ActionTarget>
  EC2DeleteRouteAction& WithRouteTableId(RouteTableIdT&& value) {
