...
class RouteHasOutOfScopeEndpointViolation {
 public:
  ...
  template <typename SubnetIdT = Aws::String>
  RouteHasOutOfScopeEndpointViolation& WithSubnetId(SubnetIdT&& value) {
  ...
  template <typename VpcIdT = Aws::String>
  RouteHasOutOfScopeEndpointViolation& WithVpcId(VpcIdT&& value) {
  ...
  template <typename RouteTableIdT = Aws::String>
  RouteHasOutOfScopeEndpointViolation& WithRouteTableId(RouteTableIdT&& value) {
  ...
  void SetViolatingRoutes(ViolatingRoutesT&& value) {
    m_violatingRoutesHasBeenSet = true;
    m_violatingRoutes = std::forward<ViolatingRoutesT>(value);
  }
  template <typename ViolatingRoutesT = Aws::Vector<Route>>
  RouteHasOutOfScopeEndpointViolation& WithViolatingRoutes(ViolatingRoutesT&& value) {
    SetViolatingRoutes(std::forward<ViolatingRoutesT>(value));
    return *this;
  }
  template <typename ViolatingRoutesT = Route>
  RouteHasOutOfScopeEndpointViolation& AddViolatingRoutes(ViolatingRoutesT&& value) {
    m_violatingRoutesHasBeenSet = true;
    m_violatingRoutes.emplace_back(std::forward<ViolatingRoutesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename SubnetAvailabilityZoneT = Aws::String>
  RouteHasOutOfScopeEndpointViolation& WithSubnetAvailabilityZone(SubnetAvailabilityZoneT&& value) {
  ...
  template <typename SubnetAvailabilityZoneIdT = Aws::String>
  RouteHasOutOfScopeEndpointViolation& WithSubnetAvailabilityZoneId(SubnetAvailabilityZoneIdT&& value) {
  ...
  void SetCurrentFirewallSubnetRouteTable(CurrentFirewallSubnetRouteTableT&& value) {
    m_currentFirewallSubnetRouteTableHasBeenSet = true;
    m_currentFirewallSubnetRouteTable = std::forward<CurrentFirewallSubnetRouteTableT>(value);
  }
  template <typename CurrentFirewallSubnetRouteTableT = Aws::String>
  RouteHasOutOfScopeEndpointViolation& WithCurrentFirewallSubnetRouteTable(CurrentFirewallSubnetRouteTableT&& value) {
    SetCurrentFirewallSubnetRouteTable(std::forward<CurrentFirewallSubnetRouteTableT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename FirewallSubnetIdT = Aws::String>
  RouteHasOutOfScopeEndpointViolation& WithFirewallSubnetId(FirewallSubnetIdT&& value) {
  ...
  void SetFirewallSubnetRoutes(FirewallSubnetRoutesT&& value) {
    m_firewallSubnetRoutesHasBeenSet = true;
    m_firewallSubnetRoutes = std::forward<FirewallSubnetRoutesT>(value);
  }
  template <typename FirewallSubnetRoutesT = Aws::Vector<Route>>
  RouteHasOutOfScopeEndpointViolation& WithFirewallSubnetRoutes(FirewallSubnetRoutesT&& value) {
    SetFirewallSubnetRoutes(std::forward<FirewallSubnetRoutesT>(value));
    return *this;
  }
  template <typename FirewallSubnetRoutesT = Route>
  RouteHasOutOfScopeEndpointViolation& AddFirewallSubnetRoutes(FirewallSubnetRoutesT&& value) {
    m_firewallSubnetRoutesHasBeenSet = true;
    m_firewallSubnetRoutes.emplace_back(std::forward<FirewallSubnetRoutesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInternetGatewayId(InternetGatewayIdT&& value) {
    ...
    m_internetGatewayId = std::forward<InternetGatewayIdT>(value);
  }
  template <typename InternetGatewayIdT = Aws::String>
  RouteHasOutOfScopeEndpointViolation& WithInternetGatewayId(InternetGatewayIdT&& value) {
    SetInternetGatewayId(std::forward<InternetGatewayIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCurrentInternetGatewayRouteTable(CurrentInternetGatewayRouteTableT&& value) {
    m_currentInternetGatewayRouteTableHasBeenSet = true;
    m_currentInternetGatewayRouteTable = std::forward<CurrentInternetGatewayRouteTableT>(value);
  }
  template <typename CurrentInternetGatewayRouteTableT = Aws::String>
  RouteHasOutOfScopeEndpointViolation& WithCurrentInternetGatewayRouteTable(CurrentInternetGatewayRouteTableT&& value) {
    SetCurrentInternetGatewayRouteTable(std::forward<CurrentInternetGatewayRouteTableT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInternetGatewayRoutes(InternetGatewayRoutesT&& value) {
    m_internetGatewayRoutesHasBeenSet = true;
    m_internetGatewayRoutes = std::forward<InternetGatewayRoutesT>(value);
  }
  template <typename InternetGatewayRoutesT = Aws::Vector<Route>>
  RouteHasOutOfScopeEndpointViolation& WithInternetGatewayRoutes(InternetGatewayRoutesT&& value) {
    SetInternetGatewayRoutes(std::forward<InternetGatewayRoutesT>(value));
    return *this;
  }
  template <typename InternetGatewayRoutesT = Route>
  RouteHasOutOfScopeEndpointViolation& AddInternetGatewayRoutes(InternetGatewayRoutesT&& value) {
    m_internetGatewayRoutesHasBeenSet = true;
    m_internetGatewayRoutes.emplace_back(std::forward<InternetGatewayRoutesT>(value));
    return *this;
  }
  ///@}
 private:
