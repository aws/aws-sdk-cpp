...
class EC2ReplaceRouteTableAssociationAction {
 public:
  ...
  template <typename DescriptionT = Aws::String>
  EC2ReplaceRouteTableAssociationAction& WithDescription(DescriptionT&& value) {
  ...
  template <typename AssociationIdT = ActionTarget>
  EC2ReplaceRouteTableAssociationAction& WithAssociationId(AssociationIdT&& value) {
  ...
  template <typename RouteTableIdT = ActionTarget>
  EC2ReplaceRouteTableAssociationAction& WithRouteTableId(RouteTableIdT&& value) {
