...
class NetworkFirewallMissingExpectedRoutesViolation {
 public:
  ...
  template <typename ViolationTargetT = Aws::String>
  NetworkFirewallMissingExpectedRoutesViolation& WithViolationTarget(ViolationTargetT&& value) {
  ...
  void SetExpectedRoutes(ExpectedRoutesT&& value) {
    m_expectedRoutesHasBeenSet = true;
    m_expectedRoutes = std::forward<ExpectedRoutesT>(value);
  }
  template <typename ExpectedRoutesT = Aws::Vector<ExpectedRoute>>
  NetworkFirewallMissingExpectedRoutesViolation& WithExpectedRoutes(ExpectedRoutesT&& value) {
    SetExpectedRoutes(std::forward<ExpectedRoutesT>(value));
    return *this;
  }
  template <typename ExpectedRoutesT = ExpectedRoute>
  NetworkFirewallMissingExpectedRoutesViolation& AddExpectedRoutes(ExpectedRoutesT&& value) {
    m_expectedRoutesHasBeenSet = true;
    m_expectedRoutes.emplace_back(std::forward<ExpectedRoutesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename VpcIdT = Aws::String>
  NetworkFirewallMissingExpectedRoutesViolation& WithVpcId(VpcIdT&& value) {
