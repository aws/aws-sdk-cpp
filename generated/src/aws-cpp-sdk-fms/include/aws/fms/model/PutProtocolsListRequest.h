...
class PutProtocolsListRequest : public FMSRequest {
 public:
  ...
  template <typename ProtocolsListT = ProtocolsListData>
  PutProtocolsListRequest& WithProtocolsList(ProtocolsListT&& value) {
  ...
  template <typename TagListT = Aws::Vector<Tag>>
  PutProtocolsListRequest& WithTagList(TagListT&& value) {
    SetTagList(std::forward<TagListT>(value));
    return *this;
  }
  template <typename TagListT = Tag>
  PutProtocolsListRequest& AddTagList(TagListT&& value) {
    m_tagListHasBeenSet = true;
