...
class EntryDescription {
 public:
  ...
  void SetEntryDetail(EntryDetailT&& value) {
    ...
    m_entryDetail = std::forward<EntryDetailT>(value);
  }
  template <typename EntryDetailT = NetworkAclEntry>
  EntryDescription& WithEntryDetail(EntryDetailT&& value) {
    SetEntryDetail(std::forward<EntryDetailT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetEntryType(EntryType value) {
    m_entryTypeHasBeenSet = true;
    m_entryType = value;
  }
  inline EntryDescription& WithEntryType(EntryType value) {
    SetEntryType(value);
    return *this;
  }
  ///@}
