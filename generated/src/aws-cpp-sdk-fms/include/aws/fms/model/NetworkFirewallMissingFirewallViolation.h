...
class NetworkFirewallMissingFirewallViolation {
 public:
  ...
  template <typename ViolationTargetT = Aws::String>
  NetworkFirewallMissingFirewallViolation& WithViolationTarget(ViolationTargetT&& value) {
  ...
  template <typename VPCT = Aws::String>
  NetworkFirewallMissingFirewallViolation& WithVPC(VPCT&& value) {
  ...
  template <typename AvailabilityZoneT = Aws::String>
  NetworkFirewallMissingFirewallViolation& WithAvailabilityZone(AvailabilityZoneT&& value) {
  ...
  template <typename TargetViolationReasonT = Aws::String>
  NetworkFirewallMissingFirewallViolation& WithTargetViolationReason(TargetViolationReasonT&& value) {
