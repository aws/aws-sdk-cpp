...
namespace Model
{
  ...
  {
  public:
    AWS_FMS_API NetworkFirewallMissingFirewallViolation();
     ...
     * <p>The ID of the Network Firewall or VPC resource that's in violation.</p>
     */
    inline NetworkFirewallMissingFirewallViolation& WithViolationTarget(const Aws::String& value) { SetViolationTarget(value); return *this;}

    /**
     * <p>The ID of the Network Firewall or VPC resource that's in violation.</p>
     */
    inline NetworkFirewallMissingFirewallViolation& WithViolationTarget(Aws::String&& value) { SetViolationTarget(std::move(value)); return *this;}

    /**
     * <p>The ID of the Network Firewall or VPC resource that's in violation.</p>
     */
    inline NetworkFirewallMissingFirewallViolation& WithViolationTarget(const char* value) { SetViolationTarget(value); return *this;}
     ...
     * <p>The resource ID of the VPC associated with a violating subnet.</p>
     */
    inline NetworkFirewallMissingFirewallViolation& WithVPC(const Aws::String& value) { SetVPC(value); return *this;}

    /**
     * <p>The resource ID of the VPC associated with a violating subnet.</p>
     */
    inline NetworkFirewallMissingFirewallViolation& WithVPC(Aws::String&& value) { SetVPC(std::move(value)); return *this;}

    /**
     * <p>The resource ID of the VPC associated with a violating subnet.</p>
     */
    inline NetworkFirewallMissingFirewallViolation& WithVPC(const char* value) { SetVPC(value); return *this;}
     ...
     * <p>The Availability Zone of a violating subnet. </p>
     */
    inline NetworkFirewallMissingFirewallViolation& WithAvailabilityZone(const Aws::String& value) { SetAvailabilityZone(value); return *this;}

    /**
     * <p>The Availability Zone of a violating subnet. </p>
     */
    inline NetworkFirewallMissingFirewallViolation& WithAvailabilityZone(Aws::String&& value) { SetAvailabilityZone(std::move(value)); return *this;}

    /**
     * <p>The Availability Zone of a violating subnet. </p>
     */
    inline NetworkFirewallMissingFirewallViolation& WithAvailabilityZone(const char* value) { SetAvailabilityZone(value); return *this;}
     ...
     * <p>The reason the resource has this violation, if one is available. </p>
     */
    inline NetworkFirewallMissingFirewallViolation& WithTargetViolationReason(const Aws::String& value) { SetTargetViolationReason(value); return *this;}

    /**
     * <p>The reason the resource has this violation, if one is available. </p>
     */
    inline NetworkFirewallMissingFirewallViolation& WithTargetViolationReason(Aws::String&& value) { SetTargetViolationReason(std::move(value)); return *this;}

    /**
     * <p>The reason the resource has this violation, if one is available. </p>
     */
    inline NetworkFirewallMissingFirewallViolation& WithTargetViolationReason(const char* value) { SetTargetViolationReason(value); return *this;}
