...
namespace Model
{
  ...
  {
  public:
    AWS_FMS_API ListMemberAccountsResult();
    ...
    inline ListMemberAccountsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}
    inline ListMemberAccountsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}
    inline ListMemberAccountsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
    ///@}
  private:
