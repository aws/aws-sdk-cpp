...
class PolicyComplianceDetail {
 public:
  ...
  inline void SetEvaluationLimitExceeded(bool value) {
    m_evaluationLimitExceededHasBeenSet = true;
    m_evaluationLimitExceeded = value;
  }
  inline PolicyComplianceDetail& WithEvaluationLimitExceeded(bool value) {
    SetEvaluationLimitExceeded(value);
    return *this;
  }
  ///@}
  ...
  void SetExpiredAt(ExpiredAtT&& value) {
    ...
    m_expiredAt = std::forward<ExpiredAtT>(value);
  }
  template <typename ExpiredAtT = Aws::Utils::DateTime>
  PolicyComplianceDetail& WithExpiredAt(ExpiredAtT&& value) {
    SetExpiredAt(std::forward<ExpiredAtT>(value));
    return *this;
  }
  ///@}
