...
class AwsEc2NetworkInterfaceViolation {
 public:
  ...
  template <typename ViolationTargetT = Aws::String>
  AwsEc2NetworkInterfaceViolation& WithViolationTarget(ViolationTargetT&& value) {
  ...
  void SetViolatingSecurityGroups(ViolatingSecurityGroupsT&& value) {
    m_violatingSecurityGroupsHasBeenSet = true;
    m_violatingSecurityGroups = std::forward<ViolatingSecurityGroupsT>(value);
  }
  template <typename ViolatingSecurityGroupsT = Aws::Vector<Aws::String>>
  AwsEc2NetworkInterfaceViolation& WithViolatingSecurityGroups(ViolatingSecurityGroupsT&& value) {
    SetViolatingSecurityGroups(std::forward<ViolatingSecurityGroupsT>(value));
    return *this;
  }
  template <typename ViolatingSecurityGroupsT = Aws::String>
  AwsEc2NetworkInterfaceViolation& AddViolatingSecurityGroups(ViolatingSecurityGroupsT&& value) {
    m_violatingSecurityGroupsHasBeenSet = true;
    m_violatingSecurityGroups.emplace_back(std::forward<ViolatingSecurityGroupsT>(value));
    return *this;
  }
  ///@}
 private:
