...
class NetworkFirewallInvalidRouteConfigurationViolation {
 public:
  ...
  void SetAffectedSubnets(AffectedSubnetsT&& value) {
    m_affectedSubnetsHasBeenSet = true;
    m_affectedSubnets = std::forward<AffectedSubnetsT>(value);
  }
  template <typename AffectedSubnetsT = Aws::Vector<Aws::String>>
  NetworkFirewallInvalidRouteConfigurationViolation& WithAffectedSubnets(AffectedSubnetsT&& value) {
    SetAffectedSubnets(std::forward<AffectedSubnetsT>(value));
    return *this;
  }
  template <typename AffectedSubnetsT = Aws::String>
  NetworkFirewallInvalidRouteConfigurationViolation& AddAffectedSubnets(AffectedSubnetsT&& value) {
    m_affectedSubnetsHasBeenSet = true;
    m_affectedSubnets.emplace_back(std::forward<AffectedSubnetsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RouteTableIdT = Aws::String>
  NetworkFirewallInvalidRouteConfigurationViolation& WithRouteTableId(RouteTableIdT&& value) {
  ...
  inline void SetIsRouteTableUsedInDifferentAZ(bool value) {
    m_isRouteTableUsedInDifferentAZHasBeenSet = true;
    m_isRouteTableUsedInDifferentAZ = value;
  }
  inline NetworkFirewallInvalidRouteConfigurationViolation& WithIsRouteTableUsedInDifferentAZ(bool value) {
    SetIsRouteTableUsedInDifferentAZ(value);
    return *this;
  }
  ///@}
  ...
  void SetViolatingRoute(ViolatingRouteT&& value) {
    m_violatingRouteHasBeenSet = true;
    m_violatingRoute = std::forward<ViolatingRouteT>(value);
  }
  template <typename ViolatingRouteT = Route>
  NetworkFirewallInvalidRouteConfigurationViolation& WithViolatingRoute(ViolatingRouteT&& value) {
    SetViolatingRoute(std::forward<ViolatingRouteT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename CurrentFirewallSubnetRouteTableT = Aws::String>
  NetworkFirewallInvalidRouteConfigurationViolation& WithCurrentFirewallSubnetRouteTable(CurrentFirewallSubnetRouteTableT&& value) {
  ...
  void SetExpectedFirewallEndpoint(ExpectedFirewallEndpointT&& value) {
    m_expectedFirewallEndpointHasBeenSet = true;
    m_expectedFirewallEndpoint = std::forward<ExpectedFirewallEndpointT>(value);
  }
  template <typename ExpectedFirewallEndpointT = Aws::String>
  NetworkFirewallInvalidRouteConfigurationViolation& WithExpectedFirewallEndpoint(ExpectedFirewallEndpointT&& value) {
    SetExpectedFirewallEndpoint(std::forward<ExpectedFirewallEndpointT>(value));
    return *this;
  }
  ///@}
  ...
  void SetActualFirewallEndpoint(ActualFirewallEndpointT&& value) {
    m_actualFirewallEndpointHasBeenSet = true;
    m_actualFirewallEndpoint = std::forward<ActualFirewallEndpointT>(value);
  }
  template <typename ActualFirewallEndpointT = Aws::String>
  NetworkFirewallInvalidRouteConfigurationViolation& WithActualFirewallEndpoint(ActualFirewallEndpointT&& value) {
    SetActualFirewallEndpoint(std::forward<ActualFirewallEndpointT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExpectedFirewallSubnetId(ExpectedFirewallSubnetIdT&& value) {
    m_expectedFirewallSubnetIdHasBeenSet = true;
    m_expectedFirewallSubnetId = std::forward<ExpectedFirewallSubnetIdT>(value);
  }
  template <typename ExpectedFirewallSubnetIdT = Aws::String>
  NetworkFirewallInvalidRouteConfigurationViolation& WithExpectedFirewallSubnetId(ExpectedFirewallSubnetIdT&& value) {
    SetExpectedFirewallSubnetId(std::forward<ExpectedFirewallSubnetIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetActualFirewallSubnetId(ActualFirewallSubnetIdT&& value) {
    m_actualFirewallSubnetIdHasBeenSet = true;
    m_actualFirewallSubnetId = std::forward<ActualFirewallSubnetIdT>(value);
  }
  template <typename ActualFirewallSubnetIdT = Aws::String>
  NetworkFirewallInvalidRouteConfigurationViolation& WithActualFirewallSubnetId(ActualFirewallSubnetIdT&& value) {
    SetActualFirewallSubnetId(std::forward<ActualFirewallSubnetIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExpectedFirewallSubnetRoutes(ExpectedFirewallSubnetRoutesT&& value) {
    m_expectedFirewallSubnetRoutesHasBeenSet = true;
    m_expectedFirewallSubnetRoutes = std::forward<ExpectedFirewallSubnetRoutesT>(value);
  }
  template <typename ExpectedFirewallSubnetRoutesT = Aws::Vector<ExpectedRoute>>
  NetworkFirewallInvalidRouteConfigurationViolation& WithExpectedFirewallSubnetRoutes(ExpectedFirewallSubnetRoutesT&& value) {
    SetExpectedFirewallSubnetRoutes(std::forward<ExpectedFirewallSubnetRoutesT>(value));
    return *this;
  }
  template <typename ExpectedFirewallSubnetRoutesT = ExpectedRoute>
  NetworkFirewallInvalidRouteConfigurationViolation& AddExpectedFirewallSubnetRoutes(ExpectedFirewallSubnetRoutesT&& value) {
    m_expectedFirewallSubnetRoutesHasBeenSet = true;
    m_expectedFirewallSubnetRoutes.emplace_back(std::forward<ExpectedFirewallSubnetRoutesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetActualFirewallSubnetRoutes(ActualFirewallSubnetRoutesT&& value) {
    m_actualFirewallSubnetRoutesHasBeenSet = true;
    m_actualFirewallSubnetRoutes = std::forward<ActualFirewallSubnetRoutesT>(value);
  }
  template <typename ActualFirewallSubnetRoutesT = Aws::Vector<Route>>
  NetworkFirewallInvalidRouteConfigurationViolation& WithActualFirewallSubnetRoutes(ActualFirewallSubnetRoutesT&& value) {
    SetActualFirewallSubnetRoutes(std::forward<ActualFirewallSubnetRoutesT>(value));
    return *this;
  }
  template <typename ActualFirewallSubnetRoutesT = Route>
  NetworkFirewallInvalidRouteConfigurationViolation& AddActualFirewallSubnetRoutes(ActualFirewallSubnetRoutesT&& value) {
    m_actualFirewallSubnetRoutesHasBeenSet = true;
    m_actualFirewallSubnetRoutes.emplace_back(std::forward<ActualFirewallSubnetRoutesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename InternetGatewayIdT = Aws::String>
  NetworkFirewallInvalidRouteConfigurationViolation& WithInternetGatewayId(InternetGatewayIdT&& value) {
  ...
  template <typename CurrentInternetGatewayRouteTableT = Aws::String>
  NetworkFirewallInvalidRouteConfigurationViolation& WithCurrentInternetGatewayRouteTable(CurrentInternetGatewayRouteTableT&& value) {
  ...
  void SetExpectedInternetGatewayRoutes(ExpectedInternetGatewayRoutesT&& value) {
    m_expectedInternetGatewayRoutesHasBeenSet = true;
    m_expectedInternetGatewayRoutes = std::forward<ExpectedInternetGatewayRoutesT>(value);
  }
  template <typename ExpectedInternetGatewayRoutesT = Aws::Vector<ExpectedRoute>>
  NetworkFirewallInvalidRouteConfigurationViolation& WithExpectedInternetGatewayRoutes(ExpectedInternetGatewayRoutesT&& value) {
    SetExpectedInternetGatewayRoutes(std::forward<ExpectedInternetGatewayRoutesT>(value));
    return *this;
  }
  template <typename ExpectedInternetGatewayRoutesT = ExpectedRoute>
  NetworkFirewallInvalidRouteConfigurationViolation& AddExpectedInternetGatewayRoutes(ExpectedInternetGatewayRoutesT&& value) {
    m_expectedInternetGatewayRoutesHasBeenSet = true;
    m_expectedInternetGatewayRoutes.emplace_back(std::forward<ExpectedInternetGatewayRoutesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetActualInternetGatewayRoutes(ActualInternetGatewayRoutesT&& value) {
    m_actualInternetGatewayRoutesHasBeenSet = true;
    m_actualInternetGatewayRoutes = std::forward<ActualInternetGatewayRoutesT>(value);
  }
  template <typename ActualInternetGatewayRoutesT = Aws::Vector<Route>>
  NetworkFirewallInvalidRouteConfigurationViolation& WithActualInternetGatewayRoutes(ActualInternetGatewayRoutesT&& value) {
    SetActualInternetGatewayRoutes(std::forward<ActualInternetGatewayRoutesT>(value));
    return *this;
  }
  template <typename ActualInternetGatewayRoutesT = Route>
  NetworkFirewallInvalidRouteConfigurationViolation& AddActualInternetGatewayRoutes(ActualInternetGatewayRoutesT&& value) {
    m_actualInternetGatewayRoutesHasBeenSet = true;
    m_actualInternetGatewayRoutes.emplace_back(std::forward<ActualInternetGatewayRoutesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename VpcIdT = Aws::String>
  NetworkFirewallInvalidRouteConfigurationViolation& WithVpcId(VpcIdT&& value) {
