...
class SecurityGroupRemediationAction {
 public:
  ...
  inline void SetRemediationActionType(RemediationActionType value) {
    m_remediationActionTypeHasBeenSet = true;
    m_remediationActionType = value;
  }
  inline SecurityGroupRemediationAction& WithRemediationActionType(RemediationActionType value) {
    SetRemediationActionType(value);
    return *this;
  }
  ///@}
  ...
  void SetRemediationResult(RemediationResultT&& value) {
    m_remediationResultHasBeenSet = true;
    m_remediationResult = std::forward<RemediationResultT>(value);
  }
  template <typename RemediationResultT = SecurityGroupRuleDescription>
  SecurityGroupRemediationAction& WithRemediationResult(RemediationResultT&& value) {
    SetRemediationResult(std::forward<RemediationResultT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetIsDefaultAction(bool value) {
    m_isDefaultActionHasBeenSet = true;
    m_isDefaultAction = value;
  }
  inline SecurityGroupRemediationAction& WithIsDefaultAction(bool value) {
    SetIsDefaultAction(value);
    return *this;
  }
  ///@}
 private:
