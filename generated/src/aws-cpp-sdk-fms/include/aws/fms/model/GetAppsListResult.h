...
namespace Model
{
  ...
  public:
    ...
    template<typename AppsListT = AppsListData>
    GetAppsListResult& WithAppsList(AppsListT&& value) { SetAppsList(std::forward<AppsListT>(value)); return *this;}
    ///@}
    ...
    template<typename AppsListArnT = Aws::String>
    GetAppsListResult& WithAppsListArn(AppsListArnT&& value) { SetAppsListArn(std::forward<AppsListArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    GetAppsListResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
