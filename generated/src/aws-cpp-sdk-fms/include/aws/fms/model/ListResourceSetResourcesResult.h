...
class ListResourceSetResourcesResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<Resource>>
  ListResourceSetResourcesResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = Resource>
  ListResourceSetResourcesResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListResourceSetResourcesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListResourceSetResourcesResult& WithRequestId(RequestIdT&& value) {
