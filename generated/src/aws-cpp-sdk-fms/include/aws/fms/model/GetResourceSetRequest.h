...
namespace Model
{
  ...
  /**
   */
  class GetResourceSetRequest : public FMSRequest
  {
  public:
    AWS_FMS_API GetResourceSetRequest();
     ...
     * resource set.</p>
     */
    inline GetResourceSetRequest& WithIdentifier(const char* value) { SetIdentifier(value); return *this;}
