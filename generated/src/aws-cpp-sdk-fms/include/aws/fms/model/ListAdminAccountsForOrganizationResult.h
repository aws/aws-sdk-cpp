...
class ListAdminAccountsForOrganizationResult {
 public:
  ...
  template <typename AdminAccountsT = Aws::Vector<AdminAccountSummary>>
  ListAdminAccountsForOrganizationResult& WithAdminAccounts(AdminAccountsT&& value) {
    SetAdminAccounts(std::forward<AdminAccountsT>(value));
    return *this;
  }
  template <typename AdminAccountsT = AdminAccountSummary>
  ListAdminAccountsForOrganizationResult& AddAdminAccounts(AdminAccountsT&& value) {
    m_adminAccountsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListAdminAccountsForOrganizationResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAdminAccountsForOrganizationResult& WithRequestId(RequestIdT&& value) {
