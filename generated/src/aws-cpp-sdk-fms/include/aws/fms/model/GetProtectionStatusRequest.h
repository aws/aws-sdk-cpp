...
class GetProtectionStatusRequest : public FMSRequest {
 public:
  ...
  void SetMemberAccountId(MemberAccountIdT&& value) {
    m_memberAccountIdHasBeenSet = true;
    m_memberAccountId = std::forward<MemberAccountIdT>(value);
  }
  template <typename MemberAccountIdT = Aws::String>
  GetProtectionStatusRequest& WithMemberAccountId(MemberAccountIdT&& value) {
    SetMemberAccountId(std::forward<MemberAccountIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetProtectionStatusRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
