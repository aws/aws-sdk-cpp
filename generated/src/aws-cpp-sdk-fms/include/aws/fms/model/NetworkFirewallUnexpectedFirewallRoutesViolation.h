...
class NetworkFirewallUnexpectedFirewallRoutesViolation {
 public:
  ...
  template <typename FirewallSubnetIdT = Aws::String>
  NetworkFirewallUnexpectedFirewallRoutesViolation& WithFirewallSubnetId(FirewallSubnetIdT&& value) {
  ...
  template <typename ViolatingRoutesT = Aws::Vector<Route>>
  NetworkFirewallUnexpectedFirewallRoutesViolation& WithViolatingRoutes(ViolatingRoutesT&& value) {
    SetViolatingRoutes(std::forward<ViolatingRoutesT>(value));
    return *this;
  }
  template <typename ViolatingRoutesT = Route>
  NetworkFirewallUnexpectedFirewallRoutesViolation& AddViolatingRoutes(ViolatingRoutesT&& value) {
    m_violatingRoutesHasBeenSet = true;
  ...
  template <typename RouteTableIdT = Aws::String>
  NetworkFirewallUnexpectedFirewallRoutesViolation& WithRouteTableId(RouteTableIdT&& value) {
  ...
  void SetFirewallEndpoint(FirewallEndpointT&& value) {
    m_firewallEndpointHasBeenSet = true;
    m_firewallEndpoint = std::forward<FirewallEndpointT>(value);
  }
  template <typename FirewallEndpointT = Aws::String>
  NetworkFirewallUnexpectedFirewallRoutesViolation& WithFirewallEndpoint(FirewallEndpointT&& value) {
    SetFirewallEndpoint(std::forward<FirewallEndpointT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename VpcIdT = Aws::String>
  NetworkFirewallUnexpectedFirewallRoutesViolation& WithVpcId(VpcIdT&& value) {
