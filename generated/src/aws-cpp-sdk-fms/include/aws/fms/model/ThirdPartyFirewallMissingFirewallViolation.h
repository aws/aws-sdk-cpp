...
class ThirdPartyFirewallMissingFirewallViolation {
 public:
  ...
  template <typename ViolationTargetT = Aws::String>
  ThirdPartyFirewallMissingFirewallViolation& WithViolationTarget(ViolationTargetT&& value) {
  ...
  template <typename VPCT = Aws::String>
  ThirdPartyFirewallMissingFirewallViolation& WithVPC(VPCT&& value) {
  ...
  template <typename AvailabilityZoneT = Aws::String>
  ThirdPartyFirewallMissingFirewallViolation& WithAvailabilityZone(AvailabilityZoneT&& value) {
  ...
  template <typename TargetViolationReasonT = Aws::String>
  ThirdPartyFirewallMissingFirewallViolation& WithTargetViolationReason(TargetViolationReasonT&& value) {
