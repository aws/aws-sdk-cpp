...
class ViolationDetail {
 public:
  ...
  void SetResourceViolations(ResourceViolationsT&& value) {
    ...
    m_resourceViolations = std::forward<ResourceViolationsT>(value);
  }
  template <typename ResourceViolationsT = Aws::Vector<ResourceViolation>>
  ViolationDetail& WithResourceViolations(ResourceViolationsT&& value) {
    SetResourceViolations(std::forward<ResourceViolationsT>(value));
    return *this;
  }
  template <typename ResourceViolationsT = ResourceViolation>
  ViolationDetail& AddResourceViolations(ResourceViolationsT&& value) {
    m_resourceViolationsHasBeenSet = true;
    m_resourceViolations.emplace_back(std::forward<ResourceViolationsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetResourceDescription(ResourceDescriptionT&& value) {
    ...
    m_resourceDescription = std::forward<ResourceDescriptionT>(value);
  }
  template <typename ResourceDescriptionT = Aws::String>
  ViolationDetail& WithResourceDescription(ResourceDescriptionT&& value) {
    SetResourceDescription(std::forward<ResourceDescriptionT>(value));
    return *this;
  }
  ///@}
 private:
