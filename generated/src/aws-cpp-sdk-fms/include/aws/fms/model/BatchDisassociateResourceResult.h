...
class BatchDisassociateResourceResult {
 public:
  ...
  template <typename ResourceSetIdentifierT = Aws::String>
  BatchDisassociateResourceResult& WithResourceSetIdentifier(ResourceSetIdentifierT&& value) {
  ...
  template <typename FailedItemsT = Aws::Vector<FailedItem>>
  BatchDisassociateResourceResult& WithFailedItems(FailedItemsT&& value) {
    SetFailedItems(std::forward<FailedItemsT>(value));
    return *this;
  }
  template <typename FailedItemsT = FailedItem>
  BatchDisassociateResourceResult& AddFailedItems(FailedItemsT&& value) {
    m_failedItemsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  BatchDisassociateResourceResult& WithRequestId(RequestIdT&& value) {
