...
class AccountScope {
 public:
  ...
  inline void SetAllAccountsEnabled(bool value) {
    m_allAccountsEnabledHasBeenSet = true;
    m_allAccountsEnabled = value;
  }
  inline AccountScope& WithAllAccountsEnabled(bool value) {
    SetAllAccountsEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline void SetExcludeSpecifiedAccounts(bool value) {
    m_excludeSpecifiedAccountsHasBeenSet = true;
    m_excludeSpecifiedAccounts = value;
  }
  inline AccountScope& WithExcludeSpecifiedAccounts(bool value) {
    SetExcludeSpecifiedAccounts(value);
    return *this;
  }
  ///@}
 private:
