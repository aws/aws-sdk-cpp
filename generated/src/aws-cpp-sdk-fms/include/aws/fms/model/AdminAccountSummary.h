...
class AdminAccountSummary {
 public:
  ...
  inline void SetDefaultAdmin(bool value) {
    m_defaultAdminHasBeenSet = true;
    m_defaultAdmin = value;
  }
  inline AdminAccountSummary& WithDefaultAdmin(bool value) {
  ...
  inline void SetStatus(OrganizationStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline AdminAccountSummary& WithStatus(OrganizationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
