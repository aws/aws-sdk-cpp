...
namespace Model
{
  ...
  public:
    ...
    template<typename ViolationTargetT = Aws::String>
    NetworkFirewallMissingSubnetViolation& WithViolationTarget(ViolationTargetT&& value) { SetViolationTarget(std::forward<ViolationTargetT>(value)); return *this;}
    ///@}
    ...
    template<typename VPCT = Aws::String>
    NetworkFirewallMissingSubnetViolation& WithVPC(VPCT&& value) { SetVPC(std::forward<VPCT>(value)); return *this;}
    ///@}
    ...
    template<typename AvailabilityZoneT = Aws::String>
    NetworkFirewallMissingSubnetViolation& WithAvailabilityZone(AvailabilityZoneT&& value) { SetAvailabilityZone(std::forward<AvailabilityZoneT>(value)); return *this;}
    ///@}
    ...
    template<typename TargetViolationReasonT = Aws::String>
    NetworkFirewallMissingSubnetViolation& WithTargetViolationReason(TargetViolationReasonT&& value) { SetTargetViolationReason(std::forward<TargetViolationReasonT>(value)); return *this;}
    ///@}
  private:
