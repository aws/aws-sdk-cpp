...
class NetworkFirewallPolicyDescription {
 public:
  ...
  void SetStatelessRuleGroups(StatelessRuleGroupsT&& value) {
    ...
    m_statelessRuleGroups = std::forward<StatelessRuleGroupsT>(value);
  }
  template <typename StatelessRuleGroupsT = Aws::Vector<StatelessRuleGroup>>
  NetworkFirewallPolicyDescription& WithStatelessRuleGroups(StatelessRuleGroupsT&& value) {
    SetStatelessRuleGroups(std::forward<StatelessRuleGroupsT>(value));
    return *this;
  }
  ...
  NetworkFirewallPolicyDescription& AddStatelessRuleGroups(StatelessRuleGroupsT&& value) {
    m_statelessRuleGroupsHasBeenSet = true;
    m_statelessRuleGroups.emplace_back(std::forward<StatelessRuleGroupsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStatefulRuleGroups(StatefulRuleGroupsT&& value) {
    ...
    m_statefulRuleGroups = std::forward<StatefulRuleGroupsT>(value);
  }
  template <typename StatefulRuleGroupsT = Aws::Vector<StatefulRuleGroup>>
  NetworkFirewallPolicyDescription& WithStatefulRuleGroups(StatefulRuleGroupsT&& value) {
    SetStatefulRuleGroups(std::forward<StatefulRuleGroupsT>(value));
    return *this;
  }
  ...
  NetworkFirewallPolicyDescription& AddStatefulRuleGroups(StatefulRuleGroupsT&& value) {
    m_statefulRuleGroupsHasBeenSet = true;
    m_statefulRuleGroups.emplace_back(std::forward<StatefulRuleGroupsT>(value));
    return *this;
  }
  ///@}
