...
class PolicyOption {
 public:
  ...
  void SetNetworkFirewallPolicy(NetworkFirewallPolicyT&& value) {
    ...
    m_networkFirewallPolicy = std::forward<NetworkFirewallPolicyT>(value);
  }
  template <typename NetworkFirewallPolicyT = NetworkFirewallPolicy>
  PolicyOption& WithNetworkFirewallPolicy(NetworkFirewallPolicyT&& value) {
    SetNetworkFirewallPolicy(std::forward<NetworkFirewallPolicyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetThirdPartyFirewallPolicy(ThirdPartyFirewallPolicyT&& value) {
    ...
    m_thirdPartyFirewallPolicy = std::forward<ThirdPartyFirewallPolicyT>(value);
  }
  template <typename ThirdPartyFirewallPolicyT = ThirdPartyFirewallPolicy>
  PolicyOption& WithThirdPartyFirewallPolicy(ThirdPartyFirewallPolicyT&& value) {
    SetThirdPartyFirewallPolicy(std::forward<ThirdPartyFirewallPolicyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNetworkAclCommonPolicy(NetworkAclCommonPolicyT&& value) {
    ...
    m_networkAclCommonPolicy = std::forward<NetworkAclCommonPolicyT>(value);
  }
  template <typename NetworkAclCommonPolicyT = NetworkAclCommonPolicy>
  PolicyOption& WithNetworkAclCommonPolicy(NetworkAclCommonPolicyT&& value) {
    SetNetworkAclCommonPolicy(std::forward<NetworkAclCommonPolicyT>(value));
    return *this;
  }
  ///@}
 private:
