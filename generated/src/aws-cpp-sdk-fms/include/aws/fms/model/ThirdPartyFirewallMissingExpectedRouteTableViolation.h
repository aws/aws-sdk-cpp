...
class ThirdPartyFirewallMissingExpectedRouteTableViolation {
 public:
  ...
  template <typename ViolationTargetT = Aws::String>
  ThirdPartyFirewallMissingExpectedRouteTableViolation& WithViolationTarget(ViolationTargetT&& value) {
  ...
  template <typename VPCT = Aws::String>
  ThirdPartyFirewallMissingExpectedRouteTableViolation& WithVPC(VPCT&& value) {
  ...
  template <typename AvailabilityZoneT = Aws::String>
  ThirdPartyFirewallMissingExpectedRouteTableViolation& WithAvailabilityZone(AvailabilityZoneT&& value) {
  ...
  template <typename CurrentRouteTableT = Aws::String>
  ThirdPartyFirewallMissingExpectedRouteTableViolation& WithCurrentRouteTable(CurrentRouteTableT&& value) {
  ...
  template <typename ExpectedRouteTableT = Aws::String>
  ThirdPartyFirewallMissingExpectedRouteTableViolation& WithExpectedRouteTable(ExpectedRouteTableT&& value) {
