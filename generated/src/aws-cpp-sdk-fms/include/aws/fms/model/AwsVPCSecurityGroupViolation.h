...
class AwsVPCSecurityGroupViolation {
 public:
  ...
  template <typename ViolationTargetT = Aws::String>
  AwsVPCSecurityGroupViolation& WithViolationTarget(ViolationTargetT&& value) {
  ...
  template <typename ViolationTargetDescriptionT = Aws::String>
  AwsVPCSecurityGroupViolation& WithViolationTargetDescription(ViolationTargetDescriptionT&& value) {
  ...
  void SetPartialMatches(PartialMatchesT&& value) {
    m_partialMatchesHasBeenSet = true;
    m_partialMatches = std::forward<PartialMatchesT>(value);
  }
  template <typename PartialMatchesT = Aws::Vector<PartialMatch>>
  AwsVPCSecurityGroupViolation& WithPartialMatches(PartialMatchesT&& value) {
    SetPartialMatches(std::forward<PartialMatchesT>(value));
    return *this;
  }
  template <typename PartialMatchesT = PartialMatch>
  AwsVPCSecurityGroupViolation& AddPartialMatches(PartialMatchesT&& value) {
    m_partialMatchesHasBeenSet = true;
    m_partialMatches.emplace_back(std::forward<PartialMatchesT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::Vector<SecurityGroupRemediationAction>& GetPossibleSecurityGroupRemediationActions() const {
    return m_possibleSecurityGroupRemediationActions;
  }
  ...
  void SetPossibleSecurityGroupRemediationActions(PossibleSecurityGroupRemediationActionsT&& value) {
    m_possibleSecurityGroupRemediationActionsHasBeenSet = true;
    m_possibleSecurityGroupRemediationActions = std::forward<PossibleSecurityGroupRemediationActionsT>(value);
  }
  template <typename PossibleSecurityGroupRemediationActionsT = Aws::Vector<SecurityGroupRemediationAction>>
  AwsVPCSecurityGroupViolation& WithPossibleSecurityGroupRemediationActions(PossibleSecurityGroupRemediationActionsT&& value) {
    SetPossibleSecurityGroupRemediationActions(std::forward<PossibleSecurityGroupRemediationActionsT>(value));
    return *this;
  }
  template <typename PossibleSecurityGroupRemediationActionsT = SecurityGroupRemediationAction>
  AwsVPCSecurityGroupViolation& AddPossibleSecurityGroupRemediationActions(PossibleSecurityGroupRemediationActionsT&& value) {
    m_possibleSecurityGroupRemediationActionsHasBeenSet = true;
    m_possibleSecurityGroupRemediationActions.emplace_back(std::forward<PossibleSecurityGroupRemediationActionsT>(value));
    return *this;
  }
  ///@}
 private:
