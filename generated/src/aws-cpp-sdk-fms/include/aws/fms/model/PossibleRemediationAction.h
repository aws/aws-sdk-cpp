...
class PossibleRemediationAction {
 public:
  ...
  template <typename DescriptionT = Aws::String>
  PossibleRemediationAction& WithDescription(DescriptionT&& value) {
  ...
  void SetOrderedRemediationActions(OrderedRemediationActionsT&& value) {
    m_orderedRemediationActionsHasBeenSet = true;
    m_orderedRemediationActions = std::forward<OrderedRemediationActionsT>(value);
  }
  template <typename OrderedRemediationActionsT = Aws::Vector<RemediationActionWithOrder>>
  PossibleRemediationAction& WithOrderedRemediationActions(OrderedRemediationActionsT&& value) {
    SetOrderedRemediationActions(std::forward<OrderedRemediationActionsT>(value));
    return *this;
  }
  template <typename OrderedRemediationActionsT = RemediationActionWithOrder>
  PossibleRemediationAction& AddOrderedRemediationActions(OrderedRemediationActionsT&& value) {
    m_orderedRemediationActionsHasBeenSet = true;
    m_orderedRemediationActions.emplace_back(std::forward<OrderedRemediationActionsT>(value));
    return *this;
  }
  ///@}
  ...
  inline PossibleRemediationAction& WithIsDefaultAction(bool value) {
