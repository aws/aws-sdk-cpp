...
class PolicyTypeScope {
 public:
  ...
  template <typename PolicyTypesT = Aws::Vector<SecurityServiceType>>
  PolicyTypeScope& WithPolicyTypes(PolicyTypesT&& value) {
    SetPolicyTypes(std::forward<PolicyTypesT>(value));
    return *this;
  }
  inline PolicyTypeScope& AddPolicyTypes(SecurityServiceType value) {
    m_policyTypesHasBeenSet = true;
    m_policyTypes.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAllPolicyTypesEnabled(bool value) {
    m_allPolicyTypesEnabledHasBeenSet = true;
    m_allPolicyTypesEnabled = value;
  }
  inline PolicyTypeScope& WithAllPolicyTypesEnabled(bool value) {
    SetAllPolicyTypesEnabled(value);
    return *this;
  }
  ///@}
 private:
