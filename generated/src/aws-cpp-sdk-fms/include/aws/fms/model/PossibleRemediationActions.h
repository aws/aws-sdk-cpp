...
class PossibleRemediationActions {
 public:
  ...
  template <typename DescriptionT = Aws::String>
  PossibleRemediationActions& WithDescription(DescriptionT&& value) {
  ...
  template <typename ActionsT = Aws::Vector<PossibleRemediationAction>>
  PossibleRemediationActions& WithActions(ActionsT&& value) {
    SetActions(std::forward<ActionsT>(value));
    return *this;
  }
  template <typename ActionsT = PossibleRemediationAction>
  PossibleRemediationActions& AddActions(ActionsT&& value) {
    m_actionsHasBeenSet = true;
