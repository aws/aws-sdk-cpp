...
class Policy {
 public:
  ...
  void SetPolicyUpdateToken(PolicyUpdateTokenT&& value) {
    ...
    m_policyUpdateToken = std::forward<PolicyUpdateTokenT>(value);
  }
  template <typename PolicyUpdateTokenT = Aws::String>
  Policy& WithPolicyUpdateToken(PolicyUpdateTokenT&& value) {
    SetPolicyUpdateToken(std::forward<PolicyUpdateTokenT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSecurityServicePolicyData(SecurityServicePolicyDataT&& value) {
    ...
    m_securityServicePolicyData = std::forward<SecurityServicePolicyDataT>(value);
  }
  template <typename SecurityServicePolicyDataT = SecurityServicePolicyData>
  Policy& WithSecurityServicePolicyData(SecurityServicePolicyDataT&& value) {
    SetSecurityServicePolicyData(std::forward<SecurityServicePolicyDataT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetExcludeResourceTags(bool value) {
    m_excludeResourceTagsHasBeenSet = true;
    m_excludeResourceTags = value;
  }
  inline Policy& WithExcludeResourceTags(bool value) {
    SetExcludeResourceTags(value);
    return *this;
  }
  ///@}
  ...
  inline Policy& WithRemediationEnabled(bool value) {
  ...
  inline void SetDeleteUnusedFMManagedResources(bool value) {
    m_deleteUnusedFMManagedResourcesHasBeenSet = true;
    m_deleteUnusedFMManagedResources = value;
  }
  inline Policy& WithDeleteUnusedFMManagedResources(bool value) {
    SetDeleteUnusedFMManagedResources(value);
    return *this;
  }
  ///@}
  ...
  void SetResourceSetIds(ResourceSetIdsT&& value) {
    ...
    m_resourceSetIds = std::forward<ResourceSetIdsT>(value);
  }
  template <typename ResourceSetIdsT = Aws::Vector<Aws::String>>
  Policy& WithResourceSetIds(ResourceSetIdsT&& value) {
    SetResourceSetIds(std::forward<ResourceSetIdsT>(value));
    return *this;
  }
  template <typename ResourceSetIdsT = Aws::String>
  Policy& AddResourceSetIds(ResourceSetIdsT&& value) {
    m_resourceSetIdsHasBeenSet = true;
    m_resourceSetIds.emplace_back(std::forward<ResourceSetIdsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetPolicyStatus(CustomerPolicyStatus value) {
    m_policyStatusHasBeenSet = true;
    m_policyStatus = value;
  }
  inline Policy& WithPolicyStatus(CustomerPolicyStatus value) {
  ...
  inline void SetResourceTagLogicalOperator(ResourceTagLogicalOperator value) {
    m_resourceTagLogicalOperatorHasBeenSet = true;
    m_resourceTagLogicalOperator = value;
  }
  inline Policy& WithResourceTagLogicalOperator(ResourceTagLogicalOperator value) {
    SetResourceTagLogicalOperator(value);
    return *this;
  }
  ///@}
 private:
