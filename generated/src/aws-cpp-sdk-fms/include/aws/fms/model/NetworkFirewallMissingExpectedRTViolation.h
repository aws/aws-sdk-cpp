...
class NetworkFirewallMissingExpectedRTViolation {
 public:
  ...
  template <typename ViolationTargetT = Aws::String>
  NetworkFirewallMissingExpectedRTViolation& WithViolationTarget(ViolationTargetT&& value) {
  ...
  template <typename VPCT = Aws::String>
  NetworkFirewallMissingExpectedRTViolation& WithVPC(VPCT&& value) {
  ...
  template <typename AvailabilityZoneT = Aws::String>
  NetworkFirewallMissingExpectedRTViolation& WithAvailabilityZone(AvailabilityZoneT&& value) {
  ...
  void SetCurrentRouteTable(CurrentRouteTableT&& value) {
    m_currentRouteTableHasBeenSet = true;
    m_currentRouteTable = std::forward<CurrentRouteTableT>(value);
  }
  template <typename CurrentRouteTableT = Aws::String>
  NetworkFirewallMissingExpectedRTViolation& WithCurrentRouteTable(CurrentRouteTableT&& value) {
    SetCurrentRouteTable(std::forward<CurrentRouteTableT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExpectedRouteTable(ExpectedRouteTableT&& value) {
    m_expectedRouteTableHasBeenSet = true;
    m_expectedRouteTable = std::forward<ExpectedRouteTableT>(value);
  }
  template <typename ExpectedRouteTableT = Aws::String>
  NetworkFirewallMissingExpectedRTViolation& WithExpectedRouteTable(ExpectedRouteTableT&& value) {
    SetExpectedRouteTable(std::forward<ExpectedRouteTableT>(value));
    return *this;
  }
  ///@}
 private:
