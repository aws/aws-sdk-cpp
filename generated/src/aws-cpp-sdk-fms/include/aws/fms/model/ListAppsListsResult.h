...
class ListAppsListsResult {
 public:
  ...
  void SetAppsLists(AppsListsT&& value) {
    m_appsListsHasBeenSet = true;
    m_appsLists = std::forward<AppsListsT>(value);
  }
  template <typename AppsListsT = Aws::Vector<AppsListDataSummary>>
  ListAppsListsResult& WithAppsLists(AppsListsT&& value) {
    SetAppsLists(std::forward<AppsListsT>(value));
    return *this;
  }
  template <typename AppsListsT = AppsListDataSummary>
  ListAppsListsResult& AddAppsLists(AppsListsT&& value) {
    m_appsListsHasBeenSet = true;
    m_appsLists.emplace_back(std::forward<AppsListsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAppsListsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAppsListsResult& WithRequestId(RequestIdT&& value) {
