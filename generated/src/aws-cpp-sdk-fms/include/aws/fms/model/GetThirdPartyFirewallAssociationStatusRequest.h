...
namespace Model
{
  ...
  public:
    ...
    inline GetThirdPartyFirewallAssociationStatusRequest& WithThirdPartyFirewall(const ThirdPartyFirewall& value) { SetThirdPartyFirewall(value); return *this;}
    inline GetThirdPartyFirewallAssociationStatusRequest& WithThirdPartyFirewall(ThirdPartyFirewall&& value) { SetThirdPartyFirewall(std::move(value)); return *this;}
    ///@}
  private:
