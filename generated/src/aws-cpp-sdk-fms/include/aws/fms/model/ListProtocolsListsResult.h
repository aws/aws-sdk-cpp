...
class ListProtocolsListsResult {
 public:
  ...
  void SetProtocolsLists(ProtocolsListsT&& value) {
    m_protocolsListsHasBeenSet = true;
    m_protocolsLists = std::forward<ProtocolsListsT>(value);
  }
  template <typename ProtocolsListsT = Aws::Vector<ProtocolsListDataSummary>>
  ListProtocolsListsResult& WithProtocolsLists(ProtocolsListsT&& value) {
    SetProtocolsLists(std::forward<ProtocolsListsT>(value));
    return *this;
  }
  template <typename ProtocolsListsT = ProtocolsListDataSummary>
  ListProtocolsListsResult& AddProtocolsLists(ProtocolsListsT&& value) {
    m_protocolsListsHasBeenSet = true;
    m_protocolsLists.emplace_back(std::forward<ProtocolsListsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListProtocolsListsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListProtocolsListsResult& WithRequestId(RequestIdT&& value) {
