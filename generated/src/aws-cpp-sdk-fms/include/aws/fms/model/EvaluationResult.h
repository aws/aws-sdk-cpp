...
class EvaluationResult {
 public:
  ...
  inline void SetComplianceStatus(PolicyComplianceStatusType value) {
    m_complianceStatusHasBeenSet = true;
    m_complianceStatus = value;
  }
  inline EvaluationResult& WithComplianceStatus(PolicyComplianceStatusType value) {
  ...
  inline void SetViolatorCount(long long value) {
    m_violatorCountHasBeenSet = true;
    m_violatorCount = value;
  }
  inline EvaluationResult& WithViolatorCount(long long value) {
    SetViolatorCount(value);
    return *this;
  }
  ///@}
  ...
  inline EvaluationResult& WithEvaluationLimitExceeded(bool value) {
