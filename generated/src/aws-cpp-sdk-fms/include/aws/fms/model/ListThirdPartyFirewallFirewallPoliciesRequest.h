...
class ListThirdPartyFirewallFirewallPoliciesRequest : public FMSRequest {
 public:
  ...
  inline void SetThirdPartyFirewall(ThirdPartyFirewall value) {
    m_thirdPartyFirewallHasBeenSet = true;
    m_thirdPartyFirewall = value;
  }
  inline ListThirdPartyFirewallFirewallPoliciesRequest& WithThirdPartyFirewall(ThirdPartyFirewall value) {
    SetThirdPartyFirewall(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListThirdPartyFirewallFirewallPoliciesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListThirdPartyFirewallFirewallPoliciesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
