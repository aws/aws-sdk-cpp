...
class WebACLHasIncompatibleConfigurationViolation {
 public:
  ...
  template <typename WebACLArnT = Aws::String>
  WebACLHasIncompatibleConfigurationViolation& WithWebACLArn(WebACLArnT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  WebACLHasIncompatibleConfigurationViolation& WithDescription(DescriptionT&& value) {
