...
class DnsDuplicateRuleGroupViolation {
 public:
  ...
  template <typename ViolationTargetT = Aws::String>
  DnsDuplicateRuleGroupViolation& WithViolationTarget(ViolationTargetT&& value) {
  ...
  template <typename ViolationTargetDescriptionT = Aws::String>
  DnsDuplicateRuleGroupViolation& WithViolationTargetDescription(ViolationTargetDescriptionT&& value) {
