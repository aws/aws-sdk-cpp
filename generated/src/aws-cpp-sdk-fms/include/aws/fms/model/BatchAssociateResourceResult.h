...
class BatchAssociateResourceResult {
 public:
  ...
  template <typename ResourceSetIdentifierT = Aws::String>
  BatchAssociateResourceResult& WithResourceSetIdentifier(ResourceSetIdentifierT&& value) {
  ...
  template <typename FailedItemsT = Aws::Vector<FailedItem>>
  BatchAssociateResourceResult& WithFailedItems(FailedItemsT&& value) {
    SetFailedItems(std::forward<FailedItemsT>(value));
    return *this;
  }
  template <typename FailedItemsT = FailedItem>
  BatchAssociateResourceResult& AddFailedItems(FailedItemsT&& value) {
    m_failedItemsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  BatchAssociateResourceResult& WithRequestId(RequestIdT&& value) {
