...
class NetworkAclEntry {
 public:
  ...
  inline void SetRuleAction(NetworkAclRuleAction value) {
    m_ruleActionHasBeenSet = true;
    m_ruleAction = value;
  }
  inline NetworkAclEntry& WithRuleAction(NetworkAclRuleAction value) {
    SetRuleAction(value);
    return *this;
  }
  ///@}
  ...
  inline NetworkAclEntry& WithEgress(bool value) {
    SetEgress(value);
    return *this;
  }
  ///@}
