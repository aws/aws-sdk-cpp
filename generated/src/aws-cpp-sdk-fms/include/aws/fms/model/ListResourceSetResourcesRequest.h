...
class ListResourceSetResourcesRequest : public FMSRequest {
 public:
  ...
  template <typename IdentifierT = Aws::String>
  ListResourceSetResourcesRequest& WithIdentifier(IdentifierT&& value) {
  ...
  inline ListResourceSetResourcesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListResourceSetResourcesRequest& WithNextToken(NextTokenT&& value) {
