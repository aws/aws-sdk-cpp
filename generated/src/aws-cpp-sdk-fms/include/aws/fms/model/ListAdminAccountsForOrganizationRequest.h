...
namespace Model
{
  ...
  {
  public:
    AWS_FMS_API ListAdminAccountsForOrganizationRequest() = default;
    ...
    template<typename NextTokenT = Aws::String>
    ListAdminAccountsForOrganizationRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
