...
class ListAppsListsRequest : public FMSRequest {
 public:
  ...
  inline ListAppsListsRequest& WithDefaultLists(bool value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListAppsListsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListAppsListsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
