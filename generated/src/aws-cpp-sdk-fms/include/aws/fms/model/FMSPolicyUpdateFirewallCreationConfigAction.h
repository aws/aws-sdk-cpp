...
class FMSPolicyUpdateFirewallCreationConfigAction {
 public:
  ...
  template <typename DescriptionT = Aws::String>
  FMSPolicyUpdateFirewallCreationConfigAction& WithDescription(DescriptionT&& value) {
  ...
  void SetFirewallCreationConfig(FirewallCreationConfigT&& value) {
    m_firewallCreationConfigHasBeenSet = true;
    m_firewallCreationConfig = std::forward<FirewallCreationConfigT>(value);
  }
  template <typename FirewallCreationConfigT = Aws::String>
  FMSPolicyUpdateFirewallCreationConfigAction& WithFirewallCreationConfig(FirewallCreationConfigT&& value) {
    SetFirewallCreationConfig(std::forward<FirewallCreationConfigT>(value));
    return *this;
  }
  ///@}
 private:
