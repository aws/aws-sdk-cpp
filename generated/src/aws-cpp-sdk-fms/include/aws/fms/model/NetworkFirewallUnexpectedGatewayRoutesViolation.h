...
class NetworkFirewallUnexpectedGatewayRoutesViolation {
 public:
  ...
  template <typename GatewayIdT = Aws::String>
  NetworkFirewallUnexpectedGatewayRoutesViolation& WithGatewayId(GatewayIdT&& value) {
  ...
  template <typename ViolatingRoutesT = Aws::Vector<Route>>
  NetworkFirewallUnexpectedGatewayRoutesViolation& WithViolatingRoutes(ViolatingRoutesT&& value) {
    SetViolatingRoutes(std::forward<ViolatingRoutesT>(value));
    return *this;
  }
  template <typename ViolatingRoutesT = Route>
  NetworkFirewallUnexpectedGatewayRoutesViolation& AddViolatingRoutes(ViolatingRoutesT&& value) {
    m_violatingRoutesHasBeenSet = true;
  ...
  template <typename RouteTableIdT = Aws::String>
  NetworkFirewallUnexpectedGatewayRoutesViolation& WithRouteTableId(RouteTableIdT&& value) {
  ...
  template <typename VpcIdT = Aws::String>
  NetworkFirewallUnexpectedGatewayRoutesViolation& WithVpcId(VpcIdT&& value) {
