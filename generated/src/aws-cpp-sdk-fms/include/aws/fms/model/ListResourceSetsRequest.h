...
class ListResourceSetsRequest : public FMSRequest {
 public:
  AWS_FMS_API ListResourceSetsRequest() = default;
  ...
  template <typename NextTokenT = Aws::String>
  ListResourceSetsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListResourceSetsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
