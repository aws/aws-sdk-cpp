...
class NetworkFirewallPolicyModifiedViolation {
 public:
  ...
  template <typename ViolationTargetT = Aws::String>
  NetworkFirewallPolicyModifiedViolation& WithViolationTarget(ViolationTargetT&& value) {
  ...
  void SetCurrentPolicyDescription(CurrentPolicyDescriptionT&& value) {
    m_currentPolicyDescriptionHasBeenSet = true;
    m_currentPolicyDescription = std::forward<CurrentPolicyDescriptionT>(value);
  }
  template <typename CurrentPolicyDescriptionT = NetworkFirewallPolicyDescription>
  NetworkFirewallPolicyModifiedViolation& WithCurrentPolicyDescription(CurrentPolicyDescriptionT&& value) {
    SetCurrentPolicyDescription(std::forward<CurrentPolicyDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExpectedPolicyDescription(ExpectedPolicyDescriptionT&& value) {
    m_expectedPolicyDescriptionHasBeenSet = true;
    m_expectedPolicyDescription = std::forward<ExpectedPolicyDescriptionT>(value);
  }
  template <typename ExpectedPolicyDescriptionT = NetworkFirewallPolicyDescription>
  NetworkFirewallPolicyModifiedViolation& WithExpectedPolicyDescription(ExpectedPolicyDescriptionT&& value) {
    SetExpectedPolicyDescription(std::forward<ExpectedPolicyDescriptionT>(value));
    return *this;
  }
  ///@}
 private:
