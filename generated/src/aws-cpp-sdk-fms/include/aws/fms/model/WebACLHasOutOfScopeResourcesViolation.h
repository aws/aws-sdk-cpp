...
class WebACLHasOutOfScopeResourcesViolation {
 public:
  ...
  template <typename WebACLArnT = Aws::String>
  WebACLHasOutOfScopeResourcesViolation& WithWebACLArn(WebACLArnT&& value) {
  ...
  void SetOutOfScopeResourceList(OutOfScopeResourceListT&& value) {
    m_outOfScopeResourceListHasBeenSet = true;
    m_outOfScopeResourceList = std::forward<OutOfScopeResourceListT>(value);
  }
  template <typename OutOfScopeResourceListT = Aws::Vector<Aws::String>>
  WebACLHasOutOfScopeResourcesViolation& WithOutOfScopeResourceList(OutOfScopeResourceListT&& value) {
    SetOutOfScopeResourceList(std::forward<OutOfScopeResourceListT>(value));
    return *this;
  }
  template <typename OutOfScopeResourceListT = Aws::String>
  WebACLHasOutOfScopeResourcesViolation& AddOutOfScopeResourceList(OutOfScopeResourceListT&& value) {
    m_outOfScopeResourceListHasBeenSet = true;
    m_outOfScopeResourceList.emplace_back(std::forward<OutOfScopeResourceListT>(value));
    return *this;
  }
  ///@}
 private:
