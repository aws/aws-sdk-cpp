 ...
 */
using FMSEndpointProviderBase = EndpointProviderBase<FMSClientConfiguration, FMSBuiltInParameters, FMSClientContextParameters>;

using FMSDefaultEpProviderBase = DefaultEndpointProvider<FMSClientConfiguration, FMSBuiltInParameters, FMSClientContextParameters>;
...
class AWS_FMS_API FMSEndpointProvider : public FMSDefaultEpProviderBase {
 public:
  ...
  FMSEndpointProvider() : FMSDefaultEpProviderBase(Aws::FMS::FMSEndpointRules::GetRulesBlob(), Aws::FMS::FMSEndpointRules::RulesBlobSize) {}
