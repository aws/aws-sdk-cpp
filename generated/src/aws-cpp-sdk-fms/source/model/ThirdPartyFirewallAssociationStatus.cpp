  ...
  namespace FMS
  {
    namespace Model
    {
      namespace ThirdPartyFirewallAssociationStatusMapper
      {
        ...
        static constexpr uint32_t ONBOARD_COMPLETE_HASH = ConstExprHashingUtils::HashString("ONBOARD_COMPLETE");
        static constexpr uint32_t OFFBOARDING_HASH = ConstExprHashingUtils::HashString("OFFBOARDING");
        static constexpr uint32_t OFFBOARD_COMPLETE_HASH = ConstExprHashingUtils::HashString("OFFBOARD_COMPLETE");
