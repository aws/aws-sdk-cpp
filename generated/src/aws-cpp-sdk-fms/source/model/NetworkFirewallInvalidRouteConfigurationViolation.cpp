...
NetworkFirewallInvalidRouteConfigurationViolation& NetworkFirewallInvalidRouteConfigurationViolation::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("ExpectedFirewallSubnetRoutes")) {
    ...
    for (unsigned expectedFirewallSubnetRoutesIndex = 0;
         expectedFirewallSubnetRoutesIndex < expectedFirewallSubnetRoutesJsonList.GetLength(); ++expectedFirewallSubnetRoutesIndex) {
  ...
  if (jsonValue.ValueExists("ActualFirewallSubnetRoutes")) {
    ...
    for (unsigned actualFirewallSubnetRoutesIndex = 0; actualFirewallSubnetRoutesIndex < actualFirewallSubnetRoutesJsonList.GetLength();
         ++actualFirewallSubnetRoutesIndex) {
  ...
  if (jsonValue.ValueExists("ExpectedInternetGatewayRoutes")) {
    ...
    for (unsigned expectedInternetGatewayRoutesIndex = 0;
         expectedInternetGatewayRoutesIndex < expectedInternetGatewayRoutesJsonList.GetLength(); ++expectedInternetGatewayRoutesIndex) {
  ...
  if (jsonValue.ValueExists("ActualInternetGatewayRoutes")) {
    ...
    for (unsigned actualInternetGatewayRoutesIndex = 0; actualInternetGatewayRoutesIndex < actualInternetGatewayRoutesJsonList.GetLength();
         ++actualInternetGatewayRoutesIndex) {
...
JsonValue NetworkFirewallInvalidRouteConfigurationViolation::Jsonize() const {
  ...
  if (m_expectedFirewallSubnetRoutesHasBeenSet) {
    ...
    for (unsigned expectedFirewallSubnetRoutesIndex = 0;
         expectedFirewallSubnetRoutesIndex < expectedFirewallSubnetRoutesJsonList.GetLength(); ++expectedFirewallSubnetRoutesIndex) {
      expectedFirewallSubnetRoutesJsonList[expectedFirewallSubnetRoutesIndex].AsObject(
          m_expectedFirewallSubnetRoutes[expectedFirewallSubnetRoutesIndex].Jsonize());
    }
  ...
  if (m_actualFirewallSubnetRoutesHasBeenSet) {
    ...
    for (unsigned actualFirewallSubnetRoutesIndex = 0; actualFirewallSubnetRoutesIndex < actualFirewallSubnetRoutesJsonList.GetLength();
         ++actualFirewallSubnetRoutesIndex) {
      actualFirewallSubnetRoutesJsonList[actualFirewallSubnetRoutesIndex].AsObject(
          m_actualFirewallSubnetRoutes[actualFirewallSubnetRoutesIndex].Jsonize());
    }
  ...
  if (m_expectedInternetGatewayRoutesHasBeenSet) {
    ...
    for (unsigned expectedInternetGatewayRoutesIndex = 0;
         expectedInternetGatewayRoutesIndex < expectedInternetGatewayRoutesJsonList.GetLength(); ++expectedInternetGatewayRoutesIndex) {
      expectedInternetGatewayRoutesJsonList[expectedInternetGatewayRoutesIndex].AsObject(
          m_expectedInternetGatewayRoutes[expectedInternetGatewayRoutesIndex].Jsonize());
    }
  ...
  if (m_actualInternetGatewayRoutesHasBeenSet) {
    ...
    for (unsigned actualInternetGatewayRoutesIndex = 0; actualInternetGatewayRoutesIndex < actualInternetGatewayRoutesJsonList.GetLength();
         ++actualInternetGatewayRoutesIndex) {
      actualInternetGatewayRoutesJsonList[actualInternetGatewayRoutesIndex].AsObject(
          m_actualInternetGatewayRoutes[actualInternetGatewayRoutesIndex].Jsonize());
    }
