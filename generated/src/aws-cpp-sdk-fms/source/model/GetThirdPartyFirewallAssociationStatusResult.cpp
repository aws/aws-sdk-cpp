...
GetThirdPartyFirewallAssociationStatusResult& GetThirdPartyFirewallAssociationStatusResult::operator=(
  ...
  if (jsonValue.ValueExists("ThirdPartyFirewallStatus")) {
    m_thirdPartyFirewallStatus = ThirdPartyFirewallAssociationStatusMapper::GetThirdPartyFirewallAssociationStatusForName(
        jsonValue.GetString("ThirdPartyFirewallStatus"));
    m_thirdPartyFirewallStatusHasBeenSet = true;
  }
  if (jsonValue.ValueExists("MarketplaceOnboardingStatus")) {
    m_marketplaceOnboardingStatus = MarketplaceSubscriptionOnboardingStatusMapper::GetMarketplaceSubscriptionOnboardingStatusForName(
        jsonValue.GetString("MarketplaceOnboardingStatus"));
