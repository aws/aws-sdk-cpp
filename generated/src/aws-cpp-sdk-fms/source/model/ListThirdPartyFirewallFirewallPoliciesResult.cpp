...
ListThirdPartyFirewallFirewallPoliciesResult& ListThirdPartyFirewallFirewallPoliciesResult::operator=(
  ...
  if (jsonValue.ValueExists("ThirdPartyFirewallFirewallPolicies")) {
    ...
    for (unsigned thirdPartyFirewallFirewallPoliciesIndex = 0;
         thirdPartyFirewallFirewallPoliciesIndex < thirdPartyFirewallFirewallPoliciesJsonList.GetLength();
         ++thirdPartyFirewallFirewallPoliciesIndex) {
      m_thirdPartyFirewallFirewallPolicies.push_back(
          thirdPartyFirewallFirewallPoliciesJsonList[thirdPartyFirewallFirewallPoliciesIndex].AsObject());
    }
    m_thirdPartyFirewallFirewallPoliciesHasBeenSet = true;
  }
