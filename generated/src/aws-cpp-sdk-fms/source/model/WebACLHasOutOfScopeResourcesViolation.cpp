...
WebACLHasOutOfScopeResourcesViolation::WebACLHasOutOfScopeResourcesViolation(JsonView jsonValue) { *this = jsonValue; }
...
WebACLHasOutOfScopeResourcesViolation& WebACLHasOutOfScopeResourcesViolation::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("OutOfScopeResourceList")) {
    ...
    for (unsigned outOfScopeResourceListIndex = 0; outOfScopeResourceListIndex < outOfScopeResourceListJsonList.GetLength();
         ++outOfScopeResourceListIndex) {
