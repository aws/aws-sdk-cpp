...
ViolationDetail::ViolationDetail(JsonView jsonValue) { *this = jsonValue; }
...
ViolationDetail& ViolationDetail::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("ResourceViolations")) {
    ...
    for (unsigned resourceViolationsIndex = 0; resourceViolationsIndex < resourceViolationsJsonList.GetLength();
         ++resourceViolationsIndex) {
