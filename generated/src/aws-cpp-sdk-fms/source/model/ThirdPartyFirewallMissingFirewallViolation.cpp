...
ThirdPartyFirewallMissingFirewallViolation::ThirdPartyFirewallMissingFirewallViolation(JsonView jsonValue) { *this = jsonValue; }

ThirdPartyFirewallMissingFirewallViolation& ThirdPartyFirewallMissingFirewallViolation::operator=(JsonView jsonValue) {
...
JsonValue ThirdPartyFirewallMissingFirewallViolation::Jsonize() const {
  JsonValue payload;
