...
ThirdPartyFirewallMissingExpectedRouteTableViolation& ThirdPartyFirewallMissingExpectedRouteTableViolation::operator =(JsonView jsonValue)
{
...
JsonValue ThirdPartyFirewallMissingExpectedRouteTableViolation::Jsonize() const
{
  JsonValue payload;
