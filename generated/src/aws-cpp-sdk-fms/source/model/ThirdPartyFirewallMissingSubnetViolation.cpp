...
ThirdPartyFirewallMissingSubnetViolation::ThirdPartyFirewallMissingSubnetViolation(JsonView jsonValue) { *this = jsonValue; }

ThirdPartyFirewallMissingSubnetViolation& ThirdPartyFirewallMissingSubnetViolation::operator=(JsonView jsonValue) {
...
JsonValue ThirdPartyFirewallMissingSubnetViolation::Jsonize() const {
  JsonValue payload;
