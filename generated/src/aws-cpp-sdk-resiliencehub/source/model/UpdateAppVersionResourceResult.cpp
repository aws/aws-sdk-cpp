...
UpdateAppVersionResourceResult::UpdateAppVersionResourceResult()
{
}

UpdateAppVersionResourceResult::UpdateAppVersionResourceResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

UpdateAppVersionResourceResult& UpdateAppVersionResourceResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
