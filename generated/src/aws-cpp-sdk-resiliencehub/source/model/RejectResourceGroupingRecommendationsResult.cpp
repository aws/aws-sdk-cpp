...
RejectResourceGroupingRecommendationsResult::RejectResourceGroupingRecommendationsResult(
    const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

RejectResourceGroupingRecommendationsResult& RejectResourceGroupingRecommendationsResult::operator=(
    const Aws::AmazonWebServiceResult<JsonValue>& result) {
