...
ListUnsupportedAppVersionResourcesResult& ListUnsupportedAppVersionResourcesResult::operator=(
  ...
  if (jsonValue.ValueExists("unsupportedResources")) {
    ...
    for (unsigned unsupportedResourcesIndex = 0; unsupportedResourcesIndex < unsupportedResourcesJsonList.GetLength();
         ++unsupportedResourcesIndex) {
