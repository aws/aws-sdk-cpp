...
ResiliencyPolicy::ResiliencyPolicy(JsonView jsonValue) { *this = jsonValue; }
...
ResiliencyPolicy& ResiliencyPolicy::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("dataLocationConstraint")) {
    m_dataLocationConstraint =
        DataLocationConstraintMapper::GetDataLocationConstraintForName(jsonValue.GetString("dataLocationConstraint"));
