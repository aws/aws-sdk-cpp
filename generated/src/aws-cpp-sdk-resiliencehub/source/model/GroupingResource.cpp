...
GroupingResource::GroupingResource(JsonView jsonValue) { *this = jsonValue; }
...
GroupingResource& GroupingResource::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("sourceAppComponentIds")) {
    ...
    for (unsigned sourceAppComponentIdsIndex = 0; sourceAppComponentIdsIndex < sourceAppComponentIdsJsonList.GetLength();
         ++sourceAppComponentIdsIndex) {
