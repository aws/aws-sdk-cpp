...
ConfigRecommendation::ConfigRecommendation(JsonView jsonValue) { *this = jsonValue; }
...
ConfigRecommendation& ConfigRecommendation::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("optimizationType")) {
    m_optimizationType =
        ConfigRecommendationOptimizationTypeMapper::GetConfigRecommendationOptimizationTypeForName(jsonValue.GetString("optimizationType"));
  ...
  if (jsonValue.ValueExists("recommendationCompliance")) {
    ...
    for (auto& recommendationComplianceItem : recommendationComplianceJsonMap) {
      m_recommendationCompliance[DisruptionTypeMapper::GetDisruptionTypeForName(recommendationComplianceItem.first)] =
          recommendationComplianceItem.second.AsObject();
    }
...
JsonValue ConfigRecommendation::Jsonize() const {
  ...
  if (m_optimizationTypeHasBeenSet) {
    payload.WithString("optimizationType",
                       ConfigRecommendationOptimizationTypeMapper::GetNameForConfigRecommendationOptimizationType(m_optimizationType));
  }
  ...
  if (m_recommendationComplianceHasBeenSet) {
    ...
    for (auto& recommendationComplianceItem : m_recommendationCompliance) {
      recommendationComplianceJsonMap.WithObject(DisruptionTypeMapper::GetNameForDisruptionType(recommendationComplianceItem.first),
                                                 recommendationComplianceItem.second.Jsonize());
    }
