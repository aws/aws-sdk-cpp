...
ComplianceDrift::ComplianceDrift(JsonView jsonValue) { *this = jsonValue; }
...
JsonValue ComplianceDrift::Jsonize() const {
  ...
  if (m_actualValueHasBeenSet) {
    ...
    for (auto& actualValueItem : m_actualValue) {
      actualValueJsonMap.WithObject(DisruptionTypeMapper::GetNameForDisruptionType(actualValueItem.first),
                                    actualValueItem.second.Jsonize());
    }
  ...
  if (m_expectedValueHasBeenSet) {
    ...
    for (auto& expectedValueItem : m_expectedValue) {
      expectedValueJsonMap.WithObject(DisruptionTypeMapper::GetNameForDisruptionType(expectedValueItem.first),
                                      expectedValueItem.second.Jsonize());
    }
