...
Aws::String RemoveDraftAppVersionResourceMappingsRequest::SerializePayload() const {
  ...
  if (m_appRegistryAppNamesHasBeenSet) {
    ...
    for (unsigned appRegistryAppNamesIndex = 0; appRegistryAppNamesIndex < appRegistryAppNamesJsonList.GetLength();
         ++appRegistryAppNamesIndex) {
  ...
  if (m_resourceGroupNamesHasBeenSet) {
    ...
    for (unsigned resourceGroupNamesIndex = 0; resourceGroupNamesIndex < resourceGroupNamesJsonList.GetLength();
         ++resourceGroupNamesIndex) {
  ...
  if (m_terraformSourceNamesHasBeenSet) {
    ...
    for (unsigned terraformSourceNamesIndex = 0; terraformSourceNamesIndex < terraformSourceNamesJsonList.GetLength();
         ++terraformSourceNamesIndex) {
