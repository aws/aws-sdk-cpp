...
class AWS_RESILIENCEHUB_API ResilienceHubClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  ResilienceHubClient(const Aws::ResilienceHub::ResilienceHubClientConfiguration& clientConfiguration =
  ...
  ResilienceHubClient(const Aws::Auth::AWSCredentials& credentials,
                      std::shared_ptr<ResilienceHubEndpointProviderBase> endpointProvider = nullptr,
                      const Aws::ResilienceHub::ResilienceHubClientConfiguration& clientConfiguration =
                          Aws::ResilienceHub::ResilienceHubClientConfiguration());
   ...
   * API Reference</a></p>
   */
  virtual Model::AcceptResourceGroupingRecommendationsOutcome AcceptResourceGroupingRecommendations(
      const Model::AcceptResourceGroupingRecommendationsRequest& request) const;

  /**
   * A Callable wrapper for AcceptResourceGroupingRecommendations that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename AcceptResourceGroupingRecommendationsRequestT = Model::AcceptResourceGroupingRecommendationsRequest>
  Model::AcceptResourceGroupingRecommendationsOutcomeCallable AcceptResourceGroupingRecommendationsCallable(
      const AcceptResourceGroupingRecommendationsRequestT& request) const {
    return SubmitCallable(&ResilienceHubClient::AcceptResourceGroupingRecommendations, request);
  }

  /**
   * An Async wrapper for AcceptResourceGroupingRecommendations that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename AcceptResourceGroupingRecommendationsRequestT = Model::AcceptResourceGroupingRecommendationsRequest>
  void AcceptResourceGroupingRecommendationsAsync(const AcceptResourceGroupingRecommendationsRequestT& request,
                                                  const AcceptResourceGroupingRecommendationsResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::AddDraftAppVersionResourceMappingsOutcome AddDraftAppVersionResourceMappings(
      const Model::AddDraftAppVersionResourceMappingsRequest& request) const;

  /**
   * A Callable wrapper for AddDraftAppVersionResourceMappings that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename AddDraftAppVersionResourceMappingsRequestT = Model::AddDraftAppVersionResourceMappingsRequest>
  Model::AddDraftAppVersionResourceMappingsOutcomeCallable AddDraftAppVersionResourceMappingsCallable(
      const AddDraftAppVersionResourceMappingsRequestT& request) const {
    return SubmitCallable(&ResilienceHubClient::AddDraftAppVersionResourceMappings, request);
  }

  /**
   * An Async wrapper for AddDraftAppVersionResourceMappings that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename AddDraftAppVersionResourceMappingsRequestT = Model::AddDraftAppVersionResourceMappingsRequest>
  void AddDraftAppVersionResourceMappingsAsync(const AddDraftAppVersionResourceMappingsRequestT& request,
                                               const AddDraftAppVersionResourceMappingsResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchUpdateRecommendationStatusOutcome BatchUpdateRecommendationStatus(
      const Model::BatchUpdateRecommendationStatusRequest& request) const;

  /**
   * A Callable wrapper for BatchUpdateRecommendationStatus that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename BatchUpdateRecommendationStatusRequestT = Model::BatchUpdateRecommendationStatusRequest>
  Model::BatchUpdateRecommendationStatusOutcomeCallable BatchUpdateRecommendationStatusCallable(
      const BatchUpdateRecommendationStatusRequestT& request) const {
    return SubmitCallable(&ResilienceHubClient::BatchUpdateRecommendationStatus, request);
  }

  /**
   * An Async wrapper for BatchUpdateRecommendationStatus that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename BatchUpdateRecommendationStatusRequestT = Model::BatchUpdateRecommendationStatusRequest>
  void BatchUpdateRecommendationStatusAsync(const BatchUpdateRecommendationStatusRequestT& request,
                                            const BatchUpdateRecommendationStatusResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateAppVersionAppComponentOutcome CreateAppVersionAppComponent(
      const Model::CreateAppVersionAppComponentRequest& request) const;

  /**
   * A Callable wrapper for CreateAppVersionAppComponent that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateAppVersionAppComponentRequestT = Model::CreateAppVersionAppComponentRequest>
  Model::CreateAppVersionAppComponentOutcomeCallable CreateAppVersionAppComponentCallable(
      const CreateAppVersionAppComponentRequestT& request) const {
    return SubmitCallable(&ResilienceHubClient::CreateAppVersionAppComponent, request);
  }

  /**
   * An Async wrapper for CreateAppVersionAppComponent that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateAppVersionAppComponentRequestT = Model::CreateAppVersionAppComponentRequest>
  void CreateAppVersionAppComponentAsync(const CreateAppVersionAppComponentRequestT& request,
                                         const CreateAppVersionAppComponentResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateAppVersionResource that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateAppVersionResource that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateAppVersionResourceRequestT = Model::CreateAppVersionResourceRequest>
  void CreateAppVersionResourceAsync(const CreateAppVersionResourceRequestT& request,
                                     const CreateAppVersionResourceResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateRecommendationTemplateOutcome CreateRecommendationTemplate(
      const Model::CreateRecommendationTemplateRequest& request) const;

  /**
   * A Callable wrapper for CreateRecommendationTemplate that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateRecommendationTemplateRequestT = Model::CreateRecommendationTemplateRequest>
  Model::CreateRecommendationTemplateOutcomeCallable CreateRecommendationTemplateCallable(
      const CreateRecommendationTemplateRequestT& request) const {
    return SubmitCallable(&ResilienceHubClient::CreateRecommendationTemplate, request);
  }

  /**
   * An Async wrapper for CreateRecommendationTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateRecommendationTemplateRequestT = Model::CreateRecommendationTemplateRequest>
  void CreateRecommendationTemplateAsync(const CreateRecommendationTemplateRequestT& request,
                                         const CreateRecommendationTemplateResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateResiliencyPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateResiliencyPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateResiliencyPolicyRequestT = Model::CreateResiliencyPolicyRequest>
  void CreateResiliencyPolicyAsync(const CreateResiliencyPolicyRequestT& request,
                                   const CreateResiliencyPolicyResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteAppAssessment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteAppAssessment that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteAppAssessmentRequestT = Model::DeleteAppAssessmentRequest>
  void DeleteAppAssessmentAsync(const DeleteAppAssessmentRequestT& request, const DeleteAppAssessmentResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteAppInputSource that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteAppInputSource that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteAppInputSourceRequestT = Model::DeleteAppInputSourceRequest>
  void DeleteAppInputSourceAsync(const DeleteAppInputSourceRequestT& request, const DeleteAppInputSourceResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteAppVersionAppComponentOutcome DeleteAppVersionAppComponent(
      const Model::DeleteAppVersionAppComponentRequest& request) const;

  /**
   * A Callable wrapper for DeleteAppVersionAppComponent that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteAppVersionAppComponentRequestT = Model::DeleteAppVersionAppComponentRequest>
  Model::DeleteAppVersionAppComponentOutcomeCallable DeleteAppVersionAppComponentCallable(
      const DeleteAppVersionAppComponentRequestT& request) const {
    return SubmitCallable(&ResilienceHubClient::DeleteAppVersionAppComponent, request);
  }

  /**
   * An Async wrapper for DeleteAppVersionAppComponent that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteAppVersionAppComponentRequestT = Model::DeleteAppVersionAppComponentRequest>
  void DeleteAppVersionAppComponentAsync(const DeleteAppVersionAppComponentRequestT& request,
                                         const DeleteAppVersionAppComponentResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteAppVersionResource that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteAppVersionResource that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteAppVersionResourceRequestT = Model::DeleteAppVersionResourceRequest>
  void DeleteAppVersionResourceAsync(const DeleteAppVersionResourceRequestT& request,
                                     const DeleteAppVersionResourceResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteRecommendationTemplateOutcome DeleteRecommendationTemplate(
      const Model::DeleteRecommendationTemplateRequest& request) const;

  /**
   * A Callable wrapper for DeleteRecommendationTemplate that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteRecommendationTemplateRequestT = Model::DeleteRecommendationTemplateRequest>
  Model::DeleteRecommendationTemplateOutcomeCallable DeleteRecommendationTemplateCallable(
      const DeleteRecommendationTemplateRequestT& request) const {
    return SubmitCallable(&ResilienceHubClient::DeleteRecommendationTemplate, request);
  }

  /**
   * An Async wrapper for DeleteRecommendationTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteRecommendationTemplateRequestT = Model::DeleteRecommendationTemplateRequest>
  void DeleteRecommendationTemplateAsync(const DeleteRecommendationTemplateRequestT& request,
                                         const DeleteRecommendationTemplateResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteResiliencyPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteResiliencyPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteResiliencyPolicyRequestT = Model::DeleteResiliencyPolicyRequest>
  void DeleteResiliencyPolicyAsync(const DeleteResiliencyPolicyRequestT& request,
                                   const DeleteResiliencyPolicyResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeAppAssessment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeAppAssessment that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeAppAssessmentRequestT = Model::DescribeAppAssessmentRequest>
  void DescribeAppAssessmentAsync(const DescribeAppAssessmentRequestT& request, const DescribeAppAssessmentResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeAppVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeAppVersion that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeAppVersionRequestT = Model::DescribeAppVersionRequest>
  void DescribeAppVersionAsync(const DescribeAppVersionRequestT& request, const DescribeAppVersionResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeAppVersionAppComponentOutcome DescribeAppVersionAppComponent(
      const Model::DescribeAppVersionAppComponentRequest& request) const;

  /**
   * A Callable wrapper for DescribeAppVersionAppComponent that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeAppVersionAppComponentRequestT = Model::DescribeAppVersionAppComponentRequest>
  Model::DescribeAppVersionAppComponentOutcomeCallable DescribeAppVersionAppComponentCallable(
      const DescribeAppVersionAppComponentRequestT& request) const {
    return SubmitCallable(&ResilienceHubClient::DescribeAppVersionAppComponent, request);
  }

  /**
   * An Async wrapper for DescribeAppVersionAppComponent that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeAppVersionAppComponentRequestT = Model::DescribeAppVersionAppComponentRequest>
  void DescribeAppVersionAppComponentAsync(const DescribeAppVersionAppComponentRequestT& request,
                                           const DescribeAppVersionAppComponentResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeAppVersionResourceOutcome DescribeAppVersionResource(
      const Model::DescribeAppVersionResourceRequest& request) const;

  /**
   * A Callable wrapper for DescribeAppVersionResource that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeAppVersionResourceRequestT = Model::DescribeAppVersionResourceRequest>
  Model::DescribeAppVersionResourceOutcomeCallable DescribeAppVersionResourceCallable(
      const DescribeAppVersionResourceRequestT& request) const {
    return SubmitCallable(&ResilienceHubClient::DescribeAppVersionResource, request);
  }

  /**
   * An Async wrapper for DescribeAppVersionResource that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeAppVersionResourceRequestT = Model::DescribeAppVersionResourceRequest>
  void DescribeAppVersionResourceAsync(const DescribeAppVersionResourceRequestT& request,
                                       const DescribeAppVersionResourceResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeAppVersionResourcesResolutionStatusOutcome DescribeAppVersionResourcesResolutionStatus(
      const Model::DescribeAppVersionResourcesResolutionStatusRequest& request) const;

  /**
   * A Callable wrapper for DescribeAppVersionResourcesResolutionStatus that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  ...
  Model::DescribeAppVersionResourcesResolutionStatusOutcomeCallable DescribeAppVersionResourcesResolutionStatusCallable(
      const DescribeAppVersionResourcesResolutionStatusRequestT& request) const {
    return SubmitCallable(&ResilienceHubClient::DescribeAppVersionResourcesResolutionStatus, request);
  }

  /**
   * An Async wrapper for DescribeAppVersionResourcesResolutionStatus that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeAppVersionResourcesResolutionStatusRequestT = Model::DescribeAppVersionResourcesResolutionStatusRequest>
  void DescribeAppVersionResourcesResolutionStatusAsync(
      const DescribeAppVersionResourcesResolutionStatusRequestT& request,
      const DescribeAppVersionResourcesResolutionStatusResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeAppVersionTemplateOutcome DescribeAppVersionTemplate(
      const Model::DescribeAppVersionTemplateRequest& request) const;

  /**
   * A Callable wrapper for DescribeAppVersionTemplate that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeAppVersionTemplateRequestT = Model::DescribeAppVersionTemplateRequest>
  Model::DescribeAppVersionTemplateOutcomeCallable DescribeAppVersionTemplateCallable(
      const DescribeAppVersionTemplateRequestT& request) const {
    return SubmitCallable(&ResilienceHubClient::DescribeAppVersionTemplate, request);
  }

  /**
   * An Async wrapper for DescribeAppVersionTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeAppVersionTemplateRequestT = Model::DescribeAppVersionTemplateRequest>
  void DescribeAppVersionTemplateAsync(const DescribeAppVersionTemplateRequestT& request,
                                       const DescribeAppVersionTemplateResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeDraftAppVersionResourcesImportStatusOutcome DescribeDraftAppVersionResourcesImportStatus(
      const Model::DescribeDraftAppVersionResourcesImportStatusRequest& request) const;

  /**
   * A Callable wrapper for DescribeDraftAppVersionResourcesImportStatus that returns a future to the operation so that it can be executed
  ...
  Model::DescribeDraftAppVersionResourcesImportStatusOutcomeCallable DescribeDraftAppVersionResourcesImportStatusCallable(
      const DescribeDraftAppVersionResourcesImportStatusRequestT& request) const {
    return SubmitCallable(&ResilienceHubClient::DescribeDraftAppVersionResourcesImportStatus, request);
  }

  /**
   * An Async wrapper for DescribeDraftAppVersionResourcesImportStatus that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename DescribeDraftAppVersionResourcesImportStatusRequestT = Model::DescribeDraftAppVersionResourcesImportStatusRequest>
  void DescribeDraftAppVersionResourcesImportStatusAsync(
      const DescribeDraftAppVersionResourcesImportStatusRequestT& request,
      const DescribeDraftAppVersionResourcesImportStatusResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeMetricsExport that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeMetricsExport that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeMetricsExportRequestT = Model::DescribeMetricsExportRequest>
  void DescribeMetricsExportAsync(const DescribeMetricsExportRequestT& request, const DescribeMetricsExportResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeResiliencyPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeResiliencyPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeResiliencyPolicyRequestT = Model::DescribeResiliencyPolicyRequest>
  void DescribeResiliencyPolicyAsync(const DescribeResiliencyPolicyRequestT& request,
                                     const DescribeResiliencyPolicyResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeResourceGroupingRecommendationTaskOutcome DescribeResourceGroupingRecommendationTask(
      const Model::DescribeResourceGroupingRecommendationTaskRequest& request) const;

  /**
   * A Callable wrapper for DescribeResourceGroupingRecommendationTask that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  ...
  Model::DescribeResourceGroupingRecommendationTaskOutcomeCallable DescribeResourceGroupingRecommendationTaskCallable(
      const DescribeResourceGroupingRecommendationTaskRequestT& request) const {
    return SubmitCallable(&ResilienceHubClient::DescribeResourceGroupingRecommendationTask, request);
  }

  /**
   * An Async wrapper for DescribeResourceGroupingRecommendationTask that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeResourceGroupingRecommendationTaskRequestT = Model::DescribeResourceGroupingRecommendationTaskRequest>
  void DescribeResourceGroupingRecommendationTaskAsync(
      const DescribeResourceGroupingRecommendationTaskRequestT& request,
      const DescribeResourceGroupingRecommendationTaskResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ImportResourcesToDraftAppVersionOutcome ImportResourcesToDraftAppVersion(
      const Model::ImportResourcesToDraftAppVersionRequest& request) const;

  /**
   * A Callable wrapper for ImportResourcesToDraftAppVersion that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ImportResourcesToDraftAppVersionRequestT = Model::ImportResourcesToDraftAppVersionRequest>
  Model::ImportResourcesToDraftAppVersionOutcomeCallable ImportResourcesToDraftAppVersionCallable(
      const ImportResourcesToDraftAppVersionRequestT& request) const {
    return SubmitCallable(&ResilienceHubClient::ImportResourcesToDraftAppVersion, request);
  }

  /**
   * An Async wrapper for ImportResourcesToDraftAppVersion that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ImportResourcesToDraftAppVersionRequestT = Model::ImportResourcesToDraftAppVersionRequest>
  void ImportResourcesToDraftAppVersionAsync(const ImportResourcesToDraftAppVersionRequestT& request,
                                             const ImportResourcesToDraftAppVersionResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAlarmRecommendations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAlarmRecommendations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAlarmRecommendationsRequestT = Model::ListAlarmRecommendationsRequest>
  void ListAlarmRecommendationsAsync(const ListAlarmRecommendationsRequestT& request,
                                     const ListAlarmRecommendationsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListAppAssessmentComplianceDriftsOutcome ListAppAssessmentComplianceDrifts(
      const Model::ListAppAssessmentComplianceDriftsRequest& request) const;

  /**
   * A Callable wrapper for ListAppAssessmentComplianceDrifts that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListAppAssessmentComplianceDriftsRequestT = Model::ListAppAssessmentComplianceDriftsRequest>
  Model::ListAppAssessmentComplianceDriftsOutcomeCallable ListAppAssessmentComplianceDriftsCallable(
      const ListAppAssessmentComplianceDriftsRequestT& request) const {
    return SubmitCallable(&ResilienceHubClient::ListAppAssessmentComplianceDrifts, request);
  }

  /**
   * An Async wrapper for ListAppAssessmentComplianceDrifts that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListAppAssessmentComplianceDriftsRequestT = Model::ListAppAssessmentComplianceDriftsRequest>
  void ListAppAssessmentComplianceDriftsAsync(const ListAppAssessmentComplianceDriftsRequestT& request,
                                              const ListAppAssessmentComplianceDriftsResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListAppAssessmentResourceDriftsOutcome ListAppAssessmentResourceDrifts(
      const Model::ListAppAssessmentResourceDriftsRequest& request) const;

  /**
   * A Callable wrapper for ListAppAssessmentResourceDrifts that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListAppAssessmentResourceDriftsRequestT = Model::ListAppAssessmentResourceDriftsRequest>
  Model::ListAppAssessmentResourceDriftsOutcomeCallable ListAppAssessmentResourceDriftsCallable(
      const ListAppAssessmentResourceDriftsRequestT& request) const {
    return SubmitCallable(&ResilienceHubClient::ListAppAssessmentResourceDrifts, request);
  }

  /**
   * An Async wrapper for ListAppAssessmentResourceDrifts that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListAppAssessmentResourceDriftsRequestT = Model::ListAppAssessmentResourceDriftsRequest>
  void ListAppAssessmentResourceDriftsAsync(const ListAppAssessmentResourceDriftsRequestT& request,
                                            const ListAppAssessmentResourceDriftsResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAppAssessments that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAppAssessments that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListAppAssessmentsRequestT = Model::ListAppAssessmentsRequest>
  void ListAppAssessmentsAsync(const ListAppAssessmentsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const ListAppAssessmentsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListAppComponentCompliancesOutcome ListAppComponentCompliances(
      const Model::ListAppComponentCompliancesRequest& request) const;

  /**
   * A Callable wrapper for ListAppComponentCompliances that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListAppComponentCompliancesRequestT = Model::ListAppComponentCompliancesRequest>
  Model::ListAppComponentCompliancesOutcomeCallable ListAppComponentCompliancesCallable(
      const ListAppComponentCompliancesRequestT& request) const {
    return SubmitCallable(&ResilienceHubClient::ListAppComponentCompliances, request);
  }

  /**
   * An Async wrapper for ListAppComponentCompliances that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAppComponentCompliancesRequestT = Model::ListAppComponentCompliancesRequest>
  void ListAppComponentCompliancesAsync(const ListAppComponentCompliancesRequestT& request,
                                        const ListAppComponentCompliancesResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListAppComponentRecommendationsOutcome ListAppComponentRecommendations(
      const Model::ListAppComponentRecommendationsRequest& request) const;

  /**
   * A Callable wrapper for ListAppComponentRecommendations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListAppComponentRecommendationsRequestT = Model::ListAppComponentRecommendationsRequest>
  Model::ListAppComponentRecommendationsOutcomeCallable ListAppComponentRecommendationsCallable(
      const ListAppComponentRecommendationsRequestT& request) const {
    return SubmitCallable(&ResilienceHubClient::ListAppComponentRecommendations, request);
  }

  /**
   * An Async wrapper for ListAppComponentRecommendations that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListAppComponentRecommendationsRequestT = Model::ListAppComponentRecommendationsRequest>
  void ListAppComponentRecommendationsAsync(const ListAppComponentRecommendationsRequestT& request,
                                            const ListAppComponentRecommendationsResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAppInputSources that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAppInputSources that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListAppInputSourcesRequestT = Model::ListAppInputSourcesRequest>
  void ListAppInputSourcesAsync(const ListAppInputSourcesRequestT& request, const ListAppInputSourcesResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListAppVersionAppComponentsOutcome ListAppVersionAppComponents(
      const Model::ListAppVersionAppComponentsRequest& request) const;

  /**
   * A Callable wrapper for ListAppVersionAppComponents that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListAppVersionAppComponentsRequestT = Model::ListAppVersionAppComponentsRequest>
  Model::ListAppVersionAppComponentsOutcomeCallable ListAppVersionAppComponentsCallable(
      const ListAppVersionAppComponentsRequestT& request) const {
    return SubmitCallable(&ResilienceHubClient::ListAppVersionAppComponents, request);
  }

  /**
   * An Async wrapper for ListAppVersionAppComponents that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAppVersionAppComponentsRequestT = Model::ListAppVersionAppComponentsRequest>
  void ListAppVersionAppComponentsAsync(const ListAppVersionAppComponentsRequestT& request,
                                        const ListAppVersionAppComponentsResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListAppVersionResourceMappingsOutcome ListAppVersionResourceMappings(
      const Model::ListAppVersionResourceMappingsRequest& request) const;

  /**
   * A Callable wrapper for ListAppVersionResourceMappings that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListAppVersionResourceMappingsRequestT = Model::ListAppVersionResourceMappingsRequest>
  Model::ListAppVersionResourceMappingsOutcomeCallable ListAppVersionResourceMappingsCallable(
      const ListAppVersionResourceMappingsRequestT& request) const {
    return SubmitCallable(&ResilienceHubClient::ListAppVersionResourceMappings, request);
  }

  /**
   * An Async wrapper for ListAppVersionResourceMappings that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListAppVersionResourceMappingsRequestT = Model::ListAppVersionResourceMappingsRequest>
  void ListAppVersionResourceMappingsAsync(const ListAppVersionResourceMappingsRequestT& request,
                                           const ListAppVersionResourceMappingsResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAppVersionResources that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAppVersionResources that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAppVersionResourcesRequestT = Model::ListAppVersionResourcesRequest>
  void ListAppVersionResourcesAsync(const ListAppVersionResourcesRequestT& request,
                                    const ListAppVersionResourcesResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListAppVersions that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListAppVersionsRequestT = Model::ListAppVersionsRequest>
  void ListAppVersionsAsync(const ListAppVersionsRequestT& request, const ListAppVersionsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename ListAppsRequestT = Model::ListAppsRequest>
  void ListAppsAsync(const ListAppsResponseReceivedHandler& handler,
                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                     const ListAppsRequestT& request = {}) const {
   ...
   */
  template <typename ListMetricsRequestT = Model::ListMetricsRequest>
  void ListMetricsAsync(const ListMetricsResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                        const ListMetricsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListRecommendationTemplatesOutcome ListRecommendationTemplates(
      const Model::ListRecommendationTemplatesRequest& request = {}) const;

  /**
   * A Callable wrapper for ListRecommendationTemplates that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListRecommendationTemplatesRequestT = Model::ListRecommendationTemplatesRequest>
  Model::ListRecommendationTemplatesOutcomeCallable ListRecommendationTemplatesCallable(
      const ListRecommendationTemplatesRequestT& request = {}) const {
    return SubmitCallable(&ResilienceHubClient::ListRecommendationTemplates, request);
  }

  /**
   * An Async wrapper for ListRecommendationTemplates that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListRecommendationTemplatesRequestT = Model::ListRecommendationTemplatesRequest>
  void ListRecommendationTemplatesAsync(const ListRecommendationTemplatesResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                        const ListRecommendationTemplatesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListResiliencyPolicies that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListResiliencyPolicies that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListResiliencyPoliciesRequestT = Model::ListResiliencyPoliciesRequest>
  void ListResiliencyPoliciesAsync(const ListResiliencyPoliciesResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const ListResiliencyPoliciesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListResourceGroupingRecommendationsOutcome ListResourceGroupingRecommendations(
      const Model::ListResourceGroupingRecommendationsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListResourceGroupingRecommendations that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListResourceGroupingRecommendationsRequestT = Model::ListResourceGroupingRecommendationsRequest>
  Model::ListResourceGroupingRecommendationsOutcomeCallable ListResourceGroupingRecommendationsCallable(
      const ListResourceGroupingRecommendationsRequestT& request = {}) const {
    return SubmitCallable(&ResilienceHubClient::ListResourceGroupingRecommendations, request);
  }

  /**
   * An Async wrapper for ListResourceGroupingRecommendations that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListResourceGroupingRecommendationsRequestT = Model::ListResourceGroupingRecommendationsRequest>
  void ListResourceGroupingRecommendationsAsync(const ListResourceGroupingRecommendationsResponseReceivedHandler& handler,
                                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                const ListResourceGroupingRecommendationsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListSopRecommendations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListSopRecommendations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListSopRecommendationsRequestT = Model::ListSopRecommendationsRequest>
  void ListSopRecommendationsAsync(const ListSopRecommendationsRequestT& request,
                                   const ListSopRecommendationsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListSuggestedResiliencyPoliciesOutcome ListSuggestedResiliencyPolicies(
      const Model::ListSuggestedResiliencyPoliciesRequest& request = {}) const;

  /**
   * A Callable wrapper for ListSuggestedResiliencyPolicies that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListSuggestedResiliencyPoliciesRequestT = Model::ListSuggestedResiliencyPoliciesRequest>
  Model::ListSuggestedResiliencyPoliciesOutcomeCallable ListSuggestedResiliencyPoliciesCallable(
      const ListSuggestedResiliencyPoliciesRequestT& request = {}) const {
    return SubmitCallable(&ResilienceHubClient::ListSuggestedResiliencyPolicies, request);
  }

  /**
   * An Async wrapper for ListSuggestedResiliencyPolicies that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListSuggestedResiliencyPoliciesRequestT = Model::ListSuggestedResiliencyPoliciesRequest>
  void ListSuggestedResiliencyPoliciesAsync(const ListSuggestedResiliencyPoliciesResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                            const ListSuggestedResiliencyPoliciesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListTestRecommendations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListTestRecommendations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListTestRecommendationsRequestT = Model::ListTestRecommendationsRequest>
  void ListTestRecommendationsAsync(const ListTestRecommendationsRequestT& request,
                                    const ListTestRecommendationsResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListUnsupportedAppVersionResourcesOutcome ListUnsupportedAppVersionResources(
      const Model::ListUnsupportedAppVersionResourcesRequest& request) const;

  /**
   * A Callable wrapper for ListUnsupportedAppVersionResources that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListUnsupportedAppVersionResourcesRequestT = Model::ListUnsupportedAppVersionResourcesRequest>
  Model::ListUnsupportedAppVersionResourcesOutcomeCallable ListUnsupportedAppVersionResourcesCallable(
      const ListUnsupportedAppVersionResourcesRequestT& request) const {
    return SubmitCallable(&ResilienceHubClient::ListUnsupportedAppVersionResources, request);
  }

  /**
   * An Async wrapper for ListUnsupportedAppVersionResources that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListUnsupportedAppVersionResourcesRequestT = Model::ListUnsupportedAppVersionResourcesRequest>
  void ListUnsupportedAppVersionResourcesAsync(const ListUnsupportedAppVersionResourcesRequestT& request,
                                               const ListUnsupportedAppVersionResourcesResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PublishAppVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PublishAppVersion that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PublishAppVersionRequestT = Model::PublishAppVersionRequest>
  void PublishAppVersionAsync(const PublishAppVersionRequestT& request, const PublishAppVersionResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::PutDraftAppVersionTemplateOutcome PutDraftAppVersionTemplate(
      const Model::PutDraftAppVersionTemplateRequest& request) const;

  /**
   * A Callable wrapper for PutDraftAppVersionTemplate that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PutDraftAppVersionTemplateRequestT = Model::PutDraftAppVersionTemplateRequest>
  Model::PutDraftAppVersionTemplateOutcomeCallable PutDraftAppVersionTemplateCallable(
      const PutDraftAppVersionTemplateRequestT& request) const {
    return SubmitCallable(&ResilienceHubClient::PutDraftAppVersionTemplate, request);
  }

  /**
   * An Async wrapper for PutDraftAppVersionTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutDraftAppVersionTemplateRequestT = Model::PutDraftAppVersionTemplateRequest>
  void PutDraftAppVersionTemplateAsync(const PutDraftAppVersionTemplateRequestT& request,
                                       const PutDraftAppVersionTemplateResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::RejectResourceGroupingRecommendationsOutcome RejectResourceGroupingRecommendations(
      const Model::RejectResourceGroupingRecommendationsRequest& request) const;

  /**
   * A Callable wrapper for RejectResourceGroupingRecommendations that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename RejectResourceGroupingRecommendationsRequestT = Model::RejectResourceGroupingRecommendationsRequest>
  Model::RejectResourceGroupingRecommendationsOutcomeCallable RejectResourceGroupingRecommendationsCallable(
      const RejectResourceGroupingRecommendationsRequestT& request) const {
    return SubmitCallable(&ResilienceHubClient::RejectResourceGroupingRecommendations, request);
  }

  /**
   * An Async wrapper for RejectResourceGroupingRecommendations that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename RejectResourceGroupingRecommendationsRequestT = Model::RejectResourceGroupingRecommendationsRequest>
  void RejectResourceGroupingRecommendationsAsync(const RejectResourceGroupingRecommendationsRequestT& request,
                                                  const RejectResourceGroupingRecommendationsResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::RemoveDraftAppVersionResourceMappingsOutcome RemoveDraftAppVersionResourceMappings(
      const Model::RemoveDraftAppVersionResourceMappingsRequest& request) const;

  /**
   * A Callable wrapper for RemoveDraftAppVersionResourceMappings that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename RemoveDraftAppVersionResourceMappingsRequestT = Model::RemoveDraftAppVersionResourceMappingsRequest>
  Model::RemoveDraftAppVersionResourceMappingsOutcomeCallable RemoveDraftAppVersionResourceMappingsCallable(
      const RemoveDraftAppVersionResourceMappingsRequestT& request) const {
    return SubmitCallable(&ResilienceHubClient::RemoveDraftAppVersionResourceMappings, request);
  }

  /**
   * An Async wrapper for RemoveDraftAppVersionResourceMappings that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename RemoveDraftAppVersionResourceMappingsRequestT = Model::RemoveDraftAppVersionResourceMappingsRequest>
  void RemoveDraftAppVersionResourceMappingsAsync(const RemoveDraftAppVersionResourceMappingsRequestT& request,
                                                  const RemoveDraftAppVersionResourceMappingsResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ResolveAppVersionResourcesOutcome ResolveAppVersionResources(
      const Model::ResolveAppVersionResourcesRequest& request) const;

  /**
   * A Callable wrapper for ResolveAppVersionResources that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ResolveAppVersionResourcesRequestT = Model::ResolveAppVersionResourcesRequest>
  Model::ResolveAppVersionResourcesOutcomeCallable ResolveAppVersionResourcesCallable(
      const ResolveAppVersionResourcesRequestT& request) const {
    return SubmitCallable(&ResilienceHubClient::ResolveAppVersionResources, request);
  }

  /**
   * An Async wrapper for ResolveAppVersionResources that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ResolveAppVersionResourcesRequestT = Model::ResolveAppVersionResourcesRequest>
  void ResolveAppVersionResourcesAsync(const ResolveAppVersionResourcesRequestT& request,
                                       const ResolveAppVersionResourcesResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartAppAssessment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartAppAssessment that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StartAppAssessmentRequestT = Model::StartAppAssessmentRequest>
  void StartAppAssessmentAsync(const StartAppAssessmentRequestT& request, const StartAppAssessmentResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartMetricsExport that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartMetricsExport that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StartMetricsExportRequestT = Model::StartMetricsExportRequest>
  void StartMetricsExportAsync(const StartMetricsExportResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const StartMetricsExportRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartResourceGroupingRecommendationTaskOutcome StartResourceGroupingRecommendationTask(
      const Model::StartResourceGroupingRecommendationTaskRequest& request) const;

  /**
   * A Callable wrapper for StartResourceGroupingRecommendationTask that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename StartResourceGroupingRecommendationTaskRequestT = Model::StartResourceGroupingRecommendationTaskRequest>
  Model::StartResourceGroupingRecommendationTaskOutcomeCallable StartResourceGroupingRecommendationTaskCallable(
      const StartResourceGroupingRecommendationTaskRequestT& request) const {
    return SubmitCallable(&ResilienceHubClient::StartResourceGroupingRecommendationTask, request);
  }

  /**
   * An Async wrapper for StartResourceGroupingRecommendationTask that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename StartResourceGroupingRecommendationTaskRequestT = Model::StartResourceGroupingRecommendationTaskRequest>
  void StartResourceGroupingRecommendationTaskAsync(const StartResourceGroupingRecommendationTaskRequestT& request,
                                                    const StartResourceGroupingRecommendationTaskResponseReceivedHandler& handler,
                                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateApp that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateAppRequestT = Model::UpdateAppRequest>
  void UpdateAppAsync(const UpdateAppRequestT& request, const UpdateAppResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateAppVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateAppVersion that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateAppVersionRequestT = Model::UpdateAppVersionRequest>
  void UpdateAppVersionAsync(const UpdateAppVersionRequestT& request, const UpdateAppVersionResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateAppVersionAppComponentOutcome UpdateAppVersionAppComponent(
      const Model::UpdateAppVersionAppComponentRequest& request) const;

  /**
   * A Callable wrapper for UpdateAppVersionAppComponent that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateAppVersionAppComponentRequestT = Model::UpdateAppVersionAppComponentRequest>
  Model::UpdateAppVersionAppComponentOutcomeCallable UpdateAppVersionAppComponentCallable(
      const UpdateAppVersionAppComponentRequestT& request) const {
    return SubmitCallable(&ResilienceHubClient::UpdateAppVersionAppComponent, request);
  }

  /**
   * An Async wrapper for UpdateAppVersionAppComponent that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateAppVersionAppComponentRequestT = Model::UpdateAppVersionAppComponentRequest>
  void UpdateAppVersionAppComponentAsync(const UpdateAppVersionAppComponentRequestT& request,
                                         const UpdateAppVersionAppComponentResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateAppVersionResource that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateAppVersionResource that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateAppVersionResourceRequestT = Model::UpdateAppVersionResourceRequest>
  void UpdateAppVersionResourceAsync(const UpdateAppVersionResourceRequestT& request,
                                     const UpdateAppVersionResourceResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateResiliencyPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateResiliencyPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateResiliencyPolicyRequestT = Model::UpdateResiliencyPolicyRequest>
  void UpdateResiliencyPolicyAsync(const UpdateResiliencyPolicyRequestT& request,
                                   const UpdateResiliencyPolicyResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
