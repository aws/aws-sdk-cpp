...
namespace ResilienceHub
{
   ...
   * production. </p>
   */
  class AWS_RESILIENCEHUB_API ResilienceHubClient : smithy::client::AwsSmithyClientT<Aws::ResilienceHub::SERVICE_NAME,
    ...
    Aws::Client::ClientWithAsyncTemplateMethods<ResilienceHubClient>
  {
    public:
