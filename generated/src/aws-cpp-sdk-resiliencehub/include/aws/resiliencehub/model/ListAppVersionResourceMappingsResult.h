...
class ListAppVersionResourceMappingsResult {
 public:
  ...
  AWS_RESILIENCEHUB_API ListAppVersionResourceMappingsResult& operator=(
  ...
  template <typename NextTokenT = Aws::String>
  ListAppVersionResourceMappingsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResourceMappingsT = Aws::Vector<ResourceMapping>>
  ListAppVersionResourceMappingsResult& WithResourceMappings(ResourceMappingsT&& value) {
    SetResourceMappings(std::forward<ResourceMappingsT>(value));
    return *this;
  }
  template <typename ResourceMappingsT = ResourceMapping>
  ListAppVersionResourceMappingsResult& AddResourceMappings(ResourceMappingsT&& value) {
    m_resourceMappingsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListAppVersionResourceMappingsResult& WithRequestId(RequestIdT&& value) {
