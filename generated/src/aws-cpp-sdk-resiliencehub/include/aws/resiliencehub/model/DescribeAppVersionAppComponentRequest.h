...
class DescribeAppVersionAppComponentRequest : public ResilienceHubRequest {
 public:
  ...
  template <typename AppArnT = Aws::String>
  DescribeAppVersionAppComponentRequest& WithAppArn(AppArnT&& value) {
  ...
  template <typename AppVersionT = Aws::String>
  DescribeAppVersionAppComponentRequest& WithAppVersion(AppVersionT&& value) {
  ...
  template <typename IdT = Aws::String>
  DescribeAppVersionAppComponentRequest& WithId(IdT&& value) {
