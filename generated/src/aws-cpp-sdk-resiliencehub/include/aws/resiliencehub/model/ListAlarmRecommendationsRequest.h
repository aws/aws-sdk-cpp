...
namespace Model
{
  ...
  {
  public:
    AWS_RESILIENCEHUB_API ListAlarmRecommendationsRequest() = default;
    ...
    template<typename AssessmentArnT = Aws::String>
    ListAlarmRecommendationsRequest& WithAssessmentArn(AssessmentArnT&& value) { SetAssessmentArn(std::forward<AssessmentArnT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListAlarmRecommendationsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
