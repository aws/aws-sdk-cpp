...
class ListAlarmRecommendationsRequest : public ResilienceHubRequest {
 public:
  ...
  template <typename AssessmentArnT = Aws::String>
  ListAlarmRecommendationsRequest& WithAssessmentArn(AssessmentArnT&& value) {
  ...
  inline ListAlarmRecommendationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAlarmRecommendationsRequest& WithNextToken(NextTokenT&& value) {
