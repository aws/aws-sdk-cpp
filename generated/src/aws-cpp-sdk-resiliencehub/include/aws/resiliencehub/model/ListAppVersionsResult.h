...
namespace Model
{
  ...
  public:
    ...
    inline ListAppVersionsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ListAppVersionsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ListAppVersionsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
