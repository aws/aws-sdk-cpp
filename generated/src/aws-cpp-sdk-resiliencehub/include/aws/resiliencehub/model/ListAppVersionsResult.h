...
class ListAppVersionsResult {
 public:
  ...
  void SetAppVersions(AppVersionsT&& value) {
    m_appVersionsHasBeenSet = true;
    m_appVersions = std::forward<AppVersionsT>(value);
  }
  template <typename AppVersionsT = Aws::Vector<AppVersionSummary>>
  ListAppVersionsResult& WithAppVersions(AppVersionsT&& value) {
    SetAppVersions(std::forward<AppVersionsT>(value));
    return *this;
  }
  template <typename AppVersionsT = AppVersionSummary>
  ListAppVersionsResult& AddAppVersions(AppVersionsT&& value) {
    m_appVersionsHasBeenSet = true;
    m_appVersions.emplace_back(std::forward<AppVersionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAppVersionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAppVersionsResult& WithRequestId(RequestIdT&& value) {
