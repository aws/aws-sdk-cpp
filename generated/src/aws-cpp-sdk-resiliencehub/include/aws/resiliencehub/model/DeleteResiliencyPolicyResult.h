...
class DeleteResiliencyPolicyResult {
 public:
  AWS_RESILIENCEHUB_API DeleteResiliencyPolicyResult() = default;
  ...
  template <typename PolicyArnT = Aws::String>
  DeleteResiliencyPolicyResult& WithPolicyArn(PolicyArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteResiliencyPolicyResult& WithRequestId(RequestIdT&& value) {
