...
class ListAlarmRecommendationsResult {
 public:
  ...
  void SetAlarmRecommendations(AlarmRecommendationsT&& value) {
    m_alarmRecommendationsHasBeenSet = true;
    m_alarmRecommendations = std::forward<AlarmRecommendationsT>(value);
  }
  template <typename AlarmRecommendationsT = Aws::Vector<AlarmRecommendation>>
  ListAlarmRecommendationsResult& WithAlarmRecommendations(AlarmRecommendationsT&& value) {
    SetAlarmRecommendations(std::forward<AlarmRecommendationsT>(value));
    return *this;
  }
  template <typename AlarmRecommendationsT = AlarmRecommendation>
  ListAlarmRecommendationsResult& AddAlarmRecommendations(AlarmRecommendationsT&& value) {
    m_alarmRecommendationsHasBeenSet = true;
    m_alarmRecommendations.emplace_back(std::forward<AlarmRecommendationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAlarmRecommendationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAlarmRecommendationsResult& WithRequestId(RequestIdT&& value) {
