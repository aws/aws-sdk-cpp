...
struct ListAppInputSourcesPaginationTraits {
  using RequestType = Model::ListAppInputSourcesRequest;
  using ResultType = Model::ListAppInputSourcesResult;
  using OutcomeType = Model::ListAppInputSourcesOutcome;
  using ClientType = Client;

  static OutcomeType Invoke(Client* client, const RequestType& request) { return client->ListAppInputSources(request); }
