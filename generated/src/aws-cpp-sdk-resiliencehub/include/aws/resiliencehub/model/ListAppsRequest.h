...
class ListAppsRequest : public ResilienceHubRequest {
 public:
  ...
  void SetFromLastAssessmentTime(FromLastAssessmentTimeT&& value) {
    m_fromLastAssessmentTimeHasBeenSet = true;
    m_fromLastAssessmentTime = std::forward<FromLastAssessmentTimeT>(value);
  }
  template <typename FromLastAssessmentTimeT = Aws::Utils::DateTime>
  ListAppsRequest& WithFromLastAssessmentTime(FromLastAssessmentTimeT&& value) {
    SetFromLastAssessmentTime(std::forward<FromLastAssessmentTimeT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListAppsRequest& WithReverseOrder(bool value) {
  ...
  void SetToLastAssessmentTime(ToLastAssessmentTimeT&& value) {
    m_toLastAssessmentTimeHasBeenSet = true;
    m_toLastAssessmentTime = std::forward<ToLastAssessmentTimeT>(value);
  }
  template <typename ToLastAssessmentTimeT = Aws::Utils::DateTime>
  ListAppsRequest& WithToLastAssessmentTime(ToLastAssessmentTimeT&& value) {
    SetToLastAssessmentTime(std::forward<ToLastAssessmentTimeT>(value));
    return *this;
  }
  ///@}
 private:
