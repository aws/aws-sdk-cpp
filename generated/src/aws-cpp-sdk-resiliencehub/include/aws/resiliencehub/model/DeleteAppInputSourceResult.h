...
class DeleteAppInputSourceResult {
 public:
  ...
  void SetAppInputSource(AppInputSourceT&& value) {
    m_appInputSourceHasBeenSet = true;
    m_appInputSource = std::forward<AppInputSourceT>(value);
  }
  template <typename AppInputSourceT = AppInputSource>
  DeleteAppInputSourceResult& WithAppInputSource(AppInputSourceT&& value) {
    SetAppInputSource(std::forward<AppInputSourceT>(value));
    return *this;
  }
  ///@}
