...
class StartResourceGroupingRecommendationTaskResult {
 public:
  ...
  AWS_RESILIENCEHUB_API StartResourceGroupingRecommendationTaskResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename AppArnT = Aws::String>
  StartResourceGroupingRecommendationTaskResult& WithAppArn(AppArnT&& value) {
  ...
  template <typename ErrorMessageT = Aws::String>
  StartResourceGroupingRecommendationTaskResult& WithErrorMessage(ErrorMessageT&& value) {
  ...
  template <typename GroupingIdT = Aws::String>
  StartResourceGroupingRecommendationTaskResult& WithGroupingId(GroupingIdT&& value) {
  ...
  inline void SetStatus(ResourcesGroupingRecGenStatusType value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline StartResourceGroupingRecommendationTaskResult& WithStatus(ResourcesGroupingRecGenStatusType value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  StartResourceGroupingRecommendationTaskResult& WithRequestId(RequestIdT&& value) {
