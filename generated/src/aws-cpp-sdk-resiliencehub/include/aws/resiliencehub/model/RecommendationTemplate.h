...
class RecommendationTemplate {
 public:
  ...
  inline RecommendationTemplate& WithFormat(TemplateFormat value) {
    SetFormat(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNeedsReplacements(bool value) {
    m_needsReplacementsHasBeenSet = true;
    m_needsReplacements = value;
  }
  inline RecommendationTemplate& WithNeedsReplacements(bool value) {
    SetNeedsReplacements(value);
    return *this;
  }
  ///@}
  ...
  inline RecommendationTemplate& AddRecommendationTypes(RenderRecommendationType value) {
    m_recommendationTypesHasBeenSet = true;
  ...
  inline RecommendationTemplate& WithStatus(RecommendationTemplateStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetTemplatesLocation(TemplatesLocationT&& value) {
    ...
    m_templatesLocation = std::forward<TemplatesLocationT>(value);
  }
  template <typename TemplatesLocationT = S3Location>
  RecommendationTemplate& WithTemplatesLocation(TemplatesLocationT&& value) {
    SetTemplatesLocation(std::forward<TemplatesLocationT>(value));
    return *this;
  }
  ///@}
 private:
