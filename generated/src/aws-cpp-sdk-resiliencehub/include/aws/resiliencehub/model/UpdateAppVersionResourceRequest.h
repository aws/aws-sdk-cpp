...
class UpdateAppVersionResourceRequest : public ResilienceHubRequest {
 public:
  ...
  UpdateAppVersionResourceRequest& AddAdditionalInfo(AdditionalInfoKeyT&& key, AdditionalInfoValueT&& value) {
    m_additionalInfoHasBeenSet = true;
    m_additionalInfo.emplace(std::forward<AdditionalInfoKeyT>(key), std::forward<AdditionalInfoValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline UpdateAppVersionResourceRequest& WithExcluded(bool value) {
    SetExcluded(value);
    return *this;
  }
  ///@}
