...
class ListAppComponentRecommendationsResult {
 public:
  ...
  AWS_RESILIENCEHUB_API ListAppComponentRecommendationsResult& operator=(
  ...
  void SetComponentRecommendations(ComponentRecommendationsT&& value) {
    m_componentRecommendationsHasBeenSet = true;
    m_componentRecommendations = std::forward<ComponentRecommendationsT>(value);
  }
  template <typename ComponentRecommendationsT = Aws::Vector<ComponentRecommendation>>
  ListAppComponentRecommendationsResult& WithComponentRecommendations(ComponentRecommendationsT&& value) {
    SetComponentRecommendations(std::forward<ComponentRecommendationsT>(value));
    return *this;
  }
  template <typename ComponentRecommendationsT = ComponentRecommendation>
  ListAppComponentRecommendationsResult& AddComponentRecommendations(ComponentRecommendationsT&& value) {
    m_componentRecommendationsHasBeenSet = true;
    m_componentRecommendations.emplace_back(std::forward<ComponentRecommendationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAppComponentRecommendationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAppComponentRecommendationsResult& WithRequestId(RequestIdT&& value) {
