...
class ResourceErrorsDetails {
 public:
  ...
  inline void SetHasMoreErrors(bool value) {
    m_hasMoreErrorsHasBeenSet = true;
    m_hasMoreErrors = value;
  }
  inline ResourceErrorsDetails& WithHasMoreErrors(bool value) {
    SetHasMoreErrors(value);
    return *this;
  }
  ///@}
  ...
  void SetResourceErrors(ResourceErrorsT&& value) {
    m_resourceErrorsHasBeenSet = true;
    m_resourceErrors = std::forward<ResourceErrorsT>(value);
  }
  template <typename ResourceErrorsT = Aws::Vector<ResourceError>>
  ResourceErrorsDetails& WithResourceErrors(ResourceErrorsT&& value) {
    SetResourceErrors(std::forward<ResourceErrorsT>(value));
    return *this;
  }
  template <typename ResourceErrorsT = ResourceError>
  ResourceErrorsDetails& AddResourceErrors(ResourceErrorsT&& value) {
    m_resourceErrorsHasBeenSet = true;
    m_resourceErrors.emplace_back(std::forward<ResourceErrorsT>(value));
    return *this;
  }
  ///@}
 private:
