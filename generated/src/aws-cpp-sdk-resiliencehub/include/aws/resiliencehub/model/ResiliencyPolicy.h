...
class ResiliencyPolicy {
 public:
  ...
  inline void SetDataLocationConstraint(DataLocationConstraint value) {
    m_dataLocationConstraintHasBeenSet = true;
    m_dataLocationConstraint = value;
  }
  inline ResiliencyPolicy& WithDataLocationConstraint(DataLocationConstraint value) {
    SetDataLocationConstraint(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEstimatedCostTier(EstimatedCostTier value) {
    m_estimatedCostTierHasBeenSet = true;
    m_estimatedCostTier = value;
  }
  inline ResiliencyPolicy& WithEstimatedCostTier(EstimatedCostTier value) {
    SetEstimatedCostTier(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTier(ResiliencyPolicyTier value) {
    m_tierHasBeenSet = true;
    m_tier = value;
  }
  inline ResiliencyPolicy& WithTier(ResiliencyPolicyTier value) {
    SetTier(value);
    return *this;
  }
  ///@}
