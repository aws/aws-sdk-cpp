...
class RecommendationDisruptionCompliance {
 public:
  ...
  inline void SetExpectedComplianceStatus(ComplianceStatus value) {
    m_expectedComplianceStatusHasBeenSet = true;
    m_expectedComplianceStatus = value;
  }
  inline RecommendationDisruptionCompliance& WithExpectedComplianceStatus(ComplianceStatus value) {
    SetExpectedComplianceStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetExpectedRpoDescription(ExpectedRpoDescriptionT&& value) {
    ...
    m_expectedRpoDescription = std::forward<ExpectedRpoDescriptionT>(value);
  }
  template <typename ExpectedRpoDescriptionT = Aws::String>
  RecommendationDisruptionCompliance& WithExpectedRpoDescription(ExpectedRpoDescriptionT&& value) {
    SetExpectedRpoDescription(std::forward<ExpectedRpoDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetExpectedRpoInSecs(int value) {
    m_expectedRpoInSecsHasBeenSet = true;
    m_expectedRpoInSecs = value;
  }
  inline RecommendationDisruptionCompliance& WithExpectedRpoInSecs(int value) {
    SetExpectedRpoInSecs(value);
    return *this;
  }
  ///@}
  ...
  void SetExpectedRtoDescription(ExpectedRtoDescriptionT&& value) {
    ...
    m_expectedRtoDescription = std::forward<ExpectedRtoDescriptionT>(value);
  }
  template <typename ExpectedRtoDescriptionT = Aws::String>
  RecommendationDisruptionCompliance& WithExpectedRtoDescription(ExpectedRtoDescriptionT&& value) {
    SetExpectedRtoDescription(std::forward<ExpectedRtoDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetExpectedRtoInSecs(int value) {
    m_expectedRtoInSecsHasBeenSet = true;
    m_expectedRtoInSecs = value;
  }
  inline RecommendationDisruptionCompliance& WithExpectedRtoInSecs(int value) {
    SetExpectedRtoInSecs(value);
    return *this;
  }
  ///@}
 private:
