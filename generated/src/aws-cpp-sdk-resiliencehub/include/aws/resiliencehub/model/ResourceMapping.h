...
class ResourceMapping {
 public:
  ...
  void SetAppRegistryAppName(AppRegistryAppNameT&& value) {
    ...
    m_appRegistryAppName = std::forward<AppRegistryAppNameT>(value);
  }
  template <typename AppRegistryAppNameT = Aws::String>
  ResourceMapping& WithAppRegistryAppName(AppRegistryAppNameT&& value) {
    SetAppRegistryAppName(std::forward<AppRegistryAppNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetMappingType(ResourceMappingType value) {
    m_mappingTypeHasBeenSet = true;
    m_mappingType = value;
  }
  inline ResourceMapping& WithMappingType(ResourceMappingType value) {
