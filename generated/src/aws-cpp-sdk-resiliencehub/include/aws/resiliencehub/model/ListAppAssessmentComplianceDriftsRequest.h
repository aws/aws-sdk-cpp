...
class ListAppAssessmentComplianceDriftsRequest : public ResilienceHubRequest {
 public:
  ...
  template <typename AssessmentArnT = Aws::String>
  ListAppAssessmentComplianceDriftsRequest& WithAssessmentArn(AssessmentArnT&& value) {
  ...
  inline ListAppAssessmentComplianceDriftsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAppAssessmentComplianceDriftsRequest& WithNextToken(NextTokenT&& value) {
