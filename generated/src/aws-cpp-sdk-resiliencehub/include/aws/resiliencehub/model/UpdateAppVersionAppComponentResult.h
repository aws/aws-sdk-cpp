...
class UpdateAppVersionAppComponentResult {
 public:
  AWS_RESILIENCEHUB_API UpdateAppVersionAppComponentResult() = default;
  ...
  AWS_RESILIENCEHUB_API UpdateAppVersionAppComponentResult& operator=(
  ...
  template <typename AppArnT = Aws::String>
  UpdateAppVersionAppComponentResult& WithAppArn(AppArnT&& value) {
  ...
  template <typename AppComponentT = AppComponent>
  UpdateAppVersionAppComponentResult& WithAppComponent(AppComponentT&& value) {
  ...
  template <typename AppVersionT = Aws::String>
  UpdateAppVersionAppComponentResult& WithAppVersion(AppVersionT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateAppVersionAppComponentResult& WithRequestId(RequestIdT&& value) {
