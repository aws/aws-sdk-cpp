...
class SopRecommendation {
 public:
  ...
  inline SopRecommendation& WithRecommendationStatus(RecommendationStatus value) {
  ...
  inline void SetServiceType(SopServiceType value) {
    m_serviceTypeHasBeenSet = true;
    m_serviceType = value;
  }
  inline SopRecommendation& WithServiceType(SopServiceType value) {
