...
class ListSopRecommendationsResult {
 public:
  ...
  void SetSopRecommendations(SopRecommendationsT&& value) {
    ...
    m_sopRecommendations = std::forward<SopRecommendationsT>(value);
  }
  template <typename SopRecommendationsT = Aws::Vector<SopRecommendation>>
  ListSopRecommendationsResult& WithSopRecommendations(SopRecommendationsT&& value) {
    SetSopRecommendations(std::forward<SopRecommendationsT>(value));
    return *this;
  }
  ...
  ListSopRecommendationsResult& AddSopRecommendations(SopRecommendationsT&& value) {
    m_sopRecommendationsHasBeenSet = true;
    m_sopRecommendations.emplace_back(std::forward<SopRecommendationsT>(value));
    return *this;
  }
  ///@}
