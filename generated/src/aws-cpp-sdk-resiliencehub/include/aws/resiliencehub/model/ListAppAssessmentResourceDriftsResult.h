...
class ListAppAssessmentResourceDriftsResult {
 public:
  ...
  AWS_RESILIENCEHUB_API ListAppAssessmentResourceDriftsResult& operator=(
  ...
  template <typename NextTokenT = Aws::String>
  ListAppAssessmentResourceDriftsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetResourceDrifts(ResourceDriftsT&& value) {
    m_resourceDriftsHasBeenSet = true;
    m_resourceDrifts = std::forward<ResourceDriftsT>(value);
  }
  template <typename ResourceDriftsT = Aws::Vector<ResourceDrift>>
  ListAppAssessmentResourceDriftsResult& WithResourceDrifts(ResourceDriftsT&& value) {
    SetResourceDrifts(std::forward<ResourceDriftsT>(value));
    return *this;
  }
  template <typename ResourceDriftsT = ResourceDrift>
  ListAppAssessmentResourceDriftsResult& AddResourceDrifts(ResourceDriftsT&& value) {
    m_resourceDriftsHasBeenSet = true;
    m_resourceDrifts.emplace_back(std::forward<ResourceDriftsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListAppAssessmentResourceDriftsResult& WithRequestId(RequestIdT&& value) {
