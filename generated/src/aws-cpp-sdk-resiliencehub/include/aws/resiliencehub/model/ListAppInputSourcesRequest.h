...
class ListAppInputSourcesRequest : public ResilienceHubRequest {
 public:
  ...
  template <typename AppArnT = Aws::String>
  ListAppInputSourcesRequest& WithAppArn(AppArnT&& value) {
  ...
  template <typename AppVersionT = Aws::String>
  ListAppInputSourcesRequest& WithAppVersion(AppVersionT&& value) {
  ...
  inline ListAppInputSourcesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAppInputSourcesRequest& WithNextToken(NextTokenT&& value) {
