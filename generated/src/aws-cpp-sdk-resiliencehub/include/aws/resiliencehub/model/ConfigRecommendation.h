...
class ConfigRecommendation {
 public:
  ...
  inline void SetHaArchitecture(HaArchitecture value) {
    m_haArchitectureHasBeenSet = true;
    m_haArchitecture = value;
  }
  inline ConfigRecommendation& WithHaArchitecture(HaArchitecture value) {
    SetHaArchitecture(value);
    return *this;
  }
  ///@}
  ...
  inline void SetOptimizationType(ConfigRecommendationOptimizationType value) {
    m_optimizationTypeHasBeenSet = true;
    m_optimizationType = value;
  }
  inline ConfigRecommendation& WithOptimizationType(ConfigRecommendationOptimizationType value) {
   ...
   * configuration change.</p>
   */
  inline const Aws::Map<DisruptionType, RecommendationDisruptionCompliance>& GetRecommendationCompliance() const {
    return m_recommendationCompliance;
  }
