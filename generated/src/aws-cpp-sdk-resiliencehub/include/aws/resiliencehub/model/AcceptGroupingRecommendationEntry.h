...
class AcceptGroupingRecommendationEntry {
 public:
  ...
  void SetGroupingRecommendationId(GroupingRecommendationIdT&& value) {
    ...
    m_groupingRecommendationId = std::forward<GroupingRecommendationIdT>(value);
  }
  template <typename GroupingRecommendationIdT = Aws::String>
  AcceptGroupingRecommendationEntry& WithGroupingRecommendationId(GroupingRecommendationIdT&& value) {
    SetGroupingRecommendationId(std::forward<GroupingRecommendationIdT>(value));
    return *this;
  }
  ///@}
 private:
