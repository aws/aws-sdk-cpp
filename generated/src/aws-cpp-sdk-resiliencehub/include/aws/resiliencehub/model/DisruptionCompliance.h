...
class DisruptionCompliance {
 public:
  ...
  inline void SetAchievableRpoInSecs(int value) {
    m_achievableRpoInSecsHasBeenSet = true;
    m_achievableRpoInSecs = value;
  }
  inline DisruptionCompliance& WithAchievableRpoInSecs(int value) {
    SetAchievableRpoInSecs(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAchievableRtoInSecs(int value) {
    m_achievableRtoInSecsHasBeenSet = true;
    m_achievableRtoInSecs = value;
  }
  inline DisruptionCompliance& WithAchievableRtoInSecs(int value) {
    SetAchievableRtoInSecs(value);
    return *this;
  }
  ///@}
  ...
  inline DisruptionCompliance& WithComplianceStatus(ComplianceStatus value) {
  ...
  inline void SetCurrentRpoInSecs(int value) {
    m_currentRpoInSecsHasBeenSet = true;
    m_currentRpoInSecs = value;
  }
  inline DisruptionCompliance& WithCurrentRpoInSecs(int value) {
    SetCurrentRpoInSecs(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCurrentRtoInSecs(int value) {
    m_currentRtoInSecsHasBeenSet = true;
    m_currentRtoInSecs = value;
  }
  inline DisruptionCompliance& WithCurrentRtoInSecs(int value) {
    SetCurrentRtoInSecs(value);
    return *this;
  }
  ///@}
  ...
  void SetRpoDescription(RpoDescriptionT&& value) {
    ...
    m_rpoDescription = std::forward<RpoDescriptionT>(value);
  }
  template <typename RpoDescriptionT = Aws::String>
  DisruptionCompliance& WithRpoDescription(RpoDescriptionT&& value) {
    SetRpoDescription(std::forward<RpoDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRpoReferenceId(RpoReferenceIdT&& value) {
    ...
    m_rpoReferenceId = std::forward<RpoReferenceIdT>(value);
  }
  template <typename RpoReferenceIdT = Aws::String>
  DisruptionCompliance& WithRpoReferenceId(RpoReferenceIdT&& value) {
    SetRpoReferenceId(std::forward<RpoReferenceIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRtoDescription(RtoDescriptionT&& value) {
    ...
    m_rtoDescription = std::forward<RtoDescriptionT>(value);
  }
  template <typename RtoDescriptionT = Aws::String>
  DisruptionCompliance& WithRtoDescription(RtoDescriptionT&& value) {
    SetRtoDescription(std::forward<RtoDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRtoReferenceId(RtoReferenceIdT&& value) {
    ...
    m_rtoReferenceId = std::forward<RtoReferenceIdT>(value);
  }
  template <typename RtoReferenceIdT = Aws::String>
  DisruptionCompliance& WithRtoReferenceId(RtoReferenceIdT&& value) {
    SetRtoReferenceId(std::forward<RtoReferenceIdT>(value));
    return *this;
  }
  ///@}
 private:
