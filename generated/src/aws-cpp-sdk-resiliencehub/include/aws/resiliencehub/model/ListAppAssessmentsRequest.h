...
class ListAppAssessmentsRequest : public ResilienceHubRequest {
 public:
  ...
  void SetAssessmentStatus(AssessmentStatusT&& value) {
    m_assessmentStatusHasBeenSet = true;
    m_assessmentStatus = std::forward<AssessmentStatusT>(value);
  }
  template <typename AssessmentStatusT = Aws::Vector<AssessmentStatus>>
  ListAppAssessmentsRequest& WithAssessmentStatus(AssessmentStatusT&& value) {
    SetAssessmentStatus(std::forward<AssessmentStatusT>(value));
    return *this;
  }
  inline ListAppAssessmentsRequest& AddAssessmentStatus(AssessmentStatus value) {
    m_assessmentStatusHasBeenSet = true;
    m_assessmentStatus.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline ListAppAssessmentsRequest& WithComplianceStatus(ComplianceStatus value) {
  ...
  inline ListAppAssessmentsRequest& WithInvoker(AssessmentInvoker value) {
    SetInvoker(value);
    return *this;
  }
  ///@}
  ...
  inline ListAppAssessmentsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline ListAppAssessmentsRequest& WithReverseOrder(bool value) {
