...
namespace Model
{
  ...
  public:
    ...
    template<typename AppArnT = Aws::String>
    UpdateAppVersionResourceResult& WithAppArn(AppArnT&& value) { SetAppArn(std::forward<AppArnT>(value)); return *this;}
    ///@}
    ...
    template<typename AppVersionT = Aws::String>
    UpdateAppVersionResourceResult& WithAppVersion(AppVersionT&& value) { SetAppVersion(std::forward<AppVersionT>(value)); return *this;}
    ///@}
    ...
    template<typename PhysicalResourceT = PhysicalResource>
    UpdateAppVersionResourceResult& WithPhysicalResource(PhysicalResourceT&& value) { SetPhysicalResource(std::forward<PhysicalResourceT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateAppVersionResourceResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
