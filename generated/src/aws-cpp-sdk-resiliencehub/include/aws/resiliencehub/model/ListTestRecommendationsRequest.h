...
class ListTestRecommendationsRequest : public ResilienceHubRequest {
 public:
  ...
  template <typename AssessmentArnT = Aws::String>
  ListTestRecommendationsRequest& WithAssessmentArn(AssessmentArnT&& value) {
  ...
  inline ListTestRecommendationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTestRecommendationsRequest& WithNextToken(NextTokenT&& value) {
