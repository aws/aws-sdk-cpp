...
class DescribeAppVersionAppComponentResult {
 public:
  ...
  AWS_RESILIENCEHUB_API DescribeAppVersionAppComponentResult& operator=(
  ...
  template <typename AppArnT = Aws::String>
  DescribeAppVersionAppComponentResult& WithAppArn(AppArnT&& value) {
  ...
  template <typename AppComponentT = AppComponent>
  DescribeAppVersionAppComponentResult& WithAppComponent(AppComponentT&& value) {
  ...
  template <typename AppVersionT = Aws::String>
  DescribeAppVersionAppComponentResult& WithAppVersion(AppVersionT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeAppVersionAppComponentResult& WithRequestId(RequestIdT&& value) {
