...
class RemoveDraftAppVersionResourceMappingsResult {
 public:
  AWS_RESILIENCEHUB_API RemoveDraftAppVersionResourceMappingsResult() = default;
  ...
  AWS_RESILIENCEHUB_API RemoveDraftAppVersionResourceMappingsResult& operator=(
  ...
  template <typename AppArnT = Aws::String>
  RemoveDraftAppVersionResourceMappingsResult& WithAppArn(AppArnT&& value) {
  ...
  template <typename AppVersionT = Aws::String>
  RemoveDraftAppVersionResourceMappingsResult& WithAppVersion(AppVersionT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  RemoveDraftAppVersionResourceMappingsResult& WithRequestId(RequestIdT&& value) {
