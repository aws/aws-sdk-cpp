...
class DescribeAppVersionResult {
 public:
  ...
  template <typename AdditionalInfoT = Aws::Map<Aws::String, Aws::Vector<Aws::String>>>
  DescribeAppVersionResult& WithAdditionalInfo(AdditionalInfoT&& value) {
  ...
  template <typename AppArnT = Aws::String>
  DescribeAppVersionResult& WithAppArn(AppArnT&& value) {
  ...
  template <typename AppVersionT = Aws::String>
  DescribeAppVersionResult& WithAppVersion(AppVersionT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeAppVersionResult& WithRequestId(RequestIdT&& value) {
