...
class DescribeMetricsExportResult {
 public:
  ...
  void SetExportLocation(ExportLocationT&& value) {
    ...
    m_exportLocation = std::forward<ExportLocationT>(value);
  }
  template <typename ExportLocationT = S3Location>
  DescribeMetricsExportResult& WithExportLocation(ExportLocationT&& value) {
    SetExportLocation(std::forward<ExportLocationT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeMetricsExportResult& WithStatus(MetricsExportStatusType value) {
    SetStatus(value);
    return *this;
  }
  ///@}
