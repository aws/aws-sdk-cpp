...
class ListAppAssessmentsResult {
 public:
  ...
  void SetAssessmentSummaries(AssessmentSummariesT&& value) {
    m_assessmentSummariesHasBeenSet = true;
    m_assessmentSummaries = std::forward<AssessmentSummariesT>(value);
  }
  template <typename AssessmentSummariesT = Aws::Vector<AppAssessmentSummary>>
  ListAppAssessmentsResult& WithAssessmentSummaries(AssessmentSummariesT&& value) {
    SetAssessmentSummaries(std::forward<AssessmentSummariesT>(value));
    return *this;
  }
  template <typename AssessmentSummariesT = AppAssessmentSummary>
  ListAppAssessmentsResult& AddAssessmentSummaries(AssessmentSummariesT&& value) {
    m_assessmentSummariesHasBeenSet = true;
    m_assessmentSummaries.emplace_back(std::forward<AssessmentSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAppAssessmentsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAppAssessmentsResult& WithRequestId(RequestIdT&& value) {
