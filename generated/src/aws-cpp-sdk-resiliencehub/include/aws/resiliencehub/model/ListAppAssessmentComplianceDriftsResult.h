...
class ListAppAssessmentComplianceDriftsResult {
 public:
  ...
  AWS_RESILIENCEHUB_API ListAppAssessmentComplianceDriftsResult& operator=(
  ...
  void SetComplianceDrifts(ComplianceDriftsT&& value) {
    m_complianceDriftsHasBeenSet = true;
    m_complianceDrifts = std::forward<ComplianceDriftsT>(value);
  }
  template <typename ComplianceDriftsT = Aws::Vector<ComplianceDrift>>
  ListAppAssessmentComplianceDriftsResult& WithComplianceDrifts(ComplianceDriftsT&& value) {
    SetComplianceDrifts(std::forward<ComplianceDriftsT>(value));
    return *this;
  }
  template <typename ComplianceDriftsT = ComplianceDrift>
  ListAppAssessmentComplianceDriftsResult& AddComplianceDrifts(ComplianceDriftsT&& value) {
    m_complianceDriftsHasBeenSet = true;
    m_complianceDrifts.emplace_back(std::forward<ComplianceDriftsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAppAssessmentComplianceDriftsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAppAssessmentComplianceDriftsResult& WithRequestId(RequestIdT&& value) {
