...
class AppComponentCompliance {
 public:
  ...
  inline AppComponentCompliance& AddCompliance(DisruptionType key, DisruptionCompliance value) {
    m_complianceHasBeenSet = true;
    m_compliance.emplace(key, value);
    return *this;
  }
  ///@}
  ...
  void SetResiliencyScore(ResiliencyScoreT&& value) {
    ...
    m_resiliencyScore = std::forward<ResiliencyScoreT>(value);
  }
  template <typename ResiliencyScoreT = ResiliencyScore>
  AppComponentCompliance& WithResiliencyScore(ResiliencyScoreT&& value) {
    SetResiliencyScore(std::forward<ResiliencyScoreT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(ComplianceStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline AppComponentCompliance& WithStatus(ComplianceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
