...
class ListRecommendationTemplatesResult {
 public:
  ...
  AWS_RESILIENCEHUB_API ListRecommendationTemplatesResult& operator=(
  ...
  template <typename NextTokenT = Aws::String>
  ListRecommendationTemplatesResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetRecommendationTemplates(RecommendationTemplatesT&& value) {
    m_recommendationTemplatesHasBeenSet = true;
    m_recommendationTemplates = std::forward<RecommendationTemplatesT>(value);
  }
  template <typename RecommendationTemplatesT = Aws::Vector<RecommendationTemplate>>
  ListRecommendationTemplatesResult& WithRecommendationTemplates(RecommendationTemplatesT&& value) {
    SetRecommendationTemplates(std::forward<RecommendationTemplatesT>(value));
    return *this;
  }
  template <typename RecommendationTemplatesT = RecommendationTemplate>
  ListRecommendationTemplatesResult& AddRecommendationTemplates(RecommendationTemplatesT&& value) {
    m_recommendationTemplatesHasBeenSet = true;
    m_recommendationTemplates.emplace_back(std::forward<RecommendationTemplatesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListRecommendationTemplatesResult& WithRequestId(RequestIdT&& value) {
