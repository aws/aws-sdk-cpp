...
class UpdateResiliencyPolicyRequest : public ResilienceHubRequest {
 public:
  ...
  inline UpdateResiliencyPolicyRequest& WithDataLocationConstraint(DataLocationConstraint value) {
  ...
  inline UpdateResiliencyPolicyRequest& WithTier(ResiliencyPolicyTier value) {
    SetTier(value);
    return *this;
  }
  ///@}
