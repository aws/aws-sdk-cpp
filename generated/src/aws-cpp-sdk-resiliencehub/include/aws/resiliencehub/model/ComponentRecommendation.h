...
class ComponentRecommendation {
 public:
  ...
  void SetConfigRecommendations(ConfigRecommendationsT&& value) {
    ...
    m_configRecommendations = std::forward<ConfigRecommendationsT>(value);
  }
  template <typename ConfigRecommendationsT = Aws::Vector<ConfigRecommendation>>
  ComponentRecommendation& WithConfigRecommendations(ConfigRecommendationsT&& value) {
    SetConfigRecommendations(std::forward<ConfigRecommendationsT>(value));
    return *this;
  }
  ...
  ComponentRecommendation& AddConfigRecommendations(ConfigRecommendationsT&& value) {
    m_configRecommendationsHasBeenSet = true;
    m_configRecommendations.emplace_back(std::forward<ConfigRecommendationsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetRecommendationStatus(RecommendationComplianceStatus value) {
    m_recommendationStatusHasBeenSet = true;
    m_recommendationStatus = value;
  }
  inline ComponentRecommendation& WithRecommendationStatus(RecommendationComplianceStatus value) {
