...
class ImportResourcesToDraftAppVersionRequest : public ResilienceHubRequest {
 public:
  ...
  template <typename AppArnT = Aws::String>
  ImportResourcesToDraftAppVersionRequest& WithAppArn(AppArnT&& value) {
  ...
  void SetEksSources(EksSourcesT&& value) {
    m_eksSourcesHasBeenSet = true;
    m_eksSources = std::forward<EksSourcesT>(value);
  }
  template <typename EksSourcesT = Aws::Vector<EksSource>>
  ImportResourcesToDraftAppVersionRequest& WithEksSources(EksSourcesT&& value) {
    SetEksSources(std::forward<EksSourcesT>(value));
    return *this;
  }
  template <typename EksSourcesT = EksSource>
  ImportResourcesToDraftAppVersionRequest& AddEksSources(EksSourcesT&& value) {
    m_eksSourcesHasBeenSet = true;
    m_eksSources.emplace_back(std::forward<EksSourcesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetImportStrategy(ResourceImportStrategyType value) {
    m_importStrategyHasBeenSet = true;
    m_importStrategy = value;
  }
  inline ImportResourcesToDraftAppVersionRequest& WithImportStrategy(ResourceImportStrategyType value) {
  ...
  void SetSourceArns(SourceArnsT&& value) {
    m_sourceArnsHasBeenSet = true;
    m_sourceArns = std::forward<SourceArnsT>(value);
  }
  template <typename SourceArnsT = Aws::Vector<Aws::String>>
  ImportResourcesToDraftAppVersionRequest& WithSourceArns(SourceArnsT&& value) {
    SetSourceArns(std::forward<SourceArnsT>(value));
    return *this;
  }
  template <typename SourceArnsT = Aws::String>
  ImportResourcesToDraftAppVersionRequest& AddSourceArns(SourceArnsT&& value) {
    m_sourceArnsHasBeenSet = true;
    m_sourceArns.emplace_back(std::forward<SourceArnsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTerraformSources(TerraformSourcesT&& value) {
    m_terraformSourcesHasBeenSet = true;
    m_terraformSources = std::forward<TerraformSourcesT>(value);
  }
  template <typename TerraformSourcesT = Aws::Vector<TerraformSource>>
  ImportResourcesToDraftAppVersionRequest& WithTerraformSources(TerraformSourcesT&& value) {
    SetTerraformSources(std::forward<TerraformSourcesT>(value));
    return *this;
  }
  template <typename TerraformSourcesT = TerraformSource>
  ImportResourcesToDraftAppVersionRequest& AddTerraformSources(TerraformSourcesT&& value) {
    m_terraformSourcesHasBeenSet = true;
    m_terraformSources.emplace_back(std::forward<TerraformSourcesT>(value));
    return *this;
  }
  ///@}
 private:
