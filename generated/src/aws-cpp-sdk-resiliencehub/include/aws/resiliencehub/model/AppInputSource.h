...
class AppInputSource {
 public:
  ...
  inline void SetImportType(ResourceMappingType value) {
    m_importTypeHasBeenSet = true;
    m_importType = value;
  }
  inline AppInputSource& WithImportType(ResourceMappingType value) {
    SetImportType(value);
    return *this;
  }
  ///@}
  ...
  inline AppInputSource& WithResourceCount(int value) {
