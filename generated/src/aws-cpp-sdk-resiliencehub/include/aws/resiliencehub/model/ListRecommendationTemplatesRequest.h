...
class ListRecommendationTemplatesRequest : public ResilienceHubRequest {
 public:
  ...
  inline ListRecommendationTemplatesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NameT = Aws::String>
  ListRecommendationTemplatesRequest& WithName(NameT&& value) {
  ...
  inline ListRecommendationTemplatesRequest& WithReverseOrder(bool value) {
  ...
  template <typename StatusT = Aws::Vector<RecommendationTemplateStatus>>
  ListRecommendationTemplatesRequest& WithStatus(StatusT&& value) {
    SetStatus(std::forward<StatusT>(value));
    return *this;
  }
  inline ListRecommendationTemplatesRequest& AddStatus(RecommendationTemplateStatus value) {
    m_statusHasBeenSet = true;
