...
class ComplianceDrift {
 public:
  ...
  void SetActualReferenceId(ActualReferenceIdT&& value) {
    ...
    m_actualReferenceId = std::forward<ActualReferenceIdT>(value);
  }
  template <typename ActualReferenceIdT = Aws::String>
  ComplianceDrift& WithActualReferenceId(ActualReferenceIdT&& value) {
    SetActualReferenceId(std::forward<ActualReferenceIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline ComplianceDrift& AddActualValue(DisruptionType key, DisruptionCompliance value) {
    m_actualValueHasBeenSet = true;
    m_actualValue.emplace(key, value);
    return *this;
  }
  ///@}
  ...
  inline ComplianceDrift& WithDiffType(DifferenceType value) {
    SetDiffType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDriftType(DriftType value) {
    m_driftTypeHasBeenSet = true;
    m_driftType = value;
  }
  inline ComplianceDrift& WithDriftType(DriftType value) {
    SetDriftType(value);
    return *this;
  }
  ///@}
  ...
  void SetExpectedReferenceId(ExpectedReferenceIdT&& value) {
    ...
    m_expectedReferenceId = std::forward<ExpectedReferenceIdT>(value);
  }
  template <typename ExpectedReferenceIdT = Aws::String>
  ComplianceDrift& WithExpectedReferenceId(ExpectedReferenceIdT&& value) {
    SetExpectedReferenceId(std::forward<ExpectedReferenceIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline ComplianceDrift& AddExpectedValue(DisruptionType key, DisruptionCompliance value) {
    m_expectedValueHasBeenSet = true;
    m_expectedValue.emplace(key, value);
    return *this;
  }
  ///@}
 private:
