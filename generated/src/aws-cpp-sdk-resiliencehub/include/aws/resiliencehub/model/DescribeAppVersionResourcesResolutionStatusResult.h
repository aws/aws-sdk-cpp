...
class DescribeAppVersionResourcesResolutionStatusResult {
 public:
  ...
  AWS_RESILIENCEHUB_API DescribeAppVersionResourcesResolutionStatusResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename AppArnT = Aws::String>
  DescribeAppVersionResourcesResolutionStatusResult& WithAppArn(AppArnT&& value) {
  ...
  template <typename AppVersionT = Aws::String>
  DescribeAppVersionResourcesResolutionStatusResult& WithAppVersion(AppVersionT&& value) {
  ...
  template <typename ErrorMessageT = Aws::String>
  DescribeAppVersionResourcesResolutionStatusResult& WithErrorMessage(ErrorMessageT&& value) {
  ...
  template <typename ResolutionIdT = Aws::String>
  DescribeAppVersionResourcesResolutionStatusResult& WithResolutionId(ResolutionIdT&& value) {
  ...
  inline DescribeAppVersionResourcesResolutionStatusResult& WithStatus(ResourceResolutionStatusType value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeAppVersionResourcesResolutionStatusResult& WithRequestId(RequestIdT&& value) {
