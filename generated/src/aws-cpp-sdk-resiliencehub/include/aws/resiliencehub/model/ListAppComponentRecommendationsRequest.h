...
namespace Model
{
  ...
  {
  public:
    AWS_RESILIENCEHUB_API ListAppComponentRecommendationsRequest() = default;
    ...
    template<typename AssessmentArnT = Aws::String>
    ListAppComponentRecommendationsRequest& WithAssessmentArn(AssessmentArnT&& value) { SetAssessmentArn(std::forward<AssessmentArnT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListAppComponentRecommendationsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
