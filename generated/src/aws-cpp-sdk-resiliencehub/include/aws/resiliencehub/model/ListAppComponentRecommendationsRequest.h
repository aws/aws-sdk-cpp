...
class ListAppComponentRecommendationsRequest : public ResilienceHubRequest {
 public:
  ...
  template <typename AssessmentArnT = Aws::String>
  ListAppComponentRecommendationsRequest& WithAssessmentArn(AssessmentArnT&& value) {
  ...
  inline ListAppComponentRecommendationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAppComponentRecommendationsRequest& WithNextToken(NextTokenT&& value) {
