...
class ImportResourcesToDraftAppVersionResult {
 public:
  ...
  AWS_RESILIENCEHUB_API ImportResourcesToDraftAppVersionResult& operator=(
  ...
  template <typename AppArnT = Aws::String>
  ImportResourcesToDraftAppVersionResult& WithAppArn(AppArnT&& value) {
  ...
  template <typename AppVersionT = Aws::String>
  ImportResourcesToDraftAppVersionResult& WithAppVersion(AppVersionT&& value) {
  ...
  template <typename EksSourcesT = Aws::Vector<EksSource>>
  ImportResourcesToDraftAppVersionResult& WithEksSources(EksSourcesT&& value) {
    SetEksSources(std::forward<EksSourcesT>(value));
    return *this;
  }
  template <typename EksSourcesT = EksSource>
  ImportResourcesToDraftAppVersionResult& AddEksSources(EksSourcesT&& value) {
    m_eksSourcesHasBeenSet = true;
  ...
  template <typename SourceArnsT = Aws::Vector<Aws::String>>
  ImportResourcesToDraftAppVersionResult& WithSourceArns(SourceArnsT&& value) {
    SetSourceArns(std::forward<SourceArnsT>(value));
    return *this;
  }
  template <typename SourceArnsT = Aws::String>
  ImportResourcesToDraftAppVersionResult& AddSourceArns(SourceArnsT&& value) {
    m_sourceArnsHasBeenSet = true;
  ...
  inline ImportResourcesToDraftAppVersionResult& WithStatus(ResourceImportStatusType value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename TerraformSourcesT = Aws::Vector<TerraformSource>>
  ImportResourcesToDraftAppVersionResult& WithTerraformSources(TerraformSourcesT&& value) {
    SetTerraformSources(std::forward<TerraformSourcesT>(value));
    return *this;
  }
  template <typename TerraformSourcesT = TerraformSource>
  ImportResourcesToDraftAppVersionResult& AddTerraformSources(TerraformSourcesT&& value) {
    m_terraformSourcesHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ImportResourcesToDraftAppVersionResult& WithRequestId(RequestIdT&& value) {
