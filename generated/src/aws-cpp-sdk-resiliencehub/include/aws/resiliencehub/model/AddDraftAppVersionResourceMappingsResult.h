...
class AddDraftAppVersionResourceMappingsResult {
 public:
  ...
  AWS_RESILIENCEHUB_API AddDraftAppVersionResourceMappingsResult& operator=(
  ...
  template <typename AppArnT = Aws::String>
  AddDraftAppVersionResourceMappingsResult& WithAppArn(AppArnT&& value) {
  ...
  template <typename AppVersionT = Aws::String>
  AddDraftAppVersionResourceMappingsResult& WithAppVersion(AppVersionT&& value) {
  ...
  template <typename ResourceMappingsT = Aws::Vector<ResourceMapping>>
  AddDraftAppVersionResourceMappingsResult& WithResourceMappings(ResourceMappingsT&& value) {
    SetResourceMappings(std::forward<ResourceMappingsT>(value));
    return *this;
  }
  template <typename ResourceMappingsT = ResourceMapping>
  AddDraftAppVersionResourceMappingsResult& AddResourceMappings(ResourceMappingsT&& value) {
    m_resourceMappingsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  AddDraftAppVersionResourceMappingsResult& WithRequestId(RequestIdT&& value) {
