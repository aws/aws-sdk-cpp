...
class CreateResiliencyPolicyRequest : public ResilienceHubRequest {
 public:
  ...
  inline CreateResiliencyPolicyRequest& WithDataLocationConstraint(DataLocationConstraint value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateResiliencyPolicyRequest& WithTags(TagsT&& value) {
  ...
  inline CreateResiliencyPolicyRequest& WithTier(ResiliencyPolicyTier value) {
    SetTier(value);
    return *this;
  }
  ///@}
