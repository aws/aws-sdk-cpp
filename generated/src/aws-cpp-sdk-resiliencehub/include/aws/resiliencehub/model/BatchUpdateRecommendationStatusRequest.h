...
class BatchUpdateRecommendationStatusRequest : public ResilienceHubRequest {
 public:
  ...
  template <typename AppArnT = Aws::String>
  BatchUpdateRecommendationStatusRequest& WithAppArn(AppArnT&& value) {
  ...
  void SetRequestEntries(RequestEntriesT&& value) {
    m_requestEntriesHasBeenSet = true;
    m_requestEntries = std::forward<RequestEntriesT>(value);
  }
  template <typename RequestEntriesT = Aws::Vector<UpdateRecommendationStatusRequestEntry>>
  BatchUpdateRecommendationStatusRequest& WithRequestEntries(RequestEntriesT&& value) {
    SetRequestEntries(std::forward<RequestEntriesT>(value));
    return *this;
  }
  template <typename RequestEntriesT = UpdateRecommendationStatusRequestEntry>
  BatchUpdateRecommendationStatusRequest& AddRequestEntries(RequestEntriesT&& value) {
    m_requestEntriesHasBeenSet = true;
    m_requestEntries.emplace_back(std::forward<RequestEntriesT>(value));
    return *this;
  }
  ///@}
 private:
