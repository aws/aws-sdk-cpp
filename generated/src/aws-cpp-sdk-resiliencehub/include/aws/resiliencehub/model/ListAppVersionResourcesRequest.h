...
class ListAppVersionResourcesRequest : public ResilienceHubRequest {
 public:
  ...
  template <typename AppArnT = Aws::String>
  ListAppVersionResourcesRequest& WithAppArn(AppArnT&& value) {
  ...
  template <typename AppVersionT = Aws::String>
  ListAppVersionResourcesRequest& WithAppVersion(AppVersionT&& value) {
  ...
  inline ListAppVersionResourcesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAppVersionResourcesRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResolutionIdT = Aws::String>
  ListAppVersionResourcesRequest& WithResolutionId(ResolutionIdT&& value) {
