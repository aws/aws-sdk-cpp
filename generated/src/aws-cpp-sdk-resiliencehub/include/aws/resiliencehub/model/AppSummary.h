...
class AppSummary {
 public:
  ...
  inline AppSummary& WithAssessmentSchedule(AppAssessmentScheduleType value) {
  ...
  inline AppSummary& WithComplianceStatus(AppComplianceStatusType value) {
  ...
  inline AppSummary& WithDriftStatus(AppDriftStatusType value) {
  ...
  inline AppSummary& WithResiliencyScore(double value) {
  ...
  inline AppSummary& WithRpoInSecs(int value) {
    SetRpoInSecs(value);
    return *this;
  }
  ///@}
  ...
  inline AppSummary& WithRtoInSecs(int value) {
    SetRtoInSecs(value);
    return *this;
  }
  ///@}
  ...
  inline AppSummary& WithStatus(AppStatusType value) {
    SetStatus(value);
    return *this;
  }
  ///@}
