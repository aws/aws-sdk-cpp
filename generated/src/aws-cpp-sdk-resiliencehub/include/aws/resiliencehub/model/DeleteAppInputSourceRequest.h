...
class DeleteAppInputSourceRequest : public ResilienceHubRequest {
 public:
  ...
  template <typename AppArnT = Aws::String>
  DeleteAppInputSourceRequest& WithAppArn(AppArnT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  DeleteAppInputSourceRequest& WithClientToken(ClientTokenT&& value) {
  ...
  void SetEksSourceClusterNamespace(EksSourceClusterNamespaceT&& value) {
    ...
    m_eksSourceClusterNamespace = std::forward<EksSourceClusterNamespaceT>(value);
  }
  template <typename EksSourceClusterNamespaceT = EksSourceClusterNamespace>
  DeleteAppInputSourceRequest& WithEksSourceClusterNamespace(EksSourceClusterNamespaceT&& value) {
    SetEksSourceClusterNamespace(std::forward<EksSourceClusterNamespaceT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename SourceArnT = Aws::String>
  DeleteAppInputSourceRequest& WithSourceArn(SourceArnT&& value) {
  ...
  void SetTerraformSource(TerraformSourceT&& value) {
    ...
    m_terraformSource = std::forward<TerraformSourceT>(value);
  }
  template <typename TerraformSourceT = TerraformSource>
  DeleteAppInputSourceRequest& WithTerraformSource(TerraformSourceT&& value) {
    SetTerraformSource(std::forward<TerraformSourceT>(value));
    return *this;
  }
  ///@}
 private:
