...
namespace Model
{
  ...
  public:
    ...
    template<typename AdditionalInfoT = Aws::Map<Aws::String, Aws::Vector<Aws::String>>>
    CreateAppVersionResourceRequest& WithAdditionalInfo(AdditionalInfoT&& value) { SetAdditionalInfo(std::forward<AdditionalInfoT>(value)); return *this;}
    ...
    template<typename AppArnT = Aws::String>
    CreateAppVersionResourceRequest& WithAppArn(AppArnT&& value) { SetAppArn(std::forward<AppArnT>(value)); return *this;}
    ///@}
    ...
    template<typename AppComponentsT = Aws::Vector<Aws::String>>
    CreateAppVersionResourceRequest& WithAppComponents(AppComponentsT&& value) { SetAppComponents(std::forward<AppComponentsT>(value)); return *this;}
    template<typename AppComponentsT = Aws::String>
    CreateAppVersionResourceRequest& AddAppComponents(AppComponentsT&& value) { m_appComponentsHasBeenSet = true; m_appComponents.emplace_back(std::forward<AppComponentsT>(value)); return *this; }
    ///@}
    ...
    template<typename AwsAccountIdT = Aws::String>
    CreateAppVersionResourceRequest& WithAwsAccountId(AwsAccountIdT&& value) { SetAwsAccountId(std::forward<AwsAccountIdT>(value)); return *this;}
    ///@}
    ...
    template<typename AwsRegionT = Aws::String>
    CreateAppVersionResourceRequest& WithAwsRegion(AwsRegionT&& value) { SetAwsRegion(std::forward<AwsRegionT>(value)); return *this;}
    ///@}
    ...
    template<typename ClientTokenT = Aws::String>
    CreateAppVersionResourceRequest& WithClientToken(ClientTokenT&& value) { SetClientToken(std::forward<ClientTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename LogicalResourceIdT = LogicalResourceId>
    CreateAppVersionResourceRequest& WithLogicalResourceId(LogicalResourceIdT&& value) { SetLogicalResourceId(std::forward<LogicalResourceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename PhysicalResourceIdT = Aws::String>
    CreateAppVersionResourceRequest& WithPhysicalResourceId(PhysicalResourceIdT&& value) { SetPhysicalResourceId(std::forward<PhysicalResourceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ResourceNameT = Aws::String>
    CreateAppVersionResourceRequest& WithResourceName(ResourceNameT&& value) { SetResourceName(std::forward<ResourceNameT>(value)); return *this;}
    ///@}
    ...
    template<typename ResourceTypeT = Aws::String>
    CreateAppVersionResourceRequest& WithResourceType(ResourceTypeT&& value) { SetResourceType(std::forward<ResourceTypeT>(value)); return *this;}
    ///@}
  private:
