...
class PhysicalResource {
 public:
  ...
  inline PhysicalResource& WithExcluded(bool value) {
    SetExcluded(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSourceType(ResourceSourceType value) {
    m_sourceTypeHasBeenSet = true;
    m_sourceType = value;
  }
  inline PhysicalResource& WithSourceType(ResourceSourceType value) {
    SetSourceType(value);
    return *this;
  }
  ///@}
