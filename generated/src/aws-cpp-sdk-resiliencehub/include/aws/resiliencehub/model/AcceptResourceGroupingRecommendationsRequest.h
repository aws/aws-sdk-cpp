...
class AcceptResourceGroupingRecommendationsRequest : public ResilienceHubRequest {
 public:
  ...
  template <typename AppArnT = Aws::String>
  AcceptResourceGroupingRecommendationsRequest& WithAppArn(AppArnT&& value) {
  ...
  template <typename EntriesT = Aws::Vector<AcceptGroupingRecommendationEntry>>
  AcceptResourceGroupingRecommendationsRequest& WithEntries(EntriesT&& value) {
    SetEntries(std::forward<EntriesT>(value));
    return *this;
  }
  template <typename EntriesT = AcceptGroupingRecommendationEntry>
  AcceptResourceGroupingRecommendationsRequest& AddEntries(EntriesT&& value) {
    m_entriesHasBeenSet = true;
