...
class ListAppComponentCompliancesRequest : public ResilienceHubRequest {
 public:
  ...
  template <typename AssessmentArnT = Aws::String>
  ListAppComponentCompliancesRequest& WithAssessmentArn(AssessmentArnT&& value) {
  ...
  inline ListAppComponentCompliancesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAppComponentCompliancesRequest& WithNextToken(NextTokenT&& value) {
