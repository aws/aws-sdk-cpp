...
class AssessmentSummary {
 public:
  ...
  void SetRiskRecommendations(RiskRecommendationsT&& value) {
    m_riskRecommendationsHasBeenSet = true;
    m_riskRecommendations = std::forward<RiskRecommendationsT>(value);
  }
  template <typename RiskRecommendationsT = Aws::Vector<AssessmentRiskRecommendation>>
  AssessmentSummary& WithRiskRecommendations(RiskRecommendationsT&& value) {
    SetRiskRecommendations(std::forward<RiskRecommendationsT>(value));
    return *this;
  }
  template <typename RiskRecommendationsT = AssessmentRiskRecommendation>
  AssessmentSummary& AddRiskRecommendations(RiskRecommendationsT&& value) {
    m_riskRecommendationsHasBeenSet = true;
    m_riskRecommendations.emplace_back(std::forward<RiskRecommendationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename SummaryT = Aws::String>
  AssessmentSummary& WithSummary(SummaryT&& value) {
