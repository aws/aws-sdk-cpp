...
namespace Model
{
  ...
  public:
    ...
    template<typename AppArnT = Aws::String>
    StartAppAssessmentRequest& WithAppArn(AppArnT&& value) { SetAppArn(std::forward<AppArnT>(value)); return *this;}
    ///@}
    ...
    template<typename AppVersionT = Aws::String>
    StartAppAssessmentRequest& WithAppVersion(AppVersionT&& value) { SetAppVersion(std::forward<AppVersionT>(value)); return *this;}
    ///@}
    ...
    template<typename AssessmentNameT = Aws::String>
    StartAppAssessmentRequest& WithAssessmentName(AssessmentNameT&& value) { SetAssessmentName(std::forward<AssessmentNameT>(value)); return *this;}
    ///@}
    ...
    template<typename ClientTokenT = Aws::String>
    StartAppAssessmentRequest& WithClientToken(ClientTokenT&& value) { SetClientToken(std::forward<ClientTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename TagsT = Aws::Map<Aws::String, Aws::String>>
    StartAppAssessmentRequest& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
