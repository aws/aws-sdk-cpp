...
namespace Model
{
  ...
  {
  public:
    AWS_RESILIENCEHUB_API DeleteAppVersionAppComponentResult() = default;
    ...
    template<typename AppArnT = Aws::String>
    DeleteAppVersionAppComponentResult& WithAppArn(AppArnT&& value) { SetAppArn(std::forward<AppArnT>(value)); return *this;}
    ///@}
    ...
    void SetAppComponent(AppComponentT&& value) { m_appComponentHasBeenSet = true; m_appComponent = std::forward<AppComponentT>(value); }
    template<typename AppComponentT = AppComponent>
    DeleteAppVersionAppComponentResult& WithAppComponent(AppComponentT&& value) { SetAppComponent(std::forward<AppComponentT>(value)); return *this;}
    ///@}
    ...
    template<typename AppVersionT = Aws::String>
    DeleteAppVersionAppComponentResult& WithAppVersion(AppVersionT&& value) { SetAppVersion(std::forward<AppVersionT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DeleteAppVersionAppComponentResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
