...
class ListResiliencyPoliciesRequest : public ResilienceHubRequest {
 public:
  ...
  inline ListResiliencyPoliciesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListResiliencyPoliciesRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename PolicyNameT = Aws::String>
  ListResiliencyPoliciesRequest& WithPolicyName(PolicyNameT&& value) {
