...
class BatchUpdateRecommendationStatusSuccessfulEntry {
 public:
  ...
  inline BatchUpdateRecommendationStatusSuccessfulEntry& WithExcludeReason(ExcludeRecommendationReason value) {
  ...
  inline BatchUpdateRecommendationStatusSuccessfulEntry& WithExcluded(bool value) {
    SetExcluded(value);
    return *this;
  }
  ///@}
