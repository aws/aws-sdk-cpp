...
class ListAppAssessmentResourceDriftsRequest : public ResilienceHubRequest {
 public:
  ...
  template <typename AssessmentArnT = Aws::String>
  ListAppAssessmentResourceDriftsRequest& WithAssessmentArn(AssessmentArnT&& value) {
  ...
  inline ListAppAssessmentResourceDriftsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAppAssessmentResourceDriftsRequest& WithNextToken(NextTokenT&& value) {
