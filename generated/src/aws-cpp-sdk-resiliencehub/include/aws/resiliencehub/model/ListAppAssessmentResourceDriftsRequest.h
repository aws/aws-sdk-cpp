...
namespace Model
{
  ...
  {
  public:
    AWS_RESILIENCEHUB_API ListAppAssessmentResourceDriftsRequest();
     ...
     * <p>Null, or the token from a previous call to get the next set of results.</p>
     */
    inline ListAppAssessmentResourceDriftsRequest& WithNextToken(const char* value) { SetNextToken(value); return *this;}
