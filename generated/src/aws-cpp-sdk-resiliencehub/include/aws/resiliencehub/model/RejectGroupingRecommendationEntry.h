...
class RejectGroupingRecommendationEntry {
 public:
  ...
  inline void SetRejectionReason(GroupingRecommendationRejectionReason value) {
    m_rejectionReasonHasBeenSet = true;
    m_rejectionReason = value;
  }
  inline RejectGroupingRecommendationEntry& WithRejectionReason(GroupingRecommendationRejectionReason value) {
