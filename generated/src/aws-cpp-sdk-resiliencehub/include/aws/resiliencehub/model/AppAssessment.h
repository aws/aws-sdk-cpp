...
class AppAssessment {
 public:
  ...
  inline AppAssessment& WithAssessmentStatus(AssessmentStatus value) {
  ...
  inline void SetComplianceStatus(ComplianceStatus value) {
    m_complianceStatusHasBeenSet = true;
    m_complianceStatus = value;
  }
  inline AppAssessment& WithComplianceStatus(ComplianceStatus value) {
  ...
  inline void SetDriftStatus(DriftStatus value) {
    m_driftStatusHasBeenSet = true;
    m_driftStatus = value;
  }
  inline AppAssessment& WithDriftStatus(DriftStatus value) {
  ...
  inline void SetInvoker(AssessmentInvoker value) {
    m_invokerHasBeenSet = true;
    m_invoker = value;
  }
  inline AppAssessment& WithInvoker(AssessmentInvoker value) {
    SetInvoker(value);
    return *this;
  }
  ///@}
  ...
  void SetResourceErrorsDetails(ResourceErrorsDetailsT&& value) {
    ...
    m_resourceErrorsDetails = std::forward<ResourceErrorsDetailsT>(value);
  }
  template <typename ResourceErrorsDetailsT = ResourceErrorsDetails>
  AppAssessment& WithResourceErrorsDetails(ResourceErrorsDetailsT&& value) {
    SetResourceErrorsDetails(std::forward<ResourceErrorsDetailsT>(value));
    return *this;
  }
  ///@}
