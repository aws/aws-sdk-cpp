...
class ScoringComponentResiliencyScore {
 public:
  ...
  inline ScoringComponentResiliencyScore& WithExcludedCount(long long value) {
  ...
  inline void SetOutstandingCount(long long value) {
    m_outstandingCountHasBeenSet = true;
    m_outstandingCount = value;
  }
  inline ScoringComponentResiliencyScore& WithOutstandingCount(long long value) {
    SetOutstandingCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPossibleScore(double value) {
    m_possibleScoreHasBeenSet = true;
    m_possibleScore = value;
  }
  inline ScoringComponentResiliencyScore& WithPossibleScore(double value) {
    SetPossibleScore(value);
    return *this;
  }
  ///@}
  ...
  inline ScoringComponentResiliencyScore& WithScore(double value) {
    SetScore(value);
    return *this;
  }
  ///@}
