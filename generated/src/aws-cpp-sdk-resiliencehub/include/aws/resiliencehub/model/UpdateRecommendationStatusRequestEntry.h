...
class UpdateRecommendationStatusRequestEntry {
 public:
  ...
  inline UpdateRecommendationStatusRequestEntry& WithExcludeReason(ExcludeRecommendationReason value) {
  ...
  inline UpdateRecommendationStatusRequestEntry& WithExcluded(bool value) {
    SetExcluded(value);
    return *this;
  }
  ///@}
