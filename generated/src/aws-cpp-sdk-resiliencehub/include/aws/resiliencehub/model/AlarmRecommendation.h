...
class AlarmRecommendation {
 public:
  ...
  void SetAppComponentNames(AppComponentNamesT&& value) {
    ...
    m_appComponentNames = std::forward<AppComponentNamesT>(value);
  }
  template <typename AppComponentNamesT = Aws::Vector<Aws::String>>
  AlarmRecommendation& WithAppComponentNames(AppComponentNamesT&& value) {
    SetAppComponentNames(std::forward<AppComponentNamesT>(value));
    return *this;
  }
  template <typename AppComponentNamesT = Aws::String>
  AlarmRecommendation& AddAppComponentNames(AppComponentNamesT&& value) {
    m_appComponentNamesHasBeenSet = true;
    m_appComponentNames.emplace_back(std::forward<AppComponentNamesT>(value));
    return *this;
  }
  ///@}
  ...
  inline AlarmRecommendation& WithRecommendationStatus(RecommendationStatus value) {
  ...
  inline void SetType(AlarmType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline AlarmRecommendation& WithType(AlarmType value) {
    SetType(value);
    return *this;
  }
  ///@}
