...
class ListSopRecommendationsRequest : public ResilienceHubRequest {
 public:
  ...
  template <typename AssessmentArnT = Aws::String>
  ListSopRecommendationsRequest& WithAssessmentArn(AssessmentArnT&& value) {
  ...
  inline ListSopRecommendationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListSopRecommendationsRequest& WithNextToken(NextTokenT&& value) {
