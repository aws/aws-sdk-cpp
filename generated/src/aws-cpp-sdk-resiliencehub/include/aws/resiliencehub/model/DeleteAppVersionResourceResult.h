...
class DeleteAppVersionResourceResult {
 public:
  ...
  template <typename AppArnT = Aws::String>
  DeleteAppVersionResourceResult& WithAppArn(AppArnT&& value) {
  ...
  template <typename AppVersionT = Aws::String>
  DeleteAppVersionResourceResult& WithAppVersion(AppVersionT&& value) {
  ...
  void SetPhysicalResource(PhysicalResourceT&& value) {
    m_physicalResourceHasBeenSet = true;
    m_physicalResource = std::forward<PhysicalResourceT>(value);
  }
  template <typename PhysicalResourceT = PhysicalResource>
  DeleteAppVersionResourceResult& WithPhysicalResource(PhysicalResourceT&& value) {
    SetPhysicalResource(std::forward<PhysicalResourceT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DeleteAppVersionResourceResult& WithRequestId(RequestIdT&& value) {
