...
class FailedGroupingRecommendationEntry {
 public:
  ...
  template <typename ErrorMessageT = Aws::String>
  FailedGroupingRecommendationEntry& WithErrorMessage(ErrorMessageT&& value) {
  ...
  template <typename GroupingRecommendationIdT = Aws::String>
  FailedGroupingRecommendationEntry& WithGroupingRecommendationId(GroupingRecommendationIdT&& value) {
