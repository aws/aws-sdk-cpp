...
namespace Model
{
  ...
  {
  public:
    AWS_RESILIENCEHUB_API AcceptResourceGroupingRecommendationsResult() = default;
    ...
    template<typename AppArnT = Aws::String>
    AcceptResourceGroupingRecommendationsResult& WithAppArn(AppArnT&& value) { SetAppArn(std::forward<AppArnT>(value)); return *this;}
    ///@}
    ...
    template<typename FailedEntriesT = Aws::Vector<FailedGroupingRecommendationEntry>>
    AcceptResourceGroupingRecommendationsResult& WithFailedEntries(FailedEntriesT&& value) { SetFailedEntries(std::forward<FailedEntriesT>(value)); return *this;}
    template<typename FailedEntriesT = FailedGroupingRecommendationEntry>
    AcceptResourceGroupingRecommendationsResult& AddFailedEntries(FailedEntriesT&& value) { m_failedEntriesHasBeenSet = true; m_failedEntries.emplace_back(std::forward<FailedEntriesT>(value)); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    AcceptResourceGroupingRecommendationsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
