...
class AppAssessmentSummary {
 public:
  ...
  inline AppAssessmentSummary& WithAssessmentStatus(AssessmentStatus value) {
  ...
  inline AppAssessmentSummary& WithComplianceStatus(ComplianceStatus value) {
  ...
  inline AppAssessmentSummary& WithDriftStatus(DriftStatus value) {
  ...
  inline AppAssessmentSummary& WithInvoker(AssessmentInvoker value) {
    SetInvoker(value);
    return *this;
  }
  ///@}
  ...
  inline AppAssessmentSummary& WithResiliencyScore(double value) {
