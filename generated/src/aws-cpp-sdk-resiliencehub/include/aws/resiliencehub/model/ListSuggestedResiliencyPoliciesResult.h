...
class ListSuggestedResiliencyPoliciesResult {
 public:
  AWS_RESILIENCEHUB_API ListSuggestedResiliencyPoliciesResult() = default;
  ...
  AWS_RESILIENCEHUB_API ListSuggestedResiliencyPoliciesResult& operator=(
  ...
  template <typename NextTokenT = Aws::String>
  ListSuggestedResiliencyPoliciesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResiliencyPoliciesT = Aws::Vector<ResiliencyPolicy>>
  ListSuggestedResiliencyPoliciesResult& WithResiliencyPolicies(ResiliencyPoliciesT&& value) {
    SetResiliencyPolicies(std::forward<ResiliencyPoliciesT>(value));
    return *this;
  }
  template <typename ResiliencyPoliciesT = ResiliencyPolicy>
  ListSuggestedResiliencyPoliciesResult& AddResiliencyPolicies(ResiliencyPoliciesT&& value) {
    m_resiliencyPoliciesHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListSuggestedResiliencyPoliciesResult& WithRequestId(RequestIdT&& value) {
