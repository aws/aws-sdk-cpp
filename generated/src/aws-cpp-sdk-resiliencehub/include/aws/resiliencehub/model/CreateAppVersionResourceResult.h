...
namespace Model
{
  ...
  public:
    ...
    template<typename AppArnT = Aws::String>
    CreateAppVersionResourceResult& WithAppArn(AppArnT&& value) { SetAppArn(std::forward<AppArnT>(value)); return *this;}
    ///@}
    ...
    template<typename AppVersionT = Aws::String>
    CreateAppVersionResourceResult& WithAppVersion(AppVersionT&& value) { SetAppVersion(std::forward<AppVersionT>(value)); return *this;}
    ///@}
    ...
    template<typename PhysicalResourceT = PhysicalResource>
    CreateAppVersionResourceResult& WithPhysicalResource(PhysicalResourceT&& value) { SetPhysicalResource(std::forward<PhysicalResourceT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateAppVersionResourceResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
