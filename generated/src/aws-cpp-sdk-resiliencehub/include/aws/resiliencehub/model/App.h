...
class App {
 public:
  ...
  inline App& WithAssessmentSchedule(AppAssessmentScheduleType value) {
  ...
  inline void SetComplianceStatus(AppComplianceStatusType value) {
    m_complianceStatusHasBeenSet = true;
    m_complianceStatus = value;
  }
  inline App& WithComplianceStatus(AppComplianceStatusType value) {
  ...
  inline void SetDriftStatus(AppDriftStatusType value) {
    m_driftStatusHasBeenSet = true;
    m_driftStatus = value;
  }
  inline App& WithDriftStatus(AppDriftStatusType value) {
    SetDriftStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetLastAppComplianceEvaluationTime(LastAppComplianceEvaluationTimeT&& value) {
    ...
    m_lastAppComplianceEvaluationTime = std::forward<LastAppComplianceEvaluationTimeT>(value);
  }
  template <typename LastAppComplianceEvaluationTimeT = Aws::Utils::DateTime>
  App& WithLastAppComplianceEvaluationTime(LastAppComplianceEvaluationTimeT&& value) {
    SetLastAppComplianceEvaluationTime(std::forward<LastAppComplianceEvaluationTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastDriftEvaluationTime(LastDriftEvaluationTimeT&& value) {
    ...
    m_lastDriftEvaluationTime = std::forward<LastDriftEvaluationTimeT>(value);
  }
  template <typename LastDriftEvaluationTimeT = Aws::Utils::DateTime>
  App& WithLastDriftEvaluationTime(LastDriftEvaluationTimeT&& value) {
    SetLastDriftEvaluationTime(std::forward<LastDriftEvaluationTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastResiliencyScoreEvaluationTime(LastResiliencyScoreEvaluationTimeT&& value) {
    ...
    m_lastResiliencyScoreEvaluationTime = std::forward<LastResiliencyScoreEvaluationTimeT>(value);
  }
  template <typename LastResiliencyScoreEvaluationTimeT = Aws::Utils::DateTime>
  App& WithLastResiliencyScoreEvaluationTime(LastResiliencyScoreEvaluationTimeT&& value) {
    SetLastResiliencyScoreEvaluationTime(std::forward<LastResiliencyScoreEvaluationTimeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetResiliencyScore(double value) {
    m_resiliencyScoreHasBeenSet = true;
    m_resiliencyScore = value;
  }
  inline App& WithResiliencyScore(double value) {
    SetResiliencyScore(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRpoInSecs(int value) {
    m_rpoInSecsHasBeenSet = true;
    m_rpoInSecs = value;
  }
  inline App& WithRpoInSecs(int value) {
    SetRpoInSecs(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRtoInSecs(int value) {
    m_rtoInSecsHasBeenSet = true;
    m_rtoInSecs = value;
  }
  inline App& WithRtoInSecs(int value) {
    SetRtoInSecs(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(AppStatusType value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline App& WithStatus(AppStatusType value) {
    SetStatus(value);
    return *this;
  }
  ///@}
