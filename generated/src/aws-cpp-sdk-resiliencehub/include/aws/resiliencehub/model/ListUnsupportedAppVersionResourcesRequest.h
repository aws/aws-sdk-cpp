...
class ListUnsupportedAppVersionResourcesRequest : public ResilienceHubRequest {
 public:
  ...
  template <typename AppArnT = Aws::String>
  ListUnsupportedAppVersionResourcesRequest& WithAppArn(AppArnT&& value) {
  ...
  template <typename AppVersionT = Aws::String>
  ListUnsupportedAppVersionResourcesRequest& WithAppVersion(AppVersionT&& value) {
  ...
  inline ListUnsupportedAppVersionResourcesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListUnsupportedAppVersionResourcesRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResolutionIdT = Aws::String>
  ListUnsupportedAppVersionResourcesRequest& WithResolutionId(ResolutionIdT&& value) {
