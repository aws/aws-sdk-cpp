...
ExpiredTokenException::ExpiredTokenException(JsonView jsonValue) { *this = jsonValue; }

ExpiredTokenException& ExpiredTokenException::operator=(JsonView jsonValue) {
...
JsonValue ExpiredTokenException::Jsonize() const {
  JsonValue payload;
