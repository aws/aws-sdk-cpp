...
'"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','o','i','d','c','-','f','i','p','s','.',
...
't','t','p','s',':','/','/','o','i','d','c','.','{','R','e','g','i','o','n','}','.','{','P','a','r',
...
const char* SSOOIDCEndpointRules::GetRulesBlob()
{
