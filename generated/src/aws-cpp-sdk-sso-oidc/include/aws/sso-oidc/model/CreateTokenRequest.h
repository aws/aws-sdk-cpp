...
class CreateTokenRequest : public SSOOIDCRequest {
 public:
  ...
  template <typename ClientIdT = Aws::String>
  CreateTokenRequest& WithClientId(ClientIdT&& value) {
  ...
  template <typename ClientSecretT = Aws::String>
  CreateTokenRequest& WithClientSecret(ClientSecretT&& value) {
  ...
  template <typename GrantTypeT = Aws::String>
  CreateTokenRequest& WithGrantType(GrantTypeT&& value) {
  ...
  template <typename DeviceCodeT = Aws::String>
  CreateTokenRequest& WithDeviceCode(DeviceCodeT&& value) {
  ...
  template <typename CodeT = Aws::String>
  CreateTokenRequest& WithCode(CodeT&& value) {
  ...
  template <typename RefreshTokenT = Aws::String>
  CreateTokenRequest& WithRefreshToken(RefreshTokenT&& value) {
  ...
  template <typename ScopeT = Aws::Vector<Aws::String>>
  CreateTokenRequest& WithScope(ScopeT&& value) {
    SetScope(std::forward<ScopeT>(value));
    return *this;
  }
  template <typename ScopeT = Aws::String>
  CreateTokenRequest& AddScope(ScopeT&& value) {
    m_scopeHasBeenSet = true;
  ...
  template <typename RedirectUriT = Aws::String>
  CreateTokenRequest& WithRedirectUri(RedirectUriT&& value) {
  ...
  template <typename CodeVerifierT = Aws::String>
  CreateTokenRequest& WithCodeVerifier(CodeVerifierT&& value) {
