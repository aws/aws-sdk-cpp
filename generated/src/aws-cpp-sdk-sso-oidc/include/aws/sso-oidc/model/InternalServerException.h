...
namespace Model
{
  ...
  {
  public:
    AWS_SSOOIDC_API InternalServerException() = default;
    ...
    template<typename Error_descriptionT = Aws::String>
    InternalServerException& WithError_description(Error_descriptionT&& value) { SetError_description(std::forward<Error_descriptionT>(value)); return *this;}
    ///@}
  private:
