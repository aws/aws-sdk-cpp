...
class CreateTokenResult {
 public:
  ...
  template <typename AccessTokenT = Aws::String>
  CreateTokenResult& WithAccessToken(AccessTokenT&& value) {
  ...
  template <typename TokenTypeT = Aws::String>
  CreateTokenResult& WithTokenType(TokenTypeT&& value) {
  ...
  inline CreateTokenResult& WithExpiresIn(int value) {
    SetExpiresIn(value);
    return *this;
  }
  ///@}
  ...
  template <typename RefreshTokenT = Aws::String>
  CreateTokenResult& WithRefreshToken(RefreshTokenT&& value) {
  ...
  template <typename IdTokenT = Aws::String>
  CreateTokenResult& WithIdToken(IdTokenT&& value) {
