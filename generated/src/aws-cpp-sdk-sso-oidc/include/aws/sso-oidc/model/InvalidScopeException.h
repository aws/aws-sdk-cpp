...
class InvalidScopeException {
 public:
  AWS_SSOOIDC_API InvalidScopeException() = default;
  ...
  template <typename ErrorT = Aws::String>
  InvalidScopeException& WithError(ErrorT&& value) {
  ...
  template <typename Error_descriptionT = Aws::String>
  InvalidScopeException& WithError_description(Error_descriptionT&& value) {
