...
class InvalidRequestRegionException {
 public:
  ...
  template <typename ErrorT = Aws::String>
  InvalidRequestRegionException& WithError(ErrorT&& value) {
  ...
  template <typename Error_descriptionT = Aws::String>
  InvalidRequestRegionException& WithError_description(Error_descriptionT&& value) {
  ...
  template <typename EndpointT = Aws::String>
  InvalidRequestRegionException& WithEndpoint(EndpointT&& value) {
  ...
  template <typename RegionT = Aws::String>
  InvalidRequestRegionException& WithRegion(RegionT&& value) {
