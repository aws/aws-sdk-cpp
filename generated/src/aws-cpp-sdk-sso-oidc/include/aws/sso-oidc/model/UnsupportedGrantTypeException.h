...
class UnsupportedGrantTypeException {
 public:
  AWS_SSOOIDC_API UnsupportedGrantTypeException() = default;
  AWS_SSOOIDC_API UnsupportedGrantTypeException(Aws::Utils::Json::JsonView jsonValue);
  AWS_SSOOIDC_API UnsupportedGrantTypeException& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename ErrorT = Aws::String>
  UnsupportedGrantTypeException& WithError(ErrorT&& value) {
  ...
  void SetError_description(Error_descriptionT&& value) {
    m_error_descriptionHasBeenSet = true;
    m_error_description = std::forward<Error_descriptionT>(value);
  }
  template <typename Error_descriptionT = Aws::String>
  UnsupportedGrantTypeException& WithError_description(Error_descriptionT&& value) {
    SetError_description(std::forward<Error_descriptionT>(value));
    return *this;
  }
  ///@}
 private:
