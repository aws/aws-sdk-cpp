...
namespace Model
{
  ...
  public:
    ...
    template<typename ErrorT = Aws::String>
    UnsupportedGrantTypeException& WithError(ErrorT&& value) { SetError(std::forward<ErrorT>(value)); return *this;}
    ///@}
    ...
    template<typename Error_descriptionT = Aws::String>
    UnsupportedGrantTypeException& WithError_description(Error_descriptionT&& value) { SetError_description(std::forward<Error_descriptionT>(value)); return *this;}
    ///@}
  private:
