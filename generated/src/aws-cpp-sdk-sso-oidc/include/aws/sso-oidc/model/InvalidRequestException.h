...
class InvalidRequestException {
 public:
  ...
  template <typename ErrorT = Aws::String>
  InvalidRequestException& WithError(ErrorT&& value) {
  ...
  inline void SetReason(InvalidRequestExceptionReason value) {
    m_reasonHasBeenSet = true;
    m_reason = value;
  }
  inline InvalidRequestException& WithReason(InvalidRequestExceptionReason value) {
    SetReason(value);
    return *this;
  }
  ///@}
  ...
  template <typename Error_descriptionT = Aws::String>
  InvalidRequestException& WithError_description(Error_descriptionT&& value) {
