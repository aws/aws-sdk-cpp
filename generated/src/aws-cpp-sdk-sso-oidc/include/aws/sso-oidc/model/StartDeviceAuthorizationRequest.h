...
class StartDeviceAuthorizationRequest : public SSOOIDCRequest {
 public:
  ...
  template <typename ClientIdT = Aws::String>
  StartDeviceAuthorizationRequest& WithClientId(ClientIdT&& value) {
  ...
  template <typename ClientSecretT = Aws::String>
  StartDeviceAuthorizationRequest& WithClientSecret(ClientSecretT&& value) {
  ...
  void SetStartUrl(StartUrlT&& value) {
    ...
    m_startUrl = std::forward<StartUrlT>(value);
  }
  template <typename StartUrlT = Aws::String>
  StartDeviceAuthorizationRequest& WithStartUrl(StartUrlT&& value) {
    SetStartUrl(std::forward<StartUrlT>(value));
    return *this;
  }
  ///@}
 private:
