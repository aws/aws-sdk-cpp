...
namespace Model
{
  ...
  /**
   * <p>Indicates that one or more redirect URI in the request is not supported for
   * this operation.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/sso-oidc-2019-06-10/InvalidRedirectUriException">AWS
   * API Reference</a></p>
   */
  class InvalidRedirectUriException
  {
  public:
    AWS_SSOOIDC_API InvalidRedirectUriException() = default;
    ...
    template<typename ErrorT = Aws::String>
    InvalidRedirectUriException& WithError(ErrorT&& value) { SetError(std::forward<ErrorT>(value)); return *this;}
    ///@}
    ...
    template<typename Error_descriptionT = Aws::String>
    InvalidRedirectUriException& WithError_description(Error_descriptionT&& value) { SetError_description(std::forward<Error_descriptionT>(value)); return *this;}
    ///@}
  private:
