...
IoTFleetHubClient::IoTFleetHubClient(const AWSCredentials& credentials, std::shared_ptr<IoTFleetHubEndpointProviderBase> endpointProvider,
                                     const IoTFleetHub::IoTFleetHubClientConfiguration& clientConfiguration)
    : BASECLASS(clientConfiguration,
...
IoTFleetHubClient::IoTFleetHubClient(const Client::ClientConfiguration& clientConfiguration)
    : BASECLASS(clientConfiguration,
                ...
                Aws::MakeShared<IoTFleetHubErrorMarshaller>(ALLOCATION_TAG)),
      m_clientConfiguration(clientConfiguration),
      m_endpointProvider(Aws::MakeShared<IoTFleetHubEndpointProvider>(ALLOCATION_TAG)) {
  init(m_clientConfiguration);
}
...
IoTFleetHubClient::~IoTFleetHubClient() { ShutdownSdkClient(this, -1); }

std::shared_ptr<IoTFleetHubEndpointProviderBase>& IoTFleetHubClient::accessEndpointProvider() { return m_endpointProvider; }

void IoTFleetHubClient::init(const IoTFleetHub::IoTFleetHubClientConfiguration& config) {
...
DeleteApplicationOutcome IoTFleetHubClient::DeleteApplication(const DeleteApplicationRequest& request) const {
  ...
  if (!request.ApplicationIdHasBeenSet()) {
    ...
    return DeleteApplicationOutcome(Aws::Client::AWSError<IoTFleetHubErrors>(IoTFleetHubErrors::MISSING_PARAMETER, "MISSING_PARAMETER",
...
DescribeApplicationOutcome IoTFleetHubClient::DescribeApplication(const DescribeApplicationRequest& request) const {
  ...
  if (!request.ApplicationIdHasBeenSet()) {
    ...
    return DescribeApplicationOutcome(Aws::Client::AWSError<IoTFleetHubErrors>(IoTFleetHubErrors::MISSING_PARAMETER, "MISSING_PARAMETER",
                                                                               "Missing required field [ApplicationId]", false));
  }
...
ListTagsForResourceOutcome IoTFleetHubClient::ListTagsForResource(const ListTagsForResourceRequest& request) const {
  ...
  if (!request.ResourceArnHasBeenSet()) {
    ...
    return ListTagsForResourceOutcome(Aws::Client::AWSError<IoTFleetHubErrors>(IoTFleetHubErrors::MISSING_PARAMETER, "MISSING_PARAMETER",
...
TagResourceOutcome IoTFleetHubClient::TagResource(const TagResourceRequest& request) const {
  ...
  if (!request.ResourceArnHasBeenSet()) {
    ...
    return TagResourceOutcome(Aws::Client::AWSError<IoTFleetHubErrors>(IoTFleetHubErrors::MISSING_PARAMETER, "MISSING_PARAMETER",
                                                                       "Missing required field [ResourceArn]", false));
  }
...
UntagResourceOutcome IoTFleetHubClient::UntagResource(const UntagResourceRequest& request) const {
  ...
  if (!request.ResourceArnHasBeenSet()) {
    ...
    return UntagResourceOutcome(Aws::Client::AWSError<IoTFleetHubErrors>(IoTFleetHubErrors::MISSING_PARAMETER, "MISSING_PARAMETER",
                                                                         "Missing required field [ResourceArn]", false));
  }
...
UpdateApplicationOutcome IoTFleetHubClient::UpdateApplication(const UpdateApplicationRequest& request) const {
  ...
  if (!request.ApplicationIdHasBeenSet()) {
    ...
    return UpdateApplicationOutcome(Aws::Client::AWSError<IoTFleetHubErrors>(IoTFleetHubErrors::MISSING_PARAMETER, "MISSING_PARAMETER",
                                                                             "Missing required field [ApplicationId]", false));
  }
