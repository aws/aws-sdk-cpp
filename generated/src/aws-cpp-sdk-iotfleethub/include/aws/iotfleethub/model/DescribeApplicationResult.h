...
class DescribeApplicationResult {
 public:
  ...
  inline DescribeApplicationResult& WithApplicationState(ApplicationState value) {
  ...
  inline DescribeApplicationResult& WithApplicationCreationDate(long long value) {
  ...
  inline DescribeApplicationResult& WithApplicationLastUpdateDate(long long value) {
  ...
  void SetSsoClientId(SsoClientIdT&& value) {
    ...
    m_ssoClientId = std::forward<SsoClientIdT>(value);
  }
  template <typename SsoClientIdT = Aws::String>
  DescribeApplicationResult& WithSsoClientId(SsoClientIdT&& value) {
    SetSsoClientId(std::forward<SsoClientIdT>(value));
    return *this;
  }
  ///@}
