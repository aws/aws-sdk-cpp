...
namespace Model
{
  ...
  {
  public:
    AWS_IOTFLEETHUB_API ListTagsForResourceResult() = default;
    AWS_IOTFLEETHUB_API ListTagsForResourceResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_IOTFLEETHUB_API ListTagsForResourceResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
