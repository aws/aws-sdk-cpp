...
DescribeAttachmentUploadStatusResult::DescribeAttachmentUploadStatusResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

DescribeAttachmentUploadStatusResult& DescribeAttachmentUploadStatusResult::operator=(
  ...
  if (jsonValue.ValueExists("uploadProgress")) {
    m_uploadProgress = jsonValue.GetObject("uploadProgress");
