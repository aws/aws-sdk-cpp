...
namespace Support
{
const size_t SupportEndpointRules::RulesBlobStrLen = 5886;
const size_t SupportEndpointRules::RulesBlobSize = 5887;
...
'"','h','t','t','p','s',':','/','/','s','u','p','p','o','r','t','.','u','s','-','e','a','s','t','-',
...
'a','m','e','"',':','"','s','u','p','p','o','r','t','"',',','"','s','i','g','n','i','n','g','R','e',
...
'/','/','s','u','p','p','o','r','t','.','u','s','-','i','s','o','-','e','a','s','t','-','1','.','c',
...
'-','e','a','s','t','-','1','.','s','c','2','s','.','s','g','o','v','.','g','o','v','"',',','"','p',
...
'u','l','e','s','"',':','[','{','"','c','o','n','d','i','t','i','o','n','s','"',':','[',']',',','"',
'e','n','d','p','o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/',
'/','s','u','p','p','o','r','t','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t',
