...
class TrustedAdvisorCheckSummary {
 public:
  ...
  inline void SetHasFlaggedResources(bool value) {
    m_hasFlaggedResourcesHasBeenSet = true;
    m_hasFlaggedResources = value;
  }
  inline TrustedAdvisorCheckSummary& WithHasFlaggedResources(bool value) {
    SetHasFlaggedResources(value);
    return *this;
  }
  ///@}
  ...
  void SetResourcesSummary(ResourcesSummaryT&& value) {
    ...
    m_resourcesSummary = std::forward<ResourcesSummaryT>(value);
  }
  template <typename ResourcesSummaryT = TrustedAdvisorResourcesSummary>
  TrustedAdvisorCheckSummary& WithResourcesSummary(ResourcesSummaryT&& value) {
    SetResourcesSummary(std::forward<ResourcesSummaryT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCategorySpecificSummary(CategorySpecificSummaryT&& value) {
    ...
    m_categorySpecificSummary = std::forward<CategorySpecificSummaryT>(value);
  }
  template <typename CategorySpecificSummaryT = TrustedAdvisorCategorySpecificSummary>
  TrustedAdvisorCheckSummary& WithCategorySpecificSummary(CategorySpecificSummaryT&& value) {
    SetCategorySpecificSummary(std::forward<CategorySpecificSummaryT>(value));
    return *this;
  }
  ///@}
 private:
