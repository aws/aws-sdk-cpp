...
class DescribeCreateCaseOptionsResult {
 public:
  ...
  void SetLanguageAvailability(LanguageAvailabilityT&& value) {
    ...
    m_languageAvailability = std::forward<LanguageAvailabilityT>(value);
  }
  template <typename LanguageAvailabilityT = Aws::String>
  DescribeCreateCaseOptionsResult& WithLanguageAvailability(LanguageAvailabilityT&& value) {
    SetLanguageAvailability(std::forward<LanguageAvailabilityT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCommunicationTypes(CommunicationTypesT&& value) {
    ...
    m_communicationTypes = std::forward<CommunicationTypesT>(value);
  }
  template <typename CommunicationTypesT = Aws::Vector<CommunicationTypeOptions>>
  DescribeCreateCaseOptionsResult& WithCommunicationTypes(CommunicationTypesT&& value) {
    SetCommunicationTypes(std::forward<CommunicationTypesT>(value));
    return *this;
  }
  ...
  DescribeCreateCaseOptionsResult& AddCommunicationTypes(CommunicationTypesT&& value) {
    m_communicationTypesHasBeenSet = true;
    m_communicationTypes.emplace_back(std::forward<CommunicationTypesT>(value));
    return *this;
  }
  ///@}
