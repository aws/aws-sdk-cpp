...
class CaseDetails {
 public:
  ...
  void SetSeverityCode(SeverityCodeT&& value) {
    ...
    m_severityCode = std::forward<SeverityCodeT>(value);
  }
  template <typename SeverityCodeT = Aws::String>
  CaseDetails& WithSeverityCode(SeverityCodeT&& value) {
    SetSeverityCode(std::forward<SeverityCodeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRecentCommunications(RecentCommunicationsT&& value) {
    ...
    m_recentCommunications = std::forward<RecentCommunicationsT>(value);
  }
  template <typename RecentCommunicationsT = RecentCaseCommunications>
  CaseDetails& WithRecentCommunications(RecentCommunicationsT&& value) {
    SetRecentCommunications(std::forward<RecentCommunicationsT>(value));
    return *this;
  }
  ///@}
