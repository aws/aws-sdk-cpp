...
class TrustedAdvisorResourcesSummary {
 public:
  ...
  inline void SetResourcesProcessed(long long value) {
    m_resourcesProcessedHasBeenSet = true;
    m_resourcesProcessed = value;
  }
  inline TrustedAdvisorResourcesSummary& WithResourcesProcessed(long long value) {
    SetResourcesProcessed(value);
    return *this;
  }
  ///@}
  ...
  inline void SetResourcesFlagged(long long value) {
    m_resourcesFlaggedHasBeenSet = true;
    m_resourcesFlagged = value;
  }
  inline TrustedAdvisorResourcesSummary& WithResourcesFlagged(long long value) {
    SetResourcesFlagged(value);
    return *this;
  }
  ///@}
  ...
  inline void SetResourcesIgnored(long long value) {
    m_resourcesIgnoredHasBeenSet = true;
    m_resourcesIgnored = value;
  }
  inline TrustedAdvisorResourcesSummary& WithResourcesIgnored(long long value) {
    SetResourcesIgnored(value);
    return *this;
  }
  ///@}
  ...
  inline void SetResourcesSuppressed(long long value) {
    m_resourcesSuppressedHasBeenSet = true;
    m_resourcesSuppressed = value;
  }
  inline TrustedAdvisorResourcesSummary& WithResourcesSuppressed(long long value) {
    SetResourcesSuppressed(value);
    return *this;
  }
  ///@}
 private:
