...
class TrustedAdvisorCostOptimizingSummary {
 public:
  ...
  inline TrustedAdvisorCostOptimizingSummary& WithEstimatedMonthlySavings(double value) {
  ...
  inline TrustedAdvisorCostOptimizingSummary& WithEstimatedPercentMonthlySavings(double value) {
