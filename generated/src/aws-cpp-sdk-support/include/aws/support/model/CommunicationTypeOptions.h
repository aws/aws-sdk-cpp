...
class CommunicationTypeOptions {
 public:
  ...
  template <typename TypeT = Aws::String>
  CommunicationTypeOptions& WithType(TypeT&& value) {
  ...
  void SetSupportedHours(SupportedHoursT&& value) {
    m_supportedHoursHasBeenSet = true;
    m_supportedHours = std::forward<SupportedHoursT>(value);
  }
  template <typename SupportedHoursT = Aws::Vector<SupportedHour>>
  CommunicationTypeOptions& WithSupportedHours(SupportedHoursT&& value) {
    SetSupportedHours(std::forward<SupportedHoursT>(value));
    return *this;
  }
  template <typename SupportedHoursT = SupportedHour>
  CommunicationTypeOptions& AddSupportedHours(SupportedHoursT&& value) {
    m_supportedHoursHasBeenSet = true;
    m_supportedHours.emplace_back(std::forward<SupportedHoursT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDatesWithoutSupport(DatesWithoutSupportT&& value) {
    m_datesWithoutSupportHasBeenSet = true;
    m_datesWithoutSupport = std::forward<DatesWithoutSupportT>(value);
  }
  template <typename DatesWithoutSupportT = Aws::Vector<DateInterval>>
  CommunicationTypeOptions& WithDatesWithoutSupport(DatesWithoutSupportT&& value) {
    SetDatesWithoutSupport(std::forward<DatesWithoutSupportT>(value));
    return *this;
  }
  template <typename DatesWithoutSupportT = DateInterval>
  CommunicationTypeOptions& AddDatesWithoutSupport(DatesWithoutSupportT&& value) {
    m_datesWithoutSupportHasBeenSet = true;
    m_datesWithoutSupport.emplace_back(std::forward<DatesWithoutSupportT>(value));
    return *this;
  }
  ///@}
 private:
