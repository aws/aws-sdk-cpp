...
class TrustedAdvisorCheckRefreshStatus {
 public:
  ...
  template <typename CheckIdT = Aws::String>
  TrustedAdvisorCheckRefreshStatus& WithCheckId(CheckIdT&& value) {
  ...
  template <typename StatusT = Aws::String>
  TrustedAdvisorCheckRefreshStatus& WithStatus(StatusT&& value) {
  ...
  inline void SetMillisUntilNextRefreshable(long long value) {
    m_millisUntilNextRefreshableHasBeenSet = true;
    m_millisUntilNextRefreshable = value;
  }
  inline TrustedAdvisorCheckRefreshStatus& WithMillisUntilNextRefreshable(long long value) {
    SetMillisUntilNextRefreshable(value);
    return *this;
  }
  ///@}
 private:
