...
class DescribeTrustedAdvisorCheckRefreshStatusesResult {
 public:
  ...
  AWS_SUPPORT_API DescribeTrustedAdvisorCheckRefreshStatusesResult& operator=(
  ...
  template <typename StatusesT = Aws::Vector<TrustedAdvisorCheckRefreshStatus>>
  DescribeTrustedAdvisorCheckRefreshStatusesResult& WithStatuses(StatusesT&& value) {
    SetStatuses(std::forward<StatusesT>(value));
    return *this;
  }
  template <typename StatusesT = TrustedAdvisorCheckRefreshStatus>
  DescribeTrustedAdvisorCheckRefreshStatusesResult& AddStatuses(StatusesT&& value) {
    m_statusesHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DescribeTrustedAdvisorCheckRefreshStatusesResult& WithRequestId(RequestIdT&& value) {
