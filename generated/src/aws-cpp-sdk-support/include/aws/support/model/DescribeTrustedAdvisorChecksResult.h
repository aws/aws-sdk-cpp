...
class DescribeTrustedAdvisorChecksResult {
 public:
  ...
  template <typename ChecksT = Aws::Vector<TrustedAdvisorCheckDescription>>
  DescribeTrustedAdvisorChecksResult& WithChecks(ChecksT&& value) {
    SetChecks(std::forward<ChecksT>(value));
    return *this;
  }
  template <typename ChecksT = TrustedAdvisorCheckDescription>
  DescribeTrustedAdvisorChecksResult& AddChecks(ChecksT&& value) {
    m_checksHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DescribeTrustedAdvisorChecksResult& WithRequestId(RequestIdT&& value) {
