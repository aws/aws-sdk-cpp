...
class DescribeServicesRequest : public SupportRequest {
 public:
  ...
  void SetServiceCodeList(ServiceCodeListT&& value) {
    m_serviceCodeListHasBeenSet = true;
    m_serviceCodeList = std::forward<ServiceCodeListT>(value);
  }
  template <typename ServiceCodeListT = Aws::Vector<Aws::String>>
  DescribeServicesRequest& WithServiceCodeList(ServiceCodeListT&& value) {
    SetServiceCodeList(std::forward<ServiceCodeListT>(value));
    return *this;
  }
  template <typename ServiceCodeListT = Aws::String>
  DescribeServicesRequest& AddServiceCodeList(ServiceCodeListT&& value) {
    m_serviceCodeListHasBeenSet = true;
    m_serviceCodeList.emplace_back(std::forward<ServiceCodeListT>(value));
    return *this;
  }
  ///@}
