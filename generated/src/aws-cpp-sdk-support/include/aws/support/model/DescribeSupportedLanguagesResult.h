...
class DescribeSupportedLanguagesResult {
 public:
  ...
  void SetSupportedLanguages(SupportedLanguagesT&& value) {
    m_supportedLanguagesHasBeenSet = true;
    m_supportedLanguages = std::forward<SupportedLanguagesT>(value);
  }
  template <typename SupportedLanguagesT = Aws::Vector<SupportedLanguage>>
  DescribeSupportedLanguagesResult& WithSupportedLanguages(SupportedLanguagesT&& value) {
    SetSupportedLanguages(std::forward<SupportedLanguagesT>(value));
    return *this;
  }
  template <typename SupportedLanguagesT = SupportedLanguage>
  DescribeSupportedLanguagesResult& AddSupportedLanguages(SupportedLanguagesT&& value) {
    m_supportedLanguagesHasBeenSet = true;
    m_supportedLanguages.emplace_back(std::forward<SupportedLanguagesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeSupportedLanguagesResult& WithRequestId(RequestIdT&& value) {
