...
class DescribeTrustedAdvisorCheckResultResult {
 public:
  ...
  AWS_SUPPORT_API DescribeTrustedAdvisorCheckResultResult& operator=(
  ...
  template <typename ResultT = TrustedAdvisorCheckResult>
  DescribeTrustedAdvisorCheckResultResult& WithResult(ResultT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeTrustedAdvisorCheckResultResult& WithRequestId(RequestIdT&& value) {
