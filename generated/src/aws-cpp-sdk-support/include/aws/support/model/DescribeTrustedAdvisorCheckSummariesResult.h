...
class DescribeTrustedAdvisorCheckSummariesResult {
 public:
  ...
  AWS_SUPPORT_API DescribeTrustedAdvisorCheckSummariesResult& operator=(
  ...
  template <typename SummariesT = Aws::Vector<TrustedAdvisorCheckSummary>>
  DescribeTrustedAdvisorCheckSummariesResult& WithSummaries(SummariesT&& value) {
    SetSummaries(std::forward<SummariesT>(value));
    return *this;
  }
  template <typename SummariesT = TrustedAdvisorCheckSummary>
  DescribeTrustedAdvisorCheckSummariesResult& AddSummaries(SummariesT&& value) {
    m_summariesHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DescribeTrustedAdvisorCheckSummariesResult& WithRequestId(RequestIdT&& value) {
