...
class DescribeCasesRequest : public SupportRequest {
 public:
  ...
  void SetCaseIdList(CaseIdListT&& value) {
    m_caseIdListHasBeenSet = true;
    m_caseIdList = std::forward<CaseIdListT>(value);
  }
  template <typename CaseIdListT = Aws::Vector<Aws::String>>
  DescribeCasesRequest& WithCaseIdList(CaseIdListT&& value) {
    SetCaseIdList(std::forward<CaseIdListT>(value));
    return *this;
  }
  template <typename CaseIdListT = Aws::String>
  DescribeCasesRequest& AddCaseIdList(CaseIdListT&& value) {
    m_caseIdListHasBeenSet = true;
    m_caseIdList.emplace_back(std::forward<CaseIdListT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDisplayId(DisplayIdT&& value) {
    ...
    m_displayId = std::forward<DisplayIdT>(value);
  }
  template <typename DisplayIdT = Aws::String>
  DescribeCasesRequest& WithDisplayId(DisplayIdT&& value) {
    SetDisplayId(std::forward<DisplayIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetIncludeResolvedCases(bool value) {
    m_includeResolvedCasesHasBeenSet = true;
    m_includeResolvedCases = value;
  }
  inline DescribeCasesRequest& WithIncludeResolvedCases(bool value) {
    SetIncludeResolvedCases(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeCasesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIncludeCommunications(bool value) {
    m_includeCommunicationsHasBeenSet = true;
    m_includeCommunications = value;
  }
  inline DescribeCasesRequest& WithIncludeCommunications(bool value) {
    SetIncludeCommunications(value);
    return *this;
  }
  ///@}
 private:
