...
class DescribeCommunicationsRequest : public SupportRequest {
 public:
  ...
  void SetBeforeTime(BeforeTimeT&& value) {
    m_beforeTimeHasBeenSet = true;
    m_beforeTime = std::forward<BeforeTimeT>(value);
  }
  template <typename BeforeTimeT = Aws::String>
  DescribeCommunicationsRequest& WithBeforeTime(BeforeTimeT&& value) {
    SetBeforeTime(std::forward<BeforeTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAfterTime(AfterTimeT&& value) {
    m_afterTimeHasBeenSet = true;
    m_afterTime = std::forward<AfterTimeT>(value);
  }
  template <typename AfterTimeT = Aws::String>
  DescribeCommunicationsRequest& WithAfterTime(AfterTimeT&& value) {
    SetAfterTime(std::forward<AfterTimeT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeCommunicationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
