...
class TrustedAdvisorCheckResult {
 public:
  ...
  void SetFlaggedResources(FlaggedResourcesT&& value) {
    m_flaggedResourcesHasBeenSet = true;
    m_flaggedResources = std::forward<FlaggedResourcesT>(value);
  }
  template <typename FlaggedResourcesT = Aws::Vector<TrustedAdvisorResourceDetail>>
  TrustedAdvisorCheckResult& WithFlaggedResources(FlaggedResourcesT&& value) {
    SetFlaggedResources(std::forward<FlaggedResourcesT>(value));
    return *this;
  }
  ...
  TrustedAdvisorCheckResult& AddFlaggedResources(FlaggedResourcesT&& value) {
    m_flaggedResourcesHasBeenSet = true;
    m_flaggedResources.emplace_back(std::forward<FlaggedResourcesT>(value));
    return *this;
  }
  ///@}
 private:
