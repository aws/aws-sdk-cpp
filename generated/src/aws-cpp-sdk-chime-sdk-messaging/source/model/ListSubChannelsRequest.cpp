...
Aws::String ListSubChannelsRequest::SerializePayload() const { return {}; }

Aws::Http::HeaderValueCollection ListSubChannelsRequest::GetRequestSpecificHeaders() const {
...
void ListSubChannelsRequest::AddQueryStringParameters(URI& uri) const {
  Aws::StringStream ss;
