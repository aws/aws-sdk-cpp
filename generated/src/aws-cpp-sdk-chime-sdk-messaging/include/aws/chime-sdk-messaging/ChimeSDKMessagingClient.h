...
namespace ChimeSDKMessaging
{
   ...
   */
  class AWS_CHIMESDKMESSAGING_API ChimeSDKMessagingClient : Aws::Client::ClientWithAsyncTemplateMethods<ChimeSDKMessagingClient>,
    smithy::client::AwsSmithyClientT<Aws::ChimeSDKMessaging::SERVICE_NAME,
