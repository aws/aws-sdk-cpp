...
#include <aws/chime-sdk-messaging/ChimeSDKMessagingWaiter.h>
...
class AWS_CHIMESDKMESSAGING_API ChimeSDKMessagingClient : public Aws::Client::AWSJsonClient,
                                                          ...
                                                          public ChimeSDKMessagingWaiter<ChimeSDKMessagingClient> {
 public:
  ...
  ChimeSDKMessagingClient(const Aws::Auth::AWSCredentials& credentials,
                          std::shared_ptr<ChimeSDKMessagingEndpointProviderBase> endpointProvider = nullptr,
                          const Aws::ChimeSDKMessaging::ChimeSDKMessagingClientConfiguration& clientConfiguration =
                              Aws::ChimeSDKMessaging::ChimeSDKMessagingClientConfiguration());
   ...
   * is not specified, it will be initialized to default values.
   */
  ChimeSDKMessagingClient(const Aws::Auth::AWSCredentials& credentials, const Aws::Client::ClientConfiguration& clientConfiguration);
  ...
  /**
   * A Callable wrapper for AssociateChannelFlow that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssociateChannelFlow that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateChannelFlowRequestT = Model::AssociateChannelFlowRequest>
  void AssociateChannelFlowAsync(const AssociateChannelFlowRequestT& request, const AssociateChannelFlowResponseReceivedHandler& handler,
  ...
  virtual Model::BatchCreateChannelMembershipOutcome BatchCreateChannelMembership(
      const Model::BatchCreateChannelMembershipRequest& request) const;

  /**
   * A Callable wrapper for BatchCreateChannelMembership that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename BatchCreateChannelMembershipRequestT = Model::BatchCreateChannelMembershipRequest>
  Model::BatchCreateChannelMembershipOutcomeCallable BatchCreateChannelMembershipCallable(
      const BatchCreateChannelMembershipRequestT& request) const {
    return SubmitCallable(&ChimeSDKMessagingClient::BatchCreateChannelMembership, request);
  }

  /**
   * An Async wrapper for BatchCreateChannelMembership that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchCreateChannelMembershipRequestT = Model::BatchCreateChannelMembershipRequest>
  void BatchCreateChannelMembershipAsync(const BatchCreateChannelMembershipRequestT& request,
                                         const BatchCreateChannelMembershipResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ChannelFlowCallback that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ChannelFlowCallback that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ChannelFlowCallbackRequestT = Model::ChannelFlowCallbackRequest>
  void ChannelFlowCallbackAsync(const ChannelFlowCallbackRequestT& request, const ChannelFlowCallbackResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateChannelBan that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateChannelBan that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateChannelBanRequestT = Model::CreateChannelBanRequest>
  void CreateChannelBanAsync(const CreateChannelBanRequestT& request, const CreateChannelBanResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateChannelFlow that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateChannelFlow that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateChannelFlowRequestT = Model::CreateChannelFlowRequest>
  void CreateChannelFlowAsync(const CreateChannelFlowRequestT& request, const CreateChannelFlowResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateChannelMembership that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateChannelMembership that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateChannelMembershipRequestT = Model::CreateChannelMembershipRequest>
  void CreateChannelMembershipAsync(const CreateChannelMembershipRequestT& request,
                                    const CreateChannelMembershipResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateChannelModerator that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateChannelModerator that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateChannelModeratorRequestT = Model::CreateChannelModeratorRequest>
  void CreateChannelModeratorAsync(const CreateChannelModeratorRequestT& request,
                                   const CreateChannelModeratorResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteChannelBan that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteChannelBan that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteChannelBanRequestT = Model::DeleteChannelBanRequest>
  void DeleteChannelBanAsync(const DeleteChannelBanRequestT& request, const DeleteChannelBanResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteChannelFlow that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteChannelFlow that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteChannelFlowRequestT = Model::DeleteChannelFlowRequest>
  void DeleteChannelFlowAsync(const DeleteChannelFlowRequestT& request, const DeleteChannelFlowResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteChannelMembership that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteChannelMembership that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteChannelMembershipRequestT = Model::DeleteChannelMembershipRequest>
  void DeleteChannelMembershipAsync(const DeleteChannelMembershipRequestT& request,
                                    const DeleteChannelMembershipResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteChannelMessage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteChannelMessage that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteChannelMessageRequestT = Model::DeleteChannelMessageRequest>
  void DeleteChannelMessageAsync(const DeleteChannelMessageRequestT& request, const DeleteChannelMessageResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteChannelModerator that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteChannelModerator that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteChannelModeratorRequestT = Model::DeleteChannelModeratorRequest>
  void DeleteChannelModeratorAsync(const DeleteChannelModeratorRequestT& request,
                                   const DeleteChannelModeratorResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteMessagingStreamingConfigurationsOutcome DeleteMessagingStreamingConfigurations(
      const Model::DeleteMessagingStreamingConfigurationsRequest& request) const;

  /**
   * A Callable wrapper for DeleteMessagingStreamingConfigurations that returns a future to the operation so that it can be executed in
  ...
  Model::DeleteMessagingStreamingConfigurationsOutcomeCallable DeleteMessagingStreamingConfigurationsCallable(
      const DeleteMessagingStreamingConfigurationsRequestT& request) const {
    return SubmitCallable(&ChimeSDKMessagingClient::DeleteMessagingStreamingConfigurations, request);
  }

  /**
   * An Async wrapper for DeleteMessagingStreamingConfigurations that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DeleteMessagingStreamingConfigurationsRequestT = Model::DeleteMessagingStreamingConfigurationsRequest>
  void DeleteMessagingStreamingConfigurationsAsync(const DeleteMessagingStreamingConfigurationsRequestT& request,
                                                   const DeleteMessagingStreamingConfigurationsResponseReceivedHandler& handler,
                                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeChannelBan that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeChannelBan that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeChannelBanRequestT = Model::DescribeChannelBanRequest>
  void DescribeChannelBanAsync(const DescribeChannelBanRequestT& request, const DescribeChannelBanResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeChannelFlow that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeChannelFlow that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeChannelFlowRequestT = Model::DescribeChannelFlowRequest>
  void DescribeChannelFlowAsync(const DescribeChannelFlowRequestT& request, const DescribeChannelFlowResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeChannelMembership that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeChannelMembershipRequestT = Model::DescribeChannelMembershipRequest>
  Model::DescribeChannelMembershipOutcomeCallable DescribeChannelMembershipCallable(
      const DescribeChannelMembershipRequestT& request) const {
    return SubmitCallable(&ChimeSDKMessagingClient::DescribeChannelMembership, request);
  }

  /**
   * An Async wrapper for DescribeChannelMembership that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeChannelMembershipRequestT = Model::DescribeChannelMembershipRequest>
  void DescribeChannelMembershipAsync(const DescribeChannelMembershipRequestT& request,
                                      const DescribeChannelMembershipResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeChannelMembershipForAppInstanceUserOutcome DescribeChannelMembershipForAppInstanceUser(
      const Model::DescribeChannelMembershipForAppInstanceUserRequest& request) const;

  /**
   * A Callable wrapper for DescribeChannelMembershipForAppInstanceUser that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  ...
  Model::DescribeChannelMembershipForAppInstanceUserOutcomeCallable DescribeChannelMembershipForAppInstanceUserCallable(
      const DescribeChannelMembershipForAppInstanceUserRequestT& request) const {
    return SubmitCallable(&ChimeSDKMessagingClient::DescribeChannelMembershipForAppInstanceUser, request);
  }

  /**
   * An Async wrapper for DescribeChannelMembershipForAppInstanceUser that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeChannelMembershipForAppInstanceUserRequestT = Model::DescribeChannelMembershipForAppInstanceUserRequest>
  void DescribeChannelMembershipForAppInstanceUserAsync(
      const DescribeChannelMembershipForAppInstanceUserRequestT& request,
      const DescribeChannelMembershipForAppInstanceUserResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeChannelModeratedByAppInstanceUserOutcome DescribeChannelModeratedByAppInstanceUser(
      const Model::DescribeChannelModeratedByAppInstanceUserRequest& request) const;

  /**
   * A Callable wrapper for DescribeChannelModeratedByAppInstanceUser that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  ...
  Model::DescribeChannelModeratedByAppInstanceUserOutcomeCallable DescribeChannelModeratedByAppInstanceUserCallable(
      const DescribeChannelModeratedByAppInstanceUserRequestT& request) const {
    return SubmitCallable(&ChimeSDKMessagingClient::DescribeChannelModeratedByAppInstanceUser, request);
  }

  /**
   * An Async wrapper for DescribeChannelModeratedByAppInstanceUser that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeChannelModeratedByAppInstanceUserRequestT = Model::DescribeChannelModeratedByAppInstanceUserRequest>
  void DescribeChannelModeratedByAppInstanceUserAsync(
      const DescribeChannelModeratedByAppInstanceUserRequestT& request,
      const DescribeChannelModeratedByAppInstanceUserResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeChannelModerator that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeChannelModerator that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeChannelModeratorRequestT = Model::DescribeChannelModeratorRequest>
  void DescribeChannelModeratorAsync(const DescribeChannelModeratorRequestT& request,
                                     const DescribeChannelModeratorResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DisassociateChannelFlow that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DisassociateChannelFlow that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateChannelFlowRequestT = Model::DisassociateChannelFlowRequest>
  void DisassociateChannelFlowAsync(const DisassociateChannelFlowRequestT& request,
                                    const DisassociateChannelFlowResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetChannelMembershipPreferencesOutcome GetChannelMembershipPreferences(
      const Model::GetChannelMembershipPreferencesRequest& request) const;

  /**
   * A Callable wrapper for GetChannelMembershipPreferences that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetChannelMembershipPreferencesRequestT = Model::GetChannelMembershipPreferencesRequest>
  Model::GetChannelMembershipPreferencesOutcomeCallable GetChannelMembershipPreferencesCallable(
      const GetChannelMembershipPreferencesRequestT& request) const {
    return SubmitCallable(&ChimeSDKMessagingClient::GetChannelMembershipPreferences, request);
  }

  /**
   * An Async wrapper for GetChannelMembershipPreferences that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetChannelMembershipPreferencesRequestT = Model::GetChannelMembershipPreferencesRequest>
  void GetChannelMembershipPreferencesAsync(const GetChannelMembershipPreferencesRequestT& request,
                                            const GetChannelMembershipPreferencesResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetChannelMessage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetChannelMessage that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetChannelMessageRequestT = Model::GetChannelMessageRequest>
  void GetChannelMessageAsync(const GetChannelMessageRequestT& request, const GetChannelMessageResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetChannelMessageStatus that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetChannelMessageStatus that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetChannelMessageStatusRequestT = Model::GetChannelMessageStatusRequest>
  void GetChannelMessageStatusAsync(const GetChannelMessageStatusRequestT& request,
                                    const GetChannelMessageStatusResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetMessagingSessionEndpointOutcome GetMessagingSessionEndpoint(
      const Model::GetMessagingSessionEndpointRequest& request = {}) const;

  /**
   * A Callable wrapper for GetMessagingSessionEndpoint that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetMessagingSessionEndpointRequestT = Model::GetMessagingSessionEndpointRequest>
  Model::GetMessagingSessionEndpointOutcomeCallable GetMessagingSessionEndpointCallable(
      const GetMessagingSessionEndpointRequestT& request = {}) const {
    return SubmitCallable(&ChimeSDKMessagingClient::GetMessagingSessionEndpoint, request);
  }

  /**
   * An Async wrapper for GetMessagingSessionEndpoint that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetMessagingSessionEndpointRequestT = Model::GetMessagingSessionEndpointRequest>
  void GetMessagingSessionEndpointAsync(const GetMessagingSessionEndpointResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetMessagingStreamingConfigurationsOutcome GetMessagingStreamingConfigurations(
      const Model::GetMessagingStreamingConfigurationsRequest& request) const;

  /**
   * A Callable wrapper for GetMessagingStreamingConfigurations that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename GetMessagingStreamingConfigurationsRequestT = Model::GetMessagingStreamingConfigurationsRequest>
  Model::GetMessagingStreamingConfigurationsOutcomeCallable GetMessagingStreamingConfigurationsCallable(
      const GetMessagingStreamingConfigurationsRequestT& request) const {
    return SubmitCallable(&ChimeSDKMessagingClient::GetMessagingStreamingConfigurations, request);
  }

  /**
   * An Async wrapper for GetMessagingStreamingConfigurations that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetMessagingStreamingConfigurationsRequestT = Model::GetMessagingStreamingConfigurationsRequest>
  void GetMessagingStreamingConfigurationsAsync(const GetMessagingStreamingConfigurationsRequestT& request,
                                                const GetMessagingStreamingConfigurationsResponseReceivedHandler& handler,
                                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListChannelBans that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListChannelBansRequestT = Model::ListChannelBansRequest>
  void ListChannelBansAsync(const ListChannelBansRequestT& request, const ListChannelBansResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListChannelFlows that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListChannelFlows that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListChannelFlowsRequestT = Model::ListChannelFlowsRequest>
  void ListChannelFlowsAsync(const ListChannelFlowsRequestT& request, const ListChannelFlowsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListChannelMemberships that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListChannelMemberships that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListChannelMembershipsRequestT = Model::ListChannelMembershipsRequest>
  void ListChannelMembershipsAsync(const ListChannelMembershipsRequestT& request,
                                   const ListChannelMembershipsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListChannelMembershipsForAppInstanceUserOutcome ListChannelMembershipsForAppInstanceUser(
      const Model::ListChannelMembershipsForAppInstanceUserRequest& request) const;

  /**
   * A Callable wrapper for ListChannelMembershipsForAppInstanceUser that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListChannelMembershipsForAppInstanceUserRequestT = Model::ListChannelMembershipsForAppInstanceUserRequest>
  Model::ListChannelMembershipsForAppInstanceUserOutcomeCallable ListChannelMembershipsForAppInstanceUserCallable(
      const ListChannelMembershipsForAppInstanceUserRequestT& request) const {
    return SubmitCallable(&ChimeSDKMessagingClient::ListChannelMembershipsForAppInstanceUser, request);
  }

  /**
   * An Async wrapper for ListChannelMembershipsForAppInstanceUser that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListChannelMembershipsForAppInstanceUserRequestT = Model::ListChannelMembershipsForAppInstanceUserRequest>
  void ListChannelMembershipsForAppInstanceUserAsync(
      const ListChannelMembershipsForAppInstanceUserRequestT& request,
      const ListChannelMembershipsForAppInstanceUserResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListChannelMessages that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListChannelMessages that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListChannelMessagesRequestT = Model::ListChannelMessagesRequest>
  void ListChannelMessagesAsync(const ListChannelMessagesRequestT& request, const ListChannelMessagesResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListChannelModerators that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListChannelModerators that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListChannelModeratorsRequestT = Model::ListChannelModeratorsRequest>
  void ListChannelModeratorsAsync(const ListChannelModeratorsRequestT& request, const ListChannelModeratorsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListChannelsAssociatedWithChannelFlowOutcome ListChannelsAssociatedWithChannelFlow(
      const Model::ListChannelsAssociatedWithChannelFlowRequest& request) const;

  /**
   * A Callable wrapper for ListChannelsAssociatedWithChannelFlow that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListChannelsAssociatedWithChannelFlowRequestT = Model::ListChannelsAssociatedWithChannelFlowRequest>
  Model::ListChannelsAssociatedWithChannelFlowOutcomeCallable ListChannelsAssociatedWithChannelFlowCallable(
      const ListChannelsAssociatedWithChannelFlowRequestT& request) const {
    return SubmitCallable(&ChimeSDKMessagingClient::ListChannelsAssociatedWithChannelFlow, request);
  }

  /**
   * An Async wrapper for ListChannelsAssociatedWithChannelFlow that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListChannelsAssociatedWithChannelFlowRequestT = Model::ListChannelsAssociatedWithChannelFlowRequest>
  void ListChannelsAssociatedWithChannelFlowAsync(const ListChannelsAssociatedWithChannelFlowRequestT& request,
                                                  const ListChannelsAssociatedWithChannelFlowResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::ListChannelsModeratedByAppInstanceUserOutcome ListChannelsModeratedByAppInstanceUser(
      const Model::ListChannelsModeratedByAppInstanceUserRequest& request) const;

  /**
   * A Callable wrapper for ListChannelsModeratedByAppInstanceUser that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListChannelsModeratedByAppInstanceUserRequestT = Model::ListChannelsModeratedByAppInstanceUserRequest>
  Model::ListChannelsModeratedByAppInstanceUserOutcomeCallable ListChannelsModeratedByAppInstanceUserCallable(
      const ListChannelsModeratedByAppInstanceUserRequestT& request) const {
    return SubmitCallable(&ChimeSDKMessagingClient::ListChannelsModeratedByAppInstanceUser, request);
  }

  /**
   * An Async wrapper for ListChannelsModeratedByAppInstanceUser that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListChannelsModeratedByAppInstanceUserRequestT = Model::ListChannelsModeratedByAppInstanceUserRequest>
  void ListChannelsModeratedByAppInstanceUserAsync(const ListChannelsModeratedByAppInstanceUserRequestT& request,
                                                   const ListChannelsModeratedByAppInstanceUserResponseReceivedHandler& handler,
                                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListSubChannels that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListSubChannelsRequestT = Model::ListSubChannelsRequest>
  void ListSubChannelsAsync(const ListSubChannelsRequestT& request, const ListSubChannelsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::PutChannelExpirationSettingsOutcome PutChannelExpirationSettings(
      const Model::PutChannelExpirationSettingsRequest& request) const;

  /**
   * A Callable wrapper for PutChannelExpirationSettings that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PutChannelExpirationSettingsRequestT = Model::PutChannelExpirationSettingsRequest>
  Model::PutChannelExpirationSettingsOutcomeCallable PutChannelExpirationSettingsCallable(
      const PutChannelExpirationSettingsRequestT& request) const {
    return SubmitCallable(&ChimeSDKMessagingClient::PutChannelExpirationSettings, request);
  }

  /**
   * An Async wrapper for PutChannelExpirationSettings that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutChannelExpirationSettingsRequestT = Model::PutChannelExpirationSettingsRequest>
  void PutChannelExpirationSettingsAsync(const PutChannelExpirationSettingsRequestT& request,
                                         const PutChannelExpirationSettingsResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::PutChannelMembershipPreferencesOutcome PutChannelMembershipPreferences(
      const Model::PutChannelMembershipPreferencesRequest& request) const;

  /**
   * A Callable wrapper for PutChannelMembershipPreferences that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PutChannelMembershipPreferencesRequestT = Model::PutChannelMembershipPreferencesRequest>
  Model::PutChannelMembershipPreferencesOutcomeCallable PutChannelMembershipPreferencesCallable(
      const PutChannelMembershipPreferencesRequestT& request) const {
    return SubmitCallable(&ChimeSDKMessagingClient::PutChannelMembershipPreferences, request);
  }

  /**
   * An Async wrapper for PutChannelMembershipPreferences that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename PutChannelMembershipPreferencesRequestT = Model::PutChannelMembershipPreferencesRequest>
  void PutChannelMembershipPreferencesAsync(const PutChannelMembershipPreferencesRequestT& request,
                                            const PutChannelMembershipPreferencesResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::PutMessagingStreamingConfigurationsOutcome PutMessagingStreamingConfigurations(
      const Model::PutMessagingStreamingConfigurationsRequest& request) const;

  /**
   * A Callable wrapper for PutMessagingStreamingConfigurations that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename PutMessagingStreamingConfigurationsRequestT = Model::PutMessagingStreamingConfigurationsRequest>
  Model::PutMessagingStreamingConfigurationsOutcomeCallable PutMessagingStreamingConfigurationsCallable(
      const PutMessagingStreamingConfigurationsRequestT& request) const {
    return SubmitCallable(&ChimeSDKMessagingClient::PutMessagingStreamingConfigurations, request);
  }

  /**
   * An Async wrapper for PutMessagingStreamingConfigurations that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename PutMessagingStreamingConfigurationsRequestT = Model::PutMessagingStreamingConfigurationsRequest>
  void PutMessagingStreamingConfigurationsAsync(const PutMessagingStreamingConfigurationsRequestT& request,
                                                const PutMessagingStreamingConfigurationsResponseReceivedHandler& handler,
                                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RedactChannelMessage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RedactChannelMessage that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RedactChannelMessageRequestT = Model::RedactChannelMessageRequest>
  void RedactChannelMessageAsync(const RedactChannelMessageRequestT& request, const RedactChannelMessageResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for SearchChannels that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename SearchChannelsRequestT = Model::SearchChannelsRequest>
  void SearchChannelsAsync(const SearchChannelsRequestT& request, const SearchChannelsResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SendChannelMessage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SendChannelMessage that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename SendChannelMessageRequestT = Model::SendChannelMessageRequest>
  void SendChannelMessageAsync(const SendChannelMessageRequestT& request, const SendChannelMessageResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateChannelFlow that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateChannelFlow that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateChannelFlowRequestT = Model::UpdateChannelFlowRequest>
  void UpdateChannelFlowAsync(const UpdateChannelFlowRequestT& request, const UpdateChannelFlowResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateChannelMessage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateChannelMessage that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateChannelMessageRequestT = Model::UpdateChannelMessageRequest>
  void UpdateChannelMessageAsync(const UpdateChannelMessageRequestT& request, const UpdateChannelMessageResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateChannelReadMarker that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateChannelReadMarker that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateChannelReadMarkerRequestT = Model::UpdateChannelReadMarkerRequest>
  void UpdateChannelReadMarkerAsync(const UpdateChannelReadMarkerRequestT& request,
                                    const UpdateChannelReadMarkerResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
