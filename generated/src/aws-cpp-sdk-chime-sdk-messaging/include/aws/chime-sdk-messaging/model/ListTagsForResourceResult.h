...
namespace Model
{
  ...
  {
  public:
    AWS_CHIMESDKMESSAGING_API ListTagsForResourceResult() = default;
    AWS_CHIMESDKMESSAGING_API ListTagsForResourceResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_CHIMESDKMESSAGING_API ListTagsForResourceResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
