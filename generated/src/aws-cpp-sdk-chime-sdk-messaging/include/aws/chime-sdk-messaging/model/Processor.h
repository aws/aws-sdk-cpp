...
class Processor {
 public:
  ...
  template <typename NameT = Aws::String>
  Processor& WithName(NameT&& value) {
  ...
  template <typename ConfigurationT = ProcessorConfiguration>
  Processor& WithConfiguration(ConfigurationT&& value) {
  ...
  inline void SetExecutionOrder(int value) {
    m_executionOrderHasBeenSet = true;
    m_executionOrder = value;
  }
  inline Processor& WithExecutionOrder(int value) {
  ...
  inline void SetFallbackAction(FallbackAction value) {
    m_fallbackActionHasBeenSet = true;
    m_fallbackAction = value;
  }
  inline Processor& WithFallbackAction(FallbackAction value) {
    SetFallbackAction(value);
    return *this;
  }
  ///@}
 private:
