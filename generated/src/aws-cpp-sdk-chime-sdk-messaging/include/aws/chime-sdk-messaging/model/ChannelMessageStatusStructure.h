...
class ChannelMessageStatusStructure {
 public:
  ...
  inline void SetValue(ChannelMessageStatus value) {
    m_valueHasBeenSet = true;
    m_value = value;
  }
  inline ChannelMessageStatusStructure& WithValue(ChannelMessageStatus value) {
    SetValue(value);
    return *this;
  }
  ///@}
  ...
  template <typename DetailT = Aws::String>
  ChannelMessageStatusStructure& WithDetail(DetailT&& value) {
