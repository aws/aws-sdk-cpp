...
class CreateChannelMembershipRequest : public ChimeSDKMessagingRequest {
 public:
  ...
  template <typename ChannelArnT = Aws::String>
  CreateChannelMembershipRequest& WithChannelArn(ChannelArnT&& value) {
  ...
  template <typename MemberArnT = Aws::String>
  CreateChannelMembershipRequest& WithMemberArn(MemberArnT&& value) {
  ...
  inline CreateChannelMembershipRequest& WithType(ChannelMembershipType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename ChimeBearerT = Aws::String>
  CreateChannelMembershipRequest& WithChimeBearer(ChimeBearerT&& value) {
  ...
  template <typename SubChannelIdT = Aws::String>
  CreateChannelMembershipRequest& WithSubChannelId(SubChannelIdT&& value) {
