...
class ListChannelModeratorsRequest : public ChimeSDKMessagingRequest {
 public:
  ...
  template <typename ChannelArnT = Aws::String>
  ListChannelModeratorsRequest& WithChannelArn(ChannelArnT&& value) {
  ...
  inline ListChannelModeratorsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListChannelModeratorsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ChimeBearerT = Aws::String>
  ListChannelModeratorsRequest& WithChimeBearer(ChimeBearerT&& value) {
