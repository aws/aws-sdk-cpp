...
class StreamingConfiguration {
 public:
  ...
  inline void SetDataType(MessagingDataType value) {
    m_dataTypeHasBeenSet = true;
    m_dataType = value;
  }
  inline StreamingConfiguration& WithDataType(MessagingDataType value) {
    SetDataType(value);
    return *this;
  }
  ///@}
  ...
  template <typename ResourceArnT = Aws::String>
  StreamingConfiguration& WithResourceArn(ResourceArnT&& value) {
