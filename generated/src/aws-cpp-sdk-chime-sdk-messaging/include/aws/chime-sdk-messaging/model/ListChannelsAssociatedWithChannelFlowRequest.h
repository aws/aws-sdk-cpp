...
class ListChannelsAssociatedWithChannelFlowRequest : public ChimeSDKMessagingRequest {
 public:
  ...
  template <typename ChannelFlowArnT = Aws::String>
  ListChannelsAssociatedWithChannelFlowRequest& WithChannelFlowArn(ChannelFlowArnT&& value) {
  ...
  inline ListChannelsAssociatedWithChannelFlowRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListChannelsAssociatedWithChannelFlowRequest& WithNextToken(NextTokenT&& value) {
