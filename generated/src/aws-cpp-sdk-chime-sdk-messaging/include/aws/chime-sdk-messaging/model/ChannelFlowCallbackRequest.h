...
class ChannelFlowCallbackRequest : public ChimeSDKMessagingRequest {
 public:
  ...
  template <typename CallbackIdT = Aws::String>
  ChannelFlowCallbackRequest& WithCallbackId(CallbackIdT&& value) {
  ...
  template <typename ChannelArnT = Aws::String>
  ChannelFlowCallbackRequest& WithChannelArn(ChannelArnT&& value) {
  ...
  inline void SetDeleteResource(bool value) {
    m_deleteResourceHasBeenSet = true;
    m_deleteResource = value;
  }
  inline ChannelFlowCallbackRequest& WithDeleteResource(bool value) {
  ...
  template <typename ChannelMessageT = ChannelMessageCallback>
  ChannelFlowCallbackRequest& WithChannelMessage(ChannelMessageT&& value) {
