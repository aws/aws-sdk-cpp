...
class ChannelMessage {
 public:
  ...
  template <typename ChannelArnT = Aws::String>
  ChannelMessage& WithChannelArn(ChannelArnT&& value) {
  ...
  template <typename MessageIdT = Aws::String>
  ChannelMessage& WithMessageId(MessageIdT&& value) {
  ...
  template <typename ContentT = Aws::String>
  ChannelMessage& WithContent(ContentT&& value) {
  ...
  template <typename MetadataT = Aws::String>
  ChannelMessage& WithMetadata(MetadataT&& value) {
  ...
  inline void SetType(ChannelMessageType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline ChannelMessage& WithType(ChannelMessageType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreatedTimestampT = Aws::Utils::DateTime>
  ChannelMessage& WithCreatedTimestamp(CreatedTimestampT&& value) {
  ...
  void SetLastEditedTimestamp(LastEditedTimestampT&& value) {
    m_lastEditedTimestampHasBeenSet = true;
    m_lastEditedTimestamp = std::forward<LastEditedTimestampT>(value);
  }
  template <typename LastEditedTimestampT = Aws::Utils::DateTime>
  ChannelMessage& WithLastEditedTimestamp(LastEditedTimestampT&& value) {
    SetLastEditedTimestamp(std::forward<LastEditedTimestampT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename LastUpdatedTimestampT = Aws::Utils::DateTime>
  ChannelMessage& WithLastUpdatedTimestamp(LastUpdatedTimestampT&& value) {
  ...
  template <typename SenderT = Identity>
  ChannelMessage& WithSender(SenderT&& value) {
  ...
  inline void SetRedacted(bool value) {
    m_redactedHasBeenSet = true;
    m_redacted = value;
  }
  inline ChannelMessage& WithRedacted(bool value) {
    SetRedacted(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPersistence(ChannelMessagePersistenceType value) {
    m_persistenceHasBeenSet = true;
    m_persistence = value;
  }
  inline ChannelMessage& WithPersistence(ChannelMessagePersistenceType value) {
  ...
  template <typename StatusT = ChannelMessageStatusStructure>
  ChannelMessage& WithStatus(StatusT&& value) {
  ...
  template <typename MessageAttributesT = Aws::Map<Aws::String, MessageAttributeValue>>
  ChannelMessage& WithMessageAttributes(MessageAttributesT&& value) {
  ...
  template <typename SubChannelIdT = Aws::String>
  ChannelMessage& WithSubChannelId(SubChannelIdT&& value) {
  ...
  template <typename ContentTypeT = Aws::String>
  ChannelMessage& WithContentType(ContentTypeT&& value) {
  ...
  template <typename TargetT = Aws::Vector<Target>>
  ChannelMessage& WithTarget(TargetT&& value) {
    SetTarget(std::forward<TargetT>(value));
    return *this;
  }
  template <typename TargetT = Target>
  ChannelMessage& AddTarget(TargetT&& value) {
    m_targetHasBeenSet = true;
    m_target.emplace_back(std::forward<TargetT>(value));
    return *this;
  }
  ///@}
 private:
