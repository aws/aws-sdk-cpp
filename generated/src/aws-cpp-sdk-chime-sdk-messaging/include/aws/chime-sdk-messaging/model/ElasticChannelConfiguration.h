...
class ElasticChannelConfiguration {
 public:
  ...
  inline void SetMaximumSubChannels(int value) {
    m_maximumSubChannelsHasBeenSet = true;
    m_maximumSubChannels = value;
  }
  inline ElasticChannelConfiguration& WithMaximumSubChannels(int value) {
    SetMaximumSubChannels(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTargetMembershipsPerSubChannel(int value) {
    m_targetMembershipsPerSubChannelHasBeenSet = true;
    m_targetMembershipsPerSubChannel = value;
  }
  inline ElasticChannelConfiguration& WithTargetMembershipsPerSubChannel(int value) {
    SetTargetMembershipsPerSubChannel(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMinimumMembershipPercentage(int value) {
    m_minimumMembershipPercentageHasBeenSet = true;
    m_minimumMembershipPercentage = value;
  }
  inline ElasticChannelConfiguration& WithMinimumMembershipPercentage(int value) {
    SetMinimumMembershipPercentage(value);
    return *this;
  }
  ///@}
 private:
