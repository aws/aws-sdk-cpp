...
class ListChannelMessagesResult {
 public:
  ...
  template <typename ChannelArnT = Aws::String>
  ListChannelMessagesResult& WithChannelArn(ChannelArnT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListChannelMessagesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ChannelMessagesT = Aws::Vector<ChannelMessageSummary>>
  ListChannelMessagesResult& WithChannelMessages(ChannelMessagesT&& value) {
    SetChannelMessages(std::forward<ChannelMessagesT>(value));
    return *this;
  }
  template <typename ChannelMessagesT = ChannelMessageSummary>
  ListChannelMessagesResult& AddChannelMessages(ChannelMessagesT&& value) {
    m_channelMessagesHasBeenSet = true;
    m_channelMessages.emplace_back(std::forward<ChannelMessagesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename SubChannelIdT = Aws::String>
  ListChannelMessagesResult& WithSubChannelId(SubChannelIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListChannelMessagesResult& WithRequestId(RequestIdT&& value) {
