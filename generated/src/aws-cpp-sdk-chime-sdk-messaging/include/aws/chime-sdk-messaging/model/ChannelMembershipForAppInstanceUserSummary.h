...
class ChannelMembershipForAppInstanceUserSummary {
 public:
  ...
  template <typename ChannelSummaryT = ChannelSummary>
  ChannelMembershipForAppInstanceUserSummary& WithChannelSummary(ChannelSummaryT&& value) {
  ...
  void SetAppInstanceUserMembershipSummary(AppInstanceUserMembershipSummaryT&& value) {
    m_appInstanceUserMembershipSummaryHasBeenSet = true;
    m_appInstanceUserMembershipSummary = std::forward<AppInstanceUserMembershipSummaryT>(value);
  }
  template <typename AppInstanceUserMembershipSummaryT = AppInstanceUserMembershipSummary>
  ChannelMembershipForAppInstanceUserSummary& WithAppInstanceUserMembershipSummary(AppInstanceUserMembershipSummaryT&& value) {
    SetAppInstanceUserMembershipSummary(std::forward<AppInstanceUserMembershipSummaryT>(value));
    return *this;
  }
  ///@}
 private:
