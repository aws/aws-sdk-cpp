...
class DescribeChannelMembershipResult {
 public:
  ...
  AWS_CHIMESDKMESSAGING_API DescribeChannelMembershipResult& operator=(
  ...
  template <typename ChannelMembershipT = ChannelMembership>
  DescribeChannelMembershipResult& WithChannelMembership(ChannelMembershipT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeChannelMembershipResult& WithRequestId(RequestIdT&& value) {
