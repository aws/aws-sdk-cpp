...
namespace Model
{
  ...
  public:
    ...
    template<typename ChannelArnT = Aws::String>
    RedactChannelMessageRequest& WithChannelArn(ChannelArnT&& value) { SetChannelArn(std::forward<ChannelArnT>(value)); return *this;}
    ///@}
    ...
    template<typename MessageIdT = Aws::String>
    RedactChannelMessageRequest& WithMessageId(MessageIdT&& value) { SetMessageId(std::forward<MessageIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ChimeBearerT = Aws::String>
    RedactChannelMessageRequest& WithChimeBearer(ChimeBearerT&& value) { SetChimeBearer(std::forward<ChimeBearerT>(value)); return *this;}
    ///@}
    ...
    template<typename SubChannelIdT = Aws::String>
    RedactChannelMessageRequest& WithSubChannelId(SubChannelIdT&& value) { SetSubChannelId(std::forward<SubChannelIdT>(value)); return *this;}
    ///@}
  private:
