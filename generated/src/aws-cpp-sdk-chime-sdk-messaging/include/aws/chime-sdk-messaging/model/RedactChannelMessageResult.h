...
class RedactChannelMessageResult {
 public:
  AWS_CHIMESDKMESSAGING_API RedactChannelMessageResult() = default;
  ...
  template <typename ChannelArnT = Aws::String>
  RedactChannelMessageResult& WithChannelArn(ChannelArnT&& value) {
  ...
  template <typename MessageIdT = Aws::String>
  RedactChannelMessageResult& WithMessageId(MessageIdT&& value) {
  ...
  template <typename SubChannelIdT = Aws::String>
  RedactChannelMessageResult& WithSubChannelId(SubChannelIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  RedactChannelMessageResult& WithRequestId(RequestIdT&& value) {
