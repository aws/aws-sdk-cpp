...
class GetChannelMessageResult {
 public:
  ...
  void SetChannelMessage(ChannelMessageT&& value) {
    m_channelMessageHasBeenSet = true;
    m_channelMessage = std::forward<ChannelMessageT>(value);
  }
  template <typename ChannelMessageT = ChannelMessage>
  GetChannelMessageResult& WithChannelMessage(ChannelMessageT&& value) {
    SetChannelMessage(std::forward<ChannelMessageT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetChannelMessageResult& WithRequestId(RequestIdT&& value) {
