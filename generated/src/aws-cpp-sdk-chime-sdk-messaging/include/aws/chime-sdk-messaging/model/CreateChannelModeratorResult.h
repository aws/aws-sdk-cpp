...
class CreateChannelModeratorResult {
 public:
  ...
  template <typename ChannelArnT = Aws::String>
  CreateChannelModeratorResult& WithChannelArn(ChannelArnT&& value) {
  ...
  void SetChannelModerator(ChannelModeratorT&& value) {
    m_channelModeratorHasBeenSet = true;
    m_channelModerator = std::forward<ChannelModeratorT>(value);
  }
  template <typename ChannelModeratorT = Identity>
  CreateChannelModeratorResult& WithChannelModerator(ChannelModeratorT&& value) {
    SetChannelModerator(std::forward<ChannelModeratorT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  CreateChannelModeratorResult& WithRequestId(RequestIdT&& value) {
