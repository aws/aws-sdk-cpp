...
class ChannelFlow {
 public:
  ...
  template <typename ChannelFlowArnT = Aws::String>
  ChannelFlow& WithChannelFlowArn(ChannelFlowArnT&& value) {
  ...
  template <typename ProcessorsT = Aws::Vector<Processor>>
  ChannelFlow& WithProcessors(ProcessorsT&& value) {
    SetProcessors(std::forward<ProcessorsT>(value));
    return *this;
  }
  template <typename ProcessorsT = Processor>
  ChannelFlow& AddProcessors(ProcessorsT&& value) {
    m_processorsHasBeenSet = true;
  ...
  template <typename NameT = Aws::String>
  ChannelFlow& WithName(NameT&& value) {
  ...
  template <typename CreatedTimestampT = Aws::Utils::DateTime>
  ChannelFlow& WithCreatedTimestamp(CreatedTimestampT&& value) {
  ...
  template <typename LastUpdatedTimestampT = Aws::Utils::DateTime>
  ChannelFlow& WithLastUpdatedTimestamp(LastUpdatedTimestampT&& value) {
