...
class GetChannelMessageStatusResult {
 public:
  ...
  AWS_CHIMESDKMESSAGING_API GetChannelMessageStatusResult& operator=(
  ...
  template <typename StatusT = ChannelMessageStatusStructure>
  GetChannelMessageStatusResult& WithStatus(StatusT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetChannelMessageStatusResult& WithRequestId(RequestIdT&& value) {
