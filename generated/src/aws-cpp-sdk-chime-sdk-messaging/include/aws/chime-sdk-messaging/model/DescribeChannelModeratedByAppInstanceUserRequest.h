...
class DescribeChannelModeratedByAppInstanceUserRequest : public ChimeSDKMessagingRequest {
 public:
  ...
  template <typename ChannelArnT = Aws::String>
  DescribeChannelModeratedByAppInstanceUserRequest& WithChannelArn(ChannelArnT&& value) {
  ...
  template <typename AppInstanceUserArnT = Aws::String>
  DescribeChannelModeratedByAppInstanceUserRequest& WithAppInstanceUserArn(AppInstanceUserArnT&& value) {
  ...
  template <typename ChimeBearerT = Aws::String>
  DescribeChannelModeratedByAppInstanceUserRequest& WithChimeBearer(ChimeBearerT&& value) {
