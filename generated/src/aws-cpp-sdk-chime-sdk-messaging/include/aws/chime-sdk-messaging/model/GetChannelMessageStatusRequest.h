...
class GetChannelMessageStatusRequest : public ChimeSDKMessagingRequest {
 public:
  ...
  template <typename ChannelArnT = Aws::String>
  GetChannelMessageStatusRequest& WithChannelArn(ChannelArnT&& value) {
  ...
  template <typename MessageIdT = Aws::String>
  GetChannelMessageStatusRequest& WithMessageId(MessageIdT&& value) {
  ...
  template <typename ChimeBearerT = Aws::String>
  GetChannelMessageStatusRequest& WithChimeBearer(ChimeBearerT&& value) {
  ...
  template <typename SubChannelIdT = Aws::String>
  GetChannelMessageStatusRequest& WithSubChannelId(SubChannelIdT&& value) {
