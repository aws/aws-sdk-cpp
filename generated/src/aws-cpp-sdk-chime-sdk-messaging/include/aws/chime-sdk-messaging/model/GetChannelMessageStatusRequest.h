...
namespace Model
{
  ...
  {
  public:
    AWS_CHIMESDKMESSAGING_API GetChannelMessageStatusRequest() = default;
    ...
    template<typename ChannelArnT = Aws::String>
    GetChannelMessageStatusRequest& WithChannelArn(ChannelArnT&& value) { SetChannelArn(std::forward<ChannelArnT>(value)); return *this;}
    ///@}
    ...
    template<typename MessageIdT = Aws::String>
    GetChannelMessageStatusRequest& WithMessageId(MessageIdT&& value) { SetMessageId(std::forward<MessageIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ChimeBearerT = Aws::String>
    GetChannelMessageStatusRequest& WithChimeBearer(ChimeBearerT&& value) { SetChimeBearer(std::forward<ChimeBearerT>(value)); return *this;}
    ///@}
    ...
    template<typename SubChannelIdT = Aws::String>
    GetChannelMessageStatusRequest& WithSubChannelId(SubChannelIdT&& value) { SetSubChannelId(std::forward<SubChannelIdT>(value)); return *this;}
    ///@}
  private:
