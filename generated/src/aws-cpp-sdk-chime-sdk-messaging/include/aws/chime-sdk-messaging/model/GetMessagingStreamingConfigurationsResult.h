...
class GetMessagingStreamingConfigurationsResult {
 public:
  ...
  AWS_CHIMESDKMESSAGING_API GetMessagingStreamingConfigurationsResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename StreamingConfigurationsT = Aws::Vector<StreamingConfiguration>>
  GetMessagingStreamingConfigurationsResult& WithStreamingConfigurations(StreamingConfigurationsT&& value) {
  ...
  GetMessagingStreamingConfigurationsResult& AddStreamingConfigurations(StreamingConfigurationsT&& value) {
    m_streamingConfigurationsHasBeenSet = true;
    m_streamingConfigurations.emplace_back(std::forward<StreamingConfigurationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetMessagingStreamingConfigurationsResult& WithRequestId(RequestIdT&& value) {
