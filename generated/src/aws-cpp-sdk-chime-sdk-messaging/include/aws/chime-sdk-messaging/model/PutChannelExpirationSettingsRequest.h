...
class PutChannelExpirationSettingsRequest : public ChimeSDKMessagingRequest {
 public:
  ...
  template <typename ChannelArnT = Aws::String>
  PutChannelExpirationSettingsRequest& WithChannelArn(ChannelArnT&& value) {
  ...
  template <typename ChimeBearerT = Aws::String>
  PutChannelExpirationSettingsRequest& WithChimeBearer(ChimeBearerT&& value) {
  ...
  template <typename ExpirationSettingsT = ExpirationSettings>
  PutChannelExpirationSettingsRequest& WithExpirationSettings(ExpirationSettingsT&& value) {
