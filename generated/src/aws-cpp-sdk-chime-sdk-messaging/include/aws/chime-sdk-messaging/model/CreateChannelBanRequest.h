...
namespace Model
{
  ...
  {
  public:
    AWS_CHIMESDKMESSAGING_API CreateChannelBanRequest() = default;
    ...
    template<typename ChannelArnT = Aws::String>
    CreateChannelBanRequest& WithChannelArn(ChannelArnT&& value) { SetChannelArn(std::forward<ChannelArnT>(value)); return *this;}
    ///@}
    ...
    template<typename MemberArnT = Aws::String>
    CreateChannelBanRequest& WithMemberArn(MemberArnT&& value) { SetMemberArn(std::forward<MemberArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ChimeBearerT = Aws::String>
    CreateChannelBanRequest& WithChimeBearer(ChimeBearerT&& value) { SetChimeBearer(std::forward<ChimeBearerT>(value)); return *this;}
    ///@}
  private:
