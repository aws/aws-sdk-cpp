...
class CreateChannelBanRequest : public ChimeSDKMessagingRequest {
 public:
  ...
  template <typename ChannelArnT = Aws::String>
  CreateChannelBanRequest& WithChannelArn(ChannelArnT&& value) {
  ...
  template <typename MemberArnT = Aws::String>
  CreateChannelBanRequest& WithMemberArn(MemberArnT&& value) {
  ...
  template <typename ChimeBearerT = Aws::String>
  CreateChannelBanRequest& WithChimeBearer(ChimeBearerT&& value) {
