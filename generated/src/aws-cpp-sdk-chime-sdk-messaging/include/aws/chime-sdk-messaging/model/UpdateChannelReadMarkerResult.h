...
class UpdateChannelReadMarkerResult {
 public:
  ...
  AWS_CHIMESDKMESSAGING_API UpdateChannelReadMarkerResult& operator=(
  ...
  template <typename ChannelArnT = Aws::String>
  UpdateChannelReadMarkerResult& WithChannelArn(ChannelArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateChannelReadMarkerResult& WithRequestId(RequestIdT&& value) {
