...
struct ListChannelMembershipsForAppInstanceUserPaginationTraits {
  using RequestType = Model::ListChannelMembershipsForAppInstanceUserRequest;
  using ResultType = Model::ListChannelMembershipsForAppInstanceUserResult;
  using OutcomeType = Model::ListChannelMembershipsForAppInstanceUserOutcome;
  using ClientType = Client;

  static OutcomeType Invoke(Client& client, const RequestType& request) { return client.ListChannelMembershipsForAppInstanceUser(request); }
