...
class AssociateChannelFlowRequest : public ChimeSDKMessagingRequest {
 public:
  ...
  template <typename ChannelArnT = Aws::String>
  AssociateChannelFlowRequest& WithChannelArn(ChannelArnT&& value) {
  ...
  template <typename ChannelFlowArnT = Aws::String>
  AssociateChannelFlowRequest& WithChannelFlowArn(ChannelFlowArnT&& value) {
  ...
  template <typename ChimeBearerT = Aws::String>
  AssociateChannelFlowRequest& WithChimeBearer(ChimeBearerT&& value) {
