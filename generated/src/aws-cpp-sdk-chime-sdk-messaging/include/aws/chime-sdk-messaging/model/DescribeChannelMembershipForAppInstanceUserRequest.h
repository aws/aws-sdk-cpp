...
class DescribeChannelMembershipForAppInstanceUserRequest : public ChimeSDKMessagingRequest {
 public:
  ...
  template <typename ChannelArnT = Aws::String>
  DescribeChannelMembershipForAppInstanceUserRequest& WithChannelArn(ChannelArnT&& value) {
  ...
  template <typename AppInstanceUserArnT = Aws::String>
  DescribeChannelMembershipForAppInstanceUserRequest& WithAppInstanceUserArn(AppInstanceUserArnT&& value) {
  ...
  template <typename ChimeBearerT = Aws::String>
  DescribeChannelMembershipForAppInstanceUserRequest& WithChimeBearer(ChimeBearerT&& value) {
