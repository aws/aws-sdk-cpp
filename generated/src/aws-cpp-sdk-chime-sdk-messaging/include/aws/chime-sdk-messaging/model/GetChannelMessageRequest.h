...
class GetChannelMessageRequest : public ChimeSDKMessagingRequest {
 public:
  ...
  template <typename ChannelArnT = Aws::String>
  GetChannelMessageRequest& WithChannelArn(ChannelArnT&& value) {
  ...
  template <typename MessageIdT = Aws::String>
  GetChannelMessageRequest& WithMessageId(MessageIdT&& value) {
  ...
  template <typename ChimeBearerT = Aws::String>
  GetChannelMessageRequest& WithChimeBearer(ChimeBearerT&& value) {
  ...
  template <typename SubChannelIdT = Aws::String>
  GetChannelMessageRequest& WithSubChannelId(SubChannelIdT&& value) {
