...
class ListChannelFlowsRequest : public ChimeSDKMessagingRequest {
 public:
  AWS_CHIMESDKMESSAGING_API ListChannelFlowsRequest() = default;
  ...
  template <typename AppInstanceArnT = Aws::String>
  ListChannelFlowsRequest& WithAppInstanceArn(AppInstanceArnT&& value) {
  ...
  inline ListChannelFlowsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListChannelFlowsRequest& WithNextToken(NextTokenT&& value) {
