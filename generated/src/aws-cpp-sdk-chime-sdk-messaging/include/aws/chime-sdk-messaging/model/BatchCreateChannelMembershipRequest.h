...
class BatchCreateChannelMembershipRequest : public ChimeSDKMessagingRequest {
 public:
  ...
  template <typename ChannelArnT = Aws::String>
  BatchCreateChannelMembershipRequest& WithChannelArn(ChannelArnT&& value) {
  ...
  inline BatchCreateChannelMembershipRequest& WithType(ChannelMembershipType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetMemberArns(MemberArnsT&& value) {
    m_memberArnsHasBeenSet = true;
    m_memberArns = std::forward<MemberArnsT>(value);
  }
  template <typename MemberArnsT = Aws::Vector<Aws::String>>
  BatchCreateChannelMembershipRequest& WithMemberArns(MemberArnsT&& value) {
    SetMemberArns(std::forward<MemberArnsT>(value));
    return *this;
  }
  template <typename MemberArnsT = Aws::String>
  BatchCreateChannelMembershipRequest& AddMemberArns(MemberArnsT&& value) {
    m_memberArnsHasBeenSet = true;
    m_memberArns.emplace_back(std::forward<MemberArnsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ChimeBearerT = Aws::String>
  BatchCreateChannelMembershipRequest& WithChimeBearer(ChimeBearerT&& value) {
  ...
  template <typename SubChannelIdT = Aws::String>
  BatchCreateChannelMembershipRequest& WithSubChannelId(SubChannelIdT&& value) {
