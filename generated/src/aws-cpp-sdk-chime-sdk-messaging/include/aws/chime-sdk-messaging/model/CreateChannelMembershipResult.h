...
class CreateChannelMembershipResult {
 public:
  ...
  AWS_CHIMESDKMESSAGING_API CreateChannelMembershipResult& operator=(
  ...
  template <typename ChannelArnT = Aws::String>
  CreateChannelMembershipResult& WithChannelArn(ChannelArnT&& value) {
  ...
  template <typename MemberT = Identity>
  CreateChannelMembershipResult& WithMember(MemberT&& value) {
  ...
  template <typename SubChannelIdT = Aws::String>
  CreateChannelMembershipResult& WithSubChannelId(SubChannelIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateChannelMembershipResult& WithRequestId(RequestIdT&& value) {
