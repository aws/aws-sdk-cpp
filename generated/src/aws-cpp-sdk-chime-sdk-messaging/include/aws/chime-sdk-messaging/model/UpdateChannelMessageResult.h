...
class UpdateChannelMessageResult {
 public:
  ...
  template <typename ChannelArnT = Aws::String>
  UpdateChannelMessageResult& WithChannelArn(ChannelArnT&& value) {
  ...
  template <typename MessageIdT = Aws::String>
  UpdateChannelMessageResult& WithMessageId(MessageIdT&& value) {
  ...
  template <typename StatusT = ChannelMessageStatusStructure>
  UpdateChannelMessageResult& WithStatus(StatusT&& value) {
  ...
  template <typename SubChannelIdT = Aws::String>
  UpdateChannelMessageResult& WithSubChannelId(SubChannelIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateChannelMessageResult& WithRequestId(RequestIdT&& value) {
