...
class ListChannelFlowsResult {
 public:
  ...
  void SetChannelFlows(ChannelFlowsT&& value) {
    m_channelFlowsHasBeenSet = true;
    m_channelFlows = std::forward<ChannelFlowsT>(value);
  }
  template <typename ChannelFlowsT = Aws::Vector<ChannelFlowSummary>>
  ListChannelFlowsResult& WithChannelFlows(ChannelFlowsT&& value) {
    SetChannelFlows(std::forward<ChannelFlowsT>(value));
    return *this;
  }
  template <typename ChannelFlowsT = ChannelFlowSummary>
  ListChannelFlowsResult& AddChannelFlows(ChannelFlowsT&& value) {
    m_channelFlowsHasBeenSet = true;
    m_channelFlows.emplace_back(std::forward<ChannelFlowsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListChannelFlowsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListChannelFlowsResult& WithRequestId(RequestIdT&& value) {
