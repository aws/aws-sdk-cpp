...
class ChannelModerator {
 public:
  ...
  void SetModerator(ModeratorT&& value) {
    m_moderatorHasBeenSet = true;
    m_moderator = std::forward<ModeratorT>(value);
  }
  template <typename ModeratorT = Identity>
  ChannelModerator& WithModerator(ModeratorT&& value) {
    SetModerator(std::forward<ModeratorT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ChannelArnT = Aws::String>
  ChannelModerator& WithChannelArn(ChannelArnT&& value) {
  ...
  template <typename CreatedTimestampT = Aws::Utils::DateTime>
  ChannelModerator& WithCreatedTimestamp(CreatedTimestampT&& value) {
  ...
  template <typename CreatedByT = Identity>
  ChannelModerator& WithCreatedBy(CreatedByT&& value) {
