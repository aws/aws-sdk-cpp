...
class ChannelAssociatedWithFlowSummary {
 public:
  ...
  template <typename NameT = Aws::String>
  ChannelAssociatedWithFlowSummary& WithName(NameT&& value) {
  ...
  template <typename ChannelArnT = Aws::String>
  ChannelAssociatedWithFlowSummary& WithChannelArn(ChannelArnT&& value) {
  ...
  inline void SetMode(ChannelMode value) {
    m_modeHasBeenSet = true;
    m_mode = value;
  }
  inline ChannelAssociatedWithFlowSummary& WithMode(ChannelMode value) {
    SetMode(value);
    return *this;
  }
  ///@}
  ...
  inline ChannelAssociatedWithFlowSummary& WithPrivacy(ChannelPrivacy value) {
    SetPrivacy(value);
    return *this;
  }
  ///@}
  ...
  template <typename MetadataT = Aws::String>
  ChannelAssociatedWithFlowSummary& WithMetadata(MetadataT&& value) {
