...
class DescribeChannelModeratorResult {
 public:
  ...
  AWS_CHIMESDKMESSAGING_API DescribeChannelModeratorResult& operator=(
  ...
  template <typename ChannelModeratorT = ChannelModerator>
  DescribeChannelModeratorResult& WithChannelModerator(ChannelModeratorT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeChannelModeratorResult& WithRequestId(RequestIdT&& value) {
