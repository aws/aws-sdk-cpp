...
class GetChannelMembershipPreferencesRequest : public ChimeSDKMessagingRequest {
 public:
  ...
  template <typename ChannelArnT = Aws::String>
  GetChannelMembershipPreferencesRequest& WithChannelArn(ChannelArnT&& value) {
  ...
  template <typename MemberArnT = Aws::String>
  GetChannelMembershipPreferencesRequest& WithMemberArn(MemberArnT&& value) {
  ...
  template <typename ChimeBearerT = Aws::String>
  GetChannelMembershipPreferencesRequest& WithChimeBearer(ChimeBearerT&& value) {
