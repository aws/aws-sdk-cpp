...
class DeleteChannelFlowRequest : public ChimeSDKMessagingRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "DeleteChannelFlow"; }
  ...
  template <typename ChannelFlowArnT = Aws::String>
  DeleteChannelFlowRequest& WithChannelFlowArn(ChannelFlowArnT&& value) {
