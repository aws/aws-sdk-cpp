...
class ListChannelMembershipsForAppInstanceUserRequest : public ChimeSDKMessagingRequest {
 public:
  AWS_CHIMESDKMESSAGING_API ListChannelMembershipsForAppInstanceUserRequest() = default;
  ...
  template <typename AppInstanceUserArnT = Aws::String>
  ListChannelMembershipsForAppInstanceUserRequest& WithAppInstanceUserArn(AppInstanceUserArnT&& value) {
  ...
  inline ListChannelMembershipsForAppInstanceUserRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListChannelMembershipsForAppInstanceUserRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ChimeBearerT = Aws::String>
  ListChannelMembershipsForAppInstanceUserRequest& WithChimeBearer(ChimeBearerT&& value) {
