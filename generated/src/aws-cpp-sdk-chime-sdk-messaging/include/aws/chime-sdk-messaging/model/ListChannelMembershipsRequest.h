...
class ListChannelMembershipsRequest : public ChimeSDKMessagingRequest {
 public:
  ...
  template <typename ChannelArnT = Aws::String>
  ListChannelMembershipsRequest& WithChannelArn(ChannelArnT&& value) {
  ...
  inline ListChannelMembershipsRequest& WithType(ChannelMembershipType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline ListChannelMembershipsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListChannelMembershipsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ChimeBearerT = Aws::String>
  ListChannelMembershipsRequest& WithChimeBearer(ChimeBearerT&& value) {
  ...
  template <typename SubChannelIdT = Aws::String>
  ListChannelMembershipsRequest& WithSubChannelId(SubChannelIdT&& value) {
