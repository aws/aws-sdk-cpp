...
class GetChannelMembershipPreferencesResult {
 public:
  ...
  AWS_CHIMESDKMESSAGING_API GetChannelMembershipPreferencesResult& operator=(
  ...
  template <typename ChannelArnT = Aws::String>
  GetChannelMembershipPreferencesResult& WithChannelArn(ChannelArnT&& value) {
  ...
  template <typename MemberT = Identity>
  GetChannelMembershipPreferencesResult& WithMember(MemberT&& value) {
  ...
  template <typename PreferencesT = ChannelMembershipPreferences>
  GetChannelMembershipPreferencesResult& WithPreferences(PreferencesT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetChannelMembershipPreferencesResult& WithRequestId(RequestIdT&& value) {
