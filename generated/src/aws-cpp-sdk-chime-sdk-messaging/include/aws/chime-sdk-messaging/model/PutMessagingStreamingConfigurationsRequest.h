...
class PutMessagingStreamingConfigurationsRequest : public ChimeSDKMessagingRequest {
 public:
  ...
  template <typename AppInstanceArnT = Aws::String>
  PutMessagingStreamingConfigurationsRequest& WithAppInstanceArn(AppInstanceArnT&& value) {
  ...
  template <typename StreamingConfigurationsT = Aws::Vector<StreamingConfiguration>>
  PutMessagingStreamingConfigurationsRequest& WithStreamingConfigurations(StreamingConfigurationsT&& value) {
  ...
  PutMessagingStreamingConfigurationsRequest& AddStreamingConfigurations(StreamingConfigurationsT&& value) {
    m_streamingConfigurationsHasBeenSet = true;
