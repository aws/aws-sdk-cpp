...
class ChannelMessageCallback {
 public:
  ...
  template <typename MessageIdT = Aws::String>
  ChannelMessageCallback& WithMessageId(MessageIdT&& value) {
  ...
  template <typename ContentT = Aws::String>
  ChannelMessageCallback& WithContent(ContentT&& value) {
  ...
  template <typename MetadataT = Aws::String>
  ChannelMessageCallback& WithMetadata(MetadataT&& value) {
  ...
  template <typename PushNotificationT = PushNotificationConfiguration>
  ChannelMessageCallback& WithPushNotification(PushNotificationT&& value) {
  ...
  template <typename MessageAttributesT = Aws::Map<Aws::String, MessageAttributeValue>>
  ChannelMessageCallback& WithMessageAttributes(MessageAttributesT&& value) {
  ...
  template <typename SubChannelIdT = Aws::String>
  ChannelMessageCallback& WithSubChannelId(SubChannelIdT&& value) {
  ...
  template <typename ContentTypeT = Aws::String>
  ChannelMessageCallback& WithContentType(ContentTypeT&& value) {
