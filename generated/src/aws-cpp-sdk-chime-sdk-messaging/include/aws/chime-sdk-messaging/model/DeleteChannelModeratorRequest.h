...
class DeleteChannelModeratorRequest : public ChimeSDKMessagingRequest {
 public:
  ...
  template <typename ChannelArnT = Aws::String>
  DeleteChannelModeratorRequest& WithChannelArn(ChannelArnT&& value) {
  ...
  template <typename ChannelModeratorArnT = Aws::String>
  DeleteChannelModeratorRequest& WithChannelModeratorArn(ChannelModeratorArnT&& value) {
  ...
  template <typename ChimeBearerT = Aws::String>
  DeleteChannelModeratorRequest& WithChimeBearer(ChimeBearerT&& value) {
