...
namespace Model
{
  ...
  {
  public:
    AWS_CHIMESDKMESSAGING_API DeleteChannelModeratorRequest() = default;
    ...
    template<typename ChannelArnT = Aws::String>
    DeleteChannelModeratorRequest& WithChannelArn(ChannelArnT&& value) { SetChannelArn(std::forward<ChannelArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ChannelModeratorArnT = Aws::String>
    DeleteChannelModeratorRequest& WithChannelModeratorArn(ChannelModeratorArnT&& value) { SetChannelModeratorArn(std::forward<ChannelModeratorArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ChimeBearerT = Aws::String>
    DeleteChannelModeratorRequest& WithChimeBearer(ChimeBearerT&& value) { SetChimeBearer(std::forward<ChimeBearerT>(value)); return *this;}
    ///@}
  private:
