...
class CreateChannelRequest : public ChimeSDKMessagingRequest {
 public:
  ...
  template <typename AppInstanceArnT = Aws::String>
  CreateChannelRequest& WithAppInstanceArn(AppInstanceArnT&& value) {
  ...
  inline CreateChannelRequest& WithMode(ChannelMode value) {
    SetMode(value);
    return *this;
  }
  ///@}
  ...
  inline CreateChannelRequest& WithPrivacy(ChannelPrivacy value) {
    SetPrivacy(value);
    return *this;
  }
  ///@}
  ...
  template <typename MetadataT = Aws::String>
  CreateChannelRequest& WithMetadata(MetadataT&& value) {
  ...
  template <typename ClientRequestTokenT = Aws::String>
  CreateChannelRequest& WithClientRequestToken(ClientRequestTokenT&& value) {
  ...
  template <typename ChimeBearerT = Aws::String>
  CreateChannelRequest& WithChimeBearer(ChimeBearerT&& value) {
  ...
  template <typename ChannelIdT = Aws::String>
  CreateChannelRequest& WithChannelId(ChannelIdT&& value) {
  ...
  template <typename MemberArnsT = Aws::Vector<Aws::String>>
  CreateChannelRequest& WithMemberArns(MemberArnsT&& value) {
    SetMemberArns(std::forward<MemberArnsT>(value));
    return *this;
  }
  template <typename MemberArnsT = Aws::String>
  CreateChannelRequest& AddMemberArns(MemberArnsT&& value) {
    m_memberArnsHasBeenSet = true;
  ...
  void SetModeratorArns(ModeratorArnsT&& value) {
    m_moderatorArnsHasBeenSet = true;
    m_moderatorArns = std::forward<ModeratorArnsT>(value);
  }
  template <typename ModeratorArnsT = Aws::Vector<Aws::String>>
  CreateChannelRequest& WithModeratorArns(ModeratorArnsT&& value) {
    SetModeratorArns(std::forward<ModeratorArnsT>(value));
    return *this;
  }
  template <typename ModeratorArnsT = Aws::String>
  CreateChannelRequest& AddModeratorArns(ModeratorArnsT&& value) {
    m_moderatorArnsHasBeenSet = true;
    m_moderatorArns.emplace_back(std::forward<ModeratorArnsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetElasticChannelConfiguration(ElasticChannelConfigurationT&& value) {
    m_elasticChannelConfigurationHasBeenSet = true;
    m_elasticChannelConfiguration = std::forward<ElasticChannelConfigurationT>(value);
  }
  template <typename ElasticChannelConfigurationT = ElasticChannelConfiguration>
  CreateChannelRequest& WithElasticChannelConfiguration(ElasticChannelConfigurationT&& value) {
    SetElasticChannelConfiguration(std::forward<ElasticChannelConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ExpirationSettingsT = ExpirationSettings>
  CreateChannelRequest& WithExpirationSettings(ExpirationSettingsT&& value) {
