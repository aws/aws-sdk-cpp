...
class ChannelMessageSummary {
 public:
  ...
  template <typename MessageIdT = Aws::String>
  ChannelMessageSummary& WithMessageId(MessageIdT&& value) {
  ...
  template <typename ContentT = Aws::String>
  ChannelMessageSummary& WithContent(ContentT&& value) {
  ...
  template <typename MetadataT = Aws::String>
  ChannelMessageSummary& WithMetadata(MetadataT&& value) {
  ...
  inline ChannelMessageSummary& WithType(ChannelMessageType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreatedTimestampT = Aws::Utils::DateTime>
  ChannelMessageSummary& WithCreatedTimestamp(CreatedTimestampT&& value) {
  ...
  template <typename LastUpdatedTimestampT = Aws::Utils::DateTime>
  ChannelMessageSummary& WithLastUpdatedTimestamp(LastUpdatedTimestampT&& value) {
  ...
  template <typename LastEditedTimestampT = Aws::Utils::DateTime>
  ChannelMessageSummary& WithLastEditedTimestamp(LastEditedTimestampT&& value) {
  ...
  template <typename SenderT = Identity>
  ChannelMessageSummary& WithSender(SenderT&& value) {
  ...
  inline ChannelMessageSummary& WithRedacted(bool value) {
    SetRedacted(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusT = ChannelMessageStatusStructure>
  ChannelMessageSummary& WithStatus(StatusT&& value) {
  ...
  template <typename MessageAttributesT = Aws::Map<Aws::String, MessageAttributeValue>>
  ChannelMessageSummary& WithMessageAttributes(MessageAttributesT&& value) {
  ...
  template <typename ContentTypeT = Aws::String>
  ChannelMessageSummary& WithContentType(ContentTypeT&& value) {
  ...
  template <typename TargetT = Aws::Vector<Target>>
  ChannelMessageSummary& WithTarget(TargetT&& value) {
    SetTarget(std::forward<TargetT>(value));
    return *this;
  }
  template <typename TargetT = Target>
  ChannelMessageSummary& AddTarget(TargetT&& value) {
    m_targetHasBeenSet = true;
