...
class GetMessagingSessionEndpointResult {
 public:
  ...
  AWS_CHIMESDKMESSAGING_API GetMessagingSessionEndpointResult& operator=(
  ...
  template <typename EndpointT = MessagingSessionEndpoint>
  GetMessagingSessionEndpointResult& WithEndpoint(EndpointT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetMessagingSessionEndpointResult& WithRequestId(RequestIdT&& value) {
