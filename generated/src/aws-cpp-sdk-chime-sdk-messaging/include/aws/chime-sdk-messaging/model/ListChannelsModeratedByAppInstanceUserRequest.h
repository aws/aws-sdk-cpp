...
class ListChannelsModeratedByAppInstanceUserRequest : public ChimeSDKMessagingRequest {
 public:
  ...
  template <typename AppInstanceUserArnT = Aws::String>
  ListChannelsModeratedByAppInstanceUserRequest& WithAppInstanceUserArn(AppInstanceUserArnT&& value) {
  ...
  inline ListChannelsModeratedByAppInstanceUserRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListChannelsModeratedByAppInstanceUserRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ChimeBearerT = Aws::String>
  ListChannelsModeratedByAppInstanceUserRequest& WithChimeBearer(ChimeBearerT&& value) {
