...
class DeleteChannelMembershipRequest : public ChimeSDKMessagingRequest {
 public:
  ...
  template <typename ChannelArnT = Aws::String>
  DeleteChannelMembershipRequest& WithChannelArn(ChannelArnT&& value) {
  ...
  template <typename MemberArnT = Aws::String>
  DeleteChannelMembershipRequest& WithMemberArn(MemberArnT&& value) {
  ...
  template <typename ChimeBearerT = Aws::String>
  DeleteChannelMembershipRequest& WithChimeBearer(ChimeBearerT&& value) {
  ...
  template <typename SubChannelIdT = Aws::String>
  DeleteChannelMembershipRequest& WithSubChannelId(SubChannelIdT&& value) {
