...
namespace Model
{
  ...
  {
  public:
    AWS_CHIMESDKMESSAGING_API DeleteChannelMembershipRequest() = default;
    ...
    template<typename ChannelArnT = Aws::String>
    DeleteChannelMembershipRequest& WithChannelArn(ChannelArnT&& value) { SetChannelArn(std::forward<ChannelArnT>(value)); return *this;}
    ///@}
    ...
    template<typename MemberArnT = Aws::String>
    DeleteChannelMembershipRequest& WithMemberArn(MemberArnT&& value) { SetMemberArn(std::forward<MemberArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ChimeBearerT = Aws::String>
    DeleteChannelMembershipRequest& WithChimeBearer(ChimeBearerT&& value) { SetChimeBearer(std::forward<ChimeBearerT>(value)); return *this;}
    ///@}
    ...
    template<typename SubChannelIdT = Aws::String>
    DeleteChannelMembershipRequest& WithSubChannelId(SubChannelIdT&& value) { SetSubChannelId(std::forward<SubChannelIdT>(value)); return *this;}
    ///@}
  private:
