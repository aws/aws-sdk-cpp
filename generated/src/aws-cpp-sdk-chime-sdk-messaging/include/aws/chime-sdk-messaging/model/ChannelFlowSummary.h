...
class ChannelFlowSummary {
 public:
  ...
  template <typename ChannelFlowArnT = Aws::String>
  ChannelFlowSummary& WithChannelFlowArn(ChannelFlowArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  ChannelFlowSummary& WithName(NameT&& value) {
  ...
  template <typename ProcessorsT = Aws::Vector<Processor>>
  ChannelFlowSummary& WithProcessors(ProcessorsT&& value) {
    SetProcessors(std::forward<ProcessorsT>(value));
    return *this;
  }
  template <typename ProcessorsT = Processor>
  ChannelFlowSummary& AddProcessors(ProcessorsT&& value) {
    m_processorsHasBeenSet = true;
