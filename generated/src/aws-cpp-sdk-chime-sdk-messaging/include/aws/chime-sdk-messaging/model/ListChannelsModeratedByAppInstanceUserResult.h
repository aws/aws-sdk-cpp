...
class ListChannelsModeratedByAppInstanceUserResult {
 public:
  ...
  AWS_CHIMESDKMESSAGING_API ListChannelsModeratedByAppInstanceUserResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ChannelsT = Aws::Vector<ChannelModeratedByAppInstanceUserSummary>>
  ListChannelsModeratedByAppInstanceUserResult& WithChannels(ChannelsT&& value) {
    SetChannels(std::forward<ChannelsT>(value));
    return *this;
  }
  template <typename ChannelsT = ChannelModeratedByAppInstanceUserSummary>
  ListChannelsModeratedByAppInstanceUserResult& AddChannels(ChannelsT&& value) {
    m_channelsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListChannelsModeratedByAppInstanceUserResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListChannelsModeratedByAppInstanceUserResult& WithRequestId(RequestIdT&& value) {
