...
namespace Model
{
  ...
  public:
    ...
    template<typename ChannelArnT = Aws::String>
    PutChannelMembershipPreferencesResult& WithChannelArn(ChannelArnT&& value) { SetChannelArn(std::forward<ChannelArnT>(value)); return *this;}
    ///@}
    ...
    template<typename MemberT = Identity>
    PutChannelMembershipPreferencesResult& WithMember(MemberT&& value) { SetMember(std::forward<MemberT>(value)); return *this;}
    ///@}
    ...
    template<typename PreferencesT = ChannelMembershipPreferences>
    PutChannelMembershipPreferencesResult& WithPreferences(PreferencesT&& value) { SetPreferences(std::forward<PreferencesT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    PutChannelMembershipPreferencesResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
