...
class DisassociateChannelFlowRequest : public ChimeSDKMessagingRequest {
 public:
  ...
  template <typename ChannelArnT = Aws::String>
  DisassociateChannelFlowRequest& WithChannelArn(ChannelArnT&& value) {
  ...
  template <typename ChannelFlowArnT = Aws::String>
  DisassociateChannelFlowRequest& WithChannelFlowArn(ChannelFlowArnT&& value) {
  ...
  template <typename ChimeBearerT = Aws::String>
  DisassociateChannelFlowRequest& WithChimeBearer(ChimeBearerT&& value) {
