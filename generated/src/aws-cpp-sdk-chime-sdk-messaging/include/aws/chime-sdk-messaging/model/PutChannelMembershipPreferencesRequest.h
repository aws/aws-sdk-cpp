...
class PutChannelMembershipPreferencesRequest : public ChimeSDKMessagingRequest {
 public:
  ...
  template <typename ChannelArnT = Aws::String>
  PutChannelMembershipPreferencesRequest& WithChannelArn(ChannelArnT&& value) {
  ...
  template <typename MemberArnT = Aws::String>
  PutChannelMembershipPreferencesRequest& WithMemberArn(MemberArnT&& value) {
  ...
  template <typename ChimeBearerT = Aws::String>
  PutChannelMembershipPreferencesRequest& WithChimeBearer(ChimeBearerT&& value) {
  ...
  template <typename PreferencesT = ChannelMembershipPreferences>
  PutChannelMembershipPreferencesRequest& WithPreferences(PreferencesT&& value) {
