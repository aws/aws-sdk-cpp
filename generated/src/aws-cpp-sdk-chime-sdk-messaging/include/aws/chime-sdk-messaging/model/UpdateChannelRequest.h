...
class UpdateChannelRequest : public ChimeSDKMessagingRequest {
 public:
  ...
  inline UpdateChannelRequest& WithMode(ChannelMode value) {
    SetMode(value);
    return *this;
  }
  ///@}
  ...
  template <typename MetadataT = Aws::String>
  UpdateChannelRequest& WithMetadata(MetadataT&& value) {
  ...
  template <typename ChimeBearerT = Aws::String>
  UpdateChannelRequest& WithChimeBearer(ChimeBearerT&& value) {
