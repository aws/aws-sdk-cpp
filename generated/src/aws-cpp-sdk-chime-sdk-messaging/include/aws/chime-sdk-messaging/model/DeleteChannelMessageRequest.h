...
class DeleteChannelMessageRequest : public ChimeSDKMessagingRequest {
 public:
  ...
  template <typename ChannelArnT = Aws::String>
  DeleteChannelMessageRequest& WithChannelArn(ChannelArnT&& value) {
  ...
  template <typename MessageIdT = Aws::String>
  DeleteChannelMessageRequest& WithMessageId(MessageIdT&& value) {
  ...
  template <typename ChimeBearerT = Aws::String>
  DeleteChannelMessageRequest& WithChimeBearer(ChimeBearerT&& value) {
  ...
  template <typename SubChannelIdT = Aws::String>
  DeleteChannelMessageRequest& WithSubChannelId(SubChannelIdT&& value) {
