...
class SearchChannelsResult {
 public:
  ...
  template <typename ChannelsT = Aws::Vector<ChannelSummary>>
  SearchChannelsResult& WithChannels(ChannelsT&& value) {
    SetChannels(std::forward<ChannelsT>(value));
    return *this;
  }
  template <typename ChannelsT = ChannelSummary>
  SearchChannelsResult& AddChannels(ChannelsT&& value) {
    m_channelsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  SearchChannelsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  SearchChannelsResult& WithRequestId(RequestIdT&& value) {
