...
class ListChannelMembershipsResult {
 public:
  ...
  template <typename ChannelArnT = Aws::String>
  ListChannelMembershipsResult& WithChannelArn(ChannelArnT&& value) {
  ...
  template <typename ChannelMembershipsT = Aws::Vector<ChannelMembershipSummary>>
  ListChannelMembershipsResult& WithChannelMemberships(ChannelMembershipsT&& value) {
  ...
  ListChannelMembershipsResult& AddChannelMemberships(ChannelMembershipsT&& value) {
    m_channelMembershipsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListChannelMembershipsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListChannelMembershipsResult& WithRequestId(RequestIdT&& value) {
