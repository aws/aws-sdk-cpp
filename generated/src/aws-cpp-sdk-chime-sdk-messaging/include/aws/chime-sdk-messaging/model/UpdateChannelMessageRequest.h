...
class UpdateChannelMessageRequest : public ChimeSDKMessagingRequest {
 public:
  ...
  template <typename ChannelArnT = Aws::String>
  UpdateChannelMessageRequest& WithChannelArn(ChannelArnT&& value) {
  ...
  template <typename MessageIdT = Aws::String>
  UpdateChannelMessageRequest& WithMessageId(MessageIdT&& value) {
  ...
  template <typename ContentT = Aws::String>
  UpdateChannelMessageRequest& WithContent(ContentT&& value) {
  ...
  template <typename MetadataT = Aws::String>
  UpdateChannelMessageRequest& WithMetadata(MetadataT&& value) {
  ...
  template <typename ChimeBearerT = Aws::String>
  UpdateChannelMessageRequest& WithChimeBearer(ChimeBearerT&& value) {
  ...
  template <typename SubChannelIdT = Aws::String>
  UpdateChannelMessageRequest& WithSubChannelId(SubChannelIdT&& value) {
  ...
  template <typename ContentTypeT = Aws::String>
  UpdateChannelMessageRequest& WithContentType(ContentTypeT&& value) {
