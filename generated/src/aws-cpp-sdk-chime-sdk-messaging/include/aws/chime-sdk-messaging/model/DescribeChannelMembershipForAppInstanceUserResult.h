...
class DescribeChannelMembershipForAppInstanceUserResult {
 public:
  ...
  AWS_CHIMESDKMESSAGING_API DescribeChannelMembershipForAppInstanceUserResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  void SetChannelMembership(ChannelMembershipT&& value) {
    m_channelMembershipHasBeenSet = true;
    m_channelMembership = std::forward<ChannelMembershipT>(value);
  }
  template <typename ChannelMembershipT = ChannelMembershipForAppInstanceUserSummary>
  DescribeChannelMembershipForAppInstanceUserResult& WithChannelMembership(ChannelMembershipT&& value) {
    SetChannelMembership(std::forward<ChannelMembershipT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeChannelMembershipForAppInstanceUserResult& WithRequestId(RequestIdT&& value) {
