...
class PushNotificationPreferences {
 public:
  ...
  inline void SetAllowNotifications(AllowNotifications value) {
    m_allowNotificationsHasBeenSet = true;
    m_allowNotifications = value;
  }
  inline PushNotificationPreferences& WithAllowNotifications(AllowNotifications value) {
  ...
  void SetFilterRule(FilterRuleT&& value) {
    m_filterRuleHasBeenSet = true;
    m_filterRule = std::forward<FilterRuleT>(value);
  }
  template <typename FilterRuleT = Aws::String>
  PushNotificationPreferences& WithFilterRule(FilterRuleT&& value) {
    SetFilterRule(std::forward<FilterRuleT>(value));
    return *this;
  }
  ///@}
 private:
