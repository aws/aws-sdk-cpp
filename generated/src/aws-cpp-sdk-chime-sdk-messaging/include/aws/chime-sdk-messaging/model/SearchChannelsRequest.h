...
class SearchChannelsRequest : public ChimeSDKMessagingRequest {
 public:
  AWS_CHIMESDKMESSAGING_API SearchChannelsRequest() = default;
  ...
  template <typename ChimeBearerT = Aws::String>
  SearchChannelsRequest& WithChimeBearer(ChimeBearerT&& value) {
  ...
  template <typename FieldsT = Aws::Vector<SearchField>>
  void SetFields(FieldsT&& value) {
    m_fieldsHasBeenSet = true;
    m_fields = std::forward<FieldsT>(value);
  }
  template <typename FieldsT = Aws::Vector<SearchField>>
  SearchChannelsRequest& WithFields(FieldsT&& value) {
    SetFields(std::forward<FieldsT>(value));
    return *this;
  }
  template <typename FieldsT = SearchField>
  SearchChannelsRequest& AddFields(FieldsT&& value) {
    m_fieldsHasBeenSet = true;
  ...
  inline SearchChannelsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  SearchChannelsRequest& WithNextToken(NextTokenT&& value) {
