...
namespace Model
{
  ...
  {
  public:
    AWS_CHIMESDKMESSAGING_API DeleteChannelBanRequest() = default;
    ...
    template<typename ChannelArnT = Aws::String>
    DeleteChannelBanRequest& WithChannelArn(ChannelArnT&& value) { SetChannelArn(std::forward<ChannelArnT>(value)); return *this;}
    ///@}
    ...
    template<typename MemberArnT = Aws::String>
    DeleteChannelBanRequest& WithMemberArn(MemberArnT&& value) { SetMemberArn(std::forward<MemberArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ChimeBearerT = Aws::String>
    DeleteChannelBanRequest& WithChimeBearer(ChimeBearerT&& value) { SetChimeBearer(std::forward<ChimeBearerT>(value)); return *this;}
    ///@}
  private:
