...
class DeleteChannelBanRequest : public ChimeSDKMessagingRequest {
 public:
  ...
  template <typename ChannelArnT = Aws::String>
  DeleteChannelBanRequest& WithChannelArn(ChannelArnT&& value) {
  ...
  template <typename MemberArnT = Aws::String>
  DeleteChannelBanRequest& WithMemberArn(MemberArnT&& value) {
  ...
  template <typename ChimeBearerT = Aws::String>
  DeleteChannelBanRequest& WithChimeBearer(ChimeBearerT&& value) {
