...
class ListSubChannelsResult {
 public:
  ...
  template <typename ChannelArnT = Aws::String>
  ListSubChannelsResult& WithChannelArn(ChannelArnT&& value) {
  ...
  void SetSubChannels(SubChannelsT&& value) {
    m_subChannelsHasBeenSet = true;
    m_subChannels = std::forward<SubChannelsT>(value);
  }
  template <typename SubChannelsT = Aws::Vector<SubChannelSummary>>
  ListSubChannelsResult& WithSubChannels(SubChannelsT&& value) {
    SetSubChannels(std::forward<SubChannelsT>(value));
    return *this;
  }
  template <typename SubChannelsT = SubChannelSummary>
  ListSubChannelsResult& AddSubChannels(SubChannelsT&& value) {
    m_subChannelsHasBeenSet = true;
    m_subChannels.emplace_back(std::forward<SubChannelsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListSubChannelsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListSubChannelsResult& WithRequestId(RequestIdT&& value) {
