...
class AppInstanceUserMembershipSummary {
 public:
  ...
  inline void SetType(ChannelMembershipType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline AppInstanceUserMembershipSummary& WithType(ChannelMembershipType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetReadMarkerTimestamp(ReadMarkerTimestampT&& value) {
    m_readMarkerTimestampHasBeenSet = true;
    m_readMarkerTimestamp = std::forward<ReadMarkerTimestampT>(value);
  }
  template <typename ReadMarkerTimestampT = Aws::Utils::DateTime>
  AppInstanceUserMembershipSummary& WithReadMarkerTimestamp(ReadMarkerTimestampT&& value) {
    SetReadMarkerTimestamp(std::forward<ReadMarkerTimestampT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename SubChannelIdT = Aws::String>
  AppInstanceUserMembershipSummary& WithSubChannelId(SubChannelIdT&& value) {
