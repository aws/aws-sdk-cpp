 ...
 * addresses and coordinates. See <a
 * href="https://docs.aws.amazon.com/location/latest/APIReference/API_geoplaces_Geocode.html">Geocode</a>
 * and <a
 * href="https://docs.aws.amazon.com/location/latest/APIReference/API_geoplaces_ReverseGeocode.html">ReverseGeocode</a>.</p>
 * </li> <li> <p>Comprehensive place searches with detailed information. See <a
 * href="https://docs.aws.amazon.com/location/latest/APIReference/API_geoplaces_SearchText.html">SearchText</a>,
 * <a
 * href="https://docs.aws.amazon.com/location/latest/APIReference/API_geoplaces_SearchNearby.html">SearchNearby</a>,
 * and <a
 * href="https://docs.aws.amazon.com/location/latest/APIReference/API_geoplaces_GetPlace.html">GetPlace</a>.
 * Place information you can find include:</p> <ul> <li> <p>Business names and
 * addresses</p> </li> <li> <p>Contact information</p> </li> <li> <p>Hours of
 * operation</p> </li> <li> <p>Points of Interest (POI) categories</p> </li> <li>
 * <p>Food types for restaurants</p> </li> <li> <p>Chain affiliation for relevant
 * businesses</p> </li> </ul> </li> <li> <p>Address and place completion as users
 * type, enhancing input efficiency by completing partial queries with valid
 * addresses. See <a
 * href="https://docs.aws.amazon.com/location/latest/APIReference/API_geoplaces_Autocomplete.html">Autocomplete</a>.</p>
 * </li> <li> <p>Intelligent place and query recommendation based on user's input
 * or context, returning relevant places, points of interest, query terms, or
 * search categories. See <a
 * href="https://docs.aws.amazon.com/location/latest/APIReference/API_geoplaces_Suggest.html">Suggest</a>.</p>
 * </li> <li> <p>Global data coverage with a wide range of POI categories.</p>
 * </li> <li> <p>Regular data updates to ensure accuracy and relevance.</p> </li>
 * <li> <p>Bulk address validation for verifying and standardizing large volumes of
 * addresses in a single operation using <a
 * href="https://docs.aws.amazon.com/location/latest/APIReference/Welcome.html#Welcome_Amazon_Location_Service_Jobs">Amazon
 * Location Service Jobs</a>.</p> </li> </ul>
 */
class AWS_GEOPLACES_API GeoPlacesClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  GeoPlacesClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<GeoPlacesEndpointProviderBase> endpointProvider = nullptr,
   ...
   * language and political views. Not supported in <code>ap-southeast-1</code> and
   ...
   * customers.</p> <p>For more information, see <a
  ...
  /**
   * An Async wrapper for Autocomplete that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename AutocompleteRequestT = Model::AutocompleteRequest>
  void AutocompleteAsync(const AutocompleteRequestT& request, const AutocompleteResponseReceivedHandler& handler,
  ...
  /**
   * An Async wrapper for Geocode that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GeocodeRequestT = Model::GeocodeRequest>
  void GeocodeAsync(const GeocodeResponseReceivedHandler& handler,
                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                    const GeocodeRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetPlace that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetPlaceRequestT = Model::GetPlaceRequest>
  void GetPlaceAsync(const GetPlaceRequestT& request, const GetPlaceResponseReceivedHandler& handler,
                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ReverseGeocode that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ReverseGeocodeRequestT = Model::ReverseGeocodeRequest>
  void ReverseGeocodeAsync(const ReverseGeocodeRequestT& request, const ReverseGeocodeResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * parameters. Not supported in <code>ap-southeast-1</code> and
   * <code>ap-southeast-5</code> regions for <a
   * href="https://docs.aws.amazon.com/location/latest/developerguide/GrabMaps.html">GrabMaps</a>
   * customers.</p> <p>For more information, see <a
  ...
  /**
   * An Async wrapper for SearchNearby that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename SearchNearbyRequestT = Model::SearchNearbyRequest>
  void SearchNearbyAsync(const SearchNearbyRequestT& request, const SearchNearbyResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for SearchText that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename SearchTextRequestT = Model::SearchTextRequest>
  void SearchTextAsync(const SearchTextResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                       const SearchTextRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for Suggest that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename SuggestRequestT = Model::SuggestRequest>
  void SuggestAsync(const SuggestRequestT& request, const SuggestResponseReceivedHandler& handler,
                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
