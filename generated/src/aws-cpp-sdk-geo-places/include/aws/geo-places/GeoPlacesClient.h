...
namespace GeoPlaces
{
   ...
   * relevance</p> </li> </ul>
   */
  class AWS_GEOPLACES_API GeoPlacesClient : Aws::Client::ClientWithAsyncTemplateMethods<GeoPlacesClient>,
    smithy::client::AwsSmithyClientT<Aws::GeoPlaces::SERVICE_NAME,
