...
namespace Model
{
  ...
  public:
    ...
    template<typename CodeT = Aws::Vector<Highlight>>
    RegionHighlights& WithCode(CodeT&& value) { SetCode(std::forward<CodeT>(value)); return *this;}
    template<typename CodeT = Highlight>
    RegionHighlights& AddCode(CodeT&& value) { m_codeHasBeenSet = true; m_code.emplace_back(std::forward<CodeT>(value)); return *this; }
    ///@}
    ...
    template<typename NameT = Aws::Vector<Highlight>>
    RegionHighlights& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    template<typename NameT = Highlight>
    RegionHighlights& AddName(NameT&& value) { m_nameHasBeenSet = true; m_name.emplace_back(std::forward<NameT>(value)); return *this; }
    ///@}
  private:
