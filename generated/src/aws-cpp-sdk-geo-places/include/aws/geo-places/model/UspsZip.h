...
class UspsZip {
 public:
  ...
  inline void SetZipClassificationCode(ZipClassificationCode value) {
    m_zipClassificationCodeHasBeenSet = true;
    m_zipClassificationCode = value;
  }
  inline UspsZip& WithZipClassificationCode(ZipClassificationCode value) {
    SetZipClassificationCode(value);
    return *this;
  }
  ///@}
 private:
