...
class ReverseGeocodeResult {
 public:
  ...
  template <typename PricingBucketT = Aws::String>
  ReverseGeocodeResult& WithPricingBucket(PricingBucketT&& value) {
  ...
  void SetResultItems(ResultItemsT&& value) {
    ...
    m_resultItems = std::forward<ResultItemsT>(value);
  }
  template <typename ResultItemsT = Aws::Vector<ReverseGeocodeResultItem>>
  ReverseGeocodeResult& WithResultItems(ResultItemsT&& value) {
    SetResultItems(std::forward<ResultItemsT>(value));
    return *this;
  }
  template <typename ResultItemsT = ReverseGeocodeResultItem>
  ReverseGeocodeResult& AddResultItems(ResultItemsT&& value) {
    m_resultItemsHasBeenSet = true;
    m_resultItems.emplace_back(std::forward<ResultItemsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ReverseGeocodeResult& WithRequestId(RequestIdT&& value) {
