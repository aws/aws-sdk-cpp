...
class GetPlaceResult {
 public:
  ...
  inline void SetPlaceType(PlaceType value) {
    m_placeTypeHasBeenSet = true;
    m_placeType = value;
  }
  inline GetPlaceResult& WithPlaceType(PlaceType value) {
    SetPlaceType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAddressNumberCorrected(bool value) {
    ...
    m_addressNumberCorrected = value;
  }
  inline GetPlaceResult& WithAddressNumberCorrected(bool value) {
    SetAddressNumberCorrected(value);
    return *this;
  }
  ///@}
  ...
  void SetPostalCodeDetails(PostalCodeDetailsT&& value) {
    ...
    m_postalCodeDetails = std::forward<PostalCodeDetailsT>(value);
  }
  template <typename PostalCodeDetailsT = Aws::Vector<PostalCodeDetails>>
  GetPlaceResult& WithPostalCodeDetails(PostalCodeDetailsT&& value) {
    SetPostalCodeDetails(std::forward<PostalCodeDetailsT>(value));
    return *this;
  }
  template <typename PostalCodeDetailsT = PostalCodeDetails>
  GetPlaceResult& AddPostalCodeDetails(PostalCodeDetailsT&& value) {
    m_postalCodeDetailsHasBeenSet = true;
    m_postalCodeDetails.emplace_back(std::forward<PostalCodeDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetPlaceResult& AddPosition(double value) {
    m_positionHasBeenSet = true;
  ...
  inline GetPlaceResult& AddMapView(double value) {
    m_mapViewHasBeenSet = true;
  ...
  void SetFoodTypes(FoodTypesT&& value) {
    ...
    m_foodTypes = std::forward<FoodTypesT>(value);
  }
  template <typename FoodTypesT = Aws::Vector<FoodType>>
  GetPlaceResult& WithFoodTypes(FoodTypesT&& value) {
    SetFoodTypes(std::forward<FoodTypesT>(value));
    return *this;
  }
  template <typename FoodTypesT = FoodType>
  GetPlaceResult& AddFoodTypes(FoodTypesT&& value) {
    m_foodTypesHasBeenSet = true;
    m_foodTypes.emplace_back(std::forward<FoodTypesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBusinessChains(BusinessChainsT&& value) {
    ...
    m_businessChains = std::forward<BusinessChainsT>(value);
  }
  template <typename BusinessChainsT = Aws::Vector<BusinessChain>>
  GetPlaceResult& WithBusinessChains(BusinessChainsT&& value) {
    SetBusinessChains(std::forward<BusinessChainsT>(value));
    return *this;
  }
  template <typename BusinessChainsT = BusinessChain>
  GetPlaceResult& AddBusinessChains(BusinessChainsT&& value) {
    m_businessChainsHasBeenSet = true;
    m_businessChains.emplace_back(std::forward<BusinessChainsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOpeningHours(OpeningHoursT&& value) {
    ...
    m_openingHours = std::forward<OpeningHoursT>(value);
  }
  template <typename OpeningHoursT = Aws::Vector<OpeningHours>>
  GetPlaceResult& WithOpeningHours(OpeningHoursT&& value) {
    SetOpeningHours(std::forward<OpeningHoursT>(value));
    return *this;
  }
  template <typename OpeningHoursT = OpeningHours>
  GetPlaceResult& AddOpeningHours(OpeningHoursT&& value) {
    m_openingHoursHasBeenSet = true;
    m_openingHours.emplace_back(std::forward<OpeningHoursT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAccessRestrictions(AccessRestrictionsT&& value) {
    ...
    m_accessRestrictions = std::forward<AccessRestrictionsT>(value);
  }
  template <typename AccessRestrictionsT = Aws::Vector<AccessRestriction>>
  GetPlaceResult& WithAccessRestrictions(AccessRestrictionsT&& value) {
    SetAccessRestrictions(std::forward<AccessRestrictionsT>(value));
    return *this;
  }
  template <typename AccessRestrictionsT = AccessRestriction>
  GetPlaceResult& AddAccessRestrictions(AccessRestrictionsT&& value) {
    m_accessRestrictionsHasBeenSet = true;
    m_accessRestrictions.emplace_back(std::forward<AccessRestrictionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPhonemes(PhonemesT&& value) {
    ...
    m_phonemes = std::forward<PhonemesT>(value);
  }
  template <typename PhonemesT = PhonemeDetails>
  GetPlaceResult& WithPhonemes(PhonemesT&& value) {
    SetPhonemes(std::forward<PhonemesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSecondaryAddresses(SecondaryAddressesT&& value) {
    ...
    m_secondaryAddresses = std::forward<SecondaryAddressesT>(value);
  }
  template <typename SecondaryAddressesT = Aws::Vector<RelatedPlace>>
  GetPlaceResult& WithSecondaryAddresses(SecondaryAddressesT&& value) {
    SetSecondaryAddresses(std::forward<SecondaryAddressesT>(value));
    return *this;
  }
  template <typename SecondaryAddressesT = RelatedPlace>
  GetPlaceResult& AddSecondaryAddresses(SecondaryAddressesT&& value) {
    m_secondaryAddressesHasBeenSet = true;
    m_secondaryAddresses.emplace_back(std::forward<SecondaryAddressesT>(value));
    return *this;
  }
  ///@}
