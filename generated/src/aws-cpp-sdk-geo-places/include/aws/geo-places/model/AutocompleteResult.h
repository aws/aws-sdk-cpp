...
class AutocompleteResult {
 public:
  ...
  template <typename PricingBucketT = Aws::String>
  AutocompleteResult& WithPricingBucket(PricingBucketT&& value) {
  ...
  template <typename ResultItemsT = Aws::Vector<AutocompleteResultItem>>
  AutocompleteResult& WithResultItems(ResultItemsT&& value) {
    SetResultItems(std::forward<ResultItemsT>(value));
    return *this;
  }
  template <typename ResultItemsT = AutocompleteResultItem>
  AutocompleteResult& AddResultItems(ResultItemsT&& value) {
    m_resultItemsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  AutocompleteResult& WithRequestId(RequestIdT&& value) {
