...
class RelatedPlace {
 public:
  ...
  template <typename PlaceIdT = Aws::String>
  RelatedPlace& WithPlaceId(PlaceIdT&& value) {
  ...
  inline RelatedPlace& WithPlaceType(PlaceType value) {
    SetPlaceType(value);
    return *this;
  }
  ///@}
  ...
  template <typename TitleT = Aws::String>
  RelatedPlace& WithTitle(TitleT&& value) {
  ...
  template <typename AddressT = Address>
  RelatedPlace& WithAddress(AddressT&& value) {
  ...
  template <typename PositionT = Aws::Vector<double>>
  RelatedPlace& WithPosition(PositionT&& value) {
    SetPosition(std::forward<PositionT>(value));
    return *this;
  }
  inline RelatedPlace& AddPosition(double value) {
    m_positionHasBeenSet = true;
  ...
  template <typename AccessPointsT = Aws::Vector<AccessPoint>>
  RelatedPlace& WithAccessPoints(AccessPointsT&& value) {
    SetAccessPoints(std::forward<AccessPointsT>(value));
    return *this;
  }
  template <typename AccessPointsT = AccessPoint>
  RelatedPlace& AddAccessPoints(AccessPointsT&& value) {
    m_accessPointsHasBeenSet = true;
