...
class ReverseGeocodeResultItem {
 public:
  ...
  inline ReverseGeocodeResultItem& WithPlaceType(PlaceType value) {
    SetPlaceType(value);
    return *this;
  }
  ///@}
  ...
  inline ReverseGeocodeResultItem& WithAddressNumberCorrected(bool value) {
  ...
  inline ReverseGeocodeResultItem& AddPosition(double value) {
    m_positionHasBeenSet = true;
  ...
  inline ReverseGeocodeResultItem& WithDistance(long long value) {
    SetDistance(value);
    return *this;
  }
  ///@}
  ...
  inline ReverseGeocodeResultItem& AddMapView(double value) {
    m_mapViewHasBeenSet = true;
