...
class StreetComponents {
 public:
  ...
  void SetBaseName(BaseNameT&& value) {
    ...
    m_baseName = std::forward<BaseNameT>(value);
  }
  template <typename BaseNameT = Aws::String>
  StreetComponents& WithBaseName(BaseNameT&& value) {
    SetBaseName(std::forward<BaseNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTypePlacement(TypePlacement value) {
    m_typePlacementHasBeenSet = true;
    m_typePlacement = value;
  }
  inline StreetComponents& WithTypePlacement(TypePlacement value) {
    SetTypePlacement(value);
    return *this;
  }
  ///@}
  ...
  void SetTypeSeparator(TypeSeparatorT&& value) {
    ...
    m_typeSeparator = std::forward<TypeSeparatorT>(value);
  }
  template <typename TypeSeparatorT = Aws::String>
  StreetComponents& WithTypeSeparator(TypeSeparatorT&& value) {
    SetTypeSeparator(std::forward<TypeSeparatorT>(value));
    return *this;
  }
  ///@}
