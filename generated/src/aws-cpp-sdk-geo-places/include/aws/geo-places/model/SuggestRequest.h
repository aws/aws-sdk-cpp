...
class SuggestRequest : public GeoPlacesRequest {
 public:
  ...
  inline SuggestRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxQueryRefinements(int value) {
    m_maxQueryRefinementsHasBeenSet = true;
    m_maxQueryRefinements = value;
  }
  inline SuggestRequest& WithMaxQueryRefinements(int value) {
    SetMaxQueryRefinements(value);
    return *this;
  }
  ///@}
  ...
  inline SuggestRequest& AddBiasPosition(double value) {
    m_biasPositionHasBeenSet = true;
  ...
  inline SuggestRequest& AddAdditionalFeatures(SuggestAdditionalFeature value) {
    m_additionalFeaturesHasBeenSet = true;
  ...
  inline void SetIntendedUse(SuggestIntendedUse value) {
    m_intendedUseHasBeenSet = true;
    m_intendedUse = value;
  }
  inline SuggestRequest& WithIntendedUse(SuggestIntendedUse value) {
