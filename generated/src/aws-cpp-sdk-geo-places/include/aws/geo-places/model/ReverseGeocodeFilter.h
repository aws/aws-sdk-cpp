...
class ReverseGeocodeFilter {
 public:
  ...
  void SetIncludePlaceTypes(IncludePlaceTypesT&& value) {
    m_includePlaceTypesHasBeenSet = true;
    m_includePlaceTypes = std::forward<IncludePlaceTypesT>(value);
  }
  template <typename IncludePlaceTypesT = Aws::Vector<ReverseGeocodeFilterPlaceType>>
  ReverseGeocodeFilter& WithIncludePlaceTypes(IncludePlaceTypesT&& value) {
    SetIncludePlaceTypes(std::forward<IncludePlaceTypesT>(value));
    return *this;
  }
  inline ReverseGeocodeFilter& AddIncludePlaceTypes(ReverseGeocodeFilterPlaceType value) {
    m_includePlaceTypesHasBeenSet = true;
    m_includePlaceTypes.push_back(value);
    return *this;
  }
  ///@}
 private:
