...
class Contacts {
 public:
  ...
  void SetPhones(PhonesT&& value) {
    ...
    m_phones = std::forward<PhonesT>(value);
  }
  template <typename PhonesT = Aws::Vector<ContactDetails>>
  Contacts& WithPhones(PhonesT&& value) {
    SetPhones(std::forward<PhonesT>(value));
    return *this;
  }
  template <typename PhonesT = ContactDetails>
  Contacts& AddPhones(PhonesT&& value) {
    m_phonesHasBeenSet = true;
    m_phones.emplace_back(std::forward<PhonesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFaxes(FaxesT&& value) {
    ...
    m_faxes = std::forward<FaxesT>(value);
  }
  template <typename FaxesT = Aws::Vector<ContactDetails>>
  Contacts& WithFaxes(FaxesT&& value) {
    SetFaxes(std::forward<FaxesT>(value));
    return *this;
  }
  template <typename FaxesT = ContactDetails>
  Contacts& AddFaxes(FaxesT&& value) {
    m_faxesHasBeenSet = true;
    m_faxes.emplace_back(std::forward<FaxesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetWebsites(WebsitesT&& value) {
    ...
    m_websites = std::forward<WebsitesT>(value);
  }
  template <typename WebsitesT = Aws::Vector<ContactDetails>>
  Contacts& WithWebsites(WebsitesT&& value) {
    SetWebsites(std::forward<WebsitesT>(value));
    return *this;
  }
  template <typename WebsitesT = ContactDetails>
  Contacts& AddWebsites(WebsitesT&& value) {
    m_websitesHasBeenSet = true;
    m_websites.emplace_back(std::forward<WebsitesT>(value));
    return *this;
  }
  ///@}
