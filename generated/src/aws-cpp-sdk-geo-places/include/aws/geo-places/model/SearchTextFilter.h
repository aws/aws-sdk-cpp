...
namespace Model
{
  ...
  {
  public:
    AWS_GEOPLACES_API SearchTextFilter() = default;
    ...
    template<typename BoundingBoxT = Aws::Vector<double>>
    SearchTextFilter& WithBoundingBox(BoundingBoxT&& value) { SetBoundingBox(std::forward<BoundingBoxT>(value)); return *this;}
    ...
    template<typename CircleT = FilterCircle>
    SearchTextFilter& WithCircle(CircleT&& value) { SetCircle(std::forward<CircleT>(value)); return *this;}
    ///@}
    ...
    template<typename IncludeCountriesT = Aws::Vector<Aws::String>>
    SearchTextFilter& WithIncludeCountries(IncludeCountriesT&& value) { SetIncludeCountries(std::forward<IncludeCountriesT>(value)); return *this;}
    template<typename IncludeCountriesT = Aws::String>
    SearchTextFilter& AddIncludeCountries(IncludeCountriesT&& value) { m_includeCountriesHasBeenSet = true; m_includeCountries.emplace_back(std::forward<IncludeCountriesT>(value)); return *this; }
    ///@}
  private:
