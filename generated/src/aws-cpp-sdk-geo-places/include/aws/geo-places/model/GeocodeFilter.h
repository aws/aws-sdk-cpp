...
class GeocodeFilter {
 public:
  ...
  template <typename IncludeCountriesT = Aws::Vector<Aws::String>>
  GeocodeFilter& WithIncludeCountries(IncludeCountriesT&& value) {
    SetIncludeCountries(std::forward<IncludeCountriesT>(value));
    return *this;
  }
  template <typename IncludeCountriesT = Aws::String>
  GeocodeFilter& AddIncludeCountries(IncludeCountriesT&& value) {
    m_includeCountriesHasBeenSet = true;
  ...
  template <typename IncludePlaceTypesT = Aws::Vector<GeocodeFilterPlaceType>>
  GeocodeFilter& WithIncludePlaceTypes(IncludePlaceTypesT&& value) {
    SetIncludePlaceTypes(std::forward<IncludePlaceTypesT>(value));
    return *this;
  }
  inline GeocodeFilter& AddIncludePlaceTypes(GeocodeFilterPlaceType value) {
    m_includePlaceTypesHasBeenSet = true;
