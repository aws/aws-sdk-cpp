...
namespace Model
{
  ...
  public:
    ...
    template<typename CodeT = Aws::Vector<Highlight>>
    CountryHighlights& WithCode(CodeT&& value) { SetCode(std::forward<CodeT>(value)); return *this;}
    template<typename CodeT = Highlight>
    CountryHighlights& AddCode(CodeT&& value) { m_codeHasBeenSet = true; m_code.emplace_back(std::forward<CodeT>(value)); return *this; }
    ///@}
    ...
    template<typename NameT = Aws::Vector<Highlight>>
    CountryHighlights& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    template<typename NameT = Highlight>
    CountryHighlights& AddName(NameT&& value) { m_nameHasBeenSet = true; m_name.emplace_back(std::forward<NameT>(value)); return *this; }
    ///@}
  private:
