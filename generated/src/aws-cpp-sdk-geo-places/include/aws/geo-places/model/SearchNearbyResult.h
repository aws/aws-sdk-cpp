...
class SearchNearbyResult {
 public:
  ...
  template <typename PricingBucketT = Aws::String>
  SearchNearbyResult& WithPricingBucket(PricingBucketT&& value) {
  ...
  template <typename ResultItemsT = Aws::Vector<SearchNearbyResultItem>>
  SearchNearbyResult& WithResultItems(ResultItemsT&& value) {
    SetResultItems(std::forward<ResultItemsT>(value));
    return *this;
  }
  template <typename ResultItemsT = SearchNearbyResultItem>
  SearchNearbyResult& AddResultItems(ResultItemsT&& value) {
    m_resultItemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  SearchNearbyResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  SearchNearbyResult& WithRequestId(RequestIdT&& value) {
