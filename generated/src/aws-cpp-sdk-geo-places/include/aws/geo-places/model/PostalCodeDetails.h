...
class PostalCodeDetails {
 public:
  ...
  inline void SetPostalAuthority(PostalAuthority value) {
    m_postalAuthorityHasBeenSet = true;
    m_postalAuthority = value;
  }
  inline PostalCodeDetails& WithPostalAuthority(PostalAuthority value) {
    SetPostalAuthority(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPostalCodeType(PostalCodeType value) {
    m_postalCodeTypeHasBeenSet = true;
    m_postalCodeType = value;
  }
  inline PostalCodeDetails& WithPostalCodeType(PostalCodeType value) {
    SetPostalCodeType(value);
    return *this;
  }
  ///@}
  ...
  void SetUspsZip(UspsZipT&& value) {
    ...
    m_uspsZip = std::forward<UspsZipT>(value);
  }
  template <typename UspsZipT = UspsZip>
  PostalCodeDetails& WithUspsZip(UspsZipT&& value) {
    SetUspsZip(std::forward<UspsZipT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUspsZipPlus4(UspsZipPlus4T&& value) {
    ...
    m_uspsZipPlus4 = std::forward<UspsZipPlus4T>(value);
  }
  template <typename UspsZipPlus4T = UspsZipPlus4>
  PostalCodeDetails& WithUspsZipPlus4(UspsZipPlus4T&& value) {
    SetUspsZipPlus4(std::forward<UspsZipPlus4T>(value));
    return *this;
  }
  ///@}
 private:
