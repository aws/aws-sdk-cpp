...
namespace Model
{
  ...
  {
  public:
    AWS_GEOPLACES_API SearchNearbyResultItem();
    ...
    inline SearchNearbyResultItem& WithPlaceId(const Aws::String& value) { SetPlaceId(value); return *this;}
    inline SearchNearbyResultItem& WithPlaceId(Aws::String&& value) { SetPlaceId(std::move(value)); return *this;}
    inline SearchNearbyResultItem& WithPlaceId(const char* value) { SetPlaceId(value); return *this;}
    ///@}
    ...
    inline SearchNearbyResultItem& WithPlaceType(const PlaceType& value) { SetPlaceType(value); return *this;}
    inline SearchNearbyResultItem& WithPlaceType(PlaceType&& value) { SetPlaceType(std::move(value)); return *this;}
    ///@}
    ...
    inline SearchNearbyResultItem& WithTitle(const Aws::String& value) { SetTitle(value); return *this;}
    inline SearchNearbyResultItem& WithTitle(Aws::String&& value) { SetTitle(std::move(value)); return *this;}
    inline SearchNearbyResultItem& WithTitle(const char* value) { SetTitle(value); return *this;}
    ///@}
    ...
    inline SearchNearbyResultItem& WithAddress(const Address& value) { SetAddress(value); return *this;}
    inline SearchNearbyResultItem& WithAddress(Address&& value) { SetAddress(std::move(value)); return *this;}
    ///@}
    ...
    inline SearchNearbyResultItem& WithPosition(const Aws::Vector<double>& value) { SetPosition(value); return *this;}
    inline SearchNearbyResultItem& WithPosition(Aws::Vector<double>&& value) { SetPosition(std::move(value)); return *this;}
    ...
    inline SearchNearbyResultItem& WithMapView(const Aws::Vector<double>& value) { SetMapView(value); return *this;}
    inline SearchNearbyResultItem& WithMapView(Aws::Vector<double>&& value) { SetMapView(std::move(value)); return *this;}
    ...
    inline SearchNearbyResultItem& WithCategories(const Aws::Vector<Category>& value) { SetCategories(value); return *this;}
    inline SearchNearbyResultItem& WithCategories(Aws::Vector<Category>&& value) { SetCategories(std::move(value)); return *this;}
    inline SearchNearbyResultItem& AddCategories(const Category& value) { m_categoriesHasBeenSet = true; m_categories.push_back(value); return *this; }
    inline SearchNearbyResultItem& AddCategories(Category&& value) { m_categoriesHasBeenSet = true; m_categories.push_back(std::move(value)); return *this; }
    ///@}
    ...
    inline SearchNearbyResultItem& WithFoodTypes(const Aws::Vector<FoodType>& value) { SetFoodTypes(value); return *this;}
    inline SearchNearbyResultItem& WithFoodTypes(Aws::Vector<FoodType>&& value) { SetFoodTypes(std::move(value)); return *this;}
    inline SearchNearbyResultItem& AddFoodTypes(const FoodType& value) { m_foodTypesHasBeenSet = true; m_foodTypes.push_back(value); return *this; }
    inline SearchNearbyResultItem& AddFoodTypes(FoodType&& value) { m_foodTypesHasBeenSet = true; m_foodTypes.push_back(std::move(value)); return *this; }
    ///@}
    ...
    inline SearchNearbyResultItem& WithBusinessChains(const Aws::Vector<BusinessChain>& value) { SetBusinessChains(value); return *this;}
    inline SearchNearbyResultItem& WithBusinessChains(Aws::Vector<BusinessChain>&& value) { SetBusinessChains(std::move(value)); return *this;}
    inline SearchNearbyResultItem& AddBusinessChains(const BusinessChain& value) { m_businessChainsHasBeenSet = true; m_businessChains.push_back(value); return *this; }
    inline SearchNearbyResultItem& AddBusinessChains(BusinessChain&& value) { m_businessChainsHasBeenSet = true; m_businessChains.push_back(std::move(value)); return *this; }
    ///@}
    ...
    inline SearchNearbyResultItem& WithContacts(const Contacts& value) { SetContacts(value); return *this;}
    inline SearchNearbyResultItem& WithContacts(Contacts&& value) { SetContacts(std::move(value)); return *this;}
    ///@}
    ...
    inline SearchNearbyResultItem& WithOpeningHours(const Aws::Vector<OpeningHours>& value) { SetOpeningHours(value); return *this;}
    inline SearchNearbyResultItem& WithOpeningHours(Aws::Vector<OpeningHours>&& value) { SetOpeningHours(std::move(value)); return *this;}
    inline SearchNearbyResultItem& AddOpeningHours(const OpeningHours& value) { m_openingHoursHasBeenSet = true; m_openingHours.push_back(value); return *this; }
    inline SearchNearbyResultItem& AddOpeningHours(OpeningHours&& value) { m_openingHoursHasBeenSet = true; m_openingHours.push_back(std::move(value)); return *this; }
    ///@}
    ...
    inline SearchNearbyResultItem& WithAccessPoints(const Aws::Vector<AccessPoint>& value) { SetAccessPoints(value); return *this;}
    inline SearchNearbyResultItem& WithAccessPoints(Aws::Vector<AccessPoint>&& value) { SetAccessPoints(std::move(value)); return *this;}
    inline SearchNearbyResultItem& AddAccessPoints(const AccessPoint& value) { m_accessPointsHasBeenSet = true; m_accessPoints.push_back(value); return *this; }
    inline SearchNearbyResultItem& AddAccessPoints(AccessPoint&& value) { m_accessPointsHasBeenSet = true; m_accessPoints.push_back(std::move(value)); return *this; }
    ///@}
    ...
    inline SearchNearbyResultItem& WithAccessRestrictions(const Aws::Vector<AccessRestriction>& value) { SetAccessRestrictions(value); return *this;}
    inline SearchNearbyResultItem& WithAccessRestrictions(Aws::Vector<AccessRestriction>&& value) { SetAccessRestrictions(std::move(value)); return *this;}
    inline SearchNearbyResultItem& AddAccessRestrictions(const AccessRestriction& value) { m_accessRestrictionsHasBeenSet = true; m_accessRestrictions.push_back(value); return *this; }
    inline SearchNearbyResultItem& AddAccessRestrictions(AccessRestriction&& value) { m_accessRestrictionsHasBeenSet = true; m_accessRestrictions.push_back(std::move(value)); return *this; }
    ///@}
    ...
    inline SearchNearbyResultItem& WithTimeZone(const TimeZone& value) { SetTimeZone(value); return *this;}
    inline SearchNearbyResultItem& WithTimeZone(TimeZone&& value) { SetTimeZone(std::move(value)); return *this;}
    ///@}
    ...
    inline SearchNearbyResultItem& WithPoliticalView(const Aws::String& value) { SetPoliticalView(value); return *this;}
    inline SearchNearbyResultItem& WithPoliticalView(Aws::String&& value) { SetPoliticalView(std::move(value)); return *this;}
    inline SearchNearbyResultItem& WithPoliticalView(const char* value) { SetPoliticalView(value); return *this;}
    ///@}
    ...
    inline SearchNearbyResultItem& WithPhonemes(const PhonemeDetails& value) { SetPhonemes(value); return *this;}
    inline SearchNearbyResultItem& WithPhonemes(PhonemeDetails&& value) { SetPhonemes(std::move(value)); return *this;}
    ///@}
  private:
