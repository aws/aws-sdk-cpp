...
class ParsedQueryComponent {
 public:
  ...
  inline ParsedQueryComponent& WithStartIndex(int value) {
    SetStartIndex(value);
    return *this;
  }
  ///@}
  ...
  inline ParsedQueryComponent& WithEndIndex(int value) {
    SetEndIndex(value);
    return *this;
  }
  ///@}
  ...
  void SetQueryComponent(QueryComponentT&& value) {
    ...
    m_queryComponent = std::forward<QueryComponentT>(value);
  }
  template <typename QueryComponentT = Aws::String>
  ParsedQueryComponent& WithQueryComponent(QueryComponentT&& value) {
    SetQueryComponent(std::forward<QueryComponentT>(value));
    return *this;
  }
  ///@}
 private:
