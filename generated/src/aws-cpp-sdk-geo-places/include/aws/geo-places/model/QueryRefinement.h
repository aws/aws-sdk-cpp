...
class QueryRefinement {
 public:
  ...
  void SetRefinedTerm(RefinedTermT&& value) {
    ...
    m_refinedTerm = std::forward<RefinedTermT>(value);
  }
  template <typename RefinedTermT = Aws::String>
  QueryRefinement& WithRefinedTerm(RefinedTermT&& value) {
    SetRefinedTerm(std::forward<RefinedTermT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOriginalTerm(OriginalTermT&& value) {
    ...
    m_originalTerm = std::forward<OriginalTermT>(value);
  }
  template <typename OriginalTermT = Aws::String>
  QueryRefinement& WithOriginalTerm(OriginalTermT&& value) {
    SetOriginalTerm(std::forward<OriginalTermT>(value));
    return *this;
  }
  ///@}
  ...
  inline QueryRefinement& WithStartIndex(int value) {
    SetStartIndex(value);
    return *this;
  }
  ///@}
  ...
  inline QueryRefinement& WithEndIndex(int value) {
    SetEndIndex(value);
    return *this;
  }
  ///@}
