...
class GeocodeResult {
 public:
  ...
  template <typename PricingBucketT = Aws::String>
  GeocodeResult& WithPricingBucket(PricingBucketT&& value) {
  ...
  template <typename ResultItemsT = Aws::Vector<GeocodeResultItem>>
  GeocodeResult& WithResultItems(ResultItemsT&& value) {
    SetResultItems(std::forward<ResultItemsT>(value));
    return *this;
  }
  template <typename ResultItemsT = GeocodeResultItem>
  GeocodeResult& AddResultItems(ResultItemsT&& value) {
    m_resultItemsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GeocodeResult& WithRequestId(RequestIdT&& value) {
