...
class GetPlaceRequest : public GeoPlacesRequest {
 public:
  ...
  inline GetPlaceRequest& AddAdditionalFeatures(GetPlaceAdditionalFeature value) {
    m_additionalFeaturesHasBeenSet = true;
  ...
  inline void SetIntendedUse(GetPlaceIntendedUse value) {
    m_intendedUseHasBeenSet = true;
    m_intendedUse = value;
  }
  inline GetPlaceRequest& WithIntendedUse(GetPlaceIntendedUse value) {
