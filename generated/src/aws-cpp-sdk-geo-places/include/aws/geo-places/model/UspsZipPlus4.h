...
class UspsZipPlus4 {
 public:
  ...
  inline void SetRecordTypeCode(RecordTypeCode value) {
    m_recordTypeCodeHasBeenSet = true;
    m_recordTypeCode = value;
  }
  inline UspsZipPlus4& WithRecordTypeCode(RecordTypeCode value) {
    SetRecordTypeCode(value);
    return *this;
  }
  ///@}
 private:
