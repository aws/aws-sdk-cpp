...
namespace Model
{
  ...
  public:
    ...
    inline GeocodeResultItem& WithPlaceId(const Aws::String& value) { SetPlaceId(value); return *this;}
    inline GeocodeResultItem& WithPlaceId(Aws::String&& value) { SetPlaceId(std::move(value)); return *this;}
    inline GeocodeResultItem& WithPlaceId(const char* value) { SetPlaceId(value); return *this;}
    ///@}
    ...
    inline GeocodeResultItem& WithPlaceType(const PlaceType& value) { SetPlaceType(value); return *this;}
    inline GeocodeResultItem& WithPlaceType(PlaceType&& value) { SetPlaceType(std::move(value)); return *this;}
    ///@}
    ...
    inline GeocodeResultItem& WithTitle(const Aws::String& value) { SetTitle(value); return *this;}
    inline GeocodeResultItem& WithTitle(Aws::String&& value) { SetTitle(std::move(value)); return *this;}
    inline GeocodeResultItem& WithTitle(const char* value) { SetTitle(value); return *this;}
    ///@}
    ...
    inline GeocodeResultItem& WithAddress(const Address& value) { SetAddress(value); return *this;}
    inline GeocodeResultItem& WithAddress(Address&& value) { SetAddress(std::move(value)); return *this;}
    ///@}
    ...
    inline GeocodeResultItem& WithPostalCodeDetails(const Aws::Vector<PostalCodeDetails>& value) { SetPostalCodeDetails(value); return *this;}
    inline GeocodeResultItem& WithPostalCodeDetails(Aws::Vector<PostalCodeDetails>&& value) { SetPostalCodeDetails(std::move(value)); return *this;}
    inline GeocodeResultItem& AddPostalCodeDetails(const PostalCodeDetails& value) { m_postalCodeDetailsHasBeenSet = true; m_postalCodeDetails.push_back(value); return *this; }
    inline GeocodeResultItem& AddPostalCodeDetails(PostalCodeDetails&& value) { m_postalCodeDetailsHasBeenSet = true; m_postalCodeDetails.push_back(std::move(value)); return *this; }
    ///@}
    ...
    inline GeocodeResultItem& WithPosition(const Aws::Vector<double>& value) { SetPosition(value); return *this;}
    inline GeocodeResultItem& WithPosition(Aws::Vector<double>&& value) { SetPosition(std::move(value)); return *this;}
    ...
    inline GeocodeResultItem& WithMapView(const Aws::Vector<double>& value) { SetMapView(value); return *this;}
    inline GeocodeResultItem& WithMapView(Aws::Vector<double>&& value) { SetMapView(std::move(value)); return *this;}
    ...
    inline GeocodeResultItem& WithCategories(const Aws::Vector<Category>& value) { SetCategories(value); return *this;}
    inline GeocodeResultItem& WithCategories(Aws::Vector<Category>&& value) { SetCategories(std::move(value)); return *this;}
    inline GeocodeResultItem& AddCategories(const Category& value) { m_categoriesHasBeenSet = true; m_categories.push_back(value); return *this; }
    inline GeocodeResultItem& AddCategories(Category&& value) { m_categoriesHasBeenSet = true; m_categories.push_back(std::move(value)); return *this; }
    ///@}
    ...
    inline GeocodeResultItem& WithFoodTypes(const Aws::Vector<FoodType>& value) { SetFoodTypes(value); return *this;}
    inline GeocodeResultItem& WithFoodTypes(Aws::Vector<FoodType>&& value) { SetFoodTypes(std::move(value)); return *this;}
    inline GeocodeResultItem& AddFoodTypes(const FoodType& value) { m_foodTypesHasBeenSet = true; m_foodTypes.push_back(value); return *this; }
    inline GeocodeResultItem& AddFoodTypes(FoodType&& value) { m_foodTypesHasBeenSet = true; m_foodTypes.push_back(std::move(value)); return *this; }
    ///@}
    ...
    inline GeocodeResultItem& WithAccessPoints(const Aws::Vector<AccessPoint>& value) { SetAccessPoints(value); return *this;}
    inline GeocodeResultItem& WithAccessPoints(Aws::Vector<AccessPoint>&& value) { SetAccessPoints(std::move(value)); return *this;}
    inline GeocodeResultItem& AddAccessPoints(const AccessPoint& value) { m_accessPointsHasBeenSet = true; m_accessPoints.push_back(value); return *this; }
    inline GeocodeResultItem& AddAccessPoints(AccessPoint&& value) { m_accessPointsHasBeenSet = true; m_accessPoints.push_back(std::move(value)); return *this; }
    ///@}
    ...
    inline GeocodeResultItem& WithTimeZone(const TimeZone& value) { SetTimeZone(value); return *this;}
    inline GeocodeResultItem& WithTimeZone(TimeZone&& value) { SetTimeZone(std::move(value)); return *this;}
    ///@}
    ...
    inline GeocodeResultItem& WithPoliticalView(const Aws::String& value) { SetPoliticalView(value); return *this;}
    inline GeocodeResultItem& WithPoliticalView(Aws::String&& value) { SetPoliticalView(std::move(value)); return *this;}
    inline GeocodeResultItem& WithPoliticalView(const char* value) { SetPoliticalView(value); return *this;}
    ///@}
    ...
    inline void SetMatchScores(const MatchScoreDetails& value) { m_matchScoresHasBeenSet = true; m_matchScores = value; }
    inline void SetMatchScores(MatchScoreDetails&& value) { m_matchScoresHasBeenSet = true; m_matchScores = std::move(value); }
    inline GeocodeResultItem& WithMatchScores(const MatchScoreDetails& value) { SetMatchScores(value); return *this;}
    inline GeocodeResultItem& WithMatchScores(MatchScoreDetails&& value) { SetMatchScores(std::move(value)); return *this;}
    ///@}
  private:
