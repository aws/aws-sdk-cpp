...
class GeocodeResultItem {
 public:
  ...
  inline GeocodeResultItem& WithPlaceType(PlaceType value) {
    SetPlaceType(value);
    return *this;
  }
  ///@}
  ...
  inline GeocodeResultItem& WithAddressNumberCorrected(bool value) {
  ...
  inline GeocodeResultItem& AddPosition(double value) {
    m_positionHasBeenSet = true;
  ...
  inline GeocodeResultItem& WithDistance(long long value) {
    SetDistance(value);
    return *this;
  }
  ///@}
  ...
  inline GeocodeResultItem& AddMapView(double value) {
    m_mapViewHasBeenSet = true;
  ...
  void SetMatchScores(MatchScoresT&& value) {
    ...
    m_matchScores = std::forward<MatchScoresT>(value);
  }
  template <typename MatchScoresT = MatchScoreDetails>
  GeocodeResultItem& WithMatchScores(MatchScoresT&& value) {
    SetMatchScores(std::forward<MatchScoresT>(value));
    return *this;
  }
  ///@}
  ...
  void SetParsedQuery(ParsedQueryT&& value) {
    ...
    m_parsedQuery = std::forward<ParsedQueryT>(value);
  }
  template <typename ParsedQueryT = GeocodeParsedQuery>
  GeocodeResultItem& WithParsedQuery(ParsedQueryT&& value) {
    SetParsedQuery(std::forward<ParsedQueryT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIntersections(IntersectionsT&& value) {
    ...
    m_intersections = std::forward<IntersectionsT>(value);
  }
  template <typename IntersectionsT = Aws::Vector<Intersection>>
  GeocodeResultItem& WithIntersections(IntersectionsT&& value) {
    SetIntersections(std::forward<IntersectionsT>(value));
    return *this;
  }
  template <typename IntersectionsT = Intersection>
  GeocodeResultItem& AddIntersections(IntersectionsT&& value) {
    m_intersectionsHasBeenSet = true;
    m_intersections.emplace_back(std::forward<IntersectionsT>(value));
    return *this;
  }
  ///@}
