...
class AutocompleteRequest : public GeoPlacesRequest {
 public:
  ...
  inline AutocompleteRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline AutocompleteRequest& AddBiasPosition(double value) {
    m_biasPositionHasBeenSet = true;
  ...
  inline AutocompleteRequest& WithPostalCodeMode(PostalCodeMode value) {
  ...
  inline AutocompleteRequest& AddAdditionalFeatures(AutocompleteAdditionalFeature value) {
    m_additionalFeaturesHasBeenSet = true;
  ...
  inline void SetIntendedUse(AutocompleteIntendedUse value) {
    m_intendedUseHasBeenSet = true;
    m_intendedUse = value;
  }
  inline AutocompleteRequest& WithIntendedUse(AutocompleteIntendedUse value) {
