...
class SearchNearbyRequest : public GeoPlacesRequest {
 public:
  ...
  inline SearchNearbyRequest& AddQueryPosition(double value) {
    m_queryPositionHasBeenSet = true;
  ...
  inline SearchNearbyRequest& WithQueryRadius(long long value) {
  ...
  inline SearchNearbyRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline SearchNearbyRequest& AddAdditionalFeatures(SearchNearbyAdditionalFeature value) {
    m_additionalFeaturesHasBeenSet = true;
   ...
   * customers. </p>  <p>When storing <code>SearchNearby</code> responses, you
  ...
  inline void SetIntendedUse(SearchNearbyIntendedUse value) {
    m_intendedUseHasBeenSet = true;
    m_intendedUse = value;
  }
  inline SearchNearbyRequest& WithIntendedUse(SearchNearbyIntendedUse value) {
