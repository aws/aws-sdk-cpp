...
class AutocompleteFilter {
 public:
  ...
  template <typename BoundingBoxT = Aws::Vector<double>>
  AutocompleteFilter& WithBoundingBox(BoundingBoxT&& value) {
    SetBoundingBox(std::forward<BoundingBoxT>(value));
    return *this;
  }
  inline AutocompleteFilter& AddBoundingBox(double value) {
    m_boundingBoxHasBeenSet = true;
  ...
  template <typename CircleT = FilterCircle>
  AutocompleteFilter& WithCircle(CircleT&& value) {
  ...
  template <typename IncludeCountriesT = Aws::Vector<Aws::String>>
  AutocompleteFilter& WithIncludeCountries(IncludeCountriesT&& value) {
    SetIncludeCountries(std::forward<IncludeCountriesT>(value));
    return *this;
  }
  template <typename IncludeCountriesT = Aws::String>
  AutocompleteFilter& AddIncludeCountries(IncludeCountriesT&& value) {
    m_includeCountriesHasBeenSet = true;
  ...
  template <typename IncludePlaceTypesT = Aws::Vector<AutocompleteFilterPlaceType>>
  AutocompleteFilter& WithIncludePlaceTypes(IncludePlaceTypesT&& value) {
    SetIncludePlaceTypes(std::forward<IncludePlaceTypesT>(value));
    return *this;
  }
  inline AutocompleteFilter& AddIncludePlaceTypes(AutocompleteFilterPlaceType value) {
    m_includePlaceTypesHasBeenSet = true;
