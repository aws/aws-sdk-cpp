...
class FoodType {
 public:
  ...
  void SetLocalizedName(LocalizedNameT&& value) {
    ...
    m_localizedName = std::forward<LocalizedNameT>(value);
  }
  template <typename LocalizedNameT = Aws::String>
  FoodType& WithLocalizedName(LocalizedNameT&& value) {
    SetLocalizedName(std::forward<LocalizedNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline FoodType& WithPrimary(bool value) {
    SetPrimary(value);
    return *this;
  }
  ///@}
