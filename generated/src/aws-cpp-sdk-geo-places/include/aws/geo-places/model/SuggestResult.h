...
class SuggestResult {
 public:
  ...
  template <typename PricingBucketT = Aws::String>
  SuggestResult& WithPricingBucket(PricingBucketT&& value) {
  ...
  template <typename ResultItemsT = Aws::Vector<SuggestResultItem>>
  SuggestResult& WithResultItems(ResultItemsT&& value) {
    SetResultItems(std::forward<ResultItemsT>(value));
    return *this;
  }
  template <typename ResultItemsT = SuggestResultItem>
  SuggestResult& AddResultItems(ResultItemsT&& value) {
    m_resultItemsHasBeenSet = true;
  ...
  void SetQueryRefinements(QueryRefinementsT&& value) {
    m_queryRefinementsHasBeenSet = true;
    m_queryRefinements = std::forward<QueryRefinementsT>(value);
  }
  template <typename QueryRefinementsT = Aws::Vector<QueryRefinement>>
  SuggestResult& WithQueryRefinements(QueryRefinementsT&& value) {
    SetQueryRefinements(std::forward<QueryRefinementsT>(value));
    return *this;
  }
  template <typename QueryRefinementsT = QueryRefinement>
  SuggestResult& AddQueryRefinements(QueryRefinementsT&& value) {
    m_queryRefinementsHasBeenSet = true;
    m_queryRefinements.emplace_back(std::forward<QueryRefinementsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  SuggestResult& WithRequestId(RequestIdT&& value) {
