...
class SearchNearbyFilter {
 public:
  ...
  template <typename BoundingBoxT = Aws::Vector<double>>
  SearchNearbyFilter& WithBoundingBox(BoundingBoxT&& value) {
    SetBoundingBox(std::forward<BoundingBoxT>(value));
    return *this;
  }
  inline SearchNearbyFilter& AddBoundingBox(double value) {
    m_boundingBoxHasBeenSet = true;
  ...
  template <typename IncludeCountriesT = Aws::Vector<Aws::String>>
  SearchNearbyFilter& WithIncludeCountries(IncludeCountriesT&& value) {
    SetIncludeCountries(std::forward<IncludeCountriesT>(value));
    return *this;
  }
  template <typename IncludeCountriesT = Aws::String>
  SearchNearbyFilter& AddIncludeCountries(IncludeCountriesT&& value) {
    m_includeCountriesHasBeenSet = true;
  ...
  void SetIncludeCategories(IncludeCategoriesT&& value) {
    m_includeCategoriesHasBeenSet = true;
    m_includeCategories = std::forward<IncludeCategoriesT>(value);
  }
  template <typename IncludeCategoriesT = Aws::Vector<Aws::String>>
  SearchNearbyFilter& WithIncludeCategories(IncludeCategoriesT&& value) {
    SetIncludeCategories(std::forward<IncludeCategoriesT>(value));
    return *this;
  }
  template <typename IncludeCategoriesT = Aws::String>
  SearchNearbyFilter& AddIncludeCategories(IncludeCategoriesT&& value) {
    m_includeCategoriesHasBeenSet = true;
    m_includeCategories.emplace_back(std::forward<IncludeCategoriesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExcludeCategories(ExcludeCategoriesT&& value) {
    m_excludeCategoriesHasBeenSet = true;
    m_excludeCategories = std::forward<ExcludeCategoriesT>(value);
  }
  template <typename ExcludeCategoriesT = Aws::Vector<Aws::String>>
  SearchNearbyFilter& WithExcludeCategories(ExcludeCategoriesT&& value) {
    SetExcludeCategories(std::forward<ExcludeCategoriesT>(value));
    return *this;
  }
  template <typename ExcludeCategoriesT = Aws::String>
  SearchNearbyFilter& AddExcludeCategories(ExcludeCategoriesT&& value) {
    m_excludeCategoriesHasBeenSet = true;
    m_excludeCategories.emplace_back(std::forward<ExcludeCategoriesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIncludeBusinessChains(IncludeBusinessChainsT&& value) {
    m_includeBusinessChainsHasBeenSet = true;
    m_includeBusinessChains = std::forward<IncludeBusinessChainsT>(value);
  }
  template <typename IncludeBusinessChainsT = Aws::Vector<Aws::String>>
  SearchNearbyFilter& WithIncludeBusinessChains(IncludeBusinessChainsT&& value) {
    SetIncludeBusinessChains(std::forward<IncludeBusinessChainsT>(value));
    return *this;
  }
  template <typename IncludeBusinessChainsT = Aws::String>
  SearchNearbyFilter& AddIncludeBusinessChains(IncludeBusinessChainsT&& value) {
    m_includeBusinessChainsHasBeenSet = true;
    m_includeBusinessChains.emplace_back(std::forward<IncludeBusinessChainsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExcludeBusinessChains(ExcludeBusinessChainsT&& value) {
    m_excludeBusinessChainsHasBeenSet = true;
    m_excludeBusinessChains = std::forward<ExcludeBusinessChainsT>(value);
  }
  template <typename ExcludeBusinessChainsT = Aws::Vector<Aws::String>>
  SearchNearbyFilter& WithExcludeBusinessChains(ExcludeBusinessChainsT&& value) {
    SetExcludeBusinessChains(std::forward<ExcludeBusinessChainsT>(value));
    return *this;
  }
  template <typename ExcludeBusinessChainsT = Aws::String>
  SearchNearbyFilter& AddExcludeBusinessChains(ExcludeBusinessChainsT&& value) {
    m_excludeBusinessChainsHasBeenSet = true;
    m_excludeBusinessChains.emplace_back(std::forward<ExcludeBusinessChainsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIncludeFoodTypes(IncludeFoodTypesT&& value) {
    m_includeFoodTypesHasBeenSet = true;
    m_includeFoodTypes = std::forward<IncludeFoodTypesT>(value);
  }
  template <typename IncludeFoodTypesT = Aws::Vector<Aws::String>>
  SearchNearbyFilter& WithIncludeFoodTypes(IncludeFoodTypesT&& value) {
    SetIncludeFoodTypes(std::forward<IncludeFoodTypesT>(value));
    return *this;
  }
  template <typename IncludeFoodTypesT = Aws::String>
  SearchNearbyFilter& AddIncludeFoodTypes(IncludeFoodTypesT&& value) {
    m_includeFoodTypesHasBeenSet = true;
    m_includeFoodTypes.emplace_back(std::forward<IncludeFoodTypesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExcludeFoodTypes(ExcludeFoodTypesT&& value) {
    m_excludeFoodTypesHasBeenSet = true;
    m_excludeFoodTypes = std::forward<ExcludeFoodTypesT>(value);
  }
  template <typename ExcludeFoodTypesT = Aws::Vector<Aws::String>>
  SearchNearbyFilter& WithExcludeFoodTypes(ExcludeFoodTypesT&& value) {
    SetExcludeFoodTypes(std::forward<ExcludeFoodTypesT>(value));
    return *this;
  }
  template <typename ExcludeFoodTypesT = Aws::String>
  SearchNearbyFilter& AddExcludeFoodTypes(ExcludeFoodTypesT&& value) {
    m_excludeFoodTypesHasBeenSet = true;
    m_excludeFoodTypes.emplace_back(std::forward<ExcludeFoodTypesT>(value));
    return *this;
  }
  ///@}
 private:
