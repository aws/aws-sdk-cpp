...
namespace Model
{
  ...
  public:
    ...
    template<typename PlaceIdT = Aws::String>
    SearchTextResultItem& WithPlaceId(PlaceIdT&& value) { SetPlaceId(std::forward<PlaceIdT>(value)); return *this;}
    ///@}
    ...
    inline SearchTextResultItem& WithPlaceType(PlaceType value) { SetPlaceType(value); return *this;}
    ///@}
    ...
    template<typename TitleT = Aws::String>
    SearchTextResultItem& WithTitle(TitleT&& value) { SetTitle(std::forward<TitleT>(value)); return *this;}
    ///@}
    ...
    template<typename AddressT = Address>
    SearchTextResultItem& WithAddress(AddressT&& value) { SetAddress(std::forward<AddressT>(value)); return *this;}
    ///@}
    ...
    template<typename PositionT = Aws::Vector<double>>
    SearchTextResultItem& WithPosition(PositionT&& value) { SetPosition(std::forward<PositionT>(value)); return *this;}
    ...
    template<typename MapViewT = Aws::Vector<double>>
    SearchTextResultItem& WithMapView(MapViewT&& value) { SetMapView(std::forward<MapViewT>(value)); return *this;}
    ...
    template<typename CategoriesT = Aws::Vector<Category>>
    SearchTextResultItem& WithCategories(CategoriesT&& value) { SetCategories(std::forward<CategoriesT>(value)); return *this;}
    template<typename CategoriesT = Category>
    SearchTextResultItem& AddCategories(CategoriesT&& value) { m_categoriesHasBeenSet = true; m_categories.emplace_back(std::forward<CategoriesT>(value)); return *this; }
    ///@}
    ...
    template<typename FoodTypesT = Aws::Vector<FoodType>>
    SearchTextResultItem& WithFoodTypes(FoodTypesT&& value) { SetFoodTypes(std::forward<FoodTypesT>(value)); return *this;}
    template<typename FoodTypesT = FoodType>
    SearchTextResultItem& AddFoodTypes(FoodTypesT&& value) { m_foodTypesHasBeenSet = true; m_foodTypes.emplace_back(std::forward<FoodTypesT>(value)); return *this; }
    ///@}
    ...
    template<typename BusinessChainsT = Aws::Vector<BusinessChain>>
    SearchTextResultItem& WithBusinessChains(BusinessChainsT&& value) { SetBusinessChains(std::forward<BusinessChainsT>(value)); return *this;}
    template<typename BusinessChainsT = BusinessChain>
    SearchTextResultItem& AddBusinessChains(BusinessChainsT&& value) { m_businessChainsHasBeenSet = true; m_businessChains.emplace_back(std::forward<BusinessChainsT>(value)); return *this; }
    ///@}
    ...
    template<typename ContactsT = Contacts>
    SearchTextResultItem& WithContacts(ContactsT&& value) { SetContacts(std::forward<ContactsT>(value)); return *this;}
    ///@}
    ...
    template<typename OpeningHoursT = Aws::Vector<OpeningHours>>
    SearchTextResultItem& WithOpeningHours(OpeningHoursT&& value) { SetOpeningHours(std::forward<OpeningHoursT>(value)); return *this;}
    template<typename OpeningHoursT = OpeningHours>
    SearchTextResultItem& AddOpeningHours(OpeningHoursT&& value) { m_openingHoursHasBeenSet = true; m_openingHours.emplace_back(std::forward<OpeningHoursT>(value)); return *this; }
    ///@}
    ...
    template<typename AccessPointsT = Aws::Vector<AccessPoint>>
    SearchTextResultItem& WithAccessPoints(AccessPointsT&& value) { SetAccessPoints(std::forward<AccessPointsT>(value)); return *this;}
    template<typename AccessPointsT = AccessPoint>
    SearchTextResultItem& AddAccessPoints(AccessPointsT&& value) { m_accessPointsHasBeenSet = true; m_accessPoints.emplace_back(std::forward<AccessPointsT>(value)); return *this; }
    ///@}
    ...
    template<typename AccessRestrictionsT = Aws::Vector<AccessRestriction>>
    SearchTextResultItem& WithAccessRestrictions(AccessRestrictionsT&& value) { SetAccessRestrictions(std::forward<AccessRestrictionsT>(value)); return *this;}
    template<typename AccessRestrictionsT = AccessRestriction>
    SearchTextResultItem& AddAccessRestrictions(AccessRestrictionsT&& value) { m_accessRestrictionsHasBeenSet = true; m_accessRestrictions.emplace_back(std::forward<AccessRestrictionsT>(value)); return *this; }
    ///@}
    ...
    template<typename TimeZoneT = TimeZone>
    SearchTextResultItem& WithTimeZone(TimeZoneT&& value) { SetTimeZone(std::forward<TimeZoneT>(value)); return *this;}
    ///@}
    ...
    template<typename PoliticalViewT = Aws::String>
    SearchTextResultItem& WithPoliticalView(PoliticalViewT&& value) { SetPoliticalView(std::forward<PoliticalViewT>(value)); return *this;}
    ///@}
    ...
    template<typename PhonemesT = PhonemeDetails>
    SearchTextResultItem& WithPhonemes(PhonemesT&& value) { SetPhonemes(std::forward<PhonemesT>(value)); return *this;}
    ///@}
  private:
