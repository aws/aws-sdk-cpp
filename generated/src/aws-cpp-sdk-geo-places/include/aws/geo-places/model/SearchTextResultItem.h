...
class SearchTextResultItem {
 public:
  ...
  inline SearchTextResultItem& WithPlaceType(PlaceType value) {
    SetPlaceType(value);
    return *this;
  }
  ///@}
  ...
  inline SearchTextResultItem& WithAddressNumberCorrected(bool value) {
  ...
  inline SearchTextResultItem& AddPosition(double value) {
    m_positionHasBeenSet = true;
  ...
  inline SearchTextResultItem& WithDistance(long long value) {
    SetDistance(value);
    return *this;
  }
  ///@}
  ...
  inline SearchTextResultItem& AddMapView(double value) {
    m_mapViewHasBeenSet = true;
