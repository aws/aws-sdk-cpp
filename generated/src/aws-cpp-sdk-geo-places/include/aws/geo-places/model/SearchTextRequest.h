...
class SearchTextRequest : public GeoPlacesRequest {
 public:
   ...
   * the original query made to the suggest API. Not available in
   ...
   * customers.</p>  <p>Exactly one of the following fields must be set:
   * <code>QueryText</code> or <code>QueryId</code>.</p>
   */
  ...
  inline SearchTextRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline SearchTextRequest& AddBiasPosition(double value) {
    m_biasPositionHasBeenSet = true;
  ...
  inline SearchTextRequest& AddAdditionalFeatures(SearchTextAdditionalFeature value) {
    m_additionalFeaturesHasBeenSet = true;
   ...
   * <code>SearchText</code> responses, you <i>must</i> set this field to
  ...
  inline void SetIntendedUse(SearchTextIntendedUse value) {
    m_intendedUseHasBeenSet = true;
    m_intendedUse = value;
  }
  inline SearchTextRequest& WithIntendedUse(SearchTextIntendedUse value) {
