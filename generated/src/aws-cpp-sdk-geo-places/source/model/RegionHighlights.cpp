...
RegionHighlights::RegionHighlights(JsonView jsonValue) { *this = jsonValue; }

RegionHighlights& RegionHighlights::operator=(JsonView jsonValue) {
...
JsonValue RegionHighlights::Jsonize() const {
  JsonValue payload;
