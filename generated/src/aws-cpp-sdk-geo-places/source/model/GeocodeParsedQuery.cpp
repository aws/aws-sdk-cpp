...
GeocodeParsedQuery::GeocodeParsedQuery(JsonView jsonValue) { *this = jsonValue; }

GeocodeParsedQuery& GeocodeParsedQuery::operator=(JsonView jsonValue) {
...
JsonValue GeocodeParsedQuery::Jsonize() const {
  JsonValue payload;
