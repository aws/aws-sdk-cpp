...
AutocompleteHighlights::AutocompleteHighlights(JsonView jsonValue) { *this = jsonValue; }

AutocompleteHighlights& AutocompleteHighlights::operator=(JsonView jsonValue) {
...
JsonValue AutocompleteHighlights::Jsonize() const {
  JsonValue payload;
