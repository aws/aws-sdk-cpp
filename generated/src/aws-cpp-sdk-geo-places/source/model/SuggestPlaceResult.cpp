...
SuggestPlaceResult::SuggestPlaceResult(JsonView jsonValue) { *this = jsonValue; }

SuggestPlaceResult& SuggestPlaceResult::operator=(JsonView jsonValue) {
...
JsonValue SuggestPlaceResult::Jsonize() const {
  JsonValue payload;
