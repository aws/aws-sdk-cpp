...
SearchTextFilter::SearchTextFilter(JsonView jsonValue) { *this = jsonValue; }

SearchTextFilter& SearchTextFilter::operator=(JsonView jsonValue) {
...
JsonValue SearchTextFilter::Jsonize() const {
  JsonValue payload;
