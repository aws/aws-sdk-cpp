...
SubRegionHighlights::SubRegionHighlights() : 
    m_codeHasBeenSet(false),
    m_nameHasBeenSet(false)
{
}

SubRegionHighlights::SubRegionHighlights(JsonView jsonValue)
  : SubRegionHighlights()
{
  *this = jsonValue;
}

SubRegionHighlights& SubRegionHighlights::operator =(JsonView jsonValue)
{
...
JsonValue SubRegionHighlights::Jsonize() const
{
  JsonValue payload;
