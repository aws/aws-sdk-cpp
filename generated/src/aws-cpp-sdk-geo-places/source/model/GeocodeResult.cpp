...
GeocodeResult::GeocodeResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

GeocodeResult& GeocodeResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
