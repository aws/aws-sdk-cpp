...
Aws::String AutocompleteRequest::SerializePayload() const
{
  ...
  if(m_additionalFeaturesHasBeenSet)
  {
   ...
   {
     additionalFeaturesJsonList[additionalFeaturesIndex].AsString(AutocompleteAdditionalFeatureMapper::GetNameForAutocompleteAdditionalFeature(m_additionalFeatures[additionalFeaturesIndex]));
   }
  ...
  {
   payload.WithString("IntendedUse", AutocompleteIntendedUseMapper::GetNameForAutocompleteIntendedUse(m_intendedUse));
  }

  return payload.View().WriteReadable();
}

void AutocompleteRequest::AddQueryStringParameters(URI& uri) const
{
    Aws::StringStream ss;
    if(m_keyHasBeenSet)
    {
