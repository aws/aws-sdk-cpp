...
SearchNearbyResultItem::SearchNearbyResultItem(JsonView jsonValue) { *this = jsonValue; }

SearchNearbyResultItem& SearchNearbyResultItem::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("AccessRestrictions")) {
    ...
    for (unsigned accessRestrictionsIndex = 0; accessRestrictionsIndex < accessRestrictionsJsonList.GetLength();
...
JsonValue SearchNearbyResultItem::Jsonize() const {
  JsonValue payload;
