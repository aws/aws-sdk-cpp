...
PhonemeDetails::PhonemeDetails(JsonView jsonValue) { *this = jsonValue; }

PhonemeDetails& PhonemeDetails::operator=(JsonView jsonValue) {
...
JsonValue PhonemeDetails::Jsonize() const {
  JsonValue payload;
