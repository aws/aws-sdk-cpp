...
SearchTextResult::SearchTextResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

SearchTextResult& SearchTextResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
