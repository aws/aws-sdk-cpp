...
AWSError<CoreErrors> GetErrorForName(const char* errorName) {
  ...
  if (hashCode == CONFLICT_HASH) {
    ...
    return AWSError<CoreErrors>(static_cast<CoreErrors>(KafkaConnectErrors::TOO_MANY_REQUESTS), RetryableType::RETRYABLE_THROTTLING);
    ...
    return AWSError<CoreErrors>(static_cast<CoreErrors>(KafkaConnectErrors::INTERNAL_SERVER_ERROR), RetryableType::RETRYABLE);
  }
