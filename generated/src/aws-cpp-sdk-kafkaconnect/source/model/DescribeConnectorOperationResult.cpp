...
DescribeConnectorOperationResult::DescribeConnectorOperationResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
DescribeConnectorOperationResult& DescribeConnectorOperationResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("connectorOperationState")) {
    m_connectorOperationState =
        ConnectorOperationStateMapper::GetConnectorOperationStateForName(jsonValue.GetString("connectorOperationState"));
    m_connectorOperationStateHasBeenSet = true;
  }
  if (jsonValue.ValueExists("connectorOperationType")) {
    m_connectorOperationType =
        ConnectorOperationTypeMapper::GetConnectorOperationTypeForName(jsonValue.GetString("connectorOperationType"));
  ...
  if (jsonValue.ValueExists("originConnectorConfiguration")) {
    Aws::Map<Aws::String, JsonView> originConnectorConfigurationJsonMap =
        jsonValue.GetObject("originConnectorConfiguration").GetAllObjects();
  ...
  if (jsonValue.ValueExists("targetConnectorConfiguration")) {
    Aws::Map<Aws::String, JsonView> targetConnectorConfigurationJsonMap =
        jsonValue.GetObject("targetConnectorConfiguration").GetAllObjects();
