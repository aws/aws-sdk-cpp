...
WorkerLogDeliveryDescription::WorkerLogDeliveryDescription(JsonView jsonValue) { *this = jsonValue; }

WorkerLogDeliveryDescription& WorkerLogDeliveryDescription::operator=(JsonView jsonValue) {
...
JsonValue WorkerLogDeliveryDescription::Jsonize() const {
  JsonValue payload;
