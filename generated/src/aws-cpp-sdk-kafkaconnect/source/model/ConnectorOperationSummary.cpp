...
ConnectorOperationSummary::ConnectorOperationSummary(JsonView jsonValue) { *this = jsonValue; }
...
JsonValue ConnectorOperationSummary::Jsonize() const {
  ...
  if (m_connectorOperationStateHasBeenSet) {
    payload.WithString("connectorOperationState",
                       ConnectorOperationStateMapper::GetNameForConnectorOperationState(m_connectorOperationState));
  }
