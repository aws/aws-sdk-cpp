...
AutoScalingUpdate::AutoScalingUpdate(JsonView jsonValue) { *this = jsonValue; }

AutoScalingUpdate& AutoScalingUpdate::operator=(JsonView jsonValue) {
...
JsonValue AutoScalingUpdate::Jsonize() const {
  JsonValue payload;
