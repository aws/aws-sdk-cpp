...
ListWorkerConfigurationsResult::ListWorkerConfigurationsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListWorkerConfigurationsResult& ListWorkerConfigurationsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("workerConfigurations")) {
    ...
    for (unsigned workerConfigurationsIndex = 0; workerConfigurationsIndex < workerConfigurationsJsonList.GetLength();
         ++workerConfigurationsIndex) {
