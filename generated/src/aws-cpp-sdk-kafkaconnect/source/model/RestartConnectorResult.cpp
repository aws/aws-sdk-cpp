...
RestartConnectorResult::RestartConnectorResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

RestartConnectorResult& RestartConnectorResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
