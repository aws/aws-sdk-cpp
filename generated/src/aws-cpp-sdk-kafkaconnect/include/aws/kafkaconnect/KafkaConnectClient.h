...
namespace KafkaConnect
{
   ...
   * <p/>
   */
  class AWS_KAFKACONNECT_API KafkaConnectClient : Aws::Client::ClientWithAsyncTemplateMethods<KafkaConnectClient>,
    smithy::client::AwsSmithyClientT<Aws::KafkaConnect::SERVICE_NAME,
