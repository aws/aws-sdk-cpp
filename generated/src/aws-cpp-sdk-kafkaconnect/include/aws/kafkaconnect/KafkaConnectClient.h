...
class AWS_KAFKACONNECT_API KafkaConnectClient : public Aws::Client::AWSJsonClient,
                                                ...
                                                public KafkaConnectWaiter<KafkaConnectClient> {
 public:
   ...
   */
  KafkaConnectClient(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<KafkaConnectEndpointProviderBase> endpointProvider = nullptr,
      const Aws::KafkaConnect::KafkaConnectClientConfiguration& clientConfiguration = Aws::KafkaConnect::KafkaConnectClientConfiguration());
  ...
  /**
   * A Callable wrapper for CreateCustomPlugin that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateCustomPlugin that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateCustomPluginRequestT = Model::CreateCustomPluginRequest>
  void CreateCustomPluginAsync(const CreateCustomPluginRequestT& request, const CreateCustomPluginResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateWorkerConfiguration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CreateWorkerConfigurationRequestT = Model::CreateWorkerConfigurationRequest>
  Model::CreateWorkerConfigurationOutcomeCallable CreateWorkerConfigurationCallable(
      const CreateWorkerConfigurationRequestT& request) const {
    return SubmitCallable(&KafkaConnectClient::CreateWorkerConfiguration, request);
  }

  /**
   * An Async wrapper for CreateWorkerConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateWorkerConfigurationRequestT = Model::CreateWorkerConfigurationRequest>
  void CreateWorkerConfigurationAsync(const CreateWorkerConfigurationRequestT& request,
                                      const CreateWorkerConfigurationResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteCustomPlugin that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteCustomPlugin that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteCustomPluginRequestT = Model::DeleteCustomPluginRequest>
  void DeleteCustomPluginAsync(const DeleteCustomPluginRequestT& request, const DeleteCustomPluginResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteWorkerConfiguration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DeleteWorkerConfigurationRequestT = Model::DeleteWorkerConfigurationRequest>
  Model::DeleteWorkerConfigurationOutcomeCallable DeleteWorkerConfigurationCallable(
      const DeleteWorkerConfigurationRequestT& request) const {
    return SubmitCallable(&KafkaConnectClient::DeleteWorkerConfiguration, request);
  }

  /**
   * An Async wrapper for DeleteWorkerConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteWorkerConfigurationRequestT = Model::DeleteWorkerConfigurationRequest>
  void DeleteWorkerConfigurationAsync(const DeleteWorkerConfigurationRequestT& request,
                                      const DeleteWorkerConfigurationResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeConnectorOperationOutcome DescribeConnectorOperation(
      const Model::DescribeConnectorOperationRequest& request) const;

  /**
   * A Callable wrapper for DescribeConnectorOperation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeConnectorOperationRequestT = Model::DescribeConnectorOperationRequest>
  Model::DescribeConnectorOperationOutcomeCallable DescribeConnectorOperationCallable(
      const DescribeConnectorOperationRequestT& request) const {
    return SubmitCallable(&KafkaConnectClient::DescribeConnectorOperation, request);
  }

  /**
   * An Async wrapper for DescribeConnectorOperation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeConnectorOperationRequestT = Model::DescribeConnectorOperationRequest>
  void DescribeConnectorOperationAsync(const DescribeConnectorOperationRequestT& request,
                                       const DescribeConnectorOperationResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeCustomPlugin that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeCustomPlugin that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeCustomPluginRequestT = Model::DescribeCustomPluginRequest>
  void DescribeCustomPluginAsync(const DescribeCustomPluginRequestT& request, const DescribeCustomPluginResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeWorkerConfigurationOutcome DescribeWorkerConfiguration(
      const Model::DescribeWorkerConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DescribeWorkerConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeWorkerConfigurationRequestT = Model::DescribeWorkerConfigurationRequest>
  Model::DescribeWorkerConfigurationOutcomeCallable DescribeWorkerConfigurationCallable(
      const DescribeWorkerConfigurationRequestT& request) const {
    return SubmitCallable(&KafkaConnectClient::DescribeWorkerConfiguration, request);
  }

  /**
   * An Async wrapper for DescribeWorkerConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeWorkerConfigurationRequestT = Model::DescribeWorkerConfigurationRequest>
  void DescribeWorkerConfigurationAsync(const DescribeWorkerConfigurationRequestT& request,
                                        const DescribeWorkerConfigurationResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListConnectorOperations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListConnectorOperations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListConnectorOperationsRequestT = Model::ListConnectorOperationsRequest>
  void ListConnectorOperationsAsync(const ListConnectorOperationsRequestT& request,
                                    const ListConnectorOperationsResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListCustomPlugins that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListCustomPlugins that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListCustomPluginsRequestT = Model::ListCustomPluginsRequest>
  void ListCustomPluginsAsync(const ListCustomPluginsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const ListCustomPluginsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListWorkerConfigurations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListWorkerConfigurationsRequestT = Model::ListWorkerConfigurationsRequest>
  Model::ListWorkerConfigurationsOutcomeCallable ListWorkerConfigurationsCallable(
      const ListWorkerConfigurationsRequestT& request = {}) const {
    return SubmitCallable(&KafkaConnectClient::ListWorkerConfigurations, request);
  }

  /**
   * An Async wrapper for ListWorkerConfigurations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListWorkerConfigurationsRequestT = Model::ListWorkerConfigurationsRequest>
  void ListWorkerConfigurationsAsync(const ListWorkerConfigurationsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const ListWorkerConfigurationsRequestT& request = {}) const {
