...
public:
  ...
  KafkaConnectError(const Aws::Client::AWSError<KafkaConnectErrors>& rhs) : Aws::Client::AWSError<KafkaConnectErrors>(rhs) {}
  KafkaConnectError(Aws::Client::AWSError<KafkaConnectErrors>&& rhs) : Aws::Client::AWSError<KafkaConnectErrors>(rhs) {}
