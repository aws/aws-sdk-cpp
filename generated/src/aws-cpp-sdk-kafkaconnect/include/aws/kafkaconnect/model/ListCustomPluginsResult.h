...
class ListCustomPluginsResult {
 public:
  ...
  void SetCustomPlugins(CustomPluginsT&& value) {
    m_customPluginsHasBeenSet = true;
    m_customPlugins = std::forward<CustomPluginsT>(value);
  }
  template <typename CustomPluginsT = Aws::Vector<CustomPluginSummary>>
  ListCustomPluginsResult& WithCustomPlugins(CustomPluginsT&& value) {
    SetCustomPlugins(std::forward<CustomPluginsT>(value));
    return *this;
  }
  template <typename CustomPluginsT = CustomPluginSummary>
  ListCustomPluginsResult& AddCustomPlugins(CustomPluginsT&& value) {
    m_customPluginsHasBeenSet = true;
    m_customPlugins.emplace_back(std::forward<CustomPluginsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListCustomPluginsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListCustomPluginsResult& WithRequestId(RequestIdT&& value) {
