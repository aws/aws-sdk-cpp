...
class DescribeConnectorResult {
 public:
  ...
  inline DescribeConnectorResult& WithConnectorState(ConnectorState value) {
  ...
  inline DescribeConnectorResult& WithNetworkType(NetworkType value) {
  ...
  void SetStateDescription(StateDescriptionT&& value) {
    ...
    m_stateDescription = std::forward<StateDescriptionT>(value);
  }
  template <typename StateDescriptionT = StateDescription>
  DescribeConnectorResult& WithStateDescription(StateDescriptionT&& value) {
    SetStateDescription(std::forward<StateDescriptionT>(value));
    return *this;
  }
  ///@}
