...
class KafkaClusterClientAuthenticationDescription {
 public:
  AWS_KAFKACONNECT_API KafkaClusterClientAuthenticationDescription() = default;
  ...
  inline void SetAuthenticationType(KafkaClusterClientAuthenticationType value) {
    m_authenticationTypeHasBeenSet = true;
    m_authenticationType = value;
  }
  inline KafkaClusterClientAuthenticationDescription& WithAuthenticationType(KafkaClusterClientAuthenticationType value) {
