...
class ConnectorOperationSummary {
 public:
  ...
  inline ConnectorOperationSummary& WithConnectorOperationType(ConnectorOperationType value) {
  ...
  inline ConnectorOperationSummary& WithConnectorOperationState(ConnectorOperationState value) {
