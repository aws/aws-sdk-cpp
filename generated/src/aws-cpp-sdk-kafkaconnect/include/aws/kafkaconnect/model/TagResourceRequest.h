...
namespace Model
{
  ...
  /**
   */
  class TagResourceRequest : public KafkaConnectRequest
  {
  public:
    AWS_KAFKACONNECT_API TagResourceRequest() = default;
    ...
    ///@{
    /**
     * <p>The Amazon Resource Name (ARN) of the resource to which you want to attach
     * tags.</p>
     */
