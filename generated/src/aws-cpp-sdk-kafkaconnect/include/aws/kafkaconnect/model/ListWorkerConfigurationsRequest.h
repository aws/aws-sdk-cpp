...
class ListWorkerConfigurationsRequest : public KafkaConnectRequest {
 public:
  ...
  inline ListWorkerConfigurationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListWorkerConfigurationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename NamePrefixT = Aws::String>
  ListWorkerConfigurationsRequest& WithNamePrefix(NamePrefixT&& value) {
