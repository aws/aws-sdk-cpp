...
class CreateWorkerConfigurationResult {
 public:
  ...
  template <typename NameT = Aws::String>
  CreateWorkerConfigurationResult& WithName(NameT&& value) {
  ...
  inline CreateWorkerConfigurationResult& WithWorkerConfigurationState(WorkerConfigurationState value) {
