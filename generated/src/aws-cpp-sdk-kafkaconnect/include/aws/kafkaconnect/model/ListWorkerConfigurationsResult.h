...
class ListWorkerConfigurationsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListWorkerConfigurationsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetWorkerConfigurations(WorkerConfigurationsT&& value) {
    m_workerConfigurationsHasBeenSet = true;
    m_workerConfigurations = std::forward<WorkerConfigurationsT>(value);
  }
  template <typename WorkerConfigurationsT = Aws::Vector<WorkerConfigurationSummary>>
  ListWorkerConfigurationsResult& WithWorkerConfigurations(WorkerConfigurationsT&& value) {
    SetWorkerConfigurations(std::forward<WorkerConfigurationsT>(value));
    return *this;
  }
  template <typename WorkerConfigurationsT = WorkerConfigurationSummary>
  ListWorkerConfigurationsResult& AddWorkerConfigurations(WorkerConfigurationsT&& value) {
    m_workerConfigurationsHasBeenSet = true;
    m_workerConfigurations.emplace_back(std::forward<WorkerConfigurationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListWorkerConfigurationsResult& WithRequestId(RequestIdT&& value) {
