...
class AutoScalingDescription {
 public:
  ...
  inline AutoScalingDescription& WithMaxWorkerCount(int value) {
  ...
  inline AutoScalingDescription& WithMcuCount(int value) {
    SetMcuCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMinWorkerCount(int value) {
    m_minWorkerCountHasBeenSet = true;
    m_minWorkerCount = value;
  }
  inline AutoScalingDescription& WithMinWorkerCount(int value) {
    SetMinWorkerCount(value);
    return *this;
  }
  ///@}
  ...
  void SetScaleOutPolicy(ScaleOutPolicyT&& value) {
    ...
    m_scaleOutPolicy = std::forward<ScaleOutPolicyT>(value);
  }
  template <typename ScaleOutPolicyT = ScaleOutPolicyDescription>
  AutoScalingDescription& WithScaleOutPolicy(ScaleOutPolicyT&& value) {
    SetScaleOutPolicy(std::forward<ScaleOutPolicyT>(value));
    return *this;
  }
  ///@}
  ...
  inline AutoScalingDescription& WithMaxAutoscalingTaskCount(int value) {
