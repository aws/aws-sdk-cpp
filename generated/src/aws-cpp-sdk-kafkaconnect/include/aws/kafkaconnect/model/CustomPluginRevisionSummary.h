...
class CustomPluginRevisionSummary {
 public:
  ...
  inline void SetContentType(CustomPluginContentType value) {
    m_contentTypeHasBeenSet = true;
    m_contentType = value;
  }
  inline CustomPluginRevisionSummary& WithContentType(CustomPluginContentType value) {
  ...
  void SetFileDescription(FileDescriptionT&& value) {
    ...
    m_fileDescription = std::forward<FileDescriptionT>(value);
  }
  template <typename FileDescriptionT = CustomPluginFileDescription>
  CustomPluginRevisionSummary& WithFileDescription(FileDescriptionT&& value) {
    SetFileDescription(std::forward<FileDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  inline CustomPluginRevisionSummary& WithRevision(long long value) {
    SetRevision(value);
    return *this;
  }
  ///@}
