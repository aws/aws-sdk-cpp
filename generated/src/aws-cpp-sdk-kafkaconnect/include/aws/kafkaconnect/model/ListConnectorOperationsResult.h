...
class ListConnectorOperationsResult {
 public:
  ...
  void SetConnectorOperations(ConnectorOperationsT&& value) {
    m_connectorOperationsHasBeenSet = true;
    m_connectorOperations = std::forward<ConnectorOperationsT>(value);
  }
  template <typename ConnectorOperationsT = Aws::Vector<ConnectorOperationSummary>>
  ListConnectorOperationsResult& WithConnectorOperations(ConnectorOperationsT&& value) {
    SetConnectorOperations(std::forward<ConnectorOperationsT>(value));
    return *this;
  }
  template <typename ConnectorOperationsT = ConnectorOperationSummary>
  ListConnectorOperationsResult& AddConnectorOperations(ConnectorOperationsT&& value) {
    m_connectorOperationsHasBeenSet = true;
    m_connectorOperations.emplace_back(std::forward<ConnectorOperationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListConnectorOperationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListConnectorOperationsResult& WithRequestId(RequestIdT&& value) {
