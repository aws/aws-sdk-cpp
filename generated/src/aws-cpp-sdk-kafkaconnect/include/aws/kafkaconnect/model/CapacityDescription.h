...
class CapacityDescription {
 public:
  ...
  template <typename AutoScalingT = AutoScalingDescription>
  CapacityDescription& WithAutoScaling(AutoScalingT&& value) {
  ...
  void SetProvisionedCapacity(ProvisionedCapacityT&& value) {
    ...
    m_provisionedCapacity = std::forward<ProvisionedCapacityT>(value);
  }
  template <typename ProvisionedCapacityT = ProvisionedCapacityDescription>
  CapacityDescription& WithProvisionedCapacity(ProvisionedCapacityT&& value) {
    SetProvisionedCapacity(std::forward<ProvisionedCapacityT>(value));
    return *this;
  }
  ///@}
 private:
