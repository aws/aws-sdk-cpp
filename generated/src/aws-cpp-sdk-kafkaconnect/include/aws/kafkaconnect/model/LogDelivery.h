...
class LogDelivery {
 public:
  ...
  void SetWorkerLogDelivery(WorkerLogDeliveryT&& value) {
    ...
    m_workerLogDelivery = std::forward<WorkerLogDeliveryT>(value);
  }
  template <typename WorkerLogDeliveryT = WorkerLogDelivery>
  LogDelivery& WithWorkerLogDelivery(WorkerLogDeliveryT&& value) {
    SetWorkerLogDelivery(std::forward<WorkerLogDeliveryT>(value));
    return *this;
  }
  ///@}
 private:
