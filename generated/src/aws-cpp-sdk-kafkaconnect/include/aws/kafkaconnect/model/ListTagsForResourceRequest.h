...
namespace Model
{
  ...
  /**
   */
  class ListTagsForResourceRequest : public KafkaConnectRequest
  {
  public:
    AWS_KAFKACONNECT_API ListTagsForResourceRequest() = default;
    ...
    ///@{
    /**
     * <p>The Amazon Resource Name (ARN) of the resource for which you want to list all
     * attached tags.</p>
     */
