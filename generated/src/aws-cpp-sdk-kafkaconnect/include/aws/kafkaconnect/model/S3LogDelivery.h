...
namespace Model
{
  ...
  {
  public:
    AWS_KAFKACONNECT_API S3LogDelivery() = default;
    ...
    template<typename BucketT = Aws::String>
    S3LogDelivery& WithBucket(BucketT&& value) { SetBucket(std::forward<BucketT>(value)); return *this;}
    ///@}
    ...
    template<typename PrefixT = Aws::String>
    S3LogDelivery& WithPrefix(PrefixT&& value) { SetPrefix(std::forward<PrefixT>(value)); return *this;}
    ///@}
  private:
