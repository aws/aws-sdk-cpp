...
class ListCustomPluginsRequest : public KafkaConnectRequest {
 public:
  ...
  inline ListCustomPluginsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListCustomPluginsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename NamePrefixT = Aws::String>
  ListCustomPluginsRequest& WithNamePrefix(NamePrefixT&& value) {
