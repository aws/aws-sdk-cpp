...
class ListConnectorsRequest : public KafkaConnectRequest {
 public:
  ...
  void SetConnectorNamePrefix(ConnectorNamePrefixT&& value) {
    m_connectorNamePrefixHasBeenSet = true;
    m_connectorNamePrefix = std::forward<ConnectorNamePrefixT>(value);
  }
  template <typename ConnectorNamePrefixT = Aws::String>
  ListConnectorsRequest& WithConnectorNamePrefix(ConnectorNamePrefixT&& value) {
    SetConnectorNamePrefix(std::forward<ConnectorNamePrefixT>(value));
    return *this;
  }
  ///@}
