...
class DescribeWorkerConfigurationResult {
 public:
  ...
  template <typename NameT = Aws::String>
  DescribeWorkerConfigurationResult& WithName(NameT&& value) {
  ...
  inline void SetWorkerConfigurationState(WorkerConfigurationState value) {
    m_workerConfigurationStateHasBeenSet = true;
    m_workerConfigurationState = value;
  }
  inline DescribeWorkerConfigurationResult& WithWorkerConfigurationState(WorkerConfigurationState value) {
    SetWorkerConfigurationState(value);
    return *this;
  }
  ///@}
