...
namespace ACMPCA
{
const size_t ACMPCAEndpointRules::RulesBlobStrLen = 3955;
const size_t ACMPCAEndpointRules::RulesBlobSize = 3956;
...
'n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','a','c','m','-','p',
'c','a','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R','e','s',
