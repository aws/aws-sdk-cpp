...
CertificateAuthority& CertificateAuthority::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("KeyStorageSecurityStandard")) {
    m_keyStorageSecurityStandard =
        KeyStorageSecurityStandardMapper::GetKeyStorageSecurityStandardForName(jsonValue.GetString("KeyStorageSecurityStandard"));
...
JsonValue CertificateAuthority::Jsonize() const {
  ...
  if (m_keyStorageSecurityStandardHasBeenSet) {
    payload.WithString("KeyStorageSecurityStandard",
                       KeyStorageSecurityStandardMapper::GetNameForKeyStorageSecurityStandard(m_keyStorageSecurityStandard));
  }
