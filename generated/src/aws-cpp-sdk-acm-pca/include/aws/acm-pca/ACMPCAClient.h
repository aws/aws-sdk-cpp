...
class AWS_ACMPCA_API ACMPCAClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  ACMPCAClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<ACMPCAEndpointProviderBase> endpointProvider = nullptr,
   ...
   * is not specified, it will be initialized to default values.
   */
  ACMPCAClient(const Aws::Auth::AWSCredentials& credentials, const Aws::Client::ClientConfiguration& clientConfiguration);
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateCertificateAuthorityAuditReportOutcome CreateCertificateAuthorityAuditReport(
      const Model::CreateCertificateAuthorityAuditReportRequest& request) const;

  /**
   * A Callable wrapper for CreateCertificateAuthorityAuditReport that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename CreateCertificateAuthorityAuditReportRequestT = Model::CreateCertificateAuthorityAuditReportRequest>
  Model::CreateCertificateAuthorityAuditReportOutcomeCallable CreateCertificateAuthorityAuditReportCallable(
      const CreateCertificateAuthorityAuditReportRequestT& request) const {
    return SubmitCallable(&ACMPCAClient::CreateCertificateAuthorityAuditReport, request);
  }

  /**
   * An Async wrapper for CreateCertificateAuthorityAuditReport that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename CreateCertificateAuthorityAuditReportRequestT = Model::CreateCertificateAuthorityAuditReportRequest>
  void CreateCertificateAuthorityAuditReportAsync(const CreateCertificateAuthorityAuditReportRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeCertificateAuthorityAuditReportOutcome DescribeCertificateAuthorityAuditReport(
      const Model::DescribeCertificateAuthorityAuditReportRequest& request) const;

  /**
   * A Callable wrapper for DescribeCertificateAuthorityAuditReport that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DescribeCertificateAuthorityAuditReportRequestT = Model::DescribeCertificateAuthorityAuditReportRequest>
  Model::DescribeCertificateAuthorityAuditReportOutcomeCallable DescribeCertificateAuthorityAuditReportCallable(
      const DescribeCertificateAuthorityAuditReportRequestT& request) const {
    return SubmitCallable(&ACMPCAClient::DescribeCertificateAuthorityAuditReport, request);
  }

  /**
   * An Async wrapper for DescribeCertificateAuthorityAuditReport that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeCertificateAuthorityAuditReportRequestT = Model::DescribeCertificateAuthorityAuditReportRequest>
  void DescribeCertificateAuthorityAuditReportAsync(const DescribeCertificateAuthorityAuditReportRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetCertificateAuthorityCertificateOutcome GetCertificateAuthorityCertificate(
      const Model::GetCertificateAuthorityCertificateRequest& request) const;

  /**
   * A Callable wrapper for GetCertificateAuthorityCertificate that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename GetCertificateAuthorityCertificateRequestT = Model::GetCertificateAuthorityCertificateRequest>
  Model::GetCertificateAuthorityCertificateOutcomeCallable GetCertificateAuthorityCertificateCallable(
      const GetCertificateAuthorityCertificateRequestT& request) const {
    return SubmitCallable(&ACMPCAClient::GetCertificateAuthorityCertificate, request);
  }

  /**
   * An Async wrapper for GetCertificateAuthorityCertificate that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetCertificateAuthorityCertificateRequestT = Model::GetCertificateAuthorityCertificateRequest>
  void GetCertificateAuthorityCertificateAsync(const GetCertificateAuthorityCertificateRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetCertificateAuthorityCsrOutcome GetCertificateAuthorityCsr(
      const Model::GetCertificateAuthorityCsrRequest& request) const;

  /**
   * A Callable wrapper for GetCertificateAuthorityCsr that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetCertificateAuthorityCsrRequestT = Model::GetCertificateAuthorityCsrRequest>
  Model::GetCertificateAuthorityCsrOutcomeCallable GetCertificateAuthorityCsrCallable(
      const GetCertificateAuthorityCsrRequestT& request) const {
    return SubmitCallable(&ACMPCAClient::GetCertificateAuthorityCsr, request);
  }

  /**
   * An Async wrapper for GetCertificateAuthorityCsr that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetCertificateAuthorityCsrRequestT = Model::GetCertificateAuthorityCsrRequest>
  void GetCertificateAuthorityCsrAsync(const GetCertificateAuthorityCsrRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::ImportCertificateAuthorityCertificateOutcome ImportCertificateAuthorityCertificate(
      const Model::ImportCertificateAuthorityCertificateRequest& request) const;

  /**
   * A Callable wrapper for ImportCertificateAuthorityCertificate that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ImportCertificateAuthorityCertificateRequestT = Model::ImportCertificateAuthorityCertificateRequest>
  Model::ImportCertificateAuthorityCertificateOutcomeCallable ImportCertificateAuthorityCertificateCallable(
      const ImportCertificateAuthorityCertificateRequestT& request) const {
    return SubmitCallable(&ACMPCAClient::ImportCertificateAuthorityCertificate, request);
  }

  /**
   * An Async wrapper for ImportCertificateAuthorityCertificate that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ImportCertificateAuthorityCertificateRequestT = Model::ImportCertificateAuthorityCertificateRequest>
  void ImportCertificateAuthorityCertificateAsync(const ImportCertificateAuthorityCertificateRequestT& request,
  ...
  /**
   * A Callable wrapper for IssueCertificate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for IssueCertificate that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename IssueCertificateRequestT = Model::IssueCertificateRequest>
  void IssueCertificateAsync(const IssueCertificateRequestT& request, const IssueCertificateResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename ListCertificateAuthoritiesRequestT = Model::ListCertificateAuthoritiesRequest>
  void ListCertificateAuthoritiesAsync(const ListCertificateAuthoritiesResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::RestoreCertificateAuthorityOutcome RestoreCertificateAuthority(
      const Model::RestoreCertificateAuthorityRequest& request) const;

  /**
   * A Callable wrapper for RestoreCertificateAuthority that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename RestoreCertificateAuthorityRequestT = Model::RestoreCertificateAuthorityRequest>
  Model::RestoreCertificateAuthorityOutcomeCallable RestoreCertificateAuthorityCallable(
      const RestoreCertificateAuthorityRequestT& request) const {
    return SubmitCallable(&ACMPCAClient::RestoreCertificateAuthority, request);
  }

  /**
   * An Async wrapper for RestoreCertificateAuthority that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RestoreCertificateAuthorityRequestT = Model::RestoreCertificateAuthorityRequest>
  void RestoreCertificateAuthorityAsync(const RestoreCertificateAuthorityRequestT& request,
  ...
  /**
   * A Callable wrapper for TagCertificateAuthority that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for TagCertificateAuthority that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename TagCertificateAuthorityRequestT = Model::TagCertificateAuthorityRequest>
  void TagCertificateAuthorityAsync(const TagCertificateAuthorityRequestT& request,
  ...
  /**
   * A Callable wrapper for UntagCertificateAuthority that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename UntagCertificateAuthorityRequestT = Model::UntagCertificateAuthorityRequest>
  Model::UntagCertificateAuthorityOutcomeCallable UntagCertificateAuthorityCallable(
      const UntagCertificateAuthorityRequestT& request) const {
    return SubmitCallable(&ACMPCAClient::UntagCertificateAuthority, request);
  }

  /**
   * An Async wrapper for UntagCertificateAuthority that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UntagCertificateAuthorityRequestT = Model::UntagCertificateAuthorityRequest>
  void UntagCertificateAuthorityAsync(const UntagCertificateAuthorityRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateCertificateAuthorityOutcome UpdateCertificateAuthority(
      const Model::UpdateCertificateAuthorityRequest& request) const;

  /**
   * A Callable wrapper for UpdateCertificateAuthority that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateCertificateAuthorityRequestT = Model::UpdateCertificateAuthorityRequest>
  Model::UpdateCertificateAuthorityOutcomeCallable UpdateCertificateAuthorityCallable(
      const UpdateCertificateAuthorityRequestT& request) const {
    return SubmitCallable(&ACMPCAClient::UpdateCertificateAuthority, request);
  }

  /**
   * An Async wrapper for UpdateCertificateAuthority that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateCertificateAuthorityRequestT = Model::UpdateCertificateAuthorityRequest>
  void UpdateCertificateAuthorityAsync(const UpdateCertificateAuthorityRequestT& request,
