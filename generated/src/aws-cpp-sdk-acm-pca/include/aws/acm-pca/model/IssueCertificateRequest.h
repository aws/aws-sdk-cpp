...
class IssueCertificateRequest : public ACMPCARequest {
 public:
  ...
  void SetApiPassthrough(ApiPassthroughT&& value) {
    m_apiPassthroughHasBeenSet = true;
    m_apiPassthrough = std::forward<ApiPassthroughT>(value);
  }
  template <typename ApiPassthroughT = ApiPassthrough>
  IssueCertificateRequest& WithApiPassthrough(ApiPassthroughT&& value) {
    SetApiPassthrough(std::forward<ApiPassthroughT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename CertificateAuthorityArnT = Aws::String>
  IssueCertificateRequest& WithCertificateAuthorityArn(CertificateAuthorityArnT&& value) {
  ...
  void SetCsr(CsrT&& value) {
    m_csrHasBeenSet = true;
    m_csr = std::forward<CsrT>(value);
  }
  template <typename CsrT = Aws::Utils::ByteBuffer>
  IssueCertificateRequest& WithCsr(CsrT&& value) {
    SetCsr(std::forward<CsrT>(value));
    return *this;
  }
  ///@}
  ...
  inline IssueCertificateRequest& WithSigningAlgorithm(SigningAlgorithm value) {
  ...
  template <typename TemplateArnT = Aws::String>
  IssueCertificateRequest& WithTemplateArn(TemplateArnT&& value) {
  ...
  template <typename ValidityT = Validity>
  IssueCertificateRequest& WithValidity(ValidityT&& value) {
  ...
  void SetValidityNotBefore(ValidityNotBeforeT&& value) {
    m_validityNotBeforeHasBeenSet = true;
    m_validityNotBefore = std::forward<ValidityNotBeforeT>(value);
  }
  template <typename ValidityNotBeforeT = Validity>
  IssueCertificateRequest& WithValidityNotBefore(ValidityNotBeforeT&& value) {
    SetValidityNotBefore(std::forward<ValidityNotBeforeT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename IdempotencyTokenT = Aws::String>
  IssueCertificateRequest& WithIdempotencyToken(IdempotencyTokenT&& value) {
