...
class AccessDescription {
 public:
  ...
  void SetAccessMethod(AccessMethodT&& value) {
    m_accessMethodHasBeenSet = true;
    m_accessMethod = std::forward<AccessMethodT>(value);
  }
  template <typename AccessMethodT = AccessMethod>
  AccessDescription& WithAccessMethod(AccessMethodT&& value) {
    SetAccessMethod(std::forward<AccessMethodT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAccessLocation(AccessLocationT&& value) {
    m_accessLocationHasBeenSet = true;
    m_accessLocation = std::forward<AccessLocationT>(value);
  }
  template <typename AccessLocationT = GeneralName>
  AccessDescription& WithAccessLocation(AccessLocationT&& value) {
    SetAccessLocation(std::forward<AccessLocationT>(value));
    return *this;
  }
  ///@}
 private:
