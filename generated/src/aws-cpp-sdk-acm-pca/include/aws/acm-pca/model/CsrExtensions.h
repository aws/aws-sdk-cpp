...
class CsrExtensions {
 public:
  ...
  template <typename KeyUsageT = KeyUsage>
  CsrExtensions& WithKeyUsage(KeyUsageT&& value) {
  ...
  void SetSubjectInformationAccess(SubjectInformationAccessT&& value) {
    m_subjectInformationAccessHasBeenSet = true;
    m_subjectInformationAccess = std::forward<SubjectInformationAccessT>(value);
  }
  template <typename SubjectInformationAccessT = Aws::Vector<AccessDescription>>
  CsrExtensions& WithSubjectInformationAccess(SubjectInformationAccessT&& value) {
    SetSubjectInformationAccess(std::forward<SubjectInformationAccessT>(value));
    return *this;
  }
  template <typename SubjectInformationAccessT = AccessDescription>
  CsrExtensions& AddSubjectInformationAccess(SubjectInformationAccessT&& value) {
    m_subjectInformationAccessHasBeenSet = true;
    m_subjectInformationAccess.emplace_back(std::forward<SubjectInformationAccessT>(value));
    return *this;
  }
  ///@}
 private:
