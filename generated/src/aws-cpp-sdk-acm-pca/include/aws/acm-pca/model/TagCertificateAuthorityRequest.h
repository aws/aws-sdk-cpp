...
class TagCertificateAuthorityRequest : public ACMPCARequest {
 public:
  AWS_ACMPCA_API TagCertificateAuthorityRequest() = default;
  ...
  template <typename CertificateAuthorityArnT = Aws::String>
  TagCertificateAuthorityRequest& WithCertificateAuthorityArn(CertificateAuthorityArnT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  TagCertificateAuthorityRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  TagCertificateAuthorityRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
