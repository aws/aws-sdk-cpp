...
class CertificateAuthority {
 public:
  ...
  template <typename ArnT = Aws::String>
  CertificateAuthority& WithArn(ArnT&& value) {
  ...
  template <typename OwnerAccountT = Aws::String>
  CertificateAuthority& WithOwnerAccount(OwnerAccountT&& value) {
  ...
  void SetLastStateChangeAt(LastStateChangeAtT&& value) {
    m_lastStateChangeAtHasBeenSet = true;
    m_lastStateChangeAt = std::forward<LastStateChangeAtT>(value);
  }
  template <typename LastStateChangeAtT = Aws::Utils::DateTime>
  CertificateAuthority& WithLastStateChangeAt(LastStateChangeAtT&& value) {
    SetLastStateChangeAt(std::forward<LastStateChangeAtT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetType(CertificateAuthorityType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline CertificateAuthority& WithType(CertificateAuthorityType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetSerial(SerialT&& value) {
    ...
    m_serial = std::forward<SerialT>(value);
  }
  template <typename SerialT = Aws::String>
  CertificateAuthority& WithSerial(SerialT&& value) {
    SetSerial(std::forward<SerialT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(CertificateAuthorityStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline CertificateAuthority& WithStatus(CertificateAuthorityStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename NotBeforeT = Aws::Utils::DateTime>
  CertificateAuthority& WithNotBefore(NotBeforeT&& value) {
  ...
  template <typename NotAfterT = Aws::Utils::DateTime>
  CertificateAuthority& WithNotAfter(NotAfterT&& value) {
  ...
  inline void SetFailureReason(FailureReason value) {
    m_failureReasonHasBeenSet = true;
    m_failureReason = value;
  }
  inline CertificateAuthority& WithFailureReason(FailureReason value) {
   ...
   */
  inline const CertificateAuthorityConfiguration& GetCertificateAuthorityConfiguration() const {
    return m_certificateAuthorityConfiguration;
  }
  ...
  void SetCertificateAuthorityConfiguration(CertificateAuthorityConfigurationT&& value) {
    m_certificateAuthorityConfigurationHasBeenSet = true;
    m_certificateAuthorityConfiguration = std::forward<CertificateAuthorityConfigurationT>(value);
  }
  template <typename CertificateAuthorityConfigurationT = CertificateAuthorityConfiguration>
  CertificateAuthority& WithCertificateAuthorityConfiguration(CertificateAuthorityConfigurationT&& value) {
    SetCertificateAuthorityConfiguration(std::forward<CertificateAuthorityConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRevocationConfiguration(RevocationConfigurationT&& value) {
    m_revocationConfigurationHasBeenSet = true;
    m_revocationConfiguration = std::forward<RevocationConfigurationT>(value);
  }
  template <typename RevocationConfigurationT = RevocationConfiguration>
  CertificateAuthority& WithRevocationConfiguration(RevocationConfigurationT&& value) {
    SetRevocationConfiguration(std::forward<RevocationConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRestorableUntil(RestorableUntilT&& value) {
    m_restorableUntilHasBeenSet = true;
    m_restorableUntil = std::forward<RestorableUntilT>(value);
  }
  template <typename RestorableUntilT = Aws::Utils::DateTime>
  CertificateAuthority& WithRestorableUntil(RestorableUntilT&& value) {
    SetRestorableUntil(std::forward<RestorableUntilT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetKeyStorageSecurityStandard(KeyStorageSecurityStandard value) {
    m_keyStorageSecurityStandardHasBeenSet = true;
    m_keyStorageSecurityStandard = value;
  }
  inline CertificateAuthority& WithKeyStorageSecurityStandard(KeyStorageSecurityStandard value) {
    SetKeyStorageSecurityStandard(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUsageMode(CertificateAuthorityUsageMode value) {
    m_usageModeHasBeenSet = true;
    m_usageMode = value;
  }
  inline CertificateAuthority& WithUsageMode(CertificateAuthorityUsageMode value) {
    SetUsageMode(value);
    return *this;
  }
  ///@}
