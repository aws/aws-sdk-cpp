...
class KeyUsage {
 public:
  ...
  inline void SetDigitalSignature(bool value) {
    m_digitalSignatureHasBeenSet = true;
    m_digitalSignature = value;
  }
  inline KeyUsage& WithDigitalSignature(bool value) {
  ...
  inline void SetNonRepudiation(bool value) {
    m_nonRepudiationHasBeenSet = true;
    m_nonRepudiation = value;
  }
  inline KeyUsage& WithNonRepudiation(bool value) {
    SetNonRepudiation(value);
    return *this;
  }
  ///@}
  ...
  inline void SetKeyEncipherment(bool value) {
    m_keyEnciphermentHasBeenSet = true;
    m_keyEncipherment = value;
  }
  inline KeyUsage& WithKeyEncipherment(bool value) {
    SetKeyEncipherment(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDataEncipherment(bool value) {
    m_dataEnciphermentHasBeenSet = true;
    m_dataEncipherment = value;
  }
  inline KeyUsage& WithDataEncipherment(bool value) {
    SetDataEncipherment(value);
    return *this;
  }
  ///@}
  ...
  inline KeyUsage& WithKeyAgreement(bool value) {
  ...
  inline void SetKeyCertSign(bool value) {
    m_keyCertSignHasBeenSet = true;
    m_keyCertSign = value;
  }
  inline KeyUsage& WithKeyCertSign(bool value) {
    SetKeyCertSign(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCRLSign(bool value) {
    m_cRLSignHasBeenSet = true;
    m_cRLSign = value;
  }
  inline KeyUsage& WithCRLSign(bool value) {
    SetCRLSign(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEncipherOnly(bool value) {
    m_encipherOnlyHasBeenSet = true;
    m_encipherOnly = value;
  }
  inline KeyUsage& WithEncipherOnly(bool value) {
    SetEncipherOnly(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDecipherOnly(bool value) {
    m_decipherOnlyHasBeenSet = true;
    m_decipherOnly = value;
  }
  inline KeyUsage& WithDecipherOnly(bool value) {
    SetDecipherOnly(value);
    return *this;
  }
  ///@}
 private:
