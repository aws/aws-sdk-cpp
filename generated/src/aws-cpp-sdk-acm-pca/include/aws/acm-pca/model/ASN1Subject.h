...
class ASN1Subject {
 public:
  ...
  template <typename CountryT = Aws::String>
  ASN1Subject& WithCountry(CountryT&& value) {
  ...
  template <typename OrganizationT = Aws::String>
  ASN1Subject& WithOrganization(OrganizationT&& value) {
  ...
  template <typename OrganizationalUnitT = Aws::String>
  ASN1Subject& WithOrganizationalUnit(OrganizationalUnitT&& value) {
  ...
  template <typename DistinguishedNameQualifierT = Aws::String>
  ASN1Subject& WithDistinguishedNameQualifier(DistinguishedNameQualifierT&& value) {
  ...
  template <typename StateT = Aws::String>
  ASN1Subject& WithState(StateT&& value) {
  ...
  template <typename CommonNameT = Aws::String>
  ASN1Subject& WithCommonName(CommonNameT&& value) {
  ...
  template <typename SerialNumberT = Aws::String>
  ASN1Subject& WithSerialNumber(SerialNumberT&& value) {
  ...
  template <typename LocalityT = Aws::String>
  ASN1Subject& WithLocality(LocalityT&& value) {
  ...
  template <typename TitleT = Aws::String>
  ASN1Subject& WithTitle(TitleT&& value) {
  ...
  template <typename SurnameT = Aws::String>
  ASN1Subject& WithSurname(SurnameT&& value) {
  ...
  template <typename GivenNameT = Aws::String>
  ASN1Subject& WithGivenName(GivenNameT&& value) {
  ...
  template <typename InitialsT = Aws::String>
  ASN1Subject& WithInitials(InitialsT&& value) {
  ...
  template <typename PseudonymT = Aws::String>
  ASN1Subject& WithPseudonym(PseudonymT&& value) {
  ...
  template <typename GenerationQualifierT = Aws::String>
  ASN1Subject& WithGenerationQualifier(GenerationQualifierT&& value) {
  ...
  template <typename CustomAttributesT = Aws::Vector<CustomAttribute>>
  ASN1Subject& WithCustomAttributes(CustomAttributesT&& value) {
    SetCustomAttributes(std::forward<CustomAttributesT>(value));
    return *this;
  }
  template <typename CustomAttributesT = CustomAttribute>
  ASN1Subject& AddCustomAttributes(CustomAttributesT&& value) {
    m_customAttributesHasBeenSet = true;
