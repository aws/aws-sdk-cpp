...
class RevocationConfiguration {
 public:
  ...
  void SetCrlConfiguration(CrlConfigurationT&& value) {
    m_crlConfigurationHasBeenSet = true;
    m_crlConfiguration = std::forward<CrlConfigurationT>(value);
  }
  template <typename CrlConfigurationT = CrlConfiguration>
  RevocationConfiguration& WithCrlConfiguration(CrlConfigurationT&& value) {
    SetCrlConfiguration(std::forward<CrlConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOcspConfiguration(OcspConfigurationT&& value) {
    m_ocspConfigurationHasBeenSet = true;
    m_ocspConfiguration = std::forward<OcspConfigurationT>(value);
  }
  template <typename OcspConfigurationT = OcspConfiguration>
  RevocationConfiguration& WithOcspConfiguration(OcspConfigurationT&& value) {
    SetOcspConfiguration(std::forward<OcspConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
