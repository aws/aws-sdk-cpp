...
class AccessMethod {
 public:
  ...
  void SetCustomObjectIdentifier(CustomObjectIdentifierT&& value) {
    m_customObjectIdentifierHasBeenSet = true;
    m_customObjectIdentifier = std::forward<CustomObjectIdentifierT>(value);
  }
  template <typename CustomObjectIdentifierT = Aws::String>
  AccessMethod& WithCustomObjectIdentifier(CustomObjectIdentifierT&& value) {
    SetCustomObjectIdentifier(std::forward<CustomObjectIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAccessMethodType(AccessMethodType value) {
    m_accessMethodTypeHasBeenSet = true;
    m_accessMethodType = value;
  }
  inline AccessMethod& WithAccessMethodType(AccessMethodType value) {
    SetAccessMethodType(value);
    return *this;
  }
  ///@}
 private:
