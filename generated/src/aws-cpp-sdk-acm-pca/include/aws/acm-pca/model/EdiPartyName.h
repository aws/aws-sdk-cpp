...
class EdiPartyName {
 public:
  ...
  void SetPartyName(PartyNameT&& value) {
    m_partyNameHasBeenSet = true;
    m_partyName = std::forward<PartyNameT>(value);
  }
  template <typename PartyNameT = Aws::String>
  EdiPartyName& WithPartyName(PartyNameT&& value) {
    SetPartyName(std::forward<PartyNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNameAssigner(NameAssignerT&& value) {
    m_nameAssignerHasBeenSet = true;
    m_nameAssigner = std::forward<NameAssignerT>(value);
  }
  template <typename NameAssignerT = Aws::String>
  EdiPartyName& WithNameAssigner(NameAssignerT&& value) {
    SetNameAssigner(std::forward<NameAssignerT>(value));
    return *this;
  }
  ///@}
 private:
