...
class CertificateAuthorityConfiguration {
 public:
  ...
  inline CertificateAuthorityConfiguration& WithKeyAlgorithm(KeyAlgorithm value) {
  ...
  inline CertificateAuthorityConfiguration& WithSigningAlgorithm(SigningAlgorithm value) {
  ...
  template <typename SubjectT = ASN1Subject>
  CertificateAuthorityConfiguration& WithSubject(SubjectT&& value) {
  ...
  void SetCsrExtensions(CsrExtensionsT&& value) {
    m_csrExtensionsHasBeenSet = true;
    m_csrExtensions = std::forward<CsrExtensionsT>(value);
  }
  template <typename CsrExtensionsT = CsrExtensions>
  CertificateAuthorityConfiguration& WithCsrExtensions(CsrExtensionsT&& value) {
    SetCsrExtensions(std::forward<CsrExtensionsT>(value));
    return *this;
  }
  ///@}
 private:
