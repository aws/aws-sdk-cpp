...
class DeleteCertificateAuthorityRequest : public ACMPCARequest {
 public:
  ...
  template <typename CertificateAuthorityArnT = Aws::String>
  DeleteCertificateAuthorityRequest& WithCertificateAuthorityArn(CertificateAuthorityArnT&& value) {
  ...
  inline void SetPermanentDeletionTimeInDays(int value) {
    m_permanentDeletionTimeInDaysHasBeenSet = true;
    m_permanentDeletionTimeInDays = value;
  }
  inline DeleteCertificateAuthorityRequest& WithPermanentDeletionTimeInDays(int value) {
    SetPermanentDeletionTimeInDays(value);
    return *this;
  }
  ///@}
 private:
