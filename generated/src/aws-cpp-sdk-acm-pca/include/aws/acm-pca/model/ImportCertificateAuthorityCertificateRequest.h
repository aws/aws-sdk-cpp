...
class ImportCertificateAuthorityCertificateRequest : public ACMPCARequest {
 public:
  ...
  template <typename CertificateAuthorityArnT = Aws::String>
  ImportCertificateAuthorityCertificateRequest& WithCertificateAuthorityArn(CertificateAuthorityArnT&& value) {
  ...
  template <typename CertificateT = Aws::Utils::ByteBuffer>
  ImportCertificateAuthorityCertificateRequest& WithCertificate(CertificateT&& value) {
  ...
  template <typename CertificateChainT = Aws::Utils::ByteBuffer>
  ImportCertificateAuthorityCertificateRequest& WithCertificateChain(CertificateChainT&& value) {
