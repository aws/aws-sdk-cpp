...
class Permission {
 public:
  ...
  template <typename CertificateAuthorityArnT = Aws::String>
  Permission& WithCertificateAuthorityArn(CertificateAuthorityArnT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  Permission& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename SourceAccountT = Aws::String>
  Permission& WithSourceAccount(SourceAccountT&& value) {
  ...
  inline Permission& AddActions(ActionType value) {
    m_actionsHasBeenSet = true;
  ...
  template <typename PolicyT = Aws::String>
  Permission& WithPolicy(PolicyT&& value) {
