 ...
 * 5280.</p> <p>Amazon Web Services Private CA API consumes the
...
class Validity {
 public:
  ...
  inline Validity& WithValue(long long value) {
    SetValue(value);
    return *this;
  }
  ///@}
  ...
  inline void SetType(ValidityPeriodType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline Validity& WithType(ValidityPeriodType value) {
    SetType(value);
    return *this;
  }
  ///@}
