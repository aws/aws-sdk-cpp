...
namespace Model
{
  ...
  /**
   */
  class RestoreCertificateAuthorityRequest : public ACMPCARequest
  {
  public:
    AWS_ACMPCA_API RestoreCertificateAuthorityRequest() = default;
    ...
    template<typename CertificateAuthorityArnT = Aws::String>
    RestoreCertificateAuthorityRequest& WithCertificateAuthorityArn(CertificateAuthorityArnT&& value) { SetCertificateAuthorityArn(std::forward<CertificateAuthorityArnT>(value)); return *this;}
    ///@}
  private:
