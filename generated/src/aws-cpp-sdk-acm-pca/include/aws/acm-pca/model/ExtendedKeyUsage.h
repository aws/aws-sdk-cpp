...
class ExtendedKeyUsage {
 public:
  ...
  inline void SetExtendedKeyUsageType(ExtendedKeyUsageType value) {
    m_extendedKeyUsageTypeHasBeenSet = true;
    m_extendedKeyUsageType = value;
  }
  inline ExtendedKeyUsage& WithExtendedKeyUsageType(ExtendedKeyUsageType value) {
    SetExtendedKeyUsageType(value);
    return *this;
  }
  ///@}
  ...
  void SetExtendedKeyUsageObjectIdentifier(ExtendedKeyUsageObjectIdentifierT&& value) {
    m_extendedKeyUsageObjectIdentifierHasBeenSet = true;
    m_extendedKeyUsageObjectIdentifier = std::forward<ExtendedKeyUsageObjectIdentifierT>(value);
  }
  template <typename ExtendedKeyUsageObjectIdentifierT = Aws::String>
  ExtendedKeyUsage& WithExtendedKeyUsageObjectIdentifier(ExtendedKeyUsageObjectIdentifierT&& value) {
    SetExtendedKeyUsageObjectIdentifier(std::forward<ExtendedKeyUsageObjectIdentifierT>(value));
    return *this;
  }
  ///@}
 private:
