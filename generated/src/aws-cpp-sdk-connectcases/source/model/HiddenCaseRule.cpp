...
HiddenCaseRule::HiddenCaseRule(JsonView jsonValue) { *this = jsonValue; }

HiddenCaseRule& HiddenCaseRule::operator=(JsonView jsonValue) {
...
JsonValue HiddenCaseRule::Jsonize() const {
  JsonValue payload;
