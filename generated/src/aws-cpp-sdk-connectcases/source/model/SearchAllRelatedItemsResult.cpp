...
SearchAllRelatedItemsResult::SearchAllRelatedItemsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

SearchAllRelatedItemsResult& SearchAllRelatedItemsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
