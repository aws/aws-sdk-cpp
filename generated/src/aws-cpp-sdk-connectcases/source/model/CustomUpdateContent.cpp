...
CustomUpdateContent::CustomUpdateContent(JsonView jsonValue) { *this = jsonValue; }

CustomUpdateContent& CustomUpdateContent::operator=(JsonView jsonValue) {
...
JsonValue CustomUpdateContent::Jsonize() const {
  JsonValue payload;
