...
#include <aws/connectcases/ConnectCasesWaiter.h>
...
class AWS_CONNECTCASES_API ConnectCasesClient : public Aws::Client::AWSJsonClient,
                                                ...
                                                public ConnectCasesWaiter<ConnectCasesClient> {
 public:
   ...
   */
  ConnectCasesClient(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<ConnectCasesEndpointProviderBase> endpointProvider = nullptr,
      const Aws::ConnectCases::ConnectCasesClientConfiguration& clientConfiguration = Aws::ConnectCases::ConnectCasesClientConfiguration());
  ...
  /**
   * A Callable wrapper for BatchGetCaseRule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchGetCaseRule that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename BatchGetCaseRuleRequestT = Model::BatchGetCaseRuleRequest>
  void BatchGetCaseRuleAsync(const BatchGetCaseRuleRequestT& request, const BatchGetCaseRuleResponseReceivedHandler& handler,
  ...
  /**
   * An Async wrapper for BatchGetField that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename BatchGetFieldRequestT = Model::BatchGetFieldRequest>
  void BatchGetFieldAsync(const BatchGetFieldRequestT& request, const BatchGetFieldResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchPutFieldOptions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchPutFieldOptions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchPutFieldOptionsRequestT = Model::BatchPutFieldOptionsRequest>
  void BatchPutFieldOptionsAsync(const BatchPutFieldOptionsRequestT& request, const BatchPutFieldOptionsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * an array id/value pairs with a declared data types.</p> <p>When creating a case
   * from a template that has tag propagation configurations, the specified tags are
   * automatically applied to the case.</p> <p>The following fields are required when
   * creating a case:</p> <ul> <li> <p> <code>customer_id</code> - You must provide
   * the full customer profile ARN in this format:
  ...
  /**
   * An Async wrapper for CreateCaseRule that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateCaseRuleRequestT = Model::CreateCaseRuleRequest>
  void CreateCaseRuleAsync(const CreateCaseRuleRequestT& request, const CreateCaseRuleResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateField that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateFieldRequestT = Model::CreateFieldRequest>
  void CreateFieldAsync(const CreateFieldRequestT& request, const CreateFieldResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateLayout that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateLayoutRequestT = Model::CreateLayoutRequest>
  void CreateLayoutAsync(const CreateLayoutRequestT& request, const CreateLayoutResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateRelatedItem that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateRelatedItem that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateRelatedItemRequestT = Model::CreateRelatedItemRequest>
  void CreateRelatedItemAsync(const CreateRelatedItemRequestT& request, const CreateRelatedItemResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteCase that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteCaseRequestT = Model::DeleteCaseRequest>
  void DeleteCaseAsync(const DeleteCaseRequestT& request, const DeleteCaseResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteCaseRule that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteCaseRuleRequestT = Model::DeleteCaseRuleRequest>
  void DeleteCaseRuleAsync(const DeleteCaseRuleRequestT& request, const DeleteCaseRuleResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteField that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteFieldRequestT = Model::DeleteFieldRequest>
  void DeleteFieldAsync(const DeleteFieldRequestT& request, const DeleteFieldResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteLayout that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteLayoutRequestT = Model::DeleteLayoutRequest>
  void DeleteLayoutAsync(const DeleteLayoutRequestT& request, const DeleteLayoutResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteRelatedItem that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteRelatedItem that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteRelatedItemRequestT = Model::DeleteRelatedItemRequest>
  void DeleteRelatedItemAsync(const DeleteRelatedItemRequestT& request, const DeleteRelatedItemResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetCase that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetCaseRequestT = Model::GetCaseRequest>
  void GetCaseAsync(const GetCaseRequestT& request, const GetCaseResponseReceivedHandler& handler,
                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetCaseAuditEvents that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetCaseAuditEvents that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetCaseAuditEventsRequestT = Model::GetCaseAuditEventsRequest>
  void GetCaseAuditEventsAsync(const GetCaseAuditEventsRequestT& request, const GetCaseAuditEventsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetCaseEventConfiguration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename GetCaseEventConfigurationRequestT = Model::GetCaseEventConfigurationRequest>
  Model::GetCaseEventConfigurationOutcomeCallable GetCaseEventConfigurationCallable(
      const GetCaseEventConfigurationRequestT& request) const {
    return SubmitCallable(&ConnectCasesClient::GetCaseEventConfiguration, request);
  }

  /**
   * An Async wrapper for GetCaseEventConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetCaseEventConfigurationRequestT = Model::GetCaseEventConfigurationRequest>
  void GetCaseEventConfigurationAsync(const GetCaseEventConfigurationRequestT& request,
                                      const GetCaseEventConfigurationResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetLayout that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetLayoutRequestT = Model::GetLayoutRequest>
  void GetLayoutAsync(const GetLayoutRequestT& request, const GetLayoutResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListCaseRules that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListCaseRulesRequestT = Model::ListCaseRulesRequest>
  void ListCaseRulesAsync(const ListCaseRulesRequestT& request, const ListCaseRulesResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListCasesForContact that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListCasesForContact that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListCasesForContactRequestT = Model::ListCasesForContactRequest>
  void ListCasesForContactAsync(const ListCasesForContactRequestT& request, const ListCasesForContactResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListFieldOptions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListFieldOptions that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListFieldOptionsRequestT = Model::ListFieldOptionsRequest>
  void ListFieldOptionsAsync(const ListFieldOptionsRequestT& request, const ListFieldOptionsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListFields that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListFieldsRequestT = Model::ListFieldsRequest>
  void ListFieldsAsync(const ListFieldsRequestT& request, const ListFieldsResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListLayouts that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListLayoutsRequestT = Model::ListLayoutsRequest>
  void ListLayoutsAsync(const ListLayoutsRequestT& request, const ListLayoutsResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutCaseEventConfiguration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename PutCaseEventConfigurationRequestT = Model::PutCaseEventConfigurationRequest>
  Model::PutCaseEventConfigurationOutcomeCallable PutCaseEventConfigurationCallable(
      const PutCaseEventConfigurationRequestT& request) const {
    return SubmitCallable(&ConnectCasesClient::PutCaseEventConfiguration, request);
  }

  /**
   * An Async wrapper for PutCaseEventConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutCaseEventConfigurationRequestT = Model::PutCaseEventConfigurationRequest>
  void PutCaseEventConfigurationAsync(const PutCaseEventConfigurationRequestT& request,
                                      const PutCaseEventConfigurationResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SearchAllRelatedItems that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SearchAllRelatedItems that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SearchAllRelatedItemsRequestT = Model::SearchAllRelatedItemsRequest>
  void SearchAllRelatedItemsAsync(const SearchAllRelatedItemsRequestT& request, const SearchAllRelatedItemsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for SearchCases that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename SearchCasesRequestT = Model::SearchCasesRequest>
  void SearchCasesAsync(const SearchCasesRequestT& request, const SearchCasesResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SearchRelatedItems that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SearchRelatedItems that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename SearchRelatedItemsRequestT = Model::SearchRelatedItemsRequest>
  void SearchRelatedItemsAsync(const SearchRelatedItemsRequestT& request, const SearchRelatedItemsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateCase that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateCaseRequestT = Model::UpdateCaseRequest>
  void UpdateCaseAsync(const UpdateCaseRequestT& request, const UpdateCaseResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateCaseRule that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateCaseRuleRequestT = Model::UpdateCaseRuleRequest>
  void UpdateCaseRuleAsync(const UpdateCaseRuleRequestT& request, const UpdateCaseRuleResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateField that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateFieldRequestT = Model::UpdateFieldRequest>
  void UpdateFieldAsync(const UpdateFieldRequestT& request, const UpdateFieldResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateLayout that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateLayoutRequestT = Model::UpdateLayoutRequest>
  void UpdateLayoutAsync(const UpdateLayoutRequestT& request, const UpdateLayoutResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
