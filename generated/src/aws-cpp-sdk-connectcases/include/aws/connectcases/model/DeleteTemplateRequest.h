...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECTCASES_API DeleteTemplateRequest() = default;
    ...
    template<typename DomainIdT = Aws::String>
    DeleteTemplateRequest& WithDomainId(DomainIdT&& value) { SetDomainId(std::forward<DomainIdT>(value)); return *this;}
    ///@}
