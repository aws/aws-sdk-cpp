...
class SlaInputConfiguration {
 public:
  ...
  template <typename NameT = Aws::String>
  SlaInputConfiguration& WithName(NameT&& value) {
  ...
  inline SlaInputConfiguration& WithType(SlaType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename FieldIdT = Aws::String>
  SlaInputConfiguration& WithFieldId(FieldIdT&& value) {
  ...
  template <typename TargetFieldValuesT = Aws::Vector<FieldValueUnion>>
  SlaInputConfiguration& WithTargetFieldValues(TargetFieldValuesT&& value) {
    SetTargetFieldValues(std::forward<TargetFieldValuesT>(value));
    return *this;
  }
  template <typename TargetFieldValuesT = FieldValueUnion>
  SlaInputConfiguration& AddTargetFieldValues(TargetFieldValuesT&& value) {
    m_targetFieldValuesHasBeenSet = true;
  ...
  inline SlaInputConfiguration& WithTargetSlaMinutes(long long value) {
