...
class SlaInputContent {
 public:
  ...
  void SetSlaInputConfiguration(SlaInputConfigurationT&& value) {
    m_slaInputConfigurationHasBeenSet = true;
    m_slaInputConfiguration = std::forward<SlaInputConfigurationT>(value);
  }
  template <typename SlaInputConfigurationT = SlaInputConfiguration>
  SlaInputContent& WithSlaInputConfiguration(SlaInputConfigurationT&& value) {
    SetSlaInputConfiguration(std::forward<SlaInputConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
