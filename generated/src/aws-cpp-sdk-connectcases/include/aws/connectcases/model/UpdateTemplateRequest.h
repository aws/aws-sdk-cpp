...
namespace Model
{
  ...
  public:
    ...
    inline UpdateTemplateRequest& WithRules(const Aws::Vector<TemplateRule>& value) { SetRules(value); return *this;}
    inline UpdateTemplateRequest& WithRules(Aws::Vector<TemplateRule>&& value) { SetRules(std::move(value)); return *this;}
    inline UpdateTemplateRequest& AddRules(const TemplateRule& value) { m_rulesHasBeenSet = true; m_rules.push_back(value); return *this; }
    inline UpdateTemplateRequest& AddRules(TemplateRule&& value) { m_rulesHasBeenSet = true; m_rules.push_back(std::move(value)); return *this; }
    ///@}
