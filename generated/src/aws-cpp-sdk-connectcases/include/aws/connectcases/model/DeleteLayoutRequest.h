...
namespace Model
{
  ...
  public:
    ...
    template<typename DomainIdT = Aws::String>
    DeleteLayoutRequest& WithDomainId(DomainIdT&& value) { SetDomainId(std::forward<DomainIdT>(value)); return *this;}
    ///@}
    ...
    template<typename LayoutIdT = Aws::String>
    DeleteLayoutRequest& WithLayoutId(LayoutIdT&& value) { SetLayoutId(std::forward<LayoutIdT>(value)); return *this;}
    ///@}
  private:
