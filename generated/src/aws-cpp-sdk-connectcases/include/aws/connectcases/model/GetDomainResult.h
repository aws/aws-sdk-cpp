...
class GetDomainResult {
 public:
  ...
  inline void SetDomainStatus(DomainStatus value) {
    m_domainStatusHasBeenSet = true;
    m_domainStatus = value;
  }
  inline GetDomainResult& WithDomainStatus(DomainStatus value) {
  ...
  inline GetDomainResult& AddTags(Aws::String key, Aws::Crt::Optional<Aws::String> value) {
    m_tagsHasBeenSet = true;
