...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECTCASES_API DeleteCaseRuleResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteCaseRuleResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
