...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECTCASES_API ConnectCaseInputContent() = default;
    AWS_CONNECTCASES_API ConnectCaseInputContent(Aws::Utils::Json::JsonView jsonValue);
    AWS_CONNECTCASES_API ConnectCaseInputContent& operator=(Aws::Utils::Json::JsonView jsonValue);
    ...
    template<typename CaseIdT = Aws::String>
    ConnectCaseInputContent& WithCaseId(CaseIdT&& value) { SetCaseId(std::forward<CaseIdT>(value)); return *this;}
    ///@}
  private:
