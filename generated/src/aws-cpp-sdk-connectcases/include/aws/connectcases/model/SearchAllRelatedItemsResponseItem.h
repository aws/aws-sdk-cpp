...
namespace Model
{
  ...
  public:
    ...
    template<typename RelatedItemIdT = Aws::String>
    SearchAllRelatedItemsResponseItem& WithRelatedItemId(RelatedItemIdT&& value) { SetRelatedItemId(std::forward<RelatedItemIdT>(value)); return *this;}
    ///@}
    ...
    template<typename CaseIdT = Aws::String>
    SearchAllRelatedItemsResponseItem& WithCaseId(CaseIdT&& value) { SetCaseId(std::forward<CaseIdT>(value)); return *this;}
    ///@}
    ...
    inline SearchAllRelatedItemsResponseItem& WithType(RelatedItemType value) { SetType(value); return *this;}
    ///@}
    ...
    template<typename AssociationTimeT = Aws::Utils::DateTime>
    SearchAllRelatedItemsResponseItem& WithAssociationTime(AssociationTimeT&& value) { SetAssociationTime(std::forward<AssociationTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename ContentT = RelatedItemContent>
    SearchAllRelatedItemsResponseItem& WithContent(ContentT&& value) { SetContent(std::forward<ContentT>(value)); return *this;}
    ///@}
    ...
    template<typename PerformedByT = UserUnion>
    SearchAllRelatedItemsResponseItem& WithPerformedBy(PerformedByT&& value) { SetPerformedBy(std::forward<PerformedByT>(value)); return *this;}
    ///@}
    ...
    template<typename TagsT = Aws::Map<Aws::String, Aws::String>>
    SearchAllRelatedItemsResponseItem& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
