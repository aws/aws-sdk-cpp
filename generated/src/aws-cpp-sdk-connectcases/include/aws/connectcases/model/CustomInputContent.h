...
namespace Model
{
  ...
  public:
    ...
    template<typename FieldsT = Aws::Vector<FieldValue>>
    CustomInputContent& WithFields(FieldsT&& value) { SetFields(std::forward<FieldsT>(value)); return *this;}
    template<typename FieldsT = FieldValue>
    CustomInputContent& AddFields(FieldsT&& value) { m_fieldsHasBeenSet = true; m_fields.emplace_back(std::forward<FieldsT>(value)); return *this; }
    ///@}
  private:
