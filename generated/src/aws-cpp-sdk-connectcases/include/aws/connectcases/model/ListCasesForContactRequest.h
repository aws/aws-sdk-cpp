...
class ListCasesForContactRequest : public ConnectCasesRequest {
 public:
  AWS_CONNECTCASES_API ListCasesForContactRequest() = default;
  ...
  template <typename DomainIdT = Aws::String>
  ListCasesForContactRequest& WithDomainId(DomainIdT&& value) {
  ...
  template <typename ContactArnT = Aws::String>
  ListCasesForContactRequest& WithContactArn(ContactArnT&& value) {
  ...
  inline ListCasesForContactRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListCasesForContactRequest& WithNextToken(NextTokenT&& value) {
