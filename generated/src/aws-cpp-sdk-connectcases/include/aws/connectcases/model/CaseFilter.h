...
class CaseFilter {
 public:
  ...
  template <typename FieldT = FieldFilter>
  CaseFilter& WithField(FieldT&& value) {
  ...
  inline const CaseFilter& GetNot() const { return *m_not; }
