...
class GetFieldResponse {
 public:
  ...
  void SetFieldArn(FieldArnT&& value) {
    ...
    m_fieldArn = std::forward<FieldArnT>(value);
  }
  template <typename FieldArnT = Aws::String>
  GetFieldResponse& WithFieldArn(FieldArnT&& value) {
    SetFieldArn(std::forward<FieldArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetFieldResponse& WithType(FieldType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNamespace(FieldNamespace value) {
    m_namespaceHasBeenSet = true;
    m_namespace = value;
  }
  inline GetFieldResponse& WithNamespace(FieldNamespace value) {
    SetNamespace(value);
    return *this;
  }
  ///@}
  ...
  inline GetFieldResponse& AddTags(Aws::String key, Aws::Crt::Optional<Aws::String> value) {
    m_tagsHasBeenSet = true;
  ...
  inline GetFieldResponse& WithDeleted(bool value) {
    SetDeleted(value);
    return *this;
  }
  ///@}
