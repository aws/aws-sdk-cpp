...
class ListFieldsResult {
 public:
  AWS_CONNECTCASES_API ListFieldsResult() = default;
  ...
  template <typename FieldsT = Aws::Vector<FieldSummary>>
  void SetFields(FieldsT&& value) {
    m_fieldsHasBeenSet = true;
    m_fields = std::forward<FieldsT>(value);
  }
  template <typename FieldsT = Aws::Vector<FieldSummary>>
  ListFieldsResult& WithFields(FieldsT&& value) {
    SetFields(std::forward<FieldsT>(value));
    return *this;
  }
  template <typename FieldsT = FieldSummary>
  ListFieldsResult& AddFields(FieldsT&& value) {
    m_fieldsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListFieldsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListFieldsResult& WithRequestId(RequestIdT&& value) {
