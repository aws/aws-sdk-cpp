...
namespace Model
{
  ...
  public:
    ...
    template<typename FieldT = FieldFilter>
    CustomFieldsFilter& WithField(FieldT&& value) { SetField(std::forward<FieldT>(value)); return *this;}
    ///@}
    ...
    template<typename NotT = CustomFieldsFilter>
    CustomFieldsFilter& WithNot(NotT&& value) { SetNot(std::forward<NotT>(value)); return *this;}
    ///@}
    ...
    template<typename AndAllT = Aws::Vector<CustomFieldsFilter>>
    CustomFieldsFilter& WithAndAll(AndAllT&& value) { SetAndAll(std::forward<AndAllT>(value)); return *this;}
    template<typename AndAllT = CustomFieldsFilter>
    CustomFieldsFilter& AddAndAll(AndAllT&& value) { m_andAllHasBeenSet = true; m_andAll.emplace_back(std::forward<AndAllT>(value)); return *this; }
    ///@}
    ...
    template<typename OrAllT = Aws::Vector<CustomFieldsFilter>>
    CustomFieldsFilter& WithOrAll(OrAllT&& value) { SetOrAll(std::forward<OrAllT>(value)); return *this;}
    template<typename OrAllT = CustomFieldsFilter>
    CustomFieldsFilter& AddOrAll(OrAllT&& value) { m_orAllHasBeenSet = true; m_orAll.emplace_back(std::forward<OrAllT>(value)); return *this; }
    ///@}
  private:
