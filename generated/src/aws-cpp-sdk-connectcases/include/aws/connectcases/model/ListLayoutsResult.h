...
class ListLayoutsResult {
 public:
  ...
  template <typename LayoutsT = Aws::Vector<LayoutSummary>>
  ListLayoutsResult& WithLayouts(LayoutsT&& value) {
    SetLayouts(std::forward<LayoutsT>(value));
    return *this;
  }
  template <typename LayoutsT = LayoutSummary>
  ListLayoutsResult& AddLayouts(LayoutsT&& value) {
    m_layoutsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListLayoutsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListLayoutsResult& WithRequestId(RequestIdT&& value) {
