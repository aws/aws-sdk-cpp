...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECTCASES_API UpdateCaseRuleResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateCaseRuleResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
