...
namespace Model
{
  ...
  public:
    ...
    inline UpdateLayoutResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateLayoutResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateLayoutResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
