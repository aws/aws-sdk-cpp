...
class GetCaseResult {
 public:
  AWS_CONNECTCASES_API GetCaseResult() = default;
  ...
  template <typename FieldsT = Aws::Vector<FieldValue>>
  GetCaseResult& WithFields(FieldsT&& value) {
    SetFields(std::forward<FieldsT>(value));
    return *this;
  }
  template <typename FieldsT = FieldValue>
  GetCaseResult& AddFields(FieldsT&& value) {
    m_fieldsHasBeenSet = true;
  ...
  template <typename TemplateIdT = Aws::String>
  GetCaseResult& WithTemplateId(TemplateIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  GetCaseResult& WithNextToken(NextTokenT&& value) {
  ...
  inline GetCaseResult& AddTags(Aws::String key, Aws::Crt::Optional<Aws::String> value) {
    m_tagsHasBeenSet = true;
