...
class SlaConfiguration {
 public:
  ...
  inline SlaConfiguration& WithType(SlaType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(SlaStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline SlaConfiguration& WithStatus(SlaStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetTargetTime(TargetTimeT&& value) {
    m_targetTimeHasBeenSet = true;
    m_targetTime = std::forward<TargetTimeT>(value);
  }
  template <typename TargetTimeT = Aws::Utils::DateTime>
  SlaConfiguration& WithTargetTime(TargetTimeT&& value) {
    SetTargetTime(std::forward<TargetTimeT>(value));
    return *this;
  }
  ///@}
