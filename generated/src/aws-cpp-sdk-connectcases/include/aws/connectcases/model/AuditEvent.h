...
class AuditEvent {
 public:
  ...
  inline void SetType(AuditEventType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline AuditEvent& WithType(AuditEventType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRelatedItemType(RelatedItemType value) {
    m_relatedItemTypeHasBeenSet = true;
    m_relatedItemType = value;
  }
  inline AuditEvent& WithRelatedItemType(RelatedItemType value) {
    SetRelatedItemType(value);
    return *this;
  }
  ///@}
  ...
  void SetPerformedTime(PerformedTimeT&& value) {
    ...
    m_performedTime = std::forward<PerformedTimeT>(value);
  }
  template <typename PerformedTimeT = Aws::Utils::DateTime>
  AuditEvent& WithPerformedTime(PerformedTimeT&& value) {
    SetPerformedTime(std::forward<PerformedTimeT>(value));
    return *this;
  }
  ///@}
