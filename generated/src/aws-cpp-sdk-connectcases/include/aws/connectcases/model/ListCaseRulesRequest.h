...
class ListCaseRulesRequest : public ConnectCasesRequest {
 public:
  AWS_CONNECTCASES_API ListCaseRulesRequest() = default;
  ...
  template <typename DomainIdT = Aws::String>
  ListCaseRulesRequest& WithDomainId(DomainIdT&& value) {
  ...
  inline ListCaseRulesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListCaseRulesRequest& WithNextToken(NextTokenT&& value) {
