...
class SearchRelatedItemsResponseItem {
 public:
  ...
  template <typename RelatedItemIdT = Aws::String>
  SearchRelatedItemsResponseItem& WithRelatedItemId(RelatedItemIdT&& value) {
  ...
  inline SearchRelatedItemsResponseItem& WithType(RelatedItemType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename AssociationTimeT = Aws::Utils::DateTime>
  SearchRelatedItemsResponseItem& WithAssociationTime(AssociationTimeT&& value) {
  ...
  template <typename ContentT = RelatedItemContent>
  SearchRelatedItemsResponseItem& WithContent(ContentT&& value) {
  ...
  template <typename PerformedByT = UserUnion>
  SearchRelatedItemsResponseItem& WithPerformedBy(PerformedByT&& value) {
