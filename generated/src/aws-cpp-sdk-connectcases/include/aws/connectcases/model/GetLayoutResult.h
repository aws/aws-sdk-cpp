...
class GetLayoutResult {
 public:
  ...
  void SetLayoutArn(LayoutArnT&& value) {
    ...
    m_layoutArn = std::forward<LayoutArnT>(value);
  }
  template <typename LayoutArnT = Aws::String>
  GetLayoutResult& WithLayoutArn(LayoutArnT&& value) {
    SetLayoutArn(std::forward<LayoutArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetLayoutResult& AddTags(Aws::String key, Aws::Crt::Optional<Aws::String> value) {
    m_tagsHasBeenSet = true;
  ...
  inline GetLayoutResult& WithDeleted(bool value) {
    SetDeleted(value);
    return *this;
  }
  ///@}
