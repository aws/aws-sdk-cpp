...
class SearchRelatedItemsRequest : public ConnectCasesRequest {
 public:
  AWS_CONNECTCASES_API SearchRelatedItemsRequest() = default;
  ...
  template <typename DomainIdT = Aws::String>
  SearchRelatedItemsRequest& WithDomainId(DomainIdT&& value) {
  ...
  template <typename CaseIdT = Aws::String>
  SearchRelatedItemsRequest& WithCaseId(CaseIdT&& value) {
  ...
  inline SearchRelatedItemsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  SearchRelatedItemsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<RelatedItemTypeFilter>>
  SearchRelatedItemsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = RelatedItemTypeFilter>
  SearchRelatedItemsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
