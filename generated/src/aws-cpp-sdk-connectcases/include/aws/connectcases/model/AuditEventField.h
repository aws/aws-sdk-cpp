...
class AuditEventField {
 public:
  ...
  void SetEventFieldId(EventFieldIdT&& value) {
    m_eventFieldIdHasBeenSet = true;
    m_eventFieldId = std::forward<EventFieldIdT>(value);
  }
  template <typename EventFieldIdT = Aws::String>
  AuditEventField& WithEventFieldId(EventFieldIdT&& value) {
    SetEventFieldId(std::forward<EventFieldIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename OldValueT = AuditEventFieldValueUnion>
  AuditEventField& WithOldValue(OldValueT&& value) {
  ...
  template <typename NewValueT = AuditEventFieldValueUnion>
  AuditEventField& WithNewValue(NewValueT&& value) {
