...
namespace Model
{
  ...
  public:
    ...
    inline UpdateFieldResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateFieldResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateFieldResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
