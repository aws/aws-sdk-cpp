...
class ListCaseRulesResult {
 public:
  ...
  template <typename CaseRulesT = Aws::Vector<CaseRuleSummary>>
  ListCaseRulesResult& WithCaseRules(CaseRulesT&& value) {
    SetCaseRules(std::forward<CaseRulesT>(value));
    return *this;
  }
  template <typename CaseRulesT = CaseRuleSummary>
  ListCaseRulesResult& AddCaseRules(CaseRulesT&& value) {
    m_caseRulesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListCaseRulesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListCaseRulesResult& WithRequestId(RequestIdT&& value) {
