...
namespace Model
{
  ...
  /**
   * <p>Represents the content of a Custom related item</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/connectcases-2022-10-03/CustomContent">AWS
   * API Reference</a></p>
   */
  class CustomContent
  {
  public:
    ...
    template<typename FieldsT = Aws::Vector<FieldValue>>
    CustomContent& WithFields(FieldsT&& value) { SetFields(std::forward<FieldsT>(value)); return *this;}
    template<typename FieldsT = FieldValue>
    CustomContent& AddFields(FieldsT&& value) { m_fieldsHasBeenSet = true; m_fields.emplace_back(std::forward<FieldsT>(value)); return *this; }
    ///@}
  private:
