...
namespace Model
{
  ...
  /**
   * <p>We couldn't process your request because of an issue with the server. Try
   * again later.</p><p><h3>See Also:</h3>   <a
  ...
  {
  public:
    AWS_CONNECTCASES_API InternalServerException() = default;
