...
class BatchPutFieldOptionsResult {
 public:
  ...
  template <typename ErrorsT = Aws::Vector<FieldOptionError>>
  BatchPutFieldOptionsResult& WithErrors(ErrorsT&& value) {
    SetErrors(std::forward<ErrorsT>(value));
    return *this;
  }
  template <typename ErrorsT = FieldOptionError>
  BatchPutFieldOptionsResult& AddErrors(ErrorsT&& value) {
    m_errorsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  BatchPutFieldOptionsResult& WithRequestId(RequestIdT&& value) {
