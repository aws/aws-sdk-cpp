...
class GetTemplateResult {
 public:
  ...
  void SetLayoutConfiguration(LayoutConfigurationT&& value) {
    ...
    m_layoutConfiguration = std::forward<LayoutConfigurationT>(value);
  }
  template <typename LayoutConfigurationT = LayoutConfiguration>
  GetTemplateResult& WithLayoutConfiguration(LayoutConfigurationT&& value) {
    SetLayoutConfiguration(std::forward<LayoutConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetTemplateResult& WithStatus(TemplateStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline GetTemplateResult& WithDeleted(bool value) {
    SetDeleted(value);
    return *this;
  }
  ///@}
