...
class OperandTwo {
 public:
  ...
  inline OperandTwo& WithBooleanValue(bool value) {
  ...
  inline OperandTwo& WithDoubleValue(double value) {
  ...
  void SetEmptyValue(EmptyValueT&& value) {
    ...
    m_emptyValue = std::forward<EmptyValueT>(value);
  }
  template <typename EmptyValueT = EmptyOperandValue>
  OperandTwo& WithEmptyValue(EmptyValueT&& value) {
    SetEmptyValue(std::forward<EmptyValueT>(value));
    return *this;
  }
  ///@}
 private:
