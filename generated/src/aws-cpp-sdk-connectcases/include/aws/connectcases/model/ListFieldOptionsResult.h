...
class ListFieldOptionsResult {
 public:
  ...
  template <typename OptionsT = Aws::Vector<FieldOption>>
  ListFieldOptionsResult& WithOptions(OptionsT&& value) {
    SetOptions(std::forward<OptionsT>(value));
    return *this;
  }
  template <typename OptionsT = FieldOption>
  ListFieldOptionsResult& AddOptions(OptionsT&& value) {
    m_optionsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListFieldOptionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListFieldOptionsResult& WithRequestId(RequestIdT&& value) {
