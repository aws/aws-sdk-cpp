...
class AuditEventFieldValueUnion {
 public:
  AWS_CONNECTCASES_API AuditEventFieldValueUnion() = default;
  ...
  template <typename StringValueT = Aws::String>
  AuditEventFieldValueUnion& WithStringValue(StringValueT&& value) {
  ...
  inline AuditEventFieldValueUnion& WithDoubleValue(double value) {
  ...
  inline AuditEventFieldValueUnion& WithBooleanValue(bool value) {
  ...
  template <typename EmptyValueT = EmptyFieldValue>
  AuditEventFieldValueUnion& WithEmptyValue(EmptyValueT&& value) {
  ...
  void SetUserArnValue(UserArnValueT&& value) {
    m_userArnValueHasBeenSet = true;
    m_userArnValue = std::forward<UserArnValueT>(value);
  }
  template <typename UserArnValueT = Aws::String>
  AuditEventFieldValueUnion& WithUserArnValue(UserArnValueT&& value) {
    SetUserArnValue(std::forward<UserArnValueT>(value));
    return *this;
  }
  ///@}
 private:
