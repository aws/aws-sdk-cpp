...
class BooleanOperands {
 public:
  ...
  void SetOperandOne(OperandOneT&& value) {
    ...
    m_operandOne = std::forward<OperandOneT>(value);
  }
  template <typename OperandOneT = OperandOne>
  BooleanOperands& WithOperandOne(OperandOneT&& value) {
    SetOperandOne(std::forward<OperandOneT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOperandTwo(OperandTwoT&& value) {
    ...
    m_operandTwo = std::forward<OperandTwoT>(value);
  }
  template <typename OperandTwoT = OperandTwo>
  BooleanOperands& WithOperandTwo(OperandTwoT&& value) {
    SetOperandTwo(std::forward<OperandTwoT>(value));
    return *this;
  }
  ///@}
  ...
  inline BooleanOperands& WithResult(bool value) {
    SetResult(value);
    return *this;
  }
  ///@}
