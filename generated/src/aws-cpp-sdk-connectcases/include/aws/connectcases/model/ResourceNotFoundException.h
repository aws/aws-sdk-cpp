...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECTCASES_API ResourceNotFoundException() = default;
    AWS_CONNECTCASES_API ResourceNotFoundException(Aws::Utils::Json::JsonView jsonValue);
    AWS_CONNECTCASES_API ResourceNotFoundException& operator=(Aws::Utils::Json::JsonView jsonValue);
