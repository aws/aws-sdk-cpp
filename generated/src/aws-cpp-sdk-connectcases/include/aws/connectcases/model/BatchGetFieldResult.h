...
class BatchGetFieldResult {
 public:
  ...
  template <typename FieldsT = Aws::Vector<GetFieldResponse>>
  BatchGetFieldResult& WithFields(FieldsT&& value) {
    SetFields(std::forward<FieldsT>(value));
    return *this;
  }
  template <typename FieldsT = GetFieldResponse>
  BatchGetFieldResult& AddFields(FieldsT&& value) {
    m_fieldsHasBeenSet = true;
  ...
  template <typename ErrorsT = Aws::Vector<FieldError>>
  BatchGetFieldResult& WithErrors(ErrorsT&& value) {
    SetErrors(std::forward<ErrorsT>(value));
    return *this;
  }
  template <typename ErrorsT = FieldError>
  BatchGetFieldResult& AddErrors(ErrorsT&& value) {
    m_errorsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  BatchGetFieldResult& WithRequestId(RequestIdT&& value) {
