...
class DeleteRelatedItemRequest : public ConnectCasesRequest {
 public:
  ...
  template <typename DomainIdT = Aws::String>
  DeleteRelatedItemRequest& WithDomainId(DomainIdT&& value) {
  ...
  template <typename CaseIdT = Aws::String>
  DeleteRelatedItemRequest& WithCaseId(CaseIdT&& value) {
  ...
  template <typename RelatedItemIdT = Aws::String>
  DeleteRelatedItemRequest& WithRelatedItemId(RelatedItemIdT&& value) {
