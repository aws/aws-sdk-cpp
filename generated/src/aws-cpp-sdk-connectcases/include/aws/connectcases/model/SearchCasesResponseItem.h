...
class SearchCasesResponseItem {
 public:
  ...
  template <typename CaseIdT = Aws::String>
  SearchCasesResponseItem& WithCaseId(CaseIdT&& value) {
  ...
  template <typename TemplateIdT = Aws::String>
  SearchCasesResponseItem& WithTemplateId(TemplateIdT&& value) {
  ...
  template <typename FieldsT = Aws::Vector<FieldValue>>
  SearchCasesResponseItem& WithFields(FieldsT&& value) {
    SetFields(std::forward<FieldsT>(value));
    return *this;
  }
  template <typename FieldsT = FieldValue>
  SearchCasesResponseItem& AddFields(FieldsT&& value) {
    m_fieldsHasBeenSet = true;
  ...
  inline SearchCasesResponseItem& AddTags(Aws::String key, Aws::Crt::Optional<Aws::String> value) {
    m_tagsHasBeenSet = true;
