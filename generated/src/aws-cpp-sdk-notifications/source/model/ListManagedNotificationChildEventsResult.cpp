...
ListManagedNotificationChildEventsResult& ListManagedNotificationChildEventsResult::operator=(
  ...
  if (jsonValue.ValueExists("managedNotificationChildEvents")) {
    ...
    for (unsigned managedNotificationChildEventsIndex = 0;
         managedNotificationChildEventsIndex < managedNotificationChildEventsJsonList.GetLength(); ++managedNotificationChildEventsIndex) {
