...
Aws::String ListManagedNotificationChildEventsRequest::SerializePayload() const { return {}; }

void ListManagedNotificationChildEventsRequest::AddQueryStringParameters(URI& uri) const {
  Aws::StringStream ss;
