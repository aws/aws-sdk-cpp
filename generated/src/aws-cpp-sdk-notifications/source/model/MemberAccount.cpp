...
MemberAccount::MemberAccount(JsonView jsonValue) { *this = jsonValue; }
...
MemberAccount& MemberAccount::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("status")) {
    m_status = MemberAccountNotificationConfigurationStatusMapper::GetMemberAccountNotificationConfigurationStatusForName(
...
JsonValue MemberAccount::Jsonize() const {
  ...
  if (m_statusHasBeenSet) {
    payload.WithString(
        "status", MemberAccountNotificationConfigurationStatusMapper::GetNameForMemberAccountNotificationConfigurationStatus(m_status));
  }
