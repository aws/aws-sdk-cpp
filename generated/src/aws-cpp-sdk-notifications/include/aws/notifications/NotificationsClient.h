...
class AWS_NOTIFICATIONS_API NotificationsClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  NotificationsClient(const Aws::Notifications::NotificationsClientConfiguration& clientConfiguration =
  ...
  NotificationsClient(const Aws::Auth::AWSCredentials& credentials,
                      std::shared_ptr<NotificationsEndpointProviderBase> endpointProvider = nullptr,
                      const Aws::Notifications::NotificationsClientConfiguration& clientConfiguration =
                          Aws::Notifications::NotificationsClientConfiguration());
  ...
  /**
   * A Callable wrapper for AssociateChannel that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssociateChannel that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename AssociateChannelRequestT = Model::AssociateChannelRequest>
  void AssociateChannelAsync(const AssociateChannelRequestT& request, const AssociateChannelResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::AssociateManagedNotificationAccountContactOutcome AssociateManagedNotificationAccountContact(
      const Model::AssociateManagedNotificationAccountContactRequest& request) const;

  /**
   * A Callable wrapper for AssociateManagedNotificationAccountContact that returns a future to the operation so that it can be executed in
  ...
  Model::AssociateManagedNotificationAccountContactOutcomeCallable AssociateManagedNotificationAccountContactCallable(
      const AssociateManagedNotificationAccountContactRequestT& request) const {
    return SubmitCallable(&NotificationsClient::AssociateManagedNotificationAccountContact, request);
  }

  /**
   * An Async wrapper for AssociateManagedNotificationAccountContact that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename AssociateManagedNotificationAccountContactRequestT = Model::AssociateManagedNotificationAccountContactRequest>
  void AssociateManagedNotificationAccountContactAsync(
      const AssociateManagedNotificationAccountContactRequestT& request,
      const AssociateManagedNotificationAccountContactResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::AssociateManagedNotificationAdditionalChannelOutcome AssociateManagedNotificationAdditionalChannel(
      const Model::AssociateManagedNotificationAdditionalChannelRequest& request) const;

  /**
   * A Callable wrapper for AssociateManagedNotificationAdditionalChannel that returns a future to the operation so that it can be executed
  ...
  Model::AssociateManagedNotificationAdditionalChannelOutcomeCallable AssociateManagedNotificationAdditionalChannelCallable(
      const AssociateManagedNotificationAdditionalChannelRequestT& request) const {
    return SubmitCallable(&NotificationsClient::AssociateManagedNotificationAdditionalChannel, request);
  }

  /**
   * An Async wrapper for AssociateManagedNotificationAdditionalChannel that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename AssociateManagedNotificationAdditionalChannelRequestT = Model::AssociateManagedNotificationAdditionalChannelRequest>
  void AssociateManagedNotificationAdditionalChannelAsync(
      const AssociateManagedNotificationAdditionalChannelRequestT& request,
      const AssociateManagedNotificationAdditionalChannelResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::AssociateOrganizationalUnitOutcome AssociateOrganizationalUnit(
      const Model::AssociateOrganizationalUnitRequest& request) const;

  /**
   * A Callable wrapper for AssociateOrganizationalUnit that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AssociateOrganizationalUnitRequestT = Model::AssociateOrganizationalUnitRequest>
  Model::AssociateOrganizationalUnitOutcomeCallable AssociateOrganizationalUnitCallable(
      const AssociateOrganizationalUnitRequestT& request) const {
    return SubmitCallable(&NotificationsClient::AssociateOrganizationalUnit, request);
  }

  /**
   * An Async wrapper for AssociateOrganizationalUnit that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateOrganizationalUnitRequestT = Model::AssociateOrganizationalUnitRequest>
  void AssociateOrganizationalUnitAsync(const AssociateOrganizationalUnitRequestT& request,
                                        const AssociateOrganizationalUnitResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateEventRule that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateEventRuleRequestT = Model::CreateEventRuleRequest>
  void CreateEventRuleAsync(const CreateEventRuleRequestT& request, const CreateEventRuleResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteEventRule that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteEventRuleRequestT = Model::DeleteEventRuleRequest>
  void DeleteEventRuleAsync(const DeleteEventRuleRequestT& request, const DeleteEventRuleResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeregisterNotificationHub that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DeregisterNotificationHubRequestT = Model::DeregisterNotificationHubRequest>
  Model::DeregisterNotificationHubOutcomeCallable DeregisterNotificationHubCallable(
      const DeregisterNotificationHubRequestT& request) const {
    return SubmitCallable(&NotificationsClient::DeregisterNotificationHub, request);
  }

  /**
   * An Async wrapper for DeregisterNotificationHub that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeregisterNotificationHubRequestT = Model::DeregisterNotificationHubRequest>
  void DeregisterNotificationHubAsync(const DeregisterNotificationHubRequestT& request,
                                      const DeregisterNotificationHubResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisableNotificationsAccessForOrganizationOutcome DisableNotificationsAccessForOrganization(
      const Model::DisableNotificationsAccessForOrganizationRequest& request = {}) const;

  /**
   * A Callable wrapper for DisableNotificationsAccessForOrganization that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  ...
  Model::DisableNotificationsAccessForOrganizationOutcomeCallable DisableNotificationsAccessForOrganizationCallable(
      const DisableNotificationsAccessForOrganizationRequestT& request = {}) const {
    return SubmitCallable(&NotificationsClient::DisableNotificationsAccessForOrganization, request);
  }

  /**
   * An Async wrapper for DisableNotificationsAccessForOrganization that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DisableNotificationsAccessForOrganizationRequestT = Model::DisableNotificationsAccessForOrganizationRequest>
  void DisableNotificationsAccessForOrganizationAsync(const DisableNotificationsAccessForOrganizationResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for DisassociateChannel that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DisassociateChannel that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DisassociateChannelRequestT = Model::DisassociateChannelRequest>
  void DisassociateChannelAsync(const DisassociateChannelRequestT& request, const DisassociateChannelResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::DisassociateManagedNotificationAccountContactOutcome DisassociateManagedNotificationAccountContact(
      const Model::DisassociateManagedNotificationAccountContactRequest& request) const;

  /**
   * A Callable wrapper for DisassociateManagedNotificationAccountContact that returns a future to the operation so that it can be executed
   * in parallel to other requests.
   */
  ...
  Model::DisassociateManagedNotificationAccountContactOutcomeCallable DisassociateManagedNotificationAccountContactCallable(
      const DisassociateManagedNotificationAccountContactRequestT& request) const {
    return SubmitCallable(&NotificationsClient::DisassociateManagedNotificationAccountContact, request);
  }

  /**
   * An Async wrapper for DisassociateManagedNotificationAccountContact that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename DisassociateManagedNotificationAccountContactRequestT = Model::DisassociateManagedNotificationAccountContactRequest>
  void DisassociateManagedNotificationAccountContactAsync(
      const DisassociateManagedNotificationAccountContactRequestT& request,
      const DisassociateManagedNotificationAccountContactResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateManagedNotificationAdditionalChannelOutcome DisassociateManagedNotificationAdditionalChannel(
      const Model::DisassociateManagedNotificationAdditionalChannelRequest& request) const;

  /**
   * A Callable wrapper for DisassociateManagedNotificationAdditionalChannel that returns a future to the operation so that it can be
  ...
  Model::DisassociateManagedNotificationAdditionalChannelOutcomeCallable DisassociateManagedNotificationAdditionalChannelCallable(
      const DisassociateManagedNotificationAdditionalChannelRequestT& request) const {
    return SubmitCallable(&NotificationsClient::DisassociateManagedNotificationAdditionalChannel, request);
  }

  /**
   * An Async wrapper for DisassociateManagedNotificationAdditionalChannel that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <
      typename DisassociateManagedNotificationAdditionalChannelRequestT = Model::DisassociateManagedNotificationAdditionalChannelRequest>
  void DisassociateManagedNotificationAdditionalChannelAsync(
      const DisassociateManagedNotificationAdditionalChannelRequestT& request,
      const DisassociateManagedNotificationAdditionalChannelResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateOrganizationalUnitOutcome DisassociateOrganizationalUnit(
      const Model::DisassociateOrganizationalUnitRequest& request) const;

  /**
   * A Callable wrapper for DisassociateOrganizationalUnit that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DisassociateOrganizationalUnitRequestT = Model::DisassociateOrganizationalUnitRequest>
  Model::DisassociateOrganizationalUnitOutcomeCallable DisassociateOrganizationalUnitCallable(
      const DisassociateOrganizationalUnitRequestT& request) const {
    return SubmitCallable(&NotificationsClient::DisassociateOrganizationalUnit, request);
  }

  /**
   * An Async wrapper for DisassociateOrganizationalUnit that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DisassociateOrganizationalUnitRequestT = Model::DisassociateOrganizationalUnitRequest>
  void DisassociateOrganizationalUnitAsync(const DisassociateOrganizationalUnitRequestT& request,
                                           const DisassociateOrganizationalUnitResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::EnableNotificationsAccessForOrganizationOutcome EnableNotificationsAccessForOrganization(
      const Model::EnableNotificationsAccessForOrganizationRequest& request = {}) const;

  /**
   * A Callable wrapper for EnableNotificationsAccessForOrganization that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename EnableNotificationsAccessForOrganizationRequestT = Model::EnableNotificationsAccessForOrganizationRequest>
  Model::EnableNotificationsAccessForOrganizationOutcomeCallable EnableNotificationsAccessForOrganizationCallable(
      const EnableNotificationsAccessForOrganizationRequestT& request = {}) const {
    return SubmitCallable(&NotificationsClient::EnableNotificationsAccessForOrganization, request);
  }

  /**
   * An Async wrapper for EnableNotificationsAccessForOrganization that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename EnableNotificationsAccessForOrganizationRequestT = Model::EnableNotificationsAccessForOrganizationRequest>
  void EnableNotificationsAccessForOrganizationAsync(const EnableNotificationsAccessForOrganizationResponseReceivedHandler& handler,
                                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                     const EnableNotificationsAccessForOrganizationRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetEventRule that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetEventRuleRequestT = Model::GetEventRuleRequest>
  void GetEventRuleAsync(const GetEventRuleRequestT& request, const GetEventRuleResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetManagedNotificationChildEventOutcome GetManagedNotificationChildEvent(
      const Model::GetManagedNotificationChildEventRequest& request) const;

  /**
   * A Callable wrapper for GetManagedNotificationChildEvent that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename GetManagedNotificationChildEventRequestT = Model::GetManagedNotificationChildEventRequest>
  Model::GetManagedNotificationChildEventOutcomeCallable GetManagedNotificationChildEventCallable(
      const GetManagedNotificationChildEventRequestT& request) const {
    return SubmitCallable(&NotificationsClient::GetManagedNotificationChildEvent, request);
  }

  /**
   * An Async wrapper for GetManagedNotificationChildEvent that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetManagedNotificationChildEventRequestT = Model::GetManagedNotificationChildEventRequest>
  void GetManagedNotificationChildEventAsync(const GetManagedNotificationChildEventRequestT& request,
                                             const GetManagedNotificationChildEventResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetManagedNotificationConfigurationOutcome GetManagedNotificationConfiguration(
      const Model::GetManagedNotificationConfigurationRequest& request) const;

  /**
   * A Callable wrapper for GetManagedNotificationConfiguration that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename GetManagedNotificationConfigurationRequestT = Model::GetManagedNotificationConfigurationRequest>
  Model::GetManagedNotificationConfigurationOutcomeCallable GetManagedNotificationConfigurationCallable(
      const GetManagedNotificationConfigurationRequestT& request) const {
    return SubmitCallable(&NotificationsClient::GetManagedNotificationConfiguration, request);
  }

  /**
   * An Async wrapper for GetManagedNotificationConfiguration that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetManagedNotificationConfigurationRequestT = Model::GetManagedNotificationConfigurationRequest>
  void GetManagedNotificationConfigurationAsync(const GetManagedNotificationConfigurationRequestT& request,
                                                const GetManagedNotificationConfigurationResponseReceivedHandler& handler,
                                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetManagedNotificationEventOutcome GetManagedNotificationEvent(
      const Model::GetManagedNotificationEventRequest& request) const;

  /**
   * A Callable wrapper for GetManagedNotificationEvent that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetManagedNotificationEventRequestT = Model::GetManagedNotificationEventRequest>
  Model::GetManagedNotificationEventOutcomeCallable GetManagedNotificationEventCallable(
      const GetManagedNotificationEventRequestT& request) const {
    return SubmitCallable(&NotificationsClient::GetManagedNotificationEvent, request);
  }

  /**
   * An Async wrapper for GetManagedNotificationEvent that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetManagedNotificationEventRequestT = Model::GetManagedNotificationEventRequest>
  void GetManagedNotificationEventAsync(const GetManagedNotificationEventRequestT& request,
                                        const GetManagedNotificationEventResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetNotificationEvent that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetNotificationEvent that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetNotificationEventRequestT = Model::GetNotificationEventRequest>
  void GetNotificationEventAsync(const GetNotificationEventRequestT& request, const GetNotificationEventResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetNotificationsAccessForOrganizationOutcome GetNotificationsAccessForOrganization(
      const Model::GetNotificationsAccessForOrganizationRequest& request = {}) const;

  /**
   * A Callable wrapper for GetNotificationsAccessForOrganization that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename GetNotificationsAccessForOrganizationRequestT = Model::GetNotificationsAccessForOrganizationRequest>
  Model::GetNotificationsAccessForOrganizationOutcomeCallable GetNotificationsAccessForOrganizationCallable(
      const GetNotificationsAccessForOrganizationRequestT& request = {}) const {
    return SubmitCallable(&NotificationsClient::GetNotificationsAccessForOrganization, request);
  }

  /**
   * An Async wrapper for GetNotificationsAccessForOrganization that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetNotificationsAccessForOrganizationRequestT = Model::GetNotificationsAccessForOrganizationRequest>
  void GetNotificationsAccessForOrganizationAsync(const GetNotificationsAccessForOrganizationResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                  const GetNotificationsAccessForOrganizationRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListEventRules that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListEventRulesRequestT = Model::ListEventRulesRequest>
  void ListEventRulesAsync(const ListEventRulesRequestT& request, const ListEventRulesResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListManagedNotificationChannelAssociationsOutcome ListManagedNotificationChannelAssociations(
      const Model::ListManagedNotificationChannelAssociationsRequest& request) const;

  /**
   * A Callable wrapper for ListManagedNotificationChannelAssociations that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  ...
  Model::ListManagedNotificationChannelAssociationsOutcomeCallable ListManagedNotificationChannelAssociationsCallable(
      const ListManagedNotificationChannelAssociationsRequestT& request) const {
    return SubmitCallable(&NotificationsClient::ListManagedNotificationChannelAssociations, request);
  }

  /**
   * An Async wrapper for ListManagedNotificationChannelAssociations that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListManagedNotificationChannelAssociationsRequestT = Model::ListManagedNotificationChannelAssociationsRequest>
  void ListManagedNotificationChannelAssociationsAsync(
      const ListManagedNotificationChannelAssociationsRequestT& request,
      const ListManagedNotificationChannelAssociationsResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::ListManagedNotificationChildEventsOutcome ListManagedNotificationChildEvents(
      const Model::ListManagedNotificationChildEventsRequest& request) const;

  /**
   * A Callable wrapper for ListManagedNotificationChildEvents that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListManagedNotificationChildEventsRequestT = Model::ListManagedNotificationChildEventsRequest>
  Model::ListManagedNotificationChildEventsOutcomeCallable ListManagedNotificationChildEventsCallable(
      const ListManagedNotificationChildEventsRequestT& request) const {
    return SubmitCallable(&NotificationsClient::ListManagedNotificationChildEvents, request);
  }

  /**
   * An Async wrapper for ListManagedNotificationChildEvents that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListManagedNotificationChildEventsRequestT = Model::ListManagedNotificationChildEventsRequest>
  void ListManagedNotificationChildEventsAsync(const ListManagedNotificationChildEventsRequestT& request,
                                               const ListManagedNotificationChildEventsResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListManagedNotificationConfigurationsOutcome ListManagedNotificationConfigurations(
      const Model::ListManagedNotificationConfigurationsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListManagedNotificationConfigurations that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListManagedNotificationConfigurationsRequestT = Model::ListManagedNotificationConfigurationsRequest>
  Model::ListManagedNotificationConfigurationsOutcomeCallable ListManagedNotificationConfigurationsCallable(
      const ListManagedNotificationConfigurationsRequestT& request = {}) const {
    return SubmitCallable(&NotificationsClient::ListManagedNotificationConfigurations, request);
  }

  /**
   * An Async wrapper for ListManagedNotificationConfigurations that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListManagedNotificationConfigurationsRequestT = Model::ListManagedNotificationConfigurationsRequest>
  void ListManagedNotificationConfigurationsAsync(const ListManagedNotificationConfigurationsResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                  const ListManagedNotificationConfigurationsRequestT& request = {}) const {
  ...
  virtual Model::ListManagedNotificationEventsOutcome ListManagedNotificationEvents(
      const Model::ListManagedNotificationEventsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListManagedNotificationEvents that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListManagedNotificationEventsRequestT = Model::ListManagedNotificationEventsRequest>
  Model::ListManagedNotificationEventsOutcomeCallable ListManagedNotificationEventsCallable(
      const ListManagedNotificationEventsRequestT& request = {}) const {
    return SubmitCallable(&NotificationsClient::ListManagedNotificationEvents, request);
  }

  /**
   * An Async wrapper for ListManagedNotificationEvents that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListManagedNotificationEventsRequestT = Model::ListManagedNotificationEventsRequest>
  void ListManagedNotificationEventsAsync(const ListManagedNotificationEventsResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                          const ListManagedNotificationEventsRequestT& request = {}) const {
   ...
   */
  template <typename ListMemberAccountsRequestT = Model::ListMemberAccountsRequest>
  void ListMemberAccountsAsync(const ListMemberAccountsRequestT& request, const ListMemberAccountsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListNotificationEvents that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListNotificationEvents that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListNotificationEventsRequestT = Model::ListNotificationEventsRequest>
  void ListNotificationEventsAsync(const ListNotificationEventsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const ListNotificationEventsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListNotificationHubs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListNotificationHubs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListNotificationHubsRequestT = Model::ListNotificationHubsRequest>
  void ListNotificationHubsAsync(const ListNotificationHubsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const ListNotificationHubsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListOrganizationalUnits that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListOrganizationalUnits that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListOrganizationalUnitsRequestT = Model::ListOrganizationalUnitsRequest>
  void ListOrganizationalUnitsAsync(const ListOrganizationalUnitsRequestT& request,
                                    const ListOrganizationalUnitsResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RegisterNotificationHub that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RegisterNotificationHub that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RegisterNotificationHubRequestT = Model::RegisterNotificationHubRequest>
  void RegisterNotificationHubAsync(const RegisterNotificationHubRequestT& request,
                                    const RegisterNotificationHubResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateEventRule that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateEventRuleRequestT = Model::UpdateEventRuleRequest>
  ...
  virtual std::shared_ptr<NotificationsEndpointProviderBase>& accessEndpointProvider();
