...
class ListManagedNotificationChannelAssociationsResult {
 public:
  ...
  AWS_NOTIFICATIONS_API ListManagedNotificationChannelAssociationsResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename NextTokenT = Aws::String>
  ListManagedNotificationChannelAssociationsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetChannelAssociations(ChannelAssociationsT&& value) {
    m_channelAssociationsHasBeenSet = true;
    m_channelAssociations = std::forward<ChannelAssociationsT>(value);
  }
  template <typename ChannelAssociationsT = Aws::Vector<ManagedNotificationChannelAssociationSummary>>
  ListManagedNotificationChannelAssociationsResult& WithChannelAssociations(ChannelAssociationsT&& value) {
    SetChannelAssociations(std::forward<ChannelAssociationsT>(value));
    return *this;
  }
  template <typename ChannelAssociationsT = ManagedNotificationChannelAssociationSummary>
  ListManagedNotificationChannelAssociationsResult& AddChannelAssociations(ChannelAssociationsT&& value) {
    m_channelAssociationsHasBeenSet = true;
    m_channelAssociations.emplace_back(std::forward<ChannelAssociationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListManagedNotificationChannelAssociationsResult& WithRequestId(RequestIdT&& value) {
