...
class AssociateOrganizationalUnitRequest : public NotificationsRequest {
 public:
  ...
  template <typename OrganizationalUnitIdT = Aws::String>
  AssociateOrganizationalUnitRequest& WithOrganizationalUnitId(OrganizationalUnitIdT&& value) {
  ...
  template <typename NotificationConfigurationArnT = Aws::String>
  AssociateOrganizationalUnitRequest& WithNotificationConfigurationArn(NotificationConfigurationArnT&& value) {
