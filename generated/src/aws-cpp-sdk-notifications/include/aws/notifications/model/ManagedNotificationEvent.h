...
class ManagedNotificationEvent {
 public:
  ...
  inline ManagedNotificationEvent& WithSchemaVersion(SchemaVersion value) {
  ...
  inline ManagedNotificationEvent& WithNotificationType(NotificationType value) {
  ...
  inline ManagedNotificationEvent& WithEventStatus(EventStatus value) {
  ...
  inline ManagedNotificationEvent& WithAggregationEventType(AggregationEventType value) {
