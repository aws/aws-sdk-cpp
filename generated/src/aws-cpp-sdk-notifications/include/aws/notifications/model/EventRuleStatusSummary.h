...
class EventRuleStatusSummary {
 public:
  ...
  inline void SetStatus(EventRuleStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline EventRuleStatusSummary& WithStatus(EventRuleStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ReasonT = Aws::String>
  EventRuleStatusSummary& WithReason(ReasonT&& value) {
