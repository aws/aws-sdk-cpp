...
class GetManagedNotificationChildEventRequest : public NotificationsRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "GetManagedNotificationChildEvent"; }
  ...
  inline GetManagedNotificationChildEventRequest& WithLocale(LocaleCode value) {
    SetLocale(value);
    return *this;
  }
  ///@}
