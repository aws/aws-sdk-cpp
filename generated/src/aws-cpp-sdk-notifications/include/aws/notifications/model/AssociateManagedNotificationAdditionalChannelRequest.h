...
namespace Model
{
  ...
  {
  public:
    AWS_NOTIFICATIONS_API AssociateManagedNotificationAdditionalChannelRequest() = default;
    ...
    template<typename ChannelArnT = Aws::String>
    AssociateManagedNotificationAdditionalChannelRequest& WithChannelArn(ChannelArnT&& value) { SetChannelArn(std::forward<ChannelArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ManagedNotificationConfigurationArnT = Aws::String>
    AssociateManagedNotificationAdditionalChannelRequest& WithManagedNotificationConfigurationArn(ManagedNotificationConfigurationArnT&& value) { SetManagedNotificationConfigurationArn(std::forward<ManagedNotificationConfigurationArnT>(value)); return *this;}
    ///@}
  private:
