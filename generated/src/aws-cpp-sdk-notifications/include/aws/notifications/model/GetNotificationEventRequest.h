...
namespace Model
{
  ...
  {
  public:
    AWS_NOTIFICATIONS_API GetNotificationEventRequest();
    ...
    inline GetNotificationEventRequest& WithArn(const Aws::String& value) { SetArn(value); return *this;}
    inline GetNotificationEventRequest& WithArn(Aws::String&& value) { SetArn(std::move(value)); return *this;}
    inline GetNotificationEventRequest& WithArn(const char* value) { SetArn(value); return *this;}
    ///@}
    ...
    inline GetNotificationEventRequest& WithLocale(const LocaleCode& value) { SetLocale(value); return *this;}
    inline GetNotificationEventRequest& WithLocale(LocaleCode&& value) { SetLocale(std::move(value)); return *this;}
    ///@}
  private:
