...
class NotificationEvent {
 public:
  ...
  inline NotificationEvent& WithSchemaVersion(SchemaVersion value) {
  ...
  void SetSourceEventDetailUrl(SourceEventDetailUrlT&& value) {
    ...
    m_sourceEventDetailUrl = std::forward<SourceEventDetailUrlT>(value);
  }
  template <typename SourceEventDetailUrlT = Aws::String>
  NotificationEvent& WithSourceEventDetailUrl(SourceEventDetailUrlT&& value) {
    SetSourceEventDetailUrl(std::forward<SourceEventDetailUrlT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSourceEventDetailUrlDisplayText(SourceEventDetailUrlDisplayTextT&& value) {
    ...
    m_sourceEventDetailUrlDisplayText = std::forward<SourceEventDetailUrlDisplayTextT>(value);
  }
  template <typename SourceEventDetailUrlDisplayTextT = Aws::String>
  NotificationEvent& WithSourceEventDetailUrlDisplayText(SourceEventDetailUrlDisplayTextT&& value) {
    SetSourceEventDetailUrlDisplayText(std::forward<SourceEventDetailUrlDisplayTextT>(value));
    return *this;
  }
  ///@}
  ...
  inline NotificationEvent& WithNotificationType(NotificationType value) {
  ...
  inline NotificationEvent& WithEventStatus(EventStatus value) {
  ...
  inline void SetAggregationEventType(AggregationEventType value) {
    m_aggregationEventTypeHasBeenSet = true;
    m_aggregationEventType = value;
  }
  inline NotificationEvent& WithAggregationEventType(AggregationEventType value) {
    SetAggregationEventType(value);
    return *this;
  }
  ///@}
  ...
  void SetAggregationSummary(AggregationSummaryT&& value) {
    ...
    m_aggregationSummary = std::forward<AggregationSummaryT>(value);
  }
  template <typename AggregationSummaryT = AggregationSummary>
  NotificationEvent& WithAggregationSummary(AggregationSummaryT&& value) {
    SetAggregationSummary(std::forward<AggregationSummaryT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTextParts(TextPartsT&& value) {
    ...
    m_textParts = std::forward<TextPartsT>(value);
  }
  template <typename TextPartsT = Aws::Map<Aws::String, TextPartValue>>
  NotificationEvent& WithTextParts(TextPartsT&& value) {
    SetTextParts(std::forward<TextPartsT>(value));
    return *this;
  }
  ...
  NotificationEvent& AddTextParts(TextPartsKeyT&& key, TextPartsValueT&& value) {
    m_textPartsHasBeenSet = true;
    m_textParts.emplace(std::forward<TextPartsKeyT>(key), std::forward<TextPartsValueT>(value));
    return *this;
  }
  ///@}
