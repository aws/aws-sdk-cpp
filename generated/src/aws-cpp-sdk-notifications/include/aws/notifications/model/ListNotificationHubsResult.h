...
class ListNotificationHubsResult {
 public:
  ...
  void SetNotificationHubs(NotificationHubsT&& value) {
    m_notificationHubsHasBeenSet = true;
    m_notificationHubs = std::forward<NotificationHubsT>(value);
  }
  template <typename NotificationHubsT = Aws::Vector<NotificationHubOverview>>
  ListNotificationHubsResult& WithNotificationHubs(NotificationHubsT&& value) {
    SetNotificationHubs(std::forward<NotificationHubsT>(value));
    return *this;
  }
  template <typename NotificationHubsT = NotificationHubOverview>
  ListNotificationHubsResult& AddNotificationHubs(NotificationHubsT&& value) {
    m_notificationHubsHasBeenSet = true;
    m_notificationHubs.emplace_back(std::forward<NotificationHubsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListNotificationHubsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListNotificationHubsResult& WithRequestId(RequestIdT&& value) {
