...
class ListManagedNotificationChildEventsRequest : public NotificationsRequest {
 public:
  ...
  template <typename AggregateManagedNotificationEventArnT = Aws::String>
  ListManagedNotificationChildEventsRequest& WithAggregateManagedNotificationEventArn(AggregateManagedNotificationEventArnT&& value) {
  ...
  template <typename StartTimeT = Aws::Utils::DateTime>
  ListManagedNotificationChildEventsRequest& WithStartTime(StartTimeT&& value) {
  ...
  template <typename EndTimeT = Aws::Utils::DateTime>
  ListManagedNotificationChildEventsRequest& WithEndTime(EndTimeT&& value) {
  ...
  inline ListManagedNotificationChildEventsRequest& WithLocale(LocaleCode value) {
    SetLocale(value);
    return *this;
  }
  ///@}
  ...
  inline ListManagedNotificationChildEventsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename RelatedAccountT = Aws::String>
  ListManagedNotificationChildEventsRequest& WithRelatedAccount(RelatedAccountT&& value) {
  ...
  template <typename OrganizationalUnitIdT = Aws::String>
  ListManagedNotificationChildEventsRequest& WithOrganizationalUnitId(OrganizationalUnitIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListManagedNotificationChildEventsRequest& WithNextToken(NextTokenT&& value) {
