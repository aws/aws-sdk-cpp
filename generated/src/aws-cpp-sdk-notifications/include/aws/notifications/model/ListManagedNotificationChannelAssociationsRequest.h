...
class ListManagedNotificationChannelAssociationsRequest : public NotificationsRequest {
 public:
  ...
  template <typename ManagedNotificationConfigurationArnT = Aws::String>
  ListManagedNotificationChannelAssociationsRequest& WithManagedNotificationConfigurationArn(ManagedNotificationConfigurationArnT&& value) {
  ...
  inline ListManagedNotificationChannelAssociationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListManagedNotificationChannelAssociationsRequest& WithNextToken(NextTokenT&& value) {
