...
class GetManagedNotificationConfigurationResult {
 public:
  ...
  AWS_NOTIFICATIONS_API GetManagedNotificationConfigurationResult& operator=(
  ...
  void SetSubCategory(SubCategoryT&& value) {
    ...
    m_subCategory = std::forward<SubCategoryT>(value);
  }
  template <typename SubCategoryT = Aws::String>
  GetManagedNotificationConfigurationResult& WithSubCategory(SubCategoryT&& value) {
    SetSubCategory(std::forward<SubCategoryT>(value));
    return *this;
  }
  ///@}
