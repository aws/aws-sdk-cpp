...
class CreateNotificationConfigurationResult {
 public:
  AWS_NOTIFICATIONS_API CreateNotificationConfigurationResult() = default;
  ...
  AWS_NOTIFICATIONS_API CreateNotificationConfigurationResult& operator=(
  ...
  template <typename ArnT = Aws::String>
  CreateNotificationConfigurationResult& WithArn(ArnT&& value) {
  ...
  inline CreateNotificationConfigurationResult& WithStatus(NotificationConfigurationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
