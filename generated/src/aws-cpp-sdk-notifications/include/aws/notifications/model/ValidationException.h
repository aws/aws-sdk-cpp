...
namespace Model
{
  ...
  /**
   * <p>This exception is thrown when the notification event fails
   * validation.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/notifications-2018-05-10/ValidationException">AWS
   * API Reference</a></p>
   */
  class ValidationException
  {
  public:
    AWS_NOTIFICATIONS_API ValidationException();
