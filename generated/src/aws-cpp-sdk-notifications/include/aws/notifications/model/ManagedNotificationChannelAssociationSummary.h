...
class ManagedNotificationChannelAssociationSummary {
 public:
  ...
  inline ManagedNotificationChannelAssociationSummary& WithChannelType(ChannelType value) {
  ...
  inline void SetOverrideOption(ChannelAssociationOverrideOption value) {
    m_overrideOptionHasBeenSet = true;
    m_overrideOption = value;
  }
  inline ManagedNotificationChannelAssociationSummary& WithOverrideOption(ChannelAssociationOverrideOption value) {
