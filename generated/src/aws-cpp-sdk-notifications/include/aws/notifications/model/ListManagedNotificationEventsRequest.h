...
class ListManagedNotificationEventsRequest : public NotificationsRequest {
 public:
  ...
  template <typename StartTimeT = Aws::Utils::DateTime>
  ListManagedNotificationEventsRequest& WithStartTime(StartTimeT&& value) {
  ...
  template <typename EndTimeT = Aws::Utils::DateTime>
  ListManagedNotificationEventsRequest& WithEndTime(EndTimeT&& value) {
  ...
  inline ListManagedNotificationEventsRequest& WithLocale(LocaleCode value) {
    SetLocale(value);
    return *this;
  }
  ///@}
  ...
  template <typename SourceT = Aws::String>
  ListManagedNotificationEventsRequest& WithSource(SourceT&& value) {
  ...
  inline ListManagedNotificationEventsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListManagedNotificationEventsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename OrganizationalUnitIdT = Aws::String>
  ListManagedNotificationEventsRequest& WithOrganizationalUnitId(OrganizationalUnitIdT&& value) {
  ...
  void SetRelatedAccount(RelatedAccountT&& value) {
    ...
    m_relatedAccount = std::forward<RelatedAccountT>(value);
  }
  template <typename RelatedAccountT = Aws::String>
  ListManagedNotificationEventsRequest& WithRelatedAccount(RelatedAccountT&& value) {
    SetRelatedAccount(std::forward<RelatedAccountT>(value));
    return *this;
  }
  ///@}
 private:
