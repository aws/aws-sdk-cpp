...
class ManagedNotificationChildEventSummary {
 public:
  ...
  inline ManagedNotificationChildEventSummary& WithSchemaVersion(SchemaVersion value) {
  ...
  void SetAggregationDetail(AggregationDetailT&& value) {
    ...
    m_aggregationDetail = std::forward<AggregationDetailT>(value);
  }
  template <typename AggregationDetailT = AggregationDetail>
  ManagedNotificationChildEventSummary& WithAggregationDetail(AggregationDetailT&& value) {
    SetAggregationDetail(std::forward<AggregationDetailT>(value));
    return *this;
  }
  ///@}
  ...
  inline ManagedNotificationChildEventSummary& WithEventStatus(EventStatus value) {
  ...
  inline ManagedNotificationChildEventSummary& WithNotificationType(NotificationType value) {
