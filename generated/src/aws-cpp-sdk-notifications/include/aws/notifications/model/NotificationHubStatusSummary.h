...
class NotificationHubStatusSummary {
 public:
  ...
  inline void SetStatus(NotificationHubStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline NotificationHubStatusSummary& WithStatus(NotificationHubStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ReasonT = Aws::String>
  NotificationHubStatusSummary& WithReason(ReasonT&& value) {
