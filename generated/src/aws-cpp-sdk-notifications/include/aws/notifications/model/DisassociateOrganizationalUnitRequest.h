...
namespace Model
{
  ...
  public:
    ...
    template<typename OrganizationalUnitIdT = Aws::String>
    DisassociateOrganizationalUnitRequest& WithOrganizationalUnitId(OrganizationalUnitIdT&& value) { SetOrganizationalUnitId(std::forward<OrganizationalUnitIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NotificationConfigurationArnT = Aws::String>
    DisassociateOrganizationalUnitRequest& WithNotificationConfigurationArn(NotificationConfigurationArnT&& value) { SetNotificationConfigurationArn(std::forward<NotificationConfigurationArnT>(value)); return *this;}
    ///@}
  private:
