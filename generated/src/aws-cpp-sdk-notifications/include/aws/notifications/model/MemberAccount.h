...
class MemberAccount {
 public:
  ...
  inline void SetStatus(MemberAccountNotificationConfigurationStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline MemberAccount& WithStatus(MemberAccountNotificationConfigurationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
