...
class ListNotificationEventsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListNotificationEventsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetNotificationEvents(NotificationEventsT&& value) {
    ...
    m_notificationEvents = std::forward<NotificationEventsT>(value);
  }
  template <typename NotificationEventsT = Aws::Vector<NotificationEventOverview>>
  ListNotificationEventsResult& WithNotificationEvents(NotificationEventsT&& value) {
    SetNotificationEvents(std::forward<NotificationEventsT>(value));
    return *this;
  }
  template <typename NotificationEventsT = NotificationEventOverview>
  ListNotificationEventsResult& AddNotificationEvents(NotificationEventsT&& value) {
    m_notificationEventsHasBeenSet = true;
    m_notificationEvents.emplace_back(std::forward<NotificationEventsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListNotificationEventsResult& WithRequestId(RequestIdT&& value) {
