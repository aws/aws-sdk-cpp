...
namespace Model
{
  ...
  {
  public:
    AWS_NOTIFICATIONS_API ListTagsForResourceResult() = default;
    AWS_NOTIFICATIONS_API ListTagsForResourceResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_NOTIFICATIONS_API ListTagsForResourceResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
