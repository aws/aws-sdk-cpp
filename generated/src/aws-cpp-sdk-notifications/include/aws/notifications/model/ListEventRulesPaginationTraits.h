...
struct ListEventRulesPaginationTraits {
  using RequestType = Model::ListEventRulesRequest;
  using ResultType = Model::ListEventRulesResult;
  using OutcomeType = Model::ListEventRulesOutcome;
  using ClientType = Client;

  static OutcomeType Invoke(Client* client, const RequestType& request) { return client->ListEventRules(request); }
