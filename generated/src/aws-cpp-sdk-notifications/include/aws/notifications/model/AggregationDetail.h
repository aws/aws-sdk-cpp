...
class AggregationDetail {
 public:
  ...
  void SetSummarizationDimensions(SummarizationDimensionsT&& value) {
    m_summarizationDimensionsHasBeenSet = true;
    m_summarizationDimensions = std::forward<SummarizationDimensionsT>(value);
  }
  template <typename SummarizationDimensionsT = Aws::Vector<SummarizationDimensionDetail>>
  AggregationDetail& WithSummarizationDimensions(SummarizationDimensionsT&& value) {
    SetSummarizationDimensions(std::forward<SummarizationDimensionsT>(value));
    return *this;
  }
  template <typename SummarizationDimensionsT = SummarizationDimensionDetail>
  AggregationDetail& AddSummarizationDimensions(SummarizationDimensionsT&& value) {
    m_summarizationDimensionsHasBeenSet = true;
    m_summarizationDimensions.emplace_back(std::forward<SummarizationDimensionsT>(value));
    return *this;
  }
  ///@}
 private:
