...
class MessageComponents {
 public:
  ...
  void SetHeadline(HeadlineT&& value) {
    ...
    m_headline = std::forward<HeadlineT>(value);
  }
  template <typename HeadlineT = Aws::String>
  MessageComponents& WithHeadline(HeadlineT&& value) {
    SetHeadline(std::forward<HeadlineT>(value));
    return *this;
  }
  ///@}
  ...
  void SetParagraphSummary(ParagraphSummaryT&& value) {
    ...
    m_paragraphSummary = std::forward<ParagraphSummaryT>(value);
  }
  template <typename ParagraphSummaryT = Aws::String>
  MessageComponents& WithParagraphSummary(ParagraphSummaryT&& value) {
    SetParagraphSummary(std::forward<ParagraphSummaryT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCompleteDescription(CompleteDescriptionT&& value) {
    ...
    m_completeDescription = std::forward<CompleteDescriptionT>(value);
  }
  template <typename CompleteDescriptionT = Aws::String>
  MessageComponents& WithCompleteDescription(CompleteDescriptionT&& value) {
    SetCompleteDescription(std::forward<CompleteDescriptionT>(value));
    return *this;
  }
  ///@}
