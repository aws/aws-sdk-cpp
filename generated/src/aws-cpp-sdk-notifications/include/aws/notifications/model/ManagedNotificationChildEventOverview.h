...
class ManagedNotificationChildEventOverview {
 public:
  ...
  void SetChildEvent(ChildEventT&& value) {
    ...
    m_childEvent = std::forward<ChildEventT>(value);
  }
  template <typename ChildEventT = ManagedNotificationChildEventSummary>
  ManagedNotificationChildEventOverview& WithChildEvent(ChildEventT&& value) {
    SetChildEvent(std::forward<ChildEventT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAggregateManagedNotificationEventArn(AggregateManagedNotificationEventArnT&& value) {
    ...
    m_aggregateManagedNotificationEventArn = std::forward<AggregateManagedNotificationEventArnT>(value);
  }
  template <typename AggregateManagedNotificationEventArnT = Aws::String>
  ManagedNotificationChildEventOverview& WithAggregateManagedNotificationEventArn(AggregateManagedNotificationEventArnT&& value) {
    SetAggregateManagedNotificationEventArn(std::forward<AggregateManagedNotificationEventArnT>(value));
    return *this;
  }
  ///@}
