...
class ListManagedNotificationEventsResult {
 public:
  ...
  AWS_NOTIFICATIONS_API ListManagedNotificationEventsResult& operator=(
  ...
  template <typename NextTokenT = Aws::String>
  ListManagedNotificationEventsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetManagedNotificationEvents(ManagedNotificationEventsT&& value) {
    m_managedNotificationEventsHasBeenSet = true;
    m_managedNotificationEvents = std::forward<ManagedNotificationEventsT>(value);
  }
  template <typename ManagedNotificationEventsT = Aws::Vector<ManagedNotificationEventOverview>>
  ListManagedNotificationEventsResult& WithManagedNotificationEvents(ManagedNotificationEventsT&& value) {
    SetManagedNotificationEvents(std::forward<ManagedNotificationEventsT>(value));
    return *this;
  }
  template <typename ManagedNotificationEventsT = ManagedNotificationEventOverview>
  ListManagedNotificationEventsResult& AddManagedNotificationEvents(ManagedNotificationEventsT&& value) {
    m_managedNotificationEventsHasBeenSet = true;
    m_managedNotificationEvents.emplace_back(std::forward<ManagedNotificationEventsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListManagedNotificationEventsResult& WithRequestId(RequestIdT&& value) {
