...
namespace Model
{
  ...
  public:
    ...
    template<typename ArnT = Aws::String>
    GetManagedNotificationEventRequest& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    inline GetManagedNotificationEventRequest& WithLocale(LocaleCode value) { SetLocale(value); return *this;}
    ///@}
  private:
