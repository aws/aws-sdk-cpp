...
class DisassociateManagedNotificationAccountContactRequest : public NotificationsRequest {
 public:
  ...
  inline void SetContactIdentifier(AccountContactType value) {
    m_contactIdentifierHasBeenSet = true;
    m_contactIdentifier = value;
  }
  inline DisassociateManagedNotificationAccountContactRequest& WithContactIdentifier(AccountContactType value) {
  ...
  template <typename ManagedNotificationConfigurationArnT = Aws::String>
  DisassociateManagedNotificationAccountContactRequest& WithManagedNotificationConfigurationArn(
