...
class NotificationEventSummary {
 public:
  ...
  inline NotificationEventSummary& WithSchemaVersion(SchemaVersion value) {
  ...
  inline NotificationEventSummary& WithEventStatus(EventStatus value) {
  ...
  inline NotificationEventSummary& WithNotificationType(NotificationType value) {
