...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/notifications-2018-05-10/ConflictException">AWS
   * API Reference</a></p>
   */
  class ConflictException
  {
  public:
    AWS_NOTIFICATIONS_API ConflictException() = default;
    AWS_NOTIFICATIONS_API ConflictException(Aws::Utils::Json::JsonView jsonValue);
    AWS_NOTIFICATIONS_API ConflictException& operator=(Aws::Utils::Json::JsonView jsonValue);
