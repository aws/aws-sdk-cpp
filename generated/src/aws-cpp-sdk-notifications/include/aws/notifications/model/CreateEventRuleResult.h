...
class CreateEventRuleResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  CreateEventRuleResult& WithArn(ArnT&& value) {
  ...
  template <typename NotificationConfigurationArnT = Aws::String>
  CreateEventRuleResult& WithNotificationConfigurationArn(NotificationConfigurationArnT&& value) {
  ...
  template <typename StatusSummaryByRegionT = Aws::Map<Aws::String, EventRuleStatusSummary>>
  CreateEventRuleResult& WithStatusSummaryByRegion(StatusSummaryByRegionT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateEventRuleResult& WithRequestId(RequestIdT&& value) {
