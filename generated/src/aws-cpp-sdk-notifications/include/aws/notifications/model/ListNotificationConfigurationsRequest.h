...
class ListNotificationConfigurationsRequest : public NotificationsRequest {
 public:
  ...
  void SetEventRuleSource(EventRuleSourceT&& value) {
    m_eventRuleSourceHasBeenSet = true;
    m_eventRuleSource = std::forward<EventRuleSourceT>(value);
  }
  template <typename EventRuleSourceT = Aws::String>
  ListNotificationConfigurationsRequest& WithEventRuleSource(EventRuleSourceT&& value) {
    SetEventRuleSource(std::forward<EventRuleSourceT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListNotificationConfigurationsRequest& WithStatus(NotificationConfigurationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline ListNotificationConfigurationsRequest& WithSubtype(NotificationConfigurationSubtype value) {
    SetSubtype(value);
    return *this;
  }
  ///@}
  ...
  inline ListNotificationConfigurationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
