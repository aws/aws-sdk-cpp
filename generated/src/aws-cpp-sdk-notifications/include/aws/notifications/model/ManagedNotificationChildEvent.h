...
class ManagedNotificationChildEvent {
 public:
  ...
  inline ManagedNotificationChildEvent& WithSchemaVersion(SchemaVersion value) {
  ...
  inline ManagedNotificationChildEvent& WithNotificationType(NotificationType value) {
  ...
  inline ManagedNotificationChildEvent& WithEventStatus(EventStatus value) {
