...
class ListNotificationConfigurationsResult {
 public:
  ...
  AWS_NOTIFICATIONS_API ListNotificationConfigurationsResult& operator=(
   ...
   */
  inline const Aws::Vector<NotificationConfigurationStructure>& GetNotificationConfigurations() const {
    return m_notificationConfigurations;
  }
