...
class MediaElement {
 public:
  ...
  void SetMediaId(MediaIdT&& value) {
    m_mediaIdHasBeenSet = true;
    m_mediaId = std::forward<MediaIdT>(value);
  }
  template <typename MediaIdT = Aws::String>
  MediaElement& WithMediaId(MediaIdT&& value) {
    SetMediaId(std::forward<MediaIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetType(MediaElementType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline MediaElement& WithType(MediaElementType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetCaption(CaptionT&& value) {
    m_captionHasBeenSet = true;
    m_caption = std::forward<CaptionT>(value);
  }
  template <typename CaptionT = Aws::String>
  MediaElement& WithCaption(CaptionT&& value) {
    SetCaption(std::forward<CaptionT>(value));
    return *this;
  }
  ///@}
 private:
