...
class ManagedNotificationEventSummary {
 public:
  ...
  inline void SetSchemaVersion(SchemaVersion value) {
    m_schemaVersionHasBeenSet = true;
    m_schemaVersion = value;
  }
  inline ManagedNotificationEventSummary& WithSchemaVersion(SchemaVersion value) {
  ...
  void SetSourceEventMetadata(SourceEventMetadataT&& value) {
    ...
    m_sourceEventMetadata = std::forward<SourceEventMetadataT>(value);
  }
  template <typename SourceEventMetadataT = ManagedSourceEventMetadataSummary>
  ManagedNotificationEventSummary& WithSourceEventMetadata(SourceEventMetadataT&& value) {
    SetSourceEventMetadata(std::forward<SourceEventMetadataT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMessageComponents(MessageComponentsT&& value) {
    ...
    m_messageComponents = std::forward<MessageComponentsT>(value);
  }
  template <typename MessageComponentsT = MessageComponentsSummary>
  ManagedNotificationEventSummary& WithMessageComponents(MessageComponentsT&& value) {
    SetMessageComponents(std::forward<MessageComponentsT>(value));
    return *this;
  }
  ///@}
  ...
  inline ManagedNotificationEventSummary& WithEventStatus(EventStatus value) {
  ...
  inline void SetNotificationType(NotificationType value) {
    m_notificationTypeHasBeenSet = true;
    m_notificationType = value;
  }
  inline ManagedNotificationEventSummary& WithNotificationType(NotificationType value) {
