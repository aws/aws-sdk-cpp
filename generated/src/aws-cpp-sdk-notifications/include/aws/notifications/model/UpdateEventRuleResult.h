...
class UpdateEventRuleResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  UpdateEventRuleResult& WithArn(ArnT&& value) {
  ...
  template <typename NotificationConfigurationArnT = Aws::String>
  UpdateEventRuleResult& WithNotificationConfigurationArn(NotificationConfigurationArnT&& value) {
  ...
  template <typename StatusSummaryByRegionT = Aws::Map<Aws::String, EventRuleStatusSummary>>
  UpdateEventRuleResult& WithStatusSummaryByRegion(StatusSummaryByRegionT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateEventRuleResult& WithRequestId(RequestIdT&& value) {
