...
class SummarizationDimensionOverview {
 public:
  ...
  inline SummarizationDimensionOverview& WithCount(int value) {
    SetCount(value);
    return *this;
  }
  ///@}
