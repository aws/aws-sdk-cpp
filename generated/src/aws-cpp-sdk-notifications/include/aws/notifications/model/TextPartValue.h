...
class TextPartValue {
 public:
  ...
  inline void SetType(TextPartType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline TextPartValue& WithType(TextPartType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetDisplayText(DisplayTextT&& value) {
    ...
    m_displayText = std::forward<DisplayTextT>(value);
  }
  template <typename DisplayTextT = Aws::String>
  TextPartValue& WithDisplayText(DisplayTextT&& value) {
    SetDisplayText(std::forward<DisplayTextT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTextByLocale(TextByLocaleT&& value) {
    ...
    m_textByLocale = std::forward<TextByLocaleT>(value);
  }
  template <typename TextByLocaleT = Aws::Map<LocaleCode, Aws::String>>
  TextPartValue& WithTextByLocale(TextByLocaleT&& value) {
    SetTextByLocale(std::forward<TextByLocaleT>(value));
    return *this;
  }
  inline TextPartValue& AddTextByLocale(LocaleCode key, Aws::String value) {
    m_textByLocaleHasBeenSet = true;
    m_textByLocale.emplace(key, value);
    return *this;
  }
  ///@}
