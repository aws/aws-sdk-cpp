...
class RegisterNotificationHubRequest : public NotificationsRequest {
 public:
  ...
  void SetNotificationHubRegion(NotificationHubRegionT&& value) {
    ...
    m_notificationHubRegion = std::forward<NotificationHubRegionT>(value);
  }
  template <typename NotificationHubRegionT = Aws::String>
  RegisterNotificationHubRequest& WithNotificationHubRegion(NotificationHubRegionT&& value) {
    SetNotificationHubRegion(std::forward<NotificationHubRegionT>(value));
    return *this;
  }
  ///@}
 private:
