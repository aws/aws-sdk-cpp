...
class ListManagedNotificationConfigurationsRequest : public NotificationsRequest {
 public:
  ...
  template <typename ChannelIdentifierT = Aws::String>
  ListManagedNotificationConfigurationsRequest& WithChannelIdentifier(ChannelIdentifierT&& value) {
  ...
  inline ListManagedNotificationConfigurationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListManagedNotificationConfigurationsRequest& WithNextToken(NextTokenT&& value) {
