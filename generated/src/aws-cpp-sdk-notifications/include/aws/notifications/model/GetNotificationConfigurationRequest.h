...
namespace Model
{
  ...
  {
  public:
    AWS_NOTIFICATIONS_API GetNotificationConfigurationRequest() = default;
    ...
    template<typename ArnT = Aws::String>
    GetNotificationConfigurationRequest& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
  private:
