...
class NotificationEventOverview {
 public:
  ...
  void SetNotificationEvent(NotificationEventT&& value) {
    ...
    m_notificationEvent = std::forward<NotificationEventT>(value);
  }
  template <typename NotificationEventT = NotificationEventSummary>
  NotificationEventOverview& WithNotificationEvent(NotificationEventT&& value) {
    SetNotificationEvent(std::forward<NotificationEventT>(value));
    return *this;
  }
  ///@}
  ...
  inline NotificationEventOverview& WithAggregationEventType(AggregationEventType value) {
