...
class ManagedNotificationEventOverview {
 public:
  ...
  inline ManagedNotificationEventOverview& WithAggregationEventType(AggregationEventType value) {
  ...
  void SetAggregatedNotificationRegions(AggregatedNotificationRegionsT&& value) {
    ...
    m_aggregatedNotificationRegions = std::forward<AggregatedNotificationRegionsT>(value);
  }
  template <typename AggregatedNotificationRegionsT = Aws::Vector<Aws::String>>
  ManagedNotificationEventOverview& WithAggregatedNotificationRegions(AggregatedNotificationRegionsT&& value) {
    SetAggregatedNotificationRegions(std::forward<AggregatedNotificationRegionsT>(value));
    return *this;
  }
  ...
  ManagedNotificationEventOverview& AddAggregatedNotificationRegions(AggregatedNotificationRegionsT&& value) {
    m_aggregatedNotificationRegionsHasBeenSet = true;
    m_aggregatedNotificationRegions.emplace_back(std::forward<AggregatedNotificationRegionsT>(value));
    return *this;
  }
  ///@}
 private:
