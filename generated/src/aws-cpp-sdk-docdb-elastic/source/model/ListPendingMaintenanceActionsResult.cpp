...
ListPendingMaintenanceActionsResult& ListPendingMaintenanceActionsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("resourcePendingMaintenanceActions")) {
    ...
    for (unsigned resourcePendingMaintenanceActionsIndex = 0;
         resourcePendingMaintenanceActionsIndex < resourcePendingMaintenanceActionsJsonList.GetLength();
         ++resourcePendingMaintenanceActionsIndex) {
      m_resourcePendingMaintenanceActions.push_back(
          resourcePendingMaintenanceActionsJsonList[resourcePendingMaintenanceActionsIndex].AsObject());
    }
