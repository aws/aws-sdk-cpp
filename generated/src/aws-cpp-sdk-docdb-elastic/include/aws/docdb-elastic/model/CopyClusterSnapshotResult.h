...
namespace Model
{
  ...
  {
  public:
    AWS_DOCDBELASTIC_API CopyClusterSnapshotResult() = default;
    ...
    template<typename SnapshotT = ClusterSnapshot>
    CopyClusterSnapshotResult& WithSnapshot(SnapshotT&& value) { SetSnapshot(std::forward<SnapshotT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CopyClusterSnapshotResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
