...
class CreateClusterRequest : public DocDBElasticRequest {
 public:
  ...
  template <typename AdminUserNameT = Aws::String>
  CreateClusterRequest& WithAdminUserName(AdminUserNameT&& value) {
  ...
  template <typename AdminUserPasswordT = Aws::String>
  CreateClusterRequest& WithAdminUserPassword(AdminUserPasswordT&& value) {
  ...
  inline void SetAuthType(Auth value) {
    m_authTypeHasBeenSet = true;
    m_authType = value;
  }
  inline CreateClusterRequest& WithAuthType(Auth value) {
    SetAuthType(value);
    return *this;
  }
  ///@}
  ...
  inline CreateClusterRequest& WithBackupRetentionPeriod(int value) {
  ...
  template <typename PreferredBackupWindowT = Aws::String>
  CreateClusterRequest& WithPreferredBackupWindow(PreferredBackupWindowT&& value) {
  ...
  inline void SetShardCapacity(int value) {
    m_shardCapacityHasBeenSet = true;
    m_shardCapacity = value;
  }
  inline CreateClusterRequest& WithShardCapacity(int value) {
    SetShardCapacity(value);
    return *this;
  }
  ///@}
  ...
  inline void SetShardCount(int value) {
    m_shardCountHasBeenSet = true;
    m_shardCount = value;
  }
  inline CreateClusterRequest& WithShardCount(int value) {
    SetShardCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetShardInstanceCount(int value) {
    m_shardInstanceCountHasBeenSet = true;
    m_shardInstanceCount = value;
  }
  inline CreateClusterRequest& WithShardInstanceCount(int value) {
    SetShardInstanceCount(value);
    return *this;
  }
  ///@}
  ...
  template <typename SubnetIdsT = Aws::Vector<Aws::String>>
  CreateClusterRequest& WithSubnetIds(SubnetIdsT&& value) {
    SetSubnetIds(std::forward<SubnetIdsT>(value));
    return *this;
  }
  template <typename SubnetIdsT = Aws::String>
  CreateClusterRequest& AddSubnetIds(SubnetIdsT&& value) {
    m_subnetIdsHasBeenSet = true;
