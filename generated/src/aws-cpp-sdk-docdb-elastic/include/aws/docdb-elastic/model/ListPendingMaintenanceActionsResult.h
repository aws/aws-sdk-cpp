...
class ListPendingMaintenanceActionsResult {
 public:
  ...
  AWS_DOCDBELASTIC_API ListPendingMaintenanceActionsResult& operator=(
  ...
  template <typename NextTokenT = Aws::String>
  ListPendingMaintenanceActionsResult& WithNextToken(NextTokenT&& value) {
   ...
   */
  inline const Aws::Vector<ResourcePendingMaintenanceAction>& GetResourcePendingMaintenanceActions() const {
  ...
  template <typename ResourcePendingMaintenanceActionsT = Aws::Vector<ResourcePendingMaintenanceAction>>
  ListPendingMaintenanceActionsResult& WithResourcePendingMaintenanceActions(ResourcePendingMaintenanceActionsT&& value) {
  ...
  ListPendingMaintenanceActionsResult& AddResourcePendingMaintenanceActions(ResourcePendingMaintenanceActionsT&& value) {
    m_resourcePendingMaintenanceActionsHasBeenSet = true;
    m_resourcePendingMaintenanceActions.emplace_back(std::forward<ResourcePendingMaintenanceActionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListPendingMaintenanceActionsResult& WithRequestId(RequestIdT&& value) {
