...
class ClusterSnapshot {
 public:
  ...
  void SetClusterCreationTime(ClusterCreationTimeT&& value) {
    ...
    m_clusterCreationTime = std::forward<ClusterCreationTimeT>(value);
  }
  template <typename ClusterCreationTimeT = Aws::String>
  ClusterSnapshot& WithClusterCreationTime(ClusterCreationTimeT&& value) {
    SetClusterCreationTime(std::forward<ClusterCreationTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSnapshotCreationTime(SnapshotCreationTimeT&& value) {
    ...
    m_snapshotCreationTime = std::forward<SnapshotCreationTimeT>(value);
  }
  template <typename SnapshotCreationTimeT = Aws::String>
  ClusterSnapshot& WithSnapshotCreationTime(SnapshotCreationTimeT&& value) {
    SetSnapshotCreationTime(std::forward<SnapshotCreationTimeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetSnapshotType(SnapshotType value) {
    m_snapshotTypeHasBeenSet = true;
    m_snapshotType = value;
  }
  inline ClusterSnapshot& WithSnapshotType(SnapshotType value) {
  ...
  inline ClusterSnapshot& WithStatus(Status value) {
    SetStatus(value);
    return *this;
  }
  ///@}
