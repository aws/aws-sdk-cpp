...
class GetPendingMaintenanceActionResult {
 public:
  ...
  template <typename ResourcePendingMaintenanceActionT = ResourcePendingMaintenanceAction>
  GetPendingMaintenanceActionResult& WithResourcePendingMaintenanceAction(ResourcePendingMaintenanceActionT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetPendingMaintenanceActionResult& WithRequestId(RequestIdT&& value) {
