...
class UpdateClusterRequest : public DocDBElasticRequest {
 public:
  ...
  inline UpdateClusterRequest& WithAuthType(Auth value) {
    SetAuthType(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateClusterRequest& WithBackupRetentionPeriod(int value) {
  ...
  inline UpdateClusterRequest& WithShardCapacity(int value) {
  ...
  inline UpdateClusterRequest& WithShardCount(int value) {
    SetShardCount(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateClusterRequest& WithShardInstanceCount(int value) {
