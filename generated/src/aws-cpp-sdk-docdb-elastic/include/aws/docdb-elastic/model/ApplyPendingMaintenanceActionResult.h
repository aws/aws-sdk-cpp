...
class ApplyPendingMaintenanceActionResult {
 public:
  ...
  AWS_DOCDBELASTIC_API ApplyPendingMaintenanceActionResult& operator=(
  ...
  void SetResourcePendingMaintenanceAction(ResourcePendingMaintenanceActionT&& value) {
    m_resourcePendingMaintenanceActionHasBeenSet = true;
    m_resourcePendingMaintenanceAction = std::forward<ResourcePendingMaintenanceActionT>(value);
  }
  template <typename ResourcePendingMaintenanceActionT = ResourcePendingMaintenanceAction>
  ApplyPendingMaintenanceActionResult& WithResourcePendingMaintenanceAction(ResourcePendingMaintenanceActionT&& value) {
    SetResourcePendingMaintenanceAction(std::forward<ResourcePendingMaintenanceActionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ApplyPendingMaintenanceActionResult& WithRequestId(RequestIdT&& value) {
