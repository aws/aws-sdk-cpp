...
class ResourcePendingMaintenanceAction {
 public:
   ...
   */
  inline const Aws::Vector<PendingMaintenanceActionDetails>& GetPendingMaintenanceActionDetails() const {
    return m_pendingMaintenanceActionDetails;
  }
  ...
  void SetPendingMaintenanceActionDetails(PendingMaintenanceActionDetailsT&& value) {
    m_pendingMaintenanceActionDetailsHasBeenSet = true;
    m_pendingMaintenanceActionDetails = std::forward<PendingMaintenanceActionDetailsT>(value);
  }
  template <typename PendingMaintenanceActionDetailsT = Aws::Vector<PendingMaintenanceActionDetails>>
  ResourcePendingMaintenanceAction& WithPendingMaintenanceActionDetails(PendingMaintenanceActionDetailsT&& value) {
    SetPendingMaintenanceActionDetails(std::forward<PendingMaintenanceActionDetailsT>(value));
    return *this;
  }
  template <typename PendingMaintenanceActionDetailsT = PendingMaintenanceActionDetails>
  ResourcePendingMaintenanceAction& AddPendingMaintenanceActionDetails(PendingMaintenanceActionDetailsT&& value) {
    m_pendingMaintenanceActionDetailsHasBeenSet = true;
    m_pendingMaintenanceActionDetails.emplace_back(std::forward<PendingMaintenanceActionDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResourceArnT = Aws::String>
  ResourcePendingMaintenanceAction& WithResourceArn(ResourceArnT&& value) {
