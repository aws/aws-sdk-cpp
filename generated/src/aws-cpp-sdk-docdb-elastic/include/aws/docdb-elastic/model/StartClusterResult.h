...
namespace Model
{
  ...
  {
  public:
    AWS_DOCDBELASTIC_API StartClusterResult() = default;
    ...
    template<typename ClusterT = Cluster>
    StartClusterResult& WithCluster(ClusterT&& value) { SetCluster(std::forward<ClusterT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    StartClusterResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
