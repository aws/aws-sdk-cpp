...
namespace Model
{
  ...
  {
  public:
    AWS_DOCDBELASTIC_API ListTagsForResourceResult() = default;
    AWS_DOCDBELASTIC_API ListTagsForResourceResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_DOCDBELASTIC_API ListTagsForResourceResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
