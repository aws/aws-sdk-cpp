...
namespace Model
{
  ...
  {
  public:
    AWS_DOCDBELASTIC_API StopClusterRequest() = default;
    ...
    template<typename ClusterArnT = Aws::String>
    StopClusterRequest& WithClusterArn(ClusterArnT&& value) { SetClusterArn(std::forward<ClusterArnT>(value)); return *this;}
    ///@}
  private:
