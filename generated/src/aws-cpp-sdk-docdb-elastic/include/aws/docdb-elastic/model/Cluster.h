...
class Cluster {
 public:
  ...
  inline Cluster& WithAuthType(Auth value) {
    SetAuthType(value);
    return *this;
  }
  ///@}
  ...
  inline Cluster& WithBackupRetentionPeriod(int value) {
  ...
  inline Cluster& WithShardCapacity(int value) {
  ...
  inline Cluster& WithShardCount(int value) {
    SetShardCount(value);
    return *this;
  }
  ///@}
  ...
  inline Cluster& WithShardInstanceCount(int value) {
  ...
  inline Cluster& WithStatus(Status value) {
    SetStatus(value);
    return *this;
  }
  ///@}
