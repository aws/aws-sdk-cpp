...
namespace DocDBElastic
{
   ...
   */
  class AWS_DOCDBELASTIC_API DocDBElasticClient : Aws::Client::ClientWithAsyncTemplateMethods<DocDBElasticClient>,
    smithy::client::AwsSmithyClientT<Aws::DocDBElastic::SERVICE_NAME,
