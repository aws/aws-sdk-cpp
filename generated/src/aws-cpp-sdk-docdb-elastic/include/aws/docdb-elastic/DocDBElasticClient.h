...
class AWS_DOCDBELASTIC_API DocDBElasticClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  DocDBElasticClient(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<DocDBElasticEndpointProviderBase> endpointProvider = nullptr,
      const Aws::DocDBElastic::DocDBElasticClientConfiguration& clientConfiguration = Aws::DocDBElastic::DocDBElasticClientConfiguration());
  ...
  /**
   * A Callable wrapper for GetClusterSnapshot that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetClusterSnapshot that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetClusterSnapshotRequestT = Model::GetClusterSnapshotRequest>
  void GetClusterSnapshotAsync(const GetClusterSnapshotRequestT& request, const GetClusterSnapshotResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetPendingMaintenanceActionOutcome GetPendingMaintenanceAction(
      const Model::GetPendingMaintenanceActionRequest& request) const;

  /**
   * A Callable wrapper for GetPendingMaintenanceAction that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetPendingMaintenanceActionRequestT = Model::GetPendingMaintenanceActionRequest>
  Model::GetPendingMaintenanceActionOutcomeCallable GetPendingMaintenanceActionCallable(
      const GetPendingMaintenanceActionRequestT& request) const {
    return SubmitCallable(&DocDBElasticClient::GetPendingMaintenanceAction, request);
  }

  /**
   * An Async wrapper for GetPendingMaintenanceAction that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetPendingMaintenanceActionRequestT = Model::GetPendingMaintenanceActionRequest>
  void GetPendingMaintenanceActionAsync(const GetPendingMaintenanceActionRequestT& request,
                                        const GetPendingMaintenanceActionResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListClusterSnapshots that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListClusterSnapshots that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListClusterSnapshotsRequestT = Model::ListClusterSnapshotsRequest>
  void ListClusterSnapshotsAsync(const ListClusterSnapshotsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const ListClusterSnapshotsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListPendingMaintenanceActionsOutcome ListPendingMaintenanceActions(
      const Model::ListPendingMaintenanceActionsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListPendingMaintenanceActions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListPendingMaintenanceActionsRequestT = Model::ListPendingMaintenanceActionsRequest>
  Model::ListPendingMaintenanceActionsOutcomeCallable ListPendingMaintenanceActionsCallable(
      const ListPendingMaintenanceActionsRequestT& request = {}) const {
    return SubmitCallable(&DocDBElasticClient::ListPendingMaintenanceActions, request);
  }

  /**
   * An Async wrapper for ListPendingMaintenanceActions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListPendingMaintenanceActionsRequestT = Model::ListPendingMaintenanceActionsRequest>
  void ListPendingMaintenanceActionsAsync(const ListPendingMaintenanceActionsResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                          const ListPendingMaintenanceActionsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::RestoreClusterFromSnapshotOutcome RestoreClusterFromSnapshot(
      const Model::RestoreClusterFromSnapshotRequest& request) const;

  /**
   * A Callable wrapper for RestoreClusterFromSnapshot that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename RestoreClusterFromSnapshotRequestT = Model::RestoreClusterFromSnapshotRequest>
  Model::RestoreClusterFromSnapshotOutcomeCallable RestoreClusterFromSnapshotCallable(
      const RestoreClusterFromSnapshotRequestT& request) const {
    return SubmitCallable(&DocDBElasticClient::RestoreClusterFromSnapshot, request);
  }

  /**
   * An Async wrapper for RestoreClusterFromSnapshot that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RestoreClusterFromSnapshotRequestT = Model::RestoreClusterFromSnapshotRequest>
  void RestoreClusterFromSnapshotAsync(const RestoreClusterFromSnapshotRequestT& request,
                                       const RestoreClusterFromSnapshotResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StartCluster that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StartClusterRequestT = Model::StartClusterRequest>
  void StartClusterAsync(const StartClusterRequestT& request, const StartClusterResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StopCluster that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StopClusterRequestT = Model::StopClusterRequest>
  void StopClusterAsync(const StopClusterRequestT& request, const StopClusterResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
