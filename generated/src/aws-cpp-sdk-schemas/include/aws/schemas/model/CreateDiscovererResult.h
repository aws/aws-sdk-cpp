...
namespace Model
{
  ...
  {
  public:
    AWS_SCHEMAS_API CreateDiscovererResult() = default;
    ...
    template<typename DescriptionT = Aws::String>
    CreateDiscovererResult& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename DiscovererArnT = Aws::String>
    CreateDiscovererResult& WithDiscovererArn(DiscovererArnT&& value) { SetDiscovererArn(std::forward<DiscovererArnT>(value)); return *this;}
    ///@}
    ...
    template<typename DiscovererIdT = Aws::String>
    CreateDiscovererResult& WithDiscovererId(DiscovererIdT&& value) { SetDiscovererId(std::forward<DiscovererIdT>(value)); return *this;}
    ///@}
    ...
    template<typename SourceArnT = Aws::String>
    CreateDiscovererResult& WithSourceArn(SourceArnT&& value) { SetSourceArn(std::forward<SourceArnT>(value)); return *this;}
    ///@}
    ...
    inline CreateDiscovererResult& WithState(DiscovererState value) { SetState(value); return *this;}
    ///@}
    ...
    template<typename TagsT = Aws::Map<Aws::String, Aws::String>>
    CreateDiscovererResult& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
    template<typename TagsKeyT = Aws::String, typename TagsValueT = Aws::String>
    CreateDiscovererResult& AddTags(TagsKeyT&& key, TagsValueT&& value) {
    ...
    template<typename RequestIdT = Aws::String>
    CreateDiscovererResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
