...
class PutCodeBindingResult {
 public:
  ...
  template <typename CreationDateT = Aws::Utils::DateTime>
  PutCodeBindingResult& WithCreationDate(CreationDateT&& value) {
  ...
  template <typename LastModifiedT = Aws::Utils::DateTime>
  PutCodeBindingResult& WithLastModified(LastModifiedT&& value) {
  ...
  template <typename SchemaVersionT = Aws::String>
  PutCodeBindingResult& WithSchemaVersion(SchemaVersionT&& value) {
  ...
  inline PutCodeBindingResult& WithStatus(CodeGenerationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  PutCodeBindingResult& WithRequestId(RequestIdT&& value) {
