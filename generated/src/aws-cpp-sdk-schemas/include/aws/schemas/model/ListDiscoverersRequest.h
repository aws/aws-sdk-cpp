...
class ListDiscoverersRequest : public SchemasRequest {
 public:
  ...
  void SetDiscovererIdPrefix(DiscovererIdPrefixT&& value) {
    m_discovererIdPrefixHasBeenSet = true;
    m_discovererIdPrefix = std::forward<DiscovererIdPrefixT>(value);
  }
  template <typename DiscovererIdPrefixT = Aws::String>
  ListDiscoverersRequest& WithDiscovererIdPrefix(DiscovererIdPrefixT&& value) {
    SetDiscovererIdPrefix(std::forward<DiscovererIdPrefixT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListDiscoverersRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListDiscoverersRequest& WithNextToken(NextTokenT&& value) {
  ...
  void SetSourceArnPrefix(SourceArnPrefixT&& value) {
    m_sourceArnPrefixHasBeenSet = true;
    m_sourceArnPrefix = std::forward<SourceArnPrefixT>(value);
  }
  template <typename SourceArnPrefixT = Aws::String>
  ListDiscoverersRequest& WithSourceArnPrefix(SourceArnPrefixT&& value) {
    SetSourceArnPrefix(std::forward<SourceArnPrefixT>(value));
    return *this;
  }
  ///@}
 private:
