...
class ListRegistriesRequest : public SchemasRequest {
 public:
  ...
  inline ListRegistriesRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  void SetRegistryNamePrefix(RegistryNamePrefixT&& value) {
    m_registryNamePrefixHasBeenSet = true;
    m_registryNamePrefix = std::forward<RegistryNamePrefixT>(value);
  }
  template <typename RegistryNamePrefixT = Aws::String>
  ListRegistriesRequest& WithRegistryNamePrefix(RegistryNamePrefixT&& value) {
    SetRegistryNamePrefix(std::forward<RegistryNamePrefixT>(value));
    return *this;
  }
  ///@}
