...
namespace Model
{
  ...
  public:
    ...
    template<typename DescriptionT = Aws::String>
    UpdateSchemaResult& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename LastModifiedT = Aws::Utils::DateTime>
    UpdateSchemaResult& WithLastModified(LastModifiedT&& value) { SetLastModified(std::forward<LastModifiedT>(value)); return *this;}
    ///@}
    ...
    template<typename SchemaVersionT = Aws::String>
    UpdateSchemaResult& WithSchemaVersion(SchemaVersionT&& value) { SetSchemaVersion(std::forward<SchemaVersionT>(value)); return *this;}
    ///@}
    ...
    template<typename TagsT = Aws::Map<Aws::String, Aws::String>>
    UpdateSchemaResult& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
    ...
    template<typename TypeT = Aws::String>
    UpdateSchemaResult& WithType(TypeT&& value) { SetType(std::forward<TypeT>(value)); return *this;}
    ///@}
    ...
    template<typename VersionCreatedDateT = Aws::Utils::DateTime>
    UpdateSchemaResult& WithVersionCreatedDate(VersionCreatedDateT&& value) { SetVersionCreatedDate(std::forward<VersionCreatedDateT>(value)); return *this;}
    ///@}
