...
namespace Model
{
  ...
  {
  public:
    AWS_SCHEMAS_API DescribeDiscovererResult() = default;
    ...
    template<typename DescriptionT = Aws::String>
    DescribeDiscovererResult& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename DiscovererArnT = Aws::String>
    DescribeDiscovererResult& WithDiscovererArn(DiscovererArnT&& value) { SetDiscovererArn(std::forward<DiscovererArnT>(value)); return *this;}
    ///@}
    ...
    template<typename DiscovererIdT = Aws::String>
    DescribeDiscovererResult& WithDiscovererId(DiscovererIdT&& value) { SetDiscovererId(std::forward<DiscovererIdT>(value)); return *this;}
    ///@}
    ...
    template<typename SourceArnT = Aws::String>
    DescribeDiscovererResult& WithSourceArn(SourceArnT&& value) { SetSourceArn(std::forward<SourceArnT>(value)); return *this;}
    ///@}
    ...
    inline DescribeDiscovererResult& WithState(DiscovererState value) { SetState(value); return *this;}
    ///@}
    ...
    template<typename TagsT = Aws::Map<Aws::String, Aws::String>>
    DescribeDiscovererResult& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
    template<typename TagsKeyT = Aws::String, typename TagsValueT = Aws::String>
    DescribeDiscovererResult& AddTags(TagsKeyT&& key, TagsValueT&& value) {
    ...
    template<typename RequestIdT = Aws::String>
    DescribeDiscovererResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
