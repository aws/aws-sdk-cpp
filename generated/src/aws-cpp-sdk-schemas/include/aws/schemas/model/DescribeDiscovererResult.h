...
class DescribeDiscovererResult {
 public:
  ...
  template <typename DescriptionT = Aws::String>
  DescribeDiscovererResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename DiscovererArnT = Aws::String>
  DescribeDiscovererResult& WithDiscovererArn(DiscovererArnT&& value) {
  ...
  template <typename DiscovererIdT = Aws::String>
  DescribeDiscovererResult& WithDiscovererId(DiscovererIdT&& value) {
  ...
  template <typename SourceArnT = Aws::String>
  DescribeDiscovererResult& WithSourceArn(SourceArnT&& value) {
  ...
  inline DescribeDiscovererResult& WithState(DiscovererState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeDiscovererResult& WithCrossAccount(bool value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  DescribeDiscovererResult& WithTags(TagsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeDiscovererResult& WithRequestId(RequestIdT&& value) {
