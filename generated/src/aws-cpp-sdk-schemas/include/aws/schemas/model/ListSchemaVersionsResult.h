...
class ListSchemaVersionsResult {
 public:
  ...
  void SetSchemaVersions(SchemaVersionsT&& value) {
    ...
    m_schemaVersions = std::forward<SchemaVersionsT>(value);
  }
  template <typename SchemaVersionsT = Aws::Vector<SchemaVersionSummary>>
  ListSchemaVersionsResult& WithSchemaVersions(SchemaVersionsT&& value) {
    SetSchemaVersions(std::forward<SchemaVersionsT>(value));
    return *this;
  }
  template <typename SchemaVersionsT = SchemaVersionSummary>
  ListSchemaVersionsResult& AddSchemaVersions(SchemaVersionsT&& value) {
    m_schemaVersionsHasBeenSet = true;
    m_schemaVersions.emplace_back(std::forward<SchemaVersionsT>(value));
    return *this;
  }
  ///@}
