...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/schemas-2019-12-02/TagResourceRequest">AWS
   * API Reference</a></p>
   */
  class TagResourceRequest : public SchemasRequest
  {
  public:
    AWS_SCHEMAS_API TagResourceRequest() = default;
