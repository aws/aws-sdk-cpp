...
namespace Model
{
  ...
  {
  public:
    AWS_SCHEMAS_API GoneException() = default;
    ...
    template<typename CodeT = Aws::String>
    GoneException& WithCode(CodeT&& value) { SetCode(std::forward<CodeT>(value)); return *this;}
    ///@}
    ...
    template<typename MessageT = Aws::String>
    GoneException& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
  private:
