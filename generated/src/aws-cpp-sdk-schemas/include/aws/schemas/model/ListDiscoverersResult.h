...
class ListDiscoverersResult {
 public:
  ...
  void SetDiscoverers(DiscoverersT&& value) {
    m_discoverersHasBeenSet = true;
    m_discoverers = std::forward<DiscoverersT>(value);
  }
  template <typename DiscoverersT = Aws::Vector<DiscovererSummary>>
  ListDiscoverersResult& WithDiscoverers(DiscoverersT&& value) {
    SetDiscoverers(std::forward<DiscoverersT>(value));
    return *this;
  }
  template <typename DiscoverersT = DiscovererSummary>
  ListDiscoverersResult& AddDiscoverers(DiscoverersT&& value) {
    m_discoverersHasBeenSet = true;
    m_discoverers.emplace_back(std::forward<DiscoverersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListDiscoverersResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDiscoverersResult& WithRequestId(RequestIdT&& value) {
