...
class ListSchemasRequest : public SchemasRequest {
 public:
  ...
  inline ListSchemasRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  void SetSchemaNamePrefix(SchemaNamePrefixT&& value) {
    m_schemaNamePrefixHasBeenSet = true;
    m_schemaNamePrefix = std::forward<SchemaNamePrefixT>(value);
  }
  template <typename SchemaNamePrefixT = Aws::String>
  ListSchemasRequest& WithSchemaNamePrefix(SchemaNamePrefixT&& value) {
    SetSchemaNamePrefix(std::forward<SchemaNamePrefixT>(value));
    return *this;
  }
  ///@}
 private:
