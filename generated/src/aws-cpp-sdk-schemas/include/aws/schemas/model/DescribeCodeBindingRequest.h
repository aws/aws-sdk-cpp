...
class DescribeCodeBindingRequest : public SchemasRequest {
 public:
  ...
  template <typename LanguageT = Aws::String>
  DescribeCodeBindingRequest& WithLanguage(LanguageT&& value) {
  ...
  template <typename RegistryNameT = Aws::String>
  DescribeCodeBindingRequest& WithRegistryName(RegistryNameT&& value) {
  ...
  template <typename SchemaNameT = Aws::String>
  DescribeCodeBindingRequest& WithSchemaName(SchemaNameT&& value) {
  ...
  template <typename SchemaVersionT = Aws::String>
  DescribeCodeBindingRequest& WithSchemaVersion(SchemaVersionT&& value) {
