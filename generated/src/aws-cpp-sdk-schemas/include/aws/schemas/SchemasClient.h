...
class AWS_SCHEMAS_API SchemasClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  SchemasClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<SchemasEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * A Callable wrapper for CreateDiscoverer that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateDiscoverer that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateDiscovererRequestT = Model::CreateDiscovererRequest>
  void CreateDiscovererAsync(const CreateDiscovererRequestT& request, const CreateDiscovererResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for DeleteDiscoverer that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteDiscoverer that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteDiscovererRequestT = Model::DeleteDiscovererRequest>
  void DeleteDiscovererAsync(const DeleteDiscovererRequestT& request, const DeleteDiscovererResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteSchemaVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteSchemaVersion that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteSchemaVersionRequestT = Model::DeleteSchemaVersionRequest>
  void DeleteSchemaVersionAsync(const DeleteSchemaVersionRequestT& request, const DeleteSchemaVersionResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeCodeBinding that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeCodeBinding that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeCodeBindingRequestT = Model::DescribeCodeBindingRequest>
  void DescribeCodeBindingAsync(const DescribeCodeBindingRequestT& request, const DescribeCodeBindingResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeDiscoverer that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeDiscoverer that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeDiscovererRequestT = Model::DescribeDiscovererRequest>
  void DescribeDiscovererAsync(const DescribeDiscovererRequestT& request, const DescribeDiscovererResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename DescribeRegistryRequestT = Model::DescribeRegistryRequest>
  void DescribeRegistryAsync(const DescribeRegistryRequestT& request, const DescribeRegistryResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ExportSchema that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ExportSchemaRequestT = Model::ExportSchemaRequest>
  void ExportSchemaAsync(const ExportSchemaRequestT& request, const ExportSchemaResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetCodeBindingSource that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetCodeBindingSource that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetCodeBindingSourceRequestT = Model::GetCodeBindingSourceRequest>
  void GetCodeBindingSourceAsync(const GetCodeBindingSourceRequestT& request, const GetCodeBindingSourceResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetDiscoveredSchema that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetDiscoveredSchema that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetDiscoveredSchemaRequestT = Model::GetDiscoveredSchemaRequest>
  void GetDiscoveredSchemaAsync(const GetDiscoveredSchemaRequestT& request, const GetDiscoveredSchemaResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListDiscoverers that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListDiscoverersRequestT = Model::ListDiscoverersRequest>
  void ListDiscoverersAsync(const ListDiscoverersResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const ListDiscoverersRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for PutCodeBinding that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutCodeBindingRequestT = Model::PutCodeBindingRequest>
  void PutCodeBindingAsync(const PutCodeBindingRequestT& request, const PutCodeBindingResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for SearchSchemas that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename SearchSchemasRequestT = Model::SearchSchemasRequest>
  void SearchSchemasAsync(const SearchSchemasRequestT& request, const SearchSchemasResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StartDiscoverer that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StartDiscovererRequestT = Model::StartDiscovererRequest>
  void StartDiscovererAsync(const StartDiscovererRequestT& request, const StartDiscovererResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StopDiscoverer that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StopDiscovererRequestT = Model::StopDiscovererRequest>
  void StopDiscovererAsync(const StopDiscovererRequestT& request, const StopDiscovererResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateDiscoverer that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateDiscoverer that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateDiscovererRequestT = Model::UpdateDiscovererRequest>
  void UpdateDiscovererAsync(const UpdateDiscovererRequestT& request, const UpdateDiscovererResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
