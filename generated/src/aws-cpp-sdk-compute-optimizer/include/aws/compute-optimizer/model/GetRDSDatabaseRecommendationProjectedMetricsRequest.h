...
class GetRDSDatabaseRecommendationProjectedMetricsRequest : public ComputeOptimizerRequest {
 public:
  ...
  template <typename ResourceArnT = Aws::String>
  GetRDSDatabaseRecommendationProjectedMetricsRequest& WithResourceArn(ResourceArnT&& value) {
  ...
  inline GetRDSDatabaseRecommendationProjectedMetricsRequest& WithStat(MetricStatistic value) {
    SetStat(value);
    return *this;
  }
  ///@}
  ...
  inline GetRDSDatabaseRecommendationProjectedMetricsRequest& WithPeriod(int value) {
    SetPeriod(value);
    return *this;
  }
  ///@}
  ...
  template <typename StartTimeT = Aws::Utils::DateTime>
  GetRDSDatabaseRecommendationProjectedMetricsRequest& WithStartTime(StartTimeT&& value) {
  ...
  template <typename EndTimeT = Aws::Utils::DateTime>
  GetRDSDatabaseRecommendationProjectedMetricsRequest& WithEndTime(EndTimeT&& value) {
  ...
  template <typename RecommendationPreferencesT = RecommendationPreferences>
  GetRDSDatabaseRecommendationProjectedMetricsRequest& WithRecommendationPreferences(RecommendationPreferencesT&& value) {
