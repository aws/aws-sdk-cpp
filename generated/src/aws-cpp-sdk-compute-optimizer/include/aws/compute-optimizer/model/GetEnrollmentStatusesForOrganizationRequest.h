...
class GetEnrollmentStatusesForOrganizationRequest : public ComputeOptimizerRequest {
 public:
  ...
  template <typename FiltersT = Aws::Vector<EnrollmentFilter>>
  GetEnrollmentStatusesForOrganizationRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = EnrollmentFilter>
  GetEnrollmentStatusesForOrganizationRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetEnrollmentStatusesForOrganizationRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline GetEnrollmentStatusesForOrganizationRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
