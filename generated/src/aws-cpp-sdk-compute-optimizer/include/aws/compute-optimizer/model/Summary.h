...
class Summary {
 public:
  ...
  AWS_COMPUTEOPTIMIZER_API Summary(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZER_API Summary& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline void SetName(Finding value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline Summary& WithName(Finding value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  inline Summary& WithValue(double value) {
    SetValue(value);
    return *this;
  }
  ///@}
  ...
  void SetReasonCodeSummaries(ReasonCodeSummariesT&& value) {
    m_reasonCodeSummariesHasBeenSet = true;
    m_reasonCodeSummaries = std::forward<ReasonCodeSummariesT>(value);
  }
  template <typename ReasonCodeSummariesT = Aws::Vector<ReasonCodeSummary>>
  Summary& WithReasonCodeSummaries(ReasonCodeSummariesT&& value) {
    SetReasonCodeSummaries(std::forward<ReasonCodeSummariesT>(value));
    return *this;
  }
  template <typename ReasonCodeSummariesT = ReasonCodeSummary>
  Summary& AddReasonCodeSummaries(ReasonCodeSummariesT&& value) {
    m_reasonCodeSummariesHasBeenSet = true;
    m_reasonCodeSummaries.emplace_back(std::forward<ReasonCodeSummariesT>(value));
    return *this;
  }
  ///@}
 private:
