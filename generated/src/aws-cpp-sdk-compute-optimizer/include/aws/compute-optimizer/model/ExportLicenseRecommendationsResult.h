...
class ExportLicenseRecommendationsResult {
 public:
  AWS_COMPUTEOPTIMIZER_API ExportLicenseRecommendationsResult() = default;
  AWS_COMPUTEOPTIMIZER_API ExportLicenseRecommendationsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_COMPUTEOPTIMIZER_API ExportLicenseRecommendationsResult& operator=(
  ...
  template <typename JobIdT = Aws::String>
  ExportLicenseRecommendationsResult& WithJobId(JobIdT&& value) {
  ...
  template <typename S3DestinationT = S3Destination>
  ExportLicenseRecommendationsResult& WithS3Destination(S3DestinationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ExportLicenseRecommendationsResult& WithRequestId(RequestIdT&& value) {
