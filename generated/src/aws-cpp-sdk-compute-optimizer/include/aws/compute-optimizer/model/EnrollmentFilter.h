...
class EnrollmentFilter {
 public:
  ...
  AWS_COMPUTEOPTIMIZER_API EnrollmentFilter(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZER_API EnrollmentFilter& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline void SetName(EnrollmentFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline EnrollmentFilter& WithName(EnrollmentFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  EnrollmentFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  EnrollmentFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
