...
class RDSInstanceSavingsOpportunityAfterDiscounts {
 public:
  ...
  AWS_COMPUTEOPTIMIZER_API RDSInstanceSavingsOpportunityAfterDiscounts(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZER_API RDSInstanceSavingsOpportunityAfterDiscounts& operator=(
  ...
  inline RDSInstanceSavingsOpportunityAfterDiscounts& WithSavingsOpportunityPercentage(double value) {
  ...
  template <typename EstimatedMonthlySavingsT = RDSInstanceEstimatedMonthlySavings>
  RDSInstanceSavingsOpportunityAfterDiscounts& WithEstimatedMonthlySavings(EstimatedMonthlySavingsT&& value) {
