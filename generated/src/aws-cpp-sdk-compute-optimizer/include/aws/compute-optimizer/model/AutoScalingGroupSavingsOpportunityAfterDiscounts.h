...
class AutoScalingGroupSavingsOpportunityAfterDiscounts {
 public:
  ...
  AWS_COMPUTEOPTIMIZER_API AutoScalingGroupSavingsOpportunityAfterDiscounts(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZER_API AutoScalingGroupSavingsOpportunityAfterDiscounts& operator=(
  ...
  inline AutoScalingGroupSavingsOpportunityAfterDiscounts& WithSavingsOpportunityPercentage(double value) {
  ...
  template <typename EstimatedMonthlySavingsT = AutoScalingGroupEstimatedMonthlySavings>
  AutoScalingGroupSavingsOpportunityAfterDiscounts& WithEstimatedMonthlySavings(EstimatedMonthlySavingsT&& value) {
