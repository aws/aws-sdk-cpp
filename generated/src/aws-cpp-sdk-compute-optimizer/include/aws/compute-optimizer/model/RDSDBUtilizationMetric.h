...
class RDSDBUtilizationMetric {
 public:
  ...
  AWS_COMPUTEOPTIMIZER_API RDSDBUtilizationMetric(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZER_API RDSDBUtilizationMetric& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline RDSDBUtilizationMetric& WithName(RDSDBMetricName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatistic(RDSDBMetricStatistic value) {
    m_statisticHasBeenSet = true;
    m_statistic = value;
  }
  inline RDSDBUtilizationMetric& WithStatistic(RDSDBMetricStatistic value) {
    SetStatistic(value);
    return *this;
  }
  ///@}
  ...
  inline RDSDBUtilizationMetric& WithValue(double value) {
    SetValue(value);
    return *this;
  }
  ///@}
