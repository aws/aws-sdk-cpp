...
class PutRecommendationPreferencesRequest : public ComputeOptimizerRequest {
 public:
  ...
  inline PutRecommendationPreferencesRequest& WithResourceType(ResourceType value) {
  ...
  inline PutRecommendationPreferencesRequest& WithEnhancedInfrastructureMetrics(EnhancedInfrastructureMetrics value) {
  ...
  inline PutRecommendationPreferencesRequest& WithInferredWorkloadTypes(InferredWorkloadTypesPreference value) {
  ...
  inline PutRecommendationPreferencesRequest& WithLookBackPeriod(LookBackPeriodPreference value) {
  ...
  inline PutRecommendationPreferencesRequest& WithSavingsEstimationMode(SavingsEstimationMode value) {
