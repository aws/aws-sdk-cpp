...
class AccountEnrollmentStatus {
 public:
  ...
  AWS_COMPUTEOPTIMIZER_API AccountEnrollmentStatus(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZER_API AccountEnrollmentStatus& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline AccountEnrollmentStatus& WithStatus(Status value) {
    SetStatus(value);
    return *this;
  }
  ///@}
