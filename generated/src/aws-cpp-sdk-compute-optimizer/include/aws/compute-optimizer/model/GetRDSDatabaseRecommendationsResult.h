...
class GetRDSDatabaseRecommendationsResult {
 public:
  ...
  AWS_COMPUTEOPTIMIZER_API GetRDSDatabaseRecommendationsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_COMPUTEOPTIMIZER_API GetRDSDatabaseRecommendationsResult& operator=(
  ...
  template <typename NextTokenT = Aws::String>
  GetRDSDatabaseRecommendationsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetRdsDBRecommendations(RdsDBRecommendationsT&& value) {
    m_rdsDBRecommendationsHasBeenSet = true;
    m_rdsDBRecommendations = std::forward<RdsDBRecommendationsT>(value);
  }
  template <typename RdsDBRecommendationsT = Aws::Vector<RDSDBRecommendation>>
  GetRDSDatabaseRecommendationsResult& WithRdsDBRecommendations(RdsDBRecommendationsT&& value) {
    SetRdsDBRecommendations(std::forward<RdsDBRecommendationsT>(value));
    return *this;
  }
  template <typename RdsDBRecommendationsT = RDSDBRecommendation>
  GetRDSDatabaseRecommendationsResult& AddRdsDBRecommendations(RdsDBRecommendationsT&& value) {
    m_rdsDBRecommendationsHasBeenSet = true;
    m_rdsDBRecommendations.emplace_back(std::forward<RdsDBRecommendationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ErrorsT = Aws::Vector<GetRecommendationError>>
  GetRDSDatabaseRecommendationsResult& WithErrors(ErrorsT&& value) {
    SetErrors(std::forward<ErrorsT>(value));
    return *this;
  }
  template <typename ErrorsT = GetRecommendationError>
  GetRDSDatabaseRecommendationsResult& AddErrors(ErrorsT&& value) {
    m_errorsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetRDSDatabaseRecommendationsResult& WithRequestId(RequestIdT&& value) {
