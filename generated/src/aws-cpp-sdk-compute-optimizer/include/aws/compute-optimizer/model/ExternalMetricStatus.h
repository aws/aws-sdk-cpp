...
class ExternalMetricStatus {
 public:
  ...
  AWS_COMPUTEOPTIMIZER_API ExternalMetricStatus(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZER_API ExternalMetricStatus& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline void SetStatusCode(ExternalMetricStatusCode value) {
    m_statusCodeHasBeenSet = true;
    m_statusCode = value;
  }
  inline ExternalMetricStatus& WithStatusCode(ExternalMetricStatusCode value) {
    SetStatusCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonT = Aws::String>
  ExternalMetricStatus& WithStatusReason(StatusReasonT&& value) {
