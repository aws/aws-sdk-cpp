...
class InstanceSavingsEstimationMode {
 public:
  ...
  AWS_COMPUTEOPTIMIZER_API InstanceSavingsEstimationMode(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZER_API InstanceSavingsEstimationMode& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline void SetSource(InstanceSavingsEstimationModeSource value) {
    m_sourceHasBeenSet = true;
    m_source = value;
  }
  inline InstanceSavingsEstimationMode& WithSource(InstanceSavingsEstimationModeSource value) {
    SetSource(value);
    return *this;
  }
  ///@}
