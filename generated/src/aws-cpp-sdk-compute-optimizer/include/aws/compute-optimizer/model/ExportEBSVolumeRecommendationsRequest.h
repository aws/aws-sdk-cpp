...
class ExportEBSVolumeRecommendationsRequest : public ComputeOptimizerRequest {
 public:
  ...
  template <typename AccountIdsT = Aws::Vector<Aws::String>>
  ExportEBSVolumeRecommendationsRequest& WithAccountIds(AccountIdsT&& value) {
    SetAccountIds(std::forward<AccountIdsT>(value));
    return *this;
  }
  template <typename AccountIdsT = Aws::String>
  ExportEBSVolumeRecommendationsRequest& AddAccountIds(AccountIdsT&& value) {
    m_accountIdsHasBeenSet = true;
  ...
  template <typename FiltersT = Aws::Vector<EBSFilter>>
  ExportEBSVolumeRecommendationsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = EBSFilter>
  ExportEBSVolumeRecommendationsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename FieldsToExportT = Aws::Vector<ExportableVolumeField>>
  ExportEBSVolumeRecommendationsRequest& WithFieldsToExport(FieldsToExportT&& value) {
    SetFieldsToExport(std::forward<FieldsToExportT>(value));
    return *this;
  }
  inline ExportEBSVolumeRecommendationsRequest& AddFieldsToExport(ExportableVolumeField value) {
    m_fieldsToExportHasBeenSet = true;
  ...
  template <typename S3DestinationConfigT = S3DestinationConfig>
  ExportEBSVolumeRecommendationsRequest& WithS3DestinationConfig(S3DestinationConfigT&& value) {
  ...
  inline ExportEBSVolumeRecommendationsRequest& WithFileFormat(FileFormat value) {
    SetFileFormat(value);
    return *this;
  }
  ///@}
  ...
  inline ExportEBSVolumeRecommendationsRequest& WithIncludeMemberAccounts(bool value) {
