...
class LicenseConfiguration {
 public:
  ...
  AWS_COMPUTEOPTIMIZER_API LicenseConfiguration(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZER_API LicenseConfiguration& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
   ...
   */
  inline int64_t GetNumberOfCores() const { return m_numberOfCores; }
  inline bool NumberOfCoresHasBeenSet() const { return m_numberOfCoresHasBeenSet; }
  inline void SetNumberOfCores(int64_t value) {
    m_numberOfCoresHasBeenSet = true;
    m_numberOfCores = value;
  }
  inline LicenseConfiguration& WithNumberOfCores(int64_t value) {
  ...
  inline LicenseConfiguration& WithLicenseEdition(LicenseEdition value) {
  ...
  inline void SetLicenseName(LicenseName value) {
    m_licenseNameHasBeenSet = true;
    m_licenseName = value;
  }
  inline LicenseConfiguration& WithLicenseName(LicenseName value) {
  ...
  inline LicenseConfiguration& WithLicenseModel(LicenseModel value) {
  ...
  void SetLicenseVersion(LicenseVersionT&& value) {
    ...
    m_licenseVersion = std::forward<LicenseVersionT>(value);
  }
  template <typename LicenseVersionT = Aws::String>
  LicenseConfiguration& WithLicenseVersion(LicenseVersionT&& value) {
    SetLicenseVersion(std::forward<LicenseVersionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMetricsSource(MetricsSourceT&& value) {
    ...
    m_metricsSource = std::forward<MetricsSourceT>(value);
  }
  template <typename MetricsSourceT = Aws::Vector<MetricSource>>
  LicenseConfiguration& WithMetricsSource(MetricsSourceT&& value) {
    SetMetricsSource(std::forward<MetricsSourceT>(value));
    return *this;
  }
  template <typename MetricsSourceT = MetricSource>
  LicenseConfiguration& AddMetricsSource(MetricsSourceT&& value) {
    m_metricsSourceHasBeenSet = true;
    m_metricsSource.emplace_back(std::forward<MetricsSourceT>(value));
    return *this;
  }
  ///@}
 private:
  int64_t m_numberOfCores{0};
