...
namespace Model
{
  ...
  public:
    ...
    inline void SetEstimatedMonthlySavings(const IdleEstimatedMonthlySavings& value) { m_estimatedMonthlySavingsHasBeenSet = true; m_estimatedMonthlySavings = value; }
    inline void SetEstimatedMonthlySavings(IdleEstimatedMonthlySavings&& value) { m_estimatedMonthlySavingsHasBeenSet = true; m_estimatedMonthlySavings = std::move(value); }
    inline IdleSavingsOpportunity& WithEstimatedMonthlySavings(const IdleEstimatedMonthlySavings& value) { SetEstimatedMonthlySavings(value); return *this;}
    inline IdleSavingsOpportunity& WithEstimatedMonthlySavings(IdleEstimatedMonthlySavings&& value) { SetEstimatedMonthlySavings(std::move(value)); return *this;}
    ///@}
  private:
