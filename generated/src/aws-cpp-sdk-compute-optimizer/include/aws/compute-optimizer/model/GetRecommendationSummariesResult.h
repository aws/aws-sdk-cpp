...
class GetRecommendationSummariesResult {
 public:
  ...
  AWS_COMPUTEOPTIMIZER_API GetRecommendationSummariesResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_COMPUTEOPTIMIZER_API GetRecommendationSummariesResult& operator=(
  ...
  template <typename NextTokenT = Aws::String>
  GetRecommendationSummariesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RecommendationSummariesT = Aws::Vector<RecommendationSummary>>
  GetRecommendationSummariesResult& WithRecommendationSummaries(RecommendationSummariesT&& value) {
  ...
  GetRecommendationSummariesResult& AddRecommendationSummaries(RecommendationSummariesT&& value) {
    m_recommendationSummariesHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetRecommendationSummariesResult& WithRequestId(RequestIdT&& value) {
