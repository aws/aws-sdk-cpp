...
namespace Model
{
  ...
  {
  public:
    AWS_COMPUTEOPTIMIZER_API ExportAutoScalingGroupRecommendationsRequest() = default;
    ...
    template<typename AccountIdsT = Aws::Vector<Aws::String>>
    ExportAutoScalingGroupRecommendationsRequest& WithAccountIds(AccountIdsT&& value) { SetAccountIds(std::forward<AccountIdsT>(value)); return *this;}
    template<typename AccountIdsT = Aws::String>
    ExportAutoScalingGroupRecommendationsRequest& AddAccountIds(AccountIdsT&& value) { m_accountIdsHasBeenSet = true; m_accountIds.emplace_back(std::forward<AccountIdsT>(value)); return *this; }
    ///@}
    ...
    template<typename FiltersT = Aws::Vector<Filter>>
    ExportAutoScalingGroupRecommendationsRequest& WithFilters(FiltersT&& value) { SetFilters(std::forward<FiltersT>(value)); return *this;}
    template<typename FiltersT = Filter>
    ExportAutoScalingGroupRecommendationsRequest& AddFilters(FiltersT&& value) { m_filtersHasBeenSet = true; m_filters.emplace_back(std::forward<FiltersT>(value)); return *this; }
    ///@}
    ...
    template<typename FieldsToExportT = Aws::Vector<ExportableAutoScalingGroupField>>
    ...
    template<typename FieldsToExportT = Aws::Vector<ExportableAutoScalingGroupField>>
    ExportAutoScalingGroupRecommendationsRequest& WithFieldsToExport(FieldsToExportT&& value) { SetFieldsToExport(std::forward<FieldsToExportT>(value)); return *this;}
    inline ExportAutoScalingGroupRecommendationsRequest& AddFieldsToExport(ExportableAutoScalingGroupField value) { m_fieldsToExportHasBeenSet = true; m_fieldsToExport.push_back(value); return *this; }
    ///@}
    ...
    template<typename S3DestinationConfigT = S3DestinationConfig>
    ExportAutoScalingGroupRecommendationsRequest& WithS3DestinationConfig(S3DestinationConfigT&& value) { SetS3DestinationConfig(std::forward<S3DestinationConfigT>(value)); return *this;}
    ///@}
    ...
    inline ExportAutoScalingGroupRecommendationsRequest& WithFileFormat(FileFormat value) { SetFileFormat(value); return *this;}
    ///@}
    ...
    template<typename RecommendationPreferencesT = RecommendationPreferences>
    ExportAutoScalingGroupRecommendationsRequest& WithRecommendationPreferences(RecommendationPreferencesT&& value) { SetRecommendationPreferences(std::forward<RecommendationPreferencesT>(value)); return *this;}
    ///@}
  private:
