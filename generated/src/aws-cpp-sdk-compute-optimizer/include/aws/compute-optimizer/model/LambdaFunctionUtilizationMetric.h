...
class LambdaFunctionUtilizationMetric {
 public:
  ...
  inline void SetName(LambdaFunctionMetricName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline LambdaFunctionUtilizationMetric& WithName(LambdaFunctionMetricName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatistic(LambdaFunctionMetricStatistic value) {
    m_statisticHasBeenSet = true;
    m_statistic = value;
  }
  inline LambdaFunctionUtilizationMetric& WithStatistic(LambdaFunctionMetricStatistic value) {
    SetStatistic(value);
    return *this;
  }
  ///@}
  ...
  inline LambdaFunctionUtilizationMetric& WithValue(double value) {
    SetValue(value);
    return *this;
  }
  ///@}
