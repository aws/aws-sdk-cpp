...
class LambdaSavingsOpportunityAfterDiscounts {
 public:
  ...
  AWS_COMPUTEOPTIMIZER_API LambdaSavingsOpportunityAfterDiscounts(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZER_API LambdaSavingsOpportunityAfterDiscounts& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline LambdaSavingsOpportunityAfterDiscounts& WithSavingsOpportunityPercentage(double value) {
  ...
  template <typename EstimatedMonthlySavingsT = LambdaEstimatedMonthlySavings>
