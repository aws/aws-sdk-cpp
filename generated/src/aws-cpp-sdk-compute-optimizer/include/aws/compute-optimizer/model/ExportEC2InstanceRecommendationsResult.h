...
class ExportEC2InstanceRecommendationsResult {
 public:
  ...
  AWS_COMPUTEOPTIMIZER_API ExportEC2InstanceRecommendationsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_COMPUTEOPTIMIZER_API ExportEC2InstanceRecommendationsResult& operator=(
  ...
  template <typename JobIdT = Aws::String>
  ExportEC2InstanceRecommendationsResult& WithJobId(JobIdT&& value) {
  ...
  template <typename S3DestinationT = S3Destination>
  ExportEC2InstanceRecommendationsResult& WithS3Destination(S3DestinationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ExportEC2InstanceRecommendationsResult& WithRequestId(RequestIdT&& value) {
