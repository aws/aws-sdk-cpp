...
class RecommendationSummary {
 public:
  ...
  AWS_COMPUTEOPTIMIZER_API RecommendationSummary(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZER_API RecommendationSummary& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline void SetRecommendationResourceType(RecommendationSourceType value) {
    m_recommendationResourceTypeHasBeenSet = true;
    m_recommendationResourceType = value;
  }
  inline RecommendationSummary& WithRecommendationResourceType(RecommendationSourceType value) {
    SetRecommendationResourceType(value);
    return *this;
  }
  ///@}
  ...
  void SetIdleSavingsOpportunity(IdleSavingsOpportunityT&& value) {
    ...
    m_idleSavingsOpportunity = std::forward<IdleSavingsOpportunityT>(value);
  }
  template <typename IdleSavingsOpportunityT = SavingsOpportunity>
  RecommendationSummary& WithIdleSavingsOpportunity(IdleSavingsOpportunityT&& value) {
    SetIdleSavingsOpportunity(std::forward<IdleSavingsOpportunityT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAggregatedSavingsOpportunity(AggregatedSavingsOpportunityT&& value) {
    ...
    m_aggregatedSavingsOpportunity = std::forward<AggregatedSavingsOpportunityT>(value);
  }
  template <typename AggregatedSavingsOpportunityT = SavingsOpportunity>
  RecommendationSummary& WithAggregatedSavingsOpportunity(AggregatedSavingsOpportunityT&& value) {
    SetAggregatedSavingsOpportunity(std::forward<AggregatedSavingsOpportunityT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCurrentPerformanceRiskRatings(CurrentPerformanceRiskRatingsT&& value) {
    ...
    m_currentPerformanceRiskRatings = std::forward<CurrentPerformanceRiskRatingsT>(value);
  }
  template <typename CurrentPerformanceRiskRatingsT = CurrentPerformanceRiskRatings>
  RecommendationSummary& WithCurrentPerformanceRiskRatings(CurrentPerformanceRiskRatingsT&& value) {
    SetCurrentPerformanceRiskRatings(std::forward<CurrentPerformanceRiskRatingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInferredWorkloadSavings(InferredWorkloadSavingsT&& value) {
    ...
    m_inferredWorkloadSavings = std::forward<InferredWorkloadSavingsT>(value);
  }
  template <typename InferredWorkloadSavingsT = Aws::Vector<InferredWorkloadSaving>>
  RecommendationSummary& WithInferredWorkloadSavings(InferredWorkloadSavingsT&& value) {
    SetInferredWorkloadSavings(std::forward<InferredWorkloadSavingsT>(value));
    return *this;
  }
  ...
  RecommendationSummary& AddInferredWorkloadSavings(InferredWorkloadSavingsT&& value) {
    m_inferredWorkloadSavingsHasBeenSet = true;
    m_inferredWorkloadSavings.emplace_back(std::forward<InferredWorkloadSavingsT>(value));
    return *this;
  }
  ///@}
 private:
