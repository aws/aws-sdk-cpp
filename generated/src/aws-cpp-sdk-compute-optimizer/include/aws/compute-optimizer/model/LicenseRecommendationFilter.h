...
class LicenseRecommendationFilter {
 public:
  ...
  AWS_COMPUTEOPTIMIZER_API LicenseRecommendationFilter(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZER_API LicenseRecommendationFilter& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline void SetName(LicenseRecommendationFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline LicenseRecommendationFilter& WithName(LicenseRecommendationFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  LicenseRecommendationFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  LicenseRecommendationFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
