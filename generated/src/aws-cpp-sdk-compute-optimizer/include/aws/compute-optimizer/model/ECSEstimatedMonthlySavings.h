...
class ECSEstimatedMonthlySavings {
 public:
  AWS_COMPUTEOPTIMIZER_API ECSEstimatedMonthlySavings() = default;
  AWS_COMPUTEOPTIMIZER_API ECSEstimatedMonthlySavings(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZER_API ECSEstimatedMonthlySavings& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline ECSEstimatedMonthlySavings& WithCurrency(Currency value) {
    SetCurrency(value);
    return *this;
  }
  ///@}
  ...
  inline ECSEstimatedMonthlySavings& WithValue(double value) {
    SetValue(value);
    return *this;
  }
  ///@}
