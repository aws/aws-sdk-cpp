...
class GetLicenseRecommendationsResult {
 public:
  ...
  AWS_COMPUTEOPTIMIZER_API GetLicenseRecommendationsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_COMPUTEOPTIMIZER_API GetLicenseRecommendationsResult& operator=(
  ...
  void SetLicenseRecommendations(LicenseRecommendationsT&& value) {
    ...
    m_licenseRecommendations = std::forward<LicenseRecommendationsT>(value);
  }
  template <typename LicenseRecommendationsT = Aws::Vector<LicenseRecommendation>>
  GetLicenseRecommendationsResult& WithLicenseRecommendations(LicenseRecommendationsT&& value) {
    SetLicenseRecommendations(std::forward<LicenseRecommendationsT>(value));
    return *this;
  }
  ...
  GetLicenseRecommendationsResult& AddLicenseRecommendations(LicenseRecommendationsT&& value) {
    m_licenseRecommendationsHasBeenSet = true;
    m_licenseRecommendations.emplace_back(std::forward<LicenseRecommendationsT>(value));
    return *this;
  }
  ///@}
