...
class InstanceRecommendation {
 public:
  ...
  AWS_COMPUTEOPTIMIZER_API InstanceRecommendation(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZER_API InstanceRecommendation& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  void SetCurrentInstanceType(CurrentInstanceTypeT&& value) {
    ...
    m_currentInstanceType = std::forward<CurrentInstanceTypeT>(value);
  }
  template <typename CurrentInstanceTypeT = Aws::String>
  InstanceRecommendation& WithCurrentInstanceType(CurrentInstanceTypeT&& value) {
    SetCurrentInstanceType(std::forward<CurrentInstanceTypeT>(value));
    return *this;
  }
  ///@}
  ...
  inline InstanceRecommendation& WithFinding(Finding value) {
    SetFinding(value);
    return *this;
  }
  ///@}
  ...
  inline InstanceRecommendation& AddFindingReasonCodes(InstanceRecommendationFindingReasonCode value) {
    m_findingReasonCodesHasBeenSet = true;
  ...
  inline InstanceRecommendation& WithLookBackPeriodInDays(double value) {
  ...
  void SetRecommendationSources(RecommendationSourcesT&& value) {
    ...
    m_recommendationSources = std::forward<RecommendationSourcesT>(value);
  }
  template <typename RecommendationSourcesT = Aws::Vector<RecommendationSource>>
  InstanceRecommendation& WithRecommendationSources(RecommendationSourcesT&& value) {
    SetRecommendationSources(std::forward<RecommendationSourcesT>(value));
    return *this;
  }
  ...
  InstanceRecommendation& AddRecommendationSources(RecommendationSourcesT&& value) {
    m_recommendationSourcesHasBeenSet = true;
    m_recommendationSources.emplace_back(std::forward<RecommendationSourcesT>(value));
    return *this;
  }
  ///@}
  ...
  inline InstanceRecommendation& WithCurrentPerformanceRisk(CurrentPerformanceRisk value) {
  ...
  inline InstanceRecommendation& AddInferredWorkloadTypes(InferredWorkloadType value) {
    m_inferredWorkloadTypesHasBeenSet = true;
  ...
  inline InstanceRecommendation& WithInstanceState(InstanceState value) {
  ...
  void SetExternalMetricStatus(ExternalMetricStatusT&& value) {
    ...
    m_externalMetricStatus = std::forward<ExternalMetricStatusT>(value);
  }
  template <typename ExternalMetricStatusT = ExternalMetricStatus>
  InstanceRecommendation& WithExternalMetricStatus(ExternalMetricStatusT&& value) {
    SetExternalMetricStatus(std::forward<ExternalMetricStatusT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetIdle(InstanceIdle value) {
    m_idleHasBeenSet = true;
    m_idle = value;
  }
  inline InstanceRecommendation& WithIdle(InstanceIdle value) {
    SetIdle(value);
    return *this;
  }
  ///@}
