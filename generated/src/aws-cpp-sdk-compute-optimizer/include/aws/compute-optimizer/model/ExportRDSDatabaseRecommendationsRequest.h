...
class ExportRDSDatabaseRecommendationsRequest : public ComputeOptimizerRequest {
 public:
  ...
  template <typename AccountIdsT = Aws::Vector<Aws::String>>
  ExportRDSDatabaseRecommendationsRequest& WithAccountIds(AccountIdsT&& value) {
    SetAccountIds(std::forward<AccountIdsT>(value));
    return *this;
  }
  template <typename AccountIdsT = Aws::String>
  ExportRDSDatabaseRecommendationsRequest& AddAccountIds(AccountIdsT&& value) {
    m_accountIdsHasBeenSet = true;
  ...
  template <typename FiltersT = Aws::Vector<RDSDBRecommendationFilter>>
  ExportRDSDatabaseRecommendationsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = RDSDBRecommendationFilter>
  ExportRDSDatabaseRecommendationsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename FieldsToExportT = Aws::Vector<ExportableRDSDBField>>
  ExportRDSDatabaseRecommendationsRequest& WithFieldsToExport(FieldsToExportT&& value) {
    SetFieldsToExport(std::forward<FieldsToExportT>(value));
    return *this;
  }
  inline ExportRDSDatabaseRecommendationsRequest& AddFieldsToExport(ExportableRDSDBField value) {
    m_fieldsToExportHasBeenSet = true;
  ...
  template <typename S3DestinationConfigT = S3DestinationConfig>
  ExportRDSDatabaseRecommendationsRequest& WithS3DestinationConfig(S3DestinationConfigT&& value) {
  ...
  inline ExportRDSDatabaseRecommendationsRequest& WithFileFormat(FileFormat value) {
    SetFileFormat(value);
    return *this;
  }
  ///@}
  ...
  inline ExportRDSDatabaseRecommendationsRequest& WithIncludeMemberAccounts(bool value) {
  ...
  template <typename RecommendationPreferencesT = RecommendationPreferences>
  ExportRDSDatabaseRecommendationsRequest& WithRecommendationPreferences(RecommendationPreferencesT&& value) {
