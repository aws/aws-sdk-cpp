...
class ECSServiceUtilizationMetric {
 public:
  ...
  AWS_COMPUTEOPTIMIZER_API ECSServiceUtilizationMetric(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZER_API ECSServiceUtilizationMetric& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline void SetName(ECSServiceMetricName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline ECSServiceUtilizationMetric& WithName(ECSServiceMetricName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatistic(ECSServiceMetricStatistic value) {
    m_statisticHasBeenSet = true;
    m_statistic = value;
  }
  inline ECSServiceUtilizationMetric& WithStatistic(ECSServiceMetricStatistic value) {
    SetStatistic(value);
    return *this;
  }
  ///@}
  ...
  inline ECSServiceUtilizationMetric& WithValue(double value) {
    SetValue(value);
    return *this;
  }
  ///@}
