...
class ExportAutoScalingGroupRecommendationsResult {
 public:
  ...
  AWS_COMPUTEOPTIMIZER_API ExportAutoScalingGroupRecommendationsResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename JobIdT = Aws::String>
  ExportAutoScalingGroupRecommendationsResult& WithJobId(JobIdT&& value) {
  ...
  template <typename S3DestinationT = S3Destination>
  ExportAutoScalingGroupRecommendationsResult& WithS3Destination(S3DestinationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ExportAutoScalingGroupRecommendationsResult& WithRequestId(RequestIdT&& value) {
