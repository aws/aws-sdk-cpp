...
namespace Model
{
  ...
  {
  public:
    AWS_COMPUTEOPTIMIZER_API ExportAutoScalingGroupRecommendationsResult() = default;
    ...
    template<typename JobIdT = Aws::String>
    ExportAutoScalingGroupRecommendationsResult& WithJobId(JobIdT&& value) { SetJobId(std::forward<JobIdT>(value)); return *this;}
    ///@}
    ...
    template<typename S3DestinationT = S3Destination>
    ExportAutoScalingGroupRecommendationsResult& WithS3Destination(S3DestinationT&& value) { SetS3Destination(std::forward<S3DestinationT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ExportAutoScalingGroupRecommendationsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
