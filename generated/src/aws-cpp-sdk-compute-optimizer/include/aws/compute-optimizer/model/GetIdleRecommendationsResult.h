...
class GetIdleRecommendationsResult {
 public:
  ...
  AWS_COMPUTEOPTIMIZER_API GetIdleRecommendationsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_COMPUTEOPTIMIZER_API GetIdleRecommendationsResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  template <typename NextTokenT = Aws::String>
  GetIdleRecommendationsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetIdleRecommendations(IdleRecommendationsT&& value) {
    m_idleRecommendationsHasBeenSet = true;
    m_idleRecommendations = std::forward<IdleRecommendationsT>(value);
  }
  template <typename IdleRecommendationsT = Aws::Vector<IdleRecommendation>>
  GetIdleRecommendationsResult& WithIdleRecommendations(IdleRecommendationsT&& value) {
    SetIdleRecommendations(std::forward<IdleRecommendationsT>(value));
    return *this;
  }
  template <typename IdleRecommendationsT = IdleRecommendation>
  GetIdleRecommendationsResult& AddIdleRecommendations(IdleRecommendationsT&& value) {
    m_idleRecommendationsHasBeenSet = true;
    m_idleRecommendations.emplace_back(std::forward<IdleRecommendationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ErrorsT = Aws::Vector<IdleRecommendationError>>
  GetIdleRecommendationsResult& WithErrors(ErrorsT&& value) {
    SetErrors(std::forward<ErrorsT>(value));
    return *this;
  }
  template <typename ErrorsT = IdleRecommendationError>
  GetIdleRecommendationsResult& AddErrors(ErrorsT&& value) {
    m_errorsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetIdleRecommendationsResult& WithRequestId(RequestIdT&& value) {
