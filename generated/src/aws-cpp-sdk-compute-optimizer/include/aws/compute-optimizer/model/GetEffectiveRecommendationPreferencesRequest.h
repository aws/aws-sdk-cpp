...
namespace Model
{
  ...
  {
  public:
    AWS_COMPUTEOPTIMIZER_API GetEffectiveRecommendationPreferencesRequest() = default;
    ...
    template<typename ResourceArnT = Aws::String>
    GetEffectiveRecommendationPreferencesRequest& WithResourceArn(ResourceArnT&& value) { SetResourceArn(std::forward<ResourceArnT>(value)); return *this;}
    ///@}
  private:
