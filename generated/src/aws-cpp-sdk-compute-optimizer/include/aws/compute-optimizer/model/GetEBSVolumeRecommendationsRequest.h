...
class GetEBSVolumeRecommendationsRequest : public ComputeOptimizerRequest {
 public:
  ...
  template <typename VolumeArnsT = Aws::Vector<Aws::String>>
  GetEBSVolumeRecommendationsRequest& WithVolumeArns(VolumeArnsT&& value) {
    SetVolumeArns(std::forward<VolumeArnsT>(value));
    return *this;
  }
  template <typename VolumeArnsT = Aws::String>
  GetEBSVolumeRecommendationsRequest& AddVolumeArns(VolumeArnsT&& value) {
    m_volumeArnsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetEBSVolumeRecommendationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline GetEBSVolumeRecommendationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<EBSFilter>>
  GetEBSVolumeRecommendationsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = EBSFilter>
  GetEBSVolumeRecommendationsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename AccountIdsT = Aws::Vector<Aws::String>>
  GetEBSVolumeRecommendationsRequest& WithAccountIds(AccountIdsT&& value) {
    SetAccountIds(std::forward<AccountIdsT>(value));
    return *this;
  }
  template <typename AccountIdsT = Aws::String>
  GetEBSVolumeRecommendationsRequest& AddAccountIds(AccountIdsT&& value) {
    m_accountIdsHasBeenSet = true;
