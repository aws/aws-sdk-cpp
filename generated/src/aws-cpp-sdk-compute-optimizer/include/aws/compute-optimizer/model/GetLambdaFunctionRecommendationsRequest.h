...
class GetLambdaFunctionRecommendationsRequest : public ComputeOptimizerRequest {
 public:
  ...
  inline GetLambdaFunctionRecommendationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
