...
class JobFilter {
 public:
  ...
  AWS_COMPUTEOPTIMIZER_API JobFilter(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZER_API JobFilter& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline void SetName(JobFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline JobFilter& WithName(JobFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  JobFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  JobFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
