...
class ECSServiceRecommendationOption {
 public:
   ...
   */
  inline const ECSSavingsOpportunityAfterDiscounts& GetSavingsOpportunityAfterDiscounts() const {
   ...
   */
  inline const Aws::Vector<ECSServiceProjectedUtilizationMetric>& GetProjectedUtilizationMetrics() const {
  ...
  void SetContainerRecommendations(ContainerRecommendationsT&& value) {
    ...
    m_containerRecommendations = std::forward<ContainerRecommendationsT>(value);
  }
  template <typename ContainerRecommendationsT = Aws::Vector<ContainerRecommendation>>
  ECSServiceRecommendationOption& WithContainerRecommendations(ContainerRecommendationsT&& value) {
    SetContainerRecommendations(std::forward<ContainerRecommendationsT>(value));
    return *this;
  }
  ...
  ECSServiceRecommendationOption& AddContainerRecommendations(ContainerRecommendationsT&& value) {
    m_containerRecommendationsHasBeenSet = true;
    m_containerRecommendations.emplace_back(std::forward<ContainerRecommendationsT>(value));
    return *this;
  }
  ///@}
 private:
