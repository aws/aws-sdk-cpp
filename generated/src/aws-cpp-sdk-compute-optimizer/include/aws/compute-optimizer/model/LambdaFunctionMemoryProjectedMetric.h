...
class LambdaFunctionMemoryProjectedMetric {
 public:
  ...
  AWS_COMPUTEOPTIMIZER_API LambdaFunctionMemoryProjectedMetric(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZER_API LambdaFunctionMemoryProjectedMetric& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline void SetName(LambdaFunctionMemoryMetricName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline LambdaFunctionMemoryProjectedMetric& WithName(LambdaFunctionMemoryMetricName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatistic(LambdaFunctionMemoryMetricStatistic value) {
    m_statisticHasBeenSet = true;
    m_statistic = value;
  }
  inline LambdaFunctionMemoryProjectedMetric& WithStatistic(LambdaFunctionMemoryMetricStatistic value) {
    SetStatistic(value);
    return *this;
  }
  ///@}
  ...
  inline LambdaFunctionMemoryProjectedMetric& WithValue(double value) {
    SetValue(value);
    return *this;
  }
  ///@}
