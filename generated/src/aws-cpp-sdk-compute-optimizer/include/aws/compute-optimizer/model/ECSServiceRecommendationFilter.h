...
class ECSServiceRecommendationFilter {
 public:
  ...
  AWS_COMPUTEOPTIMIZER_API ECSServiceRecommendationFilter(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZER_API ECSServiceRecommendationFilter& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline void SetName(ECSServiceRecommendationFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline ECSServiceRecommendationFilter& WithName(ECSServiceRecommendationFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  ECSServiceRecommendationFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  ECSServiceRecommendationFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
