...
class ExportIdleRecommendationsResult {
 public:
  ...
  AWS_COMPUTEOPTIMIZER_API ExportIdleRecommendationsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_COMPUTEOPTIMIZER_API ExportIdleRecommendationsResult& operator=(
  ...
  template <typename JobIdT = Aws::String>
  ExportIdleRecommendationsResult& WithJobId(JobIdT&& value) {
