...
class DescribeRecommendationExportJobsRequest : public ComputeOptimizerRequest {
 public:
  ...
  template <typename JobIdsT = Aws::Vector<Aws::String>>
  DescribeRecommendationExportJobsRequest& WithJobIds(JobIdsT&& value) {
    SetJobIds(std::forward<JobIdsT>(value));
    return *this;
  }
  template <typename JobIdsT = Aws::String>
  DescribeRecommendationExportJobsRequest& AddJobIds(JobIdsT&& value) {
    m_jobIdsHasBeenSet = true;
  ...
  template <typename FiltersT = Aws::Vector<JobFilter>>
  DescribeRecommendationExportJobsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = JobFilter>
  DescribeRecommendationExportJobsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline DescribeRecommendationExportJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
