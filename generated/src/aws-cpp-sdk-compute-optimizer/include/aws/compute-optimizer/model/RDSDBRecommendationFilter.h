...
class RDSDBRecommendationFilter {
 public:
  ...
  AWS_COMPUTEOPTIMIZER_API RDSDBRecommendationFilter(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZER_API RDSDBRecommendationFilter& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline void SetName(RDSDBRecommendationFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline RDSDBRecommendationFilter& WithName(RDSDBRecommendationFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  RDSDBRecommendationFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  RDSDBRecommendationFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
