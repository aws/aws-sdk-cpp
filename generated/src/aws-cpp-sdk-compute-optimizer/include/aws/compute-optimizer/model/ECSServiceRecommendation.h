...
class ECSServiceRecommendation {
 public:
  ...
  AWS_COMPUTEOPTIMIZER_API ECSServiceRecommendation(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZER_API ECSServiceRecommendation& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  void SetCurrentServiceConfiguration(CurrentServiceConfigurationT&& value) {
    ...
    m_currentServiceConfiguration = std::forward<CurrentServiceConfigurationT>(value);
  }
  template <typename CurrentServiceConfigurationT = ServiceConfiguration>
  ECSServiceRecommendation& WithCurrentServiceConfiguration(CurrentServiceConfigurationT&& value) {
    SetCurrentServiceConfiguration(std::forward<CurrentServiceConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUtilizationMetrics(UtilizationMetricsT&& value) {
    ...
    m_utilizationMetrics = std::forward<UtilizationMetricsT>(value);
  }
  template <typename UtilizationMetricsT = Aws::Vector<ECSServiceUtilizationMetric>>
  ECSServiceRecommendation& WithUtilizationMetrics(UtilizationMetricsT&& value) {
    SetUtilizationMetrics(std::forward<UtilizationMetricsT>(value));
    return *this;
  }
  ...
  ECSServiceRecommendation& AddUtilizationMetrics(UtilizationMetricsT&& value) {
    m_utilizationMetricsHasBeenSet = true;
    m_utilizationMetrics.emplace_back(std::forward<UtilizationMetricsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetLookbackPeriodInDays(double value) {
    m_lookbackPeriodInDaysHasBeenSet = true;
    m_lookbackPeriodInDays = value;
  }
  inline ECSServiceRecommendation& WithLookbackPeriodInDays(double value) {
  ...
  inline void SetLaunchType(ECSServiceLaunchType value) {
    m_launchTypeHasBeenSet = true;
    m_launchType = value;
  }
  inline ECSServiceRecommendation& WithLaunchType(ECSServiceLaunchType value) {
    SetLaunchType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFinding(ECSServiceRecommendationFinding value) {
    m_findingHasBeenSet = true;
    m_finding = value;
  }
  inline ECSServiceRecommendation& WithFinding(ECSServiceRecommendationFinding value) {
    SetFinding(value);
    return *this;
  }
  ///@}
  ...
  void SetFindingReasonCodes(FindingReasonCodesT&& value) {
    ...
    m_findingReasonCodes = std::forward<FindingReasonCodesT>(value);
  }
  template <typename FindingReasonCodesT = Aws::Vector<ECSServiceRecommendationFindingReasonCode>>
  ECSServiceRecommendation& WithFindingReasonCodes(FindingReasonCodesT&& value) {
    SetFindingReasonCodes(std::forward<FindingReasonCodesT>(value));
    return *this;
  }
  inline ECSServiceRecommendation& AddFindingReasonCodes(ECSServiceRecommendationFindingReasonCode value) {
    m_findingReasonCodesHasBeenSet = true;
    m_findingReasonCodes.push_back(value);
    return *this;
  }
  ///@}
   ...
   * ECS service. </p>
   */
  inline const Aws::Vector<ECSServiceRecommendationOption>& GetServiceRecommendationOptions() const {
    return m_serviceRecommendationOptions;
  }
  ...
  void SetServiceRecommendationOptions(ServiceRecommendationOptionsT&& value) {
    ...
    m_serviceRecommendationOptions = std::forward<ServiceRecommendationOptionsT>(value);
  }
  template <typename ServiceRecommendationOptionsT = Aws::Vector<ECSServiceRecommendationOption>>
  ECSServiceRecommendation& WithServiceRecommendationOptions(ServiceRecommendationOptionsT&& value) {
    SetServiceRecommendationOptions(std::forward<ServiceRecommendationOptionsT>(value));
    return *this;
  }
  ...
  ECSServiceRecommendation& AddServiceRecommendationOptions(ServiceRecommendationOptionsT&& value) {
    m_serviceRecommendationOptionsHasBeenSet = true;
    m_serviceRecommendationOptions.emplace_back(std::forward<ServiceRecommendationOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetCurrentPerformanceRisk(CurrentPerformanceRisk value) {
    m_currentPerformanceRiskHasBeenSet = true;
    m_currentPerformanceRisk = value;
  }
  inline ECSServiceRecommendation& WithCurrentPerformanceRisk(CurrentPerformanceRisk value) {
    SetCurrentPerformanceRisk(value);
    return *this;
  }
  ///@}
   ...
   * </p>
   */
  inline const ECSEffectiveRecommendationPreferences& GetEffectiveRecommendationPreferences() const {
  ...
  void SetEffectiveRecommendationPreferences(EffectiveRecommendationPreferencesT&& value) {
    ...
    m_effectiveRecommendationPreferences = std::forward<EffectiveRecommendationPreferencesT>(value);
  }
  template <typename EffectiveRecommendationPreferencesT = ECSEffectiveRecommendationPreferences>
  ECSServiceRecommendation& WithEffectiveRecommendationPreferences(EffectiveRecommendationPreferencesT&& value) {
    SetEffectiveRecommendationPreferences(std::forward<EffectiveRecommendationPreferencesT>(value));
    return *this;
  }
  ///@}
