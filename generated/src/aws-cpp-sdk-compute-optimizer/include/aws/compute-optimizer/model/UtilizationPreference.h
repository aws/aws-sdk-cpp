...
class UtilizationPreference {
 public:
  ...
  inline void SetMetricName(CustomizableMetricName value) {
    m_metricNameHasBeenSet = true;
    m_metricName = value;
  }
  inline UtilizationPreference& WithMetricName(CustomizableMetricName value) {
    SetMetricName(value);
    return *this;
  }
  ///@}
  ...
  void SetMetricParameters(MetricParametersT&& value) {
    ...
    m_metricParameters = std::forward<MetricParametersT>(value);
  }
  template <typename MetricParametersT = CustomizableMetricParameters>
  UtilizationPreference& WithMetricParameters(MetricParametersT&& value) {
    SetMetricParameters(std::forward<MetricParametersT>(value));
    return *this;
  }
  ///@}
 private:
