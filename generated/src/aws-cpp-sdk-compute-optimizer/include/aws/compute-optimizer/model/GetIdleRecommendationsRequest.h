...
class GetIdleRecommendationsRequest : public ComputeOptimizerRequest {
 public:
  ...
  template <typename ResourceArnsT = Aws::Vector<Aws::String>>
  GetIdleRecommendationsRequest& WithResourceArns(ResourceArnsT&& value) {
    SetResourceArns(std::forward<ResourceArnsT>(value));
    return *this;
  }
  template <typename ResourceArnsT = Aws::String>
  GetIdleRecommendationsRequest& AddResourceArns(ResourceArnsT&& value) {
    m_resourceArnsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetIdleRecommendationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline GetIdleRecommendationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<IdleRecommendationFilter>>
  GetIdleRecommendationsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = IdleRecommendationFilter>
  GetIdleRecommendationsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename AccountIdsT = Aws::Vector<Aws::String>>
  GetIdleRecommendationsRequest& WithAccountIds(AccountIdsT&& value) {
    SetAccountIds(std::forward<AccountIdsT>(value));
    return *this;
  }
  template <typename AccountIdsT = Aws::String>
  GetIdleRecommendationsRequest& AddAccountIds(AccountIdsT&& value) {
    m_accountIdsHasBeenSet = true;
  ...
  template <typename OrderByT = OrderBy>
  GetIdleRecommendationsRequest& WithOrderBy(OrderByT&& value) {
