...
class AutoScalingGroupRecommendationOption {
 public:
  ...
  void SetInstanceGpuInfo(InstanceGpuInfoT&& value) {
    ...
    m_instanceGpuInfo = std::forward<InstanceGpuInfoT>(value);
  }
  template <typename InstanceGpuInfoT = GpuInfo>
  AutoScalingGroupRecommendationOption& WithInstanceGpuInfo(InstanceGpuInfoT&& value) {
    SetInstanceGpuInfo(std::forward<InstanceGpuInfoT>(value));
    return *this;
  }
  ///@}
  ...
  inline AutoScalingGroupRecommendationOption& WithPerformanceRisk(double value) {
  ...
  inline void SetMigrationEffort(MigrationEffort value) {
    m_migrationEffortHasBeenSet = true;
    m_migrationEffort = value;
  }
  inline AutoScalingGroupRecommendationOption& WithMigrationEffort(MigrationEffort value) {
    SetMigrationEffort(value);
    return *this;
  }
  ///@}
 private:
