...
class GetEC2InstanceRecommendationsResult {
 public:
  ...
  AWS_COMPUTEOPTIMIZER_API GetEC2InstanceRecommendationsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_COMPUTEOPTIMIZER_API GetEC2InstanceRecommendationsResult& operator=(
  ...
  template <typename NextTokenT = Aws::String>
  GetEC2InstanceRecommendationsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetInstanceRecommendations(InstanceRecommendationsT&& value) {
    m_instanceRecommendationsHasBeenSet = true;
    m_instanceRecommendations = std::forward<InstanceRecommendationsT>(value);
  }
  template <typename InstanceRecommendationsT = Aws::Vector<InstanceRecommendation>>
  GetEC2InstanceRecommendationsResult& WithInstanceRecommendations(InstanceRecommendationsT&& value) {
    SetInstanceRecommendations(std::forward<InstanceRecommendationsT>(value));
    return *this;
  }
  template <typename InstanceRecommendationsT = InstanceRecommendation>
  GetEC2InstanceRecommendationsResult& AddInstanceRecommendations(InstanceRecommendationsT&& value) {
    m_instanceRecommendationsHasBeenSet = true;
    m_instanceRecommendations.emplace_back(std::forward<InstanceRecommendationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ErrorsT = Aws::Vector<GetRecommendationError>>
  GetEC2InstanceRecommendationsResult& WithErrors(ErrorsT&& value) {
    SetErrors(std::forward<ErrorsT>(value));
    return *this;
  }
  template <typename ErrorsT = GetRecommendationError>
  GetEC2InstanceRecommendationsResult& AddErrors(ErrorsT&& value) {
    m_errorsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetEC2InstanceRecommendationsResult& WithRequestId(RequestIdT&& value) {
