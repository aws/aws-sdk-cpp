...
class RDSStorageSavingsOpportunityAfterDiscounts {
 public:
  ...
  AWS_COMPUTEOPTIMIZER_API RDSStorageSavingsOpportunityAfterDiscounts(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZER_API RDSStorageSavingsOpportunityAfterDiscounts& operator=(
  ...
  inline RDSStorageSavingsOpportunityAfterDiscounts& WithSavingsOpportunityPercentage(double value) {
  ...
  template <typename EstimatedMonthlySavingsT = RDSStorageEstimatedMonthlySavings>
  RDSStorageSavingsOpportunityAfterDiscounts& WithEstimatedMonthlySavings(EstimatedMonthlySavingsT&& value) {
