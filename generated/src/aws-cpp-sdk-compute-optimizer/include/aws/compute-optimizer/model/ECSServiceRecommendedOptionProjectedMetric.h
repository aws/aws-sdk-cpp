...
class ECSServiceRecommendedOptionProjectedMetric {
 public:
  ...
  template <typename ProjectedMetricsT = Aws::Vector<ECSServiceProjectedMetric>>
  ECSServiceRecommendedOptionProjectedMetric& WithProjectedMetrics(ProjectedMetricsT&& value) {
    SetProjectedMetrics(std::forward<ProjectedMetricsT>(value));
    return *this;
  }
  template <typename ProjectedMetricsT = ECSServiceProjectedMetric>
  ECSServiceRecommendedOptionProjectedMetric& AddProjectedMetrics(ProjectedMetricsT&& value) {
    m_projectedMetricsHasBeenSet = true;
