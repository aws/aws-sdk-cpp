...
class UtilizationMetric {
 public:
  ...
  inline UtilizationMetric& WithName(MetricName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  inline UtilizationMetric& WithStatistic(MetricStatistic value) {
    SetStatistic(value);
    return *this;
  }
  ///@}
  ...
  inline UtilizationMetric& WithValue(double value) {
    SetValue(value);
    return *this;
  }
  ///@}
