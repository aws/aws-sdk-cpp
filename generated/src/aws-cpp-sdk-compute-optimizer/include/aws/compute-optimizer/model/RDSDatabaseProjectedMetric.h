...
class RDSDatabaseProjectedMetric {
 public:
  ...
  AWS_COMPUTEOPTIMIZER_API RDSDatabaseProjectedMetric(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZER_API RDSDatabaseProjectedMetric& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline void SetName(RDSDBMetricName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline RDSDatabaseProjectedMetric& WithName(RDSDBMetricName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename TimestampsT = Aws::Vector<Aws::Utils::DateTime>>
  RDSDatabaseProjectedMetric& WithTimestamps(TimestampsT&& value) {
    SetTimestamps(std::forward<TimestampsT>(value));
    return *this;
  }
  template <typename TimestampsT = Aws::Utils::DateTime>
  RDSDatabaseProjectedMetric& AddTimestamps(TimestampsT&& value) {
    m_timestampsHasBeenSet = true;
  ...
  template <typename ValuesT = Aws::Vector<double>>
  RDSDatabaseProjectedMetric& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  inline RDSDatabaseProjectedMetric& AddValues(double value) {
    m_valuesHasBeenSet = true;
