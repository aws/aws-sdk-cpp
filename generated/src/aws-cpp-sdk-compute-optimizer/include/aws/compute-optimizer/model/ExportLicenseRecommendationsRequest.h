...
class ExportLicenseRecommendationsRequest : public ComputeOptimizerRequest {
 public:
  ...
  inline ExportLicenseRecommendationsRequest& AddFieldsToExport(ExportableLicenseField value) {
    m_fieldsToExportHasBeenSet = true;
  ...
  inline ExportLicenseRecommendationsRequest& WithFileFormat(FileFormat value) {
    SetFileFormat(value);
    return *this;
  }
  ///@}
  ...
  inline ExportLicenseRecommendationsRequest& WithIncludeMemberAccounts(bool value) {
