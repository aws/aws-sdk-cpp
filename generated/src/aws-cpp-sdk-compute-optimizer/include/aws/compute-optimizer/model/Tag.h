...
class Tag {
 public:
  AWS_COMPUTEOPTIMIZER_API Tag() = default;
  AWS_COMPUTEOPTIMIZER_API Tag(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZER_API Tag& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
