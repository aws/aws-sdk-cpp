...
class GpuInfo {
 public:
  ...
  AWS_COMPUTEOPTIMIZER_API GpuInfo(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZER_API GpuInfo& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
