...
class RDSInstanceEstimatedMonthlySavings {
 public:
  ...
  AWS_COMPUTEOPTIMIZER_API RDSInstanceEstimatedMonthlySavings(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZER_API RDSInstanceEstimatedMonthlySavings& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline RDSInstanceEstimatedMonthlySavings& WithCurrency(Currency value) {
    SetCurrency(value);
    return *this;
  }
  ///@}
  ...
  inline RDSInstanceEstimatedMonthlySavings& WithValue(double value) {
    SetValue(value);
    return *this;
  }
  ///@}
