...
class GetEnrollmentStatusResult {
 public:
  ...
  inline GetEnrollmentStatusResult& WithStatus(Status value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonT = Aws::String>
  GetEnrollmentStatusResult& WithStatusReason(StatusReasonT&& value) {
  ...
  inline void SetMemberAccountsEnrolled(bool value) {
    m_memberAccountsEnrolledHasBeenSet = true;
    m_memberAccountsEnrolled = value;
  }
  inline GetEnrollmentStatusResult& WithMemberAccountsEnrolled(bool value) {
    SetMemberAccountsEnrolled(value);
    return *this;
  }
  ///@}
  ...
  template <typename LastUpdatedTimestampT = Aws::Utils::DateTime>
  GetEnrollmentStatusResult& WithLastUpdatedTimestamp(LastUpdatedTimestampT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetEnrollmentStatusResult& WithRequestId(RequestIdT&& value) {
