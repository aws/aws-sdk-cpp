...
class CurrentPerformanceRiskRatings {
 public:
  ...
  AWS_COMPUTEOPTIMIZER_API CurrentPerformanceRiskRatings(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZER_API CurrentPerformanceRiskRatings& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline CurrentPerformanceRiskRatings& WithHigh(long long value) {
    SetHigh(value);
    return *this;
  }
  ///@}
  ...
  inline CurrentPerformanceRiskRatings& WithMedium(long long value) {
    SetMedium(value);
    return *this;
  }
  ///@}
  ...
  inline CurrentPerformanceRiskRatings& WithLow(long long value) {
    SetLow(value);
    return *this;
  }
  ///@}
  ...
  inline void SetVeryLow(long long value) {
    m_veryLowHasBeenSet = true;
    m_veryLow = value;
  }
  inline CurrentPerformanceRiskRatings& WithVeryLow(long long value) {
    SetVeryLow(value);
    return *this;
  }
  ///@}
