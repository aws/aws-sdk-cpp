...
class ECSSavingsOpportunityAfterDiscounts {
 public:
  AWS_COMPUTEOPTIMIZER_API ECSSavingsOpportunityAfterDiscounts() = default;
  AWS_COMPUTEOPTIMIZER_API ECSSavingsOpportunityAfterDiscounts(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZER_API ECSSavingsOpportunityAfterDiscounts& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline void SetSavingsOpportunityPercentage(double value) {
    m_savingsOpportunityPercentageHasBeenSet = true;
    m_savingsOpportunityPercentage = value;
  }
  inline ECSSavingsOpportunityAfterDiscounts& WithSavingsOpportunityPercentage(double value) {
    SetSavingsOpportunityPercentage(value);
    return *this;
  }
  ///@}
  ...
  template <typename EstimatedMonthlySavingsT = ECSEstimatedMonthlySavings>
  ...
  template <typename EstimatedMonthlySavingsT = ECSEstimatedMonthlySavings>
  ECSSavingsOpportunityAfterDiscounts& WithEstimatedMonthlySavings(EstimatedMonthlySavingsT&& value) {
