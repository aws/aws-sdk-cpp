...
class IdleRecommendationFilter {
 public:
  ...
  AWS_COMPUTEOPTIMIZER_API IdleRecommendationFilter(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZER_API IdleRecommendationFilter& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline void SetName(IdleRecommendationFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline IdleRecommendationFilter& WithName(IdleRecommendationFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  IdleRecommendationFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  IdleRecommendationFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
