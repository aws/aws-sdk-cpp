...
class EBSEstimatedMonthlySavings {
 public:
  AWS_COMPUTEOPTIMIZER_API EBSEstimatedMonthlySavings() = default;
  AWS_COMPUTEOPTIMIZER_API EBSEstimatedMonthlySavings(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZER_API EBSEstimatedMonthlySavings& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline EBSEstimatedMonthlySavings& WithCurrency(Currency value) {
    SetCurrency(value);
    return *this;
  }
  ///@}
  ...
  inline EBSEstimatedMonthlySavings& WithValue(double value) {
    SetValue(value);
    return *this;
  }
  ///@}
