...
class EBSSavingsEstimationMode {
 public:
  ...
  AWS_COMPUTEOPTIMIZER_API EBSSavingsEstimationMode(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZER_API EBSSavingsEstimationMode& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline void SetSource(EBSSavingsEstimationModeSource value) {
    m_sourceHasBeenSet = true;
    m_source = value;
  }
  inline EBSSavingsEstimationMode& WithSource(EBSSavingsEstimationModeSource value) {
    SetSource(value);
    return *this;
  }
  ///@}
