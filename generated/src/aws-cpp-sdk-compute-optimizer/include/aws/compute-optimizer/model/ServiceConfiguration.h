...
class ServiceConfiguration {
 public:
  ...
  void SetContainerConfigurations(ContainerConfigurationsT&& value) {
    ...
    m_containerConfigurations = std::forward<ContainerConfigurationsT>(value);
  }
  template <typename ContainerConfigurationsT = Aws::Vector<ContainerConfiguration>>
  ServiceConfiguration& WithContainerConfigurations(ContainerConfigurationsT&& value) {
    SetContainerConfigurations(std::forward<ContainerConfigurationsT>(value));
    return *this;
  }
  ...
  ServiceConfiguration& AddContainerConfigurations(ContainerConfigurationsT&& value) {
    m_containerConfigurationsHasBeenSet = true;
    m_containerConfigurations.emplace_back(std::forward<ContainerConfigurationsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAutoScalingConfiguration(AutoScalingConfiguration value) {
    m_autoScalingConfigurationHasBeenSet = true;
    m_autoScalingConfiguration = value;
  }
  inline ServiceConfiguration& WithAutoScalingConfiguration(AutoScalingConfiguration value) {
    SetAutoScalingConfiguration(value);
    return *this;
  }
  ///@}
