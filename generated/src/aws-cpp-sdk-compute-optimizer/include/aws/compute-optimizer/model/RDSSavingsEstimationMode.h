...
class RDSSavingsEstimationMode {
 public:
  ...
  AWS_COMPUTEOPTIMIZER_API RDSSavingsEstimationMode(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZER_API RDSSavingsEstimationMode& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline void SetSource(RDSSavingsEstimationModeSource value) {
    m_sourceHasBeenSet = true;
    m_source = value;
  }
  inline RDSSavingsEstimationMode& WithSource(RDSSavingsEstimationModeSource value) {
    SetSource(value);
    return *this;
  }
  ///@}
