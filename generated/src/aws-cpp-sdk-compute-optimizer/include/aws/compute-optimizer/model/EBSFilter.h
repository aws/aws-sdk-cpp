...
class EBSFilter {
 public:
  ...
  AWS_COMPUTEOPTIMIZER_API EBSFilter(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZER_API EBSFilter& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline void SetName(EBSFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline EBSFilter& WithName(EBSFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  EBSFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  EBSFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
