...
class OrderBy {
 public:
  ...
  AWS_COMPUTEOPTIMIZER_API OrderBy(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZER_API OrderBy& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline OrderBy& WithDimension(Dimension value) {
    SetDimension(value);
    return *this;
  }
  ///@}
  ...
  inline OrderBy& WithOrder(Order value) {
    SetOrder(value);
    return *this;
  }
  ///@}
