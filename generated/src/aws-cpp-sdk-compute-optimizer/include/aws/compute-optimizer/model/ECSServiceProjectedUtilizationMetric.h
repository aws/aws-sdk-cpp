...
class ECSServiceProjectedUtilizationMetric {
 public:
  ...
  AWS_COMPUTEOPTIMIZER_API ECSServiceProjectedUtilizationMetric(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZER_API ECSServiceProjectedUtilizationMetric& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline ECSServiceProjectedUtilizationMetric& WithName(ECSServiceMetricName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  inline ECSServiceProjectedUtilizationMetric& WithStatistic(ECSServiceMetricStatistic value) {
    SetStatistic(value);
    return *this;
  }
  ///@}
  ...
  inline ECSServiceProjectedUtilizationMetric& WithLowerBoundValue(double value) {
  ...
  inline ECSServiceProjectedUtilizationMetric& WithUpperBoundValue(double value) {
