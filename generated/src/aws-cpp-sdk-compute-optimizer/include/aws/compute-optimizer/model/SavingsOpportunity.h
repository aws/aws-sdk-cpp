...
namespace Model
{
  ...
  public:
    ...
    template<typename EstimatedMonthlySavingsT = EstimatedMonthlySavings>
    SavingsOpportunity& WithEstimatedMonthlySavings(EstimatedMonthlySavingsT&& value) { SetEstimatedMonthlySavings(std::forward<EstimatedMonthlySavingsT>(value)); return *this;}
    ///@}
  private:
