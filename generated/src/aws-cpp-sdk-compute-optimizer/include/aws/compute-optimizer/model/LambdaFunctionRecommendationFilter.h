...
class LambdaFunctionRecommendationFilter {
 public:
  ...
  AWS_COMPUTEOPTIMIZER_API LambdaFunctionRecommendationFilter(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZER_API LambdaFunctionRecommendationFilter& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline void SetName(LambdaFunctionRecommendationFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline LambdaFunctionRecommendationFilter& WithName(LambdaFunctionRecommendationFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  LambdaFunctionRecommendationFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  LambdaFunctionRecommendationFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
