...
class ECSSavingsEstimationMode {
 public:
  ...
  AWS_COMPUTEOPTIMIZER_API ECSSavingsEstimationMode(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZER_API ECSSavingsEstimationMode& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline void SetSource(ECSSavingsEstimationModeSource value) {
    m_sourceHasBeenSet = true;
    m_source = value;
  }
  inline ECSSavingsEstimationMode& WithSource(ECSSavingsEstimationModeSource value) {
    SetSource(value);
    return *this;
  }
  ///@}
