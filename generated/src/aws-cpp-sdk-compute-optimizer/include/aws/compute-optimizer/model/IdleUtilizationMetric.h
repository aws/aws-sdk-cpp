...
class IdleUtilizationMetric {
 public:
  ...
  inline void SetName(IdleMetricName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline IdleUtilizationMetric& WithName(IdleMetricName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  inline IdleUtilizationMetric& WithStatistic(MetricStatistic value) {
    SetStatistic(value);
    return *this;
  }
  ///@}
  ...
  inline IdleUtilizationMetric& WithValue(double value) {
    SetValue(value);
    return *this;
  }
  ///@}
