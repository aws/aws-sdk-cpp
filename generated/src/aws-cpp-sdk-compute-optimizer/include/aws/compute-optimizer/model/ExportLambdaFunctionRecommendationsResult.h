...
namespace Model
{
  ...
  public:
    ...
    template<typename JobIdT = Aws::String>
    ExportLambdaFunctionRecommendationsResult& WithJobId(JobIdT&& value) { SetJobId(std::forward<JobIdT>(value)); return *this;}
    ///@}
    ...
    template<typename S3DestinationT = S3Destination>
    ExportLambdaFunctionRecommendationsResult& WithS3Destination(S3DestinationT&& value) { SetS3Destination(std::forward<S3DestinationT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ExportLambdaFunctionRecommendationsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
