...
class EBSSavingsOpportunityAfterDiscounts {
 public:
  ...
  inline EBSSavingsOpportunityAfterDiscounts& WithSavingsOpportunityPercentage(double value) {
  ...
  template <typename EstimatedMonthlySavingsT = EBSEstimatedMonthlySavings>
  EBSSavingsOpportunityAfterDiscounts& WithEstimatedMonthlySavings(EstimatedMonthlySavingsT&& value) {
