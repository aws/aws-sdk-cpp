...
class ExportECSServiceRecommendationsResult {
 public:
  AWS_COMPUTEOPTIMIZER_API ExportECSServiceRecommendationsResult() = default;
  AWS_COMPUTEOPTIMIZER_API ExportECSServiceRecommendationsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_COMPUTEOPTIMIZER_API ExportECSServiceRecommendationsResult& operator=(
  ...
  template <typename JobIdT = Aws::String>
  ExportECSServiceRecommendationsResult& WithJobId(JobIdT&& value) {
  ...
  template <typename S3DestinationT = S3Destination>
  ExportECSServiceRecommendationsResult& WithS3Destination(S3DestinationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ExportECSServiceRecommendationsResult& WithRequestId(RequestIdT&& value) {
