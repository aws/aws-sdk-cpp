...
namespace Model
{
  ...
  public:
    ...
    template<typename JobIdT = Aws::String>
    ExportECSServiceRecommendationsResult& WithJobId(JobIdT&& value) { SetJobId(std::forward<JobIdT>(value)); return *this;}
    ///@}
    ...
    template<typename S3DestinationT = S3Destination>
    ExportECSServiceRecommendationsResult& WithS3Destination(S3DestinationT&& value) { SetS3Destination(std::forward<S3DestinationT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ExportECSServiceRecommendationsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
