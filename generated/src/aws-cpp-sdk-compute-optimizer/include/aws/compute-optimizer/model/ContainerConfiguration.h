...
class ContainerConfiguration {
 public:
  ...
  AWS_COMPUTEOPTIMIZER_API ContainerConfiguration(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZER_API ContainerConfiguration& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline ContainerConfiguration& WithCpu(int64_t value) {
    SetCpu(value);
    return *this;
  }
  ///@}
