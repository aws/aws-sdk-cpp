...
class VolumeRecommendation {
 public:
  ...
  AWS_COMPUTEOPTIMIZER_API VolumeRecommendation(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZER_API VolumeRecommendation& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline void SetFinding(EBSFinding value) {
    m_findingHasBeenSet = true;
    m_finding = value;
  }
  inline VolumeRecommendation& WithFinding(EBSFinding value) {
    SetFinding(value);
    return *this;
  }
  ///@}
  ...
  inline VolumeRecommendation& WithLookBackPeriodInDays(double value) {
  ...
  void SetVolumeRecommendationOptions(VolumeRecommendationOptionsT&& value) {
    ...
    m_volumeRecommendationOptions = std::forward<VolumeRecommendationOptionsT>(value);
  }
  template <typename VolumeRecommendationOptionsT = Aws::Vector<VolumeRecommendationOption>>
  VolumeRecommendation& WithVolumeRecommendationOptions(VolumeRecommendationOptionsT&& value) {
    SetVolumeRecommendationOptions(std::forward<VolumeRecommendationOptionsT>(value));
    return *this;
  }
  ...
  VolumeRecommendation& AddVolumeRecommendationOptions(VolumeRecommendationOptionsT&& value) {
    m_volumeRecommendationOptionsHasBeenSet = true;
    m_volumeRecommendationOptions.emplace_back(std::forward<VolumeRecommendationOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  inline VolumeRecommendation& WithCurrentPerformanceRisk(CurrentPerformanceRisk value) {
   ...
   * </p>
   */
  inline const EBSEffectiveRecommendationPreferences& GetEffectiveRecommendationPreferences() const {
