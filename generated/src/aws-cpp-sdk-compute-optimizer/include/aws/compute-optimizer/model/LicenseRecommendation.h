...
class LicenseRecommendation {
 public:
  ...
  AWS_COMPUTEOPTIMIZER_API LicenseRecommendation(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZER_API LicenseRecommendation& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  void SetCurrentLicenseConfiguration(CurrentLicenseConfigurationT&& value) {
    ...
    m_currentLicenseConfiguration = std::forward<CurrentLicenseConfigurationT>(value);
  }
  template <typename CurrentLicenseConfigurationT = LicenseConfiguration>
  LicenseRecommendation& WithCurrentLicenseConfiguration(CurrentLicenseConfigurationT&& value) {
    SetCurrentLicenseConfiguration(std::forward<CurrentLicenseConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  inline LicenseRecommendation& WithLookbackPeriodInDays(double value) {
  ...
  inline void SetFinding(LicenseFinding value) {
    m_findingHasBeenSet = true;
    m_finding = value;
  }
  inline LicenseRecommendation& WithFinding(LicenseFinding value) {
    SetFinding(value);
    return *this;
  }
  ///@}
  ...
  inline LicenseRecommendation& AddFindingReasonCodes(LicenseFindingReasonCode value) {
    m_findingReasonCodesHasBeenSet = true;
  ...
  void SetLicenseRecommendationOptions(LicenseRecommendationOptionsT&& value) {
    ...
    m_licenseRecommendationOptions = std::forward<LicenseRecommendationOptionsT>(value);
  }
  template <typename LicenseRecommendationOptionsT = Aws::Vector<LicenseRecommendationOption>>
  LicenseRecommendation& WithLicenseRecommendationOptions(LicenseRecommendationOptionsT&& value) {
    SetLicenseRecommendationOptions(std::forward<LicenseRecommendationOptionsT>(value));
    return *this;
  }
  ...
  LicenseRecommendation& AddLicenseRecommendationOptions(LicenseRecommendationOptionsT&& value) {
    m_licenseRecommendationOptionsHasBeenSet = true;
    m_licenseRecommendationOptions.emplace_back(std::forward<LicenseRecommendationOptionsT>(value));
    return *this;
  }
  ///@}
