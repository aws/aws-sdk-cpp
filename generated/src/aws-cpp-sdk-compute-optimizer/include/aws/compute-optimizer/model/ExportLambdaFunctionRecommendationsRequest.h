...
namespace Model
{
  ...
  public:
    ...
    template<typename AccountIdsT = Aws::Vector<Aws::String>>
    ExportLambdaFunctionRecommendationsRequest& WithAccountIds(AccountIdsT&& value) { SetAccountIds(std::forward<AccountIdsT>(value)); return *this;}
    template<typename AccountIdsT = Aws::String>
    ExportLambdaFunctionRecommendationsRequest& AddAccountIds(AccountIdsT&& value) { m_accountIdsHasBeenSet = true; m_accountIds.emplace_back(std::forward<AccountIdsT>(value)); return *this; }
    ///@}
    ...
    template<typename FiltersT = Aws::Vector<LambdaFunctionRecommendationFilter>>
    ExportLambdaFunctionRecommendationsRequest& WithFilters(FiltersT&& value) { SetFilters(std::forward<FiltersT>(value)); return *this;}
    template<typename FiltersT = LambdaFunctionRecommendationFilter>
    ExportLambdaFunctionRecommendationsRequest& AddFilters(FiltersT&& value) { m_filtersHasBeenSet = true; m_filters.emplace_back(std::forward<FiltersT>(value)); return *this; }
    ///@}
    ...
    template<typename FieldsToExportT = Aws::Vector<ExportableLambdaFunctionField>>
    ...
    template<typename FieldsToExportT = Aws::Vector<ExportableLambdaFunctionField>>
    ExportLambdaFunctionRecommendationsRequest& WithFieldsToExport(FieldsToExportT&& value) { SetFieldsToExport(std::forward<FieldsToExportT>(value)); return *this;}
    inline ExportLambdaFunctionRecommendationsRequest& AddFieldsToExport(ExportableLambdaFunctionField value) { m_fieldsToExportHasBeenSet = true; m_fieldsToExport.push_back(value); return *this; }
    ///@}
    ...
    template<typename S3DestinationConfigT = S3DestinationConfig>
    ExportLambdaFunctionRecommendationsRequest& WithS3DestinationConfig(S3DestinationConfigT&& value) { SetS3DestinationConfig(std::forward<S3DestinationConfigT>(value)); return *this;}
    ///@}
    ...
    inline ExportLambdaFunctionRecommendationsRequest& WithFileFormat(FileFormat value) { SetFileFormat(value); return *this;}
    ///@}
