...
class ExportLambdaFunctionRecommendationsRequest : public ComputeOptimizerRequest {
 public:
  ...
  inline ExportLambdaFunctionRecommendationsRequest& AddFieldsToExport(ExportableLambdaFunctionField value) {
    m_fieldsToExportHasBeenSet = true;
  ...
  inline ExportLambdaFunctionRecommendationsRequest& WithFileFormat(FileFormat value) {
    SetFileFormat(value);
    return *this;
  }
  ///@}
  ...
  inline ExportLambdaFunctionRecommendationsRequest& WithIncludeMemberAccounts(bool value) {
