...
class GetAutoScalingGroupRecommendationsRequest : public ComputeOptimizerRequest {
 public:
  ...
  void SetAutoScalingGroupArns(AutoScalingGroupArnsT&& value) {
    m_autoScalingGroupArnsHasBeenSet = true;
    m_autoScalingGroupArns = std::forward<AutoScalingGroupArnsT>(value);
  }
  template <typename AutoScalingGroupArnsT = Aws::Vector<Aws::String>>
  GetAutoScalingGroupRecommendationsRequest& WithAutoScalingGroupArns(AutoScalingGroupArnsT&& value) {
    SetAutoScalingGroupArns(std::forward<AutoScalingGroupArnsT>(value));
    return *this;
  }
  ...
  GetAutoScalingGroupRecommendationsRequest& AddAutoScalingGroupArns(AutoScalingGroupArnsT&& value) {
    m_autoScalingGroupArnsHasBeenSet = true;
    m_autoScalingGroupArns.emplace_back(std::forward<AutoScalingGroupArnsT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetAutoScalingGroupRecommendationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  GetAutoScalingGroupRecommendationsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  GetAutoScalingGroupRecommendationsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
