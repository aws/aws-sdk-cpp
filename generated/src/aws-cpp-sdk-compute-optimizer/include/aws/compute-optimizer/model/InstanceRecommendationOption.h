...
class InstanceRecommendationOption {
 public:
  ...
  AWS_COMPUTEOPTIMIZER_API InstanceRecommendationOption(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZER_API InstanceRecommendationOption& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline InstanceRecommendationOption& AddPlatformDifferences(PlatformDifference value) {
    m_platformDifferencesHasBeenSet = true;
  ...
  inline InstanceRecommendationOption& WithPerformanceRisk(double value) {
  ...
  inline InstanceRecommendationOption& WithRank(int64_t value) {
    SetRank(value);
    return *this;
  }
  ///@}
   ...
   * percentage. </p>
   */
  inline const InstanceSavingsOpportunityAfterDiscounts& GetSavingsOpportunityAfterDiscounts() const {
  ...
  inline InstanceRecommendationOption& WithMigrationEffort(MigrationEffort value) {
