...
namespace ComputeOptimizer
{
   ...
   */
  class AWS_COMPUTEOPTIMIZER_API ComputeOptimizerClient : Aws::Client::ClientWithAsyncTemplateMethods<ComputeOptimizerClient>,
    smithy::client::AwsSmithyClientT<Aws::ComputeOptimizer::SERVICE_NAME,
