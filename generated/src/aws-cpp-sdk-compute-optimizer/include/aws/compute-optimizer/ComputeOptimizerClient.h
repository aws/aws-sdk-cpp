...
class AWS_COMPUTEOPTIMIZER_API ComputeOptimizerClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  ComputeOptimizerClient(const Aws::ComputeOptimizer::ComputeOptimizerClientConfiguration& clientConfiguration =
  ...
  ComputeOptimizerClient(const Aws::Auth::AWSCredentials& credentials,
                         std::shared_ptr<ComputeOptimizerEndpointProviderBase> endpointProvider = nullptr,
                         const Aws::ComputeOptimizer::ComputeOptimizerClientConfiguration& clientConfiguration =
                             Aws::ComputeOptimizer::ComputeOptimizerClientConfiguration());
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteRecommendationPreferencesOutcome DeleteRecommendationPreferences(
      const Model::DeleteRecommendationPreferencesRequest& request) const;

  /**
   * A Callable wrapper for DeleteRecommendationPreferences that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteRecommendationPreferencesRequestT = Model::DeleteRecommendationPreferencesRequest>
  Model::DeleteRecommendationPreferencesOutcomeCallable DeleteRecommendationPreferencesCallable(
      const DeleteRecommendationPreferencesRequestT& request) const {
    return SubmitCallable(&ComputeOptimizerClient::DeleteRecommendationPreferences, request);
  }

  /**
   * An Async wrapper for DeleteRecommendationPreferences that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteRecommendationPreferencesRequestT = Model::DeleteRecommendationPreferencesRequest>
  void DeleteRecommendationPreferencesAsync(const DeleteRecommendationPreferencesRequestT& request,
                                            const DeleteRecommendationPreferencesResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeRecommendationExportJobsOutcome DescribeRecommendationExportJobs(
      const Model::DescribeRecommendationExportJobsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeRecommendationExportJobs that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeRecommendationExportJobsRequestT = Model::DescribeRecommendationExportJobsRequest>
  Model::DescribeRecommendationExportJobsOutcomeCallable DescribeRecommendationExportJobsCallable(
      const DescribeRecommendationExportJobsRequestT& request = {}) const {
    return SubmitCallable(&ComputeOptimizerClient::DescribeRecommendationExportJobs, request);
  }

  /**
   * An Async wrapper for DescribeRecommendationExportJobs that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeRecommendationExportJobsRequestT = Model::DescribeRecommendationExportJobsRequest>
  void DescribeRecommendationExportJobsAsync(const DescribeRecommendationExportJobsResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::ExportAutoScalingGroupRecommendationsOutcome ExportAutoScalingGroupRecommendations(
      const Model::ExportAutoScalingGroupRecommendationsRequest& request) const;

  /**
   * A Callable wrapper for ExportAutoScalingGroupRecommendations that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ExportAutoScalingGroupRecommendationsRequestT = Model::ExportAutoScalingGroupRecommendationsRequest>
  Model::ExportAutoScalingGroupRecommendationsOutcomeCallable ExportAutoScalingGroupRecommendationsCallable(
      const ExportAutoScalingGroupRecommendationsRequestT& request) const {
    return SubmitCallable(&ComputeOptimizerClient::ExportAutoScalingGroupRecommendations, request);
  }

  /**
   * An Async wrapper for ExportAutoScalingGroupRecommendations that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ExportAutoScalingGroupRecommendationsRequestT = Model::ExportAutoScalingGroupRecommendationsRequest>
  void ExportAutoScalingGroupRecommendationsAsync(const ExportAutoScalingGroupRecommendationsRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::ExportEBSVolumeRecommendationsOutcome ExportEBSVolumeRecommendations(
      const Model::ExportEBSVolumeRecommendationsRequest& request) const;

  /**
   * A Callable wrapper for ExportEBSVolumeRecommendations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ExportEBSVolumeRecommendationsRequestT = Model::ExportEBSVolumeRecommendationsRequest>
  Model::ExportEBSVolumeRecommendationsOutcomeCallable ExportEBSVolumeRecommendationsCallable(
      const ExportEBSVolumeRecommendationsRequestT& request) const {
    return SubmitCallable(&ComputeOptimizerClient::ExportEBSVolumeRecommendations, request);
  }

  /**
   * An Async wrapper for ExportEBSVolumeRecommendations that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ExportEBSVolumeRecommendationsRequestT = Model::ExportEBSVolumeRecommendationsRequest>
  void ExportEBSVolumeRecommendationsAsync(const ExportEBSVolumeRecommendationsRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::ExportEC2InstanceRecommendationsOutcome ExportEC2InstanceRecommendations(
      const Model::ExportEC2InstanceRecommendationsRequest& request) const;

  /**
   * A Callable wrapper for ExportEC2InstanceRecommendations that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ExportEC2InstanceRecommendationsRequestT = Model::ExportEC2InstanceRecommendationsRequest>
  Model::ExportEC2InstanceRecommendationsOutcomeCallable ExportEC2InstanceRecommendationsCallable(
      const ExportEC2InstanceRecommendationsRequestT& request) const {
    return SubmitCallable(&ComputeOptimizerClient::ExportEC2InstanceRecommendations, request);
  }

  /**
   * An Async wrapper for ExportEC2InstanceRecommendations that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ExportEC2InstanceRecommendationsRequestT = Model::ExportEC2InstanceRecommendationsRequest>
  void ExportEC2InstanceRecommendationsAsync(const ExportEC2InstanceRecommendationsRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::ExportECSServiceRecommendationsOutcome ExportECSServiceRecommendations(
      const Model::ExportECSServiceRecommendationsRequest& request) const;

  /**
   * A Callable wrapper for ExportECSServiceRecommendations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ExportECSServiceRecommendationsRequestT = Model::ExportECSServiceRecommendationsRequest>
  Model::ExportECSServiceRecommendationsOutcomeCallable ExportECSServiceRecommendationsCallable(
      const ExportECSServiceRecommendationsRequestT& request) const {
    return SubmitCallable(&ComputeOptimizerClient::ExportECSServiceRecommendations, request);
  }

  /**
   * An Async wrapper for ExportECSServiceRecommendations that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ExportECSServiceRecommendationsRequestT = Model::ExportECSServiceRecommendationsRequest>
  void ExportECSServiceRecommendationsAsync(const ExportECSServiceRecommendationsRequestT& request,
                                            const ExportECSServiceRecommendationsResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ExportIdleRecommendations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ExportIdleRecommendationsRequestT = Model::ExportIdleRecommendationsRequest>
  Model::ExportIdleRecommendationsOutcomeCallable ExportIdleRecommendationsCallable(
      const ExportIdleRecommendationsRequestT& request) const {
    return SubmitCallable(&ComputeOptimizerClient::ExportIdleRecommendations, request);
  }

  /**
   * An Async wrapper for ExportIdleRecommendations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ExportIdleRecommendationsRequestT = Model::ExportIdleRecommendationsRequest>
  void ExportIdleRecommendationsAsync(const ExportIdleRecommendationsRequestT& request,
                                      const ExportIdleRecommendationsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ExportLambdaFunctionRecommendationsOutcome ExportLambdaFunctionRecommendations(
      const Model::ExportLambdaFunctionRecommendationsRequest& request) const;

  /**
   * A Callable wrapper for ExportLambdaFunctionRecommendations that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ExportLambdaFunctionRecommendationsRequestT = Model::ExportLambdaFunctionRecommendationsRequest>
  Model::ExportLambdaFunctionRecommendationsOutcomeCallable ExportLambdaFunctionRecommendationsCallable(
      const ExportLambdaFunctionRecommendationsRequestT& request) const {
    return SubmitCallable(&ComputeOptimizerClient::ExportLambdaFunctionRecommendations, request);
  }

  /**
   * An Async wrapper for ExportLambdaFunctionRecommendations that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ExportLambdaFunctionRecommendationsRequestT = Model::ExportLambdaFunctionRecommendationsRequest>
  void ExportLambdaFunctionRecommendationsAsync(const ExportLambdaFunctionRecommendationsRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::ExportLicenseRecommendationsOutcome ExportLicenseRecommendations(
      const Model::ExportLicenseRecommendationsRequest& request) const;

  /**
   * A Callable wrapper for ExportLicenseRecommendations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ExportLicenseRecommendationsRequestT = Model::ExportLicenseRecommendationsRequest>
  Model::ExportLicenseRecommendationsOutcomeCallable ExportLicenseRecommendationsCallable(
      const ExportLicenseRecommendationsRequestT& request) const {
    return SubmitCallable(&ComputeOptimizerClient::ExportLicenseRecommendations, request);
  }

  /**
   * An Async wrapper for ExportLicenseRecommendations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ExportLicenseRecommendationsRequestT = Model::ExportLicenseRecommendationsRequest>
  void ExportLicenseRecommendationsAsync(const ExportLicenseRecommendationsRequestT& request,
                                         const ExportLicenseRecommendationsResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ExportRDSDatabaseRecommendationsOutcome ExportRDSDatabaseRecommendations(
      const Model::ExportRDSDatabaseRecommendationsRequest& request) const;

  /**
   * A Callable wrapper for ExportRDSDatabaseRecommendations that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ExportRDSDatabaseRecommendationsRequestT = Model::ExportRDSDatabaseRecommendationsRequest>
  Model::ExportRDSDatabaseRecommendationsOutcomeCallable ExportRDSDatabaseRecommendationsCallable(
      const ExportRDSDatabaseRecommendationsRequestT& request) const {
    return SubmitCallable(&ComputeOptimizerClient::ExportRDSDatabaseRecommendations, request);
  }

  /**
   * An Async wrapper for ExportRDSDatabaseRecommendations that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ExportRDSDatabaseRecommendationsRequestT = Model::ExportRDSDatabaseRecommendationsRequest>
  void ExportRDSDatabaseRecommendationsAsync(const ExportRDSDatabaseRecommendationsRequestT& request,
                                             const ExportRDSDatabaseRecommendationsResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetAutoScalingGroupRecommendationsOutcome GetAutoScalingGroupRecommendations(
      const Model::GetAutoScalingGroupRecommendationsRequest& request = {}) const;

  /**
   * A Callable wrapper for GetAutoScalingGroupRecommendations that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename GetAutoScalingGroupRecommendationsRequestT = Model::GetAutoScalingGroupRecommendationsRequest>
  Model::GetAutoScalingGroupRecommendationsOutcomeCallable GetAutoScalingGroupRecommendationsCallable(
      const GetAutoScalingGroupRecommendationsRequestT& request = {}) const {
    return SubmitCallable(&ComputeOptimizerClient::GetAutoScalingGroupRecommendations, request);
  }

  /**
   * An Async wrapper for GetAutoScalingGroupRecommendations that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetAutoScalingGroupRecommendationsRequestT = Model::GetAutoScalingGroupRecommendationsRequest>
  void GetAutoScalingGroupRecommendationsAsync(const GetAutoScalingGroupRecommendationsResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                               const GetAutoScalingGroupRecommendationsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetEBSVolumeRecommendationsOutcome GetEBSVolumeRecommendations(
      const Model::GetEBSVolumeRecommendationsRequest& request = {}) const;

  /**
   * A Callable wrapper for GetEBSVolumeRecommendations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetEBSVolumeRecommendationsRequestT = Model::GetEBSVolumeRecommendationsRequest>
  Model::GetEBSVolumeRecommendationsOutcomeCallable GetEBSVolumeRecommendationsCallable(
      const GetEBSVolumeRecommendationsRequestT& request = {}) const {
    return SubmitCallable(&ComputeOptimizerClient::GetEBSVolumeRecommendations, request);
  }

  /**
   * An Async wrapper for GetEBSVolumeRecommendations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetEBSVolumeRecommendationsRequestT = Model::GetEBSVolumeRecommendationsRequest>
  void GetEBSVolumeRecommendationsAsync(const GetEBSVolumeRecommendationsResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                        const GetEBSVolumeRecommendationsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetEC2InstanceRecommendationsOutcome GetEC2InstanceRecommendations(
      const Model::GetEC2InstanceRecommendationsRequest& request = {}) const;

  /**
   * A Callable wrapper for GetEC2InstanceRecommendations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetEC2InstanceRecommendationsRequestT = Model::GetEC2InstanceRecommendationsRequest>
  Model::GetEC2InstanceRecommendationsOutcomeCallable GetEC2InstanceRecommendationsCallable(
      const GetEC2InstanceRecommendationsRequestT& request = {}) const {
    return SubmitCallable(&ComputeOptimizerClient::GetEC2InstanceRecommendations, request);
  }

  /**
   * An Async wrapper for GetEC2InstanceRecommendations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetEC2InstanceRecommendationsRequestT = Model::GetEC2InstanceRecommendationsRequest>
  void GetEC2InstanceRecommendationsAsync(const GetEC2InstanceRecommendationsResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                          const GetEC2InstanceRecommendationsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetEC2RecommendationProjectedMetricsOutcome GetEC2RecommendationProjectedMetrics(
      const Model::GetEC2RecommendationProjectedMetricsRequest& request) const;

  /**
   * A Callable wrapper for GetEC2RecommendationProjectedMetrics that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename GetEC2RecommendationProjectedMetricsRequestT = Model::GetEC2RecommendationProjectedMetricsRequest>
  Model::GetEC2RecommendationProjectedMetricsOutcomeCallable GetEC2RecommendationProjectedMetricsCallable(
      const GetEC2RecommendationProjectedMetricsRequestT& request) const {
    return SubmitCallable(&ComputeOptimizerClient::GetEC2RecommendationProjectedMetrics, request);
  }

  /**
   * An Async wrapper for GetEC2RecommendationProjectedMetrics that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetEC2RecommendationProjectedMetricsRequestT = Model::GetEC2RecommendationProjectedMetricsRequest>
  void GetEC2RecommendationProjectedMetricsAsync(const GetEC2RecommendationProjectedMetricsRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetECSServiceRecommendationProjectedMetricsOutcome GetECSServiceRecommendationProjectedMetrics(
      const Model::GetECSServiceRecommendationProjectedMetricsRequest& request) const;

  /**
   * A Callable wrapper for GetECSServiceRecommendationProjectedMetrics that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  ...
  Model::GetECSServiceRecommendationProjectedMetricsOutcomeCallable GetECSServiceRecommendationProjectedMetricsCallable(
      const GetECSServiceRecommendationProjectedMetricsRequestT& request) const {
    return SubmitCallable(&ComputeOptimizerClient::GetECSServiceRecommendationProjectedMetrics, request);
  }

  /**
   * An Async wrapper for GetECSServiceRecommendationProjectedMetrics that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetECSServiceRecommendationProjectedMetricsRequestT = Model::GetECSServiceRecommendationProjectedMetricsRequest>
  void GetECSServiceRecommendationProjectedMetricsAsync(
      const GetECSServiceRecommendationProjectedMetricsRequestT& request,
      const GetECSServiceRecommendationProjectedMetricsResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetECSServiceRecommendationsOutcome GetECSServiceRecommendations(
      const Model::GetECSServiceRecommendationsRequest& request = {}) const;

  /**
   * A Callable wrapper for GetECSServiceRecommendations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetECSServiceRecommendationsRequestT = Model::GetECSServiceRecommendationsRequest>
  Model::GetECSServiceRecommendationsOutcomeCallable GetECSServiceRecommendationsCallable(
      const GetECSServiceRecommendationsRequestT& request = {}) const {
    return SubmitCallable(&ComputeOptimizerClient::GetECSServiceRecommendations, request);
  }

  /**
   * An Async wrapper for GetECSServiceRecommendations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetECSServiceRecommendationsRequestT = Model::GetECSServiceRecommendationsRequest>
  void GetECSServiceRecommendationsAsync(const GetECSServiceRecommendationsResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                         const GetECSServiceRecommendationsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetEffectiveRecommendationPreferencesOutcome GetEffectiveRecommendationPreferences(
      const Model::GetEffectiveRecommendationPreferencesRequest& request) const;

  /**
   * A Callable wrapper for GetEffectiveRecommendationPreferences that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename GetEffectiveRecommendationPreferencesRequestT = Model::GetEffectiveRecommendationPreferencesRequest>
  Model::GetEffectiveRecommendationPreferencesOutcomeCallable GetEffectiveRecommendationPreferencesCallable(
      const GetEffectiveRecommendationPreferencesRequestT& request) const {
    return SubmitCallable(&ComputeOptimizerClient::GetEffectiveRecommendationPreferences, request);
  }

  /**
   * An Async wrapper for GetEffectiveRecommendationPreferences that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetEffectiveRecommendationPreferencesRequestT = Model::GetEffectiveRecommendationPreferencesRequest>
  void GetEffectiveRecommendationPreferencesAsync(const GetEffectiveRecommendationPreferencesRequestT& request,
                                                  const GetEffectiveRecommendationPreferencesResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetEnrollmentStatus that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetEnrollmentStatus that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetEnrollmentStatusRequestT = Model::GetEnrollmentStatusRequest>
  void GetEnrollmentStatusAsync(const GetEnrollmentStatusResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const GetEnrollmentStatusRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetEnrollmentStatusesForOrganizationOutcome GetEnrollmentStatusesForOrganization(
      const Model::GetEnrollmentStatusesForOrganizationRequest& request = {}) const;

  /**
   * A Callable wrapper for GetEnrollmentStatusesForOrganization that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename GetEnrollmentStatusesForOrganizationRequestT = Model::GetEnrollmentStatusesForOrganizationRequest>
  Model::GetEnrollmentStatusesForOrganizationOutcomeCallable GetEnrollmentStatusesForOrganizationCallable(
      const GetEnrollmentStatusesForOrganizationRequestT& request = {}) const {
    return SubmitCallable(&ComputeOptimizerClient::GetEnrollmentStatusesForOrganization, request);
  }

  /**
   * An Async wrapper for GetEnrollmentStatusesForOrganization that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetEnrollmentStatusesForOrganizationRequestT = Model::GetEnrollmentStatusesForOrganizationRequest>
  void GetEnrollmentStatusesForOrganizationAsync(const GetEnrollmentStatusesForOrganizationResponseReceivedHandler& handler,
                                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                 const GetEnrollmentStatusesForOrganizationRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetIdleRecommendations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetIdleRecommendations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetIdleRecommendationsRequestT = Model::GetIdleRecommendationsRequest>
  void GetIdleRecommendationsAsync(const GetIdleRecommendationsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const GetIdleRecommendationsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetLambdaFunctionRecommendationsOutcome GetLambdaFunctionRecommendations(
      const Model::GetLambdaFunctionRecommendationsRequest& request = {}) const;

  /**
   * A Callable wrapper for GetLambdaFunctionRecommendations that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename GetLambdaFunctionRecommendationsRequestT = Model::GetLambdaFunctionRecommendationsRequest>
  Model::GetLambdaFunctionRecommendationsOutcomeCallable GetLambdaFunctionRecommendationsCallable(
      const GetLambdaFunctionRecommendationsRequestT& request = {}) const {
    return SubmitCallable(&ComputeOptimizerClient::GetLambdaFunctionRecommendations, request);
  }

  /**
   * An Async wrapper for GetLambdaFunctionRecommendations that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetLambdaFunctionRecommendationsRequestT = Model::GetLambdaFunctionRecommendationsRequest>
  void GetLambdaFunctionRecommendationsAsync(const GetLambdaFunctionRecommendationsResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                             const GetLambdaFunctionRecommendationsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetLicenseRecommendationsOutcome GetLicenseRecommendations(
      const Model::GetLicenseRecommendationsRequest& request = {}) const;

  /**
   * A Callable wrapper for GetLicenseRecommendations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename GetLicenseRecommendationsRequestT = Model::GetLicenseRecommendationsRequest>
  Model::GetLicenseRecommendationsOutcomeCallable GetLicenseRecommendationsCallable(
      const GetLicenseRecommendationsRequestT& request = {}) const {
    return SubmitCallable(&ComputeOptimizerClient::GetLicenseRecommendations, request);
  }

  /**
   * An Async wrapper for GetLicenseRecommendations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetLicenseRecommendationsRequestT = Model::GetLicenseRecommendationsRequest>
  void GetLicenseRecommendationsAsync(const GetLicenseRecommendationsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const GetLicenseRecommendationsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetRDSDatabaseRecommendationProjectedMetricsOutcome GetRDSDatabaseRecommendationProjectedMetrics(
      const Model::GetRDSDatabaseRecommendationProjectedMetricsRequest& request) const;

  /**
   * A Callable wrapper for GetRDSDatabaseRecommendationProjectedMetrics that returns a future to the operation so that it can be executed
  ...
  Model::GetRDSDatabaseRecommendationProjectedMetricsOutcomeCallable GetRDSDatabaseRecommendationProjectedMetricsCallable(
      const GetRDSDatabaseRecommendationProjectedMetricsRequestT& request) const {
    return SubmitCallable(&ComputeOptimizerClient::GetRDSDatabaseRecommendationProjectedMetrics, request);
  }

  /**
   * An Async wrapper for GetRDSDatabaseRecommendationProjectedMetrics that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename GetRDSDatabaseRecommendationProjectedMetricsRequestT = Model::GetRDSDatabaseRecommendationProjectedMetricsRequest>
  void GetRDSDatabaseRecommendationProjectedMetricsAsync(
      const GetRDSDatabaseRecommendationProjectedMetricsRequestT& request,
      const GetRDSDatabaseRecommendationProjectedMetricsResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetRDSDatabaseRecommendationsOutcome GetRDSDatabaseRecommendations(
      const Model::GetRDSDatabaseRecommendationsRequest& request = {}) const;

  /**
   * A Callable wrapper for GetRDSDatabaseRecommendations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetRDSDatabaseRecommendationsRequestT = Model::GetRDSDatabaseRecommendationsRequest>
  Model::GetRDSDatabaseRecommendationsOutcomeCallable GetRDSDatabaseRecommendationsCallable(
      const GetRDSDatabaseRecommendationsRequestT& request = {}) const {
    return SubmitCallable(&ComputeOptimizerClient::GetRDSDatabaseRecommendations, request);
  }

  /**
   * An Async wrapper for GetRDSDatabaseRecommendations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetRDSDatabaseRecommendationsRequestT = Model::GetRDSDatabaseRecommendationsRequest>
  void GetRDSDatabaseRecommendationsAsync(const GetRDSDatabaseRecommendationsResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                          const GetRDSDatabaseRecommendationsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetRecommendationPreferencesOutcome GetRecommendationPreferences(
      const Model::GetRecommendationPreferencesRequest& request) const;

  /**
   * A Callable wrapper for GetRecommendationPreferences that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetRecommendationPreferencesRequestT = Model::GetRecommendationPreferencesRequest>
  Model::GetRecommendationPreferencesOutcomeCallable GetRecommendationPreferencesCallable(
      const GetRecommendationPreferencesRequestT& request) const {
    return SubmitCallable(&ComputeOptimizerClient::GetRecommendationPreferences, request);
  }

  /**
   * An Async wrapper for GetRecommendationPreferences that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetRecommendationPreferencesRequestT = Model::GetRecommendationPreferencesRequest>
  void GetRecommendationPreferencesAsync(const GetRecommendationPreferencesRequestT& request,
                                         const GetRecommendationPreferencesResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetRecommendationSummariesOutcome GetRecommendationSummaries(
      const Model::GetRecommendationSummariesRequest& request = {}) const;

  /**
   * A Callable wrapper for GetRecommendationSummaries that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetRecommendationSummariesRequestT = Model::GetRecommendationSummariesRequest>
  Model::GetRecommendationSummariesOutcomeCallable GetRecommendationSummariesCallable(
      const GetRecommendationSummariesRequestT& request = {}) const {
    return SubmitCallable(&ComputeOptimizerClient::GetRecommendationSummaries, request);
  }

  /**
   * An Async wrapper for GetRecommendationSummaries that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetRecommendationSummariesRequestT = Model::GetRecommendationSummariesRequest>
  void GetRecommendationSummariesAsync(const GetRecommendationSummariesResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const GetRecommendationSummariesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::PutRecommendationPreferencesOutcome PutRecommendationPreferences(
      const Model::PutRecommendationPreferencesRequest& request) const;

  /**
   * A Callable wrapper for PutRecommendationPreferences that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PutRecommendationPreferencesRequestT = Model::PutRecommendationPreferencesRequest>
  Model::PutRecommendationPreferencesOutcomeCallable PutRecommendationPreferencesCallable(
      const PutRecommendationPreferencesRequestT& request) const {
    return SubmitCallable(&ComputeOptimizerClient::PutRecommendationPreferences, request);
  }

  /**
   * An Async wrapper for PutRecommendationPreferences that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutRecommendationPreferencesRequestT = Model::PutRecommendationPreferencesRequest>
  void PutRecommendationPreferencesAsync(const PutRecommendationPreferencesRequestT& request,
                                         const PutRecommendationPreferencesResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
