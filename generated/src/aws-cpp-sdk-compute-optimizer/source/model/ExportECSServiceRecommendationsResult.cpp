...
ExportECSServiceRecommendationsResult& ExportECSServiceRecommendationsResult::operator=(
    const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result) {
          ...
          for (size_t i = 0; i < mapSize.value(); ++i) {
            ...
            if (initialKey.has_value()) {
              ...
              if ((decoder->LastError() != AWS_ERROR_UNKNOWN)) {
                AWS_LOG_ERROR("ExportECSServiceRecommendationsResult", "Invalid data received for %s", initialKeyStr.c_str());
                break;
              }
            }
          }
