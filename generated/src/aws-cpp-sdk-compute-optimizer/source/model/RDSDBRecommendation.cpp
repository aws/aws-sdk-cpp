...
RDSDBRecommendation::RDSDBRecommendation(JsonView jsonValue) { *this = jsonValue; }
...
RDSDBRecommendation& RDSDBRecommendation::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("instanceFindingReasonCodes")) {
    ...
    for (unsigned instanceFindingReasonCodesIndex = 0; instanceFindingReasonCodesIndex < instanceFindingReasonCodesJsonList.GetLength();
         ++instanceFindingReasonCodesIndex) {
      m_instanceFindingReasonCodes.push_back(RDSInstanceFindingReasonCodeMapper::GetRDSInstanceFindingReasonCodeForName(
          instanceFindingReasonCodesJsonList[instanceFindingReasonCodesIndex].AsString()));
    }
  ...
  if (jsonValue.ValueExists("currentInstancePerformanceRisk")) {
    m_currentInstancePerformanceRisk = RDSCurrentInstancePerformanceRiskMapper::GetRDSCurrentInstancePerformanceRiskForName(
        jsonValue.GetString("currentInstancePerformanceRisk"));
  ...
  if (jsonValue.ValueExists("currentStorageEstimatedMonthlyVolumeIOPsCostVariation")) {
    m_currentStorageEstimatedMonthlyVolumeIOPsCostVariation =
        RDSEstimatedMonthlyVolumeIOPsCostVariationMapper::GetRDSEstimatedMonthlyVolumeIOPsCostVariationForName(
            jsonValue.GetString("currentStorageEstimatedMonthlyVolumeIOPsCostVariation"));
  ...
  if (jsonValue.ValueExists("storageFindingReasonCodes")) {
    ...
    for (unsigned storageFindingReasonCodesIndex = 0; storageFindingReasonCodesIndex < storageFindingReasonCodesJsonList.GetLength();
         ++storageFindingReasonCodesIndex) {
      m_storageFindingReasonCodes.push_back(RDSStorageFindingReasonCodeMapper::GetRDSStorageFindingReasonCodeForName(
          storageFindingReasonCodesJsonList[storageFindingReasonCodesIndex].AsString()));
    }
  ...
  if (jsonValue.ValueExists("instanceRecommendationOptions")) {
    ...
    for (unsigned instanceRecommendationOptionsIndex = 0;
         instanceRecommendationOptionsIndex < instanceRecommendationOptionsJsonList.GetLength(); ++instanceRecommendationOptionsIndex) {
  ...
  if (jsonValue.ValueExists("storageRecommendationOptions")) {
    ...
    for (unsigned storageRecommendationOptionsIndex = 0;
         storageRecommendationOptionsIndex < storageRecommendationOptionsJsonList.GetLength(); ++storageRecommendationOptionsIndex) {
...
JsonValue RDSDBRecommendation::Jsonize() const {
  ...
  if (m_instanceFindingReasonCodesHasBeenSet) {
    ...
    for (unsigned instanceFindingReasonCodesIndex = 0; instanceFindingReasonCodesIndex < instanceFindingReasonCodesJsonList.GetLength();
         ++instanceFindingReasonCodesIndex) {
      instanceFindingReasonCodesJsonList[instanceFindingReasonCodesIndex].AsString(
          RDSInstanceFindingReasonCodeMapper::GetNameForRDSInstanceFindingReasonCode(
              m_instanceFindingReasonCodes[instanceFindingReasonCodesIndex]));
    }
  ...
  if (m_currentInstancePerformanceRiskHasBeenSet) {
    payload.WithString(
        ...
        RDSCurrentInstancePerformanceRiskMapper::GetNameForRDSCurrentInstancePerformanceRisk(m_currentInstancePerformanceRisk));
  }

  if (m_currentStorageEstimatedMonthlyVolumeIOPsCostVariationHasBeenSet) {
    payload.WithString("currentStorageEstimatedMonthlyVolumeIOPsCostVariation",
  ...
  if (m_storageFindingReasonCodesHasBeenSet) {
    ...
    for (unsigned storageFindingReasonCodesIndex = 0; storageFindingReasonCodesIndex < storageFindingReasonCodesJsonList.GetLength();
         ++storageFindingReasonCodesIndex) {
      storageFindingReasonCodesJsonList[storageFindingReasonCodesIndex].AsString(
          RDSStorageFindingReasonCodeMapper::GetNameForRDSStorageFindingReasonCode(
              m_storageFindingReasonCodes[storageFindingReasonCodesIndex]));
    }
  ...
  if (m_instanceRecommendationOptionsHasBeenSet) {
    ...
    for (unsigned instanceRecommendationOptionsIndex = 0;
         instanceRecommendationOptionsIndex < instanceRecommendationOptionsJsonList.GetLength(); ++instanceRecommendationOptionsIndex) {
      instanceRecommendationOptionsJsonList[instanceRecommendationOptionsIndex].AsObject(
          m_instanceRecommendationOptions[instanceRecommendationOptionsIndex].Jsonize());
    }
  ...
  if (m_storageRecommendationOptionsHasBeenSet) {
    ...
    for (unsigned storageRecommendationOptionsIndex = 0;
         storageRecommendationOptionsIndex < storageRecommendationOptionsJsonList.GetLength(); ++storageRecommendationOptionsIndex) {
      storageRecommendationOptionsJsonList[storageRecommendationOptionsIndex].AsObject(
          m_storageRecommendationOptions[storageRecommendationOptionsIndex].Jsonize());
    }
