...
ExportLambdaFunctionRecommendationsResult& ExportLambdaFunctionRecommendationsResult::operator=(
    const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result) {
        ...
        if (mapSize.has_value()) {
          for (size_t i = 0; i < mapSize.value(); ++i) {
            ...
            if (initialKey.has_value()) {
              ...
              else if (initialKeyStr == "s3Destination") {
                m_s3Destination = S3Destination(decoder);
              ...
              if ((decoder->LastError() != AWS_ERROR_UNKNOWN)) {
                AWS_LOG_ERROR("ExportLambdaFunctionRecommendationsResult", "Invalid data received for %s", initialKeyStr.c_str());
                break;
              }
            }
          }
