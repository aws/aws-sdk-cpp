...
RDSEffectiveRecommendationPreferences::RDSEffectiveRecommendationPreferences(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder) {
  *this = decoder;
}

RDSEffectiveRecommendationPreferences& RDSEffectiveRecommendationPreferences::operator=(
          ...
          for (size_t i = 0; i < mapSize.value(); ++i) {
            ...
            if (initialKey.has_value()) {
              ...
              if (initialKeyStr == "cpuVendorArchitectures") {
                ...
                m_savingsEstimationMode = RDSSavingsEstimationMode(decoder);
              ...
              if ((decoder->LastError() != AWS_ERROR_UNKNOWN)) {
                AWS_LOG_ERROR("RDSEffectiveRecommendationPreferences", "Invalid data received for %s", initialKeyStr.c_str());
                break;
              }
            }
          }
...
void RDSEffectiveRecommendationPreferences::CborEncode(Aws::Crt::Cbor::CborEncoder& encoder) const {
  // Calculate map size
  size_t mapSize = 0;
