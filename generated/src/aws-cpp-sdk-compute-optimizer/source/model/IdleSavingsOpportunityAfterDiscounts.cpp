...
IdleSavingsOpportunityAfterDiscounts::IdleSavingsOpportunityAfterDiscounts(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder) {
  *this = decoder;
}

IdleSavingsOpportunityAfterDiscounts& IdleSavingsOpportunityAfterDiscounts::operator=(
          ...
          for (size_t i = 0; i < mapSize.value(); ++i) {
            ...
            if (initialKey.has_value()) {
              ...
              if (initialKeyStr == "savingsOpportunityPercentage") {
                ...
                m_estimatedMonthlySavings = IdleEstimatedMonthlySavings(decoder);
              ...
              if ((decoder->LastError() != AWS_ERROR_UNKNOWN)) {
                AWS_LOG_ERROR("IdleSavingsOpportunityAfterDiscounts", "Invalid data received for %s", initialKeyStr.c_str());
                break;
              }
            }
          }
...
void IdleSavingsOpportunityAfterDiscounts::CborEncode(Aws::Crt::Cbor::CborEncoder& encoder) const {
  // Calculate map size
  size_t mapSize = 0;
