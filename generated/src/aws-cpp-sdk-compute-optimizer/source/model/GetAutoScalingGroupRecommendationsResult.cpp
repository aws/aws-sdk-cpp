...
GetAutoScalingGroupRecommendationsResult& GetAutoScalingGroupRecommendationsResult::operator=(
  ...
  if (jsonValue.ValueExists("autoScalingGroupRecommendations")) {
    ...
    for (unsigned autoScalingGroupRecommendationsIndex = 0;
         autoScalingGroupRecommendationsIndex < autoScalingGroupRecommendationsJsonList.GetLength();
         ++autoScalingGroupRecommendationsIndex) {
