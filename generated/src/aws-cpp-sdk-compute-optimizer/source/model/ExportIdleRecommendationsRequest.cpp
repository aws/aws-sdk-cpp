...
ExportIdleRecommendationsRequest::ExportIdleRecommendationsRequest() : 
...
Aws::String ExportIdleRecommendationsRequest::SerializePayload() const
{
  JsonValue payload;
  ...
  if(m_fieldsToExportHasBeenSet)
  {
   ...
   {
     fieldsToExportJsonList[fieldsToExportIndex].AsString(ExportableIdleFieldMapper::GetNameForExportableIdleField(m_fieldsToExport[fieldsToExportIndex]));
   }
...
Aws::Http::HeaderValueCollection ExportIdleRecommendationsRequest::GetRequestSpecificHeaders() const
{
  Aws::Http::HeaderValueCollection headers;
  headers.insert(Aws::Http::HeaderValuePair("X-Amz-Target", "ComputeOptimizerService.ExportIdleRecommendations"));
  return headers;
