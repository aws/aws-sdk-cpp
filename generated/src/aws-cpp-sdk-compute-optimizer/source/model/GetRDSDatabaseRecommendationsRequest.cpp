...
Aws::Http::HeaderValueCollection GetRDSDatabaseRecommendationsRequest::GetRequestSpecificHeaders() const
{
  Aws::Http::HeaderValueCollection headers;
  headers.insert(Aws::Http::HeaderValuePair("X-Amz-Target", "ComputeOptimizerService.GetRDSDatabaseRecommendations"));
  return headers;
