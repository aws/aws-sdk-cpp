...
Aws::Http::HeaderValueCollection GetLicenseRecommendationsRequest::GetRequestSpecificHeaders() const
{
  Aws::Http::HeaderValueCollection headers;
  headers.insert(Aws::Http::HeaderValuePair("X-Amz-Target", "ComputeOptimizerService.GetLicenseRecommendations"));
  return headers;
