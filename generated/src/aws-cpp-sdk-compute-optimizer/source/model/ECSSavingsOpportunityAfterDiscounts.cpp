...
ECSSavingsOpportunityAfterDiscounts::ECSSavingsOpportunityAfterDiscounts(JsonView jsonValue) { *this = jsonValue; }

ECSSavingsOpportunityAfterDiscounts& ECSSavingsOpportunityAfterDiscounts::operator=(JsonView jsonValue) {
...
JsonValue ECSSavingsOpportunityAfterDiscounts::Jsonize() const {
  JsonValue payload;
