...
GetRecommendationPreferencesResult& GetRecommendationPreferencesResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("recommendationPreferencesDetails")) {
    ...
    for (unsigned recommendationPreferencesDetailsIndex = 0;
         recommendationPreferencesDetailsIndex < recommendationPreferencesDetailsJsonList.GetLength();
         ++recommendationPreferencesDetailsIndex) {
      m_recommendationPreferencesDetails.push_back(
          recommendationPreferencesDetailsJsonList[recommendationPreferencesDetailsIndex].AsObject());
    }
