...
GetLicenseRecommendationsResult::GetLicenseRecommendationsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
GetLicenseRecommendationsResult& GetLicenseRecommendationsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("licenseRecommendations")) {
    ...
    for (unsigned licenseRecommendationsIndex = 0; licenseRecommendationsIndex < licenseRecommendationsJsonList.GetLength();
         ++licenseRecommendationsIndex) {
