...
GetLambdaFunctionRecommendationsResult& GetLambdaFunctionRecommendationsResult::operator=(
  ...
  if (jsonValue.ValueExists("lambdaFunctionRecommendations")) {
    ...
    for (unsigned lambdaFunctionRecommendationsIndex = 0;
         lambdaFunctionRecommendationsIndex < lambdaFunctionRecommendationsJsonList.GetLength(); ++lambdaFunctionRecommendationsIndex) {
