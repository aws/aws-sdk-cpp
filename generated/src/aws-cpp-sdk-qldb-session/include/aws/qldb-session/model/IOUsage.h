...
class IOUsage {
 public:
  ...
  inline void SetReadIOs(long long value) {
    m_readIOsHasBeenSet = true;
    m_readIOs = value;
  }
  inline IOUsage& WithReadIOs(long long value) {
    SetReadIOs(value);
    return *this;
  }
  ///@}
  ...
  inline void SetWriteIOs(long long value) {
    m_writeIOsHasBeenSet = true;
    m_writeIOs = value;
  }
  inline IOUsage& WithWriteIOs(long long value) {
    SetWriteIOs(value);
    return *this;
  }
  ///@}
