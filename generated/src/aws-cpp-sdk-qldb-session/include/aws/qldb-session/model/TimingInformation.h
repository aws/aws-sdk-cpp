...
class TimingInformation {
 public:
  ...
  inline void SetProcessingTimeMilliseconds(long long value) {
    m_processingTimeMillisecondsHasBeenSet = true;
    m_processingTimeMilliseconds = value;
  }
  inline TimingInformation& WithProcessingTimeMilliseconds(long long value) {
    SetProcessingTimeMilliseconds(value);
    return *this;
  }
  ///@}
 private:
