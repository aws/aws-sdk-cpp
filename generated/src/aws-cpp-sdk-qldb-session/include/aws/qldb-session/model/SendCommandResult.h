...
class SendCommandResult {
 public:
  ...
  template <typename StartSessionT = StartSessionResult>
  SendCommandResult& WithStartSession(StartSessionT&& value) {
  ...
  template <typename StartTransactionT = StartTransactionResult>
  SendCommandResult& WithStartTransaction(StartTransactionT&& value) {
  ...
  template <typename EndSessionT = EndSessionResult>
  SendCommandResult& WithEndSession(EndSessionT&& value) {
  ...
  template <typename CommitTransactionT = CommitTransactionResult>
  SendCommandResult& WithCommitTransaction(CommitTransactionT&& value) {
  ...
  template <typename AbortTransactionT = AbortTransactionResult>
  SendCommandResult& WithAbortTransaction(AbortTransactionT&& value) {
  ...
  template <typename ExecuteStatementT = ExecuteStatementResult>
  SendCommandResult& WithExecuteStatement(ExecuteStatementT&& value) {
  ...
  template <typename FetchPageT = FetchPageResult>
  SendCommandResult& WithFetchPage(FetchPageT&& value) {
