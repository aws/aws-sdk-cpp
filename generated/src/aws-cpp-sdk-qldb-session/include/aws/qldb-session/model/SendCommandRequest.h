...
class SendCommandRequest : public QLDBSessionRequest {
 public:
  ...
  template <typename SessionTokenT = Aws::String>
  SendCommandRequest& WithSessionToken(SessionTokenT&& value) {
  ...
  void SetStartSession(StartSessionT&& value) {
    m_startSessionHasBeenSet = true;
    m_startSession = std::forward<StartSessionT>(value);
  }
  template <typename StartSessionT = StartSessionRequest>
  SendCommandRequest& WithStartSession(StartSessionT&& value) {
    SetStartSession(std::forward<StartSessionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStartTransaction(StartTransactionT&& value) {
    m_startTransactionHasBeenSet = true;
    m_startTransaction = std::forward<StartTransactionT>(value);
  }
  template <typename StartTransactionT = StartTransactionRequest>
  SendCommandRequest& WithStartTransaction(StartTransactionT&& value) {
    SetStartTransaction(std::forward<StartTransactionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEndSession(EndSessionT&& value) {
    m_endSessionHasBeenSet = true;
    m_endSession = std::forward<EndSessionT>(value);
  }
  template <typename EndSessionT = EndSessionRequest>
  SendCommandRequest& WithEndSession(EndSessionT&& value) {
    SetEndSession(std::forward<EndSessionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCommitTransaction(CommitTransactionT&& value) {
    m_commitTransactionHasBeenSet = true;
    m_commitTransaction = std::forward<CommitTransactionT>(value);
  }
  template <typename CommitTransactionT = CommitTransactionRequest>
  SendCommandRequest& WithCommitTransaction(CommitTransactionT&& value) {
    SetCommitTransaction(std::forward<CommitTransactionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAbortTransaction(AbortTransactionT&& value) {
    m_abortTransactionHasBeenSet = true;
    m_abortTransaction = std::forward<AbortTransactionT>(value);
  }
  template <typename AbortTransactionT = AbortTransactionRequest>
  SendCommandRequest& WithAbortTransaction(AbortTransactionT&& value) {
    SetAbortTransaction(std::forward<AbortTransactionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExecuteStatement(ExecuteStatementT&& value) {
    m_executeStatementHasBeenSet = true;
    m_executeStatement = std::forward<ExecuteStatementT>(value);
  }
  template <typename ExecuteStatementT = ExecuteStatementRequest>
  SendCommandRequest& WithExecuteStatement(ExecuteStatementT&& value) {
    SetExecuteStatement(std::forward<ExecuteStatementT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFetchPage(FetchPageT&& value) {
    m_fetchPageHasBeenSet = true;
    m_fetchPage = std::forward<FetchPageT>(value);
  }
  template <typename FetchPageT = FetchPageRequest>
  SendCommandRequest& WithFetchPage(FetchPageT&& value) {
    SetFetchPage(std::forward<FetchPageT>(value));
    return *this;
  }
  ///@}
 private:
