...
namespace Model
{
  ...
  {
  public:
    AWS_QLDBSESSION_API InvalidSessionException() = default;
    ...
    template<typename MessageT = Aws::String>
    InvalidSessionException& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
    ...
    template<typename CodeT = Aws::String>
    InvalidSessionException& WithCode(CodeT&& value) { SetCode(std::forward<CodeT>(value)); return *this;}
    ///@}
  private:
