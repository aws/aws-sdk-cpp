...
class ExecuteStatementResult {
 public:
  ...
  void SetFirstPage(FirstPageT&& value) {
    m_firstPageHasBeenSet = true;
    m_firstPage = std::forward<FirstPageT>(value);
  }
  template <typename FirstPageT = Page>
  ExecuteStatementResult& WithFirstPage(FirstPageT&& value) {
    SetFirstPage(std::forward<FirstPageT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TimingInformationT = TimingInformation>
  ExecuteStatementResult& WithTimingInformation(TimingInformationT&& value) {
  ...
  template <typename ConsumedIOsT = IOUsage>
  ExecuteStatementResult& WithConsumedIOs(ConsumedIOsT&& value) {
