...
namespace QLDBSession
{
   ...
   */
  class AWS_QLDBSESSION_API QLDBSessionClient : Aws::Client::ClientWithAsyncTemplateMethods<QLDBSessionClient>,
    smithy::client::AwsSmithyClientT<Aws::QLDBSession::SERVICE_NAME,
