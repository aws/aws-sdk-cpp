...
class AWS_QLDBSESSION_API QLDBSessionClient : public Aws::Client::AWSJsonClient,
                                              public Aws::Client::ClientWithAsyncTemplateMethods<QLDBSessionClient> {
 public:
   ...
   */
  QLDBSessionClient(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<QLDBSessionEndpointProviderBase> endpointProvider = nullptr,
      const Aws::QLDBSession::QLDBSessionClientConfiguration& clientConfiguration = Aws::QLDBSession::QLDBSessionClientConfiguration());
   ...
   * is not specified, it will be initialized to default values.
   */
  QLDBSessionClient(const Aws::Auth::AWSCredentials& credentials, const Aws::Client::ClientConfiguration& clientConfiguration);
   ...
   */
  template <typename SendCommandRequestT = Model::SendCommandRequest>
  void SendCommandAsync(const SendCommandResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                        const SendCommandRequestT& request = {}) const {
