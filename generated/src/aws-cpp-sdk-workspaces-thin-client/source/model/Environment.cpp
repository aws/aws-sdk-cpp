...
Environment& Environment::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("softwareSetUpdateSchedule")) {
    m_softwareSetUpdateSchedule =
        SoftwareSetUpdateScheduleMapper::GetSoftwareSetUpdateScheduleForName(jsonValue.GetString("softwareSetUpdateSchedule"));
  ...
  if (jsonValue.ValueExists("softwareSetComplianceStatus")) {
    m_softwareSetComplianceStatus = EnvironmentSoftwareSetComplianceStatusMapper::GetEnvironmentSoftwareSetComplianceStatusForName(
        jsonValue.GetString("softwareSetComplianceStatus"));
...
JsonValue Environment::Jsonize() const {
  ...
  if (m_softwareSetComplianceStatusHasBeenSet) {
    payload.WithString(
        ...
        EnvironmentSoftwareSetComplianceStatusMapper::GetNameForEnvironmentSoftwareSetComplianceStatus(m_softwareSetComplianceStatus));
  }
