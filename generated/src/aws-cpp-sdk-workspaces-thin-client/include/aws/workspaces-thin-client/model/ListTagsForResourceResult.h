...
namespace Model
{
  ...
  {
  public:
    AWS_WORKSPACESTHINCLIENT_API ListTagsForResourceResult() = default;
    AWS_WORKSPACESTHINCLIENT_API ListTagsForResourceResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_WORKSPACESTHINCLIENT_API ListTagsForResourceResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
