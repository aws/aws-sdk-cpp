...
class SoftwareSetSummary {
 public:
  ...
  template <typename IdT = Aws::String>
  SoftwareSetSummary& WithId(IdT&& value) {
  ...
  template <typename VersionT = Aws::String>
  SoftwareSetSummary& WithVersion(VersionT&& value) {
  ...
  template <typename ReleasedAtT = Aws::Utils::DateTime>
  SoftwareSetSummary& WithReleasedAt(ReleasedAtT&& value) {
  ...
  template <typename SupportedUntilT = Aws::Utils::DateTime>
  SoftwareSetSummary& WithSupportedUntil(SupportedUntilT&& value) {
  ...
  inline SoftwareSetSummary& WithValidationStatus(SoftwareSetValidationStatus value) {
  ...
  template <typename ArnT = Aws::String>
  SoftwareSetSummary& WithArn(ArnT&& value) {
