...
class CreateEnvironmentRequest : public WorkSpacesThinClientRequest {
 public:
  ...
  template <typename DesktopArnT = Aws::String>
  CreateEnvironmentRequest& WithDesktopArn(DesktopArnT&& value) {
  ...
  template <typename DesktopEndpointT = Aws::String>
  CreateEnvironmentRequest& WithDesktopEndpoint(DesktopEndpointT&& value) {
  ...
  inline CreateEnvironmentRequest& WithSoftwareSetUpdateSchedule(SoftwareSetUpdateSchedule value) {
  ...
  template <typename MaintenanceWindowT = MaintenanceWindow>
  CreateEnvironmentRequest& WithMaintenanceWindow(MaintenanceWindowT&& value) {
  ...
  inline CreateEnvironmentRequest& WithSoftwareSetUpdateMode(SoftwareSetUpdateMode value) {
  ...
  template <typename DesiredSoftwareSetIdT = Aws::String>
  CreateEnvironmentRequest& WithDesiredSoftwareSetId(DesiredSoftwareSetIdT&& value) {
  ...
  template <typename KmsKeyArnT = Aws::String>
  CreateEnvironmentRequest& WithKmsKeyArn(KmsKeyArnT&& value) {
  ...
  template <typename DeviceCreationTagsT = Aws::Map<Aws::String, Aws::String>>
  CreateEnvironmentRequest& WithDeviceCreationTags(DeviceCreationTagsT&& value) {
