...
namespace Model
{
   ...
   * <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/workspaces-thin-client-2023-08-22/ResourceNotFoundException">AWS
   * API Reference</a></p>
   */
  class ResourceNotFoundException
  {
  public:
    AWS_WORKSPACESTHINCLIENT_API ResourceNotFoundException() = default;
    AWS_WORKSPACESTHINCLIENT_API ResourceNotFoundException(Aws::Utils::Json::JsonView jsonValue);
