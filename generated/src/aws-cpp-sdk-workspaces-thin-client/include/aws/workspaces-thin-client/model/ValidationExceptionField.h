...
namespace Model
{
  ...
  /**
   * <p>Describes a validation exception.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/workspaces-thin-client-2023-08-22/ValidationExceptionField">AWS
   * API Reference</a></p>
   */
  class ValidationExceptionField
  {
  public:
    AWS_WORKSPACESTHINCLIENT_API ValidationExceptionField() = default;
    AWS_WORKSPACESTHINCLIENT_API ValidationExceptionField(Aws::Utils::Json::JsonView jsonValue);
