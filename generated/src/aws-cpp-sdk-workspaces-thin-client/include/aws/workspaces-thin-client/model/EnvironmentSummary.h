...
class EnvironmentSummary {
 public:
  ...
  void SetDesktopArn(DesktopArnT&& value) {
    m_desktopArnHasBeenSet = true;
    m_desktopArn = std::forward<DesktopArnT>(value);
  }
  template <typename DesktopArnT = Aws::String>
  EnvironmentSummary& WithDesktopArn(DesktopArnT&& value) {
    SetDesktopArn(std::forward<DesktopArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDesktopEndpoint(DesktopEndpointT&& value) {
    m_desktopEndpointHasBeenSet = true;
    m_desktopEndpoint = std::forward<DesktopEndpointT>(value);
  }
  template <typename DesktopEndpointT = Aws::String>
  EnvironmentSummary& WithDesktopEndpoint(DesktopEndpointT&& value) {
    SetDesktopEndpoint(std::forward<DesktopEndpointT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetDesktopType(DesktopType value) {
    m_desktopTypeHasBeenSet = true;
    m_desktopType = value;
  }
  inline EnvironmentSummary& WithDesktopType(DesktopType value) {
    SetDesktopType(value);
    return *this;
  }
  ///@}
  ...
  template <typename ActivationCodeT = Aws::String>
  EnvironmentSummary& WithActivationCode(ActivationCodeT&& value) {
  ...
  inline EnvironmentSummary& WithSoftwareSetUpdateSchedule(SoftwareSetUpdateSchedule value) {
  ...
  template <typename MaintenanceWindowT = MaintenanceWindow>
  EnvironmentSummary& WithMaintenanceWindow(MaintenanceWindowT&& value) {
  ...
  inline void SetSoftwareSetUpdateMode(SoftwareSetUpdateMode value) {
    m_softwareSetUpdateModeHasBeenSet = true;
    m_softwareSetUpdateMode = value;
  }
  inline EnvironmentSummary& WithSoftwareSetUpdateMode(SoftwareSetUpdateMode value) {
    SetSoftwareSetUpdateMode(value);
    return *this;
  }
  ///@}
  ...
  template <typename DesiredSoftwareSetIdT = Aws::String>
  EnvironmentSummary& WithDesiredSoftwareSetId(DesiredSoftwareSetIdT&& value) {
  ...
  void SetPendingSoftwareSetId(PendingSoftwareSetIdT&& value) {
    m_pendingSoftwareSetIdHasBeenSet = true;
    m_pendingSoftwareSetId = std::forward<PendingSoftwareSetIdT>(value);
  }
  template <typename PendingSoftwareSetIdT = Aws::String>
  EnvironmentSummary& WithPendingSoftwareSetId(PendingSoftwareSetIdT&& value) {
    SetPendingSoftwareSetId(std::forward<PendingSoftwareSetIdT>(value));
    return *this;
  }
  ///@}
