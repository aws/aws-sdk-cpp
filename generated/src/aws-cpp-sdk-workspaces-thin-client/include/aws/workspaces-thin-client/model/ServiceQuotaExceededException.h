...
namespace Model
{
  ...
  /**
   * <p>Your request exceeds a service quota.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/workspaces-thin-client-2023-08-22/ServiceQuotaExceededException">AWS
   * API Reference</a></p>
   */
  class ServiceQuotaExceededException
  {
  public:
    AWS_WORKSPACESTHINCLIENT_API ServiceQuotaExceededException() = default;
    AWS_WORKSPACESTHINCLIENT_API ServiceQuotaExceededException(Aws::Utils::Json::JsonView jsonValue);
