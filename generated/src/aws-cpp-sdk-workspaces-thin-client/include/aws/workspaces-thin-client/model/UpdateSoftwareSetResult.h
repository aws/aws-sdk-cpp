...
namespace Model
{
  ...
  {
  public:
    AWS_WORKSPACESTHINCLIENT_API UpdateSoftwareSetResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateSoftwareSetResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
