...
class DeviceSummary {
 public:
  ...
  template <typename IdT = Aws::String>
  DeviceSummary& WithId(IdT&& value) {
  ...
  template <typename SerialNumberT = Aws::String>
  DeviceSummary& WithSerialNumber(SerialNumberT&& value) {
  ...
  template <typename NameT = Aws::String>
  DeviceSummary& WithName(NameT&& value) {
  ...
  template <typename ModelT = Aws::String>
  DeviceSummary& WithModel(ModelT&& value) {
  ...
  template <typename EnvironmentIdT = Aws::String>
  DeviceSummary& WithEnvironmentId(EnvironmentIdT&& value) {
  ...
  inline DeviceSummary& WithStatus(DeviceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CurrentSoftwareSetIdT = Aws::String>
  DeviceSummary& WithCurrentSoftwareSetId(CurrentSoftwareSetIdT&& value) {
  ...
  template <typename DesiredSoftwareSetIdT = Aws::String>
  DeviceSummary& WithDesiredSoftwareSetId(DesiredSoftwareSetIdT&& value) {
  ...
  template <typename PendingSoftwareSetIdT = Aws::String>
  DeviceSummary& WithPendingSoftwareSetId(PendingSoftwareSetIdT&& value) {
  ...
  inline DeviceSummary& WithSoftwareSetUpdateSchedule(SoftwareSetUpdateSchedule value) {
  ...
  template <typename LastConnectedAtT = Aws::Utils::DateTime>
  DeviceSummary& WithLastConnectedAt(LastConnectedAtT&& value) {
  ...
  template <typename LastPostureAtT = Aws::Utils::DateTime>
  DeviceSummary& WithLastPostureAt(LastPostureAtT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  DeviceSummary& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  DeviceSummary& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  template <typename ArnT = Aws::String>
  DeviceSummary& WithArn(ArnT&& value) {
  ...
  template <typename LastUserIdT = Aws::String>
  DeviceSummary& WithLastUserId(LastUserIdT&& value) {
