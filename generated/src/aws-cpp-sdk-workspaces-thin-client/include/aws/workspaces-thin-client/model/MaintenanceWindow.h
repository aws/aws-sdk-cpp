...
class MaintenanceWindow {
 public:
  ...
  inline void SetType(MaintenanceWindowType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline MaintenanceWindow& WithType(MaintenanceWindowType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStartTimeHour(int value) {
    m_startTimeHourHasBeenSet = true;
    m_startTimeHour = value;
  }
  inline MaintenanceWindow& WithStartTimeHour(int value) {
  ...
  inline void SetStartTimeMinute(int value) {
    m_startTimeMinuteHasBeenSet = true;
    m_startTimeMinute = value;
  }
  inline MaintenanceWindow& WithStartTimeMinute(int value) {
  ...
  inline void SetEndTimeHour(int value) {
    m_endTimeHourHasBeenSet = true;
    m_endTimeHour = value;
  }
  inline MaintenanceWindow& WithEndTimeHour(int value) {
  ...
  inline void SetEndTimeMinute(int value) {
    m_endTimeMinuteHasBeenSet = true;
    m_endTimeMinute = value;
  }
  inline MaintenanceWindow& WithEndTimeMinute(int value) {
  ...
  void SetDaysOfTheWeek(DaysOfTheWeekT&& value) {
    m_daysOfTheWeekHasBeenSet = true;
    m_daysOfTheWeek = std::forward<DaysOfTheWeekT>(value);
  }
  template <typename DaysOfTheWeekT = Aws::Vector<DayOfWeek>>
  MaintenanceWindow& WithDaysOfTheWeek(DaysOfTheWeekT&& value) {
    SetDaysOfTheWeek(std::forward<DaysOfTheWeekT>(value));
    return *this;
  }
  inline MaintenanceWindow& AddDaysOfTheWeek(DayOfWeek value) {
    m_daysOfTheWeekHasBeenSet = true;
    m_daysOfTheWeek.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline void SetApplyTimeOf(ApplyTimeOf value) {
    m_applyTimeOfHasBeenSet = true;
    m_applyTimeOf = value;
  }
  inline MaintenanceWindow& WithApplyTimeOf(ApplyTimeOf value) {
    SetApplyTimeOf(value);
    return *this;
  }
  ///@}
 private:
