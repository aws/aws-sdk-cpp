...
class SoftwareSet {
 public:
  ...
  template <typename VersionT = Aws::String>
  SoftwareSet& WithVersion(VersionT&& value) {
  ...
  void SetReleasedAt(ReleasedAtT&& value) {
    m_releasedAtHasBeenSet = true;
    m_releasedAt = std::forward<ReleasedAtT>(value);
  }
  template <typename ReleasedAtT = Aws::Utils::DateTime>
  SoftwareSet& WithReleasedAt(ReleasedAtT&& value) {
    SetReleasedAt(std::forward<ReleasedAtT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSupportedUntil(SupportedUntilT&& value) {
    m_supportedUntilHasBeenSet = true;
    m_supportedUntil = std::forward<SupportedUntilT>(value);
  }
  template <typename SupportedUntilT = Aws::Utils::DateTime>
  SoftwareSet& WithSupportedUntil(SupportedUntilT&& value) {
    SetSupportedUntil(std::forward<SupportedUntilT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetValidationStatus(SoftwareSetValidationStatus value) {
    m_validationStatusHasBeenSet = true;
    m_validationStatus = value;
  }
  inline SoftwareSet& WithValidationStatus(SoftwareSetValidationStatus value) {
  ...
  template <typename SoftwareT = Aws::Vector<Software>>
  SoftwareSet& WithSoftware(SoftwareT&& value) {
    SetSoftware(std::forward<SoftwareT>(value));
    return *this;
  }
  template <typename SoftwareT = Software>
  SoftwareSet& AddSoftware(SoftwareT&& value) {
    m_softwareHasBeenSet = true;
    m_software.emplace_back(std::forward<SoftwareT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ArnT = Aws::String>
  SoftwareSet& WithArn(ArnT&& value) {
