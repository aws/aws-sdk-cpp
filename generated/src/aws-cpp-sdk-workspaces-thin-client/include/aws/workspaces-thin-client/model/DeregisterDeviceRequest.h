...
class DeregisterDeviceRequest : public WorkSpacesThinClientRequest {
 public:
  ...
  template <typename IdT = Aws::String>
  DeregisterDeviceRequest& WithId(IdT&& value) {
  ...
  inline void SetTargetDeviceStatus(TargetDeviceStatus value) {
    m_targetDeviceStatusHasBeenSet = true;
    m_targetDeviceStatus = value;
  }
  inline DeregisterDeviceRequest& WithTargetDeviceStatus(TargetDeviceStatus value) {
    SetTargetDeviceStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ClientTokenT = Aws::String>
  DeregisterDeviceRequest& WithClientToken(ClientTokenT&& value) {
