...
namespace Model
{
  ...
  {
  public:
    AWS_WORKSPACESTHINCLIENT_API DeleteEnvironmentRequest() = default;
    ...
    template<typename IdT = Aws::String>
    DeleteEnvironmentRequest& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename ClientTokenT = Aws::String>
    DeleteEnvironmentRequest& WithClientToken(ClientTokenT&& value) { SetClientToken(std::forward<ClientTokenT>(value)); return *this;}
    ///@}
  private:
