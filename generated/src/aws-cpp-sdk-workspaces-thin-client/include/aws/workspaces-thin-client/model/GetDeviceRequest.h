...
namespace Model
{
  ...
  /**
   */
  class GetDeviceRequest : public WorkSpacesThinClientRequest
  {
  public:
    AWS_WORKSPACESTHINCLIENT_API GetDeviceRequest() = default;
    ...
    template<typename IdT = Aws::String>
    GetDeviceRequest& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
  private:
