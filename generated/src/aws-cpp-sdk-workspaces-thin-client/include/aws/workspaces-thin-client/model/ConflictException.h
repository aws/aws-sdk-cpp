...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/workspaces-thin-client-2023-08-22/ConflictException">AWS
   * API Reference</a></p>
   */
  class ConflictException
  {
  public:
    AWS_WORKSPACESTHINCLIENT_API ConflictException() = default;
    AWS_WORKSPACESTHINCLIENT_API ConflictException(Aws::Utils::Json::JsonView jsonValue);
