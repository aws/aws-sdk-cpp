...
class Environment {
 public:
  ...
  template <typename DesktopArnT = Aws::String>
  Environment& WithDesktopArn(DesktopArnT&& value) {
  ...
  template <typename DesktopEndpointT = Aws::String>
  Environment& WithDesktopEndpoint(DesktopEndpointT&& value) {
  ...
  inline Environment& WithDesktopType(DesktopType value) {
  ...
  template <typename ActivationCodeT = Aws::String>
  Environment& WithActivationCode(ActivationCodeT&& value) {
  ...
  inline void SetRegisteredDevicesCount(int value) {
    m_registeredDevicesCountHasBeenSet = true;
    m_registeredDevicesCount = value;
  }
  inline Environment& WithRegisteredDevicesCount(int value) {
    SetRegisteredDevicesCount(value);
    return *this;
  }
  ///@}
  ...
  inline Environment& WithSoftwareSetUpdateSchedule(SoftwareSetUpdateSchedule value) {
  ...
  template <typename MaintenanceWindowT = MaintenanceWindow>
  Environment& WithMaintenanceWindow(MaintenanceWindowT&& value) {
  ...
  inline Environment& WithSoftwareSetUpdateMode(SoftwareSetUpdateMode value) {
  ...
  template <typename DesiredSoftwareSetIdT = Aws::String>
  Environment& WithDesiredSoftwareSetId(DesiredSoftwareSetIdT&& value) {
  ...
  template <typename PendingSoftwareSetIdT = Aws::String>
  Environment& WithPendingSoftwareSetId(PendingSoftwareSetIdT&& value) {
  ...
  void SetPendingSoftwareSetVersion(PendingSoftwareSetVersionT&& value) {
    m_pendingSoftwareSetVersionHasBeenSet = true;
    m_pendingSoftwareSetVersion = std::forward<PendingSoftwareSetVersionT>(value);
  }
  template <typename PendingSoftwareSetVersionT = Aws::String>
  Environment& WithPendingSoftwareSetVersion(PendingSoftwareSetVersionT&& value) {
    SetPendingSoftwareSetVersion(std::forward<PendingSoftwareSetVersionT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetSoftwareSetComplianceStatus(EnvironmentSoftwareSetComplianceStatus value) {
    m_softwareSetComplianceStatusHasBeenSet = true;
    m_softwareSetComplianceStatus = value;
  }
  inline Environment& WithSoftwareSetComplianceStatus(EnvironmentSoftwareSetComplianceStatus value) {
    SetSoftwareSetComplianceStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  Environment& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  template <typename KmsKeyArnT = Aws::String>
  Environment& WithKmsKeyArn(KmsKeyArnT&& value) {
  ...
  void SetDeviceCreationTags(DeviceCreationTagsT&& value) {
    m_deviceCreationTagsHasBeenSet = true;
    m_deviceCreationTags = std::forward<DeviceCreationTagsT>(value);
  }
  template <typename DeviceCreationTagsT = Aws::Map<Aws::String, Aws::String>>
  Environment& WithDeviceCreationTags(DeviceCreationTagsT&& value) {
    SetDeviceCreationTags(std::forward<DeviceCreationTagsT>(value));
    return *this;
  }
  ...
  Environment& AddDeviceCreationTags(DeviceCreationTagsKeyT&& key, DeviceCreationTagsValueT&& value) {
    m_deviceCreationTagsHasBeenSet = true;
    m_deviceCreationTags.emplace(std::forward<DeviceCreationTagsKeyT>(key), std::forward<DeviceCreationTagsValueT>(value));
    return *this;
  }
  ///@}
 private:
