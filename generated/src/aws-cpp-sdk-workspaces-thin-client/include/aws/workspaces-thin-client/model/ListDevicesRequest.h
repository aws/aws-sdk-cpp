...
/**
 */
class ListDevicesRequest : public WorkSpacesThinClientRequest {
 public:
  AWS_WORKSPACESTHINCLIENT_API ListDevicesRequest() = default;
  ...
  inline ListDevicesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
