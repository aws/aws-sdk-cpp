...
namespace WorkSpacesThinClient
{
   ...
   */
  class AWS_WORKSPACESTHINCLIENT_API WorkSpacesThinClientClient : Aws::Client::ClientWithAsyncTemplateMethods<WorkSpacesThinClientClient>,
    smithy::client::AwsSmithyClientT<Aws::WorkSpacesThinClient::SERVICE_NAME,
