...
class AWS_WORKSPACESTHINCLIENT_API WorkSpacesThinClientClient
 ...
 public:
   ...
   */
  WorkSpacesThinClientClient(const Aws::WorkSpacesThinClient::WorkSpacesThinClientClientConfiguration& clientConfiguration =
  ...
  WorkSpacesThinClientClient(const Aws::Auth::AWSCredentials& credentials,
                             std::shared_ptr<WorkSpacesThinClientEndpointProviderBase> endpointProvider = nullptr,
                             const Aws::WorkSpacesThinClient::WorkSpacesThinClientClientConfiguration& clientConfiguration =
                                 Aws::WorkSpacesThinClient::WorkSpacesThinClientClientConfiguration());
   ...
   * is not specified, it will be initialized to default values.
   */
  WorkSpacesThinClientClient(const Aws::Auth::AWSCredentials& credentials, const Aws::Client::ClientConfiguration& clientConfiguration);
  ...
  /**
   * A Callable wrapper for DeregisterDevice that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeregisterDevice that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeregisterDeviceRequestT = Model::DeregisterDeviceRequest>
  void DeregisterDeviceAsync(const DeregisterDeviceRequestT& request, const DeregisterDeviceResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetSoftwareSet that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetSoftwareSetRequestT = Model::GetSoftwareSetRequest>
  void GetSoftwareSetAsync(const GetSoftwareSetRequestT& request, const GetSoftwareSetResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListSoftwareSets that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListSoftwareSets that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListSoftwareSetsRequestT = Model::ListSoftwareSetsRequest>
  void ListSoftwareSetsAsync(const ListSoftwareSetsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const ListSoftwareSetsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for UpdateSoftwareSet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateSoftwareSet that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateSoftwareSetRequestT = Model::UpdateSoftwareSetRequest>
  void UpdateSoftwareSetAsync(const UpdateSoftwareSetRequestT& request, const UpdateSoftwareSetResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
