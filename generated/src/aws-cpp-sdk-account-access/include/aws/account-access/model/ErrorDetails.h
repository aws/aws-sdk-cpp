...
/**
 * <p>Contains information about an error that occurred during application
 * processing.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/account-access-2018-05-10/ErrorDetails">AWS
 * API Reference</a></p>
 */
class ErrorDetails {
 public:
  AWS_ACCOUNTACCESS_API ErrorDetails() = default;
  AWS_ACCOUNTACCESS_API ErrorDetails(Aws::Utils::Json::JsonView jsonValue);
  AWS_ACCOUNTACCESS_API ErrorDetails& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  inline ErrorDetails& WithCode(ErrorCode value) {
    SetCode(value);
    return *this;
  }
  ///@}
