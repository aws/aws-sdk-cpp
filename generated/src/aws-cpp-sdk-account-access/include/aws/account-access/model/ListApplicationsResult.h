...
class ListApplicationsResult {
 public:
  AWS_ACCOUNTACCESS_API ListApplicationsResult() = default;
  AWS_ACCOUNTACCESS_API ListApplicationsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_ACCOUNTACCESS_API ListApplicationsResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
