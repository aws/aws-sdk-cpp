...
EntitlementDetails::EntitlementDetails(JsonView jsonValue) { *this = jsonValue; }

EntitlementDetails& EntitlementDetails::operator=(JsonView jsonValue) {
...
JsonValue EntitlementDetails::Jsonize() const {
  JsonValue payload;
