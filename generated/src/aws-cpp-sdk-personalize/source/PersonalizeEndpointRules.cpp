...
{
const size_t PersonalizeEndpointRules::RulesBlobStrLen = 3744;
const size_t PersonalizeEndpointRules::RulesBlobSize = 3745;
...
't','p','s',':','/','/','p','e','r','s','o','n','a','l','i','z','e','-','f','i','p','s','.','{','R',
