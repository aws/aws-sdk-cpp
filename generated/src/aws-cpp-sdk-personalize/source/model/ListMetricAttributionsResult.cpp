...
ListMetricAttributionsResult::ListMetricAttributionsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListMetricAttributionsResult& ListMetricAttributionsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("metricAttributions")) {
    ...
    for (unsigned metricAttributionsIndex = 0; metricAttributionsIndex < metricAttributionsJsonList.GetLength();
         ++metricAttributionsIndex) {
