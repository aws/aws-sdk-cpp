...
DefaultHyperParameterRanges::DefaultHyperParameterRanges(JsonView jsonValue) { *this = jsonValue; }

DefaultHyperParameterRanges& DefaultHyperParameterRanges::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("integerHyperParameterRanges")) {
    ...
    for (unsigned integerHyperParameterRangesIndex = 0; integerHyperParameterRangesIndex < integerHyperParameterRangesJsonList.GetLength();
         ++integerHyperParameterRangesIndex) {
  ...
  if (jsonValue.ValueExists("continuousHyperParameterRanges")) {
    ...
    for (unsigned continuousHyperParameterRangesIndex = 0;
         continuousHyperParameterRangesIndex < continuousHyperParameterRangesJsonList.GetLength(); ++continuousHyperParameterRangesIndex) {
  ...
  if (jsonValue.ValueExists("categoricalHyperParameterRanges")) {
    ...
    for (unsigned categoricalHyperParameterRangesIndex = 0;
         categoricalHyperParameterRangesIndex < categoricalHyperParameterRangesJsonList.GetLength();
         ++categoricalHyperParameterRangesIndex) {
...
JsonValue DefaultHyperParameterRanges::Jsonize() const {
  JsonValue payload;
  ...
  if (m_integerHyperParameterRangesHasBeenSet) {
    ...
    for (unsigned integerHyperParameterRangesIndex = 0; integerHyperParameterRangesIndex < integerHyperParameterRangesJsonList.GetLength();
         ++integerHyperParameterRangesIndex) {
      integerHyperParameterRangesJsonList[integerHyperParameterRangesIndex].AsObject(
          m_integerHyperParameterRanges[integerHyperParameterRangesIndex].Jsonize());
    }
  ...
  if (m_continuousHyperParameterRangesHasBeenSet) {
    ...
    for (unsigned continuousHyperParameterRangesIndex = 0;
         continuousHyperParameterRangesIndex < continuousHyperParameterRangesJsonList.GetLength(); ++continuousHyperParameterRangesIndex) {
      continuousHyperParameterRangesJsonList[continuousHyperParameterRangesIndex].AsObject(
          m_continuousHyperParameterRanges[continuousHyperParameterRangesIndex].Jsonize());
    }
  ...
  if (m_categoricalHyperParameterRangesHasBeenSet) {
    ...
    for (unsigned categoricalHyperParameterRangesIndex = 0;
         categoricalHyperParameterRangesIndex < categoricalHyperParameterRangesJsonList.GetLength();
         ++categoricalHyperParameterRangesIndex) {
      categoricalHyperParameterRangesJsonList[categoricalHyperParameterRangesIndex].AsObject(
          m_categoricalHyperParameterRanges[categoricalHyperParameterRangesIndex].Jsonize());
    }
