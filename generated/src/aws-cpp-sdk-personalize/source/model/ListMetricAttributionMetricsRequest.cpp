...
Aws::Http::HeaderValueCollection ListMetricAttributionMetricsRequest::GetRequestSpecificHeaders() const
{
  Aws::Http::HeaderValueCollection headers;
  headers.insert(Aws::Http::HeaderValuePair("X-Amz-Target", "AmazonPersonalize.ListMetricAttributionMetrics"));
  return headers;
