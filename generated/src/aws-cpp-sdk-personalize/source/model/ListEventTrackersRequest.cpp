...
Aws::Http::HeaderValueCollection ListEventTrackersRequest::GetRequestSpecificHeaders() const
{
  Aws::Http::HeaderValueCollection headers;
  headers.insert(Aws::Http::HeaderValuePair("X-Amz-Target", "AmazonPersonalize.ListEventTrackers"));
  return headers;
