...
SolutionConfig::SolutionConfig(JsonView jsonValue) { *this = jsonValue; }
...
SolutionConfig& SolutionConfig::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("featureTransformationParameters")) {
    Aws::Map<Aws::String, JsonView> featureTransformationParametersJsonMap =
        jsonValue.GetObject("featureTransformationParameters").GetAllObjects();
...
JsonValue SolutionConfig::Jsonize() const {
  ...
  if (m_featureTransformationParametersHasBeenSet) {
    ...
    for (auto& featureTransformationParametersItem : m_featureTransformationParameters) {
      featureTransformationParametersJsonMap.WithString(featureTransformationParametersItem.first,
                                                        featureTransformationParametersItem.second);
    }
