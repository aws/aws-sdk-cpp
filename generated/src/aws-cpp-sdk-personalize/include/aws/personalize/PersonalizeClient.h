...
namespace Personalize
{
   ...
   */
  class AWS_PERSONALIZE_API PersonalizeClient : Aws::Client::ClientWithAsyncTemplateMethods<PersonalizeClient>,
    smithy::client::AwsSmithyClientT<Aws::Personalize::SERVICE_NAME,
