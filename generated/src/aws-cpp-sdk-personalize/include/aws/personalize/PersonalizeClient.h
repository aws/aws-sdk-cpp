...
class AWS_PERSONALIZE_API PersonalizeClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  PersonalizeClient(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<PersonalizeEndpointProviderBase> endpointProvider = nullptr,
      const Aws::Personalize::PersonalizeClientConfiguration& clientConfiguration = Aws::Personalize::PersonalizeClientConfiguration());
  ...
  /**
   * A Callable wrapper for CreateBatchInferenceJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateBatchInferenceJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateBatchInferenceJobRequestT = Model::CreateBatchInferenceJobRequest>
  void CreateBatchInferenceJobAsync(const CreateBatchInferenceJobRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateBatchSegmentJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateBatchSegmentJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateBatchSegmentJobRequestT = Model::CreateBatchSegmentJobRequest>
  void CreateBatchSegmentJobAsync(const CreateBatchSegmentJobRequestT& request, const CreateBatchSegmentJobResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateDataDeletionJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateDataDeletionJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateDataDeletionJobRequestT = Model::CreateDataDeletionJobRequest>
  void CreateDataDeletionJobAsync(const CreateDataDeletionJobRequestT& request, const CreateDataDeletionJobResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateEventTracker that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateEventTracker that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateEventTrackerRequestT = Model::CreateEventTrackerRequest>
  void CreateEventTrackerAsync(const CreateEventTrackerRequestT& request, const CreateEventTrackerResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateFilter that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateFilterRequestT = Model::CreateFilterRequest>
  void CreateFilterAsync(const CreateFilterRequestT& request, const CreateFilterResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateMetricAttribution that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateMetricAttribution that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateMetricAttributionRequestT = Model::CreateMetricAttributionRequest>
  void CreateMetricAttributionAsync(const CreateMetricAttributionRequestT& request,
                                    const CreateMetricAttributionResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateSolution that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateSolutionRequestT = Model::CreateSolutionRequest>
  void CreateSolutionAsync(const CreateSolutionRequestT& request, const CreateSolutionResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateSolutionVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateSolutionVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateSolutionVersionRequestT = Model::CreateSolutionVersionRequest>
  void CreateSolutionVersionAsync(const CreateSolutionVersionRequestT& request, const CreateSolutionVersionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteEventTracker that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteEventTracker that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteEventTrackerRequestT = Model::DeleteEventTrackerRequest>
  void DeleteEventTrackerAsync(const DeleteEventTrackerRequestT& request, const DeleteEventTrackerResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteFilter that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteFilterRequestT = Model::DeleteFilterRequest>
  void DeleteFilterAsync(const DeleteFilterRequestT& request, const DeleteFilterResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteMetricAttribution that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteMetricAttribution that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteMetricAttributionRequestT = Model::DeleteMetricAttributionRequest>
  void DeleteMetricAttributionAsync(const DeleteMetricAttributionRequestT& request,
                                    const DeleteMetricAttributionResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteSolution that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteSolutionRequestT = Model::DeleteSolutionRequest>
  void DeleteSolutionAsync(const DeleteSolutionRequestT& request, const DeleteSolutionResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeBatchInferenceJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeBatchInferenceJobRequestT = Model::DescribeBatchInferenceJobRequest>
  Model::DescribeBatchInferenceJobOutcomeCallable DescribeBatchInferenceJobCallable(
      const DescribeBatchInferenceJobRequestT& request) const {
    return SubmitCallable(&PersonalizeClient::DescribeBatchInferenceJob, request);
  }

  /**
   * An Async wrapper for DescribeBatchInferenceJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeBatchInferenceJobRequestT = Model::DescribeBatchInferenceJobRequest>
  void DescribeBatchInferenceJobAsync(const DescribeBatchInferenceJobRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeBatchSegmentJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeBatchSegmentJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeBatchSegmentJobRequestT = Model::DescribeBatchSegmentJobRequest>
  void DescribeBatchSegmentJobAsync(const DescribeBatchSegmentJobRequestT& request,
                                    const DescribeBatchSegmentJobResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeDataDeletionJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeDataDeletionJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeDataDeletionJobRequestT = Model::DescribeDataDeletionJobRequest>
  void DescribeDataDeletionJobAsync(const DescribeDataDeletionJobRequestT& request,
                                    const DescribeDataDeletionJobResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeEventTracker that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeEventTracker that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeEventTrackerRequestT = Model::DescribeEventTrackerRequest>
  void DescribeEventTrackerAsync(const DescribeEventTrackerRequestT& request, const DescribeEventTrackerResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeFeatureTransformationOutcome DescribeFeatureTransformation(
      const Model::DescribeFeatureTransformationRequest& request) const;

  /**
   * A Callable wrapper for DescribeFeatureTransformation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeFeatureTransformationRequestT = Model::DescribeFeatureTransformationRequest>
  Model::DescribeFeatureTransformationOutcomeCallable DescribeFeatureTransformationCallable(
      const DescribeFeatureTransformationRequestT& request) const {
    return SubmitCallable(&PersonalizeClient::DescribeFeatureTransformation, request);
  }

  /**
   * An Async wrapper for DescribeFeatureTransformation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeFeatureTransformationRequestT = Model::DescribeFeatureTransformationRequest>
  void DescribeFeatureTransformationAsync(const DescribeFeatureTransformationRequestT& request,
  ...
  /**
   * An Async wrapper for DescribeFilter that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeFilterRequestT = Model::DescribeFilterRequest>
  void DescribeFilterAsync(const DescribeFilterRequestT& request, const DescribeFilterResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeMetricAttribution that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeMetricAttributionRequestT = Model::DescribeMetricAttributionRequest>
  Model::DescribeMetricAttributionOutcomeCallable DescribeMetricAttributionCallable(
      const DescribeMetricAttributionRequestT& request) const {
    return SubmitCallable(&PersonalizeClient::DescribeMetricAttribution, request);
  }

  /**
   * An Async wrapper for DescribeMetricAttribution that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeMetricAttributionRequestT = Model::DescribeMetricAttributionRequest>
  void DescribeMetricAttributionAsync(const DescribeMetricAttributionRequestT& request,
                                      const DescribeMetricAttributionResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeRecommender that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeRecommender that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeRecommenderRequestT = Model::DescribeRecommenderRequest>
  void DescribeRecommenderAsync(const DescribeRecommenderRequestT& request, const DescribeRecommenderResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeSchema that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeSchemaRequestT = Model::DescribeSchemaRequest>
  void DescribeSchemaAsync(const DescribeSchemaRequestT& request, const DescribeSchemaResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeSolution that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeSolution that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeSolutionRequestT = Model::DescribeSolutionRequest>
  void DescribeSolutionAsync(const DescribeSolutionRequestT& request, const DescribeSolutionResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeSolutionVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeSolutionVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeSolutionVersionRequestT = Model::DescribeSolutionVersionRequest>
  void DescribeSolutionVersionAsync(const DescribeSolutionVersionRequestT& request,
  ...
  /**
   * A Callable wrapper for GetSolutionMetrics that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetSolutionMetrics that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetSolutionMetricsRequestT = Model::GetSolutionMetricsRequest>
  void GetSolutionMetricsAsync(const GetSolutionMetricsRequestT& request, const GetSolutionMetricsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListBatchInferenceJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListBatchInferenceJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListBatchInferenceJobsRequestT = Model::ListBatchInferenceJobsRequest>
  void ListBatchInferenceJobsAsync(const ListBatchInferenceJobsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const ListBatchInferenceJobsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListBatchSegmentJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListBatchSegmentJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListBatchSegmentJobsRequestT = Model::ListBatchSegmentJobsRequest>
  void ListBatchSegmentJobsAsync(const ListBatchSegmentJobsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const ListBatchSegmentJobsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListDataDeletionJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListDataDeletionJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListDataDeletionJobsRequestT = Model::ListDataDeletionJobsRequest>
  void ListDataDeletionJobsAsync(const ListDataDeletionJobsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const ListDataDeletionJobsRequestT& request = {}) const {
   ...
   */
  template <typename ListDatasetExportJobsRequestT = Model::ListDatasetExportJobsRequest>
  void ListDatasetExportJobsAsync(const ListDatasetExportJobsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const ListDatasetExportJobsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListEventTrackers that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListEventTrackers that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListEventTrackersRequestT = Model::ListEventTrackersRequest>
  void ListEventTrackersAsync(const ListEventTrackersResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const ListEventTrackersRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListFilters that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListFiltersRequestT = Model::ListFiltersRequest>
  void ListFiltersAsync(const ListFiltersResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                        const ListFiltersRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListMetricAttributionMetricsOutcome ListMetricAttributionMetrics(
      const Model::ListMetricAttributionMetricsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListMetricAttributionMetrics that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListMetricAttributionMetricsRequestT = Model::ListMetricAttributionMetricsRequest>
  Model::ListMetricAttributionMetricsOutcomeCallable ListMetricAttributionMetricsCallable(
      const ListMetricAttributionMetricsRequestT& request = {}) const {
    return SubmitCallable(&PersonalizeClient::ListMetricAttributionMetrics, request);
  }

  /**
   * An Async wrapper for ListMetricAttributionMetrics that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListMetricAttributionMetricsRequestT = Model::ListMetricAttributionMetricsRequest>
  void ListMetricAttributionMetricsAsync(const ListMetricAttributionMetricsResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                         const ListMetricAttributionMetricsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListMetricAttributions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListMetricAttributions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListMetricAttributionsRequestT = Model::ListMetricAttributionsRequest>
  void ListMetricAttributionsAsync(const ListMetricAttributionsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const ListMetricAttributionsRequestT& request = {}) const {
   ...
   */
  template <typename ListRecommendersRequestT = Model::ListRecommendersRequest>
  void ListRecommendersAsync(const ListRecommendersResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const ListRecommendersRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListSolutionVersions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListSolutionVersions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListSolutionVersionsRequestT = Model::ListSolutionVersionsRequest>
  void ListSolutionVersionsAsync(const ListSolutionVersionsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const ListSolutionVersionsRequestT& request = {}) const {
   ...
   */
  template <typename ListSolutionsRequestT = Model::ListSolutionsRequest>
  void ListSolutionsAsync(const ListSolutionsResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                          const ListSolutionsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StopSolutionVersionCreationOutcome StopSolutionVersionCreation(
      const Model::StopSolutionVersionCreationRequest& request) const;

  /**
   * A Callable wrapper for StopSolutionVersionCreation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename StopSolutionVersionCreationRequestT = Model::StopSolutionVersionCreationRequest>
  Model::StopSolutionVersionCreationOutcomeCallable StopSolutionVersionCreationCallable(
      const StopSolutionVersionCreationRequestT& request) const {
    return SubmitCallable(&PersonalizeClient::StopSolutionVersionCreation, request);
  }

  /**
   * An Async wrapper for StopSolutionVersionCreation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StopSolutionVersionCreationRequestT = Model::StopSolutionVersionCreationRequest>
  void StopSolutionVersionCreationAsync(const StopSolutionVersionCreationRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateMetricAttribution that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateMetricAttribution that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateMetricAttributionRequestT = Model::UpdateMetricAttributionRequest>
  void UpdateMetricAttributionAsync(const UpdateMetricAttributionResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const UpdateMetricAttributionRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for UpdateSolution that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateSolutionRequestT = Model::UpdateSolutionRequest>
  void UpdateSolutionAsync(const UpdateSolutionRequestT& request, const UpdateSolutionResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
