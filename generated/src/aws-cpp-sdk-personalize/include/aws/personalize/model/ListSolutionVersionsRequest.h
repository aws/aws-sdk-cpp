...
class ListSolutionVersionsRequest : public PersonalizeRequest {
 public:
  AWS_PERSONALIZE_API ListSolutionVersionsRequest() = default;
  ...
  template <typename SolutionArnT = Aws::String>
  ListSolutionVersionsRequest& WithSolutionArn(SolutionArnT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListSolutionVersionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListSolutionVersionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
