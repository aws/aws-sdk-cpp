...
class CreateDatasetExportJobRequest : public PersonalizeRequest {
 public:
  ...
  inline void SetIngestionMode(IngestionMode value) {
    m_ingestionModeHasBeenSet = true;
    m_ingestionMode = value;
  }
  inline CreateDatasetExportJobRequest& WithIngestionMode(IngestionMode value) {
  ...
  CreateDatasetExportJobRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
