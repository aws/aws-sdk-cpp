...
class CreateSolutionVersionResult {
 public:
  AWS_PERSONALIZE_API CreateSolutionVersionResult() = default;
  ...
  template <typename SolutionVersionArnT = Aws::String>
  CreateSolutionVersionResult& WithSolutionVersionArn(SolutionVersionArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateSolutionVersionResult& WithRequestId(RequestIdT&& value) {
