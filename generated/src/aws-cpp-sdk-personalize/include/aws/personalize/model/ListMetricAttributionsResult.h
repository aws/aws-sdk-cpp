...
class ListMetricAttributionsResult {
 public:
  ...
  void SetMetricAttributions(MetricAttributionsT&& value) {
    m_metricAttributionsHasBeenSet = true;
    m_metricAttributions = std::forward<MetricAttributionsT>(value);
  }
  template <typename MetricAttributionsT = Aws::Vector<MetricAttributionSummary>>
  ListMetricAttributionsResult& WithMetricAttributions(MetricAttributionsT&& value) {
    SetMetricAttributions(std::forward<MetricAttributionsT>(value));
    return *this;
  }
  template <typename MetricAttributionsT = MetricAttributionSummary>
  ListMetricAttributionsResult& AddMetricAttributions(MetricAttributionsT&& value) {
    m_metricAttributionsHasBeenSet = true;
    m_metricAttributions.emplace_back(std::forward<MetricAttributionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListMetricAttributionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListMetricAttributionsResult& WithRequestId(RequestIdT&& value) {
