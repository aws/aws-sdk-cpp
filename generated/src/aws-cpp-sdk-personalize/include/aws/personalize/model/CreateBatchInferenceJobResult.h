...
class CreateBatchInferenceJobResult {
 public:
  ...
  void SetBatchInferenceJobArn(BatchInferenceJobArnT&& value) {
    ...
    m_batchInferenceJobArn = std::forward<BatchInferenceJobArnT>(value);
  }
  template <typename BatchInferenceJobArnT = Aws::String>
  CreateBatchInferenceJobResult& WithBatchInferenceJobArn(BatchInferenceJobArnT&& value) {
    SetBatchInferenceJobArn(std::forward<BatchInferenceJobArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  CreateBatchInferenceJobResult& WithRequestId(RequestIdT&& value) {
