...
namespace Model
{
  ...
  public:
    ...
    inline StopRecommenderResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline StopRecommenderResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline StopRecommenderResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
