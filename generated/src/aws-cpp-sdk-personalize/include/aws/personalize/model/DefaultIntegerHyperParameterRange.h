...
class DefaultIntegerHyperParameterRange {
 public:
  ...
  template <typename NameT = Aws::String>
  DefaultIntegerHyperParameterRange& WithName(NameT&& value) {
  ...
  inline DefaultIntegerHyperParameterRange& WithMinValue(int value) {
    SetMinValue(value);
    return *this;
  }
  ///@}
  ...
  inline DefaultIntegerHyperParameterRange& WithMaxValue(int value) {
    SetMaxValue(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIsTunable(bool value) {
    m_isTunableHasBeenSet = true;
    m_isTunable = value;
  }
  inline DefaultIntegerHyperParameterRange& WithIsTunable(bool value) {
    SetIsTunable(value);
    return *this;
  }
  ///@}
