...
class DescribeBatchInferenceJobResult {
 public:
  ...
  void SetBatchInferenceJob(BatchInferenceJobT&& value) {
    m_batchInferenceJobHasBeenSet = true;
    m_batchInferenceJob = std::forward<BatchInferenceJobT>(value);
  }
  template <typename BatchInferenceJobT = BatchInferenceJob>
  DescribeBatchInferenceJobResult& WithBatchInferenceJob(BatchInferenceJobT&& value) {
    SetBatchInferenceJob(std::forward<BatchInferenceJobT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeBatchInferenceJobResult& WithRequestId(RequestIdT&& value) {
