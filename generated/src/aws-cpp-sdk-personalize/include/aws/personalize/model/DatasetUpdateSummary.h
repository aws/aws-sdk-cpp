...
namespace Model
{
  ...
  public:
    ...
    template<typename SchemaArnT = Aws::String>
    DatasetUpdateSummary& WithSchemaArn(SchemaArnT&& value) { SetSchemaArn(std::forward<SchemaArnT>(value)); return *this;}
    ///@}
    ...
    template<typename StatusT = Aws::String>
    DatasetUpdateSummary& WithStatus(StatusT&& value) { SetStatus(std::forward<StatusT>(value)); return *this;}
    ///@}
    ...
    template<typename FailureReasonT = Aws::String>
    DatasetUpdateSummary& WithFailureReason(FailureReasonT&& value) { SetFailureReason(std::forward<FailureReasonT>(value)); return *this;}
    ///@}
    ...
    template<typename CreationDateTimeT = Aws::Utils::DateTime>
    DatasetUpdateSummary& WithCreationDateTime(CreationDateTimeT&& value) { SetCreationDateTime(std::forward<CreationDateTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename LastUpdatedDateTimeT = Aws::Utils::DateTime>
    DatasetUpdateSummary& WithLastUpdatedDateTime(LastUpdatedDateTimeT&& value) { SetLastUpdatedDateTime(std::forward<LastUpdatedDateTimeT>(value)); return *this;}
    ///@}
  private:
