...
class TunedHPOParams {
 public:
  ...
  void SetAlgorithmHyperParameters(AlgorithmHyperParametersT&& value) {
    ...
    m_algorithmHyperParameters = std::forward<AlgorithmHyperParametersT>(value);
  }
  template <typename AlgorithmHyperParametersT = Aws::Map<Aws::String, Aws::String>>
  TunedHPOParams& WithAlgorithmHyperParameters(AlgorithmHyperParametersT&& value) {
    SetAlgorithmHyperParameters(std::forward<AlgorithmHyperParametersT>(value));
    return *this;
  }
  ...
  TunedHPOParams& AddAlgorithmHyperParameters(AlgorithmHyperParametersKeyT&& key, AlgorithmHyperParametersValueT&& value) {
    m_algorithmHyperParametersHasBeenSet = true;
    m_algorithmHyperParameters.emplace(std::forward<AlgorithmHyperParametersKeyT>(key),
                                       std::forward<AlgorithmHyperParametersValueT>(value));
    return *this;
  }
  ///@}
 private:
