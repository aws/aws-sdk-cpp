...
class Algorithm {
 public:
  ...
  void SetAlgorithmImage(AlgorithmImageT&& value) {
    ...
    m_algorithmImage = std::forward<AlgorithmImageT>(value);
  }
  template <typename AlgorithmImageT = AlgorithmImage>
  Algorithm& WithAlgorithmImage(AlgorithmImageT&& value) {
    SetAlgorithmImage(std::forward<AlgorithmImageT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDefaultHyperParameters(DefaultHyperParametersT&& value) {
    ...
    m_defaultHyperParameters = std::forward<DefaultHyperParametersT>(value);
  }
  template <typename DefaultHyperParametersT = Aws::Map<Aws::String, Aws::String>>
  Algorithm& WithDefaultHyperParameters(DefaultHyperParametersT&& value) {
    SetDefaultHyperParameters(std::forward<DefaultHyperParametersT>(value));
    return *this;
  }
  ...
  Algorithm& AddDefaultHyperParameters(DefaultHyperParametersKeyT&& key, DefaultHyperParametersValueT&& value) {
    m_defaultHyperParametersHasBeenSet = true;
    m_defaultHyperParameters.emplace(std::forward<DefaultHyperParametersKeyT>(key), std::forward<DefaultHyperParametersValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDefaultHyperParameterRanges(DefaultHyperParameterRangesT&& value) {
    ...
    m_defaultHyperParameterRanges = std::forward<DefaultHyperParameterRangesT>(value);
  }
  template <typename DefaultHyperParameterRangesT = DefaultHyperParameterRanges>
  Algorithm& WithDefaultHyperParameterRanges(DefaultHyperParameterRangesT&& value) {
    SetDefaultHyperParameterRanges(std::forward<DefaultHyperParameterRangesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDefaultResourceConfig(DefaultResourceConfigT&& value) {
    ...
    m_defaultResourceConfig = std::forward<DefaultResourceConfigT>(value);
  }
  template <typename DefaultResourceConfigT = Aws::Map<Aws::String, Aws::String>>
  Algorithm& WithDefaultResourceConfig(DefaultResourceConfigT&& value) {
    SetDefaultResourceConfig(std::forward<DefaultResourceConfigT>(value));
    return *this;
  }
  ...
  Algorithm& AddDefaultResourceConfig(DefaultResourceConfigKeyT&& key, DefaultResourceConfigValueT&& value) {
    m_defaultResourceConfigHasBeenSet = true;
    m_defaultResourceConfig.emplace(std::forward<DefaultResourceConfigKeyT>(key), std::forward<DefaultResourceConfigValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTrainingInputMode(TrainingInputModeT&& value) {
    ...
    m_trainingInputMode = std::forward<TrainingInputModeT>(value);
  }
  template <typename TrainingInputModeT = Aws::String>
  Algorithm& WithTrainingInputMode(TrainingInputModeT&& value) {
    SetTrainingInputMode(std::forward<TrainingInputModeT>(value));
    return *this;
  }
  ///@}
