...
namespace Model
{
  ...
  public:
    ...
    inline ListSolutionVersionsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ListSolutionVersionsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ListSolutionVersionsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
