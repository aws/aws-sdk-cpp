...
class ListSolutionVersionsResult {
 public:
  ...
  void SetSolutionVersions(SolutionVersionsT&& value) {
    m_solutionVersionsHasBeenSet = true;
    m_solutionVersions = std::forward<SolutionVersionsT>(value);
  }
  template <typename SolutionVersionsT = Aws::Vector<SolutionVersionSummary>>
  ListSolutionVersionsResult& WithSolutionVersions(SolutionVersionsT&& value) {
    SetSolutionVersions(std::forward<SolutionVersionsT>(value));
    return *this;
  }
  template <typename SolutionVersionsT = SolutionVersionSummary>
  ListSolutionVersionsResult& AddSolutionVersions(SolutionVersionsT&& value) {
    m_solutionVersionsHasBeenSet = true;
    m_solutionVersions.emplace_back(std::forward<SolutionVersionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListSolutionVersionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListSolutionVersionsResult& WithRequestId(RequestIdT&& value) {
