...
namespace Model
{
  ...
  {
  public:
    AWS_PERSONALIZE_API UpdateRecommenderResult() = default;
    ...
    template<typename RecommenderArnT = Aws::String>
    UpdateRecommenderResult& WithRecommenderArn(RecommenderArnT&& value) { SetRecommenderArn(std::forward<RecommenderArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateRecommenderResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
