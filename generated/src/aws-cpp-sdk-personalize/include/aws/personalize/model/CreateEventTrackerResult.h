...
class CreateEventTrackerResult {
 public:
  ...
  template <typename EventTrackerArnT = Aws::String>
  CreateEventTrackerResult& WithEventTrackerArn(EventTrackerArnT&& value) {
  ...
  template <typename TrackingIdT = Aws::String>
  CreateEventTrackerResult& WithTrackingId(TrackingIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateEventTrackerResult& WithRequestId(RequestIdT&& value) {
