...
class DescribeEventTrackerRequest : public PersonalizeRequest {
 public:
  AWS_PERSONALIZE_API DescribeEventTrackerRequest() = default;
  ...
  void SetEventTrackerArn(EventTrackerArnT&& value) {
    ...
    m_eventTrackerArn = std::forward<EventTrackerArnT>(value);
  }
  template <typename EventTrackerArnT = Aws::String>
  DescribeEventTrackerRequest& WithEventTrackerArn(EventTrackerArnT&& value) {
    SetEventTrackerArn(std::forward<EventTrackerArnT>(value));
    return *this;
  }
  ///@}
 private:
