...
class HyperParameterRanges {
 public:
  ...
  void SetIntegerHyperParameterRanges(IntegerHyperParameterRangesT&& value) {
    ...
    m_integerHyperParameterRanges = std::forward<IntegerHyperParameterRangesT>(value);
  }
  template <typename IntegerHyperParameterRangesT = Aws::Vector<IntegerHyperParameterRange>>
  HyperParameterRanges& WithIntegerHyperParameterRanges(IntegerHyperParameterRangesT&& value) {
    SetIntegerHyperParameterRanges(std::forward<IntegerHyperParameterRangesT>(value));
    return *this;
  }
  template <typename IntegerHyperParameterRangesT = IntegerHyperParameterRange>
  HyperParameterRanges& AddIntegerHyperParameterRanges(IntegerHyperParameterRangesT&& value) {
    m_integerHyperParameterRangesHasBeenSet = true;
    m_integerHyperParameterRanges.emplace_back(std::forward<IntegerHyperParameterRangesT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::Vector<ContinuousHyperParameterRange>& GetContinuousHyperParameterRanges() const {
    return m_continuousHyperParameterRanges;
  }
  ...
  void SetContinuousHyperParameterRanges(ContinuousHyperParameterRangesT&& value) {
    ...
    m_continuousHyperParameterRanges = std::forward<ContinuousHyperParameterRangesT>(value);
  }
  template <typename ContinuousHyperParameterRangesT = Aws::Vector<ContinuousHyperParameterRange>>
  HyperParameterRanges& WithContinuousHyperParameterRanges(ContinuousHyperParameterRangesT&& value) {
    SetContinuousHyperParameterRanges(std::forward<ContinuousHyperParameterRangesT>(value));
    return *this;
  }
  template <typename ContinuousHyperParameterRangesT = ContinuousHyperParameterRange>
  HyperParameterRanges& AddContinuousHyperParameterRanges(ContinuousHyperParameterRangesT&& value) {
    m_continuousHyperParameterRangesHasBeenSet = true;
    m_continuousHyperParameterRanges.emplace_back(std::forward<ContinuousHyperParameterRangesT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::Vector<CategoricalHyperParameterRange>& GetCategoricalHyperParameterRanges() const {
    return m_categoricalHyperParameterRanges;
  }
  ...
  void SetCategoricalHyperParameterRanges(CategoricalHyperParameterRangesT&& value) {
    ...
    m_categoricalHyperParameterRanges = std::forward<CategoricalHyperParameterRangesT>(value);
  }
  template <typename CategoricalHyperParameterRangesT = Aws::Vector<CategoricalHyperParameterRange>>
  HyperParameterRanges& WithCategoricalHyperParameterRanges(CategoricalHyperParameterRangesT&& value) {
    SetCategoricalHyperParameterRanges(std::forward<CategoricalHyperParameterRangesT>(value));
    return *this;
  }
  template <typename CategoricalHyperParameterRangesT = CategoricalHyperParameterRange>
  HyperParameterRanges& AddCategoricalHyperParameterRanges(CategoricalHyperParameterRangesT&& value) {
    m_categoricalHyperParameterRangesHasBeenSet = true;
    m_categoricalHyperParameterRanges.emplace_back(std::forward<CategoricalHyperParameterRangesT>(value));
    return *this;
  }
  ///@}
 private:
