...
class ListRecipesResult {
 public:
  ...
  template <typename RecipesT = Aws::Vector<RecipeSummary>>
  ListRecipesResult& WithRecipes(RecipesT&& value) {
    SetRecipes(std::forward<RecipesT>(value));
    return *this;
  }
  template <typename RecipesT = RecipeSummary>
  ListRecipesResult& AddRecipes(RecipesT&& value) {
    m_recipesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListRecipesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListRecipesResult& WithRequestId(RequestIdT&& value) {
