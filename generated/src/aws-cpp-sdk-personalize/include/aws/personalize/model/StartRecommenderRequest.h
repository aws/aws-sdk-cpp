...
namespace Model
{
  ...
  {
  public:
    AWS_PERSONALIZE_API StartRecommenderRequest() = default;
    ...
    template<typename RecommenderArnT = Aws::String>
    StartRecommenderRequest& WithRecommenderArn(RecommenderArnT&& value) { SetRecommenderArn(std::forward<RecommenderArnT>(value)); return *this;}
    ///@}
  private:
