...
class ListBatchSegmentJobsRequest : public PersonalizeRequest {
 public:
  ...
  template <typename SolutionVersionArnT = Aws::String>
  ListBatchSegmentJobsRequest& WithSolutionVersionArn(SolutionVersionArnT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListBatchSegmentJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListBatchSegmentJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
