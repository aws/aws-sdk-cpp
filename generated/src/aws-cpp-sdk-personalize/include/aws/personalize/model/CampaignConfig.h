...
class CampaignConfig {
 public:
  ...
  inline void SetEnableMetadataWithRecommendations(bool value) {
    m_enableMetadataWithRecommendationsHasBeenSet = true;
    m_enableMetadataWithRecommendations = value;
  }
  inline CampaignConfig& WithEnableMetadataWithRecommendations(bool value) {
    SetEnableMetadataWithRecommendations(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSyncWithLatestSolutionVersion(bool value) {
    m_syncWithLatestSolutionVersionHasBeenSet = true;
    m_syncWithLatestSolutionVersion = value;
  }
  inline CampaignConfig& WithSyncWithLatestSolutionVersion(bool value) {
    SetSyncWithLatestSolutionVersion(value);
    return *this;
  }
  ///@}
 private:
