...
class CreateDatasetGroupRequest : public PersonalizeRequest {
 public:
  AWS_PERSONALIZE_API CreateDatasetGroupRequest() = default;
  ...
  template <typename NameT = Aws::String>
  CreateDatasetGroupRequest& WithName(NameT&& value) {
  ...
  template <typename RoleArnT = Aws::String>
  CreateDatasetGroupRequest& WithRoleArn(RoleArnT&& value) {
  ...
  template <typename KmsKeyArnT = Aws::String>
  CreateDatasetGroupRequest& WithKmsKeyArn(KmsKeyArnT&& value) {
  ...
  inline void SetDomain(Domain value) {
    m_domainHasBeenSet = true;
    m_domain = value;
  }
  inline CreateDatasetGroupRequest& WithDomain(Domain value) {
    SetDomain(value);
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateDatasetGroupRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateDatasetGroupRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
