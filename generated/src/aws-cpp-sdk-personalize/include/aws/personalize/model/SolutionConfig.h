...
class SolutionConfig {
 public:
  ...
  void SetEventValueThreshold(EventValueThresholdT&& value) {
    ...
    m_eventValueThreshold = std::forward<EventValueThresholdT>(value);
  }
  template <typename EventValueThresholdT = Aws::String>
  SolutionConfig& WithEventValueThreshold(EventValueThresholdT&& value) {
    SetEventValueThreshold(std::forward<EventValueThresholdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFeatureTransformationParameters(FeatureTransformationParametersT&& value) {
    ...
    m_featureTransformationParameters = std::forward<FeatureTransformationParametersT>(value);
  }
  template <typename FeatureTransformationParametersT = Aws::Map<Aws::String, Aws::String>>
  SolutionConfig& WithFeatureTransformationParameters(FeatureTransformationParametersT&& value) {
    SetFeatureTransformationParameters(std::forward<FeatureTransformationParametersT>(value));
    return *this;
  }
  ...
  SolutionConfig& AddFeatureTransformationParameters(FeatureTransformationParametersKeyT&& key,
                                                     FeatureTransformationParametersValueT&& value) {
    m_featureTransformationParametersHasBeenSet = true;
    m_featureTransformationParameters.emplace(std::forward<FeatureTransformationParametersKeyT>(key),
                                              std::forward<FeatureTransformationParametersValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAutoMLConfig(AutoMLConfigT&& value) {
    ...
    m_autoMLConfig = std::forward<AutoMLConfigT>(value);
  }
  template <typename AutoMLConfigT = AutoMLConfig>
  SolutionConfig& WithAutoMLConfig(AutoMLConfigT&& value) {
    SetAutoMLConfig(std::forward<AutoMLConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOptimizationObjective(OptimizationObjectiveT&& value) {
    ...
    m_optimizationObjective = std::forward<OptimizationObjectiveT>(value);
  }
  template <typename OptimizationObjectiveT = OptimizationObjective>
  SolutionConfig& WithOptimizationObjective(OptimizationObjectiveT&& value) {
    SetOptimizationObjective(std::forward<OptimizationObjectiveT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAutoTrainingConfig(AutoTrainingConfigT&& value) {
    ...
    m_autoTrainingConfig = std::forward<AutoTrainingConfigT>(value);
  }
  template <typename AutoTrainingConfigT = AutoTrainingConfig>
  SolutionConfig& WithAutoTrainingConfig(AutoTrainingConfigT&& value) {
    SetAutoTrainingConfig(std::forward<AutoTrainingConfigT>(value));
    return *this;
  }
  ///@}
 private:
