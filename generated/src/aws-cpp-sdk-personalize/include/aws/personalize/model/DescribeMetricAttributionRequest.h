...
namespace Model
{
  ...
  {
  public:
    AWS_PERSONALIZE_API DescribeMetricAttributionRequest() = default;
    ...
    template<typename MetricAttributionArnT = Aws::String>
    DescribeMetricAttributionRequest& WithMetricAttributionArn(MetricAttributionArnT&& value) { SetMetricAttributionArn(std::forward<MetricAttributionArnT>(value)); return *this;}
    ///@}
  private:
