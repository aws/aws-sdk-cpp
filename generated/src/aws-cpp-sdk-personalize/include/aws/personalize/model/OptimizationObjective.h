...
class OptimizationObjective {
 public:
  ...
  void SetItemAttribute(ItemAttributeT&& value) {
    m_itemAttributeHasBeenSet = true;
    m_itemAttribute = std::forward<ItemAttributeT>(value);
  }
  template <typename ItemAttributeT = Aws::String>
  OptimizationObjective& WithItemAttribute(ItemAttributeT&& value) {
    SetItemAttribute(std::forward<ItemAttributeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetObjectiveSensitivity(ObjectiveSensitivity value) {
    m_objectiveSensitivityHasBeenSet = true;
    m_objectiveSensitivity = value;
  }
  inline OptimizationObjective& WithObjectiveSensitivity(ObjectiveSensitivity value) {
    SetObjectiveSensitivity(value);
    return *this;
  }
  ///@}
 private:
