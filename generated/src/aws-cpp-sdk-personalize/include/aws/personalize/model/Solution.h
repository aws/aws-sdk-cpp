...
class Solution {
 public:
  ...
  inline Solution& WithPerformHPO(bool value) {
    SetPerformHPO(value);
    return *this;
  }
  ///@}
  ...
  inline Solution& WithPerformAutoML(bool value) {
  ...
  inline Solution& WithPerformAutoTraining(bool value) {
  ...
  void SetAutoMLResult(AutoMLResultT&& value) {
    ...
    m_autoMLResult = std::forward<AutoMLResultT>(value);
  }
  template <typename AutoMLResultT = AutoMLResult>
  Solution& WithAutoMLResult(AutoMLResultT&& value) {
    SetAutoMLResult(std::forward<AutoMLResultT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLatestSolutionVersion(LatestSolutionVersionT&& value) {
    ...
    m_latestSolutionVersion = std::forward<LatestSolutionVersionT>(value);
  }
  template <typename LatestSolutionVersionT = SolutionVersionSummary>
  Solution& WithLatestSolutionVersion(LatestSolutionVersionT&& value) {
    SetLatestSolutionVersion(std::forward<LatestSolutionVersionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLatestSolutionUpdate(LatestSolutionUpdateT&& value) {
    ...
    m_latestSolutionUpdate = std::forward<LatestSolutionUpdateT>(value);
  }
  template <typename LatestSolutionUpdateT = SolutionUpdateSummary>
  Solution& WithLatestSolutionUpdate(LatestSolutionUpdateT&& value) {
    SetLatestSolutionUpdate(std::forward<LatestSolutionUpdateT>(value));
    return *this;
  }
  ///@}
 private:
