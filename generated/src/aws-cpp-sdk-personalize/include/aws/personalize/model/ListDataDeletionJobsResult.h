...
class ListDataDeletionJobsResult {
 public:
  ...
  void SetDataDeletionJobs(DataDeletionJobsT&& value) {
    m_dataDeletionJobsHasBeenSet = true;
    m_dataDeletionJobs = std::forward<DataDeletionJobsT>(value);
  }
  template <typename DataDeletionJobsT = Aws::Vector<DataDeletionJobSummary>>
  ListDataDeletionJobsResult& WithDataDeletionJobs(DataDeletionJobsT&& value) {
    SetDataDeletionJobs(std::forward<DataDeletionJobsT>(value));
    return *this;
  }
  template <typename DataDeletionJobsT = DataDeletionJobSummary>
  ListDataDeletionJobsResult& AddDataDeletionJobs(DataDeletionJobsT&& value) {
    m_dataDeletionJobsHasBeenSet = true;
    m_dataDeletionJobs.emplace_back(std::forward<DataDeletionJobsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListDataDeletionJobsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDataDeletionJobsResult& WithRequestId(RequestIdT&& value) {
