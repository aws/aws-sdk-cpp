...
class ListMetricAttributionMetricsResult {
 public:
  ...
  template <typename MetricsT = Aws::Vector<MetricAttribute>>
  ListMetricAttributionMetricsResult& WithMetrics(MetricsT&& value) {
    SetMetrics(std::forward<MetricsT>(value));
    return *this;
  }
  template <typename MetricsT = MetricAttribute>
  ListMetricAttributionMetricsResult& AddMetrics(MetricsT&& value) {
    m_metricsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListMetricAttributionMetricsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListMetricAttributionMetricsResult& WithRequestId(RequestIdT&& value) {
