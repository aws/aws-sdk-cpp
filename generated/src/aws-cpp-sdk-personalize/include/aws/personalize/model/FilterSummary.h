...
class FilterSummary {
 public:
  AWS_PERSONALIZE_API FilterSummary() = default;
  ...
  template <typename NameT = Aws::String>
  FilterSummary& WithName(NameT&& value) {
  ...
  template <typename FilterArnT = Aws::String>
  FilterSummary& WithFilterArn(FilterArnT&& value) {
  ...
  template <typename CreationDateTimeT = Aws::Utils::DateTime>
  FilterSummary& WithCreationDateTime(CreationDateTimeT&& value) {
  ...
  template <typename LastUpdatedDateTimeT = Aws::Utils::DateTime>
  FilterSummary& WithLastUpdatedDateTime(LastUpdatedDateTimeT&& value) {
  ...
  template <typename DatasetGroupArnT = Aws::String>
  FilterSummary& WithDatasetGroupArn(DatasetGroupArnT&& value) {
  ...
  template <typename FailureReasonT = Aws::String>
  FilterSummary& WithFailureReason(FailureReasonT&& value) {
  ...
  template <typename StatusT = Aws::String>
  FilterSummary& WithStatus(StatusT&& value) {
