...
class UpdateDatasetRequest : public PersonalizeRequest {
 public:
  AWS_PERSONALIZE_API UpdateDatasetRequest() = default;
  ...
  template <typename DatasetArnT = Aws::String>
  UpdateDatasetRequest& WithDatasetArn(DatasetArnT&& value) {
  ...
  template <typename SchemaArnT = Aws::String>
  UpdateDatasetRequest& WithSchemaArn(SchemaArnT&& value) {
