...
class HPOConfig {
 public:
  ...
  void SetHpoObjective(HpoObjectiveT&& value) {
    ...
    m_hpoObjective = std::forward<HpoObjectiveT>(value);
  }
  template <typename HpoObjectiveT = HPOObjective>
  HPOConfig& WithHpoObjective(HpoObjectiveT&& value) {
    SetHpoObjective(std::forward<HpoObjectiveT>(value));
    return *this;
  }
  ///@}
  ...
  void SetHpoResourceConfig(HpoResourceConfigT&& value) {
    ...
    m_hpoResourceConfig = std::forward<HpoResourceConfigT>(value);
  }
  template <typename HpoResourceConfigT = HPOResourceConfig>
  HPOConfig& WithHpoResourceConfig(HpoResourceConfigT&& value) {
    SetHpoResourceConfig(std::forward<HpoResourceConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAlgorithmHyperParameterRanges(AlgorithmHyperParameterRangesT&& value) {
    ...
    m_algorithmHyperParameterRanges = std::forward<AlgorithmHyperParameterRangesT>(value);
  }
  template <typename AlgorithmHyperParameterRangesT = HyperParameterRanges>
  HPOConfig& WithAlgorithmHyperParameterRanges(AlgorithmHyperParameterRangesT&& value) {
    SetAlgorithmHyperParameterRanges(std::forward<AlgorithmHyperParameterRangesT>(value));
    return *this;
  }
  ///@}
 private:
