...
class FeatureTransformation {
 public:
  ...
  void SetFeatureTransformationArn(FeatureTransformationArnT&& value) {
    ...
    m_featureTransformationArn = std::forward<FeatureTransformationArnT>(value);
  }
  template <typename FeatureTransformationArnT = Aws::String>
  FeatureTransformation& WithFeatureTransformationArn(FeatureTransformationArnT&& value) {
    SetFeatureTransformationArn(std::forward<FeatureTransformationArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDefaultParameters(DefaultParametersT&& value) {
    ...
    m_defaultParameters = std::forward<DefaultParametersT>(value);
  }
  template <typename DefaultParametersT = Aws::Map<Aws::String, Aws::String>>
  FeatureTransformation& WithDefaultParameters(DefaultParametersT&& value) {
    SetDefaultParameters(std::forward<DefaultParametersT>(value));
    return *this;
  }
  ...
  FeatureTransformation& AddDefaultParameters(DefaultParametersKeyT&& key, DefaultParametersValueT&& value) {
    m_defaultParametersHasBeenSet = true;
    m_defaultParameters.emplace(std::forward<DefaultParametersKeyT>(key), std::forward<DefaultParametersValueT>(value));
    return *this;
  }
  ///@}
