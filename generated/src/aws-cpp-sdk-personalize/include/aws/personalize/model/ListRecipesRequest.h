...
class ListRecipesRequest : public PersonalizeRequest {
 public:
  ...
  inline void SetRecipeProvider(RecipeProvider value) {
    m_recipeProviderHasBeenSet = true;
    m_recipeProvider = value;
  }
  inline ListRecipesRequest& WithRecipeProvider(RecipeProvider value) {
    SetRecipeProvider(value);
    return *this;
  }
  ///@}
  ...
  inline ListRecipesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline ListRecipesRequest& WithDomain(Domain value) {
    SetDomain(value);
    return *this;
  }
  ///@}
