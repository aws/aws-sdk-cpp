...
class ListDataDeletionJobsRequest : public PersonalizeRequest {
 public:
  ...
  template <typename DatasetGroupArnT = Aws::String>
  ListDataDeletionJobsRequest& WithDatasetGroupArn(DatasetGroupArnT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListDataDeletionJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListDataDeletionJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
