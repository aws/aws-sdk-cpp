...
class ListMetricAttributionMetricsRequest : public PersonalizeRequest {
 public:
  ...
  template <typename MetricAttributionArnT = Aws::String>
  ListMetricAttributionMetricsRequest& WithMetricAttributionArn(MetricAttributionArnT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListMetricAttributionMetricsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListMetricAttributionMetricsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
