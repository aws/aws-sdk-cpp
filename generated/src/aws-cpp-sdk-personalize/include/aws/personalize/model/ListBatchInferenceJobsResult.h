...
class ListBatchInferenceJobsResult {
 public:
  ...
  void SetBatchInferenceJobs(BatchInferenceJobsT&& value) {
    m_batchInferenceJobsHasBeenSet = true;
    m_batchInferenceJobs = std::forward<BatchInferenceJobsT>(value);
  }
  template <typename BatchInferenceJobsT = Aws::Vector<BatchInferenceJobSummary>>
  ListBatchInferenceJobsResult& WithBatchInferenceJobs(BatchInferenceJobsT&& value) {
    SetBatchInferenceJobs(std::forward<BatchInferenceJobsT>(value));
    return *this;
  }
  template <typename BatchInferenceJobsT = BatchInferenceJobSummary>
  ListBatchInferenceJobsResult& AddBatchInferenceJobs(BatchInferenceJobsT&& value) {
    m_batchInferenceJobsHasBeenSet = true;
    m_batchInferenceJobs.emplace_back(std::forward<BatchInferenceJobsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListBatchInferenceJobsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListBatchInferenceJobsResult& WithRequestId(RequestIdT&& value) {
