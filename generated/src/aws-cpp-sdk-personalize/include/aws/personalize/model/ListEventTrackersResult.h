...
class ListEventTrackersResult {
 public:
  ...
  void SetEventTrackers(EventTrackersT&& value) {
    m_eventTrackersHasBeenSet = true;
    m_eventTrackers = std::forward<EventTrackersT>(value);
  }
  template <typename EventTrackersT = Aws::Vector<EventTrackerSummary>>
  ListEventTrackersResult& WithEventTrackers(EventTrackersT&& value) {
    SetEventTrackers(std::forward<EventTrackersT>(value));
    return *this;
  }
  template <typename EventTrackersT = EventTrackerSummary>
  ListEventTrackersResult& AddEventTrackers(EventTrackersT&& value) {
    m_eventTrackersHasBeenSet = true;
    m_eventTrackers.emplace_back(std::forward<EventTrackersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListEventTrackersResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListEventTrackersResult& WithRequestId(RequestIdT&& value) {
