...
class ListMetricAttributionsRequest : public PersonalizeRequest {
 public:
  ...
  template <typename DatasetGroupArnT = Aws::String>
  ListMetricAttributionsRequest& WithDatasetGroupArn(DatasetGroupArnT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListMetricAttributionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListMetricAttributionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
