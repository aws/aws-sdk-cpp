...
class DescribeFeatureTransformationResult {
 public:
  ...
  AWS_PERSONALIZE_API DescribeFeatureTransformationResult& operator=(
  ...
  void SetFeatureTransformation(FeatureTransformationT&& value) {
    m_featureTransformationHasBeenSet = true;
    m_featureTransformation = std::forward<FeatureTransformationT>(value);
  }
  template <typename FeatureTransformationT = FeatureTransformation>
  DescribeFeatureTransformationResult& WithFeatureTransformation(FeatureTransformationT&& value) {
    SetFeatureTransformation(std::forward<FeatureTransformationT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeFeatureTransformationResult& WithRequestId(RequestIdT&& value) {
