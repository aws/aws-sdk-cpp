...
namespace Model
{
  ...
  /**
   */
  class ListSolutionsRequest : public PersonalizeRequest
  {
  public:
    AWS_PERSONALIZE_API ListSolutionsRequest() = default;
    ...
    template<typename DatasetGroupArnT = Aws::String>
    ListSolutionsRequest& WithDatasetGroupArn(DatasetGroupArnT&& value) { SetDatasetGroupArn(std::forward<DatasetGroupArnT>(value)); return *this;}
    ///@}
