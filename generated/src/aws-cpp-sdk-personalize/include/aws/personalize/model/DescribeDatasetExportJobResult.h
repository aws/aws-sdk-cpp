...
class DescribeDatasetExportJobResult {
 public:
  ...
  void SetDatasetExportJob(DatasetExportJobT&& value) {
    m_datasetExportJobHasBeenSet = true;
    m_datasetExportJob = std::forward<DatasetExportJobT>(value);
  }
  template <typename DatasetExportJobT = DatasetExportJob>
  DescribeDatasetExportJobResult& WithDatasetExportJob(DatasetExportJobT&& value) {
    SetDatasetExportJob(std::forward<DatasetExportJobT>(value));
    return *this;
  }
  ///@}
