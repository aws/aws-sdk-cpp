...
class CreateRecommenderRequest : public PersonalizeRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  CreateRecommenderRequest& WithName(NameT&& value) {
  ...
  template <typename DatasetGroupArnT = Aws::String>
  CreateRecommenderRequest& WithDatasetGroupArn(DatasetGroupArnT&& value) {
  ...
  template <typename RecipeArnT = Aws::String>
  CreateRecommenderRequest& WithRecipeArn(RecipeArnT&& value) {
  ...
  CreateRecommenderRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
