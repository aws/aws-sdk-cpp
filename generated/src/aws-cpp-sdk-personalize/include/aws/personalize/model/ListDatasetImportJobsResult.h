...
class ListDatasetImportJobsResult {
 public:
  ...
  void SetDatasetImportJobs(DatasetImportJobsT&& value) {
    m_datasetImportJobsHasBeenSet = true;
    m_datasetImportJobs = std::forward<DatasetImportJobsT>(value);
  }
  template <typename DatasetImportJobsT = Aws::Vector<DatasetImportJobSummary>>
  ListDatasetImportJobsResult& WithDatasetImportJobs(DatasetImportJobsT&& value) {
    SetDatasetImportJobs(std::forward<DatasetImportJobsT>(value));
    return *this;
  }
  template <typename DatasetImportJobsT = DatasetImportJobSummary>
  ListDatasetImportJobsResult& AddDatasetImportJobs(DatasetImportJobsT&& value) {
    m_datasetImportJobsHasBeenSet = true;
    m_datasetImportJobs.emplace_back(std::forward<DatasetImportJobsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListDatasetImportJobsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDatasetImportJobsResult& WithRequestId(RequestIdT&& value) {
