...
class IntegerHyperParameterRange {
 public:
  ...
  template <typename NameT = Aws::String>
  IntegerHyperParameterRange& WithName(NameT&& value) {
  ...
  inline IntegerHyperParameterRange& WithMinValue(int value) {
    SetMinValue(value);
    return *this;
  }
  ///@}
  ...
  inline IntegerHyperParameterRange& WithMaxValue(int value) {
    SetMaxValue(value);
    return *this;
  }
  ///@}
