...
class DefaultContinuousHyperParameterRange {
 public:
  ...
  template <typename NameT = Aws::String>
  DefaultContinuousHyperParameterRange& WithName(NameT&& value) {
  ...
  inline DefaultContinuousHyperParameterRange& WithMinValue(double value) {
    SetMinValue(value);
    return *this;
  }
  ///@}
  ...
  inline DefaultContinuousHyperParameterRange& WithMaxValue(double value) {
    SetMaxValue(value);
    return *this;
  }
  ///@}
  ...
  inline DefaultContinuousHyperParameterRange& WithIsTunable(bool value) {
    SetIsTunable(value);
    return *this;
  }
  ///@}
