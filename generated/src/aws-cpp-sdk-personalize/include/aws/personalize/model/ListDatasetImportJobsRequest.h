...
class ListDatasetImportJobsRequest : public PersonalizeRequest {
 public:
  AWS_PERSONALIZE_API ListDatasetImportJobsRequest() = default;
  ...
  template <typename DatasetArnT = Aws::String>
  ListDatasetImportJobsRequest& WithDatasetArn(DatasetArnT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListDatasetImportJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListDatasetImportJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
