...
class ListBatchSegmentJobsResult {
 public:
  ...
  void SetBatchSegmentJobs(BatchSegmentJobsT&& value) {
    m_batchSegmentJobsHasBeenSet = true;
    m_batchSegmentJobs = std::forward<BatchSegmentJobsT>(value);
  }
  template <typename BatchSegmentJobsT = Aws::Vector<BatchSegmentJobSummary>>
  ListBatchSegmentJobsResult& WithBatchSegmentJobs(BatchSegmentJobsT&& value) {
    SetBatchSegmentJobs(std::forward<BatchSegmentJobsT>(value));
    return *this;
  }
  template <typename BatchSegmentJobsT = BatchSegmentJobSummary>
  ListBatchSegmentJobsResult& AddBatchSegmentJobs(BatchSegmentJobsT&& value) {
    m_batchSegmentJobsHasBeenSet = true;
    m_batchSegmentJobs.emplace_back(std::forward<BatchSegmentJobsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListBatchSegmentJobsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListBatchSegmentJobsResult& WithRequestId(RequestIdT&& value) {
