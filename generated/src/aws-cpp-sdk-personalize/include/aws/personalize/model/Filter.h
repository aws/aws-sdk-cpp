...
class Filter {
 public:
  ...
  template <typename FilterArnT = Aws::String>
  Filter& WithFilterArn(FilterArnT&& value) {
  ...
  template <typename CreationDateTimeT = Aws::Utils::DateTime>
  Filter& WithCreationDateTime(CreationDateTimeT&& value) {
  ...
  template <typename LastUpdatedDateTimeT = Aws::Utils::DateTime>
  Filter& WithLastUpdatedDateTime(LastUpdatedDateTimeT&& value) {
  ...
  template <typename DatasetGroupArnT = Aws::String>
  Filter& WithDatasetGroupArn(DatasetGroupArnT&& value) {
  ...
  template <typename FailureReasonT = Aws::String>
  Filter& WithFailureReason(FailureReasonT&& value) {
  ...
  template <typename FilterExpressionT = Aws::String>
  Filter& WithFilterExpression(FilterExpressionT&& value) {
