...
class CreateDatasetImportJobRequest : public PersonalizeRequest {
 public:
  ...
  inline void SetPublishAttributionMetricsToS3(bool value) {
    m_publishAttributionMetricsToS3HasBeenSet = true;
    m_publishAttributionMetricsToS3 = value;
  }
  inline CreateDatasetImportJobRequest& WithPublishAttributionMetricsToS3(bool value) {
    SetPublishAttributionMetricsToS3(value);
    return *this;
  }
  ///@}
 private:
