...
class ContinuousHyperParameterRange {
 public:
  AWS_PERSONALIZE_API ContinuousHyperParameterRange() = default;
  ...
  template <typename NameT = Aws::String>
  ContinuousHyperParameterRange& WithName(NameT&& value) {
  ...
  inline ContinuousHyperParameterRange& WithMinValue(double value) {
    SetMinValue(value);
    return *this;
  }
  ///@}
  ...
  inline ContinuousHyperParameterRange& WithMaxValue(double value) {
    SetMaxValue(value);
    return *this;
  }
  ///@}
