...
class ListEventTrackersRequest : public PersonalizeRequest {
 public:
  ...
  template <typename DatasetGroupArnT = Aws::String>
  ListEventTrackersRequest& WithDatasetGroupArn(DatasetGroupArnT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListEventTrackersRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListEventTrackersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
