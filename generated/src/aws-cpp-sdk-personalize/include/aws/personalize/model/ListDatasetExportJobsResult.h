...
namespace Model
{
  ...
  public:
    ...
    void SetDatasetExportJobs(DatasetExportJobsT&& value) { m_datasetExportJobsHasBeenSet = true; m_datasetExportJobs = std::forward<DatasetExportJobsT>(value); }
    template<typename DatasetExportJobsT = Aws::Vector<DatasetExportJobSummary>>
    ListDatasetExportJobsResult& WithDatasetExportJobs(DatasetExportJobsT&& value) { SetDatasetExportJobs(std::forward<DatasetExportJobsT>(value)); return *this;}
    template<typename DatasetExportJobsT = DatasetExportJobSummary>
    ListDatasetExportJobsResult& AddDatasetExportJobs(DatasetExportJobsT&& value) { m_datasetExportJobsHasBeenSet = true; m_datasetExportJobs.emplace_back(std::forward<DatasetExportJobsT>(value)); return *this; }
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListDatasetExportJobsResult& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ListDatasetExportJobsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
