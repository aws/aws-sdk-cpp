...
namespace AppConfig
{
const size_t AppConfigEndpointRules::RulesBlobStrLen = 3856;
const size_t AppConfigEndpointRules::RulesBlobSize = 3857;
...
'"',':','"','h','t','t','p','s',':','/','/','a','p','p','c','o','n','f','i','g','.','u','s','-','g',
...
't','p','s',':','/','/','a','p','p','c','o','n','f','i','g','.','{','R','e','g','i','o','n','}','.',
