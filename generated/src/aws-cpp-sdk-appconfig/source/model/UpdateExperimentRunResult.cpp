...
UpdateExperimentRunResult::UpdateExperimentRunResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

UpdateExperimentRunResult& UpdateExperimentRunResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
