...
UpdateExperimentDefinitionResult::UpdateExperimentDefinitionResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

UpdateExperimentDefinitionResult& UpdateExperimentDefinitionResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
