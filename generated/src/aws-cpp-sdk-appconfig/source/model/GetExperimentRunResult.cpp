...
GetExperimentRunResult::GetExperimentRunResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

GetExperimentRunResult& GetExperimentRunResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
