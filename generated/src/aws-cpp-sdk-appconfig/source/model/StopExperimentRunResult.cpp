...
StopExperimentRunResult::StopExperimentRunResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

StopExperimentRunResult& StopExperimentRunResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
