...
CreateExperimentDefinitionResult::CreateExperimentDefinitionResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

CreateExperimentDefinitionResult& CreateExperimentDefinitionResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
