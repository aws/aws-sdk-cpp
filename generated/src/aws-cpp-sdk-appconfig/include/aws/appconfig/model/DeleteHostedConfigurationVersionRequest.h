...
class DeleteHostedConfigurationVersionRequest : public AppConfigRequest {
 public:
  ...
  template <typename ApplicationIdT = Aws::String>
  DeleteHostedConfigurationVersionRequest& WithApplicationId(ApplicationIdT&& value) {
  ...
  template <typename ConfigurationProfileIdT = Aws::String>
  DeleteHostedConfigurationVersionRequest& WithConfigurationProfileId(ConfigurationProfileIdT&& value) {
  ...
  inline DeleteHostedConfigurationVersionRequest& WithVersionNumber(int value) {
