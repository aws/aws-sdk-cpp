...
class ListExtensionsResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<ExtensionSummary>>
  ListExtensionsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = ExtensionSummary>
  ListExtensionsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListExtensionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListExtensionsResult& WithRequestId(RequestIdT&& value) {
