...
class DeleteConfigurationProfileRequest : public AppConfigRequest {
 public:
  ...
  inline void SetDeletionProtectionCheck(DeletionProtectionCheck value) {
    m_deletionProtectionCheckHasBeenSet = true;
    m_deletionProtectionCheck = value;
  }
  inline DeleteConfigurationProfileRequest& WithDeletionProtectionCheck(DeletionProtectionCheck value) {
    SetDeletionProtectionCheck(value);
    return *this;
  }
  ///@}
 private:
