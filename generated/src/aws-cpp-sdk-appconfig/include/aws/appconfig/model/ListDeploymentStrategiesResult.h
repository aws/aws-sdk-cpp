...
class ListDeploymentStrategiesResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<DeploymentStrategy>>
  ListDeploymentStrategiesResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = DeploymentStrategy>
  ListDeploymentStrategiesResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListDeploymentStrategiesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDeploymentStrategiesResult& WithRequestId(RequestIdT&& value) {
