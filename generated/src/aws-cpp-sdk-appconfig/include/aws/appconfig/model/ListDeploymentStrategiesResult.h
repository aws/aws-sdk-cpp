...
namespace Model
{
  ...
  public:
    ...
    inline ListDeploymentStrategiesResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ListDeploymentStrategiesResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ListDeploymentStrategiesResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
