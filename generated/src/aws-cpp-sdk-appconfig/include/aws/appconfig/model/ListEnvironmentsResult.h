...
namespace Model
{
  ...
  public:
    ...
    template<typename ItemsT = Aws::Vector<Environment>>
    ListEnvironmentsResult& WithItems(ItemsT&& value) { SetItems(std::forward<ItemsT>(value)); return *this;}
    template<typename ItemsT = Environment>
    ListEnvironmentsResult& AddItems(ItemsT&& value) { m_itemsHasBeenSet = true; m_items.emplace_back(std::forward<ItemsT>(value)); return *this; }
    ///@}
