...
class ListExtensionsRequest : public AppConfigRequest {
 public:
  AWS_APPCONFIG_API ListExtensionsRequest() = default;
  ...
  inline ListExtensionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListExtensionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename NameT = Aws::String>
  ListExtensionsRequest& WithName(NameT&& value) {
