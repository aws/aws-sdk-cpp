 ...
 * API Reference</a></p>
 */
class StartExperimentRunResult {
 public:
  ...
  inline StartExperimentRunResult& WithRun(int value) {
    SetRun(value);
    return *this;
  }
  ///@}
  ...
  inline StartExperimentRunResult& WithStatus(ExperimentRunStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline StartExperimentRunResult& WithExposurePercentage(double value) {
