...
class GetExtensionResult {
 public:
  ...
  template <typename IdT = Aws::String>
  GetExtensionResult& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  GetExtensionResult& WithName(NameT&& value) {
  ...
  inline GetExtensionResult& WithVersionNumber(int value) {
  ...
  template <typename ArnT = Aws::String>
  GetExtensionResult& WithArn(ArnT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  GetExtensionResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename ActionsT = Aws::Map<ActionPoint, Aws::Vector<Action>>>
  GetExtensionResult& WithActions(ActionsT&& value) {
  ...
  template <typename ParametersT = Aws::Map<Aws::String, Parameter>>
  GetExtensionResult& WithParameters(ParametersT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetExtensionResult& WithRequestId(RequestIdT&& value) {
