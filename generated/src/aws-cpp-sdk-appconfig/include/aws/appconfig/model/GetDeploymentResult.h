...
namespace Model
{
  ...
  public:
    ...
    template<typename DeploymentStrategyIdT = Aws::String>
    GetDeploymentResult& WithDeploymentStrategyId(DeploymentStrategyIdT&& value) { SetDeploymentStrategyId(std::forward<DeploymentStrategyIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ConfigurationProfileIdT = Aws::String>
    GetDeploymentResult& WithConfigurationProfileId(ConfigurationProfileIdT&& value) { SetConfigurationProfileId(std::forward<ConfigurationProfileIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ConfigurationNameT = Aws::String>
    GetDeploymentResult& WithConfigurationName(ConfigurationNameT&& value) { SetConfigurationName(std::forward<ConfigurationNameT>(value)); return *this;}
    ///@}
    ...
    template<typename ConfigurationLocationUriT = Aws::String>
    GetDeploymentResult& WithConfigurationLocationUri(ConfigurationLocationUriT&& value) { SetConfigurationLocationUri(std::forward<ConfigurationLocationUriT>(value)); return *this;}
    ///@}
    ...
    template<typename ConfigurationVersionT = Aws::String>
    GetDeploymentResult& WithConfigurationVersion(ConfigurationVersionT&& value) { SetConfigurationVersion(std::forward<ConfigurationVersionT>(value)); return *this;}
    ///@}
    ...
    inline GetDeploymentResult& WithGrowthType(GrowthType value) { SetGrowthType(value); return *this;}
    ///@}
    ...
    inline GetDeploymentResult& WithState(DeploymentState value) { SetState(value); return *this;}
    ///@}
    ...
    template<typename EventLogT = Aws::Vector<DeploymentEvent>>
    GetDeploymentResult& WithEventLog(EventLogT&& value) { SetEventLog(std::forward<EventLogT>(value)); return *this;}
    template<typename EventLogT = DeploymentEvent>
    GetDeploymentResult& AddEventLog(EventLogT&& value) { m_eventLogHasBeenSet = true; m_eventLog.emplace_back(std::forward<EventLogT>(value)); return *this; }
    ///@}
    ...
    template<typename StartedAtT = Aws::Utils::DateTime>
    GetDeploymentResult& WithStartedAt(StartedAtT&& value) { SetStartedAt(std::forward<StartedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename CompletedAtT = Aws::Utils::DateTime>
    GetDeploymentResult& WithCompletedAt(CompletedAtT&& value) { SetCompletedAt(std::forward<CompletedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename AppliedExtensionsT = Aws::Vector<AppliedExtension>>
    GetDeploymentResult& WithAppliedExtensions(AppliedExtensionsT&& value) { SetAppliedExtensions(std::forward<AppliedExtensionsT>(value)); return *this;}
    template<typename AppliedExtensionsT = AppliedExtension>
    GetDeploymentResult& AddAppliedExtensions(AppliedExtensionsT&& value) { m_appliedExtensionsHasBeenSet = true; m_appliedExtensions.emplace_back(std::forward<AppliedExtensionsT>(value)); return *this; }
    ///@}
    ...
    template<typename KmsKeyArnT = Aws::String>
    GetDeploymentResult& WithKmsKeyArn(KmsKeyArnT&& value) { SetKmsKeyArn(std::forward<KmsKeyArnT>(value)); return *this;}
    ///@}
    ...
    template<typename KmsKeyIdentifierT = Aws::String>
    GetDeploymentResult& WithKmsKeyIdentifier(KmsKeyIdentifierT&& value) { SetKmsKeyIdentifier(std::forward<KmsKeyIdentifierT>(value)); return *this;}
    ///@}
    ...
    template<typename VersionLabelT = Aws::String>
    GetDeploymentResult& WithVersionLabel(VersionLabelT&& value) { SetVersionLabel(std::forward<VersionLabelT>(value)); return *this;}
    ///@}
