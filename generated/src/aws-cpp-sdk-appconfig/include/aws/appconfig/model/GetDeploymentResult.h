...
class GetDeploymentResult {
 public:
  ...
  inline GetDeploymentResult& WithDeploymentNumber(int value) {
  ...
  inline GetDeploymentResult& WithDeploymentDurationInMinutes(int value) {
  ...
  inline GetDeploymentResult& WithGrowthType(GrowthType value) {
    SetGrowthType(value);
    return *this;
  }
  ///@}
  ...
  inline GetDeploymentResult& WithGrowthFactor(double value) {
  ...
  inline GetDeploymentResult& WithFinalBakeTimeInMinutes(int value) {
  ...
  inline GetDeploymentResult& WithState(DeploymentState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline GetDeploymentResult& WithPercentageComplete(double value) {
