...
namespace Model
{
  ...
  {
  public:
    AWS_APPCONFIG_API CreateExtensionAssociationResult() = default;
    ...
    template<typename IdT = Aws::String>
    CreateExtensionAssociationResult& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename ExtensionArnT = Aws::String>
    CreateExtensionAssociationResult& WithExtensionArn(ExtensionArnT&& value) { SetExtensionArn(std::forward<ExtensionArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ResourceArnT = Aws::String>
    CreateExtensionAssociationResult& WithResourceArn(ResourceArnT&& value) { SetResourceArn(std::forward<ResourceArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ArnT = Aws::String>
    CreateExtensionAssociationResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ParametersT = Aws::Map<Aws::String, Aws::String>>
    CreateExtensionAssociationResult& WithParameters(ParametersT&& value) { SetParameters(std::forward<ParametersT>(value)); return *this;}
    template<typename ParametersKeyT = Aws::String, typename ParametersValueT = Aws::String>
    CreateExtensionAssociationResult& AddParameters(ParametersKeyT&& key, ParametersValueT&& value) {
    ...
    template<typename RequestIdT = Aws::String>
    CreateExtensionAssociationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
