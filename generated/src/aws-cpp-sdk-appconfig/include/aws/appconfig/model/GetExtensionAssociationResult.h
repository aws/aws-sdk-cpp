...
class GetExtensionAssociationResult {
 public:
  ...
  template <typename IdT = Aws::String>
  GetExtensionAssociationResult& WithId(IdT&& value) {
  ...
  template <typename ExtensionArnT = Aws::String>
  GetExtensionAssociationResult& WithExtensionArn(ExtensionArnT&& value) {
  ...
  template <typename ResourceArnT = Aws::String>
  GetExtensionAssociationResult& WithResourceArn(ResourceArnT&& value) {
  ...
  template <typename ArnT = Aws::String>
  GetExtensionAssociationResult& WithArn(ArnT&& value) {
  ...
  template <typename ParametersT = Aws::Map<Aws::String, Aws::String>>
  GetExtensionAssociationResult& WithParameters(ParametersT&& value) {
  ...
  inline GetExtensionAssociationResult& WithExtensionVersionNumber(int value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetExtensionAssociationResult& WithRequestId(RequestIdT&& value) {
