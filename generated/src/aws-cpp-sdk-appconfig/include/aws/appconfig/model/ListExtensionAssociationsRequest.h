...
class ListExtensionAssociationsRequest : public AppConfigRequest {
 public:
  ...
  inline void SetExtensionVersionNumber(int value) {
    m_extensionVersionNumberHasBeenSet = true;
    m_extensionVersionNumber = value;
  }
  inline ListExtensionAssociationsRequest& WithExtensionVersionNumber(int value) {
    SetExtensionVersionNumber(value);
    return *this;
  }
  ///@}
  ...
  inline ListExtensionAssociationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
