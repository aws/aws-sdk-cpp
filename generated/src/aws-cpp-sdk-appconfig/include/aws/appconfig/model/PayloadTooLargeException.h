...
class PayloadTooLargeException {
 public:
  ...
  inline void SetMeasure(BytesMeasure value) {
    m_measureHasBeenSet = true;
    m_measure = value;
  }
  inline PayloadTooLargeException& WithMeasure(BytesMeasure value) {
    SetMeasure(value);
    return *this;
  }
  ///@}
  ...
  inline PayloadTooLargeException& WithLimit(double value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  inline PayloadTooLargeException& WithSize(double value) {
    SetSize(value);
    return *this;
  }
  ///@}
