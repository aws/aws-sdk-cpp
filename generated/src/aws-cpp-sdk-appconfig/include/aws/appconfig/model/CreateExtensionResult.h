...
class CreateExtensionResult {
 public:
  ...
  template <typename IdT = Aws::String>
  CreateExtensionResult& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateExtensionResult& WithName(NameT&& value) {
  ...
  inline CreateExtensionResult& WithVersionNumber(int value) {
  ...
  template <typename ArnT = Aws::String>
  CreateExtensionResult& WithArn(ArnT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateExtensionResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename ActionsT = Aws::Map<ActionPoint, Aws::Vector<Action>>>
  CreateExtensionResult& WithActions(ActionsT&& value) {
  ...
  template <typename ParametersT = Aws::Map<Aws::String, Parameter>>
  CreateExtensionResult& WithParameters(ParametersT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateExtensionResult& WithRequestId(RequestIdT&& value) {
