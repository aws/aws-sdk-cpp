...
namespace Model
{
  ...
  {
  public:
    AWS_APPCONFIG_API CreateExtensionResult() = default;
    ...
    template<typename IdT = Aws::String>
    CreateExtensionResult& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    CreateExtensionResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename ArnT = Aws::String>
    CreateExtensionResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    CreateExtensionResult& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename ActionsT = Aws::Map<ActionPoint, Aws::Vector<Action>>>
    CreateExtensionResult& WithActions(ActionsT&& value) { SetActions(std::forward<ActionsT>(value)); return *this;}
    inline CreateExtensionResult& AddActions(ActionPoint key, Aws::Vector<Action> value) {
    ...
    template<typename ParametersT = Aws::Map<Aws::String, Parameter>>
    CreateExtensionResult& WithParameters(ParametersT&& value) { SetParameters(std::forward<ParametersT>(value)); return *this;}
    template<typename ParametersKeyT = Aws::String, typename ParametersValueT = Parameter>
    CreateExtensionResult& AddParameters(ParametersKeyT&& key, ParametersValueT&& value) {
    ...
    template<typename RequestIdT = Aws::String>
    CreateExtensionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
