...
/**
 */
class ListExperimentDefinitionsRequest : public AppConfigRequest {
 public:
  AWS_APPCONFIG_API ListExperimentDefinitionsRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "ListExperimentDefinitions"; }
  ...
  template <typename ApplicationIdentifierT = Aws::String>
  ListExperimentDefinitionsRequest& WithApplicationIdentifier(ApplicationIdentifierT&& value) {
  ...
  template <typename ConfigurationProfileIdentifierT = Aws::String>
  ListExperimentDefinitionsRequest& WithConfigurationProfileIdentifier(ConfigurationProfileIdentifierT&& value) {
  ...
  template <typename EnvironmentIdentifierT = Aws::String>
  ListExperimentDefinitionsRequest& WithEnvironmentIdentifier(EnvironmentIdentifierT&& value) {
  ...
  inline ListExperimentDefinitionsRequest& WithStatus(ExperimentDefinitionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline ListExperimentDefinitionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListExperimentDefinitionsRequest& WithNextToken(NextTokenT&& value) {
