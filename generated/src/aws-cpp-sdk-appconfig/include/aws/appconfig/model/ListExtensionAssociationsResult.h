...
class ListExtensionAssociationsResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<ExtensionAssociationSummary>>
  ListExtensionAssociationsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = ExtensionAssociationSummary>
  ListExtensionAssociationsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListExtensionAssociationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListExtensionAssociationsResult& WithRequestId(RequestIdT&& value) {
