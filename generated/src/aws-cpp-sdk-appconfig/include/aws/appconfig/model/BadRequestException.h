...
class BadRequestException {
 public:
  ...
  inline void SetReason(BadRequestReason value) {
    m_reasonHasBeenSet = true;
    m_reason = value;
  }
  inline BadRequestException& WithReason(BadRequestReason value) {
    SetReason(value);
    return *this;
  }
  ///@}
  ...
  template <typename DetailsT = BadRequestDetails>
  BadRequestException& WithDetails(DetailsT&& value) {
