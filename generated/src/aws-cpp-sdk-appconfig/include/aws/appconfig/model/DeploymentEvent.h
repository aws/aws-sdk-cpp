...
class DeploymentEvent {
 public:
  ...
  inline void SetEventType(DeploymentEventType value) {
    m_eventTypeHasBeenSet = true;
    m_eventType = value;
  }
  inline DeploymentEvent& WithEventType(DeploymentEventType value) {
    SetEventType(value);
    return *this;
  }
  ///@}
  ...
  inline DeploymentEvent& WithTriggeredBy(TriggeredBy value) {
  ...
  void SetActionInvocations(ActionInvocationsT&& value) {
    ...
    m_actionInvocations = std::forward<ActionInvocationsT>(value);
  }
  template <typename ActionInvocationsT = Aws::Vector<ActionInvocation>>
  DeploymentEvent& WithActionInvocations(ActionInvocationsT&& value) {
    SetActionInvocations(std::forward<ActionInvocationsT>(value));
    return *this;
  }
  template <typename ActionInvocationsT = ActionInvocation>
  DeploymentEvent& AddActionInvocations(ActionInvocationsT&& value) {
    m_actionInvocationsHasBeenSet = true;
    m_actionInvocations.emplace_back(std::forward<ActionInvocationsT>(value));
    return *this;
  }
  ///@}
