 ...
 * API Reference</a></p>
 */
class UpdateExperimentDefinitionResult {
 public:
  AWS_APPCONFIG_API UpdateExperimentDefinitionResult() = default;
  AWS_APPCONFIG_API UpdateExperimentDefinitionResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_APPCONFIG_API UpdateExperimentDefinitionResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ApplicationIdT = Aws::String>
  UpdateExperimentDefinitionResult& WithApplicationId(ApplicationIdT&& value) {
  ...
  template <typename IdT = Aws::String>
  UpdateExperimentDefinitionResult& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  UpdateExperimentDefinitionResult& WithName(NameT&& value) {
  ...
  template <typename HypothesisT = Aws::String>
  UpdateExperimentDefinitionResult& WithHypothesis(HypothesisT&& value) {
  ...
  inline UpdateExperimentDefinitionResult& WithStatus(ExperimentDefinitionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ConfigurationProfileIdT = Aws::String>
  UpdateExperimentDefinitionResult& WithConfigurationProfileId(ConfigurationProfileIdT&& value) {
  ...
  template <typename EnvironmentIdT = Aws::String>
  UpdateExperimentDefinitionResult& WithEnvironmentId(EnvironmentIdT&& value) {
  ...
  template <typename FlagKeyT = Aws::String>
  UpdateExperimentDefinitionResult& WithFlagKey(FlagKeyT&& value) {
  ...
  template <typename AudienceRuleT = Aws::String>
  UpdateExperimentDefinitionResult& WithAudienceRule(AudienceRuleT&& value) {
  ...
  template <typename AudienceDescriptionT = Aws::String>
  UpdateExperimentDefinitionResult& WithAudienceDescription(AudienceDescriptionT&& value) {
  ...
  template <typename LaunchCriteriaT = Aws::String>
  UpdateExperimentDefinitionResult& WithLaunchCriteria(LaunchCriteriaT&& value) {
  ...
  template <typename TreatmentsT = Aws::Vector<Treatment>>
  UpdateExperimentDefinitionResult& WithTreatments(TreatmentsT&& value) {
    SetTreatments(std::forward<TreatmentsT>(value));
    return *this;
  }
  template <typename TreatmentsT = Treatment>
  UpdateExperimentDefinitionResult& AddTreatments(TreatmentsT&& value) {
    m_treatmentsHasBeenSet = true;
  ...
  template <typename ControlT = Treatment>
  UpdateExperimentDefinitionResult& WithControl(ControlT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  UpdateExperimentDefinitionResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  UpdateExperimentDefinitionResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  template <typename KmsKeyIdentifierT = Aws::String>
  UpdateExperimentDefinitionResult& WithKmsKeyIdentifier(KmsKeyIdentifierT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateExperimentDefinitionResult& WithRequestId(RequestIdT&& value) {
