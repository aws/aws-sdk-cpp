...
class StartDeploymentResult {
 public:
  ...
  void SetDeploymentStrategyId(DeploymentStrategyIdT&& value) {
    ...
    m_deploymentStrategyId = std::forward<DeploymentStrategyIdT>(value);
  }
  template <typename DeploymentStrategyIdT = Aws::String>
  StartDeploymentResult& WithDeploymentStrategyId(DeploymentStrategyIdT&& value) {
    SetDeploymentStrategyId(std::forward<DeploymentStrategyIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetDeploymentNumber(int value) {
    m_deploymentNumberHasBeenSet = true;
    m_deploymentNumber = value;
  }
  inline StartDeploymentResult& WithDeploymentNumber(int value) {
  ...
  void SetConfigurationLocationUri(ConfigurationLocationUriT&& value) {
    ...
    m_configurationLocationUri = std::forward<ConfigurationLocationUriT>(value);
  }
  template <typename ConfigurationLocationUriT = Aws::String>
  StartDeploymentResult& WithConfigurationLocationUri(ConfigurationLocationUriT&& value) {
    SetConfigurationLocationUri(std::forward<ConfigurationLocationUriT>(value));
    return *this;
  }
  ///@}
  ...
  void SetConfigurationVersion(ConfigurationVersionT&& value) {
    ...
    m_configurationVersion = std::forward<ConfigurationVersionT>(value);
  }
  template <typename ConfigurationVersionT = Aws::String>
  StartDeploymentResult& WithConfigurationVersion(ConfigurationVersionT&& value) {
    SetConfigurationVersion(std::forward<ConfigurationVersionT>(value));
    return *this;
  }
  ///@}
  ...
  inline StartDeploymentResult& WithDeploymentDurationInMinutes(int value) {
  ...
  inline StartDeploymentResult& WithGrowthType(GrowthType value) {
    SetGrowthType(value);
    return *this;
  }
  ///@}
  ...
  inline StartDeploymentResult& WithGrowthFactor(double value) {
  ...
  inline StartDeploymentResult& WithFinalBakeTimeInMinutes(int value) {
  ...
  inline void SetState(DeploymentState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline StartDeploymentResult& WithState(DeploymentState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPercentageComplete(double value) {
    m_percentageCompleteHasBeenSet = true;
    m_percentageComplete = value;
  }
  inline StartDeploymentResult& WithPercentageComplete(double value) {
