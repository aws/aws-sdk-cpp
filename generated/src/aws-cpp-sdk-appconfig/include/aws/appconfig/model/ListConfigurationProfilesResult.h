...
class ListConfigurationProfilesResult {
 public:
  AWS_APPCONFIG_API ListConfigurationProfilesResult() = default;
  ...
  template <typename ItemsT = Aws::Vector<ConfigurationProfileSummary>>
  void SetItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
    m_items = std::forward<ItemsT>(value);
  }
  template <typename ItemsT = Aws::Vector<ConfigurationProfileSummary>>
  ListConfigurationProfilesResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = ConfigurationProfileSummary>
  ListConfigurationProfilesResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListConfigurationProfilesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListConfigurationProfilesResult& WithRequestId(RequestIdT&& value) {
