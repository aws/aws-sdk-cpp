 ...
 * API Reference</a></p>
 */
class UpdateExperimentRunResult {
 public:
  ...
  inline UpdateExperimentRunResult& WithRun(int value) {
    SetRun(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateExperimentRunResult& WithStatus(ExperimentRunStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateExperimentRunResult& WithExposurePercentage(double value) {
