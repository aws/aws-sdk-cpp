...
class DeploymentSummary {
 public:
  ...
  inline DeploymentSummary& WithDeploymentDurationInMinutes(int value) {
  ...
  inline DeploymentSummary& WithGrowthType(GrowthType value) {
    SetGrowthType(value);
    return *this;
  }
  ///@}
  ...
  inline DeploymentSummary& WithGrowthFactor(double value) {
  ...
  inline DeploymentSummary& WithFinalBakeTimeInMinutes(int value) {
  ...
  inline DeploymentSummary& WithState(DeploymentState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline DeploymentSummary& WithPercentageComplete(double value) {
