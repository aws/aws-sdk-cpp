...
class ListConfigurationProfilesRequest : public AppConfigRequest {
 public:
  AWS_APPCONFIG_API ListConfigurationProfilesRequest() = default;
  ...
  template <typename ApplicationIdT = Aws::String>
  ListConfigurationProfilesRequest& WithApplicationId(ApplicationIdT&& value) {
  ...
  inline ListConfigurationProfilesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListConfigurationProfilesRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename TypeT = Aws::String>
  ListConfigurationProfilesRequest& WithType(TypeT&& value) {
