...
class UpdateEnvironmentResult {
 public:
  ...
  template <typename ApplicationIdT = Aws::String>
  UpdateEnvironmentResult& WithApplicationId(ApplicationIdT&& value) {
  ...
  inline UpdateEnvironmentResult& WithState(EnvironmentState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename MonitorsT = Aws::Vector<Monitor>>
  UpdateEnvironmentResult& WithMonitors(MonitorsT&& value) {
    SetMonitors(std::forward<MonitorsT>(value));
    return *this;
  }
  template <typename MonitorsT = Monitor>
  UpdateEnvironmentResult& AddMonitors(MonitorsT&& value) {
    m_monitorsHasBeenSet = true;
