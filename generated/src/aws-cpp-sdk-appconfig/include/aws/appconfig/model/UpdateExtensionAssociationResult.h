...
class UpdateExtensionAssociationResult {
 public:
  ...
  template <typename IdT = Aws::String>
  UpdateExtensionAssociationResult& WithId(IdT&& value) {
  ...
  template <typename ExtensionArnT = Aws::String>
  UpdateExtensionAssociationResult& WithExtensionArn(ExtensionArnT&& value) {
  ...
  template <typename ResourceArnT = Aws::String>
  UpdateExtensionAssociationResult& WithResourceArn(ResourceArnT&& value) {
  ...
  template <typename ArnT = Aws::String>
  UpdateExtensionAssociationResult& WithArn(ArnT&& value) {
  ...
  template <typename ParametersT = Aws::Map<Aws::String, Aws::String>>
  UpdateExtensionAssociationResult& WithParameters(ParametersT&& value) {
  ...
  inline UpdateExtensionAssociationResult& WithExtensionVersionNumber(int value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateExtensionAssociationResult& WithRequestId(RequestIdT&& value) {
