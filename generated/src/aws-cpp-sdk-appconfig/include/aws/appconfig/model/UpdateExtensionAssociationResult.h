...
namespace Model
{
  ...
  {
  public:
    AWS_APPCONFIG_API UpdateExtensionAssociationResult() = default;
    ...
    template<typename IdT = Aws::String>
    UpdateExtensionAssociationResult& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename ExtensionArnT = Aws::String>
    UpdateExtensionAssociationResult& WithExtensionArn(ExtensionArnT&& value) { SetExtensionArn(std::forward<ExtensionArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ResourceArnT = Aws::String>
    UpdateExtensionAssociationResult& WithResourceArn(ResourceArnT&& value) { SetResourceArn(std::forward<ResourceArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ArnT = Aws::String>
    UpdateExtensionAssociationResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ParametersT = Aws::Map<Aws::String, Aws::String>>
    UpdateExtensionAssociationResult& WithParameters(ParametersT&& value) { SetParameters(std::forward<ParametersT>(value)); return *this;}
    template<typename ParametersKeyT = Aws::String, typename ParametersValueT = Aws::String>
    UpdateExtensionAssociationResult& AddParameters(ParametersKeyT&& key, ParametersValueT&& value) {
    ...
    template<typename RequestIdT = Aws::String>
    UpdateExtensionAssociationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
