 ...
 * API Reference</a></p>
 */
class StopExperimentRunResult {
 public:
  AWS_APPCONFIG_API StopExperimentRunResult() = default;
  AWS_APPCONFIG_API StopExperimentRunResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_APPCONFIG_API StopExperimentRunResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ApplicationIdT = Aws::String>
  StopExperimentRunResult& WithApplicationId(ApplicationIdT&& value) {
  ...
  template <typename ExperimentDefinitionIdT = Aws::String>
  StopExperimentRunResult& WithExperimentDefinitionId(ExperimentDefinitionIdT&& value) {
  ...
  inline StopExperimentRunResult& WithRun(int value) {
    SetRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename DescriptionT = Aws::String>
  StopExperimentRunResult& WithDescription(DescriptionT&& value) {
  ...
  inline StopExperimentRunResult& WithStatus(ExperimentRunStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline StopExperimentRunResult& WithExposurePercentage(double value) {
  ...
  template <typename TreatmentOverridesT = TreatmentOverrides>
  StopExperimentRunResult& WithTreatmentOverrides(TreatmentOverridesT&& value) {
  ...
  template <typename ResultT = ExperimentRunResult>
  StopExperimentRunResult& WithResult(ResultT&& value) {
  ...
  template <typename StartedAtT = Aws::Utils::DateTime>
  StopExperimentRunResult& WithStartedAt(StartedAtT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  StopExperimentRunResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  template <typename EndedAtT = Aws::Utils::DateTime>
  StopExperimentRunResult& WithEndedAt(EndedAtT&& value) {
  ...
  template <typename ExperimentDefinitionSnapshotT = ExperimentDefinitionSnapshot>
  StopExperimentRunResult& WithExperimentDefinitionSnapshot(ExperimentDefinitionSnapshotT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StopExperimentRunResult& WithRequestId(RequestIdT&& value) {
