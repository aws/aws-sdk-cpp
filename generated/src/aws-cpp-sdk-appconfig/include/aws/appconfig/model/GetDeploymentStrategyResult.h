...
namespace Model
{
  ...
  {
  public:
    AWS_APPCONFIG_API GetDeploymentStrategyResult();
    ...
    inline GetDeploymentStrategyResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline GetDeploymentStrategyResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline GetDeploymentStrategyResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
