...
namespace Model
{
  ...
  public:
    ...
    inline UpdateDeploymentStrategyResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateDeploymentStrategyResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateDeploymentStrategyResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
