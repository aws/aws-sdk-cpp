...
namespace Model
{
  ...
  public:
    ...
    template<typename IdT = Aws::String>
    UpdateDeploymentStrategyResult& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    UpdateDeploymentStrategyResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    UpdateDeploymentStrategyResult& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    inline UpdateDeploymentStrategyResult& WithGrowthType(GrowthType value) { SetGrowthType(value); return *this;}
    ///@}
    ...
    inline UpdateDeploymentStrategyResult& WithReplicateTo(ReplicateTo value) { SetReplicateTo(value); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateDeploymentStrategyResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
