...
namespace Model
{
  ...
  /**
   */
  class ListApplicationsRequest : public AppConfigRequest
  {
  public:
    AWS_APPCONFIG_API ListApplicationsRequest() = default;
    ...
    ///@{
    /**
     * <p>A token to start the list. Next token is a pagination token generated by
     ...
     * this token to get the next set of results. </p>
     */
