...
class GetDeploymentRequest : public AppConfigRequest {
 public:
  AWS_APPCONFIG_API GetDeploymentRequest() = default;
  ...
  template <typename EnvironmentIdT = Aws::String>
  GetDeploymentRequest& WithEnvironmentId(EnvironmentIdT&& value) {
  ...
  inline GetDeploymentRequest& WithDeploymentNumber(int value) {
