...
namespace AppConfig
{
   ...
   * User Guide</a>.</p>
   */
  class AWS_APPCONFIG_API AppConfigClient : Aws::Client::ClientWithAsyncTemplateMethods<AppConfigClient>,
    smithy::client::AwsSmithyClientT<Aws::AppConfig::SERVICE_NAME,
