...
class PutBandwidthRateLimitScheduleResult {
 public:
  ...
  AWS_BACKUPGATEWAY_API PutBandwidthRateLimitScheduleResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_BACKUPGATEWAY_API PutBandwidthRateLimitScheduleResult& operator=(
  ...
  template <typename GatewayArnT = Aws::String>
  PutBandwidthRateLimitScheduleResult& WithGatewayArn(GatewayArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  PutBandwidthRateLimitScheduleResult& WithRequestId(RequestIdT&& value) {
