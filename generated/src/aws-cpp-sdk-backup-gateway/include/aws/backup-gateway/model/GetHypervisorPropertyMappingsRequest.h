...
namespace Model
{
  ...
  {
  public:
    AWS_BACKUPGATEWAY_API GetHypervisorPropertyMappingsRequest() = default;
    ...
    template<typename HypervisorArnT = Aws::String>
    GetHypervisorPropertyMappingsRequest& WithHypervisorArn(HypervisorArnT&& value) { SetHypervisorArn(std::forward<HypervisorArnT>(value)); return *this;}
    ///@}
  private:
