...
namespace Model
{
  ...
  /**
   */
  class GetHypervisorPropertyMappingsRequest : public BackupGatewayRequest
  {
  public:
    AWS_BACKUPGATEWAY_API GetHypervisorPropertyMappingsRequest();

    // Service request name is the Operation name which will send this request out,
    // each operation should has unique request name, so that we can get operation's name from this request.
    // Note: this is not true for response, multiple operations may have the same response name,
    // so we can not get operation's name from response.
    inline virtual const char* GetServiceRequestName() const override { return "GetHypervisorPropertyMappings"; }
     ...
     * <p>The Amazon Resource Name (ARN) of the hypervisor.</p>
     */
    inline GetHypervisorPropertyMappingsRequest& WithHypervisorArn(const Aws::String& value) { SetHypervisorArn(value); return *this;}

    /**
     * <p>The Amazon Resource Name (ARN) of the hypervisor.</p>
     */
    inline GetHypervisorPropertyMappingsRequest& WithHypervisorArn(Aws::String&& value) { SetHypervisorArn(std::move(value)); return *this;}

    /**
     * <p>The Amazon Resource Name (ARN) of the hypervisor.</p>
     */
    inline GetHypervisorPropertyMappingsRequest& WithHypervisorArn(const char* value) { SetHypervisorArn(value); return *this;}
