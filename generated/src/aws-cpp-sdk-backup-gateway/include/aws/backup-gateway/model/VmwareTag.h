...
class VmwareTag {
 public:
  ...
  AWS_BACKUPGATEWAY_API VmwareTag(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_BACKUPGATEWAY_API VmwareTag& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  void SetVmwareCategory(VmwareCategoryT&& value) {
    m_vmwareCategoryHasBeenSet = true;
    m_vmwareCategory = std::forward<VmwareCategoryT>(value);
  }
  template <typename VmwareCategoryT = Aws::String>
  VmwareTag& WithVmwareCategory(VmwareCategoryT&& value) {
    SetVmwareCategory(std::forward<VmwareCategoryT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVmwareTagName(VmwareTagNameT&& value) {
    m_vmwareTagNameHasBeenSet = true;
    m_vmwareTagName = std::forward<VmwareTagNameT>(value);
  }
  template <typename VmwareTagNameT = Aws::String>
  VmwareTag& WithVmwareTagName(VmwareTagNameT&& value) {
    SetVmwareTagName(std::forward<VmwareTagNameT>(value));
    return *this;
  }
  ///@}
