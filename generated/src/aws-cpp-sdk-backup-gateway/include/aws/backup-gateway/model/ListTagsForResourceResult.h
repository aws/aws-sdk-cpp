...
class ListTagsForResourceResult {
 public:
  AWS_BACKUPGATEWAY_API ListTagsForResourceResult() = default;
  AWS_BACKUPGATEWAY_API ListTagsForResourceResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_BACKUPGATEWAY_API ListTagsForResourceResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
