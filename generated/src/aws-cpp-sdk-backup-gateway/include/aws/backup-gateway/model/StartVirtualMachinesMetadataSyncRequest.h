...
namespace Model
{
  ...
  {
  public:
    AWS_BACKUPGATEWAY_API StartVirtualMachinesMetadataSyncRequest();
     ...
     * <p>The Amazon Resource Name (ARN) of the hypervisor.</p>
     */
    inline StartVirtualMachinesMetadataSyncRequest& WithHypervisorArn(const Aws::String& value) { SetHypervisorArn(value); return *this;}

    /**
     * <p>The Amazon Resource Name (ARN) of the hypervisor.</p>
     */
    inline StartVirtualMachinesMetadataSyncRequest& WithHypervisorArn(Aws::String&& value) { SetHypervisorArn(std::move(value)); return *this;}

    /**
     * <p>The Amazon Resource Name (ARN) of the hypervisor.</p>
     */
    inline StartVirtualMachinesMetadataSyncRequest& WithHypervisorArn(const char* value) { SetHypervisorArn(value); return *this;}
