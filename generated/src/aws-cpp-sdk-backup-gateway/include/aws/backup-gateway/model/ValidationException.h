...
class ValidationException {
 public:
  AWS_BACKUPGATEWAY_API ValidationException() = default;
  AWS_BACKUPGATEWAY_API ValidationException(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_BACKUPGATEWAY_API ValidationException& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
