...
class VmwareToAwsTagMapping {
 public:
  ...
  AWS_BACKUPGATEWAY_API VmwareToAwsTagMapping(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_BACKUPGATEWAY_API VmwareToAwsTagMapping& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  template <typename VmwareCategoryT = Aws::String>
  VmwareToAwsTagMapping& WithVmwareCategory(VmwareCategoryT&& value) {
  ...
  template <typename VmwareTagNameT = Aws::String>
  VmwareToAwsTagMapping& WithVmwareTagName(VmwareTagNameT&& value) {
