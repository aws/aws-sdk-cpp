...
class UpdateHypervisorResult {
 public:
  ...
  AWS_BACKUPGATEWAY_API UpdateHypervisorResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_BACKUPGATEWAY_API UpdateHypervisorResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  template <typename HypervisorArnT = Aws::String>
  UpdateHypervisorResult& WithHypervisorArn(HypervisorArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateHypervisorResult& WithRequestId(RequestIdT&& value) {
