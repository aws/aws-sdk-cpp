...
class GetHypervisorResult {
 public:
  ...
  AWS_BACKUPGATEWAY_API GetHypervisorResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_BACKUPGATEWAY_API GetHypervisorResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  template <typename HypervisorT = HypervisorDetails>
  GetHypervisorResult& WithHypervisor(HypervisorT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetHypervisorResult& WithRequestId(RequestIdT&& value) {
