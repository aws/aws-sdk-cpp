...
class VirtualMachine {
 public:
  ...
  AWS_BACKUPGATEWAY_API VirtualMachine(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_BACKUPGATEWAY_API VirtualMachine& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
