...
class ImportHypervisorConfigurationResult {
 public:
  AWS_BACKUPGATEWAY_API ImportHypervisorConfigurationResult() = default;
  AWS_BACKUPGATEWAY_API ImportHypervisorConfigurationResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_BACKUPGATEWAY_API ImportHypervisorConfigurationResult& operator=(
  ...
  template <typename HypervisorArnT = Aws::String>
  ImportHypervisorConfigurationResult& WithHypervisorArn(HypervisorArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ImportHypervisorConfigurationResult& WithRequestId(RequestIdT&& value) {
