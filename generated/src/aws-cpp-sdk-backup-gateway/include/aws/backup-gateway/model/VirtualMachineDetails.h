...
namespace Model
{
  ...
  public:
    ...
    template<typename HostNameT = Aws::String>
    VirtualMachineDetails& WithHostName(HostNameT&& value) { SetHostName(std::forward<HostNameT>(value)); return *this;}
    ///@}
    ...
    template<typename HypervisorIdT = Aws::String>
    VirtualMachineDetails& WithHypervisorId(HypervisorIdT&& value) { SetHypervisorId(std::forward<HypervisorIdT>(value)); return *this;}
    ///@}
    ...
    template<typename LastBackupDateT = Aws::Utils::DateTime>
    VirtualMachineDetails& WithLastBackupDate(LastBackupDateT&& value) { SetLastBackupDate(std::forward<LastBackupDateT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    VirtualMachineDetails& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename PathT = Aws::String>
    VirtualMachineDetails& WithPath(PathT&& value) { SetPath(std::forward<PathT>(value)); return *this;}
    ///@}
    ...
    template<typename ResourceArnT = Aws::String>
    VirtualMachineDetails& WithResourceArn(ResourceArnT&& value) { SetResourceArn(std::forward<ResourceArnT>(value)); return *this;}
    ///@}
    ...
    template<typename VmwareTagsT = Aws::Vector<VmwareTag>>
    void SetVmwareTags(VmwareTagsT&& value) { m_vmwareTagsHasBeenSet = true; m_vmwareTags = std::forward<VmwareTagsT>(value); }
    template<typename VmwareTagsT = Aws::Vector<VmwareTag>>
    VirtualMachineDetails& WithVmwareTags(VmwareTagsT&& value) { SetVmwareTags(std::forward<VmwareTagsT>(value)); return *this;}
    template<typename VmwareTagsT = VmwareTag>
    VirtualMachineDetails& AddVmwareTags(VmwareTagsT&& value) { m_vmwareTagsHasBeenSet = true; m_vmwareTags.emplace_back(std::forward<VmwareTagsT>(value)); return *this; }
    ///@}
  private:
