...
class VirtualMachineDetails {
 public:
  ...
  AWS_BACKUPGATEWAY_API VirtualMachineDetails(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_BACKUPGATEWAY_API VirtualMachineDetails& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
