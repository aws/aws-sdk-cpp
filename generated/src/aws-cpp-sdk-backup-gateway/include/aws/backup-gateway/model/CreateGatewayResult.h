...
class CreateGatewayResult {
 public:
  AWS_BACKUPGATEWAY_API CreateGatewayResult() = default;
  AWS_BACKUPGATEWAY_API CreateGatewayResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_BACKUPGATEWAY_API CreateGatewayResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
