...
class ResourceNotFoundException {
 public:
  AWS_BACKUPGATEWAY_API ResourceNotFoundException() = default;
  AWS_BACKUPGATEWAY_API ResourceNotFoundException(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_BACKUPGATEWAY_API ResourceNotFoundException& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
