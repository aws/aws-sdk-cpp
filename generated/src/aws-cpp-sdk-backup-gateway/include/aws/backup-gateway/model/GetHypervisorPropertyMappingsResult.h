...
class GetHypervisorPropertyMappingsResult {
 public:
  ...
  AWS_BACKUPGATEWAY_API GetHypervisorPropertyMappingsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_BACKUPGATEWAY_API GetHypervisorPropertyMappingsResult& operator=(
  ...
  template <typename HypervisorArnT = Aws::String>
  GetHypervisorPropertyMappingsResult& WithHypervisorArn(HypervisorArnT&& value) {
  ...
  void SetVmwareToAwsTagMappings(VmwareToAwsTagMappingsT&& value) {
    m_vmwareToAwsTagMappingsHasBeenSet = true;
    m_vmwareToAwsTagMappings = std::forward<VmwareToAwsTagMappingsT>(value);
  }
  template <typename VmwareToAwsTagMappingsT = Aws::Vector<VmwareToAwsTagMapping>>
  GetHypervisorPropertyMappingsResult& WithVmwareToAwsTagMappings(VmwareToAwsTagMappingsT&& value) {
    SetVmwareToAwsTagMappings(std::forward<VmwareToAwsTagMappingsT>(value));
    return *this;
  }
  ...
  template <typename RequestIdT = Aws::String>
  GetHypervisorPropertyMappingsResult& WithRequestId(RequestIdT&& value) {
