...
namespace BackupGateway
{
   ...
   * gateway</b>.</p></p>
   */
  class AWS_BACKUPGATEWAY_API BackupGatewayClient : Aws::Client::ClientWithAsyncTemplateMethods<BackupGatewayClient>,
    smithy::client::AwsSmithyClientT<Aws::BackupGateway::SERVICE_NAME,
