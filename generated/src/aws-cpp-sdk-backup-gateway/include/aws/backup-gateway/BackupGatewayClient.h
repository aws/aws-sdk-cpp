...
class AWS_BACKUPGATEWAY_API BackupGatewayClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  BackupGatewayClient(const Aws::BackupGateway::BackupGatewayClientConfiguration& clientConfiguration =
  ...
  BackupGatewayClient(const Aws::Auth::AWSCredentials& credentials,
                      std::shared_ptr<BackupGatewayEndpointProviderBase> endpointProvider = nullptr,
                      const Aws::BackupGateway::BackupGatewayClientConfiguration& clientConfiguration =
                          Aws::BackupGateway::BackupGatewayClientConfiguration());
  ...
  /**
   * A Callable wrapper for AssociateGatewayToServer that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssociateGatewayToServer that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateGatewayToServerRequestT = Model::AssociateGatewayToServerRequest>
  void AssociateGatewayToServerAsync(const AssociateGatewayToServerRequestT& request,
                                     const AssociateGatewayToServerResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for DeleteHypervisor that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteHypervisor that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteHypervisorRequestT = Model::DeleteHypervisorRequest>
  void DeleteHypervisorAsync(const DeleteHypervisorRequestT& request, const DeleteHypervisorResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateGatewayFromServerOutcome DisassociateGatewayFromServer(
      const Model::DisassociateGatewayFromServerRequest& request) const;

  /**
   * A Callable wrapper for DisassociateGatewayFromServer that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DisassociateGatewayFromServerRequestT = Model::DisassociateGatewayFromServerRequest>
  Model::DisassociateGatewayFromServerOutcomeCallable DisassociateGatewayFromServerCallable(
      const DisassociateGatewayFromServerRequestT& request) const {
    return SubmitCallable(&BackupGatewayClient::DisassociateGatewayFromServer, request);
  }

  /**
   * An Async wrapper for DisassociateGatewayFromServer that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateGatewayFromServerRequestT = Model::DisassociateGatewayFromServerRequest>
  void DisassociateGatewayFromServerAsync(const DisassociateGatewayFromServerRequestT& request,
                                          const DisassociateGatewayFromServerResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetBandwidthRateLimitScheduleOutcome GetBandwidthRateLimitSchedule(
      const Model::GetBandwidthRateLimitScheduleRequest& request) const;

  /**
   * A Callable wrapper for GetBandwidthRateLimitSchedule that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetBandwidthRateLimitScheduleRequestT = Model::GetBandwidthRateLimitScheduleRequest>
  Model::GetBandwidthRateLimitScheduleOutcomeCallable GetBandwidthRateLimitScheduleCallable(
      const GetBandwidthRateLimitScheduleRequestT& request) const {
    return SubmitCallable(&BackupGatewayClient::GetBandwidthRateLimitSchedule, request);
  }

  /**
   * An Async wrapper for GetBandwidthRateLimitSchedule that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetBandwidthRateLimitScheduleRequestT = Model::GetBandwidthRateLimitScheduleRequest>
  void GetBandwidthRateLimitScheduleAsync(const GetBandwidthRateLimitScheduleRequestT& request,
                                          const GetBandwidthRateLimitScheduleResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetHypervisor that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetHypervisorRequestT = Model::GetHypervisorRequest>
  void GetHypervisorAsync(const GetHypervisorRequestT& request, const GetHypervisorResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetHypervisorPropertyMappingsOutcome GetHypervisorPropertyMappings(
      const Model::GetHypervisorPropertyMappingsRequest& request) const;

  /**
   * A Callable wrapper for GetHypervisorPropertyMappings that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetHypervisorPropertyMappingsRequestT = Model::GetHypervisorPropertyMappingsRequest>
  Model::GetHypervisorPropertyMappingsOutcomeCallable GetHypervisorPropertyMappingsCallable(
      const GetHypervisorPropertyMappingsRequestT& request) const {
    return SubmitCallable(&BackupGatewayClient::GetHypervisorPropertyMappings, request);
  }

  /**
   * An Async wrapper for GetHypervisorPropertyMappings that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetHypervisorPropertyMappingsRequestT = Model::GetHypervisorPropertyMappingsRequest>
  void GetHypervisorPropertyMappingsAsync(const GetHypervisorPropertyMappingsRequestT& request,
                                          const GetHypervisorPropertyMappingsResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetVirtualMachine that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetVirtualMachine that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetVirtualMachineRequestT = Model::GetVirtualMachineRequest>
  void GetVirtualMachineAsync(const GetVirtualMachineRequestT& request, const GetVirtualMachineResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ImportHypervisorConfigurationOutcome ImportHypervisorConfiguration(
      const Model::ImportHypervisorConfigurationRequest& request) const;

  /**
   * A Callable wrapper for ImportHypervisorConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ImportHypervisorConfigurationRequestT = Model::ImportHypervisorConfigurationRequest>
  Model::ImportHypervisorConfigurationOutcomeCallable ImportHypervisorConfigurationCallable(
      const ImportHypervisorConfigurationRequestT& request) const {
    return SubmitCallable(&BackupGatewayClient::ImportHypervisorConfiguration, request);
  }

  /**
   * An Async wrapper for ImportHypervisorConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ImportHypervisorConfigurationRequestT = Model::ImportHypervisorConfigurationRequest>
  void ImportHypervisorConfigurationAsync(const ImportHypervisorConfigurationRequestT& request,
                                          const ImportHypervisorConfigurationResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListHypervisors that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListHypervisorsRequestT = Model::ListHypervisorsRequest>
  void ListHypervisorsAsync(const ListHypervisorsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const ListHypervisorsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListVirtualMachines that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListVirtualMachines that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListVirtualMachinesRequestT = Model::ListVirtualMachinesRequest>
  void ListVirtualMachinesAsync(const ListVirtualMachinesResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const ListVirtualMachinesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::PutBandwidthRateLimitScheduleOutcome PutBandwidthRateLimitSchedule(
      const Model::PutBandwidthRateLimitScheduleRequest& request) const;

  /**
   * A Callable wrapper for PutBandwidthRateLimitSchedule that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PutBandwidthRateLimitScheduleRequestT = Model::PutBandwidthRateLimitScheduleRequest>
  Model::PutBandwidthRateLimitScheduleOutcomeCallable PutBandwidthRateLimitScheduleCallable(
      const PutBandwidthRateLimitScheduleRequestT& request) const {
    return SubmitCallable(&BackupGatewayClient::PutBandwidthRateLimitSchedule, request);
  }

  /**
   * An Async wrapper for PutBandwidthRateLimitSchedule that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutBandwidthRateLimitScheduleRequestT = Model::PutBandwidthRateLimitScheduleRequest>
  void PutBandwidthRateLimitScheduleAsync(const PutBandwidthRateLimitScheduleRequestT& request,
                                          const PutBandwidthRateLimitScheduleResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::PutHypervisorPropertyMappingsOutcome PutHypervisorPropertyMappings(
      const Model::PutHypervisorPropertyMappingsRequest& request) const;

  /**
   * A Callable wrapper for PutHypervisorPropertyMappings that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PutHypervisorPropertyMappingsRequestT = Model::PutHypervisorPropertyMappingsRequest>
  Model::PutHypervisorPropertyMappingsOutcomeCallable PutHypervisorPropertyMappingsCallable(
      const PutHypervisorPropertyMappingsRequestT& request) const {
    return SubmitCallable(&BackupGatewayClient::PutHypervisorPropertyMappings, request);
  }

  /**
   * An Async wrapper for PutHypervisorPropertyMappings that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutHypervisorPropertyMappingsRequestT = Model::PutHypervisorPropertyMappingsRequest>
  void PutHypervisorPropertyMappingsAsync(const PutHypervisorPropertyMappingsRequestT& request,
                                          const PutHypervisorPropertyMappingsResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutMaintenanceStartTime that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutMaintenanceStartTime that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutMaintenanceStartTimeRequestT = Model::PutMaintenanceStartTimeRequest>
  void PutMaintenanceStartTimeAsync(const PutMaintenanceStartTimeRequestT& request,
                                    const PutMaintenanceStartTimeResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartVirtualMachinesMetadataSyncOutcome StartVirtualMachinesMetadataSync(
      const Model::StartVirtualMachinesMetadataSyncRequest& request) const;

  /**
   * A Callable wrapper for StartVirtualMachinesMetadataSync that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename StartVirtualMachinesMetadataSyncRequestT = Model::StartVirtualMachinesMetadataSyncRequest>
  Model::StartVirtualMachinesMetadataSyncOutcomeCallable StartVirtualMachinesMetadataSyncCallable(
      const StartVirtualMachinesMetadataSyncRequestT& request) const {
    return SubmitCallable(&BackupGatewayClient::StartVirtualMachinesMetadataSync, request);
  }

  /**
   * An Async wrapper for StartVirtualMachinesMetadataSync that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename StartVirtualMachinesMetadataSyncRequestT = Model::StartVirtualMachinesMetadataSyncRequest>
  void StartVirtualMachinesMetadataSyncAsync(const StartVirtualMachinesMetadataSyncRequestT& request,
                                             const StartVirtualMachinesMetadataSyncResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::TestHypervisorConfigurationOutcome TestHypervisorConfiguration(
      const Model::TestHypervisorConfigurationRequest& request) const;

  /**
   * A Callable wrapper for TestHypervisorConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename TestHypervisorConfigurationRequestT = Model::TestHypervisorConfigurationRequest>
  Model::TestHypervisorConfigurationOutcomeCallable TestHypervisorConfigurationCallable(
      const TestHypervisorConfigurationRequestT& request) const {
    return SubmitCallable(&BackupGatewayClient::TestHypervisorConfiguration, request);
  }

  /**
   * An Async wrapper for TestHypervisorConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename TestHypervisorConfigurationRequestT = Model::TestHypervisorConfigurationRequest>
  void TestHypervisorConfigurationAsync(const TestHypervisorConfigurationRequestT& request,
                                        const TestHypervisorConfigurationResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateGatewayInformation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateGatewayInformation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateGatewayInformationRequestT = Model::UpdateGatewayInformationRequest>
  void UpdateGatewayInformationAsync(const UpdateGatewayInformationRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateGatewaySoftwareNow that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateGatewaySoftwareNow that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateGatewaySoftwareNowRequestT = Model::UpdateGatewaySoftwareNowRequest>
  void UpdateGatewaySoftwareNowAsync(const UpdateGatewaySoftwareNowRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateHypervisor that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateHypervisor that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateHypervisorRequestT = Model::UpdateHypervisorRequest>
  void UpdateHypervisorAsync(const UpdateHypervisorRequestT& request, const UpdateHypervisorResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
