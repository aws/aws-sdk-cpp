...
class AWS_CLOUDFRONTKEYVALUESTORE_API CloudFrontKeyValueStoreClient
 ...
 public:
   ...
   */
  CloudFrontKeyValueStoreClient(const Aws::CloudFrontKeyValueStore::CloudFrontKeyValueStoreClientConfiguration& clientConfiguration =
                                    Aws::CloudFrontKeyValueStore::CloudFrontKeyValueStoreClientConfiguration(),
  ...
  CloudFrontKeyValueStoreClient(const Aws::Auth::AWSCredentials& credentials,
                                std::shared_ptr<CloudFrontKeyValueStoreEndpointProviderBase> endpointProvider = nullptr,
                                const Aws::CloudFrontKeyValueStore::CloudFrontKeyValueStoreClientConfiguration& clientConfiguration =
                                    Aws::CloudFrontKeyValueStore::CloudFrontKeyValueStoreClientConfiguration());
   ...
   * is not specified, it will be initialized to default values.
   */
  CloudFrontKeyValueStoreClient(const Aws::Auth::AWSCredentials& credentials, const Aws::Client::ClientConfiguration& clientConfiguration);
  ...
  /**
   * A Callable wrapper for DescribeKeyValueStore that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeKeyValueStore that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeKeyValueStoreRequestT = Model::DescribeKeyValueStoreRequest>
  void DescribeKeyValueStoreAsync(const DescribeKeyValueStoreRequestT& request, const DescribeKeyValueStoreResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename ListKeysRequestT = Model::ListKeysRequest>
  void ListKeysAsync(const ListKeysRequestT& request, const ListKeysResponseReceivedHandler& handler,
                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for PutKey that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutKeyRequestT = Model::PutKeyRequest>
  void PutKeyAsync(const PutKeyRequestT& request, const PutKeyResponseReceivedHandler& handler,
                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateKeys that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateKeysRequestT = Model::UpdateKeysRequest>
  void UpdateKeysAsync(const UpdateKeysRequestT& request, const UpdateKeysResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
