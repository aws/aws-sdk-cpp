...
class DeleteKeyResult {
 public:
  AWS_CLOUDFRONTKEYVALUESTORE_API DeleteKeyResult() = default;
  ...
  inline DeleteKeyResult& WithItemCount(int value) {
    SetItemCount(value);
    return *this;
  }
  ///@}
  ...
  inline DeleteKeyResult& WithTotalSizeInBytes(long long value) {
  ...
  template <typename ETagT = Aws::String>
  DeleteKeyResult& WithETag(ETagT&& value) {
