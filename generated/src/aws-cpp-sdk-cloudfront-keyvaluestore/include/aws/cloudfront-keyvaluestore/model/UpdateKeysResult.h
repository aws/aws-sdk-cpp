...
class UpdateKeysResult {
 public:
  AWS_CLOUDFRONTKEYVALUESTORE_API UpdateKeysResult() = default;
  ...
  inline UpdateKeysResult& WithItemCount(int value) {
    SetItemCount(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateKeysResult& WithTotalSizeInBytes(long long value) {
  ...
  template <typename ETagT = Aws::String>
  UpdateKeysResult& WithETag(ETagT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateKeysResult& WithRequestId(RequestIdT&& value) {
