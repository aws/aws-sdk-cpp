...
class PutKeyResult {
 public:
  ...
  inline PutKeyResult& WithItemCount(int value) {
    SetItemCount(value);
    return *this;
  }
  ///@}
  ...
  inline PutKeyResult& WithTotalSizeInBytes(long long value) {
  ...
  template <typename ETagT = Aws::String>
  PutKeyResult& WithETag(ETagT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  PutKeyResult& WithRequestId(RequestIdT&& value) {
