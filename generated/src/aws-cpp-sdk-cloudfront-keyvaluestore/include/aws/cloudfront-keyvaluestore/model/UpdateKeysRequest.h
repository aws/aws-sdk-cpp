...
class UpdateKeysRequest : public CloudFrontKeyValueStoreRequest {
 public:
  ...
  template <typename KvsARNT = Aws::String>
  UpdateKeysRequest& WithKvsARN(KvsARNT&& value) {
  ...
  template <typename IfMatchT = Aws::String>
  UpdateKeysRequest& WithIfMatch(IfMatchT&& value) {
  ...
  void SetPuts(PutsT&& value) {
    m_putsHasBeenSet = true;
    m_puts = std::forward<PutsT>(value);
  }
  template <typename PutsT = Aws::Vector<PutKeyRequestListItem>>
  UpdateKeysRequest& WithPuts(PutsT&& value) {
    SetPuts(std::forward<PutsT>(value));
    return *this;
  }
  template <typename PutsT = PutKeyRequestListItem>
  UpdateKeysRequest& AddPuts(PutsT&& value) {
    m_putsHasBeenSet = true;
    m_puts.emplace_back(std::forward<PutsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename DeletesT = Aws::Vector<DeleteKeyRequestListItem>>
  UpdateKeysRequest& WithDeletes(DeletesT&& value) {
    SetDeletes(std::forward<DeletesT>(value));
    return *this;
  }
  template <typename DeletesT = DeleteKeyRequestListItem>
  UpdateKeysRequest& AddDeletes(DeletesT&& value) {
    m_deletesHasBeenSet = true;
    m_deletes.emplace_back(std::forward<DeletesT>(value));
    return *this;
  }
  ///@}
 private:
