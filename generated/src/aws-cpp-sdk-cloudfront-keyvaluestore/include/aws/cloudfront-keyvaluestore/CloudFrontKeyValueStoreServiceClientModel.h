...
typedef std::function<void(const CloudFrontKeyValueStoreClient*, const Model::DeleteKeyRequest&, const Model::DeleteKeyOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteKeyResponseReceivedHandler;
typedef std::function<void(const CloudFrontKeyValueStoreClient*, const Model::DescribeKeyValueStoreRequest&,
                           const Model::DescribeKeyValueStoreOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DescribeKeyValueStoreResponseReceivedHandler;
typedef std::function<void(const CloudFrontKeyValueStoreClient*, const Model::GetKeyRequest&, const Model::GetKeyOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetKeyResponseReceivedHandler;
typedef std::function<void(const CloudFrontKeyValueStoreClient*, const Model::ListKeysRequest&, const Model::ListKeysOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListKeysResponseReceivedHandler;
typedef std::function<void(const CloudFrontKeyValueStoreClient*, const Model::PutKeyRequest&, const Model::PutKeyOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    PutKeyResponseReceivedHandler;
typedef std::function<void(const CloudFrontKeyValueStoreClient*, const Model::UpdateKeysRequest&, const Model::UpdateKeysOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    UpdateKeysResponseReceivedHandler;
