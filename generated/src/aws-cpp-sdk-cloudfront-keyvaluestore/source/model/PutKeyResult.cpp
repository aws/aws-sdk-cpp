...
PutKeyResult::PutKeyResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

PutKeyResult& PutKeyResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
