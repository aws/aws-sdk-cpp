...
Filters& Filters::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("ContentCategories")) {
    ...
    for (unsigned contentCategoriesIndex = 0; contentCategoriesIndex < contentCategoriesJsonList.GetLength(); ++contentCategoriesIndex) {
      m_contentCategories.push_back(
          ContentCategoryTypeMapper::GetContentCategoryTypeForName(contentCategoriesJsonList[contentCategoriesIndex].AsString()));
    }
  ...
  if (jsonValue.ValueExists("ResourceTypes")) {
    ...
    for (unsigned resourceTypesIndex = 0; resourceTypesIndex < resourceTypesJsonList.GetLength(); ++resourceTypesIndex) {
      m_resourceTypes.push_back(
          SearchResourceTypeMapper::GetSearchResourceTypeForName(resourceTypesJsonList[resourceTypesIndex].AsString()));
    }
  ...
  if (jsonValue.ValueExists("SearchCollectionTypes")) {
    ...
    for (unsigned searchCollectionTypesIndex = 0; searchCollectionTypesIndex < searchCollectionTypesJsonList.GetLength();
         ++searchCollectionTypesIndex) {
      m_searchCollectionTypes.push_back(
          SearchCollectionTypeMapper::GetSearchCollectionTypeForName(searchCollectionTypesJsonList[searchCollectionTypesIndex].AsString()));
    }
...
JsonValue Filters::Jsonize() const {
  ...
  if (m_contentCategoriesHasBeenSet) {
    ...
    for (unsigned contentCategoriesIndex = 0; contentCategoriesIndex < contentCategoriesJsonList.GetLength(); ++contentCategoriesIndex) {
      contentCategoriesJsonList[contentCategoriesIndex].AsString(
          ContentCategoryTypeMapper::GetNameForContentCategoryType(m_contentCategories[contentCategoriesIndex]));
    }
  ...
  if (m_resourceTypesHasBeenSet) {
    ...
    for (unsigned resourceTypesIndex = 0; resourceTypesIndex < resourceTypesJsonList.GetLength(); ++resourceTypesIndex) {
      resourceTypesJsonList[resourceTypesIndex].AsString(
          SearchResourceTypeMapper::GetNameForSearchResourceType(m_resourceTypes[resourceTypesIndex]));
    }
  ...
  if (m_searchCollectionTypesHasBeenSet) {
    ...
    for (unsigned searchCollectionTypesIndex = 0; searchCollectionTypesIndex < searchCollectionTypesJsonList.GetLength();
         ++searchCollectionTypesIndex) {
      searchCollectionTypesJsonList[searchCollectionTypesIndex].AsString(
          SearchCollectionTypeMapper::GetNameForSearchCollectionType(m_searchCollectionTypes[searchCollectionTypesIndex]));
    }
