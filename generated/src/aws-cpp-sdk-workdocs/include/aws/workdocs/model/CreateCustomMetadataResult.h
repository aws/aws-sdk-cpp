...
namespace Model
{
  ...
  public:
    ...
    inline CreateCustomMetadataResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline CreateCustomMetadataResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline CreateCustomMetadataResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
