...
namespace Model
{
  ...
  {
  public:
    AWS_WORKDOCS_API CreateCustomMetadataResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    CreateCustomMetadataResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
