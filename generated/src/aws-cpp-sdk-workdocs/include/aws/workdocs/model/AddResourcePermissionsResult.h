...
class AddResourcePermissionsResult {
 public:
  ...
  void SetShareResults(ShareResultsT&& value) {
    m_shareResultsHasBeenSet = true;
    m_shareResults = std::forward<ShareResultsT>(value);
  }
  template <typename ShareResultsT = Aws::Vector<ShareResult>>
  AddResourcePermissionsResult& WithShareResults(ShareResultsT&& value) {
    SetShareResults(std::forward<ShareResultsT>(value));
    return *this;
  }
  template <typename ShareResultsT = ShareResult>
  AddResourcePermissionsResult& AddShareResults(ShareResultsT&& value) {
    m_shareResultsHasBeenSet = true;
    m_shareResults.emplace_back(std::forward<ShareResultsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  AddResourcePermissionsResult& WithRequestId(RequestIdT&& value) {
