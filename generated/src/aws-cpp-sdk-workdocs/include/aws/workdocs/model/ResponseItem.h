...
class ResponseItem {
 public:
  ...
  inline void SetResourceType(ResponseItemType value) {
    m_resourceTypeHasBeenSet = true;
    m_resourceType = value;
  }
  inline ResponseItem& WithResourceType(ResponseItemType value) {
  ...
  template <typename WebUrlT = Aws::String>
  ResponseItem& WithWebUrl(WebUrlT&& value) {
  ...
  template <typename DocumentMetadataT = DocumentMetadata>
  ResponseItem& WithDocumentMetadata(DocumentMetadataT&& value) {
  ...
  void SetFolderMetadata(FolderMetadataT&& value) {
    m_folderMetadataHasBeenSet = true;
    m_folderMetadata = std::forward<FolderMetadataT>(value);
  }
  template <typename FolderMetadataT = FolderMetadata>
  ResponseItem& WithFolderMetadata(FolderMetadataT&& value) {
    SetFolderMetadata(std::forward<FolderMetadataT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCommentMetadata(CommentMetadataT&& value) {
    ...
    m_commentMetadata = std::forward<CommentMetadataT>(value);
  }
  template <typename CommentMetadataT = CommentMetadata>
  ResponseItem& WithCommentMetadata(CommentMetadataT&& value) {
    SetCommentMetadata(std::forward<CommentMetadataT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDocumentVersionMetadata(DocumentVersionMetadataT&& value) {
    m_documentVersionMetadataHasBeenSet = true;
    m_documentVersionMetadata = std::forward<DocumentVersionMetadataT>(value);
  }
  template <typename DocumentVersionMetadataT = DocumentVersionMetadata>
  ResponseItem& WithDocumentVersionMetadata(DocumentVersionMetadataT&& value) {
    SetDocumentVersionMetadata(std::forward<DocumentVersionMetadataT>(value));
    return *this;
  }
  ///@}
 private:
