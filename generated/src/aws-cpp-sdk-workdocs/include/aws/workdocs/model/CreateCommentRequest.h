...
class CreateCommentRequest : public WorkDocsRequest {
 public:
  ...
  inline void SetVisibility(CommentVisibilityType value) {
    m_visibilityHasBeenSet = true;
    m_visibility = value;
  }
  inline CreateCommentRequest& WithVisibility(CommentVisibilityType value) {
    SetVisibility(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNotifyCollaborators(bool value) {
    m_notifyCollaboratorsHasBeenSet = true;
    m_notifyCollaborators = value;
  }
  inline CreateCommentRequest& WithNotifyCollaborators(bool value) {
    SetNotifyCollaborators(value);
    return *this;
  }
  ///@}
 private:
