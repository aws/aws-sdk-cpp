...
namespace Model
{
  ...
  {
  public:
    AWS_WORKDOCS_API DeleteDocumentRequest() = default;
    ...
    template<typename AuthenticationTokenT = Aws::String>
    DeleteDocumentRequest& WithAuthenticationToken(AuthenticationTokenT&& value) { SetAuthenticationToken(std::forward<AuthenticationTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename DocumentIdT = Aws::String>
    DeleteDocumentRequest& WithDocumentId(DocumentIdT&& value) { SetDocumentId(std::forward<DocumentIdT>(value)); return *this;}
    ///@}
  private:
