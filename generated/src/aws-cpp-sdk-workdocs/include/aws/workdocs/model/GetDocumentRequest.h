...
class GetDocumentRequest : public WorkDocsRequest {
 public:
  ...
  template <typename AuthenticationTokenT = Aws::String>
  GetDocumentRequest& WithAuthenticationToken(AuthenticationTokenT&& value) {
  ...
  template <typename DocumentIdT = Aws::String>
  GetDocumentRequest& WithDocumentId(DocumentIdT&& value) {
  ...
  inline GetDocumentRequest& WithIncludeCustomMetadata(bool value) {
