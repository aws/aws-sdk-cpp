...
namespace Model
{
  ...
  /**
   */
  class GetDocumentRequest : public WorkDocsRequest
  {
  public:
    AWS_WORKDOCS_API GetDocumentRequest() = default;
    ...
    template<typename AuthenticationTokenT = Aws::String>
    GetDocumentRequest& WithAuthenticationToken(AuthenticationTokenT&& value) { SetAuthenticationToken(std::forward<AuthenticationTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename DocumentIdT = Aws::String>
    GetDocumentRequest& WithDocumentId(DocumentIdT&& value) { SetDocumentId(std::forward<DocumentIdT>(value)); return *this;}
    ///@}
