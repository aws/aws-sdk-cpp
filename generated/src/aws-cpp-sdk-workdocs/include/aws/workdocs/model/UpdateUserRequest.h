...
class UpdateUserRequest : public WorkDocsRequest {
 public:
  ...
  inline UpdateUserRequest& WithType(UserType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateUserRequest& WithLocale(LocaleType value) {
    SetLocale(value);
    return *this;
  }
  ///@}
  ...
  inline void SetGrantPoweruserPrivileges(BooleanEnumType value) {
    m_grantPoweruserPrivilegesHasBeenSet = true;
    m_grantPoweruserPrivileges = value;
  }
  inline UpdateUserRequest& WithGrantPoweruserPrivileges(BooleanEnumType value) {
    SetGrantPoweruserPrivileges(value);
    return *this;
  }
  ///@}
 private:
