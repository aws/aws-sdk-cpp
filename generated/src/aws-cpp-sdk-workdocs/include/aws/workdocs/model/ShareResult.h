...
class ShareResult {
 public:
  ...
  template <typename PrincipalIdT = Aws::String>
  ShareResult& WithPrincipalId(PrincipalIdT&& value) {
  ...
  void SetInviteePrincipalId(InviteePrincipalIdT&& value) {
    m_inviteePrincipalIdHasBeenSet = true;
    m_inviteePrincipalId = std::forward<InviteePrincipalIdT>(value);
  }
  template <typename InviteePrincipalIdT = Aws::String>
  ShareResult& WithInviteePrincipalId(InviteePrincipalIdT&& value) {
    SetInviteePrincipalId(std::forward<InviteePrincipalIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline ShareResult& WithRole(RoleType value) {
    SetRole(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(ShareStatusType value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ShareResult& WithStatus(ShareStatusType value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ShareIdT = Aws::String>
  ShareResult& WithShareId(ShareIdT&& value) {
  ...
  template <typename StatusMessageT = Aws::String>
  ShareResult& WithStatusMessage(StatusMessageT&& value) {
