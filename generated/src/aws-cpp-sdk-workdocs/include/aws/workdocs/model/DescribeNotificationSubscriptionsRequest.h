...
namespace Model
{
  ...
  public:
    ...
    template<typename OrganizationIdT = Aws::String>
    DescribeNotificationSubscriptionsRequest& WithOrganizationId(OrganizationIdT&& value) { SetOrganizationId(std::forward<OrganizationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename MarkerT = Aws::String>
    DescribeNotificationSubscriptionsRequest& WithMarker(MarkerT&& value) { SetMarker(std::forward<MarkerT>(value)); return *this;}
    ///@}
