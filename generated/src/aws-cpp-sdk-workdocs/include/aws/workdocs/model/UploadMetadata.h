...
class UploadMetadata {
 public:
  ...
  template <typename UploadUrlT = Aws::String>
  UploadMetadata& WithUploadUrl(UploadUrlT&& value) {
  ...
  void SetSignedHeaders(SignedHeadersT&& value) {
    m_signedHeadersHasBeenSet = true;
    m_signedHeaders = std::forward<SignedHeadersT>(value);
  }
  template <typename SignedHeadersT = Aws::Map<Aws::String, Aws::String>>
  UploadMetadata& WithSignedHeaders(SignedHeadersT&& value) {
    SetSignedHeaders(std::forward<SignedHeadersT>(value));
    return *this;
  }
  ...
  UploadMetadata& AddSignedHeaders(SignedHeadersKeyT&& key, SignedHeadersValueT&& value) {
    m_signedHeadersHasBeenSet = true;
    m_signedHeaders.emplace(std::forward<SignedHeadersKeyT>(key), std::forward<SignedHeadersValueT>(value));
    return *this;
  }
  ///@}
 private:
