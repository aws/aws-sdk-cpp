...
class GetDocumentResult {
 public:
  ...
  template <typename MetadataT = DocumentMetadata>
  GetDocumentResult& WithMetadata(MetadataT&& value) {
  ...
  template <typename CustomMetadataT = Aws::Map<Aws::String, Aws::String>>
  GetDocumentResult& WithCustomMetadata(CustomMetadataT&& value) {
  ...
  GetDocumentResult& AddCustomMetadata(CustomMetadataKeyT&& key, CustomMetadataValueT&& value) {
    m_customMetadataHasBeenSet = true;
    m_customMetadata.emplace(std::forward<CustomMetadataKeyT>(key), std::forward<CustomMetadataValueT>(value));
    return *this;
  }
  ///@}
