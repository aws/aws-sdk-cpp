...
class CreateNotificationSubscriptionRequest : public WorkDocsRequest {
 public:
  ...
  template <typename OrganizationIdT = Aws::String>
  CreateNotificationSubscriptionRequest& WithOrganizationId(OrganizationIdT&& value) {
  ...
  template <typename EndpointT = Aws::String>
  CreateNotificationSubscriptionRequest& WithEndpoint(EndpointT&& value) {
  ...
  inline void SetProtocol(SubscriptionProtocolType value) {
    m_protocolHasBeenSet = true;
    m_protocol = value;
  }
  inline CreateNotificationSubscriptionRequest& WithProtocol(SubscriptionProtocolType value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSubscriptionType(SubscriptionType value) {
    m_subscriptionTypeHasBeenSet = true;
    m_subscriptionType = value;
  }
  inline CreateNotificationSubscriptionRequest& WithSubscriptionType(SubscriptionType value) {
