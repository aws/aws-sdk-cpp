...
class GetFolderPathRequest : public WorkDocsRequest {
 public:
  ...
  template <typename AuthenticationTokenT = Aws::String>
  GetFolderPathRequest& WithAuthenticationToken(AuthenticationTokenT&& value) {
  ...
  template <typename FolderIdT = Aws::String>
  GetFolderPathRequest& WithFolderId(FolderIdT&& value) {
  ...
  inline GetFolderPathRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  template <typename FieldsT = Aws::String>
  GetFolderPathRequest& WithFields(FieldsT&& value) {
  ...
  template <typename MarkerT = Aws::String>
  GetFolderPathRequest& WithMarker(MarkerT&& value) {
