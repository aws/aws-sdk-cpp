...
class GetDocumentVersionResult {
 public:
  ...
  template <typename MetadataT = DocumentVersionMetadata>
  GetDocumentVersionResult& WithMetadata(MetadataT&& value) {
  ...
  template <typename CustomMetadataT = Aws::Map<Aws::String, Aws::String>>
  GetDocumentVersionResult& WithCustomMetadata(CustomMetadataT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetDocumentVersionResult& WithRequestId(RequestIdT&& value) {
