...
namespace Model
{
  ...
  /**
   */
  class ActivateUserRequest : public WorkDocsRequest
  {
  public:
    AWS_WORKDOCS_API ActivateUserRequest() = default;
    ...
    template<typename UserIdT = Aws::String>
    ActivateUserRequest& WithUserId(UserIdT&& value) { SetUserId(std::forward<UserIdT>(value)); return *this;}
    ///@}
    ...
    template<typename AuthenticationTokenT = Aws::String>
    ActivateUserRequest& WithAuthenticationToken(AuthenticationTokenT&& value) { SetAuthenticationToken(std::forward<AuthenticationTokenT>(value)); return *this;}
    ///@}
  private:
