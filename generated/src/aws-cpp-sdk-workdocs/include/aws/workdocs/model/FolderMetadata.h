...
class FolderMetadata {
 public:
  ...
  inline FolderMetadata& WithResourceState(ResourceStateType value) {
  ...
  inline FolderMetadata& WithSize(long long value) {
    SetSize(value);
    return *this;
  }
  ///@}
  ...
  inline void SetLatestVersionSize(long long value) {
    m_latestVersionSizeHasBeenSet = true;
    m_latestVersionSize = value;
  }
  inline FolderMetadata& WithLatestVersionSize(long long value) {
    SetLatestVersionSize(value);
    return *this;
  }
  ///@}
 private:
