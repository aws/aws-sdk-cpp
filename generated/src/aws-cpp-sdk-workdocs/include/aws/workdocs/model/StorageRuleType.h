...
class StorageRuleType {
 public:
  ...
  inline void SetStorageAllocatedInBytes(long long value) {
    m_storageAllocatedInBytesHasBeenSet = true;
    m_storageAllocatedInBytes = value;
  }
  inline StorageRuleType& WithStorageAllocatedInBytes(long long value) {
    SetStorageAllocatedInBytes(value);
    return *this;
  }
  ///@}
  ...
  inline StorageRuleType& WithStorageType(StorageType value) {
