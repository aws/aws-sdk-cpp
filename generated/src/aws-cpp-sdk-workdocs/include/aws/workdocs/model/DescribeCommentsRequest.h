...
class DescribeCommentsRequest : public WorkDocsRequest {
 public:
  ...
  template <typename AuthenticationTokenT = Aws::String>
  DescribeCommentsRequest& WithAuthenticationToken(AuthenticationTokenT&& value) {
  ...
  template <typename DocumentIdT = Aws::String>
  DescribeCommentsRequest& WithDocumentId(DocumentIdT&& value) {
  ...
  template <typename VersionIdT = Aws::String>
  DescribeCommentsRequest& WithVersionId(VersionIdT&& value) {
  ...
  inline DescribeCommentsRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  DescribeCommentsRequest& WithMarker(MarkerT&& value) {
