...
class DeleteNotificationSubscriptionRequest : public WorkDocsRequest {
 public:
  ...
  template <typename SubscriptionIdT = Aws::String>
  DeleteNotificationSubscriptionRequest& WithSubscriptionId(SubscriptionIdT&& value) {
  ...
  template <typename OrganizationIdT = Aws::String>
  DeleteNotificationSubscriptionRequest& WithOrganizationId(OrganizationIdT&& value) {
