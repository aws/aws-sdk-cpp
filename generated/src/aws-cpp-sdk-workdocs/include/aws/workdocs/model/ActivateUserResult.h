...
namespace Model
{
  ...
  {
  public:
    AWS_WORKDOCS_API ActivateUserResult() = default;
    ...
    template<typename UserT = User>
    ActivateUserResult& WithUser(UserT&& value) { SetUser(std::forward<UserT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ActivateUserResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
