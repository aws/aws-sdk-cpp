...
class SearchResourcesRequest : public WorkDocsRequest {
 public:
  ...
  void SetQueryScopes(QueryScopesT&& value) {
    m_queryScopesHasBeenSet = true;
    m_queryScopes = std::forward<QueryScopesT>(value);
  }
  template <typename QueryScopesT = Aws::Vector<SearchQueryScopeType>>
  SearchResourcesRequest& WithQueryScopes(QueryScopesT&& value) {
    SetQueryScopes(std::forward<QueryScopesT>(value));
    return *this;
  }
  inline SearchResourcesRequest& AddQueryScopes(SearchQueryScopeType value) {
    m_queryScopesHasBeenSet = true;
    m_queryScopes.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetAdditionalResponseFields(AdditionalResponseFieldsT&& value) {
    m_additionalResponseFieldsHasBeenSet = true;
    m_additionalResponseFields = std::forward<AdditionalResponseFieldsT>(value);
  }
  template <typename AdditionalResponseFieldsT = Aws::Vector<AdditionalResponseFieldType>>
  SearchResourcesRequest& WithAdditionalResponseFields(AdditionalResponseFieldsT&& value) {
    SetAdditionalResponseFields(std::forward<AdditionalResponseFieldsT>(value));
    return *this;
  }
  inline SearchResourcesRequest& AddAdditionalResponseFields(AdditionalResponseFieldType value) {
    m_additionalResponseFieldsHasBeenSet = true;
    m_additionalResponseFields.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline SearchResourcesRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
