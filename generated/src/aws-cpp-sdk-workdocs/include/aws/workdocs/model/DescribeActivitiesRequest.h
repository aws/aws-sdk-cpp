...
class DescribeActivitiesRequest : public WorkDocsRequest {
 public:
  ...
  template <typename AuthenticationTokenT = Aws::String>
  DescribeActivitiesRequest& WithAuthenticationToken(AuthenticationTokenT&& value) {
  ...
  template <typename StartTimeT = Aws::Utils::DateTime>
  DescribeActivitiesRequest& WithStartTime(StartTimeT&& value) {
  ...
  template <typename EndTimeT = Aws::Utils::DateTime>
  DescribeActivitiesRequest& WithEndTime(EndTimeT&& value) {
  ...
  template <typename OrganizationIdT = Aws::String>
  DescribeActivitiesRequest& WithOrganizationId(OrganizationIdT&& value) {
  ...
  void SetActivityTypes(ActivityTypesT&& value) {
    m_activityTypesHasBeenSet = true;
    m_activityTypes = std::forward<ActivityTypesT>(value);
  }
  template <typename ActivityTypesT = Aws::String>
  DescribeActivitiesRequest& WithActivityTypes(ActivityTypesT&& value) {
    SetActivityTypes(std::forward<ActivityTypesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResourceIdT = Aws::String>
  DescribeActivitiesRequest& WithResourceId(ResourceIdT&& value) {
  ...
  template <typename UserIdT = Aws::String>
  DescribeActivitiesRequest& WithUserId(UserIdT&& value) {
  ...
  inline void SetIncludeIndirectActivities(bool value) {
    m_includeIndirectActivitiesHasBeenSet = true;
    m_includeIndirectActivities = value;
  }
  inline DescribeActivitiesRequest& WithIncludeIndirectActivities(bool value) {
    SetIncludeIndirectActivities(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeActivitiesRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  DescribeActivitiesRequest& WithMarker(MarkerT&& value) {
