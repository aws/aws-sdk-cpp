...
class ResourceMetadata {
 public:
  ...
  inline ResourceMetadata& WithType(ResourceType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename NameT = Aws::String>
  ResourceMetadata& WithName(NameT&& value) {
  ...
  void SetOriginalName(OriginalNameT&& value) {
    m_originalNameHasBeenSet = true;
    m_originalName = std::forward<OriginalNameT>(value);
  }
  template <typename OriginalNameT = Aws::String>
  ResourceMetadata& WithOriginalName(OriginalNameT&& value) {
    SetOriginalName(std::forward<OriginalNameT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename IdT = Aws::String>
  ResourceMetadata& WithId(IdT&& value) {
  ...
  template <typename VersionIdT = Aws::String>
  ResourceMetadata& WithVersionId(VersionIdT&& value) {
  ...
  template <typename OwnerT = UserMetadata>
  ResourceMetadata& WithOwner(OwnerT&& value) {
  ...
  template <typename ParentIdT = Aws::String>
  ResourceMetadata& WithParentId(ParentIdT&& value) {
