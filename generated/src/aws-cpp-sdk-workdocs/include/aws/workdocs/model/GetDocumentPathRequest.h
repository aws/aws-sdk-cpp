...
class GetDocumentPathRequest : public WorkDocsRequest {
 public:
  AWS_WORKDOCS_API GetDocumentPathRequest() = default;
  ...
  template <typename AuthenticationTokenT = Aws::String>
  GetDocumentPathRequest& WithAuthenticationToken(AuthenticationTokenT&& value) {
  ...
  template <typename DocumentIdT = Aws::String>
  GetDocumentPathRequest& WithDocumentId(DocumentIdT&& value) {
  ...
  inline GetDocumentPathRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  template <typename FieldsT = Aws::String>
  GetDocumentPathRequest& WithFields(FieldsT&& value) {
  ...
  template <typename MarkerT = Aws::String>
  GetDocumentPathRequest& WithMarker(MarkerT&& value) {
