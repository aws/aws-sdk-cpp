...
class InitiateDocumentVersionUploadResult {
 public:
  ...
  template <typename MetadataT = DocumentMetadata>
  InitiateDocumentVersionUploadResult& WithMetadata(MetadataT&& value) {
  ...
  template <typename UploadMetadataT = UploadMetadata>
  InitiateDocumentVersionUploadResult& WithUploadMetadata(UploadMetadataT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  InitiateDocumentVersionUploadResult& WithRequestId(RequestIdT&& value) {
