...
class DescribeActivitiesResult {
 public:
  ...
  void SetUserActivities(UserActivitiesT&& value) {
    m_userActivitiesHasBeenSet = true;
    m_userActivities = std::forward<UserActivitiesT>(value);
  }
  template <typename UserActivitiesT = Aws::Vector<Activity>>
  DescribeActivitiesResult& WithUserActivities(UserActivitiesT&& value) {
    SetUserActivities(std::forward<UserActivitiesT>(value));
    return *this;
  }
  template <typename UserActivitiesT = Activity>
  DescribeActivitiesResult& AddUserActivities(UserActivitiesT&& value) {
    m_userActivitiesHasBeenSet = true;
    m_userActivities.emplace_back(std::forward<UserActivitiesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  DescribeActivitiesResult& WithMarker(MarkerT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeActivitiesResult& WithRequestId(RequestIdT&& value) {
