...
class DescribeCommentsResult {
 public:
  ...
  template <typename CommentsT = Aws::Vector<Comment>>
  DescribeCommentsResult& WithComments(CommentsT&& value) {
    SetComments(std::forward<CommentsT>(value));
    return *this;
  }
  template <typename CommentsT = Comment>
  DescribeCommentsResult& AddComments(CommentsT&& value) {
    m_commentsHasBeenSet = true;
    m_comments.emplace_back(std::forward<CommentsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  DescribeCommentsResult& WithMarker(MarkerT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeCommentsResult& WithRequestId(RequestIdT&& value) {
