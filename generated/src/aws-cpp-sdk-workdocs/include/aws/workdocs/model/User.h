...
class User {
 public:
  ...
  void SetRootFolderId(RootFolderIdT&& value) {
    ...
    m_rootFolderId = std::forward<RootFolderIdT>(value);
  }
  template <typename RootFolderIdT = Aws::String>
  User& WithRootFolderId(RootFolderIdT&& value) {
    SetRootFolderId(std::forward<RootFolderIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRecycleBinFolderId(RecycleBinFolderIdT&& value) {
    ...
    m_recycleBinFolderId = std::forward<RecycleBinFolderIdT>(value);
  }
  template <typename RecycleBinFolderIdT = Aws::String>
  User& WithRecycleBinFolderId(RecycleBinFolderIdT&& value) {
    SetRecycleBinFolderId(std::forward<RecycleBinFolderIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(UserStatusType value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline User& WithStatus(UserStatusType value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline User& WithType(UserType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetModifiedTimestamp(ModifiedTimestampT&& value) {
    ...
    m_modifiedTimestamp = std::forward<ModifiedTimestampT>(value);
  }
  template <typename ModifiedTimestampT = Aws::Utils::DateTime>
  User& WithModifiedTimestamp(ModifiedTimestampT&& value) {
    SetModifiedTimestamp(std::forward<ModifiedTimestampT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetLocale(LocaleType value) {
    m_localeHasBeenSet = true;
    m_locale = value;
  }
  inline User& WithLocale(LocaleType value) {
    SetLocale(value);
    return *this;
  }
  ///@}
