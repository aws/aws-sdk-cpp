...
class DescribeFolderContentsResult {
 public:
  ...
  template <typename FoldersT = Aws::Vector<FolderMetadata>>
  DescribeFolderContentsResult& WithFolders(FoldersT&& value) {
    SetFolders(std::forward<FoldersT>(value));
    return *this;
  }
  template <typename FoldersT = FolderMetadata>
  DescribeFolderContentsResult& AddFolders(FoldersT&& value) {
    m_foldersHasBeenSet = true;
  ...
  template <typename DocumentsT = Aws::Vector<DocumentMetadata>>
  DescribeFolderContentsResult& WithDocuments(DocumentsT&& value) {
    SetDocuments(std::forward<DocumentsT>(value));
    return *this;
  }
  template <typename DocumentsT = DocumentMetadata>
  DescribeFolderContentsResult& AddDocuments(DocumentsT&& value) {
    m_documentsHasBeenSet = true;
  ...
  template <typename MarkerT = Aws::String>
  DescribeFolderContentsResult& WithMarker(MarkerT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeFolderContentsResult& WithRequestId(RequestIdT&& value) {
