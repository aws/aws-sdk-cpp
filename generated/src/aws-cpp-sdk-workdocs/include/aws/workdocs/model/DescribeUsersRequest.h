...
class DescribeUsersRequest : public WorkDocsRequest {
 public:
  ...
  inline void SetInclude(UserFilterType value) {
    m_includeHasBeenSet = true;
    m_include = value;
  }
  inline DescribeUsersRequest& WithInclude(UserFilterType value) {
    SetInclude(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeUsersRequest& WithOrder(OrderType value) {
    SetOrder(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSort(UserSortType value) {
    m_sortHasBeenSet = true;
    m_sort = value;
  }
  inline DescribeUsersRequest& WithSort(UserSortType value) {
    SetSort(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeUsersRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
