...
class DateRangeType {
 public:
  ...
  void SetStartValue(StartValueT&& value) {
    m_startValueHasBeenSet = true;
    m_startValue = std::forward<StartValueT>(value);
  }
  template <typename StartValueT = Aws::Utils::DateTime>
  DateRangeType& WithStartValue(StartValueT&& value) {
    SetStartValue(std::forward<StartValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEndValue(EndValueT&& value) {
    m_endValueHasBeenSet = true;
    m_endValue = std::forward<EndValueT>(value);
  }
  template <typename EndValueT = Aws::Utils::DateTime>
  DateRangeType& WithEndValue(EndValueT&& value) {
    SetEndValue(std::forward<EndValueT>(value));
    return *this;
  }
  ///@}
 private:
