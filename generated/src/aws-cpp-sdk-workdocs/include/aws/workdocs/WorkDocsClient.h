...
namespace WorkDocs
{
   ...
   * 
   */
  class AWS_WORKDOCS_API WorkDocsClient : Aws::Client::ClientWithAsyncTemplateMethods<WorkDocsClient>,
    smithy::client::AwsSmithyClientT<Aws::WorkDocs::SERVICE_NAME,
