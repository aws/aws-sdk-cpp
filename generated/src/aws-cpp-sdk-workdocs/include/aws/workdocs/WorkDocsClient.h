...
class AWS_WORKDOCS_API WorkDocsClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  WorkDocsClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<WorkDocsEndpointProviderBase> endpointProvider = nullptr,
   ...
   * API Reference</a></p>
   */
  virtual Model::AbortDocumentVersionUploadOutcome AbortDocumentVersionUpload(
      const Model::AbortDocumentVersionUploadRequest& request) const;

  /**
   * A Callable wrapper for AbortDocumentVersionUpload that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AbortDocumentVersionUploadRequestT = Model::AbortDocumentVersionUploadRequest>
  Model::AbortDocumentVersionUploadOutcomeCallable AbortDocumentVersionUploadCallable(
      const AbortDocumentVersionUploadRequestT& request) const {
    return SubmitCallable(&WorkDocsClient::AbortDocumentVersionUpload, request);
  }

  /**
   * An Async wrapper for AbortDocumentVersionUpload that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AbortDocumentVersionUploadRequestT = Model::AbortDocumentVersionUploadRequest>
  void AbortDocumentVersionUploadAsync(const AbortDocumentVersionUploadRequestT& request,
                                       const AbortDocumentVersionUploadResponseReceivedHandler& handler,
  ...
  /**
   * An Async wrapper for ActivateUser that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ActivateUserRequestT = Model::ActivateUserRequest>
  void ActivateUserAsync(const ActivateUserRequestT& request, const ActivateUserResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for AddResourcePermissions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AddResourcePermissions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AddResourcePermissionsRequestT = Model::AddResourcePermissionsRequest>
  void AddResourcePermissionsAsync(const AddResourcePermissionsRequestT& request,
                                   const AddResourcePermissionsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateComment that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateCommentRequestT = Model::CreateCommentRequest>
  void CreateCommentAsync(const CreateCommentRequestT& request, const CreateCommentResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateCustomMetadata that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateCustomMetadata that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateCustomMetadataRequestT = Model::CreateCustomMetadataRequest>
  void CreateCustomMetadataAsync(const CreateCustomMetadataRequestT& request, const CreateCustomMetadataResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateFolder that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateFolderRequestT = Model::CreateFolderRequest>
  void CreateFolderAsync(const CreateFolderRequestT& request, const CreateFolderResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateLabels that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateLabelsRequestT = Model::CreateLabelsRequest>
  void CreateLabelsAsync(const CreateLabelsRequestT& request, const CreateLabelsResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateNotificationSubscriptionOutcome CreateNotificationSubscription(
      const Model::CreateNotificationSubscriptionRequest& request) const;

  /**
   * A Callable wrapper for CreateNotificationSubscription that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateNotificationSubscriptionRequestT = Model::CreateNotificationSubscriptionRequest>
  Model::CreateNotificationSubscriptionOutcomeCallable CreateNotificationSubscriptionCallable(
      const CreateNotificationSubscriptionRequestT& request) const {
    return SubmitCallable(&WorkDocsClient::CreateNotificationSubscription, request);
  }

  /**
   * An Async wrapper for CreateNotificationSubscription that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateNotificationSubscriptionRequestT = Model::CreateNotificationSubscriptionRequest>
  void CreateNotificationSubscriptionAsync(const CreateNotificationSubscriptionRequestT& request,
                                           const CreateNotificationSubscriptionResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeactivateUser that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeactivateUserRequestT = Model::DeactivateUserRequest>
  void DeactivateUserAsync(const DeactivateUserRequestT& request, const DeactivateUserResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteComment that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteCommentRequestT = Model::DeleteCommentRequest>
  void DeleteCommentAsync(const DeleteCommentRequestT& request, const DeleteCommentResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteCustomMetadata that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteCustomMetadata that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteCustomMetadataRequestT = Model::DeleteCustomMetadataRequest>
  void DeleteCustomMetadataAsync(const DeleteCustomMetadataRequestT& request, const DeleteCustomMetadataResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteDocument that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteDocumentRequestT = Model::DeleteDocumentRequest>
  void DeleteDocumentAsync(const DeleteDocumentRequestT& request, const DeleteDocumentResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteDocumentVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteDocumentVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteDocumentVersionRequestT = Model::DeleteDocumentVersionRequest>
  void DeleteDocumentVersionAsync(const DeleteDocumentVersionRequestT& request, const DeleteDocumentVersionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteFolder that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteFolderRequestT = Model::DeleteFolderRequest>
  void DeleteFolderAsync(const DeleteFolderRequestT& request, const DeleteFolderResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteFolderContents that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteFolderContents that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteFolderContentsRequestT = Model::DeleteFolderContentsRequest>
  void DeleteFolderContentsAsync(const DeleteFolderContentsRequestT& request, const DeleteFolderContentsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteLabels that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteLabelsRequestT = Model::DeleteLabelsRequest>
  void DeleteLabelsAsync(const DeleteLabelsRequestT& request, const DeleteLabelsResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteNotificationSubscriptionOutcome DeleteNotificationSubscription(
      const Model::DeleteNotificationSubscriptionRequest& request) const;

  /**
   * A Callable wrapper for DeleteNotificationSubscription that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteNotificationSubscriptionRequestT = Model::DeleteNotificationSubscriptionRequest>
  Model::DeleteNotificationSubscriptionOutcomeCallable DeleteNotificationSubscriptionCallable(
      const DeleteNotificationSubscriptionRequestT& request) const {
    return SubmitCallable(&WorkDocsClient::DeleteNotificationSubscription, request);
  }

  /**
   * An Async wrapper for DeleteNotificationSubscription that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteNotificationSubscriptionRequestT = Model::DeleteNotificationSubscriptionRequest>
  void DeleteNotificationSubscriptionAsync(const DeleteNotificationSubscriptionRequestT& request,
                                           const DeleteNotificationSubscriptionResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeActivities that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeActivities that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeActivitiesRequestT = Model::DescribeActivitiesRequest>
  void DescribeActivitiesAsync(const DescribeActivitiesResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const DescribeActivitiesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeComments that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeComments that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeCommentsRequestT = Model::DescribeCommentsRequest>
  void DescribeCommentsAsync(const DescribeCommentsRequestT& request, const DescribeCommentsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeDocumentVersions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeDocumentVersions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeDocumentVersionsRequestT = Model::DescribeDocumentVersionsRequest>
  void DescribeDocumentVersionsAsync(const DescribeDocumentVersionsRequestT& request,
                                     const DescribeDocumentVersionsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeFolderContents that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeFolderContents that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeFolderContentsRequestT = Model::DescribeFolderContentsRequest>
  void DescribeFolderContentsAsync(const DescribeFolderContentsRequestT& request,
                                   const DescribeFolderContentsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeGroups that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeGroupsRequestT = Model::DescribeGroupsRequest>
  void DescribeGroupsAsync(const DescribeGroupsRequestT& request, const DescribeGroupsResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeNotificationSubscriptionsOutcome DescribeNotificationSubscriptions(
      const Model::DescribeNotificationSubscriptionsRequest& request) const;

  /**
   * A Callable wrapper for DescribeNotificationSubscriptions that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeNotificationSubscriptionsRequestT = Model::DescribeNotificationSubscriptionsRequest>
  Model::DescribeNotificationSubscriptionsOutcomeCallable DescribeNotificationSubscriptionsCallable(
      const DescribeNotificationSubscriptionsRequestT& request) const {
    return SubmitCallable(&WorkDocsClient::DescribeNotificationSubscriptions, request);
  }

  /**
   * An Async wrapper for DescribeNotificationSubscriptions that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeNotificationSubscriptionsRequestT = Model::DescribeNotificationSubscriptionsRequest>
  void DescribeNotificationSubscriptionsAsync(const DescribeNotificationSubscriptionsRequestT& request,
                                              const DescribeNotificationSubscriptionsResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeResourcePermissionsOutcome DescribeResourcePermissions(
      const Model::DescribeResourcePermissionsRequest& request) const;

  /**
   * A Callable wrapper for DescribeResourcePermissions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeResourcePermissionsRequestT = Model::DescribeResourcePermissionsRequest>
  Model::DescribeResourcePermissionsOutcomeCallable DescribeResourcePermissionsCallable(
      const DescribeResourcePermissionsRequestT& request) const {
    return SubmitCallable(&WorkDocsClient::DescribeResourcePermissions, request);
  }

  /**
   * An Async wrapper for DescribeResourcePermissions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeResourcePermissionsRequestT = Model::DescribeResourcePermissionsRequest>
  void DescribeResourcePermissionsAsync(const DescribeResourcePermissionsRequestT& request,
                                        const DescribeResourcePermissionsResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeRootFolders that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeRootFolders that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeRootFoldersRequestT = Model::DescribeRootFoldersRequest>
  void DescribeRootFoldersAsync(const DescribeRootFoldersRequestT& request, const DescribeRootFoldersResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetCurrentUser that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetCurrentUserRequestT = Model::GetCurrentUserRequest>
  void GetCurrentUserAsync(const GetCurrentUserRequestT& request, const GetCurrentUserResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetDocument that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetDocumentRequestT = Model::GetDocumentRequest>
  void GetDocumentAsync(const GetDocumentRequestT& request, const GetDocumentResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetDocumentPath that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetDocumentPathRequestT = Model::GetDocumentPathRequest>
  void GetDocumentPathAsync(const GetDocumentPathRequestT& request, const GetDocumentPathResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetDocumentVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetDocumentVersion that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetDocumentVersionRequestT = Model::GetDocumentVersionRequest>
  void GetDocumentVersionAsync(const GetDocumentVersionRequestT& request, const GetDocumentVersionResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetFolderPath that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetFolderPathRequestT = Model::GetFolderPathRequest>
  void GetFolderPathAsync(const GetFolderPathRequestT& request, const GetFolderPathResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetResources that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetResourcesRequestT = Model::GetResourcesRequest>
  void GetResourcesAsync(const GetResourcesResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                         const GetResourcesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::InitiateDocumentVersionUploadOutcome InitiateDocumentVersionUpload(
      const Model::InitiateDocumentVersionUploadRequest& request = {}) const;

  /**
   * A Callable wrapper for InitiateDocumentVersionUpload that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename InitiateDocumentVersionUploadRequestT = Model::InitiateDocumentVersionUploadRequest>
  Model::InitiateDocumentVersionUploadOutcomeCallable InitiateDocumentVersionUploadCallable(
      const InitiateDocumentVersionUploadRequestT& request = {}) const {
    return SubmitCallable(&WorkDocsClient::InitiateDocumentVersionUpload, request);
  }

  /**
   * An Async wrapper for InitiateDocumentVersionUpload that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename InitiateDocumentVersionUploadRequestT = Model::InitiateDocumentVersionUploadRequest>
  void InitiateDocumentVersionUploadAsync(const InitiateDocumentVersionUploadResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                          const InitiateDocumentVersionUploadRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::RemoveAllResourcePermissionsOutcome RemoveAllResourcePermissions(
      const Model::RemoveAllResourcePermissionsRequest& request) const;

  /**
   * A Callable wrapper for RemoveAllResourcePermissions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename RemoveAllResourcePermissionsRequestT = Model::RemoveAllResourcePermissionsRequest>
  Model::RemoveAllResourcePermissionsOutcomeCallable RemoveAllResourcePermissionsCallable(
      const RemoveAllResourcePermissionsRequestT& request) const {
    return SubmitCallable(&WorkDocsClient::RemoveAllResourcePermissions, request);
  }

  /**
   * An Async wrapper for RemoveAllResourcePermissions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RemoveAllResourcePermissionsRequestT = Model::RemoveAllResourcePermissionsRequest>
  void RemoveAllResourcePermissionsAsync(const RemoveAllResourcePermissionsRequestT& request,
                                         const RemoveAllResourcePermissionsResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RemoveResourcePermission that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RemoveResourcePermission that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RemoveResourcePermissionRequestT = Model::RemoveResourcePermissionRequest>
  void RemoveResourcePermissionAsync(const RemoveResourcePermissionRequestT& request,
                                     const RemoveResourcePermissionResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RestoreDocumentVersions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RestoreDocumentVersions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RestoreDocumentVersionsRequestT = Model::RestoreDocumentVersionsRequest>
  void RestoreDocumentVersionsAsync(const RestoreDocumentVersionsRequestT& request,
                                    const RestoreDocumentVersionsResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateDocument that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateDocumentRequestT = Model::UpdateDocumentRequest>
  void UpdateDocumentAsync(const UpdateDocumentRequestT& request, const UpdateDocumentResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateDocumentVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateDocumentVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateDocumentVersionRequestT = Model::UpdateDocumentVersionRequest>
  void UpdateDocumentVersionAsync(const UpdateDocumentVersionRequestT& request, const UpdateDocumentVersionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateFolder that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateFolderRequestT = Model::UpdateFolderRequest>
  void UpdateFolderAsync(const UpdateFolderRequestT& request, const UpdateFolderResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
