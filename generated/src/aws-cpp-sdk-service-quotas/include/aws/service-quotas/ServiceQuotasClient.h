...
namespace ServiceQuotas
{
   ...
   */
  class AWS_SERVICEQUOTAS_API ServiceQuotasClient : Aws::Client::ClientWithAsyncTemplateMethods<ServiceQuotasClient>,
    smithy::client::AwsSmithyClientT<Aws::ServiceQuotas::SERVICE_NAME,
