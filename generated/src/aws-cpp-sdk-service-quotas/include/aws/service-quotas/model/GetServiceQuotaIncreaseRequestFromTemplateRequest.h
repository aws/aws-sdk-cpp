...
class GetServiceQuotaIncreaseRequestFromTemplateRequest : public ServiceQuotasRequest {
 public:
  ...
  template <typename ServiceCodeT = Aws::String>
  GetServiceQuotaIncreaseRequestFromTemplateRequest& WithServiceCode(ServiceCodeT&& value) {
  ...
  template <typename QuotaCodeT = Aws::String>
  GetServiceQuotaIncreaseRequestFromTemplateRequest& WithQuotaCode(QuotaCodeT&& value) {
  ...
  template <typename AwsRegionT = Aws::String>
  GetServiceQuotaIncreaseRequestFromTemplateRequest& WithAwsRegion(AwsRegionT&& value) {
