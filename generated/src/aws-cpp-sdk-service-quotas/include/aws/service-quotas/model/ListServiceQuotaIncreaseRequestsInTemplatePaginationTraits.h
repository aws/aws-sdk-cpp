...
struct ListServiceQuotaIncreaseRequestsInTemplatePaginationTraits {
  using RequestType = Model::ListServiceQuotaIncreaseRequestsInTemplateRequest;
  using ResultType = Model::ListServiceQuotaIncreaseRequestsInTemplateResult;
  using OutcomeType = Model::ListServiceQuotaIncreaseRequestsInTemplateOutcome;
