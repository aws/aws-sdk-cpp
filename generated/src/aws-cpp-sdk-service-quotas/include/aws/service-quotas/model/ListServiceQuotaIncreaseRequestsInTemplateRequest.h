...
class ListServiceQuotaIncreaseRequestsInTemplateRequest : public ServiceQuotasRequest {
 public:
  ...
  template <typename ServiceCodeT = Aws::String>
  ListServiceQuotaIncreaseRequestsInTemplateRequest& WithServiceCode(ServiceCodeT&& value) {
  ...
  template <typename AwsRegionT = Aws::String>
  ListServiceQuotaIncreaseRequestsInTemplateRequest& WithAwsRegion(AwsRegionT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListServiceQuotaIncreaseRequestsInTemplateRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListServiceQuotaIncreaseRequestsInTemplateRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
