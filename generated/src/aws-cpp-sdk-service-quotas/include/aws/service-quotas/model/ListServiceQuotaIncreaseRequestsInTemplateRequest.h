...
namespace Model
{
  ...
  {
  public:
    AWS_SERVICEQUOTAS_API ListServiceQuotaIncreaseRequestsInTemplateRequest() = default;
    ...
    template<typename ServiceCodeT = Aws::String>
    ListServiceQuotaIncreaseRequestsInTemplateRequest& WithServiceCode(ServiceCodeT&& value) { SetServiceCode(std::forward<ServiceCodeT>(value)); return *this;}
    ///@}
    ...
    template<typename AwsRegionT = Aws::String>
    ListServiceQuotaIncreaseRequestsInTemplateRequest& WithAwsRegion(AwsRegionT&& value) { SetAwsRegion(std::forward<AwsRegionT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListServiceQuotaIncreaseRequestsInTemplateRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
