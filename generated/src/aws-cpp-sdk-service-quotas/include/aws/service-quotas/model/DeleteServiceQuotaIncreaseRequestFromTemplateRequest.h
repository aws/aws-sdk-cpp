...
class DeleteServiceQuotaIncreaseRequestFromTemplateRequest : public ServiceQuotasRequest {
 public:
  ...
  template <typename ServiceCodeT = Aws::String>
  DeleteServiceQuotaIncreaseRequestFromTemplateRequest& WithServiceCode(ServiceCodeT&& value) {
  ...
  template <typename QuotaCodeT = Aws::String>
  DeleteServiceQuotaIncreaseRequestFromTemplateRequest& WithQuotaCode(QuotaCodeT&& value) {
  ...
  template <typename AwsRegionT = Aws::String>
  DeleteServiceQuotaIncreaseRequestFromTemplateRequest& WithAwsRegion(AwsRegionT&& value) {
