...
namespace Model
{
  ...
  {
  public:
    AWS_SERVICEQUOTAS_API DeleteServiceQuotaIncreaseRequestFromTemplateRequest() = default;
    ...
    template<typename ServiceCodeT = Aws::String>
    DeleteServiceQuotaIncreaseRequestFromTemplateRequest& WithServiceCode(ServiceCodeT&& value) { SetServiceCode(std::forward<ServiceCodeT>(value)); return *this;}
    ///@}
    ...
    template<typename QuotaCodeT = Aws::String>
    DeleteServiceQuotaIncreaseRequestFromTemplateRequest& WithQuotaCode(QuotaCodeT&& value) { SetQuotaCode(std::forward<QuotaCodeT>(value)); return *this;}
    ///@}
    ...
    template<typename AwsRegionT = Aws::String>
    DeleteServiceQuotaIncreaseRequestFromTemplateRequest& WithAwsRegion(AwsRegionT&& value) { SetAwsRegion(std::forward<AwsRegionT>(value)); return *this;}
    ///@}
  private:
