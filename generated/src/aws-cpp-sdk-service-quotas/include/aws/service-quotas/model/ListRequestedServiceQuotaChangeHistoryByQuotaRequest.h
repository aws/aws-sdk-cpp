...
class ListRequestedServiceQuotaChangeHistoryByQuotaRequest : public ServiceQuotasRequest {
 public:
  ...
  template <typename ServiceCodeT = Aws::String>
  ListRequestedServiceQuotaChangeHistoryByQuotaRequest& WithServiceCode(ServiceCodeT&& value) {
  ...
  template <typename QuotaCodeT = Aws::String>
  ListRequestedServiceQuotaChangeHistoryByQuotaRequest& WithQuotaCode(QuotaCodeT&& value) {
  ...
  inline ListRequestedServiceQuotaChangeHistoryByQuotaRequest& WithStatus(RequestStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListRequestedServiceQuotaChangeHistoryByQuotaRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListRequestedServiceQuotaChangeHistoryByQuotaRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline ListRequestedServiceQuotaChangeHistoryByQuotaRequest& WithQuotaRequestedAtLevel(AppliedLevelEnum value) {
