...
namespace Model
{
  ...
  public:
    ...
    inline DeleteServiceQuotaIncreaseRequestFromTemplateResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeleteServiceQuotaIncreaseRequestFromTemplateResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeleteServiceQuotaIncreaseRequestFromTemplateResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
