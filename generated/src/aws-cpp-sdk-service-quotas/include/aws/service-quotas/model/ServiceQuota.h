...
class ServiceQuota {
 public:
  ...
  inline ServiceQuota& WithValue(double value) {
    SetValue(value);
    return *this;
  }
  ///@}
  ...
  inline ServiceQuota& WithAdjustable(bool value) {
    SetAdjustable(value);
    return *this;
  }
  ///@}
  ...
  inline ServiceQuota& WithGlobalQuota(bool value) {
  ...
  void SetUsageMetric(UsageMetricT&& value) {
    ...
    m_usageMetric = std::forward<UsageMetricT>(value);
  }
  template <typename UsageMetricT = MetricInfo>
  ServiceQuota& WithUsageMetric(UsageMetricT&& value) {
    SetUsageMetric(std::forward<UsageMetricT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetQuotaAppliedAtLevel(AppliedLevelEnum value) {
    m_quotaAppliedAtLevelHasBeenSet = true;
    m_quotaAppliedAtLevel = value;
  }
  inline ServiceQuota& WithQuotaAppliedAtLevel(AppliedLevelEnum value) {
    SetQuotaAppliedAtLevel(value);
    return *this;
  }
  ///@}
