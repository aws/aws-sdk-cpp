...
namespace Model
{
  ...
  public:
    ...
    template<typename NextTokenT = Aws::String>
    ListServiceQuotasResult& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename QuotasT = Aws::Vector<ServiceQuota>>
    ListServiceQuotasResult& WithQuotas(QuotasT&& value) { SetQuotas(std::forward<QuotasT>(value)); return *this;}
    template<typename QuotasT = ServiceQuota>
    ListServiceQuotasResult& AddQuotas(QuotasT&& value) { m_quotasHasBeenSet = true; m_quotas.emplace_back(std::forward<QuotasT>(value)); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ListServiceQuotasResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
