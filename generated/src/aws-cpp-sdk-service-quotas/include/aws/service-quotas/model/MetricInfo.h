...
class MetricInfo {
 public:
  ...
  void SetMetricDimensions(MetricDimensionsT&& value) {
    ...
    m_metricDimensions = std::forward<MetricDimensionsT>(value);
  }
  template <typename MetricDimensionsT = Aws::Map<Aws::String, Aws::String>>
  MetricInfo& WithMetricDimensions(MetricDimensionsT&& value) {
    SetMetricDimensions(std::forward<MetricDimensionsT>(value));
    return *this;
  }
  ...
  MetricInfo& AddMetricDimensions(MetricDimensionsKeyT&& key, MetricDimensionsValueT&& value) {
    m_metricDimensionsHasBeenSet = true;
    m_metricDimensions.emplace(std::forward<MetricDimensionsKeyT>(key), std::forward<MetricDimensionsValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMetricStatisticRecommendation(MetricStatisticRecommendationT&& value) {
    ...
    m_metricStatisticRecommendation = std::forward<MetricStatisticRecommendationT>(value);
  }
  template <typename MetricStatisticRecommendationT = Aws::String>
  MetricInfo& WithMetricStatisticRecommendation(MetricStatisticRecommendationT&& value) {
    SetMetricStatisticRecommendation(std::forward<MetricStatisticRecommendationT>(value));
    return *this;
  }
  ///@}
 private:
