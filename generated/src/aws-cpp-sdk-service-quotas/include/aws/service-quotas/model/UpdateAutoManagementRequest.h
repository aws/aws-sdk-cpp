...
namespace Model
{
  ...
  public:
    ...
    inline UpdateAutoManagementRequest& WithOptInType(OptInType value) { SetOptInType(value); return *this;}
    ///@}
    ...
    template<typename NotificationArnT = Aws::String>
    UpdateAutoManagementRequest& WithNotificationArn(NotificationArnT&& value) { SetNotificationArn(std::forward<NotificationArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ExclusionListT = Aws::Map<Aws::String, Aws::Vector<Aws::String>>>
    UpdateAutoManagementRequest& WithExclusionList(ExclusionListT&& value) { SetExclusionList(std::forward<ExclusionListT>(value)); return *this;}
