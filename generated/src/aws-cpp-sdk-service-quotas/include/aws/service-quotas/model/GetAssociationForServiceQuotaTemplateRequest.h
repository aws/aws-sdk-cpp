...
namespace Model
{
  ...
  /**
   */
  class GetAssociationForServiceQuotaTemplateRequest : public ServiceQuotasRequest
  {
  public:
    AWS_SERVICEQUOTAS_API GetAssociationForServiceQuotaTemplateRequest() = default;
