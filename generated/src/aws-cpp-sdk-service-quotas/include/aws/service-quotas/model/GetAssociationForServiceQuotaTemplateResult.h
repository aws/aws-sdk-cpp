...
class GetAssociationForServiceQuotaTemplateResult {
 public:
  ...
  AWS_SERVICEQUOTAS_API GetAssociationForServiceQuotaTemplateResult& operator=(
   ...
   */
  inline ServiceQuotaTemplateAssociationStatus GetServiceQuotaTemplateAssociationStatus() const {
    return m_serviceQuotaTemplateAssociationStatus;
  }
  inline void SetServiceQuotaTemplateAssociationStatus(ServiceQuotaTemplateAssociationStatus value) {
    m_serviceQuotaTemplateAssociationStatusHasBeenSet = true;
    m_serviceQuotaTemplateAssociationStatus = value;
  }
  inline GetAssociationForServiceQuotaTemplateResult& WithServiceQuotaTemplateAssociationStatus(
      ServiceQuotaTemplateAssociationStatus value) {
    SetServiceQuotaTemplateAssociationStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetAssociationForServiceQuotaTemplateResult& WithRequestId(RequestIdT&& value) {
