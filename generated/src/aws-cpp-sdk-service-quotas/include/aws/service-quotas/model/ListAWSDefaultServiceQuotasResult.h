...
class ListAWSDefaultServiceQuotasResult {
 public:
  ...
  AWS_SERVICEQUOTAS_API ListAWSDefaultServiceQuotasResult& operator=(
  ...
  template <typename NextTokenT = Aws::String>
  ListAWSDefaultServiceQuotasResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename QuotasT = Aws::Vector<ServiceQuota>>
  ListAWSDefaultServiceQuotasResult& WithQuotas(QuotasT&& value) {
    SetQuotas(std::forward<QuotasT>(value));
    return *this;
  }
  template <typename QuotasT = ServiceQuota>
  ListAWSDefaultServiceQuotasResult& AddQuotas(QuotasT&& value) {
    m_quotasHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListAWSDefaultServiceQuotasResult& WithRequestId(RequestIdT&& value) {
