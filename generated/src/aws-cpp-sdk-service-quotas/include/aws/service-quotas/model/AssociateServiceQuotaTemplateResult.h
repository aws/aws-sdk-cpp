...
namespace Model
{
  ...
  public:
    ...
    inline AssociateServiceQuotaTemplateResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline AssociateServiceQuotaTemplateResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline AssociateServiceQuotaTemplateResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
