...
class GetServiceQuotaIncreaseRequestFromTemplateResult {
 public:
  AWS_SERVICEQUOTAS_API GetServiceQuotaIncreaseRequestFromTemplateResult() = default;
  AWS_SERVICEQUOTAS_API GetServiceQuotaIncreaseRequestFromTemplateResult(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_SERVICEQUOTAS_API GetServiceQuotaIncreaseRequestFromTemplateResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ServiceQuotaIncreaseRequestInTemplateT = ServiceQuotaIncreaseRequestInTemplate>
  GetServiceQuotaIncreaseRequestFromTemplateResult& WithServiceQuotaIncreaseRequestInTemplate(
  ...
  template <typename RequestIdT = Aws::String>
  GetServiceQuotaIncreaseRequestFromTemplateResult& WithRequestId(RequestIdT&& value) {
