...
class GetAutoManagementConfigurationResult {
 public:
  ...
  AWS_SERVICEQUOTAS_API GetAutoManagementConfigurationResult& operator=(
  ...
  inline void SetOptInLevel(OptInLevel value) {
    m_optInLevelHasBeenSet = true;
    m_optInLevel = value;
  }
  inline GetAutoManagementConfigurationResult& WithOptInLevel(OptInLevel value) {
    SetOptInLevel(value);
    return *this;
  }
  ///@}
  ...
  inline GetAutoManagementConfigurationResult& WithOptInType(OptInType value) {
    SetOptInType(value);
    return *this;
  }
  ///@}
  ...
  inline GetAutoManagementConfigurationResult& WithOptInStatus(OptInStatus value) {
