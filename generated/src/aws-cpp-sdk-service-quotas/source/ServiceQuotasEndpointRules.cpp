...
{
const size_t ServiceQuotasEndpointRules::RulesBlobStrLen = 3733;
const size_t ServiceQuotasEndpointRules::RulesBlobSize = 3734;
...
'"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','s','e','r','v','i','c','e','q','u','o',
't','a','s','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t',
...
'v','i','c','e','q','u','o','t','a','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t',
...
'q','u','o','t','a','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o',
...
const char* ServiceQuotasEndpointRules::GetRulesBlob()
{
