...
class AWS_PAYMENTCRYPTOGRAPHY_API PaymentCryptographyClient : public Aws::Client::AWSJsonClient,
 ...
 public:
  ...
  PaymentCryptographyClient(const Aws::Auth::AWSCredentials& credentials,
                            std::shared_ptr<PaymentCryptographyEndpointProviderBase> endpointProvider = nullptr,
                            const Aws::PaymentCryptography::PaymentCryptographyClientConfiguration& clientConfiguration =
                                Aws::PaymentCryptography::PaymentCryptographyClientConfiguration());
  ...
  /**
   * A Callable wrapper for AddKeyReplicationRegions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AddKeyReplicationRegions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AddKeyReplicationRegionsRequestT = Model::AddKeyReplicationRegionsRequest>
  void AddKeyReplicationRegionsAsync(const AddKeyReplicationRegionsRequestT& request,
   ...
   */
  template <typename CreateKeyRequestT = Model::CreateKeyRequest>
  void CreateKeyAsync(const CreateKeyRequestT& request, const CreateKeyResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteKey that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteKeyRequestT = Model::DeleteKeyRequest>
   ...
   * API Reference</a></p>
   */
  virtual Model::DisableDefaultKeyReplicationRegionsOutcome DisableDefaultKeyReplicationRegions(
      const Model::DisableDefaultKeyReplicationRegionsRequest& request) const;

  /**
   * A Callable wrapper for DisableDefaultKeyReplicationRegions that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DisableDefaultKeyReplicationRegionsRequestT = Model::DisableDefaultKeyReplicationRegionsRequest>
  Model::DisableDefaultKeyReplicationRegionsOutcomeCallable DisableDefaultKeyReplicationRegionsCallable(
      const DisableDefaultKeyReplicationRegionsRequestT& request) const {
    return SubmitCallable(&PaymentCryptographyClient::DisableDefaultKeyReplicationRegions, request);
  }

  /**
   * An Async wrapper for DisableDefaultKeyReplicationRegions that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DisableDefaultKeyReplicationRegionsRequestT = Model::DisableDefaultKeyReplicationRegionsRequest>
  void DisableDefaultKeyReplicationRegionsAsync(const DisableDefaultKeyReplicationRegionsRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::EnableDefaultKeyReplicationRegionsOutcome EnableDefaultKeyReplicationRegions(
      const Model::EnableDefaultKeyReplicationRegionsRequest& request) const;

  /**
   * A Callable wrapper for EnableDefaultKeyReplicationRegions that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename EnableDefaultKeyReplicationRegionsRequestT = Model::EnableDefaultKeyReplicationRegionsRequest>
  Model::EnableDefaultKeyReplicationRegionsOutcomeCallable EnableDefaultKeyReplicationRegionsCallable(
      const EnableDefaultKeyReplicationRegionsRequestT& request) const {
    return SubmitCallable(&PaymentCryptographyClient::EnableDefaultKeyReplicationRegions, request);
  }

  /**
   * An Async wrapper for EnableDefaultKeyReplicationRegions that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename EnableDefaultKeyReplicationRegionsRequestT = Model::EnableDefaultKeyReplicationRegionsRequest>
  void EnableDefaultKeyReplicationRegionsAsync(const EnableDefaultKeyReplicationRegionsRequestT& request,
                                               const EnableDefaultKeyReplicationRegionsResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ExportKey that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ExportKeyRequestT = Model::ExportKeyRequest>
  void ExportKeyAsync(const ExportKeyRequestT& request, const ExportKeyResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetAlias that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetAliasRequestT = Model::GetAliasRequest>
  void GetAliasAsync(const GetAliasRequestT& request, const GetAliasResponseReceivedHandler& handler,
                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetCertificateSigningRequestOutcome GetCertificateSigningRequest(
      const Model::GetCertificateSigningRequestRequest& request) const;

  /**
   * A Callable wrapper for GetCertificateSigningRequest that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetCertificateSigningRequestRequestT = Model::GetCertificateSigningRequestRequest>
  Model::GetCertificateSigningRequestOutcomeCallable GetCertificateSigningRequestCallable(
      const GetCertificateSigningRequestRequestT& request) const {
    return SubmitCallable(&PaymentCryptographyClient::GetCertificateSigningRequest, request);
  }

  /**
   * An Async wrapper for GetCertificateSigningRequest that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetCertificateSigningRequestRequestT = Model::GetCertificateSigningRequestRequest>
  void GetCertificateSigningRequestAsync(const GetCertificateSigningRequestRequestT& request,
                                         const GetCertificateSigningRequestResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetDefaultKeyReplicationRegionsOutcome GetDefaultKeyReplicationRegions(
      const Model::GetDefaultKeyReplicationRegionsRequest& request = {}) const;

  /**
   * A Callable wrapper for GetDefaultKeyReplicationRegions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetDefaultKeyReplicationRegionsRequestT = Model::GetDefaultKeyReplicationRegionsRequest>
  Model::GetDefaultKeyReplicationRegionsOutcomeCallable GetDefaultKeyReplicationRegionsCallable(
      const GetDefaultKeyReplicationRegionsRequestT& request = {}) const {
    return SubmitCallable(&PaymentCryptographyClient::GetDefaultKeyReplicationRegions, request);
  }

  /**
   * An Async wrapper for GetDefaultKeyReplicationRegions that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetDefaultKeyReplicationRegionsRequestT = Model::GetDefaultKeyReplicationRegionsRequest>
  void GetDefaultKeyReplicationRegionsAsync(const GetDefaultKeyReplicationRegionsResponseReceivedHandler& handler,
  ...
  /**
   * An Async wrapper for GetKey that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetKeyRequestT = Model::GetKeyRequest>
  ...
  /**
   * A Callable wrapper for GetParametersForExport that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetParametersForExport that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetParametersForExportRequestT = Model::GetParametersForExportRequest>
  void GetParametersForExportAsync(const GetParametersForExportRequestT& request,
                                   const GetParametersForExportResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetPublicKeyCertificate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetPublicKeyCertificate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetPublicKeyCertificateRequestT = Model::GetPublicKeyCertificateRequest>
  void GetPublicKeyCertificateAsync(const GetPublicKeyCertificateRequestT& request,
  ...
  /**
   * An Async wrapper for ImportKey that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ImportKeyRequestT = Model::ImportKeyRequest>
  void ImportKeyAsync(const ImportKeyRequestT& request, const ImportKeyResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::RemoveKeyReplicationRegionsOutcome RemoveKeyReplicationRegions(
      const Model::RemoveKeyReplicationRegionsRequest& request) const;

  /**
   * A Callable wrapper for RemoveKeyReplicationRegions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename RemoveKeyReplicationRegionsRequestT = Model::RemoveKeyReplicationRegionsRequest>
  Model::RemoveKeyReplicationRegionsOutcomeCallable RemoveKeyReplicationRegionsCallable(
      const RemoveKeyReplicationRegionsRequestT& request) const {
    return SubmitCallable(&PaymentCryptographyClient::RemoveKeyReplicationRegions, request);
  }

  /**
   * An Async wrapper for RemoveKeyReplicationRegions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RemoveKeyReplicationRegionsRequestT = Model::RemoveKeyReplicationRegionsRequest>
  void RemoveKeyReplicationRegionsAsync(const RemoveKeyReplicationRegionsRequestT& request,
                                        const RemoveKeyReplicationRegionsResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for RestoreKey that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename RestoreKeyRequestT = Model::RestoreKeyRequest>
  void RestoreKeyAsync(const RestoreKeyRequestT& request, const RestoreKeyResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StartKeyUsage that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StartKeyUsageRequestT = Model::StartKeyUsageRequest>
  void StartKeyUsageAsync(const StartKeyUsageRequestT& request, const StartKeyUsageResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StopKeyUsage that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StopKeyUsageRequestT = Model::StopKeyUsageRequest>
  void StopKeyUsageAsync(const StopKeyUsageRequestT& request, const StopKeyUsageResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
