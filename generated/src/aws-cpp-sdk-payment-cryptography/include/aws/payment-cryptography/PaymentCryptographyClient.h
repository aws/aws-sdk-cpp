...
namespace PaymentCryptography
{
   ...
   * User Guide</a>.</p>
   */
  class AWS_PAYMENTCRYPTOGRAPHY_API PaymentCryptographyClient : Aws::Client::ClientWithAsyncTemplateMethods<PaymentCryptographyClient>,
    smithy::client::AwsSmithyClientT<Aws::PaymentCryptography::SERVICE_NAME,
    ...
    public:
      ...
      typedef PaymentCryptographyEndpointProvider EndpointProviderType;
        ...
        */
         ...
         * KDH signing certificate expires after 7 days. </p> <p>Next the KRD generates a
         ...
         * The export token expires in 7 days. You can use the same export token to export
