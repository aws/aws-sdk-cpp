...
using PaymentCryptographyEndpointProviderBase =
    EndpointProviderBase<PaymentCryptographyClientConfiguration, PaymentCryptographyBuiltInParameters,
                         PaymentCryptographyClientContextParameters>;

using PaymentCryptographyDefaultEpProviderBase =
    DefaultEndpointProvider<PaymentCryptographyClientConfiguration, PaymentCryptographyBuiltInParameters,
                            PaymentCryptographyClientContextParameters>;
