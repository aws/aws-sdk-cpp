...
class ExportTr34KeyBlock {
 public:
  ...
  void SetWrappingKeyCertificate(WrappingKeyCertificateT&& value) {
    ...
    m_wrappingKeyCertificate = std::forward<WrappingKeyCertificateT>(value);
  }
  template <typename WrappingKeyCertificateT = Aws::String>
  ExportTr34KeyBlock& WithWrappingKeyCertificate(WrappingKeyCertificateT&& value) {
    SetWrappingKeyCertificate(std::forward<WrappingKeyCertificateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExportToken(ExportTokenT&& value) {
    ...
    m_exportToken = std::forward<ExportTokenT>(value);
  }
  template <typename ExportTokenT = Aws::String>
  ExportTr34KeyBlock& WithExportToken(ExportTokenT&& value) {
    SetExportToken(std::forward<ExportTokenT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSigningKeyIdentifier(SigningKeyIdentifierT&& value) {
    ...
    m_signingKeyIdentifier = std::forward<SigningKeyIdentifierT>(value);
  }
  template <typename SigningKeyIdentifierT = Aws::String>
  ExportTr34KeyBlock& WithSigningKeyIdentifier(SigningKeyIdentifierT&& value) {
    SetSigningKeyIdentifier(std::forward<SigningKeyIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSigningKeyCertificate(SigningKeyCertificateT&& value) {
    ...
    m_signingKeyCertificate = std::forward<SigningKeyCertificateT>(value);
  }
  template <typename SigningKeyCertificateT = Aws::String>
  ExportTr34KeyBlock& WithSigningKeyCertificate(SigningKeyCertificateT&& value) {
    SetSigningKeyCertificate(std::forward<SigningKeyCertificateT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetKeyBlockFormat(Tr34KeyBlockFormat value) {
    m_keyBlockFormatHasBeenSet = true;
    m_keyBlockFormat = value;
  }
  inline ExportTr34KeyBlock& WithKeyBlockFormat(Tr34KeyBlockFormat value) {
    SetKeyBlockFormat(value);
    return *this;
  }
  ///@}
  ...
  void SetRandomNonce(RandomNonceT&& value) {
    ...
    m_randomNonce = std::forward<RandomNonceT>(value);
  }
  template <typename RandomNonceT = Aws::String>
  ExportTr34KeyBlock& WithRandomNonce(RandomNonceT&& value) {
    SetRandomNonce(std::forward<RandomNonceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetKeyBlockHeaders(KeyBlockHeadersT&& value) {
    ...
    m_keyBlockHeaders = std::forward<KeyBlockHeadersT>(value);
  }
  template <typename KeyBlockHeadersT = KeyBlockHeaders>
  ExportTr34KeyBlock& WithKeyBlockHeaders(KeyBlockHeadersT&& value) {
    SetKeyBlockHeaders(std::forward<KeyBlockHeadersT>(value));
    return *this;
  }
  ///@}
 private:
