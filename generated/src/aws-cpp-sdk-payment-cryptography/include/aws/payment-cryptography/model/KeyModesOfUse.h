...
class KeyModesOfUse {
 public:
  ...
  inline void SetEncrypt(bool value) {
    m_encryptHasBeenSet = true;
    m_encrypt = value;
  }
  inline KeyModesOfUse& WithEncrypt(bool value) {
    SetEncrypt(value);
    return *this;
  }
  ///@}
  ...
  inline KeyModesOfUse& WithDecrypt(bool value) {
    SetDecrypt(value);
    return *this;
  }
  ///@}
  ...
  inline void SetWrap(bool value) {
    m_wrapHasBeenSet = true;
    m_wrap = value;
  }
  inline KeyModesOfUse& WithWrap(bool value) {
    SetWrap(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUnwrap(bool value) {
    m_unwrapHasBeenSet = true;
    m_unwrap = value;
  }
  inline KeyModesOfUse& WithUnwrap(bool value) {
    SetUnwrap(value);
    return *this;
  }
  ///@}
  ...
  inline void SetGenerate(bool value) {
    m_generateHasBeenSet = true;
    m_generate = value;
  }
  inline KeyModesOfUse& WithGenerate(bool value) {
    SetGenerate(value);
    return *this;
  }
  ///@}
  ...
  inline KeyModesOfUse& WithSign(bool value) {
    SetSign(value);
    return *this;
  }
  ///@}
  ...
  inline void SetVerify(bool value) {
    m_verifyHasBeenSet = true;
    m_verify = value;
  }
  inline KeyModesOfUse& WithVerify(bool value) {
    SetVerify(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDeriveKey(bool value) {
    m_deriveKeyHasBeenSet = true;
    m_deriveKey = value;
  }
  inline KeyModesOfUse& WithDeriveKey(bool value) {
    SetDeriveKey(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNoRestrictions(bool value) {
    m_noRestrictionsHasBeenSet = true;
    m_noRestrictions = value;
  }
  inline KeyModesOfUse& WithNoRestrictions(bool value) {
    SetNoRestrictions(value);
    return *this;
  }
  ///@}
 private:
