...
class CreateKeyRequest : public PaymentCryptographyRequest {
 public:
  ...
  inline CreateKeyRequest& WithKeyCheckValueAlgorithm(KeyCheckValueAlgorithm value) {
  ...
  inline CreateKeyRequest& WithExportable(bool value) {
    SetExportable(value);
    return *this;
  }
  ///@}
  ...
  inline CreateKeyRequest& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline CreateKeyRequest& WithDeriveKeyUsage(DeriveKeyUsage value) {
