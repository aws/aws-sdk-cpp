...
class ImportDiffieHellmanTr31KeyBlock {
 public:
  ...
  template <typename PrivateKeyIdentifierT = Aws::String>
  ImportDiffieHellmanTr31KeyBlock& WithPrivateKeyIdentifier(PrivateKeyIdentifierT&& value) {
  ...
  template <typename CertificateAuthorityPublicKeyIdentifierT = Aws::String>
  ImportDiffieHellmanTr31KeyBlock& WithCertificateAuthorityPublicKeyIdentifier(CertificateAuthorityPublicKeyIdentifierT&& value) {
  ...
  template <typename PublicKeyCertificateT = Aws::String>
  ImportDiffieHellmanTr31KeyBlock& WithPublicKeyCertificate(PublicKeyCertificateT&& value) {
  ...
  inline ImportDiffieHellmanTr31KeyBlock& WithDeriveKeyAlgorithm(SymmetricKeyAlgorithm value) {
  ...
  inline ImportDiffieHellmanTr31KeyBlock& WithKeyDerivationFunction(KeyDerivationFunction value) {
  ...
  inline ImportDiffieHellmanTr31KeyBlock& WithKeyDerivationHashAlgorithm(KeyDerivationHashAlgorithm value) {
  ...
  template <typename DerivationDataT = DiffieHellmanDerivationData>
  ImportDiffieHellmanTr31KeyBlock& WithDerivationData(DerivationDataT&& value) {
  ...
  template <typename WrappedKeyBlockT = Aws::String>
  ImportDiffieHellmanTr31KeyBlock& WithWrappedKeyBlock(WrappedKeyBlockT&& value) {
