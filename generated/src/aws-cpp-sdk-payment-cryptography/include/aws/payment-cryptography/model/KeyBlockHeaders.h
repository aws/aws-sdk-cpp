...
class KeyBlockHeaders {
 public:
  ...
  inline void SetKeyExportability(KeyExportability value) {
    m_keyExportabilityHasBeenSet = true;
    m_keyExportability = value;
  }
  inline KeyBlockHeaders& WithKeyExportability(KeyExportability value) {
    SetKeyExportability(value);
    return *this;
  }
  ///@}
  ...
  void SetKeyVersion(KeyVersionT&& value) {
    m_keyVersionHasBeenSet = true;
    m_keyVersion = std::forward<KeyVersionT>(value);
  }
  template <typename KeyVersionT = Aws::String>
  KeyBlockHeaders& WithKeyVersion(KeyVersionT&& value) {
    SetKeyVersion(std::forward<KeyVersionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOptionalBlocks(OptionalBlocksT&& value) {
    m_optionalBlocksHasBeenSet = true;
    m_optionalBlocks = std::forward<OptionalBlocksT>(value);
  }
  template <typename OptionalBlocksT = Aws::Map<Aws::String, Aws::String>>
  KeyBlockHeaders& WithOptionalBlocks(OptionalBlocksT&& value) {
    SetOptionalBlocks(std::forward<OptionalBlocksT>(value));
    return *this;
  }
  ...
  KeyBlockHeaders& AddOptionalBlocks(OptionalBlocksKeyT&& key, OptionalBlocksValueT&& value) {
    m_optionalBlocksHasBeenSet = true;
    m_optionalBlocks.emplace(std::forward<OptionalBlocksKeyT>(key), std::forward<OptionalBlocksValueT>(value));
    return *this;
  }
  ///@}
 private:
