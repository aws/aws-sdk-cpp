...
class KeyAttributes {
 public:
  ...
  inline void SetKeyUsage(KeyUsage value) {
    m_keyUsageHasBeenSet = true;
    m_keyUsage = value;
  }
  inline KeyAttributes& WithKeyUsage(KeyUsage value) {
    SetKeyUsage(value);
    return *this;
  }
  ///@}
  ...
  inline void SetKeyClass(KeyClass value) {
    m_keyClassHasBeenSet = true;
    m_keyClass = value;
  }
  inline KeyAttributes& WithKeyClass(KeyClass value) {
    SetKeyClass(value);
    return *this;
  }
  ///@}
  ...
  inline KeyAttributes& WithKeyAlgorithm(KeyAlgorithm value) {
