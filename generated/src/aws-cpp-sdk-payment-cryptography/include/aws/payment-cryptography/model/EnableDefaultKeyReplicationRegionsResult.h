...
class EnableDefaultKeyReplicationRegionsResult {
 public:
  ...
  AWS_PAYMENTCRYPTOGRAPHY_API EnableDefaultKeyReplicationRegionsResult(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_PAYMENTCRYPTOGRAPHY_API EnableDefaultKeyReplicationRegionsResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename EnabledReplicationRegionsT = Aws::Vector<Aws::String>>
  EnableDefaultKeyReplicationRegionsResult& WithEnabledReplicationRegions(EnabledReplicationRegionsT&& value) {
  ...
  EnableDefaultKeyReplicationRegionsResult& AddEnabledReplicationRegions(EnabledReplicationRegionsT&& value) {
    m_enabledReplicationRegionsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  EnableDefaultKeyReplicationRegionsResult& WithRequestId(RequestIdT&& value) {
