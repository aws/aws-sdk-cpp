...
class GetParametersForExportResult {
 public:
  ...
  AWS_PAYMENTCRYPTOGRAPHY_API GetParametersForExportResult& operator=(
  ...
  template <typename SigningKeyCertificateT = Aws::String>
  GetParametersForExportResult& WithSigningKeyCertificate(SigningKeyCertificateT&& value) {
  ...
  void SetSigningKeyCertificateChain(SigningKeyCertificateChainT&& value) {
    m_signingKeyCertificateChainHasBeenSet = true;
    m_signingKeyCertificateChain = std::forward<SigningKeyCertificateChainT>(value);
  }
  template <typename SigningKeyCertificateChainT = Aws::String>
  GetParametersForExportResult& WithSigningKeyCertificateChain(SigningKeyCertificateChainT&& value) {
    SetSigningKeyCertificateChain(std::forward<SigningKeyCertificateChainT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetParametersForExportResult& WithSigningKeyAlgorithm(KeyAlgorithm value) {
  ...
  template <typename ExportTokenT = Aws::String>
  GetParametersForExportResult& WithExportToken(ExportTokenT&& value) {
  ...
  void SetParametersValidUntilTimestamp(ParametersValidUntilTimestampT&& value) {
    m_parametersValidUntilTimestampHasBeenSet = true;
    m_parametersValidUntilTimestamp = std::forward<ParametersValidUntilTimestampT>(value);
  }
  template <typename ParametersValidUntilTimestampT = Aws::Utils::DateTime>
  GetParametersForExportResult& WithParametersValidUntilTimestamp(ParametersValidUntilTimestampT&& value) {
    SetParametersValidUntilTimestamp(std::forward<ParametersValidUntilTimestampT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetParametersForExportResult& WithRequestId(RequestIdT&& value) {
