...
class GetDefaultKeyReplicationRegionsResult {
 public:
  ...
  AWS_PAYMENTCRYPTOGRAPHY_API GetDefaultKeyReplicationRegionsResult& operator=(
  ...
  template <typename EnabledReplicationRegionsT = Aws::Vector<Aws::String>>
  GetDefaultKeyReplicationRegionsResult& WithEnabledReplicationRegions(EnabledReplicationRegionsT&& value) {
  ...
  GetDefaultKeyReplicationRegionsResult& AddEnabledReplicationRegions(EnabledReplicationRegionsT&& value) {
    m_enabledReplicationRegionsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetDefaultKeyReplicationRegionsResult& WithRequestId(RequestIdT&& value) {
