...
class ExportKeyRequest : public PaymentCryptographyRequest {
 public:
  ...
  void SetExportKeyIdentifier(ExportKeyIdentifierT&& value) {
    m_exportKeyIdentifierHasBeenSet = true;
    m_exportKeyIdentifier = std::forward<ExportKeyIdentifierT>(value);
  }
  template <typename ExportKeyIdentifierT = Aws::String>
  ExportKeyRequest& WithExportKeyIdentifier(ExportKeyIdentifierT&& value) {
    SetExportKeyIdentifier(std::forward<ExportKeyIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExportAttributes(ExportAttributesT&& value) {
    m_exportAttributesHasBeenSet = true;
    m_exportAttributes = std::forward<ExportAttributesT>(value);
  }
  template <typename ExportAttributesT = ExportAttributes>
  ExportKeyRequest& WithExportAttributes(ExportAttributesT&& value) {
    SetExportAttributes(std::forward<ExportAttributesT>(value));
    return *this;
  }
  ///@}
 private:
