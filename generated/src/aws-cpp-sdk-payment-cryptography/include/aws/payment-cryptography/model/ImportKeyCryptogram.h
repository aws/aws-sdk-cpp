...
class ImportKeyCryptogram {
 public:
  ...
  inline ImportKeyCryptogram& WithExportable(bool value) {
    SetExportable(value);
    return *this;
  }
  ///@}
  ...
  inline void SetWrappingSpec(WrappingKeySpec value) {
    m_wrappingSpecHasBeenSet = true;
    m_wrappingSpec = value;
  }
  inline ImportKeyCryptogram& WithWrappingSpec(WrappingKeySpec value) {
    SetWrappingSpec(value);
    return *this;
  }
  ///@}
 private:
