...
class EnableDefaultKeyReplicationRegionsRequest : public PaymentCryptographyRequest {
 public:
  ...
  template <typename ReplicationRegionsT = Aws::Vector<Aws::String>>
  EnableDefaultKeyReplicationRegionsRequest& WithReplicationRegions(ReplicationRegionsT&& value) {
    SetReplicationRegions(std::forward<ReplicationRegionsT>(value));
    return *this;
  }
  template <typename ReplicationRegionsT = Aws::String>
  EnableDefaultKeyReplicationRegionsRequest& AddReplicationRegions(ReplicationRegionsT&& value) {
    m_replicationRegionsHasBeenSet = true;
