...
namespace Model
{
  ...
  /**
   */
  class GetPublicKeyCertificateRequest : public PaymentCryptographyRequest
  {
  public:
    AWS_PAYMENTCRYPTOGRAPHY_API GetPublicKeyCertificateRequest();

    // Service request name is the Operation name which will send this request out,
    // each operation should has unique request name, so that we can get operation's name from this request.
    // Note: this is not true for response, multiple operations may have the same response name,
    // so we can not get operation's name from response.
    inline virtual const char* GetServiceRequestName() const override { return "GetPublicKeyCertificate"; }
     ...
     * <p>The <code>KeyARN</code> of the asymmetric key pair.</p>
     */
    inline GetPublicKeyCertificateRequest& WithKeyIdentifier(const Aws::String& value) { SetKeyIdentifier(value); return *this;}

    /**
     * <p>The <code>KeyARN</code> of the asymmetric key pair.</p>
     */
    inline GetPublicKeyCertificateRequest& WithKeyIdentifier(Aws::String&& value) { SetKeyIdentifier(std::move(value)); return *this;}

    /**
     * <p>The <code>KeyARN</code> of the asymmetric key pair.</p>
     */
    inline GetPublicKeyCertificateRequest& WithKeyIdentifier(const char* value) { SetKeyIdentifier(value); return *this;}
