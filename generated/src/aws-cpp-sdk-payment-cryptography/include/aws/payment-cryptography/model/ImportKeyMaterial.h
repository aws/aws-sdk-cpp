...
class ImportKeyMaterial {
 public:
  ...
  void SetRootCertificatePublicKey(RootCertificatePublicKeyT&& value) {
    ...
    m_rootCertificatePublicKey = std::forward<RootCertificatePublicKeyT>(value);
  }
  template <typename RootCertificatePublicKeyT = RootCertificatePublicKey>
  ImportKeyMaterial& WithRootCertificatePublicKey(RootCertificatePublicKeyT&& value) {
    SetRootCertificatePublicKey(std::forward<RootCertificatePublicKeyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTrustedCertificatePublicKey(TrustedCertificatePublicKeyT&& value) {
    ...
    m_trustedCertificatePublicKey = std::forward<TrustedCertificatePublicKeyT>(value);
  }
  template <typename TrustedCertificatePublicKeyT = TrustedCertificatePublicKey>
  ImportKeyMaterial& WithTrustedCertificatePublicKey(TrustedCertificatePublicKeyT&& value) {
    SetTrustedCertificatePublicKey(std::forward<TrustedCertificatePublicKeyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTr31KeyBlock(Tr31KeyBlockT&& value) {
    ...
    m_tr31KeyBlock = std::forward<Tr31KeyBlockT>(value);
  }
  template <typename Tr31KeyBlockT = ImportTr31KeyBlock>
  ImportKeyMaterial& WithTr31KeyBlock(Tr31KeyBlockT&& value) {
    SetTr31KeyBlock(std::forward<Tr31KeyBlockT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTr34KeyBlock(Tr34KeyBlockT&& value) {
    ...
    m_tr34KeyBlock = std::forward<Tr34KeyBlockT>(value);
  }
  template <typename Tr34KeyBlockT = ImportTr34KeyBlock>
  ImportKeyMaterial& WithTr34KeyBlock(Tr34KeyBlockT&& value) {
    SetTr34KeyBlock(std::forward<Tr34KeyBlockT>(value));
    return *this;
  }
  ///@}
  ...
  void SetKeyCryptogram(KeyCryptogramT&& value) {
    ...
    m_keyCryptogram = std::forward<KeyCryptogramT>(value);
  }
  template <typename KeyCryptogramT = ImportKeyCryptogram>
  ImportKeyMaterial& WithKeyCryptogram(KeyCryptogramT&& value) {
    SetKeyCryptogram(std::forward<KeyCryptogramT>(value));
    return *this;
  }
  ///@}
