...
class Key {
 public:
  ...
  inline Key& WithKeyCheckValueAlgorithm(KeyCheckValueAlgorithm value) {
  ...
  inline Key& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline Key& WithExportable(bool value) {
    SetExportable(value);
    return *this;
  }
  ///@}
  ...
  inline Key& WithKeyState(KeyState value) {
    SetKeyState(value);
    return *this;
  }
  ///@}
  ...
  inline void SetKeyOrigin(KeyOrigin value) {
    m_keyOriginHasBeenSet = true;
    m_keyOrigin = value;
  }
  inline Key& WithKeyOrigin(KeyOrigin value) {
    SetKeyOrigin(value);
    return *this;
  }
  ///@}
  ...
  void SetUsageStartTimestamp(UsageStartTimestampT&& value) {
    ...
    m_usageStartTimestamp = std::forward<UsageStartTimestampT>(value);
  }
  template <typename UsageStartTimestampT = Aws::Utils::DateTime>
  Key& WithUsageStartTimestamp(UsageStartTimestampT&& value) {
    SetUsageStartTimestamp(std::forward<UsageStartTimestampT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUsageStopTimestamp(UsageStopTimestampT&& value) {
    ...
    m_usageStopTimestamp = std::forward<UsageStopTimestampT>(value);
  }
  template <typename UsageStopTimestampT = Aws::Utils::DateTime>
  Key& WithUsageStopTimestamp(UsageStopTimestampT&& value) {
    SetUsageStopTimestamp(std::forward<UsageStopTimestampT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDeletePendingTimestamp(DeletePendingTimestampT&& value) {
    ...
    m_deletePendingTimestamp = std::forward<DeletePendingTimestampT>(value);
  }
  template <typename DeletePendingTimestampT = Aws::Utils::DateTime>
  Key& WithDeletePendingTimestamp(DeletePendingTimestampT&& value) {
    SetDeletePendingTimestamp(std::forward<DeletePendingTimestampT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetDeriveKeyUsage(DeriveKeyUsage value) {
    m_deriveKeyUsageHasBeenSet = true;
    m_deriveKeyUsage = value;
  }
  inline Key& WithDeriveKeyUsage(DeriveKeyUsage value) {
    SetDeriveKeyUsage(value);
    return *this;
  }
  ///@}
  ...
  inline Key& WithMultiRegionKeyType(MultiRegionKeyType value) {
  ...
  Key& AddReplicationStatus(ReplicationStatusKeyT&& key, ReplicationStatusValueT&& value) {
    m_replicationStatusHasBeenSet = true;
    m_replicationStatus.emplace(std::forward<ReplicationStatusKeyT>(key), std::forward<ReplicationStatusValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetUsingDefaultReplicationRegions(bool value) {
    m_usingDefaultReplicationRegionsHasBeenSet = true;
    m_usingDefaultReplicationRegions = value;
  }
  inline Key& WithUsingDefaultReplicationRegions(bool value) {
    SetUsingDefaultReplicationRegions(value);
    return *this;
  }
  ///@}
 private:
