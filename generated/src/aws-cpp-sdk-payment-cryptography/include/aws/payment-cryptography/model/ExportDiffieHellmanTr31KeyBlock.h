...
class ExportDiffieHellmanTr31KeyBlock {
 public:
  ...
  template <typename PrivateKeyIdentifierT = Aws::String>
  ExportDiffieHellmanTr31KeyBlock& WithPrivateKeyIdentifier(PrivateKeyIdentifierT&& value) {
  ...
  template <typename CertificateAuthorityPublicKeyIdentifierT = Aws::String>
  ExportDiffieHellmanTr31KeyBlock& WithCertificateAuthorityPublicKeyIdentifier(CertificateAuthorityPublicKeyIdentifierT&& value) {
  ...
  template <typename PublicKeyCertificateT = Aws::String>
  ExportDiffieHellmanTr31KeyBlock& WithPublicKeyCertificate(PublicKeyCertificateT&& value) {
  ...
  inline ExportDiffieHellmanTr31KeyBlock& WithDeriveKeyAlgorithm(SymmetricKeyAlgorithm value) {
  ...
  inline ExportDiffieHellmanTr31KeyBlock& WithKeyDerivationFunction(KeyDerivationFunction value) {
  ...
  inline ExportDiffieHellmanTr31KeyBlock& WithKeyDerivationHashAlgorithm(KeyDerivationHashAlgorithm value) {
  ...
  template <typename DerivationDataT = DiffieHellmanDerivationData>
  ExportDiffieHellmanTr31KeyBlock& WithDerivationData(DerivationDataT&& value) {
  ...
  template <typename KeyBlockHeadersT = KeyBlockHeaders>
  ExportDiffieHellmanTr31KeyBlock& WithKeyBlockHeaders(KeyBlockHeadersT&& value) {
