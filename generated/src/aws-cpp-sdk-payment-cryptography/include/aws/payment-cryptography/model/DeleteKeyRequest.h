...
class DeleteKeyRequest : public PaymentCryptographyRequest {
 public:
  ...
  inline void SetDeleteKeyInDays(int value) {
    m_deleteKeyInDaysHasBeenSet = true;
    m_deleteKeyInDays = value;
  }
  inline DeleteKeyRequest& WithDeleteKeyInDays(int value) {
    SetDeleteKeyInDays(value);
    return *this;
  }
  ///@}
 private:
