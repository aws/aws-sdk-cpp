...
class GetParametersForImportResult {
 public:
  ...
  AWS_PAYMENTCRYPTOGRAPHY_API GetParametersForImportResult& operator=(
  ...
  template <typename WrappingKeyCertificateT = Aws::String>
  GetParametersForImportResult& WithWrappingKeyCertificate(WrappingKeyCertificateT&& value) {
  ...
  void SetWrappingKeyCertificateChain(WrappingKeyCertificateChainT&& value) {
    m_wrappingKeyCertificateChainHasBeenSet = true;
    m_wrappingKeyCertificateChain = std::forward<WrappingKeyCertificateChainT>(value);
  }
  template <typename WrappingKeyCertificateChainT = Aws::String>
  GetParametersForImportResult& WithWrappingKeyCertificateChain(WrappingKeyCertificateChainT&& value) {
    SetWrappingKeyCertificateChain(std::forward<WrappingKeyCertificateChainT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetParametersForImportResult& WithWrappingKeyAlgorithm(KeyAlgorithm value) {
  ...
  template <typename ParametersValidUntilTimestampT = Aws::Utils::DateTime>
  GetParametersForImportResult& WithParametersValidUntilTimestamp(ParametersValidUntilTimestampT&& value) {
