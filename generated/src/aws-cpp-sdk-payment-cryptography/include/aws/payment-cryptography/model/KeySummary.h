...
class KeySummary {
 public:
  ...
  inline KeySummary& WithKeyState(KeyState value) {
    SetKeyState(value);
    return *this;
  }
  ///@}
  ...
  inline KeySummary& WithExportable(bool value) {
    SetExportable(value);
    return *this;
  }
  ///@}
  ...
  inline KeySummary& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline KeySummary& WithMultiRegionKeyType(MultiRegionKeyType value) {
