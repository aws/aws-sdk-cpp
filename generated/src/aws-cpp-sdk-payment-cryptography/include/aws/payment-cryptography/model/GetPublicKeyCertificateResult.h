...
class GetPublicKeyCertificateResult {
 public:
  ...
  AWS_PAYMENTCRYPTOGRAPHY_API GetPublicKeyCertificateResult& operator=(
  ...
  void SetKeyCertificate(KeyCertificateT&& value) {
    ...
    m_keyCertificate = std::forward<KeyCertificateT>(value);
  }
  template <typename KeyCertificateT = Aws::String>
  GetPublicKeyCertificateResult& WithKeyCertificate(KeyCertificateT&& value) {
    SetKeyCertificate(std::forward<KeyCertificateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetKeyCertificateChain(KeyCertificateChainT&& value) {
    ...
    m_keyCertificateChain = std::forward<KeyCertificateChainT>(value);
  }
  template <typename KeyCertificateChainT = Aws::String>
  GetPublicKeyCertificateResult& WithKeyCertificateChain(KeyCertificateChainT&& value) {
    SetKeyCertificateChain(std::forward<KeyCertificateChainT>(value));
    return *this;
  }
  ///@}
