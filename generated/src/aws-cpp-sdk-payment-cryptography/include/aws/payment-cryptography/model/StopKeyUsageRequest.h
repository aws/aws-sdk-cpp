...
namespace Model
{
  ...
  {
  public:
    AWS_PAYMENTCRYPTOGRAPHY_API StopKeyUsageRequest() = default;
    ...
    template<typename KeyIdentifierT = Aws::String>
    StopKeyUsageRequest& WithKeyIdentifier(KeyIdentifierT&& value) { SetKeyIdentifier(std::forward<KeyIdentifierT>(value)); return *this;}
    ///@}
  private:
