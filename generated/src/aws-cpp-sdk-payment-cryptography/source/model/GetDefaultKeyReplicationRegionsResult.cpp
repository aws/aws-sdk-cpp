...
GetDefaultKeyReplicationRegionsResult::GetDefaultKeyReplicationRegionsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

GetDefaultKeyReplicationRegionsResult& GetDefaultKeyReplicationRegionsResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
