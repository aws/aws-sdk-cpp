...
namespace ServiceDiscovery
{
   ...
   */
  class AWS_SERVICEDISCOVERY_API ServiceDiscoveryClient : Aws::Client::ClientWithAsyncTemplateMethods<ServiceDiscoveryClient>,
    smithy::client::AwsSmithyClientT<Aws::ServiceDiscovery::SERVICE_NAME,
