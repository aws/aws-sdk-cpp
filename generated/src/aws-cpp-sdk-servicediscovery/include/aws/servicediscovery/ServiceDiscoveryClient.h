...
class AWS_SERVICEDISCOVERY_API ServiceDiscoveryClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  ServiceDiscoveryClient(const Aws::ServiceDiscovery::ServiceDiscoveryClientConfiguration& clientConfiguration =
  ...
  ServiceDiscoveryClient(const Aws::Auth::AWSCredentials& credentials,
                         std::shared_ptr<ServiceDiscoveryEndpointProviderBase> endpointProvider = nullptr,
                         const Aws::ServiceDiscovery::ServiceDiscoveryClientConfiguration& clientConfiguration =
                             Aws::ServiceDiscovery::ServiceDiscoveryClientConfiguration());
  ...
  /**
   * A Callable wrapper for CreateHttpNamespace that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateHttpNamespace that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateHttpNamespaceRequestT = Model::CreateHttpNamespaceRequest>
  void CreateHttpNamespaceAsync(const CreateHttpNamespaceRequestT& request, const CreateHttpNamespaceResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for CreatePrivateDnsNamespace that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CreatePrivateDnsNamespaceRequestT = Model::CreatePrivateDnsNamespaceRequest>
  Model::CreatePrivateDnsNamespaceOutcomeCallable CreatePrivateDnsNamespaceCallable(
      const CreatePrivateDnsNamespaceRequestT& request) const {
    return SubmitCallable(&ServiceDiscoveryClient::CreatePrivateDnsNamespace, request);
  }

  /**
   * An Async wrapper for CreatePrivateDnsNamespace that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreatePrivateDnsNamespaceRequestT = Model::CreatePrivateDnsNamespaceRequest>
  void CreatePrivateDnsNamespaceAsync(const CreatePrivateDnsNamespaceRequestT& request,
  ...
  /**
   * A Callable wrapper for CreatePublicDnsNamespace that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreatePublicDnsNamespace that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreatePublicDnsNamespaceRequestT = Model::CreatePublicDnsNamespaceRequest>
  void CreatePublicDnsNamespaceAsync(const CreatePublicDnsNamespaceRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteServiceAttributes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteServiceAttributes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteServiceAttributesRequestT = Model::DeleteServiceAttributesRequest>
  void DeleteServiceAttributesAsync(const DeleteServiceAttributesRequestT& request,
                                    const DeleteServiceAttributesResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeregisterInstance that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeregisterInstance that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeregisterInstanceRequestT = Model::DeregisterInstanceRequest>
  void DeregisterInstanceAsync(const DeregisterInstanceRequestT& request, const DeregisterInstanceResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DiscoverInstances that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DiscoverInstances that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DiscoverInstancesRequestT = Model::DiscoverInstancesRequest>
  void DiscoverInstancesAsync(const DiscoverInstancesRequestT& request, const DiscoverInstancesResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DiscoverInstancesRevision that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DiscoverInstancesRevisionRequestT = Model::DiscoverInstancesRevisionRequest>
  Model::DiscoverInstancesRevisionOutcomeCallable DiscoverInstancesRevisionCallable(
      const DiscoverInstancesRevisionRequestT& request) const {
    return SubmitCallable(&ServiceDiscoveryClient::DiscoverInstancesRevision, request);
  }

  /**
   * An Async wrapper for DiscoverInstancesRevision that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DiscoverInstancesRevisionRequestT = Model::DiscoverInstancesRevisionRequest>
  void DiscoverInstancesRevisionAsync(const DiscoverInstancesRevisionRequestT& request,
                                      const DiscoverInstancesRevisionResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetInstancesHealthStatus that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetInstancesHealthStatus that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetInstancesHealthStatusRequestT = Model::GetInstancesHealthStatusRequest>
  void GetInstancesHealthStatusAsync(const GetInstancesHealthStatusRequestT& request,
  ...
  /**
   * An Async wrapper for GetOperation that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetOperationRequestT = Model::GetOperationRequest>
  void GetOperationAsync(const GetOperationRequestT& request, const GetOperationResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetServiceAttributes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetServiceAttributes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetServiceAttributesRequestT = Model::GetServiceAttributesRequest>
  void GetServiceAttributesAsync(const GetServiceAttributesRequestT& request, const GetServiceAttributesResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename ListInstancesRequestT = Model::ListInstancesRequest>
  void ListInstancesAsync(const ListInstancesRequestT& request, const ListInstancesResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename ListNamespacesRequestT = Model::ListNamespacesRequest>
  void ListNamespacesAsync(const ListNamespacesResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const ListNamespacesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for RegisterInstance that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RegisterInstance that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename RegisterInstanceRequestT = Model::RegisterInstanceRequest>
  void RegisterInstanceAsync(const RegisterInstanceRequestT& request, const RegisterInstanceResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateHttpNamespace that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateHttpNamespace that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateHttpNamespaceRequestT = Model::UpdateHttpNamespaceRequest>
  void UpdateHttpNamespaceAsync(const UpdateHttpNamespaceRequestT& request, const UpdateHttpNamespaceResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateInstanceCustomHealthStatusOutcome UpdateInstanceCustomHealthStatus(
      const Model::UpdateInstanceCustomHealthStatusRequest& request) const;

  /**
   * A Callable wrapper for UpdateInstanceCustomHealthStatus that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename UpdateInstanceCustomHealthStatusRequestT = Model::UpdateInstanceCustomHealthStatusRequest>
  Model::UpdateInstanceCustomHealthStatusOutcomeCallable UpdateInstanceCustomHealthStatusCallable(
      const UpdateInstanceCustomHealthStatusRequestT& request) const {
    return SubmitCallable(&ServiceDiscoveryClient::UpdateInstanceCustomHealthStatus, request);
  }

  /**
   * An Async wrapper for UpdateInstanceCustomHealthStatus that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateInstanceCustomHealthStatusRequestT = Model::UpdateInstanceCustomHealthStatusRequest>
  void UpdateInstanceCustomHealthStatusAsync(const UpdateInstanceCustomHealthStatusRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdatePrivateDnsNamespace that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename UpdatePrivateDnsNamespaceRequestT = Model::UpdatePrivateDnsNamespaceRequest>
  Model::UpdatePrivateDnsNamespaceOutcomeCallable UpdatePrivateDnsNamespaceCallable(
      const UpdatePrivateDnsNamespaceRequestT& request) const {
    return SubmitCallable(&ServiceDiscoveryClient::UpdatePrivateDnsNamespace, request);
  }

  /**
   * An Async wrapper for UpdatePrivateDnsNamespace that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdatePrivateDnsNamespaceRequestT = Model::UpdatePrivateDnsNamespaceRequest>
  void UpdatePrivateDnsNamespaceAsync(const UpdatePrivateDnsNamespaceRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdatePublicDnsNamespace that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdatePublicDnsNamespace that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdatePublicDnsNamespaceRequestT = Model::UpdatePublicDnsNamespaceRequest>
  void UpdatePublicDnsNamespaceAsync(const UpdatePublicDnsNamespaceRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateServiceAttributes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateServiceAttributes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateServiceAttributesRequestT = Model::UpdateServiceAttributesRequest>
  void UpdateServiceAttributesAsync(const UpdateServiceAttributesRequestT& request,
                                    const UpdateServiceAttributesResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
