...
namespace Model
{
  ...
  {
  public:
    AWS_SERVICEDISCOVERY_API CreatePublicDnsNamespaceResult() = default;
    ...
    template<typename OperationIdT = Aws::String>
    CreatePublicDnsNamespaceResult& WithOperationId(OperationIdT&& value) { SetOperationId(std::forward<OperationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreatePublicDnsNamespaceResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
