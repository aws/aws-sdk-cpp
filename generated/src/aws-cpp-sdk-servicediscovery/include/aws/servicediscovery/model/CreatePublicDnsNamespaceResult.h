...
class CreatePublicDnsNamespaceResult {
 public:
  ...
  AWS_SERVICEDISCOVERY_API CreatePublicDnsNamespaceResult& operator=(
  ...
  template <typename OperationIdT = Aws::String>
  CreatePublicDnsNamespaceResult& WithOperationId(OperationIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreatePublicDnsNamespaceResult& WithRequestId(RequestIdT&& value) {
