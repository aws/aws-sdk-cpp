...
class DnsConfig {
 public:
  ...
  inline void SetRoutingPolicy(RoutingPolicy value) {
    m_routingPolicyHasBeenSet = true;
    m_routingPolicy = value;
  }
  inline DnsConfig& WithRoutingPolicy(RoutingPolicy value) {
  ...
  void SetDnsRecords(DnsRecordsT&& value) {
    ...
    m_dnsRecords = std::forward<DnsRecordsT>(value);
  }
  template <typename DnsRecordsT = Aws::Vector<DnsRecord>>
  DnsConfig& WithDnsRecords(DnsRecordsT&& value) {
    SetDnsRecords(std::forward<DnsRecordsT>(value));
    return *this;
  }
  template <typename DnsRecordsT = DnsRecord>
  DnsConfig& AddDnsRecords(DnsRecordsT&& value) {
    m_dnsRecordsHasBeenSet = true;
    m_dnsRecords.emplace_back(std::forward<DnsRecordsT>(value));
    return *this;
  }
  ///@}
 private:
