...
class NamespaceAlreadyExists {
 public:
  ...
  template <typename MessageT = Aws::String>
  NamespaceAlreadyExists& WithMessage(MessageT&& value) {
  ...
  template <typename CreatorRequestIdT = Aws::String>
  NamespaceAlreadyExists& WithCreatorRequestId(CreatorRequestIdT&& value) {
  ...
  template <typename NamespaceIdT = Aws::String>
  NamespaceAlreadyExists& WithNamespaceId(NamespaceIdT&& value) {
