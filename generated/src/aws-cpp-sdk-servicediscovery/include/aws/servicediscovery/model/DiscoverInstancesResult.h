...
class DiscoverInstancesResult {
 public:
  ...
  template <typename InstancesT = Aws::Vector<HttpInstanceSummary>>
  DiscoverInstancesResult& WithInstances(InstancesT&& value) {
    SetInstances(std::forward<InstancesT>(value));
    return *this;
  }
  template <typename InstancesT = HttpInstanceSummary>
  DiscoverInstancesResult& AddInstances(InstancesT&& value) {
    m_instancesHasBeenSet = true;
  ...
  inline DiscoverInstancesResult& WithInstancesRevision(long long value) {
  ...
  template <typename RequestIdT = Aws::String>
  DiscoverInstancesResult& WithRequestId(RequestIdT&& value) {
