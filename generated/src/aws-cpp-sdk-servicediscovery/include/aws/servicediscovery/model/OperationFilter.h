...
class OperationFilter {
 public:
  ...
  inline void SetName(OperationFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline OperationFilter& WithName(OperationFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  OperationFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  OperationFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
  ...
  inline OperationFilter& WithCondition(FilterCondition value) {
    SetCondition(value);
    return *this;
  }
  ///@}
