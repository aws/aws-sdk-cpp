...
class GetInstancesHealthStatusRequest : public ServiceDiscoveryRequest {
 public:
  ...
  template <typename ServiceIdT = Aws::String>
  GetInstancesHealthStatusRequest& WithServiceId(ServiceIdT&& value) {
  ...
  template <typename InstancesT = Aws::Vector<Aws::String>>
  GetInstancesHealthStatusRequest& WithInstances(InstancesT&& value) {
    SetInstances(std::forward<InstancesT>(value));
    return *this;
  }
  template <typename InstancesT = Aws::String>
  GetInstancesHealthStatusRequest& AddInstances(InstancesT&& value) {
    m_instancesHasBeenSet = true;
  ...
  inline GetInstancesHealthStatusRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetInstancesHealthStatusRequest& WithNextToken(NextTokenT&& value) {
