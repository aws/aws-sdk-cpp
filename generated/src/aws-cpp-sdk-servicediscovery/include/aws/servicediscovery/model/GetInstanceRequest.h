...
namespace Model
{
  ...
  {
  public:
    AWS_SERVICEDISCOVERY_API GetInstanceRequest() = default;
     ...
     * ARN. For more information about shared namespaces, see <a
    ...
    template<typename ServiceIdT = Aws::String>
    GetInstanceRequest& WithServiceId(ServiceIdT&& value) { SetServiceId(std::forward<ServiceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename InstanceIdT = Aws::String>
    GetInstanceRequest& WithInstanceId(InstanceIdT&& value) { SetInstanceId(std::forward<InstanceIdT>(value)); return *this;}
    ///@}
  private:
