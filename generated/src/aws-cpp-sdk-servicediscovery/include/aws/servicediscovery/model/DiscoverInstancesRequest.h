...
class DiscoverInstancesRequest : public ServiceDiscoveryRequest {
 public:
  ...
  inline DiscoverInstancesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  DiscoverInstancesRequest& AddQueryParameters(QueryParametersKeyT&& key, QueryParametersValueT&& value) {
    m_queryParametersHasBeenSet = true;
    m_queryParameters.emplace(std::forward<QueryParametersKeyT>(key), std::forward<QueryParametersValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOptionalParameters(OptionalParametersT&& value) {
    m_optionalParametersHasBeenSet = true;
    m_optionalParameters = std::forward<OptionalParametersT>(value);
  }
  template <typename OptionalParametersT = Aws::Map<Aws::String, Aws::String>>
  DiscoverInstancesRequest& WithOptionalParameters(OptionalParametersT&& value) {
    SetOptionalParameters(std::forward<OptionalParametersT>(value));
    return *this;
  }
  ...
  DiscoverInstancesRequest& AddOptionalParameters(OptionalParametersKeyT&& key, OptionalParametersValueT&& value) {
    m_optionalParametersHasBeenSet = true;
    m_optionalParameters.emplace(std::forward<OptionalParametersKeyT>(key), std::forward<OptionalParametersValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetHealthStatus(HealthStatusFilter value) {
    m_healthStatusHasBeenSet = true;
    m_healthStatus = value;
  }
  inline DiscoverInstancesRequest& WithHealthStatus(HealthStatusFilter value) {
