...
class ServiceFilter {
 public:
  ...
  inline void SetName(ServiceFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline ServiceFilter& WithName(ServiceFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  ServiceFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  ServiceFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
  ...
  inline void SetCondition(FilterCondition value) {
    m_conditionHasBeenSet = true;
    m_condition = value;
  }
  inline ServiceFilter& WithCondition(FilterCondition value) {
    SetCondition(value);
    return *this;
  }
  ///@}
