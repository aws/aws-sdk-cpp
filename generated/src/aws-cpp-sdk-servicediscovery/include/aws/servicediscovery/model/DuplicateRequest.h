...
class DuplicateRequest {
 public:
  ...
  template <typename MessageT = Aws::String>
  DuplicateRequest& WithMessage(MessageT&& value) {
  ...
  void SetDuplicateOperationId(DuplicateOperationIdT&& value) {
    m_duplicateOperationIdHasBeenSet = true;
    m_duplicateOperationId = std::forward<DuplicateOperationIdT>(value);
  }
  template <typename DuplicateOperationIdT = Aws::String>
  DuplicateRequest& WithDuplicateOperationId(DuplicateOperationIdT&& value) {
    SetDuplicateOperationId(std::forward<DuplicateOperationIdT>(value));
    return *this;
  }
  ///@}
 private:
