...
namespace Model
{
  ...
  {
  public:
    AWS_SERVICEDISCOVERY_API GetNamespaceRequest() = default;
    ...
    ///@{
    /**
     * <p>The ID or Amazon Resource Name (ARN) of the namespace that you want to get
    ...
    template<typename IdT = Aws::String>
    GetNamespaceRequest& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
  private:
