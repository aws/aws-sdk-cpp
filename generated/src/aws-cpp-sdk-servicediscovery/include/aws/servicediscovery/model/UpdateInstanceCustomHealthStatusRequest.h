...
class UpdateInstanceCustomHealthStatusRequest : public ServiceDiscoveryRequest {
 public:
  ...
  template <typename ServiceIdT = Aws::String>
  UpdateInstanceCustomHealthStatusRequest& WithServiceId(ServiceIdT&& value) {
  ...
  template <typename InstanceIdT = Aws::String>
  UpdateInstanceCustomHealthStatusRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  inline void SetStatus(CustomHealthStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline UpdateInstanceCustomHealthStatusRequest& WithStatus(CustomHealthStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
