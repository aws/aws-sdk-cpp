...
class HealthCheckConfig {
 public:
  ...
  inline void SetType(HealthCheckType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline HealthCheckConfig& WithType(HealthCheckType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline HealthCheckConfig& WithFailureThreshold(int value) {
