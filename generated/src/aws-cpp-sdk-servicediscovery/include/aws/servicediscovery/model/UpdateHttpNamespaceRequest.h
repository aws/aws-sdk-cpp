...
class UpdateHttpNamespaceRequest : public ServiceDiscoveryRequest {
 public:
  ...
  template <typename IdT = Aws::String>
  UpdateHttpNamespaceRequest& WithId(IdT&& value) {
  ...
  void SetUpdaterRequestId(UpdaterRequestIdT&& value) {
    ...
    m_updaterRequestId = std::forward<UpdaterRequestIdT>(value);
  }
  template <typename UpdaterRequestIdT = Aws::String>
  UpdateHttpNamespaceRequest& WithUpdaterRequestId(UpdaterRequestIdT&& value) {
    SetUpdaterRequestId(std::forward<UpdaterRequestIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NamespaceT = HttpNamespaceChange>
  UpdateHttpNamespaceRequest& WithNamespace(NamespaceT&& value) {
