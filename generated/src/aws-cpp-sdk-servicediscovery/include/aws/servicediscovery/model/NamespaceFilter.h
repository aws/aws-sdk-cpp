...
class NamespaceFilter {
 public:
  ...
  inline void SetName(NamespaceFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline NamespaceFilter& WithName(NamespaceFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  NamespaceFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  NamespaceFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
  ...
  inline NamespaceFilter& WithCondition(FilterCondition value) {
    SetCondition(value);
    return *this;
  }
  ///@}
