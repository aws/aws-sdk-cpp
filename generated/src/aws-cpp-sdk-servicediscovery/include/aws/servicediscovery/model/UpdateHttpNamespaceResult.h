...
namespace Model
{
  ...
  {
  public:
    AWS_SERVICEDISCOVERY_API UpdateHttpNamespaceResult() = default;
    ...
    template<typename OperationIdT = Aws::String>
    UpdateHttpNamespaceResult& WithOperationId(OperationIdT&& value) { SetOperationId(std::forward<OperationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateHttpNamespaceResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
