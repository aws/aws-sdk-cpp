...
class DiscoverInstancesRevisionResult {
 public:
  ...
  AWS_SERVICEDISCOVERY_API DiscoverInstancesRevisionResult& operator=(
  ...
  inline void SetInstancesRevision(long long value) {
    m_instancesRevisionHasBeenSet = true;
    m_instancesRevision = value;
  }
  inline DiscoverInstancesRevisionResult& WithInstancesRevision(long long value) {
    SetInstancesRevision(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DiscoverInstancesRevisionResult& WithRequestId(RequestIdT&& value) {
