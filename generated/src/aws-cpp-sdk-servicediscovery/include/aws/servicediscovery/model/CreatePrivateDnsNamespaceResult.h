...
class CreatePrivateDnsNamespaceResult {
 public:
  ...
  AWS_SERVICEDISCOVERY_API CreatePrivateDnsNamespaceResult& operator=(
  ...
  template <typename OperationIdT = Aws::String>
  CreatePrivateDnsNamespaceResult& WithOperationId(OperationIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreatePrivateDnsNamespaceResult& WithRequestId(RequestIdT&& value) {
