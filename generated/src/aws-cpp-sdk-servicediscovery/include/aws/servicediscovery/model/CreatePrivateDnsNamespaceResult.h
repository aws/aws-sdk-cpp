...
namespace Model
{
  ...
  {
  public:
    AWS_SERVICEDISCOVERY_API CreatePrivateDnsNamespaceResult() = default;
    ...
    template<typename OperationIdT = Aws::String>
    CreatePrivateDnsNamespaceResult& WithOperationId(OperationIdT&& value) { SetOperationId(std::forward<OperationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreatePrivateDnsNamespaceResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
