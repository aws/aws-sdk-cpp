...
namespace Model
{
  ...
  {
  public:
    AWS_SERVICEDISCOVERY_API UpdateServiceAttributesResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateServiceAttributesResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
