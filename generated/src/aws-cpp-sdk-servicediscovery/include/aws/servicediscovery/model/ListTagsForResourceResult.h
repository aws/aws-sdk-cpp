...
namespace Model
{
  ...
  {
  public:
    AWS_SERVICEDISCOVERY_API ListTagsForResourceResult() = default;
    AWS_SERVICEDISCOVERY_API ListTagsForResourceResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_SERVICEDISCOVERY_API ListTagsForResourceResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
