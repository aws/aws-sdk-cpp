...
class GetServiceAttributesResult {
 public:
  ...
  void SetServiceAttributes(ServiceAttributesT&& value) {
    ...
    m_serviceAttributes = std::forward<ServiceAttributesT>(value);
  }
  template <typename ServiceAttributesT = ServiceAttributes>
  GetServiceAttributesResult& WithServiceAttributes(ServiceAttributesT&& value) {
    SetServiceAttributes(std::forward<ServiceAttributesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetServiceAttributesResult& WithRequestId(RequestIdT&& value) {
