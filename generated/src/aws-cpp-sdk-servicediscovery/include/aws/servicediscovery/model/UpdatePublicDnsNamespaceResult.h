...
class UpdatePublicDnsNamespaceResult {
 public:
  ...
  AWS_SERVICEDISCOVERY_API UpdatePublicDnsNamespaceResult& operator=(
  ...
  template <typename OperationIdT = Aws::String>
  UpdatePublicDnsNamespaceResult& WithOperationId(OperationIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdatePublicDnsNamespaceResult& WithRequestId(RequestIdT&& value) {
