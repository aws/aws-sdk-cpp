...
namespace Model
{
  ...
  {
  public:
    AWS_SERVICEDISCOVERY_API UpdatePublicDnsNamespaceResult() = default;
    ...
    template<typename OperationIdT = Aws::String>
    UpdatePublicDnsNamespaceResult& WithOperationId(OperationIdT&& value) { SetOperationId(std::forward<OperationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdatePublicDnsNamespaceResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
