...
namespace Model
{
  ...
  {
  public:
    AWS_SERVICEDISCOVERY_API UpdatePrivateDnsNamespaceResult() = default;
    ...
    template<typename OperationIdT = Aws::String>
    UpdatePrivateDnsNamespaceResult& WithOperationId(OperationIdT&& value) { SetOperationId(std::forward<OperationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdatePrivateDnsNamespaceResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
