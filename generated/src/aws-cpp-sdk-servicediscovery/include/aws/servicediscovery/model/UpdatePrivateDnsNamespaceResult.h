...
class UpdatePrivateDnsNamespaceResult {
 public:
  ...
  AWS_SERVICEDISCOVERY_API UpdatePrivateDnsNamespaceResult& operator=(
  ...
  template <typename OperationIdT = Aws::String>
  UpdatePrivateDnsNamespaceResult& WithOperationId(OperationIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdatePrivateDnsNamespaceResult& WithRequestId(RequestIdT&& value) {
