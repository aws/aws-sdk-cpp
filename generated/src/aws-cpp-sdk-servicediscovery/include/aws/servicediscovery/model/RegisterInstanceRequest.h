...
class RegisterInstanceRequest : public ServiceDiscoveryRequest {
 public:
  ...
  ///@{
  /**
   * <p>The ID or Amazon Resource Name (ARN) of the service that you want to use for
   * settings for the instance. For services created in a shared namespace, specify
   * the service ARN. For more information about shared namespaces, see <a
  ...
  template <typename ServiceIdT = Aws::String>
  RegisterInstanceRequest& WithServiceId(ServiceIdT&& value) {
  ...
  template <typename InstanceIdT = Aws::String>
  RegisterInstanceRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename CreatorRequestIdT = Aws::String>
  RegisterInstanceRequest& WithCreatorRequestId(CreatorRequestIdT&& value) {
  ...
  template <typename AttributesT = Aws::Map<Aws::String, Aws::String>>
  RegisterInstanceRequest& WithAttributes(AttributesT&& value) {
