...
namespace Model
{
  ...
  {
  public:
    AWS_SERVICEDISCOVERY_API Tag() = default;
    AWS_SERVICEDISCOVERY_API Tag(Aws::Utils::Json::JsonView jsonValue);
    AWS_SERVICEDISCOVERY_API Tag& operator=(Aws::Utils::Json::JsonView jsonValue);
