...
{
const size_t ServiceDiscoveryEndpointRules::RulesBlobStrLen = 3764;
const size_t ServiceDiscoveryEndpointRules::RulesBlobSize = 3765;
...
't','t','p','s',':','/','/','s','e','r','v','i','c','e','d','i','s','c','o','v','e','r','y','.','{',
