...
namespace Model
{
  ...
  public:
    ...
    template<typename ElasticIpT = Aws::String>
    RegisterElasticIpRequest& WithElasticIp(ElasticIpT&& value) { SetElasticIp(std::forward<ElasticIpT>(value)); return *this;}
    ///@}
    ...
    template<typename StackIdT = Aws::String>
    RegisterElasticIpRequest& WithStackId(StackIdT&& value) { SetStackId(std::forward<StackIdT>(value)); return *this;}
    ///@}
  private:
