...
namespace Model
{
  ...
  public:
    ...
    ///@{
    /**
     * <p>The stack's Amazon Web Services Region, such as <code>ap-south-1</code>. For
     ...
     * Endpoints</a>.</p>  <p>In the CLI, this API maps to the
     * <code>--stack-region</code> parameter. If the <code>--stack-region</code>
     * parameter and the CLI common parameter <code>--region</code> are set to the same
     * value, the stack uses a <i>regional</i> endpoint. If the
     * <code>--stack-region</code> parameter is not set, but the CLI
     ...
     * stacks. The CLI common <code>--region</code> parameter always specifies a
     * regional API endpoint; it cannot be used to specify a classic OpsWorks Stacks
     * region.</p> 
     */
    ...
    template<typename RegionT = Aws::String>
    CreateStackRequest& WithRegion(RegionT&& value) { SetRegion(std::forward<RegionT>(value)); return *this;}
    ///@}
     ...
     * and the corresponding default VPC subnet ID, respectively.</p> <p>If you specify
     * a nondefault VPC ID, note the following:</p> <ul> <li> <p>It must belong to a
     * VPC in your account that is in the specified region.</p> </li> <li> <p>You must
     * specify a value for <code>DefaultSubnetId</code>.</p> </li> </ul> <p>For more
     * information about how to use OpsWorks Stacks with a VPC, see <a
    ...
    template<typename VpcIdT = Aws::String>
    CreateStackRequest& WithVpcId(VpcIdT&& value) { SetVpcId(std::forward<VpcIdT>(value)); return *this;}
    ///@}
    ...
    template<typename AttributesT = Aws::Map<StackAttributesKeys, Aws::String>>
    CreateStackRequest& WithAttributes(AttributesT&& value) { SetAttributes(std::forward<AttributesT>(value)); return *this;}
    inline CreateStackRequest& AddAttributes(StackAttributesKeys key, Aws::String value) {
    ...
    ///@{
    /**
     * <p>The stack's IAM role, which allows OpsWorks Stacks to work with Amazon Web
    ...
    template<typename ServiceRoleArnT = Aws::String>
    CreateStackRequest& WithServiceRoleArn(ServiceRoleArnT&& value) { SetServiceRoleArn(std::forward<ServiceRoleArnT>(value)); return *this;}
    ///@}
    ...
    template<typename DefaultInstanceProfileArnT = Aws::String>
    CreateStackRequest& WithDefaultInstanceProfileArn(DefaultInstanceProfileArnT&& value) { SetDefaultInstanceProfileArn(std::forward<DefaultInstanceProfileArnT>(value)); return *this;}
    ///@}
     ...
     * operating system: An Amazon Linux version, such as <code>Amazon Linux 2</code>,
     ...
     * operating system, such as <code>Ubuntu 18.04 LTS</code>, <code>Ubuntu 16.04
     ...
     * Amazon Linux version. Not all operating systems are supported with all versions
    ...
    template<typename DefaultOsT = Aws::String>
    CreateStackRequest& WithDefaultOs(DefaultOsT&& value) { SetDefaultOs(std::forward<DefaultOsT>(value)); return *this;}
    ///@}
    ...
    template<typename HostnameThemeT = Aws::String>
    CreateStackRequest& WithHostnameTheme(HostnameThemeT&& value) { SetHostnameTheme(std::forward<HostnameThemeT>(value)); return *this;}
    ///@}
    ...
    template<typename DefaultAvailabilityZoneT = Aws::String>
    CreateStackRequest& WithDefaultAvailabilityZone(DefaultAvailabilityZoneT&& value) { SetDefaultAvailabilityZone(std::forward<DefaultAvailabilityZoneT>(value)); return *this;}
    ///@}
    ...
    template<typename DefaultSubnetIdT = Aws::String>
    CreateStackRequest& WithDefaultSubnetId(DefaultSubnetIdT&& value) { SetDefaultSubnetId(std::forward<DefaultSubnetIdT>(value)); return *this;}
    ///@}
    ...
    template<typename CustomJsonT = Aws::String>
    CreateStackRequest& WithCustomJson(CustomJsonT&& value) { SetCustomJson(std::forward<CustomJsonT>(value)); return *this;}
    ///@}
    ...
    template<typename ConfigurationManagerT = StackConfigurationManager>
    CreateStackRequest& WithConfigurationManager(ConfigurationManagerT&& value) { SetConfigurationManager(std::forward<ConfigurationManagerT>(value)); return *this;}
    ///@}
    ...
    template<typename ChefConfigurationT = ChefConfiguration>
    CreateStackRequest& WithChefConfiguration(ChefConfigurationT&& value) { SetChefConfiguration(std::forward<ChefConfigurationT>(value)); return *this;}
    ///@}
     ...
     * default. With <code>UseOpsworksSecurityGroups</code> you can instead provide
     * your own custom security groups. <code>UseOpsworksSecurityGroups</code> has the
     * following settings: </p> <ul> <li> <p>True - OpsWorks Stacks automatically
     ...
     * <p>False - OpsWorks Stacks does not associate built-in security groups with
    ...
    template<typename CustomCookbooksSourceT = Source>
    CreateStackRequest& WithCustomCookbooksSource(CustomCookbooksSourceT&& value) { SetCustomCookbooksSource(std::forward<CustomCookbooksSourceT>(value)); return *this;}
    ///@}
    ...
    template<typename DefaultSshKeyNameT = Aws::String>
    CreateStackRequest& WithDefaultSshKeyName(DefaultSshKeyNameT&& value) { SetDefaultSshKeyName(std::forward<DefaultSshKeyNameT>(value)); return *this;}
    ///@}
     ...
     * <p>The default setting is the most recent release of the agent. To specify an
    ...
    template<typename AgentVersionT = Aws::String>
    CreateStackRequest& WithAgentVersion(AgentVersionT&& value) { SetAgentVersion(std::forward<AgentVersionT>(value)); return *this;}
    ///@}
  private:
