...
namespace Model
{
  ...
  {
  public:
    AWS_OPSWORKS_API RegisterInstanceResult() = default;
    ...
    template<typename InstanceIdT = Aws::String>
    RegisterInstanceResult& WithInstanceId(InstanceIdT&& value) { SetInstanceId(std::forward<InstanceIdT>(value)); return *this;}
    ///@}
