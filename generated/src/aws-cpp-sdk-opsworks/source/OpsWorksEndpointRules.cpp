...
namespace OpsWorks
{
const size_t OpsWorksEndpointRules::RulesBlobStrLen = 3480;
const size_t OpsWorksEndpointRules::RulesBlobSize = 3481;

using RulesBlobT = Aws::Array<const char, OpsWorksEndpointRules::RulesBlobSize>;
...
'o','r','k','s','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i',
...
'u','r','l','"',':','"','h','t','t','p','s',':','/','/','o','p','s','w','o','r','k','s','-','f','i',
...
':','"','h','t','t','p','s',':','/','/','o','p','s','w','o','r','k','s','.','{','R','e','g','i','o',
...
'p','o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','o','p',
's','w','o','r','k','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o',
...
const char* OpsWorksEndpointRules::GetRulesBlob()
{
