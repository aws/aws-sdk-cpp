...
namespace inspectorscan
{
   ...
   */
  class AWS_INSPECTORSCAN_API InspectorscanClient : Aws::Client::ClientWithAsyncTemplateMethods<InspectorscanClient>,
    smithy::client::AwsSmithyClientT<Aws::inspectorscan::SERVICE_NAME,
