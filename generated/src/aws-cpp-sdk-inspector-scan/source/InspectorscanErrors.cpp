...
template <>
AWS_INSPECTORSCAN_API ThrottlingException InspectorscanError::GetModeledError() {
  assert(this->GetErrorType() == InspectorscanErrors::THROTTLING);
  return ThrottlingException(this->GetJsonPayload().View());
}

template <>
AWS_INSPECTORSCAN_API InternalServerException InspectorscanError::GetModeledError() {
  assert(this->GetErrorType() == InspectorscanErrors::INTERNAL_SERVER);
  return InternalServerException(this->GetJsonPayload().View());
}

template <>
AWS_INSPECTORSCAN_API ValidationException InspectorscanError::GetModeledError() {
