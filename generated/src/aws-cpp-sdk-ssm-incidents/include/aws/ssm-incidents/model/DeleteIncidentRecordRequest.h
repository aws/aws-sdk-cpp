...
namespace Model
{
  ...
  /**
   */
  class DeleteIncidentRecordRequest : public SSMIncidentsRequest
  {
  public:
    AWS_SSMINCIDENTS_API DeleteIncidentRecordRequest() = default;
    ...
    template<typename ArnT = Aws::String>
    DeleteIncidentRecordRequest& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
  private:
