...
namespace Model
{
  ...
  {
  public:
    AWS_SSMINCIDENTS_API UpdateTimelineEventResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateTimelineEventResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
