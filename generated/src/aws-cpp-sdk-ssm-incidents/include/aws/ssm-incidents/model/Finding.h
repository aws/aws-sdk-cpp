...
class Finding {
 public:
  AWS_SSMINCIDENTS_API Finding() = default;
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  Finding& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename DetailsT = FindingDetails>
  void SetDetails(DetailsT&& value) {
    m_detailsHasBeenSet = true;
    m_details = std::forward<DetailsT>(value);
  }
  template <typename DetailsT = FindingDetails>
  Finding& WithDetails(DetailsT&& value) {
  ...
  template <typename LastModifiedTimeT = Aws::Utils::DateTime>
  Finding& WithLastModifiedTime(LastModifiedTimeT&& value) {
