...
class ListReplicationSetsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListReplicationSetsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetReplicationSetArns(ReplicationSetArnsT&& value) {
    m_replicationSetArnsHasBeenSet = true;
    m_replicationSetArns = std::forward<ReplicationSetArnsT>(value);
  }
  template <typename ReplicationSetArnsT = Aws::Vector<Aws::String>>
  ListReplicationSetsResult& WithReplicationSetArns(ReplicationSetArnsT&& value) {
    SetReplicationSetArns(std::forward<ReplicationSetArnsT>(value));
    return *this;
  }
  template <typename ReplicationSetArnsT = Aws::String>
  ListReplicationSetsResult& AddReplicationSetArns(ReplicationSetArnsT&& value) {
    m_replicationSetArnsHasBeenSet = true;
    m_replicationSetArns.emplace_back(std::forward<ReplicationSetArnsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListReplicationSetsResult& WithRequestId(RequestIdT&& value) {
