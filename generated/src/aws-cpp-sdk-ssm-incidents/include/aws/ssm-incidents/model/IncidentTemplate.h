...
class IncidentTemplate {
 public:
  ...
  void SetDedupeString(DedupeStringT&& value) {
    ...
    m_dedupeString = std::forward<DedupeStringT>(value);
  }
  template <typename DedupeStringT = Aws::String>
  IncidentTemplate& WithDedupeString(DedupeStringT&& value) {
    SetDedupeString(std::forward<DedupeStringT>(value));
    return *this;
  }
  ///@}
  ...
  inline IncidentTemplate& WithImpact(int value) {
    SetImpact(value);
    return *this;
  }
  ///@}
  ...
  void SetIncidentTags(IncidentTagsT&& value) {
    ...
    m_incidentTags = std::forward<IncidentTagsT>(value);
  }
  template <typename IncidentTagsT = Aws::Map<Aws::String, Aws::String>>
  IncidentTemplate& WithIncidentTags(IncidentTagsT&& value) {
    SetIncidentTags(std::forward<IncidentTagsT>(value));
    return *this;
  }
  ...
  IncidentTemplate& AddIncidentTags(IncidentTagsKeyT&& key, IncidentTagsValueT&& value) {
    m_incidentTagsHasBeenSet = true;
    m_incidentTags.emplace(std::forward<IncidentTagsKeyT>(key), std::forward<IncidentTagsValueT>(value));
    return *this;
  }
  ///@}
