...
class Integration {
 public:
  ...
  void SetPagerDutyConfiguration(PagerDutyConfigurationT&& value) {
    m_pagerDutyConfigurationHasBeenSet = true;
    m_pagerDutyConfiguration = std::forward<PagerDutyConfigurationT>(value);
  }
  template <typename PagerDutyConfigurationT = PagerDutyConfiguration>
  Integration& WithPagerDutyConfiguration(PagerDutyConfigurationT&& value) {
    SetPagerDutyConfiguration(std::forward<PagerDutyConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
