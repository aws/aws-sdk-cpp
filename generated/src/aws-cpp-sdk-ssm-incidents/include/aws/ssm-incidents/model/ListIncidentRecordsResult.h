...
class ListIncidentRecordsResult {
 public:
  ...
  void SetIncidentRecordSummaries(IncidentRecordSummariesT&& value) {
    m_incidentRecordSummariesHasBeenSet = true;
    m_incidentRecordSummaries = std::forward<IncidentRecordSummariesT>(value);
  }
  template <typename IncidentRecordSummariesT = Aws::Vector<IncidentRecordSummary>>
  ListIncidentRecordsResult& WithIncidentRecordSummaries(IncidentRecordSummariesT&& value) {
    SetIncidentRecordSummaries(std::forward<IncidentRecordSummariesT>(value));
    return *this;
  }
  template <typename IncidentRecordSummariesT = IncidentRecordSummary>
  ListIncidentRecordsResult& AddIncidentRecordSummaries(IncidentRecordSummariesT&& value) {
    m_incidentRecordSummariesHasBeenSet = true;
    m_incidentRecordSummaries.emplace_back(std::forward<IncidentRecordSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListIncidentRecordsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListIncidentRecordsResult& WithRequestId(RequestIdT&& value) {
