...
namespace Model
{
  ...
  {
  public:
    AWS_SSMINCIDENTS_API UpdateReplicationSetResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateReplicationSetResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
