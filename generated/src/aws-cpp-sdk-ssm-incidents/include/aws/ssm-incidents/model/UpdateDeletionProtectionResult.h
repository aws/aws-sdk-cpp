...
namespace Model
{
  ...
  {
  public:
    AWS_SSMINCIDENTS_API UpdateDeletionProtectionResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateDeletionProtectionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
