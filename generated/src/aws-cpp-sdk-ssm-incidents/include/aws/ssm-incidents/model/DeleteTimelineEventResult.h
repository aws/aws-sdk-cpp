...
namespace Model
{
  ...
  {
  public:
    AWS_SSMINCIDENTS_API DeleteTimelineEventResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteTimelineEventResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
