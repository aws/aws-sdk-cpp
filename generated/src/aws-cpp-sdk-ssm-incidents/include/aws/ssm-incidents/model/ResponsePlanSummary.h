...
class ResponsePlanSummary {
 public:
  AWS_SSMINCIDENTS_API ResponsePlanSummary() = default;
  ...
  template <typename ArnT = Aws::String>
  ResponsePlanSummary& WithArn(ArnT&& value) {
  ...
  template <typename DisplayNameT = Aws::String>
  ResponsePlanSummary& WithDisplayName(DisplayNameT&& value) {
  ...
  template <typename NameT = Aws::String>
  ResponsePlanSummary& WithName(NameT&& value) {
