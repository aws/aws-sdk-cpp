...
class UpdateIncidentRecordRequest : public SSMIncidentsRequest {
 public:
  ...
  template <typename ArnT = Aws::String>
  UpdateIncidentRecordRequest& WithArn(ArnT&& value) {
  ...
  void SetChatChannel(ChatChannelT&& value) {
    ...
    m_chatChannel = std::forward<ChatChannelT>(value);
  }
  template <typename ChatChannelT = ChatChannel>
  UpdateIncidentRecordRequest& WithChatChannel(ChatChannelT&& value) {
    SetChatChannel(std::forward<ChatChannelT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ClientTokenT = Aws::String>
  UpdateIncidentRecordRequest& WithClientToken(ClientTokenT&& value) {
  ...
  inline void SetImpact(int value) {
    m_impactHasBeenSet = true;
    m_impact = value;
  }
  inline UpdateIncidentRecordRequest& WithImpact(int value) {
    SetImpact(value);
    return *this;
  }
  ///@}
  ...
  void SetNotificationTargets(NotificationTargetsT&& value) {
    ...
    m_notificationTargets = std::forward<NotificationTargetsT>(value);
  }
  template <typename NotificationTargetsT = Aws::Vector<NotificationTargetItem>>
  UpdateIncidentRecordRequest& WithNotificationTargets(NotificationTargetsT&& value) {
    SetNotificationTargets(std::forward<NotificationTargetsT>(value));
    return *this;
  }
  template <typename NotificationTargetsT = NotificationTargetItem>
  UpdateIncidentRecordRequest& AddNotificationTargets(NotificationTargetsT&& value) {
    m_notificationTargetsHasBeenSet = true;
    m_notificationTargets.emplace_back(std::forward<NotificationTargetsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(IncidentRecordStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline UpdateIncidentRecordRequest& WithStatus(IncidentRecordStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename SummaryT = Aws::String>
  UpdateIncidentRecordRequest& WithSummary(SummaryT&& value) {
  ...
  template <typename TitleT = Aws::String>
  UpdateIncidentRecordRequest& WithTitle(TitleT&& value) {
