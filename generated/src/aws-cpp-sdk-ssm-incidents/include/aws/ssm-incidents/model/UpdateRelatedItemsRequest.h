...
class UpdateRelatedItemsRequest : public SSMIncidentsRequest {
 public:
  ...
  template <typename ClientTokenT = Aws::String>
  UpdateRelatedItemsRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename IncidentRecordArnT = Aws::String>
  UpdateRelatedItemsRequest& WithIncidentRecordArn(IncidentRecordArnT&& value) {
  ...
  void SetRelatedItemsUpdate(RelatedItemsUpdateT&& value) {
    m_relatedItemsUpdateHasBeenSet = true;
    m_relatedItemsUpdate = std::forward<RelatedItemsUpdateT>(value);
  }
  template <typename RelatedItemsUpdateT = RelatedItemsUpdate>
  UpdateRelatedItemsRequest& WithRelatedItemsUpdate(RelatedItemsUpdateT&& value) {
    SetRelatedItemsUpdate(std::forward<RelatedItemsUpdateT>(value));
    return *this;
  }
  ///@}
 private:
