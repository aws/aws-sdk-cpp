...
namespace Model
{
  ...
  /**
   */
  class TagResourceRequest : public SSMIncidentsRequest
  {
  public:
    AWS_SSMINCIDENTS_API TagResourceRequest() = default;
    ...
    ///@{
    /**
     * <p>The Amazon Resource Name (ARN) of the response plan you're adding the tags
     * to.</p>
     */
