...
namespace Model
{
  ...
  {
  public:
    AWS_SSMINCIDENTS_API CreateResponsePlanResult() = default;
    ...
    template<typename ArnT = Aws::String>
    CreateResponsePlanResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateResponsePlanResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
