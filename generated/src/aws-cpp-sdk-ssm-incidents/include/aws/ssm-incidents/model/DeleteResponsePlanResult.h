...
namespace Model
{
  ...
  {
  public:
    AWS_SSMINCIDENTS_API DeleteResponsePlanResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteResponsePlanResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
