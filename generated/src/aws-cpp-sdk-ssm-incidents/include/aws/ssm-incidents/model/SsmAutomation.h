...
class SsmAutomation {
 public:
  ...
  void SetDynamicParameters(DynamicParametersT&& value) {
    ...
    m_dynamicParameters = std::forward<DynamicParametersT>(value);
  }
  template <typename DynamicParametersT = Aws::Map<Aws::String, DynamicSsmParameterValue>>
  SsmAutomation& WithDynamicParameters(DynamicParametersT&& value) {
    SetDynamicParameters(std::forward<DynamicParametersT>(value));
    return *this;
  }
  ...
  SsmAutomation& AddDynamicParameters(DynamicParametersKeyT&& key, DynamicParametersValueT&& value) {
    m_dynamicParametersHasBeenSet = true;
    m_dynamicParameters.emplace(std::forward<DynamicParametersKeyT>(key), std::forward<DynamicParametersValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTargetAccount(SsmTargetAccount value) {
    m_targetAccountHasBeenSet = true;
    m_targetAccount = value;
  }
  inline SsmAutomation& WithTargetAccount(SsmTargetAccount value) {
