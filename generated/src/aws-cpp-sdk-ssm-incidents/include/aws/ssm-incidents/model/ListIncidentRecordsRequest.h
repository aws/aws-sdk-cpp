...
class ListIncidentRecordsRequest : public SSMIncidentsRequest {
 public:
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  ListIncidentRecordsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  ListIncidentRecordsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline ListIncidentRecordsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListIncidentRecordsRequest& WithNextToken(NextTokenT&& value) {
