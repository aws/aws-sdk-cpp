...
class RelatedItem {
 public:
  ...
  void SetGeneratedId(GeneratedIdT&& value) {
    m_generatedIdHasBeenSet = true;
    m_generatedId = std::forward<GeneratedIdT>(value);
  }
  template <typename GeneratedIdT = Aws::String>
  RelatedItem& WithGeneratedId(GeneratedIdT&& value) {
    SetGeneratedId(std::forward<GeneratedIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename IdentifierT = ItemIdentifier>
  RelatedItem& WithIdentifier(IdentifierT&& value) {
  ...
  template <typename TitleT = Aws::String>
  RelatedItem& WithTitle(TitleT&& value) {
