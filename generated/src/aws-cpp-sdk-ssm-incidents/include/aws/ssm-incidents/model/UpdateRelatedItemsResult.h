...
namespace Model
{
  ...
  {
  public:
    AWS_SSMINCIDENTS_API UpdateRelatedItemsResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateRelatedItemsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
