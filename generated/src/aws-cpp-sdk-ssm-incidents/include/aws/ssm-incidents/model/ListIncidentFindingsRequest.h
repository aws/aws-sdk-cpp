...
class ListIncidentFindingsRequest : public SSMIncidentsRequest {
 public:
  ...
  template <typename IncidentRecordArnT = Aws::String>
  ListIncidentFindingsRequest& WithIncidentRecordArn(IncidentRecordArnT&& value) {
  ...
  inline ListIncidentFindingsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListIncidentFindingsRequest& WithNextToken(NextTokenT&& value) {
