...
namespace Model
{
  ...
  {
  public:
    AWS_SSMINCIDENTS_API ListIncidentFindingsRequest() = default;
    ...
    template<typename IncidentRecordArnT = Aws::String>
    ListIncidentFindingsRequest& WithIncidentRecordArn(IncidentRecordArnT&& value) { SetIncidentRecordArn(std::forward<IncidentRecordArnT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListIncidentFindingsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
