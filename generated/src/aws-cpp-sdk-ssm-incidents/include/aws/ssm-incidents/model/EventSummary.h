...
class EventSummary {
 public:
  ...
  void SetEventReferences(EventReferencesT&& value) {
    ...
    m_eventReferences = std::forward<EventReferencesT>(value);
  }
  template <typename EventReferencesT = Aws::Vector<EventReference>>
  EventSummary& WithEventReferences(EventReferencesT&& value) {
    SetEventReferences(std::forward<EventReferencesT>(value));
    return *this;
  }
  template <typename EventReferencesT = EventReference>
  EventSummary& AddEventReferences(EventReferencesT&& value) {
    m_eventReferencesHasBeenSet = true;
    m_eventReferences.emplace_back(std::forward<EventReferencesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEventUpdatedTime(EventUpdatedTimeT&& value) {
    ...
    m_eventUpdatedTime = std::forward<EventUpdatedTimeT>(value);
  }
  template <typename EventUpdatedTimeT = Aws::Utils::DateTime>
  EventSummary& WithEventUpdatedTime(EventUpdatedTimeT&& value) {
    SetEventUpdatedTime(std::forward<EventUpdatedTimeT>(value));
    return *this;
  }
  ///@}
