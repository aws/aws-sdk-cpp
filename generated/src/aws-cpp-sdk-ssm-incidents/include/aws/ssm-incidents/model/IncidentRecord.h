...
class IncidentRecord {
 public:
  ...
  void SetAutomationExecutions(AutomationExecutionsT&& value) {
    ...
    m_automationExecutions = std::forward<AutomationExecutionsT>(value);
  }
  template <typename AutomationExecutionsT = Aws::Vector<AutomationExecution>>
  IncidentRecord& WithAutomationExecutions(AutomationExecutionsT&& value) {
    SetAutomationExecutions(std::forward<AutomationExecutionsT>(value));
    return *this;
  }
  ...
  IncidentRecord& AddAutomationExecutions(AutomationExecutionsT&& value) {
    m_automationExecutionsHasBeenSet = true;
    m_automationExecutions.emplace_back(std::forward<AutomationExecutionsT>(value));
    return *this;
  }
  ///@}
  ...
  inline IncidentRecord& WithImpact(int value) {
    SetImpact(value);
    return *this;
  }
  ///@}
  ...
  inline IncidentRecord& WithStatus(IncidentRecordStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
