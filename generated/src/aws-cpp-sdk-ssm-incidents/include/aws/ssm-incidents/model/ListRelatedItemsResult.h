...
class ListRelatedItemsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListRelatedItemsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RelatedItemsT = Aws::Vector<RelatedItem>>
  ListRelatedItemsResult& WithRelatedItems(RelatedItemsT&& value) {
    SetRelatedItems(std::forward<RelatedItemsT>(value));
    return *this;
  }
  template <typename RelatedItemsT = RelatedItem>
  ListRelatedItemsResult& AddRelatedItems(RelatedItemsT&& value) {
    m_relatedItemsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListRelatedItemsResult& WithRequestId(RequestIdT&& value) {
