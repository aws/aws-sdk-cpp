...
namespace Model
{
  ...
  {
  public:
    AWS_SSMINCIDENTS_API UpdateResponsePlanResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateResponsePlanResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
