...
class RegionInfo {
 public:
  ...
  template <typename SseKmsKeyIdT = Aws::String>
  RegionInfo& WithSseKmsKeyId(SseKmsKeyIdT&& value) {
  ...
  inline RegionInfo& WithStatus(RegionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusMessageT = Aws::String>
  RegionInfo& WithStatusMessage(StatusMessageT&& value) {
  ...
  void SetStatusUpdateDateTime(StatusUpdateDateTimeT&& value) {
    m_statusUpdateDateTimeHasBeenSet = true;
    m_statusUpdateDateTime = std::forward<StatusUpdateDateTimeT>(value);
  }
  template <typename StatusUpdateDateTimeT = Aws::Utils::DateTime>
  RegionInfo& WithStatusUpdateDateTime(StatusUpdateDateTimeT&& value) {
    SetStatusUpdateDateTime(std::forward<StatusUpdateDateTimeT>(value));
    return *this;
  }
  ///@}
 private:
