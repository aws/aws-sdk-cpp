...
class FindingDetails {
 public:
  ...
  void SetCloudFormationStackUpdate(CloudFormationStackUpdateT&& value) {
    m_cloudFormationStackUpdateHasBeenSet = true;
    m_cloudFormationStackUpdate = std::forward<CloudFormationStackUpdateT>(value);
  }
  template <typename CloudFormationStackUpdateT = CloudFormationStackUpdate>
  FindingDetails& WithCloudFormationStackUpdate(CloudFormationStackUpdateT&& value) {
    SetCloudFormationStackUpdate(std::forward<CloudFormationStackUpdateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCodeDeployDeployment(CodeDeployDeploymentT&& value) {
    m_codeDeployDeploymentHasBeenSet = true;
    m_codeDeployDeployment = std::forward<CodeDeployDeploymentT>(value);
  }
  template <typename CodeDeployDeploymentT = CodeDeployDeployment>
  FindingDetails& WithCodeDeployDeployment(CodeDeployDeploymentT&& value) {
    SetCodeDeployDeployment(std::forward<CodeDeployDeploymentT>(value));
    return *this;
  }
  ///@}
 private:
