...
class UpdateReplicationSetAction {
 public:
  ...
  void SetAddRegionAction(AddRegionActionT&& value) {
    ...
    m_addRegionAction = std::forward<AddRegionActionT>(value);
  }
  template <typename AddRegionActionT = AddRegionAction>
  UpdateReplicationSetAction& WithAddRegionAction(AddRegionActionT&& value) {
    SetAddRegionAction(std::forward<AddRegionActionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDeleteRegionAction(DeleteRegionActionT&& value) {
    ...
    m_deleteRegionAction = std::forward<DeleteRegionActionT>(value);
  }
  template <typename DeleteRegionActionT = DeleteRegionAction>
  UpdateReplicationSetAction& WithDeleteRegionAction(DeleteRegionActionT&& value) {
    SetDeleteRegionAction(std::forward<DeleteRegionActionT>(value));
    return *this;
  }
  ///@}
 private:
