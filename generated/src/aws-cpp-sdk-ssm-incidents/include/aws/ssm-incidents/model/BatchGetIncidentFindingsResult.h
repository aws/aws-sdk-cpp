...
class BatchGetIncidentFindingsResult {
 public:
  ...
  template <typename ErrorsT = Aws::Vector<BatchGetIncidentFindingsError>>
  BatchGetIncidentFindingsResult& WithErrors(ErrorsT&& value) {
    SetErrors(std::forward<ErrorsT>(value));
    return *this;
  }
  template <typename ErrorsT = BatchGetIncidentFindingsError>
  BatchGetIncidentFindingsResult& AddErrors(ErrorsT&& value) {
    m_errorsHasBeenSet = true;
  ...
  template <typename FindingsT = Aws::Vector<Finding>>
  BatchGetIncidentFindingsResult& WithFindings(FindingsT&& value) {
    SetFindings(std::forward<FindingsT>(value));
    return *this;
  }
  template <typename FindingsT = Finding>
  BatchGetIncidentFindingsResult& AddFindings(FindingsT&& value) {
    m_findingsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  BatchGetIncidentFindingsResult& WithRequestId(RequestIdT&& value) {
