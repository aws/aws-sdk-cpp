...
class ListTimelineEventsResult {
 public:
  ...
  void SetEventSummaries(EventSummariesT&& value) {
    m_eventSummariesHasBeenSet = true;
    m_eventSummaries = std::forward<EventSummariesT>(value);
  }
  template <typename EventSummariesT = Aws::Vector<EventSummary>>
  ListTimelineEventsResult& WithEventSummaries(EventSummariesT&& value) {
    SetEventSummaries(std::forward<EventSummariesT>(value));
    return *this;
  }
  template <typename EventSummariesT = EventSummary>
  ListTimelineEventsResult& AddEventSummaries(EventSummariesT&& value) {
    m_eventSummariesHasBeenSet = true;
    m_eventSummaries.emplace_back(std::forward<EventSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTimelineEventsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListTimelineEventsResult& WithRequestId(RequestIdT&& value) {
