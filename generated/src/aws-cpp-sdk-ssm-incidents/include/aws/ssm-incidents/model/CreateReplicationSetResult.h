...
namespace Model
{
  ...
  {
  public:
    AWS_SSMINCIDENTS_API CreateReplicationSetResult() = default;
    ...
    template<typename ArnT = Aws::String>
    CreateReplicationSetResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateReplicationSetResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
