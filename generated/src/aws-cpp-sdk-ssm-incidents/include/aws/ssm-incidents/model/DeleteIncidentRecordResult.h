...
namespace Model
{
  ...
  public:
    ...
    inline DeleteIncidentRecordResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeleteIncidentRecordResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeleteIncidentRecordResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
