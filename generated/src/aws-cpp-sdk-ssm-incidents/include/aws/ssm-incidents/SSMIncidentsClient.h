...
namespace SSMIncidents
{
   ...
   */
  class AWS_SSMINCIDENTS_API SSMIncidentsClient : Aws::Client::ClientWithAsyncTemplateMethods<SSMIncidentsClient>,
    smithy::client::AwsSmithyClientT<Aws::SSMIncidents::SERVICE_NAME,
