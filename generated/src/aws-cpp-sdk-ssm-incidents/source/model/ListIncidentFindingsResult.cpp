...
ListIncidentFindingsResult::ListIncidentFindingsResult()
{
}

ListIncidentFindingsResult::ListIncidentFindingsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListIncidentFindingsResult& ListIncidentFindingsResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
