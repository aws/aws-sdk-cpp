...
IncidentRecord::IncidentRecord(JsonView jsonValue) { *this = jsonValue; }
...
IncidentRecord& IncidentRecord::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("automationExecutions")) {
    ...
    for (unsigned automationExecutionsIndex = 0; automationExecutionsIndex < automationExecutionsJsonList.GetLength();
         ++automationExecutionsIndex) {
  ...
  if (jsonValue.ValueExists("notificationTargets")) {
    ...
    for (unsigned notificationTargetsIndex = 0; notificationTargetsIndex < notificationTargetsJsonList.GetLength();
         ++notificationTargetsIndex) {
