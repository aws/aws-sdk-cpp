...
ListReplicationSetsResult::ListReplicationSetsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListReplicationSetsResult& ListReplicationSetsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("replicationSetArns")) {
    ...
    for (unsigned replicationSetArnsIndex = 0; replicationSetArnsIndex < replicationSetArnsJsonList.GetLength();
         ++replicationSetArnsIndex) {
