...
ListResponsePlansResult::ListResponsePlansResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListResponsePlansResult& ListResponsePlansResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("responsePlanSummaries")) {
    ...
    for (unsigned responsePlanSummariesIndex = 0; responsePlanSummariesIndex < responsePlanSummariesJsonList.GetLength();
         ++responsePlanSummariesIndex) {
