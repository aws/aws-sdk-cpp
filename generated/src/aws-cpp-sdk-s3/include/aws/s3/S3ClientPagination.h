...
using ListObjectAnnotationsPaginator = Aws::Utils::Pagination::Paginator<S3Client, Model::ListObjectAnnotationsRequest,
                                                                         Pagination::ListObjectAnnotationsPaginationTraits<S3Client>>;
