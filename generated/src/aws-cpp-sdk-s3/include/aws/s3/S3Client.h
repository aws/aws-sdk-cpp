...
/**
 *  <p>For information about using the Amazon S3 API—including
 * authentication, signing requests, code examples, and error handling—see the <a
 * href="https://docs.aws.amazon.com/AmazonS3/latest/developerguide/Welcome.html">Amazon
 * S3 Developer Guide</a>.</p>  <p>Welcome to the <i>Amazon S3 API
 * Reference</i>. This guide explains the Amazon Simple Storage Service (Amazon S3)
 * application programming interface (API).</p> <p>Welcome to the <i>Amazon S3 API
 * Reference</i>. This guide explains the Amazon Simple Storage Service (Amazon S3)
 * application programming interface (API).</p> <p>You can use any toolkit that
 * supports HTTP to use the REST API. You can even use a browser to fetch objects,
 * as long as they are anonymously readable.</p> <p>The REST API uses the standard
 * HTTP headers and status codes, so that standard browsers and toolkits work as
 * expected. In some areas, we have added functionality to HTTP (for example, we
 * added headers to support access control). In these cases, we have done our best
 * to add the new functionality in a way that matched the style of standard HTTP
 * usage.</p> <p>The current version of the Amazon S3 API is
 * <code>2006-03-01</code>.</p> <p>Amazon S3 supports the REST API.</p>
 * <p>Support for SOAP over HTTP is deprecated, but it is still available over
 * HTTPS. However, new Amazon S3 features will not be supported for SOAP. We
 * recommend that you use either this REST API or the Amazon Web Services SDKs.</p>
 *
 */
class AWS_S3_API S3Client : public Aws::Client::AWSXMLClient,
 ...
 public:
   ...
   */
  S3Client(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<S3EndpointProviderBase> endpointProvider = nullptr,
   ...
   */
  S3Client(
      const Aws::Client::ClientConfiguration& clientConfiguration, Aws::Client::AWSAuthV4Signer::PayloadSigningPolicy signPayloads,
   ...
   */
  S3Client(
      const Aws::Auth::AWSCredentials& credentials, const Aws::Client::ClientConfiguration& clientConfiguration,
  ...
  /**
   * A Callable wrapper for AbortMultipartUpload that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AbortMultipartUpload that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AbortMultipartUploadRequestT = Model::AbortMultipartUploadRequest>
  void AbortMultipartUploadAsync(const AbortMultipartUploadRequestT& request, const AbortMultipartUploadResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for CompleteMultipartUpload that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CompleteMultipartUpload that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CompleteMultipartUploadRequestT = Model::CompleteMultipartUploadRequest>
  void CompleteMultipartUploadAsync(const CompleteMultipartUploadRequestT& request,
  ...
  /**
   * An Async wrapper for CopyObject that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  virtual void CopyObjectAsync(const Model::CopyObjectRequest& request, const CopyObjectResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const;
  ...
  /**
   * An Async wrapper for CreateBucket that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateBucketRequestT = Model::CreateBucketRequest>
  void CreateBucketAsync(const CreateBucketRequestT& request, const CreateBucketResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&S3Client::CreateBucket, request, handler, context);
  }

  /**
   * <p>Creates an S3 Metadata V2 metadata configuration for a general purpose
   * bucket. For more information, see <a
   * href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/metadata-tables-overview.html">Accelerating
   * data discovery with S3 Metadata</a> in the <i>Amazon S3 User Guide</i>.</p> <dl>
   * <dt>Permissions</dt> <dd> <p>To use this operation, you must have the following
   ...
   * Guide</i>.</p> <p>If you want to encrypt your metadata tables with server-side
   * encryption with Key Management Service (KMS) keys (SSE-KMS), you need additional
   * permissions in your KMS key policy. For more information, see <a
   * href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/metadata-tables-permissions.html">
   * Setting up permissions for configuring metadata tables</a> in the <i>Amazon S3
   * User Guide</i>.</p> <p>If you also want to integrate your table bucket with
   * Amazon Web Services analytics services so that you can query your metadata
   * table, you need additional permissions. For more information, see <a
   ...
   * the <i>Amazon S3 User Guide</i>.</p> <p>To query your metadata tables, you need
   * additional permissions. For more information, see <a
   * href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/metadata-tables-bucket-query-permissions.html">
   * Permissions for querying metadata tables</a> in the <i>Amazon S3 User
   * Guide</i>.</p> <ul> <li> <p>
   * <code>s3:CreateBucketMetadataTableConfiguration</code> </p>  <p>The IAM
   * policy action name is the same for the V1 and V2 API operations.</p>
   * </li> <li> <p> <code>s3tables:CreateTableBucket</code> </p> </li> <li> <p>
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateBucketMetadataConfigurationOutcome CreateBucketMetadataConfiguration(
      const Model::CreateBucketMetadataConfigurationRequest& request) const;

  /**
   * A Callable wrapper for CreateBucketMetadataConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename CreateBucketMetadataConfigurationRequestT = Model::CreateBucketMetadataConfigurationRequest>
  Model::CreateBucketMetadataConfigurationOutcomeCallable CreateBucketMetadataConfigurationCallable(
      const CreateBucketMetadataConfigurationRequestT& request) const {
    return SubmitCallable(&S3Client::CreateBucketMetadataConfiguration, request);
  }

  /**
   * An Async wrapper for CreateBucketMetadataConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateBucketMetadataConfigurationRequestT = Model::CreateBucketMetadataConfigurationRequest>
  void CreateBucketMetadataConfigurationAsync(const CreateBucketMetadataConfigurationRequestT& request,
                                              const CreateBucketMetadataConfigurationResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&S3Client::CreateBucketMetadataConfiguration, request, handler, context);
  }

  /**
   *  <p> We recommend that you create your S3 Metadata configurations by
   * using the V2 <a
   ...
   * <code>CreateBucketMetadataTableConfiguration</code> API operation. </p> <p>If
   ...
   * table.</p>  <p>Creates a V1 S3 Metadata configuration for a general
   * purpose bucket. For more information, see <a
   * href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/metadata-tables-overview.html">Accelerating
   * data discovery with S3 Metadata</a> in the <i>Amazon S3 User Guide</i>.</p> <dl>
   * <dt>Permissions</dt> <dd> <p>To use this operation, you must have the following
   * permissions. For more information, see <a
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateBucketMetadataTableConfigurationOutcome CreateBucketMetadataTableConfiguration(
      const Model::CreateBucketMetadataTableConfigurationRequest& request) const;

  /**
   * A Callable wrapper for CreateBucketMetadataTableConfiguration that returns a future to the operation so that it can be executed in
  ...
  Model::CreateBucketMetadataTableConfigurationOutcomeCallable CreateBucketMetadataTableConfigurationCallable(
      const CreateBucketMetadataTableConfigurationRequestT& request) const {
    return SubmitCallable(&S3Client::CreateBucketMetadataTableConfiguration, request);
  }

  /**
   * An Async wrapper for CreateBucketMetadataTableConfiguration that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename CreateBucketMetadataTableConfigurationRequestT = Model::CreateBucketMetadataTableConfigurationRequest>
  void CreateBucketMetadataTableConfigurationAsync(const CreateBucketMetadataTableConfigurationRequestT& request,
                                                   const CreateBucketMetadataTableConfigurationResponseReceivedHandler& handler,
                                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateMultipartUpload that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateMultipartUpload that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateMultipartUploadRequestT = Model::CreateMultipartUploadRequest>
  void CreateMultipartUploadAsync(const CreateMultipartUploadRequestT& request, const CreateMultipartUploadResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteBucket that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteBucketRequestT = Model::DeleteBucketRequest>
  void DeleteBucketAsync(const DeleteBucketRequestT& request, const DeleteBucketResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteBucketAnalyticsConfigurationOutcome DeleteBucketAnalyticsConfiguration(
      const Model::DeleteBucketAnalyticsConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DeleteBucketAnalyticsConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DeleteBucketAnalyticsConfigurationRequestT = Model::DeleteBucketAnalyticsConfigurationRequest>
  Model::DeleteBucketAnalyticsConfigurationOutcomeCallable DeleteBucketAnalyticsConfigurationCallable(
      const DeleteBucketAnalyticsConfigurationRequestT& request) const {
    return SubmitCallable(&S3Client::DeleteBucketAnalyticsConfiguration, request);
  }

  /**
   * An Async wrapper for DeleteBucketAnalyticsConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteBucketAnalyticsConfigurationRequestT = Model::DeleteBucketAnalyticsConfigurationRequest>
  void DeleteBucketAnalyticsConfigurationAsync(const DeleteBucketAnalyticsConfigurationRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteBucketCors that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteBucketCors that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteBucketCorsRequestT = Model::DeleteBucketCorsRequest>
  void DeleteBucketCorsAsync(const DeleteBucketCorsRequestT& request, const DeleteBucketCorsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteBucketEncryption that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteBucketEncryption that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteBucketEncryptionRequestT = Model::DeleteBucketEncryptionRequest>
  void DeleteBucketEncryptionAsync(const DeleteBucketEncryptionRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteBucketIntelligentTieringConfigurationOutcome DeleteBucketIntelligentTieringConfiguration(
      const Model::DeleteBucketIntelligentTieringConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DeleteBucketIntelligentTieringConfiguration that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  ...
  Model::DeleteBucketIntelligentTieringConfigurationOutcomeCallable DeleteBucketIntelligentTieringConfigurationCallable(
      const DeleteBucketIntelligentTieringConfigurationRequestT& request) const {
    return SubmitCallable(&S3Client::DeleteBucketIntelligentTieringConfiguration, request);
  }

  /**
   * An Async wrapper for DeleteBucketIntelligentTieringConfiguration that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DeleteBucketIntelligentTieringConfigurationRequestT = Model::DeleteBucketIntelligentTieringConfigurationRequest>
  void DeleteBucketIntelligentTieringConfigurationAsync(
      const DeleteBucketIntelligentTieringConfigurationRequestT& request,
      const DeleteBucketIntelligentTieringConfigurationResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&S3Client::DeleteBucketIntelligentTieringConfiguration, request, handler, context);
  }

  /**
   * <p>Deletes an S3 Inventory configuration (identified by the inventory ID) from
   * the bucket.</p>  <p> <b>Directory buckets </b> - For directory buckets,
   ...
   * permissions to perform the <code>s3:PutInventoryConfiguration</code> action. The
   ...
   * purpose bucket permissions</b> - The <code>s3:PutInventoryConfiguration</code>
   ...
   * operation, you must have the <code>s3express:PutInventoryConfiguration</code>
   * permission in an IAM identity-based policy instead of a bucket policy. For more
   ...
   * syntax</dt> <dd> <p> <b>Directory buckets </b> - The HTTP Host header syntax is
   * <code>s3express-control.<i>region-code</i>.amazonaws.com</code>.</p> </dd> </dl>
   * <p>For information about the Amazon S3 inventory feature, see <a
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteBucketInventoryConfigurationOutcome DeleteBucketInventoryConfiguration(
      const Model::DeleteBucketInventoryConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DeleteBucketInventoryConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DeleteBucketInventoryConfigurationRequestT = Model::DeleteBucketInventoryConfigurationRequest>
  Model::DeleteBucketInventoryConfigurationOutcomeCallable DeleteBucketInventoryConfigurationCallable(
      const DeleteBucketInventoryConfigurationRequestT& request) const {
    return SubmitCallable(&S3Client::DeleteBucketInventoryConfiguration, request);
  }

  /**
   * An Async wrapper for DeleteBucketInventoryConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteBucketInventoryConfigurationRequestT = Model::DeleteBucketInventoryConfigurationRequest>
  void DeleteBucketInventoryConfigurationAsync(const DeleteBucketInventoryConfigurationRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteBucketLifecycle that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteBucketLifecycle that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteBucketLifecycleRequestT = Model::DeleteBucketLifecycleRequest>
  void DeleteBucketLifecycleAsync(const DeleteBucketLifecycleRequestT& request, const DeleteBucketLifecycleResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&S3Client::DeleteBucketLifecycle, request, handler, context);
  }

  /**
   * <p> Deletes an S3 Metadata configuration from a general purpose bucket. For more
   * information, see <a
   * href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/metadata-tables-overview.html">Accelerating
   * data discovery with S3 Metadata</a> in the <i>Amazon S3 User Guide</i>. </p>
   *  <p>You can use the V2 <code>DeleteBucketMetadataConfiguration</code> API
   * operation with V1 or V2 metadata configurations. However, if you try to use the
   * V1 <code>DeleteBucketMetadataTableConfiguration</code> API operation with V2
   * configurations, you will receive an HTTP <code>405 Method Not Allowed</code>
   * error.</p>  <dl> <dt>Permissions</dt> <dd> <p>To use this operation, you
   * must have the <code>s3:DeleteBucketMetadataTableConfiguration</code> permission.
   * For more information, see <a
   * href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/metadata-tables-permissions.html">Setting
   * up permissions for configuring metadata tables</a> in the <i>Amazon S3 User
   * Guide</i>. </p>  <p>The IAM policy action name is the same for the V1 and
   * V2 API operations.</p>  </dd> </dl> <p>The following operations are
   * related to <code>DeleteBucketMetadataConfiguration</code>:</p> <ul> <li> <p> <a
   * href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_CreateBucketMetadataConfiguration.html">CreateBucketMetadataConfiguration</a>
   * </p> </li> <li> <p> <a
   * href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_GetBucketMetadataConfiguration.html">GetBucketMetadataConfiguration</a>
   * </p> </li> <li> <p> <a
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteBucketMetadataConfigurationOutcome DeleteBucketMetadataConfiguration(
      const Model::DeleteBucketMetadataConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DeleteBucketMetadataConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DeleteBucketMetadataConfigurationRequestT = Model::DeleteBucketMetadataConfigurationRequest>
  Model::DeleteBucketMetadataConfigurationOutcomeCallable DeleteBucketMetadataConfigurationCallable(
      const DeleteBucketMetadataConfigurationRequestT& request) const {
    return SubmitCallable(&S3Client::DeleteBucketMetadataConfiguration, request);
  }

  /**
   * An Async wrapper for DeleteBucketMetadataConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteBucketMetadataConfigurationRequestT = Model::DeleteBucketMetadataConfigurationRequest>
  void DeleteBucketMetadataConfigurationAsync(const DeleteBucketMetadataConfigurationRequestT& request,
                                              const DeleteBucketMetadataConfigurationResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&S3Client::DeleteBucketMetadataConfiguration, request, handler, context);
  }

  /**
   *  <p> We recommend that you delete your S3 Metadata configurations by
   * using the V2 <a
   * href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_DeleteBucketMetadataTableConfiguration.html">DeleteBucketMetadataTableConfiguration</a>
   * API operation. We no longer recommend using the V1
   * <code>DeleteBucketMetadataTableConfiguration</code> API operation. </p> <p>If
   * you created your S3 Metadata configuration before July 15, 2025, we recommend
   * that you delete and re-create your configuration by using <a
   * href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_CreateBucketMetadataConfiguration.html">CreateBucketMetadataConfiguration</a>
   * so that you can expire journal table records and create a live inventory
   * table.</p>  <p> Deletes a V1 S3 Metadata configuration from a
   * general purpose bucket. For more information, see <a
   * href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/metadata-tables-overview.html">Accelerating
   * data discovery with S3 Metadata</a> in the <i>Amazon S3 User Guide</i>. </p>
   *  <p>You can use the V2 <code>DeleteBucketMetadataConfiguration</code> API
   * operation with V1 or V2 metadata table configurations. However, if you try to
   * use the V1 <code>DeleteBucketMetadataTableConfiguration</code> API operation
   * with V2 configurations, you will receive an HTTP <code>405 Method Not
   * Allowed</code> error.</p> <p>Make sure that you update your processes to use the
   * new V2 API operations (<code>CreateBucketMetadataConfiguration</code>,
   * <code>GetBucketMetadataConfiguration</code>, and
   * <code>DeleteBucketMetadataConfiguration</code>) instead of the V1 API
   * operations. </p>  <dl> <dt>Permissions</dt> <dd> <p>To use this
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteBucketMetadataTableConfigurationOutcome DeleteBucketMetadataTableConfiguration(
      const Model::DeleteBucketMetadataTableConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DeleteBucketMetadataTableConfiguration that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DeleteBucketMetadataTableConfigurationRequestT = Model::DeleteBucketMetadataTableConfigurationRequest>
  Model::DeleteBucketMetadataTableConfigurationOutcomeCallable DeleteBucketMetadataTableConfigurationCallable(
      const DeleteBucketMetadataTableConfigurationRequestT& request) const {
    return SubmitCallable(&S3Client::DeleteBucketMetadataTableConfiguration, request);
  }

  /**
   * An Async wrapper for DeleteBucketMetadataTableConfiguration that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DeleteBucketMetadataTableConfigurationRequestT = Model::DeleteBucketMetadataTableConfigurationRequest>
  void DeleteBucketMetadataTableConfigurationAsync(const DeleteBucketMetadataTableConfigurationRequestT& request,
                                                   const DeleteBucketMetadataTableConfigurationResponseReceivedHandler& handler,
                                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteBucketMetricsConfigurationOutcome DeleteBucketMetricsConfiguration(
      const Model::DeleteBucketMetricsConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DeleteBucketMetricsConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DeleteBucketMetricsConfigurationRequestT = Model::DeleteBucketMetricsConfigurationRequest>
  Model::DeleteBucketMetricsConfigurationOutcomeCallable DeleteBucketMetricsConfigurationCallable(
      const DeleteBucketMetricsConfigurationRequestT& request) const {
    return SubmitCallable(&S3Client::DeleteBucketMetricsConfiguration, request);
  }

  /**
   * An Async wrapper for DeleteBucketMetricsConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteBucketMetricsConfigurationRequestT = Model::DeleteBucketMetricsConfigurationRequest>
  void DeleteBucketMetricsConfigurationAsync(const DeleteBucketMetricsConfigurationRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteBucketOwnershipControlsOutcome DeleteBucketOwnershipControls(
      const Model::DeleteBucketOwnershipControlsRequest& request) const;

  /**
   * A Callable wrapper for DeleteBucketOwnershipControls that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  ...
  Model::DeleteBucketOwnershipControlsOutcomeCallable DeleteBucketOwnershipControlsCallable(
      const DeleteBucketOwnershipControlsRequestT& request) const {
    return SubmitCallable(&S3Client::DeleteBucketOwnershipControls, request);
  }

  /**
   * An Async wrapper for DeleteBucketOwnershipControls that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteBucketOwnershipControlsRequestT = Model::DeleteBucketOwnershipControlsRequest>
  void DeleteBucketOwnershipControlsAsync(const DeleteBucketOwnershipControlsRequestT& request,
                                          const DeleteBucketOwnershipControlsResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteBucketPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteBucketPolicy that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteBucketPolicyRequestT = Model::DeleteBucketPolicyRequest>
  void DeleteBucketPolicyAsync(const DeleteBucketPolicyRequestT& request, const DeleteBucketPolicyResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteBucketReplication that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteBucketReplication that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteBucketReplicationRequestT = Model::DeleteBucketReplicationRequest>
  void DeleteBucketReplicationAsync(const DeleteBucketReplicationRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteBucketTagging that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteBucketTagging that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteBucketTaggingRequestT = Model::DeleteBucketTaggingRequest>
  void DeleteBucketTaggingAsync(const DeleteBucketTaggingRequestT& request, const DeleteBucketTaggingResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteBucketWebsite that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteBucketWebsite that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteBucketWebsiteRequestT = Model::DeleteBucketWebsiteRequest>
  void DeleteBucketWebsiteAsync(const DeleteBucketWebsiteRequestT& request, const DeleteBucketWebsiteResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteObject that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteObjectRequestT = Model::DeleteObjectRequest>
  ...
  /**
   * A Callable wrapper for DeleteObjectTagging that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteObjectTagging that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteObjectTaggingRequestT = Model::DeleteObjectTaggingRequest>
  void DeleteObjectTaggingAsync(const DeleteObjectTaggingRequestT& request, const DeleteObjectTaggingResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteObjects that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteObjectsRequestT = Model::DeleteObjectsRequest>
  void DeleteObjectsAsync(const DeleteObjectsRequestT& request, const DeleteObjectsResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeletePublicAccessBlock that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeletePublicAccessBlock that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeletePublicAccessBlockRequestT = Model::DeletePublicAccessBlockRequest>
  void DeletePublicAccessBlockAsync(const DeletePublicAccessBlockRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetBucketAccelerateConfigurationOutcome GetBucketAccelerateConfiguration(
      const Model::GetBucketAccelerateConfigurationRequest& request) const;

  /**
   * A Callable wrapper for GetBucketAccelerateConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename GetBucketAccelerateConfigurationRequestT = Model::GetBucketAccelerateConfigurationRequest>
  Model::GetBucketAccelerateConfigurationOutcomeCallable GetBucketAccelerateConfigurationCallable(
      const GetBucketAccelerateConfigurationRequestT& request) const {
    return SubmitCallable(&S3Client::GetBucketAccelerateConfiguration, request);
  }

  /**
   * An Async wrapper for GetBucketAccelerateConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetBucketAccelerateConfigurationRequestT = Model::GetBucketAccelerateConfigurationRequest>
  void GetBucketAccelerateConfigurationAsync(const GetBucketAccelerateConfigurationRequestT& request,
  ...
  /**
   * An Async wrapper for GetBucketAcl that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetBucketAclRequestT = Model::GetBucketAclRequest>
  void GetBucketAclAsync(const GetBucketAclRequestT& request, const GetBucketAclResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetBucketAnalyticsConfigurationOutcome GetBucketAnalyticsConfiguration(
      const Model::GetBucketAnalyticsConfigurationRequest& request) const;

  /**
   * A Callable wrapper for GetBucketAnalyticsConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetBucketAnalyticsConfigurationRequestT = Model::GetBucketAnalyticsConfigurationRequest>
  Model::GetBucketAnalyticsConfigurationOutcomeCallable GetBucketAnalyticsConfigurationCallable(
      const GetBucketAnalyticsConfigurationRequestT& request) const {
    return SubmitCallable(&S3Client::GetBucketAnalyticsConfiguration, request);
  }

  /**
   * An Async wrapper for GetBucketAnalyticsConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetBucketAnalyticsConfigurationRequestT = Model::GetBucketAnalyticsConfigurationRequest>
  void GetBucketAnalyticsConfigurationAsync(const GetBucketAnalyticsConfigurationRequestT& request,
  ...
  /**
   * An Async wrapper for GetBucketCors that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetBucketCorsRequestT = Model::GetBucketCorsRequest>
  void GetBucketCorsAsync(const GetBucketCorsRequestT& request, const GetBucketCorsResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetBucketEncryption that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetBucketEncryption that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetBucketEncryptionRequestT = Model::GetBucketEncryptionRequest>
  void GetBucketEncryptionAsync(const GetBucketEncryptionRequestT& request, const GetBucketEncryptionResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetBucketIntelligentTieringConfigurationOutcome GetBucketIntelligentTieringConfiguration(
      const Model::GetBucketIntelligentTieringConfigurationRequest& request) const;

  /**
   * A Callable wrapper for GetBucketIntelligentTieringConfiguration that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename GetBucketIntelligentTieringConfigurationRequestT = Model::GetBucketIntelligentTieringConfigurationRequest>
  Model::GetBucketIntelligentTieringConfigurationOutcomeCallable GetBucketIntelligentTieringConfigurationCallable(
      const GetBucketIntelligentTieringConfigurationRequestT& request) const {
    return SubmitCallable(&S3Client::GetBucketIntelligentTieringConfiguration, request);
  }

  /**
   * An Async wrapper for GetBucketIntelligentTieringConfiguration that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetBucketIntelligentTieringConfigurationRequestT = Model::GetBucketIntelligentTieringConfigurationRequest>
  void GetBucketIntelligentTieringConfigurationAsync(
      const GetBucketIntelligentTieringConfigurationRequestT& request,
      const GetBucketIntelligentTieringConfigurationResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&S3Client::GetBucketIntelligentTieringConfiguration, request, handler, context);
  }

  /**
   * <p>Returns an S3 Inventory configuration (identified by the inventory
   * configuration ID) from the bucket.</p>  <p> <b>Directory buckets </b> -
   ...
   * for directory buckets in Local Zones</a> in the <i>Amazon S3 User Guide</i>.</p>
   *  <dl> <dt>Permissions</dt> <dd> <p>To use this operation, you must have
   * permissions to perform the <code>s3:GetInventoryConfiguration</code> action. The
   * bucket owner has this permission by default. The bucket owner can grant this
   * permission to others. For more information about permissions, see <a
   * href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/using-with-s3-actions.html#using-with-s3-actions-related-to-bucket-subresources">Permissions
   * Related to Bucket Subresource Operations</a> and <a
   * href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/s3-access-control.html">Managing
   * Access Permissions to Your Amazon S3 Resources</a>.</p> <ul> <li> <p> <b>General
   * purpose bucket permissions</b> - The <code>s3:GetInventoryConfiguration</code>
   * permission is required in a policy. For more information about general purpose
   * buckets permissions, see <a
   * href="https://docs.aws.amazon.com/AmazonS3/latest/dev/using-iam-policies.html">Using
   * Bucket Policies and User Policies</a> in the <i>Amazon S3 User Guide</i>.</p>
   * </li> <li> <p> <b>Directory bucket permissions</b> - To grant access to this API
   * operation, you must have the <code>s3express:GetInventoryConfiguration</code>
   * permission in an IAM identity-based policy instead of a bucket policy. For more
   * information about directory bucket policies and permissions, see <a
   * href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/s3-express-security-iam.html">Amazon
   * Web Services Identity and Access Management (IAM) for S3 Express One Zone</a> in
   ...
   * API Reference</a></p>
   */
  virtual Model::GetBucketInventoryConfigurationOutcome GetBucketInventoryConfiguration(
      const Model::GetBucketInventoryConfigurationRequest& request) const;

  /**
   * A Callable wrapper for GetBucketInventoryConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetBucketInventoryConfigurationRequestT = Model::GetBucketInventoryConfigurationRequest>
  Model::GetBucketInventoryConfigurationOutcomeCallable GetBucketInventoryConfigurationCallable(
      const GetBucketInventoryConfigurationRequestT& request) const {
    return SubmitCallable(&S3Client::GetBucketInventoryConfiguration, request);
  }

  /**
   * An Async wrapper for GetBucketInventoryConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetBucketInventoryConfigurationRequestT = Model::GetBucketInventoryConfigurationRequest>
  void GetBucketInventoryConfigurationAsync(const GetBucketInventoryConfigurationRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetBucketLifecycleConfigurationOutcome GetBucketLifecycleConfiguration(
      const Model::GetBucketLifecycleConfigurationRequest& request) const;

  /**
   * A Callable wrapper for GetBucketLifecycleConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetBucketLifecycleConfigurationRequestT = Model::GetBucketLifecycleConfigurationRequest>
  Model::GetBucketLifecycleConfigurationOutcomeCallable GetBucketLifecycleConfigurationCallable(
      const GetBucketLifecycleConfigurationRequestT& request) const {
    return SubmitCallable(&S3Client::GetBucketLifecycleConfiguration, request);
  }

  /**
   * An Async wrapper for GetBucketLifecycleConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetBucketLifecycleConfigurationRequestT = Model::GetBucketLifecycleConfigurationRequest>
  void GetBucketLifecycleConfigurationAsync(const GetBucketLifecycleConfigurationRequestT& request,
  ...
  /**
   * A Callable wrapper for GetBucketLocation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetBucketLocation that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetBucketLocationRequestT = Model::GetBucketLocationRequest>
  void GetBucketLocationAsync(const GetBucketLocationRequestT& request, const GetBucketLocationResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetBucketLogging that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetBucketLogging that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetBucketLoggingRequestT = Model::GetBucketLoggingRequest>
  void GetBucketLoggingAsync(const GetBucketLoggingRequestT& request, const GetBucketLoggingResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&S3Client::GetBucketLogging, request, handler, context);
  }

  /**
   * <p>Retrieves the S3 Metadata configuration for a general purpose bucket. For
   * more information, see <a
   * href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/metadata-tables-overview.html">Accelerating
   * data discovery with S3 Metadata</a> in the <i>Amazon S3 User Guide</i>. </p>
   *  <p>You can use the V2 <code>GetBucketMetadataConfiguration</code> API
   * operation with V1 or V2 metadata configurations. However, if you try to use the
   * V1 <code>GetBucketMetadataTableConfiguration</code> API operation with V2
   * configurations, you will receive an HTTP <code>405 Method Not Allowed</code>
   * error.</p>  <dl> <dt>Permissions</dt> <dd> <p>To use this operation, you
   * must have the <code>s3:GetBucketMetadataTableConfiguration</code> permission.
   * For more information, see <a
   * href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/metadata-tables-permissions.html">Setting
   * up permissions for configuring metadata tables</a> in the <i>Amazon S3 User
   * Guide</i>. </p>  <p>The IAM policy action name is the same for the V1 and
   * V2 API operations.</p>  </dd> </dl> <p>The following operations are
   * related to <code>GetBucketMetadataConfiguration</code>:</p> <ul> <li> <p> <a
   * href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_CreateBucketMetadataConfiguration.html">CreateBucketMetadataConfiguration</a>
   * </p> </li> <li> <p> <a
   * href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_DeleteBucketMetadataConfiguration.html">DeleteBucketMetadataConfiguration</a>
   * </p> </li> <li> <p> <a
   ...
   * API Reference</a></p>
   */
  virtual Model::GetBucketMetadataConfigurationOutcome GetBucketMetadataConfiguration(
      const Model::GetBucketMetadataConfigurationRequest& request) const;

  /**
   * A Callable wrapper for GetBucketMetadataConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetBucketMetadataConfigurationRequestT = Model::GetBucketMetadataConfigurationRequest>
  Model::GetBucketMetadataConfigurationOutcomeCallable GetBucketMetadataConfigurationCallable(
      const GetBucketMetadataConfigurationRequestT& request) const {
    return SubmitCallable(&S3Client::GetBucketMetadataConfiguration, request);
  }

  /**
   * An Async wrapper for GetBucketMetadataConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetBucketMetadataConfigurationRequestT = Model::GetBucketMetadataConfigurationRequest>
  void GetBucketMetadataConfigurationAsync(const GetBucketMetadataConfigurationRequestT& request,
                                           const GetBucketMetadataConfigurationResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&S3Client::GetBucketMetadataConfiguration, request, handler, context);
  }
   ...
   * href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_GetBucketMetadataTableConfiguration.html">GetBucketMetadataTableConfiguration</a>
   * API operation. We no longer recommend using the V1
   * <code>GetBucketMetadataTableConfiguration</code> API operation. </p> <p>If you
   * created your S3 Metadata configuration before July 15, 2025, we recommend that
   * you delete and re-create your configuration by using <a
   * href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_CreateBucketMetadataConfiguration.html">CreateBucketMetadataConfiguration</a>
   * so that you can expire journal table records and create a live inventory
   * table.</p>  <p> Retrieves the V1 S3 Metadata configuration for a
   * general purpose bucket. For more information, see <a
   * href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/metadata-tables-overview.html">Accelerating
   * data discovery with S3 Metadata</a> in the <i>Amazon S3 User Guide</i>. </p>
   *  <p>You can use the V2 <code>GetBucketMetadataConfiguration</code> API
   * operation with V1 or V2 metadata table configurations. However, if you try to
   * use the V1 <code>GetBucketMetadataTableConfiguration</code> API operation with
   * V2 configurations, you will receive an HTTP <code>405 Method Not Allowed</code>
   * error.</p> <p>Make sure that you update your processes to use the new V2 API
   * operations (<code>CreateBucketMetadataConfiguration</code>,
   * <code>GetBucketMetadataConfiguration</code>, and
   * <code>DeleteBucketMetadataConfiguration</code>) instead of the V1 API
   * operations. </p>  <dl> <dt>Permissions</dt> <dd> <p>To use this
   * operation, you must have the <code>s3:GetBucketMetadataTableConfiguration</code>
  ...
  virtual Model::GetBucketMetadataTableConfigurationOutcome GetBucketMetadataTableConfiguration(
      const Model::GetBucketMetadataTableConfigurationRequest& request) const;

  /**
   * A Callable wrapper for GetBucketMetadataTableConfiguration that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename GetBucketMetadataTableConfigurationRequestT = Model::GetBucketMetadataTableConfigurationRequest>
  Model::GetBucketMetadataTableConfigurationOutcomeCallable GetBucketMetadataTableConfigurationCallable(
      const GetBucketMetadataTableConfigurationRequestT& request) const {
    return SubmitCallable(&S3Client::GetBucketMetadataTableConfiguration, request);
  }

  /**
   * An Async wrapper for GetBucketMetadataTableConfiguration that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetBucketMetadataTableConfigurationRequestT = Model::GetBucketMetadataTableConfigurationRequest>
  void GetBucketMetadataTableConfigurationAsync(const GetBucketMetadataTableConfigurationRequestT& request,
                                                const GetBucketMetadataTableConfigurationResponseReceivedHandler& handler,
                                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetBucketMetricsConfigurationOutcome GetBucketMetricsConfiguration(
      const Model::GetBucketMetricsConfigurationRequest& request) const;

  /**
   * A Callable wrapper for GetBucketMetricsConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetBucketMetricsConfigurationRequestT = Model::GetBucketMetricsConfigurationRequest>
  Model::GetBucketMetricsConfigurationOutcomeCallable GetBucketMetricsConfigurationCallable(
      const GetBucketMetricsConfigurationRequestT& request) const {
    return SubmitCallable(&S3Client::GetBucketMetricsConfiguration, request);
  }

  /**
   * An Async wrapper for GetBucketMetricsConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetBucketMetricsConfigurationRequestT = Model::GetBucketMetricsConfigurationRequest>
  void GetBucketMetricsConfigurationAsync(const GetBucketMetricsConfigurationRequestT& request,
  ...
  virtual Model::GetBucketNotificationConfigurationOutcome GetBucketNotificationConfiguration(
      const Model::GetBucketNotificationConfigurationRequest& request) const;

  /**
   * A Callable wrapper for GetBucketNotificationConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename GetBucketNotificationConfigurationRequestT = Model::GetBucketNotificationConfigurationRequest>
  Model::GetBucketNotificationConfigurationOutcomeCallable GetBucketNotificationConfigurationCallable(
      const GetBucketNotificationConfigurationRequestT& request) const {
    return SubmitCallable(&S3Client::GetBucketNotificationConfiguration, request);
  }

  /**
   * An Async wrapper for GetBucketNotificationConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetBucketNotificationConfigurationRequestT = Model::GetBucketNotificationConfigurationRequest>
  void GetBucketNotificationConfigurationAsync(const GetBucketNotificationConfigurationRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetBucketOwnershipControlsOutcome GetBucketOwnershipControls(
      const Model::GetBucketOwnershipControlsRequest& request) const;

  /**
   * A Callable wrapper for GetBucketOwnershipControls that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetBucketOwnershipControlsRequestT = Model::GetBucketOwnershipControlsRequest>
  Model::GetBucketOwnershipControlsOutcomeCallable GetBucketOwnershipControlsCallable(
      const GetBucketOwnershipControlsRequestT& request) const {
    return SubmitCallable(&S3Client::GetBucketOwnershipControls, request);
  }

  /**
   * An Async wrapper for GetBucketOwnershipControls that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetBucketOwnershipControlsRequestT = Model::GetBucketOwnershipControlsRequest>
  void GetBucketOwnershipControlsAsync(const GetBucketOwnershipControlsRequestT& request,
                                       const GetBucketOwnershipControlsResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetBucketPolicy that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetBucketPolicyRequestT = Model::GetBucketPolicyRequest>
  void GetBucketPolicyAsync(const GetBucketPolicyRequestT& request, const GetBucketPolicyResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetBucketPolicyStatus that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetBucketPolicyStatus that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetBucketPolicyStatusRequestT = Model::GetBucketPolicyStatusRequest>
  void GetBucketPolicyStatusAsync(const GetBucketPolicyStatusRequestT& request, const GetBucketPolicyStatusResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetBucketReplication that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetBucketReplication that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetBucketReplicationRequestT = Model::GetBucketReplicationRequest>
  void GetBucketReplicationAsync(const GetBucketReplicationRequestT& request, const GetBucketReplicationResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetBucketRequestPayment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetBucketRequestPayment that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetBucketRequestPaymentRequestT = Model::GetBucketRequestPaymentRequest>
  void GetBucketRequestPaymentAsync(const GetBucketRequestPaymentRequestT& request,
  ...
  /**
   * A Callable wrapper for GetBucketTagging that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetBucketTagging that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetBucketTaggingRequestT = Model::GetBucketTaggingRequest>
  void GetBucketTaggingAsync(const GetBucketTaggingRequestT& request, const GetBucketTaggingResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetBucketVersioning that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetBucketVersioning that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetBucketVersioningRequestT = Model::GetBucketVersioningRequest>
  void GetBucketVersioningAsync(const GetBucketVersioningRequestT& request, const GetBucketVersioningResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetBucketWebsite that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetBucketWebsite that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetBucketWebsiteRequestT = Model::GetBucketWebsiteRequest>
  void GetBucketWebsiteAsync(const GetBucketWebsiteRequestT& request, const GetBucketWebsiteResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetObject that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  virtual void GetObjectAsync(const Model::GetObjectRequest& request, const GetObjectResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const;
  ...
  /**
   * An Async wrapper for GetObjectAcl that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetObjectAclRequestT = Model::GetObjectAclRequest>
  void GetObjectAclAsync(const GetObjectAclRequestT& request, const GetObjectAclResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetObjectAttributes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetObjectAttributes that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetObjectAttributesRequestT = Model::GetObjectAttributesRequest>
  void GetObjectAttributesAsync(const GetObjectAttributesRequestT& request, const GetObjectAttributesResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetObjectLegalHold that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetObjectLegalHold that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetObjectLegalHoldRequestT = Model::GetObjectLegalHoldRequest>
  void GetObjectLegalHoldAsync(const GetObjectLegalHoldRequestT& request, const GetObjectLegalHoldResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::GetObjectLockConfigurationOutcome GetObjectLockConfiguration(
      const Model::GetObjectLockConfigurationRequest& request) const;

  /**
   * A Callable wrapper for GetObjectLockConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetObjectLockConfigurationRequestT = Model::GetObjectLockConfigurationRequest>
  Model::GetObjectLockConfigurationOutcomeCallable GetObjectLockConfigurationCallable(
      const GetObjectLockConfigurationRequestT& request) const {
    return SubmitCallable(&S3Client::GetObjectLockConfiguration, request);
  }

  /**
   * An Async wrapper for GetObjectLockConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetObjectLockConfigurationRequestT = Model::GetObjectLockConfigurationRequest>
  void GetObjectLockConfigurationAsync(const GetObjectLockConfigurationRequestT& request,
  ...
  /**
   * A Callable wrapper for GetObjectRetention that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetObjectRetention that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetObjectRetentionRequestT = Model::GetObjectRetentionRequest>
  void GetObjectRetentionAsync(const GetObjectRetentionRequestT& request, const GetObjectRetentionResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetObjectTagging that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetObjectTagging that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetObjectTaggingRequestT = Model::GetObjectTaggingRequest>
  void GetObjectTaggingAsync(const GetObjectTaggingRequestT& request, const GetObjectTaggingResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetObjectTorrent that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetObjectTorrent that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetObjectTorrentRequestT = Model::GetObjectTorrentRequest>
  void GetObjectTorrentAsync(const GetObjectTorrentRequestT& request, const GetObjectTorrentResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetPublicAccessBlock that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetPublicAccessBlock that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetPublicAccessBlockRequestT = Model::GetPublicAccessBlockRequest>
  void GetPublicAccessBlockAsync(const GetPublicAccessBlockRequestT& request, const GetPublicAccessBlockResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for HeadBucket that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename HeadBucketRequestT = Model::HeadBucketRequest>
  void HeadBucketAsync(const HeadBucketRequestT& request, const HeadBucketResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::ListBucketAnalyticsConfigurationsOutcome ListBucketAnalyticsConfigurations(
      const Model::ListBucketAnalyticsConfigurationsRequest& request) const;

  /**
   * A Callable wrapper for ListBucketAnalyticsConfigurations that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListBucketAnalyticsConfigurationsRequestT = Model::ListBucketAnalyticsConfigurationsRequest>
  Model::ListBucketAnalyticsConfigurationsOutcomeCallable ListBucketAnalyticsConfigurationsCallable(
      const ListBucketAnalyticsConfigurationsRequestT& request) const {
    return SubmitCallable(&S3Client::ListBucketAnalyticsConfigurations, request);
  }

  /**
   * An Async wrapper for ListBucketAnalyticsConfigurations that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListBucketAnalyticsConfigurationsRequestT = Model::ListBucketAnalyticsConfigurationsRequest>
  void ListBucketAnalyticsConfigurationsAsync(const ListBucketAnalyticsConfigurationsRequestT& request,
  ...
  virtual Model::ListBucketIntelligentTieringConfigurationsOutcome ListBucketIntelligentTieringConfigurations(
      const Model::ListBucketIntelligentTieringConfigurationsRequest& request) const;

  /**
   * A Callable wrapper for ListBucketIntelligentTieringConfigurations that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  ...
  Model::ListBucketIntelligentTieringConfigurationsOutcomeCallable ListBucketIntelligentTieringConfigurationsCallable(
      const ListBucketIntelligentTieringConfigurationsRequestT& request) const {
    return SubmitCallable(&S3Client::ListBucketIntelligentTieringConfigurations, request);
  }

  /**
   * An Async wrapper for ListBucketIntelligentTieringConfigurations that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListBucketIntelligentTieringConfigurationsRequestT = Model::ListBucketIntelligentTieringConfigurationsRequest>
  void ListBucketIntelligentTieringConfigurationsAsync(
      const ListBucketIntelligentTieringConfigurationsRequestT& request,
      const ListBucketIntelligentTieringConfigurationsResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * <code>NextContinuationToken</code> value to continue the pagination of the list
   * by passing the value in continuation-token in the request to <code>GET</code>
   * the next page.</p>  <p> <b>Directory buckets </b> - For directory buckets,
   * you must make requests for this API operation to the Regional endpoint. These
   * endpoints support path-style requests in the format
   * <code>https://s3express-control.<i>region-code</i>.amazonaws.com/<i>bucket-name</i>
   * </code>. Virtual-hosted-style requests aren't supported. For more information
   ...
   * API Reference</a></p>
   */
  virtual Model::ListBucketInventoryConfigurationsOutcome ListBucketInventoryConfigurations(
      const Model::ListBucketInventoryConfigurationsRequest& request) const;

  /**
   * A Callable wrapper for ListBucketInventoryConfigurations that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListBucketInventoryConfigurationsRequestT = Model::ListBucketInventoryConfigurationsRequest>
  Model::ListBucketInventoryConfigurationsOutcomeCallable ListBucketInventoryConfigurationsCallable(
      const ListBucketInventoryConfigurationsRequestT& request) const {
    return SubmitCallable(&S3Client::ListBucketInventoryConfigurations, request);
  }

  /**
   * An Async wrapper for ListBucketInventoryConfigurations that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListBucketInventoryConfigurationsRequestT = Model::ListBucketInventoryConfigurationsRequest>
  void ListBucketInventoryConfigurationsAsync(const ListBucketInventoryConfigurationsRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::ListBucketMetricsConfigurationsOutcome ListBucketMetricsConfigurations(
      const Model::ListBucketMetricsConfigurationsRequest& request) const;

  /**
   * A Callable wrapper for ListBucketMetricsConfigurations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListBucketMetricsConfigurationsRequestT = Model::ListBucketMetricsConfigurationsRequest>
  Model::ListBucketMetricsConfigurationsOutcomeCallable ListBucketMetricsConfigurationsCallable(
      const ListBucketMetricsConfigurationsRequestT& request) const {
    return SubmitCallable(&S3Client::ListBucketMetricsConfigurations, request);
  }

  /**
   * An Async wrapper for ListBucketMetricsConfigurations that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListBucketMetricsConfigurationsRequestT = Model::ListBucketMetricsConfigurationsRequest>
  void ListBucketMetricsConfigurationsAsync(const ListBucketMetricsConfigurationsRequestT& request,
  ...
  /**
   * An Async wrapper for ListBuckets that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListBucketsRequestT = Model::ListBucketsRequest>
  void ListBucketsAsync(const ListBucketsResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                        const ListBucketsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListDirectoryBuckets that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListDirectoryBuckets that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListDirectoryBucketsRequestT = Model::ListDirectoryBucketsRequest>
  void ListDirectoryBucketsAsync(const ListDirectoryBucketsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const ListDirectoryBucketsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListMultipartUploads that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListMultipartUploads that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListMultipartUploadsRequestT = Model::ListMultipartUploadsRequest>
  ...
  /**
   * A Callable wrapper for ListObjectVersions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListObjectVersions that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListObjectVersionsRequestT = Model::ListObjectVersionsRequest>
  void ListObjectVersionsAsync(const ListObjectVersionsRequestT& request, const ListObjectVersionsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListObjects that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListObjectsRequestT = Model::ListObjectsRequest>
  void ListObjectsAsync(const ListObjectsRequestT& request, const ListObjectsResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListObjectsV2 that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListObjectsV2RequestT = Model::ListObjectsV2Request>
  ...
  /**
   * An Async wrapper for ListParts that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListPartsRequestT = Model::ListPartsRequest>
  void ListPartsAsync(const ListPartsRequestT& request, const ListPartsResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::PutBucketAccelerateConfigurationOutcome PutBucketAccelerateConfiguration(
      const Model::PutBucketAccelerateConfigurationRequest& request) const;

  /**
   * A Callable wrapper for PutBucketAccelerateConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename PutBucketAccelerateConfigurationRequestT = Model::PutBucketAccelerateConfigurationRequest>
  Model::PutBucketAccelerateConfigurationOutcomeCallable PutBucketAccelerateConfigurationCallable(
      const PutBucketAccelerateConfigurationRequestT& request) const {
    return SubmitCallable(&S3Client::PutBucketAccelerateConfiguration, request);
  }

  /**
   * An Async wrapper for PutBucketAccelerateConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename PutBucketAccelerateConfigurationRequestT = Model::PutBucketAccelerateConfigurationRequest>
  void PutBucketAccelerateConfigurationAsync(const PutBucketAccelerateConfigurationRequestT& request,
  ...
  /**
   * An Async wrapper for PutBucketAcl that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutBucketAclRequestT = Model::PutBucketAclRequest>
  void PutBucketAclAsync(const PutBucketAclRequestT& request, const PutBucketAclResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::PutBucketAnalyticsConfigurationOutcome PutBucketAnalyticsConfiguration(
      const Model::PutBucketAnalyticsConfigurationRequest& request) const;

  /**
   * A Callable wrapper for PutBucketAnalyticsConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  ...
  Model::PutBucketAnalyticsConfigurationOutcomeCallable PutBucketAnalyticsConfigurationCallable(
      const PutBucketAnalyticsConfigurationRequestT& request) const {
    return SubmitCallable(&S3Client::PutBucketAnalyticsConfiguration, request);
  }

  /**
   * An Async wrapper for PutBucketAnalyticsConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename PutBucketAnalyticsConfigurationRequestT = Model::PutBucketAnalyticsConfigurationRequest>
  void PutBucketAnalyticsConfigurationAsync(const PutBucketAnalyticsConfigurationRequestT& request,
  ...
  /**
   * An Async wrapper for PutBucketCors that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutBucketCorsRequestT = Model::PutBucketCorsRequest>
  void PutBucketCorsAsync(const PutBucketCorsRequestT& request, const PutBucketCorsResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutBucketEncryption that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutBucketEncryption that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PutBucketEncryptionRequestT = Model::PutBucketEncryptionRequest>
  void PutBucketEncryptionAsync(const PutBucketEncryptionRequestT& request, const PutBucketEncryptionResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::PutBucketIntelligentTieringConfigurationOutcome PutBucketIntelligentTieringConfiguration(
      const Model::PutBucketIntelligentTieringConfigurationRequest& request) const;

  /**
   * A Callable wrapper for PutBucketIntelligentTieringConfiguration that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename PutBucketIntelligentTieringConfigurationRequestT = Model::PutBucketIntelligentTieringConfigurationRequest>
  Model::PutBucketIntelligentTieringConfigurationOutcomeCallable PutBucketIntelligentTieringConfigurationCallable(
      const PutBucketIntelligentTieringConfigurationRequestT& request) const {
    return SubmitCallable(&S3Client::PutBucketIntelligentTieringConfiguration, request);
  }

  /**
   * An Async wrapper for PutBucketIntelligentTieringConfiguration that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename PutBucketIntelligentTieringConfigurationRequestT = Model::PutBucketIntelligentTieringConfigurationRequest>
  void PutBucketIntelligentTieringConfigurationAsync(
      const PutBucketIntelligentTieringConfigurationRequestT& request,
      const PutBucketIntelligentTieringConfigurationResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&S3Client::PutBucketIntelligentTieringConfiguration, request, handler, context);
  }

  /**
   * <p>This implementation of the <code>PUT</code> action adds an S3 Inventory
   ...
   *   <p> <b>Directory buckets </b> - For directory buckets, you
   * must make requests for this API operation to the Regional endpoint. These
   * endpoints support path-style requests in the format
   * <code>https://s3express-control.<i>region-code</i>.amazonaws.com/<i>bucket-name</i>
   * </code>. Virtual-hosted-style requests aren't supported. For more information
   * about endpoints in Availability Zones, see <a
   ...
   * for directory buckets in Local Zones</a> in the <i>Amazon S3 User Guide</i>.</p>
   *  <dl> <dt>Permissions</dt> <dd> <p>To use this operation, you must have
   * permission to perform the <code>s3:PutInventoryConfiguration</code> action. The
   ...
   * that are available in the inventory report. </p> <ul> <li> <p> <b>General
   * purpose bucket permissions</b> - The <code>s3:PutInventoryConfiguration</code>
   * permission is required in a policy. For more information about general purpose
   * buckets permissions, see <a
   * href="https://docs.aws.amazon.com/AmazonS3/latest/dev/using-iam-policies.html">Using
   ...
   * href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/s3-express-security-iam.html">Amazon
   * Web Services Identity and Access Management (IAM) for S3 Express One Zone</a> in
   * the <i>Amazon S3 User Guide</i>.</p> </li> </ul> <p>To restrict access to an
   * inventory report, see <a
   * href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/example-bucket-policies.html#example-bucket-policies-s3-inventory">Restricting
   ...
   * HTTP Host header syntax is
   * <code>s3express-control.<i>region-code</i>.amazonaws.com</code>.</p> </dd> </dl>
   * <p> <code>PutBucketInventoryConfiguration</code> has the following special
   * errors:</p> <dl> <dt>HTTP 400 Bad Request Error</dt> <dd> <p> <i>Code:</i>
   * InvalidArgument</p> <p> <i>Cause:</i> Invalid Argument</p> </dd> <dt>HTTP 400
   * Bad Request Error</dt> <dd> <p> <i>Code:</i> TooManyConfigurations</p> <p>
   * <i>Cause:</i> You are attempting to create a new configuration but have already
   * reached the 1,000-configuration limit. </p> </dd> <dt>HTTP 403 Forbidden
   * Error</dt> <dd> <p> <i>Cause:</i> You are not the owner of the specified bucket,
   * or you do not have the <code>s3:PutInventoryConfiguration</code> bucket
   * permission to set the configuration on the bucket. </p> </dd> </dl> <p>The
   * following operations are related to
   * <code>PutBucketInventoryConfiguration</code>:</p> <ul> <li> <p> <a
   * href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_GetBucketInventoryConfiguration.html">GetBucketInventoryConfiguration</a>
   * </p> </li> <li> <p> <a
   * href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_DeleteBucketInventoryConfiguration.html">DeleteBucketInventoryConfiguration</a>
   * </p> </li> <li> <p> <a
   ...
   * API Reference</a></p>
   */
  virtual Model::PutBucketInventoryConfigurationOutcome PutBucketInventoryConfiguration(
      const Model::PutBucketInventoryConfigurationRequest& request) const;

  /**
   * A Callable wrapper for PutBucketInventoryConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PutBucketInventoryConfigurationRequestT = Model::PutBucketInventoryConfigurationRequest>
  Model::PutBucketInventoryConfigurationOutcomeCallable PutBucketInventoryConfigurationCallable(
      const PutBucketInventoryConfigurationRequestT& request) const {
    return SubmitCallable(&S3Client::PutBucketInventoryConfiguration, request);
  }

  /**
   * An Async wrapper for PutBucketInventoryConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename PutBucketInventoryConfigurationRequestT = Model::PutBucketInventoryConfigurationRequest>
  void PutBucketInventoryConfigurationAsync(const PutBucketInventoryConfigurationRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::PutBucketLifecycleConfigurationOutcome PutBucketLifecycleConfiguration(
      const Model::PutBucketLifecycleConfigurationRequest& request) const;

  /**
   * A Callable wrapper for PutBucketLifecycleConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PutBucketLifecycleConfigurationRequestT = Model::PutBucketLifecycleConfigurationRequest>
  Model::PutBucketLifecycleConfigurationOutcomeCallable PutBucketLifecycleConfigurationCallable(
      const PutBucketLifecycleConfigurationRequestT& request) const {
    return SubmitCallable(&S3Client::PutBucketLifecycleConfiguration, request);
  }

  /**
   * An Async wrapper for PutBucketLifecycleConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename PutBucketLifecycleConfigurationRequestT = Model::PutBucketLifecycleConfigurationRequest>
  void PutBucketLifecycleConfigurationAsync(const PutBucketLifecycleConfigurationRequestT& request,
  ...
  /**
   * A Callable wrapper for PutBucketLogging that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutBucketLogging that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PutBucketLoggingRequestT = Model::PutBucketLoggingRequest>
  void PutBucketLoggingAsync(const PutBucketLoggingRequestT& request, const PutBucketLoggingResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::PutBucketMetricsConfigurationOutcome PutBucketMetricsConfiguration(
      const Model::PutBucketMetricsConfigurationRequest& request) const;

  /**
   * A Callable wrapper for PutBucketMetricsConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PutBucketMetricsConfigurationRequestT = Model::PutBucketMetricsConfigurationRequest>
  Model::PutBucketMetricsConfigurationOutcomeCallable PutBucketMetricsConfigurationCallable(
      const PutBucketMetricsConfigurationRequestT& request) const {
    return SubmitCallable(&S3Client::PutBucketMetricsConfiguration, request);
  }

  /**
   * An Async wrapper for PutBucketMetricsConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutBucketMetricsConfigurationRequestT = Model::PutBucketMetricsConfigurationRequest>
  void PutBucketMetricsConfigurationAsync(const PutBucketMetricsConfigurationRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::PutBucketNotificationConfigurationOutcome PutBucketNotificationConfiguration(
      const Model::PutBucketNotificationConfigurationRequest& request) const;

  /**
   * A Callable wrapper for PutBucketNotificationConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename PutBucketNotificationConfigurationRequestT = Model::PutBucketNotificationConfigurationRequest>
  Model::PutBucketNotificationConfigurationOutcomeCallable PutBucketNotificationConfigurationCallable(
      const PutBucketNotificationConfigurationRequestT& request) const {
    return SubmitCallable(&S3Client::PutBucketNotificationConfiguration, request);
  }

  /**
   * An Async wrapper for PutBucketNotificationConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename PutBucketNotificationConfigurationRequestT = Model::PutBucketNotificationConfigurationRequest>
  void PutBucketNotificationConfigurationAsync(const PutBucketNotificationConfigurationRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::PutBucketOwnershipControlsOutcome PutBucketOwnershipControls(
      const Model::PutBucketOwnershipControlsRequest& request) const;

  /**
   * A Callable wrapper for PutBucketOwnershipControls that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PutBucketOwnershipControlsRequestT = Model::PutBucketOwnershipControlsRequest>
  Model::PutBucketOwnershipControlsOutcomeCallable PutBucketOwnershipControlsCallable(
      const PutBucketOwnershipControlsRequestT& request) const {
    return SubmitCallable(&S3Client::PutBucketOwnershipControls, request);
  }

  /**
   * An Async wrapper for PutBucketOwnershipControls that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutBucketOwnershipControlsRequestT = Model::PutBucketOwnershipControlsRequest>
  void PutBucketOwnershipControlsAsync(const PutBucketOwnershipControlsRequestT& request,
                                       const PutBucketOwnershipControlsResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for PutBucketPolicy that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutBucketPolicyRequestT = Model::PutBucketPolicyRequest>
  void PutBucketPolicyAsync(const PutBucketPolicyRequestT& request, const PutBucketPolicyResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutBucketReplication that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutBucketReplication that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutBucketReplicationRequestT = Model::PutBucketReplicationRequest>
  void PutBucketReplicationAsync(const PutBucketReplicationRequestT& request, const PutBucketReplicationResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutBucketRequestPayment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutBucketRequestPayment that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutBucketRequestPaymentRequestT = Model::PutBucketRequestPaymentRequest>
  void PutBucketRequestPaymentAsync(const PutBucketRequestPaymentRequestT& request,
  ...
  /**
   * A Callable wrapper for PutBucketTagging that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutBucketTagging that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PutBucketTaggingRequestT = Model::PutBucketTaggingRequest>
  void PutBucketTaggingAsync(const PutBucketTaggingRequestT& request, const PutBucketTaggingResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutBucketVersioning that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutBucketVersioning that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PutBucketVersioningRequestT = Model::PutBucketVersioningRequest>
  void PutBucketVersioningAsync(const PutBucketVersioningRequestT& request, const PutBucketVersioningResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutBucketWebsite that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutBucketWebsite that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PutBucketWebsiteRequestT = Model::PutBucketWebsiteRequest>
  void PutBucketWebsiteAsync(const PutBucketWebsiteRequestT& request, const PutBucketWebsiteResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for PutObject that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  virtual void PutObjectAsync(const Model::PutObjectRequest& request, const PutObjectResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const;
  ...
  /**
   * An Async wrapper for PutObjectAcl that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutObjectAclRequestT = Model::PutObjectAclRequest>
  void PutObjectAclAsync(const PutObjectAclRequestT& request, const PutObjectAclResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutObjectLegalHold that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutObjectLegalHold that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PutObjectLegalHoldRequestT = Model::PutObjectLegalHoldRequest>
  void PutObjectLegalHoldAsync(const PutObjectLegalHoldRequestT& request, const PutObjectLegalHoldResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::PutObjectLockConfigurationOutcome PutObjectLockConfiguration(
      const Model::PutObjectLockConfigurationRequest& request) const;

  /**
   * A Callable wrapper for PutObjectLockConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PutObjectLockConfigurationRequestT = Model::PutObjectLockConfigurationRequest>
  Model::PutObjectLockConfigurationOutcomeCallable PutObjectLockConfigurationCallable(
      const PutObjectLockConfigurationRequestT& request) const {
    return SubmitCallable(&S3Client::PutObjectLockConfiguration, request);
  }

  /**
   * An Async wrapper for PutObjectLockConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutObjectLockConfigurationRequestT = Model::PutObjectLockConfigurationRequest>
  void PutObjectLockConfigurationAsync(const PutObjectLockConfigurationRequestT& request,
                                       const PutObjectLockConfigurationResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutObjectRetention that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutObjectRetention that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PutObjectRetentionRequestT = Model::PutObjectRetentionRequest>
  void PutObjectRetentionAsync(const PutObjectRetentionRequestT& request, const PutObjectRetentionResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutObjectTagging that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutObjectTagging that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PutObjectTaggingRequestT = Model::PutObjectTaggingRequest>
  void PutObjectTaggingAsync(const PutObjectTaggingRequestT& request, const PutObjectTaggingResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutPublicAccessBlock that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutPublicAccessBlock that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutPublicAccessBlockRequestT = Model::PutPublicAccessBlockRequest>
  void PutPublicAccessBlockAsync(const PutPublicAccessBlockRequestT& request, const PutPublicAccessBlockResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for RenameObject that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename RenameObjectRequestT = Model::RenameObjectRequest>
  void RenameObjectAsync(const RenameObjectRequestT& request, const RenameObjectResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for RestoreObject that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename RestoreObjectRequestT = Model::RestoreObjectRequest>
  void RestoreObjectAsync(const RestoreObjectRequestT& request, const RestoreObjectResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SelectObjectContent that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SelectObjectContent that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename SelectObjectContentRequestT = Model::SelectObjectContentRequest>
  ...
  /**
   * <p>Enables or disables a live inventory table for an S3 Metadata configuration
   * on a general purpose bucket. For more information, see <a
   * href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/metadata-tables-overview.html">Accelerating
   * data discovery with S3 Metadata</a> in the <i>Amazon S3 User Guide</i>.</p> <dl>
   * <dt>Permissions</dt> <dd> <p>To use this operation, you must have the following
   * permissions. For more information, see <a
   * href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/metadata-tables-permissions.html">Setting
   * up permissions for configuring metadata tables</a> in the <i>Amazon S3 User
   * Guide</i>.</p> <p>If you want to encrypt your inventory table with server-side
   * encryption with Key Management Service (KMS) keys (SSE-KMS), you need additional
   * permissions in your KMS key policy. For more information, see <a
   * href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/metadata-tables-permissions.html">
   * Setting up permissions for configuring metadata tables</a> in the <i>Amazon S3
   * User Guide</i>.</p> <ul> <li> <p>
   * <code>s3:UpdateBucketMetadataInventoryTableConfiguration</code> </p> </li> <li>
   * <p> <code>s3tables:CreateTableBucket</code> </p> </li> <li> <p>
   * <code>s3tables:CreateNamespace</code> </p> </li> <li> <p>
   * <code>s3tables:GetTable</code> </p> </li> <li> <p>
   * <code>s3tables:CreateTable</code> </p> </li> <li> <p>
   * <code>s3tables:PutTablePolicy</code> </p> </li> <li> <p>
   ...
   * <code>UpdateBucketMetadataInventoryTableConfiguration</code>:</p> <ul> <li> <p>
   * <a
   * href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_CreateBucketMetadataConfiguration.html">CreateBucketMetadataConfiguration</a>
   * </p> </li> <li> <p> <a
   * href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_DeleteBucketMetadataConfiguration.html">DeleteBucketMetadataConfiguration</a>
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateBucketMetadataInventoryTableConfigurationOutcome UpdateBucketMetadataInventoryTableConfiguration(
      const Model::UpdateBucketMetadataInventoryTableConfigurationRequest& request) const;

  /**
   * A Callable wrapper for UpdateBucketMetadataInventoryTableConfiguration that returns a future to the operation so that it can be
   * executed in parallel to other requests.
   */
  template <
  ...
  Model::UpdateBucketMetadataInventoryTableConfigurationOutcomeCallable UpdateBucketMetadataInventoryTableConfigurationCallable(
      const UpdateBucketMetadataInventoryTableConfigurationRequestT& request) const {
    return SubmitCallable(&S3Client::UpdateBucketMetadataInventoryTableConfiguration, request);
  }

  /**
   * An Async wrapper for UpdateBucketMetadataInventoryTableConfiguration that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <
      typename UpdateBucketMetadataInventoryTableConfigurationRequestT = Model::UpdateBucketMetadataInventoryTableConfigurationRequest>
  void UpdateBucketMetadataInventoryTableConfigurationAsync(
      const UpdateBucketMetadataInventoryTableConfigurationRequestT& request,
      const UpdateBucketMetadataInventoryTableConfigurationResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&S3Client::UpdateBucketMetadataInventoryTableConfiguration, request, handler, context);
  }

  /**
   * <p>Enables or disables journal table record expiration for an S3 Metadata
   * configuration on a general purpose bucket. For more information, see <a
   * href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/metadata-tables-overview.html">Accelerating
   * data discovery with S3 Metadata</a> in the <i>Amazon S3 User Guide</i>.</p> <dl>
   * <dt>Permissions</dt> <dd> <p>To use this operation, you must have the
   * <code>s3:UpdateBucketMetadataJournalTableConfiguration</code> permission. For
   * more information, see <a
   * href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/metadata-tables-permissions.html">Setting
   * up permissions for configuring metadata tables</a> in the <i>Amazon S3 User
   * Guide</i>. </p> </dd> </dl> <p>The following operations are related to
   * <code>UpdateBucketMetadataJournalTableConfiguration</code>:</p> <ul> <li> <p> <a
   * href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_CreateBucketMetadataConfiguration.html">CreateBucketMetadataConfiguration</a>
   * </p> </li> <li> <p> <a
   * href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_DeleteBucketMetadataConfiguration.html">DeleteBucketMetadataConfiguration</a>
   * </p> </li> <li> <p> <a
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateBucketMetadataJournalTableConfigurationOutcome UpdateBucketMetadataJournalTableConfiguration(
      const Model::UpdateBucketMetadataJournalTableConfigurationRequest& request) const;

  /**
   * A Callable wrapper for UpdateBucketMetadataJournalTableConfiguration that returns a future to the operation so that it can be executed
   * in parallel to other requests.
   */
  template <typename UpdateBucketMetadataJournalTableConfigurationRequestT = Model::UpdateBucketMetadataJournalTableConfigurationRequest>
  Model::UpdateBucketMetadataJournalTableConfigurationOutcomeCallable UpdateBucketMetadataJournalTableConfigurationCallable(
      const UpdateBucketMetadataJournalTableConfigurationRequestT& request) const {
    return SubmitCallable(&S3Client::UpdateBucketMetadataJournalTableConfiguration, request);
  }

  /**
   * An Async wrapper for UpdateBucketMetadataJournalTableConfiguration that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename UpdateBucketMetadataJournalTableConfigurationRequestT = Model::UpdateBucketMetadataJournalTableConfigurationRequest>
  void UpdateBucketMetadataJournalTableConfigurationAsync(
      const UpdateBucketMetadataJournalTableConfigurationRequestT& request,
   ...
   * permissions:</p> <ul> <li> <p> <code>s3:UpdateObjectEncryption</code> </p> </li>
   * <li> <p> <code>kms:Encrypt</code> </p> </li> <li> <p> <code>kms:Decrypt</code>
  ...
  /**
   * An Async wrapper for UploadPart that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UploadPartRequestT = Model::UploadPartRequest>
  void UploadPartAsync(const UploadPartRequestT& request, const UploadPartResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UploadPartCopy that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UploadPartCopyRequestT = Model::UploadPartCopyRequest>
  void UploadPartCopyAsync(const UploadPartCopyRequestT& request, const UploadPartCopyResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for WriteGetObjectResponse that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for WriteGetObjectResponse that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename WriteGetObjectResponseRequestT = Model::WriteGetObjectResponseRequest>
  void WriteGetObjectResponseAsync(const WriteGetObjectResponseRequestT& request,
                                   const WriteGetObjectResponseResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&S3Client::WriteGetObjectResponse, request, handler, context);
  }

  virtual Aws::String GeneratePresignedUrl(const Aws::String& bucket, const Aws::String& key, Aws::Http::HttpMethod method,
   ...
   * SS3-C     AES256       x-amz-server-side-encryption-customer-algorithm:AES256,
   * x-amz-server-side-encryption-customer-key:<base64EncodedKey>,
   * x-amz-server-side-encryption-customer-key-MD5:<Base64EncodedMD5ofNonBase64EncodedKey>
   */
  /**
   ...
   */
  virtual Aws::String GeneratePresignedUrlWithSSES3(const Aws::String& bucket, const Aws::String& key, Aws::Http::HttpMethod method,
                                                    uint64_t expirationInSeconds = MAX_EXPIRATION_SECONDS);
  /**
   * Generate presigned URL with Sever Side Encryption(SSE) and with S3 managed keys.
   * https://docs.aws.amazon.com/AmazonS3/latest/dev/serv-side-encryption.html (algo: AES256)
   ...
   * if kmsMasterKeyId is empty, we will end up use the default one generated by KMS for you. You can find it via AWS IAM console, it's the
   * one aliased as "aws/s3". https://docs.aws.amazon.com/AmazonS3/latest/dev/serv-side-encryption.html (algo: aws:kms)
   */
  virtual Aws::String GeneratePresignedUrlWithSSEKMS(const Aws::String& bucket, const Aws::String& key, Aws::Http::HttpMethod method,
                                                     const Aws::String& kmsMasterKeyId = "",
                                                     uint64_t expirationInSeconds = MAX_EXPIRATION_SECONDS);
  /**
   * Generate presigned URL with Server Side Encryption(SSE) and with KMS master key id.
   * if kmsMasterKeyId is empty, we will end up use the default one generated by KMS for you. You can find it via AWS IAM console, it's the
   * one aliased as "aws/s3". https://docs.aws.amazon.com/AmazonS3/latest/dev/serv-side-encryption.html (algo: aws:kms) Headers:
   * "x-amz-server-side-encryption" and "x-amz-server-side-encryption-aws-kms-key-id" will be added internally, don't customize them.
   */
  virtual Aws::String GeneratePresignedUrlWithSSEKMS(const Aws::String& bucket, const Aws::String& key, Aws::Http::HttpMethod method,
   ...
   * https://docs.aws.amazon.com/AmazonS3/latest/dev/serv-side-encryption.html (algo: AES256)
   */
  virtual Aws::String GeneratePresignedUrlWithSSEC(const Aws::String& bucket, const Aws::String& key, Aws::Http::HttpMethod method,
                                                   const Aws::String& base64EncodedAES256Key,
                                                   uint64_t expirationInSeconds = MAX_EXPIRATION_SECONDS);
  /**
   * Generate presigned URL with Sever Side Encryption(SSE) and with customer supplied Key.
   * https://docs.aws.amazon.com/AmazonS3/latest/dev/serv-side-encryption.html (algo: AES256)
   * Headers: "x-amz-server-side-encryption-customer-algorithm","x-amz-server-side-encryption-customer-key" and
   * "x-amz-server-side-encryption-customer-key-MD5" will be added internally, don't customize them.
   */
  virtual Aws::String GeneratePresignedUrlWithSSEC(const Aws::String& bucket, const Aws::String& key, Aws::Http::HttpMethod method,
