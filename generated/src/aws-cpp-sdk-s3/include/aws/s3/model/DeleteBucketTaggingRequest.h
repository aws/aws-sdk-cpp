...
class DeleteBucketTaggingRequest : public S3Request {
 public:
  ...
  template <typename BucketT = Aws::String>
  DeleteBucketTaggingRequest& WithBucket(BucketT&& value) {
  ...
  template <typename ExpectedBucketOwnerT = Aws::String>
  DeleteBucketTaggingRequest& WithExpectedBucketOwner(ExpectedBucketOwnerT&& value) {
  ...
  template <typename CustomizedAccessLogTagT = Aws::Map<Aws::String, Aws::String>>
  DeleteBucketTaggingRequest& WithCustomizedAccessLogTag(CustomizedAccessLogTagT&& value) {
