...
namespace Model
{
  ...
  public:
    ...
    void SetRules(RulesT&& value) { m_rules = std::forward<RulesT>(value); }
    template<typename RulesT = Aws::Vector<LifecycleRule>>
    ...
    GetBucketLifecycleConfigurationResult& AddRules(RulesT&& value) { m_rules.emplace_back(std::forward<RulesT>(value)); return *this; }
    ///@}
