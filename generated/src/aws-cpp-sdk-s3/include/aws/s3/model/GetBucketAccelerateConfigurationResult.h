...
class GetBucketAccelerateConfigurationResult {
 public:
  ...
  inline GetBucketAccelerateConfigurationResult& WithStatus(BucketAccelerateStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline GetBucketAccelerateConfigurationResult& WithRequestCharged(RequestCharged value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetBucketAccelerateConfigurationResult& WithRequestId(RequestIdT&& value) {
