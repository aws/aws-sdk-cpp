...
class CreateBucketMetadataTableConfigurationRequest : public S3Request {
 public:
  ...
  inline CreateBucketMetadataTableConfigurationRequest& WithChecksumAlgorithm(ChecksumAlgorithm value) {
  ...
  void SetMetadataTableConfiguration(MetadataTableConfigurationT&& value) {
    m_metadataTableConfigurationHasBeenSet = true;
    m_metadataTableConfiguration = std::forward<MetadataTableConfigurationT>(value);
  }
  template <typename MetadataTableConfigurationT = MetadataTableConfiguration>
  CreateBucketMetadataTableConfigurationRequest& WithMetadataTableConfiguration(MetadataTableConfigurationT&& value) {
    SetMetadataTableConfiguration(std::forward<MetadataTableConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  CreateBucketMetadataTableConfigurationRequest& AddCustomizedAccessLogTag(CustomizedAccessLogTagKeyT&& key,
