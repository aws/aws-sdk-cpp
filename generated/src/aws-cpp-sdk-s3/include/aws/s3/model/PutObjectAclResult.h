...
namespace Model
{
  ...
  {
  public:
    AWS_S3_API PutObjectAclResult() = default;
    ...
    inline PutObjectAclResult& WithRequestCharged(RequestCharged value) { SetRequestCharged(value); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    PutObjectAclResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
