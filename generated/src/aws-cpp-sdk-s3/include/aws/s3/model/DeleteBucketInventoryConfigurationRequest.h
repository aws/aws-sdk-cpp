...
class DeleteBucketInventoryConfigurationRequest : public S3Request {
 public:
  ...
  template <typename BucketT = Aws::String>
  DeleteBucketInventoryConfigurationRequest& WithBucket(BucketT&& value) {
  ...
  template <typename IdT = Aws::String>
  DeleteBucketInventoryConfigurationRequest& WithId(IdT&& value) {
  ...
  template <typename ExpectedBucketOwnerT = Aws::String>
  DeleteBucketInventoryConfigurationRequest& WithExpectedBucketOwner(ExpectedBucketOwnerT&& value) {
  ...
  template <typename CustomizedAccessLogTagT = Aws::Map<Aws::String, Aws::String>>
  DeleteBucketInventoryConfigurationRequest& WithCustomizedAccessLogTag(CustomizedAccessLogTagT&& value) {
  ...
  DeleteBucketInventoryConfigurationRequest& AddCustomizedAccessLogTag(CustomizedAccessLogTagKeyT&& key,
