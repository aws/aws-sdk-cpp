...
namespace Model
{
  ...
  public:
    ...
    void SetVersionIdMarker(VersionIdMarkerT&& value) { m_versionIdMarker = std::forward<VersionIdMarkerT>(value); }
    template<typename VersionIdMarkerT = Aws::String>
    ...
    void SetNextVersionIdMarker(NextVersionIdMarkerT&& value) { m_nextVersionIdMarker = std::forward<NextVersionIdMarkerT>(value); }
    template<typename NextVersionIdMarkerT = Aws::String>
    ...
    void SetVersions(VersionsT&& value) { m_versions = std::forward<VersionsT>(value); }
    template<typename VersionsT = Aws::Vector<ObjectVersion>>
    ...
    ListObjectVersionsResult& AddVersions(VersionsT&& value) { m_versions.emplace_back(std::forward<VersionsT>(value)); return *this; }
    ///@}
    ...
    void SetDeleteMarkers(DeleteMarkersT&& value) { m_deleteMarkers = std::forward<DeleteMarkersT>(value); }
    template<typename DeleteMarkersT = Aws::Vector<DeleteMarkerEntry>>
    ...
    ListObjectVersionsResult& AddDeleteMarkers(DeleteMarkersT&& value) { m_deleteMarkers.emplace_back(std::forward<DeleteMarkersT>(value)); return *this; }
    ///@}
    ...
    void SetName(NameT&& value) { m_name = std::forward<NameT>(value); }
    template<typename NameT = Aws::String>
    ...
    ListObjectVersionsResult& AddCommonPrefixes(CommonPrefixesT&& value) { m_commonPrefixes.emplace_back(std::forward<CommonPrefixesT>(value)); return *this; }
    ///@}
