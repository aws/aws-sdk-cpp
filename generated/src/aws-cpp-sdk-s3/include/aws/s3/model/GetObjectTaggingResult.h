...
namespace Model
{
  ...
  public:
    ...
    void SetTagSet(TagSetT&& value) { m_tagSet = std::forward<TagSetT>(value); }
    template<typename TagSetT = Aws::Vector<Tag>>
    ...
    GetObjectTaggingResult& AddTagSet(TagSetT&& value) { m_tagSet.emplace_back(std::forward<TagSetT>(value)); return *this; }
    ///@}
