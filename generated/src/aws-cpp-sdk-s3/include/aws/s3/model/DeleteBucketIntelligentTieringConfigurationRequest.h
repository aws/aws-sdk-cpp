...
class DeleteBucketIntelligentTieringConfigurationRequest : public S3Request {
 public:
  ...
  template <typename BucketT = Aws::String>
  DeleteBucketIntelligentTieringConfigurationRequest& WithBucket(BucketT&& value) {
  ...
  template <typename IdT = Aws::String>
  DeleteBucketIntelligentTieringConfigurationRequest& WithId(IdT&& value) {
  ...
  template <typename ExpectedBucketOwnerT = Aws::String>
  DeleteBucketIntelligentTieringConfigurationRequest& WithExpectedBucketOwner(ExpectedBucketOwnerT&& value) {
  ...
  template <typename CustomizedAccessLogTagT = Aws::Map<Aws::String, Aws::String>>
  DeleteBucketIntelligentTieringConfigurationRequest& WithCustomizedAccessLogTag(CustomizedAccessLogTagT&& value) {
  ...
  DeleteBucketIntelligentTieringConfigurationRequest& AddCustomizedAccessLogTag(CustomizedAccessLogTagKeyT&& key,
