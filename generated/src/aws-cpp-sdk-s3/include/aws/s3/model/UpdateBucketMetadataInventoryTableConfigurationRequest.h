...
class UpdateBucketMetadataInventoryTableConfigurationRequest : public S3Request {
 public:
  ...
  template <typename BucketT = Aws::String>
  UpdateBucketMetadataInventoryTableConfigurationRequest& WithBucket(BucketT&& value) {
  ...
  template <typename ContentMD5T = Aws::String>
  UpdateBucketMetadataInventoryTableConfigurationRequest& WithContentMD5(ContentMD5T&& value) {
  ...
  inline UpdateBucketMetadataInventoryTableConfigurationRequest& WithChecksumAlgorithm(ChecksumAlgorithm value) {
  ...
  template <typename InventoryTableConfigurationT = InventoryTableConfigurationUpdates>
  UpdateBucketMetadataInventoryTableConfigurationRequest& WithInventoryTableConfiguration(InventoryTableConfigurationT&& value) {
  ...
  template <typename ExpectedBucketOwnerT = Aws::String>
  UpdateBucketMetadataInventoryTableConfigurationRequest& WithExpectedBucketOwner(ExpectedBucketOwnerT&& value) {
  ...
  template <typename CustomizedAccessLogTagT = Aws::Map<Aws::String, Aws::String>>
  UpdateBucketMetadataInventoryTableConfigurationRequest& WithCustomizedAccessLogTag(CustomizedAccessLogTagT&& value) {
  ...
  UpdateBucketMetadataInventoryTableConfigurationRequest& AddCustomizedAccessLogTag(CustomizedAccessLogTagKeyT&& key,
