...
namespace Model
{
  ...
  public:
    ...
    void SetOwner(OwnerT&& value) { m_owner = std::forward<OwnerT>(value); }
    template<typename OwnerT = Owner>
    ...
    void SetGrants(GrantsT&& value) { m_grants = std::forward<GrantsT>(value); }
    template<typename GrantsT = Aws::Vector<Grant>>
    ...
    GetObjectAclResult& AddGrants(GrantsT&& value) { m_grants.emplace_back(std::forward<GrantsT>(value)); return *this; }
    ///@}
