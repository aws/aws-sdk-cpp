...
class NotificationConfigurationDeprecated {
 public:
  ...
  void SetTopicConfiguration(TopicConfigurationT&& value) {
    ...
    m_topicConfiguration = std::forward<TopicConfigurationT>(value);
  }
  template <typename TopicConfigurationT = TopicConfigurationDeprecated>
  NotificationConfigurationDeprecated& WithTopicConfiguration(TopicConfigurationT&& value) {
    SetTopicConfiguration(std::forward<TopicConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetQueueConfiguration(QueueConfigurationT&& value) {
    ...
    m_queueConfiguration = std::forward<QueueConfigurationT>(value);
  }
  template <typename QueueConfigurationT = QueueConfigurationDeprecated>
  NotificationConfigurationDeprecated& WithQueueConfiguration(QueueConfigurationT&& value) {
    SetQueueConfiguration(std::forward<QueueConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCloudFunctionConfiguration(CloudFunctionConfigurationT&& value) {
    ...
    m_cloudFunctionConfiguration = std::forward<CloudFunctionConfigurationT>(value);
  }
  template <typename CloudFunctionConfigurationT = CloudFunctionConfiguration>
  NotificationConfigurationDeprecated& WithCloudFunctionConfiguration(CloudFunctionConfigurationT&& value) {
    SetCloudFunctionConfiguration(std::forward<CloudFunctionConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
