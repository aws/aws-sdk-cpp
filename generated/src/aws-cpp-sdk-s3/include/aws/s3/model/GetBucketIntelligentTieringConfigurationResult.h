...
namespace Model
{
  ...
  public:
    ...
    void SetIntelligentTieringConfiguration(IntelligentTieringConfigurationT&& value) { m_intelligentTieringConfiguration = std::forward<IntelligentTieringConfigurationT>(value); }
    template<typename IntelligentTieringConfigurationT = IntelligentTieringConfiguration>
