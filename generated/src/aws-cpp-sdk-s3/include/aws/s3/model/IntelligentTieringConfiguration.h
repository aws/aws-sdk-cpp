...
class IntelligentTieringConfiguration {
 public:
  ...
  inline void SetStatus(IntelligentTieringStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline IntelligentTieringConfiguration& WithStatus(IntelligentTieringStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
