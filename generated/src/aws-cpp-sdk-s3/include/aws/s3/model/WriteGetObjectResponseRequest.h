...
class WriteGetObjectResponseRequest : public StreamingS3Request {
 public:
  ...
  AWS_S3_API Aws::Vector<smithy::AuthSchemeOption> GetRequestSpecificSupportedAuth() const override;
  ...
  void SetRequestRoute(RequestRouteT&& value) {
    m_requestRouteHasBeenSet = true;
    m_requestRoute = std::forward<RequestRouteT>(value);
  }
  template <typename RequestRouteT = Aws::String>
  WriteGetObjectResponseRequest& WithRequestRoute(RequestRouteT&& value) {
    SetRequestRoute(std::forward<RequestRouteT>(value));
    return *this;
  }
  ///@}
  ...
  inline WriteGetObjectResponseRequest& WithStatusCode(int value) {
    SetStatusCode(value);
    return *this;
  }
  ///@}
  ...
  inline WriteGetObjectResponseRequest& WithContentLength(long long value) {
  ...
  inline WriteGetObjectResponseRequest& WithDeleteMarker(bool value) {
  ...
  inline WriteGetObjectResponseRequest& WithMissingMeta(int value) {
  ...
  inline WriteGetObjectResponseRequest& WithObjectLockMode(ObjectLockMode value) {
  ...
  inline WriteGetObjectResponseRequest& WithObjectLockLegalHoldStatus(ObjectLockLegalHoldStatus value) {
  ...
  inline WriteGetObjectResponseRequest& WithPartsCount(int value) {
    SetPartsCount(value);
    return *this;
  }
  ///@}
  ...
  inline WriteGetObjectResponseRequest& WithReplicationStatus(ReplicationStatus value) {
  ...
  inline WriteGetObjectResponseRequest& WithRequestCharged(RequestCharged value) {
  ...
  inline WriteGetObjectResponseRequest& WithServerSideEncryption(ServerSideEncryption value) {
  ...
  inline WriteGetObjectResponseRequest& WithStorageClass(StorageClass value) {
  ...
  inline WriteGetObjectResponseRequest& WithTagCount(int value) {
    SetTagCount(value);
    return *this;
  }
  ///@}
  ...
  inline WriteGetObjectResponseRequest& WithBucketKeyEnabled(bool value) {
