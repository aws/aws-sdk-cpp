...
class ListBucketIntelligentTieringConfigurationsRequest : public S3Request {
 public:
  ...
  template <typename BucketT = Aws::String>
  ListBucketIntelligentTieringConfigurationsRequest& WithBucket(BucketT&& value) {
  ...
  template <typename ContinuationTokenT = Aws::String>
  ListBucketIntelligentTieringConfigurationsRequest& WithContinuationToken(ContinuationTokenT&& value) {
  ...
  template <typename ExpectedBucketOwnerT = Aws::String>
  ListBucketIntelligentTieringConfigurationsRequest& WithExpectedBucketOwner(ExpectedBucketOwnerT&& value) {
  ...
  template <typename CustomizedAccessLogTagT = Aws::Map<Aws::String, Aws::String>>
  ListBucketIntelligentTieringConfigurationsRequest& WithCustomizedAccessLogTag(CustomizedAccessLogTagT&& value) {
  ...
  ListBucketIntelligentTieringConfigurationsRequest& AddCustomizedAccessLogTag(CustomizedAccessLogTagKeyT&& key,
