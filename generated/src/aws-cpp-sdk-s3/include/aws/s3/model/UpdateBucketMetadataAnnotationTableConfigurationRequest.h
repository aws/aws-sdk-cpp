...
/**
 */
class UpdateBucketMetadataAnnotationTableConfigurationRequest : public S3Request {
 public:
  AWS_S3_API UpdateBucketMetadataAnnotationTableConfigurationRequest() = default;
