...
class AbortMultipartUploadRequest : public S3Request {
 public:
  ...
  inline AbortMultipartUploadRequest& WithRequestPayer(RequestPayer value) {
  ...
  void SetIfMatchInitiatedTime(IfMatchInitiatedTimeT&& value) {
    m_ifMatchInitiatedTimeHasBeenSet = true;
    m_ifMatchInitiatedTime = std::forward<IfMatchInitiatedTimeT>(value);
  }
  template <typename IfMatchInitiatedTimeT = Aws::Utils::DateTime>
  AbortMultipartUploadRequest& WithIfMatchInitiatedTime(IfMatchInitiatedTimeT&& value) {
    SetIfMatchInitiatedTime(std::forward<IfMatchInitiatedTimeT>(value));
    return *this;
  }
  ///@}
