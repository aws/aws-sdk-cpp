...
class PutBucketOwnershipControlsRequest : public S3Request {
 public:
  ...
  void SetOwnershipControls(OwnershipControlsT&& value) {
    ...
    m_ownershipControls = std::forward<OwnershipControlsT>(value);
  }
  template <typename OwnershipControlsT = OwnershipControls>
  PutBucketOwnershipControlsRequest& WithOwnershipControls(OwnershipControlsT&& value) {
    SetOwnershipControls(std::forward<OwnershipControlsT>(value));
    return *this;
  }
  ///@}
   ...
   * <code>x-amz-checksum-<i>algorithm</i> </code> header sent. Otherwise, Amazon S3
   * fails the request with the HTTP status code <code>400 Bad Request</code>. For
  ...
  inline PutBucketOwnershipControlsRequest& WithChecksumAlgorithm(ChecksumAlgorithm value) {
