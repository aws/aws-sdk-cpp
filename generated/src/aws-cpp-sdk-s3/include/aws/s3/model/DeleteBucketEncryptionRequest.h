...
class DeleteBucketEncryptionRequest : public S3Request {
 public:
  ...
  template <typename BucketT = Aws::String>
  DeleteBucketEncryptionRequest& WithBucket(BucketT&& value) {
  ...
  template <typename ExpectedBucketOwnerT = Aws::String>
  DeleteBucketEncryptionRequest& WithExpectedBucketOwner(ExpectedBucketOwnerT&& value) {
  ...
  template <typename CustomizedAccessLogTagT = Aws::Map<Aws::String, Aws::String>>
  DeleteBucketEncryptionRequest& WithCustomizedAccessLogTag(CustomizedAccessLogTagT&& value) {
