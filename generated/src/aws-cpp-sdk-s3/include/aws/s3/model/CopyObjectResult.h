...
namespace Model
{
  ...
  public:
    ...
    void SetCopySourceVersionId(CopySourceVersionIdT&& value) { m_copySourceVersionId = std::forward<CopySourceVersionIdT>(value); }
    template<typename CopySourceVersionIdT = Aws::String>
    ...
    void SetSSEKMSEncryptionContext(SSEKMSEncryptionContextT&& value) { m_sSEKMSEncryptionContext = std::forward<SSEKMSEncryptionContextT>(value); }
    template<typename SSEKMSEncryptionContextT = Aws::String>
    ...
    void SetCopyObjectResultDetails(CopyObjectResultDetailsT&& value) { m_copyObjectResultDetails = std::forward<CopyObjectResultDetailsT>(value); }
    template<typename CopyObjectResultDetailsT = CopyObjectResultDetails>
