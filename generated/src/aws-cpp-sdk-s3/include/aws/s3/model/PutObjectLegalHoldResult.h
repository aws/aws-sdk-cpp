...
namespace Model
{
  ...
  public:
    ...
    inline PutObjectLegalHoldResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline PutObjectLegalHoldResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline PutObjectLegalHoldResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
