...
class PutObjectAnnotationResult {
 public:
  AWS_S3_API PutObjectAnnotationResult() = default;
  AWS_S3_API PutObjectAnnotationResult(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  AWS_S3_API PutObjectAnnotationResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
