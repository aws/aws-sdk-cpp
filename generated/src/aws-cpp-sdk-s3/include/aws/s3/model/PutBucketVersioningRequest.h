...
class PutBucketVersioningRequest : public S3Request {
 public:
  ...
  inline PutBucketVersioningRequest& WithChecksumAlgorithm(ChecksumAlgorithm value) {
  ...
  void SetVersioningConfiguration(VersioningConfigurationT&& value) {
    ...
    m_versioningConfiguration = std::forward<VersioningConfigurationT>(value);
  }
  template <typename VersioningConfigurationT = VersioningConfiguration>
  PutBucketVersioningRequest& WithVersioningConfiguration(VersioningConfigurationT&& value) {
    SetVersioningConfiguration(std::forward<VersioningConfigurationT>(value));
    return *this;
  }
  ///@}
