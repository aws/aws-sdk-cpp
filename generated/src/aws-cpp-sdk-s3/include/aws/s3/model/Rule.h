...
class Rule {
 public:
  ...
  inline void SetStatus(ExpirationStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline Rule& WithStatus(ExpirationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetTransition(TransitionT&& value) {
    ...
    m_transition = std::forward<TransitionT>(value);
  }
  template <typename TransitionT = Transition>
  Rule& WithTransition(TransitionT&& value) {
    SetTransition(std::forward<TransitionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNoncurrentVersionTransition(NoncurrentVersionTransitionT&& value) {
    ...
    m_noncurrentVersionTransition = std::forward<NoncurrentVersionTransitionT>(value);
  }
  template <typename NoncurrentVersionTransitionT = NoncurrentVersionTransition>
  Rule& WithNoncurrentVersionTransition(NoncurrentVersionTransitionT&& value) {
    SetNoncurrentVersionTransition(std::forward<NoncurrentVersionTransitionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNoncurrentVersionExpiration(NoncurrentVersionExpirationT&& value) {
    ...
    m_noncurrentVersionExpiration = std::forward<NoncurrentVersionExpirationT>(value);
  }
  template <typename NoncurrentVersionExpirationT = NoncurrentVersionExpiration>
  Rule& WithNoncurrentVersionExpiration(NoncurrentVersionExpirationT&& value) {
    SetNoncurrentVersionExpiration(std::forward<NoncurrentVersionExpirationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAbortIncompleteMultipartUpload(AbortIncompleteMultipartUploadT&& value) {
    ...
    m_abortIncompleteMultipartUpload = std::forward<AbortIncompleteMultipartUploadT>(value);
  }
  template <typename AbortIncompleteMultipartUploadT = AbortIncompleteMultipartUpload>
  Rule& WithAbortIncompleteMultipartUpload(AbortIncompleteMultipartUploadT&& value) {
    SetAbortIncompleteMultipartUpload(std::forward<AbortIncompleteMultipartUploadT>(value));
    return *this;
  }
  ///@}
 private:
