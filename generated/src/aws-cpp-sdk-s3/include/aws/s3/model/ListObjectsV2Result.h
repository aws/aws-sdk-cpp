...
namespace Model
{
  ...
  public:
    ...
    ListObjectsV2Result& AddContents(ContentsT&& value) { m_contents.emplace_back(std::forward<ContentsT>(value)); return *this; }
    ///@}
    ...
    ListObjectsV2Result& AddCommonPrefixes(CommonPrefixesT&& value) { m_commonPrefixes.emplace_back(std::forward<CommonPrefixesT>(value)); return *this; }
    ///@}
    ...
    void SetStartAfter(StartAfterT&& value) { m_startAfter = std::forward<StartAfterT>(value); }
    template<typename StartAfterT = Aws::String>
