...
class GetBucketInventoryConfigurationRequest : public S3Request {
 public:
  ...
  template <typename BucketT = Aws::String>
  GetBucketInventoryConfigurationRequest& WithBucket(BucketT&& value) {
  ...
  template <typename IdT = Aws::String>
  GetBucketInventoryConfigurationRequest& WithId(IdT&& value) {
  ...
  template <typename ExpectedBucketOwnerT = Aws::String>
  GetBucketInventoryConfigurationRequest& WithExpectedBucketOwner(ExpectedBucketOwnerT&& value) {
  ...
  template <typename CustomizedAccessLogTagT = Aws::Map<Aws::String, Aws::String>>
  GetBucketInventoryConfigurationRequest& WithCustomizedAccessLogTag(CustomizedAccessLogTagT&& value) {
  ...
  GetBucketInventoryConfigurationRequest& AddCustomizedAccessLogTag(CustomizedAccessLogTagKeyT&& key,
