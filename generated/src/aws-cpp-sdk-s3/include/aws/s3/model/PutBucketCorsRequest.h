...
class PutBucketCorsRequest : public S3Request {
 public:
  ...
  template <typename BucketT = Aws::String>
  PutBucketCorsRequest& WithBucket(BucketT&& value) {
  ...
  template <typename CORSConfigurationT = CORSConfiguration>
  PutBucketCorsRequest& WithCORSConfiguration(CORSConfigurationT&& value) {
  ...
  template <typename ContentMD5T = Aws::String>
  PutBucketCorsRequest& WithContentMD5(ContentMD5T&& value) {
  ...
  inline PutBucketCorsRequest& WithChecksumAlgorithm(ChecksumAlgorithm value) {
  ...
  template <typename ExpectedBucketOwnerT = Aws::String>
  PutBucketCorsRequest& WithExpectedBucketOwner(ExpectedBucketOwnerT&& value) {
  ...
  template <typename CustomizedAccessLogTagT = Aws::Map<Aws::String, Aws::String>>
  PutBucketCorsRequest& WithCustomizedAccessLogTag(CustomizedAccessLogTagT&& value) {
