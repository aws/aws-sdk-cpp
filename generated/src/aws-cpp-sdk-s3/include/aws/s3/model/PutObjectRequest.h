...
namespace Model
{
  ...
  public:
     ...
     * for performance.</p>
     */
    inline const ChecksumAlgorithm& GetChecksumAlgorithm() const{ return m_checksumInfo.GetChecksumAlgorithm(); }
    ...
    inline void SetChecksumAlgorithm(const ChecksumAlgorithm& value) { m_checksumInfo.SetChecksumAlgorithm(value); }
    inline void SetChecksumAlgorithm(ChecksumAlgorithm&& value) { m_checksumInfo.SetChecksumAlgorithm(value); }
     ...
     */
    inline const Aws::String& GetChecksumCRC32() const{ return m_checksumInfo.GetChecksumHeader(Client::Checksum::ChecksumAlgorithm::CRC32); }
    ...
    inline void SetChecksumCRC32(const Aws::String& value) { m_checksumInfo.AddChecksumHeader(Aws::Client::Checksum::ChecksumAlgorithm::CRC32, value); }
    inline void SetChecksumCRC32(Aws::String&& value) {  m_checksumInfo.AddChecksumHeader(Aws::Client::Checksum::ChecksumAlgorithm::CRC32, value); }
     ...
     * object integrity</a> in the <i>Amazon S3 User Guide</i>.</p>
     */
    inline const Aws::String& GetChecksumCRC32C() const{ return m_checksumInfo.GetChecksumHeader(Client::Checksum::ChecksumAlgorithm::CRC32C); }
    ...
    inline void SetChecksumCRC32C(const Aws::String& value) {  m_checksumInfo.AddChecksumHeader(Aws::Client::Checksum::ChecksumAlgorithm::CRC32C, value); }
    inline void SetChecksumCRC32C(Aws::String&& value) { m_checksumInfo.AddChecksumHeader(Aws::Client::Checksum::ChecksumAlgorithm::CRC32C, value); }
     ...
     * object integrity</a> in the <i>Amazon S3 User Guide</i>.</p>
     */
    inline const Aws::String& GetChecksumSHA1() const{ return m_checksumInfo.GetChecksumHeader(Client::Checksum::ChecksumAlgorithm::SHA1);; }
    ...
    inline void SetChecksumSHA1(const Aws::String& value) { m_checksumInfo.AddChecksumHeader(Aws::Client::Checksum::ChecksumAlgorithm::SHA1, value); }
    inline void SetChecksumSHA1(Aws::String&& value) { m_checksumInfo.AddChecksumHeader(Aws::Client::Checksum::ChecksumAlgorithm::SHA1, value); }
     ...
     * object integrity</a> in the <i>Amazon S3 User Guide</i>.</p>
     */
    inline const Aws::String& GetChecksumSHA256() const{ return m_checksumInfo.GetChecksumHeader(Client::Checksum::ChecksumAlgorithm::SHA256); }
    ...
    inline void SetChecksumSHA256(const Aws::String& value) { m_checksumInfo.AddChecksumHeader(Aws::Client::Checksum::ChecksumAlgorithm::SHA256, value); }
    inline void SetChecksumSHA256(Aws::String&& value) { m_checksumInfo.AddChecksumHeader(Aws::Client::Checksum::ChecksumAlgorithm::SHA256, value); }
