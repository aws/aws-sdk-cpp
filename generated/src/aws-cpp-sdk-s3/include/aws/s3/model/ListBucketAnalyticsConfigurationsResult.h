...
namespace Model
{
  ...
  public:
    ...
    void SetAnalyticsConfigurationList(AnalyticsConfigurationListT&& value) { m_analyticsConfigurationList = std::forward<AnalyticsConfigurationListT>(value); }
    template<typename AnalyticsConfigurationListT = Aws::Vector<AnalyticsConfiguration>>
    ...
    ListBucketAnalyticsConfigurationsResult& AddAnalyticsConfigurationList(AnalyticsConfigurationListT&& value) { m_analyticsConfigurationList.emplace_back(std::forward<AnalyticsConfigurationListT>(value)); return *this; }
    ///@}
