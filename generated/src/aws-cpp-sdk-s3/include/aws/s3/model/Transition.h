...
class Transition {
 public:
   ...
   * the specified storage class. The value can be <code>0</code> or any positive
   * integer. Be aware that some storage classes have a minimum storage duration and
   * that you're charged for transitioning objects before their minimum storage
   * duration. For more information, see <a
  ...
  inline Transition& WithDays(int value) {
    SetDays(value);
    return *this;
  }
  ///@}
  ...
  inline Transition& WithStorageClass(TransitionStorageClass value) {
