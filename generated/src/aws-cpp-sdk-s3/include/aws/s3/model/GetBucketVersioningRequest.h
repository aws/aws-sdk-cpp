...
class GetBucketVersioningRequest : public S3Request {
 public:
  ...
  template <typename ExpectedBucketOwnerT = Aws::String>
  GetBucketVersioningRequest& WithExpectedBucketOwner(ExpectedBucketOwnerT&& value) {
  ...
  template <typename CustomizedAccessLogTagT = Aws::Map<Aws::String, Aws::String>>
  GetBucketVersioningRequest& WithCustomizedAccessLogTag(CustomizedAccessLogTagT&& value) {
