...
class ListObjectAnnotationsResult {
 public:
  AWS_S3_API ListObjectAnnotationsResult() = default;
  AWS_S3_API ListObjectAnnotationsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  AWS_S3_API ListObjectAnnotationsResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
