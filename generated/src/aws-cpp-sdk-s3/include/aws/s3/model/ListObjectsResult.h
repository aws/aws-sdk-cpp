...
namespace Model
{
  ...
  public:
    ...
    void SetMarker(MarkerT&& value) { m_marker = std::forward<MarkerT>(value); }
    template<typename MarkerT = Aws::String>
    ...
    void SetNextMarker(NextMarkerT&& value) { m_nextMarker = std::forward<NextMarkerT>(value); }
    template<typename NextMarkerT = Aws::String>
    ...
    void SetContents(ContentsT&& value) { m_contents = std::forward<ContentsT>(value); }
    template<typename ContentsT = Aws::Vector<Object>>
    ...
    ListObjectsResult& AddContents(ContentsT&& value) { m_contents.emplace_back(std::forward<ContentsT>(value)); return *this; }
    ///@}
    ...
    ListObjectsResult& AddCommonPrefixes(CommonPrefixesT&& value) { m_commonPrefixes.emplace_back(std::forward<CommonPrefixesT>(value)); return *this; }
    ///@}
