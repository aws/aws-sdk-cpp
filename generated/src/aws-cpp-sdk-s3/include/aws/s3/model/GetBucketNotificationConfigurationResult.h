...
namespace Model
{
  ...
  public:
    ...
    void SetTopicConfigurations(TopicConfigurationsT&& value) { m_topicConfigurations = std::forward<TopicConfigurationsT>(value); }
    template<typename TopicConfigurationsT = Aws::Vector<TopicConfiguration>>
    ...
    GetBucketNotificationConfigurationResult& AddTopicConfigurations(TopicConfigurationsT&& value) { m_topicConfigurations.emplace_back(std::forward<TopicConfigurationsT>(value)); return *this; }
    ///@}
    ...
    void SetQueueConfigurations(QueueConfigurationsT&& value) { m_queueConfigurations = std::forward<QueueConfigurationsT>(value); }
    template<typename QueueConfigurationsT = Aws::Vector<QueueConfiguration>>
    ...
    GetBucketNotificationConfigurationResult& AddQueueConfigurations(QueueConfigurationsT&& value) { m_queueConfigurations.emplace_back(std::forward<QueueConfigurationsT>(value)); return *this; }
    ///@}
    ...
    void SetLambdaFunctionConfigurations(LambdaFunctionConfigurationsT&& value) { m_lambdaFunctionConfigurations = std::forward<LambdaFunctionConfigurationsT>(value); }
    template<typename LambdaFunctionConfigurationsT = Aws::Vector<LambdaFunctionConfiguration>>
    ...
    GetBucketNotificationConfigurationResult& AddLambdaFunctionConfigurations(LambdaFunctionConfigurationsT&& value) { m_lambdaFunctionConfigurations.emplace_back(std::forward<LambdaFunctionConfigurationsT>(value)); return *this; }
    ///@}
    ...
    void SetEventBridgeConfiguration(EventBridgeConfigurationT&& value) { m_eventBridgeConfiguration = std::forward<EventBridgeConfigurationT>(value); }
    template<typename EventBridgeConfigurationT = EventBridgeConfiguration>
