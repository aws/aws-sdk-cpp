...
/**
 * <p>Specifies the default server-side encryption configuration.</p>  <ul> <li>
 * <p> <b>General purpose buckets</b> - If you're specifying a customer managed KMS
 ...
 * requester, and not the bucket owner.</p> </li> <li> <p> <b>Directory buckets</b>
...
class ServerSideEncryptionRule {
 public:
   ...
   * <code>true</code> causes Amazon S3 to use an S3 Bucket Key. </p>  <ul> <li> <p>
   * <b>General purpose buckets</b> - By default, S3 Bucket Key is not enabled. For
   ...
   * or unblocking SSE-C for a general purpose bucket</a>.</p>  <p>Currently, this
   * parameter only supports blocking or unblocking server-side encryption with
