...
namespace Model
{
  ...
  public:
    ...
    void SetRedirectAllRequestsTo(RedirectAllRequestsToT&& value) { m_redirectAllRequestsTo = std::forward<RedirectAllRequestsToT>(value); }
    template<typename RedirectAllRequestsToT = RedirectAllRequestsTo>
    ...
    void SetIndexDocument(IndexDocumentT&& value) { m_indexDocument = std::forward<IndexDocumentT>(value); }
    template<typename IndexDocumentT = IndexDocument>
    ...
    void SetErrorDocument(ErrorDocumentT&& value) { m_errorDocument = std::forward<ErrorDocumentT>(value); }
    template<typename ErrorDocumentT = ErrorDocument>
    ...
    void SetRoutingRules(RoutingRulesT&& value) { m_routingRules = std::forward<RoutingRulesT>(value); }
    template<typename RoutingRulesT = Aws::Vector<RoutingRule>>
    ...
    GetBucketWebsiteResult& AddRoutingRules(RoutingRulesT&& value) { m_routingRules.emplace_back(std::forward<RoutingRulesT>(value)); return *this; }
    ///@}
