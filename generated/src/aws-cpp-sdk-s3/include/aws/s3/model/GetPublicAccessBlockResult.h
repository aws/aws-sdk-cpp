...
class GetPublicAccessBlockResult {
 public:
  ...
  template <typename PublicAccessBlockConfigurationT = PublicAccessBlockConfiguration>
  GetPublicAccessBlockResult& WithPublicAccessBlockConfiguration(PublicAccessBlockConfigurationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetPublicAccessBlockResult& WithRequestId(RequestIdT&& value) {
