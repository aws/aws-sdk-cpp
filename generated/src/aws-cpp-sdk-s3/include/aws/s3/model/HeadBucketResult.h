...
namespace Model
{
  ...
  public:
    ...
    inline void SetBucketLocationType(LocationType value) { m_bucketLocationType = value; }
    ...
    void SetBucketLocationName(BucketLocationNameT&& value) { m_bucketLocationName = std::forward<BucketLocationNameT>(value); }
    template<typename BucketLocationNameT = Aws::String>
    ...
    void SetBucketRegion(BucketRegionT&& value) { m_bucketRegion = std::forward<BucketRegionT>(value); }
    template<typename BucketRegionT = Aws::String>
