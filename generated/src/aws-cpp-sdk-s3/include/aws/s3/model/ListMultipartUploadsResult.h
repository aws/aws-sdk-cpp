...
namespace Model
{
  ...
  public:
    ...
    void SetBucket(BucketT&& value) { m_bucket = std::forward<BucketT>(value); }
    template<typename BucketT = Aws::String>
    ...
    void SetKeyMarker(KeyMarkerT&& value) { m_keyMarker = std::forward<KeyMarkerT>(value); }
    template<typename KeyMarkerT = Aws::String>
    ...
    void SetUploadIdMarker(UploadIdMarkerT&& value) { m_uploadIdMarker = std::forward<UploadIdMarkerT>(value); }
    template<typename UploadIdMarkerT = Aws::String>
    ...
    void SetNextKeyMarker(NextKeyMarkerT&& value) { m_nextKeyMarker = std::forward<NextKeyMarkerT>(value); }
    template<typename NextKeyMarkerT = Aws::String>
    ...
    void SetPrefix(PrefixT&& value) { m_prefix = std::forward<PrefixT>(value); }
    template<typename PrefixT = Aws::String>
    ...
    void SetDelimiter(DelimiterT&& value) { m_delimiter = std::forward<DelimiterT>(value); }
    template<typename DelimiterT = Aws::String>
    ...
    void SetNextUploadIdMarker(NextUploadIdMarkerT&& value) { m_nextUploadIdMarker = std::forward<NextUploadIdMarkerT>(value); }
    template<typename NextUploadIdMarkerT = Aws::String>
    ...
    void SetUploads(UploadsT&& value) { m_uploads = std::forward<UploadsT>(value); }
    template<typename UploadsT = Aws::Vector<MultipartUpload>>
    ...
    ListMultipartUploadsResult& AddUploads(UploadsT&& value) { m_uploads.emplace_back(std::forward<UploadsT>(value)); return *this; }
    ///@}
    ...
    void SetCommonPrefixes(CommonPrefixesT&& value) { m_commonPrefixes = std::forward<CommonPrefixesT>(value); }
    template<typename CommonPrefixesT = Aws::Vector<CommonPrefix>>
    ...
    ListMultipartUploadsResult& AddCommonPrefixes(CommonPrefixesT&& value) { m_commonPrefixes.emplace_back(std::forward<CommonPrefixesT>(value)); return *this; }
    ///@}
