...
class DeletedObject {
 public:
  ...
  template <typename KeyT = Aws::String>
  DeletedObject& WithKey(KeyT&& value) {
  ...
  template <typename VersionIdT = Aws::String>
  DeletedObject& WithVersionId(VersionIdT&& value) {
  ...
  inline DeletedObject& WithDeleteMarker(bool value) {
  ...
  void SetDeleteMarkerVersionId(DeleteMarkerVersionIdT&& value) {
    m_deleteMarkerVersionIdHasBeenSet = true;
    m_deleteMarkerVersionId = std::forward<DeleteMarkerVersionIdT>(value);
  }
  template <typename DeleteMarkerVersionIdT = Aws::String>
  DeletedObject& WithDeleteMarkerVersionId(DeleteMarkerVersionIdT&& value) {
    SetDeleteMarkerVersionId(std::forward<DeleteMarkerVersionIdT>(value));
    return *this;
  }
  ///@}
 private:
