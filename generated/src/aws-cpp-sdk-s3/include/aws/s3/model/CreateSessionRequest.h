...
class CreateSessionRequest : public S3Request {
 public:
  ...
  inline void SetSessionMode(SessionMode value) {
    m_sessionModeHasBeenSet = true;
    m_sessionMode = value;
  }
  inline CreateSessionRequest& WithSessionMode(SessionMode value) {
  ...
  inline CreateSessionRequest& WithServerSideEncryption(ServerSideEncryption value) {
  ...
  inline CreateSessionRequest& WithBucketKeyEnabled(bool value) {
