...
class GetBucketOwnershipControlsRequest : public S3Request {
 public:
  ...
  template <typename BucketT = Aws::String>
  GetBucketOwnershipControlsRequest& WithBucket(BucketT&& value) {
  ...
  template <typename ExpectedBucketOwnerT = Aws::String>
  GetBucketOwnershipControlsRequest& WithExpectedBucketOwner(ExpectedBucketOwnerT&& value) {
  ...
  template <typename CustomizedAccessLogTagT = Aws::Map<Aws::String, Aws::String>>
  GetBucketOwnershipControlsRequest& WithCustomizedAccessLogTag(CustomizedAccessLogTagT&& value) {
