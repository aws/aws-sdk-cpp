...
class MetadataConfiguration {
 public:
  ...
  void SetInventoryTableConfiguration(InventoryTableConfigurationT&& value) {
    ...
    m_inventoryTableConfiguration = std::forward<InventoryTableConfigurationT>(value);
  }
  template <typename InventoryTableConfigurationT = InventoryTableConfiguration>
  MetadataConfiguration& WithInventoryTableConfiguration(InventoryTableConfigurationT&& value) {
    SetInventoryTableConfiguration(std::forward<InventoryTableConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
