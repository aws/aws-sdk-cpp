...
class UploadPartCopyRequest : public S3Request {
 public:
  ...
  void SetCopySourceRange(CopySourceRangeT&& value) {
    m_copySourceRangeHasBeenSet = true;
    m_copySourceRange = std::forward<CopySourceRangeT>(value);
  }
  template <typename CopySourceRangeT = Aws::String>
  UploadPartCopyRequest& WithCopySourceRange(CopySourceRangeT&& value) {
    SetCopySourceRange(std::forward<CopySourceRangeT>(value));
    return *this;
  }
  ///@}
  ...
  inline UploadPartCopyRequest& WithPartNumber(int value) {
    SetPartNumber(value);
    return *this;
  }
  ///@}
  ...
  inline UploadPartCopyRequest& WithRequestPayer(RequestPayer value) {
