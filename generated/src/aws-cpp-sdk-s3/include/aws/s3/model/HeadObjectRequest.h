...
class HeadObjectRequest : public S3Request {
 public:
  ...
  inline HeadObjectRequest& WithRequestPayer(RequestPayer value) {
  ...
  inline HeadObjectRequest& WithPartNumber(int value) {
    SetPartNumber(value);
    return *this;
  }
  ///@}
  ...
  inline HeadObjectRequest& WithChecksumMode(ChecksumMode value) {
