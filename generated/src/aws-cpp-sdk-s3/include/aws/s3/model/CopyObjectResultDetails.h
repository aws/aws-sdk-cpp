...
class CopyObjectResultDetails {
 public:
  ...
  inline CopyObjectResultDetails& WithChecksumType(ChecksumType value) {
   ...
   * checksum is only present if the object was uploaded with the <code>SHA512</code>
  ...
  template <typename ChecksumSHA512T = Aws::String>
  CopyObjectResultDetails& WithChecksumSHA512(ChecksumSHA512T&& value) {
   ...
   * checksum is only present if the object was uploaded with the <code>MD5</code>
   * checksum algorithm. For more information, see <a
   * href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html">Checking
   * object integrity</a> in the <i>Amazon S3 User Guide</i>.</p>
   */
  ...
  template <typename ChecksumMD5T = Aws::String>
  CopyObjectResultDetails& WithChecksumMD5(ChecksumMD5T&& value) {
  ...
  template <typename ChecksumXXHASH64T = Aws::String>
  CopyObjectResultDetails& WithChecksumXXHASH64(ChecksumXXHASH64T&& value) {
  ...
  template <typename ChecksumXXHASH3T = Aws::String>
  CopyObjectResultDetails& WithChecksumXXHASH3(ChecksumXXHASH3T&& value) {
   ...
   * This checksum is only present if the object was uploaded with the
  ...
  template <typename ChecksumXXHASH128T = Aws::String>
  CopyObjectResultDetails& WithChecksumXXHASH128(ChecksumXXHASH128T&& value) {
