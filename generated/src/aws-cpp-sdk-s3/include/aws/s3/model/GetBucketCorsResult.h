...
namespace Model
{
  ...
  public:
    ...
    void SetCORSRules(CORSRulesT&& value) { m_cORSRules = std::forward<CORSRulesT>(value); }
    template<typename CORSRulesT = Aws::Vector<CORSRule>>
    ...
    GetBucketCorsResult& AddCORSRules(CORSRulesT&& value) { m_cORSRules.emplace_back(std::forward<CORSRulesT>(value)); return *this; }
    ///@}
