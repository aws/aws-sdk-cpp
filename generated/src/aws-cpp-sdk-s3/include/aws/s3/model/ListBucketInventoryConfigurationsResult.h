...
namespace Model
{
  ...
  public:
    ...
    void SetInventoryConfigurationList(InventoryConfigurationListT&& value) { m_inventoryConfigurationList = std::forward<InventoryConfigurationListT>(value); }
    template<typename InventoryConfigurationListT = Aws::Vector<InventoryConfiguration>>
    ...
    ListBucketInventoryConfigurationsResult& AddInventoryConfigurationList(InventoryConfigurationListT&& value) { m_inventoryConfigurationList.emplace_back(std::forward<InventoryConfigurationListT>(value)); return *this; }
    ///@}
