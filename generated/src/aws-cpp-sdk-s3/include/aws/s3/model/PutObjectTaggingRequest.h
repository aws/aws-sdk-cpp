...
class PutObjectTaggingRequest : public S3Request {
 public:
  ...
  template <typename BucketT = Aws::String>
  PutObjectTaggingRequest& WithBucket(BucketT&& value) {
  ...
  template <typename KeyT = Aws::String>
  PutObjectTaggingRequest& WithKey(KeyT&& value) {
  ...
  template <typename VersionIdT = Aws::String>
  PutObjectTaggingRequest& WithVersionId(VersionIdT&& value) {
  ...
  template <typename ContentMD5T = Aws::String>
  PutObjectTaggingRequest& WithContentMD5(ContentMD5T&& value) {
  ...
  inline PutObjectTaggingRequest& WithChecksumAlgorithm(ChecksumAlgorithm value) {
  ...
  template <typename TaggingT = Tagging>
  PutObjectTaggingRequest& WithTagging(TaggingT&& value) {
  ...
  template <typename ExpectedBucketOwnerT = Aws::String>
  PutObjectTaggingRequest& WithExpectedBucketOwner(ExpectedBucketOwnerT&& value) {
  ...
  inline PutObjectTaggingRequest& WithRequestPayer(RequestPayer value) {
  ...
  template <typename CustomizedAccessLogTagT = Aws::Map<Aws::String, Aws::String>>
  PutObjectTaggingRequest& WithCustomizedAccessLogTag(CustomizedAccessLogTagT&& value) {
