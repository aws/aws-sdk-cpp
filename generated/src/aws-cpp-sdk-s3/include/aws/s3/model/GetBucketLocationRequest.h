...
class GetBucketLocationRequest : public S3Request {
 public:
  ...
  template <typename BucketT = Aws::String>
  GetBucketLocationRequest& WithBucket(BucketT&& value) {
  ...
  template <typename ExpectedBucketOwnerT = Aws::String>
  GetBucketLocationRequest& WithExpectedBucketOwner(ExpectedBucketOwnerT&& value) {
  ...
  template <typename CustomizedAccessLogTagT = Aws::Map<Aws::String, Aws::String>>
  GetBucketLocationRequest& WithCustomizedAccessLogTag(CustomizedAccessLogTagT&& value) {
