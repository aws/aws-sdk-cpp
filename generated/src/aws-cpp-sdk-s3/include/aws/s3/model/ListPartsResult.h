...
namespace Model
{
  ...
  public:
    ...
    void SetParts(PartsT&& value) { m_parts = std::forward<PartsT>(value); }
    template<typename PartsT = Aws::Vector<Part>>
    ListPartsResult& WithParts(PartsT&& value) { SetParts(std::forward<PartsT>(value)); return *this;}
    template<typename PartsT = Part>
    ListPartsResult& AddParts(PartsT&& value) { m_parts.emplace_back(std::forward<PartsT>(value)); return *this; }
    ///@}
    ...
    void SetInitiator(InitiatorT&& value) { m_initiator = std::forward<InitiatorT>(value); }
    template<typename InitiatorT = Initiator>
