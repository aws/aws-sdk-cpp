...
class GetBucketAbacResult {
 public:
  AWS_S3_API GetBucketAbacResult() = default;
  AWS_S3_API GetBucketAbacResult(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  AWS_S3_API GetBucketAbacResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
