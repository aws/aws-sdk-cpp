...
class ListObjectsRequest : public S3Request {
 public:
  ...
  inline ListObjectsRequest& WithEncodingType(EncodingType value) {
  ...
  inline ListObjectsRequest& WithMaxKeys(int value) {
    SetMaxKeys(value);
    return *this;
  }
  ///@}
  ...
  inline ListObjectsRequest& WithRequestPayer(RequestPayer value) {
  ...
  inline ListObjectsRequest& AddOptionalObjectAttributes(OptionalObjectAttributes value) {
    m_optionalObjectAttributesHasBeenSet = true;
