...
namespace Model
{
  ...
  public:
    ...
    void SetAcceptRanges(AcceptRangesT&& value) { m_acceptRanges = std::forward<AcceptRangesT>(value); }
    template<typename AcceptRangesT = Aws::String>
    ...
    void SetExpiration(ExpirationT&& value) { m_expiration = std::forward<ExpirationT>(value); }
    template<typename ExpirationT = Aws::String>
    ...
    void SetRestore(RestoreT&& value) { m_restore = std::forward<RestoreT>(value); }
    template<typename RestoreT = Aws::String>
    ...
    void SetLastModified(LastModifiedT&& value) { m_lastModified = std::forward<LastModifiedT>(value); }
    template<typename LastModifiedT = Aws::Utils::DateTime>
    ...
    void SetETag(ETagT&& value) { m_eTag = std::forward<ETagT>(value); }
    template<typename ETagT = Aws::String>
    ...
    void SetChecksumCRC32(ChecksumCRC32T&& value) { m_checksumCRC32 = std::forward<ChecksumCRC32T>(value); }
    template<typename ChecksumCRC32T = Aws::String>
    ...
    void SetChecksumCRC32C(ChecksumCRC32CT&& value) { m_checksumCRC32C = std::forward<ChecksumCRC32CT>(value); }
    template<typename ChecksumCRC32CT = Aws::String>
    ...
    void SetChecksumCRC64NVME(ChecksumCRC64NVMET&& value) { m_checksumCRC64NVME = std::forward<ChecksumCRC64NVMET>(value); }
    template<typename ChecksumCRC64NVMET = Aws::String>
    ...
    void SetChecksumSHA1(ChecksumSHA1T&& value) { m_checksumSHA1 = std::forward<ChecksumSHA1T>(value); }
    template<typename ChecksumSHA1T = Aws::String>
    ...
    void SetChecksumSHA256(ChecksumSHA256T&& value) { m_checksumSHA256 = std::forward<ChecksumSHA256T>(value); }
    template<typename ChecksumSHA256T = Aws::String>
    ...
    inline void SetChecksumType(ChecksumType value) { m_checksumType = value; }
    ...
    void SetCacheControl(CacheControlT&& value) { m_cacheControl = std::forward<CacheControlT>(value); }
    template<typename CacheControlT = Aws::String>
    ...
    void SetContentDisposition(ContentDispositionT&& value) { m_contentDisposition = std::forward<ContentDispositionT>(value); }
    template<typename ContentDispositionT = Aws::String>
    ...
    void SetContentEncoding(ContentEncodingT&& value) { m_contentEncoding = std::forward<ContentEncodingT>(value); }
    template<typename ContentEncodingT = Aws::String>
    ...
    void SetContentLanguage(ContentLanguageT&& value) { m_contentLanguage = std::forward<ContentLanguageT>(value); }
    template<typename ContentLanguageT = Aws::String>
    ...
    void SetContentRange(ContentRangeT&& value) { m_contentRange = std::forward<ContentRangeT>(value); }
    template<typename ContentRangeT = Aws::String>
    ...
    void SetContentType(ContentTypeT&& value) { m_contentType = std::forward<ContentTypeT>(value); }
    template<typename ContentTypeT = Aws::String>
    ...
    void SetExpires(ExpiresT&& value) { m_expires = std::forward<ExpiresT>(value); }
    template<typename ExpiresT = Aws::Utils::DateTime>
    ...
    void SetWebsiteRedirectLocation(WebsiteRedirectLocationT&& value) { m_websiteRedirectLocation = std::forward<WebsiteRedirectLocationT>(value); }
    template<typename WebsiteRedirectLocationT = Aws::String>
    ...
    void SetMetadata(MetadataT&& value) { m_metadata = std::forward<MetadataT>(value); }
    template<typename MetadataT = Aws::Map<Aws::String, Aws::String>>
    ...
    GetObjectResult& AddMetadata(MetadataKeyT&& key, MetadataValueT&& value) {
      m_metadata.emplace(std::forward<MetadataKeyT>(key), std::forward<MetadataValueT>(value)); return *this;
    }
    ///@}
    ...
    void SetSSECustomerAlgorithm(SSECustomerAlgorithmT&& value) { m_sSECustomerAlgorithm = std::forward<SSECustomerAlgorithmT>(value); }
    template<typename SSECustomerAlgorithmT = Aws::String>
    ...
    void SetSSECustomerKeyMD5(SSECustomerKeyMD5T&& value) { m_sSECustomerKeyMD5 = std::forward<SSECustomerKeyMD5T>(value); }
    template<typename SSECustomerKeyMD5T = Aws::String>
    ...
    void SetSSEKMSKeyId(SSEKMSKeyIdT&& value) { m_sSEKMSKeyId = std::forward<SSEKMSKeyIdT>(value); }
    template<typename SSEKMSKeyIdT = Aws::String>
    ...
    inline void SetObjectLockMode(ObjectLockMode value) { m_objectLockMode = value; }
    ...
    void SetObjectLockRetainUntilDate(ObjectLockRetainUntilDateT&& value) { m_objectLockRetainUntilDate = std::forward<ObjectLockRetainUntilDateT>(value); }
    template<typename ObjectLockRetainUntilDateT = Aws::Utils::DateTime>
    ...
    inline void SetObjectLockLegalHoldStatus(ObjectLockLegalHoldStatus value) { m_objectLockLegalHoldStatus = value; }
    ...
    void SetId2(Id2T&& value) { m_id2 = std::forward<Id2T>(value); }
    template<typename Id2T = Aws::String>
    ...
    void SetExpiresString(ExpiresStringT&& value) { m_expiresString = std::forward<ExpiresStringT>(value); }
    template<typename ExpiresStringT = Aws::String>
