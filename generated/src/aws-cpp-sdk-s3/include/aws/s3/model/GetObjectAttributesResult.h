...
namespace Model
{
  ...
  public:
    ...
    void SetChecksum(ChecksumT&& value) { m_checksum = std::forward<ChecksumT>(value); }
    template<typename ChecksumT = Checksum>
    ...
    void SetObjectParts(ObjectPartsT&& value) { m_objectParts = std::forward<ObjectPartsT>(value); }
    template<typename ObjectPartsT = GetObjectAttributesParts>
