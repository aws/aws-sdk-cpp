...
namespace Model
{
  ...
  public:
    ...
    void SetDeleted(DeletedT&& value) { m_deleted = std::forward<DeletedT>(value); }
    template<typename DeletedT = Aws::Vector<DeletedObject>>
    ...
    DeleteObjectsResult& AddDeleted(DeletedT&& value) { m_deleted.emplace_back(std::forward<DeletedT>(value)); return *this; }
    ///@}
    ...
    void SetErrors(ErrorsT&& value) { m_errors = std::forward<ErrorsT>(value); }
    template<typename ErrorsT = Aws::Vector<Error>>
    ...
    DeleteObjectsResult& AddErrors(ErrorsT&& value) { m_errors.emplace_back(std::forward<ErrorsT>(value)); return *this; }
    ///@}
