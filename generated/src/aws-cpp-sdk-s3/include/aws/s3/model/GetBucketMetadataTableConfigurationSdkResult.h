...
namespace Model
{
  ...
  public:
    ...
    void SetGetBucketMetadataTableConfigurationResult(GetBucketMetadataTableConfigurationResultT&& value) { m_getBucketMetadataTableConfigurationResult = std::forward<GetBucketMetadataTableConfigurationResultT>(value); }
    template<typename GetBucketMetadataTableConfigurationResultT = GetBucketMetadataTableConfigurationResult>
