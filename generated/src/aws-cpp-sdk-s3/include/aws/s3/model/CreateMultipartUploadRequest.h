...
class CreateMultipartUploadRequest : public S3Request {
 public:
  ...
  inline CreateMultipartUploadRequest& WithACL(ObjectCannedACL value) {
    SetACL(value);
    return *this;
  }
  ///@}
  ...
  inline CreateMultipartUploadRequest& WithServerSideEncryption(ServerSideEncryption value) {
  ...
  inline CreateMultipartUploadRequest& WithStorageClass(StorageClass value) {
  ...
  inline CreateMultipartUploadRequest& WithRequestPayer(RequestPayer value) {
  ...
  inline CreateMultipartUploadRequest& WithObjectLockMode(ObjectLockMode value) {
  ...
  inline CreateMultipartUploadRequest& WithObjectLockLegalHoldStatus(ObjectLockLegalHoldStatus value) {
   ...
   * You cannot specify a duration in both days and years.</p>  <p>This functionality
  ...
  inline CreateMultipartUploadRequest& WithChecksumAlgorithm(ChecksumAlgorithm value) {
  ...
  inline CreateMultipartUploadRequest& WithChecksumType(ChecksumType value) {
