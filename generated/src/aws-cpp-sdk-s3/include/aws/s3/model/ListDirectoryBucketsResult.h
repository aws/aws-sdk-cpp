...
class ListDirectoryBucketsResult {
 public:
  ...
  template <typename BucketsT = Aws::Vector<Bucket>>
  ListDirectoryBucketsResult& WithBuckets(BucketsT&& value) {
    SetBuckets(std::forward<BucketsT>(value));
    return *this;
  }
  template <typename BucketsT = Bucket>
  ListDirectoryBucketsResult& AddBuckets(BucketsT&& value) {
    m_bucketsHasBeenSet = true;
  ...
  template <typename ContinuationTokenT = Aws::String>
  ListDirectoryBucketsResult& WithContinuationToken(ContinuationTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDirectoryBucketsResult& WithRequestId(RequestIdT&& value) {
