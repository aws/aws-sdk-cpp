...
namespace Model
{
  ...
  public:
    ...
    void SetBuckets(BucketsT&& value) { m_buckets = std::forward<BucketsT>(value); }
    template<typename BucketsT = Aws::Vector<Bucket>>
    ...
    ListDirectoryBucketsResult& AddBuckets(BucketsT&& value) { m_buckets.emplace_back(std::forward<BucketsT>(value)); return *this; }
    ///@}
    ...
    void SetContinuationToken(ContinuationTokenT&& value) { m_continuationToken = std::forward<ContinuationTokenT>(value); }
    template<typename ContinuationTokenT = Aws::String>
