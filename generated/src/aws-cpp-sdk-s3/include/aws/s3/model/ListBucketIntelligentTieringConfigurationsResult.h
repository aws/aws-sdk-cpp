...
namespace Model
{
  ...
  public:
    ...
    void SetNextContinuationToken(NextContinuationTokenT&& value) { m_nextContinuationToken = std::forward<NextContinuationTokenT>(value); }
    template<typename NextContinuationTokenT = Aws::String>
    ...
    void SetIntelligentTieringConfigurationList(IntelligentTieringConfigurationListT&& value) { m_intelligentTieringConfigurationList = std::forward<IntelligentTieringConfigurationListT>(value); }
    template<typename IntelligentTieringConfigurationListT = Aws::Vector<IntelligentTieringConfiguration>>
    ...
    ListBucketIntelligentTieringConfigurationsResult& AddIntelligentTieringConfigurationList(IntelligentTieringConfigurationListT&& value) { m_intelligentTieringConfigurationList.emplace_back(std::forward<IntelligentTieringConfigurationListT>(value)); return *this; }
    ///@}
