...
class ScanRange {
 public:
  ...
  inline void SetStart(long long value) {
    m_startHasBeenSet = true;
    m_start = value;
  }
  inline ScanRange& WithStart(long long value) {
    SetStart(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEnd(long long value) {
    m_endHasBeenSet = true;
    m_end = value;
  }
  inline ScanRange& WithEnd(long long value) {
    SetEnd(value);
    return *this;
  }
  ///@}
