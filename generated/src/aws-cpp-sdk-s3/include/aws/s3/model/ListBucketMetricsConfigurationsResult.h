...
namespace Model
{
  ...
  public:
    ...
    void SetMetricsConfigurationList(MetricsConfigurationListT&& value) { m_metricsConfigurationList = std::forward<MetricsConfigurationListT>(value); }
    template<typename MetricsConfigurationListT = Aws::Vector<MetricsConfiguration>>
    ...
    ListBucketMetricsConfigurationsResult& AddMetricsConfigurationList(MetricsConfigurationListT&& value) { m_metricsConfigurationList.emplace_back(std::forward<MetricsConfigurationListT>(value)); return *this; }
    ///@}
