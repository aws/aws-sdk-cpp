...
Aws::String GetBucketTaggingRequest::SerializePayload() const { return {}; }
...
void GetBucketTaggingRequest::AddQueryStringParameters(Aws::Http::URI& uri) const {
  Aws::StringStream ss;
...
bool GetBucketTaggingRequest::HasEmbeddedError(Aws::IOStream& body, const Aws::Http::HeaderValueCollection& header) const {
