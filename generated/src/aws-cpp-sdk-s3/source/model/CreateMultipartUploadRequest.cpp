...
Aws::String CreateMultipartUploadRequest::SerializePayload() const { return {}; }
...
Aws::Http::HeaderValueCollection CreateMultipartUploadRequest::GetRequestSpecificHeaders() const {
  ...
  if (m_objectLockLegalHoldStatusHasBeenSet && m_objectLockLegalHoldStatus != ObjectLockLegalHoldStatus::NOT_SET) {
    headers.emplace("x-amz-object-lock-legal-hold",
...
void CreateMultipartUploadRequest::AddQueryStringParameters(Aws::Http::URI& uri) const {
  Aws::StringStream ss;
...
bool CreateMultipartUploadRequest::HasEmbeddedError(Aws::IOStream& body, const Aws::Http::HeaderValueCollection& header) const {
