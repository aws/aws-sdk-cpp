...
Aws::String GetObjectLegalHoldRequest::SerializePayload() const { return {}; }
...
void GetObjectLegalHoldRequest::AddQueryStringParameters(Aws::Http::URI& uri) const {
  Aws::StringStream ss;
...
bool GetObjectLegalHoldRequest::HasEmbeddedError(Aws::IOStream& body, const Aws::Http::HeaderValueCollection& header) const {
