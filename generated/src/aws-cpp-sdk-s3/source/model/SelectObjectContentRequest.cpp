...
Aws::String SelectObjectContentRequest::SerializePayload() const { return {}; }
...
void SelectObjectContentRequest::AddQueryStringParameters(Aws::Http::URI& uri) const {
  Aws::StringStream ss;
...
bool SelectObjectContentRequest::HasEmbeddedError(Aws::IOStream& body, const Aws::Http::HeaderValueCollection& header) const {
