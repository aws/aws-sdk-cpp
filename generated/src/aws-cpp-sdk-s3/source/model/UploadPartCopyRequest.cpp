...
Aws::String UploadPartCopyRequest::SerializePayload() const { return {}; }
...
void UploadPartCopyRequest::AddQueryStringParameters(Aws::Http::URI& uri) const {
  Aws::StringStream ss;
...
bool UploadPartCopyRequest::HasEmbeddedError(Aws::IOStream& body, const Aws::Http::HeaderValueCollection& header) const {
