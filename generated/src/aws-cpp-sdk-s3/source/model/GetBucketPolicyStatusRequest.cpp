...
Aws::String GetBucketPolicyStatusRequest::SerializePayload() const { return {}; }
...
void GetBucketPolicyStatusRequest::AddQueryStringParameters(Aws::Http::URI& uri) const {
  Aws::StringStream ss;
...
bool GetBucketPolicyStatusRequest::HasEmbeddedError(Aws::IOStream& body, const Aws::Http::HeaderValueCollection& header) const {
