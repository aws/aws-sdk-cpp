...
Aws::String PutBucketLoggingRequest::SerializePayload() const { return {}; }
...
void PutBucketLoggingRequest::AddQueryStringParameters(Aws::Http::URI& uri) const {
  Aws::StringStream ss;
...
bool PutBucketLoggingRequest::HasEmbeddedError(Aws::IOStream& body, const Aws::Http::HeaderValueCollection& header) const {
