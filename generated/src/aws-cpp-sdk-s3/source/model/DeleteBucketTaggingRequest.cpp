...
Aws::String DeleteBucketTaggingRequest::SerializePayload() const { return {}; }
...
void DeleteBucketTaggingRequest::AddQueryStringParameters(Aws::Http::URI& uri) const {
  Aws::StringStream ss;
...
bool DeleteBucketTaggingRequest::HasEmbeddedError(Aws::IOStream& body, const Aws::Http::HeaderValueCollection& header) const {
