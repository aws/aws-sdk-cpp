...
Aws::String PutBucketCorsRequest::SerializePayload() const { return {}; }
...
void PutBucketCorsRequest::AddQueryStringParameters(Aws::Http::URI& uri) const {
  Aws::StringStream ss;
...
bool PutBucketCorsRequest::HasEmbeddedError(Aws::IOStream& body, const Aws::Http::HeaderValueCollection& header) const {
