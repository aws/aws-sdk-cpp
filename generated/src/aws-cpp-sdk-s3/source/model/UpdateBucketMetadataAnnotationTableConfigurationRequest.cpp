...
Aws::String UpdateBucketMetadataAnnotationTableConfigurationRequest::SerializePayload() const {
  XmlDocument payloadDoc = XmlDocument::CreateWithRootNode("AnnotationTableConfiguration");
...
void UpdateBucketMetadataAnnotationTableConfigurationRequest::AddQueryStringParameters(URI& uri) const {
  Aws::StringStream ss;
...
Aws::Http::HeaderValueCollection UpdateBucketMetadataAnnotationTableConfigurationRequest::GetRequestSpecificHeaders() const {
...
UpdateBucketMetadataAnnotationTableConfigurationRequest::EndpointParameters
UpdateBucketMetadataAnnotationTableConfigurationRequest::GetEndpointContextParams() const {
...
Aws::String UpdateBucketMetadataAnnotationTableConfigurationRequest::GetChecksumAlgorithmName() const {
