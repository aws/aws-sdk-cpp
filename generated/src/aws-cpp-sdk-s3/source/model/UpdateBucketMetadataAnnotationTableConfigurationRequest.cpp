...
Aws::String UpdateBucketMetadataAnnotationTableConfigurationRequest::SerializePayload() const { return {}; }
...
void UpdateBucketMetadataAnnotationTableConfigurationRequest::AddQueryStringParameters(Aws::Http::URI& uri) const {
  Aws::StringStream ss;
