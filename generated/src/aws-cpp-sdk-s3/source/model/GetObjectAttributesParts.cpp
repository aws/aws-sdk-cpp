...
GetObjectAttributesParts::GetObjectAttributesParts(const XmlNode& xmlNode) { *this = xmlNode; }
...
GetObjectAttributesParts& GetObjectAttributesParts::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!totalPartsCountNode.IsNull()) {
      m_totalPartsCount = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(totalPartsCountNode.GetText()).c_str()).c_str());
    ...
    if (!partNumberMarkerNode.IsNull()) {
      m_partNumberMarker = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(partNumberMarkerNode.GetText()).c_str()).c_str());
    ...
    if (!nextPartNumberMarkerNode.IsNull()) {
      m_nextPartNumberMarker = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(nextPartNumberMarkerNode.GetText()).c_str()).c_str());
      m_nextPartNumberMarkerHasBeenSet = true;
    }
    XmlNode maxPartsNode = resultNode.FirstChild("MaxParts");
    if (!maxPartsNode.IsNull()) {
      m_maxParts =
          StringUtils::ConvertToInt32(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(maxPartsNode.GetText()).c_str()).c_str());
