...
Aws::String PutBucketIntelligentTieringConfigurationRequest::SerializePayload() const { return {}; }
...
void PutBucketIntelligentTieringConfigurationRequest::AddQueryStringParameters(Aws::Http::URI& uri) const {
  Aws::StringStream ss;
  if (m_idHasBeenSet) {
    ss << m_id;
