...
Aws::String ListBucketIntelligentTieringConfigurationsRequest::SerializePayload() const { return {}; }
...
void ListBucketIntelligentTieringConfigurationsRequest::AddQueryStringParameters(Aws::Http::URI& uri) const {
  Aws::StringStream ss;
...
ListBucketIntelligentTieringConfigurationsRequest::EndpointParameters
ListBucketIntelligentTieringConfigurationsRequest::GetEndpointContextParams() const {
