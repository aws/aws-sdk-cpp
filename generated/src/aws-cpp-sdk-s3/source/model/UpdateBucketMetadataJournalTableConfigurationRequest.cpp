...
Aws::String UpdateBucketMetadataJournalTableConfigurationRequest::SerializePayload() const { return {}; }
...
void UpdateBucketMetadataJournalTableConfigurationRequest::AddQueryStringParameters(Aws::Http::URI& uri) const {
  Aws::StringStream ss;
...
UpdateBucketMetadataJournalTableConfigurationRequest::EndpointParameters
UpdateBucketMetadataJournalTableConfigurationRequest::GetEndpointContextParams() const {
