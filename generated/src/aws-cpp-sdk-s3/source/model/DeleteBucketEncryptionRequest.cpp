...
Aws::String DeleteBucketEncryptionRequest::SerializePayload() const { return {}; }
...
void DeleteBucketEncryptionRequest::AddQueryStringParameters(Aws::Http::URI& uri) const {
  Aws::StringStream ss;
...
bool DeleteBucketEncryptionRequest::HasEmbeddedError(Aws::IOStream& body, const Aws::Http::HeaderValueCollection& header) const {
