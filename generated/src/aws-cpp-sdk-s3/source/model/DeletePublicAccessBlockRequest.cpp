...
Aws::String DeletePublicAccessBlockRequest::SerializePayload() const { return {}; }
...
void DeletePublicAccessBlockRequest::AddQueryStringParameters(Aws::Http::URI& uri) const {
  Aws::StringStream ss;
...
bool DeletePublicAccessBlockRequest::HasEmbeddedError(Aws::IOStream& body, const Aws::Http::HeaderValueCollection& header) const {
