...
Aws::String PutBucketNotificationConfigurationRequest::SerializePayload() const { return {}; }
...
void PutBucketNotificationConfigurationRequest::AddQueryStringParameters(Aws::Http::URI& uri) const {
  Aws::StringStream ss;
