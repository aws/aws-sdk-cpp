...
Aws::String GetObjectTaggingRequest::SerializePayload() const { return {}; }
...
void GetObjectTaggingRequest::AddQueryStringParameters(Aws::Http::URI& uri) const {
  Aws::StringStream ss;
...
bool GetObjectTaggingRequest::HasEmbeddedError(Aws::IOStream& body, const Aws::Http::HeaderValueCollection& header) const {
