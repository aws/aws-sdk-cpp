...
Aws::String PutBucketOwnershipControlsRequest::SerializePayload() const { return {}; }
...
void PutBucketOwnershipControlsRequest::AddQueryStringParameters(Aws::Http::URI& uri) const {
  Aws::StringStream ss;
