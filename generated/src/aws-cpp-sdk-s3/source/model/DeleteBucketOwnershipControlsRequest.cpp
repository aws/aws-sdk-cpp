...
Aws::String DeleteBucketOwnershipControlsRequest::SerializePayload() const { return {}; }
...
void DeleteBucketOwnershipControlsRequest::AddQueryStringParameters(Aws::Http::URI& uri) const {
  Aws::StringStream ss;
...
bool DeleteBucketOwnershipControlsRequest::HasEmbeddedError(Aws::IOStream& body, const Aws::Http::HeaderValueCollection& header) const {
