...
Aws::String PutBucketWebsiteRequest::SerializePayload() const { return {}; }
...
void PutBucketWebsiteRequest::AddQueryStringParameters(Aws::Http::URI& uri) const {
  Aws::StringStream ss;
...
bool PutBucketWebsiteRequest::HasEmbeddedError(Aws::IOStream& body, const Aws::Http::HeaderValueCollection& header) const {
