...
Aws::String GetBucketCorsRequest::SerializePayload() const { return {}; }
...
void GetBucketCorsRequest::AddQueryStringParameters(Aws::Http::URI& uri) const {
  Aws::StringStream ss;
...
bool GetBucketCorsRequest::HasEmbeddedError(Aws::IOStream& body, const Aws::Http::HeaderValueCollection& header) const {
