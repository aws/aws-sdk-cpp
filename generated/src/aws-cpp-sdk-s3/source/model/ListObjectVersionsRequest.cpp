...
Aws::String ListObjectVersionsRequest::SerializePayload() const { return {}; }
...
void ListObjectVersionsRequest::AddQueryStringParameters(Aws::Http::URI& uri) const {
  Aws::StringStream ss;
...
bool ListObjectVersionsRequest::HasEmbeddedError(Aws::IOStream& body, const Aws::Http::HeaderValueCollection& header) const {
