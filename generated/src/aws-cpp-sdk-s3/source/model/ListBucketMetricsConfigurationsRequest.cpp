...
Aws::String ListBucketMetricsConfigurationsRequest::SerializePayload() const { return {}; }
...
void ListBucketMetricsConfigurationsRequest::AddQueryStringParameters(Aws::Http::URI& uri) const {
  Aws::StringStream ss;
...
bool ListBucketMetricsConfigurationsRequest::HasEmbeddedError(Aws::IOStream& body, const Aws::Http::HeaderValueCollection& header) const {
