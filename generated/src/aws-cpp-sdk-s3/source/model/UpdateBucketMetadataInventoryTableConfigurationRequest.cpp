...
Aws::String UpdateBucketMetadataInventoryTableConfigurationRequest::SerializePayload() const
{
  XmlDocument payloadDoc = XmlDocument::CreateWithRootNode("InventoryTableConfiguration");
...
void UpdateBucketMetadataInventoryTableConfigurationRequest::AddQueryStringParameters(URI& uri) const
{
    Aws::StringStream ss;
...
Aws::Http::HeaderValueCollection UpdateBucketMetadataInventoryTableConfigurationRequest::GetRequestSpecificHeaders() const
{
...
UpdateBucketMetadataInventoryTableConfigurationRequest::EndpointParameters UpdateBucketMetadataInventoryTableConfigurationRequest::GetEndpointContextParams() const
{
...
Aws::String UpdateBucketMetadataInventoryTableConfigurationRequest::GetChecksumAlgorithmName() const
{
