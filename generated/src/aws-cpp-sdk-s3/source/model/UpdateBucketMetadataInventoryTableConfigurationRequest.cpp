...
Aws::String UpdateBucketMetadataInventoryTableConfigurationRequest::SerializePayload() const { return {}; }
...
void UpdateBucketMetadataInventoryTableConfigurationRequest::AddQueryStringParameters(Aws::Http::URI& uri) const {
  Aws::StringStream ss;
