...
Aws::String GetObjectRetentionRequest::SerializePayload() const { return {}; }
...
void GetObjectRetentionRequest::AddQueryStringParameters(Aws::Http::URI& uri) const {
  Aws::StringStream ss;
...
bool GetObjectRetentionRequest::HasEmbeddedError(Aws::IOStream& body, const Aws::Http::HeaderValueCollection& header) const {
