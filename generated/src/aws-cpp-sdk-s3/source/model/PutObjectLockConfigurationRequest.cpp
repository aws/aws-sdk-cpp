...
Aws::String PutObjectLockConfigurationRequest::SerializePayload() const { return {}; }
...
void PutObjectLockConfigurationRequest::AddQueryStringParameters(Aws::Http::URI& uri) const {
  Aws::StringStream ss;
...
bool PutObjectLockConfigurationRequest::HasEmbeddedError(Aws::IOStream& body, const Aws::Http::HeaderValueCollection& header) const {
