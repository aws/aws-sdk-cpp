...
Aws::String PutBucketMetricsConfigurationRequest::SerializePayload() const { return {}; }
...
void PutBucketMetricsConfigurationRequest::AddQueryStringParameters(Aws::Http::URI& uri) const {
  Aws::StringStream ss;
  if (m_idHasBeenSet) {
    ss << m_id;
