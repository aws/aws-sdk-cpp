...
Aws::String GetBucketRequestPaymentRequest::SerializePayload() const { return {}; }
...
void GetBucketRequestPaymentRequest::AddQueryStringParameters(Aws::Http::URI& uri) const {
  Aws::StringStream ss;
...
bool GetBucketRequestPaymentRequest::HasEmbeddedError(Aws::IOStream& body, const Aws::Http::HeaderValueCollection& header) const {
