...
Aws::String PutObjectTaggingRequest::SerializePayload() const { return {}; }
...
void PutObjectTaggingRequest::AddQueryStringParameters(Aws::Http::URI& uri) const {
  Aws::StringStream ss;
...
bool PutObjectTaggingRequest::HasEmbeddedError(Aws::IOStream& body, const Aws::Http::HeaderValueCollection& header) const {
