...
Aws::String PutBucketAccelerateConfigurationRequest::SerializePayload() const { return {}; }
...
void PutBucketAccelerateConfigurationRequest::AddQueryStringParameters(Aws::Http::URI& uri) const {
  Aws::StringStream ss;
...
bool PutBucketAccelerateConfigurationRequest::HasEmbeddedError(Aws::IOStream& body, const Aws::Http::HeaderValueCollection& header) const {
