...
Aws::String PutObjectRetentionRequest::SerializePayload() const { return {}; }
...
void PutObjectRetentionRequest::AddQueryStringParameters(Aws::Http::URI& uri) const {
  Aws::StringStream ss;
...
bool PutObjectRetentionRequest::HasEmbeddedError(Aws::IOStream& body, const Aws::Http::HeaderValueCollection& header) const {
