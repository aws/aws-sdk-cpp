...
Aws::String GetBucketLifecycleConfigurationRequest::SerializePayload() const { return {}; }
...
void GetBucketLifecycleConfigurationRequest::AddQueryStringParameters(Aws::Http::URI& uri) const {
  Aws::StringStream ss;
...
bool GetBucketLifecycleConfigurationRequest::HasEmbeddedError(Aws::IOStream& body, const Aws::Http::HeaderValueCollection& header) const {
