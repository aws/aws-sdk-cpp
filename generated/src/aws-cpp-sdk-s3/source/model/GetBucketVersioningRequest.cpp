...
Aws::String GetBucketVersioningRequest::SerializePayload() const { return {}; }
...
void GetBucketVersioningRequest::AddQueryStringParameters(Aws::Http::URI& uri) const {
  Aws::StringStream ss;
...
bool GetBucketVersioningRequest::HasEmbeddedError(Aws::IOStream& body, const Aws::Http::HeaderValueCollection& header) const {
