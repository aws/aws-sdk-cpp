...
Aws::String GetBucketPolicyRequest::SerializePayload() const { return {}; }
...
void GetBucketPolicyRequest::AddQueryStringParameters(Aws::Http::URI& uri) const {
  Aws::StringStream ss;
...
bool GetBucketPolicyRequest::HasEmbeddedError(Aws::IOStream& body, const Aws::Http::HeaderValueCollection& header) const {
