...
Aws::String HeadObjectRequest::SerializePayload() const { return {}; }
...
void HeadObjectRequest::AddQueryStringParameters(Aws::Http::URI& uri) const {
  Aws::StringStream ss;
...
bool HeadObjectRequest::HasEmbeddedError(Aws::IOStream& body, const Aws::Http::HeaderValueCollection& header) const {
