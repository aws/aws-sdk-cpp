...
ObjectStorageClass GetObjectStorageClassForName(const Aws::String& name) {
  ...
  if (hashCode == STANDARD_HASH) {
    ...
    return ObjectStorageClass::FSX_ONTAP;
  } else if (hashCode == AWS_BACKUP_WARM_HASH) {
    return ObjectStorageClass::AWS_BACKUP_WARM;
  } else if (hashCode == AWS_BACKUP_LOW_COST_WARM_HASH) {
    return ObjectStorageClass::AWS_BACKUP_LOW_COST_WARM;
  }
...
Aws::String GetNameForObjectStorageClass(ObjectStorageClass enumValue) {
  switch (enumValue) {
    ...
    case ObjectStorageClass::FSX_OPENZFS:
      return "FSX_OPENZFS";
    case ObjectStorageClass::FSX_ONTAP:
      return "FSX_ONTAP";
    case ObjectStorageClass::AWS_BACKUP_WARM:
      return "AWS_BACKUP_WARM";
    case ObjectStorageClass::AWS_BACKUP_LOW_COST_WARM:
