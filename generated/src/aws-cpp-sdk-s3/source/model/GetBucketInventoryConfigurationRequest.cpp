...
Aws::String GetBucketInventoryConfigurationRequest::SerializePayload() const { return {}; }
...
void GetBucketInventoryConfigurationRequest::AddQueryStringParameters(Aws::Http::URI& uri) const {
  Aws::StringStream ss;
  if (m_idHasBeenSet) {
    ss << m_id;
...
bool GetBucketInventoryConfigurationRequest::HasEmbeddedError(Aws::IOStream& body, const Aws::Http::HeaderValueCollection& header) const {
