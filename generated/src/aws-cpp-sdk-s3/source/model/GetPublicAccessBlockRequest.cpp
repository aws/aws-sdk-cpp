...
Aws::String GetPublicAccessBlockRequest::SerializePayload() const { return {}; }
...
void GetPublicAccessBlockRequest::AddQueryStringParameters(Aws::Http::URI& uri) const {
  Aws::StringStream ss;
...
bool GetPublicAccessBlockRequest::HasEmbeddedError(Aws::IOStream& body, const Aws::Http::HeaderValueCollection& header) const {
