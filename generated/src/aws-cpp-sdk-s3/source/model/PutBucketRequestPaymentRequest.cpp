...
Aws::String PutBucketRequestPaymentRequest::SerializePayload() const { return {}; }
...
void PutBucketRequestPaymentRequest::AddQueryStringParameters(Aws::Http::URI& uri) const {
  Aws::StringStream ss;
