...
Aws::String GetBucketReplicationRequest::SerializePayload() const { return {}; }
...
void GetBucketReplicationRequest::AddQueryStringParameters(Aws::Http::URI& uri) const {
  Aws::StringStream ss;
...
bool GetBucketReplicationRequest::HasEmbeddedError(Aws::IOStream& body, const Aws::Http::HeaderValueCollection& header) const {
