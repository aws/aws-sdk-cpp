...
Aws::Http::HeaderValueCollection PutObjectAnnotationRequest::GetRequestSpecificHeaders() const {
...
void PutObjectAnnotationRequest::AddQueryStringParameters(Aws::Http::URI& uri) const {
  Aws::StringStream ss;
...
Aws::String PutObjectAnnotationRequest::GetChecksumAlgorithmName() const {
...
PutObjectAnnotationRequest::EndpointParameters PutObjectAnnotationRequest::GetEndpointContextParams() const {
