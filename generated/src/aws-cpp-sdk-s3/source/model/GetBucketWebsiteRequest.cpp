...
Aws::String GetBucketWebsiteRequest::SerializePayload() const { return {}; }
...
void GetBucketWebsiteRequest::AddQueryStringParameters(Aws::Http::URI& uri) const {
  Aws::StringStream ss;
...
bool GetBucketWebsiteRequest::HasEmbeddedError(Aws::IOStream& body, const Aws::Http::HeaderValueCollection& header) const {
