...
Aws::String CreateBucketMetadataTableConfigurationRequest::SerializePayload() const { return {}; }
...
void CreateBucketMetadataTableConfigurationRequest::AddQueryStringParameters(Aws::Http::URI& uri) const {
  Aws::StringStream ss;
