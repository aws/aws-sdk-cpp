...
Aws::String GetObjectAttributesRequest::SerializePayload() const { return {}; }
...
Aws::Http::HeaderValueCollection GetObjectAttributesRequest::GetRequestSpecificHeaders() const {
  ...
  if (m_objectAttributesHasBeenSet) {
    headers.emplace("x-amz-object-attributes", std::accumulate(std::begin(m_objectAttributes), std::end(m_objectAttributes), Aws::String{},
                                                               [](const Aws::String& acc, const ObjectAttributes& item) -> Aws::String {
                                                                 const auto headerValue =
                                                                     ObjectAttributesMapper::GetNameForObjectAttributes(item);
...
void GetObjectAttributesRequest::AddQueryStringParameters(Aws::Http::URI& uri) const {
  Aws::StringStream ss;
...
bool GetObjectAttributesRequest::HasEmbeddedError(Aws::IOStream& body, const Aws::Http::HeaderValueCollection& header) const {
