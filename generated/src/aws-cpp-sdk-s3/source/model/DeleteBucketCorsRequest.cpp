...
Aws::String DeleteBucketCorsRequest::SerializePayload() const { return {}; }
...
void DeleteBucketCorsRequest::AddQueryStringParameters(Aws::Http::URI& uri) const {
  Aws::StringStream ss;
...
bool DeleteBucketCorsRequest::HasEmbeddedError(Aws::IOStream& body, const Aws::Http::HeaderValueCollection& header) const {
