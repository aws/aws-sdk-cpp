...
Aws::String GetBucketNotificationConfigurationRequest::SerializePayload() const { return {}; }
...
void GetBucketNotificationConfigurationRequest::AddQueryStringParameters(Aws::Http::URI& uri) const {
  Aws::StringStream ss;
...
bool GetBucketNotificationConfigurationRequest::HasEmbeddedError(Aws::IOStream& body,
