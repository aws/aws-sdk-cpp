...
Aws::String ListObjectsRequest::SerializePayload() const { return {}; }
...
void ListObjectsRequest::AddQueryStringParameters(Aws::Http::URI& uri) const {
  Aws::StringStream ss;
...
bool ListObjectsRequest::HasEmbeddedError(Aws::IOStream& body, const Aws::Http::HeaderValueCollection& header) const {
