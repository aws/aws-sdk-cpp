...
Aws::String CreateBucketMetadataConfigurationRequest::SerializePayload() const { return {}; }
...
void CreateBucketMetadataConfigurationRequest::AddQueryStringParameters(Aws::Http::URI& uri) const {
  Aws::StringStream ss;
