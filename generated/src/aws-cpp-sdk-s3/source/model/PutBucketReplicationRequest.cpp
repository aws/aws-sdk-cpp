...
Aws::String PutBucketReplicationRequest::SerializePayload() const { return {}; }
...
void PutBucketReplicationRequest::AddQueryStringParameters(Aws::Http::URI& uri) const {
  Aws::StringStream ss;
...
bool PutBucketReplicationRequest::HasEmbeddedError(Aws::IOStream& body, const Aws::Http::HeaderValueCollection& header) const {
