...
bool PutBucketReplicationRequest::HasEmbeddedError(Aws::IOStream &body,
...
Aws::Crt::Optional<Aws::Client::Checksum::ChecksumInfo> PutBucketReplicationRequest::GetChecksumInfo() const
{
