...
BucketLocationConstraint GetBucketLocationConstraintForName(const Aws::String& name) {
  ...
  if (hashCode == af_south_1_HASH) {
    ...
    return BucketLocationConstraint::ap_east_2;
    ...
    return BucketLocationConstraint::mx_central_1;
...
Aws::String GetNameForBucketLocationConstraint(BucketLocationConstraint enumValue) {
  switch (enumValue) {
    ...
    case BucketLocationConstraint::ap_east_1:
      return "ap-east-1";
    case BucketLocationConstraint::ap_east_2:
      return "ap-east-2";
    ...
    case BucketLocationConstraint::ap_southeast_6:
      return "ap-southeast-6";
    case BucketLocationConstraint::ap_southeast_7:
      return "ap-southeast-7";
    case BucketLocationConstraint::ca_central_1:
      return "ca-central-1";
    case BucketLocationConstraint::ca_west_1:
      return "ca-west-1";
    ...
    case BucketLocationConstraint::me_south_1:
      return "me-south-1";
    case BucketLocationConstraint::mx_central_1:
      return "mx-central-1";
