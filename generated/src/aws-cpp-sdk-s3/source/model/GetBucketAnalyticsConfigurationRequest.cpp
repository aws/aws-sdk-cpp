...
Aws::String GetBucketAnalyticsConfigurationRequest::SerializePayload() const { return {}; }
...
void GetBucketAnalyticsConfigurationRequest::AddQueryStringParameters(Aws::Http::URI& uri) const {
  Aws::StringStream ss;
  if (m_idHasBeenSet) {
    ss << m_id;
...
bool GetBucketAnalyticsConfigurationRequest::HasEmbeddedError(Aws::IOStream& body, const Aws::Http::HeaderValueCollection& header) const {
