...
const S3ClientContextParameters::ClientContextParameters::EndpointParameter& S3ClientContextParameters::GetDisableMultiRegionAccessPoints()
    const {
  return GetParameter("DisableMultiRegionAccessPoints");
}
void S3ClientContextParameters::SetUseArnRegion(bool value) { return SetBooleanParameter(Aws::String("UseArnRegion"), value); }
...
void S3ClientContextParameters::SetAccelerate(bool value) { return SetBooleanParameter(Aws::String("Accelerate"), value); }
...
const S3ClientContextParameters::ClientContextParameters::EndpointParameter& S3ClientContextParameters::GetDisableS3ExpressSessionAuth()
    const {
...
void S3BuiltInParameters::SetServiceSpecificParameters(const S3ClientConfiguration& config) {
