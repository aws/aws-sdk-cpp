...
namespace Invoicing
{
   ...
   */
  class AWS_INVOICING_API InvoicingClient : Aws::Client::ClientWithAsyncTemplateMethods<InvoicingClient>,
    smithy::client::AwsSmithyClientT<Aws::Invoicing::SERVICE_NAME,
