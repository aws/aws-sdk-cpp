...
class UpdateInvoiceUnitResult {
 public:
  AWS_INVOICING_API UpdateInvoiceUnitResult() = default;
  ...
  template <typename InvoiceUnitArnT = Aws::String>
  UpdateInvoiceUnitResult& WithInvoiceUnitArn(InvoiceUnitArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateInvoiceUnitResult& WithRequestId(RequestIdT&& value) {
