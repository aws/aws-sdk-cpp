...
class Filters {
 public:
  ...
  void SetInvoiceReceivers(InvoiceReceiversT&& value) {
    m_invoiceReceiversHasBeenSet = true;
    m_invoiceReceivers = std::forward<InvoiceReceiversT>(value);
  }
  template <typename InvoiceReceiversT = Aws::Vector<Aws::String>>
  Filters& WithInvoiceReceivers(InvoiceReceiversT&& value) {
    SetInvoiceReceivers(std::forward<InvoiceReceiversT>(value));
    return *this;
  }
  template <typename InvoiceReceiversT = Aws::String>
  Filters& AddInvoiceReceivers(InvoiceReceiversT&& value) {
    m_invoiceReceiversHasBeenSet = true;
    m_invoiceReceivers.emplace_back(std::forward<InvoiceReceiversT>(value));
    return *this;
  }
  ///@}
