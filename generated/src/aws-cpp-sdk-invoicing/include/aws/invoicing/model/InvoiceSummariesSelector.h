...
class InvoiceSummariesSelector {
 public:
  ...
  inline void SetResourceType(ListInvoiceSummariesResourceType value) {
    m_resourceTypeHasBeenSet = true;
    m_resourceType = value;
  }
  inline InvoiceSummariesSelector& WithResourceType(ListInvoiceSummariesResourceType value) {
