...
class CurrencyExchangeDetails {
 public:
  ...
  void SetSourceCurrencyCode(SourceCurrencyCodeT&& value) {
    ...
    m_sourceCurrencyCode = std::forward<SourceCurrencyCodeT>(value);
  }
  template <typename SourceCurrencyCodeT = Aws::String>
  CurrencyExchangeDetails& WithSourceCurrencyCode(SourceCurrencyCodeT&& value) {
    SetSourceCurrencyCode(std::forward<SourceCurrencyCodeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTargetCurrencyCode(TargetCurrencyCodeT&& value) {
    ...
    m_targetCurrencyCode = std::forward<TargetCurrencyCodeT>(value);
  }
  template <typename TargetCurrencyCodeT = Aws::String>
  CurrencyExchangeDetails& WithTargetCurrencyCode(TargetCurrencyCodeT&& value) {
    SetTargetCurrencyCode(std::forward<TargetCurrencyCodeT>(value));
    return *this;
  }
  ///@}
