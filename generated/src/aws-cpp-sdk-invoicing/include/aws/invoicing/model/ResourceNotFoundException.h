...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/invoicing-2024-12-01/ResourceNotFoundException">AWS
   * API Reference</a></p>
   */
  class ResourceNotFoundException
  {
  public:
    AWS_INVOICING_API ResourceNotFoundException() = default;
    AWS_INVOICING_API ResourceNotFoundException(Aws::Utils::Json::JsonView jsonValue);
