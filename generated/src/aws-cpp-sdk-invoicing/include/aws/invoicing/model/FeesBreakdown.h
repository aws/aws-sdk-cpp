...
namespace Model
{
  ...
  public:
    ...
    template<typename BreakdownT = Aws::Vector<FeesBreakdownAmount>>
    FeesBreakdown& WithBreakdown(BreakdownT&& value) { SetBreakdown(std::forward<BreakdownT>(value)); return *this;}
    template<typename BreakdownT = FeesBreakdownAmount>
    FeesBreakdown& AddBreakdown(BreakdownT&& value) { m_breakdownHasBeenSet = true; m_breakdown.emplace_back(std::forward<BreakdownT>(value)); return *this; }
    ///@}
    ...
    template<typename TotalAmountT = Aws::String>
    FeesBreakdown& WithTotalAmount(TotalAmountT&& value) { SetTotalAmount(std::forward<TotalAmountT>(value)); return *this;}
    ///@}
  private:
