...
namespace Invoicing {
namespace Model {
class DeleteProcurementPortalPreferenceResult {
 public:
  AWS_INVOICING_API DeleteProcurementPortalPreferenceResult() = default;
  AWS_INVOICING_API DeleteProcurementPortalPreferenceResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_INVOICING_API DeleteProcurementPortalPreferenceResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);

  ///@{
  /**
   * <p>The Amazon Resource Name (ARN) of the deleted procurement portal
   * preference.</p>
   */
  ...
  template <typename ProcurementPortalPreferenceArnT = Aws::String>
  DeleteProcurementPortalPreferenceResult& WithProcurementPortalPreferenceArn(ProcurementPortalPreferenceArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteProcurementPortalPreferenceResult& WithRequestId(RequestIdT&& value) {
