...
namespace Model
{
  ...
  public:
    ...
    template<typename DescriptionT = Aws::String>
    FeesBreakdownAmount& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename AmountT = Aws::String>
    FeesBreakdownAmount& WithAmount(AmountT&& value) { SetAmount(std::forward<AmountT>(value)); return *this;}
    ///@}
    ...
    template<typename RateT = Aws::String>
    FeesBreakdownAmount& WithRate(RateT&& value) { SetRate(std::forward<RateT>(value)); return *this;}
    ///@}
  private:
