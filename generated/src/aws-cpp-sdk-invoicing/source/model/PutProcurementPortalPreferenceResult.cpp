...
PutProcurementPortalPreferenceResult::PutProcurementPortalPreferenceResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

PutProcurementPortalPreferenceResult& PutProcurementPortalPreferenceResult::operator=(
