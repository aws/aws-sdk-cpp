...
VerifyProcurementPortalValidationResult::VerifyProcurementPortalValidationResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

VerifyProcurementPortalValidationResult& VerifyProcurementPortalValidationResult::operator=(
