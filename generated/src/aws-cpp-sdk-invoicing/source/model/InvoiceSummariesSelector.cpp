...
InvoiceSummariesSelector::InvoiceSummariesSelector(JsonView jsonValue) { *this = jsonValue; }

InvoiceSummariesSelector& InvoiceSummariesSelector::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("ResourceType")) {
    m_resourceType =
        ListInvoiceSummariesResourceTypeMapper::GetListInvoiceSummariesResourceTypeForName(jsonValue.GetString("ResourceType"));
