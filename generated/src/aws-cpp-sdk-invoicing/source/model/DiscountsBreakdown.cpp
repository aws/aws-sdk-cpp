...
DiscountsBreakdown::DiscountsBreakdown(JsonView jsonValue) { *this = jsonValue; }

DiscountsBreakdown& DiscountsBreakdown::operator=(JsonView jsonValue) {
...
JsonValue DiscountsBreakdown::Jsonize() const {
  JsonValue payload;
