...
TaxesBreakdown::TaxesBreakdown(JsonView jsonValue) { *this = jsonValue; }

TaxesBreakdown& TaxesBreakdown::operator=(JsonView jsonValue) {
...
JsonValue TaxesBreakdown::Jsonize() const {
  JsonValue payload;
