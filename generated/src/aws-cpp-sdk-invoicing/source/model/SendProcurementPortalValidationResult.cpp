...
SendProcurementPortalValidationResult::SendProcurementPortalValidationResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

SendProcurementPortalValidationResult& SendProcurementPortalValidationResult::operator=(
