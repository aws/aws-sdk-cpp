...
template <>
AWS_INVOICING_API InternalServerException InvoicingError::GetModeledError() {
  assert(this->GetErrorType() == InvoicingErrors::INTERNAL_SERVER);
  return InternalServerException(this->GetJsonPayload().View());
}

template <>
AWS_INVOICING_API ValidationException InvoicingError::GetModeledError() {
  assert(this->GetErrorType() == InvoicingErrors::VALIDATION);
  return ValidationException(this->GetJsonPayload().View());
}

template <>
AWS_INVOICING_API AccessDeniedException InvoicingError::GetModeledError() {
