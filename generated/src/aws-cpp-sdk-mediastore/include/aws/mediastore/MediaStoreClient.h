...
namespace MediaStore
{
   ...
   */
  class AWS_MEDIASTORE_API MediaStoreClient : Aws::Client::ClientWithAsyncTemplateMethods<MediaStoreClient>,
    smithy::client::AwsSmithyClientT<Aws::MediaStore::SERVICE_NAME,
