...
class MetricPolicy {
 public:
  ...
  inline void SetContainerLevelMetrics(ContainerLevelMetrics value) {
    m_containerLevelMetricsHasBeenSet = true;
    m_containerLevelMetrics = value;
  }
  inline MetricPolicy& WithContainerLevelMetrics(ContainerLevelMetrics value) {
    SetContainerLevelMetrics(value);
    return *this;
  }
  ///@}
  ...
  void SetMetricPolicyRules(MetricPolicyRulesT&& value) {
    ...
    m_metricPolicyRules = std::forward<MetricPolicyRulesT>(value);
  }
  template <typename MetricPolicyRulesT = Aws::Vector<MetricPolicyRule>>
  MetricPolicy& WithMetricPolicyRules(MetricPolicyRulesT&& value) {
    SetMetricPolicyRules(std::forward<MetricPolicyRulesT>(value));
    return *this;
  }
  template <typename MetricPolicyRulesT = MetricPolicyRule>
  MetricPolicy& AddMetricPolicyRules(MetricPolicyRulesT&& value) {
    m_metricPolicyRulesHasBeenSet = true;
    m_metricPolicyRules.emplace_back(std::forward<MetricPolicyRulesT>(value));
    return *this;
  }
  ///@}
 private:
