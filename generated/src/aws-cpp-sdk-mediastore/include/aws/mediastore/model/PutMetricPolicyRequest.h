...
class PutMetricPolicyRequest : public MediaStoreRequest {
 public:
  ...
  template <typename ContainerNameT = Aws::String>
  PutMetricPolicyRequest& WithContainerName(ContainerNameT&& value) {
  ...
  void SetMetricPolicy(MetricPolicyT&& value) {
    m_metricPolicyHasBeenSet = true;
    m_metricPolicy = std::forward<MetricPolicyT>(value);
  }
  template <typename MetricPolicyT = MetricPolicy>
  PutMetricPolicyRequest& WithMetricPolicy(MetricPolicyT&& value) {
    SetMetricPolicy(std::forward<MetricPolicyT>(value));
    return *this;
  }
  ///@}
 private:
