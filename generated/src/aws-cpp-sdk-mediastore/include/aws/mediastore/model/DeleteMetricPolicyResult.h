...
namespace Model
{
  ...
  public:
    ...
    inline DeleteMetricPolicyResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeleteMetricPolicyResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeleteMetricPolicyResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
