...
class MetricPolicyRule {
 public:
  ...
  void SetObjectGroup(ObjectGroupT&& value) {
    ...
    m_objectGroup = std::forward<ObjectGroupT>(value);
  }
  template <typename ObjectGroupT = Aws::String>
  MetricPolicyRule& WithObjectGroup(ObjectGroupT&& value) {
    SetObjectGroup(std::forward<ObjectGroupT>(value));
    return *this;
  }
  ///@}
  ...
  void SetObjectGroupName(ObjectGroupNameT&& value) {
    ...
    m_objectGroupName = std::forward<ObjectGroupNameT>(value);
  }
  template <typename ObjectGroupNameT = Aws::String>
  MetricPolicyRule& WithObjectGroupName(ObjectGroupNameT&& value) {
    SetObjectGroupName(std::forward<ObjectGroupNameT>(value));
    return *this;
  }
  ///@}
 private:
