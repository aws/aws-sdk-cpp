...
namespace Model
{
  ...
  /**
   */
  class GetContainerPolicyRequest : public MediaStoreRequest
  {
  public:
    AWS_MEDIASTORE_API GetContainerPolicyRequest() = default;
    ...
    template<typename ContainerNameT = Aws::String>
    GetContainerPolicyRequest& WithContainerName(ContainerNameT&& value) { SetContainerName(std::forward<ContainerNameT>(value)); return *this;}
    ///@}
  private:
