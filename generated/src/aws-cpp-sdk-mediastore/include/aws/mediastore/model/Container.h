...
class Container {
 public:
  ...
  inline void SetStatus(ContainerStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline Container& WithStatus(ContainerStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAccessLoggingEnabled(bool value) {
    m_accessLoggingEnabledHasBeenSet = true;
    m_accessLoggingEnabled = value;
  }
  inline Container& WithAccessLoggingEnabled(bool value) {
    SetAccessLoggingEnabled(value);
    return *this;
  }
  ///@}
 private:
