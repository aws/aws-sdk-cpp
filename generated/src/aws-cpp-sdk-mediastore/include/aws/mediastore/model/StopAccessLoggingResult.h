...
namespace Model
{
  ...
  public:
    ...
    inline StopAccessLoggingResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline StopAccessLoggingResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline StopAccessLoggingResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
