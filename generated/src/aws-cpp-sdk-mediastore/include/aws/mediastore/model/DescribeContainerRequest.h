...
namespace Model
{
  ...
  {
  public:
    AWS_MEDIASTORE_API DescribeContainerRequest() = default;
    ...
    template<typename ContainerNameT = Aws::String>
    DescribeContainerRequest& WithContainerName(ContainerNameT&& value) { SetContainerName(std::forward<ContainerNameT>(value)); return *this;}
    ///@}
  private:
