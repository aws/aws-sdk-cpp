...
class GetCorsPolicyResult {
 public:
  ...
  void SetCorsPolicy(CorsPolicyT&& value) {
    m_corsPolicyHasBeenSet = true;
    m_corsPolicy = std::forward<CorsPolicyT>(value);
  }
  template <typename CorsPolicyT = Aws::Vector<CorsRule>>
  GetCorsPolicyResult& WithCorsPolicy(CorsPolicyT&& value) {
    SetCorsPolicy(std::forward<CorsPolicyT>(value));
    return *this;
  }
  template <typename CorsPolicyT = CorsRule>
  GetCorsPolicyResult& AddCorsPolicy(CorsPolicyT&& value) {
    m_corsPolicyHasBeenSet = true;
    m_corsPolicy.emplace_back(std::forward<CorsPolicyT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetCorsPolicyResult& WithRequestId(RequestIdT&& value) {
