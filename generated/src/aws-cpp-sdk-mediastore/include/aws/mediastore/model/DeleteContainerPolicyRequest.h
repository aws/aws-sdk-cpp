...
namespace Model
{
  ...
  /**
   */
  class DeleteContainerPolicyRequest : public MediaStoreRequest
  {
  public:
    AWS_MEDIASTORE_API DeleteContainerPolicyRequest() = default;
    ...
    template<typename ContainerNameT = Aws::String>
    DeleteContainerPolicyRequest& WithContainerName(ContainerNameT&& value) { SetContainerName(std::forward<ContainerNameT>(value)); return *this;}
    ///@}
  private:
