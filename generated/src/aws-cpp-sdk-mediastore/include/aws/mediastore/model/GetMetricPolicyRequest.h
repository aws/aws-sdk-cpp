...
namespace Model
{
  ...
  /**
   */
  class GetMetricPolicyRequest : public MediaStoreRequest
  {
  public:
    AWS_MEDIASTORE_API GetMetricPolicyRequest() = default;
    ...
    template<typename ContainerNameT = Aws::String>
    GetMetricPolicyRequest& WithContainerName(ContainerNameT&& value) { SetContainerName(std::forward<ContainerNameT>(value)); return *this;}
    ///@}
  private:
