...
class ListContainersResult {
 public:
  ...
  template <typename ContainersT = Aws::Vector<Container>>
  ListContainersResult& WithContainers(ContainersT&& value) {
    SetContainers(std::forward<ContainersT>(value));
    return *this;
  }
  template <typename ContainersT = Container>
  ListContainersResult& AddContainers(ContainersT&& value) {
    m_containersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListContainersResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListContainersResult& WithRequestId(RequestIdT&& value) {
