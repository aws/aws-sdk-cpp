...
public:
  ...
  SSOAdminError(const Aws::Client::AWSError<SSOAdminErrors>& rhs) : Aws::Client::AWSError<SSOAdminErrors>(rhs) {}
  SSOAdminError(Aws::Client::AWSError<SSOAdminErrors>&& rhs) : Aws::Client::AWSError<SSOAdminErrors>(rhs) {}
