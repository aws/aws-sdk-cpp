...
class ListApplicationAuthenticationMethodsRequest : public SSOAdminRequest {
 public:
  ...
  template <typename ApplicationArnT = Aws::String>
  ListApplicationAuthenticationMethodsRequest& WithApplicationArn(ApplicationArnT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListApplicationAuthenticationMethodsRequest& WithNextToken(NextTokenT&& value) {
