...
class PutApplicationAuthenticationMethodRequest : public SSOAdminRequest {
 public:
  ...
  inline PutApplicationAuthenticationMethodRequest& WithAuthenticationMethodType(AuthenticationMethodType value) {
  ...
  void SetAuthenticationMethod(AuthenticationMethodT&& value) {
    ...
    m_authenticationMethod = std::forward<AuthenticationMethodT>(value);
  }
  template <typename AuthenticationMethodT = AuthenticationMethod>
  PutApplicationAuthenticationMethodRequest& WithAuthenticationMethod(AuthenticationMethodT&& value) {
    SetAuthenticationMethod(std::forward<AuthenticationMethodT>(value));
    return *this;
  }
  ///@}
 private:
