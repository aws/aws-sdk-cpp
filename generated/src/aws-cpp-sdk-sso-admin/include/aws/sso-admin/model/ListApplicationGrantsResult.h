...
class ListApplicationGrantsResult {
 public:
  AWS_SSOADMIN_API ListApplicationGrantsResult() = default;
  ...
  template <typename GrantsT = Aws::Vector<GrantItem>>
  ListApplicationGrantsResult& WithGrants(GrantsT&& value) {
    SetGrants(std::forward<GrantsT>(value));
    return *this;
  }
  template <typename GrantsT = GrantItem>
  ListApplicationGrantsResult& AddGrants(GrantsT&& value) {
    m_grantsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListApplicationGrantsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListApplicationGrantsResult& WithRequestId(RequestIdT&& value) {
