...
class UpdateApplicationRequest : public SSOAdminRequest {
 public:
  ...
  template <typename ApplicationArnT = Aws::String>
  UpdateApplicationRequest& WithApplicationArn(ApplicationArnT&& value) {
  ...
  inline UpdateApplicationRequest& WithStatus(ApplicationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetPortalOptions(PortalOptionsT&& value) {
    ...
    m_portalOptions = std::forward<PortalOptionsT>(value);
  }
  template <typename PortalOptionsT = UpdateApplicationPortalOptions>
  UpdateApplicationRequest& WithPortalOptions(PortalOptionsT&& value) {
    SetPortalOptions(std::forward<PortalOptionsT>(value));
    return *this;
  }
  ///@}
 private:
