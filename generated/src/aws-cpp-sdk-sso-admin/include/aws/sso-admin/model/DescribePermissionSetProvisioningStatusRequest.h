...
class DescribePermissionSetProvisioningStatusRequest : public SSOAdminRequest {
 public:
  ...
  template <typename InstanceArnT = Aws::String>
  DescribePermissionSetProvisioningStatusRequest& WithInstanceArn(InstanceArnT&& value) {
  ...
  void SetProvisionPermissionSetRequestId(ProvisionPermissionSetRequestIdT&& value) {
    m_provisionPermissionSetRequestIdHasBeenSet = true;
    m_provisionPermissionSetRequestId = std::forward<ProvisionPermissionSetRequestIdT>(value);
  }
  template <typename ProvisionPermissionSetRequestIdT = Aws::String>
  DescribePermissionSetProvisioningStatusRequest& WithProvisionPermissionSetRequestId(ProvisionPermissionSetRequestIdT&& value) {
    SetProvisionPermissionSetRequestId(std::forward<ProvisionPermissionSetRequestIdT>(value));
    return *this;
  }
  ///@}
 private:
