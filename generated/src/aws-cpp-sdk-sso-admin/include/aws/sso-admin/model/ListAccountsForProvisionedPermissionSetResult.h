...
class ListAccountsForProvisionedPermissionSetResult {
 public:
  AWS_SSOADMIN_API ListAccountsForProvisionedPermissionSetResult() = default;
  ...
  AWS_SSOADMIN_API ListAccountsForProvisionedPermissionSetResult& operator=(
  ...
  template <typename AccountIdsT = Aws::Vector<Aws::String>>
  ListAccountsForProvisionedPermissionSetResult& WithAccountIds(AccountIdsT&& value) {
    SetAccountIds(std::forward<AccountIdsT>(value));
    return *this;
  }
  template <typename AccountIdsT = Aws::String>
  ListAccountsForProvisionedPermissionSetResult& AddAccountIds(AccountIdsT&& value) {
    m_accountIdsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListAccountsForProvisionedPermissionSetResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAccountsForProvisionedPermissionSetResult& WithRequestId(RequestIdT&& value) {
