...
class CreateAccountAssignmentRequest : public SSOAdminRequest {
 public:
  ...
  template <typename InstanceArnT = Aws::String>
  CreateAccountAssignmentRequest& WithInstanceArn(InstanceArnT&& value) {
  ...
  template <typename TargetIdT = Aws::String>
  CreateAccountAssignmentRequest& WithTargetId(TargetIdT&& value) {
  ...
  inline CreateAccountAssignmentRequest& WithTargetType(TargetType value) {
    SetTargetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename PermissionSetArnT = Aws::String>
  CreateAccountAssignmentRequest& WithPermissionSetArn(PermissionSetArnT&& value) {
  ...
  inline CreateAccountAssignmentRequest& WithPrincipalType(PrincipalType value) {
  ...
  template <typename PrincipalIdT = Aws::String>
  CreateAccountAssignmentRequest& WithPrincipalId(PrincipalIdT&& value) {
