 ...
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/sso-admin-2020-07-20/ValidationException">AWS
 * API Reference</a></p>
 */
class ValidationException {
 public:
  AWS_SSOADMIN_API ValidationException() = default;
  AWS_SSOADMIN_API ValidationException(Aws::Utils::Json::JsonView jsonValue);
  AWS_SSOADMIN_API ValidationException& operator=(Aws::Utils::Json::JsonView jsonValue);
