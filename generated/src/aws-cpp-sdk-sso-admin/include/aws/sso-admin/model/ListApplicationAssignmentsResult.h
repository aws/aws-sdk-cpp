...
class ListApplicationAssignmentsResult {
 public:
  ...
  template <typename ApplicationAssignmentsT = Aws::Vector<ApplicationAssignment>>
  ListApplicationAssignmentsResult& WithApplicationAssignments(ApplicationAssignmentsT&& value) {
  ...
  ListApplicationAssignmentsResult& AddApplicationAssignments(ApplicationAssignmentsT&& value) {
    m_applicationAssignmentsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListApplicationAssignmentsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListApplicationAssignmentsResult& WithRequestId(RequestIdT&& value) {
