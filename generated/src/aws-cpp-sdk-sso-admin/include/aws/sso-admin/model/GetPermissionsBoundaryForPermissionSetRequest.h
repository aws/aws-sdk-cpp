...
class GetPermissionsBoundaryForPermissionSetRequest : public SSOAdminRequest {
 public:
  ...
  template <typename InstanceArnT = Aws::String>
  GetPermissionsBoundaryForPermissionSetRequest& WithInstanceArn(InstanceArnT&& value) {
  ...
  template <typename PermissionSetArnT = Aws::String>
  GetPermissionsBoundaryForPermissionSetRequest& WithPermissionSetArn(PermissionSetArnT&& value) {
