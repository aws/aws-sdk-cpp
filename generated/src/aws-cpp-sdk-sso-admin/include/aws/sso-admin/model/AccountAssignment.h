...
class AccountAssignment {
 public:
  ...
  template <typename AccountIdT = Aws::String>
  AccountAssignment& WithAccountId(AccountIdT&& value) {
  ...
  template <typename PermissionSetArnT = Aws::String>
  AccountAssignment& WithPermissionSetArn(PermissionSetArnT&& value) {
  ...
  inline AccountAssignment& WithPrincipalType(PrincipalType value) {
  ...
  template <typename PrincipalIdT = Aws::String>
  AccountAssignment& WithPrincipalId(PrincipalIdT&& value) {
