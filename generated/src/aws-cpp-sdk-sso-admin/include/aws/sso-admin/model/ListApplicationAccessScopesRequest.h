...
class ListApplicationAccessScopesRequest : public SSOAdminRequest {
 public:
  AWS_SSOADMIN_API ListApplicationAccessScopesRequest() = default;
  ...
  template <typename ApplicationArnT = Aws::String>
  ListApplicationAccessScopesRequest& WithApplicationArn(ApplicationArnT&& value) {
  ...
  inline ListApplicationAccessScopesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListApplicationAccessScopesRequest& WithNextToken(NextTokenT&& value) {
