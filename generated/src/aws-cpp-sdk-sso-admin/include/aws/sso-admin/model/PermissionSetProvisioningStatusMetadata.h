...
class PermissionSetProvisioningStatusMetadata {
 public:
  ...
  inline PermissionSetProvisioningStatusMetadata& WithStatus(StatusValues value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  PermissionSetProvisioningStatusMetadata& WithRequestId(RequestIdT&& value) {
  ...
  template <typename CreatedDateT = Aws::Utils::DateTime>
  PermissionSetProvisioningStatusMetadata& WithCreatedDate(CreatedDateT&& value) {
