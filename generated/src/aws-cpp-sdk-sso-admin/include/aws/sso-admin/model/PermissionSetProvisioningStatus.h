...
class PermissionSetProvisioningStatus {
 public:
  ...
  inline PermissionSetProvisioningStatus& WithStatus(StatusValues value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  PermissionSetProvisioningStatus& WithRequestId(RequestIdT&& value) {
  ...
  template <typename AccountIdT = Aws::String>
  PermissionSetProvisioningStatus& WithAccountId(AccountIdT&& value) {
  ...
  template <typename PermissionSetArnT = Aws::String>
  PermissionSetProvisioningStatus& WithPermissionSetArn(PermissionSetArnT&& value) {
  ...
  template <typename FailureReasonT = Aws::String>
  PermissionSetProvisioningStatus& WithFailureReason(FailureReasonT&& value) {
  ...
  template <typename CreatedDateT = Aws::Utils::DateTime>
  PermissionSetProvisioningStatus& WithCreatedDate(CreatedDateT&& value) {
