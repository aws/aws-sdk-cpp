...
class UpdateTrustedTokenIssuerRequest : public SSOAdminRequest {
 public:
  ...
  template <typename TrustedTokenIssuerArnT = Aws::String>
  UpdateTrustedTokenIssuerRequest& WithTrustedTokenIssuerArn(TrustedTokenIssuerArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  UpdateTrustedTokenIssuerRequest& WithName(NameT&& value) {
   ...
   */
  inline const TrustedTokenIssuerUpdateConfiguration& GetTrustedTokenIssuerConfiguration() const {
    return m_trustedTokenIssuerConfiguration;
  }
  ...
  template <typename TrustedTokenIssuerConfigurationT = TrustedTokenIssuerUpdateConfiguration>
  UpdateTrustedTokenIssuerRequest& WithTrustedTokenIssuerConfiguration(TrustedTokenIssuerConfigurationT&& value) {
