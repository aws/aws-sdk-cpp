...
class PermissionsBoundary {
 public:
  ...
  template <typename CustomerManagedPolicyReferenceT = CustomerManagedPolicyReference>
  PermissionsBoundary& WithCustomerManagedPolicyReference(CustomerManagedPolicyReferenceT&& value) {
  ...
  template <typename ManagedPolicyArnT = Aws::String>
  PermissionsBoundary& WithManagedPolicyArn(ManagedPolicyArnT&& value) {
