...
class ListApplicationsFilter {
 public:
  ...
  void SetApplicationAccount(ApplicationAccountT&& value) {
    ...
    m_applicationAccount = std::forward<ApplicationAccountT>(value);
  }
  template <typename ApplicationAccountT = Aws::String>
  ListApplicationsFilter& WithApplicationAccount(ApplicationAccountT&& value) {
    SetApplicationAccount(std::forward<ApplicationAccountT>(value));
    return *this;
  }
  ///@}
  ...
  void SetApplicationProvider(ApplicationProviderT&& value) {
    m_applicationProviderHasBeenSet = true;
    m_applicationProvider = std::forward<ApplicationProviderT>(value);
  }
  template <typename ApplicationProviderT = Aws::String>
  ListApplicationsFilter& WithApplicationProvider(ApplicationProviderT&& value) {
    SetApplicationProvider(std::forward<ApplicationProviderT>(value));
    return *this;
  }
  ///@}
 private:
