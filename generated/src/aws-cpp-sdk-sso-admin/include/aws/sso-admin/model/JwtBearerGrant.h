...
class JwtBearerGrant {
 public:
  ...
  void SetAuthorizedTokenIssuers(AuthorizedTokenIssuersT&& value) {
    m_authorizedTokenIssuersHasBeenSet = true;
    m_authorizedTokenIssuers = std::forward<AuthorizedTokenIssuersT>(value);
  }
  template <typename AuthorizedTokenIssuersT = Aws::Vector<AuthorizedTokenIssuer>>
  JwtBearerGrant& WithAuthorizedTokenIssuers(AuthorizedTokenIssuersT&& value) {
    SetAuthorizedTokenIssuers(std::forward<AuthorizedTokenIssuersT>(value));
    return *this;
  }
  template <typename AuthorizedTokenIssuersT = AuthorizedTokenIssuer>
  JwtBearerGrant& AddAuthorizedTokenIssuers(AuthorizedTokenIssuersT&& value) {
    m_authorizedTokenIssuersHasBeenSet = true;
    m_authorizedTokenIssuers.emplace_back(std::forward<AuthorizedTokenIssuersT>(value));
    return *this;
  }
  ///@}
 private:
