...
class ListApplicationAssignmentsForPrincipalResult {
 public:
  ...
  AWS_SSOADMIN_API ListApplicationAssignmentsForPrincipalResult& operator=(
  ...
  void SetApplicationAssignments(ApplicationAssignmentsT&& value) {
    m_applicationAssignmentsHasBeenSet = true;
    m_applicationAssignments = std::forward<ApplicationAssignmentsT>(value);
  }
  template <typename ApplicationAssignmentsT = Aws::Vector<ApplicationAssignmentForPrincipal>>
  ListApplicationAssignmentsForPrincipalResult& WithApplicationAssignments(ApplicationAssignmentsT&& value) {
    SetApplicationAssignments(std::forward<ApplicationAssignmentsT>(value));
    return *this;
  }
  template <typename ApplicationAssignmentsT = ApplicationAssignmentForPrincipal>
  ListApplicationAssignmentsForPrincipalResult& AddApplicationAssignments(ApplicationAssignmentsT&& value) {
    m_applicationAssignmentsHasBeenSet = true;
    m_applicationAssignments.emplace_back(std::forward<ApplicationAssignmentsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListApplicationAssignmentsForPrincipalResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListApplicationAssignmentsForPrincipalResult& WithRequestId(RequestIdT&& value) {
