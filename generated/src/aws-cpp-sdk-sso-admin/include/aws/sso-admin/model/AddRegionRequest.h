...
/**
 */
class AddRegionRequest : public SSOAdminRequest {
 public:
  AWS_SSOADMIN_API AddRegionRequest() = default;
   ...
   * replicate to the target Region.</p>
   */
  ...
  template <typename InstanceArnT = Aws::String>
  AddRegionRequest& WithInstanceArn(InstanceArnT&& value) {
  ...
  ///@{
  /**
   * <p>The name of the Amazon Web Services Region to add to the IAM Identity Center
   * instance. The Region name must be 1-32 characters long and follow the pattern of
   * Amazon Web Services Region names (for example, us-east-1).</p>
   */
