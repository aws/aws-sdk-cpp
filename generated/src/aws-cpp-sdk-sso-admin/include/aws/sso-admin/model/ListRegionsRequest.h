...
/**
 */
class ListRegionsRequest : public SSOAdminRequest {
 public:
  AWS_SSOADMIN_API ListRegionsRequest() = default;
  ...
  template <typename InstanceArnT = Aws::String>
  ListRegionsRequest& WithInstanceArn(InstanceArnT&& value) {
  ...
  inline ListRegionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListRegionsRequest& WithNextToken(NextTokenT&& value) {
