...
class CreateTrustedTokenIssuerRequest : public SSOAdminRequest {
 public:
  ...
  template <typename InstanceArnT = Aws::String>
  CreateTrustedTokenIssuerRequest& WithInstanceArn(InstanceArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateTrustedTokenIssuerRequest& WithName(NameT&& value) {
  ...
  inline CreateTrustedTokenIssuerRequest& WithTrustedTokenIssuerType(TrustedTokenIssuerType value) {
  ...
  template <typename TrustedTokenIssuerConfigurationT = TrustedTokenIssuerConfiguration>
  CreateTrustedTokenIssuerRequest& WithTrustedTokenIssuerConfiguration(TrustedTokenIssuerConfigurationT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  CreateTrustedTokenIssuerRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateTrustedTokenIssuerRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateTrustedTokenIssuerRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
