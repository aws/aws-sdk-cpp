...
class ListAccountAssignmentsResult {
 public:
  ...
  template <typename AccountAssignmentsT = Aws::Vector<AccountAssignment>>
  ListAccountAssignmentsResult& WithAccountAssignments(AccountAssignmentsT&& value) {
    SetAccountAssignments(std::forward<AccountAssignmentsT>(value));
    return *this;
  }
  template <typename AccountAssignmentsT = AccountAssignment>
  ListAccountAssignmentsResult& AddAccountAssignments(AccountAssignmentsT&& value) {
    m_accountAssignmentsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListAccountAssignmentsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAccountAssignmentsResult& WithRequestId(RequestIdT&& value) {
