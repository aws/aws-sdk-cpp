...
class ApplicationAssignmentForPrincipal {
 public:
  ...
  template <typename ApplicationArnT = Aws::String>
  ApplicationAssignmentForPrincipal& WithApplicationArn(ApplicationArnT&& value) {
  ...
  template <typename PrincipalIdT = Aws::String>
  ApplicationAssignmentForPrincipal& WithPrincipalId(PrincipalIdT&& value) {
  ...
  inline ApplicationAssignmentForPrincipal& WithPrincipalType(PrincipalType value) {
