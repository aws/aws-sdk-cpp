...
class GetPermissionsBoundaryForPermissionSetResult {
 public:
  ...
  AWS_SSOADMIN_API GetPermissionsBoundaryForPermissionSetResult& operator=(
  ...
  template <typename PermissionsBoundaryT = PermissionsBoundary>
  GetPermissionsBoundaryForPermissionSetResult& WithPermissionsBoundary(PermissionsBoundaryT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetPermissionsBoundaryForPermissionSetResult& WithRequestId(RequestIdT&& value) {
