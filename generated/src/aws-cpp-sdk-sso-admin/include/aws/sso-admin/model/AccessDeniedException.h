 ...
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/sso-admin-2020-07-20/AccessDeniedException">AWS
 * API Reference</a></p>
 */
class AccessDeniedException {
 public:
  AWS_SSOADMIN_API AccessDeniedException() = default;
  AWS_SSOADMIN_API AccessDeniedException(Aws::Utils::Json::JsonView jsonValue);
  AWS_SSOADMIN_API AccessDeniedException& operator=(Aws::Utils::Json::JsonView jsonValue);
