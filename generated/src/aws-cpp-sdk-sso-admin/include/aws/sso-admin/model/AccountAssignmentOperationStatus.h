...
class AccountAssignmentOperationStatus {
 public:
  ...
  inline AccountAssignmentOperationStatus& WithStatus(StatusValues value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  AccountAssignmentOperationStatus& WithRequestId(RequestIdT&& value) {
  ...
  template <typename FailureReasonT = Aws::String>
  AccountAssignmentOperationStatus& WithFailureReason(FailureReasonT&& value) {
  ...
  template <typename TargetIdT = Aws::String>
  AccountAssignmentOperationStatus& WithTargetId(TargetIdT&& value) {
  ...
  inline AccountAssignmentOperationStatus& WithTargetType(TargetType value) {
    SetTargetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename PermissionSetArnT = Aws::String>
  AccountAssignmentOperationStatus& WithPermissionSetArn(PermissionSetArnT&& value) {
  ...
  inline AccountAssignmentOperationStatus& WithPrincipalType(PrincipalType value) {
  ...
  template <typename PrincipalIdT = Aws::String>
  AccountAssignmentOperationStatus& WithPrincipalId(PrincipalIdT&& value) {
  ...
  template <typename CreatedDateT = Aws::Utils::DateTime>
  AccountAssignmentOperationStatus& WithCreatedDate(CreatedDateT&& value) {
