...
namespace Model
{
  ...
  public:
    ...
    template<typename InstanceArnT = Aws::String>
    DeleteAccountAssignmentRequest& WithInstanceArn(InstanceArnT&& value) { SetInstanceArn(std::forward<InstanceArnT>(value)); return *this;}
    ///@}
    ...
    template<typename TargetIdT = Aws::String>
    DeleteAccountAssignmentRequest& WithTargetId(TargetIdT&& value) { SetTargetId(std::forward<TargetIdT>(value)); return *this;}
    ///@}
