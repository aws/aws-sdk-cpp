...
class DescribeInstanceResult {
 public:
  ...
  inline DescribeInstanceResult& WithStatus(InstanceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonT = Aws::String>
  DescribeInstanceResult& WithStatusReason(StatusReasonT&& value) {
  ...
  void SetEncryptionConfigurationDetails(EncryptionConfigurationDetailsT&& value) {
    m_encryptionConfigurationDetailsHasBeenSet = true;
    m_encryptionConfigurationDetails = std::forward<EncryptionConfigurationDetailsT>(value);
  }
  template <typename EncryptionConfigurationDetailsT = EncryptionConfigurationDetails>
  DescribeInstanceResult& WithEncryptionConfigurationDetails(EncryptionConfigurationDetailsT&& value) {
    SetEncryptionConfigurationDetails(std::forward<EncryptionConfigurationDetailsT>(value));
    return *this;
  }
  ///@}
