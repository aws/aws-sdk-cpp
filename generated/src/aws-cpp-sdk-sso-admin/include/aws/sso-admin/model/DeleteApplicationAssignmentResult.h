...
namespace Model
{
  ...
  {
  public:
    AWS_SSOADMIN_API DeleteApplicationAssignmentResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteApplicationAssignmentResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
