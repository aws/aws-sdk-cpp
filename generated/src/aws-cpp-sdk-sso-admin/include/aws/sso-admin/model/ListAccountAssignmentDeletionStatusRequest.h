...
class ListAccountAssignmentDeletionStatusRequest : public SSOAdminRequest {
 public:
  ...
  template <typename InstanceArnT = Aws::String>
  ListAccountAssignmentDeletionStatusRequest& WithInstanceArn(InstanceArnT&& value) {
  ...
  inline ListAccountAssignmentDeletionStatusRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAccountAssignmentDeletionStatusRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename FilterT = OperationStatusFilter>
  ListAccountAssignmentDeletionStatusRequest& WithFilter(FilterT&& value) {
