...
class CreateInstanceAccessControlAttributeConfigurationRequest : public SSOAdminRequest {
 public:
  ...
  template <typename InstanceArnT = Aws::String>
  CreateInstanceAccessControlAttributeConfigurationRequest& WithInstanceArn(InstanceArnT&& value) {
  ...
  template <typename InstanceAccessControlAttributeConfigurationT = InstanceAccessControlAttributeConfiguration>
  CreateInstanceAccessControlAttributeConfigurationRequest& WithInstanceAccessControlAttributeConfiguration(
