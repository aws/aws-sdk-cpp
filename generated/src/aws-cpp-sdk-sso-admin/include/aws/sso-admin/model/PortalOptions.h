...
class PortalOptions {
 public:
  ...
  void SetSignInOptions(SignInOptionsT&& value) {
    m_signInOptionsHasBeenSet = true;
    m_signInOptions = std::forward<SignInOptionsT>(value);
  }
  template <typename SignInOptionsT = SignInOptions>
  PortalOptions& WithSignInOptions(SignInOptionsT&& value) {
    SetSignInOptions(std::forward<SignInOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetVisibility(ApplicationVisibility value) {
    m_visibilityHasBeenSet = true;
    m_visibility = value;
  }
  inline PortalOptions& WithVisibility(ApplicationVisibility value) {
    SetVisibility(value);
    return *this;
  }
  ///@}
