...
class ListApplicationGrantsRequest : public SSOAdminRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "ListApplicationGrants"; }
  ...
  template <typename ApplicationArnT = Aws::String>
  ListApplicationGrantsRequest& WithApplicationArn(ApplicationArnT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListApplicationGrantsRequest& WithNextToken(NextTokenT&& value) {
