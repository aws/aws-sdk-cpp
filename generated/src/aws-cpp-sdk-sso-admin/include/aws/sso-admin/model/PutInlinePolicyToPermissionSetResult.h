...
namespace Model
{
  ...
  {
  public:
    AWS_SSOADMIN_API PutInlinePolicyToPermissionSetResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    PutInlinePolicyToPermissionSetResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
