...
class ListManagedPoliciesInPermissionSetRequest : public SSOAdminRequest {
 public:
  AWS_SSOADMIN_API ListManagedPoliciesInPermissionSetRequest() = default;
  ...
  template <typename InstanceArnT = Aws::String>
  ListManagedPoliciesInPermissionSetRequest& WithInstanceArn(InstanceArnT&& value) {
  ...
  template <typename PermissionSetArnT = Aws::String>
  ListManagedPoliciesInPermissionSetRequest& WithPermissionSetArn(PermissionSetArnT&& value) {
  ...
  inline ListManagedPoliciesInPermissionSetRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListManagedPoliciesInPermissionSetRequest& WithNextToken(NextTokenT&& value) {
