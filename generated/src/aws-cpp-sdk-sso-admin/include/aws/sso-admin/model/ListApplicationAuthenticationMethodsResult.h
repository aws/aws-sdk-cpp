...
class ListApplicationAuthenticationMethodsResult {
 public:
  ...
  AWS_SSOADMIN_API ListApplicationAuthenticationMethodsResult& operator=(
  ...
  void SetAuthenticationMethods(AuthenticationMethodsT&& value) {
    m_authenticationMethodsHasBeenSet = true;
    m_authenticationMethods = std::forward<AuthenticationMethodsT>(value);
  }
  template <typename AuthenticationMethodsT = Aws::Vector<AuthenticationMethodItem>>
  ListApplicationAuthenticationMethodsResult& WithAuthenticationMethods(AuthenticationMethodsT&& value) {
    SetAuthenticationMethods(std::forward<AuthenticationMethodsT>(value));
    return *this;
  }
  template <typename AuthenticationMethodsT = AuthenticationMethodItem>
  ListApplicationAuthenticationMethodsResult& AddAuthenticationMethods(AuthenticationMethodsT&& value) {
    m_authenticationMethodsHasBeenSet = true;
    m_authenticationMethods.emplace_back(std::forward<AuthenticationMethodsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListApplicationAuthenticationMethodsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListApplicationAuthenticationMethodsResult& WithRequestId(RequestIdT&& value) {
