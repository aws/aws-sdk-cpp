...
class PutInlinePolicyToPermissionSetRequest : public SSOAdminRequest {
 public:
  ...
  template <typename InstanceArnT = Aws::String>
  PutInlinePolicyToPermissionSetRequest& WithInstanceArn(InstanceArnT&& value) {
  ...
  template <typename PermissionSetArnT = Aws::String>
  PutInlinePolicyToPermissionSetRequest& WithPermissionSetArn(PermissionSetArnT&& value) {
  ...
  void SetInlinePolicy(InlinePolicyT&& value) {
    m_inlinePolicyHasBeenSet = true;
    m_inlinePolicy = std::forward<InlinePolicyT>(value);
  }
  template <typename InlinePolicyT = Aws::String>
  PutInlinePolicyToPermissionSetRequest& WithInlinePolicy(InlinePolicyT&& value) {
    SetInlinePolicy(std::forward<InlinePolicyT>(value));
    return *this;
  }
  ///@}
 private:
