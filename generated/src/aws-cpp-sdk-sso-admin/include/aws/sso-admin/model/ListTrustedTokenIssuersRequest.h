...
namespace Model
{
  ...
  public:
    ...
    template<typename InstanceArnT = Aws::String>
    ListTrustedTokenIssuersRequest& WithInstanceArn(InstanceArnT&& value) { SetInstanceArn(std::forward<InstanceArnT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListTrustedTokenIssuersRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
