...
class ListPermissionSetsProvisionedToAccountRequest : public SSOAdminRequest {
 public:
  ...
  template <typename InstanceArnT = Aws::String>
  ListPermissionSetsProvisionedToAccountRequest& WithInstanceArn(InstanceArnT&& value) {
  ...
  template <typename AccountIdT = Aws::String>
  ListPermissionSetsProvisionedToAccountRequest& WithAccountId(AccountIdT&& value) {
  ...
  inline ListPermissionSetsProvisionedToAccountRequest& WithProvisioningStatus(ProvisioningStatus value) {
  ...
  inline ListPermissionSetsProvisionedToAccountRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListPermissionSetsProvisionedToAccountRequest& WithNextToken(NextTokenT&& value) {
