...
class OidcJwtUpdateConfiguration {
 public:
  ...
  void SetClaimAttributePath(ClaimAttributePathT&& value) {
    ...
    m_claimAttributePath = std::forward<ClaimAttributePathT>(value);
  }
  template <typename ClaimAttributePathT = Aws::String>
  OidcJwtUpdateConfiguration& WithClaimAttributePath(ClaimAttributePathT&& value) {
    SetClaimAttributePath(std::forward<ClaimAttributePathT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIdentityStoreAttributePath(IdentityStoreAttributePathT&& value) {
    ...
    m_identityStoreAttributePath = std::forward<IdentityStoreAttributePathT>(value);
  }
  template <typename IdentityStoreAttributePathT = Aws::String>
  OidcJwtUpdateConfiguration& WithIdentityStoreAttributePath(IdentityStoreAttributePathT&& value) {
    SetIdentityStoreAttributePath(std::forward<IdentityStoreAttributePathT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetJwksRetrievalOption(JwksRetrievalOption value) {
    m_jwksRetrievalOptionHasBeenSet = true;
    m_jwksRetrievalOption = value;
  }
  inline OidcJwtUpdateConfiguration& WithJwksRetrievalOption(JwksRetrievalOption value) {
    SetJwksRetrievalOption(value);
    return *this;
  }
  ///@}
 private:
