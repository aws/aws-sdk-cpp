...
class ListTrustedTokenIssuersResult {
 public:
  ...
  void SetTrustedTokenIssuers(TrustedTokenIssuersT&& value) {
    m_trustedTokenIssuersHasBeenSet = true;
    m_trustedTokenIssuers = std::forward<TrustedTokenIssuersT>(value);
  }
  template <typename TrustedTokenIssuersT = Aws::Vector<TrustedTokenIssuerMetadata>>
  ListTrustedTokenIssuersResult& WithTrustedTokenIssuers(TrustedTokenIssuersT&& value) {
    SetTrustedTokenIssuers(std::forward<TrustedTokenIssuersT>(value));
    return *this;
  }
  template <typename TrustedTokenIssuersT = TrustedTokenIssuerMetadata>
  ListTrustedTokenIssuersResult& AddTrustedTokenIssuers(TrustedTokenIssuersT&& value) {
    m_trustedTokenIssuersHasBeenSet = true;
    m_trustedTokenIssuers.emplace_back(std::forward<TrustedTokenIssuersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTrustedTokenIssuersResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListTrustedTokenIssuersResult& WithRequestId(RequestIdT&& value) {
