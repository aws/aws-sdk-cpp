...
/**
 */
class ListAccountAssignmentCreationStatusRequest : public SSOAdminRequest {
 public:
  AWS_SSOADMIN_API ListAccountAssignmentCreationStatusRequest() = default;
  ...
  template <typename InstanceArnT = Aws::String>
  ListAccountAssignmentCreationStatusRequest& WithInstanceArn(InstanceArnT&& value) {
  ...
  inline ListAccountAssignmentCreationStatusRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAccountAssignmentCreationStatusRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename FilterT = OperationStatusFilter>
  ListAccountAssignmentCreationStatusRequest& WithFilter(FilterT&& value) {
