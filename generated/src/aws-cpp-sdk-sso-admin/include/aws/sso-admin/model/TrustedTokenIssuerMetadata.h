...
class TrustedTokenIssuerMetadata {
 public:
  ...
  template <typename TrustedTokenIssuerArnT = Aws::String>
  TrustedTokenIssuerMetadata& WithTrustedTokenIssuerArn(TrustedTokenIssuerArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  TrustedTokenIssuerMetadata& WithName(NameT&& value) {
  ...
  inline TrustedTokenIssuerMetadata& WithTrustedTokenIssuerType(TrustedTokenIssuerType value) {
