...
class ListCustomerManagedPolicyReferencesInPermissionSetRequest : public SSOAdminRequest {
 public:
  ...
  template <typename InstanceArnT = Aws::String>
  ListCustomerManagedPolicyReferencesInPermissionSetRequest& WithInstanceArn(InstanceArnT&& value) {
  ...
  template <typename PermissionSetArnT = Aws::String>
  ListCustomerManagedPolicyReferencesInPermissionSetRequest& WithPermissionSetArn(PermissionSetArnT&& value) {
  ...
  inline ListCustomerManagedPolicyReferencesInPermissionSetRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListCustomerManagedPolicyReferencesInPermissionSetRequest& WithNextToken(NextTokenT&& value) {
