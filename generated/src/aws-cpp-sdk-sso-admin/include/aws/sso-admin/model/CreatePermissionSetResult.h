...
class CreatePermissionSetResult {
 public:
  AWS_SSOADMIN_API CreatePermissionSetResult() = default;
  ...
  void SetPermissionSet(PermissionSetT&& value) {
    m_permissionSetHasBeenSet = true;
    m_permissionSet = std::forward<PermissionSetT>(value);
  }
  template <typename PermissionSetT = PermissionSet>
  CreatePermissionSetResult& WithPermissionSet(PermissionSetT&& value) {
    SetPermissionSet(std::forward<PermissionSetT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  CreatePermissionSetResult& WithRequestId(RequestIdT&& value) {
