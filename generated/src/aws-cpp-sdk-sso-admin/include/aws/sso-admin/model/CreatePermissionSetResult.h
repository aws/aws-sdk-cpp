...
namespace Model
{
  ...
  public:
    ...
    template<typename PermissionSetT = PermissionSet>
    CreatePermissionSetResult& WithPermissionSet(PermissionSetT&& value) { SetPermissionSet(std::forward<PermissionSetT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreatePermissionSetResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
