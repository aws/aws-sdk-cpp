...
namespace Model
{
  ...
  public:
    ...
    inline AttachCustomerManagedPolicyReferenceToPermissionSetResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline AttachCustomerManagedPolicyReferenceToPermissionSetResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline AttachCustomerManagedPolicyReferenceToPermissionSetResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
