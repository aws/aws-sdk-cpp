...
class ListApplicationAccessScopesResult {
 public:
  ...
  template <typename ScopesT = Aws::Vector<ScopeDetails>>
  ListApplicationAccessScopesResult& WithScopes(ScopesT&& value) {
    SetScopes(std::forward<ScopesT>(value));
    return *this;
  }
  template <typename ScopesT = ScopeDetails>
  ListApplicationAccessScopesResult& AddScopes(ScopesT&& value) {
    m_scopesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListApplicationAccessScopesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListApplicationAccessScopesResult& WithRequestId(RequestIdT&& value) {
