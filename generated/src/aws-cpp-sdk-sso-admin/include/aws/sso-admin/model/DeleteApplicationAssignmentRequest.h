...
namespace Model
{
  ...
  {
  public:
    AWS_SSOADMIN_API DeleteApplicationAssignmentRequest() = default;
    ...
    template<typename ApplicationArnT = Aws::String>
    DeleteApplicationAssignmentRequest& WithApplicationArn(ApplicationArnT&& value) { SetApplicationArn(std::forward<ApplicationArnT>(value)); return *this;}
    ///@}
    ...
    template<typename PrincipalIdT = Aws::String>
    DeleteApplicationAssignmentRequest& WithPrincipalId(PrincipalIdT&& value) { SetPrincipalId(std::forward<PrincipalIdT>(value)); return *this;}
    ///@}
    ...
    inline DeleteApplicationAssignmentRequest& WithPrincipalType(PrincipalType value) { SetPrincipalType(value); return *this;}
    ///@}
  private:
