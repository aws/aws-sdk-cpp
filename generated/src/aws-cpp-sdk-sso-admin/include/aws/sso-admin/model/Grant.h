...
class Grant {
 public:
  ...
  void SetJwtBearer(JwtBearerT&& value) {
    ...
    m_jwtBearer = std::forward<JwtBearerT>(value);
  }
  template <typename JwtBearerT = JwtBearerGrant>
  Grant& WithJwtBearer(JwtBearerT&& value) {
    SetJwtBearer(std::forward<JwtBearerT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTokenExchange(TokenExchangeT&& value) {
    ...
    m_tokenExchange = std::forward<TokenExchangeT>(value);
  }
  template <typename TokenExchangeT = TokenExchangeGrant>
  Grant& WithTokenExchange(TokenExchangeT&& value) {
    SetTokenExchange(std::forward<TokenExchangeT>(value));
    return *this;
  }
  ///@}
 private:
