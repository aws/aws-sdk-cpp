...
namespace Model
{
  ...
  {
  public:
    AWS_SSOADMIN_API UpdateTrustedTokenIssuerResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateTrustedTokenIssuerResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
