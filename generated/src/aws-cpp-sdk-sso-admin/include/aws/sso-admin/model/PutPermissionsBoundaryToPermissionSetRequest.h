...
class PutPermissionsBoundaryToPermissionSetRequest : public SSOAdminRequest {
 public:
  ...
  template <typename InstanceArnT = Aws::String>
  PutPermissionsBoundaryToPermissionSetRequest& WithInstanceArn(InstanceArnT&& value) {
  ...
  template <typename PermissionSetArnT = Aws::String>
  PutPermissionsBoundaryToPermissionSetRequest& WithPermissionSetArn(PermissionSetArnT&& value) {
  ...
  template <typename PermissionsBoundaryT = PermissionsBoundary>
  PutPermissionsBoundaryToPermissionSetRequest& WithPermissionsBoundary(PermissionsBoundaryT&& value) {
