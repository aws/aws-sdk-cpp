...
namespace Model
{
  ...
  {
  public:
    AWS_SSOADMIN_API DeleteAccountAssignmentResult() = default;
    ...
    template<typename AccountAssignmentDeletionStatusT = AccountAssignmentOperationStatus>
    DeleteAccountAssignmentResult& WithAccountAssignmentDeletionStatus(AccountAssignmentDeletionStatusT&& value) { SetAccountAssignmentDeletionStatus(std::forward<AccountAssignmentDeletionStatusT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DeleteAccountAssignmentResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
