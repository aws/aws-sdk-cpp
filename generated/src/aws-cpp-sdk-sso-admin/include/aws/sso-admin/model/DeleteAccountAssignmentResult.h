...
class DeleteAccountAssignmentResult {
 public:
  ...
  template <typename AccountAssignmentDeletionStatusT = AccountAssignmentOperationStatus>
  DeleteAccountAssignmentResult& WithAccountAssignmentDeletionStatus(AccountAssignmentDeletionStatusT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteAccountAssignmentResult& WithRequestId(RequestIdT&& value) {
