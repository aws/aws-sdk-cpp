...
class PutApplicationAssignmentConfigurationRequest : public SSOAdminRequest {
 public:
  ...
  template <typename ApplicationArnT = Aws::String>
  PutApplicationAssignmentConfigurationRequest& WithApplicationArn(ApplicationArnT&& value) {
  ...
  inline PutApplicationAssignmentConfigurationRequest& WithAssignmentRequired(bool value) {
