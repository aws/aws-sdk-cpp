...
class GrantItem {
 public:
  ...
  inline void SetGrantType(GrantType value) {
    m_grantTypeHasBeenSet = true;
    m_grantType = value;
  }
  inline GrantItem& WithGrantType(GrantType value) {
    SetGrantType(value);
    return *this;
  }
  ///@}
  ...
  void SetGrant(GrantT&& value) {
    ...
    m_grant = std::forward<GrantT>(value);
  }
  template <typename GrantT = Grant>
  GrantItem& WithGrant(GrantT&& value) {
    SetGrant(std::forward<GrantT>(value));
    return *this;
  }
  ///@}
 private:
