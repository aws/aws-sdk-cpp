...
class GetInlinePolicyForPermissionSetRequest : public SSOAdminRequest {
 public:
  ...
  template <typename InstanceArnT = Aws::String>
  GetInlinePolicyForPermissionSetRequest& WithInstanceArn(InstanceArnT&& value) {
  ...
  template <typename PermissionSetArnT = Aws::String>
  GetInlinePolicyForPermissionSetRequest& WithPermissionSetArn(PermissionSetArnT&& value) {
