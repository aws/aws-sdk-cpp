...
namespace Model
{
  ...
  {
  public:
    AWS_SSOADMIN_API DeleteApplicationRequest();
     ...
     * Services General Reference</i>. </p>
     */
    inline DeleteApplicationRequest& WithApplicationArn(Aws::String&& value) { SetApplicationArn(std::move(value)); return *this;}
