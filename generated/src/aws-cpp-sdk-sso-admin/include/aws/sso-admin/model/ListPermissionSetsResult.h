...
class ListPermissionSetsResult {
 public:
  ...
  template <typename PermissionSetsT = Aws::Vector<Aws::String>>
  ListPermissionSetsResult& WithPermissionSets(PermissionSetsT&& value) {
    SetPermissionSets(std::forward<PermissionSetsT>(value));
    return *this;
  }
  template <typename PermissionSetsT = Aws::String>
  ListPermissionSetsResult& AddPermissionSets(PermissionSetsT&& value) {
    m_permissionSetsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListPermissionSetsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListPermissionSetsResult& WithRequestId(RequestIdT&& value) {
