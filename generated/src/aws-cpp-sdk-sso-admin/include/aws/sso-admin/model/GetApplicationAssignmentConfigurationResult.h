...
class GetApplicationAssignmentConfigurationResult {
 public:
  ...
  AWS_SSOADMIN_API GetApplicationAssignmentConfigurationResult& operator=(
  ...
  inline void SetAssignmentRequired(bool value) {
    m_assignmentRequiredHasBeenSet = true;
    m_assignmentRequired = value;
  }
  inline GetApplicationAssignmentConfigurationResult& WithAssignmentRequired(bool value) {
    SetAssignmentRequired(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetApplicationAssignmentConfigurationResult& WithRequestId(RequestIdT&& value) {
