...
class CreateApplicationAssignmentRequest : public SSOAdminRequest {
 public:
  ...
  template <typename ApplicationArnT = Aws::String>
  CreateApplicationAssignmentRequest& WithApplicationArn(ApplicationArnT&& value) {
  ...
  template <typename PrincipalIdT = Aws::String>
  CreateApplicationAssignmentRequest& WithPrincipalId(PrincipalIdT&& value) {
  ...
  inline CreateApplicationAssignmentRequest& WithPrincipalType(PrincipalType value) {
