...
class DescribeAccountAssignmentCreationStatusRequest : public SSOAdminRequest {
 public:
  ...
  template <typename InstanceArnT = Aws::String>
  DescribeAccountAssignmentCreationStatusRequest& WithInstanceArn(InstanceArnT&& value) {
  ...
  void SetAccountAssignmentCreationRequestId(AccountAssignmentCreationRequestIdT&& value) {
    m_accountAssignmentCreationRequestIdHasBeenSet = true;
    m_accountAssignmentCreationRequestId = std::forward<AccountAssignmentCreationRequestIdT>(value);
  }
  template <typename AccountAssignmentCreationRequestIdT = Aws::String>
  DescribeAccountAssignmentCreationStatusRequest& WithAccountAssignmentCreationRequestId(AccountAssignmentCreationRequestIdT&& value) {
    SetAccountAssignmentCreationRequestId(std::forward<AccountAssignmentCreationRequestIdT>(value));
    return *this;
  }
  ///@}
 private:
