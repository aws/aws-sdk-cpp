...
class DescribeApplicationProviderResult {
 public:
  ...
  void SetApplicationProviderArn(ApplicationProviderArnT&& value) {
    ...
    m_applicationProviderArn = std::forward<ApplicationProviderArnT>(value);
  }
  template <typename ApplicationProviderArnT = Aws::String>
  DescribeApplicationProviderResult& WithApplicationProviderArn(ApplicationProviderArnT&& value) {
    SetApplicationProviderArn(std::forward<ApplicationProviderArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetFederationProtocol(FederationProtocol value) {
    m_federationProtocolHasBeenSet = true;
    m_federationProtocol = value;
  }
  inline DescribeApplicationProviderResult& WithFederationProtocol(FederationProtocol value) {
    SetFederationProtocol(value);
    return *this;
  }
  ///@}
  ...
  void SetDisplayData(DisplayDataT&& value) {
    ...
    m_displayData = std::forward<DisplayDataT>(value);
  }
  template <typename DisplayDataT = DisplayData>
  DescribeApplicationProviderResult& WithDisplayData(DisplayDataT&& value) {
    SetDisplayData(std::forward<DisplayDataT>(value));
    return *this;
  }
  ///@}
  ...
  void SetResourceServerConfig(ResourceServerConfigT&& value) {
    ...
    m_resourceServerConfig = std::forward<ResourceServerConfigT>(value);
  }
  template <typename ResourceServerConfigT = ResourceServerConfig>
  DescribeApplicationProviderResult& WithResourceServerConfig(ResourceServerConfigT&& value) {
    SetResourceServerConfig(std::forward<ResourceServerConfigT>(value));
    return *this;
  }
  ///@}
