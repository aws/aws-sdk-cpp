...
class ListPermissionSetProvisioningStatusRequest : public SSOAdminRequest {
 public:
  ...
  template <typename InstanceArnT = Aws::String>
  ListPermissionSetProvisioningStatusRequest& WithInstanceArn(InstanceArnT&& value) {
  ...
  inline ListPermissionSetProvisioningStatusRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListPermissionSetProvisioningStatusRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename FilterT = OperationStatusFilter>
  ListPermissionSetProvisioningStatusRequest& WithFilter(FilterT&& value) {
