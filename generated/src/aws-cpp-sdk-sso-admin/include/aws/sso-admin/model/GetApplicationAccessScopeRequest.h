...
namespace Model
{
  ...
  public:
    ...
    template<typename ApplicationArnT = Aws::String>
    GetApplicationAccessScopeRequest& WithApplicationArn(ApplicationArnT&& value) { SetApplicationArn(std::forward<ApplicationArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ScopeT = Aws::String>
    GetApplicationAccessScopeRequest& WithScope(ScopeT&& value) { SetScope(std::forward<ScopeT>(value)); return *this;}
    ///@}
  private:
