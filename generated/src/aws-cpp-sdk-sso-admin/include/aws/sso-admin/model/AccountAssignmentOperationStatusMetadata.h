...
class AccountAssignmentOperationStatusMetadata {
 public:
  ...
  inline void SetStatus(StatusValues value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline AccountAssignmentOperationStatusMetadata& WithStatus(StatusValues value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  AccountAssignmentOperationStatusMetadata& WithRequestId(RequestIdT&& value) {
  ...
  template <typename CreatedDateT = Aws::Utils::DateTime>
  AccountAssignmentOperationStatusMetadata& WithCreatedDate(CreatedDateT&& value) {
