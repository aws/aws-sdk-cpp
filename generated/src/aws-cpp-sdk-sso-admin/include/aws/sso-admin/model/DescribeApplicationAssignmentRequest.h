...
class DescribeApplicationAssignmentRequest : public SSOAdminRequest {
 public:
  ...
  template <typename ApplicationArnT = Aws::String>
  DescribeApplicationAssignmentRequest& WithApplicationArn(ApplicationArnT&& value) {
  ...
  template <typename PrincipalIdT = Aws::String>
  DescribeApplicationAssignmentRequest& WithPrincipalId(PrincipalIdT&& value) {
  ...
  inline DescribeApplicationAssignmentRequest& WithPrincipalType(PrincipalType value) {
