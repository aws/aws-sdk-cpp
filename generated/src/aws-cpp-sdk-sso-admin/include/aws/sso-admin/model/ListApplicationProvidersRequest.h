...
class ListApplicationProvidersRequest : public SSOAdminRequest {
 public:
  AWS_SSOADMIN_API ListApplicationProvidersRequest() = default;
  ...
  inline ListApplicationProvidersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListApplicationProvidersRequest& WithNextToken(NextTokenT&& value) {
