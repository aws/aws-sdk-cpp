...
class ListApplicationAssignmentsRequest : public SSOAdminRequest {
 public:
  ...
  template <typename ApplicationArnT = Aws::String>
  ListApplicationAssignmentsRequest& WithApplicationArn(ApplicationArnT&& value) {
  ...
  inline ListApplicationAssignmentsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListApplicationAssignmentsRequest& WithNextToken(NextTokenT&& value) {
