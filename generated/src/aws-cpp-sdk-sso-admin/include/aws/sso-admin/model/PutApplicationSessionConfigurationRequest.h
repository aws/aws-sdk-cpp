...
class PutApplicationSessionConfigurationRequest : public SSOAdminRequest {
 public:
  ...
  template <typename ApplicationArnT = Aws::String>
  PutApplicationSessionConfigurationRequest& WithApplicationArn(ApplicationArnT&& value) {
   ...
   */
  inline UserBackgroundSessionApplicationStatus GetUserBackgroundSessionApplicationStatus() const {
    return m_userBackgroundSessionApplicationStatus;
  }
  ...
  inline void SetUserBackgroundSessionApplicationStatus(UserBackgroundSessionApplicationStatus value) {
    m_userBackgroundSessionApplicationStatusHasBeenSet = true;
    m_userBackgroundSessionApplicationStatus = value;
  }
  inline PutApplicationSessionConfigurationRequest& WithUserBackgroundSessionApplicationStatus(
      UserBackgroundSessionApplicationStatus value) {
    SetUserBackgroundSessionApplicationStatus(value);
    return *this;
  }
  ///@}
 private:
