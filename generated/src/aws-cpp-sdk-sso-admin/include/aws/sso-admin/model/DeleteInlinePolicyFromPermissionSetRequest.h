...
class DeleteInlinePolicyFromPermissionSetRequest : public SSOAdminRequest {
 public:
  ...
  template <typename InstanceArnT = Aws::String>
  DeleteInlinePolicyFromPermissionSetRequest& WithInstanceArn(InstanceArnT&& value) {
  ...
  template <typename PermissionSetArnT = Aws::String>
  DeleteInlinePolicyFromPermissionSetRequest& WithPermissionSetArn(PermissionSetArnT&& value) {
