...
namespace Model
{
  ...
  public:
    ...
    template<typename InstanceArnT = Aws::String>
    AttachCustomerManagedPolicyReferenceToPermissionSetRequest& WithInstanceArn(InstanceArnT&& value) { SetInstanceArn(std::forward<InstanceArnT>(value)); return *this;}
    ///@}
