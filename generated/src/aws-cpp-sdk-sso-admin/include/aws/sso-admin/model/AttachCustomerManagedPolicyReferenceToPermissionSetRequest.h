...
/**
 */
class AttachCustomerManagedPolicyReferenceToPermissionSetRequest : public SSOAdminRequest {
 public:
  AWS_SSOADMIN_API AttachCustomerManagedPolicyReferenceToPermissionSetRequest() = default;
  ...
  template <typename InstanceArnT = Aws::String>
  AttachCustomerManagedPolicyReferenceToPermissionSetRequest& WithInstanceArn(InstanceArnT&& value) {
  ...
  template <typename PermissionSetArnT = Aws::String>
  AttachCustomerManagedPolicyReferenceToPermissionSetRequest& WithPermissionSetArn(PermissionSetArnT&& value) {
  ...
  template <typename CustomerManagedPolicyReferenceT = CustomerManagedPolicyReference>
  AttachCustomerManagedPolicyReferenceToPermissionSetRequest& WithCustomerManagedPolicyReference(CustomerManagedPolicyReferenceT&& value) {
