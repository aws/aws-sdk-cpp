...
namespace SSOAdmin
{
   ...
   * 
   */
  class AWS_SSOADMIN_API SSOAdminClient : Aws::Client::ClientWithAsyncTemplateMethods<SSOAdminClient>,
    smithy::client::AwsSmithyClientT<Aws::SSOAdmin::SERVICE_NAME,
