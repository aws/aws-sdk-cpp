...
namespace SSOAdmin
{
const size_t SSOAdminEndpointRules::RulesBlobStrLen = 3442;
const size_t SSOAdminEndpointRules::RulesBlobSize = 3443;
...
'"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','s','s','o','.','{','R','e','g','i','o',
...
'o','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R','e','s','u',
