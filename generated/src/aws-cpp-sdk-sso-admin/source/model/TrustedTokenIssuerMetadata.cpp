...
TrustedTokenIssuerMetadata::TrustedTokenIssuerMetadata(JsonView jsonValue) { *this = jsonValue; }
...
TrustedTokenIssuerMetadata& TrustedTokenIssuerMetadata::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("TrustedTokenIssuerType")) {
    m_trustedTokenIssuerType =
        TrustedTokenIssuerTypeMapper::GetTrustedTokenIssuerTypeForName(jsonValue.GetString("TrustedTokenIssuerType"));
