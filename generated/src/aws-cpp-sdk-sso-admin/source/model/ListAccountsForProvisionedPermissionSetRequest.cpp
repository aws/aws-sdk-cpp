...
Aws::Http::HeaderValueCollection ListAccountsForProvisionedPermissionSetRequest::GetRequestSpecificHeaders() const
{
  Aws::Http::HeaderValueCollection headers;
  headers.insert(Aws::Http::HeaderValuePair("X-Amz-Target", "SWBExternalService.ListAccountsForProvisionedPermissionSet"));
  return headers;
