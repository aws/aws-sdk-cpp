...
ListApplicationGrantsResult::ListApplicationGrantsResult()
{
}

ListApplicationGrantsResult::ListApplicationGrantsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListApplicationGrantsResult& ListApplicationGrantsResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
