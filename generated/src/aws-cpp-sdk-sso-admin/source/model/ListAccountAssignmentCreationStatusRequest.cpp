...
Aws::Http::HeaderValueCollection ListAccountAssignmentCreationStatusRequest::GetRequestSpecificHeaders() const
{
  Aws::Http::HeaderValueCollection headers;
  headers.insert(Aws::Http::HeaderValuePair("X-Amz-Target", "SWBExternalService.ListAccountAssignmentCreationStatus"));
  return headers;
