...
Aws::Http::HeaderValueCollection ListCustomerManagedPolicyReferencesInPermissionSetRequest::GetRequestSpecificHeaders() const
{
  Aws::Http::HeaderValueCollection headers;
  headers.insert(Aws::Http::HeaderValuePair("X-Amz-Target", "SWBExternalService.ListCustomerManagedPolicyReferencesInPermissionSet"));
  return headers;
