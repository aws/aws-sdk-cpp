...
Aws::Http::HeaderValueCollection ListApplicationAssignmentsForPrincipalRequest::GetRequestSpecificHeaders() const
{
  Aws::Http::HeaderValueCollection headers;
  headers.insert(Aws::Http::HeaderValuePair("X-Amz-Target", "SWBExternalService.ListApplicationAssignmentsForPrincipal"));
  return headers;
