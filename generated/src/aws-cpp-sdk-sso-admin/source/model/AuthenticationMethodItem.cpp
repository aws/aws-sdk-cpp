...
AuthenticationMethodItem::AuthenticationMethodItem(JsonView jsonValue) { *this = jsonValue; }
...
AuthenticationMethodItem& AuthenticationMethodItem::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("AuthenticationMethodType")) {
    m_authenticationMethodType =
        AuthenticationMethodTypeMapper::GetAuthenticationMethodTypeForName(jsonValue.GetString("AuthenticationMethodType"));
