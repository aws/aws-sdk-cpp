...
ListAccountAssignmentDeletionStatusResult& ListAccountAssignmentDeletionStatusResult::operator=(
  ...
  if (jsonValue.ValueExists("AccountAssignmentsDeletionStatus")) {
    ...
    for (unsigned accountAssignmentsDeletionStatusIndex = 0;
         accountAssignmentsDeletionStatusIndex < accountAssignmentsDeletionStatusJsonList.GetLength();
         ++accountAssignmentsDeletionStatusIndex) {
      m_accountAssignmentsDeletionStatus.push_back(
          accountAssignmentsDeletionStatusJsonList[accountAssignmentsDeletionStatusIndex].AsObject());
    }
