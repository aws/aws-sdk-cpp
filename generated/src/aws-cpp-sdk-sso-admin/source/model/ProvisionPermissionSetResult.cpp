...
ProvisionPermissionSetResult::ProvisionPermissionSetResult()
{
}

ProvisionPermissionSetResult::ProvisionPermissionSetResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
