...
ListAccountAssignmentCreationStatusResult& ListAccountAssignmentCreationStatusResult::operator=(
  ...
  if (jsonValue.ValueExists("AccountAssignmentsCreationStatus")) {
    ...
    for (unsigned accountAssignmentsCreationStatusIndex = 0;
         accountAssignmentsCreationStatusIndex < accountAssignmentsCreationStatusJsonList.GetLength();
         ++accountAssignmentsCreationStatusIndex) {
      m_accountAssignmentsCreationStatus.push_back(
          accountAssignmentsCreationStatusJsonList[accountAssignmentsCreationStatusIndex].AsObject());
    }
