...
Aws::Http::HeaderValueCollection ListApplicationAssignmentsRequest::GetRequestSpecificHeaders() const
{
  Aws::Http::HeaderValueCollection headers;
  headers.insert(Aws::Http::HeaderValuePair("X-Amz-Target", "SWBExternalService.ListApplicationAssignments"));
  return headers;
