...
template <>
AWS_PCACONNECTORAD_API ConflictException PcaConnectorAdError::GetModeledError() {
  assert(this->GetErrorType() == PcaConnectorAdErrors::CONFLICT);
  return ConflictException(this->GetJsonPayload().View());
}

template <>
AWS_PCACONNECTORAD_API ThrottlingException PcaConnectorAdError::GetModeledError() {
  assert(this->GetErrorType() == PcaConnectorAdErrors::THROTTLING);
  return ThrottlingException(this->GetJsonPayload().View());
}

template <>
AWS_PCACONNECTORAD_API ServiceQuotaExceededException PcaConnectorAdError::GetModeledError() {
  assert(this->GetErrorType() == PcaConnectorAdErrors::SERVICE_QUOTA_EXCEEDED);
  return ServiceQuotaExceededException(this->GetJsonPayload().View());
}

template <>
AWS_PCACONNECTORAD_API ResourceNotFoundException PcaConnectorAdError::GetModeledError() {
  assert(this->GetErrorType() == PcaConnectorAdErrors::RESOURCE_NOT_FOUND);
  return ResourceNotFoundException(this->GetJsonPayload().View());
}

template <>
AWS_PCACONNECTORAD_API ValidationException PcaConnectorAdError::GetModeledError() {
