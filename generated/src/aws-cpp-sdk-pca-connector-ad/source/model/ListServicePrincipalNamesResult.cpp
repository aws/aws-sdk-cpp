...
ListServicePrincipalNamesResult::ListServicePrincipalNamesResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListServicePrincipalNamesResult& ListServicePrincipalNamesResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("ServicePrincipalNames")) {
    ...
    for (unsigned servicePrincipalNamesIndex = 0; servicePrincipalNamesIndex < servicePrincipalNamesJsonList.GetLength();
         ++servicePrincipalNamesIndex) {
