...
GetServicePrincipalNameResult::GetServicePrincipalNameResult()
{
}

GetServicePrincipalNameResult::GetServicePrincipalNameResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
