...
GetDirectoryRegistrationResult::GetDirectoryRegistrationResult()
{
}

GetDirectoryRegistrationResult::GetDirectoryRegistrationResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
