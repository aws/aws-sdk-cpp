...
PrivateKeyAttributesV2::PrivateKeyAttributesV2(JsonView jsonValue) { *this = jsonValue; }

PrivateKeyAttributesV2& PrivateKeyAttributesV2::operator=(JsonView jsonValue) {
...
JsonValue PrivateKeyAttributesV2::Jsonize() const {
  JsonValue payload;
