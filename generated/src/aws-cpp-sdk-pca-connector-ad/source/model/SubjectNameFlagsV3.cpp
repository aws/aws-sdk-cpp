...
SubjectNameFlagsV3::SubjectNameFlagsV3(JsonView jsonValue) { *this = jsonValue; }

SubjectNameFlagsV3& SubjectNameFlagsV3::operator=(JsonView jsonValue) {
...
JsonValue SubjectNameFlagsV3::Jsonize() const {
  JsonValue payload;
