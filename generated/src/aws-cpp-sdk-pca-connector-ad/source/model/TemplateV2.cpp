...
TemplateV2::TemplateV2(JsonView jsonValue) { *this = jsonValue; }

TemplateV2& TemplateV2::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("SupersededTemplates")) {
    ...
    for (unsigned supersededTemplatesIndex = 0; supersededTemplatesIndex < supersededTemplatesJsonList.GetLength();
         ++supersededTemplatesIndex) {
...
JsonValue TemplateV2::Jsonize() const {
  JsonValue payload;
