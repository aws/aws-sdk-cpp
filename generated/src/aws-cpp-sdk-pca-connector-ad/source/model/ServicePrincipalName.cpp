...
ServicePrincipalName::ServicePrincipalName(JsonView jsonValue) { *this = jsonValue; }
...
ServicePrincipalName& ServicePrincipalName::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("StatusReason")) {
    m_statusReason =
        ServicePrincipalNameStatusReasonMapper::GetServicePrincipalNameStatusReasonForName(jsonValue.GetString("StatusReason"));
