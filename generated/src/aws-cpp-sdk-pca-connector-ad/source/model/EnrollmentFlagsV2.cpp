...
EnrollmentFlagsV2::EnrollmentFlagsV2(JsonView jsonValue) { *this = jsonValue; }

EnrollmentFlagsV2& EnrollmentFlagsV2::operator=(JsonView jsonValue) {
...
JsonValue EnrollmentFlagsV2::Jsonize() const {
  JsonValue payload;
