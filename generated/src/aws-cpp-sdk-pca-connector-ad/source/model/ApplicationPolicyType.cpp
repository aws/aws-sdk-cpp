...
static const int EMBEDDED_WINDOWS_SYSTEM_COMPONENT_VERIFICATION_HASH =
    HashingUtils::HashString("EMBEDDED_WINDOWS_SYSTEM_COMPONENT_VERIFICATION");
...
static const int WINDOWS_HARDWARE_DRIVER_ATTESTED_VERIFICATION_HASH =
    HashingUtils::HashString("WINDOWS_HARDWARE_DRIVER_ATTESTED_VERIFICATION");
static const int WINDOWS_HARDWARE_DRIVER_EXTENDED_VERIFICATION_HASH =
    HashingUtils::HashString("WINDOWS_HARDWARE_DRIVER_EXTENDED_VERIFICATION");
