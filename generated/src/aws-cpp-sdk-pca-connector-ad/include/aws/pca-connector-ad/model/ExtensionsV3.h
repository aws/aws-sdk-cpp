...
/**
 * <p>Certificate extensions for v3 template schema</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/pca-connector-ad-2018-05-10/ExtensionsV3">AWS
 * API Reference</a></p>
 */
class ExtensionsV3 {
 public:
  ...
  void SetApplicationPolicies(ApplicationPoliciesT&& value) {
    m_applicationPoliciesHasBeenSet = true;
    m_applicationPolicies = std::forward<ApplicationPoliciesT>(value);
  }
  template <typename ApplicationPoliciesT = ApplicationPolicies>
  ExtensionsV3& WithApplicationPolicies(ApplicationPoliciesT&& value) {
    SetApplicationPolicies(std::forward<ApplicationPoliciesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename KeyUsageT = KeyUsage>
  ExtensionsV3& WithKeyUsage(KeyUsageT&& value) {
