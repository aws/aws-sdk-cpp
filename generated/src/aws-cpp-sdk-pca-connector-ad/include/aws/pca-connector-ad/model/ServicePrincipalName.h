...
class ServicePrincipalName {
 public:
  ...
  template <typename ConnectorArnT = Aws::String>
  ServicePrincipalName& WithConnectorArn(ConnectorArnT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  ServicePrincipalName& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename DirectoryRegistrationArnT = Aws::String>
  ServicePrincipalName& WithDirectoryRegistrationArn(DirectoryRegistrationArnT&& value) {
  ...
  inline void SetStatus(ServicePrincipalNameStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ServicePrincipalName& WithStatus(ServicePrincipalNameStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatusReason(ServicePrincipalNameStatusReason value) {
    m_statusReasonHasBeenSet = true;
    m_statusReason = value;
  }
  inline ServicePrincipalName& WithStatusReason(ServicePrincipalNameStatusReason value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  ServicePrincipalName& WithUpdatedAt(UpdatedAtT&& value) {
