 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/pca-connector-ad-2018-05-10/SubjectNameFlagsV2">AWS
 * API Reference</a></p>
 */
class SubjectNameFlagsV2 {
 public:
  AWS_PCACONNECTORAD_API SubjectNameFlagsV2() = default;
  AWS_PCACONNECTORAD_API SubjectNameFlagsV2(Aws::Utils::Json::JsonView jsonValue);
  AWS_PCACONNECTORAD_API SubjectNameFlagsV2& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  inline void SetRequireCommonName(bool value) {
    m_requireCommonNameHasBeenSet = true;
    m_requireCommonName = value;
  }
  inline SubjectNameFlagsV2& WithRequireCommonName(bool value) {
    SetRequireCommonName(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRequireDirectoryPath(bool value) {
    m_requireDirectoryPathHasBeenSet = true;
    m_requireDirectoryPath = value;
  }
  inline SubjectNameFlagsV2& WithRequireDirectoryPath(bool value) {
    SetRequireDirectoryPath(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRequireDnsAsCn(bool value) {
    m_requireDnsAsCnHasBeenSet = true;
    m_requireDnsAsCn = value;
  }
  inline SubjectNameFlagsV2& WithRequireDnsAsCn(bool value) {
    SetRequireDnsAsCn(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRequireEmail(bool value) {
    m_requireEmailHasBeenSet = true;
    m_requireEmail = value;
  }
  inline SubjectNameFlagsV2& WithRequireEmail(bool value) {
  ...
  inline void SetSanRequireDirectoryGuid(bool value) {
    m_sanRequireDirectoryGuidHasBeenSet = true;
    m_sanRequireDirectoryGuid = value;
  }
  inline SubjectNameFlagsV2& WithSanRequireDirectoryGuid(bool value) {
    SetSanRequireDirectoryGuid(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSanRequireDns(bool value) {
    m_sanRequireDnsHasBeenSet = true;
    m_sanRequireDns = value;
  }
  inline SubjectNameFlagsV2& WithSanRequireDns(bool value) {
    SetSanRequireDns(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSanRequireDomainDns(bool value) {
    m_sanRequireDomainDnsHasBeenSet = true;
    m_sanRequireDomainDns = value;
  }
  inline SubjectNameFlagsV2& WithSanRequireDomainDns(bool value) {
    SetSanRequireDomainDns(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSanRequireEmail(bool value) {
    m_sanRequireEmailHasBeenSet = true;
    m_sanRequireEmail = value;
  }
  inline SubjectNameFlagsV2& WithSanRequireEmail(bool value) {
    SetSanRequireEmail(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSanRequireSpn(bool value) {
    m_sanRequireSpnHasBeenSet = true;
    m_sanRequireSpn = value;
  }
  inline SubjectNameFlagsV2& WithSanRequireSpn(bool value) {
    SetSanRequireSpn(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSanRequireUpn(bool value) {
    m_sanRequireUpnHasBeenSet = true;
    m_sanRequireUpn = value;
  }
  inline SubjectNameFlagsV2& WithSanRequireUpn(bool value) {
    SetSanRequireUpn(value);
    return *this;
  }
  ///@}
 private:
