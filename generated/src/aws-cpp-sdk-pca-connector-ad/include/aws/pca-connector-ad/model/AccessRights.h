...
class AccessRights {
 public:
  ...
  inline void SetAutoEnroll(AccessRight value) {
    m_autoEnrollHasBeenSet = true;
    m_autoEnroll = value;
  }
  inline AccessRights& WithAutoEnroll(AccessRight value) {
    SetAutoEnroll(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEnroll(AccessRight value) {
    m_enrollHasBeenSet = true;
    m_enroll = value;
  }
  inline AccessRights& WithEnroll(AccessRight value) {
    SetEnroll(value);
    return *this;
  }
  ///@}
