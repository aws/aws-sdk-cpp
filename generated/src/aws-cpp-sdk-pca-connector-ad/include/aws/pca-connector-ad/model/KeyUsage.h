...
class KeyUsage {
 public:
  ...
  inline KeyUsage& WithCritical(bool value) {
    SetCritical(value);
    return *this;
  }
  ///@}
  ...
  void SetUsageFlags(UsageFlagsT&& value) {
    m_usageFlagsHasBeenSet = true;
    m_usageFlags = std::forward<UsageFlagsT>(value);
  }
  template <typename UsageFlagsT = KeyUsageFlags>
  KeyUsage& WithUsageFlags(UsageFlagsT&& value) {
    SetUsageFlags(std::forward<UsageFlagsT>(value));
    return *this;
  }
  ///@}
 private:
