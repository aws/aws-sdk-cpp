...
class TemplateDefinition {
 public:
  ...
  void SetTemplateV2(TemplateV2T&& value) {
    m_templateV2HasBeenSet = true;
    m_templateV2 = std::forward<TemplateV2T>(value);
  }
  template <typename TemplateV2T = TemplateV2>
  TemplateDefinition& WithTemplateV2(TemplateV2T&& value) {
    SetTemplateV2(std::forward<TemplateV2T>(value));
    return *this;
  }
  ///@}
  ...
  void SetTemplateV3(TemplateV3T&& value) {
    m_templateV3HasBeenSet = true;
    m_templateV3 = std::forward<TemplateV3T>(value);
  }
  template <typename TemplateV3T = TemplateV3>
  TemplateDefinition& WithTemplateV3(TemplateV3T&& value) {
    SetTemplateV3(std::forward<TemplateV3T>(value));
    return *this;
  }
  ///@}
  ...
  void SetTemplateV4(TemplateV4T&& value) {
    m_templateV4HasBeenSet = true;
    m_templateV4 = std::forward<TemplateV4T>(value);
  }
  template <typename TemplateV4T = TemplateV4>
  TemplateDefinition& WithTemplateV4(TemplateV4T&& value) {
    SetTemplateV4(std::forward<TemplateV4T>(value));
    return *this;
  }
  ///@}
 private:
