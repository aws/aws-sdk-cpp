...
class GetTemplateGroupAccessControlEntryRequest : public PcaConnectorAdRequest {
 public:
  ...
  template <typename GroupSecurityIdentifierT = Aws::String>
  GetTemplateGroupAccessControlEntryRequest& WithGroupSecurityIdentifier(GroupSecurityIdentifierT&& value) {
  ...
  template <typename TemplateArnT = Aws::String>
  GetTemplateGroupAccessControlEntryRequest& WithTemplateArn(TemplateArnT&& value) {
