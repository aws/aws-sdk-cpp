...
class ListDirectoryRegistrationsRequest : public PcaConnectorAdRequest {
 public:
  AWS_PCACONNECTORAD_API ListDirectoryRegistrationsRequest() = default;
  ...
  inline ListDirectoryRegistrationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListDirectoryRegistrationsRequest& WithNextToken(NextTokenT&& value) {
