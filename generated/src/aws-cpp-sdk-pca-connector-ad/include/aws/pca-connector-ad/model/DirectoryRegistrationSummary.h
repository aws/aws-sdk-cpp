...
class DirectoryRegistrationSummary {
 public:
  ...
  template <typename ArnT = Aws::String>
  DirectoryRegistrationSummary& WithArn(ArnT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  DirectoryRegistrationSummary& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename DirectoryIdT = Aws::String>
  DirectoryRegistrationSummary& WithDirectoryId(DirectoryIdT&& value) {
  ...
  inline DirectoryRegistrationSummary& WithStatus(DirectoryRegistrationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline DirectoryRegistrationSummary& WithStatusReason(DirectoryRegistrationStatusReason value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  DirectoryRegistrationSummary& WithUpdatedAt(UpdatedAtT&& value) {
