...
namespace Model
{
  ...
  {
  public:
    AWS_PCACONNECTORAD_API DirectoryRegistrationSummary() = default;
    ...
    template<typename ArnT = Aws::String>
    DirectoryRegistrationSummary& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename CreatedAtT = Aws::Utils::DateTime>
    DirectoryRegistrationSummary& WithCreatedAt(CreatedAtT&& value) { SetCreatedAt(std::forward<CreatedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename DirectoryIdT = Aws::String>
    DirectoryRegistrationSummary& WithDirectoryId(DirectoryIdT&& value) { SetDirectoryId(std::forward<DirectoryIdT>(value)); return *this;}
    ///@}
    ...
    inline DirectoryRegistrationSummary& WithStatus(DirectoryRegistrationStatus value) { SetStatus(value); return *this;}
    ///@}
    ...
    inline DirectoryRegistrationSummary& WithStatusReason(DirectoryRegistrationStatusReason value) { SetStatusReason(value); return *this;}
    ///@}
    ...
    template<typename UpdatedAtT = Aws::Utils::DateTime>
    DirectoryRegistrationSummary& WithUpdatedAt(UpdatedAtT&& value) { SetUpdatedAt(std::forward<UpdatedAtT>(value)); return *this;}
    ///@}
  private:
