...
class TemplateSummary {
 public:
  ...
  template <typename ConnectorArnT = Aws::String>
  TemplateSummary& WithConnectorArn(ConnectorArnT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  TemplateSummary& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename DefinitionT = TemplateDefinition>
  TemplateSummary& WithDefinition(DefinitionT&& value) {
  ...
  template <typename ObjectIdentifierT = Aws::String>
  TemplateSummary& WithObjectIdentifier(ObjectIdentifierT&& value) {
  ...
  inline void SetPolicySchema(int value) {
    m_policySchemaHasBeenSet = true;
    m_policySchema = value;
  }
  inline TemplateSummary& WithPolicySchema(int value) {
    SetPolicySchema(value);
    return *this;
  }
  ///@}
  ...
  template <typename RevisionT = TemplateRevision>
  TemplateSummary& WithRevision(RevisionT&& value) {
  ...
  inline void SetStatus(TemplateStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline TemplateSummary& WithStatus(TemplateStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
