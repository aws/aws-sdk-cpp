...
class CertificateValidity {
 public:
  ...
  void SetRenewalPeriod(RenewalPeriodT&& value) {
    m_renewalPeriodHasBeenSet = true;
    m_renewalPeriod = std::forward<RenewalPeriodT>(value);
  }
  template <typename RenewalPeriodT = ValidityPeriod>
  CertificateValidity& WithRenewalPeriod(RenewalPeriodT&& value) {
    SetRenewalPeriod(std::forward<RenewalPeriodT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ValidityPeriodT = ValidityPeriod>
  CertificateValidity& WithValidityPeriod(ValidityPeriodT&& value) {
