...
class AccessControlEntry {
 public:
  ...
  template <typename AccessRightsT = AccessRights>
  AccessControlEntry& WithAccessRights(AccessRightsT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  AccessControlEntry& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename GroupDisplayNameT = Aws::String>
  AccessControlEntry& WithGroupDisplayName(GroupDisplayNameT&& value) {
  ...
  template <typename GroupSecurityIdentifierT = Aws::String>
  AccessControlEntry& WithGroupSecurityIdentifier(GroupSecurityIdentifierT&& value) {
  ...
  template <typename TemplateArnT = Aws::String>
  AccessControlEntry& WithTemplateArn(TemplateArnT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  AccessControlEntry& WithUpdatedAt(UpdatedAtT&& value) {
