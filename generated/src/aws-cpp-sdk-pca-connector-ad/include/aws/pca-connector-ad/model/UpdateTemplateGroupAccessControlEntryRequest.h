...
class UpdateTemplateGroupAccessControlEntryRequest : public PcaConnectorAdRequest {
 public:
  ...
  template <typename AccessRightsT = AccessRights>
  UpdateTemplateGroupAccessControlEntryRequest& WithAccessRights(AccessRightsT&& value) {
  ...
  template <typename GroupDisplayNameT = Aws::String>
  UpdateTemplateGroupAccessControlEntryRequest& WithGroupDisplayName(GroupDisplayNameT&& value) {
  ...
  template <typename GroupSecurityIdentifierT = Aws::String>
  UpdateTemplateGroupAccessControlEntryRequest& WithGroupSecurityIdentifier(GroupSecurityIdentifierT&& value) {
  ...
  template <typename TemplateArnT = Aws::String>
  UpdateTemplateGroupAccessControlEntryRequest& WithTemplateArn(TemplateArnT&& value) {
