...
class PrivateKeyAttributesV3 {
 public:
  ...
  inline void SetAlgorithm(PrivateKeyAlgorithm value) {
    m_algorithmHasBeenSet = true;
    m_algorithm = value;
  }
  inline PrivateKeyAttributesV3& WithAlgorithm(PrivateKeyAlgorithm value) {
    SetAlgorithm(value);
    return *this;
  }
  ///@}
  ...
  void SetCryptoProviders(CryptoProvidersT&& value) {
    m_cryptoProvidersHasBeenSet = true;
    m_cryptoProviders = std::forward<CryptoProvidersT>(value);
  }
  template <typename CryptoProvidersT = Aws::Vector<Aws::String>>
  PrivateKeyAttributesV3& WithCryptoProviders(CryptoProvidersT&& value) {
    SetCryptoProviders(std::forward<CryptoProvidersT>(value));
    return *this;
  }
  template <typename CryptoProvidersT = Aws::String>
  PrivateKeyAttributesV3& AddCryptoProviders(CryptoProvidersT&& value) {
    m_cryptoProvidersHasBeenSet = true;
    m_cryptoProviders.emplace_back(std::forward<CryptoProvidersT>(value));
    return *this;
  }
  ///@}
  ...
  inline PrivateKeyAttributesV3& WithKeySpec(KeySpec value) {
    SetKeySpec(value);
    return *this;
  }
  ///@}
  ...
  void SetKeyUsageProperty(KeyUsagePropertyT&& value) {
    m_keyUsagePropertyHasBeenSet = true;
    m_keyUsageProperty = std::forward<KeyUsagePropertyT>(value);
  }
  template <typename KeyUsagePropertyT = KeyUsageProperty>
  PrivateKeyAttributesV3& WithKeyUsageProperty(KeyUsagePropertyT&& value) {
    SetKeyUsageProperty(std::forward<KeyUsagePropertyT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetMinimalKeyLength(int value) {
    m_minimalKeyLengthHasBeenSet = true;
    m_minimalKeyLength = value;
  }
  inline PrivateKeyAttributesV3& WithMinimalKeyLength(int value) {
    SetMinimalKeyLength(value);
    return *this;
  }
  ///@}
 private:
