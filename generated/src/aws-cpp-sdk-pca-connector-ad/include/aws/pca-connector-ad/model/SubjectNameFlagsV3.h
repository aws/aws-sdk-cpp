...
class SubjectNameFlagsV3 {
 public:
  ...
  inline SubjectNameFlagsV3& WithRequireCommonName(bool value) {
  ...
  inline SubjectNameFlagsV3& WithRequireDirectoryPath(bool value) {
  ...
  inline SubjectNameFlagsV3& WithRequireDnsAsCn(bool value) {
  ...
  inline SubjectNameFlagsV3& WithRequireEmail(bool value) {
  ...
  inline SubjectNameFlagsV3& WithSanRequireDirectoryGuid(bool value) {
  ...
  inline SubjectNameFlagsV3& WithSanRequireDns(bool value) {
  ...
  inline SubjectNameFlagsV3& WithSanRequireDomainDns(bool value) {
  ...
  inline SubjectNameFlagsV3& WithSanRequireEmail(bool value) {
  ...
  inline SubjectNameFlagsV3& WithSanRequireSpn(bool value) {
  ...
  inline SubjectNameFlagsV3& WithSanRequireUpn(bool value) {
