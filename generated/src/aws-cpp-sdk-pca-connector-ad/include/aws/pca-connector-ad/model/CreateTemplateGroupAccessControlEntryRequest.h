...
class CreateTemplateGroupAccessControlEntryRequest : public PcaConnectorAdRequest {
 public:
  ...
  void SetAccessRights(AccessRightsT&& value) {
    m_accessRightsHasBeenSet = true;
    m_accessRights = std::forward<AccessRightsT>(value);
  }
  template <typename AccessRightsT = AccessRights>
  CreateTemplateGroupAccessControlEntryRequest& WithAccessRights(AccessRightsT&& value) {
    SetAccessRights(std::forward<AccessRightsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ClientTokenT = Aws::String>
  CreateTemplateGroupAccessControlEntryRequest& WithClientToken(ClientTokenT&& value) {
  ...
  void SetGroupDisplayName(GroupDisplayNameT&& value) {
    m_groupDisplayNameHasBeenSet = true;
    m_groupDisplayName = std::forward<GroupDisplayNameT>(value);
  }
  template <typename GroupDisplayNameT = Aws::String>
  CreateTemplateGroupAccessControlEntryRequest& WithGroupDisplayName(GroupDisplayNameT&& value) {
    SetGroupDisplayName(std::forward<GroupDisplayNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGroupSecurityIdentifier(GroupSecurityIdentifierT&& value) {
    m_groupSecurityIdentifierHasBeenSet = true;
    m_groupSecurityIdentifier = std::forward<GroupSecurityIdentifierT>(value);
  }
  template <typename GroupSecurityIdentifierT = Aws::String>
  CreateTemplateGroupAccessControlEntryRequest& WithGroupSecurityIdentifier(GroupSecurityIdentifierT&& value) {
    SetGroupSecurityIdentifier(std::forward<GroupSecurityIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TemplateArnT = Aws::String>
  CreateTemplateGroupAccessControlEntryRequest& WithTemplateArn(TemplateArnT&& value) {
