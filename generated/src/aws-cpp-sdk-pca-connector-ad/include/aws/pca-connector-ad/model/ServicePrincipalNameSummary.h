...
class ServicePrincipalNameSummary {
 public:
  ...
  template <typename ConnectorArnT = Aws::String>
  ServicePrincipalNameSummary& WithConnectorArn(ConnectorArnT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  ServicePrincipalNameSummary& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename DirectoryRegistrationArnT = Aws::String>
  ServicePrincipalNameSummary& WithDirectoryRegistrationArn(DirectoryRegistrationArnT&& value) {
  ...
  inline ServicePrincipalNameSummary& WithStatus(ServicePrincipalNameStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline ServicePrincipalNameSummary& WithStatusReason(ServicePrincipalNameStatusReason value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  ServicePrincipalNameSummary& WithUpdatedAt(UpdatedAtT&& value) {
