...
class AccessControlEntrySummary {
 public:
  ...
  template <typename AccessRightsT = AccessRights>
  AccessControlEntrySummary& WithAccessRights(AccessRightsT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  AccessControlEntrySummary& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename GroupDisplayNameT = Aws::String>
  AccessControlEntrySummary& WithGroupDisplayName(GroupDisplayNameT&& value) {
  ...
  template <typename GroupSecurityIdentifierT = Aws::String>
  AccessControlEntrySummary& WithGroupSecurityIdentifier(GroupSecurityIdentifierT&& value) {
  ...
  template <typename TemplateArnT = Aws::String>
  AccessControlEntrySummary& WithTemplateArn(TemplateArnT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  AccessControlEntrySummary& WithUpdatedAt(UpdatedAtT&& value) {
