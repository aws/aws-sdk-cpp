...
namespace Model
{
  ...
  public:
    ...
    inline GeneralFlagsV2& WithAutoEnrollment(bool value) { SetAutoEnrollment(value); return *this;}
    ///@}
    ...
    inline GeneralFlagsV2& WithMachineType(bool value) { SetMachineType(value); return *this;}
    ///@}
  private:
