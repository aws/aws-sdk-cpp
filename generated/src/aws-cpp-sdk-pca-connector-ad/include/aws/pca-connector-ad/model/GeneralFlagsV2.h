...
/**
 * <p>General flags for v2 template schema that defines if the template is for a
 * machine or a user and if the template can be issued using
 * autoenrollment.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/pca-connector-ad-2018-05-10/GeneralFlagsV2">AWS
 * API Reference</a></p>
 */
class GeneralFlagsV2 {
 public:
  AWS_PCACONNECTORAD_API GeneralFlagsV2() = default;
  AWS_PCACONNECTORAD_API GeneralFlagsV2(Aws::Utils::Json::JsonView jsonValue);
  AWS_PCACONNECTORAD_API GeneralFlagsV2& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  inline void SetAutoEnrollment(bool value) {
    m_autoEnrollmentHasBeenSet = true;
    m_autoEnrollment = value;
  }
  inline GeneralFlagsV2& WithAutoEnrollment(bool value) {
  ...
  inline void SetMachineType(bool value) {
    m_machineTypeHasBeenSet = true;
    m_machineType = value;
  }
  inline GeneralFlagsV2& WithMachineType(bool value) {
