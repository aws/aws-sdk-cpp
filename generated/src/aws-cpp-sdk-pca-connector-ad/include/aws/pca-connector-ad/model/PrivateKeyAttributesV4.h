...
namespace Model
{
  ...
  {
  public:
    AWS_PCACONNECTORAD_API PrivateKeyAttributesV4() = default;
    ...
    inline PrivateKeyAttributesV4& WithAlgorithm(PrivateKeyAlgorithm value) { SetAlgorithm(value); return *this;}
    ///@}
    ...
    template<typename CryptoProvidersT = Aws::Vector<Aws::String>>
    PrivateKeyAttributesV4& WithCryptoProviders(CryptoProvidersT&& value) { SetCryptoProviders(std::forward<CryptoProvidersT>(value)); return *this;}
    template<typename CryptoProvidersT = Aws::String>
    PrivateKeyAttributesV4& AddCryptoProviders(CryptoProvidersT&& value) { m_cryptoProvidersHasBeenSet = true; m_cryptoProviders.emplace_back(std::forward<CryptoProvidersT>(value)); return *this; }
    ///@}
    ...
    inline PrivateKeyAttributesV4& WithKeySpec(KeySpec value) { SetKeySpec(value); return *this;}
    ///@}
    ...
    template<typename KeyUsagePropertyT = KeyUsageProperty>
    PrivateKeyAttributesV4& WithKeyUsageProperty(KeyUsagePropertyT&& value) { SetKeyUsageProperty(std::forward<KeyUsagePropertyT>(value)); return *this;}
    ///@}
