...
class PrivateKeyAttributesV4 {
 public:
  ...
  inline PrivateKeyAttributesV4& WithAlgorithm(PrivateKeyAlgorithm value) {
    SetAlgorithm(value);
    return *this;
  }
  ///@}
  ...
  template <typename CryptoProvidersT = Aws::Vector<Aws::String>>
  PrivateKeyAttributesV4& WithCryptoProviders(CryptoProvidersT&& value) {
    SetCryptoProviders(std::forward<CryptoProvidersT>(value));
    return *this;
  }
  template <typename CryptoProvidersT = Aws::String>
  PrivateKeyAttributesV4& AddCryptoProviders(CryptoProvidersT&& value) {
    m_cryptoProvidersHasBeenSet = true;
  ...
  inline PrivateKeyAttributesV4& WithKeySpec(KeySpec value) {
    SetKeySpec(value);
    return *this;
  }
  ///@}
  ...
  template <typename KeyUsagePropertyT = KeyUsageProperty>
  PrivateKeyAttributesV4& WithKeyUsageProperty(KeyUsagePropertyT&& value) {
  ...
  inline PrivateKeyAttributesV4& WithMinimalKeyLength(int value) {
