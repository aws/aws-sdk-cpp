...
class DeleteTemplateGroupAccessControlEntryRequest : public PcaConnectorAdRequest {
 public:
  ...
  template <typename GroupSecurityIdentifierT = Aws::String>
  DeleteTemplateGroupAccessControlEntryRequest& WithGroupSecurityIdentifier(GroupSecurityIdentifierT&& value) {
  ...
  template <typename TemplateArnT = Aws::String>
  DeleteTemplateGroupAccessControlEntryRequest& WithTemplateArn(TemplateArnT&& value) {
