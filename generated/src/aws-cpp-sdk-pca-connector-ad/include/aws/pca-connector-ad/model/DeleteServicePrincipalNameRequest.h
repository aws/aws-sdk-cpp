...
class DeleteServicePrincipalNameRequest : public PcaConnectorAdRequest {
 public:
  ...
  template <typename ConnectorArnT = Aws::String>
  DeleteServicePrincipalNameRequest& WithConnectorArn(ConnectorArnT&& value) {
  ...
  template <typename DirectoryRegistrationArnT = Aws::String>
  DeleteServicePrincipalNameRequest& WithDirectoryRegistrationArn(DirectoryRegistrationArnT&& value) {
