...
class CreateDirectoryRegistrationRequest : public PcaConnectorAdRequest {
 public:
  AWS_PCACONNECTORAD_API CreateDirectoryRegistrationRequest() = default;
  ...
  template <typename ClientTokenT = Aws::String>
  CreateDirectoryRegistrationRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename DirectoryIdT = Aws::String>
  CreateDirectoryRegistrationRequest& WithDirectoryId(DirectoryIdT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateDirectoryRegistrationRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsKeyT = Aws::String, typename TagsValueT = Aws::String>
  CreateDirectoryRegistrationRequest& AddTags(TagsKeyT&& key, TagsValueT&& value) {
    m_tagsHasBeenSet = true;
