...
class PrivateKeyAttributesV2 {
 public:
  ...
  template <typename CryptoProvidersT = Aws::Vector<Aws::String>>
  PrivateKeyAttributesV2& WithCryptoProviders(CryptoProvidersT&& value) {
    SetCryptoProviders(std::forward<CryptoProvidersT>(value));
    return *this;
  }
  template <typename CryptoProvidersT = Aws::String>
  PrivateKeyAttributesV2& AddCryptoProviders(CryptoProvidersT&& value) {
    m_cryptoProvidersHasBeenSet = true;
  ...
  inline PrivateKeyAttributesV2& WithKeySpec(KeySpec value) {
    SetKeySpec(value);
    return *this;
  }
  ///@}
  ...
  inline PrivateKeyAttributesV2& WithMinimalKeyLength(int value) {
