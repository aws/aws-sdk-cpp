...
class PrivateKeyFlagsV3 {
 public:
  ...
  inline void SetClientVersion(ClientCompatibilityV3 value) {
    m_clientVersionHasBeenSet = true;
    m_clientVersion = value;
  }
  inline PrivateKeyFlagsV3& WithClientVersion(ClientCompatibilityV3 value) {
  ...
  inline PrivateKeyFlagsV3& WithExportableKey(bool value) {
  ...
  inline PrivateKeyFlagsV3& WithRequireAlternateSignatureAlgorithm(bool value) {
  ...
  inline PrivateKeyFlagsV3& WithStrongKeyProtectionRequired(bool value) {
