...
class TemplateV2 {
 public:
  ...
  template <typename CertificateValidityT = CertificateValidity>
  TemplateV2& WithCertificateValidity(CertificateValidityT&& value) {
  ...
  template <typename EnrollmentFlagsT = EnrollmentFlagsV2>
  TemplateV2& WithEnrollmentFlags(EnrollmentFlagsT&& value) {
  ...
  template <typename ExtensionsT = ExtensionsV2>
  TemplateV2& WithExtensions(ExtensionsT&& value) {
  ...
  template <typename GeneralFlagsT = GeneralFlagsV2>
  TemplateV2& WithGeneralFlags(GeneralFlagsT&& value) {
  ...
  template <typename PrivateKeyAttributesT = PrivateKeyAttributesV2>
  TemplateV2& WithPrivateKeyAttributes(PrivateKeyAttributesT&& value) {
  ...
  template <typename PrivateKeyFlagsT = PrivateKeyFlagsV2>
  TemplateV2& WithPrivateKeyFlags(PrivateKeyFlagsT&& value) {
  ...
  template <typename SubjectNameFlagsT = SubjectNameFlagsV2>
  TemplateV2& WithSubjectNameFlags(SubjectNameFlagsT&& value) {
  ...
  template <typename SupersededTemplatesT = Aws::Vector<Aws::String>>
  TemplateV2& WithSupersededTemplates(SupersededTemplatesT&& value) {
    SetSupersededTemplates(std::forward<SupersededTemplatesT>(value));
    return *this;
  }
  template <typename SupersededTemplatesT = Aws::String>
  TemplateV2& AddSupersededTemplates(SupersededTemplatesT&& value) {
    m_supersededTemplatesHasBeenSet = true;
