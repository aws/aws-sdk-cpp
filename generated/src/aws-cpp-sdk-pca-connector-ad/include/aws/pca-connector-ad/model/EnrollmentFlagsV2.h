...
class EnrollmentFlagsV2 {
 public:
  ...
  inline EnrollmentFlagsV2& WithEnableKeyReuseOnNtTokenKeysetStorageFull(bool value) {
  ...
  inline EnrollmentFlagsV2& WithIncludeSymmetricAlgorithms(bool value) {
  ...
  inline EnrollmentFlagsV2& WithNoSecurityExtension(bool value) {
  ...
  inline EnrollmentFlagsV2& WithRemoveInvalidCertificateFromPersonalStore(bool value) {
  ...
  inline EnrollmentFlagsV2& WithUserInteractionRequired(bool value) {
