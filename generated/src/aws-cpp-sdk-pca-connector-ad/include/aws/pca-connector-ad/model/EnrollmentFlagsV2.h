...
namespace Model
{
  ...
  /**
   * <p>Template configurations for v2 template schema.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/pca-connector-ad-2018-05-10/EnrollmentFlagsV2">AWS
   * API Reference</a></p>
   */
  class EnrollmentFlagsV2
  {
  public:
    AWS_PCACONNECTORAD_API EnrollmentFlagsV2() = default;
    AWS_PCACONNECTORAD_API EnrollmentFlagsV2(Aws::Utils::Json::JsonView jsonValue);
    AWS_PCACONNECTORAD_API EnrollmentFlagsV2& operator=(Aws::Utils::Json::JsonView jsonValue);
    ...
    inline EnrollmentFlagsV2& WithEnableKeyReuseOnNtTokenKeysetStorageFull(bool value) { SetEnableKeyReuseOnNtTokenKeysetStorageFull(value); return *this;}
    ///@}
    ...
    inline EnrollmentFlagsV2& WithIncludeSymmetricAlgorithms(bool value) { SetIncludeSymmetricAlgorithms(value); return *this;}
    ///@}
    ...
    inline EnrollmentFlagsV2& WithNoSecurityExtension(bool value) { SetNoSecurityExtension(value); return *this;}
    ///@}
    ...
    inline EnrollmentFlagsV2& WithRemoveInvalidCertificateFromPersonalStore(bool value) { SetRemoveInvalidCertificateFromPersonalStore(value); return *this;}
    ///@}
    ...
    inline EnrollmentFlagsV2& WithUserInteractionRequired(bool value) { SetUserInteractionRequired(value); return *this;}
    ///@}
  private:
