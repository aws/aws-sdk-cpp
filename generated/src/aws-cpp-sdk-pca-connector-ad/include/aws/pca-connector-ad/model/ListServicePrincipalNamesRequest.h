...
class ListServicePrincipalNamesRequest : public PcaConnectorAdRequest {
 public:
  ...
  template <typename DirectoryRegistrationArnT = Aws::String>
  ListServicePrincipalNamesRequest& WithDirectoryRegistrationArn(DirectoryRegistrationArnT&& value) {
  ...
  inline ListServicePrincipalNamesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListServicePrincipalNamesRequest& WithNextToken(NextTokenT&& value) {
