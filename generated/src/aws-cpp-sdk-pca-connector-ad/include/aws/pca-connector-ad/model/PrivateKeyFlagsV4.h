...
class PrivateKeyFlagsV4 {
 public:
  ...
  inline void SetClientVersion(ClientCompatibilityV4 value) {
    m_clientVersionHasBeenSet = true;
    m_clientVersion = value;
  }
  inline PrivateKeyFlagsV4& WithClientVersion(ClientCompatibilityV4 value) {
  ...
  inline void SetExportableKey(bool value) {
    m_exportableKeyHasBeenSet = true;
    m_exportableKey = value;
  }
  inline PrivateKeyFlagsV4& WithExportableKey(bool value) {
    SetExportableKey(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRequireAlternateSignatureAlgorithm(bool value) {
    m_requireAlternateSignatureAlgorithmHasBeenSet = true;
    m_requireAlternateSignatureAlgorithm = value;
  }
  inline PrivateKeyFlagsV4& WithRequireAlternateSignatureAlgorithm(bool value) {
    SetRequireAlternateSignatureAlgorithm(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRequireSameKeyRenewal(bool value) {
    m_requireSameKeyRenewalHasBeenSet = true;
    m_requireSameKeyRenewal = value;
  }
  inline PrivateKeyFlagsV4& WithRequireSameKeyRenewal(bool value) {
    SetRequireSameKeyRenewal(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStrongKeyProtectionRequired(bool value) {
    m_strongKeyProtectionRequiredHasBeenSet = true;
    m_strongKeyProtectionRequired = value;
  }
  inline PrivateKeyFlagsV4& WithStrongKeyProtectionRequired(bool value) {
    SetStrongKeyProtectionRequired(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUseLegacyProvider(bool value) {
    m_useLegacyProviderHasBeenSet = true;
    m_useLegacyProvider = value;
  }
  inline PrivateKeyFlagsV4& WithUseLegacyProvider(bool value) {
    SetUseLegacyProvider(value);
    return *this;
  }
  ///@}
 private:
