...
namespace Model
{
  ...
  {
  public:
    AWS_PCACONNECTORAD_API CreateTemplateRequest() = default;
    ...
    template<typename ConnectorArnT = Aws::String>
    CreateTemplateRequest& WithConnectorArn(ConnectorArnT&& value) { SetConnectorArn(std::forward<ConnectorArnT>(value)); return *this;}
    ///@}
