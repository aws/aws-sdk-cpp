...
class TemplateV4 {
 public:
  ...
  template <typename CertificateValidityT = CertificateValidity>
  TemplateV4& WithCertificateValidity(CertificateValidityT&& value) {
  ...
  template <typename EnrollmentFlagsT = EnrollmentFlagsV4>
  TemplateV4& WithEnrollmentFlags(EnrollmentFlagsT&& value) {
  ...
  template <typename ExtensionsT = ExtensionsV4>
  TemplateV4& WithExtensions(ExtensionsT&& value) {
  ...
  template <typename GeneralFlagsT = GeneralFlagsV4>
  TemplateV4& WithGeneralFlags(GeneralFlagsT&& value) {
  ...
  inline TemplateV4& WithHashAlgorithm(HashAlgorithm value) {
  ...
  template <typename PrivateKeyAttributesT = PrivateKeyAttributesV4>
  TemplateV4& WithPrivateKeyAttributes(PrivateKeyAttributesT&& value) {
  ...
  template <typename PrivateKeyFlagsT = PrivateKeyFlagsV4>
  TemplateV4& WithPrivateKeyFlags(PrivateKeyFlagsT&& value) {
  ...
  template <typename SubjectNameFlagsT = SubjectNameFlagsV4>
  TemplateV4& WithSubjectNameFlags(SubjectNameFlagsT&& value) {
  ...
  template <typename SupersededTemplatesT = Aws::Vector<Aws::String>>
  TemplateV4& WithSupersededTemplates(SupersededTemplatesT&& value) {
    SetSupersededTemplates(std::forward<SupersededTemplatesT>(value));
    return *this;
  }
  template <typename SupersededTemplatesT = Aws::String>
  TemplateV4& AddSupersededTemplates(SupersededTemplatesT&& value) {
    m_supersededTemplatesHasBeenSet = true;
