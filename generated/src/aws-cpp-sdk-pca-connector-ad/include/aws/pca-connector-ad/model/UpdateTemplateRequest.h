...
class UpdateTemplateRequest : public PcaConnectorAdRequest {
 public:
  ...
  inline void SetReenrollAllCertificateHolders(bool value) {
    m_reenrollAllCertificateHoldersHasBeenSet = true;
    m_reenrollAllCertificateHolders = value;
  }
  inline UpdateTemplateRequest& WithReenrollAllCertificateHolders(bool value) {
    SetReenrollAllCertificateHolders(value);
    return *this;
  }
  ///@}
  ...
  template <typename TemplateArnT = Aws::String>
  UpdateTemplateRequest& WithTemplateArn(TemplateArnT&& value) {
