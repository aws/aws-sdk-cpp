...
class TemplateV3 {
 public:
  ...
  void SetCertificateValidity(CertificateValidityT&& value) {
    m_certificateValidityHasBeenSet = true;
    m_certificateValidity = std::forward<CertificateValidityT>(value);
  }
  template <typename CertificateValidityT = CertificateValidity>
  TemplateV3& WithCertificateValidity(CertificateValidityT&& value) {
    SetCertificateValidity(std::forward<CertificateValidityT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEnrollmentFlags(EnrollmentFlagsT&& value) {
    m_enrollmentFlagsHasBeenSet = true;
    m_enrollmentFlags = std::forward<EnrollmentFlagsT>(value);
  }
  template <typename EnrollmentFlagsT = EnrollmentFlagsV3>
  TemplateV3& WithEnrollmentFlags(EnrollmentFlagsT&& value) {
    SetEnrollmentFlags(std::forward<EnrollmentFlagsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ExtensionsT = ExtensionsV3>
  TemplateV3& WithExtensions(ExtensionsT&& value) {
  ...
  void SetGeneralFlags(GeneralFlagsT&& value) {
    m_generalFlagsHasBeenSet = true;
    m_generalFlags = std::forward<GeneralFlagsT>(value);
  }
  template <typename GeneralFlagsT = GeneralFlagsV3>
  TemplateV3& WithGeneralFlags(GeneralFlagsT&& value) {
    SetGeneralFlags(std::forward<GeneralFlagsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetHashAlgorithm(HashAlgorithm value) {
    m_hashAlgorithmHasBeenSet = true;
    m_hashAlgorithm = value;
  }
  inline TemplateV3& WithHashAlgorithm(HashAlgorithm value) {
  ...
  void SetPrivateKeyAttributes(PrivateKeyAttributesT&& value) {
    m_privateKeyAttributesHasBeenSet = true;
    m_privateKeyAttributes = std::forward<PrivateKeyAttributesT>(value);
  }
  template <typename PrivateKeyAttributesT = PrivateKeyAttributesV3>
  TemplateV3& WithPrivateKeyAttributes(PrivateKeyAttributesT&& value) {
    SetPrivateKeyAttributes(std::forward<PrivateKeyAttributesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPrivateKeyFlags(PrivateKeyFlagsT&& value) {
    m_privateKeyFlagsHasBeenSet = true;
    m_privateKeyFlags = std::forward<PrivateKeyFlagsT>(value);
  }
  template <typename PrivateKeyFlagsT = PrivateKeyFlagsV3>
  TemplateV3& WithPrivateKeyFlags(PrivateKeyFlagsT&& value) {
    SetPrivateKeyFlags(std::forward<PrivateKeyFlagsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSubjectNameFlags(SubjectNameFlagsT&& value) {
    m_subjectNameFlagsHasBeenSet = true;
    m_subjectNameFlags = std::forward<SubjectNameFlagsT>(value);
  }
  template <typename SubjectNameFlagsT = SubjectNameFlagsV3>
  TemplateV3& WithSubjectNameFlags(SubjectNameFlagsT&& value) {
    SetSubjectNameFlags(std::forward<SubjectNameFlagsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSupersededTemplates(SupersededTemplatesT&& value) {
    m_supersededTemplatesHasBeenSet = true;
    m_supersededTemplates = std::forward<SupersededTemplatesT>(value);
  }
  template <typename SupersededTemplatesT = Aws::Vector<Aws::String>>
  TemplateV3& WithSupersededTemplates(SupersededTemplatesT&& value) {
    SetSupersededTemplates(std::forward<SupersededTemplatesT>(value));
    return *this;
  }
  template <typename SupersededTemplatesT = Aws::String>
  TemplateV3& AddSupersededTemplates(SupersededTemplatesT&& value) {
    m_supersededTemplatesHasBeenSet = true;
    m_supersededTemplates.emplace_back(std::forward<SupersededTemplatesT>(value));
    return *this;
  }
  ///@}
 private:
