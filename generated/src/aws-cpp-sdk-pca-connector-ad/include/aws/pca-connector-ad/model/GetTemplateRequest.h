...
namespace Model
{
  ...
  {
  public:
    AWS_PCACONNECTORAD_API GetTemplateRequest() = default;
    ...
    template<typename TemplateArnT = Aws::String>
    GetTemplateRequest& WithTemplateArn(TemplateArnT&& value) { SetTemplateArn(std::forward<TemplateArnT>(value)); return *this;}
    ///@}
  private:
