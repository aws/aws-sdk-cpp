...
namespace Model
{
  ...
  public:
    ...
    template<typename ApplicationPoliciesT = ApplicationPolicies>
    ExtensionsV4& WithApplicationPolicies(ApplicationPoliciesT&& value) { SetApplicationPolicies(std::forward<ApplicationPoliciesT>(value)); return *this;}
    ///@}
    ...
    template<typename KeyUsageT = KeyUsage>
    ExtensionsV4& WithKeyUsage(KeyUsageT&& value) { SetKeyUsage(std::forward<KeyUsageT>(value)); return *this;}
    ///@}
  private:
