...
class Connector {
 public:
  AWS_PCACONNECTORAD_API Connector() = default;
  ...
  template <typename CertificateAuthorityArnT = Aws::String>
  Connector& WithCertificateAuthorityArn(CertificateAuthorityArnT&& value) {
  ...
  template <typename CertificateEnrollmentPolicyServerEndpointT = Aws::String>
  Connector& WithCertificateEnrollmentPolicyServerEndpoint(CertificateEnrollmentPolicyServerEndpointT&& value) {
  ...
  template <typename DirectoryIdT = Aws::String>
  Connector& WithDirectoryId(DirectoryIdT&& value) {
  ...
  inline Connector& WithStatus(ConnectorStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline Connector& WithStatusReason(ConnectorStatusReason value) {
  ...
  template <typename VpcInformationT = VpcInformation>
  Connector& WithVpcInformation(VpcInformationT&& value) {
