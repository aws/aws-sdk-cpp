...
class ListTemplateGroupAccessControlEntriesRequest : public PcaConnectorAdRequest {
 public:
  AWS_PCACONNECTORAD_API ListTemplateGroupAccessControlEntriesRequest() = default;
  ...
  inline ListTemplateGroupAccessControlEntriesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTemplateGroupAccessControlEntriesRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename TemplateArnT = Aws::String>
  ListTemplateGroupAccessControlEntriesRequest& WithTemplateArn(TemplateArnT&& value) {
