...
class SubjectNameFlagsV4 {
 public:
  ...
  inline SubjectNameFlagsV4& WithRequireCommonName(bool value) {
  ...
  inline SubjectNameFlagsV4& WithRequireDirectoryPath(bool value) {
  ...
  inline SubjectNameFlagsV4& WithRequireDnsAsCn(bool value) {
  ...
  inline SubjectNameFlagsV4& WithRequireEmail(bool value) {
  ...
  inline SubjectNameFlagsV4& WithSanRequireDirectoryGuid(bool value) {
  ...
  inline SubjectNameFlagsV4& WithSanRequireDns(bool value) {
  ...
  inline SubjectNameFlagsV4& WithSanRequireDomainDns(bool value) {
  ...
  inline SubjectNameFlagsV4& WithSanRequireEmail(bool value) {
  ...
  inline SubjectNameFlagsV4& WithSanRequireSpn(bool value) {
  ...
  inline SubjectNameFlagsV4& WithSanRequireUpn(bool value) {
