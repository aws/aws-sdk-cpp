...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/pca-connector-ad-2018-05-10/SubjectNameFlagsV4">AWS
   * API Reference</a></p>
   */
  class SubjectNameFlagsV4
  {
  public:
    AWS_PCACONNECTORAD_API SubjectNameFlagsV4() = default;
    AWS_PCACONNECTORAD_API SubjectNameFlagsV4(Aws::Utils::Json::JsonView jsonValue);
    AWS_PCACONNECTORAD_API SubjectNameFlagsV4& operator=(Aws::Utils::Json::JsonView jsonValue);
    ...
    inline SubjectNameFlagsV4& WithRequireCommonName(bool value) { SetRequireCommonName(value); return *this;}
    ///@}
    ...
    inline SubjectNameFlagsV4& WithRequireDirectoryPath(bool value) { SetRequireDirectoryPath(value); return *this;}
    ///@}
    ...
    inline SubjectNameFlagsV4& WithRequireDnsAsCn(bool value) { SetRequireDnsAsCn(value); return *this;}
    ///@}
    ...
    inline SubjectNameFlagsV4& WithRequireEmail(bool value) { SetRequireEmail(value); return *this;}
    ///@}
    ...
    inline SubjectNameFlagsV4& WithSanRequireDirectoryGuid(bool value) { SetSanRequireDirectoryGuid(value); return *this;}
    ///@}
    ...
    inline SubjectNameFlagsV4& WithSanRequireDns(bool value) { SetSanRequireDns(value); return *this;}
    ///@}
    ...
    inline SubjectNameFlagsV4& WithSanRequireDomainDns(bool value) { SetSanRequireDomainDns(value); return *this;}
    ///@}
    ...
    inline SubjectNameFlagsV4& WithSanRequireEmail(bool value) { SetSanRequireEmail(value); return *this;}
    ///@}
    ...
    inline SubjectNameFlagsV4& WithSanRequireSpn(bool value) { SetSanRequireSpn(value); return *this;}
    ///@}
    ...
    inline SubjectNameFlagsV4& WithSanRequireUpn(bool value) { SetSanRequireUpn(value); return *this;}
    ///@}
  private:
