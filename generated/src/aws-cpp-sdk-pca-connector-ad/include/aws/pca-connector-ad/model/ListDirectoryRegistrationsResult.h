...
class ListDirectoryRegistrationsResult {
 public:
  ...
  AWS_PCACONNECTORAD_API ListDirectoryRegistrationsResult& operator=(
  ...
  void SetDirectoryRegistrations(DirectoryRegistrationsT&& value) {
    m_directoryRegistrationsHasBeenSet = true;
    m_directoryRegistrations = std::forward<DirectoryRegistrationsT>(value);
  }
  template <typename DirectoryRegistrationsT = Aws::Vector<DirectoryRegistrationSummary>>
  ListDirectoryRegistrationsResult& WithDirectoryRegistrations(DirectoryRegistrationsT&& value) {
    SetDirectoryRegistrations(std::forward<DirectoryRegistrationsT>(value));
    return *this;
  }
  template <typename DirectoryRegistrationsT = DirectoryRegistrationSummary>
  ListDirectoryRegistrationsResult& AddDirectoryRegistrations(DirectoryRegistrationsT&& value) {
    m_directoryRegistrationsHasBeenSet = true;
    m_directoryRegistrations.emplace_back(std::forward<DirectoryRegistrationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListDirectoryRegistrationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDirectoryRegistrationsResult& WithRequestId(RequestIdT&& value) {
