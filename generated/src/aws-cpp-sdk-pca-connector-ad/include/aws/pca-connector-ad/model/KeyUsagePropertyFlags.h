...
class KeyUsagePropertyFlags {
 public:
  ...
  inline void SetDecrypt(bool value) {
    m_decryptHasBeenSet = true;
    m_decrypt = value;
  }
  inline KeyUsagePropertyFlags& WithDecrypt(bool value) {
    SetDecrypt(value);
    return *this;
  }
  ///@}
  ...
  inline void SetKeyAgreement(bool value) {
    m_keyAgreementHasBeenSet = true;
    m_keyAgreement = value;
  }
  inline KeyUsagePropertyFlags& WithKeyAgreement(bool value) {
    SetKeyAgreement(value);
    return *this;
  }
  ///@}
  ...
  inline KeyUsagePropertyFlags& WithSign(bool value) {
    SetSign(value);
    return *this;
  }
  ///@}
