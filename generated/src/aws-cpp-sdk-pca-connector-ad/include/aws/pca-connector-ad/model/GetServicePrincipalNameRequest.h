...
class GetServicePrincipalNameRequest : public PcaConnectorAdRequest {
 public:
  ...
  template <typename ConnectorArnT = Aws::String>
  GetServicePrincipalNameRequest& WithConnectorArn(ConnectorArnT&& value) {
  ...
  template <typename DirectoryRegistrationArnT = Aws::String>
  GetServicePrincipalNameRequest& WithDirectoryRegistrationArn(DirectoryRegistrationArnT&& value) {
