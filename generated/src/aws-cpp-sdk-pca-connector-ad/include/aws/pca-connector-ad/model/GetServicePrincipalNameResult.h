...
class GetServicePrincipalNameResult {
 public:
  ...
  void SetServicePrincipalName(ServicePrincipalNameT&& value) {
    m_servicePrincipalNameHasBeenSet = true;
    m_servicePrincipalName = std::forward<ServicePrincipalNameT>(value);
  }
  template <typename ServicePrincipalNameT = ServicePrincipalName>
  GetServicePrincipalNameResult& WithServicePrincipalName(ServicePrincipalNameT&& value) {
    SetServicePrincipalName(std::forward<ServicePrincipalNameT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetServicePrincipalNameResult& WithRequestId(RequestIdT&& value) {
