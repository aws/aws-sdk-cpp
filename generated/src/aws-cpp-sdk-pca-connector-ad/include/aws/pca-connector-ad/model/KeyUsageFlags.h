...
class KeyUsageFlags {
 public:
  ...
  inline KeyUsageFlags& WithDataEncipherment(bool value) {
  ...
  inline KeyUsageFlags& WithDigitalSignature(bool value) {
  ...
  inline KeyUsageFlags& WithKeyAgreement(bool value) {
  ...
  inline KeyUsageFlags& WithKeyEncipherment(bool value) {
  ...
  inline KeyUsageFlags& WithNonRepudiation(bool value) {
