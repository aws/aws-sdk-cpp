...
namespace Model
{
  ...
  /**
   */
  class UntagResourceRequest : public PcaConnectorAdRequest
  {
  public:
    AWS_PCACONNECTORAD_API UntagResourceRequest() = default;
    ...
    ///@{
    /**
     * <p>The Amazon Resource Name (ARN) that was returned when you created the
     * resource.</p>
     */
