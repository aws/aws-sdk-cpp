...
typedef std::function<void(const PcaConnectorAdClient*, const Model::CreateConnectorRequest&, const Model::CreateConnectorOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CreateConnectorResponseReceivedHandler;
typedef std::function<void(const PcaConnectorAdClient*, const Model::CreateDirectoryRegistrationRequest&,
                           const Model::CreateDirectoryRegistrationOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CreateDirectoryRegistrationResponseReceivedHandler;
typedef std::function<void(const PcaConnectorAdClient*, const Model::CreateServicePrincipalNameRequest&,
                           const Model::CreateServicePrincipalNameOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CreateServicePrincipalNameResponseReceivedHandler;
typedef std::function<void(const PcaConnectorAdClient*, const Model::CreateTemplateRequest&, const Model::CreateTemplateOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CreateTemplateResponseReceivedHandler;
typedef std::function<void(const PcaConnectorAdClient*, const Model::CreateTemplateGroupAccessControlEntryRequest&,
                           const Model::CreateTemplateGroupAccessControlEntryOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CreateTemplateGroupAccessControlEntryResponseReceivedHandler;
typedef std::function<void(const PcaConnectorAdClient*, const Model::DeleteConnectorRequest&, const Model::DeleteConnectorOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteConnectorResponseReceivedHandler;
typedef std::function<void(const PcaConnectorAdClient*, const Model::DeleteDirectoryRegistrationRequest&,
                           const Model::DeleteDirectoryRegistrationOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteDirectoryRegistrationResponseReceivedHandler;
typedef std::function<void(const PcaConnectorAdClient*, const Model::DeleteServicePrincipalNameRequest&,
                           const Model::DeleteServicePrincipalNameOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteServicePrincipalNameResponseReceivedHandler;
typedef std::function<void(const PcaConnectorAdClient*, const Model::DeleteTemplateRequest&, const Model::DeleteTemplateOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteTemplateResponseReceivedHandler;
typedef std::function<void(const PcaConnectorAdClient*, const Model::DeleteTemplateGroupAccessControlEntryRequest&,
                           const Model::DeleteTemplateGroupAccessControlEntryOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteTemplateGroupAccessControlEntryResponseReceivedHandler;
typedef std::function<void(const PcaConnectorAdClient*, const Model::GetConnectorRequest&, const Model::GetConnectorOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetConnectorResponseReceivedHandler;
typedef std::function<void(const PcaConnectorAdClient*, const Model::GetDirectoryRegistrationRequest&,
                           const Model::GetDirectoryRegistrationOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetDirectoryRegistrationResponseReceivedHandler;
typedef std::function<void(const PcaConnectorAdClient*, const Model::GetServicePrincipalNameRequest&,
                           const Model::GetServicePrincipalNameOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetServicePrincipalNameResponseReceivedHandler;
typedef std::function<void(const PcaConnectorAdClient*, const Model::GetTemplateRequest&, const Model::GetTemplateOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetTemplateResponseReceivedHandler;
typedef std::function<void(const PcaConnectorAdClient*, const Model::GetTemplateGroupAccessControlEntryRequest&,
                           const Model::GetTemplateGroupAccessControlEntryOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetTemplateGroupAccessControlEntryResponseReceivedHandler;
typedef std::function<void(const PcaConnectorAdClient*, const Model::ListConnectorsRequest&, const Model::ListConnectorsOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListConnectorsResponseReceivedHandler;
typedef std::function<void(const PcaConnectorAdClient*, const Model::ListDirectoryRegistrationsRequest&,
                           const Model::ListDirectoryRegistrationsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListDirectoryRegistrationsResponseReceivedHandler;
typedef std::function<void(const PcaConnectorAdClient*, const Model::ListServicePrincipalNamesRequest&,
                           const Model::ListServicePrincipalNamesOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListServicePrincipalNamesResponseReceivedHandler;
typedef std::function<void(const PcaConnectorAdClient*, const Model::ListTagsForResourceRequest&, const Model::ListTagsForResourceOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListTagsForResourceResponseReceivedHandler;
typedef std::function<void(const PcaConnectorAdClient*, const Model::ListTemplateGroupAccessControlEntriesRequest&,
                           const Model::ListTemplateGroupAccessControlEntriesOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListTemplateGroupAccessControlEntriesResponseReceivedHandler;
typedef std::function<void(const PcaConnectorAdClient*, const Model::ListTemplatesRequest&, const Model::ListTemplatesOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListTemplatesResponseReceivedHandler;
typedef std::function<void(const PcaConnectorAdClient*, const Model::TagResourceRequest&, const Model::TagResourceOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    TagResourceResponseReceivedHandler;
typedef std::function<void(const PcaConnectorAdClient*, const Model::UntagResourceRequest&, const Model::UntagResourceOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    UntagResourceResponseReceivedHandler;
typedef std::function<void(const PcaConnectorAdClient*, const Model::UpdateTemplateRequest&, const Model::UpdateTemplateOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    UpdateTemplateResponseReceivedHandler;
typedef std::function<void(const PcaConnectorAdClient*, const Model::UpdateTemplateGroupAccessControlEntryRequest&,
                           const Model::UpdateTemplateGroupAccessControlEntryOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    UpdateTemplateGroupAccessControlEntryResponseReceivedHandler;
