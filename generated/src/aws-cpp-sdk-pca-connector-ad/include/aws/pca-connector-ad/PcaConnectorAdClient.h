...
namespace PcaConnectorAd
{
   ...
   */
  class AWS_PCACONNECTORAD_API PcaConnectorAdClient : Aws::Client::ClientWithAsyncTemplateMethods<PcaConnectorAdClient>,
    smithy::client::AwsSmithyClientT<Aws::PcaConnectorAd::SERVICE_NAME,
