...
class AWS_PCACONNECTORAD_API PcaConnectorAdClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  PcaConnectorAdClient(const Aws::PcaConnectorAd::PcaConnectorAdClientConfiguration& clientConfiguration =
  ...
  PcaConnectorAdClient(const Aws::Auth::AWSCredentials& credentials,
                       std::shared_ptr<PcaConnectorAdEndpointProviderBase> endpointProvider = nullptr,
                       const Aws::PcaConnectorAd::PcaConnectorAdClientConfiguration& clientConfiguration =
                           Aws::PcaConnectorAd::PcaConnectorAdClientConfiguration());
   ...
   * is not specified, it will be initialized to default values.
   */
  PcaConnectorAdClient(const Aws::Auth::AWSCredentials& credentials, const Aws::Client::ClientConfiguration& clientConfiguration);
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateDirectoryRegistrationOutcome CreateDirectoryRegistration(
      const Model::CreateDirectoryRegistrationRequest& request) const;

  /**
   * A Callable wrapper for CreateDirectoryRegistration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateDirectoryRegistrationRequestT = Model::CreateDirectoryRegistrationRequest>
  Model::CreateDirectoryRegistrationOutcomeCallable CreateDirectoryRegistrationCallable(
      const CreateDirectoryRegistrationRequestT& request) const {
    return SubmitCallable(&PcaConnectorAdClient::CreateDirectoryRegistration, request);
  }

  /**
   * An Async wrapper for CreateDirectoryRegistration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateDirectoryRegistrationRequestT = Model::CreateDirectoryRegistrationRequest>
  void CreateDirectoryRegistrationAsync(const CreateDirectoryRegistrationRequestT& request,
                                        const CreateDirectoryRegistrationResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateServicePrincipalNameOutcome CreateServicePrincipalName(
      const Model::CreateServicePrincipalNameRequest& request) const;

  /**
   * A Callable wrapper for CreateServicePrincipalName that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateServicePrincipalNameRequestT = Model::CreateServicePrincipalNameRequest>
  Model::CreateServicePrincipalNameOutcomeCallable CreateServicePrincipalNameCallable(
      const CreateServicePrincipalNameRequestT& request) const {
    return SubmitCallable(&PcaConnectorAdClient::CreateServicePrincipalName, request);
  }

  /**
   * An Async wrapper for CreateServicePrincipalName that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateServicePrincipalNameRequestT = Model::CreateServicePrincipalNameRequest>
  void CreateServicePrincipalNameAsync(const CreateServicePrincipalNameRequestT& request,
                                       const CreateServicePrincipalNameResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateTemplateGroupAccessControlEntryOutcome CreateTemplateGroupAccessControlEntry(
      const Model::CreateTemplateGroupAccessControlEntryRequest& request) const;

  /**
   * A Callable wrapper for CreateTemplateGroupAccessControlEntry that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename CreateTemplateGroupAccessControlEntryRequestT = Model::CreateTemplateGroupAccessControlEntryRequest>
  Model::CreateTemplateGroupAccessControlEntryOutcomeCallable CreateTemplateGroupAccessControlEntryCallable(
      const CreateTemplateGroupAccessControlEntryRequestT& request) const {
    return SubmitCallable(&PcaConnectorAdClient::CreateTemplateGroupAccessControlEntry, request);
  }

  /**
   * An Async wrapper for CreateTemplateGroupAccessControlEntry that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename CreateTemplateGroupAccessControlEntryRequestT = Model::CreateTemplateGroupAccessControlEntryRequest>
  void CreateTemplateGroupAccessControlEntryAsync(const CreateTemplateGroupAccessControlEntryRequestT& request,
                                                  const CreateTemplateGroupAccessControlEntryResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteDirectoryRegistrationOutcome DeleteDirectoryRegistration(
      const Model::DeleteDirectoryRegistrationRequest& request) const;

  /**
   * A Callable wrapper for DeleteDirectoryRegistration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteDirectoryRegistrationRequestT = Model::DeleteDirectoryRegistrationRequest>
  Model::DeleteDirectoryRegistrationOutcomeCallable DeleteDirectoryRegistrationCallable(
      const DeleteDirectoryRegistrationRequestT& request) const {
    return SubmitCallable(&PcaConnectorAdClient::DeleteDirectoryRegistration, request);
  }

  /**
   * An Async wrapper for DeleteDirectoryRegistration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteDirectoryRegistrationRequestT = Model::DeleteDirectoryRegistrationRequest>
  void DeleteDirectoryRegistrationAsync(const DeleteDirectoryRegistrationRequestT& request,
                                        const DeleteDirectoryRegistrationResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteServicePrincipalNameOutcome DeleteServicePrincipalName(
      const Model::DeleteServicePrincipalNameRequest& request) const;

  /**
   * A Callable wrapper for DeleteServicePrincipalName that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteServicePrincipalNameRequestT = Model::DeleteServicePrincipalNameRequest>
  Model::DeleteServicePrincipalNameOutcomeCallable DeleteServicePrincipalNameCallable(
      const DeleteServicePrincipalNameRequestT& request) const {
    return SubmitCallable(&PcaConnectorAdClient::DeleteServicePrincipalName, request);
  }

  /**
   * An Async wrapper for DeleteServicePrincipalName that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteServicePrincipalNameRequestT = Model::DeleteServicePrincipalNameRequest>
  void DeleteServicePrincipalNameAsync(const DeleteServicePrincipalNameRequestT& request,
                                       const DeleteServicePrincipalNameResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteTemplateGroupAccessControlEntryOutcome DeleteTemplateGroupAccessControlEntry(
      const Model::DeleteTemplateGroupAccessControlEntryRequest& request) const;

  /**
   * A Callable wrapper for DeleteTemplateGroupAccessControlEntry that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DeleteTemplateGroupAccessControlEntryRequestT = Model::DeleteTemplateGroupAccessControlEntryRequest>
  Model::DeleteTemplateGroupAccessControlEntryOutcomeCallable DeleteTemplateGroupAccessControlEntryCallable(
      const DeleteTemplateGroupAccessControlEntryRequestT& request) const {
    return SubmitCallable(&PcaConnectorAdClient::DeleteTemplateGroupAccessControlEntry, request);
  }

  /**
   * An Async wrapper for DeleteTemplateGroupAccessControlEntry that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DeleteTemplateGroupAccessControlEntryRequestT = Model::DeleteTemplateGroupAccessControlEntryRequest>
  void DeleteTemplateGroupAccessControlEntryAsync(const DeleteTemplateGroupAccessControlEntryRequestT& request,
                                                  const DeleteTemplateGroupAccessControlEntryResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetDirectoryRegistration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetDirectoryRegistration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetDirectoryRegistrationRequestT = Model::GetDirectoryRegistrationRequest>
  void GetDirectoryRegistrationAsync(const GetDirectoryRegistrationRequestT& request,
                                     const GetDirectoryRegistrationResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetServicePrincipalName that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetServicePrincipalName that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetServicePrincipalNameRequestT = Model::GetServicePrincipalNameRequest>
  void GetServicePrincipalNameAsync(const GetServicePrincipalNameRequestT& request,
                                    const GetServicePrincipalNameResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetTemplateGroupAccessControlEntryOutcome GetTemplateGroupAccessControlEntry(
      const Model::GetTemplateGroupAccessControlEntryRequest& request) const;

  /**
   * A Callable wrapper for GetTemplateGroupAccessControlEntry that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename GetTemplateGroupAccessControlEntryRequestT = Model::GetTemplateGroupAccessControlEntryRequest>
  Model::GetTemplateGroupAccessControlEntryOutcomeCallable GetTemplateGroupAccessControlEntryCallable(
      const GetTemplateGroupAccessControlEntryRequestT& request) const {
    return SubmitCallable(&PcaConnectorAdClient::GetTemplateGroupAccessControlEntry, request);
  }

  /**
   * An Async wrapper for GetTemplateGroupAccessControlEntry that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetTemplateGroupAccessControlEntryRequestT = Model::GetTemplateGroupAccessControlEntryRequest>
  void GetTemplateGroupAccessControlEntryAsync(const GetTemplateGroupAccessControlEntryRequestT& request,
                                               const GetTemplateGroupAccessControlEntryResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListDirectoryRegistrationsOutcome ListDirectoryRegistrations(
      const Model::ListDirectoryRegistrationsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListDirectoryRegistrations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListDirectoryRegistrationsRequestT = Model::ListDirectoryRegistrationsRequest>
  Model::ListDirectoryRegistrationsOutcomeCallable ListDirectoryRegistrationsCallable(
      const ListDirectoryRegistrationsRequestT& request = {}) const {
    return SubmitCallable(&PcaConnectorAdClient::ListDirectoryRegistrations, request);
  }

  /**
   * An Async wrapper for ListDirectoryRegistrations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListDirectoryRegistrationsRequestT = Model::ListDirectoryRegistrationsRequest>
  void ListDirectoryRegistrationsAsync(const ListDirectoryRegistrationsResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const ListDirectoryRegistrationsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListServicePrincipalNames that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListServicePrincipalNamesRequestT = Model::ListServicePrincipalNamesRequest>
  Model::ListServicePrincipalNamesOutcomeCallable ListServicePrincipalNamesCallable(
      const ListServicePrincipalNamesRequestT& request) const {
    return SubmitCallable(&PcaConnectorAdClient::ListServicePrincipalNames, request);
  }

  /**
   * An Async wrapper for ListServicePrincipalNames that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListServicePrincipalNamesRequestT = Model::ListServicePrincipalNamesRequest>
  void ListServicePrincipalNamesAsync(const ListServicePrincipalNamesRequestT& request,
                                      const ListServicePrincipalNamesResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListTemplateGroupAccessControlEntriesOutcome ListTemplateGroupAccessControlEntries(
      const Model::ListTemplateGroupAccessControlEntriesRequest& request) const;

  /**
   * A Callable wrapper for ListTemplateGroupAccessControlEntries that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListTemplateGroupAccessControlEntriesRequestT = Model::ListTemplateGroupAccessControlEntriesRequest>
  Model::ListTemplateGroupAccessControlEntriesOutcomeCallable ListTemplateGroupAccessControlEntriesCallable(
      const ListTemplateGroupAccessControlEntriesRequestT& request) const {
    return SubmitCallable(&PcaConnectorAdClient::ListTemplateGroupAccessControlEntries, request);
  }

  /**
   * An Async wrapper for ListTemplateGroupAccessControlEntries that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListTemplateGroupAccessControlEntriesRequestT = Model::ListTemplateGroupAccessControlEntriesRequest>
  void ListTemplateGroupAccessControlEntriesAsync(const ListTemplateGroupAccessControlEntriesRequestT& request,
                                                  const ListTemplateGroupAccessControlEntriesResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename ListTemplatesRequestT = Model::ListTemplatesRequest>
  void ListTemplatesAsync(const ListTemplatesRequestT& request, const ListTemplatesResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateTemplateGroupAccessControlEntryOutcome UpdateTemplateGroupAccessControlEntry(
      const Model::UpdateTemplateGroupAccessControlEntryRequest& request) const;

  /**
   * A Callable wrapper for UpdateTemplateGroupAccessControlEntry that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename UpdateTemplateGroupAccessControlEntryRequestT = Model::UpdateTemplateGroupAccessControlEntryRequest>
  Model::UpdateTemplateGroupAccessControlEntryOutcomeCallable UpdateTemplateGroupAccessControlEntryCallable(
      const UpdateTemplateGroupAccessControlEntryRequestT& request) const {
    return SubmitCallable(&PcaConnectorAdClient::UpdateTemplateGroupAccessControlEntry, request);
  }

  /**
   * An Async wrapper for UpdateTemplateGroupAccessControlEntry that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename UpdateTemplateGroupAccessControlEntryRequestT = Model::UpdateTemplateGroupAccessControlEntryRequest>
  void UpdateTemplateGroupAccessControlEntryAsync(const UpdateTemplateGroupAccessControlEntryRequestT& request,
                                                  const UpdateTemplateGroupAccessControlEntryResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
