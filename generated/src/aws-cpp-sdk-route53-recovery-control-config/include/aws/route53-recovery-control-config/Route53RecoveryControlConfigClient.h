...
namespace Route53RecoveryControlConfig
{
   ...
   */
  class AWS_ROUTE53RECOVERYCONTROLCONFIG_API Route53RecoveryControlConfigClient : Aws::Client::ClientWithAsyncTemplateMethods<Route53RecoveryControlConfigClient>,
    smithy::client::AwsSmithyClientT<Aws::Route53RecoveryControlConfig::SERVICE_NAME,
