...
class CreateControlPanelRequest : public Route53RecoveryControlConfigRequest {
 public:
  AWS_ROUTE53RECOVERYCONTROLCONFIG_API CreateControlPanelRequest() = default;
  ...
  template <typename ClientTokenT = Aws::String>
  CreateControlPanelRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename ClusterArnT = Aws::String>
  CreateControlPanelRequest& WithClusterArn(ClusterArnT&& value) {
  ...
  void SetControlPanelName(ControlPanelNameT&& value) {
    ...
    m_controlPanelName = std::forward<ControlPanelNameT>(value);
  }
  template <typename ControlPanelNameT = Aws::String>
  CreateControlPanelRequest& WithControlPanelName(ControlPanelNameT&& value) {
    SetControlPanelName(std::forward<ControlPanelNameT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateControlPanelRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsKeyT = Aws::String, typename TagsValueT = Aws::String>
  CreateControlPanelRequest& AddTags(TagsKeyT&& key, TagsValueT&& value) {
    m_tagsHasBeenSet = true;
