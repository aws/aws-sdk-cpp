...
namespace Model
{
  ...
  public:
    ...
    inline ListSafetyRulesResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ListSafetyRulesResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ListSafetyRulesResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
