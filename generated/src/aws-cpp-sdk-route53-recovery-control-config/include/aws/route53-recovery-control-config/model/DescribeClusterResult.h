...
class DescribeClusterResult {
 public:
  AWS_ROUTE53RECOVERYCONTROLCONFIG_API DescribeClusterResult() = default;
  ...
  AWS_ROUTE53RECOVERYCONTROLCONFIG_API DescribeClusterResult& operator=(
  ...
  template <typename ClusterT = Cluster>
  DescribeClusterResult& WithCluster(ClusterT&& value) {
