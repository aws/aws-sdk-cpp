...
class DescribeSafetyRuleResult {
 public:
  ...
  AWS_ROUTE53RECOVERYCONTROLCONFIG_API DescribeSafetyRuleResult& operator=(
  ...
  template <typename AssertionRuleT = AssertionRule>
  DescribeSafetyRuleResult& WithAssertionRule(AssertionRuleT&& value) {
  ...
  template <typename GatingRuleT = GatingRule>
  DescribeSafetyRuleResult& WithGatingRule(GatingRuleT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeSafetyRuleResult& WithRequestId(RequestIdT&& value) {
