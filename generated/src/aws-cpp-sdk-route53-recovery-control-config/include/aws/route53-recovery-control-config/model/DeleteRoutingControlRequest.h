...
namespace Model
{
  ...
  {
  public:
    AWS_ROUTE53RECOVERYCONTROLCONFIG_API DeleteRoutingControlRequest();
     ...
     * deleting.</p>
     */
    inline DeleteRoutingControlRequest& WithRoutingControlArn(const char* value) { SetRoutingControlArn(value); return *this;}
