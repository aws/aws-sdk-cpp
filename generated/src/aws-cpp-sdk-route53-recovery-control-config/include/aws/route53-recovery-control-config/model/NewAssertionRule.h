...
class NewAssertionRule {
 public:
  ...
  void SetAssertedControls(AssertedControlsT&& value) {
    ...
    m_assertedControls = std::forward<AssertedControlsT>(value);
  }
  template <typename AssertedControlsT = Aws::Vector<Aws::String>>
  NewAssertionRule& WithAssertedControls(AssertedControlsT&& value) {
    SetAssertedControls(std::forward<AssertedControlsT>(value));
    return *this;
  }
  template <typename AssertedControlsT = Aws::String>
  NewAssertionRule& AddAssertedControls(AssertedControlsT&& value) {
    m_assertedControlsHasBeenSet = true;
    m_assertedControls.emplace_back(std::forward<AssertedControlsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRuleConfig(RuleConfigT&& value) {
    ...
    m_ruleConfig = std::forward<RuleConfigT>(value);
  }
  template <typename RuleConfigT = RuleConfig>
  NewAssertionRule& WithRuleConfig(RuleConfigT&& value) {
    SetRuleConfig(std::forward<RuleConfigT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetWaitPeriodMs(int value) {
    m_waitPeriodMsHasBeenSet = true;
    m_waitPeriodMs = value;
  }
  inline NewAssertionRule& WithWaitPeriodMs(int value) {
    SetWaitPeriodMs(value);
    return *this;
  }
  ///@}
 private:
