...
class CreateControlPanelResult {
 public:
  ...
  AWS_ROUTE53RECOVERYCONTROLCONFIG_API CreateControlPanelResult& operator=(
  ...
  template <typename ControlPanelT = ControlPanel>
  CreateControlPanelResult& WithControlPanel(ControlPanelT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateControlPanelResult& WithRequestId(RequestIdT&& value) {
