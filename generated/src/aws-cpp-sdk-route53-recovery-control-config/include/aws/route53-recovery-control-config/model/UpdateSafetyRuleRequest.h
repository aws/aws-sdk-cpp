...
class UpdateSafetyRuleRequest : public Route53RecoveryControlConfigRequest {
 public:
  ...
  void SetAssertionRuleUpdate(AssertionRuleUpdateT&& value) {
    m_assertionRuleUpdateHasBeenSet = true;
    m_assertionRuleUpdate = std::forward<AssertionRuleUpdateT>(value);
  }
  template <typename AssertionRuleUpdateT = AssertionRuleUpdate>
  UpdateSafetyRuleRequest& WithAssertionRuleUpdate(AssertionRuleUpdateT&& value) {
    SetAssertionRuleUpdate(std::forward<AssertionRuleUpdateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGatingRuleUpdate(GatingRuleUpdateT&& value) {
    m_gatingRuleUpdateHasBeenSet = true;
    m_gatingRuleUpdate = std::forward<GatingRuleUpdateT>(value);
  }
  template <typename GatingRuleUpdateT = GatingRuleUpdate>
  UpdateSafetyRuleRequest& WithGatingRuleUpdate(GatingRuleUpdateT&& value) {
    SetGatingRuleUpdate(std::forward<GatingRuleUpdateT>(value));
    return *this;
  }
  ///@}
 private:
