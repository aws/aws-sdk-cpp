...
namespace Model
{
  ...
  /**
   * <p>Request of adding tag to the resource</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/route53-recovery-control-config-2020-11-02/TagResourceRequest">AWS
   * API Reference</a></p>
   */
  class TagResourceRequest : public Route53RecoveryControlConfigRequest
  {
  public:
    AWS_ROUTE53RECOVERYCONTROLCONFIG_API TagResourceRequest() = default;
