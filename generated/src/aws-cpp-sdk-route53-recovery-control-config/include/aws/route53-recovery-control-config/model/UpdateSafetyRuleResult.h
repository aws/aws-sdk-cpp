...
class UpdateSafetyRuleResult {
 public:
  ...
  AWS_ROUTE53RECOVERYCONTROLCONFIG_API UpdateSafetyRuleResult& operator=(
  ...
  template <typename AssertionRuleT = AssertionRule>
  UpdateSafetyRuleResult& WithAssertionRule(AssertionRuleT&& value) {
  ...
  template <typename GatingRuleT = GatingRule>
  UpdateSafetyRuleResult& WithGatingRule(GatingRuleT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateSafetyRuleResult& WithRequestId(RequestIdT&& value) {
