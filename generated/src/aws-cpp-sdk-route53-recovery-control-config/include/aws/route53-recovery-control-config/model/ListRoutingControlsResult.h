...
class ListRoutingControlsResult {
 public:
  ...
  AWS_ROUTE53RECOVERYCONTROLCONFIG_API ListRoutingControlsResult& operator=(
  ...
  template <typename NextTokenT = Aws::String>
  ListRoutingControlsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetRoutingControls(RoutingControlsT&& value) {
    m_routingControlsHasBeenSet = true;
    m_routingControls = std::forward<RoutingControlsT>(value);
  }
  template <typename RoutingControlsT = Aws::Vector<RoutingControl>>
  ListRoutingControlsResult& WithRoutingControls(RoutingControlsT&& value) {
    SetRoutingControls(std::forward<RoutingControlsT>(value));
    return *this;
  }
  template <typename RoutingControlsT = RoutingControl>
  ListRoutingControlsResult& AddRoutingControls(RoutingControlsT&& value) {
    m_routingControlsHasBeenSet = true;
    m_routingControls.emplace_back(std::forward<RoutingControlsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListRoutingControlsResult& WithRequestId(RequestIdT&& value) {
