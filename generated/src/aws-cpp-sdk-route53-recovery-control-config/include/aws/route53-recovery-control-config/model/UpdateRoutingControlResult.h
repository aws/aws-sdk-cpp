...
class UpdateRoutingControlResult {
 public:
  ...
  AWS_ROUTE53RECOVERYCONTROLCONFIG_API UpdateRoutingControlResult& operator=(
  ...
  template <typename RoutingControlT = RoutingControl>
  UpdateRoutingControlResult& WithRoutingControl(RoutingControlT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateRoutingControlResult& WithRequestId(RequestIdT&& value) {
