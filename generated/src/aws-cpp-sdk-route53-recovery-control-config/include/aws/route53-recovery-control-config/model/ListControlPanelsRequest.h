...
class ListControlPanelsRequest : public Route53RecoveryControlConfigRequest {
 public:
  AWS_ROUTE53RECOVERYCONTROLCONFIG_API ListControlPanelsRequest() = default;
  ...
  template <typename ClusterArnT = Aws::String>
  ListControlPanelsRequest& WithClusterArn(ClusterArnT&& value) {
  ...
  inline ListControlPanelsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListControlPanelsRequest& WithNextToken(NextTokenT&& value) {
