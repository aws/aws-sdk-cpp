...
class ListSafetyRulesRequest : public Route53RecoveryControlConfigRequest {
 public:
  ...
  template <typename ControlPanelArnT = Aws::String>
  ListSafetyRulesRequest& WithControlPanelArn(ControlPanelArnT&& value) {
  ...
  inline ListSafetyRulesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListSafetyRulesRequest& WithNextToken(NextTokenT&& value) {
