...
namespace Model
{
  ...
  {
  public:
    AWS_ROUTE53RECOVERYCONTROLCONFIG_API ListSafetyRulesRequest() = default;
    ...
    template<typename ControlPanelArnT = Aws::String>
    ListSafetyRulesRequest& WithControlPanelArn(ControlPanelArnT&& value) { SetControlPanelArn(std::forward<ControlPanelArnT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListSafetyRulesRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
