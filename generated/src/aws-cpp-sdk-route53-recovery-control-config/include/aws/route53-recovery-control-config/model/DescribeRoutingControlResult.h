...
class DescribeRoutingControlResult {
 public:
  ...
  AWS_ROUTE53RECOVERYCONTROLCONFIG_API DescribeRoutingControlResult& operator=(
  ...
  template <typename RoutingControlT = RoutingControl>
  DescribeRoutingControlResult& WithRoutingControl(RoutingControlT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeRoutingControlResult& WithRequestId(RequestIdT&& value) {
