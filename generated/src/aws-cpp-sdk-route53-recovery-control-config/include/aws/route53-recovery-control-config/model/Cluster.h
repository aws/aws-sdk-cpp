...
class Cluster {
 public:
  ...
  void SetClusterEndpoints(ClusterEndpointsT&& value) {
    ...
    m_clusterEndpoints = std::forward<ClusterEndpointsT>(value);
  }
  template <typename ClusterEndpointsT = Aws::Vector<ClusterEndpoint>>
  Cluster& WithClusterEndpoints(ClusterEndpointsT&& value) {
    SetClusterEndpoints(std::forward<ClusterEndpointsT>(value));
    return *this;
  }
  template <typename ClusterEndpointsT = ClusterEndpoint>
  Cluster& AddClusterEndpoints(ClusterEndpointsT&& value) {
    m_clusterEndpointsHasBeenSet = true;
    m_clusterEndpoints.emplace_back(std::forward<ClusterEndpointsT>(value));
    return *this;
  }
  ///@}
