...
class ListControlPanelsResult {
 public:
  ...
  AWS_ROUTE53RECOVERYCONTROLCONFIG_API ListControlPanelsResult& operator=(
  ...
  void SetControlPanels(ControlPanelsT&& value) {
    m_controlPanelsHasBeenSet = true;
    m_controlPanels = std::forward<ControlPanelsT>(value);
  }
  template <typename ControlPanelsT = Aws::Vector<ControlPanel>>
  ListControlPanelsResult& WithControlPanels(ControlPanelsT&& value) {
    SetControlPanels(std::forward<ControlPanelsT>(value));
    return *this;
  }
  template <typename ControlPanelsT = ControlPanel>
  ListControlPanelsResult& AddControlPanels(ControlPanelsT&& value) {
    m_controlPanelsHasBeenSet = true;
    m_controlPanels.emplace_back(std::forward<ControlPanelsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListControlPanelsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListControlPanelsResult& WithRequestId(RequestIdT&& value) {
