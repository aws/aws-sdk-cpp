...
ContactListDestination::ContactListDestination(JsonView jsonValue) { *this = jsonValue; }
...
ContactListDestination& ContactListDestination::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("ContactListImportAction")) {
    m_contactListImportAction =
        ContactListImportActionMapper::GetContactListImportActionForName(jsonValue.GetString("ContactListImportAction"));
...
JsonValue ContactListDestination::Jsonize() const {
  ...
  if (m_contactListImportActionHasBeenSet) {
    payload.WithString("ContactListImportAction",
                       ContactListImportActionMapper::GetNameForContactListImportAction(m_contactListImportAction));
  }
