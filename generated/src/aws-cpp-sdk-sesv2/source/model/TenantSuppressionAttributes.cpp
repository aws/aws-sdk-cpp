...
TenantSuppressionAttributes::TenantSuppressionAttributes(JsonView jsonValue) { *this = jsonValue; }

TenantSuppressionAttributes& TenantSuppressionAttributes::operator=(JsonView jsonValue) {
...
JsonValue TenantSuppressionAttributes::Jsonize() const {
  JsonValue payload;
