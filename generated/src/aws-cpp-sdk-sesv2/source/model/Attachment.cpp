...
Attachment& Attachment::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("ContentDisposition")) {
    m_contentDisposition =
        AttachmentContentDispositionMapper::GetAttachmentContentDispositionForName(jsonValue.GetString("ContentDisposition"));
  ...
  if (jsonValue.ValueExists("ContentTransferEncoding")) {
    m_contentTransferEncoding = AttachmentContentTransferEncodingMapper::GetAttachmentContentTransferEncodingForName(
        jsonValue.GetString("ContentTransferEncoding"));
...
JsonValue Attachment::Jsonize() const {
  ...
  if (m_contentDispositionHasBeenSet) {
    payload.WithString("ContentDisposition",
                       AttachmentContentDispositionMapper::GetNameForAttachmentContentDisposition(m_contentDisposition));
  }
  ...
  if (m_contentTransferEncodingHasBeenSet) {
    payload.WithString("ContentTransferEncoding",
                       AttachmentContentTransferEncodingMapper::GetNameForAttachmentContentTransferEncoding(m_contentTransferEncoding));
  }
