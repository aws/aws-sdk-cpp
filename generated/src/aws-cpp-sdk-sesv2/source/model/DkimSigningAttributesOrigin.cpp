...
static const int AWS_SES_US_GOV_EAST_1_HASH = HashingUtils::HashString("AWS_SES_US_GOV_EAST_1");
static const int AWS_SES_US_GOV_WEST_1_HASH = HashingUtils::HashString("AWS_SES_US_GOV_WEST_1");
...
DkimSigningAttributesOrigin GetDkimSigningAttributesOriginForName(const Aws::String& name) {
  ...
  } else if (hashCode == AWS_SES_US_GOV_EAST_1_HASH) {
    return DkimSigningAttributesOrigin::AWS_SES_US_GOV_EAST_1;
  } else if (hashCode == AWS_SES_US_GOV_WEST_1_HASH) {
    return DkimSigningAttributesOrigin::AWS_SES_US_GOV_WEST_1;
  }
...
Aws::String GetNameForDkimSigningAttributesOrigin(DkimSigningAttributesOrigin enumValue) {
  switch (enumValue) {
    ...
    case DkimSigningAttributesOrigin::AWS_SES_US_GOV_EAST_1:
      return "AWS_SES_US_GOV_EAST_1";
    case DkimSigningAttributesOrigin::AWS_SES_US_GOV_WEST_1:
      return "AWS_SES_US_GOV_WEST_1";
    default:
      EnumParseOverflowContainer* overflowContainer = Aws::GetEnumOverflowContainer();
      if (overflowContainer) {
