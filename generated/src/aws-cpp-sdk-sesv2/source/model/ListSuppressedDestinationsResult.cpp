...
ListSuppressedDestinationsResult::ListSuppressedDestinationsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListSuppressedDestinationsResult& ListSuppressedDestinationsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("SuppressedDestinationSummaries")) {
    ...
    for (unsigned suppressedDestinationSummariesIndex = 0;
         suppressedDestinationSummariesIndex < suppressedDestinationSummariesJsonList.GetLength(); ++suppressedDestinationSummariesIndex) {
    ...
    m_suppressedDestinationSummariesHasBeenSet = true;
  }
