...
DkimSigningAttributes::DkimSigningAttributes(JsonView jsonValue) { *this = jsonValue; }
...
DkimSigningAttributes& DkimSigningAttributes::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("DomainSigningAttributesOrigin")) {
    m_domainSigningAttributesOrigin =
        DkimSigningAttributesOriginMapper::GetDkimSigningAttributesOriginForName(jsonValue.GetString("DomainSigningAttributesOrigin"));
...
JsonValue DkimSigningAttributes::Jsonize() const {
  ...
  if (m_domainSigningAttributesOriginHasBeenSet) {
    payload.WithString("DomainSigningAttributesOrigin",
                       DkimSigningAttributesOriginMapper::GetNameForDkimSigningAttributesOrigin(m_domainSigningAttributesOrigin));
  }
