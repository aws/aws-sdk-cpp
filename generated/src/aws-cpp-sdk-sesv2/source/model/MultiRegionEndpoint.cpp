...
MultiRegionEndpoint::MultiRegionEndpoint(JsonView jsonValue) { *this = jsonValue; }

MultiRegionEndpoint& MultiRegionEndpoint::operator=(JsonView jsonValue) {
...
JsonValue MultiRegionEndpoint::Jsonize() const {
  JsonValue payload;
