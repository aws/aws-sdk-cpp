...
SuppressionValidationAttributes::SuppressionValidationAttributes(JsonView jsonValue) { *this = jsonValue; }

SuppressionValidationAttributes& SuppressionValidationAttributes::operator=(JsonView jsonValue) {
...
JsonValue SuppressionValidationAttributes::Jsonize() const {
  JsonValue payload;
