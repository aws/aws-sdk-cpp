...
namespace Model
{
  ...
  {
  public:
    AWS_SESV2_API CreateEmailIdentityPolicyResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    CreateEmailIdentityPolicyResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
