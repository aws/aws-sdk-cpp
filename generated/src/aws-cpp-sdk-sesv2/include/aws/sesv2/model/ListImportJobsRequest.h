...
class ListImportJobsRequest : public SESV2Request {
 public:
  ...
  inline void SetImportDestinationType(ImportDestinationType value) {
    m_importDestinationTypeHasBeenSet = true;
    m_importDestinationType = value;
  }
  inline ListImportJobsRequest& WithImportDestinationType(ImportDestinationType value) {
    SetImportDestinationType(value);
    return *this;
  }
  ///@}
  ...
  inline ListImportJobsRequest& WithPageSize(int value) {
    SetPageSize(value);
    return *this;
  }
  ///@}
