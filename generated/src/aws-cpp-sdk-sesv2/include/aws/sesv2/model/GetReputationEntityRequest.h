...
class GetReputationEntityRequest : public SESV2Request {
 public:
  ...
  template <typename ReputationEntityReferenceT = Aws::String>
  GetReputationEntityRequest& WithReputationEntityReference(ReputationEntityReferenceT&& value) {
  ...
  inline GetReputationEntityRequest& WithReputationEntityType(ReputationEntityType value) {
