...
class ContactListDestination {
 public:
  ...
  template <typename ContactListNameT = Aws::String>
  ContactListDestination& WithContactListName(ContactListNameT&& value) {
  ...
  inline void SetContactListImportAction(ContactListImportAction value) {
    m_contactListImportActionHasBeenSet = true;
    m_contactListImportAction = value;
  }
  inline ContactListDestination& WithContactListImportAction(ContactListImportAction value) {
    SetContactListImportAction(value);
    return *this;
  }
  ///@}
 private:
