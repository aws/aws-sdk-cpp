...
class ListExportJobsRequest : public SESV2Request {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListExportJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListExportJobsRequest& WithPageSize(int value) {
    SetPageSize(value);
    return *this;
  }
  ///@}
  ...
  inline void SetExportSourceType(ExportSourceType value) {
    m_exportSourceTypeHasBeenSet = true;
    m_exportSourceType = value;
  }
  inline ListExportJobsRequest& WithExportSourceType(ExportSourceType value) {
    SetExportSourceType(value);
    return *this;
  }
  ///@}
  ...
  inline ListExportJobsRequest& WithJobStatus(JobStatus value) {
    SetJobStatus(value);
    return *this;
  }
  ///@}
