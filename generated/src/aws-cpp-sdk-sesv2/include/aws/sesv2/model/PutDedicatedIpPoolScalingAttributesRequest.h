...
class PutDedicatedIpPoolScalingAttributesRequest : public SESV2Request {
 public:
  ...
  template <typename PoolNameT = Aws::String>
  PutDedicatedIpPoolScalingAttributesRequest& WithPoolName(PoolNameT&& value) {
  ...
  inline void SetScalingMode(ScalingMode value) {
    m_scalingModeHasBeenSet = true;
    m_scalingMode = value;
  }
  inline PutDedicatedIpPoolScalingAttributesRequest& WithScalingMode(ScalingMode value) {
