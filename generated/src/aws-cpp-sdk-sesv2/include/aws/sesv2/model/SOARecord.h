...
class SOARecord {
 public:
  ...
  void SetPrimaryNameServer(PrimaryNameServerT&& value) {
    m_primaryNameServerHasBeenSet = true;
    m_primaryNameServer = std::forward<PrimaryNameServerT>(value);
  }
  template <typename PrimaryNameServerT = Aws::String>
  SOARecord& WithPrimaryNameServer(PrimaryNameServerT&& value) {
    SetPrimaryNameServer(std::forward<PrimaryNameServerT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAdminEmail(AdminEmailT&& value) {
    m_adminEmailHasBeenSet = true;
    m_adminEmail = std::forward<AdminEmailT>(value);
  }
  template <typename AdminEmailT = Aws::String>
  SOARecord& WithAdminEmail(AdminEmailT&& value) {
    SetAdminEmail(std::forward<AdminEmailT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetSerialNumber(long long value) {
    m_serialNumberHasBeenSet = true;
    m_serialNumber = value;
  }
  inline SOARecord& WithSerialNumber(long long value) {
