...
class PutConfigurationSetVdmOptionsRequest : public SESV2Request {
 public:
  ...
  template <typename ConfigurationSetNameT = Aws::String>
  PutConfigurationSetVdmOptionsRequest& WithConfigurationSetName(ConfigurationSetNameT&& value) {
  ...
  template <typename VdmOptionsT = VdmOptions>
  PutConfigurationSetVdmOptionsRequest& WithVdmOptions(VdmOptionsT&& value) {
