...
class UpdateEmailIdentityPolicyRequest : public SESV2Request {
 public:
  AWS_SESV2_API UpdateEmailIdentityPolicyRequest() = default;
  ...
  template <typename EmailIdentityT = Aws::String>
  UpdateEmailIdentityPolicyRequest& WithEmailIdentity(EmailIdentityT&& value) {
  ...
  template <typename PolicyNameT = Aws::String>
  UpdateEmailIdentityPolicyRequest& WithPolicyName(PolicyNameT&& value) {
  ...
  template <typename PolicyT = Aws::String>
  UpdateEmailIdentityPolicyRequest& WithPolicy(PolicyT&& value) {
