...
class ListReputationEntitiesRequest : public SESV2Request {
 public:
  ...
  template <typename FilterT = Aws::Map<ReputationEntityFilterKey, Aws::String>>
  ListReputationEntitiesRequest& WithFilter(FilterT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListReputationEntitiesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListReputationEntitiesRequest& WithPageSize(int value) {
    SetPageSize(value);
    return *this;
  }
  ///@}
