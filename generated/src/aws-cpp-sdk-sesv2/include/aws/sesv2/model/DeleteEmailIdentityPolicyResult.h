...
namespace Model
{
  ...
  {
  public:
    AWS_SESV2_API DeleteEmailIdentityPolicyResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteEmailIdentityPolicyResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
