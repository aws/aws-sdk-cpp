...
namespace Model
{
  ...
  public:
    ...
    inline DeleteEmailIdentityPolicyResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeleteEmailIdentityPolicyResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeleteEmailIdentityPolicyResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
