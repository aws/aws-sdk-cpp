...
namespace Model
{
  ...
  {
  public:
    AWS_SESV2_API PutAccountVdmAttributesResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    PutAccountVdmAttributesResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
