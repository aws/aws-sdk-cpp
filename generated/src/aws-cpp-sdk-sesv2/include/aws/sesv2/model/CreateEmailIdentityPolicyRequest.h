...
class CreateEmailIdentityPolicyRequest : public SESV2Request {
 public:
  AWS_SESV2_API CreateEmailIdentityPolicyRequest() = default;
  ...
  template <typename EmailIdentityT = Aws::String>
  CreateEmailIdentityPolicyRequest& WithEmailIdentity(EmailIdentityT&& value) {
  ...
  template <typename PolicyNameT = Aws::String>
  CreateEmailIdentityPolicyRequest& WithPolicyName(PolicyNameT&& value) {
  ...
  template <typename PolicyT = Aws::String>
  CreateEmailIdentityPolicyRequest& WithPolicy(PolicyT&& value) {
