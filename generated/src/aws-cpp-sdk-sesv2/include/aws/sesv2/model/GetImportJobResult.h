...
class GetImportJobResult {
 public:
  ...
  template <typename JobIdT = Aws::String>
  GetImportJobResult& WithJobId(JobIdT&& value) {
  ...
  template <typename ImportDestinationT = ImportDestination>
  GetImportJobResult& WithImportDestination(ImportDestinationT&& value) {
  ...
  void SetImportDataSource(ImportDataSourceT&& value) {
    m_importDataSourceHasBeenSet = true;
    m_importDataSource = std::forward<ImportDataSourceT>(value);
  }
  template <typename ImportDataSourceT = ImportDataSource>
  GetImportJobResult& WithImportDataSource(ImportDataSourceT&& value) {
    SetImportDataSource(std::forward<ImportDataSourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFailureInfo(FailureInfoT&& value) {
    m_failureInfoHasBeenSet = true;
    m_failureInfo = std::forward<FailureInfoT>(value);
  }
  template <typename FailureInfoT = FailureInfo>
  GetImportJobResult& WithFailureInfo(FailureInfoT&& value) {
    SetFailureInfo(std::forward<FailureInfoT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetImportJobResult& WithJobStatus(JobStatus value) {
    SetJobStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreatedTimestampT = Aws::Utils::DateTime>
  GetImportJobResult& WithCreatedTimestamp(CreatedTimestampT&& value) {
  ...
  template <typename CompletedTimestampT = Aws::Utils::DateTime>
  GetImportJobResult& WithCompletedTimestamp(CompletedTimestampT&& value) {
  ...
  inline GetImportJobResult& WithProcessedRecordsCount(int value) {
  ...
  inline GetImportJobResult& WithFailedRecordsCount(int value) {
