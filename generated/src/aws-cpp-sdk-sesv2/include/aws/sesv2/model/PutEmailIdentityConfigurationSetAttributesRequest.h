...
class PutEmailIdentityConfigurationSetAttributesRequest : public SESV2Request {
 public:
  ...
  template <typename EmailIdentityT = Aws::String>
  PutEmailIdentityConfigurationSetAttributesRequest& WithEmailIdentity(EmailIdentityT&& value) {
  ...
  template <typename ConfigurationSetNameT = Aws::String>
  PutEmailIdentityConfigurationSetAttributesRequest& WithConfigurationSetName(ConfigurationSetNameT&& value) {
