...
class GetExportJobResult {
 public:
  ...
  template <typename JobIdT = Aws::String>
  GetExportJobResult& WithJobId(JobIdT&& value) {
  ...
  inline GetExportJobResult& WithExportSourceType(ExportSourceType value) {
  ...
  inline GetExportJobResult& WithJobStatus(JobStatus value) {
    SetJobStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ExportDestinationT = ExportDestination>
  GetExportJobResult& WithExportDestination(ExportDestinationT&& value) {
  ...
  template <typename ExportDataSourceT = ExportDataSource>
  GetExportJobResult& WithExportDataSource(ExportDataSourceT&& value) {
  ...
  template <typename CreatedTimestampT = Aws::Utils::DateTime>
  GetExportJobResult& WithCreatedTimestamp(CreatedTimestampT&& value) {
  ...
  template <typename CompletedTimestampT = Aws::Utils::DateTime>
  GetExportJobResult& WithCompletedTimestamp(CompletedTimestampT&& value) {
  ...
  template <typename FailureInfoT = FailureInfo>
  GetExportJobResult& WithFailureInfo(FailureInfoT&& value) {
  ...
  template <typename StatisticsT = ExportStatistics>
  GetExportJobResult& WithStatistics(StatisticsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetExportJobResult& WithRequestId(RequestIdT&& value) {
