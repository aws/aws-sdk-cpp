...
class EventDestinationDefinition {
 public:
  ...
  void SetEventBridgeDestination(EventBridgeDestinationT&& value) {
    m_eventBridgeDestinationHasBeenSet = true;
    m_eventBridgeDestination = std::forward<EventBridgeDestinationT>(value);
  }
  template <typename EventBridgeDestinationT = EventBridgeDestination>
  EventDestinationDefinition& WithEventBridgeDestination(EventBridgeDestinationT&& value) {
    SetEventBridgeDestination(std::forward<EventBridgeDestinationT>(value));
    return *this;
  }
  ///@}
