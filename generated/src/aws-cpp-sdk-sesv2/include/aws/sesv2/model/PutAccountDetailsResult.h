...
namespace Model
{
  ...
  public:
    ...
    inline PutAccountDetailsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline PutAccountDetailsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline PutAccountDetailsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
