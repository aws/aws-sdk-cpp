...
namespace Model
{
  ...
  {
  public:
    AWS_SESV2_API PutAccountDetailsResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    PutAccountDetailsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
