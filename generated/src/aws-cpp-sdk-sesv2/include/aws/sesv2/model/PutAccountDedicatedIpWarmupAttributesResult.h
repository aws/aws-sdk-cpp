...
class PutAccountDedicatedIpWarmupAttributesResult {
 public:
  AWS_SESV2_API PutAccountDedicatedIpWarmupAttributesResult() = default;
  ...
  AWS_SESV2_API PutAccountDedicatedIpWarmupAttributesResult& operator=(
  ...
  template <typename RequestIdT = Aws::String>
  PutAccountDedicatedIpWarmupAttributesResult& WithRequestId(RequestIdT&& value) {
