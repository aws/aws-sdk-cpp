...
namespace Model
{
  ...
  public:
    ...
    inline PutAccountDedicatedIpWarmupAttributesResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline PutAccountDedicatedIpWarmupAttributesResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline PutAccountDedicatedIpWarmupAttributesResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
