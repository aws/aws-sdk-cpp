...
class DkimAttributes {
 public:
  ...
  inline DkimAttributes& WithSigningEnabled(bool value) {
  ...
  inline void SetStatus(DkimStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline DkimAttributes& WithStatus(DkimStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename TokensT = Aws::Vector<Aws::String>>
  DkimAttributes& WithTokens(TokensT&& value) {
    SetTokens(std::forward<TokensT>(value));
    return *this;
  }
  template <typename TokensT = Aws::String>
  DkimAttributes& AddTokens(TokensT&& value) {
    m_tokensHasBeenSet = true;
   ...
   * (Calgary) region using Deterministic Easy-DKIM (DEED). </p> </li> <li> <p>
   ...
   * <p> <code>AWS_SES_AP_SOUTHEAST_5</code> – Indicates that DKIM was configured for
   * the identity by replicating signing attributes from a parent identity in Asia
   * Pacific (Malaysia) region using Deterministic Easy-DKIM (DEED). </p> </li> <li>
   ...
   * (Oregon) region using Deterministic Easy-DKIM (DEED). </p> </li> <li> <p>
   * <code>AWS_SES_US_GOV_EAST_1</code> – Indicates that DKIM was configured for the
   * identity by replicating signing attributes from a parent identity in AWS
   * GovCloud (US-East) region using Deterministic Easy-DKIM (DEED). </p> </li> <li>
   * <p> <code>AWS_SES_US_GOV_WEST_1</code> – Indicates that DKIM was configured for
   * the identity by replicating signing attributes from a parent identity in AWS
   * GovCloud (US-West) region using Deterministic Easy-DKIM (DEED). </p> </li> </ul>
   */
  ...
  inline void SetSigningAttributesOrigin(DkimSigningAttributesOrigin value) {
    m_signingAttributesOriginHasBeenSet = true;
    m_signingAttributesOrigin = value;
  }
  inline DkimAttributes& WithSigningAttributesOrigin(DkimSigningAttributesOrigin value) {
    SetSigningAttributesOrigin(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNextSigningKeyLength(DkimSigningKeyLength value) {
    m_nextSigningKeyLengthHasBeenSet = true;
    m_nextSigningKeyLength = value;
  }
  inline DkimAttributes& WithNextSigningKeyLength(DkimSigningKeyLength value) {
    SetNextSigningKeyLength(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCurrentSigningKeyLength(DkimSigningKeyLength value) {
    m_currentSigningKeyLengthHasBeenSet = true;
    m_currentSigningKeyLength = value;
  }
  inline DkimAttributes& WithCurrentSigningKeyLength(DkimSigningKeyLength value) {
    SetCurrentSigningKeyLength(value);
    return *this;
  }
  ///@}
  ...
  void SetLastKeyGenerationTimestamp(LastKeyGenerationTimestampT&& value) {
    m_lastKeyGenerationTimestampHasBeenSet = true;
    m_lastKeyGenerationTimestamp = std::forward<LastKeyGenerationTimestampT>(value);
  }
  template <typename LastKeyGenerationTimestampT = Aws::Utils::DateTime>
  DkimAttributes& WithLastKeyGenerationTimestamp(LastKeyGenerationTimestampT&& value) {
    SetLastKeyGenerationTimestamp(std::forward<LastKeyGenerationTimestampT>(value));
    return *this;
  }
  ///@}
 private:
