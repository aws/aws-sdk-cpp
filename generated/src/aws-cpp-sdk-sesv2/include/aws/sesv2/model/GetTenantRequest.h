...
/**
 * <p>Represents a request to get information about a specific
 * tenant.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/sesv2-2019-09-27/GetTenantRequest">AWS
 * API Reference</a></p>
 */
class GetTenantRequest : public SESV2Request {
 public:
  AWS_SESV2_API GetTenantRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "GetTenant"; }
  ...
  template <typename TenantNameT = Aws::String>
  GetTenantRequest& WithTenantName(TenantNameT&& value) {
