...
namespace Model
{
  ...
  public:
    ...
    inline PutConfigurationSetSuppressionOptionsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline PutConfigurationSetSuppressionOptionsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline PutConfigurationSetSuppressionOptionsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
