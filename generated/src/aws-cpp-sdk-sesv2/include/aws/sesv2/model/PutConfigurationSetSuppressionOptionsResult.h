...
class PutConfigurationSetSuppressionOptionsResult {
 public:
  AWS_SESV2_API PutConfigurationSetSuppressionOptionsResult() = default;
  ...
  AWS_SESV2_API PutConfigurationSetSuppressionOptionsResult& operator=(
  ...
  template <typename RequestIdT = Aws::String>
  PutConfigurationSetSuppressionOptionsResult& WithRequestId(RequestIdT&& value) {
