...
class BulkEmailEntryResult {
 public:
  ...
  inline void SetStatus(BulkEmailStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline BulkEmailEntryResult& WithStatus(BulkEmailStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ErrorT = Aws::String>
  BulkEmailEntryResult& WithError(ErrorT&& value) {
  ...
  template <typename MessageIdT = Aws::String>
  BulkEmailEntryResult& WithMessageId(MessageIdT&& value) {
