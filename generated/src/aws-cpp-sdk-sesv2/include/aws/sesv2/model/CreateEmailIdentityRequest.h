...
class CreateEmailIdentityRequest : public SESV2Request {
 public:
  ...
  void SetDkimSigningAttributes(DkimSigningAttributesT&& value) {
    m_dkimSigningAttributesHasBeenSet = true;
    m_dkimSigningAttributes = std::forward<DkimSigningAttributesT>(value);
  }
  template <typename DkimSigningAttributesT = DkimSigningAttributes>
  CreateEmailIdentityRequest& WithDkimSigningAttributes(DkimSigningAttributesT&& value) {
    SetDkimSigningAttributes(std::forward<DkimSigningAttributesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ConfigurationSetNameT = Aws::String>
  CreateEmailIdentityRequest& WithConfigurationSetName(ConfigurationSetNameT&& value) {
