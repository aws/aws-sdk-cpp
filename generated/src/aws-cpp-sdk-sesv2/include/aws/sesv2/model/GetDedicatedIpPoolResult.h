...
class GetDedicatedIpPoolResult {
 public:
  ...
  void SetDedicatedIpPool(DedicatedIpPoolT&& value) {
    m_dedicatedIpPoolHasBeenSet = true;
    m_dedicatedIpPool = std::forward<DedicatedIpPoolT>(value);
  }
  template <typename DedicatedIpPoolT = DedicatedIpPool>
  GetDedicatedIpPoolResult& WithDedicatedIpPool(DedicatedIpPoolT&& value) {
    SetDedicatedIpPool(std::forward<DedicatedIpPoolT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetDedicatedIpPoolResult& WithRequestId(RequestIdT&& value) {
