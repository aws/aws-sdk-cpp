...
class ListEmailTemplatesResult {
 public:
  ...
  template <typename TemplatesMetadataT = Aws::Vector<EmailTemplateMetadata>>
  ListEmailTemplatesResult& WithTemplatesMetadata(TemplatesMetadataT&& value) {
    SetTemplatesMetadata(std::forward<TemplatesMetadataT>(value));
    return *this;
  }
  template <typename TemplatesMetadataT = EmailTemplateMetadata>
  ListEmailTemplatesResult& AddTemplatesMetadata(TemplatesMetadataT&& value) {
    m_templatesMetadataHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListEmailTemplatesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListEmailTemplatesResult& WithRequestId(RequestIdT&& value) {
