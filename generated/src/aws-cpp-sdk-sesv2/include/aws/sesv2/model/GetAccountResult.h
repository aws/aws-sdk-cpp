...
class GetAccountResult {
 public:
  ...
  template <typename SuppressionAttributesT = SuppressionAttributes>
  GetAccountResult& WithSuppressionAttributes(SuppressionAttributesT&& value) {
  ...
  template <typename DetailsT = AccountDetails>
  GetAccountResult& WithDetails(DetailsT&& value) {
  ...
  template <typename VdmAttributesT = VdmAttributes>
  GetAccountResult& WithVdmAttributes(VdmAttributesT&& value) {
