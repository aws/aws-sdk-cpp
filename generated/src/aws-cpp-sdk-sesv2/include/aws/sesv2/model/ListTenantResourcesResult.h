...
class ListTenantResourcesResult {
 public:
  ...
  void SetTenantResources(TenantResourcesT&& value) {
    m_tenantResourcesHasBeenSet = true;
    m_tenantResources = std::forward<TenantResourcesT>(value);
  }
  template <typename TenantResourcesT = Aws::Vector<TenantResource>>
  ListTenantResourcesResult& WithTenantResources(TenantResourcesT&& value) {
    SetTenantResources(std::forward<TenantResourcesT>(value));
    return *this;
  }
  template <typename TenantResourcesT = TenantResource>
  ListTenantResourcesResult& AddTenantResources(TenantResourcesT&& value) {
    m_tenantResourcesHasBeenSet = true;
    m_tenantResources.emplace_back(std::forward<TenantResourcesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTenantResourcesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListTenantResourcesResult& WithRequestId(RequestIdT&& value) {
