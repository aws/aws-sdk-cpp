...
class ListResourceTenantsResult {
 public:
  ...
  void SetResourceTenants(ResourceTenantsT&& value) {
    m_resourceTenantsHasBeenSet = true;
    m_resourceTenants = std::forward<ResourceTenantsT>(value);
  }
  template <typename ResourceTenantsT = Aws::Vector<ResourceTenantMetadata>>
  ListResourceTenantsResult& WithResourceTenants(ResourceTenantsT&& value) {
    SetResourceTenants(std::forward<ResourceTenantsT>(value));
    return *this;
  }
  template <typename ResourceTenantsT = ResourceTenantMetadata>
  ListResourceTenantsResult& AddResourceTenants(ResourceTenantsT&& value) {
    m_resourceTenantsHasBeenSet = true;
    m_resourceTenants.emplace_back(std::forward<ResourceTenantsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListResourceTenantsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListResourceTenantsResult& WithRequestId(RequestIdT&& value) {
