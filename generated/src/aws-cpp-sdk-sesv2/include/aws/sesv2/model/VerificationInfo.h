...
class VerificationInfo {
 public:
  ...
  template <typename LastCheckedTimestampT = Aws::Utils::DateTime>
  VerificationInfo& WithLastCheckedTimestamp(LastCheckedTimestampT&& value) {
  ...
  void SetLastSuccessTimestamp(LastSuccessTimestampT&& value) {
    m_lastSuccessTimestampHasBeenSet = true;
    m_lastSuccessTimestamp = std::forward<LastSuccessTimestampT>(value);
  }
  template <typename LastSuccessTimestampT = Aws::Utils::DateTime>
  VerificationInfo& WithLastSuccessTimestamp(LastSuccessTimestampT&& value) {
    SetLastSuccessTimestamp(std::forward<LastSuccessTimestampT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetErrorType(VerificationError value) {
    m_errorTypeHasBeenSet = true;
    m_errorType = value;
  }
  inline VerificationInfo& WithErrorType(VerificationError value) {
    SetErrorType(value);
    return *this;
  }
  ///@}
  ...
  void SetSOARecord(SOARecordT&& value) {
    m_sOARecordHasBeenSet = true;
    m_sOARecord = std::forward<SOARecordT>(value);
  }
  template <typename SOARecordT = SOARecord>
  VerificationInfo& WithSOARecord(SOARecordT&& value) {
    SetSOARecord(std::forward<SOARecordT>(value));
    return *this;
  }
  ///@}
 private:
