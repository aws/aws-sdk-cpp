...
class GetMultiRegionEndpointResult {
 public:
  ...
  template <typename EndpointNameT = Aws::String>
  GetMultiRegionEndpointResult& WithEndpointName(EndpointNameT&& value) {
  ...
  template <typename EndpointIdT = Aws::String>
  GetMultiRegionEndpointResult& WithEndpointId(EndpointIdT&& value) {
  ...
  template <typename RoutesT = Aws::Vector<Route>>
  GetMultiRegionEndpointResult& WithRoutes(RoutesT&& value) {
    SetRoutes(std::forward<RoutesT>(value));
    return *this;
  }
  template <typename RoutesT = Route>
  GetMultiRegionEndpointResult& AddRoutes(RoutesT&& value) {
    m_routesHasBeenSet = true;
  ...
  inline GetMultiRegionEndpointResult& WithStatus(Status value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreatedTimestampT = Aws::Utils::DateTime>
  GetMultiRegionEndpointResult& WithCreatedTimestamp(CreatedTimestampT&& value) {
  ...
  template <typename LastUpdatedTimestampT = Aws::Utils::DateTime>
  GetMultiRegionEndpointResult& WithLastUpdatedTimestamp(LastUpdatedTimestampT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetMultiRegionEndpointResult& WithRequestId(RequestIdT&& value) {
