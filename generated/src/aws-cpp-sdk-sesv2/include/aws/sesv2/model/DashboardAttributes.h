...
class DashboardAttributes {
 public:
  AWS_SESV2_API DashboardAttributes() = default;
  ...
  inline void SetEngagementMetrics(FeatureStatus value) {
    m_engagementMetricsHasBeenSet = true;
    m_engagementMetrics = value;
  }
  inline DashboardAttributes& WithEngagementMetrics(FeatureStatus value) {
    SetEngagementMetrics(value);
    return *this;
  }
  ///@}
 private:
