...
class UpdateReputationEntityPolicyRequest : public SESV2Request {
 public:
  ...
  inline UpdateReputationEntityPolicyRequest& WithReputationEntityType(ReputationEntityType value) {
  ...
  template <typename ReputationEntityReferenceT = Aws::String>
  UpdateReputationEntityPolicyRequest& WithReputationEntityReference(ReputationEntityReferenceT&& value) {
  ...
  void SetReputationEntityPolicy(ReputationEntityPolicyT&& value) {
    m_reputationEntityPolicyHasBeenSet = true;
    m_reputationEntityPolicy = std::forward<ReputationEntityPolicyT>(value);
  }
  template <typename ReputationEntityPolicyT = Aws::String>
  UpdateReputationEntityPolicyRequest& WithReputationEntityPolicy(ReputationEntityPolicyT&& value) {
    SetReputationEntityPolicy(std::forward<ReputationEntityPolicyT>(value));
    return *this;
  }
  ///@}
 private:
