...
namespace Model
{
  ...
  {
  public:
    AWS_SESV2_API PutConfigurationSetDeliveryOptionsResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    PutConfigurationSetDeliveryOptionsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
