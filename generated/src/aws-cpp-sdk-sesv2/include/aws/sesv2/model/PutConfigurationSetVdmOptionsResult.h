...
namespace Model
{
  ...
  public:
    ...
    inline PutConfigurationSetVdmOptionsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline PutConfigurationSetVdmOptionsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline PutConfigurationSetVdmOptionsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
