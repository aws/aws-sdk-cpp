...
class Topic {
 public:
  ...
  template <typename TopicNameT = Aws::String>
  Topic& WithTopicName(TopicNameT&& value) {
  ...
  template <typename DisplayNameT = Aws::String>
  Topic& WithDisplayName(DisplayNameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  Topic& WithDescription(DescriptionT&& value) {
  ...
  inline void SetDefaultSubscriptionStatus(SubscriptionStatus value) {
    m_defaultSubscriptionStatusHasBeenSet = true;
    m_defaultSubscriptionStatus = value;
  }
  inline Topic& WithDefaultSubscriptionStatus(SubscriptionStatus value) {
    SetDefaultSubscriptionStatus(value);
    return *this;
  }
  ///@}
 private:
