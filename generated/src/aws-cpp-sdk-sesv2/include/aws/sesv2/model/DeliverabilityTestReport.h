...
class DeliverabilityTestReport {
 public:
  ...
  void SetReportName(ReportNameT&& value) {
    ...
    m_reportName = std::forward<ReportNameT>(value);
  }
  template <typename ReportNameT = Aws::String>
  DeliverabilityTestReport& WithReportName(ReportNameT&& value) {
    SetReportName(std::forward<ReportNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline DeliverabilityTestReport& WithDeliverabilityTestStatus(DeliverabilityTestStatus value) {
