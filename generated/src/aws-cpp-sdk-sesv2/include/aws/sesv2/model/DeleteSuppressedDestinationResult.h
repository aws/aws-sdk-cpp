...
namespace Model
{
  ...
  {
  public:
    AWS_SESV2_API DeleteSuppressedDestinationResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteSuppressedDestinationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
