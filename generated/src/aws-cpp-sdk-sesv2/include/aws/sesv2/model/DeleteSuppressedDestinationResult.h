...
namespace Model
{
  ...
  public:
    ...
    inline DeleteSuppressedDestinationResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeleteSuppressedDestinationResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeleteSuppressedDestinationResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
