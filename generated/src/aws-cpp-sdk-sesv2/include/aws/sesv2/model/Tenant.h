...
class Tenant {
 public:
  ...
  template <typename TenantNameT = Aws::String>
  Tenant& WithTenantName(TenantNameT&& value) {
  ...
  template <typename TenantIdT = Aws::String>
  Tenant& WithTenantId(TenantIdT&& value) {
  ...
  template <typename TenantArnT = Aws::String>
  Tenant& WithTenantArn(TenantArnT&& value) {
  ...
  template <typename CreatedTimestampT = Aws::Utils::DateTime>
  Tenant& WithCreatedTimestamp(CreatedTimestampT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  Tenant& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  Tenant& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  inline Tenant& WithSendingStatus(SendingStatus value) {
