...
namespace Model
{
  ...
  {
  public:
    AWS_SESV2_API GuardianOptions() = default;
    ...
    inline GuardianOptions& WithOptimizedSharedDelivery(FeatureStatus value) { SetOptimizedSharedDelivery(value); return *this;}
    ///@}
  private:
