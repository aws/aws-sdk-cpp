...
class ExportStatistics {
 public:
  ...
  inline ExportStatistics& WithProcessedRecordsCount(int value) {
  ...
  inline void SetExportedRecordsCount(int value) {
    m_exportedRecordsCountHasBeenSet = true;
    m_exportedRecordsCount = value;
  }
  inline ExportStatistics& WithExportedRecordsCount(int value) {
    SetExportedRecordsCount(value);
    return *this;
  }
  ///@}
 private:
