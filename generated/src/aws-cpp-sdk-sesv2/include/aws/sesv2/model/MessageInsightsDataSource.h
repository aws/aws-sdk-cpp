...
class MessageInsightsDataSource {
 public:
  ...
  template <typename StartDateT = Aws::Utils::DateTime>
  MessageInsightsDataSource& WithStartDate(StartDateT&& value) {
  ...
  template <typename EndDateT = Aws::Utils::DateTime>
  MessageInsightsDataSource& WithEndDate(EndDateT&& value) {
  ...
  template <typename IncludeT = MessageInsightsFilters>
  MessageInsightsDataSource& WithInclude(IncludeT&& value) {
  ...
  template <typename ExcludeT = MessageInsightsFilters>
  MessageInsightsDataSource& WithExclude(ExcludeT&& value) {
  ...
  inline MessageInsightsDataSource& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
