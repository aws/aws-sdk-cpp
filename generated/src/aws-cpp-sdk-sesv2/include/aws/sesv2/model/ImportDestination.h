...
class ImportDestination {
 public:
  ...
  void SetSuppressionListDestination(SuppressionListDestinationT&& value) {
    m_suppressionListDestinationHasBeenSet = true;
    m_suppressionListDestination = std::forward<SuppressionListDestinationT>(value);
  }
  template <typename SuppressionListDestinationT = SuppressionListDestination>
  ImportDestination& WithSuppressionListDestination(SuppressionListDestinationT&& value) {
    SetSuppressionListDestination(std::forward<SuppressionListDestinationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetContactListDestination(ContactListDestinationT&& value) {
    m_contactListDestinationHasBeenSet = true;
    m_contactListDestination = std::forward<ContactListDestinationT>(value);
  }
  template <typename ContactListDestinationT = ContactListDestination>
  ImportDestination& WithContactListDestination(ContactListDestinationT&& value) {
    SetContactListDestination(std::forward<ContactListDestinationT>(value));
    return *this;
  }
  ///@}
 private:
