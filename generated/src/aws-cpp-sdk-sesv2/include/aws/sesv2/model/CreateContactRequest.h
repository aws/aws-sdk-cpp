...
class CreateContactRequest : public SESV2Request {
 public:
  ...
  template <typename ContactListNameT = Aws::String>
  CreateContactRequest& WithContactListName(ContactListNameT&& value) {
  ...
  template <typename EmailAddressT = Aws::String>
  CreateContactRequest& WithEmailAddress(EmailAddressT&& value) {
  ...
  template <typename TopicPreferencesT = Aws::Vector<TopicPreference>>
  CreateContactRequest& WithTopicPreferences(TopicPreferencesT&& value) {
    SetTopicPreferences(std::forward<TopicPreferencesT>(value));
    return *this;
  }
  template <typename TopicPreferencesT = TopicPreference>
  CreateContactRequest& AddTopicPreferences(TopicPreferencesT&& value) {
    m_topicPreferencesHasBeenSet = true;
  ...
  inline CreateContactRequest& WithUnsubscribeAll(bool value) {
  ...
  template <typename AttributesDataT = Aws::String>
  CreateContactRequest& WithAttributesData(AttributesDataT&& value) {
