...
class GetConfigurationSetResult {
 public:
  ...
  template <typename SuppressionOptionsT = SuppressionOptions>
  GetConfigurationSetResult& WithSuppressionOptions(SuppressionOptionsT&& value) {
  ...
  template <typename VdmOptionsT = VdmOptions>
  GetConfigurationSetResult& WithVdmOptions(VdmOptionsT&& value) {
  ...
  template <typename ArchivingOptionsT = ArchivingOptions>
  GetConfigurationSetResult& WithArchivingOptions(ArchivingOptionsT&& value) {
