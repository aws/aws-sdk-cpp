...
class CustomVerificationEmailTemplateMetadata {
 public:
  ...
  template <typename TemplateNameT = Aws::String>
  CustomVerificationEmailTemplateMetadata& WithTemplateName(TemplateNameT&& value) {
  ...
  template <typename FromEmailAddressT = Aws::String>
  CustomVerificationEmailTemplateMetadata& WithFromEmailAddress(FromEmailAddressT&& value) {
  ...
  template <typename TemplateSubjectT = Aws::String>
  CustomVerificationEmailTemplateMetadata& WithTemplateSubject(TemplateSubjectT&& value) {
  ...
  template <typename SuccessRedirectionURLT = Aws::String>
  CustomVerificationEmailTemplateMetadata& WithSuccessRedirectionURL(SuccessRedirectionURLT&& value) {
  ...
  template <typename FailureRedirectionURLT = Aws::String>
  CustomVerificationEmailTemplateMetadata& WithFailureRedirectionURL(FailureRedirectionURLT&& value) {
