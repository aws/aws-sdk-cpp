...
class TenantInfo {
 public:
  ...
  template <typename TenantNameT = Aws::String>
  TenantInfo& WithTenantName(TenantNameT&& value) {
  ...
  template <typename TenantIdT = Aws::String>
  TenantInfo& WithTenantId(TenantIdT&& value) {
  ...
  template <typename TenantArnT = Aws::String>
  TenantInfo& WithTenantArn(TenantArnT&& value) {
  ...
  template <typename CreatedTimestampT = Aws::Utils::DateTime>
  TenantInfo& WithCreatedTimestamp(CreatedTimestampT&& value) {
