...
class Bounce {
 public:
  ...
  inline Bounce& WithBounceType(BounceType value) {
    SetBounceType(value);
    return *this;
  }
  ///@}
  ...
  void SetBounceSubType(BounceSubTypeT&& value) {
    m_bounceSubTypeHasBeenSet = true;
    m_bounceSubType = std::forward<BounceSubTypeT>(value);
  }
  template <typename BounceSubTypeT = Aws::String>
  Bounce& WithBounceSubType(BounceSubTypeT&& value) {
    SetBounceSubType(std::forward<BounceSubTypeT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename DiagnosticCodeT = Aws::String>
  Bounce& WithDiagnosticCode(DiagnosticCodeT&& value) {
