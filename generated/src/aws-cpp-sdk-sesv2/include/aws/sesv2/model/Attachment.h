...
class Attachment {
 public:
  ...
  template <typename RawContentT = Aws::Utils::ByteBuffer>
  Attachment& WithRawContent(RawContentT&& value) {
  ...
  inline void SetContentDisposition(AttachmentContentDisposition value) {
    m_contentDispositionHasBeenSet = true;
    m_contentDisposition = value;
  }
  inline Attachment& WithContentDisposition(AttachmentContentDisposition value) {
  ...
  void SetContentDescription(ContentDescriptionT&& value) {
    m_contentDescriptionHasBeenSet = true;
    m_contentDescription = std::forward<ContentDescriptionT>(value);
  }
  template <typename ContentDescriptionT = Aws::String>
  Attachment& WithContentDescription(ContentDescriptionT&& value) {
    SetContentDescription(std::forward<ContentDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ContentIdT = Aws::String>
  Attachment& WithContentId(ContentIdT&& value) {
  ...
  inline void SetContentTransferEncoding(AttachmentContentTransferEncoding value) {
    m_contentTransferEncodingHasBeenSet = true;
    m_contentTransferEncoding = value;
  }
  inline Attachment& WithContentTransferEncoding(AttachmentContentTransferEncoding value) {
    SetContentTransferEncoding(value);
    return *this;
  }
  ///@}
  ...
  template <typename ContentTypeT = Aws::String>
  Attachment& WithContentType(ContentTypeT&& value) {
