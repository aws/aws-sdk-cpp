...
namespace Model
{
  ...
  public:
    ...
    inline PutConfigurationSetTrackingOptionsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline PutConfigurationSetTrackingOptionsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline PutConfigurationSetTrackingOptionsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
