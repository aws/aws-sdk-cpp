...
namespace Model
{
  ...
  {
  public:
    AWS_SESV2_API PutConfigurationSetTrackingOptionsResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    PutConfigurationSetTrackingOptionsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
