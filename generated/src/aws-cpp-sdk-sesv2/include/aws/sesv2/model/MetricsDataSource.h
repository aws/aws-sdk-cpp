...
class MetricsDataSource {
 public:
  ...
  template <typename DimensionsT = Aws::Map<MetricDimensionName, Aws::Vector<Aws::String>>>
  MetricsDataSource& WithDimensions(DimensionsT&& value) {
  ...
  inline MetricsDataSource& WithNamespace(MetricNamespace value) {
    SetNamespace(value);
    return *this;
  }
  ///@}
  ...
  template <typename MetricsT = Aws::Vector<ExportMetric>>
  MetricsDataSource& WithMetrics(MetricsT&& value) {
    SetMetrics(std::forward<MetricsT>(value));
    return *this;
  }
  template <typename MetricsT = ExportMetric>
  MetricsDataSource& AddMetrics(MetricsT&& value) {
    m_metricsHasBeenSet = true;
  ...
  template <typename StartDateT = Aws::Utils::DateTime>
  MetricsDataSource& WithStartDate(StartDateT&& value) {
  ...
  template <typename EndDateT = Aws::Utils::DateTime>
  MetricsDataSource& WithEndDate(EndDateT&& value) {
