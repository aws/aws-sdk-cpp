...
class PutConfigurationSetReputationOptionsRequest : public SESV2Request {
 public:
  ...
  template <typename ConfigurationSetNameT = Aws::String>
  PutConfigurationSetReputationOptionsRequest& WithConfigurationSetName(ConfigurationSetNameT&& value) {
  ...
  inline PutConfigurationSetReputationOptionsRequest& WithReputationMetricsEnabled(bool value) {
