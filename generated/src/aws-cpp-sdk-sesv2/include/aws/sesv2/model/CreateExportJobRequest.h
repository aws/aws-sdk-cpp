...
class CreateExportJobRequest : public SESV2Request {
 public:
  ...
  void SetExportDataSource(ExportDataSourceT&& value) {
    m_exportDataSourceHasBeenSet = true;
    m_exportDataSource = std::forward<ExportDataSourceT>(value);
  }
  template <typename ExportDataSourceT = ExportDataSource>
  CreateExportJobRequest& WithExportDataSource(ExportDataSourceT&& value) {
    SetExportDataSource(std::forward<ExportDataSourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExportDestination(ExportDestinationT&& value) {
    m_exportDestinationHasBeenSet = true;
    m_exportDestination = std::forward<ExportDestinationT>(value);
  }
  template <typename ExportDestinationT = ExportDestination>
  CreateExportJobRequest& WithExportDestination(ExportDestinationT&& value) {
    SetExportDestination(std::forward<ExportDestinationT>(value));
    return *this;
  }
  ///@}
 private:
