...
class Details {
 public:
  ...
  void SetRoutesDetails(RoutesDetailsT&& value) {
    m_routesDetailsHasBeenSet = true;
    m_routesDetails = std::forward<RoutesDetailsT>(value);
  }
  template <typename RoutesDetailsT = Aws::Vector<RouteDetails>>
  Details& WithRoutesDetails(RoutesDetailsT&& value) {
    SetRoutesDetails(std::forward<RoutesDetailsT>(value));
    return *this;
  }
  template <typename RoutesDetailsT = RouteDetails>
  Details& AddRoutesDetails(RoutesDetailsT&& value) {
    m_routesDetailsHasBeenSet = true;
    m_routesDetails.emplace_back(std::forward<RoutesDetailsT>(value));
    return *this;
  }
  ///@}
 private:
