...
class ListResourceTenantsRequest : public SESV2Request {
 public:
  ...
  template <typename ResourceArnT = Aws::String>
  ListResourceTenantsRequest& WithResourceArn(ResourceArnT&& value) {
  ...
  inline ListResourceTenantsRequest& WithPageSize(int value) {
    SetPageSize(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListResourceTenantsRequest& WithNextToken(NextTokenT&& value) {
