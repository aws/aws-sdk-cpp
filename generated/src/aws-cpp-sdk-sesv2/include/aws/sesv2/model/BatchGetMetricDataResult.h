...
class BatchGetMetricDataResult {
 public:
  ...
  template <typename ResultsT = Aws::Vector<MetricDataResult>>
  BatchGetMetricDataResult& WithResults(ResultsT&& value) {
    SetResults(std::forward<ResultsT>(value));
    return *this;
  }
  template <typename ResultsT = MetricDataResult>
  BatchGetMetricDataResult& AddResults(ResultsT&& value) {
    m_resultsHasBeenSet = true;
  ...
  template <typename ErrorsT = Aws::Vector<MetricDataError>>
  BatchGetMetricDataResult& WithErrors(ErrorsT&& value) {
    SetErrors(std::forward<ErrorsT>(value));
    return *this;
  }
  template <typename ErrorsT = MetricDataError>
  BatchGetMetricDataResult& AddErrors(ErrorsT&& value) {
    m_errorsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  BatchGetMetricDataResult& WithRequestId(RequestIdT&& value) {
