...
class ReplacementEmailContent {
 public:
  ...
  void SetReplacementTemplate(ReplacementTemplateT&& value) {
    m_replacementTemplateHasBeenSet = true;
    m_replacementTemplate = std::forward<ReplacementTemplateT>(value);
  }
  template <typename ReplacementTemplateT = ReplacementTemplate>
  ReplacementEmailContent& WithReplacementTemplate(ReplacementTemplateT&& value) {
    SetReplacementTemplate(std::forward<ReplacementTemplateT>(value));
    return *this;
  }
  ///@}
 private:
