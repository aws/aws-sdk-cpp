...
class ListContactListsResult {
 public:
  ...
  void SetContactLists(ContactListsT&& value) {
    m_contactListsHasBeenSet = true;
    m_contactLists = std::forward<ContactListsT>(value);
  }
  template <typename ContactListsT = Aws::Vector<ContactList>>
  ListContactListsResult& WithContactLists(ContactListsT&& value) {
    SetContactLists(std::forward<ContactListsT>(value));
    return *this;
  }
  template <typename ContactListsT = ContactList>
  ListContactListsResult& AddContactLists(ContactListsT&& value) {
    m_contactListsHasBeenSet = true;
    m_contactLists.emplace_back(std::forward<ContactListsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListContactListsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListContactListsResult& WithRequestId(RequestIdT&& value) {
