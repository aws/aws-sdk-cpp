...
class SuppressedDestinationSummary {
 public:
  ...
  template <typename EmailAddressT = Aws::String>
  SuppressedDestinationSummary& WithEmailAddress(EmailAddressT&& value) {
  ...
  inline void SetReason(SuppressionListReason value) {
    m_reasonHasBeenSet = true;
    m_reason = value;
  }
  inline SuppressedDestinationSummary& WithReason(SuppressionListReason value) {
    SetReason(value);
    return *this;
  }
  ///@}
  ...
  template <typename LastUpdateTimeT = Aws::Utils::DateTime>
  SuppressedDestinationSummary& WithLastUpdateTime(LastUpdateTimeT&& value) {
