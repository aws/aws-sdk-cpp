...
class ListMultiRegionEndpointsResult {
 public:
  ...
  void SetMultiRegionEndpoints(MultiRegionEndpointsT&& value) {
    m_multiRegionEndpointsHasBeenSet = true;
    m_multiRegionEndpoints = std::forward<MultiRegionEndpointsT>(value);
  }
  template <typename MultiRegionEndpointsT = Aws::Vector<MultiRegionEndpoint>>
  ListMultiRegionEndpointsResult& WithMultiRegionEndpoints(MultiRegionEndpointsT&& value) {
    SetMultiRegionEndpoints(std::forward<MultiRegionEndpointsT>(value));
    return *this;
  }
  template <typename MultiRegionEndpointsT = MultiRegionEndpoint>
  ListMultiRegionEndpointsResult& AddMultiRegionEndpoints(MultiRegionEndpointsT&& value) {
    m_multiRegionEndpointsHasBeenSet = true;
    m_multiRegionEndpoints.emplace_back(std::forward<MultiRegionEndpointsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListMultiRegionEndpointsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListMultiRegionEndpointsResult& WithRequestId(RequestIdT&& value) {
