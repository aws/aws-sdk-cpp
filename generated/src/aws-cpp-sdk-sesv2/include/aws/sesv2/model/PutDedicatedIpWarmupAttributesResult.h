...
namespace Model
{
  ...
  {
  public:
    AWS_SESV2_API PutDedicatedIpWarmupAttributesResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    PutDedicatedIpWarmupAttributesResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
