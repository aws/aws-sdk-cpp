...
class SendBulkEmailRequest : public SESV2Request {
 public:
  ...
  template <typename FromEmailAddressT = Aws::String>
  SendBulkEmailRequest& WithFromEmailAddress(FromEmailAddressT&& value) {
  ...
  void SetFromEmailAddressIdentityArn(FromEmailAddressIdentityArnT&& value) {
    m_fromEmailAddressIdentityArnHasBeenSet = true;
    m_fromEmailAddressIdentityArn = std::forward<FromEmailAddressIdentityArnT>(value);
  }
  template <typename FromEmailAddressIdentityArnT = Aws::String>
  SendBulkEmailRequest& WithFromEmailAddressIdentityArn(FromEmailAddressIdentityArnT&& value) {
    SetFromEmailAddressIdentityArn(std::forward<FromEmailAddressIdentityArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ReplyToAddressesT = Aws::Vector<Aws::String>>
  SendBulkEmailRequest& WithReplyToAddresses(ReplyToAddressesT&& value) {
    SetReplyToAddresses(std::forward<ReplyToAddressesT>(value));
    return *this;
  }
  template <typename ReplyToAddressesT = Aws::String>
  SendBulkEmailRequest& AddReplyToAddresses(ReplyToAddressesT&& value) {
    m_replyToAddressesHasBeenSet = true;
  ...
  void SetFeedbackForwardingEmailAddress(FeedbackForwardingEmailAddressT&& value) {
    m_feedbackForwardingEmailAddressHasBeenSet = true;
    m_feedbackForwardingEmailAddress = std::forward<FeedbackForwardingEmailAddressT>(value);
  }
  template <typename FeedbackForwardingEmailAddressT = Aws::String>
  SendBulkEmailRequest& WithFeedbackForwardingEmailAddress(FeedbackForwardingEmailAddressT&& value) {
    SetFeedbackForwardingEmailAddress(std::forward<FeedbackForwardingEmailAddressT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFeedbackForwardingEmailAddressIdentityArn(FeedbackForwardingEmailAddressIdentityArnT&& value) {
    m_feedbackForwardingEmailAddressIdentityArnHasBeenSet = true;
    m_feedbackForwardingEmailAddressIdentityArn = std::forward<FeedbackForwardingEmailAddressIdentityArnT>(value);
  }
  template <typename FeedbackForwardingEmailAddressIdentityArnT = Aws::String>
  SendBulkEmailRequest& WithFeedbackForwardingEmailAddressIdentityArn(FeedbackForwardingEmailAddressIdentityArnT&& value) {
    SetFeedbackForwardingEmailAddressIdentityArn(std::forward<FeedbackForwardingEmailAddressIdentityArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDefaultEmailTags(DefaultEmailTagsT&& value) {
    m_defaultEmailTagsHasBeenSet = true;
    m_defaultEmailTags = std::forward<DefaultEmailTagsT>(value);
  }
  template <typename DefaultEmailTagsT = Aws::Vector<MessageTag>>
  SendBulkEmailRequest& WithDefaultEmailTags(DefaultEmailTagsT&& value) {
    SetDefaultEmailTags(std::forward<DefaultEmailTagsT>(value));
    return *this;
  }
  template <typename DefaultEmailTagsT = MessageTag>
  SendBulkEmailRequest& AddDefaultEmailTags(DefaultEmailTagsT&& value) {
    m_defaultEmailTagsHasBeenSet = true;
    m_defaultEmailTags.emplace_back(std::forward<DefaultEmailTagsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDefaultContent(DefaultContentT&& value) {
    m_defaultContentHasBeenSet = true;
    m_defaultContent = std::forward<DefaultContentT>(value);
  }
  template <typename DefaultContentT = BulkEmailContent>
  SendBulkEmailRequest& WithDefaultContent(DefaultContentT&& value) {
    SetDefaultContent(std::forward<DefaultContentT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBulkEmailEntries(BulkEmailEntriesT&& value) {
    m_bulkEmailEntriesHasBeenSet = true;
    m_bulkEmailEntries = std::forward<BulkEmailEntriesT>(value);
  }
  template <typename BulkEmailEntriesT = Aws::Vector<BulkEmailEntry>>
  SendBulkEmailRequest& WithBulkEmailEntries(BulkEmailEntriesT&& value) {
    SetBulkEmailEntries(std::forward<BulkEmailEntriesT>(value));
    return *this;
  }
  template <typename BulkEmailEntriesT = BulkEmailEntry>
  SendBulkEmailRequest& AddBulkEmailEntries(BulkEmailEntriesT&& value) {
    m_bulkEmailEntriesHasBeenSet = true;
    m_bulkEmailEntries.emplace_back(std::forward<BulkEmailEntriesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ConfigurationSetNameT = Aws::String>
  SendBulkEmailRequest& WithConfigurationSetName(ConfigurationSetNameT&& value) {
  ...
  template <typename EndpointIdT = Aws::String>
  SendBulkEmailRequest& WithEndpointId(EndpointIdT&& value) {
  ...
  template <typename TenantNameT = Aws::String>
  SendBulkEmailRequest& WithTenantName(TenantNameT&& value) {
