...
class ListTenantsResult {
 public:
  ...
  void SetTenants(TenantsT&& value) {
    m_tenantsHasBeenSet = true;
    m_tenants = std::forward<TenantsT>(value);
  }
  template <typename TenantsT = Aws::Vector<TenantInfo>>
  ListTenantsResult& WithTenants(TenantsT&& value) {
    SetTenants(std::forward<TenantsT>(value));
    return *this;
  }
  template <typename TenantsT = TenantInfo>
  ListTenantsResult& AddTenants(TenantsT&& value) {
    m_tenantsHasBeenSet = true;
    m_tenants.emplace_back(std::forward<TenantsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTenantsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListTenantsResult& WithRequestId(RequestIdT&& value) {
