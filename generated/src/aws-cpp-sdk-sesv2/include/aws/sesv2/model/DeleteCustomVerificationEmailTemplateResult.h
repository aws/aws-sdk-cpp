...
class DeleteCustomVerificationEmailTemplateResult {
 public:
  AWS_SESV2_API DeleteCustomVerificationEmailTemplateResult() = default;
  ...
  AWS_SESV2_API DeleteCustomVerificationEmailTemplateResult& operator=(
  ...
  template <typename RequestIdT = Aws::String>
  DeleteCustomVerificationEmailTemplateResult& WithRequestId(RequestIdT&& value) {
