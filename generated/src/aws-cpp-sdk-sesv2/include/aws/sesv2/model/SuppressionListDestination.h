...
class SuppressionListDestination {
 public:
  ...
  inline void SetSuppressionListImportAction(SuppressionListImportAction value) {
    m_suppressionListImportActionHasBeenSet = true;
    m_suppressionListImportAction = value;
  }
  inline SuppressionListDestination& WithSuppressionListImportAction(SuppressionListImportAction value) {
    SetSuppressionListImportAction(value);
    return *this;
  }
  ///@}
 private:
