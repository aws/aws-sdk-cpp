...
class GetDomainDeliverabilityCampaignResult {
 public:
  ...
  void SetDomainDeliverabilityCampaign(DomainDeliverabilityCampaignT&& value) {
    m_domainDeliverabilityCampaignHasBeenSet = true;
    m_domainDeliverabilityCampaign = std::forward<DomainDeliverabilityCampaignT>(value);
  }
  template <typename DomainDeliverabilityCampaignT = DomainDeliverabilityCampaign>
  GetDomainDeliverabilityCampaignResult& WithDomainDeliverabilityCampaign(DomainDeliverabilityCampaignT&& value) {
    SetDomainDeliverabilityCampaign(std::forward<DomainDeliverabilityCampaignT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetDomainDeliverabilityCampaignResult& WithRequestId(RequestIdT&& value) {
