...
class UpdateContactRequest : public SESV2Request {
 public:
  AWS_SESV2_API UpdateContactRequest() = default;
  ...
  template <typename ContactListNameT = Aws::String>
  UpdateContactRequest& WithContactListName(ContactListNameT&& value) {
  ...
  template <typename EmailAddressT = Aws::String>
  UpdateContactRequest& WithEmailAddress(EmailAddressT&& value) {
  ...
  template <typename TopicPreferencesT = Aws::Vector<TopicPreference>>
  UpdateContactRequest& WithTopicPreferences(TopicPreferencesT&& value) {
    SetTopicPreferences(std::forward<TopicPreferencesT>(value));
    return *this;
  }
  template <typename TopicPreferencesT = TopicPreference>
  UpdateContactRequest& AddTopicPreferences(TopicPreferencesT&& value) {
    m_topicPreferencesHasBeenSet = true;
  ...
  inline UpdateContactRequest& WithUnsubscribeAll(bool value) {
  ...
  void SetAttributesData(AttributesDataT&& value) {
    m_attributesDataHasBeenSet = true;
    m_attributesData = std::forward<AttributesDataT>(value);
  }
  template <typename AttributesDataT = Aws::String>
  UpdateContactRequest& WithAttributesData(AttributesDataT&& value) {
    SetAttributesData(std::forward<AttributesDataT>(value));
    return *this;
  }
  ///@}
 private:
