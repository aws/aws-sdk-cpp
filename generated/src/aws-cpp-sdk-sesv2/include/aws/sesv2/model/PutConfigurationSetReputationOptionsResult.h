...
namespace Model
{
  ...
  public:
    ...
    inline PutConfigurationSetReputationOptionsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline PutConfigurationSetReputationOptionsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline PutConfigurationSetReputationOptionsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
