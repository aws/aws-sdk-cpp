...
class Complaint {
 public:
  ...
  void SetComplaintSubType(ComplaintSubTypeT&& value) {
    m_complaintSubTypeHasBeenSet = true;
    m_complaintSubType = std::forward<ComplaintSubTypeT>(value);
  }
  template <typename ComplaintSubTypeT = Aws::String>
  Complaint& WithComplaintSubType(ComplaintSubTypeT&& value) {
    SetComplaintSubType(std::forward<ComplaintSubTypeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetComplaintFeedbackType(ComplaintFeedbackTypeT&& value) {
    m_complaintFeedbackTypeHasBeenSet = true;
    m_complaintFeedbackType = std::forward<ComplaintFeedbackTypeT>(value);
  }
  template <typename ComplaintFeedbackTypeT = Aws::String>
  Complaint& WithComplaintFeedbackType(ComplaintFeedbackTypeT&& value) {
    SetComplaintFeedbackType(std::forward<ComplaintFeedbackTypeT>(value));
    return *this;
  }
  ///@}
 private:
