...
class DedicatedIp {
 public:
  ...
  inline void SetWarmupStatus(WarmupStatus value) {
    m_warmupStatusHasBeenSet = true;
    m_warmupStatus = value;
  }
  inline DedicatedIp& WithWarmupStatus(WarmupStatus value) {
    SetWarmupStatus(value);
    return *this;
  }
  ///@}
  ...
  inline DedicatedIp& WithWarmupPercentage(int value) {
