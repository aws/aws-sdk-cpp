...
class ListImportJobsResult {
 public:
  ...
  template <typename ImportJobsT = Aws::Vector<ImportJobSummary>>
  ListImportJobsResult& WithImportJobs(ImportJobsT&& value) {
    SetImportJobs(std::forward<ImportJobsT>(value));
    return *this;
  }
  template <typename ImportJobsT = ImportJobSummary>
  ListImportJobsResult& AddImportJobs(ImportJobsT&& value) {
    m_importJobsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListImportJobsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListImportJobsResult& WithRequestId(RequestIdT&& value) {
