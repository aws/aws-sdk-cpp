...
class MessageInsightsFilters {
 public:
  ...
  template <typename FromEmailAddressT = Aws::Vector<Aws::String>>
  MessageInsightsFilters& WithFromEmailAddress(FromEmailAddressT&& value) {
    SetFromEmailAddress(std::forward<FromEmailAddressT>(value));
    return *this;
  }
  template <typename FromEmailAddressT = Aws::String>
  MessageInsightsFilters& AddFromEmailAddress(FromEmailAddressT&& value) {
    m_fromEmailAddressHasBeenSet = true;
    m_fromEmailAddress.emplace_back(std::forward<FromEmailAddressT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename DestinationT = Aws::Vector<Aws::String>>
  MessageInsightsFilters& WithDestination(DestinationT&& value) {
    SetDestination(std::forward<DestinationT>(value));
    return *this;
  }
  template <typename DestinationT = Aws::String>
  MessageInsightsFilters& AddDestination(DestinationT&& value) {
    m_destinationHasBeenSet = true;
  ...
  template <typename SubjectT = Aws::Vector<Aws::String>>
  MessageInsightsFilters& WithSubject(SubjectT&& value) {
    SetSubject(std::forward<SubjectT>(value));
    return *this;
  }
  template <typename SubjectT = Aws::String>
  MessageInsightsFilters& AddSubject(SubjectT&& value) {
    m_subjectHasBeenSet = true;
    m_subject.emplace_back(std::forward<SubjectT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename IspT = Aws::Vector<Aws::String>>
  MessageInsightsFilters& WithIsp(IspT&& value) {
    SetIsp(std::forward<IspT>(value));
    return *this;
  }
  template <typename IspT = Aws::String>
  MessageInsightsFilters& AddIsp(IspT&& value) {
    m_ispHasBeenSet = true;
    m_isp.emplace_back(std::forward<IspT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastDeliveryEvent(LastDeliveryEventT&& value) {
    m_lastDeliveryEventHasBeenSet = true;
    m_lastDeliveryEvent = std::forward<LastDeliveryEventT>(value);
  }
  template <typename LastDeliveryEventT = Aws::Vector<DeliveryEventType>>
  MessageInsightsFilters& WithLastDeliveryEvent(LastDeliveryEventT&& value) {
    SetLastDeliveryEvent(std::forward<LastDeliveryEventT>(value));
    return *this;
  }
  inline MessageInsightsFilters& AddLastDeliveryEvent(DeliveryEventType value) {
    m_lastDeliveryEventHasBeenSet = true;
    m_lastDeliveryEvent.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetLastEngagementEvent(LastEngagementEventT&& value) {
    m_lastEngagementEventHasBeenSet = true;
    m_lastEngagementEvent = std::forward<LastEngagementEventT>(value);
  }
  template <typename LastEngagementEventT = Aws::Vector<EngagementEventType>>
  MessageInsightsFilters& WithLastEngagementEvent(LastEngagementEventT&& value) {
    SetLastEngagementEvent(std::forward<LastEngagementEventT>(value));
    return *this;
  }
  inline MessageInsightsFilters& AddLastEngagementEvent(EngagementEventType value) {
    m_lastEngagementEventHasBeenSet = true;
    m_lastEngagementEvent.push_back(value);
    return *this;
  }
  ///@}
 private:
