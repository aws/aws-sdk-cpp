...
class ListTenantResourcesRequest : public SESV2Request {
 public:
  ...
  template <typename TenantNameT = Aws::String>
  ListTenantResourcesRequest& WithTenantName(TenantNameT&& value) {
  ...
  template <typename FilterT = Aws::Map<ListTenantResourcesFilterKey, Aws::String>>
  ListTenantResourcesRequest& WithFilter(FilterT&& value) {
  ...
  inline ListTenantResourcesRequest& WithPageSize(int value) {
    SetPageSize(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTenantResourcesRequest& WithNextToken(NextTokenT&& value) {
