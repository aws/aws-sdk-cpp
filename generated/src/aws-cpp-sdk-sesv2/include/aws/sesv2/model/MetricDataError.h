...
class MetricDataError {
 public:
  ...
  template <typename IdT = Aws::String>
  MetricDataError& WithId(IdT&& value) {
  ...
  inline void SetCode(QueryErrorCode value) {
    m_codeHasBeenSet = true;
    m_code = value;
  }
  inline MetricDataError& WithCode(QueryErrorCode value) {
    SetCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename MessageT = Aws::String>
  MetricDataError& WithMessage(MessageT&& value) {
