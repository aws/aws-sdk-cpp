...
class VdmAttributes {
 public:
  ...
  inline void SetVdmEnabled(FeatureStatus value) {
    m_vdmEnabledHasBeenSet = true;
    m_vdmEnabled = value;
  }
  inline VdmAttributes& WithVdmEnabled(FeatureStatus value) {
    SetVdmEnabled(value);
    return *this;
  }
  ///@}
  ...
  void SetDashboardAttributes(DashboardAttributesT&& value) {
    m_dashboardAttributesHasBeenSet = true;
    m_dashboardAttributes = std::forward<DashboardAttributesT>(value);
  }
  template <typename DashboardAttributesT = DashboardAttributes>
  VdmAttributes& WithDashboardAttributes(DashboardAttributesT&& value) {
    SetDashboardAttributes(std::forward<DashboardAttributesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGuardianAttributes(GuardianAttributesT&& value) {
    m_guardianAttributesHasBeenSet = true;
    m_guardianAttributes = std::forward<GuardianAttributesT>(value);
  }
  template <typename GuardianAttributesT = GuardianAttributes>
  VdmAttributes& WithGuardianAttributes(GuardianAttributesT&& value) {
    SetGuardianAttributes(std::forward<GuardianAttributesT>(value));
    return *this;
  }
  ///@}
 private:
