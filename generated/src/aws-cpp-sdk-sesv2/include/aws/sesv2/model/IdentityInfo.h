...
class IdentityInfo {
 public:
  ...
  inline IdentityInfo& WithIdentityType(IdentityType value) {
  ...
  inline IdentityInfo& WithSendingEnabled(bool value) {
  ...
  inline IdentityInfo& WithVerificationStatus(VerificationStatus value) {
