...
namespace Model
{
  ...
  {
  public:
    AWS_SESV2_API PutAccountSuppressionAttributesResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    PutAccountSuppressionAttributesResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
