...
class BatchGetMetricDataQuery {
 public:
  ...
  template <typename IdT = Aws::String>
  BatchGetMetricDataQuery& WithId(IdT&& value) {
  ...
  inline void SetNamespace(MetricNamespace value) {
    m_namespaceHasBeenSet = true;
    m_namespace = value;
  }
  inline BatchGetMetricDataQuery& WithNamespace(MetricNamespace value) {
    SetNamespace(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMetric(Metric value) {
    m_metricHasBeenSet = true;
    m_metric = value;
  }
  inline BatchGetMetricDataQuery& WithMetric(Metric value) {
    SetMetric(value);
    return *this;
  }
  ///@}
  ...
  template <typename DimensionsT = Aws::Map<MetricDimensionName, Aws::String>>
  BatchGetMetricDataQuery& WithDimensions(DimensionsT&& value) {
  ...
  template <typename StartDateT = Aws::Utils::DateTime>
  BatchGetMetricDataQuery& WithStartDate(StartDateT&& value) {
  ...
  template <typename EndDateT = Aws::Utils::DateTime>
  BatchGetMetricDataQuery& WithEndDate(EndDateT&& value) {
