...
class ListSuppressedDestinationsResult {
 public:
   ...
   * destination.</p>
   */
  inline const Aws::Vector<SuppressedDestinationSummary>& GetSuppressedDestinationSummaries() const {
    return m_suppressedDestinationSummaries;
  }
  template <typename SuppressedDestinationSummariesT = Aws::Vector<SuppressedDestinationSummary>>
  void SetSuppressedDestinationSummaries(SuppressedDestinationSummariesT&& value) {
    m_suppressedDestinationSummariesHasBeenSet = true;
    m_suppressedDestinationSummaries = std::forward<SuppressedDestinationSummariesT>(value);
  }
  template <typename SuppressedDestinationSummariesT = Aws::Vector<SuppressedDestinationSummary>>
  ListSuppressedDestinationsResult& WithSuppressedDestinationSummaries(SuppressedDestinationSummariesT&& value) {
    SetSuppressedDestinationSummaries(std::forward<SuppressedDestinationSummariesT>(value));
    return *this;
  }
  template <typename SuppressedDestinationSummariesT = SuppressedDestinationSummary>
  ListSuppressedDestinationsResult& AddSuppressedDestinationSummaries(SuppressedDestinationSummariesT&& value) {
    m_suppressedDestinationSummariesHasBeenSet = true;
    m_suppressedDestinationSummaries.emplace_back(std::forward<SuppressedDestinationSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListSuppressedDestinationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListSuppressedDestinationsResult& WithRequestId(RequestIdT&& value) {
