 ...
 * <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/sesv2-2019-09-27/GetEmailIdentityRequest">AWS
 * API Reference</a></p>
 */
class GetEmailIdentityRequest : public SESV2Request {
 public:
  AWS_SESV2_API GetEmailIdentityRequest() = default;
  ...
  template <typename EmailIdentityT = Aws::String>
  GetEmailIdentityRequest& WithEmailIdentity(EmailIdentityT&& value) {
