...
class CreateMultiRegionEndpointResult {
 public:
  ...
  inline CreateMultiRegionEndpointResult& WithStatus(Status value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename EndpointIdT = Aws::String>
  CreateMultiRegionEndpointResult& WithEndpointId(EndpointIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateMultiRegionEndpointResult& WithRequestId(RequestIdT&& value) {
