...
class FailureInfo {
 public:
  ...
  void SetFailedRecordsS3Url(FailedRecordsS3UrlT&& value) {
    m_failedRecordsS3UrlHasBeenSet = true;
    m_failedRecordsS3Url = std::forward<FailedRecordsS3UrlT>(value);
  }
  template <typename FailedRecordsS3UrlT = Aws::String>
  FailureInfo& WithFailedRecordsS3Url(FailedRecordsS3UrlT&& value) {
    SetFailedRecordsS3Url(std::forward<FailedRecordsS3UrlT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ErrorMessageT = Aws::String>
  FailureInfo& WithErrorMessage(ErrorMessageT&& value) {
