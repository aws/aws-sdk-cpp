...
class ExportDataSource {
 public:
  ...
  void SetMetricsDataSource(MetricsDataSourceT&& value) {
    m_metricsDataSourceHasBeenSet = true;
    m_metricsDataSource = std::forward<MetricsDataSourceT>(value);
  }
  template <typename MetricsDataSourceT = MetricsDataSource>
  ExportDataSource& WithMetricsDataSource(MetricsDataSourceT&& value) {
    SetMetricsDataSource(std::forward<MetricsDataSourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMessageInsightsDataSource(MessageInsightsDataSourceT&& value) {
    m_messageInsightsDataSourceHasBeenSet = true;
    m_messageInsightsDataSource = std::forward<MessageInsightsDataSourceT>(value);
  }
  template <typename MessageInsightsDataSourceT = MessageInsightsDataSource>
  ExportDataSource& WithMessageInsightsDataSource(MessageInsightsDataSourceT&& value) {
    SetMessageInsightsDataSource(std::forward<MessageInsightsDataSourceT>(value));
    return *this;
  }
  ///@}
 private:
