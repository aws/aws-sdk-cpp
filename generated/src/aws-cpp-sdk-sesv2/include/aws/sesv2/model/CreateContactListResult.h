...
namespace Model
{
  ...
  {
  public:
    AWS_SESV2_API CreateContactListResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    CreateContactListResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
