...
class GetReputationEntityResult {
 public:
  ...
  void SetReputationEntity(ReputationEntityT&& value) {
    m_reputationEntityHasBeenSet = true;
    m_reputationEntity = std::forward<ReputationEntityT>(value);
  }
  template <typename ReputationEntityT = ReputationEntity>
  GetReputationEntityResult& WithReputationEntity(ReputationEntityT&& value) {
    SetReputationEntity(std::forward<ReputationEntityT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetReputationEntityResult& WithRequestId(RequestIdT&& value) {
