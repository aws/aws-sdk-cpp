...
class PutAccountVdmAttributesRequest : public SESV2Request {
 public:
  ...
  void SetVdmAttributes(VdmAttributesT&& value) {
    m_vdmAttributesHasBeenSet = true;
    m_vdmAttributes = std::forward<VdmAttributesT>(value);
  }
  template <typename VdmAttributesT = VdmAttributes>
  PutAccountVdmAttributesRequest& WithVdmAttributes(VdmAttributesT&& value) {
    SetVdmAttributes(std::forward<VdmAttributesT>(value));
    return *this;
  }
  ///@}
 private:
