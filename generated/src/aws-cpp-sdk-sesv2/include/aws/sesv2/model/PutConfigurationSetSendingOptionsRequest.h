...
class PutConfigurationSetSendingOptionsRequest : public SESV2Request {
 public:
  AWS_SESV2_API PutConfigurationSetSendingOptionsRequest() = default;
  ...
  template <typename ConfigurationSetNameT = Aws::String>
  PutConfigurationSetSendingOptionsRequest& WithConfigurationSetName(ConfigurationSetNameT&& value) {
  ...
  inline PutConfigurationSetSendingOptionsRequest& WithSendingEnabled(bool value) {
