...
class PutConfigurationSetArchivingOptionsResult {
 public:
  AWS_SESV2_API PutConfigurationSetArchivingOptionsResult() = default;
  AWS_SESV2_API PutConfigurationSetArchivingOptionsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_SESV2_API PutConfigurationSetArchivingOptionsResult& operator=(
  ...
  template <typename RequestIdT = Aws::String>
  PutConfigurationSetArchivingOptionsResult& WithRequestId(RequestIdT&& value) {
