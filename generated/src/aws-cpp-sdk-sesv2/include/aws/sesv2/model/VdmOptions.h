...
class VdmOptions {
 public:
  ...
  void SetDashboardOptions(DashboardOptionsT&& value) {
    m_dashboardOptionsHasBeenSet = true;
    m_dashboardOptions = std::forward<DashboardOptionsT>(value);
  }
  template <typename DashboardOptionsT = DashboardOptions>
  VdmOptions& WithDashboardOptions(DashboardOptionsT&& value) {
    SetDashboardOptions(std::forward<DashboardOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGuardianOptions(GuardianOptionsT&& value) {
    m_guardianOptionsHasBeenSet = true;
    m_guardianOptions = std::forward<GuardianOptionsT>(value);
  }
  template <typename GuardianOptionsT = GuardianOptions>
  VdmOptions& WithGuardianOptions(GuardianOptionsT&& value) {
    SetGuardianOptions(std::forward<GuardianOptionsT>(value));
    return *this;
  }
  ///@}
 private:
