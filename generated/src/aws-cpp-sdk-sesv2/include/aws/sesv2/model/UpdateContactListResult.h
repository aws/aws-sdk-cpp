...
namespace Model
{
  ...
  {
  public:
    AWS_SESV2_API UpdateContactListResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateContactListResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
