...
class GuardianAttributes {
 public:
  ...
  inline void SetOptimizedSharedDelivery(FeatureStatus value) {
    m_optimizedSharedDeliveryHasBeenSet = true;
    m_optimizedSharedDelivery = value;
  }
  inline GuardianAttributes& WithOptimizedSharedDelivery(FeatureStatus value) {
    SetOptimizedSharedDelivery(value);
    return *this;
  }
  ///@}
 private:
