...
class DkimSigningAttributes {
 public:
  ...
  void SetDomainSigningSelector(DomainSigningSelectorT&& value) {
    m_domainSigningSelectorHasBeenSet = true;
    m_domainSigningSelector = std::forward<DomainSigningSelectorT>(value);
  }
  template <typename DomainSigningSelectorT = Aws::String>
  DkimSigningAttributes& WithDomainSigningSelector(DomainSigningSelectorT&& value) {
    SetDomainSigningSelector(std::forward<DomainSigningSelectorT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDomainSigningPrivateKey(DomainSigningPrivateKeyT&& value) {
    m_domainSigningPrivateKeyHasBeenSet = true;
    m_domainSigningPrivateKey = std::forward<DomainSigningPrivateKeyT>(value);
  }
  template <typename DomainSigningPrivateKeyT = Aws::String>
  DkimSigningAttributes& WithDomainSigningPrivateKey(DomainSigningPrivateKeyT&& value) {
    SetDomainSigningPrivateKey(std::forward<DomainSigningPrivateKeyT>(value));
    return *this;
  }
  ///@}
  ...
  inline DkimSigningAttributes& WithNextSigningKeyLength(DkimSigningKeyLength value) {
   ...
   * <code>AWS_SES_CA_WEST_1</code> – Configure DKIM for the identity by replicating
   * from a parent identity in Canada (Calgary) region using Deterministic Easy-DKIM
   * (DEED). </p> </li> <li> <p> <code>AWS_SES_AP_SOUTHEAST_1</code> – Configure DKIM
   * for the identity by replicating from a parent identity in Asia Pacific
   * (Singapore) region using Deterministic Easy-DKIM (DEED). </p> </li> <li> <p>
  ...
  inline void SetDomainSigningAttributesOrigin(DkimSigningAttributesOrigin value) {
    m_domainSigningAttributesOriginHasBeenSet = true;
    m_domainSigningAttributesOrigin = value;
  }
  inline DkimSigningAttributes& WithDomainSigningAttributesOrigin(DkimSigningAttributesOrigin value) {
    SetDomainSigningAttributesOrigin(value);
    return *this;
  }
  ///@}
 private:
