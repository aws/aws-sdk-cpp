...
class SuppressedDestination {
 public:
  ...
  template <typename EmailAddressT = Aws::String>
  SuppressedDestination& WithEmailAddress(EmailAddressT&& value) {
  ...
  inline SuppressedDestination& WithReason(SuppressionListReason value) {
    SetReason(value);
    return *this;
  }
  ///@}
  ...
  template <typename LastUpdateTimeT = Aws::Utils::DateTime>
  SuppressedDestination& WithLastUpdateTime(LastUpdateTimeT&& value) {
  ...
  template <typename AttributesT = SuppressedDestinationAttributes>
  SuppressedDestination& WithAttributes(AttributesT&& value) {
