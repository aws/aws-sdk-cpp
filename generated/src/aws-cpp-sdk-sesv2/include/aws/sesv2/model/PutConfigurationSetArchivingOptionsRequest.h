...
class PutConfigurationSetArchivingOptionsRequest : public SESV2Request {
 public:
  ...
  template <typename ConfigurationSetNameT = Aws::String>
  PutConfigurationSetArchivingOptionsRequest& WithConfigurationSetName(ConfigurationSetNameT&& value) {
  ...
  template <typename ArchiveArnT = Aws::String>
  PutConfigurationSetArchivingOptionsRequest& WithArchiveArn(ArchiveArnT&& value) {
