...
namespace Aws
{
  ...
  namespace SESV2
  {
    ...
    namespace Model
    {
      ...
      typedef Aws::Utils::Outcome<UpdateReputationEntityCustomerManagedStatusResult, SESV2Error> UpdateReputationEntityCustomerManagedStatusOutcome;
    ...
    typedef std::function<void(const SESV2Client*, const Model::CreateTenantResourceAssociationRequest&, const Model::CreateTenantResourceAssociationOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > CreateTenantResourceAssociationResponseReceivedHandler;
    ...
    typedef std::function<void(const SESV2Client*, const Model::DeleteTenantResourceAssociationRequest&, const Model::DeleteTenantResourceAssociationOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > DeleteTenantResourceAssociationResponseReceivedHandler;
    ...
    typedef std::function<void(const SESV2Client*, const Model::GetReputationEntityRequest&, const Model::GetReputationEntityOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > GetReputationEntityResponseReceivedHandler;
    ...
    typedef std::function<void(const SESV2Client*, const Model::ListReputationEntitiesRequest&, const Model::ListReputationEntitiesOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > ListReputationEntitiesResponseReceivedHandler;
    typedef std::function<void(const SESV2Client*, const Model::ListResourceTenantsRequest&, const Model::ListResourceTenantsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > ListResourceTenantsResponseReceivedHandler;
    ...
    typedef std::function<void(const SESV2Client*, const Model::ListTenantResourcesRequest&, const Model::ListTenantResourcesOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > ListTenantResourcesResponseReceivedHandler;
    ...
    typedef std::function<void(const SESV2Client*, const Model::UpdateReputationEntityCustomerManagedStatusRequest&, const Model::UpdateReputationEntityCustomerManagedStatusOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > UpdateReputationEntityCustomerManagedStatusResponseReceivedHandler;
    typedef std::function<void(const SESV2Client*, const Model::UpdateReputationEntityPolicyRequest&, const Model::UpdateReputationEntityPolicyOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > UpdateReputationEntityPolicyResponseReceivedHandler;
