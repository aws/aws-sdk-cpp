...
namespace IoTTwinMaker
{
   ...
   * errors.</p>
   */
  class AWS_IOTTWINMAKER_API IoTTwinMakerClient : Aws::Client::ClientWithAsyncTemplateMethods<IoTTwinMakerClient>,
    smithy::client::AwsSmithyClientT<Aws::IoTTwinMaker::SERVICE_NAME,
