...
class AWS_IOTTWINMAKER_API IoTTwinMakerClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  IoTTwinMakerClient(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<IoTTwinMakerEndpointProviderBase> endpointProvider = nullptr,
      const Aws::IoTTwinMaker::IoTTwinMakerClientConfiguration& clientConfiguration = Aws::IoTTwinMaker::IoTTwinMakerClientConfiguration());
  ...
  /**
   * A Callable wrapper for BatchPutPropertyValues that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchPutPropertyValues that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchPutPropertyValuesRequestT = Model::BatchPutPropertyValuesRequest>
  void BatchPutPropertyValuesAsync(const BatchPutPropertyValuesRequestT& request,
                                   const BatchPutPropertyValuesResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for CancelMetadataTransferJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CancelMetadataTransferJobRequestT = Model::CancelMetadataTransferJobRequest>
  Model::CancelMetadataTransferJobOutcomeCallable CancelMetadataTransferJobCallable(
      const CancelMetadataTransferJobRequestT& request) const {
    return SubmitCallable(&IoTTwinMakerClient::CancelMetadataTransferJob, request);
  }

  /**
   * An Async wrapper for CancelMetadataTransferJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CancelMetadataTransferJobRequestT = Model::CancelMetadataTransferJobRequest>
  void CancelMetadataTransferJobAsync(const CancelMetadataTransferJobRequestT& request,
                                      const CancelMetadataTransferJobResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateComponentType that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateComponentType that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateComponentTypeRequestT = Model::CreateComponentTypeRequest>
  void CreateComponentTypeAsync(const CreateComponentTypeRequestT& request, const CreateComponentTypeResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateEntity that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateEntityRequestT = Model::CreateEntityRequest>
  void CreateEntityAsync(const CreateEntityRequestT& request, const CreateEntityResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateMetadataTransferJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CreateMetadataTransferJobRequestT = Model::CreateMetadataTransferJobRequest>
  Model::CreateMetadataTransferJobOutcomeCallable CreateMetadataTransferJobCallable(
      const CreateMetadataTransferJobRequestT& request) const {
    return SubmitCallable(&IoTTwinMakerClient::CreateMetadataTransferJob, request);
  }

  /**
   * An Async wrapper for CreateMetadataTransferJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateMetadataTransferJobRequestT = Model::CreateMetadataTransferJobRequest>
  void CreateMetadataTransferJobAsync(const CreateMetadataTransferJobRequestT& request,
                                      const CreateMetadataTransferJobResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateScene that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateSceneRequestT = Model::CreateSceneRequest>
  void CreateSceneAsync(const CreateSceneRequestT& request, const CreateSceneResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateSyncJob that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateSyncJobRequestT = Model::CreateSyncJobRequest>
  void CreateSyncJobAsync(const CreateSyncJobRequestT& request, const CreateSyncJobResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteComponentType that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteComponentType that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteComponentTypeRequestT = Model::DeleteComponentTypeRequest>
  void DeleteComponentTypeAsync(const DeleteComponentTypeRequestT& request, const DeleteComponentTypeResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteEntity that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteEntityRequestT = Model::DeleteEntityRequest>
  void DeleteEntityAsync(const DeleteEntityRequestT& request, const DeleteEntityResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteScene that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteSceneRequestT = Model::DeleteSceneRequest>
  void DeleteSceneAsync(const DeleteSceneRequestT& request, const DeleteSceneResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteSyncJob that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteSyncJobRequestT = Model::DeleteSyncJobRequest>
  void DeleteSyncJobAsync(const DeleteSyncJobRequestT& request, const DeleteSyncJobResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetComponentType that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetComponentType that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetComponentTypeRequestT = Model::GetComponentTypeRequest>
  void GetComponentTypeAsync(const GetComponentTypeRequestT& request, const GetComponentTypeResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetEntity that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetEntityRequestT = Model::GetEntityRequest>
  void GetEntityAsync(const GetEntityRequestT& request, const GetEntityResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetMetadataTransferJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetMetadataTransferJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetMetadataTransferJobRequestT = Model::GetMetadataTransferJobRequest>
  void GetMetadataTransferJobAsync(const GetMetadataTransferJobRequestT& request,
                                   const GetMetadataTransferJobResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetPricingPlan that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetPricingPlanRequestT = Model::GetPricingPlanRequest>
  void GetPricingPlanAsync(const GetPricingPlanResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const GetPricingPlanRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetPropertyValue that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetPropertyValue that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetPropertyValueRequestT = Model::GetPropertyValueRequest>
  void GetPropertyValueAsync(const GetPropertyValueRequestT& request, const GetPropertyValueResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetPropertyValueHistory that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetPropertyValueHistory that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetPropertyValueHistoryRequestT = Model::GetPropertyValueHistoryRequest>
  void GetPropertyValueHistoryAsync(const GetPropertyValueHistoryRequestT& request,
                                    const GetPropertyValueHistoryResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetScene that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetSceneRequestT = Model::GetSceneRequest>
  void GetSceneAsync(const GetSceneRequestT& request, const GetSceneResponseReceivedHandler& handler,
                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetSyncJob that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetSyncJobRequestT = Model::GetSyncJobRequest>
  void GetSyncJobAsync(const GetSyncJobRequestT& request, const GetSyncJobResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetWorkspace that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetWorkspaceRequestT = Model::GetWorkspaceRequest>
  void GetWorkspaceAsync(const GetWorkspaceRequestT& request, const GetWorkspaceResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListComponentTypes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListComponentTypes that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListComponentTypesRequestT = Model::ListComponentTypesRequest>
  void ListComponentTypesAsync(const ListComponentTypesRequestT& request, const ListComponentTypesResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListMetadataTransferJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListMetadataTransferJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListMetadataTransferJobsRequestT = Model::ListMetadataTransferJobsRequest>
  void ListMetadataTransferJobsAsync(const ListMetadataTransferJobsRequestT& request,
                                     const ListMetadataTransferJobsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListProperties that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListPropertiesRequestT = Model::ListPropertiesRequest>
  void ListPropertiesAsync(const ListPropertiesRequestT& request, const ListPropertiesResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListScenes that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListScenesRequestT = Model::ListScenesRequest>
  void ListScenesAsync(const ListScenesRequestT& request, const ListScenesResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListSyncJobs that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListSyncJobsRequestT = Model::ListSyncJobsRequest>
  void ListSyncJobsAsync(const ListSyncJobsRequestT& request, const ListSyncJobsResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListSyncResources that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListSyncResources that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListSyncResourcesRequestT = Model::ListSyncResourcesRequest>
  void ListSyncResourcesAsync(const ListSyncResourcesRequestT& request, const ListSyncResourcesResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateComponentType that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateComponentType that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateComponentTypeRequestT = Model::UpdateComponentTypeRequest>
  void UpdateComponentTypeAsync(const UpdateComponentTypeRequestT& request, const UpdateComponentTypeResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateEntity that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateEntityRequestT = Model::UpdateEntityRequest>
  void UpdateEntityAsync(const UpdateEntityRequestT& request, const UpdateEntityResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateScene that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateSceneRequestT = Model::UpdateSceneRequest>
  void UpdateSceneAsync(const UpdateSceneRequestT& request, const UpdateSceneResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual std::shared_ptr<IoTTwinMakerEndpointProviderBase>& accessEndpointProvider();
