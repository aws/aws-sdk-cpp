...
class EntitySummary {
 public:
  ...
  template <typename EntityIdT = Aws::String>
  EntitySummary& WithEntityId(EntityIdT&& value) {
  ...
  template <typename EntityNameT = Aws::String>
  EntitySummary& WithEntityName(EntityNameT&& value) {
  ...
  template <typename ArnT = Aws::String>
  EntitySummary& WithArn(ArnT&& value) {
  ...
  template <typename ParentEntityIdT = Aws::String>
  EntitySummary& WithParentEntityId(ParentEntityIdT&& value) {
  ...
  template <typename StatusT = Status>
  EntitySummary& WithStatus(StatusT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  EntitySummary& WithDescription(DescriptionT&& value) {
  ...
  inline EntitySummary& WithHasChildEntities(bool value) {
  ...
  template <typename CreationDateTimeT = Aws::Utils::DateTime>
  EntitySummary& WithCreationDateTime(CreationDateTimeT&& value) {
  ...
  template <typename UpdateDateTimeT = Aws::Utils::DateTime>
  EntitySummary& WithUpdateDateTime(UpdateDateTimeT&& value) {
