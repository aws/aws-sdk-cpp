...
class ListMetadataTransferJobsResult {
 public:
  ...
  void SetMetadataTransferJobSummaries(MetadataTransferJobSummariesT&& value) {
    m_metadataTransferJobSummariesHasBeenSet = true;
    m_metadataTransferJobSummaries = std::forward<MetadataTransferJobSummariesT>(value);
  }
  template <typename MetadataTransferJobSummariesT = Aws::Vector<MetadataTransferJobSummary>>
  ListMetadataTransferJobsResult& WithMetadataTransferJobSummaries(MetadataTransferJobSummariesT&& value) {
    SetMetadataTransferJobSummaries(std::forward<MetadataTransferJobSummariesT>(value));
    return *this;
  }
  template <typename MetadataTransferJobSummariesT = MetadataTransferJobSummary>
  ListMetadataTransferJobsResult& AddMetadataTransferJobSummaries(MetadataTransferJobSummariesT&& value) {
    m_metadataTransferJobSummariesHasBeenSet = true;
    m_metadataTransferJobSummaries.emplace_back(std::forward<MetadataTransferJobSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListMetadataTransferJobsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListMetadataTransferJobsResult& WithRequestId(RequestIdT&& value) {
