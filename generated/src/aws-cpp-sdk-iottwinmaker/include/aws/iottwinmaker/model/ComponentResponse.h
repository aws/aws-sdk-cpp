...
class ComponentResponse {
 public:
  ...
  void SetDefinedIn(DefinedInT&& value) {
    ...
    m_definedIn = std::forward<DefinedInT>(value);
  }
  template <typename DefinedInT = Aws::String>
  ComponentResponse& WithDefinedIn(DefinedInT&& value) {
    SetDefinedIn(std::forward<DefinedInT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAreAllPropertiesReturned(bool value) {
    m_areAllPropertiesReturnedHasBeenSet = true;
    m_areAllPropertiesReturned = value;
  }
  inline ComponentResponse& WithAreAllPropertiesReturned(bool value) {
    SetAreAllPropertiesReturned(value);
    return *this;
  }
  ///@}
  ...
  void SetCompositeComponents(CompositeComponentsT&& value) {
    ...
    m_compositeComponents = std::forward<CompositeComponentsT>(value);
  }
  template <typename CompositeComponentsT = Aws::Map<Aws::String, ComponentSummary>>
  ComponentResponse& WithCompositeComponents(CompositeComponentsT&& value) {
    SetCompositeComponents(std::forward<CompositeComponentsT>(value));
    return *this;
  }
  ...
  ComponentResponse& AddCompositeComponents(CompositeComponentsKeyT&& key, CompositeComponentsValueT&& value) {
    m_compositeComponentsHasBeenSet = true;
    m_compositeComponents.emplace(std::forward<CompositeComponentsKeyT>(key), std::forward<CompositeComponentsValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAreAllCompositeComponentsReturned(bool value) {
    m_areAllCompositeComponentsReturnedHasBeenSet = true;
    m_areAllCompositeComponentsReturned = value;
  }
  inline ComponentResponse& WithAreAllCompositeComponentsReturned(bool value) {
    SetAreAllCompositeComponentsReturned(value);
    return *this;
  }
  ///@}
 private:
