...
class Relationship {
 public:
  ...
  void SetTargetComponentTypeId(TargetComponentTypeIdT&& value) {
    ...
    m_targetComponentTypeId = std::forward<TargetComponentTypeIdT>(value);
  }
  template <typename TargetComponentTypeIdT = Aws::String>
  Relationship& WithTargetComponentTypeId(TargetComponentTypeIdT&& value) {
    SetTargetComponentTypeId(std::forward<TargetComponentTypeIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRelationshipType(RelationshipTypeT&& value) {
    ...
    m_relationshipType = std::forward<RelationshipTypeT>(value);
  }
  template <typename RelationshipTypeT = Aws::String>
  Relationship& WithRelationshipType(RelationshipTypeT&& value) {
    SetRelationshipType(std::forward<RelationshipTypeT>(value));
    return *this;
  }
  ///@}
 private:
