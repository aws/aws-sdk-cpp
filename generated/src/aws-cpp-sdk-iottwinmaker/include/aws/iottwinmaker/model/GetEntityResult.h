...
class GetEntityResult {
 public:
  ...
  void SetParentEntityId(ParentEntityIdT&& value) {
    ...
    m_parentEntityId = std::forward<ParentEntityIdT>(value);
  }
  template <typename ParentEntityIdT = Aws::String>
  GetEntityResult& WithParentEntityId(ParentEntityIdT&& value) {
    SetParentEntityId(std::forward<ParentEntityIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetHasChildEntities(bool value) {
    m_hasChildEntitiesHasBeenSet = true;
    m_hasChildEntities = value;
  }
  inline GetEntityResult& WithHasChildEntities(bool value) {
    SetHasChildEntities(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAreAllComponentsReturned(bool value) {
    m_areAllComponentsReturnedHasBeenSet = true;
    m_areAllComponentsReturned = value;
  }
  inline GetEntityResult& WithAreAllComponentsReturned(bool value) {
    SetAreAllComponentsReturned(value);
    return *this;
  }
  ///@}
