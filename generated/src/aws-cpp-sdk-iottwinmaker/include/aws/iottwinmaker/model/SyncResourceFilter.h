...
class SyncResourceFilter {
 public:
  ...
  inline void SetState(SyncResourceState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline SyncResourceFilter& WithState(SyncResourceState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline void SetResourceType(SyncResourceType value) {
    m_resourceTypeHasBeenSet = true;
    m_resourceType = value;
  }
  inline SyncResourceFilter& WithResourceType(SyncResourceType value) {
  ...
  template <typename ResourceIdT = Aws::String>
  SyncResourceFilter& WithResourceId(ResourceIdT&& value) {
  ...
  template <typename ExternalIdT = Aws::String>
  SyncResourceFilter& WithExternalId(ExternalIdT&& value) {
