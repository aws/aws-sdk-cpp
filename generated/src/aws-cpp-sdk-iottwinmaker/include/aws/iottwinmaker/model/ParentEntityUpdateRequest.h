...
class ParentEntityUpdateRequest {
 public:
  ...
  inline void SetUpdateType(ParentEntityUpdateType value) {
    m_updateTypeHasBeenSet = true;
    m_updateType = value;
  }
  inline ParentEntityUpdateRequest& WithUpdateType(ParentEntityUpdateType value) {
    SetUpdateType(value);
    return *this;
  }
  ///@}
  ...
  template <typename ParentEntityIdT = Aws::String>
  ParentEntityUpdateRequest& WithParentEntityId(ParentEntityIdT&& value) {
