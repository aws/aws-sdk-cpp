...
class ListScenesRequest : public IoTTwinMakerRequest {
 public:
  AWS_IOTTWINMAKER_API ListScenesRequest() = default;
  ...
  template <typename WorkspaceIdT = Aws::String>
  ListScenesRequest& WithWorkspaceId(WorkspaceIdT&& value) {
  ...
  inline ListScenesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListScenesRequest& WithNextToken(NextTokenT&& value) {
