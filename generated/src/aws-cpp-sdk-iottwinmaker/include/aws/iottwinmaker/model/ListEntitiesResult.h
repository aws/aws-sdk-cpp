...
class ListEntitiesResult {
 public:
  ...
  void SetEntitySummaries(EntitySummariesT&& value) {
    m_entitySummariesHasBeenSet = true;
    m_entitySummaries = std::forward<EntitySummariesT>(value);
  }
  template <typename EntitySummariesT = Aws::Vector<EntitySummary>>
  ListEntitiesResult& WithEntitySummaries(EntitySummariesT&& value) {
    SetEntitySummaries(std::forward<EntitySummariesT>(value));
    return *this;
  }
  template <typename EntitySummariesT = EntitySummary>
  ListEntitiesResult& AddEntitySummaries(EntitySummariesT&& value) {
    m_entitySummariesHasBeenSet = true;
    m_entitySummaries.emplace_back(std::forward<EntitySummariesT>(value));
    return *this;
  }
  ///@}
