...
class CreateComponentTypeResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  CreateComponentTypeResult& WithArn(ArnT&& value) {
  ...
  template <typename CreationDateTimeT = Aws::Utils::DateTime>
  CreateComponentTypeResult& WithCreationDateTime(CreationDateTimeT&& value) {
  ...
  inline CreateComponentTypeResult& WithState(State value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  CreateComponentTypeResult& WithRequestId(RequestIdT&& value) {
