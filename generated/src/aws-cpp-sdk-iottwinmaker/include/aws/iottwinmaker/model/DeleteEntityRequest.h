...
class DeleteEntityRequest : public IoTTwinMakerRequest {
 public:
  ...
  template <typename WorkspaceIdT = Aws::String>
  DeleteEntityRequest& WithWorkspaceId(WorkspaceIdT&& value) {
  ...
  template <typename EntityIdT = Aws::String>
  DeleteEntityRequest& WithEntityId(EntityIdT&& value) {
  ...
  inline void SetIsRecursive(bool value) {
    m_isRecursiveHasBeenSet = true;
    m_isRecursive = value;
  }
  inline DeleteEntityRequest& WithIsRecursive(bool value) {
