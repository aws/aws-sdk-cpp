...
class IotTwinMakerSourceConfigurationFilter {
 public:
  ...
  void SetFilterByComponentType(FilterByComponentTypeT&& value) {
    m_filterByComponentTypeHasBeenSet = true;
    m_filterByComponentType = std::forward<FilterByComponentTypeT>(value);
  }
  template <typename FilterByComponentTypeT = FilterByComponentType>
  IotTwinMakerSourceConfigurationFilter& WithFilterByComponentType(FilterByComponentTypeT&& value) {
    SetFilterByComponentType(std::forward<FilterByComponentTypeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFilterByEntity(FilterByEntityT&& value) {
    m_filterByEntityHasBeenSet = true;
    m_filterByEntity = std::forward<FilterByEntityT>(value);
  }
  template <typename FilterByEntityT = FilterByEntity>
  IotTwinMakerSourceConfigurationFilter& WithFilterByEntity(FilterByEntityT&& value) {
    SetFilterByEntity(std::forward<FilterByEntityT>(value));
    return *this;
  }
  ///@}
 private:
