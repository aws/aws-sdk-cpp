...
class CompositeComponentUpdateRequest {
 public:
  ...
  inline void SetUpdateType(ComponentUpdateType value) {
    m_updateTypeHasBeenSet = true;
    m_updateType = value;
  }
  inline CompositeComponentUpdateRequest& WithUpdateType(ComponentUpdateType value) {
    SetUpdateType(value);
    return *this;
  }
  ///@}
  ...
  void SetPropertyUpdates(PropertyUpdatesT&& value) {
    ...
    m_propertyUpdates = std::forward<PropertyUpdatesT>(value);
  }
  template <typename PropertyUpdatesT = Aws::Map<Aws::String, PropertyRequest>>
  CompositeComponentUpdateRequest& WithPropertyUpdates(PropertyUpdatesT&& value) {
    SetPropertyUpdates(std::forward<PropertyUpdatesT>(value));
    return *this;
  }
  ...
  CompositeComponentUpdateRequest& AddPropertyUpdates(PropertyUpdatesKeyT&& key, PropertyUpdatesValueT&& value) {
    m_propertyUpdatesHasBeenSet = true;
    m_propertyUpdates.emplace(std::forward<PropertyUpdatesKeyT>(key), std::forward<PropertyUpdatesValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPropertyGroupUpdates(PropertyGroupUpdatesT&& value) {
    ...
    m_propertyGroupUpdates = std::forward<PropertyGroupUpdatesT>(value);
  }
  template <typename PropertyGroupUpdatesT = Aws::Map<Aws::String, ComponentPropertyGroupRequest>>
  CompositeComponentUpdateRequest& WithPropertyGroupUpdates(PropertyGroupUpdatesT&& value) {
    SetPropertyGroupUpdates(std::forward<PropertyGroupUpdatesT>(value));
    return *this;
  }
  ...
  CompositeComponentUpdateRequest& AddPropertyGroupUpdates(PropertyGroupUpdatesKeyT&& key, PropertyGroupUpdatesValueT&& value) {
    m_propertyGroupUpdatesHasBeenSet = true;
    m_propertyGroupUpdates.emplace(std::forward<PropertyGroupUpdatesKeyT>(key), std::forward<PropertyGroupUpdatesValueT>(value));
    return *this;
  }
  ///@}
 private:
