...
class MetadataTransferJobStatus {
 public:
  ...
  inline void SetState(MetadataTransferJobState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline MetadataTransferJobStatus& WithState(MetadataTransferJobState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline void SetQueuedPosition(int value) {
    m_queuedPositionHasBeenSet = true;
    m_queuedPosition = value;
  }
  inline MetadataTransferJobStatus& WithQueuedPosition(int value) {
    SetQueuedPosition(value);
    return *this;
  }
  ///@}
 private:
