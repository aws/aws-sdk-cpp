...
class ComponentPropertyGroupRequest {
 public:
  ...
  inline ComponentPropertyGroupRequest& WithGroupType(GroupType value) {
    SetGroupType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUpdateType(PropertyGroupUpdateType value) {
    m_updateTypeHasBeenSet = true;
    m_updateType = value;
  }
  inline ComponentPropertyGroupRequest& WithUpdateType(PropertyGroupUpdateType value) {
    SetUpdateType(value);
    return *this;
  }
  ///@}
