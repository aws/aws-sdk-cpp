...
class UpdateComponentTypeResult {
 public:
  ...
  template <typename WorkspaceIdT = Aws::String>
  UpdateComponentTypeResult& WithWorkspaceId(WorkspaceIdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  UpdateComponentTypeResult& WithArn(ArnT&& value) {
  ...
  template <typename ComponentTypeIdT = Aws::String>
  UpdateComponentTypeResult& WithComponentTypeId(ComponentTypeIdT&& value) {
  ...
  inline UpdateComponentTypeResult& WithState(State value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  UpdateComponentTypeResult& WithRequestId(RequestIdT&& value) {
