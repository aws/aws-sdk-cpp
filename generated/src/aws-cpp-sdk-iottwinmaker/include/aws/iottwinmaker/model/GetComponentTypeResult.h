...
class GetComponentTypeResult {
 public:
  ...
  template <typename WorkspaceIdT = Aws::String>
  GetComponentTypeResult& WithWorkspaceId(WorkspaceIdT&& value) {
  ...
  inline GetComponentTypeResult& WithIsSingleton(bool value) {
  ...
  template <typename ComponentTypeIdT = Aws::String>
  GetComponentTypeResult& WithComponentTypeId(ComponentTypeIdT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  GetComponentTypeResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename PropertyDefinitionsT = Aws::Map<Aws::String, PropertyDefinitionResponse>>
  GetComponentTypeResult& WithPropertyDefinitions(PropertyDefinitionsT&& value) {
  ...
  template <typename ExtendsFromT = Aws::Vector<Aws::String>>
  GetComponentTypeResult& WithExtendsFrom(ExtendsFromT&& value) {
    SetExtendsFrom(std::forward<ExtendsFromT>(value));
    return *this;
  }
  template <typename ExtendsFromT = Aws::String>
  GetComponentTypeResult& AddExtendsFrom(ExtendsFromT&& value) {
    m_extendsFromHasBeenSet = true;
  ...
  template <typename FunctionsT = Aws::Map<Aws::String, FunctionResponse>>
  GetComponentTypeResult& WithFunctions(FunctionsT&& value) {
  ...
  template <typename CreationDateTimeT = Aws::Utils::DateTime>
  GetComponentTypeResult& WithCreationDateTime(CreationDateTimeT&& value) {
  ...
  template <typename UpdateDateTimeT = Aws::Utils::DateTime>
  GetComponentTypeResult& WithUpdateDateTime(UpdateDateTimeT&& value) {
  ...
  template <typename ArnT = Aws::String>
  GetComponentTypeResult& WithArn(ArnT&& value) {
  ...
  inline GetComponentTypeResult& WithIsAbstract(bool value) {
    SetIsAbstract(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIsSchemaInitialized(bool value) {
    m_isSchemaInitializedHasBeenSet = true;
    m_isSchemaInitialized = value;
  }
  inline GetComponentTypeResult& WithIsSchemaInitialized(bool value) {
    SetIsSchemaInitialized(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusT = Status>
  GetComponentTypeResult& WithStatus(StatusT&& value) {
  ...
  template <typename PropertyGroupsT = Aws::Map<Aws::String, PropertyGroupResponse>>
  GetComponentTypeResult& WithPropertyGroups(PropertyGroupsT&& value) {
  ...
  template <typename SyncSourceT = Aws::String>
  GetComponentTypeResult& WithSyncSource(SyncSourceT&& value) {
  ...
  template <typename ComponentTypeNameT = Aws::String>
  GetComponentTypeResult& WithComponentTypeName(ComponentTypeNameT&& value) {
   ...
   */
  inline const Aws::Map<Aws::String, CompositeComponentTypeResponse>& GetCompositeComponentTypes() const {
  ...
  template <typename CompositeComponentTypesT = Aws::Map<Aws::String, CompositeComponentTypeResponse>>
  GetComponentTypeResult& WithCompositeComponentTypes(CompositeComponentTypesT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetComponentTypeResult& WithRequestId(RequestIdT&& value) {
