...
class ListEntitiesFilter {
 public:
  ...
  template <typename ParentEntityIdT = Aws::String>
  ListEntitiesFilter& WithParentEntityId(ParentEntityIdT&& value) {
  ...
  template <typename ComponentTypeIdT = Aws::String>
  ListEntitiesFilter& WithComponentTypeId(ComponentTypeIdT&& value) {
  ...
  template <typename ExternalIdT = Aws::String>
  ListEntitiesFilter& WithExternalId(ExternalIdT&& value) {
