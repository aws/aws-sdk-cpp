...
class GetPropertyValueHistoryRequest : public IoTTwinMakerRequest {
 public:
  ...
  void SetComponentPath(ComponentPathT&& value) {
    ...
    m_componentPath = std::forward<ComponentPathT>(value);
  }
  template <typename ComponentPathT = Aws::String>
  GetPropertyValueHistoryRequest& WithComponentPath(ComponentPathT&& value) {
    SetComponentPath(std::forward<ComponentPathT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSelectedProperties(SelectedPropertiesT&& value) {
    m_selectedPropertiesHasBeenSet = true;
    m_selectedProperties = std::forward<SelectedPropertiesT>(value);
  }
  template <typename SelectedPropertiesT = Aws::Vector<Aws::String>>
  GetPropertyValueHistoryRequest& WithSelectedProperties(SelectedPropertiesT&& value) {
    SetSelectedProperties(std::forward<SelectedPropertiesT>(value));
    return *this;
  }
  ...
  GetPropertyValueHistoryRequest& AddSelectedProperties(SelectedPropertiesT&& value) {
    m_selectedPropertiesHasBeenSet = true;
    m_selectedProperties.emplace_back(std::forward<SelectedPropertiesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPropertyFilters(PropertyFiltersT&& value) {
    ...
    m_propertyFilters = std::forward<PropertyFiltersT>(value);
  }
  template <typename PropertyFiltersT = Aws::Vector<PropertyFilter>>
  GetPropertyValueHistoryRequest& WithPropertyFilters(PropertyFiltersT&& value) {
    SetPropertyFilters(std::forward<PropertyFiltersT>(value));
    return *this;
  }
  ...
  GetPropertyValueHistoryRequest& AddPropertyFilters(PropertyFiltersT&& value) {
    m_propertyFiltersHasBeenSet = true;
    m_propertyFilters.emplace_back(std::forward<PropertyFiltersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInterpolation(InterpolationT&& value) {
    m_interpolationHasBeenSet = true;
    m_interpolation = std::forward<InterpolationT>(value);
  }
  template <typename InterpolationT = InterpolationParameters>
  GetPropertyValueHistoryRequest& WithInterpolation(InterpolationT&& value) {
    SetInterpolation(std::forward<InterpolationT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetPropertyValueHistoryRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline void SetOrderByTime(OrderByTime value) {
    m_orderByTimeHasBeenSet = true;
    m_orderByTime = value;
  }
  inline GetPropertyValueHistoryRequest& WithOrderByTime(OrderByTime value) {
