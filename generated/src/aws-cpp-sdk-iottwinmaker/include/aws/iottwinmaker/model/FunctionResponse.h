...
class FunctionResponse {
 public:
  ...
  template <typename RequiredPropertiesT = Aws::Vector<Aws::String>>
  FunctionResponse& WithRequiredProperties(RequiredPropertiesT&& value) {
    SetRequiredProperties(std::forward<RequiredPropertiesT>(value));
    return *this;
  }
  template <typename RequiredPropertiesT = Aws::String>
  FunctionResponse& AddRequiredProperties(RequiredPropertiesT&& value) {
    m_requiredPropertiesHasBeenSet = true;
  ...
  inline FunctionResponse& WithScope(Scope value) {
    SetScope(value);
    return *this;
  }
  ///@}
  ...
  template <typename ImplementedByT = DataConnector>
  FunctionResponse& WithImplementedBy(ImplementedByT&& value) {
  ...
  inline FunctionResponse& WithIsInherited(bool value) {
