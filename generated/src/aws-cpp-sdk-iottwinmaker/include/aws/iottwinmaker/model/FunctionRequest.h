...
class FunctionRequest {
 public:
  ...
  void SetRequiredProperties(RequiredPropertiesT&& value) {
    m_requiredPropertiesHasBeenSet = true;
    m_requiredProperties = std::forward<RequiredPropertiesT>(value);
  }
  template <typename RequiredPropertiesT = Aws::Vector<Aws::String>>
  FunctionRequest& WithRequiredProperties(RequiredPropertiesT&& value) {
    SetRequiredProperties(std::forward<RequiredPropertiesT>(value));
    return *this;
  }
  template <typename RequiredPropertiesT = Aws::String>
  FunctionRequest& AddRequiredProperties(RequiredPropertiesT&& value) {
    m_requiredPropertiesHasBeenSet = true;
    m_requiredProperties.emplace_back(std::forward<RequiredPropertiesT>(value));
    return *this;
  }
  ///@}
  ...
  inline FunctionRequest& WithScope(Scope value) {
    SetScope(value);
    return *this;
  }
  ///@}
  ...
  void SetImplementedBy(ImplementedByT&& value) {
    m_implementedByHasBeenSet = true;
    m_implementedBy = std::forward<ImplementedByT>(value);
  }
  template <typename ImplementedByT = DataConnector>
  FunctionRequest& WithImplementedBy(ImplementedByT&& value) {
    SetImplementedBy(std::forward<ImplementedByT>(value));
    return *this;
  }
  ///@}
 private:
