...
class ListComponentTypesFilter {
 public:
  ...
  template <typename ExtendsFromT = Aws::String>
  ListComponentTypesFilter& WithExtendsFrom(ExtendsFromT&& value) {
  ...
  template <typename NamespaceT = Aws::String>
  ListComponentTypesFilter& WithNamespace(NamespaceT&& value) {
  ...
  inline ListComponentTypesFilter& WithIsAbstract(bool value) {
    SetIsAbstract(value);
    return *this;
  }
  ///@}
