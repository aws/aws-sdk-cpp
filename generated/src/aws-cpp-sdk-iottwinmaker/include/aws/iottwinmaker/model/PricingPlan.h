...
class PricingPlan {
 public:
  ...
  inline void SetBillableEntityCount(long long value) {
    m_billableEntityCountHasBeenSet = true;
    m_billableEntityCount = value;
  }
  inline PricingPlan& WithBillableEntityCount(long long value) {
    SetBillableEntityCount(value);
    return *this;
  }
  ///@}
  ...
  void SetBundleInformation(BundleInformationT&& value) {
    ...
    m_bundleInformation = std::forward<BundleInformationT>(value);
  }
  template <typename BundleInformationT = BundleInformation>
  PricingPlan& WithBundleInformation(BundleInformationT&& value) {
    SetBundleInformation(std::forward<BundleInformationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEffectiveDateTime(EffectiveDateTimeT&& value) {
    ...
    m_effectiveDateTime = std::forward<EffectiveDateTimeT>(value);
  }
  template <typename EffectiveDateTimeT = Aws::Utils::DateTime>
  PricingPlan& WithEffectiveDateTime(EffectiveDateTimeT&& value) {
    SetEffectiveDateTime(std::forward<EffectiveDateTimeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetPricingMode(PricingMode value) {
    m_pricingModeHasBeenSet = true;
    m_pricingMode = value;
  }
  inline PricingPlan& WithPricingMode(PricingMode value) {
  ...
  inline void SetUpdateReason(UpdateReason value) {
    m_updateReasonHasBeenSet = true;
    m_updateReason = value;
  }
  inline PricingPlan& WithUpdateReason(UpdateReason value) {
