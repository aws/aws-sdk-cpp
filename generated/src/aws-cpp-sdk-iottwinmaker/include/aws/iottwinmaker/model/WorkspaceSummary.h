...
class WorkspaceSummary {
 public:
  ...
  void SetLinkedServices(LinkedServicesT&& value) {
    ...
    m_linkedServices = std::forward<LinkedServicesT>(value);
  }
  template <typename LinkedServicesT = Aws::Vector<Aws::String>>
  WorkspaceSummary& WithLinkedServices(LinkedServicesT&& value) {
    SetLinkedServices(std::forward<LinkedServicesT>(value));
    return *this;
  }
  template <typename LinkedServicesT = Aws::String>
  WorkspaceSummary& AddLinkedServices(LinkedServicesT&& value) {
    m_linkedServicesHasBeenSet = true;
    m_linkedServices.emplace_back(std::forward<LinkedServicesT>(value));
    return *this;
  }
  ///@}
