...
class IotSiteWiseSourceConfigurationFilter {
 public:
  ...
  void SetFilterByAssetModel(FilterByAssetModelT&& value) {
    m_filterByAssetModelHasBeenSet = true;
    m_filterByAssetModel = std::forward<FilterByAssetModelT>(value);
  }
  template <typename FilterByAssetModelT = FilterByAssetModel>
  IotSiteWiseSourceConfigurationFilter& WithFilterByAssetModel(FilterByAssetModelT&& value) {
    SetFilterByAssetModel(std::forward<FilterByAssetModelT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFilterByAsset(FilterByAssetT&& value) {
    m_filterByAssetHasBeenSet = true;
    m_filterByAsset = std::forward<FilterByAssetT>(value);
  }
  template <typename FilterByAssetT = FilterByAsset>
  IotSiteWiseSourceConfigurationFilter& WithFilterByAsset(FilterByAssetT&& value) {
    SetFilterByAsset(std::forward<FilterByAssetT>(value));
    return *this;
  }
  ///@}
 private:
