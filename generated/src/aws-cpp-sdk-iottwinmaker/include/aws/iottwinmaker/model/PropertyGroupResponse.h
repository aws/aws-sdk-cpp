...
class PropertyGroupResponse {
 public:
  ...
  inline PropertyGroupResponse& WithGroupType(GroupType value) {
    SetGroupType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIsInherited(bool value) {
    m_isInheritedHasBeenSet = true;
    m_isInherited = value;
  }
  inline PropertyGroupResponse& WithIsInherited(bool value) {
