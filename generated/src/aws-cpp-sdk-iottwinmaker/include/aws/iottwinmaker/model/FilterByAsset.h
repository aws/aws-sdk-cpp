...
class FilterByAsset {
 public:
  ...
  template <typename AssetIdT = Aws::String>
  FilterByAsset& WithAssetId(AssetIdT&& value) {
  ...
  template <typename AssetExternalIdT = Aws::String>
  FilterByAsset& WithAssetExternalId(AssetExternalIdT&& value) {
  ...
  inline void SetIncludeOffspring(bool value) {
    m_includeOffspringHasBeenSet = true;
    m_includeOffspring = value;
  }
  inline FilterByAsset& WithIncludeOffspring(bool value) {
    SetIncludeOffspring(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIncludeAssetModel(bool value) {
    m_includeAssetModelHasBeenSet = true;
    m_includeAssetModel = value;
  }
  inline FilterByAsset& WithIncludeAssetModel(bool value) {
    SetIncludeAssetModel(value);
    return *this;
  }
  ///@}
 private:
