...
class ExecuteQueryResult {
 public:
  ...
  void SetColumnDescriptions(ColumnDescriptionsT&& value) {
    m_columnDescriptionsHasBeenSet = true;
    m_columnDescriptions = std::forward<ColumnDescriptionsT>(value);
  }
  template <typename ColumnDescriptionsT = Aws::Vector<ColumnDescription>>
  ExecuteQueryResult& WithColumnDescriptions(ColumnDescriptionsT&& value) {
    SetColumnDescriptions(std::forward<ColumnDescriptionsT>(value));
    return *this;
  }
  template <typename ColumnDescriptionsT = ColumnDescription>
  ExecuteQueryResult& AddColumnDescriptions(ColumnDescriptionsT&& value) {
    m_columnDescriptionsHasBeenSet = true;
    m_columnDescriptions.emplace_back(std::forward<ColumnDescriptionsT>(value));
    return *this;
  }
  ///@}
