...
class CreateSceneRequest : public IoTTwinMakerRequest {
 public:
  ...
  template <typename WorkspaceIdT = Aws::String>
  CreateSceneRequest& WithWorkspaceId(WorkspaceIdT&& value) {
  ...
  template <typename SceneIdT = Aws::String>
  CreateSceneRequest& WithSceneId(SceneIdT&& value) {
  ...
  template <typename ContentLocationT = Aws::String>
  CreateSceneRequest& WithContentLocation(ContentLocationT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateSceneRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename CapabilitiesT = Aws::Vector<Aws::String>>
  CreateSceneRequest& WithCapabilities(CapabilitiesT&& value) {
    SetCapabilities(std::forward<CapabilitiesT>(value));
    return *this;
  }
  template <typename CapabilitiesT = Aws::String>
  CreateSceneRequest& AddCapabilities(CapabilitiesT&& value) {
    m_capabilitiesHasBeenSet = true;
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateSceneRequest& WithTags(TagsT&& value) {
  ...
  void SetSceneMetadata(SceneMetadataT&& value) {
    ...
    m_sceneMetadata = std::forward<SceneMetadataT>(value);
  }
  template <typename SceneMetadataT = Aws::Map<Aws::String, Aws::String>>
  CreateSceneRequest& WithSceneMetadata(SceneMetadataT&& value) {
    SetSceneMetadata(std::forward<SceneMetadataT>(value));
    return *this;
  }
  ...
  CreateSceneRequest& AddSceneMetadata(SceneMetadataKeyT&& key, SceneMetadataValueT&& value) {
    m_sceneMetadataHasBeenSet = true;
    m_sceneMetadata.emplace(std::forward<SceneMetadataKeyT>(key), std::forward<SceneMetadataValueT>(value));
    return *this;
  }
  ///@}
 private:
