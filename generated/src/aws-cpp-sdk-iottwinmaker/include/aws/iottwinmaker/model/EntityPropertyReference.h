...
class EntityPropertyReference {
 public:
  ...
  void SetExternalIdProperty(ExternalIdPropertyT&& value) {
    ...
    m_externalIdProperty = std::forward<ExternalIdPropertyT>(value);
  }
  template <typename ExternalIdPropertyT = Aws::Map<Aws::String, Aws::String>>
  EntityPropertyReference& WithExternalIdProperty(ExternalIdPropertyT&& value) {
    SetExternalIdProperty(std::forward<ExternalIdPropertyT>(value));
    return *this;
  }
  ...
  EntityPropertyReference& AddExternalIdProperty(ExternalIdPropertyKeyT&& key, ExternalIdPropertyValueT&& value) {
    m_externalIdPropertyHasBeenSet = true;
    m_externalIdProperty.emplace(std::forward<ExternalIdPropertyKeyT>(key), std::forward<ExternalIdPropertyValueT>(value));
    return *this;
  }
  ///@}
