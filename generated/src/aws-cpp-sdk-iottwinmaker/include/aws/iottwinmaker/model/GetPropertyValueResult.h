...
class GetPropertyValueResult {
 public:
  ...
  GetPropertyValueResult& AddPropertyValues(PropertyValuesKeyT&& key, PropertyValuesValueT&& value) {
    m_propertyValuesHasBeenSet = true;
    m_propertyValues.emplace(std::forward<PropertyValuesKeyT>(key), std::forward<PropertyValuesValueT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::Vector<Aws::Vector<Aws::Map<Aws::String, DataValue>>>& GetTabularPropertyValues() const {
    return m_tabularPropertyValues;
  }
  ...
  void SetTabularPropertyValues(TabularPropertyValuesT&& value) {
    ...
    m_tabularPropertyValues = std::forward<TabularPropertyValuesT>(value);
  }
  template <typename TabularPropertyValuesT = Aws::Vector<Aws::Vector<Aws::Map<Aws::String, DataValue>>>>
  GetPropertyValueResult& WithTabularPropertyValues(TabularPropertyValuesT&& value) {
    SetTabularPropertyValues(std::forward<TabularPropertyValuesT>(value));
    return *this;
  }
  ...
  GetPropertyValueResult& AddTabularPropertyValues(TabularPropertyValuesT&& value) {
    m_tabularPropertyValuesHasBeenSet = true;
    m_tabularPropertyValues.emplace_back(std::forward<TabularPropertyValuesT>(value));
    return *this;
  }
  ///@}
