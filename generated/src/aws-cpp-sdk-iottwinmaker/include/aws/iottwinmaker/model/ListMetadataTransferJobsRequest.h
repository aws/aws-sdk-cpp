...
class ListMetadataTransferJobsRequest : public IoTTwinMakerRequest {
 public:
  ...
  inline ListMetadataTransferJobsRequest& WithSourceType(SourceType value) {
    SetSourceType(value);
    return *this;
  }
  ///@}
  ...
  inline ListMetadataTransferJobsRequest& WithDestinationType(DestinationType value) {
  ...
  template <typename FiltersT = Aws::Vector<ListMetadataTransferJobsFilter>>
  ListMetadataTransferJobsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = ListMetadataTransferJobsFilter>
  ListMetadataTransferJobsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListMetadataTransferJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListMetadataTransferJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
