...
class ListComponentTypesRequest : public IoTTwinMakerRequest {
 public:
  ...
  template <typename WorkspaceIdT = Aws::String>
  ListComponentTypesRequest& WithWorkspaceId(WorkspaceIdT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<ListComponentTypesFilter>>
  ListComponentTypesRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = ListComponentTypesFilter>
  ListComponentTypesRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListComponentTypesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListComponentTypesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
