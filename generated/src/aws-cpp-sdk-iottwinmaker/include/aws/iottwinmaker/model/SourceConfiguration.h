...
class SourceConfiguration {
 public:
  ...
  inline SourceConfiguration& WithType(SourceType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetIotSiteWiseConfiguration(IotSiteWiseConfigurationT&& value) {
    ...
    m_iotSiteWiseConfiguration = std::forward<IotSiteWiseConfigurationT>(value);
  }
  template <typename IotSiteWiseConfigurationT = IotSiteWiseSourceConfiguration>
  SourceConfiguration& WithIotSiteWiseConfiguration(IotSiteWiseConfigurationT&& value) {
    SetIotSiteWiseConfiguration(std::forward<IotSiteWiseConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIotTwinMakerConfiguration(IotTwinMakerConfigurationT&& value) {
    ...
    m_iotTwinMakerConfiguration = std::forward<IotTwinMakerConfigurationT>(value);
  }
  template <typename IotTwinMakerConfigurationT = IotTwinMakerSourceConfiguration>
  SourceConfiguration& WithIotTwinMakerConfiguration(IotTwinMakerConfigurationT&& value) {
    SetIotTwinMakerConfiguration(std::forward<IotTwinMakerConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
