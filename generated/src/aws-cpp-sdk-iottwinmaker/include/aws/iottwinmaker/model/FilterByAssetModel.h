...
class FilterByAssetModel {
 public:
  ...
  template <typename AssetModelIdT = Aws::String>
  FilterByAssetModel& WithAssetModelId(AssetModelIdT&& value) {
  ...
  template <typename AssetModelExternalIdT = Aws::String>
  FilterByAssetModel& WithAssetModelExternalId(AssetModelExternalIdT&& value) {
  ...
  inline FilterByAssetModel& WithIncludeOffspring(bool value) {
  ...
  inline void SetIncludeAssets(bool value) {
    m_includeAssetsHasBeenSet = true;
    m_includeAssets = value;
  }
  inline FilterByAssetModel& WithIncludeAssets(bool value) {
    SetIncludeAssets(value);
    return *this;
  }
  ///@}
 private:
