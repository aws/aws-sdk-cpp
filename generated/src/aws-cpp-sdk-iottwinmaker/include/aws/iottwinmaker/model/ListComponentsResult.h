...
class ListComponentsResult {
 public:
  ...
  void SetComponentSummaries(ComponentSummariesT&& value) {
    m_componentSummariesHasBeenSet = true;
    m_componentSummaries = std::forward<ComponentSummariesT>(value);
  }
  template <typename ComponentSummariesT = Aws::Vector<ComponentSummary>>
  ListComponentsResult& WithComponentSummaries(ComponentSummariesT&& value) {
    SetComponentSummaries(std::forward<ComponentSummariesT>(value));
    return *this;
  }
  template <typename ComponentSummariesT = ComponentSummary>
  ListComponentsResult& AddComponentSummaries(ComponentSummariesT&& value) {
    m_componentSummariesHasBeenSet = true;
    m_componentSummaries.emplace_back(std::forward<ComponentSummariesT>(value));
    return *this;
  }
  ///@}
