...
class DataValue {
 public:
  ...
  inline DataValue& WithBooleanValue(bool value) {
  ...
  inline DataValue& WithDoubleValue(double value) {
  ...
  inline DataValue& WithIntegerValue(int value) {
  ...
  inline DataValue& WithLongValue(long long value) {
    SetLongValue(value);
    return *this;
  }
  ///@}
  ...
  void SetRelationshipValue(RelationshipValueT&& value) {
    ...
    m_relationshipValue = std::forward<RelationshipValueT>(value);
  }
  template <typename RelationshipValueT = RelationshipValue>
  DataValue& WithRelationshipValue(RelationshipValueT&& value) {
    SetRelationshipValue(std::forward<RelationshipValueT>(value));
    return *this;
  }
  ///@}
