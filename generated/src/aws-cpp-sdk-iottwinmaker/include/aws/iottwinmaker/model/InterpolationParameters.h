...
class InterpolationParameters {
 public:
  ...
  inline void SetInterpolationType(InterpolationType value) {
    m_interpolationTypeHasBeenSet = true;
    m_interpolationType = value;
  }
  inline InterpolationParameters& WithInterpolationType(InterpolationType value) {
  ...
  inline void SetIntervalInSeconds(long long value) {
    m_intervalInSecondsHasBeenSet = true;
    m_intervalInSeconds = value;
  }
  inline InterpolationParameters& WithIntervalInSeconds(long long value) {
