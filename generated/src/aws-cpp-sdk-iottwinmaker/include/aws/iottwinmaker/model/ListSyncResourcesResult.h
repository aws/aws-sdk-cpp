...
class ListSyncResourcesResult {
 public:
  ...
  void SetSyncResources(SyncResourcesT&& value) {
    m_syncResourcesHasBeenSet = true;
    m_syncResources = std::forward<SyncResourcesT>(value);
  }
  template <typename SyncResourcesT = Aws::Vector<SyncResourceSummary>>
  ListSyncResourcesResult& WithSyncResources(SyncResourcesT&& value) {
    SetSyncResources(std::forward<SyncResourcesT>(value));
    return *this;
  }
  template <typename SyncResourcesT = SyncResourceSummary>
  ListSyncResourcesResult& AddSyncResources(SyncResourcesT&& value) {
    m_syncResourcesHasBeenSet = true;
    m_syncResources.emplace_back(std::forward<SyncResourcesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListSyncResourcesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListSyncResourcesResult& WithRequestId(RequestIdT&& value) {
