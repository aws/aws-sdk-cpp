...
class PropertyDefinitionResponse {
 public:
  ...
  inline PropertyDefinitionResponse& WithIsTimeSeries(bool value) {
  ...
  inline PropertyDefinitionResponse& WithIsRequiredInEntity(bool value) {
  ...
  inline PropertyDefinitionResponse& WithIsExternalId(bool value) {
  ...
  inline PropertyDefinitionResponse& WithIsStoredExternally(bool value) {
  ...
  inline void SetIsImported(bool value) {
    m_isImportedHasBeenSet = true;
    m_isImported = value;
  }
  inline PropertyDefinitionResponse& WithIsImported(bool value) {
    SetIsImported(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIsFinal(bool value) {
    m_isFinalHasBeenSet = true;
    m_isFinal = value;
  }
  inline PropertyDefinitionResponse& WithIsFinal(bool value) {
    SetIsFinal(value);
    return *this;
  }
  ///@}
  ...
  inline PropertyDefinitionResponse& WithIsInherited(bool value) {
