...
class GetPropertyValueRequest : public IoTTwinMakerRequest {
 public:
  ...
  inline GetPropertyValueRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  void SetPropertyGroupName(PropertyGroupNameT&& value) {
    m_propertyGroupNameHasBeenSet = true;
    m_propertyGroupName = std::forward<PropertyGroupNameT>(value);
  }
  template <typename PropertyGroupNameT = Aws::String>
  GetPropertyValueRequest& WithPropertyGroupName(PropertyGroupNameT&& value) {
    SetPropertyGroupName(std::forward<PropertyGroupNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTabularConditions(TabularConditionsT&& value) {
    m_tabularConditionsHasBeenSet = true;
    m_tabularConditions = std::forward<TabularConditionsT>(value);
  }
  template <typename TabularConditionsT = TabularConditions>
  GetPropertyValueRequest& WithTabularConditions(TabularConditionsT&& value) {
    SetTabularConditions(std::forward<TabularConditionsT>(value));
    return *this;
  }
  ///@}
 private:
