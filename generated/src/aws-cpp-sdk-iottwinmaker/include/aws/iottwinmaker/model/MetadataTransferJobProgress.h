...
class MetadataTransferJobProgress {
 public:
  ...
  inline MetadataTransferJobProgress& WithTotalCount(int value) {
    SetTotalCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSucceededCount(int value) {
    m_succeededCountHasBeenSet = true;
    m_succeededCount = value;
  }
  inline MetadataTransferJobProgress& WithSucceededCount(int value) {
  ...
  inline void SetSkippedCount(int value) {
    m_skippedCountHasBeenSet = true;
    m_skippedCount = value;
  }
  inline MetadataTransferJobProgress& WithSkippedCount(int value) {
  ...
  inline MetadataTransferJobProgress& WithFailedCount(int value) {
