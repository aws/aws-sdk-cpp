...
class CreateSceneResult {
 public:
  AWS_IOTTWINMAKER_API CreateSceneResult() = default;
  ...
  template <typename ArnT = Aws::String>
  CreateSceneResult& WithArn(ArnT&& value) {
  ...
  template <typename CreationDateTimeT = Aws::Utils::DateTime>
  CreateSceneResult& WithCreationDateTime(CreationDateTimeT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateSceneResult& WithRequestId(RequestIdT&& value) {
