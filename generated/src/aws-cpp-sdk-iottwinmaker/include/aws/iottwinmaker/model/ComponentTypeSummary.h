...
class ComponentTypeSummary {
 public:
  ...
  template <typename ArnT = Aws::String>
  ComponentTypeSummary& WithArn(ArnT&& value) {
  ...
  template <typename ComponentTypeIdT = Aws::String>
  ComponentTypeSummary& WithComponentTypeId(ComponentTypeIdT&& value) {
  ...
  template <typename CreationDateTimeT = Aws::Utils::DateTime>
  ComponentTypeSummary& WithCreationDateTime(CreationDateTimeT&& value) {
  ...
  template <typename UpdateDateTimeT = Aws::Utils::DateTime>
  ComponentTypeSummary& WithUpdateDateTime(UpdateDateTimeT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  ComponentTypeSummary& WithDescription(DescriptionT&& value) {
  ...
  template <typename StatusT = Status>
  ComponentTypeSummary& WithStatus(StatusT&& value) {
  ...
  template <typename ComponentTypeNameT = Aws::String>
  ComponentTypeSummary& WithComponentTypeName(ComponentTypeNameT&& value) {
