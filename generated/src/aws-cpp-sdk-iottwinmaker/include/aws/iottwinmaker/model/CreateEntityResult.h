...
class CreateEntityResult {
 public:
  AWS_IOTTWINMAKER_API CreateEntityResult() = default;
  ...
  template <typename EntityIdT = Aws::String>
  CreateEntityResult& WithEntityId(EntityIdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  CreateEntityResult& WithArn(ArnT&& value) {
  ...
  template <typename CreationDateTimeT = Aws::Utils::DateTime>
  CreateEntityResult& WithCreationDateTime(CreationDateTimeT&& value) {
  ...
  inline CreateEntityResult& WithState(State value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  CreateEntityResult& WithRequestId(RequestIdT&& value) {
