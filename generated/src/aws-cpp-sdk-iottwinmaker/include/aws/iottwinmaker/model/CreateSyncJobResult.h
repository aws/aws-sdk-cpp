...
class CreateSyncJobResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  CreateSyncJobResult& WithArn(ArnT&& value) {
  ...
  template <typename CreationDateTimeT = Aws::Utils::DateTime>
  CreateSyncJobResult& WithCreationDateTime(CreationDateTimeT&& value) {
  ...
  inline CreateSyncJobResult& WithState(SyncJobState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  CreateSyncJobResult& WithRequestId(RequestIdT&& value) {
