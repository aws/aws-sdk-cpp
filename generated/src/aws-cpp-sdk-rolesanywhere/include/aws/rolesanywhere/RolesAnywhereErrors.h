...
public:
  ...
  RolesAnywhereError(const Aws::Client::AWSError<RolesAnywhereErrors>& rhs) : Aws::Client::AWSError<RolesAnywhereErrors>(rhs) {}
  RolesAnywhereError(Aws::Client::AWSError<RolesAnywhereErrors>&& rhs) : Aws::Client::AWSError<RolesAnywhereErrors>(rhs) {}
