...
namespace RolesAnywhere
{
   ...
   */
  class AWS_ROLESANYWHERE_API RolesAnywhereClient : Aws::Client::ClientWithAsyncTemplateMethods<RolesAnywhereClient>,
    smithy::client::AwsSmithyClientT<Aws::RolesAnywhere::SERVICE_NAME,
