...
class AWS_ROLESANYWHERE_API RolesAnywhereClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  RolesAnywhereClient(const Aws::RolesAnywhere::RolesAnywhereClientConfiguration& clientConfiguration =
  ...
  RolesAnywhereClient(const Aws::Auth::AWSCredentials& credentials,
                      std::shared_ptr<RolesAnywhereEndpointProviderBase> endpointProvider = nullptr,
                      const Aws::RolesAnywhere::RolesAnywhereClientConfiguration& clientConfiguration =
                          Aws::RolesAnywhere::RolesAnywhereClientConfiguration());
  ...
  /**
   * A Callable wrapper for CreateTrustAnchor that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateTrustAnchor that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateTrustAnchorRequestT = Model::CreateTrustAnchorRequest>
  void CreateTrustAnchorAsync(const CreateTrustAnchorRequestT& request, const CreateTrustAnchorResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteAttributeMapping that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteAttributeMapping that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteAttributeMappingRequestT = Model::DeleteAttributeMappingRequest>
  void DeleteAttributeMappingAsync(const DeleteAttributeMappingRequestT& request,
                                   const DeleteAttributeMappingResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteCrl that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteCrlRequestT = Model::DeleteCrlRequest>
  void DeleteCrlAsync(const DeleteCrlRequestT& request, const DeleteCrlResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteTrustAnchor that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteTrustAnchor that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteTrustAnchorRequestT = Model::DeleteTrustAnchorRequest>
  void DeleteTrustAnchorAsync(const DeleteTrustAnchorRequestT& request, const DeleteTrustAnchorResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DisableCrl that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DisableCrlRequestT = Model::DisableCrlRequest>
  void DisableCrlAsync(const DisableCrlRequestT& request, const DisableCrlResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DisableProfile that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DisableProfileRequestT = Model::DisableProfileRequest>
  void DisableProfileAsync(const DisableProfileRequestT& request, const DisableProfileResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DisableTrustAnchor that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DisableTrustAnchor that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DisableTrustAnchorRequestT = Model::DisableTrustAnchorRequest>
  void DisableTrustAnchorAsync(const DisableTrustAnchorRequestT& request, const DisableTrustAnchorResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for EnableCrl that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename EnableCrlRequestT = Model::EnableCrlRequest>
  void EnableCrlAsync(const EnableCrlRequestT& request, const EnableCrlResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for EnableProfile that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename EnableProfileRequestT = Model::EnableProfileRequest>
  void EnableProfileAsync(const EnableProfileRequestT& request, const EnableProfileResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for EnableTrustAnchor that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for EnableTrustAnchor that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename EnableTrustAnchorRequestT = Model::EnableTrustAnchorRequest>
  void EnableTrustAnchorAsync(const EnableTrustAnchorRequestT& request, const EnableTrustAnchorResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetCrl that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetCrlRequestT = Model::GetCrlRequest>
  void GetCrlAsync(const GetCrlRequestT& request, const GetCrlResponseReceivedHandler& handler,
                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetSubject that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetSubjectRequestT = Model::GetSubjectRequest>
  void GetSubjectAsync(const GetSubjectRequestT& request, const GetSubjectResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetTrustAnchor that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetTrustAnchorRequestT = Model::GetTrustAnchorRequest>
  void GetTrustAnchorAsync(const GetTrustAnchorRequestT& request, const GetTrustAnchorResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ImportCrl that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ImportCrlRequestT = Model::ImportCrlRequest>
  void ImportCrlAsync(const ImportCrlRequestT& request, const ImportCrlResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListCrls that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListCrlsRequestT = Model::ListCrlsRequest>
  void ListCrlsAsync(const ListCrlsResponseReceivedHandler& handler,
                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                     const ListCrlsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListSubjects that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListSubjectsRequestT = Model::ListSubjectsRequest>
  void ListSubjectsAsync(const ListSubjectsResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                         const ListSubjectsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListTrustAnchors that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListTrustAnchors that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListTrustAnchorsRequestT = Model::ListTrustAnchorsRequest>
  void ListTrustAnchorsAsync(const ListTrustAnchorsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const ListTrustAnchorsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for PutAttributeMapping that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutAttributeMapping that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PutAttributeMappingRequestT = Model::PutAttributeMappingRequest>
  void PutAttributeMappingAsync(const PutAttributeMappingRequestT& request, const PutAttributeMappingResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutNotificationSettings that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutNotificationSettings that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutNotificationSettingsRequestT = Model::PutNotificationSettingsRequest>
  void PutNotificationSettingsAsync(const PutNotificationSettingsRequestT& request,
                                    const PutNotificationSettingsResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ResetNotificationSettings that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ResetNotificationSettingsRequestT = Model::ResetNotificationSettingsRequest>
  Model::ResetNotificationSettingsOutcomeCallable ResetNotificationSettingsCallable(
      const ResetNotificationSettingsRequestT& request) const {
    return SubmitCallable(&RolesAnywhereClient::ResetNotificationSettings, request);
  }

  /**
   * An Async wrapper for ResetNotificationSettings that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ResetNotificationSettingsRequestT = Model::ResetNotificationSettingsRequest>
  void ResetNotificationSettingsAsync(const ResetNotificationSettingsRequestT& request,
                                      const ResetNotificationSettingsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateCrl that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateCrlRequestT = Model::UpdateCrlRequest>
  void UpdateCrlAsync(const UpdateCrlRequestT& request, const UpdateCrlResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateTrustAnchor that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateTrustAnchor that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateTrustAnchorRequestT = Model::UpdateTrustAnchorRequest>
  void UpdateTrustAnchorAsync(const UpdateTrustAnchorRequestT& request, const UpdateTrustAnchorResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
