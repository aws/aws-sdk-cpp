...
namespace Model
{
  ...
  public:
    ...
    inline UpdateCrlResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateCrlResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateCrlResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
