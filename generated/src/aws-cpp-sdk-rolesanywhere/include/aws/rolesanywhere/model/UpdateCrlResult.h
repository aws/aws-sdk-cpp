...
namespace Model
{
  ...
  public:
    ...
    template<typename CrlT = CrlDetail>
    UpdateCrlResult& WithCrl(CrlT&& value) { SetCrl(std::forward<CrlT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateCrlResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
