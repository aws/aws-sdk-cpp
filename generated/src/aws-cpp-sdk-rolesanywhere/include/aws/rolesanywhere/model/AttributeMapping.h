...
class AttributeMapping {
 public:
  ...
  inline AttributeMapping& WithCertificateField(CertificateField value) {
  ...
  void SetMappingRules(MappingRulesT&& value) {
    ...
    m_mappingRules = std::forward<MappingRulesT>(value);
  }
  template <typename MappingRulesT = Aws::Vector<MappingRule>>
  AttributeMapping& WithMappingRules(MappingRulesT&& value) {
    SetMappingRules(std::forward<MappingRulesT>(value));
    return *this;
  }
  template <typename MappingRulesT = MappingRule>
  AttributeMapping& AddMappingRules(MappingRulesT&& value) {
    m_mappingRulesHasBeenSet = true;
    m_mappingRules.emplace_back(std::forward<MappingRulesT>(value));
    return *this;
  }
  ///@}
 private:
