...
class DeleteTrustAnchorResult {
 public:
  AWS_ROLESANYWHERE_API DeleteTrustAnchorResult() = default;
  ...
  template <typename TrustAnchorT = TrustAnchorDetail>
  DeleteTrustAnchorResult& WithTrustAnchor(TrustAnchorT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteTrustAnchorResult& WithRequestId(RequestIdT&& value) {
