...
namespace Model
{
  ...
  /**
   */
  class DeleteTrustAnchorRequest : public RolesAnywhereRequest
  {
  public:
    AWS_ROLESANYWHERE_API DeleteTrustAnchorRequest() = default;
    ...
    template<typename TrustAnchorIdT = Aws::String>
    DeleteTrustAnchorRequest& WithTrustAnchorId(TrustAnchorIdT&& value) { SetTrustAnchorId(std::forward<TrustAnchorIdT>(value)); return *this;}
    ///@}
  private:
