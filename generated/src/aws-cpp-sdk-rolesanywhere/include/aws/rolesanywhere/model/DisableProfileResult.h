...
namespace Model
{
  ...
  {
  public:
    AWS_ROLESANYWHERE_API DisableProfileResult() = default;
    ...
    template<typename ProfileT = ProfileDetail>
    DisableProfileResult& WithProfile(ProfileT&& value) { SetProfile(std::forward<ProfileT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DisableProfileResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
