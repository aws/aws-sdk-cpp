...
namespace Model
{
  ...
  public:
     ...
     * <p>The state of the profile after a read or write operation.</p>
     */
    inline DisableProfileResult& WithProfile(const ProfileDetail& value) { SetProfile(value); return *this;}

    /**
     * <p>The state of the profile after a read or write operation.</p>
     */
    inline DisableProfileResult& WithProfile(ProfileDetail&& value) { SetProfile(std::move(value)); return *this;}
    ...
    inline DisableProfileResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DisableProfileResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DisableProfileResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
