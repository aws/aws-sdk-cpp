...
class DeleteAttributeMappingRequest : public RolesAnywhereRequest {
 public:
  ...
  void SetSpecifiers(SpecifiersT&& value) {
    m_specifiersHasBeenSet = true;
    m_specifiers = std::forward<SpecifiersT>(value);
  }
  template <typename SpecifiersT = Aws::Vector<Aws::String>>
  DeleteAttributeMappingRequest& WithSpecifiers(SpecifiersT&& value) {
    SetSpecifiers(std::forward<SpecifiersT>(value));
    return *this;
  }
  template <typename SpecifiersT = Aws::String>
  DeleteAttributeMappingRequest& AddSpecifiers(SpecifiersT&& value) {
    m_specifiersHasBeenSet = true;
    m_specifiers.emplace_back(std::forward<SpecifiersT>(value));
    return *this;
  }
  ///@}
 private:
