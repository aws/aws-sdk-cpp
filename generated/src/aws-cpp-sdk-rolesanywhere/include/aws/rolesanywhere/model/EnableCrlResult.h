...
namespace Model
{
  ...
  {
  public:
    AWS_ROLESANYWHERE_API EnableCrlResult() = default;
    ...
    template<typename CrlT = CrlDetail>
    EnableCrlResult& WithCrl(CrlT&& value) { SetCrl(std::forward<CrlT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    EnableCrlResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
