...
class ResetNotificationSettingsRequest : public RolesAnywhereRequest {
 public:
  ...
  void SetNotificationSettingKeys(NotificationSettingKeysT&& value) {
    m_notificationSettingKeysHasBeenSet = true;
    m_notificationSettingKeys = std::forward<NotificationSettingKeysT>(value);
  }
  template <typename NotificationSettingKeysT = Aws::Vector<NotificationSettingKey>>
  ResetNotificationSettingsRequest& WithNotificationSettingKeys(NotificationSettingKeysT&& value) {
    SetNotificationSettingKeys(std::forward<NotificationSettingKeysT>(value));
    return *this;
  }
  ...
  ResetNotificationSettingsRequest& AddNotificationSettingKeys(NotificationSettingKeysT&& value) {
    m_notificationSettingKeysHasBeenSet = true;
    m_notificationSettingKeys.emplace_back(std::forward<NotificationSettingKeysT>(value));
    return *this;
  }
  ///@}
