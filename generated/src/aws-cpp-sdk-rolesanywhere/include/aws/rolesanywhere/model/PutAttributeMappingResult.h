...
namespace Model
{
  ...
  {
  public:
    AWS_ROLESANYWHERE_API PutAttributeMappingResult() = default;
    ...
    template<typename ProfileT = ProfileDetail>
    PutAttributeMappingResult& WithProfile(ProfileT&& value) { SetProfile(std::forward<ProfileT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    PutAttributeMappingResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
