...
class NotificationSettingDetail {
 public:
  ...
  inline NotificationSettingDetail& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline NotificationSettingDetail& WithEvent(NotificationEvent value) {
    SetEvent(value);
    return *this;
  }
  ///@}
  ...
  inline NotificationSettingDetail& WithThreshold(int value) {
    SetThreshold(value);
    return *this;
  }
  ///@}
  ...
  inline NotificationSettingDetail& WithChannel(NotificationChannel value) {
    SetChannel(value);
    return *this;
  }
  ///@}
  ...
  void SetConfiguredBy(ConfiguredByT&& value) {
    ...
    m_configuredBy = std::forward<ConfiguredByT>(value);
  }
  template <typename ConfiguredByT = Aws::String>
  NotificationSettingDetail& WithConfiguredBy(ConfiguredByT&& value) {
    SetConfiguredBy(std::forward<ConfiguredByT>(value));
    return *this;
  }
  ///@}
 private:
