...
namespace Model
{
  ...
  {
  public:
    AWS_ROLESANYWHERE_API GetTrustAnchorResult() = default;
    ...
    template<typename TrustAnchorT = TrustAnchorDetail>
    GetTrustAnchorResult& WithTrustAnchor(TrustAnchorT&& value) { SetTrustAnchor(std::forward<TrustAnchorT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    GetTrustAnchorResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
