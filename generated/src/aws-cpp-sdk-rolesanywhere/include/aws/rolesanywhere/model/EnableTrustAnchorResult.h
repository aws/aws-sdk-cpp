...
namespace Model
{
  ...
  {
  public:
    AWS_ROLESANYWHERE_API EnableTrustAnchorResult() = default;
    ...
    template<typename TrustAnchorT = TrustAnchorDetail>
    EnableTrustAnchorResult& WithTrustAnchor(TrustAnchorT&& value) { SetTrustAnchor(std::forward<TrustAnchorT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    EnableTrustAnchorResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
