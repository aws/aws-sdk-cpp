...
class NotificationSetting {
 public:
  ...
  inline NotificationSetting& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline NotificationSetting& WithEvent(NotificationEvent value) {
    SetEvent(value);
    return *this;
  }
  ///@}
  ...
  inline NotificationSetting& WithThreshold(int value) {
    SetThreshold(value);
    return *this;
  }
  ///@}
