...
namespace Model
{
  ...
  {
  public:
    AWS_ROLESANYWHERE_API ListTrustAnchorsRequest() = default;
    ...
    template<typename NextTokenT = Aws::String>
    ListTrustAnchorsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
