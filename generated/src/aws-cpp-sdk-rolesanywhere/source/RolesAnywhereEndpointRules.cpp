...
{
const size_t RolesAnywhereEndpointRules::RulesBlobStrLen = 3482;
const size_t RolesAnywhereEndpointRules::RulesBlobSize = 3483;
...
't','t','p','s',':','/','/','r','o','l','e','s','a','n','y','w','h','e','r','e','-','f','i','p','s',
