...
LaunchGroupConfig::LaunchGroupConfig(JsonView jsonValue) { *this = jsonValue; }

LaunchGroupConfig& LaunchGroupConfig::operator=(JsonView jsonValue) {
...
JsonValue LaunchGroupConfig::Jsonize() const {
  JsonValue payload;
