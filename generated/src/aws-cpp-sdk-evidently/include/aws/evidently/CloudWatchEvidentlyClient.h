...
namespace CloudWatchEvidently
{
   ...
   */
  class AWS_CLOUDWATCHEVIDENTLY_API CloudWatchEvidentlyClient : Aws::Client::ClientWithAsyncTemplateMethods<CloudWatchEvidentlyClient>,
    smithy::client::AwsSmithyClientT<Aws::CloudWatchEvidently::SERVICE_NAME,
