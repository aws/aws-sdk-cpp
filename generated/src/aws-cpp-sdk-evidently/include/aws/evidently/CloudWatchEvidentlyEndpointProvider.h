...
using CloudWatchEvidentlyEndpointProviderBase =
    EndpointProviderBase<CloudWatchEvidentlyClientConfiguration, CloudWatchEvidentlyBuiltInParameters,
                         CloudWatchEvidentlyClientContextParameters>;

using CloudWatchEvidentlyDefaultEpProviderBase =
    DefaultEndpointProvider<CloudWatchEvidentlyClientConfiguration, CloudWatchEvidentlyBuiltInParameters,
                            CloudWatchEvidentlyClientContextParameters>;
...
class AWS_CLOUDWATCHEVIDENTLY_API CloudWatchEvidentlyEndpointProvider : public CloudWatchEvidentlyDefaultEpProviderBase {
 public:
  ...
  CloudWatchEvidentlyEndpointProvider()
      : CloudWatchEvidentlyDefaultEpProviderBase(Aws::CloudWatchEvidently::CloudWatchEvidentlyEndpointRules::GetRulesBlob(),
                                                 Aws::CloudWatchEvidently::CloudWatchEvidentlyEndpointRules::RulesBlobSize) {}
