...
class CreateLaunchRequest : public CloudWatchEvidentlyRequest {
 public:
  ...
  void SetScheduledSplitsConfig(ScheduledSplitsConfigT&& value) {
    m_scheduledSplitsConfigHasBeenSet = true;
    m_scheduledSplitsConfig = std::forward<ScheduledSplitsConfigT>(value);
  }
  template <typename ScheduledSplitsConfigT = ScheduledSplitsLaunchConfig>
  CreateLaunchRequest& WithScheduledSplitsConfig(ScheduledSplitsConfigT&& value) {
    SetScheduledSplitsConfig(std::forward<ScheduledSplitsConfigT>(value));
    return *this;
  }
  ///@}
