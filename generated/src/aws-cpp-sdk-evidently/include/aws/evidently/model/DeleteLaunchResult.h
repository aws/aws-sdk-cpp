...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDWATCHEVIDENTLY_API DeleteLaunchResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteLaunchResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
