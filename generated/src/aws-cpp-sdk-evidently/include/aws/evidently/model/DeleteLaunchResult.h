...
namespace Model
{
  ...
  public:
    ...
    inline DeleteLaunchResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeleteLaunchResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeleteLaunchResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
