...
class ListSegmentReferencesResult {
 public:
  ...
  AWS_CLOUDWATCHEVIDENTLY_API ListSegmentReferencesResult& operator=(
  ...
  template <typename NextTokenT = Aws::String>
  ListSegmentReferencesResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetReferencedBy(ReferencedByT&& value) {
    ...
    m_referencedBy = std::forward<ReferencedByT>(value);
  }
  template <typename ReferencedByT = Aws::Vector<RefResource>>
  ListSegmentReferencesResult& WithReferencedBy(ReferencedByT&& value) {
    SetReferencedBy(std::forward<ReferencedByT>(value));
    return *this;
  }
  template <typename ReferencedByT = RefResource>
  ListSegmentReferencesResult& AddReferencedBy(ReferencedByT&& value) {
    m_referencedByHasBeenSet = true;
    m_referencedBy.emplace_back(std::forward<ReferencedByT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListSegmentReferencesResult& WithRequestId(RequestIdT&& value) {
