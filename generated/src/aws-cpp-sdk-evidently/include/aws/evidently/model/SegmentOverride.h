...
class SegmentOverride {
 public:
  ...
  inline void SetEvaluationOrder(long long value) {
    m_evaluationOrderHasBeenSet = true;
    m_evaluationOrder = value;
  }
  inline SegmentOverride& WithEvaluationOrder(long long value) {
