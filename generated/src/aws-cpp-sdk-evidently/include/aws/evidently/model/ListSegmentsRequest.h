...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDWATCHEVIDENTLY_API ListSegmentsRequest() = default;
    ...
    template<typename NextTokenT = Aws::String>
    ListSegmentsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
