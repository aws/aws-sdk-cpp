...
class UpdateFeatureRequest : public CloudWatchEvidentlyRequest {
 public:
  ...
  void SetAddOrUpdateVariations(AddOrUpdateVariationsT&& value) {
    m_addOrUpdateVariationsHasBeenSet = true;
    m_addOrUpdateVariations = std::forward<AddOrUpdateVariationsT>(value);
  }
  template <typename AddOrUpdateVariationsT = Aws::Vector<VariationConfig>>
  UpdateFeatureRequest& WithAddOrUpdateVariations(AddOrUpdateVariationsT&& value) {
    SetAddOrUpdateVariations(std::forward<AddOrUpdateVariationsT>(value));
    return *this;
  }
  template <typename AddOrUpdateVariationsT = VariationConfig>
  UpdateFeatureRequest& AddAddOrUpdateVariations(AddOrUpdateVariationsT&& value) {
    m_addOrUpdateVariationsHasBeenSet = true;
    m_addOrUpdateVariations.emplace_back(std::forward<AddOrUpdateVariationsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDefaultVariation(DefaultVariationT&& value) {
    ...
    m_defaultVariation = std::forward<DefaultVariationT>(value);
  }
  template <typename DefaultVariationT = Aws::String>
  UpdateFeatureRequest& WithDefaultVariation(DefaultVariationT&& value) {
    SetDefaultVariation(std::forward<DefaultVariationT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename DescriptionT = Aws::String>
  UpdateFeatureRequest& WithDescription(DescriptionT&& value) {
  ...
  void SetEntityOverrides(EntityOverridesT&& value) {
    ...
    m_entityOverrides = std::forward<EntityOverridesT>(value);
  }
  template <typename EntityOverridesT = Aws::Map<Aws::String, Aws::String>>
  UpdateFeatureRequest& WithEntityOverrides(EntityOverridesT&& value) {
    SetEntityOverrides(std::forward<EntityOverridesT>(value));
    return *this;
  }
  ...
  UpdateFeatureRequest& AddEntityOverrides(EntityOverridesKeyT&& key, EntityOverridesValueT&& value) {
    m_entityOverridesHasBeenSet = true;
    m_entityOverrides.emplace(std::forward<EntityOverridesKeyT>(key), std::forward<EntityOverridesValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetEvaluationStrategy(FeatureEvaluationStrategy value) {
    m_evaluationStrategyHasBeenSet = true;
    m_evaluationStrategy = value;
  }
  inline UpdateFeatureRequest& WithEvaluationStrategy(FeatureEvaluationStrategy value) {
  ...
  template <typename FeatureT = Aws::String>
  UpdateFeatureRequest& WithFeature(FeatureT&& value) {
  ...
  template <typename ProjectT = Aws::String>
  UpdateFeatureRequest& WithProject(ProjectT&& value) {
  ...
  void SetRemoveVariations(RemoveVariationsT&& value) {
    m_removeVariationsHasBeenSet = true;
    m_removeVariations = std::forward<RemoveVariationsT>(value);
  }
  template <typename RemoveVariationsT = Aws::Vector<Aws::String>>
  UpdateFeatureRequest& WithRemoveVariations(RemoveVariationsT&& value) {
    SetRemoveVariations(std::forward<RemoveVariationsT>(value));
    return *this;
  }
  template <typename RemoveVariationsT = Aws::String>
  UpdateFeatureRequest& AddRemoveVariations(RemoveVariationsT&& value) {
    m_removeVariationsHasBeenSet = true;
    m_removeVariations.emplace_back(std::forward<RemoveVariationsT>(value));
    return *this;
  }
  ///@}
 private:
