...
class VariableValue {
 public:
  ...
  inline VariableValue& WithBoolValue(bool value) {
    SetBoolValue(value);
    return *this;
  }
  ///@}
  ...
  inline VariableValue& WithDoubleValue(double value) {
  ...
  inline VariableValue& WithLongValue(long long value) {
    SetLongValue(value);
    return *this;
  }
  ///@}
  ...
  template <typename StringValueT = Aws::String>
  VariableValue& WithStringValue(StringValueT&& value) {
