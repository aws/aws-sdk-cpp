...
class MetricDefinition {
 public:
  ...
  void SetEntityIdKey(EntityIdKeyT&& value) {
    m_entityIdKeyHasBeenSet = true;
    m_entityIdKey = std::forward<EntityIdKeyT>(value);
  }
  template <typename EntityIdKeyT = Aws::String>
  MetricDefinition& WithEntityIdKey(EntityIdKeyT&& value) {
    SetEntityIdKey(std::forward<EntityIdKeyT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename EventPatternT = Aws::String>
  MetricDefinition& WithEventPattern(EventPatternT&& value) {
