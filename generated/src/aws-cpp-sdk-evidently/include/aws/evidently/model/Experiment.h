...
class Experiment {
 public:
  ...
  void SetMetricGoals(MetricGoalsT&& value) {
    ...
    m_metricGoals = std::forward<MetricGoalsT>(value);
  }
  template <typename MetricGoalsT = Aws::Vector<MetricGoal>>
  Experiment& WithMetricGoals(MetricGoalsT&& value) {
    SetMetricGoals(std::forward<MetricGoalsT>(value));
    return *this;
  }
  template <typename MetricGoalsT = MetricGoal>
  Experiment& AddMetricGoals(MetricGoalsT&& value) {
    m_metricGoalsHasBeenSet = true;
    m_metricGoals.emplace_back(std::forward<MetricGoalsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOnlineAbDefinition(OnlineAbDefinitionT&& value) {
    ...
    m_onlineAbDefinition = std::forward<OnlineAbDefinitionT>(value);
  }
  template <typename OnlineAbDefinitionT = OnlineAbDefinition>
  Experiment& WithOnlineAbDefinition(OnlineAbDefinitionT&& value) {
    SetOnlineAbDefinition(std::forward<OnlineAbDefinitionT>(value));
    return *this;
  }
  ///@}
  ...
  inline Experiment& WithSamplingRate(long long value) {
  ...
  inline Experiment& WithStatus(ExperimentStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetType(ExperimentType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline Experiment& WithType(ExperimentType value) {
    SetType(value);
    return *this;
  }
  ///@}
