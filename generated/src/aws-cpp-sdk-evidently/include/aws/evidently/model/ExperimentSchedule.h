...
class ExperimentSchedule {
 public:
  ...
  void SetAnalysisCompleteTime(AnalysisCompleteTimeT&& value) {
    m_analysisCompleteTimeHasBeenSet = true;
    m_analysisCompleteTime = std::forward<AnalysisCompleteTimeT>(value);
  }
  template <typename AnalysisCompleteTimeT = Aws::Utils::DateTime>
  ExperimentSchedule& WithAnalysisCompleteTime(AnalysisCompleteTimeT&& value) {
    SetAnalysisCompleteTime(std::forward<AnalysisCompleteTimeT>(value));
    return *this;
  }
  ///@}
 private:
