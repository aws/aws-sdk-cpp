...
class UpdateProjectDataDeliveryResult {
 public:
  ...
  AWS_CLOUDWATCHEVIDENTLY_API UpdateProjectDataDeliveryResult& operator=(
  ...
  template <typename ProjectT = Project>
  UpdateProjectDataDeliveryResult& WithProject(ProjectT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateProjectDataDeliveryResult& WithRequestId(RequestIdT&& value) {
