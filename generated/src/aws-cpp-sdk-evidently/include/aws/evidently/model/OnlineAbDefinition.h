...
class OnlineAbDefinition {
 public:
  ...
  void SetControlTreatmentName(ControlTreatmentNameT&& value) {
    ...
    m_controlTreatmentName = std::forward<ControlTreatmentNameT>(value);
  }
  template <typename ControlTreatmentNameT = Aws::String>
  OnlineAbDefinition& WithControlTreatmentName(ControlTreatmentNameT&& value) {
    SetControlTreatmentName(std::forward<ControlTreatmentNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTreatmentWeights(TreatmentWeightsT&& value) {
    ...
    m_treatmentWeights = std::forward<TreatmentWeightsT>(value);
  }
  template <typename TreatmentWeightsT = Aws::Map<Aws::String, long long>>
  OnlineAbDefinition& WithTreatmentWeights(TreatmentWeightsT&& value) {
    SetTreatmentWeights(std::forward<TreatmentWeightsT>(value));
    return *this;
  }
  inline OnlineAbDefinition& AddTreatmentWeights(Aws::String key, long long value) {
    m_treatmentWeightsHasBeenSet = true;
    m_treatmentWeights.emplace(key, value);
    return *this;
  }
  ///@}
 private:
