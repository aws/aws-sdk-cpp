...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDWATCHEVIDENTLY_API CloudWatchLogsDestination() = default;
    ...
    template<typename LogGroupT = Aws::String>
    CloudWatchLogsDestination& WithLogGroup(LogGroupT&& value) { SetLogGroup(std::forward<LogGroupT>(value)); return *this;}
    ///@}
  private:
