...
class Feature {
 public:
  ...
  void SetEvaluationRules(EvaluationRulesT&& value) {
    ...
    m_evaluationRules = std::forward<EvaluationRulesT>(value);
  }
  template <typename EvaluationRulesT = Aws::Vector<EvaluationRule>>
  Feature& WithEvaluationRules(EvaluationRulesT&& value) {
    SetEvaluationRules(std::forward<EvaluationRulesT>(value));
    return *this;
  }
  template <typename EvaluationRulesT = EvaluationRule>
  Feature& AddEvaluationRules(EvaluationRulesT&& value) {
    m_evaluationRulesHasBeenSet = true;
    m_evaluationRules.emplace_back(std::forward<EvaluationRulesT>(value));
    return *this;
  }
  ///@}
  ...
  inline Feature& WithEvaluationStrategy(FeatureEvaluationStrategy value) {
  ...
  inline Feature& WithStatus(FeatureStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetValueType(VariationValueType value) {
    m_valueTypeHasBeenSet = true;
    m_valueType = value;
  }
  inline Feature& WithValueType(VariationValueType value) {
    SetValueType(value);
    return *this;
  }
  ///@}
  ...
  void SetVariations(VariationsT&& value) {
    ...
    m_variations = std::forward<VariationsT>(value);
  }
  template <typename VariationsT = Aws::Vector<Variation>>
  Feature& WithVariations(VariationsT&& value) {
    SetVariations(std::forward<VariationsT>(value));
    return *this;
  }
  template <typename VariationsT = Variation>
  Feature& AddVariations(VariationsT&& value) {
    m_variationsHasBeenSet = true;
    m_variations.emplace_back(std::forward<VariationsT>(value));
    return *this;
  }
  ///@}
 private:
