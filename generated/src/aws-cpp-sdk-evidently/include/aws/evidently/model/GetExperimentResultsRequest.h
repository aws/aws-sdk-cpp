...
class GetExperimentResultsRequest : public CloudWatchEvidentlyRequest {
 public:
  ...
  inline void SetBaseStat(ExperimentBaseStat value) {
    m_baseStatHasBeenSet = true;
    m_baseStat = value;
  }
  inline GetExperimentResultsRequest& WithBaseStat(ExperimentBaseStat value) {
    SetBaseStat(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPeriod(long long value) {
    m_periodHasBeenSet = true;
    m_period = value;
  }
  inline GetExperimentResultsRequest& WithPeriod(long long value) {
    SetPeriod(value);
    return *this;
  }
  ///@}
  ...
  void SetReportNames(ReportNamesT&& value) {
    m_reportNamesHasBeenSet = true;
    m_reportNames = std::forward<ReportNamesT>(value);
  }
  template <typename ReportNamesT = Aws::Vector<ExperimentReportName>>
  GetExperimentResultsRequest& WithReportNames(ReportNamesT&& value) {
    SetReportNames(std::forward<ReportNamesT>(value));
    return *this;
  }
  inline GetExperimentResultsRequest& AddReportNames(ExperimentReportName value) {
    m_reportNamesHasBeenSet = true;
    m_reportNames.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetResultStats(ResultStatsT&& value) {
    m_resultStatsHasBeenSet = true;
    m_resultStats = std::forward<ResultStatsT>(value);
  }
  template <typename ResultStatsT = Aws::Vector<ExperimentResultRequestType>>
  GetExperimentResultsRequest& WithResultStats(ResultStatsT&& value) {
    SetResultStats(std::forward<ResultStatsT>(value));
    return *this;
  }
  inline GetExperimentResultsRequest& AddResultStats(ExperimentResultRequestType value) {
    m_resultStatsHasBeenSet = true;
    m_resultStats.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetTreatmentNames(TreatmentNamesT&& value) {
    m_treatmentNamesHasBeenSet = true;
    m_treatmentNames = std::forward<TreatmentNamesT>(value);
  }
  template <typename TreatmentNamesT = Aws::Vector<Aws::String>>
  GetExperimentResultsRequest& WithTreatmentNames(TreatmentNamesT&& value) {
    SetTreatmentNames(std::forward<TreatmentNamesT>(value));
    return *this;
  }
  template <typename TreatmentNamesT = Aws::String>
  GetExperimentResultsRequest& AddTreatmentNames(TreatmentNamesT&& value) {
    m_treatmentNamesHasBeenSet = true;
    m_treatmentNames.emplace_back(std::forward<TreatmentNamesT>(value));
    return *this;
  }
  ///@}
 private:
