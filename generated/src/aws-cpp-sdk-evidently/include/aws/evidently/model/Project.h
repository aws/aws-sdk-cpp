...
class Project {
 public:
  ...
  inline Project& WithActiveExperimentCount(long long value) {
  ...
  inline Project& WithActiveLaunchCount(long long value) {
  ...
  void SetAppConfigResource(AppConfigResourceT&& value) {
    ...
    m_appConfigResource = std::forward<AppConfigResourceT>(value);
  }
  template <typename AppConfigResourceT = ProjectAppConfigResource>
  Project& WithAppConfigResource(AppConfigResourceT&& value) {
    SetAppConfigResource(std::forward<AppConfigResourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDataDelivery(DataDeliveryT&& value) {
    ...
    m_dataDelivery = std::forward<DataDeliveryT>(value);
  }
  template <typename DataDeliveryT = ProjectDataDelivery>
  Project& WithDataDelivery(DataDeliveryT&& value) {
    SetDataDelivery(std::forward<DataDeliveryT>(value));
    return *this;
  }
  ///@}
  ...
  inline Project& WithExperimentCount(long long value) {
  ...
  inline Project& WithFeatureCount(long long value) {
  ...
  inline Project& WithLaunchCount(long long value) {
  ...
  inline Project& WithStatus(ProjectStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
