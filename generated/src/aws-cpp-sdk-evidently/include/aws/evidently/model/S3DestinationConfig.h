 ...
 * <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/evidently-2021-02-01/S3DestinationConfig">AWS
 * API Reference</a></p>
 */
class S3DestinationConfig {
 public:
  AWS_CLOUDWATCHEVIDENTLY_API S3DestinationConfig() = default;
  AWS_CLOUDWATCHEVIDENTLY_API S3DestinationConfig(Aws::Utils::Json::JsonView jsonValue);
  AWS_CLOUDWATCHEVIDENTLY_API S3DestinationConfig& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename PrefixT = Aws::String>
  S3DestinationConfig& WithPrefix(PrefixT&& value) {
