...
class LaunchGroup {
 public:
  ...
  template <typename DescriptionT = Aws::String>
  LaunchGroup& WithDescription(DescriptionT&& value) {
  ...
  void SetFeatureVariations(FeatureVariationsT&& value) {
    ...
    m_featureVariations = std::forward<FeatureVariationsT>(value);
  }
  template <typename FeatureVariationsT = Aws::Map<Aws::String, Aws::String>>
  LaunchGroup& WithFeatureVariations(FeatureVariationsT&& value) {
    SetFeatureVariations(std::forward<FeatureVariationsT>(value));
    return *this;
  }
  ...
  LaunchGroup& AddFeatureVariations(FeatureVariationsKeyT&& key, FeatureVariationsValueT&& value) {
    m_featureVariationsHasBeenSet = true;
    m_featureVariations.emplace(std::forward<FeatureVariationsKeyT>(key), std::forward<FeatureVariationsValueT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NameT = Aws::String>
  LaunchGroup& WithName(NameT&& value) {
