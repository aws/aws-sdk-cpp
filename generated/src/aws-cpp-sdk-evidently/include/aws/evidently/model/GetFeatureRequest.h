...
namespace Model
{
  ...
  public:
    ...
    template<typename FeatureT = Aws::String>
    GetFeatureRequest& WithFeature(FeatureT&& value) { SetFeature(std::forward<FeatureT>(value)); return *this;}
    ///@}
    ...
    template<typename ProjectT = Aws::String>
    GetFeatureRequest& WithProject(ProjectT&& value) { SetProject(std::forward<ProjectT>(value)); return *this;}
    ///@}
  private:
