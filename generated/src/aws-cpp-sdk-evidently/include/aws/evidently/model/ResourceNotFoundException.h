...
namespace Model
{
   ...
   * Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/evidently-2021-02-01/ResourceNotFoundException">AWS
   * API Reference</a></p>
   */
  class ResourceNotFoundException
  {
  public:
    AWS_CLOUDWATCHEVIDENTLY_API ResourceNotFoundException() = default;
    AWS_CLOUDWATCHEVIDENTLY_API ResourceNotFoundException(Aws::Utils::Json::JsonView jsonValue);
    AWS_CLOUDWATCHEVIDENTLY_API ResourceNotFoundException& operator=(Aws::Utils::Json::JsonView jsonValue);
