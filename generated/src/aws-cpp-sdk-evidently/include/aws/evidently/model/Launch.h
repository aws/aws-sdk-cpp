...
class Launch {
 public:
  ...
  void SetExecution(ExecutionT&& value) {
    ...
    m_execution = std::forward<ExecutionT>(value);
  }
  template <typename ExecutionT = LaunchExecution>
  Launch& WithExecution(ExecutionT&& value) {
    SetExecution(std::forward<ExecutionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMetricMonitors(MetricMonitorsT&& value) {
    ...
    m_metricMonitors = std::forward<MetricMonitorsT>(value);
  }
  template <typename MetricMonitorsT = Aws::Vector<MetricMonitor>>
  Launch& WithMetricMonitors(MetricMonitorsT&& value) {
    SetMetricMonitors(std::forward<MetricMonitorsT>(value));
    return *this;
  }
  template <typename MetricMonitorsT = MetricMonitor>
  Launch& AddMetricMonitors(MetricMonitorsT&& value) {
    m_metricMonitorsHasBeenSet = true;
    m_metricMonitors.emplace_back(std::forward<MetricMonitorsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRandomizationSalt(RandomizationSaltT&& value) {
    ...
    m_randomizationSalt = std::forward<RandomizationSaltT>(value);
  }
  template <typename RandomizationSaltT = Aws::String>
  Launch& WithRandomizationSalt(RandomizationSaltT&& value) {
    SetRandomizationSalt(std::forward<RandomizationSaltT>(value));
    return *this;
  }
  ///@}
  ...
  void SetScheduledSplitsDefinition(ScheduledSplitsDefinitionT&& value) {
    ...
    m_scheduledSplitsDefinition = std::forward<ScheduledSplitsDefinitionT>(value);
  }
  template <typename ScheduledSplitsDefinitionT = ScheduledSplitsLaunchDefinition>
  Launch& WithScheduledSplitsDefinition(ScheduledSplitsDefinitionT&& value) {
    SetScheduledSplitsDefinition(std::forward<ScheduledSplitsDefinitionT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(LaunchStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline Launch& WithStatus(LaunchStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetType(LaunchType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline Launch& WithType(LaunchType value) {
    SetType(value);
    return *this;
  }
  ///@}
