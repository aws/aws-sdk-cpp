...
class ScheduledSplit {
 public:
  ...
  void SetGroupWeights(GroupWeightsT&& value) {
    m_groupWeightsHasBeenSet = true;
    m_groupWeights = std::forward<GroupWeightsT>(value);
  }
  template <typename GroupWeightsT = Aws::Map<Aws::String, long long>>
  ScheduledSplit& WithGroupWeights(GroupWeightsT&& value) {
    SetGroupWeights(std::forward<GroupWeightsT>(value));
    return *this;
  }
  inline ScheduledSplit& AddGroupWeights(Aws::String key, long long value) {
    m_groupWeightsHasBeenSet = true;
    m_groupWeights.emplace(key, value);
    return *this;
  }
  ///@}
  ...
  void SetSegmentOverrides(SegmentOverridesT&& value) {
    m_segmentOverridesHasBeenSet = true;
    m_segmentOverrides = std::forward<SegmentOverridesT>(value);
  }
  template <typename SegmentOverridesT = Aws::Vector<SegmentOverride>>
  ScheduledSplit& WithSegmentOverrides(SegmentOverridesT&& value) {
    SetSegmentOverrides(std::forward<SegmentOverridesT>(value));
    return *this;
  }
  template <typename SegmentOverridesT = SegmentOverride>
  ScheduledSplit& AddSegmentOverrides(SegmentOverridesT&& value) {
    m_segmentOverridesHasBeenSet = true;
    m_segmentOverrides.emplace_back(std::forward<SegmentOverridesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename StartTimeT = Aws::Utils::DateTime>
  ScheduledSplit& WithStartTime(StartTimeT&& value) {
