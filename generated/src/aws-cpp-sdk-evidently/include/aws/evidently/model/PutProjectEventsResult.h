...
class PutProjectEventsResult {
 public:
  ...
  void SetEventResults(EventResultsT&& value) {
    m_eventResultsHasBeenSet = true;
    m_eventResults = std::forward<EventResultsT>(value);
  }
  template <typename EventResultsT = Aws::Vector<PutProjectEventsResultEntry>>
  PutProjectEventsResult& WithEventResults(EventResultsT&& value) {
    SetEventResults(std::forward<EventResultsT>(value));
    return *this;
  }
  template <typename EventResultsT = PutProjectEventsResultEntry>
  PutProjectEventsResult& AddEventResults(EventResultsT&& value) {
    m_eventResultsHasBeenSet = true;
    m_eventResults.emplace_back(std::forward<EventResultsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetFailedEventCount(int value) {
    m_failedEventCountHasBeenSet = true;
    m_failedEventCount = value;
  }
  inline PutProjectEventsResult& WithFailedEventCount(int value) {
    SetFailedEventCount(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  PutProjectEventsResult& WithRequestId(RequestIdT&& value) {
