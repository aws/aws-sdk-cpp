...
class EvaluateFeatureResult {
 public:
  ...
  template <typename DetailsT = Aws::String>
  EvaluateFeatureResult& WithDetails(DetailsT&& value) {
  ...
  template <typename ReasonT = Aws::String>
  EvaluateFeatureResult& WithReason(ReasonT&& value) {
  ...
  template <typename ValueT = VariableValue>
  EvaluateFeatureResult& WithValue(ValueT&& value) {
  ...
  void SetVariation(VariationT&& value) {
    ...
    m_variation = std::forward<VariationT>(value);
  }
  template <typename VariationT = Aws::String>
  EvaluateFeatureResult& WithVariation(VariationT&& value) {
    SetVariation(std::forward<VariationT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  EvaluateFeatureResult& WithRequestId(RequestIdT&& value) {
