...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDWATCHEVIDENTLY_API GetLaunchResult() = default;
    ...
    template<typename LaunchT = Launch>
    GetLaunchResult& WithLaunch(LaunchT&& value) { SetLaunch(std::forward<LaunchT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    GetLaunchResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
