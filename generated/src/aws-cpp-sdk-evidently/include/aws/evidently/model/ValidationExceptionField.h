...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDWATCHEVIDENTLY_API ValidationExceptionField() = default;
    AWS_CLOUDWATCHEVIDENTLY_API ValidationExceptionField(Aws::Utils::Json::JsonView jsonValue);
    AWS_CLOUDWATCHEVIDENTLY_API ValidationExceptionField& operator=(Aws::Utils::Json::JsonView jsonValue);
