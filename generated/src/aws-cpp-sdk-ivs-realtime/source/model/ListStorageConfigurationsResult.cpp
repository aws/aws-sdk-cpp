...
ListStorageConfigurationsResult::ListStorageConfigurationsResult()
{
}

ListStorageConfigurationsResult::ListStorageConfigurationsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
