...
Aws::String CreateStageRequest::SerializePayload() const {
  ...
  if (m_participantTokenConfigurationsHasBeenSet) {
    ...
    for (unsigned participantTokenConfigurationsIndex = 0;
         participantTokenConfigurationsIndex < participantTokenConfigurationsJsonList.GetLength(); ++participantTokenConfigurationsIndex) {
      participantTokenConfigurationsJsonList[participantTokenConfigurationsIndex].AsObject(
          m_participantTokenConfigurations[participantTokenConfigurationsIndex].Jsonize());
    }
