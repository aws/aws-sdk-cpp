...
UpdateIngestConfigurationResult::UpdateIngestConfigurationResult()
{
}

UpdateIngestConfigurationResult::UpdateIngestConfigurationResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
