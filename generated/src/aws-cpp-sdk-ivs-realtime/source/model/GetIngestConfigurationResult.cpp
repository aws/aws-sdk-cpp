...
GetIngestConfigurationResult::GetIngestConfigurationResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

GetIngestConfigurationResult& GetIngestConfigurationResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
