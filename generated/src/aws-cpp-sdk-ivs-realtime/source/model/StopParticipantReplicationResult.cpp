...
StopParticipantReplicationResult::StopParticipantReplicationResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

StopParticipantReplicationResult& StopParticipantReplicationResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
