...
class AWS_IVSREALTIME_API IvsrealtimeClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  IvsrealtimeClient(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<IvsrealtimeEndpointProviderBase> endpointProvider = nullptr,
      const Aws::ivsrealtime::IvsrealtimeClientConfiguration& clientConfiguration = Aws::ivsrealtime::IvsrealtimeClientConfiguration());
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateEncoderConfigurationOutcome CreateEncoderConfiguration(
      const Model::CreateEncoderConfigurationRequest& request = {}) const;

  /**
   * A Callable wrapper for CreateEncoderConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateEncoderConfigurationRequestT = Model::CreateEncoderConfigurationRequest>
  Model::CreateEncoderConfigurationOutcomeCallable CreateEncoderConfigurationCallable(
      const CreateEncoderConfigurationRequestT& request = {}) const {
    return SubmitCallable(&IvsrealtimeClient::CreateEncoderConfiguration, request);
  }

  /**
   * An Async wrapper for CreateEncoderConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateEncoderConfigurationRequestT = Model::CreateEncoderConfigurationRequest>
  void CreateEncoderConfigurationAsync(const CreateEncoderConfigurationResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for CreateIngestConfiguration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CreateIngestConfigurationRequestT = Model::CreateIngestConfigurationRequest>
  Model::CreateIngestConfigurationOutcomeCallable CreateIngestConfigurationCallable(
      const CreateIngestConfigurationRequestT& request) const {
    return SubmitCallable(&IvsrealtimeClient::CreateIngestConfiguration, request);
  }

  /**
   * An Async wrapper for CreateIngestConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateIngestConfigurationRequestT = Model::CreateIngestConfigurationRequest>
  void CreateIngestConfigurationAsync(const CreateIngestConfigurationRequestT& request,
                                      const CreateIngestConfigurationResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for CreateParticipantToken that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateParticipantToken that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateParticipantTokenRequestT = Model::CreateParticipantTokenRequest>
  void CreateParticipantTokenAsync(const CreateParticipantTokenRequestT& request,
                                   const CreateParticipantTokenResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename CreateStageRequestT = Model::CreateStageRequest>
  void CreateStageAsync(const CreateStageResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                        const CreateStageRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateStorageConfigurationOutcome CreateStorageConfiguration(
      const Model::CreateStorageConfigurationRequest& request) const;

  /**
   * A Callable wrapper for CreateStorageConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateStorageConfigurationRequestT = Model::CreateStorageConfigurationRequest>
  Model::CreateStorageConfigurationOutcomeCallable CreateStorageConfigurationCallable(
      const CreateStorageConfigurationRequestT& request) const {
    return SubmitCallable(&IvsrealtimeClient::CreateStorageConfiguration, request);
  }

  /**
   * An Async wrapper for CreateStorageConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateStorageConfigurationRequestT = Model::CreateStorageConfigurationRequest>
  void CreateStorageConfigurationAsync(const CreateStorageConfigurationRequestT& request,
                                       const CreateStorageConfigurationResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteEncoderConfigurationOutcome DeleteEncoderConfiguration(
      const Model::DeleteEncoderConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DeleteEncoderConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteEncoderConfigurationRequestT = Model::DeleteEncoderConfigurationRequest>
  Model::DeleteEncoderConfigurationOutcomeCallable DeleteEncoderConfigurationCallable(
      const DeleteEncoderConfigurationRequestT& request) const {
    return SubmitCallable(&IvsrealtimeClient::DeleteEncoderConfiguration, request);
  }

  /**
   * An Async wrapper for DeleteEncoderConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteEncoderConfigurationRequestT = Model::DeleteEncoderConfigurationRequest>
  void DeleteEncoderConfigurationAsync(const DeleteEncoderConfigurationRequestT& request,
                                       const DeleteEncoderConfigurationResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteIngestConfiguration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DeleteIngestConfigurationRequestT = Model::DeleteIngestConfigurationRequest>
  Model::DeleteIngestConfigurationOutcomeCallable DeleteIngestConfigurationCallable(
      const DeleteIngestConfigurationRequestT& request) const {
    return SubmitCallable(&IvsrealtimeClient::DeleteIngestConfiguration, request);
  }

  /**
   * An Async wrapper for DeleteIngestConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteIngestConfigurationRequestT = Model::DeleteIngestConfigurationRequest>
  void DeleteIngestConfigurationAsync(const DeleteIngestConfigurationRequestT& request,
                                      const DeleteIngestConfigurationResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeletePublicKey that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeletePublicKeyRequestT = Model::DeletePublicKeyRequest>
  void DeletePublicKeyAsync(const DeletePublicKeyRequestT& request, const DeletePublicKeyResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteStorageConfigurationOutcome DeleteStorageConfiguration(
      const Model::DeleteStorageConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DeleteStorageConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteStorageConfigurationRequestT = Model::DeleteStorageConfigurationRequest>
  Model::DeleteStorageConfigurationOutcomeCallable DeleteStorageConfigurationCallable(
      const DeleteStorageConfigurationRequestT& request) const {
    return SubmitCallable(&IvsrealtimeClient::DeleteStorageConfiguration, request);
  }

  /**
   * An Async wrapper for DeleteStorageConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteStorageConfigurationRequestT = Model::DeleteStorageConfigurationRequest>
  void DeleteStorageConfigurationAsync(const DeleteStorageConfigurationRequestT& request,
                                       const DeleteStorageConfigurationResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DisconnectParticipant that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DisconnectParticipant that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisconnectParticipantRequestT = Model::DisconnectParticipantRequest>
  void DisconnectParticipantAsync(const DisconnectParticipantRequestT& request, const DisconnectParticipantResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetComposition that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetCompositionRequestT = Model::GetCompositionRequest>
  void GetCompositionAsync(const GetCompositionRequestT& request, const GetCompositionResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetEncoderConfiguration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetEncoderConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetEncoderConfigurationRequestT = Model::GetEncoderConfigurationRequest>
  void GetEncoderConfigurationAsync(const GetEncoderConfigurationRequestT& request,
                                    const GetEncoderConfigurationResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetIngestConfiguration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetIngestConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetIngestConfigurationRequestT = Model::GetIngestConfigurationRequest>
  void GetIngestConfigurationAsync(const GetIngestConfigurationRequestT& request,
                                   const GetIngestConfigurationResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetParticipant that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetParticipantRequestT = Model::GetParticipantRequest>
  void GetParticipantAsync(const GetParticipantRequestT& request, const GetParticipantResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetStageSession that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetStageSessionRequestT = Model::GetStageSessionRequest>
  void GetStageSessionAsync(const GetStageSessionRequestT& request, const GetStageSessionResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetStorageConfiguration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetStorageConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetStorageConfigurationRequestT = Model::GetStorageConfigurationRequest>
  void GetStorageConfigurationAsync(const GetStorageConfigurationRequestT& request,
                                    const GetStorageConfigurationResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ImportPublicKey that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ImportPublicKeyRequestT = Model::ImportPublicKeyRequest>
  void ImportPublicKeyAsync(const ImportPublicKeyRequestT& request, const ImportPublicKeyResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListCompositions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListCompositions that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListCompositionsRequestT = Model::ListCompositionsRequest>
  void ListCompositionsAsync(const ListCompositionsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const ListCompositionsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListEncoderConfigurationsOutcome ListEncoderConfigurations(
      const Model::ListEncoderConfigurationsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListEncoderConfigurations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListEncoderConfigurationsRequestT = Model::ListEncoderConfigurationsRequest>
  Model::ListEncoderConfigurationsOutcomeCallable ListEncoderConfigurationsCallable(
      const ListEncoderConfigurationsRequestT& request = {}) const {
    return SubmitCallable(&IvsrealtimeClient::ListEncoderConfigurations, request);
  }

  /**
   * An Async wrapper for ListEncoderConfigurations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListEncoderConfigurationsRequestT = Model::ListEncoderConfigurationsRequest>
  void ListEncoderConfigurationsAsync(const ListEncoderConfigurationsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const ListEncoderConfigurationsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListIngestConfigurations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListIngestConfigurationsRequestT = Model::ListIngestConfigurationsRequest>
  Model::ListIngestConfigurationsOutcomeCallable ListIngestConfigurationsCallable(
      const ListIngestConfigurationsRequestT& request = {}) const {
    return SubmitCallable(&IvsrealtimeClient::ListIngestConfigurations, request);
  }

  /**
   * An Async wrapper for ListIngestConfigurations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListIngestConfigurationsRequestT = Model::ListIngestConfigurationsRequest>
  void ListIngestConfigurationsAsync(const ListIngestConfigurationsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const ListIngestConfigurationsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListParticipantEvents that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListParticipantEvents that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListParticipantEventsRequestT = Model::ListParticipantEventsRequest>
  void ListParticipantEventsAsync(const ListParticipantEventsRequestT& request, const ListParticipantEventsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListParticipantReplicas that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListParticipantReplicas that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListParticipantReplicasRequestT = Model::ListParticipantReplicasRequest>
  void ListParticipantReplicasAsync(const ListParticipantReplicasRequestT& request,
                                    const ListParticipantReplicasResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListParticipants that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListParticipants that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListParticipantsRequestT = Model::ListParticipantsRequest>
  void ListParticipantsAsync(const ListParticipantsRequestT& request, const ListParticipantsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListStageSessions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListStageSessions that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListStageSessionsRequestT = Model::ListStageSessionsRequest>
  void ListStageSessionsAsync(const ListStageSessionsRequestT& request, const ListStageSessionsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListStages that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListStagesRequestT = Model::ListStagesRequest>
  void ListStagesAsync(const ListStagesResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                       const ListStagesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListStorageConfigurationsOutcome ListStorageConfigurations(
      const Model::ListStorageConfigurationsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListStorageConfigurations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListStorageConfigurationsRequestT = Model::ListStorageConfigurationsRequest>
  Model::ListStorageConfigurationsOutcomeCallable ListStorageConfigurationsCallable(
      const ListStorageConfigurationsRequestT& request = {}) const {
    return SubmitCallable(&IvsrealtimeClient::ListStorageConfigurations, request);
  }

  /**
   * An Async wrapper for ListStorageConfigurations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListStorageConfigurationsRequestT = Model::ListStorageConfigurationsRequest>
  void ListStorageConfigurationsAsync(const ListStorageConfigurationsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const ListStorageConfigurationsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for StartComposition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartComposition that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StartCompositionRequestT = Model::StartCompositionRequest>
  void StartCompositionAsync(const StartCompositionRequestT& request, const StartCompositionResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartParticipantReplicationOutcome StartParticipantReplication(
      const Model::StartParticipantReplicationRequest& request) const;

  /**
   * A Callable wrapper for StartParticipantReplication that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename StartParticipantReplicationRequestT = Model::StartParticipantReplicationRequest>
  Model::StartParticipantReplicationOutcomeCallable StartParticipantReplicationCallable(
      const StartParticipantReplicationRequestT& request) const {
    return SubmitCallable(&IvsrealtimeClient::StartParticipantReplication, request);
  }

  /**
   * An Async wrapper for StartParticipantReplication that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartParticipantReplicationRequestT = Model::StartParticipantReplicationRequest>
  void StartParticipantReplicationAsync(const StartParticipantReplicationRequestT& request,
                                        const StartParticipantReplicationResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StopComposition that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StopCompositionRequestT = Model::StopCompositionRequest>
  void StopCompositionAsync(const StopCompositionRequestT& request, const StopCompositionResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StopParticipantReplicationOutcome StopParticipantReplication(
      const Model::StopParticipantReplicationRequest& request) const;

  /**
   * A Callable wrapper for StopParticipantReplication that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename StopParticipantReplicationRequestT = Model::StopParticipantReplicationRequest>
  Model::StopParticipantReplicationOutcomeCallable StopParticipantReplicationCallable(
      const StopParticipantReplicationRequestT& request) const {
    return SubmitCallable(&IvsrealtimeClient::StopParticipantReplication, request);
  }

  /**
   * An Async wrapper for StopParticipantReplication that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StopParticipantReplicationRequestT = Model::StopParticipantReplicationRequest>
  void StopParticipantReplicationAsync(const StopParticipantReplicationRequestT& request,
                                       const StopParticipantReplicationResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateIngestConfiguration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename UpdateIngestConfigurationRequestT = Model::UpdateIngestConfigurationRequest>
  Model::UpdateIngestConfigurationOutcomeCallable UpdateIngestConfigurationCallable(
      const UpdateIngestConfigurationRequestT& request) const {
    return SubmitCallable(&IvsrealtimeClient::UpdateIngestConfiguration, request);
  }

  /**
   * An Async wrapper for UpdateIngestConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateIngestConfigurationRequestT = Model::UpdateIngestConfigurationRequest>
  void UpdateIngestConfigurationAsync(const UpdateIngestConfigurationRequestT& request,
                                      const UpdateIngestConfigurationResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
