...
class ListEncoderConfigurationsRequest : public IvsrealtimeRequest {
 public:
  AWS_IVSREALTIME_API ListEncoderConfigurationsRequest() = default;
  ...
  template <typename NextTokenT = Aws::String>
  ListEncoderConfigurationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListEncoderConfigurationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
