...
class S3DestinationConfiguration {
 public:
  ...
  void SetStorageConfigurationArn(StorageConfigurationArnT&& value) {
    m_storageConfigurationArnHasBeenSet = true;
    m_storageConfigurationArn = std::forward<StorageConfigurationArnT>(value);
  }
  template <typename StorageConfigurationArnT = Aws::String>
  S3DestinationConfiguration& WithStorageConfigurationArn(StorageConfigurationArnT&& value) {
    SetStorageConfigurationArn(std::forward<StorageConfigurationArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEncoderConfigurationArns(EncoderConfigurationArnsT&& value) {
    m_encoderConfigurationArnsHasBeenSet = true;
    m_encoderConfigurationArns = std::forward<EncoderConfigurationArnsT>(value);
  }
  template <typename EncoderConfigurationArnsT = Aws::Vector<Aws::String>>
  S3DestinationConfiguration& WithEncoderConfigurationArns(EncoderConfigurationArnsT&& value) {
    SetEncoderConfigurationArns(std::forward<EncoderConfigurationArnsT>(value));
    return *this;
  }
  template <typename EncoderConfigurationArnsT = Aws::String>
  S3DestinationConfiguration& AddEncoderConfigurationArns(EncoderConfigurationArnsT&& value) {
    m_encoderConfigurationArnsHasBeenSet = true;
    m_encoderConfigurationArns.emplace_back(std::forward<EncoderConfigurationArnsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RecordingConfigurationT = RecordingConfiguration>
  S3DestinationConfiguration& WithRecordingConfiguration(RecordingConfigurationT&& value) {
  ...
  void SetThumbnailConfigurations(ThumbnailConfigurationsT&& value) {
    m_thumbnailConfigurationsHasBeenSet = true;
    m_thumbnailConfigurations = std::forward<ThumbnailConfigurationsT>(value);
  }
  template <typename ThumbnailConfigurationsT = Aws::Vector<CompositionThumbnailConfiguration>>
  S3DestinationConfiguration& WithThumbnailConfigurations(ThumbnailConfigurationsT&& value) {
    SetThumbnailConfigurations(std::forward<ThumbnailConfigurationsT>(value));
    return *this;
  }
  template <typename ThumbnailConfigurationsT = CompositionThumbnailConfiguration>
  S3DestinationConfiguration& AddThumbnailConfigurations(ThumbnailConfigurationsT&& value) {
    m_thumbnailConfigurationsHasBeenSet = true;
    m_thumbnailConfigurations.emplace_back(std::forward<ThumbnailConfigurationsT>(value));
    return *this;
  }
  ///@}
 private:
