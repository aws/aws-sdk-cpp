...
class ListParticipantsRequest : public IvsrealtimeRequest {
 public:
  ...
  void SetFilterByUserId(FilterByUserIdT&& value) {
    m_filterByUserIdHasBeenSet = true;
    m_filterByUserId = std::forward<FilterByUserIdT>(value);
  }
  template <typename FilterByUserIdT = Aws::String>
  ListParticipantsRequest& WithFilterByUserId(FilterByUserIdT&& value) {
    SetFilterByUserId(std::forward<FilterByUserIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetFilterByPublished(bool value) {
    m_filterByPublishedHasBeenSet = true;
    m_filterByPublished = value;
  }
  inline ListParticipantsRequest& WithFilterByPublished(bool value) {
    SetFilterByPublished(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFilterByState(ParticipantState value) {
    m_filterByStateHasBeenSet = true;
    m_filterByState = value;
  }
  inline ListParticipantsRequest& WithFilterByState(ParticipantState value) {
  ...
  inline ListParticipantsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFilterByRecordingState(ParticipantRecordingFilterByRecordingState value) {
    m_filterByRecordingStateHasBeenSet = true;
    m_filterByRecordingState = value;
  }
  inline ListParticipantsRequest& WithFilterByRecordingState(ParticipantRecordingFilterByRecordingState value) {
    SetFilterByRecordingState(value);
    return *this;
  }
  ///@}
 private:
