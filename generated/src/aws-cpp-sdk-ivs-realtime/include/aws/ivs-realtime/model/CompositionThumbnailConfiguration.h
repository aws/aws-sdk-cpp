...
class CompositionThumbnailConfiguration {
 public:
  ...
  inline CompositionThumbnailConfiguration& WithTargetIntervalSeconds(int value) {
  ...
  inline CompositionThumbnailConfiguration& AddStorage(ThumbnailStorageType value) {
    m_storageHasBeenSet = true;
