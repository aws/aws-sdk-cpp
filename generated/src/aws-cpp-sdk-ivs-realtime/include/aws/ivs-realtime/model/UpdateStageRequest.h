...
class UpdateStageRequest : public IvsrealtimeRequest {
 public:
  ...
  template <typename ArnT = Aws::String>
  UpdateStageRequest& WithArn(ArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  UpdateStageRequest& WithName(NameT&& value) {
  ...
  template <typename AutoParticipantRecordingConfigurationT = AutoParticipantRecordingConfiguration>
  UpdateStageRequest& WithAutoParticipantRecordingConfiguration(AutoParticipantRecordingConfigurationT&& value) {
