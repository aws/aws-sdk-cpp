...
class Participant {
 public:
  ...
  inline Participant& WithState(ParticipantState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline Participant& WithPublished(bool value) {
    SetPublished(value);
    return *this;
  }
  ///@}
  ...
  void SetOsName(OsNameT&& value) {
    ...
    m_osName = std::forward<OsNameT>(value);
  }
  template <typename OsNameT = Aws::String>
  Participant& WithOsName(OsNameT&& value) {
    SetOsName(std::forward<OsNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBrowserName(BrowserNameT&& value) {
    ...
    m_browserName = std::forward<BrowserNameT>(value);
  }
  template <typename BrowserNameT = Aws::String>
  Participant& WithBrowserName(BrowserNameT&& value) {
    SetBrowserName(std::forward<BrowserNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBrowserVersion(BrowserVersionT&& value) {
    ...
    m_browserVersion = std::forward<BrowserVersionT>(value);
  }
  template <typename BrowserVersionT = Aws::String>
  Participant& WithBrowserVersion(BrowserVersionT&& value) {
    SetBrowserVersion(std::forward<BrowserVersionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRecordingS3BucketName(RecordingS3BucketNameT&& value) {
    ...
    m_recordingS3BucketName = std::forward<RecordingS3BucketNameT>(value);
  }
  template <typename RecordingS3BucketNameT = Aws::String>
  Participant& WithRecordingS3BucketName(RecordingS3BucketNameT&& value) {
    SetRecordingS3BucketName(std::forward<RecordingS3BucketNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRecordingS3Prefix(RecordingS3PrefixT&& value) {
    ...
    m_recordingS3Prefix = std::forward<RecordingS3PrefixT>(value);
  }
  template <typename RecordingS3PrefixT = Aws::String>
  Participant& WithRecordingS3Prefix(RecordingS3PrefixT&& value) {
    SetRecordingS3Prefix(std::forward<RecordingS3PrefixT>(value));
    return *this;
  }
  ///@}
  ...
  inline Participant& WithRecordingState(ParticipantRecordingState value) {
  ...
  inline void SetProtocol(ParticipantProtocol value) {
    m_protocolHasBeenSet = true;
    m_protocol = value;
  }
  inline Participant& WithProtocol(ParticipantProtocol value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
  ...
  inline Participant& WithReplicationType(ReplicationType value) {
  ...
  inline Participant& WithReplicationState(ReplicationState value) {
