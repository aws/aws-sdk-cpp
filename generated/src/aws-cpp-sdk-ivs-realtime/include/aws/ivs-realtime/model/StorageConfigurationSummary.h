...
class StorageConfigurationSummary {
 public:
  AWS_IVSREALTIME_API StorageConfigurationSummary() = default;
  ...
  template <typename ArnT = Aws::String>
  StorageConfigurationSummary& WithArn(ArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  StorageConfigurationSummary& WithName(NameT&& value) {
  ...
  template <typename S3T = S3StorageConfiguration>
  StorageConfigurationSummary& WithS3(S3T&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  StorageConfigurationSummary& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsKeyT = Aws::String, typename TagsValueT = Aws::String>
  StorageConfigurationSummary& AddTags(TagsKeyT&& key, TagsValueT&& value) {
    m_tagsHasBeenSet = true;
