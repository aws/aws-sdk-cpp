...
class ListIngestConfigurationsResult {
 public:
  ...
  void SetIngestConfigurations(IngestConfigurationsT&& value) {
    ...
    m_ingestConfigurations = std::forward<IngestConfigurationsT>(value);
  }
  template <typename IngestConfigurationsT = Aws::Vector<IngestConfigurationSummary>>
  ListIngestConfigurationsResult& WithIngestConfigurations(IngestConfigurationsT&& value) {
    SetIngestConfigurations(std::forward<IngestConfigurationsT>(value));
    return *this;
  }
  template <typename IngestConfigurationsT = IngestConfigurationSummary>
  ListIngestConfigurationsResult& AddIngestConfigurations(IngestConfigurationsT&& value) {
    m_ingestConfigurationsHasBeenSet = true;
    m_ingestConfigurations.emplace_back(std::forward<IngestConfigurationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListIngestConfigurationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListIngestConfigurationsResult& WithRequestId(RequestIdT&& value) {
