...
namespace Model
{
  ...
  /**
   */
  class UntagResourceRequest : public IvsrealtimeRequest
  {
  public:
    AWS_IVSREALTIME_API UntagResourceRequest() = default;
    ...
    AWS_IVSREALTIME_API void AddQueryStringParameters(Aws::Http::URI& uri) const override;
