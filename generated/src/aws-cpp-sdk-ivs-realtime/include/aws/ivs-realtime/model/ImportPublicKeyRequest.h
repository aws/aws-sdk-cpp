...
namespace Model
{
  ...
  public:
    ...
    template<typename PublicKeyMaterialT = Aws::String>
    ImportPublicKeyRequest& WithPublicKeyMaterial(PublicKeyMaterialT&& value) { SetPublicKeyMaterial(std::forward<PublicKeyMaterialT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    ImportPublicKeyRequest& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename TagsT = Aws::Map<Aws::String, Aws::String>>
    ImportPublicKeyRequest& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
