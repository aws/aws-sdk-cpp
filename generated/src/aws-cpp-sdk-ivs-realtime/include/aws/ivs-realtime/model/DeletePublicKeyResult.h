...
namespace Model
{
  ...
  {
  public:
    AWS_IVSREALTIME_API DeletePublicKeyResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeletePublicKeyResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
