...
class ListCompositionsRequest : public IvsrealtimeRequest {
 public:
  ...
  void SetFilterByStageArn(FilterByStageArnT&& value) {
    m_filterByStageArnHasBeenSet = true;
    m_filterByStageArn = std::forward<FilterByStageArnT>(value);
  }
  template <typename FilterByStageArnT = Aws::String>
  ListCompositionsRequest& WithFilterByStageArn(FilterByStageArnT&& value) {
    SetFilterByStageArn(std::forward<FilterByStageArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFilterByEncoderConfigurationArn(FilterByEncoderConfigurationArnT&& value) {
    m_filterByEncoderConfigurationArnHasBeenSet = true;
    m_filterByEncoderConfigurationArn = std::forward<FilterByEncoderConfigurationArnT>(value);
  }
  template <typename FilterByEncoderConfigurationArnT = Aws::String>
  ListCompositionsRequest& WithFilterByEncoderConfigurationArn(FilterByEncoderConfigurationArnT&& value) {
    SetFilterByEncoderConfigurationArn(std::forward<FilterByEncoderConfigurationArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListCompositionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListCompositionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
