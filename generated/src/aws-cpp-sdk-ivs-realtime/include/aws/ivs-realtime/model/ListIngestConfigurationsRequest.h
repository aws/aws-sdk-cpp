...
class ListIngestConfigurationsRequest : public IvsrealtimeRequest {
 public:
  ...
  inline void SetFilterByState(IngestConfigurationState value) {
    m_filterByStateHasBeenSet = true;
    m_filterByState = value;
  }
  inline ListIngestConfigurationsRequest& WithFilterByState(IngestConfigurationState value) {
  ...
  inline ListIngestConfigurationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
