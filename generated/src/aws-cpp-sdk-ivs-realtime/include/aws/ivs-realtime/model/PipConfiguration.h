...
class PipConfiguration {
 public:
  ...
  void SetFeaturedParticipantAttribute(FeaturedParticipantAttributeT&& value) {
    ...
    m_featuredParticipantAttribute = std::forward<FeaturedParticipantAttributeT>(value);
  }
  template <typename FeaturedParticipantAttributeT = Aws::String>
  PipConfiguration& WithFeaturedParticipantAttribute(FeaturedParticipantAttributeT&& value) {
    SetFeaturedParticipantAttribute(std::forward<FeaturedParticipantAttributeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetOmitStoppedVideo(bool value) {
    m_omitStoppedVideoHasBeenSet = true;
    m_omitStoppedVideo = value;
  }
  inline PipConfiguration& WithOmitStoppedVideo(bool value) {
    SetOmitStoppedVideo(value);
    return *this;
  }
  ///@}
  ...
  inline void SetVideoFillMode(VideoFillMode value) {
    m_videoFillModeHasBeenSet = true;
    m_videoFillMode = value;
  }
  inline PipConfiguration& WithVideoFillMode(VideoFillMode value) {
    SetVideoFillMode(value);
    return *this;
  }
  ///@}
  ...
  inline void SetGridGap(int value) {
    m_gridGapHasBeenSet = true;
    m_gridGap = value;
  }
  inline PipConfiguration& WithGridGap(int value) {
    SetGridGap(value);
    return *this;
  }
  ///@}
  ...
  void SetPipParticipantAttribute(PipParticipantAttributeT&& value) {
    ...
    m_pipParticipantAttribute = std::forward<PipParticipantAttributeT>(value);
  }
  template <typename PipParticipantAttributeT = Aws::String>
  PipConfiguration& WithPipParticipantAttribute(PipParticipantAttributeT&& value) {
    SetPipParticipantAttribute(std::forward<PipParticipantAttributeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetPipBehavior(PipBehavior value) {
    m_pipBehaviorHasBeenSet = true;
    m_pipBehavior = value;
  }
  inline PipConfiguration& WithPipBehavior(PipBehavior value) {
    SetPipBehavior(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPipOffset(int value) {
    m_pipOffsetHasBeenSet = true;
    m_pipOffset = value;
  }
  inline PipConfiguration& WithPipOffset(int value) {
    SetPipOffset(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPipPosition(PipPosition value) {
    m_pipPositionHasBeenSet = true;
    m_pipPosition = value;
  }
  inline PipConfiguration& WithPipPosition(PipPosition value) {
  ...
  inline void SetPipWidth(int value) {
    m_pipWidthHasBeenSet = true;
    m_pipWidth = value;
  }
  inline PipConfiguration& WithPipWidth(int value) {
    SetPipWidth(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPipHeight(int value) {
    m_pipHeightHasBeenSet = true;
    m_pipHeight = value;
  }
  inline PipConfiguration& WithPipHeight(int value) {
    SetPipHeight(value);
    return *this;
  }
  ///@}
  ...
  void SetParticipantOrderAttribute(ParticipantOrderAttributeT&& value) {
    ...
    m_participantOrderAttribute = std::forward<ParticipantOrderAttributeT>(value);
  }
  template <typename ParticipantOrderAttributeT = Aws::String>
  PipConfiguration& WithParticipantOrderAttribute(ParticipantOrderAttributeT&& value) {
    SetParticipantOrderAttribute(std::forward<ParticipantOrderAttributeT>(value));
    return *this;
  }
  ///@}
 private:
