...
namespace Model
{
  ...
  {
  public:
    AWS_IVSREALTIME_API DeleteEncoderConfigurationRequest() = default;
    ...
    template<typename ArnT = Aws::String>
    DeleteEncoderConfigurationRequest& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
  private:
