...
class StageSummary {
 public:
  AWS_IVSREALTIME_API StageSummary() = default;
  ...
  template <typename ArnT = Aws::String>
  StageSummary& WithArn(ArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  StageSummary& WithName(NameT&& value) {
  ...
  template <typename ActiveSessionIdT = Aws::String>
  StageSummary& WithActiveSessionId(ActiveSessionIdT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  StageSummary& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsKeyT = Aws::String, typename TagsValueT = Aws::String>
  StageSummary& AddTags(TagsKeyT&& key, TagsValueT&& value) {
    m_tagsHasBeenSet = true;
