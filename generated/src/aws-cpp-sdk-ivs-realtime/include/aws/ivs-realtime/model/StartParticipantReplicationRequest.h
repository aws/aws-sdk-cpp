...
class StartParticipantReplicationRequest : public IvsrealtimeRequest {
 public:
  ...
  inline void SetReconnectWindowSeconds(int value) {
    m_reconnectWindowSecondsHasBeenSet = true;
    m_reconnectWindowSeconds = value;
  }
  inline StartParticipantReplicationRequest& WithReconnectWindowSeconds(int value) {
    SetReconnectWindowSeconds(value);
    return *this;
  }
  ///@}
