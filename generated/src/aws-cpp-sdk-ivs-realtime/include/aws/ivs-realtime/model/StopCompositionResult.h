...
namespace Model
{
  ...
  {
  public:
    AWS_IVSREALTIME_API StopCompositionResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    StopCompositionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
