...
class ListStageSessionsResult {
 public:
  ...
  void SetStageSessions(StageSessionsT&& value) {
    m_stageSessionsHasBeenSet = true;
    m_stageSessions = std::forward<StageSessionsT>(value);
  }
  template <typename StageSessionsT = Aws::Vector<StageSessionSummary>>
  ListStageSessionsResult& WithStageSessions(StageSessionsT&& value) {
    SetStageSessions(std::forward<StageSessionsT>(value));
    return *this;
  }
  template <typename StageSessionsT = StageSessionSummary>
  ListStageSessionsResult& AddStageSessions(StageSessionsT&& value) {
    m_stageSessionsHasBeenSet = true;
    m_stageSessions.emplace_back(std::forward<StageSessionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListStageSessionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListStageSessionsResult& WithRequestId(RequestIdT&& value) {
