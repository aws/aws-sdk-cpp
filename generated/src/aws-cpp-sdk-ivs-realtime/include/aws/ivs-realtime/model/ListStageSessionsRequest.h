...
class ListStageSessionsRequest : public IvsrealtimeRequest {
 public:
  ...
  template <typename StageArnT = Aws::String>
  ListStageSessionsRequest& WithStageArn(StageArnT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListStageSessionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListStageSessionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
