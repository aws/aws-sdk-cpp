...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/ivs-realtime-2020-07-14/PendingVerification">AWS
   * API Reference</a></p>
   */
  class PendingVerification
  {
  public:
    AWS_IVSREALTIME_API PendingVerification();
    AWS_IVSREALTIME_API PendingVerification(Aws::Utils::Json::JsonView jsonValue);
    AWS_IVSREALTIME_API PendingVerification& operator=(Aws::Utils::Json::JsonView jsonValue);
    ...
    inline PendingVerification& WithAccessControlAllowOrigin(const Aws::String& value) { SetAccessControlAllowOrigin(value); return *this;}
    inline PendingVerification& WithAccessControlAllowOrigin(Aws::String&& value) { SetAccessControlAllowOrigin(std::move(value)); return *this;}
    inline PendingVerification& WithAccessControlAllowOrigin(const char* value) { SetAccessControlAllowOrigin(value); return *this;}
    ///@}
    ...
    inline PendingVerification& WithAccessControlExposeHeaders(const Aws::String& value) { SetAccessControlExposeHeaders(value); return *this;}
    inline PendingVerification& WithAccessControlExposeHeaders(Aws::String&& value) { SetAccessControlExposeHeaders(std::move(value)); return *this;}
    inline PendingVerification& WithAccessControlExposeHeaders(const char* value) { SetAccessControlExposeHeaders(value); return *this;}
    ///@}
    ...
    inline PendingVerification& WithCacheControl(const Aws::String& value) { SetCacheControl(value); return *this;}
    inline PendingVerification& WithCacheControl(Aws::String&& value) { SetCacheControl(std::move(value)); return *this;}
    inline PendingVerification& WithCacheControl(const char* value) { SetCacheControl(value); return *this;}
    ///@}
    ...
    inline PendingVerification& WithContentSecurityPolicy(const Aws::String& value) { SetContentSecurityPolicy(value); return *this;}
    inline PendingVerification& WithContentSecurityPolicy(Aws::String&& value) { SetContentSecurityPolicy(std::move(value)); return *this;}
    inline PendingVerification& WithContentSecurityPolicy(const char* value) { SetContentSecurityPolicy(value); return *this;}
    ///@}
    ...
    inline PendingVerification& WithStrictTransportSecurity(const Aws::String& value) { SetStrictTransportSecurity(value); return *this;}
    inline PendingVerification& WithStrictTransportSecurity(Aws::String&& value) { SetStrictTransportSecurity(std::move(value)); return *this;}
    inline PendingVerification& WithStrictTransportSecurity(const char* value) { SetStrictTransportSecurity(value); return *this;}
    ///@}
    ...
    inline PendingVerification& WithXContentTypeOptions(const Aws::String& value) { SetXContentTypeOptions(value); return *this;}
    inline PendingVerification& WithXContentTypeOptions(Aws::String&& value) { SetXContentTypeOptions(std::move(value)); return *this;}
    inline PendingVerification& WithXContentTypeOptions(const char* value) { SetXContentTypeOptions(value); return *this;}
    ///@}
    ...
    inline PendingVerification& WithXFrameOptions(const Aws::String& value) { SetXFrameOptions(value); return *this;}
    inline PendingVerification& WithXFrameOptions(Aws::String&& value) { SetXFrameOptions(std::move(value)); return *this;}
    inline PendingVerification& WithXFrameOptions(const char* value) { SetXFrameOptions(value); return *this;}
    ///@}
    ...
    inline PendingVerification& WithXAmznErrorType(const Aws::String& value) { SetXAmznErrorType(value); return *this;}
    inline PendingVerification& WithXAmznErrorType(Aws::String&& value) { SetXAmznErrorType(std::move(value)); return *this;}
    inline PendingVerification& WithXAmznErrorType(const char* value) { SetXAmznErrorType(value); return *this;}
    ///@}
