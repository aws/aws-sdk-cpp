...
namespace Model
{
  ...
  {
  public:
    AWS_IVSREALTIME_API PendingVerification() = default;
    ...
    template<typename AccessControlAllowOriginT = Aws::String>
    PendingVerification& WithAccessControlAllowOrigin(AccessControlAllowOriginT&& value) { SetAccessControlAllowOrigin(std::forward<AccessControlAllowOriginT>(value)); return *this;}
    ///@}
    ...
    template<typename AccessControlExposeHeadersT = Aws::String>
    PendingVerification& WithAccessControlExposeHeaders(AccessControlExposeHeadersT&& value) { SetAccessControlExposeHeaders(std::forward<AccessControlExposeHeadersT>(value)); return *this;}
    ///@}
    ...
    template<typename CacheControlT = Aws::String>
    PendingVerification& WithCacheControl(CacheControlT&& value) { SetCacheControl(std::forward<CacheControlT>(value)); return *this;}
    ///@}
    ...
    template<typename ContentSecurityPolicyT = Aws::String>
    PendingVerification& WithContentSecurityPolicy(ContentSecurityPolicyT&& value) { SetContentSecurityPolicy(std::forward<ContentSecurityPolicyT>(value)); return *this;}
    ///@}
    ...
    template<typename StrictTransportSecurityT = Aws::String>
    PendingVerification& WithStrictTransportSecurity(StrictTransportSecurityT&& value) { SetStrictTransportSecurity(std::forward<StrictTransportSecurityT>(value)); return *this;}
    ///@}
    ...
    template<typename XContentTypeOptionsT = Aws::String>
    PendingVerification& WithXContentTypeOptions(XContentTypeOptionsT&& value) { SetXContentTypeOptions(std::forward<XContentTypeOptionsT>(value)); return *this;}
    ///@}
    ...
    template<typename XFrameOptionsT = Aws::String>
    PendingVerification& WithXFrameOptions(XFrameOptionsT&& value) { SetXFrameOptions(std::forward<XFrameOptionsT>(value)); return *this;}
    ///@}
    ...
    template<typename XAmznErrorTypeT = Aws::String>
    PendingVerification& WithXAmznErrorType(XAmznErrorTypeT&& value) { SetXAmznErrorType(std::forward<XAmznErrorTypeT>(value)); return *this;}
    ///@}
