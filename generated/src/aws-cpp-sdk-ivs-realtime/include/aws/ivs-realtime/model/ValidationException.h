...
namespace Model
{
  ...
  public:
    ...
    template<typename AccessControlAllowOriginT = Aws::String>
    ValidationException& WithAccessControlAllowOrigin(AccessControlAllowOriginT&& value) { SetAccessControlAllowOrigin(std::forward<AccessControlAllowOriginT>(value)); return *this;}
    ///@}
    ...
    template<typename AccessControlExposeHeadersT = Aws::String>
    ValidationException& WithAccessControlExposeHeaders(AccessControlExposeHeadersT&& value) { SetAccessControlExposeHeaders(std::forward<AccessControlExposeHeadersT>(value)); return *this;}
    ///@}
    ...
    template<typename CacheControlT = Aws::String>
    ValidationException& WithCacheControl(CacheControlT&& value) { SetCacheControl(std::forward<CacheControlT>(value)); return *this;}
    ///@}
    ...
    template<typename ContentSecurityPolicyT = Aws::String>
    ValidationException& WithContentSecurityPolicy(ContentSecurityPolicyT&& value) { SetContentSecurityPolicy(std::forward<ContentSecurityPolicyT>(value)); return *this;}
    ///@}
    ...
    template<typename StrictTransportSecurityT = Aws::String>
    ValidationException& WithStrictTransportSecurity(StrictTransportSecurityT&& value) { SetStrictTransportSecurity(std::forward<StrictTransportSecurityT>(value)); return *this;}
    ///@}
    ...
    template<typename XContentTypeOptionsT = Aws::String>
    ValidationException& WithXContentTypeOptions(XContentTypeOptionsT&& value) { SetXContentTypeOptions(std::forward<XContentTypeOptionsT>(value)); return *this;}
    ///@}
    ...
    template<typename XFrameOptionsT = Aws::String>
    ValidationException& WithXFrameOptions(XFrameOptionsT&& value) { SetXFrameOptions(std::forward<XFrameOptionsT>(value)); return *this;}
    ///@}
    ...
    template<typename XAmznErrorTypeT = Aws::String>
    ValidationException& WithXAmznErrorType(XAmznErrorTypeT&& value) { SetXAmznErrorType(std::forward<XAmznErrorTypeT>(value)); return *this;}
    ///@}
