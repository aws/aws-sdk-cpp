...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/ivs-realtime-2020-07-14/ConflictException">AWS
   * API Reference</a></p>
   */
  class ConflictException
  {
  public:
    AWS_IVSREALTIME_API ConflictException();
    AWS_IVSREALTIME_API ConflictException(Aws::Utils::Json::JsonView jsonValue);
    AWS_IVSREALTIME_API ConflictException& operator=(Aws::Utils::Json::JsonView jsonValue);
    ...
    inline ConflictException& WithAccessControlAllowOrigin(const Aws::String& value) { SetAccessControlAllowOrigin(value); return *this;}
    inline ConflictException& WithAccessControlAllowOrigin(Aws::String&& value) { SetAccessControlAllowOrigin(std::move(value)); return *this;}
    inline ConflictException& WithAccessControlAllowOrigin(const char* value) { SetAccessControlAllowOrigin(value); return *this;}
    ///@}
    ...
    inline ConflictException& WithAccessControlExposeHeaders(const Aws::String& value) { SetAccessControlExposeHeaders(value); return *this;}
    inline ConflictException& WithAccessControlExposeHeaders(Aws::String&& value) { SetAccessControlExposeHeaders(std::move(value)); return *this;}
    inline ConflictException& WithAccessControlExposeHeaders(const char* value) { SetAccessControlExposeHeaders(value); return *this;}
    ///@}
    ...
    inline ConflictException& WithCacheControl(const Aws::String& value) { SetCacheControl(value); return *this;}
    inline ConflictException& WithCacheControl(Aws::String&& value) { SetCacheControl(std::move(value)); return *this;}
    inline ConflictException& WithCacheControl(const char* value) { SetCacheControl(value); return *this;}
    ///@}
    ...
    inline ConflictException& WithContentSecurityPolicy(const Aws::String& value) { SetContentSecurityPolicy(value); return *this;}
    inline ConflictException& WithContentSecurityPolicy(Aws::String&& value) { SetContentSecurityPolicy(std::move(value)); return *this;}
    inline ConflictException& WithContentSecurityPolicy(const char* value) { SetContentSecurityPolicy(value); return *this;}
    ///@}
    ...
    inline ConflictException& WithStrictTransportSecurity(const Aws::String& value) { SetStrictTransportSecurity(value); return *this;}
    inline ConflictException& WithStrictTransportSecurity(Aws::String&& value) { SetStrictTransportSecurity(std::move(value)); return *this;}
    inline ConflictException& WithStrictTransportSecurity(const char* value) { SetStrictTransportSecurity(value); return *this;}
    ///@}
    ...
    inline ConflictException& WithXContentTypeOptions(const Aws::String& value) { SetXContentTypeOptions(value); return *this;}
    inline ConflictException& WithXContentTypeOptions(Aws::String&& value) { SetXContentTypeOptions(std::move(value)); return *this;}
    inline ConflictException& WithXContentTypeOptions(const char* value) { SetXContentTypeOptions(value); return *this;}
    ///@}
    ...
    inline ConflictException& WithXFrameOptions(const Aws::String& value) { SetXFrameOptions(value); return *this;}
    inline ConflictException& WithXFrameOptions(Aws::String&& value) { SetXFrameOptions(std::move(value)); return *this;}
    inline ConflictException& WithXFrameOptions(const char* value) { SetXFrameOptions(value); return *this;}
    ///@}
    ...
    inline ConflictException& WithXAmznErrorType(const Aws::String& value) { SetXAmznErrorType(value); return *this;}
    inline ConflictException& WithXAmznErrorType(Aws::String&& value) { SetXAmznErrorType(std::move(value)); return *this;}
    inline ConflictException& WithXAmznErrorType(const char* value) { SetXAmznErrorType(value); return *this;}
    ///@}
