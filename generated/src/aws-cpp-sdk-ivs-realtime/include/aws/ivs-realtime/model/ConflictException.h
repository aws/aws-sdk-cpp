...
namespace Model
{
  ...
  {
  public:
    AWS_IVSREALTIME_API ConflictException() = default;
    ...
    template<typename AccessControlAllowOriginT = Aws::String>
    ConflictException& WithAccessControlAllowOrigin(AccessControlAllowOriginT&& value) { SetAccessControlAllowOrigin(std::forward<AccessControlAllowOriginT>(value)); return *this;}
    ///@}
    ...
    template<typename AccessControlExposeHeadersT = Aws::String>
    ConflictException& WithAccessControlExposeHeaders(AccessControlExposeHeadersT&& value) { SetAccessControlExposeHeaders(std::forward<AccessControlExposeHeadersT>(value)); return *this;}
    ///@}
    ...
    template<typename CacheControlT = Aws::String>
    ConflictException& WithCacheControl(CacheControlT&& value) { SetCacheControl(std::forward<CacheControlT>(value)); return *this;}
    ///@}
    ...
    template<typename ContentSecurityPolicyT = Aws::String>
    ConflictException& WithContentSecurityPolicy(ContentSecurityPolicyT&& value) { SetContentSecurityPolicy(std::forward<ContentSecurityPolicyT>(value)); return *this;}
    ///@}
    ...
    template<typename StrictTransportSecurityT = Aws::String>
    ConflictException& WithStrictTransportSecurity(StrictTransportSecurityT&& value) { SetStrictTransportSecurity(std::forward<StrictTransportSecurityT>(value)); return *this;}
    ///@}
    ...
    template<typename XContentTypeOptionsT = Aws::String>
    ConflictException& WithXContentTypeOptions(XContentTypeOptionsT&& value) { SetXContentTypeOptions(std::forward<XContentTypeOptionsT>(value)); return *this;}
    ///@}
    ...
    template<typename XFrameOptionsT = Aws::String>
    ConflictException& WithXFrameOptions(XFrameOptionsT&& value) { SetXFrameOptions(std::forward<XFrameOptionsT>(value)); return *this;}
    ///@}
    ...
    template<typename XAmznErrorTypeT = Aws::String>
    ConflictException& WithXAmznErrorType(XAmznErrorTypeT&& value) { SetXAmznErrorType(std::forward<XAmznErrorTypeT>(value)); return *this;}
    ///@}
