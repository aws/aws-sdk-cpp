...
class ParticipantSummary {
 public:
  ...
  inline void SetState(ParticipantState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline ParticipantSummary& WithState(ParticipantState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  void SetFirstJoinTime(FirstJoinTimeT&& value) {
    ...
    m_firstJoinTime = std::forward<FirstJoinTimeT>(value);
  }
  template <typename FirstJoinTimeT = Aws::Utils::DateTime>
  ParticipantSummary& WithFirstJoinTime(FirstJoinTimeT&& value) {
    SetFirstJoinTime(std::forward<FirstJoinTimeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetPublished(bool value) {
    m_publishedHasBeenSet = true;
    m_published = value;
  }
  inline ParticipantSummary& WithPublished(bool value) {
    SetPublished(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRecordingState(ParticipantRecordingState value) {
    m_recordingStateHasBeenSet = true;
    m_recordingState = value;
  }
  inline ParticipantSummary& WithRecordingState(ParticipantRecordingState value) {
  ...
  inline ParticipantSummary& WithReplicationType(ReplicationType value) {
  ...
  inline ParticipantSummary& WithReplicationState(ReplicationState value) {
  ...
  void SetSourceStageArn(SourceStageArnT&& value) {
    ...
    m_sourceStageArn = std::forward<SourceStageArnT>(value);
  }
  template <typename SourceStageArnT = Aws::String>
  ParticipantSummary& WithSourceStageArn(SourceStageArnT&& value) {
    SetSourceStageArn(std::forward<SourceStageArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSourceSessionId(SourceSessionIdT&& value) {
    ...
    m_sourceSessionId = std::forward<SourceSessionIdT>(value);
  }
  template <typename SourceSessionIdT = Aws::String>
  ParticipantSummary& WithSourceSessionId(SourceSessionIdT&& value) {
    SetSourceSessionId(std::forward<SourceSessionIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline ParticipantSummary& WithRedundantIngest(bool value) {
