...
class StageEndpoints {
 public:
  ...
  template <typename EventsT = Aws::String>
  StageEndpoints& WithEvents(EventsT&& value) {
  ...
  void SetWhip(WhipT&& value) {
    m_whipHasBeenSet = true;
    m_whip = std::forward<WhipT>(value);
  }
  template <typename WhipT = Aws::String>
  StageEndpoints& WithWhip(WhipT&& value) {
    SetWhip(std::forward<WhipT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRtmp(RtmpT&& value) {
    m_rtmpHasBeenSet = true;
    m_rtmp = std::forward<RtmpT>(value);
  }
  template <typename RtmpT = Aws::String>
  StageEndpoints& WithRtmp(RtmpT&& value) {
    SetRtmp(std::forward<RtmpT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRtmps(RtmpsT&& value) {
    m_rtmpsHasBeenSet = true;
    m_rtmps = std::forward<RtmpsT>(value);
  }
  template <typename RtmpsT = Aws::String>
  StageEndpoints& WithRtmps(RtmpsT&& value) {
    SetRtmps(std::forward<RtmpsT>(value));
    return *this;
  }
  ///@}
 private:
