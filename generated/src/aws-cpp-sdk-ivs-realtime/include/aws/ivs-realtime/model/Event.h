...
class Event {
 public:
  ...
  inline void SetName(EventName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline Event& WithName(EventName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  void SetRemoteParticipantId(RemoteParticipantIdT&& value) {
    ...
    m_remoteParticipantId = std::forward<RemoteParticipantIdT>(value);
  }
  template <typename RemoteParticipantIdT = Aws::String>
  Event& WithRemoteParticipantId(RemoteParticipantIdT&& value) {
    SetRemoteParticipantId(std::forward<RemoteParticipantIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetErrorCode(EventErrorCode value) {
    m_errorCodeHasBeenSet = true;
    m_errorCode = value;
  }
  inline Event& WithErrorCode(EventErrorCode value) {
    SetErrorCode(value);
    return *this;
  }
  ///@}
  ...
  void SetDestinationStageArn(DestinationStageArnT&& value) {
    ...
    m_destinationStageArn = std::forward<DestinationStageArnT>(value);
  }
  template <typename DestinationStageArnT = Aws::String>
  Event& WithDestinationStageArn(DestinationStageArnT&& value) {
    SetDestinationStageArn(std::forward<DestinationStageArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDestinationSessionId(DestinationSessionIdT&& value) {
    ...
    m_destinationSessionId = std::forward<DestinationSessionIdT>(value);
  }
  template <typename DestinationSessionIdT = Aws::String>
  Event& WithDestinationSessionId(DestinationSessionIdT&& value) {
    SetDestinationSessionId(std::forward<DestinationSessionIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetReplica(bool value) {
    m_replicaHasBeenSet = true;
    m_replica = value;
  }
  inline Event& WithReplica(bool value) {
    SetReplica(value);
    return *this;
  }
  ///@}
