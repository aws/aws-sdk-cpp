...
class ParticipantThumbnailConfiguration {
 public:
  ...
  inline void SetTargetIntervalSeconds(int value) {
    m_targetIntervalSecondsHasBeenSet = true;
    m_targetIntervalSeconds = value;
  }
  inline ParticipantThumbnailConfiguration& WithTargetIntervalSeconds(int value) {
    SetTargetIntervalSeconds(value);
    return *this;
  }
  ///@}
  ...
  inline ParticipantThumbnailConfiguration& AddStorage(ThumbnailStorageType value) {
    m_storageHasBeenSet = true;
  ...
  inline void SetRecordingMode(ThumbnailRecordingMode value) {
    m_recordingModeHasBeenSet = true;
    m_recordingMode = value;
  }
  inline ParticipantThumbnailConfiguration& WithRecordingMode(ThumbnailRecordingMode value) {
