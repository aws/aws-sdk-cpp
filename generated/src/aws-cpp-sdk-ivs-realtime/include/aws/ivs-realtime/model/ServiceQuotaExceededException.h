...
namespace Model
{
  ...
  {
  public:
    AWS_IVSREALTIME_API ServiceQuotaExceededException() = default;
    ...
    template<typename AccessControlAllowOriginT = Aws::String>
    ServiceQuotaExceededException& WithAccessControlAllowOrigin(AccessControlAllowOriginT&& value) { SetAccessControlAllowOrigin(std::forward<AccessControlAllowOriginT>(value)); return *this;}
    ///@}
    ...
    template<typename AccessControlExposeHeadersT = Aws::String>
    ServiceQuotaExceededException& WithAccessControlExposeHeaders(AccessControlExposeHeadersT&& value) { SetAccessControlExposeHeaders(std::forward<AccessControlExposeHeadersT>(value)); return *this;}
    ///@}
    ...
    template<typename CacheControlT = Aws::String>
    ServiceQuotaExceededException& WithCacheControl(CacheControlT&& value) { SetCacheControl(std::forward<CacheControlT>(value)); return *this;}
    ///@}
    ...
    template<typename ContentSecurityPolicyT = Aws::String>
    ServiceQuotaExceededException& WithContentSecurityPolicy(ContentSecurityPolicyT&& value) { SetContentSecurityPolicy(std::forward<ContentSecurityPolicyT>(value)); return *this;}
    ///@}
    ...
    template<typename StrictTransportSecurityT = Aws::String>
    ServiceQuotaExceededException& WithStrictTransportSecurity(StrictTransportSecurityT&& value) { SetStrictTransportSecurity(std::forward<StrictTransportSecurityT>(value)); return *this;}
    ///@}
    ...
    template<typename XContentTypeOptionsT = Aws::String>
    ServiceQuotaExceededException& WithXContentTypeOptions(XContentTypeOptionsT&& value) { SetXContentTypeOptions(std::forward<XContentTypeOptionsT>(value)); return *this;}
    ///@}
    ...
    template<typename XFrameOptionsT = Aws::String>
    ServiceQuotaExceededException& WithXFrameOptions(XFrameOptionsT&& value) { SetXFrameOptions(std::forward<XFrameOptionsT>(value)); return *this;}
    ///@}
    ...
    template<typename XAmznErrorTypeT = Aws::String>
    ServiceQuotaExceededException& WithXAmznErrorType(XAmznErrorTypeT&& value) { SetXAmznErrorType(std::forward<XAmznErrorTypeT>(value)); return *this;}
    ///@}
