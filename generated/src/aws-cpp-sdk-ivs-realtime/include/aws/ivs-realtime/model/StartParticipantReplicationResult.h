...
namespace Model
{
  class StartParticipantReplicationResult
  {
  public:
    ...
    template<typename AccessControlAllowOriginT = Aws::String>
    StartParticipantReplicationResult& WithAccessControlAllowOrigin(AccessControlAllowOriginT&& value) { SetAccessControlAllowOrigin(std::forward<AccessControlAllowOriginT>(value)); return *this;}
    ///@}
    ...
    template<typename AccessControlExposeHeadersT = Aws::String>
    StartParticipantReplicationResult& WithAccessControlExposeHeaders(AccessControlExposeHeadersT&& value) { SetAccessControlExposeHeaders(std::forward<AccessControlExposeHeadersT>(value)); return *this;}
    ///@}
    ...
    template<typename CacheControlT = Aws::String>
    StartParticipantReplicationResult& WithCacheControl(CacheControlT&& value) { SetCacheControl(std::forward<CacheControlT>(value)); return *this;}
    ///@}
    ...
    template<typename ContentSecurityPolicyT = Aws::String>
    StartParticipantReplicationResult& WithContentSecurityPolicy(ContentSecurityPolicyT&& value) { SetContentSecurityPolicy(std::forward<ContentSecurityPolicyT>(value)); return *this;}
    ///@}
    ...
    template<typename StrictTransportSecurityT = Aws::String>
    StartParticipantReplicationResult& WithStrictTransportSecurity(StrictTransportSecurityT&& value) { SetStrictTransportSecurity(std::forward<StrictTransportSecurityT>(value)); return *this;}
    ///@}
    ...
    template<typename XContentTypeOptionsT = Aws::String>
    StartParticipantReplicationResult& WithXContentTypeOptions(XContentTypeOptionsT&& value) { SetXContentTypeOptions(std::forward<XContentTypeOptionsT>(value)); return *this;}
    ///@}
    ...
    template<typename XFrameOptionsT = Aws::String>
    StartParticipantReplicationResult& WithXFrameOptions(XFrameOptionsT&& value) { SetXFrameOptions(std::forward<XFrameOptionsT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    StartParticipantReplicationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
