 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/ivs-realtime-2020-07-14/AccessDeniedException">AWS
 * API Reference</a></p>
 */
class AccessDeniedException {
 public:
  ...
  void SetXAmznErrorType(XAmznErrorTypeT&& value) {
    m_xAmznErrorTypeHasBeenSet = true;
    m_xAmznErrorType = std::forward<XAmznErrorTypeT>(value);
  }
  template <typename XAmznErrorTypeT = Aws::String>
  AccessDeniedException& WithXAmznErrorType(XAmznErrorTypeT&& value) {
    SetXAmznErrorType(std::forward<XAmznErrorTypeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExceptionMessage(ExceptionMessageT&& value) {
    ...
    m_exceptionMessage = std::forward<ExceptionMessageT>(value);
  }
  template <typename ExceptionMessageT = Aws::String>
  AccessDeniedException& WithExceptionMessage(ExceptionMessageT&& value) {
    SetExceptionMessage(std::forward<ExceptionMessageT>(value));
    return *this;
  }
  ///@}
 private:
