...
class UpdateIngestConfigurationResult {
 public:
  AWS_IVSREALTIME_API UpdateIngestConfigurationResult() = default;
  ...
  template <typename AccessControlAllowOriginT = Aws::String>
  UpdateIngestConfigurationResult& WithAccessControlAllowOrigin(AccessControlAllowOriginT&& value) {
  ...
  template <typename AccessControlExposeHeadersT = Aws::String>
  UpdateIngestConfigurationResult& WithAccessControlExposeHeaders(AccessControlExposeHeadersT&& value) {
  ...
  template <typename CacheControlT = Aws::String>
  UpdateIngestConfigurationResult& WithCacheControl(CacheControlT&& value) {
  ...
  template <typename ContentSecurityPolicyT = Aws::String>
  UpdateIngestConfigurationResult& WithContentSecurityPolicy(ContentSecurityPolicyT&& value) {
  ...
  template <typename StrictTransportSecurityT = Aws::String>
  UpdateIngestConfigurationResult& WithStrictTransportSecurity(StrictTransportSecurityT&& value) {
  ...
  template <typename XContentTypeOptionsT = Aws::String>
  UpdateIngestConfigurationResult& WithXContentTypeOptions(XContentTypeOptionsT&& value) {
  ...
  template <typename XFrameOptionsT = Aws::String>
  UpdateIngestConfigurationResult& WithXFrameOptions(XFrameOptionsT&& value) {
  ...
  template <typename IngestConfigurationT = IngestConfiguration>
  UpdateIngestConfigurationResult& WithIngestConfiguration(IngestConfigurationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateIngestConfigurationResult& WithRequestId(RequestIdT&& value) {
