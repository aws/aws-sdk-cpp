...
class GridConfiguration {
 public:
  ...
  inline GridConfiguration& WithOmitStoppedVideo(bool value) {
  ...
  inline void SetVideoAspectRatio(VideoAspectRatio value) {
    m_videoAspectRatioHasBeenSet = true;
    m_videoAspectRatio = value;
  }
  inline GridConfiguration& WithVideoAspectRatio(VideoAspectRatio value) {
  ...
  inline GridConfiguration& WithVideoFillMode(VideoFillMode value) {
  ...
  inline GridConfiguration& WithGridGap(int value) {
    SetGridGap(value);
    return *this;
  }
  ///@}
