...
class StorageConfiguration {
 public:
  ...
  template <typename ArnT = Aws::String>
  StorageConfiguration& WithArn(ArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  StorageConfiguration& WithName(NameT&& value) {
  ...
  template <typename S3T = S3StorageConfiguration>
  StorageConfiguration& WithS3(S3T&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  StorageConfiguration& WithTags(TagsT&& value) {
