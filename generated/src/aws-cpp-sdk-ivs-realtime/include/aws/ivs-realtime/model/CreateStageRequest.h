...
class CreateStageRequest : public IvsrealtimeRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  CreateStageRequest& WithName(NameT&& value) {
   ...
   * stage.</p>
   */
  inline const Aws::Vector<ParticipantTokenConfiguration>& GetParticipantTokenConfigurations() const {
    return m_participantTokenConfigurations;
  }
  ...
  void SetParticipantTokenConfigurations(ParticipantTokenConfigurationsT&& value) {
    m_participantTokenConfigurationsHasBeenSet = true;
    m_participantTokenConfigurations = std::forward<ParticipantTokenConfigurationsT>(value);
  }
  template <typename ParticipantTokenConfigurationsT = Aws::Vector<ParticipantTokenConfiguration>>
  CreateStageRequest& WithParticipantTokenConfigurations(ParticipantTokenConfigurationsT&& value) {
    SetParticipantTokenConfigurations(std::forward<ParticipantTokenConfigurationsT>(value));
    return *this;
  }
  template <typename ParticipantTokenConfigurationsT = ParticipantTokenConfiguration>
  CreateStageRequest& AddParticipantTokenConfigurations(ParticipantTokenConfigurationsT&& value) {
    m_participantTokenConfigurationsHasBeenSet = true;
    m_participantTokenConfigurations.emplace_back(std::forward<ParticipantTokenConfigurationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateStageRequest& WithTags(TagsT&& value) {
   ...
   * new stage.</p>
   */
  inline const AutoParticipantRecordingConfiguration& GetAutoParticipantRecordingConfiguration() const {
    return m_autoParticipantRecordingConfiguration;
  }
  ...
  void SetAutoParticipantRecordingConfiguration(AutoParticipantRecordingConfigurationT&& value) {
    m_autoParticipantRecordingConfigurationHasBeenSet = true;
    m_autoParticipantRecordingConfiguration = std::forward<AutoParticipantRecordingConfigurationT>(value);
  }
  template <typename AutoParticipantRecordingConfigurationT = AutoParticipantRecordingConfiguration>
  CreateStageRequest& WithAutoParticipantRecordingConfiguration(AutoParticipantRecordingConfigurationT&& value) {
    SetAutoParticipantRecordingConfiguration(std::forward<AutoParticipantRecordingConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
