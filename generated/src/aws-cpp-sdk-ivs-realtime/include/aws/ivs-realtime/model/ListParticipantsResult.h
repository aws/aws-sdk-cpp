...
class ListParticipantsResult {
 public:
  ...
  template <typename ParticipantsT = Aws::Vector<ParticipantSummary>>
  ListParticipantsResult& WithParticipants(ParticipantsT&& value) {
    SetParticipants(std::forward<ParticipantsT>(value));
    return *this;
  }
  template <typename ParticipantsT = ParticipantSummary>
  ListParticipantsResult& AddParticipants(ParticipantsT&& value) {
    m_participantsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListParticipantsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListParticipantsResult& WithRequestId(RequestIdT&& value) {
