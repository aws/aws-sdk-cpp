...
class AutoParticipantRecordingConfiguration {
 public:
  ...
  template <typename StorageConfigurationArnT = Aws::String>
  AutoParticipantRecordingConfiguration& WithStorageConfigurationArn(StorageConfigurationArnT&& value) {
  ...
  void SetMediaTypes(MediaTypesT&& value) {
    m_mediaTypesHasBeenSet = true;
    m_mediaTypes = std::forward<MediaTypesT>(value);
  }
  template <typename MediaTypesT = Aws::Vector<ParticipantRecordingMediaType>>
  AutoParticipantRecordingConfiguration& WithMediaTypes(MediaTypesT&& value) {
    SetMediaTypes(std::forward<MediaTypesT>(value));
    return *this;
  }
  inline AutoParticipantRecordingConfiguration& AddMediaTypes(ParticipantRecordingMediaType value) {
    m_mediaTypesHasBeenSet = true;
    m_mediaTypes.push_back(value);
    return *this;
  }
  ///@}
  ...
  template <typename ThumbnailConfigurationT = ParticipantThumbnailConfiguration>
  AutoParticipantRecordingConfiguration& WithThumbnailConfiguration(ThumbnailConfigurationT&& value) {
  ...
  inline AutoParticipantRecordingConfiguration& WithRecordingReconnectWindowSeconds(int value) {
  ...
  template <typename HlsConfigurationT = ParticipantRecordingHlsConfiguration>
  AutoParticipantRecordingConfiguration& WithHlsConfiguration(HlsConfigurationT&& value) {
  ...
  inline void SetRecordParticipantReplicas(bool value) {
    m_recordParticipantReplicasHasBeenSet = true;
    m_recordParticipantReplicas = value;
  }
  inline AutoParticipantRecordingConfiguration& WithRecordParticipantReplicas(bool value) {
    SetRecordParticipantReplicas(value);
    return *this;
  }
  ///@}
 private:
