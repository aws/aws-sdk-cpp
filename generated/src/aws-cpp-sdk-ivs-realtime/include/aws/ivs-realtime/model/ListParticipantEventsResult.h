...
class ListParticipantEventsResult {
 public:
  ...
  template <typename EventsT = Aws::Vector<Event>>
  ListParticipantEventsResult& WithEvents(EventsT&& value) {
    SetEvents(std::forward<EventsT>(value));
    return *this;
  }
  template <typename EventsT = Event>
  ListParticipantEventsResult& AddEvents(EventsT&& value) {
    m_eventsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListParticipantEventsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListParticipantEventsResult& WithRequestId(RequestIdT&& value) {
