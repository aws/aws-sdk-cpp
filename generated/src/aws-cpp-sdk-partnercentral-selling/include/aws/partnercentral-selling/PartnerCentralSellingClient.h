...
class AWS_PARTNERCENTRALSELLING_API PartnerCentralSellingClient
 ...
 public:
   ...
   */
  PartnerCentralSellingClient(const Aws::PartnerCentralSelling::PartnerCentralSellingClientConfiguration& clientConfiguration =
  ...
  PartnerCentralSellingClient(const Aws::Auth::AWSCredentials& credentials,
                              std::shared_ptr<PartnerCentralSellingEndpointProviderBase> endpointProvider = nullptr,
                              const Aws::PartnerCentralSelling::PartnerCentralSellingClientConfiguration& clientConfiguration =
                                  Aws::PartnerCentralSelling::PartnerCentralSellingClientConfiguration());
   ...
   * API Reference</a></p>
   */
  virtual Model::AcceptEngagementInvitationOutcome AcceptEngagementInvitation(
      const Model::AcceptEngagementInvitationRequest& request) const;

  /**
   * A Callable wrapper for AcceptEngagementInvitation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AcceptEngagementInvitationRequestT = Model::AcceptEngagementInvitationRequest>
  Model::AcceptEngagementInvitationOutcomeCallable AcceptEngagementInvitationCallable(
      const AcceptEngagementInvitationRequestT& request) const {
    return SubmitCallable(&PartnerCentralSellingClient::AcceptEngagementInvitation, request);
  }

  /**
   * An Async wrapper for AcceptEngagementInvitation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AcceptEngagementInvitationRequestT = Model::AcceptEngagementInvitationRequest>
  void AcceptEngagementInvitationAsync(const AcceptEngagementInvitationRequestT& request,
                                       const AcceptEngagementInvitationResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for AssignOpportunity that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssignOpportunity that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename AssignOpportunityRequestT = Model::AssignOpportunityRequest>
  void AssignOpportunityAsync(const AssignOpportunityRequestT& request, const AssignOpportunityResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for AssociateOpportunity that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssociateOpportunity that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateOpportunityRequestT = Model::AssociateOpportunityRequest>
  void AssociateOpportunityAsync(const AssociateOpportunityRequestT& request, const AssociateOpportunityResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateEngagement that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateEngagement that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateEngagementRequestT = Model::CreateEngagementRequest>
  void CreateEngagementAsync(const CreateEngagementRequestT& request, const CreateEngagementResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateEngagementInvitationOutcome CreateEngagementInvitation(
      const Model::CreateEngagementInvitationRequest& request) const;

  /**
   * A Callable wrapper for CreateEngagementInvitation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateEngagementInvitationRequestT = Model::CreateEngagementInvitationRequest>
  Model::CreateEngagementInvitationOutcomeCallable CreateEngagementInvitationCallable(
      const CreateEngagementInvitationRequestT& request) const {
    return SubmitCallable(&PartnerCentralSellingClient::CreateEngagementInvitation, request);
  }

  /**
   * An Async wrapper for CreateEngagementInvitation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateEngagementInvitationRequestT = Model::CreateEngagementInvitationRequest>
  void CreateEngagementInvitationAsync(const CreateEngagementInvitationRequestT& request,
                                       const CreateEngagementInvitationResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateOpportunity that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateOpportunity that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateOpportunityRequestT = Model::CreateOpportunityRequest>
  void CreateOpportunityAsync(const CreateOpportunityRequestT& request, const CreateOpportunityResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateResourceSnapshot that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateResourceSnapshot that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateResourceSnapshotRequestT = Model::CreateResourceSnapshotRequest>
  void CreateResourceSnapshotAsync(const CreateResourceSnapshotRequestT& request,
                                   const CreateResourceSnapshotResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateResourceSnapshotJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CreateResourceSnapshotJobRequestT = Model::CreateResourceSnapshotJobRequest>
  Model::CreateResourceSnapshotJobOutcomeCallable CreateResourceSnapshotJobCallable(
      const CreateResourceSnapshotJobRequestT& request) const {
    return SubmitCallable(&PartnerCentralSellingClient::CreateResourceSnapshotJob, request);
  }

  /**
   * An Async wrapper for CreateResourceSnapshotJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateResourceSnapshotJobRequestT = Model::CreateResourceSnapshotJobRequest>
  void CreateResourceSnapshotJobAsync(const CreateResourceSnapshotJobRequestT& request,
                                      const CreateResourceSnapshotJobResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteResourceSnapshotJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DeleteResourceSnapshotJobRequestT = Model::DeleteResourceSnapshotJobRequest>
  Model::DeleteResourceSnapshotJobOutcomeCallable DeleteResourceSnapshotJobCallable(
      const DeleteResourceSnapshotJobRequestT& request) const {
    return SubmitCallable(&PartnerCentralSellingClient::DeleteResourceSnapshotJob, request);
  }

  /**
   * An Async wrapper for DeleteResourceSnapshotJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteResourceSnapshotJobRequestT = Model::DeleteResourceSnapshotJobRequest>
  void DeleteResourceSnapshotJobAsync(const DeleteResourceSnapshotJobRequestT& request,
                                      const DeleteResourceSnapshotJobResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DisassociateOpportunity that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DisassociateOpportunity that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateOpportunityRequestT = Model::DisassociateOpportunityRequest>
  void DisassociateOpportunityAsync(const DisassociateOpportunityRequestT& request,
                                    const DisassociateOpportunityResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetAwsOpportunitySummary that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetAwsOpportunitySummary that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetAwsOpportunitySummaryRequestT = Model::GetAwsOpportunitySummaryRequest>
  void GetAwsOpportunitySummaryAsync(const GetAwsOpportunitySummaryRequestT& request,
                                     const GetAwsOpportunitySummaryResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetEngagement that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetEngagementRequestT = Model::GetEngagementRequest>
  void GetEngagementAsync(const GetEngagementRequestT& request, const GetEngagementResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetEngagementInvitation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetEngagementInvitation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetEngagementInvitationRequestT = Model::GetEngagementInvitationRequest>
  void GetEngagementInvitationAsync(const GetEngagementInvitationRequestT& request,
                                    const GetEngagementInvitationResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetOpportunity that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetOpportunityRequestT = Model::GetOpportunityRequest>
  void GetOpportunityAsync(const GetOpportunityRequestT& request, const GetOpportunityResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetResourceSnapshot that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetResourceSnapshot that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetResourceSnapshotRequestT = Model::GetResourceSnapshotRequest>
  void GetResourceSnapshotAsync(const GetResourceSnapshotRequestT& request, const GetResourceSnapshotResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetResourceSnapshotJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetResourceSnapshotJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetResourceSnapshotJobRequestT = Model::GetResourceSnapshotJobRequest>
  void GetResourceSnapshotJobAsync(const GetResourceSnapshotJobRequestT& request,
                                   const GetResourceSnapshotJobResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetSellingSystemSettings that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetSellingSystemSettings that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetSellingSystemSettingsRequestT = Model::GetSellingSystemSettingsRequest>
  void GetSellingSystemSettingsAsync(const GetSellingSystemSettingsRequestT& request,
                                     const GetSellingSystemSettingsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListEngagementByAcceptingInvitationTasksOutcome ListEngagementByAcceptingInvitationTasks(
      const Model::ListEngagementByAcceptingInvitationTasksRequest& request) const;

  /**
   * A Callable wrapper for ListEngagementByAcceptingInvitationTasks that returns a future to the operation so that it can be executed in
  ...
  Model::ListEngagementByAcceptingInvitationTasksOutcomeCallable ListEngagementByAcceptingInvitationTasksCallable(
      const ListEngagementByAcceptingInvitationTasksRequestT& request) const {
    return SubmitCallable(&PartnerCentralSellingClient::ListEngagementByAcceptingInvitationTasks, request);
  }

  /**
   * An Async wrapper for ListEngagementByAcceptingInvitationTasks that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListEngagementByAcceptingInvitationTasksRequestT = Model::ListEngagementByAcceptingInvitationTasksRequest>
  void ListEngagementByAcceptingInvitationTasksAsync(
      const ListEngagementByAcceptingInvitationTasksRequestT& request,
      const ListEngagementByAcceptingInvitationTasksResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListEngagementFromOpportunityTasksOutcome ListEngagementFromOpportunityTasks(
      const Model::ListEngagementFromOpportunityTasksRequest& request) const;

  /**
   * A Callable wrapper for ListEngagementFromOpportunityTasks that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListEngagementFromOpportunityTasksRequestT = Model::ListEngagementFromOpportunityTasksRequest>
  Model::ListEngagementFromOpportunityTasksOutcomeCallable ListEngagementFromOpportunityTasksCallable(
      const ListEngagementFromOpportunityTasksRequestT& request) const {
    return SubmitCallable(&PartnerCentralSellingClient::ListEngagementFromOpportunityTasks, request);
  }

  /**
   * An Async wrapper for ListEngagementFromOpportunityTasks that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListEngagementFromOpportunityTasksRequestT = Model::ListEngagementFromOpportunityTasksRequest>
  void ListEngagementFromOpportunityTasksAsync(const ListEngagementFromOpportunityTasksRequestT& request,
                                               const ListEngagementFromOpportunityTasksResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListEngagementInvitations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListEngagementInvitationsRequestT = Model::ListEngagementInvitationsRequest>
  Model::ListEngagementInvitationsOutcomeCallable ListEngagementInvitationsCallable(
      const ListEngagementInvitationsRequestT& request) const {
    return SubmitCallable(&PartnerCentralSellingClient::ListEngagementInvitations, request);
  }

  /**
   * An Async wrapper for ListEngagementInvitations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListEngagementInvitationsRequestT = Model::ListEngagementInvitationsRequest>
  void ListEngagementInvitationsAsync(const ListEngagementInvitationsRequestT& request,
                                      const ListEngagementInvitationsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListEngagementMembers that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListEngagementMembers that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListEngagementMembersRequestT = Model::ListEngagementMembersRequest>
  void ListEngagementMembersAsync(const ListEngagementMembersRequestT& request, const ListEngagementMembersResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::ListEngagementResourceAssociationsOutcome ListEngagementResourceAssociations(
      const Model::ListEngagementResourceAssociationsRequest& request) const;

  /**
   * A Callable wrapper for ListEngagementResourceAssociations that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListEngagementResourceAssociationsRequestT = Model::ListEngagementResourceAssociationsRequest>
  Model::ListEngagementResourceAssociationsOutcomeCallable ListEngagementResourceAssociationsCallable(
      const ListEngagementResourceAssociationsRequestT& request) const {
    return SubmitCallable(&PartnerCentralSellingClient::ListEngagementResourceAssociations, request);
  }

  /**
   * An Async wrapper for ListEngagementResourceAssociations that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListEngagementResourceAssociationsRequestT = Model::ListEngagementResourceAssociationsRequest>
  void ListEngagementResourceAssociationsAsync(const ListEngagementResourceAssociationsRequestT& request,
                                               const ListEngagementResourceAssociationsResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListEngagements that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListEngagementsRequestT = Model::ListEngagementsRequest>
  void ListEngagementsAsync(const ListEngagementsRequestT& request, const ListEngagementsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListOpportunities that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListOpportunities that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListOpportunitiesRequestT = Model::ListOpportunitiesRequest>
  void ListOpportunitiesAsync(const ListOpportunitiesRequestT& request, const ListOpportunitiesResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListResourceSnapshotJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListResourceSnapshotJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListResourceSnapshotJobsRequestT = Model::ListResourceSnapshotJobsRequest>
  void ListResourceSnapshotJobsAsync(const ListResourceSnapshotJobsRequestT& request,
                                     const ListResourceSnapshotJobsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListResourceSnapshots that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListResourceSnapshots that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListResourceSnapshotsRequestT = Model::ListResourceSnapshotsRequest>
  void ListResourceSnapshotsAsync(const ListResourceSnapshotsRequestT& request, const ListResourceSnapshotsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListSolutions that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListSolutionsRequestT = Model::ListSolutionsRequest>
  void ListSolutionsAsync(const ListSolutionsRequestT& request, const ListSolutionsResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutSellingSystemSettings that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutSellingSystemSettings that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutSellingSystemSettingsRequestT = Model::PutSellingSystemSettingsRequest>
  void PutSellingSystemSettingsAsync(const PutSellingSystemSettingsRequestT& request,
                                     const PutSellingSystemSettingsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::RejectEngagementInvitationOutcome RejectEngagementInvitation(
      const Model::RejectEngagementInvitationRequest& request) const;

  /**
   * A Callable wrapper for RejectEngagementInvitation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename RejectEngagementInvitationRequestT = Model::RejectEngagementInvitationRequest>
  Model::RejectEngagementInvitationOutcomeCallable RejectEngagementInvitationCallable(
      const RejectEngagementInvitationRequestT& request) const {
    return SubmitCallable(&PartnerCentralSellingClient::RejectEngagementInvitation, request);
  }

  /**
   * An Async wrapper for RejectEngagementInvitation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RejectEngagementInvitationRequestT = Model::RejectEngagementInvitationRequest>
  void RejectEngagementInvitationAsync(const RejectEngagementInvitationRequestT& request,
                                       const RejectEngagementInvitationResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartEngagementByAcceptingInvitationTaskOutcome StartEngagementByAcceptingInvitationTask(
      const Model::StartEngagementByAcceptingInvitationTaskRequest& request) const;

  /**
   * A Callable wrapper for StartEngagementByAcceptingInvitationTask that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename StartEngagementByAcceptingInvitationTaskRequestT = Model::StartEngagementByAcceptingInvitationTaskRequest>
  Model::StartEngagementByAcceptingInvitationTaskOutcomeCallable StartEngagementByAcceptingInvitationTaskCallable(
      const StartEngagementByAcceptingInvitationTaskRequestT& request) const {
    return SubmitCallable(&PartnerCentralSellingClient::StartEngagementByAcceptingInvitationTask, request);
  }

  /**
   * An Async wrapper for StartEngagementByAcceptingInvitationTask that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename StartEngagementByAcceptingInvitationTaskRequestT = Model::StartEngagementByAcceptingInvitationTaskRequest>
  void StartEngagementByAcceptingInvitationTaskAsync(
      const StartEngagementByAcceptingInvitationTaskRequestT& request,
      const StartEngagementByAcceptingInvitationTaskResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartEngagementFromOpportunityTaskOutcome StartEngagementFromOpportunityTask(
      const Model::StartEngagementFromOpportunityTaskRequest& request) const;

  /**
   * A Callable wrapper for StartEngagementFromOpportunityTask that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename StartEngagementFromOpportunityTaskRequestT = Model::StartEngagementFromOpportunityTaskRequest>
  Model::StartEngagementFromOpportunityTaskOutcomeCallable StartEngagementFromOpportunityTaskCallable(
      const StartEngagementFromOpportunityTaskRequestT& request) const {
    return SubmitCallable(&PartnerCentralSellingClient::StartEngagementFromOpportunityTask, request);
  }

  /**
   * An Async wrapper for StartEngagementFromOpportunityTask that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename StartEngagementFromOpportunityTaskRequestT = Model::StartEngagementFromOpportunityTaskRequest>
  void StartEngagementFromOpportunityTaskAsync(const StartEngagementFromOpportunityTaskRequestT& request,
                                               const StartEngagementFromOpportunityTaskResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartResourceSnapshotJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartResourceSnapshotJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartResourceSnapshotJobRequestT = Model::StartResourceSnapshotJobRequest>
  void StartResourceSnapshotJobAsync(const StartResourceSnapshotJobRequestT& request,
                                     const StartResourceSnapshotJobResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StopResourceSnapshotJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopResourceSnapshotJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StopResourceSnapshotJobRequestT = Model::StopResourceSnapshotJobRequest>
  void StopResourceSnapshotJobAsync(const StopResourceSnapshotJobRequestT& request,
                                    const StopResourceSnapshotJobResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SubmitOpportunity that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SubmitOpportunity that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename SubmitOpportunityRequestT = Model::SubmitOpportunityRequest>
  void SubmitOpportunityAsync(const SubmitOpportunityRequestT& request, const SubmitOpportunityResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateOpportunity that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateOpportunity that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateOpportunityRequestT = Model::UpdateOpportunityRequest>
  void UpdateOpportunityAsync(const UpdateOpportunityRequestT& request, const UpdateOpportunityResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
