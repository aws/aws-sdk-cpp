...
class EngagementInvitationSummary {
 public:
  ...
  inline void SetPayloadType(EngagementInvitationPayloadType value) {
    m_payloadTypeHasBeenSet = true;
    m_payloadType = value;
  }
  inline EngagementInvitationSummary& WithPayloadType(EngagementInvitationPayloadType value) {
  ...
  void SetEngagementTitle(EngagementTitleT&& value) {
    ...
    m_engagementTitle = std::forward<EngagementTitleT>(value);
  }
  template <typename EngagementTitleT = Aws::String>
  EngagementInvitationSummary& WithEngagementTitle(EngagementTitleT&& value) {
    SetEngagementTitle(std::forward<EngagementTitleT>(value));
    return *this;
  }
  ///@}
  ...
  inline EngagementInvitationSummary& WithStatus(InvitationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetInvitationDate(InvitationDateT&& value) {
    ...
    m_invitationDate = std::forward<InvitationDateT>(value);
  }
  template <typename InvitationDateT = Aws::Utils::DateTime>
  EngagementInvitationSummary& WithInvitationDate(InvitationDateT&& value) {
    SetInvitationDate(std::forward<InvitationDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSenderAwsAccountId(SenderAwsAccountIdT&& value) {
    ...
    m_senderAwsAccountId = std::forward<SenderAwsAccountIdT>(value);
  }
  template <typename SenderAwsAccountIdT = Aws::String>
  EngagementInvitationSummary& WithSenderAwsAccountId(SenderAwsAccountIdT&& value) {
    SetSenderAwsAccountId(std::forward<SenderAwsAccountIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSenderCompanyName(SenderCompanyNameT&& value) {
    ...
    m_senderCompanyName = std::forward<SenderCompanyNameT>(value);
  }
  template <typename SenderCompanyNameT = Aws::String>
  EngagementInvitationSummary& WithSenderCompanyName(SenderCompanyNameT&& value) {
    SetSenderCompanyName(std::forward<SenderCompanyNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReceiver(ReceiverT&& value) {
    ...
    m_receiver = std::forward<ReceiverT>(value);
  }
  template <typename ReceiverT = Receiver>
  EngagementInvitationSummary& WithReceiver(ReceiverT&& value) {
    SetReceiver(std::forward<ReceiverT>(value));
    return *this;
  }
  ///@}
  ...
  inline EngagementInvitationSummary& WithParticipantType(ParticipantType value) {
