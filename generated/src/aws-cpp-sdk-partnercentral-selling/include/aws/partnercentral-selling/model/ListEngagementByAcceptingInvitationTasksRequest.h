...
class ListEngagementByAcceptingInvitationTasksRequest : public PartnerCentralSellingRequest {
 public:
  ...
  inline ListEngagementByAcceptingInvitationTasksRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListEngagementByAcceptingInvitationTasksRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename SortT = ListTasksSortBase>
  ListEngagementByAcceptingInvitationTasksRequest& WithSort(SortT&& value) {
  ...
  template <typename CatalogT = Aws::String>
  ListEngagementByAcceptingInvitationTasksRequest& WithCatalog(CatalogT&& value) {
  ...
  template <typename TaskStatusT = Aws::Vector<TaskStatus>>
  ListEngagementByAcceptingInvitationTasksRequest& WithTaskStatus(TaskStatusT&& value) {
    SetTaskStatus(std::forward<TaskStatusT>(value));
    return *this;
  }
  inline ListEngagementByAcceptingInvitationTasksRequest& AddTaskStatus(TaskStatus value) {
    m_taskStatusHasBeenSet = true;
  ...
  template <typename OpportunityIdentifierT = Aws::Vector<Aws::String>>
  ListEngagementByAcceptingInvitationTasksRequest& WithOpportunityIdentifier(OpportunityIdentifierT&& value) {
    SetOpportunityIdentifier(std::forward<OpportunityIdentifierT>(value));
    return *this;
  }
  template <typename OpportunityIdentifierT = Aws::String>
  ListEngagementByAcceptingInvitationTasksRequest& AddOpportunityIdentifier(OpportunityIdentifierT&& value) {
    m_opportunityIdentifierHasBeenSet = true;
  ...
  void SetEngagementInvitationIdentifier(EngagementInvitationIdentifierT&& value) {
    m_engagementInvitationIdentifierHasBeenSet = true;
    m_engagementInvitationIdentifier = std::forward<EngagementInvitationIdentifierT>(value);
  }
  template <typename EngagementInvitationIdentifierT = Aws::Vector<Aws::String>>
  ListEngagementByAcceptingInvitationTasksRequest& WithEngagementInvitationIdentifier(EngagementInvitationIdentifierT&& value) {
    SetEngagementInvitationIdentifier(std::forward<EngagementInvitationIdentifierT>(value));
    return *this;
  }
  template <typename EngagementInvitationIdentifierT = Aws::String>
  ListEngagementByAcceptingInvitationTasksRequest& AddEngagementInvitationIdentifier(EngagementInvitationIdentifierT&& value) {
    m_engagementInvitationIdentifierHasBeenSet = true;
    m_engagementInvitationIdentifier.emplace_back(std::forward<EngagementInvitationIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TaskIdentifierT = Aws::Vector<Aws::String>>
  ListEngagementByAcceptingInvitationTasksRequest& WithTaskIdentifier(TaskIdentifierT&& value) {
    SetTaskIdentifier(std::forward<TaskIdentifierT>(value));
    return *this;
  }
  template <typename TaskIdentifierT = Aws::String>
  ListEngagementByAcceptingInvitationTasksRequest& AddTaskIdentifier(TaskIdentifierT&& value) {
    m_taskIdentifierHasBeenSet = true;
