...
class AwsOpportunityLifeCycle {
 public:
  ...
  inline void SetClosedLostReason(AwsClosedLostReason value) {
    m_closedLostReasonHasBeenSet = true;
    m_closedLostReason = value;
  }
  inline AwsOpportunityLifeCycle& WithClosedLostReason(AwsClosedLostReason value) {
  ...
  inline void SetStage(AwsOpportunityStage value) {
    m_stageHasBeenSet = true;
    m_stage = value;
  }
  inline AwsOpportunityLifeCycle& WithStage(AwsOpportunityStage value) {
    SetStage(value);
    return *this;
  }
  ///@}
