...
class ListEngagementsResult {
 public:
  ...
  void SetEngagementSummaryList(EngagementSummaryListT&& value) {
    m_engagementSummaryListHasBeenSet = true;
    m_engagementSummaryList = std::forward<EngagementSummaryListT>(value);
  }
  template <typename EngagementSummaryListT = Aws::Vector<EngagementSummary>>
  ListEngagementsResult& WithEngagementSummaryList(EngagementSummaryListT&& value) {
    SetEngagementSummaryList(std::forward<EngagementSummaryListT>(value));
    return *this;
  }
  template <typename EngagementSummaryListT = EngagementSummary>
  ListEngagementsResult& AddEngagementSummaryList(EngagementSummaryListT&& value) {
    m_engagementSummaryListHasBeenSet = true;
    m_engagementSummaryList.emplace_back(std::forward<EngagementSummaryListT>(value));
    return *this;
  }
  ///@}
