...
class StopResourceSnapshotJobRequest : public PartnerCentralSellingRequest {
 public:
  ...
  template <typename CatalogT = Aws::String>
  StopResourceSnapshotJobRequest& WithCatalog(CatalogT&& value) {
  ...
  template <typename ResourceSnapshotJobIdentifierT = Aws::String>
  StopResourceSnapshotJobRequest& WithResourceSnapshotJobIdentifier(ResourceSnapshotJobIdentifierT&& value) {
