...
class ListResourceSnapshotJobsResult {
 public:
  ...
  AWS_PARTNERCENTRALSELLING_API ListResourceSnapshotJobsResult& operator=(
  ...
  void SetResourceSnapshotJobSummaries(ResourceSnapshotJobSummariesT&& value) {
    m_resourceSnapshotJobSummariesHasBeenSet = true;
    m_resourceSnapshotJobSummaries = std::forward<ResourceSnapshotJobSummariesT>(value);
  }
  template <typename ResourceSnapshotJobSummariesT = Aws::Vector<ResourceSnapshotJobSummary>>
  ListResourceSnapshotJobsResult& WithResourceSnapshotJobSummaries(ResourceSnapshotJobSummariesT&& value) {
    SetResourceSnapshotJobSummaries(std::forward<ResourceSnapshotJobSummariesT>(value));
    return *this;
  }
  template <typename ResourceSnapshotJobSummariesT = ResourceSnapshotJobSummary>
  ListResourceSnapshotJobsResult& AddResourceSnapshotJobSummaries(ResourceSnapshotJobSummariesT&& value) {
    m_resourceSnapshotJobSummariesHasBeenSet = true;
    m_resourceSnapshotJobSummaries.emplace_back(std::forward<ResourceSnapshotJobSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListResourceSnapshotJobsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListResourceSnapshotJobsResult& WithRequestId(RequestIdT&& value) {
