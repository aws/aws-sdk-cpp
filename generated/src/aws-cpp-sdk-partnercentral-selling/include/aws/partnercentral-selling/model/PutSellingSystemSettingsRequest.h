...
class PutSellingSystemSettingsRequest : public PartnerCentralSellingRequest {
 public:
  ...
  void SetResourceSnapshotJobRoleIdentifier(ResourceSnapshotJobRoleIdentifierT&& value) {
    m_resourceSnapshotJobRoleIdentifierHasBeenSet = true;
    m_resourceSnapshotJobRoleIdentifier = std::forward<ResourceSnapshotJobRoleIdentifierT>(value);
  }
  template <typename ResourceSnapshotJobRoleIdentifierT = Aws::String>
  PutSellingSystemSettingsRequest& WithResourceSnapshotJobRoleIdentifier(ResourceSnapshotJobRoleIdentifierT&& value) {
    SetResourceSnapshotJobRoleIdentifier(std::forward<ResourceSnapshotJobRoleIdentifierT>(value));
    return *this;
  }
  ///@}
 private:
