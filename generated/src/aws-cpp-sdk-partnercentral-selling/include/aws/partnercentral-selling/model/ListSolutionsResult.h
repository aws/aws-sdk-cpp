...
class ListSolutionsResult {
 public:
  ...
  void SetSolutionSummaries(SolutionSummariesT&& value) {
    m_solutionSummariesHasBeenSet = true;
    m_solutionSummaries = std::forward<SolutionSummariesT>(value);
  }
  template <typename SolutionSummariesT = Aws::Vector<SolutionBase>>
  ListSolutionsResult& WithSolutionSummaries(SolutionSummariesT&& value) {
    SetSolutionSummaries(std::forward<SolutionSummariesT>(value));
    return *this;
  }
  template <typename SolutionSummariesT = SolutionBase>
  ListSolutionsResult& AddSolutionSummaries(SolutionSummariesT&& value) {
    m_solutionSummariesHasBeenSet = true;
    m_solutionSummaries.emplace_back(std::forward<SolutionSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListSolutionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListSolutionsResult& WithRequestId(RequestIdT&& value) {
