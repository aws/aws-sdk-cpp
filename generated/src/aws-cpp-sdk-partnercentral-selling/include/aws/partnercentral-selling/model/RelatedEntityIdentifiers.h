...
class RelatedEntityIdentifiers {
 public:
  ...
  void SetAwsMarketplaceOffers(AwsMarketplaceOffersT&& value) {
    m_awsMarketplaceOffersHasBeenSet = true;
    m_awsMarketplaceOffers = std::forward<AwsMarketplaceOffersT>(value);
  }
  template <typename AwsMarketplaceOffersT = Aws::Vector<Aws::String>>
  RelatedEntityIdentifiers& WithAwsMarketplaceOffers(AwsMarketplaceOffersT&& value) {
    SetAwsMarketplaceOffers(std::forward<AwsMarketplaceOffersT>(value));
    return *this;
  }
  template <typename AwsMarketplaceOffersT = Aws::String>
  RelatedEntityIdentifiers& AddAwsMarketplaceOffers(AwsMarketplaceOffersT&& value) {
    m_awsMarketplaceOffersHasBeenSet = true;
    m_awsMarketplaceOffers.emplace_back(std::forward<AwsMarketplaceOffersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename SolutionsT = Aws::Vector<Aws::String>>
  RelatedEntityIdentifiers& WithSolutions(SolutionsT&& value) {
    SetSolutions(std::forward<SolutionsT>(value));
    return *this;
  }
  template <typename SolutionsT = Aws::String>
  RelatedEntityIdentifiers& AddSolutions(SolutionsT&& value) {
    m_solutionsHasBeenSet = true;
  ...
  template <typename AwsProductsT = Aws::Vector<Aws::String>>
  RelatedEntityIdentifiers& WithAwsProducts(AwsProductsT&& value) {
    SetAwsProducts(std::forward<AwsProductsT>(value));
    return *this;
  }
  template <typename AwsProductsT = Aws::String>
  RelatedEntityIdentifiers& AddAwsProducts(AwsProductsT&& value) {
    m_awsProductsHasBeenSet = true;
