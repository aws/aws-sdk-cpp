...
class ListEngagementInvitationsResult {
 public:
  ...
  AWS_PARTNERCENTRALSELLING_API ListEngagementInvitationsResult& operator=(
   ...
   */
  inline const Aws::Vector<EngagementInvitationSummary>& GetEngagementInvitationSummaries() const {
    return m_engagementInvitationSummaries;
  }
  template <typename EngagementInvitationSummariesT = Aws::Vector<EngagementInvitationSummary>>
  void SetEngagementInvitationSummaries(EngagementInvitationSummariesT&& value) {
    m_engagementInvitationSummariesHasBeenSet = true;
    m_engagementInvitationSummaries = std::forward<EngagementInvitationSummariesT>(value);
  }
  template <typename EngagementInvitationSummariesT = Aws::Vector<EngagementInvitationSummary>>
  ListEngagementInvitationsResult& WithEngagementInvitationSummaries(EngagementInvitationSummariesT&& value) {
    SetEngagementInvitationSummaries(std::forward<EngagementInvitationSummariesT>(value));
    return *this;
  }
  template <typename EngagementInvitationSummariesT = EngagementInvitationSummary>
  ListEngagementInvitationsResult& AddEngagementInvitationSummaries(EngagementInvitationSummariesT&& value) {
    m_engagementInvitationSummariesHasBeenSet = true;
    m_engagementInvitationSummaries.emplace_back(std::forward<EngagementInvitationSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListEngagementInvitationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListEngagementInvitationsResult& WithRequestId(RequestIdT&& value) {
