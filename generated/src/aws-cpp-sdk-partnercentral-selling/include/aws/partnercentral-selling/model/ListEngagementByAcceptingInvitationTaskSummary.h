...
class ListEngagementByAcceptingInvitationTaskSummary {
 public:
  ...
  template <typename TaskIdT = Aws::String>
  ListEngagementByAcceptingInvitationTaskSummary& WithTaskId(TaskIdT&& value) {
  ...
  template <typename TaskArnT = Aws::String>
  ListEngagementByAcceptingInvitationTaskSummary& WithTaskArn(TaskArnT&& value) {
  ...
  template <typename StartTimeT = Aws::Utils::DateTime>
  ListEngagementByAcceptingInvitationTaskSummary& WithStartTime(StartTimeT&& value) {
  ...
  inline ListEngagementByAcceptingInvitationTaskSummary& WithTaskStatus(TaskStatus value) {
    SetTaskStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename MessageT = Aws::String>
  ListEngagementByAcceptingInvitationTaskSummary& WithMessage(MessageT&& value) {
  ...
  inline ListEngagementByAcceptingInvitationTaskSummary& WithReasonCode(ReasonCode value) {
    SetReasonCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename OpportunityIdT = Aws::String>
  ListEngagementByAcceptingInvitationTaskSummary& WithOpportunityId(OpportunityIdT&& value) {
  ...
  template <typename ResourceSnapshotJobIdT = Aws::String>
  ListEngagementByAcceptingInvitationTaskSummary& WithResourceSnapshotJobId(ResourceSnapshotJobIdT&& value) {
  ...
  template <typename EngagementInvitationIdT = Aws::String>
  ListEngagementByAcceptingInvitationTaskSummary& WithEngagementInvitationId(EngagementInvitationIdT&& value) {
