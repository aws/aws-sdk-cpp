...
class LifeCycleForView {
 public:
  ...
  inline void SetReviewStatus(ReviewStatus value) {
    m_reviewStatusHasBeenSet = true;
    m_reviewStatus = value;
  }
  inline LifeCycleForView& WithReviewStatus(ReviewStatus value) {
  ...
  inline LifeCycleForView& WithStage(Stage value) {
    SetStage(value);
    return *this;
  }
  ///@}
  ...
  void SetNextSteps(NextStepsT&& value) {
    ...
    m_nextSteps = std::forward<NextStepsT>(value);
  }
  template <typename NextStepsT = Aws::String>
  LifeCycleForView& WithNextSteps(NextStepsT&& value) {
    SetNextSteps(std::forward<NextStepsT>(value));
    return *this;
  }
  ///@}
 private:
