...
class EngagementSort {
 public:
  ...
  inline EngagementSort& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSortBy(EngagementSortName value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline EngagementSort& WithSortBy(EngagementSortName value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
