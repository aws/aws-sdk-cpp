...
class GetAwsOpportunitySummaryRequest : public PartnerCentralSellingRequest {
 public:
  ...
  void SetRelatedOpportunityIdentifier(RelatedOpportunityIdentifierT&& value) {
    ...
    m_relatedOpportunityIdentifier = std::forward<RelatedOpportunityIdentifierT>(value);
  }
  template <typename RelatedOpportunityIdentifierT = Aws::String>
  GetAwsOpportunitySummaryRequest& WithRelatedOpportunityIdentifier(RelatedOpportunityIdentifierT&& value) {
    SetRelatedOpportunityIdentifier(std::forward<RelatedOpportunityIdentifierT>(value));
    return *this;
  }
  ///@}
 private:
