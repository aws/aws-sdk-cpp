...
class LastModifiedDate {
 public:
  ...
  void SetAfterLastModifiedDate(AfterLastModifiedDateT&& value) {
    ...
    m_afterLastModifiedDate = std::forward<AfterLastModifiedDateT>(value);
  }
  template <typename AfterLastModifiedDateT = Aws::Utils::DateTime>
  LastModifiedDate& WithAfterLastModifiedDate(AfterLastModifiedDateT&& value) {
    SetAfterLastModifiedDate(std::forward<AfterLastModifiedDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBeforeLastModifiedDate(BeforeLastModifiedDateT&& value) {
    ...
    m_beforeLastModifiedDate = std::forward<BeforeLastModifiedDateT>(value);
  }
  template <typename BeforeLastModifiedDateT = Aws::Utils::DateTime>
  LastModifiedDate& WithBeforeLastModifiedDate(BeforeLastModifiedDateT&& value) {
    SetBeforeLastModifiedDate(std::forward<BeforeLastModifiedDateT>(value));
    return *this;
  }
  ///@}
 private:
