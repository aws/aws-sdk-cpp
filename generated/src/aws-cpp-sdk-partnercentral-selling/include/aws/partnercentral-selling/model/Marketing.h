...
class Marketing {
 public:
  ...
  void SetCampaignName(CampaignNameT&& value) {
    ...
    m_campaignName = std::forward<CampaignNameT>(value);
  }
  template <typename CampaignNameT = Aws::String>
  Marketing& WithCampaignName(CampaignNameT&& value) {
    SetCampaignName(std::forward<CampaignNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetSource(MarketingSource value) {
    m_sourceHasBeenSet = true;
    m_source = value;
  }
  inline Marketing& WithSource(MarketingSource value) {
    SetSource(value);
    return *this;
  }
  ///@}
  ...
  inline Marketing& AddChannels(Channel value) {
    m_channelsHasBeenSet = true;
  ...
  inline void SetAwsFundingUsed(AwsFundingUsed value) {
    m_awsFundingUsedHasBeenSet = true;
    m_awsFundingUsed = value;
  }
  inline Marketing& WithAwsFundingUsed(AwsFundingUsed value) {
    SetAwsFundingUsed(value);
    return *this;
  }
  ///@}
 private:
