...
class LifeCycleSummary {
 public:
  ...
  inline LifeCycleSummary& WithStage(Stage value) {
    SetStage(value);
    return *this;
  }
  ///@}
  ...
  inline LifeCycleSummary& WithClosedLostReason(ClosedLostReason value) {
  ...
  inline LifeCycleSummary& WithReviewStatus(ReviewStatus value) {
