...
class ListEngagementByAcceptingInvitationTasksResult {
 public:
  ...
  AWS_PARTNERCENTRALSELLING_API ListEngagementByAcceptingInvitationTasksResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename TaskSummariesT = Aws::Vector<ListEngagementByAcceptingInvitationTaskSummary>>
  ListEngagementByAcceptingInvitationTasksResult& WithTaskSummaries(TaskSummariesT&& value) {
  ...
  ListEngagementByAcceptingInvitationTasksResult& AddTaskSummaries(TaskSummariesT&& value) {
    m_taskSummariesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListEngagementByAcceptingInvitationTasksResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListEngagementByAcceptingInvitationTasksResult& WithRequestId(RequestIdT&& value) {
