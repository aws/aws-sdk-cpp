...
class AssociateOpportunityRequest : public PartnerCentralSellingRequest {
 public:
  ...
  inline void SetRelatedEntityType(RelatedEntityType value) {
    m_relatedEntityTypeHasBeenSet = true;
    m_relatedEntityType = value;
  }
  inline AssociateOpportunityRequest& WithRelatedEntityType(RelatedEntityType value) {
  ...
  void SetRelatedEntityIdentifier(RelatedEntityIdentifierT&& value) {
    m_relatedEntityIdentifierHasBeenSet = true;
    m_relatedEntityIdentifier = std::forward<RelatedEntityIdentifierT>(value);
  }
  template <typename RelatedEntityIdentifierT = Aws::String>
  AssociateOpportunityRequest& WithRelatedEntityIdentifier(RelatedEntityIdentifierT&& value) {
    SetRelatedEntityIdentifier(std::forward<RelatedEntityIdentifierT>(value));
    return *this;
  }
  ///@}
 private:
