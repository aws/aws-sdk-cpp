...
class StartEngagementFromOpportunityTaskResult {
 public:
  ...
  AWS_PARTNERCENTRALSELLING_API StartEngagementFromOpportunityTaskResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename TaskIdT = Aws::String>
  StartEngagementFromOpportunityTaskResult& WithTaskId(TaskIdT&& value) {
  ...
  template <typename TaskArnT = Aws::String>
  StartEngagementFromOpportunityTaskResult& WithTaskArn(TaskArnT&& value) {
  ...
  template <typename StartTimeT = Aws::Utils::DateTime>
  StartEngagementFromOpportunityTaskResult& WithStartTime(StartTimeT&& value) {
  ...
  inline StartEngagementFromOpportunityTaskResult& WithTaskStatus(TaskStatus value) {
    SetTaskStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename MessageT = Aws::String>
  StartEngagementFromOpportunityTaskResult& WithMessage(MessageT&& value) {
  ...
  inline StartEngagementFromOpportunityTaskResult& WithReasonCode(ReasonCode value) {
    SetReasonCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename OpportunityIdT = Aws::String>
  StartEngagementFromOpportunityTaskResult& WithOpportunityId(OpportunityIdT&& value) {
  ...
  template <typename ResourceSnapshotJobIdT = Aws::String>
  StartEngagementFromOpportunityTaskResult& WithResourceSnapshotJobId(ResourceSnapshotJobIdT&& value) {
  ...
  template <typename EngagementIdT = Aws::String>
  StartEngagementFromOpportunityTaskResult& WithEngagementId(EngagementIdT&& value) {
  ...
  template <typename EngagementInvitationIdT = Aws::String>
  StartEngagementFromOpportunityTaskResult& WithEngagementInvitationId(EngagementInvitationIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StartEngagementFromOpportunityTaskResult& WithRequestId(RequestIdT&& value) {
