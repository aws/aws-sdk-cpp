...
class EngagementCustomerProjectDetails {
 public:
  ...
  template <typename TitleT = Aws::String>
  EngagementCustomerProjectDetails& WithTitle(TitleT&& value) {
  ...
  void SetTargetCompletionDate(TargetCompletionDateT&& value) {
    ...
    m_targetCompletionDate = std::forward<TargetCompletionDateT>(value);
  }
  template <typename TargetCompletionDateT = Aws::String>
  EngagementCustomerProjectDetails& WithTargetCompletionDate(TargetCompletionDateT&& value) {
    SetTargetCompletionDate(std::forward<TargetCompletionDateT>(value));
    return *this;
  }
  ///@}
 private:
