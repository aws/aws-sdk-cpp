...
class ListEngagementFromOpportunityTaskSummary {
 public:
  ...
  template <typename TaskIdT = Aws::String>
  ListEngagementFromOpportunityTaskSummary& WithTaskId(TaskIdT&& value) {
  ...
  template <typename TaskArnT = Aws::String>
  ListEngagementFromOpportunityTaskSummary& WithTaskArn(TaskArnT&& value) {
  ...
  template <typename StartTimeT = Aws::Utils::DateTime>
  ListEngagementFromOpportunityTaskSummary& WithStartTime(StartTimeT&& value) {
  ...
  inline ListEngagementFromOpportunityTaskSummary& WithTaskStatus(TaskStatus value) {
    SetTaskStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename MessageT = Aws::String>
  ListEngagementFromOpportunityTaskSummary& WithMessage(MessageT&& value) {
  ...
  inline ListEngagementFromOpportunityTaskSummary& WithReasonCode(ReasonCode value) {
    SetReasonCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename OpportunityIdT = Aws::String>
  ListEngagementFromOpportunityTaskSummary& WithOpportunityId(OpportunityIdT&& value) {
  ...
  template <typename ResourceSnapshotJobIdT = Aws::String>
  ListEngagementFromOpportunityTaskSummary& WithResourceSnapshotJobId(ResourceSnapshotJobIdT&& value) {
  ...
  template <typename EngagementIdT = Aws::String>
  ListEngagementFromOpportunityTaskSummary& WithEngagementId(EngagementIdT&& value) {
  ...
  template <typename EngagementInvitationIdT = Aws::String>
  ListEngagementFromOpportunityTaskSummary& WithEngagementInvitationId(EngagementInvitationIdT&& value) {
