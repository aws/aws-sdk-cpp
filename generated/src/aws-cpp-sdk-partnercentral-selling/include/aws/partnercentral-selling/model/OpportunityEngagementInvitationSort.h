...
class OpportunityEngagementInvitationSort {
 public:
  ...
  inline OpportunityEngagementInvitationSort& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSortBy(OpportunityEngagementInvitationSortName value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline OpportunityEngagementInvitationSort& WithSortBy(OpportunityEngagementInvitationSortName value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
