...
class ListEngagementInvitationsRequest : public PartnerCentralSellingRequest {
 public:
  ...
  inline ListEngagementInvitationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  void SetPayloadType(PayloadTypeT&& value) {
    ...
    m_payloadType = std::forward<PayloadTypeT>(value);
  }
  template <typename PayloadTypeT = Aws::Vector<EngagementInvitationPayloadType>>
  ListEngagementInvitationsRequest& WithPayloadType(PayloadTypeT&& value) {
    SetPayloadType(std::forward<PayloadTypeT>(value));
    return *this;
  }
  inline ListEngagementInvitationsRequest& AddPayloadType(EngagementInvitationPayloadType value) {
    m_payloadTypeHasBeenSet = true;
    m_payloadType.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline ListEngagementInvitationsRequest& WithParticipantType(ParticipantType value) {
  ...
  inline ListEngagementInvitationsRequest& AddStatus(InvitationStatus value) {
    m_statusHasBeenSet = true;
  ...
  ListEngagementInvitationsRequest& AddSenderAwsAccountId(SenderAwsAccountIdT&& value) {
    m_senderAwsAccountIdHasBeenSet = true;
    m_senderAwsAccountId.emplace_back(std::forward<SenderAwsAccountIdT>(value));
    return *this;
  }
  ///@}
 private:
