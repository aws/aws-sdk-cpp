...
class ListResourceSnapshotsResult {
 public:
  ...
  AWS_PARTNERCENTRALSELLING_API ListResourceSnapshotsResult& operator=(
  ...
  void SetResourceSnapshotSummaries(ResourceSnapshotSummariesT&& value) {
    m_resourceSnapshotSummariesHasBeenSet = true;
    m_resourceSnapshotSummaries = std::forward<ResourceSnapshotSummariesT>(value);
  }
  template <typename ResourceSnapshotSummariesT = Aws::Vector<ResourceSnapshotSummary>>
  ListResourceSnapshotsResult& WithResourceSnapshotSummaries(ResourceSnapshotSummariesT&& value) {
    SetResourceSnapshotSummaries(std::forward<ResourceSnapshotSummariesT>(value));
    return *this;
  }
  template <typename ResourceSnapshotSummariesT = ResourceSnapshotSummary>
  ListResourceSnapshotsResult& AddResourceSnapshotSummaries(ResourceSnapshotSummariesT&& value) {
    m_resourceSnapshotSummariesHasBeenSet = true;
    m_resourceSnapshotSummaries.emplace_back(std::forward<ResourceSnapshotSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListResourceSnapshotsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListResourceSnapshotsResult& WithRequestId(RequestIdT&& value) {
