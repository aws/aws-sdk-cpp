...
class ListEngagementResourceAssociationsRequest : public PartnerCentralSellingRequest {
 public:
  ...
  template <typename CatalogT = Aws::String>
  ListEngagementResourceAssociationsRequest& WithCatalog(CatalogT&& value) {
  ...
  inline ListEngagementResourceAssociationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListEngagementResourceAssociationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename EngagementIdentifierT = Aws::String>
  ListEngagementResourceAssociationsRequest& WithEngagementIdentifier(EngagementIdentifierT&& value) {
  ...
  inline ListEngagementResourceAssociationsRequest& WithResourceType(ResourceType value) {
  ...
  template <typename ResourceIdentifierT = Aws::String>
  ListEngagementResourceAssociationsRequest& WithResourceIdentifier(ResourceIdentifierT&& value) {
  ...
  template <typename CreatedByT = Aws::String>
  ListEngagementResourceAssociationsRequest& WithCreatedBy(CreatedByT&& value) {
