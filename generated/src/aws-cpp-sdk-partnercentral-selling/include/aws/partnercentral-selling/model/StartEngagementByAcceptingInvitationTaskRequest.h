...
class StartEngagementByAcceptingInvitationTaskRequest : public PartnerCentralSellingRequest {
 public:
  ...
  template <typename CatalogT = Aws::String>
  StartEngagementByAcceptingInvitationTaskRequest& WithCatalog(CatalogT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  StartEngagementByAcceptingInvitationTaskRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename IdentifierT = Aws::String>
  StartEngagementByAcceptingInvitationTaskRequest& WithIdentifier(IdentifierT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  StartEngagementByAcceptingInvitationTaskRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  StartEngagementByAcceptingInvitationTaskRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
