...
class ListOpportunitiesResult {
 public:
  ...
  void SetOpportunitySummaries(OpportunitySummariesT&& value) {
    m_opportunitySummariesHasBeenSet = true;
    m_opportunitySummaries = std::forward<OpportunitySummariesT>(value);
  }
  template <typename OpportunitySummariesT = Aws::Vector<OpportunitySummary>>
  ListOpportunitiesResult& WithOpportunitySummaries(OpportunitySummariesT&& value) {
    SetOpportunitySummaries(std::forward<OpportunitySummariesT>(value));
    return *this;
  }
  template <typename OpportunitySummariesT = OpportunitySummary>
  ListOpportunitiesResult& AddOpportunitySummaries(OpportunitySummariesT&& value) {
    m_opportunitySummariesHasBeenSet = true;
    m_opportunitySummaries.emplace_back(std::forward<OpportunitySummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListOpportunitiesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListOpportunitiesResult& WithRequestId(RequestIdT&& value) {
