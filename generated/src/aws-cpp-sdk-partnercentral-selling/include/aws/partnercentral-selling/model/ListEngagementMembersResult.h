...
class ListEngagementMembersResult {
 public:
  ...
  AWS_PARTNERCENTRALSELLING_API ListEngagementMembersResult& operator=(
  ...
  void SetEngagementMemberList(EngagementMemberListT&& value) {
    m_engagementMemberListHasBeenSet = true;
    m_engagementMemberList = std::forward<EngagementMemberListT>(value);
  }
  template <typename EngagementMemberListT = Aws::Vector<EngagementMember>>
  ListEngagementMembersResult& WithEngagementMemberList(EngagementMemberListT&& value) {
    SetEngagementMemberList(std::forward<EngagementMemberListT>(value));
    return *this;
  }
  template <typename EngagementMemberListT = EngagementMember>
  ListEngagementMembersResult& AddEngagementMemberList(EngagementMemberListT&& value) {
    m_engagementMemberListHasBeenSet = true;
    m_engagementMemberList.emplace_back(std::forward<EngagementMemberListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListEngagementMembersResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListEngagementMembersResult& WithRequestId(RequestIdT&& value) {
