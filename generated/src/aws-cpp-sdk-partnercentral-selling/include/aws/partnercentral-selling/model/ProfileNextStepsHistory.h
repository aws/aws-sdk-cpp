...
namespace Model
{
  ...
  {
  public:
    AWS_PARTNERCENTRALSELLING_API ProfileNextStepsHistory();
    ...
    inline ProfileNextStepsHistory& WithTime(const Aws::Utils::DateTime& value) { SetTime(value); return *this;}
    inline ProfileNextStepsHistory& WithTime(Aws::Utils::DateTime&& value) { SetTime(std::move(value)); return *this;}
    ///@}
    ...
    inline ProfileNextStepsHistory& WithValue(const Aws::String& value) { SetValue(value); return *this;}
    inline ProfileNextStepsHistory& WithValue(Aws::String&& value) { SetValue(std::move(value)); return *this;}
    inline ProfileNextStepsHistory& WithValue(const char* value) { SetValue(value); return *this;}
    ///@}
  private:
