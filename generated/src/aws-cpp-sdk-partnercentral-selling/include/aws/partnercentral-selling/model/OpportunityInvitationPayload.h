...
class OpportunityInvitationPayload {
 public:
  ...
  void SetReceiverResponsibilities(ReceiverResponsibilitiesT&& value) {
    ...
    m_receiverResponsibilities = std::forward<ReceiverResponsibilitiesT>(value);
  }
  template <typename ReceiverResponsibilitiesT = Aws::Vector<ReceiverResponsibility>>
  OpportunityInvitationPayload& WithReceiverResponsibilities(ReceiverResponsibilitiesT&& value) {
    SetReceiverResponsibilities(std::forward<ReceiverResponsibilitiesT>(value));
    return *this;
  }
  inline OpportunityInvitationPayload& AddReceiverResponsibilities(ReceiverResponsibility value) {
    m_receiverResponsibilitiesHasBeenSet = true;
    m_receiverResponsibilities.push_back(value);
    return *this;
  }
  ///@}
