...
class UpdateOpportunityRequest : public PartnerCentralSellingRequest {
 public:
  ...
  inline UpdateOpportunityRequest& AddPrimaryNeedsFromAws(PrimaryNeedFromAws value) {
    m_primaryNeedsFromAwsHasBeenSet = true;
  ...
  inline UpdateOpportunityRequest& WithNationalSecurity(NationalSecurity value) {
  ...
  inline UpdateOpportunityRequest& WithOpportunityType(OpportunityType value) {
