...
class StartEngagementFromOpportunityTaskRequest : public PartnerCentralSellingRequest {
 public:
  ...
  template <typename CatalogT = Aws::String>
  StartEngagementFromOpportunityTaskRequest& WithCatalog(CatalogT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  StartEngagementFromOpportunityTaskRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename IdentifierT = Aws::String>
  StartEngagementFromOpportunityTaskRequest& WithIdentifier(IdentifierT&& value) {
  ...
  void SetAwsSubmission(AwsSubmissionT&& value) {
    m_awsSubmissionHasBeenSet = true;
    m_awsSubmission = std::forward<AwsSubmissionT>(value);
  }
  template <typename AwsSubmissionT = AwsSubmission>
  StartEngagementFromOpportunityTaskRequest& WithAwsSubmission(AwsSubmissionT&& value) {
    SetAwsSubmission(std::forward<AwsSubmissionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  StartEngagementFromOpportunityTaskRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  StartEngagementFromOpportunityTaskRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
