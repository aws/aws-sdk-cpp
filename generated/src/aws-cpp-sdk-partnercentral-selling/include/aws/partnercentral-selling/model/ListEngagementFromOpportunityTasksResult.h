...
class ListEngagementFromOpportunityTasksResult {
 public:
  ...
  AWS_PARTNERCENTRALSELLING_API ListEngagementFromOpportunityTasksResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename TaskSummariesT = Aws::Vector<ListEngagementFromOpportunityTaskSummary>>
  ListEngagementFromOpportunityTasksResult& WithTaskSummaries(TaskSummariesT&& value) {
  ...
  ListEngagementFromOpportunityTasksResult& AddTaskSummaries(TaskSummariesT&& value) {
    m_taskSummariesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListEngagementFromOpportunityTasksResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListEngagementFromOpportunityTasksResult& WithRequestId(RequestIdT&& value) {
