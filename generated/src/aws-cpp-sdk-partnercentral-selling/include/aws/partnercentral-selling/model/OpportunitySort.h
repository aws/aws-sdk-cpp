...
class OpportunitySort {
 public:
  ...
  inline OpportunitySort& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSortBy(OpportunitySortName value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline OpportunitySort& WithSortBy(OpportunitySortName value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
