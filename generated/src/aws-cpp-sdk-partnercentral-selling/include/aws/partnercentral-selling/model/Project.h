...
class Project {
 public:
  ...
  inline Project& AddDeliveryModels(DeliveryModel value) {
    m_deliveryModelsHasBeenSet = true;
  ...
  void SetApnPrograms(ApnProgramsT&& value) {
    ...
    m_apnPrograms = std::forward<ApnProgramsT>(value);
  }
  template <typename ApnProgramsT = Aws::Vector<Aws::String>>
  Project& WithApnPrograms(ApnProgramsT&& value) {
    SetApnPrograms(std::forward<ApnProgramsT>(value));
    return *this;
  }
  template <typename ApnProgramsT = Aws::String>
  Project& AddApnPrograms(ApnProgramsT&& value) {
    m_apnProgramsHasBeenSet = true;
    m_apnPrograms.emplace_back(std::forward<ApnProgramsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCustomerBusinessProblem(CustomerBusinessProblemT&& value) {
    ...
    m_customerBusinessProblem = std::forward<CustomerBusinessProblemT>(value);
  }
  template <typename CustomerBusinessProblemT = Aws::String>
  Project& WithCustomerBusinessProblem(CustomerBusinessProblemT&& value) {
    SetCustomerBusinessProblem(std::forward<CustomerBusinessProblemT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCustomerUseCase(CustomerUseCaseT&& value) {
    ...
    m_customerUseCase = std::forward<CustomerUseCaseT>(value);
  }
  template <typename CustomerUseCaseT = Aws::String>
  Project& WithCustomerUseCase(CustomerUseCaseT&& value) {
    SetCustomerUseCase(std::forward<CustomerUseCaseT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSalesActivities(SalesActivitiesT&& value) {
    ...
    m_salesActivities = std::forward<SalesActivitiesT>(value);
  }
  template <typename SalesActivitiesT = Aws::Vector<SalesActivity>>
  Project& WithSalesActivities(SalesActivitiesT&& value) {
    SetSalesActivities(std::forward<SalesActivitiesT>(value));
    return *this;
  }
  inline Project& AddSalesActivities(SalesActivity value) {
    m_salesActivitiesHasBeenSet = true;
    m_salesActivities.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCompetitorName(CompetitorName value) {
    m_competitorNameHasBeenSet = true;
    m_competitorName = value;
  }
  inline Project& WithCompetitorName(CompetitorName value) {
    SetCompetitorName(value);
    return *this;
  }
  ///@}
  ...
  void SetOtherCompetitorNames(OtherCompetitorNamesT&& value) {
    ...
    m_otherCompetitorNames = std::forward<OtherCompetitorNamesT>(value);
  }
  template <typename OtherCompetitorNamesT = Aws::String>
  Project& WithOtherCompetitorNames(OtherCompetitorNamesT&& value) {
    SetOtherCompetitorNames(std::forward<OtherCompetitorNamesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOtherSolutionDescription(OtherSolutionDescriptionT&& value) {
    ...
    m_otherSolutionDescription = std::forward<OtherSolutionDescriptionT>(value);
  }
  template <typename OtherSolutionDescriptionT = Aws::String>
  Project& WithOtherSolutionDescription(OtherSolutionDescriptionT&& value) {
    SetOtherSolutionDescription(std::forward<OtherSolutionDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAdditionalComments(AdditionalCommentsT&& value) {
    ...
    m_additionalComments = std::forward<AdditionalCommentsT>(value);
  }
  template <typename AdditionalCommentsT = Aws::String>
  Project& WithAdditionalComments(AdditionalCommentsT&& value) {
    SetAdditionalComments(std::forward<AdditionalCommentsT>(value));
    return *this;
  }
  ///@}
 private:
