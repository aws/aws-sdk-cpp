...
class GetEngagementInvitationResult {
 public:
  ...
  AWS_PARTNERCENTRALSELLING_API GetEngagementInvitationResult& operator=(
  ...
  inline GetEngagementInvitationResult& WithPayloadType(EngagementInvitationPayloadType value) {
  ...
  inline GetEngagementInvitationResult& WithStatus(InvitationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetEngagementDescription(EngagementDescriptionT&& value) {
    ...
    m_engagementDescription = std::forward<EngagementDescriptionT>(value);
  }
  template <typename EngagementDescriptionT = Aws::String>
  GetEngagementInvitationResult& WithEngagementDescription(EngagementDescriptionT&& value) {
    SetEngagementDescription(std::forward<EngagementDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExistingMembers(ExistingMembersT&& value) {
    ...
    m_existingMembers = std::forward<ExistingMembersT>(value);
  }
  template <typename ExistingMembersT = Aws::Vector<EngagementMemberSummary>>
  GetEngagementInvitationResult& WithExistingMembers(ExistingMembersT&& value) {
    SetExistingMembers(std::forward<ExistingMembersT>(value));
    return *this;
  }
  ...
  GetEngagementInvitationResult& AddExistingMembers(ExistingMembersT&& value) {
    m_existingMembersHasBeenSet = true;
    m_existingMembers.emplace_back(std::forward<ExistingMembersT>(value));
    return *this;
  }
  ///@}
