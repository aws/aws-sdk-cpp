...
class ListEngagementMembersRequest : public PartnerCentralSellingRequest {
 public:
  ...
  template <typename CatalogT = Aws::String>
  ListEngagementMembersRequest& WithCatalog(CatalogT&& value) {
  ...
  template <typename IdentifierT = Aws::String>
  ListEngagementMembersRequest& WithIdentifier(IdentifierT&& value) {
  ...
  inline ListEngagementMembersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListEngagementMembersRequest& WithNextToken(NextTokenT&& value) {
