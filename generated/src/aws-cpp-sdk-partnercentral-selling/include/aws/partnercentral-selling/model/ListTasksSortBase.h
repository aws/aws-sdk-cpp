...
class ListTasksSortBase {
 public:
  ...
  inline ListTasksSortBase& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSortBy(ListTasksSortName value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ListTasksSortBase& WithSortBy(ListTasksSortName value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
