...
class GetOpportunityResult {
 public:
  ...
  void SetPrimaryNeedsFromAws(PrimaryNeedsFromAwsT&& value) {
    ...
    m_primaryNeedsFromAws = std::forward<PrimaryNeedsFromAwsT>(value);
  }
  template <typename PrimaryNeedsFromAwsT = Aws::Vector<PrimaryNeedFromAws>>
  GetOpportunityResult& WithPrimaryNeedsFromAws(PrimaryNeedsFromAwsT&& value) {
    SetPrimaryNeedsFromAws(std::forward<PrimaryNeedsFromAwsT>(value));
    return *this;
  }
  inline GetOpportunityResult& AddPrimaryNeedsFromAws(PrimaryNeedFromAws value) {
    m_primaryNeedsFromAwsHasBeenSet = true;
    m_primaryNeedsFromAws.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNationalSecurity(NationalSecurity value) {
    m_nationalSecurityHasBeenSet = true;
    m_nationalSecurity = value;
  }
  inline GetOpportunityResult& WithNationalSecurity(NationalSecurity value) {
    SetNationalSecurity(value);
    return *this;
  }
  ///@}
  ...
  inline GetOpportunityResult& WithOpportunityType(OpportunityType value) {
  ...
  void SetMarketing(MarketingT&& value) {
    ...
    m_marketing = std::forward<MarketingT>(value);
  }
  template <typename MarketingT = Marketing>
  GetOpportunityResult& WithMarketing(MarketingT&& value) {
    SetMarketing(std::forward<MarketingT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRelatedEntityIdentifiers(RelatedEntityIdentifiersT&& value) {
    ...
    m_relatedEntityIdentifiers = std::forward<RelatedEntityIdentifiersT>(value);
  }
  template <typename RelatedEntityIdentifiersT = RelatedEntityIdentifiers>
  GetOpportunityResult& WithRelatedEntityIdentifiers(RelatedEntityIdentifiersT&& value) {
    SetRelatedEntityIdentifiers(std::forward<RelatedEntityIdentifiersT>(value));
    return *this;
  }
  ///@}
