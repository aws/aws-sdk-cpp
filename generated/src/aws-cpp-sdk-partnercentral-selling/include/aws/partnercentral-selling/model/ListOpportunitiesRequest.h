...
class ListOpportunitiesRequest : public PartnerCentralSellingRequest {
 public:
  ...
  inline ListOpportunitiesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  ListOpportunitiesRequest& AddIdentifier(IdentifierT&& value) {
    m_identifierHasBeenSet = true;
    m_identifier.emplace_back(std::forward<IdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLifeCycleStage(LifeCycleStageT&& value) {
    ...
    m_lifeCycleStage = std::forward<LifeCycleStageT>(value);
  }
  template <typename LifeCycleStageT = Aws::Vector<Stage>>
  ListOpportunitiesRequest& WithLifeCycleStage(LifeCycleStageT&& value) {
    SetLifeCycleStage(std::forward<LifeCycleStageT>(value));
    return *this;
  }
  inline ListOpportunitiesRequest& AddLifeCycleStage(Stage value) {
    m_lifeCycleStageHasBeenSet = true;
    m_lifeCycleStage.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetLifeCycleReviewStatus(LifeCycleReviewStatusT&& value) {
    m_lifeCycleReviewStatusHasBeenSet = true;
    m_lifeCycleReviewStatus = std::forward<LifeCycleReviewStatusT>(value);
  }
  template <typename LifeCycleReviewStatusT = Aws::Vector<ReviewStatus>>
  ListOpportunitiesRequest& WithLifeCycleReviewStatus(LifeCycleReviewStatusT&& value) {
    SetLifeCycleReviewStatus(std::forward<LifeCycleReviewStatusT>(value));
    return *this;
  }
  inline ListOpportunitiesRequest& AddLifeCycleReviewStatus(ReviewStatus value) {
    m_lifeCycleReviewStatusHasBeenSet = true;
    m_lifeCycleReviewStatus.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetCustomerCompanyName(CustomerCompanyNameT&& value) {
    m_customerCompanyNameHasBeenSet = true;
    m_customerCompanyName = std::forward<CustomerCompanyNameT>(value);
  }
  template <typename CustomerCompanyNameT = Aws::Vector<Aws::String>>
  ListOpportunitiesRequest& WithCustomerCompanyName(CustomerCompanyNameT&& value) {
    SetCustomerCompanyName(std::forward<CustomerCompanyNameT>(value));
    return *this;
  }
  ...
  ListOpportunitiesRequest& AddCustomerCompanyName(CustomerCompanyNameT&& value) {
    m_customerCompanyNameHasBeenSet = true;
    m_customerCompanyName.emplace_back(std::forward<CustomerCompanyNameT>(value));
    return *this;
  }
  ///@}
 private:
