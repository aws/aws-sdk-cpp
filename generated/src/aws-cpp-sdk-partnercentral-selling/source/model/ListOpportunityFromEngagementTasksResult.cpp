...
ListOpportunityFromEngagementTasksResult::ListOpportunityFromEngagementTasksResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

ListOpportunityFromEngagementTasksResult& ListOpportunityFromEngagementTasksResult::operator=(
