...
Aws::String ListEngagementByAcceptingInvitationTasksRequest::SerializePayload() const {
  ...
  if (m_engagementInvitationIdentifierHasBeenSet) {
    ...
    for (unsigned engagementInvitationIdentifierIndex = 0;
         engagementInvitationIdentifierIndex < engagementInvitationIdentifierJsonList.GetLength(); ++engagementInvitationIdentifierIndex) {
      engagementInvitationIdentifierJsonList[engagementInvitationIdentifierIndex].AsString(
          m_engagementInvitationIdentifier[engagementInvitationIdentifierIndex]);
    }
