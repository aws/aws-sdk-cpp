...
ListEngagementByAcceptingInvitationTasksResult::ListEngagementByAcceptingInvitationTasksResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListEngagementByAcceptingInvitationTasksResult& ListEngagementByAcceptingInvitationTasksResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
