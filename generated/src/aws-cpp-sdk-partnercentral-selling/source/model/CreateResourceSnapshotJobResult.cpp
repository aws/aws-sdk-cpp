...
CreateResourceSnapshotJobResult::CreateResourceSnapshotJobResult()
{
}

CreateResourceSnapshotJobResult::CreateResourceSnapshotJobResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
