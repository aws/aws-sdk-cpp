...
ListProspectingFromEngagementTasksResult::ListProspectingFromEngagementTasksResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

ListProspectingFromEngagementTasksResult& ListProspectingFromEngagementTasksResult::operator=(
