...
namespace WellArchitected
{
   ...
   * Tool User Guide</a>.</p>
   */
  class AWS_WELLARCHITECTED_API WellArchitectedClient : Aws::Client::ClientWithAsyncTemplateMethods<WellArchitectedClient>,
    smithy::client::AwsSmithyClientT<Aws::WellArchitected::SERVICE_NAME,
