...
class AWS_WELLARCHITECTED_API WellArchitectedClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  WellArchitectedClient(const Aws::WellArchitected::WellArchitectedClientConfiguration& clientConfiguration =
  ...
  WellArchitectedClient(const Aws::Auth::AWSCredentials& credentials,
                        std::shared_ptr<WellArchitectedEndpointProviderBase> endpointProvider = nullptr,
                        const Aws::WellArchitected::WellArchitectedClientConfiguration& clientConfiguration =
                            Aws::WellArchitected::WellArchitectedClientConfiguration());
  ...
  /**
   * An Async wrapper for AssociateLenses that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename AssociateLensesRequestT = Model::AssociateLensesRequest>
  void AssociateLensesAsync(const AssociateLensesRequestT& request, const AssociateLensesResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for AssociateProfiles that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssociateProfiles that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename AssociateProfilesRequestT = Model::AssociateProfilesRequest>
  ...
  /**
   * An Async wrapper for CreateLensShare that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateLensShareRequestT = Model::CreateLensShareRequest>
  void CreateLensShareAsync(const CreateLensShareRequestT& request, const CreateLensShareResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateLensVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateLensVersion that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateLensVersionRequestT = Model::CreateLensVersionRequest>
  void CreateLensVersionAsync(const CreateLensVersionRequestT& request, const CreateLensVersionResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateMilestone that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateMilestoneRequestT = Model::CreateMilestoneRequest>
  void CreateMilestoneAsync(const CreateMilestoneRequestT& request, const CreateMilestoneResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateProfileShare that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateProfileShare that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateProfileShareRequestT = Model::CreateProfileShareRequest>
  void CreateProfileShareAsync(const CreateProfileShareRequestT& request, const CreateProfileShareResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateReviewTemplate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateReviewTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateReviewTemplateRequestT = Model::CreateReviewTemplateRequest>
  void CreateReviewTemplateAsync(const CreateReviewTemplateRequestT& request, const CreateReviewTemplateResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateTemplateShare that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateTemplateShare that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateTemplateShareRequestT = Model::CreateTemplateShareRequest>
  void CreateTemplateShareAsync(const CreateTemplateShareRequestT& request, const CreateTemplateShareResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateWorkload that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateWorkloadRequestT = Model::CreateWorkloadRequest>
  void CreateWorkloadAsync(const CreateWorkloadRequestT& request, const CreateWorkloadResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateWorkloadShare that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateWorkloadShare that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateWorkloadShareRequestT = Model::CreateWorkloadShareRequest>
  ...
  /**
   * An Async wrapper for DeleteLens that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteLensRequestT = Model::DeleteLensRequest>
  void DeleteLensAsync(const DeleteLensRequestT& request, const DeleteLensResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteLensShare that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteLensShareRequestT = Model::DeleteLensShareRequest>
  void DeleteLensShareAsync(const DeleteLensShareRequestT& request, const DeleteLensShareResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteProfileShare that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteProfileShare that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteProfileShareRequestT = Model::DeleteProfileShareRequest>
  void DeleteProfileShareAsync(const DeleteProfileShareRequestT& request, const DeleteProfileShareResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteReviewTemplate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteReviewTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteReviewTemplateRequestT = Model::DeleteReviewTemplateRequest>
  void DeleteReviewTemplateAsync(const DeleteReviewTemplateRequestT& request, const DeleteReviewTemplateResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteTemplateShare that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteTemplateShare that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteTemplateShareRequestT = Model::DeleteTemplateShareRequest>
  void DeleteTemplateShareAsync(const DeleteTemplateShareRequestT& request, const DeleteTemplateShareResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteWorkload that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteWorkloadRequestT = Model::DeleteWorkloadRequest>
  void DeleteWorkloadAsync(const DeleteWorkloadRequestT& request, const DeleteWorkloadResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteWorkloadShare that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteWorkloadShare that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteWorkloadShareRequestT = Model::DeleteWorkloadShareRequest>
  void DeleteWorkloadShareAsync(const DeleteWorkloadShareRequestT& request, const DeleteWorkloadShareResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DisassociateLenses that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DisassociateLenses that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DisassociateLensesRequestT = Model::DisassociateLensesRequest>
  void DisassociateLensesAsync(const DisassociateLensesRequestT& request, const DisassociateLensesResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DisassociateProfiles that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DisassociateProfiles that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateProfilesRequestT = Model::DisassociateProfilesRequest>
  void DisassociateProfilesAsync(const DisassociateProfilesRequestT& request, const DisassociateProfilesResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ExportLens that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ExportLensRequestT = Model::ExportLensRequest>
  ...
  /**
   * An Async wrapper for GetAnswer that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetAnswerRequestT = Model::GetAnswerRequest>
  void GetAnswerAsync(const GetAnswerRequestT& request, const GetAnswerResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetConsolidatedReport that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetConsolidatedReport that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetConsolidatedReportRequestT = Model::GetConsolidatedReportRequest>
  void GetConsolidatedReportAsync(const GetConsolidatedReportRequestT& request, const GetConsolidatedReportResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetLens that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetLensRequestT = Model::GetLensRequest>
  void GetLensAsync(const GetLensRequestT& request, const GetLensResponseReceivedHandler& handler,
                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetLensReview that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetLensReviewRequestT = Model::GetLensReviewRequest>
  void GetLensReviewAsync(const GetLensReviewRequestT& request, const GetLensReviewResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetLensReviewReport that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetLensReviewReport that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetLensReviewReportRequestT = Model::GetLensReviewReportRequest>
  void GetLensReviewReportAsync(const GetLensReviewReportRequestT& request, const GetLensReviewReportResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetLensVersionDifference that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetLensVersionDifference that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetLensVersionDifferenceRequestT = Model::GetLensVersionDifferenceRequest>
  void GetLensVersionDifferenceAsync(const GetLensVersionDifferenceRequestT& request,
                                     const GetLensVersionDifferenceResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetMilestone that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetMilestoneRequestT = Model::GetMilestoneRequest>
  void GetMilestoneAsync(const GetMilestoneRequestT& request, const GetMilestoneResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetProfileTemplate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetProfileTemplate that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetProfileTemplateRequestT = Model::GetProfileTemplateRequest>
  void GetProfileTemplateAsync(const GetProfileTemplateResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const GetProfileTemplateRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetReviewTemplate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetReviewTemplate that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetReviewTemplateRequestT = Model::GetReviewTemplateRequest>
  void GetReviewTemplateAsync(const GetReviewTemplateRequestT& request, const GetReviewTemplateResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetReviewTemplateAnswer that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetReviewTemplateAnswer that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetReviewTemplateAnswerRequestT = Model::GetReviewTemplateAnswerRequest>
  void GetReviewTemplateAnswerAsync(const GetReviewTemplateAnswerRequestT& request,
                                    const GetReviewTemplateAnswerResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetReviewTemplateLensReviewOutcome GetReviewTemplateLensReview(
      const Model::GetReviewTemplateLensReviewRequest& request) const;

  /**
   * A Callable wrapper for GetReviewTemplateLensReview that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetReviewTemplateLensReviewRequestT = Model::GetReviewTemplateLensReviewRequest>
  Model::GetReviewTemplateLensReviewOutcomeCallable GetReviewTemplateLensReviewCallable(
      const GetReviewTemplateLensReviewRequestT& request) const {
    return SubmitCallable(&WellArchitectedClient::GetReviewTemplateLensReview, request);
  }

  /**
   * An Async wrapper for GetReviewTemplateLensReview that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetReviewTemplateLensReviewRequestT = Model::GetReviewTemplateLensReviewRequest>
  void GetReviewTemplateLensReviewAsync(const GetReviewTemplateLensReviewRequestT& request,
                                        const GetReviewTemplateLensReviewResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetWorkload that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetWorkloadRequestT = Model::GetWorkloadRequest>
  void GetWorkloadAsync(const GetWorkloadRequestT& request, const GetWorkloadResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ImportLens that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ImportLensRequestT = Model::ImportLensRequest>
  ...
  /**
   * An Async wrapper for ListAnswers that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListAnswersRequestT = Model::ListAnswersRequest>
  void ListAnswersAsync(const ListAnswersRequestT& request, const ListAnswersResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListCheckDetails that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListCheckDetails that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListCheckDetailsRequestT = Model::ListCheckDetailsRequest>
  void ListCheckDetailsAsync(const ListCheckDetailsRequestT& request, const ListCheckDetailsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListCheckSummaries that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListCheckSummaries that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListCheckSummariesRequestT = Model::ListCheckSummariesRequest>
  void ListCheckSummariesAsync(const ListCheckSummariesRequestT& request, const ListCheckSummariesResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListLensReviewImprovementsOutcome ListLensReviewImprovements(
      const Model::ListLensReviewImprovementsRequest& request) const;

  /**
   * A Callable wrapper for ListLensReviewImprovements that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListLensReviewImprovementsRequestT = Model::ListLensReviewImprovementsRequest>
  Model::ListLensReviewImprovementsOutcomeCallable ListLensReviewImprovementsCallable(
      const ListLensReviewImprovementsRequestT& request) const {
    return SubmitCallable(&WellArchitectedClient::ListLensReviewImprovements, request);
  }

  /**
   * An Async wrapper for ListLensReviewImprovements that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListLensReviewImprovementsRequestT = Model::ListLensReviewImprovementsRequest>
  void ListLensReviewImprovementsAsync(const ListLensReviewImprovementsRequestT& request,
                                       const ListLensReviewImprovementsResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListLensReviews that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListLensReviewsRequestT = Model::ListLensReviewsRequest>
  void ListLensReviewsAsync(const ListLensReviewsRequestT& request, const ListLensReviewsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListLensShares that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListLensSharesRequestT = Model::ListLensSharesRequest>
  void ListLensSharesAsync(const ListLensSharesRequestT& request, const ListLensSharesResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListLenses that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListLensesRequestT = Model::ListLensesRequest>
  void ListLensesAsync(const ListLensesResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                       const ListLensesRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListMilestones that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListMilestonesRequestT = Model::ListMilestonesRequest>
  void ListMilestonesAsync(const ListMilestonesRequestT& request, const ListMilestonesResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename ListNotificationsRequestT = Model::ListNotificationsRequest>
  void ListNotificationsAsync(const ListNotificationsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const ListNotificationsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListProfileNotifications that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListProfileNotificationsRequestT = Model::ListProfileNotificationsRequest>
  Model::ListProfileNotificationsOutcomeCallable ListProfileNotificationsCallable(
      const ListProfileNotificationsRequestT& request = {}) const {
    return SubmitCallable(&WellArchitectedClient::ListProfileNotifications, request);
  }

  /**
   * An Async wrapper for ListProfileNotifications that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListProfileNotificationsRequestT = Model::ListProfileNotificationsRequest>
  void ListProfileNotificationsAsync(const ListProfileNotificationsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const ListProfileNotificationsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListProfileShares that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListProfileShares that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListProfileSharesRequestT = Model::ListProfileSharesRequest>
  void ListProfileSharesAsync(const ListProfileSharesRequestT& request, const ListProfileSharesResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListReviewTemplateAnswers that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListReviewTemplateAnswersRequestT = Model::ListReviewTemplateAnswersRequest>
  Model::ListReviewTemplateAnswersOutcomeCallable ListReviewTemplateAnswersCallable(
      const ListReviewTemplateAnswersRequestT& request) const {
    return SubmitCallable(&WellArchitectedClient::ListReviewTemplateAnswers, request);
  }

  /**
   * An Async wrapper for ListReviewTemplateAnswers that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListReviewTemplateAnswersRequestT = Model::ListReviewTemplateAnswersRequest>
  void ListReviewTemplateAnswersAsync(const ListReviewTemplateAnswersRequestT& request,
                                      const ListReviewTemplateAnswersResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListReviewTemplates that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListReviewTemplates that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListReviewTemplatesRequestT = Model::ListReviewTemplatesRequest>
  void ListReviewTemplatesAsync(const ListReviewTemplatesResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const ListReviewTemplatesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListShareInvitations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListShareInvitations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListShareInvitationsRequestT = Model::ListShareInvitationsRequest>
  void ListShareInvitationsAsync(const ListShareInvitationsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const ListShareInvitationsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListTemplateShares that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListTemplateShares that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListTemplateSharesRequestT = Model::ListTemplateSharesRequest>
  void ListTemplateSharesAsync(const ListTemplateSharesRequestT& request, const ListTemplateSharesResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListWorkloadShares that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListWorkloadShares that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListWorkloadSharesRequestT = Model::ListWorkloadSharesRequest>
  void ListWorkloadSharesAsync(const ListWorkloadSharesRequestT& request, const ListWorkloadSharesResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename ListWorkloadsRequestT = Model::ListWorkloadsRequest>
  void ListWorkloadsAsync(const ListWorkloadsResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                          const ListWorkloadsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for UpdateAnswer that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateAnswerRequestT = Model::UpdateAnswerRequest>
  void UpdateAnswerAsync(const UpdateAnswerRequestT& request, const UpdateAnswerResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateLensReview that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateLensReview that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateLensReviewRequestT = Model::UpdateLensReviewRequest>
  void UpdateLensReviewAsync(const UpdateLensReviewRequestT& request, const UpdateLensReviewResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateReviewTemplate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateReviewTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateReviewTemplateRequestT = Model::UpdateReviewTemplateRequest>
  void UpdateReviewTemplateAsync(const UpdateReviewTemplateRequestT& request, const UpdateReviewTemplateResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateReviewTemplateAnswerOutcome UpdateReviewTemplateAnswer(
      const Model::UpdateReviewTemplateAnswerRequest& request) const;

  /**
   * A Callable wrapper for UpdateReviewTemplateAnswer that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateReviewTemplateAnswerRequestT = Model::UpdateReviewTemplateAnswerRequest>
  Model::UpdateReviewTemplateAnswerOutcomeCallable UpdateReviewTemplateAnswerCallable(
      const UpdateReviewTemplateAnswerRequestT& request) const {
    return SubmitCallable(&WellArchitectedClient::UpdateReviewTemplateAnswer, request);
  }

  /**
   * An Async wrapper for UpdateReviewTemplateAnswer that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateReviewTemplateAnswerRequestT = Model::UpdateReviewTemplateAnswerRequest>
  void UpdateReviewTemplateAnswerAsync(const UpdateReviewTemplateAnswerRequestT& request,
                                       const UpdateReviewTemplateAnswerResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateReviewTemplateLensReviewOutcome UpdateReviewTemplateLensReview(
      const Model::UpdateReviewTemplateLensReviewRequest& request) const;

  /**
   * A Callable wrapper for UpdateReviewTemplateLensReview that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateReviewTemplateLensReviewRequestT = Model::UpdateReviewTemplateLensReviewRequest>
  Model::UpdateReviewTemplateLensReviewOutcomeCallable UpdateReviewTemplateLensReviewCallable(
      const UpdateReviewTemplateLensReviewRequestT& request) const {
    return SubmitCallable(&WellArchitectedClient::UpdateReviewTemplateLensReview, request);
  }

  /**
   * An Async wrapper for UpdateReviewTemplateLensReview that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateReviewTemplateLensReviewRequestT = Model::UpdateReviewTemplateLensReviewRequest>
  void UpdateReviewTemplateLensReviewAsync(const UpdateReviewTemplateLensReviewRequestT& request,
                                           const UpdateReviewTemplateLensReviewResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateShareInvitation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateShareInvitation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateShareInvitationRequestT = Model::UpdateShareInvitationRequest>
  void UpdateShareInvitationAsync(const UpdateShareInvitationRequestT& request, const UpdateShareInvitationResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateWorkloadShare that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateWorkloadShare that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateWorkloadShareRequestT = Model::UpdateWorkloadShareRequest>
  void UpdateWorkloadShareAsync(const UpdateWorkloadShareRequestT& request, const UpdateWorkloadShareResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpgradeLensReview that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpgradeLensReview that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpgradeLensReviewRequestT = Model::UpgradeLensReviewRequest>
  void UpgradeLensReviewAsync(const UpgradeLensReviewRequestT& request, const UpgradeLensReviewResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpgradeProfileVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpgradeProfileVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpgradeProfileVersionRequestT = Model::UpgradeProfileVersionRequest>
  void UpgradeProfileVersionAsync(const UpgradeProfileVersionRequestT& request, const UpgradeProfileVersionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpgradeReviewTemplateLensReviewOutcome UpgradeReviewTemplateLensReview(
      const Model::UpgradeReviewTemplateLensReviewRequest& request) const;

  /**
   * A Callable wrapper for UpgradeReviewTemplateLensReview that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpgradeReviewTemplateLensReviewRequestT = Model::UpgradeReviewTemplateLensReviewRequest>
  Model::UpgradeReviewTemplateLensReviewOutcomeCallable UpgradeReviewTemplateLensReviewCallable(
      const UpgradeReviewTemplateLensReviewRequestT& request) const {
    return SubmitCallable(&WellArchitectedClient::UpgradeReviewTemplateLensReview, request);
  }

  /**
   * An Async wrapper for UpgradeReviewTemplateLensReview that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpgradeReviewTemplateLensReviewRequestT = Model::UpgradeReviewTemplateLensReviewRequest>
  void UpgradeReviewTemplateLensReviewAsync(const UpgradeReviewTemplateLensReviewRequestT& request,
                                            const UpgradeReviewTemplateLensReviewResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
