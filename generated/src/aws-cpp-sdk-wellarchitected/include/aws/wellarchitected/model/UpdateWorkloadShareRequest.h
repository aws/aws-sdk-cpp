...
class UpdateWorkloadShareRequest : public WellArchitectedRequest {
 public:
  ...
  template <typename ShareIdT = Aws::String>
  UpdateWorkloadShareRequest& WithShareId(ShareIdT&& value) {
  ...
  template <typename WorkloadIdT = Aws::String>
  UpdateWorkloadShareRequest& WithWorkloadId(WorkloadIdT&& value) {
  ...
  inline UpdateWorkloadShareRequest& WithPermissionType(PermissionType value) {
