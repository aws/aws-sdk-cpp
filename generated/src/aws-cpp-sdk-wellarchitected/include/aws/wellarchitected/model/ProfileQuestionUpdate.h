...
class ProfileQuestionUpdate {
 public:
  ...
  void SetSelectedChoiceIds(SelectedChoiceIdsT&& value) {
    ...
    m_selectedChoiceIds = std::forward<SelectedChoiceIdsT>(value);
  }
  template <typename SelectedChoiceIdsT = Aws::Vector<Aws::String>>
  ProfileQuestionUpdate& WithSelectedChoiceIds(SelectedChoiceIdsT&& value) {
    SetSelectedChoiceIds(std::forward<SelectedChoiceIdsT>(value));
    return *this;
  }
  template <typename SelectedChoiceIdsT = Aws::String>
  ProfileQuestionUpdate& AddSelectedChoiceIds(SelectedChoiceIdsT&& value) {
    m_selectedChoiceIdsHasBeenSet = true;
    m_selectedChoiceIds.emplace_back(std::forward<SelectedChoiceIdsT>(value));
    return *this;
  }
  ///@}
 private:
