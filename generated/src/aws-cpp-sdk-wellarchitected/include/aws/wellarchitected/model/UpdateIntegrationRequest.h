...
class UpdateIntegrationRequest : public WellArchitectedRequest {
 public:
  ...
  inline void SetIntegratingService(IntegratingService value) {
    m_integratingServiceHasBeenSet = true;
    m_integratingService = value;
  }
  inline UpdateIntegrationRequest& WithIntegratingService(IntegratingService value) {
    SetIntegratingService(value);
    return *this;
  }
  ///@}
 private:
