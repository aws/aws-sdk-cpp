...
class SelectedPillar {
 public:
  ...
  void SetSelectedQuestionIds(SelectedQuestionIdsT&& value) {
    ...
    m_selectedQuestionIds = std::forward<SelectedQuestionIdsT>(value);
  }
  template <typename SelectedQuestionIdsT = Aws::Vector<Aws::String>>
  SelectedPillar& WithSelectedQuestionIds(SelectedQuestionIdsT&& value) {
    SetSelectedQuestionIds(std::forward<SelectedQuestionIdsT>(value));
    return *this;
  }
  template <typename SelectedQuestionIdsT = Aws::String>
  SelectedPillar& AddSelectedQuestionIds(SelectedQuestionIdsT&& value) {
    m_selectedQuestionIdsHasBeenSet = true;
    m_selectedQuestionIds.emplace_back(std::forward<SelectedQuestionIdsT>(value));
    return *this;
  }
  ///@}
 private:
