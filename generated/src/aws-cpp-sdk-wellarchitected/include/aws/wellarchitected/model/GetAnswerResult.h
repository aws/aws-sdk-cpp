...
class GetAnswerResult {
 public:
  ...
  template <typename WorkloadIdT = Aws::String>
  GetAnswerResult& WithWorkloadId(WorkloadIdT&& value) {
  ...
  inline GetAnswerResult& WithMilestoneNumber(int value) {
  ...
  template <typename LensAliasT = Aws::String>
  GetAnswerResult& WithLensAlias(LensAliasT&& value) {
  ...
  template <typename LensArnT = Aws::String>
  GetAnswerResult& WithLensArn(LensArnT&& value) {
  ...
  template <typename AnswerT = Answer>
  GetAnswerResult& WithAnswer(AnswerT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetAnswerResult& WithRequestId(RequestIdT&& value) {
