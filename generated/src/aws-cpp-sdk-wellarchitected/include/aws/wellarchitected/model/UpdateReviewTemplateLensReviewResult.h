...
class UpdateReviewTemplateLensReviewResult {
 public:
  ...
  AWS_WELLARCHITECTED_API UpdateReviewTemplateLensReviewResult& operator=(
  ...
  template <typename TemplateArnT = Aws::String>
  UpdateReviewTemplateLensReviewResult& WithTemplateArn(TemplateArnT&& value) {
  ...
  template <typename LensReviewT = ReviewTemplateLensReview>
  UpdateReviewTemplateLensReviewResult& WithLensReview(LensReviewT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateReviewTemplateLensReviewResult& WithRequestId(RequestIdT&& value) {
