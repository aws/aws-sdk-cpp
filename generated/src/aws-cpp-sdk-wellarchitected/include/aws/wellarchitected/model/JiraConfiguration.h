...
class JiraConfiguration {
 public:
  ...
  void SetJiraIssueUrl(JiraIssueUrlT&& value) {
    ...
    m_jiraIssueUrl = std::forward<JiraIssueUrlT>(value);
  }
  template <typename JiraIssueUrlT = Aws::String>
  JiraConfiguration& WithJiraIssueUrl(JiraIssueUrlT&& value) {
    SetJiraIssueUrl(std::forward<JiraIssueUrlT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastSyncedTime(LastSyncedTimeT&& value) {
    ...
    m_lastSyncedTime = std::forward<LastSyncedTimeT>(value);
  }
  template <typename LastSyncedTimeT = Aws::Utils::DateTime>
  JiraConfiguration& WithLastSyncedTime(LastSyncedTimeT&& value) {
    SetLastSyncedTime(std::forward<LastSyncedTimeT>(value));
    return *this;
  }
  ///@}
 private:
