...
class CreateTemplateShareResult {
 public:
  ...
  template <typename TemplateArnT = Aws::String>
  CreateTemplateShareResult& WithTemplateArn(TemplateArnT&& value) {
  ...
  template <typename ShareIdT = Aws::String>
  CreateTemplateShareResult& WithShareId(ShareIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateTemplateShareResult& WithRequestId(RequestIdT&& value) {
