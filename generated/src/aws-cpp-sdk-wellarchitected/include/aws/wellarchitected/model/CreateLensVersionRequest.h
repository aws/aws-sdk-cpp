...
class CreateLensVersionRequest : public WellArchitectedRequest {
 public:
  ...
  inline void SetIsMajorVersion(bool value) {
    m_isMajorVersionHasBeenSet = true;
    m_isMajorVersion = value;
  }
  inline CreateLensVersionRequest& WithIsMajorVersion(bool value) {
    SetIsMajorVersion(value);
    return *this;
  }
  ///@}
