...
namespace Model
{
  ...
  {
  public:
    AWS_WELLARCHITECTED_API ResourceNotFoundException() = default;
    AWS_WELLARCHITECTED_API ResourceNotFoundException(Aws::Utils::Json::JsonView jsonValue);
    AWS_WELLARCHITECTED_API ResourceNotFoundException& operator=(Aws::Utils::Json::JsonView jsonValue);
