...
class LensSummary {
 public:
  ...
  void SetLensName(LensNameT&& value) {
    ...
    m_lensName = std::forward<LensNameT>(value);
  }
  template <typename LensNameT = Aws::String>
  LensSummary& WithLensName(LensNameT&& value) {
    SetLensName(std::forward<LensNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetLensType(LensType value) {
    m_lensTypeHasBeenSet = true;
    m_lensType = value;
  }
  inline LensSummary& WithLensType(LensType value) {
    SetLensType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetLensStatus(LensStatus value) {
    m_lensStatusHasBeenSet = true;
    m_lensStatus = value;
  }
  inline LensSummary& WithLensStatus(LensStatus value) {
    SetLensStatus(value);
    return *this;
  }
  ///@}
