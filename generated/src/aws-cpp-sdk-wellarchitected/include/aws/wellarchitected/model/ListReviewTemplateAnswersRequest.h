...
class ListReviewTemplateAnswersRequest : public WellArchitectedRequest {
 public:
  AWS_WELLARCHITECTED_API ListReviewTemplateAnswersRequest() = default;
  ...
  template <typename TemplateArnT = Aws::String>
  ListReviewTemplateAnswersRequest& WithTemplateArn(TemplateArnT&& value) {
  ...
  template <typename LensAliasT = Aws::String>
  ListReviewTemplateAnswersRequest& WithLensAlias(LensAliasT&& value) {
  ...
  template <typename PillarIdT = Aws::String>
  ListReviewTemplateAnswersRequest& WithPillarId(PillarIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListReviewTemplateAnswersRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListReviewTemplateAnswersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
