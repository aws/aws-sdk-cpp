...
class GetConsolidatedReportRequest : public WellArchitectedRequest {
 public:
  ...
  inline GetConsolidatedReportRequest& WithFormat(ReportFormat value) {
    SetFormat(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIncludeSharedResources(bool value) {
    m_includeSharedResourcesHasBeenSet = true;
    m_includeSharedResources = value;
  }
  inline GetConsolidatedReportRequest& WithIncludeSharedResources(bool value) {
    SetIncludeSharedResources(value);
    return *this;
  }
  ///@}
  ...
  inline GetConsolidatedReportRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
