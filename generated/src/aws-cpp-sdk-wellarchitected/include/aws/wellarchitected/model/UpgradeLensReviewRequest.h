...
class UpgradeLensReviewRequest : public WellArchitectedRequest {
 public:
  ...
  template <typename WorkloadIdT = Aws::String>
  UpgradeLensReviewRequest& WithWorkloadId(WorkloadIdT&& value) {
  ...
  template <typename LensAliasT = Aws::String>
  UpgradeLensReviewRequest& WithLensAlias(LensAliasT&& value) {
  ...
  void SetMilestoneName(MilestoneNameT&& value) {
    ...
    m_milestoneName = std::forward<MilestoneNameT>(value);
  }
  template <typename MilestoneNameT = Aws::String>
  UpgradeLensReviewRequest& WithMilestoneName(MilestoneNameT&& value) {
    SetMilestoneName(std::forward<MilestoneNameT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ClientRequestTokenT = Aws::String>
  UpgradeLensReviewRequest& WithClientRequestToken(ClientRequestTokenT&& value) {
