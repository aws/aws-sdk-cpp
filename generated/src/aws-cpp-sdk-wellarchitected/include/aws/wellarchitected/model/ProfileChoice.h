...
class ProfileChoice {
 public:
  ...
  void SetChoiceTitle(ChoiceTitleT&& value) {
    ...
    m_choiceTitle = std::forward<ChoiceTitleT>(value);
  }
  template <typename ChoiceTitleT = Aws::String>
  ProfileChoice& WithChoiceTitle(ChoiceTitleT&& value) {
    SetChoiceTitle(std::forward<ChoiceTitleT>(value));
    return *this;
  }
  ///@}
  ...
  void SetChoiceDescription(ChoiceDescriptionT&& value) {
    ...
    m_choiceDescription = std::forward<ChoiceDescriptionT>(value);
  }
  template <typename ChoiceDescriptionT = Aws::String>
  ProfileChoice& WithChoiceDescription(ChoiceDescriptionT&& value) {
    SetChoiceDescription(std::forward<ChoiceDescriptionT>(value));
    return *this;
  }
  ///@}
 private:
