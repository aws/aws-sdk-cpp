...
class ConsolidatedReportMetric {
 public:
  ...
  inline void SetMetricType(MetricType value) {
    m_metricTypeHasBeenSet = true;
    m_metricType = value;
  }
  inline ConsolidatedReportMetric& WithMetricType(MetricType value) {
    SetMetricType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetLensesAppliedCount(int value) {
    m_lensesAppliedCountHasBeenSet = true;
    m_lensesAppliedCount = value;
  }
  inline ConsolidatedReportMetric& WithLensesAppliedCount(int value) {
    SetLensesAppliedCount(value);
    return *this;
  }
  ///@}
 private:
