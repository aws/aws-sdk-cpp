...
class ProfileTemplateQuestion {
 public:
  ...
  void SetQuestionDescription(QuestionDescriptionT&& value) {
    ...
    m_questionDescription = std::forward<QuestionDescriptionT>(value);
  }
  template <typename QuestionDescriptionT = Aws::String>
  ProfileTemplateQuestion& WithQuestionDescription(QuestionDescriptionT&& value) {
    SetQuestionDescription(std::forward<QuestionDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetQuestionChoices(QuestionChoicesT&& value) {
    ...
    m_questionChoices = std::forward<QuestionChoicesT>(value);
  }
  template <typename QuestionChoicesT = Aws::Vector<ProfileTemplateChoice>>
  ProfileTemplateQuestion& WithQuestionChoices(QuestionChoicesT&& value) {
    SetQuestionChoices(std::forward<QuestionChoicesT>(value));
    return *this;
  }
  ...
  ProfileTemplateQuestion& AddQuestionChoices(QuestionChoicesT&& value) {
    m_questionChoicesHasBeenSet = true;
    m_questionChoices.emplace_back(std::forward<QuestionChoicesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetMinSelectedChoices(int value) {
    m_minSelectedChoicesHasBeenSet = true;
    m_minSelectedChoices = value;
  }
  inline ProfileTemplateQuestion& WithMinSelectedChoices(int value) {
    SetMinSelectedChoices(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxSelectedChoices(int value) {
    m_maxSelectedChoicesHasBeenSet = true;
    m_maxSelectedChoices = value;
  }
  inline ProfileTemplateQuestion& WithMaxSelectedChoices(int value) {
    SetMaxSelectedChoices(value);
    return *this;
  }
  ///@}
 private:
