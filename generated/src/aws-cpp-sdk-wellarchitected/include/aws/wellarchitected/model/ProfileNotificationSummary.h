...
class ProfileNotificationSummary {
 public:
  ...
  void SetCurrentProfileVersion(CurrentProfileVersionT&& value) {
    ...
    m_currentProfileVersion = std::forward<CurrentProfileVersionT>(value);
  }
  template <typename CurrentProfileVersionT = Aws::String>
  ProfileNotificationSummary& WithCurrentProfileVersion(CurrentProfileVersionT&& value) {
    SetCurrentProfileVersion(std::forward<CurrentProfileVersionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLatestProfileVersion(LatestProfileVersionT&& value) {
    ...
    m_latestProfileVersion = std::forward<LatestProfileVersionT>(value);
  }
  template <typename LatestProfileVersionT = Aws::String>
  ProfileNotificationSummary& WithLatestProfileVersion(LatestProfileVersionT&& value) {
    SetLatestProfileVersion(std::forward<LatestProfileVersionT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetType(ProfileNotificationType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline ProfileNotificationSummary& WithType(ProfileNotificationType value) {
    SetType(value);
    return *this;
  }
  ///@}
