...
class ListProfileNotificationsResult {
 public:
  ...
  void SetNotificationSummaries(NotificationSummariesT&& value) {
    ...
    m_notificationSummaries = std::forward<NotificationSummariesT>(value);
  }
  template <typename NotificationSummariesT = Aws::Vector<ProfileNotificationSummary>>
  ListProfileNotificationsResult& WithNotificationSummaries(NotificationSummariesT&& value) {
    SetNotificationSummaries(std::forward<NotificationSummariesT>(value));
    return *this;
  }
  ...
  ListProfileNotificationsResult& AddNotificationSummaries(NotificationSummariesT&& value) {
    m_notificationSummariesHasBeenSet = true;
    m_notificationSummaries.emplace_back(std::forward<NotificationSummariesT>(value));
    return *this;
  }
  ///@}
