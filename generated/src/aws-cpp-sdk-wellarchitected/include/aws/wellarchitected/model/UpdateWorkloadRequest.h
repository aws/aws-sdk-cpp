...
class UpdateWorkloadRequest : public WellArchitectedRequest {
 public:
  ...
  inline UpdateWorkloadRequest& WithEnvironment(WorkloadEnvironment value) {
  ...
  inline UpdateWorkloadRequest& WithIsReviewOwnerUpdateAcknowledged(bool value) {
  ...
  inline UpdateWorkloadRequest& WithImprovementStatus(WorkloadImprovementStatus value) {
