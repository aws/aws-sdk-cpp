...
class LensUpgradeSummary {
 public:
  ...
  void SetCurrentLensVersion(CurrentLensVersionT&& value) {
    ...
    m_currentLensVersion = std::forward<CurrentLensVersionT>(value);
  }
  template <typename CurrentLensVersionT = Aws::String>
  LensUpgradeSummary& WithCurrentLensVersion(CurrentLensVersionT&& value) {
    SetCurrentLensVersion(std::forward<CurrentLensVersionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLatestLensVersion(LatestLensVersionT&& value) {
    ...
    m_latestLensVersion = std::forward<LatestLensVersionT>(value);
  }
  template <typename LatestLensVersionT = Aws::String>
  LensUpgradeSummary& WithLatestLensVersion(LatestLensVersionT&& value) {
    SetLatestLensVersion(std::forward<LatestLensVersionT>(value));
    return *this;
  }
  ///@}
