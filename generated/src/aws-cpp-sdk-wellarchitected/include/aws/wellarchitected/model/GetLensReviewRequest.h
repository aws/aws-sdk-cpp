...
class GetLensReviewRequest : public WellArchitectedRequest {
 public:
  ...
  template <typename WorkloadIdT = Aws::String>
  GetLensReviewRequest& WithWorkloadId(WorkloadIdT&& value) {
  ...
  template <typename LensAliasT = Aws::String>
  GetLensReviewRequest& WithLensAlias(LensAliasT&& value) {
  ...
  inline GetLensReviewRequest& WithMilestoneNumber(int value) {
