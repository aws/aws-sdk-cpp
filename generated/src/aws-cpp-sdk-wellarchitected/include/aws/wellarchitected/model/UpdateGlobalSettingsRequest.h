...
class UpdateGlobalSettingsRequest : public WellArchitectedRequest {
 public:
  ...
  inline UpdateGlobalSettingsRequest& WithOrganizationSharingStatus(OrganizationSharingStatus value) {
  ...
  inline UpdateGlobalSettingsRequest& WithDiscoveryIntegrationStatus(DiscoveryIntegrationStatus value) {
  ...
  template <typename JiraConfigurationT = AccountJiraConfigurationInput>
  UpdateGlobalSettingsRequest& WithJiraConfiguration(JiraConfigurationT&& value) {
