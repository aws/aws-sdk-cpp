...
class CreateWorkloadShareResult {
 public:
  ...
  template <typename WorkloadIdT = Aws::String>
  CreateWorkloadShareResult& WithWorkloadId(WorkloadIdT&& value) {
  ...
  template <typename ShareIdT = Aws::String>
  CreateWorkloadShareResult& WithShareId(ShareIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateWorkloadShareResult& WithRequestId(RequestIdT&& value) {
