...
class UpdateReviewTemplateLensReviewRequest : public WellArchitectedRequest {
 public:
  ...
  void SetLensNotes(LensNotesT&& value) {
    m_lensNotesHasBeenSet = true;
    m_lensNotes = std::forward<LensNotesT>(value);
  }
  template <typename LensNotesT = Aws::String>
  UpdateReviewTemplateLensReviewRequest& WithLensNotes(LensNotesT&& value) {
    SetLensNotes(std::forward<LensNotesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPillarNotes(PillarNotesT&& value) {
    m_pillarNotesHasBeenSet = true;
    m_pillarNotes = std::forward<PillarNotesT>(value);
  }
  template <typename PillarNotesT = Aws::Map<Aws::String, Aws::String>>
  UpdateReviewTemplateLensReviewRequest& WithPillarNotes(PillarNotesT&& value) {
    SetPillarNotes(std::forward<PillarNotesT>(value));
    return *this;
  }
  ...
  UpdateReviewTemplateLensReviewRequest& AddPillarNotes(PillarNotesKeyT&& key, PillarNotesValueT&& value) {
    m_pillarNotesHasBeenSet = true;
    m_pillarNotes.emplace(std::forward<PillarNotesKeyT>(key), std::forward<PillarNotesValueT>(value));
    return *this;
  }
  ///@}
 private:
