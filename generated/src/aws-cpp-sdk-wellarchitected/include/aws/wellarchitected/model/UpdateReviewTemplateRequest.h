...
class UpdateReviewTemplateRequest : public WellArchitectedRequest {
 public:
  ...
  void SetLensesToAssociate(LensesToAssociateT&& value) {
    m_lensesToAssociateHasBeenSet = true;
    m_lensesToAssociate = std::forward<LensesToAssociateT>(value);
  }
  template <typename LensesToAssociateT = Aws::Vector<Aws::String>>
  UpdateReviewTemplateRequest& WithLensesToAssociate(LensesToAssociateT&& value) {
    SetLensesToAssociate(std::forward<LensesToAssociateT>(value));
    return *this;
  }
  template <typename LensesToAssociateT = Aws::String>
  UpdateReviewTemplateRequest& AddLensesToAssociate(LensesToAssociateT&& value) {
    m_lensesToAssociateHasBeenSet = true;
    m_lensesToAssociate.emplace_back(std::forward<LensesToAssociateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLensesToDisassociate(LensesToDisassociateT&& value) {
    m_lensesToDisassociateHasBeenSet = true;
    m_lensesToDisassociate = std::forward<LensesToDisassociateT>(value);
  }
  template <typename LensesToDisassociateT = Aws::Vector<Aws::String>>
  UpdateReviewTemplateRequest& WithLensesToDisassociate(LensesToDisassociateT&& value) {
    SetLensesToDisassociate(std::forward<LensesToDisassociateT>(value));
    return *this;
  }
  ...
  UpdateReviewTemplateRequest& AddLensesToDisassociate(LensesToDisassociateT&& value) {
    m_lensesToDisassociateHasBeenSet = true;
    m_lensesToDisassociate.emplace_back(std::forward<LensesToDisassociateT>(value));
    return *this;
  }
  ///@}
 private:
