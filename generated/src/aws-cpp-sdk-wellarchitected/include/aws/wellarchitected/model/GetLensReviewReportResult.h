...
class GetLensReviewReportResult {
 public:
  ...
  template <typename WorkloadIdT = Aws::String>
  GetLensReviewReportResult& WithWorkloadId(WorkloadIdT&& value) {
  ...
  inline GetLensReviewReportResult& WithMilestoneNumber(int value) {
  ...
  void SetLensReviewReport(LensReviewReportT&& value) {
    m_lensReviewReportHasBeenSet = true;
    m_lensReviewReport = std::forward<LensReviewReportT>(value);
  }
  template <typename LensReviewReportT = LensReviewReport>
  GetLensReviewReportResult& WithLensReviewReport(LensReviewReportT&& value) {
    SetLensReviewReport(std::forward<LensReviewReportT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetLensReviewReportResult& WithRequestId(RequestIdT&& value) {
