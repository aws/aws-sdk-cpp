...
class ListLensReviewImprovementsRequest : public WellArchitectedRequest {
 public:
  ...
  template <typename WorkloadIdT = Aws::String>
  ListLensReviewImprovementsRequest& WithWorkloadId(WorkloadIdT&& value) {
  ...
  template <typename LensAliasT = Aws::String>
  ListLensReviewImprovementsRequest& WithLensAlias(LensAliasT&& value) {
  ...
  template <typename PillarIdT = Aws::String>
  ListLensReviewImprovementsRequest& WithPillarId(PillarIdT&& value) {
  ...
  inline ListLensReviewImprovementsRequest& WithMilestoneNumber(int value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListLensReviewImprovementsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListLensReviewImprovementsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline ListLensReviewImprovementsRequest& WithQuestionPriority(QuestionPriority value) {
