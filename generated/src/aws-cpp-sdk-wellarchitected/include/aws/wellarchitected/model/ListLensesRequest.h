...
class ListLensesRequest : public WellArchitectedRequest {
 public:
  ...
  inline ListLensesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline ListLensesRequest& WithLensType(LensType value) {
    SetLensType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetLensStatus(LensStatusType value) {
    m_lensStatusHasBeenSet = true;
    m_lensStatus = value;
  }
  inline ListLensesRequest& WithLensStatus(LensStatusType value) {
    SetLensStatus(value);
    return *this;
  }
  ///@}
