...
class CreateWorkloadShareRequest : public WellArchitectedRequest {
 public:
  ...
  template <typename WorkloadIdT = Aws::String>
  CreateWorkloadShareRequest& WithWorkloadId(WorkloadIdT&& value) {
  ...
  template <typename SharedWithT = Aws::String>
  CreateWorkloadShareRequest& WithSharedWith(SharedWithT&& value) {
  ...
  inline CreateWorkloadShareRequest& WithPermissionType(PermissionType value) {
  ...
  template <typename ClientRequestTokenT = Aws::String>
  CreateWorkloadShareRequest& WithClientRequestToken(ClientRequestTokenT&& value) {
