...
class CreateWorkloadRequest : public WellArchitectedRequest {
 public:
  ...
  inline CreateWorkloadRequest& WithEnvironment(WorkloadEnvironment value) {
  ...
  void SetReviewTemplateArns(ReviewTemplateArnsT&& value) {
    m_reviewTemplateArnsHasBeenSet = true;
    m_reviewTemplateArns = std::forward<ReviewTemplateArnsT>(value);
  }
  template <typename ReviewTemplateArnsT = Aws::Vector<Aws::String>>
  CreateWorkloadRequest& WithReviewTemplateArns(ReviewTemplateArnsT&& value) {
    SetReviewTemplateArns(std::forward<ReviewTemplateArnsT>(value));
    return *this;
  }
  template <typename ReviewTemplateArnsT = Aws::String>
  CreateWorkloadRequest& AddReviewTemplateArns(ReviewTemplateArnsT&& value) {
    m_reviewTemplateArnsHasBeenSet = true;
    m_reviewTemplateArns.emplace_back(std::forward<ReviewTemplateArnsT>(value));
    return *this;
  }
  ///@}
