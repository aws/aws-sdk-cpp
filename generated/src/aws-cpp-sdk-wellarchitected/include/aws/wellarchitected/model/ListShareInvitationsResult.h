...
namespace Model
{
  ...
  public:
    ...
    inline ListShareInvitationsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ListShareInvitationsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ListShareInvitationsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
