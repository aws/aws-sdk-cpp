...
class ListShareInvitationsResult {
 public:
  ...
  void SetShareInvitationSummaries(ShareInvitationSummariesT&& value) {
    m_shareInvitationSummariesHasBeenSet = true;
    m_shareInvitationSummaries = std::forward<ShareInvitationSummariesT>(value);
  }
  template <typename ShareInvitationSummariesT = Aws::Vector<ShareInvitationSummary>>
  ListShareInvitationsResult& WithShareInvitationSummaries(ShareInvitationSummariesT&& value) {
    SetShareInvitationSummaries(std::forward<ShareInvitationSummariesT>(value));
    return *this;
  }
  template <typename ShareInvitationSummariesT = ShareInvitationSummary>
  ListShareInvitationsResult& AddShareInvitationSummaries(ShareInvitationSummariesT&& value) {
    m_shareInvitationSummariesHasBeenSet = true;
    m_shareInvitationSummaries.emplace_back(std::forward<ShareInvitationSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListShareInvitationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListShareInvitationsResult& WithRequestId(RequestIdT&& value) {
