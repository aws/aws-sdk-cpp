...
class CreateMilestoneRequest : public WellArchitectedRequest {
 public:
  ...
  template <typename WorkloadIdT = Aws::String>
  CreateMilestoneRequest& WithWorkloadId(WorkloadIdT&& value) {
  ...
  template <typename MilestoneNameT = Aws::String>
  CreateMilestoneRequest& WithMilestoneName(MilestoneNameT&& value) {
  ...
  template <typename ClientRequestTokenT = Aws::String>
  CreateMilestoneRequest& WithClientRequestToken(ClientRequestTokenT&& value) {
