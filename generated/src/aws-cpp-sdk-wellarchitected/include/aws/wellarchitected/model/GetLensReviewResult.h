...
class GetLensReviewResult {
 public:
  ...
  template <typename WorkloadIdT = Aws::String>
  GetLensReviewResult& WithWorkloadId(WorkloadIdT&& value) {
  ...
  inline GetLensReviewResult& WithMilestoneNumber(int value) {
  ...
  template <typename LensReviewT = LensReview>
  GetLensReviewResult& WithLensReview(LensReviewT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetLensReviewResult& WithRequestId(RequestIdT&& value) {
