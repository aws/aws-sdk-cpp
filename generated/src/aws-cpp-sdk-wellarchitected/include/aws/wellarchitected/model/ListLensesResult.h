...
class ListLensesResult {
 public:
  ...
  void SetLensSummaries(LensSummariesT&& value) {
    m_lensSummariesHasBeenSet = true;
    m_lensSummaries = std::forward<LensSummariesT>(value);
  }
  template <typename LensSummariesT = Aws::Vector<LensSummary>>
  ListLensesResult& WithLensSummaries(LensSummariesT&& value) {
    SetLensSummaries(std::forward<LensSummariesT>(value));
    return *this;
  }
  template <typename LensSummariesT = LensSummary>
  ListLensesResult& AddLensSummaries(LensSummariesT&& value) {
    m_lensSummariesHasBeenSet = true;
    m_lensSummaries.emplace_back(std::forward<LensSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListLensesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListLensesResult& WithRequestId(RequestIdT&& value) {
