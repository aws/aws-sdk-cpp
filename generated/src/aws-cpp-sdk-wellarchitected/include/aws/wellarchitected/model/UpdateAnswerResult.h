...
namespace Model
{
  ...
  public:
    ...
    inline UpdateAnswerResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateAnswerResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateAnswerResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
