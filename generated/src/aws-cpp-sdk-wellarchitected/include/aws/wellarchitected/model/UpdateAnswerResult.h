...
class UpdateAnswerResult {
 public:
  AWS_WELLARCHITECTED_API UpdateAnswerResult() = default;
  ...
  template <typename WorkloadIdT = Aws::String>
  UpdateAnswerResult& WithWorkloadId(WorkloadIdT&& value) {
  ...
  template <typename LensAliasT = Aws::String>
  UpdateAnswerResult& WithLensAlias(LensAliasT&& value) {
  ...
  template <typename LensArnT = Aws::String>
  UpdateAnswerResult& WithLensArn(LensArnT&& value) {
  ...
  template <typename AnswerT = Answer>
  UpdateAnswerResult& WithAnswer(AnswerT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateAnswerResult& WithRequestId(RequestIdT&& value) {
