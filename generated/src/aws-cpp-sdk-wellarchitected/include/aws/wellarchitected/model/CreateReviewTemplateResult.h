...
class CreateReviewTemplateResult {
 public:
  AWS_WELLARCHITECTED_API CreateReviewTemplateResult() = default;
  ...
  template <typename TemplateArnT = Aws::String>
  CreateReviewTemplateResult& WithTemplateArn(TemplateArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateReviewTemplateResult& WithRequestId(RequestIdT&& value) {
