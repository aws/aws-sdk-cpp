...
class DisassociateProfilesRequest : public WellArchitectedRequest {
 public:
  ...
  template <typename WorkloadIdT = Aws::String>
  DisassociateProfilesRequest& WithWorkloadId(WorkloadIdT&& value) {
  ...
  void SetProfileArns(ProfileArnsT&& value) {
    m_profileArnsHasBeenSet = true;
    m_profileArns = std::forward<ProfileArnsT>(value);
  }
  template <typename ProfileArnsT = Aws::Vector<Aws::String>>
  DisassociateProfilesRequest& WithProfileArns(ProfileArnsT&& value) {
    SetProfileArns(std::forward<ProfileArnsT>(value));
    return *this;
  }
  template <typename ProfileArnsT = Aws::String>
  DisassociateProfilesRequest& AddProfileArns(ProfileArnsT&& value) {
    m_profileArnsHasBeenSet = true;
    m_profileArns.emplace_back(std::forward<ProfileArnsT>(value));
    return *this;
  }
  ///@}
 private:
