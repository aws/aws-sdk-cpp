...
class ListLensReviewImprovementsResult {
 public:
  ...
  AWS_WELLARCHITECTED_API ListLensReviewImprovementsResult& operator=(
  ...
  template <typename WorkloadIdT = Aws::String>
  ListLensReviewImprovementsResult& WithWorkloadId(WorkloadIdT&& value) {
  ...
  inline ListLensReviewImprovementsResult& WithMilestoneNumber(int value) {
  ...
  template <typename LensAliasT = Aws::String>
  ListLensReviewImprovementsResult& WithLensAlias(LensAliasT&& value) {
  ...
  template <typename LensArnT = Aws::String>
  ListLensReviewImprovementsResult& WithLensArn(LensArnT&& value) {
  ...
  void SetImprovementSummaries(ImprovementSummariesT&& value) {
    m_improvementSummariesHasBeenSet = true;
    m_improvementSummaries = std::forward<ImprovementSummariesT>(value);
  }
  template <typename ImprovementSummariesT = Aws::Vector<ImprovementSummary>>
  ListLensReviewImprovementsResult& WithImprovementSummaries(ImprovementSummariesT&& value) {
    SetImprovementSummaries(std::forward<ImprovementSummariesT>(value));
    return *this;
  }
  template <typename ImprovementSummariesT = ImprovementSummary>
  ListLensReviewImprovementsResult& AddImprovementSummaries(ImprovementSummariesT&& value) {
    m_improvementSummariesHasBeenSet = true;
    m_improvementSummaries.emplace_back(std::forward<ImprovementSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListLensReviewImprovementsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListLensReviewImprovementsResult& WithRequestId(RequestIdT&& value) {
