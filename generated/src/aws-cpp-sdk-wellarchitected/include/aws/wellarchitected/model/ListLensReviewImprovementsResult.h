...
namespace Model
{
  ...
  public:
    ...
    inline ListLensReviewImprovementsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ListLensReviewImprovementsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ListLensReviewImprovementsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
