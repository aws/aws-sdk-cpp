...
class ListProfileNotificationsRequest : public WellArchitectedRequest {
 public:
  ...
  template <typename WorkloadIdT = Aws::String>
  ListProfileNotificationsRequest& WithWorkloadId(WorkloadIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListProfileNotificationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListProfileNotificationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
