...
class ShareInvitationSummary {
 public:
  ...
  inline ShareInvitationSummary& WithPermissionType(PermissionType value) {
  ...
  inline void SetShareResourceType(ShareResourceType value) {
    m_shareResourceTypeHasBeenSet = true;
    m_shareResourceType = value;
  }
  inline ShareInvitationSummary& WithShareResourceType(ShareResourceType value) {
    SetShareResourceType(value);
    return *this;
  }
  ///@}
