...
namespace Model
{
  ...
  {
  public:
    AWS_WELLARCHITECTED_API ListCheckDetailsRequest() = default;
    ...
    template<typename WorkloadIdT = Aws::String>
    ListCheckDetailsRequest& WithWorkloadId(WorkloadIdT&& value) { SetWorkloadId(std::forward<WorkloadIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListCheckDetailsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename LensArnT = Aws::String>
    ListCheckDetailsRequest& WithLensArn(LensArnT&& value) { SetLensArn(std::forward<LensArnT>(value)); return *this;}
    ///@}
    ...
    template<typename PillarIdT = Aws::String>
    ListCheckDetailsRequest& WithPillarId(PillarIdT&& value) { SetPillarId(std::forward<PillarIdT>(value)); return *this;}
    ///@}
    ...
    template<typename QuestionIdT = Aws::String>
    ListCheckDetailsRequest& WithQuestionId(QuestionIdT&& value) { SetQuestionId(std::forward<QuestionIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ChoiceIdT = Aws::String>
    ListCheckDetailsRequest& WithChoiceId(ChoiceIdT&& value) { SetChoiceId(std::forward<ChoiceIdT>(value)); return *this;}
    ///@}
  private:
