...
class AccountJiraConfigurationOutput {
 public:
  ...
  inline AccountJiraConfigurationOutput& WithIntegrationStatus(IntegrationStatus value) {
  ...
  inline AccountJiraConfigurationOutput& WithIssueManagementStatus(AccountJiraIssueManagementStatus value) {
  ...
  inline AccountJiraConfigurationOutput& WithIssueManagementType(IssueManagementType value) {
