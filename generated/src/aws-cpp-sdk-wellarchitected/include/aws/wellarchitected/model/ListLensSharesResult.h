...
class ListLensSharesResult {
 public:
  ...
  void SetLensShareSummaries(LensShareSummariesT&& value) {
    m_lensShareSummariesHasBeenSet = true;
    m_lensShareSummaries = std::forward<LensShareSummariesT>(value);
  }
  template <typename LensShareSummariesT = Aws::Vector<LensShareSummary>>
  ListLensSharesResult& WithLensShareSummaries(LensShareSummariesT&& value) {
    SetLensShareSummaries(std::forward<LensShareSummariesT>(value));
    return *this;
  }
  template <typename LensShareSummariesT = LensShareSummary>
  ListLensSharesResult& AddLensShareSummaries(LensShareSummariesT&& value) {
    m_lensShareSummariesHasBeenSet = true;
    m_lensShareSummaries.emplace_back(std::forward<LensShareSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListLensSharesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListLensSharesResult& WithRequestId(RequestIdT&& value) {
