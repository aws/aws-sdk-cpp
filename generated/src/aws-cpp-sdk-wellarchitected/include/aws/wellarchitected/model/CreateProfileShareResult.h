...
class CreateProfileShareResult {
 public:
  ...
  template <typename ShareIdT = Aws::String>
  CreateProfileShareResult& WithShareId(ShareIdT&& value) {
  ...
  template <typename ProfileArnT = Aws::String>
  CreateProfileShareResult& WithProfileArn(ProfileArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateProfileShareResult& WithRequestId(RequestIdT&& value) {
