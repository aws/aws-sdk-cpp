...
class UpdateShareInvitationRequest : public WellArchitectedRequest {
 public:
  ...
  inline void SetShareInvitationAction(ShareInvitationAction value) {
    m_shareInvitationActionHasBeenSet = true;
    m_shareInvitationAction = value;
  }
  inline UpdateShareInvitationRequest& WithShareInvitationAction(ShareInvitationAction value) {
    SetShareInvitationAction(value);
    return *this;
  }
  ///@}
 private:
