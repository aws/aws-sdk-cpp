...
class ListWorkloadSharesRequest : public WellArchitectedRequest {
 public:
  ...
  template <typename WorkloadIdT = Aws::String>
  ListWorkloadSharesRequest& WithWorkloadId(WorkloadIdT&& value) {
  ...
  template <typename SharedWithPrefixT = Aws::String>
  ListWorkloadSharesRequest& WithSharedWithPrefix(SharedWithPrefixT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListWorkloadSharesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListWorkloadSharesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline ListWorkloadSharesRequest& WithStatus(ShareStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
