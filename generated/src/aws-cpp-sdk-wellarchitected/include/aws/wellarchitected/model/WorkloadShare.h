...
class WorkloadShare {
 public:
  ...
  void SetSharedBy(SharedByT&& value) {
    ...
    m_sharedBy = std::forward<SharedByT>(value);
  }
  template <typename SharedByT = Aws::String>
  WorkloadShare& WithSharedBy(SharedByT&& value) {
    SetSharedBy(std::forward<SharedByT>(value));
    return *this;
  }
  ///@}
  ...
  inline WorkloadShare& WithPermissionType(PermissionType value) {
  ...
  inline WorkloadShare& WithStatus(ShareStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
