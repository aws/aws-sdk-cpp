...
class DeleteWorkloadShareRequest : public WellArchitectedRequest {
 public:
  AWS_WELLARCHITECTED_API DeleteWorkloadShareRequest() = default;
  ...
  template <typename ShareIdT = Aws::String>
  DeleteWorkloadShareRequest& WithShareId(ShareIdT&& value) {
  ...
  template <typename WorkloadIdT = Aws::String>
  DeleteWorkloadShareRequest& WithWorkloadId(WorkloadIdT&& value) {
  ...
  template <typename ClientRequestTokenT = Aws::String>
  DeleteWorkloadShareRequest& WithClientRequestToken(ClientRequestTokenT&& value) {
