...
namespace Model
{
  ...
  public:
    ...
    template<typename WorkloadIdT = Aws::String>
    GetAnswerRequest& WithWorkloadId(WorkloadIdT&& value) { SetWorkloadId(std::forward<WorkloadIdT>(value)); return *this;}
    ///@}
    ...
    template<typename LensAliasT = Aws::String>
    GetAnswerRequest& WithLensAlias(LensAliasT&& value) { SetLensAlias(std::forward<LensAliasT>(value)); return *this;}
    ///@}
    ...
    template<typename QuestionIdT = Aws::String>
    GetAnswerRequest& WithQuestionId(QuestionIdT&& value) { SetQuestionId(std::forward<QuestionIdT>(value)); return *this;}
    ///@}
