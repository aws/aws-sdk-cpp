...
/**
 * <p>Summary of an optimization goal associated with a profile.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/wellarchitected-2020-03-31/GoalSummary">AWS
 * API Reference</a></p>
 */
class GoalSummary {
 public:
  ...
  inline GoalSummary& AddPillars(Pillar value) {
    m_pillarsHasBeenSet = true;
