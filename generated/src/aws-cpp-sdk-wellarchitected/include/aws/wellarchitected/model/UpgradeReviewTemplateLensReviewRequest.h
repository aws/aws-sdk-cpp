...
class UpgradeReviewTemplateLensReviewRequest : public WellArchitectedRequest {
 public:
  ...
  template <typename TemplateArnT = Aws::String>
  UpgradeReviewTemplateLensReviewRequest& WithTemplateArn(TemplateArnT&& value) {
  ...
  template <typename LensAliasT = Aws::String>
  UpgradeReviewTemplateLensReviewRequest& WithLensAlias(LensAliasT&& value) {
  ...
  template <typename ClientRequestTokenT = Aws::String>
  UpgradeReviewTemplateLensReviewRequest& WithClientRequestToken(ClientRequestTokenT&& value) {
