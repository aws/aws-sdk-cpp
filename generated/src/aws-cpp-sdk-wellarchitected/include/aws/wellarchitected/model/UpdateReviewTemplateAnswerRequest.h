...
class UpdateReviewTemplateAnswerRequest : public WellArchitectedRequest {
 public:
  ...
  void SetChoiceUpdates(ChoiceUpdatesT&& value) {
    m_choiceUpdatesHasBeenSet = true;
    m_choiceUpdates = std::forward<ChoiceUpdatesT>(value);
  }
  template <typename ChoiceUpdatesT = Aws::Map<Aws::String, ChoiceUpdate>>
  UpdateReviewTemplateAnswerRequest& WithChoiceUpdates(ChoiceUpdatesT&& value) {
    SetChoiceUpdates(std::forward<ChoiceUpdatesT>(value));
    return *this;
  }
  ...
  UpdateReviewTemplateAnswerRequest& AddChoiceUpdates(ChoiceUpdatesKeyT&& key, ChoiceUpdatesValueT&& value) {
    m_choiceUpdatesHasBeenSet = true;
    m_choiceUpdates.emplace(std::forward<ChoiceUpdatesKeyT>(key), std::forward<ChoiceUpdatesValueT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NotesT = Aws::String>
  UpdateReviewTemplateAnswerRequest& WithNotes(NotesT&& value) {
  ...
  inline UpdateReviewTemplateAnswerRequest& WithIsApplicable(bool value) {
  ...
  inline UpdateReviewTemplateAnswerRequest& WithReason(AnswerReason value) {
    SetReason(value);
    return *this;
  }
  ///@}
