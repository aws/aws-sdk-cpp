...
/**
 */
class ListAgentRecommendationsRequest : public WellArchitectedRequest {
 public:
  AWS_WELLARCHITECTED_API ListAgentRecommendationsRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "ListAgentRecommendations"; }
  ...
  ///@{
  /**
   * <p>The Amazon Resource Name (ARN) of the optimization profile to list
  ...
  template <typename ProfileArnT = Aws::String>
  ListAgentRecommendationsRequest& WithProfileArn(ProfileArnT&& value) {
  ...
  inline ListAgentRecommendationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAgentRecommendationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  ///@{
  /**
   * <p>Optional filter to return only recommendations with the specified state (OPEN
   * or CLOSED).</p>
   */
  ...
  inline ListAgentRecommendationsRequest& WithState(RecommendationState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline ListAgentRecommendationsRequest& WithPillar(Pillar value) {
    SetPillar(value);
    return *this;
  }
  ///@}
