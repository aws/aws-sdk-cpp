...
class ListLensReviewsRequest : public WellArchitectedRequest {
 public:
  ...
  template <typename WorkloadIdT = Aws::String>
  ListLensReviewsRequest& WithWorkloadId(WorkloadIdT&& value) {
  ...
  inline ListLensReviewsRequest& WithMilestoneNumber(int value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListLensReviewsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListLensReviewsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
