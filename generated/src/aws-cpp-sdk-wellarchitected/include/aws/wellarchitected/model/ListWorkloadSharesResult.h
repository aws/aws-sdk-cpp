...
class ListWorkloadSharesResult {
 public:
  ...
  template <typename WorkloadIdT = Aws::String>
  ListWorkloadSharesResult& WithWorkloadId(WorkloadIdT&& value) {
  ...
  void SetWorkloadShareSummaries(WorkloadShareSummariesT&& value) {
    m_workloadShareSummariesHasBeenSet = true;
    m_workloadShareSummaries = std::forward<WorkloadShareSummariesT>(value);
  }
  template <typename WorkloadShareSummariesT = Aws::Vector<WorkloadShareSummary>>
  ListWorkloadSharesResult& WithWorkloadShareSummaries(WorkloadShareSummariesT&& value) {
    SetWorkloadShareSummaries(std::forward<WorkloadShareSummariesT>(value));
    return *this;
  }
  template <typename WorkloadShareSummariesT = WorkloadShareSummary>
  ListWorkloadSharesResult& AddWorkloadShareSummaries(WorkloadShareSummariesT&& value) {
    m_workloadShareSummariesHasBeenSet = true;
    m_workloadShareSummaries.emplace_back(std::forward<WorkloadShareSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListWorkloadSharesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListWorkloadSharesResult& WithRequestId(RequestIdT&& value) {
