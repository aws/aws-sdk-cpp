...
class NotificationSummary {
 public:
  ...
  inline NotificationSummary& WithType(NotificationType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetLensUpgradeSummary(LensUpgradeSummaryT&& value) {
    ...
    m_lensUpgradeSummary = std::forward<LensUpgradeSummaryT>(value);
  }
  template <typename LensUpgradeSummaryT = LensUpgradeSummary>
  NotificationSummary& WithLensUpgradeSummary(LensUpgradeSummaryT&& value) {
    SetLensUpgradeSummary(std::forward<LensUpgradeSummaryT>(value));
    return *this;
  }
  ///@}
 private:
