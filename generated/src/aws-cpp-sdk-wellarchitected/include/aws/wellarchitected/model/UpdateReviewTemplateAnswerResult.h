...
class UpdateReviewTemplateAnswerResult {
 public:
  ...
  AWS_WELLARCHITECTED_API UpdateReviewTemplateAnswerResult& operator=(
  ...
  template <typename TemplateArnT = Aws::String>
  UpdateReviewTemplateAnswerResult& WithTemplateArn(TemplateArnT&& value) {
  ...
  template <typename LensAliasT = Aws::String>
  UpdateReviewTemplateAnswerResult& WithLensAlias(LensAliasT&& value) {
  ...
  template <typename AnswerT = ReviewTemplateAnswer>
  UpdateReviewTemplateAnswerResult& WithAnswer(AnswerT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateReviewTemplateAnswerResult& WithRequestId(RequestIdT&& value) {
