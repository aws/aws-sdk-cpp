...
class GetLensReviewReportRequest : public WellArchitectedRequest {
 public:
  ...
  template <typename WorkloadIdT = Aws::String>
  GetLensReviewReportRequest& WithWorkloadId(WorkloadIdT&& value) {
  ...
  template <typename LensAliasT = Aws::String>
  GetLensReviewReportRequest& WithLensAlias(LensAliasT&& value) {
  ...
  inline GetLensReviewReportRequest& WithMilestoneNumber(int value) {
