...
/**
 */
class ListAgentRecommendationGenerationsRequest : public WellArchitectedRequest {
 public:
  AWS_WELLARCHITECTED_API ListAgentRecommendationGenerationsRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "ListAgentRecommendationGenerations"; }
  ...
  ///@{
  /**
   * <p>The Amazon Resource Name (ARN) of the optimization profile to list generation
   * processes for.</p>
   */
  ...
  template <typename ProfileArnT = Aws::String>
  ListAgentRecommendationGenerationsRequest& WithProfileArn(ProfileArnT&& value) {
  ...
  inline ListAgentRecommendationGenerationsRequest& WithRecommendationType(RecommendationType value) {
  ...
  ///@{
  /**
   * <p>The maximum number of generation processes to return in a single
   * response.</p>
   */
  ...
  inline ListAgentRecommendationGenerationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAgentRecommendationGenerationsRequest& WithNextToken(NextTokenT&& value) {
