...
class DisassociateLensesRequest : public WellArchitectedRequest {
 public:
  ...
  template <typename WorkloadIdT = Aws::String>
  DisassociateLensesRequest& WithWorkloadId(WorkloadIdT&& value) {
  ...
  void SetLensAliases(LensAliasesT&& value) {
    m_lensAliasesHasBeenSet = true;
    m_lensAliases = std::forward<LensAliasesT>(value);
  }
  template <typename LensAliasesT = Aws::Vector<Aws::String>>
  DisassociateLensesRequest& WithLensAliases(LensAliasesT&& value) {
    SetLensAliases(std::forward<LensAliasesT>(value));
    return *this;
  }
  template <typename LensAliasesT = Aws::String>
  DisassociateLensesRequest& AddLensAliases(LensAliasesT&& value) {
    m_lensAliasesHasBeenSet = true;
    m_lensAliases.emplace_back(std::forward<LensAliasesT>(value));
    return *this;
  }
  ///@}
 private:
