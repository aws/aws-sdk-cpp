...
namespace Model
{
  ...
  public:
    ...
    inline GetLensVersionDifferenceResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline GetLensVersionDifferenceResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline GetLensVersionDifferenceResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
