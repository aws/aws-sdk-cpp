...
class AccountJiraConfigurationInput {
 public:
  ...
  inline void SetIssueManagementStatus(AccountJiraIssueManagementStatus value) {
    m_issueManagementStatusHasBeenSet = true;
    m_issueManagementStatus = value;
  }
  inline AccountJiraConfigurationInput& WithIssueManagementStatus(AccountJiraIssueManagementStatus value) {
    SetIssueManagementStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIssueManagementType(IssueManagementType value) {
    m_issueManagementTypeHasBeenSet = true;
    m_issueManagementType = value;
  }
  inline AccountJiraConfigurationInput& WithIssueManagementType(IssueManagementType value) {
    SetIssueManagementType(value);
    return *this;
  }
  ///@}
  ...
  void SetJiraProjectKey(JiraProjectKeyT&& value) {
    ...
    m_jiraProjectKey = std::forward<JiraProjectKeyT>(value);
  }
  template <typename JiraProjectKeyT = Aws::String>
  AccountJiraConfigurationInput& WithJiraProjectKey(JiraProjectKeyT&& value) {
    SetJiraProjectKey(std::forward<JiraProjectKeyT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetIntegrationStatus(IntegrationStatusInput value) {
    m_integrationStatusHasBeenSet = true;
    m_integrationStatus = value;
  }
  inline AccountJiraConfigurationInput& WithIntegrationStatus(IntegrationStatusInput value) {
