...
class WorkloadJiraConfigurationInput {
 public:
  ...
  inline void SetIssueManagementStatus(WorkloadIssueManagementStatus value) {
    m_issueManagementStatusHasBeenSet = true;
    m_issueManagementStatus = value;
  }
  inline WorkloadJiraConfigurationInput& WithIssueManagementStatus(WorkloadIssueManagementStatus value) {
  ...
  inline WorkloadJiraConfigurationInput& WithIssueManagementType(IssueManagementType value) {
