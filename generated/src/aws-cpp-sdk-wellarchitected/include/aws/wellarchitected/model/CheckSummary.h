...
class CheckSummary {
 public:
  ...
  inline void SetProvider(CheckProvider value) {
    m_providerHasBeenSet = true;
    m_provider = value;
  }
  inline CheckSummary& WithProvider(CheckProvider value) {
    SetProvider(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(CheckStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline CheckSummary& WithStatus(CheckStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetAccountSummary(AccountSummaryT&& value) {
    ...
    m_accountSummary = std::forward<AccountSummaryT>(value);
  }
  template <typename AccountSummaryT = Aws::Map<CheckStatus, int>>
  CheckSummary& WithAccountSummary(AccountSummaryT&& value) {
    SetAccountSummary(std::forward<AccountSummaryT>(value));
    return *this;
  }
  inline CheckSummary& AddAccountSummary(CheckStatus key, int value) {
    m_accountSummaryHasBeenSet = true;
    m_accountSummary.emplace(key, value);
    return *this;
  }
  ///@}
 private:
