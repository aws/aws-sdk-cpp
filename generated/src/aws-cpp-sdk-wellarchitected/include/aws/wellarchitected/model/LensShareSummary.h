...
class LensShareSummary {
 public:
  ...
  template <typename ShareIdT = Aws::String>
  LensShareSummary& WithShareId(ShareIdT&& value) {
  ...
  template <typename SharedWithT = Aws::String>
  LensShareSummary& WithSharedWith(SharedWithT&& value) {
  ...
  inline LensShareSummary& WithStatus(ShareStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusMessageT = Aws::String>
  LensShareSummary& WithStatusMessage(StatusMessageT&& value) {
