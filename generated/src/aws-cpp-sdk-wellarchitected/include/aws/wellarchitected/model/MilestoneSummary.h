...
class MilestoneSummary {
 public:
  ...
  inline MilestoneSummary& WithMilestoneNumber(int value) {
  ...
  void SetWorkloadSummary(WorkloadSummaryT&& value) {
    ...
    m_workloadSummary = std::forward<WorkloadSummaryT>(value);
  }
  template <typename WorkloadSummaryT = WorkloadSummary>
  MilestoneSummary& WithWorkloadSummary(WorkloadSummaryT&& value) {
    SetWorkloadSummary(std::forward<WorkloadSummaryT>(value));
    return *this;
  }
  ///@}
 private:
