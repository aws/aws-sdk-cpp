...
namespace Model
{
  ...
  public:
    ...
    template<typename QuestionIdT = Aws::String>
    ReviewTemplateAnswer& WithQuestionId(QuestionIdT&& value) { SetQuestionId(std::forward<QuestionIdT>(value)); return *this;}
    ///@}
    ...
    template<typename PillarIdT = Aws::String>
    ReviewTemplateAnswer& WithPillarId(PillarIdT&& value) { SetPillarId(std::forward<PillarIdT>(value)); return *this;}
    ///@}
    ...
    template<typename QuestionTitleT = Aws::String>
    ReviewTemplateAnswer& WithQuestionTitle(QuestionTitleT&& value) { SetQuestionTitle(std::forward<QuestionTitleT>(value)); return *this;}
    ///@}
    ...
    template<typename QuestionDescriptionT = Aws::String>
    ReviewTemplateAnswer& WithQuestionDescription(QuestionDescriptionT&& value) { SetQuestionDescription(std::forward<QuestionDescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename ImprovementPlanUrlT = Aws::String>
    ReviewTemplateAnswer& WithImprovementPlanUrl(ImprovementPlanUrlT&& value) { SetImprovementPlanUrl(std::forward<ImprovementPlanUrlT>(value)); return *this;}
    ///@}
    ...
    template<typename HelpfulResourceUrlT = Aws::String>
    ReviewTemplateAnswer& WithHelpfulResourceUrl(HelpfulResourceUrlT&& value) { SetHelpfulResourceUrl(std::forward<HelpfulResourceUrlT>(value)); return *this;}
    ///@}
    ...
    template<typename HelpfulResourceDisplayTextT = Aws::String>
    ReviewTemplateAnswer& WithHelpfulResourceDisplayText(HelpfulResourceDisplayTextT&& value) { SetHelpfulResourceDisplayText(std::forward<HelpfulResourceDisplayTextT>(value)); return *this;}
    ///@}
    ...
    template<typename ChoicesT = Aws::Vector<Choice>>
    ReviewTemplateAnswer& WithChoices(ChoicesT&& value) { SetChoices(std::forward<ChoicesT>(value)); return *this;}
    template<typename ChoicesT = Choice>
    ReviewTemplateAnswer& AddChoices(ChoicesT&& value) { m_choicesHasBeenSet = true; m_choices.emplace_back(std::forward<ChoicesT>(value)); return *this; }
    ///@}
    ...
    template<typename SelectedChoicesT = Aws::Vector<Aws::String>>
    ReviewTemplateAnswer& WithSelectedChoices(SelectedChoicesT&& value) { SetSelectedChoices(std::forward<SelectedChoicesT>(value)); return *this;}
    template<typename SelectedChoicesT = Aws::String>
    ReviewTemplateAnswer& AddSelectedChoices(SelectedChoicesT&& value) { m_selectedChoicesHasBeenSet = true; m_selectedChoices.emplace_back(std::forward<SelectedChoicesT>(value)); return *this; }
    ///@}
    ...
    template<typename ChoiceAnswersT = Aws::Vector<ChoiceAnswer>>
    ReviewTemplateAnswer& WithChoiceAnswers(ChoiceAnswersT&& value) { SetChoiceAnswers(std::forward<ChoiceAnswersT>(value)); return *this;}
    template<typename ChoiceAnswersT = ChoiceAnswer>
    ReviewTemplateAnswer& AddChoiceAnswers(ChoiceAnswersT&& value) { m_choiceAnswersHasBeenSet = true; m_choiceAnswers.emplace_back(std::forward<ChoiceAnswersT>(value)); return *this; }
    ///@}
    ...
    inline ReviewTemplateAnswer& WithAnswerStatus(ReviewTemplateAnswerStatus value) { SetAnswerStatus(value); return *this;}
    ///@}
    ...
    template<typename NotesT = Aws::String>
    ReviewTemplateAnswer& WithNotes(NotesT&& value) { SetNotes(std::forward<NotesT>(value)); return *this;}
    ///@}
    ...
    inline ReviewTemplateAnswer& WithReason(AnswerReason value) { SetReason(value); return *this;}
    ///@}
  private:
