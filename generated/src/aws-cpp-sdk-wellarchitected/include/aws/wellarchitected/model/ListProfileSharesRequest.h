...
class ListProfileSharesRequest : public WellArchitectedRequest {
 public:
  ...
  template <typename ProfileArnT = Aws::String>
  ListProfileSharesRequest& WithProfileArn(ProfileArnT&& value) {
  ...
  template <typename SharedWithPrefixT = Aws::String>
  ListProfileSharesRequest& WithSharedWithPrefix(SharedWithPrefixT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListProfileSharesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListProfileSharesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline ListProfileSharesRequest& WithStatus(ShareStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
