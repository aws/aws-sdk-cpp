...
class ListAnswersResult {
 public:
  ...
  template <typename WorkloadIdT = Aws::String>
  ListAnswersResult& WithWorkloadId(WorkloadIdT&& value) {
  ...
  inline ListAnswersResult& WithMilestoneNumber(int value) {
  ...
  template <typename LensAliasT = Aws::String>
  ListAnswersResult& WithLensAlias(LensAliasT&& value) {
  ...
  template <typename LensArnT = Aws::String>
  ListAnswersResult& WithLensArn(LensArnT&& value) {
  ...
  void SetAnswerSummaries(AnswerSummariesT&& value) {
    m_answerSummariesHasBeenSet = true;
    m_answerSummaries = std::forward<AnswerSummariesT>(value);
  }
  template <typename AnswerSummariesT = Aws::Vector<AnswerSummary>>
  ListAnswersResult& WithAnswerSummaries(AnswerSummariesT&& value) {
    SetAnswerSummaries(std::forward<AnswerSummariesT>(value));
    return *this;
  }
  template <typename AnswerSummariesT = AnswerSummary>
  ListAnswersResult& AddAnswerSummaries(AnswerSummariesT&& value) {
    m_answerSummariesHasBeenSet = true;
    m_answerSummaries.emplace_back(std::forward<AnswerSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAnswersResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAnswersResult& WithRequestId(RequestIdT&& value) {
