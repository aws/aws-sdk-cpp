...
class AssociateLensesRequest : public WellArchitectedRequest {
 public:
  ...
  template <typename WorkloadIdT = Aws::String>
  AssociateLensesRequest& WithWorkloadId(WorkloadIdT&& value) {
  ...
  template <typename LensAliasesT = Aws::Vector<Aws::String>>
  AssociateLensesRequest& WithLensAliases(LensAliasesT&& value) {
    SetLensAliases(std::forward<LensAliasesT>(value));
    return *this;
  }
  template <typename LensAliasesT = Aws::String>
  AssociateLensesRequest& AddLensAliases(LensAliasesT&& value) {
    m_lensAliasesHasBeenSet = true;
