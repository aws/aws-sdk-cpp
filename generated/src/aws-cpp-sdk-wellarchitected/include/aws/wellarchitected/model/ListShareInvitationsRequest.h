...
class ListShareInvitationsRequest : public WellArchitectedRequest {
 public:
  ...
  void SetLensNamePrefix(LensNamePrefixT&& value) {
    m_lensNamePrefixHasBeenSet = true;
    m_lensNamePrefix = std::forward<LensNamePrefixT>(value);
  }
  template <typename LensNamePrefixT = Aws::String>
  ListShareInvitationsRequest& WithLensNamePrefix(LensNamePrefixT&& value) {
    SetLensNamePrefix(std::forward<LensNamePrefixT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListShareInvitationsRequest& WithShareResourceType(ShareResourceType value) {
  ...
  inline ListShareInvitationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  void SetTemplateNamePrefix(TemplateNamePrefixT&& value) {
    m_templateNamePrefixHasBeenSet = true;
    m_templateNamePrefix = std::forward<TemplateNamePrefixT>(value);
  }
  template <typename TemplateNamePrefixT = Aws::String>
  ListShareInvitationsRequest& WithTemplateNamePrefix(TemplateNamePrefixT&& value) {
    SetTemplateNamePrefix(std::forward<TemplateNamePrefixT>(value));
    return *this;
  }
  ///@}
 private:
