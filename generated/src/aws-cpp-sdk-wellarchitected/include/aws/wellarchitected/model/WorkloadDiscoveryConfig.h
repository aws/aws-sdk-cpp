...
class WorkloadDiscoveryConfig {
 public:
  ...
  inline void SetTrustedAdvisorIntegrationStatus(TrustedAdvisorIntegrationStatus value) {
    m_trustedAdvisorIntegrationStatusHasBeenSet = true;
    m_trustedAdvisorIntegrationStatus = value;
  }
  inline WorkloadDiscoveryConfig& WithTrustedAdvisorIntegrationStatus(TrustedAdvisorIntegrationStatus value) {
    SetTrustedAdvisorIntegrationStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetWorkloadResourceDefinition(WorkloadResourceDefinitionT&& value) {
    m_workloadResourceDefinitionHasBeenSet = true;
    m_workloadResourceDefinition = std::forward<WorkloadResourceDefinitionT>(value);
  }
  template <typename WorkloadResourceDefinitionT = Aws::Vector<DefinitionType>>
  WorkloadDiscoveryConfig& WithWorkloadResourceDefinition(WorkloadResourceDefinitionT&& value) {
    SetWorkloadResourceDefinition(std::forward<WorkloadResourceDefinitionT>(value));
    return *this;
  }
  inline WorkloadDiscoveryConfig& AddWorkloadResourceDefinition(DefinitionType value) {
    m_workloadResourceDefinitionHasBeenSet = true;
    m_workloadResourceDefinition.push_back(value);
    return *this;
  }
  ///@}
 private:
