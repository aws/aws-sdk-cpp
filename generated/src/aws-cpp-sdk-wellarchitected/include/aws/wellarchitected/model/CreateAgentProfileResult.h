...
namespace Model {
class CreateAgentProfileResult {
 public:
  AWS_WELLARCHITECTED_API CreateAgentProfileResult() = default;
  AWS_WELLARCHITECTED_API CreateAgentProfileResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_WELLARCHITECTED_API CreateAgentProfileResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);

  ///@{
  /**
   * <p>The system name of the created profile.</p>
   */
  ...
  template <typename NameT = Aws::String>
  CreateAgentProfileResult& WithName(NameT&& value) {
  ...
  ///@{
  /**
   * <p>The display name of the created profile.</p>
   */
  ...
  template <typename DisplayNameT = Aws::String>
  CreateAgentProfileResult& WithDisplayName(DisplayNameT&& value) {
  ...
  ///@{
  /**
   * <p>A description of the created profile.</p>
   */
  ...
  template <typename DescriptionT = Aws::String>
  CreateAgentProfileResult& WithDescription(DescriptionT&& value) {
  ...
  ///@{
  /**
   * <p>The business overview of the created profile.</p>
   */
  ...
  template <typename BusinessOverviewT = Aws::String>
  CreateAgentProfileResult& WithBusinessOverview(BusinessOverviewT&& value) {
  ...
  ///@{
  /**
   * <p>The Well-Architected Tool Framework pillars associated with the created
   * profile.</p>
   */
  ...
  template <typename PillarsT = Aws::Vector<Pillar>>
  CreateAgentProfileResult& WithPillars(PillarsT&& value) {
    SetPillars(std::forward<PillarsT>(value));
    return *this;
  }
  inline CreateAgentProfileResult& AddPillars(Pillar value) {
    m_pillarsHasBeenSet = true;
  ...
  inline CreateAgentProfileResult& WithDeletionProtection(bool value) {
  ...
  template <typename ExecutionRoleArnT = Aws::String>
  CreateAgentProfileResult& WithExecutionRoleArn(ExecutionRoleArnT&& value) {
  ...
  template <typename AggregationConfigurationT = Aws::Vector<AggregationConfiguration>>
  CreateAgentProfileResult& WithAggregationConfiguration(AggregationConfigurationT&& value) {
  ...
  CreateAgentProfileResult& AddAggregationConfiguration(AggregationConfigurationT&& value) {
    m_aggregationConfigurationHasBeenSet = true;
  ...
  ///@{
  /**
   * <p>The Amazon Resource Name (ARN) of the created profile.</p>
   */
  ...
  template <typename ArnT = Aws::String>
  CreateAgentProfileResult& WithArn(ArnT&& value) {
  ...
  inline CreateAgentProfileResult& WithEligibleForScheduledGeneration(bool value) {
  ...
  inline CreateAgentProfileResult& WithEligibleForArchitectureGeneration(bool value) {
  ...
  template <typename FieldErrorsT = Aws::Map<Aws::String, Aws::String>>
  CreateAgentProfileResult& WithFieldErrors(FieldErrorsT&& value) {
  ...
  CreateAgentProfileResult& AddFieldErrors(FieldErrorsKeyT&& key, FieldErrorsValueT&& value) {
    m_fieldErrorsHasBeenSet = true;
  ...
  ///@{
  /**
   * <p>The tags associated with the created profile.</p>
   */
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateAgentProfileResult& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateAgentProfileResult& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename CreatedByT = Aws::String>
  CreateAgentProfileResult& WithCreatedBy(CreatedByT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  CreateAgentProfileResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename LastModifiedByT = Aws::String>
  CreateAgentProfileResult& WithLastModifiedBy(LastModifiedByT&& value) {
  ...
  template <typename LastModifiedAtT = Aws::Utils::DateTime>
  CreateAgentProfileResult& WithLastModifiedAt(LastModifiedAtT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateAgentProfileResult& WithRequestId(RequestIdT&& value) {
