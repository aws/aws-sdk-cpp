...
class ListCheckDetailsResult {
 public:
  ...
  void SetCheckDetails(CheckDetailsT&& value) {
    m_checkDetailsHasBeenSet = true;
    m_checkDetails = std::forward<CheckDetailsT>(value);
  }
  template <typename CheckDetailsT = Aws::Vector<CheckDetail>>
  ListCheckDetailsResult& WithCheckDetails(CheckDetailsT&& value) {
    SetCheckDetails(std::forward<CheckDetailsT>(value));
    return *this;
  }
  template <typename CheckDetailsT = CheckDetail>
  ListCheckDetailsResult& AddCheckDetails(CheckDetailsT&& value) {
    m_checkDetailsHasBeenSet = true;
    m_checkDetails.emplace_back(std::forward<CheckDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListCheckDetailsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListCheckDetailsResult& WithRequestId(RequestIdT&& value) {
