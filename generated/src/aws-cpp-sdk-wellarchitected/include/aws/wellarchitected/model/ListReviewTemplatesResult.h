...
class ListReviewTemplatesResult {
 public:
  ...
  void SetReviewTemplates(ReviewTemplatesT&& value) {
    m_reviewTemplatesHasBeenSet = true;
    m_reviewTemplates = std::forward<ReviewTemplatesT>(value);
  }
  template <typename ReviewTemplatesT = Aws::Vector<ReviewTemplateSummary>>
  ListReviewTemplatesResult& WithReviewTemplates(ReviewTemplatesT&& value) {
    SetReviewTemplates(std::forward<ReviewTemplatesT>(value));
    return *this;
  }
  template <typename ReviewTemplatesT = ReviewTemplateSummary>
  ListReviewTemplatesResult& AddReviewTemplates(ReviewTemplatesT&& value) {
    m_reviewTemplatesHasBeenSet = true;
    m_reviewTemplates.emplace_back(std::forward<ReviewTemplatesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListReviewTemplatesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListReviewTemplatesResult& WithRequestId(RequestIdT&& value) {
