...
class VersionDifferences {
 public:
  ...
  void SetPillarDifferences(PillarDifferencesT&& value) {
    ...
    m_pillarDifferences = std::forward<PillarDifferencesT>(value);
  }
  template <typename PillarDifferencesT = Aws::Vector<PillarDifference>>
  VersionDifferences& WithPillarDifferences(PillarDifferencesT&& value) {
    SetPillarDifferences(std::forward<PillarDifferencesT>(value));
    return *this;
  }
  template <typename PillarDifferencesT = PillarDifference>
  VersionDifferences& AddPillarDifferences(PillarDifferencesT&& value) {
    m_pillarDifferencesHasBeenSet = true;
    m_pillarDifferences.emplace_back(std::forward<PillarDifferencesT>(value));
    return *this;
  }
  ///@}
 private:
