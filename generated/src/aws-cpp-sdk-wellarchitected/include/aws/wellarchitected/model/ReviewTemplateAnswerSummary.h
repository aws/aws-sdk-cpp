...
class ReviewTemplateAnswerSummary {
 public:
  ...
  inline ReviewTemplateAnswerSummary& WithIsApplicable(bool value) {
  ...
  inline ReviewTemplateAnswerSummary& WithAnswerStatus(ReviewTemplateAnswerStatus value) {
  ...
  inline ReviewTemplateAnswerSummary& WithReason(AnswerReason value) {
    SetReason(value);
    return *this;
  }
  ///@}
  ...
  inline ReviewTemplateAnswerSummary& WithQuestionType(QuestionType value) {
