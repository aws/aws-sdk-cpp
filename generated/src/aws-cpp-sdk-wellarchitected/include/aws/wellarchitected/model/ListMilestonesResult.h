...
class ListMilestonesResult {
 public:
  ...
  template <typename WorkloadIdT = Aws::String>
  ListMilestonesResult& WithWorkloadId(WorkloadIdT&& value) {
  ...
  void SetMilestoneSummaries(MilestoneSummariesT&& value) {
    m_milestoneSummariesHasBeenSet = true;
    m_milestoneSummaries = std::forward<MilestoneSummariesT>(value);
  }
  template <typename MilestoneSummariesT = Aws::Vector<MilestoneSummary>>
  ListMilestonesResult& WithMilestoneSummaries(MilestoneSummariesT&& value) {
    SetMilestoneSummaries(std::forward<MilestoneSummariesT>(value));
    return *this;
  }
  template <typename MilestoneSummariesT = MilestoneSummary>
  ListMilestonesResult& AddMilestoneSummaries(MilestoneSummariesT&& value) {
    m_milestoneSummariesHasBeenSet = true;
    m_milestoneSummaries.emplace_back(std::forward<MilestoneSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListMilestonesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListMilestonesResult& WithRequestId(RequestIdT&& value) {
