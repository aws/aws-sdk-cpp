...
public:
  ...
  WellArchitectedError(const Aws::Client::AWSError<WellArchitectedErrors>& rhs) : Aws::Client::AWSError<WellArchitectedErrors>(rhs) {}
  WellArchitectedError(Aws::Client::AWSError<WellArchitectedErrors>&& rhs) : Aws::Client::AWSError<WellArchitectedErrors>(rhs) {}
