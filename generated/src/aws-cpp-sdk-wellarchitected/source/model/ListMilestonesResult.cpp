...
ListMilestonesResult::ListMilestonesResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListMilestonesResult& ListMilestonesResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("MilestoneSummaries")) {
    ...
    for (unsigned milestoneSummariesIndex = 0; milestoneSummariesIndex < milestoneSummariesJsonList.GetLength();
         ++milestoneSummariesIndex) {
