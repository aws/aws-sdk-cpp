...
ListProfileNotificationsResult::ListProfileNotificationsResult()
{
}

ListProfileNotificationsResult::ListProfileNotificationsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
