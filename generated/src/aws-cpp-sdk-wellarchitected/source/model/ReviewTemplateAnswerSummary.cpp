...
ReviewTemplateAnswerSummary::ReviewTemplateAnswerSummary(JsonView jsonValue) { *this = jsonValue; }
...
ReviewTemplateAnswerSummary& ReviewTemplateAnswerSummary::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("ChoiceAnswerSummaries")) {
    ...
    for (unsigned choiceAnswerSummariesIndex = 0; choiceAnswerSummariesIndex < choiceAnswerSummariesJsonList.GetLength();
         ++choiceAnswerSummariesIndex) {
