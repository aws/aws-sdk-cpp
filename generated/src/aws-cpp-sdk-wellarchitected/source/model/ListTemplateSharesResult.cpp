...
ListTemplateSharesResult::ListTemplateSharesResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListTemplateSharesResult& ListTemplateSharesResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("TemplateShareSummaries")) {
    ...
    for (unsigned templateShareSummariesIndex = 0; templateShareSummariesIndex < templateShareSummariesJsonList.GetLength();
         ++templateShareSummariesIndex) {
