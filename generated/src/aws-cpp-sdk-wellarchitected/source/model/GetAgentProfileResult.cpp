...
GetAgentProfileResult::GetAgentProfileResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

GetAgentProfileResult& GetAgentProfileResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
