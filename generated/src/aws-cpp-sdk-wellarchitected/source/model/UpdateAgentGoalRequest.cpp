...
Aws::String UpdateAgentGoalRequest::SerializePayload() const {
  JsonValue payload;
...
UpdateAgentGoalRequest::EndpointParameters UpdateAgentGoalRequest::GetEndpointContextParams() const {
