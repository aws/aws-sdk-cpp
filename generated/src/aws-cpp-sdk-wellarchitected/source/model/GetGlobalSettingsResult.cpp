...
GetGlobalSettingsResult& GetGlobalSettingsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("OrganizationSharingStatus")) {
    m_organizationSharingStatus =
        OrganizationSharingStatusMapper::GetOrganizationSharingStatusForName(jsonValue.GetString("OrganizationSharingStatus"));
    m_organizationSharingStatusHasBeenSet = true;
  }
  if (jsonValue.ValueExists("DiscoveryIntegrationStatus")) {
    m_discoveryIntegrationStatus =
        DiscoveryIntegrationStatusMapper::GetDiscoveryIntegrationStatusForName(jsonValue.GetString("DiscoveryIntegrationStatus"));
