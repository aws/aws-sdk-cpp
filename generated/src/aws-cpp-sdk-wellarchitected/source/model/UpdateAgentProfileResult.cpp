...
UpdateAgentProfileResult::UpdateAgentProfileResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

UpdateAgentProfileResult& UpdateAgentProfileResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
