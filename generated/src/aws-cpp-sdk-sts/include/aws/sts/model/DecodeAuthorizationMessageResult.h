...
class DecodeAuthorizationMessageResult {
 public:
  ...
  void SetDecodedMessage(DecodedMessageT&& value) {
    m_decodedMessageHasBeenSet = true;
    m_decodedMessage = std::forward<DecodedMessageT>(value);
  }
  template <typename DecodedMessageT = Aws::String>
  DecodeAuthorizationMessageResult& WithDecodedMessage(DecodedMessageT&& value) {
    SetDecodedMessage(std::forward<DecodedMessageT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DecodeAuthorizationMessageResult& WithResponseMetadata(ResponseMetadataT&& value) {
