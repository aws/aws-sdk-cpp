...
class AssumeRoleRequest : public STSRequest {
 ...
 public:
  ...
  inline AssumeRoleRequest& WithDurationSeconds(int value) {
  ...
  void SetTransitiveTagKeys(TransitiveTagKeysT&& value) {
    m_transitiveTagKeysHasBeenSet = true;
    m_transitiveTagKeys = std::forward<TransitiveTagKeysT>(value);
  }
  template <typename TransitiveTagKeysT = Aws::Vector<Aws::String>>
  AssumeRoleRequest& WithTransitiveTagKeys(TransitiveTagKeysT&& value) {
    SetTransitiveTagKeys(std::forward<TransitiveTagKeysT>(value));
    return *this;
  }
  template <typename TransitiveTagKeysT = Aws::String>
  AssumeRoleRequest& AddTransitiveTagKeys(TransitiveTagKeysT&& value) {
    m_transitiveTagKeysHasBeenSet = true;
    m_transitiveTagKeys.emplace_back(std::forward<TransitiveTagKeysT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTokenCode(TokenCodeT&& value) {
    ...
    m_tokenCode = std::forward<TokenCodeT>(value);
  }
  template <typename TokenCodeT = Aws::String>
  AssumeRoleRequest& WithTokenCode(TokenCodeT&& value) {
    SetTokenCode(std::forward<TokenCodeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetProvidedContexts(ProvidedContextsT&& value) {
    m_providedContextsHasBeenSet = true;
    m_providedContexts = std::forward<ProvidedContextsT>(value);
  }
  template <typename ProvidedContextsT = Aws::Vector<ProvidedContext>>
  AssumeRoleRequest& WithProvidedContexts(ProvidedContextsT&& value) {
    SetProvidedContexts(std::forward<ProvidedContextsT>(value));
    return *this;
  }
  template <typename ProvidedContextsT = ProvidedContext>
  AssumeRoleRequest& AddProvidedContexts(ProvidedContextsT&& value) {
    m_providedContextsHasBeenSet = true;
    m_providedContexts.emplace_back(std::forward<ProvidedContextsT>(value));
    return *this;
  }
  ///@}
 private:
