...
class GetCallerIdentityResult {
 public:
  ...
  template <typename UserIdT = Aws::String>
  GetCallerIdentityResult& WithUserId(UserIdT&& value) {
  ...
  template <typename AccountT = Aws::String>
  GetCallerIdentityResult& WithAccount(AccountT&& value) {
  ...
  template <typename ArnT = Aws::String>
  GetCallerIdentityResult& WithArn(ArnT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  GetCallerIdentityResult& WithResponseMetadata(ResponseMetadataT&& value) {
