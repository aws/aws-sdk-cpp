...
namespace Model {
class CreateServiceFunctionResourcesResult {
 public:
  AWS_RESILIENCEHUBV2_API CreateServiceFunctionResourcesResult() = default;
  AWS_RESILIENCEHUBV2_API CreateServiceFunctionResourcesResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_RESILIENCEHUBV2_API CreateServiceFunctionResourcesResult& operator=(
  ...
  template <typename ServiceArnT = Aws::String>
  CreateServiceFunctionResourcesResult& WithServiceArn(ServiceArnT&& value) {
  ...
  template <typename ServiceFunctionIdT = Aws::String>
  CreateServiceFunctionResourcesResult& WithServiceFunctionId(ServiceFunctionIdT&& value) {
  ...
  template <typename ResourcesT = Aws::Vector<Aws::String>>
  CreateServiceFunctionResourcesResult& WithResources(ResourcesT&& value) {
    SetResources(std::forward<ResourcesT>(value));
    return *this;
  }
  template <typename ResourcesT = Aws::String>
  CreateServiceFunctionResourcesResult& AddResources(ResourcesT&& value) {
    m_resourcesHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  CreateServiceFunctionResourcesResult& WithRequestId(RequestIdT&& value) {
