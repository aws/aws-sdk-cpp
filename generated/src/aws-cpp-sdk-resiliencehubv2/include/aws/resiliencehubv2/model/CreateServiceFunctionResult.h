...
namespace Model {
class CreateServiceFunctionResult {
 public:
  AWS_RESILIENCEHUBV2_API CreateServiceFunctionResult() = default;
  AWS_RESILIENCEHUBV2_API CreateServiceFunctionResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_RESILIENCEHUBV2_API CreateServiceFunctionResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ServiceFunctionT = ServiceFunction>
  CreateServiceFunctionResult& WithServiceFunction(ServiceFunctionT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateServiceFunctionResult& WithRequestId(RequestIdT&& value) {
