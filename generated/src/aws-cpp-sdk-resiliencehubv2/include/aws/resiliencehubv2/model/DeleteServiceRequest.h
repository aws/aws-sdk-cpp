...
/**
 */
class DeleteServiceRequest : public Resiliencehubv2Request {
 public:
  AWS_RESILIENCEHUBV2_API DeleteServiceRequest() = default;
  ...
  template <typename ServiceArnT = Aws::String>
  DeleteServiceRequest& WithServiceArn(ServiceArnT&& value) {
