 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/resiliencehubv2-2026-02-17/ResourceNotFoundException">AWS
 * API Reference</a></p>
 */
class ResourceNotFoundException {
 public:
  AWS_RESILIENCEHUBV2_API ResourceNotFoundException() = default;
  AWS_RESILIENCEHUBV2_API ResourceNotFoundException(Aws::Utils::Json::JsonView jsonValue);
  AWS_RESILIENCEHUBV2_API ResourceNotFoundException& operator=(Aws::Utils::Json::JsonView jsonValue);
