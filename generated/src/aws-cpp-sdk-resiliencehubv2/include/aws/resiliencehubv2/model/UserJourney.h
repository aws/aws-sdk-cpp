...
/**
 * <p>Represents a user journey that defines a critical path through a
 * system.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/resiliencehubv2-2026-02-17/UserJourney">AWS
 * API Reference</a></p>
 */
class UserJourney {
 public:
