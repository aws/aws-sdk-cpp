...
/**
 * <p>Metadata for a service workflow updated event.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/resiliencehubv2-2026-02-17/ServiceWorkflowUpdatedMetadata">AWS
 * API Reference</a></p>
 */
class ServiceWorkflowUpdatedMetadata {
 public:
  AWS_RESILIENCEHUBV2_API ServiceWorkflowUpdatedMetadata() = default;
  AWS_RESILIENCEHUBV2_API ServiceWorkflowUpdatedMetadata(Aws::Utils::Json::JsonView jsonValue);
  AWS_RESILIENCEHUBV2_API ServiceWorkflowUpdatedMetadata& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename ServiceFunctionIdT = Aws::String>
  ServiceWorkflowUpdatedMetadata& WithServiceFunctionId(ServiceFunctionIdT&& value) {
  ...
  template <typename ServiceFunctionNameT = Aws::String>
  ServiceWorkflowUpdatedMetadata& WithServiceFunctionName(ServiceFunctionNameT&& value) {
