...
/**
 */
class ListTestsRequest : public Resiliencehubv2Request {
 public:
  AWS_RESILIENCEHUBV2_API ListTestsRequest() = default;
  ...
  template <typename ServiceArnT = Aws::String>
  ListTestsRequest& WithServiceArn(ServiceArnT&& value) {
  ...
  inline ListTestsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
