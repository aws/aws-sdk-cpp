...
/**
 */
class ListTestRunsRequest : public Resiliencehubv2Request {
 public:
  AWS_RESILIENCEHUBV2_API ListTestRunsRequest() = default;
  ...
  template <typename ServiceArnT = Aws::String>
  ListTestRunsRequest& WithServiceArn(ServiceArnT&& value) {
  ...
  template <typename TestIdT = Aws::String>
  ListTestRunsRequest& WithTestId(TestIdT&& value) {
  ...
  inline ListTestRunsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTestRunsRequest& WithNextToken(NextTokenT&& value) {
