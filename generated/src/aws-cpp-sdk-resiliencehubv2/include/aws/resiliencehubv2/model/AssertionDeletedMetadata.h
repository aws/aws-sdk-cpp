...
/**
 * <p>Metadata for an assertion deleted event.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/resiliencehubv2-2026-02-17/AssertionDeletedMetadata">AWS
 * API Reference</a></p>
 */
class AssertionDeletedMetadata {
 public:
  AWS_RESILIENCEHUBV2_API AssertionDeletedMetadata() = default;
  AWS_RESILIENCEHUBV2_API AssertionDeletedMetadata(Aws::Utils::Json::JsonView jsonValue);
  AWS_RESILIENCEHUBV2_API AssertionDeletedMetadata& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename AssertionIdT = Aws::String>
  AssertionDeletedMetadata& WithAssertionId(AssertionIdT&& value) {
  ...
  template <typename AssertionNameT = Aws::String>
  AssertionDeletedMetadata& WithAssertionName(AssertionNameT&& value) {
