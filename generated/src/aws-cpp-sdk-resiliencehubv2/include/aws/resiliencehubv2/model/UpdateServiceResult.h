...
class UpdateServiceResult {
 public:
  AWS_RESILIENCEHUBV2_API UpdateServiceResult() = default;
  AWS_RESILIENCEHUBV2_API UpdateServiceResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_RESILIENCEHUBV2_API UpdateServiceResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
