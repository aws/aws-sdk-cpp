...
/**
 * <p>Metadata for a service resources disassociated event.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/resiliencehubv2-2026-02-17/ServiceResourcesDisassociatedMetadata">AWS
 * API Reference</a></p>
 */
class ServiceResourcesDisassociatedMetadata {
 public:
  ...
  inline ServiceResourcesDisassociatedMetadata& WithResourceCount(int value) {
