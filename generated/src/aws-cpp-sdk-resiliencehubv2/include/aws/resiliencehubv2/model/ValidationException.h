...
/**
 * <p>Validation error — invalid input parameters.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/resiliencehubv2-2026-02-17/ValidationException">AWS
 * API Reference</a></p>
 */
class ValidationException {
 public:
  AWS_RESILIENCEHUBV2_API ValidationException() = default;
  AWS_RESILIENCEHUBV2_API ValidationException(Aws::Utils::Json::JsonView jsonValue);
  AWS_RESILIENCEHUBV2_API ValidationException& operator=(Aws::Utils::Json::JsonView jsonValue);
