...
/**
 */
class GetServiceRequest : public Resiliencehubv2Request {
 public:
  AWS_RESILIENCEHUBV2_API GetServiceRequest() = default;
  ...
  template <typename ServiceArnT = Aws::String>
  GetServiceRequest& WithServiceArn(ServiceArnT&& value) {
