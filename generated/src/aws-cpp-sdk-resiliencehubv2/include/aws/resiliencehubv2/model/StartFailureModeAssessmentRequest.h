...
/**
 */
class StartFailureModeAssessmentRequest : public Resiliencehubv2Request {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "StartFailureModeAssessment"; }
