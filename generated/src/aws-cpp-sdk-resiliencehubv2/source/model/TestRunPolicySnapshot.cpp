...
TestRunPolicySnapshot::TestRunPolicySnapshot(JsonView jsonValue) { *this = jsonValue; }

TestRunPolicySnapshot& TestRunPolicySnapshot::operator=(JsonView jsonValue) {
...
JsonValue TestRunPolicySnapshot::Jsonize() const {
  JsonValue payload;
