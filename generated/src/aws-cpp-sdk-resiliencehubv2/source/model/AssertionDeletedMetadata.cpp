...
AssertionDeletedMetadata::AssertionDeletedMetadata(JsonView jsonValue) { *this = jsonValue; }

AssertionDeletedMetadata& AssertionDeletedMetadata::operator=(JsonView jsonValue) {
...
JsonValue AssertionDeletedMetadata::Jsonize() const {
  JsonValue payload;
