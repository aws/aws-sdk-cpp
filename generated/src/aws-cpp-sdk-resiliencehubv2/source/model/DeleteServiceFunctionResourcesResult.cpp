...
DeleteServiceFunctionResourcesResult::DeleteServiceFunctionResourcesResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

DeleteServiceFunctionResourcesResult& DeleteServiceFunctionResourcesResult::operator=(
