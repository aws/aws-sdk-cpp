...
CreateServiceFunctionResourcesResult::CreateServiceFunctionResourcesResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

CreateServiceFunctionResourcesResult& CreateServiceFunctionResourcesResult::operator=(
