...
DeleteServiceFunctionResult::DeleteServiceFunctionResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

DeleteServiceFunctionResult& DeleteServiceFunctionResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
