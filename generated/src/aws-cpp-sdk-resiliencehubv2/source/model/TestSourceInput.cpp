...
TestSourceInput::TestSourceInput(JsonView jsonValue) { *this = jsonValue; }

TestSourceInput& TestSourceInput::operator=(JsonView jsonValue) {
...
JsonValue TestSourceInput::Jsonize() const {
  JsonValue payload;
