...
ListTestRunDependenciesResult::ListTestRunDependenciesResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

ListTestRunDependenciesResult& ListTestRunDependenciesResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
