...
MultiAzTargets::MultiAzTargets(JsonView jsonValue) { *this = jsonValue; }

MultiAzTargets& MultiAzTargets::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("disasterRecoveryApproach")) {
    m_disasterRecoveryApproach =
        MultiAzDisasterRecoveryApproachMapper::GetMultiAzDisasterRecoveryApproachForName(jsonValue.GetString("disasterRecoveryApproach"));
    m_disasterRecoveryApproachHasBeenSet = true;
  }
  return *this;
}

JsonValue MultiAzTargets::Jsonize() const {
  JsonValue payload;
  ...
  if (m_disasterRecoveryApproachHasBeenSet) {
    payload.WithString("disasterRecoveryApproach",
                       MultiAzDisasterRecoveryApproachMapper::GetNameForMultiAzDisasterRecoveryApproach(m_disasterRecoveryApproach));
  }
