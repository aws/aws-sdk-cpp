...
DeleteAssertionResult::DeleteAssertionResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

DeleteAssertionResult& DeleteAssertionResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
