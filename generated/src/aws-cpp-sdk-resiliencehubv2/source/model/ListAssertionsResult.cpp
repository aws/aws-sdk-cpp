...
ListAssertionsResult::ListAssertionsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

ListAssertionsResult& ListAssertionsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
