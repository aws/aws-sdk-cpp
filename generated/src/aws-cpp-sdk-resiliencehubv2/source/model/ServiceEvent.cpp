...
ServiceEvent::ServiceEvent(JsonView jsonValue) { *this = jsonValue; }
...
ServiceEvent& ServiceEvent::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("eventType")) {
    m_eventType = ServiceEventTypeMapper::GetServiceEventTypeForName(jsonValue.GetString("eventType"));
...
JsonValue ServiceEvent::Jsonize() const {
  JsonValue payload;
  ...
  if (m_eventTypeHasBeenSet) {
    payload.WithString("eventType", ServiceEventTypeMapper::GetNameForServiceEventType(m_eventType));
  }
