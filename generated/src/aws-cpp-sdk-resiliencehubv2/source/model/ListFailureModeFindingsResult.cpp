...
ListFailureModeFindingsResult::ListFailureModeFindingsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

ListFailureModeFindingsResult& ListFailureModeFindingsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
