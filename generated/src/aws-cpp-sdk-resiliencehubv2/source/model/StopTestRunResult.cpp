...
StopTestRunResult::StopTestRunResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

StopTestRunResult& StopTestRunResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
