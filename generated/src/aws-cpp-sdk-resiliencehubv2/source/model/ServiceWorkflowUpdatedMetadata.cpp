...
ServiceWorkflowUpdatedMetadata::ServiceWorkflowUpdatedMetadata(JsonView jsonValue) { *this = jsonValue; }

ServiceWorkflowUpdatedMetadata& ServiceWorkflowUpdatedMetadata::operator=(JsonView jsonValue) {
...
JsonValue ServiceWorkflowUpdatedMetadata::Jsonize() const {
  JsonValue payload;
