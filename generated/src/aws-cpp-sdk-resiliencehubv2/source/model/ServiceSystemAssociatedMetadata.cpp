...
ServiceSystemAssociatedMetadata::ServiceSystemAssociatedMetadata(JsonView jsonValue) { *this = jsonValue; }

ServiceSystemAssociatedMetadata& ServiceSystemAssociatedMetadata::operator=(JsonView jsonValue) {
...
JsonValue ServiceSystemAssociatedMetadata::Jsonize() const {
  JsonValue payload;
