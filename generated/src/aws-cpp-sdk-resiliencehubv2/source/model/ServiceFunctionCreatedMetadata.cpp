...
ServiceFunctionCreatedMetadata::ServiceFunctionCreatedMetadata(JsonView jsonValue) { *this = jsonValue; }

ServiceFunctionCreatedMetadata& ServiceFunctionCreatedMetadata::operator=(JsonView jsonValue) {
...
JsonValue ServiceFunctionCreatedMetadata::Jsonize() const {
  JsonValue payload;
