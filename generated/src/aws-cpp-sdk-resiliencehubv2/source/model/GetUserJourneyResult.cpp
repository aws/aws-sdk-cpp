...
GetUserJourneyResult::GetUserJourneyResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

GetUserJourneyResult& GetUserJourneyResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
