...
CreateInputSourceResult::CreateInputSourceResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

CreateInputSourceResult& CreateInputSourceResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
