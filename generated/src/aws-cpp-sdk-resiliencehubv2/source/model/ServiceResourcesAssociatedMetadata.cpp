...
ServiceResourcesAssociatedMetadata::ServiceResourcesAssociatedMetadata(JsonView jsonValue) { *this = jsonValue; }

ServiceResourcesAssociatedMetadata& ServiceResourcesAssociatedMetadata::operator=(JsonView jsonValue) {
...
JsonValue ServiceResourcesAssociatedMetadata::Jsonize() const {
  JsonValue payload;
