...
TestingRecommendation::TestingRecommendation(JsonView jsonValue) { *this = jsonValue; }

TestingRecommendation& TestingRecommendation::operator=(JsonView jsonValue) {
...
JsonValue TestingRecommendation::Jsonize() const {
  JsonValue payload;
