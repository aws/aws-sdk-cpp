...
StartFailureModeAssessmentResult::StartFailureModeAssessmentResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

StartFailureModeAssessmentResult& StartFailureModeAssessmentResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
