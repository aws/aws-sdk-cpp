...
AssertionCreatedMetadata::AssertionCreatedMetadata(JsonView jsonValue) { *this = jsonValue; }

AssertionCreatedMetadata& AssertionCreatedMetadata::operator=(JsonView jsonValue) {
...
JsonValue AssertionCreatedMetadata::Jsonize() const {
  JsonValue payload;
