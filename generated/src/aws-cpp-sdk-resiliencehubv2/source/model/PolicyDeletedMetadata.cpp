...
PolicyDeletedMetadata::PolicyDeletedMetadata(JsonView jsonValue) { *this = jsonValue; }

PolicyDeletedMetadata& PolicyDeletedMetadata::operator=(JsonView jsonValue) {
...
JsonValue PolicyDeletedMetadata::Jsonize() const {
  JsonValue payload;
