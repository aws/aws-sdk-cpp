...
SuccessCriteriaAlarmSummary::SuccessCriteriaAlarmSummary(JsonView jsonValue) { *this = jsonValue; }

SuccessCriteriaAlarmSummary& SuccessCriteriaAlarmSummary::operator=(JsonView jsonValue) {
...
JsonValue SuccessCriteriaAlarmSummary::Jsonize() const {
  JsonValue payload;
