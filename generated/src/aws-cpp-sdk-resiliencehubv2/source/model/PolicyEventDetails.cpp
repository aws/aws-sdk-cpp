...
PolicyEventDetails::PolicyEventDetails(JsonView jsonValue) { *this = jsonValue; }

PolicyEventDetails& PolicyEventDetails::operator=(JsonView jsonValue) {
...
JsonValue PolicyEventDetails::Jsonize() const {
  JsonValue payload;
