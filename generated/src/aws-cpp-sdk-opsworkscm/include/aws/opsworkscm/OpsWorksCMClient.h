...
namespace OpsWorksCM
{
   ...
   */
  class AWS_OPSWORKSCM_API OpsWorksCMClient : Aws::Client::ClientWithAsyncTemplateMethods<OpsWorksCMClient>,
    smithy::client::AwsSmithyClientT<Aws::OpsWorksCM::SERVICE_NAME,
