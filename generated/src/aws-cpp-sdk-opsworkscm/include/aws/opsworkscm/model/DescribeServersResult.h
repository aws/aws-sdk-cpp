...
namespace Model
{
  ...
  public:
    ...
    inline DescribeServersResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DescribeServersResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DescribeServersResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
