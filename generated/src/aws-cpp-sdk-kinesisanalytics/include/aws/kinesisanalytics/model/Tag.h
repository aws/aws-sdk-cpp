...
class Tag {
 public:
  AWS_KINESISANALYTICS_API Tag() = default;
  AWS_KINESISANALYTICS_API Tag(Aws::Utils::Json::JsonView jsonValue);
  AWS_KINESISANALYTICS_API Tag& operator=(Aws::Utils::Json::JsonView jsonValue);
