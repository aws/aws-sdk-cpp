...
class CreateApplicationResult {
 public:
  ...
  void SetApplicationSummary(ApplicationSummaryT&& value) {
    m_applicationSummaryHasBeenSet = true;
    m_applicationSummary = std::forward<ApplicationSummaryT>(value);
  }
  template <typename ApplicationSummaryT = ApplicationSummary>
  CreateApplicationResult& WithApplicationSummary(ApplicationSummaryT&& value) {
    SetApplicationSummary(std::forward<ApplicationSummaryT>(value));
    return *this;
  }
  ///@}
