...
class CSVMappingParameters {
 public:
  ...
  void SetRecordRowDelimiter(RecordRowDelimiterT&& value) {
    m_recordRowDelimiterHasBeenSet = true;
    m_recordRowDelimiter = std::forward<RecordRowDelimiterT>(value);
  }
  template <typename RecordRowDelimiterT = Aws::String>
  CSVMappingParameters& WithRecordRowDelimiter(RecordRowDelimiterT&& value) {
    SetRecordRowDelimiter(std::forward<RecordRowDelimiterT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRecordColumnDelimiter(RecordColumnDelimiterT&& value) {
    m_recordColumnDelimiterHasBeenSet = true;
    m_recordColumnDelimiter = std::forward<RecordColumnDelimiterT>(value);
  }
  template <typename RecordColumnDelimiterT = Aws::String>
  CSVMappingParameters& WithRecordColumnDelimiter(RecordColumnDelimiterT&& value) {
    SetRecordColumnDelimiter(std::forward<RecordColumnDelimiterT>(value));
    return *this;
  }
  ///@}
 private:
