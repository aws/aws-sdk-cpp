...
class AddApplicationReferenceDataSourceRequest : public KinesisAnalyticsRequest {
 public:
  ...
  template <typename ApplicationNameT = Aws::String>
  AddApplicationReferenceDataSourceRequest& WithApplicationName(ApplicationNameT&& value) {
  ...
  inline AddApplicationReferenceDataSourceRequest& WithCurrentApplicationVersionId(long long value) {
  ...
  void SetReferenceDataSource(ReferenceDataSourceT&& value) {
    m_referenceDataSourceHasBeenSet = true;
    m_referenceDataSource = std::forward<ReferenceDataSourceT>(value);
  }
  template <typename ReferenceDataSourceT = ReferenceDataSource>
  AddApplicationReferenceDataSourceRequest& WithReferenceDataSource(ReferenceDataSourceT&& value) {
    SetReferenceDataSource(std::forward<ReferenceDataSourceT>(value));
    return *this;
  }
  ///@}
 private:
