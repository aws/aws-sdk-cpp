...
class UpdateApplicationRequest : public KinesisAnalyticsRequest {
 public:
  ...
  inline UpdateApplicationRequest& WithCurrentApplicationVersionId(long long value) {
  ...
  void SetApplicationUpdate(ApplicationUpdateT&& value) {
    m_applicationUpdateHasBeenSet = true;
    m_applicationUpdate = std::forward<ApplicationUpdateT>(value);
  }
  template <typename ApplicationUpdateT = ApplicationUpdate>
  UpdateApplicationRequest& WithApplicationUpdate(ApplicationUpdateT&& value) {
    SetApplicationUpdate(std::forward<ApplicationUpdateT>(value));
    return *this;
  }
  ///@}
 private:
