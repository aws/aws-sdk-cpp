...
class InputStartingPositionConfiguration {
 public:
  AWS_KINESISANALYTICS_API InputStartingPositionConfiguration() = default;
  ...
  inline void SetInputStartingPosition(InputStartingPosition value) {
    m_inputStartingPositionHasBeenSet = true;
    m_inputStartingPosition = value;
  }
  inline InputStartingPositionConfiguration& WithInputStartingPosition(InputStartingPosition value) {
    SetInputStartingPosition(value);
    return *this;
  }
  ///@}
 private:
