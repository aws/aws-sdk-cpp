...
class AWS_KINESISANALYTICS_API KinesisAnalyticsClient : public Aws::Client::AWSJsonClient,
                                                        ...
                                                        public KinesisAnalyticsWaiter<KinesisAnalyticsClient> {
 public:
   ...
   */
  KinesisAnalyticsClient(const Aws::KinesisAnalytics::KinesisAnalyticsClientConfiguration& clientConfiguration =
  ...
  KinesisAnalyticsClient(const Aws::Auth::AWSCredentials& credentials,
                         std::shared_ptr<KinesisAnalyticsEndpointProviderBase> endpointProvider = nullptr,
                         const Aws::KinesisAnalytics::KinesisAnalyticsClientConfiguration& clientConfiguration =
                             Aws::KinesisAnalytics::KinesisAnalyticsClientConfiguration());
   ...
   */
  template <typename DiscoverInputSchemaRequestT = Model::DiscoverInputSchemaRequest>
  void DiscoverInputSchemaAsync(const DiscoverInputSchemaResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const DiscoverInputSchemaRequestT& request = {}) const {
