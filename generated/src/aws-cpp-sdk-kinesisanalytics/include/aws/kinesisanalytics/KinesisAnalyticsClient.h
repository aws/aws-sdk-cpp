...
namespace KinesisAnalytics
{
   ...
   */
  class AWS_KINESISANALYTICS_API KinesisAnalyticsClient : Aws::Client::ClientWithAsyncTemplateMethods<KinesisAnalyticsClient>,
    smithy::client::AwsSmithyClientT<Aws::KinesisAnalytics::SERVICE_NAME,
