...
#define AWS_KINESISANALYTICS_EXTERN
#else
#define AWS_KINESISANALYTICS_API
#define AWS_KINESISANALYTICS_EXTERN extern
#endif  // USE_IMPORT_EXPORT
#define AWS_KINESISANALYTICS_LOCAL
#else  // defined (USE_WINDOWS_DLL_SEMANTICS) || defined (WIN32)
#define AWS_KINESISANALYTICS_API
#define AWS_KINESISANALYTICS_EXTERN extern
#if __GNUC__ >= 4
#define AWS_KINESISANALYTICS_LOCAL __attribute__((visibility("hidden")))
#else
#define AWS_KINESISANALYTICS_LOCAL
#endif
