...
GetWorkflowDefinitionResult::GetWorkflowDefinitionResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

GetWorkflowDefinitionResult& GetWorkflowDefinitionResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
