...
ListWorkflowDefinitionsResult& ListWorkflowDefinitionsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("workflowDefinitionSummaries")) {
    ...
    for (unsigned workflowDefinitionSummariesIndex = 0; workflowDefinitionSummariesIndex < workflowDefinitionSummariesJsonList.GetLength();
         ++workflowDefinitionSummariesIndex) {
      m_workflowDefinitionSummaries.push_back(workflowDefinitionSummariesJsonList[workflowDefinitionSummariesIndex].AsObject());
    }
