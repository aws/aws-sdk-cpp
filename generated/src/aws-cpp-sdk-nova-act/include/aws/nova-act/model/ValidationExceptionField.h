 ...
 * <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/nova-act-2025-08-22/ValidationExceptionField">AWS
 * API Reference</a></p>
 */
class ValidationExceptionField {
 public:
  AWS_NOVAACT_API ValidationExceptionField() = default;
  AWS_NOVAACT_API ValidationExceptionField(Aws::Utils::Json::JsonView jsonValue);
  AWS_NOVAACT_API ValidationExceptionField& operator=(Aws::Utils::Json::JsonView jsonValue);
