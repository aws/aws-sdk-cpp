...
/**
 */
class GetWorkflowRunRequest : public NovaActRequest {
 public:
  AWS_NOVAACT_API GetWorkflowRunRequest() = default;
  ...
  template <typename WorkflowDefinitionNameT = Aws::String>
  GetWorkflowRunRequest& WithWorkflowDefinitionName(WorkflowDefinitionNameT&& value) {
  ...
  template <typename WorkflowRunIdT = Aws::String>
  GetWorkflowRunRequest& WithWorkflowRunId(WorkflowRunIdT&& value) {
