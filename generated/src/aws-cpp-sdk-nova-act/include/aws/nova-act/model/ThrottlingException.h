...
/**
 * <p>The request was throttled due to too many requests. Please try again
 * later.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/nova-act-2025-08-22/ThrottlingException">AWS
 * API Reference</a></p>
 */
