 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/nova-act-2025-08-22/ResourceNotFoundException">AWS
 * API Reference</a></p>
 */
class ResourceNotFoundException {
 public:
  AWS_NOVAACT_API ResourceNotFoundException() = default;
  AWS_NOVAACT_API ResourceNotFoundException(Aws::Utils::Json::JsonView jsonValue);
  AWS_NOVAACT_API ResourceNotFoundException& operator=(Aws::Utils::Json::JsonView jsonValue);
