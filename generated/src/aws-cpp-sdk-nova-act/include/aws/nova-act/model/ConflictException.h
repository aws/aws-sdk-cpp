 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/nova-act-2025-08-22/ConflictException">AWS
 * API Reference</a></p>
 */
class ConflictException {
 public:
  AWS_NOVAACT_API ConflictException() = default;
  AWS_NOVAACT_API ConflictException(Aws::Utils::Json::JsonView jsonValue);
  AWS_NOVAACT_API ConflictException& operator=(Aws::Utils::Json::JsonView jsonValue);
