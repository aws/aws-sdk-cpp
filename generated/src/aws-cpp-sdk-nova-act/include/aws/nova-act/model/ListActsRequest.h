...
/**
 */
class ListActsRequest : public NovaActRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "ListActs"; }
  ...
  inline ListActsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline ListActsRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
