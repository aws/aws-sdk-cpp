...
class ListTagSyncTasksRequest : public ResourceGroupsRequest {
 public:
  ...
  template <typename FiltersT = Aws::Vector<ListTagSyncTasksFilter>>
  ListTagSyncTasksRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = ListTagSyncTasksFilter>
  ListTagSyncTasksRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline ListTagSyncTasksRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTagSyncTasksRequest& WithNextToken(NextTokenT&& value) {
