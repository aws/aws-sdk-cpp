...
class GroupingStatusesItem {
 public:
  ...
  template <typename ResourceArnT = Aws::String>
  GroupingStatusesItem& WithResourceArn(ResourceArnT&& value) {
  ...
  inline void SetAction(GroupingType value) {
    m_actionHasBeenSet = true;
    m_action = value;
  }
  inline GroupingStatusesItem& WithAction(GroupingType value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(GroupingStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline GroupingStatusesItem& WithStatus(GroupingStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ErrorMessageT = Aws::String>
  GroupingStatusesItem& WithErrorMessage(ErrorMessageT&& value) {
  ...
  template <typename ErrorCodeT = Aws::String>
  GroupingStatusesItem& WithErrorCode(ErrorCodeT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  GroupingStatusesItem& WithUpdatedAt(UpdatedAtT&& value) {
