...
class ListGroupingStatusesRequest : public ResourceGroupsRequest {
 public:
  ...
  template <typename GroupT = Aws::String>
  ListGroupingStatusesRequest& WithGroup(GroupT&& value) {
  ...
  inline ListGroupingStatusesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<ListGroupingStatusesFilter>>
  ListGroupingStatusesRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = ListGroupingStatusesFilter>
  ListGroupingStatusesRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListGroupingStatusesRequest& WithNextToken(NextTokenT&& value) {
