...
class ListGroupsResult {
 public:
  ...
  void SetGroupIdentifiers(GroupIdentifiersT&& value) {
    ...
    m_groupIdentifiers = std::forward<GroupIdentifiersT>(value);
  }
  template <typename GroupIdentifiersT = Aws::Vector<GroupIdentifier>>
  ListGroupsResult& WithGroupIdentifiers(GroupIdentifiersT&& value) {
    SetGroupIdentifiers(std::forward<GroupIdentifiersT>(value));
    return *this;
  }
  template <typename GroupIdentifiersT = GroupIdentifier>
  ListGroupsResult& AddGroupIdentifiers(GroupIdentifiersT&& value) {
    m_groupIdentifiersHasBeenSet = true;
    m_groupIdentifiers.emplace_back(std::forward<GroupIdentifiersT>(value));
    return *this;
  }
  ///@}
