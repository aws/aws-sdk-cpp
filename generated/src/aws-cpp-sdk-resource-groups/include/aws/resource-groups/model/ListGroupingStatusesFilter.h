...
class ListGroupingStatusesFilter {
 public:
  ...
  inline void SetName(ListGroupingStatusesFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline ListGroupingStatusesFilter& WithName(ListGroupingStatusesFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  ListGroupingStatusesFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  ListGroupingStatusesFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
