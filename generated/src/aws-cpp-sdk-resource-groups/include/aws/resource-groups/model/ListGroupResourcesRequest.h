...
class ListGroupResourcesRequest : public ResourceGroupsRequest {
 public:
  ...
  template <typename GroupT = Aws::String>
  ListGroupResourcesRequest& WithGroup(GroupT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<ResourceFilter>>
  ListGroupResourcesRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = ResourceFilter>
  ListGroupResourcesRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline ListGroupResourcesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
