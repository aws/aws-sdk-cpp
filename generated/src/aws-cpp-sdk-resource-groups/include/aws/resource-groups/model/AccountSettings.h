...
class AccountSettings {
 public:
  ...
  inline void SetGroupLifecycleEventsDesiredStatus(GroupLifecycleEventsDesiredStatus value) {
    m_groupLifecycleEventsDesiredStatusHasBeenSet = true;
    m_groupLifecycleEventsDesiredStatus = value;
  }
  inline AccountSettings& WithGroupLifecycleEventsDesiredStatus(GroupLifecycleEventsDesiredStatus value) {
    SetGroupLifecycleEventsDesiredStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetGroupLifecycleEventsStatus(GroupLifecycleEventsStatus value) {
    m_groupLifecycleEventsStatusHasBeenSet = true;
    m_groupLifecycleEventsStatus = value;
  }
  inline AccountSettings& WithGroupLifecycleEventsStatus(GroupLifecycleEventsStatus value) {
    SetGroupLifecycleEventsStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetGroupLifecycleEventsStatusMessage(GroupLifecycleEventsStatusMessageT&& value) {
    ...
    m_groupLifecycleEventsStatusMessage = std::forward<GroupLifecycleEventsStatusMessageT>(value);
  }
  template <typename GroupLifecycleEventsStatusMessageT = Aws::String>
  AccountSettings& WithGroupLifecycleEventsStatusMessage(GroupLifecycleEventsStatusMessageT&& value) {
    SetGroupLifecycleEventsStatusMessage(std::forward<GroupLifecycleEventsStatusMessageT>(value));
    return *this;
  }
  ///@}
 private:
