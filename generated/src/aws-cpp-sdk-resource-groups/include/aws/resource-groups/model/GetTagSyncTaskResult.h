...
class GetTagSyncTaskResult {
 public:
  ...
  template <typename GroupArnT = Aws::String>
  GetTagSyncTaskResult& WithGroupArn(GroupArnT&& value) {
  ...
  template <typename GroupNameT = Aws::String>
  GetTagSyncTaskResult& WithGroupName(GroupNameT&& value) {
  ...
  template <typename TaskArnT = Aws::String>
  GetTagSyncTaskResult& WithTaskArn(TaskArnT&& value) {
  ...
  template <typename TagKeyT = Aws::String>
  GetTagSyncTaskResult& WithTagKey(TagKeyT&& value) {
  ...
  template <typename TagValueT = Aws::String>
  GetTagSyncTaskResult& WithTagValue(TagValueT&& value) {
  ...
  template <typename ResourceQueryT = ResourceQuery>
  GetTagSyncTaskResult& WithResourceQuery(ResourceQueryT&& value) {
  ...
  template <typename RoleArnT = Aws::String>
  GetTagSyncTaskResult& WithRoleArn(RoleArnT&& value) {
  ...
  inline GetTagSyncTaskResult& WithStatus(TagSyncTaskStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ErrorMessageT = Aws::String>
  GetTagSyncTaskResult& WithErrorMessage(ErrorMessageT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  GetTagSyncTaskResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetTagSyncTaskResult& WithRequestId(RequestIdT&& value) {
