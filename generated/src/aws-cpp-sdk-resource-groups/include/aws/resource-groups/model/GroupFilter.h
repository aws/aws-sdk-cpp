...
class GroupFilter {
 public:
  ...
  inline void SetName(GroupFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline GroupFilter& WithName(GroupFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  GroupFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  GroupFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
