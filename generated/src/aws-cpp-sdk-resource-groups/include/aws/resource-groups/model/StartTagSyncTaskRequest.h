...
class StartTagSyncTaskRequest : public ResourceGroupsRequest {
 public:
  ...
  template <typename GroupT = Aws::String>
  StartTagSyncTaskRequest& WithGroup(GroupT&& value) {
  ...
  template <typename TagKeyT = Aws::String>
  StartTagSyncTaskRequest& WithTagKey(TagKeyT&& value) {
  ...
  template <typename TagValueT = Aws::String>
  StartTagSyncTaskRequest& WithTagValue(TagValueT&& value) {
  ...
  template <typename ResourceQueryT = ResourceQuery>
  StartTagSyncTaskRequest& WithResourceQuery(ResourceQueryT&& value) {
  ...
  template <typename RoleArnT = Aws::String>
  StartTagSyncTaskRequest& WithRoleArn(RoleArnT&& value) {
