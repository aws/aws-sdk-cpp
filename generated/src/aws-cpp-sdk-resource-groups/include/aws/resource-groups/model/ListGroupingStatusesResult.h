...
class ListGroupingStatusesResult {
 public:
  ...
  template <typename GroupT = Aws::String>
  ListGroupingStatusesResult& WithGroup(GroupT&& value) {
  ...
  void SetGroupingStatuses(GroupingStatusesT&& value) {
    m_groupingStatusesHasBeenSet = true;
    m_groupingStatuses = std::forward<GroupingStatusesT>(value);
  }
  template <typename GroupingStatusesT = Aws::Vector<GroupingStatusesItem>>
  ListGroupingStatusesResult& WithGroupingStatuses(GroupingStatusesT&& value) {
    SetGroupingStatuses(std::forward<GroupingStatusesT>(value));
    return *this;
  }
  template <typename GroupingStatusesT = GroupingStatusesItem>
  ListGroupingStatusesResult& AddGroupingStatuses(GroupingStatusesT&& value) {
    m_groupingStatusesHasBeenSet = true;
    m_groupingStatuses.emplace_back(std::forward<GroupingStatusesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListGroupingStatusesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListGroupingStatusesResult& WithRequestId(RequestIdT&& value) {
