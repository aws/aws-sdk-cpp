...
class TagSyncTaskItem {
 public:
  ...
  template <typename GroupArnT = Aws::String>
  TagSyncTaskItem& WithGroupArn(GroupArnT&& value) {
  ...
  template <typename GroupNameT = Aws::String>
  TagSyncTaskItem& WithGroupName(GroupNameT&& value) {
  ...
  template <typename TaskArnT = Aws::String>
  TagSyncTaskItem& WithTaskArn(TaskArnT&& value) {
  ...
  template <typename TagKeyT = Aws::String>
  TagSyncTaskItem& WithTagKey(TagKeyT&& value) {
  ...
  void SetTagValue(TagValueT&& value) {
    ...
    m_tagValue = std::forward<TagValueT>(value);
  }
  template <typename TagValueT = Aws::String>
  TagSyncTaskItem& WithTagValue(TagValueT&& value) {
    SetTagValue(std::forward<TagValueT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResourceQueryT = ResourceQuery>
  TagSyncTaskItem& WithResourceQuery(ResourceQueryT&& value) {
  ...
  template <typename RoleArnT = Aws::String>
  TagSyncTaskItem& WithRoleArn(RoleArnT&& value) {
  ...
  inline void SetStatus(TagSyncTaskStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline TagSyncTaskItem& WithStatus(TagSyncTaskStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ErrorMessageT = Aws::String>
  TagSyncTaskItem& WithErrorMessage(ErrorMessageT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  TagSyncTaskItem& WithCreatedAt(CreatedAtT&& value) {
