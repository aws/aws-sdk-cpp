...
GroupConfiguration::GroupConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
GroupConfiguration& GroupConfiguration::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("ProposedConfiguration")) {
    ...
    for (unsigned proposedConfigurationIndex = 0; proposedConfigurationIndex < proposedConfigurationJsonList.GetLength();
         ++proposedConfigurationIndex) {
