...
Mpeg2Settings& Mpeg2Settings::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("timecodeInsertion")) {
    m_timecodeInsertion =
        Mpeg2TimecodeInsertionBehaviorMapper::GetMpeg2TimecodeInsertionBehaviorForName(jsonValue.GetString("timecodeInsertion"));
...
JsonValue Mpeg2Settings::Jsonize() const {
  ...
  if (m_timecodeInsertionHasBeenSet) {
    payload.WithString("timecodeInsertion",
                       Mpeg2TimecodeInsertionBehaviorMapper::GetNameForMpeg2TimecodeInsertionBehavior(m_timecodeInsertion));
  }
