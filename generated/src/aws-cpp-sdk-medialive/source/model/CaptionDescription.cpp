...
CaptionDescription::CaptionDescription(JsonView jsonValue) { *this = jsonValue; }
...
CaptionDescription& CaptionDescription::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("captionDashRoles")) {
    ...
    for (unsigned captionDashRolesIndex = 0; captionDashRolesIndex < captionDashRolesJsonList.GetLength(); ++captionDashRolesIndex) {
      m_captionDashRoles.push_back(
          DashRoleCaptionMapper::GetDashRoleCaptionForName(captionDashRolesJsonList[captionDashRolesIndex].AsString()));
    }
...
JsonValue CaptionDescription::Jsonize() const {
  ...
  if (m_captionDashRolesHasBeenSet) {
    ...
    for (unsigned captionDashRolesIndex = 0; captionDashRolesIndex < captionDashRolesJsonList.GetLength(); ++captionDashRolesIndex) {
      captionDashRolesJsonList[captionDashRolesIndex].AsString(
          DashRoleCaptionMapper::GetNameForDashRoleCaption(m_captionDashRoles[captionDashRolesIndex]));
    }
