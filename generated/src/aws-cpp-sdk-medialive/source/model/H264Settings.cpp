...
H264Settings::H264Settings(JsonView jsonValue) { *this = jsonValue; }

H264Settings& H264Settings::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("adaptiveQuantization")) {
    m_adaptiveQuantization =
        H264AdaptiveQuantizationMapper::GetH264AdaptiveQuantizationForName(jsonValue.GetString("adaptiveQuantization"));
  ...
  if (jsonValue.ValueExists("lookAheadRateControl")) {
    m_lookAheadRateControl =
        H264LookAheadRateControlMapper::GetH264LookAheadRateControlForName(jsonValue.GetString("lookAheadRateControl"));
  ...
  if (jsonValue.ValueExists("timecodeInsertion")) {
    m_timecodeInsertion =
        H264TimecodeInsertionBehaviorMapper::GetH264TimecodeInsertionBehaviorForName(jsonValue.GetString("timecodeInsertion"));
...
JsonValue H264Settings::Jsonize() const {
  ...
  if (m_timecodeInsertionHasBeenSet) {
    payload.WithString("timecodeInsertion",
                       H264TimecodeInsertionBehaviorMapper::GetNameForH264TimecodeInsertionBehavior(m_timecodeInsertion));
  }
