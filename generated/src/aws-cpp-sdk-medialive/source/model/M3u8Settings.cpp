...
M3u8Settings& M3u8Settings::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("timedMetadataBehavior")) {
    m_timedMetadataBehavior =
        M3u8TimedMetadataBehaviorMapper::GetM3u8TimedMetadataBehaviorForName(jsonValue.GetString("timedMetadataBehavior"));
...
JsonValue M3u8Settings::Jsonize() const {
  ...
  if (m_timedMetadataBehaviorHasBeenSet) {
    payload.WithString("timedMetadataBehavior",
                       M3u8TimedMetadataBehaviorMapper::GetNameForM3u8TimedMetadataBehavior(m_timedMetadataBehavior));
  }
