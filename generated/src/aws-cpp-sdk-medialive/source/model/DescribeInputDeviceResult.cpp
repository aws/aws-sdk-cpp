...
DescribeInputDeviceResult::DescribeInputDeviceResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
DescribeInputDeviceResult& DescribeInputDeviceResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("deviceSettingsSyncState")) {
    m_deviceSettingsSyncState =
        DeviceSettingsSyncStateMapper::GetDeviceSettingsSyncStateForName(jsonValue.GetString("deviceSettingsSyncState"));
  ...
  if (jsonValue.ValueExists("medialiveInputArns")) {
    ...
    for (unsigned medialiveInputArnsIndex = 0; medialiveInputArnsIndex < medialiveInputArnsJsonList.GetLength();
         ++medialiveInputArnsIndex) {
