...
AvailConfiguration::AvailConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
AvailConfiguration& AvailConfiguration::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("scte35SegmentationScope")) {
    m_scte35SegmentationScope =
        Scte35SegmentationScopeMapper::GetScte35SegmentationScopeForName(jsonValue.GetString("scte35SegmentationScope"));
...
JsonValue AvailConfiguration::Jsonize() const {
  ...
  if (m_scte35SegmentationScopeHasBeenSet) {
    payload.WithString("scte35SegmentationScope",
                       Scte35SegmentationScopeMapper::GetNameForScte35SegmentationScope(m_scte35SegmentationScope));
  }
