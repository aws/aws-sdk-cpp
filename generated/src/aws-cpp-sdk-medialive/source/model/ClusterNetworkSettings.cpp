...
ClusterNetworkSettings::ClusterNetworkSettings(JsonView jsonValue) { *this = jsonValue; }

ClusterNetworkSettings& ClusterNetworkSettings::operator=(JsonView jsonValue) {
...
JsonValue ClusterNetworkSettings::Jsonize() const {
  JsonValue payload;
