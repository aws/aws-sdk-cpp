...
NielsenNwOnly::NielsenNwOnly(JsonView jsonValue) { *this = jsonValue; }

NielsenNwOnly& NielsenNwOnly::operator=(JsonView jsonValue) {
...
JsonValue NielsenNwOnly::Jsonize() const {
  JsonValue payload;
