...
Smpte2110ReceiverGroupSettings::Smpte2110ReceiverGroupSettings(JsonView jsonValue) { *this = jsonValue; }
...
Smpte2110ReceiverGroupSettings& Smpte2110ReceiverGroupSettings::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("smpte2110ReceiverGroups")) {
    ...
    for (unsigned smpte2110ReceiverGroupsIndex = 0; smpte2110ReceiverGroupsIndex < smpte2110ReceiverGroupsJsonList.GetLength();
         ++smpte2110ReceiverGroupsIndex) {
...
JsonValue Smpte2110ReceiverGroupSettings::Jsonize() const {
  ...
  if (m_smpte2110ReceiverGroupsHasBeenSet) {
    ...
    for (unsigned smpte2110ReceiverGroupsIndex = 0; smpte2110ReceiverGroupsIndex < smpte2110ReceiverGroupsJsonList.GetLength();
         ++smpte2110ReceiverGroupsIndex) {
      smpte2110ReceiverGroupsJsonList[smpte2110ReceiverGroupsIndex].AsObject(
          m_smpte2110ReceiverGroups[smpte2110ReceiverGroupsIndex].Jsonize());
    }
