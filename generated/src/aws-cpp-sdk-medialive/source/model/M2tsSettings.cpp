...
M2tsSettings::M2tsSettings(JsonView jsonValue) { *this = jsonValue; }

M2tsSettings& M2tsSettings::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("absentInputAudioBehavior")) {
    m_absentInputAudioBehavior =
        M2tsAbsentInputAudioBehaviorMapper::GetM2tsAbsentInputAudioBehaviorForName(jsonValue.GetString("absentInputAudioBehavior"));
  ...
  if (jsonValue.ValueExists("aribCaptionsPidControl")) {
    m_aribCaptionsPidControl =
        M2tsAribCaptionsPidControlMapper::GetM2tsAribCaptionsPidControlForName(jsonValue.GetString("aribCaptionsPidControl"));
  ...
  if (jsonValue.ValueExists("timedMetadataBehavior")) {
    m_timedMetadataBehavior =
        M2tsTimedMetadataBehaviorMapper::GetM2tsTimedMetadataBehaviorForName(jsonValue.GetString("timedMetadataBehavior"));
...
JsonValue M2tsSettings::Jsonize() const {
  ...
  if (m_absentInputAudioBehaviorHasBeenSet) {
    payload.WithString("absentInputAudioBehavior",
                       M2tsAbsentInputAudioBehaviorMapper::GetNameForM2tsAbsentInputAudioBehavior(m_absentInputAudioBehavior));
  }
  ...
  if (m_aribCaptionsPidControlHasBeenSet) {
    payload.WithString("aribCaptionsPidControl",
                       M2tsAribCaptionsPidControlMapper::GetNameForM2tsAribCaptionsPidControl(m_aribCaptionsPidControl));
  }
  ...
  if (m_timedMetadataBehaviorHasBeenSet) {
    payload.WithString("timedMetadataBehavior",
                       M2tsTimedMetadataBehaviorMapper::GetNameForM2tsTimedMetadataBehavior(m_timedMetadataBehavior));
  }
