...
AudioDescription& AudioDescription::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("audioTypeControl")) {
    m_audioTypeControl =
        AudioDescriptionAudioTypeControlMapper::GetAudioDescriptionAudioTypeControlForName(jsonValue.GetString("audioTypeControl"));
  ...
  if (jsonValue.ValueExists("languageCodeControl")) {
    m_languageCodeControl = AudioDescriptionLanguageCodeControlMapper::GetAudioDescriptionLanguageCodeControlForName(
        jsonValue.GetString("languageCodeControl"));
...
JsonValue AudioDescription::Jsonize() const {
  ...
  if (m_audioTypeControlHasBeenSet) {
    payload.WithString("audioTypeControl",
                       AudioDescriptionAudioTypeControlMapper::GetNameForAudioDescriptionAudioTypeControl(m_audioTypeControl));
  }
  ...
  if (m_languageCodeControlHasBeenSet) {
    payload.WithString("languageCodeControl",
                       AudioDescriptionLanguageCodeControlMapper::GetNameForAudioDescriptionLanguageCodeControl(m_languageCodeControl));
  }
  ...
  if (m_audioDashRolesHasBeenSet) {
    ...
    for (unsigned audioDashRolesIndex = 0; audioDashRolesIndex < audioDashRolesJsonList.GetLength(); ++audioDashRolesIndex) {
      audioDashRolesJsonList[audioDashRolesIndex].AsString(
          DashRoleAudioMapper::GetNameForDashRoleAudio(m_audioDashRoles[audioDashRolesIndex]));
    }
