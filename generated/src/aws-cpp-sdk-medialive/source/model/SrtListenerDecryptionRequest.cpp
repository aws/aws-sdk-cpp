...
SrtListenerDecryptionRequest::SrtListenerDecryptionRequest(JsonView jsonValue) { *this = jsonValue; }

SrtListenerDecryptionRequest& SrtListenerDecryptionRequest::operator=(JsonView jsonValue) {
...
JsonValue SrtListenerDecryptionRequest::Jsonize() const {
  JsonValue payload;
