...
SrtListenerDecryption::SrtListenerDecryption(JsonView jsonValue) { *this = jsonValue; }

SrtListenerDecryption& SrtListenerDecryption::operator=(JsonView jsonValue) {
...
JsonValue SrtListenerDecryption::Jsonize() const {
  JsonValue payload;
