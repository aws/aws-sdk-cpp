...
ListNetworksSdkResult::ListNetworksSdkResult()
{
}

ListNetworksSdkResult::ListNetworksSdkResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListNetworksSdkResult& ListNetworksSdkResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
