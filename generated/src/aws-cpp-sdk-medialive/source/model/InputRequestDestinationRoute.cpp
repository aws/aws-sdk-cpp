...
InputRequestDestinationRoute::InputRequestDestinationRoute(JsonView jsonValue) { *this = jsonValue; }

InputRequestDestinationRoute& InputRequestDestinationRoute::operator=(JsonView jsonValue) {
...
JsonValue InputRequestDestinationRoute::Jsonize() const {
  JsonValue payload;
