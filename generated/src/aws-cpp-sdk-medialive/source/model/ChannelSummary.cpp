...
ChannelSummary& ChannelSummary::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("usedChannelEngineVersions")) {
    ...
    for (unsigned usedChannelEngineVersionsIndex = 0; usedChannelEngineVersionsIndex < usedChannelEngineVersionsJsonList.GetLength();
         ++usedChannelEngineVersionsIndex) {
...
JsonValue ChannelSummary::Jsonize() const {
  ...
  if (m_usedChannelEngineVersionsHasBeenSet) {
    ...
    for (unsigned usedChannelEngineVersionsIndex = 0; usedChannelEngineVersionsIndex < usedChannelEngineVersionsJsonList.GetLength();
         ++usedChannelEngineVersionsIndex) {
      usedChannelEngineVersionsJsonList[usedChannelEngineVersionsIndex].AsObject(
