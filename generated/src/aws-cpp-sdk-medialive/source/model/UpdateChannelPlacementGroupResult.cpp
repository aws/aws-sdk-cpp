...
UpdateChannelPlacementGroupResult::UpdateChannelPlacementGroupResult() : 
    m_state(ChannelPlacementGroupState::NOT_SET)
{
}

UpdateChannelPlacementGroupResult::UpdateChannelPlacementGroupResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
  : UpdateChannelPlacementGroupResult()
{
  *this = result;
}
