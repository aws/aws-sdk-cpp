...
HlsGroupSettings& HlsGroupSettings::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("hlsId3SegmentTagging")) {
    m_hlsId3SegmentTagging =
        HlsId3SegmentTaggingStateMapper::GetHlsId3SegmentTaggingStateForName(jsonValue.GetString("hlsId3SegmentTagging"));
  ...
  if (jsonValue.ValueExists("incompleteSegmentBehavior")) {
    m_incompleteSegmentBehavior =
        HlsIncompleteSegmentBehaviorMapper::GetHlsIncompleteSegmentBehaviorForName(jsonValue.GetString("incompleteSegmentBehavior"));
...
JsonValue HlsGroupSettings::Jsonize() const {
  ...
  if (m_hlsId3SegmentTaggingHasBeenSet) {
    payload.WithString("hlsId3SegmentTagging",
                       HlsId3SegmentTaggingStateMapper::GetNameForHlsId3SegmentTaggingState(m_hlsId3SegmentTagging));
  }
  ...
  if (m_incompleteSegmentBehaviorHasBeenSet) {
    payload.WithString("incompleteSegmentBehavior",
                       HlsIncompleteSegmentBehaviorMapper::GetNameForHlsIncompleteSegmentBehavior(m_incompleteSegmentBehavior));
  }
