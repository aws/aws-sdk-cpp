...
Aws::String ListCloudWatchAlarmTemplatesRequest::SerializePayload() const { return {}; }

void ListCloudWatchAlarmTemplatesRequest::AddQueryStringParameters(URI& uri) const {
  Aws::StringStream ss;
