...
StartUpdateSignalMapResult::StartUpdateSignalMapResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

StartUpdateSignalMapResult& StartUpdateSignalMapResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
