...
TemporalFilterSettings::TemporalFilterSettings(JsonView jsonValue) { *this = jsonValue; }

TemporalFilterSettings& TemporalFilterSettings::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("postFilterSharpening")) {
    m_postFilterSharpening =
        TemporalFilterPostFilterSharpeningMapper::GetTemporalFilterPostFilterSharpeningForName(jsonValue.GetString("postFilterSharpening"));
...
JsonValue TemporalFilterSettings::Jsonize() const {
  ...
  if (m_postFilterSharpeningHasBeenSet) {
    payload.WithString("postFilterSharpening",
                       TemporalFilterPostFilterSharpeningMapper::GetNameForTemporalFilterPostFilterSharpening(m_postFilterSharpening));
  }
