...
BandwidthReductionFilterSettings::BandwidthReductionFilterSettings(JsonView jsonValue) { *this = jsonValue; }
...
BandwidthReductionFilterSettings& BandwidthReductionFilterSettings::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("postFilterSharpening")) {
    m_postFilterSharpening = BandwidthReductionPostFilterSharpeningMapper::GetBandwidthReductionPostFilterSharpeningForName(
        jsonValue.GetString("postFilterSharpening"));
...
JsonValue BandwidthReductionFilterSettings::Jsonize() const {
  ...
  if (m_postFilterSharpeningHasBeenSet) {
    payload.WithString(
        ...
        BandwidthReductionPostFilterSharpeningMapper::GetNameForBandwidthReductionPostFilterSharpening(m_postFilterSharpening));
  }
