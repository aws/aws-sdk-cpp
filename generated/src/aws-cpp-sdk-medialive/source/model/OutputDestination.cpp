...
OutputDestination::OutputDestination(JsonView jsonValue) { *this = jsonValue; }
...
OutputDestination& OutputDestination::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("mediaPackageSettings")) {
    ...
    for (unsigned mediaPackageSettingsIndex = 0; mediaPackageSettingsIndex < mediaPackageSettingsJsonList.GetLength();
         ++mediaPackageSettingsIndex) {
  ...
  if (jsonValue.ValueExists("logicalInterfaceNames")) {
    ...
    for (unsigned logicalInterfaceNamesIndex = 0; logicalInterfaceNamesIndex < logicalInterfaceNamesJsonList.GetLength();
         ++logicalInterfaceNamesIndex) {
