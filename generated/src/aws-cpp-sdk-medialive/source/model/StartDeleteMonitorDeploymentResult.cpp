...
StartDeleteMonitorDeploymentResult& StartDeleteMonitorDeploymentResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("cloudWatchAlarmTemplateGroupIds")) {
    ...
    for (unsigned cloudWatchAlarmTemplateGroupIdsIndex = 0;
         cloudWatchAlarmTemplateGroupIdsIndex < cloudWatchAlarmTemplateGroupIdsJsonList.GetLength();
  ...
  if (jsonValue.ValueExists("eventBridgeRuleTemplateGroupIds")) {
    ...
    for (unsigned eventBridgeRuleTemplateGroupIdsIndex = 0;
         eventBridgeRuleTemplateGroupIdsIndex < eventBridgeRuleTemplateGroupIdsJsonList.GetLength();
         ++eventBridgeRuleTemplateGroupIdsIndex) {
