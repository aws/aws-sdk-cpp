...
BlackoutSlate::BlackoutSlate(JsonView jsonValue) { *this = jsonValue; }
...
BlackoutSlate& BlackoutSlate::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("networkEndBlackout")) {
    m_networkEndBlackout =
        BlackoutSlateNetworkEndBlackoutMapper::GetBlackoutSlateNetworkEndBlackoutForName(jsonValue.GetString("networkEndBlackout"));
...
JsonValue BlackoutSlate::Jsonize() const {
  ...
  if (m_networkEndBlackoutHasBeenSet) {
    payload.WithString("networkEndBlackout",
                       BlackoutSlateNetworkEndBlackoutMapper::GetNameForBlackoutSlateNetworkEndBlackout(m_networkEndBlackout));
  }
