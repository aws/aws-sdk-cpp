...
Scte35DeliveryRestrictions::Scte35DeliveryRestrictions(JsonView jsonValue) { *this = jsonValue; }
...
Scte35DeliveryRestrictions& Scte35DeliveryRestrictions::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("noRegionalBlackoutFlag")) {
    m_noRegionalBlackoutFlag =
        Scte35NoRegionalBlackoutFlagMapper::GetScte35NoRegionalBlackoutFlagForName(jsonValue.GetString("noRegionalBlackoutFlag"));
    m_noRegionalBlackoutFlagHasBeenSet = true;
  }
  if (jsonValue.ValueExists("webDeliveryAllowedFlag")) {
    m_webDeliveryAllowedFlag =
        Scte35WebDeliveryAllowedFlagMapper::GetScte35WebDeliveryAllowedFlagForName(jsonValue.GetString("webDeliveryAllowedFlag"));
...
JsonValue Scte35DeliveryRestrictions::Jsonize() const {
  ...
  if (m_noRegionalBlackoutFlagHasBeenSet) {
    payload.WithString("noRegionalBlackoutFlag",
                       Scte35NoRegionalBlackoutFlagMapper::GetNameForScte35NoRegionalBlackoutFlag(m_noRegionalBlackoutFlag));
  }

  if (m_webDeliveryAllowedFlagHasBeenSet) {
    payload.WithString("webDeliveryAllowedFlag",
                       Scte35WebDeliveryAllowedFlagMapper::GetNameForScte35WebDeliveryAllowedFlag(m_webDeliveryAllowedFlag));
  }
