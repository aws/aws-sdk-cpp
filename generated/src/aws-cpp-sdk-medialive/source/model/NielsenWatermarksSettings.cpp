...
NielsenWatermarksSettings::NielsenWatermarksSettings(JsonView jsonValue) { *this = jsonValue; }
...
NielsenWatermarksSettings& NielsenWatermarksSettings::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("nielsenDistributionType")) {
    m_nielsenDistributionType = NielsenWatermarksDistributionTypesMapper::GetNielsenWatermarksDistributionTypesForName(
        jsonValue.GetString("nielsenDistributionType"));
...
JsonValue NielsenWatermarksSettings::Jsonize() const {
  ...
  if (m_nielsenDistributionTypeHasBeenSet) {
    payload.WithString("nielsenDistributionType",
                       NielsenWatermarksDistributionTypesMapper::GetNameForNielsenWatermarksDistributionTypes(m_nielsenDistributionType));
  }
