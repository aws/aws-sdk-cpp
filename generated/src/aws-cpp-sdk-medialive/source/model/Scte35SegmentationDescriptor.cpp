...
Scte35SegmentationDescriptor::Scte35SegmentationDescriptor(JsonView jsonValue) { *this = jsonValue; }
...
Scte35SegmentationDescriptor& Scte35SegmentationDescriptor::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("segmentationCancelIndicator")) {
    m_segmentationCancelIndicator = Scte35SegmentationCancelIndicatorMapper::GetScte35SegmentationCancelIndicatorForName(
        jsonValue.GetString("segmentationCancelIndicator"));
...
JsonValue Scte35SegmentationDescriptor::Jsonize() const {
  ...
  if (m_segmentationCancelIndicatorHasBeenSet) {
    payload.WithString("segmentationCancelIndicator",
                       Scte35SegmentationCancelIndicatorMapper::GetNameForScte35SegmentationCancelIndicator(m_segmentationCancelIndicator));
  }
