...
BatchStopResult::BatchStopResult()
{
}

BatchStopResult::BatchStopResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

BatchStopResult& BatchStopResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
