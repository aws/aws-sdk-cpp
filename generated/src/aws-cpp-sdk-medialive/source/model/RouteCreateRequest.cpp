...
RouteCreateRequest::RouteCreateRequest(JsonView jsonValue) { *this = jsonValue; }

RouteCreateRequest& RouteCreateRequest::operator=(JsonView jsonValue) {
...
JsonValue RouteCreateRequest::Jsonize() const {
  JsonValue payload;
