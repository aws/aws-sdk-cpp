...
CloudWatchAlarmTemplateGroupSummary::CloudWatchAlarmTemplateGroupSummary(JsonView jsonValue) { *this = jsonValue; }

CloudWatchAlarmTemplateGroupSummary& CloudWatchAlarmTemplateGroupSummary::operator=(JsonView jsonValue) {
...
JsonValue CloudWatchAlarmTemplateGroupSummary::Jsonize() const {
  JsonValue payload;
