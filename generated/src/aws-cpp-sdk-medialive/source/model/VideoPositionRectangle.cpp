...
VideoPositionRectangle::VideoPositionRectangle(JsonView jsonValue) { *this = jsonValue; }

VideoPositionRectangle& VideoPositionRectangle::operator=(JsonView jsonValue) {
...
JsonValue VideoPositionRectangle::Jsonize() const {
  JsonValue payload;
