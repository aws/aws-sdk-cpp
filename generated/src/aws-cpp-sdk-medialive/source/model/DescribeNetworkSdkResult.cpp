...
DescribeNetworkSdkResult::DescribeNetworkSdkResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
DescribeNetworkSdkResult& DescribeNetworkSdkResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("associatedClusterIds")) {
    ...
    for (unsigned associatedClusterIdsIndex = 0; associatedClusterIdsIndex < associatedClusterIdsJsonList.GetLength();
         ++associatedClusterIdsIndex) {
