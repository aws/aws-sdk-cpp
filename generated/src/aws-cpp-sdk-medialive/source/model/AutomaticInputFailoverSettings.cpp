...
AutomaticInputFailoverSettings::AutomaticInputFailoverSettings(JsonView jsonValue) { *this = jsonValue; }
...
AutomaticInputFailoverSettings& AutomaticInputFailoverSettings::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("failoverConditions")) {
    ...
    for (unsigned failoverConditionsIndex = 0; failoverConditionsIndex < failoverConditionsJsonList.GetLength();
         ++failoverConditionsIndex) {
