...
InputSettings::InputSettings(JsonView jsonValue) { *this = jsonValue; }
...
InputSettings& InputSettings::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("smpte2038DataPreference")) {
    m_smpte2038DataPreference =
        Smpte2038DataPreferenceMapper::GetSmpte2038DataPreferenceForName(jsonValue.GetString("smpte2038DataPreference"));
...
JsonValue InputSettings::Jsonize() const {
  ...
  if (m_smpte2038DataPreferenceHasBeenSet) {
    payload.WithString("smpte2038DataPreference",
                       Smpte2038DataPreferenceMapper::GetNameForSmpte2038DataPreference(m_smpte2038DataPreference));
  }
