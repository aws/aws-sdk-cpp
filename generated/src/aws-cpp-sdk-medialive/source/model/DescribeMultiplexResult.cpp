...
DescribeMultiplexResult::DescribeMultiplexResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

DescribeMultiplexResult& DescribeMultiplexResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
