...
InputDeviceSummary::InputDeviceSummary(JsonView jsonValue) { *this = jsonValue; }
...
JsonValue InputDeviceSummary::Jsonize() const {
  ...
  if (m_deviceSettingsSyncStateHasBeenSet) {
    payload.WithString("deviceSettingsSyncState",
                       DeviceSettingsSyncStateMapper::GetNameForDeviceSettingsSyncState(m_deviceSettingsSyncState));
  }
