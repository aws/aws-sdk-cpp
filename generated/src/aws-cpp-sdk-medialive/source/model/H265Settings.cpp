...
H265Settings::H265Settings(JsonView jsonValue) { *this = jsonValue; }

H265Settings& H265Settings::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("adaptiveQuantization")) {
    m_adaptiveQuantization =
        H265AdaptiveQuantizationMapper::GetH265AdaptiveQuantizationForName(jsonValue.GetString("adaptiveQuantization"));
  ...
  if (jsonValue.ValueExists("alternativeTransferFunction")) {
    m_alternativeTransferFunction = H265AlternativeTransferFunctionMapper::GetH265AlternativeTransferFunctionForName(
        jsonValue.GetString("alternativeTransferFunction"));
  ...
  if (jsonValue.ValueExists("lookAheadRateControl")) {
    m_lookAheadRateControl =
        H265LookAheadRateControlMapper::GetH265LookAheadRateControlForName(jsonValue.GetString("lookAheadRateControl"));
  ...
  if (jsonValue.ValueExists("timecodeInsertion")) {
    m_timecodeInsertion =
        H265TimecodeInsertionBehaviorMapper::GetH265TimecodeInsertionBehaviorForName(jsonValue.GetString("timecodeInsertion"));
...
JsonValue H265Settings::Jsonize() const {
  ...
  if (m_alternativeTransferFunctionHasBeenSet) {
    payload.WithString("alternativeTransferFunction",
                       H265AlternativeTransferFunctionMapper::GetNameForH265AlternativeTransferFunction(m_alternativeTransferFunction));
  }
  ...
  if (m_timecodeInsertionHasBeenSet) {
    payload.WithString("timecodeInsertion",
                       H265TimecodeInsertionBehaviorMapper::GetNameForH265TimecodeInsertionBehavior(m_timecodeInsertion));
  }
