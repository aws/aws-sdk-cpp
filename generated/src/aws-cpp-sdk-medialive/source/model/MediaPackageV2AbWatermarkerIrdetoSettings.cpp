...
MediaPackageV2AbWatermarkerIrdetoSettings::MediaPackageV2AbWatermarkerIrdetoSettings(JsonView jsonValue) { *this = jsonValue; }

MediaPackageV2AbWatermarkerIrdetoSettings& MediaPackageV2AbWatermarkerIrdetoSettings::operator=(JsonView jsonValue) {
...
JsonValue MediaPackageV2AbWatermarkerIrdetoSettings::Jsonize() const {
  JsonValue payload;
