...
RouterInputSettings::RouterInputSettings(JsonView jsonValue) { *this = jsonValue; }

RouterInputSettings& RouterInputSettings::operator=(JsonView jsonValue) {
...
JsonValue RouterInputSettings::Jsonize() const {
  JsonValue payload;
