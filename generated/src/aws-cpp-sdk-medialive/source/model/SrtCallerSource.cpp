...
SrtCallerSource::SrtCallerSource(JsonView jsonValue) { *this = jsonValue; }

SrtCallerSource& SrtCallerSource::operator=(JsonView jsonValue) {
...
JsonValue SrtCallerSource::Jsonize() const {
  JsonValue payload;
