...
MsSmoothGroupSettings& MsSmoothGroupSettings::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("audioOnlyTimecodeControl")) {
    m_audioOnlyTimecodeControl = SmoothGroupAudioOnlyTimecodeControlMapper::GetSmoothGroupAudioOnlyTimecodeControlForName(
        jsonValue.GetString("audioOnlyTimecodeControl"));
  ...
  if (jsonValue.ValueExists("eventStopBehavior")) {
    m_eventStopBehavior =
        SmoothGroupEventStopBehaviorMapper::GetSmoothGroupEventStopBehaviorForName(jsonValue.GetString("eventStopBehavior"));
  ...
  if (jsonValue.ValueExists("inputLossAction")) {
    m_inputLossAction =
        InputLossActionForMsSmoothOutMapper::GetInputLossActionForMsSmoothOutForName(jsonValue.GetString("inputLossAction"));
  ...
  if (jsonValue.ValueExists("streamManifestBehavior")) {
    m_streamManifestBehavior =
        SmoothGroupStreamManifestBehaviorMapper::GetSmoothGroupStreamManifestBehaviorForName(jsonValue.GetString("streamManifestBehavior"));
  ...
  if (jsonValue.ValueExists("timestampOffsetMode")) {
    m_timestampOffsetMode =
        SmoothGroupTimestampOffsetModeMapper::GetSmoothGroupTimestampOffsetModeForName(jsonValue.GetString("timestampOffsetMode"));
...
JsonValue MsSmoothGroupSettings::Jsonize() const {
  ...
  if (m_audioOnlyTimecodeControlHasBeenSet) {
    payload.WithString("audioOnlyTimecodeControl", SmoothGroupAudioOnlyTimecodeControlMapper::GetNameForSmoothGroupAudioOnlyTimecodeControl(
                                                       m_audioOnlyTimecodeControl));
  }
  ...
  if (m_eventStopBehaviorHasBeenSet) {
    payload.WithString("eventStopBehavior",
                       SmoothGroupEventStopBehaviorMapper::GetNameForSmoothGroupEventStopBehavior(m_eventStopBehavior));
  }
  ...
  if (m_streamManifestBehaviorHasBeenSet) {
    payload.WithString("streamManifestBehavior",
                       SmoothGroupStreamManifestBehaviorMapper::GetNameForSmoothGroupStreamManifestBehavior(m_streamManifestBehavior));
  }
  ...
  if (m_timestampOffsetModeHasBeenSet) {
    payload.WithString("timestampOffsetMode",
                       SmoothGroupTimestampOffsetModeMapper::GetNameForSmoothGroupTimestampOffsetMode(m_timestampOffsetMode));
  }
