...
ListInputDeviceTransfersResult::ListInputDeviceTransfersResult()
{
}

ListInputDeviceTransfersResult::ListInputDeviceTransfersResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
