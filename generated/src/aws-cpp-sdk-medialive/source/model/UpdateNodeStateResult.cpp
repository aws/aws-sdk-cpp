...
UpdateNodeStateResult::UpdateNodeStateResult() : 
...
UpdateNodeStateResult::UpdateNodeStateResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
  : UpdateNodeStateResult()
{
  *this = result;
}

UpdateNodeStateResult& UpdateNodeStateResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
