...
MotionGraphicsConfiguration::MotionGraphicsConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
MotionGraphicsConfiguration& MotionGraphicsConfiguration::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("motionGraphicsInsertion")) {
    m_motionGraphicsInsertion =
        MotionGraphicsInsertionMapper::GetMotionGraphicsInsertionForName(jsonValue.GetString("motionGraphicsInsertion"));
...
JsonValue MotionGraphicsConfiguration::Jsonize() const {
  ...
  if (m_motionGraphicsInsertionHasBeenSet) {
    payload.WithString("motionGraphicsInsertion",
                       MotionGraphicsInsertionMapper::GetNameForMotionGraphicsInsertion(m_motionGraphicsInsertion));
  }
