...
DvbSubDestinationSettings::DvbSubDestinationSettings(JsonView jsonValue) { *this = jsonValue; }
...
DvbSubDestinationSettings& DvbSubDestinationSettings::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("backgroundColor")) {
    m_backgroundColor =
        DvbSubDestinationBackgroundColorMapper::GetDvbSubDestinationBackgroundColorForName(jsonValue.GetString("backgroundColor"));
  ...
  if (jsonValue.ValueExists("teletextGridControl")) {
    m_teletextGridControl = DvbSubDestinationTeletextGridControlMapper::GetDvbSubDestinationTeletextGridControlForName(
        jsonValue.GetString("teletextGridControl"));
...
JsonValue DvbSubDestinationSettings::Jsonize() const {
  ...
  if (m_backgroundColorHasBeenSet) {
    payload.WithString("backgroundColor",
                       DvbSubDestinationBackgroundColorMapper::GetNameForDvbSubDestinationBackgroundColor(m_backgroundColor));
  }
  ...
  if (m_teletextGridControlHasBeenSet) {
    payload.WithString("teletextGridControl",
                       DvbSubDestinationTeletextGridControlMapper::GetNameForDvbSubDestinationTeletextGridControl(m_teletextGridControl));
  }
