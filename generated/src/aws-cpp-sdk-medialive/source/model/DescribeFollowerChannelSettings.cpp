...
DescribeFollowerChannelSettings::DescribeFollowerChannelSettings(JsonView jsonValue) { *this = jsonValue; }

DescribeFollowerChannelSettings& DescribeFollowerChannelSettings::operator=(JsonView jsonValue) {
...
JsonValue DescribeFollowerChannelSettings::Jsonize() const {
  JsonValue payload;
