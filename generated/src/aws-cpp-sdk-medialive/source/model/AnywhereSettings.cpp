...
AnywhereSettings::AnywhereSettings(JsonView jsonValue) { *this = jsonValue; }

AnywhereSettings& AnywhereSettings::operator=(JsonView jsonValue) {
...
JsonValue AnywhereSettings::Jsonize() const {
  JsonValue payload;
