...
StartMonitorDeploymentResult::StartMonitorDeploymentResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

StartMonitorDeploymentResult& StartMonitorDeploymentResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
