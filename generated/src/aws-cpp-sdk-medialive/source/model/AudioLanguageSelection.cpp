...
AudioLanguageSelection::AudioLanguageSelection(JsonView jsonValue) { *this = jsonValue; }
...
AudioLanguageSelection& AudioLanguageSelection::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("languageSelectionPolicy")) {
    m_languageSelectionPolicy =
        AudioLanguageSelectionPolicyMapper::GetAudioLanguageSelectionPolicyForName(jsonValue.GetString("languageSelectionPolicy"));
...
JsonValue AudioLanguageSelection::Jsonize() const {
  ...
  if (m_languageSelectionPolicyHasBeenSet) {
    payload.WithString("languageSelectionPolicy",
                       AudioLanguageSelectionPolicyMapper::GetNameForAudioLanguageSelectionPolicy(m_languageSelectionPolicy));
  }
