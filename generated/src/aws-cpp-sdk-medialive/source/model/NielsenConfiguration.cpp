...
NielsenConfiguration& NielsenConfiguration::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("nielsenPcmToId3Tagging")) {
    m_nielsenPcmToId3Tagging =
        NielsenPcmToId3TaggingStateMapper::GetNielsenPcmToId3TaggingStateForName(jsonValue.GetString("nielsenPcmToId3Tagging"));
...
JsonValue NielsenConfiguration::Jsonize() const {
  ...
  if (m_nielsenPcmToId3TaggingHasBeenSet) {
    payload.WithString("nielsenPcmToId3Tagging",
                       NielsenPcmToId3TaggingStateMapper::GetNameForNielsenPcmToId3TaggingState(m_nielsenPcmToId3Tagging));
  }
