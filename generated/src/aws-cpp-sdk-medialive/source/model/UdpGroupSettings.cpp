...
UdpGroupSettings::UdpGroupSettings(JsonView jsonValue) { *this = jsonValue; }
...
UdpGroupSettings& UdpGroupSettings::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("timedMetadataId3Frame")) {
    m_timedMetadataId3Frame =
        UdpTimedMetadataId3FrameMapper::GetUdpTimedMetadataId3FrameForName(jsonValue.GetString("timedMetadataId3Frame"));
...
JsonValue UdpGroupSettings::Jsonize() const {
  ...
  if (m_timedMetadataId3FrameHasBeenSet) {
    payload.WithString("timedMetadataId3Frame",
                       UdpTimedMetadataId3FrameMapper::GetNameForUdpTimedMetadataId3Frame(m_timedMetadataId3Frame));
  }
