...
SdiSourceSummary::SdiSourceSummary(JsonView jsonValue) { *this = jsonValue; }

SdiSourceSummary& SdiSourceSummary::operator=(JsonView jsonValue) {
...
JsonValue SdiSourceSummary::Jsonize() const {
  JsonValue payload;
