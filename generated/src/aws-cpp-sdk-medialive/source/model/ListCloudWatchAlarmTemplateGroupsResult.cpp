...
ListCloudWatchAlarmTemplateGroupsResult& ListCloudWatchAlarmTemplateGroupsResult::operator=(
  ...
  if (jsonValue.ValueExists("cloudWatchAlarmTemplateGroups")) {
    ...
    for (unsigned cloudWatchAlarmTemplateGroupsIndex = 0;
         cloudWatchAlarmTemplateGroupsIndex < cloudWatchAlarmTemplateGroupsJsonList.GetLength(); ++cloudWatchAlarmTemplateGroupsIndex) {
