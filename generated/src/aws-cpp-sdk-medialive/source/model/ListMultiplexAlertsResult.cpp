...
ListMultiplexAlertsResult::ListMultiplexAlertsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

ListMultiplexAlertsResult& ListMultiplexAlertsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
