...
class AWS_MEDIALIVE_API MediaLiveClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  MediaLiveClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<MediaLiveEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * A Callable wrapper for AcceptInputDeviceTransfer that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename AcceptInputDeviceTransferRequestT = Model::AcceptInputDeviceTransferRequest>
  Model::AcceptInputDeviceTransferOutcomeCallable AcceptInputDeviceTransferCallable(
      const AcceptInputDeviceTransferRequestT& request) const {
    return SubmitCallable(&MediaLiveClient::AcceptInputDeviceTransfer, request);
  }

  /**
   * An Async wrapper for AcceptInputDeviceTransfer that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AcceptInputDeviceTransferRequestT = Model::AcceptInputDeviceTransferRequest>
  void AcceptInputDeviceTransferAsync(const AcceptInputDeviceTransferRequestT& request,
  ...
  /**
   * An Async wrapper for BatchDelete that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename BatchDeleteRequestT = Model::BatchDeleteRequest>
  void BatchDeleteAsync(const BatchDeleteResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                        const BatchDeleteRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for BatchStart that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename BatchStartRequestT = Model::BatchStartRequest>
  void BatchStartAsync(const BatchStartResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                       const BatchStartRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for BatchStop that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename BatchStopRequestT = Model::BatchStopRequest>
  void BatchStopAsync(const BatchStopResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                      const BatchStopRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for BatchUpdateSchedule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchUpdateSchedule that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename BatchUpdateScheduleRequestT = Model::BatchUpdateScheduleRequest>
  void BatchUpdateScheduleAsync(const BatchUpdateScheduleRequestT& request, const BatchUpdateScheduleResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CancelInputDeviceTransfer that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CancelInputDeviceTransferRequestT = Model::CancelInputDeviceTransferRequest>
  Model::CancelInputDeviceTransferOutcomeCallable CancelInputDeviceTransferCallable(
      const CancelInputDeviceTransferRequestT& request) const {
    return SubmitCallable(&MediaLiveClient::CancelInputDeviceTransfer, request);
  }

  /**
   * An Async wrapper for CancelInputDeviceTransfer that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CancelInputDeviceTransferRequestT = Model::CancelInputDeviceTransferRequest>
  void CancelInputDeviceTransferAsync(const CancelInputDeviceTransferRequestT& request,
  ...
  /**
   * An Async wrapper for ClaimDevice that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ClaimDeviceRequestT = Model::ClaimDeviceRequest>
  void ClaimDeviceAsync(const ClaimDeviceResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                        const ClaimDeviceRequestT& request = {}) const {
   ...
   */
  template <typename CreateChannelRequestT = Model::CreateChannelRequest>
  void CreateChannelAsync(const CreateChannelResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                          const CreateChannelRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateChannelPlacementGroupOutcome CreateChannelPlacementGroup(
      const Model::CreateChannelPlacementGroupRequest& request) const;

  /**
   * A Callable wrapper for CreateChannelPlacementGroup that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateChannelPlacementGroupRequestT = Model::CreateChannelPlacementGroupRequest>
  Model::CreateChannelPlacementGroupOutcomeCallable CreateChannelPlacementGroupCallable(
      const CreateChannelPlacementGroupRequestT& request) const {
    return SubmitCallable(&MediaLiveClient::CreateChannelPlacementGroup, request);
  }

  /**
   * An Async wrapper for CreateChannelPlacementGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateChannelPlacementGroupRequestT = Model::CreateChannelPlacementGroupRequest>
  void CreateChannelPlacementGroupAsync(const CreateChannelPlacementGroupRequestT& request,
                                        const CreateChannelPlacementGroupResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateCloudWatchAlarmTemplateOutcome CreateCloudWatchAlarmTemplate(
      const Model::CreateCloudWatchAlarmTemplateRequest& request) const;

  /**
   * A Callable wrapper for CreateCloudWatchAlarmTemplate that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateCloudWatchAlarmTemplateRequestT = Model::CreateCloudWatchAlarmTemplateRequest>
  Model::CreateCloudWatchAlarmTemplateOutcomeCallable CreateCloudWatchAlarmTemplateCallable(
      const CreateCloudWatchAlarmTemplateRequestT& request) const {
    return SubmitCallable(&MediaLiveClient::CreateCloudWatchAlarmTemplate, request);
  }

  /**
   * An Async wrapper for CreateCloudWatchAlarmTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateCloudWatchAlarmTemplateRequestT = Model::CreateCloudWatchAlarmTemplateRequest>
  void CreateCloudWatchAlarmTemplateAsync(const CreateCloudWatchAlarmTemplateRequestT& request,
                                          const CreateCloudWatchAlarmTemplateResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateCloudWatchAlarmTemplateGroupOutcome CreateCloudWatchAlarmTemplateGroup(
      const Model::CreateCloudWatchAlarmTemplateGroupRequest& request) const;

  /**
   * A Callable wrapper for CreateCloudWatchAlarmTemplateGroup that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename CreateCloudWatchAlarmTemplateGroupRequestT = Model::CreateCloudWatchAlarmTemplateGroupRequest>
  Model::CreateCloudWatchAlarmTemplateGroupOutcomeCallable CreateCloudWatchAlarmTemplateGroupCallable(
      const CreateCloudWatchAlarmTemplateGroupRequestT& request) const {
    return SubmitCallable(&MediaLiveClient::CreateCloudWatchAlarmTemplateGroup, request);
  }

  /**
   * An Async wrapper for CreateCloudWatchAlarmTemplateGroup that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateCloudWatchAlarmTemplateGroupRequestT = Model::CreateCloudWatchAlarmTemplateGroupRequest>
  void CreateCloudWatchAlarmTemplateGroupAsync(const CreateCloudWatchAlarmTemplateGroupRequestT& request,
                                               const CreateCloudWatchAlarmTemplateGroupResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateEventBridgeRuleTemplateOutcome CreateEventBridgeRuleTemplate(
      const Model::CreateEventBridgeRuleTemplateRequest& request) const;

  /**
   * A Callable wrapper for CreateEventBridgeRuleTemplate that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateEventBridgeRuleTemplateRequestT = Model::CreateEventBridgeRuleTemplateRequest>
  Model::CreateEventBridgeRuleTemplateOutcomeCallable CreateEventBridgeRuleTemplateCallable(
      const CreateEventBridgeRuleTemplateRequestT& request) const {
    return SubmitCallable(&MediaLiveClient::CreateEventBridgeRuleTemplate, request);
  }

  /**
   * An Async wrapper for CreateEventBridgeRuleTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateEventBridgeRuleTemplateRequestT = Model::CreateEventBridgeRuleTemplateRequest>
  void CreateEventBridgeRuleTemplateAsync(const CreateEventBridgeRuleTemplateRequestT& request,
                                          const CreateEventBridgeRuleTemplateResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateEventBridgeRuleTemplateGroupOutcome CreateEventBridgeRuleTemplateGroup(
      const Model::CreateEventBridgeRuleTemplateGroupRequest& request) const;

  /**
   * A Callable wrapper for CreateEventBridgeRuleTemplateGroup that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename CreateEventBridgeRuleTemplateGroupRequestT = Model::CreateEventBridgeRuleTemplateGroupRequest>
  Model::CreateEventBridgeRuleTemplateGroupOutcomeCallable CreateEventBridgeRuleTemplateGroupCallable(
      const CreateEventBridgeRuleTemplateGroupRequestT& request) const {
    return SubmitCallable(&MediaLiveClient::CreateEventBridgeRuleTemplateGroup, request);
  }

  /**
   * An Async wrapper for CreateEventBridgeRuleTemplateGroup that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateEventBridgeRuleTemplateGroupRequestT = Model::CreateEventBridgeRuleTemplateGroupRequest>
  void CreateEventBridgeRuleTemplateGroupAsync(const CreateEventBridgeRuleTemplateGroupRequestT& request,
                                               const CreateEventBridgeRuleTemplateGroupResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateInput that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateInputRequestT = Model::CreateInputRequest>
  void CreateInputAsync(const CreateInputResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                        const CreateInputRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for CreateInputSecurityGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CreateInputSecurityGroupRequestT = Model::CreateInputSecurityGroupRequest>
  Model::CreateInputSecurityGroupOutcomeCallable CreateInputSecurityGroupCallable(
      const CreateInputSecurityGroupRequestT& request = {}) const {
    return SubmitCallable(&MediaLiveClient::CreateInputSecurityGroup, request);
  }

  /**
   * An Async wrapper for CreateInputSecurityGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateInputSecurityGroupRequestT = Model::CreateInputSecurityGroupRequest>
  void CreateInputSecurityGroupAsync(const CreateInputSecurityGroupResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const CreateInputSecurityGroupRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for CreateMultiplex that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateMultiplexRequestT = Model::CreateMultiplexRequest>
  void CreateMultiplexAsync(const CreateMultiplexRequestT& request, const CreateMultiplexResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateMultiplexProgram that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateMultiplexProgram that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateMultiplexProgramRequestT = Model::CreateMultiplexProgramRequest>
  void CreateMultiplexProgramAsync(const CreateMultiplexProgramRequestT& request,
   ...
   */
  template <typename CreateNetworkRequestT = Model::CreateNetworkRequest>
  void CreateNetworkAsync(const CreateNetworkResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                          const CreateNetworkRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for CreateNode that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateNodeRequestT = Model::CreateNodeRequest>
  void CreateNodeAsync(const CreateNodeRequestT& request, const CreateNodeResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateNodeRegistrationScriptOutcome CreateNodeRegistrationScript(
      const Model::CreateNodeRegistrationScriptRequest& request) const;

  /**
   * A Callable wrapper for CreateNodeRegistrationScript that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateNodeRegistrationScriptRequestT = Model::CreateNodeRegistrationScriptRequest>
  Model::CreateNodeRegistrationScriptOutcomeCallable CreateNodeRegistrationScriptCallable(
      const CreateNodeRegistrationScriptRequestT& request) const {
    return SubmitCallable(&MediaLiveClient::CreateNodeRegistrationScript, request);
  }

  /**
   * An Async wrapper for CreateNodeRegistrationScript that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateNodeRegistrationScriptRequestT = Model::CreateNodeRegistrationScriptRequest>
  void CreateNodeRegistrationScriptAsync(const CreateNodeRegistrationScriptRequestT& request,
                                         const CreateNodeRegistrationScriptResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreatePartnerInput that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreatePartnerInput that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreatePartnerInputRequestT = Model::CreatePartnerInputRequest>
  void CreatePartnerInputAsync(const CreatePartnerInputRequestT& request, const CreatePartnerInputResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateSdiSource that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateSdiSourceRequestT = Model::CreateSdiSourceRequest>
  void CreateSdiSourceAsync(const CreateSdiSourceResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const CreateSdiSourceRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for CreateSignalMap that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateSignalMapRequestT = Model::CreateSignalMapRequest>
  void CreateSignalMapAsync(const CreateSignalMapRequestT& request, const CreateSignalMapResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateTags that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateTagsRequestT = Model::CreateTagsRequest>
  void CreateTagsAsync(const CreateTagsRequestT& request, const CreateTagsResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteChannelPlacementGroupOutcome DeleteChannelPlacementGroup(
      const Model::DeleteChannelPlacementGroupRequest& request) const;

  /**
   * A Callable wrapper for DeleteChannelPlacementGroup that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteChannelPlacementGroupRequestT = Model::DeleteChannelPlacementGroupRequest>
  Model::DeleteChannelPlacementGroupOutcomeCallable DeleteChannelPlacementGroupCallable(
      const DeleteChannelPlacementGroupRequestT& request) const {
    return SubmitCallable(&MediaLiveClient::DeleteChannelPlacementGroup, request);
  }

  /**
   * An Async wrapper for DeleteChannelPlacementGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteChannelPlacementGroupRequestT = Model::DeleteChannelPlacementGroupRequest>
  void DeleteChannelPlacementGroupAsync(const DeleteChannelPlacementGroupRequestT& request,
                                        const DeleteChannelPlacementGroupResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteCloudWatchAlarmTemplateOutcome DeleteCloudWatchAlarmTemplate(
      const Model::DeleteCloudWatchAlarmTemplateRequest& request) const;

  /**
   * A Callable wrapper for DeleteCloudWatchAlarmTemplate that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteCloudWatchAlarmTemplateRequestT = Model::DeleteCloudWatchAlarmTemplateRequest>
  Model::DeleteCloudWatchAlarmTemplateOutcomeCallable DeleteCloudWatchAlarmTemplateCallable(
      const DeleteCloudWatchAlarmTemplateRequestT& request) const {
    return SubmitCallable(&MediaLiveClient::DeleteCloudWatchAlarmTemplate, request);
  }

  /**
   * An Async wrapper for DeleteCloudWatchAlarmTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteCloudWatchAlarmTemplateRequestT = Model::DeleteCloudWatchAlarmTemplateRequest>
  void DeleteCloudWatchAlarmTemplateAsync(const DeleteCloudWatchAlarmTemplateRequestT& request,
                                          const DeleteCloudWatchAlarmTemplateResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteCloudWatchAlarmTemplateGroupOutcome DeleteCloudWatchAlarmTemplateGroup(
      const Model::DeleteCloudWatchAlarmTemplateGroupRequest& request) const;

  /**
   * A Callable wrapper for DeleteCloudWatchAlarmTemplateGroup that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DeleteCloudWatchAlarmTemplateGroupRequestT = Model::DeleteCloudWatchAlarmTemplateGroupRequest>
  Model::DeleteCloudWatchAlarmTemplateGroupOutcomeCallable DeleteCloudWatchAlarmTemplateGroupCallable(
      const DeleteCloudWatchAlarmTemplateGroupRequestT& request) const {
    return SubmitCallable(&MediaLiveClient::DeleteCloudWatchAlarmTemplateGroup, request);
  }

  /**
   * An Async wrapper for DeleteCloudWatchAlarmTemplateGroup that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteCloudWatchAlarmTemplateGroupRequestT = Model::DeleteCloudWatchAlarmTemplateGroupRequest>
  void DeleteCloudWatchAlarmTemplateGroupAsync(const DeleteCloudWatchAlarmTemplateGroupRequestT& request,
                                               const DeleteCloudWatchAlarmTemplateGroupResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteEventBridgeRuleTemplateOutcome DeleteEventBridgeRuleTemplate(
      const Model::DeleteEventBridgeRuleTemplateRequest& request) const;

  /**
   * A Callable wrapper for DeleteEventBridgeRuleTemplate that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteEventBridgeRuleTemplateRequestT = Model::DeleteEventBridgeRuleTemplateRequest>
  Model::DeleteEventBridgeRuleTemplateOutcomeCallable DeleteEventBridgeRuleTemplateCallable(
      const DeleteEventBridgeRuleTemplateRequestT& request) const {
    return SubmitCallable(&MediaLiveClient::DeleteEventBridgeRuleTemplate, request);
  }

  /**
   * An Async wrapper for DeleteEventBridgeRuleTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteEventBridgeRuleTemplateRequestT = Model::DeleteEventBridgeRuleTemplateRequest>
  void DeleteEventBridgeRuleTemplateAsync(const DeleteEventBridgeRuleTemplateRequestT& request,
                                          const DeleteEventBridgeRuleTemplateResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteEventBridgeRuleTemplateGroupOutcome DeleteEventBridgeRuleTemplateGroup(
      const Model::DeleteEventBridgeRuleTemplateGroupRequest& request) const;

  /**
   * A Callable wrapper for DeleteEventBridgeRuleTemplateGroup that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DeleteEventBridgeRuleTemplateGroupRequestT = Model::DeleteEventBridgeRuleTemplateGroupRequest>
  Model::DeleteEventBridgeRuleTemplateGroupOutcomeCallable DeleteEventBridgeRuleTemplateGroupCallable(
      const DeleteEventBridgeRuleTemplateGroupRequestT& request) const {
    return SubmitCallable(&MediaLiveClient::DeleteEventBridgeRuleTemplateGroup, request);
  }

  /**
   * An Async wrapper for DeleteEventBridgeRuleTemplateGroup that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteEventBridgeRuleTemplateGroupRequestT = Model::DeleteEventBridgeRuleTemplateGroupRequest>
  void DeleteEventBridgeRuleTemplateGroupAsync(const DeleteEventBridgeRuleTemplateGroupRequestT& request,
                                               const DeleteEventBridgeRuleTemplateGroupResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteInput that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteInputRequestT = Model::DeleteInputRequest>
  void DeleteInputAsync(const DeleteInputRequestT& request, const DeleteInputResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteInputSecurityGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteInputSecurityGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteInputSecurityGroupRequestT = Model::DeleteInputSecurityGroupRequest>
  void DeleteInputSecurityGroupAsync(const DeleteInputSecurityGroupRequestT& request,
  ...
  /**
   * An Async wrapper for DeleteMultiplex that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteMultiplexRequestT = Model::DeleteMultiplexRequest>
  void DeleteMultiplexAsync(const DeleteMultiplexRequestT& request, const DeleteMultiplexResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteMultiplexProgram that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteMultiplexProgram that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteMultiplexProgramRequestT = Model::DeleteMultiplexProgramRequest>
  void DeleteMultiplexProgramAsync(const DeleteMultiplexProgramRequestT& request,
  ...
  /**
   * An Async wrapper for DeleteNode that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteNodeRequestT = Model::DeleteNodeRequest>
  void DeleteNodeAsync(const DeleteNodeRequestT& request, const DeleteNodeResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteReservation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteReservation that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteReservationRequestT = Model::DeleteReservationRequest>
  void DeleteReservationAsync(const DeleteReservationRequestT& request, const DeleteReservationResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteSdiSource that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteSdiSourceRequestT = Model::DeleteSdiSourceRequest>
  void DeleteSdiSourceAsync(const DeleteSdiSourceRequestT& request, const DeleteSdiSourceResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteSignalMap that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteSignalMapRequestT = Model::DeleteSignalMapRequest>
  void DeleteSignalMapAsync(const DeleteSignalMapRequestT& request, const DeleteSignalMapResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeAccountConfigurationOutcome DescribeAccountConfiguration(
      const Model::DescribeAccountConfigurationRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeAccountConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeAccountConfigurationRequestT = Model::DescribeAccountConfigurationRequest>
  Model::DescribeAccountConfigurationOutcomeCallable DescribeAccountConfigurationCallable(
      const DescribeAccountConfigurationRequestT& request = {}) const {
    return SubmitCallable(&MediaLiveClient::DescribeAccountConfiguration, request);
  }

  /**
   * An Async wrapper for DescribeAccountConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeAccountConfigurationRequestT = Model::DescribeAccountConfigurationRequest>
  void DescribeAccountConfigurationAsync(const DescribeAccountConfigurationResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                         const DescribeAccountConfigurationRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeChannelPlacementGroupOutcome DescribeChannelPlacementGroup(
      const Model::DescribeChannelPlacementGroupRequest& request) const;

  /**
   * A Callable wrapper for DescribeChannelPlacementGroup that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeChannelPlacementGroupRequestT = Model::DescribeChannelPlacementGroupRequest>
  Model::DescribeChannelPlacementGroupOutcomeCallable DescribeChannelPlacementGroupCallable(
      const DescribeChannelPlacementGroupRequestT& request) const {
    return SubmitCallable(&MediaLiveClient::DescribeChannelPlacementGroup, request);
  }

  /**
   * An Async wrapper for DescribeChannelPlacementGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeChannelPlacementGroupRequestT = Model::DescribeChannelPlacementGroupRequest>
  void DescribeChannelPlacementGroupAsync(const DescribeChannelPlacementGroupRequestT& request,
                                          const DescribeChannelPlacementGroupResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeInput that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeInputRequestT = Model::DescribeInputRequest>
  void DescribeInputAsync(const DescribeInputRequestT& request, const DescribeInputResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeInputDevice that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeInputDevice that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeInputDeviceRequestT = Model::DescribeInputDeviceRequest>
  void DescribeInputDeviceAsync(const DescribeInputDeviceRequestT& request, const DescribeInputDeviceResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeInputDeviceThumbnailOutcome DescribeInputDeviceThumbnail(
      const Model::DescribeInputDeviceThumbnailRequest& request) const;

  /**
   * A Callable wrapper for DescribeInputDeviceThumbnail that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeInputDeviceThumbnailRequestT = Model::DescribeInputDeviceThumbnailRequest>
  Model::DescribeInputDeviceThumbnailOutcomeCallable DescribeInputDeviceThumbnailCallable(
      const DescribeInputDeviceThumbnailRequestT& request) const {
    return SubmitCallable(&MediaLiveClient::DescribeInputDeviceThumbnail, request);
  }

  /**
   * An Async wrapper for DescribeInputDeviceThumbnail that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeInputDeviceThumbnailRequestT = Model::DescribeInputDeviceThumbnailRequest>
  void DescribeInputDeviceThumbnailAsync(const DescribeInputDeviceThumbnailRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeInputSecurityGroupOutcome DescribeInputSecurityGroup(
      const Model::DescribeInputSecurityGroupRequest& request) const;

  /**
   * A Callable wrapper for DescribeInputSecurityGroup that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeInputSecurityGroupRequestT = Model::DescribeInputSecurityGroupRequest>
  Model::DescribeInputSecurityGroupOutcomeCallable DescribeInputSecurityGroupCallable(
      const DescribeInputSecurityGroupRequestT& request) const {
    return SubmitCallable(&MediaLiveClient::DescribeInputSecurityGroup, request);
  }

  /**
   * An Async wrapper for DescribeInputSecurityGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeInputSecurityGroupRequestT = Model::DescribeInputSecurityGroupRequest>
  void DescribeInputSecurityGroupAsync(const DescribeInputSecurityGroupRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeMultiplex that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeMultiplex that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeMultiplexRequestT = Model::DescribeMultiplexRequest>
  void DescribeMultiplexAsync(const DescribeMultiplexRequestT& request, const DescribeMultiplexResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeMultiplexProgram that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeMultiplexProgram that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeMultiplexProgramRequestT = Model::DescribeMultiplexProgramRequest>
  void DescribeMultiplexProgramAsync(const DescribeMultiplexProgramRequestT& request,
  ...
  /**
   * An Async wrapper for DescribeNetwork that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeNetworkRequestT = Model::DescribeNetworkRequest>
  void DescribeNetworkAsync(const DescribeNetworkRequestT& request, const DescribeNetworkResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeNode that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeNodeRequestT = Model::DescribeNodeRequest>
  void DescribeNodeAsync(const DescribeNodeRequestT& request, const DescribeNodeResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeSdiSource that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeSdiSource that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeSdiSourceRequestT = Model::DescribeSdiSourceRequest>
  void DescribeSdiSourceAsync(const DescribeSdiSourceRequestT& request, const DescribeSdiSourceResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeThumbnails that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeThumbnails that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeThumbnailsRequestT = Model::DescribeThumbnailsRequest>
  void DescribeThumbnailsAsync(const DescribeThumbnailsRequestT& request, const DescribeThumbnailsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::GetCloudWatchAlarmTemplateOutcome GetCloudWatchAlarmTemplate(
      const Model::GetCloudWatchAlarmTemplateRequest& request) const;

  /**
   * A Callable wrapper for GetCloudWatchAlarmTemplate that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetCloudWatchAlarmTemplateRequestT = Model::GetCloudWatchAlarmTemplateRequest>
  Model::GetCloudWatchAlarmTemplateOutcomeCallable GetCloudWatchAlarmTemplateCallable(
      const GetCloudWatchAlarmTemplateRequestT& request) const {
    return SubmitCallable(&MediaLiveClient::GetCloudWatchAlarmTemplate, request);
  }

  /**
   * An Async wrapper for GetCloudWatchAlarmTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetCloudWatchAlarmTemplateRequestT = Model::GetCloudWatchAlarmTemplateRequest>
  void GetCloudWatchAlarmTemplateAsync(const GetCloudWatchAlarmTemplateRequestT& request,
                                       const GetCloudWatchAlarmTemplateResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::GetCloudWatchAlarmTemplateGroupOutcome GetCloudWatchAlarmTemplateGroup(
      const Model::GetCloudWatchAlarmTemplateGroupRequest& request) const;

  /**
   * A Callable wrapper for GetCloudWatchAlarmTemplateGroup that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetCloudWatchAlarmTemplateGroupRequestT = Model::GetCloudWatchAlarmTemplateGroupRequest>
  Model::GetCloudWatchAlarmTemplateGroupOutcomeCallable GetCloudWatchAlarmTemplateGroupCallable(
      const GetCloudWatchAlarmTemplateGroupRequestT& request) const {
    return SubmitCallable(&MediaLiveClient::GetCloudWatchAlarmTemplateGroup, request);
  }

  /**
   * An Async wrapper for GetCloudWatchAlarmTemplateGroup that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetCloudWatchAlarmTemplateGroupRequestT = Model::GetCloudWatchAlarmTemplateGroupRequest>
  void GetCloudWatchAlarmTemplateGroupAsync(const GetCloudWatchAlarmTemplateGroupRequestT& request,
                                            const GetCloudWatchAlarmTemplateGroupResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetEventBridgeRuleTemplateOutcome GetEventBridgeRuleTemplate(
      const Model::GetEventBridgeRuleTemplateRequest& request) const;

  /**
   * A Callable wrapper for GetEventBridgeRuleTemplate that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetEventBridgeRuleTemplateRequestT = Model::GetEventBridgeRuleTemplateRequest>
  Model::GetEventBridgeRuleTemplateOutcomeCallable GetEventBridgeRuleTemplateCallable(
      const GetEventBridgeRuleTemplateRequestT& request) const {
    return SubmitCallable(&MediaLiveClient::GetEventBridgeRuleTemplate, request);
  }

  /**
   * An Async wrapper for GetEventBridgeRuleTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetEventBridgeRuleTemplateRequestT = Model::GetEventBridgeRuleTemplateRequest>
  void GetEventBridgeRuleTemplateAsync(const GetEventBridgeRuleTemplateRequestT& request,
                                       const GetEventBridgeRuleTemplateResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetEventBridgeRuleTemplateGroupOutcome GetEventBridgeRuleTemplateGroup(
      const Model::GetEventBridgeRuleTemplateGroupRequest& request) const;

  /**
   * A Callable wrapper for GetEventBridgeRuleTemplateGroup that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetEventBridgeRuleTemplateGroupRequestT = Model::GetEventBridgeRuleTemplateGroupRequest>
  Model::GetEventBridgeRuleTemplateGroupOutcomeCallable GetEventBridgeRuleTemplateGroupCallable(
      const GetEventBridgeRuleTemplateGroupRequestT& request) const {
    return SubmitCallable(&MediaLiveClient::GetEventBridgeRuleTemplateGroup, request);
  }

  /**
   * An Async wrapper for GetEventBridgeRuleTemplateGroup that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetEventBridgeRuleTemplateGroupRequestT = Model::GetEventBridgeRuleTemplateGroupRequest>
  void GetEventBridgeRuleTemplateGroupAsync(const GetEventBridgeRuleTemplateGroupRequestT& request,
                                            const GetEventBridgeRuleTemplateGroupResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetSignalMap that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetSignalMapRequestT = Model::GetSignalMapRequest>
  void GetSignalMapAsync(const GetSignalMapRequestT& request, const GetSignalMapResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListChannelPlacementGroupsOutcome ListChannelPlacementGroups(
      const Model::ListChannelPlacementGroupsRequest& request) const;

  /**
   * A Callable wrapper for ListChannelPlacementGroups that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListChannelPlacementGroupsRequestT = Model::ListChannelPlacementGroupsRequest>
  Model::ListChannelPlacementGroupsOutcomeCallable ListChannelPlacementGroupsCallable(
      const ListChannelPlacementGroupsRequestT& request) const {
    return SubmitCallable(&MediaLiveClient::ListChannelPlacementGroups, request);
  }

  /**
   * An Async wrapper for ListChannelPlacementGroups that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListChannelPlacementGroupsRequestT = Model::ListChannelPlacementGroupsRequest>
  void ListChannelPlacementGroupsAsync(const ListChannelPlacementGroupsRequestT& request,
                                       const ListChannelPlacementGroupsResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::ListCloudWatchAlarmTemplateGroupsOutcome ListCloudWatchAlarmTemplateGroups(
      const Model::ListCloudWatchAlarmTemplateGroupsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListCloudWatchAlarmTemplateGroups that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListCloudWatchAlarmTemplateGroupsRequestT = Model::ListCloudWatchAlarmTemplateGroupsRequest>
  Model::ListCloudWatchAlarmTemplateGroupsOutcomeCallable ListCloudWatchAlarmTemplateGroupsCallable(
      const ListCloudWatchAlarmTemplateGroupsRequestT& request = {}) const {
    return SubmitCallable(&MediaLiveClient::ListCloudWatchAlarmTemplateGroups, request);
  }

  /**
   * An Async wrapper for ListCloudWatchAlarmTemplateGroups that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListCloudWatchAlarmTemplateGroupsRequestT = Model::ListCloudWatchAlarmTemplateGroupsRequest>
  void ListCloudWatchAlarmTemplateGroupsAsync(const ListCloudWatchAlarmTemplateGroupsResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                              const ListCloudWatchAlarmTemplateGroupsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListCloudWatchAlarmTemplatesOutcome ListCloudWatchAlarmTemplates(
      const Model::ListCloudWatchAlarmTemplatesRequest& request = {}) const;

  /**
   * A Callable wrapper for ListCloudWatchAlarmTemplates that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListCloudWatchAlarmTemplatesRequestT = Model::ListCloudWatchAlarmTemplatesRequest>
  Model::ListCloudWatchAlarmTemplatesOutcomeCallable ListCloudWatchAlarmTemplatesCallable(
      const ListCloudWatchAlarmTemplatesRequestT& request = {}) const {
    return SubmitCallable(&MediaLiveClient::ListCloudWatchAlarmTemplates, request);
  }

  /**
   * An Async wrapper for ListCloudWatchAlarmTemplates that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListCloudWatchAlarmTemplatesRequestT = Model::ListCloudWatchAlarmTemplatesRequest>
  void ListCloudWatchAlarmTemplatesAsync(const ListCloudWatchAlarmTemplatesResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                         const ListCloudWatchAlarmTemplatesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListClusterAlerts that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListClusterAlerts that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListClusterAlertsRequestT = Model::ListClusterAlertsRequest>
  void ListClusterAlertsAsync(const ListClusterAlertsRequestT& request, const ListClusterAlertsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListEventBridgeRuleTemplateGroupsOutcome ListEventBridgeRuleTemplateGroups(
      const Model::ListEventBridgeRuleTemplateGroupsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListEventBridgeRuleTemplateGroups that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListEventBridgeRuleTemplateGroupsRequestT = Model::ListEventBridgeRuleTemplateGroupsRequest>
  Model::ListEventBridgeRuleTemplateGroupsOutcomeCallable ListEventBridgeRuleTemplateGroupsCallable(
      const ListEventBridgeRuleTemplateGroupsRequestT& request = {}) const {
    return SubmitCallable(&MediaLiveClient::ListEventBridgeRuleTemplateGroups, request);
  }

  /**
   * An Async wrapper for ListEventBridgeRuleTemplateGroups that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListEventBridgeRuleTemplateGroupsRequestT = Model::ListEventBridgeRuleTemplateGroupsRequest>
  void ListEventBridgeRuleTemplateGroupsAsync(const ListEventBridgeRuleTemplateGroupsResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                              const ListEventBridgeRuleTemplateGroupsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListEventBridgeRuleTemplatesOutcome ListEventBridgeRuleTemplates(
      const Model::ListEventBridgeRuleTemplatesRequest& request = {}) const;

  /**
   * A Callable wrapper for ListEventBridgeRuleTemplates that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListEventBridgeRuleTemplatesRequestT = Model::ListEventBridgeRuleTemplatesRequest>
  Model::ListEventBridgeRuleTemplatesOutcomeCallable ListEventBridgeRuleTemplatesCallable(
      const ListEventBridgeRuleTemplatesRequestT& request = {}) const {
    return SubmitCallable(&MediaLiveClient::ListEventBridgeRuleTemplates, request);
  }

  /**
   * An Async wrapper for ListEventBridgeRuleTemplates that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListEventBridgeRuleTemplatesRequestT = Model::ListEventBridgeRuleTemplatesRequest>
  void ListEventBridgeRuleTemplatesAsync(const ListEventBridgeRuleTemplatesResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                         const ListEventBridgeRuleTemplatesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListInputDeviceTransfers that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListInputDeviceTransfers that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListInputDeviceTransfersRequestT = Model::ListInputDeviceTransfersRequest>
  void ListInputDeviceTransfersAsync(const ListInputDeviceTransfersRequestT& request,
  ...
  /**
   * A Callable wrapper for ListInputDevices that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListInputDevices that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListInputDevicesRequestT = Model::ListInputDevicesRequest>
  void ListInputDevicesAsync(const ListInputDevicesResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const ListInputDevicesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListInputSecurityGroups that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListInputSecurityGroups that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListInputSecurityGroupsRequestT = Model::ListInputSecurityGroupsRequest>
  void ListInputSecurityGroupsAsync(const ListInputSecurityGroupsResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const ListInputSecurityGroupsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListInputs that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListInputsRequestT = Model::ListInputsRequest>
  void ListInputsAsync(const ListInputsResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                       const ListInputsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListMultiplexAlerts that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListMultiplexAlerts that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListMultiplexAlertsRequestT = Model::ListMultiplexAlertsRequest>
  void ListMultiplexAlertsAsync(const ListMultiplexAlertsRequestT& request, const ListMultiplexAlertsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListMultiplexPrograms that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListMultiplexPrograms that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListMultiplexProgramsRequestT = Model::ListMultiplexProgramsRequest>
  void ListMultiplexProgramsAsync(const ListMultiplexProgramsRequestT& request, const ListMultiplexProgramsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListMultiplexes that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListMultiplexesRequestT = Model::ListMultiplexesRequest>
  void ListMultiplexesAsync(const ListMultiplexesResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const ListMultiplexesRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListNodes that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListNodesRequestT = Model::ListNodesRequest>
  void ListNodesAsync(const ListNodesRequestT& request, const ListNodesResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListSdiSources that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListSdiSourcesRequestT = Model::ListSdiSourcesRequest>
  void ListSdiSourcesAsync(const ListSdiSourcesResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const ListSdiSourcesRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListSignalMaps that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListSignalMapsRequestT = Model::ListSignalMapsRequest>
  void ListSignalMapsAsync(const ListSignalMapsResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const ListSignalMapsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for RebootInputDevice that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RebootInputDevice that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename RebootInputDeviceRequestT = Model::RebootInputDeviceRequest>
  void RebootInputDeviceAsync(const RebootInputDeviceRequestT& request, const RebootInputDeviceResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RejectInputDeviceTransfer that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename RejectInputDeviceTransferRequestT = Model::RejectInputDeviceTransferRequest>
  Model::RejectInputDeviceTransferOutcomeCallable RejectInputDeviceTransferCallable(
      const RejectInputDeviceTransferRequestT& request) const {
    return SubmitCallable(&MediaLiveClient::RejectInputDeviceTransfer, request);
  }

  /**
   * An Async wrapper for RejectInputDeviceTransfer that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RejectInputDeviceTransferRequestT = Model::RejectInputDeviceTransferRequest>
  void RejectInputDeviceTransferAsync(const RejectInputDeviceTransferRequestT& request,
  ...
  /**
   * A Callable wrapper for RestartChannelPipelines that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RestartChannelPipelines that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RestartChannelPipelinesRequestT = Model::RestartChannelPipelinesRequest>
  void RestartChannelPipelinesAsync(const RestartChannelPipelinesRequestT& request,
                                    const RestartChannelPipelinesResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartDeleteMonitorDeploymentOutcome StartDeleteMonitorDeployment(
      const Model::StartDeleteMonitorDeploymentRequest& request) const;

  /**
   * A Callable wrapper for StartDeleteMonitorDeployment that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename StartDeleteMonitorDeploymentRequestT = Model::StartDeleteMonitorDeploymentRequest>
  Model::StartDeleteMonitorDeploymentOutcomeCallable StartDeleteMonitorDeploymentCallable(
      const StartDeleteMonitorDeploymentRequestT& request) const {
    return SubmitCallable(&MediaLiveClient::StartDeleteMonitorDeployment, request);
  }

  /**
   * An Async wrapper for StartDeleteMonitorDeployment that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartDeleteMonitorDeploymentRequestT = Model::StartDeleteMonitorDeploymentRequest>
  void StartDeleteMonitorDeploymentAsync(const StartDeleteMonitorDeploymentRequestT& request,
                                         const StartDeleteMonitorDeploymentResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartInputDevice that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartInputDevice that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StartInputDeviceRequestT = Model::StartInputDeviceRequest>
  void StartInputDeviceAsync(const StartInputDeviceRequestT& request, const StartInputDeviceResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartInputDeviceMaintenanceWindowOutcome StartInputDeviceMaintenanceWindow(
      const Model::StartInputDeviceMaintenanceWindowRequest& request) const;

  /**
   * A Callable wrapper for StartInputDeviceMaintenanceWindow that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename StartInputDeviceMaintenanceWindowRequestT = Model::StartInputDeviceMaintenanceWindowRequest>
  Model::StartInputDeviceMaintenanceWindowOutcomeCallable StartInputDeviceMaintenanceWindowCallable(
      const StartInputDeviceMaintenanceWindowRequestT& request) const {
    return SubmitCallable(&MediaLiveClient::StartInputDeviceMaintenanceWindow, request);
  }

  /**
   * An Async wrapper for StartInputDeviceMaintenanceWindow that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename StartInputDeviceMaintenanceWindowRequestT = Model::StartInputDeviceMaintenanceWindowRequest>
  void StartInputDeviceMaintenanceWindowAsync(const StartInputDeviceMaintenanceWindowRequestT& request,
                                              const StartInputDeviceMaintenanceWindowResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartMonitorDeployment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartMonitorDeployment that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartMonitorDeploymentRequestT = Model::StartMonitorDeploymentRequest>
  void StartMonitorDeploymentAsync(const StartMonitorDeploymentRequestT& request,
                                   const StartMonitorDeploymentResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StartMultiplex that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StartMultiplexRequestT = Model::StartMultiplexRequest>
  void StartMultiplexAsync(const StartMultiplexRequestT& request, const StartMultiplexResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartUpdateSignalMap that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartUpdateSignalMap that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartUpdateSignalMapRequestT = Model::StartUpdateSignalMapRequest>
  void StartUpdateSignalMapAsync(const StartUpdateSignalMapRequestT& request, const StartUpdateSignalMapResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StopInputDevice that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StopInputDeviceRequestT = Model::StopInputDeviceRequest>
  void StopInputDeviceAsync(const StopInputDeviceRequestT& request, const StopInputDeviceResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StopMultiplex that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StopMultiplexRequestT = Model::StopMultiplexRequest>
  void StopMultiplexAsync(const StopMultiplexRequestT& request, const StopMultiplexResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for TransferInputDevice that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for TransferInputDevice that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename TransferInputDeviceRequestT = Model::TransferInputDeviceRequest>
  void TransferInputDeviceAsync(const TransferInputDeviceRequestT& request, const TransferInputDeviceResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateAccountConfigurationOutcome UpdateAccountConfiguration(
      const Model::UpdateAccountConfigurationRequest& request = {}) const;

  /**
   * A Callable wrapper for UpdateAccountConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateAccountConfigurationRequestT = Model::UpdateAccountConfigurationRequest>
  Model::UpdateAccountConfigurationOutcomeCallable UpdateAccountConfigurationCallable(
      const UpdateAccountConfigurationRequestT& request = {}) const {
    return SubmitCallable(&MediaLiveClient::UpdateAccountConfiguration, request);
  }

  /**
   * An Async wrapper for UpdateAccountConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateAccountConfigurationRequestT = Model::UpdateAccountConfigurationRequest>
  void UpdateAccountConfigurationAsync(const UpdateAccountConfigurationResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const UpdateAccountConfigurationRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for UpdateChannelClass that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateChannelClass that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateChannelClassRequestT = Model::UpdateChannelClassRequest>
  void UpdateChannelClassAsync(const UpdateChannelClassRequestT& request, const UpdateChannelClassResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateChannelPlacementGroupOutcome UpdateChannelPlacementGroup(
      const Model::UpdateChannelPlacementGroupRequest& request) const;

  /**
   * A Callable wrapper for UpdateChannelPlacementGroup that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateChannelPlacementGroupRequestT = Model::UpdateChannelPlacementGroupRequest>
  Model::UpdateChannelPlacementGroupOutcomeCallable UpdateChannelPlacementGroupCallable(
      const UpdateChannelPlacementGroupRequestT& request) const {
    return SubmitCallable(&MediaLiveClient::UpdateChannelPlacementGroup, request);
  }

  /**
   * An Async wrapper for UpdateChannelPlacementGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateChannelPlacementGroupRequestT = Model::UpdateChannelPlacementGroupRequest>
  void UpdateChannelPlacementGroupAsync(const UpdateChannelPlacementGroupRequestT& request,
                                        const UpdateChannelPlacementGroupResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateCloudWatchAlarmTemplateOutcome UpdateCloudWatchAlarmTemplate(
      const Model::UpdateCloudWatchAlarmTemplateRequest& request) const;

  /**
   * A Callable wrapper for UpdateCloudWatchAlarmTemplate that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateCloudWatchAlarmTemplateRequestT = Model::UpdateCloudWatchAlarmTemplateRequest>
  Model::UpdateCloudWatchAlarmTemplateOutcomeCallable UpdateCloudWatchAlarmTemplateCallable(
      const UpdateCloudWatchAlarmTemplateRequestT& request) const {
    return SubmitCallable(&MediaLiveClient::UpdateCloudWatchAlarmTemplate, request);
  }

  /**
   * An Async wrapper for UpdateCloudWatchAlarmTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateCloudWatchAlarmTemplateRequestT = Model::UpdateCloudWatchAlarmTemplateRequest>
  void UpdateCloudWatchAlarmTemplateAsync(const UpdateCloudWatchAlarmTemplateRequestT& request,
                                          const UpdateCloudWatchAlarmTemplateResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateCloudWatchAlarmTemplateGroupOutcome UpdateCloudWatchAlarmTemplateGroup(
      const Model::UpdateCloudWatchAlarmTemplateGroupRequest& request) const;

  /**
   * A Callable wrapper for UpdateCloudWatchAlarmTemplateGroup that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename UpdateCloudWatchAlarmTemplateGroupRequestT = Model::UpdateCloudWatchAlarmTemplateGroupRequest>
  Model::UpdateCloudWatchAlarmTemplateGroupOutcomeCallable UpdateCloudWatchAlarmTemplateGroupCallable(
      const UpdateCloudWatchAlarmTemplateGroupRequestT& request) const {
    return SubmitCallable(&MediaLiveClient::UpdateCloudWatchAlarmTemplateGroup, request);
  }

  /**
   * An Async wrapper for UpdateCloudWatchAlarmTemplateGroup that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateCloudWatchAlarmTemplateGroupRequestT = Model::UpdateCloudWatchAlarmTemplateGroupRequest>
  void UpdateCloudWatchAlarmTemplateGroupAsync(const UpdateCloudWatchAlarmTemplateGroupRequestT& request,
                                               const UpdateCloudWatchAlarmTemplateGroupResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateEventBridgeRuleTemplateOutcome UpdateEventBridgeRuleTemplate(
      const Model::UpdateEventBridgeRuleTemplateRequest& request) const;

  /**
   * A Callable wrapper for UpdateEventBridgeRuleTemplate that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateEventBridgeRuleTemplateRequestT = Model::UpdateEventBridgeRuleTemplateRequest>
  Model::UpdateEventBridgeRuleTemplateOutcomeCallable UpdateEventBridgeRuleTemplateCallable(
      const UpdateEventBridgeRuleTemplateRequestT& request) const {
    return SubmitCallable(&MediaLiveClient::UpdateEventBridgeRuleTemplate, request);
  }

  /**
   * An Async wrapper for UpdateEventBridgeRuleTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateEventBridgeRuleTemplateRequestT = Model::UpdateEventBridgeRuleTemplateRequest>
  void UpdateEventBridgeRuleTemplateAsync(const UpdateEventBridgeRuleTemplateRequestT& request,
                                          const UpdateEventBridgeRuleTemplateResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateEventBridgeRuleTemplateGroupOutcome UpdateEventBridgeRuleTemplateGroup(
      const Model::UpdateEventBridgeRuleTemplateGroupRequest& request) const;

  /**
   * A Callable wrapper for UpdateEventBridgeRuleTemplateGroup that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename UpdateEventBridgeRuleTemplateGroupRequestT = Model::UpdateEventBridgeRuleTemplateGroupRequest>
  Model::UpdateEventBridgeRuleTemplateGroupOutcomeCallable UpdateEventBridgeRuleTemplateGroupCallable(
      const UpdateEventBridgeRuleTemplateGroupRequestT& request) const {
    return SubmitCallable(&MediaLiveClient::UpdateEventBridgeRuleTemplateGroup, request);
  }

  /**
   * An Async wrapper for UpdateEventBridgeRuleTemplateGroup that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateEventBridgeRuleTemplateGroupRequestT = Model::UpdateEventBridgeRuleTemplateGroupRequest>
  void UpdateEventBridgeRuleTemplateGroupAsync(const UpdateEventBridgeRuleTemplateGroupRequestT& request,
                                               const UpdateEventBridgeRuleTemplateGroupResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateInput that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateInputRequestT = Model::UpdateInputRequest>
  void UpdateInputAsync(const UpdateInputRequestT& request, const UpdateInputResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateInputDevice that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateInputDevice that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateInputDeviceRequestT = Model::UpdateInputDeviceRequest>
  void UpdateInputDeviceAsync(const UpdateInputDeviceRequestT& request, const UpdateInputDeviceResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateInputSecurityGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateInputSecurityGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateInputSecurityGroupRequestT = Model::UpdateInputSecurityGroupRequest>
  void UpdateInputSecurityGroupAsync(const UpdateInputSecurityGroupRequestT& request,
  ...
  /**
   * An Async wrapper for UpdateMultiplex that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateMultiplexRequestT = Model::UpdateMultiplexRequest>
  void UpdateMultiplexAsync(const UpdateMultiplexRequestT& request, const UpdateMultiplexResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateMultiplexProgram that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateMultiplexProgram that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateMultiplexProgramRequestT = Model::UpdateMultiplexProgramRequest>
  void UpdateMultiplexProgramAsync(const UpdateMultiplexProgramRequestT& request,
  ...
  /**
   * An Async wrapper for UpdateNode that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateNodeRequestT = Model::UpdateNodeRequest>
  void UpdateNodeAsync(const UpdateNodeRequestT& request, const UpdateNodeResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateNodeState that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateNodeStateRequestT = Model::UpdateNodeStateRequest>
  void UpdateNodeStateAsync(const UpdateNodeStateRequestT& request, const UpdateNodeStateResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateReservation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateReservation that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateReservationRequestT = Model::UpdateReservationRequest>
  void UpdateReservationAsync(const UpdateReservationRequestT& request, const UpdateReservationResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateSdiSource that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateSdiSourceRequestT = Model::UpdateSdiSourceRequest>
  void UpdateSdiSourceAsync(const UpdateSdiSourceRequestT& request, const UpdateSdiSourceResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
