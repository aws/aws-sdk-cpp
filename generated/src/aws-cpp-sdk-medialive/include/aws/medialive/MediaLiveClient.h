...
namespace MediaLive
{
   ...
   */
  class AWS_MEDIALIVE_API MediaLiveClient : Aws::Client::ClientWithAsyncTemplateMethods<MediaLiveClient>,
    smithy::client::AwsSmithyClientT<Aws::MediaLive::SERVICE_NAME,
