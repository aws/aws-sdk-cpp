...
class Scte35TimeSignalScheduleActionSettings {
 public:
  ...
  void SetScte35Descriptors(Scte35DescriptorsT&& value) {
    m_scte35DescriptorsHasBeenSet = true;
    m_scte35Descriptors = std::forward<Scte35DescriptorsT>(value);
  }
  template <typename Scte35DescriptorsT = Aws::Vector<Scte35Descriptor>>
  Scte35TimeSignalScheduleActionSettings& WithScte35Descriptors(Scte35DescriptorsT&& value) {
    SetScte35Descriptors(std::forward<Scte35DescriptorsT>(value));
    return *this;
  }
  template <typename Scte35DescriptorsT = Scte35Descriptor>
  Scte35TimeSignalScheduleActionSettings& AddScte35Descriptors(Scte35DescriptorsT&& value) {
    m_scte35DescriptorsHasBeenSet = true;
    m_scte35Descriptors.emplace_back(std::forward<Scte35DescriptorsT>(value));
    return *this;
  }
  ///@}
 private:
