...
class UpdateNodeStateResult {
 public:
  ...
  inline UpdateNodeStateResult& WithConnectionState(NodeConnectionState value) {
  ...
  inline UpdateNodeStateResult& WithRole(NodeRole value) {
    SetRole(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateNodeStateResult& WithState(NodeState value) {
    SetState(value);
    return *this;
  }
  ///@}
