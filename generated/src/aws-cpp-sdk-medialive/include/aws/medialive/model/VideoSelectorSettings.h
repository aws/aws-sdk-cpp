...
class VideoSelectorSettings {
 public:
  ...
  void SetVideoSelectorPid(VideoSelectorPidT&& value) {
    m_videoSelectorPidHasBeenSet = true;
    m_videoSelectorPid = std::forward<VideoSelectorPidT>(value);
  }
  template <typename VideoSelectorPidT = VideoSelectorPid>
  VideoSelectorSettings& WithVideoSelectorPid(VideoSelectorPidT&& value) {
    SetVideoSelectorPid(std::forward<VideoSelectorPidT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVideoSelectorProgramId(VideoSelectorProgramIdT&& value) {
    m_videoSelectorProgramIdHasBeenSet = true;
    m_videoSelectorProgramId = std::forward<VideoSelectorProgramIdT>(value);
  }
  template <typename VideoSelectorProgramIdT = VideoSelectorProgramId>
  VideoSelectorSettings& WithVideoSelectorProgramId(VideoSelectorProgramIdT&& value) {
    SetVideoSelectorProgramId(std::forward<VideoSelectorProgramIdT>(value));
    return *this;
  }
  ///@}
 private:
