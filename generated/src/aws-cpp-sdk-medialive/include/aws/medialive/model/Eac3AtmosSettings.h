...
class Eac3AtmosSettings {
 public:
  ...
  inline Eac3AtmosSettings& WithBitrate(double value) {
    SetBitrate(value);
    return *this;
  }
  ///@}
  ...
  inline Eac3AtmosSettings& WithDialnorm(int value) {
    SetDialnorm(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDrcLine(Eac3AtmosDrcLine value) {
    m_drcLineHasBeenSet = true;
    m_drcLine = value;
  }
  inline Eac3AtmosSettings& WithDrcLine(Eac3AtmosDrcLine value) {
    SetDrcLine(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDrcRf(Eac3AtmosDrcRf value) {
    m_drcRfHasBeenSet = true;
    m_drcRf = value;
  }
  inline Eac3AtmosSettings& WithDrcRf(Eac3AtmosDrcRf value) {
    SetDrcRf(value);
    return *this;
  }
  ///@}
  ...
  inline void SetHeightTrim(double value) {
    m_heightTrimHasBeenSet = true;
    m_heightTrim = value;
  }
  inline Eac3AtmosSettings& WithHeightTrim(double value) {
    SetHeightTrim(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSurroundTrim(double value) {
    m_surroundTrimHasBeenSet = true;
    m_surroundTrim = value;
  }
  inline Eac3AtmosSettings& WithSurroundTrim(double value) {
    SetSurroundTrim(value);
    return *this;
  }
  ///@}
 private:
