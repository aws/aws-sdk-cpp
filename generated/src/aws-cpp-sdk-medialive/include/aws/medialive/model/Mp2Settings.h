...
class Mp2Settings {
 public:
  ...
  inline void SetBitrate(double value) {
    m_bitrateHasBeenSet = true;
    m_bitrate = value;
  }
  inline Mp2Settings& WithBitrate(double value) {
    SetBitrate(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCodingMode(Mp2CodingMode value) {
    m_codingModeHasBeenSet = true;
    m_codingMode = value;
  }
  inline Mp2Settings& WithCodingMode(Mp2CodingMode value) {
    SetCodingMode(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSampleRate(double value) {
    m_sampleRateHasBeenSet = true;
    m_sampleRate = value;
  }
  inline Mp2Settings& WithSampleRate(double value) {
    SetSampleRate(value);
    return *this;
  }
  ///@}
