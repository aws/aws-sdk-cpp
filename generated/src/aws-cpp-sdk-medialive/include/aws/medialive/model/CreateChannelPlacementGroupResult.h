...
class CreateChannelPlacementGroupResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  CreateChannelPlacementGroupResult& WithArn(ArnT&& value) {
  ...
  template <typename IdT = Aws::String>
  CreateChannelPlacementGroupResult& WithId(IdT&& value) {
  ...
  inline CreateChannelPlacementGroupResult& WithState(ChannelPlacementGroupState value) {
    SetState(value);
    return *this;
  }
  ///@}
