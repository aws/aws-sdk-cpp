...
namespace Model
{
  ...
  public:
    ...
    template<typename CidrT = Aws::String>
    Route& WithCidr(CidrT&& value) { SetCidr(std::forward<CidrT>(value)); return *this;}
    ///@}
    ...
    template<typename GatewayT = Aws::String>
    Route& WithGateway(GatewayT&& value) { SetGateway(std::forward<GatewayT>(value)); return *this;}
    ///@}
  private:
