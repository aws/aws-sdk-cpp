...
class M2tsSettings {
 public:
  ...
  inline void SetAbsentInputAudioBehavior(M2tsAbsentInputAudioBehavior value) {
    m_absentInputAudioBehaviorHasBeenSet = true;
    m_absentInputAudioBehavior = value;
  }
  inline M2tsSettings& WithAbsentInputAudioBehavior(M2tsAbsentInputAudioBehavior value) {
    SetAbsentInputAudioBehavior(value);
    return *this;
  }
  ///@}
  ...
  inline void SetArib(M2tsArib value) {
    m_aribHasBeenSet = true;
    m_arib = value;
  }
  inline M2tsSettings& WithArib(M2tsArib value) {
    SetArib(value);
    return *this;
  }
  ///@}
  ...
  void SetAribCaptionsPid(AribCaptionsPidT&& value) {
    ...
    m_aribCaptionsPid = std::forward<AribCaptionsPidT>(value);
  }
  template <typename AribCaptionsPidT = Aws::String>
  M2tsSettings& WithAribCaptionsPid(AribCaptionsPidT&& value) {
    SetAribCaptionsPid(std::forward<AribCaptionsPidT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAribCaptionsPidControl(M2tsAribCaptionsPidControl value) {
    m_aribCaptionsPidControlHasBeenSet = true;
    m_aribCaptionsPidControl = value;
  }
  inline M2tsSettings& WithAribCaptionsPidControl(M2tsAribCaptionsPidControl value) {
    SetAribCaptionsPidControl(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAudioBufferModel(M2tsAudioBufferModel value) {
    m_audioBufferModelHasBeenSet = true;
    m_audioBufferModel = value;
  }
  inline M2tsSettings& WithAudioBufferModel(M2tsAudioBufferModel value) {
    SetAudioBufferModel(value);
    return *this;
  }
  ///@}
  ...
  inline M2tsSettings& WithAudioFramesPerPes(int value) {
  ...
  inline void SetAudioStreamType(M2tsAudioStreamType value) {
    m_audioStreamTypeHasBeenSet = true;
    m_audioStreamType = value;
  }
  inline M2tsSettings& WithAudioStreamType(M2tsAudioStreamType value) {
  ...
  inline M2tsSettings& WithBitrate(int value) {
    SetBitrate(value);
    return *this;
  }
  ///@}
  ...
  inline void SetBufferModel(M2tsBufferModel value) {
    m_bufferModelHasBeenSet = true;
    m_bufferModel = value;
  }
  inline M2tsSettings& WithBufferModel(M2tsBufferModel value) {
    SetBufferModel(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCcDescriptor(M2tsCcDescriptor value) {
    m_ccDescriptorHasBeenSet = true;
    m_ccDescriptor = value;
  }
  inline M2tsSettings& WithCcDescriptor(M2tsCcDescriptor value) {
    SetCcDescriptor(value);
    return *this;
  }
  ///@}
  ...
  void SetDvbNitSettings(DvbNitSettingsT&& value) {
    ...
    m_dvbNitSettings = std::forward<DvbNitSettingsT>(value);
  }
  template <typename DvbNitSettingsT = DvbNitSettings>
  M2tsSettings& WithDvbNitSettings(DvbNitSettingsT&& value) {
    SetDvbNitSettings(std::forward<DvbNitSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDvbSdtSettings(DvbSdtSettingsT&& value) {
    ...
    m_dvbSdtSettings = std::forward<DvbSdtSettingsT>(value);
  }
  template <typename DvbSdtSettingsT = DvbSdtSettings>
  M2tsSettings& WithDvbSdtSettings(DvbSdtSettingsT&& value) {
    SetDvbSdtSettings(std::forward<DvbSdtSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDvbSubPids(DvbSubPidsT&& value) {
    ...
    m_dvbSubPids = std::forward<DvbSubPidsT>(value);
  }
  template <typename DvbSubPidsT = Aws::String>
  M2tsSettings& WithDvbSubPids(DvbSubPidsT&& value) {
    SetDvbSubPids(std::forward<DvbSubPidsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDvbTdtSettings(DvbTdtSettingsT&& value) {
    ...
    m_dvbTdtSettings = std::forward<DvbTdtSettingsT>(value);
  }
  template <typename DvbTdtSettingsT = DvbTdtSettings>
  M2tsSettings& WithDvbTdtSettings(DvbTdtSettingsT&& value) {
    SetDvbTdtSettings(std::forward<DvbTdtSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDvbTeletextPid(DvbTeletextPidT&& value) {
    ...
    m_dvbTeletextPid = std::forward<DvbTeletextPidT>(value);
  }
  template <typename DvbTeletextPidT = Aws::String>
  M2tsSettings& WithDvbTeletextPid(DvbTeletextPidT&& value) {
    SetDvbTeletextPid(std::forward<DvbTeletextPidT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetEbif(M2tsEbifControl value) {
    m_ebifHasBeenSet = true;
    m_ebif = value;
  }
  inline M2tsSettings& WithEbif(M2tsEbifControl value) {
    SetEbif(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEbpAudioInterval(M2tsAudioInterval value) {
    m_ebpAudioIntervalHasBeenSet = true;
    m_ebpAudioInterval = value;
  }
  inline M2tsSettings& WithEbpAudioInterval(M2tsAudioInterval value) {
    SetEbpAudioInterval(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEbpLookaheadMs(int value) {
    m_ebpLookaheadMsHasBeenSet = true;
    m_ebpLookaheadMs = value;
  }
  inline M2tsSettings& WithEbpLookaheadMs(int value) {
    SetEbpLookaheadMs(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEbpPlacement(M2tsEbpPlacement value) {
    m_ebpPlacementHasBeenSet = true;
    m_ebpPlacement = value;
  }
  inline M2tsSettings& WithEbpPlacement(M2tsEbpPlacement value) {
    SetEbpPlacement(value);
    return *this;
  }
  ///@}
  ...
  void SetEcmPid(EcmPidT&& value) {
    ...
    m_ecmPid = std::forward<EcmPidT>(value);
  }
  template <typename EcmPidT = Aws::String>
  M2tsSettings& WithEcmPid(EcmPidT&& value) {
    SetEcmPid(std::forward<EcmPidT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetEsRateInPes(M2tsEsRateInPes value) {
    m_esRateInPesHasBeenSet = true;
    m_esRateInPes = value;
  }
  inline M2tsSettings& WithEsRateInPes(M2tsEsRateInPes value) {
    SetEsRateInPes(value);
    return *this;
  }
  ///@}
  ...
  void SetEtvPlatformPid(EtvPlatformPidT&& value) {
    ...
    m_etvPlatformPid = std::forward<EtvPlatformPidT>(value);
  }
  template <typename EtvPlatformPidT = Aws::String>
  M2tsSettings& WithEtvPlatformPid(EtvPlatformPidT&& value) {
    SetEtvPlatformPid(std::forward<EtvPlatformPidT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEtvSignalPid(EtvSignalPidT&& value) {
    ...
    m_etvSignalPid = std::forward<EtvSignalPidT>(value);
  }
  template <typename EtvSignalPidT = Aws::String>
  M2tsSettings& WithEtvSignalPid(EtvSignalPidT&& value) {
    SetEtvSignalPid(std::forward<EtvSignalPidT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetFragmentTime(double value) {
    m_fragmentTimeHasBeenSet = true;
    m_fragmentTime = value;
  }
  inline M2tsSettings& WithFragmentTime(double value) {
  ...
  inline void SetKlv(M2tsKlv value) {
    m_klvHasBeenSet = true;
    m_klv = value;
  }
  inline M2tsSettings& WithKlv(M2tsKlv value) {
    SetKlv(value);
    return *this;
  }
  ///@}
  ...
  void SetKlvDataPids(KlvDataPidsT&& value) {
    ...
    m_klvDataPids = std::forward<KlvDataPidsT>(value);
  }
  template <typename KlvDataPidsT = Aws::String>
  M2tsSettings& WithKlvDataPids(KlvDataPidsT&& value) {
    SetKlvDataPids(std::forward<KlvDataPidsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetNielsenId3Behavior(M2tsNielsenId3Behavior value) {
    m_nielsenId3BehaviorHasBeenSet = true;
    m_nielsenId3Behavior = value;
  }
  inline M2tsSettings& WithNielsenId3Behavior(M2tsNielsenId3Behavior value) {
  ...
  inline void SetNullPacketBitrate(double value) {
    m_nullPacketBitrateHasBeenSet = true;
    m_nullPacketBitrate = value;
  }
  inline M2tsSettings& WithNullPacketBitrate(double value) {
    SetNullPacketBitrate(value);
    return *this;
  }
  ///@}
  ...
  inline M2tsSettings& WithPatInterval(int value) {
  ...
  inline void SetPcrControl(M2tsPcrControl value) {
    m_pcrControlHasBeenSet = true;
    m_pcrControl = value;
  }
  inline M2tsSettings& WithPcrControl(M2tsPcrControl value) {
    SetPcrControl(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPcrPeriod(int value) {
    m_pcrPeriodHasBeenSet = true;
    m_pcrPeriod = value;
  }
  inline M2tsSettings& WithPcrPeriod(int value) {
    SetPcrPeriod(value);
    return *this;
  }
  ///@}
  ...
  void SetPcrPid(PcrPidT&& value) {
    m_pcrPidHasBeenSet = true;
    m_pcrPid = std::forward<PcrPidT>(value);
  }
  template <typename PcrPidT = Aws::String>
  M2tsSettings& WithPcrPid(PcrPidT&& value) {
    SetPcrPid(std::forward<PcrPidT>(value));
    return *this;
  }
  ///@}
  ...
  inline M2tsSettings& WithPmtInterval(int value) {
  ...
  void SetPmtPid(PmtPidT&& value) {
    m_pmtPidHasBeenSet = true;
    m_pmtPid = std::forward<PmtPidT>(value);
  }
  template <typename PmtPidT = Aws::String>
  M2tsSettings& WithPmtPid(PmtPidT&& value) {
    SetPmtPid(std::forward<PmtPidT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetProgramNum(int value) {
    m_programNumHasBeenSet = true;
    m_programNum = value;
  }
  inline M2tsSettings& WithProgramNum(int value) {
    SetProgramNum(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRateMode(M2tsRateMode value) {
    m_rateModeHasBeenSet = true;
    m_rateMode = value;
  }
  inline M2tsSettings& WithRateMode(M2tsRateMode value) {
    SetRateMode(value);
    return *this;
  }
  ///@}
  ...
  void SetScte27Pids(Scte27PidsT&& value) {
    ...
    m_scte27Pids = std::forward<Scte27PidsT>(value);
  }
  template <typename Scte27PidsT = Aws::String>
  M2tsSettings& WithScte27Pids(Scte27PidsT&& value) {
    SetScte27Pids(std::forward<Scte27PidsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetScte35Control(M2tsScte35Control value) {
    m_scte35ControlHasBeenSet = true;
    m_scte35Control = value;
  }
  inline M2tsSettings& WithScte35Control(M2tsScte35Control value) {
    SetScte35Control(value);
    return *this;
  }
  ///@}
  ...
  void SetScte35Pid(Scte35PidT&& value) {
    ...
    m_scte35Pid = std::forward<Scte35PidT>(value);
  }
  template <typename Scte35PidT = Aws::String>
  M2tsSettings& WithScte35Pid(Scte35PidT&& value) {
    SetScte35Pid(std::forward<Scte35PidT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetSegmentationMarkers(M2tsSegmentationMarkers value) {
    m_segmentationMarkersHasBeenSet = true;
    m_segmentationMarkers = value;
  }
  inline M2tsSettings& WithSegmentationMarkers(M2tsSegmentationMarkers value) {
    SetSegmentationMarkers(value);
    return *this;
  }
  ///@}
...
When
  ...
  inline void SetSegmentationStyle(M2tsSegmentationStyle value) {
    m_segmentationStyleHasBeenSet = true;
    m_segmentationStyle = value;
  }
  inline M2tsSettings& WithSegmentationStyle(M2tsSegmentationStyle value) {
  ...
  inline void SetSegmentationTime(double value) {
    m_segmentationTimeHasBeenSet = true;
    m_segmentationTime = value;
  }
  inline M2tsSettings& WithSegmentationTime(double value) {
    SetSegmentationTime(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTimedMetadataBehavior(M2tsTimedMetadataBehavior value) {
    m_timedMetadataBehaviorHasBeenSet = true;
    m_timedMetadataBehavior = value;
  }
  inline M2tsSettings& WithTimedMetadataBehavior(M2tsTimedMetadataBehavior value) {
    SetTimedMetadataBehavior(value);
    return *this;
  }
  ///@}
  ...
  void SetTimedMetadataPid(TimedMetadataPidT&& value) {
    ...
    m_timedMetadataPid = std::forward<TimedMetadataPidT>(value);
  }
  template <typename TimedMetadataPidT = Aws::String>
  M2tsSettings& WithTimedMetadataPid(TimedMetadataPidT&& value) {
    SetTimedMetadataPid(std::forward<TimedMetadataPidT>(value));
    return *this;
  }
  ///@}
  ...
  inline M2tsSettings& WithTransportStreamId(int value) {
  ...
  void SetVideoPid(VideoPidT&& value) {
    ...
    m_videoPid = std::forward<VideoPidT>(value);
  }
  template <typename VideoPidT = Aws::String>
  M2tsSettings& WithVideoPid(VideoPidT&& value) {
    SetVideoPid(std::forward<VideoPidT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetScte35PrerollPullupMilliseconds(double value) {
    m_scte35PrerollPullupMillisecondsHasBeenSet = true;
    m_scte35PrerollPullupMilliseconds = value;
  }
  inline M2tsSettings& WithScte35PrerollPullupMilliseconds(double value) {
    SetScte35PrerollPullupMilliseconds(value);
    return *this;
  }
  ///@}
 private:
