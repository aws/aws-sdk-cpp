...
class DescribeInputDeviceThumbnailRequest : public MediaLiveRequest {
 public:
  ...
  template <typename InputDeviceIdT = Aws::String>
  DescribeInputDeviceThumbnailRequest& WithInputDeviceId(InputDeviceIdT&& value) {
  ...
  inline void SetAccept(AcceptHeader value) {
    m_acceptHasBeenSet = true;
    m_accept = value;
  }
  inline DescribeInputDeviceThumbnailRequest& WithAccept(AcceptHeader value) {
    SetAccept(value);
    return *this;
  }
  ///@}
