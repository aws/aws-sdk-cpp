...
namespace Model
{
  ...
  {
  public:
    AWS_MEDIALIVE_API StartInputDeviceResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    StartInputDeviceResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
