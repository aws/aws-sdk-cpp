...
class MonitorDeployment {
 public:
  ...
  void SetDetailsUri(DetailsUriT&& value) {
    m_detailsUriHasBeenSet = true;
    m_detailsUri = std::forward<DetailsUriT>(value);
  }
  template <typename DetailsUriT = Aws::String>
  MonitorDeployment& WithDetailsUri(DetailsUriT&& value) {
    SetDetailsUri(std::forward<DetailsUriT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ErrorMessageT = Aws::String>
  MonitorDeployment& WithErrorMessage(ErrorMessageT&& value) {
  ...
  inline void SetStatus(SignalMapMonitorDeploymentStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline MonitorDeployment& WithStatus(SignalMapMonitorDeploymentStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
