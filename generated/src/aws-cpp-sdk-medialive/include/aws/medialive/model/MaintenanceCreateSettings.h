...
class MaintenanceCreateSettings {
 public:
  ...
  inline MaintenanceCreateSettings& WithMaintenanceDay(MaintenanceDay value) {
  ...
  template <typename MaintenanceStartTimeT = Aws::String>
  MaintenanceCreateSettings& WithMaintenanceStartTime(MaintenanceStartTimeT&& value) {
