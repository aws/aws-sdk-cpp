...
class ArchiveContainerSettings {
 public:
  ...
  void SetM2tsSettings(M2tsSettingsT&& value) {
    m_m2tsSettingsHasBeenSet = true;
    m_m2tsSettings = std::forward<M2tsSettingsT>(value);
  }
  template <typename M2tsSettingsT = M2tsSettings>
  ArchiveContainerSettings& WithM2tsSettings(M2tsSettingsT&& value) {
    SetM2tsSettings(std::forward<M2tsSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRawSettings(RawSettingsT&& value) {
    m_rawSettingsHasBeenSet = true;
    m_rawSettings = std::forward<RawSettingsT>(value);
  }
  template <typename RawSettingsT = RawSettings>
  ArchiveContainerSettings& WithRawSettings(RawSettingsT&& value) {
    SetRawSettings(std::forward<RawSettingsT>(value));
    return *this;
  }
  ///@}
 private:
