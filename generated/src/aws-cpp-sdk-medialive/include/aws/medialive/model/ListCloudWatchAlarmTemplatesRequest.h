...
class ListCloudWatchAlarmTemplatesRequest : public MediaLiveRequest {
 public:
  ...
  template <typename GroupIdentifierT = Aws::String>
  ListCloudWatchAlarmTemplatesRequest& WithGroupIdentifier(GroupIdentifierT&& value) {
  ...
  inline ListCloudWatchAlarmTemplatesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListCloudWatchAlarmTemplatesRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ScopeT = Aws::String>
  ListCloudWatchAlarmTemplatesRequest& WithScope(ScopeT&& value) {
  ...
  template <typename SignalMapIdentifierT = Aws::String>
  ListCloudWatchAlarmTemplatesRequest& WithSignalMapIdentifier(SignalMapIdentifierT&& value) {
