...
class StaticImageOutputActivateScheduleActionSettings {
 public:
  ...
  inline StaticImageOutputActivateScheduleActionSettings& WithDuration(int value) {
    SetDuration(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFadeIn(int value) {
    m_fadeInHasBeenSet = true;
    m_fadeIn = value;
  }
  inline StaticImageOutputActivateScheduleActionSettings& WithFadeIn(int value) {
    SetFadeIn(value);
    return *this;
  }
  ///@}
  ...
  inline StaticImageOutputActivateScheduleActionSettings& WithFadeOut(int value) {
    SetFadeOut(value);
    return *this;
  }
  ///@}
  ...
  inline StaticImageOutputActivateScheduleActionSettings& WithHeight(int value) {
    SetHeight(value);
    return *this;
  }
  ///@}
  ...
  template <typename ImageT = InputLocation>
  StaticImageOutputActivateScheduleActionSettings& WithImage(ImageT&& value) {
  ...
  inline void SetImageX(int value) {
    m_imageXHasBeenSet = true;
    m_imageX = value;
  }
  inline StaticImageOutputActivateScheduleActionSettings& WithImageX(int value) {
    SetImageX(value);
    return *this;
  }
  ///@}
  ...
  inline void SetImageY(int value) {
    m_imageYHasBeenSet = true;
    m_imageY = value;
  }
  inline StaticImageOutputActivateScheduleActionSettings& WithImageY(int value) {
    SetImageY(value);
    return *this;
  }
  ///@}
  ...
  inline StaticImageOutputActivateScheduleActionSettings& WithLayer(int value) {
    SetLayer(value);
    return *this;
  }
  ///@}
  ...
  inline StaticImageOutputActivateScheduleActionSettings& WithOpacity(int value) {
    SetOpacity(value);
    return *this;
  }
  ///@}
  ...
  template <typename OutputNamesT = Aws::Vector<Aws::String>>
  StaticImageOutputActivateScheduleActionSettings& WithOutputNames(OutputNamesT&& value) {
    SetOutputNames(std::forward<OutputNamesT>(value));
    return *this;
  }
  template <typename OutputNamesT = Aws::String>
  StaticImageOutputActivateScheduleActionSettings& AddOutputNames(OutputNamesT&& value) {
    m_outputNamesHasBeenSet = true;
  ...
  inline StaticImageOutputActivateScheduleActionSettings& WithWidth(int value) {
    SetWidth(value);
    return *this;
  }
  ///@}
