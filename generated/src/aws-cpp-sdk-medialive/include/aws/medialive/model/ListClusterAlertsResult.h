...
namespace Model
{
  ...
  public:
    ...
    template<typename AlertsT = Aws::Vector<ClusterAlert>>
    ListClusterAlertsResult& WithAlerts(AlertsT&& value) { SetAlerts(std::forward<AlertsT>(value)); return *this;}
    template<typename AlertsT = ClusterAlert>
    ListClusterAlertsResult& AddAlerts(AlertsT&& value) { m_alertsHasBeenSet = true; m_alerts.emplace_back(std::forward<AlertsT>(value)); return *this; }
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListClusterAlertsResult& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ListClusterAlertsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
