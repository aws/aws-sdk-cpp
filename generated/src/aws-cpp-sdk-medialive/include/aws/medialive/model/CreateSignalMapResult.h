...
namespace Model
{
  ...
  public:
    ...
    template<typename ArnT = Aws::String>
    CreateSignalMapResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename CloudWatchAlarmTemplateGroupIdsT = Aws::Vector<Aws::String>>
    CreateSignalMapResult& WithCloudWatchAlarmTemplateGroupIds(CloudWatchAlarmTemplateGroupIdsT&& value) { SetCloudWatchAlarmTemplateGroupIds(std::forward<CloudWatchAlarmTemplateGroupIdsT>(value)); return *this;}
    template<typename CloudWatchAlarmTemplateGroupIdsT = Aws::String>
    CreateSignalMapResult& AddCloudWatchAlarmTemplateGroupIds(CloudWatchAlarmTemplateGroupIdsT&& value) { m_cloudWatchAlarmTemplateGroupIdsHasBeenSet = true; m_cloudWatchAlarmTemplateGroupIds.emplace_back(std::forward<CloudWatchAlarmTemplateGroupIdsT>(value)); return *this; }
    ///@}
    ...
    template<typename CreatedAtT = Aws::Utils::DateTime>
    CreateSignalMapResult& WithCreatedAt(CreatedAtT&& value) { SetCreatedAt(std::forward<CreatedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    CreateSignalMapResult& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename DiscoveryEntryPointArnT = Aws::String>
    CreateSignalMapResult& WithDiscoveryEntryPointArn(DiscoveryEntryPointArnT&& value) { SetDiscoveryEntryPointArn(std::forward<DiscoveryEntryPointArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ErrorMessageT = Aws::String>
    CreateSignalMapResult& WithErrorMessage(ErrorMessageT&& value) { SetErrorMessage(std::forward<ErrorMessageT>(value)); return *this;}
    ///@}
    ...
    template<typename EventBridgeRuleTemplateGroupIdsT = Aws::Vector<Aws::String>>
    CreateSignalMapResult& WithEventBridgeRuleTemplateGroupIds(EventBridgeRuleTemplateGroupIdsT&& value) { SetEventBridgeRuleTemplateGroupIds(std::forward<EventBridgeRuleTemplateGroupIdsT>(value)); return *this;}
    template<typename EventBridgeRuleTemplateGroupIdsT = Aws::String>
    CreateSignalMapResult& AddEventBridgeRuleTemplateGroupIds(EventBridgeRuleTemplateGroupIdsT&& value) { m_eventBridgeRuleTemplateGroupIdsHasBeenSet = true; m_eventBridgeRuleTemplateGroupIds.emplace_back(std::forward<EventBridgeRuleTemplateGroupIdsT>(value)); return *this; }
    ///@}
    ...
    template<typename FailedMediaResourceMapT = Aws::Map<Aws::String, MediaResource>>
    CreateSignalMapResult& WithFailedMediaResourceMap(FailedMediaResourceMapT&& value) { SetFailedMediaResourceMap(std::forward<FailedMediaResourceMapT>(value)); return *this;}
    ...
    template<typename IdT = Aws::String>
    CreateSignalMapResult& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename LastDiscoveredAtT = Aws::Utils::DateTime>
    CreateSignalMapResult& WithLastDiscoveredAt(LastDiscoveredAtT&& value) { SetLastDiscoveredAt(std::forward<LastDiscoveredAtT>(value)); return *this;}
    ///@}
    ...
    template<typename LastSuccessfulMonitorDeploymentT = SuccessfulMonitorDeployment>
    CreateSignalMapResult& WithLastSuccessfulMonitorDeployment(LastSuccessfulMonitorDeploymentT&& value) { SetLastSuccessfulMonitorDeployment(std::forward<LastSuccessfulMonitorDeploymentT>(value)); return *this;}
    ///@}
    ...
    template<typename MediaResourceMapT = Aws::Map<Aws::String, MediaResource>>
    CreateSignalMapResult& WithMediaResourceMap(MediaResourceMapT&& value) { SetMediaResourceMap(std::forward<MediaResourceMapT>(value)); return *this;}
    ...
    template<typename ModifiedAtT = Aws::Utils::DateTime>
    CreateSignalMapResult& WithModifiedAt(ModifiedAtT&& value) { SetModifiedAt(std::forward<ModifiedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename MonitorDeploymentT = MonitorDeployment>
    CreateSignalMapResult& WithMonitorDeployment(MonitorDeploymentT&& value) { SetMonitorDeployment(std::forward<MonitorDeploymentT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    CreateSignalMapResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    inline CreateSignalMapResult& WithStatus(SignalMapStatus value) { SetStatus(value); return *this;}
    ///@}
    ...
    template<typename TagsT = Aws::Map<Aws::String, Aws::String>>
    CreateSignalMapResult& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
    ...
    template<typename RequestIdT = Aws::String>
    CreateSignalMapResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
