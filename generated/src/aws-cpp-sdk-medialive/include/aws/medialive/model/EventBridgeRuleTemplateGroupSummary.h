...
class EventBridgeRuleTemplateGroupSummary {
 public:
  ...
  template <typename ArnT = Aws::String>
  EventBridgeRuleTemplateGroupSummary& WithArn(ArnT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  EventBridgeRuleTemplateGroupSummary& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  EventBridgeRuleTemplateGroupSummary& WithDescription(DescriptionT&& value) {
  ...
  template <typename IdT = Aws::String>
  EventBridgeRuleTemplateGroupSummary& WithId(IdT&& value) {
  ...
  template <typename ModifiedAtT = Aws::Utils::DateTime>
  EventBridgeRuleTemplateGroupSummary& WithModifiedAt(ModifiedAtT&& value) {
  ...
  template <typename NameT = Aws::String>
  EventBridgeRuleTemplateGroupSummary& WithName(NameT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  EventBridgeRuleTemplateGroupSummary& WithTags(TagsT&& value) {
  ...
  inline void SetTemplateCount(int value) {
    m_templateCountHasBeenSet = true;
    m_templateCount = value;
  }
  inline EventBridgeRuleTemplateGroupSummary& WithTemplateCount(int value) {
