...
class MultiplexSettings {
 public:
  ...
  inline void SetMaximumVideoBufferDelayMilliseconds(int value) {
    m_maximumVideoBufferDelayMillisecondsHasBeenSet = true;
    m_maximumVideoBufferDelayMilliseconds = value;
  }
  inline MultiplexSettings& WithMaximumVideoBufferDelayMilliseconds(int value) {
    SetMaximumVideoBufferDelayMilliseconds(value);
    return *this;
  }
  ///@}
  ...
  inline MultiplexSettings& WithTransportStreamBitrate(int value) {
  ...
  inline MultiplexSettings& WithTransportStreamId(int value) {
  ...
  inline void SetTransportStreamReservedBitrate(int value) {
    m_transportStreamReservedBitrateHasBeenSet = true;
    m_transportStreamReservedBitrate = value;
  }
  inline MultiplexSettings& WithTransportStreamReservedBitrate(int value) {
    SetTransportStreamReservedBitrate(value);
    return *this;
  }
  ///@}
 private:
