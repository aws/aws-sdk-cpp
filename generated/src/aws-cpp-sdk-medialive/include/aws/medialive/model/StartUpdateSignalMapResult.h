...
class StartUpdateSignalMapResult {
 public:
  ...
  template <typename IdT = Aws::String>
  StartUpdateSignalMapResult& WithId(IdT&& value) {
  ...
  inline StartUpdateSignalMapResult& WithMonitorChangesPendingDeployment(bool value) {
  ...
  inline StartUpdateSignalMapResult& WithStatus(SignalMapStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
