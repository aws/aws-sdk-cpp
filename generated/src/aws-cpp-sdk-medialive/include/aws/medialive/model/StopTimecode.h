...
class StopTimecode {
 public:
  ...
  inline void SetLastFrameClippingBehavior(LastFrameClippingBehavior value) {
    m_lastFrameClippingBehaviorHasBeenSet = true;
    m_lastFrameClippingBehavior = value;
  }
  inline StopTimecode& WithLastFrameClippingBehavior(LastFrameClippingBehavior value) {
    SetLastFrameClippingBehavior(value);
    return *this;
  }
  ///@}
