...
namespace Model
{
  ...
  {
  public:
    AWS_MEDIALIVE_API DeleteNodeResult();
    ...
    inline DeleteNodeResult& WithArn(const Aws::String& value) { SetArn(value); return *this;}
    inline DeleteNodeResult& WithArn(Aws::String&& value) { SetArn(std::move(value)); return *this;}
    inline DeleteNodeResult& WithArn(const char* value) { SetArn(value); return *this;}
    ///@}
    ...
    inline DeleteNodeResult& WithChannelPlacementGroups(const Aws::Vector<Aws::String>& value) { SetChannelPlacementGroups(value); return *this;}
    inline DeleteNodeResult& WithChannelPlacementGroups(Aws::Vector<Aws::String>&& value) { SetChannelPlacementGroups(std::move(value)); return *this;}
    inline DeleteNodeResult& AddChannelPlacementGroups(const Aws::String& value) { m_channelPlacementGroups.push_back(value); return *this; }
    inline DeleteNodeResult& AddChannelPlacementGroups(Aws::String&& value) { m_channelPlacementGroups.push_back(std::move(value)); return *this; }
    inline DeleteNodeResult& AddChannelPlacementGroups(const char* value) { m_channelPlacementGroups.push_back(value); return *this; }
    ///@}
    ...
    inline DeleteNodeResult& WithClusterId(const Aws::String& value) { SetClusterId(value); return *this;}
    inline DeleteNodeResult& WithClusterId(Aws::String&& value) { SetClusterId(std::move(value)); return *this;}
    inline DeleteNodeResult& WithClusterId(const char* value) { SetClusterId(value); return *this;}
    ///@}
    ...
    inline DeleteNodeResult& WithConnectionState(const NodeConnectionState& value) { SetConnectionState(value); return *this;}
    inline DeleteNodeResult& WithConnectionState(NodeConnectionState&& value) { SetConnectionState(std::move(value)); return *this;}
    ///@}
    ...
    inline DeleteNodeResult& WithId(const Aws::String& value) { SetId(value); return *this;}
    inline DeleteNodeResult& WithId(Aws::String&& value) { SetId(std::move(value)); return *this;}
    inline DeleteNodeResult& WithId(const char* value) { SetId(value); return *this;}
    ///@}
    ...
    inline DeleteNodeResult& WithInstanceArn(const Aws::String& value) { SetInstanceArn(value); return *this;}
    inline DeleteNodeResult& WithInstanceArn(Aws::String&& value) { SetInstanceArn(std::move(value)); return *this;}
    inline DeleteNodeResult& WithInstanceArn(const char* value) { SetInstanceArn(value); return *this;}
    ///@}
    ...
    inline DeleteNodeResult& WithName(const Aws::String& value) { SetName(value); return *this;}
    inline DeleteNodeResult& WithName(Aws::String&& value) { SetName(std::move(value)); return *this;}
    inline DeleteNodeResult& WithName(const char* value) { SetName(value); return *this;}
    ///@}
    ...
    inline DeleteNodeResult& WithNodeInterfaceMappings(const Aws::Vector<NodeInterfaceMapping>& value) { SetNodeInterfaceMappings(value); return *this;}
    inline DeleteNodeResult& WithNodeInterfaceMappings(Aws::Vector<NodeInterfaceMapping>&& value) { SetNodeInterfaceMappings(std::move(value)); return *this;}
    inline DeleteNodeResult& AddNodeInterfaceMappings(const NodeInterfaceMapping& value) { m_nodeInterfaceMappings.push_back(value); return *this; }
    inline DeleteNodeResult& AddNodeInterfaceMappings(NodeInterfaceMapping&& value) { m_nodeInterfaceMappings.push_back(std::move(value)); return *this; }
    ///@}
    ...
    inline DeleteNodeResult& WithRole(const NodeRole& value) { SetRole(value); return *this;}
    inline DeleteNodeResult& WithRole(NodeRole&& value) { SetRole(std::move(value)); return *this;}
    ///@}
    ...
    inline DeleteNodeResult& WithState(const NodeState& value) { SetState(value); return *this;}
    inline DeleteNodeResult& WithState(NodeState&& value) { SetState(std::move(value)); return *this;}
    ///@}
