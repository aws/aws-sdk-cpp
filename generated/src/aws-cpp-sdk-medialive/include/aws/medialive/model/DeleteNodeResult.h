...
class DeleteNodeResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  DeleteNodeResult& WithArn(ArnT&& value) {
  ...
  template <typename ChannelPlacementGroupsT = Aws::Vector<Aws::String>>
  DeleteNodeResult& WithChannelPlacementGroups(ChannelPlacementGroupsT&& value) {
    SetChannelPlacementGroups(std::forward<ChannelPlacementGroupsT>(value));
    return *this;
  }
  template <typename ChannelPlacementGroupsT = Aws::String>
  DeleteNodeResult& AddChannelPlacementGroups(ChannelPlacementGroupsT&& value) {
    m_channelPlacementGroupsHasBeenSet = true;
  ...
  template <typename ClusterIdT = Aws::String>
  DeleteNodeResult& WithClusterId(ClusterIdT&& value) {
  ...
  inline DeleteNodeResult& WithConnectionState(NodeConnectionState value) {
  ...
  template <typename IdT = Aws::String>
  DeleteNodeResult& WithId(IdT&& value) {
  ...
  template <typename InstanceArnT = Aws::String>
  DeleteNodeResult& WithInstanceArn(InstanceArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  DeleteNodeResult& WithName(NameT&& value) {
  ...
  template <typename NodeInterfaceMappingsT = Aws::Vector<NodeInterfaceMapping>>
  DeleteNodeResult& WithNodeInterfaceMappings(NodeInterfaceMappingsT&& value) {
  ...
  DeleteNodeResult& AddNodeInterfaceMappings(NodeInterfaceMappingsT&& value) {
    m_nodeInterfaceMappingsHasBeenSet = true;
  ...
  inline DeleteNodeResult& WithRole(NodeRole value) {
    SetRole(value);
    return *this;
  }
  ///@}
  ...
  inline DeleteNodeResult& WithState(NodeState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename SdiSourceMappingsT = Aws::Vector<SdiSourceMapping>>
  DeleteNodeResult& WithSdiSourceMappings(SdiSourceMappingsT&& value) {
    SetSdiSourceMappings(std::forward<SdiSourceMappingsT>(value));
    return *this;
  }
  template <typename SdiSourceMappingsT = SdiSourceMapping>
  DeleteNodeResult& AddSdiSourceMappings(SdiSourceMappingsT&& value) {
    m_sdiSourceMappingsHasBeenSet = true;
