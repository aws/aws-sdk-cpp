...
namespace Model
{
  ...
  /**
   * Placeholder documentation for ListClustersRequest<p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/medialive-2017-10-14/ListClustersRequest">AWS
   * API Reference</a></p>
   */
  class ListClustersRequest : public MediaLiveRequest
  {
  public:
    AWS_MEDIALIVE_API ListClustersRequest() = default;
