...
class SrtCallerSourceRequest {
 public:
  ...
  inline SrtCallerSourceRequest& WithMinimumLatency(int value) {
  ...
  void SetSrtListenerAddress(SrtListenerAddressT&& value) {
    ...
    m_srtListenerAddress = std::forward<SrtListenerAddressT>(value);
  }
  template <typename SrtListenerAddressT = Aws::String>
  SrtCallerSourceRequest& WithSrtListenerAddress(SrtListenerAddressT&& value) {
    SetSrtListenerAddress(std::forward<SrtListenerAddressT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSrtListenerPort(SrtListenerPortT&& value) {
    ...
    m_srtListenerPort = std::forward<SrtListenerPortT>(value);
  }
  template <typename SrtListenerPortT = Aws::String>
  SrtCallerSourceRequest& WithSrtListenerPort(SrtListenerPortT&& value) {
    SetSrtListenerPort(std::forward<SrtListenerPortT>(value));
    return *this;
  }
  ///@}
