...
namespace Model
{
  ...
  public:
    ...
    template<typename ArnT = Aws::String>
    DescribeReservationResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename CurrencyCodeT = Aws::String>
    DescribeReservationResult& WithCurrencyCode(CurrencyCodeT&& value) { SetCurrencyCode(std::forward<CurrencyCodeT>(value)); return *this;}
    ///@}
    ...
    inline DescribeReservationResult& WithDurationUnits(OfferingDurationUnits value) { SetDurationUnits(value); return *this;}
    ///@}
    ...
    template<typename EndT = Aws::String>
    DescribeReservationResult& WithEnd(EndT&& value) { SetEnd(std::forward<EndT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    DescribeReservationResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename OfferingDescriptionT = Aws::String>
    DescribeReservationResult& WithOfferingDescription(OfferingDescriptionT&& value) { SetOfferingDescription(std::forward<OfferingDescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename OfferingIdT = Aws::String>
    DescribeReservationResult& WithOfferingId(OfferingIdT&& value) { SetOfferingId(std::forward<OfferingIdT>(value)); return *this;}
    ///@}
    ...
    inline DescribeReservationResult& WithOfferingType(OfferingType value) { SetOfferingType(value); return *this;}
    ///@}
    ...
    template<typename RegionT = Aws::String>
    DescribeReservationResult& WithRegion(RegionT&& value) { SetRegion(std::forward<RegionT>(value)); return *this;}
    ///@}
    ...
    template<typename RenewalSettingsT = RenewalSettings>
    DescribeReservationResult& WithRenewalSettings(RenewalSettingsT&& value) { SetRenewalSettings(std::forward<RenewalSettingsT>(value)); return *this;}
    ///@}
    ...
    template<typename ReservationIdT = Aws::String>
    DescribeReservationResult& WithReservationId(ReservationIdT&& value) { SetReservationId(std::forward<ReservationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ResourceSpecificationT = ReservationResourceSpecification>
    DescribeReservationResult& WithResourceSpecification(ResourceSpecificationT&& value) { SetResourceSpecification(std::forward<ResourceSpecificationT>(value)); return *this;}
    ///@}
    ...
    template<typename StartT = Aws::String>
    DescribeReservationResult& WithStart(StartT&& value) { SetStart(std::forward<StartT>(value)); return *this;}
    ///@}
    ...
    inline DescribeReservationResult& WithState(ReservationState value) { SetState(value); return *this;}
    ///@}
    ...
    template<typename TagsT = Aws::Map<Aws::String, Aws::String>>
    DescribeReservationResult& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
