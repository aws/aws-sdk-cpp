...
class DescribeReservationResult {
 public:
  ...
  inline DescribeReservationResult& WithCount(int value) {
    SetCount(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeReservationResult& WithDuration(int value) {
    SetDuration(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeReservationResult& WithDurationUnits(OfferingDurationUnits value) {
  ...
  inline DescribeReservationResult& WithFixedPrice(double value) {
    SetFixedPrice(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeReservationResult& WithOfferingType(OfferingType value) {
  ...
  inline DescribeReservationResult& WithState(ReservationState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeReservationResult& WithUsagePrice(double value) {
    SetUsagePrice(value);
    return *this;
  }
  ///@}
