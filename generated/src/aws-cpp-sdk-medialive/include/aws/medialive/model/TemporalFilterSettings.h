...
- If the source content is already clean, the filter tends to
  ...
  inline void SetPostFilterSharpening(TemporalFilterPostFilterSharpening value) {
    m_postFilterSharpeningHasBeenSet = true;
    m_postFilterSharpening = value;
  }
  inline TemporalFilterSettings& WithPostFilterSharpening(TemporalFilterPostFilterSharpening value) {
    SetPostFilterSharpening(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStrength(TemporalFilterStrength value) {
    m_strengthHasBeenSet = true;
    m_strength = value;
  }
  inline TemporalFilterSettings& WithStrength(TemporalFilterStrength value) {
    SetStrength(value);
    return *this;
  }
  ///@}
