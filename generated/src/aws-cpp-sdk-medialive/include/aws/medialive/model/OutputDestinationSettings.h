...
class OutputDestinationSettings {
 public:
  ...
  template <typename PasswordParamT = Aws::String>
  OutputDestinationSettings& WithPasswordParam(PasswordParamT&& value) {
  ...
  template <typename StreamNameT = Aws::String>
  OutputDestinationSettings& WithStreamName(StreamNameT&& value) {
  ...
  template <typename UrlT = Aws::String>
  OutputDestinationSettings& WithUrl(UrlT&& value) {
  ...
  template <typename UsernameT = Aws::String>
  OutputDestinationSettings& WithUsername(UsernameT&& value) {
