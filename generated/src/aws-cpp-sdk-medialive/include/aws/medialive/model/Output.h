...
class Output {
 public:
  ...
  void SetAudioDescriptionNames(AudioDescriptionNamesT&& value) {
    ...
    m_audioDescriptionNames = std::forward<AudioDescriptionNamesT>(value);
  }
  template <typename AudioDescriptionNamesT = Aws::Vector<Aws::String>>
  Output& WithAudioDescriptionNames(AudioDescriptionNamesT&& value) {
    SetAudioDescriptionNames(std::forward<AudioDescriptionNamesT>(value));
    return *this;
  }
  template <typename AudioDescriptionNamesT = Aws::String>
  Output& AddAudioDescriptionNames(AudioDescriptionNamesT&& value) {
    m_audioDescriptionNamesHasBeenSet = true;
    m_audioDescriptionNames.emplace_back(std::forward<AudioDescriptionNamesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCaptionDescriptionNames(CaptionDescriptionNamesT&& value) {
    ...
    m_captionDescriptionNames = std::forward<CaptionDescriptionNamesT>(value);
  }
  template <typename CaptionDescriptionNamesT = Aws::Vector<Aws::String>>
  Output& WithCaptionDescriptionNames(CaptionDescriptionNamesT&& value) {
    SetCaptionDescriptionNames(std::forward<CaptionDescriptionNamesT>(value));
    return *this;
  }
  template <typename CaptionDescriptionNamesT = Aws::String>
  Output& AddCaptionDescriptionNames(CaptionDescriptionNamesT&& value) {
    m_captionDescriptionNamesHasBeenSet = true;
    m_captionDescriptionNames.emplace_back(std::forward<CaptionDescriptionNamesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVideoDescriptionName(VideoDescriptionNameT&& value) {
    ...
    m_videoDescriptionName = std::forward<VideoDescriptionNameT>(value);
  }
  template <typename VideoDescriptionNameT = Aws::String>
  Output& WithVideoDescriptionName(VideoDescriptionNameT&& value) {
    SetVideoDescriptionName(std::forward<VideoDescriptionNameT>(value));
    return *this;
  }
  ///@}
 private:
