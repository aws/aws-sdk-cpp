...
class ScheduleActionStartSettings {
 public:
   ...
   */
  inline const FixedModeScheduleActionStartSettings& GetFixedModeScheduleActionStartSettings() const {
    return m_fixedModeScheduleActionStartSettings;
  }
  ...
  void SetFixedModeScheduleActionStartSettings(FixedModeScheduleActionStartSettingsT&& value) {
    ...
    m_fixedModeScheduleActionStartSettings = std::forward<FixedModeScheduleActionStartSettingsT>(value);
  }
  template <typename FixedModeScheduleActionStartSettingsT = FixedModeScheduleActionStartSettings>
  ScheduleActionStartSettings& WithFixedModeScheduleActionStartSettings(FixedModeScheduleActionStartSettingsT&& value) {
    SetFixedModeScheduleActionStartSettings(std::forward<FixedModeScheduleActionStartSettingsT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const FollowModeScheduleActionStartSettings& GetFollowModeScheduleActionStartSettings() const {
    return m_followModeScheduleActionStartSettings;
  }
  ...
  void SetFollowModeScheduleActionStartSettings(FollowModeScheduleActionStartSettingsT&& value) {
    ...
    m_followModeScheduleActionStartSettings = std::forward<FollowModeScheduleActionStartSettingsT>(value);
  }
  template <typename FollowModeScheduleActionStartSettingsT = FollowModeScheduleActionStartSettings>
  ScheduleActionStartSettings& WithFollowModeScheduleActionStartSettings(FollowModeScheduleActionStartSettingsT&& value) {
    SetFollowModeScheduleActionStartSettings(std::forward<FollowModeScheduleActionStartSettingsT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const ImmediateModeScheduleActionStartSettings& GetImmediateModeScheduleActionStartSettings() const {
    return m_immediateModeScheduleActionStartSettings;
  }
  ...
  void SetImmediateModeScheduleActionStartSettings(ImmediateModeScheduleActionStartSettingsT&& value) {
    ...
    m_immediateModeScheduleActionStartSettings = std::forward<ImmediateModeScheduleActionStartSettingsT>(value);
  }
  template <typename ImmediateModeScheduleActionStartSettingsT = ImmediateModeScheduleActionStartSettings>
  ScheduleActionStartSettings& WithImmediateModeScheduleActionStartSettings(ImmediateModeScheduleActionStartSettingsT&& value) {
    SetImmediateModeScheduleActionStartSettings(std::forward<ImmediateModeScheduleActionStartSettingsT>(value));
    return *this;
  }
  ///@}
 private:
