...
class Scte35SpliceInsert {
 public:
  ...
  inline Scte35SpliceInsert& WithAdAvailOffset(int value) {
  ...
  inline void SetNoRegionalBlackoutFlag(Scte35SpliceInsertNoRegionalBlackoutBehavior value) {
    m_noRegionalBlackoutFlagHasBeenSet = true;
    m_noRegionalBlackoutFlag = value;
  }
  inline Scte35SpliceInsert& WithNoRegionalBlackoutFlag(Scte35SpliceInsertNoRegionalBlackoutBehavior value) {
  ...
  inline void SetWebDeliveryAllowedFlag(Scte35SpliceInsertWebDeliveryAllowedBehavior value) {
    m_webDeliveryAllowedFlagHasBeenSet = true;
    m_webDeliveryAllowedFlag = value;
  }
  inline Scte35SpliceInsert& WithWebDeliveryAllowedFlag(Scte35SpliceInsertWebDeliveryAllowedBehavior value) {
