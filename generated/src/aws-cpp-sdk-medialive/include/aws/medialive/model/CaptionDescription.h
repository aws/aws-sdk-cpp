...
class CaptionDescription {
 public:
  ...
  inline void SetAccessibility(AccessibilityType value) {
    m_accessibilityHasBeenSet = true;
    m_accessibility = value;
  }
  inline CaptionDescription& WithAccessibility(AccessibilityType value) {
  ...
  void SetCaptionDashRoles(CaptionDashRolesT&& value) {
    ...
    m_captionDashRoles = std::forward<CaptionDashRolesT>(value);
  }
  template <typename CaptionDashRolesT = Aws::Vector<DashRoleCaption>>
  CaptionDescription& WithCaptionDashRoles(CaptionDashRolesT&& value) {
    SetCaptionDashRoles(std::forward<CaptionDashRolesT>(value));
    return *this;
  }
  inline CaptionDescription& AddCaptionDashRoles(DashRoleCaption value) {
    m_captionDashRolesHasBeenSet = true;
    m_captionDashRoles.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline CaptionDescription& WithDvbDashAccessibility(DvbDashAccessibility value) {
