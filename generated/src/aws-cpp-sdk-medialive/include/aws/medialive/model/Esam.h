...
class Esam {
 public:
  ...
  inline Esam& WithAdAvailOffset(int value) {
  ...
  void SetPoisEndpoint(PoisEndpointT&& value) {
    ...
    m_poisEndpoint = std::forward<PoisEndpointT>(value);
  }
  template <typename PoisEndpointT = Aws::String>
  Esam& WithPoisEndpoint(PoisEndpointT&& value) {
    SetPoisEndpoint(std::forward<PoisEndpointT>(value));
    return *this;
  }
  ///@}
  ...
  void SetZoneIdentity(ZoneIdentityT&& value) {
    ...
    m_zoneIdentity = std::forward<ZoneIdentityT>(value);
  }
  template <typename ZoneIdentityT = Aws::String>
  Esam& WithZoneIdentity(ZoneIdentityT&& value) {
    SetZoneIdentity(std::forward<ZoneIdentityT>(value));
    return *this;
  }
  ///@}
 private:
