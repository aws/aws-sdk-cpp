...
class ScheduleAction {
 public:
  ...
  void SetScheduleActionSettings(ScheduleActionSettingsT&& value) {
    ...
    m_scheduleActionSettings = std::forward<ScheduleActionSettingsT>(value);
  }
  template <typename ScheduleActionSettingsT = ScheduleActionSettings>
  ScheduleAction& WithScheduleActionSettings(ScheduleActionSettingsT&& value) {
    SetScheduleActionSettings(std::forward<ScheduleActionSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetScheduleActionStartSettings(ScheduleActionStartSettingsT&& value) {
    ...
    m_scheduleActionStartSettings = std::forward<ScheduleActionStartSettingsT>(value);
  }
  template <typename ScheduleActionStartSettingsT = ScheduleActionStartSettings>
  ScheduleAction& WithScheduleActionStartSettings(ScheduleActionStartSettingsT&& value) {
    SetScheduleActionStartSettings(std::forward<ScheduleActionStartSettingsT>(value));
    return *this;
  }
  ///@}
 private:
