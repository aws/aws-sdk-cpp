...
class NielsenConfiguration {
 public:
  ...
  inline void SetNielsenPcmToId3Tagging(NielsenPcmToId3TaggingState value) {
    m_nielsenPcmToId3TaggingHasBeenSet = true;
    m_nielsenPcmToId3Tagging = value;
  }
  inline NielsenConfiguration& WithNielsenPcmToId3Tagging(NielsenPcmToId3TaggingState value) {
    SetNielsenPcmToId3Tagging(value);
    return *this;
  }
  ///@}
 private:
