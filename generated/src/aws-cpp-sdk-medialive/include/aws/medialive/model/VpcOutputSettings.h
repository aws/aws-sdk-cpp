...
Must specify one for SINGLE_PIPELINE, two for STANDARD
  ...
  void SetPublicAddressAllocationIds(PublicAddressAllocationIdsT&& value) {
    ...
    m_publicAddressAllocationIds = std::forward<PublicAddressAllocationIdsT>(value);
  }
  template <typename PublicAddressAllocationIdsT = Aws::Vector<Aws::String>>
  VpcOutputSettings& WithPublicAddressAllocationIds(PublicAddressAllocationIdsT&& value) {
    SetPublicAddressAllocationIds(std::forward<PublicAddressAllocationIdsT>(value));
    return *this;
  }
  ...
  VpcOutputSettings& AddPublicAddressAllocationIds(PublicAddressAllocationIdsT&& value) {
    m_publicAddressAllocationIdsHasBeenSet = true;
    m_publicAddressAllocationIds.emplace_back(std::forward<PublicAddressAllocationIdsT>(value));
    return *this;
  }
  ///@}
