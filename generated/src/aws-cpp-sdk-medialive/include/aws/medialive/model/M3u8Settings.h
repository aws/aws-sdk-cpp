...
class M3u8Settings {
 public:
  ...
  inline void SetNielsenId3Behavior(M3u8NielsenId3Behavior value) {
    m_nielsenId3BehaviorHasBeenSet = true;
    m_nielsenId3Behavior = value;
  }
  inline M3u8Settings& WithNielsenId3Behavior(M3u8NielsenId3Behavior value) {
  ...
  inline M3u8Settings& WithPcrPeriod(int value) {
    SetPcrPeriod(value);
    return *this;
  }
  ///@}
  ...
  inline M3u8Settings& WithProgramNum(int value) {
    SetProgramNum(value);
    return *this;
  }
  ///@}
  ...
  inline void SetScte35Behavior(M3u8Scte35Behavior value) {
    m_scte35BehaviorHasBeenSet = true;
    m_scte35Behavior = value;
  }
  inline M3u8Settings& WithScte35Behavior(M3u8Scte35Behavior value) {
    SetScte35Behavior(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTimedMetadataBehavior(M3u8TimedMetadataBehavior value) {
    m_timedMetadataBehaviorHasBeenSet = true;
    m_timedMetadataBehavior = value;
  }
  inline M3u8Settings& WithTimedMetadataBehavior(M3u8TimedMetadataBehavior value) {
  ...
  inline void SetKlvBehavior(M3u8KlvBehavior value) {
    m_klvBehaviorHasBeenSet = true;
    m_klvBehavior = value;
  }
  inline M3u8Settings& WithKlvBehavior(M3u8KlvBehavior value) {
