...
class CreateMultiplexProgramRequest : public MediaLiveRequest {
 public:
  ...
  template <typename MultiplexIdT = Aws::String>
  CreateMultiplexProgramRequest& WithMultiplexId(MultiplexIdT&& value) {
  ...
  template <typename MultiplexProgramSettingsT = MultiplexProgramSettings>
  CreateMultiplexProgramRequest& WithMultiplexProgramSettings(MultiplexProgramSettingsT&& value) {
  ...
  template <typename ProgramNameT = Aws::String>
  CreateMultiplexProgramRequest& WithProgramName(ProgramNameT&& value) {
...
resources.
  ...
  template <typename RequestIdT = Aws::String>
  CreateMultiplexProgramRequest& WithRequestId(RequestIdT&& value) {
