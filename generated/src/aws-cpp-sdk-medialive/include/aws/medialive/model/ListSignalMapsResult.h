...
class ListSignalMapsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListSignalMapsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetSignalMaps(SignalMapsT&& value) {
    m_signalMapsHasBeenSet = true;
    m_signalMaps = std::forward<SignalMapsT>(value);
  }
  template <typename SignalMapsT = Aws::Vector<SignalMapSummary>>
  ListSignalMapsResult& WithSignalMaps(SignalMapsT&& value) {
    SetSignalMaps(std::forward<SignalMapsT>(value));
    return *this;
  }
  template <typename SignalMapsT = SignalMapSummary>
  ListSignalMapsResult& AddSignalMaps(SignalMapsT&& value) {
    m_signalMapsHasBeenSet = true;
    m_signalMaps.emplace_back(std::forward<SignalMapsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListSignalMapsResult& WithRequestId(RequestIdT&& value) {
