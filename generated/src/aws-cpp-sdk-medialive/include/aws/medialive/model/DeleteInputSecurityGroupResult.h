...
namespace Model
{
  ...
  {
  public:
    AWS_MEDIALIVE_API DeleteInputSecurityGroupResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteInputSecurityGroupResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
