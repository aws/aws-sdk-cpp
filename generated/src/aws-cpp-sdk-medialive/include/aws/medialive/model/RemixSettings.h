...
class RemixSettings {
 public:
  ...
  void SetChannelMappings(ChannelMappingsT&& value) {
    ...
    m_channelMappings = std::forward<ChannelMappingsT>(value);
  }
  template <typename ChannelMappingsT = Aws::Vector<AudioChannelMapping>>
  RemixSettings& WithChannelMappings(ChannelMappingsT&& value) {
    SetChannelMappings(std::forward<ChannelMappingsT>(value));
    return *this;
  }
  template <typename ChannelMappingsT = AudioChannelMapping>
  RemixSettings& AddChannelMappings(ChannelMappingsT&& value) {
    m_channelMappingsHasBeenSet = true;
    m_channelMappings.emplace_back(std::forward<ChannelMappingsT>(value));
    return *this;
  }
  ///@}
