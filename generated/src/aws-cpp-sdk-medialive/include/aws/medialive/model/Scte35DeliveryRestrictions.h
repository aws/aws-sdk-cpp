...
class Scte35DeliveryRestrictions {
 public:
  ...
  inline void SetArchiveAllowedFlag(Scte35ArchiveAllowedFlag value) {
    m_archiveAllowedFlagHasBeenSet = true;
    m_archiveAllowedFlag = value;
  }
  inline Scte35DeliveryRestrictions& WithArchiveAllowedFlag(Scte35ArchiveAllowedFlag value) {
    SetArchiveAllowedFlag(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDeviceRestrictions(Scte35DeviceRestrictions value) {
    m_deviceRestrictionsHasBeenSet = true;
    m_deviceRestrictions = value;
  }
  inline Scte35DeliveryRestrictions& WithDeviceRestrictions(Scte35DeviceRestrictions value) {
    SetDeviceRestrictions(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNoRegionalBlackoutFlag(Scte35NoRegionalBlackoutFlag value) {
    m_noRegionalBlackoutFlagHasBeenSet = true;
    m_noRegionalBlackoutFlag = value;
  }
  inline Scte35DeliveryRestrictions& WithNoRegionalBlackoutFlag(Scte35NoRegionalBlackoutFlag value) {
    SetNoRegionalBlackoutFlag(value);
    return *this;
  }
  ///@}
  ...
  inline void SetWebDeliveryAllowedFlag(Scte35WebDeliveryAllowedFlag value) {
    m_webDeliveryAllowedFlagHasBeenSet = true;
    m_webDeliveryAllowedFlag = value;
  }
  inline Scte35DeliveryRestrictions& WithWebDeliveryAllowedFlag(Scte35WebDeliveryAllowedFlag value) {
    SetWebDeliveryAllowedFlag(value);
    return *this;
  }
  ///@}
 private:
