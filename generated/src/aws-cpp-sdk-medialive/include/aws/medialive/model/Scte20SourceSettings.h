...
class Scte20SourceSettings {
 public:
  ...
  inline void SetConvert608To708(Scte20Convert608To708 value) {
    m_convert608To708HasBeenSet = true;
    m_convert608To708 = value;
  }
  inline Scte20SourceSettings& WithConvert608To708(Scte20Convert608To708 value) {
  ...
  inline void SetSource608ChannelNumber(int value) {
    m_source608ChannelNumberHasBeenSet = true;
    m_source608ChannelNumber = value;
  }
  inline Scte20SourceSettings& WithSource608ChannelNumber(int value) {
    SetSource608ChannelNumber(value);
    return *this;
  }
  ///@}
 private:
