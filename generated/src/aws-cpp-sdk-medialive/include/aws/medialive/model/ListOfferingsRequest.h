...
namespace Model
{
  ...
  public:
    ...
    template<typename ChannelClassT = Aws::String>
    ListOfferingsRequest& WithChannelClass(ChannelClassT&& value) { SetChannelClass(std::forward<ChannelClassT>(value)); return *this;}
    ///@}
    ...
    template<typename ChannelConfigurationT = Aws::String>
    ...
    template<typename ChannelConfigurationT = Aws::String>
    ListOfferingsRequest& WithChannelConfiguration(ChannelConfigurationT&& value) { SetChannelConfiguration(std::forward<ChannelConfigurationT>(value)); return *this;}
    ///@}
    ...
    template<typename CodecT = Aws::String>
    ListOfferingsRequest& WithCodec(CodecT&& value) { SetCodec(std::forward<CodecT>(value)); return *this;}
    ///@}
    ...
    template<typename DurationT = Aws::String>
    ListOfferingsRequest& WithDuration(DurationT&& value) { SetDuration(std::forward<DurationT>(value)); return *this;}
    ///@}
    ...
    template<typename MaximumBitrateT = Aws::String>
    ListOfferingsRequest& WithMaximumBitrate(MaximumBitrateT&& value) { SetMaximumBitrate(std::forward<MaximumBitrateT>(value)); return *this;}
    ///@}
    ...
    template<typename MaximumFramerateT = Aws::String>
    ListOfferingsRequest& WithMaximumFramerate(MaximumFramerateT&& value) { SetMaximumFramerate(std::forward<MaximumFramerateT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListOfferingsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename ResolutionT = Aws::String>
    ListOfferingsRequest& WithResolution(ResolutionT&& value) { SetResolution(std::forward<ResolutionT>(value)); return *this;}
    ///@}
    ...
    template<typename ResourceTypeT = Aws::String>
    ListOfferingsRequest& WithResourceType(ResourceTypeT&& value) { SetResourceType(std::forward<ResourceTypeT>(value)); return *this;}
    ///@}
    ...
    template<typename SpecialFeatureT = Aws::String>
    ListOfferingsRequest& WithSpecialFeature(SpecialFeatureT&& value) { SetSpecialFeature(std::forward<SpecialFeatureT>(value)); return *this;}
    ///@}
    ...
    template<typename VideoQualityT = Aws::String>
    ListOfferingsRequest& WithVideoQuality(VideoQualityT&& value) { SetVideoQuality(std::forward<VideoQualityT>(value)); return *this;}
    ///@}
  private:
