...
class UpdateNodeResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  UpdateNodeResult& WithArn(ArnT&& value) {
  ...
  template <typename ChannelPlacementGroupsT = Aws::Vector<Aws::String>>
  UpdateNodeResult& WithChannelPlacementGroups(ChannelPlacementGroupsT&& value) {
    SetChannelPlacementGroups(std::forward<ChannelPlacementGroupsT>(value));
    return *this;
  }
  template <typename ChannelPlacementGroupsT = Aws::String>
  UpdateNodeResult& AddChannelPlacementGroups(ChannelPlacementGroupsT&& value) {
    m_channelPlacementGroupsHasBeenSet = true;
  ...
  template <typename ClusterIdT = Aws::String>
  UpdateNodeResult& WithClusterId(ClusterIdT&& value) {
  ...
  inline UpdateNodeResult& WithConnectionState(NodeConnectionState value) {
  ...
  template <typename IdT = Aws::String>
  UpdateNodeResult& WithId(IdT&& value) {
  ...
  template <typename InstanceArnT = Aws::String>
  UpdateNodeResult& WithInstanceArn(InstanceArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  UpdateNodeResult& WithName(NameT&& value) {
  ...
  template <typename NodeInterfaceMappingsT = Aws::Vector<NodeInterfaceMapping>>
  UpdateNodeResult& WithNodeInterfaceMappings(NodeInterfaceMappingsT&& value) {
  ...
  UpdateNodeResult& AddNodeInterfaceMappings(NodeInterfaceMappingsT&& value) {
    m_nodeInterfaceMappingsHasBeenSet = true;
  ...
  inline UpdateNodeResult& WithRole(NodeRole value) {
    SetRole(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateNodeResult& WithState(NodeState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename SdiSourceMappingsT = Aws::Vector<SdiSourceMapping>>
  UpdateNodeResult& WithSdiSourceMappings(SdiSourceMappingsT&& value) {
    SetSdiSourceMappings(std::forward<SdiSourceMappingsT>(value));
    return *this;
  }
  template <typename SdiSourceMappingsT = SdiSourceMapping>
  UpdateNodeResult& AddSdiSourceMappings(SdiSourceMappingsT&& value) {
    m_sdiSourceMappingsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  UpdateNodeResult& WithRequestId(RequestIdT&& value) {
