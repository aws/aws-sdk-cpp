...
namespace Model
{
  ...
  {
  public:
    AWS_MEDIALIVE_API DeleteReservationRequest() = default;
    ...
    template<typename ReservationIdT = Aws::String>
    DeleteReservationRequest& WithReservationId(ReservationIdT&& value) { SetReservationId(std::forward<ReservationIdT>(value)); return *this;}
    ///@}
  private:
