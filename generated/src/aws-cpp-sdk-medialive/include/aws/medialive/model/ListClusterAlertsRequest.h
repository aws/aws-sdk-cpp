...
class ListClusterAlertsRequest : public MediaLiveRequest {
 public:
  ...
  template <typename ClusterIdT = Aws::String>
  ListClusterAlertsRequest& WithClusterId(ClusterIdT&& value) {
  ...
  inline ListClusterAlertsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListClusterAlertsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename StateFilterT = Aws::String>
  ListClusterAlertsRequest& WithStateFilter(StateFilterT&& value) {
