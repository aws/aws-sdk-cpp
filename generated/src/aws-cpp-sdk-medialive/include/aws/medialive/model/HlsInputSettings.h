...
class HlsInputSettings {
 public:
  ...
  inline void SetBandwidth(int value) {
    m_bandwidthHasBeenSet = true;
    m_bandwidth = value;
  }
  inline HlsInputSettings& WithBandwidth(int value) {
    SetBandwidth(value);
    return *this;
  }
  ///@}
  ...
  inline void SetBufferSegments(int value) {
    m_bufferSegmentsHasBeenSet = true;
    m_bufferSegments = value;
  }
  inline HlsInputSettings& WithBufferSegments(int value) {
    SetBufferSegments(value);
    return *this;
  }
  ///@}
  ...
  inline HlsInputSettings& WithRetries(int value) {
    SetRetries(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRetryInterval(int value) {
    m_retryIntervalHasBeenSet = true;
    m_retryInterval = value;
  }
  inline HlsInputSettings& WithRetryInterval(int value) {
  ...
  inline void SetScte35Source(HlsScte35SourceType value) {
    m_scte35SourceHasBeenSet = true;
    m_scte35Source = value;
  }
  inline HlsInputSettings& WithScte35Source(HlsScte35SourceType value) {
