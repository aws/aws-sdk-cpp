...
class InputSdpLocation {
 public:
  ...
  inline void SetMediaIndex(int value) {
    m_mediaIndexHasBeenSet = true;
    m_mediaIndex = value;
  }
  inline InputSdpLocation& WithMediaIndex(int value) {
    SetMediaIndex(value);
    return *this;
  }
  ///@}
  ...
  void SetSdpUrl(SdpUrlT&& value) {
    m_sdpUrlHasBeenSet = true;
    m_sdpUrl = std::forward<SdpUrlT>(value);
  }
  template <typename SdpUrlT = Aws::String>
  InputSdpLocation& WithSdpUrl(SdpUrlT&& value) {
    SetSdpUrl(std::forward<SdpUrlT>(value));
    return *this;
  }
  ///@}
 private:
