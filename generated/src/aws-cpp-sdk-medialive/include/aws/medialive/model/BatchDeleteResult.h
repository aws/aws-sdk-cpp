...
class BatchDeleteResult {
 public:
  ...
  template <typename FailedT = Aws::Vector<BatchFailedResultModel>>
  BatchDeleteResult& WithFailed(FailedT&& value) {
    SetFailed(std::forward<FailedT>(value));
    return *this;
  }
  template <typename FailedT = BatchFailedResultModel>
  BatchDeleteResult& AddFailed(FailedT&& value) {
    m_failedHasBeenSet = true;
  ...
  template <typename SuccessfulT = Aws::Vector<BatchSuccessfulResultModel>>
  BatchDeleteResult& WithSuccessful(SuccessfulT&& value) {
    SetSuccessful(std::forward<SuccessfulT>(value));
    return *this;
  }
  template <typename SuccessfulT = BatchSuccessfulResultModel>
  BatchDeleteResult& AddSuccessful(SuccessfulT&& value) {
    m_successfulHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  BatchDeleteResult& WithRequestId(RequestIdT&& value) {
