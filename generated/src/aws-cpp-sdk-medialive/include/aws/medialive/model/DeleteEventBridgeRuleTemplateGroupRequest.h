...
namespace Model
{
  ...
  {
  public:
    AWS_MEDIALIVE_API DeleteEventBridgeRuleTemplateGroupRequest() = default;
    ...
    template<typename IdentifierT = Aws::String>
    DeleteEventBridgeRuleTemplateGroupRequest& WithIdentifier(IdentifierT&& value) { SetIdentifier(std::forward<IdentifierT>(value)); return *this;}
    ///@}
  private:
