...
namespace Model
{
  ...
  public:
    ...
    template<typename TemporalFilterSettingsT = TemporalFilterSettings>
    H265FilterSettings& WithTemporalFilterSettings(TemporalFilterSettingsT&& value) { SetTemporalFilterSettings(std::forward<TemporalFilterSettingsT>(value)); return *this;}
    ///@}
    ...
    template<typename BandwidthReductionFilterSettingsT = BandwidthReductionFilterSettings>
    H265FilterSettings& WithBandwidthReductionFilterSettings(BandwidthReductionFilterSettingsT&& value) { SetBandwidthReductionFilterSettings(std::forward<BandwidthReductionFilterSettingsT>(value)); return *this;}
    ///@}
  private:
