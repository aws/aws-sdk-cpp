...
This field corresponds to
  ...
  inline CaptionRectangle& WithHeight(double value) {
    SetHeight(value);
    return *this;
  }
  ///@}
...
This field corresponds to
  ...
  inline void SetLeftOffset(double value) {
    m_leftOffsetHasBeenSet = true;
    m_leftOffset = value;
  }
  inline CaptionRectangle& WithLeftOffset(double value) {
    SetLeftOffset(value);
    return *this;
  }
  ///@}
...
This field corresponds to tts:origin -
  ...
  inline void SetTopOffset(double value) {
    m_topOffsetHasBeenSet = true;
    m_topOffset = value;
  }
  inline CaptionRectangle& WithTopOffset(double value) {
    SetTopOffset(value);
    return *this;
  }
  ///@}
...
This field corresponds to
  ...
  inline CaptionRectangle& WithWidth(double value) {
    SetWidth(value);
    return *this;
  }
  ///@}
