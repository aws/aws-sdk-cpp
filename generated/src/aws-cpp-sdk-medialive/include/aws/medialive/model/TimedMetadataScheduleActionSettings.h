...
namespace Model
{
  ...
  {
  public:
    AWS_MEDIALIVE_API TimedMetadataScheduleActionSettings();
    ...
    inline TimedMetadataScheduleActionSettings& WithId3(const Aws::String& value) { SetId3(value); return *this;}
    inline TimedMetadataScheduleActionSettings& WithId3(Aws::String&& value) { SetId3(std::move(value)); return *this;}
    inline TimedMetadataScheduleActionSettings& WithId3(const char* value) { SetId3(value); return *this;}
    ///@}
  private:
