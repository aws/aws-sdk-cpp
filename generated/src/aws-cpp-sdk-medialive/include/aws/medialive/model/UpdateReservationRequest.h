...
class UpdateReservationRequest : public MediaLiveRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  UpdateReservationRequest& WithName(NameT&& value) {
  ...
  template <typename RenewalSettingsT = RenewalSettings>
  UpdateReservationRequest& WithRenewalSettings(RenewalSettingsT&& value) {
  ...
  template <typename ReservationIdT = Aws::String>
  UpdateReservationRequest& WithReservationId(ReservationIdT&& value) {
