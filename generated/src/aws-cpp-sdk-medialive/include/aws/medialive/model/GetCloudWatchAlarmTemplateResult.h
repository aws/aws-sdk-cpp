...
class GetCloudWatchAlarmTemplateResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  GetCloudWatchAlarmTemplateResult& WithArn(ArnT&& value) {
  ...
  inline GetCloudWatchAlarmTemplateResult& WithComparisonOperator(CloudWatchAlarmTemplateComparisonOperator value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  GetCloudWatchAlarmTemplateResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  inline GetCloudWatchAlarmTemplateResult& WithDatapointsToAlarm(int value) {
  ...
  template <typename DescriptionT = Aws::String>
  GetCloudWatchAlarmTemplateResult& WithDescription(DescriptionT&& value) {
  ...
  inline GetCloudWatchAlarmTemplateResult& WithEvaluationPeriods(int value) {
  ...
  template <typename GroupIdT = Aws::String>
  GetCloudWatchAlarmTemplateResult& WithGroupId(GroupIdT&& value) {
  ...
  template <typename IdT = Aws::String>
  GetCloudWatchAlarmTemplateResult& WithId(IdT&& value) {
  ...
  template <typename MetricNameT = Aws::String>
  GetCloudWatchAlarmTemplateResult& WithMetricName(MetricNameT&& value) {
  ...
  template <typename ModifiedAtT = Aws::Utils::DateTime>
  GetCloudWatchAlarmTemplateResult& WithModifiedAt(ModifiedAtT&& value) {
  ...
  template <typename NameT = Aws::String>
  GetCloudWatchAlarmTemplateResult& WithName(NameT&& value) {
  ...
  inline GetCloudWatchAlarmTemplateResult& WithPeriod(int value) {
    SetPeriod(value);
    return *this;
  }
  ///@}
  ...
  inline GetCloudWatchAlarmTemplateResult& WithStatistic(CloudWatchAlarmTemplateStatistic value) {
    SetStatistic(value);
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  GetCloudWatchAlarmTemplateResult& WithTags(TagsT&& value) {
  ...
  inline GetCloudWatchAlarmTemplateResult& WithTargetResourceType(CloudWatchAlarmTemplateTargetResourceType value) {
  ...
  inline GetCloudWatchAlarmTemplateResult& WithThreshold(double value) {
    SetThreshold(value);
    return *this;
  }
  ///@}
  ...
  inline GetCloudWatchAlarmTemplateResult& WithTreatMissingData(CloudWatchAlarmTemplateTreatMissingData value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetCloudWatchAlarmTemplateResult& WithRequestId(RequestIdT&& value) {
