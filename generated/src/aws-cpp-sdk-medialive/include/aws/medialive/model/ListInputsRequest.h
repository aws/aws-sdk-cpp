...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class ListInputsRequest : public MediaLiveRequest
  {
  public:
    AWS_MEDIALIVE_API ListInputsRequest() = default;
    ...
    template<typename NextTokenT = Aws::String>
    ListInputsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
