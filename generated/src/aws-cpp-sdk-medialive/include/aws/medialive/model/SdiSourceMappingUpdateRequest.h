...
class SdiSourceMappingUpdateRequest {
 public:
  ...
  inline void SetCardNumber(int value) {
    m_cardNumberHasBeenSet = true;
    m_cardNumber = value;
  }
  inline SdiSourceMappingUpdateRequest& WithCardNumber(int value) {
    SetCardNumber(value);
    return *this;
  }
  ///@}
  ...
  inline void SetChannelNumber(int value) {
    m_channelNumberHasBeenSet = true;
    m_channelNumber = value;
  }
  inline SdiSourceMappingUpdateRequest& WithChannelNumber(int value) {
