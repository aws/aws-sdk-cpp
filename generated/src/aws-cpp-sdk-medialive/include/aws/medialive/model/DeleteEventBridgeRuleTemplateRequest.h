...
namespace Model
{
  ...
  {
  public:
    AWS_MEDIALIVE_API DeleteEventBridgeRuleTemplateRequest() = default;
    ...
    template<typename IdentifierT = Aws::String>
    DeleteEventBridgeRuleTemplateRequest& WithIdentifier(IdentifierT&& value) { SetIdentifier(std::forward<IdentifierT>(value)); return *this;}
    ///@}
  private:
