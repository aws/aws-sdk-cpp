...
class AvailSettings {
 public:
  ...
  template <typename EsamT = Esam>
  AvailSettings& WithEsam(EsamT&& value) {
  ...
  void SetScte35SpliceInsert(Scte35SpliceInsertT&& value) {
    m_scte35SpliceInsertHasBeenSet = true;
    m_scte35SpliceInsert = std::forward<Scte35SpliceInsertT>(value);
  }
  template <typename Scte35SpliceInsertT = Scte35SpliceInsert>
  AvailSettings& WithScte35SpliceInsert(Scte35SpliceInsertT&& value) {
    SetScte35SpliceInsert(std::forward<Scte35SpliceInsertT>(value));
    return *this;
  }
  ///@}
  ...
  void SetScte35TimeSignalApos(Scte35TimeSignalAposT&& value) {
    m_scte35TimeSignalAposHasBeenSet = true;
    m_scte35TimeSignalApos = std::forward<Scte35TimeSignalAposT>(value);
  }
  template <typename Scte35TimeSignalAposT = Scte35TimeSignalApos>
  AvailSettings& WithScte35TimeSignalApos(Scte35TimeSignalAposT&& value) {
    SetScte35TimeSignalApos(std::forward<Scte35TimeSignalAposT>(value));
    return *this;
  }
  ///@}
 private:
