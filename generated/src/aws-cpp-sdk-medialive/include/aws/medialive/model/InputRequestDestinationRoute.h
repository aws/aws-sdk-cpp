 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/medialive-2017-10-14/InputRequestDestinationRoute">AWS
 * API Reference</a></p>
 */
class InputRequestDestinationRoute {
 public:
  ...
  template <typename CidrT = Aws::String>
  InputRequestDestinationRoute& WithCidr(CidrT&& value) {
  ...
  template <typename GatewayT = Aws::String>
  InputRequestDestinationRoute& WithGateway(GatewayT&& value) {
