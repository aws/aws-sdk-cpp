...
namespace Model
{
  ...
  {
  public:
    AWS_MEDIALIVE_API RebootInputDeviceResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    RebootInputDeviceResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
