...
class UdpGroupSettings {
 public:
  ...
  inline void SetInputLossAction(InputLossActionForUdpOut value) {
    m_inputLossActionHasBeenSet = true;
    m_inputLossAction = value;
  }
  inline UdpGroupSettings& WithInputLossAction(InputLossActionForUdpOut value) {
  ...
  inline void SetTimedMetadataId3Frame(UdpTimedMetadataId3Frame value) {
    m_timedMetadataId3FrameHasBeenSet = true;
    m_timedMetadataId3Frame = value;
  }
  inline UdpGroupSettings& WithTimedMetadataId3Frame(UdpTimedMetadataId3Frame value) {
  ...
  inline UdpGroupSettings& WithTimedMetadataId3Period(int value) {
