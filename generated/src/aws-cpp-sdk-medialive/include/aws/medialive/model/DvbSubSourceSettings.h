...
provide the language to consider when translating
  ...
  inline void SetOcrLanguage(DvbSubOcrLanguage value) {
    m_ocrLanguageHasBeenSet = true;
    m_ocrLanguage = value;
  }
  inline DvbSubSourceSettings& WithOcrLanguage(DvbSubOcrLanguage value) {
  ...
  inline DvbSubSourceSettings& WithPid(int value) {
    SetPid(value);
    return *this;
  }
  ///@}
