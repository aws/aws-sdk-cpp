...
class InputDeviceConfigurableSettings {
 public:
  ...
  inline InputDeviceConfigurableSettings& WithConfiguredInput(InputDeviceConfiguredInput value) {
  ...
  inline InputDeviceConfigurableSettings& WithMaxBitrate(int value) {
    SetMaxBitrate(value);
    return *this;
  }
  ///@}
  ...
  inline InputDeviceConfigurableSettings& WithLatencyMs(int value) {
    SetLatencyMs(value);
    return *this;
  }
  ///@}
  ...
  inline InputDeviceConfigurableSettings& WithCodec(InputDeviceCodec value) {
    SetCodec(value);
    return *this;
  }
  ///@}
