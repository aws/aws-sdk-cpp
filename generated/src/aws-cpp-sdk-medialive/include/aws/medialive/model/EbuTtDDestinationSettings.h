...
class EbuTtDDestinationSettings {
 public:
  ...
  void SetCopyrightHolder(CopyrightHolderT&& value) {
    m_copyrightHolderHasBeenSet = true;
    m_copyrightHolder = std::forward<CopyrightHolderT>(value);
  }
  template <typename CopyrightHolderT = Aws::String>
  EbuTtDDestinationSettings& WithCopyrightHolder(CopyrightHolderT&& value) {
    SetCopyrightHolder(std::forward<CopyrightHolderT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetFillLineGap(EbuTtDFillLineGapControl value) {
    m_fillLineGapHasBeenSet = true;
    m_fillLineGap = value;
  }
  inline EbuTtDDestinationSettings& WithFillLineGap(EbuTtDFillLineGapControl value) {
    SetFillLineGap(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStyleControl(EbuTtDDestinationStyleControl value) {
    m_styleControlHasBeenSet = true;
    m_styleControl = value;
  }
  inline EbuTtDDestinationSettings& WithStyleControl(EbuTtDDestinationStyleControl value) {
  ...
  inline void SetDefaultFontSize(int value) {
    m_defaultFontSizeHasBeenSet = true;
    m_defaultFontSize = value;
  }
  inline EbuTtDDestinationSettings& WithDefaultFontSize(int value) {
  ...
  inline void SetDefaultLineHeight(int value) {
    m_defaultLineHeightHasBeenSet = true;
    m_defaultLineHeight = value;
  }
  inline EbuTtDDestinationSettings& WithDefaultLineHeight(int value) {
    SetDefaultLineHeight(value);
    return *this;
  }
  ///@}
 private:
