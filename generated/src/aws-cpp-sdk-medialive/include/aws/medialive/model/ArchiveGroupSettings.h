...
class ArchiveGroupSettings {
 public:
  ...
  void SetArchiveCdnSettings(ArchiveCdnSettingsT&& value) {
    ...
    m_archiveCdnSettings = std::forward<ArchiveCdnSettingsT>(value);
  }
  template <typename ArchiveCdnSettingsT = ArchiveCdnSettings>
  ArchiveGroupSettings& WithArchiveCdnSettings(ArchiveCdnSettingsT&& value) {
    SetArchiveCdnSettings(std::forward<ArchiveCdnSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetRolloverInterval(int value) {
    m_rolloverIntervalHasBeenSet = true;
    m_rolloverInterval = value;
  }
  inline ArchiveGroupSettings& WithRolloverInterval(int value) {
    SetRolloverInterval(value);
    return *this;
  }
  ///@}
 private:
