...
class MultiplexProgramSettings {
 public:
  ...
  inline void SetPreferredChannelPipeline(PreferredChannelPipeline value) {
    m_preferredChannelPipelineHasBeenSet = true;
    m_preferredChannelPipeline = value;
  }
  inline MultiplexProgramSettings& WithPreferredChannelPipeline(PreferredChannelPipeline value) {
    SetPreferredChannelPipeline(value);
    return *this;
  }
  ///@}
  ...
  inline MultiplexProgramSettings& WithProgramNumber(int value) {
  ...
  void SetServiceDescriptor(ServiceDescriptorT&& value) {
    m_serviceDescriptorHasBeenSet = true;
    m_serviceDescriptor = std::forward<ServiceDescriptorT>(value);
  }
  template <typename ServiceDescriptorT = MultiplexProgramServiceDescriptor>
  MultiplexProgramSettings& WithServiceDescriptor(ServiceDescriptorT&& value) {
    SetServiceDescriptor(std::forward<ServiceDescriptorT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVideoSettings(VideoSettingsT&& value) {
    m_videoSettingsHasBeenSet = true;
    m_videoSettings = std::forward<VideoSettingsT>(value);
  }
  template <typename VideoSettingsT = MultiplexVideoSettings>
  MultiplexProgramSettings& WithVideoSettings(VideoSettingsT&& value) {
    SetVideoSettings(std::forward<VideoSettingsT>(value));
    return *this;
  }
  ///@}
 private:
