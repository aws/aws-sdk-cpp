...
namespace Model
{
  ...
  public:
    ...
    template<typename ArnT = Aws::String>
    UpdateInputDeviceResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    inline UpdateInputDeviceResult& WithConnectionState(InputDeviceConnectionState value) { SetConnectionState(value); return *this;}
    ///@}
    ...
    inline UpdateInputDeviceResult& WithDeviceSettingsSyncState(DeviceSettingsSyncState value) { SetDeviceSettingsSyncState(value); return *this;}
    ///@}
    ...
    inline UpdateInputDeviceResult& WithDeviceUpdateStatus(DeviceUpdateStatus value) { SetDeviceUpdateStatus(value); return *this;}
    ///@}
    ...
    template<typename HdDeviceSettingsT = InputDeviceHdSettings>
    UpdateInputDeviceResult& WithHdDeviceSettings(HdDeviceSettingsT&& value) { SetHdDeviceSettings(std::forward<HdDeviceSettingsT>(value)); return *this;}
    ///@}
    ...
    template<typename IdT = Aws::String>
    UpdateInputDeviceResult& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename MacAddressT = Aws::String>
    UpdateInputDeviceResult& WithMacAddress(MacAddressT&& value) { SetMacAddress(std::forward<MacAddressT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    UpdateInputDeviceResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename NetworkSettingsT = InputDeviceNetworkSettings>
    UpdateInputDeviceResult& WithNetworkSettings(NetworkSettingsT&& value) { SetNetworkSettings(std::forward<NetworkSettingsT>(value)); return *this;}
    ///@}
    ...
    template<typename SerialNumberT = Aws::String>
    UpdateInputDeviceResult& WithSerialNumber(SerialNumberT&& value) { SetSerialNumber(std::forward<SerialNumberT>(value)); return *this;}
    ///@}
    ...
    inline UpdateInputDeviceResult& WithType(InputDeviceType value) { SetType(value); return *this;}
    ///@}
    ...
    template<typename UhdDeviceSettingsT = InputDeviceUhdSettings>
    UpdateInputDeviceResult& WithUhdDeviceSettings(UhdDeviceSettingsT&& value) { SetUhdDeviceSettings(std::forward<UhdDeviceSettingsT>(value)); return *this;}
    ///@}
    ...
    template<typename TagsT = Aws::Map<Aws::String, Aws::String>>
    UpdateInputDeviceResult& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
    ...
    template<typename AvailabilityZoneT = Aws::String>
    UpdateInputDeviceResult& WithAvailabilityZone(AvailabilityZoneT&& value) { SetAvailabilityZone(std::forward<AvailabilityZoneT>(value)); return *this;}
    ///@}
    ...
    template<typename MedialiveInputArnsT = Aws::Vector<Aws::String>>
    UpdateInputDeviceResult& WithMedialiveInputArns(MedialiveInputArnsT&& value) { SetMedialiveInputArns(std::forward<MedialiveInputArnsT>(value)); return *this;}
    template<typename MedialiveInputArnsT = Aws::String>
    UpdateInputDeviceResult& AddMedialiveInputArns(MedialiveInputArnsT&& value) { m_medialiveInputArnsHasBeenSet = true; m_medialiveInputArns.emplace_back(std::forward<MedialiveInputArnsT>(value)); return *this; }
    ///@}
    ...
    inline UpdateInputDeviceResult& WithOutputType(InputDeviceOutputType value) { SetOutputType(value); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateInputDeviceResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
