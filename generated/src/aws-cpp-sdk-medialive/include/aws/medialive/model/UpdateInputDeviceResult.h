...
class UpdateInputDeviceResult {
 public:
  ...
  inline UpdateInputDeviceResult& WithConnectionState(InputDeviceConnectionState value) {
  ...
  inline UpdateInputDeviceResult& WithDeviceSettingsSyncState(DeviceSettingsSyncState value) {
  ...
  inline UpdateInputDeviceResult& WithDeviceUpdateStatus(DeviceUpdateStatus value) {
  ...
  inline UpdateInputDeviceResult& WithType(InputDeviceType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateInputDeviceResult& WithOutputType(InputDeviceOutputType value) {
    SetOutputType(value);
    return *this;
  }
  ///@}
