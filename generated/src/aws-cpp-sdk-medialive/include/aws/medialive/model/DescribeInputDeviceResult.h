...
class DescribeInputDeviceResult {
 public:
  ...
  inline void SetConnectionState(InputDeviceConnectionState value) {
    m_connectionStateHasBeenSet = true;
    m_connectionState = value;
  }
  inline DescribeInputDeviceResult& WithConnectionState(InputDeviceConnectionState value) {
  ...
  inline void SetDeviceSettingsSyncState(DeviceSettingsSyncState value) {
    m_deviceSettingsSyncStateHasBeenSet = true;
    m_deviceSettingsSyncState = value;
  }
  inline DescribeInputDeviceResult& WithDeviceSettingsSyncState(DeviceSettingsSyncState value) {
    SetDeviceSettingsSyncState(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDeviceUpdateStatus(DeviceUpdateStatus value) {
    m_deviceUpdateStatusHasBeenSet = true;
    m_deviceUpdateStatus = value;
  }
  inline DescribeInputDeviceResult& WithDeviceUpdateStatus(DeviceUpdateStatus value) {
    SetDeviceUpdateStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetHdDeviceSettings(HdDeviceSettingsT&& value) {
    ...
    m_hdDeviceSettings = std::forward<HdDeviceSettingsT>(value);
  }
  template <typename HdDeviceSettingsT = InputDeviceHdSettings>
  DescribeInputDeviceResult& WithHdDeviceSettings(HdDeviceSettingsT&& value) {
    SetHdDeviceSettings(std::forward<HdDeviceSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetType(InputDeviceType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline DescribeInputDeviceResult& WithType(InputDeviceType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetUhdDeviceSettings(UhdDeviceSettingsT&& value) {
    ...
    m_uhdDeviceSettings = std::forward<UhdDeviceSettingsT>(value);
  }
  template <typename UhdDeviceSettingsT = InputDeviceUhdSettings>
  DescribeInputDeviceResult& WithUhdDeviceSettings(UhdDeviceSettingsT&& value) {
    SetUhdDeviceSettings(std::forward<UhdDeviceSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMedialiveInputArns(MedialiveInputArnsT&& value) {
    ...
    m_medialiveInputArns = std::forward<MedialiveInputArnsT>(value);
  }
  template <typename MedialiveInputArnsT = Aws::Vector<Aws::String>>
  DescribeInputDeviceResult& WithMedialiveInputArns(MedialiveInputArnsT&& value) {
    SetMedialiveInputArns(std::forward<MedialiveInputArnsT>(value));
    return *this;
  }
  ...
  DescribeInputDeviceResult& AddMedialiveInputArns(MedialiveInputArnsT&& value) {
    m_medialiveInputArnsHasBeenSet = true;
    m_medialiveInputArns.emplace_back(std::forward<MedialiveInputArnsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetOutputType(InputDeviceOutputType value) {
    m_outputTypeHasBeenSet = true;
    m_outputType = value;
  }
  inline DescribeInputDeviceResult& WithOutputType(InputDeviceOutputType value) {
    SetOutputType(value);
    return *this;
  }
  ///@}
