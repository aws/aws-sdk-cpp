...
class ListChannelPlacementGroupsRequest : public MediaLiveRequest {
 public:
  ...
  template <typename ClusterIdT = Aws::String>
  ListChannelPlacementGroupsRequest& WithClusterId(ClusterIdT&& value) {
  ...
  inline ListChannelPlacementGroupsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListChannelPlacementGroupsRequest& WithNextToken(NextTokenT&& value) {
