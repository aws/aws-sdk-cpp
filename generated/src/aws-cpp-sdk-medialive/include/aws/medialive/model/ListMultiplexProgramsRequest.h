...
class ListMultiplexProgramsRequest : public MediaLiveRequest {
 public:
  ...
  inline ListMultiplexProgramsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename MultiplexIdT = Aws::String>
  ListMultiplexProgramsRequest& WithMultiplexId(MultiplexIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListMultiplexProgramsRequest& WithNextToken(NextTokenT&& value) {
