...
class VideoSelector {
 public:
  ...
  inline void SetColorSpace(VideoSelectorColorSpace value) {
    m_colorSpaceHasBeenSet = true;
    m_colorSpace = value;
  }
  inline VideoSelector& WithColorSpace(VideoSelectorColorSpace value) {
    SetColorSpace(value);
    return *this;
  }
  ///@}
  ...
  inline void SetColorSpaceUsage(VideoSelectorColorSpaceUsage value) {
    m_colorSpaceUsageHasBeenSet = true;
    m_colorSpaceUsage = value;
  }
  inline VideoSelector& WithColorSpaceUsage(VideoSelectorColorSpaceUsage value) {
