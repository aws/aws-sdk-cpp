...
class DescribeInputDeviceThumbnailResult {
 public:
  ...
  inline DescribeInputDeviceThumbnailResult& WithContentType(ContentType value) {
  ...
  inline DescribeInputDeviceThumbnailResult& WithContentLength(long long value) {
