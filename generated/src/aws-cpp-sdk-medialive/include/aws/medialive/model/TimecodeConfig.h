...
-Start at 0 (zerobased): The time of the first frame of the event
  ...
  inline void SetSource(TimecodeConfigSource value) {
    m_sourceHasBeenSet = true;
    m_source = value;
  }
  inline TimecodeConfig& WithSource(TimecodeConfigSource value) {
    SetSource(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSyncThreshold(int value) {
    m_syncThresholdHasBeenSet = true;
    m_syncThreshold = value;
  }
  inline TimecodeConfig& WithSyncThreshold(int value) {
