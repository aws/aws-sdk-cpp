...
class Id3SegmentTaggingScheduleActionSettings {
 public:
  ...
  void SetId3(Id3T&& value) {
    m_id3HasBeenSet = true;
    m_id3 = std::forward<Id3T>(value);
  }
  template <typename Id3T = Aws::String>
  Id3SegmentTaggingScheduleActionSettings& WithId3(Id3T&& value) {
    SetId3(std::forward<Id3T>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TagT = Aws::String>
  Id3SegmentTaggingScheduleActionSettings& WithTag(TagT&& value) {
