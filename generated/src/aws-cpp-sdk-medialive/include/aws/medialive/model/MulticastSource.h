...
namespace Model
{
  ...
  {
  public:
    AWS_MEDIALIVE_API MulticastSource();
    ...
    inline MulticastSource& WithSourceIp(const Aws::String& value) { SetSourceIp(value); return *this;}
    inline MulticastSource& WithSourceIp(Aws::String&& value) { SetSourceIp(std::move(value)); return *this;}
    inline MulticastSource& WithSourceIp(const char* value) { SetSourceIp(value); return *this;}
    ///@}
    ...
    inline MulticastSource& WithUrl(const Aws::String& value) { SetUrl(value); return *this;}
    inline MulticastSource& WithUrl(Aws::String&& value) { SetUrl(std::move(value)); return *this;}
    inline MulticastSource& WithUrl(const char* value) { SetUrl(value); return *this;}
    ///@}
  private:
