...
class StaticKeySettings {
 public:
  ...
  void SetKeyProviderServer(KeyProviderServerT&& value) {
    m_keyProviderServerHasBeenSet = true;
    m_keyProviderServer = std::forward<KeyProviderServerT>(value);
  }
  template <typename KeyProviderServerT = InputLocation>
  StaticKeySettings& WithKeyProviderServer(KeyProviderServerT&& value) {
    SetKeyProviderServer(std::forward<KeyProviderServerT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename StaticKeyValueT = Aws::String>
  StaticKeySettings& WithStaticKeyValue(StaticKeyValueT&& value) {
