...
class VideoBlackFailoverSettings {
 public:
  ...
  inline void SetBlackDetectThreshold(double value) {
    m_blackDetectThresholdHasBeenSet = true;
    m_blackDetectThreshold = value;
  }
  inline VideoBlackFailoverSettings& WithBlackDetectThreshold(double value) {
    SetBlackDetectThreshold(value);
    return *this;
  }
  ///@}
  ...
  inline void SetVideoBlackThresholdMsec(int value) {
    m_videoBlackThresholdMsecHasBeenSet = true;
    m_videoBlackThresholdMsec = value;
  }
  inline VideoBlackFailoverSettings& WithVideoBlackThresholdMsec(int value) {
    SetVideoBlackThresholdMsec(value);
    return *this;
  }
  ///@}
 private:
