...
class WavSettings {
 public:
  ...
  inline void SetBitDepth(double value) {
    m_bitDepthHasBeenSet = true;
    m_bitDepth = value;
  }
  inline WavSettings& WithBitDepth(double value) {
    SetBitDepth(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCodingMode(WavCodingMode value) {
    m_codingModeHasBeenSet = true;
    m_codingMode = value;
  }
  inline WavSettings& WithCodingMode(WavCodingMode value) {
    SetCodingMode(value);
    return *this;
  }
  ///@}
  ...
  inline WavSettings& WithSampleRate(double value) {
    SetSampleRate(value);
    return *this;
  }
  ///@}
