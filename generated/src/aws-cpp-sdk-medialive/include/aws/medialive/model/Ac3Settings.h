...
class Ac3Settings {
 public:
  ...
  inline Ac3Settings& WithBitrate(double value) {
    SetBitrate(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDrcProfile(Ac3DrcProfile value) {
    m_drcProfileHasBeenSet = true;
    m_drcProfile = value;
  }
  inline Ac3Settings& WithDrcProfile(Ac3DrcProfile value) {
    SetDrcProfile(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAttenuationControl(Ac3AttenuationControl value) {
    m_attenuationControlHasBeenSet = true;
    m_attenuationControl = value;
  }
  inline Ac3Settings& WithAttenuationControl(Ac3AttenuationControl value) {
