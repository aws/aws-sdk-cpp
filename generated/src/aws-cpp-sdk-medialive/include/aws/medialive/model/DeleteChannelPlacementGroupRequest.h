...
namespace Model
{
  ...
  public:
    ...
    template<typename ChannelPlacementGroupIdT = Aws::String>
    DeleteChannelPlacementGroupRequest& WithChannelPlacementGroupId(ChannelPlacementGroupIdT&& value) { SetChannelPlacementGroupId(std::forward<ChannelPlacementGroupIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ClusterIdT = Aws::String>
    DeleteChannelPlacementGroupRequest& WithClusterId(ClusterIdT&& value) { SetClusterId(std::forward<ClusterIdT>(value)); return *this;}
    ///@}
  private:
