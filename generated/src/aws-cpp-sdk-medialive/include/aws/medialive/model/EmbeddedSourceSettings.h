...
class EmbeddedSourceSettings {
 public:
  ...
  inline void SetConvert608To708(EmbeddedConvert608To708 value) {
    m_convert608To708HasBeenSet = true;
    m_convert608To708 = value;
  }
  inline EmbeddedSourceSettings& WithConvert608To708(EmbeddedConvert608To708 value) {
  ...
  inline void SetScte20Detection(EmbeddedScte20Detection value) {
    m_scte20DetectionHasBeenSet = true;
    m_scte20Detection = value;
  }
  inline EmbeddedSourceSettings& WithScte20Detection(EmbeddedScte20Detection value) {
    SetScte20Detection(value);
    return *this;
  }
  ///@}
  ...
  inline EmbeddedSourceSettings& WithSource608ChannelNumber(int value) {
  ...
  inline void SetSource608TrackNumber(int value) {
    m_source608TrackNumberHasBeenSet = true;
    m_source608TrackNumber = value;
  }
  inline EmbeddedSourceSettings& WithSource608TrackNumber(int value) {
    SetSource608TrackNumber(value);
    return *this;
  }
  ///@}
 private:
