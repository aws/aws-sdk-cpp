...
namespace Model
{
  ...
  {
  public:
    AWS_MEDIALIVE_API DescribeMultiplexRequest() = default;
    ...
    template<typename MultiplexIdT = Aws::String>
    DescribeMultiplexRequest& WithMultiplexId(MultiplexIdT&& value) { SetMultiplexId(std::forward<MultiplexIdT>(value)); return *this;}
    ///@}
  private:
