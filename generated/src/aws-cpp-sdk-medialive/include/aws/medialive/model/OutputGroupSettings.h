...
class OutputGroupSettings {
 public:
  ...
  void SetArchiveGroupSettings(ArchiveGroupSettingsT&& value) {
    ...
    m_archiveGroupSettings = std::forward<ArchiveGroupSettingsT>(value);
  }
  template <typename ArchiveGroupSettingsT = ArchiveGroupSettings>
  OutputGroupSettings& WithArchiveGroupSettings(ArchiveGroupSettingsT&& value) {
    SetArchiveGroupSettings(std::forward<ArchiveGroupSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFrameCaptureGroupSettings(FrameCaptureGroupSettingsT&& value) {
    ...
    m_frameCaptureGroupSettings = std::forward<FrameCaptureGroupSettingsT>(value);
  }
  template <typename FrameCaptureGroupSettingsT = FrameCaptureGroupSettings>
  OutputGroupSettings& WithFrameCaptureGroupSettings(FrameCaptureGroupSettingsT&& value) {
    SetFrameCaptureGroupSettings(std::forward<FrameCaptureGroupSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetHlsGroupSettings(HlsGroupSettingsT&& value) {
    ...
    m_hlsGroupSettings = std::forward<HlsGroupSettingsT>(value);
  }
  template <typename HlsGroupSettingsT = HlsGroupSettings>
  OutputGroupSettings& WithHlsGroupSettings(HlsGroupSettingsT&& value) {
    SetHlsGroupSettings(std::forward<HlsGroupSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMediaPackageGroupSettings(MediaPackageGroupSettingsT&& value) {
    ...
    m_mediaPackageGroupSettings = std::forward<MediaPackageGroupSettingsT>(value);
  }
  template <typename MediaPackageGroupSettingsT = MediaPackageGroupSettings>
  OutputGroupSettings& WithMediaPackageGroupSettings(MediaPackageGroupSettingsT&& value) {
    SetMediaPackageGroupSettings(std::forward<MediaPackageGroupSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMsSmoothGroupSettings(MsSmoothGroupSettingsT&& value) {
    ...
    m_msSmoothGroupSettings = std::forward<MsSmoothGroupSettingsT>(value);
  }
  template <typename MsSmoothGroupSettingsT = MsSmoothGroupSettings>
  OutputGroupSettings& WithMsSmoothGroupSettings(MsSmoothGroupSettingsT&& value) {
    SetMsSmoothGroupSettings(std::forward<MsSmoothGroupSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMultiplexGroupSettings(MultiplexGroupSettingsT&& value) {
    ...
    m_multiplexGroupSettings = std::forward<MultiplexGroupSettingsT>(value);
  }
  template <typename MultiplexGroupSettingsT = MultiplexGroupSettings>
  OutputGroupSettings& WithMultiplexGroupSettings(MultiplexGroupSettingsT&& value) {
    SetMultiplexGroupSettings(std::forward<MultiplexGroupSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRtmpGroupSettings(RtmpGroupSettingsT&& value) {
    ...
    m_rtmpGroupSettings = std::forward<RtmpGroupSettingsT>(value);
  }
  template <typename RtmpGroupSettingsT = RtmpGroupSettings>
  OutputGroupSettings& WithRtmpGroupSettings(RtmpGroupSettingsT&& value) {
    SetRtmpGroupSettings(std::forward<RtmpGroupSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUdpGroupSettings(UdpGroupSettingsT&& value) {
    ...
    m_udpGroupSettings = std::forward<UdpGroupSettingsT>(value);
  }
  template <typename UdpGroupSettingsT = UdpGroupSettings>
  OutputGroupSettings& WithUdpGroupSettings(UdpGroupSettingsT&& value) {
    SetUdpGroupSettings(std::forward<UdpGroupSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCmafIngestGroupSettings(CmafIngestGroupSettingsT&& value) {
    ...
    m_cmafIngestGroupSettings = std::forward<CmafIngestGroupSettingsT>(value);
  }
  template <typename CmafIngestGroupSettingsT = CmafIngestGroupSettings>
  OutputGroupSettings& WithCmafIngestGroupSettings(CmafIngestGroupSettingsT&& value) {
    SetCmafIngestGroupSettings(std::forward<CmafIngestGroupSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSrtGroupSettings(SrtGroupSettingsT&& value) {
    ...
    m_srtGroupSettings = std::forward<SrtGroupSettingsT>(value);
  }
  template <typename SrtGroupSettingsT = SrtGroupSettings>
  OutputGroupSettings& WithSrtGroupSettings(SrtGroupSettingsT&& value) {
    SetSrtGroupSettings(std::forward<SrtGroupSettingsT>(value));
    return *this;
  }
  ///@}
 private:
