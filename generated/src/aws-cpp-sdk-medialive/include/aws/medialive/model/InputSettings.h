...
class InputSettings {
 public:
  ...
  InputSettings& AddAudioSelectors(AudioSelectorsT&& value) {
    m_audioSelectorsHasBeenSet = true;
    m_audioSelectors.emplace_back(std::forward<AudioSelectorsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCaptionSelectors(CaptionSelectorsT&& value) {
    ...
    m_captionSelectors = std::forward<CaptionSelectorsT>(value);
  }
  template <typename CaptionSelectorsT = Aws::Vector<CaptionSelector>>
  InputSettings& WithCaptionSelectors(CaptionSelectorsT&& value) {
    SetCaptionSelectors(std::forward<CaptionSelectorsT>(value));
    return *this;
  }
  template <typename CaptionSelectorsT = CaptionSelector>
  InputSettings& AddCaptionSelectors(CaptionSelectorsT&& value) {
    m_captionSelectorsHasBeenSet = true;
    m_captionSelectors.emplace_back(std::forward<CaptionSelectorsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetDeblockFilter(InputDeblockFilter value) {
    m_deblockFilterHasBeenSet = true;
    m_deblockFilter = value;
  }
  inline InputSettings& WithDeblockFilter(InputDeblockFilter value) {
    SetDeblockFilter(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDenoiseFilter(InputDenoiseFilter value) {
    m_denoiseFilterHasBeenSet = true;
    m_denoiseFilter = value;
  }
  inline InputSettings& WithDenoiseFilter(InputDenoiseFilter value) {
    SetDenoiseFilter(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFilterStrength(int value) {
    m_filterStrengthHasBeenSet = true;
    m_filterStrength = value;
  }
  inline InputSettings& WithFilterStrength(int value) {
...
3) forced -
  ...
  inline void SetInputFilter(InputFilter value) {
    m_inputFilterHasBeenSet = true;
    m_inputFilter = value;
  }
  inline InputSettings& WithInputFilter(InputFilter value) {
  ...
  void SetNetworkInputSettings(NetworkInputSettingsT&& value) {
    ...
    m_networkInputSettings = std::forward<NetworkInputSettingsT>(value);
  }
  template <typename NetworkInputSettingsT = NetworkInputSettings>
  InputSettings& WithNetworkInputSettings(NetworkInputSettingsT&& value) {
    SetNetworkInputSettings(std::forward<NetworkInputSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  inline InputSettings& WithScte35Pid(int value) {
    SetScte35Pid(value);
    return *this;
  }
  ///@}
...
- IGNORE: Never extract any ancillary data
  ...
  inline void SetSmpte2038DataPreference(Smpte2038DataPreference value) {
    m_smpte2038DataPreferenceHasBeenSet = true;
    m_smpte2038DataPreference = value;
  }
  inline InputSettings& WithSmpte2038DataPreference(Smpte2038DataPreference value) {
    SetSmpte2038DataPreference(value);
    return *this;
  }
  ///@}
  ...
  void SetVideoSelector(VideoSelectorT&& value) {
    ...
    m_videoSelector = std::forward<VideoSelectorT>(value);
  }
  template <typename VideoSelectorT = VideoSelector>
  InputSettings& WithVideoSelector(VideoSelectorT&& value) {
    SetVideoSelector(std::forward<VideoSelectorT>(value));
    return *this;
  }
  ///@}
 private:
