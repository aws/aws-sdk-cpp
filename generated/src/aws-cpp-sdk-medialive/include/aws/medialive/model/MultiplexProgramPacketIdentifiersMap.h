...
class MultiplexProgramPacketIdentifiersMap {
 public:
  ...
  inline MultiplexProgramPacketIdentifiersMap& AddAudioPids(int value) {
    m_audioPidsHasBeenSet = true;
  ...
  inline MultiplexProgramPacketIdentifiersMap& AddDvbSubPids(int value) {
    m_dvbSubPidsHasBeenSet = true;
  ...
  inline MultiplexProgramPacketIdentifiersMap& WithDvbTeletextPid(int value) {
  ...
  inline void SetEtvPlatformPid(int value) {
    m_etvPlatformPidHasBeenSet = true;
    m_etvPlatformPid = value;
  }
  inline MultiplexProgramPacketIdentifiersMap& WithEtvPlatformPid(int value) {
    SetEtvPlatformPid(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEtvSignalPid(int value) {
    m_etvSignalPidHasBeenSet = true;
    m_etvSignalPid = value;
  }
  inline MultiplexProgramPacketIdentifiersMap& WithEtvSignalPid(int value) {
    SetEtvSignalPid(value);
    return *this;
  }
  ///@}
  ...
  inline MultiplexProgramPacketIdentifiersMap& AddKlvDataPids(int value) {
    m_klvDataPidsHasBeenSet = true;
    m_klvDataPids.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline MultiplexProgramPacketIdentifiersMap& WithPcrPid(int value) {
    SetPcrPid(value);
    return *this;
  }
  ///@}
  ...
  inline MultiplexProgramPacketIdentifiersMap& WithPmtPid(int value) {
    SetPmtPid(value);
    return *this;
  }
  ///@}
  ...
  inline MultiplexProgramPacketIdentifiersMap& WithPrivateMetadataPid(int value) {
  ...
  inline MultiplexProgramPacketIdentifiersMap& AddScte27Pids(int value) {
    m_scte27PidsHasBeenSet = true;
    m_scte27Pids.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline MultiplexProgramPacketIdentifiersMap& WithScte35Pid(int value) {
    SetScte35Pid(value);
    return *this;
  }
  ///@}
  ...
  inline MultiplexProgramPacketIdentifiersMap& WithTimedMetadataPid(int value) {
  ...
  inline MultiplexProgramPacketIdentifiersMap& WithVideoPid(int value) {
    SetVideoPid(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAribCaptionsPid(int value) {
    m_aribCaptionsPidHasBeenSet = true;
    m_aribCaptionsPid = value;
  }
  inline MultiplexProgramPacketIdentifiersMap& WithAribCaptionsPid(int value) {
    SetAribCaptionsPid(value);
    return *this;
  }
  ///@}
  ...
  void SetDvbTeletextPids(DvbTeletextPidsT&& value) {
    m_dvbTeletextPidsHasBeenSet = true;
    m_dvbTeletextPids = std::forward<DvbTeletextPidsT>(value);
  }
  template <typename DvbTeletextPidsT = Aws::Vector<int>>
  MultiplexProgramPacketIdentifiersMap& WithDvbTeletextPids(DvbTeletextPidsT&& value) {
    SetDvbTeletextPids(std::forward<DvbTeletextPidsT>(value));
    return *this;
  }
  inline MultiplexProgramPacketIdentifiersMap& AddDvbTeletextPids(int value) {
    m_dvbTeletextPidsHasBeenSet = true;
    m_dvbTeletextPids.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEcmPid(int value) {
    m_ecmPidHasBeenSet = true;
    m_ecmPid = value;
  }
  inline MultiplexProgramPacketIdentifiersMap& WithEcmPid(int value) {
    SetEcmPid(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSmpte2038Pid(int value) {
    m_smpte2038PidHasBeenSet = true;
    m_smpte2038Pid = value;
  }
  inline MultiplexProgramPacketIdentifiersMap& WithSmpte2038Pid(int value) {
    SetSmpte2038Pid(value);
    return *this;
  }
  ///@}
 private:
