...
class InputDeviceSummary {
 public:
  ...
  inline InputDeviceSummary& WithConnectionState(InputDeviceConnectionState value) {
  ...
  inline InputDeviceSummary& WithDeviceSettingsSyncState(DeviceSettingsSyncState value) {
  ...
  inline InputDeviceSummary& WithDeviceUpdateStatus(DeviceUpdateStatus value) {
  ...
  inline InputDeviceSummary& WithType(InputDeviceType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline InputDeviceSummary& WithOutputType(InputDeviceOutputType value) {
    SetOutputType(value);
    return *this;
  }
  ///@}
