...
class CloudWatchAlarmTemplateSummary {
 public:
  ...
  inline CloudWatchAlarmTemplateSummary& WithComparisonOperator(CloudWatchAlarmTemplateComparisonOperator value) {
  ...
  inline CloudWatchAlarmTemplateSummary& WithDatapointsToAlarm(int value) {
  ...
  inline CloudWatchAlarmTemplateSummary& WithEvaluationPeriods(int value) {
  ...
  template <typename IdT = Aws::String>
  CloudWatchAlarmTemplateSummary& WithId(IdT&& value) {
  ...
  inline CloudWatchAlarmTemplateSummary& WithPeriod(int value) {
    SetPeriod(value);
    return *this;
  }
  ///@}
  ...
  inline CloudWatchAlarmTemplateSummary& WithStatistic(CloudWatchAlarmTemplateStatistic value) {
    SetStatistic(value);
    return *this;
  }
  ///@}
  ...
  inline CloudWatchAlarmTemplateSummary& WithTargetResourceType(CloudWatchAlarmTemplateTargetResourceType value) {
  ...
  inline CloudWatchAlarmTemplateSummary& WithThreshold(double value) {
    SetThreshold(value);
    return *this;
  }
  ///@}
  ...
  inline CloudWatchAlarmTemplateSummary& WithTreatMissingData(CloudWatchAlarmTemplateTreatMissingData value) {
