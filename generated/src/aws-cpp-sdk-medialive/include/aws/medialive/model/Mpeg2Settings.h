...
FIXED: MediaLive will use
  ...
  inline Mpeg2Settings& WithAfdSignaling(AfdSignaling value) {
  ...
  inline void SetColorMetadata(Mpeg2ColorMetadata value) {
    m_colorMetadataHasBeenSet = true;
    m_colorMetadata = value;
  }
  inline Mpeg2Settings& WithColorMetadata(Mpeg2ColorMetadata value) {
...
AUTO:Convert all content that is SD to
  ...
  inline void SetColorSpace(Mpeg2ColorSpace value) {
    m_colorSpaceHasBeenSet = true;
    m_colorSpace = value;
  }
  inline Mpeg2Settings& WithColorSpace(Mpeg2ColorSpace value) {
    SetColorSpace(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDisplayAspectRatio(Mpeg2DisplayRatio value) {
    m_displayAspectRatioHasBeenSet = true;
    m_displayAspectRatio = value;
  }
  inline Mpeg2Settings& WithDisplayAspectRatio(Mpeg2DisplayRatio value) {
...
When the
  ...
  inline Mpeg2Settings& WithFixedAfd(FixedAfd value) {
    SetFixedAfd(value);
    return *this;
  }
  ///@}
  ...
  inline Mpeg2Settings& WithGopNumBFrames(int value) {
...
If gopSizeUnits is seconds, the gopSize must be greater than
  ...
  inline void SetScanType(Mpeg2ScanType value) {
    m_scanTypeHasBeenSet = true;
    m_scanType = value;
  }
  inline Mpeg2Settings& WithScanType(Mpeg2ScanType value) {
    SetScanType(value);
    return *this;
  }
  ///@}
...
DYNAMIC: Let MediaLive optimize the number of B-frames in each
  ...
  inline void SetSubgopLength(Mpeg2SubGopLength value) {
    m_subgopLengthHasBeenSet = true;
    m_subgopLength = value;
  }
  inline Mpeg2Settings& WithSubgopLength(Mpeg2SubGopLength value) {
...
GOP_TIMECODE: Include timecode
  ...
  inline void SetTimecodeInsertion(Mpeg2TimecodeInsertionBehavior value) {
    m_timecodeInsertionHasBeenSet = true;
    m_timecodeInsertion = value;
  }
  inline Mpeg2Settings& WithTimecodeInsertion(Mpeg2TimecodeInsertionBehavior value) {
