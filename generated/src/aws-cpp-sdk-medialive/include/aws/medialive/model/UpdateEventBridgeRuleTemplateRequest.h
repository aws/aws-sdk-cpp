...
class UpdateEventBridgeRuleTemplateRequest : public MediaLiveRequest {
 public:
  ...
  inline UpdateEventBridgeRuleTemplateRequest& WithEventType(EventBridgeRuleTemplateEventType value) {
    SetEventType(value);
    return *this;
  }
  ///@}
  ...
  template <typename NameT = Aws::String>
  UpdateEventBridgeRuleTemplateRequest& WithName(NameT&& value) {
