...
class NielsenWatermarksSettings {
 public:
  ...
  void SetNielsenCbetSettings(NielsenCbetSettingsT&& value) {
    ...
    m_nielsenCbetSettings = std::forward<NielsenCbetSettingsT>(value);
  }
  template <typename NielsenCbetSettingsT = NielsenCBET>
  NielsenWatermarksSettings& WithNielsenCbetSettings(NielsenCbetSettingsT&& value) {
    SetNielsenCbetSettings(std::forward<NielsenCbetSettingsT>(value));
    return *this;
  }
  ///@}
...
- FINAL_DISTRIBUTOR
  ...
  inline void SetNielsenDistributionType(NielsenWatermarksDistributionTypes value) {
    m_nielsenDistributionTypeHasBeenSet = true;
    m_nielsenDistributionType = value;
  }
  inline NielsenWatermarksSettings& WithNielsenDistributionType(NielsenWatermarksDistributionTypes value) {
    SetNielsenDistributionType(value);
    return *this;
  }
  ///@}
  ...
  void SetNielsenNaesIiNwSettings(NielsenNaesIiNwSettingsT&& value) {
    ...
    m_nielsenNaesIiNwSettings = std::forward<NielsenNaesIiNwSettingsT>(value);
  }
  template <typename NielsenNaesIiNwSettingsT = NielsenNaesIiNw>
  NielsenWatermarksSettings& WithNielsenNaesIiNwSettings(NielsenNaesIiNwSettingsT&& value) {
    SetNielsenNaesIiNwSettings(std::forward<NielsenNaesIiNwSettingsT>(value));
    return *this;
  }
  ///@}
 private:
