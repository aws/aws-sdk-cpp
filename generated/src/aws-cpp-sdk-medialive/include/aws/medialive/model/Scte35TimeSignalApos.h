...
class Scte35TimeSignalApos {
 public:
  ...
  inline Scte35TimeSignalApos& WithAdAvailOffset(int value) {
  ...
  inline void SetNoRegionalBlackoutFlag(Scte35AposNoRegionalBlackoutBehavior value) {
    m_noRegionalBlackoutFlagHasBeenSet = true;
    m_noRegionalBlackoutFlag = value;
  }
  inline Scte35TimeSignalApos& WithNoRegionalBlackoutFlag(Scte35AposNoRegionalBlackoutBehavior value) {
  ...
  inline void SetWebDeliveryAllowedFlag(Scte35AposWebDeliveryAllowedBehavior value) {
    m_webDeliveryAllowedFlagHasBeenSet = true;
    m_webDeliveryAllowedFlag = value;
  }
  inline Scte35TimeSignalApos& WithWebDeliveryAllowedFlag(Scte35AposWebDeliveryAllowedBehavior value) {
