...
class InputDeviceHdSettings {
 public:
  ...
  inline InputDeviceHdSettings& WithActiveInput(InputDeviceActiveInput value) {
  ...
  inline InputDeviceHdSettings& WithConfiguredInput(InputDeviceConfiguredInput value) {
  ...
  inline InputDeviceHdSettings& WithDeviceState(InputDeviceState value) {
  ...
  inline InputDeviceHdSettings& WithFramerate(double value) {
    SetFramerate(value);
    return *this;
  }
  ///@}
  ...
  inline InputDeviceHdSettings& WithHeight(int value) {
    SetHeight(value);
    return *this;
  }
  ///@}
  ...
  inline InputDeviceHdSettings& WithMaxBitrate(int value) {
    SetMaxBitrate(value);
    return *this;
  }
  ///@}
  ...
  inline InputDeviceHdSettings& WithScanType(InputDeviceScanType value) {
    SetScanType(value);
    return *this;
  }
  ///@}
  ...
  inline InputDeviceHdSettings& WithWidth(int value) {
    SetWidth(value);
    return *this;
  }
  ///@}
  ...
  inline InputDeviceHdSettings& WithLatencyMs(int value) {
    SetLatencyMs(value);
    return *this;
  }
  ///@}
