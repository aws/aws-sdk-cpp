...
class FecOutputSettings {
 public:
  ...
  inline void SetColumnDepth(int value) {
    m_columnDepthHasBeenSet = true;
    m_columnDepth = value;
  }
  inline FecOutputSettings& WithColumnDepth(int value) {
  ...
  inline void SetIncludeFec(FecOutputIncludeFec value) {
    m_includeFecHasBeenSet = true;
    m_includeFec = value;
  }
  inline FecOutputSettings& WithIncludeFec(FecOutputIncludeFec value) {
    SetIncludeFec(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRowLength(int value) {
    m_rowLengthHasBeenSet = true;
    m_rowLength = value;
  }
  inline FecOutputSettings& WithRowLength(int value) {
    SetRowLength(value);
    return *this;
  }
  ///@}
