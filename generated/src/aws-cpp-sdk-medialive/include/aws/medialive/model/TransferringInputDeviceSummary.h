...
class TransferringInputDeviceSummary {
 public:
  ...
  template <typename IdT = Aws::String>
  TransferringInputDeviceSummary& WithId(IdT&& value) {
  ...
  inline void SetTransferType(InputDeviceTransferType value) {
    m_transferTypeHasBeenSet = true;
    m_transferType = value;
  }
  inline TransferringInputDeviceSummary& WithTransferType(InputDeviceTransferType value) {
