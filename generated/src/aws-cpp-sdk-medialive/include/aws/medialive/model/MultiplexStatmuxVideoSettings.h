...
class MultiplexStatmuxVideoSettings {
 public:
  ...
  inline void SetMaximumBitrate(int value) {
    m_maximumBitrateHasBeenSet = true;
    m_maximumBitrate = value;
  }
  inline MultiplexStatmuxVideoSettings& WithMaximumBitrate(int value) {
  ...
  inline void SetMinimumBitrate(int value) {
    m_minimumBitrateHasBeenSet = true;
    m_minimumBitrate = value;
  }
  inline MultiplexStatmuxVideoSettings& WithMinimumBitrate(int value) {
    SetMinimumBitrate(value);
    return *this;
  }
  ///@}
  ...
  inline MultiplexStatmuxVideoSettings& WithPriority(int value) {
    SetPriority(value);
    return *this;
  }
  ///@}
