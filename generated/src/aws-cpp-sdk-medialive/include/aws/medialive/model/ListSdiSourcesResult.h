...
class ListSdiSourcesResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListSdiSourcesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename SdiSourcesT = Aws::Vector<SdiSourceSummary>>
  ListSdiSourcesResult& WithSdiSources(SdiSourcesT&& value) {
    SetSdiSources(std::forward<SdiSourcesT>(value));
    return *this;
  }
  template <typename SdiSourcesT = SdiSourceSummary>
  ListSdiSourcesResult& AddSdiSources(SdiSourcesT&& value) {
    m_sdiSourcesHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListSdiSourcesResult& WithRequestId(RequestIdT&& value) {
