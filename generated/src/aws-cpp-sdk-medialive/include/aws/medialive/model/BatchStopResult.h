...
namespace Model
{
  ...
  {
  public:
    AWS_MEDIALIVE_API BatchStopResult() = default;
    ...
    template<typename FailedT = Aws::Vector<BatchFailedResultModel>>
    BatchStopResult& WithFailed(FailedT&& value) { SetFailed(std::forward<FailedT>(value)); return *this;}
    template<typename FailedT = BatchFailedResultModel>
    BatchStopResult& AddFailed(FailedT&& value) { m_failedHasBeenSet = true; m_failed.emplace_back(std::forward<FailedT>(value)); return *this; }
    ///@}
    ...
    template<typename SuccessfulT = Aws::Vector<BatchSuccessfulResultModel>>
    BatchStopResult& WithSuccessful(SuccessfulT&& value) { SetSuccessful(std::forward<SuccessfulT>(value)); return *this;}
    template<typename SuccessfulT = BatchSuccessfulResultModel>
    BatchStopResult& AddSuccessful(SuccessfulT&& value) { m_successfulHasBeenSet = true; m_successful.emplace_back(std::forward<SuccessfulT>(value)); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    BatchStopResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
