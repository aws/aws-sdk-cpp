...
class DeleteReservationResult {
 public:
  ...
  inline DeleteReservationResult& WithCount(int value) {
    SetCount(value);
    return *this;
  }
  ///@}
  ...
  inline DeleteReservationResult& WithDuration(int value) {
    SetDuration(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDurationUnits(OfferingDurationUnits value) {
    m_durationUnitsHasBeenSet = true;
    m_durationUnits = value;
  }
  inline DeleteReservationResult& WithDurationUnits(OfferingDurationUnits value) {
  ...
  inline DeleteReservationResult& WithFixedPrice(double value) {
    SetFixedPrice(value);
    return *this;
  }
  ///@}
  ...
  void SetOfferingDescription(OfferingDescriptionT&& value) {
    ...
    m_offeringDescription = std::forward<OfferingDescriptionT>(value);
  }
  template <typename OfferingDescriptionT = Aws::String>
  DeleteReservationResult& WithOfferingDescription(OfferingDescriptionT&& value) {
    SetOfferingDescription(std::forward<OfferingDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetOfferingType(OfferingType value) {
    m_offeringTypeHasBeenSet = true;
    m_offeringType = value;
  }
  inline DeleteReservationResult& WithOfferingType(OfferingType value) {
  ...
  void SetRenewalSettings(RenewalSettingsT&& value) {
    ...
    m_renewalSettings = std::forward<RenewalSettingsT>(value);
  }
  template <typename RenewalSettingsT = RenewalSettings>
  DeleteReservationResult& WithRenewalSettings(RenewalSettingsT&& value) {
    SetRenewalSettings(std::forward<RenewalSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetState(ReservationState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline DeleteReservationResult& WithState(ReservationState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline DeleteReservationResult& WithUsagePrice(double value) {
    SetUsagePrice(value);
    return *this;
  }
  ///@}
