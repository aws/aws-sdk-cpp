...
namespace Model
{
  ...
  public:
    ...
    template<typename ArnT = Aws::String>
    DeleteReservationResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename CurrencyCodeT = Aws::String>
    DeleteReservationResult& WithCurrencyCode(CurrencyCodeT&& value) { SetCurrencyCode(std::forward<CurrencyCodeT>(value)); return *this;}
    ///@}
    ...
    inline DeleteReservationResult& WithDurationUnits(OfferingDurationUnits value) { SetDurationUnits(value); return *this;}
    ///@}
    ...
    template<typename EndT = Aws::String>
    DeleteReservationResult& WithEnd(EndT&& value) { SetEnd(std::forward<EndT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    DeleteReservationResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename OfferingDescriptionT = Aws::String>
    DeleteReservationResult& WithOfferingDescription(OfferingDescriptionT&& value) { SetOfferingDescription(std::forward<OfferingDescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename OfferingIdT = Aws::String>
    DeleteReservationResult& WithOfferingId(OfferingIdT&& value) { SetOfferingId(std::forward<OfferingIdT>(value)); return *this;}
    ///@}
    ...
    inline DeleteReservationResult& WithOfferingType(OfferingType value) { SetOfferingType(value); return *this;}
    ///@}
    ...
    template<typename RegionT = Aws::String>
    DeleteReservationResult& WithRegion(RegionT&& value) { SetRegion(std::forward<RegionT>(value)); return *this;}
    ///@}
    ...
    template<typename RenewalSettingsT = RenewalSettings>
    DeleteReservationResult& WithRenewalSettings(RenewalSettingsT&& value) { SetRenewalSettings(std::forward<RenewalSettingsT>(value)); return *this;}
    ///@}
    ...
    template<typename ReservationIdT = Aws::String>
    DeleteReservationResult& WithReservationId(ReservationIdT&& value) { SetReservationId(std::forward<ReservationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ResourceSpecificationT = ReservationResourceSpecification>
    DeleteReservationResult& WithResourceSpecification(ResourceSpecificationT&& value) { SetResourceSpecification(std::forward<ResourceSpecificationT>(value)); return *this;}
    ///@}
    ...
    template<typename StartT = Aws::String>
    DeleteReservationResult& WithStart(StartT&& value) { SetStart(std::forward<StartT>(value)); return *this;}
    ///@}
    ...
    inline DeleteReservationResult& WithState(ReservationState value) { SetState(value); return *this;}
    ///@}
    ...
    template<typename TagsT = Aws::Map<Aws::String, Aws::String>>
    DeleteReservationResult& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
    ...
    template<typename RequestIdT = Aws::String>
    DeleteReservationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
