...
class DeleteMultiplexProgramResult {
 public:
  ...
  template <typename ChannelIdT = Aws::String>
  DeleteMultiplexProgramResult& WithChannelId(ChannelIdT&& value) {
  ...
  template <typename MultiplexProgramSettingsT = MultiplexProgramSettings>
  DeleteMultiplexProgramResult& WithMultiplexProgramSettings(MultiplexProgramSettingsT&& value) {
  ...
  template <typename PacketIdentifiersMapT = MultiplexProgramPacketIdentifiersMap>
  DeleteMultiplexProgramResult& WithPacketIdentifiersMap(PacketIdentifiersMapT&& value) {
  ...
  template <typename PipelineDetailsT = Aws::Vector<MultiplexProgramPipelineDetail>>
  DeleteMultiplexProgramResult& WithPipelineDetails(PipelineDetailsT&& value) {
    SetPipelineDetails(std::forward<PipelineDetailsT>(value));
    return *this;
  }
  template <typename PipelineDetailsT = MultiplexProgramPipelineDetail>
  DeleteMultiplexProgramResult& AddPipelineDetails(PipelineDetailsT&& value) {
    m_pipelineDetailsHasBeenSet = true;
  ...
  template <typename ProgramNameT = Aws::String>
  DeleteMultiplexProgramResult& WithProgramName(ProgramNameT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteMultiplexProgramResult& WithRequestId(RequestIdT&& value) {
