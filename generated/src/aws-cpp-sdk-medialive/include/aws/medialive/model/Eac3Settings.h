...
class Eac3Settings {
 public:
  ...
  inline Eac3Settings& WithBitrate(double value) {
    SetBitrate(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDrcLine(Eac3DrcLine value) {
    m_drcLineHasBeenSet = true;
    m_drcLine = value;
  }
  inline Eac3Settings& WithDrcLine(Eac3DrcLine value) {
    SetDrcLine(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDrcRf(Eac3DrcRf value) {
    m_drcRfHasBeenSet = true;
    m_drcRf = value;
  }
  inline Eac3Settings& WithDrcRf(Eac3DrcRf value) {
    SetDrcRf(value);
    return *this;
  }
  ///@}
