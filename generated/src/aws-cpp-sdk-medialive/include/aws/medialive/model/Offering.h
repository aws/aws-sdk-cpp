...
class Offering {
 public:
  ...
  inline Offering& WithDurationUnits(OfferingDurationUnits value) {
  ...
  inline Offering& WithFixedPrice(double value) {
    SetFixedPrice(value);
    return *this;
  }
  ///@}
  ...
  inline Offering& WithOfferingType(OfferingType value) {
  ...
  inline Offering& WithUsagePrice(double value) {
    SetUsagePrice(value);
    return *this;
  }
  ///@}
