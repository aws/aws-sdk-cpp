...
namespace Model
{
  ...
  {
  public:
    AWS_MEDIALIVE_API ListMultiplexesRequest() = default;
    ...
    template<typename NextTokenT = Aws::String>
    ListMultiplexesRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
