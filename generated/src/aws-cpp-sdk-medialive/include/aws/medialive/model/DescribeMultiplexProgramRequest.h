...
namespace Model
{
  ...
  {
  public:
    AWS_MEDIALIVE_API DescribeMultiplexProgramRequest() = default;
    ...
    template<typename MultiplexIdT = Aws::String>
    DescribeMultiplexProgramRequest& WithMultiplexId(MultiplexIdT&& value) { SetMultiplexId(std::forward<MultiplexIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ProgramNameT = Aws::String>
    DescribeMultiplexProgramRequest& WithProgramName(ProgramNameT&& value) { SetProgramName(std::forward<ProgramNameT>(value)); return *this;}
    ///@}
  private:
