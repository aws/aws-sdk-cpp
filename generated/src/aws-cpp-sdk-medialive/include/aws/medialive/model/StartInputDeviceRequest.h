...
/**
 * Placeholder documentation for StartInputDeviceRequest<p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/medialive-2017-10-14/StartInputDeviceRequest">AWS
 * API Reference</a></p>
 */
class StartInputDeviceRequest : public MediaLiveRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "StartInputDevice"; }
  ...
  template <typename InputDeviceIdT = Aws::String>
  StartInputDeviceRequest& WithInputDeviceId(InputDeviceIdT&& value) {
