...
class StartChannelResult {
 public:
  ...
  inline StartChannelResult& WithChannelClass(ChannelClass value) {
...
one destination per
  ...
  inline StartChannelResult& WithLogLevel(LogLevel value) {
    SetLogLevel(value);
    return *this;
  }
  ///@}
  ...
  inline StartChannelResult& WithPipelinesRunningCount(int value) {
  ...
  inline StartChannelResult& WithState(ChannelState value) {
    SetState(value);
    return *this;
  }
  ///@}
