...
class NielsenNaesIiNw {
 public:
  ...
  void SetCheckDigitString(CheckDigitStringT&& value) {
    ...
    m_checkDigitString = std::forward<CheckDigitStringT>(value);
  }
  template <typename CheckDigitStringT = Aws::String>
  NielsenNaesIiNw& WithCheckDigitString(CheckDigitStringT&& value) {
    SetCheckDigitString(std::forward<CheckDigitStringT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetSid(double value) {
    m_sidHasBeenSet = true;
    m_sid = value;
  }
  inline NielsenNaesIiNw& WithSid(double value) {
    SetSid(value);
    return *this;
  }
  ///@}
...
the
  ...
  inline void SetTimezone(NielsenWatermarkTimezones value) {
    m_timezoneHasBeenSet = true;
    m_timezone = value;
  }
  inline NielsenNaesIiNw& WithTimezone(NielsenWatermarkTimezones value) {
    SetTimezone(value);
    return *this;
  }
  ///@}
