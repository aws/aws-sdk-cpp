...
class NodeInterfaceMapping {
 public:
  ...
  inline void SetNetworkInterfaceMode(NetworkInterfaceMode value) {
    m_networkInterfaceModeHasBeenSet = true;
    m_networkInterfaceMode = value;
  }
  inline NodeInterfaceMapping& WithNetworkInterfaceMode(NetworkInterfaceMode value) {
    SetNetworkInterfaceMode(value);
    return *this;
  }
  ///@}
  ...
  void SetPhysicalInterfaceName(PhysicalInterfaceNameT&& value) {
    ...
    m_physicalInterfaceName = std::forward<PhysicalInterfaceNameT>(value);
  }
  template <typename PhysicalInterfaceNameT = Aws::String>
  NodeInterfaceMapping& WithPhysicalInterfaceName(PhysicalInterfaceNameT&& value) {
    SetPhysicalInterfaceName(std::forward<PhysicalInterfaceNameT>(value));
    return *this;
  }
  ///@}
 private:
