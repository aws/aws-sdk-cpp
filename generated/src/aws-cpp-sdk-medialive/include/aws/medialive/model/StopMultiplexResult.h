...
class StopMultiplexResult {
 public:
  ...
  inline StopMultiplexResult& WithPipelinesRunningCount(int value) {
  ...
  inline StopMultiplexResult& WithProgramCount(int value) {
  ...
  inline StopMultiplexResult& WithState(MultiplexState value) {
    SetState(value);
    return *this;
  }
  ///@}
