...
class SdiSourceSummary {
 public:
  ...
  inline SdiSourceSummary& WithMode(SdiSourceMode value) {
    SetMode(value);
    return *this;
  }
  ///@}
  ...
  inline SdiSourceSummary& WithState(SdiSourceState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline SdiSourceSummary& WithType(SdiSourceType value) {
    SetType(value);
    return *this;
  }
  ///@}
