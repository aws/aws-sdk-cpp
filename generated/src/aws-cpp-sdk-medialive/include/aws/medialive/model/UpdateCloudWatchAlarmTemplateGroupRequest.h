...
class UpdateCloudWatchAlarmTemplateGroupRequest : public MediaLiveRequest {
 public:
  ...
  template <typename DescriptionT = Aws::String>
  UpdateCloudWatchAlarmTemplateGroupRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename IdentifierT = Aws::String>
  UpdateCloudWatchAlarmTemplateGroupRequest& WithIdentifier(IdentifierT&& value) {
