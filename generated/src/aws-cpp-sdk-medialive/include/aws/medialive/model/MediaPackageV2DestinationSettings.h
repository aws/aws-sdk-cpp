...
class MediaPackageV2DestinationSettings {
 public:
  ...
  template <typename AudioGroupIdT = Aws::String>
  MediaPackageV2DestinationSettings& WithAudioGroupId(AudioGroupIdT&& value) {
  ...
  template <typename AudioRenditionSetsT = Aws::String>
  MediaPackageV2DestinationSettings& WithAudioRenditionSets(AudioRenditionSetsT&& value) {
...
When you consider all the renditions, follow these
  ...
  inline void SetHlsAutoSelect(HlsAutoSelect value) {
    m_hlsAutoSelectHasBeenSet = true;
    m_hlsAutoSelect = value;
  }
  inline MediaPackageV2DestinationSettings& WithHlsAutoSelect(HlsAutoSelect value) {
    SetHlsAutoSelect(value);
    return *this;
  }
  ///@}
...
When you consider all the renditions, follow these guidelines. You
  ...
  inline void SetHlsDefault(HlsDefault value) {
    m_hlsDefaultHasBeenSet = true;
    m_hlsDefault = value;
  }
  inline MediaPackageV2DestinationSettings& WithHlsDefault(HlsDefault value) {
    SetHlsDefault(value);
    return *this;
  }
  ///@}
