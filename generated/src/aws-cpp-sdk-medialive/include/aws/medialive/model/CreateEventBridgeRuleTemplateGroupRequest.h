...
class CreateEventBridgeRuleTemplateGroupRequest : public MediaLiveRequest {
 public:
  ...
  template <typename DescriptionT = Aws::String>
  CreateEventBridgeRuleTemplateGroupRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateEventBridgeRuleTemplateGroupRequest& WithName(NameT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateEventBridgeRuleTemplateGroupRequest& WithTags(TagsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateEventBridgeRuleTemplateGroupRequest& WithRequestId(RequestIdT&& value) {
