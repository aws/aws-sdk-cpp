...
/**
 * Settings for a follower channel in a linked pair<p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/medialive-2017-10-14/FollowerChannelSettings">AWS
 * API Reference</a></p>
 */
class FollowerChannelSettings {
 public:
  AWS_MEDIALIVE_API FollowerChannelSettings() = default;
  AWS_MEDIALIVE_API FollowerChannelSettings(Aws::Utils::Json::JsonView jsonValue);
  AWS_MEDIALIVE_API FollowerChannelSettings& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  inline FollowerChannelSettings& WithLinkedChannelType(LinkedChannelType value) {
  ...
  template <typename PrimaryChannelArnT = Aws::String>
  FollowerChannelSettings& WithPrimaryChannelArn(PrimaryChannelArnT&& value) {
