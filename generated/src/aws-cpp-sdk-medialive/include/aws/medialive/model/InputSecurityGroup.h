...
class InputSecurityGroup {
 public:
  ...
  template <typename ArnT = Aws::String>
  InputSecurityGroup& WithArn(ArnT&& value) {
  ...
  template <typename IdT = Aws::String>
  InputSecurityGroup& WithId(IdT&& value) {
  ...
  template <typename InputsT = Aws::Vector<Aws::String>>
  InputSecurityGroup& WithInputs(InputsT&& value) {
    SetInputs(std::forward<InputsT>(value));
    return *this;
  }
  template <typename InputsT = Aws::String>
  InputSecurityGroup& AddInputs(InputsT&& value) {
    m_inputsHasBeenSet = true;
  ...
  inline void SetState(InputSecurityGroupState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline InputSecurityGroup& WithState(InputSecurityGroupState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  InputSecurityGroup& WithTags(TagsT&& value) {
  ...
  template <typename WhitelistRulesT = Aws::Vector<InputWhitelistRule>>
  InputSecurityGroup& WithWhitelistRules(WhitelistRulesT&& value) {
    SetWhitelistRules(std::forward<WhitelistRulesT>(value));
    return *this;
  }
  template <typename WhitelistRulesT = InputWhitelistRule>
  InputSecurityGroup& AddWhitelistRules(WhitelistRulesT&& value) {
    m_whitelistRulesHasBeenSet = true;
