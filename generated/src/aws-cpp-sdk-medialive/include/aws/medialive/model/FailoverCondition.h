...
class FailoverCondition {
 public:
  ...
  void SetFailoverConditionSettings(FailoverConditionSettingsT&& value) {
    m_failoverConditionSettingsHasBeenSet = true;
    m_failoverConditionSettings = std::forward<FailoverConditionSettingsT>(value);
  }
  template <typename FailoverConditionSettingsT = FailoverConditionSettings>
  FailoverCondition& WithFailoverConditionSettings(FailoverConditionSettingsT&& value) {
    SetFailoverConditionSettings(std::forward<FailoverConditionSettingsT>(value));
    return *this;
  }
  ///@}
 private:
