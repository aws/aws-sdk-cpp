...
class ListSignalMapsRequest : public MediaLiveRequest {
 public:
  ...
  void SetCloudWatchAlarmTemplateGroupIdentifier(CloudWatchAlarmTemplateGroupIdentifierT&& value) {
    m_cloudWatchAlarmTemplateGroupIdentifierHasBeenSet = true;
    m_cloudWatchAlarmTemplateGroupIdentifier = std::forward<CloudWatchAlarmTemplateGroupIdentifierT>(value);
  }
  template <typename CloudWatchAlarmTemplateGroupIdentifierT = Aws::String>
  ListSignalMapsRequest& WithCloudWatchAlarmTemplateGroupIdentifier(CloudWatchAlarmTemplateGroupIdentifierT&& value) {
    SetCloudWatchAlarmTemplateGroupIdentifier(std::forward<CloudWatchAlarmTemplateGroupIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEventBridgeRuleTemplateGroupIdentifier(EventBridgeRuleTemplateGroupIdentifierT&& value) {
    m_eventBridgeRuleTemplateGroupIdentifierHasBeenSet = true;
    m_eventBridgeRuleTemplateGroupIdentifier = std::forward<EventBridgeRuleTemplateGroupIdentifierT>(value);
  }
  template <typename EventBridgeRuleTemplateGroupIdentifierT = Aws::String>
  ListSignalMapsRequest& WithEventBridgeRuleTemplateGroupIdentifier(EventBridgeRuleTemplateGroupIdentifierT&& value) {
    SetEventBridgeRuleTemplateGroupIdentifier(std::forward<EventBridgeRuleTemplateGroupIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListSignalMapsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListSignalMapsRequest& WithNextToken(NextTokenT&& value) {
