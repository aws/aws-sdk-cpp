...
namespace Model {
/**
 * Placeholder documentation for StartMonitorDeploymentResponse<p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/medialive-2017-10-14/StartMonitorDeploymentResponse">AWS
 * API Reference</a></p>
 */
class StartMonitorDeploymentResult {
 public:
  ...
  template <typename IdT = Aws::String>
  StartMonitorDeploymentResult& WithId(IdT&& value) {
  ...
  inline StartMonitorDeploymentResult& WithMonitorChangesPendingDeployment(bool value) {
  ...
  inline StartMonitorDeploymentResult& WithStatus(SignalMapStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
