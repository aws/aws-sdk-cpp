...
class DescribeChannelPlacementGroupSdkResult {
 public:
  ...
  AWS_MEDIALIVE_API DescribeChannelPlacementGroupSdkResult& operator=(
  ...
  template <typename ArnT = Aws::String>
  DescribeChannelPlacementGroupSdkResult& WithArn(ArnT&& value) {
  ...
  template <typename ChannelsT = Aws::Vector<Aws::String>>
  DescribeChannelPlacementGroupSdkResult& WithChannels(ChannelsT&& value) {
    SetChannels(std::forward<ChannelsT>(value));
    return *this;
  }
  template <typename ChannelsT = Aws::String>
  DescribeChannelPlacementGroupSdkResult& AddChannels(ChannelsT&& value) {
    m_channelsHasBeenSet = true;
  ...
  template <typename ClusterIdT = Aws::String>
  DescribeChannelPlacementGroupSdkResult& WithClusterId(ClusterIdT&& value) {
  ...
  template <typename IdT = Aws::String>
  DescribeChannelPlacementGroupSdkResult& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  DescribeChannelPlacementGroupSdkResult& WithName(NameT&& value) {
  ...
  template <typename NodesT = Aws::Vector<Aws::String>>
  DescribeChannelPlacementGroupSdkResult& WithNodes(NodesT&& value) {
    SetNodes(std::forward<NodesT>(value));
    return *this;
  }
  template <typename NodesT = Aws::String>
  DescribeChannelPlacementGroupSdkResult& AddNodes(NodesT&& value) {
    m_nodesHasBeenSet = true;
  ...
  inline DescribeChannelPlacementGroupSdkResult& WithState(ChannelPlacementGroupState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeChannelPlacementGroupSdkResult& WithRequestId(RequestIdT&& value) {
