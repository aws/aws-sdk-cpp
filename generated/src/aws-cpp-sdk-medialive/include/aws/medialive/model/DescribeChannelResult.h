...
namespace Model
{
  ...
  public:
    ...
    template<typename ArnT = Aws::String>
    DescribeChannelResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename CdiInputSpecificationT = CdiInputSpecification>
    DescribeChannelResult& WithCdiInputSpecification(CdiInputSpecificationT&& value) { SetCdiInputSpecification(std::forward<CdiInputSpecificationT>(value)); return *this;}
    ///@}
    ...
    inline DescribeChannelResult& WithChannelClass(ChannelClass value) { SetChannelClass(value); return *this;}
    ///@}
...
one destination per
    ...
    template<typename DestinationsT = Aws::Vector<OutputDestination>>
    DescribeChannelResult& WithDestinations(DestinationsT&& value) { SetDestinations(std::forward<DestinationsT>(value)); return *this;}
    template<typename DestinationsT = OutputDestination>
    DescribeChannelResult& AddDestinations(DestinationsT&& value) { m_destinationsHasBeenSet = true; m_destinations.emplace_back(std::forward<DestinationsT>(value)); return *this; }
    ///@}
    ...
    template<typename EgressEndpointsT = Aws::Vector<ChannelEgressEndpoint>>
    DescribeChannelResult& WithEgressEndpoints(EgressEndpointsT&& value) { SetEgressEndpoints(std::forward<EgressEndpointsT>(value)); return *this;}
    template<typename EgressEndpointsT = ChannelEgressEndpoint>
    DescribeChannelResult& AddEgressEndpoints(EgressEndpointsT&& value) { m_egressEndpointsHasBeenSet = true; m_egressEndpoints.emplace_back(std::forward<EgressEndpointsT>(value)); return *this; }
    ///@}
    ...
    template<typename EncoderSettingsT = EncoderSettings>
    DescribeChannelResult& WithEncoderSettings(EncoderSettingsT&& value) { SetEncoderSettings(std::forward<EncoderSettingsT>(value)); return *this;}
    ///@}
    ...
    template<typename IdT = Aws::String>
    DescribeChannelResult& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename InputAttachmentsT = Aws::Vector<InputAttachment>>
    DescribeChannelResult& WithInputAttachments(InputAttachmentsT&& value) { SetInputAttachments(std::forward<InputAttachmentsT>(value)); return *this;}
    template<typename InputAttachmentsT = InputAttachment>
    DescribeChannelResult& AddInputAttachments(InputAttachmentsT&& value) { m_inputAttachmentsHasBeenSet = true; m_inputAttachments.emplace_back(std::forward<InputAttachmentsT>(value)); return *this; }
    ///@}
    ...
    template<typename InputSpecificationT = InputSpecification>
    DescribeChannelResult& WithInputSpecification(InputSpecificationT&& value) { SetInputSpecification(std::forward<InputSpecificationT>(value)); return *this;}
    ///@}
    ...
    inline DescribeChannelResult& WithLogLevel(LogLevel value) { SetLogLevel(value); return *this;}
    ///@}
    ...
    template<typename MaintenanceT = MaintenanceStatus>
    DescribeChannelResult& WithMaintenance(MaintenanceT&& value) { SetMaintenance(std::forward<MaintenanceT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    DescribeChannelResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename PipelineDetailsT = Aws::Vector<PipelineDetail>>
    DescribeChannelResult& WithPipelineDetails(PipelineDetailsT&& value) { SetPipelineDetails(std::forward<PipelineDetailsT>(value)); return *this;}
    template<typename PipelineDetailsT = PipelineDetail>
    DescribeChannelResult& AddPipelineDetails(PipelineDetailsT&& value) { m_pipelineDetailsHasBeenSet = true; m_pipelineDetails.emplace_back(std::forward<PipelineDetailsT>(value)); return *this; }
    ///@}
    ...
    template<typename RoleArnT = Aws::String>
    DescribeChannelResult& WithRoleArn(RoleArnT&& value) { SetRoleArn(std::forward<RoleArnT>(value)); return *this;}
    ///@}
    ...
    inline DescribeChannelResult& WithState(ChannelState value) { SetState(value); return *this;}
    ///@}
    ...
    template<typename TagsT = Aws::Map<Aws::String, Aws::String>>
    DescribeChannelResult& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
    ...
    template<typename VpcT = VpcOutputSettingsDescription>
    DescribeChannelResult& WithVpc(VpcT&& value) { SetVpc(std::forward<VpcT>(value)); return *this;}
    ///@}
    ...
    template<typename AnywhereSettingsT = DescribeAnywhereSettings>
    DescribeChannelResult& WithAnywhereSettings(AnywhereSettingsT&& value) { SetAnywhereSettings(std::forward<AnywhereSettingsT>(value)); return *this;}
    ///@}
    ...
    template<typename ChannelEngineVersionT = ChannelEngineVersionResponse>
    DescribeChannelResult& WithChannelEngineVersion(ChannelEngineVersionT&& value) { SetChannelEngineVersion(std::forward<ChannelEngineVersionT>(value)); return *this;}
    ///@}
