...
class DescribeChannelResult {
 public:
  ...
  inline DescribeChannelResult& WithChannelClass(ChannelClass value) {
...
one destination per
  ...
  inline DescribeChannelResult& WithLogLevel(LogLevel value) {
    SetLogLevel(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeChannelResult& WithPipelinesRunningCount(int value) {
  ...
  inline DescribeChannelResult& WithState(ChannelState value) {
    SetState(value);
    return *this;
  }
  ///@}
