...
namespace Model
{
  ...
  {
  public:
    AWS_MEDIALIVE_API GetEventBridgeRuleTemplateGroupRequest() = default;
    ...
    template<typename IdentifierT = Aws::String>
    GetEventBridgeRuleTemplateGroupRequest& WithIdentifier(IdentifierT&& value) { SetIdentifier(std::forward<IdentifierT>(value)); return *this;}
    ///@}
  private:
