...
class AudioLanguageSelection {
 public:
  ...
  template <typename LanguageCodeT = Aws::String>
  AudioLanguageSelection& WithLanguageCode(LanguageCodeT&& value) {
  ...
  inline void SetLanguageSelectionPolicy(AudioLanguageSelectionPolicy value) {
    m_languageSelectionPolicyHasBeenSet = true;
    m_languageSelectionPolicy = value;
  }
  inline AudioLanguageSelection& WithLanguageSelectionPolicy(AudioLanguageSelectionPolicy value) {
    SetLanguageSelectionPolicy(value);
    return *this;
  }
  ///@}
 private:
