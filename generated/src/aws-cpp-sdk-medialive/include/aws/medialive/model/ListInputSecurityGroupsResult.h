...
class ListInputSecurityGroupsResult {
 public:
  ...
  void SetInputSecurityGroups(InputSecurityGroupsT&& value) {
    ...
    m_inputSecurityGroups = std::forward<InputSecurityGroupsT>(value);
  }
  template <typename InputSecurityGroupsT = Aws::Vector<InputSecurityGroup>>
  ListInputSecurityGroupsResult& WithInputSecurityGroups(InputSecurityGroupsT&& value) {
    SetInputSecurityGroups(std::forward<InputSecurityGroupsT>(value));
    return *this;
  }
  template <typename InputSecurityGroupsT = InputSecurityGroup>
  ListInputSecurityGroupsResult& AddInputSecurityGroups(InputSecurityGroupsT&& value) {
    m_inputSecurityGroupsHasBeenSet = true;
    m_inputSecurityGroups.emplace_back(std::forward<InputSecurityGroupsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListInputSecurityGroupsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListInputSecurityGroupsResult& WithRequestId(RequestIdT&& value) {
