...
namespace Model
{
  ...
  {
  public:
    AWS_MEDIALIVE_API MulticastSourceCreateRequest() = default;
    ...
    template<typename SourceIpT = Aws::String>
    MulticastSourceCreateRequest& WithSourceIp(SourceIpT&& value) { SetSourceIp(std::forward<SourceIpT>(value)); return *this;}
    ///@}
    ...
    template<typename UrlT = Aws::String>
    MulticastSourceCreateRequest& WithUrl(UrlT&& value) { SetUrl(std::forward<UrlT>(value)); return *this;}
    ///@}
  private:
