...
class DvbSdtSettings {
 public:
  ...
  inline void SetOutputSdt(DvbSdtOutputSdt value) {
    m_outputSdtHasBeenSet = true;
    m_outputSdt = value;
  }
  inline DvbSdtSettings& WithOutputSdt(DvbSdtOutputSdt value) {
    SetOutputSdt(value);
    return *this;
  }
  ///@}
  ...
  inline DvbSdtSettings& WithRepInterval(int value) {
