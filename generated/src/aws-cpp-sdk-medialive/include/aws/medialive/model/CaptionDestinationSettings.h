...
class CaptionDestinationSettings {
 public:
  ...
  void SetAribDestinationSettings(AribDestinationSettingsT&& value) {
    ...
    m_aribDestinationSettings = std::forward<AribDestinationSettingsT>(value);
  }
  template <typename AribDestinationSettingsT = AribDestinationSettings>
  CaptionDestinationSettings& WithAribDestinationSettings(AribDestinationSettingsT&& value) {
    SetAribDestinationSettings(std::forward<AribDestinationSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEbuTtDDestinationSettings(EbuTtDDestinationSettingsT&& value) {
    ...
    m_ebuTtDDestinationSettings = std::forward<EbuTtDDestinationSettingsT>(value);
  }
  template <typename EbuTtDDestinationSettingsT = EbuTtDDestinationSettings>
  CaptionDestinationSettings& WithEbuTtDDestinationSettings(EbuTtDDestinationSettingsT&& value) {
    SetEbuTtDDestinationSettings(std::forward<EbuTtDDestinationSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  inline const EmbeddedPlusScte20DestinationSettings& GetEmbeddedPlusScte20DestinationSettings() const {
    return m_embeddedPlusScte20DestinationSettings;
  }
  ...
  void SetEmbeddedPlusScte20DestinationSettings(EmbeddedPlusScte20DestinationSettingsT&& value) {
    ...
    m_embeddedPlusScte20DestinationSettings = std::forward<EmbeddedPlusScte20DestinationSettingsT>(value);
  }
  template <typename EmbeddedPlusScte20DestinationSettingsT = EmbeddedPlusScte20DestinationSettings>
  CaptionDestinationSettings& WithEmbeddedPlusScte20DestinationSettings(EmbeddedPlusScte20DestinationSettingsT&& value) {
    SetEmbeddedPlusScte20DestinationSettings(std::forward<EmbeddedPlusScte20DestinationSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  inline const RtmpCaptionInfoDestinationSettings& GetRtmpCaptionInfoDestinationSettings() const {
    return m_rtmpCaptionInfoDestinationSettings;
  }
  ...
  void SetRtmpCaptionInfoDestinationSettings(RtmpCaptionInfoDestinationSettingsT&& value) {
    ...
    m_rtmpCaptionInfoDestinationSettings = std::forward<RtmpCaptionInfoDestinationSettingsT>(value);
  }
  template <typename RtmpCaptionInfoDestinationSettingsT = RtmpCaptionInfoDestinationSettings>
  CaptionDestinationSettings& WithRtmpCaptionInfoDestinationSettings(RtmpCaptionInfoDestinationSettingsT&& value) {
    SetRtmpCaptionInfoDestinationSettings(std::forward<RtmpCaptionInfoDestinationSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  inline const Scte20PlusEmbeddedDestinationSettings& GetScte20PlusEmbeddedDestinationSettings() const {
    return m_scte20PlusEmbeddedDestinationSettings;
  }
  ...
  void SetScte20PlusEmbeddedDestinationSettings(Scte20PlusEmbeddedDestinationSettingsT&& value) {
    ...
    m_scte20PlusEmbeddedDestinationSettings = std::forward<Scte20PlusEmbeddedDestinationSettingsT>(value);
  }
  template <typename Scte20PlusEmbeddedDestinationSettingsT = Scte20PlusEmbeddedDestinationSettings>
  CaptionDestinationSettings& WithScte20PlusEmbeddedDestinationSettings(Scte20PlusEmbeddedDestinationSettingsT&& value) {
    SetScte20PlusEmbeddedDestinationSettings(std::forward<Scte20PlusEmbeddedDestinationSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetScte27DestinationSettings(Scte27DestinationSettingsT&& value) {
    ...
    m_scte27DestinationSettings = std::forward<Scte27DestinationSettingsT>(value);
  }
  template <typename Scte27DestinationSettingsT = Scte27DestinationSettings>
  CaptionDestinationSettings& WithScte27DestinationSettings(Scte27DestinationSettingsT&& value) {
    SetScte27DestinationSettings(std::forward<Scte27DestinationSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSmpteTtDestinationSettings(SmpteTtDestinationSettingsT&& value) {
    ...
    m_smpteTtDestinationSettings = std::forward<SmpteTtDestinationSettingsT>(value);
  }
  template <typename SmpteTtDestinationSettingsT = SmpteTtDestinationSettings>
  CaptionDestinationSettings& WithSmpteTtDestinationSettings(SmpteTtDestinationSettingsT&& value) {
    SetSmpteTtDestinationSettings(std::forward<SmpteTtDestinationSettingsT>(value));
    return *this;
  }
  ///@}
