...
class DeleteClusterResult {
 public:
  ...
  void SetChannelIds(ChannelIdsT&& value) {
    m_channelIdsHasBeenSet = true;
    m_channelIds = std::forward<ChannelIdsT>(value);
  }
  template <typename ChannelIdsT = Aws::Vector<Aws::String>>
  DeleteClusterResult& WithChannelIds(ChannelIdsT&& value) {
    SetChannelIds(std::forward<ChannelIdsT>(value));
    return *this;
  }
  template <typename ChannelIdsT = Aws::String>
  DeleteClusterResult& AddChannelIds(ChannelIdsT&& value) {
    m_channelIdsHasBeenSet = true;
    m_channelIds.emplace_back(std::forward<ChannelIdsT>(value));
    return *this;
  }
  ///@}
  ...
  inline DeleteClusterResult& WithClusterType(ClusterType value) {
  ...
  template <typename IdT = Aws::String>
  DeleteClusterResult& WithId(IdT&& value) {
  ...
  template <typename InstanceRoleArnT = Aws::String>
  DeleteClusterResult& WithInstanceRoleArn(InstanceRoleArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  DeleteClusterResult& WithName(NameT&& value) {
  ...
  template <typename NetworkSettingsT = ClusterNetworkSettings>
  DeleteClusterResult& WithNetworkSettings(NetworkSettingsT&& value) {
