...
namespace Model
{
  ...
  {
  public:
    AWS_MEDIALIVE_API DeleteClusterResult() = default;
    ...
    template<typename ArnT = Aws::String>
    DeleteClusterResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ChannelIdsT = Aws::Vector<Aws::String>>
    DeleteClusterResult& WithChannelIds(ChannelIdsT&& value) { SetChannelIds(std::forward<ChannelIdsT>(value)); return *this;}
    template<typename ChannelIdsT = Aws::String>
    DeleteClusterResult& AddChannelIds(ChannelIdsT&& value) { m_channelIdsHasBeenSet = true; m_channelIds.emplace_back(std::forward<ChannelIdsT>(value)); return *this; }
    ///@}
    ...
    inline DeleteClusterResult& WithClusterType(ClusterType value) { SetClusterType(value); return *this;}
    ///@}
    ...
    template<typename IdT = Aws::String>
    DeleteClusterResult& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename InstanceRoleArnT = Aws::String>
    DeleteClusterResult& WithInstanceRoleArn(InstanceRoleArnT&& value) { SetInstanceRoleArn(std::forward<InstanceRoleArnT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    DeleteClusterResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename NetworkSettingsT = ClusterNetworkSettings>
    DeleteClusterResult& WithNetworkSettings(NetworkSettingsT&& value) { SetNetworkSettings(std::forward<NetworkSettingsT>(value)); return *this;}
    ///@}
    ...
    inline DeleteClusterResult& WithState(ClusterState value) { SetState(value); return *this;}
    ///@}
