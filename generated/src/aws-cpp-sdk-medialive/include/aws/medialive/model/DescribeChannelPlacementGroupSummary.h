...
class DescribeChannelPlacementGroupSummary {
 public:
  ...
  template <typename ArnT = Aws::String>
  DescribeChannelPlacementGroupSummary& WithArn(ArnT&& value) {
  ...
  template <typename IdT = Aws::String>
  DescribeChannelPlacementGroupSummary& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  DescribeChannelPlacementGroupSummary& WithName(NameT&& value) {
  ...
  inline DescribeChannelPlacementGroupSummary& WithState(ChannelPlacementGroupState value) {
    SetState(value);
    return *this;
  }
  ///@}
