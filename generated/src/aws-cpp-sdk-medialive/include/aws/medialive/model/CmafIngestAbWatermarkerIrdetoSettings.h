 ...
 * <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/medialive-2017-10-14/CmafIngestAbWatermarkerIrdetoSettings">AWS
 * API Reference</a></p>
 */
class CmafIngestAbWatermarkerIrdetoSettings {
 public:
  AWS_MEDIALIVE_API CmafIngestAbWatermarkerIrdetoSettings() = default;
  AWS_MEDIALIVE_API CmafIngestAbWatermarkerIrdetoSettings(Aws::Utils::Json::JsonView jsonValue);
  AWS_MEDIALIVE_API CmafIngestAbWatermarkerIrdetoSettings& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename AdditionalDestinationsAlternateDestinationsT = Aws::Vector<OutputLocationRef>>
  CmafIngestAbWatermarkerIrdetoSettings& WithAdditionalDestinationsAlternateDestinations(
  ...
  CmafIngestAbWatermarkerIrdetoSettings& AddAdditionalDestinationsAlternateDestinations(
      AdditionalDestinationsAlternateDestinationsT&& value) {
    m_additionalDestinationsAlternateDestinationsHasBeenSet = true;
  ...
  template <typename AlternateDestinationT = OutputLocationRef>
  CmafIngestAbWatermarkerIrdetoSettings& WithAlternateDestination(AlternateDestinationT&& value) {
  ...
  template <typename CustomProfileT = AbWatermarkingCustomProfile>
  CmafIngestAbWatermarkerIrdetoSettings& WithCustomProfile(CustomProfileT&& value) {
  ...
  template <typename LicenseT = Aws::String>
  CmafIngestAbWatermarkerIrdetoSettings& WithLicense(LicenseT&& value) {
  ...
  inline CmafIngestAbWatermarkerIrdetoSettings& WithOperatorId(int value) {
    SetOperatorId(value);
    return *this;
  }
  ///@}
...
should be the LCM (least common multiple) of all segments sizes
  ...
  inline CmafIngestAbWatermarkerIrdetoSettings& WithPolyPeriod(int value) {
    SetPolyPeriod(value);
    return *this;
  }
  ///@}
  ...
  inline CmafIngestAbWatermarkerIrdetoSettings& WithProfile(AbWatermarkingProfile value) {
    SetProfile(value);
    return *this;
  }
  ///@}
  ...
  inline CmafIngestAbWatermarkerIrdetoSettings& WithWatermarkIdLength(AbWatermarkerIdLength value) {
