...
class UpdateInputSecurityGroupRequest : public MediaLiveRequest {
 public:
  ...
  template <typename InputSecurityGroupIdT = Aws::String>
  UpdateInputSecurityGroupRequest& WithInputSecurityGroupId(InputSecurityGroupIdT&& value) {
  ...
  template <typename WhitelistRulesT = Aws::Vector<InputWhitelistRuleCidr>>
  UpdateInputSecurityGroupRequest& WithWhitelistRules(WhitelistRulesT&& value) {
    SetWhitelistRules(std::forward<WhitelistRulesT>(value));
    return *this;
  }
  template <typename WhitelistRulesT = InputWhitelistRuleCidr>
  UpdateInputSecurityGroupRequest& AddWhitelistRules(WhitelistRulesT&& value) {
    m_whitelistRulesHasBeenSet = true;
