...
class NetworkInputSettings {
 public:
  ...
  void SetHlsInputSettings(HlsInputSettingsT&& value) {
    ...
    m_hlsInputSettings = std::forward<HlsInputSettingsT>(value);
  }
  template <typename HlsInputSettingsT = HlsInputSettings>
  NetworkInputSettings& WithHlsInputSettings(HlsInputSettingsT&& value) {
    SetHlsInputSettings(std::forward<HlsInputSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetServerValidation(NetworkInputServerValidation value) {
    m_serverValidationHasBeenSet = true;
    m_serverValidation = value;
  }
  inline NetworkInputSettings& WithServerValidation(NetworkInputServerValidation value) {
    SetServerValidation(value);
    return *this;
  }
  ///@}
  ...
  void SetMulticastInputSettings(MulticastInputSettingsT&& value) {
    ...
    m_multicastInputSettings = std::forward<MulticastInputSettingsT>(value);
  }
  template <typename MulticastInputSettingsT = MulticastInputSettings>
  NetworkInputSettings& WithMulticastInputSettings(MulticastInputSettingsT&& value) {
    SetMulticastInputSettings(std::forward<MulticastInputSettingsT>(value));
    return *this;
  }
  ///@}
 private:
