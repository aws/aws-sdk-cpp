...
class UpdateCloudWatchAlarmTemplateRequest : public MediaLiveRequest {
 public:
  ...
  inline UpdateCloudWatchAlarmTemplateRequest& WithComparisonOperator(CloudWatchAlarmTemplateComparisonOperator value) {
  ...
  inline UpdateCloudWatchAlarmTemplateRequest& WithDatapointsToAlarm(int value) {
  ...
  inline UpdateCloudWatchAlarmTemplateRequest& WithEvaluationPeriods(int value) {
  ...
  template <typename NameT = Aws::String>
  UpdateCloudWatchAlarmTemplateRequest& WithName(NameT&& value) {
  ...
  inline UpdateCloudWatchAlarmTemplateRequest& WithPeriod(int value) {
    SetPeriod(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateCloudWatchAlarmTemplateRequest& WithStatistic(CloudWatchAlarmTemplateStatistic value) {
    SetStatistic(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateCloudWatchAlarmTemplateRequest& WithTargetResourceType(CloudWatchAlarmTemplateTargetResourceType value) {
  ...
  inline UpdateCloudWatchAlarmTemplateRequest& WithThreshold(double value) {
    SetThreshold(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateCloudWatchAlarmTemplateRequest& WithTreatMissingData(CloudWatchAlarmTemplateTreatMissingData value) {
