...
class UpdateMultiplexProgramRequest : public MediaLiveRequest {
 public:
  ...
  template <typename MultiplexIdT = Aws::String>
  UpdateMultiplexProgramRequest& WithMultiplexId(MultiplexIdT&& value) {
  ...
  template <typename MultiplexProgramSettingsT = MultiplexProgramSettings>
  UpdateMultiplexProgramRequest& WithMultiplexProgramSettings(MultiplexProgramSettingsT&& value) {
  ...
  template <typename ProgramNameT = Aws::String>
  UpdateMultiplexProgramRequest& WithProgramName(ProgramNameT&& value) {
