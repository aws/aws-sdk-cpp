...
class SrtOutputDestinationSettings {
 public:
  ...
  void SetEncryptionPassphraseSecretArn(EncryptionPassphraseSecretArnT&& value) {
    ...
    m_encryptionPassphraseSecretArn = std::forward<EncryptionPassphraseSecretArnT>(value);
  }
  template <typename EncryptionPassphraseSecretArnT = Aws::String>
  SrtOutputDestinationSettings& WithEncryptionPassphraseSecretArn(EncryptionPassphraseSecretArnT&& value) {
    SetEncryptionPassphraseSecretArn(std::forward<EncryptionPassphraseSecretArnT>(value));
    return *this;
  }
  ///@}
