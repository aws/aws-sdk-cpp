...
class ClusterNetworkSettingsUpdateRequest {
 public:
  ...
  template <typename DefaultRouteT = Aws::String>
  ClusterNetworkSettingsUpdateRequest& WithDefaultRoute(DefaultRouteT&& value) {
  ...
  template <typename InterfaceMappingsT = Aws::Vector<InterfaceMappingUpdateRequest>>
  ClusterNetworkSettingsUpdateRequest& WithInterfaceMappings(InterfaceMappingsT&& value) {
  ...
  ClusterNetworkSettingsUpdateRequest& AddInterfaceMappings(InterfaceMappingsT&& value) {
    m_interfaceMappingsHasBeenSet = true;
