...
namespace Model
{
  ...
  public:
    ...
    template<typename ChannelIdT = Aws::String>
    ListAlertsRequest& WithChannelId(ChannelIdT&& value) { SetChannelId(std::forward<ChannelIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListAlertsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    void SetStateFilter(StateFilterT&& value) { m_stateFilterHasBeenSet = true; m_stateFilter = std::forward<StateFilterT>(value); }
    template<typename StateFilterT = Aws::String>
    ListAlertsRequest& WithStateFilter(StateFilterT&& value) { SetStateFilter(std::forward<StateFilterT>(value)); return *this;}
    ///@}
  private:
