...
class StaticImageActivateScheduleActionSettings {
 public:
  ...
  inline StaticImageActivateScheduleActionSettings& WithDuration(int value) {
    SetDuration(value);
    return *this;
  }
  ///@}
  ...
  inline StaticImageActivateScheduleActionSettings& WithFadeIn(int value) {
    SetFadeIn(value);
    return *this;
  }
  ///@}
  ...
  inline StaticImageActivateScheduleActionSettings& WithFadeOut(int value) {
    SetFadeOut(value);
    return *this;
  }
  ///@}
  ...
  inline StaticImageActivateScheduleActionSettings& WithHeight(int value) {
    SetHeight(value);
    return *this;
  }
  ///@}
  ...
  template <typename ImageT = InputLocation>
  StaticImageActivateScheduleActionSettings& WithImage(ImageT&& value) {
  ...
  inline StaticImageActivateScheduleActionSettings& WithImageX(int value) {
    SetImageX(value);
    return *this;
  }
  ///@}
  ...
  inline StaticImageActivateScheduleActionSettings& WithImageY(int value) {
    SetImageY(value);
    return *this;
  }
  ///@}
  ...
  inline StaticImageActivateScheduleActionSettings& WithLayer(int value) {
    SetLayer(value);
    return *this;
  }
  ///@}
  ...
  inline StaticImageActivateScheduleActionSettings& WithOpacity(int value) {
    SetOpacity(value);
    return *this;
  }
  ///@}
  ...
  inline StaticImageActivateScheduleActionSettings& WithWidth(int value) {
    SetWidth(value);
    return *this;
  }
  ///@}
