...
class AudioDescription {
 public:
  ...
  inline void SetAudioType(AudioType value) {
    m_audioTypeHasBeenSet = true;
    m_audioType = value;
  }
  inline AudioDescription& WithAudioType(AudioType value) {
    SetAudioType(value);
    return *this;
  }
  ///@}
...
Note
  ...
  inline void SetAudioTypeControl(AudioDescriptionAudioTypeControl value) {
    m_audioTypeControlHasBeenSet = true;
    m_audioTypeControl = value;
  }
  inline AudioDescription& WithAudioTypeControl(AudioDescriptionAudioTypeControl value) {
    SetAudioTypeControl(value);
    return *this;
  }
  ///@}
  ...
  void SetAudioWatermarkingSettings(AudioWatermarkingSettingsT&& value) {
    ...
    m_audioWatermarkingSettings = std::forward<AudioWatermarkingSettingsT>(value);
  }
  template <typename AudioWatermarkingSettingsT = AudioWatermarkSettings>
  AudioDescription& WithAudioWatermarkingSettings(AudioWatermarkingSettingsT&& value) {
    SetAudioWatermarkingSettings(std::forward<AudioWatermarkingSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCodecSettings(CodecSettingsT&& value) {
    ...
    m_codecSettings = std::forward<CodecSettingsT>(value);
  }
  template <typename CodecSettingsT = AudioCodecSettings>
  AudioDescription& WithCodecSettings(CodecSettingsT&& value) {
    SetCodecSettings(std::forward<CodecSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetLanguageCodeControl(AudioDescriptionLanguageCodeControl value) {
    m_languageCodeControlHasBeenSet = true;
    m_languageCodeControl = value;
  }
  inline AudioDescription& WithLanguageCodeControl(AudioDescriptionLanguageCodeControl value) {
    SetLanguageCodeControl(value);
    return *this;
  }
  ///@}
  ...
  void SetAudioDashRoles(AudioDashRolesT&& value) {
    ...
    m_audioDashRoles = std::forward<AudioDashRolesT>(value);
  }
  template <typename AudioDashRolesT = Aws::Vector<DashRoleAudio>>
  AudioDescription& WithAudioDashRoles(AudioDashRolesT&& value) {
    SetAudioDashRoles(std::forward<AudioDashRolesT>(value));
    return *this;
  }
  inline AudioDescription& AddAudioDashRoles(DashRoleAudio value) {
    m_audioDashRolesHasBeenSet = true;
    m_audioDashRoles.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDvbDashAccessibility(DvbDashAccessibility value) {
    m_dvbDashAccessibilityHasBeenSet = true;
    m_dvbDashAccessibility = value;
  }
  inline AudioDescription& WithDvbDashAccessibility(DvbDashAccessibility value) {
    SetDvbDashAccessibility(value);
    return *this;
  }
  ///@}
 private:
