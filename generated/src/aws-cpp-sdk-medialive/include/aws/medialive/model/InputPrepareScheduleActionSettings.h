...
class InputPrepareScheduleActionSettings {
 public:
  ...
  void SetInputAttachmentNameReference(InputAttachmentNameReferenceT&& value) {
    ...
    m_inputAttachmentNameReference = std::forward<InputAttachmentNameReferenceT>(value);
  }
  template <typename InputAttachmentNameReferenceT = Aws::String>
  InputPrepareScheduleActionSettings& WithInputAttachmentNameReference(InputAttachmentNameReferenceT&& value) {
    SetInputAttachmentNameReference(std::forward<InputAttachmentNameReferenceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInputClippingSettings(InputClippingSettingsT&& value) {
    m_inputClippingSettingsHasBeenSet = true;
    m_inputClippingSettings = std::forward<InputClippingSettingsT>(value);
  }
  template <typename InputClippingSettingsT = InputClippingSettings>
  InputPrepareScheduleActionSettings& WithInputClippingSettings(InputClippingSettingsT&& value) {
    SetInputClippingSettings(std::forward<InputClippingSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  InputPrepareScheduleActionSettings& AddUrlPath(UrlPathT&& value) {
    m_urlPathHasBeenSet = true;
    m_urlPath.emplace_back(std::forward<UrlPathT>(value));
    return *this;
  }
  ///@}
 private:
