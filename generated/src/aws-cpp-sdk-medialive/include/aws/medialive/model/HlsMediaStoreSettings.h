...
class HlsMediaStoreSettings {
 public:
  ...
  inline HlsMediaStoreSettings& WithConnectionRetryInterval(int value) {
  ...
  inline HlsMediaStoreSettings& WithFilecacheDuration(int value) {
  ...
  inline void SetMediaStoreStorageClass(HlsMediaStoreStorageClass value) {
    m_mediaStoreStorageClassHasBeenSet = true;
    m_mediaStoreStorageClass = value;
  }
  inline HlsMediaStoreSettings& WithMediaStoreStorageClass(HlsMediaStoreStorageClass value) {
    SetMediaStoreStorageClass(value);
    return *this;
  }
  ///@}
  ...
  inline HlsMediaStoreSettings& WithNumRetries(int value) {
    SetNumRetries(value);
    return *this;
  }
  ///@}
  ...
  inline HlsMediaStoreSettings& WithRestartDelay(int value) {
