...
class Fmp4HlsSettings {
 public:
  ...
  template <typename AudioRenditionSetsT = Aws::String>
  Fmp4HlsSettings& WithAudioRenditionSets(AudioRenditionSetsT&& value) {
  ...
  inline void SetNielsenId3Behavior(Fmp4NielsenId3Behavior value) {
    m_nielsenId3BehaviorHasBeenSet = true;
    m_nielsenId3Behavior = value;
  }
  inline Fmp4HlsSettings& WithNielsenId3Behavior(Fmp4NielsenId3Behavior value) {
  ...
  inline void SetTimedMetadataBehavior(Fmp4TimedMetadataBehavior value) {
    m_timedMetadataBehaviorHasBeenSet = true;
    m_timedMetadataBehavior = value;
  }
  inline Fmp4HlsSettings& WithTimedMetadataBehavior(Fmp4TimedMetadataBehavior value) {
