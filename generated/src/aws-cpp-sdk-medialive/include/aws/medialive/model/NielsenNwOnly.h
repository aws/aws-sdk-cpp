...
/**
 * Nielsen Nw Only<p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/medialive-2017-10-14/NielsenNwOnly">AWS
 * API Reference</a></p>
 */
class NielsenNwOnly {
 public:
  AWS_MEDIALIVE_API NielsenNwOnly() = default;
  AWS_MEDIALIVE_API NielsenNwOnly(Aws::Utils::Json::JsonView jsonValue);
  AWS_MEDIALIVE_API NielsenNwOnly& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename CheckDigitStringT = Aws::String>
  NielsenNwOnly& WithCheckDigitString(CheckDigitStringT&& value) {
  ...
  inline NielsenNwOnly& WithSid(double value) {
    SetSid(value);
    return *this;
  }
  ///@}
...
the
  ...
  inline NielsenNwOnly& WithTimezone(NielsenWatermarkTimezones value) {
    SetTimezone(value);
    return *this;
  }
  ///@}
