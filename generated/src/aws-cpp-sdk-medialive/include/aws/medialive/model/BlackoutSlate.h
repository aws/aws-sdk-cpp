...
class BlackoutSlate {
 public:
  ...
  void SetBlackoutSlateImage(BlackoutSlateImageT&& value) {
    ...
    m_blackoutSlateImage = std::forward<BlackoutSlateImageT>(value);
  }
  template <typename BlackoutSlateImageT = InputLocation>
  BlackoutSlate& WithBlackoutSlateImage(BlackoutSlateImageT&& value) {
    SetBlackoutSlateImage(std::forward<BlackoutSlateImageT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetNetworkEndBlackout(BlackoutSlateNetworkEndBlackout value) {
    m_networkEndBlackoutHasBeenSet = true;
    m_networkEndBlackout = value;
  }
  inline BlackoutSlate& WithNetworkEndBlackout(BlackoutSlateNetworkEndBlackout value) {
    SetNetworkEndBlackout(value);
    return *this;
  }
  ///@}
  ...
  void SetNetworkEndBlackoutImage(NetworkEndBlackoutImageT&& value) {
    ...
    m_networkEndBlackoutImage = std::forward<NetworkEndBlackoutImageT>(value);
  }
  template <typename NetworkEndBlackoutImageT = InputLocation>
  BlackoutSlate& WithNetworkEndBlackoutImage(NetworkEndBlackoutImageT&& value) {
    SetNetworkEndBlackoutImage(std::forward<NetworkEndBlackoutImageT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetState(BlackoutSlateState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline BlackoutSlate& WithState(BlackoutSlateState value) {
    SetState(value);
    return *this;
  }
  ///@}
