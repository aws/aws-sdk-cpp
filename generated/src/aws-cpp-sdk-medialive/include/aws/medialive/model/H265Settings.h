...
class H265Settings {
 public:
  ...
  inline H265Settings& WithAfdSignaling(AfdSignaling value) {
  ...
  inline void SetAlternativeTransferFunction(H265AlternativeTransferFunction value) {
    m_alternativeTransferFunctionHasBeenSet = true;
    m_alternativeTransferFunction = value;
  }
  inline H265Settings& WithAlternativeTransferFunction(H265AlternativeTransferFunction value) {
    SetAlternativeTransferFunction(value);
    return *this;
  }
  ///@}
  ...
  inline H265Settings& WithBufSize(int value) {
    SetBufSize(value);
    return *this;
  }
  ///@}
  ...
  inline void SetColorMetadata(H265ColorMetadata value) {
    m_colorMetadataHasBeenSet = true;
    m_colorMetadata = value;
  }
  inline H265Settings& WithColorMetadata(H265ColorMetadata value) {
...
compression level to filter imperceptible signals. This filter works
  ...
  inline H265Settings& WithFixedAfd(FixedAfd value) {
    SetFixedAfd(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFlickerAq(H265FlickerAq value) {
    m_flickerAqHasBeenSet = true;
    m_flickerAq = value;
  }
  inline H265Settings& WithFlickerAq(H265FlickerAq value) {
    SetFlickerAq(value);
    return *this;
  }
  ///@}
...
If gopSizeUnits is seconds, gopSize must be greater
  ...
  inline void SetLevel(H265Level value) {
    m_levelHasBeenSet = true;
    m_level = value;
  }
  inline H265Settings& WithLevel(H265Level value) {
    SetLevel(value);
    return *this;
  }
  ///@}
  ...
  inline void SetLookAheadRateControl(H265LookAheadRateControl value) {
    m_lookAheadRateControlHasBeenSet = true;
    m_lookAheadRateControl = value;
  }
  inline H265Settings& WithLookAheadRateControl(H265LookAheadRateControl value) {
  ...
  inline void SetProfile(H265Profile value) {
    m_profileHasBeenSet = true;
    m_profile = value;
  }
  inline H265Settings& WithProfile(H265Profile value) {
    SetProfile(value);
    return *this;
  }
  ///@}
...
- Smartphone: Quality level: 6. Max
  ...
  inline H265Settings& WithQvbrQualityLevel(int value) {
...
by the
  ...
  inline void SetScanType(H265ScanType value) {
    m_scanTypeHasBeenSet = true;
    m_scanType = value;
  }
  inline H265Settings& WithScanType(H265ScanType value) {
    SetScanType(value);
    return *this;
  }
  ///@}
...
This field is optional; when
  ...
  inline void SetTier(H265Tier value) {
    m_tierHasBeenSet = true;
    m_tier = value;
  }
  inline H265Settings& WithTier(H265Tier value) {
    SetTier(value);
    return *this;
  }
  ///@}
...
- 'picTimingSei': Pass through picture
  ...
  inline void SetTimecodeInsertion(H265TimecodeInsertionBehavior value) {
    m_timecodeInsertionHasBeenSet = true;
    m_timecodeInsertion = value;
  }
  inline H265Settings& WithTimecodeInsertion(H265TimecodeInsertionBehavior value) {
...
apply an appropriate value.
  ...
  inline H265Settings& WithMinQp(int value) {
    SetMinQp(value);
    return *this;
  }
  ///@}
...
Set to 2 if resolution is
  ...
  inline H265Settings& WithGopNumBFrames(int value) {
...
Enter a minimum bitrate if you
  ...
  inline H265Settings& WithMinBitrate(int value) {
    SetMinBitrate(value);
    return *this;
  }
  ///@}
...
Must be FIXED if resolution is greater than 1080p or when using
  ...
  inline void SetSubgopLength(H265SubGopLength value) {
    m_subgopLengthHasBeenSet = true;
    m_subgopLength = value;
  }
  inline H265Settings& WithSubgopLength(H265SubGopLength value) {
