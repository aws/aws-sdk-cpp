...
namespace Model
{
  ...
  {
  public:
    AWS_MEDIALIVE_API GetCloudWatchAlarmTemplateGroupRequest() = default;
    ...
    template<typename IdentifierT = Aws::String>
    GetCloudWatchAlarmTemplateGroupRequest& WithIdentifier(IdentifierT&& value) { SetIdentifier(std::forward<IdentifierT>(value)); return *this;}
    ///@}
  private:
