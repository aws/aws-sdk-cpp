...
namespace Model
{
  ...
  {
  public:
    AWS_MEDIALIVE_API AcceptInputDeviceTransferResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    AcceptInputDeviceTransferResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
