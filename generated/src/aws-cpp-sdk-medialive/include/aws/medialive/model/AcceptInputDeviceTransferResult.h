...
namespace Model
{
  ...
  public:
    ...
    inline AcceptInputDeviceTransferResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline AcceptInputDeviceTransferResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline AcceptInputDeviceTransferResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
