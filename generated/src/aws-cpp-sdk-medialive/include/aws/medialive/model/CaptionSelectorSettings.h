...
class CaptionSelectorSettings {
 public:
  ...
  void SetAncillarySourceSettings(AncillarySourceSettingsT&& value) {
    ...
    m_ancillarySourceSettings = std::forward<AncillarySourceSettingsT>(value);
  }
  template <typename AncillarySourceSettingsT = AncillarySourceSettings>
  CaptionSelectorSettings& WithAncillarySourceSettings(AncillarySourceSettingsT&& value) {
    SetAncillarySourceSettings(std::forward<AncillarySourceSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAribSourceSettings(AribSourceSettingsT&& value) {
    ...
    m_aribSourceSettings = std::forward<AribSourceSettingsT>(value);
  }
  template <typename AribSourceSettingsT = AribSourceSettings>
  CaptionSelectorSettings& WithAribSourceSettings(AribSourceSettingsT&& value) {
    SetAribSourceSettings(std::forward<AribSourceSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDvbSubSourceSettings(DvbSubSourceSettingsT&& value) {
    ...
    m_dvbSubSourceSettings = std::forward<DvbSubSourceSettingsT>(value);
  }
  template <typename DvbSubSourceSettingsT = DvbSubSourceSettings>
  CaptionSelectorSettings& WithDvbSubSourceSettings(DvbSubSourceSettingsT&& value) {
    SetDvbSubSourceSettings(std::forward<DvbSubSourceSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEmbeddedSourceSettings(EmbeddedSourceSettingsT&& value) {
    ...
    m_embeddedSourceSettings = std::forward<EmbeddedSourceSettingsT>(value);
  }
  template <typename EmbeddedSourceSettingsT = EmbeddedSourceSettings>
  CaptionSelectorSettings& WithEmbeddedSourceSettings(EmbeddedSourceSettingsT&& value) {
    SetEmbeddedSourceSettings(std::forward<EmbeddedSourceSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetScte20SourceSettings(Scte20SourceSettingsT&& value) {
    ...
    m_scte20SourceSettings = std::forward<Scte20SourceSettingsT>(value);
  }
  template <typename Scte20SourceSettingsT = Scte20SourceSettings>
  CaptionSelectorSettings& WithScte20SourceSettings(Scte20SourceSettingsT&& value) {
    SetScte20SourceSettings(std::forward<Scte20SourceSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetScte27SourceSettings(Scte27SourceSettingsT&& value) {
    ...
    m_scte27SourceSettings = std::forward<Scte27SourceSettingsT>(value);
  }
  template <typename Scte27SourceSettingsT = Scte27SourceSettings>
  CaptionSelectorSettings& WithScte27SourceSettings(Scte27SourceSettingsT&& value) {
    SetScte27SourceSettings(std::forward<Scte27SourceSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTeletextSourceSettings(TeletextSourceSettingsT&& value) {
    ...
    m_teletextSourceSettings = std::forward<TeletextSourceSettingsT>(value);
  }
  template <typename TeletextSourceSettingsT = TeletextSourceSettings>
  CaptionSelectorSettings& WithTeletextSourceSettings(TeletextSourceSettingsT&& value) {
    SetTeletextSourceSettings(std::forward<TeletextSourceSettingsT>(value));
    return *this;
  }
  ///@}
 private:
