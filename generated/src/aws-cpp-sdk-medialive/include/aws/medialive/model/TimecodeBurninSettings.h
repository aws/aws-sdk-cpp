...
class TimecodeBurninSettings {
 public:
  ...
  inline void SetFontSize(TimecodeBurninFontSize value) {
    m_fontSizeHasBeenSet = true;
    m_fontSize = value;
  }
  inline TimecodeBurninSettings& WithFontSize(TimecodeBurninFontSize value) {
    SetFontSize(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPosition(TimecodeBurninPosition value) {
    m_positionHasBeenSet = true;
    m_position = value;
  }
  inline TimecodeBurninSettings& WithPosition(TimecodeBurninPosition value) {
    SetPosition(value);
    return *this;
  }
  ///@}
