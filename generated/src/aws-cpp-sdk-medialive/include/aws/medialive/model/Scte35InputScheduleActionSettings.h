...
class Scte35InputScheduleActionSettings {
 public:
  ...
  template <typename InputAttachmentNameReferenceT = Aws::String>
  Scte35InputScheduleActionSettings& WithInputAttachmentNameReference(InputAttachmentNameReferenceT&& value) {
  ...
  inline void SetMode(Scte35InputMode value) {
    m_modeHasBeenSet = true;
    m_mode = value;
  }
  inline Scte35InputScheduleActionSettings& WithMode(Scte35InputMode value) {
    SetMode(value);
    return *this;
  }
  ///@}
