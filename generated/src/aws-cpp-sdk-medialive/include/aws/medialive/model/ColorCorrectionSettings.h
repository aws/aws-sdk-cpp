...
class ColorCorrectionSettings {
 public:
  ...
  void SetGlobalColorCorrections(GlobalColorCorrectionsT&& value) {
    m_globalColorCorrectionsHasBeenSet = true;
    m_globalColorCorrections = std::forward<GlobalColorCorrectionsT>(value);
  }
  template <typename GlobalColorCorrectionsT = Aws::Vector<ColorCorrection>>
  ColorCorrectionSettings& WithGlobalColorCorrections(GlobalColorCorrectionsT&& value) {
    SetGlobalColorCorrections(std::forward<GlobalColorCorrectionsT>(value));
    return *this;
  }
  template <typename GlobalColorCorrectionsT = ColorCorrection>
  ColorCorrectionSettings& AddGlobalColorCorrections(GlobalColorCorrectionsT&& value) {
    m_globalColorCorrectionsHasBeenSet = true;
    m_globalColorCorrections.emplace_back(std::forward<GlobalColorCorrectionsT>(value));
    return *this;
  }
  ///@}
 private:
