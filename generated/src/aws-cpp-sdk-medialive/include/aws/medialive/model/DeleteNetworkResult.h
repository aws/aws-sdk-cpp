...
class DeleteNetworkResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  DeleteNetworkResult& WithArn(ArnT&& value) {
  ...
  template <typename AssociatedClusterIdsT = Aws::Vector<Aws::String>>
  DeleteNetworkResult& WithAssociatedClusterIds(AssociatedClusterIdsT&& value) {
    SetAssociatedClusterIds(std::forward<AssociatedClusterIdsT>(value));
    return *this;
  }
  template <typename AssociatedClusterIdsT = Aws::String>
  DeleteNetworkResult& AddAssociatedClusterIds(AssociatedClusterIdsT&& value) {
    m_associatedClusterIdsHasBeenSet = true;
  ...
  template <typename IdT = Aws::String>
  DeleteNetworkResult& WithId(IdT&& value) {
  ...
  template <typename IpPoolsT = Aws::Vector<IpPool>>
  DeleteNetworkResult& WithIpPools(IpPoolsT&& value) {
    SetIpPools(std::forward<IpPoolsT>(value));
    return *this;
  }
  template <typename IpPoolsT = IpPool>
  DeleteNetworkResult& AddIpPools(IpPoolsT&& value) {
    m_ipPoolsHasBeenSet = true;
  ...
  template <typename NameT = Aws::String>
  DeleteNetworkResult& WithName(NameT&& value) {
  ...
  template <typename RoutesT = Aws::Vector<Route>>
  DeleteNetworkResult& WithRoutes(RoutesT&& value) {
    SetRoutes(std::forward<RoutesT>(value));
    return *this;
  }
  template <typename RoutesT = Route>
  DeleteNetworkResult& AddRoutes(RoutesT&& value) {
    m_routesHasBeenSet = true;
  ...
  inline DeleteNetworkResult& WithState(NetworkState value) {
    SetState(value);
    return *this;
  }
  ///@}
