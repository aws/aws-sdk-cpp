...
namespace Model
{
  ...
  public:
    ...
    inline RejectInputDeviceTransferResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline RejectInputDeviceTransferResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline RejectInputDeviceTransferResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
