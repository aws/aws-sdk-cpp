...
namespace Model
{
  ...
  {
  public:
    AWS_MEDIALIVE_API RejectInputDeviceTransferResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    RejectInputDeviceTransferResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
