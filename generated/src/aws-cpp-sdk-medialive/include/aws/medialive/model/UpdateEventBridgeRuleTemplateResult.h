...
class UpdateEventBridgeRuleTemplateResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  UpdateEventBridgeRuleTemplateResult& WithArn(ArnT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  UpdateEventBridgeRuleTemplateResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateEventBridgeRuleTemplateResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename EventTargetsT = Aws::Vector<EventBridgeRuleTemplateTarget>>
  UpdateEventBridgeRuleTemplateResult& WithEventTargets(EventTargetsT&& value) {
    SetEventTargets(std::forward<EventTargetsT>(value));
    return *this;
  }
  template <typename EventTargetsT = EventBridgeRuleTemplateTarget>
  UpdateEventBridgeRuleTemplateResult& AddEventTargets(EventTargetsT&& value) {
    m_eventTargetsHasBeenSet = true;
  ...
  inline UpdateEventBridgeRuleTemplateResult& WithEventType(EventBridgeRuleTemplateEventType value) {
    SetEventType(value);
    return *this;
  }
  ///@}
  ...
  template <typename GroupIdT = Aws::String>
  UpdateEventBridgeRuleTemplateResult& WithGroupId(GroupIdT&& value) {
  ...
  template <typename IdT = Aws::String>
  UpdateEventBridgeRuleTemplateResult& WithId(IdT&& value) {
  ...
  template <typename ModifiedAtT = Aws::Utils::DateTime>
  UpdateEventBridgeRuleTemplateResult& WithModifiedAt(ModifiedAtT&& value) {
  ...
  template <typename NameT = Aws::String>
  UpdateEventBridgeRuleTemplateResult& WithName(NameT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  UpdateEventBridgeRuleTemplateResult& WithTags(TagsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateEventBridgeRuleTemplateResult& WithRequestId(RequestIdT&& value) {
