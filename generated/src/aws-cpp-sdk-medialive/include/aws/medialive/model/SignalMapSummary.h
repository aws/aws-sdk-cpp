...
class SignalMapSummary {
 public:
  ...
  inline void SetMonitorDeploymentStatus(SignalMapMonitorDeploymentStatus value) {
    m_monitorDeploymentStatusHasBeenSet = true;
    m_monitorDeploymentStatus = value;
  }
  inline SignalMapSummary& WithMonitorDeploymentStatus(SignalMapMonitorDeploymentStatus value) {
    SetMonitorDeploymentStatus(value);
    return *this;
  }
  ///@}
  ...
  inline SignalMapSummary& WithStatus(SignalMapStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
