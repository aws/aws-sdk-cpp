...
class GlobalConfiguration {
 public:
  ...
  inline void SetInitialAudioGain(int value) {
    m_initialAudioGainHasBeenSet = true;
    m_initialAudioGain = value;
  }
  inline GlobalConfiguration& WithInitialAudioGain(int value) {
    SetInitialAudioGain(value);
    return *this;
  }
  ///@}
  ...
  inline void SetInputEndAction(GlobalConfigurationInputEndAction value) {
    m_inputEndActionHasBeenSet = true;
    m_inputEndAction = value;
  }
  inline GlobalConfiguration& WithInputEndAction(GlobalConfigurationInputEndAction value) {
    SetInputEndAction(value);
    return *this;
  }
  ///@}
  ...
  void SetInputLossBehavior(InputLossBehaviorT&& value) {
    ...
    m_inputLossBehavior = std::forward<InputLossBehaviorT>(value);
  }
  template <typename InputLossBehaviorT = InputLossBehavior>
  GlobalConfiguration& WithInputLossBehavior(InputLossBehaviorT&& value) {
    SetInputLossBehavior(std::forward<InputLossBehaviorT>(value));
    return *this;
  }
  ///@}
...
DISABLED - MediaLive will not attempt to synchronize
  ...
  inline void SetOutputLockingMode(GlobalConfigurationOutputLockingMode value) {
    m_outputLockingModeHasBeenSet = true;
    m_outputLockingMode = value;
  }
  inline GlobalConfiguration& WithOutputLockingMode(GlobalConfigurationOutputLockingMode value) {
  ...
  inline void SetOutputTimingSource(GlobalConfigurationOutputTimingSource value) {
    m_outputTimingSourceHasBeenSet = true;
    m_outputTimingSource = value;
  }
  inline GlobalConfiguration& WithOutputTimingSource(GlobalConfigurationOutputTimingSource value) {
    SetOutputTimingSource(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSupportLowFramerateInputs(GlobalConfigurationLowFramerateInputs value) {
    m_supportLowFramerateInputsHasBeenSet = true;
    m_supportLowFramerateInputs = value;
  }
  inline GlobalConfiguration& WithSupportLowFramerateInputs(GlobalConfigurationLowFramerateInputs value) {
    SetSupportLowFramerateInputs(value);
    return *this;
  }
  ///@}
  ...
  void SetOutputLockingSettings(OutputLockingSettingsT&& value) {
    ...
    m_outputLockingSettings = std::forward<OutputLockingSettingsT>(value);
  }
  template <typename OutputLockingSettingsT = OutputLockingSettings>
  GlobalConfiguration& WithOutputLockingSettings(OutputLockingSettingsT&& value) {
    SetOutputLockingSettings(std::forward<OutputLockingSettingsT>(value));
    return *this;
  }
  ///@}
 private:
