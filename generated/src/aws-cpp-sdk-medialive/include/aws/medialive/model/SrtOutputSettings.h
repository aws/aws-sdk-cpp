...
class SrtOutputSettings {
 public:
  ...
  inline void SetBufferMsec(int value) {
    m_bufferMsecHasBeenSet = true;
    m_bufferMsec = value;
  }
  inline SrtOutputSettings& WithBufferMsec(int value) {
    SetBufferMsec(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEncryptionType(SrtEncryptionType value) {
    m_encryptionTypeHasBeenSet = true;
    m_encryptionType = value;
  }
  inline SrtOutputSettings& WithEncryptionType(SrtEncryptionType value) {
  ...
  inline void SetLatency(int value) {
    m_latencyHasBeenSet = true;
    m_latency = value;
  }
  inline SrtOutputSettings& WithLatency(int value) {
    SetLatency(value);
    return *this;
  }
  ///@}
