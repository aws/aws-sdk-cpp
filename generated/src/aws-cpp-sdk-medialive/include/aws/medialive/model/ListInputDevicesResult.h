...
class ListInputDevicesResult {
 public:
  ...
  template <typename InputDevicesT = Aws::Vector<InputDeviceSummary>>
  ListInputDevicesResult& WithInputDevices(InputDevicesT&& value) {
    SetInputDevices(std::forward<InputDevicesT>(value));
    return *this;
  }
  template <typename InputDevicesT = InputDeviceSummary>
  ListInputDevicesResult& AddInputDevices(InputDevicesT&& value) {
    m_inputDevicesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListInputDevicesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListInputDevicesResult& WithRequestId(RequestIdT&& value) {
