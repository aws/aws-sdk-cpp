...
class InputLossBehavior {
 public:
  ...
  inline void SetBlackFrameMsec(int value) {
    m_blackFrameMsecHasBeenSet = true;
    m_blackFrameMsec = value;
  }
  inline InputLossBehavior& WithBlackFrameMsec(int value) {
    SetBlackFrameMsec(value);
    return *this;
  }
  ///@}
  ...
  void SetInputLossImageColor(InputLossImageColorT&& value) {
    ...
    m_inputLossImageColor = std::forward<InputLossImageColorT>(value);
  }
  template <typename InputLossImageColorT = Aws::String>
  InputLossBehavior& WithInputLossImageColor(InputLossImageColorT&& value) {
    SetInputLossImageColor(std::forward<InputLossImageColorT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInputLossImageSlate(InputLossImageSlateT&& value) {
    ...
    m_inputLossImageSlate = std::forward<InputLossImageSlateT>(value);
  }
  template <typename InputLossImageSlateT = InputLocation>
  InputLossBehavior& WithInputLossImageSlate(InputLossImageSlateT&& value) {
    SetInputLossImageSlate(std::forward<InputLossImageSlateT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetInputLossImageType(InputLossImageType value) {
    m_inputLossImageTypeHasBeenSet = true;
    m_inputLossImageType = value;
  }
  inline InputLossBehavior& WithInputLossImageType(InputLossImageType value) {
    SetInputLossImageType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRepeatFrameMsec(int value) {
    m_repeatFrameMsecHasBeenSet = true;
    m_repeatFrameMsec = value;
  }
  inline InputLossBehavior& WithRepeatFrameMsec(int value) {
    SetRepeatFrameMsec(value);
    return *this;
  }
  ///@}
 private:
