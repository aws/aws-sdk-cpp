...
class UdpOutputSettings {
 public:
  ...
  inline UdpOutputSettings& WithBufferMsec(int value) {
    SetBufferMsec(value);
    return *this;
  }
  ///@}
  ...
  void SetFecOutputSettings(FecOutputSettingsT&& value) {
    ...
    m_fecOutputSettings = std::forward<FecOutputSettingsT>(value);
  }
  template <typename FecOutputSettingsT = FecOutputSettings>
  UdpOutputSettings& WithFecOutputSettings(FecOutputSettingsT&& value) {
    SetFecOutputSettings(std::forward<FecOutputSettingsT>(value));
    return *this;
  }
  ///@}
 private:
