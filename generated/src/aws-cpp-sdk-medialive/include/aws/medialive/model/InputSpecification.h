...
class InputSpecification {
 public:
  ...
  inline void SetCodec(InputCodec value) {
    m_codecHasBeenSet = true;
    m_codec = value;
  }
  inline InputSpecification& WithCodec(InputCodec value) {
    SetCodec(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaximumBitrate(InputMaximumBitrate value) {
    m_maximumBitrateHasBeenSet = true;
    m_maximumBitrate = value;
  }
  inline InputSpecification& WithMaximumBitrate(InputMaximumBitrate value) {
  ...
  inline void SetResolution(InputResolution value) {
    m_resolutionHasBeenSet = true;
    m_resolution = value;
  }
  inline InputSpecification& WithResolution(InputResolution value) {
    SetResolution(value);
    return *this;
  }
  ///@}
