...
class CreateChannelRequest : public MediaLiveRequest {
 public:
  ...
  inline CreateChannelRequest& WithChannelClass(ChannelClass value) {
  ...
  inline CreateChannelRequest& WithLogLevel(LogLevel value) {
    SetLogLevel(value);
    return *this;
  }
  ///@}
...
creating multiple resources.
  ...
  inline CreateChannelRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
