...
class NodeInterfaceMappingCreateRequest {
 public:
  ...
  template <typename LogicalInterfaceNameT = Aws::String>
  NodeInterfaceMappingCreateRequest& WithLogicalInterfaceName(LogicalInterfaceNameT&& value) {
  ...
  inline NodeInterfaceMappingCreateRequest& WithNetworkInterfaceMode(NetworkInterfaceMode value) {
  ...
  template <typename PhysicalInterfaceNameT = Aws::String>
  NodeInterfaceMappingCreateRequest& WithPhysicalInterfaceName(PhysicalInterfaceNameT&& value) {
