...
class AudioChannelMapping {
 public:
  ...
  void SetInputChannelLevels(InputChannelLevelsT&& value) {
    m_inputChannelLevelsHasBeenSet = true;
    m_inputChannelLevels = std::forward<InputChannelLevelsT>(value);
  }
  template <typename InputChannelLevelsT = Aws::Vector<InputChannelLevel>>
  AudioChannelMapping& WithInputChannelLevels(InputChannelLevelsT&& value) {
    SetInputChannelLevels(std::forward<InputChannelLevelsT>(value));
    return *this;
  }
  template <typename InputChannelLevelsT = InputChannelLevel>
  AudioChannelMapping& AddInputChannelLevels(InputChannelLevelsT&& value) {
    m_inputChannelLevelsHasBeenSet = true;
    m_inputChannelLevels.emplace_back(std::forward<InputChannelLevelsT>(value));
    return *this;
  }
  ///@}
  ...
  inline AudioChannelMapping& WithOutputChannel(int value) {
