...
class ListInputDeviceTransfersRequest : public MediaLiveRequest {
 public:
  ...
  inline ListInputDeviceTransfersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListInputDeviceTransfersRequest& WithNextToken(NextTokenT&& value) {
  ...
  void SetTransferType(TransferTypeT&& value) {
    m_transferTypeHasBeenSet = true;
    m_transferType = std::forward<TransferTypeT>(value);
  }
  template <typename TransferTypeT = Aws::String>
  ListInputDeviceTransfersRequest& WithTransferType(TransferTypeT&& value) {
    SetTransferType(std::forward<TransferTypeT>(value));
    return *this;
  }
  ///@}
 private:
