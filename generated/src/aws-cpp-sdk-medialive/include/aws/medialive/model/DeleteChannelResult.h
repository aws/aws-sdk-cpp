...
class DeleteChannelResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  DeleteChannelResult& WithArn(ArnT&& value) {
  ...
  template <typename CdiInputSpecificationT = CdiInputSpecification>
  DeleteChannelResult& WithCdiInputSpecification(CdiInputSpecificationT&& value) {
  ...
  inline DeleteChannelResult& WithChannelClass(ChannelClass value) {
...
one destination per
  ...
  template <typename DestinationsT = Aws::Vector<OutputDestination>>
  DeleteChannelResult& WithDestinations(DestinationsT&& value) {
    SetDestinations(std::forward<DestinationsT>(value));
    return *this;
  }
  template <typename DestinationsT = OutputDestination>
  DeleteChannelResult& AddDestinations(DestinationsT&& value) {
    m_destinationsHasBeenSet = true;
  ...
  template <typename EgressEndpointsT = Aws::Vector<ChannelEgressEndpoint>>
  DeleteChannelResult& WithEgressEndpoints(EgressEndpointsT&& value) {
    SetEgressEndpoints(std::forward<EgressEndpointsT>(value));
    return *this;
  }
  template <typename EgressEndpointsT = ChannelEgressEndpoint>
  DeleteChannelResult& AddEgressEndpoints(EgressEndpointsT&& value) {
    m_egressEndpointsHasBeenSet = true;
  ...
  template <typename EncoderSettingsT = EncoderSettings>
  DeleteChannelResult& WithEncoderSettings(EncoderSettingsT&& value) {
  ...
  template <typename IdT = Aws::String>
  DeleteChannelResult& WithId(IdT&& value) {
  ...
  template <typename InputAttachmentsT = Aws::Vector<InputAttachment>>
  DeleteChannelResult& WithInputAttachments(InputAttachmentsT&& value) {
    SetInputAttachments(std::forward<InputAttachmentsT>(value));
    return *this;
  }
  template <typename InputAttachmentsT = InputAttachment>
  DeleteChannelResult& AddInputAttachments(InputAttachmentsT&& value) {
    m_inputAttachmentsHasBeenSet = true;
  ...
  template <typename InputSpecificationT = InputSpecification>
  DeleteChannelResult& WithInputSpecification(InputSpecificationT&& value) {
  ...
  inline DeleteChannelResult& WithLogLevel(LogLevel value) {
    SetLogLevel(value);
    return *this;
  }
  ///@}
  ...
  template <typename MaintenanceT = MaintenanceStatus>
  DeleteChannelResult& WithMaintenance(MaintenanceT&& value) {
  ...
  template <typename NameT = Aws::String>
  DeleteChannelResult& WithName(NameT&& value) {
  ...
  template <typename PipelineDetailsT = Aws::Vector<PipelineDetail>>
  DeleteChannelResult& WithPipelineDetails(PipelineDetailsT&& value) {
    SetPipelineDetails(std::forward<PipelineDetailsT>(value));
    return *this;
  }
  template <typename PipelineDetailsT = PipelineDetail>
  DeleteChannelResult& AddPipelineDetails(PipelineDetailsT&& value) {
    m_pipelineDetailsHasBeenSet = true;
  ...
  inline DeleteChannelResult& WithPipelinesRunningCount(int value) {
  ...
  template <typename RoleArnT = Aws::String>
  DeleteChannelResult& WithRoleArn(RoleArnT&& value) {
  ...
  inline DeleteChannelResult& WithState(ChannelState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  DeleteChannelResult& WithTags(TagsT&& value) {
  ...
  template <typename VpcT = VpcOutputSettingsDescription>
  DeleteChannelResult& WithVpc(VpcT&& value) {
  ...
  template <typename AnywhereSettingsT = DescribeAnywhereSettings>
  DeleteChannelResult& WithAnywhereSettings(AnywhereSettingsT&& value) {
  ...
  template <typename ChannelEngineVersionT = ChannelEngineVersionResponse>
  DeleteChannelResult& WithChannelEngineVersion(ChannelEngineVersionT&& value) {
  ...
  template <typename ChannelSecurityGroupsT = Aws::Vector<Aws::String>>
  DeleteChannelResult& WithChannelSecurityGroups(ChannelSecurityGroupsT&& value) {
    SetChannelSecurityGroups(std::forward<ChannelSecurityGroupsT>(value));
    return *this;
  }
  template <typename ChannelSecurityGroupsT = Aws::String>
  DeleteChannelResult& AddChannelSecurityGroups(ChannelSecurityGroupsT&& value) {
    m_channelSecurityGroupsHasBeenSet = true;
  ...
  template <typename InferenceSettingsT = DescribeInferenceSettings>
  DeleteChannelResult& WithInferenceSettings(InferenceSettingsT&& value) {
