...
class CmafIngestGroupSettings {
 public:
  ...
  inline CmafIngestGroupSettings& WithNielsenId3Behavior(CmafNielsenId3Behavior value) {
  ...
  inline CmafIngestGroupSettings& WithScte35Type(Scte35Type value) {
    SetScte35Type(value);
    return *this;
  }
  ///@}
  ...
  inline CmafIngestGroupSettings& WithSegmentLength(int value) {
  ...
  inline CmafIngestGroupSettings& WithSegmentLengthUnits(CmafIngestSegmentLengthUnits value) {
  ...
  inline void SetSendDelayMs(int value) {
    m_sendDelayMsHasBeenSet = true;
    m_sendDelayMs = value;
  }
  inline CmafIngestGroupSettings& WithSendDelayMs(int value) {
    SetSendDelayMs(value);
    return *this;
  }
  ///@}
  ...
  inline CmafIngestGroupSettings& WithKlvBehavior(CmafKLVBehavior value) {
  ...
  void SetKlvNameModifier(KlvNameModifierT&& value) {
    m_klvNameModifierHasBeenSet = true;
    m_klvNameModifier = std::forward<KlvNameModifierT>(value);
  }
  template <typename KlvNameModifierT = Aws::String>
  CmafIngestGroupSettings& WithKlvNameModifier(KlvNameModifierT&& value) {
    SetKlvNameModifier(std::forward<KlvNameModifierT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNielsenId3NameModifier(NielsenId3NameModifierT&& value) {
    ...
    m_nielsenId3NameModifier = std::forward<NielsenId3NameModifierT>(value);
  }
  template <typename NielsenId3NameModifierT = Aws::String>
  CmafIngestGroupSettings& WithNielsenId3NameModifier(NielsenId3NameModifierT&& value) {
    SetNielsenId3NameModifier(std::forward<NielsenId3NameModifierT>(value));
    return *this;
  }
  ///@}
  ...
  void SetScte35NameModifier(Scte35NameModifierT&& value) {
    ...
    m_scte35NameModifier = std::forward<Scte35NameModifierT>(value);
  }
  template <typename Scte35NameModifierT = Aws::String>
  CmafIngestGroupSettings& WithScte35NameModifier(Scte35NameModifierT&& value) {
    SetScte35NameModifier(std::forward<Scte35NameModifierT>(value));
    return *this;
  }
  ///@}
  ...
  inline CmafIngestGroupSettings& WithId3Behavior(CmafId3Behavior value) {
  ...
  void SetId3NameModifier(Id3NameModifierT&& value) {
    m_id3NameModifierHasBeenSet = true;
    m_id3NameModifier = std::forward<Id3NameModifierT>(value);
  }
  template <typename Id3NameModifierT = Aws::String>
  CmafIngestGroupSettings& WithId3NameModifier(Id3NameModifierT&& value) {
    SetId3NameModifier(std::forward<Id3NameModifierT>(value));
    return *this;
  }
  ///@}
  ...
  inline CmafIngestGroupSettings& WithTimedMetadataId3Frame(CmafTimedMetadataId3Frame value) {
  ...
  inline CmafIngestGroupSettings& WithTimedMetadataId3Period(int value) {
  ...
  inline CmafIngestGroupSettings& WithTimedMetadataPassthrough(CmafTimedMetadataPassthrough value) {
