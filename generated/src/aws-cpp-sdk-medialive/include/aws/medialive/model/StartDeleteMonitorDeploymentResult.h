...
class StartDeleteMonitorDeploymentResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  StartDeleteMonitorDeploymentResult& WithArn(ArnT&& value) {
  ...
  template <typename IdT = Aws::String>
  StartDeleteMonitorDeploymentResult& WithId(IdT&& value) {
  ...
  inline StartDeleteMonitorDeploymentResult& WithMonitorChangesPendingDeployment(bool value) {
  ...
  template <typename NameT = Aws::String>
  StartDeleteMonitorDeploymentResult& WithName(NameT&& value) {
  ...
  inline StartDeleteMonitorDeploymentResult& WithStatus(SignalMapStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  StartDeleteMonitorDeploymentResult& WithTags(TagsT&& value) {
