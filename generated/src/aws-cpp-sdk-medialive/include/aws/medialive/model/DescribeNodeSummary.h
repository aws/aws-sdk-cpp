...
class DescribeNodeSummary {
 public:
  ...
  inline DescribeNodeSummary& WithConnectionState(NodeConnectionState value) {
  ...
  void SetManagedInstanceId(ManagedInstanceIdT&& value) {
    ...
    m_managedInstanceId = std::forward<ManagedInstanceIdT>(value);
  }
  template <typename ManagedInstanceIdT = Aws::String>
  DescribeNodeSummary& WithManagedInstanceId(ManagedInstanceIdT&& value) {
    SetManagedInstanceId(std::forward<ManagedInstanceIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeNodeSummary& WithRole(NodeRole value) {
    SetRole(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeNodeSummary& WithState(NodeState value) {
    SetState(value);
    return *this;
  }
  ///@}
