...
class UpdateCloudWatchAlarmTemplateResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  UpdateCloudWatchAlarmTemplateResult& WithArn(ArnT&& value) {
  ...
  inline UpdateCloudWatchAlarmTemplateResult& WithComparisonOperator(CloudWatchAlarmTemplateComparisonOperator value) {
  ...
  inline UpdateCloudWatchAlarmTemplateResult& WithDatapointsToAlarm(int value) {
  ...
  inline UpdateCloudWatchAlarmTemplateResult& WithEvaluationPeriods(int value) {
  ...
  template <typename IdT = Aws::String>
  UpdateCloudWatchAlarmTemplateResult& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  UpdateCloudWatchAlarmTemplateResult& WithName(NameT&& value) {
  ...
  inline UpdateCloudWatchAlarmTemplateResult& WithPeriod(int value) {
    SetPeriod(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateCloudWatchAlarmTemplateResult& WithStatistic(CloudWatchAlarmTemplateStatistic value) {
    SetStatistic(value);
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  UpdateCloudWatchAlarmTemplateResult& WithTags(TagsT&& value) {
  ...
  inline UpdateCloudWatchAlarmTemplateResult& WithTargetResourceType(CloudWatchAlarmTemplateTargetResourceType value) {
  ...
  inline UpdateCloudWatchAlarmTemplateResult& WithThreshold(double value) {
    SetThreshold(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateCloudWatchAlarmTemplateResult& WithTreatMissingData(CloudWatchAlarmTemplateTreatMissingData value) {
