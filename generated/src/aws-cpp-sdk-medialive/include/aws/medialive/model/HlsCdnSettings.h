...
class HlsCdnSettings {
 public:
  ...
  void SetHlsAkamaiSettings(HlsAkamaiSettingsT&& value) {
    ...
    m_hlsAkamaiSettings = std::forward<HlsAkamaiSettingsT>(value);
  }
  template <typename HlsAkamaiSettingsT = HlsAkamaiSettings>
  HlsCdnSettings& WithHlsAkamaiSettings(HlsAkamaiSettingsT&& value) {
    SetHlsAkamaiSettings(std::forward<HlsAkamaiSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetHlsBasicPutSettings(HlsBasicPutSettingsT&& value) {
    ...
    m_hlsBasicPutSettings = std::forward<HlsBasicPutSettingsT>(value);
  }
  template <typename HlsBasicPutSettingsT = HlsBasicPutSettings>
  HlsCdnSettings& WithHlsBasicPutSettings(HlsBasicPutSettingsT&& value) {
    SetHlsBasicPutSettings(std::forward<HlsBasicPutSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetHlsMediaStoreSettings(HlsMediaStoreSettingsT&& value) {
    ...
    m_hlsMediaStoreSettings = std::forward<HlsMediaStoreSettingsT>(value);
  }
  template <typename HlsMediaStoreSettingsT = HlsMediaStoreSettings>
  HlsCdnSettings& WithHlsMediaStoreSettings(HlsMediaStoreSettingsT&& value) {
    SetHlsMediaStoreSettings(std::forward<HlsMediaStoreSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetHlsS3Settings(HlsS3SettingsT&& value) {
    ...
    m_hlsS3Settings = std::forward<HlsS3SettingsT>(value);
  }
  template <typename HlsS3SettingsT = HlsS3Settings>
  HlsCdnSettings& WithHlsS3Settings(HlsS3SettingsT&& value) {
    SetHlsS3Settings(std::forward<HlsS3SettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetHlsWebdavSettings(HlsWebdavSettingsT&& value) {
    ...
    m_hlsWebdavSettings = std::forward<HlsWebdavSettingsT>(value);
  }
  template <typename HlsWebdavSettingsT = HlsWebdavSettings>
  HlsCdnSettings& WithHlsWebdavSettings(HlsWebdavSettingsT&& value) {
    SetHlsWebdavSettings(std::forward<HlsWebdavSettingsT>(value));
    return *this;
  }
  ///@}
 private:
