...
class StartMultiplexResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  StartMultiplexResult& WithArn(ArnT&& value) {
  ...
  template <typename AvailabilityZonesT = Aws::Vector<Aws::String>>
  StartMultiplexResult& WithAvailabilityZones(AvailabilityZonesT&& value) {
    SetAvailabilityZones(std::forward<AvailabilityZonesT>(value));
    return *this;
  }
  template <typename AvailabilityZonesT = Aws::String>
  StartMultiplexResult& AddAvailabilityZones(AvailabilityZonesT&& value) {
    m_availabilityZonesHasBeenSet = true;
  ...
  template <typename DestinationsT = Aws::Vector<MultiplexOutputDestination>>
  StartMultiplexResult& WithDestinations(DestinationsT&& value) {
    SetDestinations(std::forward<DestinationsT>(value));
    return *this;
  }
  template <typename DestinationsT = MultiplexOutputDestination>
  StartMultiplexResult& AddDestinations(DestinationsT&& value) {
    m_destinationsHasBeenSet = true;
  ...
  template <typename IdT = Aws::String>
  StartMultiplexResult& WithId(IdT&& value) {
  ...
  template <typename MultiplexSettingsT = MultiplexSettings>
  StartMultiplexResult& WithMultiplexSettings(MultiplexSettingsT&& value) {
  ...
  template <typename NameT = Aws::String>
  StartMultiplexResult& WithName(NameT&& value) {
  ...
  inline StartMultiplexResult& WithPipelinesRunningCount(int value) {
  ...
  inline StartMultiplexResult& WithProgramCount(int value) {
  ...
  inline StartMultiplexResult& WithState(MultiplexState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  StartMultiplexResult& WithTags(TagsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StartMultiplexResult& WithRequestId(RequestIdT&& value) {
