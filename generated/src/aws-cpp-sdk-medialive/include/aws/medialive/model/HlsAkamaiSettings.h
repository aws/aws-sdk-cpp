...
class HlsAkamaiSettings {
 public:
  ...
  inline HlsAkamaiSettings& WithConnectionRetryInterval(int value) {
  ...
  inline HlsAkamaiSettings& WithFilecacheDuration(int value) {
  ...
  inline void SetHttpTransferMode(HlsAkamaiHttpTransferMode value) {
    m_httpTransferModeHasBeenSet = true;
    m_httpTransferMode = value;
  }
  inline HlsAkamaiSettings& WithHttpTransferMode(HlsAkamaiHttpTransferMode value) {
  ...
  inline HlsAkamaiSettings& WithNumRetries(int value) {
    SetNumRetries(value);
    return *this;
  }
  ///@}
  ...
  inline HlsAkamaiSettings& WithRestartDelay(int value) {
