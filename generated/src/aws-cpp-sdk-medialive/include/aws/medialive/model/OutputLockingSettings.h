...
class OutputLockingSettings {
 public:
  ...
  void SetEpochLockingSettings(EpochLockingSettingsT&& value) {
    m_epochLockingSettingsHasBeenSet = true;
    m_epochLockingSettings = std::forward<EpochLockingSettingsT>(value);
  }
  template <typename EpochLockingSettingsT = EpochLockingSettings>
  OutputLockingSettings& WithEpochLockingSettings(EpochLockingSettingsT&& value) {
    SetEpochLockingSettings(std::forward<EpochLockingSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPipelineLockingSettings(PipelineLockingSettingsT&& value) {
    m_pipelineLockingSettingsHasBeenSet = true;
    m_pipelineLockingSettings = std::forward<PipelineLockingSettingsT>(value);
  }
  template <typename PipelineLockingSettingsT = PipelineLockingSettings>
  OutputLockingSettings& WithPipelineLockingSettings(PipelineLockingSettingsT&& value) {
    SetPipelineLockingSettings(std::forward<PipelineLockingSettingsT>(value));
    return *this;
  }
  ///@}
 private:
