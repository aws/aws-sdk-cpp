...
class HlsBasicPutSettings {
 public:
  ...
  inline HlsBasicPutSettings& WithConnectionRetryInterval(int value) {
  ...
  inline HlsBasicPutSettings& WithFilecacheDuration(int value) {
  ...
  inline HlsBasicPutSettings& WithNumRetries(int value) {
    SetNumRetries(value);
    return *this;
  }
  ///@}
  ...
  inline HlsBasicPutSettings& WithRestartDelay(int value) {
