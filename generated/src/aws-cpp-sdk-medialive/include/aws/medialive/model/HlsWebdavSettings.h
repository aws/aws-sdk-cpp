...
class HlsWebdavSettings {
 public:
  ...
  inline HlsWebdavSettings& WithConnectionRetryInterval(int value) {
  ...
  inline HlsWebdavSettings& WithFilecacheDuration(int value) {
  ...
  inline void SetHttpTransferMode(HlsWebdavHttpTransferMode value) {
    m_httpTransferModeHasBeenSet = true;
    m_httpTransferMode = value;
  }
  inline HlsWebdavSettings& WithHttpTransferMode(HlsWebdavHttpTransferMode value) {
    SetHttpTransferMode(value);
    return *this;
  }
  ///@}
  ...
  inline HlsWebdavSettings& WithNumRetries(int value) {
    SetNumRetries(value);
    return *this;
  }
  ///@}
  ...
  inline HlsWebdavSettings& WithRestartDelay(int value) {
