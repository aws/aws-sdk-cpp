...
class StaticImageOutputDeactivateScheduleActionSettings {
 public:
  ...
  inline void SetFadeOut(int value) {
    m_fadeOutHasBeenSet = true;
    m_fadeOut = value;
  }
  inline StaticImageOutputDeactivateScheduleActionSettings& WithFadeOut(int value) {
    SetFadeOut(value);
    return *this;
  }
  ///@}
  ...
  inline StaticImageOutputDeactivateScheduleActionSettings& WithLayer(int value) {
    SetLayer(value);
    return *this;
  }
  ///@}
  ...
  void SetOutputNames(OutputNamesT&& value) {
    m_outputNamesHasBeenSet = true;
    m_outputNames = std::forward<OutputNamesT>(value);
  }
  template <typename OutputNamesT = Aws::Vector<Aws::String>>
  StaticImageOutputDeactivateScheduleActionSettings& WithOutputNames(OutputNamesT&& value) {
    SetOutputNames(std::forward<OutputNamesT>(value));
    return *this;
  }
  template <typename OutputNamesT = Aws::String>
  StaticImageOutputDeactivateScheduleActionSettings& AddOutputNames(OutputNamesT&& value) {
    m_outputNamesHasBeenSet = true;
    m_outputNames.emplace_back(std::forward<OutputNamesT>(value));
    return *this;
  }
  ///@}
 private:
