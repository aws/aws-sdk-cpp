...
class ListCloudWatchAlarmTemplateGroupsRequest : public MediaLiveRequest {
 public:
  ...
  inline ListCloudWatchAlarmTemplateGroupsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListCloudWatchAlarmTemplateGroupsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ScopeT = Aws::String>
  ListCloudWatchAlarmTemplateGroupsRequest& WithScope(ScopeT&& value) {
  ...
  template <typename SignalMapIdentifierT = Aws::String>
  ListCloudWatchAlarmTemplateGroupsRequest& WithSignalMapIdentifier(SignalMapIdentifierT&& value) {
