...
class DeleteChannelPlacementGroupResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  DeleteChannelPlacementGroupResult& WithArn(ArnT&& value) {
  ...
  template <typename ChannelsT = Aws::Vector<Aws::String>>
  DeleteChannelPlacementGroupResult& WithChannels(ChannelsT&& value) {
    SetChannels(std::forward<ChannelsT>(value));
    return *this;
  }
  template <typename ChannelsT = Aws::String>
  DeleteChannelPlacementGroupResult& AddChannels(ChannelsT&& value) {
    m_channelsHasBeenSet = true;
  ...
  template <typename ClusterIdT = Aws::String>
  DeleteChannelPlacementGroupResult& WithClusterId(ClusterIdT&& value) {
  ...
  template <typename IdT = Aws::String>
  DeleteChannelPlacementGroupResult& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  DeleteChannelPlacementGroupResult& WithName(NameT&& value) {
  ...
  template <typename NodesT = Aws::Vector<Aws::String>>
  DeleteChannelPlacementGroupResult& WithNodes(NodesT&& value) {
    SetNodes(std::forward<NodesT>(value));
    return *this;
  }
  template <typename NodesT = Aws::String>
  DeleteChannelPlacementGroupResult& AddNodes(NodesT&& value) {
    m_nodesHasBeenSet = true;
  ...
  inline DeleteChannelPlacementGroupResult& WithState(ChannelPlacementGroupState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DeleteChannelPlacementGroupResult& WithRequestId(RequestIdT&& value) {
