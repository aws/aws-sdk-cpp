...
class VideoDescription {
 public:
  ...
  inline VideoDescription& WithHeight(int value) {
    SetHeight(value);
    return *this;
  }
  ///@}
...
NONE: MediaLive does not clip the input video and does not include the
  ...
  inline void SetRespondToAfd(VideoDescriptionRespondToAfd value) {
    m_respondToAfdHasBeenSet = true;
    m_respondToAfd = value;
  }
  inline VideoDescription& WithRespondToAfd(VideoDescriptionRespondToAfd value) {
    SetRespondToAfd(value);
    return *this;
  }
  ///@}
   ...
   * frame.
Use STRETCH_TO_OUTPUT to stretch the video to fill the output frame. The
   * video might get distorted.
Use DEFAULT to insert pillar boxes or letter boxes
   * around the video to fill the output frame. The video won't get distorted.
Use
  ...
  inline void SetScalingBehavior(VideoDescriptionScalingBehavior value) {
    m_scalingBehaviorHasBeenSet = true;
    m_scalingBehavior = value;
  }
  inline VideoDescription& WithScalingBehavior(VideoDescriptionScalingBehavior value) {
    SetScalingBehavior(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSharpness(int value) {
    m_sharpnessHasBeenSet = true;
    m_sharpness = value;
  }
  inline VideoDescription& WithSharpness(int value) {
    SetSharpness(value);
    return *this;
  }
  ///@}
  ...
  inline VideoDescription& WithWidth(int value) {
    SetWidth(value);
    return *this;
  }
  ///@}
