...
class BatchDeleteRequest : public MediaLiveRequest {
 public:
  ...
  void SetInputIds(InputIdsT&& value) {
    m_inputIdsHasBeenSet = true;
    m_inputIds = std::forward<InputIdsT>(value);
  }
  template <typename InputIdsT = Aws::Vector<Aws::String>>
  BatchDeleteRequest& WithInputIds(InputIdsT&& value) {
    SetInputIds(std::forward<InputIdsT>(value));
    return *this;
  }
  template <typename InputIdsT = Aws::String>
  BatchDeleteRequest& AddInputIds(InputIdsT&& value) {
    m_inputIdsHasBeenSet = true;
    m_inputIds.emplace_back(std::forward<InputIdsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInputSecurityGroupIds(InputSecurityGroupIdsT&& value) {
    m_inputSecurityGroupIdsHasBeenSet = true;
    m_inputSecurityGroupIds = std::forward<InputSecurityGroupIdsT>(value);
  }
  template <typename InputSecurityGroupIdsT = Aws::Vector<Aws::String>>
  BatchDeleteRequest& WithInputSecurityGroupIds(InputSecurityGroupIdsT&& value) {
    SetInputSecurityGroupIds(std::forward<InputSecurityGroupIdsT>(value));
    return *this;
  }
  ...
  BatchDeleteRequest& AddInputSecurityGroupIds(InputSecurityGroupIdsT&& value) {
    m_inputSecurityGroupIdsHasBeenSet = true;
    m_inputSecurityGroupIds.emplace_back(std::forward<InputSecurityGroupIdsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMultiplexIds(MultiplexIdsT&& value) {
    m_multiplexIdsHasBeenSet = true;
    m_multiplexIds = std::forward<MultiplexIdsT>(value);
  }
  template <typename MultiplexIdsT = Aws::Vector<Aws::String>>
  BatchDeleteRequest& WithMultiplexIds(MultiplexIdsT&& value) {
    SetMultiplexIds(std::forward<MultiplexIdsT>(value));
    return *this;
  }
  template <typename MultiplexIdsT = Aws::String>
  BatchDeleteRequest& AddMultiplexIds(MultiplexIdsT&& value) {
    m_multiplexIdsHasBeenSet = true;
    m_multiplexIds.emplace_back(std::forward<MultiplexIdsT>(value));
    return *this;
  }
  ///@}
 private:
