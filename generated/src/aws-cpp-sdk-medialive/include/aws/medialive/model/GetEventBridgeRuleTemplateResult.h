...
class GetEventBridgeRuleTemplateResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  GetEventBridgeRuleTemplateResult& WithArn(ArnT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  GetEventBridgeRuleTemplateResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  GetEventBridgeRuleTemplateResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename EventTargetsT = Aws::Vector<EventBridgeRuleTemplateTarget>>
  GetEventBridgeRuleTemplateResult& WithEventTargets(EventTargetsT&& value) {
    SetEventTargets(std::forward<EventTargetsT>(value));
    return *this;
  }
  template <typename EventTargetsT = EventBridgeRuleTemplateTarget>
  GetEventBridgeRuleTemplateResult& AddEventTargets(EventTargetsT&& value) {
    m_eventTargetsHasBeenSet = true;
  ...
  inline GetEventBridgeRuleTemplateResult& WithEventType(EventBridgeRuleTemplateEventType value) {
    SetEventType(value);
    return *this;
  }
  ///@}
  ...
  template <typename GroupIdT = Aws::String>
  GetEventBridgeRuleTemplateResult& WithGroupId(GroupIdT&& value) {
  ...
  template <typename IdT = Aws::String>
  GetEventBridgeRuleTemplateResult& WithId(IdT&& value) {
  ...
  template <typename ModifiedAtT = Aws::Utils::DateTime>
  GetEventBridgeRuleTemplateResult& WithModifiedAt(ModifiedAtT&& value) {
  ...
  template <typename NameT = Aws::String>
  GetEventBridgeRuleTemplateResult& WithName(NameT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  GetEventBridgeRuleTemplateResult& WithTags(TagsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetEventBridgeRuleTemplateResult& WithRequestId(RequestIdT&& value) {
