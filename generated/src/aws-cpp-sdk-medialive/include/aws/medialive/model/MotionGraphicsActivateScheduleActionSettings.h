...
class MotionGraphicsActivateScheduleActionSettings {
 public:
  ...
  inline MotionGraphicsActivateScheduleActionSettings& WithDuration(long long value) {
    SetDuration(value);
    return *this;
  }
  ///@}
  ...
  void SetPasswordParam(PasswordParamT&& value) {
    ...
    m_passwordParam = std::forward<PasswordParamT>(value);
  }
  template <typename PasswordParamT = Aws::String>
  MotionGraphicsActivateScheduleActionSettings& WithPasswordParam(PasswordParamT&& value) {
    SetPasswordParam(std::forward<PasswordParamT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename UrlT = Aws::String>
  MotionGraphicsActivateScheduleActionSettings& WithUrl(UrlT&& value) {
