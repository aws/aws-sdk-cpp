...
namespace Model
{
  ...
  public:
    ...
    template<typename ArnT = Aws::String>
    RestartChannelPipelinesResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename CdiInputSpecificationT = CdiInputSpecification>
    RestartChannelPipelinesResult& WithCdiInputSpecification(CdiInputSpecificationT&& value) { SetCdiInputSpecification(std::forward<CdiInputSpecificationT>(value)); return *this;}
    ///@}
    ...
    inline RestartChannelPipelinesResult& WithChannelClass(ChannelClass value) { SetChannelClass(value); return *this;}
    ///@}
...
one destination per
    ...
    template<typename DestinationsT = Aws::Vector<OutputDestination>>
    RestartChannelPipelinesResult& WithDestinations(DestinationsT&& value) { SetDestinations(std::forward<DestinationsT>(value)); return *this;}
    template<typename DestinationsT = OutputDestination>
    RestartChannelPipelinesResult& AddDestinations(DestinationsT&& value) { m_destinationsHasBeenSet = true; m_destinations.emplace_back(std::forward<DestinationsT>(value)); return *this; }
    ///@}
    ...
    template<typename EgressEndpointsT = Aws::Vector<ChannelEgressEndpoint>>
    RestartChannelPipelinesResult& WithEgressEndpoints(EgressEndpointsT&& value) { SetEgressEndpoints(std::forward<EgressEndpointsT>(value)); return *this;}
    template<typename EgressEndpointsT = ChannelEgressEndpoint>
    RestartChannelPipelinesResult& AddEgressEndpoints(EgressEndpointsT&& value) { m_egressEndpointsHasBeenSet = true; m_egressEndpoints.emplace_back(std::forward<EgressEndpointsT>(value)); return *this; }
    ///@}
    ...
    template<typename EncoderSettingsT = EncoderSettings>
    RestartChannelPipelinesResult& WithEncoderSettings(EncoderSettingsT&& value) { SetEncoderSettings(std::forward<EncoderSettingsT>(value)); return *this;}
    ///@}
    ...
    template<typename IdT = Aws::String>
    RestartChannelPipelinesResult& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename InputAttachmentsT = Aws::Vector<InputAttachment>>
    RestartChannelPipelinesResult& WithInputAttachments(InputAttachmentsT&& value) { SetInputAttachments(std::forward<InputAttachmentsT>(value)); return *this;}
    template<typename InputAttachmentsT = InputAttachment>
    RestartChannelPipelinesResult& AddInputAttachments(InputAttachmentsT&& value) { m_inputAttachmentsHasBeenSet = true; m_inputAttachments.emplace_back(std::forward<InputAttachmentsT>(value)); return *this; }
    ///@}
    ...
    template<typename InputSpecificationT = InputSpecification>
    RestartChannelPipelinesResult& WithInputSpecification(InputSpecificationT&& value) { SetInputSpecification(std::forward<InputSpecificationT>(value)); return *this;}
    ///@}
    ...
    inline RestartChannelPipelinesResult& WithLogLevel(LogLevel value) { SetLogLevel(value); return *this;}
    ///@}
    ...
    template<typename MaintenanceT = MaintenanceStatus>
    RestartChannelPipelinesResult& WithMaintenance(MaintenanceT&& value) { SetMaintenance(std::forward<MaintenanceT>(value)); return *this;}
    ///@}
    ...
    template<typename MaintenanceStatusT = Aws::String>
    void SetMaintenanceStatus(MaintenanceStatusT&& value) { m_maintenanceStatusHasBeenSet = true; m_maintenanceStatus = std::forward<MaintenanceStatusT>(value); }
    template<typename MaintenanceStatusT = Aws::String>
    RestartChannelPipelinesResult& WithMaintenanceStatus(MaintenanceStatusT&& value) { SetMaintenanceStatus(std::forward<MaintenanceStatusT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    RestartChannelPipelinesResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename PipelineDetailsT = Aws::Vector<PipelineDetail>>
    RestartChannelPipelinesResult& WithPipelineDetails(PipelineDetailsT&& value) { SetPipelineDetails(std::forward<PipelineDetailsT>(value)); return *this;}
    template<typename PipelineDetailsT = PipelineDetail>
    RestartChannelPipelinesResult& AddPipelineDetails(PipelineDetailsT&& value) { m_pipelineDetailsHasBeenSet = true; m_pipelineDetails.emplace_back(std::forward<PipelineDetailsT>(value)); return *this; }
    ///@}
    ...
    template<typename RoleArnT = Aws::String>
    RestartChannelPipelinesResult& WithRoleArn(RoleArnT&& value) { SetRoleArn(std::forward<RoleArnT>(value)); return *this;}
    ///@}
    ...
    inline RestartChannelPipelinesResult& WithState(ChannelState value) { SetState(value); return *this;}
    ///@}
    ...
    template<typename TagsT = Aws::Map<Aws::String, Aws::String>>
    RestartChannelPipelinesResult& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
    ...
    template<typename VpcT = VpcOutputSettingsDescription>
    RestartChannelPipelinesResult& WithVpc(VpcT&& value) { SetVpc(std::forward<VpcT>(value)); return *this;}
    ///@}
    ...
    template<typename AnywhereSettingsT = DescribeAnywhereSettings>
    RestartChannelPipelinesResult& WithAnywhereSettings(AnywhereSettingsT&& value) { SetAnywhereSettings(std::forward<AnywhereSettingsT>(value)); return *this;}
    ///@}
    ...
    template<typename ChannelEngineVersionT = ChannelEngineVersionResponse>
    RestartChannelPipelinesResult& WithChannelEngineVersion(ChannelEngineVersionT&& value) { SetChannelEngineVersion(std::forward<ChannelEngineVersionT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    RestartChannelPipelinesResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
