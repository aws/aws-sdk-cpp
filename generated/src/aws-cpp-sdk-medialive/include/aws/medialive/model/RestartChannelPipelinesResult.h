...
class RestartChannelPipelinesResult {
 public:
  ...
  inline RestartChannelPipelinesResult& WithChannelClass(ChannelClass value) {
...
one destination per
  ...
  template <typename IdT = Aws::String>
  RestartChannelPipelinesResult& WithId(IdT&& value) {
  ...
  inline RestartChannelPipelinesResult& WithLogLevel(LogLevel value) {
    SetLogLevel(value);
    return *this;
  }
  ///@}
  ...
  void SetMaintenanceStatus(MaintenanceStatusT&& value) {
    m_maintenanceStatusHasBeenSet = true;
    m_maintenanceStatus = std::forward<MaintenanceStatusT>(value);
  }
  template <typename MaintenanceStatusT = Aws::String>
  RestartChannelPipelinesResult& WithMaintenanceStatus(MaintenanceStatusT&& value) {
    SetMaintenanceStatus(std::forward<MaintenanceStatusT>(value));
    return *this;
  }
  ///@}
  ...
  inline RestartChannelPipelinesResult& WithPipelinesRunningCount(int value) {
  ...
  inline RestartChannelPipelinesResult& WithState(ChannelState value) {
    SetState(value);
    return *this;
  }
  ///@}
