...
namespace Model
{
  ...
  {
  public:
    AWS_MEDIALIVE_API CancelInputDeviceTransferResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    CancelInputDeviceTransferResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
