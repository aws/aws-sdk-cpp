...
class ColorCorrection {
 public:
  ...
  inline ColorCorrection& WithInputColorSpace(ColorSpace value) {
  ...
  inline ColorCorrection& WithOutputColorSpace(ColorSpace value) {
  ...
  template <typename UriT = Aws::String>
  ColorCorrection& WithUri(UriT&& value) {
