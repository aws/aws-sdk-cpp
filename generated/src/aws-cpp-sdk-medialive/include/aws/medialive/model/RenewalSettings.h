...
class RenewalSettings {
 public:
  ...
  inline void SetAutomaticRenewal(ReservationAutomaticRenewal value) {
    m_automaticRenewalHasBeenSet = true;
    m_automaticRenewal = value;
  }
  inline RenewalSettings& WithAutomaticRenewal(ReservationAutomaticRenewal value) {
    SetAutomaticRenewal(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRenewalCount(int value) {
    m_renewalCountHasBeenSet = true;
    m_renewalCount = value;
  }
  inline RenewalSettings& WithRenewalCount(int value) {
    SetRenewalCount(value);
    return *this;
  }
  ///@}
 private:
