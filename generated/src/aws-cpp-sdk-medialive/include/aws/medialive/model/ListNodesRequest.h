...
namespace Model
{
  ...
  /**
   * Placeholder documentation for ListNodesRequest<p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/medialive-2017-10-14/ListNodesRequest">AWS
   * API Reference</a></p>
   */
  class ListNodesRequest : public MediaLiveRequest
  {
  public:
    AWS_MEDIALIVE_API ListNodesRequest();
    ...
    inline ListNodesRequest& WithClusterId(const Aws::String& value) { SetClusterId(value); return *this;}
    inline ListNodesRequest& WithClusterId(Aws::String&& value) { SetClusterId(std::move(value)); return *this;}
    inline ListNodesRequest& WithClusterId(const char* value) { SetClusterId(value); return *this;}
    ///@}
