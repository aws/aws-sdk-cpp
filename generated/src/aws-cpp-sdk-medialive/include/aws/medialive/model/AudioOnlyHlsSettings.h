...
The image is attached to the audio as an ID3 tag,
  ...
  void SetAudioOnlyImage(AudioOnlyImageT&& value) {
    ...
    m_audioOnlyImage = std::forward<AudioOnlyImageT>(value);
  }
  template <typename AudioOnlyImageT = InputLocation>
  AudioOnlyHlsSettings& WithAudioOnlyImage(AudioOnlyImageT&& value) {
    SetAudioOnlyImage(std::forward<AudioOnlyImageT>(value));
    return *this;
  }
  ///@}
...
Alternate rendition that the client will not try to play
  ...
  inline void SetAudioTrackType(AudioOnlyHlsTrackType value) {
    m_audioTrackTypeHasBeenSet = true;
    m_audioTrackType = value;
  }
  inline AudioOnlyHlsSettings& WithAudioTrackType(AudioOnlyHlsTrackType value) {
  ...
  inline void SetSegmentType(AudioOnlyHlsSegmentType value) {
    m_segmentTypeHasBeenSet = true;
    m_segmentType = value;
  }
  inline AudioOnlyHlsSettings& WithSegmentType(AudioOnlyHlsSegmentType value) {
