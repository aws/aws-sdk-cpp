...
class ArchiveCdnSettings {
 public:
  ...
  void SetArchiveS3Settings(ArchiveS3SettingsT&& value) {
    m_archiveS3SettingsHasBeenSet = true;
    m_archiveS3Settings = std::forward<ArchiveS3SettingsT>(value);
  }
  template <typename ArchiveS3SettingsT = ArchiveS3Settings>
  ArchiveCdnSettings& WithArchiveS3Settings(ArchiveS3SettingsT&& value) {
    SetArchiveS3Settings(std::forward<ArchiveS3SettingsT>(value));
    return *this;
  }
  ///@}
 private:
