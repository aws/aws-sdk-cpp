...
class UpdateEventBridgeRuleTemplateGroupRequest : public MediaLiveRequest {
 public:
  ...
  template <typename DescriptionT = Aws::String>
  UpdateEventBridgeRuleTemplateGroupRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename IdentifierT = Aws::String>
  UpdateEventBridgeRuleTemplateGroupRequest& WithIdentifier(IdentifierT&& value) {
