...
class InputSourceRequest {
 public:
  AWS_MEDIALIVE_API InputSourceRequest() = default;
  ...
  template <typename PasswordParamT = Aws::String>
  InputSourceRequest& WithPasswordParam(PasswordParamT&& value) {
...
pulled from.
  ...
  template <typename UrlT = Aws::String>
  InputSourceRequest& WithUrl(UrlT&& value) {
  ...
  template <typename UsernameT = Aws::String>
  InputSourceRequest& WithUsername(UsernameT&& value) {
