...
class ListInputDeviceTransfersResult {
 public:
  ...
  void SetInputDeviceTransfers(InputDeviceTransfersT&& value) {
    m_inputDeviceTransfersHasBeenSet = true;
    m_inputDeviceTransfers = std::forward<InputDeviceTransfersT>(value);
  }
  template <typename InputDeviceTransfersT = Aws::Vector<TransferringInputDeviceSummary>>
  ListInputDeviceTransfersResult& WithInputDeviceTransfers(InputDeviceTransfersT&& value) {
    SetInputDeviceTransfers(std::forward<InputDeviceTransfersT>(value));
    return *this;
  }
  template <typename InputDeviceTransfersT = TransferringInputDeviceSummary>
  ListInputDeviceTransfersResult& AddInputDeviceTransfers(InputDeviceTransfersT&& value) {
    m_inputDeviceTransfersHasBeenSet = true;
    m_inputDeviceTransfers.emplace_back(std::forward<InputDeviceTransfersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListInputDeviceTransfersResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListInputDeviceTransfersResult& WithRequestId(RequestIdT&& value) {
