...
namespace Model
{
  ...
  /**
   * Placeholder documentation for ListNetworksRequest<p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/medialive-2017-10-14/ListNetworksRequest">AWS
   * API Reference</a></p>
   */
  class ListNetworksRequest : public MediaLiveRequest
  {
  public:
    AWS_MEDIALIVE_API ListNetworksRequest() = default;
