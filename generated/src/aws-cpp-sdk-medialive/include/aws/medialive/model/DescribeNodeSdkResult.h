...
class DescribeNodeSdkResult {
 public:
  ...
  inline DescribeNodeSdkResult& WithConnectionState(NodeConnectionState value) {
  ...
  inline DescribeNodeSdkResult& WithRole(NodeRole value) {
    SetRole(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeNodeSdkResult& WithState(NodeState value) {
    SetState(value);
    return *this;
  }
  ///@}
