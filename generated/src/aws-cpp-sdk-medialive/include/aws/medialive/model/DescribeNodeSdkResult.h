...
namespace Model
{
  ...
  public:
    ...
    template<typename ArnT = Aws::String>
    DescribeNodeSdkResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ChannelPlacementGroupsT = Aws::Vector<Aws::String>>
    DescribeNodeSdkResult& WithChannelPlacementGroups(ChannelPlacementGroupsT&& value) { SetChannelPlacementGroups(std::forward<ChannelPlacementGroupsT>(value)); return *this;}
    template<typename ChannelPlacementGroupsT = Aws::String>
    DescribeNodeSdkResult& AddChannelPlacementGroups(ChannelPlacementGroupsT&& value) { m_channelPlacementGroupsHasBeenSet = true; m_channelPlacementGroups.emplace_back(std::forward<ChannelPlacementGroupsT>(value)); return *this; }
    ///@}
    ...
    template<typename ClusterIdT = Aws::String>
    DescribeNodeSdkResult& WithClusterId(ClusterIdT&& value) { SetClusterId(std::forward<ClusterIdT>(value)); return *this;}
    ///@}
    ...
    inline DescribeNodeSdkResult& WithConnectionState(NodeConnectionState value) { SetConnectionState(value); return *this;}
    ///@}
    ...
    template<typename IdT = Aws::String>
    DescribeNodeSdkResult& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename InstanceArnT = Aws::String>
    DescribeNodeSdkResult& WithInstanceArn(InstanceArnT&& value) { SetInstanceArn(std::forward<InstanceArnT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    DescribeNodeSdkResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename NodeInterfaceMappingsT = Aws::Vector<NodeInterfaceMapping>>
    DescribeNodeSdkResult& WithNodeInterfaceMappings(NodeInterfaceMappingsT&& value) { SetNodeInterfaceMappings(std::forward<NodeInterfaceMappingsT>(value)); return *this;}
    template<typename NodeInterfaceMappingsT = NodeInterfaceMapping>
    DescribeNodeSdkResult& AddNodeInterfaceMappings(NodeInterfaceMappingsT&& value) { m_nodeInterfaceMappingsHasBeenSet = true; m_nodeInterfaceMappings.emplace_back(std::forward<NodeInterfaceMappingsT>(value)); return *this; }
    ///@}
    ...
    inline DescribeNodeSdkResult& WithRole(NodeRole value) { SetRole(value); return *this;}
    ///@}
    ...
    inline DescribeNodeSdkResult& WithState(NodeState value) { SetState(value); return *this;}
    ///@}
    ...
    template<typename SdiSourceMappingsT = Aws::Vector<SdiSourceMapping>>
    DescribeNodeSdkResult& WithSdiSourceMappings(SdiSourceMappingsT&& value) { SetSdiSourceMappings(std::forward<SdiSourceMappingsT>(value)); return *this;}
    template<typename SdiSourceMappingsT = SdiSourceMapping>
    DescribeNodeSdkResult& AddSdiSourceMappings(SdiSourceMappingsT&& value) { m_sdiSourceMappingsHasBeenSet = true; m_sdiSourceMappings.emplace_back(std::forward<SdiSourceMappingsT>(value)); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DescribeNodeSdkResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
