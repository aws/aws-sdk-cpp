...
namespace Model
{
  ...
  public:
    ...
    inline ClaimDeviceResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ClaimDeviceResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ClaimDeviceResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
