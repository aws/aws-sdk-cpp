...
class UpdateSdiSourceRequest : public MediaLiveRequest {
 public:
  ...
  inline void SetMode(SdiSourceMode value) {
    m_modeHasBeenSet = true;
    m_mode = value;
  }
  inline UpdateSdiSourceRequest& WithMode(SdiSourceMode value) {
    SetMode(value);
    return *this;
  }
  ///@}
  ...
  inline void SetType(SdiSourceType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline UpdateSdiSourceRequest& WithType(SdiSourceType value) {
    SetType(value);
    return *this;
  }
  ///@}
