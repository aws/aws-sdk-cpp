...
class MultiplexProgramPipelineDetail {
 public:
  ...
  void SetActiveChannelPipeline(ActiveChannelPipelineT&& value) {
    m_activeChannelPipelineHasBeenSet = true;
    m_activeChannelPipeline = std::forward<ActiveChannelPipelineT>(value);
  }
  template <typename ActiveChannelPipelineT = Aws::String>
  MultiplexProgramPipelineDetail& WithActiveChannelPipeline(ActiveChannelPipelineT&& value) {
    SetActiveChannelPipeline(std::forward<ActiveChannelPipelineT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename PipelineIdT = Aws::String>
  MultiplexProgramPipelineDetail& WithPipelineId(PipelineIdT&& value) {
