...
one destination per
    ...
    inline StopChannelResult& WithAnywhereSettings(const DescribeAnywhereSettings& value) { SetAnywhereSettings(value); return *this;}
    ...
    inline StopChannelResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}
    inline StopChannelResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}
    inline StopChannelResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
    ///@}
  private:
