...
namespace Model
{
  ...
  {
  public:
    AWS_MEDIALIVE_API StopChannelResult() = default;
    ...
    template<typename ArnT = Aws::String>
    StopChannelResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename CdiInputSpecificationT = CdiInputSpecification>
    StopChannelResult& WithCdiInputSpecification(CdiInputSpecificationT&& value) { SetCdiInputSpecification(std::forward<CdiInputSpecificationT>(value)); return *this;}
    ///@}
    ...
    inline StopChannelResult& WithChannelClass(ChannelClass value) { SetChannelClass(value); return *this;}
    ///@}
...
one destination per
    ...
    template<typename DestinationsT = Aws::Vector<OutputDestination>>
    StopChannelResult& WithDestinations(DestinationsT&& value) { SetDestinations(std::forward<DestinationsT>(value)); return *this;}
    template<typename DestinationsT = OutputDestination>
    StopChannelResult& AddDestinations(DestinationsT&& value) { m_destinationsHasBeenSet = true; m_destinations.emplace_back(std::forward<DestinationsT>(value)); return *this; }
    ///@}
    ...
    template<typename EgressEndpointsT = Aws::Vector<ChannelEgressEndpoint>>
    StopChannelResult& WithEgressEndpoints(EgressEndpointsT&& value) { SetEgressEndpoints(std::forward<EgressEndpointsT>(value)); return *this;}
    template<typename EgressEndpointsT = ChannelEgressEndpoint>
    StopChannelResult& AddEgressEndpoints(EgressEndpointsT&& value) { m_egressEndpointsHasBeenSet = true; m_egressEndpoints.emplace_back(std::forward<EgressEndpointsT>(value)); return *this; }
    ///@}
    ...
    template<typename EncoderSettingsT = EncoderSettings>
    StopChannelResult& WithEncoderSettings(EncoderSettingsT&& value) { SetEncoderSettings(std::forward<EncoderSettingsT>(value)); return *this;}
    ///@}
    ...
    template<typename IdT = Aws::String>
    StopChannelResult& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename InputAttachmentsT = Aws::Vector<InputAttachment>>
    StopChannelResult& WithInputAttachments(InputAttachmentsT&& value) { SetInputAttachments(std::forward<InputAttachmentsT>(value)); return *this;}
    template<typename InputAttachmentsT = InputAttachment>
    StopChannelResult& AddInputAttachments(InputAttachmentsT&& value) { m_inputAttachmentsHasBeenSet = true; m_inputAttachments.emplace_back(std::forward<InputAttachmentsT>(value)); return *this; }
    ///@}
    ...
    template<typename InputSpecificationT = InputSpecification>
    StopChannelResult& WithInputSpecification(InputSpecificationT&& value) { SetInputSpecification(std::forward<InputSpecificationT>(value)); return *this;}
    ///@}
    ...
    inline StopChannelResult& WithLogLevel(LogLevel value) { SetLogLevel(value); return *this;}
    ///@}
    ...
    template<typename MaintenanceT = MaintenanceStatus>
    StopChannelResult& WithMaintenance(MaintenanceT&& value) { SetMaintenance(std::forward<MaintenanceT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    StopChannelResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename PipelineDetailsT = Aws::Vector<PipelineDetail>>
    StopChannelResult& WithPipelineDetails(PipelineDetailsT&& value) { SetPipelineDetails(std::forward<PipelineDetailsT>(value)); return *this;}
    template<typename PipelineDetailsT = PipelineDetail>
    StopChannelResult& AddPipelineDetails(PipelineDetailsT&& value) { m_pipelineDetailsHasBeenSet = true; m_pipelineDetails.emplace_back(std::forward<PipelineDetailsT>(value)); return *this; }
    ///@}
    ...
    template<typename RoleArnT = Aws::String>
    StopChannelResult& WithRoleArn(RoleArnT&& value) { SetRoleArn(std::forward<RoleArnT>(value)); return *this;}
    ///@}
    ...
    inline StopChannelResult& WithState(ChannelState value) { SetState(value); return *this;}
    ///@}
    ...
    template<typename TagsT = Aws::Map<Aws::String, Aws::String>>
    StopChannelResult& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
    template<typename TagsKeyT = Aws::String, typename TagsValueT = Aws::String>
    StopChannelResult& AddTags(TagsKeyT&& key, TagsValueT&& value) {
    ...
    template<typename VpcT = VpcOutputSettingsDescription>
    StopChannelResult& WithVpc(VpcT&& value) { SetVpc(std::forward<VpcT>(value)); return *this;}
    ///@}
    ...
    template<typename AnywhereSettingsT = DescribeAnywhereSettings>
    StopChannelResult& WithAnywhereSettings(AnywhereSettingsT&& value) { SetAnywhereSettings(std::forward<AnywhereSettingsT>(value)); return *this;}
    ///@}
    ...
    template<typename ChannelEngineVersionT = ChannelEngineVersionResponse>
    StopChannelResult& WithChannelEngineVersion(ChannelEngineVersionT&& value) { SetChannelEngineVersion(std::forward<ChannelEngineVersionT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    StopChannelResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
