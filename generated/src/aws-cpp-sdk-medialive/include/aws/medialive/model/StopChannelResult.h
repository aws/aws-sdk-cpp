...
class StopChannelResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  StopChannelResult& WithArn(ArnT&& value) {
  ...
  template <typename CdiInputSpecificationT = CdiInputSpecification>
  StopChannelResult& WithCdiInputSpecification(CdiInputSpecificationT&& value) {
  ...
  inline void SetChannelClass(ChannelClass value) {
    m_channelClassHasBeenSet = true;
    m_channelClass = value;
  }
  inline StopChannelResult& WithChannelClass(ChannelClass value) {
...
one destination per
  ...
  template <typename DestinationsT = Aws::Vector<OutputDestination>>
  StopChannelResult& WithDestinations(DestinationsT&& value) {
    SetDestinations(std::forward<DestinationsT>(value));
    return *this;
  }
  template <typename DestinationsT = OutputDestination>
  StopChannelResult& AddDestinations(DestinationsT&& value) {
    m_destinationsHasBeenSet = true;
  ...
  template <typename EgressEndpointsT = Aws::Vector<ChannelEgressEndpoint>>
  StopChannelResult& WithEgressEndpoints(EgressEndpointsT&& value) {
    SetEgressEndpoints(std::forward<EgressEndpointsT>(value));
    return *this;
  }
  template <typename EgressEndpointsT = ChannelEgressEndpoint>
  StopChannelResult& AddEgressEndpoints(EgressEndpointsT&& value) {
    m_egressEndpointsHasBeenSet = true;
  ...
  template <typename EncoderSettingsT = EncoderSettings>
  StopChannelResult& WithEncoderSettings(EncoderSettingsT&& value) {
  ...
  template <typename IdT = Aws::String>
  StopChannelResult& WithId(IdT&& value) {
  ...
  template <typename InputAttachmentsT = Aws::Vector<InputAttachment>>
  StopChannelResult& WithInputAttachments(InputAttachmentsT&& value) {
    SetInputAttachments(std::forward<InputAttachmentsT>(value));
    return *this;
  }
  template <typename InputAttachmentsT = InputAttachment>
  StopChannelResult& AddInputAttachments(InputAttachmentsT&& value) {
    m_inputAttachmentsHasBeenSet = true;
  ...
  template <typename InputSpecificationT = InputSpecification>
  StopChannelResult& WithInputSpecification(InputSpecificationT&& value) {
  ...
  inline StopChannelResult& WithLogLevel(LogLevel value) {
    SetLogLevel(value);
    return *this;
  }
  ///@}
  ...
  template <typename MaintenanceT = MaintenanceStatus>
  StopChannelResult& WithMaintenance(MaintenanceT&& value) {
  ...
  template <typename NameT = Aws::String>
  StopChannelResult& WithName(NameT&& value) {
  ...
  template <typename PipelineDetailsT = Aws::Vector<PipelineDetail>>
  StopChannelResult& WithPipelineDetails(PipelineDetailsT&& value) {
    SetPipelineDetails(std::forward<PipelineDetailsT>(value));
    return *this;
  }
  template <typename PipelineDetailsT = PipelineDetail>
  StopChannelResult& AddPipelineDetails(PipelineDetailsT&& value) {
    m_pipelineDetailsHasBeenSet = true;
  ...
  inline StopChannelResult& WithPipelinesRunningCount(int value) {
  ...
  template <typename RoleArnT = Aws::String>
  StopChannelResult& WithRoleArn(RoleArnT&& value) {
  ...
  inline void SetState(ChannelState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline StopChannelResult& WithState(ChannelState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  StopChannelResult& WithTags(TagsT&& value) {
  ...
  template <typename VpcT = VpcOutputSettingsDescription>
  StopChannelResult& WithVpc(VpcT&& value) {
  ...
  template <typename AnywhereSettingsT = DescribeAnywhereSettings>
  StopChannelResult& WithAnywhereSettings(AnywhereSettingsT&& value) {
  ...
  template <typename ChannelEngineVersionT = ChannelEngineVersionResponse>
  StopChannelResult& WithChannelEngineVersion(ChannelEngineVersionT&& value) {
  ...
  template <typename LinkedChannelSettingsT = DescribeLinkedChannelSettings>
  StopChannelResult& WithLinkedChannelSettings(LinkedChannelSettingsT&& value) {
  ...
  template <typename ChannelSecurityGroupsT = Aws::Vector<Aws::String>>
  StopChannelResult& WithChannelSecurityGroups(ChannelSecurityGroupsT&& value) {
    SetChannelSecurityGroups(std::forward<ChannelSecurityGroupsT>(value));
    return *this;
  }
  template <typename ChannelSecurityGroupsT = Aws::String>
  StopChannelResult& AddChannelSecurityGroups(ChannelSecurityGroupsT&& value) {
    m_channelSecurityGroupsHasBeenSet = true;
  ...
  template <typename InferenceSettingsT = DescribeInferenceSettings>
  StopChannelResult& WithInferenceSettings(InferenceSettingsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StopChannelResult& WithRequestId(RequestIdT&& value) {
