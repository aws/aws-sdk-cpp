...
class ListEventBridgeRuleTemplateGroupsRequest : public MediaLiveRequest {
 public:
  ...
  inline ListEventBridgeRuleTemplateGroupsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListEventBridgeRuleTemplateGroupsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename SignalMapIdentifierT = Aws::String>
  ListEventBridgeRuleTemplateGroupsRequest& WithSignalMapIdentifier(SignalMapIdentifierT&& value) {
