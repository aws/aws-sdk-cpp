...
class UpdateNetworkSdkResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  UpdateNetworkSdkResult& WithArn(ArnT&& value) {
  ...
  template <typename AssociatedClusterIdsT = Aws::Vector<Aws::String>>
  UpdateNetworkSdkResult& WithAssociatedClusterIds(AssociatedClusterIdsT&& value) {
    SetAssociatedClusterIds(std::forward<AssociatedClusterIdsT>(value));
    return *this;
  }
  template <typename AssociatedClusterIdsT = Aws::String>
  UpdateNetworkSdkResult& AddAssociatedClusterIds(AssociatedClusterIdsT&& value) {
    m_associatedClusterIdsHasBeenSet = true;
  ...
  template <typename IdT = Aws::String>
  UpdateNetworkSdkResult& WithId(IdT&& value) {
  ...
  template <typename IpPoolsT = Aws::Vector<IpPool>>
  UpdateNetworkSdkResult& WithIpPools(IpPoolsT&& value) {
    SetIpPools(std::forward<IpPoolsT>(value));
    return *this;
  }
  template <typename IpPoolsT = IpPool>
  UpdateNetworkSdkResult& AddIpPools(IpPoolsT&& value) {
    m_ipPoolsHasBeenSet = true;
  ...
  template <typename NameT = Aws::String>
  UpdateNetworkSdkResult& WithName(NameT&& value) {
  ...
  template <typename RoutesT = Aws::Vector<Route>>
  UpdateNetworkSdkResult& WithRoutes(RoutesT&& value) {
    SetRoutes(std::forward<RoutesT>(value));
    return *this;
  }
  template <typename RoutesT = Route>
  UpdateNetworkSdkResult& AddRoutes(RoutesT&& value) {
    m_routesHasBeenSet = true;
  ...
  inline UpdateNetworkSdkResult& WithState(NetworkState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  UpdateNetworkSdkResult& WithRequestId(RequestIdT&& value) {
