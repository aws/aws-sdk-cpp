...
class ListEventBridgeRuleTemplatesRequest : public MediaLiveRequest {
 public:
  ...
  template <typename GroupIdentifierT = Aws::String>
  ListEventBridgeRuleTemplatesRequest& WithGroupIdentifier(GroupIdentifierT&& value) {
  ...
  inline ListEventBridgeRuleTemplatesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListEventBridgeRuleTemplatesRequest& WithNextToken(NextTokenT&& value) {
  ...
  void SetSignalMapIdentifier(SignalMapIdentifierT&& value) {
    m_signalMapIdentifierHasBeenSet = true;
    m_signalMapIdentifier = std::forward<SignalMapIdentifierT>(value);
  }
  template <typename SignalMapIdentifierT = Aws::String>
  ListEventBridgeRuleTemplatesRequest& WithSignalMapIdentifier(SignalMapIdentifierT&& value) {
    SetSignalMapIdentifier(std::forward<SignalMapIdentifierT>(value));
    return *this;
  }
  ///@}
 private:
