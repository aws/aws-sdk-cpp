...
namespace Model
{
  ...
  public:
    ...
    inline MediaPackageV2GroupSettings& WithId3Behavior(CmafId3Behavior value) { SetId3Behavior(value); return *this;}
    ///@}
    ...
    inline MediaPackageV2GroupSettings& WithKlvBehavior(CmafKLVBehavior value) { SetKlvBehavior(value); return *this;}
    ///@}
    ...
    inline MediaPackageV2GroupSettings& WithNielsenId3Behavior(CmafNielsenId3Behavior value) { SetNielsenId3Behavior(value); return *this;}
    ///@}
    ...
    inline MediaPackageV2GroupSettings& WithScte35Type(Scte35Type value) { SetScte35Type(value); return *this;}
    ///@}
    ...
    inline MediaPackageV2GroupSettings& WithSegmentLength(int value) { SetSegmentLength(value); return *this;}
    ///@}
    ...
    inline MediaPackageV2GroupSettings& WithSegmentLengthUnits(CmafIngestSegmentLengthUnits value) { SetSegmentLengthUnits(value); return *this;}
    ///@}
    ...
    inline MediaPackageV2GroupSettings& WithTimedMetadataId3Frame(CmafTimedMetadataId3Frame value) { SetTimedMetadataId3Frame(value); return *this;}
    ///@}
    ...
    inline MediaPackageV2GroupSettings& WithTimedMetadataId3Period(int value) { SetTimedMetadataId3Period(value); return *this;}
    ///@}
    ...
    inline MediaPackageV2GroupSettings& WithTimedMetadataPassthrough(CmafTimedMetadataPassthrough value) { SetTimedMetadataPassthrough(value); return *this;}
    ///@}
  private:
