...
class AacSettings {
 public:
  ...
  inline AacSettings& WithBitrate(double value) {
    SetBitrate(value);
    return *this;
  }
  ///@}
...
Leave set to "normal" when input does not contain pre-mixed
  ...
  inline void SetInputType(AacInputType value) {
    m_inputTypeHasBeenSet = true;
    m_inputType = value;
  }
  inline AacSettings& WithInputType(AacInputType value) {
    SetInputType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetProfile(AacProfile value) {
    m_profileHasBeenSet = true;
    m_profile = value;
  }
  inline AacSettings& WithProfile(AacProfile value) {
    SetProfile(value);
    return *this;
  }
  ///@}
  ...
  inline AacSettings& WithSampleRate(double value) {
    SetSampleRate(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSpec(AacSpec value) {
    m_specHasBeenSet = true;
    m_spec = value;
  }
  inline AacSettings& WithSpec(AacSpec value) {
    SetSpec(value);
    return *this;
  }
  ///@}
