...
When this field is
  ...
  inline void SetConstantBitrate(int value) {
    m_constantBitrateHasBeenSet = true;
    m_constantBitrate = value;
  }
  inline MultiplexVideoSettings& WithConstantBitrate(int value) {
    SetConstantBitrate(value);
    return *this;
  }
  ///@}
...
When this field is defined, ConstantBitrate must
  ...
  void SetStatmuxSettings(StatmuxSettingsT&& value) {
    m_statmuxSettingsHasBeenSet = true;
    m_statmuxSettings = std::forward<StatmuxSettingsT>(value);
  }
  template <typename StatmuxSettingsT = MultiplexStatmuxVideoSettings>
  MultiplexVideoSettings& WithStatmuxSettings(StatmuxSettingsT&& value) {
    SetStatmuxSettings(std::forward<StatmuxSettingsT>(value));
    return *this;
  }
  ///@}
 private:
