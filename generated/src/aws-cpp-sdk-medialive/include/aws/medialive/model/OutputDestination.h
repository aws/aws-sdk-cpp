...
class OutputDestination {
 public:
  ...
  void SetMediaPackageSettings(MediaPackageSettingsT&& value) {
    ...
    m_mediaPackageSettings = std::forward<MediaPackageSettingsT>(value);
  }
  template <typename MediaPackageSettingsT = Aws::Vector<MediaPackageOutputDestinationSettings>>
  OutputDestination& WithMediaPackageSettings(MediaPackageSettingsT&& value) {
    SetMediaPackageSettings(std::forward<MediaPackageSettingsT>(value));
    return *this;
  }
  ...
  OutputDestination& AddMediaPackageSettings(MediaPackageSettingsT&& value) {
    m_mediaPackageSettingsHasBeenSet = true;
    m_mediaPackageSettings.emplace_back(std::forward<MediaPackageSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  OutputDestination& AddSrtSettings(SrtSettingsT&& value) {
    m_srtSettingsHasBeenSet = true;
    m_srtSettings.emplace_back(std::forward<SrtSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLogicalInterfaceNames(LogicalInterfaceNamesT&& value) {
    ...
    m_logicalInterfaceNames = std::forward<LogicalInterfaceNamesT>(value);
  }
  template <typename LogicalInterfaceNamesT = Aws::Vector<Aws::String>>
  OutputDestination& WithLogicalInterfaceNames(LogicalInterfaceNamesT&& value) {
    SetLogicalInterfaceNames(std::forward<LogicalInterfaceNamesT>(value));
    return *this;
  }
  ...
  OutputDestination& AddLogicalInterfaceNames(LogicalInterfaceNamesT&& value) {
    m_logicalInterfaceNamesHasBeenSet = true;
    m_logicalInterfaceNames.emplace_back(std::forward<LogicalInterfaceNamesT>(value));
    return *this;
  }
  ///@}
 private:
