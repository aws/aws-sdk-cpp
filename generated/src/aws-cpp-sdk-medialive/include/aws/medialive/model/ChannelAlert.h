...
namespace Model
{
  ...
  /**
   * An alert on a channel<p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/medialive-2017-10-14/ChannelAlert">AWS
   * API Reference</a></p>
   */
  class ChannelAlert
  {
  public:
    ...
    template<typename AlertTypeT = Aws::String>
    ChannelAlert& WithAlertType(AlertTypeT&& value) { SetAlertType(std::forward<AlertTypeT>(value)); return *this;}
    ///@}
    ...
    template<typename ClearedTimestampT = Aws::Utils::DateTime>
    ChannelAlert& WithClearedTimestamp(ClearedTimestampT&& value) { SetClearedTimestamp(std::forward<ClearedTimestampT>(value)); return *this;}
    ///@}
    ...
    template<typename IdT = Aws::String>
    ChannelAlert& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename MessageT = Aws::String>
    ChannelAlert& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
    ...
    template<typename PipelineIdT = Aws::String>
    ChannelAlert& WithPipelineId(PipelineIdT&& value) { SetPipelineId(std::forward<PipelineIdT>(value)); return *this;}
    ///@}
    ...
    template<typename SetTimestampT = Aws::Utils::DateTime>
    ChannelAlert& WithSetTimestamp(SetTimestampT&& value) { SetSetTimestamp(std::forward<SetTimestampT>(value)); return *this;}
    ///@}
     ...
     */
    inline ChannelAlertState GetState() const { return m_state; }
    inline bool StateHasBeenSet() const { return m_stateHasBeenSet; }
    inline void SetState(ChannelAlertState value) { m_stateHasBeenSet = true; m_state = value; }
    inline ChannelAlert& WithState(ChannelAlertState value) { SetState(value); return *this;}
    ///@}
  private:
