...
class InputDestinationVpc {
 public:
  AWS_MEDIALIVE_API InputDestinationVpc() = default;
  ...
  template <typename AvailabilityZoneT = Aws::String>
  InputDestinationVpc& WithAvailabilityZone(AvailabilityZoneT&& value) {
  ...
  template <typename NetworkInterfaceIdT = Aws::String>
  InputDestinationVpc& WithNetworkInterfaceId(NetworkInterfaceIdT&& value) {
