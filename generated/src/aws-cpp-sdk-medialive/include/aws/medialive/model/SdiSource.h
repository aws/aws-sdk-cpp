 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/medialive-2017-10-14/SdiSource">AWS
 * API Reference</a></p>
 */
class SdiSource {
 public:
  ...
  inline SdiSource& WithMode(SdiSourceMode value) {
    SetMode(value);
    return *this;
  }
  ///@}
  ...
  inline void SetState(SdiSourceState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline SdiSource& WithState(SdiSourceState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline SdiSource& WithType(SdiSourceType value) {
    SetType(value);
    return *this;
  }
  ///@}
