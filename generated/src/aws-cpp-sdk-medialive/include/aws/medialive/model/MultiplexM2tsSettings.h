...
class MultiplexM2tsSettings {
 public:
  ...
  inline MultiplexM2tsSettings& WithAbsentInputAudioBehavior(M2tsAbsentInputAudioBehavior value) {
  ...
  inline MultiplexM2tsSettings& WithArib(M2tsArib value) {
    SetArib(value);
    return *this;
  }
  ///@}
  ...
  inline MultiplexM2tsSettings& WithAudioBufferModel(M2tsAudioBufferModel value) {
  ...
  inline MultiplexM2tsSettings& WithAudioFramesPerPes(int value) {
  ...
  inline MultiplexM2tsSettings& WithAudioStreamType(M2tsAudioStreamType value) {
  ...
  inline MultiplexM2tsSettings& WithCcDescriptor(M2tsCcDescriptor value) {
  ...
  inline MultiplexM2tsSettings& WithEbif(M2tsEbifControl value) {
    SetEbif(value);
    return *this;
  }
  ///@}
  ...
  inline MultiplexM2tsSettings& WithEsRateInPes(M2tsEsRateInPes value) {
  ...
  inline MultiplexM2tsSettings& WithKlv(M2tsKlv value) {
    SetKlv(value);
    return *this;
  }
  ///@}
  ...
  inline MultiplexM2tsSettings& WithNielsenId3Behavior(M2tsNielsenId3Behavior value) {
  ...
  inline MultiplexM2tsSettings& WithPcrControl(M2tsPcrControl value) {
    SetPcrControl(value);
    return *this;
  }
  ///@}
  ...
  inline MultiplexM2tsSettings& WithPcrPeriod(int value) {
    SetPcrPeriod(value);
    return *this;
  }
  ///@}
  ...
  inline MultiplexM2tsSettings& WithScte35Control(M2tsScte35Control value) {
  ...
  inline MultiplexM2tsSettings& WithScte35PrerollPullupMilliseconds(double value) {
