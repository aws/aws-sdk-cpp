...
class InputDeviceConfigurableAudioChannelPairConfig {
 public:
  ...
  inline InputDeviceConfigurableAudioChannelPairConfig& WithId(int value) {
    SetId(value);
    return *this;
  }
  ///@}
  ...
  inline void SetProfile(InputDeviceConfigurableAudioChannelPairProfile value) {
    m_profileHasBeenSet = true;
    m_profile = value;
  }
  inline InputDeviceConfigurableAudioChannelPairConfig& WithProfile(InputDeviceConfigurableAudioChannelPairProfile value) {
    SetProfile(value);
    return *this;
  }
  ///@}
