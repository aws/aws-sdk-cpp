...
Only specify sources for PULL type Inputs. Leave
  ...
  inline CreateInputRequest& WithType(InputType value) {
    SetType(value);
    return *this;
  }
  ///@}
...
an input in a customer network.
  ...
  inline CreateInputRequest& WithInputNetworkLocation(InputNetworkLocation value) {
  ...
  inline const RouterSettings& GetRouterSettings() const { return m_routerSettings; }
  inline bool RouterSettingsHasBeenSet() const { return m_routerSettingsHasBeenSet; }
  template <typename RouterSettingsT = RouterSettings>
