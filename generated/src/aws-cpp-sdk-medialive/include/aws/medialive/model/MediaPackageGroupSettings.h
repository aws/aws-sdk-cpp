...
class MediaPackageGroupSettings {
 public:
  ...
  void SetMediapackageV2GroupSettings(MediapackageV2GroupSettingsT&& value) {
    ...
    m_mediapackageV2GroupSettings = std::forward<MediapackageV2GroupSettingsT>(value);
  }
  template <typename MediapackageV2GroupSettingsT = MediaPackageV2GroupSettings>
  MediaPackageGroupSettings& WithMediapackageV2GroupSettings(MediapackageV2GroupSettingsT&& value) {
    SetMediapackageV2GroupSettings(std::forward<MediapackageV2GroupSettingsT>(value));
    return *this;
  }
  ///@}
 private:
