...
namespace Model
{
  ...
  public:
    ...
    template<typename ArnT = Aws::String>
    GetSignalMapResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename CloudWatchAlarmTemplateGroupIdsT = Aws::Vector<Aws::String>>
    GetSignalMapResult& WithCloudWatchAlarmTemplateGroupIds(CloudWatchAlarmTemplateGroupIdsT&& value) { SetCloudWatchAlarmTemplateGroupIds(std::forward<CloudWatchAlarmTemplateGroupIdsT>(value)); return *this;}
    template<typename CloudWatchAlarmTemplateGroupIdsT = Aws::String>
    GetSignalMapResult& AddCloudWatchAlarmTemplateGroupIds(CloudWatchAlarmTemplateGroupIdsT&& value) { m_cloudWatchAlarmTemplateGroupIdsHasBeenSet = true; m_cloudWatchAlarmTemplateGroupIds.emplace_back(std::forward<CloudWatchAlarmTemplateGroupIdsT>(value)); return *this; }
    ///@}
    ...
    template<typename CreatedAtT = Aws::Utils::DateTime>
    GetSignalMapResult& WithCreatedAt(CreatedAtT&& value) { SetCreatedAt(std::forward<CreatedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    GetSignalMapResult& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename DiscoveryEntryPointArnT = Aws::String>
    GetSignalMapResult& WithDiscoveryEntryPointArn(DiscoveryEntryPointArnT&& value) { SetDiscoveryEntryPointArn(std::forward<DiscoveryEntryPointArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ErrorMessageT = Aws::String>
    GetSignalMapResult& WithErrorMessage(ErrorMessageT&& value) { SetErrorMessage(std::forward<ErrorMessageT>(value)); return *this;}
    ///@}
    ...
    template<typename EventBridgeRuleTemplateGroupIdsT = Aws::Vector<Aws::String>>
    GetSignalMapResult& WithEventBridgeRuleTemplateGroupIds(EventBridgeRuleTemplateGroupIdsT&& value) { SetEventBridgeRuleTemplateGroupIds(std::forward<EventBridgeRuleTemplateGroupIdsT>(value)); return *this;}
    template<typename EventBridgeRuleTemplateGroupIdsT = Aws::String>
    GetSignalMapResult& AddEventBridgeRuleTemplateGroupIds(EventBridgeRuleTemplateGroupIdsT&& value) { m_eventBridgeRuleTemplateGroupIdsHasBeenSet = true; m_eventBridgeRuleTemplateGroupIds.emplace_back(std::forward<EventBridgeRuleTemplateGroupIdsT>(value)); return *this; }
    ///@}
    ...
    template<typename FailedMediaResourceMapT = Aws::Map<Aws::String, MediaResource>>
    GetSignalMapResult& WithFailedMediaResourceMap(FailedMediaResourceMapT&& value) { SetFailedMediaResourceMap(std::forward<FailedMediaResourceMapT>(value)); return *this;}
    ...
    template<typename IdT = Aws::String>
    GetSignalMapResult& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename LastDiscoveredAtT = Aws::Utils::DateTime>
    GetSignalMapResult& WithLastDiscoveredAt(LastDiscoveredAtT&& value) { SetLastDiscoveredAt(std::forward<LastDiscoveredAtT>(value)); return *this;}
    ///@}
    ...
    template<typename LastSuccessfulMonitorDeploymentT = SuccessfulMonitorDeployment>
    GetSignalMapResult& WithLastSuccessfulMonitorDeployment(LastSuccessfulMonitorDeploymentT&& value) { SetLastSuccessfulMonitorDeployment(std::forward<LastSuccessfulMonitorDeploymentT>(value)); return *this;}
    ///@}
    ...
    template<typename MediaResourceMapT = Aws::Map<Aws::String, MediaResource>>
    GetSignalMapResult& WithMediaResourceMap(MediaResourceMapT&& value) { SetMediaResourceMap(std::forward<MediaResourceMapT>(value)); return *this;}
    ...
    template<typename ModifiedAtT = Aws::Utils::DateTime>
    GetSignalMapResult& WithModifiedAt(ModifiedAtT&& value) { SetModifiedAt(std::forward<ModifiedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename MonitorDeploymentT = MonitorDeployment>
    GetSignalMapResult& WithMonitorDeployment(MonitorDeploymentT&& value) { SetMonitorDeployment(std::forward<MonitorDeploymentT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    GetSignalMapResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    inline GetSignalMapResult& WithStatus(SignalMapStatus value) { SetStatus(value); return *this;}
    ///@}
    ...
    template<typename TagsT = Aws::Map<Aws::String, Aws::String>>
    GetSignalMapResult& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
    ...
    template<typename RequestIdT = Aws::String>
    GetSignalMapResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
