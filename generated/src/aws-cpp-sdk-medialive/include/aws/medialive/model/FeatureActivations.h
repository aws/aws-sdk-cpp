...
If you disable the feature on an
  ...
  inline void SetInputPrepareScheduleActions(FeatureActivationsInputPrepareScheduleActions value) {
    m_inputPrepareScheduleActionsHasBeenSet = true;
    m_inputPrepareScheduleActions = value;
  }
  inline FeatureActivations& WithInputPrepareScheduleActions(FeatureActivationsInputPrepareScheduleActions value) {
    SetInputPrepareScheduleActions(value);
    return *this;
  }
  ///@}
...
to display/clear/modify image overlays on
   ...
   */
  inline FeatureActivationsOutputStaticImageOverlayScheduleActions GetOutputStaticImageOverlayScheduleActions() const {
    return m_outputStaticImageOverlayScheduleActions;
  }
  ...
  inline void SetOutputStaticImageOverlayScheduleActions(FeatureActivationsOutputStaticImageOverlayScheduleActions value) {
    m_outputStaticImageOverlayScheduleActionsHasBeenSet = true;
    m_outputStaticImageOverlayScheduleActions = value;
  }
  inline FeatureActivations& WithOutputStaticImageOverlayScheduleActions(FeatureActivationsOutputStaticImageOverlayScheduleActions value) {
    SetOutputStaticImageOverlayScheduleActions(value);
    return *this;
  }
  ///@}
 private:
