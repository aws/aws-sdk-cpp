...
class DescribeOfferingResult {
 public:
  ...
  inline DescribeOfferingResult& WithDuration(int value) {
    SetDuration(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeOfferingResult& WithDurationUnits(OfferingDurationUnits value) {
  ...
  inline DescribeOfferingResult& WithFixedPrice(double value) {
    SetFixedPrice(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeOfferingResult& WithOfferingType(OfferingType value) {
  ...
  inline DescribeOfferingResult& WithUsagePrice(double value) {
    SetUsagePrice(value);
    return *this;
  }
  ///@}
