...
class AudioCodecSettings {
 public:
  ...
  void SetAacSettings(AacSettingsT&& value) {
    m_aacSettingsHasBeenSet = true;
    m_aacSettings = std::forward<AacSettingsT>(value);
  }
  template <typename AacSettingsT = AacSettings>
  AudioCodecSettings& WithAacSettings(AacSettingsT&& value) {
    SetAacSettings(std::forward<AacSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAc3Settings(Ac3SettingsT&& value) {
    m_ac3SettingsHasBeenSet = true;
    m_ac3Settings = std::forward<Ac3SettingsT>(value);
  }
  template <typename Ac3SettingsT = Ac3Settings>
  ...
  void SetEac3AtmosSettings(Eac3AtmosSettingsT&& value) {
    ...
    m_eac3AtmosSettings = std::forward<Eac3AtmosSettingsT>(value);
  }
  template <typename Eac3AtmosSettingsT = Eac3AtmosSettings>
  AudioCodecSettings& WithEac3AtmosSettings(Eac3AtmosSettingsT&& value) {
    SetEac3AtmosSettings(std::forward<Eac3AtmosSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEac3Settings(Eac3SettingsT&& value) {
    ...
    m_eac3Settings = std::forward<Eac3SettingsT>(value);
  }
  template <typename Eac3SettingsT = Eac3Settings>
  AudioCodecSettings& WithEac3Settings(Eac3SettingsT&& value) {
    SetEac3Settings(std::forward<Eac3SettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMp2Settings(Mp2SettingsT&& value) {
    m_mp2SettingsHasBeenSet = true;
    m_mp2Settings = std::forward<Mp2SettingsT>(value);
  }
  template <typename Mp2SettingsT = Mp2Settings>
  AudioCodecSettings& WithMp2Settings(Mp2SettingsT&& value) {
    SetMp2Settings(std::forward<Mp2SettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetWavSettings(WavSettingsT&& value) {
    m_wavSettingsHasBeenSet = true;
    m_wavSettings = std::forward<WavSettingsT>(value);
  }
  template <typename WavSettingsT = WavSettings>
  AudioCodecSettings& WithWavSettings(WavSettingsT&& value) {
    SetWavSettings(std::forward<WavSettingsT>(value));
    return *this;
  }
  ///@}
 private:
