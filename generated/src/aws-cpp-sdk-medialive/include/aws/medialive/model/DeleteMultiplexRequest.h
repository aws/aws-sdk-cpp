...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class DeleteMultiplexRequest : public MediaLiveRequest
  {
  public:
    AWS_MEDIALIVE_API DeleteMultiplexRequest() = default;
    ...
    template<typename MultiplexIdT = Aws::String>
    DeleteMultiplexRequest& WithMultiplexId(MultiplexIdT&& value) { SetMultiplexId(std::forward<MultiplexIdT>(value)); return *this;}
    ///@}
  private:
