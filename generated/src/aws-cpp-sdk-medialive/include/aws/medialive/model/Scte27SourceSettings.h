...
provide the language to consider when translating
  ...
  inline void SetOcrLanguage(Scte27OcrLanguage value) {
    m_ocrLanguageHasBeenSet = true;
    m_ocrLanguage = value;
  }
  inline Scte27SourceSettings& WithOcrLanguage(Scte27OcrLanguage value) {
...
- Omit PID and omit Language:
  ...
  inline Scte27SourceSettings& WithPid(int value) {
    SetPid(value);
    return *this;
  }
  ///@}
