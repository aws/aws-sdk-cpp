...
class ClusterNetworkSettingsCreateRequest {
 public:
  ...
  template <typename DefaultRouteT = Aws::String>
  ClusterNetworkSettingsCreateRequest& WithDefaultRoute(DefaultRouteT&& value) {
  ...
  template <typename InterfaceMappingsT = Aws::Vector<InterfaceMappingCreateRequest>>
  ClusterNetworkSettingsCreateRequest& WithInterfaceMappings(InterfaceMappingsT&& value) {
  ...
  ClusterNetworkSettingsCreateRequest& AddInterfaceMappings(InterfaceMappingsT&& value) {
    m_interfaceMappingsHasBeenSet = true;
