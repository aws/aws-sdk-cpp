...
class ListCloudWatchAlarmTemplatesResult {
 public:
  ...
  void SetCloudWatchAlarmTemplates(CloudWatchAlarmTemplatesT&& value) {
    m_cloudWatchAlarmTemplatesHasBeenSet = true;
    m_cloudWatchAlarmTemplates = std::forward<CloudWatchAlarmTemplatesT>(value);
  }
  template <typename CloudWatchAlarmTemplatesT = Aws::Vector<CloudWatchAlarmTemplateSummary>>
  ListCloudWatchAlarmTemplatesResult& WithCloudWatchAlarmTemplates(CloudWatchAlarmTemplatesT&& value) {
    SetCloudWatchAlarmTemplates(std::forward<CloudWatchAlarmTemplatesT>(value));
    return *this;
  }
  template <typename CloudWatchAlarmTemplatesT = CloudWatchAlarmTemplateSummary>
  ListCloudWatchAlarmTemplatesResult& AddCloudWatchAlarmTemplates(CloudWatchAlarmTemplatesT&& value) {
    m_cloudWatchAlarmTemplatesHasBeenSet = true;
    m_cloudWatchAlarmTemplates.emplace_back(std::forward<CloudWatchAlarmTemplatesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListCloudWatchAlarmTemplatesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListCloudWatchAlarmTemplatesResult& WithRequestId(RequestIdT&& value) {
