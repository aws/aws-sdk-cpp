...
namespace Model
{
  ...
  /**
   * Used in ClusterNetworkSettingsCreateRequest.<p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/medialive-2017-10-14/InterfaceMappingCreateRequest">AWS
   * API Reference</a></p>
   */
  class InterfaceMappingCreateRequest
  {
  public:
    AWS_MEDIALIVE_API InterfaceMappingCreateRequest();
    ...
    inline InterfaceMappingCreateRequest& WithLogicalInterfaceName(const Aws::String& value) { SetLogicalInterfaceName(value); return *this;}
    inline InterfaceMappingCreateRequest& WithLogicalInterfaceName(Aws::String&& value) { SetLogicalInterfaceName(std::move(value)); return *this;}
    inline InterfaceMappingCreateRequest& WithLogicalInterfaceName(const char* value) { SetLogicalInterfaceName(value); return *this;}
    ///@}
    ...
    inline InterfaceMappingCreateRequest& WithNetworkId(const Aws::String& value) { SetNetworkId(value); return *this;}
    inline InterfaceMappingCreateRequest& WithNetworkId(Aws::String&& value) { SetNetworkId(std::move(value)); return *this;}
    inline InterfaceMappingCreateRequest& WithNetworkId(const char* value) { SetNetworkId(value); return *this;}
    ///@}
  private:
