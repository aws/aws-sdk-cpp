...
namespace Model
{
  ...
  {
  public:
    AWS_MEDIALIVE_API InterfaceMappingCreateRequest() = default;
    ...
    template<typename LogicalInterfaceNameT = Aws::String>
    InterfaceMappingCreateRequest& WithLogicalInterfaceName(LogicalInterfaceNameT&& value) { SetLogicalInterfaceName(std::forward<LogicalInterfaceNameT>(value)); return *this;}
    ///@}
    ...
    template<typename NetworkIdT = Aws::String>
    InterfaceMappingCreateRequest& WithNetworkId(NetworkIdT&& value) { SetNetworkId(std::forward<NetworkIdT>(value)); return *this;}
    ///@}
  private:
