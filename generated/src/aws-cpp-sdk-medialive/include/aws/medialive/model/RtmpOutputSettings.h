...
class RtmpOutputSettings {
 public:
  ...
  inline void SetCertificateMode(RtmpOutputCertificateMode value) {
    m_certificateModeHasBeenSet = true;
    m_certificateMode = value;
  }
  inline RtmpOutputSettings& WithCertificateMode(RtmpOutputCertificateMode value) {
  ...
  inline RtmpOutputSettings& WithConnectionRetryInterval(int value) {
  ...
  inline RtmpOutputSettings& WithNumRetries(int value) {
    SetNumRetries(value);
    return *this;
  }
  ///@}
