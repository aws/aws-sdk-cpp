...
class CreateCloudWatchAlarmTemplateGroupRequest : public MediaLiveRequest {
 public:
  ...
  template <typename DescriptionT = Aws::String>
  CreateCloudWatchAlarmTemplateGroupRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateCloudWatchAlarmTemplateGroupRequest& WithName(NameT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateCloudWatchAlarmTemplateGroupRequest& WithTags(TagsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateCloudWatchAlarmTemplateGroupRequest& WithRequestId(RequestIdT&& value) {
