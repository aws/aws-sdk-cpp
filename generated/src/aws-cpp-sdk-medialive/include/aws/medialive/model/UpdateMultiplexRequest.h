...
class UpdateMultiplexRequest : public MediaLiveRequest {
 public:
  ...
  inline const Aws::Map<Aws::String, MultiplexProgramPacketIdentifiersMap>& GetPacketIdentifiersMapping() const {
    return m_packetIdentifiersMapping;
  }
  ...
  void SetPacketIdentifiersMapping(PacketIdentifiersMappingT&& value) {
    m_packetIdentifiersMappingHasBeenSet = true;
    m_packetIdentifiersMapping = std::forward<PacketIdentifiersMappingT>(value);
  }
  template <typename PacketIdentifiersMappingT = Aws::Map<Aws::String, MultiplexProgramPacketIdentifiersMap>>
  UpdateMultiplexRequest& WithPacketIdentifiersMapping(PacketIdentifiersMappingT&& value) {
    SetPacketIdentifiersMapping(std::forward<PacketIdentifiersMappingT>(value));
    return *this;
  }
  template <typename PacketIdentifiersMappingKeyT = Aws::String,
  ...
  UpdateMultiplexRequest& AddPacketIdentifiersMapping(PacketIdentifiersMappingKeyT&& key, PacketIdentifiersMappingValueT&& value) {
    m_packetIdentifiersMappingHasBeenSet = true;
    m_packetIdentifiersMapping.emplace(std::forward<PacketIdentifiersMappingKeyT>(key),
                                       std::forward<PacketIdentifiersMappingValueT>(value));
    return *this;
  }
  ///@}
 private:
