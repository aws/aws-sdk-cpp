...
class AutomaticInputFailoverSettings {
 public:
  ...
  inline void SetErrorClearTimeMsec(int value) {
    m_errorClearTimeMsecHasBeenSet = true;
    m_errorClearTimeMsec = value;
  }
  inline AutomaticInputFailoverSettings& WithErrorClearTimeMsec(int value) {
    SetErrorClearTimeMsec(value);
    return *this;
  }
  ///@}
  ...
  void SetFailoverConditions(FailoverConditionsT&& value) {
    m_failoverConditionsHasBeenSet = true;
    m_failoverConditions = std::forward<FailoverConditionsT>(value);
  }
  template <typename FailoverConditionsT = Aws::Vector<FailoverCondition>>
  AutomaticInputFailoverSettings& WithFailoverConditions(FailoverConditionsT&& value) {
    SetFailoverConditions(std::forward<FailoverConditionsT>(value));
    return *this;
  }
  ...
  AutomaticInputFailoverSettings& AddFailoverConditions(FailoverConditionsT&& value) {
    m_failoverConditionsHasBeenSet = true;
    m_failoverConditions.emplace_back(std::forward<FailoverConditionsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetInputPreference(InputPreference value) {
    m_inputPreferenceHasBeenSet = true;
    m_inputPreference = value;
  }
  inline AutomaticInputFailoverSettings& WithInputPreference(InputPreference value) {
    SetInputPreference(value);
    return *this;
  }
  ///@}
  ...
  void SetSecondaryInputId(SecondaryInputIdT&& value) {
    m_secondaryInputIdHasBeenSet = true;
    m_secondaryInputId = std::forward<SecondaryInputIdT>(value);
  }
  template <typename SecondaryInputIdT = Aws::String>
  AutomaticInputFailoverSettings& WithSecondaryInputId(SecondaryInputIdT&& value) {
    SetSecondaryInputId(std::forward<SecondaryInputIdT>(value));
    return *this;
  }
  ///@}
 private:
