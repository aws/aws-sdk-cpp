...
namespace Model
{
  ...
  public:
    ...
    template<typename AlertTypeT = Aws::String>
    MultiplexAlert& WithAlertType(AlertTypeT&& value) { SetAlertType(std::forward<AlertTypeT>(value)); return *this;}
    ///@}
    ...
    template<typename ClearedTimestampT = Aws::Utils::DateTime>
    MultiplexAlert& WithClearedTimestamp(ClearedTimestampT&& value) { SetClearedTimestamp(std::forward<ClearedTimestampT>(value)); return *this;}
    ///@}
    ...
    template<typename IdT = Aws::String>
    MultiplexAlert& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename MessageT = Aws::String>
    MultiplexAlert& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
    ...
    template<typename PipelineIdT = Aws::String>
    MultiplexAlert& WithPipelineId(PipelineIdT&& value) { SetPipelineId(std::forward<PipelineIdT>(value)); return *this;}
    ///@}
    ...
    template<typename SetTimestampT = Aws::Utils::DateTime>
    MultiplexAlert& WithSetTimestamp(SetTimestampT&& value) { SetSetTimestamp(std::forward<SetTimestampT>(value)); return *this;}
    ///@}
    ...
    inline void SetState(MultiplexAlertState value) { m_stateHasBeenSet = true; m_state = value; }
    inline MultiplexAlert& WithState(MultiplexAlertState value) { SetState(value); return *this;}
    ///@}
  private:
