...
class MediaPackageOutputSettings {
 public:
   ...
   */
  inline const MediaPackageV2DestinationSettings& GetMediaPackageV2DestinationSettings() const {
    return m_mediaPackageV2DestinationSettings;
  }
  ...
  void SetMediaPackageV2DestinationSettings(MediaPackageV2DestinationSettingsT&& value) {
    m_mediaPackageV2DestinationSettingsHasBeenSet = true;
    m_mediaPackageV2DestinationSettings = std::forward<MediaPackageV2DestinationSettingsT>(value);
  }
  template <typename MediaPackageV2DestinationSettingsT = MediaPackageV2DestinationSettings>
  MediaPackageOutputSettings& WithMediaPackageV2DestinationSettings(MediaPackageV2DestinationSettingsT&& value) {
    SetMediaPackageV2DestinationSettings(std::forward<MediaPackageV2DestinationSettingsT>(value));
    return *this;
  }
  ///@}
 private:
