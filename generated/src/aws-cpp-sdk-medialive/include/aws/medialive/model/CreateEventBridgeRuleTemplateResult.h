...
class CreateEventBridgeRuleTemplateResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  CreateEventBridgeRuleTemplateResult& WithArn(ArnT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  CreateEventBridgeRuleTemplateResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateEventBridgeRuleTemplateResult& WithDescription(DescriptionT&& value) {
  ...
  void SetEventTargets(EventTargetsT&& value) {
    m_eventTargetsHasBeenSet = true;
    m_eventTargets = std::forward<EventTargetsT>(value);
  }
  template <typename EventTargetsT = Aws::Vector<EventBridgeRuleTemplateTarget>>
  CreateEventBridgeRuleTemplateResult& WithEventTargets(EventTargetsT&& value) {
    SetEventTargets(std::forward<EventTargetsT>(value));
    return *this;
  }
  template <typename EventTargetsT = EventBridgeRuleTemplateTarget>
  CreateEventBridgeRuleTemplateResult& AddEventTargets(EventTargetsT&& value) {
    m_eventTargetsHasBeenSet = true;
    m_eventTargets.emplace_back(std::forward<EventTargetsT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateEventBridgeRuleTemplateResult& WithEventType(EventBridgeRuleTemplateEventType value) {
    SetEventType(value);
    return *this;
  }
  ///@}
  ...
  template <typename GroupIdT = Aws::String>
  CreateEventBridgeRuleTemplateResult& WithGroupId(GroupIdT&& value) {
  ...
  template <typename IdT = Aws::String>
  CreateEventBridgeRuleTemplateResult& WithId(IdT&& value) {
  ...
  template <typename ModifiedAtT = Aws::Utils::DateTime>
  CreateEventBridgeRuleTemplateResult& WithModifiedAt(ModifiedAtT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateEventBridgeRuleTemplateResult& WithName(NameT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateEventBridgeRuleTemplateResult& WithTags(TagsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateEventBridgeRuleTemplateResult& WithRequestId(RequestIdT&& value) {
