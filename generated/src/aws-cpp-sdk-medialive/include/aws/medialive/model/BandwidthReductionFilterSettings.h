...
content.
  ...
  inline void SetPostFilterSharpening(BandwidthReductionPostFilterSharpening value) {
    m_postFilterSharpeningHasBeenSet = true;
    m_postFilterSharpening = value;
  }
  inline BandwidthReductionFilterSettings& WithPostFilterSharpening(BandwidthReductionPostFilterSharpening value) {
...
enable this filter and use AUTO, to let MediaLive
  ...
  inline void SetStrength(BandwidthReductionFilterStrength value) {
    m_strengthHasBeenSet = true;
    m_strength = value;
  }
  inline BandwidthReductionFilterSettings& WithStrength(BandwidthReductionFilterStrength value) {
    SetStrength(value);
    return *this;
  }
  ///@}
