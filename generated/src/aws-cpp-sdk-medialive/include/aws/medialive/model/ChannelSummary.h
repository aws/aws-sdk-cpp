...
class ChannelSummary {
 public:
  ...
  inline ChannelSummary& WithChannelClass(ChannelClass value) {
...
one destination per
  ...
  inline ChannelSummary& WithLogLevel(LogLevel value) {
    SetLogLevel(value);
    return *this;
  }
  ///@}
  ...
  inline ChannelSummary& WithPipelinesRunningCount(int value) {
  ...
  inline ChannelSummary& WithState(ChannelState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  void SetUsedChannelEngineVersions(UsedChannelEngineVersionsT&& value) {
    ...
    m_usedChannelEngineVersions = std::forward<UsedChannelEngineVersionsT>(value);
  }
  template <typename UsedChannelEngineVersionsT = Aws::Vector<ChannelEngineVersionResponse>>
  ChannelSummary& WithUsedChannelEngineVersions(UsedChannelEngineVersionsT&& value) {
    SetUsedChannelEngineVersions(std::forward<UsedChannelEngineVersionsT>(value));
    return *this;
  }
  ...
  ChannelSummary& AddUsedChannelEngineVersions(UsedChannelEngineVersionsT&& value) {
    m_usedChannelEngineVersionsHasBeenSet = true;
    m_usedChannelEngineVersions.emplace_back(std::forward<UsedChannelEngineVersionsT>(value));
    return *this;
  }
  ///@}
 private:
