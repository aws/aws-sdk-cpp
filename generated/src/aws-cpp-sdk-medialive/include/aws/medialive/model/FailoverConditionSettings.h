...
class FailoverConditionSettings {
 public:
  ...
  void SetAudioSilenceSettings(AudioSilenceSettingsT&& value) {
    ...
    m_audioSilenceSettings = std::forward<AudioSilenceSettingsT>(value);
  }
  template <typename AudioSilenceSettingsT = AudioSilenceFailoverSettings>
  FailoverConditionSettings& WithAudioSilenceSettings(AudioSilenceSettingsT&& value) {
    SetAudioSilenceSettings(std::forward<AudioSilenceSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInputLossSettings(InputLossSettingsT&& value) {
    m_inputLossSettingsHasBeenSet = true;
    m_inputLossSettings = std::forward<InputLossSettingsT>(value);
  }
  template <typename InputLossSettingsT = InputLossFailoverSettings>
  FailoverConditionSettings& WithInputLossSettings(InputLossSettingsT&& value) {
    SetInputLossSettings(std::forward<InputLossSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVideoBlackSettings(VideoBlackSettingsT&& value) {
    m_videoBlackSettingsHasBeenSet = true;
    m_videoBlackSettings = std::forward<VideoBlackSettingsT>(value);
  }
  template <typename VideoBlackSettingsT = VideoBlackFailoverSettings>
  FailoverConditionSettings& WithVideoBlackSettings(VideoBlackSettingsT&& value) {
    SetVideoBlackSettings(std::forward<VideoBlackSettingsT>(value));
    return *this;
  }
  ///@}
 private:
