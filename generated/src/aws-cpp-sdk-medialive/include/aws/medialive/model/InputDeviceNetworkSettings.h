...
class InputDeviceNetworkSettings {
 public:
  ...
  inline void SetIpScheme(InputDeviceIpScheme value) {
    m_ipSchemeHasBeenSet = true;
    m_ipScheme = value;
  }
  inline InputDeviceNetworkSettings& WithIpScheme(InputDeviceIpScheme value) {
    SetIpScheme(value);
    return *this;
  }
  ///@}
  ...
  void SetSubnetMask(SubnetMaskT&& value) {
    m_subnetMaskHasBeenSet = true;
    m_subnetMask = std::forward<SubnetMaskT>(value);
  }
  template <typename SubnetMaskT = Aws::String>
  InputDeviceNetworkSettings& WithSubnetMask(SubnetMaskT&& value) {
    SetSubnetMask(std::forward<SubnetMaskT>(value));
    return *this;
  }
  ///@}
 private:
