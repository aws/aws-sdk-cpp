...
namespace Model
{
  ...
  public:
    ...
    template<typename ArnT = Aws::String>
    CloudWatchAlarmTemplateGroupSummary& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename CreatedAtT = Aws::Utils::DateTime>
    CloudWatchAlarmTemplateGroupSummary& WithCreatedAt(CreatedAtT&& value) { SetCreatedAt(std::forward<CreatedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    CloudWatchAlarmTemplateGroupSummary& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename IdT = Aws::String>
    CloudWatchAlarmTemplateGroupSummary& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename ModifiedAtT = Aws::Utils::DateTime>
    CloudWatchAlarmTemplateGroupSummary& WithModifiedAt(ModifiedAtT&& value) { SetModifiedAt(std::forward<ModifiedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    CloudWatchAlarmTemplateGroupSummary& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename TagsT = Aws::Map<Aws::String, Aws::String>>
    CloudWatchAlarmTemplateGroupSummary& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
