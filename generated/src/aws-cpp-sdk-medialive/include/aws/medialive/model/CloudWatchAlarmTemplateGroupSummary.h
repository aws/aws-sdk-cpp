...
class CloudWatchAlarmTemplateGroupSummary {
 public:
  AWS_MEDIALIVE_API CloudWatchAlarmTemplateGroupSummary() = default;
  ...
  template <typename ArnT = Aws::String>
  CloudWatchAlarmTemplateGroupSummary& WithArn(ArnT&& value) {
  ...
  template <typename IdT = Aws::String>
  CloudWatchAlarmTemplateGroupSummary& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  CloudWatchAlarmTemplateGroupSummary& WithName(NameT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CloudWatchAlarmTemplateGroupSummary& WithTags(TagsT&& value) {
  ...
  inline CloudWatchAlarmTemplateGroupSummary& WithTemplateCount(int value) {
