...
class ListClustersSdkResult {
 public:
  ...
  template <typename ClustersT = Aws::Vector<DescribeClusterSummary>>
  ListClustersSdkResult& WithClusters(ClustersT&& value) {
    SetClusters(std::forward<ClustersT>(value));
    return *this;
  }
  template <typename ClustersT = DescribeClusterSummary>
  ListClustersSdkResult& AddClusters(ClustersT&& value) {
    m_clustersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListClustersSdkResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListClustersSdkResult& WithRequestId(RequestIdT&& value) {
