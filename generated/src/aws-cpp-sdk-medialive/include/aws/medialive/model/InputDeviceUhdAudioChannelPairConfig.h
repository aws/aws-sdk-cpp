...
class InputDeviceUhdAudioChannelPairConfig {
 public:
  ...
  inline InputDeviceUhdAudioChannelPairConfig& WithId(int value) {
    SetId(value);
    return *this;
  }
  ///@}
  ...
  inline void SetProfile(InputDeviceUhdAudioChannelPairProfile value) {
    m_profileHasBeenSet = true;
    m_profile = value;
  }
  inline InputDeviceUhdAudioChannelPairConfig& WithProfile(InputDeviceUhdAudioChannelPairProfile value) {
    SetProfile(value);
    return *this;
  }
  ///@}
