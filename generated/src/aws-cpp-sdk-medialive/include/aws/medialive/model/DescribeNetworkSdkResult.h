...
namespace Model
{
  ...
  {
  public:
    AWS_MEDIALIVE_API DescribeNetworkSdkResult() = default;
    ...
    template<typename ArnT = Aws::String>
    DescribeNetworkSdkResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename AssociatedClusterIdsT = Aws::Vector<Aws::String>>
    DescribeNetworkSdkResult& WithAssociatedClusterIds(AssociatedClusterIdsT&& value) { SetAssociatedClusterIds(std::forward<AssociatedClusterIdsT>(value)); return *this;}
    template<typename AssociatedClusterIdsT = Aws::String>
    DescribeNetworkSdkResult& AddAssociatedClusterIds(AssociatedClusterIdsT&& value) { m_associatedClusterIdsHasBeenSet = true; m_associatedClusterIds.emplace_back(std::forward<AssociatedClusterIdsT>(value)); return *this; }
    ///@}
    ...
    template<typename IdT = Aws::String>
    DescribeNetworkSdkResult& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename IpPoolsT = Aws::Vector<IpPool>>
    DescribeNetworkSdkResult& WithIpPools(IpPoolsT&& value) { SetIpPools(std::forward<IpPoolsT>(value)); return *this;}
    template<typename IpPoolsT = IpPool>
    DescribeNetworkSdkResult& AddIpPools(IpPoolsT&& value) { m_ipPoolsHasBeenSet = true; m_ipPools.emplace_back(std::forward<IpPoolsT>(value)); return *this; }
    ///@}
    ...
    template<typename NameT = Aws::String>
    DescribeNetworkSdkResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename RoutesT = Aws::Vector<Route>>
    DescribeNetworkSdkResult& WithRoutes(RoutesT&& value) { SetRoutes(std::forward<RoutesT>(value)); return *this;}
    template<typename RoutesT = Route>
    DescribeNetworkSdkResult& AddRoutes(RoutesT&& value) { m_routesHasBeenSet = true; m_routes.emplace_back(std::forward<RoutesT>(value)); return *this; }
    ///@}
    ...
    inline DescribeNetworkSdkResult& WithState(NetworkState value) { SetState(value); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DescribeNetworkSdkResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
