...
BatchGetRecordResult::BatchGetRecordResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
BatchGetRecordResult& BatchGetRecordResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("UnprocessedIdentifiers")) {
    ...
    for (unsigned unprocessedIdentifiersIndex = 0; unprocessedIdentifiersIndex < unprocessedIdentifiersJsonList.GetLength();
         ++unprocessedIdentifiersIndex) {
