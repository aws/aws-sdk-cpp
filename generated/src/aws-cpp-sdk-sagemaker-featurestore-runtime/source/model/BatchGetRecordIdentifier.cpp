...
BatchGetRecordIdentifier::BatchGetRecordIdentifier(JsonView jsonValue) { *this = jsonValue; }
...
BatchGetRecordIdentifier& BatchGetRecordIdentifier::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("RecordIdentifiersValueAsString")) {
    ...
    for (unsigned recordIdentifiersValueAsStringIndex = 0;
         recordIdentifiersValueAsStringIndex < recordIdentifiersValueAsStringJsonList.GetLength(); ++recordIdentifiersValueAsStringIndex) {
...
JsonValue BatchGetRecordIdentifier::Jsonize() const {
  ...
  if (m_recordIdentifiersValueAsStringHasBeenSet) {
    ...
    for (unsigned recordIdentifiersValueAsStringIndex = 0;
         recordIdentifiersValueAsStringIndex < recordIdentifiersValueAsStringJsonList.GetLength(); ++recordIdentifiersValueAsStringIndex) {
      recordIdentifiersValueAsStringJsonList[recordIdentifiersValueAsStringIndex].AsString(
          m_recordIdentifiersValueAsString[recordIdentifiersValueAsStringIndex]);
    }
