...
class DeleteRecordRequest : public SageMakerFeatureStoreRuntimeRequest {
 public:
  ...
  template <typename FeatureGroupNameT = Aws::String>
  DeleteRecordRequest& WithFeatureGroupName(FeatureGroupNameT&& value) {
  ...
  template <typename RecordIdentifierValueAsStringT = Aws::String>
  DeleteRecordRequest& WithRecordIdentifierValueAsString(RecordIdentifierValueAsStringT&& value) {
  ...
  template <typename EventTimeT = Aws::String>
  DeleteRecordRequest& WithEventTime(EventTimeT&& value) {
  ...
  template <typename TargetStoresT = Aws::Vector<TargetStore>>
  DeleteRecordRequest& WithTargetStores(TargetStoresT&& value) {
    SetTargetStores(std::forward<TargetStoresT>(value));
    return *this;
  }
  inline DeleteRecordRequest& AddTargetStores(TargetStore value) {
    m_targetStoresHasBeenSet = true;
  ...
  inline DeleteRecordRequest& WithDeletionMode(DeletionMode value) {
