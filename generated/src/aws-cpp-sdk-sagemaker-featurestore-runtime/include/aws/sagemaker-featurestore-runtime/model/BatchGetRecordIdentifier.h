...
class BatchGetRecordIdentifier {
 public:
  ...
  template <typename FeatureGroupNameT = Aws::String>
  BatchGetRecordIdentifier& WithFeatureGroupName(FeatureGroupNameT&& value) {
  ...
  void SetRecordIdentifiersValueAsString(RecordIdentifiersValueAsStringT&& value) {
    m_recordIdentifiersValueAsStringHasBeenSet = true;
    m_recordIdentifiersValueAsString = std::forward<RecordIdentifiersValueAsStringT>(value);
  }
  template <typename RecordIdentifiersValueAsStringT = Aws::Vector<Aws::String>>
  BatchGetRecordIdentifier& WithRecordIdentifiersValueAsString(RecordIdentifiersValueAsStringT&& value) {
    SetRecordIdentifiersValueAsString(std::forward<RecordIdentifiersValueAsStringT>(value));
    return *this;
  }
  template <typename RecordIdentifiersValueAsStringT = Aws::String>
  BatchGetRecordIdentifier& AddRecordIdentifiersValueAsString(RecordIdentifiersValueAsStringT&& value) {
    m_recordIdentifiersValueAsStringHasBeenSet = true;
    m_recordIdentifiersValueAsString.emplace_back(std::forward<RecordIdentifiersValueAsStringT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename FeatureNamesT = Aws::Vector<Aws::String>>
  BatchGetRecordIdentifier& WithFeatureNames(FeatureNamesT&& value) {
    SetFeatureNames(std::forward<FeatureNamesT>(value));
    return *this;
  }
  template <typename FeatureNamesT = Aws::String>
  BatchGetRecordIdentifier& AddFeatureNames(FeatureNamesT&& value) {
    m_featureNamesHasBeenSet = true;
