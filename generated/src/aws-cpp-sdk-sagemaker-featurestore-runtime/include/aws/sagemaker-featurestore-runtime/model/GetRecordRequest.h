...
class GetRecordRequest : public SageMakerFeatureStoreRuntimeRequest {
 public:
  ...
  template <typename FeatureGroupNameT = Aws::String>
  GetRecordRequest& WithFeatureGroupName(FeatureGroupNameT&& value) {
  ...
  template <typename RecordIdentifierValueAsStringT = Aws::String>
  GetRecordRequest& WithRecordIdentifierValueAsString(RecordIdentifierValueAsStringT&& value) {
  ...
  void SetFeatureNames(FeatureNamesT&& value) {
    m_featureNamesHasBeenSet = true;
    m_featureNames = std::forward<FeatureNamesT>(value);
  }
  template <typename FeatureNamesT = Aws::Vector<Aws::String>>
  GetRecordRequest& WithFeatureNames(FeatureNamesT&& value) {
    SetFeatureNames(std::forward<FeatureNamesT>(value));
    return *this;
  }
  template <typename FeatureNamesT = Aws::String>
  GetRecordRequest& AddFeatureNames(FeatureNamesT&& value) {
    m_featureNamesHasBeenSet = true;
    m_featureNames.emplace_back(std::forward<FeatureNamesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetExpirationTimeResponse(ExpirationTimeResponse value) {
    m_expirationTimeResponseHasBeenSet = true;
    m_expirationTimeResponse = value;
  }
  inline GetRecordRequest& WithExpirationTimeResponse(ExpirationTimeResponse value) {
    SetExpirationTimeResponse(value);
    return *this;
  }
  ///@}
 private:
