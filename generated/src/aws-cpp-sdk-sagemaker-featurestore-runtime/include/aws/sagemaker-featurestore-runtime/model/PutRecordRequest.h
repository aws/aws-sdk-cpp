...
class PutRecordRequest : public SageMakerFeatureStoreRuntimeRequest {
 public:
  ...
  template <typename FeatureGroupNameT = Aws::String>
  PutRecordRequest& WithFeatureGroupName(FeatureGroupNameT&& value) {
  ...
  template <typename RecordT = Aws::Vector<FeatureValue>>
  PutRecordRequest& WithRecord(RecordT&& value) {
    SetRecord(std::forward<RecordT>(value));
    return *this;
  }
  template <typename RecordT = FeatureValue>
  PutRecordRequest& AddRecord(RecordT&& value) {
    m_recordHasBeenSet = true;
  ...
  template <typename TargetStoresT = Aws::Vector<TargetStore>>
  PutRecordRequest& WithTargetStores(TargetStoresT&& value) {
    SetTargetStores(std::forward<TargetStoresT>(value));
    return *this;
  }
  inline PutRecordRequest& AddTargetStores(TargetStore value) {
    m_targetStoresHasBeenSet = true;
  ...
  template <typename TtlDurationT = TtlDuration>
  PutRecordRequest& WithTtlDuration(TtlDurationT&& value) {
