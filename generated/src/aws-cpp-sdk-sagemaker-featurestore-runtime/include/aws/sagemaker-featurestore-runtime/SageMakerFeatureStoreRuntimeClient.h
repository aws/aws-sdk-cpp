...
class AWS_SAGEMAKERFEATURESTORERUNTIME_API SageMakerFeatureStoreRuntimeClient
 ...
 public:
  ...
  SageMakerFeatureStoreRuntimeClient(
      const Aws::SageMakerFeatureStoreRuntime::SageMakerFeatureStoreRuntimeClientConfiguration& clientConfiguration =
  ...
  /**
   * An Async wrapper for BatchGetRecord that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename BatchGetRecordRequestT = Model::BatchGetRecordRequest>
  void BatchGetRecordAsync(const BatchGetRecordRequestT& request, const BatchGetRecordResponseReceivedHandler& handler,
  ...
  /**
   * An Async wrapper for DeleteRecord that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteRecordRequestT = Model::DeleteRecordRequest>
  void DeleteRecordAsync(const DeleteRecordRequestT& request, const DeleteRecordResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetRecord that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetRecordRequestT = Model::GetRecordRequest>
