...
namespace SageMakerFeatureStoreRuntime
{
   ...
   * </p> </li> </ul>
   */
  class AWS_SAGEMAKERFEATURESTORERUNTIME_API SageMakerFeatureStoreRuntimeClient : Aws::Client::ClientWithAsyncTemplateMethods<SageMakerFeatureStoreRuntimeClient>,
    smithy::client::AwsSmithyClientT<Aws::SageMakerFeatureStoreRuntime::SERVICE_NAME,
