...
class AWS_PERSONALIZERUNTIME_API PersonalizeRuntimeClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  PersonalizeRuntimeClient(const Aws::PersonalizeRuntime::PersonalizeRuntimeClientConfiguration& clientConfiguration =
  ...
  PersonalizeRuntimeClient(const Aws::Auth::AWSCredentials& credentials,
                           std::shared_ptr<PersonalizeRuntimeEndpointProviderBase> endpointProvider = nullptr,
                           const Aws::PersonalizeRuntime::PersonalizeRuntimeClientConfiguration& clientConfiguration =
                               Aws::PersonalizeRuntime::PersonalizeRuntimeClientConfiguration());
  ...
  /**
   * A Callable wrapper for GetActionRecommendations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename GetActionRecommendationsRequestT = Model::GetActionRecommendationsRequest>
  Model::GetActionRecommendationsOutcomeCallable GetActionRecommendationsCallable(
      const GetActionRecommendationsRequestT& request = {}) const {
    return SubmitCallable(&PersonalizeRuntimeClient::GetActionRecommendations, request);
  }

  /**
   * An Async wrapper for GetActionRecommendations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetActionRecommendationsRequestT = Model::GetActionRecommendationsRequest>
  void GetActionRecommendationsAsync(const GetActionRecommendationsResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for GetPersonalizedRanking that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetPersonalizedRanking that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetPersonalizedRankingRequestT = Model::GetPersonalizedRankingRequest>
  void GetPersonalizedRankingAsync(const GetPersonalizedRankingRequestT& request,
                                   const GetPersonalizedRankingResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for GetRecommendations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetRecommendations that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetRecommendationsRequestT = Model::GetRecommendationsRequest>
  void GetRecommendationsAsync(const GetRecommendationsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const GetRecommendationsRequestT& request = {}) const {
