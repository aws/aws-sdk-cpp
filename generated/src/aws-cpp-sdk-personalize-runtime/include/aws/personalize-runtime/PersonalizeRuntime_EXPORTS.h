...
#ifdef AWS_PERSONALIZERUNTIME_EXPORTS
#define AWS_PERSONALIZERUNTIME_API __declspec(dllexport)
#else
...
#define AWS_PERSONALIZERUNTIME_LOCAL
#else  // defined (USE_WINDOWS_DLL_SEMANTICS) || defined (WIN32)
#define AWS_PERSONALIZERUNTIME_API
#define AWS_PERSONALIZERUNTIME_EXTERN extern
#if __GNUC__ >= 4
#define AWS_PERSONALIZERUNTIME_LOCAL __attribute__((visibility("hidden")))
#else
#define AWS_PERSONALIZERUNTIME_LOCAL
#endif
