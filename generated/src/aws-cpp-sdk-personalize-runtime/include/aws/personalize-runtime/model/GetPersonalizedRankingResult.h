...
class GetPersonalizedRankingResult {
 public:
  ...
  AWS_PERSONALIZERUNTIME_API GetPersonalizedRankingResult& operator=(
  ...
  void SetPersonalizedRanking(PersonalizedRankingT&& value) {
    m_personalizedRankingHasBeenSet = true;
    m_personalizedRanking = std::forward<PersonalizedRankingT>(value);
  }
  template <typename PersonalizedRankingT = Aws::Vector<PredictedItem>>
  GetPersonalizedRankingResult& WithPersonalizedRanking(PersonalizedRankingT&& value) {
    SetPersonalizedRanking(std::forward<PersonalizedRankingT>(value));
    return *this;
  }
  template <typename PersonalizedRankingT = PredictedItem>
  GetPersonalizedRankingResult& AddPersonalizedRanking(PersonalizedRankingT&& value) {
    m_personalizedRankingHasBeenSet = true;
    m_personalizedRanking.emplace_back(std::forward<PersonalizedRankingT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RecommendationIdT = Aws::String>
  GetPersonalizedRankingResult& WithRecommendationId(RecommendationIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetPersonalizedRankingResult& WithRequestId(RequestIdT&& value) {
