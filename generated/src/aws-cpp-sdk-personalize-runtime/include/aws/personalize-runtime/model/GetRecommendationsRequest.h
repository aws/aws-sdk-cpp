...
class GetRecommendationsRequest : public PersonalizeRuntimeRequest {
 public:
  ...
  inline GetRecommendationsRequest& WithNumResults(int value) {
    SetNumResults(value);
    return *this;
  }
  ///@}
  ...
  GetRecommendationsRequest& AddFilterValues(FilterValuesKeyT&& key, FilterValuesValueT&& value) {
    m_filterValuesHasBeenSet = true;
    m_filterValues.emplace(std::forward<FilterValuesKeyT>(key), std::forward<FilterValuesValueT>(value));
    return *this;
  }
  ///@}
  ...
  GetRecommendationsRequest& AddMetadataColumns(MetadataColumnsKeyT&& key, MetadataColumnsValueT&& value) {
    m_metadataColumnsHasBeenSet = true;
    m_metadataColumns.emplace(std::forward<MetadataColumnsKeyT>(key), std::forward<MetadataColumnsValueT>(value));
    return *this;
  }
  ///@}
 private:
