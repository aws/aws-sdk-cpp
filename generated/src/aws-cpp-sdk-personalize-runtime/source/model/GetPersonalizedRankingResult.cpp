...
GetPersonalizedRankingResult::GetPersonalizedRankingResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
GetPersonalizedRankingResult& GetPersonalizedRankingResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("personalizedRanking")) {
    ...
    for (unsigned personalizedRankingIndex = 0; personalizedRankingIndex < personalizedRankingJsonList.GetLength();
         ++personalizedRankingIndex) {
