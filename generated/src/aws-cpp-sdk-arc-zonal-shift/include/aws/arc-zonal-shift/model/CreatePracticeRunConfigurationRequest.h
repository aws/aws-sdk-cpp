...
class CreatePracticeRunConfigurationRequest : public ARCZonalShiftRequest {
 public:
  ...
  template <typename ResourceIdentifierT = Aws::String>
  CreatePracticeRunConfigurationRequest& WithResourceIdentifier(ResourceIdentifierT&& value) {
  ...
  template <typename BlockedWindowsT = Aws::Vector<Aws::String>>
  CreatePracticeRunConfigurationRequest& WithBlockedWindows(BlockedWindowsT&& value) {
    SetBlockedWindows(std::forward<BlockedWindowsT>(value));
    return *this;
  }
  template <typename BlockedWindowsT = Aws::String>
  CreatePracticeRunConfigurationRequest& AddBlockedWindows(BlockedWindowsT&& value) {
    m_blockedWindowsHasBeenSet = true;
  ...
  template <typename BlockedDatesT = Aws::Vector<Aws::String>>
  CreatePracticeRunConfigurationRequest& WithBlockedDates(BlockedDatesT&& value) {
    SetBlockedDates(std::forward<BlockedDatesT>(value));
    return *this;
  }
  template <typename BlockedDatesT = Aws::String>
  CreatePracticeRunConfigurationRequest& AddBlockedDates(BlockedDatesT&& value) {
    m_blockedDatesHasBeenSet = true;
  ...
  template <typename BlockingAlarmsT = Aws::Vector<ControlCondition>>
  CreatePracticeRunConfigurationRequest& WithBlockingAlarms(BlockingAlarmsT&& value) {
    SetBlockingAlarms(std::forward<BlockingAlarmsT>(value));
    return *this;
  }
  template <typename BlockingAlarmsT = ControlCondition>
  CreatePracticeRunConfigurationRequest& AddBlockingAlarms(BlockingAlarmsT&& value) {
    m_blockingAlarmsHasBeenSet = true;
  ...
  template <typename AllowedWindowsT = Aws::Vector<Aws::String>>
  CreatePracticeRunConfigurationRequest& WithAllowedWindows(AllowedWindowsT&& value) {
    SetAllowedWindows(std::forward<AllowedWindowsT>(value));
    return *this;
  }
  template <typename AllowedWindowsT = Aws::String>
  CreatePracticeRunConfigurationRequest& AddAllowedWindows(AllowedWindowsT&& value) {
    m_allowedWindowsHasBeenSet = true;
  ...
  template <typename OutcomeAlarmsT = Aws::Vector<ControlCondition>>
  CreatePracticeRunConfigurationRequest& WithOutcomeAlarms(OutcomeAlarmsT&& value) {
    SetOutcomeAlarms(std::forward<OutcomeAlarmsT>(value));
    return *this;
  }
  template <typename OutcomeAlarmsT = ControlCondition>
  CreatePracticeRunConfigurationRequest& AddOutcomeAlarms(OutcomeAlarmsT&& value) {
    m_outcomeAlarmsHasBeenSet = true;
