...
class ListManagedResourcesResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<ManagedResourceSummary>>
  ListManagedResourcesResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = ManagedResourceSummary>
  ListManagedResourcesResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListManagedResourcesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListManagedResourcesResult& WithRequestId(RequestIdT&& value) {
