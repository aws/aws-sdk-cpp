...
namespace Model
{
  class StartPracticeRunResult
  {
  public:
    AWS_ARCZONALSHIFT_API StartPracticeRunResult() = default;
    AWS_ARCZONALSHIFT_API StartPracticeRunResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_ARCZONALSHIFT_API StartPracticeRunResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ...
    template<typename ZonalShiftIdT = Aws::String>
    StartPracticeRunResult& WithZonalShiftId(ZonalShiftIdT&& value) { SetZonalShiftId(std::forward<ZonalShiftIdT>(value)); return *this;}
    ///@}

    ///@{
    /**
     * <p>The identifier for the resource that you want to shift traffic for. The
    ...
    template<typename ResourceIdentifierT = Aws::String>
    StartPracticeRunResult& WithResourceIdentifier(ResourceIdentifierT&& value) { SetResourceIdentifier(std::forward<ResourceIdentifierT>(value)); return *this;}
    ///@}
    ...
    template<typename AwayFromT = Aws::String>
    StartPracticeRunResult& WithAwayFrom(AwayFromT&& value) { SetAwayFrom(std::forward<AwayFromT>(value)); return *this;}
    ///@}
    ...
    template<typename ExpiryTimeT = Aws::Utils::DateTime>
    StartPracticeRunResult& WithExpiryTime(ExpiryTimeT&& value) { SetExpiryTime(std::forward<ExpiryTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename StartTimeT = Aws::Utils::DateTime>
    StartPracticeRunResult& WithStartTime(StartTimeT&& value) { SetStartTime(std::forward<StartTimeT>(value)); return *this;}
    ///@}
    ...
    inline StartPracticeRunResult& WithStatus(ZonalShiftStatus value) { SetStatus(value); return *this;}
    ///@}
    ...
    template<typename CommentT = Aws::String>
    StartPracticeRunResult& WithComment(CommentT&& value) { SetComment(std::forward<CommentT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    StartPracticeRunResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
