...
class StartZonalShiftRequest : public ARCZonalShiftRequest {
 public:
  ...
  template <typename ResourceIdentifierT = Aws::String>
  StartZonalShiftRequest& WithResourceIdentifier(ResourceIdentifierT&& value) {
  ...
  template <typename AwayFromT = Aws::String>
  StartZonalShiftRequest& WithAwayFrom(AwayFromT&& value) {
  ...
  void SetExpiresIn(ExpiresInT&& value) {
    m_expiresInHasBeenSet = true;
    m_expiresIn = std::forward<ExpiresInT>(value);
  }
  template <typename ExpiresInT = Aws::String>
  StartZonalShiftRequest& WithExpiresIn(ExpiresInT&& value) {
    SetExpiresIn(std::forward<ExpiresInT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename CommentT = Aws::String>
  StartZonalShiftRequest& WithComment(CommentT&& value) {
