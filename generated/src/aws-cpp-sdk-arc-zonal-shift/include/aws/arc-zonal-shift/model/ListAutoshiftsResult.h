...
class ListAutoshiftsResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<AutoshiftSummary>>
  ListAutoshiftsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = AutoshiftSummary>
  ListAutoshiftsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListAutoshiftsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAutoshiftsResult& WithRequestId(RequestIdT&& value) {
