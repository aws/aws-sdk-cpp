...
class UpdateZonalAutoshiftConfigurationResult {
 public:
  ...
  AWS_ARCZONALSHIFT_API UpdateZonalAutoshiftConfigurationResult& operator=(
  ...
  template <typename ResourceIdentifierT = Aws::String>
  UpdateZonalAutoshiftConfigurationResult& WithResourceIdentifier(ResourceIdentifierT&& value) {
  ...
  inline UpdateZonalAutoshiftConfigurationResult& WithZonalAutoshiftStatus(ZonalAutoshiftStatus value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateZonalAutoshiftConfigurationResult& WithRequestId(RequestIdT&& value) {
