...
class CancelZonalShiftResult {
 public:
  ...
  template <typename ZonalShiftIdT = Aws::String>
  CancelZonalShiftResult& WithZonalShiftId(ZonalShiftIdT&& value) {
  ...
  template <typename ResourceIdentifierT = Aws::String>
  CancelZonalShiftResult& WithResourceIdentifier(ResourceIdentifierT&& value) {
  ...
  template <typename AwayFromT = Aws::String>
  CancelZonalShiftResult& WithAwayFrom(AwayFromT&& value) {
  ...
  template <typename ExpiryTimeT = Aws::Utils::DateTime>
  CancelZonalShiftResult& WithExpiryTime(ExpiryTimeT&& value) {
  ...
  template <typename StartTimeT = Aws::Utils::DateTime>
  CancelZonalShiftResult& WithStartTime(StartTimeT&& value) {
  ...
  inline void SetStatus(ZonalShiftStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline CancelZonalShiftResult& WithStatus(ZonalShiftStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CommentT = Aws::String>
  CancelZonalShiftResult& WithComment(CommentT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CancelZonalShiftResult& WithRequestId(RequestIdT&& value) {
