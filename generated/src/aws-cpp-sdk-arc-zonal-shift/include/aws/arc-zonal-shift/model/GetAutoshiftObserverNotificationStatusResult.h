...
class GetAutoshiftObserverNotificationStatusResult {
 public:
  ...
  AWS_ARCZONALSHIFT_API GetAutoshiftObserverNotificationStatusResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  inline GetAutoshiftObserverNotificationStatusResult& WithStatus(AutoshiftObserverNotificationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetAutoshiftObserverNotificationStatusResult& WithRequestId(RequestIdT&& value) {
