...
class UpdateAutoshiftObserverNotificationStatusResult {
 public:
  ...
  AWS_ARCZONALSHIFT_API UpdateAutoshiftObserverNotificationStatusResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  inline void SetStatus(AutoshiftObserverNotificationStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline UpdateAutoshiftObserverNotificationStatusResult& WithStatus(AutoshiftObserverNotificationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  UpdateAutoshiftObserverNotificationStatusResult& WithRequestId(RequestIdT&& value) {
