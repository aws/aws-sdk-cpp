...
class UpdateZonalShiftResult {
 public:
  ...
  template <typename ZonalShiftIdT = Aws::String>
  UpdateZonalShiftResult& WithZonalShiftId(ZonalShiftIdT&& value) {
  ...
  template <typename ResourceIdentifierT = Aws::String>
  UpdateZonalShiftResult& WithResourceIdentifier(ResourceIdentifierT&& value) {
  ...
  template <typename AwayFromT = Aws::String>
  UpdateZonalShiftResult& WithAwayFrom(AwayFromT&& value) {
  ...
  template <typename ExpiryTimeT = Aws::Utils::DateTime>
  UpdateZonalShiftResult& WithExpiryTime(ExpiryTimeT&& value) {
  ...
  template <typename StartTimeT = Aws::Utils::DateTime>
  UpdateZonalShiftResult& WithStartTime(StartTimeT&& value) {
  ...
  inline UpdateZonalShiftResult& WithStatus(ZonalShiftStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CommentT = Aws::String>
  UpdateZonalShiftResult& WithComment(CommentT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateZonalShiftResult& WithRequestId(RequestIdT&& value) {
