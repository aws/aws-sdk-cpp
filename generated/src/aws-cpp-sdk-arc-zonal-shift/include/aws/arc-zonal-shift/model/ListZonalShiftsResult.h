...
class ListZonalShiftsResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<ZonalShiftSummary>>
  ListZonalShiftsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = ZonalShiftSummary>
  ListZonalShiftsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListZonalShiftsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListZonalShiftsResult& WithRequestId(RequestIdT&& value) {
