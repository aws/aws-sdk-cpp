...
class AutoshiftSummary {
 public:
  ...
  template <typename AwayFromT = Aws::String>
  AutoshiftSummary& WithAwayFrom(AwayFromT&& value) {
  ...
  template <typename EndTimeT = Aws::Utils::DateTime>
  AutoshiftSummary& WithEndTime(EndTimeT&& value) {
  ...
  template <typename StartTimeT = Aws::Utils::DateTime>
  AutoshiftSummary& WithStartTime(StartTimeT&& value) {
  ...
  inline AutoshiftSummary& WithStatus(AutoshiftExecutionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
