...
class ManagedResourceSummary {
 public:
  ...
  template <typename ArnT = Aws::String>
  ManagedResourceSummary& WithArn(ArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  ManagedResourceSummary& WithName(NameT&& value) {
  ...
  template <typename AvailabilityZonesT = Aws::Vector<Aws::String>>
  ManagedResourceSummary& WithAvailabilityZones(AvailabilityZonesT&& value) {
    SetAvailabilityZones(std::forward<AvailabilityZonesT>(value));
    return *this;
  }
  template <typename AvailabilityZonesT = Aws::String>
  ManagedResourceSummary& AddAvailabilityZones(AvailabilityZonesT&& value) {
    m_availabilityZonesHasBeenSet = true;
  ...
  void SetAppliedWeights(AppliedWeightsT&& value) {
    m_appliedWeightsHasBeenSet = true;
    m_appliedWeights = std::forward<AppliedWeightsT>(value);
  }
  template <typename AppliedWeightsT = Aws::Map<Aws::String, double>>
  ManagedResourceSummary& WithAppliedWeights(AppliedWeightsT&& value) {
    SetAppliedWeights(std::forward<AppliedWeightsT>(value));
    return *this;
  }
  inline ManagedResourceSummary& AddAppliedWeights(Aws::String key, double value) {
    m_appliedWeightsHasBeenSet = true;
    m_appliedWeights.emplace(key, value);
    return *this;
  }
  ///@}
  ...
  void SetZonalShifts(ZonalShiftsT&& value) {
    m_zonalShiftsHasBeenSet = true;
    m_zonalShifts = std::forward<ZonalShiftsT>(value);
  }
  template <typename ZonalShiftsT = Aws::Vector<ZonalShiftInResource>>
  ManagedResourceSummary& WithZonalShifts(ZonalShiftsT&& value) {
    SetZonalShifts(std::forward<ZonalShiftsT>(value));
    return *this;
  }
  template <typename ZonalShiftsT = ZonalShiftInResource>
  ManagedResourceSummary& AddZonalShifts(ZonalShiftsT&& value) {
    m_zonalShiftsHasBeenSet = true;
    m_zonalShifts.emplace_back(std::forward<ZonalShiftsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAutoshifts(AutoshiftsT&& value) {
    m_autoshiftsHasBeenSet = true;
    m_autoshifts = std::forward<AutoshiftsT>(value);
  }
  template <typename AutoshiftsT = Aws::Vector<AutoshiftInResource>>
  ManagedResourceSummary& WithAutoshifts(AutoshiftsT&& value) {
    SetAutoshifts(std::forward<AutoshiftsT>(value));
    return *this;
  }
  template <typename AutoshiftsT = AutoshiftInResource>
  ManagedResourceSummary& AddAutoshifts(AutoshiftsT&& value) {
    m_autoshiftsHasBeenSet = true;
    m_autoshifts.emplace_back(std::forward<AutoshiftsT>(value));
    return *this;
  }
  ///@}
  ...
  inline ManagedResourceSummary& WithZonalAutoshiftStatus(ZonalAutoshiftStatus value) {
  ...
  inline void SetPracticeRunStatus(ZonalAutoshiftStatus value) {
    m_practiceRunStatusHasBeenSet = true;
    m_practiceRunStatus = value;
  }
  inline ManagedResourceSummary& WithPracticeRunStatus(ZonalAutoshiftStatus value) {
    SetPracticeRunStatus(value);
    return *this;
  }
  ///@}
 private:
