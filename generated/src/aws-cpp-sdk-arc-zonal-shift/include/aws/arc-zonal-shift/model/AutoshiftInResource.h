...
class AutoshiftInResource {
 public:
  ...
  inline void SetAppliedStatus(AutoshiftAppliedStatus value) {
    m_appliedStatusHasBeenSet = true;
    m_appliedStatus = value;
  }
  inline AutoshiftInResource& WithAppliedStatus(AutoshiftAppliedStatus value) {
  ...
  template <typename AwayFromT = Aws::String>
  AutoshiftInResource& WithAwayFrom(AwayFromT&& value) {
  ...
  template <typename StartTimeT = Aws::Utils::DateTime>
  AutoshiftInResource& WithStartTime(StartTimeT&& value) {
