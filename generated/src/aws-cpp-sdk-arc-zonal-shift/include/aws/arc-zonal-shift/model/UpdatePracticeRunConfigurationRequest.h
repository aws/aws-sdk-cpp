...
class UpdatePracticeRunConfigurationRequest : public ARCZonalShiftRequest {
 public:
  ...
  template <typename ResourceIdentifierT = Aws::String>
  UpdatePracticeRunConfigurationRequest& WithResourceIdentifier(ResourceIdentifierT&& value) {
  ...
  template <typename BlockedWindowsT = Aws::Vector<Aws::String>>
  UpdatePracticeRunConfigurationRequest& WithBlockedWindows(BlockedWindowsT&& value) {
    SetBlockedWindows(std::forward<BlockedWindowsT>(value));
    return *this;
  }
  template <typename BlockedWindowsT = Aws::String>
  UpdatePracticeRunConfigurationRequest& AddBlockedWindows(BlockedWindowsT&& value) {
    m_blockedWindowsHasBeenSet = true;
  ...
  template <typename BlockedDatesT = Aws::Vector<Aws::String>>
  UpdatePracticeRunConfigurationRequest& WithBlockedDates(BlockedDatesT&& value) {
    SetBlockedDates(std::forward<BlockedDatesT>(value));
    return *this;
  }
  template <typename BlockedDatesT = Aws::String>
  UpdatePracticeRunConfigurationRequest& AddBlockedDates(BlockedDatesT&& value) {
    m_blockedDatesHasBeenSet = true;
  ...
  template <typename BlockingAlarmsT = Aws::Vector<ControlCondition>>
  UpdatePracticeRunConfigurationRequest& WithBlockingAlarms(BlockingAlarmsT&& value) {
    SetBlockingAlarms(std::forward<BlockingAlarmsT>(value));
    return *this;
  }
  template <typename BlockingAlarmsT = ControlCondition>
  UpdatePracticeRunConfigurationRequest& AddBlockingAlarms(BlockingAlarmsT&& value) {
    m_blockingAlarmsHasBeenSet = true;
  ...
  template <typename AllowedWindowsT = Aws::Vector<Aws::String>>
  UpdatePracticeRunConfigurationRequest& WithAllowedWindows(AllowedWindowsT&& value) {
    SetAllowedWindows(std::forward<AllowedWindowsT>(value));
    return *this;
  }
  template <typename AllowedWindowsT = Aws::String>
  UpdatePracticeRunConfigurationRequest& AddAllowedWindows(AllowedWindowsT&& value) {
    m_allowedWindowsHasBeenSet = true;
  ...
  template <typename OutcomeAlarmsT = Aws::Vector<ControlCondition>>
  UpdatePracticeRunConfigurationRequest& WithOutcomeAlarms(OutcomeAlarmsT&& value) {
    SetOutcomeAlarms(std::forward<OutcomeAlarmsT>(value));
    return *this;
  }
  template <typename OutcomeAlarmsT = ControlCondition>
  UpdatePracticeRunConfigurationRequest& AddOutcomeAlarms(OutcomeAlarmsT&& value) {
    m_outcomeAlarmsHasBeenSet = true;
