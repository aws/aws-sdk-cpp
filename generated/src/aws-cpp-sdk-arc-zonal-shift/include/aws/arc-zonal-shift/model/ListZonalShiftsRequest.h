...
class ListZonalShiftsRequest : public ARCZonalShiftRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListZonalShiftsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListZonalShiftsRequest& WithStatus(ZonalShiftStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline ListZonalShiftsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename ResourceIdentifierT = Aws::String>
  ListZonalShiftsRequest& WithResourceIdentifier(ResourceIdentifierT&& value) {
