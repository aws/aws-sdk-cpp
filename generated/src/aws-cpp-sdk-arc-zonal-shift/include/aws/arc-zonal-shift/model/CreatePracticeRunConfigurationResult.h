...
class CreatePracticeRunConfigurationResult {
 public:
  ...
  AWS_ARCZONALSHIFT_API CreatePracticeRunConfigurationResult& operator=(
  ...
  template <typename ArnT = Aws::String>
  CreatePracticeRunConfigurationResult& WithArn(ArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreatePracticeRunConfigurationResult& WithName(NameT&& value) {
  ...
  inline CreatePracticeRunConfigurationResult& WithZonalAutoshiftStatus(ZonalAutoshiftStatus value) {
  ...
  template <typename PracticeRunConfigurationT = PracticeRunConfiguration>
  CreatePracticeRunConfigurationResult& WithPracticeRunConfiguration(PracticeRunConfigurationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreatePracticeRunConfigurationResult& WithRequestId(RequestIdT&& value) {
