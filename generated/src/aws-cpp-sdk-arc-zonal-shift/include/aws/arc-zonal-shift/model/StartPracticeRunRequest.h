...
class StartPracticeRunRequest : public ARCZonalShiftRequest {
 public:
  ...
  template <typename ResourceIdentifierT = Aws::String>
  StartPracticeRunRequest& WithResourceIdentifier(ResourceIdentifierT&& value) {
  ...
  template <typename AwayFromT = Aws::String>
  StartPracticeRunRequest& WithAwayFrom(AwayFromT&& value) {
  ...
  template <typename CommentT = Aws::String>
  StartPracticeRunRequest& WithComment(CommentT&& value) {
