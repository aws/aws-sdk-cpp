...
class ZonalShiftSummary {
 public:
  ...
  template <typename ZonalShiftIdT = Aws::String>
  ZonalShiftSummary& WithZonalShiftId(ZonalShiftIdT&& value) {
  ...
  template <typename ResourceIdentifierT = Aws::String>
  ZonalShiftSummary& WithResourceIdentifier(ResourceIdentifierT&& value) {
  ...
  template <typename AwayFromT = Aws::String>
  ZonalShiftSummary& WithAwayFrom(AwayFromT&& value) {
  ...
  template <typename ExpiryTimeT = Aws::Utils::DateTime>
  ZonalShiftSummary& WithExpiryTime(ExpiryTimeT&& value) {
  ...
  template <typename StartTimeT = Aws::Utils::DateTime>
  ZonalShiftSummary& WithStartTime(StartTimeT&& value) {
  ...
  inline ZonalShiftSummary& WithStatus(ZonalShiftStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CommentT = Aws::String>
  ZonalShiftSummary& WithComment(CommentT&& value) {
  ...
  inline ZonalShiftSummary& WithShiftType(ShiftType value) {
    SetShiftType(value);
    return *this;
  }
  ///@}
  ...
  inline ZonalShiftSummary& WithPracticeRunOutcome(PracticeRunOutcome value) {
