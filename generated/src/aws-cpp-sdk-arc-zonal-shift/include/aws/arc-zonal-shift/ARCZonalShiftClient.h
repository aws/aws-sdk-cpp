...
class AWS_ARCZONALSHIFT_API ARCZonalShiftClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  ARCZonalShiftClient(const Aws::ARCZonalShift::ARCZonalShiftClientConfiguration& clientConfiguration =
  ...
  ARCZonalShiftClient(const Aws::Auth::AWSCredentials& credentials,
                      std::shared_ptr<ARCZonalShiftEndpointProviderBase> endpointProvider = nullptr,
                      const Aws::ARCZonalShift::ARCZonalShiftClientConfiguration& clientConfiguration =
                          Aws::ARCZonalShift::ARCZonalShiftClientConfiguration());
   ...
   * is not specified, it will be initialized to default values.
   */
  ARCZonalShiftClient(const Aws::Auth::AWSCredentials& credentials, const Aws::Client::ClientConfiguration& clientConfiguration);
  ...
  /**
   * A Callable wrapper for CancelPracticeRun that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CancelPracticeRun that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CancelPracticeRunRequestT = Model::CancelPracticeRunRequest>
  void CancelPracticeRunAsync(const CancelPracticeRunRequestT& request, const CancelPracticeRunResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for CancelZonalShift that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CancelZonalShift that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CancelZonalShiftRequestT = Model::CancelZonalShiftRequest>
  void CancelZonalShiftAsync(const CancelZonalShiftRequestT& request, const CancelZonalShiftResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreatePracticeRunConfigurationOutcome CreatePracticeRunConfiguration(
      const Model::CreatePracticeRunConfigurationRequest& request) const;

  /**
   * A Callable wrapper for CreatePracticeRunConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreatePracticeRunConfigurationRequestT = Model::CreatePracticeRunConfigurationRequest>
  Model::CreatePracticeRunConfigurationOutcomeCallable CreatePracticeRunConfigurationCallable(
      const CreatePracticeRunConfigurationRequestT& request) const {
    return SubmitCallable(&ARCZonalShiftClient::CreatePracticeRunConfiguration, request);
  }

  /**
   * An Async wrapper for CreatePracticeRunConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreatePracticeRunConfigurationRequestT = Model::CreatePracticeRunConfigurationRequest>
  void CreatePracticeRunConfigurationAsync(const CreatePracticeRunConfigurationRequestT& request,
                                           const CreatePracticeRunConfigurationResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeletePracticeRunConfigurationOutcome DeletePracticeRunConfiguration(
      const Model::DeletePracticeRunConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DeletePracticeRunConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeletePracticeRunConfigurationRequestT = Model::DeletePracticeRunConfigurationRequest>
  Model::DeletePracticeRunConfigurationOutcomeCallable DeletePracticeRunConfigurationCallable(
      const DeletePracticeRunConfigurationRequestT& request) const {
    return SubmitCallable(&ARCZonalShiftClient::DeletePracticeRunConfiguration, request);
  }

  /**
   * An Async wrapper for DeletePracticeRunConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeletePracticeRunConfigurationRequestT = Model::DeletePracticeRunConfigurationRequest>
  void DeletePracticeRunConfigurationAsync(const DeletePracticeRunConfigurationRequestT& request,
                                           const DeletePracticeRunConfigurationResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::GetAutoshiftObserverNotificationStatusOutcome GetAutoshiftObserverNotificationStatus(
      const Model::GetAutoshiftObserverNotificationStatusRequest& request = {}) const;

  /**
   * A Callable wrapper for GetAutoshiftObserverNotificationStatus that returns a future to the operation so that it can be executed in
  ...
  Model::GetAutoshiftObserverNotificationStatusOutcomeCallable GetAutoshiftObserverNotificationStatusCallable(
      const GetAutoshiftObserverNotificationStatusRequestT& request = {}) const {
    return SubmitCallable(&ARCZonalShiftClient::GetAutoshiftObserverNotificationStatus, request);
  }

  /**
   * An Async wrapper for GetAutoshiftObserverNotificationStatus that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetAutoshiftObserverNotificationStatusRequestT = Model::GetAutoshiftObserverNotificationStatusRequest>
  void GetAutoshiftObserverNotificationStatusAsync(const GetAutoshiftObserverNotificationStatusResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for GetManagedResource that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetManagedResource that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetManagedResourceRequestT = Model::GetManagedResourceRequest>
  void GetManagedResourceAsync(const GetManagedResourceRequestT& request, const GetManagedResourceResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListAutoshifts that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListAutoshiftsRequestT = Model::ListAutoshiftsRequest>
  void ListAutoshiftsAsync(const ListAutoshiftsResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const ListAutoshiftsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListManagedResources that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListManagedResources that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListManagedResourcesRequestT = Model::ListManagedResourcesRequest>
  void ListManagedResourcesAsync(const ListManagedResourcesResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const ListManagedResourcesRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListZonalShifts that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListZonalShiftsRequestT = Model::ListZonalShiftsRequest>
  void ListZonalShiftsAsync(const ListZonalShiftsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const ListZonalShiftsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for StartPracticeRun that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartPracticeRun that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StartPracticeRunRequestT = Model::StartPracticeRunRequest>
  void StartPracticeRunAsync(const StartPracticeRunRequestT& request, const StartPracticeRunResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StartZonalShift that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StartZonalShiftRequestT = Model::StartZonalShiftRequest>
  void StartZonalShiftAsync(const StartZonalShiftRequestT& request, const StartZonalShiftResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateAutoshiftObserverNotificationStatusOutcome UpdateAutoshiftObserverNotificationStatus(
      const Model::UpdateAutoshiftObserverNotificationStatusRequest& request) const;

  /**
   * A Callable wrapper for UpdateAutoshiftObserverNotificationStatus that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  ...
  Model::UpdateAutoshiftObserverNotificationStatusOutcomeCallable UpdateAutoshiftObserverNotificationStatusCallable(
      const UpdateAutoshiftObserverNotificationStatusRequestT& request) const {
    return SubmitCallable(&ARCZonalShiftClient::UpdateAutoshiftObserverNotificationStatus, request);
  }

  /**
   * An Async wrapper for UpdateAutoshiftObserverNotificationStatus that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename UpdateAutoshiftObserverNotificationStatusRequestT = Model::UpdateAutoshiftObserverNotificationStatusRequest>
  void UpdateAutoshiftObserverNotificationStatusAsync(
      const UpdateAutoshiftObserverNotificationStatusRequestT& request,
      const UpdateAutoshiftObserverNotificationStatusResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdatePracticeRunConfigurationOutcome UpdatePracticeRunConfiguration(
      const Model::UpdatePracticeRunConfigurationRequest& request) const;

  /**
   * A Callable wrapper for UpdatePracticeRunConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdatePracticeRunConfigurationRequestT = Model::UpdatePracticeRunConfigurationRequest>
  Model::UpdatePracticeRunConfigurationOutcomeCallable UpdatePracticeRunConfigurationCallable(
      const UpdatePracticeRunConfigurationRequestT& request) const {
    return SubmitCallable(&ARCZonalShiftClient::UpdatePracticeRunConfiguration, request);
  }

  /**
   * An Async wrapper for UpdatePracticeRunConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdatePracticeRunConfigurationRequestT = Model::UpdatePracticeRunConfigurationRequest>
  void UpdatePracticeRunConfigurationAsync(const UpdatePracticeRunConfigurationRequestT& request,
                                           const UpdatePracticeRunConfigurationResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateZonalAutoshiftConfigurationOutcome UpdateZonalAutoshiftConfiguration(
      const Model::UpdateZonalAutoshiftConfigurationRequest& request) const;

  /**
   * A Callable wrapper for UpdateZonalAutoshiftConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename UpdateZonalAutoshiftConfigurationRequestT = Model::UpdateZonalAutoshiftConfigurationRequest>
  Model::UpdateZonalAutoshiftConfigurationOutcomeCallable UpdateZonalAutoshiftConfigurationCallable(
      const UpdateZonalAutoshiftConfigurationRequestT& request) const {
    return SubmitCallable(&ARCZonalShiftClient::UpdateZonalAutoshiftConfiguration, request);
  }

  /**
   * An Async wrapper for UpdateZonalAutoshiftConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateZonalAutoshiftConfigurationRequestT = Model::UpdateZonalAutoshiftConfigurationRequest>
  void UpdateZonalAutoshiftConfigurationAsync(const UpdateZonalAutoshiftConfigurationRequestT& request,
                                              const UpdateZonalAutoshiftConfigurationResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateZonalShift that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateZonalShift that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateZonalShiftRequestT = Model::UpdateZonalShiftRequest>
  void UpdateZonalShiftAsync(const UpdateZonalShiftRequestT& request, const UpdateZonalShiftResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
