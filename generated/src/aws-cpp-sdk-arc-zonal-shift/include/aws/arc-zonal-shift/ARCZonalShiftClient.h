...
namespace ARCZonalShift
{
   ...
   */
  class AWS_ARCZONALSHIFT_API ARCZonalShiftClient : Aws::Client::ClientWithAsyncTemplateMethods<ARCZonalShiftClient>,
    smithy::client::AwsSmithyClientT<Aws::ARCZonalShift::SERVICE_NAME,
