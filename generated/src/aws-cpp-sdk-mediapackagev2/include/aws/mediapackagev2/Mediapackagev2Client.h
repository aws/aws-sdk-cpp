...
class AWS_MEDIAPACKAGEV2_API Mediapackagev2Client : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  Mediapackagev2Client(const Aws::mediapackagev2::Mediapackagev2ClientConfiguration& clientConfiguration =
  ...
  Mediapackagev2Client(const Aws::Auth::AWSCredentials& credentials,
                       std::shared_ptr<Mediapackagev2EndpointProviderBase> endpointProvider = nullptr,
                       const Aws::mediapackagev2::Mediapackagev2ClientConfiguration& clientConfiguration =
                           Aws::mediapackagev2::Mediapackagev2ClientConfiguration());
  ...
  /**
   * A Callable wrapper for CancelHarvestJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CancelHarvestJob that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CancelHarvestJobRequestT = Model::CancelHarvestJobRequest>
  void CancelHarvestJobAsync(const CancelHarvestJobRequestT& request, const CancelHarvestJobResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for CreateChannelGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateChannelGroup that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateChannelGroupRequestT = Model::CreateChannelGroupRequest>
  void CreateChannelGroupAsync(const CreateChannelGroupRequestT& request, const CreateChannelGroupResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteChannelGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteChannelGroup that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteChannelGroupRequestT = Model::DeleteChannelGroupRequest>
  void DeleteChannelGroupAsync(const DeleteChannelGroupRequestT& request, const DeleteChannelGroupResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteOriginEndpointPolicyOutcome DeleteOriginEndpointPolicy(
      const Model::DeleteOriginEndpointPolicyRequest& request) const;

  /**
   * A Callable wrapper for DeleteOriginEndpointPolicy that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteOriginEndpointPolicyRequestT = Model::DeleteOriginEndpointPolicyRequest>
  Model::DeleteOriginEndpointPolicyOutcomeCallable DeleteOriginEndpointPolicyCallable(
      const DeleteOriginEndpointPolicyRequestT& request) const {
    return SubmitCallable(&Mediapackagev2Client::DeleteOriginEndpointPolicy, request);
  }

  /**
   * An Async wrapper for DeleteOriginEndpointPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteOriginEndpointPolicyRequestT = Model::DeleteOriginEndpointPolicyRequest>
  void DeleteOriginEndpointPolicyAsync(const DeleteOriginEndpointPolicyRequestT& request,
                                       const DeleteOriginEndpointPolicyResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetChannelGroup that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetChannelGroupRequestT = Model::GetChannelGroupRequest>
  void GetChannelGroupAsync(const GetChannelGroupRequestT& request, const GetChannelGroupResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetHarvestJob that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetHarvestJobRequestT = Model::GetHarvestJobRequest>
  void GetHarvestJobAsync(const GetHarvestJobRequestT& request, const GetHarvestJobResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetOriginEndpoint that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetOriginEndpoint that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetOriginEndpointRequestT = Model::GetOriginEndpointRequest>
  void GetOriginEndpointAsync(const GetOriginEndpointRequestT& request, const GetOriginEndpointResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetOriginEndpointPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetOriginEndpointPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetOriginEndpointPolicyRequestT = Model::GetOriginEndpointPolicyRequest>
  void GetOriginEndpointPolicyAsync(const GetOriginEndpointPolicyRequestT& request,
                                    const GetOriginEndpointPolicyResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListChannelGroups that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListChannelGroups that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListChannelGroupsRequestT = Model::ListChannelGroupsRequest>
  void ListChannelGroupsAsync(const ListChannelGroupsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const ListChannelGroupsRequestT& request = {}) const {
   ...
   */
  template <typename ListHarvestJobsRequestT = Model::ListHarvestJobsRequest>
  void ListHarvestJobsAsync(const ListHarvestJobsRequestT& request, const ListHarvestJobsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename ListOriginEndpointsRequestT = Model::ListOriginEndpointsRequest>
  void ListOriginEndpointsAsync(const ListOriginEndpointsRequestT& request, const ListOriginEndpointsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutOriginEndpointPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutOriginEndpointPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutOriginEndpointPolicyRequestT = Model::PutOriginEndpointPolicyRequest>
  void PutOriginEndpointPolicyAsync(const PutOriginEndpointPolicyRequestT& request,
                                    const PutOriginEndpointPolicyResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ResetChannelState that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ResetChannelState that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ResetChannelStateRequestT = Model::ResetChannelStateRequest>
  void ResetChannelStateAsync(const ResetChannelStateRequestT& request, const ResetChannelStateResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ResetOriginEndpointState that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ResetOriginEndpointState that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ResetOriginEndpointStateRequestT = Model::ResetOriginEndpointStateRequest>
  void ResetOriginEndpointStateAsync(const ResetOriginEndpointStateRequestT& request,
                                     const ResetOriginEndpointStateResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateChannelGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateChannelGroup that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateChannelGroupRequestT = Model::UpdateChannelGroupRequest>
  void UpdateChannelGroupAsync(const UpdateChannelGroupRequestT& request, const UpdateChannelGroupResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
