...
namespace Model
{
  ...
  {
  public:
    AWS_MEDIAPACKAGEV2_API DeleteOriginEndpointPolicyRequest() = default;
    ...
    template<typename ChannelGroupNameT = Aws::String>
    DeleteOriginEndpointPolicyRequest& WithChannelGroupName(ChannelGroupNameT&& value) { SetChannelGroupName(std::forward<ChannelGroupNameT>(value)); return *this;}
    ///@}
    ...
    template<typename ChannelNameT = Aws::String>
    DeleteOriginEndpointPolicyRequest& WithChannelName(ChannelNameT&& value) { SetChannelName(std::forward<ChannelNameT>(value)); return *this;}
    ///@}
    ...
    template<typename OriginEndpointNameT = Aws::String>
    DeleteOriginEndpointPolicyRequest& WithOriginEndpointName(OriginEndpointNameT&& value) { SetOriginEndpointName(std::forward<OriginEndpointNameT>(value)); return *this;}
    ///@}
  private:
