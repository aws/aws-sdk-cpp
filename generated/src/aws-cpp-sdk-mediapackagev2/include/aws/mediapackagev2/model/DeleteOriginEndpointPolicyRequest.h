...
class DeleteOriginEndpointPolicyRequest : public Mediapackagev2Request {
 public:
  ...
  template <typename ChannelGroupNameT = Aws::String>
  DeleteOriginEndpointPolicyRequest& WithChannelGroupName(ChannelGroupNameT&& value) {
  ...
  template <typename ChannelNameT = Aws::String>
  DeleteOriginEndpointPolicyRequest& WithChannelName(ChannelNameT&& value) {
  ...
  template <typename OriginEndpointNameT = Aws::String>
  DeleteOriginEndpointPolicyRequest& WithOriginEndpointName(OriginEndpointNameT&& value) {
