...
class Encryption {
 public:
  ...
  void SetEncryptionMethod(EncryptionMethodT&& value) {
    ...
    m_encryptionMethod = std::forward<EncryptionMethodT>(value);
  }
  template <typename EncryptionMethodT = EncryptionMethod>
  Encryption& WithEncryptionMethod(EncryptionMethodT&& value) {
    SetEncryptionMethod(std::forward<EncryptionMethodT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetKeyRotationIntervalSeconds(int value) {
    m_keyRotationIntervalSecondsHasBeenSet = true;
    m_keyRotationIntervalSeconds = value;
  }
  inline Encryption& WithKeyRotationIntervalSeconds(int value) {
    SetKeyRotationIntervalSeconds(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCmafExcludeSegmentDrmMetadata(bool value) {
    m_cmafExcludeSegmentDrmMetadataHasBeenSet = true;
    m_cmafExcludeSegmentDrmMetadata = value;
  }
  inline Encryption& WithCmafExcludeSegmentDrmMetadata(bool value) {
    SetCmafExcludeSegmentDrmMetadata(value);
    return *this;
  }
  ///@}
