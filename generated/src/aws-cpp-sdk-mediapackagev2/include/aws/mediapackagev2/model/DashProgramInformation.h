...
class DashProgramInformation {
 public:
  ...
  void SetCopyright(CopyrightT&& value) {
    m_copyrightHasBeenSet = true;
    m_copyright = std::forward<CopyrightT>(value);
  }
  template <typename CopyrightT = Aws::String>
  DashProgramInformation& WithCopyright(CopyrightT&& value) {
    SetCopyright(std::forward<CopyrightT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMoreInformationUrl(MoreInformationUrlT&& value) {
    m_moreInformationUrlHasBeenSet = true;
    m_moreInformationUrl = std::forward<MoreInformationUrlT>(value);
  }
  template <typename MoreInformationUrlT = Aws::String>
  DashProgramInformation& WithMoreInformationUrl(MoreInformationUrlT&& value) {
    SetMoreInformationUrl(std::forward<MoreInformationUrlT>(value));
    return *this;
  }
  ///@}
 private:
