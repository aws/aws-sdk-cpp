...
class CreateDashManifestConfiguration {
 public:
  ...
  inline CreateDashManifestConfiguration& WithManifestWindowSeconds(int value) {
  ...
  inline CreateDashManifestConfiguration& WithMinUpdatePeriodSeconds(int value) {
  ...
  inline CreateDashManifestConfiguration& WithMinBufferTimeSeconds(int value) {
  ...
  inline CreateDashManifestConfiguration& WithSuggestedPresentationDelaySeconds(int value) {
  ...
  inline CreateDashManifestConfiguration& WithSegmentTemplateFormat(DashSegmentTemplateFormat value) {
  ...
  inline CreateDashManifestConfiguration& AddPeriodTriggers(DashPeriodTrigger value) {
    m_periodTriggersHasBeenSet = true;
  ...
  inline CreateDashManifestConfiguration& WithDrmSignaling(DashDrmSignaling value) {
  ...
  inline CreateDashManifestConfiguration& AddProfiles(DashProfile value) {
    m_profilesHasBeenSet = true;
  ...
  inline CreateDashManifestConfiguration& WithCompactness(DashCompactness value) {
