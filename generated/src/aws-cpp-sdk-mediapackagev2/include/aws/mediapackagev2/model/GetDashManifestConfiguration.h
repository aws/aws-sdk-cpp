...
class GetDashManifestConfiguration {
 public:
  ...
  template <typename UrlT = Aws::String>
  GetDashManifestConfiguration& WithUrl(UrlT&& value) {
  ...
  inline GetDashManifestConfiguration& WithManifestWindowSeconds(int value) {
  ...
  inline void SetMinUpdatePeriodSeconds(int value) {
    m_minUpdatePeriodSecondsHasBeenSet = true;
    m_minUpdatePeriodSeconds = value;
  }
  inline GetDashManifestConfiguration& WithMinUpdatePeriodSeconds(int value) {
    SetMinUpdatePeriodSeconds(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMinBufferTimeSeconds(int value) {
    m_minBufferTimeSecondsHasBeenSet = true;
    m_minBufferTimeSeconds = value;
  }
  inline GetDashManifestConfiguration& WithMinBufferTimeSeconds(int value) {
    SetMinBufferTimeSeconds(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSuggestedPresentationDelaySeconds(int value) {
    m_suggestedPresentationDelaySecondsHasBeenSet = true;
    m_suggestedPresentationDelaySeconds = value;
  }
  inline GetDashManifestConfiguration& WithSuggestedPresentationDelaySeconds(int value) {
    SetSuggestedPresentationDelaySeconds(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSegmentTemplateFormat(DashSegmentTemplateFormat value) {
    m_segmentTemplateFormatHasBeenSet = true;
    m_segmentTemplateFormat = value;
  }
  inline GetDashManifestConfiguration& WithSegmentTemplateFormat(DashSegmentTemplateFormat value) {
  ...
  inline GetDashManifestConfiguration& AddPeriodTriggers(DashPeriodTrigger value) {
    m_periodTriggersHasBeenSet = true;
  ...
  void SetScteDash(ScteDashT&& value) {
    m_scteDashHasBeenSet = true;
    m_scteDash = std::forward<ScteDashT>(value);
  }
  template <typename ScteDashT = ScteDash>
  GetDashManifestConfiguration& WithScteDash(ScteDashT&& value) {
    SetScteDash(std::forward<ScteDashT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetDrmSignaling(DashDrmSignaling value) {
    m_drmSignalingHasBeenSet = true;
    m_drmSignaling = value;
  }
  inline GetDashManifestConfiguration& WithDrmSignaling(DashDrmSignaling value) {
    SetDrmSignaling(value);
    return *this;
  }
  ///@}
  ...
  void SetUtcTiming(UtcTimingT&& value) {
    m_utcTimingHasBeenSet = true;
    m_utcTiming = std::forward<UtcTimingT>(value);
  }
  template <typename UtcTimingT = DashUtcTiming>
  GetDashManifestConfiguration& WithUtcTiming(UtcTimingT&& value) {
    SetUtcTiming(std::forward<UtcTimingT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetDashManifestConfiguration& AddProfiles(DashProfile value) {
    m_profilesHasBeenSet = true;
  ...
  void SetProgramInformation(ProgramInformationT&& value) {
    m_programInformationHasBeenSet = true;
    m_programInformation = std::forward<ProgramInformationT>(value);
  }
  template <typename ProgramInformationT = DashProgramInformation>
  GetDashManifestConfiguration& WithProgramInformation(ProgramInformationT&& value) {
    SetProgramInformation(std::forward<ProgramInformationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDvbSettings(DvbSettingsT&& value) {
    m_dvbSettingsHasBeenSet = true;
    m_dvbSettings = std::forward<DvbSettingsT>(value);
  }
  template <typename DvbSettingsT = DashDvbSettings>
  GetDashManifestConfiguration& WithDvbSettings(DvbSettingsT&& value) {
    SetDvbSettings(std::forward<DvbSettingsT>(value));
    return *this;
  }
  ///@}
   ...
   * <code>NONE</code> indicates a full manifest.</p>
   */
  ...
  inline void SetCompactness(DashCompactness value) {
    m_compactnessHasBeenSet = true;
    m_compactness = value;
  }
  inline GetDashManifestConfiguration& WithCompactness(DashCompactness value) {
    SetCompactness(value);
    return *this;
  }
  ///@}
  ...
  void SetSubtitleConfiguration(SubtitleConfigurationT&& value) {
    m_subtitleConfigurationHasBeenSet = true;
    m_subtitleConfiguration = std::forward<SubtitleConfigurationT>(value);
  }
  template <typename SubtitleConfigurationT = DashSubtitleConfiguration>
  GetDashManifestConfiguration& WithSubtitleConfiguration(SubtitleConfigurationT&& value) {
    SetSubtitleConfiguration(std::forward<SubtitleConfigurationT>(value));
    return *this;
  }
  ///@}
   ...
   * of the Media Presentation Description (MPD).</p>
   */
