...
class PutOriginEndpointPolicyRequest : public Mediapackagev2Request {
 public:
  ...
  template <typename ChannelGroupNameT = Aws::String>
  PutOriginEndpointPolicyRequest& WithChannelGroupName(ChannelGroupNameT&& value) {
  ...
  template <typename ChannelNameT = Aws::String>
  PutOriginEndpointPolicyRequest& WithChannelName(ChannelNameT&& value) {
  ...
  template <typename OriginEndpointNameT = Aws::String>
  PutOriginEndpointPolicyRequest& WithOriginEndpointName(OriginEndpointNameT&& value) {
  ...
  template <typename PolicyT = Aws::String>
  PutOriginEndpointPolicyRequest& WithPolicy(PolicyT&& value) {
  ...
  void SetCdnAuthConfiguration(CdnAuthConfigurationT&& value) {
    m_cdnAuthConfigurationHasBeenSet = true;
    m_cdnAuthConfiguration = std::forward<CdnAuthConfigurationT>(value);
  }
  template <typename CdnAuthConfigurationT = CdnAuthConfiguration>
  PutOriginEndpointPolicyRequest& WithCdnAuthConfiguration(CdnAuthConfigurationT&& value) {
    SetCdnAuthConfiguration(std::forward<CdnAuthConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
