...
namespace Model
{
  ...
  {
  public:
    AWS_MEDIAPACKAGEV2_API DeleteChannelRequest();
     ...
     * Region.</p>
     */
    inline DeleteChannelRequest& WithChannelGroupName(const Aws::String& value) { SetChannelGroupName(value); return *this;}
     ...
     * Region.</p>
     */
    inline DeleteChannelRequest& WithChannelGroupName(Aws::String&& value) { SetChannelGroupName(std::move(value)); return *this;}
     ...
     * Region.</p>
     */
    inline DeleteChannelRequest& WithChannelGroupName(const char* value) { SetChannelGroupName(value); return *this;}
