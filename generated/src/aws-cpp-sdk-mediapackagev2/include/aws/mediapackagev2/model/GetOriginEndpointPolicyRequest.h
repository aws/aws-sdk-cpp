...
class GetOriginEndpointPolicyRequest : public Mediapackagev2Request {
 public:
  ...
  template <typename ChannelGroupNameT = Aws::String>
  GetOriginEndpointPolicyRequest& WithChannelGroupName(ChannelGroupNameT&& value) {
  ...
  template <typename ChannelNameT = Aws::String>
  GetOriginEndpointPolicyRequest& WithChannelName(ChannelNameT&& value) {
  ...
  template <typename OriginEndpointNameT = Aws::String>
  GetOriginEndpointPolicyRequest& WithOriginEndpointName(OriginEndpointNameT&& value) {
