...
class CdnAuthConfiguration {
 public:
  ...
  void SetCdnIdentifierSecretArns(CdnIdentifierSecretArnsT&& value) {
    ...
    m_cdnIdentifierSecretArns = std::forward<CdnIdentifierSecretArnsT>(value);
  }
  template <typename CdnIdentifierSecretArnsT = Aws::Vector<Aws::String>>
  CdnAuthConfiguration& WithCdnIdentifierSecretArns(CdnIdentifierSecretArnsT&& value) {
    SetCdnIdentifierSecretArns(std::forward<CdnIdentifierSecretArnsT>(value));
    return *this;
  }
  ...
  CdnAuthConfiguration& AddCdnIdentifierSecretArns(CdnIdentifierSecretArnsT&& value) {
    m_cdnIdentifierSecretArnsHasBeenSet = true;
    m_cdnIdentifierSecretArns.emplace_back(std::forward<CdnIdentifierSecretArnsT>(value));
    return *this;
  }
  ///@}
