...
class CreateOriginEndpointResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  CreateOriginEndpointResult& WithArn(ArnT&& value) {
  ...
  inline CreateOriginEndpointResult& WithContainerType(ContainerType value) {
  ...
  inline CreateOriginEndpointResult& WithStartoverWindowSeconds(int value) {
  ...
  void SetHlsManifests(HlsManifestsT&& value) {
    ...
    m_hlsManifests = std::forward<HlsManifestsT>(value);
  }
  template <typename HlsManifestsT = Aws::Vector<GetHlsManifestConfiguration>>
  CreateOriginEndpointResult& WithHlsManifests(HlsManifestsT&& value) {
    SetHlsManifests(std::forward<HlsManifestsT>(value));
    return *this;
  }
  ...
  CreateOriginEndpointResult& AddHlsManifests(HlsManifestsT&& value) {
    m_hlsManifestsHasBeenSet = true;
    m_hlsManifests.emplace_back(std::forward<HlsManifestsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLowLatencyHlsManifests(LowLatencyHlsManifestsT&& value) {
    ...
    m_lowLatencyHlsManifests = std::forward<LowLatencyHlsManifestsT>(value);
  }
  template <typename LowLatencyHlsManifestsT = Aws::Vector<GetLowLatencyHlsManifestConfiguration>>
  CreateOriginEndpointResult& WithLowLatencyHlsManifests(LowLatencyHlsManifestsT&& value) {
    SetLowLatencyHlsManifests(std::forward<LowLatencyHlsManifestsT>(value));
    return *this;
  }
  ...
  CreateOriginEndpointResult& AddLowLatencyHlsManifests(LowLatencyHlsManifestsT&& value) {
    m_lowLatencyHlsManifestsHasBeenSet = true;
    m_lowLatencyHlsManifests.emplace_back(std::forward<LowLatencyHlsManifestsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMssManifests(MssManifestsT&& value) {
    m_mssManifestsHasBeenSet = true;
    m_mssManifests = std::forward<MssManifestsT>(value);
  }
  template <typename MssManifestsT = Aws::Vector<GetMssManifestConfiguration>>
  CreateOriginEndpointResult& WithMssManifests(MssManifestsT&& value) {
    SetMssManifests(std::forward<MssManifestsT>(value));
    return *this;
  }
  ...
  CreateOriginEndpointResult& AddMssManifests(MssManifestsT&& value) {
    m_mssManifestsHasBeenSet = true;
    m_mssManifests.emplace_back(std::forward<MssManifestsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetForceEndpointErrorConfiguration(ForceEndpointErrorConfigurationT&& value) {
    ...
    m_forceEndpointErrorConfiguration = std::forward<ForceEndpointErrorConfigurationT>(value);
  }
  template <typename ForceEndpointErrorConfigurationT = ForceEndpointErrorConfiguration>
  CreateOriginEndpointResult& WithForceEndpointErrorConfiguration(ForceEndpointErrorConfigurationT&& value) {
    SetForceEndpointErrorConfiguration(std::forward<ForceEndpointErrorConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateOriginEndpointResult& WithStreamNameOutputMode(StreamNameOutputMode value) {
  ...
  template <typename ETagT = Aws::String>
  CreateOriginEndpointResult& WithETag(ETagT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateOriginEndpointResult& WithTags(TagsT&& value) {
