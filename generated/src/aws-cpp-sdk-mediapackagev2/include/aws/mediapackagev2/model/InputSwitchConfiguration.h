...
class InputSwitchConfiguration {
 public:
   ...
   * MQCS. Default is false. This setting is valid only when <code>InputType</code>
   * is <code>CMAF</code>.</p>
   */
  ...
  inline void SetMQCSInputSwitching(bool value) {
    m_mQCSInputSwitchingHasBeenSet = true;
    m_mQCSInputSwitching = value;
  }
  inline InputSwitchConfiguration& WithMQCSInputSwitching(bool value) {
    SetMQCSInputSwitching(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPreferredInput(int value) {
    m_preferredInputHasBeenSet = true;
    m_preferredInput = value;
  }
  inline InputSwitchConfiguration& WithPreferredInput(int value) {
