...
class CreateMssManifestConfiguration {
 public:
  ...
  template <typename ManifestNameT = Aws::String>
  CreateMssManifestConfiguration& WithManifestName(ManifestNameT&& value) {
  ...
  inline CreateMssManifestConfiguration& WithManifestWindowSeconds(int value) {
  ...
  template <typename FilterConfigurationT = FilterConfiguration>
  CreateMssManifestConfiguration& WithFilterConfiguration(FilterConfigurationT&& value) {
  ...
  inline void SetManifestLayout(MssManifestLayout value) {
    m_manifestLayoutHasBeenSet = true;
    m_manifestLayout = value;
  }
  inline CreateMssManifestConfiguration& WithManifestLayout(MssManifestLayout value) {
