...
class EncryptionMethod {
 public:
  ...
  inline void SetTsEncryptionMethod(TsEncryptionMethod value) {
    m_tsEncryptionMethodHasBeenSet = true;
    m_tsEncryptionMethod = value;
  }
  inline EncryptionMethod& WithTsEncryptionMethod(TsEncryptionMethod value) {
    SetTsEncryptionMethod(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCmafEncryptionMethod(CmafEncryptionMethod value) {
    m_cmafEncryptionMethodHasBeenSet = true;
    m_cmafEncryptionMethod = value;
  }
  inline EncryptionMethod& WithCmafEncryptionMethod(CmafEncryptionMethod value) {
    SetCmafEncryptionMethod(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIsmEncryptionMethod(IsmEncryptionMethod value) {
    m_ismEncryptionMethodHasBeenSet = true;
    m_ismEncryptionMethod = value;
  }
  inline EncryptionMethod& WithIsmEncryptionMethod(IsmEncryptionMethod value) {
    SetIsmEncryptionMethod(value);
    return *this;
  }
  ///@}
 private:
