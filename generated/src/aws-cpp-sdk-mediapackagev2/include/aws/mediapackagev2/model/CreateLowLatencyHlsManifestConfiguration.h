...
class CreateLowLatencyHlsManifestConfiguration {
 public:
  ...
  template <typename ScteHlsT = ScteHls>
  CreateLowLatencyHlsManifestConfiguration& WithScteHls(ScteHlsT&& value) {
  ...
  inline CreateLowLatencyHlsManifestConfiguration& WithManifestWindowSeconds(int value) {
  ...
  inline CreateLowLatencyHlsManifestConfiguration& WithProgramDateTimeIntervalSeconds(int value) {
  ...
  inline CreateLowLatencyHlsManifestConfiguration& WithUrlEncodeChildManifest(bool value) {
