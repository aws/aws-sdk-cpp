...
namespace Model
{
  ...
  {
  public:
    AWS_MEDIAPACKAGEV2_API CreateLowLatencyHlsManifestConfiguration() = default;
    ...
    template<typename ManifestNameT = Aws::String>
    CreateLowLatencyHlsManifestConfiguration& WithManifestName(ManifestNameT&& value) { SetManifestName(std::forward<ManifestNameT>(value)); return *this;}
    ///@}
    ...
    template<typename ChildManifestNameT = Aws::String>
    CreateLowLatencyHlsManifestConfiguration& WithChildManifestName(ChildManifestNameT&& value) { SetChildManifestName(std::forward<ChildManifestNameT>(value)); return *this;}
    ///@}
    ...
    template<typename ScteHlsT = ScteHls>
    CreateLowLatencyHlsManifestConfiguration& WithScteHls(ScteHlsT&& value) { SetScteHls(std::forward<ScteHlsT>(value)); return *this;}
    ///@}
    ...
    template<typename StartTagT = StartTag>
    CreateLowLatencyHlsManifestConfiguration& WithStartTag(StartTagT&& value) { SetStartTag(std::forward<StartTagT>(value)); return *this;}
    ///@}
    ...
    template<typename FilterConfigurationT = FilterConfiguration>
    CreateLowLatencyHlsManifestConfiguration& WithFilterConfiguration(FilterConfigurationT&& value) { SetFilterConfiguration(std::forward<FilterConfigurationT>(value)); return *this;}
    ///@}
