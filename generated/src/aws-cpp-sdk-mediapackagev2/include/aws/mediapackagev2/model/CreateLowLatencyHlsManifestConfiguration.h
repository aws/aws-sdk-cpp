...
namespace Model
{
  ...
  /**
   * <p>Create a low-latency HTTP live streaming (HLS) manifest
   * configuration.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/mediapackagev2-2022-12-25/CreateLowLatencyHlsManifestConfiguration">AWS
   * API Reference</a></p>
   */
  class CreateLowLatencyHlsManifestConfiguration
  {
  public:
    AWS_MEDIAPACKAGEV2_API CreateLowLatencyHlsManifestConfiguration();
     ...
     * object overrides the manifestName you provided on the originEndpoint object.</p>
     */
    inline CreateLowLatencyHlsManifestConfiguration& WithManifestName(const Aws::String& value) { SetManifestName(value); return *this;}
     ...
     * object overrides the manifestName you provided on the originEndpoint object.</p>
     */
    inline CreateLowLatencyHlsManifestConfiguration& WithManifestName(Aws::String&& value) { SetManifestName(std::move(value)); return *this;}
     ...
     * object overrides the manifestName you provided on the originEndpoint object.</p>
     */
    inline CreateLowLatencyHlsManifestConfiguration& WithManifestName(const char* value) { SetManifestName(value); return *this;}
     ...
     * manifestName you provided on the originEndpoint object.</p>
     */
    inline CreateLowLatencyHlsManifestConfiguration& WithChildManifestName(const Aws::String& value) { SetChildManifestName(value); return *this;}
     ...
     * manifestName you provided on the originEndpoint object.</p>
     */
    inline CreateLowLatencyHlsManifestConfiguration& WithChildManifestName(Aws::String&& value) { SetChildManifestName(std::move(value)); return *this;}
     ...
     * manifestName you provided on the originEndpoint object.</p>
     */
    inline CreateLowLatencyHlsManifestConfiguration& WithChildManifestName(const char* value) { SetChildManifestName(value); return *this;}
    ...
    inline CreateLowLatencyHlsManifestConfiguration& WithScteHls(const ScteHls& value) { SetScteHls(value); return *this;}

    
    inline CreateLowLatencyHlsManifestConfiguration& WithScteHls(ScteHls&& value) { SetScteHls(std::move(value)); return *this;}
     ...
     * <p>The total duration (in seconds) of the manifest's content.</p>
     */
    inline CreateLowLatencyHlsManifestConfiguration& WithManifestWindowSeconds(int value) { SetManifestWindowSeconds(value); return *this;}
