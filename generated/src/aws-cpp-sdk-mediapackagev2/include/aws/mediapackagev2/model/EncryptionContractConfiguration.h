...
class EncryptionContractConfiguration {
 public:
  ...
  inline void SetPresetSpeke20Audio(PresetSpeke20Audio value) {
    m_presetSpeke20AudioHasBeenSet = true;
    m_presetSpeke20Audio = value;
  }
  inline EncryptionContractConfiguration& WithPresetSpeke20Audio(PresetSpeke20Audio value) {
    SetPresetSpeke20Audio(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPresetSpeke20Video(PresetSpeke20Video value) {
    m_presetSpeke20VideoHasBeenSet = true;
    m_presetSpeke20Video = value;
  }
  inline EncryptionContractConfiguration& WithPresetSpeke20Video(PresetSpeke20Video value) {
    SetPresetSpeke20Video(value);
    return *this;
  }
  ///@}
 private:
