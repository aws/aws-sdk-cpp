...
namespace Model
{
  ...
  {
  public:
    AWS_MEDIAPACKAGEV2_API ListTagsForResourceResult() = default;
    AWS_MEDIAPACKAGEV2_API ListTagsForResourceResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_MEDIAPACKAGEV2_API ListTagsForResourceResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
