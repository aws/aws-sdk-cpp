...
class ForceEndpointErrorConfiguration {
 public:
  ...
  void SetEndpointErrorConditions(EndpointErrorConditionsT&& value) {
    m_endpointErrorConditionsHasBeenSet = true;
    m_endpointErrorConditions = std::forward<EndpointErrorConditionsT>(value);
  }
  template <typename EndpointErrorConditionsT = Aws::Vector<EndpointErrorCondition>>
  ForceEndpointErrorConfiguration& WithEndpointErrorConditions(EndpointErrorConditionsT&& value) {
    SetEndpointErrorConditions(std::forward<EndpointErrorConditionsT>(value));
    return *this;
  }
  inline ForceEndpointErrorConfiguration& AddEndpointErrorConditions(EndpointErrorCondition value) {
    m_endpointErrorConditionsHasBeenSet = true;
    m_endpointErrorConditions.push_back(value);
    return *this;
  }
  ///@}
 private:
