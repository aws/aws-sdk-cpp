...
namespace Model
{
  ...
  {
  public:
    AWS_MEDIAPACKAGEV2_API PutOriginEndpointPolicyResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    PutOriginEndpointPolicyResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
