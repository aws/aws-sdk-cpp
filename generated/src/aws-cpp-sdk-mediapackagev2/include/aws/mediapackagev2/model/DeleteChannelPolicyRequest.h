...
namespace Model
{
  ...
  /**
   */
  class DeleteChannelPolicyRequest : public Mediapackagev2Request
  {
  public:
    AWS_MEDIAPACKAGEV2_API DeleteChannelPolicyRequest();
     ...
     * Region.</p>
     */
    inline DeleteChannelPolicyRequest& WithChannelGroupName(const Aws::String& value) { SetChannelGroupName(value); return *this;}
     ...
     * Region.</p>
     */
    inline DeleteChannelPolicyRequest& WithChannelGroupName(Aws::String&& value) { SetChannelGroupName(std::move(value)); return *this;}
     ...
     * Region.</p>
     */
    inline DeleteChannelPolicyRequest& WithChannelGroupName(const char* value) { SetChannelGroupName(value); return *this;}
