...
namespace Model
{
  ...
  {
  public:
    AWS_MEDIAPACKAGEV2_API GetChannelPolicyRequest() = default;
    ...
    template<typename ChannelGroupNameT = Aws::String>
    GetChannelPolicyRequest& WithChannelGroupName(ChannelGroupNameT&& value) { SetChannelGroupName(std::forward<ChannelGroupNameT>(value)); return *this;}
    ///@}
    ...
    template<typename ChannelNameT = Aws::String>
    GetChannelPolicyRequest& WithChannelName(ChannelNameT&& value) { SetChannelName(std::forward<ChannelNameT>(value)); return *this;}
    ///@}
  private:
