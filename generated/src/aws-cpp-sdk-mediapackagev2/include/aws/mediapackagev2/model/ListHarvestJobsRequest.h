...
class ListHarvestJobsRequest : public Mediapackagev2Request {
 public:
  ...
  template <typename ChannelGroupNameT = Aws::String>
  ListHarvestJobsRequest& WithChannelGroupName(ChannelGroupNameT&& value) {
  ...
  template <typename ChannelNameT = Aws::String>
  ListHarvestJobsRequest& WithChannelName(ChannelNameT&& value) {
  ...
  template <typename OriginEndpointNameT = Aws::String>
  ListHarvestJobsRequest& WithOriginEndpointName(OriginEndpointNameT&& value) {
  ...
  inline void SetStatus(HarvestJobStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ListHarvestJobsRequest& WithStatus(HarvestJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline ListHarvestJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListHarvestJobsRequest& WithNextToken(NextTokenT&& value) {
