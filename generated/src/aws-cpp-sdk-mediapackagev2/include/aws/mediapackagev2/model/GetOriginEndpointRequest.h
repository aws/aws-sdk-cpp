...
namespace Model
{
  ...
  {
  public:
    AWS_MEDIAPACKAGEV2_API GetOriginEndpointRequest() = default;
    ...
    template<typename ChannelGroupNameT = Aws::String>
    GetOriginEndpointRequest& WithChannelGroupName(ChannelGroupNameT&& value) { SetChannelGroupName(std::forward<ChannelGroupNameT>(value)); return *this;}
    ///@}
    ...
    template<typename ChannelNameT = Aws::String>
    GetOriginEndpointRequest& WithChannelName(ChannelNameT&& value) { SetChannelName(std::forward<ChannelNameT>(value)); return *this;}
    ///@}
    ...
    template<typename OriginEndpointNameT = Aws::String>
    GetOriginEndpointRequest& WithOriginEndpointName(OriginEndpointNameT&& value) { SetOriginEndpointName(std::forward<OriginEndpointNameT>(value)); return *this;}
    ///@}
  private:
