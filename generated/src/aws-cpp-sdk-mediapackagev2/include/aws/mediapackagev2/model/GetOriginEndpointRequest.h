...
class GetOriginEndpointRequest : public Mediapackagev2Request {
 public:
  ...
  template <typename ChannelGroupNameT = Aws::String>
  GetOriginEndpointRequest& WithChannelGroupName(ChannelGroupNameT&& value) {
  ...
  template <typename ChannelNameT = Aws::String>
  GetOriginEndpointRequest& WithChannelName(ChannelNameT&& value) {
  ...
  template <typename OriginEndpointNameT = Aws::String>
  GetOriginEndpointRequest& WithOriginEndpointName(OriginEndpointNameT&& value) {
