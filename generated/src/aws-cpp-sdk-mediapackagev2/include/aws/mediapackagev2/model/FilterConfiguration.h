...
class FilterConfiguration {
 public:
  ...
  void SetManifestFilter(ManifestFilterT&& value) {
    m_manifestFilterHasBeenSet = true;
    m_manifestFilter = std::forward<ManifestFilterT>(value);
  }
  template <typename ManifestFilterT = Aws::String>
  FilterConfiguration& WithManifestFilter(ManifestFilterT&& value) {
    SetManifestFilter(std::forward<ManifestFilterT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename StartT = Aws::Utils::DateTime>
  FilterConfiguration& WithStart(StartT&& value) {
  ...
  template <typename EndT = Aws::Utils::DateTime>
  FilterConfiguration& WithEnd(EndT&& value) {
  ...
  inline FilterConfiguration& WithTimeDelaySeconds(int value) {
  ...
  void SetClipStartTime(ClipStartTimeT&& value) {
    m_clipStartTimeHasBeenSet = true;
    m_clipStartTime = std::forward<ClipStartTimeT>(value);
  }
  template <typename ClipStartTimeT = Aws::Utils::DateTime>
  FilterConfiguration& WithClipStartTime(ClipStartTimeT&& value) {
    SetClipStartTime(std::forward<ClipStartTimeT>(value));
    return *this;
  }
  ///@}
 private:
