...
class ListLowLatencyHlsManifestConfiguration {
 public:
  ...
  template <typename ManifestNameT = Aws::String>
  ListLowLatencyHlsManifestConfiguration& WithManifestName(ManifestNameT&& value) {
  ...
  template <typename ChildManifestNameT = Aws::String>
  ListLowLatencyHlsManifestConfiguration& WithChildManifestName(ChildManifestNameT&& value) {
  ...
  template <typename UrlT = Aws::String>
  ListLowLatencyHlsManifestConfiguration& WithUrl(UrlT&& value) {
