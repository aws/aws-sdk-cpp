...
class DashUtcTiming {
 public:
  ...
  inline void SetTimingMode(DashUtcTimingMode value) {
    m_timingModeHasBeenSet = true;
    m_timingMode = value;
  }
  inline DashUtcTiming& WithTimingMode(DashUtcTimingMode value) {
    SetTimingMode(value);
    return *this;
  }
  ///@}
  ...
  void SetTimingSource(TimingSourceT&& value) {
    m_timingSourceHasBeenSet = true;
    m_timingSource = std::forward<TimingSourceT>(value);
  }
  template <typename TimingSourceT = Aws::String>
  DashUtcTiming& WithTimingSource(TimingSourceT&& value) {
    SetTimingSource(std::forward<TimingSourceT>(value));
    return *this;
  }
  ///@}
 private:
