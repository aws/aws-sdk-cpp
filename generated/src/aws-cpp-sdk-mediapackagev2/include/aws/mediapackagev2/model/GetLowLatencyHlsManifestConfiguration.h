...
class GetLowLatencyHlsManifestConfiguration {
 public:
  ...
  template <typename ManifestNameT = Aws::String>
  GetLowLatencyHlsManifestConfiguration& WithManifestName(ManifestNameT&& value) {
  ...
  template <typename UrlT = Aws::String>
  GetLowLatencyHlsManifestConfiguration& WithUrl(UrlT&& value) {
  ...
  template <typename ChildManifestNameT = Aws::String>
  GetLowLatencyHlsManifestConfiguration& WithChildManifestName(ChildManifestNameT&& value) {
  ...
  inline GetLowLatencyHlsManifestConfiguration& WithManifestWindowSeconds(int value) {
  ...
  inline GetLowLatencyHlsManifestConfiguration& WithProgramDateTimeIntervalSeconds(int value) {
  ...
  template <typename ScteHlsT = ScteHls>
  GetLowLatencyHlsManifestConfiguration& WithScteHls(ScteHlsT&& value) {
  ...
  template <typename FilterConfigurationT = FilterConfiguration>
  GetLowLatencyHlsManifestConfiguration& WithFilterConfiguration(FilterConfigurationT&& value) {
  ...
  template <typename StartTagT = StartTag>
  GetLowLatencyHlsManifestConfiguration& WithStartTag(StartTagT&& value) {
  ...
  inline GetLowLatencyHlsManifestConfiguration& WithUrlEncodeChildManifest(bool value) {
  ...
  inline GetLowLatencyHlsManifestConfiguration& WithUriPathType(UriPathType value) {
