...
class GetOriginEndpointResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  GetOriginEndpointResult& WithArn(ArnT&& value) {
  ...
  inline GetOriginEndpointResult& WithContainerType(ContainerType value) {
  ...
  inline GetOriginEndpointResult& WithStartoverWindowSeconds(int value) {
  ...
  inline GetOriginEndpointResult& WithUriSeparator(UriSeparator value) {
