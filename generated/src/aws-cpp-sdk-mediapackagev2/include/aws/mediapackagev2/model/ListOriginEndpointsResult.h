...
class ListOriginEndpointsResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<OriginEndpointListConfiguration>>
  ListOriginEndpointsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = OriginEndpointListConfiguration>
  ListOriginEndpointsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListOriginEndpointsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListOriginEndpointsResult& WithRequestId(RequestIdT&& value) {
