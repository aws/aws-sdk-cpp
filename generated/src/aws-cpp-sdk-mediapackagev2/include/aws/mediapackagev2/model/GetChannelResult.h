...
class GetChannelResult {
 public:
  ...
  void SetIngestEndpoints(IngestEndpointsT&& value) {
    ...
    m_ingestEndpoints = std::forward<IngestEndpointsT>(value);
  }
  template <typename IngestEndpointsT = Aws::Vector<IngestEndpoint>>
  GetChannelResult& WithIngestEndpoints(IngestEndpointsT&& value) {
    SetIngestEndpoints(std::forward<IngestEndpointsT>(value));
    return *this;
  }
  template <typename IngestEndpointsT = IngestEndpoint>
  GetChannelResult& AddIngestEndpoints(IngestEndpointsT&& value) {
    m_ingestEndpointsHasBeenSet = true;
    m_ingestEndpoints.emplace_back(std::forward<IngestEndpointsT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetChannelResult& WithInputType(InputType value) {
    SetInputType(value);
    return *this;
  }
  ///@}
