...
class UpdateOriginEndpointResult {
 public:
  ...
  inline UpdateOriginEndpointResult& WithContainerType(ContainerType value) {
  ...
  inline UpdateOriginEndpointResult& WithUriSeparator(UriSeparator value) {
  ...
  inline UpdateOriginEndpointResult& WithStreamNameOutputMode(StreamNameOutputMode value) {
  ...
  template <typename ETagT = Aws::String>
  UpdateOriginEndpointResult& WithETag(ETagT&& value) {
