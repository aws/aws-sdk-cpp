...
class ResourceNotFoundException {
 public:
  ...
  inline void SetResourceTypeNotFound(ResourceTypeNotFound value) {
    m_resourceTypeNotFoundHasBeenSet = true;
    m_resourceTypeNotFound = value;
  }
  inline ResourceNotFoundException& WithResourceTypeNotFound(ResourceTypeNotFound value) {
    SetResourceTypeNotFound(value);
    return *this;
  }
  ///@}
 private:
