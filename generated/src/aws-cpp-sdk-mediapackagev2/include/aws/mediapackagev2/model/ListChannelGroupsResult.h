...
class ListChannelGroupsResult {
 public:
  AWS_MEDIAPACKAGEV2_API ListChannelGroupsResult() = default;
  ...
  template <typename ItemsT = Aws::Vector<ChannelGroupListConfiguration>>
  void SetItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
    m_items = std::forward<ItemsT>(value);
  }
  template <typename ItemsT = Aws::Vector<ChannelGroupListConfiguration>>
  ListChannelGroupsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = ChannelGroupListConfiguration>
  ListChannelGroupsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListChannelGroupsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListChannelGroupsResult& WithRequestId(RequestIdT&& value) {
