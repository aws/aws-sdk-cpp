...
class CreateHlsManifestConfiguration {
 public:
  ...
  inline CreateHlsManifestConfiguration& WithManifestWindowSeconds(int value) {
  ...
  inline CreateHlsManifestConfiguration& WithProgramDateTimeIntervalSeconds(int value) {
  ...
  inline CreateHlsManifestConfiguration& WithUrlEncodeChildManifest(bool value) {
  ...
  inline CreateHlsManifestConfiguration& WithUriPathType(UriPathType value) {
