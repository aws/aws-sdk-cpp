...
class UpdateChannelResult {
 public:
  ...
  template <typename MultiviewConfigurationT = MultiviewConfiguration>
  UpdateChannelResult& WithMultiviewConfiguration(MultiviewConfigurationT&& value) {
  ...
  template <typename AttachedMultiviewChannelsT = Aws::Vector<Aws::String>>
  UpdateChannelResult& WithAttachedMultiviewChannels(AttachedMultiviewChannelsT&& value) {
  ...
  UpdateChannelResult& AddAttachedMultiviewChannels(AttachedMultiviewChannelsT&& value) {
    m_attachedMultiviewChannelsHasBeenSet = true;
  ...
  inline UpdateChannelResult& WithInputType(InputType value) {
    SetInputType(value);
    return *this;
  }
  ///@}
  ...
  ///@{
  /**
   * <p>The output locking mode configured for the channel. This value is immutable
   * after channel creation.</p> <p>The allowed values are:</p> <ul> <li> <p>
   ...
   * time.</p> </li> <li> <p> <code>NON_EPOCH_LOCKED</code> - The channel uses
   * non-epoch-locked behavior with duration-based segment combining and
  ...
  inline UpdateChannelResult& WithOutputLockingMode(OutputLockingMode value) {
