...
class OriginEndpointListConfiguration {
 public:
  ...
  template <typename ArnT = Aws::String>
  OriginEndpointListConfiguration& WithArn(ArnT&& value) {
  ...
  template <typename ChannelGroupNameT = Aws::String>
  OriginEndpointListConfiguration& WithChannelGroupName(ChannelGroupNameT&& value) {
  ...
  template <typename ChannelNameT = Aws::String>
  OriginEndpointListConfiguration& WithChannelName(ChannelNameT&& value) {
  ...
  template <typename OriginEndpointNameT = Aws::String>
  OriginEndpointListConfiguration& WithOriginEndpointName(OriginEndpointNameT&& value) {
  ...
  inline OriginEndpointListConfiguration& WithContainerType(ContainerType value) {
  ...
  template <typename DescriptionT = Aws::String>
  OriginEndpointListConfiguration& WithDescription(DescriptionT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  OriginEndpointListConfiguration& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename ModifiedAtT = Aws::Utils::DateTime>
  OriginEndpointListConfiguration& WithModifiedAt(ModifiedAtT&& value) {
  ...
  template <typename HlsManifestsT = Aws::Vector<ListHlsManifestConfiguration>>
  OriginEndpointListConfiguration& WithHlsManifests(HlsManifestsT&& value) {
    SetHlsManifests(std::forward<HlsManifestsT>(value));
    return *this;
  }
  template <typename HlsManifestsT = ListHlsManifestConfiguration>
  OriginEndpointListConfiguration& AddHlsManifests(HlsManifestsT&& value) {
    m_hlsManifestsHasBeenSet = true;
  ...
  template <typename LowLatencyHlsManifestsT = Aws::Vector<ListLowLatencyHlsManifestConfiguration>>
  OriginEndpointListConfiguration& WithLowLatencyHlsManifests(LowLatencyHlsManifestsT&& value) {
  ...
  OriginEndpointListConfiguration& AddLowLatencyHlsManifests(LowLatencyHlsManifestsT&& value) {
    m_lowLatencyHlsManifestsHasBeenSet = true;
  ...
  template <typename DashManifestsT = Aws::Vector<ListDashManifestConfiguration>>
  OriginEndpointListConfiguration& WithDashManifests(DashManifestsT&& value) {
    SetDashManifests(std::forward<DashManifestsT>(value));
    return *this;
  }
  template <typename DashManifestsT = ListDashManifestConfiguration>
  OriginEndpointListConfiguration& AddDashManifests(DashManifestsT&& value) {
    m_dashManifestsHasBeenSet = true;
  ...
  template <typename MssManifestsT = Aws::Vector<ListMssManifestConfiguration>>
  OriginEndpointListConfiguration& WithMssManifests(MssManifestsT&& value) {
    SetMssManifests(std::forward<MssManifestsT>(value));
    return *this;
  }
  template <typename MssManifestsT = ListMssManifestConfiguration>
  OriginEndpointListConfiguration& AddMssManifests(MssManifestsT&& value) {
    m_mssManifestsHasBeenSet = true;
  ...
  template <typename ForceEndpointErrorConfigurationT = ForceEndpointErrorConfiguration>
  OriginEndpointListConfiguration& WithForceEndpointErrorConfiguration(ForceEndpointErrorConfigurationT&& value) {
