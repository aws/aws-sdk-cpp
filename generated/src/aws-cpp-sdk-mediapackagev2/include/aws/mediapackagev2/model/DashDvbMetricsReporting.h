...
class DashDvbMetricsReporting {
 public:
  ...
  void SetReportingUrl(ReportingUrlT&& value) {
    m_reportingUrlHasBeenSet = true;
    m_reportingUrl = std::forward<ReportingUrlT>(value);
  }
  template <typename ReportingUrlT = Aws::String>
  DashDvbMetricsReporting& WithReportingUrl(ReportingUrlT&& value) {
    SetReportingUrl(std::forward<ReportingUrlT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetProbability(int value) {
    m_probabilityHasBeenSet = true;
    m_probability = value;
  }
  inline DashDvbMetricsReporting& WithProbability(int value) {
