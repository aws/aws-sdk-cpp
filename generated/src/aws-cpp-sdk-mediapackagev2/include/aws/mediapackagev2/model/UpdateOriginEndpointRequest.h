...
class UpdateOriginEndpointRequest : public Mediapackagev2Request {
 public:
  ...
  inline UpdateOriginEndpointRequest& WithContainerType(ContainerType value) {
  ...
  inline UpdateOriginEndpointRequest& WithStartoverWindowSeconds(int value) {
  ...
  template <typename ETagT = Aws::String>
  UpdateOriginEndpointRequest& WithETag(ETagT&& value) {
