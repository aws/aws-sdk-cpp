...
class DeleteOriginEndpointRequest : public Mediapackagev2Request {
 public:
  ...
  template <typename ChannelGroupNameT = Aws::String>
  DeleteOriginEndpointRequest& WithChannelGroupName(ChannelGroupNameT&& value) {
  ...
  template <typename ChannelNameT = Aws::String>
  DeleteOriginEndpointRequest& WithChannelName(ChannelNameT&& value) {
  ...
  template <typename OriginEndpointNameT = Aws::String>
  DeleteOriginEndpointRequest& WithOriginEndpointName(OriginEndpointNameT&& value) {
