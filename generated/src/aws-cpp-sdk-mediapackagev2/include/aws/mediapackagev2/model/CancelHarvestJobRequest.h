...
class CancelHarvestJobRequest : public Mediapackagev2Request {
 public:
  ...
  template <typename ChannelGroupNameT = Aws::String>
  CancelHarvestJobRequest& WithChannelGroupName(ChannelGroupNameT&& value) {
  ...
  template <typename ChannelNameT = Aws::String>
  CancelHarvestJobRequest& WithChannelName(ChannelNameT&& value) {
  ...
  template <typename OriginEndpointNameT = Aws::String>
  CancelHarvestJobRequest& WithOriginEndpointName(OriginEndpointNameT&& value) {
  ...
  template <typename HarvestJobNameT = Aws::String>
  CancelHarvestJobRequest& WithHarvestJobName(HarvestJobNameT&& value) {
  ...
  template <typename ETagT = Aws::String>
  CancelHarvestJobRequest& WithETag(ETagT&& value) {
