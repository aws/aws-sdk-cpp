...
class CreateChannelRequest : public Mediapackagev2Request {
 public:
  ...
  inline CreateChannelRequest& WithInputType(InputType value) {
    SetInputType(value);
    return *this;
  }
  ///@}
  ...
  void SetInputSwitchConfiguration(InputSwitchConfigurationT&& value) {
    ...
    m_inputSwitchConfiguration = std::forward<InputSwitchConfigurationT>(value);
  }
  template <typename InputSwitchConfigurationT = InputSwitchConfiguration>
  CreateChannelRequest& WithInputSwitchConfiguration(InputSwitchConfigurationT&& value) {
    SetInputSwitchConfiguration(std::forward<InputSwitchConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOutputHeaderConfiguration(OutputHeaderConfigurationT&& value) {
    ...
    m_outputHeaderConfiguration = std::forward<OutputHeaderConfigurationT>(value);
  }
  template <typename OutputHeaderConfigurationT = OutputHeaderConfiguration>
  CreateChannelRequest& WithOutputHeaderConfiguration(OutputHeaderConfigurationT&& value) {
    SetOutputHeaderConfiguration(std::forward<OutputHeaderConfigurationT>(value));
    return *this;
  }
  ///@}
