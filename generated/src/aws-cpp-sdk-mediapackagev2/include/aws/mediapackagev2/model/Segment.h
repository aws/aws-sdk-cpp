...
class Segment {
 public:
  ...
  inline Segment& WithSegmentDurationSeconds(int value) {
  ...
  inline void SetTsUseAudioRenditionGroup(bool value) {
    m_tsUseAudioRenditionGroupHasBeenSet = true;
    m_tsUseAudioRenditionGroup = value;
  }
  inline Segment& WithTsUseAudioRenditionGroup(bool value) {
    SetTsUseAudioRenditionGroup(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIncludeIframeOnlyStreams(bool value) {
    m_includeIframeOnlyStreamsHasBeenSet = true;
    m_includeIframeOnlyStreams = value;
  }
  inline Segment& WithIncludeIframeOnlyStreams(bool value) {
    SetIncludeIframeOnlyStreams(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTsIncludeDvbSubtitles(bool value) {
    m_tsIncludeDvbSubtitlesHasBeenSet = true;
    m_tsIncludeDvbSubtitles = value;
  }
  inline Segment& WithTsIncludeDvbSubtitles(bool value) {
    SetTsIncludeDvbSubtitles(value);
    return *this;
  }
  ///@}
  ...
  void SetScte(ScteT&& value) {
    ...
    m_scte = std::forward<ScteT>(value);
  }
  template <typename ScteT = Scte>
  Segment& WithScte(ScteT&& value) {
    SetScte(std::forward<ScteT>(value));
    return *this;
  }
  ///@}
