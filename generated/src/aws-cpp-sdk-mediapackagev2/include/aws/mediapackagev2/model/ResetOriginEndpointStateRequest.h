...
class ResetOriginEndpointStateRequest : public Mediapackagev2Request {
 public:
  ...
  template <typename ChannelGroupNameT = Aws::String>
  ResetOriginEndpointStateRequest& WithChannelGroupName(ChannelGroupNameT&& value) {
  ...
  template <typename ChannelNameT = Aws::String>
  ResetOriginEndpointStateRequest& WithChannelName(ChannelNameT&& value) {
  ...
  template <typename OriginEndpointNameT = Aws::String>
  ResetOriginEndpointStateRequest& WithOriginEndpointName(OriginEndpointNameT&& value) {
