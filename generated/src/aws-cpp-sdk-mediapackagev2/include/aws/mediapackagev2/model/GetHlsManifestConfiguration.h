...
namespace Model
{
  ...
  public:
    ...
    template<typename ManifestNameT = Aws::String>
    GetHlsManifestConfiguration& WithManifestName(ManifestNameT&& value) { SetManifestName(std::forward<ManifestNameT>(value)); return *this;}
    ///@}
    ...
    template<typename UrlT = Aws::String>
    GetHlsManifestConfiguration& WithUrl(UrlT&& value) { SetUrl(std::forward<UrlT>(value)); return *this;}
    ///@}
    ...
    template<typename ChildManifestNameT = Aws::String>
    GetHlsManifestConfiguration& WithChildManifestName(ChildManifestNameT&& value) { SetChildManifestName(std::forward<ChildManifestNameT>(value)); return *this;}
    ///@}
    ...
    template<typename ScteHlsT = ScteHls>
    GetHlsManifestConfiguration& WithScteHls(ScteHlsT&& value) { SetScteHls(std::forward<ScteHlsT>(value)); return *this;}
    ///@}
    ...
    template<typename FilterConfigurationT = FilterConfiguration>
    GetHlsManifestConfiguration& WithFilterConfiguration(FilterConfigurationT&& value) { SetFilterConfiguration(std::forward<FilterConfigurationT>(value)); return *this;}
    ///@}
    ...
    template<typename StartTagT = StartTag>
    GetHlsManifestConfiguration& WithStartTag(StartTagT&& value) { SetStartTag(std::forward<StartTagT>(value)); return *this;}
    ///@}
