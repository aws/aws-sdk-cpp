...
ValidationException& ValidationException::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("ValidationExceptionType")) {
    m_validationExceptionType =
        ValidationExceptionTypeMapper::GetValidationExceptionTypeForName(jsonValue.GetString("ValidationExceptionType"));
...
JsonValue ValidationException::Jsonize() const {
  ...
  if (m_validationExceptionTypeHasBeenSet) {
    payload.WithString("ValidationExceptionType",
                       ValidationExceptionTypeMapper::GetNameForValidationExceptionType(m_validationExceptionType));
  }
