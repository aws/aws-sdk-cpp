...
ResetOriginEndpointStateResult::ResetOriginEndpointStateResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

ResetOriginEndpointStateResult& ResetOriginEndpointStateResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
