...
GetChannelGroupResult::GetChannelGroupResult()
{
}

GetChannelGroupResult::GetChannelGroupResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

GetChannelGroupResult& GetChannelGroupResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
