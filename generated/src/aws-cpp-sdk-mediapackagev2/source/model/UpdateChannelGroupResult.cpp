...
UpdateChannelGroupResult::UpdateChannelGroupResult()
{
}

UpdateChannelGroupResult::UpdateChannelGroupResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

UpdateChannelGroupResult& UpdateChannelGroupResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
