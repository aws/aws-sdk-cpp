...
GetOriginEndpointResult::GetOriginEndpointResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
GetOriginEndpointResult& GetOriginEndpointResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("LowLatencyHlsManifests")) {
    ...
    for (unsigned lowLatencyHlsManifestsIndex = 0; lowLatencyHlsManifestsIndex < lowLatencyHlsManifestsJsonList.GetLength();
         ++lowLatencyHlsManifestsIndex) {
