...
CdnAuthConfiguration::CdnAuthConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
CdnAuthConfiguration& CdnAuthConfiguration::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("CdnIdentifierSecretArns")) {
    ...
    for (unsigned cdnIdentifierSecretArnsIndex = 0; cdnIdentifierSecretArnsIndex < cdnIdentifierSecretArnsJsonList.GetLength();
         ++cdnIdentifierSecretArnsIndex) {
