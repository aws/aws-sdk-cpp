...
class CreateGuardrailVersionResult {
 public:
  ...
  template <typename GuardrailIdT = Aws::String>
  CreateGuardrailVersionResult& WithGuardrailId(GuardrailIdT&& value) {
  ...
  template <typename VersionT = Aws::String>
  CreateGuardrailVersionResult& WithVersion(VersionT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateGuardrailVersionResult& WithRequestId(RequestIdT&& value) {
