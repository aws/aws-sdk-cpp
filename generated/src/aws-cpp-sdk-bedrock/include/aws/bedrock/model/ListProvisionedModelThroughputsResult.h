...
class ListProvisionedModelThroughputsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListProvisionedModelThroughputsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetProvisionedModelSummaries(ProvisionedModelSummariesT&& value) {
    m_provisionedModelSummariesHasBeenSet = true;
    m_provisionedModelSummaries = std::forward<ProvisionedModelSummariesT>(value);
  }
  template <typename ProvisionedModelSummariesT = Aws::Vector<ProvisionedModelSummary>>
  ListProvisionedModelThroughputsResult& WithProvisionedModelSummaries(ProvisionedModelSummariesT&& value) {
    SetProvisionedModelSummaries(std::forward<ProvisionedModelSummariesT>(value));
    return *this;
  }
  template <typename ProvisionedModelSummariesT = ProvisionedModelSummary>
  ListProvisionedModelThroughputsResult& AddProvisionedModelSummaries(ProvisionedModelSummariesT&& value) {
    m_provisionedModelSummariesHasBeenSet = true;
    m_provisionedModelSummaries.emplace_back(std::forward<ProvisionedModelSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListProvisionedModelThroughputsResult& WithRequestId(RequestIdT&& value) {
