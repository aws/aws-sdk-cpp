...
class AutomatedReasoningPolicyBuildStepMessage {
 public:
  ...
  template <typename MessageT = Aws::String>
  AutomatedReasoningPolicyBuildStepMessage& WithMessage(MessageT&& value) {
  ...
  inline void SetMessageType(AutomatedReasoningPolicyBuildMessageType value) {
    m_messageTypeHasBeenSet = true;
    m_messageType = value;
  }
  inline AutomatedReasoningPolicyBuildStepMessage& WithMessageType(AutomatedReasoningPolicyBuildMessageType value) {
