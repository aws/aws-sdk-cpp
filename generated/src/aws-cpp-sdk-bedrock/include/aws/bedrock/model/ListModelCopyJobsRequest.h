...
class ListModelCopyJobsRequest : public BedrockRequest {
 public:
  ...
  template <typename CreationTimeAfterT = Aws::Utils::DateTime>
  ListModelCopyJobsRequest& WithCreationTimeAfter(CreationTimeAfterT&& value) {
  ...
  template <typename CreationTimeBeforeT = Aws::Utils::DateTime>
  ListModelCopyJobsRequest& WithCreationTimeBefore(CreationTimeBeforeT&& value) {
  ...
  inline void SetStatusEquals(ModelCopyJobStatus value) {
    m_statusEqualsHasBeenSet = true;
    m_statusEquals = value;
  }
  inline ListModelCopyJobsRequest& WithStatusEquals(ModelCopyJobStatus value) {
  ...
  void SetSourceAccountEquals(SourceAccountEqualsT&& value) {
    m_sourceAccountEqualsHasBeenSet = true;
    m_sourceAccountEquals = std::forward<SourceAccountEqualsT>(value);
  }
  template <typename SourceAccountEqualsT = Aws::String>
  ListModelCopyJobsRequest& WithSourceAccountEquals(SourceAccountEqualsT&& value) {
    SetSourceAccountEquals(std::forward<SourceAccountEqualsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSourceModelArnEquals(SourceModelArnEqualsT&& value) {
    m_sourceModelArnEqualsHasBeenSet = true;
    m_sourceModelArnEquals = std::forward<SourceModelArnEqualsT>(value);
  }
  template <typename SourceModelArnEqualsT = Aws::String>
  ListModelCopyJobsRequest& WithSourceModelArnEquals(SourceModelArnEqualsT&& value) {
    SetSourceModelArnEquals(std::forward<SourceModelArnEqualsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTargetModelNameContains(TargetModelNameContainsT&& value) {
    m_targetModelNameContainsHasBeenSet = true;
    m_targetModelNameContains = std::forward<TargetModelNameContainsT>(value);
  }
  template <typename TargetModelNameContainsT = Aws::String>
  ListModelCopyJobsRequest& WithTargetModelNameContains(TargetModelNameContainsT&& value) {
    SetTargetModelNameContains(std::forward<TargetModelNameContainsT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListModelCopyJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListModelCopyJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListModelCopyJobsRequest& WithSortBy(SortJobsBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListModelCopyJobsRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
