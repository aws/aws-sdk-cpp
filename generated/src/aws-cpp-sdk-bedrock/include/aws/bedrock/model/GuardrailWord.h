...
namespace Model
{
  ...
  public:
    ...
    inline GuardrailWord& WithInputAction(GuardrailWordAction value) { SetInputAction(value); return *this;}
    ///@}
    ...
    inline GuardrailWord& WithOutputAction(GuardrailWordAction value) { SetOutputAction(value); return *this;}
    ///@}
    ...
    inline GuardrailWord& WithInputEnabled(bool value) { SetInputEnabled(value); return *this;}
    ///@}
    ...
    inline GuardrailWord& WithOutputEnabled(bool value) { SetOutputEnabled(value); return *this;}
    ///@}
  private:
