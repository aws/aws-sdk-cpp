...
class GuardrailWord {
 public:
  ...
  inline GuardrailWord& WithInputAction(GuardrailWordAction value) {
  ...
  inline GuardrailWord& WithOutputAction(GuardrailWordAction value) {
  ...
  inline GuardrailWord& WithInputEnabled(bool value) {
  ...
  inline GuardrailWord& WithOutputEnabled(bool value) {
