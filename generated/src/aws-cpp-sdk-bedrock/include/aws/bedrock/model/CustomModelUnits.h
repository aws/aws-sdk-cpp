...
class CustomModelUnits {
 public:
  ...
  inline void SetCustomModelUnitsPerModelCopy(int value) {
    m_customModelUnitsPerModelCopyHasBeenSet = true;
    m_customModelUnitsPerModelCopy = value;
  }
  inline CustomModelUnits& WithCustomModelUnitsPerModelCopy(int value) {
    SetCustomModelUnitsPerModelCopy(value);
    return *this;
  }
  ///@}
  ...
  void SetCustomModelUnitsVersion(CustomModelUnitsVersionT&& value) {
    ...
    m_customModelUnitsVersion = std::forward<CustomModelUnitsVersionT>(value);
  }
  template <typename CustomModelUnitsVersionT = Aws::String>
  CustomModelUnits& WithCustomModelUnitsVersion(CustomModelUnitsVersionT&& value) {
    SetCustomModelUnitsVersion(std::forward<CustomModelUnitsVersionT>(value));
    return *this;
  }
  ///@}
 private:
