...
class GuardrailPiiEntityConfig {
 public:
  ...
  inline void SetInputAction(GuardrailSensitiveInformationAction value) {
    m_inputActionHasBeenSet = true;
    m_inputAction = value;
  }
  inline GuardrailPiiEntityConfig& WithInputAction(GuardrailSensitiveInformationAction value) {
  ...
  inline void SetOutputAction(GuardrailSensitiveInformationAction value) {
    m_outputActionHasBeenSet = true;
    m_outputAction = value;
  }
  inline GuardrailPiiEntityConfig& WithOutputAction(GuardrailSensitiveInformationAction value) {
  ...
  inline GuardrailPiiEntityConfig& WithInputEnabled(bool value) {
  ...
  inline GuardrailPiiEntityConfig& WithOutputEnabled(bool value) {
