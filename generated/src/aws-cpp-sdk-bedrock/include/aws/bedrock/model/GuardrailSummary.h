...
class GuardrailSummary {
 public:
  ...
  inline void SetStatus(GuardrailStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline GuardrailSummary& WithStatus(GuardrailStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetCrossRegionDetails(CrossRegionDetailsT&& value) {
    ...
    m_crossRegionDetails = std::forward<CrossRegionDetailsT>(value);
  }
  template <typename CrossRegionDetailsT = GuardrailCrossRegionDetails>
  GuardrailSummary& WithCrossRegionDetails(CrossRegionDetailsT&& value) {
    SetCrossRegionDetails(std::forward<CrossRegionDetailsT>(value));
    return *this;
  }
  ///@}
 private:
