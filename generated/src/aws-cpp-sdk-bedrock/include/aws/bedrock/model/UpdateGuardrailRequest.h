...
class UpdateGuardrailRequest : public BedrockRequest {
 public:
  ...
  void SetTopicPolicyConfig(TopicPolicyConfigT&& value) {
    ...
    m_topicPolicyConfig = std::forward<TopicPolicyConfigT>(value);
  }
  template <typename TopicPolicyConfigT = GuardrailTopicPolicyConfig>
  UpdateGuardrailRequest& WithTopicPolicyConfig(TopicPolicyConfigT&& value) {
    SetTopicPolicyConfig(std::forward<TopicPolicyConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetContentPolicyConfig(ContentPolicyConfigT&& value) {
    ...
    m_contentPolicyConfig = std::forward<ContentPolicyConfigT>(value);
  }
  template <typename ContentPolicyConfigT = GuardrailContentPolicyConfig>
  UpdateGuardrailRequest& WithContentPolicyConfig(ContentPolicyConfigT&& value) {
    SetContentPolicyConfig(std::forward<ContentPolicyConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetWordPolicyConfig(WordPolicyConfigT&& value) {
    ...
    m_wordPolicyConfig = std::forward<WordPolicyConfigT>(value);
  }
  template <typename WordPolicyConfigT = GuardrailWordPolicyConfig>
  UpdateGuardrailRequest& WithWordPolicyConfig(WordPolicyConfigT&& value) {
    SetWordPolicyConfig(std::forward<WordPolicyConfigT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const GuardrailSensitiveInformationPolicyConfig& GetSensitiveInformationPolicyConfig() const {
    return m_sensitiveInformationPolicyConfig;
  }
  ...
  void SetSensitiveInformationPolicyConfig(SensitiveInformationPolicyConfigT&& value) {
    ...
    m_sensitiveInformationPolicyConfig = std::forward<SensitiveInformationPolicyConfigT>(value);
  }
  template <typename SensitiveInformationPolicyConfigT = GuardrailSensitiveInformationPolicyConfig>
  UpdateGuardrailRequest& WithSensitiveInformationPolicyConfig(SensitiveInformationPolicyConfigT&& value) {
    SetSensitiveInformationPolicyConfig(std::forward<SensitiveInformationPolicyConfigT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const GuardrailContextualGroundingPolicyConfig& GetContextualGroundingPolicyConfig() const {
    return m_contextualGroundingPolicyConfig;
  }
  ...
  void SetContextualGroundingPolicyConfig(ContextualGroundingPolicyConfigT&& value) {
    ...
    m_contextualGroundingPolicyConfig = std::forward<ContextualGroundingPolicyConfigT>(value);
  }
  template <typename ContextualGroundingPolicyConfigT = GuardrailContextualGroundingPolicyConfig>
  UpdateGuardrailRequest& WithContextualGroundingPolicyConfig(ContextualGroundingPolicyConfigT&& value) {
    SetContextualGroundingPolicyConfig(std::forward<ContextualGroundingPolicyConfigT>(value));
    return *this;
  }
  ///@}
   ...
   * guardrail.</p>
   */
  inline const GuardrailAutomatedReasoningPolicyConfig& GetAutomatedReasoningPolicyConfig() const {
    return m_automatedReasoningPolicyConfig;
  }
  ...
  void SetAutomatedReasoningPolicyConfig(AutomatedReasoningPolicyConfigT&& value) {
    m_automatedReasoningPolicyConfigHasBeenSet = true;
    m_automatedReasoningPolicyConfig = std::forward<AutomatedReasoningPolicyConfigT>(value);
  }
  template <typename AutomatedReasoningPolicyConfigT = GuardrailAutomatedReasoningPolicyConfig>
  UpdateGuardrailRequest& WithAutomatedReasoningPolicyConfig(AutomatedReasoningPolicyConfigT&& value) {
    SetAutomatedReasoningPolicyConfig(std::forward<AutomatedReasoningPolicyConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCrossRegionConfig(CrossRegionConfigT&& value) {
    ...
    m_crossRegionConfig = std::forward<CrossRegionConfigT>(value);
  }
  template <typename CrossRegionConfigT = GuardrailCrossRegionConfig>
  UpdateGuardrailRequest& WithCrossRegionConfig(CrossRegionConfigT&& value) {
    SetCrossRegionConfig(std::forward<CrossRegionConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBlockedInputMessaging(BlockedInputMessagingT&& value) {
    ...
    m_blockedInputMessaging = std::forward<BlockedInputMessagingT>(value);
  }
  template <typename BlockedInputMessagingT = Aws::String>
  UpdateGuardrailRequest& WithBlockedInputMessaging(BlockedInputMessagingT&& value) {
    SetBlockedInputMessaging(std::forward<BlockedInputMessagingT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBlockedOutputsMessaging(BlockedOutputsMessagingT&& value) {
    ...
    m_blockedOutputsMessaging = std::forward<BlockedOutputsMessagingT>(value);
  }
  template <typename BlockedOutputsMessagingT = Aws::String>
  UpdateGuardrailRequest& WithBlockedOutputsMessaging(BlockedOutputsMessagingT&& value) {
    SetBlockedOutputsMessaging(std::forward<BlockedOutputsMessagingT>(value));
    return *this;
  }
  ///@}
