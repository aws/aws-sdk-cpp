...
class ListEvaluationJobsRequest : public BedrockRequest {
 public:
  ...
  inline void SetStatusEquals(EvaluationJobStatus value) {
    m_statusEqualsHasBeenSet = true;
    m_statusEquals = value;
  }
  inline ListEvaluationJobsRequest& WithStatusEquals(EvaluationJobStatus value) {
  ...
  inline void SetApplicationTypeEquals(ApplicationType value) {
    m_applicationTypeEqualsHasBeenSet = true;
    m_applicationTypeEquals = value;
  }
  inline ListEvaluationJobsRequest& WithApplicationTypeEquals(ApplicationType value) {
    SetApplicationTypeEquals(value);
    return *this;
  }
  ///@}
  ...
  inline ListEvaluationJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline ListEvaluationJobsRequest& WithSortBy(SortJobsBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListEvaluationJobsRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
