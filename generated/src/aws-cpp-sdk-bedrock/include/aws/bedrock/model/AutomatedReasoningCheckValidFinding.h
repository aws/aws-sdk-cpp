...
class AutomatedReasoningCheckValidFinding {
 public:
  ...
  void SetSupportingRules(SupportingRulesT&& value) {
    ...
    m_supportingRules = std::forward<SupportingRulesT>(value);
  }
  template <typename SupportingRulesT = Aws::Vector<AutomatedReasoningCheckRule>>
  AutomatedReasoningCheckValidFinding& WithSupportingRules(SupportingRulesT&& value) {
    SetSupportingRules(std::forward<SupportingRulesT>(value));
    return *this;
  }
  ...
  AutomatedReasoningCheckValidFinding& AddSupportingRules(SupportingRulesT&& value) {
    m_supportingRulesHasBeenSet = true;
    m_supportingRules.emplace_back(std::forward<SupportingRulesT>(value));
    return *this;
  }
  ///@}
