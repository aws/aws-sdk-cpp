...
namespace Model
{
  ...
  public:
    ...
    template<typename TranslationT = AutomatedReasoningCheckTranslation>
    AutomatedReasoningCheckImpossibleFinding& WithTranslation(TranslationT&& value) { SetTranslation(std::forward<TranslationT>(value)); return *this;}
    ///@}
    ...
    template<typename ContradictingRulesT = Aws::Vector<AutomatedReasoningCheckRule>>
    AutomatedReasoningCheckImpossibleFinding& WithContradictingRules(ContradictingRulesT&& value) { SetContradictingRules(std::forward<ContradictingRulesT>(value)); return *this;}
    template<typename ContradictingRulesT = AutomatedReasoningCheckRule>
    AutomatedReasoningCheckImpossibleFinding& AddContradictingRules(ContradictingRulesT&& value) { m_contradictingRulesHasBeenSet = true; m_contradictingRules.emplace_back(std::forward<ContradictingRulesT>(value)); return *this; }
    ///@}
    ...
    template<typename LogicWarningT = AutomatedReasoningCheckLogicWarning>
    AutomatedReasoningCheckImpossibleFinding& WithLogicWarning(LogicWarningT&& value) { SetLogicWarning(std::forward<LogicWarningT>(value)); return *this;}
    ///@}
  private:
