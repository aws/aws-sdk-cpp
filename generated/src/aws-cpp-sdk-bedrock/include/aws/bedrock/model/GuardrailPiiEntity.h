...
class GuardrailPiiEntity {
 public:
  ...
  inline GuardrailPiiEntity& WithType(GuardrailPiiEntityType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline GuardrailPiiEntity& WithAction(GuardrailSensitiveInformationAction value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  inline GuardrailPiiEntity& WithInputAction(GuardrailSensitiveInformationAction value) {
  ...
  inline GuardrailPiiEntity& WithOutputAction(GuardrailSensitiveInformationAction value) {
  ...
  inline GuardrailPiiEntity& WithInputEnabled(bool value) {
  ...
  inline GuardrailPiiEntity& WithOutputEnabled(bool value) {
