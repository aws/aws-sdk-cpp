...
class DeleteAutomatedReasoningPolicyTestCaseRequest : public BedrockRequest {
 public:
  ...
  template <typename PolicyArnT = Aws::String>
  DeleteAutomatedReasoningPolicyTestCaseRequest& WithPolicyArn(PolicyArnT&& value) {
  ...
  template <typename TestCaseIdT = Aws::String>
  DeleteAutomatedReasoningPolicyTestCaseRequest& WithTestCaseId(TestCaseIdT&& value) {
  ...
  template <typename LastUpdatedAtT = Aws::Utils::DateTime>
  DeleteAutomatedReasoningPolicyTestCaseRequest& WithLastUpdatedAt(LastUpdatedAtT&& value) {
