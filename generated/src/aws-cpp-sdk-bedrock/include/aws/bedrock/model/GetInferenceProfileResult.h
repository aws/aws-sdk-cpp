...
class GetInferenceProfileResult {
 public:
  ...
  void SetInferenceProfileId(InferenceProfileIdT&& value) {
    ...
    m_inferenceProfileId = std::forward<InferenceProfileIdT>(value);
  }
  template <typename InferenceProfileIdT = Aws::String>
  GetInferenceProfileResult& WithInferenceProfileId(InferenceProfileIdT&& value) {
    SetInferenceProfileId(std::forward<InferenceProfileIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetInferenceProfileResult& WithStatus(InferenceProfileStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetType(InferenceProfileType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline GetInferenceProfileResult& WithType(InferenceProfileType value) {
    SetType(value);
    return *this;
  }
  ///@}
