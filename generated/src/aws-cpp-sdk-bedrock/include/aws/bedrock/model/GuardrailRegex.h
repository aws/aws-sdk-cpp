...
namespace Model
{
  ...
  public:
    ...
    template<typename NameT = Aws::String>
    GuardrailRegex& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    GuardrailRegex& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename PatternT = Aws::String>
    GuardrailRegex& WithPattern(PatternT&& value) { SetPattern(std::forward<PatternT>(value)); return *this;}
    ///@}
    ...
    inline GuardrailRegex& WithAction(GuardrailSensitiveInformationAction value) { SetAction(value); return *this;}
    ///@}
    ...
    inline GuardrailRegex& WithInputAction(GuardrailSensitiveInformationAction value) { SetInputAction(value); return *this;}
    ///@}
    ...
    inline GuardrailRegex& WithOutputAction(GuardrailSensitiveInformationAction value) { SetOutputAction(value); return *this;}
    ///@}
    ...
    inline GuardrailRegex& WithInputEnabled(bool value) { SetInputEnabled(value); return *this;}
    ///@}
    ...
    inline GuardrailRegex& WithOutputEnabled(bool value) { SetOutputEnabled(value); return *this;}
    ///@}
  private:
