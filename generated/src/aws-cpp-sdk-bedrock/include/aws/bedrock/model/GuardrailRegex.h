...
class GuardrailRegex {
 public:
  ...
  inline GuardrailRegex& WithAction(GuardrailSensitiveInformationAction value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  inline GuardrailRegex& WithInputAction(GuardrailSensitiveInformationAction value) {
  ...
  inline GuardrailRegex& WithOutputAction(GuardrailSensitiveInformationAction value) {
  ...
  inline GuardrailRegex& WithInputEnabled(bool value) {
  ...
  inline GuardrailRegex& WithOutputEnabled(bool value) {
