...
class AdvancedPromptOptimizationOutputConfig {
 public:
  AWS_BEDROCK_API AdvancedPromptOptimizationOutputConfig() = default;
  AWS_BEDROCK_API AdvancedPromptOptimizationOutputConfig(Aws::Utils::Json::JsonView jsonValue);
  AWS_BEDROCK_API AdvancedPromptOptimizationOutputConfig& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename S3UriT = Aws::String>
  AdvancedPromptOptimizationOutputConfig& WithS3Uri(S3UriT&& value) {
