...
class UpdateAutomatedReasoningPolicyTestCaseRequest : public BedrockRequest {
 public:
  ...
  template <typename PolicyArnT = Aws::String>
  UpdateAutomatedReasoningPolicyTestCaseRequest& WithPolicyArn(PolicyArnT&& value) {
  ...
  template <typename TestCaseIdT = Aws::String>
  UpdateAutomatedReasoningPolicyTestCaseRequest& WithTestCaseId(TestCaseIdT&& value) {
  ...
  template <typename GuardContentT = Aws::String>
  UpdateAutomatedReasoningPolicyTestCaseRequest& WithGuardContent(GuardContentT&& value) {
  ...
  template <typename QueryContentT = Aws::String>
  UpdateAutomatedReasoningPolicyTestCaseRequest& WithQueryContent(QueryContentT&& value) {
  ...
  template <typename LastUpdatedAtT = Aws::Utils::DateTime>
  UpdateAutomatedReasoningPolicyTestCaseRequest& WithLastUpdatedAt(LastUpdatedAtT&& value) {
  ...
  inline UpdateAutomatedReasoningPolicyTestCaseRequest& WithExpectedAggregatedFindingsResult(AutomatedReasoningCheckResult value) {
  ...
  inline UpdateAutomatedReasoningPolicyTestCaseRequest& WithConfidenceThreshold(double value) {
  ...
  template <typename ClientRequestTokenT = Aws::String>
  UpdateAutomatedReasoningPolicyTestCaseRequest& WithClientRequestToken(ClientRequestTokenT&& value) {
