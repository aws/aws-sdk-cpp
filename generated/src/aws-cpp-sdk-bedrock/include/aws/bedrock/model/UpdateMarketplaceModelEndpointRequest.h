...
class UpdateMarketplaceModelEndpointRequest : public BedrockRequest {
 public:
  ...
  template <typename EndpointArnT = Aws::String>
  UpdateMarketplaceModelEndpointRequest& WithEndpointArn(EndpointArnT&& value) {
  ...
  template <typename EndpointConfigT = EndpointConfig>
  UpdateMarketplaceModelEndpointRequest& WithEndpointConfig(EndpointConfigT&& value) {
  ...
  template <typename ClientRequestTokenT = Aws::String>
  UpdateMarketplaceModelEndpointRequest& WithClientRequestToken(ClientRequestTokenT&& value) {
