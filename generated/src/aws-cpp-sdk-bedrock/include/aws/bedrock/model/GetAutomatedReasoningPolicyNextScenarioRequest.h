...
class GetAutomatedReasoningPolicyNextScenarioRequest : public BedrockRequest {
 public:
  ...
  template <typename PolicyArnT = Aws::String>
  GetAutomatedReasoningPolicyNextScenarioRequest& WithPolicyArn(PolicyArnT&& value) {
  ...
  template <typename BuildWorkflowIdT = Aws::String>
  GetAutomatedReasoningPolicyNextScenarioRequest& WithBuildWorkflowId(BuildWorkflowIdT&& value) {
