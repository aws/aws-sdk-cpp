...
class AutomatedReasoningPolicyBuildStepContext {
 public:
  ...
  void SetPlanning(PlanningT&& value) {
    m_planningHasBeenSet = true;
    m_planning = std::forward<PlanningT>(value);
  }
  template <typename PlanningT = AutomatedReasoningPolicyPlanning>
  AutomatedReasoningPolicyBuildStepContext& WithPlanning(PlanningT&& value) {
    SetPlanning(std::forward<PlanningT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMutation(MutationT&& value) {
    m_mutationHasBeenSet = true;
    m_mutation = std::forward<MutationT>(value);
  }
  template <typename MutationT = AutomatedReasoningPolicyMutation>
  AutomatedReasoningPolicyBuildStepContext& WithMutation(MutationT&& value) {
    SetMutation(std::forward<MutationT>(value));
    return *this;
  }
  ///@}
 private:
