...
class ListAutomatedReasoningPoliciesRequest : public BedrockRequest {
 public:
  ...
  template <typename PolicyArnT = Aws::String>
  ListAutomatedReasoningPoliciesRequest& WithPolicyArn(PolicyArnT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListAutomatedReasoningPoliciesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListAutomatedReasoningPoliciesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
