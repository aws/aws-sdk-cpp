...
class AutomatedReasoningPolicyBuildLogEntry {
 public:
  ...
  template <typename AnnotationT = AutomatedReasoningPolicyAnnotation>
  AutomatedReasoningPolicyBuildLogEntry& WithAnnotation(AnnotationT&& value) {
  ...
  inline void SetStatus(AutomatedReasoningPolicyAnnotationStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline AutomatedReasoningPolicyBuildLogEntry& WithStatus(AutomatedReasoningPolicyAnnotationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetBuildSteps(BuildStepsT&& value) {
    m_buildStepsHasBeenSet = true;
    m_buildSteps = std::forward<BuildStepsT>(value);
  }
  template <typename BuildStepsT = Aws::Vector<AutomatedReasoningPolicyBuildStep>>
  AutomatedReasoningPolicyBuildLogEntry& WithBuildSteps(BuildStepsT&& value) {
    SetBuildSteps(std::forward<BuildStepsT>(value));
    return *this;
  }
  template <typename BuildStepsT = AutomatedReasoningPolicyBuildStep>
  AutomatedReasoningPolicyBuildLogEntry& AddBuildSteps(BuildStepsT&& value) {
    m_buildStepsHasBeenSet = true;
    m_buildSteps.emplace_back(std::forward<BuildStepsT>(value));
    return *this;
  }
  ///@}
 private:
