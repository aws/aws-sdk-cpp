...
namespace Model
{
  ...
  public:
    ...
    template<typename TranslationT = AutomatedReasoningCheckTranslation>
    AutomatedReasoningCheckSatisfiableFinding& WithTranslation(TranslationT&& value) { SetTranslation(std::forward<TranslationT>(value)); return *this;}
    ///@}
    ...
    template<typename ClaimsTrueScenarioT = AutomatedReasoningCheckScenario>
    AutomatedReasoningCheckSatisfiableFinding& WithClaimsTrueScenario(ClaimsTrueScenarioT&& value) { SetClaimsTrueScenario(std::forward<ClaimsTrueScenarioT>(value)); return *this;}
    ///@}
    ...
    template<typename ClaimsFalseScenarioT = AutomatedReasoningCheckScenario>
    AutomatedReasoningCheckSatisfiableFinding& WithClaimsFalseScenario(ClaimsFalseScenarioT&& value) { SetClaimsFalseScenario(std::forward<ClaimsFalseScenarioT>(value)); return *this;}
    ///@}
    ...
    template<typename LogicWarningT = AutomatedReasoningCheckLogicWarning>
    AutomatedReasoningCheckSatisfiableFinding& WithLogicWarning(LogicWarningT&& value) { SetLogicWarning(std::forward<LogicWarningT>(value)); return *this;}
    ///@}
  private:
