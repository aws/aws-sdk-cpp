...
class GuardrailWordPolicyConfig {
 public:
  ...
  void SetManagedWordListsConfig(ManagedWordListsConfigT&& value) {
    ...
    m_managedWordListsConfig = std::forward<ManagedWordListsConfigT>(value);
  }
  template <typename ManagedWordListsConfigT = Aws::Vector<GuardrailManagedWordsConfig>>
  GuardrailWordPolicyConfig& WithManagedWordListsConfig(ManagedWordListsConfigT&& value) {
    SetManagedWordListsConfig(std::forward<ManagedWordListsConfigT>(value));
    return *this;
  }
  ...
  GuardrailWordPolicyConfig& AddManagedWordListsConfig(ManagedWordListsConfigT&& value) {
    m_managedWordListsConfigHasBeenSet = true;
    m_managedWordListsConfig.emplace_back(std::forward<ManagedWordListsConfigT>(value));
    return *this;
  }
  ///@}
 private:
