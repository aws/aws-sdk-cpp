...
class GetMarketplaceModelEndpointResult {
 public:
  ...
  template <typename MarketplaceModelEndpointT = MarketplaceModelEndpoint>
  GetMarketplaceModelEndpointResult& WithMarketplaceModelEndpoint(MarketplaceModelEndpointT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetMarketplaceModelEndpointResult& WithRequestId(RequestIdT&& value) {
