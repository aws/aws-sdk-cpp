...
class ListMarketplaceModelEndpointsResult {
 public:
  ...
  void SetMarketplaceModelEndpoints(MarketplaceModelEndpointsT&& value) {
    m_marketplaceModelEndpointsHasBeenSet = true;
    m_marketplaceModelEndpoints = std::forward<MarketplaceModelEndpointsT>(value);
  }
  template <typename MarketplaceModelEndpointsT = Aws::Vector<MarketplaceModelEndpointSummary>>
  ListMarketplaceModelEndpointsResult& WithMarketplaceModelEndpoints(MarketplaceModelEndpointsT&& value) {
    SetMarketplaceModelEndpoints(std::forward<MarketplaceModelEndpointsT>(value));
    return *this;
  }
  template <typename MarketplaceModelEndpointsT = MarketplaceModelEndpointSummary>
  ListMarketplaceModelEndpointsResult& AddMarketplaceModelEndpoints(MarketplaceModelEndpointsT&& value) {
    m_marketplaceModelEndpointsHasBeenSet = true;
    m_marketplaceModelEndpoints.emplace_back(std::forward<MarketplaceModelEndpointsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListMarketplaceModelEndpointsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListMarketplaceModelEndpointsResult& WithRequestId(RequestIdT&& value) {
