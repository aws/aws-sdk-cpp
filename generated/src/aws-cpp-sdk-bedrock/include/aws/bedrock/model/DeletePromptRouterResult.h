...
namespace Model
{
  ...
  {
  public:
    AWS_BEDROCK_API DeletePromptRouterResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeletePromptRouterResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
