...
class GuardrailContentFilterConfig {
 public:
  ...
  inline GuardrailContentFilterConfig& WithType(GuardrailContentFilterType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetInputStrength(GuardrailFilterStrength value) {
    m_inputStrengthHasBeenSet = true;
    m_inputStrength = value;
  }
  inline GuardrailContentFilterConfig& WithInputStrength(GuardrailFilterStrength value) {
    SetInputStrength(value);
    return *this;
  }
  ///@}
  ...
  inline void SetOutputStrength(GuardrailFilterStrength value) {
    m_outputStrengthHasBeenSet = true;
    m_outputStrength = value;
  }
  inline GuardrailContentFilterConfig& WithOutputStrength(GuardrailFilterStrength value) {
    SetOutputStrength(value);
    return *this;
  }
  ///@}
  ...
  void SetInputModalities(InputModalitiesT&& value) {
    ...
    m_inputModalities = std::forward<InputModalitiesT>(value);
  }
  template <typename InputModalitiesT = Aws::Vector<GuardrailModality>>
  GuardrailContentFilterConfig& WithInputModalities(InputModalitiesT&& value) {
    SetInputModalities(std::forward<InputModalitiesT>(value));
    return *this;
  }
  inline GuardrailContentFilterConfig& AddInputModalities(GuardrailModality value) {
    m_inputModalitiesHasBeenSet = true;
    m_inputModalities.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetOutputModalities(OutputModalitiesT&& value) {
    ...
    m_outputModalities = std::forward<OutputModalitiesT>(value);
  }
  template <typename OutputModalitiesT = Aws::Vector<GuardrailModality>>
  GuardrailContentFilterConfig& WithOutputModalities(OutputModalitiesT&& value) {
    SetOutputModalities(std::forward<OutputModalitiesT>(value));
    return *this;
  }
  inline GuardrailContentFilterConfig& AddOutputModalities(GuardrailModality value) {
    m_outputModalitiesHasBeenSet = true;
    m_outputModalities.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline void SetInputAction(GuardrailContentFilterAction value) {
    m_inputActionHasBeenSet = true;
    m_inputAction = value;
  }
  inline GuardrailContentFilterConfig& WithInputAction(GuardrailContentFilterAction value) {
  ...
  inline void SetOutputAction(GuardrailContentFilterAction value) {
    m_outputActionHasBeenSet = true;
    m_outputAction = value;
  }
  inline GuardrailContentFilterConfig& WithOutputAction(GuardrailContentFilterAction value) {
  ...
  inline GuardrailContentFilterConfig& WithInputEnabled(bool value) {
  ...
  inline GuardrailContentFilterConfig& WithOutputEnabled(bool value) {
