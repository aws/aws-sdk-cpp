...
class ListProvisionedModelThroughputsRequest : public BedrockRequest {
 public:
  ...
  template <typename CreationTimeAfterT = Aws::Utils::DateTime>
  ListProvisionedModelThroughputsRequest& WithCreationTimeAfter(CreationTimeAfterT&& value) {
  ...
  template <typename CreationTimeBeforeT = Aws::Utils::DateTime>
  ListProvisionedModelThroughputsRequest& WithCreationTimeBefore(CreationTimeBeforeT&& value) {
  ...
  inline void SetStatusEquals(ProvisionedModelStatus value) {
    m_statusEqualsHasBeenSet = true;
    m_statusEquals = value;
  }
  inline ListProvisionedModelThroughputsRequest& WithStatusEquals(ProvisionedModelStatus value) {
  ...
  void SetModelArnEquals(ModelArnEqualsT&& value) {
    m_modelArnEqualsHasBeenSet = true;
    m_modelArnEquals = std::forward<ModelArnEqualsT>(value);
  }
  template <typename ModelArnEqualsT = Aws::String>
  ListProvisionedModelThroughputsRequest& WithModelArnEquals(ModelArnEqualsT&& value) {
    SetModelArnEquals(std::forward<ModelArnEqualsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NameContainsT = Aws::String>
  ListProvisionedModelThroughputsRequest& WithNameContains(NameContainsT&& value) {
  ...
  inline ListProvisionedModelThroughputsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListProvisionedModelThroughputsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline void SetSortBy(SortByProvisionedModels value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ListProvisionedModelThroughputsRequest& WithSortBy(SortByProvisionedModels value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListProvisionedModelThroughputsRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
