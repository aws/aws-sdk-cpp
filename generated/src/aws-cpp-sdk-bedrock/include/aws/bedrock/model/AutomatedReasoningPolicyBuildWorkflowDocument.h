...
class AutomatedReasoningPolicyBuildWorkflowDocument {
 public:
  ...
  template <typename DocumentT = Aws::Utils::CryptoBuffer>
  AutomatedReasoningPolicyBuildWorkflowDocument& WithDocument(DocumentT&& value) {
  ...
  inline AutomatedReasoningPolicyBuildWorkflowDocument& WithDocumentContentType(AutomatedReasoningPolicyBuildDocumentContentType value) {
  ...
  template <typename DocumentNameT = Aws::String>
  AutomatedReasoningPolicyBuildWorkflowDocument& WithDocumentName(DocumentNameT&& value) {
  ...
  template <typename DocumentDescriptionT = Aws::String>
  AutomatedReasoningPolicyBuildWorkflowDocument& WithDocumentDescription(DocumentDescriptionT&& value) {
