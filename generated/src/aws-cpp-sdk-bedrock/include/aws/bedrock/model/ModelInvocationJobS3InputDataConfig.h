...
class ModelInvocationJobS3InputDataConfig {
 public:
  ...
  inline void SetS3InputFormat(S3InputFormat value) {
    m_s3InputFormatHasBeenSet = true;
    m_s3InputFormat = value;
  }
  inline ModelInvocationJobS3InputDataConfig& WithS3InputFormat(S3InputFormat value) {
    SetS3InputFormat(value);
    return *this;
  }
  ///@}
  ...
  template <typename S3UriT = Aws::String>
  ModelInvocationJobS3InputDataConfig& WithS3Uri(S3UriT&& value) {
  ...
  template <typename S3BucketOwnerT = Aws::String>
  ModelInvocationJobS3InputDataConfig& WithS3BucketOwner(S3BucketOwnerT&& value) {
