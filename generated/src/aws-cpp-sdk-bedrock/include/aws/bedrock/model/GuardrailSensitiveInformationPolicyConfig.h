...
class GuardrailSensitiveInformationPolicyConfig {
 public:
  ...
  void SetPiiEntitiesConfig(PiiEntitiesConfigT&& value) {
    m_piiEntitiesConfigHasBeenSet = true;
    m_piiEntitiesConfig = std::forward<PiiEntitiesConfigT>(value);
  }
  template <typename PiiEntitiesConfigT = Aws::Vector<GuardrailPiiEntityConfig>>
  GuardrailSensitiveInformationPolicyConfig& WithPiiEntitiesConfig(PiiEntitiesConfigT&& value) {
    SetPiiEntitiesConfig(std::forward<PiiEntitiesConfigT>(value));
    return *this;
  }
  template <typename PiiEntitiesConfigT = GuardrailPiiEntityConfig>
  GuardrailSensitiveInformationPolicyConfig& AddPiiEntitiesConfig(PiiEntitiesConfigT&& value) {
    m_piiEntitiesConfigHasBeenSet = true;
    m_piiEntitiesConfig.emplace_back(std::forward<PiiEntitiesConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRegexesConfig(RegexesConfigT&& value) {
    m_regexesConfigHasBeenSet = true;
    m_regexesConfig = std::forward<RegexesConfigT>(value);
  }
  template <typename RegexesConfigT = Aws::Vector<GuardrailRegexConfig>>
  GuardrailSensitiveInformationPolicyConfig& WithRegexesConfig(RegexesConfigT&& value) {
    SetRegexesConfig(std::forward<RegexesConfigT>(value));
    return *this;
  }
  template <typename RegexesConfigT = GuardrailRegexConfig>
  GuardrailSensitiveInformationPolicyConfig& AddRegexesConfig(RegexesConfigT&& value) {
    m_regexesConfigHasBeenSet = true;
    m_regexesConfig.emplace_back(std::forward<RegexesConfigT>(value));
    return *this;
  }
  ///@}
 private:
