...
class ListCustomModelDeploymentsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListCustomModelDeploymentsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetModelDeploymentSummaries(ModelDeploymentSummariesT&& value) {
    m_modelDeploymentSummariesHasBeenSet = true;
    m_modelDeploymentSummaries = std::forward<ModelDeploymentSummariesT>(value);
  }
  template <typename ModelDeploymentSummariesT = Aws::Vector<CustomModelDeploymentSummary>>
  ListCustomModelDeploymentsResult& WithModelDeploymentSummaries(ModelDeploymentSummariesT&& value) {
    SetModelDeploymentSummaries(std::forward<ModelDeploymentSummariesT>(value));
    return *this;
  }
  template <typename ModelDeploymentSummariesT = CustomModelDeploymentSummary>
  ListCustomModelDeploymentsResult& AddModelDeploymentSummaries(ModelDeploymentSummariesT&& value) {
    m_modelDeploymentSummariesHasBeenSet = true;
    m_modelDeploymentSummaries.emplace_back(std::forward<ModelDeploymentSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListCustomModelDeploymentsResult& WithRequestId(RequestIdT&& value) {
