...
class GetAutomatedReasoningPolicyBuildWorkflowResultAssetsResult {
 public:
  ...
  AWS_BEDROCK_API GetAutomatedReasoningPolicyBuildWorkflowResultAssetsResult(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_BEDROCK_API GetAutomatedReasoningPolicyBuildWorkflowResultAssetsResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename PolicyArnT = Aws::String>
  GetAutomatedReasoningPolicyBuildWorkflowResultAssetsResult& WithPolicyArn(PolicyArnT&& value) {
  ...
  template <typename BuildWorkflowIdT = Aws::String>
  GetAutomatedReasoningPolicyBuildWorkflowResultAssetsResult& WithBuildWorkflowId(BuildWorkflowIdT&& value) {
  ...
  void SetBuildWorkflowAssets(BuildWorkflowAssetsT&& value) {
    m_buildWorkflowAssetsHasBeenSet = true;
    m_buildWorkflowAssets = std::forward<BuildWorkflowAssetsT>(value);
  }
  template <typename BuildWorkflowAssetsT = AutomatedReasoningPolicyBuildResultAssets>
  GetAutomatedReasoningPolicyBuildWorkflowResultAssetsResult& WithBuildWorkflowAssets(BuildWorkflowAssetsT&& value) {
    SetBuildWorkflowAssets(std::forward<BuildWorkflowAssetsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetAutomatedReasoningPolicyBuildWorkflowResultAssetsResult& WithRequestId(RequestIdT&& value) {
