...
class ListModelCopyJobsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListModelCopyJobsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetModelCopyJobSummaries(ModelCopyJobSummariesT&& value) {
    m_modelCopyJobSummariesHasBeenSet = true;
    m_modelCopyJobSummaries = std::forward<ModelCopyJobSummariesT>(value);
  }
  template <typename ModelCopyJobSummariesT = Aws::Vector<ModelCopyJobSummary>>
  ListModelCopyJobsResult& WithModelCopyJobSummaries(ModelCopyJobSummariesT&& value) {
    SetModelCopyJobSummaries(std::forward<ModelCopyJobSummariesT>(value));
    return *this;
  }
  template <typename ModelCopyJobSummariesT = ModelCopyJobSummary>
  ListModelCopyJobsResult& AddModelCopyJobSummaries(ModelCopyJobSummariesT&& value) {
    m_modelCopyJobSummariesHasBeenSet = true;
    m_modelCopyJobSummaries.emplace_back(std::forward<ModelCopyJobSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListModelCopyJobsResult& WithRequestId(RequestIdT&& value) {
