...
class TeacherModelConfig {
 public:
  ...
  void SetTeacherModelIdentifier(TeacherModelIdentifierT&& value) {
    ...
    m_teacherModelIdentifier = std::forward<TeacherModelIdentifierT>(value);
  }
  template <typename TeacherModelIdentifierT = Aws::String>
  TeacherModelConfig& WithTeacherModelIdentifier(TeacherModelIdentifierT&& value) {
    SetTeacherModelIdentifier(std::forward<TeacherModelIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetMaxResponseLengthForInference(int value) {
    m_maxResponseLengthForInferenceHasBeenSet = true;
    m_maxResponseLengthForInference = value;
  }
  inline TeacherModelConfig& WithMaxResponseLengthForInference(int value) {
    SetMaxResponseLengthForInference(value);
    return *this;
  }
  ///@}
 private:
