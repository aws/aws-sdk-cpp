...
class UpdateMarketplaceModelEndpointResult {
 public:
  ...
  template <typename MarketplaceModelEndpointT = MarketplaceModelEndpoint>
  UpdateMarketplaceModelEndpointResult& WithMarketplaceModelEndpoint(MarketplaceModelEndpointT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateMarketplaceModelEndpointResult& WithRequestId(RequestIdT&& value) {
