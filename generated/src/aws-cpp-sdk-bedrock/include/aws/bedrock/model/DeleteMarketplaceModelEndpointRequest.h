...
namespace Model
{
  ...
  {
  public:
    AWS_BEDROCK_API DeleteMarketplaceModelEndpointRequest() = default;
    ...
    template<typename EndpointArnT = Aws::String>
    DeleteMarketplaceModelEndpointRequest& WithEndpointArn(EndpointArnT&& value) { SetEndpointArn(std::forward<EndpointArnT>(value)); return *this;}
    ///@}
  private:
