...
class ListFoundationModelAgreementOffersRequest : public BedrockRequest {
 public:
  ...
  template <typename ModelIdT = Aws::String>
  ListFoundationModelAgreementOffersRequest& WithModelId(ModelIdT&& value) {
  ...
  inline void SetOfferType(OfferType value) {
    m_offerTypeHasBeenSet = true;
    m_offerType = value;
  }
  inline ListFoundationModelAgreementOffersRequest& WithOfferType(OfferType value) {
    SetOfferType(value);
    return *this;
  }
  ///@}
