...
class ListModelImportJobsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListModelImportJobsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetModelImportJobSummaries(ModelImportJobSummariesT&& value) {
    m_modelImportJobSummariesHasBeenSet = true;
    m_modelImportJobSummaries = std::forward<ModelImportJobSummariesT>(value);
  }
  template <typename ModelImportJobSummariesT = Aws::Vector<ModelImportJobSummary>>
  ListModelImportJobsResult& WithModelImportJobSummaries(ModelImportJobSummariesT&& value) {
    SetModelImportJobSummaries(std::forward<ModelImportJobSummariesT>(value));
    return *this;
  }
  template <typename ModelImportJobSummariesT = ModelImportJobSummary>
  ListModelImportJobsResult& AddModelImportJobSummaries(ModelImportJobSummariesT&& value) {
    m_modelImportJobSummariesHasBeenSet = true;
    m_modelImportJobSummaries.emplace_back(std::forward<ModelImportJobSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListModelImportJobsResult& WithRequestId(RequestIdT&& value) {
