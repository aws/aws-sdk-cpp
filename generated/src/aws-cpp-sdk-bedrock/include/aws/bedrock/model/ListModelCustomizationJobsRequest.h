...
class ListModelCustomizationJobsRequest : public BedrockRequest {
 public:
  ...
  template <typename CreationTimeAfterT = Aws::Utils::DateTime>
  ListModelCustomizationJobsRequest& WithCreationTimeAfter(CreationTimeAfterT&& value) {
  ...
  template <typename CreationTimeBeforeT = Aws::Utils::DateTime>
  ListModelCustomizationJobsRequest& WithCreationTimeBefore(CreationTimeBeforeT&& value) {
  ...
  inline void SetStatusEquals(FineTuningJobStatus value) {
    m_statusEqualsHasBeenSet = true;
    m_statusEquals = value;
  }
  inline ListModelCustomizationJobsRequest& WithStatusEquals(FineTuningJobStatus value) {
  ...
  template <typename NameContainsT = Aws::String>
  ListModelCustomizationJobsRequest& WithNameContains(NameContainsT&& value) {
  ...
  inline ListModelCustomizationJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListModelCustomizationJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListModelCustomizationJobsRequest& WithSortBy(SortJobsBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListModelCustomizationJobsRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
