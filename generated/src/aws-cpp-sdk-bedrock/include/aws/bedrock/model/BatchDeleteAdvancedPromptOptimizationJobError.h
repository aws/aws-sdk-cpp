...
class BatchDeleteAdvancedPromptOptimizationJobError {
 public:
  AWS_BEDROCK_API BatchDeleteAdvancedPromptOptimizationJobError() = default;
  AWS_BEDROCK_API BatchDeleteAdvancedPromptOptimizationJobError(Aws::Utils::Json::JsonView jsonValue);
  AWS_BEDROCK_API BatchDeleteAdvancedPromptOptimizationJobError& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename JobIdentifierT = Aws::String>
  BatchDeleteAdvancedPromptOptimizationJobError& WithJobIdentifier(JobIdentifierT&& value) {
  ...
  template <typename CodeT = Aws::String>
  BatchDeleteAdvancedPromptOptimizationJobError& WithCode(CodeT&& value) {
  ...
  template <typename MessageT = Aws::String>
  BatchDeleteAdvancedPromptOptimizationJobError& WithMessage(MessageT&& value) {
