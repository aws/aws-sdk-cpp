...
class GuardrailRegexConfig {
 public:
  ...
  inline GuardrailRegexConfig& WithInputAction(GuardrailSensitiveInformationAction value) {
  ...
  inline GuardrailRegexConfig& WithOutputAction(GuardrailSensitiveInformationAction value) {
  ...
  inline GuardrailRegexConfig& WithInputEnabled(bool value) {
  ...
  inline GuardrailRegexConfig& WithOutputEnabled(bool value) {
