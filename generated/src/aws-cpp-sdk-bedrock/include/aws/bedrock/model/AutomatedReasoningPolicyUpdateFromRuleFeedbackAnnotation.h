...
class AutomatedReasoningPolicyUpdateFromRuleFeedbackAnnotation {
 public:
  ...
  template <typename RuleIdsT = Aws::Vector<Aws::String>>
  AutomatedReasoningPolicyUpdateFromRuleFeedbackAnnotation& WithRuleIds(RuleIdsT&& value) {
    SetRuleIds(std::forward<RuleIdsT>(value));
    return *this;
  }
  template <typename RuleIdsT = Aws::String>
  AutomatedReasoningPolicyUpdateFromRuleFeedbackAnnotation& AddRuleIds(RuleIdsT&& value) {
    m_ruleIdsHasBeenSet = true;
  ...
  template <typename FeedbackT = Aws::String>
  AutomatedReasoningPolicyUpdateFromRuleFeedbackAnnotation& WithFeedback(FeedbackT&& value) {
