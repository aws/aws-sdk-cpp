...
class GetModelCustomizationJobRequest : public BedrockRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "GetModelCustomizationJob"; }
  ...
  template <typename JobIdentifierT = Aws::String>
  GetModelCustomizationJobRequest& WithJobIdentifier(JobIdentifierT&& value) {
