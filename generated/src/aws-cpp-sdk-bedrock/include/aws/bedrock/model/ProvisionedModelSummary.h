...
class ProvisionedModelSummary {
 public:
  ...
  inline ProvisionedModelSummary& WithModelUnits(int value) {
    SetModelUnits(value);
    return *this;
  }
  ///@}
  ...
  inline ProvisionedModelSummary& WithDesiredModelUnits(int value) {
  ...
  inline ProvisionedModelSummary& WithStatus(ProvisionedModelStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline ProvisionedModelSummary& WithCommitmentDuration(CommitmentDuration value) {
