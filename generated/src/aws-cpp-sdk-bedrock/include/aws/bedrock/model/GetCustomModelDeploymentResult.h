...
class GetCustomModelDeploymentResult {
 public:
  ...
  void SetCustomModelDeploymentArn(CustomModelDeploymentArnT&& value) {
    ...
    m_customModelDeploymentArn = std::forward<CustomModelDeploymentArnT>(value);
  }
  template <typename CustomModelDeploymentArnT = Aws::String>
  GetCustomModelDeploymentResult& WithCustomModelDeploymentArn(CustomModelDeploymentArnT&& value) {
    SetCustomModelDeploymentArn(std::forward<CustomModelDeploymentArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetModelDeploymentName(ModelDeploymentNameT&& value) {
    m_modelDeploymentNameHasBeenSet = true;
    m_modelDeploymentName = std::forward<ModelDeploymentNameT>(value);
  }
  template <typename ModelDeploymentNameT = Aws::String>
  GetCustomModelDeploymentResult& WithModelDeploymentName(ModelDeploymentNameT&& value) {
    SetModelDeploymentName(std::forward<ModelDeploymentNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(CustomModelDeploymentStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline GetCustomModelDeploymentResult& WithStatus(CustomModelDeploymentStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
