...
class EvaluationModelConfig {
 public:
  ...
  void SetBedrockModel(BedrockModelT&& value) {
    m_bedrockModelHasBeenSet = true;
    m_bedrockModel = std::forward<BedrockModelT>(value);
  }
  template <typename BedrockModelT = EvaluationBedrockModel>
  EvaluationModelConfig& WithBedrockModel(BedrockModelT&& value) {
    SetBedrockModel(std::forward<BedrockModelT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPrecomputedInferenceSource(PrecomputedInferenceSourceT&& value) {
    ...
    m_precomputedInferenceSource = std::forward<PrecomputedInferenceSourceT>(value);
  }
  template <typename PrecomputedInferenceSourceT = EvaluationPrecomputedInferenceSource>
  EvaluationModelConfig& WithPrecomputedInferenceSource(PrecomputedInferenceSourceT&& value) {
    SetPrecomputedInferenceSource(std::forward<PrecomputedInferenceSourceT>(value));
    return *this;
  }
  ///@}
 private:
