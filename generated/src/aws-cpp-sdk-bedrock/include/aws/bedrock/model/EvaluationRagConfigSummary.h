...
class EvaluationRagConfigSummary {
 public:
  ...
  void SetBedrockKnowledgeBaseIdentifiers(BedrockKnowledgeBaseIdentifiersT&& value) {
    ...
    m_bedrockKnowledgeBaseIdentifiers = std::forward<BedrockKnowledgeBaseIdentifiersT>(value);
  }
  template <typename BedrockKnowledgeBaseIdentifiersT = Aws::Vector<Aws::String>>
  EvaluationRagConfigSummary& WithBedrockKnowledgeBaseIdentifiers(BedrockKnowledgeBaseIdentifiersT&& value) {
    SetBedrockKnowledgeBaseIdentifiers(std::forward<BedrockKnowledgeBaseIdentifiersT>(value));
    return *this;
  }
  ...
  EvaluationRagConfigSummary& AddBedrockKnowledgeBaseIdentifiers(BedrockKnowledgeBaseIdentifiersT&& value) {
    m_bedrockKnowledgeBaseIdentifiersHasBeenSet = true;
    m_bedrockKnowledgeBaseIdentifiers.emplace_back(std::forward<BedrockKnowledgeBaseIdentifiersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPrecomputedRagSourceIdentifiers(PrecomputedRagSourceIdentifiersT&& value) {
    ...
    m_precomputedRagSourceIdentifiers = std::forward<PrecomputedRagSourceIdentifiersT>(value);
  }
  template <typename PrecomputedRagSourceIdentifiersT = Aws::Vector<Aws::String>>
  EvaluationRagConfigSummary& WithPrecomputedRagSourceIdentifiers(PrecomputedRagSourceIdentifiersT&& value) {
    SetPrecomputedRagSourceIdentifiers(std::forward<PrecomputedRagSourceIdentifiersT>(value));
    return *this;
  }
  ...
  EvaluationRagConfigSummary& AddPrecomputedRagSourceIdentifiers(PrecomputedRagSourceIdentifiersT&& value) {
    m_precomputedRagSourceIdentifiersHasBeenSet = true;
    m_precomputedRagSourceIdentifiers.emplace_back(std::forward<PrecomputedRagSourceIdentifiersT>(value));
    return *this;
  }
  ///@}
 private:
