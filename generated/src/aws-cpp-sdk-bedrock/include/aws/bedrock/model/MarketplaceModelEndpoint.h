...
class MarketplaceModelEndpoint {
 public:
  ...
  inline MarketplaceModelEndpoint& WithStatus(Status value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetEndpointStatusMessage(EndpointStatusMessageT&& value) {
    ...
    m_endpointStatusMessage = std::forward<EndpointStatusMessageT>(value);
  }
  template <typename EndpointStatusMessageT = Aws::String>
  MarketplaceModelEndpoint& WithEndpointStatusMessage(EndpointStatusMessageT&& value) {
    SetEndpointStatusMessage(std::forward<EndpointStatusMessageT>(value));
    return *this;
  }
  ///@}
 private:
