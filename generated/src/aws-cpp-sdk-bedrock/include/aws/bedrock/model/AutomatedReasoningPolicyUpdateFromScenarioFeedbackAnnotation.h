...
class AutomatedReasoningPolicyUpdateFromScenarioFeedbackAnnotation {
 public:
  ...
  void SetRuleIds(RuleIdsT&& value) {
    m_ruleIdsHasBeenSet = true;
    m_ruleIds = std::forward<RuleIdsT>(value);
  }
  template <typename RuleIdsT = Aws::Vector<Aws::String>>
  AutomatedReasoningPolicyUpdateFromScenarioFeedbackAnnotation& WithRuleIds(RuleIdsT&& value) {
    SetRuleIds(std::forward<RuleIdsT>(value));
    return *this;
  }
  template <typename RuleIdsT = Aws::String>
  AutomatedReasoningPolicyUpdateFromScenarioFeedbackAnnotation& AddRuleIds(RuleIdsT&& value) {
    m_ruleIdsHasBeenSet = true;
    m_ruleIds.emplace_back(std::forward<RuleIdsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetScenarioExpression(ScenarioExpressionT&& value) {
    m_scenarioExpressionHasBeenSet = true;
    m_scenarioExpression = std::forward<ScenarioExpressionT>(value);
  }
  template <typename ScenarioExpressionT = Aws::String>
  AutomatedReasoningPolicyUpdateFromScenarioFeedbackAnnotation& WithScenarioExpression(ScenarioExpressionT&& value) {
    SetScenarioExpression(std::forward<ScenarioExpressionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename FeedbackT = Aws::String>
  AutomatedReasoningPolicyUpdateFromScenarioFeedbackAnnotation& WithFeedback(FeedbackT&& value) {
