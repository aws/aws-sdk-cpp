...
class GetAutomatedReasoningPolicyNextScenarioResult {
 public:
  ...
  AWS_BEDROCK_API GetAutomatedReasoningPolicyNextScenarioResult& operator=(
  ...
  template <typename PolicyArnT = Aws::String>
  GetAutomatedReasoningPolicyNextScenarioResult& WithPolicyArn(PolicyArnT&& value) {
  ...
  template <typename ScenarioT = AutomatedReasoningPolicyScenario>
  GetAutomatedReasoningPolicyNextScenarioResult& WithScenario(ScenarioT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetAutomatedReasoningPolicyNextScenarioResult& WithRequestId(RequestIdT&& value) {
