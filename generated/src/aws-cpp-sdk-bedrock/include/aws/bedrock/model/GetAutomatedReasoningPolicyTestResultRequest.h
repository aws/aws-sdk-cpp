...
class GetAutomatedReasoningPolicyTestResultRequest : public BedrockRequest {
 public:
  ...
  template <typename PolicyArnT = Aws::String>
  GetAutomatedReasoningPolicyTestResultRequest& WithPolicyArn(PolicyArnT&& value) {
  ...
  template <typename BuildWorkflowIdT = Aws::String>
  GetAutomatedReasoningPolicyTestResultRequest& WithBuildWorkflowId(BuildWorkflowIdT&& value) {
  ...
  template <typename TestCaseIdT = Aws::String>
  GetAutomatedReasoningPolicyTestResultRequest& WithTestCaseId(TestCaseIdT&& value) {
