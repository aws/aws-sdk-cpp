...
class LoggingConfig {
 public:
  ...
  inline void SetTextDataDeliveryEnabled(bool value) {
    m_textDataDeliveryEnabledHasBeenSet = true;
    m_textDataDeliveryEnabled = value;
  }
  inline LoggingConfig& WithTextDataDeliveryEnabled(bool value) {
    SetTextDataDeliveryEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline void SetImageDataDeliveryEnabled(bool value) {
    m_imageDataDeliveryEnabledHasBeenSet = true;
    m_imageDataDeliveryEnabled = value;
  }
  inline LoggingConfig& WithImageDataDeliveryEnabled(bool value) {
    SetImageDataDeliveryEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEmbeddingDataDeliveryEnabled(bool value) {
    m_embeddingDataDeliveryEnabledHasBeenSet = true;
    m_embeddingDataDeliveryEnabled = value;
  }
  inline LoggingConfig& WithEmbeddingDataDeliveryEnabled(bool value) {
    SetEmbeddingDataDeliveryEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline void SetVideoDataDeliveryEnabled(bool value) {
    m_videoDataDeliveryEnabledHasBeenSet = true;
    m_videoDataDeliveryEnabled = value;
  }
  inline LoggingConfig& WithVideoDataDeliveryEnabled(bool value) {
    SetVideoDataDeliveryEnabled(value);
    return *this;
  }
  ///@}
