...
class AutomatedReasoningPolicyAddTypeAnnotation {
 public:
  ...
  template <typename NameT = Aws::String>
  AutomatedReasoningPolicyAddTypeAnnotation& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  AutomatedReasoningPolicyAddTypeAnnotation& WithDescription(DescriptionT&& value) {
  ...
  template <typename ValuesT = Aws::Vector<AutomatedReasoningPolicyDefinitionTypeValue>>
  AutomatedReasoningPolicyAddTypeAnnotation& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = AutomatedReasoningPolicyDefinitionTypeValue>
  AutomatedReasoningPolicyAddTypeAnnotation& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
