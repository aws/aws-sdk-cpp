...
class AutomatedReasoningPolicyDefinitionTypeValuePair {
 public:
  ...
  template <typename TypeNameT = Aws::String>
  AutomatedReasoningPolicyDefinitionTypeValuePair& WithTypeName(TypeNameT&& value) {
  ...
  void SetValueName(ValueNameT&& value) {
    m_valueNameHasBeenSet = true;
    m_valueName = std::forward<ValueNameT>(value);
  }
  template <typename ValueNameT = Aws::String>
  AutomatedReasoningPolicyDefinitionTypeValuePair& WithValueName(ValueNameT&& value) {
    SetValueName(std::forward<ValueNameT>(value));
    return *this;
  }
  ///@}
 private:
