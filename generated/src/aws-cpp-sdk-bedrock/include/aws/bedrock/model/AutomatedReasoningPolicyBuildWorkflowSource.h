...
class AutomatedReasoningPolicyBuildWorkflowSource {
 public:
  ...
  template <typename PolicyDefinitionT = AutomatedReasoningPolicyDefinition>
  AutomatedReasoningPolicyBuildWorkflowSource& WithPolicyDefinition(PolicyDefinitionT&& value) {
  ...
  void SetWorkflowContent(WorkflowContentT&& value) {
    m_workflowContentHasBeenSet = true;
    m_workflowContent = std::forward<WorkflowContentT>(value);
  }
  template <typename WorkflowContentT = AutomatedReasoningPolicyWorkflowTypeContent>
  AutomatedReasoningPolicyBuildWorkflowSource& WithWorkflowContent(WorkflowContentT&& value) {
    SetWorkflowContent(std::forward<WorkflowContentT>(value));
    return *this;
  }
  ///@}
 private:
