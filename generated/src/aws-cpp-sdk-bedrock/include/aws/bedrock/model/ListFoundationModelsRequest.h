...
class ListFoundationModelsRequest : public BedrockRequest {
 public:
  ...
  void SetByProvider(ByProviderT&& value) {
    m_byProviderHasBeenSet = true;
    m_byProvider = std::forward<ByProviderT>(value);
  }
  template <typename ByProviderT = Aws::String>
  ListFoundationModelsRequest& WithByProvider(ByProviderT&& value) {
    SetByProvider(std::forward<ByProviderT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetByCustomizationType(ModelCustomization value) {
    m_byCustomizationTypeHasBeenSet = true;
    m_byCustomizationType = value;
  }
  inline ListFoundationModelsRequest& WithByCustomizationType(ModelCustomization value) {
    SetByCustomizationType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetByOutputModality(ModelModality value) {
    m_byOutputModalityHasBeenSet = true;
    m_byOutputModality = value;
  }
  inline ListFoundationModelsRequest& WithByOutputModality(ModelModality value) {
    SetByOutputModality(value);
    return *this;
  }
  ///@}
  ...
  inline void SetByInferenceType(InferenceType value) {
    m_byInferenceTypeHasBeenSet = true;
    m_byInferenceType = value;
  }
  inline ListFoundationModelsRequest& WithByInferenceType(InferenceType value) {
    SetByInferenceType(value);
    return *this;
  }
  ///@}
 private:
