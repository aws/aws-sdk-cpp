...
class AutomatedReasoningPolicyDisjointRuleSet {
 public:
  ...
  template <typename VariablesT = Aws::Vector<Aws::String>>
  AutomatedReasoningPolicyDisjointRuleSet& WithVariables(VariablesT&& value) {
    SetVariables(std::forward<VariablesT>(value));
    return *this;
  }
  template <typename VariablesT = Aws::String>
  AutomatedReasoningPolicyDisjointRuleSet& AddVariables(VariablesT&& value) {
    m_variablesHasBeenSet = true;
  ...
  template <typename RulesT = Aws::Vector<Aws::String>>
  AutomatedReasoningPolicyDisjointRuleSet& WithRules(RulesT&& value) {
    SetRules(std::forward<RulesT>(value));
    return *this;
  }
  template <typename RulesT = Aws::String>
  AutomatedReasoningPolicyDisjointRuleSet& AddRules(RulesT&& value) {
    m_rulesHasBeenSet = true;
