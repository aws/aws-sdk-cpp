...
class EvaluationSummary {
 public:
  ...
  inline void SetStatus(EvaluationJobStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline EvaluationSummary& WithStatus(EvaluationJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetJobType(EvaluationJobType value) {
    m_jobTypeHasBeenSet = true;
    m_jobType = value;
  }
  inline EvaluationSummary& WithJobType(EvaluationJobType value) {
    SetJobType(value);
    return *this;
  }
  ///@}
  ...
  void SetEvaluationTaskTypes(EvaluationTaskTypesT&& value) {
    ...
    m_evaluationTaskTypes = std::forward<EvaluationTaskTypesT>(value);
  }
  template <typename EvaluationTaskTypesT = Aws::Vector<EvaluationTaskType>>
  EvaluationSummary& WithEvaluationTaskTypes(EvaluationTaskTypesT&& value) {
    SetEvaluationTaskTypes(std::forward<EvaluationTaskTypesT>(value));
    return *this;
  }
  inline EvaluationSummary& AddEvaluationTaskTypes(EvaluationTaskType value) {
    m_evaluationTaskTypesHasBeenSet = true;
    m_evaluationTaskTypes.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetEvaluatorModelIdentifiers(EvaluatorModelIdentifiersT&& value) {
    ...
    m_evaluatorModelIdentifiers = std::forward<EvaluatorModelIdentifiersT>(value);
  }
  template <typename EvaluatorModelIdentifiersT = Aws::Vector<Aws::String>>
  EvaluationSummary& WithEvaluatorModelIdentifiers(EvaluatorModelIdentifiersT&& value) {
    SetEvaluatorModelIdentifiers(std::forward<EvaluatorModelIdentifiersT>(value));
    return *this;
  }
  ...
  EvaluationSummary& AddEvaluatorModelIdentifiers(EvaluatorModelIdentifiersT&& value) {
    m_evaluatorModelIdentifiersHasBeenSet = true;
    m_evaluatorModelIdentifiers.emplace_back(std::forward<EvaluatorModelIdentifiersT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::Vector<Aws::String>& GetCustomMetricsEvaluatorModelIdentifiers() const {
    return m_customMetricsEvaluatorModelIdentifiers;
  }
  ...
  void SetCustomMetricsEvaluatorModelIdentifiers(CustomMetricsEvaluatorModelIdentifiersT&& value) {
    ...
    m_customMetricsEvaluatorModelIdentifiers = std::forward<CustomMetricsEvaluatorModelIdentifiersT>(value);
  }
  template <typename CustomMetricsEvaluatorModelIdentifiersT = Aws::Vector<Aws::String>>
  EvaluationSummary& WithCustomMetricsEvaluatorModelIdentifiers(CustomMetricsEvaluatorModelIdentifiersT&& value) {
    SetCustomMetricsEvaluatorModelIdentifiers(std::forward<CustomMetricsEvaluatorModelIdentifiersT>(value));
    return *this;
  }
  ...
  EvaluationSummary& AddCustomMetricsEvaluatorModelIdentifiers(CustomMetricsEvaluatorModelIdentifiersT&& value) {
    m_customMetricsEvaluatorModelIdentifiersHasBeenSet = true;
    m_customMetricsEvaluatorModelIdentifiers.emplace_back(std::forward<CustomMetricsEvaluatorModelIdentifiersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInferenceConfigSummary(InferenceConfigSummaryT&& value) {
    ...
    m_inferenceConfigSummary = std::forward<InferenceConfigSummaryT>(value);
  }
  template <typename InferenceConfigSummaryT = EvaluationInferenceConfigSummary>
  EvaluationSummary& WithInferenceConfigSummary(InferenceConfigSummaryT&& value) {
    SetInferenceConfigSummary(std::forward<InferenceConfigSummaryT>(value));
    return *this;
  }
  ///@}
  ...
  inline EvaluationSummary& WithApplicationType(ApplicationType value) {
