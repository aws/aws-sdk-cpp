...
class EvaluationInferenceConfigSummary {
 public:
  ...
  void SetModelConfigSummary(ModelConfigSummaryT&& value) {
    ...
    m_modelConfigSummary = std::forward<ModelConfigSummaryT>(value);
  }
  template <typename ModelConfigSummaryT = EvaluationModelConfigSummary>
  EvaluationInferenceConfigSummary& WithModelConfigSummary(ModelConfigSummaryT&& value) {
    SetModelConfigSummary(std::forward<ModelConfigSummaryT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRagConfigSummary(RagConfigSummaryT&& value) {
    ...
    m_ragConfigSummary = std::forward<RagConfigSummaryT>(value);
  }
  template <typename RagConfigSummaryT = EvaluationRagConfigSummary>
  EvaluationInferenceConfigSummary& WithRagConfigSummary(RagConfigSummaryT&& value) {
    SetRagConfigSummary(std::forward<RagConfigSummaryT>(value));
    return *this;
  }
  ///@}
 private:
