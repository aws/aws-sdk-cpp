...
class AutomatedReasoningPolicyDefinitionElement {
 public:
  ...
  void SetPolicyDefinitionVariable(PolicyDefinitionVariableT&& value) {
    ...
    m_policyDefinitionVariable = std::forward<PolicyDefinitionVariableT>(value);
  }
  template <typename PolicyDefinitionVariableT = AutomatedReasoningPolicyDefinitionVariable>
  AutomatedReasoningPolicyDefinitionElement& WithPolicyDefinitionVariable(PolicyDefinitionVariableT&& value) {
    SetPolicyDefinitionVariable(std::forward<PolicyDefinitionVariableT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPolicyDefinitionType(PolicyDefinitionTypeT&& value) {
    ...
    m_policyDefinitionType = std::forward<PolicyDefinitionTypeT>(value);
  }
  template <typename PolicyDefinitionTypeT = AutomatedReasoningPolicyDefinitionType>
  AutomatedReasoningPolicyDefinitionElement& WithPolicyDefinitionType(PolicyDefinitionTypeT&& value) {
    SetPolicyDefinitionType(std::forward<PolicyDefinitionTypeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPolicyDefinitionRule(PolicyDefinitionRuleT&& value) {
    ...
    m_policyDefinitionRule = std::forward<PolicyDefinitionRuleT>(value);
  }
  template <typename PolicyDefinitionRuleT = AutomatedReasoningPolicyDefinitionRule>
  AutomatedReasoningPolicyDefinitionElement& WithPolicyDefinitionRule(PolicyDefinitionRuleT&& value) {
    SetPolicyDefinitionRule(std::forward<PolicyDefinitionRuleT>(value));
    return *this;
  }
  ///@}
 private:
