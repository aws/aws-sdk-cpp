...
class CreateAutomatedReasoningPolicyVersionRequest : public BedrockRequest {
 public:
  ...
  template <typename PolicyArnT = Aws::String>
  CreateAutomatedReasoningPolicyVersionRequest& WithPolicyArn(PolicyArnT&& value) {
  ...
  template <typename ClientRequestTokenT = Aws::String>
  CreateAutomatedReasoningPolicyVersionRequest& WithClientRequestToken(ClientRequestTokenT&& value) {
  ...
  void SetLastUpdatedDefinitionHash(LastUpdatedDefinitionHashT&& value) {
    m_lastUpdatedDefinitionHashHasBeenSet = true;
    m_lastUpdatedDefinitionHash = std::forward<LastUpdatedDefinitionHashT>(value);
  }
  template <typename LastUpdatedDefinitionHashT = Aws::String>
  CreateAutomatedReasoningPolicyVersionRequest& WithLastUpdatedDefinitionHash(LastUpdatedDefinitionHashT&& value) {
    SetLastUpdatedDefinitionHash(std::forward<LastUpdatedDefinitionHashT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateAutomatedReasoningPolicyVersionRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateAutomatedReasoningPolicyVersionRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
