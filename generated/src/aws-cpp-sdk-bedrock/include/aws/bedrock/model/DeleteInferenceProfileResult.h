...
namespace Model
{
  ...
  {
  public:
    AWS_BEDROCK_API DeleteInferenceProfileResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteInferenceProfileResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
