...
class ValidationDetails {
 public:
  ...
  inline void SetStatus(JobStatusDetails value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ValidationDetails& WithStatus(JobStatusDetails value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  ValidationDetails& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename LastModifiedTimeT = Aws::Utils::DateTime>
  ValidationDetails& WithLastModifiedTime(LastModifiedTimeT&& value) {
