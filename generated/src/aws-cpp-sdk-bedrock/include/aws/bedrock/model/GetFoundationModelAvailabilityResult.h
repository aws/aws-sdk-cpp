...
class GetFoundationModelAvailabilityResult {
 public:
  ...
  void SetAgreementAvailability(AgreementAvailabilityT&& value) {
    ...
    m_agreementAvailability = std::forward<AgreementAvailabilityT>(value);
  }
  template <typename AgreementAvailabilityT = AgreementAvailability>
  GetFoundationModelAvailabilityResult& WithAgreementAvailability(AgreementAvailabilityT&& value) {
    SetAgreementAvailability(std::forward<AgreementAvailabilityT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAuthorizationStatus(AuthorizationStatus value) {
    m_authorizationStatusHasBeenSet = true;
    m_authorizationStatus = value;
  }
  inline GetFoundationModelAvailabilityResult& WithAuthorizationStatus(AuthorizationStatus value) {
  ...
  inline void SetEntitlementAvailability(EntitlementAvailability value) {
    m_entitlementAvailabilityHasBeenSet = true;
    m_entitlementAvailability = value;
  }
  inline GetFoundationModelAvailabilityResult& WithEntitlementAvailability(EntitlementAvailability value) {
    SetEntitlementAvailability(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRegionAvailability(RegionAvailability value) {
    m_regionAvailabilityHasBeenSet = true;
    m_regionAvailability = value;
  }
  inline GetFoundationModelAvailabilityResult& WithRegionAvailability(RegionAvailability value) {
    SetRegionAvailability(value);
    return *this;
  }
  ///@}
