...
class KnowledgeBaseConfig {
 public:
  ...
  void SetRetrieveConfig(RetrieveConfigT&& value) {
    ...
    m_retrieveConfig = std::forward<RetrieveConfigT>(value);
  }
  template <typename RetrieveConfigT = RetrieveConfig>
  KnowledgeBaseConfig& WithRetrieveConfig(RetrieveConfigT&& value) {
    SetRetrieveConfig(std::forward<RetrieveConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRetrieveAndGenerateConfig(RetrieveAndGenerateConfigT&& value) {
    ...
    m_retrieveAndGenerateConfig = std::forward<RetrieveAndGenerateConfigT>(value);
  }
  template <typename RetrieveAndGenerateConfigT = RetrieveAndGenerateConfiguration>
  KnowledgeBaseConfig& WithRetrieveAndGenerateConfig(RetrieveAndGenerateConfigT&& value) {
    SetRetrieveAndGenerateConfig(std::forward<RetrieveAndGenerateConfigT>(value));
    return *this;
  }
  ///@}
 private:
