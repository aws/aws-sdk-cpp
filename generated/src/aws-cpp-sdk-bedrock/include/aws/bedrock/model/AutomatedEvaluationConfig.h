...
class AutomatedEvaluationConfig {
 public:
  ...
  void SetDatasetMetricConfigs(DatasetMetricConfigsT&& value) {
    ...
    m_datasetMetricConfigs = std::forward<DatasetMetricConfigsT>(value);
  }
  template <typename DatasetMetricConfigsT = Aws::Vector<EvaluationDatasetMetricConfig>>
  AutomatedEvaluationConfig& WithDatasetMetricConfigs(DatasetMetricConfigsT&& value) {
    SetDatasetMetricConfigs(std::forward<DatasetMetricConfigsT>(value));
    return *this;
  }
  ...
  AutomatedEvaluationConfig& AddDatasetMetricConfigs(DatasetMetricConfigsT&& value) {
    m_datasetMetricConfigsHasBeenSet = true;
    m_datasetMetricConfigs.emplace_back(std::forward<DatasetMetricConfigsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEvaluatorModelConfig(EvaluatorModelConfigT&& value) {
    ...
    m_evaluatorModelConfig = std::forward<EvaluatorModelConfigT>(value);
  }
  template <typename EvaluatorModelConfigT = EvaluatorModelConfig>
  AutomatedEvaluationConfig& WithEvaluatorModelConfig(EvaluatorModelConfigT&& value) {
    SetEvaluatorModelConfig(std::forward<EvaluatorModelConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCustomMetricConfig(CustomMetricConfigT&& value) {
    ...
    m_customMetricConfig = std::forward<CustomMetricConfigT>(value);
  }
  template <typename CustomMetricConfigT = AutomatedEvaluationCustomMetricConfig>
  AutomatedEvaluationConfig& WithCustomMetricConfig(CustomMetricConfigT&& value) {
    SetCustomMetricConfig(std::forward<CustomMetricConfigT>(value));
    return *this;
  }
  ///@}
 private:
