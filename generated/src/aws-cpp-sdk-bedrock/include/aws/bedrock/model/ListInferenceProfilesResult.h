...
class ListInferenceProfilesResult {
 public:
  ...
  void SetInferenceProfileSummaries(InferenceProfileSummariesT&& value) {
    m_inferenceProfileSummariesHasBeenSet = true;
    m_inferenceProfileSummaries = std::forward<InferenceProfileSummariesT>(value);
  }
  template <typename InferenceProfileSummariesT = Aws::Vector<InferenceProfileSummary>>
  ListInferenceProfilesResult& WithInferenceProfileSummaries(InferenceProfileSummariesT&& value) {
    SetInferenceProfileSummaries(std::forward<InferenceProfileSummariesT>(value));
    return *this;
  }
  template <typename InferenceProfileSummariesT = InferenceProfileSummary>
  ListInferenceProfilesResult& AddInferenceProfileSummaries(InferenceProfileSummariesT&& value) {
    m_inferenceProfileSummariesHasBeenSet = true;
    m_inferenceProfileSummaries.emplace_back(std::forward<InferenceProfileSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListInferenceProfilesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListInferenceProfilesResult& WithRequestId(RequestIdT&& value) {
