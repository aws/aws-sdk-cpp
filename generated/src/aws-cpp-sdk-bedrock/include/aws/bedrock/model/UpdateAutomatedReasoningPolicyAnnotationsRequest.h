...
class UpdateAutomatedReasoningPolicyAnnotationsRequest : public BedrockRequest {
 public:
  ...
  template <typename PolicyArnT = Aws::String>
  UpdateAutomatedReasoningPolicyAnnotationsRequest& WithPolicyArn(PolicyArnT&& value) {
  ...
  template <typename BuildWorkflowIdT = Aws::String>
  UpdateAutomatedReasoningPolicyAnnotationsRequest& WithBuildWorkflowId(BuildWorkflowIdT&& value) {
  ...
  template <typename AnnotationsT = Aws::Vector<AutomatedReasoningPolicyAnnotation>>
  UpdateAutomatedReasoningPolicyAnnotationsRequest& WithAnnotations(AnnotationsT&& value) {
    SetAnnotations(std::forward<AnnotationsT>(value));
    return *this;
  }
  template <typename AnnotationsT = AutomatedReasoningPolicyAnnotation>
  UpdateAutomatedReasoningPolicyAnnotationsRequest& AddAnnotations(AnnotationsT&& value) {
    m_annotationsHasBeenSet = true;
  ...
  void SetLastUpdatedAnnotationSetHash(LastUpdatedAnnotationSetHashT&& value) {
    m_lastUpdatedAnnotationSetHashHasBeenSet = true;
    m_lastUpdatedAnnotationSetHash = std::forward<LastUpdatedAnnotationSetHashT>(value);
  }
  template <typename LastUpdatedAnnotationSetHashT = Aws::String>
  UpdateAutomatedReasoningPolicyAnnotationsRequest& WithLastUpdatedAnnotationSetHash(LastUpdatedAnnotationSetHashT&& value) {
    SetLastUpdatedAnnotationSetHash(std::forward<LastUpdatedAnnotationSetHashT>(value));
    return *this;
  }
  ///@}
 private:
