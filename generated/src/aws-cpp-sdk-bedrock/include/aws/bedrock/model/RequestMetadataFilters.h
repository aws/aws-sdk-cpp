...
class RequestMetadataFilters {
 public:
  ...
  template <typename EqualsT = Aws::Map<Aws::String, Aws::String>>
  RequestMetadataFilters& WithEquals(EqualsT&& value) {
  ...
  template <typename NotEqualsT = Aws::Map<Aws::String, Aws::String>>
  RequestMetadataFilters& WithNotEquals(NotEqualsT&& value) {
  ...
  template <typename AndAllT = Aws::Vector<RequestMetadataBaseFilters>>
  RequestMetadataFilters& WithAndAll(AndAllT&& value) {
    SetAndAll(std::forward<AndAllT>(value));
    return *this;
  }
  template <typename AndAllT = RequestMetadataBaseFilters>
  RequestMetadataFilters& AddAndAll(AndAllT&& value) {
    m_andAllHasBeenSet = true;
  ...
  template <typename OrAllT = Aws::Vector<RequestMetadataBaseFilters>>
  RequestMetadataFilters& WithOrAll(OrAllT&& value) {
    SetOrAll(std::forward<OrAllT>(value));
    return *this;
  }
  template <typename OrAllT = RequestMetadataBaseFilters>
  RequestMetadataFilters& AddOrAll(OrAllT&& value) {
    m_orAllHasBeenSet = true;
