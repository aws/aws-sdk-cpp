...
class ExportAutomatedReasoningPolicyVersionResult {
 public:
  ...
  AWS_BEDROCK_API ExportAutomatedReasoningPolicyVersionResult& operator=(
  ...
  template <typename PolicyDefinitionT = AutomatedReasoningPolicyDefinition>
  ExportAutomatedReasoningPolicyVersionResult& WithPolicyDefinition(PolicyDefinitionT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ExportAutomatedReasoningPolicyVersionResult& WithRequestId(RequestIdT&& value) {
