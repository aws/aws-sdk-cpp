...
namespace Model
{
  ...
  public:
    ...
    template<typename ModelArnT = Aws::String>
    FoundationModelSummary& WithModelArn(ModelArnT&& value) { SetModelArn(std::forward<ModelArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ModelIdT = Aws::String>
    FoundationModelSummary& WithModelId(ModelIdT&& value) { SetModelId(std::forward<ModelIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ModelNameT = Aws::String>
    FoundationModelSummary& WithModelName(ModelNameT&& value) { SetModelName(std::forward<ModelNameT>(value)); return *this;}
    ///@}
    ...
    template<typename ProviderNameT = Aws::String>
    FoundationModelSummary& WithProviderName(ProviderNameT&& value) { SetProviderName(std::forward<ProviderNameT>(value)); return *this;}
    ///@}
    ...
    template<typename InputModalitiesT = Aws::Vector<ModelModality>>
    FoundationModelSummary& WithInputModalities(InputModalitiesT&& value) { SetInputModalities(std::forward<InputModalitiesT>(value)); return *this;}
    inline FoundationModelSummary& AddInputModalities(ModelModality value) { m_inputModalitiesHasBeenSet = true; m_inputModalities.push_back(value); return *this; }
    ///@}
    ...
    template<typename OutputModalitiesT = Aws::Vector<ModelModality>>
    FoundationModelSummary& WithOutputModalities(OutputModalitiesT&& value) { SetOutputModalities(std::forward<OutputModalitiesT>(value)); return *this;}
    inline FoundationModelSummary& AddOutputModalities(ModelModality value) { m_outputModalitiesHasBeenSet = true; m_outputModalities.push_back(value); return *this; }
    ///@}
    ...
    template<typename CustomizationsSupportedT = Aws::Vector<ModelCustomization>>
    FoundationModelSummary& WithCustomizationsSupported(CustomizationsSupportedT&& value) { SetCustomizationsSupported(std::forward<CustomizationsSupportedT>(value)); return *this;}
    inline FoundationModelSummary& AddCustomizationsSupported(ModelCustomization value) { m_customizationsSupportedHasBeenSet = true; m_customizationsSupported.push_back(value); return *this; }
    ///@}
    ...
    template<typename InferenceTypesSupportedT = Aws::Vector<InferenceType>>
    FoundationModelSummary& WithInferenceTypesSupported(InferenceTypesSupportedT&& value) { SetInferenceTypesSupported(std::forward<InferenceTypesSupportedT>(value)); return *this;}
    inline FoundationModelSummary& AddInferenceTypesSupported(InferenceType value) { m_inferenceTypesSupportedHasBeenSet = true; m_inferenceTypesSupported.push_back(value); return *this; }
    ///@}
    ...
    template<typename ModelLifecycleT = FoundationModelLifecycle>
    FoundationModelSummary& WithModelLifecycle(ModelLifecycleT&& value) { SetModelLifecycle(std::forward<ModelLifecycleT>(value)); return *this;}
    ///@}
  private:
