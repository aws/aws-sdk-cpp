...
class UpdateProvisionedModelThroughputRequest : public BedrockRequest {
 public:
  ...
  void SetDesiredProvisionedModelName(DesiredProvisionedModelNameT&& value) {
    m_desiredProvisionedModelNameHasBeenSet = true;
    m_desiredProvisionedModelName = std::forward<DesiredProvisionedModelNameT>(value);
  }
  template <typename DesiredProvisionedModelNameT = Aws::String>
  UpdateProvisionedModelThroughputRequest& WithDesiredProvisionedModelName(DesiredProvisionedModelNameT&& value) {
    SetDesiredProvisionedModelName(std::forward<DesiredProvisionedModelNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDesiredModelId(DesiredModelIdT&& value) {
    m_desiredModelIdHasBeenSet = true;
    m_desiredModelId = std::forward<DesiredModelIdT>(value);
  }
  template <typename DesiredModelIdT = Aws::String>
  UpdateProvisionedModelThroughputRequest& WithDesiredModelId(DesiredModelIdT&& value) {
    SetDesiredModelId(std::forward<DesiredModelIdT>(value));
    return *this;
  }
  ///@}
 private:
