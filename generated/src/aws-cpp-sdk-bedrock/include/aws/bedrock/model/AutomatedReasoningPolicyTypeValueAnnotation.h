...
class AutomatedReasoningPolicyTypeValueAnnotation {
 public:
  ...
  void SetAddTypeValue(AddTypeValueT&& value) {
    m_addTypeValueHasBeenSet = true;
    m_addTypeValue = std::forward<AddTypeValueT>(value);
  }
  template <typename AddTypeValueT = AutomatedReasoningPolicyAddTypeValue>
  AutomatedReasoningPolicyTypeValueAnnotation& WithAddTypeValue(AddTypeValueT&& value) {
    SetAddTypeValue(std::forward<AddTypeValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUpdateTypeValue(UpdateTypeValueT&& value) {
    m_updateTypeValueHasBeenSet = true;
    m_updateTypeValue = std::forward<UpdateTypeValueT>(value);
  }
  template <typename UpdateTypeValueT = AutomatedReasoningPolicyUpdateTypeValue>
  AutomatedReasoningPolicyTypeValueAnnotation& WithUpdateTypeValue(UpdateTypeValueT&& value) {
    SetUpdateTypeValue(std::forward<UpdateTypeValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDeleteTypeValue(DeleteTypeValueT&& value) {
    m_deleteTypeValueHasBeenSet = true;
    m_deleteTypeValue = std::forward<DeleteTypeValueT>(value);
  }
  template <typename DeleteTypeValueT = AutomatedReasoningPolicyDeleteTypeValue>
  AutomatedReasoningPolicyTypeValueAnnotation& WithDeleteTypeValue(DeleteTypeValueT&& value) {
    SetDeleteTypeValue(std::forward<DeleteTypeValueT>(value));
    return *this;
  }
  ///@}
 private:
