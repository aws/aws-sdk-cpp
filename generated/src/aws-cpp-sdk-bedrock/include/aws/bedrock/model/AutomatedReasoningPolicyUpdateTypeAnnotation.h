...
class AutomatedReasoningPolicyUpdateTypeAnnotation {
 public:
  ...
  template <typename NameT = Aws::String>
  AutomatedReasoningPolicyUpdateTypeAnnotation& WithName(NameT&& value) {
  ...
  template <typename NewNameT = Aws::String>
  AutomatedReasoningPolicyUpdateTypeAnnotation& WithNewName(NewNameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  AutomatedReasoningPolicyUpdateTypeAnnotation& WithDescription(DescriptionT&& value) {
  ...
  template <typename ValuesT = Aws::Vector<AutomatedReasoningPolicyTypeValueAnnotation>>
  AutomatedReasoningPolicyUpdateTypeAnnotation& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = AutomatedReasoningPolicyTypeValueAnnotation>
  AutomatedReasoningPolicyUpdateTypeAnnotation& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
