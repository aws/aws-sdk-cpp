...
class GuardrailManagedWords {
 public:
  ...
  inline GuardrailManagedWords& WithType(GuardrailManagedWordsType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline GuardrailManagedWords& WithInputAction(GuardrailWordAction value) {
  ...
  inline GuardrailManagedWords& WithOutputAction(GuardrailWordAction value) {
  ...
  inline GuardrailManagedWords& WithInputEnabled(bool value) {
  ...
  inline GuardrailManagedWords& WithOutputEnabled(bool value) {
