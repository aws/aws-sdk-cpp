...
class GuardrailCrossRegionDetails {
 public:
  ...
  void SetGuardrailProfileId(GuardrailProfileIdT&& value) {
    ...
    m_guardrailProfileId = std::forward<GuardrailProfileIdT>(value);
  }
  template <typename GuardrailProfileIdT = Aws::String>
  GuardrailCrossRegionDetails& WithGuardrailProfileId(GuardrailProfileIdT&& value) {
    SetGuardrailProfileId(std::forward<GuardrailProfileIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGuardrailProfileArn(GuardrailProfileArnT&& value) {
    ...
    m_guardrailProfileArn = std::forward<GuardrailProfileArnT>(value);
  }
  template <typename GuardrailProfileArnT = Aws::String>
  GuardrailCrossRegionDetails& WithGuardrailProfileArn(GuardrailProfileArnT&& value) {
    SetGuardrailProfileArn(std::forward<GuardrailProfileArnT>(value));
    return *this;
  }
  ///@}
 private:
