...
namespace Model
{
  ...
  {
  public:
    AWS_BEDROCK_API StopModelInvocationJobRequest() = default;
    ...
    template<typename JobIdentifierT = Aws::String>
    StopModelInvocationJobRequest& WithJobIdentifier(JobIdentifierT&& value) { SetJobIdentifier(std::forward<JobIdentifierT>(value)); return *this;}
    ///@}
  private:
