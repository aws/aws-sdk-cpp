...
class ImplicitFilterConfiguration {
 public:
  ...
  void SetMetadataAttributes(MetadataAttributesT&& value) {
    m_metadataAttributesHasBeenSet = true;
    m_metadataAttributes = std::forward<MetadataAttributesT>(value);
  }
  template <typename MetadataAttributesT = Aws::Vector<MetadataAttributeSchema>>
  ImplicitFilterConfiguration& WithMetadataAttributes(MetadataAttributesT&& value) {
    SetMetadataAttributes(std::forward<MetadataAttributesT>(value));
    return *this;
  }
  template <typename MetadataAttributesT = MetadataAttributeSchema>
  ImplicitFilterConfiguration& AddMetadataAttributes(MetadataAttributesT&& value) {
    m_metadataAttributesHasBeenSet = true;
    m_metadataAttributes.emplace_back(std::forward<MetadataAttributesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ModelArnT = Aws::String>
  ImplicitFilterConfiguration& WithModelArn(ModelArnT&& value) {
