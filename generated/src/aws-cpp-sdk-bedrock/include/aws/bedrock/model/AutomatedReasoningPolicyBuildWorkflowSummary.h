...
class AutomatedReasoningPolicyBuildWorkflowSummary {
 public:
  ...
  template <typename PolicyArnT = Aws::String>
  AutomatedReasoningPolicyBuildWorkflowSummary& WithPolicyArn(PolicyArnT&& value) {
  ...
  template <typename BuildWorkflowIdT = Aws::String>
  AutomatedReasoningPolicyBuildWorkflowSummary& WithBuildWorkflowId(BuildWorkflowIdT&& value) {
  ...
  inline AutomatedReasoningPolicyBuildWorkflowSummary& WithStatus(AutomatedReasoningPolicyBuildWorkflowStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline AutomatedReasoningPolicyBuildWorkflowSummary& WithBuildWorkflowType(AutomatedReasoningPolicyBuildWorkflowType value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  AutomatedReasoningPolicyBuildWorkflowSummary& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  AutomatedReasoningPolicyBuildWorkflowSummary& WithUpdatedAt(UpdatedAtT&& value) {
