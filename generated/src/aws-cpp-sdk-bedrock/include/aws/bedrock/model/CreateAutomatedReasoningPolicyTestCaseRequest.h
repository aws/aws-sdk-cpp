...
class CreateAutomatedReasoningPolicyTestCaseRequest : public BedrockRequest {
 public:
  ...
  template <typename PolicyArnT = Aws::String>
  CreateAutomatedReasoningPolicyTestCaseRequest& WithPolicyArn(PolicyArnT&& value) {
  ...
  template <typename GuardContentT = Aws::String>
  CreateAutomatedReasoningPolicyTestCaseRequest& WithGuardContent(GuardContentT&& value) {
  ...
  template <typename QueryContentT = Aws::String>
  CreateAutomatedReasoningPolicyTestCaseRequest& WithQueryContent(QueryContentT&& value) {
  ...
  inline CreateAutomatedReasoningPolicyTestCaseRequest& WithExpectedAggregatedFindingsResult(AutomatedReasoningCheckResult value) {
  ...
  template <typename ClientRequestTokenT = Aws::String>
  CreateAutomatedReasoningPolicyTestCaseRequest& WithClientRequestToken(ClientRequestTokenT&& value) {
  ...
  inline CreateAutomatedReasoningPolicyTestCaseRequest& WithConfidenceThreshold(double value) {
