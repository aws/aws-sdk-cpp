...
class ListCustomModelsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListCustomModelsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ModelSummariesT = Aws::Vector<CustomModelSummary>>
  ListCustomModelsResult& WithModelSummaries(ModelSummariesT&& value) {
    SetModelSummaries(std::forward<ModelSummariesT>(value));
    return *this;
  }
  template <typename ModelSummariesT = CustomModelSummary>
  ListCustomModelsResult& AddModelSummaries(ModelSummariesT&& value) {
    m_modelSummariesHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListCustomModelsResult& WithRequestId(RequestIdT&& value) {
