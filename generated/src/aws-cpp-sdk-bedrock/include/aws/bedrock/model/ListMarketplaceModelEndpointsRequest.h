...
class ListMarketplaceModelEndpointsRequest : public BedrockRequest {
 public:
  ...
  inline ListMarketplaceModelEndpointsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListMarketplaceModelEndpointsRequest& WithNextToken(NextTokenT&& value) {
  ...
  void SetModelSourceEquals(ModelSourceEqualsT&& value) {
    m_modelSourceEqualsHasBeenSet = true;
    m_modelSourceEquals = std::forward<ModelSourceEqualsT>(value);
  }
  template <typename ModelSourceEqualsT = Aws::String>
  ListMarketplaceModelEndpointsRequest& WithModelSourceEquals(ModelSourceEqualsT&& value) {
    SetModelSourceEquals(std::forward<ModelSourceEqualsT>(value));
    return *this;
  }
  ///@}
 private:
