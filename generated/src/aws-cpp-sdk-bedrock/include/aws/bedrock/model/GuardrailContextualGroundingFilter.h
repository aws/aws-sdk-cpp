...
class GuardrailContextualGroundingFilter {
 public:
  ...
  inline void SetType(GuardrailContextualGroundingFilterType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline GuardrailContextualGroundingFilter& WithType(GuardrailContextualGroundingFilterType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline GuardrailContextualGroundingFilter& WithThreshold(double value) {
    SetThreshold(value);
    return *this;
  }
  ///@}
  ...
  ///@{
  /**
   * <p>The action to take when content fails the contextual grounding evaluation.
  ...
  inline void SetAction(GuardrailContextualGroundingAction value) {
    m_actionHasBeenSet = true;
    m_action = value;
  }
  inline GuardrailContextualGroundingFilter& WithAction(GuardrailContextualGroundingAction value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  ///@{
  /**
   * <p>Indicates whether contextual grounding is enabled for evaluation. When
  ...
  inline GuardrailContextualGroundingFilter& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
