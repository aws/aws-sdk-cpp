...
class ModelCopyJobSummary {
 public:
  ...
  inline void SetStatus(ModelCopyJobStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ModelCopyJobSummary& WithStatus(ModelCopyJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetTargetModelArn(TargetModelArnT&& value) {
    ...
    m_targetModelArn = std::forward<TargetModelArnT>(value);
  }
  template <typename TargetModelArnT = Aws::String>
  ModelCopyJobSummary& WithTargetModelArn(TargetModelArnT&& value) {
    SetTargetModelArn(std::forward<TargetModelArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTargetModelName(TargetModelNameT&& value) {
    ...
    m_targetModelName = std::forward<TargetModelNameT>(value);
  }
  template <typename TargetModelNameT = Aws::String>
  ModelCopyJobSummary& WithTargetModelName(TargetModelNameT&& value) {
    SetTargetModelName(std::forward<TargetModelNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTargetModelKmsKeyArn(TargetModelKmsKeyArnT&& value) {
    ...
    m_targetModelKmsKeyArn = std::forward<TargetModelKmsKeyArnT>(value);
  }
  template <typename TargetModelKmsKeyArnT = Aws::String>
  ModelCopyJobSummary& WithTargetModelKmsKeyArn(TargetModelKmsKeyArnT&& value) {
    SetTargetModelKmsKeyArn(std::forward<TargetModelKmsKeyArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTargetModelTags(TargetModelTagsT&& value) {
    ...
    m_targetModelTags = std::forward<TargetModelTagsT>(value);
  }
  template <typename TargetModelTagsT = Aws::Vector<Tag>>
  ModelCopyJobSummary& WithTargetModelTags(TargetModelTagsT&& value) {
    SetTargetModelTags(std::forward<TargetModelTagsT>(value));
    return *this;
  }
  template <typename TargetModelTagsT = Tag>
  ModelCopyJobSummary& AddTargetModelTags(TargetModelTagsT&& value) {
    m_targetModelTagsHasBeenSet = true;
    m_targetModelTags.emplace_back(std::forward<TargetModelTagsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSourceModelName(SourceModelNameT&& value) {
    ...
    m_sourceModelName = std::forward<SourceModelNameT>(value);
  }
  template <typename SourceModelNameT = Aws::String>
  ModelCopyJobSummary& WithSourceModelName(SourceModelNameT&& value) {
    SetSourceModelName(std::forward<SourceModelNameT>(value));
    return *this;
  }
  ///@}
 private:
