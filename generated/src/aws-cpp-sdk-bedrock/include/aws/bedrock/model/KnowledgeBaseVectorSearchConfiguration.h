...
class KnowledgeBaseVectorSearchConfiguration {
 public:
  ...
  inline KnowledgeBaseVectorSearchConfiguration& WithNumberOfResults(int value) {
  ...
  inline void SetOverrideSearchType(SearchType value) {
    m_overrideSearchTypeHasBeenSet = true;
    m_overrideSearchType = value;
  }
  inline KnowledgeBaseVectorSearchConfiguration& WithOverrideSearchType(SearchType value) {
    SetOverrideSearchType(value);
    return *this;
  }
  ///@}
