...
class EvaluationModelConfigSummary {
 public:
  ...
  void SetBedrockModelIdentifiers(BedrockModelIdentifiersT&& value) {
    ...
    m_bedrockModelIdentifiers = std::forward<BedrockModelIdentifiersT>(value);
  }
  template <typename BedrockModelIdentifiersT = Aws::Vector<Aws::String>>
  EvaluationModelConfigSummary& WithBedrockModelIdentifiers(BedrockModelIdentifiersT&& value) {
    SetBedrockModelIdentifiers(std::forward<BedrockModelIdentifiersT>(value));
    return *this;
  }
  ...
  EvaluationModelConfigSummary& AddBedrockModelIdentifiers(BedrockModelIdentifiersT&& value) {
    m_bedrockModelIdentifiersHasBeenSet = true;
    m_bedrockModelIdentifiers.emplace_back(std::forward<BedrockModelIdentifiersT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::Vector<Aws::String>& GetPrecomputedInferenceSourceIdentifiers() const {
    return m_precomputedInferenceSourceIdentifiers;
  }
  ...
  void SetPrecomputedInferenceSourceIdentifiers(PrecomputedInferenceSourceIdentifiersT&& value) {
    ...
    m_precomputedInferenceSourceIdentifiers = std::forward<PrecomputedInferenceSourceIdentifiersT>(value);
  }
  template <typename PrecomputedInferenceSourceIdentifiersT = Aws::Vector<Aws::String>>
  EvaluationModelConfigSummary& WithPrecomputedInferenceSourceIdentifiers(PrecomputedInferenceSourceIdentifiersT&& value) {
    SetPrecomputedInferenceSourceIdentifiers(std::forward<PrecomputedInferenceSourceIdentifiersT>(value));
    return *this;
  }
  ...
  EvaluationModelConfigSummary& AddPrecomputedInferenceSourceIdentifiers(PrecomputedInferenceSourceIdentifiersT&& value) {
    m_precomputedInferenceSourceIdentifiersHasBeenSet = true;
    m_precomputedInferenceSourceIdentifiers.emplace_back(std::forward<PrecomputedInferenceSourceIdentifiersT>(value));
    return *this;
  }
  ///@}
 private:
