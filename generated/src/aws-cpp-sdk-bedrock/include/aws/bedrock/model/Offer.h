...
class Offer {
 public:
  ...
  void SetOfferToken(OfferTokenT&& value) {
    ...
    m_offerToken = std::forward<OfferTokenT>(value);
  }
  template <typename OfferTokenT = Aws::String>
  Offer& WithOfferToken(OfferTokenT&& value) {
    SetOfferToken(std::forward<OfferTokenT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTermDetails(TermDetailsT&& value) {
    ...
    m_termDetails = std::forward<TermDetailsT>(value);
  }
  template <typename TermDetailsT = TermDetails>
  Offer& WithTermDetails(TermDetailsT&& value) {
    SetTermDetails(std::forward<TermDetailsT>(value));
    return *this;
  }
  ///@}
 private:
