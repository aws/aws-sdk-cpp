...
class AutomatedEvaluationCustomMetricConfig {
 public:
  ...
  void SetCustomMetrics(CustomMetricsT&& value) {
    ...
    m_customMetrics = std::forward<CustomMetricsT>(value);
  }
  template <typename CustomMetricsT = Aws::Vector<AutomatedEvaluationCustomMetricSource>>
  AutomatedEvaluationCustomMetricConfig& WithCustomMetrics(CustomMetricsT&& value) {
    SetCustomMetrics(std::forward<CustomMetricsT>(value));
    return *this;
  }
  ...
  AutomatedEvaluationCustomMetricConfig& AddCustomMetrics(CustomMetricsT&& value) {
    m_customMetricsHasBeenSet = true;
    m_customMetrics.emplace_back(std::forward<CustomMetricsT>(value));
    return *this;
  }
  ///@}
