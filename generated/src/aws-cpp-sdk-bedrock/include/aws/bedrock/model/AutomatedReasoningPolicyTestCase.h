...
class AutomatedReasoningPolicyTestCase {
 public:
  ...
  inline AutomatedReasoningPolicyTestCase& WithExpectedAggregatedFindingsResult(AutomatedReasoningCheckResult value) {
  ...
  inline void SetConfidenceThreshold(double value) {
    m_confidenceThresholdHasBeenSet = true;
    m_confidenceThreshold = value;
  }
  inline AutomatedReasoningPolicyTestCase& WithConfidenceThreshold(double value) {
