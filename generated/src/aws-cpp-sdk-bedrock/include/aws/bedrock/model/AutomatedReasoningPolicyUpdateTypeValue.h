...
class AutomatedReasoningPolicyUpdateTypeValue {
 public:
  ...
  template <typename ValueT = Aws::String>
  AutomatedReasoningPolicyUpdateTypeValue& WithValue(ValueT&& value) {
  ...
  template <typename NewValueT = Aws::String>
  AutomatedReasoningPolicyUpdateTypeValue& WithNewValue(NewValueT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  AutomatedReasoningPolicyUpdateTypeValue& WithDescription(DescriptionT&& value) {
