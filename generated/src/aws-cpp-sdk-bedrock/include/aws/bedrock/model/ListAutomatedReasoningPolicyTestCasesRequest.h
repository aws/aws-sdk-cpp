...
namespace Model
{
  ...
  public:
    ...
    template<typename PolicyArnT = Aws::String>
    ListAutomatedReasoningPolicyTestCasesRequest& WithPolicyArn(PolicyArnT&& value) { SetPolicyArn(std::forward<PolicyArnT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListAutomatedReasoningPolicyTestCasesRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    inline ListAutomatedReasoningPolicyTestCasesRequest& WithMaxResults(int value) { SetMaxResults(value); return *this;}
    ///@}
  private:
