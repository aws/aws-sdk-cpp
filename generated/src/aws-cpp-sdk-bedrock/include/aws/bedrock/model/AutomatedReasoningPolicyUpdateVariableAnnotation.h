...
class AutomatedReasoningPolicyUpdateVariableAnnotation {
 public:
  ...
  template <typename NameT = Aws::String>
  AutomatedReasoningPolicyUpdateVariableAnnotation& WithName(NameT&& value) {
  ...
  template <typename NewNameT = Aws::String>
  AutomatedReasoningPolicyUpdateVariableAnnotation& WithNewName(NewNameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  AutomatedReasoningPolicyUpdateVariableAnnotation& WithDescription(DescriptionT&& value) {
