...
class GetAutomatedReasoningPolicyTestResultResult {
 public:
  ...
  AWS_BEDROCK_API GetAutomatedReasoningPolicyTestResultResult& operator=(
  ...
  template <typename TestResultT = AutomatedReasoningPolicyTestResult>
  GetAutomatedReasoningPolicyTestResultResult& WithTestResult(TestResultT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetAutomatedReasoningPolicyTestResultResult& WithRequestId(RequestIdT&& value) {
