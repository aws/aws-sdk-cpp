...
class InvocationLogsConfig {
 public:
  ...
  inline void SetUsePromptResponse(bool value) {
    m_usePromptResponseHasBeenSet = true;
    m_usePromptResponse = value;
  }
  inline InvocationLogsConfig& WithUsePromptResponse(bool value) {
    SetUsePromptResponse(value);
    return *this;
  }
  ///@}
  ...
  void SetInvocationLogSource(InvocationLogSourceT&& value) {
    ...
    m_invocationLogSource = std::forward<InvocationLogSourceT>(value);
  }
  template <typename InvocationLogSourceT = InvocationLogSource>
  InvocationLogsConfig& WithInvocationLogSource(InvocationLogSourceT&& value) {
    SetInvocationLogSource(std::forward<InvocationLogSourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRequestMetadataFilters(RequestMetadataFiltersT&& value) {
    ...
    m_requestMetadataFilters = std::forward<RequestMetadataFiltersT>(value);
  }
  template <typename RequestMetadataFiltersT = RequestMetadataFilters>
  InvocationLogsConfig& WithRequestMetadataFilters(RequestMetadataFiltersT&& value) {
    SetRequestMetadataFilters(std::forward<RequestMetadataFiltersT>(value));
    return *this;
  }
  ///@}
 private:
