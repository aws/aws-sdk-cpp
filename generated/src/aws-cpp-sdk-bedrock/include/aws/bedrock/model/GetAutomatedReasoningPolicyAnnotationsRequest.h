...
class GetAutomatedReasoningPolicyAnnotationsRequest : public BedrockRequest {
 public:
  ...
  template <typename PolicyArnT = Aws::String>
  GetAutomatedReasoningPolicyAnnotationsRequest& WithPolicyArn(PolicyArnT&& value) {
  ...
  template <typename BuildWorkflowIdT = Aws::String>
  GetAutomatedReasoningPolicyAnnotationsRequest& WithBuildWorkflowId(BuildWorkflowIdT&& value) {
