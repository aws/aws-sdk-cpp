...
class CreateModelCustomizationJobRequest : public BedrockRequest {
 public:
  ...
  void SetBaseModelIdentifier(BaseModelIdentifierT&& value) {
    m_baseModelIdentifierHasBeenSet = true;
    m_baseModelIdentifier = std::forward<BaseModelIdentifierT>(value);
  }
  template <typename BaseModelIdentifierT = Aws::String>
  CreateModelCustomizationJobRequest& WithBaseModelIdentifier(BaseModelIdentifierT&& value) {
    SetBaseModelIdentifier(std::forward<BaseModelIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateModelCustomizationJobRequest& WithCustomizationType(CustomizationType value) {
  ...
  void SetCustomModelKmsKeyId(CustomModelKmsKeyIdT&& value) {
    m_customModelKmsKeyIdHasBeenSet = true;
    m_customModelKmsKeyId = std::forward<CustomModelKmsKeyIdT>(value);
  }
  template <typename CustomModelKmsKeyIdT = Aws::String>
  CreateModelCustomizationJobRequest& WithCustomModelKmsKeyId(CustomModelKmsKeyIdT&& value) {
    SetCustomModelKmsKeyId(std::forward<CustomModelKmsKeyIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCustomModelTags(CustomModelTagsT&& value) {
    m_customModelTagsHasBeenSet = true;
    m_customModelTags = std::forward<CustomModelTagsT>(value);
  }
  template <typename CustomModelTagsT = Aws::Vector<Tag>>
  CreateModelCustomizationJobRequest& WithCustomModelTags(CustomModelTagsT&& value) {
    SetCustomModelTags(std::forward<CustomModelTagsT>(value));
    return *this;
  }
  template <typename CustomModelTagsT = Tag>
  CreateModelCustomizationJobRequest& AddCustomModelTags(CustomModelTagsT&& value) {
    m_customModelTagsHasBeenSet = true;
    m_customModelTags.emplace_back(std::forward<CustomModelTagsT>(value));
    return *this;
  }
  ///@}
