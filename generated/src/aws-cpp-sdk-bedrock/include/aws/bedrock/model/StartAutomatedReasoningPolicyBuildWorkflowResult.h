...
class StartAutomatedReasoningPolicyBuildWorkflowResult {
 public:
  ...
  AWS_BEDROCK_API StartAutomatedReasoningPolicyBuildWorkflowResult& operator=(
  ...
  template <typename PolicyArnT = Aws::String>
  StartAutomatedReasoningPolicyBuildWorkflowResult& WithPolicyArn(PolicyArnT&& value) {
  ...
  template <typename BuildWorkflowIdT = Aws::String>
  StartAutomatedReasoningPolicyBuildWorkflowResult& WithBuildWorkflowId(BuildWorkflowIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StartAutomatedReasoningPolicyBuildWorkflowResult& WithRequestId(RequestIdT&& value) {
