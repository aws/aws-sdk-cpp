...
class AutomatedReasoningPolicyAddVariableAnnotation {
 public:
  ...
  template <typename NameT = Aws::String>
  AutomatedReasoningPolicyAddVariableAnnotation& WithName(NameT&& value) {
  ...
  template <typename TypeT = Aws::String>
  AutomatedReasoningPolicyAddVariableAnnotation& WithType(TypeT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  AutomatedReasoningPolicyAddVariableAnnotation& WithDescription(DescriptionT&& value) {
