...
class GuardrailManagedWordsConfig {
 public:
  ...
  inline void SetType(GuardrailManagedWordsType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline GuardrailManagedWordsConfig& WithType(GuardrailManagedWordsType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetInputAction(GuardrailWordAction value) {
    m_inputActionHasBeenSet = true;
    m_inputAction = value;
  }
  inline GuardrailManagedWordsConfig& WithInputAction(GuardrailWordAction value) {
  ...
  inline void SetOutputAction(GuardrailWordAction value) {
    m_outputActionHasBeenSet = true;
    m_outputAction = value;
  }
  inline GuardrailManagedWordsConfig& WithOutputAction(GuardrailWordAction value) {
  ...
  inline GuardrailManagedWordsConfig& WithInputEnabled(bool value) {
  ...
  inline GuardrailManagedWordsConfig& WithOutputEnabled(bool value) {
