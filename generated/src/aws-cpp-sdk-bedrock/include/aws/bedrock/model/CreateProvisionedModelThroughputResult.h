...
class CreateProvisionedModelThroughputResult {
 public:
  ...
  template <typename ProvisionedModelArnT = Aws::String>
  CreateProvisionedModelThroughputResult& WithProvisionedModelArn(ProvisionedModelArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateProvisionedModelThroughputResult& WithRequestId(RequestIdT&& value) {
