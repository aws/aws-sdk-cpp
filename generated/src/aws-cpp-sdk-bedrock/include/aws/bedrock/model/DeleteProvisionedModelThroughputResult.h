...
namespace Model
{
  ...
  {
  public:
    AWS_BEDROCK_API DeleteProvisionedModelThroughputResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteProvisionedModelThroughputResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
