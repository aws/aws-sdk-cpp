...
class GetPromptRouterResult {
 public:
  ...
  void SetPromptRouterName(PromptRouterNameT&& value) {
    ...
    m_promptRouterName = std::forward<PromptRouterNameT>(value);
  }
  template <typename PromptRouterNameT = Aws::String>
  GetPromptRouterResult& WithPromptRouterName(PromptRouterNameT&& value) {
    SetPromptRouterName(std::forward<PromptRouterNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPromptRouterArn(PromptRouterArnT&& value) {
    ...
    m_promptRouterArn = std::forward<PromptRouterArnT>(value);
  }
  template <typename PromptRouterArnT = Aws::String>
  GetPromptRouterResult& WithPromptRouterArn(PromptRouterArnT&& value) {
    SetPromptRouterArn(std::forward<PromptRouterArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFallbackModel(FallbackModelT&& value) {
    ...
    m_fallbackModel = std::forward<FallbackModelT>(value);
  }
  template <typename FallbackModelT = PromptRouterTargetModel>
  GetPromptRouterResult& WithFallbackModel(FallbackModelT&& value) {
    SetFallbackModel(std::forward<FallbackModelT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(PromptRouterStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline GetPromptRouterResult& WithStatus(PromptRouterStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline GetPromptRouterResult& WithType(PromptRouterType value) {
    SetType(value);
    return *this;
  }
  ///@}
