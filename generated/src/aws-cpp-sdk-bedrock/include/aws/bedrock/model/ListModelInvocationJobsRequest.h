...
class ListModelInvocationJobsRequest : public BedrockRequest {
 public:
  ...
  template <typename SubmitTimeAfterT = Aws::Utils::DateTime>
  ListModelInvocationJobsRequest& WithSubmitTimeAfter(SubmitTimeAfterT&& value) {
  ...
  template <typename SubmitTimeBeforeT = Aws::Utils::DateTime>
  ListModelInvocationJobsRequest& WithSubmitTimeBefore(SubmitTimeBeforeT&& value) {
  ...
  inline void SetStatusEquals(ModelInvocationJobStatus value) {
    m_statusEqualsHasBeenSet = true;
    m_statusEquals = value;
  }
  inline ListModelInvocationJobsRequest& WithStatusEquals(ModelInvocationJobStatus value) {
  ...
  template <typename NameContainsT = Aws::String>
  ListModelInvocationJobsRequest& WithNameContains(NameContainsT&& value) {
  ...
  inline ListModelInvocationJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListModelInvocationJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListModelInvocationJobsRequest& WithSortBy(SortJobsBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListModelInvocationJobsRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
