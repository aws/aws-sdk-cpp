...
class AdvancedPromptOptimizationInputConfig {
 public:
  AWS_BEDROCK_API AdvancedPromptOptimizationInputConfig() = default;
  AWS_BEDROCK_API AdvancedPromptOptimizationInputConfig(Aws::Utils::Json::JsonView jsonValue);
  AWS_BEDROCK_API AdvancedPromptOptimizationInputConfig& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename S3UriT = Aws::String>
  AdvancedPromptOptimizationInputConfig& WithS3Uri(S3UriT&& value) {
