...
class DeleteImportedModelRequest : public BedrockRequest {
 public:
  AWS_BEDROCK_API DeleteImportedModelRequest() = default;
  ...
  void SetModelIdentifier(ModelIdentifierT&& value) {
    ...
    m_modelIdentifier = std::forward<ModelIdentifierT>(value);
  }
  template <typename ModelIdentifierT = Aws::String>
  DeleteImportedModelRequest& WithModelIdentifier(ModelIdentifierT&& value) {
    SetModelIdentifier(std::forward<ModelIdentifierT>(value));
    return *this;
  }
  ///@}
 private:
