...
class GetAutomatedReasoningPolicyBuildWorkflowRequest : public BedrockRequest {
 public:
  ...
  template <typename PolicyArnT = Aws::String>
  GetAutomatedReasoningPolicyBuildWorkflowRequest& WithPolicyArn(PolicyArnT&& value) {
  ...
  template <typename BuildWorkflowIdT = Aws::String>
  GetAutomatedReasoningPolicyBuildWorkflowRequest& WithBuildWorkflowId(BuildWorkflowIdT&& value) {
