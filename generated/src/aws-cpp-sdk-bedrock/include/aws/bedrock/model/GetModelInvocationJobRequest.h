...
namespace Model
{
  ...
  /**
   */
  class GetModelInvocationJobRequest : public BedrockRequest
  {
  public:
    ...
    inline virtual const char* GetServiceRequestName() const override { return "GetModelInvocationJob"; }
    ...
    inline GetModelInvocationJobRequest& WithJobIdentifier(const Aws::String& value) { SetJobIdentifier(value); return *this;}
    inline GetModelInvocationJobRequest& WithJobIdentifier(Aws::String&& value) { SetJobIdentifier(std::move(value)); return *this;}
    inline GetModelInvocationJobRequest& WithJobIdentifier(const char* value) { SetJobIdentifier(value); return *this;}
    ///@}
  private:
