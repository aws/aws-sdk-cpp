...
/**
 * <p>Details about topics for the guardrail to identify and deny.</p><p><h3>See
 * Also:</h3>   <a
...
class GuardrailTopicConfig {
 public:
  ...
  inline GuardrailTopicConfig& WithType(GuardrailTopicType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetInputAction(GuardrailTopicAction value) {
    m_inputActionHasBeenSet = true;
    m_inputAction = value;
  }
  inline GuardrailTopicConfig& WithInputAction(GuardrailTopicAction value) {
  ...
  inline void SetOutputAction(GuardrailTopicAction value) {
    m_outputActionHasBeenSet = true;
    m_outputAction = value;
  }
  inline GuardrailTopicConfig& WithOutputAction(GuardrailTopicAction value) {
  ...
  inline GuardrailTopicConfig& WithInputEnabled(bool value) {
  ...
  inline GuardrailTopicConfig& WithOutputEnabled(bool value) {
