...
namespace Model
{
  ...
  {
  public:
    AWS_BEDROCK_API DeletePromptRouterRequest();
    ...
    inline DeletePromptRouterRequest& WithPromptRouterArn(const Aws::String& value) { SetPromptRouterArn(value); return *this;}
    inline DeletePromptRouterRequest& WithPromptRouterArn(Aws::String&& value) { SetPromptRouterArn(std::move(value)); return *this;}
    inline DeletePromptRouterRequest& WithPromptRouterArn(const char* value) { SetPromptRouterArn(value); return *this;}
    ///@}
  private:
