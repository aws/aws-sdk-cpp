...
namespace Model
{
  ...
  public:
    ...
    template<typename MarketplaceModelEndpointT = MarketplaceModelEndpoint>
    RegisterMarketplaceModelEndpointResult& WithMarketplaceModelEndpoint(MarketplaceModelEndpointT&& value) { SetMarketplaceModelEndpoint(std::forward<MarketplaceModelEndpointT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    RegisterMarketplaceModelEndpointResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
