...
class RegisterMarketplaceModelEndpointResult {
 public:
  AWS_BEDROCK_API RegisterMarketplaceModelEndpointResult() = default;
  ...
  void SetMarketplaceModelEndpoint(MarketplaceModelEndpointT&& value) {
    m_marketplaceModelEndpointHasBeenSet = true;
    m_marketplaceModelEndpoint = std::forward<MarketplaceModelEndpointT>(value);
  }
  template <typename MarketplaceModelEndpointT = MarketplaceModelEndpoint>
  RegisterMarketplaceModelEndpointResult& WithMarketplaceModelEndpoint(MarketplaceModelEndpointT&& value) {
    SetMarketplaceModelEndpoint(std::forward<MarketplaceModelEndpointT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  RegisterMarketplaceModelEndpointResult& WithRequestId(RequestIdT&& value) {
