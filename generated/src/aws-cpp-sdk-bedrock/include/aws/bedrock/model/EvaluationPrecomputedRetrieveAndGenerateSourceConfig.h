...
class EvaluationPrecomputedRetrieveAndGenerateSourceConfig {
 public:
  ...
  void SetRagSourceIdentifier(RagSourceIdentifierT&& value) {
    ...
    m_ragSourceIdentifier = std::forward<RagSourceIdentifierT>(value);
  }
  template <typename RagSourceIdentifierT = Aws::String>
  EvaluationPrecomputedRetrieveAndGenerateSourceConfig& WithRagSourceIdentifier(RagSourceIdentifierT&& value) {
    SetRagSourceIdentifier(std::forward<RagSourceIdentifierT>(value));
    return *this;
  }
  ///@}
 private:
