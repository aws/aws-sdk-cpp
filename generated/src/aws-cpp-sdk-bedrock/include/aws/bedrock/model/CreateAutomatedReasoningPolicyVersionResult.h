...
class CreateAutomatedReasoningPolicyVersionResult {
 public:
  ...
  AWS_BEDROCK_API CreateAutomatedReasoningPolicyVersionResult& operator=(
  ...
  template <typename PolicyArnT = Aws::String>
  CreateAutomatedReasoningPolicyVersionResult& WithPolicyArn(PolicyArnT&& value) {
  ...
  template <typename VersionT = Aws::String>
  CreateAutomatedReasoningPolicyVersionResult& WithVersion(VersionT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateAutomatedReasoningPolicyVersionResult& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateAutomatedReasoningPolicyVersionResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename DefinitionHashT = Aws::String>
  CreateAutomatedReasoningPolicyVersionResult& WithDefinitionHash(DefinitionHashT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  CreateAutomatedReasoningPolicyVersionResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateAutomatedReasoningPolicyVersionResult& WithRequestId(RequestIdT&& value) {
