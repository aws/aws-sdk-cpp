 ...
 */
class AWS_BEDROCK_API BedrockClient
 ...
 public:
   ...
   */
  BedrockClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<BedrockEndpointProviderBase> endpointProvider = nullptr,
                const Aws::Bedrock::BedrockClientConfiguration& clientConfiguration = Aws::Bedrock::BedrockClientConfiguration());
  ...
  /**
   * A Callable wrapper for BatchDeleteEvaluationJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchDeleteEvaluationJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchDeleteEvaluationJobRequestT = Model::BatchDeleteEvaluationJobRequest>
  void BatchDeleteEvaluationJobAsync(const BatchDeleteEvaluationJobRequestT& request,
                                     const BatchDeleteEvaluationJobResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::CancelAutomatedReasoningPolicyBuildWorkflowOutcome CancelAutomatedReasoningPolicyBuildWorkflow(
      const Model::CancelAutomatedReasoningPolicyBuildWorkflowRequest& request) const;

  /**
   * A Callable wrapper for CancelAutomatedReasoningPolicyBuildWorkflow that returns a future to the operation so that it can be executed in
  ...
  Model::CancelAutomatedReasoningPolicyBuildWorkflowOutcomeCallable CancelAutomatedReasoningPolicyBuildWorkflowCallable(
      const CancelAutomatedReasoningPolicyBuildWorkflowRequestT& request) const {
    return SubmitCallable(&BedrockClient::CancelAutomatedReasoningPolicyBuildWorkflow, request);
  }

  /**
   * An Async wrapper for CancelAutomatedReasoningPolicyBuildWorkflow that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename CancelAutomatedReasoningPolicyBuildWorkflowRequestT = Model::CancelAutomatedReasoningPolicyBuildWorkflowRequest>
  void CancelAutomatedReasoningPolicyBuildWorkflowAsync(
      const CancelAutomatedReasoningPolicyBuildWorkflowRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateAutomatedReasoningPolicyOutcome CreateAutomatedReasoningPolicy(
      const Model::CreateAutomatedReasoningPolicyRequest& request) const;

  /**
   * A Callable wrapper for CreateAutomatedReasoningPolicy that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateAutomatedReasoningPolicyRequestT = Model::CreateAutomatedReasoningPolicyRequest>
  Model::CreateAutomatedReasoningPolicyOutcomeCallable CreateAutomatedReasoningPolicyCallable(
      const CreateAutomatedReasoningPolicyRequestT& request) const {
    return SubmitCallable(&BedrockClient::CreateAutomatedReasoningPolicy, request);
  }

  /**
   * An Async wrapper for CreateAutomatedReasoningPolicy that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateAutomatedReasoningPolicyRequestT = Model::CreateAutomatedReasoningPolicyRequest>
  void CreateAutomatedReasoningPolicyAsync(const CreateAutomatedReasoningPolicyRequestT& request,
                                           const CreateAutomatedReasoningPolicyResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateAutomatedReasoningPolicyTestCaseOutcome CreateAutomatedReasoningPolicyTestCase(
      const Model::CreateAutomatedReasoningPolicyTestCaseRequest& request) const;

  /**
   * A Callable wrapper for CreateAutomatedReasoningPolicyTestCase that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename CreateAutomatedReasoningPolicyTestCaseRequestT = Model::CreateAutomatedReasoningPolicyTestCaseRequest>
  Model::CreateAutomatedReasoningPolicyTestCaseOutcomeCallable CreateAutomatedReasoningPolicyTestCaseCallable(
      const CreateAutomatedReasoningPolicyTestCaseRequestT& request) const {
    return SubmitCallable(&BedrockClient::CreateAutomatedReasoningPolicyTestCase, request);
  }

  /**
   * An Async wrapper for CreateAutomatedReasoningPolicyTestCase that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename CreateAutomatedReasoningPolicyTestCaseRequestT = Model::CreateAutomatedReasoningPolicyTestCaseRequest>
  void CreateAutomatedReasoningPolicyTestCaseAsync(const CreateAutomatedReasoningPolicyTestCaseRequestT& request,
                                                   const CreateAutomatedReasoningPolicyTestCaseResponseReceivedHandler& handler,
                                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateAutomatedReasoningPolicyVersionOutcome CreateAutomatedReasoningPolicyVersion(
      const Model::CreateAutomatedReasoningPolicyVersionRequest& request) const;

  /**
   * A Callable wrapper for CreateAutomatedReasoningPolicyVersion that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename CreateAutomatedReasoningPolicyVersionRequestT = Model::CreateAutomatedReasoningPolicyVersionRequest>
  Model::CreateAutomatedReasoningPolicyVersionOutcomeCallable CreateAutomatedReasoningPolicyVersionCallable(
      const CreateAutomatedReasoningPolicyVersionRequestT& request) const {
    return SubmitCallable(&BedrockClient::CreateAutomatedReasoningPolicyVersion, request);
  }

  /**
   * An Async wrapper for CreateAutomatedReasoningPolicyVersion that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename CreateAutomatedReasoningPolicyVersionRequestT = Model::CreateAutomatedReasoningPolicyVersionRequest>
  void CreateAutomatedReasoningPolicyVersionAsync(const CreateAutomatedReasoningPolicyVersionRequestT& request,
                                                  const CreateAutomatedReasoningPolicyVersionResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateCustomModel that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateCustomModel that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateCustomModelRequestT = Model::CreateCustomModelRequest>
  void CreateCustomModelAsync(const CreateCustomModelRequestT& request, const CreateCustomModelResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateCustomModelDeploymentOutcome CreateCustomModelDeployment(
      const Model::CreateCustomModelDeploymentRequest& request) const;

  /**
   * A Callable wrapper for CreateCustomModelDeployment that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateCustomModelDeploymentRequestT = Model::CreateCustomModelDeploymentRequest>
  Model::CreateCustomModelDeploymentOutcomeCallable CreateCustomModelDeploymentCallable(
      const CreateCustomModelDeploymentRequestT& request) const {
    return SubmitCallable(&BedrockClient::CreateCustomModelDeployment, request);
  }

  /**
   * An Async wrapper for CreateCustomModelDeployment that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateCustomModelDeploymentRequestT = Model::CreateCustomModelDeploymentRequest>
  void CreateCustomModelDeploymentAsync(const CreateCustomModelDeploymentRequestT& request,
                                        const CreateCustomModelDeploymentResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateEvaluationJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateEvaluationJob that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateEvaluationJobRequestT = Model::CreateEvaluationJobRequest>
  void CreateEvaluationJobAsync(const CreateEvaluationJobRequestT& request, const CreateEvaluationJobResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateFoundationModelAgreementOutcome CreateFoundationModelAgreement(
      const Model::CreateFoundationModelAgreementRequest& request) const;

  /**
   * A Callable wrapper for CreateFoundationModelAgreement that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateFoundationModelAgreementRequestT = Model::CreateFoundationModelAgreementRequest>
  Model::CreateFoundationModelAgreementOutcomeCallable CreateFoundationModelAgreementCallable(
      const CreateFoundationModelAgreementRequestT& request) const {
    return SubmitCallable(&BedrockClient::CreateFoundationModelAgreement, request);
  }

  /**
   * An Async wrapper for CreateFoundationModelAgreement that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateFoundationModelAgreementRequestT = Model::CreateFoundationModelAgreementRequest>
  void CreateFoundationModelAgreementAsync(const CreateFoundationModelAgreementRequestT& request,
                                           const CreateFoundationModelAgreementResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateGuardrail that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateGuardrailRequestT = Model::CreateGuardrailRequest>
  void CreateGuardrailAsync(const CreateGuardrailRequestT& request, const CreateGuardrailResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateGuardrailVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateGuardrailVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateGuardrailVersionRequestT = Model::CreateGuardrailVersionRequest>
  void CreateGuardrailVersionAsync(const CreateGuardrailVersionRequestT& request,
                                   const CreateGuardrailVersionResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateInferenceProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateInferenceProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateInferenceProfileRequestT = Model::CreateInferenceProfileRequest>
  void CreateInferenceProfileAsync(const CreateInferenceProfileRequestT& request,
                                   const CreateInferenceProfileResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateMarketplaceModelEndpointOutcome CreateMarketplaceModelEndpoint(
      const Model::CreateMarketplaceModelEndpointRequest& request) const;

  /**
   * A Callable wrapper for CreateMarketplaceModelEndpoint that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateMarketplaceModelEndpointRequestT = Model::CreateMarketplaceModelEndpointRequest>
  Model::CreateMarketplaceModelEndpointOutcomeCallable CreateMarketplaceModelEndpointCallable(
      const CreateMarketplaceModelEndpointRequestT& request) const {
    return SubmitCallable(&BedrockClient::CreateMarketplaceModelEndpoint, request);
  }

  /**
   * An Async wrapper for CreateMarketplaceModelEndpoint that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateMarketplaceModelEndpointRequestT = Model::CreateMarketplaceModelEndpointRequest>
  void CreateMarketplaceModelEndpointAsync(const CreateMarketplaceModelEndpointRequestT& request,
                                           const CreateMarketplaceModelEndpointResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateModelCopyJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateModelCopyJob that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateModelCopyJobRequestT = Model::CreateModelCopyJobRequest>
  void CreateModelCopyJobAsync(const CreateModelCopyJobRequestT& request, const CreateModelCopyJobResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateModelCustomizationJobOutcome CreateModelCustomizationJob(
      const Model::CreateModelCustomizationJobRequest& request) const;

  /**
   * A Callable wrapper for CreateModelCustomizationJob that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateModelCustomizationJobRequestT = Model::CreateModelCustomizationJobRequest>
  Model::CreateModelCustomizationJobOutcomeCallable CreateModelCustomizationJobCallable(
      const CreateModelCustomizationJobRequestT& request) const {
    return SubmitCallable(&BedrockClient::CreateModelCustomizationJob, request);
  }

  /**
   * An Async wrapper for CreateModelCustomizationJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateModelCustomizationJobRequestT = Model::CreateModelCustomizationJobRequest>
  void CreateModelCustomizationJobAsync(const CreateModelCustomizationJobRequestT& request,
                                        const CreateModelCustomizationJobResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateModelImportJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateModelImportJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateModelImportJobRequestT = Model::CreateModelImportJobRequest>
  void CreateModelImportJobAsync(const CreateModelImportJobRequestT& request, const CreateModelImportJobResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateModelInvocationJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateModelInvocationJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateModelInvocationJobRequestT = Model::CreateModelInvocationJobRequest>
  void CreateModelInvocationJobAsync(const CreateModelInvocationJobRequestT& request,
                                     const CreateModelInvocationJobResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreatePromptRouter that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreatePromptRouter that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreatePromptRouterRequestT = Model::CreatePromptRouterRequest>
  void CreatePromptRouterAsync(const CreatePromptRouterRequestT& request, const CreatePromptRouterResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateProvisionedModelThroughputOutcome CreateProvisionedModelThroughput(
      const Model::CreateProvisionedModelThroughputRequest& request) const;

  /**
   * A Callable wrapper for CreateProvisionedModelThroughput that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename CreateProvisionedModelThroughputRequestT = Model::CreateProvisionedModelThroughputRequest>
  Model::CreateProvisionedModelThroughputOutcomeCallable CreateProvisionedModelThroughputCallable(
      const CreateProvisionedModelThroughputRequestT& request) const {
    return SubmitCallable(&BedrockClient::CreateProvisionedModelThroughput, request);
  }

  /**
   * An Async wrapper for CreateProvisionedModelThroughput that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateProvisionedModelThroughputRequestT = Model::CreateProvisionedModelThroughputRequest>
  void CreateProvisionedModelThroughputAsync(const CreateProvisionedModelThroughputRequestT& request,
                                             const CreateProvisionedModelThroughputResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteAutomatedReasoningPolicyOutcome DeleteAutomatedReasoningPolicy(
      const Model::DeleteAutomatedReasoningPolicyRequest& request) const;

  /**
   * A Callable wrapper for DeleteAutomatedReasoningPolicy that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteAutomatedReasoningPolicyRequestT = Model::DeleteAutomatedReasoningPolicyRequest>
  Model::DeleteAutomatedReasoningPolicyOutcomeCallable DeleteAutomatedReasoningPolicyCallable(
      const DeleteAutomatedReasoningPolicyRequestT& request) const {
    return SubmitCallable(&BedrockClient::DeleteAutomatedReasoningPolicy, request);
  }

  /**
   * An Async wrapper for DeleteAutomatedReasoningPolicy that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteAutomatedReasoningPolicyRequestT = Model::DeleteAutomatedReasoningPolicyRequest>
  void DeleteAutomatedReasoningPolicyAsync(const DeleteAutomatedReasoningPolicyRequestT& request,
                                           const DeleteAutomatedReasoningPolicyResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteAutomatedReasoningPolicyBuildWorkflowOutcome DeleteAutomatedReasoningPolicyBuildWorkflow(
      const Model::DeleteAutomatedReasoningPolicyBuildWorkflowRequest& request) const;

  /**
   * A Callable wrapper for DeleteAutomatedReasoningPolicyBuildWorkflow that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  ...
  Model::DeleteAutomatedReasoningPolicyBuildWorkflowOutcomeCallable DeleteAutomatedReasoningPolicyBuildWorkflowCallable(
      const DeleteAutomatedReasoningPolicyBuildWorkflowRequestT& request) const {
    return SubmitCallable(&BedrockClient::DeleteAutomatedReasoningPolicyBuildWorkflow, request);
  }

  /**
   * An Async wrapper for DeleteAutomatedReasoningPolicyBuildWorkflow that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DeleteAutomatedReasoningPolicyBuildWorkflowRequestT = Model::DeleteAutomatedReasoningPolicyBuildWorkflowRequest>
  void DeleteAutomatedReasoningPolicyBuildWorkflowAsync(
      const DeleteAutomatedReasoningPolicyBuildWorkflowRequestT& request,
      const DeleteAutomatedReasoningPolicyBuildWorkflowResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteAutomatedReasoningPolicyTestCaseOutcome DeleteAutomatedReasoningPolicyTestCase(
      const Model::DeleteAutomatedReasoningPolicyTestCaseRequest& request) const;

  /**
   * A Callable wrapper for DeleteAutomatedReasoningPolicyTestCase that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DeleteAutomatedReasoningPolicyTestCaseRequestT = Model::DeleteAutomatedReasoningPolicyTestCaseRequest>
  Model::DeleteAutomatedReasoningPolicyTestCaseOutcomeCallable DeleteAutomatedReasoningPolicyTestCaseCallable(
      const DeleteAutomatedReasoningPolicyTestCaseRequestT& request) const {
    return SubmitCallable(&BedrockClient::DeleteAutomatedReasoningPolicyTestCase, request);
  }

  /**
   * An Async wrapper for DeleteAutomatedReasoningPolicyTestCase that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DeleteAutomatedReasoningPolicyTestCaseRequestT = Model::DeleteAutomatedReasoningPolicyTestCaseRequest>
  void DeleteAutomatedReasoningPolicyTestCaseAsync(const DeleteAutomatedReasoningPolicyTestCaseRequestT& request,
                                                   const DeleteAutomatedReasoningPolicyTestCaseResponseReceivedHandler& handler,
                                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteCustomModel that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteCustomModel that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteCustomModelRequestT = Model::DeleteCustomModelRequest>
  void DeleteCustomModelAsync(const DeleteCustomModelRequestT& request, const DeleteCustomModelResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteCustomModelDeploymentOutcome DeleteCustomModelDeployment(
      const Model::DeleteCustomModelDeploymentRequest& request) const;

  /**
   * A Callable wrapper for DeleteCustomModelDeployment that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteCustomModelDeploymentRequestT = Model::DeleteCustomModelDeploymentRequest>
  Model::DeleteCustomModelDeploymentOutcomeCallable DeleteCustomModelDeploymentCallable(
      const DeleteCustomModelDeploymentRequestT& request) const {
    return SubmitCallable(&BedrockClient::DeleteCustomModelDeployment, request);
  }

  /**
   * An Async wrapper for DeleteCustomModelDeployment that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteCustomModelDeploymentRequestT = Model::DeleteCustomModelDeploymentRequest>
  void DeleteCustomModelDeploymentAsync(const DeleteCustomModelDeploymentRequestT& request,
                                        const DeleteCustomModelDeploymentResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteFoundationModelAgreementOutcome DeleteFoundationModelAgreement(
      const Model::DeleteFoundationModelAgreementRequest& request) const;

  /**
   * A Callable wrapper for DeleteFoundationModelAgreement that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteFoundationModelAgreementRequestT = Model::DeleteFoundationModelAgreementRequest>
  Model::DeleteFoundationModelAgreementOutcomeCallable DeleteFoundationModelAgreementCallable(
      const DeleteFoundationModelAgreementRequestT& request) const {
    return SubmitCallable(&BedrockClient::DeleteFoundationModelAgreement, request);
  }

  /**
   * An Async wrapper for DeleteFoundationModelAgreement that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteFoundationModelAgreementRequestT = Model::DeleteFoundationModelAgreementRequest>
  void DeleteFoundationModelAgreementAsync(const DeleteFoundationModelAgreementRequestT& request,
                                           const DeleteFoundationModelAgreementResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteGuardrail that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteGuardrailRequestT = Model::DeleteGuardrailRequest>
  void DeleteGuardrailAsync(const DeleteGuardrailRequestT& request, const DeleteGuardrailResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteImportedModel that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteImportedModel that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteImportedModelRequestT = Model::DeleteImportedModelRequest>
  void DeleteImportedModelAsync(const DeleteImportedModelRequestT& request, const DeleteImportedModelResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteInferenceProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteInferenceProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteInferenceProfileRequestT = Model::DeleteInferenceProfileRequest>
  void DeleteInferenceProfileAsync(const DeleteInferenceProfileRequestT& request,
                                   const DeleteInferenceProfileResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteMarketplaceModelEndpointOutcome DeleteMarketplaceModelEndpoint(
      const Model::DeleteMarketplaceModelEndpointRequest& request) const;

  /**
   * A Callable wrapper for DeleteMarketplaceModelEndpoint that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteMarketplaceModelEndpointRequestT = Model::DeleteMarketplaceModelEndpointRequest>
  Model::DeleteMarketplaceModelEndpointOutcomeCallable DeleteMarketplaceModelEndpointCallable(
      const DeleteMarketplaceModelEndpointRequestT& request) const {
    return SubmitCallable(&BedrockClient::DeleteMarketplaceModelEndpoint, request);
  }

  /**
   * An Async wrapper for DeleteMarketplaceModelEndpoint that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteMarketplaceModelEndpointRequestT = Model::DeleteMarketplaceModelEndpointRequest>
  void DeleteMarketplaceModelEndpointAsync(const DeleteMarketplaceModelEndpointRequestT& request,
                                           const DeleteMarketplaceModelEndpointResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteModelInvocationLoggingConfigurationOutcome DeleteModelInvocationLoggingConfiguration(
      const Model::DeleteModelInvocationLoggingConfigurationRequest& request = {}) const;

  /**
   * A Callable wrapper for DeleteModelInvocationLoggingConfiguration that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  ...
  Model::DeleteModelInvocationLoggingConfigurationOutcomeCallable DeleteModelInvocationLoggingConfigurationCallable(
      const DeleteModelInvocationLoggingConfigurationRequestT& request = {}) const {
    return SubmitCallable(&BedrockClient::DeleteModelInvocationLoggingConfiguration, request);
  }

  /**
   * An Async wrapper for DeleteModelInvocationLoggingConfiguration that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DeleteModelInvocationLoggingConfigurationRequestT = Model::DeleteModelInvocationLoggingConfigurationRequest>
  void DeleteModelInvocationLoggingConfigurationAsync(const DeleteModelInvocationLoggingConfigurationResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for DeletePromptRouter that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeletePromptRouter that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeletePromptRouterRequestT = Model::DeletePromptRouterRequest>
  void DeletePromptRouterAsync(const DeletePromptRouterRequestT& request, const DeletePromptRouterResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteProvisionedModelThroughputOutcome DeleteProvisionedModelThroughput(
      const Model::DeleteProvisionedModelThroughputRequest& request) const;

  /**
   * A Callable wrapper for DeleteProvisionedModelThroughput that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DeleteProvisionedModelThroughputRequestT = Model::DeleteProvisionedModelThroughputRequest>
  Model::DeleteProvisionedModelThroughputOutcomeCallable DeleteProvisionedModelThroughputCallable(
      const DeleteProvisionedModelThroughputRequestT& request) const {
    return SubmitCallable(&BedrockClient::DeleteProvisionedModelThroughput, request);
  }

  /**
   * An Async wrapper for DeleteProvisionedModelThroughput that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteProvisionedModelThroughputRequestT = Model::DeleteProvisionedModelThroughputRequest>
  void DeleteProvisionedModelThroughputAsync(const DeleteProvisionedModelThroughputRequestT& request,
                                             const DeleteProvisionedModelThroughputResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeregisterMarketplaceModelEndpointOutcome DeregisterMarketplaceModelEndpoint(
      const Model::DeregisterMarketplaceModelEndpointRequest& request) const;

  /**
   * A Callable wrapper for DeregisterMarketplaceModelEndpoint that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DeregisterMarketplaceModelEndpointRequestT = Model::DeregisterMarketplaceModelEndpointRequest>
  Model::DeregisterMarketplaceModelEndpointOutcomeCallable DeregisterMarketplaceModelEndpointCallable(
      const DeregisterMarketplaceModelEndpointRequestT& request) const {
    return SubmitCallable(&BedrockClient::DeregisterMarketplaceModelEndpoint, request);
  }

  /**
   * An Async wrapper for DeregisterMarketplaceModelEndpoint that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeregisterMarketplaceModelEndpointRequestT = Model::DeregisterMarketplaceModelEndpointRequest>
  void DeregisterMarketplaceModelEndpointAsync(const DeregisterMarketplaceModelEndpointRequestT& request,
                                               const DeregisterMarketplaceModelEndpointResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ExportAutomatedReasoningPolicyVersionOutcome ExportAutomatedReasoningPolicyVersion(
      const Model::ExportAutomatedReasoningPolicyVersionRequest& request) const;

  /**
   * A Callable wrapper for ExportAutomatedReasoningPolicyVersion that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ExportAutomatedReasoningPolicyVersionRequestT = Model::ExportAutomatedReasoningPolicyVersionRequest>
  Model::ExportAutomatedReasoningPolicyVersionOutcomeCallable ExportAutomatedReasoningPolicyVersionCallable(
      const ExportAutomatedReasoningPolicyVersionRequestT& request) const {
    return SubmitCallable(&BedrockClient::ExportAutomatedReasoningPolicyVersion, request);
  }

  /**
   * An Async wrapper for ExportAutomatedReasoningPolicyVersion that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ExportAutomatedReasoningPolicyVersionRequestT = Model::ExportAutomatedReasoningPolicyVersionRequest>
  void ExportAutomatedReasoningPolicyVersionAsync(const ExportAutomatedReasoningPolicyVersionRequestT& request,
                                                  const ExportAutomatedReasoningPolicyVersionResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetAutomatedReasoningPolicyOutcome GetAutomatedReasoningPolicy(
      const Model::GetAutomatedReasoningPolicyRequest& request) const;

  /**
   * A Callable wrapper for GetAutomatedReasoningPolicy that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetAutomatedReasoningPolicyRequestT = Model::GetAutomatedReasoningPolicyRequest>
  Model::GetAutomatedReasoningPolicyOutcomeCallable GetAutomatedReasoningPolicyCallable(
      const GetAutomatedReasoningPolicyRequestT& request) const {
    return SubmitCallable(&BedrockClient::GetAutomatedReasoningPolicy, request);
  }

  /**
   * An Async wrapper for GetAutomatedReasoningPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetAutomatedReasoningPolicyRequestT = Model::GetAutomatedReasoningPolicyRequest>
  void GetAutomatedReasoningPolicyAsync(const GetAutomatedReasoningPolicyRequestT& request,
                                        const GetAutomatedReasoningPolicyResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetAutomatedReasoningPolicyAnnotationsOutcome GetAutomatedReasoningPolicyAnnotations(
      const Model::GetAutomatedReasoningPolicyAnnotationsRequest& request) const;

  /**
   * A Callable wrapper for GetAutomatedReasoningPolicyAnnotations that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename GetAutomatedReasoningPolicyAnnotationsRequestT = Model::GetAutomatedReasoningPolicyAnnotationsRequest>
  Model::GetAutomatedReasoningPolicyAnnotationsOutcomeCallable GetAutomatedReasoningPolicyAnnotationsCallable(
      const GetAutomatedReasoningPolicyAnnotationsRequestT& request) const {
    return SubmitCallable(&BedrockClient::GetAutomatedReasoningPolicyAnnotations, request);
  }

  /**
   * An Async wrapper for GetAutomatedReasoningPolicyAnnotations that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetAutomatedReasoningPolicyAnnotationsRequestT = Model::GetAutomatedReasoningPolicyAnnotationsRequest>
  void GetAutomatedReasoningPolicyAnnotationsAsync(const GetAutomatedReasoningPolicyAnnotationsRequestT& request,
                                                   const GetAutomatedReasoningPolicyAnnotationsResponseReceivedHandler& handler,
                                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetAutomatedReasoningPolicyBuildWorkflowOutcome GetAutomatedReasoningPolicyBuildWorkflow(
      const Model::GetAutomatedReasoningPolicyBuildWorkflowRequest& request) const;

  /**
   * A Callable wrapper for GetAutomatedReasoningPolicyBuildWorkflow that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename GetAutomatedReasoningPolicyBuildWorkflowRequestT = Model::GetAutomatedReasoningPolicyBuildWorkflowRequest>
  Model::GetAutomatedReasoningPolicyBuildWorkflowOutcomeCallable GetAutomatedReasoningPolicyBuildWorkflowCallable(
      const GetAutomatedReasoningPolicyBuildWorkflowRequestT& request) const {
    return SubmitCallable(&BedrockClient::GetAutomatedReasoningPolicyBuildWorkflow, request);
  }

  /**
   * An Async wrapper for GetAutomatedReasoningPolicyBuildWorkflow that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetAutomatedReasoningPolicyBuildWorkflowRequestT = Model::GetAutomatedReasoningPolicyBuildWorkflowRequest>
  void GetAutomatedReasoningPolicyBuildWorkflowAsync(
      const GetAutomatedReasoningPolicyBuildWorkflowRequestT& request,
      const GetAutomatedReasoningPolicyBuildWorkflowResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetAutomatedReasoningPolicyBuildWorkflowResultAssetsOutcome GetAutomatedReasoningPolicyBuildWorkflowResultAssets(
      const Model::GetAutomatedReasoningPolicyBuildWorkflowResultAssetsRequest& request) const;

  /**
   * A Callable wrapper for GetAutomatedReasoningPolicyBuildWorkflowResultAssets that returns a future to the operation so that it can be
   * executed in parallel to other requests.
   */
  template <typename GetAutomatedReasoningPolicyBuildWorkflowResultAssetsRequestT =
                Model::GetAutomatedReasoningPolicyBuildWorkflowResultAssetsRequest>
  Model::GetAutomatedReasoningPolicyBuildWorkflowResultAssetsOutcomeCallable GetAutomatedReasoningPolicyBuildWorkflowResultAssetsCallable(
      const GetAutomatedReasoningPolicyBuildWorkflowResultAssetsRequestT& request) const {
    return SubmitCallable(&BedrockClient::GetAutomatedReasoningPolicyBuildWorkflowResultAssets, request);
  }

  /**
   * An Async wrapper for GetAutomatedReasoningPolicyBuildWorkflowResultAssets that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename GetAutomatedReasoningPolicyBuildWorkflowResultAssetsRequestT =
                Model::GetAutomatedReasoningPolicyBuildWorkflowResultAssetsRequest>
  void GetAutomatedReasoningPolicyBuildWorkflowResultAssetsAsync(
      const GetAutomatedReasoningPolicyBuildWorkflowResultAssetsRequestT& request,
      const GetAutomatedReasoningPolicyBuildWorkflowResultAssetsResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetAutomatedReasoningPolicyNextScenarioOutcome GetAutomatedReasoningPolicyNextScenario(
      const Model::GetAutomatedReasoningPolicyNextScenarioRequest& request) const;

  /**
   * A Callable wrapper for GetAutomatedReasoningPolicyNextScenario that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename GetAutomatedReasoningPolicyNextScenarioRequestT = Model::GetAutomatedReasoningPolicyNextScenarioRequest>
  Model::GetAutomatedReasoningPolicyNextScenarioOutcomeCallable GetAutomatedReasoningPolicyNextScenarioCallable(
      const GetAutomatedReasoningPolicyNextScenarioRequestT& request) const {
    return SubmitCallable(&BedrockClient::GetAutomatedReasoningPolicyNextScenario, request);
  }

  /**
   * An Async wrapper for GetAutomatedReasoningPolicyNextScenario that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetAutomatedReasoningPolicyNextScenarioRequestT = Model::GetAutomatedReasoningPolicyNextScenarioRequest>
  void GetAutomatedReasoningPolicyNextScenarioAsync(const GetAutomatedReasoningPolicyNextScenarioRequestT& request,
                                                    const GetAutomatedReasoningPolicyNextScenarioResponseReceivedHandler& handler,
                                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetAutomatedReasoningPolicyTestCaseOutcome GetAutomatedReasoningPolicyTestCase(
      const Model::GetAutomatedReasoningPolicyTestCaseRequest& request) const;

  /**
   * A Callable wrapper for GetAutomatedReasoningPolicyTestCase that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename GetAutomatedReasoningPolicyTestCaseRequestT = Model::GetAutomatedReasoningPolicyTestCaseRequest>
  Model::GetAutomatedReasoningPolicyTestCaseOutcomeCallable GetAutomatedReasoningPolicyTestCaseCallable(
      const GetAutomatedReasoningPolicyTestCaseRequestT& request) const {
    return SubmitCallable(&BedrockClient::GetAutomatedReasoningPolicyTestCase, request);
  }

  /**
   * An Async wrapper for GetAutomatedReasoningPolicyTestCase that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetAutomatedReasoningPolicyTestCaseRequestT = Model::GetAutomatedReasoningPolicyTestCaseRequest>
  void GetAutomatedReasoningPolicyTestCaseAsync(const GetAutomatedReasoningPolicyTestCaseRequestT& request,
                                                const GetAutomatedReasoningPolicyTestCaseResponseReceivedHandler& handler,
                                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetAutomatedReasoningPolicyTestResultOutcome GetAutomatedReasoningPolicyTestResult(
      const Model::GetAutomatedReasoningPolicyTestResultRequest& request) const;

  /**
   * A Callable wrapper for GetAutomatedReasoningPolicyTestResult that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename GetAutomatedReasoningPolicyTestResultRequestT = Model::GetAutomatedReasoningPolicyTestResultRequest>
  Model::GetAutomatedReasoningPolicyTestResultOutcomeCallable GetAutomatedReasoningPolicyTestResultCallable(
      const GetAutomatedReasoningPolicyTestResultRequestT& request) const {
    return SubmitCallable(&BedrockClient::GetAutomatedReasoningPolicyTestResult, request);
  }

  /**
   * An Async wrapper for GetAutomatedReasoningPolicyTestResult that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetAutomatedReasoningPolicyTestResultRequestT = Model::GetAutomatedReasoningPolicyTestResultRequest>
  void GetAutomatedReasoningPolicyTestResultAsync(const GetAutomatedReasoningPolicyTestResultRequestT& request,
                                                  const GetAutomatedReasoningPolicyTestResultResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetCustomModel that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetCustomModelRequestT = Model::GetCustomModelRequest>
  void GetCustomModelAsync(const GetCustomModelRequestT& request, const GetCustomModelResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetCustomModelDeployment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetCustomModelDeployment that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetCustomModelDeploymentRequestT = Model::GetCustomModelDeploymentRequest>
  void GetCustomModelDeploymentAsync(const GetCustomModelDeploymentRequestT& request,
                                     const GetCustomModelDeploymentResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetEvaluationJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetEvaluationJob that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetEvaluationJobRequestT = Model::GetEvaluationJobRequest>
  void GetEvaluationJobAsync(const GetEvaluationJobRequestT& request, const GetEvaluationJobResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetFoundationModel that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetFoundationModel that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetFoundationModelRequestT = Model::GetFoundationModelRequest>
  void GetFoundationModelAsync(const GetFoundationModelRequestT& request, const GetFoundationModelResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetFoundationModelAvailabilityOutcome GetFoundationModelAvailability(
      const Model::GetFoundationModelAvailabilityRequest& request) const;

  /**
   * A Callable wrapper for GetFoundationModelAvailability that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetFoundationModelAvailabilityRequestT = Model::GetFoundationModelAvailabilityRequest>
  Model::GetFoundationModelAvailabilityOutcomeCallable GetFoundationModelAvailabilityCallable(
      const GetFoundationModelAvailabilityRequestT& request) const {
    return SubmitCallable(&BedrockClient::GetFoundationModelAvailability, request);
  }

  /**
   * An Async wrapper for GetFoundationModelAvailability that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetFoundationModelAvailabilityRequestT = Model::GetFoundationModelAvailabilityRequest>
  void GetFoundationModelAvailabilityAsync(const GetFoundationModelAvailabilityRequestT& request,
                                           const GetFoundationModelAvailabilityResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetGuardrail that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetGuardrailRequestT = Model::GetGuardrailRequest>
  void GetGuardrailAsync(const GetGuardrailRequestT& request, const GetGuardrailResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetImportedModel that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetImportedModel that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetImportedModelRequestT = Model::GetImportedModelRequest>
  void GetImportedModelAsync(const GetImportedModelRequestT& request, const GetImportedModelResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetInferenceProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetInferenceProfile that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetInferenceProfileRequestT = Model::GetInferenceProfileRequest>
  void GetInferenceProfileAsync(const GetInferenceProfileRequestT& request, const GetInferenceProfileResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetMarketplaceModelEndpointOutcome GetMarketplaceModelEndpoint(
      const Model::GetMarketplaceModelEndpointRequest& request) const;

  /**
   * A Callable wrapper for GetMarketplaceModelEndpoint that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetMarketplaceModelEndpointRequestT = Model::GetMarketplaceModelEndpointRequest>
  Model::GetMarketplaceModelEndpointOutcomeCallable GetMarketplaceModelEndpointCallable(
      const GetMarketplaceModelEndpointRequestT& request) const {
    return SubmitCallable(&BedrockClient::GetMarketplaceModelEndpoint, request);
  }

  /**
   * An Async wrapper for GetMarketplaceModelEndpoint that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetMarketplaceModelEndpointRequestT = Model::GetMarketplaceModelEndpointRequest>
  void GetMarketplaceModelEndpointAsync(const GetMarketplaceModelEndpointRequestT& request,
                                        const GetMarketplaceModelEndpointResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetModelCopyJob that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetModelCopyJobRequestT = Model::GetModelCopyJobRequest>
  void GetModelCopyJobAsync(const GetModelCopyJobRequestT& request, const GetModelCopyJobResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetModelCustomizationJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetModelCustomizationJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetModelCustomizationJobRequestT = Model::GetModelCustomizationJobRequest>
  void GetModelCustomizationJobAsync(const GetModelCustomizationJobRequestT& request,
                                     const GetModelCustomizationJobResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetModelImportJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetModelImportJob that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetModelImportJobRequestT = Model::GetModelImportJobRequest>
  void GetModelImportJobAsync(const GetModelImportJobRequestT& request, const GetModelImportJobResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetModelInvocationJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetModelInvocationJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetModelInvocationJobRequestT = Model::GetModelInvocationJobRequest>
  void GetModelInvocationJobAsync(const GetModelInvocationJobRequestT& request, const GetModelInvocationJobResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetModelInvocationLoggingConfigurationOutcome GetModelInvocationLoggingConfiguration(
      const Model::GetModelInvocationLoggingConfigurationRequest& request = {}) const;

  /**
   * A Callable wrapper for GetModelInvocationLoggingConfiguration that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename GetModelInvocationLoggingConfigurationRequestT = Model::GetModelInvocationLoggingConfigurationRequest>
  Model::GetModelInvocationLoggingConfigurationOutcomeCallable GetModelInvocationLoggingConfigurationCallable(
      const GetModelInvocationLoggingConfigurationRequestT& request = {}) const {
    return SubmitCallable(&BedrockClient::GetModelInvocationLoggingConfiguration, request);
  }

  /**
   * An Async wrapper for GetModelInvocationLoggingConfiguration that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetModelInvocationLoggingConfigurationRequestT = Model::GetModelInvocationLoggingConfigurationRequest>
  void GetModelInvocationLoggingConfigurationAsync(const GetModelInvocationLoggingConfigurationResponseReceivedHandler& handler,
                                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                   const GetModelInvocationLoggingConfigurationRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetPromptRouter that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetPromptRouterRequestT = Model::GetPromptRouterRequest>
  void GetPromptRouterAsync(const GetPromptRouterRequestT& request, const GetPromptRouterResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetProvisionedModelThroughputOutcome GetProvisionedModelThroughput(
      const Model::GetProvisionedModelThroughputRequest& request) const;

  /**
   * A Callable wrapper for GetProvisionedModelThroughput that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetProvisionedModelThroughputRequestT = Model::GetProvisionedModelThroughputRequest>
  Model::GetProvisionedModelThroughputOutcomeCallable GetProvisionedModelThroughputCallable(
      const GetProvisionedModelThroughputRequestT& request) const {
    return SubmitCallable(&BedrockClient::GetProvisionedModelThroughput, request);
  }

  /**
   * An Async wrapper for GetProvisionedModelThroughput that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetProvisionedModelThroughputRequestT = Model::GetProvisionedModelThroughputRequest>
  void GetProvisionedModelThroughputAsync(const GetProvisionedModelThroughputRequestT& request,
                                          const GetProvisionedModelThroughputResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetUseCaseForModelAccess that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename GetUseCaseForModelAccessRequestT = Model::GetUseCaseForModelAccessRequest>
  Model::GetUseCaseForModelAccessOutcomeCallable GetUseCaseForModelAccessCallable(
      const GetUseCaseForModelAccessRequestT& request = {}) const {
    return SubmitCallable(&BedrockClient::GetUseCaseForModelAccess, request);
  }

  /**
   * An Async wrapper for GetUseCaseForModelAccess that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetUseCaseForModelAccessRequestT = Model::GetUseCaseForModelAccessRequest>
  void GetUseCaseForModelAccessAsync(const GetUseCaseForModelAccessResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const GetUseCaseForModelAccessRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListAutomatedReasoningPoliciesOutcome ListAutomatedReasoningPolicies(
      const Model::ListAutomatedReasoningPoliciesRequest& request = {}) const;

  /**
   * A Callable wrapper for ListAutomatedReasoningPolicies that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListAutomatedReasoningPoliciesRequestT = Model::ListAutomatedReasoningPoliciesRequest>
  Model::ListAutomatedReasoningPoliciesOutcomeCallable ListAutomatedReasoningPoliciesCallable(
      const ListAutomatedReasoningPoliciesRequestT& request = {}) const {
    return SubmitCallable(&BedrockClient::ListAutomatedReasoningPolicies, request);
  }

  /**
   * An Async wrapper for ListAutomatedReasoningPolicies that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListAutomatedReasoningPoliciesRequestT = Model::ListAutomatedReasoningPoliciesRequest>
  void ListAutomatedReasoningPoliciesAsync(const ListAutomatedReasoningPoliciesResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                           const ListAutomatedReasoningPoliciesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListAutomatedReasoningPolicyBuildWorkflowsOutcome ListAutomatedReasoningPolicyBuildWorkflows(
      const Model::ListAutomatedReasoningPolicyBuildWorkflowsRequest& request) const;

  /**
   * A Callable wrapper for ListAutomatedReasoningPolicyBuildWorkflows that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  ...
  Model::ListAutomatedReasoningPolicyBuildWorkflowsOutcomeCallable ListAutomatedReasoningPolicyBuildWorkflowsCallable(
      const ListAutomatedReasoningPolicyBuildWorkflowsRequestT& request) const {
    return SubmitCallable(&BedrockClient::ListAutomatedReasoningPolicyBuildWorkflows, request);
  }

  /**
   * An Async wrapper for ListAutomatedReasoningPolicyBuildWorkflows that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListAutomatedReasoningPolicyBuildWorkflowsRequestT = Model::ListAutomatedReasoningPolicyBuildWorkflowsRequest>
  void ListAutomatedReasoningPolicyBuildWorkflowsAsync(
      const ListAutomatedReasoningPolicyBuildWorkflowsRequestT& request,
      const ListAutomatedReasoningPolicyBuildWorkflowsResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListAutomatedReasoningPolicyTestCasesOutcome ListAutomatedReasoningPolicyTestCases(
      const Model::ListAutomatedReasoningPolicyTestCasesRequest& request) const;

  /**
   * A Callable wrapper for ListAutomatedReasoningPolicyTestCases that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListAutomatedReasoningPolicyTestCasesRequestT = Model::ListAutomatedReasoningPolicyTestCasesRequest>
  Model::ListAutomatedReasoningPolicyTestCasesOutcomeCallable ListAutomatedReasoningPolicyTestCasesCallable(
      const ListAutomatedReasoningPolicyTestCasesRequestT& request) const {
    return SubmitCallable(&BedrockClient::ListAutomatedReasoningPolicyTestCases, request);
  }

  /**
   * An Async wrapper for ListAutomatedReasoningPolicyTestCases that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListAutomatedReasoningPolicyTestCasesRequestT = Model::ListAutomatedReasoningPolicyTestCasesRequest>
  void ListAutomatedReasoningPolicyTestCasesAsync(const ListAutomatedReasoningPolicyTestCasesRequestT& request,
                                                  const ListAutomatedReasoningPolicyTestCasesResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListAutomatedReasoningPolicyTestResultsOutcome ListAutomatedReasoningPolicyTestResults(
      const Model::ListAutomatedReasoningPolicyTestResultsRequest& request) const;

  /**
   * A Callable wrapper for ListAutomatedReasoningPolicyTestResults that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListAutomatedReasoningPolicyTestResultsRequestT = Model::ListAutomatedReasoningPolicyTestResultsRequest>
  Model::ListAutomatedReasoningPolicyTestResultsOutcomeCallable ListAutomatedReasoningPolicyTestResultsCallable(
      const ListAutomatedReasoningPolicyTestResultsRequestT& request) const {
    return SubmitCallable(&BedrockClient::ListAutomatedReasoningPolicyTestResults, request);
  }

  /**
   * An Async wrapper for ListAutomatedReasoningPolicyTestResults that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListAutomatedReasoningPolicyTestResultsRequestT = Model::ListAutomatedReasoningPolicyTestResultsRequest>
  void ListAutomatedReasoningPolicyTestResultsAsync(const ListAutomatedReasoningPolicyTestResultsRequestT& request,
                                                    const ListAutomatedReasoningPolicyTestResultsResponseReceivedHandler& handler,
                                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListCustomModelDeploymentsOutcome ListCustomModelDeployments(
      const Model::ListCustomModelDeploymentsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListCustomModelDeployments that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListCustomModelDeploymentsRequestT = Model::ListCustomModelDeploymentsRequest>
  Model::ListCustomModelDeploymentsOutcomeCallable ListCustomModelDeploymentsCallable(
      const ListCustomModelDeploymentsRequestT& request = {}) const {
    return SubmitCallable(&BedrockClient::ListCustomModelDeployments, request);
  }

  /**
   * An Async wrapper for ListCustomModelDeployments that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListCustomModelDeploymentsRequestT = Model::ListCustomModelDeploymentsRequest>
  void ListCustomModelDeploymentsAsync(const ListCustomModelDeploymentsResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const ListCustomModelDeploymentsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListCustomModels that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListCustomModels that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListCustomModelsRequestT = Model::ListCustomModelsRequest>
  void ListCustomModelsAsync(const ListCustomModelsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const ListCustomModelsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListEvaluationJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListEvaluationJobs that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListEvaluationJobsRequestT = Model::ListEvaluationJobsRequest>
  void ListEvaluationJobsAsync(const ListEvaluationJobsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const ListEvaluationJobsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListFoundationModelAgreementOffersOutcome ListFoundationModelAgreementOffers(
      const Model::ListFoundationModelAgreementOffersRequest& request) const;

  /**
   * A Callable wrapper for ListFoundationModelAgreementOffers that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListFoundationModelAgreementOffersRequestT = Model::ListFoundationModelAgreementOffersRequest>
  Model::ListFoundationModelAgreementOffersOutcomeCallable ListFoundationModelAgreementOffersCallable(
      const ListFoundationModelAgreementOffersRequestT& request) const {
    return SubmitCallable(&BedrockClient::ListFoundationModelAgreementOffers, request);
  }

  /**
   * An Async wrapper for ListFoundationModelAgreementOffers that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListFoundationModelAgreementOffersRequestT = Model::ListFoundationModelAgreementOffersRequest>
  void ListFoundationModelAgreementOffersAsync(const ListFoundationModelAgreementOffersRequestT& request,
                                               const ListFoundationModelAgreementOffersResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListFoundationModels that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListFoundationModels that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListFoundationModelsRequestT = Model::ListFoundationModelsRequest>
  void ListFoundationModelsAsync(const ListFoundationModelsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const ListFoundationModelsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListGuardrails that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListGuardrailsRequestT = Model::ListGuardrailsRequest>
  void ListGuardrailsAsync(const ListGuardrailsResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const ListGuardrailsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListImportedModels that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListImportedModels that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListImportedModelsRequestT = Model::ListImportedModelsRequest>
  void ListImportedModelsAsync(const ListImportedModelsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const ListImportedModelsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListInferenceProfiles that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListInferenceProfiles that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListInferenceProfilesRequestT = Model::ListInferenceProfilesRequest>
  void ListInferenceProfilesAsync(const ListInferenceProfilesResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const ListInferenceProfilesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListMarketplaceModelEndpointsOutcome ListMarketplaceModelEndpoints(
      const Model::ListMarketplaceModelEndpointsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListMarketplaceModelEndpoints that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListMarketplaceModelEndpointsRequestT = Model::ListMarketplaceModelEndpointsRequest>
  Model::ListMarketplaceModelEndpointsOutcomeCallable ListMarketplaceModelEndpointsCallable(
      const ListMarketplaceModelEndpointsRequestT& request = {}) const {
    return SubmitCallable(&BedrockClient::ListMarketplaceModelEndpoints, request);
  }

  /**
   * An Async wrapper for ListMarketplaceModelEndpoints that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListMarketplaceModelEndpointsRequestT = Model::ListMarketplaceModelEndpointsRequest>
  void ListMarketplaceModelEndpointsAsync(const ListMarketplaceModelEndpointsResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                          const ListMarketplaceModelEndpointsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListModelCopyJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListModelCopyJobs that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListModelCopyJobsRequestT = Model::ListModelCopyJobsRequest>
  void ListModelCopyJobsAsync(const ListModelCopyJobsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const ListModelCopyJobsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListModelCustomizationJobsOutcome ListModelCustomizationJobs(
      const Model::ListModelCustomizationJobsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListModelCustomizationJobs that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListModelCustomizationJobsRequestT = Model::ListModelCustomizationJobsRequest>
  Model::ListModelCustomizationJobsOutcomeCallable ListModelCustomizationJobsCallable(
      const ListModelCustomizationJobsRequestT& request = {}) const {
    return SubmitCallable(&BedrockClient::ListModelCustomizationJobs, request);
  }

  /**
   * An Async wrapper for ListModelCustomizationJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListModelCustomizationJobsRequestT = Model::ListModelCustomizationJobsRequest>
  void ListModelCustomizationJobsAsync(const ListModelCustomizationJobsResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const ListModelCustomizationJobsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListModelImportJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListModelImportJobs that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListModelImportJobsRequestT = Model::ListModelImportJobsRequest>
  void ListModelImportJobsAsync(const ListModelImportJobsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const ListModelImportJobsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListModelInvocationJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListModelInvocationJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListModelInvocationJobsRequestT = Model::ListModelInvocationJobsRequest>
  void ListModelInvocationJobsAsync(const ListModelInvocationJobsResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const ListModelInvocationJobsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListPromptRouters that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListPromptRouters that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListPromptRoutersRequestT = Model::ListPromptRoutersRequest>
  void ListPromptRoutersAsync(const ListPromptRoutersResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const ListPromptRoutersRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListProvisionedModelThroughputsOutcome ListProvisionedModelThroughputs(
      const Model::ListProvisionedModelThroughputsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListProvisionedModelThroughputs that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListProvisionedModelThroughputsRequestT = Model::ListProvisionedModelThroughputsRequest>
  Model::ListProvisionedModelThroughputsOutcomeCallable ListProvisionedModelThroughputsCallable(
      const ListProvisionedModelThroughputsRequestT& request = {}) const {
    return SubmitCallable(&BedrockClient::ListProvisionedModelThroughputs, request);
  }

  /**
   * An Async wrapper for ListProvisionedModelThroughputs that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListProvisionedModelThroughputsRequestT = Model::ListProvisionedModelThroughputsRequest>
  void ListProvisionedModelThroughputsAsync(const ListProvisionedModelThroughputsResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                            const ListProvisionedModelThroughputsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::PutModelInvocationLoggingConfigurationOutcome PutModelInvocationLoggingConfiguration(
      const Model::PutModelInvocationLoggingConfigurationRequest& request) const;

  /**
   * A Callable wrapper for PutModelInvocationLoggingConfiguration that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename PutModelInvocationLoggingConfigurationRequestT = Model::PutModelInvocationLoggingConfigurationRequest>
  Model::PutModelInvocationLoggingConfigurationOutcomeCallable PutModelInvocationLoggingConfigurationCallable(
      const PutModelInvocationLoggingConfigurationRequestT& request) const {
    return SubmitCallable(&BedrockClient::PutModelInvocationLoggingConfiguration, request);
  }

  /**
   * An Async wrapper for PutModelInvocationLoggingConfiguration that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename PutModelInvocationLoggingConfigurationRequestT = Model::PutModelInvocationLoggingConfigurationRequest>
  void PutModelInvocationLoggingConfigurationAsync(const PutModelInvocationLoggingConfigurationRequestT& request,
  ...
  /**
   * A Callable wrapper for PutUseCaseForModelAccess that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutUseCaseForModelAccess that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutUseCaseForModelAccessRequestT = Model::PutUseCaseForModelAccessRequest>
  void PutUseCaseForModelAccessAsync(const PutUseCaseForModelAccessRequestT& request,
                                     const PutUseCaseForModelAccessResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::RegisterMarketplaceModelEndpointOutcome RegisterMarketplaceModelEndpoint(
      const Model::RegisterMarketplaceModelEndpointRequest& request) const;

  /**
   * A Callable wrapper for RegisterMarketplaceModelEndpoint that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename RegisterMarketplaceModelEndpointRequestT = Model::RegisterMarketplaceModelEndpointRequest>
  Model::RegisterMarketplaceModelEndpointOutcomeCallable RegisterMarketplaceModelEndpointCallable(
      const RegisterMarketplaceModelEndpointRequestT& request) const {
    return SubmitCallable(&BedrockClient::RegisterMarketplaceModelEndpoint, request);
  }

  /**
   * An Async wrapper for RegisterMarketplaceModelEndpoint that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename RegisterMarketplaceModelEndpointRequestT = Model::RegisterMarketplaceModelEndpointRequest>
  void RegisterMarketplaceModelEndpointAsync(const RegisterMarketplaceModelEndpointRequestT& request,
                                             const RegisterMarketplaceModelEndpointResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartAutomatedReasoningPolicyBuildWorkflowOutcome StartAutomatedReasoningPolicyBuildWorkflow(
      const Model::StartAutomatedReasoningPolicyBuildWorkflowRequest& request) const;

  /**
   * A Callable wrapper for StartAutomatedReasoningPolicyBuildWorkflow that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  ...
  Model::StartAutomatedReasoningPolicyBuildWorkflowOutcomeCallable StartAutomatedReasoningPolicyBuildWorkflowCallable(
      const StartAutomatedReasoningPolicyBuildWorkflowRequestT& request) const {
    return SubmitCallable(&BedrockClient::StartAutomatedReasoningPolicyBuildWorkflow, request);
  }

  /**
   * An Async wrapper for StartAutomatedReasoningPolicyBuildWorkflow that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename StartAutomatedReasoningPolicyBuildWorkflowRequestT = Model::StartAutomatedReasoningPolicyBuildWorkflowRequest>
  void StartAutomatedReasoningPolicyBuildWorkflowAsync(
      const StartAutomatedReasoningPolicyBuildWorkflowRequestT& request,
      const StartAutomatedReasoningPolicyBuildWorkflowResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartAutomatedReasoningPolicyTestWorkflowOutcome StartAutomatedReasoningPolicyTestWorkflow(
      const Model::StartAutomatedReasoningPolicyTestWorkflowRequest& request) const;

  /**
   * A Callable wrapper for StartAutomatedReasoningPolicyTestWorkflow that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  ...
  Model::StartAutomatedReasoningPolicyTestWorkflowOutcomeCallable StartAutomatedReasoningPolicyTestWorkflowCallable(
      const StartAutomatedReasoningPolicyTestWorkflowRequestT& request) const {
    return SubmitCallable(&BedrockClient::StartAutomatedReasoningPolicyTestWorkflow, request);
  }

  /**
   * An Async wrapper for StartAutomatedReasoningPolicyTestWorkflow that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename StartAutomatedReasoningPolicyTestWorkflowRequestT = Model::StartAutomatedReasoningPolicyTestWorkflowRequest>
  void StartAutomatedReasoningPolicyTestWorkflowAsync(
      const StartAutomatedReasoningPolicyTestWorkflowRequestT& request,
  ...
  /**
   * A Callable wrapper for StopEvaluationJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopEvaluationJob that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StopEvaluationJobRequestT = Model::StopEvaluationJobRequest>
  void StopEvaluationJobAsync(const StopEvaluationJobRequestT& request, const StopEvaluationJobResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StopModelCustomizationJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename StopModelCustomizationJobRequestT = Model::StopModelCustomizationJobRequest>
  Model::StopModelCustomizationJobOutcomeCallable StopModelCustomizationJobCallable(
      const StopModelCustomizationJobRequestT& request) const {
    return SubmitCallable(&BedrockClient::StopModelCustomizationJob, request);
  }

  /**
   * An Async wrapper for StopModelCustomizationJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StopModelCustomizationJobRequestT = Model::StopModelCustomizationJobRequest>
  void StopModelCustomizationJobAsync(const StopModelCustomizationJobRequestT& request,
                                      const StopModelCustomizationJobResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StopModelInvocationJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopModelInvocationJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StopModelInvocationJobRequestT = Model::StopModelInvocationJobRequest>
  void StopModelInvocationJobAsync(const StopModelInvocationJobRequestT& request,
                                   const StopModelInvocationJobResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateAutomatedReasoningPolicyOutcome UpdateAutomatedReasoningPolicy(
      const Model::UpdateAutomatedReasoningPolicyRequest& request) const;

  /**
   * A Callable wrapper for UpdateAutomatedReasoningPolicy that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateAutomatedReasoningPolicyRequestT = Model::UpdateAutomatedReasoningPolicyRequest>
  Model::UpdateAutomatedReasoningPolicyOutcomeCallable UpdateAutomatedReasoningPolicyCallable(
      const UpdateAutomatedReasoningPolicyRequestT& request) const {
    return SubmitCallable(&BedrockClient::UpdateAutomatedReasoningPolicy, request);
  }

  /**
   * An Async wrapper for UpdateAutomatedReasoningPolicy that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateAutomatedReasoningPolicyRequestT = Model::UpdateAutomatedReasoningPolicyRequest>
  void UpdateAutomatedReasoningPolicyAsync(const UpdateAutomatedReasoningPolicyRequestT& request,
                                           const UpdateAutomatedReasoningPolicyResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateAutomatedReasoningPolicyAnnotationsOutcome UpdateAutomatedReasoningPolicyAnnotations(
      const Model::UpdateAutomatedReasoningPolicyAnnotationsRequest& request) const;

  /**
   * A Callable wrapper for UpdateAutomatedReasoningPolicyAnnotations that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  ...
  Model::UpdateAutomatedReasoningPolicyAnnotationsOutcomeCallable UpdateAutomatedReasoningPolicyAnnotationsCallable(
      const UpdateAutomatedReasoningPolicyAnnotationsRequestT& request) const {
    return SubmitCallable(&BedrockClient::UpdateAutomatedReasoningPolicyAnnotations, request);
  }

  /**
   * An Async wrapper for UpdateAutomatedReasoningPolicyAnnotations that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename UpdateAutomatedReasoningPolicyAnnotationsRequestT = Model::UpdateAutomatedReasoningPolicyAnnotationsRequest>
  void UpdateAutomatedReasoningPolicyAnnotationsAsync(
      const UpdateAutomatedReasoningPolicyAnnotationsRequestT& request,
      const UpdateAutomatedReasoningPolicyAnnotationsResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateAutomatedReasoningPolicyTestCaseOutcome UpdateAutomatedReasoningPolicyTestCase(
      const Model::UpdateAutomatedReasoningPolicyTestCaseRequest& request) const;

  /**
   * A Callable wrapper for UpdateAutomatedReasoningPolicyTestCase that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename UpdateAutomatedReasoningPolicyTestCaseRequestT = Model::UpdateAutomatedReasoningPolicyTestCaseRequest>
  Model::UpdateAutomatedReasoningPolicyTestCaseOutcomeCallable UpdateAutomatedReasoningPolicyTestCaseCallable(
      const UpdateAutomatedReasoningPolicyTestCaseRequestT& request) const {
    return SubmitCallable(&BedrockClient::UpdateAutomatedReasoningPolicyTestCase, request);
  }

  /**
   * An Async wrapper for UpdateAutomatedReasoningPolicyTestCase that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename UpdateAutomatedReasoningPolicyTestCaseRequestT = Model::UpdateAutomatedReasoningPolicyTestCaseRequest>
  void UpdateAutomatedReasoningPolicyTestCaseAsync(const UpdateAutomatedReasoningPolicyTestCaseRequestT& request,
                                                   const UpdateAutomatedReasoningPolicyTestCaseResponseReceivedHandler& handler,
                                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateGuardrail that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateGuardrailRequestT = Model::UpdateGuardrailRequest>
  void UpdateGuardrailAsync(const UpdateGuardrailRequestT& request, const UpdateGuardrailResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateMarketplaceModelEndpointOutcome UpdateMarketplaceModelEndpoint(
      const Model::UpdateMarketplaceModelEndpointRequest& request) const;

  /**
   * A Callable wrapper for UpdateMarketplaceModelEndpoint that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateMarketplaceModelEndpointRequestT = Model::UpdateMarketplaceModelEndpointRequest>
  Model::UpdateMarketplaceModelEndpointOutcomeCallable UpdateMarketplaceModelEndpointCallable(
      const UpdateMarketplaceModelEndpointRequestT& request) const {
    return SubmitCallable(&BedrockClient::UpdateMarketplaceModelEndpoint, request);
  }

  /**
   * An Async wrapper for UpdateMarketplaceModelEndpoint that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateMarketplaceModelEndpointRequestT = Model::UpdateMarketplaceModelEndpointRequest>
  void UpdateMarketplaceModelEndpointAsync(const UpdateMarketplaceModelEndpointRequestT& request,
                                           const UpdateMarketplaceModelEndpointResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateProvisionedModelThroughputOutcome UpdateProvisionedModelThroughput(
      const Model::UpdateProvisionedModelThroughputRequest& request) const;

  /**
   * A Callable wrapper for UpdateProvisionedModelThroughput that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename UpdateProvisionedModelThroughputRequestT = Model::UpdateProvisionedModelThroughputRequest>
  Model::UpdateProvisionedModelThroughputOutcomeCallable UpdateProvisionedModelThroughputCallable(
      const UpdateProvisionedModelThroughputRequestT& request) const {
    return SubmitCallable(&BedrockClient::UpdateProvisionedModelThroughput, request);
  }

  /**
   * An Async wrapper for UpdateProvisionedModelThroughput that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateProvisionedModelThroughputRequestT = Model::UpdateProvisionedModelThroughputRequest>
  void UpdateProvisionedModelThroughputAsync(const UpdateProvisionedModelThroughputRequestT& request,
                                             const UpdateProvisionedModelThroughputResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
