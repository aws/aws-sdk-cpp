...
Aws::String ListAdvancedPromptOptimizationJobsRequest::SerializePayload() const { return {}; }

void ListAdvancedPromptOptimizationJobsRequest::AddQueryStringParameters(URI& uri) const {
  Aws::StringStream ss;
