...
AutomatedEvaluationConfig::AutomatedEvaluationConfig(JsonView jsonValue) { *this = jsonValue; }
...
AutomatedEvaluationConfig& AutomatedEvaluationConfig::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("datasetMetricConfigs")) {
    ...
    for (unsigned datasetMetricConfigsIndex = 0; datasetMetricConfigsIndex < datasetMetricConfigsJsonList.GetLength();
         ++datasetMetricConfigsIndex) {
