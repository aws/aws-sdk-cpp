...
EvaluationRagConfigSummary::EvaluationRagConfigSummary(JsonView jsonValue) { *this = jsonValue; }
...
EvaluationRagConfigSummary& EvaluationRagConfigSummary::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("bedrockKnowledgeBaseIdentifiers")) {
    ...
    for (unsigned bedrockKnowledgeBaseIdentifiersIndex = 0;
         bedrockKnowledgeBaseIdentifiersIndex < bedrockKnowledgeBaseIdentifiersJsonList.GetLength();
         ++bedrockKnowledgeBaseIdentifiersIndex) {
  ...
  if (jsonValue.ValueExists("precomputedRagSourceIdentifiers")) {
    ...
    for (unsigned precomputedRagSourceIdentifiersIndex = 0;
         precomputedRagSourceIdentifiersIndex < precomputedRagSourceIdentifiersJsonList.GetLength();
         ++precomputedRagSourceIdentifiersIndex) {
...
JsonValue EvaluationRagConfigSummary::Jsonize() const {
  ...
  if (m_bedrockKnowledgeBaseIdentifiersHasBeenSet) {
    ...
    for (unsigned bedrockKnowledgeBaseIdentifiersIndex = 0;
         bedrockKnowledgeBaseIdentifiersIndex < bedrockKnowledgeBaseIdentifiersJsonList.GetLength();
         ++bedrockKnowledgeBaseIdentifiersIndex) {
      bedrockKnowledgeBaseIdentifiersJsonList[bedrockKnowledgeBaseIdentifiersIndex].AsString(
          m_bedrockKnowledgeBaseIdentifiers[bedrockKnowledgeBaseIdentifiersIndex]);
    }
  ...
  if (m_precomputedRagSourceIdentifiersHasBeenSet) {
    ...
    for (unsigned precomputedRagSourceIdentifiersIndex = 0;
         precomputedRagSourceIdentifiersIndex < precomputedRagSourceIdentifiersJsonList.GetLength();
         ++precomputedRagSourceIdentifiersIndex) {
      precomputedRagSourceIdentifiersJsonList[precomputedRagSourceIdentifiersIndex].AsString(
          m_precomputedRagSourceIdentifiers[precomputedRagSourceIdentifiersIndex]);
    }
