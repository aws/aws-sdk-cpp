...
ListModelInvocationJobsResult::ListModelInvocationJobsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListModelInvocationJobsResult& ListModelInvocationJobsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("invocationJobSummaries")) {
    ...
    for (unsigned invocationJobSummariesIndex = 0; invocationJobSummariesIndex < invocationJobSummariesJsonList.GetLength();
         ++invocationJobSummariesIndex) {
