...
ListModelCustomizationJobsResult::ListModelCustomizationJobsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListModelCustomizationJobsResult& ListModelCustomizationJobsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("modelCustomizationJobSummaries")) {
    ...
    for (unsigned modelCustomizationJobSummariesIndex = 0;
         modelCustomizationJobSummariesIndex < modelCustomizationJobSummariesJsonList.GetLength(); ++modelCustomizationJobSummariesIndex) {
