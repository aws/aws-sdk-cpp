...
AutomatedReasoningPolicyVariableReport::AutomatedReasoningPolicyVariableReport(JsonView jsonValue) { *this = jsonValue; }

AutomatedReasoningPolicyVariableReport& AutomatedReasoningPolicyVariableReport::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("policyVariable")) {
    m_policyVariable = jsonValue.GetString("policyVariable");
...
JsonValue AutomatedReasoningPolicyVariableReport::Jsonize() const {
  JsonValue payload;

  if (m_policyVariableHasBeenSet) {
    payload.WithString("policyVariable", m_policyVariable);
  }
