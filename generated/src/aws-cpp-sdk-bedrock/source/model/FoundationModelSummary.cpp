...
FoundationModelSummary::FoundationModelSummary(JsonView jsonValue) { *this = jsonValue; }

FoundationModelSummary& FoundationModelSummary::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("outputModalities")) {
    ...
    for (unsigned outputModalitiesIndex = 0; outputModalitiesIndex < outputModalitiesJsonList.GetLength(); ++outputModalitiesIndex) {
      m_outputModalities.push_back(
          ModelModalityMapper::GetModelModalityForName(outputModalitiesJsonList[outputModalitiesIndex].AsString()));
    }
  ...
  if (jsonValue.ValueExists("customizationsSupported")) {
    ...
    for (unsigned customizationsSupportedIndex = 0; customizationsSupportedIndex < customizationsSupportedJsonList.GetLength();
         ++customizationsSupportedIndex) {
      m_customizationsSupported.push_back(
          ModelCustomizationMapper::GetModelCustomizationForName(customizationsSupportedJsonList[customizationsSupportedIndex].AsString()));
    }
  ...
  if (jsonValue.ValueExists("inferenceTypesSupported")) {
    ...
    for (unsigned inferenceTypesSupportedIndex = 0; inferenceTypesSupportedIndex < inferenceTypesSupportedJsonList.GetLength();
         ++inferenceTypesSupportedIndex) {
      m_inferenceTypesSupported.push_back(
          InferenceTypeMapper::GetInferenceTypeForName(inferenceTypesSupportedJsonList[inferenceTypesSupportedIndex].AsString()));
    }
...
JsonValue FoundationModelSummary::Jsonize() const {
  JsonValue payload;
  ...
  if (m_inputModalitiesHasBeenSet) {
    ...
    for (unsigned inputModalitiesIndex = 0; inputModalitiesIndex < inputModalitiesJsonList.GetLength(); ++inputModalitiesIndex) {
      inputModalitiesJsonList[inputModalitiesIndex].AsString(
          ModelModalityMapper::GetNameForModelModality(m_inputModalities[inputModalitiesIndex]));
    }
  ...
  if (m_outputModalitiesHasBeenSet) {
    ...
    for (unsigned outputModalitiesIndex = 0; outputModalitiesIndex < outputModalitiesJsonList.GetLength(); ++outputModalitiesIndex) {
      outputModalitiesJsonList[outputModalitiesIndex].AsString(
          ModelModalityMapper::GetNameForModelModality(m_outputModalities[outputModalitiesIndex]));
    }
  ...
  if (m_customizationsSupportedHasBeenSet) {
    ...
    for (unsigned customizationsSupportedIndex = 0; customizationsSupportedIndex < customizationsSupportedJsonList.GetLength();
         ++customizationsSupportedIndex) {
      customizationsSupportedJsonList[customizationsSupportedIndex].AsString(
          ModelCustomizationMapper::GetNameForModelCustomization(m_customizationsSupported[customizationsSupportedIndex]));
    }
  ...
  if (m_inferenceTypesSupportedHasBeenSet) {
    ...
    for (unsigned inferenceTypesSupportedIndex = 0; inferenceTypesSupportedIndex < inferenceTypesSupportedJsonList.GetLength();
         ++inferenceTypesSupportedIndex) {
      inferenceTypesSupportedJsonList[inferenceTypesSupportedIndex].AsString(
          InferenceTypeMapper::GetNameForInferenceType(m_inferenceTypesSupported[inferenceTypesSupportedIndex]));
    }
