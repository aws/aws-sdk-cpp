...
ValidationDetails::ValidationDetails(JsonView jsonValue) { *this = jsonValue; }

ValidationDetails& ValidationDetails::operator=(JsonView jsonValue) {
...
JsonValue ValidationDetails::Jsonize() const {
  JsonValue payload;
