...
Aws::String ListProvisionedModelThroughputsRequest::SerializePayload() const { return {}; }

void ListProvisionedModelThroughputsRequest::AddQueryStringParameters(URI& uri) const {
  Aws::StringStream ss;
  ...
  if (m_statusEqualsHasBeenSet) {
    ss << ProvisionedModelStatusMapper::GetNameForProvisionedModelStatus(m_statusEquals);
  ...
  if (m_sortByHasBeenSet) {
    ss << SortByProvisionedModelsMapper::GetNameForSortByProvisionedModels(m_sortBy);
