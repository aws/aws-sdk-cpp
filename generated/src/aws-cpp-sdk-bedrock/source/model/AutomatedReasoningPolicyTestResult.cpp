...
AutomatedReasoningPolicyTestResult::AutomatedReasoningPolicyTestResult(JsonView jsonValue) { *this = jsonValue; }
...
AutomatedReasoningPolicyTestResult& AutomatedReasoningPolicyTestResult::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("testRunStatus")) {
    m_testRunStatus =
        AutomatedReasoningPolicyTestRunStatusMapper::GetAutomatedReasoningPolicyTestRunStatusForName(jsonValue.GetString("testRunStatus"));
  ...
  if (jsonValue.ValueExists("testRunResult")) {
    m_testRunResult =
        AutomatedReasoningPolicyTestRunResultMapper::GetAutomatedReasoningPolicyTestRunResultForName(jsonValue.GetString("testRunResult"));
    m_testRunResultHasBeenSet = true;
  }
  if (jsonValue.ValueExists("aggregatedTestFindingsResult")) {
    m_aggregatedTestFindingsResult =
        AutomatedReasoningCheckResultMapper::GetAutomatedReasoningCheckResultForName(jsonValue.GetString("aggregatedTestFindingsResult"));
...
JsonValue AutomatedReasoningPolicyTestResult::Jsonize() const {
  ...
  if (m_testRunStatusHasBeenSet) {
    payload.WithString("testRunStatus",
                       AutomatedReasoningPolicyTestRunStatusMapper::GetNameForAutomatedReasoningPolicyTestRunStatus(m_testRunStatus));
  }
  ...
  if (m_testRunResultHasBeenSet) {
    payload.WithString("testRunResult",
                       AutomatedReasoningPolicyTestRunResultMapper::GetNameForAutomatedReasoningPolicyTestRunResult(m_testRunResult));
  }

  if (m_aggregatedTestFindingsResultHasBeenSet) {
    payload.WithString("aggregatedTestFindingsResult",
                       AutomatedReasoningCheckResultMapper::GetNameForAutomatedReasoningCheckResult(m_aggregatedTestFindingsResult));
  }
