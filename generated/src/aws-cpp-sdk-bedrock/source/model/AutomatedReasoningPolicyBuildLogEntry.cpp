...
AutomatedReasoningPolicyBuildLogEntry::AutomatedReasoningPolicyBuildLogEntry(JsonView jsonValue) { *this = jsonValue; }
...
AutomatedReasoningPolicyBuildLogEntry& AutomatedReasoningPolicyBuildLogEntry::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("status")) {
    m_status =
        AutomatedReasoningPolicyAnnotationStatusMapper::GetAutomatedReasoningPolicyAnnotationStatusForName(jsonValue.GetString("status"));
...
JsonValue AutomatedReasoningPolicyBuildLogEntry::Jsonize() const {
  ...
  if (m_statusHasBeenSet) {
    payload.WithString("status",
                       AutomatedReasoningPolicyAnnotationStatusMapper::GetNameForAutomatedReasoningPolicyAnnotationStatus(m_status));
  }
