...
EvaluationModelConfigSummary::EvaluationModelConfigSummary(JsonView jsonValue) { *this = jsonValue; }
...
EvaluationModelConfigSummary& EvaluationModelConfigSummary::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("bedrockModelIdentifiers")) {
    ...
    for (unsigned bedrockModelIdentifiersIndex = 0; bedrockModelIdentifiersIndex < bedrockModelIdentifiersJsonList.GetLength();
         ++bedrockModelIdentifiersIndex) {
  ...
  if (jsonValue.ValueExists("precomputedInferenceSourceIdentifiers")) {
    ...
    for (unsigned precomputedInferenceSourceIdentifiersIndex = 0;
         precomputedInferenceSourceIdentifiersIndex < precomputedInferenceSourceIdentifiersJsonList.GetLength();
         ++precomputedInferenceSourceIdentifiersIndex) {
      m_precomputedInferenceSourceIdentifiers.push_back(
          precomputedInferenceSourceIdentifiersJsonList[precomputedInferenceSourceIdentifiersIndex].AsString());
    }
...
JsonValue EvaluationModelConfigSummary::Jsonize() const {
  ...
  if (m_precomputedInferenceSourceIdentifiersHasBeenSet) {
    ...
    for (unsigned precomputedInferenceSourceIdentifiersIndex = 0;
         ...
         ++precomputedInferenceSourceIdentifiersIndex) {
      precomputedInferenceSourceIdentifiersJsonList[precomputedInferenceSourceIdentifiersIndex].AsString(
          m_precomputedInferenceSourceIdentifiers[precomputedInferenceSourceIdentifiersIndex]);
    }
