...
EvaluationSummary& EvaluationSummary::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("evaluationTaskTypes")) {
    ...
    for (unsigned evaluationTaskTypesIndex = 0; evaluationTaskTypesIndex < evaluationTaskTypesJsonList.GetLength();
         ++evaluationTaskTypesIndex) {
      m_evaluationTaskTypes.push_back(
          EvaluationTaskTypeMapper::GetEvaluationTaskTypeForName(evaluationTaskTypesJsonList[evaluationTaskTypesIndex].AsString()));
    }
  ...
  if (jsonValue.ValueExists("evaluatorModelIdentifiers")) {
    ...
    for (unsigned evaluatorModelIdentifiersIndex = 0; evaluatorModelIdentifiersIndex < evaluatorModelIdentifiersJsonList.GetLength();
         ++evaluatorModelIdentifiersIndex) {
  ...
  if (jsonValue.ValueExists("customMetricsEvaluatorModelIdentifiers")) {
    Aws::Utils::Array<JsonView> customMetricsEvaluatorModelIdentifiersJsonList =
        jsonValue.GetArray("customMetricsEvaluatorModelIdentifiers");
    for (unsigned customMetricsEvaluatorModelIdentifiersIndex = 0;
         customMetricsEvaluatorModelIdentifiersIndex < customMetricsEvaluatorModelIdentifiersJsonList.GetLength();
         ++customMetricsEvaluatorModelIdentifiersIndex) {
      m_customMetricsEvaluatorModelIdentifiers.push_back(
          customMetricsEvaluatorModelIdentifiersJsonList[customMetricsEvaluatorModelIdentifiersIndex].AsString());
    }
...
JsonValue EvaluationSummary::Jsonize() const {
  ...
  if (m_evaluationTaskTypesHasBeenSet) {
    ...
    for (unsigned evaluationTaskTypesIndex = 0; evaluationTaskTypesIndex < evaluationTaskTypesJsonList.GetLength();
         ++evaluationTaskTypesIndex) {
      evaluationTaskTypesJsonList[evaluationTaskTypesIndex].AsString(
          EvaluationTaskTypeMapper::GetNameForEvaluationTaskType(m_evaluationTaskTypes[evaluationTaskTypesIndex]));
    }
  ...
  if (m_evaluatorModelIdentifiersHasBeenSet) {
    ...
    for (unsigned evaluatorModelIdentifiersIndex = 0; evaluatorModelIdentifiersIndex < evaluatorModelIdentifiersJsonList.GetLength();
         ++evaluatorModelIdentifiersIndex) {
      evaluatorModelIdentifiersJsonList[evaluatorModelIdentifiersIndex].AsString(
          m_evaluatorModelIdentifiers[evaluatorModelIdentifiersIndex]);
    }
  ...
  if (m_customMetricsEvaluatorModelIdentifiersHasBeenSet) {
    ...
    for (unsigned customMetricsEvaluatorModelIdentifiersIndex = 0;
         ...
         ++customMetricsEvaluatorModelIdentifiersIndex) {
      customMetricsEvaluatorModelIdentifiersJsonList[customMetricsEvaluatorModelIdentifiersIndex].AsString(
          m_customMetricsEvaluatorModelIdentifiers[customMetricsEvaluatorModelIdentifiersIndex]);
    }
