...
GetAutomatedReasoningPolicyBuildWorkflowResult::GetAutomatedReasoningPolicyBuildWorkflowResult(
    const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

GetAutomatedReasoningPolicyBuildWorkflowResult& GetAutomatedReasoningPolicyBuildWorkflowResult::operator=(
    const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("status")) {
    m_status = AutomatedReasoningPolicyBuildWorkflowStatusMapper::GetAutomatedReasoningPolicyBuildWorkflowStatusForName(
        jsonValue.GetString("status"));
    m_statusHasBeenSet = true;
  }
  if (jsonValue.ValueExists("buildWorkflowType")) {
    m_buildWorkflowType = AutomatedReasoningPolicyBuildWorkflowTypeMapper::GetAutomatedReasoningPolicyBuildWorkflowTypeForName(
        jsonValue.GetString("buildWorkflowType"));
