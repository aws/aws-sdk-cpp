...
ListProvisionedModelThroughputsResult& ListProvisionedModelThroughputsResult::operator=(
  ...
  if (jsonValue.ValueExists("provisionedModelSummaries")) {
    ...
    for (unsigned provisionedModelSummariesIndex = 0; provisionedModelSummariesIndex < provisionedModelSummariesJsonList.GetLength();
         ++provisionedModelSummariesIndex) {
      m_provisionedModelSummaries.push_back(provisionedModelSummariesJsonList[provisionedModelSummariesIndex].AsObject());
    }
    m_provisionedModelSummariesHasBeenSet = true;
  }
