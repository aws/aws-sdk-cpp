...
ListModelImportJobsResult::ListModelImportJobsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListModelImportJobsResult& ListModelImportJobsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("modelImportJobSummaries")) {
    ...
    for (unsigned modelImportJobSummariesIndex = 0; modelImportJobSummariesIndex < modelImportJobSummariesJsonList.GetLength();
         ++modelImportJobSummariesIndex) {
