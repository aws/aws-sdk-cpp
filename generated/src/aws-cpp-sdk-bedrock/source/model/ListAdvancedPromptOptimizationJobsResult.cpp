...
ListAdvancedPromptOptimizationJobsResult::ListAdvancedPromptOptimizationJobsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

ListAdvancedPromptOptimizationJobsResult& ListAdvancedPromptOptimizationJobsResult::operator=(
