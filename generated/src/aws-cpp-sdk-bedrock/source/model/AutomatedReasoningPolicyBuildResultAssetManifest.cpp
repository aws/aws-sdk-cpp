...
AutomatedReasoningPolicyBuildResultAssetManifest::AutomatedReasoningPolicyBuildResultAssetManifest(JsonView jsonValue) {
  *this = jsonValue;
}

AutomatedReasoningPolicyBuildResultAssetManifest& AutomatedReasoningPolicyBuildResultAssetManifest::operator=(JsonView jsonValue) {
...
JsonValue AutomatedReasoningPolicyBuildResultAssetManifest::Jsonize() const {
  JsonValue payload;
