...
ImplicitFilterConfiguration::ImplicitFilterConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
ImplicitFilterConfiguration& ImplicitFilterConfiguration::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("metadataAttributes")) {
    ...
    for (unsigned metadataAttributesIndex = 0; metadataAttributesIndex < metadataAttributesJsonList.GetLength();
         ++metadataAttributesIndex) {
