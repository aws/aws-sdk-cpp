...
AutomatedReasoningCheckTranslationAmbiguousFinding::AutomatedReasoningCheckTranslationAmbiguousFinding(JsonView jsonValue) {
  *this = jsonValue;
}

AutomatedReasoningCheckTranslationAmbiguousFinding& AutomatedReasoningCheckTranslationAmbiguousFinding::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("differenceScenarios")) {
    ...
    for (unsigned differenceScenariosIndex = 0; differenceScenariosIndex < differenceScenariosJsonList.GetLength();
         ++differenceScenariosIndex) {
...
JsonValue AutomatedReasoningCheckTranslationAmbiguousFinding::Jsonize() const {
  JsonValue payload;
