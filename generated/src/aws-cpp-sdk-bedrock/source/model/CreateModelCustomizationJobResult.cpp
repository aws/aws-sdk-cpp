...
CreateModelCustomizationJobResult::CreateModelCustomizationJobResult()
{
}

CreateModelCustomizationJobResult::CreateModelCustomizationJobResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
