...
class ExportErrorDetails {
 public:
  ...
  void SetExportResults(ExportResultsT&& value) {
    ...
    m_exportResults = std::forward<ExportResultsT>(value);
  }
  template <typename ExportResultsT = ExportErrorDetailsOutput>
  ExportErrorDetails& WithExportResults(ExportResultsT&& value) {
    SetExportResults(std::forward<ExportResultsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExportSourceImages(ExportSourceImagesT&& value) {
    ...
    m_exportSourceImages = std::forward<ExportSourceImagesT>(value);
  }
  template <typename ExportSourceImagesT = ExportErrorDetailsOutput>
  ExportErrorDetails& WithExportSourceImages(ExportSourceImagesT&& value) {
    SetExportSourceImages(std::forward<ExportSourceImagesT>(value));
    return *this;
  }
  ///@}
 private:
