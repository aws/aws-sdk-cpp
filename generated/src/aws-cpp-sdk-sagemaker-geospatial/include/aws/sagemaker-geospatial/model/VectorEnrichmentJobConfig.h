...
class VectorEnrichmentJobConfig {
 public:
  ...
  void SetMapMatchingConfig(MapMatchingConfigT&& value) {
    ...
    m_mapMatchingConfig = std::forward<MapMatchingConfigT>(value);
  }
  template <typename MapMatchingConfigT = MapMatchingConfig>
  VectorEnrichmentJobConfig& WithMapMatchingConfig(MapMatchingConfigT&& value) {
    SetMapMatchingConfig(std::forward<MapMatchingConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReverseGeocodingConfig(ReverseGeocodingConfigT&& value) {
    ...
    m_reverseGeocodingConfig = std::forward<ReverseGeocodingConfigT>(value);
  }
  template <typename ReverseGeocodingConfigT = ReverseGeocodingConfig>
  VectorEnrichmentJobConfig& WithReverseGeocodingConfig(ReverseGeocodingConfigT&& value) {
    SetReverseGeocodingConfig(std::forward<ReverseGeocodingConfigT>(value));
    return *this;
  }
  ///@}
 private:
