...
class TemporalStatisticsConfigInput {
 public:
  ...
  inline void SetGroupBy(GroupBy value) {
    m_groupByHasBeenSet = true;
    m_groupBy = value;
  }
  inline TemporalStatisticsConfigInput& WithGroupBy(GroupBy value) {
    SetGroupBy(value);
    return *this;
  }
  ///@}
  ...
  inline TemporalStatisticsConfigInput& AddStatistics(TemporalStatistics value) {
    m_statisticsHasBeenSet = true;
