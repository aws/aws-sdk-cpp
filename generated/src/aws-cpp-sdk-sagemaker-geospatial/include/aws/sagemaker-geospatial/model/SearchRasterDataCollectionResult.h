...
class SearchRasterDataCollectionResult {
 public:
  ...
  AWS_SAGEMAKERGEOSPATIAL_API SearchRasterDataCollectionResult& operator=(
  ...
  inline void SetApproximateResultCount(int value) {
    m_approximateResultCountHasBeenSet = true;
    m_approximateResultCount = value;
  }
  inline SearchRasterDataCollectionResult& WithApproximateResultCount(int value) {
    SetApproximateResultCount(value);
    return *this;
  }
  ///@}
