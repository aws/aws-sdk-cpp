...
class ExportVectorEnrichmentJobRequest : public SageMakerGeospatialRequest {
 public:
  ...
  template <typename ArnT = Aws::String>
  ExportVectorEnrichmentJobRequest& WithArn(ArnT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  ExportVectorEnrichmentJobRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename ExecutionRoleArnT = Aws::String>
  ExportVectorEnrichmentJobRequest& WithExecutionRoleArn(ExecutionRoleArnT&& value) {
  ...
  template <typename OutputConfigT = ExportVectorEnrichmentJobOutputConfig>
  ExportVectorEnrichmentJobRequest& WithOutputConfig(OutputConfigT&& value) {
