...
class ListVectorEnrichmentJobsRequest : public SageMakerGeospatialRequest {
 public:
  ...
  inline ListVectorEnrichmentJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListVectorEnrichmentJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename SortByT = Aws::String>
  ListVectorEnrichmentJobsRequest& WithSortBy(SortByT&& value) {
  ...
  inline ListVectorEnrichmentJobsRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  void SetStatusEquals(StatusEqualsT&& value) {
    m_statusEqualsHasBeenSet = true;
    m_statusEquals = std::forward<StatusEqualsT>(value);
  }
  template <typename StatusEqualsT = Aws::String>
  ListVectorEnrichmentJobsRequest& WithStatusEquals(StatusEqualsT&& value) {
    SetStatusEquals(std::forward<StatusEqualsT>(value));
    return *this;
  }
  ///@}
 private:
