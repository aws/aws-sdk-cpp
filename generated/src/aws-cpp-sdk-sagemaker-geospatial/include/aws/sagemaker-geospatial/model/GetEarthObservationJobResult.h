...
class GetEarthObservationJobResult {
 public:
  ...
  AWS_SAGEMAKERGEOSPATIAL_API GetEarthObservationJobResult& operator=(
  ...
  inline GetEarthObservationJobResult& WithDurationInSeconds(int value) {
  ...
  void SetExportErrorDetails(ExportErrorDetailsT&& value) {
    ...
    m_exportErrorDetails = std::forward<ExportErrorDetailsT>(value);
  }
  template <typename ExportErrorDetailsT = ExportErrorDetails>
  GetEarthObservationJobResult& WithExportErrorDetails(ExportErrorDetailsT&& value) {
    SetExportErrorDetails(std::forward<ExportErrorDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetEarthObservationJobResult& WithExportStatus(EarthObservationJobExportStatus value) {
  ...
  inline void SetStatus(EarthObservationJobStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline GetEarthObservationJobResult& WithStatus(EarthObservationJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
