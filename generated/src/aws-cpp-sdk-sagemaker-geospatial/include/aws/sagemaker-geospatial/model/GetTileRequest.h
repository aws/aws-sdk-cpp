...
class GetTileRequest : public SageMakerGeospatialRequest {
 public:
  ...
  void SetImageAssets(ImageAssetsT&& value) {
    m_imageAssetsHasBeenSet = true;
    m_imageAssets = std::forward<ImageAssetsT>(value);
  }
  template <typename ImageAssetsT = Aws::Vector<Aws::String>>
  GetTileRequest& WithImageAssets(ImageAssetsT&& value) {
    SetImageAssets(std::forward<ImageAssetsT>(value));
    return *this;
  }
  template <typename ImageAssetsT = Aws::String>
  GetTileRequest& AddImageAssets(ImageAssetsT&& value) {
    m_imageAssetsHasBeenSet = true;
    m_imageAssets.emplace_back(std::forward<ImageAssetsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetImageMask(bool value) {
    m_imageMaskHasBeenSet = true;
    m_imageMask = value;
  }
  inline GetTileRequest& WithImageMask(bool value) {
    SetImageMask(value);
    return *this;
  }
  ///@}
  ...
  inline GetTileRequest& WithOutputDataType(OutputType value) {
  ...
  void SetOutputFormat(OutputFormatT&& value) {
    ...
    m_outputFormat = std::forward<OutputFormatT>(value);
  }
  template <typename OutputFormatT = Aws::String>
  GetTileRequest& WithOutputFormat(OutputFormatT&& value) {
    SetOutputFormat(std::forward<OutputFormatT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTarget(TargetOptions value) {
    m_targetHasBeenSet = true;
    m_target = value;
  }
  inline GetTileRequest& WithTarget(TargetOptions value) {
    SetTarget(value);
    return *this;
  }
  ///@}
  ...
  inline GetTileRequest& WithX(int value) {
    SetX(value);
    return *this;
  }
  ///@}
  ...
  inline GetTileRequest& WithY(int value) {
    SetY(value);
    return *this;
  }
  ///@}
  ...
  inline GetTileRequest& WithZ(int value) {
    SetZ(value);
    return *this;
  }
  ///@}
