...
class PropertyFilters {
 public:
  ...
  inline PropertyFilters& WithLogicalOperator(LogicalOperator value) {
  ...
  template <typename PropertiesT = Aws::Vector<PropertyFilter>>
  PropertyFilters& WithProperties(PropertiesT&& value) {
    SetProperties(std::forward<PropertiesT>(value));
    return *this;
  }
  template <typename PropertiesT = PropertyFilter>
  PropertyFilters& AddProperties(PropertiesT&& value) {
    m_propertiesHasBeenSet = true;
