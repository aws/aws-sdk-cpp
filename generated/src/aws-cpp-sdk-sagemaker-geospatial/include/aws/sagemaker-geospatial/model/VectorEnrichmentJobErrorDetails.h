...
class VectorEnrichmentJobErrorDetails {
 public:
  ...
  template <typename ErrorMessageT = Aws::String>
  VectorEnrichmentJobErrorDetails& WithErrorMessage(ErrorMessageT&& value) {
  ...
  inline void SetErrorType(VectorEnrichmentJobErrorType value) {
    m_errorTypeHasBeenSet = true;
    m_errorType = value;
  }
  inline VectorEnrichmentJobErrorDetails& WithErrorType(VectorEnrichmentJobErrorType value) {
    SetErrorType(value);
    return *this;
  }
  ///@}
