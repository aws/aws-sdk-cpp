...
class BandMathConfigInput {
 public:
  ...
  void SetCustomIndices(CustomIndicesT&& value) {
    m_customIndicesHasBeenSet = true;
    m_customIndices = std::forward<CustomIndicesT>(value);
  }
  template <typename CustomIndicesT = CustomIndicesInput>
  BandMathConfigInput& WithCustomIndices(CustomIndicesT&& value) {
    SetCustomIndices(std::forward<CustomIndicesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPredefinedIndices(PredefinedIndicesT&& value) {
    m_predefinedIndicesHasBeenSet = true;
    m_predefinedIndices = std::forward<PredefinedIndicesT>(value);
  }
  template <typename PredefinedIndicesT = Aws::Vector<Aws::String>>
  BandMathConfigInput& WithPredefinedIndices(PredefinedIndicesT&& value) {
    SetPredefinedIndices(std::forward<PredefinedIndicesT>(value));
    return *this;
  }
  template <typename PredefinedIndicesT = Aws::String>
  BandMathConfigInput& AddPredefinedIndices(PredefinedIndicesT&& value) {
    m_predefinedIndicesHasBeenSet = true;
    m_predefinedIndices.emplace_back(std::forward<PredefinedIndicesT>(value));
    return *this;
  }
  ///@}
 private:
