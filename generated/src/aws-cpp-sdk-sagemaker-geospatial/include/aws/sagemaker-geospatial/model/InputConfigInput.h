...
class InputConfigInput {
 public:
  ...
  template <typename PreviousEarthObservationJobArnT = Aws::String>
  InputConfigInput& WithPreviousEarthObservationJobArn(PreviousEarthObservationJobArnT&& value) {
  ...
  template <typename RasterDataCollectionQueryT = RasterDataCollectionQueryInput>
  InputConfigInput& WithRasterDataCollectionQuery(RasterDataCollectionQueryT&& value) {
