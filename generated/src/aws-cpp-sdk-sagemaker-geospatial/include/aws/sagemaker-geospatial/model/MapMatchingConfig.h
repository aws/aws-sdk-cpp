...
class MapMatchingConfig {
 public:
  ...
  void SetIdAttributeName(IdAttributeNameT&& value) {
    ...
    m_idAttributeName = std::forward<IdAttributeNameT>(value);
  }
  template <typename IdAttributeNameT = Aws::String>
  MapMatchingConfig& WithIdAttributeName(IdAttributeNameT&& value) {
    SetIdAttributeName(std::forward<IdAttributeNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetXAttributeName(XAttributeNameT&& value) {
    ...
    m_xAttributeName = std::forward<XAttributeNameT>(value);
  }
  template <typename XAttributeNameT = Aws::String>
  MapMatchingConfig& WithXAttributeName(XAttributeNameT&& value) {
    SetXAttributeName(std::forward<XAttributeNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetYAttributeName(YAttributeNameT&& value) {
    ...
    m_yAttributeName = std::forward<YAttributeNameT>(value);
  }
  template <typename YAttributeNameT = Aws::String>
  MapMatchingConfig& WithYAttributeName(YAttributeNameT&& value) {
    SetYAttributeName(std::forward<YAttributeNameT>(value));
    return *this;
  }
  ///@}
 private:
