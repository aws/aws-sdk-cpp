...
class VectorEnrichmentJobInputConfig {
 public:
  ...
  template <typename DataSourceConfigT = VectorEnrichmentJobDataSourceConfigInput>
  VectorEnrichmentJobInputConfig& WithDataSourceConfig(DataSourceConfigT&& value) {
  ...
  inline void SetDocumentType(VectorEnrichmentJobDocumentType value) {
    m_documentTypeHasBeenSet = true;
    m_documentType = value;
  }
  inline VectorEnrichmentJobInputConfig& WithDocumentType(VectorEnrichmentJobDocumentType value) {
