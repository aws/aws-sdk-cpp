...
class AreaOfInterestGeometry {
 public:
  ...
  void SetMultiPolygonGeometry(MultiPolygonGeometryT&& value) {
    m_multiPolygonGeometryHasBeenSet = true;
    m_multiPolygonGeometry = std::forward<MultiPolygonGeometryT>(value);
  }
  template <typename MultiPolygonGeometryT = MultiPolygonGeometryInput>
  AreaOfInterestGeometry& WithMultiPolygonGeometry(MultiPolygonGeometryT&& value) {
    SetMultiPolygonGeometry(std::forward<MultiPolygonGeometryT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPolygonGeometry(PolygonGeometryT&& value) {
    m_polygonGeometryHasBeenSet = true;
    m_polygonGeometry = std::forward<PolygonGeometryT>(value);
  }
  template <typename PolygonGeometryT = PolygonGeometryInput>
  AreaOfInterestGeometry& WithPolygonGeometry(PolygonGeometryT&& value) {
    SetPolygonGeometry(std::forward<PolygonGeometryT>(value));
    return *this;
  }
  ///@}
 private:
