...
namespace Model
{
  ...
  {
  public:
    AWS_SAGEMAKERGEOSPATIAL_API ValidationException() = default;
    ...
    template<typename ResourceIdT = Aws::String>
    ValidationException& WithResourceId(ResourceIdT&& value) { SetResourceId(std::forward<ResourceIdT>(value)); return *this;}
    ///@}
  private:
