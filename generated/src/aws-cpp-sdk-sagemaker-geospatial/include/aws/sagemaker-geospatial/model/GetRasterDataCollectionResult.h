...
class GetRasterDataCollectionResult {
 public:
  ...
  AWS_SAGEMAKERGEOSPATIAL_API GetRasterDataCollectionResult& operator=(
  ...
  void SetDescriptionPageUrl(DescriptionPageUrlT&& value) {
    ...
    m_descriptionPageUrl = std::forward<DescriptionPageUrlT>(value);
  }
  template <typename DescriptionPageUrlT = Aws::String>
  GetRasterDataCollectionResult& WithDescriptionPageUrl(DescriptionPageUrlT&& value) {
    SetDescriptionPageUrl(std::forward<DescriptionPageUrlT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetType(DataCollectionType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline GetRasterDataCollectionResult& WithType(DataCollectionType value) {
    SetType(value);
    return *this;
  }
  ///@}
