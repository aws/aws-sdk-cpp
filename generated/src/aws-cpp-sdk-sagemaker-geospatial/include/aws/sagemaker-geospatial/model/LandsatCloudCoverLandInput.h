...
class LandsatCloudCoverLandInput {
 public:
  AWS_SAGEMAKERGEOSPATIAL_API LandsatCloudCoverLandInput() = default;
  ...
  inline LandsatCloudCoverLandInput& WithLowerBound(double value) {
    SetLowerBound(value);
    return *this;
  }
  ///@}
  ...
  inline LandsatCloudCoverLandInput& WithUpperBound(double value) {
    SetUpperBound(value);
    return *this;
  }
  ///@}
