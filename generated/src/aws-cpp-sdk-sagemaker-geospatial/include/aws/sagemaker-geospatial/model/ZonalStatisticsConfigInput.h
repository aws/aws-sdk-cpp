...
class ZonalStatisticsConfigInput {
 public:
  ...
  inline ZonalStatisticsConfigInput& AddStatistics(ZonalStatistics value) {
    m_statisticsHasBeenSet = true;
  ...
  void SetZoneS3Path(ZoneS3PathT&& value) {
    m_zoneS3PathHasBeenSet = true;
    m_zoneS3Path = std::forward<ZoneS3PathT>(value);
  }
  template <typename ZoneS3PathT = Aws::String>
  ZonalStatisticsConfigInput& WithZoneS3Path(ZoneS3PathT&& value) {
    SetZoneS3Path(std::forward<ZoneS3PathT>(value));
    return *this;
  }
  ///@}
  ...
  void SetZoneS3PathKmsKeyId(ZoneS3PathKmsKeyIdT&& value) {
    m_zoneS3PathKmsKeyIdHasBeenSet = true;
    m_zoneS3PathKmsKeyId = std::forward<ZoneS3PathKmsKeyIdT>(value);
  }
  template <typename ZoneS3PathKmsKeyIdT = Aws::String>
  ZonalStatisticsConfigInput& WithZoneS3PathKmsKeyId(ZoneS3PathKmsKeyIdT&& value) {
    SetZoneS3PathKmsKeyId(std::forward<ZoneS3PathKmsKeyIdT>(value));
    return *this;
  }
  ///@}
 private:
