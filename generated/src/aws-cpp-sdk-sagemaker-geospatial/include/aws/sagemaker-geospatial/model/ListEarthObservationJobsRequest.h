...
class ListEarthObservationJobsRequest : public SageMakerGeospatialRequest {
 public:
  ...
  inline ListEarthObservationJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListEarthObservationJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename SortByT = Aws::String>
  ListEarthObservationJobsRequest& WithSortBy(SortByT&& value) {
  ...
  inline ListEarthObservationJobsRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatusEquals(EarthObservationJobStatus value) {
    m_statusEqualsHasBeenSet = true;
    m_statusEquals = value;
  }
  inline ListEarthObservationJobsRequest& WithStatusEquals(EarthObservationJobStatus value) {
