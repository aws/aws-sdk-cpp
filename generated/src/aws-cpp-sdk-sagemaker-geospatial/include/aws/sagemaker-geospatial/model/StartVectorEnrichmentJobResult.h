...
class StartVectorEnrichmentJobResult {
 public:
  ...
  AWS_SAGEMAKERGEOSPATIAL_API StartVectorEnrichmentJobResult& operator=(
  ...
  inline StartVectorEnrichmentJobResult& WithDurationInSeconds(int value) {
  ...
  inline StartVectorEnrichmentJobResult& WithStatus(VectorEnrichmentJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline StartVectorEnrichmentJobResult& WithType(VectorEnrichmentJobType value) {
    SetType(value);
    return *this;
  }
  ///@}
