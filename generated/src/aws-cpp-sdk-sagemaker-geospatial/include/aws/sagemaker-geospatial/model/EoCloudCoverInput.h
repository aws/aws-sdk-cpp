...
class EoCloudCoverInput {
 public:
  AWS_SAGEMAKERGEOSPATIAL_API EoCloudCoverInput() = default;
  ...
  inline EoCloudCoverInput& WithLowerBound(double value) {
    SetLowerBound(value);
    return *this;
  }
  ///@}
  ...
  inline EoCloudCoverInput& WithUpperBound(double value) {
    SetUpperBound(value);
    return *this;
  }
  ///@}
