...
class ExportVectorEnrichmentJobOutputConfig {
 public:
  AWS_SAGEMAKERGEOSPATIAL_API ExportVectorEnrichmentJobOutputConfig() = default;
  ...
  void SetS3Data(S3DataT&& value) {
    m_s3DataHasBeenSet = true;
    m_s3Data = std::forward<S3DataT>(value);
  }
  template <typename S3DataT = VectorEnrichmentJobS3Data>
  ExportVectorEnrichmentJobOutputConfig& WithS3Data(S3DataT&& value) {
    SetS3Data(std::forward<S3DataT>(value));
    return *this;
  }
  ///@}
 private:
