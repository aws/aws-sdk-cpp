...
class Property {
 public:
  ...
  void SetEoCloudCover(EoCloudCoverT&& value) {
    ...
    m_eoCloudCover = std::forward<EoCloudCoverT>(value);
  }
  template <typename EoCloudCoverT = EoCloudCoverInput>
  Property& WithEoCloudCover(EoCloudCoverT&& value) {
    SetEoCloudCover(std::forward<EoCloudCoverT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLandsatCloudCoverLand(LandsatCloudCoverLandT&& value) {
    ...
    m_landsatCloudCoverLand = std::forward<LandsatCloudCoverLandT>(value);
  }
  template <typename LandsatCloudCoverLandT = LandsatCloudCoverLandInput>
  Property& WithLandsatCloudCoverLand(LandsatCloudCoverLandT&& value) {
    SetLandsatCloudCoverLand(std::forward<LandsatCloudCoverLandT>(value));
    return *this;
  }
  ///@}
  ...
  void SetViewOffNadir(ViewOffNadirT&& value) {
    ...
    m_viewOffNadir = std::forward<ViewOffNadirT>(value);
  }
  template <typename ViewOffNadirT = ViewOffNadirInput>
  Property& WithViewOffNadir(ViewOffNadirT&& value) {
    SetViewOffNadir(std::forward<ViewOffNadirT>(value));
    return *this;
  }
  ///@}
  ...
  void SetViewSunAzimuth(ViewSunAzimuthT&& value) {
    ...
    m_viewSunAzimuth = std::forward<ViewSunAzimuthT>(value);
  }
  template <typename ViewSunAzimuthT = ViewSunAzimuthInput>
  Property& WithViewSunAzimuth(ViewSunAzimuthT&& value) {
    SetViewSunAzimuth(std::forward<ViewSunAzimuthT>(value));
    return *this;
  }
  ///@}
  ...
  void SetViewSunElevation(ViewSunElevationT&& value) {
    ...
    m_viewSunElevation = std::forward<ViewSunElevationT>(value);
  }
  template <typename ViewSunElevationT = ViewSunElevationInput>
  Property& WithViewSunElevation(ViewSunElevationT&& value) {
    SetViewSunElevation(std::forward<ViewSunElevationT>(value));
    return *this;
  }
  ///@}
 private:
