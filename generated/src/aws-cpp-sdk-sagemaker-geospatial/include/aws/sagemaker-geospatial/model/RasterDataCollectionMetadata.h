...
class RasterDataCollectionMetadata {
 public:
  ...
  template <typename ArnT = Aws::String>
  RasterDataCollectionMetadata& WithArn(ArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  RasterDataCollectionMetadata& WithName(NameT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  RasterDataCollectionMetadata& WithTags(TagsT&& value) {
  ...
  inline RasterDataCollectionMetadata& WithType(DataCollectionType value) {
    SetType(value);
    return *this;
  }
  ///@}
