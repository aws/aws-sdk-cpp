...
class ListVectorEnrichmentJobOutputConfig {
 public:
  ...
  template <typename ArnT = Aws::String>
  ListVectorEnrichmentJobOutputConfig& WithArn(ArnT&& value) {
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  ListVectorEnrichmentJobOutputConfig& WithCreationTime(CreationTimeT&& value) {
  ...
  inline ListVectorEnrichmentJobOutputConfig& WithDurationInSeconds(int value) {
  ...
  template <typename NameT = Aws::String>
  ListVectorEnrichmentJobOutputConfig& WithName(NameT&& value) {
  ...
  inline void SetStatus(VectorEnrichmentJobStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ListVectorEnrichmentJobOutputConfig& WithStatus(VectorEnrichmentJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  ListVectorEnrichmentJobOutputConfig& WithTags(TagsT&& value) {
  ...
  inline void SetType(VectorEnrichmentJobType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline ListVectorEnrichmentJobOutputConfig& WithType(VectorEnrichmentJobType value) {
    SetType(value);
    return *this;
  }
  ///@}
