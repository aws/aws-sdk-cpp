...
class OutputResolutionStackInput {
 public:
  ...
  inline void SetPredefined(PredefinedResolution value) {
    m_predefinedHasBeenSet = true;
    m_predefined = value;
  }
  inline OutputResolutionStackInput& WithPredefined(PredefinedResolution value) {
    SetPredefined(value);
    return *this;
  }
  ///@}
  ...
  template <typename UserDefinedT = UserDefined>
  OutputResolutionStackInput& WithUserDefined(UserDefinedT&& value) {
