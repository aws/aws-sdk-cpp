...
class JobConfigInput {
 public:
  ...
  void SetBandMathConfig(BandMathConfigT&& value) {
    ...
    m_bandMathConfig = std::forward<BandMathConfigT>(value);
  }
  template <typename BandMathConfigT = BandMathConfigInput>
  JobConfigInput& WithBandMathConfig(BandMathConfigT&& value) {
    SetBandMathConfig(std::forward<BandMathConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCloudMaskingConfig(CloudMaskingConfigT&& value) {
    ...
    m_cloudMaskingConfig = std::forward<CloudMaskingConfigT>(value);
  }
  template <typename CloudMaskingConfigT = CloudMaskingConfigInput>
  JobConfigInput& WithCloudMaskingConfig(CloudMaskingConfigT&& value) {
    SetCloudMaskingConfig(std::forward<CloudMaskingConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCloudRemovalConfig(CloudRemovalConfigT&& value) {
    ...
    m_cloudRemovalConfig = std::forward<CloudRemovalConfigT>(value);
  }
  template <typename CloudRemovalConfigT = CloudRemovalConfigInput>
  JobConfigInput& WithCloudRemovalConfig(CloudRemovalConfigT&& value) {
    SetCloudRemovalConfig(std::forward<CloudRemovalConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGeoMosaicConfig(GeoMosaicConfigT&& value) {
    ...
    m_geoMosaicConfig = std::forward<GeoMosaicConfigT>(value);
  }
  template <typename GeoMosaicConfigT = GeoMosaicConfigInput>
  JobConfigInput& WithGeoMosaicConfig(GeoMosaicConfigT&& value) {
    SetGeoMosaicConfig(std::forward<GeoMosaicConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLandCoverSegmentationConfig(LandCoverSegmentationConfigT&& value) {
    ...
    m_landCoverSegmentationConfig = std::forward<LandCoverSegmentationConfigT>(value);
  }
  template <typename LandCoverSegmentationConfigT = LandCoverSegmentationConfigInput>
  JobConfigInput& WithLandCoverSegmentationConfig(LandCoverSegmentationConfigT&& value) {
    SetLandCoverSegmentationConfig(std::forward<LandCoverSegmentationConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetResamplingConfig(ResamplingConfigT&& value) {
    ...
    m_resamplingConfig = std::forward<ResamplingConfigT>(value);
  }
  template <typename ResamplingConfigT = ResamplingConfigInput>
  JobConfigInput& WithResamplingConfig(ResamplingConfigT&& value) {
    SetResamplingConfig(std::forward<ResamplingConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStackConfig(StackConfigT&& value) {
    m_stackConfigHasBeenSet = true;
    m_stackConfig = std::forward<StackConfigT>(value);
  }
  template <typename StackConfigT = StackConfigInput>
  JobConfigInput& WithStackConfig(StackConfigT&& value) {
    SetStackConfig(std::forward<StackConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTemporalStatisticsConfig(TemporalStatisticsConfigT&& value) {
    ...
    m_temporalStatisticsConfig = std::forward<TemporalStatisticsConfigT>(value);
  }
  template <typename TemporalStatisticsConfigT = TemporalStatisticsConfigInput>
  JobConfigInput& WithTemporalStatisticsConfig(TemporalStatisticsConfigT&& value) {
    SetTemporalStatisticsConfig(std::forward<TemporalStatisticsConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetZonalStatisticsConfig(ZonalStatisticsConfigT&& value) {
    ...
    m_zonalStatisticsConfig = std::forward<ZonalStatisticsConfigT>(value);
  }
  template <typename ZonalStatisticsConfigT = ZonalStatisticsConfigInput>
  JobConfigInput& WithZonalStatisticsConfig(ZonalStatisticsConfigT&& value) {
    SetZonalStatisticsConfig(std::forward<ZonalStatisticsConfigT>(value));
    return *this;
  }
  ///@}
 private:
