...
class StartEarthObservationJobResult {
 public:
  ...
  AWS_SAGEMAKERGEOSPATIAL_API StartEarthObservationJobResult& operator=(
  ...
  inline StartEarthObservationJobResult& WithDurationInSeconds(int value) {
  ...
  inline StartEarthObservationJobResult& WithStatus(EarthObservationJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
