...
class AWS_SAGEMAKERGEOSPATIAL_API SageMakerGeospatialClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  SageMakerGeospatialClient(const Aws::SageMakerGeospatial::SageMakerGeospatialClientConfiguration& clientConfiguration =
  ...
  SageMakerGeospatialClient(const Aws::Auth::AWSCredentials& credentials,
                            std::shared_ptr<SageMakerGeospatialEndpointProviderBase> endpointProvider = nullptr,
                            const Aws::SageMakerGeospatial::SageMakerGeospatialClientConfiguration& clientConfiguration =
                                Aws::SageMakerGeospatial::SageMakerGeospatialClientConfiguration());
  ...
  /**
   * A Callable wrapper for DeleteEarthObservationJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DeleteEarthObservationJobRequestT = Model::DeleteEarthObservationJobRequest>
  Model::DeleteEarthObservationJobOutcomeCallable DeleteEarthObservationJobCallable(
      const DeleteEarthObservationJobRequestT& request) const {
    return SubmitCallable(&SageMakerGeospatialClient::DeleteEarthObservationJob, request);
  }

  /**
   * An Async wrapper for DeleteEarthObservationJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteEarthObservationJobRequestT = Model::DeleteEarthObservationJobRequest>
  void DeleteEarthObservationJobAsync(const DeleteEarthObservationJobRequestT& request,
                                      const DeleteEarthObservationJobResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for DeleteVectorEnrichmentJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DeleteVectorEnrichmentJobRequestT = Model::DeleteVectorEnrichmentJobRequest>
  Model::DeleteVectorEnrichmentJobOutcomeCallable DeleteVectorEnrichmentJobCallable(
      const DeleteVectorEnrichmentJobRequestT& request) const {
    return SubmitCallable(&SageMakerGeospatialClient::DeleteVectorEnrichmentJob, request);
  }

  /**
   * An Async wrapper for DeleteVectorEnrichmentJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteVectorEnrichmentJobRequestT = Model::DeleteVectorEnrichmentJobRequest>
  void DeleteVectorEnrichmentJobAsync(const DeleteVectorEnrichmentJobRequestT& request,
                                      const DeleteVectorEnrichmentJobResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ExportEarthObservationJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ExportEarthObservationJobRequestT = Model::ExportEarthObservationJobRequest>
  Model::ExportEarthObservationJobOutcomeCallable ExportEarthObservationJobCallable(
      const ExportEarthObservationJobRequestT& request) const {
    return SubmitCallable(&SageMakerGeospatialClient::ExportEarthObservationJob, request);
  }

  /**
   * An Async wrapper for ExportEarthObservationJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ExportEarthObservationJobRequestT = Model::ExportEarthObservationJobRequest>
  void ExportEarthObservationJobAsync(const ExportEarthObservationJobRequestT& request,
                                      const ExportEarthObservationJobResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ExportVectorEnrichmentJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ExportVectorEnrichmentJobRequestT = Model::ExportVectorEnrichmentJobRequest>
  Model::ExportVectorEnrichmentJobOutcomeCallable ExportVectorEnrichmentJobCallable(
      const ExportVectorEnrichmentJobRequestT& request) const {
    return SubmitCallable(&SageMakerGeospatialClient::ExportVectorEnrichmentJob, request);
  }

  /**
   * An Async wrapper for ExportVectorEnrichmentJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ExportVectorEnrichmentJobRequestT = Model::ExportVectorEnrichmentJobRequest>
  void ExportVectorEnrichmentJobAsync(const ExportVectorEnrichmentJobRequestT& request,
                                      const ExportVectorEnrichmentJobResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetEarthObservationJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetEarthObservationJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetEarthObservationJobRequestT = Model::GetEarthObservationJobRequest>
  void GetEarthObservationJobAsync(const GetEarthObservationJobRequestT& request,
                                   const GetEarthObservationJobResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetRasterDataCollection that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetRasterDataCollection that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetRasterDataCollectionRequestT = Model::GetRasterDataCollectionRequest>
  void GetRasterDataCollectionAsync(const GetRasterDataCollectionRequestT& request,
                                    const GetRasterDataCollectionResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetVectorEnrichmentJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetVectorEnrichmentJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetVectorEnrichmentJobRequestT = Model::GetVectorEnrichmentJobRequest>
  void GetVectorEnrichmentJobAsync(const GetVectorEnrichmentJobRequestT& request,
                                   const GetVectorEnrichmentJobResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListEarthObservationJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListEarthObservationJobsRequestT = Model::ListEarthObservationJobsRequest>
  Model::ListEarthObservationJobsOutcomeCallable ListEarthObservationJobsCallable(
      const ListEarthObservationJobsRequestT& request = {}) const {
    return SubmitCallable(&SageMakerGeospatialClient::ListEarthObservationJobs, request);
  }

  /**
   * An Async wrapper for ListEarthObservationJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListEarthObservationJobsRequestT = Model::ListEarthObservationJobsRequest>
  void ListEarthObservationJobsAsync(const ListEarthObservationJobsResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::ListRasterDataCollectionsOutcome ListRasterDataCollections(
      const Model::ListRasterDataCollectionsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListRasterDataCollections that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListRasterDataCollectionsRequestT = Model::ListRasterDataCollectionsRequest>
  Model::ListRasterDataCollectionsOutcomeCallable ListRasterDataCollectionsCallable(
      const ListRasterDataCollectionsRequestT& request = {}) const {
    return SubmitCallable(&SageMakerGeospatialClient::ListRasterDataCollections, request);
  }

  /**
   * An Async wrapper for ListRasterDataCollections that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListRasterDataCollectionsRequestT = Model::ListRasterDataCollectionsRequest>
  void ListRasterDataCollectionsAsync(const ListRasterDataCollectionsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const ListRasterDataCollectionsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListVectorEnrichmentJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListVectorEnrichmentJobsRequestT = Model::ListVectorEnrichmentJobsRequest>
  Model::ListVectorEnrichmentJobsOutcomeCallable ListVectorEnrichmentJobsCallable(
      const ListVectorEnrichmentJobsRequestT& request = {}) const {
    return SubmitCallable(&SageMakerGeospatialClient::ListVectorEnrichmentJobs, request);
  }

  /**
   * An Async wrapper for ListVectorEnrichmentJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListVectorEnrichmentJobsRequestT = Model::ListVectorEnrichmentJobsRequest>
  void ListVectorEnrichmentJobsAsync(const ListVectorEnrichmentJobsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const ListVectorEnrichmentJobsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::SearchRasterDataCollectionOutcome SearchRasterDataCollection(
      const Model::SearchRasterDataCollectionRequest& request) const;

  /**
   * A Callable wrapper for SearchRasterDataCollection that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename SearchRasterDataCollectionRequestT = Model::SearchRasterDataCollectionRequest>
  Model::SearchRasterDataCollectionOutcomeCallable SearchRasterDataCollectionCallable(
      const SearchRasterDataCollectionRequestT& request) const {
    return SubmitCallable(&SageMakerGeospatialClient::SearchRasterDataCollection, request);
  }

  /**
   * An Async wrapper for SearchRasterDataCollection that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SearchRasterDataCollectionRequestT = Model::SearchRasterDataCollectionRequest>
  void SearchRasterDataCollectionAsync(const SearchRasterDataCollectionRequestT& request,
                                       const SearchRasterDataCollectionResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartEarthObservationJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartEarthObservationJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartEarthObservationJobRequestT = Model::StartEarthObservationJobRequest>
  void StartEarthObservationJobAsync(const StartEarthObservationJobRequestT& request,
                                     const StartEarthObservationJobResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartVectorEnrichmentJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartVectorEnrichmentJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartVectorEnrichmentJobRequestT = Model::StartVectorEnrichmentJobRequest>
  void StartVectorEnrichmentJobAsync(const StartVectorEnrichmentJobRequestT& request,
                                     const StartVectorEnrichmentJobResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StopEarthObservationJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopEarthObservationJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StopEarthObservationJobRequestT = Model::StopEarthObservationJobRequest>
  void StopEarthObservationJobAsync(const StopEarthObservationJobRequestT& request,
                                    const StopEarthObservationJobResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StopVectorEnrichmentJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopVectorEnrichmentJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StopVectorEnrichmentJobRequestT = Model::StopVectorEnrichmentJobRequest>
  void StopVectorEnrichmentJobAsync(const StopVectorEnrichmentJobRequestT& request,
                                    const StopVectorEnrichmentJobResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
 ...
 private:
  ...
  typedef Aws::Utils::Outcome<Aws::AmazonWebServiceResult<RESPONSE>, SageMakerGeospatialError> InvokeOperationOutcome;
