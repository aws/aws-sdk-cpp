...
namespace SageMakerGeospatial
{
   ...
   */
  class AWS_SAGEMAKERGEOSPATIAL_API SageMakerGeospatialClient : Aws::Client::ClientWithAsyncTemplateMethods<SageMakerGeospatialClient>,
    smithy::client::AwsSmithyClientT<Aws::SageMakerGeospatial::SERVICE_NAME,
