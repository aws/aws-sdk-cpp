...
template <>
AWS_SAGEMAKERGEOSPATIAL_API ConflictException SageMakerGeospatialError::GetModeledError() {
  assert(this->GetErrorType() == SageMakerGeospatialErrors::CONFLICT);
  return ConflictException(this->GetJsonPayload().View());
}

template <>
AWS_SAGEMAKERGEOSPATIAL_API ThrottlingException SageMakerGeospatialError::GetModeledError() {
  assert(this->GetErrorType() == SageMakerGeospatialErrors::THROTTLING);
  return ThrottlingException(this->GetJsonPayload().View());
}

template <>
AWS_SAGEMAKERGEOSPATIAL_API ServiceQuotaExceededException SageMakerGeospatialError::GetModeledError() {
  assert(this->GetErrorType() == SageMakerGeospatialErrors::SERVICE_QUOTA_EXCEEDED);
  return ServiceQuotaExceededException(this->GetJsonPayload().View());
}

template <>
AWS_SAGEMAKERGEOSPATIAL_API InternalServerException SageMakerGeospatialError::GetModeledError() {
  assert(this->GetErrorType() == SageMakerGeospatialErrors::INTERNAL_SERVER);
  return InternalServerException(this->GetJsonPayload().View());
}

template <>
AWS_SAGEMAKERGEOSPATIAL_API ResourceNotFoundException SageMakerGeospatialError::GetModeledError() {
  assert(this->GetErrorType() == SageMakerGeospatialErrors::RESOURCE_NOT_FOUND);
  return ResourceNotFoundException(this->GetJsonPayload().View());
}

template <>
AWS_SAGEMAKERGEOSPATIAL_API ValidationException SageMakerGeospatialError::GetModeledError() {
...
AWSError<CoreErrors> GetErrorForName(const char* errorName) {
  ...
  if (hashCode == CONFLICT_HASH) {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(SageMakerGeospatialErrors::CONFLICT), RetryableType::NOT_RETRYABLE);
  } else if (hashCode == SERVICE_QUOTA_EXCEEDED_HASH) {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(SageMakerGeospatialErrors::SERVICE_QUOTA_EXCEEDED), RetryableType::NOT_RETRYABLE);
  } else if (hashCode == INTERNAL_SERVER_HASH) {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(SageMakerGeospatialErrors::INTERNAL_SERVER), RetryableType::RETRYABLE);
  }
