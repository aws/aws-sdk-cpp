...
ListVectorEnrichmentJobsResult::ListVectorEnrichmentJobsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListVectorEnrichmentJobsResult& ListVectorEnrichmentJobsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("VectorEnrichmentJobSummaries")) {
    ...
    for (unsigned vectorEnrichmentJobSummariesIndex = 0;
         vectorEnrichmentJobSummariesIndex < vectorEnrichmentJobSummariesJsonList.GetLength(); ++vectorEnrichmentJobSummariesIndex) {
