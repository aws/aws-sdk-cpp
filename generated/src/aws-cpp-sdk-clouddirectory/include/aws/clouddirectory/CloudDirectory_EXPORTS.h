...
#define AWS_CLOUDDIRECTORY_EXTERN
#else
#define AWS_CLOUDDIRECTORY_API
#define AWS_CLOUDDIRECTORY_EXTERN extern
#endif  // USE_IMPORT_EXPORT
#define AWS_CLOUDDIRECTORY_LOCAL
#else  // defined (USE_WINDOWS_DLL_SEMANTICS) || defined (WIN32)
#define AWS_CLOUDDIRECTORY_API
#define AWS_CLOUDDIRECTORY_EXTERN extern
#if __GNUC__ >= 4
#define AWS_CLOUDDIRECTORY_LOCAL __attribute__((visibility("hidden")))
#else
#define AWS_CLOUDDIRECTORY_LOCAL
#endif
