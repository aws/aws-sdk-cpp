...
namespace CloudDirectory
{
   ...
   */
  class AWS_CLOUDDIRECTORY_API CloudDirectoryClient : Aws::Client::ClientWithAsyncTemplateMethods<CloudDirectoryClient>,
    smithy::client::AwsSmithyClientT<Aws::CloudDirectory::SERVICE_NAME,
