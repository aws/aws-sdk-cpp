...
class ListObjectChildrenRequest : public CloudDirectoryRequest {
 public:
  ...
  template <typename DirectoryArnT = Aws::String>
  ListObjectChildrenRequest& WithDirectoryArn(DirectoryArnT&& value) {
  ...
  template <typename ObjectReferenceT = ObjectReference>
  ListObjectChildrenRequest& WithObjectReference(ObjectReferenceT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListObjectChildrenRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListObjectChildrenRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline ListObjectChildrenRequest& WithConsistencyLevel(ConsistencyLevel value) {
