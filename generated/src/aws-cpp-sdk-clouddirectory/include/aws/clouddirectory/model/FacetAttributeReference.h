...
class FacetAttributeReference {
 public:
  ...
  void SetTargetFacetName(TargetFacetNameT&& value) {
    m_targetFacetNameHasBeenSet = true;
    m_targetFacetName = std::forward<TargetFacetNameT>(value);
  }
  template <typename TargetFacetNameT = Aws::String>
  FacetAttributeReference& WithTargetFacetName(TargetFacetNameT&& value) {
    SetTargetFacetName(std::forward<TargetFacetNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTargetAttributeName(TargetAttributeNameT&& value) {
    ...
    m_targetAttributeName = std::forward<TargetAttributeNameT>(value);
  }
  template <typename TargetAttributeNameT = Aws::String>
  FacetAttributeReference& WithTargetAttributeName(TargetAttributeNameT&& value) {
    SetTargetAttributeName(std::forward<TargetAttributeNameT>(value));
    return *this;
  }
  ///@}
 private:
