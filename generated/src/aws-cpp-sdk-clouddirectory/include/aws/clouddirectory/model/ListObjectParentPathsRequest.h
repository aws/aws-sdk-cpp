...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDDIRECTORY_API ListObjectParentPathsRequest() = default;
    ...
    template<typename DirectoryArnT = Aws::String>
    ListObjectParentPathsRequest& WithDirectoryArn(DirectoryArnT&& value) { SetDirectoryArn(std::forward<DirectoryArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ObjectReferenceT = ObjectReference>
    ListObjectParentPathsRequest& WithObjectReference(ObjectReferenceT&& value) { SetObjectReference(std::forward<ObjectReferenceT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListObjectParentPathsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
