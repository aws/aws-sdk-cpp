...
class ListIndexResult {
 public:
  ...
  template <typename IndexAttachmentsT = Aws::Vector<IndexAttachment>>
  ListIndexResult& WithIndexAttachments(IndexAttachmentsT&& value) {
    SetIndexAttachments(std::forward<IndexAttachmentsT>(value));
    return *this;
  }
  template <typename IndexAttachmentsT = IndexAttachment>
  ListIndexResult& AddIndexAttachments(IndexAttachmentsT&& value) {
    m_indexAttachmentsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListIndexResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListIndexResult& WithRequestId(RequestIdT&& value) {
