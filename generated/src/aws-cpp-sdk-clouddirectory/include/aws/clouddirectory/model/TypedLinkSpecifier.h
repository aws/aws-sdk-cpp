...
class TypedLinkSpecifier {
 public:
  ...
  template <typename TypedLinkFacetT = TypedLinkSchemaAndFacetName>
  TypedLinkSpecifier& WithTypedLinkFacet(TypedLinkFacetT&& value) {
  ...
  template <typename SourceObjectReferenceT = ObjectReference>
  TypedLinkSpecifier& WithSourceObjectReference(SourceObjectReferenceT&& value) {
  ...
  template <typename TargetObjectReferenceT = ObjectReference>
  TypedLinkSpecifier& WithTargetObjectReference(TargetObjectReferenceT&& value) {
  ...
  void SetIdentityAttributeValues(IdentityAttributeValuesT&& value) {
    m_identityAttributeValuesHasBeenSet = true;
    m_identityAttributeValues = std::forward<IdentityAttributeValuesT>(value);
  }
  template <typename IdentityAttributeValuesT = Aws::Vector<AttributeNameAndValue>>
  TypedLinkSpecifier& WithIdentityAttributeValues(IdentityAttributeValuesT&& value) {
    SetIdentityAttributeValues(std::forward<IdentityAttributeValuesT>(value));
    return *this;
  }
  template <typename IdentityAttributeValuesT = AttributeNameAndValue>
  TypedLinkSpecifier& AddIdentityAttributeValues(IdentityAttributeValuesT&& value) {
    m_identityAttributeValuesHasBeenSet = true;
    m_identityAttributeValues.emplace_back(std::forward<IdentityAttributeValuesT>(value));
    return *this;
  }
  ///@}
 private:
