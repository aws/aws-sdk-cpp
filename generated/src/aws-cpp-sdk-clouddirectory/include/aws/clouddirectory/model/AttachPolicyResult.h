...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDDIRECTORY_API AttachPolicyResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    AttachPolicyResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
