...
class ListObjectChildrenResult {
 public:
  ...
  template <typename ChildrenT = Aws::Map<Aws::String, Aws::String>>
  ListObjectChildrenResult& WithChildren(ChildrenT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListObjectChildrenResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListObjectChildrenResult& WithRequestId(RequestIdT&& value) {
