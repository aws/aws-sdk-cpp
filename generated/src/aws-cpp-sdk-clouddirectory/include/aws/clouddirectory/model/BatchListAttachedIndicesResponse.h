...
class BatchListAttachedIndicesResponse {
 public:
  ...
  template <typename IndexAttachmentsT = Aws::Vector<IndexAttachment>>
  BatchListAttachedIndicesResponse& WithIndexAttachments(IndexAttachmentsT&& value) {
    SetIndexAttachments(std::forward<IndexAttachmentsT>(value));
    return *this;
  }
  template <typename IndexAttachmentsT = IndexAttachment>
  BatchListAttachedIndicesResponse& AddIndexAttachments(IndexAttachmentsT&& value) {
    m_indexAttachmentsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  BatchListAttachedIndicesResponse& WithNextToken(NextTokenT&& value) {
