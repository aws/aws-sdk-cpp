...
class BatchListObjectPoliciesResponse {
 public:
  ...
  void SetAttachedPolicyIds(AttachedPolicyIdsT&& value) {
    m_attachedPolicyIdsHasBeenSet = true;
    m_attachedPolicyIds = std::forward<AttachedPolicyIdsT>(value);
  }
  template <typename AttachedPolicyIdsT = Aws::Vector<Aws::String>>
  BatchListObjectPoliciesResponse& WithAttachedPolicyIds(AttachedPolicyIdsT&& value) {
    SetAttachedPolicyIds(std::forward<AttachedPolicyIdsT>(value));
    return *this;
  }
  template <typename AttachedPolicyIdsT = Aws::String>
  BatchListObjectPoliciesResponse& AddAttachedPolicyIds(AttachedPolicyIdsT&& value) {
    m_attachedPolicyIdsHasBeenSet = true;
    m_attachedPolicyIds.emplace_back(std::forward<AttachedPolicyIdsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  BatchListObjectPoliciesResponse& WithNextToken(NextTokenT&& value) {
