...
class LinkAttributeAction {
 public:
  ...
  inline void SetAttributeActionType(UpdateActionType value) {
    m_attributeActionTypeHasBeenSet = true;
    m_attributeActionType = value;
  }
  inline LinkAttributeAction& WithAttributeActionType(UpdateActionType value) {
    SetAttributeActionType(value);
    return *this;
  }
  ///@}
  ...
  void SetAttributeUpdateValue(AttributeUpdateValueT&& value) {
    ...
    m_attributeUpdateValue = std::forward<AttributeUpdateValueT>(value);
  }
  template <typename AttributeUpdateValueT = TypedAttributeValue>
  LinkAttributeAction& WithAttributeUpdateValue(AttributeUpdateValueT&& value) {
    SetAttributeUpdateValue(std::forward<AttributeUpdateValueT>(value));
    return *this;
  }
  ///@}
 private:
