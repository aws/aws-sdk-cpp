...
class ListPublishedSchemaArnsResult {
 public:
  ...
  template <typename SchemaArnsT = Aws::Vector<Aws::String>>
  ListPublishedSchemaArnsResult& WithSchemaArns(SchemaArnsT&& value) {
    SetSchemaArns(std::forward<SchemaArnsT>(value));
    return *this;
  }
  template <typename SchemaArnsT = Aws::String>
  ListPublishedSchemaArnsResult& AddSchemaArns(SchemaArnsT&& value) {
    m_schemaArnsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListPublishedSchemaArnsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListPublishedSchemaArnsResult& WithRequestId(RequestIdT&& value) {
