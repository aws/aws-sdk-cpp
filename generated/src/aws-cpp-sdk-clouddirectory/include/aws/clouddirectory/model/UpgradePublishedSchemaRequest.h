...
class UpgradePublishedSchemaRequest : public CloudDirectoryRequest {
 public:
  ...
  void SetDevelopmentSchemaArn(DevelopmentSchemaArnT&& value) {
    m_developmentSchemaArnHasBeenSet = true;
    m_developmentSchemaArn = std::forward<DevelopmentSchemaArnT>(value);
  }
  template <typename DevelopmentSchemaArnT = Aws::String>
  UpgradePublishedSchemaRequest& WithDevelopmentSchemaArn(DevelopmentSchemaArnT&& value) {
    SetDevelopmentSchemaArn(std::forward<DevelopmentSchemaArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename PublishedSchemaArnT = Aws::String>
  UpgradePublishedSchemaRequest& WithPublishedSchemaArn(PublishedSchemaArnT&& value) {
  ...
  template <typename MinorVersionT = Aws::String>
  UpgradePublishedSchemaRequest& WithMinorVersion(MinorVersionT&& value) {
  ...
  inline UpgradePublishedSchemaRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
