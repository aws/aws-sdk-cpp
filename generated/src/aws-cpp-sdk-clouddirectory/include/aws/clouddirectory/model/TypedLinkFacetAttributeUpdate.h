...
class TypedLinkFacetAttributeUpdate {
 public:
  ...
  template <typename AttributeT = TypedLinkAttributeDefinition>
  TypedLinkFacetAttributeUpdate& WithAttribute(AttributeT&& value) {
  ...
  inline void SetAction(UpdateActionType value) {
    m_actionHasBeenSet = true;
    m_action = value;
  }
  inline TypedLinkFacetAttributeUpdate& WithAction(UpdateActionType value) {
    SetAction(value);
    return *this;
  }
  ///@}
