...
class ListOutgoingTypedLinksResult {
 public:
  ...
  template <typename TypedLinkSpecifiersT = Aws::Vector<TypedLinkSpecifier>>
  ListOutgoingTypedLinksResult& WithTypedLinkSpecifiers(TypedLinkSpecifiersT&& value) {
    SetTypedLinkSpecifiers(std::forward<TypedLinkSpecifiersT>(value));
    return *this;
  }
  template <typename TypedLinkSpecifiersT = TypedLinkSpecifier>
  ListOutgoingTypedLinksResult& AddTypedLinkSpecifiers(TypedLinkSpecifiersT&& value) {
    m_typedLinkSpecifiersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListOutgoingTypedLinksResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListOutgoingTypedLinksResult& WithRequestId(RequestIdT&& value) {
