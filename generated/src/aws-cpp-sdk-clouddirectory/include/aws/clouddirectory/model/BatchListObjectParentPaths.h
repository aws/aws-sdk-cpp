...
namespace Model
{
  ...
  public:
    ...
    template<typename ObjectReferenceT = ObjectReference>
    BatchListObjectParentPaths& WithObjectReference(ObjectReferenceT&& value) { SetObjectReference(std::forward<ObjectReferenceT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    BatchListObjectParentPaths& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
