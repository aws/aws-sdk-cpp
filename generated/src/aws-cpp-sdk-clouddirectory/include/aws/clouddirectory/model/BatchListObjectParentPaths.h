...
class BatchListObjectParentPaths {
 public:
  AWS_CLOUDDIRECTORY_API BatchListObjectParentPaths() = default;
  ...
  template <typename ObjectReferenceT = ObjectReference>
  BatchListObjectParentPaths& WithObjectReference(ObjectReferenceT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  BatchListObjectParentPaths& WithNextToken(NextTokenT&& value) {
  ...
  inline BatchListObjectParentPaths& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
