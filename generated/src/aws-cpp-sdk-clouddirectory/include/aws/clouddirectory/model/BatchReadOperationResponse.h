...
class BatchReadOperationResponse {
 public:
  ...
  void SetSuccessfulResponse(SuccessfulResponseT&& value) {
    ...
    m_successfulResponse = std::forward<SuccessfulResponseT>(value);
  }
  template <typename SuccessfulResponseT = BatchReadSuccessfulResponse>
  BatchReadOperationResponse& WithSuccessfulResponse(SuccessfulResponseT&& value) {
    SetSuccessfulResponse(std::forward<SuccessfulResponseT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExceptionResponse(ExceptionResponseT&& value) {
    ...
    m_exceptionResponse = std::forward<ExceptionResponseT>(value);
  }
  template <typename ExceptionResponseT = BatchReadException>
  BatchReadOperationResponse& WithExceptionResponse(ExceptionResponseT&& value) {
    SetExceptionResponse(std::forward<ExceptionResponseT>(value));
    return *this;
  }
  ///@}
 private:
