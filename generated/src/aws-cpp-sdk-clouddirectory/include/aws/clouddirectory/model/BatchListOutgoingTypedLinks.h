...
class BatchListOutgoingTypedLinks {
 public:
  ...
  template <typename ObjectReferenceT = ObjectReference>
  BatchListOutgoingTypedLinks& WithObjectReference(ObjectReferenceT&& value) {
  ...
  template <typename FilterAttributeRangesT = Aws::Vector<TypedLinkAttributeRange>>
  BatchListOutgoingTypedLinks& WithFilterAttributeRanges(FilterAttributeRangesT&& value) {
  ...
  BatchListOutgoingTypedLinks& AddFilterAttributeRanges(FilterAttributeRangesT&& value) {
    m_filterAttributeRangesHasBeenSet = true;
  ...
  template <typename FilterTypedLinkT = TypedLinkSchemaAndFacetName>
  BatchListOutgoingTypedLinks& WithFilterTypedLink(FilterTypedLinkT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  BatchListOutgoingTypedLinks& WithNextToken(NextTokenT&& value) {
  ...
  inline BatchListOutgoingTypedLinks& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
