...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDDIRECTORY_API Tag() = default;
    AWS_CLOUDDIRECTORY_API Tag(Aws::Utils::Json::JsonView jsonValue);
    AWS_CLOUDDIRECTORY_API Tag& operator=(Aws::Utils::Json::JsonView jsonValue);
