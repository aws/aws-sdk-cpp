...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDDIRECTORY_API RemoveFacetFromObjectResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    RemoveFacetFromObjectResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
