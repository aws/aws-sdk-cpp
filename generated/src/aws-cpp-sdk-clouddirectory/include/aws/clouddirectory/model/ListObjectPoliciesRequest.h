...
class ListObjectPoliciesRequest : public CloudDirectoryRequest {
 public:
  ...
  template <typename DirectoryArnT = Aws::String>
  ListObjectPoliciesRequest& WithDirectoryArn(DirectoryArnT&& value) {
  ...
  template <typename ObjectReferenceT = ObjectReference>
  ListObjectPoliciesRequest& WithObjectReference(ObjectReferenceT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListObjectPoliciesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListObjectPoliciesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline ListObjectPoliciesRequest& WithConsistencyLevel(ConsistencyLevel value) {
