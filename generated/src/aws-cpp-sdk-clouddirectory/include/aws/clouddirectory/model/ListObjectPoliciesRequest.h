...
namespace Model
{
  ...
  /**
   */
  class ListObjectPoliciesRequest : public CloudDirectoryRequest
  {
  public:
    AWS_CLOUDDIRECTORY_API ListObjectPoliciesRequest() = default;
    ...
    template<typename DirectoryArnT = Aws::String>
    ListObjectPoliciesRequest& WithDirectoryArn(DirectoryArnT&& value) { SetDirectoryArn(std::forward<DirectoryArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ObjectReferenceT = ObjectReference>
    ListObjectPoliciesRequest& WithObjectReference(ObjectReferenceT&& value) { SetObjectReference(std::forward<ObjectReferenceT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListObjectPoliciesRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    inline ListObjectPoliciesRequest& WithConsistencyLevel(ConsistencyLevel value) { SetConsistencyLevel(value); return *this;}
    ///@}
  private:
