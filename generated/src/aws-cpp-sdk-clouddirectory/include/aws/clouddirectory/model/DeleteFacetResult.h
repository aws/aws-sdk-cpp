...
namespace Model
{
  ...
  public:
    ...
    inline DeleteFacetResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeleteFacetResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeleteFacetResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
