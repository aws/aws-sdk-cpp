...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDDIRECTORY_API DeleteFacetResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteFacetResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
