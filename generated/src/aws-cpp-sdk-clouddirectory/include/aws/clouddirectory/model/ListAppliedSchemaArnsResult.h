...
namespace Model
{
  ...
  public:
    ...
    inline ListAppliedSchemaArnsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ListAppliedSchemaArnsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ListAppliedSchemaArnsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
