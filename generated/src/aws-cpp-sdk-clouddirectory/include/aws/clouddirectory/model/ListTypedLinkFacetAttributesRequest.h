...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDDIRECTORY_API ListTypedLinkFacetAttributesRequest() = default;
    ...
    template<typename SchemaArnT = Aws::String>
    ListTypedLinkFacetAttributesRequest& WithSchemaArn(SchemaArnT&& value) { SetSchemaArn(std::forward<SchemaArnT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    ListTypedLinkFacetAttributesRequest& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListTypedLinkFacetAttributesRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
