...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDDIRECTORY_API PutSchemaFromJsonResult() = default;
    ...
    template<typename ArnT = Aws::String>
    PutSchemaFromJsonResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    PutSchemaFromJsonResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
