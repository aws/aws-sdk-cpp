...
class UpgradeAppliedSchemaResult {
 public:
  ...
  template <typename UpgradedSchemaArnT = Aws::String>
  UpgradeAppliedSchemaResult& WithUpgradedSchemaArn(UpgradedSchemaArnT&& value) {
  ...
  template <typename DirectoryArnT = Aws::String>
  UpgradeAppliedSchemaResult& WithDirectoryArn(DirectoryArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpgradeAppliedSchemaResult& WithRequestId(RequestIdT&& value) {
