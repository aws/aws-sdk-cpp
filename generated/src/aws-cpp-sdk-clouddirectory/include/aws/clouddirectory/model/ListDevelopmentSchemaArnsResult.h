...
class ListDevelopmentSchemaArnsResult {
 public:
  ...
  template <typename SchemaArnsT = Aws::Vector<Aws::String>>
  ListDevelopmentSchemaArnsResult& WithSchemaArns(SchemaArnsT&& value) {
    SetSchemaArns(std::forward<SchemaArnsT>(value));
    return *this;
  }
  template <typename SchemaArnsT = Aws::String>
  ListDevelopmentSchemaArnsResult& AddSchemaArns(SchemaArnsT&& value) {
    m_schemaArnsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListDevelopmentSchemaArnsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDevelopmentSchemaArnsResult& WithRequestId(RequestIdT&& value) {
