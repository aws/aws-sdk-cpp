...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDDIRECTORY_API ListDevelopmentSchemaArnsResult() = default;
    ...
    template<typename SchemaArnsT = Aws::Vector<Aws::String>>
    ListDevelopmentSchemaArnsResult& WithSchemaArns(SchemaArnsT&& value) { SetSchemaArns(std::forward<SchemaArnsT>(value)); return *this;}
    template<typename SchemaArnsT = Aws::String>
    ListDevelopmentSchemaArnsResult& AddSchemaArns(SchemaArnsT&& value) { m_schemaArnsHasBeenSet = true; m_schemaArns.emplace_back(std::forward<SchemaArnsT>(value)); return *this; }
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListDevelopmentSchemaArnsResult& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ListDevelopmentSchemaArnsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
