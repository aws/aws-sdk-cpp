...
namespace Model
{
  ...
  public:
    ...
    inline UpdateTypedLinkFacetResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateTypedLinkFacetResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateTypedLinkFacetResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
