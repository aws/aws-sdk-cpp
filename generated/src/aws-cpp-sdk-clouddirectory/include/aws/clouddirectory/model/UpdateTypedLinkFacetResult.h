...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDDIRECTORY_API UpdateTypedLinkFacetResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateTypedLinkFacetResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
