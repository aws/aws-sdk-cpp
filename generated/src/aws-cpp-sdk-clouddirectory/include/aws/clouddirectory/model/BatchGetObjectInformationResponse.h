...
class BatchGetObjectInformationResponse {
 public:
  ...
  template <typename SchemaFacetsT = Aws::Vector<SchemaFacet>>
  BatchGetObjectInformationResponse& WithSchemaFacets(SchemaFacetsT&& value) {
    SetSchemaFacets(std::forward<SchemaFacetsT>(value));
    return *this;
  }
  template <typename SchemaFacetsT = SchemaFacet>
  BatchGetObjectInformationResponse& AddSchemaFacets(SchemaFacetsT&& value) {
    m_schemaFacetsHasBeenSet = true;
  ...
  template <typename ObjectIdentifierT = Aws::String>
  BatchGetObjectInformationResponse& WithObjectIdentifier(ObjectIdentifierT&& value) {
