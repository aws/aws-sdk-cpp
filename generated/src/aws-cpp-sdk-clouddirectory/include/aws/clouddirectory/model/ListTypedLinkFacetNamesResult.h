...
class ListTypedLinkFacetNamesResult {
 public:
  ...
  void SetFacetNames(FacetNamesT&& value) {
    m_facetNamesHasBeenSet = true;
    m_facetNames = std::forward<FacetNamesT>(value);
  }
  template <typename FacetNamesT = Aws::Vector<Aws::String>>
  ListTypedLinkFacetNamesResult& WithFacetNames(FacetNamesT&& value) {
    SetFacetNames(std::forward<FacetNamesT>(value));
    return *this;
  }
  template <typename FacetNamesT = Aws::String>
  ListTypedLinkFacetNamesResult& AddFacetNames(FacetNamesT&& value) {
    m_facetNamesHasBeenSet = true;
    m_facetNames.emplace_back(std::forward<FacetNamesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTypedLinkFacetNamesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListTypedLinkFacetNamesResult& WithRequestId(RequestIdT&& value) {
