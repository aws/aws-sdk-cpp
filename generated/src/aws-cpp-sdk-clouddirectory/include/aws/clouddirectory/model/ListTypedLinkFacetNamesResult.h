...
namespace Model
{
  ...
  public:
    ...
    inline ListTypedLinkFacetNamesResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ListTypedLinkFacetNamesResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ListTypedLinkFacetNamesResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
