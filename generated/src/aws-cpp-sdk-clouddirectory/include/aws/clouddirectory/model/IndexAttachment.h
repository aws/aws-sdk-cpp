...
class IndexAttachment {
 public:
  ...
  void SetIndexedAttributes(IndexedAttributesT&& value) {
    ...
    m_indexedAttributes = std::forward<IndexedAttributesT>(value);
  }
  template <typename IndexedAttributesT = Aws::Vector<AttributeKeyAndValue>>
  IndexAttachment& WithIndexedAttributes(IndexedAttributesT&& value) {
    SetIndexedAttributes(std::forward<IndexedAttributesT>(value));
    return *this;
  }
  template <typename IndexedAttributesT = AttributeKeyAndValue>
  IndexAttachment& AddIndexedAttributes(IndexedAttributesT&& value) {
    m_indexedAttributesHasBeenSet = true;
    m_indexedAttributes.emplace_back(std::forward<IndexedAttributesT>(value));
    return *this;
  }
  ///@}
