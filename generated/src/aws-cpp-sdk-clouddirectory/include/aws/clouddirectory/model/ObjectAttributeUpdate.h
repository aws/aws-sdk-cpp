...
class ObjectAttributeUpdate {
 public:
  ...
  void SetObjectAttributeKey(ObjectAttributeKeyT&& value) {
    ...
    m_objectAttributeKey = std::forward<ObjectAttributeKeyT>(value);
  }
  template <typename ObjectAttributeKeyT = AttributeKey>
  ObjectAttributeUpdate& WithObjectAttributeKey(ObjectAttributeKeyT&& value) {
    SetObjectAttributeKey(std::forward<ObjectAttributeKeyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetObjectAttributeAction(ObjectAttributeActionT&& value) {
    ...
    m_objectAttributeAction = std::forward<ObjectAttributeActionT>(value);
  }
  template <typename ObjectAttributeActionT = ObjectAttributeAction>
  ObjectAttributeUpdate& WithObjectAttributeAction(ObjectAttributeActionT&& value) {
    SetObjectAttributeAction(std::forward<ObjectAttributeActionT>(value));
    return *this;
  }
  ///@}
 private:
