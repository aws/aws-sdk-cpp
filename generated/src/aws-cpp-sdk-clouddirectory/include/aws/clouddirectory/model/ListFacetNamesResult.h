...
class ListFacetNamesResult {
 public:
  ...
  template <typename FacetNamesT = Aws::Vector<Aws::String>>
  ListFacetNamesResult& WithFacetNames(FacetNamesT&& value) {
    SetFacetNames(std::forward<FacetNamesT>(value));
    return *this;
  }
  template <typename FacetNamesT = Aws::String>
  ListFacetNamesResult& AddFacetNames(FacetNamesT&& value) {
    m_facetNamesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListFacetNamesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListFacetNamesResult& WithRequestId(RequestIdT&& value) {
