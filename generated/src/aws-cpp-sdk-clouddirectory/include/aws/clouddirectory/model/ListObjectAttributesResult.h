...
class ListObjectAttributesResult {
 public:
  ...
  template <typename AttributesT = Aws::Vector<AttributeKeyAndValue>>
  ListObjectAttributesResult& WithAttributes(AttributesT&& value) {
    SetAttributes(std::forward<AttributesT>(value));
    return *this;
  }
  template <typename AttributesT = AttributeKeyAndValue>
  ListObjectAttributesResult& AddAttributes(AttributesT&& value) {
    m_attributesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListObjectAttributesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListObjectAttributesResult& WithRequestId(RequestIdT&& value) {
