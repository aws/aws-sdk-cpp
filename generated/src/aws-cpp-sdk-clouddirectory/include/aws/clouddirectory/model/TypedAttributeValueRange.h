...
class TypedAttributeValueRange {
 public:
  ...
  inline void SetStartMode(RangeMode value) {
    m_startModeHasBeenSet = true;
    m_startMode = value;
  }
  inline TypedAttributeValueRange& WithStartMode(RangeMode value) {
    SetStartMode(value);
    return *this;
  }
  ///@}
  ...
  template <typename StartValueT = TypedAttributeValue>
  TypedAttributeValueRange& WithStartValue(StartValueT&& value) {
  ...
  inline void SetEndMode(RangeMode value) {
    m_endModeHasBeenSet = true;
    m_endMode = value;
  }
  inline TypedAttributeValueRange& WithEndMode(RangeMode value) {
    SetEndMode(value);
    return *this;
  }
  ///@}
  ...
  template <typename EndValueT = TypedAttributeValue>
  TypedAttributeValueRange& WithEndValue(EndValueT&& value) {
