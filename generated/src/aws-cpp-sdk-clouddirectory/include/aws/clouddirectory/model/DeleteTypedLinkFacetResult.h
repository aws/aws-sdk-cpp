...
namespace Model
{
  ...
  public:
    ...
    inline DeleteTypedLinkFacetResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeleteTypedLinkFacetResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeleteTypedLinkFacetResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
