...
class BatchReadOperation {
 public:
  ...
  void SetListObjectAttributes(ListObjectAttributesT&& value) {
    ...
    m_listObjectAttributes = std::forward<ListObjectAttributesT>(value);
  }
  template <typename ListObjectAttributesT = BatchListObjectAttributes>
  BatchReadOperation& WithListObjectAttributes(ListObjectAttributesT&& value) {
    SetListObjectAttributes(std::forward<ListObjectAttributesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetListObjectChildren(ListObjectChildrenT&& value) {
    ...
    m_listObjectChildren = std::forward<ListObjectChildrenT>(value);
  }
  template <typename ListObjectChildrenT = BatchListObjectChildren>
  BatchReadOperation& WithListObjectChildren(ListObjectChildrenT&& value) {
    SetListObjectChildren(std::forward<ListObjectChildrenT>(value));
    return *this;
  }
  ///@}
  ...
  void SetListAttachedIndices(ListAttachedIndicesT&& value) {
    ...
    m_listAttachedIndices = std::forward<ListAttachedIndicesT>(value);
  }
  template <typename ListAttachedIndicesT = BatchListAttachedIndices>
  BatchReadOperation& WithListAttachedIndices(ListAttachedIndicesT&& value) {
    SetListAttachedIndices(std::forward<ListAttachedIndicesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetListObjectParentPaths(ListObjectParentPathsT&& value) {
    ...
    m_listObjectParentPaths = std::forward<ListObjectParentPathsT>(value);
  }
  template <typename ListObjectParentPathsT = BatchListObjectParentPaths>
  BatchReadOperation& WithListObjectParentPaths(ListObjectParentPathsT&& value) {
    SetListObjectParentPaths(std::forward<ListObjectParentPathsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGetObjectInformation(GetObjectInformationT&& value) {
    ...
    m_getObjectInformation = std::forward<GetObjectInformationT>(value);
  }
  template <typename GetObjectInformationT = BatchGetObjectInformation>
  BatchReadOperation& WithGetObjectInformation(GetObjectInformationT&& value) {
    SetGetObjectInformation(std::forward<GetObjectInformationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGetObjectAttributes(GetObjectAttributesT&& value) {
    ...
    m_getObjectAttributes = std::forward<GetObjectAttributesT>(value);
  }
  template <typename GetObjectAttributesT = BatchGetObjectAttributes>
  BatchReadOperation& WithGetObjectAttributes(GetObjectAttributesT&& value) {
    SetGetObjectAttributes(std::forward<GetObjectAttributesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetListObjectParents(ListObjectParentsT&& value) {
    ...
    m_listObjectParents = std::forward<ListObjectParentsT>(value);
  }
  template <typename ListObjectParentsT = BatchListObjectParents>
  BatchReadOperation& WithListObjectParents(ListObjectParentsT&& value) {
    SetListObjectParents(std::forward<ListObjectParentsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetListObjectPolicies(ListObjectPoliciesT&& value) {
    ...
    m_listObjectPolicies = std::forward<ListObjectPoliciesT>(value);
  }
  template <typename ListObjectPoliciesT = BatchListObjectPolicies>
  BatchReadOperation& WithListObjectPolicies(ListObjectPoliciesT&& value) {
    SetListObjectPolicies(std::forward<ListObjectPoliciesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetListPolicyAttachments(ListPolicyAttachmentsT&& value) {
    ...
    m_listPolicyAttachments = std::forward<ListPolicyAttachmentsT>(value);
  }
  template <typename ListPolicyAttachmentsT = BatchListPolicyAttachments>
  BatchReadOperation& WithListPolicyAttachments(ListPolicyAttachmentsT&& value) {
    SetListPolicyAttachments(std::forward<ListPolicyAttachmentsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLookupPolicy(LookupPolicyT&& value) {
    ...
    m_lookupPolicy = std::forward<LookupPolicyT>(value);
  }
  template <typename LookupPolicyT = BatchLookupPolicy>
  BatchReadOperation& WithLookupPolicy(LookupPolicyT&& value) {
    SetLookupPolicy(std::forward<LookupPolicyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetListIndex(ListIndexT&& value) {
    ...
    m_listIndex = std::forward<ListIndexT>(value);
  }
  template <typename ListIndexT = BatchListIndex>
  BatchReadOperation& WithListIndex(ListIndexT&& value) {
    SetListIndex(std::forward<ListIndexT>(value));
    return *this;
  }
  ///@}
  ...
  void SetListOutgoingTypedLinks(ListOutgoingTypedLinksT&& value) {
    ...
    m_listOutgoingTypedLinks = std::forward<ListOutgoingTypedLinksT>(value);
  }
  template <typename ListOutgoingTypedLinksT = BatchListOutgoingTypedLinks>
  BatchReadOperation& WithListOutgoingTypedLinks(ListOutgoingTypedLinksT&& value) {
    SetListOutgoingTypedLinks(std::forward<ListOutgoingTypedLinksT>(value));
    return *this;
  }
  ///@}
  ...
  void SetListIncomingTypedLinks(ListIncomingTypedLinksT&& value) {
    ...
    m_listIncomingTypedLinks = std::forward<ListIncomingTypedLinksT>(value);
  }
  template <typename ListIncomingTypedLinksT = BatchListIncomingTypedLinks>
  BatchReadOperation& WithListIncomingTypedLinks(ListIncomingTypedLinksT&& value) {
    SetListIncomingTypedLinks(std::forward<ListIncomingTypedLinksT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGetLinkAttributes(GetLinkAttributesT&& value) {
    ...
    m_getLinkAttributes = std::forward<GetLinkAttributesT>(value);
  }
  template <typename GetLinkAttributesT = BatchGetLinkAttributes>
  BatchReadOperation& WithGetLinkAttributes(GetLinkAttributesT&& value) {
    SetGetLinkAttributes(std::forward<GetLinkAttributesT>(value));
    return *this;
  }
  ///@}
 private:
