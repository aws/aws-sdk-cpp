...
class ListTypedLinkFacetAttributesResult {
 public:
  ...
  AWS_CLOUDDIRECTORY_API ListTypedLinkFacetAttributesResult& operator=(
  ...
  template <typename AttributesT = Aws::Vector<TypedLinkAttributeDefinition>>
  ListTypedLinkFacetAttributesResult& WithAttributes(AttributesT&& value) {
    SetAttributes(std::forward<AttributesT>(value));
    return *this;
  }
  template <typename AttributesT = TypedLinkAttributeDefinition>
  ListTypedLinkFacetAttributesResult& AddAttributes(AttributesT&& value) {
    m_attributesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListTypedLinkFacetAttributesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListTypedLinkFacetAttributesResult& WithRequestId(RequestIdT&& value) {
