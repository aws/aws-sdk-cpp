...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDDIRECTORY_API DeleteTypedLinkFacetRequest() = default;
    ...
    template<typename SchemaArnT = Aws::String>
    DeleteTypedLinkFacetRequest& WithSchemaArn(SchemaArnT&& value) { SetSchemaArn(std::forward<SchemaArnT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    DeleteTypedLinkFacetRequest& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
  private:
