...
class BatchListPolicyAttachments {
 public:
  ...
  template <typename PolicyReferenceT = ObjectReference>
  BatchListPolicyAttachments& WithPolicyReference(PolicyReferenceT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  BatchListPolicyAttachments& WithNextToken(NextTokenT&& value) {
  ...
  inline BatchListPolicyAttachments& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
