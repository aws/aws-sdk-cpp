...
class ObjectAttributeAction {
 public:
  ...
  inline void SetObjectAttributeActionType(UpdateActionType value) {
    m_objectAttributeActionTypeHasBeenSet = true;
    m_objectAttributeActionType = value;
  }
  inline ObjectAttributeAction& WithObjectAttributeActionType(UpdateActionType value) {
    SetObjectAttributeActionType(value);
    return *this;
  }
  ///@}
  ...
  void SetObjectAttributeUpdateValue(ObjectAttributeUpdateValueT&& value) {
    ...
    m_objectAttributeUpdateValue = std::forward<ObjectAttributeUpdateValueT>(value);
  }
  template <typename ObjectAttributeUpdateValueT = TypedAttributeValue>
  ObjectAttributeAction& WithObjectAttributeUpdateValue(ObjectAttributeUpdateValueT&& value) {
    SetObjectAttributeUpdateValue(std::forward<ObjectAttributeUpdateValueT>(value));
    return *this;
  }
  ///@}
 private:
