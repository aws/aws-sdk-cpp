...
namespace Model
{
  ...
  public:
    ...
    inline UpdateFacetResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateFacetResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateFacetResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
