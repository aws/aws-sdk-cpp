...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDDIRECTORY_API UpdateFacetResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateFacetResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
