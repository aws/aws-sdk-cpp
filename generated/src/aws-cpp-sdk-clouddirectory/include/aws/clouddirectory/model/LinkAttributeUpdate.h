...
class LinkAttributeUpdate {
 public:
  ...
  void SetAttributeKey(AttributeKeyT&& value) {
    ...
    m_attributeKey = std::forward<AttributeKeyT>(value);
  }
  template <typename AttributeKeyT = AttributeKey>
  LinkAttributeUpdate& WithAttributeKey(AttributeKeyT&& value) {
    SetAttributeKey(std::forward<AttributeKeyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAttributeAction(AttributeActionT&& value) {
    ...
    m_attributeAction = std::forward<AttributeActionT>(value);
  }
  template <typename AttributeActionT = LinkAttributeAction>
  LinkAttributeUpdate& WithAttributeAction(AttributeActionT&& value) {
    SetAttributeAction(std::forward<AttributeActionT>(value));
    return *this;
  }
  ///@}
 private:
