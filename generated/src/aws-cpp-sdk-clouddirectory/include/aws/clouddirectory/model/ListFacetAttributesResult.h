...
class ListFacetAttributesResult {
 public:
  ...
  template <typename AttributesT = Aws::Vector<FacetAttribute>>
  ListFacetAttributesResult& WithAttributes(AttributesT&& value) {
    SetAttributes(std::forward<AttributesT>(value));
    return *this;
  }
  template <typename AttributesT = FacetAttribute>
  ListFacetAttributesResult& AddAttributes(AttributesT&& value) {
    m_attributesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListFacetAttributesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListFacetAttributesResult& WithRequestId(RequestIdT&& value) {
