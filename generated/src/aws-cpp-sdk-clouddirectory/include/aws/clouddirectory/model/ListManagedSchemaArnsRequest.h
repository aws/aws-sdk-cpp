...
class ListManagedSchemaArnsRequest : public CloudDirectoryRequest {
 public:
  ...
  template <typename SchemaArnT = Aws::String>
  ListManagedSchemaArnsRequest& WithSchemaArn(SchemaArnT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListManagedSchemaArnsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListManagedSchemaArnsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
