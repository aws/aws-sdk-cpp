...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDDIRECTORY_API ListManagedSchemaArnsRequest() = default;
    ...
    template<typename SchemaArnT = Aws::String>
    ListManagedSchemaArnsRequest& WithSchemaArn(SchemaArnT&& value) { SetSchemaArn(std::forward<SchemaArnT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListManagedSchemaArnsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
