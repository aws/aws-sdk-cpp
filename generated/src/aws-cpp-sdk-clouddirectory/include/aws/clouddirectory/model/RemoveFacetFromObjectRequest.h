...
class RemoveFacetFromObjectRequest : public CloudDirectoryRequest {
 public:
  ...
  template <typename DirectoryArnT = Aws::String>
  RemoveFacetFromObjectRequest& WithDirectoryArn(DirectoryArnT&& value) {
  ...
  template <typename SchemaFacetT = SchemaFacet>
  RemoveFacetFromObjectRequest& WithSchemaFacet(SchemaFacetT&& value) {
  ...
  template <typename ObjectReferenceT = ObjectReference>
  RemoveFacetFromObjectRequest& WithObjectReference(ObjectReferenceT&& value) {
