...
class BatchReadException {
 public:
  ...
  inline void SetType(BatchReadExceptionType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline BatchReadException& WithType(BatchReadExceptionType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename MessageT = Aws::String>
  BatchReadException& WithMessage(MessageT&& value) {
