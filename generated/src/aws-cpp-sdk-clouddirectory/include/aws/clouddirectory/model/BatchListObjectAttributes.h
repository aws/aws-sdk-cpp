...
class BatchListObjectAttributes {
 public:
  ...
  template <typename ObjectReferenceT = ObjectReference>
  BatchListObjectAttributes& WithObjectReference(ObjectReferenceT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  BatchListObjectAttributes& WithNextToken(NextTokenT&& value) {
  ...
  inline BatchListObjectAttributes& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename FacetFilterT = SchemaFacet>
  BatchListObjectAttributes& WithFacetFilter(FacetFilterT&& value) {
