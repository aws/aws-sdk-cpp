...
class BatchListOutgoingTypedLinksResponse {
 public:
  ...
  void SetTypedLinkSpecifiers(TypedLinkSpecifiersT&& value) {
    m_typedLinkSpecifiersHasBeenSet = true;
    m_typedLinkSpecifiers = std::forward<TypedLinkSpecifiersT>(value);
  }
  template <typename TypedLinkSpecifiersT = Aws::Vector<TypedLinkSpecifier>>
  BatchListOutgoingTypedLinksResponse& WithTypedLinkSpecifiers(TypedLinkSpecifiersT&& value) {
    SetTypedLinkSpecifiers(std::forward<TypedLinkSpecifiersT>(value));
    return *this;
  }
  template <typename TypedLinkSpecifiersT = TypedLinkSpecifier>
  BatchListOutgoingTypedLinksResponse& AddTypedLinkSpecifiers(TypedLinkSpecifiersT&& value) {
    m_typedLinkSpecifiersHasBeenSet = true;
    m_typedLinkSpecifiers.emplace_back(std::forward<TypedLinkSpecifiersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  BatchListOutgoingTypedLinksResponse& WithNextToken(NextTokenT&& value) {
