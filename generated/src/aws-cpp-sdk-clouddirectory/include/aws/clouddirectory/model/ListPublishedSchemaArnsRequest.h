...
/**
 */
class ListPublishedSchemaArnsRequest : public CloudDirectoryRequest {
 public:
  AWS_CLOUDDIRECTORY_API ListPublishedSchemaArnsRequest() = default;
  ...
  template <typename SchemaArnT = Aws::String>
  ListPublishedSchemaArnsRequest& WithSchemaArn(SchemaArnT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListPublishedSchemaArnsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListPublishedSchemaArnsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
