...
/**
 */
class ListPolicyAttachmentsRequest : public CloudDirectoryRequest {
 public:
  AWS_CLOUDDIRECTORY_API ListPolicyAttachmentsRequest() = default;
  ...
  template <typename DirectoryArnT = Aws::String>
  ListPolicyAttachmentsRequest& WithDirectoryArn(DirectoryArnT&& value) {
  ...
  template <typename PolicyReferenceT = ObjectReference>
  ListPolicyAttachmentsRequest& WithPolicyReference(PolicyReferenceT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListPolicyAttachmentsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListPolicyAttachmentsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline ListPolicyAttachmentsRequest& WithConsistencyLevel(ConsistencyLevel value) {
