...
class ListIncomingTypedLinksRequest : public CloudDirectoryRequest {
 public:
  ...
  template <typename DirectoryArnT = Aws::String>
  ListIncomingTypedLinksRequest& WithDirectoryArn(DirectoryArnT&& value) {
  ...
  template <typename ObjectReferenceT = ObjectReference>
  ListIncomingTypedLinksRequest& WithObjectReference(ObjectReferenceT&& value) {
  ...
  void SetFilterAttributeRanges(FilterAttributeRangesT&& value) {
    m_filterAttributeRangesHasBeenSet = true;
    m_filterAttributeRanges = std::forward<FilterAttributeRangesT>(value);
  }
  template <typename FilterAttributeRangesT = Aws::Vector<TypedLinkAttributeRange>>
  ListIncomingTypedLinksRequest& WithFilterAttributeRanges(FilterAttributeRangesT&& value) {
    SetFilterAttributeRanges(std::forward<FilterAttributeRangesT>(value));
    return *this;
  }
  template <typename FilterAttributeRangesT = TypedLinkAttributeRange>
  ListIncomingTypedLinksRequest& AddFilterAttributeRanges(FilterAttributeRangesT&& value) {
    m_filterAttributeRangesHasBeenSet = true;
    m_filterAttributeRanges.emplace_back(std::forward<FilterAttributeRangesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFilterTypedLink(FilterTypedLinkT&& value) {
    m_filterTypedLinkHasBeenSet = true;
    m_filterTypedLink = std::forward<FilterTypedLinkT>(value);
  }
  template <typename FilterTypedLinkT = TypedLinkSchemaAndFacetName>
  ListIncomingTypedLinksRequest& WithFilterTypedLink(FilterTypedLinkT&& value) {
    SetFilterTypedLink(std::forward<FilterTypedLinkT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListIncomingTypedLinksRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListIncomingTypedLinksRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline ListIncomingTypedLinksRequest& WithConsistencyLevel(ConsistencyLevel value) {
