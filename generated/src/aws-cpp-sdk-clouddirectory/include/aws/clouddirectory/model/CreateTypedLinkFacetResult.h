...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDDIRECTORY_API CreateTypedLinkFacetResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    CreateTypedLinkFacetResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
