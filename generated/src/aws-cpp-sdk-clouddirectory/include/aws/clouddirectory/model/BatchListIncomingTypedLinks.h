...
class BatchListIncomingTypedLinks {
 public:
  ...
  template <typename ObjectReferenceT = ObjectReference>
  BatchListIncomingTypedLinks& WithObjectReference(ObjectReferenceT&& value) {
  ...
  template <typename FilterAttributeRangesT = Aws::Vector<TypedLinkAttributeRange>>
  BatchListIncomingTypedLinks& WithFilterAttributeRanges(FilterAttributeRangesT&& value) {
  ...
  BatchListIncomingTypedLinks& AddFilterAttributeRanges(FilterAttributeRangesT&& value) {
    m_filterAttributeRangesHasBeenSet = true;
  ...
  template <typename FilterTypedLinkT = TypedLinkSchemaAndFacetName>
  BatchListIncomingTypedLinks& WithFilterTypedLink(FilterTypedLinkT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  BatchListIncomingTypedLinks& WithNextToken(NextTokenT&& value) {
  ...
  inline BatchListIncomingTypedLinks& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
