...
class ListAttachedIndicesResult {
 public:
  ...
  template <typename IndexAttachmentsT = Aws::Vector<IndexAttachment>>
  ListAttachedIndicesResult& WithIndexAttachments(IndexAttachmentsT&& value) {
    SetIndexAttachments(std::forward<IndexAttachmentsT>(value));
    return *this;
  }
  template <typename IndexAttachmentsT = IndexAttachment>
  ListAttachedIndicesResult& AddIndexAttachments(IndexAttachmentsT&& value) {
    m_indexAttachmentsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListAttachedIndicesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAttachedIndicesResult& WithRequestId(RequestIdT&& value) {
