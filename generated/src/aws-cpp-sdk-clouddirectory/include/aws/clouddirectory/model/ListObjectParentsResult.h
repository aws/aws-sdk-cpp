...
class ListObjectParentsResult {
 public:
  ...
  template <typename ParentsT = Aws::Map<Aws::String, Aws::String>>
  ListObjectParentsResult& WithParents(ParentsT&& value) {
  ...
  ListObjectParentsResult& AddParents(ParentsKeyT&& key, ParentsValueT&& value) {
    m_parentsHasBeenSet = true;
    m_parents.emplace(std::forward<ParentsKeyT>(key), std::forward<ParentsValueT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListObjectParentsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ParentLinksT = Aws::Vector<ObjectIdentifierAndLinkNameTuple>>
  ListObjectParentsResult& WithParentLinks(ParentLinksT&& value) {
    SetParentLinks(std::forward<ParentLinksT>(value));
    return *this;
  }
  template <typename ParentLinksT = ObjectIdentifierAndLinkNameTuple>
  ListObjectParentsResult& AddParentLinks(ParentLinksT&& value) {
    m_parentLinksHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListObjectParentsResult& WithRequestId(RequestIdT&& value) {
