...
class BatchListIncomingTypedLinksResponse {
 public:
  ...
  template <typename LinkSpecifiersT = Aws::Vector<TypedLinkSpecifier>>
  BatchListIncomingTypedLinksResponse& WithLinkSpecifiers(LinkSpecifiersT&& value) {
    SetLinkSpecifiers(std::forward<LinkSpecifiersT>(value));
    return *this;
  }
  template <typename LinkSpecifiersT = TypedLinkSpecifier>
  BatchListIncomingTypedLinksResponse& AddLinkSpecifiers(LinkSpecifiersT&& value) {
    m_linkSpecifiersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  BatchListIncomingTypedLinksResponse& WithNextToken(NextTokenT&& value) {
