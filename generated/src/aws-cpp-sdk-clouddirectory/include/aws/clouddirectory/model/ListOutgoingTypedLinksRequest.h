...
class ListOutgoingTypedLinksRequest : public CloudDirectoryRequest {
 public:
  ...
  template <typename DirectoryArnT = Aws::String>
  ListOutgoingTypedLinksRequest& WithDirectoryArn(DirectoryArnT&& value) {
  ...
  template <typename ObjectReferenceT = ObjectReference>
  ListOutgoingTypedLinksRequest& WithObjectReference(ObjectReferenceT&& value) {
  ...
  template <typename FilterAttributeRangesT = Aws::Vector<TypedLinkAttributeRange>>
  ListOutgoingTypedLinksRequest& WithFilterAttributeRanges(FilterAttributeRangesT&& value) {
  ...
  ListOutgoingTypedLinksRequest& AddFilterAttributeRanges(FilterAttributeRangesT&& value) {
    m_filterAttributeRangesHasBeenSet = true;
  ...
  template <typename FilterTypedLinkT = TypedLinkSchemaAndFacetName>
  ListOutgoingTypedLinksRequest& WithFilterTypedLink(FilterTypedLinkT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListOutgoingTypedLinksRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListOutgoingTypedLinksRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline ListOutgoingTypedLinksRequest& WithConsistencyLevel(ConsistencyLevel value) {
