...
class BatchListAttachedIndices {
 public:
  ...
  template <typename TargetReferenceT = ObjectReference>
  BatchListAttachedIndices& WithTargetReference(TargetReferenceT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  BatchListAttachedIndices& WithNextToken(NextTokenT&& value) {
  ...
  inline BatchListAttachedIndices& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
