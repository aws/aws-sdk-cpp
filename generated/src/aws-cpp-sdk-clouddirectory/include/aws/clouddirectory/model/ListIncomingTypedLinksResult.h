...
class ListIncomingTypedLinksResult {
 public:
  ...
  void SetLinkSpecifiers(LinkSpecifiersT&& value) {
    m_linkSpecifiersHasBeenSet = true;
    m_linkSpecifiers = std::forward<LinkSpecifiersT>(value);
  }
  template <typename LinkSpecifiersT = Aws::Vector<TypedLinkSpecifier>>
  ListIncomingTypedLinksResult& WithLinkSpecifiers(LinkSpecifiersT&& value) {
    SetLinkSpecifiers(std::forward<LinkSpecifiersT>(value));
    return *this;
  }
  template <typename LinkSpecifiersT = TypedLinkSpecifier>
  ListIncomingTypedLinksResult& AddLinkSpecifiers(LinkSpecifiersT&& value) {
    m_linkSpecifiersHasBeenSet = true;
    m_linkSpecifiers.emplace_back(std::forward<LinkSpecifiersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListIncomingTypedLinksResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListIncomingTypedLinksResult& WithRequestId(RequestIdT&& value) {
