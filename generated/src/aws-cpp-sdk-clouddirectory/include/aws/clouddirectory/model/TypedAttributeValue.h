...
class TypedAttributeValue {
 public:
  ...
  template <typename StringValueT = Aws::String>
  TypedAttributeValue& WithStringValue(StringValueT&& value) {
  ...
  template <typename BinaryValueT = Aws::Utils::ByteBuffer>
  TypedAttributeValue& WithBinaryValue(BinaryValueT&& value) {
  ...
  inline TypedAttributeValue& WithBooleanValue(bool value) {
  ...
  void SetNumberValue(NumberValueT&& value) {
    m_numberValueHasBeenSet = true;
    m_numberValue = std::forward<NumberValueT>(value);
  }
  template <typename NumberValueT = Aws::String>
  TypedAttributeValue& WithNumberValue(NumberValueT&& value) {
    SetNumberValue(std::forward<NumberValueT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename DatetimeValueT = Aws::Utils::DateTime>
  TypedAttributeValue& WithDatetimeValue(DatetimeValueT&& value) {
