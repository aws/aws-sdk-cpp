...
namespace Model
{
  ...
  public:
    ...
    template<typename DirectoryArnT = Aws::String>
    ListObjectParentsRequest& WithDirectoryArn(DirectoryArnT&& value) { SetDirectoryArn(std::forward<DirectoryArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ObjectReferenceT = ObjectReference>
    ListObjectParentsRequest& WithObjectReference(ObjectReferenceT&& value) { SetObjectReference(std::forward<ObjectReferenceT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListObjectParentsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
