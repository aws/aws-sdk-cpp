...
class TypedLinkSchemaAndFacetName {
 public:
  ...
  template <typename SchemaArnT = Aws::String>
  TypedLinkSchemaAndFacetName& WithSchemaArn(SchemaArnT&& value) {
  ...
  void SetTypedLinkName(TypedLinkNameT&& value) {
    m_typedLinkNameHasBeenSet = true;
    m_typedLinkName = std::forward<TypedLinkNameT>(value);
  }
  template <typename TypedLinkNameT = Aws::String>
  TypedLinkSchemaAndFacetName& WithTypedLinkName(TypedLinkNameT&& value) {
    SetTypedLinkName(std::forward<TypedLinkNameT>(value));
    return *this;
  }
  ///@}
 private:
