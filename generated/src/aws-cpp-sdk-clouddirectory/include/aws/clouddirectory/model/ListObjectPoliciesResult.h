...
class ListObjectPoliciesResult {
 public:
  ...
  template <typename AttachedPolicyIdsT = Aws::Vector<Aws::String>>
  ListObjectPoliciesResult& WithAttachedPolicyIds(AttachedPolicyIdsT&& value) {
    SetAttachedPolicyIds(std::forward<AttachedPolicyIdsT>(value));
    return *this;
  }
  template <typename AttachedPolicyIdsT = Aws::String>
  ListObjectPoliciesResult& AddAttachedPolicyIds(AttachedPolicyIdsT&& value) {
    m_attachedPolicyIdsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListObjectPoliciesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListObjectPoliciesResult& WithRequestId(RequestIdT&& value) {
