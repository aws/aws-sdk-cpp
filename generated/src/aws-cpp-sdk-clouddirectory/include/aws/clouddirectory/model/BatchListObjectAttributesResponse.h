...
class BatchListObjectAttributesResponse {
 public:
  AWS_CLOUDDIRECTORY_API BatchListObjectAttributesResponse() = default;
  ...
  template <typename AttributesT = Aws::Vector<AttributeKeyAndValue>>
  BatchListObjectAttributesResponse& WithAttributes(AttributesT&& value) {
    SetAttributes(std::forward<AttributesT>(value));
    return *this;
  }
  template <typename AttributesT = AttributeKeyAndValue>
  BatchListObjectAttributesResponse& AddAttributes(AttributesT&& value) {
    m_attributesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  BatchListObjectAttributesResponse& WithNextToken(NextTokenT&& value) {
