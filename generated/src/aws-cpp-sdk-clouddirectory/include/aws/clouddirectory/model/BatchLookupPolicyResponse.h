...
class BatchLookupPolicyResponse {
 public:
  ...
  template <typename PolicyToPathListT = Aws::Vector<PolicyToPath>>
  BatchLookupPolicyResponse& WithPolicyToPathList(PolicyToPathListT&& value) {
    SetPolicyToPathList(std::forward<PolicyToPathListT>(value));
    return *this;
  }
  template <typename PolicyToPathListT = PolicyToPath>
  BatchLookupPolicyResponse& AddPolicyToPathList(PolicyToPathListT&& value) {
    m_policyToPathListHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  BatchLookupPolicyResponse& WithNextToken(NextTokenT&& value) {
