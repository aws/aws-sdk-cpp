...
class GetTypedLinkFacetInformationRequest : public CloudDirectoryRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "GetTypedLinkFacetInformation"; }
  ...
  template <typename SchemaArnT = Aws::String>
  GetTypedLinkFacetInformationRequest& WithSchemaArn(SchemaArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  GetTypedLinkFacetInformationRequest& WithName(NameT&& value) {
