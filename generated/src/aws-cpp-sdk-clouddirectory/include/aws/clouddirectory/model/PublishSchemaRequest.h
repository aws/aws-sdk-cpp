...
class PublishSchemaRequest : public CloudDirectoryRequest {
 public:
  ...
  template <typename DevelopmentSchemaArnT = Aws::String>
  PublishSchemaRequest& WithDevelopmentSchemaArn(DevelopmentSchemaArnT&& value) {
  ...
  template <typename VersionT = Aws::String>
  PublishSchemaRequest& WithVersion(VersionT&& value) {
  ...
  template <typename MinorVersionT = Aws::String>
  PublishSchemaRequest& WithMinorVersion(MinorVersionT&& value) {
  ...
  template <typename NameT = Aws::String>
  PublishSchemaRequest& WithName(NameT&& value) {
