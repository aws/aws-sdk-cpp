...
class TypedLinkAttributeDefinition {
 public:
  ...
  template <typename NameT = Aws::String>
  TypedLinkAttributeDefinition& WithName(NameT&& value) {
  ...
  inline void SetType(FacetAttributeType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline TypedLinkAttributeDefinition& WithType(FacetAttributeType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename DefaultValueT = TypedAttributeValue>
  TypedLinkAttributeDefinition& WithDefaultValue(DefaultValueT&& value) {
  ...
  inline void SetIsImmutable(bool value) {
    m_isImmutableHasBeenSet = true;
    m_isImmutable = value;
  }
  inline TypedLinkAttributeDefinition& WithIsImmutable(bool value) {
  ...
  template <typename RulesT = Aws::Map<Aws::String, Rule>>
  TypedLinkAttributeDefinition& WithRules(RulesT&& value) {
  ...
  TypedLinkAttributeDefinition& AddRules(RulesKeyT&& key, RulesValueT&& value) {
    m_rulesHasBeenSet = true;
    m_rules.emplace(std::forward<RulesKeyT>(key), std::forward<RulesValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetRequiredBehavior(RequiredAttributeBehavior value) {
    m_requiredBehaviorHasBeenSet = true;
    m_requiredBehavior = value;
  }
  inline TypedLinkAttributeDefinition& WithRequiredBehavior(RequiredAttributeBehavior value) {
    SetRequiredBehavior(value);
    return *this;
  }
  ///@}
 private:
