...
class AttributeKey {
 public:
  ...
  template <typename SchemaArnT = Aws::String>
  AttributeKey& WithSchemaArn(SchemaArnT&& value) {
  ...
  void SetFacetName(FacetNameT&& value) {
    m_facetNameHasBeenSet = true;
    m_facetName = std::forward<FacetNameT>(value);
  }
  template <typename FacetNameT = Aws::String>
  AttributeKey& WithFacetName(FacetNameT&& value) {
    SetFacetName(std::forward<FacetNameT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NameT = Aws::String>
  AttributeKey& WithName(NameT&& value) {
