...
class ListAppliedSchemaArnsRequest : public CloudDirectoryRequest {
 public:
  AWS_CLOUDDIRECTORY_API ListAppliedSchemaArnsRequest() = default;
  ...
  template <typename DirectoryArnT = Aws::String>
  ListAppliedSchemaArnsRequest& WithDirectoryArn(DirectoryArnT&& value) {
  ...
  template <typename SchemaArnT = Aws::String>
  ListAppliedSchemaArnsRequest& WithSchemaArn(SchemaArnT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListAppliedSchemaArnsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListAppliedSchemaArnsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
