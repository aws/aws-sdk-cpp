...
namespace Model
{
  ...
  public:
    ...
    template<typename DirectoryArnT = Aws::String>
    ListAppliedSchemaArnsRequest& WithDirectoryArn(DirectoryArnT&& value) { SetDirectoryArn(std::forward<DirectoryArnT>(value)); return *this;}
    ///@}
    ...
    template<typename SchemaArnT = Aws::String>
    ListAppliedSchemaArnsRequest& WithSchemaArn(SchemaArnT&& value) { SetSchemaArn(std::forward<SchemaArnT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListAppliedSchemaArnsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
