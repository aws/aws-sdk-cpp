...
class BatchListObjectPolicies {
 public:
  ...
  template <typename ObjectReferenceT = ObjectReference>
  BatchListObjectPolicies& WithObjectReference(ObjectReferenceT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  BatchListObjectPolicies& WithNextToken(NextTokenT&& value) {
  ...
  inline BatchListObjectPolicies& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
