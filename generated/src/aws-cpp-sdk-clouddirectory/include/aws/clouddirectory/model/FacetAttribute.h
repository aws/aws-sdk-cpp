...
class FacetAttribute {
 public:
  ...
  void SetAttributeDefinition(AttributeDefinitionT&& value) {
    ...
    m_attributeDefinition = std::forward<AttributeDefinitionT>(value);
  }
  template <typename AttributeDefinitionT = FacetAttributeDefinition>
  FacetAttribute& WithAttributeDefinition(AttributeDefinitionT&& value) {
    SetAttributeDefinition(std::forward<AttributeDefinitionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAttributeReference(AttributeReferenceT&& value) {
    ...
    m_attributeReference = std::forward<AttributeReferenceT>(value);
  }
  template <typename AttributeReferenceT = FacetAttributeReference>
  FacetAttribute& WithAttributeReference(AttributeReferenceT&& value) {
    SetAttributeReference(std::forward<AttributeReferenceT>(value));
    return *this;
  }
  ///@}
  ...
  inline FacetAttribute& WithRequiredBehavior(RequiredAttributeBehavior value) {
