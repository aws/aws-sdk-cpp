...
namespace Model
{
  ...
  public:
    ...
    template<typename ObjectReferenceT = ObjectReference>
    BatchListObjectParents& WithObjectReference(ObjectReferenceT&& value) { SetObjectReference(std::forward<ObjectReferenceT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    BatchListObjectParents& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
