...
class BatchListObjectParents {
 public:
  AWS_CLOUDDIRECTORY_API BatchListObjectParents() = default;
  ...
  template <typename ObjectReferenceT = ObjectReference>
  BatchListObjectParents& WithObjectReference(ObjectReferenceT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  BatchListObjectParents& WithNextToken(NextTokenT&& value) {
  ...
  inline BatchListObjectParents& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
