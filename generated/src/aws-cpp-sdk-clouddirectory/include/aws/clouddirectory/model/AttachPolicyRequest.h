...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDDIRECTORY_API AttachPolicyRequest() = default;
    ...
    template<typename DirectoryArnT = Aws::String>
    AttachPolicyRequest& WithDirectoryArn(DirectoryArnT&& value) { SetDirectoryArn(std::forward<DirectoryArnT>(value)); return *this;}
    ///@}
    ...
    template<typename PolicyReferenceT = ObjectReference>
    AttachPolicyRequest& WithPolicyReference(PolicyReferenceT&& value) { SetPolicyReference(std::forward<PolicyReferenceT>(value)); return *this;}
    ///@}
    ...
    template<typename ObjectReferenceT = ObjectReference>
    AttachPolicyRequest& WithObjectReference(ObjectReferenceT&& value) { SetObjectReference(std::forward<ObjectReferenceT>(value)); return *this;}
    ///@}
  private:
