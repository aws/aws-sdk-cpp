...
class AttachPolicyRequest : public CloudDirectoryRequest {
 public:
  ...
  template <typename DirectoryArnT = Aws::String>
  AttachPolicyRequest& WithDirectoryArn(DirectoryArnT&& value) {
  ...
  template <typename PolicyReferenceT = ObjectReference>
  AttachPolicyRequest& WithPolicyReference(PolicyReferenceT&& value) {
  ...
  template <typename ObjectReferenceT = ObjectReference>
  AttachPolicyRequest& WithObjectReference(ObjectReferenceT&& value) {
