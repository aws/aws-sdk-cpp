...
class BatchListPolicyAttachmentsResponse {
 public:
  ...
  template <typename ObjectIdentifiersT = Aws::Vector<Aws::String>>
  BatchListPolicyAttachmentsResponse& WithObjectIdentifiers(ObjectIdentifiersT&& value) {
    SetObjectIdentifiers(std::forward<ObjectIdentifiersT>(value));
    return *this;
  }
  template <typename ObjectIdentifiersT = Aws::String>
  BatchListPolicyAttachmentsResponse& AddObjectIdentifiers(ObjectIdentifiersT&& value) {
    m_objectIdentifiersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  BatchListPolicyAttachmentsResponse& WithNextToken(NextTokenT&& value) {
