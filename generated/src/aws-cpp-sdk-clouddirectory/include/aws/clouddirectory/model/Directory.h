...
class Directory {
 public:
  ...
  template <typename NameT = Aws::String>
  Directory& WithName(NameT&& value) {
  ...
  template <typename DirectoryArnT = Aws::String>
  Directory& WithDirectoryArn(DirectoryArnT&& value) {
  ...
  inline Directory& WithState(DirectoryState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreationDateTimeT = Aws::Utils::DateTime>
  Directory& WithCreationDateTime(CreationDateTimeT&& value) {
