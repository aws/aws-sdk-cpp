...
template <>
AWS_CLOUDDIRECTORY_API BatchWriteException CloudDirectoryError::GetModeledError() {
...
AWSError<CoreErrors> GetErrorForName(const char* errorName) {
  ...
  if (hashCode == LIMIT_EXCEEDED_HASH) {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(CloudDirectoryErrors::LIMIT_EXCEEDED), RetryableType::RETRYABLE_THROTTLING);
