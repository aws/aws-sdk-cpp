...
{
const size_t CloudDirectoryEndpointRules::RulesBlobStrLen = 3738;
const size_t CloudDirectoryEndpointRules::RulesBlobSize = 3739;
...
'"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','c','l','o','u','d','d','i','r','e','c',
't','o','r','y','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i',
...
'c','l','o','u','d','d','i','r','e','c','t','o','r','y','.','{','R','e','g','i','o','n','}','.','{',
...
'u','d','d','i','r','e','c','t','o','r','y','.','{','R','e','g','i','o','n','}','.','{','P','a','r',
...
const char* CloudDirectoryEndpointRules::GetRulesBlob()
{
