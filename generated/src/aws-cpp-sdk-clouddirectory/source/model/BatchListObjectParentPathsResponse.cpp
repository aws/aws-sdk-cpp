...
BatchListObjectParentPathsResponse::BatchListObjectParentPathsResponse(JsonView jsonValue) { *this = jsonValue; }
...
JsonValue BatchListObjectParentPathsResponse::Jsonize() const {
  ...
  if (m_pathToObjectIdentifiersListHasBeenSet) {
    ...
    for (unsigned pathToObjectIdentifiersListIndex = 0; pathToObjectIdentifiersListIndex < pathToObjectIdentifiersListJsonList.GetLength();
         ++pathToObjectIdentifiersListIndex) {
      pathToObjectIdentifiersListJsonList[pathToObjectIdentifiersListIndex].AsObject(
          m_pathToObjectIdentifiersList[pathToObjectIdentifiersListIndex].Jsonize());
    }
