...
BatchListOutgoingTypedLinksResponse::BatchListOutgoingTypedLinksResponse(JsonView jsonValue) { *this = jsonValue; }
...
BatchListOutgoingTypedLinksResponse& BatchListOutgoingTypedLinksResponse::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("TypedLinkSpecifiers")) {
    ...
    for (unsigned typedLinkSpecifiersIndex = 0; typedLinkSpecifiersIndex < typedLinkSpecifiersJsonList.GetLength();
         ++typedLinkSpecifiersIndex) {
