...
DisassociateLicenseResult::DisassociateLicenseResult()
{
}

DisassociateLicenseResult::DisassociateLicenseResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
