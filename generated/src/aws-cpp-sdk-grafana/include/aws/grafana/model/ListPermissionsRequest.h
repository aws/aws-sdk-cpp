...
namespace Model
{
  ...
  public:
    ...
    template<typename GroupIdT = Aws::String>
    ListPermissionsRequest& WithGroupId(GroupIdT&& value) { SetGroupId(std::forward<GroupIdT>(value)); return *this;}
    ///@}
    ...
    template<typename UserIdT = Aws::String>
    ListPermissionsRequest& WithUserId(UserIdT&& value) { SetUserId(std::forward<UserIdT>(value)); return *this;}
    ///@}
    ...
    inline ListPermissionsRequest& WithUserType(UserType value) { SetUserType(value); return *this;}
    ///@}
    ...
    template<typename WorkspaceIdT = Aws::String>
    ListPermissionsRequest& WithWorkspaceId(WorkspaceIdT&& value) { SetWorkspaceId(std::forward<WorkspaceIdT>(value)); return *this;}
    ///@}
  private:
