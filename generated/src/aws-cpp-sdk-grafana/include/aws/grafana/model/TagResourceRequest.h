...
namespace Model
{
  ...
  /**
   */
  class TagResourceRequest : public ManagedGrafanaRequest
  {
  public:
    AWS_MANAGEDGRAFANA_API TagResourceRequest() = default;
    ...
    ///@{
    /**
     * <p>The list of tag keys and values to associate with the resource. You can
