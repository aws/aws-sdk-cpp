...
class CreateWorkspaceServiceAccountTokenRequest : public ManagedGrafanaRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  CreateWorkspaceServiceAccountTokenRequest& WithName(NameT&& value) {
  ...
  inline void SetSecondsToLive(int value) {
    m_secondsToLiveHasBeenSet = true;
    m_secondsToLive = value;
  }
  inline CreateWorkspaceServiceAccountTokenRequest& WithSecondsToLive(int value) {
    SetSecondsToLive(value);
    return *this;
  }
  ///@}
  ...
  template <typename ServiceAccountIdT = Aws::String>
  CreateWorkspaceServiceAccountTokenRequest& WithServiceAccountId(ServiceAccountIdT&& value) {
  ...
  template <typename WorkspaceIdT = Aws::String>
  CreateWorkspaceServiceAccountTokenRequest& WithWorkspaceId(WorkspaceIdT&& value) {
