...
class CreateWorkspaceApiKeyRequest : public ManagedGrafanaRequest {
 public:
  ...
  template <typename KeyNameT = Aws::String>
  CreateWorkspaceApiKeyRequest& WithKeyName(KeyNameT&& value) {
  ...
  void SetKeyRole(KeyRoleT&& value) {
    m_keyRoleHasBeenSet = true;
    m_keyRole = std::forward<KeyRoleT>(value);
  }
  template <typename KeyRoleT = Aws::String>
  CreateWorkspaceApiKeyRequest& WithKeyRole(KeyRoleT&& value) {
    SetKeyRole(std::forward<KeyRoleT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateWorkspaceApiKeyRequest& WithSecondsToLive(int value) {
  ...
  template <typename WorkspaceIdT = Aws::String>
  CreateWorkspaceApiKeyRequest& WithWorkspaceId(WorkspaceIdT&& value) {
