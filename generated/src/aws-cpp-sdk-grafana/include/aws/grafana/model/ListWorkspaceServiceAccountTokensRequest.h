...
class ListWorkspaceServiceAccountTokensRequest : public ManagedGrafanaRequest {
 public:
  ...
  inline ListWorkspaceServiceAccountTokensRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListWorkspaceServiceAccountTokensRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ServiceAccountIdT = Aws::String>
  ListWorkspaceServiceAccountTokensRequest& WithServiceAccountId(ServiceAccountIdT&& value) {
  ...
  template <typename WorkspaceIdT = Aws::String>
  ListWorkspaceServiceAccountTokensRequest& WithWorkspaceId(WorkspaceIdT&& value) {
