...
namespace Model
{
  ...
  {
  public:
    AWS_MANAGEDGRAFANA_API ListTagsForResourceResult() = default;
    AWS_MANAGEDGRAFANA_API ListTagsForResourceResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_MANAGEDGRAFANA_API ListTagsForResourceResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
