...
namespace Model
{
  ...
  public:
    ...
    inline UpdateWorkspaceRequest& WithAccountAccessType(AccountAccessType value) { SetAccountAccessType(value); return *this;}
    ///@}
    ...
    template<typename NetworkAccessControlT = NetworkAccessConfiguration>
    UpdateWorkspaceRequest& WithNetworkAccessControl(NetworkAccessControlT&& value) { SetNetworkAccessControl(std::forward<NetworkAccessControlT>(value)); return *this;}
    ///@}
    ...
    template<typename OrganizationRoleNameT = Aws::String>
    UpdateWorkspaceRequest& WithOrganizationRoleName(OrganizationRoleNameT&& value) { SetOrganizationRoleName(std::forward<OrganizationRoleNameT>(value)); return *this;}
    ///@}
    ...
    inline UpdateWorkspaceRequest& WithPermissionType(PermissionType value) { SetPermissionType(value); return *this;}
    ///@}
    ...
    template<typename StackSetNameT = Aws::String>
    UpdateWorkspaceRequest& WithStackSetName(StackSetNameT&& value) { SetStackSetName(std::forward<StackSetNameT>(value)); return *this;}
    ///@}
    ...
    template<typename VpcConfigurationT = VpcConfiguration>
    UpdateWorkspaceRequest& WithVpcConfiguration(VpcConfigurationT&& value) { SetVpcConfiguration(std::forward<VpcConfigurationT>(value)); return *this;}
    ///@}
    ...
    template<typename WorkspaceDataSourcesT = Aws::Vector<DataSourceType>>
    UpdateWorkspaceRequest& WithWorkspaceDataSources(WorkspaceDataSourcesT&& value) { SetWorkspaceDataSources(std::forward<WorkspaceDataSourcesT>(value)); return *this;}
    inline UpdateWorkspaceRequest& AddWorkspaceDataSources(DataSourceType value) { m_workspaceDataSourcesHasBeenSet = true; m_workspaceDataSources.push_back(value); return *this; }
    ///@}
    ...
    template<typename WorkspaceDescriptionT = Aws::String>
    UpdateWorkspaceRequest& WithWorkspaceDescription(WorkspaceDescriptionT&& value) { SetWorkspaceDescription(std::forward<WorkspaceDescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename WorkspaceIdT = Aws::String>
    UpdateWorkspaceRequest& WithWorkspaceId(WorkspaceIdT&& value) { SetWorkspaceId(std::forward<WorkspaceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename WorkspaceNameT = Aws::String>
    UpdateWorkspaceRequest& WithWorkspaceName(WorkspaceNameT&& value) { SetWorkspaceName(std::forward<WorkspaceNameT>(value)); return *this;}
    ///@}
    ...
    template<typename WorkspaceNotificationDestinationsT = Aws::Vector<NotificationDestinationType>>
    UpdateWorkspaceRequest& WithWorkspaceNotificationDestinations(WorkspaceNotificationDestinationsT&& value) { SetWorkspaceNotificationDestinations(std::forward<WorkspaceNotificationDestinationsT>(value)); return *this;}
    inline UpdateWorkspaceRequest& AddWorkspaceNotificationDestinations(NotificationDestinationType value) { m_workspaceNotificationDestinationsHasBeenSet = true; m_workspaceNotificationDestinations.push_back(value); return *this; }
    ///@}
    ...
    template<typename WorkspaceOrganizationalUnitsT = Aws::Vector<Aws::String>>
    UpdateWorkspaceRequest& WithWorkspaceOrganizationalUnits(WorkspaceOrganizationalUnitsT&& value) { SetWorkspaceOrganizationalUnits(std::forward<WorkspaceOrganizationalUnitsT>(value)); return *this;}
    template<typename WorkspaceOrganizationalUnitsT = Aws::String>
    UpdateWorkspaceRequest& AddWorkspaceOrganizationalUnits(WorkspaceOrganizationalUnitsT&& value) { m_workspaceOrganizationalUnitsHasBeenSet = true; m_workspaceOrganizationalUnits.emplace_back(std::forward<WorkspaceOrganizationalUnitsT>(value)); return *this; }
    ///@}
    ...
    template<typename WorkspaceRoleArnT = Aws::String>
    UpdateWorkspaceRequest& WithWorkspaceRoleArn(WorkspaceRoleArnT&& value) { SetWorkspaceRoleArn(std::forward<WorkspaceRoleArnT>(value)); return *this;}
    ///@}
  private:
