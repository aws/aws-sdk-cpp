...
class ListWorkspaceServiceAccountsResult {
 public:
  ...
  AWS_MANAGEDGRAFANA_API ListWorkspaceServiceAccountsResult& operator=(
  ...
  template <typename NextTokenT = Aws::String>
  ListWorkspaceServiceAccountsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetServiceAccounts(ServiceAccountsT&& value) {
    m_serviceAccountsHasBeenSet = true;
    m_serviceAccounts = std::forward<ServiceAccountsT>(value);
  }
  template <typename ServiceAccountsT = Aws::Vector<ServiceAccountSummary>>
  ListWorkspaceServiceAccountsResult& WithServiceAccounts(ServiceAccountsT&& value) {
    SetServiceAccounts(std::forward<ServiceAccountsT>(value));
    return *this;
  }
  template <typename ServiceAccountsT = ServiceAccountSummary>
  ListWorkspaceServiceAccountsResult& AddServiceAccounts(ServiceAccountsT&& value) {
    m_serviceAccountsHasBeenSet = true;
    m_serviceAccounts.emplace_back(std::forward<ServiceAccountsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename WorkspaceIdT = Aws::String>
  ListWorkspaceServiceAccountsResult& WithWorkspaceId(WorkspaceIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListWorkspaceServiceAccountsResult& WithRequestId(RequestIdT&& value) {
