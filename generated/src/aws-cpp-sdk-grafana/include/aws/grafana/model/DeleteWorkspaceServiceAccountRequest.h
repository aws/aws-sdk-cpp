...
class DeleteWorkspaceServiceAccountRequest : public ManagedGrafanaRequest {
 public:
  ...
  template <typename ServiceAccountIdT = Aws::String>
  DeleteWorkspaceServiceAccountRequest& WithServiceAccountId(ServiceAccountIdT&& value) {
  ...
  template <typename WorkspaceIdT = Aws::String>
  DeleteWorkspaceServiceAccountRequest& WithWorkspaceId(WorkspaceIdT&& value) {
