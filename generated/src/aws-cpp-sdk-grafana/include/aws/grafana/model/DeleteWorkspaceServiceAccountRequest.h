...
namespace Model
{
  ...
  {
  public:
    AWS_MANAGEDGRAFANA_API DeleteWorkspaceServiceAccountRequest() = default;
    ...
    template<typename ServiceAccountIdT = Aws::String>
    DeleteWorkspaceServiceAccountRequest& WithServiceAccountId(ServiceAccountIdT&& value) { SetServiceAccountId(std::forward<ServiceAccountIdT>(value)); return *this;}
    ///@}
    ...
    template<typename WorkspaceIdT = Aws::String>
    DeleteWorkspaceServiceAccountRequest& WithWorkspaceId(WorkspaceIdT&& value) { SetWorkspaceId(std::forward<WorkspaceIdT>(value)); return *this;}
    ///@}
  private:
