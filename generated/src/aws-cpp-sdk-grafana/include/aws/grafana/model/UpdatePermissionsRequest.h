...
class UpdatePermissionsRequest : public ManagedGrafanaRequest {
 public:
  ...
  void SetUpdateInstructionBatch(UpdateInstructionBatchT&& value) {
    m_updateInstructionBatchHasBeenSet = true;
    m_updateInstructionBatch = std::forward<UpdateInstructionBatchT>(value);
  }
  template <typename UpdateInstructionBatchT = Aws::Vector<UpdateInstruction>>
  UpdatePermissionsRequest& WithUpdateInstructionBatch(UpdateInstructionBatchT&& value) {
    SetUpdateInstructionBatch(std::forward<UpdateInstructionBatchT>(value));
    return *this;
  }
  ...
  UpdatePermissionsRequest& AddUpdateInstructionBatch(UpdateInstructionBatchT&& value) {
    m_updateInstructionBatchHasBeenSet = true;
    m_updateInstructionBatch.emplace_back(std::forward<UpdateInstructionBatchT>(value));
    return *this;
  }
  ///@}
