...
class DeleteWorkspaceApiKeyRequest : public ManagedGrafanaRequest {
 public:
  AWS_MANAGEDGRAFANA_API DeleteWorkspaceApiKeyRequest() = default;
  ...
  template <typename KeyNameT = Aws::String>
  DeleteWorkspaceApiKeyRequest& WithKeyName(KeyNameT&& value) {
  ...
  template <typename WorkspaceIdT = Aws::String>
  DeleteWorkspaceApiKeyRequest& WithWorkspaceId(WorkspaceIdT&& value) {
