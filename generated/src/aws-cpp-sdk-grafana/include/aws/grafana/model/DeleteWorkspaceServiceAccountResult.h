...
class DeleteWorkspaceServiceAccountResult {
 public:
  ...
  AWS_MANAGEDGRAFANA_API DeleteWorkspaceServiceAccountResult& operator=(
  ...
  template <typename ServiceAccountIdT = Aws::String>
  DeleteWorkspaceServiceAccountResult& WithServiceAccountId(ServiceAccountIdT&& value) {
  ...
  template <typename WorkspaceIdT = Aws::String>
  DeleteWorkspaceServiceAccountResult& WithWorkspaceId(WorkspaceIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteWorkspaceServiceAccountResult& WithRequestId(RequestIdT&& value) {
