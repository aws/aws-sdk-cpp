...
namespace Model
{
  ...
  public:
    ...
    inline ServiceAccountSummary& WithGrafanaRole(Role value) { SetGrafanaRole(value); return *this;}
    ///@}
    ...
    template<typename IdT = Aws::String>
    ServiceAccountSummary& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    void SetIsDisabled(IsDisabledT&& value) { m_isDisabledHasBeenSet = true; m_isDisabled = std::forward<IsDisabledT>(value); }
    template<typename IsDisabledT = Aws::String>
    ServiceAccountSummary& WithIsDisabled(IsDisabledT&& value) { SetIsDisabled(std::forward<IsDisabledT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    ServiceAccountSummary& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
  private:
