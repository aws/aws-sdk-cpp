...
namespace Model
{
  ...
  {
  public:
    AWS_MANAGEDGRAFANA_API ListWorkspaceServiceAccountsRequest() = default;
    ...
    template<typename NextTokenT = Aws::String>
    ListWorkspaceServiceAccountsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename WorkspaceIdT = Aws::String>
    ListWorkspaceServiceAccountsRequest& WithWorkspaceId(WorkspaceIdT&& value) { SetWorkspaceId(std::forward<WorkspaceIdT>(value)); return *this;}
    ///@}
  private:
