...
class ListWorkspaceServiceAccountsRequest : public ManagedGrafanaRequest {
 public:
  ...
  inline ListWorkspaceServiceAccountsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListWorkspaceServiceAccountsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename WorkspaceIdT = Aws::String>
  ListWorkspaceServiceAccountsRequest& WithWorkspaceId(WorkspaceIdT&& value) {
