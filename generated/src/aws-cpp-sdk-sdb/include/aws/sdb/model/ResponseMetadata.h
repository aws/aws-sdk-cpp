...
namespace Model
{
  ...
  {
  public:
    AWS_SIMPLEDB_API ResponseMetadata() = default;
    AWS_SIMPLEDB_API ResponseMetadata(const Aws::Utils::Xml::XmlNode& xmlNode);
    AWS_SIMPLEDB_API ResponseMetadata& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
