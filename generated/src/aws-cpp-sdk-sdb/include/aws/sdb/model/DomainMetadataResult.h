...
class DomainMetadataResult {
 public:
  ...
  inline DomainMetadataResult& WithItemCount(int value) {
    SetItemCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetItemNamesSizeBytes(long long value) {
    m_itemNamesSizeBytesHasBeenSet = true;
    m_itemNamesSizeBytes = value;
  }
  inline DomainMetadataResult& WithItemNamesSizeBytes(long long value) {
  ...
  inline void SetAttributeNameCount(int value) {
    m_attributeNameCountHasBeenSet = true;
    m_attributeNameCount = value;
  }
  inline DomainMetadataResult& WithAttributeNameCount(int value) {
  ...
  inline void SetAttributeNamesSizeBytes(long long value) {
    m_attributeNamesSizeBytesHasBeenSet = true;
    m_attributeNamesSizeBytes = value;
  }
  inline DomainMetadataResult& WithAttributeNamesSizeBytes(long long value) {
  ...
  inline void SetAttributeValueCount(int value) {
    m_attributeValueCountHasBeenSet = true;
    m_attributeValueCount = value;
  }
  inline DomainMetadataResult& WithAttributeValueCount(int value) {
  ...
  inline void SetAttributeValuesSizeBytes(long long value) {
    m_attributeValuesSizeBytesHasBeenSet = true;
    m_attributeValuesSizeBytes = value;
  }
  inline DomainMetadataResult& WithAttributeValuesSizeBytes(long long value) {
  ...
  inline void SetTimestamp(int value) {
    m_timestampHasBeenSet = true;
    m_timestamp = value;
  }
  inline DomainMetadataResult& WithTimestamp(int value) {
    SetTimestamp(value);
    return *this;
  }
  ///@}
