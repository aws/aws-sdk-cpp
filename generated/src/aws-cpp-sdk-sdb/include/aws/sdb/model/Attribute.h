...
class Attribute {
 public:
  ...
  void SetAlternateNameEncoding(AlternateNameEncodingT&& value) {
    ...
    m_alternateNameEncoding = std::forward<AlternateNameEncodingT>(value);
  }
  template <typename AlternateNameEncodingT = Aws::String>
  Attribute& WithAlternateNameEncoding(AlternateNameEncodingT&& value) {
    SetAlternateNameEncoding(std::forward<AlternateNameEncodingT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAlternateValueEncoding(AlternateValueEncodingT&& value) {
    ...
    m_alternateValueEncoding = std::forward<AlternateValueEncodingT>(value);
  }
  template <typename AlternateValueEncodingT = Aws::String>
  Attribute& WithAlternateValueEncoding(AlternateValueEncodingT&& value) {
    SetAlternateValueEncoding(std::forward<AlternateValueEncodingT>(value));
    return *this;
  }
  ///@}
 private:
