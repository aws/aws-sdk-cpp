...
class SelectRequest : public SimpleDBRequest {
 ...
 public:
  ...
  void SetSelectExpression(SelectExpressionT&& value) {
    m_selectExpressionHasBeenSet = true;
    m_selectExpression = std::forward<SelectExpressionT>(value);
  }
  template <typename SelectExpressionT = Aws::String>
  SelectRequest& WithSelectExpression(SelectExpressionT&& value) {
    SetSelectExpression(std::forward<SelectExpressionT>(value));
    return *this;
  }
  ///@}
  ...
  inline SelectRequest& WithConsistentRead(bool value) {
