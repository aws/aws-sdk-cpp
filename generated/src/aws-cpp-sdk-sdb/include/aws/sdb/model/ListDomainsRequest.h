...
class ListDomainsRequest : public SimpleDBRequest {
 ...
 public:
  ...
  inline void SetMaxNumberOfDomains(int value) {
    m_maxNumberOfDomainsHasBeenSet = true;
    m_maxNumberOfDomains = value;
  }
  inline ListDomainsRequest& WithMaxNumberOfDomains(int value) {
