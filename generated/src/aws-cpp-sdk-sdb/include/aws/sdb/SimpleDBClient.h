...
class AWS_SIMPLEDB_API SimpleDBClient : public Aws::Client::AWSXMLClient,
 ...
 public:
   ...
   */
  SimpleDBClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<SimpleDBEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * A Callable wrapper for BatchDeleteAttributes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename BatchDeleteAttributesRequestT = Model::BatchDeleteAttributesRequest>
  Model::BatchDeleteAttributesOutcomeCallable BatchDeleteAttributesCallable(const BatchDeleteAttributesRequestT& request) const {
    return SubmitCallable(&SimpleDBClient::BatchDeleteAttributes, request);
  }

  /**
   * An Async wrapper for BatchDeleteAttributes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchDeleteAttributesRequestT = Model::BatchDeleteAttributesRequest>
  void BatchDeleteAttributesAsync(const BatchDeleteAttributesRequestT& request, const BatchDeleteAttributesResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&SimpleDBClient::BatchDeleteAttributes, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for BatchPutAttributes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename BatchPutAttributesRequestT = Model::BatchPutAttributesRequest>
  Model::BatchPutAttributesOutcomeCallable BatchPutAttributesCallable(const BatchPutAttributesRequestT& request) const {
    return SubmitCallable(&SimpleDBClient::BatchPutAttributes, request);
  }

  /**
   * An Async wrapper for BatchPutAttributes that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename BatchPutAttributesRequestT = Model::BatchPutAttributesRequest>
  void BatchPutAttributesAsync(const BatchPutAttributesRequestT& request, const BatchPutAttributesResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&SimpleDBClient::BatchPutAttributes, request, handler, context);
  }
  ...
  Model::CreateDomainOutcomeCallable CreateDomainCallable(const CreateDomainRequestT& request) const {
    return SubmitCallable(&SimpleDBClient::CreateDomain, request);
  }
  ...
  void CreateDomainAsync(const CreateDomainRequestT& request, const CreateDomainResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&SimpleDBClient::CreateDomain, request, handler, context);
  }
  ...
  Model::DeleteAttributesOutcomeCallable DeleteAttributesCallable(const DeleteAttributesRequestT& request) const {
    return SubmitCallable(&SimpleDBClient::DeleteAttributes, request);
  }
  ...
  void DeleteAttributesAsync(const DeleteAttributesRequestT& request, const DeleteAttributesResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&SimpleDBClient::DeleteAttributes, request, handler, context);
  }
  ...
  Model::DeleteDomainOutcomeCallable DeleteDomainCallable(const DeleteDomainRequestT& request) const {
    return SubmitCallable(&SimpleDBClient::DeleteDomain, request);
  }
  ...
  void DeleteDomainAsync(const DeleteDomainRequestT& request, const DeleteDomainResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&SimpleDBClient::DeleteDomain, request, handler, context);
  }
   ...
   */
  template <typename DomainMetadataRequestT = Model::DomainMetadataRequest>
  Model::DomainMetadataOutcomeCallable DomainMetadataCallable(const DomainMetadataRequestT& request) const {
    return SubmitCallable(&SimpleDBClient::DomainMetadata, request);
  }

  /**
   * An Async wrapper for DomainMetadata that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DomainMetadataRequestT = Model::DomainMetadataRequest>
  void DomainMetadataAsync(const DomainMetadataRequestT& request, const DomainMetadataResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&SimpleDBClient::DomainMetadata, request, handler, context);
  }
   ...
   */
  template <typename GetAttributesRequestT = Model::GetAttributesRequest>
  Model::GetAttributesOutcomeCallable GetAttributesCallable(const GetAttributesRequestT& request) const {
    return SubmitCallable(&SimpleDBClient::GetAttributes, request);
  }

  /**
   * An Async wrapper for GetAttributes that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetAttributesRequestT = Model::GetAttributesRequest>
  void GetAttributesAsync(const GetAttributesRequestT& request, const GetAttributesResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&SimpleDBClient::GetAttributes, request, handler, context);
  }
  ...
  Model::PutAttributesOutcomeCallable PutAttributesCallable(const PutAttributesRequestT& request) const {
    return SubmitCallable(&SimpleDBClient::PutAttributes, request);
  }
  ...
  void PutAttributesAsync(const PutAttributesRequestT& request, const PutAttributesResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&SimpleDBClient::PutAttributes, request, handler, context);
  }
   ...
   */
  template <typename SelectRequestT = Model::SelectRequest>
  Model::SelectOutcomeCallable SelectCallable(const SelectRequestT& request) const {
    return SubmitCallable(&SimpleDBClient::Select, request);
  }

  /**
   * An Async wrapper for Select that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename SelectRequestT = Model::SelectRequest>
  void SelectAsync(const SelectRequestT& request, const SelectResponseReceivedHandler& handler,
                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
