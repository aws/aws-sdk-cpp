...
NumberItemAttributesExceeded::NumberItemAttributesExceeded(const XmlNode& xmlNode) { *this = xmlNode; }
...
void NumberItemAttributesExceeded::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
