...
NumberSubmittedItemsExceeded::NumberSubmittedItemsExceeded(const XmlNode& xmlNode) { *this = xmlNode; }
...
void NumberSubmittedItemsExceeded::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
