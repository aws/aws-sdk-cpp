...
NumberDomainBytesExceeded::NumberDomainBytesExceeded(const XmlNode& xmlNode) { *this = xmlNode; }
...
void NumberDomainBytesExceeded::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
