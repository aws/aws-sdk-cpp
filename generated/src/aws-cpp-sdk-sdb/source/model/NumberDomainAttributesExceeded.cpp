...
NumberDomainAttributesExceeded::NumberDomainAttributesExceeded(const XmlNode& xmlNode) { *this = xmlNode; }
...
void NumberDomainAttributesExceeded::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
