...
class GetStatementResultV2Request : public RedshiftDataAPIServiceRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "GetStatementResultV2"; }
  ...
  template <typename IdT = Aws::String>
  GetStatementResultV2Request& WithId(IdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  GetStatementResultV2Request& WithNextToken(NextTokenT&& value) {
