...
class ExecuteStatementResult {
 public:
  AWS_REDSHIFTDATAAPISERVICE_API ExecuteStatementResult() = default;
  ...
  template <typename IdT = Aws::String>
  ExecuteStatementResult& WithId(IdT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  ExecuteStatementResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename ClusterIdentifierT = Aws::String>
  ExecuteStatementResult& WithClusterIdentifier(ClusterIdentifierT&& value) {
  ...
  template <typename DbUserT = Aws::String>
  ExecuteStatementResult& WithDbUser(DbUserT&& value) {
  ...
  void SetDbGroups(DbGroupsT&& value) {
    ...
    m_dbGroups = std::forward<DbGroupsT>(value);
  }
  template <typename DbGroupsT = Aws::Vector<Aws::String>>
  ExecuteStatementResult& WithDbGroups(DbGroupsT&& value) {
    SetDbGroups(std::forward<DbGroupsT>(value));
    return *this;
  }
  template <typename DbGroupsT = Aws::String>
  ExecuteStatementResult& AddDbGroups(DbGroupsT&& value) {
    m_dbGroupsHasBeenSet = true;
    m_dbGroups.emplace_back(std::forward<DbGroupsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename DatabaseT = Aws::String>
  ExecuteStatementResult& WithDatabase(DatabaseT&& value) {
  ...
  template <typename SecretArnT = Aws::String>
  ExecuteStatementResult& WithSecretArn(SecretArnT&& value) {
  ...
  template <typename WorkgroupNameT = Aws::String>
  ExecuteStatementResult& WithWorkgroupName(WorkgroupNameT&& value) {
  ...
  template <typename SessionIdT = Aws::String>
  ExecuteStatementResult& WithSessionId(SessionIdT&& value) {
  ...
  inline ExecuteStatementResult& WithStatus(StatementStatusString value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline ExecuteStatementResult& WithRedshiftPid(long long value) {
  ...
  inline ExecuteStatementResult& WithHasResultSet(bool value) {
