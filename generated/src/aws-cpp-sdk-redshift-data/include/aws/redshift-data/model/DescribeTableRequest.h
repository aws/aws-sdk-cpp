...
class DescribeTableRequest : public RedshiftDataAPIServiceRequest {
 public:
  ...
  template <typename ClusterIdentifierT = Aws::String>
  DescribeTableRequest& WithClusterIdentifier(ClusterIdentifierT&& value) {
  ...
  template <typename DatabaseT = Aws::String>
  DescribeTableRequest& WithDatabase(DatabaseT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  DescribeTableRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename WorkgroupNameT = Aws::String>
  DescribeTableRequest& WithWorkgroupName(WorkgroupNameT&& value) {
