...
class ListDatabasesRequest : public RedshiftDataAPIServiceRequest {
 public:
  ...
  template <typename ClusterIdentifierT = Aws::String>
  ListDatabasesRequest& WithClusterIdentifier(ClusterIdentifierT&& value) {
  ...
  template <typename DatabaseT = Aws::String>
  ListDatabasesRequest& WithDatabase(DatabaseT&& value) {
  ...
  template <typename WorkgroupNameT = Aws::String>
  ListDatabasesRequest& WithWorkgroupName(WorkgroupNameT&& value) {
