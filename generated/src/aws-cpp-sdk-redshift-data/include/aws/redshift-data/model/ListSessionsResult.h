...
class ListSessionsResult {
 public:
  AWS_REDSHIFTDATAAPISERVICE_API ListSessionsResult() = default;
  AWS_REDSHIFTDATAAPISERVICE_API ListSessionsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_REDSHIFTDATAAPISERVICE_API ListSessionsResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);

  ///@{
  /**
   * <p>The sessions that match the request.</p>
   */
  inline const Aws::Vector<SessionData>& GetSessions() const { return m_sessions; }
  template <typename SessionsT = Aws::Vector<SessionData>>
  ...
  template <typename SessionsT = SessionData>
 ...
 private:
  Aws::Vector<SessionData> m_sessions;
