...
class DescribeStatementRequest : public RedshiftDataAPIServiceRequest {
 public:
  AWS_REDSHIFTDATAAPISERVICE_API DescribeStatementRequest() = default;
  ...
  template <typename IdT = Aws::String>
  DescribeStatementRequest& WithId(IdT&& value) {
   ...
   * before returning the description. The maximum value is 30 seconds.</p>
   */
  ...
  inline DescribeStatementRequest& WithWaitTimeSeconds(int value) {
