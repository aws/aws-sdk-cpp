...
class BatchExecuteStatementResult {
 public:
  ...
  AWS_REDSHIFTDATAAPISERVICE_API BatchExecuteStatementResult& operator=(
  ...
  template <typename IdT = Aws::String>
  BatchExecuteStatementResult& WithId(IdT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  BatchExecuteStatementResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename ClusterIdentifierT = Aws::String>
  BatchExecuteStatementResult& WithClusterIdentifier(ClusterIdentifierT&& value) {
  ...
  template <typename DbUserT = Aws::String>
  BatchExecuteStatementResult& WithDbUser(DbUserT&& value) {
  ...
  template <typename DbGroupsT = Aws::Vector<Aws::String>>
  BatchExecuteStatementResult& WithDbGroups(DbGroupsT&& value) {
    SetDbGroups(std::forward<DbGroupsT>(value));
    return *this;
  }
  template <typename DbGroupsT = Aws::String>
  BatchExecuteStatementResult& AddDbGroups(DbGroupsT&& value) {
    m_dbGroupsHasBeenSet = true;
  ...
  template <typename DatabaseT = Aws::String>
  BatchExecuteStatementResult& WithDatabase(DatabaseT&& value) {
  ...
  template <typename SecretArnT = Aws::String>
  BatchExecuteStatementResult& WithSecretArn(SecretArnT&& value) {
  ...
  template <typename WorkgroupNameT = Aws::String>
  BatchExecuteStatementResult& WithWorkgroupName(WorkgroupNameT&& value) {
  ...
  template <typename SessionIdT = Aws::String>
  BatchExecuteStatementResult& WithSessionId(SessionIdT&& value) {
