...
class ListStatementsRequest : public RedshiftDataAPIServiceRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListStatementsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename StatementNameT = Aws::String>
  ListStatementsRequest& WithStatementName(StatementNameT&& value) {
  ...
  inline void SetStatus(StatusString value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ListStatementsRequest& WithStatus(StatusString value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename WorkgroupNameT = Aws::String>
  ListStatementsRequest& WithWorkgroupName(WorkgroupNameT&& value) {
