...
class StatementData {
 public:
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  StatementData& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename IdT = Aws::String>
  StatementData& WithId(IdT&& value) {
  ...
  inline void SetIsBatchStatement(bool value) {
    m_isBatchStatementHasBeenSet = true;
    m_isBatchStatement = value;
  }
  inline StatementData& WithIsBatchStatement(bool value) {
    SetIsBatchStatement(value);
    return *this;
  }
  ///@}
  ...
  template <typename QueryParametersT = Aws::Vector<SqlParameter>>
  StatementData& WithQueryParameters(QueryParametersT&& value) {
    SetQueryParameters(std::forward<QueryParametersT>(value));
    return *this;
  }
  template <typename QueryParametersT = SqlParameter>
  StatementData& AddQueryParameters(QueryParametersT&& value) {
    m_queryParametersHasBeenSet = true;
  ...
  template <typename QueryStringT = Aws::String>
  StatementData& WithQueryString(QueryStringT&& value) {
  ...
  void SetQueryStrings(QueryStringsT&& value) {
    ...
    m_queryStrings = std::forward<QueryStringsT>(value);
  }
  template <typename QueryStringsT = Aws::Vector<Aws::String>>
  StatementData& WithQueryStrings(QueryStringsT&& value) {
    SetQueryStrings(std::forward<QueryStringsT>(value));
    return *this;
  }
  template <typename QueryStringsT = Aws::String>
  StatementData& AddQueryStrings(QueryStringsT&& value) {
    m_queryStringsHasBeenSet = true;
    m_queryStrings.emplace_back(std::forward<QueryStringsT>(value));
    return *this;
  }
  ///@}
  ...
  inline StatementData& WithResultFormat(ResultFormatString value) {
  ...
  template <typename SecretArnT = Aws::String>
  StatementData& WithSecretArn(SecretArnT&& value) {
  ...
  template <typename SessionIdT = Aws::String>
  StatementData& WithSessionId(SessionIdT&& value) {
  ...
  template <typename StatementNameT = Aws::String>
  StatementData& WithStatementName(StatementNameT&& value) {
  ...
  inline StatementData& WithStatus(StatusString value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  StatementData& WithUpdatedAt(UpdatedAtT&& value) {
