...
{
const size_t RedshiftDataAPIServiceEndpointRules::RulesBlobStrLen = 3752;
const size_t RedshiftDataAPIServiceEndpointRules::RulesBlobSize = 3753;
...
'h','t','t','p','s',':','/','/','r','e','d','s','h','i','f','t','-','d','a','t','a','-','f','i','p',
...
'/','r','e','d','s','h','i','f','t','-','d','a','t','a','.','{','R','e','g','i','o','n','}','.','{',
