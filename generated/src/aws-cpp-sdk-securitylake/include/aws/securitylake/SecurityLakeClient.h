...
namespace SecurityLake
{
   ...
   */
  class AWS_SECURITYLAKE_API SecurityLakeClient : Aws::Client::ClientWithAsyncTemplateMethods<SecurityLakeClient>,
    smithy::client::AwsSmithyClientT<Aws::SecurityLake::SERVICE_NAME,
