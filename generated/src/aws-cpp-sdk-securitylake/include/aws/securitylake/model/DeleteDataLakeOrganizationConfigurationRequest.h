...
class DeleteDataLakeOrganizationConfigurationRequest : public SecurityLakeRequest {
 public:
  ...
  template <typename AutoEnableNewAccountT = Aws::Vector<DataLakeAutoEnableNewAccountConfiguration>>
  DeleteDataLakeOrganizationConfigurationRequest& WithAutoEnableNewAccount(AutoEnableNewAccountT&& value) {
  ...
  DeleteDataLakeOrganizationConfigurationRequest& AddAutoEnableNewAccount(AutoEnableNewAccountT&& value) {
    m_autoEnableNewAccountHasBeenSet = true;
