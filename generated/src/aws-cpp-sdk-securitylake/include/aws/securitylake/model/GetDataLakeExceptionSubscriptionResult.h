...
class GetDataLakeExceptionSubscriptionResult {
 public:
  ...
  AWS_SECURITYLAKE_API GetDataLakeExceptionSubscriptionResult& operator=(
  ...
  inline void SetExceptionTimeToLive(long long value) {
    m_exceptionTimeToLiveHasBeenSet = true;
    m_exceptionTimeToLive = value;
  }
  inline GetDataLakeExceptionSubscriptionResult& WithExceptionTimeToLive(long long value) {
    SetExceptionTimeToLive(value);
    return *this;
  }
  ///@}
  ...
  void SetNotificationEndpoint(NotificationEndpointT&& value) {
    ...
    m_notificationEndpoint = std::forward<NotificationEndpointT>(value);
  }
  template <typename NotificationEndpointT = Aws::String>
  GetDataLakeExceptionSubscriptionResult& WithNotificationEndpoint(NotificationEndpointT&& value) {
    SetNotificationEndpoint(std::forward<NotificationEndpointT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSubscriptionProtocol(SubscriptionProtocolT&& value) {
    ...
    m_subscriptionProtocol = std::forward<SubscriptionProtocolT>(value);
  }
  template <typename SubscriptionProtocolT = Aws::String>
  GetDataLakeExceptionSubscriptionResult& WithSubscriptionProtocol(SubscriptionProtocolT&& value) {
    SetSubscriptionProtocol(std::forward<SubscriptionProtocolT>(value));
    return *this;
  }
  ///@}
