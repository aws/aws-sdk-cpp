...
class ListDataLakeExceptionsResult {
 public:
  ...
  void SetExceptions(ExceptionsT&& value) {
    ...
    m_exceptions = std::forward<ExceptionsT>(value);
  }
  template <typename ExceptionsT = Aws::Vector<DataLakeException>>
  ListDataLakeExceptionsResult& WithExceptions(ExceptionsT&& value) {
    SetExceptions(std::forward<ExceptionsT>(value));
    return *this;
  }
  template <typename ExceptionsT = DataLakeException>
  ListDataLakeExceptionsResult& AddExceptions(ExceptionsT&& value) {
    m_exceptionsHasBeenSet = true;
    m_exceptions.emplace_back(std::forward<ExceptionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListDataLakeExceptionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDataLakeExceptionsResult& WithRequestId(RequestIdT&& value) {
