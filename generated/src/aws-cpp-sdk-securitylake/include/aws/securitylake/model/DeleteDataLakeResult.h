...
namespace Model
{
  ...
  {
  public:
    AWS_SECURITYLAKE_API DeleteDataLakeResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteDataLakeResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
