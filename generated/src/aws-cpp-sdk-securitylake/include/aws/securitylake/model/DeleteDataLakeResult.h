...
namespace Model
{
  ...
  public:
    ...
    inline DeleteDataLakeResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeleteDataLakeResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeleteDataLakeResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
