...
namespace Model
{
  ...
  public:
    ...
    inline CreateDatalakeDelegatedAdminResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline CreateDatalakeDelegatedAdminResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline CreateDatalakeDelegatedAdminResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
