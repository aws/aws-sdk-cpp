...
class DataLakeSourceStatus {
 public:
  ...
  template <typename ResourceT = Aws::String>
  DataLakeSourceStatus& WithResource(ResourceT&& value) {
  ...
  inline void SetStatus(SourceCollectionStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline DataLakeSourceStatus& WithStatus(SourceCollectionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
