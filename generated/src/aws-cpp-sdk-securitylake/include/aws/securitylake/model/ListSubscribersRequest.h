...
namespace Model
{
  ...
  {
  public:
    AWS_SECURITYLAKE_API ListSubscribersRequest() = default;
    ...
    template<typename NextTokenT = Aws::String>
    ListSubscribersRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
