...
namespace Model
{
  ...
  /**
   */
  class UntagResourceRequest : public SecurityLakeRequest
  {
  public:
    AWS_SECURITYLAKE_API UntagResourceRequest() = default;
    ...
    ///@{
    /**
     * <p>The Amazon Resource Name (ARN) of the Amazon Security Lake resource to remove
     * one or more tags from.</p>
     */
    ...
    ///@{
    /**
     * <p>A list of one or more tag keys. For each value in the list, specify the tag
     * key for a tag to remove from the Amazon Security Lake resource.</p>
     */
