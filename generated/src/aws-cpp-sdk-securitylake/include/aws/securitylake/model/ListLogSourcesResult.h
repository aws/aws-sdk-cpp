...
class ListLogSourcesResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListLogSourcesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename SourcesT = Aws::Vector<LogSource>>
  ListLogSourcesResult& WithSources(SourcesT&& value) {
    SetSources(std::forward<SourcesT>(value));
    return *this;
  }
  template <typename SourcesT = LogSource>
  ListLogSourcesResult& AddSources(SourcesT&& value) {
    m_sourcesHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListLogSourcesResult& WithRequestId(RequestIdT&& value) {
