...
class NotificationConfiguration {
 public:
  ...
  void SetHttpsNotificationConfiguration(HttpsNotificationConfigurationT&& value) {
    ...
    m_httpsNotificationConfiguration = std::forward<HttpsNotificationConfigurationT>(value);
  }
  template <typename HttpsNotificationConfigurationT = HttpsNotificationConfiguration>
  NotificationConfiguration& WithHttpsNotificationConfiguration(HttpsNotificationConfigurationT&& value) {
    SetHttpsNotificationConfiguration(std::forward<HttpsNotificationConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSqsNotificationConfiguration(SqsNotificationConfigurationT&& value) {
    ...
    m_sqsNotificationConfiguration = std::forward<SqsNotificationConfigurationT>(value);
  }
  template <typename SqsNotificationConfigurationT = SqsNotificationConfiguration>
  NotificationConfiguration& WithSqsNotificationConfiguration(SqsNotificationConfigurationT&& value) {
    SetSqsNotificationConfiguration(std::forward<SqsNotificationConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
