...
namespace Model
{
  ...
  {
  public:
    AWS_SECURITYLAKE_API DeleteSubscriberResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteSubscriberResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
