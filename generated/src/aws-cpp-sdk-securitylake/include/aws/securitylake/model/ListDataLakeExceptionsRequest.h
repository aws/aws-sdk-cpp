...
class ListDataLakeExceptionsRequest : public SecurityLakeRequest {
 public:
  AWS_SECURITYLAKE_API ListDataLakeExceptionsRequest() = default;
  ...
  inline ListDataLakeExceptionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListDataLakeExceptionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RegionsT = Aws::Vector<Aws::String>>
  ListDataLakeExceptionsRequest& WithRegions(RegionsT&& value) {
    SetRegions(std::forward<RegionsT>(value));
    return *this;
  }
  template <typename RegionsT = Aws::String>
  ListDataLakeExceptionsRequest& AddRegions(RegionsT&& value) {
    m_regionsHasBeenSet = true;
