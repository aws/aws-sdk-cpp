...
class LogSourceResource {
 public:
  ...
  void SetAwsLogSource(AwsLogSourceT&& value) {
    m_awsLogSourceHasBeenSet = true;
    m_awsLogSource = std::forward<AwsLogSourceT>(value);
  }
  template <typename AwsLogSourceT = AwsLogSourceResource>
  LogSourceResource& WithAwsLogSource(AwsLogSourceT&& value) {
    SetAwsLogSource(std::forward<AwsLogSourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCustomLogSource(CustomLogSourceT&& value) {
    ...
    m_customLogSource = std::forward<CustomLogSourceT>(value);
  }
  template <typename CustomLogSourceT = CustomLogSourceResource>
  LogSourceResource& WithCustomLogSource(CustomLogSourceT&& value) {
    SetCustomLogSource(std::forward<CustomLogSourceT>(value));
    return *this;
  }
  ///@}
 private:
