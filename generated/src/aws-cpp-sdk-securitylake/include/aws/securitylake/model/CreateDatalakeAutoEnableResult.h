...
namespace Model
{
  ...
  public:
    ...
    inline CreateDatalakeAutoEnableResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline CreateDatalakeAutoEnableResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline CreateDatalakeAutoEnableResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
