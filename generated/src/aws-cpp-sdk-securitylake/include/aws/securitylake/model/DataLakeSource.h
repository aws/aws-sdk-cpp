...
class DataLakeSource {
 public:
  ...
  void SetEventClasses(EventClassesT&& value) {
    ...
    m_eventClasses = std::forward<EventClassesT>(value);
  }
  template <typename EventClassesT = Aws::Vector<Aws::String>>
  DataLakeSource& WithEventClasses(EventClassesT&& value) {
    SetEventClasses(std::forward<EventClassesT>(value));
    return *this;
  }
  template <typename EventClassesT = Aws::String>
  DataLakeSource& AddEventClasses(EventClassesT&& value) {
    m_eventClassesHasBeenSet = true;
    m_eventClasses.emplace_back(std::forward<EventClassesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSourceStatuses(SourceStatusesT&& value) {
    ...
    m_sourceStatuses = std::forward<SourceStatusesT>(value);
  }
  template <typename SourceStatusesT = Aws::Vector<DataLakeSourceStatus>>
  DataLakeSource& WithSourceStatuses(SourceStatusesT&& value) {
    SetSourceStatuses(std::forward<SourceStatusesT>(value));
    return *this;
  }
  template <typename SourceStatusesT = DataLakeSourceStatus>
  DataLakeSource& AddSourceStatuses(SourceStatusesT&& value) {
    m_sourceStatusesHasBeenSet = true;
    m_sourceStatuses.emplace_back(std::forward<SourceStatusesT>(value));
    return *this;
  }
  ///@}
 private:
