...
namespace Model
{
  ...
  public:
    ...
    inline DeleteDatalakeAutoEnableResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeleteDatalakeAutoEnableResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeleteDatalakeAutoEnableResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
