...
namespace Model
{
  ...
  public:
    ...
    inline UpdateDatalakeExceptionsSubscriptionResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateDatalakeExceptionsSubscriptionResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateDatalakeExceptionsSubscriptionResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
