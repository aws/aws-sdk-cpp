...
CreateSubscriberNotificationResult::CreateSubscriberNotificationResult()
{
}

CreateSubscriberNotificationResult::CreateSubscriberNotificationResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
