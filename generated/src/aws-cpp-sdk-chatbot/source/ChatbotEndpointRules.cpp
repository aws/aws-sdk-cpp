...
'"','h','t','t','p','s',':','/','/','c','h','a','t','b','o','t','-','f','i','p','s','.','{','R','e',
...
'p','s',':','/','/','c','h','a','t','b','o','t','.','{','R','e','g','i','o','n','}','.','{','P','a',
...
'l','"',':','"','h','t','t','p','s',':','/','/','c','h','a','t','b','o','t','.','{','R','e','g','i',
...
const char* ChatbotEndpointRules::GetRulesBlob()
{
