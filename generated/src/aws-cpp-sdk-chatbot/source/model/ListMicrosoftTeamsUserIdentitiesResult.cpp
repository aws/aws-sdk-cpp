...
ListMicrosoftTeamsUserIdentitiesResult& ListMicrosoftTeamsUserIdentitiesResult::operator=(
  ...
  if (jsonValue.ValueExists("TeamsUserIdentities")) {
    ...
    for (unsigned teamsUserIdentitiesIndex = 0; teamsUserIdentitiesIndex < teamsUserIdentitiesJsonList.GetLength();
         ++teamsUserIdentitiesIndex) {
      m_teamsUserIdentities.push_back(teamsUserIdentitiesJsonList[teamsUserIdentitiesIndex].AsObject());
    }
    m_teamsUserIdentitiesHasBeenSet = true;
  }
