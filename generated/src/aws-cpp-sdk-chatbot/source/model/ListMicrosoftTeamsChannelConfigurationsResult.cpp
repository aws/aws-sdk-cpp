...
ListMicrosoftTeamsChannelConfigurationsResult& ListMicrosoftTeamsChannelConfigurationsResult::operator=(
    const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("TeamChannelConfigurations")) {
    ...
    for (unsigned teamChannelConfigurationsIndex = 0; teamChannelConfigurationsIndex < teamChannelConfigurationsJsonList.GetLength();
         ++teamChannelConfigurationsIndex) {
      m_teamChannelConfigurations.push_back(teamChannelConfigurationsJsonList[teamChannelConfigurationsIndex].AsObject());
    }
    m_teamChannelConfigurationsHasBeenSet = true;
  }
