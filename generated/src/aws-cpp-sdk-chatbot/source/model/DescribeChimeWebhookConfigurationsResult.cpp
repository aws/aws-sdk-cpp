...
DescribeChimeWebhookConfigurationsResult& DescribeChimeWebhookConfigurationsResult::operator=(
  ...
  if (jsonValue.ValueExists("WebhookConfigurations")) {
    ...
    for (unsigned webhookConfigurationsIndex = 0; webhookConfigurationsIndex < webhookConfigurationsJsonList.GetLength();
         ++webhookConfigurationsIndex) {
