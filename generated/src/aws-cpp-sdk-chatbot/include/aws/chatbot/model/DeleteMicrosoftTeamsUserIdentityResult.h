...
namespace Model
{
  ...
  {
  public:
    AWS_CHATBOT_API DeleteMicrosoftTeamsUserIdentityResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteMicrosoftTeamsUserIdentityResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
