...
class DescribeSlackWorkspacesResult {
 public:
  ...
  void SetSlackWorkspaces(SlackWorkspacesT&& value) {
    m_slackWorkspacesHasBeenSet = true;
    m_slackWorkspaces = std::forward<SlackWorkspacesT>(value);
  }
  template <typename SlackWorkspacesT = Aws::Vector<SlackWorkspace>>
  DescribeSlackWorkspacesResult& WithSlackWorkspaces(SlackWorkspacesT&& value) {
    SetSlackWorkspaces(std::forward<SlackWorkspacesT>(value));
    return *this;
  }
  template <typename SlackWorkspacesT = SlackWorkspace>
  DescribeSlackWorkspacesResult& AddSlackWorkspaces(SlackWorkspacesT&& value) {
    m_slackWorkspacesHasBeenSet = true;
    m_slackWorkspaces.emplace_back(std::forward<SlackWorkspacesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeSlackWorkspacesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeSlackWorkspacesResult& WithRequestId(RequestIdT&& value) {
