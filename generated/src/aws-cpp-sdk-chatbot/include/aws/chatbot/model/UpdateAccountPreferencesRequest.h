...
class UpdateAccountPreferencesRequest : public ChatbotRequest {
 public:
  ...
  inline UpdateAccountPreferencesRequest& WithUserAuthorizationRequired(bool value) {
  ...
  inline void SetTrainingDataCollectionEnabled(bool value) {
    m_trainingDataCollectionEnabledHasBeenSet = true;
    m_trainingDataCollectionEnabled = value;
  }
  inline UpdateAccountPreferencesRequest& WithTrainingDataCollectionEnabled(bool value) {
    SetTrainingDataCollectionEnabled(value);
    return *this;
  }
  ///@}
 private:
