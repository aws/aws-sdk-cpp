...
namespace Model
{
  ...
  public:
    ...
    template<typename ChannelIdT = Aws::String>
    CreateMicrosoftTeamsChannelConfigurationRequest& WithChannelId(ChannelIdT&& value) { SetChannelId(std::forward<ChannelIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ChannelNameT = Aws::String>
    CreateMicrosoftTeamsChannelConfigurationRequest& WithChannelName(ChannelNameT&& value) { SetChannelName(std::forward<ChannelNameT>(value)); return *this;}
    ///@}
    ...
    template<typename TeamIdT = Aws::String>
    CreateMicrosoftTeamsChannelConfigurationRequest& WithTeamId(TeamIdT&& value) { SetTeamId(std::forward<TeamIdT>(value)); return *this;}
    ///@}
    ...
    template<typename TeamNameT = Aws::String>
    CreateMicrosoftTeamsChannelConfigurationRequest& WithTeamName(TeamNameT&& value) { SetTeamName(std::forward<TeamNameT>(value)); return *this;}
    ///@}
    ...
    template<typename TenantIdT = Aws::String>
    CreateMicrosoftTeamsChannelConfigurationRequest& WithTenantId(TenantIdT&& value) { SetTenantId(std::forward<TenantIdT>(value)); return *this;}
    ///@}
    ...
    template<typename SnsTopicArnsT = Aws::Vector<Aws::String>>
    CreateMicrosoftTeamsChannelConfigurationRequest& WithSnsTopicArns(SnsTopicArnsT&& value) { SetSnsTopicArns(std::forward<SnsTopicArnsT>(value)); return *this;}
    template<typename SnsTopicArnsT = Aws::String>
    CreateMicrosoftTeamsChannelConfigurationRequest& AddSnsTopicArns(SnsTopicArnsT&& value) { m_snsTopicArnsHasBeenSet = true; m_snsTopicArns.emplace_back(std::forward<SnsTopicArnsT>(value)); return *this; }
    ///@}
    ...
    template<typename IamRoleArnT = Aws::String>
    CreateMicrosoftTeamsChannelConfigurationRequest& WithIamRoleArn(IamRoleArnT&& value) { SetIamRoleArn(std::forward<IamRoleArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ConfigurationNameT = Aws::String>
    CreateMicrosoftTeamsChannelConfigurationRequest& WithConfigurationName(ConfigurationNameT&& value) { SetConfigurationName(std::forward<ConfigurationNameT>(value)); return *this;}
    ///@}
    ...
    template<typename LoggingLevelT = Aws::String>
    CreateMicrosoftTeamsChannelConfigurationRequest& WithLoggingLevel(LoggingLevelT&& value) { SetLoggingLevel(std::forward<LoggingLevelT>(value)); return *this;}
    ///@}
    ...
    template<typename GuardrailPolicyArnsT = Aws::Vector<Aws::String>>
    CreateMicrosoftTeamsChannelConfigurationRequest& WithGuardrailPolicyArns(GuardrailPolicyArnsT&& value) { SetGuardrailPolicyArns(std::forward<GuardrailPolicyArnsT>(value)); return *this;}
    template<typename GuardrailPolicyArnsT = Aws::String>
    CreateMicrosoftTeamsChannelConfigurationRequest& AddGuardrailPolicyArns(GuardrailPolicyArnsT&& value) { m_guardrailPolicyArnsHasBeenSet = true; m_guardrailPolicyArns.emplace_back(std::forward<GuardrailPolicyArnsT>(value)); return *this; }
    ///@}
    ...
    template<typename TagsT = Aws::Vector<Tag>>
    CreateMicrosoftTeamsChannelConfigurationRequest& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
    template<typename TagsT = Tag>
    CreateMicrosoftTeamsChannelConfigurationRequest& AddTags(TagsT&& value) { m_tagsHasBeenSet = true; m_tags.emplace_back(std::forward<TagsT>(value)); return *this; }
    ///@}
  private:
