...
class DeleteSlackUserIdentityRequest : public ChatbotRequest {
 public:
  ...
  template <typename ChatConfigurationArnT = Aws::String>
  DeleteSlackUserIdentityRequest& WithChatConfigurationArn(ChatConfigurationArnT&& value) {
  ...
  template <typename SlackTeamIdT = Aws::String>
  DeleteSlackUserIdentityRequest& WithSlackTeamId(SlackTeamIdT&& value) {
  ...
  template <typename SlackUserIdT = Aws::String>
  DeleteSlackUserIdentityRequest& WithSlackUserId(SlackUserIdT&& value) {
