...
namespace Model
{
  ...
  {
  public:
    AWS_CHATBOT_API DeleteChimeWebhookConfigurationResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteChimeWebhookConfigurationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
