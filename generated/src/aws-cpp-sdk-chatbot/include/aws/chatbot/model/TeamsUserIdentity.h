...
class TeamsUserIdentity {
 public:
  ...
  void SetAwsUserIdentity(AwsUserIdentityT&& value) {
    ...
    m_awsUserIdentity = std::forward<AwsUserIdentityT>(value);
  }
  template <typename AwsUserIdentityT = Aws::String>
  TeamsUserIdentity& WithAwsUserIdentity(AwsUserIdentityT&& value) {
    SetAwsUserIdentity(std::forward<AwsUserIdentityT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTeamsChannelId(TeamsChannelIdT&& value) {
    ...
    m_teamsChannelId = std::forward<TeamsChannelIdT>(value);
  }
  template <typename TeamsChannelIdT = Aws::String>
  TeamsUserIdentity& WithTeamsChannelId(TeamsChannelIdT&& value) {
    SetTeamsChannelId(std::forward<TeamsChannelIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTeamsTenantId(TeamsTenantIdT&& value) {
    ...
    m_teamsTenantId = std::forward<TeamsTenantIdT>(value);
  }
  template <typename TeamsTenantIdT = Aws::String>
  TeamsUserIdentity& WithTeamsTenantId(TeamsTenantIdT&& value) {
    SetTeamsTenantId(std::forward<TeamsTenantIdT>(value));
    return *this;
  }
  ///@}
 private:
