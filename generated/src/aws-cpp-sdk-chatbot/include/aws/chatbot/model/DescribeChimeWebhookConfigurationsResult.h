...
class DescribeChimeWebhookConfigurationsResult {
 public:
  ...
  AWS_CHATBOT_API DescribeChimeWebhookConfigurationsResult& operator=(
  ...
  void SetWebhookConfigurations(WebhookConfigurationsT&& value) {
    m_webhookConfigurationsHasBeenSet = true;
    m_webhookConfigurations = std::forward<WebhookConfigurationsT>(value);
  }
  template <typename WebhookConfigurationsT = Aws::Vector<ChimeWebhookConfiguration>>
  DescribeChimeWebhookConfigurationsResult& WithWebhookConfigurations(WebhookConfigurationsT&& value) {
    SetWebhookConfigurations(std::forward<WebhookConfigurationsT>(value));
    return *this;
  }
  ...
  DescribeChimeWebhookConfigurationsResult& AddWebhookConfigurations(WebhookConfigurationsT&& value) {
    m_webhookConfigurationsHasBeenSet = true;
    m_webhookConfigurations.emplace_back(std::forward<WebhookConfigurationsT>(value));
    return *this;
  }
  ///@}
