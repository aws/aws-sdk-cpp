...
class ListMicrosoftTeamsConfiguredTeamsResult {
 public:
  ...
  AWS_CHATBOT_API ListMicrosoftTeamsConfiguredTeamsResult& operator=(
  ...
  void SetConfiguredTeams(ConfiguredTeamsT&& value) {
    m_configuredTeamsHasBeenSet = true;
    m_configuredTeams = std::forward<ConfiguredTeamsT>(value);
  }
  template <typename ConfiguredTeamsT = Aws::Vector<ConfiguredTeam>>
  ListMicrosoftTeamsConfiguredTeamsResult& WithConfiguredTeams(ConfiguredTeamsT&& value) {
    SetConfiguredTeams(std::forward<ConfiguredTeamsT>(value));
    return *this;
  }
  template <typename ConfiguredTeamsT = ConfiguredTeam>
  ListMicrosoftTeamsConfiguredTeamsResult& AddConfiguredTeams(ConfiguredTeamsT&& value) {
    m_configuredTeamsHasBeenSet = true;
    m_configuredTeams.emplace_back(std::forward<ConfiguredTeamsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListMicrosoftTeamsConfiguredTeamsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListMicrosoftTeamsConfiguredTeamsResult& WithRequestId(RequestIdT&& value) {
