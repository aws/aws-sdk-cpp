...
class SlackChannelConfiguration {
 public:
  ...
  void SetSlackTeamName(SlackTeamNameT&& value) {
    ...
    m_slackTeamName = std::forward<SlackTeamNameT>(value);
  }
  template <typename SlackTeamNameT = Aws::String>
  SlackChannelConfiguration& WithSlackTeamName(SlackTeamNameT&& value) {
    SetSlackTeamName(std::forward<SlackTeamNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline SlackChannelConfiguration& WithUserAuthorizationRequired(bool value) {
