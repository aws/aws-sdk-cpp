...
namespace Model
{
  ...
  public:
    ...
    template<typename SlackTeamNameT = Aws::String>
    SlackChannelConfiguration& WithSlackTeamName(SlackTeamNameT&& value) { SetSlackTeamName(std::forward<SlackTeamNameT>(value)); return *this;}
    ///@}
    ...
    template<typename SlackTeamIdT = Aws::String>
    SlackChannelConfiguration& WithSlackTeamId(SlackTeamIdT&& value) { SetSlackTeamId(std::forward<SlackTeamIdT>(value)); return *this;}
    ///@}
    ...
    template<typename SlackChannelIdT = Aws::String>
    SlackChannelConfiguration& WithSlackChannelId(SlackChannelIdT&& value) { SetSlackChannelId(std::forward<SlackChannelIdT>(value)); return *this;}
    ///@}
    ...
    template<typename SlackChannelNameT = Aws::String>
    SlackChannelConfiguration& WithSlackChannelName(SlackChannelNameT&& value) { SetSlackChannelName(std::forward<SlackChannelNameT>(value)); return *this;}
    ///@}
    ...
    template<typename ChatConfigurationArnT = Aws::String>
    SlackChannelConfiguration& WithChatConfigurationArn(ChatConfigurationArnT&& value) { SetChatConfigurationArn(std::forward<ChatConfigurationArnT>(value)); return *this;}
    ///@}
    ...
    template<typename IamRoleArnT = Aws::String>
    SlackChannelConfiguration& WithIamRoleArn(IamRoleArnT&& value) { SetIamRoleArn(std::forward<IamRoleArnT>(value)); return *this;}
    ///@}
    ...
    template<typename SnsTopicArnsT = Aws::Vector<Aws::String>>
    SlackChannelConfiguration& WithSnsTopicArns(SnsTopicArnsT&& value) { SetSnsTopicArns(std::forward<SnsTopicArnsT>(value)); return *this;}
    template<typename SnsTopicArnsT = Aws::String>
    SlackChannelConfiguration& AddSnsTopicArns(SnsTopicArnsT&& value) { m_snsTopicArnsHasBeenSet = true; m_snsTopicArns.emplace_back(std::forward<SnsTopicArnsT>(value)); return *this; }
    ///@}
    ...
    template<typename ConfigurationNameT = Aws::String>
    SlackChannelConfiguration& WithConfigurationName(ConfigurationNameT&& value) { SetConfigurationName(std::forward<ConfigurationNameT>(value)); return *this;}
    ///@}
    ...
    template<typename LoggingLevelT = Aws::String>
    SlackChannelConfiguration& WithLoggingLevel(LoggingLevelT&& value) { SetLoggingLevel(std::forward<LoggingLevelT>(value)); return *this;}
    ///@}
    ...
    template<typename GuardrailPolicyArnsT = Aws::Vector<Aws::String>>
    SlackChannelConfiguration& WithGuardrailPolicyArns(GuardrailPolicyArnsT&& value) { SetGuardrailPolicyArns(std::forward<GuardrailPolicyArnsT>(value)); return *this;}
    template<typename GuardrailPolicyArnsT = Aws::String>
    SlackChannelConfiguration& AddGuardrailPolicyArns(GuardrailPolicyArnsT&& value) { m_guardrailPolicyArnsHasBeenSet = true; m_guardrailPolicyArns.emplace_back(std::forward<GuardrailPolicyArnsT>(value)); return *this; }
    ///@}
    ...
    template<typename TagsT = Aws::Vector<Tag>>
    SlackChannelConfiguration& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
    template<typename TagsT = Tag>
    SlackChannelConfiguration& AddTags(TagsT&& value) { m_tagsHasBeenSet = true; m_tags.emplace_back(std::forward<TagsT>(value)); return *this; }
    ///@}
    ...
    template<typename StateT = Aws::String>
    SlackChannelConfiguration& WithState(StateT&& value) { SetState(std::forward<StateT>(value)); return *this;}
    ///@}
    ...
    template<typename StateReasonT = Aws::String>
    SlackChannelConfiguration& WithStateReason(StateReasonT&& value) { SetStateReason(std::forward<StateReasonT>(value)); return *this;}
    ///@}
  private:
