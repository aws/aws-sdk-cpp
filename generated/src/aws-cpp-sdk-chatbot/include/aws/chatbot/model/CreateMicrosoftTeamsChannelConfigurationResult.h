...
class CreateMicrosoftTeamsChannelConfigurationResult {
 public:
  ...
  AWS_CHATBOT_API CreateMicrosoftTeamsChannelConfigurationResult& operator=(
  ...
  template <typename ChannelConfigurationT = TeamsChannelConfiguration>
  CreateMicrosoftTeamsChannelConfigurationResult& WithChannelConfiguration(ChannelConfigurationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateMicrosoftTeamsChannelConfigurationResult& WithRequestId(RequestIdT&& value) {
