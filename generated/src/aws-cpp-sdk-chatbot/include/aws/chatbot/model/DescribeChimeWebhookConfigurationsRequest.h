...
class DescribeChimeWebhookConfigurationsRequest : public ChatbotRequest {
 public:
  ...
  inline DescribeChimeWebhookConfigurationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeChimeWebhookConfigurationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ChatConfigurationArnT = Aws::String>
  DescribeChimeWebhookConfigurationsRequest& WithChatConfigurationArn(ChatConfigurationArnT&& value) {
