...
namespace Model
{
  ...
  {
  public:
    AWS_CHATBOT_API DescribeChimeWebhookConfigurationsRequest() = default;
    ...
    template<typename NextTokenT = Aws::String>
    DescribeChimeWebhookConfigurationsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename ChatConfigurationArnT = Aws::String>
    DescribeChimeWebhookConfigurationsRequest& WithChatConfigurationArn(ChatConfigurationArnT&& value) { SetChatConfigurationArn(std::forward<ChatConfigurationArnT>(value)); return *this;}
    ///@}
  private:
