...
class DescribeSlackUserIdentitiesResult {
 public:
  ...
  void SetSlackUserIdentities(SlackUserIdentitiesT&& value) {
    m_slackUserIdentitiesHasBeenSet = true;
    m_slackUserIdentities = std::forward<SlackUserIdentitiesT>(value);
  }
  template <typename SlackUserIdentitiesT = Aws::Vector<SlackUserIdentity>>
  DescribeSlackUserIdentitiesResult& WithSlackUserIdentities(SlackUserIdentitiesT&& value) {
    SetSlackUserIdentities(std::forward<SlackUserIdentitiesT>(value));
    return *this;
  }
  template <typename SlackUserIdentitiesT = SlackUserIdentity>
  DescribeSlackUserIdentitiesResult& AddSlackUserIdentities(SlackUserIdentitiesT&& value) {
    m_slackUserIdentitiesHasBeenSet = true;
    m_slackUserIdentities.emplace_back(std::forward<SlackUserIdentitiesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeSlackUserIdentitiesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeSlackUserIdentitiesResult& WithRequestId(RequestIdT&& value) {
