...
namespace Model
{
  ...
  {
  public:
    AWS_CHATBOT_API DeleteSlackUserIdentityResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteSlackUserIdentityResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
