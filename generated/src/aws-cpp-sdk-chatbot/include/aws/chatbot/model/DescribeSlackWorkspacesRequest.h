...
class DescribeSlackWorkspacesRequest : public ChatbotRequest {
 public:
  AWS_CHATBOT_API DescribeSlackWorkspacesRequest() = default;
  ...
  inline DescribeSlackWorkspacesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeSlackWorkspacesRequest& WithNextToken(NextTokenT&& value) {
