...
class ListMicrosoftTeamsUserIdentitiesResult {
 public:
  ...
  void SetTeamsUserIdentities(TeamsUserIdentitiesT&& value) {
    m_teamsUserIdentitiesHasBeenSet = true;
    m_teamsUserIdentities = std::forward<TeamsUserIdentitiesT>(value);
  }
  template <typename TeamsUserIdentitiesT = Aws::Vector<TeamsUserIdentity>>
  ListMicrosoftTeamsUserIdentitiesResult& WithTeamsUserIdentities(TeamsUserIdentitiesT&& value) {
    SetTeamsUserIdentities(std::forward<TeamsUserIdentitiesT>(value));
    return *this;
  }
  template <typename TeamsUserIdentitiesT = TeamsUserIdentity>
  ListMicrosoftTeamsUserIdentitiesResult& AddTeamsUserIdentities(TeamsUserIdentitiesT&& value) {
    m_teamsUserIdentitiesHasBeenSet = true;
    m_teamsUserIdentities.emplace_back(std::forward<TeamsUserIdentitiesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListMicrosoftTeamsUserIdentitiesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListMicrosoftTeamsUserIdentitiesResult& WithRequestId(RequestIdT&& value) {
