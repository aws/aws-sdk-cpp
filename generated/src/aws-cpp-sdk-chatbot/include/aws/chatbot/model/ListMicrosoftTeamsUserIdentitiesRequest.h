...
class ListMicrosoftTeamsUserIdentitiesRequest : public ChatbotRequest {
 public:
  ...
  template <typename ChatConfigurationArnT = Aws::String>
  ListMicrosoftTeamsUserIdentitiesRequest& WithChatConfigurationArn(ChatConfigurationArnT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListMicrosoftTeamsUserIdentitiesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListMicrosoftTeamsUserIdentitiesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
