...
class CustomActionAttachmentCriteria {
 public:
  ...
  inline void SetOperator(CustomActionAttachmentCriteriaOperator value) {
    m_operatorHasBeenSet = true;
    m_operator = value;
  }
  inline CustomActionAttachmentCriteria& WithOperator(CustomActionAttachmentCriteriaOperator value) {
    SetOperator(value);
    return *this;
  }
  ///@}
