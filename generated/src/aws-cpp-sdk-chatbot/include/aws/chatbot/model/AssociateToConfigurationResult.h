...
namespace Model
{
  ...
  {
  public:
    AWS_CHATBOT_API AssociateToConfigurationResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    AssociateToConfigurationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
