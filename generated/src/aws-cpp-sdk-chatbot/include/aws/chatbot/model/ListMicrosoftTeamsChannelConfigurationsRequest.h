...
class ListMicrosoftTeamsChannelConfigurationsRequest : public ChatbotRequest {
 public:
  ...
  inline ListMicrosoftTeamsChannelConfigurationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListMicrosoftTeamsChannelConfigurationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename TeamIdT = Aws::String>
  ListMicrosoftTeamsChannelConfigurationsRequest& WithTeamId(TeamIdT&& value) {
