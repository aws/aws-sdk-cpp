...
class GetMicrosoftTeamsChannelConfigurationResult {
 public:
  ...
  AWS_CHATBOT_API GetMicrosoftTeamsChannelConfigurationResult& operator=(
  ...
  template <typename ChannelConfigurationT = TeamsChannelConfiguration>
  GetMicrosoftTeamsChannelConfigurationResult& WithChannelConfiguration(ChannelConfigurationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetMicrosoftTeamsChannelConfigurationResult& WithRequestId(RequestIdT&& value) {
