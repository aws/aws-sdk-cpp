...
namespace Model
{
  ...
  public:
    ...
    template<typename ChatConfigurationArnT = Aws::String>
    DescribeSlackUserIdentitiesRequest& WithChatConfigurationArn(ChatConfigurationArnT&& value) { SetChatConfigurationArn(std::forward<ChatConfigurationArnT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    DescribeSlackUserIdentitiesRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
