...
namespace Model
{
  ...
  /**
   * <p>Request to create/modify content would result in a conflict.</p><p><h3>See
   * Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/artifact-2018-05-10/ConflictException">AWS
   * API Reference</a></p>
   */
  class ConflictException
  {
  public:
    AWS_ARTIFACT_API ConflictException() = default;
    AWS_ARTIFACT_API ConflictException(Aws::Utils::Json::JsonView jsonValue);
    AWS_ARTIFACT_API ConflictException& operator=(Aws::Utils::Json::JsonView jsonValue);
