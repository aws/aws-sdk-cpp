...
class CustomerAgreementSummary {
 public:
  ...
  void SetAgreementArn(AgreementArnT&& value) {
    ...
    m_agreementArn = std::forward<AgreementArnT>(value);
  }
  template <typename AgreementArnT = Aws::String>
  CustomerAgreementSummary& WithAgreementArn(AgreementArnT&& value) {
    SetAgreementArn(std::forward<AgreementArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetState(CustomerAgreementState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline CustomerAgreementSummary& WithState(CustomerAgreementState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline void SetType(AgreementType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline CustomerAgreementSummary& WithType(AgreementType value) {
    SetType(value);
    return *this;
  }
  ///@}
