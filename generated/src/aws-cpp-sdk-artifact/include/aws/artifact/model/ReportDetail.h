...
class ReportDetail {
 public:
  ...
  void SetPeriodStart(PeriodStartT&& value) {
    ...
    m_periodStart = std::forward<PeriodStartT>(value);
  }
  template <typename PeriodStartT = Aws::Utils::DateTime>
  ReportDetail& WithPeriodStart(PeriodStartT&& value) {
    SetPeriodStart(std::forward<PeriodStartT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPeriodEnd(PeriodEndT&& value) {
    ...
    m_periodEnd = std::forward<PeriodEndT>(value);
  }
  template <typename PeriodEndT = Aws::Utils::DateTime>
  ReportDetail& WithPeriodEnd(PeriodEndT&& value) {
    SetPeriodEnd(std::forward<PeriodEndT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetState(PublishedState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline ReportDetail& WithState(PublishedState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  void SetTermArn(TermArnT&& value) {
    ...
    m_termArn = std::forward<TermArnT>(value);
  }
  template <typename TermArnT = Aws::String>
  ReportDetail& WithTermArn(TermArnT&& value) {
    SetTermArn(std::forward<TermArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline ReportDetail& WithVersion(long long value) {
    SetVersion(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAcceptanceType(AcceptanceType value) {
    m_acceptanceTypeHasBeenSet = true;
    m_acceptanceType = value;
  }
  inline ReportDetail& WithAcceptanceType(AcceptanceType value) {
  ...
  inline void SetSequenceNumber(long long value) {
    m_sequenceNumberHasBeenSet = true;
    m_sequenceNumber = value;
  }
  inline ReportDetail& WithSequenceNumber(long long value) {
  ...
  inline void SetUploadState(UploadState value) {
    m_uploadStateHasBeenSet = true;
    m_uploadState = value;
  }
  inline ReportDetail& WithUploadState(UploadState value) {
