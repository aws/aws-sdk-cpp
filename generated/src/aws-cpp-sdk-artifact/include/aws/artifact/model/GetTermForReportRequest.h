...
namespace Model
{
  ...
  /**
   */
  class GetTermForReportRequest : public ArtifactRequest
  {
  public:
    AWS_ARTIFACT_API GetTermForReportRequest();

    // Service request name is the Operation name which will send this request out,
    // each operation should has unique request name, so that we can get operation's name from this request.
    // Note: this is not true for response, multiple operations may have the same response name,
    // so we can not get operation's name from response.
    inline virtual const char* GetServiceRequestName() const override { return "GetTermForReport"; }
    ...
    inline GetTermForReportRequest& WithReportId(const Aws::String& value) { SetReportId(value); return *this;}
    inline GetTermForReportRequest& WithReportId(Aws::String&& value) { SetReportId(std::move(value)); return *this;}
    inline GetTermForReportRequest& WithReportId(const char* value) { SetReportId(value); return *this;}
    ///@}
    ...
    inline GetTermForReportRequest& WithReportVersion(long long value) { SetReportVersion(value); return *this;}
    ///@}
  private:
