...
class GetTermForReportRequest : public ArtifactRequest {
 public:
  ...
  template <typename ReportIdT = Aws::String>
  GetTermForReportRequest& WithReportId(ReportIdT&& value) {
  ...
  inline void SetReportVersion(long long value) {
    m_reportVersionHasBeenSet = true;
    m_reportVersion = value;
  }
  inline GetTermForReportRequest& WithReportVersion(long long value) {
