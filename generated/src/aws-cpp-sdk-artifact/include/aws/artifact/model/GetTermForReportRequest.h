...
namespace Model
{
  ...
  {
  public:
    AWS_ARTIFACT_API GetTermForReportRequest() = default;
    ...
    template<typename ReportIdT = Aws::String>
    GetTermForReportRequest& WithReportId(ReportIdT&& value) { SetReportId(std::forward<ReportIdT>(value)); return *this;}
    ///@}
