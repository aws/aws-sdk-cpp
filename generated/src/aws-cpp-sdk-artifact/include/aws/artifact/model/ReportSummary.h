...
class ReportSummary {
 public:
  ...
  inline ReportSummary& WithState(PublishedState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline ReportSummary& WithVersion(long long value) {
    SetVersion(value);
    return *this;
  }
  ///@}
  ...
  inline ReportSummary& WithUploadState(UploadState value) {
  ...
  inline ReportSummary& WithAcceptanceType(AcceptanceType value) {
