...
namespace Model
{
   ...
   * <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/artifact-2018-05-10/ResourceNotFoundException">AWS
   * API Reference</a></p>
   */
  class ResourceNotFoundException
  {
  public:
    AWS_ARTIFACT_API ResourceNotFoundException() = default;
    AWS_ARTIFACT_API ResourceNotFoundException(Aws::Utils::Json::JsonView jsonValue);
    AWS_ARTIFACT_API ResourceNotFoundException& operator=(Aws::Utils::Json::JsonView jsonValue);
