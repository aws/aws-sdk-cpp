...
namespace Model
{
   ...
   * <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/artifact-2018-05-10/ServiceQuotaExceededException">AWS
   * API Reference</a></p>
   */
  class ServiceQuotaExceededException
  {
  public:
    AWS_ARTIFACT_API ServiceQuotaExceededException() = default;
    AWS_ARTIFACT_API ServiceQuotaExceededException(Aws::Utils::Json::JsonView jsonValue);
    AWS_ARTIFACT_API ServiceQuotaExceededException& operator=(Aws::Utils::Json::JsonView jsonValue);
