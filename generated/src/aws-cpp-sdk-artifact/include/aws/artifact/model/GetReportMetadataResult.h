...
class GetReportMetadataResult {
 public:
  ...
  void SetReportDetails(ReportDetailsT&& value) {
    m_reportDetailsHasBeenSet = true;
    m_reportDetails = std::forward<ReportDetailsT>(value);
  }
  template <typename ReportDetailsT = ReportDetail>
  GetReportMetadataResult& WithReportDetails(ReportDetailsT&& value) {
    SetReportDetails(std::forward<ReportDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetReportMetadataResult& WithRequestId(RequestIdT&& value) {
