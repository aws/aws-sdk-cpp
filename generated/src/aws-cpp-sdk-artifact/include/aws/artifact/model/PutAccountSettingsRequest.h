...
class PutAccountSettingsRequest : public ArtifactRequest {
 public:
  ...
  inline void SetNotificationSubscriptionStatus(NotificationSubscriptionStatus value) {
    m_notificationSubscriptionStatusHasBeenSet = true;
    m_notificationSubscriptionStatus = value;
  }
  inline PutAccountSettingsRequest& WithNotificationSubscriptionStatus(NotificationSubscriptionStatus value) {
    SetNotificationSubscriptionStatus(value);
    return *this;
  }
  ///@}
 private:
