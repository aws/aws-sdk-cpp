...
class ListCustomerAgreementsResult {
 public:
  ...
  void SetCustomerAgreements(CustomerAgreementsT&& value) {
    m_customerAgreementsHasBeenSet = true;
    m_customerAgreements = std::forward<CustomerAgreementsT>(value);
  }
  template <typename CustomerAgreementsT = Aws::Vector<CustomerAgreementSummary>>
  ListCustomerAgreementsResult& WithCustomerAgreements(CustomerAgreementsT&& value) {
    SetCustomerAgreements(std::forward<CustomerAgreementsT>(value));
    return *this;
  }
  template <typename CustomerAgreementsT = CustomerAgreementSummary>
  ListCustomerAgreementsResult& AddCustomerAgreements(CustomerAgreementsT&& value) {
    m_customerAgreementsHasBeenSet = true;
    m_customerAgreements.emplace_back(std::forward<CustomerAgreementsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListCustomerAgreementsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListCustomerAgreementsResult& WithRequestId(RequestIdT&& value) {
