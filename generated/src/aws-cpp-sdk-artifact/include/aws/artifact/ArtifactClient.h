...
namespace Artifact
{
   ...
   * API.</p>
   */
  class AWS_ARTIFACT_API ArtifactClient : Aws::Client::ClientWithAsyncTemplateMethods<ArtifactClient>,
    smithy::client::AwsSmithyClientT<Aws::Artifact::SERVICE_NAME,
