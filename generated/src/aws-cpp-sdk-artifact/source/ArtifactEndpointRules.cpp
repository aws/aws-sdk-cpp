...
namespace Artifact
{
const size_t ArtifactEndpointRules::RulesBlobStrLen = 3732;
const size_t ArtifactEndpointRules::RulesBlobSize = 3733;
...
'"','h','t','t','p','s',':','/','/','a','r','t','i','f','a','c','t','-','f','i','p','s','.','{','R',
...
't','t','p','s',':','/','/','a','r','t','i','f','a','c','t','.','{','R','e','g','i','o','n','}','.',
