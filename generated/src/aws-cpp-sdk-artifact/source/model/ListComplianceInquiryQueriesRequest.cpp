...
Aws::String ListComplianceInquiryQueriesRequest::SerializePayload() const { return {}; }

void ListComplianceInquiryQueriesRequest::AddQueryStringParameters(URI& uri) const {
  Aws::StringStream ss;
