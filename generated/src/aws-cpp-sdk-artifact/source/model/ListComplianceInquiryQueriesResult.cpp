...
ListComplianceInquiryQueriesResult::ListComplianceInquiryQueriesResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

ListComplianceInquiryQueriesResult& ListComplianceInquiryQueriesResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
