...
GetReportResult::GetReportResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

GetReportResult& GetReportResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
