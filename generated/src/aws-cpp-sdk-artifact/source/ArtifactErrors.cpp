...
namespace Artifact {
template <>
AWS_ARTIFACT_API ConflictException ArtifactError::GetModeledError() {
  assert(this->GetErrorType() == ArtifactErrors::CONFLICT);
  return ConflictException(this->GetJsonPayload().View());
}

template <>
AWS_ARTIFACT_API ThrottlingException ArtifactError::GetModeledError() {
  assert(this->GetErrorType() == ArtifactErrors::THROTTLING);
  return ThrottlingException(this->GetJsonPayload().View());
}

template <>
AWS_ARTIFACT_API ServiceQuotaExceededException ArtifactError::GetModeledError() {
...
template <>
AWS_ARTIFACT_API ValidationException ArtifactError::GetModeledError() {
