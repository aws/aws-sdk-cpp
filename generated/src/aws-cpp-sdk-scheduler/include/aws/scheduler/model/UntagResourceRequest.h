...
namespace Model
{
  ...
  /**
   */
  class UntagResourceRequest : public SchedulerRequest
  {
  public:
    AWS_SCHEDULER_API UntagResourceRequest() = default;
    ...
    ///@{
    /**
     * <p>The Amazon Resource Name (ARN) of the schedule group from which you are
     * removing tags.</p>
     */
