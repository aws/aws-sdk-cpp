...
namespace Model
{
  ...
  /**
   */
  class TagResourceRequest : public SchedulerRequest
  {
  public:
    AWS_SCHEDULER_API TagResourceRequest() = default;
    ...
    ///@{
    /**
     * <p>The Amazon Resource Name (ARN) of the schedule group that you are adding tags
     * to.</p>
     */
