...
namespace Model
{
  ...
  /**
   */
  class ListTagsForResourceRequest : public SchedulerRequest
  {
  public:
    AWS_SCHEDULER_API ListTagsForResourceRequest() = default;
    ...
    ///@{
    /**
     * <p>The ARN of the EventBridge Scheduler resource for which you want to view
     * tags.</p>
     */
