...
namespace Model
{
  ...
  {
  public:
    AWS_SCHEDULER_API DeleteScheduleGroupResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteScheduleGroupResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
