...
class ListScheduleGroupsRequest : public SchedulerRequest {
 public:
  ...
  inline ListScheduleGroupsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NamePrefixT = Aws::String>
  ListScheduleGroupsRequest& WithNamePrefix(NamePrefixT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListScheduleGroupsRequest& WithNextToken(NextTokenT&& value) {
