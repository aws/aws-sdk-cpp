...
namespace Scheduler
{
   ...
   * Scheduler. </p>
   */
  class AWS_SCHEDULER_API SchedulerClient : Aws::Client::ClientWithAsyncTemplateMethods<SchedulerClient>,
    smithy::client::AwsSmithyClientT<Aws::Scheduler::SERVICE_NAME,
