...
namespace AuditManager
{
   ...
   */
  class AWS_AUDITMANAGER_API AuditManagerClient : Aws::Client::ClientWithAsyncTemplateMethods<AuditManagerClient>,
    smithy::client::AwsSmithyClientT<Aws::AuditManager::SERVICE_NAME,
