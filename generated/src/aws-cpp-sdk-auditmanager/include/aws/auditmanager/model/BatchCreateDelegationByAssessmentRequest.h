...
class BatchCreateDelegationByAssessmentRequest : public AuditManagerRequest {
 public:
  ...
  void SetCreateDelegationRequests(CreateDelegationRequestsT&& value) {
    m_createDelegationRequestsHasBeenSet = true;
    m_createDelegationRequests = std::forward<CreateDelegationRequestsT>(value);
  }
  template <typename CreateDelegationRequestsT = Aws::Vector<CreateDelegationRequest>>
  BatchCreateDelegationByAssessmentRequest& WithCreateDelegationRequests(CreateDelegationRequestsT&& value) {
    SetCreateDelegationRequests(std::forward<CreateDelegationRequestsT>(value));
    return *this;
  }
  template <typename CreateDelegationRequestsT = CreateDelegationRequest>
  BatchCreateDelegationByAssessmentRequest& AddCreateDelegationRequests(CreateDelegationRequestsT&& value) {
    m_createDelegationRequestsHasBeenSet = true;
    m_createDelegationRequests.emplace_back(std::forward<CreateDelegationRequestsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename AssessmentIdT = Aws::String>
  BatchCreateDelegationByAssessmentRequest& WithAssessmentId(AssessmentIdT&& value) {
