...
class ListControlInsightsByControlDomainRequest : public AuditManagerRequest {
 public:
  ...
  template <typename ControlDomainIdT = Aws::String>
  ListControlInsightsByControlDomainRequest& WithControlDomainId(ControlDomainIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListControlInsightsByControlDomainRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListControlInsightsByControlDomainRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
