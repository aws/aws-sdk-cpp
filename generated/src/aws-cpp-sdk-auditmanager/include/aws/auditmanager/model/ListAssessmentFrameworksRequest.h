...
class ListAssessmentFrameworksRequest : public AuditManagerRequest {
 public:
  ...
  inline void SetFrameworkType(FrameworkType value) {
    m_frameworkTypeHasBeenSet = true;
    m_frameworkType = value;
  }
  inline ListAssessmentFrameworksRequest& WithFrameworkType(FrameworkType value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListAssessmentFrameworksRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListAssessmentFrameworksRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
