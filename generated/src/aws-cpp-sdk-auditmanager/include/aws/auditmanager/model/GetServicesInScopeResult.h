...
class GetServicesInScopeResult {
 public:
  ...
  template <typename ServiceMetadataT = Aws::Vector<ServiceMetadata>>
  GetServicesInScopeResult& WithServiceMetadata(ServiceMetadataT&& value) {
    SetServiceMetadata(std::forward<ServiceMetadataT>(value));
    return *this;
  }
  template <typename ServiceMetadataT = ServiceMetadata>
  GetServicesInScopeResult& AddServiceMetadata(ServiceMetadataT&& value) {
    m_serviceMetadataHasBeenSet = true;
    m_serviceMetadata.emplace_back(std::forward<ServiceMetadataT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetServicesInScopeResult& WithRequestId(RequestIdT&& value) {
