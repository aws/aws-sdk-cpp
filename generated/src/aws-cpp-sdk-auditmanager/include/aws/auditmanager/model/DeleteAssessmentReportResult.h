...
namespace Model
{
  ...
  {
  public:
    AWS_AUDITMANAGER_API DeleteAssessmentReportResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteAssessmentReportResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
