...
class GetEvidenceFoldersByAssessmentResult {
 public:
  ...
  AWS_AUDITMANAGER_API GetEvidenceFoldersByAssessmentResult& operator=(
  ...
  void SetEvidenceFolders(EvidenceFoldersT&& value) {
    m_evidenceFoldersHasBeenSet = true;
    m_evidenceFolders = std::forward<EvidenceFoldersT>(value);
  }
  template <typename EvidenceFoldersT = Aws::Vector<AssessmentEvidenceFolder>>
  GetEvidenceFoldersByAssessmentResult& WithEvidenceFolders(EvidenceFoldersT&& value) {
    SetEvidenceFolders(std::forward<EvidenceFoldersT>(value));
    return *this;
  }
  template <typename EvidenceFoldersT = AssessmentEvidenceFolder>
  GetEvidenceFoldersByAssessmentResult& AddEvidenceFolders(EvidenceFoldersT&& value) {
    m_evidenceFoldersHasBeenSet = true;
    m_evidenceFolders.emplace_back(std::forward<EvidenceFoldersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetEvidenceFoldersByAssessmentResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetEvidenceFoldersByAssessmentResult& WithRequestId(RequestIdT&& value) {
