...
class GetEvidenceByEvidenceFolderRequest : public AuditManagerRequest {
 public:
  ...
  template <typename AssessmentIdT = Aws::String>
  GetEvidenceByEvidenceFolderRequest& WithAssessmentId(AssessmentIdT&& value) {
  ...
  template <typename ControlSetIdT = Aws::String>
  GetEvidenceByEvidenceFolderRequest& WithControlSetId(ControlSetIdT&& value) {
  ...
  void SetEvidenceFolderId(EvidenceFolderIdT&& value) {
    ...
    m_evidenceFolderId = std::forward<EvidenceFolderIdT>(value);
  }
  template <typename EvidenceFolderIdT = Aws::String>
  GetEvidenceByEvidenceFolderRequest& WithEvidenceFolderId(EvidenceFolderIdT&& value) {
    SetEvidenceFolderId(std::forward<EvidenceFolderIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetEvidenceByEvidenceFolderRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline GetEvidenceByEvidenceFolderRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
