...
class UpdateAssessmentControlSetStatusResult {
 public:
  ...
  AWS_AUDITMANAGER_API UpdateAssessmentControlSetStatusResult& operator=(
  ...
  void SetControlSet(ControlSetT&& value) {
    m_controlSetHasBeenSet = true;
    m_controlSet = std::forward<ControlSetT>(value);
  }
  template <typename ControlSetT = AssessmentControlSet>
  UpdateAssessmentControlSetStatusResult& WithControlSet(ControlSetT&& value) {
    SetControlSet(std::forward<ControlSetT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  UpdateAssessmentControlSetStatusResult& WithRequestId(RequestIdT&& value) {
