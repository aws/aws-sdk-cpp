...
class BatchDeleteDelegationByAssessmentRequest : public AuditManagerRequest {
 public:
  ...
  void SetDelegationIds(DelegationIdsT&& value) {
    m_delegationIdsHasBeenSet = true;
    m_delegationIds = std::forward<DelegationIdsT>(value);
  }
  template <typename DelegationIdsT = Aws::Vector<Aws::String>>
  BatchDeleteDelegationByAssessmentRequest& WithDelegationIds(DelegationIdsT&& value) {
    SetDelegationIds(std::forward<DelegationIdsT>(value));
    return *this;
  }
  template <typename DelegationIdsT = Aws::String>
  BatchDeleteDelegationByAssessmentRequest& AddDelegationIds(DelegationIdsT&& value) {
    m_delegationIdsHasBeenSet = true;
    m_delegationIds.emplace_back(std::forward<DelegationIdsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename AssessmentIdT = Aws::String>
  BatchDeleteDelegationByAssessmentRequest& WithAssessmentId(AssessmentIdT&& value) {
