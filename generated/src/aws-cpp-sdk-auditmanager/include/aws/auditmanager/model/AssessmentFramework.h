...
class AssessmentFramework {
 public:
  ...
  template <typename IdT = Aws::String>
  AssessmentFramework& WithId(IdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  AssessmentFramework& WithArn(ArnT&& value) {
  ...
  template <typename MetadataT = FrameworkMetadata>
  AssessmentFramework& WithMetadata(MetadataT&& value) {
  ...
  void SetControlSets(ControlSetsT&& value) {
    ...
    m_controlSets = std::forward<ControlSetsT>(value);
  }
  template <typename ControlSetsT = Aws::Vector<AssessmentControlSet>>
  AssessmentFramework& WithControlSets(ControlSetsT&& value) {
    SetControlSets(std::forward<ControlSetsT>(value));
    return *this;
  }
  template <typename ControlSetsT = AssessmentControlSet>
  AssessmentFramework& AddControlSets(ControlSetsT&& value) {
    m_controlSetsHasBeenSet = true;
    m_controlSets.emplace_back(std::forward<ControlSetsT>(value));
    return *this;
  }
  ///@}
 private:
