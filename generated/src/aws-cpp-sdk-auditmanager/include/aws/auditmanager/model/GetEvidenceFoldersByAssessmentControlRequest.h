...
class GetEvidenceFoldersByAssessmentControlRequest : public AuditManagerRequest {
 public:
  AWS_AUDITMANAGER_API GetEvidenceFoldersByAssessmentControlRequest() = default;
  ...
  template <typename AssessmentIdT = Aws::String>
  GetEvidenceFoldersByAssessmentControlRequest& WithAssessmentId(AssessmentIdT&& value) {
  ...
  template <typename ControlSetIdT = Aws::String>
  GetEvidenceFoldersByAssessmentControlRequest& WithControlSetId(ControlSetIdT&& value) {
  ...
  template <typename ControlIdT = Aws::String>
  GetEvidenceFoldersByAssessmentControlRequest& WithControlId(ControlIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  GetEvidenceFoldersByAssessmentControlRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline GetEvidenceFoldersByAssessmentControlRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
