...
namespace Model
{
  ...
  {
  public:
    AWS_AUDITMANAGER_API DeleteAssessmentResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteAssessmentResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
