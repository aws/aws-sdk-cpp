...
class ListKeywordsForDataSourceRequest : public AuditManagerRequest {
 public:
  ...
  inline void SetSource(DataSourceType value) {
    m_sourceHasBeenSet = true;
    m_source = value;
  }
  inline ListKeywordsForDataSourceRequest& WithSource(DataSourceType value) {
    SetSource(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListKeywordsForDataSourceRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListKeywordsForDataSourceRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
