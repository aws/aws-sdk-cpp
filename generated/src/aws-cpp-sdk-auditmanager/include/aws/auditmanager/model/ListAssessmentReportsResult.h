...
class ListAssessmentReportsResult {
 public:
  ...
  void SetAssessmentReports(AssessmentReportsT&& value) {
    m_assessmentReportsHasBeenSet = true;
    m_assessmentReports = std::forward<AssessmentReportsT>(value);
  }
  template <typename AssessmentReportsT = Aws::Vector<AssessmentReportMetadata>>
  ListAssessmentReportsResult& WithAssessmentReports(AssessmentReportsT&& value) {
    SetAssessmentReports(std::forward<AssessmentReportsT>(value));
    return *this;
  }
  template <typename AssessmentReportsT = AssessmentReportMetadata>
  ListAssessmentReportsResult& AddAssessmentReports(AssessmentReportsT&& value) {
    m_assessmentReportsHasBeenSet = true;
    m_assessmentReports.emplace_back(std::forward<AssessmentReportsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAssessmentReportsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAssessmentReportsResult& WithRequestId(RequestIdT&& value) {
