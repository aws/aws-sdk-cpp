...
class ListAssessmentsResult {
 public:
  ...
  void SetAssessmentMetadata(AssessmentMetadataT&& value) {
    m_assessmentMetadataHasBeenSet = true;
    m_assessmentMetadata = std::forward<AssessmentMetadataT>(value);
  }
  template <typename AssessmentMetadataT = Aws::Vector<AssessmentMetadataItem>>
  ListAssessmentsResult& WithAssessmentMetadata(AssessmentMetadataT&& value) {
    SetAssessmentMetadata(std::forward<AssessmentMetadataT>(value));
    return *this;
  }
  template <typename AssessmentMetadataT = AssessmentMetadataItem>
  ListAssessmentsResult& AddAssessmentMetadata(AssessmentMetadataT&& value) {
    m_assessmentMetadataHasBeenSet = true;
    m_assessmentMetadata.emplace_back(std::forward<AssessmentMetadataT>(value));
    return *this;
  }
  ///@}
