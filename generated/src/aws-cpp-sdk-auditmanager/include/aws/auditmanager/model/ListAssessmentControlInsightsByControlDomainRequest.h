...
/**
 */
class ListAssessmentControlInsightsByControlDomainRequest : public AuditManagerRequest {
 public:
  AWS_AUDITMANAGER_API ListAssessmentControlInsightsByControlDomainRequest() = default;
  ...
  void SetControlDomainId(ControlDomainIdT&& value) {
    m_controlDomainIdHasBeenSet = true;
    m_controlDomainId = std::forward<ControlDomainIdT>(value);
  }
  template <typename ControlDomainIdT = Aws::String>
  ListAssessmentControlInsightsByControlDomainRequest& WithControlDomainId(ControlDomainIdT&& value) {
    SetControlDomainId(std::forward<ControlDomainIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename AssessmentIdT = Aws::String>
  ListAssessmentControlInsightsByControlDomainRequest& WithAssessmentId(AssessmentIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListAssessmentControlInsightsByControlDomainRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListAssessmentControlInsightsByControlDomainRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
