...
class GetEvidenceFileUploadUrlResult {
 public:
  ...
  void SetEvidenceFileName(EvidenceFileNameT&& value) {
    ...
    m_evidenceFileName = std::forward<EvidenceFileNameT>(value);
  }
  template <typename EvidenceFileNameT = Aws::String>
  GetEvidenceFileUploadUrlResult& WithEvidenceFileName(EvidenceFileNameT&& value) {
    SetEvidenceFileName(std::forward<EvidenceFileNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUploadUrl(UploadUrlT&& value) {
    m_uploadUrlHasBeenSet = true;
    m_uploadUrl = std::forward<UploadUrlT>(value);
  }
  template <typename UploadUrlT = Aws::String>
  GetEvidenceFileUploadUrlResult& WithUploadUrl(UploadUrlT&& value) {
    SetUploadUrl(std::forward<UploadUrlT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetEvidenceFileUploadUrlResult& WithRequestId(RequestIdT&& value) {
