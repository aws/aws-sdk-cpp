...
class GetAssessmentReportUrlRequest : public AuditManagerRequest {
 public:
  ...
  void SetAssessmentReportId(AssessmentReportIdT&& value) {
    m_assessmentReportIdHasBeenSet = true;
    m_assessmentReportId = std::forward<AssessmentReportIdT>(value);
  }
  template <typename AssessmentReportIdT = Aws::String>
  GetAssessmentReportUrlRequest& WithAssessmentReportId(AssessmentReportIdT&& value) {
    SetAssessmentReportId(std::forward<AssessmentReportIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename AssessmentIdT = Aws::String>
  GetAssessmentReportUrlRequest& WithAssessmentId(AssessmentIdT&& value) {
