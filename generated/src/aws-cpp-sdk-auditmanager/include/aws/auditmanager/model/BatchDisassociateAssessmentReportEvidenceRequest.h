...
class BatchDisassociateAssessmentReportEvidenceRequest : public AuditManagerRequest {
 public:
  ...
  template <typename AssessmentIdT = Aws::String>
  BatchDisassociateAssessmentReportEvidenceRequest& WithAssessmentId(AssessmentIdT&& value) {
  ...
  template <typename EvidenceFolderIdT = Aws::String>
  BatchDisassociateAssessmentReportEvidenceRequest& WithEvidenceFolderId(EvidenceFolderIdT&& value) {
  ...
  template <typename EvidenceIdsT = Aws::Vector<Aws::String>>
  BatchDisassociateAssessmentReportEvidenceRequest& WithEvidenceIds(EvidenceIdsT&& value) {
    SetEvidenceIds(std::forward<EvidenceIdsT>(value));
    return *this;
  }
  template <typename EvidenceIdsT = Aws::String>
  BatchDisassociateAssessmentReportEvidenceRequest& AddEvidenceIds(EvidenceIdsT&& value) {
    m_evidenceIdsHasBeenSet = true;
