...
class ListAssessmentFrameworkShareRequestsRequest : public AuditManagerRequest {
 public:
  ...
  inline ListAssessmentFrameworkShareRequestsRequest& WithRequestType(ShareRequestType value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListAssessmentFrameworkShareRequestsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListAssessmentFrameworkShareRequestsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
