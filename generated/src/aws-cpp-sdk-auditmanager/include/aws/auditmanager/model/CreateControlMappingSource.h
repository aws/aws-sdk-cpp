...
class CreateControlMappingSource {
 public:
  ...
  void SetSourceDescription(SourceDescriptionT&& value) {
    ...
    m_sourceDescription = std::forward<SourceDescriptionT>(value);
  }
  template <typename SourceDescriptionT = Aws::String>
  CreateControlMappingSource& WithSourceDescription(SourceDescriptionT&& value) {
    SetSourceDescription(std::forward<SourceDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetSourceSetUpOption(SourceSetUpOption value) {
    m_sourceSetUpOptionHasBeenSet = true;
    m_sourceSetUpOption = value;
  }
  inline CreateControlMappingSource& WithSourceSetUpOption(SourceSetUpOption value) {
    SetSourceSetUpOption(value);
    return *this;
  }
  ///@}
  ...
  inline CreateControlMappingSource& WithSourceType(SourceType value) {
    SetSourceType(value);
    return *this;
  }
  ///@}
  ...
  void SetSourceKeyword(SourceKeywordT&& value) {
    ...
    m_sourceKeyword = std::forward<SourceKeywordT>(value);
  }
  template <typename SourceKeywordT = SourceKeyword>
  CreateControlMappingSource& WithSourceKeyword(SourceKeywordT&& value) {
    SetSourceKeyword(std::forward<SourceKeywordT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetSourceFrequency(SourceFrequency value) {
    m_sourceFrequencyHasBeenSet = true;
    m_sourceFrequency = value;
  }
  inline CreateControlMappingSource& WithSourceFrequency(SourceFrequency value) {
    SetSourceFrequency(value);
    return *this;
  }
  ///@}
  ...
  void SetTroubleshootingText(TroubleshootingTextT&& value) {
    ...
    m_troubleshootingText = std::forward<TroubleshootingTextT>(value);
  }
  template <typename TroubleshootingTextT = Aws::String>
  CreateControlMappingSource& WithTroubleshootingText(TroubleshootingTextT&& value) {
    SetTroubleshootingText(std::forward<TroubleshootingTextT>(value));
    return *this;
  }
  ///@}
 private:
