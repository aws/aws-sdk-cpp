...
class BatchImportEvidenceToAssessmentControlRequest : public AuditManagerRequest {
 public:
  ...
  template <typename AssessmentIdT = Aws::String>
  BatchImportEvidenceToAssessmentControlRequest& WithAssessmentId(AssessmentIdT&& value) {
  ...
  template <typename ControlSetIdT = Aws::String>
  BatchImportEvidenceToAssessmentControlRequest& WithControlSetId(ControlSetIdT&& value) {
  ...
  template <typename ControlIdT = Aws::String>
  BatchImportEvidenceToAssessmentControlRequest& WithControlId(ControlIdT&& value) {
  ...
  template <typename ManualEvidenceT = Aws::Vector<ManualEvidence>>
  BatchImportEvidenceToAssessmentControlRequest& WithManualEvidence(ManualEvidenceT&& value) {
    SetManualEvidence(std::forward<ManualEvidenceT>(value));
    return *this;
  }
  template <typename ManualEvidenceT = ManualEvidence>
  BatchImportEvidenceToAssessmentControlRequest& AddManualEvidence(ManualEvidenceT&& value) {
    m_manualEvidenceHasBeenSet = true;
    m_manualEvidence.emplace_back(std::forward<ManualEvidenceT>(value));
    return *this;
  }
  ///@}
 private:
