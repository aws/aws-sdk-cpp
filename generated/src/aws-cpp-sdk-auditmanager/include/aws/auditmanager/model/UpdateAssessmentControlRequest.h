...
class UpdateAssessmentControlRequest : public AuditManagerRequest {
 public:
  ...
  template <typename AssessmentIdT = Aws::String>
  UpdateAssessmentControlRequest& WithAssessmentId(AssessmentIdT&& value) {
  ...
  template <typename ControlSetIdT = Aws::String>
  UpdateAssessmentControlRequest& WithControlSetId(ControlSetIdT&& value) {
  ...
  template <typename ControlIdT = Aws::String>
  UpdateAssessmentControlRequest& WithControlId(ControlIdT&& value) {
  ...
  inline UpdateAssessmentControlRequest& WithControlStatus(ControlStatus value) {
  ...
  template <typename CommentBodyT = Aws::String>
  UpdateAssessmentControlRequest& WithCommentBody(CommentBodyT&& value) {
