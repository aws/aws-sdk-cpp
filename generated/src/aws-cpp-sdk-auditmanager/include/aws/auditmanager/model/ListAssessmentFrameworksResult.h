...
class ListAssessmentFrameworksResult {
 public:
  ...
  void SetFrameworkMetadataList(FrameworkMetadataListT&& value) {
    m_frameworkMetadataListHasBeenSet = true;
    m_frameworkMetadataList = std::forward<FrameworkMetadataListT>(value);
  }
  template <typename FrameworkMetadataListT = Aws::Vector<AssessmentFrameworkMetadata>>
  ListAssessmentFrameworksResult& WithFrameworkMetadataList(FrameworkMetadataListT&& value) {
    SetFrameworkMetadataList(std::forward<FrameworkMetadataListT>(value));
    return *this;
  }
  template <typename FrameworkMetadataListT = AssessmentFrameworkMetadata>
  ListAssessmentFrameworksResult& AddFrameworkMetadataList(FrameworkMetadataListT&& value) {
    m_frameworkMetadataListHasBeenSet = true;
    m_frameworkMetadataList.emplace_back(std::forward<FrameworkMetadataListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAssessmentFrameworksResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAssessmentFrameworksResult& WithRequestId(RequestIdT&& value) {
