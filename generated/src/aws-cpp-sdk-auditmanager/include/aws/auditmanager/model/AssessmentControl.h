...
class AssessmentControl {
 public:
  ...
  inline void SetStatus(ControlStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline AssessmentControl& WithStatus(ControlStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetResponse(ControlResponse value) {
    m_responseHasBeenSet = true;
    m_response = value;
  }
  inline AssessmentControl& WithResponse(ControlResponse value) {
    SetResponse(value);
    return *this;
  }
  ///@}
  ...
  void SetEvidenceSources(EvidenceSourcesT&& value) {
    ...
    m_evidenceSources = std::forward<EvidenceSourcesT>(value);
  }
  template <typename EvidenceSourcesT = Aws::Vector<Aws::String>>
  AssessmentControl& WithEvidenceSources(EvidenceSourcesT&& value) {
    SetEvidenceSources(std::forward<EvidenceSourcesT>(value));
    return *this;
  }
  template <typename EvidenceSourcesT = Aws::String>
  AssessmentControl& AddEvidenceSources(EvidenceSourcesT&& value) {
    m_evidenceSourcesHasBeenSet = true;
    m_evidenceSources.emplace_back(std::forward<EvidenceSourcesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetEvidenceCount(int value) {
    m_evidenceCountHasBeenSet = true;
    m_evidenceCount = value;
  }
  inline AssessmentControl& WithEvidenceCount(int value) {
    SetEvidenceCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAssessmentReportEvidenceCount(int value) {
    m_assessmentReportEvidenceCountHasBeenSet = true;
    m_assessmentReportEvidenceCount = value;
  }
  inline AssessmentControl& WithAssessmentReportEvidenceCount(int value) {
    SetAssessmentReportEvidenceCount(value);
    return *this;
  }
  ///@}
 private:
