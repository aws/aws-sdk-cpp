...
class GetChangeLogsResult {
 public:
  ...
  void SetChangeLogs(ChangeLogsT&& value) {
    m_changeLogsHasBeenSet = true;
    m_changeLogs = std::forward<ChangeLogsT>(value);
  }
  template <typename ChangeLogsT = Aws::Vector<ChangeLog>>
  GetChangeLogsResult& WithChangeLogs(ChangeLogsT&& value) {
    SetChangeLogs(std::forward<ChangeLogsT>(value));
    return *this;
  }
  template <typename ChangeLogsT = ChangeLog>
  GetChangeLogsResult& AddChangeLogs(ChangeLogsT&& value) {
    m_changeLogsHasBeenSet = true;
    m_changeLogs.emplace_back(std::forward<ChangeLogsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetChangeLogsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetChangeLogsResult& WithRequestId(RequestIdT&& value) {
