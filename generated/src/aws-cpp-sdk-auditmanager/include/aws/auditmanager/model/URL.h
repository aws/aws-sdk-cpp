...
class URL {
 public:
  ...
  void SetHyperlinkName(HyperlinkNameT&& value) {
    m_hyperlinkNameHasBeenSet = true;
    m_hyperlinkName = std::forward<HyperlinkNameT>(value);
  }
  template <typename HyperlinkNameT = Aws::String>
  URL& WithHyperlinkName(HyperlinkNameT&& value) {
    SetHyperlinkName(std::forward<HyperlinkNameT>(value));
    return *this;
  }
  ///@}
