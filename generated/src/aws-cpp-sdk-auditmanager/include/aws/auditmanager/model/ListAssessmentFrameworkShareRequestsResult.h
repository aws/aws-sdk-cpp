...
namespace Model
{
  ...
  public:
    ...
    inline ListAssessmentFrameworkShareRequestsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ListAssessmentFrameworkShareRequestsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ListAssessmentFrameworkShareRequestsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
