...
namespace Model
{
  ...
  public:
    ...
    template<typename EvidenceIdsT = Aws::Vector<Aws::String>>
    BatchDisassociateAssessmentReportEvidenceResult& WithEvidenceIds(EvidenceIdsT&& value) { SetEvidenceIds(std::forward<EvidenceIdsT>(value)); return *this;}
    template<typename EvidenceIdsT = Aws::String>
    BatchDisassociateAssessmentReportEvidenceResult& AddEvidenceIds(EvidenceIdsT&& value) { m_evidenceIdsHasBeenSet = true; m_evidenceIds.emplace_back(std::forward<EvidenceIdsT>(value)); return *this; }
    ///@}
    ...
    template<typename ErrorsT = Aws::Vector<AssessmentReportEvidenceError>>
    BatchDisassociateAssessmentReportEvidenceResult& WithErrors(ErrorsT&& value) { SetErrors(std::forward<ErrorsT>(value)); return *this;}
    template<typename ErrorsT = AssessmentReportEvidenceError>
    BatchDisassociateAssessmentReportEvidenceResult& AddErrors(ErrorsT&& value) { m_errorsHasBeenSet = true; m_errors.emplace_back(std::forward<ErrorsT>(value)); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    BatchDisassociateAssessmentReportEvidenceResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
