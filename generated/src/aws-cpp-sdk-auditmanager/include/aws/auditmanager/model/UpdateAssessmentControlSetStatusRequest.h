...
class UpdateAssessmentControlSetStatusRequest : public AuditManagerRequest {
 public:
  ...
  template <typename AssessmentIdT = Aws::String>
  UpdateAssessmentControlSetStatusRequest& WithAssessmentId(AssessmentIdT&& value) {
  ...
  template <typename ControlSetIdT = Aws::String>
  UpdateAssessmentControlSetStatusRequest& WithControlSetId(ControlSetIdT&& value) {
  ...
  inline UpdateAssessmentControlSetStatusRequest& WithStatus(ControlSetStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CommentT = Aws::String>
  UpdateAssessmentControlSetStatusRequest& WithComment(CommentT&& value) {
