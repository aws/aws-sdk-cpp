...
class AssessmentReportsDestination {
 public:
  ...
  inline void SetDestinationType(AssessmentReportDestinationType value) {
    m_destinationTypeHasBeenSet = true;
    m_destinationType = value;
  }
  inline AssessmentReportsDestination& WithDestinationType(AssessmentReportDestinationType value) {
