...
namespace Model
{
  ...
  public:
    ...
    inline DeleteControlResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeleteControlResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeleteControlResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
