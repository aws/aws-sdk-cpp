...
namespace Model
{
  ...
  public:
    ...
    inline ListKeywordsForDataSourceResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ListKeywordsForDataSourceResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ListKeywordsForDataSourceResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
