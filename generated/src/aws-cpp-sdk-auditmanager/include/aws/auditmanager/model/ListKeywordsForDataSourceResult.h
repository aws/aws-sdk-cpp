...
class ListKeywordsForDataSourceResult {
 public:
  ...
  template <typename KeywordsT = Aws::Vector<Aws::String>>
  ListKeywordsForDataSourceResult& WithKeywords(KeywordsT&& value) {
    SetKeywords(std::forward<KeywordsT>(value));
    return *this;
  }
  template <typename KeywordsT = Aws::String>
  ListKeywordsForDataSourceResult& AddKeywords(KeywordsT&& value) {
    m_keywordsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListKeywordsForDataSourceResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListKeywordsForDataSourceResult& WithRequestId(RequestIdT&& value) {
