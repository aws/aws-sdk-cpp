...
class BatchCreateDelegationByAssessmentError {
 public:
  ...
  void SetCreateDelegationRequest(CreateDelegationRequestT&& value) {
    m_createDelegationRequestHasBeenSet = true;
    m_createDelegationRequest = std::forward<CreateDelegationRequestT>(value);
  }
  template <typename CreateDelegationRequestT = CreateDelegationRequest>
  BatchCreateDelegationByAssessmentError& WithCreateDelegationRequest(CreateDelegationRequestT&& value) {
    SetCreateDelegationRequest(std::forward<CreateDelegationRequestT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ErrorCodeT = Aws::String>
  BatchCreateDelegationByAssessmentError& WithErrorCode(ErrorCodeT&& value) {
  ...
  template <typename ErrorMessageT = Aws::String>
  BatchCreateDelegationByAssessmentError& WithErrorMessage(ErrorMessageT&& value) {
