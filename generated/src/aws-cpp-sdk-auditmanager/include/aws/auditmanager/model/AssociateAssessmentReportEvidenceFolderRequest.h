...
class AssociateAssessmentReportEvidenceFolderRequest : public AuditManagerRequest {
 public:
  ...
  template <typename AssessmentIdT = Aws::String>
  AssociateAssessmentReportEvidenceFolderRequest& WithAssessmentId(AssessmentIdT&& value) {
  ...
  template <typename EvidenceFolderIdT = Aws::String>
  AssociateAssessmentReportEvidenceFolderRequest& WithEvidenceFolderId(EvidenceFolderIdT&& value) {
