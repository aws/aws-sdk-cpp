...
class UpdateAssessmentFrameworkShareResult {
 public:
  ...
  AWS_AUDITMANAGER_API UpdateAssessmentFrameworkShareResult& operator=(
  ...
  void SetAssessmentFrameworkShareRequest(AssessmentFrameworkShareRequestT&& value) {
    m_assessmentFrameworkShareRequestHasBeenSet = true;
    m_assessmentFrameworkShareRequest = std::forward<AssessmentFrameworkShareRequestT>(value);
  }
  template <typename AssessmentFrameworkShareRequestT = AssessmentFrameworkShareRequest>
  UpdateAssessmentFrameworkShareResult& WithAssessmentFrameworkShareRequest(AssessmentFrameworkShareRequestT&& value) {
    SetAssessmentFrameworkShareRequest(std::forward<AssessmentFrameworkShareRequestT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  UpdateAssessmentFrameworkShareResult& WithRequestId(RequestIdT&& value) {
