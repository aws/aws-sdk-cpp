...
class UpdateAssessmentFrameworkShareRequest : public AuditManagerRequest {
 public:
  ...
  inline UpdateAssessmentFrameworkShareRequest& WithRequestType(ShareRequestType value) {
  ...
  inline void SetAction(ShareRequestAction value) {
    m_actionHasBeenSet = true;
    m_action = value;
  }
  inline UpdateAssessmentFrameworkShareRequest& WithAction(ShareRequestAction value) {
    SetAction(value);
    return *this;
  }
  ///@}
