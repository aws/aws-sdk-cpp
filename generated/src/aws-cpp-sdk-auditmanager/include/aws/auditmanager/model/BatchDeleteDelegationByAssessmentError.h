...
class BatchDeleteDelegationByAssessmentError {
 public:
  ...
  void SetDelegationId(DelegationIdT&& value) {
    m_delegationIdHasBeenSet = true;
    m_delegationId = std::forward<DelegationIdT>(value);
  }
  template <typename DelegationIdT = Aws::String>
  BatchDeleteDelegationByAssessmentError& WithDelegationId(DelegationIdT&& value) {
    SetDelegationId(std::forward<DelegationIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ErrorCodeT = Aws::String>
  BatchDeleteDelegationByAssessmentError& WithErrorCode(ErrorCodeT&& value) {
  ...
  template <typename ErrorMessageT = Aws::String>
  BatchDeleteDelegationByAssessmentError& WithErrorMessage(ErrorMessageT&& value) {
