...
class RegisterAccountRequest : public AuditManagerRequest {
 public:
  ...
  template <typename KmsKeyT = Aws::String>
  RegisterAccountRequest& WithKmsKey(KmsKeyT&& value) {
  ...
  void SetDelegatedAdminAccount(DelegatedAdminAccountT&& value) {
    m_delegatedAdminAccountHasBeenSet = true;
    m_delegatedAdminAccount = std::forward<DelegatedAdminAccountT>(value);
  }
  template <typename DelegatedAdminAccountT = Aws::String>
  RegisterAccountRequest& WithDelegatedAdminAccount(DelegatedAdminAccountT&& value) {
    SetDelegatedAdminAccount(std::forward<DelegatedAdminAccountT>(value));
    return *this;
  }
  ///@}
 private:
