...
class BatchImportEvidenceToAssessmentControlResult {
 public:
  ...
  AWS_AUDITMANAGER_API BatchImportEvidenceToAssessmentControlResult& operator=(
  ...
  template <typename ErrorsT = Aws::Vector<BatchImportEvidenceToAssessmentControlError>>
  BatchImportEvidenceToAssessmentControlResult& WithErrors(ErrorsT&& value) {
    SetErrors(std::forward<ErrorsT>(value));
    return *this;
  }
  template <typename ErrorsT = BatchImportEvidenceToAssessmentControlError>
  BatchImportEvidenceToAssessmentControlResult& AddErrors(ErrorsT&& value) {
    m_errorsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  BatchImportEvidenceToAssessmentControlResult& WithRequestId(RequestIdT&& value) {
