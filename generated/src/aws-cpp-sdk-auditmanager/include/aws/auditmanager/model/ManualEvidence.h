...
class ManualEvidence {
 public:
  ...
  void SetS3ResourcePath(S3ResourcePathT&& value) {
    ...
    m_s3ResourcePath = std::forward<S3ResourcePathT>(value);
  }
  template <typename S3ResourcePathT = Aws::String>
  ManualEvidence& WithS3ResourcePath(S3ResourcePathT&& value) {
    SetS3ResourcePath(std::forward<S3ResourcePathT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTextResponse(TextResponseT&& value) {
    ...
    m_textResponse = std::forward<TextResponseT>(value);
  }
  template <typename TextResponseT = Aws::String>
  ManualEvidence& WithTextResponse(TextResponseT&& value) {
    SetTextResponse(std::forward<TextResponseT>(value));
    return *this;
  }
  ///@}
