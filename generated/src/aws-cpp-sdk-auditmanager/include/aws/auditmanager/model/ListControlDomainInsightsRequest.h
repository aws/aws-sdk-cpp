...
class ListControlDomainInsightsRequest : public AuditManagerRequest {
 public:
  AWS_AUDITMANAGER_API ListControlDomainInsightsRequest() = default;
  ...
  template <typename NextTokenT = Aws::String>
  ListControlDomainInsightsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListControlDomainInsightsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
