...
class StartAssessmentFrameworkShareResult {
 public:
  ...
  AWS_AUDITMANAGER_API StartAssessmentFrameworkShareResult& operator=(
  ...
  template <typename AssessmentFrameworkShareRequestT = AssessmentFrameworkShareRequest>
  StartAssessmentFrameworkShareResult& WithAssessmentFrameworkShareRequest(AssessmentFrameworkShareRequestT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StartAssessmentFrameworkShareResult& WithRequestId(RequestIdT&& value) {
