...
class GetOrganizationAdminAccountResult {
 public:
  ...
  template <typename AdminAccountIdT = Aws::String>
  GetOrganizationAdminAccountResult& WithAdminAccountId(AdminAccountIdT&& value) {
  ...
  template <typename OrganizationIdT = Aws::String>
  GetOrganizationAdminAccountResult& WithOrganizationId(OrganizationIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetOrganizationAdminAccountResult& WithRequestId(RequestIdT&& value) {
