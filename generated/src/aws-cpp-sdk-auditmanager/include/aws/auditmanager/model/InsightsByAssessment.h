...
class InsightsByAssessment {
 public:
  ...
  inline InsightsByAssessment& WithNoncompliantEvidenceCount(int value) {
  ...
  inline InsightsByAssessment& WithCompliantEvidenceCount(int value) {
  ...
  inline InsightsByAssessment& WithInconclusiveEvidenceCount(int value) {
  ...
  inline InsightsByAssessment& WithAssessmentControlsCountByNoncompliantEvidence(int value) {
  ...
  inline InsightsByAssessment& WithTotalAssessmentControlsCount(int value) {
