...
class GetEvidenceFoldersByAssessmentControlResult {
 public:
  ...
  AWS_AUDITMANAGER_API GetEvidenceFoldersByAssessmentControlResult& operator=(
  ...
  template <typename EvidenceFoldersT = Aws::Vector<AssessmentEvidenceFolder>>
  GetEvidenceFoldersByAssessmentControlResult& WithEvidenceFolders(EvidenceFoldersT&& value) {
    SetEvidenceFolders(std::forward<EvidenceFoldersT>(value));
    return *this;
  }
  template <typename EvidenceFoldersT = AssessmentEvidenceFolder>
  GetEvidenceFoldersByAssessmentControlResult& AddEvidenceFolders(EvidenceFoldersT&& value) {
    m_evidenceFoldersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetEvidenceFoldersByAssessmentControlResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetEvidenceFoldersByAssessmentControlResult& WithRequestId(RequestIdT&& value) {
