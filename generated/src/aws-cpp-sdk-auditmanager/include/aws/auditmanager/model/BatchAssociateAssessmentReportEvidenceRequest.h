...
class BatchAssociateAssessmentReportEvidenceRequest : public AuditManagerRequest {
 public:
  ...
  template <typename AssessmentIdT = Aws::String>
  BatchAssociateAssessmentReportEvidenceRequest& WithAssessmentId(AssessmentIdT&& value) {
  ...
  template <typename EvidenceFolderIdT = Aws::String>
  BatchAssociateAssessmentReportEvidenceRequest& WithEvidenceFolderId(EvidenceFolderIdT&& value) {
  ...
  template <typename EvidenceIdsT = Aws::Vector<Aws::String>>
  BatchAssociateAssessmentReportEvidenceRequest& WithEvidenceIds(EvidenceIdsT&& value) {
    SetEvidenceIds(std::forward<EvidenceIdsT>(value));
    return *this;
  }
  template <typename EvidenceIdsT = Aws::String>
  BatchAssociateAssessmentReportEvidenceRequest& AddEvidenceIds(EvidenceIdsT&& value) {
    m_evidenceIdsHasBeenSet = true;
