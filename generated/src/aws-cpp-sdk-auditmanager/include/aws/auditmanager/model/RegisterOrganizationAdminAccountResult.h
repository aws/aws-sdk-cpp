...
namespace Model
{
  ...
  public:
    ...
    template<typename AdminAccountIdT = Aws::String>
    RegisterOrganizationAdminAccountResult& WithAdminAccountId(AdminAccountIdT&& value) { SetAdminAccountId(std::forward<AdminAccountIdT>(value)); return *this;}
    ///@}
    ...
    template<typename OrganizationIdT = Aws::String>
    RegisterOrganizationAdminAccountResult& WithOrganizationId(OrganizationIdT&& value) { SetOrganizationId(std::forward<OrganizationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    RegisterOrganizationAdminAccountResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
