...
class EvidenceFinderEnablement {
 public:
  ...
  inline void SetEnablementStatus(EvidenceFinderEnablementStatus value) {
    m_enablementStatusHasBeenSet = true;
    m_enablementStatus = value;
  }
  inline EvidenceFinderEnablement& WithEnablementStatus(EvidenceFinderEnablementStatus value) {
  ...
  inline void SetBackfillStatus(EvidenceFinderBackfillStatus value) {
    m_backfillStatusHasBeenSet = true;
    m_backfillStatus = value;
  }
  inline EvidenceFinderEnablement& WithBackfillStatus(EvidenceFinderBackfillStatus value) {
    SetBackfillStatus(value);
    return *this;
  }
  ///@}
