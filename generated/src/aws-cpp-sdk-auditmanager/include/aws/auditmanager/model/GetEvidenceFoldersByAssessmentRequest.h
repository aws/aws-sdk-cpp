...
class GetEvidenceFoldersByAssessmentRequest : public AuditManagerRequest {
 public:
  AWS_AUDITMANAGER_API GetEvidenceFoldersByAssessmentRequest() = default;
  ...
  template <typename AssessmentIdT = Aws::String>
  GetEvidenceFoldersByAssessmentRequest& WithAssessmentId(AssessmentIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  GetEvidenceFoldersByAssessmentRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline GetEvidenceFoldersByAssessmentRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
