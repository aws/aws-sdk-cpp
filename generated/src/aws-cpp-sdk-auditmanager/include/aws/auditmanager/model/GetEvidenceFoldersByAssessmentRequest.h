...
namespace Model
{
  ...
  public:
    ...
    template<typename AssessmentIdT = Aws::String>
    GetEvidenceFoldersByAssessmentRequest& WithAssessmentId(AssessmentIdT&& value) { SetAssessmentId(std::forward<AssessmentIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    GetEvidenceFoldersByAssessmentRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
