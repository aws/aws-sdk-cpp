...
class ListControlDomainInsightsResult {
 public:
  ...
  template <typename ControlDomainInsightsT = Aws::Vector<ControlDomainInsights>>
  ListControlDomainInsightsResult& WithControlDomainInsights(ControlDomainInsightsT&& value) {
  ...
  ListControlDomainInsightsResult& AddControlDomainInsights(ControlDomainInsightsT&& value) {
    m_controlDomainInsightsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListControlDomainInsightsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListControlDomainInsightsResult& WithRequestId(RequestIdT&& value) {
