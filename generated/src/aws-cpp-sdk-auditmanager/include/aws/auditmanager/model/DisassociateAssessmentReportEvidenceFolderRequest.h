...
namespace Model
{
  ...
  {
  public:
    AWS_AUDITMANAGER_API DisassociateAssessmentReportEvidenceFolderRequest() = default;
    ...
    template<typename AssessmentIdT = Aws::String>
    DisassociateAssessmentReportEvidenceFolderRequest& WithAssessmentId(AssessmentIdT&& value) { SetAssessmentId(std::forward<AssessmentIdT>(value)); return *this;}
    ///@}
    ...
    template<typename EvidenceFolderIdT = Aws::String>
    DisassociateAssessmentReportEvidenceFolderRequest& WithEvidenceFolderId(EvidenceFolderIdT&& value) { SetEvidenceFolderId(std::forward<EvidenceFolderIdT>(value)); return *this;}
    ///@}
  private:
