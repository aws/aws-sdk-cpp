...
class DisassociateAssessmentReportEvidenceFolderRequest : public AuditManagerRequest {
 public:
  ...
  template <typename AssessmentIdT = Aws::String>
  DisassociateAssessmentReportEvidenceFolderRequest& WithAssessmentId(AssessmentIdT&& value) {
  ...
  template <typename EvidenceFolderIdT = Aws::String>
  DisassociateAssessmentReportEvidenceFolderRequest& WithEvidenceFolderId(EvidenceFolderIdT&& value) {
