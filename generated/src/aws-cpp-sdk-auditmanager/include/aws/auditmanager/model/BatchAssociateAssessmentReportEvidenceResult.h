...
class BatchAssociateAssessmentReportEvidenceResult {
 public:
  ...
  AWS_AUDITMANAGER_API BatchAssociateAssessmentReportEvidenceResult& operator=(
  ...
  template <typename EvidenceIdsT = Aws::Vector<Aws::String>>
  BatchAssociateAssessmentReportEvidenceResult& WithEvidenceIds(EvidenceIdsT&& value) {
    SetEvidenceIds(std::forward<EvidenceIdsT>(value));
    return *this;
  }
  template <typename EvidenceIdsT = Aws::String>
  BatchAssociateAssessmentReportEvidenceResult& AddEvidenceIds(EvidenceIdsT&& value) {
    m_evidenceIdsHasBeenSet = true;
  ...
  template <typename ErrorsT = Aws::Vector<AssessmentReportEvidenceError>>
  BatchAssociateAssessmentReportEvidenceResult& WithErrors(ErrorsT&& value) {
    SetErrors(std::forward<ErrorsT>(value));
    return *this;
  }
  template <typename ErrorsT = AssessmentReportEvidenceError>
  BatchAssociateAssessmentReportEvidenceResult& AddErrors(ErrorsT&& value) {
    m_errorsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  BatchAssociateAssessmentReportEvidenceResult& WithRequestId(RequestIdT&& value) {
