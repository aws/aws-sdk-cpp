...
class ControlInsightsMetadataItem {
 public:
  ...
  template <typename NameT = Aws::String>
  ControlInsightsMetadataItem& WithName(NameT&& value) {
  ...
  template <typename IdT = Aws::String>
  ControlInsightsMetadataItem& WithId(IdT&& value) {
  ...
  template <typename EvidenceInsightsT = EvidenceInsights>
  ControlInsightsMetadataItem& WithEvidenceInsights(EvidenceInsightsT&& value) {
  ...
  template <typename LastUpdatedT = Aws::Utils::DateTime>
  ControlInsightsMetadataItem& WithLastUpdated(LastUpdatedT&& value) {
