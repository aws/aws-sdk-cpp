...
class GetEvidenceByEvidenceFolderResult {
 public:
  ...
  template <typename EvidenceT = Aws::Vector<Evidence>>
  GetEvidenceByEvidenceFolderResult& WithEvidence(EvidenceT&& value) {
    SetEvidence(std::forward<EvidenceT>(value));
    return *this;
  }
  template <typename EvidenceT = Evidence>
  GetEvidenceByEvidenceFolderResult& AddEvidence(EvidenceT&& value) {
    m_evidenceHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetEvidenceByEvidenceFolderResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetEvidenceByEvidenceFolderResult& WithRequestId(RequestIdT&& value) {
