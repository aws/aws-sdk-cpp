...
class AssessmentReportEvidenceError {
 public:
  ...
  template <typename EvidenceIdT = Aws::String>
  AssessmentReportEvidenceError& WithEvidenceId(EvidenceIdT&& value) {
  ...
  template <typename ErrorCodeT = Aws::String>
  AssessmentReportEvidenceError& WithErrorCode(ErrorCodeT&& value) {
  ...
  template <typename ErrorMessageT = Aws::String>
  AssessmentReportEvidenceError& WithErrorMessage(ErrorMessageT&& value) {
