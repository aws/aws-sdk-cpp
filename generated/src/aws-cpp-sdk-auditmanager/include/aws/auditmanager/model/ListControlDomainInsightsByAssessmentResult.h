...
class ListControlDomainInsightsByAssessmentResult {
 public:
  ...
  AWS_AUDITMANAGER_API ListControlDomainInsightsByAssessmentResult& operator=(
  ...
  void SetControlDomainInsights(ControlDomainInsightsT&& value) {
    m_controlDomainInsightsHasBeenSet = true;
    m_controlDomainInsights = std::forward<ControlDomainInsightsT>(value);
  }
  template <typename ControlDomainInsightsT = Aws::Vector<ControlDomainInsights>>
  ListControlDomainInsightsByAssessmentResult& WithControlDomainInsights(ControlDomainInsightsT&& value) {
    SetControlDomainInsights(std::forward<ControlDomainInsightsT>(value));
    return *this;
  }
  template <typename ControlDomainInsightsT = ControlDomainInsights>
  ListControlDomainInsightsByAssessmentResult& AddControlDomainInsights(ControlDomainInsightsT&& value) {
    m_controlDomainInsightsHasBeenSet = true;
    m_controlDomainInsights.emplace_back(std::forward<ControlDomainInsightsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListControlDomainInsightsByAssessmentResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListControlDomainInsightsByAssessmentResult& WithRequestId(RequestIdT&& value) {
