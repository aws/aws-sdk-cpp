...
Control::Control(JsonView jsonValue) { *this = jsonValue; }
...
Control& Control::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("controlMappingSources")) {
    ...
    for (unsigned controlMappingSourcesIndex = 0; controlMappingSourcesIndex < controlMappingSourcesJsonList.GetLength();
         ++controlMappingSourcesIndex) {
