...
InsightsByAssessment::InsightsByAssessment(JsonView jsonValue) { *this = jsonValue; }

InsightsByAssessment& InsightsByAssessment::operator=(JsonView jsonValue) {
...
JsonValue InsightsByAssessment::Jsonize() const {
  JsonValue payload;
