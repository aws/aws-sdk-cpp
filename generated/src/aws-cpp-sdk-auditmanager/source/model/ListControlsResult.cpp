...
ListControlsResult::ListControlsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListControlsResult& ListControlsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("controlMetadataList")) {
    ...
    for (unsigned controlMetadataListIndex = 0; controlMetadataListIndex < controlMetadataListJsonList.GetLength();
         ++controlMetadataListIndex) {
