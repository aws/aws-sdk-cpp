...
ListAssessmentFrameworkShareRequestsResult& ListAssessmentFrameworkShareRequestsResult::operator=(
  ...
  if (jsonValue.ValueExists("assessmentFrameworkShareRequests")) {
    ...
    for (unsigned assessmentFrameworkShareRequestsIndex = 0;
         assessmentFrameworkShareRequestsIndex < assessmentFrameworkShareRequestsJsonList.GetLength();
         ++assessmentFrameworkShareRequestsIndex) {
      m_assessmentFrameworkShareRequests.push_back(
          assessmentFrameworkShareRequestsJsonList[assessmentFrameworkShareRequestsIndex].AsObject());
    }
    m_assessmentFrameworkShareRequestsHasBeenSet = true;
  }
