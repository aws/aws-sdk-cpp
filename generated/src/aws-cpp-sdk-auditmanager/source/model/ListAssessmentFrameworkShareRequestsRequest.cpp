...
Aws::String ListAssessmentFrameworkShareRequestsRequest::SerializePayload() const { return {}; }

void ListAssessmentFrameworkShareRequestsRequest::AddQueryStringParameters(URI& uri) const {
  Aws::StringStream ss;
