...
ListControlInsightsByControlDomainResult& ListControlInsightsByControlDomainResult::operator=(
  ...
  if (jsonValue.ValueExists("controlInsightsMetadata")) {
    ...
    for (unsigned controlInsightsMetadataIndex = 0; controlInsightsMetadataIndex < controlInsightsMetadataJsonList.GetLength();
         ++controlInsightsMetadataIndex) {
