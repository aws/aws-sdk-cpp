...
template <>
AWS_AUDITMANAGER_API ResourceNotFoundException AuditManagerError::GetModeledError() {
  assert(this->GetErrorType() == AuditManagerErrors::RESOURCE_NOT_FOUND);
  return ResourceNotFoundException(this->GetJsonPayload().View());
}

template <>
AWS_AUDITMANAGER_API ValidationException AuditManagerError::GetModeledError() {
