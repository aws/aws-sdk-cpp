...
namespace ControlTower
{
   ...
   */
  class AWS_CONTROLTOWER_API ControlTowerClient : Aws::Client::ClientWithAsyncTemplateMethods<ControlTowerClient>,
    smithy::client::AwsSmithyClientT<Aws::ControlTower::SERVICE_NAME,
