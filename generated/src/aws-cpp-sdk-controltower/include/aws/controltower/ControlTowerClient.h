...
class AWS_CONTROLTOWER_API ControlTowerClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  ControlTowerClient(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<ControlTowerEndpointProviderBase> endpointProvider = nullptr,
      const Aws::ControlTower::ControlTowerClientConfiguration& clientConfiguration = Aws::ControlTower::ControlTowerClientConfiguration());
  ...
  /**
   * A Callable wrapper for CreateLandingZone that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateLandingZone that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateLandingZoneRequestT = Model::CreateLandingZoneRequest>
  void CreateLandingZoneAsync(const CreateLandingZoneRequestT& request, const CreateLandingZoneResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for DeleteLandingZone that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteLandingZone that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteLandingZoneRequestT = Model::DeleteLandingZoneRequest>
  void DeleteLandingZoneAsync(const DeleteLandingZoneRequestT& request, const DeleteLandingZoneResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DisableBaseline that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DisableBaselineRequestT = Model::DisableBaselineRequest>
  void DisableBaselineAsync(const DisableBaselineRequestT& request, const DisableBaselineResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DisableControl that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DisableControlRequestT = Model::DisableControlRequest>
  ...
  /**
   * An Async wrapper for EnableBaseline that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename EnableBaselineRequestT = Model::EnableBaselineRequest>
  void EnableBaselineAsync(const EnableBaselineRequestT& request, const EnableBaselineResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for EnableControl that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename EnableControlRequestT = Model::EnableControlRequest>
  void EnableControlAsync(const EnableControlRequestT& request, const EnableControlResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetBaseline that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetBaselineRequestT = Model::GetBaselineRequest>
  void GetBaselineAsync(const GetBaselineRequestT& request, const GetBaselineResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetBaselineOperation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetBaselineOperation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetBaselineOperationRequestT = Model::GetBaselineOperationRequest>
  void GetBaselineOperationAsync(const GetBaselineOperationRequestT& request, const GetBaselineOperationResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetControlOperation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetControlOperation that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetControlOperationRequestT = Model::GetControlOperationRequest>
  void GetControlOperationAsync(const GetControlOperationRequestT& request, const GetControlOperationResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetEnabledBaseline that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetEnabledBaseline that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetEnabledBaselineRequestT = Model::GetEnabledBaselineRequest>
  void GetEnabledBaselineAsync(const GetEnabledBaselineRequestT& request, const GetEnabledBaselineResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetEnabledControl that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetEnabledControl that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetEnabledControlRequestT = Model::GetEnabledControlRequest>
  void GetEnabledControlAsync(const GetEnabledControlRequestT& request, const GetEnabledControlResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetLandingZone that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetLandingZoneRequestT = Model::GetLandingZoneRequest>
  void GetLandingZoneAsync(const GetLandingZoneRequestT& request, const GetLandingZoneResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetLandingZoneOperation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetLandingZoneOperation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetLandingZoneOperationRequestT = Model::GetLandingZoneOperationRequest>
  void GetLandingZoneOperationAsync(const GetLandingZoneOperationRequestT& request,
                                    const GetLandingZoneOperationResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListBaselines that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListBaselinesRequestT = Model::ListBaselinesRequest>
  void ListBaselinesAsync(const ListBaselinesResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                          const ListBaselinesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListControlOperations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListControlOperations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListControlOperationsRequestT = Model::ListControlOperationsRequest>
  void ListControlOperationsAsync(const ListControlOperationsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const ListControlOperationsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListEnabledBaselines that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListEnabledBaselines that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListEnabledBaselinesRequestT = Model::ListEnabledBaselinesRequest>
  void ListEnabledBaselinesAsync(const ListEnabledBaselinesResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const ListEnabledBaselinesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListEnabledControls that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListEnabledControls that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListEnabledControlsRequestT = Model::ListEnabledControlsRequest>
  void ListEnabledControlsAsync(const ListEnabledControlsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const ListEnabledControlsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListLandingZoneOperationsOutcome ListLandingZoneOperations(
      const Model::ListLandingZoneOperationsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListLandingZoneOperations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListLandingZoneOperationsRequestT = Model::ListLandingZoneOperationsRequest>
  Model::ListLandingZoneOperationsOutcomeCallable ListLandingZoneOperationsCallable(
      const ListLandingZoneOperationsRequestT& request = {}) const {
    return SubmitCallable(&ControlTowerClient::ListLandingZoneOperations, request);
  }

  /**
   * An Async wrapper for ListLandingZoneOperations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListLandingZoneOperationsRequestT = Model::ListLandingZoneOperationsRequest>
  void ListLandingZoneOperationsAsync(const ListLandingZoneOperationsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const ListLandingZoneOperationsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListLandingZones that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListLandingZones that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListLandingZonesRequestT = Model::ListLandingZonesRequest>
  void ListLandingZonesAsync(const ListLandingZonesResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const ListLandingZonesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ResetEnabledBaseline that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ResetEnabledBaseline that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ResetEnabledBaselineRequestT = Model::ResetEnabledBaselineRequest>
  void ResetEnabledBaselineAsync(const ResetEnabledBaselineRequestT& request, const ResetEnabledBaselineResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ResetEnabledControl that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ResetEnabledControl that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ResetEnabledControlRequestT = Model::ResetEnabledControlRequest>
  void ResetEnabledControlAsync(const ResetEnabledControlRequestT& request, const ResetEnabledControlResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ResetLandingZone that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ResetLandingZone that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ResetLandingZoneRequestT = Model::ResetLandingZoneRequest>
  void ResetLandingZoneAsync(const ResetLandingZoneRequestT& request, const ResetLandingZoneResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateEnabledBaseline that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateEnabledBaseline that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateEnabledBaselineRequestT = Model::UpdateEnabledBaselineRequest>
  void UpdateEnabledBaselineAsync(const UpdateEnabledBaselineRequestT& request, const UpdateEnabledBaselineResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateEnabledControl that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateEnabledControl that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateEnabledControlRequestT = Model::UpdateEnabledControlRequest>
  void UpdateEnabledControlAsync(const UpdateEnabledControlRequestT& request, const UpdateEnabledControlResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateLandingZone that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateLandingZone that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateLandingZoneRequestT = Model::UpdateLandingZoneRequest>
  void UpdateLandingZoneAsync(const UpdateLandingZoneRequestT& request, const UpdateLandingZoneResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
