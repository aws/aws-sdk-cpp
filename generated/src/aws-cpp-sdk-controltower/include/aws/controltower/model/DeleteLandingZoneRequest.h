...
namespace Model
{
  ...
  {
  public:
    AWS_CONTROLTOWER_API DeleteLandingZoneRequest();
     ...
     * <p>The unique identifier of the landing zone.</p>
     */
    inline DeleteLandingZoneRequest& WithLandingZoneIdentifier(const char* value) { SetLandingZoneIdentifier(value); return *this;}
