...
namespace Model
{
  ...
  /**
   * <p>An AWS Region in which AWS Control Tower expects to find the control
   * deployed. </p> <p>The expected Regions are based on the Regions that are
   * governed by the landing zone. In certain cases, a control is not actually
   * enabled in the Region as expected, such as during drift, or <a
