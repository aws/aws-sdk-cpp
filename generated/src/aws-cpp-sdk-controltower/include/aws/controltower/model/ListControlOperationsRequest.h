...
class ListControlOperationsRequest : public ControlTowerRequest {
 public:
  ...
  template <typename FilterT = ControlOperationFilter>
  ListControlOperationsRequest& WithFilter(FilterT&& value) {
  ...
  inline ListControlOperationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListControlOperationsRequest& WithNextToken(NextTokenT&& value) {
