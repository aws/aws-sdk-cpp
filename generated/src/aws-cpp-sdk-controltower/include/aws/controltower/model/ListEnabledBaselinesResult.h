...
class ListEnabledBaselinesResult {
 public:
  ...
  void SetEnabledBaselines(EnabledBaselinesT&& value) {
    m_enabledBaselinesHasBeenSet = true;
    m_enabledBaselines = std::forward<EnabledBaselinesT>(value);
  }
  template <typename EnabledBaselinesT = Aws::Vector<EnabledBaselineSummary>>
  ListEnabledBaselinesResult& WithEnabledBaselines(EnabledBaselinesT&& value) {
    SetEnabledBaselines(std::forward<EnabledBaselinesT>(value));
    return *this;
  }
  template <typename EnabledBaselinesT = EnabledBaselineSummary>
  ListEnabledBaselinesResult& AddEnabledBaselines(EnabledBaselinesT&& value) {
    m_enabledBaselinesHasBeenSet = true;
    m_enabledBaselines.emplace_back(std::forward<EnabledBaselinesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListEnabledBaselinesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListEnabledBaselinesResult& WithRequestId(RequestIdT&& value) {
