...
class GetLandingZoneResult {
 public:
  ...
  void SetLandingZone(LandingZoneT&& value) {
    m_landingZoneHasBeenSet = true;
    m_landingZone = std::forward<LandingZoneT>(value);
  }
  template <typename LandingZoneT = LandingZoneDetail>
  GetLandingZoneResult& WithLandingZone(LandingZoneT&& value) {
    SetLandingZone(std::forward<LandingZoneT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetLandingZoneResult& WithRequestId(RequestIdT&& value) {
