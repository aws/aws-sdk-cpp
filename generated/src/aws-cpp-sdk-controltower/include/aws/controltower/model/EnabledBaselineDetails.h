...
namespace Model
{
  ...
  public:
    ...
    template<typename ArnT = Aws::String>
    EnabledBaselineDetails& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename BaselineIdentifierT = Aws::String>
    EnabledBaselineDetails& WithBaselineIdentifier(BaselineIdentifierT&& value) { SetBaselineIdentifier(std::forward<BaselineIdentifierT>(value)); return *this;}
    ///@}
    ...
    template<typename BaselineVersionT = Aws::String>
    EnabledBaselineDetails& WithBaselineVersion(BaselineVersionT&& value) { SetBaselineVersion(std::forward<BaselineVersionT>(value)); return *this;}
    ///@}
    ...
    template<typename ParametersT = Aws::Vector<EnabledBaselineParameterSummary>>
    EnabledBaselineDetails& WithParameters(ParametersT&& value) { SetParameters(std::forward<ParametersT>(value)); return *this;}
    template<typename ParametersT = EnabledBaselineParameterSummary>
    EnabledBaselineDetails& AddParameters(ParametersT&& value) { m_parametersHasBeenSet = true; m_parameters.emplace_back(std::forward<ParametersT>(value)); return *this; }
    ///@}
    ...
    template<typename ParentIdentifierT = Aws::String>
    EnabledBaselineDetails& WithParentIdentifier(ParentIdentifierT&& value) { SetParentIdentifier(std::forward<ParentIdentifierT>(value)); return *this;}
    ///@}
    ...
    template<typename StatusSummaryT = EnablementStatusSummary>
    EnabledBaselineDetails& WithStatusSummary(StatusSummaryT&& value) { SetStatusSummary(std::forward<StatusSummaryT>(value)); return *this;}
    ///@}
    ...
    template<typename TargetIdentifierT = Aws::String>
    EnabledBaselineDetails& WithTargetIdentifier(TargetIdentifierT&& value) { SetTargetIdentifier(std::forward<TargetIdentifierT>(value)); return *this;}
    ///@}
  private:
