...
namespace Model
{
  ...
  {
  public:
    AWS_CONTROLTOWER_API GetEnabledBaselineRequest() = default;
    ...
    template<typename EnabledBaselineIdentifierT = Aws::String>
    GetEnabledBaselineRequest& WithEnabledBaselineIdentifier(EnabledBaselineIdentifierT&& value) { SetEnabledBaselineIdentifier(std::forward<EnabledBaselineIdentifierT>(value)); return *this;}
    ///@}
  private:
