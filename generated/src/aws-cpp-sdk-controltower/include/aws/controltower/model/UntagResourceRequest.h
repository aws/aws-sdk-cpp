...
namespace Model
{
  ...
  /**
   */
  class UntagResourceRequest : public ControlTowerRequest
  {
  public:
    AWS_CONTROLTOWER_API UntagResourceRequest() = default;
    ...
    AWS_CONTROLTOWER_API void AddQueryStringParameters(Aws::Http::URI& uri) const override;
