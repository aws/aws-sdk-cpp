...
class ListLandingZonesResult {
 public:
  ...
  void SetLandingZones(LandingZonesT&& value) {
    m_landingZonesHasBeenSet = true;
    m_landingZones = std::forward<LandingZonesT>(value);
  }
  template <typename LandingZonesT = Aws::Vector<LandingZoneSummary>>
  ListLandingZonesResult& WithLandingZones(LandingZonesT&& value) {
    SetLandingZones(std::forward<LandingZonesT>(value));
    return *this;
  }
  template <typename LandingZonesT = LandingZoneSummary>
  ListLandingZonesResult& AddLandingZones(LandingZonesT&& value) {
    m_landingZonesHasBeenSet = true;
    m_landingZones.emplace_back(std::forward<LandingZonesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListLandingZonesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListLandingZonesResult& WithRequestId(RequestIdT&& value) {
