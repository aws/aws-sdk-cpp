...
class EnabledBaselineFilter {
 public:
  ...
  void SetBaselineIdentifiers(BaselineIdentifiersT&& value) {
    m_baselineIdentifiersHasBeenSet = true;
    m_baselineIdentifiers = std::forward<BaselineIdentifiersT>(value);
  }
  template <typename BaselineIdentifiersT = Aws::Vector<Aws::String>>
  EnabledBaselineFilter& WithBaselineIdentifiers(BaselineIdentifiersT&& value) {
    SetBaselineIdentifiers(std::forward<BaselineIdentifiersT>(value));
    return *this;
  }
  ...
  template <typename ParentIdentifiersT = Aws::Vector<Aws::String>>
  EnabledBaselineFilter& WithParentIdentifiers(ParentIdentifiersT&& value) {
    SetParentIdentifiers(std::forward<ParentIdentifiersT>(value));
    return *this;
  }
  template <typename ParentIdentifiersT = Aws::String>
  EnabledBaselineFilter& AddParentIdentifiers(ParentIdentifiersT&& value) {
    m_parentIdentifiersHasBeenSet = true;
  ...
  template <typename StatusesT = Aws::Vector<EnablementStatus>>
  EnabledBaselineFilter& WithStatuses(StatusesT&& value) {
    SetStatuses(std::forward<StatusesT>(value));
    return *this;
  }
  inline EnabledBaselineFilter& AddStatuses(EnablementStatus value) {
    m_statusesHasBeenSet = true;
