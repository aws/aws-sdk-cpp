...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>The landing zone manifest.yaml text file that specifies the landing zone
     * configurations. </p>
     */
    ...
    /**
     * <p>The landing zone deployment status. </p> <p>Valid values:</p> <ul> <li> <p>
     * <code>ACTIVE</code>: The landing zone is actively deployed. </p> </li> <li> <p>
     * <code>PROCESSING</code>: The landing zone is processing deployment. </p> </li>
     * <li> <p> <code>FAILED</code>: The landing zone failed deployment. </p> </li>
     * </ul>
     */
