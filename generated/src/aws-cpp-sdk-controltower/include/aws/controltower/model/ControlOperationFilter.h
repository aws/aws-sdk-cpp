...
class ControlOperationFilter {
 public:
  ...
  void SetControlIdentifiers(ControlIdentifiersT&& value) {
    m_controlIdentifiersHasBeenSet = true;
    m_controlIdentifiers = std::forward<ControlIdentifiersT>(value);
  }
  template <typename ControlIdentifiersT = Aws::Vector<Aws::String>>
  ControlOperationFilter& WithControlIdentifiers(ControlIdentifiersT&& value) {
    SetControlIdentifiers(std::forward<ControlIdentifiersT>(value));
    return *this;
  }
  template <typename ControlIdentifiersT = Aws::String>
  ControlOperationFilter& AddControlIdentifiers(ControlIdentifiersT&& value) {
    m_controlIdentifiersHasBeenSet = true;
    m_controlIdentifiers.emplace_back(std::forward<ControlIdentifiersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEnabledControlIdentifiers(EnabledControlIdentifiersT&& value) {
    m_enabledControlIdentifiersHasBeenSet = true;
    m_enabledControlIdentifiers = std::forward<EnabledControlIdentifiersT>(value);
  }
  template <typename EnabledControlIdentifiersT = Aws::Vector<Aws::String>>
  ControlOperationFilter& WithEnabledControlIdentifiers(EnabledControlIdentifiersT&& value) {
    SetEnabledControlIdentifiers(std::forward<EnabledControlIdentifiersT>(value));
    return *this;
  }
  template <typename EnabledControlIdentifiersT = Aws::String>
  ControlOperationFilter& AddEnabledControlIdentifiers(EnabledControlIdentifiersT&& value) {
    m_enabledControlIdentifiersHasBeenSet = true;
    m_enabledControlIdentifiers.emplace_back(std::forward<EnabledControlIdentifiersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename StatusesT = Aws::Vector<ControlOperationStatus>>
  ControlOperationFilter& WithStatuses(StatusesT&& value) {
    SetStatuses(std::forward<StatusesT>(value));
    return *this;
  }
  inline ControlOperationFilter& AddStatuses(ControlOperationStatus value) {
    m_statusesHasBeenSet = true;
