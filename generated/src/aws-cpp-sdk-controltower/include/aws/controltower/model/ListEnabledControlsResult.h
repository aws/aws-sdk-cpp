...
class ListEnabledControlsResult {
 public:
  ...
  void SetEnabledControls(EnabledControlsT&& value) {
    m_enabledControlsHasBeenSet = true;
    m_enabledControls = std::forward<EnabledControlsT>(value);
  }
  template <typename EnabledControlsT = Aws::Vector<EnabledControlSummary>>
  ListEnabledControlsResult& WithEnabledControls(EnabledControlsT&& value) {
    SetEnabledControls(std::forward<EnabledControlsT>(value));
    return *this;
  }
  template <typename EnabledControlsT = EnabledControlSummary>
  ListEnabledControlsResult& AddEnabledControls(EnabledControlsT&& value) {
    m_enabledControlsHasBeenSet = true;
    m_enabledControls.emplace_back(std::forward<EnabledControlsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListEnabledControlsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListEnabledControlsResult& WithRequestId(RequestIdT&& value) {
