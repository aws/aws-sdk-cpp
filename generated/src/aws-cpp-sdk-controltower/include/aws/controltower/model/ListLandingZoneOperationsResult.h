...
class ListLandingZoneOperationsResult {
 public:
  ...
  void SetLandingZoneOperations(LandingZoneOperationsT&& value) {
    m_landingZoneOperationsHasBeenSet = true;
    m_landingZoneOperations = std::forward<LandingZoneOperationsT>(value);
  }
  template <typename LandingZoneOperationsT = Aws::Vector<LandingZoneOperationSummary>>
  ListLandingZoneOperationsResult& WithLandingZoneOperations(LandingZoneOperationsT&& value) {
    SetLandingZoneOperations(std::forward<LandingZoneOperationsT>(value));
    return *this;
  }
  template <typename LandingZoneOperationsT = LandingZoneOperationSummary>
  ListLandingZoneOperationsResult& AddLandingZoneOperations(LandingZoneOperationsT&& value) {
    m_landingZoneOperationsHasBeenSet = true;
    m_landingZoneOperations.emplace_back(std::forward<LandingZoneOperationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListLandingZoneOperationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListLandingZoneOperationsResult& WithRequestId(RequestIdT&& value) {
