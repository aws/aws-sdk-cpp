...
class CreateLandingZoneResult {
 public:
  AWS_CONTROLTOWER_API CreateLandingZoneResult() = default;
  ...
  template <typename ArnT = Aws::String>
  CreateLandingZoneResult& WithArn(ArnT&& value) {
  ...
  template <typename OperationIdentifierT = Aws::String>
  CreateLandingZoneResult& WithOperationIdentifier(OperationIdentifierT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateLandingZoneResult& WithRequestId(RequestIdT&& value) {
