...
class BaselineOperation {
 public:
  ...
  template <typename OperationIdentifierT = Aws::String>
  BaselineOperation& WithOperationIdentifier(OperationIdentifierT&& value) {
  ...
  inline void SetOperationType(BaselineOperationType value) {
    m_operationTypeHasBeenSet = true;
    m_operationType = value;
  }
  inline BaselineOperation& WithOperationType(BaselineOperationType value) {
  ...
  template <typename StartTimeT = Aws::Utils::DateTime>
  BaselineOperation& WithStartTime(StartTimeT&& value) {
  ...
  template <typename StatusMessageT = Aws::String>
  BaselineOperation& WithStatusMessage(StatusMessageT&& value) {
