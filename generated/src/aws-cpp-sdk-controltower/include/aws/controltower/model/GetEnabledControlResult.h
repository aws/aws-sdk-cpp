...
class GetEnabledControlResult {
 public:
  ...
  void SetEnabledControlDetails(EnabledControlDetailsT&& value) {
    m_enabledControlDetailsHasBeenSet = true;
    m_enabledControlDetails = std::forward<EnabledControlDetailsT>(value);
  }
  template <typename EnabledControlDetailsT = EnabledControlDetails>
  GetEnabledControlResult& WithEnabledControlDetails(EnabledControlDetailsT&& value) {
    SetEnabledControlDetails(std::forward<EnabledControlDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetEnabledControlResult& WithRequestId(RequestIdT&& value) {
