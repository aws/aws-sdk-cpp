...
class GetEnabledBaselineResult {
 public:
  ...
  void SetEnabledBaselineDetails(EnabledBaselineDetailsT&& value) {
    m_enabledBaselineDetailsHasBeenSet = true;
    m_enabledBaselineDetails = std::forward<EnabledBaselineDetailsT>(value);
  }
  template <typename EnabledBaselineDetailsT = EnabledBaselineDetails>
  GetEnabledBaselineResult& WithEnabledBaselineDetails(EnabledBaselineDetailsT&& value) {
    SetEnabledBaselineDetails(std::forward<EnabledBaselineDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetEnabledBaselineResult& WithRequestId(RequestIdT&& value) {
