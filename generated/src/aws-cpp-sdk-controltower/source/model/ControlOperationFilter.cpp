...
ControlOperationFilter::ControlOperationFilter(JsonView jsonValue) { *this = jsonValue; }
...
ControlOperationFilter& ControlOperationFilter::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("enabledControlIdentifiers")) {
    ...
    for (unsigned enabledControlIdentifiersIndex = 0; enabledControlIdentifiersIndex < enabledControlIdentifiersJsonList.GetLength();
         ++enabledControlIdentifiersIndex) {
...
JsonValue ControlOperationFilter::Jsonize() const {
  ...
  if (m_enabledControlIdentifiersHasBeenSet) {
    ...
    for (unsigned enabledControlIdentifiersIndex = 0; enabledControlIdentifiersIndex < enabledControlIdentifiersJsonList.GetLength();
         ++enabledControlIdentifiersIndex) {
      enabledControlIdentifiersJsonList[enabledControlIdentifiersIndex].AsString(
          m_enabledControlIdentifiers[enabledControlIdentifiersIndex]);
    }
