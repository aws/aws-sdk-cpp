...
namespace WorkSpacesWeb
{
   ...
   * images.</p>
   */
  class AWS_WORKSPACESWEB_API WorkSpacesWebClient : Aws::Client::ClientWithAsyncTemplateMethods<WorkSpacesWebClient>,
    smithy::client::AwsSmithyClientT<Aws::WorkSpacesWeb::SERVICE_NAME,
