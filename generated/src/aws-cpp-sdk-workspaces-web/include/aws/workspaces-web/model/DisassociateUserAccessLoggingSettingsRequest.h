...
namespace Model
{
  ...
  {
  public:
    AWS_WORKSPACESWEB_API DisassociateUserAccessLoggingSettingsRequest();
     ...
     * <p>The ARN of the web portal.</p>
     */
    inline DisassociateUserAccessLoggingSettingsRequest& WithPortalArn(const Aws::String& value) { SetPortalArn(value); return *this;}

    /**
     * <p>The ARN of the web portal.</p>
     */
    inline DisassociateUserAccessLoggingSettingsRequest& WithPortalArn(Aws::String&& value) { SetPortalArn(std::move(value)); return *this;}

    /**
     * <p>The ARN of the web portal.</p>
     */
    inline DisassociateUserAccessLoggingSettingsRequest& WithPortalArn(const char* value) { SetPortalArn(value); return *this;}
