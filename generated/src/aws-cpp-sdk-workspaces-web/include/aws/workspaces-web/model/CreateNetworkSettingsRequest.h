...
class CreateNetworkSettingsRequest : public WorkSpacesWebRequest {
 public:
  ...
  template <typename VpcIdT = Aws::String>
  CreateNetworkSettingsRequest& WithVpcId(VpcIdT&& value) {
  ...
  template <typename SubnetIdsT = Aws::Vector<Aws::String>>
  CreateNetworkSettingsRequest& WithSubnetIds(SubnetIdsT&& value) {
    SetSubnetIds(std::forward<SubnetIdsT>(value));
    return *this;
  }
  template <typename SubnetIdsT = Aws::String>
  CreateNetworkSettingsRequest& AddSubnetIds(SubnetIdsT&& value) {
    m_subnetIdsHasBeenSet = true;
  ...
  template <typename SecurityGroupIdsT = Aws::Vector<Aws::String>>
  CreateNetworkSettingsRequest& WithSecurityGroupIds(SecurityGroupIdsT&& value) {
    SetSecurityGroupIds(std::forward<SecurityGroupIdsT>(value));
    return *this;
  }
  template <typename SecurityGroupIdsT = Aws::String>
  CreateNetworkSettingsRequest& AddSecurityGroupIds(SecurityGroupIdsT&& value) {
    m_securityGroupIdsHasBeenSet = true;
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateNetworkSettingsRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateNetworkSettingsRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename ClientTokenT = Aws::String>
  CreateNetworkSettingsRequest& WithClientToken(ClientTokenT&& value) {
