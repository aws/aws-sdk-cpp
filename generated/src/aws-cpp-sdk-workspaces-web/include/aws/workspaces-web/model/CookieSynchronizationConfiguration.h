...
class CookieSynchronizationConfiguration {
 public:
  ...
  template <typename AllowlistT = Aws::Vector<CookieSpecification>>
  CookieSynchronizationConfiguration& WithAllowlist(AllowlistT&& value) {
    SetAllowlist(std::forward<AllowlistT>(value));
    return *this;
  }
  template <typename AllowlistT = CookieSpecification>
  CookieSynchronizationConfiguration& AddAllowlist(AllowlistT&& value) {
    m_allowlistHasBeenSet = true;
    m_allowlist.emplace_back(std::forward<AllowlistT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename BlocklistT = Aws::Vector<CookieSpecification>>
  CookieSynchronizationConfiguration& WithBlocklist(BlocklistT&& value) {
    SetBlocklist(std::forward<BlocklistT>(value));
    return *this;
  }
  template <typename BlocklistT = CookieSpecification>
  CookieSynchronizationConfiguration& AddBlocklist(BlocklistT&& value) {
    m_blocklistHasBeenSet = true;
