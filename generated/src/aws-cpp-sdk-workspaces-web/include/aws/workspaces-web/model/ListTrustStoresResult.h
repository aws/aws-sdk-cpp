...
class ListTrustStoresResult {
 public:
  ...
  template <typename TrustStoresT = Aws::Vector<TrustStoreSummary>>
  ListTrustStoresResult& WithTrustStores(TrustStoresT&& value) {
    SetTrustStores(std::forward<TrustStoresT>(value));
    return *this;
  }
  template <typename TrustStoresT = TrustStoreSummary>
  ListTrustStoresResult& AddTrustStores(TrustStoresT&& value) {
    m_trustStoresHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListTrustStoresResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListTrustStoresResult& WithRequestId(RequestIdT&& value) {
