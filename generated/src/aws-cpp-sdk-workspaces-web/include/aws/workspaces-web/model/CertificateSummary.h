...
class CertificateSummary {
 public:
  ...
  template <typename ThumbprintT = Aws::String>
  CertificateSummary& WithThumbprint(ThumbprintT&& value) {
  ...
  template <typename SubjectT = Aws::String>
  CertificateSummary& WithSubject(SubjectT&& value) {
  ...
  template <typename IssuerT = Aws::String>
  CertificateSummary& WithIssuer(IssuerT&& value) {
  ...
  template <typename NotValidBeforeT = Aws::Utils::DateTime>
  CertificateSummary& WithNotValidBefore(NotValidBeforeT&& value) {
  ...
  template <typename NotValidAfterT = Aws::Utils::DateTime>
  CertificateSummary& WithNotValidAfter(NotValidAfterT&& value) {
