...
class S3LogConfiguration {
 public:
  ...
  template <typename BucketT = Aws::String>
  S3LogConfiguration& WithBucket(BucketT&& value) {
  ...
  template <typename KeyPrefixT = Aws::String>
  S3LogConfiguration& WithKeyPrefix(KeyPrefixT&& value) {
  ...
  template <typename BucketOwnerT = Aws::String>
  S3LogConfiguration& WithBucketOwner(BucketOwnerT&& value) {
  ...
  inline void SetLogFileFormat(LogFileFormat value) {
    m_logFileFormatHasBeenSet = true;
    m_logFileFormat = value;
  }
  inline S3LogConfiguration& WithLogFileFormat(LogFileFormat value) {
    SetLogFileFormat(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFolderStructure(FolderStructure value) {
    m_folderStructureHasBeenSet = true;
    m_folderStructure = value;
  }
  inline S3LogConfiguration& WithFolderStructure(FolderStructure value) {
