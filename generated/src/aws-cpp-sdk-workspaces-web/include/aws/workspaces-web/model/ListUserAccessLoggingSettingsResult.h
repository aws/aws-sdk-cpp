...
class ListUserAccessLoggingSettingsResult {
 public:
  ...
  AWS_WORKSPACESWEB_API ListUserAccessLoggingSettingsResult& operator=(
  ...
  template <typename UserAccessLoggingSettingsT = Aws::Vector<UserAccessLoggingSettingsSummary>>
  ListUserAccessLoggingSettingsResult& WithUserAccessLoggingSettings(UserAccessLoggingSettingsT&& value) {
  ...
  ListUserAccessLoggingSettingsResult& AddUserAccessLoggingSettings(UserAccessLoggingSettingsT&& value) {
    m_userAccessLoggingSettingsHasBeenSet = true;
    m_userAccessLoggingSettings.emplace_back(std::forward<UserAccessLoggingSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListUserAccessLoggingSettingsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListUserAccessLoggingSettingsResult& WithRequestId(RequestIdT&& value) {
