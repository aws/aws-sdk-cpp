...
class InlineRedactionPattern {
 public:
  ...
  void SetBuiltInPatternId(BuiltInPatternIdT&& value) {
    m_builtInPatternIdHasBeenSet = true;
    m_builtInPatternId = std::forward<BuiltInPatternIdT>(value);
  }
  template <typename BuiltInPatternIdT = Aws::String>
  InlineRedactionPattern& WithBuiltInPatternId(BuiltInPatternIdT&& value) {
    SetBuiltInPatternId(std::forward<BuiltInPatternIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCustomPattern(CustomPatternT&& value) {
    m_customPatternHasBeenSet = true;
    m_customPattern = std::forward<CustomPatternT>(value);
  }
  template <typename CustomPatternT = CustomPattern>
  InlineRedactionPattern& WithCustomPattern(CustomPatternT&& value) {
    SetCustomPattern(std::forward<CustomPatternT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRedactionPlaceHolder(RedactionPlaceHolderT&& value) {
    m_redactionPlaceHolderHasBeenSet = true;
    m_redactionPlaceHolder = std::forward<RedactionPlaceHolderT>(value);
  }
  template <typename RedactionPlaceHolderT = RedactionPlaceHolder>
  InlineRedactionPattern& WithRedactionPlaceHolder(RedactionPlaceHolderT&& value) {
    SetRedactionPlaceHolder(std::forward<RedactionPlaceHolderT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEnforcedUrls(EnforcedUrlsT&& value) {
    m_enforcedUrlsHasBeenSet = true;
    m_enforcedUrls = std::forward<EnforcedUrlsT>(value);
  }
  template <typename EnforcedUrlsT = Aws::Vector<Aws::String>>
  InlineRedactionPattern& WithEnforcedUrls(EnforcedUrlsT&& value) {
    SetEnforcedUrls(std::forward<EnforcedUrlsT>(value));
    return *this;
  }
  template <typename EnforcedUrlsT = Aws::String>
  InlineRedactionPattern& AddEnforcedUrls(EnforcedUrlsT&& value) {
    m_enforcedUrlsHasBeenSet = true;
    m_enforcedUrls.emplace_back(std::forward<EnforcedUrlsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExemptUrls(ExemptUrlsT&& value) {
    m_exemptUrlsHasBeenSet = true;
    m_exemptUrls = std::forward<ExemptUrlsT>(value);
  }
  template <typename ExemptUrlsT = Aws::Vector<Aws::String>>
  InlineRedactionPattern& WithExemptUrls(ExemptUrlsT&& value) {
    SetExemptUrls(std::forward<ExemptUrlsT>(value));
    return *this;
  }
  template <typename ExemptUrlsT = Aws::String>
  InlineRedactionPattern& AddExemptUrls(ExemptUrlsT&& value) {
    m_exemptUrlsHasBeenSet = true;
    m_exemptUrls.emplace_back(std::forward<ExemptUrlsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetConfidenceLevel(int value) {
    m_confidenceLevelHasBeenSet = true;
    m_confidenceLevel = value;
  }
  inline InlineRedactionPattern& WithConfidenceLevel(int value) {
