...
class ToolbarConfiguration {
 public:
  ...
  inline void SetToolbarType(ToolbarType value) {
    m_toolbarTypeHasBeenSet = true;
    m_toolbarType = value;
  }
  inline ToolbarConfiguration& WithToolbarType(ToolbarType value) {
    SetToolbarType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetVisualMode(VisualMode value) {
    m_visualModeHasBeenSet = true;
    m_visualMode = value;
  }
  inline ToolbarConfiguration& WithVisualMode(VisualMode value) {
    SetVisualMode(value);
    return *this;
  }
  ///@}
  ...
  void SetHiddenToolbarItems(HiddenToolbarItemsT&& value) {
    m_hiddenToolbarItemsHasBeenSet = true;
    m_hiddenToolbarItems = std::forward<HiddenToolbarItemsT>(value);
  }
  template <typename HiddenToolbarItemsT = Aws::Vector<ToolbarItem>>
  ToolbarConfiguration& WithHiddenToolbarItems(HiddenToolbarItemsT&& value) {
    SetHiddenToolbarItems(std::forward<HiddenToolbarItemsT>(value));
    return *this;
  }
  inline ToolbarConfiguration& AddHiddenToolbarItems(ToolbarItem value) {
    m_hiddenToolbarItemsHasBeenSet = true;
    m_hiddenToolbarItems.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxDisplayResolution(MaxDisplayResolution value) {
    m_maxDisplayResolutionHasBeenSet = true;
    m_maxDisplayResolution = value;
  }
  inline ToolbarConfiguration& WithMaxDisplayResolution(MaxDisplayResolution value) {
    SetMaxDisplayResolution(value);
    return *this;
  }
  ///@}
 private:
