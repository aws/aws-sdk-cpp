...
namespace Model
{
  ...
  /**
   * <p>The resource cannot be found.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/workspaces-web-2020-07-08/ResourceNotFoundException">AWS
   * API Reference</a></p>
   */
  class ResourceNotFoundException
  {
  public:
    AWS_WORKSPACESWEB_API ResourceNotFoundException() = default;
    AWS_WORKSPACESWEB_API ResourceNotFoundException(Aws::Utils::Json::JsonView jsonValue);
    AWS_WORKSPACESWEB_API ResourceNotFoundException& operator=(Aws::Utils::Json::JsonView jsonValue);
