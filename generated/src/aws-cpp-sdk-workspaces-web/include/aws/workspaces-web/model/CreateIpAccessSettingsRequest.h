...
class CreateIpAccessSettingsRequest : public WorkSpacesWebRequest {
 public:
  ...
  template <typename DisplayNameT = Aws::String>
  CreateIpAccessSettingsRequest& WithDisplayName(DisplayNameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateIpAccessSettingsRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateIpAccessSettingsRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateIpAccessSettingsRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename CustomerManagedKeyT = Aws::String>
  CreateIpAccessSettingsRequest& WithCustomerManagedKey(CustomerManagedKeyT&& value) {
  ...
  template <typename AdditionalEncryptionContextT = Aws::Map<Aws::String, Aws::String>>
  CreateIpAccessSettingsRequest& WithAdditionalEncryptionContext(AdditionalEncryptionContextT&& value) {
  ...
  CreateIpAccessSettingsRequest& AddAdditionalEncryptionContext(AdditionalEncryptionContextKeyT&& key,
  ...
  template <typename IpRulesT = Aws::Vector<IpRule>>
  CreateIpAccessSettingsRequest& WithIpRules(IpRulesT&& value) {
    SetIpRules(std::forward<IpRulesT>(value));
    return *this;
  }
  template <typename IpRulesT = IpRule>
  CreateIpAccessSettingsRequest& AddIpRules(IpRulesT&& value) {
    m_ipRulesHasBeenSet = true;
  ...
  template <typename ClientTokenT = Aws::String>
  CreateIpAccessSettingsRequest& WithClientToken(ClientTokenT&& value) {
