...
class UserSettings {
 public:
  ...
  template <typename UserSettingsArnT = Aws::String>
  UserSettings& WithUserSettingsArn(UserSettingsArnT&& value) {
  ...
  template <typename AssociatedPortalArnsT = Aws::Vector<Aws::String>>
  UserSettings& WithAssociatedPortalArns(AssociatedPortalArnsT&& value) {
    SetAssociatedPortalArns(std::forward<AssociatedPortalArnsT>(value));
    return *this;
  }
  template <typename AssociatedPortalArnsT = Aws::String>
  UserSettings& AddAssociatedPortalArns(AssociatedPortalArnsT&& value) {
    m_associatedPortalArnsHasBeenSet = true;
  ...
  inline UserSettings& WithCopyAllowed(EnabledType value) {
  ...
  inline UserSettings& WithPasteAllowed(EnabledType value) {
  ...
  inline UserSettings& WithDownloadAllowed(EnabledType value) {
  ...
  inline UserSettings& WithUploadAllowed(EnabledType value) {
  ...
  inline UserSettings& WithPrintAllowed(EnabledType value) {
  ...
  inline UserSettings& WithDisconnectTimeoutInMinutes(int value) {
  ...
  inline UserSettings& WithIdleDisconnectTimeoutInMinutes(int value) {
  ...
  template <typename CookieSynchronizationConfigurationT = CookieSynchronizationConfiguration>
  UserSettings& WithCookieSynchronizationConfiguration(CookieSynchronizationConfigurationT&& value) {
  ...
  template <typename CustomerManagedKeyT = Aws::String>
  UserSettings& WithCustomerManagedKey(CustomerManagedKeyT&& value) {
  ...
  template <typename AdditionalEncryptionContextT = Aws::Map<Aws::String, Aws::String>>
  UserSettings& WithAdditionalEncryptionContext(AdditionalEncryptionContextT&& value) {
  ...
  inline UserSettings& WithDeepLinkAllowed(EnabledType value) {
  ...
  template <typename ToolbarConfigurationT = ToolbarConfiguration>
  UserSettings& WithToolbarConfiguration(ToolbarConfigurationT&& value) {
