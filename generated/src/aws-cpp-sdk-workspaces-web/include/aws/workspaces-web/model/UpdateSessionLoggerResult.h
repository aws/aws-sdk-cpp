...
class UpdateSessionLoggerResult {
 public:
  ...
  void SetSessionLogger(SessionLoggerT&& value) {
    m_sessionLoggerHasBeenSet = true;
    m_sessionLogger = std::forward<SessionLoggerT>(value);
  }
  template <typename SessionLoggerT = SessionLogger>
  UpdateSessionLoggerResult& WithSessionLogger(SessionLoggerT&& value) {
    SetSessionLogger(std::forward<SessionLoggerT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  UpdateSessionLoggerResult& WithRequestId(RequestIdT&& value) {
