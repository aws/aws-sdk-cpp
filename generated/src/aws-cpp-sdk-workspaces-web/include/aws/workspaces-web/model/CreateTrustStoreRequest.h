...
class CreateTrustStoreRequest : public WorkSpacesWebRequest {
 public:
  ...
  template <typename CertificateListT = Aws::Vector<Aws::Utils::ByteBuffer>>
  CreateTrustStoreRequest& WithCertificateList(CertificateListT&& value) {
    SetCertificateList(std::forward<CertificateListT>(value));
    return *this;
  }
  template <typename CertificateListT = Aws::Utils::ByteBuffer>
  CreateTrustStoreRequest& AddCertificateList(CertificateListT&& value) {
    m_certificateListHasBeenSet = true;
  ...
  template <typename ClientTokenT = Aws::String>
  CreateTrustStoreRequest& WithClientToken(ClientTokenT&& value) {
