...
/**
 */
class CreateDataProtectionSettingsRequest : public WorkSpacesWebRequest {
 public:
  AWS_WORKSPACESWEB_API CreateDataProtectionSettingsRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "CreateDataProtectionSettings"; }
  ...
  template <typename DisplayNameT = Aws::String>
  CreateDataProtectionSettingsRequest& WithDisplayName(DisplayNameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateDataProtectionSettingsRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateDataProtectionSettingsRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateDataProtectionSettingsRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename CustomerManagedKeyT = Aws::String>
  CreateDataProtectionSettingsRequest& WithCustomerManagedKey(CustomerManagedKeyT&& value) {
  ...
  template <typename AdditionalEncryptionContextT = Aws::Map<Aws::String, Aws::String>>
  CreateDataProtectionSettingsRequest& WithAdditionalEncryptionContext(AdditionalEncryptionContextT&& value) {
  ...
  CreateDataProtectionSettingsRequest& AddAdditionalEncryptionContext(AdditionalEncryptionContextKeyT&& key,
  ...
  template <typename InlineRedactionConfigurationT = InlineRedactionConfiguration>
  CreateDataProtectionSettingsRequest& WithInlineRedactionConfiguration(InlineRedactionConfigurationT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  CreateDataProtectionSettingsRequest& WithClientToken(ClientTokenT&& value) {
