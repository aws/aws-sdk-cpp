...
class IdentityProviderSummary {
 public:
  ...
  template <typename IdentityProviderNameT = Aws::String>
  IdentityProviderSummary& WithIdentityProviderName(IdentityProviderNameT&& value) {
  ...
  inline IdentityProviderSummary& WithIdentityProviderType(IdentityProviderType value) {
