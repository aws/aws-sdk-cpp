...
namespace Model
{
  ...
  {
  public:
    AWS_WORKSPACESWEB_API DeletePortalRequest() = default;
    ...
    template<typename PortalArnT = Aws::String>
    DeletePortalRequest& WithPortalArn(PortalArnT&& value) { SetPortalArn(std::forward<PortalArnT>(value)); return *this;}
    ///@}
  private:
