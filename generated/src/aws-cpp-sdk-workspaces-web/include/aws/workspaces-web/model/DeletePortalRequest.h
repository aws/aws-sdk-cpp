...
namespace Model
{
  ...
  /**
   */
  class DeletePortalRequest : public WorkSpacesWebRequest
  {
  public:
    AWS_WORKSPACESWEB_API DeletePortalRequest();
     ...
     * <p>The ARN of the web portal.</p>
     */
    inline DeletePortalRequest& WithPortalArn(const Aws::String& value) { SetPortalArn(value); return *this;}

    /**
     * <p>The ARN of the web portal.</p>
     */
    inline DeletePortalRequest& WithPortalArn(Aws::String&& value) { SetPortalArn(std::move(value)); return *this;}

    /**
     * <p>The ARN of the web portal.</p>
     */
    inline DeletePortalRequest& WithPortalArn(const char* value) { SetPortalArn(value); return *this;}
