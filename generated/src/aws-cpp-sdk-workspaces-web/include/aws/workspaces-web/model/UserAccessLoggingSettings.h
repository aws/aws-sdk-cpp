...
class UserAccessLoggingSettings {
 public:
  ...
  template <typename UserAccessLoggingSettingsArnT = Aws::String>
  UserAccessLoggingSettings& WithUserAccessLoggingSettingsArn(UserAccessLoggingSettingsArnT&& value) {
  ...
  template <typename AssociatedPortalArnsT = Aws::Vector<Aws::String>>
  UserAccessLoggingSettings& WithAssociatedPortalArns(AssociatedPortalArnsT&& value) {
    SetAssociatedPortalArns(std::forward<AssociatedPortalArnsT>(value));
    return *this;
  }
  template <typename AssociatedPortalArnsT = Aws::String>
  UserAccessLoggingSettings& AddAssociatedPortalArns(AssociatedPortalArnsT&& value) {
    m_associatedPortalArnsHasBeenSet = true;
  ...
  void SetKinesisStreamArn(KinesisStreamArnT&& value) {
    ...
    m_kinesisStreamArn = std::forward<KinesisStreamArnT>(value);
  }
  template <typename KinesisStreamArnT = Aws::String>
  UserAccessLoggingSettings& WithKinesisStreamArn(KinesisStreamArnT&& value) {
    SetKinesisStreamArn(std::forward<KinesisStreamArnT>(value));
    return *this;
  }
  ///@}
 private:
