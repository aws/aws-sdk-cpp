...
class RedactionPlaceHolder {
 public:
  ...
  inline void SetRedactionPlaceHolderType(RedactionPlaceHolderType value) {
    m_redactionPlaceHolderTypeHasBeenSet = true;
    m_redactionPlaceHolderType = value;
  }
  inline RedactionPlaceHolder& WithRedactionPlaceHolderType(RedactionPlaceHolderType value) {
    SetRedactionPlaceHolderType(value);
    return *this;
  }
  ///@}
  ...
  void SetRedactionPlaceHolderText(RedactionPlaceHolderTextT&& value) {
    m_redactionPlaceHolderTextHasBeenSet = true;
    m_redactionPlaceHolderText = std::forward<RedactionPlaceHolderTextT>(value);
  }
  template <typename RedactionPlaceHolderTextT = Aws::String>
  RedactionPlaceHolder& WithRedactionPlaceHolderText(RedactionPlaceHolderTextT&& value) {
    SetRedactionPlaceHolderText(std::forward<RedactionPlaceHolderTextT>(value));
    return *this;
  }
  ///@}
 private:
