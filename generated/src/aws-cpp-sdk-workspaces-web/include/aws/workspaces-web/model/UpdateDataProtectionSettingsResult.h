...
class UpdateDataProtectionSettingsResult {
 public:
  ...
  AWS_WORKSPACESWEB_API UpdateDataProtectionSettingsResult& operator=(
  ...
  template <typename DataProtectionSettingsT = DataProtectionSettings>
  UpdateDataProtectionSettingsResult& WithDataProtectionSettings(DataProtectionSettingsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateDataProtectionSettingsResult& WithRequestId(RequestIdT&& value) {
