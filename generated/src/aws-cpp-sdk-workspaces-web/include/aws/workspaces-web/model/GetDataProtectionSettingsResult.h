...
class GetDataProtectionSettingsResult {
 public:
  ...
  template <typename DataProtectionSettingsT = DataProtectionSettings>
  GetDataProtectionSettingsResult& WithDataProtectionSettings(DataProtectionSettingsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetDataProtectionSettingsResult& WithRequestId(RequestIdT&& value) {
