...
class GetPortalServiceProviderMetadataResult {
 public:
  ...
  AWS_WORKSPACESWEB_API GetPortalServiceProviderMetadataResult& operator=(
  ...
  template <typename PortalArnT = Aws::String>
  GetPortalServiceProviderMetadataResult& WithPortalArn(PortalArnT&& value) {
  ...
  void SetServiceProviderSamlMetadata(ServiceProviderSamlMetadataT&& value) {
    m_serviceProviderSamlMetadataHasBeenSet = true;
    m_serviceProviderSamlMetadata = std::forward<ServiceProviderSamlMetadataT>(value);
  }
  template <typename ServiceProviderSamlMetadataT = Aws::String>
  GetPortalServiceProviderMetadataResult& WithServiceProviderSamlMetadata(ServiceProviderSamlMetadataT&& value) {
    SetServiceProviderSamlMetadata(std::forward<ServiceProviderSamlMetadataT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetPortalServiceProviderMetadataResult& WithRequestId(RequestIdT&& value) {
