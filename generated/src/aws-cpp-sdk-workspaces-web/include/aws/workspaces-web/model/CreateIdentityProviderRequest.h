...
class CreateIdentityProviderRequest : public WorkSpacesWebRequest {
 public:
  ...
  template <typename PortalArnT = Aws::String>
  CreateIdentityProviderRequest& WithPortalArn(PortalArnT&& value) {
  ...
  template <typename IdentityProviderNameT = Aws::String>
  CreateIdentityProviderRequest& WithIdentityProviderName(IdentityProviderNameT&& value) {
  ...
  inline CreateIdentityProviderRequest& WithIdentityProviderType(IdentityProviderType value) {
  ...
  template <typename IdentityProviderDetailsT = Aws::Map<Aws::String, Aws::String>>
  CreateIdentityProviderRequest& WithIdentityProviderDetails(IdentityProviderDetailsT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  CreateIdentityProviderRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateIdentityProviderRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateIdentityProviderRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
