...
class AssociateDataProtectionSettingsRequest : public WorkSpacesWebRequest {
 public:
  ...
  template <typename PortalArnT = Aws::String>
  AssociateDataProtectionSettingsRequest& WithPortalArn(PortalArnT&& value) {
  ...
  template <typename DataProtectionSettingsArnT = Aws::String>
  AssociateDataProtectionSettingsRequest& WithDataProtectionSettingsArn(DataProtectionSettingsArnT&& value) {
