...
namespace Model
{
  ...
  public:
    ...
    void SetSessionLoggers(SessionLoggersT&& value) { m_sessionLoggersHasBeenSet = true; m_sessionLoggers = std::forward<SessionLoggersT>(value); }
    template<typename SessionLoggersT = Aws::Vector<SessionLoggerSummary>>
    ListSessionLoggersResult& WithSessionLoggers(SessionLoggersT&& value) { SetSessionLoggers(std::forward<SessionLoggersT>(value)); return *this;}
    template<typename SessionLoggersT = SessionLoggerSummary>
    ListSessionLoggersResult& AddSessionLoggers(SessionLoggersT&& value) { m_sessionLoggersHasBeenSet = true; m_sessionLoggers.emplace_back(std::forward<SessionLoggersT>(value)); return *this; }
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListSessionLoggersResult& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ListSessionLoggersResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
