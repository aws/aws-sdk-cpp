...
class NetworkSettings {
 public:
  ...
  template <typename NetworkSettingsArnT = Aws::String>
  NetworkSettings& WithNetworkSettingsArn(NetworkSettingsArnT&& value) {
  ...
  template <typename AssociatedPortalArnsT = Aws::Vector<Aws::String>>
  NetworkSettings& WithAssociatedPortalArns(AssociatedPortalArnsT&& value) {
    SetAssociatedPortalArns(std::forward<AssociatedPortalArnsT>(value));
    return *this;
  }
  template <typename AssociatedPortalArnsT = Aws::String>
  NetworkSettings& AddAssociatedPortalArns(AssociatedPortalArnsT&& value) {
    m_associatedPortalArnsHasBeenSet = true;
  ...
  template <typename VpcIdT = Aws::String>
  NetworkSettings& WithVpcId(VpcIdT&& value) {
  ...
  template <typename SubnetIdsT = Aws::Vector<Aws::String>>
  NetworkSettings& WithSubnetIds(SubnetIdsT&& value) {
    SetSubnetIds(std::forward<SubnetIdsT>(value));
    return *this;
  }
  template <typename SubnetIdsT = Aws::String>
  NetworkSettings& AddSubnetIds(SubnetIdsT&& value) {
    m_subnetIdsHasBeenSet = true;
  ...
  template <typename SecurityGroupIdsT = Aws::Vector<Aws::String>>
  NetworkSettings& WithSecurityGroupIds(SecurityGroupIdsT&& value) {
    SetSecurityGroupIds(std::forward<SecurityGroupIdsT>(value));
    return *this;
  }
  template <typename SecurityGroupIdsT = Aws::String>
  NetworkSettings& AddSecurityGroupIds(SecurityGroupIdsT&& value) {
    m_securityGroupIdsHasBeenSet = true;
