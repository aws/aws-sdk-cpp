...
namespace Model
{
  ...
  public:
    ...
    template<typename PortalArnT = Aws::String>
    SessionSummary& WithPortalArn(PortalArnT&& value) { SetPortalArn(std::forward<PortalArnT>(value)); return *this;}
    ///@}
    ...
    inline SessionSummary& WithStatus(SessionStatus value) { SetStatus(value); return *this;}
    ///@}
