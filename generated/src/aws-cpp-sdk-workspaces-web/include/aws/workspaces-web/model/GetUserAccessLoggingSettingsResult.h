...
class GetUserAccessLoggingSettingsResult {
 public:
  ...
  AWS_WORKSPACESWEB_API GetUserAccessLoggingSettingsResult& operator=(
  ...
  template <typename UserAccessLoggingSettingsT = UserAccessLoggingSettings>
  GetUserAccessLoggingSettingsResult& WithUserAccessLoggingSettings(UserAccessLoggingSettingsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetUserAccessLoggingSettingsResult& WithRequestId(RequestIdT&& value) {
