...
class AssociateTrustStoreResult {
 public:
  ...
  template <typename PortalArnT = Aws::String>
  AssociateTrustStoreResult& WithPortalArn(PortalArnT&& value) {
  ...
  template <typename TrustStoreArnT = Aws::String>
  AssociateTrustStoreResult& WithTrustStoreArn(TrustStoreArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  AssociateTrustStoreResult& WithRequestId(RequestIdT&& value) {
