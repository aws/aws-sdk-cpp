...
namespace Model
{
  ...
  {
  public:
    AWS_WORKSPACESWEB_API DeleteIdentityProviderResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteIdentityProviderResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
