...
namespace Model
{
  ...
  {
  public:
    AWS_WORKSPACESWEB_API GetNetworkSettingsRequest() = default;
    ...
    template<typename NetworkSettingsArnT = Aws::String>
    GetNetworkSettingsRequest& WithNetworkSettingsArn(NetworkSettingsArnT&& value) { SetNetworkSettingsArn(std::forward<NetworkSettingsArnT>(value)); return *this;}
    ///@}
  private:
