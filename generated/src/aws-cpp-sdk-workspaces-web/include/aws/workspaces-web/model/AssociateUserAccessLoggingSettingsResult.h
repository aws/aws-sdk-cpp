...
class AssociateUserAccessLoggingSettingsResult {
 public:
  ...
  AWS_WORKSPACESWEB_API AssociateUserAccessLoggingSettingsResult& operator=(
  ...
  template <typename PortalArnT = Aws::String>
  AssociateUserAccessLoggingSettingsResult& WithPortalArn(PortalArnT&& value) {
  ...
  template <typename UserAccessLoggingSettingsArnT = Aws::String>
  AssociateUserAccessLoggingSettingsResult& WithUserAccessLoggingSettingsArn(UserAccessLoggingSettingsArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  AssociateUserAccessLoggingSettingsResult& WithRequestId(RequestIdT&& value) {
