...
namespace Model
{
  ...
  {
  public:
    AWS_WORKSPACESWEB_API ValidationExceptionField() = default;
    AWS_WORKSPACESWEB_API ValidationExceptionField(Aws::Utils::Json::JsonView jsonValue);
    AWS_WORKSPACESWEB_API ValidationExceptionField& operator=(Aws::Utils::Json::JsonView jsonValue);
