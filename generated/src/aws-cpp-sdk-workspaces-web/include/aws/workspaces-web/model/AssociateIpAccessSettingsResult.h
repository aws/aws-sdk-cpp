...
class AssociateIpAccessSettingsResult {
 public:
  ...
  template <typename PortalArnT = Aws::String>
  AssociateIpAccessSettingsResult& WithPortalArn(PortalArnT&& value) {
  ...
  template <typename IpAccessSettingsArnT = Aws::String>
  AssociateIpAccessSettingsResult& WithIpAccessSettingsArn(IpAccessSettingsArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  AssociateIpAccessSettingsResult& WithRequestId(RequestIdT&& value) {
