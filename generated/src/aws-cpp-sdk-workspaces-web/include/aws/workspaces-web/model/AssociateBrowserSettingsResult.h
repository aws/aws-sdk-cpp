...
class AssociateBrowserSettingsResult {
 public:
  ...
  template <typename PortalArnT = Aws::String>
  AssociateBrowserSettingsResult& WithPortalArn(PortalArnT&& value) {
  ...
  template <typename BrowserSettingsArnT = Aws::String>
  AssociateBrowserSettingsResult& WithBrowserSettingsArn(BrowserSettingsArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  AssociateBrowserSettingsResult& WithRequestId(RequestIdT&& value) {
