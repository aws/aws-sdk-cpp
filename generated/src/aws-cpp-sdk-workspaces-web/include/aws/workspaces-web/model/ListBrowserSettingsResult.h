...
class ListBrowserSettingsResult {
 public:
  ...
  template <typename BrowserSettingsT = Aws::Vector<BrowserSettingsSummary>>
  ListBrowserSettingsResult& WithBrowserSettings(BrowserSettingsT&& value) {
    SetBrowserSettings(std::forward<BrowserSettingsT>(value));
    return *this;
  }
  template <typename BrowserSettingsT = BrowserSettingsSummary>
  ListBrowserSettingsResult& AddBrowserSettings(BrowserSettingsT&& value) {
    m_browserSettingsHasBeenSet = true;
    m_browserSettings.emplace_back(std::forward<BrowserSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListBrowserSettingsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListBrowserSettingsResult& WithRequestId(RequestIdT&& value) {
