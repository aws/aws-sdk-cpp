...
class UpdateUserAccessLoggingSettingsRequest : public WorkSpacesWebRequest {
 public:
  ...
  template <typename UserAccessLoggingSettingsArnT = Aws::String>
  UpdateUserAccessLoggingSettingsRequest& WithUserAccessLoggingSettingsArn(UserAccessLoggingSettingsArnT&& value) {
  ...
  template <typename KinesisStreamArnT = Aws::String>
  UpdateUserAccessLoggingSettingsRequest& WithKinesisStreamArn(KinesisStreamArnT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  UpdateUserAccessLoggingSettingsRequest& WithClientToken(ClientTokenT&& value) {
