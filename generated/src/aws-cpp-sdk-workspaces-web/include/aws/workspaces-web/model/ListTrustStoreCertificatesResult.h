...
class ListTrustStoreCertificatesResult {
 public:
  ...
  void SetCertificateList(CertificateListT&& value) {
    m_certificateListHasBeenSet = true;
    m_certificateList = std::forward<CertificateListT>(value);
  }
  template <typename CertificateListT = Aws::Vector<CertificateSummary>>
  ListTrustStoreCertificatesResult& WithCertificateList(CertificateListT&& value) {
    SetCertificateList(std::forward<CertificateListT>(value));
    return *this;
  }
  template <typename CertificateListT = CertificateSummary>
  ListTrustStoreCertificatesResult& AddCertificateList(CertificateListT&& value) {
    m_certificateListHasBeenSet = true;
    m_certificateList.emplace_back(std::forward<CertificateListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TrustStoreArnT = Aws::String>
  ListTrustStoreCertificatesResult& WithTrustStoreArn(TrustStoreArnT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListTrustStoreCertificatesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListTrustStoreCertificatesResult& WithRequestId(RequestIdT&& value) {
