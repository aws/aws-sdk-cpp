...
namespace Model
{
  ...
  public:
    ...
    template<typename UserAccessLoggingSettingsArnT = Aws::String>
    GetUserAccessLoggingSettingsRequest& WithUserAccessLoggingSettingsArn(UserAccessLoggingSettingsArnT&& value) { SetUserAccessLoggingSettingsArn(std::forward<UserAccessLoggingSettingsArnT>(value)); return *this;}
    ///@}
  private:
