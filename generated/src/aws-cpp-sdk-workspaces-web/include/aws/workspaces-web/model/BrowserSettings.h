...
class BrowserSettings {
 public:
  ...
  template <typename BrowserSettingsArnT = Aws::String>
  BrowserSettings& WithBrowserSettingsArn(BrowserSettingsArnT&& value) {
  ...
  template <typename AssociatedPortalArnsT = Aws::Vector<Aws::String>>
  BrowserSettings& WithAssociatedPortalArns(AssociatedPortalArnsT&& value) {
    SetAssociatedPortalArns(std::forward<AssociatedPortalArnsT>(value));
    return *this;
  }
  template <typename AssociatedPortalArnsT = Aws::String>
  BrowserSettings& AddAssociatedPortalArns(AssociatedPortalArnsT&& value) {
    m_associatedPortalArnsHasBeenSet = true;
  ...
  template <typename BrowserPolicyT = Aws::String>
  BrowserSettings& WithBrowserPolicy(BrowserPolicyT&& value) {
  ...
  template <typename CustomerManagedKeyT = Aws::String>
  BrowserSettings& WithCustomerManagedKey(CustomerManagedKeyT&& value) {
  ...
  template <typename AdditionalEncryptionContextT = Aws::Map<Aws::String, Aws::String>>
  BrowserSettings& WithAdditionalEncryptionContext(AdditionalEncryptionContextT&& value) {
