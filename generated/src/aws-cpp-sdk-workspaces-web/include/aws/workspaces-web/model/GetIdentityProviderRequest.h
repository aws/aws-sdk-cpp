...
namespace Model
{
  ...
  {
  public:
    AWS_WORKSPACESWEB_API GetIdentityProviderRequest() = default;
    ...
    template<typename IdentityProviderArnT = Aws::String>
    GetIdentityProviderRequest& WithIdentityProviderArn(IdentityProviderArnT&& value) { SetIdentityProviderArn(std::forward<IdentityProviderArnT>(value)); return *this;}
    ///@}
  private:
