...
class AssociateDataProtectionSettingsResult {
 public:
  ...
  AWS_WORKSPACESWEB_API AssociateDataProtectionSettingsResult& operator=(
  ...
  template <typename PortalArnT = Aws::String>
  AssociateDataProtectionSettingsResult& WithPortalArn(PortalArnT&& value) {
  ...
  template <typename DataProtectionSettingsArnT = Aws::String>
  AssociateDataProtectionSettingsResult& WithDataProtectionSettingsArn(DataProtectionSettingsArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  AssociateDataProtectionSettingsResult& WithRequestId(RequestIdT&& value) {
