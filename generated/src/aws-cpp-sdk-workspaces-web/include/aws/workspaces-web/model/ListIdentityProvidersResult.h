...
class ListIdentityProvidersResult {
 public:
  ...
  template <typename IdentityProvidersT = Aws::Vector<IdentityProviderSummary>>
  ListIdentityProvidersResult& WithIdentityProviders(IdentityProvidersT&& value) {
    SetIdentityProviders(std::forward<IdentityProvidersT>(value));
    return *this;
  }
  template <typename IdentityProvidersT = IdentityProviderSummary>
  ListIdentityProvidersResult& AddIdentityProviders(IdentityProvidersT&& value) {
    m_identityProvidersHasBeenSet = true;
    m_identityProviders.emplace_back(std::forward<IdentityProvidersT>(value));
    return *this;
  }
  ///@}
