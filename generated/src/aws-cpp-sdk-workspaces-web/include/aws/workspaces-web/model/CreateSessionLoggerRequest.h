...
class CreateSessionLoggerRequest : public WorkSpacesWebRequest {
 public:
  ...
  template <typename EventFilterT = EventFilter>
  CreateSessionLoggerRequest& WithEventFilter(EventFilterT&& value) {
  ...
  template <typename LogConfigurationT = LogConfiguration>
  CreateSessionLoggerRequest& WithLogConfiguration(LogConfigurationT&& value) {
  ...
  template <typename DisplayNameT = Aws::String>
  CreateSessionLoggerRequest& WithDisplayName(DisplayNameT&& value) {
  ...
  template <typename CustomerManagedKeyT = Aws::String>
  CreateSessionLoggerRequest& WithCustomerManagedKey(CustomerManagedKeyT&& value) {
  ...
  template <typename AdditionalEncryptionContextT = Aws::Map<Aws::String, Aws::String>>
  CreateSessionLoggerRequest& WithAdditionalEncryptionContext(AdditionalEncryptionContextT&& value) {
  ...
  CreateSessionLoggerRequest& AddAdditionalEncryptionContext(AdditionalEncryptionContextKeyT&& key,
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateSessionLoggerRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateSessionLoggerRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename ClientTokenT = Aws::String>
  CreateSessionLoggerRequest& WithClientToken(ClientTokenT&& value) {
