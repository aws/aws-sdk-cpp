...
class ListSessionsRequest : public WorkSpacesWebRequest {
 public:
  ...
  template <typename PortalIdT = Aws::String>
  ListSessionsRequest& WithPortalId(PortalIdT&& value) {
  ...
  template <typename UsernameT = Aws::String>
  ListSessionsRequest& WithUsername(UsernameT&& value) {
  ...
  inline void SetSortBy(SessionSortBy value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ListSessionsRequest& WithSortBy(SessionSortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListSessionsRequest& WithStatus(SessionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
