...
class ListNetworkSettingsResult {
 public:
  ...
  template <typename NetworkSettingsT = Aws::Vector<NetworkSettingsSummary>>
  ListNetworkSettingsResult& WithNetworkSettings(NetworkSettingsT&& value) {
    SetNetworkSettings(std::forward<NetworkSettingsT>(value));
    return *this;
  }
  template <typename NetworkSettingsT = NetworkSettingsSummary>
  ListNetworkSettingsResult& AddNetworkSettings(NetworkSettingsT&& value) {
    m_networkSettingsHasBeenSet = true;
    m_networkSettings.emplace_back(std::forward<NetworkSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListNetworkSettingsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListNetworkSettingsResult& WithRequestId(RequestIdT&& value) {
