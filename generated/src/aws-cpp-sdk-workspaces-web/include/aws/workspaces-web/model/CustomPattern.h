...
class CustomPattern {
 public:
  ...
  template <typename PatternNameT = Aws::String>
  CustomPattern& WithPatternName(PatternNameT&& value) {
  ...
  template <typename PatternRegexT = Aws::String>
  CustomPattern& WithPatternRegex(PatternRegexT&& value) {
  ...
  void SetPatternDescription(PatternDescriptionT&& value) {
    m_patternDescriptionHasBeenSet = true;
    m_patternDescription = std::forward<PatternDescriptionT>(value);
  }
  template <typename PatternDescriptionT = Aws::String>
  CustomPattern& WithPatternDescription(PatternDescriptionT&& value) {
    SetPatternDescription(std::forward<PatternDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetKeywordRegex(KeywordRegexT&& value) {
    m_keywordRegexHasBeenSet = true;
    m_keywordRegex = std::forward<KeywordRegexT>(value);
  }
  template <typename KeywordRegexT = Aws::String>
  CustomPattern& WithKeywordRegex(KeywordRegexT&& value) {
    SetKeywordRegex(std::forward<KeywordRegexT>(value));
    return *this;
  }
  ///@}
 private:
