...
class CreateIpAccessSettingsResult {
 public:
  AWS_WORKSPACESWEB_API CreateIpAccessSettingsResult() = default;
  ...
  template <typename IpAccessSettingsArnT = Aws::String>
  CreateIpAccessSettingsResult& WithIpAccessSettingsArn(IpAccessSettingsArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateIpAccessSettingsResult& WithRequestId(RequestIdT&& value) {
