...
class ListDataProtectionSettingsResult {
 public:
  ...
  void SetDataProtectionSettings(DataProtectionSettingsT&& value) {
    m_dataProtectionSettingsHasBeenSet = true;
    m_dataProtectionSettings = std::forward<DataProtectionSettingsT>(value);
  }
  template <typename DataProtectionSettingsT = Aws::Vector<DataProtectionSettingsSummary>>
  ListDataProtectionSettingsResult& WithDataProtectionSettings(DataProtectionSettingsT&& value) {
    SetDataProtectionSettings(std::forward<DataProtectionSettingsT>(value));
    return *this;
  }
  template <typename DataProtectionSettingsT = DataProtectionSettingsSummary>
  ListDataProtectionSettingsResult& AddDataProtectionSettings(DataProtectionSettingsT&& value) {
    m_dataProtectionSettingsHasBeenSet = true;
    m_dataProtectionSettings.emplace_back(std::forward<DataProtectionSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListDataProtectionSettingsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDataProtectionSettingsResult& WithRequestId(RequestIdT&& value) {
