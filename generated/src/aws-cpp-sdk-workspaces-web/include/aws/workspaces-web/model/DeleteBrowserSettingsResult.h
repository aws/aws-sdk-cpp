...
namespace Model
{
  ...
  {
  public:
    AWS_WORKSPACESWEB_API DeleteBrowserSettingsResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteBrowserSettingsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
