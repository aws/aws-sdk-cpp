...
WallpaperImageInput::WallpaperImageInput(JsonView jsonValue) { *this = jsonValue; }

WallpaperImageInput& WallpaperImageInput::operator=(JsonView jsonValue) {
...
JsonValue WallpaperImageInput::Jsonize() const {
  JsonValue payload;
