...
RedactionPlaceHolder::RedactionPlaceHolder(JsonView jsonValue) { *this = jsonValue; }

RedactionPlaceHolder& RedactionPlaceHolder::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("redactionPlaceHolderType")) {
    m_redactionPlaceHolderType =
        RedactionPlaceHolderTypeMapper::GetRedactionPlaceHolderTypeForName(jsonValue.GetString("redactionPlaceHolderType"));
...
JsonValue RedactionPlaceHolder::Jsonize() const {
  ...
  if (m_redactionPlaceHolderTypeHasBeenSet) {
    payload.WithString("redactionPlaceHolderType",
                       RedactionPlaceHolderTypeMapper::GetNameForRedactionPlaceHolderType(m_redactionPlaceHolderType));
  }
