...
InlineRedactionConfiguration::InlineRedactionConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
InlineRedactionConfiguration& InlineRedactionConfiguration::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("inlineRedactionPatterns")) {
    ...
    for (unsigned inlineRedactionPatternsIndex = 0; inlineRedactionPatternsIndex < inlineRedactionPatternsJsonList.GetLength();
         ++inlineRedactionPatternsIndex) {
  ...
  if (jsonValue.ValueExists("globalEnforcedUrls")) {
    ...
    for (unsigned globalEnforcedUrlsIndex = 0; globalEnforcedUrlsIndex < globalEnforcedUrlsJsonList.GetLength();
         ++globalEnforcedUrlsIndex) {
...
JsonValue InlineRedactionConfiguration::Jsonize() const {
  ...
  if (m_inlineRedactionPatternsHasBeenSet) {
    ...
    for (unsigned inlineRedactionPatternsIndex = 0; inlineRedactionPatternsIndex < inlineRedactionPatternsJsonList.GetLength();
         ++inlineRedactionPatternsIndex) {
      inlineRedactionPatternsJsonList[inlineRedactionPatternsIndex].AsObject(
          m_inlineRedactionPatterns[inlineRedactionPatternsIndex].Jsonize());
    }
