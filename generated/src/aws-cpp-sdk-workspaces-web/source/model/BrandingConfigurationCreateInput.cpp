...
BrandingConfigurationCreateInput::BrandingConfigurationCreateInput(JsonView jsonValue) { *this = jsonValue; }

BrandingConfigurationCreateInput& BrandingConfigurationCreateInput::operator=(JsonView jsonValue) {
...
JsonValue BrandingConfigurationCreateInput::Jsonize() const {
  JsonValue payload;
