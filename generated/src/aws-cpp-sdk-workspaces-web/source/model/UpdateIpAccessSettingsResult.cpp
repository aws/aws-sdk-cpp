...
UpdateIpAccessSettingsResult::UpdateIpAccessSettingsResult()
{
}

UpdateIpAccessSettingsResult::UpdateIpAccessSettingsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
