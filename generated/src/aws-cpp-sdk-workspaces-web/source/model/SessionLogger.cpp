...
SessionLogger::SessionLogger(JsonView jsonValue) { *this = jsonValue; }
...
SessionLogger& SessionLogger::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("associatedPortalArns")) {
    ...
    for (unsigned associatedPortalArnsIndex = 0; associatedPortalArnsIndex < associatedPortalArnsJsonList.GetLength();
         ++associatedPortalArnsIndex) {
