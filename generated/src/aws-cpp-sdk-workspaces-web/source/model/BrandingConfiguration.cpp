...
BrandingConfiguration::BrandingConfiguration(JsonView jsonValue) { *this = jsonValue; }

BrandingConfiguration& BrandingConfiguration::operator=(JsonView jsonValue) {
...
JsonValue BrandingConfiguration::Jsonize() const {
  JsonValue payload;
