...
{
const size_t WorkSpacesWebEndpointRules::RulesBlobStrLen = 3756;
const size_t WorkSpacesWebEndpointRules::RulesBlobSize = 3757;
...
'"','h','t','t','p','s',':','/','/','w','o','r','k','s','p','a','c','e','s','-','w','e','b','-','f',
...
':','/','/','w','o','r','k','s','p','a','c','e','s','-','w','e','b','.','{','R','e','g','i','o','n',
...
'w','e','b','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R','e',
's','u','l','t','#','d','n','s','S','u','f','f','i','x','}','"',',','"','p','r','o','p','e','r','t',
'i','e','s','"',':','{','}',',','"','h','e','a','d','e','r','s','"',':','{','}','}',',','"','t','y',
