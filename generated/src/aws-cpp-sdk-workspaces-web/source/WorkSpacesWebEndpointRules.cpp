...
{
const size_t WorkSpacesWebEndpointRules::RulesBlobStrLen = 3424;
const size_t WorkSpacesWebEndpointRules::RulesBlobSize = 3425;
...
'a','c','e','s','-','w','e','b','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t',
