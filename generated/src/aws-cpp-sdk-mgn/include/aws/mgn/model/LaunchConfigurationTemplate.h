...
class LaunchConfigurationTemplate {
 public:
  ...
  inline LaunchConfigurationTemplate& WithEnableMapAutoTagging(bool value) {
  ...
  inline LaunchConfigurationTemplate& WithLaunchDisposition(LaunchDisposition value) {
  ...
  inline LaunchConfigurationTemplate& WithTargetInstanceTypeRightSizingMethod(TargetInstanceTypeRightSizingMethod value) {
  ...
  inline LaunchConfigurationTemplate& WithCopyPrivateIp(bool value) {
  ...
  inline LaunchConfigurationTemplate& WithAssociatePublicIpAddress(bool value) {
  ...
  inline LaunchConfigurationTemplate& WithCopyTags(bool value) {
    SetCopyTags(value);
    return *this;
  }
  ///@}
  ...
  inline LaunchConfigurationTemplate& WithBootMode(BootMode value) {
    SetBootMode(value);
    return *this;
  }
  ///@}
  ...
  inline LaunchConfigurationTemplate& WithSmallVolumeMaxSize(long long value) {
  ...
  inline LaunchConfigurationTemplate& WithEnableParametersEncryption(bool value) {
