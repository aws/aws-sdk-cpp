...
class StartReplicationResult {
 public:
  ...
  template <typename ApplicationIDT = Aws::String>
  StartReplicationResult& WithApplicationID(ApplicationIDT&& value) {
  ...
  template <typename ArnT = Aws::String>
  StartReplicationResult& WithArn(ArnT&& value) {
  ...
  template <typename ConnectorActionT = SourceServerConnectorAction>
  StartReplicationResult& WithConnectorAction(ConnectorActionT&& value) {
  ...
  template <typename DataReplicationInfoT = DataReplicationInfo>
  StartReplicationResult& WithDataReplicationInfo(DataReplicationInfoT&& value) {
  ...
  template <typename FqdnForActionFrameworkT = Aws::String>
  StartReplicationResult& WithFqdnForActionFramework(FqdnForActionFrameworkT&& value) {
  ...
  inline StartReplicationResult& WithIsArchived(bool value) {
    SetIsArchived(value);
    return *this;
  }
  ///@}
  ...
  template <typename LaunchedInstanceT = LaunchedInstance>
  StartReplicationResult& WithLaunchedInstance(LaunchedInstanceT&& value) {
  ...
  template <typename LifeCycleT = LifeCycle>
  StartReplicationResult& WithLifeCycle(LifeCycleT&& value) {
  ...
  inline StartReplicationResult& WithReplicationType(ReplicationType value) {
  ...
  template <typename SourcePropertiesT = SourceProperties>
  StartReplicationResult& WithSourceProperties(SourcePropertiesT&& value) {
  ...
  template <typename SourceServerIDT = Aws::String>
  StartReplicationResult& WithSourceServerID(SourceServerIDT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  StartReplicationResult& WithTags(TagsT&& value) {
  ...
  template <typename UserProvidedIDT = Aws::String>
  StartReplicationResult& WithUserProvidedID(UserProvidedIDT&& value) {
  ...
  template <typename VcenterClientIDT = Aws::String>
  StartReplicationResult& WithVcenterClientID(VcenterClientIDT&& value) {
