...
/**
 * <p>Details about a network migration mapping update job.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/mgn-2020-02-26/NetworkMigrationMappingUpdateJobDetails">AWS
 * API Reference</a></p>
 */
class NetworkMigrationMappingUpdateJobDetails {
 public:
  AWS_MGN_API NetworkMigrationMappingUpdateJobDetails() = default;
  AWS_MGN_API NetworkMigrationMappingUpdateJobDetails(Aws::Utils::Json::JsonView jsonValue);
  AWS_MGN_API NetworkMigrationMappingUpdateJobDetails& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename JobIDT = Aws::String>
  NetworkMigrationMappingUpdateJobDetails& WithJobID(JobIDT&& value) {
  ...
  template <typename NetworkMigrationExecutionIDT = Aws::String>
  NetworkMigrationMappingUpdateJobDetails& WithNetworkMigrationExecutionID(NetworkMigrationExecutionIDT&& value) {
  ...
  template <typename NetworkMigrationDefinitionIDT = Aws::String>
  NetworkMigrationMappingUpdateJobDetails& WithNetworkMigrationDefinitionID(NetworkMigrationDefinitionIDT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  NetworkMigrationMappingUpdateJobDetails& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename EndedAtT = Aws::Utils::DateTime>
  NetworkMigrationMappingUpdateJobDetails& WithEndedAt(EndedAtT&& value) {
  ...
  inline NetworkMigrationMappingUpdateJobDetails& WithStatus(NetworkMigrationJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusDetailsT = Aws::String>
  NetworkMigrationMappingUpdateJobDetails& WithStatusDetails(StatusDetailsT&& value) {
