...
class PutTemplateActionRequest : public MgnRequest {
 public:
  ...
  template <typename ActionIDT = Aws::String>
  PutTemplateActionRequest& WithActionID(ActionIDT&& value) {
  ...
  template <typename ActionNameT = Aws::String>
  PutTemplateActionRequest& WithActionName(ActionNameT&& value) {
  ...
  inline PutTemplateActionRequest& WithActive(bool value) {
    SetActive(value);
    return *this;
  }
  ///@}
  ...
  inline PutTemplateActionRequest& WithCategory(ActionCategory value) {
    SetCategory(value);
    return *this;
  }
  ///@}
  ...
  template <typename DescriptionT = Aws::String>
  PutTemplateActionRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename DocumentIdentifierT = Aws::String>
  PutTemplateActionRequest& WithDocumentIdentifier(DocumentIdentifierT&& value) {
  ...
  template <typename DocumentVersionT = Aws::String>
  PutTemplateActionRequest& WithDocumentVersion(DocumentVersionT&& value) {
  ...
  template <typename ExternalParametersT = Aws::Map<Aws::String, SsmExternalParameter>>
  PutTemplateActionRequest& WithExternalParameters(ExternalParametersT&& value) {
  ...
  template <typename LaunchConfigurationTemplateIDT = Aws::String>
  PutTemplateActionRequest& WithLaunchConfigurationTemplateID(LaunchConfigurationTemplateIDT&& value) {
  ...
  inline PutTemplateActionRequest& WithMustSucceedForCutover(bool value) {
  ...
  template <typename OperatingSystemT = Aws::String>
  PutTemplateActionRequest& WithOperatingSystem(OperatingSystemT&& value) {
  ...
  inline PutTemplateActionRequest& WithOrder(int value) {
    SetOrder(value);
    return *this;
  }
  ///@}
  ...
  template <typename ParametersT = Aws::Map<Aws::String, Aws::Vector<SsmParameterStoreParameter>>>
  PutTemplateActionRequest& WithParameters(ParametersT&& value) {
  ...
  inline PutTemplateActionRequest& WithTimeoutSeconds(int value) {
