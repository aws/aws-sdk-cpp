...
class ListManagedAccountsRequest : public MgnRequest {
 public:
  AWS_MGN_API ListManagedAccountsRequest() = default;
  ...
  inline ListManagedAccountsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListManagedAccountsRequest& WithNextToken(NextTokenT&& value) {
