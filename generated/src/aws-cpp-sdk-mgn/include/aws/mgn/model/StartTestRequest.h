...
class StartTestRequest : public MgnRequest {
 public:
  ...
  template <typename SourceServerIDsT = Aws::Vector<Aws::String>>
  StartTestRequest& WithSourceServerIDs(SourceServerIDsT&& value) {
    SetSourceServerIDs(std::forward<SourceServerIDsT>(value));
    return *this;
  }
  template <typename SourceServerIDsT = Aws::String>
  StartTestRequest& AddSourceServerIDs(SourceServerIDsT&& value) {
    m_sourceServerIDsHasBeenSet = true;
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  StartTestRequest& WithTags(TagsT&& value) {
