...
class UpdateReplicationConfigurationResult {
 public:
  ...
  inline UpdateReplicationConfigurationResult& WithUseFipsEndpoint(bool value) {
  ...
  inline UpdateReplicationConfigurationResult& WithStoreSnapshotOnLocalZone(bool value) {
