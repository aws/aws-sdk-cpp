...
/**
 * <p>Filters for listing mapper segments.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/mgn-2020-02-26/ListNetworkMigrationMapperSegmentsFilters">AWS
 * API Reference</a></p>
 */
class ListNetworkMigrationMapperSegmentsFilters {
 public:
  AWS_MGN_API ListNetworkMigrationMapperSegmentsFilters() = default;
  AWS_MGN_API ListNetworkMigrationMapperSegmentsFilters(Aws::Utils::Json::JsonView jsonValue);
  AWS_MGN_API ListNetworkMigrationMapperSegmentsFilters& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename SegmentIDsT = Aws::Vector<Aws::String>>
  ListNetworkMigrationMapperSegmentsFilters& WithSegmentIDs(SegmentIDsT&& value) {
    SetSegmentIDs(std::forward<SegmentIDsT>(value));
    return *this;
  }
  template <typename SegmentIDsT = Aws::String>
  ListNetworkMigrationMapperSegmentsFilters& AddSegmentIDs(SegmentIDsT&& value) {
    m_segmentIDsHasBeenSet = true;
