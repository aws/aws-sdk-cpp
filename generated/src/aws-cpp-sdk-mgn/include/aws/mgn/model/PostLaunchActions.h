...
class PostLaunchActions {
 public:
  ...
  inline void SetDeployment(PostLaunchActionsDeploymentType value) {
    m_deploymentHasBeenSet = true;
    m_deployment = value;
  }
  inline PostLaunchActions& WithDeployment(PostLaunchActionsDeploymentType value) {
    SetDeployment(value);
    return *this;
  }
  ///@}
  ...
  void SetS3LogBucket(S3LogBucketT&& value) {
    ...
    m_s3LogBucket = std::forward<S3LogBucketT>(value);
  }
  template <typename S3LogBucketT = Aws::String>
  PostLaunchActions& WithS3LogBucket(S3LogBucketT&& value) {
    SetS3LogBucket(std::forward<S3LogBucketT>(value));
    return *this;
  }
  ///@}
  ...
  void SetS3OutputKeyPrefix(S3OutputKeyPrefixT&& value) {
    ...
    m_s3OutputKeyPrefix = std::forward<S3OutputKeyPrefixT>(value);
  }
  template <typename S3OutputKeyPrefixT = Aws::String>
  PostLaunchActions& WithS3OutputKeyPrefix(S3OutputKeyPrefixT&& value) {
    SetS3OutputKeyPrefix(std::forward<S3OutputKeyPrefixT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSsmDocuments(SsmDocumentsT&& value) {
    ...
    m_ssmDocuments = std::forward<SsmDocumentsT>(value);
  }
  template <typename SsmDocumentsT = Aws::Vector<SsmDocument>>
  PostLaunchActions& WithSsmDocuments(SsmDocumentsT&& value) {
    SetSsmDocuments(std::forward<SsmDocumentsT>(value));
    return *this;
  }
  template <typename SsmDocumentsT = SsmDocument>
  PostLaunchActions& AddSsmDocuments(SsmDocumentsT&& value) {
    m_ssmDocumentsHasBeenSet = true;
    m_ssmDocuments.emplace_back(std::forward<SsmDocumentsT>(value));
    return *this;
  }
  ///@}
 private:
