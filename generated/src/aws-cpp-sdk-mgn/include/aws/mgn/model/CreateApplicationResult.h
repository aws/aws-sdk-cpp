...
namespace Model
{
  ...
  public:
    ...
    template<typename ApplicationAggregatedStatusT = ApplicationAggregatedStatus>
    CreateApplicationResult& WithApplicationAggregatedStatus(ApplicationAggregatedStatusT&& value) { SetApplicationAggregatedStatus(std::forward<ApplicationAggregatedStatusT>(value)); return *this;}
    ///@}
    ...
    template<typename CreationDateTimeT = Aws::String>
    CreateApplicationResult& WithCreationDateTime(CreationDateTimeT&& value) { SetCreationDateTime(std::forward<CreationDateTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename LastModifiedDateTimeT = Aws::String>
    CreateApplicationResult& WithLastModifiedDateTime(LastModifiedDateTimeT&& value) { SetLastModifiedDateTime(std::forward<LastModifiedDateTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename WaveIDT = Aws::String>
    CreateApplicationResult& WithWaveID(WaveIDT&& value) { SetWaveID(std::forward<WaveIDT>(value)); return *this;}
    ///@}
