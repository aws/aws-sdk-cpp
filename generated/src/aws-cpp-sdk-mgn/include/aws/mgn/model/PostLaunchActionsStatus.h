...
class PostLaunchActionsStatus {
 public:
  ...
  inline const Aws::Vector<JobPostLaunchActionsLaunchStatus>& GetPostLaunchActionsLaunchStatusList() const {
    return m_postLaunchActionsLaunchStatusList;
  }
  ...
  void SetPostLaunchActionsLaunchStatusList(PostLaunchActionsLaunchStatusListT&& value) {
    m_postLaunchActionsLaunchStatusListHasBeenSet = true;
    m_postLaunchActionsLaunchStatusList = std::forward<PostLaunchActionsLaunchStatusListT>(value);
  }
  template <typename PostLaunchActionsLaunchStatusListT = Aws::Vector<JobPostLaunchActionsLaunchStatus>>
  PostLaunchActionsStatus& WithPostLaunchActionsLaunchStatusList(PostLaunchActionsLaunchStatusListT&& value) {
    SetPostLaunchActionsLaunchStatusList(std::forward<PostLaunchActionsLaunchStatusListT>(value));
    return *this;
  }
  template <typename PostLaunchActionsLaunchStatusListT = JobPostLaunchActionsLaunchStatus>
  PostLaunchActionsStatus& AddPostLaunchActionsLaunchStatusList(PostLaunchActionsLaunchStatusListT&& value) {
    m_postLaunchActionsLaunchStatusListHasBeenSet = true;
    m_postLaunchActionsLaunchStatusList.emplace_back(std::forward<PostLaunchActionsLaunchStatusListT>(value));
    return *this;
  }
  ///@}
