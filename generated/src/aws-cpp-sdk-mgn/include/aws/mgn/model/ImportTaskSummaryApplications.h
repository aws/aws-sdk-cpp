...
class ImportTaskSummaryApplications {
 public:
  AWS_MGN_API ImportTaskSummaryApplications() = default;
  ...
  inline ImportTaskSummaryApplications& WithCreatedCount(long long value) {
  ...
  inline ImportTaskSummaryApplications& WithModifiedCount(long long value) {
