...
class LifeCycleLastTest {
 public:
  ...
  template <typename InitiatedT = LifeCycleLastTestInitiated>
  LifeCycleLastTest& WithInitiated(InitiatedT&& value) {
  ...
  void SetReverted(RevertedT&& value) {
    ...
    m_reverted = std::forward<RevertedT>(value);
  }
  template <typename RevertedT = LifeCycleLastTestReverted>
  LifeCycleLastTest& WithReverted(RevertedT&& value) {
    SetReverted(std::forward<RevertedT>(value));
    return *this;
  }
  ///@}
