...
class ListWavesResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<Wave>>
  ListWavesResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = Wave>
  ListWavesResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListWavesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListWavesResult& WithRequestId(RequestIdT&& value) {
