...
class VcenterClient {
 public:
  ...
  void SetSourceServerTags(SourceServerTagsT&& value) {
    ...
    m_sourceServerTags = std::forward<SourceServerTagsT>(value);
  }
  template <typename SourceServerTagsT = Aws::Map<Aws::String, Aws::String>>
  VcenterClient& WithSourceServerTags(SourceServerTagsT&& value) {
    SetSourceServerTags(std::forward<SourceServerTagsT>(value));
    return *this;
  }
  ...
  VcenterClient& AddSourceServerTags(SourceServerTagsKeyT&& key, SourceServerTagsValueT&& value) {
    m_sourceServerTagsHasBeenSet = true;
    m_sourceServerTags.emplace(std::forward<SourceServerTagsKeyT>(key), std::forward<SourceServerTagsValueT>(value));
    return *this;
  }
  ///@}
