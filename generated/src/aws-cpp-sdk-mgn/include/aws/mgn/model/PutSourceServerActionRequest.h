...
class PutSourceServerActionRequest : public MgnRequest {
 public:
  ...
  inline PutSourceServerActionRequest& WithActive(bool value) {
    SetActive(value);
    return *this;
  }
  ///@}
  ...
  inline PutSourceServerActionRequest& WithCategory(ActionCategory value) {
    SetCategory(value);
    return *this;
  }
  ///@}
  ...
  inline PutSourceServerActionRequest& WithMustSucceedForCutover(bool value) {
  ...
  inline PutSourceServerActionRequest& WithOrder(int value) {
    SetOrder(value);
    return *this;
  }
  ///@}
  ...
  inline PutSourceServerActionRequest& WithTimeoutSeconds(int value) {
