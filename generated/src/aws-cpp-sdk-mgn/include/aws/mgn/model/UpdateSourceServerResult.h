...
class UpdateSourceServerResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  UpdateSourceServerResult& WithArn(ArnT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  UpdateSourceServerResult& WithTags(TagsT&& value) {
  ...
  template <typename VcenterClientIDT = Aws::String>
  UpdateSourceServerResult& WithVcenterClientID(VcenterClientIDT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateSourceServerResult& WithRequestId(RequestIdT&& value) {
