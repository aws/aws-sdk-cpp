...
namespace Model
{
  ...
  {
  public:
    AWS_MGN_API RemoveTemplateActionResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    RemoveTemplateActionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
