...
#include <aws/mgn/model/ListNetworkMigrationCodeGenerationsFilters.h>
...
/**
 */
class ListNetworkMigrationCodeGenerationsRequest : public MgnRequest {
 public:
  AWS_MGN_API ListNetworkMigrationCodeGenerationsRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "ListNetworkMigrationCodeGenerations"; }
  ...
  template <typename NetworkMigrationExecutionIDT = Aws::String>
  ListNetworkMigrationCodeGenerationsRequest& WithNetworkMigrationExecutionID(NetworkMigrationExecutionIDT&& value) {
  ...
  template <typename NetworkMigrationDefinitionIDT = Aws::String>
  ListNetworkMigrationCodeGenerationsRequest& WithNetworkMigrationDefinitionID(NetworkMigrationDefinitionIDT&& value) {
   ...
   */
  inline const ListNetworkMigrationCodeGenerationsFilters& GetFilters() const { return m_filters; }
  inline bool FiltersHasBeenSet() const { return m_filtersHasBeenSet; }
  template <typename FiltersT = ListNetworkMigrationCodeGenerationsFilters>
  void SetFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
    m_filters = std::forward<FiltersT>(value);
  }
  template <typename FiltersT = ListNetworkMigrationCodeGenerationsFilters>
  ListNetworkMigrationCodeGenerationsRequest& WithFilters(FiltersT&& value) {
  ...
  inline ListNetworkMigrationCodeGenerationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListNetworkMigrationCodeGenerationsRequest& WithNextToken(NextTokenT&& value) {
 ...
 private:
  ...
  ListNetworkMigrationCodeGenerationsFilters m_filters;
