...
class ApplicationAggregatedStatus {
 public:
  ...
  inline void SetProgressStatus(ApplicationProgressStatus value) {
    m_progressStatusHasBeenSet = true;
    m_progressStatus = value;
  }
  inline ApplicationAggregatedStatus& WithProgressStatus(ApplicationProgressStatus value) {
  ...
  inline void SetTotalSourceServers(long long value) {
    m_totalSourceServersHasBeenSet = true;
    m_totalSourceServers = value;
  }
  inline ApplicationAggregatedStatus& WithTotalSourceServers(long long value) {
    SetTotalSourceServers(value);
    return *this;
  }
  ///@}
 private:
