...
/**
 * <p>Details about a network migration deployer job.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/mgn-2020-02-26/NetworkMigrationDeployerJobDetails">AWS
 * API Reference</a></p>
 */
class NetworkMigrationDeployerJobDetails {
 public:
  AWS_MGN_API NetworkMigrationDeployerJobDetails() = default;
  AWS_MGN_API NetworkMigrationDeployerJobDetails(Aws::Utils::Json::JsonView jsonValue);
  AWS_MGN_API NetworkMigrationDeployerJobDetails& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename JobIDT = Aws::String>
  NetworkMigrationDeployerJobDetails& WithJobID(JobIDT&& value) {
  ...
  template <typename NetworkMigrationExecutionIDT = Aws::String>
  NetworkMigrationDeployerJobDetails& WithNetworkMigrationExecutionID(NetworkMigrationExecutionIDT&& value) {
  ...
  template <typename NetworkMigrationDefinitionIDT = Aws::String>
  NetworkMigrationDeployerJobDetails& WithNetworkMigrationDefinitionID(NetworkMigrationDefinitionIDT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  NetworkMigrationDeployerJobDetails& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename EndedAtT = Aws::Utils::DateTime>
  NetworkMigrationDeployerJobDetails& WithEndedAt(EndedAtT&& value) {
  ...
  inline NetworkMigrationDeployerJobDetails& WithStatus(NetworkMigrationJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusDetailsT = Aws::String>
  NetworkMigrationDeployerJobDetails& WithStatusDetails(StatusDetailsT&& value) {
