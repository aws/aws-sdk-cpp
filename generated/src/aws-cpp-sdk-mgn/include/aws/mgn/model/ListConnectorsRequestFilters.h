...
class ListConnectorsRequestFilters {
 public:
  ...
  void SetConnectorIDs(ConnectorIDsT&& value) {
    m_connectorIDsHasBeenSet = true;
    m_connectorIDs = std::forward<ConnectorIDsT>(value);
  }
  template <typename ConnectorIDsT = Aws::Vector<Aws::String>>
  ListConnectorsRequestFilters& WithConnectorIDs(ConnectorIDsT&& value) {
    SetConnectorIDs(std::forward<ConnectorIDsT>(value));
    return *this;
  }
  template <typename ConnectorIDsT = Aws::String>
  ListConnectorsRequestFilters& AddConnectorIDs(ConnectorIDsT&& value) {
    m_connectorIDsHasBeenSet = true;
    m_connectorIDs.emplace_back(std::forward<ConnectorIDsT>(value));
    return *this;
  }
  ///@}
 private:
