...
namespace Model
{
  ...
  {
  public:
    AWS_MGN_API FinalizeCutoverResult() = default;
    ...
    template<typename ApplicationIDT = Aws::String>
    FinalizeCutoverResult& WithApplicationID(ApplicationIDT&& value) { SetApplicationID(std::forward<ApplicationIDT>(value)); return *this;}
    ///@}
    ...
    template<typename ArnT = Aws::String>
    FinalizeCutoverResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ConnectorActionT = SourceServerConnectorAction>
    FinalizeCutoverResult& WithConnectorAction(ConnectorActionT&& value) { SetConnectorAction(std::forward<ConnectorActionT>(value)); return *this;}
    ///@}
    ...
    template<typename DataReplicationInfoT = DataReplicationInfo>
    FinalizeCutoverResult& WithDataReplicationInfo(DataReplicationInfoT&& value) { SetDataReplicationInfo(std::forward<DataReplicationInfoT>(value)); return *this;}
    ///@}
    ...
    template<typename FqdnForActionFrameworkT = Aws::String>
    FinalizeCutoverResult& WithFqdnForActionFramework(FqdnForActionFrameworkT&& value) { SetFqdnForActionFramework(std::forward<FqdnForActionFrameworkT>(value)); return *this;}
    ///@}
    ...
    template<typename LaunchedInstanceT = LaunchedInstance>
    FinalizeCutoverResult& WithLaunchedInstance(LaunchedInstanceT&& value) { SetLaunchedInstance(std::forward<LaunchedInstanceT>(value)); return *this;}
    ///@}
    ...
    template<typename LifeCycleT = LifeCycle>
    FinalizeCutoverResult& WithLifeCycle(LifeCycleT&& value) { SetLifeCycle(std::forward<LifeCycleT>(value)); return *this;}
    ///@}
    ...
    inline FinalizeCutoverResult& WithReplicationType(ReplicationType value) { SetReplicationType(value); return *this;}
    ///@}
    ...
    template<typename SourcePropertiesT = SourceProperties>
    FinalizeCutoverResult& WithSourceProperties(SourcePropertiesT&& value) { SetSourceProperties(std::forward<SourcePropertiesT>(value)); return *this;}
    ///@}
    ...
    template<typename SourceServerIDT = Aws::String>
    FinalizeCutoverResult& WithSourceServerID(SourceServerIDT&& value) { SetSourceServerID(std::forward<SourceServerIDT>(value)); return *this;}
    ///@}
    ...
    template<typename TagsT = Aws::Map<Aws::String, Aws::String>>
    FinalizeCutoverResult& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
    template<typename TagsKeyT = Aws::String, typename TagsValueT = Aws::String>
    FinalizeCutoverResult& AddTags(TagsKeyT&& key, TagsValueT&& value) {
    ...
    template<typename UserProvidedIDT = Aws::String>
    FinalizeCutoverResult& WithUserProvidedID(UserProvidedIDT&& value) { SetUserProvidedID(std::forward<UserProvidedIDT>(value)); return *this;}
    ///@}
    ...
    template<typename VcenterClientIDT = Aws::String>
    FinalizeCutoverResult& WithVcenterClientID(VcenterClientIDT&& value) { SetVcenterClientID(std::forward<VcenterClientIDT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    FinalizeCutoverResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
