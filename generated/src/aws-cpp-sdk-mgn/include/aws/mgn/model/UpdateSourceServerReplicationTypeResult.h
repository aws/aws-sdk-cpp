...
namespace Model
{
  ...
  public:
    ...
    template<typename ApplicationIDT = Aws::String>
    UpdateSourceServerReplicationTypeResult& WithApplicationID(ApplicationIDT&& value) { SetApplicationID(std::forward<ApplicationIDT>(value)); return *this;}
    ///@}
    ...
    template<typename ArnT = Aws::String>
    UpdateSourceServerReplicationTypeResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ConnectorActionT = SourceServerConnectorAction>
    UpdateSourceServerReplicationTypeResult& WithConnectorAction(ConnectorActionT&& value) { SetConnectorAction(std::forward<ConnectorActionT>(value)); return *this;}
    ///@}
    ...
    template<typename DataReplicationInfoT = DataReplicationInfo>
    UpdateSourceServerReplicationTypeResult& WithDataReplicationInfo(DataReplicationInfoT&& value) { SetDataReplicationInfo(std::forward<DataReplicationInfoT>(value)); return *this;}
    ///@}
    ...
    template<typename FqdnForActionFrameworkT = Aws::String>
    UpdateSourceServerReplicationTypeResult& WithFqdnForActionFramework(FqdnForActionFrameworkT&& value) { SetFqdnForActionFramework(std::forward<FqdnForActionFrameworkT>(value)); return *this;}
    ///@}
    ...
    template<typename LaunchedInstanceT = LaunchedInstance>
    UpdateSourceServerReplicationTypeResult& WithLaunchedInstance(LaunchedInstanceT&& value) { SetLaunchedInstance(std::forward<LaunchedInstanceT>(value)); return *this;}
    ///@}
    ...
    template<typename LifeCycleT = LifeCycle>
    UpdateSourceServerReplicationTypeResult& WithLifeCycle(LifeCycleT&& value) { SetLifeCycle(std::forward<LifeCycleT>(value)); return *this;}
    ///@}
    ...
    inline UpdateSourceServerReplicationTypeResult& WithReplicationType(ReplicationType value) { SetReplicationType(value); return *this;}
    ///@}
    ...
    template<typename SourcePropertiesT = SourceProperties>
    UpdateSourceServerReplicationTypeResult& WithSourceProperties(SourcePropertiesT&& value) { SetSourceProperties(std::forward<SourcePropertiesT>(value)); return *this;}
    ///@}
    ...
    template<typename SourceServerIDT = Aws::String>
    UpdateSourceServerReplicationTypeResult& WithSourceServerID(SourceServerIDT&& value) { SetSourceServerID(std::forward<SourceServerIDT>(value)); return *this;}
    ///@}
    ...
    template<typename TagsT = Aws::Map<Aws::String, Aws::String>>
    UpdateSourceServerReplicationTypeResult& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
    ...
    template<typename UserProvidedIDT = Aws::String>
    UpdateSourceServerReplicationTypeResult& WithUserProvidedID(UserProvidedIDT&& value) { SetUserProvidedID(std::forward<UserProvidedIDT>(value)); return *this;}
    ///@}
    ...
    template<typename VcenterClientIDT = Aws::String>
    UpdateSourceServerReplicationTypeResult& WithVcenterClientID(VcenterClientIDT&& value) { SetVcenterClientID(std::forward<VcenterClientIDT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateSourceServerReplicationTypeResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
