...
namespace Model
{
  ...
  {
  public:
    AWS_MGN_API ListConnectorsResult() = default;
    ...
    template<typename ItemsT = Aws::Vector<Connector>>
    void SetItems(ItemsT&& value) { m_itemsHasBeenSet = true; m_items = std::forward<ItemsT>(value); }
    template<typename ItemsT = Aws::Vector<Connector>>
    ListConnectorsResult& WithItems(ItemsT&& value) { SetItems(std::forward<ItemsT>(value)); return *this;}
    template<typename ItemsT = Connector>
    ListConnectorsResult& AddItems(ItemsT&& value) { m_itemsHasBeenSet = true; m_items.emplace_back(std::forward<ItemsT>(value)); return *this; }
    ///@}
