...
class ListApplicationsRequestFilters {
 public:
  ...
  template <typename ApplicationIDsT = Aws::Vector<Aws::String>>
  ListApplicationsRequestFilters& WithApplicationIDs(ApplicationIDsT&& value) {
    SetApplicationIDs(std::forward<ApplicationIDsT>(value));
    return *this;
  }
  template <typename ApplicationIDsT = Aws::String>
  ListApplicationsRequestFilters& AddApplicationIDs(ApplicationIDsT&& value) {
    m_applicationIDsHasBeenSet = true;
  ...
  inline ListApplicationsRequestFilters& WithIsArchived(bool value) {
    SetIsArchived(value);
    return *this;
  }
  ///@}
  ...
  void SetWaveIDs(WaveIDsT&& value) {
    m_waveIDsHasBeenSet = true;
    m_waveIDs = std::forward<WaveIDsT>(value);
  }
  template <typename WaveIDsT = Aws::Vector<Aws::String>>
  ListApplicationsRequestFilters& WithWaveIDs(WaveIDsT&& value) {
    SetWaveIDs(std::forward<WaveIDsT>(value));
    return *this;
  }
  template <typename WaveIDsT = Aws::String>
  ListApplicationsRequestFilters& AddWaveIDs(WaveIDsT&& value) {
    m_waveIDsHasBeenSet = true;
    m_waveIDs.emplace_back(std::forward<WaveIDsT>(value));
    return *this;
  }
  ///@}
 private:
