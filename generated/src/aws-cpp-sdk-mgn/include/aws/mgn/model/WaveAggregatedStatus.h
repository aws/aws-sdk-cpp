...
class WaveAggregatedStatus {
 public:
  ...
  void SetReplicationStartedDateTime(ReplicationStartedDateTimeT&& value) {
    ...
    m_replicationStartedDateTime = std::forward<ReplicationStartedDateTimeT>(value);
  }
  template <typename ReplicationStartedDateTimeT = Aws::String>
  WaveAggregatedStatus& WithReplicationStartedDateTime(ReplicationStartedDateTimeT&& value) {
    SetReplicationStartedDateTime(std::forward<ReplicationStartedDateTimeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTotalApplications(long long value) {
    m_totalApplicationsHasBeenSet = true;
    m_totalApplications = value;
  }
  inline WaveAggregatedStatus& WithTotalApplications(long long value) {
