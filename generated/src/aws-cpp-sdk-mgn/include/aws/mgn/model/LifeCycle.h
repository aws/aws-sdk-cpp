...
class LifeCycle {
 public:
  ...
  void SetLastTest(LastTestT&& value) {
    ...
    m_lastTest = std::forward<LastTestT>(value);
  }
  template <typename LastTestT = LifeCycleLastTest>
  LifeCycle& WithLastTest(LastTestT&& value) {
    SetLastTest(std::forward<LastTestT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetState(LifeCycleState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline LifeCycle& WithState(LifeCycleState value) {
    SetState(value);
    return *this;
  }
  ///@}
