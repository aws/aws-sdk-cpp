...
class UpdateReplicationConfigurationTemplateResult {
 public:
  AWS_MGN_API UpdateReplicationConfigurationTemplateResult() = default;
  ...
  AWS_MGN_API UpdateReplicationConfigurationTemplateResult& operator=(
  ...
  inline UpdateReplicationConfigurationTemplateResult& WithUseFipsEndpoint(bool value) {
  ...
  inline UpdateReplicationConfigurationTemplateResult& WithStoreSnapshotOnLocalZone(bool value) {
  ...
  template <typename StorageConfigurationT = StorageConfiguration>
  UpdateReplicationConfigurationTemplateResult& WithStorageConfiguration(StorageConfigurationT&& value) {
