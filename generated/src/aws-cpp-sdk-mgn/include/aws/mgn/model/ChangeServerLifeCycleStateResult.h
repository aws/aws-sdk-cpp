...
namespace Model
{
  ...
  public:
    ...
    template<typename ApplicationIDT = Aws::String>
    ChangeServerLifeCycleStateResult& WithApplicationID(ApplicationIDT&& value) { SetApplicationID(std::forward<ApplicationIDT>(value)); return *this;}
    ///@}
    ...
    template<typename ArnT = Aws::String>
    ChangeServerLifeCycleStateResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ConnectorActionT = SourceServerConnectorAction>
    ChangeServerLifeCycleStateResult& WithConnectorAction(ConnectorActionT&& value) { SetConnectorAction(std::forward<ConnectorActionT>(value)); return *this;}
    ///@}
    ...
    template<typename DataReplicationInfoT = DataReplicationInfo>
    ChangeServerLifeCycleStateResult& WithDataReplicationInfo(DataReplicationInfoT&& value) { SetDataReplicationInfo(std::forward<DataReplicationInfoT>(value)); return *this;}
    ///@}
    ...
    template<typename FqdnForActionFrameworkT = Aws::String>
    ChangeServerLifeCycleStateResult& WithFqdnForActionFramework(FqdnForActionFrameworkT&& value) { SetFqdnForActionFramework(std::forward<FqdnForActionFrameworkT>(value)); return *this;}
    ///@}
    ...
    template<typename LaunchedInstanceT = LaunchedInstance>
    ChangeServerLifeCycleStateResult& WithLaunchedInstance(LaunchedInstanceT&& value) { SetLaunchedInstance(std::forward<LaunchedInstanceT>(value)); return *this;}
    ///@}
    ...
    template<typename LifeCycleT = LifeCycle>
    ChangeServerLifeCycleStateResult& WithLifeCycle(LifeCycleT&& value) { SetLifeCycle(std::forward<LifeCycleT>(value)); return *this;}
    ///@}
    ...
    inline ChangeServerLifeCycleStateResult& WithReplicationType(ReplicationType value) { SetReplicationType(value); return *this;}
    ///@}
    ...
    template<typename SourcePropertiesT = SourceProperties>
    ChangeServerLifeCycleStateResult& WithSourceProperties(SourcePropertiesT&& value) { SetSourceProperties(std::forward<SourcePropertiesT>(value)); return *this;}
    ///@}
    ...
    template<typename SourceServerIDT = Aws::String>
    ChangeServerLifeCycleStateResult& WithSourceServerID(SourceServerIDT&& value) { SetSourceServerID(std::forward<SourceServerIDT>(value)); return *this;}
    ///@}
    ...
    template<typename TagsT = Aws::Map<Aws::String, Aws::String>>
    ChangeServerLifeCycleStateResult& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
    ...
    template<typename UserProvidedIDT = Aws::String>
    ChangeServerLifeCycleStateResult& WithUserProvidedID(UserProvidedIDT&& value) { SetUserProvidedID(std::forward<UserProvidedIDT>(value)); return *this;}
    ///@}
    ...
    template<typename VcenterClientIDT = Aws::String>
    ChangeServerLifeCycleStateResult& WithVcenterClientID(VcenterClientIDT&& value) { SetVcenterClientID(std::forward<VcenterClientIDT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ChangeServerLifeCycleStateResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
