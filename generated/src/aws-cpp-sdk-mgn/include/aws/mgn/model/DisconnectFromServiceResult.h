...
namespace Model
{
  ...
  public:
     ...
     * <p>Source Server connector action.</p>
     */
    inline DisconnectFromServiceResult& WithConnectorAction(const SourceServerConnectorAction& value) { SetConnectorAction(value); return *this;}

    /**
     * <p>Source Server connector action.</p>
     */
    inline DisconnectFromServiceResult& WithConnectorAction(SourceServerConnectorAction&& value) { SetConnectorAction(std::move(value)); return *this;}
     ...
     * <p>Source server fqdn for action framework.</p>
     */
    inline DisconnectFromServiceResult& WithFqdnForActionFramework(const Aws::String& value) { SetFqdnForActionFramework(value); return *this;}

    /**
     * <p>Source server fqdn for action framework.</p>
     */
    inline DisconnectFromServiceResult& WithFqdnForActionFramework(Aws::String&& value) { SetFqdnForActionFramework(std::move(value)); return *this;}

    /**
     * <p>Source server fqdn for action framework.</p>
     */
    inline DisconnectFromServiceResult& WithFqdnForActionFramework(const char* value) { SetFqdnForActionFramework(value); return *this;}
     ...
     * <p>Source server user provided ID.</p>
     */
    inline DisconnectFromServiceResult& WithUserProvidedID(const Aws::String& value) { SetUserProvidedID(value); return *this;}

    /**
     * <p>Source server user provided ID.</p>
     */
    inline DisconnectFromServiceResult& WithUserProvidedID(Aws::String&& value) { SetUserProvidedID(std::move(value)); return *this;}

    /**
     * <p>Source server user provided ID.</p>
     */
    inline DisconnectFromServiceResult& WithUserProvidedID(const char* value) { SetUserProvidedID(value); return *this;}
    ...
    inline DisconnectFromServiceResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DisconnectFromServiceResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DisconnectFromServiceResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
