...
namespace Model
{
  ...
  public:
     ...
     * <p>Source Server connector action.</p>
     */
    inline MarkAsArchivedResult& WithConnectorAction(const SourceServerConnectorAction& value) { SetConnectorAction(value); return *this;}

    /**
     * <p>Source Server connector action.</p>
     */
    inline MarkAsArchivedResult& WithConnectorAction(SourceServerConnectorAction&& value) { SetConnectorAction(std::move(value)); return *this;}
    ...
    inline MarkAsArchivedResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline MarkAsArchivedResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline MarkAsArchivedResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
