...
class ListExportErrorsRequest : public MgnRequest {
 public:
  ...
  template <typename ExportIDT = Aws::String>
  ListExportErrorsRequest& WithExportID(ExportIDT&& value) {
  ...
  inline ListExportErrorsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListExportErrorsRequest& WithNextToken(NextTokenT&& value) {
