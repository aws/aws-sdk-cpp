...
namespace mgn {
namespace Model {
class UpdateNetworkMigrationMapperSegmentResult {
 public:
  AWS_MGN_API UpdateNetworkMigrationMapperSegmentResult() = default;
  AWS_MGN_API UpdateNetworkMigrationMapperSegmentResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_MGN_API UpdateNetworkMigrationMapperSegmentResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename JobIDT = Aws::String>
  UpdateNetworkMigrationMapperSegmentResult& WithJobID(JobIDT&& value) {
  ...
  template <typename NetworkMigrationExecutionIDT = Aws::String>
  UpdateNetworkMigrationMapperSegmentResult& WithNetworkMigrationExecutionID(NetworkMigrationExecutionIDT&& value) {
  ...
  template <typename NetworkMigrationDefinitionIDT = Aws::String>
  UpdateNetworkMigrationMapperSegmentResult& WithNetworkMigrationDefinitionID(NetworkMigrationDefinitionIDT&& value) {
  ...
  template <typename SegmentIDT = Aws::String>
  UpdateNetworkMigrationMapperSegmentResult& WithSegmentID(SegmentIDT&& value) {
  ...
  ///@{
  /**
   * <p>The category of the network migration segment. A segment groups the network
   * constructs (such as VPCs, subnets, and security groups) that are migrated
   * together. Valid values: <code>WORKLOAD</code>, <code>APPLIANCE</code>.</p>
   */
  ...
  inline UpdateNetworkMigrationMapperSegmentResult& WithSegmentType(NetworkMigrationMapperSegmentType value) {
  ...
  template <typename NameT = Aws::String>
  UpdateNetworkMigrationMapperSegmentResult& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateNetworkMigrationMapperSegmentResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename LogicalIDT = Aws::String>
  UpdateNetworkMigrationMapperSegmentResult& WithLogicalID(LogicalIDT&& value) {
  ...
  template <typename ChecksumT = Checksum>
  UpdateNetworkMigrationMapperSegmentResult& WithChecksum(ChecksumT&& value) {
  ...
  template <typename OutputS3ConfigurationT = S3Configuration>
  UpdateNetworkMigrationMapperSegmentResult& WithOutputS3Configuration(OutputS3ConfigurationT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  UpdateNetworkMigrationMapperSegmentResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  UpdateNetworkMigrationMapperSegmentResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  template <typename ScopeTagsT = Aws::Map<Aws::String, Aws::String>>
  UpdateNetworkMigrationMapperSegmentResult& WithScopeTags(ScopeTagsT&& value) {
    SetScopeTags(std::forward<ScopeTagsT>(value));
    return *this;
  }
  template <typename ScopeTagsKeyT = Aws::String, typename ScopeTagsValueT = Aws::String>
  UpdateNetworkMigrationMapperSegmentResult& AddScopeTags(ScopeTagsKeyT&& key, ScopeTagsValueT&& value) {
    m_scopeTagsHasBeenSet = true;
  ...
  template <typename TargetAccountT = Aws::String>
  UpdateNetworkMigrationMapperSegmentResult& WithTargetAccount(TargetAccountT&& value) {
  ...
  template <typename ReferencedSegmentsT = Aws::Vector<Aws::String>>
  UpdateNetworkMigrationMapperSegmentResult& WithReferencedSegments(ReferencedSegmentsT&& value) {
    SetReferencedSegments(std::forward<ReferencedSegmentsT>(value));
    return *this;
  }
  template <typename ReferencedSegmentsT = Aws::String>
  UpdateNetworkMigrationMapperSegmentResult& AddReferencedSegments(ReferencedSegmentsT&& value) {
    m_referencedSegmentsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  UpdateNetworkMigrationMapperSegmentResult& WithRequestId(RequestIdT&& value) {
