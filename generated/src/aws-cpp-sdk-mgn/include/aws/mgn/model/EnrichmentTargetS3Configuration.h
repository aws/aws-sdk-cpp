...
/**
 * <p>S3 configuration for storing the enriched import file.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/mgn-2020-02-26/EnrichmentTargetS3Configuration">AWS
 * API Reference</a></p>
 */
class EnrichmentTargetS3Configuration {
 public:
  AWS_MGN_API EnrichmentTargetS3Configuration() = default;
