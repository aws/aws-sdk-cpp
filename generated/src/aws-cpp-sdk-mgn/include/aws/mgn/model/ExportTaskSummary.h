...
class ExportTaskSummary {
 public:
  ...
  inline void SetServersCount(long long value) {
    m_serversCountHasBeenSet = true;
    m_serversCount = value;
  }
  ...
  inline void SetWavesCount(long long value) {
    m_wavesCountHasBeenSet = true;
    m_wavesCount = value;
  }
  inline ExportTaskSummary& WithWavesCount(long long value) {
    SetWavesCount(value);
    return *this;
  }
  ///@}
