...
class ListImportsRequestFilters {
 public:
  ...
  void SetImportIDs(ImportIDsT&& value) {
    m_importIDsHasBeenSet = true;
    m_importIDs = std::forward<ImportIDsT>(value);
  }
  template <typename ImportIDsT = Aws::Vector<Aws::String>>
  ListImportsRequestFilters& WithImportIDs(ImportIDsT&& value) {
    SetImportIDs(std::forward<ImportIDsT>(value));
    return *this;
  }
  template <typename ImportIDsT = Aws::String>
  ListImportsRequestFilters& AddImportIDs(ImportIDsT&& value) {
    m_importIDsHasBeenSet = true;
    m_importIDs.emplace_back(std::forward<ImportIDsT>(value));
    return *this;
  }
  ///@}
 private:
