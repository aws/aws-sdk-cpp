...
class CreateLaunchConfigurationTemplateRequest : public MgnRequest {
 public:
  ...
  inline CreateLaunchConfigurationTemplateRequest& WithEnableMapAutoTagging(bool value) {
  ...
  inline CreateLaunchConfigurationTemplateRequest& WithCopyPrivateIp(bool value) {
  ...
  inline CreateLaunchConfigurationTemplateRequest& WithAssociatePublicIpAddress(bool value) {
  ...
  inline CreateLaunchConfigurationTemplateRequest& WithCopyTags(bool value) {
    SetCopyTags(value);
    return *this;
  }
  ///@}
  ...
  inline CreateLaunchConfigurationTemplateRequest& WithBootMode(BootMode value) {
    SetBootMode(value);
    return *this;
  }
  ///@}
  ...
  inline CreateLaunchConfigurationTemplateRequest& WithSmallVolumeMaxSize(long long value) {
  ...
  inline CreateLaunchConfigurationTemplateRequest& WithEnableParametersEncryption(bool value) {
