...
class CreateConnectorResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  CreateConnectorResult& WithArn(ArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateConnectorResult& WithName(NameT&& value) {
  ...
  template <typename SsmCommandConfigT = ConnectorSsmCommandConfig>
  CreateConnectorResult& WithSsmCommandConfig(SsmCommandConfigT&& value) {
  ...
  void SetSsmInstanceID(SsmInstanceIDT&& value) {
    ...
    m_ssmInstanceID = std::forward<SsmInstanceIDT>(value);
  }
  template <typename SsmInstanceIDT = Aws::String>
  CreateConnectorResult& WithSsmInstanceID(SsmInstanceIDT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateConnectorResult& WithTags(TagsT&& value) {
