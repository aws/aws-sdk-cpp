...
namespace Model
{
  ...
  {
  public:
    AWS_MGN_API DeleteSourceServerResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteSourceServerResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
