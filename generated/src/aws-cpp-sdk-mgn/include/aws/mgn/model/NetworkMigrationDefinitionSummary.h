...
/**
 * <p>A summary of a network migration definition.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/mgn-2020-02-26/NetworkMigrationDefinitionSummary">AWS
 * API Reference</a></p>
 */
class NetworkMigrationDefinitionSummary {
 public:
  ...
  inline NetworkMigrationDefinitionSummary& WithSourceEnvironment(SourceEnvironment value) {
