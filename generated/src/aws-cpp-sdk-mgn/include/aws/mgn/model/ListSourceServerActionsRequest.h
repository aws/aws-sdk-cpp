...
class ListSourceServerActionsRequest : public MgnRequest {
 public:
  ...
  template <typename FiltersT = SourceServerActionsRequestFilters>
  ListSourceServerActionsRequest& WithFilters(FiltersT&& value) {
  ...
  inline ListSourceServerActionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListSourceServerActionsRequest& WithNextToken(NextTokenT&& value) {
