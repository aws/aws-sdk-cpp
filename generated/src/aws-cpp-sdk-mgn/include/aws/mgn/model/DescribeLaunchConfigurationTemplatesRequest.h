...
class DescribeLaunchConfigurationTemplatesRequest : public MgnRequest {
 public:
  ...
  void SetLaunchConfigurationTemplateIDs(LaunchConfigurationTemplateIDsT&& value) {
    m_launchConfigurationTemplateIDsHasBeenSet = true;
    m_launchConfigurationTemplateIDs = std::forward<LaunchConfigurationTemplateIDsT>(value);
  }
  template <typename LaunchConfigurationTemplateIDsT = Aws::Vector<Aws::String>>
  DescribeLaunchConfigurationTemplatesRequest& WithLaunchConfigurationTemplateIDs(LaunchConfigurationTemplateIDsT&& value) {
    SetLaunchConfigurationTemplateIDs(std::forward<LaunchConfigurationTemplateIDsT>(value));
    return *this;
  }
  ...
  DescribeLaunchConfigurationTemplatesRequest& AddLaunchConfigurationTemplateIDs(LaunchConfigurationTemplateIDsT&& value) {
    m_launchConfigurationTemplateIDsHasBeenSet = true;
    m_launchConfigurationTemplateIDs.emplace_back(std::forward<LaunchConfigurationTemplateIDsT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeLaunchConfigurationTemplatesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
