...
namespace Model
{
  ...
  {
  public:
    AWS_MGN_API UpdateConnectorResult() = default;
    ...
    template<typename ArnT = Aws::String>
    UpdateConnectorResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    UpdateConnectorResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename SsmCommandConfigT = ConnectorSsmCommandConfig>
    UpdateConnectorResult& WithSsmCommandConfig(SsmCommandConfigT&& value) { SetSsmCommandConfig(std::forward<SsmCommandConfigT>(value)); return *this;}
    ///@}
    ...
    template<typename SsmInstanceIDT = Aws::String>
    UpdateConnectorResult& WithSsmInstanceID(SsmInstanceIDT&& value) { SetSsmInstanceID(std::forward<SsmInstanceIDT>(value)); return *this;}
    ///@}
    ...
    template<typename TagsT = Aws::Map<Aws::String, Aws::String>>
    UpdateConnectorResult& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
    template<typename TagsKeyT = Aws::String, typename TagsValueT = Aws::String>
    UpdateConnectorResult& AddTags(TagsKeyT&& key, TagsValueT&& value) {
