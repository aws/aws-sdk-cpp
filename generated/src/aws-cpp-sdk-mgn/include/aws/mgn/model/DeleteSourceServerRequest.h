...
/**
 */
class DeleteSourceServerRequest : public MgnRequest {
 public:
  AWS_MGN_API DeleteSourceServerRequest() = default;
  ...
  template <typename SourceServerIDT = Aws::String>
  DeleteSourceServerRequest& WithSourceServerID(SourceServerIDT&& value) {
  ...
  template <typename AccountIDT = Aws::String>
  DeleteSourceServerRequest& WithAccountID(AccountIDT&& value) {
