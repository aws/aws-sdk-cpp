...
class ListExportErrorsResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<ExportTaskError>>
  ListExportErrorsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = ExportTaskError>
  ListExportErrorsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListExportErrorsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListExportErrorsResult& WithRequestId(RequestIdT&& value) {
