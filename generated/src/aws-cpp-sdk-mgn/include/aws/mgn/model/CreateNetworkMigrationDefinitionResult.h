...
namespace mgn {
namespace Model {
class CreateNetworkMigrationDefinitionResult {
 public:
  AWS_MGN_API CreateNetworkMigrationDefinitionResult() = default;
  AWS_MGN_API CreateNetworkMigrationDefinitionResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_MGN_API CreateNetworkMigrationDefinitionResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ArnT = Aws::String>
  CreateNetworkMigrationDefinitionResult& WithArn(ArnT&& value) {
  ...
  template <typename NetworkMigrationDefinitionIDT = Aws::String>
  CreateNetworkMigrationDefinitionResult& WithNetworkMigrationDefinitionID(NetworkMigrationDefinitionIDT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateNetworkMigrationDefinitionResult& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateNetworkMigrationDefinitionResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename SourceConfigurationsT = Aws::Vector<SourceConfiguration>>
  CreateNetworkMigrationDefinitionResult& WithSourceConfigurations(SourceConfigurationsT&& value) {
  ...
  CreateNetworkMigrationDefinitionResult& AddSourceConfigurations(SourceConfigurationsT&& value) {
    m_sourceConfigurationsHasBeenSet = true;
  ...
  template <typename TargetS3ConfigurationT = TargetS3Configuration>
  CreateNetworkMigrationDefinitionResult& WithTargetS3Configuration(TargetS3ConfigurationT&& value) {
  ...
  template <typename TargetNetworkT = TargetNetwork>
  CreateNetworkMigrationDefinitionResult& WithTargetNetwork(TargetNetworkT&& value) {
  ...
  inline CreateNetworkMigrationDefinitionResult& WithTargetDeployment(TargetDeployment value) {
  ...
  inline CreateNetworkMigrationDefinitionResult& WithVpcProvisioningStrategy(VpcProvisioningStrategy value) {
  ...
  template <typename CidrMappingsT = Aws::Vector<CidrMapping>>
  CreateNetworkMigrationDefinitionResult& WithCidrMappings(CidrMappingsT&& value) {
    SetCidrMappings(std::forward<CidrMappingsT>(value));
    return *this;
  }
  template <typename CidrMappingsT = CidrMapping>
  CreateNetworkMigrationDefinitionResult& AddCidrMappings(CidrMappingsT&& value) {
    m_cidrMappingsHasBeenSet = true;
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  CreateNetworkMigrationDefinitionResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  CreateNetworkMigrationDefinitionResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateNetworkMigrationDefinitionResult& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsKeyT = Aws::String, typename TagsValueT = Aws::String>
  CreateNetworkMigrationDefinitionResult& AddTags(TagsKeyT&& key, TagsValueT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename ScopeTagsT = Aws::Map<Aws::String, Aws::String>>
  CreateNetworkMigrationDefinitionResult& WithScopeTags(ScopeTagsT&& value) {
    SetScopeTags(std::forward<ScopeTagsT>(value));
    return *this;
  }
  template <typename ScopeTagsKeyT = Aws::String, typename ScopeTagsValueT = Aws::String>
  CreateNetworkMigrationDefinitionResult& AddScopeTags(ScopeTagsKeyT&& key, ScopeTagsValueT&& value) {
    m_scopeTagsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  CreateNetworkMigrationDefinitionResult& WithRequestId(RequestIdT&& value) {
