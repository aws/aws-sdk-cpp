...
namespace Model
{
  ...
  public:
    ...
    template<typename ArnT = Aws::String>
    ArchiveWaveResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename CreationDateTimeT = Aws::String>
    ArchiveWaveResult& WithCreationDateTime(CreationDateTimeT&& value) { SetCreationDateTime(std::forward<CreationDateTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    ArchiveWaveResult& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename LastModifiedDateTimeT = Aws::String>
    ArchiveWaveResult& WithLastModifiedDateTime(LastModifiedDateTimeT&& value) { SetLastModifiedDateTime(std::forward<LastModifiedDateTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    ArchiveWaveResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename TagsT = Aws::Map<Aws::String, Aws::String>>
    ArchiveWaveResult& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
    ...
    template<typename WaveAggregatedStatusT = WaveAggregatedStatus>
    ArchiveWaveResult& WithWaveAggregatedStatus(WaveAggregatedStatusT&& value) { SetWaveAggregatedStatus(std::forward<WaveAggregatedStatusT>(value)); return *this;}
    ///@}
    ...
    template<typename WaveIDT = Aws::String>
    ArchiveWaveResult& WithWaveID(WaveIDT&& value) { SetWaveID(std::forward<WaveIDT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ArchiveWaveResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
