...
namespace Model
{
  ...
  {
  public:
    AWS_MGN_API ListImportsResult() = default;
    ...
    template<typename ItemsT = Aws::Vector<ImportTask>>
    void SetItems(ItemsT&& value) { m_itemsHasBeenSet = true; m_items = std::forward<ItemsT>(value); }
    template<typename ItemsT = Aws::Vector<ImportTask>>
    ListImportsResult& WithItems(ItemsT&& value) { SetItems(std::forward<ItemsT>(value)); return *this;}
    template<typename ItemsT = ImportTask>
    ListImportsResult& AddItems(ItemsT&& value) { m_itemsHasBeenSet = true; m_items.emplace_back(std::forward<ItemsT>(value)); return *this; }
    ///@}
