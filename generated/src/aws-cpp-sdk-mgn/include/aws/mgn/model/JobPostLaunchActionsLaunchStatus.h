...
class JobPostLaunchActionsLaunchStatus {
 public:
  ...
  inline void SetExecutionStatus(PostLaunchActionExecutionStatus value) {
    m_executionStatusHasBeenSet = true;
    m_executionStatus = value;
  }
  inline JobPostLaunchActionsLaunchStatus& WithExecutionStatus(PostLaunchActionExecutionStatus value) {
