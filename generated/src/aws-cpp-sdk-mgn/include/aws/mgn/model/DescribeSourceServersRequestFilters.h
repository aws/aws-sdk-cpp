...
class DescribeSourceServersRequestFilters {
 public:
  ...
  void SetReplicationTypes(ReplicationTypesT&& value) {
    m_replicationTypesHasBeenSet = true;
    m_replicationTypes = std::forward<ReplicationTypesT>(value);
  }
  template <typename ReplicationTypesT = Aws::Vector<ReplicationType>>
  DescribeSourceServersRequestFilters& WithReplicationTypes(ReplicationTypesT&& value) {
    SetReplicationTypes(std::forward<ReplicationTypesT>(value));
    return *this;
  }
  inline DescribeSourceServersRequestFilters& AddReplicationTypes(ReplicationType value) {
    m_replicationTypesHasBeenSet = true;
    m_replicationTypes.push_back(value);
    return *this;
  }
  ///@}
