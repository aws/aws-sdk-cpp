...
/**
 */
class ListNetworkMigrationAnalysisResultsRequest : public MgnRequest {
 public:
  AWS_MGN_API ListNetworkMigrationAnalysisResultsRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "ListNetworkMigrationAnalysisResults"; }
  ...
  template <typename NetworkMigrationExecutionIDT = Aws::String>
  ListNetworkMigrationAnalysisResultsRequest& WithNetworkMigrationExecutionID(NetworkMigrationExecutionIDT&& value) {
  ...
  template <typename NetworkMigrationDefinitionIDT = Aws::String>
  ListNetworkMigrationAnalysisResultsRequest& WithNetworkMigrationDefinitionID(NetworkMigrationDefinitionIDT&& value) {
   ...
   */
  inline const ListNetworkMigrationAnalysisResultsFilters& GetFilters() const { return m_filters; }
  inline bool FiltersHasBeenSet() const { return m_filtersHasBeenSet; }
  template <typename FiltersT = ListNetworkMigrationAnalysisResultsFilters>
  void SetFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
    m_filters = std::forward<FiltersT>(value);
  }
  template <typename FiltersT = ListNetworkMigrationAnalysisResultsFilters>
  ListNetworkMigrationAnalysisResultsRequest& WithFilters(FiltersT&& value) {
  ...
  inline ListNetworkMigrationAnalysisResultsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListNetworkMigrationAnalysisResultsRequest& WithNextToken(NextTokenT&& value) {
 ...
 private:
  ...
  ListNetworkMigrationAnalysisResultsFilters m_filters;
