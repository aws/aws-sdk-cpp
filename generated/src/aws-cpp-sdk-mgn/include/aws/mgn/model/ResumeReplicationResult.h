...
class ResumeReplicationResult {
 public:
  ...
  template <typename SourceServerIDT = Aws::String>
  ResumeReplicationResult& WithSourceServerID(SourceServerIDT&& value) {
  ...
  template <typename ArnT = Aws::String>
  ResumeReplicationResult& WithArn(ArnT&& value) {
  ...
  inline ResumeReplicationResult& WithIsArchived(bool value) {
    SetIsArchived(value);
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  ResumeReplicationResult& WithTags(TagsT&& value) {
  ...
  template <typename LaunchedInstanceT = LaunchedInstance>
  ResumeReplicationResult& WithLaunchedInstance(LaunchedInstanceT&& value) {
  ...
  template <typename DataReplicationInfoT = DataReplicationInfo>
  ResumeReplicationResult& WithDataReplicationInfo(DataReplicationInfoT&& value) {
  ...
  template <typename LifeCycleT = LifeCycle>
  ResumeReplicationResult& WithLifeCycle(LifeCycleT&& value) {
  ...
  template <typename SourcePropertiesT = SourceProperties>
  ResumeReplicationResult& WithSourceProperties(SourcePropertiesT&& value) {
  ...
  inline ResumeReplicationResult& WithReplicationType(ReplicationType value) {
  ...
  template <typename VcenterClientIDT = Aws::String>
  ResumeReplicationResult& WithVcenterClientID(VcenterClientIDT&& value) {
  ...
  template <typename ApplicationIDT = Aws::String>
  ResumeReplicationResult& WithApplicationID(ApplicationIDT&& value) {
  ...
  template <typename UserProvidedIDT = Aws::String>
  ResumeReplicationResult& WithUserProvidedID(UserProvidedIDT&& value) {
  ...
  template <typename FqdnForActionFrameworkT = Aws::String>
  ResumeReplicationResult& WithFqdnForActionFramework(FqdnForActionFrameworkT&& value) {
  ...
  template <typename ConnectorActionT = SourceServerConnectorAction>
  ResumeReplicationResult& WithConnectorAction(ConnectorActionT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ResumeReplicationResult& WithRequestId(RequestIdT&& value) {
