...
namespace Model
{
  ...
  {
  public:
    AWS_MGN_API ResumeReplicationResult() = default;
    ...
    template<typename ApplicationIDT = Aws::String>
    ResumeReplicationResult& WithApplicationID(ApplicationIDT&& value) { SetApplicationID(std::forward<ApplicationIDT>(value)); return *this;}
    ///@}
    ...
    template<typename ArnT = Aws::String>
    ResumeReplicationResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ConnectorActionT = SourceServerConnectorAction>
    ResumeReplicationResult& WithConnectorAction(ConnectorActionT&& value) { SetConnectorAction(std::forward<ConnectorActionT>(value)); return *this;}
    ///@}
    ...
    template<typename DataReplicationInfoT = DataReplicationInfo>
    ResumeReplicationResult& WithDataReplicationInfo(DataReplicationInfoT&& value) { SetDataReplicationInfo(std::forward<DataReplicationInfoT>(value)); return *this;}
    ///@}
    ...
    template<typename FqdnForActionFrameworkT = Aws::String>
    ResumeReplicationResult& WithFqdnForActionFramework(FqdnForActionFrameworkT&& value) { SetFqdnForActionFramework(std::forward<FqdnForActionFrameworkT>(value)); return *this;}
    ///@}
    ...
    template<typename LaunchedInstanceT = LaunchedInstance>
    ResumeReplicationResult& WithLaunchedInstance(LaunchedInstanceT&& value) { SetLaunchedInstance(std::forward<LaunchedInstanceT>(value)); return *this;}
    ///@}
    ...
    template<typename LifeCycleT = LifeCycle>
    ResumeReplicationResult& WithLifeCycle(LifeCycleT&& value) { SetLifeCycle(std::forward<LifeCycleT>(value)); return *this;}
    ///@}
    ...
    inline ResumeReplicationResult& WithReplicationType(ReplicationType value) { SetReplicationType(value); return *this;}
    ///@}
    ...
    template<typename SourcePropertiesT = SourceProperties>
    ResumeReplicationResult& WithSourceProperties(SourcePropertiesT&& value) { SetSourceProperties(std::forward<SourcePropertiesT>(value)); return *this;}
    ///@}
    ...
    template<typename SourceServerIDT = Aws::String>
    ResumeReplicationResult& WithSourceServerID(SourceServerIDT&& value) { SetSourceServerID(std::forward<SourceServerIDT>(value)); return *this;}
    ///@}
    ...
    template<typename TagsT = Aws::Map<Aws::String, Aws::String>>
    ResumeReplicationResult& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
    template<typename TagsKeyT = Aws::String, typename TagsValueT = Aws::String>
    ResumeReplicationResult& AddTags(TagsKeyT&& key, TagsValueT&& value) {
    ...
    template<typename UserProvidedIDT = Aws::String>
    ResumeReplicationResult& WithUserProvidedID(UserProvidedIDT&& value) { SetUserProvidedID(std::forward<UserProvidedIDT>(value)); return *this;}
    ///@}
    ...
    template<typename VcenterClientIDT = Aws::String>
    ResumeReplicationResult& WithVcenterClientID(VcenterClientIDT&& value) { SetVcenterClientID(std::forward<VcenterClientIDT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ResumeReplicationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
