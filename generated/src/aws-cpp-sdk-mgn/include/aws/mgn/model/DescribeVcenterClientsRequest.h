...
/**
 */
class DescribeVcenterClientsRequest : public MgnRequest {
 public:
  AWS_MGN_API DescribeVcenterClientsRequest() = default;
  ...
  inline DescribeVcenterClientsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeVcenterClientsRequest& WithNextToken(NextTokenT&& value) {
