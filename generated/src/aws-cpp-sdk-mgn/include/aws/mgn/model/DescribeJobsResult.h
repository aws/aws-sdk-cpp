...
class DescribeJobsResult {
 public:
  AWS_MGN_API DescribeJobsResult() = default;
  ...
  template <typename ItemsT = Aws::Vector<Job>>
  void SetItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
    m_items = std::forward<ItemsT>(value);
  }
  template <typename ItemsT = Aws::Vector<Job>>
  DescribeJobsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = Job>
  DescribeJobsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeJobsResult& WithNextToken(NextTokenT&& value) {
