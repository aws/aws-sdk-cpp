...
class GetNetworkMigrationDefinitionResult {
 public:
  AWS_MGN_API GetNetworkMigrationDefinitionResult() = default;
  AWS_MGN_API GetNetworkMigrationDefinitionResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_MGN_API GetNetworkMigrationDefinitionResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ArnT = Aws::String>
  GetNetworkMigrationDefinitionResult& WithArn(ArnT&& value) {
  ...
  template <typename NetworkMigrationDefinitionIDT = Aws::String>
  GetNetworkMigrationDefinitionResult& WithNetworkMigrationDefinitionID(NetworkMigrationDefinitionIDT&& value) {
  ...
  template <typename NameT = Aws::String>
  GetNetworkMigrationDefinitionResult& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  GetNetworkMigrationDefinitionResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename SourceConfigurationsT = Aws::Vector<SourceConfiguration>>
  GetNetworkMigrationDefinitionResult& WithSourceConfigurations(SourceConfigurationsT&& value) {
  ...
  GetNetworkMigrationDefinitionResult& AddSourceConfigurations(SourceConfigurationsT&& value) {
    m_sourceConfigurationsHasBeenSet = true;
  ...
  template <typename TargetS3ConfigurationT = TargetS3Configuration>
  GetNetworkMigrationDefinitionResult& WithTargetS3Configuration(TargetS3ConfigurationT&& value) {
  ...
  template <typename TargetNetworkT = TargetNetwork>
  GetNetworkMigrationDefinitionResult& WithTargetNetwork(TargetNetworkT&& value) {
  ...
  inline GetNetworkMigrationDefinitionResult& WithTargetDeployment(TargetDeployment value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  GetNetworkMigrationDefinitionResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  GetNetworkMigrationDefinitionResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  GetNetworkMigrationDefinitionResult& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsKeyT = Aws::String, typename TagsValueT = Aws::String>
  GetNetworkMigrationDefinitionResult& AddTags(TagsKeyT&& key, TagsValueT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename ScopeTagsT = Aws::Map<Aws::String, Aws::String>>
  GetNetworkMigrationDefinitionResult& WithScopeTags(ScopeTagsT&& value) {
    SetScopeTags(std::forward<ScopeTagsT>(value));
    return *this;
  }
  template <typename ScopeTagsKeyT = Aws::String, typename ScopeTagsValueT = Aws::String>
  GetNetworkMigrationDefinitionResult& AddScopeTags(ScopeTagsKeyT&& key, ScopeTagsValueT&& value) {
    m_scopeTagsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetNetworkMigrationDefinitionResult& WithRequestId(RequestIdT&& value) {
