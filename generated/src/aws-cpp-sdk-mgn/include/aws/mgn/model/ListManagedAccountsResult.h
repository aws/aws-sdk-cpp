...
class ListManagedAccountsResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<ManagedAccount>>
  ListManagedAccountsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = ManagedAccount>
  ListManagedAccountsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListManagedAccountsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListManagedAccountsResult& WithRequestId(RequestIdT&& value) {
