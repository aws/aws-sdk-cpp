...
namespace Model
{
  ...
  public:
    ...
    inline UpdateLaunchConfigurationResult& WithBootMode(BootMode value) { SetBootMode(value); return *this;}
    ///@}
    ...
    template<typename MapAutoTaggingMpeIDT = Aws::String>
    UpdateLaunchConfigurationResult& WithMapAutoTaggingMpeID(MapAutoTaggingMpeIDT&& value) { SetMapAutoTaggingMpeID(std::forward<MapAutoTaggingMpeIDT>(value)); return *this;}
    ///@}
    ...
    template<typename PostLaunchActionsT = PostLaunchActions>
    UpdateLaunchConfigurationResult& WithPostLaunchActions(PostLaunchActionsT&& value) { SetPostLaunchActions(std::forward<PostLaunchActionsT>(value)); return *this;}
    ///@}
