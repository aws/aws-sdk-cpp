...
class ListImportErrorsResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<ImportTaskError>>
  ListImportErrorsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = ImportTaskError>
  ListImportErrorsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListImportErrorsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListImportErrorsResult& WithRequestId(RequestIdT&& value) {
