...
class CreateReplicationConfigurationTemplateRequest : public MgnRequest {
 public:
  ...
  ///@{
  /**
   * <p>Request to configure storage during Replication Settings template
   * creation.</p>
   */
  ...
  template <typename StorageConfigurationT = StorageConfiguration>
  CreateReplicationConfigurationTemplateRequest& WithStorageConfiguration(StorageConfigurationT&& value) {
