...
class ListSourceServerActionsResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<SourceServerActionDocument>>
  ListSourceServerActionsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = SourceServerActionDocument>
  ListSourceServerActionsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListSourceServerActionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListSourceServerActionsResult& WithRequestId(RequestIdT&& value) {
