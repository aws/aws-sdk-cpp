...
class ParticipatingServer {
 public:
  ...
  void SetLaunchedEc2InstanceID(LaunchedEc2InstanceIDT&& value) {
    ...
    m_launchedEc2InstanceID = std::forward<LaunchedEc2InstanceIDT>(value);
  }
  template <typename LaunchedEc2InstanceIDT = Aws::String>
  ParticipatingServer& WithLaunchedEc2InstanceID(LaunchedEc2InstanceIDT&& value) {
    SetLaunchedEc2InstanceID(std::forward<LaunchedEc2InstanceIDT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPostLaunchActionsStatus(PostLaunchActionsStatusT&& value) {
    ...
    m_postLaunchActionsStatus = std::forward<PostLaunchActionsStatusT>(value);
  }
  template <typename PostLaunchActionsStatusT = PostLaunchActionsStatus>
  ParticipatingServer& WithPostLaunchActionsStatus(PostLaunchActionsStatusT&& value) {
    SetPostLaunchActionsStatus(std::forward<PostLaunchActionsStatusT>(value));
    return *this;
  }
  ///@}
