...
class DataReplicationInitiationStep {
 public:
  ...
  inline void SetName(DataReplicationInitiationStepName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline DataReplicationInitiationStep& WithName(DataReplicationInitiationStepName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(DataReplicationInitiationStepStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline DataReplicationInitiationStep& WithStatus(DataReplicationInitiationStepStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
