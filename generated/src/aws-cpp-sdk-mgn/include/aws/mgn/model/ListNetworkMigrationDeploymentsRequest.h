...
/**
 */
class ListNetworkMigrationDeploymentsRequest : public MgnRequest {
 public:
  AWS_MGN_API ListNetworkMigrationDeploymentsRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "ListNetworkMigrationDeployments"; }
  ...
  template <typename NetworkMigrationExecutionIDT = Aws::String>
  ListNetworkMigrationDeploymentsRequest& WithNetworkMigrationExecutionID(NetworkMigrationExecutionIDT&& value) {
  ...
  template <typename NetworkMigrationDefinitionIDT = Aws::String>
  ListNetworkMigrationDeploymentsRequest& WithNetworkMigrationDefinitionID(NetworkMigrationDefinitionIDT&& value) {
   ...
   */
  inline const ListNetworkMigrationDeployerJobFilters& GetFilters() const { return m_filters; }
  inline bool FiltersHasBeenSet() const { return m_filtersHasBeenSet; }
  template <typename FiltersT = ListNetworkMigrationDeployerJobFilters>
  void SetFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
    m_filters = std::forward<FiltersT>(value);
  }
  template <typename FiltersT = ListNetworkMigrationDeployerJobFilters>
  ListNetworkMigrationDeploymentsRequest& WithFilters(FiltersT&& value) {
  ...
  inline ListNetworkMigrationDeploymentsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListNetworkMigrationDeploymentsRequest& WithNextToken(NextTokenT&& value) {
 ...
 private:
  ...
  ListNetworkMigrationDeployerJobFilters m_filters;
