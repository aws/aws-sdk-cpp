...
namespace Model
{
  ...
  {
  public:
    AWS_MGN_API PauseReplicationResult() = default;
    ...
    template<typename ApplicationIDT = Aws::String>
    PauseReplicationResult& WithApplicationID(ApplicationIDT&& value) { SetApplicationID(std::forward<ApplicationIDT>(value)); return *this;}
    ///@}
    ...
    template<typename ArnT = Aws::String>
    PauseReplicationResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ConnectorActionT = SourceServerConnectorAction>
    PauseReplicationResult& WithConnectorAction(ConnectorActionT&& value) { SetConnectorAction(std::forward<ConnectorActionT>(value)); return *this;}
    ///@}
    ...
    template<typename DataReplicationInfoT = DataReplicationInfo>
    PauseReplicationResult& WithDataReplicationInfo(DataReplicationInfoT&& value) { SetDataReplicationInfo(std::forward<DataReplicationInfoT>(value)); return *this;}
    ///@}
    ...
    template<typename FqdnForActionFrameworkT = Aws::String>
    PauseReplicationResult& WithFqdnForActionFramework(FqdnForActionFrameworkT&& value) { SetFqdnForActionFramework(std::forward<FqdnForActionFrameworkT>(value)); return *this;}
    ///@}
    ...
    template<typename LaunchedInstanceT = LaunchedInstance>
    PauseReplicationResult& WithLaunchedInstance(LaunchedInstanceT&& value) { SetLaunchedInstance(std::forward<LaunchedInstanceT>(value)); return *this;}
    ///@}
    ...
    template<typename LifeCycleT = LifeCycle>
    PauseReplicationResult& WithLifeCycle(LifeCycleT&& value) { SetLifeCycle(std::forward<LifeCycleT>(value)); return *this;}
    ///@}
    ...
    inline PauseReplicationResult& WithReplicationType(ReplicationType value) { SetReplicationType(value); return *this;}
    ///@}
    ...
    template<typename SourcePropertiesT = SourceProperties>
    PauseReplicationResult& WithSourceProperties(SourcePropertiesT&& value) { SetSourceProperties(std::forward<SourcePropertiesT>(value)); return *this;}
    ///@}
    ...
    template<typename SourceServerIDT = Aws::String>
    PauseReplicationResult& WithSourceServerID(SourceServerIDT&& value) { SetSourceServerID(std::forward<SourceServerIDT>(value)); return *this;}
    ///@}
    ...
    template<typename TagsT = Aws::Map<Aws::String, Aws::String>>
    PauseReplicationResult& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
    template<typename TagsKeyT = Aws::String, typename TagsValueT = Aws::String>
    PauseReplicationResult& AddTags(TagsKeyT&& key, TagsValueT&& value) {
    ...
    template<typename UserProvidedIDT = Aws::String>
    PauseReplicationResult& WithUserProvidedID(UserProvidedIDT&& value) { SetUserProvidedID(std::forward<UserProvidedIDT>(value)); return *this;}
    ///@}
    ...
    template<typename VcenterClientIDT = Aws::String>
    PauseReplicationResult& WithVcenterClientID(VcenterClientIDT&& value) { SetVcenterClientID(std::forward<VcenterClientIDT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    PauseReplicationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
