...
class PauseReplicationResult {
 public:
  ...
  template <typename ApplicationIDT = Aws::String>
  PauseReplicationResult& WithApplicationID(ApplicationIDT&& value) {
  ...
  template <typename ArnT = Aws::String>
  PauseReplicationResult& WithArn(ArnT&& value) {
  ...
  template <typename ConnectorActionT = SourceServerConnectorAction>
  PauseReplicationResult& WithConnectorAction(ConnectorActionT&& value) {
  ...
  template <typename DataReplicationInfoT = DataReplicationInfo>
  PauseReplicationResult& WithDataReplicationInfo(DataReplicationInfoT&& value) {
  ...
  template <typename FqdnForActionFrameworkT = Aws::String>
  PauseReplicationResult& WithFqdnForActionFramework(FqdnForActionFrameworkT&& value) {
  ...
  inline PauseReplicationResult& WithIsArchived(bool value) {
    SetIsArchived(value);
    return *this;
  }
  ///@}
  ...
  template <typename LaunchedInstanceT = LaunchedInstance>
  PauseReplicationResult& WithLaunchedInstance(LaunchedInstanceT&& value) {
  ...
  template <typename LifeCycleT = LifeCycle>
  PauseReplicationResult& WithLifeCycle(LifeCycleT&& value) {
  ...
  inline PauseReplicationResult& WithReplicationType(ReplicationType value) {
  ...
  template <typename SourcePropertiesT = SourceProperties>
  PauseReplicationResult& WithSourceProperties(SourcePropertiesT&& value) {
  ...
  template <typename SourceServerIDT = Aws::String>
  PauseReplicationResult& WithSourceServerID(SourceServerIDT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  PauseReplicationResult& WithTags(TagsT&& value) {
  ...
  template <typename UserProvidedIDT = Aws::String>
  PauseReplicationResult& WithUserProvidedID(UserProvidedIDT&& value) {
  ...
  template <typename VcenterClientIDT = Aws::String>
  PauseReplicationResult& WithVcenterClientID(VcenterClientIDT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  PauseReplicationResult& WithRequestId(RequestIdT&& value) {
