...
class UpdateNetworkMigrationDefinitionResult {
 public:
  ...
  inline UpdateNetworkMigrationDefinitionResult& WithVpcProvisioningStrategy(VpcProvisioningStrategy value) {
  ...
  template <typename CidrMappingsT = Aws::Vector<CidrMapping>>
  UpdateNetworkMigrationDefinitionResult& WithCidrMappings(CidrMappingsT&& value) {
    SetCidrMappings(std::forward<CidrMappingsT>(value));
    return *this;
  }
  template <typename CidrMappingsT = CidrMapping>
  UpdateNetworkMigrationDefinitionResult& AddCidrMappings(CidrMappingsT&& value) {
    m_cidrMappingsHasBeenSet = true;
