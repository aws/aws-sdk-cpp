...
class CreateReplicationConfigurationTemplateResult {
 public:
  ...
  AWS_MGN_API CreateReplicationConfigurationTemplateResult& operator=(
  ...
  inline CreateReplicationConfigurationTemplateResult& WithUseFipsEndpoint(bool value) {
  ...
  inline CreateReplicationConfigurationTemplateResult& WithStoreSnapshotOnLocalZone(bool value) {
