...
namespace Model
{
  ...
  {
  public:
    AWS_MGN_API RemoveSourceServerActionResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    RemoveSourceServerActionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
