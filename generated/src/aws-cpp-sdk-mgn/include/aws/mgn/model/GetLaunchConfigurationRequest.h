...
namespace Model
{
  ...
  /**
   */
  class GetLaunchConfigurationRequest : public MgnRequest
  {
  public:
    AWS_MGN_API GetLaunchConfigurationRequest();
     ...
     * <p>Request to get Launch Configuration information by Account ID.</p>
     */
    inline GetLaunchConfigurationRequest& WithAccountID(const Aws::String& value) { SetAccountID(value); return *this;}

    /**
     * <p>Request to get Launch Configuration information by Account ID.</p>
     */
    inline GetLaunchConfigurationRequest& WithAccountID(Aws::String&& value) { SetAccountID(std::move(value)); return *this;}

    /**
     * <p>Request to get Launch Configuration information by Account ID.</p>
     */
    inline GetLaunchConfigurationRequest& WithAccountID(const char* value) { SetAccountID(value); return *this;}
