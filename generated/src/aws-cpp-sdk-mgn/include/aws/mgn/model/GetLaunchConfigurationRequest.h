...
namespace Model
{
  ...
  {
  public:
    AWS_MGN_API GetLaunchConfigurationRequest() = default;
    ...
    template<typename AccountIDT = Aws::String>
    GetLaunchConfigurationRequest& WithAccountID(AccountIDT&& value) { SetAccountID(std::forward<AccountIDT>(value)); return *this;}
    ///@}
    ...
    template<typename SourceServerIDT = Aws::String>
    GetLaunchConfigurationRequest& WithSourceServerID(SourceServerIDT&& value) { SetSourceServerID(std::forward<SourceServerIDT>(value)); return *this;}
    ///@}
  private:
