...
class TemplateActionsRequestFilters {
 public:
  ...
  void SetActionIDs(ActionIDsT&& value) {
    m_actionIDsHasBeenSet = true;
    m_actionIDs = std::forward<ActionIDsT>(value);
  }
  template <typename ActionIDsT = Aws::Vector<Aws::String>>
  TemplateActionsRequestFilters& WithActionIDs(ActionIDsT&& value) {
    SetActionIDs(std::forward<ActionIDsT>(value));
    return *this;
  }
  template <typename ActionIDsT = Aws::String>
  TemplateActionsRequestFilters& AddActionIDs(ActionIDsT&& value) {
    m_actionIDsHasBeenSet = true;
    m_actionIDs.emplace_back(std::forward<ActionIDsT>(value));
    return *this;
  }
  ///@}
 private:
