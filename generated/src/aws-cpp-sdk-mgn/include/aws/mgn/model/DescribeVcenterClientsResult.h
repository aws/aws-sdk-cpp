...
class DescribeVcenterClientsResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<VcenterClient>>
  DescribeVcenterClientsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = VcenterClient>
  DescribeVcenterClientsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeVcenterClientsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeVcenterClientsResult& WithRequestId(RequestIdT&& value) {
