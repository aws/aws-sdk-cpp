...
#include <aws/mgn/model/ListNetworkMigrationMappingsFilters.h>
...
/**
 */
class ListNetworkMigrationMappingsRequest : public MgnRequest {
 public:
  AWS_MGN_API ListNetworkMigrationMappingsRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "ListNetworkMigrationMappings"; }
  ...
  template <typename NetworkMigrationExecutionIDT = Aws::String>
  ListNetworkMigrationMappingsRequest& WithNetworkMigrationExecutionID(NetworkMigrationExecutionIDT&& value) {
  ...
  template <typename NetworkMigrationDefinitionIDT = Aws::String>
  ListNetworkMigrationMappingsRequest& WithNetworkMigrationDefinitionID(NetworkMigrationDefinitionIDT&& value) {
   ...
   */
  inline const ListNetworkMigrationMappingsFilters& GetFilters() const { return m_filters; }
  inline bool FiltersHasBeenSet() const { return m_filtersHasBeenSet; }
  template <typename FiltersT = ListNetworkMigrationMappingsFilters>
  void SetFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
    m_filters = std::forward<FiltersT>(value);
  }
  template <typename FiltersT = ListNetworkMigrationMappingsFilters>
  ListNetworkMigrationMappingsRequest& WithFilters(FiltersT&& value) {
  ...
  inline ListNetworkMigrationMappingsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListNetworkMigrationMappingsRequest& WithNextToken(NextTokenT&& value) {
 ...
 private:
  ...
  ListNetworkMigrationMappingsFilters m_filters;
