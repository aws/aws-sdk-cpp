...
class ListTemplateActionsResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<TemplateActionDocument>>
  ListTemplateActionsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = TemplateActionDocument>
  ListTemplateActionsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListTemplateActionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListTemplateActionsResult& WithRequestId(RequestIdT&& value) {
