...
/**
 * <p>Filters for listing import file enrichment jobs.</p><p><h3>See Also:</h3>
 * <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/mgn-2020-02-26/ListImportFileEnrichmentsFilters">AWS
 * API Reference</a></p>
 */
class ListImportFileEnrichmentsFilters {
 public:
  AWS_MGN_API ListImportFileEnrichmentsFilters() = default;
  AWS_MGN_API ListImportFileEnrichmentsFilters(Aws::Utils::Json::JsonView jsonValue);
  AWS_MGN_API ListImportFileEnrichmentsFilters& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename JobIDsT = Aws::Vector<Aws::String>>
  ListImportFileEnrichmentsFilters& WithJobIDs(JobIDsT&& value) {
    SetJobIDs(std::forward<JobIDsT>(value));
    return *this;
  }
  template <typename JobIDsT = Aws::String>
  ListImportFileEnrichmentsFilters& AddJobIDs(JobIDsT&& value) {
    m_jobIDsHasBeenSet = true;
