...
namespace Model
{
  ...
  {
  public:
    AWS_MGN_API FinalizeCutoverRequest() = default;
    ...
    template<typename AccountIDT = Aws::String>
    FinalizeCutoverRequest& WithAccountID(AccountIDT&& value) { SetAccountID(std::forward<AccountIDT>(value)); return *this;}
    ///@}
    ...
    template<typename SourceServerIDT = Aws::String>
    FinalizeCutoverRequest& WithSourceServerID(SourceServerIDT&& value) { SetSourceServerID(std::forward<SourceServerIDT>(value)); return *this;}
    ///@}
  private:
