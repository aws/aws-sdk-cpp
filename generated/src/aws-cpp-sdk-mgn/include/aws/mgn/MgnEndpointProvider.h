 ...
 */
using MgnEndpointProviderBase = EndpointProviderBase<MgnClientConfiguration, MgnBuiltInParameters, MgnClientContextParameters>;

using MgnDefaultEpProviderBase = DefaultEndpointProvider<MgnClientConfiguration, MgnBuiltInParameters, MgnClientContextParameters>;
