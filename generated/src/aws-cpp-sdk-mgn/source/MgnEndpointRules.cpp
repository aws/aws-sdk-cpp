...
namespace mgn
{
const size_t MgnEndpointRules::RulesBlobStrLen = 3712;
const size_t MgnEndpointRules::RulesBlobSize = 3713;
...
't','p','s',':','/','/','m','g','n','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i',
