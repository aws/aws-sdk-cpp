...
namespace mgn
{
const size_t MgnEndpointRules::RulesBlobStrLen = 3442;
const size_t MgnEndpointRules::RulesBlobSize = 3443;
...
'"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','m','g','n','.','{','R','e','g','i','o',
