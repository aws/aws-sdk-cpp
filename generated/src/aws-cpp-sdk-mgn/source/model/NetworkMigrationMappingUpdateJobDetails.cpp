...
#include <aws/mgn/model/NetworkMigrationMappingUpdateJobDetails.h>
...
NetworkMigrationMappingUpdateJobDetails::NetworkMigrationMappingUpdateJobDetails(JsonView jsonValue) { *this = jsonValue; }

NetworkMigrationMappingUpdateJobDetails& NetworkMigrationMappingUpdateJobDetails::operator=(JsonView jsonValue) {
...
JsonValue NetworkMigrationMappingUpdateJobDetails::Jsonize() const {
  JsonValue payload;
