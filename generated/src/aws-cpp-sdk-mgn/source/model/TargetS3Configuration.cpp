...
TargetS3Configuration::TargetS3Configuration(JsonView jsonValue) { *this = jsonValue; }

TargetS3Configuration& TargetS3Configuration::operator=(JsonView jsonValue) {
...
JsonValue TargetS3Configuration::Jsonize() const {
  JsonValue payload;
