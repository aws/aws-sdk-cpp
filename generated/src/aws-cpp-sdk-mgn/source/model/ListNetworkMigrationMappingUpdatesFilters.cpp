...
ListNetworkMigrationMappingUpdatesFilters::ListNetworkMigrationMappingUpdatesFilters(JsonView jsonValue) { *this = jsonValue; }

ListNetworkMigrationMappingUpdatesFilters& ListNetworkMigrationMappingUpdatesFilters::operator=(JsonView jsonValue) {
...
JsonValue ListNetworkMigrationMappingUpdatesFilters::Jsonize() const {
  JsonValue payload;
