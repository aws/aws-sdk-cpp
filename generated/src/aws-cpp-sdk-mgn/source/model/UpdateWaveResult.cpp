...
UpdateWaveResult::UpdateWaveResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

UpdateWaveResult& UpdateWaveResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
