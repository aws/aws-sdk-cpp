...
ListImportFileEnrichmentsFilters::ListImportFileEnrichmentsFilters(JsonView jsonValue) { *this = jsonValue; }

ListImportFileEnrichmentsFilters& ListImportFileEnrichmentsFilters::operator=(JsonView jsonValue) {
...
JsonValue ListImportFileEnrichmentsFilters::Jsonize() const {
  JsonValue payload;
