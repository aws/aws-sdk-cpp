...
UnarchiveApplicationResult::UnarchiveApplicationResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

UnarchiveApplicationResult& UnarchiveApplicationResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
