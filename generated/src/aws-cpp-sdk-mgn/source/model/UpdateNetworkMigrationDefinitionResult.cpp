...
UpdateNetworkMigrationDefinitionResult::UpdateNetworkMigrationDefinitionResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

UpdateNetworkMigrationDefinitionResult& UpdateNetworkMigrationDefinitionResult::operator=(
