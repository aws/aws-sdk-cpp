...
ListNetworkMigrationCodeGenerationsFilters::ListNetworkMigrationCodeGenerationsFilters(JsonView jsonValue) { *this = jsonValue; }

ListNetworkMigrationCodeGenerationsFilters& ListNetworkMigrationCodeGenerationsFilters::operator=(JsonView jsonValue) {
...
JsonValue ListNetworkMigrationCodeGenerationsFilters::Jsonize() const {
  JsonValue payload;
