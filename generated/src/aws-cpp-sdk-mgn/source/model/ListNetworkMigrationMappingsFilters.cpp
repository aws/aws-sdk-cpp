...
ListNetworkMigrationMappingsFilters::ListNetworkMigrationMappingsFilters(JsonView jsonValue) { *this = jsonValue; }

ListNetworkMigrationMappingsFilters& ListNetworkMigrationMappingsFilters::operator=(JsonView jsonValue) {
...
JsonValue ListNetworkMigrationMappingsFilters::Jsonize() const {
  JsonValue payload;
