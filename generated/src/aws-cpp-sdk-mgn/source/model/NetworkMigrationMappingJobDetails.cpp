...
#include <aws/mgn/model/NetworkMigrationMappingJobDetails.h>
...
NetworkMigrationMappingJobDetails::NetworkMigrationMappingJobDetails(JsonView jsonValue) { *this = jsonValue; }

NetworkMigrationMappingJobDetails& NetworkMigrationMappingJobDetails::operator=(JsonView jsonValue) {
...
JsonValue NetworkMigrationMappingJobDetails::Jsonize() const {
  JsonValue payload;
