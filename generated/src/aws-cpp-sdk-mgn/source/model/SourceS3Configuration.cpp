...
SourceS3Configuration::SourceS3Configuration(JsonView jsonValue) { *this = jsonValue; }

SourceS3Configuration& SourceS3Configuration::operator=(JsonView jsonValue) {
...
JsonValue SourceS3Configuration::Jsonize() const {
  JsonValue payload;
