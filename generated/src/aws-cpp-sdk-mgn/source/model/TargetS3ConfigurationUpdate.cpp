...
TargetS3ConfigurationUpdate::TargetS3ConfigurationUpdate(JsonView jsonValue) { *this = jsonValue; }

TargetS3ConfigurationUpdate& TargetS3ConfigurationUpdate::operator=(JsonView jsonValue) {
...
JsonValue TargetS3ConfigurationUpdate::Jsonize() const {
  JsonValue payload;
