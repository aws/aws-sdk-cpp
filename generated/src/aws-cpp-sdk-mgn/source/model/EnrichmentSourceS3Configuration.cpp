...
EnrichmentSourceS3Configuration::EnrichmentSourceS3Configuration(JsonView jsonValue) { *this = jsonValue; }

EnrichmentSourceS3Configuration& EnrichmentSourceS3Configuration::operator=(JsonView jsonValue) {
...
JsonValue EnrichmentSourceS3Configuration::Jsonize() const {
  JsonValue payload;
