...
NetworkMigrationAnalysisJobDetails::NetworkMigrationAnalysisJobDetails(JsonView jsonValue) { *this = jsonValue; }

NetworkMigrationAnalysisJobDetails& NetworkMigrationAnalysisJobDetails::operator=(JsonView jsonValue) {
...
JsonValue NetworkMigrationAnalysisJobDetails::Jsonize() const {
  JsonValue payload;
