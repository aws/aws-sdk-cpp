...
EnrichmentTargetS3Configuration::EnrichmentTargetS3Configuration(JsonView jsonValue) { *this = jsonValue; }

EnrichmentTargetS3Configuration& EnrichmentTargetS3Configuration::operator=(JsonView jsonValue) {
...
JsonValue EnrichmentTargetS3Configuration::Jsonize() const {
  JsonValue payload;
