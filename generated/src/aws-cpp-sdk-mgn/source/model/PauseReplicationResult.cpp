...
PauseReplicationResult::PauseReplicationResult() : 
    m_isArchived(false),
    m_replicationType(ReplicationType::NOT_SET)
{
}

PauseReplicationResult::PauseReplicationResult(const Aws::AmazonWebServiceResult<JsonValue>& result) : 
    m_isArchived(false),
    m_replicationType(ReplicationType::NOT_SET)
{
  *this = result;
...
PauseReplicationResult& PauseReplicationResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
