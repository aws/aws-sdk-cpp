...
TargetNetworkUpdate::TargetNetworkUpdate(JsonView jsonValue) { *this = jsonValue; }

TargetNetworkUpdate& TargetNetworkUpdate::operator=(JsonView jsonValue) {
...
JsonValue TargetNetworkUpdate::Jsonize() const {
  JsonValue payload;
