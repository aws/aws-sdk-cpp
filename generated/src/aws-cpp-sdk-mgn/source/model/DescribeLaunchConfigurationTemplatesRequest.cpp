...
Aws::String DescribeLaunchConfigurationTemplatesRequest::SerializePayload() const {
  ...
  if (m_launchConfigurationTemplateIDsHasBeenSet) {
    ...
    for (unsigned launchConfigurationTemplateIDsIndex = 0;
         launchConfigurationTemplateIDsIndex < launchConfigurationTemplateIDsJsonList.GetLength(); ++launchConfigurationTemplateIDsIndex) {
      launchConfigurationTemplateIDsJsonList[launchConfigurationTemplateIDsIndex].AsString(
          m_launchConfigurationTemplateIDs[launchConfigurationTemplateIDsIndex]);
    }
