...
CreateNetworkMigrationDefinitionResult::CreateNetworkMigrationDefinitionResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

CreateNetworkMigrationDefinitionResult& CreateNetworkMigrationDefinitionResult::operator=(
