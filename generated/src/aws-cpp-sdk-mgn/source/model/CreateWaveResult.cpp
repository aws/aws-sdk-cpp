...
CreateWaveResult::CreateWaveResult() : 
    m_isArchived(false)
{
}

CreateWaveResult::CreateWaveResult(const Aws::AmazonWebServiceResult<JsonValue>& result) : 
    m_isArchived(false)
{
  *this = result;
}

CreateWaveResult& CreateWaveResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
