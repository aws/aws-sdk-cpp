...
ListNetworkMigrationDeployerJobFilters::ListNetworkMigrationDeployerJobFilters(JsonView jsonValue) { *this = jsonValue; }

ListNetworkMigrationDeployerJobFilters& ListNetworkMigrationDeployerJobFilters::operator=(JsonView jsonValue) {
...
JsonValue ListNetworkMigrationDeployerJobFilters::Jsonize() const {
  JsonValue payload;
