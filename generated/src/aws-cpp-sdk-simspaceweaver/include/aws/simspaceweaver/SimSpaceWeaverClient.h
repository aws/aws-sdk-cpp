...
class AWS_SIMSPACEWEAVER_API SimSpaceWeaverClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  SimSpaceWeaverClient(const Aws::SimSpaceWeaver::SimSpaceWeaverClientConfiguration& clientConfiguration =
  ...
  SimSpaceWeaverClient(const Aws::Auth::AWSCredentials& credentials,
                       std::shared_ptr<SimSpaceWeaverEndpointProviderBase> endpointProvider = nullptr,
                       const Aws::SimSpaceWeaver::SimSpaceWeaverClientConfiguration& clientConfiguration =
                           Aws::SimSpaceWeaver::SimSpaceWeaverClientConfiguration());
  ...
  /**
   * A Callable wrapper for DeleteSimulation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteSimulation that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteSimulationRequestT = Model::DeleteSimulationRequest>
  void DeleteSimulationAsync(const DeleteSimulationRequestT& request, const DeleteSimulationResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeSimulation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeSimulation that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeSimulationRequestT = Model::DescribeSimulationRequest>
  void DescribeSimulationAsync(const DescribeSimulationRequestT& request, const DescribeSimulationResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListSimulations that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListSimulationsRequestT = Model::ListSimulationsRequest>
  void ListSimulationsAsync(const ListSimulationsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const ListSimulationsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for StartApp that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StartAppRequestT = Model::StartAppRequest>
  void StartAppAsync(const StartAppRequestT& request, const StartAppResponseReceivedHandler& handler,
                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StartClock that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StartClockRequestT = Model::StartClockRequest>
  void StartClockAsync(const StartClockRequestT& request, const StartClockResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StartSimulation that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StartSimulationRequestT = Model::StartSimulationRequest>
  void StartSimulationAsync(const StartSimulationRequestT& request, const StartSimulationResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StopApp that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StopAppRequestT = Model::StopAppRequest>
  void StopAppAsync(const StopAppRequestT& request, const StopAppResponseReceivedHandler& handler,
                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StopClock that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StopClockRequestT = Model::StopClockRequest>
  void StopClockAsync(const StopClockRequestT& request, const StopClockResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StopSimulation that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StopSimulationRequestT = Model::StopSimulationRequest>
  void StopSimulationAsync(const StopSimulationRequestT& request, const StopSimulationResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
