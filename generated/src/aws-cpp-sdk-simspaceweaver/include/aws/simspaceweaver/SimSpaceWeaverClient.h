...
namespace SimSpaceWeaver
{
   ...
   */
  class AWS_SIMSPACEWEAVER_API SimSpaceWeaverClient : Aws::Client::ClientWithAsyncTemplateMethods<SimSpaceWeaverClient>,
    smithy::client::AwsSmithyClientT<Aws::SimSpaceWeaver::SERVICE_NAME,
