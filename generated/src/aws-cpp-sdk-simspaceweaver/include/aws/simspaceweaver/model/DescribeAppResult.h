...
class DescribeAppResult {
 public:
  ...
  inline void SetStatus(SimulationAppStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline DescribeAppResult& WithStatus(SimulationAppStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTargetStatus(SimulationAppTargetStatus value) {
    m_targetStatusHasBeenSet = true;
    m_targetStatus = value;
  }
  inline DescribeAppResult& WithTargetStatus(SimulationAppTargetStatus value) {
