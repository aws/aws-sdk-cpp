...
class LogDestination {
 public:
  ...
  void SetCloudWatchLogsLogGroup(CloudWatchLogsLogGroupT&& value) {
    m_cloudWatchLogsLogGroupHasBeenSet = true;
    m_cloudWatchLogsLogGroup = std::forward<CloudWatchLogsLogGroupT>(value);
  }
  template <typename CloudWatchLogsLogGroupT = CloudWatchLogsLogGroup>
  LogDestination& WithCloudWatchLogsLogGroup(CloudWatchLogsLogGroupT&& value) {
    SetCloudWatchLogsLogGroup(std::forward<CloudWatchLogsLogGroupT>(value));
    return *this;
  }
  ///@}
 private:
