...
class SimulationAppEndpointInfo {
 public:
  ...
  void SetIngressPortMappings(IngressPortMappingsT&& value) {
    ...
    m_ingressPortMappings = std::forward<IngressPortMappingsT>(value);
  }
  template <typename IngressPortMappingsT = Aws::Vector<SimulationAppPortMapping>>
  SimulationAppEndpointInfo& WithIngressPortMappings(IngressPortMappingsT&& value) {
    SetIngressPortMappings(std::forward<IngressPortMappingsT>(value));
    return *this;
  }
  ...
  SimulationAppEndpointInfo& AddIngressPortMappings(IngressPortMappingsT&& value) {
    m_ingressPortMappingsHasBeenSet = true;
    m_ingressPortMappings.emplace_back(std::forward<IngressPortMappingsT>(value));
    return *this;
  }
  ///@}
 private:
