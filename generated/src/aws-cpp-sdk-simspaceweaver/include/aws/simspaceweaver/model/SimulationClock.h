...
class SimulationClock {
 public:
  ...
  inline void SetStatus(ClockStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline SimulationClock& WithStatus(ClockStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTargetStatus(ClockTargetStatus value) {
    m_targetStatusHasBeenSet = true;
    m_targetStatus = value;
  }
  inline SimulationClock& WithTargetStatus(ClockTargetStatus value) {
