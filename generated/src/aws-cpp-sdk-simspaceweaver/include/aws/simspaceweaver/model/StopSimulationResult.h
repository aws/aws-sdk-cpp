...
namespace Model
{
  ...
  {
  public:
    AWS_SIMSPACEWEAVER_API StopSimulationResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    StopSimulationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
