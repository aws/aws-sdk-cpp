...
class DescribeSimulationResult {
 public:
  ...
  void SetLiveSimulationState(LiveSimulationStateT&& value) {
    ...
    m_liveSimulationState = std::forward<LiveSimulationStateT>(value);
  }
  template <typename LiveSimulationStateT = LiveSimulationState>
  DescribeSimulationResult& WithLiveSimulationState(LiveSimulationStateT&& value) {
    SetLiveSimulationState(std::forward<LiveSimulationStateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMaximumDuration(MaximumDurationT&& value) {
    ...
    m_maximumDuration = std::forward<MaximumDurationT>(value);
  }
  template <typename MaximumDurationT = Aws::String>
  DescribeSimulationResult& WithMaximumDuration(MaximumDurationT&& value) {
    SetMaximumDuration(std::forward<MaximumDurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSchemaS3Location(SchemaS3LocationT&& value) {
    ...
    m_schemaS3Location = std::forward<SchemaS3LocationT>(value);
  }
  template <typename SchemaS3LocationT = S3Location>
  DescribeSimulationResult& WithSchemaS3Location(SchemaS3LocationT&& value) {
    SetSchemaS3Location(std::forward<SchemaS3LocationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSnapshotS3Location(SnapshotS3LocationT&& value) {
    ...
    m_snapshotS3Location = std::forward<SnapshotS3LocationT>(value);
  }
  template <typename SnapshotS3LocationT = S3Location>
  DescribeSimulationResult& WithSnapshotS3Location(SnapshotS3LocationT&& value) {
    SetSnapshotS3Location(std::forward<SnapshotS3LocationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStartError(StartErrorT&& value) {
    ...
    m_startError = std::forward<StartErrorT>(value);
  }
  template <typename StartErrorT = Aws::String>
  DescribeSimulationResult& WithStartError(StartErrorT&& value) {
    SetStartError(std::forward<StartErrorT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeSimulationResult& WithStatus(SimulationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeSimulationResult& WithTargetStatus(SimulationTargetStatus value) {
