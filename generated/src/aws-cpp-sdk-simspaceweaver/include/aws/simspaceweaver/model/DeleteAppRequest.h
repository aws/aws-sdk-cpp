...
namespace Model
{
  ...
  /**
   */
  class DeleteAppRequest : public SimSpaceWeaverRequest
  {
  public:
    ...
    template<typename AppT = Aws::String>
    DeleteAppRequest& WithApp(AppT&& value) { SetApp(std::forward<AppT>(value)); return *this;}
    ///@}
    ...
    template<typename DomainT = Aws::String>
    DeleteAppRequest& WithDomain(DomainT&& value) { SetDomain(std::forward<DomainT>(value)); return *this;}
    ///@}
    ...
    template<typename SimulationT = Aws::String>
    DeleteAppRequest& WithSimulation(SimulationT&& value) { SetSimulation(std::forward<SimulationT>(value)); return *this;}
    ///@}
  private:
