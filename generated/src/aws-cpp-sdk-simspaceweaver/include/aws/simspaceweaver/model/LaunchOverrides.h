...
class LaunchOverrides {
 public:
  ...
  void SetLaunchCommands(LaunchCommandsT&& value) {
    ...
    m_launchCommands = std::forward<LaunchCommandsT>(value);
  }
  template <typename LaunchCommandsT = Aws::Vector<Aws::String>>
  LaunchOverrides& WithLaunchCommands(LaunchCommandsT&& value) {
    SetLaunchCommands(std::forward<LaunchCommandsT>(value));
    return *this;
  }
  template <typename LaunchCommandsT = Aws::String>
  LaunchOverrides& AddLaunchCommands(LaunchCommandsT&& value) {
    m_launchCommandsHasBeenSet = true;
    m_launchCommands.emplace_back(std::forward<LaunchCommandsT>(value));
    return *this;
  }
  ///@}
 private:
