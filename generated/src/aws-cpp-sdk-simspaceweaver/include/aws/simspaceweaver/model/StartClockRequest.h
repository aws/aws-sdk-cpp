...
namespace Model
{
  ...
  {
  public:
    AWS_SIMSPACEWEAVER_API StartClockRequest() = default;
    ...
    template<typename SimulationT = Aws::String>
    StartClockRequest& WithSimulation(SimulationT&& value) { SetSimulation(std::forward<SimulationT>(value)); return *this;}
    ///@}
  private:
