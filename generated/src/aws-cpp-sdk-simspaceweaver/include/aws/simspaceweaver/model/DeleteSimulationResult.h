...
namespace Model
{
  ...
  public:
    ...
    inline DeleteSimulationResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeleteSimulationResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeleteSimulationResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
