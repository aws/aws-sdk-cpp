...
namespace Model
{
  ...
  {
  public:
    AWS_SIMSPACEWEAVER_API DeleteSimulationResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteSimulationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
