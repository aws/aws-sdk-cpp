...
namespace Model
{
  ...
  public:
    ...
    inline StartClockResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline StartClockResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline StartClockResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
