...
public:
  ...
  SimSpaceWeaverError(const Aws::Client::AWSError<SimSpaceWeaverErrors>& rhs) : Aws::Client::AWSError<SimSpaceWeaverErrors>(rhs) {}
  SimSpaceWeaverError(Aws::Client::AWSError<SimSpaceWeaverErrors>&& rhs) : Aws::Client::AWSError<SimSpaceWeaverErrors>(rhs) {}
