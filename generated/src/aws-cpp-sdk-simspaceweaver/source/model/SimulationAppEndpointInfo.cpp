...
SimulationAppEndpointInfo::SimulationAppEndpointInfo(JsonView jsonValue) { *this = jsonValue; }
...
SimulationAppEndpointInfo& SimulationAppEndpointInfo::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("IngressPortMappings")) {
    ...
    for (unsigned ingressPortMappingsIndex = 0; ingressPortMappingsIndex < ingressPortMappingsJsonList.GetLength();
         ++ingressPortMappingsIndex) {
