...
'"','h','t','t','p','s',':','/','/','s','i','m','s','p','a','c','e','w','e','a','v','e','r','-','f',
...
's','i','m','s','p','a','c','e','w','e','a','v','e','r','-','f','i','p','s','.','{','R','e','g','i',
...
'c','e','w','e','a','v','e','r','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t',
...
const char* SimSpaceWeaverEndpointRules::GetRulesBlob()
{
