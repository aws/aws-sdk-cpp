...
class LicenseConfigurationRequest {
 public:
  ...
  AWS_WORKSPACESINSTANCES_API LicenseConfigurationRequest(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_WORKSPACESINSTANCES_API LicenseConfigurationRequest& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
