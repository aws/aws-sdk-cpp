...
class EnaSrdSpecificationRequest {
 public:
  ...
  AWS_WORKSPACESINSTANCES_API EnaSrdSpecificationRequest(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_WORKSPACESINSTANCES_API EnaSrdSpecificationRequest& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
