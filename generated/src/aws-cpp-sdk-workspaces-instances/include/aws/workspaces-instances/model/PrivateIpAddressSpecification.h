...
class PrivateIpAddressSpecification {
 public:
  ...
  AWS_WORKSPACESINSTANCES_API PrivateIpAddressSpecification(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_WORKSPACESINSTANCES_API PrivateIpAddressSpecification& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline PrivateIpAddressSpecification& WithPrimary(bool value) {
    SetPrimary(value);
    return *this;
  }
  ///@}
