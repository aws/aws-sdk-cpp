...
class CapacityReservationSpecification {
 public:
  ...
  AWS_WORKSPACESINSTANCES_API CapacityReservationSpecification(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_WORKSPACESINSTANCES_API CapacityReservationSpecification& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline void SetCapacityReservationPreference(CapacityReservationPreferenceEnum value) {
    m_capacityReservationPreferenceHasBeenSet = true;
    m_capacityReservationPreference = value;
  }
  inline CapacityReservationSpecification& WithCapacityReservationPreference(CapacityReservationPreferenceEnum value) {
