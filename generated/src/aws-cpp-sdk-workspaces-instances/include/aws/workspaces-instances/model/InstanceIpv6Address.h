...
class InstanceIpv6Address {
 public:
  ...
  AWS_WORKSPACESINSTANCES_API InstanceIpv6Address(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_WORKSPACESINSTANCES_API InstanceIpv6Address& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
