...
class PrivateDnsNameOptionsRequest {
 public:
  ...
  AWS_WORKSPACESINSTANCES_API PrivateDnsNameOptionsRequest(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_WORKSPACESINSTANCES_API PrivateDnsNameOptionsRequest& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline void SetHostnameType(HostnameTypeEnum value) {
    m_hostnameTypeHasBeenSet = true;
    m_hostnameType = value;
  }
  inline PrivateDnsNameOptionsRequest& WithHostnameType(HostnameTypeEnum value) {
    SetHostnameType(value);
    return *this;
  }
  ///@}
  ...
  inline PrivateDnsNameOptionsRequest& WithEnableResourceNameDnsARecord(bool value) {
  ...
  inline PrivateDnsNameOptionsRequest& WithEnableResourceNameDnsAAAARecord(bool value) {
