...
class ListWorkspaceInstancesRequest : public WorkspacesInstancesRequest {
 public:
  ...
  void SetProvisionStates(ProvisionStatesT&& value) {
    m_provisionStatesHasBeenSet = true;
    m_provisionStates = std::forward<ProvisionStatesT>(value);
  }
  template <typename ProvisionStatesT = Aws::Vector<ProvisionStateEnum>>
  ListWorkspaceInstancesRequest& WithProvisionStates(ProvisionStatesT&& value) {
    SetProvisionStates(std::forward<ProvisionStatesT>(value));
    return *this;
  }
  inline ListWorkspaceInstancesRequest& AddProvisionStates(ProvisionStateEnum value) {
    m_provisionStatesHasBeenSet = true;
    m_provisionStates.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline ListWorkspaceInstancesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListWorkspaceInstancesRequest& WithNextToken(NextTokenT&& value) {
