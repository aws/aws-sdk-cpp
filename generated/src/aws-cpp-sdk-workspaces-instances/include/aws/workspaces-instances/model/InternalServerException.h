...
/**
 * <p>Indicates an unexpected server-side error occurred.</p><p><h3>See Also:</h3>
 * <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/workspaces-instances-2022-07-26/InternalServerException">AWS
 * API Reference</a></p>
 */
