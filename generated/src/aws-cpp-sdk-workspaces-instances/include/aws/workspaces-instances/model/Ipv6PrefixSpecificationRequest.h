...
class Ipv6PrefixSpecificationRequest {
 public:
  ...
  AWS_WORKSPACESINSTANCES_API Ipv6PrefixSpecificationRequest(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_WORKSPACESINSTANCES_API Ipv6PrefixSpecificationRequest& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  void SetIpv6Prefix(Ipv6PrefixT&& value) {
    ...
    m_ipv6Prefix = std::forward<Ipv6PrefixT>(value);
  }
  template <typename Ipv6PrefixT = Aws::String>
  Ipv6PrefixSpecificationRequest& WithIpv6Prefix(Ipv6PrefixT&& value) {
    SetIpv6Prefix(std::forward<Ipv6PrefixT>(value));
    return *this;
  }
  ///@}
 private:
