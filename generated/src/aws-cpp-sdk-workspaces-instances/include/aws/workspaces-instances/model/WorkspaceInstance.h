...
class WorkspaceInstance {
 public:
  ...
  AWS_WORKSPACESINSTANCES_API WorkspaceInstance(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_WORKSPACESINSTANCES_API WorkspaceInstance& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline WorkspaceInstance& WithProvisionState(ProvisionStateEnum value) {
  ...
  template <typename WorkspaceInstanceIdT = Aws::String>
  WorkspaceInstance& WithWorkspaceInstanceId(WorkspaceInstanceIdT&& value) {
  ...
  template <typename EC2ManagedInstanceT = EC2ManagedInstance>
  WorkspaceInstance& WithEC2ManagedInstance(EC2ManagedInstanceT&& value) {
