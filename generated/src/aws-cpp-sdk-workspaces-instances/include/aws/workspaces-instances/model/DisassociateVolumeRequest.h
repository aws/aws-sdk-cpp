...
class DisassociateVolumeRequest : public WorkspacesInstancesRequest {
 public:
  ...
  template <typename DeviceT = Aws::String>
  DisassociateVolumeRequest& WithDevice(DeviceT&& value) {
  ...
  inline void SetDisassociateMode(DisassociateModeEnum value) {
    m_disassociateModeHasBeenSet = true;
    m_disassociateMode = value;
  }
  inline DisassociateVolumeRequest& WithDisassociateMode(DisassociateModeEnum value) {
    SetDisassociateMode(value);
    return *this;
  }
  ///@}
 private:
