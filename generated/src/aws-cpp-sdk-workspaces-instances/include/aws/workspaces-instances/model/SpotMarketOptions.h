...
class SpotMarketOptions {
 public:
  ...
  AWS_WORKSPACESINSTANCES_API SpotMarketOptions(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_WORKSPACESINSTANCES_API SpotMarketOptions& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
   ...
   */
  inline int64_t GetBlockDurationMinutes() const { return m_blockDurationMinutes; }
  inline bool BlockDurationMinutesHasBeenSet() const { return m_blockDurationMinutesHasBeenSet; }
  inline void SetBlockDurationMinutes(int64_t value) {
    m_blockDurationMinutesHasBeenSet = true;
    m_blockDurationMinutes = value;
  }
  inline SpotMarketOptions& WithBlockDurationMinutes(int64_t value) {
  ...
  inline void SetInstanceInterruptionBehavior(InstanceInterruptionBehaviorEnum value) {
    m_instanceInterruptionBehaviorHasBeenSet = true;
    m_instanceInterruptionBehavior = value;
  }
  inline SpotMarketOptions& WithInstanceInterruptionBehavior(InstanceInterruptionBehaviorEnum value) {
  ...
  inline void SetSpotInstanceType(SpotInstanceTypeEnum value) {
    m_spotInstanceTypeHasBeenSet = true;
    m_spotInstanceType = value;
  }
  inline SpotMarketOptions& WithSpotInstanceType(SpotInstanceTypeEnum value) {
  ...
  void SetValidUntilUtc(ValidUntilUtcT&& value) {
    ...
    m_validUntilUtc = std::forward<ValidUntilUtcT>(value);
  }
  template <typename ValidUntilUtcT = Aws::Utils::DateTime>
  SpotMarketOptions& WithValidUntilUtc(ValidUntilUtcT&& value) {
    SetValidUntilUtc(std::forward<ValidUntilUtcT>(value));
    return *this;
  }
  ///@}
 private:
  int64_t m_blockDurationMinutes{0};
