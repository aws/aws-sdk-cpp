...
class BlockDeviceMappingRequest {
 public:
  ...
  AWS_WORKSPACESINSTANCES_API BlockDeviceMappingRequest(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_WORKSPACESINSTANCES_API BlockDeviceMappingRequest& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
