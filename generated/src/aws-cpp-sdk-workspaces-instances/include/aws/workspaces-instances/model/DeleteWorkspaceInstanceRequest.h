...
/**
 * <p>The WorkSpace to delete</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/workspaces-instances-2022-07-26/DeleteWorkspaceInstanceRequest">AWS
 * API Reference</a></p>
 */
class DeleteWorkspaceInstanceRequest : public WorkspacesInstancesRequest {
 public:
  AWS_WORKSPACESINSTANCES_API DeleteWorkspaceInstanceRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "DeleteWorkspaceInstance"; }
  ...
  template <typename WorkspaceInstanceIdT = Aws::String>
  DeleteWorkspaceInstanceRequest& WithWorkspaceInstanceId(WorkspaceInstanceIdT&& value) {
