...
class ListTagsForResourceResult {
 public:
  ...
  AWS_WORKSPACESINSTANCES_API ListTagsForResourceResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_WORKSPACESINSTANCES_API ListTagsForResourceResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
