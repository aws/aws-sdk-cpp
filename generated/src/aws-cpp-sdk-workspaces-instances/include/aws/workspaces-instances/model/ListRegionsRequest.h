...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/workspaces-instances-2022-07-26/ListRegionsRequest">AWS
   * API Reference</a></p>
   */
  class ListRegionsRequest : public WorkspacesInstancesRequest
  {
  public:
    AWS_WORKSPACESINSTANCES_API ListRegionsRequest() = default;
    ...
    ///@{
    /**
     * <p>Maximum number of regions to return in a single API call. Enables pagination
     * of region results.</p>
     */
