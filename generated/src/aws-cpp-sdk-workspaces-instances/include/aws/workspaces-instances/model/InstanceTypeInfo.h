...
class InstanceTypeInfo {
 public:
  ...
  AWS_WORKSPACESINSTANCES_API InstanceTypeInfo(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_WORKSPACESINSTANCES_API InstanceTypeInfo& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
