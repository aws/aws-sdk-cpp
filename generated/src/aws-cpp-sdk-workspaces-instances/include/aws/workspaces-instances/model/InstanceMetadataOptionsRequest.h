...
class InstanceMetadataOptionsRequest {
 public:
  ...
  inline void SetHttpEndpoint(HttpEndpointEnum value) {
    m_httpEndpointHasBeenSet = true;
    m_httpEndpoint = value;
  }
  inline InstanceMetadataOptionsRequest& WithHttpEndpoint(HttpEndpointEnum value) {
  ...
  inline void SetHttpProtocolIpv6(HttpProtocolIpv6Enum value) {
    m_httpProtocolIpv6HasBeenSet = true;
    m_httpProtocolIpv6 = value;
  }
  inline InstanceMetadataOptionsRequest& WithHttpProtocolIpv6(HttpProtocolIpv6Enum value) {
  ...
  inline void SetHttpTokens(HttpTokensEnum value) {
    m_httpTokensHasBeenSet = true;
    m_httpTokens = value;
  }
  inline InstanceMetadataOptionsRequest& WithHttpTokens(HttpTokensEnum value) {
    SetHttpTokens(value);
    return *this;
  }
  ///@}
  ...
  inline void SetInstanceMetadataTags(InstanceMetadataTagsEnum value) {
    m_instanceMetadataTagsHasBeenSet = true;
    m_instanceMetadataTags = value;
  }
  inline InstanceMetadataOptionsRequest& WithInstanceMetadataTags(InstanceMetadataTagsEnum value) {
