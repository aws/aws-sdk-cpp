...
class AssociateVolumeResult {
 public:
  ...
  AWS_WORKSPACESINSTANCES_API AssociateVolumeResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_WORKSPACESINSTANCES_API AssociateVolumeResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
