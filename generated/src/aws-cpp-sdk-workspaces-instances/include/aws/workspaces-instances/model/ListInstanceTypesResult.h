...
class ListInstanceTypesResult {
 public:
  ...
  AWS_WORKSPACESINSTANCES_API ListInstanceTypesResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_WORKSPACESINSTANCES_API ListInstanceTypesResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  template <typename InstanceTypesT = Aws::Vector<InstanceTypeInfo>>
  ListInstanceTypesResult& WithInstanceTypes(InstanceTypesT&& value) {
    SetInstanceTypes(std::forward<InstanceTypesT>(value));
    return *this;
  }
  template <typename InstanceTypesT = InstanceTypeInfo>
  ListInstanceTypesResult& AddInstanceTypes(InstanceTypesT&& value) {
    m_instanceTypesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListInstanceTypesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListInstanceTypesResult& WithRequestId(RequestIdT&& value) {
