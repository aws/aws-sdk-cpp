...
/**
 * <p>Indicates that a service quota has been exceeded.</p><p><h3>See Also:</h3>
 * <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/workspaces-instances-2022-07-26/ServiceQuotaExceededException">AWS
 * API Reference</a></p>
 */
class ServiceQuotaExceededException {
 public:
  AWS_WORKSPACESINSTANCES_API ServiceQuotaExceededException() = default;
  AWS_WORKSPACESINSTANCES_API ServiceQuotaExceededException(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_WORKSPACESINSTANCES_API ServiceQuotaExceededException& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
