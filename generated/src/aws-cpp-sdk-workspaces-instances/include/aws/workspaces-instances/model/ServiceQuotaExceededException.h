...
namespace Model
{
  ...
  public:
    ...
    AWS_WORKSPACESINSTANCES_API ServiceQuotaExceededException(Aws::Utils::Json::JsonView jsonValue);
    AWS_WORKSPACESINSTANCES_API ServiceQuotaExceededException& operator=(Aws::Utils::Json::JsonView jsonValue);
