...
class InstanceConfigurationFilter {
 public:
  ...
  AWS_WORKSPACESINSTANCES_API InstanceConfigurationFilter(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_WORKSPACESINSTANCES_API InstanceConfigurationFilter& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
