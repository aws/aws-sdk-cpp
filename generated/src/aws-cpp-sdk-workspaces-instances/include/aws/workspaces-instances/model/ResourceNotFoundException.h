...
/**
 * <p>Indicates the requested resource could not be found.</p><p><h3>See Also:</h3>
 * <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/workspaces-instances-2022-07-26/ResourceNotFoundException">AWS
 * API Reference</a></p>
 */
class ResourceNotFoundException {
 public:
  AWS_WORKSPACESINSTANCES_API ResourceNotFoundException() = default;
  AWS_WORKSPACESINSTANCES_API ResourceNotFoundException(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_WORKSPACESINSTANCES_API ResourceNotFoundException& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
