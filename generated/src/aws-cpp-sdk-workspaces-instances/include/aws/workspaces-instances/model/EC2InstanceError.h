...
class EC2InstanceError {
 public:
  ...
  AWS_WORKSPACESINSTANCES_API EC2InstanceError(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_WORKSPACESINSTANCES_API EC2InstanceError& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  void SetEC2ErrorCode(EC2ErrorCodeT&& value) {
    ...
    m_eC2ErrorCode = std::forward<EC2ErrorCodeT>(value);
  }
  template <typename EC2ErrorCodeT = Aws::String>
  EC2InstanceError& WithEC2ErrorCode(EC2ErrorCodeT&& value) {
    SetEC2ErrorCode(std::forward<EC2ErrorCodeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEC2ExceptionType(EC2ExceptionTypeT&& value) {
    ...
    m_eC2ExceptionType = std::forward<EC2ExceptionTypeT>(value);
  }
  template <typename EC2ExceptionTypeT = Aws::String>
  EC2InstanceError& WithEC2ExceptionType(EC2ExceptionTypeT&& value) {
    SetEC2ExceptionType(std::forward<EC2ExceptionTypeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEC2ErrorMessage(EC2ErrorMessageT&& value) {
    ...
    m_eC2ErrorMessage = std::forward<EC2ErrorMessageT>(value);
  }
  template <typename EC2ErrorMessageT = Aws::String>
  EC2InstanceError& WithEC2ErrorMessage(EC2ErrorMessageT&& value) {
    SetEC2ErrorMessage(std::forward<EC2ErrorMessageT>(value));
    return *this;
  }
  ///@}
 private:
