...
class ListWorkspaceInstancesResult {
 public:
  ...
  AWS_WORKSPACESINSTANCES_API ListWorkspaceInstancesResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_WORKSPACESINSTANCES_API ListWorkspaceInstancesResult& operator=(
  ...
  void SetWorkspaceInstances(WorkspaceInstancesT&& value) {
    m_workspaceInstancesHasBeenSet = true;
    m_workspaceInstances = std::forward<WorkspaceInstancesT>(value);
  }
  template <typename WorkspaceInstancesT = Aws::Vector<WorkspaceInstance>>
  ListWorkspaceInstancesResult& WithWorkspaceInstances(WorkspaceInstancesT&& value) {
    SetWorkspaceInstances(std::forward<WorkspaceInstancesT>(value));
    return *this;
  }
  template <typename WorkspaceInstancesT = WorkspaceInstance>
  ListWorkspaceInstancesResult& AddWorkspaceInstances(WorkspaceInstancesT&& value) {
    m_workspaceInstancesHasBeenSet = true;
    m_workspaceInstances.emplace_back(std::forward<WorkspaceInstancesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListWorkspaceInstancesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListWorkspaceInstancesResult& WithRequestId(RequestIdT&& value) {
