...
class Region {
 public:
  ...
  AWS_WORKSPACESINSTANCES_API Region(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_WORKSPACESINSTANCES_API Region& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
