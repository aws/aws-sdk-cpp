...
class SupportedInstanceConfiguration {
 public:
  ...
  AWS_WORKSPACESINSTANCES_API SupportedInstanceConfiguration(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_WORKSPACESINSTANCES_API SupportedInstanceConfiguration& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
