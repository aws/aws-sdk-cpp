...
class InstanceNetworkInterfaceSpecification {
 public:
  ...
  inline InstanceNetworkInterfaceSpecification& WithAssociateCarrierIpAddress(bool value) {
  ...
  inline InstanceNetworkInterfaceSpecification& WithAssociatePublicIpAddress(bool value) {
  ...
  inline void SetInterfaceType(InterfaceTypeEnum value) {
    m_interfaceTypeHasBeenSet = true;
    m_interfaceType = value;
  }
  inline InstanceNetworkInterfaceSpecification& WithInterfaceType(InterfaceTypeEnum value) {
  ...
  inline InstanceNetworkInterfaceSpecification& WithPrimaryIpv6(bool value) {
