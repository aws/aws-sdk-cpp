...
class TagSpecification {
 public:
  ...
  AWS_WORKSPACESINSTANCES_API TagSpecification(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_WORKSPACESINSTANCES_API TagSpecification& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline void SetResourceType(ResourceTypeEnum value) {
    m_resourceTypeHasBeenSet = true;
    m_resourceType = value;
  }
  inline TagSpecification& WithResourceType(ResourceTypeEnum value) {
