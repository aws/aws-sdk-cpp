...
class AWS_WORKSPACESINSTANCES_API WorkspacesInstancesClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  WorkspacesInstancesClient(const Aws::WorkspacesInstances::WorkspacesInstancesClientConfiguration& clientConfiguration =
                                Aws::WorkspacesInstances::WorkspacesInstancesClientConfiguration(),
  ...
  WorkspacesInstancesClient(const Aws::Auth::AWSCredentials& credentials,
                            std::shared_ptr<WorkspacesInstancesEndpointProviderBase> endpointProvider = nullptr,
                            const Aws::WorkspacesInstances::WorkspacesInstancesClientConfiguration& clientConfiguration =
                                Aws::WorkspacesInstances::WorkspacesInstancesClientConfiguration());
  ...
  /**
   * An Async wrapper for AssociateVolume that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename AssociateVolumeRequestT = Model::AssociateVolumeRequest>
  void AssociateVolumeAsync(const AssociateVolumeRequestT& request, const AssociateVolumeResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for CreateWorkspaceInstance that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateWorkspaceInstance that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateWorkspaceInstanceRequestT = Model::CreateWorkspaceInstanceRequest>
  void CreateWorkspaceInstanceAsync(const CreateWorkspaceInstanceRequestT& request,
                                    const CreateWorkspaceInstanceResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteWorkspaceInstance that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteWorkspaceInstance that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteWorkspaceInstanceRequestT = Model::DeleteWorkspaceInstanceRequest>
  void DeleteWorkspaceInstanceAsync(const DeleteWorkspaceInstanceRequestT& request,
  ...
  /**
   * A Callable wrapper for DisassociateVolume that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DisassociateVolume that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DisassociateVolumeRequestT = Model::DisassociateVolumeRequest>
  void DisassociateVolumeAsync(const DisassociateVolumeRequestT& request, const DisassociateVolumeResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetWorkspaceInstance that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetWorkspaceInstance that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetWorkspaceInstanceRequestT = Model::GetWorkspaceInstanceRequest>
  void GetWorkspaceInstanceAsync(const GetWorkspaceInstanceRequestT& request, const GetWorkspaceInstanceResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListInstanceTypes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListInstanceTypes that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListInstanceTypesRequestT = Model::ListInstanceTypesRequest>
  void ListInstanceTypesAsync(const ListInstanceTypesResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const ListInstanceTypesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListWorkspaceInstances that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListWorkspaceInstances that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListWorkspaceInstancesRequestT = Model::ListWorkspaceInstancesRequest>
  void ListWorkspaceInstancesAsync(const ListWorkspaceInstancesResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const ListWorkspaceInstancesRequestT& request = {}) const {
