...
'u','r','l','"',':','"','h','t','t','p','s',':','/','/','w','o','r','k','s','p','a','c','e','s','-',
'i','n','s','t','a','n','c','e','s','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{',
...
'p','s',':','/','/','w','o','r','k','s','p','a','c','e','s','-','i','n','s','t','a','n','c','e','s',
...
const char* WorkspacesInstancesEndpointRules::GetRulesBlob()
{
