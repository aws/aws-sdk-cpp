...
DeleteWorkspaceInstanceResult::DeleteWorkspaceInstanceResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result) {
  *this = result;
}

DeleteWorkspaceInstanceResult& DeleteWorkspaceInstanceResult::operator=(
