...
CreateWorkspaceInstanceResult::CreateWorkspaceInstanceResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

CreateWorkspaceInstanceResult& CreateWorkspaceInstanceResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
