...
Aws::String ListInstanceTypesRequest::SerializePayload() const {
  ...
  if (m_instanceConfigurationFilterHasBeenSet) {
    encoder.WriteText(Aws::Crt::ByteCursorFromCString("InstanceConfigurationFilter"));
    m_instanceConfigurationFilter.CborEncode(encoder);
  }
  const auto str = Aws::String(reinterpret_cast<char*>(encoder.GetEncodedData().ptr), encoder.GetEncodedData().len);
  return str;
}

Aws::Http::HeaderValueCollection ListInstanceTypesRequest::GetRequestSpecificHeaders() const {
