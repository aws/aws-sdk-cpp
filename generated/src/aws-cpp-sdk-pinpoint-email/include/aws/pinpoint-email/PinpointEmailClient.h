...
class AWS_PINPOINTEMAIL_API PinpointEmailClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  PinpointEmailClient(const Aws::PinpointEmail::PinpointEmailClientConfiguration& clientConfiguration =
  ...
  PinpointEmailClient(const Aws::Auth::AWSCredentials& credentials,
                      std::shared_ptr<PinpointEmailEndpointProviderBase> endpointProvider = nullptr,
                      const Aws::PinpointEmail::PinpointEmailClientConfiguration& clientConfiguration =
                          Aws::PinpointEmail::PinpointEmailClientConfiguration());
