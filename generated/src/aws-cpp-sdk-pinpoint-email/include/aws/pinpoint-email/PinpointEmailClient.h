...
namespace PinpointEmail
{
   ...
   * Infrastructure</a>.</p>
   */
  class AWS_PINPOINTEMAIL_API PinpointEmailClient : smithy::client::AwsSmithyClientT<Aws::PinpointEmail::SERVICE_NAME,
    ...
    Aws::Client::ClientWithAsyncTemplateMethods<PinpointEmailClient>
  {
    public:
