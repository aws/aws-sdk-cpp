...
class PutConfigurationSetReputationOptionsResult {
 public:
  AWS_PINPOINTEMAIL_API PutConfigurationSetReputationOptionsResult() = default;
  ...
  AWS_PINPOINTEMAIL_API PutConfigurationSetReputationOptionsResult& operator=(
  ...
  template <typename RequestIdT = Aws::String>
  PutConfigurationSetReputationOptionsResult& WithRequestId(RequestIdT&& value) {
