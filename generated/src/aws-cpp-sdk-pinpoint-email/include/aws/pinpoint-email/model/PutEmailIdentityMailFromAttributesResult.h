...
class PutEmailIdentityMailFromAttributesResult {
 public:
  AWS_PINPOINTEMAIL_API PutEmailIdentityMailFromAttributesResult() = default;
  ...
  AWS_PINPOINTEMAIL_API PutEmailIdentityMailFromAttributesResult& operator=(
  ...
  template <typename RequestIdT = Aws::String>
  PutEmailIdentityMailFromAttributesResult& WithRequestId(RequestIdT&& value) {
