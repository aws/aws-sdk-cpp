...
namespace Model
{
  ...
  public:
    ...
    inline PutEmailIdentityMailFromAttributesResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline PutEmailIdentityMailFromAttributesResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline PutEmailIdentityMailFromAttributesResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
