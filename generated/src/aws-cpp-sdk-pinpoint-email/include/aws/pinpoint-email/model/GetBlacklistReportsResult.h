...
class GetBlacklistReportsResult {
 public:
  ...
  void SetBlacklistReport(BlacklistReportT&& value) {
    m_blacklistReportHasBeenSet = true;
    m_blacklistReport = std::forward<BlacklistReportT>(value);
  }
  template <typename BlacklistReportT = Aws::Map<Aws::String, Aws::Vector<BlacklistEntry>>>
  GetBlacklistReportsResult& WithBlacklistReport(BlacklistReportT&& value) {
    SetBlacklistReport(std::forward<BlacklistReportT>(value));
    return *this;
  }
  ...
  GetBlacklistReportsResult& AddBlacklistReport(BlacklistReportKeyT&& key, BlacklistReportValueT&& value) {
    m_blacklistReportHasBeenSet = true;
    m_blacklistReport.emplace(std::forward<BlacklistReportKeyT>(key), std::forward<BlacklistReportValueT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetBlacklistReportsResult& WithRequestId(RequestIdT&& value) {
