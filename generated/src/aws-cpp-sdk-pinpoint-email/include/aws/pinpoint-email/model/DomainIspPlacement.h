...
class DomainIspPlacement {
 public:
  ...
  inline void SetInboxRawCount(long long value) {
    m_inboxRawCountHasBeenSet = true;
    m_inboxRawCount = value;
  }
  inline DomainIspPlacement& WithInboxRawCount(long long value) {
    SetInboxRawCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSpamRawCount(long long value) {
    m_spamRawCountHasBeenSet = true;
    m_spamRawCount = value;
  }
  inline DomainIspPlacement& WithSpamRawCount(long long value) {
    SetSpamRawCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetInboxPercentage(double value) {
    m_inboxPercentageHasBeenSet = true;
    m_inboxPercentage = value;
  }
  inline DomainIspPlacement& WithInboxPercentage(double value) {
    SetInboxPercentage(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSpamPercentage(double value) {
    m_spamPercentageHasBeenSet = true;
    m_spamPercentage = value;
  }
  inline DomainIspPlacement& WithSpamPercentage(double value) {
    SetSpamPercentage(value);
    return *this;
  }
  ///@}
 private:
