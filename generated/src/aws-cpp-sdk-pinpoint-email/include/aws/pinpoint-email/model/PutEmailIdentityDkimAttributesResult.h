...
class PutEmailIdentityDkimAttributesResult {
 public:
  AWS_PINPOINTEMAIL_API PutEmailIdentityDkimAttributesResult() = default;
  ...
  AWS_PINPOINTEMAIL_API PutEmailIdentityDkimAttributesResult& operator=(
  ...
  template <typename RequestIdT = Aws::String>
  PutEmailIdentityDkimAttributesResult& WithRequestId(RequestIdT&& value) {
