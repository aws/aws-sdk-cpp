...
class GetAccountResult {
 public:
  ...
  void SetSendQuota(SendQuotaT&& value) {
    ...
    m_sendQuota = std::forward<SendQuotaT>(value);
  }
  template <typename SendQuotaT = SendQuota>
  GetAccountResult& WithSendQuota(SendQuotaT&& value) {
    SetSendQuota(std::forward<SendQuotaT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetSendingEnabled(bool value) {
    m_sendingEnabledHasBeenSet = true;
    m_sendingEnabled = value;
  }
  inline GetAccountResult& WithSendingEnabled(bool value) {
    SetSendingEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDedicatedIpAutoWarmupEnabled(bool value) {
    m_dedicatedIpAutoWarmupEnabledHasBeenSet = true;
    m_dedicatedIpAutoWarmupEnabled = value;
  }
  inline GetAccountResult& WithDedicatedIpAutoWarmupEnabled(bool value) {
    SetDedicatedIpAutoWarmupEnabled(value);
    return *this;
  }
  ///@}
  ...
  void SetEnforcementStatus(EnforcementStatusT&& value) {
    ...
    m_enforcementStatus = std::forward<EnforcementStatusT>(value);
  }
  template <typename EnforcementStatusT = Aws::String>
  GetAccountResult& WithEnforcementStatus(EnforcementStatusT&& value) {
    SetEnforcementStatus(std::forward<EnforcementStatusT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetProductionAccessEnabled(bool value) {
    m_productionAccessEnabledHasBeenSet = true;
    m_productionAccessEnabled = value;
  }
  inline GetAccountResult& WithProductionAccessEnabled(bool value) {
    SetProductionAccessEnabled(value);
    return *this;
  }
  ///@}
