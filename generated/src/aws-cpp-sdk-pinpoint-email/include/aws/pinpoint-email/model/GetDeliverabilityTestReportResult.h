...
class GetDeliverabilityTestReportResult {
 public:
  ...
  AWS_PINPOINTEMAIL_API GetDeliverabilityTestReportResult& operator=(
  ...
  void SetDeliverabilityTestReport(DeliverabilityTestReportT&& value) {
    ...
    m_deliverabilityTestReport = std::forward<DeliverabilityTestReportT>(value);
  }
  template <typename DeliverabilityTestReportT = DeliverabilityTestReport>
  GetDeliverabilityTestReportResult& WithDeliverabilityTestReport(DeliverabilityTestReportT&& value) {
    SetDeliverabilityTestReport(std::forward<DeliverabilityTestReportT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOverallPlacement(OverallPlacementT&& value) {
    ...
    m_overallPlacement = std::forward<OverallPlacementT>(value);
  }
  template <typename OverallPlacementT = PlacementStatistics>
  GetDeliverabilityTestReportResult& WithOverallPlacement(OverallPlacementT&& value) {
    SetOverallPlacement(std::forward<OverallPlacementT>(value));
    return *this;
  }
  ///@}
