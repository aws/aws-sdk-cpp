...
class PutDeliverabilityDashboardOptionRequest : public PinpointEmailRequest {
 public:
  ...
  inline PutDeliverabilityDashboardOptionRequest& WithDashboardEnabled(bool value) {
  ...
  void SetSubscribedDomains(SubscribedDomainsT&& value) {
    m_subscribedDomainsHasBeenSet = true;
    m_subscribedDomains = std::forward<SubscribedDomainsT>(value);
  }
  template <typename SubscribedDomainsT = Aws::Vector<DomainDeliverabilityTrackingOption>>
  PutDeliverabilityDashboardOptionRequest& WithSubscribedDomains(SubscribedDomainsT&& value) {
    SetSubscribedDomains(std::forward<SubscribedDomainsT>(value));
    return *this;
  }
  ...
  PutDeliverabilityDashboardOptionRequest& AddSubscribedDomains(SubscribedDomainsT&& value) {
    m_subscribedDomainsHasBeenSet = true;
    m_subscribedDomains.emplace_back(std::forward<SubscribedDomainsT>(value));
    return *this;
  }
  ///@}
 private:
