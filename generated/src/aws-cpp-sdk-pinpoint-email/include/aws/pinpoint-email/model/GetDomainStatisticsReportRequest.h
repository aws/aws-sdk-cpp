...
namespace Model
{
  ...
  public:
    ...
    template<typename DomainT = Aws::String>
    GetDomainStatisticsReportRequest& WithDomain(DomainT&& value) { SetDomain(std::forward<DomainT>(value)); return *this;}
    ///@}
    ...
    template<typename StartDateT = Aws::Utils::DateTime>
    GetDomainStatisticsReportRequest& WithStartDate(StartDateT&& value) { SetStartDate(std::forward<StartDateT>(value)); return *this;}
    ///@}
    ...
    template<typename EndDateT = Aws::Utils::DateTime>
    GetDomainStatisticsReportRequest& WithEndDate(EndDateT&& value) { SetEndDate(std::forward<EndDateT>(value)); return *this;}
    ///@}
  private:
