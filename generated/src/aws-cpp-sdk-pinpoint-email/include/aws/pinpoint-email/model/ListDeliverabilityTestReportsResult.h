...
class ListDeliverabilityTestReportsResult {
 public:
  ...
  AWS_PINPOINTEMAIL_API ListDeliverabilityTestReportsResult& operator=(
  ...
  void SetDeliverabilityTestReports(DeliverabilityTestReportsT&& value) {
    m_deliverabilityTestReportsHasBeenSet = true;
    m_deliverabilityTestReports = std::forward<DeliverabilityTestReportsT>(value);
  }
  template <typename DeliverabilityTestReportsT = Aws::Vector<DeliverabilityTestReport>>
  ListDeliverabilityTestReportsResult& WithDeliverabilityTestReports(DeliverabilityTestReportsT&& value) {
    SetDeliverabilityTestReports(std::forward<DeliverabilityTestReportsT>(value));
    return *this;
  }
  template <typename DeliverabilityTestReportsT = DeliverabilityTestReport>
  ListDeliverabilityTestReportsResult& AddDeliverabilityTestReports(DeliverabilityTestReportsT&& value) {
    m_deliverabilityTestReportsHasBeenSet = true;
    m_deliverabilityTestReports.emplace_back(std::forward<DeliverabilityTestReportsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListDeliverabilityTestReportsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDeliverabilityTestReportsResult& WithRequestId(RequestIdT&& value) {
