 ...
 * API Reference</a></p>
 */
class ListEmailIdentitiesRequest : public PinpointEmailRequest {
 public:
  AWS_PINPOINTEMAIL_API ListEmailIdentitiesRequest() = default;
  ...
  template <typename NextTokenT = Aws::String>
  ListEmailIdentitiesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListEmailIdentitiesRequest& WithPageSize(int value) {
    SetPageSize(value);
    return *this;
  }
  ///@}
