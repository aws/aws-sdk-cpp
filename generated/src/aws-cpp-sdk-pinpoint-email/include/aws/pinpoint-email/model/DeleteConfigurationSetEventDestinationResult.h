...
class DeleteConfigurationSetEventDestinationResult {
 public:
  AWS_PINPOINTEMAIL_API DeleteConfigurationSetEventDestinationResult() = default;
  AWS_PINPOINTEMAIL_API DeleteConfigurationSetEventDestinationResult(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_PINPOINTEMAIL_API DeleteConfigurationSetEventDestinationResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename RequestIdT = Aws::String>
  DeleteConfigurationSetEventDestinationResult& WithRequestId(RequestIdT&& value) {
