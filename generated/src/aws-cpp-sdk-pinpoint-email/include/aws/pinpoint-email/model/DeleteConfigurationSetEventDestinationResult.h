...
namespace Model
{
  ...
  public:
    ...
    inline DeleteConfigurationSetEventDestinationResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeleteConfigurationSetEventDestinationResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeleteConfigurationSetEventDestinationResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
