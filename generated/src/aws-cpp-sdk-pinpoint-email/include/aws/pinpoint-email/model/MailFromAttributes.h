...
class MailFromAttributes {
 public:
  ...
  inline void SetMailFromDomainStatus(MailFromDomainStatus value) {
    m_mailFromDomainStatusHasBeenSet = true;
    m_mailFromDomainStatus = value;
  }
  inline MailFromAttributes& WithMailFromDomainStatus(MailFromDomainStatus value) {
    SetMailFromDomainStatus(value);
    return *this;
  }
  ///@}
  ...
  inline MailFromAttributes& WithBehaviorOnMxFailure(BehaviorOnMxFailure value) {
