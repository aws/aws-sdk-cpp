...
class BlacklistEntry {
 public:
  ...
  void SetRblName(RblNameT&& value) {
    ...
    m_rblName = std::forward<RblNameT>(value);
  }
  template <typename RblNameT = Aws::String>
  BlacklistEntry& WithRblName(RblNameT&& value) {
    SetRblName(std::forward<RblNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetListingTime(ListingTimeT&& value) {
    ...
    m_listingTime = std::forward<ListingTimeT>(value);
  }
  template <typename ListingTimeT = Aws::Utils::DateTime>
  BlacklistEntry& WithListingTime(ListingTimeT&& value) {
    SetListingTime(std::forward<ListingTimeT>(value));
    return *this;
  }
  ///@}
