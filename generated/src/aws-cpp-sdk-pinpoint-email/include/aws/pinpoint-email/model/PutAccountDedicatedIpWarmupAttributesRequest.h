...
class PutAccountDedicatedIpWarmupAttributesRequest : public PinpointEmailRequest {
 public:
  ...
  inline void SetAutoWarmupEnabled(bool value) {
    m_autoWarmupEnabledHasBeenSet = true;
    m_autoWarmupEnabled = value;
  }
  inline PutAccountDedicatedIpWarmupAttributesRequest& WithAutoWarmupEnabled(bool value) {
    SetAutoWarmupEnabled(value);
    return *this;
  }
  ///@}
 private:
