...
class CreateDeliverabilityTestReportResult {
 public:
  ...
  AWS_PINPOINTEMAIL_API CreateDeliverabilityTestReportResult& operator=(
  ...
  template <typename ReportIdT = Aws::String>
  CreateDeliverabilityTestReportResult& WithReportId(ReportIdT&& value) {
  ...
  inline void SetDeliverabilityTestStatus(DeliverabilityTestStatus value) {
    m_deliverabilityTestStatusHasBeenSet = true;
    m_deliverabilityTestStatus = value;
  }
  inline CreateDeliverabilityTestReportResult& WithDeliverabilityTestStatus(DeliverabilityTestStatus value) {
    SetDeliverabilityTestStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  CreateDeliverabilityTestReportResult& WithRequestId(RequestIdT&& value) {
