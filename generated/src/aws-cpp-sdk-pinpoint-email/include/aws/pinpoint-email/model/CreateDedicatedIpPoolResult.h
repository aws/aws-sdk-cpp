...
namespace Model
{
  ...
  {
  public:
    AWS_PINPOINTEMAIL_API CreateDedicatedIpPoolResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    CreateDedicatedIpPoolResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
