...
class GetBlacklistReportsRequest : public PinpointEmailRequest {
 public:
  ...
  void SetBlacklistItemNames(BlacklistItemNamesT&& value) {
    m_blacklistItemNamesHasBeenSet = true;
    m_blacklistItemNames = std::forward<BlacklistItemNamesT>(value);
  }
  template <typename BlacklistItemNamesT = Aws::Vector<Aws::String>>
  GetBlacklistReportsRequest& WithBlacklistItemNames(BlacklistItemNamesT&& value) {
    SetBlacklistItemNames(std::forward<BlacklistItemNamesT>(value));
    return *this;
  }
  template <typename BlacklistItemNamesT = Aws::String>
  GetBlacklistReportsRequest& AddBlacklistItemNames(BlacklistItemNamesT&& value) {
    m_blacklistItemNamesHasBeenSet = true;
    m_blacklistItemNames.emplace_back(std::forward<BlacklistItemNamesT>(value));
    return *this;
  }
  ///@}
 private:
