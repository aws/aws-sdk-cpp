...
class GetDeliverabilityDashboardOptionsResult {
 public:
  ...
  AWS_PINPOINTEMAIL_API GetDeliverabilityDashboardOptionsResult& operator=(
  ...
  inline void SetDashboardEnabled(bool value) {
    m_dashboardEnabledHasBeenSet = true;
    m_dashboardEnabled = value;
  }
  inline GetDeliverabilityDashboardOptionsResult& WithDashboardEnabled(bool value) {
  ...
  void SetSubscriptionExpiryDate(SubscriptionExpiryDateT&& value) {
    ...
    m_subscriptionExpiryDate = std::forward<SubscriptionExpiryDateT>(value);
  }
  template <typename SubscriptionExpiryDateT = Aws::Utils::DateTime>
  GetDeliverabilityDashboardOptionsResult& WithSubscriptionExpiryDate(SubscriptionExpiryDateT&& value) {
    SetSubscriptionExpiryDate(std::forward<SubscriptionExpiryDateT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAccountStatus(DeliverabilityDashboardAccountStatus value) {
    m_accountStatusHasBeenSet = true;
    m_accountStatus = value;
  }
  inline GetDeliverabilityDashboardOptionsResult& WithAccountStatus(DeliverabilityDashboardAccountStatus value) {
  ...
  void SetActiveSubscribedDomains(ActiveSubscribedDomainsT&& value) {
    ...
    m_activeSubscribedDomains = std::forward<ActiveSubscribedDomainsT>(value);
  }
  template <typename ActiveSubscribedDomainsT = Aws::Vector<DomainDeliverabilityTrackingOption>>
  GetDeliverabilityDashboardOptionsResult& WithActiveSubscribedDomains(ActiveSubscribedDomainsT&& value) {
    SetActiveSubscribedDomains(std::forward<ActiveSubscribedDomainsT>(value));
    return *this;
  }
  ...
  GetDeliverabilityDashboardOptionsResult& AddActiveSubscribedDomains(ActiveSubscribedDomainsT&& value) {
    m_activeSubscribedDomainsHasBeenSet = true;
    m_activeSubscribedDomains.emplace_back(std::forward<ActiveSubscribedDomainsT>(value));
    return *this;
  }
  ///@}
   ...
   * scheduled to expire at the end of the current calendar month.</p>
   */
  inline const Aws::Vector<DomainDeliverabilityTrackingOption>& GetPendingExpirationSubscribedDomains() const {
    return m_pendingExpirationSubscribedDomains;
  }
  ...
  void SetPendingExpirationSubscribedDomains(PendingExpirationSubscribedDomainsT&& value) {
    ...
    m_pendingExpirationSubscribedDomains = std::forward<PendingExpirationSubscribedDomainsT>(value);
  }
  template <typename PendingExpirationSubscribedDomainsT = Aws::Vector<DomainDeliverabilityTrackingOption>>
  GetDeliverabilityDashboardOptionsResult& WithPendingExpirationSubscribedDomains(PendingExpirationSubscribedDomainsT&& value) {
    SetPendingExpirationSubscribedDomains(std::forward<PendingExpirationSubscribedDomainsT>(value));
    return *this;
  }
  ...
  GetDeliverabilityDashboardOptionsResult& AddPendingExpirationSubscribedDomains(PendingExpirationSubscribedDomainsT&& value) {
    m_pendingExpirationSubscribedDomainsHasBeenSet = true;
    m_pendingExpirationSubscribedDomains.emplace_back(std::forward<PendingExpirationSubscribedDomainsT>(value));
    return *this;
  }
  ///@}
