...
ListDomainDeliverabilityCampaignsResult& ListDomainDeliverabilityCampaignsResult::operator=(
  ...
  if (jsonValue.ValueExists("DomainDeliverabilityCampaigns")) {
    ...
    for (unsigned domainDeliverabilityCampaignsIndex = 0;
         domainDeliverabilityCampaignsIndex < domainDeliverabilityCampaignsJsonList.GetLength(); ++domainDeliverabilityCampaignsIndex) {
