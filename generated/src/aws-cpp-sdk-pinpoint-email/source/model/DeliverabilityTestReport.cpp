...
DeliverabilityTestReport::DeliverabilityTestReport(JsonView jsonValue) { *this = jsonValue; }
...
DeliverabilityTestReport& DeliverabilityTestReport::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("DeliverabilityTestStatus")) {
    m_deliverabilityTestStatus =
        DeliverabilityTestStatusMapper::GetDeliverabilityTestStatusForName(jsonValue.GetString("DeliverabilityTestStatus"));
...
JsonValue DeliverabilityTestReport::Jsonize() const {
  ...
  if (m_deliverabilityTestStatusHasBeenSet) {
    payload.WithString("DeliverabilityTestStatus",
                       DeliverabilityTestStatusMapper::GetNameForDeliverabilityTestStatus(m_deliverabilityTestStatus));
  }
