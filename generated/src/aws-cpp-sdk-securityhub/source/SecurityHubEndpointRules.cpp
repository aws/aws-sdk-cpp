...
{
const size_t SecurityHubEndpointRules::RulesBlobStrLen = 3744;
const size_t SecurityHubEndpointRules::RulesBlobSize = 3745;
...
't','p','s',':','/','/','s','e','c','u','r','i','t','y','h','u','b','-','f','i','p','s','.','{','R',
