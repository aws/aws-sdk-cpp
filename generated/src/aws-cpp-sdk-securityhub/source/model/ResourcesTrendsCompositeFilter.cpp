...
ResourcesTrendsCompositeFilter::ResourcesTrendsCompositeFilter(JsonView jsonValue) { *this = jsonValue; }

ResourcesTrendsCompositeFilter& ResourcesTrendsCompositeFilter::operator=(JsonView jsonValue) {
...
JsonValue ResourcesTrendsCompositeFilter::Jsonize() const {
  JsonValue payload;
