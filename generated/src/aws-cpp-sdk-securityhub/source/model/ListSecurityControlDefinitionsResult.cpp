...
ListSecurityControlDefinitionsResult& ListSecurityControlDefinitionsResult::operator=(
  ...
  if (jsonValue.ValueExists("SecurityControlDefinitions")) {
    ...
    for (unsigned securityControlDefinitionsIndex = 0; securityControlDefinitionsIndex < securityControlDefinitionsJsonList.GetLength();
         ++securityControlDefinitionsIndex) {
      m_securityControlDefinitions.push_back(securityControlDefinitionsJsonList[securityControlDefinitionsIndex].AsObject());
    }
    m_securityControlDefinitionsHasBeenSet = true;
  }
