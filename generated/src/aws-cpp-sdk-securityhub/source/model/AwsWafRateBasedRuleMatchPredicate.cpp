...
AwsWafRateBasedRuleMatchPredicate::AwsWafRateBasedRuleMatchPredicate(JsonView jsonValue) { *this = jsonValue; }

AwsWafRateBasedRuleMatchPredicate& AwsWafRateBasedRuleMatchPredicate::operator=(JsonView jsonValue) {
...
JsonValue AwsWafRateBasedRuleMatchPredicate::Jsonize() const {
  JsonValue payload;
