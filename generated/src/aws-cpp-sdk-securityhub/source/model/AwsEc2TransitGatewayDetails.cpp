...
AwsEc2TransitGatewayDetails::AwsEc2TransitGatewayDetails(JsonView jsonValue) { *this = jsonValue; }
...
AwsEc2TransitGatewayDetails& AwsEc2TransitGatewayDetails::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("TransitGatewayCidrBlocks")) {
    ...
    for (unsigned transitGatewayCidrBlocksIndex = 0; transitGatewayCidrBlocksIndex < transitGatewayCidrBlocksJsonList.GetLength();
         ++transitGatewayCidrBlocksIndex) {
