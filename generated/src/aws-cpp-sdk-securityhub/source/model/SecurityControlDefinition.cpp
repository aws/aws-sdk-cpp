...
SecurityControlDefinition::SecurityControlDefinition(JsonView jsonValue) { *this = jsonValue; }
...
SecurityControlDefinition& SecurityControlDefinition::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("CurrentRegionAvailability")) {
    m_currentRegionAvailability =
        RegionAvailabilityStatusMapper::GetRegionAvailabilityStatusForName(jsonValue.GetString("CurrentRegionAvailability"));
  ...
  if (jsonValue.ValueExists("CustomizableProperties")) {
    ...
    for (unsigned customizablePropertiesIndex = 0; customizablePropertiesIndex < customizablePropertiesJsonList.GetLength();
         ++customizablePropertiesIndex) {
      m_customizableProperties.push_back(SecurityControlPropertyMapper::GetSecurityControlPropertyForName(
          customizablePropertiesJsonList[customizablePropertiesIndex].AsString()));
    }
...
JsonValue SecurityControlDefinition::Jsonize() const {
  ...
  if (m_currentRegionAvailabilityHasBeenSet) {
    payload.WithString("CurrentRegionAvailability",
                       RegionAvailabilityStatusMapper::GetNameForRegionAvailabilityStatus(m_currentRegionAvailability));
  }
  ...
  if (m_customizablePropertiesHasBeenSet) {
    ...
    for (unsigned customizablePropertiesIndex = 0; customizablePropertiesIndex < customizablePropertiesJsonList.GetLength();
         ++customizablePropertiesIndex) {
      customizablePropertiesJsonList[customizablePropertiesIndex].AsString(
          SecurityControlPropertyMapper::GetNameForSecurityControlProperty(m_customizableProperties[customizablePropertiesIndex]));
    }
