...
AwsRedshiftClusterDetails::AwsRedshiftClusterDetails(JsonView jsonValue) { *this = jsonValue; }
...
AwsRedshiftClusterDetails& AwsRedshiftClusterDetails::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("ClusterParameterGroups")) {
    ...
    for (unsigned clusterParameterGroupsIndex = 0; clusterParameterGroupsIndex < clusterParameterGroupsJsonList.GetLength();
  ...
  if (jsonValue.ValueExists("ClusterSecurityGroups")) {
    ...
    for (unsigned clusterSecurityGroupsIndex = 0; clusterSecurityGroupsIndex < clusterSecurityGroupsJsonList.GetLength();
  ...
  if (jsonValue.ValueExists("DeferredMaintenanceWindows")) {
    ...
    for (unsigned deferredMaintenanceWindowsIndex = 0; deferredMaintenanceWindowsIndex < deferredMaintenanceWindowsJsonList.GetLength();
...
JsonValue AwsRedshiftClusterDetails::Jsonize() const {
  ...
  if (m_deferredMaintenanceWindowsHasBeenSet) {
    ...
    for (unsigned deferredMaintenanceWindowsIndex = 0; deferredMaintenanceWindowsIndex < deferredMaintenanceWindowsJsonList.GetLength();
         ++deferredMaintenanceWindowsIndex) {
      deferredMaintenanceWindowsJsonList[deferredMaintenanceWindowsIndex].AsObject(
          m_deferredMaintenanceWindows[deferredMaintenanceWindowsIndex].Jsonize());
    }
