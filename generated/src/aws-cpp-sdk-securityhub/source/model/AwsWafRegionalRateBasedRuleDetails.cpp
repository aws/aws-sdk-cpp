...
AwsWafRegionalRateBasedRuleDetails::AwsWafRegionalRateBasedRuleDetails(JsonView jsonValue) { *this = jsonValue; }

AwsWafRegionalRateBasedRuleDetails& AwsWafRegionalRateBasedRuleDetails::operator=(JsonView jsonValue) {
...
JsonValue AwsWafRegionalRateBasedRuleDetails::Jsonize() const {
  JsonValue payload;
