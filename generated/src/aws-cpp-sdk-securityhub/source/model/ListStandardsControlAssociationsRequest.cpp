...
Aws::String ListStandardsControlAssociationsRequest::SerializePayload() const { return {}; }

void ListStandardsControlAssociationsRequest::AddQueryStringParameters(URI& uri) const {
  Aws::StringStream ss;
