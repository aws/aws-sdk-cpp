...
AwsEc2LaunchTemplateDataDetails::AwsEc2LaunchTemplateDataDetails(JsonView jsonValue) { *this = jsonValue; }
...
AwsEc2LaunchTemplateDataDetails& AwsEc2LaunchTemplateDataDetails::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("BlockDeviceMappingSet")) {
    ...
    for (unsigned blockDeviceMappingSetIndex = 0; blockDeviceMappingSetIndex < blockDeviceMappingSetJsonList.GetLength();
         ++blockDeviceMappingSetIndex) {
  ...
  if (jsonValue.ValueExists("ElasticGpuSpecificationSet")) {
    ...
    for (unsigned elasticGpuSpecificationSetIndex = 0; elasticGpuSpecificationSetIndex < elasticGpuSpecificationSetJsonList.GetLength();
         ++elasticGpuSpecificationSetIndex) {
  ...
  if (jsonValue.ValueExists("ElasticInferenceAcceleratorSet")) {
    ...
    for (unsigned elasticInferenceAcceleratorSetIndex = 0;
         elasticInferenceAcceleratorSetIndex < elasticInferenceAcceleratorSetJsonList.GetLength(); ++elasticInferenceAcceleratorSetIndex) {
  ...
  if (jsonValue.ValueExists("NetworkInterfaceSet")) {
    ...
    for (unsigned networkInterfaceSetIndex = 0; networkInterfaceSetIndex < networkInterfaceSetJsonList.GetLength();
         ++networkInterfaceSetIndex) {
...
JsonValue AwsEc2LaunchTemplateDataDetails::Jsonize() const {
  ...
  if (m_elasticGpuSpecificationSetHasBeenSet) {
    ...
    for (unsigned elasticGpuSpecificationSetIndex = 0; elasticGpuSpecificationSetIndex < elasticGpuSpecificationSetJsonList.GetLength();
         ++elasticGpuSpecificationSetIndex) {
      elasticGpuSpecificationSetJsonList[elasticGpuSpecificationSetIndex].AsObject(
          m_elasticGpuSpecificationSet[elasticGpuSpecificationSetIndex].Jsonize());
    }
  ...
  if (m_elasticInferenceAcceleratorSetHasBeenSet) {
    ...
    for (unsigned elasticInferenceAcceleratorSetIndex = 0;
         elasticInferenceAcceleratorSetIndex < elasticInferenceAcceleratorSetJsonList.GetLength(); ++elasticInferenceAcceleratorSetIndex) {
      elasticInferenceAcceleratorSetJsonList[elasticInferenceAcceleratorSetIndex].AsObject(
          m_elasticInferenceAcceleratorSet[elasticInferenceAcceleratorSetIndex].Jsonize());
    }
