...
AwsIamRoleDetails::AwsIamRoleDetails(JsonView jsonValue) { *this = jsonValue; }
...
AwsIamRoleDetails& AwsIamRoleDetails::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("InstanceProfileList")) {
    ...
    for (unsigned instanceProfileListIndex = 0; instanceProfileListIndex < instanceProfileListJsonList.GetLength();
