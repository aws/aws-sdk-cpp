...
AwsElbLoadBalancerDetails::AwsElbLoadBalancerDetails(JsonView jsonValue) { *this = jsonValue; }
...
AwsElbLoadBalancerDetails& AwsElbLoadBalancerDetails::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("BackendServerDescriptions")) {
    ...
    for (unsigned backendServerDescriptionsIndex = 0; backendServerDescriptionsIndex < backendServerDescriptionsJsonList.GetLength();
  ...
  if (jsonValue.ValueExists("ListenerDescriptions")) {
    ...
    for (unsigned listenerDescriptionsIndex = 0; listenerDescriptionsIndex < listenerDescriptionsJsonList.GetLength();
...
JsonValue AwsElbLoadBalancerDetails::Jsonize() const {
  ...
  if (m_backendServerDescriptionsHasBeenSet) {
    ...
    for (unsigned backendServerDescriptionsIndex = 0; backendServerDescriptionsIndex < backendServerDescriptionsJsonList.GetLength();
         ++backendServerDescriptionsIndex) {
      backendServerDescriptionsJsonList[backendServerDescriptionsIndex].AsObject(
          m_backendServerDescriptions[backendServerDescriptionsIndex].Jsonize());
    }
