...
AwsEc2VpcDetails::AwsEc2VpcDetails(JsonView jsonValue) { *this = jsonValue; }
...
AwsEc2VpcDetails& AwsEc2VpcDetails::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("CidrBlockAssociationSet")) {
    ...
    for (unsigned cidrBlockAssociationSetIndex = 0; cidrBlockAssociationSetIndex < cidrBlockAssociationSetJsonList.GetLength();
         ++cidrBlockAssociationSetIndex) {
...
JsonValue AwsEc2VpcDetails::Jsonize() const {
  ...
  if (m_cidrBlockAssociationSetHasBeenSet) {
    ...
    for (unsigned cidrBlockAssociationSetIndex = 0; cidrBlockAssociationSetIndex < cidrBlockAssociationSetJsonList.GetLength();
         ++cidrBlockAssociationSetIndex) {
      cidrBlockAssociationSetJsonList[cidrBlockAssociationSetIndex].AsObject(
          m_cidrBlockAssociationSet[cidrBlockAssociationSetIndex].Jsonize());
    }
