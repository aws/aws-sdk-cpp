...
AwsEc2ClientVpnEndpointAuthenticationOptionsFederatedAuthenticationDetails::
    AwsEc2ClientVpnEndpointAuthenticationOptionsFederatedAuthenticationDetails(JsonView jsonValue) {
  *this = jsonValue;
}

AwsEc2ClientVpnEndpointAuthenticationOptionsFederatedAuthenticationDetails&
AwsEc2ClientVpnEndpointAuthenticationOptionsFederatedAuthenticationDetails::operator=(JsonView jsonValue) {
