...
AwsEcsTaskDefinitionContainerDefinitionsLogConfigurationSecretOptionsDetails::
    AwsEcsTaskDefinitionContainerDefinitionsLogConfigurationSecretOptionsDetails(JsonView jsonValue) {
  *this = jsonValue;
}

AwsEcsTaskDefinitionContainerDefinitionsLogConfigurationSecretOptionsDetails&
AwsEcsTaskDefinitionContainerDefinitionsLogConfigurationSecretOptionsDetails::operator=(JsonView jsonValue) {
