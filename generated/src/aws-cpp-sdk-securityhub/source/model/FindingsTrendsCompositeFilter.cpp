...
FindingsTrendsCompositeFilter::FindingsTrendsCompositeFilter(JsonView jsonValue) { *this = jsonValue; }

FindingsTrendsCompositeFilter& FindingsTrendsCompositeFilter::operator=(JsonView jsonValue) {
...
JsonValue FindingsTrendsCompositeFilter::Jsonize() const {
  JsonValue payload;
