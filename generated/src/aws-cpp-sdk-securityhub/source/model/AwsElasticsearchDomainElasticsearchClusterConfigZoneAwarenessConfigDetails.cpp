...
AwsElasticsearchDomainElasticsearchClusterConfigZoneAwarenessConfigDetails::
    AwsElasticsearchDomainElasticsearchClusterConfigZoneAwarenessConfigDetails(JsonView jsonValue) {
  *this = jsonValue;
}

AwsElasticsearchDomainElasticsearchClusterConfigZoneAwarenessConfigDetails&
AwsElasticsearchDomainElasticsearchClusterConfigZoneAwarenessConfigDetails::operator=(JsonView jsonValue) {
