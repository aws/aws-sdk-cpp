...
CspmHealthCheck::CspmHealthCheck(JsonView jsonValue) { *this = jsonValue; }

CspmHealthCheck& CspmHealthCheck::operator=(JsonView jsonValue) {
...
JsonValue CspmHealthCheck::Jsonize() const {
  JsonValue payload;
