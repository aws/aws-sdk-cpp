...
AzureUpdateConfiguration::AzureUpdateConfiguration(JsonView jsonValue) { *this = jsonValue; }

AzureUpdateConfiguration& AzureUpdateConfiguration::operator=(JsonView jsonValue) {
...
JsonValue AzureUpdateConfiguration::Jsonize() const {
  JsonValue payload;
