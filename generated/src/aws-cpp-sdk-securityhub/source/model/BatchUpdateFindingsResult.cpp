...
BatchUpdateFindingsResult::BatchUpdateFindingsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
BatchUpdateFindingsResult& BatchUpdateFindingsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("UnprocessedFindings")) {
    ...
    for (unsigned unprocessedFindingsIndex = 0; unprocessedFindingsIndex < unprocessedFindingsJsonList.GetLength();
         ++unprocessedFindingsIndex) {
