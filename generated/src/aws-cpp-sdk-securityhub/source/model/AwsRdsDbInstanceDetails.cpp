...
AwsRdsDbInstanceDetails::AwsRdsDbInstanceDetails(JsonView jsonValue) { *this = jsonValue; }
...
AwsRdsDbInstanceDetails& AwsRdsDbInstanceDetails::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("ReadReplicaDBInstanceIdentifiers")) {
    ...
    for (unsigned readReplicaDBInstanceIdentifiersIndex = 0;
         readReplicaDBInstanceIdentifiersIndex < readReplicaDBInstanceIdentifiersJsonList.GetLength();
         ++readReplicaDBInstanceIdentifiersIndex) {
      m_readReplicaDBInstanceIdentifiers.push_back(
          readReplicaDBInstanceIdentifiersJsonList[readReplicaDBInstanceIdentifiersIndex].AsString());
    }
  ...
  if (jsonValue.ValueExists("ReadReplicaDBClusterIdentifiers")) {
    ...
    for (unsigned readReplicaDBClusterIdentifiersIndex = 0;
         readReplicaDBClusterIdentifiersIndex < readReplicaDBClusterIdentifiersJsonList.GetLength();
  ...
  if (jsonValue.ValueExists("OptionGroupMemberships")) {
    ...
    for (unsigned optionGroupMembershipsIndex = 0; optionGroupMembershipsIndex < optionGroupMembershipsJsonList.GetLength();
...
JsonValue AwsRdsDbInstanceDetails::Jsonize() const {
  ...
  if (m_readReplicaDBInstanceIdentifiersHasBeenSet) {
    ...
    for (unsigned readReplicaDBInstanceIdentifiersIndex = 0;
         ...
         ++readReplicaDBInstanceIdentifiersIndex) {
      readReplicaDBInstanceIdentifiersJsonList[readReplicaDBInstanceIdentifiersIndex].AsString(
          m_readReplicaDBInstanceIdentifiers[readReplicaDBInstanceIdentifiersIndex]);
    }
  ...
  if (m_readReplicaDBClusterIdentifiersHasBeenSet) {
    ...
    for (unsigned readReplicaDBClusterIdentifiersIndex = 0;
         readReplicaDBClusterIdentifiersIndex < readReplicaDBClusterIdentifiersJsonList.GetLength();
         ++readReplicaDBClusterIdentifiersIndex) {
      readReplicaDBClusterIdentifiersJsonList[readReplicaDBClusterIdentifiersIndex].AsString(
          m_readReplicaDBClusterIdentifiers[readReplicaDBClusterIdentifiersIndex]);
    }
