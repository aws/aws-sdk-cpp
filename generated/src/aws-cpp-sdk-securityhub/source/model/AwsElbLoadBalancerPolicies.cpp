...
AwsElbLoadBalancerPolicies::AwsElbLoadBalancerPolicies(JsonView jsonValue) { *this = jsonValue; }
...
AwsElbLoadBalancerPolicies& AwsElbLoadBalancerPolicies::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("AppCookieStickinessPolicies")) {
    ...
    for (unsigned appCookieStickinessPoliciesIndex = 0; appCookieStickinessPoliciesIndex < appCookieStickinessPoliciesJsonList.GetLength();
  ...
  if (jsonValue.ValueExists("LbCookieStickinessPolicies")) {
    ...
    for (unsigned lbCookieStickinessPoliciesIndex = 0; lbCookieStickinessPoliciesIndex < lbCookieStickinessPoliciesJsonList.GetLength();
...
JsonValue AwsElbLoadBalancerPolicies::Jsonize() const {
  ...
  if (m_appCookieStickinessPoliciesHasBeenSet) {
    ...
    for (unsigned appCookieStickinessPoliciesIndex = 0; appCookieStickinessPoliciesIndex < appCookieStickinessPoliciesJsonList.GetLength();
         ++appCookieStickinessPoliciesIndex) {
      appCookieStickinessPoliciesJsonList[appCookieStickinessPoliciesIndex].AsObject(
          m_appCookieStickinessPolicies[appCookieStickinessPoliciesIndex].Jsonize());
    }
  ...
  if (m_lbCookieStickinessPoliciesHasBeenSet) {
    ...
    for (unsigned lbCookieStickinessPoliciesIndex = 0; lbCookieStickinessPoliciesIndex < lbCookieStickinessPoliciesJsonList.GetLength();
         ++lbCookieStickinessPoliciesIndex) {
      lbCookieStickinessPoliciesJsonList[lbCookieStickinessPoliciesIndex].AsObject(
          m_lbCookieStickinessPolicies[lbCookieStickinessPoliciesIndex].Jsonize());
    }
