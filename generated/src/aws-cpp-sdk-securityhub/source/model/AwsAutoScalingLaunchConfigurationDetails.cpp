...
AwsAutoScalingLaunchConfigurationDetails::AwsAutoScalingLaunchConfigurationDetails(JsonView jsonValue) { *this = jsonValue; }
...
AwsAutoScalingLaunchConfigurationDetails& AwsAutoScalingLaunchConfigurationDetails::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("ClassicLinkVpcSecurityGroups")) {
    ...
    for (unsigned classicLinkVpcSecurityGroupsIndex = 0;
         classicLinkVpcSecurityGroupsIndex < classicLinkVpcSecurityGroupsJsonList.GetLength(); ++classicLinkVpcSecurityGroupsIndex) {
...
JsonValue AwsAutoScalingLaunchConfigurationDetails::Jsonize() const {
  ...
  if (m_classicLinkVpcSecurityGroupsHasBeenSet) {
    ...
    for (unsigned classicLinkVpcSecurityGroupsIndex = 0;
         classicLinkVpcSecurityGroupsIndex < classicLinkVpcSecurityGroupsJsonList.GetLength(); ++classicLinkVpcSecurityGroupsIndex) {
      classicLinkVpcSecurityGroupsJsonList[classicLinkVpcSecurityGroupsIndex].AsString(
          m_classicLinkVpcSecurityGroups[classicLinkVpcSecurityGroupsIndex]);
    }
