...
FindingsTrendsFilters::FindingsTrendsFilters(JsonView jsonValue) { *this = jsonValue; }

FindingsTrendsFilters& FindingsTrendsFilters::operator=(JsonView jsonValue) {
...
JsonValue FindingsTrendsFilters::Jsonize() const {
  JsonValue payload;
