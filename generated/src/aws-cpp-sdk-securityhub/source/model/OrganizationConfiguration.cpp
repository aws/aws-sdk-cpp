...
OrganizationConfiguration& OrganizationConfiguration::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("ConfigurationType")) {
    m_configurationType = OrganizationConfigurationConfigurationTypeMapper::GetOrganizationConfigurationConfigurationTypeForName(
        jsonValue.GetString("ConfigurationType"));
...
JsonValue OrganizationConfiguration::Jsonize() const {
  ...
  if (m_configurationTypeHasBeenSet) {
    payload.WithString(
        "ConfigurationType",
        OrganizationConfigurationConfigurationTypeMapper::GetNameForOrganizationConfigurationConfigurationType(m_configurationType));
  }
