...
AwsEcsClusterConfigurationExecuteCommandConfigurationLogConfigurationDetails::
    AwsEcsClusterConfigurationExecuteCommandConfigurationLogConfigurationDetails(JsonView jsonValue) {
  *this = jsonValue;
}

AwsEcsClusterConfigurationExecuteCommandConfigurationLogConfigurationDetails&
AwsEcsClusterConfigurationExecuteCommandConfigurationLogConfigurationDetails::operator=(JsonView jsonValue) {
