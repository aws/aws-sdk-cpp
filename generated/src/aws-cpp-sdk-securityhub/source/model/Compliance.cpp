...
Compliance& Compliance::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("AssociatedStandards")) {
    ...
    for (unsigned associatedStandardsIndex = 0; associatedStandardsIndex < associatedStandardsJsonList.GetLength();
         ++associatedStandardsIndex) {
  ...
  if (jsonValue.ValueExists("SecurityControlParameters")) {
    ...
    for (unsigned securityControlParametersIndex = 0; securityControlParametersIndex < securityControlParametersJsonList.GetLength();
         ++securityControlParametersIndex) {
...
JsonValue Compliance::Jsonize() const {
  ...
  if (m_securityControlParametersHasBeenSet) {
    ...
    for (unsigned securityControlParametersIndex = 0; securityControlParametersIndex < securityControlParametersJsonList.GetLength();
         ++securityControlParametersIndex) {
      securityControlParametersJsonList[securityControlParametersIndex].AsObject(
          m_securityControlParameters[securityControlParametersIndex].Jsonize());
    }
