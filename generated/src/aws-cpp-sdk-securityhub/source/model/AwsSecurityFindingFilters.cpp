...
AwsSecurityFindingFilters::AwsSecurityFindingFilters(JsonView jsonValue) { *this = jsonValue; }
...
AwsSecurityFindingFilters& AwsSecurityFindingFilters::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("RecommendationText")) {
    ...
    for (unsigned recommendationTextIndex = 0; recommendationTextIndex < recommendationTextJsonList.GetLength();
         ++recommendationTextIndex) {
  ...
  if (jsonValue.ValueExists("NetworkSourceDomain")) {
    ...
    for (unsigned networkSourceDomainIndex = 0; networkSourceDomainIndex < networkSourceDomainJsonList.GetLength();
         ++networkSourceDomainIndex) {
  ...
  if (jsonValue.ValueExists("NetworkDestinationIpV4")) {
    ...
    for (unsigned networkDestinationIpV4Index = 0; networkDestinationIpV4Index < networkDestinationIpV4JsonList.GetLength();
         ++networkDestinationIpV4Index) {
  ...
  if (jsonValue.ValueExists("NetworkDestinationIpV6")) {
    ...
    for (unsigned networkDestinationIpV6Index = 0; networkDestinationIpV6Index < networkDestinationIpV6JsonList.GetLength();
         ++networkDestinationIpV6Index) {
  ...
  if (jsonValue.ValueExists("NetworkDestinationPort")) {
    ...
    for (unsigned networkDestinationPortIndex = 0; networkDestinationPortIndex < networkDestinationPortJsonList.GetLength();
         ++networkDestinationPortIndex) {
  ...
  if (jsonValue.ValueExists("NetworkDestinationDomain")) {
    ...
    for (unsigned networkDestinationDomainIndex = 0; networkDestinationDomainIndex < networkDestinationDomainJsonList.GetLength();
         ++networkDestinationDomainIndex) {
  ...
  if (jsonValue.ValueExists("ProcessTerminatedAt")) {
    ...
    for (unsigned processTerminatedAtIndex = 0; processTerminatedAtIndex < processTerminatedAtJsonList.GetLength();
         ++processTerminatedAtIndex) {
  ...
  if (jsonValue.ValueExists("ThreatIntelIndicatorType")) {
    ...
    for (unsigned threatIntelIndicatorTypeIndex = 0; threatIntelIndicatorTypeIndex < threatIntelIndicatorTypeJsonList.GetLength();
         ++threatIntelIndicatorTypeIndex) {
  ...
  if (jsonValue.ValueExists("ThreatIntelIndicatorValue")) {
    ...
    for (unsigned threatIntelIndicatorValueIndex = 0; threatIntelIndicatorValueIndex < threatIntelIndicatorValueJsonList.GetLength();
         ++threatIntelIndicatorValueIndex) {
  ...
  if (jsonValue.ValueExists("ThreatIntelIndicatorCategory")) {
    ...
    for (unsigned threatIntelIndicatorCategoryIndex = 0;
         threatIntelIndicatorCategoryIndex < threatIntelIndicatorCategoryJsonList.GetLength(); ++threatIntelIndicatorCategoryIndex) {
  ...
  if (jsonValue.ValueExists("ThreatIntelIndicatorLastObservedAt")) {
    ...
    for (unsigned threatIntelIndicatorLastObservedAtIndex = 0;
         threatIntelIndicatorLastObservedAtIndex < threatIntelIndicatorLastObservedAtJsonList.GetLength();
         ++threatIntelIndicatorLastObservedAtIndex) {
      m_threatIntelIndicatorLastObservedAt.push_back(
          threatIntelIndicatorLastObservedAtJsonList[threatIntelIndicatorLastObservedAtIndex].AsObject());
    }
  ...
  if (jsonValue.ValueExists("ThreatIntelIndicatorSource")) {
    ...
    for (unsigned threatIntelIndicatorSourceIndex = 0; threatIntelIndicatorSourceIndex < threatIntelIndicatorSourceJsonList.GetLength();
         ++threatIntelIndicatorSourceIndex) {
  ...
  if (jsonValue.ValueExists("ThreatIntelIndicatorSourceUrl")) {
    ...
    for (unsigned threatIntelIndicatorSourceUrlIndex = 0;
         threatIntelIndicatorSourceUrlIndex < threatIntelIndicatorSourceUrlJsonList.GetLength(); ++threatIntelIndicatorSourceUrlIndex) {
  ...
  if (jsonValue.ValueExists("ResourceAwsEc2InstanceType")) {
    ...
    for (unsigned resourceAwsEc2InstanceTypeIndex = 0; resourceAwsEc2InstanceTypeIndex < resourceAwsEc2InstanceTypeJsonList.GetLength();
         ++resourceAwsEc2InstanceTypeIndex) {
  ...
  if (jsonValue.ValueExists("ResourceAwsEc2InstanceImageId")) {
    ...
    for (unsigned resourceAwsEc2InstanceImageIdIndex = 0;
         resourceAwsEc2InstanceImageIdIndex < resourceAwsEc2InstanceImageIdJsonList.GetLength(); ++resourceAwsEc2InstanceImageIdIndex) {
  ...
  if (jsonValue.ValueExists("ResourceAwsEc2InstanceIpV4Addresses")) {
    ...
    for (unsigned resourceAwsEc2InstanceIpV4AddressesIndex = 0;
         resourceAwsEc2InstanceIpV4AddressesIndex < resourceAwsEc2InstanceIpV4AddressesJsonList.GetLength();
         ++resourceAwsEc2InstanceIpV4AddressesIndex) {
      m_resourceAwsEc2InstanceIpV4Addresses.push_back(
          resourceAwsEc2InstanceIpV4AddressesJsonList[resourceAwsEc2InstanceIpV4AddressesIndex].AsObject());
    }
  ...
  if (jsonValue.ValueExists("ResourceAwsEc2InstanceIpV6Addresses")) {
    ...
    for (unsigned resourceAwsEc2InstanceIpV6AddressesIndex = 0;
         resourceAwsEc2InstanceIpV6AddressesIndex < resourceAwsEc2InstanceIpV6AddressesJsonList.GetLength();
         ++resourceAwsEc2InstanceIpV6AddressesIndex) {
      m_resourceAwsEc2InstanceIpV6Addresses.push_back(
          resourceAwsEc2InstanceIpV6AddressesJsonList[resourceAwsEc2InstanceIpV6AddressesIndex].AsObject());
    }
  ...
  if (jsonValue.ValueExists("ResourceAwsEc2InstanceKeyName")) {
    ...
    for (unsigned resourceAwsEc2InstanceKeyNameIndex = 0;
         resourceAwsEc2InstanceKeyNameIndex < resourceAwsEc2InstanceKeyNameJsonList.GetLength(); ++resourceAwsEc2InstanceKeyNameIndex) {
  ...
  if (jsonValue.ValueExists("ResourceAwsEc2InstanceIamInstanceProfileArn")) {
    Aws::Utils::Array<JsonView> resourceAwsEc2InstanceIamInstanceProfileArnJsonList =
        jsonValue.GetArray("ResourceAwsEc2InstanceIamInstanceProfileArn");
    for (unsigned resourceAwsEc2InstanceIamInstanceProfileArnIndex = 0;
         resourceAwsEc2InstanceIamInstanceProfileArnIndex < resourceAwsEc2InstanceIamInstanceProfileArnJsonList.GetLength();
         ++resourceAwsEc2InstanceIamInstanceProfileArnIndex) {
      m_resourceAwsEc2InstanceIamInstanceProfileArn.push_back(
          resourceAwsEc2InstanceIamInstanceProfileArnJsonList[resourceAwsEc2InstanceIamInstanceProfileArnIndex].AsObject());
    }
  ...
  if (jsonValue.ValueExists("ResourceAwsEc2InstanceVpcId")) {
    ...
    for (unsigned resourceAwsEc2InstanceVpcIdIndex = 0; resourceAwsEc2InstanceVpcIdIndex < resourceAwsEc2InstanceVpcIdJsonList.GetLength();
         ++resourceAwsEc2InstanceVpcIdIndex) {
  ...
  if (jsonValue.ValueExists("ResourceAwsEc2InstanceSubnetId")) {
    ...
    for (unsigned resourceAwsEc2InstanceSubnetIdIndex = 0;
         resourceAwsEc2InstanceSubnetIdIndex < resourceAwsEc2InstanceSubnetIdJsonList.GetLength(); ++resourceAwsEc2InstanceSubnetIdIndex) {
  ...
  if (jsonValue.ValueExists("ResourceAwsEc2InstanceLaunchedAt")) {
    ...
    for (unsigned resourceAwsEc2InstanceLaunchedAtIndex = 0;
         resourceAwsEc2InstanceLaunchedAtIndex < resourceAwsEc2InstanceLaunchedAtJsonList.GetLength();
         ++resourceAwsEc2InstanceLaunchedAtIndex) {
      m_resourceAwsEc2InstanceLaunchedAt.push_back(
          resourceAwsEc2InstanceLaunchedAtJsonList[resourceAwsEc2InstanceLaunchedAtIndex].AsObject());
    }
  ...
  if (jsonValue.ValueExists("ResourceAwsS3BucketOwnerId")) {
    ...
    for (unsigned resourceAwsS3BucketOwnerIdIndex = 0; resourceAwsS3BucketOwnerIdIndex < resourceAwsS3BucketOwnerIdJsonList.GetLength();
         ++resourceAwsS3BucketOwnerIdIndex) {
  ...
  if (jsonValue.ValueExists("ResourceAwsS3BucketOwnerName")) {
    ...
    for (unsigned resourceAwsS3BucketOwnerNameIndex = 0;
         resourceAwsS3BucketOwnerNameIndex < resourceAwsS3BucketOwnerNameJsonList.GetLength(); ++resourceAwsS3BucketOwnerNameIndex) {
  ...
  if (jsonValue.ValueExists("ResourceAwsIamAccessKeyPrincipalName")) {
    ...
    for (unsigned resourceAwsIamAccessKeyPrincipalNameIndex = 0;
         resourceAwsIamAccessKeyPrincipalNameIndex < resourceAwsIamAccessKeyPrincipalNameJsonList.GetLength();
         ++resourceAwsIamAccessKeyPrincipalNameIndex) {
      m_resourceAwsIamAccessKeyPrincipalName.push_back(
          resourceAwsIamAccessKeyPrincipalNameJsonList[resourceAwsIamAccessKeyPrincipalNameIndex].AsObject());
    }
  ...
  if (jsonValue.ValueExists("ResourceAwsIamAccessKeyStatus")) {
    ...
    for (unsigned resourceAwsIamAccessKeyStatusIndex = 0;
         resourceAwsIamAccessKeyStatusIndex < resourceAwsIamAccessKeyStatusJsonList.GetLength(); ++resourceAwsIamAccessKeyStatusIndex) {
  ...
  if (jsonValue.ValueExists("ResourceAwsIamAccessKeyCreatedAt")) {
    ...
    for (unsigned resourceAwsIamAccessKeyCreatedAtIndex = 0;
         resourceAwsIamAccessKeyCreatedAtIndex < resourceAwsIamAccessKeyCreatedAtJsonList.GetLength();
         ++resourceAwsIamAccessKeyCreatedAtIndex) {
      m_resourceAwsIamAccessKeyCreatedAt.push_back(
          resourceAwsIamAccessKeyCreatedAtJsonList[resourceAwsIamAccessKeyCreatedAtIndex].AsObject());
    }
  ...
  if (jsonValue.ValueExists("ResourceAwsIamUserUserName")) {
    ...
    for (unsigned resourceAwsIamUserUserNameIndex = 0; resourceAwsIamUserUserNameIndex < resourceAwsIamUserUserNameJsonList.GetLength();
         ++resourceAwsIamUserUserNameIndex) {
  ...
  if (jsonValue.ValueExists("ResourceContainerName")) {
    ...
    for (unsigned resourceContainerNameIndex = 0; resourceContainerNameIndex < resourceContainerNameJsonList.GetLength();
         ++resourceContainerNameIndex) {
  ...
  if (jsonValue.ValueExists("ResourceContainerImageId")) {
    ...
    for (unsigned resourceContainerImageIdIndex = 0; resourceContainerImageIdIndex < resourceContainerImageIdJsonList.GetLength();
         ++resourceContainerImageIdIndex) {
  ...
  if (jsonValue.ValueExists("ResourceContainerImageName")) {
    ...
    for (unsigned resourceContainerImageNameIndex = 0; resourceContainerImageNameIndex < resourceContainerImageNameJsonList.GetLength();
         ++resourceContainerImageNameIndex) {
  ...
  if (jsonValue.ValueExists("ResourceContainerLaunchedAt")) {
    ...
    for (unsigned resourceContainerLaunchedAtIndex = 0; resourceContainerLaunchedAtIndex < resourceContainerLaunchedAtJsonList.GetLength();
         ++resourceContainerLaunchedAtIndex) {
  ...
  if (jsonValue.ValueExists("ResourceDetailsOther")) {
    ...
    for (unsigned resourceDetailsOtherIndex = 0; resourceDetailsOtherIndex < resourceDetailsOtherJsonList.GetLength();
         ++resourceDetailsOtherIndex) {
  ...
  if (jsonValue.ValueExists("RelatedFindingsProductArn")) {
    ...
    for (unsigned relatedFindingsProductArnIndex = 0; relatedFindingsProductArnIndex < relatedFindingsProductArnJsonList.GetLength();
         ++relatedFindingsProductArnIndex) {
  ...
  if (jsonValue.ValueExists("FindingProviderFieldsConfidence")) {
    ...
    for (unsigned findingProviderFieldsConfidenceIndex = 0;
         findingProviderFieldsConfidenceIndex < findingProviderFieldsConfidenceJsonList.GetLength();
         ++findingProviderFieldsConfidenceIndex) {
  ...
  if (jsonValue.ValueExists("FindingProviderFieldsCriticality")) {
    ...
    for (unsigned findingProviderFieldsCriticalityIndex = 0;
         findingProviderFieldsCriticalityIndex < findingProviderFieldsCriticalityJsonList.GetLength();
         ++findingProviderFieldsCriticalityIndex) {
      m_findingProviderFieldsCriticality.push_back(
          findingProviderFieldsCriticalityJsonList[findingProviderFieldsCriticalityIndex].AsObject());
    }
    m_findingProviderFieldsCriticalityHasBeenSet = true;
  }
  if (jsonValue.ValueExists("FindingProviderFieldsRelatedFindingsId")) {
    Aws::Utils::Array<JsonView> findingProviderFieldsRelatedFindingsIdJsonList =
        jsonValue.GetArray("FindingProviderFieldsRelatedFindingsId");
    for (unsigned findingProviderFieldsRelatedFindingsIdIndex = 0;
         findingProviderFieldsRelatedFindingsIdIndex < findingProviderFieldsRelatedFindingsIdJsonList.GetLength();
         ++findingProviderFieldsRelatedFindingsIdIndex) {
      m_findingProviderFieldsRelatedFindingsId.push_back(
          findingProviderFieldsRelatedFindingsIdJsonList[findingProviderFieldsRelatedFindingsIdIndex].AsObject());
    }
  ...
  if (jsonValue.ValueExists("FindingProviderFieldsRelatedFindingsProductArn")) {
    Aws::Utils::Array<JsonView> findingProviderFieldsRelatedFindingsProductArnJsonList =
        jsonValue.GetArray("FindingProviderFieldsRelatedFindingsProductArn");
    for (unsigned findingProviderFieldsRelatedFindingsProductArnIndex = 0;
         findingProviderFieldsRelatedFindingsProductArnIndex < findingProviderFieldsRelatedFindingsProductArnJsonList.GetLength();
         ++findingProviderFieldsRelatedFindingsProductArnIndex) {
      m_findingProviderFieldsRelatedFindingsProductArn.push_back(
          findingProviderFieldsRelatedFindingsProductArnJsonList[findingProviderFieldsRelatedFindingsProductArnIndex].AsObject());
    }
  ...
  if (jsonValue.ValueExists("FindingProviderFieldsSeverityLabel")) {
    ...
    for (unsigned findingProviderFieldsSeverityLabelIndex = 0;
         findingProviderFieldsSeverityLabelIndex < findingProviderFieldsSeverityLabelJsonList.GetLength();
         ++findingProviderFieldsSeverityLabelIndex) {
      m_findingProviderFieldsSeverityLabel.push_back(
          findingProviderFieldsSeverityLabelJsonList[findingProviderFieldsSeverityLabelIndex].AsObject());
    }
  ...
  if (jsonValue.ValueExists("FindingProviderFieldsSeverityOriginal")) {
    ...
    for (unsigned findingProviderFieldsSeverityOriginalIndex = 0;
         findingProviderFieldsSeverityOriginalIndex < findingProviderFieldsSeverityOriginalJsonList.GetLength();
         ++findingProviderFieldsSeverityOriginalIndex) {
      m_findingProviderFieldsSeverityOriginal.push_back(
          findingProviderFieldsSeverityOriginalJsonList[findingProviderFieldsSeverityOriginalIndex].AsObject());
    }
  ...
  if (jsonValue.ValueExists("FindingProviderFieldsTypes")) {
    ...
    for (unsigned findingProviderFieldsTypesIndex = 0; findingProviderFieldsTypesIndex < findingProviderFieldsTypesJsonList.GetLength();
         ++findingProviderFieldsTypesIndex) {
  ...
  if (jsonValue.ValueExists("ComplianceSecurityControlId")) {
    ...
    for (unsigned complianceSecurityControlIdIndex = 0; complianceSecurityControlIdIndex < complianceSecurityControlIdJsonList.GetLength();
         ++complianceSecurityControlIdIndex) {
  ...
  if (jsonValue.ValueExists("ComplianceAssociatedStandardsId")) {
    ...
    for (unsigned complianceAssociatedStandardsIdIndex = 0;
         complianceAssociatedStandardsIdIndex < complianceAssociatedStandardsIdJsonList.GetLength();
         ++complianceAssociatedStandardsIdIndex) {
  ...
  if (jsonValue.ValueExists("VulnerabilitiesExploitAvailable")) {
    ...
    for (unsigned vulnerabilitiesExploitAvailableIndex = 0;
         vulnerabilitiesExploitAvailableIndex < vulnerabilitiesExploitAvailableJsonList.GetLength();
  ...
  if (jsonValue.ValueExists("VulnerabilitiesFixAvailable")) {
    ...
    for (unsigned vulnerabilitiesFixAvailableIndex = 0; vulnerabilitiesFixAvailableIndex < vulnerabilitiesFixAvailableJsonList.GetLength();
         ++vulnerabilitiesFixAvailableIndex) {
  ...
  if (jsonValue.ValueExists("ComplianceSecurityControlParametersName")) {
    Aws::Utils::Array<JsonView> complianceSecurityControlParametersNameJsonList =
        jsonValue.GetArray("ComplianceSecurityControlParametersName");
    for (unsigned complianceSecurityControlParametersNameIndex = 0;
         complianceSecurityControlParametersNameIndex < complianceSecurityControlParametersNameJsonList.GetLength();
         ++complianceSecurityControlParametersNameIndex) {
      m_complianceSecurityControlParametersName.push_back(
          complianceSecurityControlParametersNameJsonList[complianceSecurityControlParametersNameIndex].AsObject());
    }
  ...
  if (jsonValue.ValueExists("ComplianceSecurityControlParametersValue")) {
    Aws::Utils::Array<JsonView> complianceSecurityControlParametersValueJsonList =
        jsonValue.GetArray("ComplianceSecurityControlParametersValue");
    for (unsigned complianceSecurityControlParametersValueIndex = 0;
         complianceSecurityControlParametersValueIndex < complianceSecurityControlParametersValueJsonList.GetLength();
         ++complianceSecurityControlParametersValueIndex) {
      m_complianceSecurityControlParametersValue.push_back(
          complianceSecurityControlParametersValueJsonList[complianceSecurityControlParametersValueIndex].AsObject());
    }
  ...
  if (jsonValue.ValueExists("ResourceApplicationName")) {
    ...
    for (unsigned resourceApplicationNameIndex = 0; resourceApplicationNameIndex < resourceApplicationNameJsonList.GetLength();
         ++resourceApplicationNameIndex) {
  ...
  if (jsonValue.ValueExists("ResourceApplicationArn")) {
    ...
    for (unsigned resourceApplicationArnIndex = 0; resourceApplicationArnIndex < resourceApplicationArnJsonList.GetLength();
         ++resourceApplicationArnIndex) {
...
JsonValue AwsSecurityFindingFilters::Jsonize() const {
  ...
  if (m_networkDestinationDomainHasBeenSet) {
    ...
    for (unsigned networkDestinationDomainIndex = 0; networkDestinationDomainIndex < networkDestinationDomainJsonList.GetLength();
         ++networkDestinationDomainIndex) {
      networkDestinationDomainJsonList[networkDestinationDomainIndex].AsObject(
          m_networkDestinationDomain[networkDestinationDomainIndex].Jsonize());
    }
  ...
  if (m_threatIntelIndicatorTypeHasBeenSet) {
    ...
    for (unsigned threatIntelIndicatorTypeIndex = 0; threatIntelIndicatorTypeIndex < threatIntelIndicatorTypeJsonList.GetLength();
         ++threatIntelIndicatorTypeIndex) {
      threatIntelIndicatorTypeJsonList[threatIntelIndicatorTypeIndex].AsObject(
          m_threatIntelIndicatorType[threatIntelIndicatorTypeIndex].Jsonize());
    }
  ...
  if (m_threatIntelIndicatorValueHasBeenSet) {
    ...
    for (unsigned threatIntelIndicatorValueIndex = 0; threatIntelIndicatorValueIndex < threatIntelIndicatorValueJsonList.GetLength();
         ++threatIntelIndicatorValueIndex) {
      threatIntelIndicatorValueJsonList[threatIntelIndicatorValueIndex].AsObject(
          m_threatIntelIndicatorValue[threatIntelIndicatorValueIndex].Jsonize());
    }
  ...
  if (m_threatIntelIndicatorCategoryHasBeenSet) {
    ...
    for (unsigned threatIntelIndicatorCategoryIndex = 0;
         threatIntelIndicatorCategoryIndex < threatIntelIndicatorCategoryJsonList.GetLength(); ++threatIntelIndicatorCategoryIndex) {
      threatIntelIndicatorCategoryJsonList[threatIntelIndicatorCategoryIndex].AsObject(
          m_threatIntelIndicatorCategory[threatIntelIndicatorCategoryIndex].Jsonize());
    }
  ...
  if (m_threatIntelIndicatorLastObservedAtHasBeenSet) {
    ...
    for (unsigned threatIntelIndicatorLastObservedAtIndex = 0;
         ...
         ++threatIntelIndicatorLastObservedAtIndex) {
      threatIntelIndicatorLastObservedAtJsonList[threatIntelIndicatorLastObservedAtIndex].AsObject(
          m_threatIntelIndicatorLastObservedAt[threatIntelIndicatorLastObservedAtIndex].Jsonize());
    }
  ...
  if (m_threatIntelIndicatorSourceHasBeenSet) {
    ...
    for (unsigned threatIntelIndicatorSourceIndex = 0; threatIntelIndicatorSourceIndex < threatIntelIndicatorSourceJsonList.GetLength();
         ++threatIntelIndicatorSourceIndex) {
      threatIntelIndicatorSourceJsonList[threatIntelIndicatorSourceIndex].AsObject(
          m_threatIntelIndicatorSource[threatIntelIndicatorSourceIndex].Jsonize());
    }
  ...
  if (m_threatIntelIndicatorSourceUrlHasBeenSet) {
    ...
    for (unsigned threatIntelIndicatorSourceUrlIndex = 0;
         threatIntelIndicatorSourceUrlIndex < threatIntelIndicatorSourceUrlJsonList.GetLength(); ++threatIntelIndicatorSourceUrlIndex) {
      threatIntelIndicatorSourceUrlJsonList[threatIntelIndicatorSourceUrlIndex].AsObject(
          m_threatIntelIndicatorSourceUrl[threatIntelIndicatorSourceUrlIndex].Jsonize());
    }
  ...
  if (m_resourceAwsEc2InstanceTypeHasBeenSet) {
    ...
    for (unsigned resourceAwsEc2InstanceTypeIndex = 0; resourceAwsEc2InstanceTypeIndex < resourceAwsEc2InstanceTypeJsonList.GetLength();
         ++resourceAwsEc2InstanceTypeIndex) {
      resourceAwsEc2InstanceTypeJsonList[resourceAwsEc2InstanceTypeIndex].AsObject(
          m_resourceAwsEc2InstanceType[resourceAwsEc2InstanceTypeIndex].Jsonize());
    }
  ...
  if (m_resourceAwsEc2InstanceImageIdHasBeenSet) {
    ...
    for (unsigned resourceAwsEc2InstanceImageIdIndex = 0;
         resourceAwsEc2InstanceImageIdIndex < resourceAwsEc2InstanceImageIdJsonList.GetLength(); ++resourceAwsEc2InstanceImageIdIndex) {
      resourceAwsEc2InstanceImageIdJsonList[resourceAwsEc2InstanceImageIdIndex].AsObject(
          m_resourceAwsEc2InstanceImageId[resourceAwsEc2InstanceImageIdIndex].Jsonize());
    }
  ...
  if (m_resourceAwsEc2InstanceIpV4AddressesHasBeenSet) {
    ...
    for (unsigned resourceAwsEc2InstanceIpV4AddressesIndex = 0;
         ...
         ++resourceAwsEc2InstanceIpV4AddressesIndex) {
      resourceAwsEc2InstanceIpV4AddressesJsonList[resourceAwsEc2InstanceIpV4AddressesIndex].AsObject(
          m_resourceAwsEc2InstanceIpV4Addresses[resourceAwsEc2InstanceIpV4AddressesIndex].Jsonize());
    }
  ...
  if (m_resourceAwsEc2InstanceIpV6AddressesHasBeenSet) {
    ...
    for (unsigned resourceAwsEc2InstanceIpV6AddressesIndex = 0;
         ...
         ++resourceAwsEc2InstanceIpV6AddressesIndex) {
      resourceAwsEc2InstanceIpV6AddressesJsonList[resourceAwsEc2InstanceIpV6AddressesIndex].AsObject(
          m_resourceAwsEc2InstanceIpV6Addresses[resourceAwsEc2InstanceIpV6AddressesIndex].Jsonize());
    }
  ...
  if (m_resourceAwsEc2InstanceKeyNameHasBeenSet) {
    ...
    for (unsigned resourceAwsEc2InstanceKeyNameIndex = 0;
         resourceAwsEc2InstanceKeyNameIndex < resourceAwsEc2InstanceKeyNameJsonList.GetLength(); ++resourceAwsEc2InstanceKeyNameIndex) {
      resourceAwsEc2InstanceKeyNameJsonList[resourceAwsEc2InstanceKeyNameIndex].AsObject(
          m_resourceAwsEc2InstanceKeyName[resourceAwsEc2InstanceKeyNameIndex].Jsonize());
    }
  ...
  if (m_resourceAwsEc2InstanceIamInstanceProfileArnHasBeenSet) {
    ...
    for (unsigned resourceAwsEc2InstanceIamInstanceProfileArnIndex = 0;
         ...
         ++resourceAwsEc2InstanceIamInstanceProfileArnIndex) {
      resourceAwsEc2InstanceIamInstanceProfileArnJsonList[resourceAwsEc2InstanceIamInstanceProfileArnIndex].AsObject(
          m_resourceAwsEc2InstanceIamInstanceProfileArn[resourceAwsEc2InstanceIamInstanceProfileArnIndex].Jsonize());
    }
  ...
  if (m_resourceAwsEc2InstanceVpcIdHasBeenSet) {
    ...
    for (unsigned resourceAwsEc2InstanceVpcIdIndex = 0; resourceAwsEc2InstanceVpcIdIndex < resourceAwsEc2InstanceVpcIdJsonList.GetLength();
         ++resourceAwsEc2InstanceVpcIdIndex) {
      resourceAwsEc2InstanceVpcIdJsonList[resourceAwsEc2InstanceVpcIdIndex].AsObject(
          m_resourceAwsEc2InstanceVpcId[resourceAwsEc2InstanceVpcIdIndex].Jsonize());
    }
  ...
  if (m_resourceAwsEc2InstanceSubnetIdHasBeenSet) {
    ...
    for (unsigned resourceAwsEc2InstanceSubnetIdIndex = 0;
         resourceAwsEc2InstanceSubnetIdIndex < resourceAwsEc2InstanceSubnetIdJsonList.GetLength(); ++resourceAwsEc2InstanceSubnetIdIndex) {
      resourceAwsEc2InstanceSubnetIdJsonList[resourceAwsEc2InstanceSubnetIdIndex].AsObject(
          m_resourceAwsEc2InstanceSubnetId[resourceAwsEc2InstanceSubnetIdIndex].Jsonize());
    }
  ...
  if (m_resourceAwsEc2InstanceLaunchedAtHasBeenSet) {
    ...
    for (unsigned resourceAwsEc2InstanceLaunchedAtIndex = 0;
         ...
         ++resourceAwsEc2InstanceLaunchedAtIndex) {
      resourceAwsEc2InstanceLaunchedAtJsonList[resourceAwsEc2InstanceLaunchedAtIndex].AsObject(
          m_resourceAwsEc2InstanceLaunchedAt[resourceAwsEc2InstanceLaunchedAtIndex].Jsonize());
    }
  ...
  if (m_resourceAwsS3BucketOwnerIdHasBeenSet) {
    ...
    for (unsigned resourceAwsS3BucketOwnerIdIndex = 0; resourceAwsS3BucketOwnerIdIndex < resourceAwsS3BucketOwnerIdJsonList.GetLength();
         ++resourceAwsS3BucketOwnerIdIndex) {
      resourceAwsS3BucketOwnerIdJsonList[resourceAwsS3BucketOwnerIdIndex].AsObject(
          m_resourceAwsS3BucketOwnerId[resourceAwsS3BucketOwnerIdIndex].Jsonize());
    }
  ...
  if (m_resourceAwsS3BucketOwnerNameHasBeenSet) {
    ...
    for (unsigned resourceAwsS3BucketOwnerNameIndex = 0;
         resourceAwsS3BucketOwnerNameIndex < resourceAwsS3BucketOwnerNameJsonList.GetLength(); ++resourceAwsS3BucketOwnerNameIndex) {
      resourceAwsS3BucketOwnerNameJsonList[resourceAwsS3BucketOwnerNameIndex].AsObject(
          m_resourceAwsS3BucketOwnerName[resourceAwsS3BucketOwnerNameIndex].Jsonize());
    }
  ...
  if (m_resourceAwsIamAccessKeyPrincipalNameHasBeenSet) {
    ...
    for (unsigned resourceAwsIamAccessKeyPrincipalNameIndex = 0;
         ...
         ++resourceAwsIamAccessKeyPrincipalNameIndex) {
      resourceAwsIamAccessKeyPrincipalNameJsonList[resourceAwsIamAccessKeyPrincipalNameIndex].AsObject(
          m_resourceAwsIamAccessKeyPrincipalName[resourceAwsIamAccessKeyPrincipalNameIndex].Jsonize());
    }
  ...
  if (m_resourceAwsIamAccessKeyStatusHasBeenSet) {
    ...
    for (unsigned resourceAwsIamAccessKeyStatusIndex = 0;
         resourceAwsIamAccessKeyStatusIndex < resourceAwsIamAccessKeyStatusJsonList.GetLength(); ++resourceAwsIamAccessKeyStatusIndex) {
      resourceAwsIamAccessKeyStatusJsonList[resourceAwsIamAccessKeyStatusIndex].AsObject(
          m_resourceAwsIamAccessKeyStatus[resourceAwsIamAccessKeyStatusIndex].Jsonize());
    }
  ...
  if (m_resourceAwsIamAccessKeyCreatedAtHasBeenSet) {
    ...
    for (unsigned resourceAwsIamAccessKeyCreatedAtIndex = 0;
         ...
         ++resourceAwsIamAccessKeyCreatedAtIndex) {
      resourceAwsIamAccessKeyCreatedAtJsonList[resourceAwsIamAccessKeyCreatedAtIndex].AsObject(
          m_resourceAwsIamAccessKeyCreatedAt[resourceAwsIamAccessKeyCreatedAtIndex].Jsonize());
    }
  ...
  if (m_resourceAwsIamUserUserNameHasBeenSet) {
    ...
    for (unsigned resourceAwsIamUserUserNameIndex = 0; resourceAwsIamUserUserNameIndex < resourceAwsIamUserUserNameJsonList.GetLength();
         ++resourceAwsIamUserUserNameIndex) {
      resourceAwsIamUserUserNameJsonList[resourceAwsIamUserUserNameIndex].AsObject(
          m_resourceAwsIamUserUserName[resourceAwsIamUserUserNameIndex].Jsonize());
    }
  ...
  if (m_resourceContainerImageIdHasBeenSet) {
    ...
    for (unsigned resourceContainerImageIdIndex = 0; resourceContainerImageIdIndex < resourceContainerImageIdJsonList.GetLength();
         ++resourceContainerImageIdIndex) {
      resourceContainerImageIdJsonList[resourceContainerImageIdIndex].AsObject(
          m_resourceContainerImageId[resourceContainerImageIdIndex].Jsonize());
    }
  ...
  if (m_resourceContainerImageNameHasBeenSet) {
    ...
    for (unsigned resourceContainerImageNameIndex = 0; resourceContainerImageNameIndex < resourceContainerImageNameJsonList.GetLength();
         ++resourceContainerImageNameIndex) {
      resourceContainerImageNameJsonList[resourceContainerImageNameIndex].AsObject(
          m_resourceContainerImageName[resourceContainerImageNameIndex].Jsonize());
    }
  ...
  if (m_resourceContainerLaunchedAtHasBeenSet) {
    ...
    for (unsigned resourceContainerLaunchedAtIndex = 0; resourceContainerLaunchedAtIndex < resourceContainerLaunchedAtJsonList.GetLength();
         ++resourceContainerLaunchedAtIndex) {
      resourceContainerLaunchedAtJsonList[resourceContainerLaunchedAtIndex].AsObject(
          m_resourceContainerLaunchedAt[resourceContainerLaunchedAtIndex].Jsonize());
    }
  ...
  if (m_relatedFindingsProductArnHasBeenSet) {
    ...
    for (unsigned relatedFindingsProductArnIndex = 0; relatedFindingsProductArnIndex < relatedFindingsProductArnJsonList.GetLength();
         ++relatedFindingsProductArnIndex) {
      relatedFindingsProductArnJsonList[relatedFindingsProductArnIndex].AsObject(
          m_relatedFindingsProductArn[relatedFindingsProductArnIndex].Jsonize());
    }
  ...
  if (m_findingProviderFieldsConfidenceHasBeenSet) {
    ...
    for (unsigned findingProviderFieldsConfidenceIndex = 0;
         findingProviderFieldsConfidenceIndex < findingProviderFieldsConfidenceJsonList.GetLength();
         ++findingProviderFieldsConfidenceIndex) {
      findingProviderFieldsConfidenceJsonList[findingProviderFieldsConfidenceIndex].AsObject(
          m_findingProviderFieldsConfidence[findingProviderFieldsConfidenceIndex].Jsonize());
    }
  ...
  if (m_findingProviderFieldsCriticalityHasBeenSet) {
    ...
    for (unsigned findingProviderFieldsCriticalityIndex = 0;
         ...
         ++findingProviderFieldsCriticalityIndex) {
      findingProviderFieldsCriticalityJsonList[findingProviderFieldsCriticalityIndex].AsObject(
          m_findingProviderFieldsCriticality[findingProviderFieldsCriticalityIndex].Jsonize());
    }
  ...
  if (m_findingProviderFieldsRelatedFindingsIdHasBeenSet) {
    ...
    for (unsigned findingProviderFieldsRelatedFindingsIdIndex = 0;
         ...
         ++findingProviderFieldsRelatedFindingsIdIndex) {
      findingProviderFieldsRelatedFindingsIdJsonList[findingProviderFieldsRelatedFindingsIdIndex].AsObject(
          m_findingProviderFieldsRelatedFindingsId[findingProviderFieldsRelatedFindingsIdIndex].Jsonize());
    }
  ...
  if (m_findingProviderFieldsRelatedFindingsProductArnHasBeenSet) {
    Aws::Utils::Array<JsonValue> findingProviderFieldsRelatedFindingsProductArnJsonList(
        m_findingProviderFieldsRelatedFindingsProductArn.size());
    for (unsigned findingProviderFieldsRelatedFindingsProductArnIndex = 0;
         findingProviderFieldsRelatedFindingsProductArnIndex < findingProviderFieldsRelatedFindingsProductArnJsonList.GetLength();
         ++findingProviderFieldsRelatedFindingsProductArnIndex) {
      findingProviderFieldsRelatedFindingsProductArnJsonList[findingProviderFieldsRelatedFindingsProductArnIndex].AsObject(
          m_findingProviderFieldsRelatedFindingsProductArn[findingProviderFieldsRelatedFindingsProductArnIndex].Jsonize());
    }
  ...
  if (m_findingProviderFieldsSeverityLabelHasBeenSet) {
    ...
    for (unsigned findingProviderFieldsSeverityLabelIndex = 0;
         ...
         ++findingProviderFieldsSeverityLabelIndex) {
      findingProviderFieldsSeverityLabelJsonList[findingProviderFieldsSeverityLabelIndex].AsObject(
          m_findingProviderFieldsSeverityLabel[findingProviderFieldsSeverityLabelIndex].Jsonize());
    }
  ...
  if (m_findingProviderFieldsSeverityOriginalHasBeenSet) {
    ...
    for (unsigned findingProviderFieldsSeverityOriginalIndex = 0;
         ...
         ++findingProviderFieldsSeverityOriginalIndex) {
      findingProviderFieldsSeverityOriginalJsonList[findingProviderFieldsSeverityOriginalIndex].AsObject(
          m_findingProviderFieldsSeverityOriginal[findingProviderFieldsSeverityOriginalIndex].Jsonize());
    }
  ...
  if (m_findingProviderFieldsTypesHasBeenSet) {
    ...
    for (unsigned findingProviderFieldsTypesIndex = 0; findingProviderFieldsTypesIndex < findingProviderFieldsTypesJsonList.GetLength();
         ++findingProviderFieldsTypesIndex) {
      findingProviderFieldsTypesJsonList[findingProviderFieldsTypesIndex].AsObject(
          m_findingProviderFieldsTypes[findingProviderFieldsTypesIndex].Jsonize());
    }
  ...
  if (m_complianceSecurityControlIdHasBeenSet) {
    ...
    for (unsigned complianceSecurityControlIdIndex = 0; complianceSecurityControlIdIndex < complianceSecurityControlIdJsonList.GetLength();
         ++complianceSecurityControlIdIndex) {
      complianceSecurityControlIdJsonList[complianceSecurityControlIdIndex].AsObject(
          m_complianceSecurityControlId[complianceSecurityControlIdIndex].Jsonize());
    }
  ...
  if (m_complianceAssociatedStandardsIdHasBeenSet) {
    ...
    for (unsigned complianceAssociatedStandardsIdIndex = 0;
         complianceAssociatedStandardsIdIndex < complianceAssociatedStandardsIdJsonList.GetLength();
         ++complianceAssociatedStandardsIdIndex) {
      complianceAssociatedStandardsIdJsonList[complianceAssociatedStandardsIdIndex].AsObject(
          m_complianceAssociatedStandardsId[complianceAssociatedStandardsIdIndex].Jsonize());
    }
  ...
  if (m_vulnerabilitiesExploitAvailableHasBeenSet) {
    ...
    for (unsigned vulnerabilitiesExploitAvailableIndex = 0;
         vulnerabilitiesExploitAvailableIndex < vulnerabilitiesExploitAvailableJsonList.GetLength();
         ++vulnerabilitiesExploitAvailableIndex) {
      vulnerabilitiesExploitAvailableJsonList[vulnerabilitiesExploitAvailableIndex].AsObject(
          m_vulnerabilitiesExploitAvailable[vulnerabilitiesExploitAvailableIndex].Jsonize());
    }
  ...
  if (m_vulnerabilitiesFixAvailableHasBeenSet) {
    ...
    for (unsigned vulnerabilitiesFixAvailableIndex = 0; vulnerabilitiesFixAvailableIndex < vulnerabilitiesFixAvailableJsonList.GetLength();
         ++vulnerabilitiesFixAvailableIndex) {
      vulnerabilitiesFixAvailableJsonList[vulnerabilitiesFixAvailableIndex].AsObject(
          m_vulnerabilitiesFixAvailable[vulnerabilitiesFixAvailableIndex].Jsonize());
    }
  ...
  if (m_complianceSecurityControlParametersNameHasBeenSet) {
    ...
    for (unsigned complianceSecurityControlParametersNameIndex = 0;
         ...
         ++complianceSecurityControlParametersNameIndex) {
      complianceSecurityControlParametersNameJsonList[complianceSecurityControlParametersNameIndex].AsObject(
          m_complianceSecurityControlParametersName[complianceSecurityControlParametersNameIndex].Jsonize());
    }
  ...
  if (m_complianceSecurityControlParametersValueHasBeenSet) {
    ...
    for (unsigned complianceSecurityControlParametersValueIndex = 0;
         ...
         ++complianceSecurityControlParametersValueIndex) {
      complianceSecurityControlParametersValueJsonList[complianceSecurityControlParametersValueIndex].AsObject(
          m_complianceSecurityControlParametersValue[complianceSecurityControlParametersValueIndex].Jsonize());
    }
  ...
  if (m_resourceApplicationNameHasBeenSet) {
    ...
    for (unsigned resourceApplicationNameIndex = 0; resourceApplicationNameIndex < resourceApplicationNameJsonList.GetLength();
         ++resourceApplicationNameIndex) {
      resourceApplicationNameJsonList[resourceApplicationNameIndex].AsObject(
          m_resourceApplicationName[resourceApplicationNameIndex].Jsonize());
    }
