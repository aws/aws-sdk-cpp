...
AwsEc2LaunchTemplateDataInstanceRequirementsTotalLocalStorageGBDetails::
    AwsEc2LaunchTemplateDataInstanceRequirementsTotalLocalStorageGBDetails(JsonView jsonValue) {
  *this = jsonValue;
}

AwsEc2LaunchTemplateDataInstanceRequirementsTotalLocalStorageGBDetails&
AwsEc2LaunchTemplateDataInstanceRequirementsTotalLocalStorageGBDetails::operator=(JsonView jsonValue) {
