...
GetFindingsV2Result::GetFindingsV2Result(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

GetFindingsV2Result& GetFindingsV2Result::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
