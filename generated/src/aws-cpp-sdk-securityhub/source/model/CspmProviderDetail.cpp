...
CspmProviderDetail::CspmProviderDetail(JsonView jsonValue) { *this = jsonValue; }

CspmProviderDetail& CspmProviderDetail::operator=(JsonView jsonValue) {
...
JsonValue CspmProviderDetail::Jsonize() const {
  JsonValue payload;
