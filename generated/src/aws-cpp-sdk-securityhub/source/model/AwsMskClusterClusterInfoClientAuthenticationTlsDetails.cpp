...
AwsMskClusterClusterInfoClientAuthenticationTlsDetails& AwsMskClusterClusterInfoClientAuthenticationTlsDetails::operator=(
    JsonView jsonValue) {
  if (jsonValue.ValueExists("CertificateAuthorityArnList")) {
    ...
    for (unsigned certificateAuthorityArnListIndex = 0; certificateAuthorityArnListIndex < certificateAuthorityArnListJsonList.GetLength();
         ++certificateAuthorityArnListIndex) {
...
JsonValue AwsMskClusterClusterInfoClientAuthenticationTlsDetails::Jsonize() const {
  ...
  if (m_certificateAuthorityArnListHasBeenSet) {
    ...
    for (unsigned certificateAuthorityArnListIndex = 0; certificateAuthorityArnListIndex < certificateAuthorityArnListJsonList.GetLength();
         ++certificateAuthorityArnListIndex) {
      certificateAuthorityArnListJsonList[certificateAuthorityArnListIndex].AsString(
          m_certificateAuthorityArnList[certificateAuthorityArnListIndex]);
    }
