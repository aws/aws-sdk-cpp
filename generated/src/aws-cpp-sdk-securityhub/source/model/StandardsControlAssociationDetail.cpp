...
StandardsControlAssociationDetail::StandardsControlAssociationDetail(JsonView jsonValue) { *this = jsonValue; }
...
StandardsControlAssociationDetail& StandardsControlAssociationDetail::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("StandardsControlArns")) {
    ...
    for (unsigned standardsControlArnsIndex = 0; standardsControlArnsIndex < standardsControlArnsJsonList.GetLength();
         ++standardsControlArnsIndex) {
