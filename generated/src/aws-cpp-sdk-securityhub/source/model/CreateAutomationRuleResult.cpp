...
CreateAutomationRuleResult::CreateAutomationRuleResult()
{
}

CreateAutomationRuleResult::CreateAutomationRuleResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
