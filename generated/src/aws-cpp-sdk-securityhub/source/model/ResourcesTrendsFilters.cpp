...
ResourcesTrendsFilters::ResourcesTrendsFilters(JsonView jsonValue) { *this = jsonValue; }

ResourcesTrendsFilters& ResourcesTrendsFilters::operator=(JsonView jsonValue) {
...
JsonValue ResourcesTrendsFilters::Jsonize() const {
  JsonValue payload;
