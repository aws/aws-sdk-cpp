...
SecurityControlsConfiguration::SecurityControlsConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
SecurityControlsConfiguration& SecurityControlsConfiguration::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("EnabledSecurityControlIdentifiers")) {
    ...
    for (unsigned enabledSecurityControlIdentifiersIndex = 0;
         enabledSecurityControlIdentifiersIndex < enabledSecurityControlIdentifiersJsonList.GetLength();
         ++enabledSecurityControlIdentifiersIndex) {
      m_enabledSecurityControlIdentifiers.push_back(
          enabledSecurityControlIdentifiersJsonList[enabledSecurityControlIdentifiersIndex].AsString());
    }
  ...
  if (jsonValue.ValueExists("DisabledSecurityControlIdentifiers")) {
    ...
    for (unsigned disabledSecurityControlIdentifiersIndex = 0;
         disabledSecurityControlIdentifiersIndex < disabledSecurityControlIdentifiersJsonList.GetLength();
         ++disabledSecurityControlIdentifiersIndex) {
      m_disabledSecurityControlIdentifiers.push_back(
          disabledSecurityControlIdentifiersJsonList[disabledSecurityControlIdentifiersIndex].AsString());
    }
  ...
  if (jsonValue.ValueExists("SecurityControlCustomParameters")) {
    ...
    for (unsigned securityControlCustomParametersIndex = 0;
         securityControlCustomParametersIndex < securityControlCustomParametersJsonList.GetLength();
         ++securityControlCustomParametersIndex) {
...
JsonValue SecurityControlsConfiguration::Jsonize() const {
  ...
  if (m_enabledSecurityControlIdentifiersHasBeenSet) {
    ...
    for (unsigned enabledSecurityControlIdentifiersIndex = 0;
         ...
         ++enabledSecurityControlIdentifiersIndex) {
      enabledSecurityControlIdentifiersJsonList[enabledSecurityControlIdentifiersIndex].AsString(
          m_enabledSecurityControlIdentifiers[enabledSecurityControlIdentifiersIndex]);
    }
  ...
  if (m_disabledSecurityControlIdentifiersHasBeenSet) {
    ...
    for (unsigned disabledSecurityControlIdentifiersIndex = 0;
         ...
         ++disabledSecurityControlIdentifiersIndex) {
      disabledSecurityControlIdentifiersJsonList[disabledSecurityControlIdentifiersIndex].AsString(
          m_disabledSecurityControlIdentifiers[disabledSecurityControlIdentifiersIndex]);
    }
  ...
  if (m_securityControlCustomParametersHasBeenSet) {
    ...
    for (unsigned securityControlCustomParametersIndex = 0;
         securityControlCustomParametersIndex < securityControlCustomParametersJsonList.GetLength();
         ++securityControlCustomParametersIndex) {
      securityControlCustomParametersJsonList[securityControlCustomParametersIndex].AsObject(
          m_securityControlCustomParameters[securityControlCustomParametersIndex].Jsonize());
    }
