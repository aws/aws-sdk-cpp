...
AwsEc2VpnConnectionOptionsTunnelOptionsDetails::AwsEc2VpnConnectionOptionsTunnelOptionsDetails(JsonView jsonValue) { *this = jsonValue; }
...
AwsEc2VpnConnectionOptionsTunnelOptionsDetails& AwsEc2VpnConnectionOptionsTunnelOptionsDetails::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("Phase1DhGroupNumbers")) {
    ...
    for (unsigned phase1DhGroupNumbersIndex = 0; phase1DhGroupNumbersIndex < phase1DhGroupNumbersJsonList.GetLength();
         ++phase1DhGroupNumbersIndex) {
  ...
  if (jsonValue.ValueExists("Phase1EncryptionAlgorithms")) {
    ...
    for (unsigned phase1EncryptionAlgorithmsIndex = 0; phase1EncryptionAlgorithmsIndex < phase1EncryptionAlgorithmsJsonList.GetLength();
         ++phase1EncryptionAlgorithmsIndex) {
  ...
  if (jsonValue.ValueExists("Phase1IntegrityAlgorithms")) {
    ...
    for (unsigned phase1IntegrityAlgorithmsIndex = 0; phase1IntegrityAlgorithmsIndex < phase1IntegrityAlgorithmsJsonList.GetLength();
         ++phase1IntegrityAlgorithmsIndex) {
  ...
  if (jsonValue.ValueExists("Phase2DhGroupNumbers")) {
    ...
    for (unsigned phase2DhGroupNumbersIndex = 0; phase2DhGroupNumbersIndex < phase2DhGroupNumbersJsonList.GetLength();
         ++phase2DhGroupNumbersIndex) {
  ...
  if (jsonValue.ValueExists("Phase2EncryptionAlgorithms")) {
    ...
    for (unsigned phase2EncryptionAlgorithmsIndex = 0; phase2EncryptionAlgorithmsIndex < phase2EncryptionAlgorithmsJsonList.GetLength();
         ++phase2EncryptionAlgorithmsIndex) {
  ...
  if (jsonValue.ValueExists("Phase2IntegrityAlgorithms")) {
    ...
    for (unsigned phase2IntegrityAlgorithmsIndex = 0; phase2IntegrityAlgorithmsIndex < phase2IntegrityAlgorithmsJsonList.GetLength();
         ++phase2IntegrityAlgorithmsIndex) {
...
JsonValue AwsEc2VpnConnectionOptionsTunnelOptionsDetails::Jsonize() const {
  ...
  if (m_phase1EncryptionAlgorithmsHasBeenSet) {
    ...
    for (unsigned phase1EncryptionAlgorithmsIndex = 0; phase1EncryptionAlgorithmsIndex < phase1EncryptionAlgorithmsJsonList.GetLength();
         ++phase1EncryptionAlgorithmsIndex) {
      phase1EncryptionAlgorithmsJsonList[phase1EncryptionAlgorithmsIndex].AsString(
          m_phase1EncryptionAlgorithms[phase1EncryptionAlgorithmsIndex]);
    }
  ...
  if (m_phase1IntegrityAlgorithmsHasBeenSet) {
    ...
    for (unsigned phase1IntegrityAlgorithmsIndex = 0; phase1IntegrityAlgorithmsIndex < phase1IntegrityAlgorithmsJsonList.GetLength();
         ++phase1IntegrityAlgorithmsIndex) {
      phase1IntegrityAlgorithmsJsonList[phase1IntegrityAlgorithmsIndex].AsString(
          m_phase1IntegrityAlgorithms[phase1IntegrityAlgorithmsIndex]);
    }
  ...
  if (m_phase2EncryptionAlgorithmsHasBeenSet) {
    ...
    for (unsigned phase2EncryptionAlgorithmsIndex = 0; phase2EncryptionAlgorithmsIndex < phase2EncryptionAlgorithmsJsonList.GetLength();
         ++phase2EncryptionAlgorithmsIndex) {
      phase2EncryptionAlgorithmsJsonList[phase2EncryptionAlgorithmsIndex].AsString(
          m_phase2EncryptionAlgorithms[phase2EncryptionAlgorithmsIndex]);
    }
  ...
  if (m_phase2IntegrityAlgorithmsHasBeenSet) {
    ...
    for (unsigned phase2IntegrityAlgorithmsIndex = 0; phase2IntegrityAlgorithmsIndex < phase2IntegrityAlgorithmsJsonList.GetLength();
         ++phase2IntegrityAlgorithmsIndex) {
      phase2IntegrityAlgorithmsJsonList[phase2IntegrityAlgorithmsIndex].AsString(
          m_phase2IntegrityAlgorithms[phase2IntegrityAlgorithmsIndex]);
    }
