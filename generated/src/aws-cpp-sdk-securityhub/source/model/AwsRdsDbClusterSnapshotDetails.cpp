...
AwsRdsDbClusterSnapshotDetails::AwsRdsDbClusterSnapshotDetails(JsonView jsonValue) { *this = jsonValue; }
...
AwsRdsDbClusterSnapshotDetails& AwsRdsDbClusterSnapshotDetails::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("DbClusterSnapshotAttributes")) {
    ...
    for (unsigned dbClusterSnapshotAttributesIndex = 0; dbClusterSnapshotAttributesIndex < dbClusterSnapshotAttributesJsonList.GetLength();
...
JsonValue AwsRdsDbClusterSnapshotDetails::Jsonize() const {
  ...
  if (m_dbClusterSnapshotAttributesHasBeenSet) {
    ...
    for (unsigned dbClusterSnapshotAttributesIndex = 0; dbClusterSnapshotAttributesIndex < dbClusterSnapshotAttributesJsonList.GetLength();
         ++dbClusterSnapshotAttributesIndex) {
      dbClusterSnapshotAttributesJsonList[dbClusterSnapshotAttributesIndex].AsObject(
          m_dbClusterSnapshotAttributes[dbClusterSnapshotAttributesIndex].Jsonize());
    }
