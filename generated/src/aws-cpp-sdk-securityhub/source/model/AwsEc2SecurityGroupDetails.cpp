...
AwsEc2SecurityGroupDetails::AwsEc2SecurityGroupDetails(JsonView jsonValue) { *this = jsonValue; }
...
AwsEc2SecurityGroupDetails& AwsEc2SecurityGroupDetails::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("IpPermissionsEgress")) {
    ...
    for (unsigned ipPermissionsEgressIndex = 0; ipPermissionsEgressIndex < ipPermissionsEgressJsonList.GetLength();
         ++ipPermissionsEgressIndex) {
