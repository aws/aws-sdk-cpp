...
AzureProviderConfiguration::AzureProviderConfiguration(JsonView jsonValue) { *this = jsonValue; }

AzureProviderConfiguration& AzureProviderConfiguration::operator=(JsonView jsonValue) {
...
JsonValue AzureProviderConfiguration::Jsonize() const {
  JsonValue payload;
