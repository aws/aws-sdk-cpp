...
AwsEc2ClientVpnEndpointAuthenticationOptionsMutualAuthenticationDetails::
    AwsEc2ClientVpnEndpointAuthenticationOptionsMutualAuthenticationDetails(JsonView jsonValue) {
  *this = jsonValue;
}

AwsEc2ClientVpnEndpointAuthenticationOptionsMutualAuthenticationDetails&
AwsEc2ClientVpnEndpointAuthenticationOptionsMutualAuthenticationDetails::operator=(JsonView jsonValue) {
