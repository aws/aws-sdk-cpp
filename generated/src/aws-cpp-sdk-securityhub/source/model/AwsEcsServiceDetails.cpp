...
AwsEcsServiceDetails::AwsEcsServiceDetails(JsonView jsonValue) { *this = jsonValue; }
...
AwsEcsServiceDetails& AwsEcsServiceDetails::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("PlacementStrategies")) {
    ...
    for (unsigned placementStrategiesIndex = 0; placementStrategiesIndex < placementStrategiesJsonList.GetLength();
         ++placementStrategiesIndex) {
