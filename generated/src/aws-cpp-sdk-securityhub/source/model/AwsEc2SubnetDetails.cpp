...
AwsEc2SubnetDetails::AwsEc2SubnetDetails(JsonView jsonValue) { *this = jsonValue; }
...
AwsEc2SubnetDetails& AwsEc2SubnetDetails::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("Ipv6CidrBlockAssociationSet")) {
    ...
    for (unsigned ipv6CidrBlockAssociationSetIndex = 0; ipv6CidrBlockAssociationSetIndex < ipv6CidrBlockAssociationSetJsonList.GetLength();
         ++ipv6CidrBlockAssociationSetIndex) {
...
JsonValue AwsEc2SubnetDetails::Jsonize() const {
  ...
  if (m_ipv6CidrBlockAssociationSetHasBeenSet) {
    ...
    for (unsigned ipv6CidrBlockAssociationSetIndex = 0; ipv6CidrBlockAssociationSetIndex < ipv6CidrBlockAssociationSetJsonList.GetLength();
         ++ipv6CidrBlockAssociationSetIndex) {
      ipv6CidrBlockAssociationSetJsonList[ipv6CidrBlockAssociationSetIndex].AsObject(
          m_ipv6CidrBlockAssociationSet[ipv6CidrBlockAssociationSetIndex].Jsonize());
    }
