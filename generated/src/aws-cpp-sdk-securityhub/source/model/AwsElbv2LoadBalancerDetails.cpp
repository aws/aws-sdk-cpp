...
AwsElbv2LoadBalancerDetails::AwsElbv2LoadBalancerDetails(JsonView jsonValue) { *this = jsonValue; }
...
AwsElbv2LoadBalancerDetails& AwsElbv2LoadBalancerDetails::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("LoadBalancerAttributes")) {
    ...
    for (unsigned loadBalancerAttributesIndex = 0; loadBalancerAttributesIndex < loadBalancerAttributesJsonList.GetLength();
