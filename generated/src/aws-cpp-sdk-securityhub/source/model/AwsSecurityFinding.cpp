...
AwsSecurityFinding::AwsSecurityFinding(JsonView jsonValue) { *this = jsonValue; }
...
AwsSecurityFinding& AwsSecurityFinding::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("ThreatIntelIndicators")) {
    ...
    for (unsigned threatIntelIndicatorsIndex = 0; threatIntelIndicatorsIndex < threatIntelIndicatorsJsonList.GetLength();
         ++threatIntelIndicatorsIndex) {
