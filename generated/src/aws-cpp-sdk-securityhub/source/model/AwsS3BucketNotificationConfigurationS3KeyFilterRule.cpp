...
AwsS3BucketNotificationConfigurationS3KeyFilterRule& AwsS3BucketNotificationConfigurationS3KeyFilterRule::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("Name")) {
    m_name =
        AwsS3BucketNotificationConfigurationS3KeyFilterRuleNameMapper::GetAwsS3BucketNotificationConfigurationS3KeyFilterRuleNameForName(
...
JsonValue AwsS3BucketNotificationConfigurationS3KeyFilterRule::Jsonize() const {
  ...
  if (m_nameHasBeenSet) {
    payload.WithString(
        "Name",
        AwsS3BucketNotificationConfigurationS3KeyFilterRuleNameMapper::GetNameForAwsS3BucketNotificationConfigurationS3KeyFilterRuleName(
            m_name));
  }
