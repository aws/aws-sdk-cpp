...
Aws::String BatchEnableStandardsRequest::SerializePayload() const {
  ...
  if (m_standardsSubscriptionRequestsHasBeenSet) {
    ...
    for (unsigned standardsSubscriptionRequestsIndex = 0;
         standardsSubscriptionRequestsIndex < standardsSubscriptionRequestsJsonList.GetLength(); ++standardsSubscriptionRequestsIndex) {
      standardsSubscriptionRequestsJsonList[standardsSubscriptionRequestsIndex].AsObject(
          m_standardsSubscriptionRequests[standardsSubscriptionRequestsIndex].Jsonize());
    }
