...
AwsAutoScalingAutoScalingGroupLaunchTemplateLaunchTemplateSpecification::
    AwsAutoScalingAutoScalingGroupLaunchTemplateLaunchTemplateSpecification(JsonView jsonValue) {
  *this = jsonValue;
}

AwsAutoScalingAutoScalingGroupLaunchTemplateLaunchTemplateSpecification&
AwsAutoScalingAutoScalingGroupLaunchTemplateLaunchTemplateSpecification::operator=(JsonView jsonValue) {
...
JsonValue AwsAutoScalingAutoScalingGroupLaunchTemplateLaunchTemplateSpecification::Jsonize() const {
  JsonValue payload;
