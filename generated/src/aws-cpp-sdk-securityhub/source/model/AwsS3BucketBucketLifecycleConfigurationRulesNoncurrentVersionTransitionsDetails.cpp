...
AwsS3BucketBucketLifecycleConfigurationRulesNoncurrentVersionTransitionsDetails::
    AwsS3BucketBucketLifecycleConfigurationRulesNoncurrentVersionTransitionsDetails(JsonView jsonValue) {
  *this = jsonValue;
}

AwsS3BucketBucketLifecycleConfigurationRulesNoncurrentVersionTransitionsDetails&
AwsS3BucketBucketLifecycleConfigurationRulesNoncurrentVersionTransitionsDetails::operator=(JsonView jsonValue) {
