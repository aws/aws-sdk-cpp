...
GetAggregatorV2Result::GetAggregatorV2Result(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

GetAggregatorV2Result& GetAggregatorV2Result::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
