...
AwsCloudWatchAlarmDetails::AwsCloudWatchAlarmDetails(JsonView jsonValue) { *this = jsonValue; }
...
AwsCloudWatchAlarmDetails& AwsCloudWatchAlarmDetails::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("InsufficientDataActions")) {
    ...
    for (unsigned insufficientDataActionsIndex = 0; insufficientDataActionsIndex < insufficientDataActionsJsonList.GetLength();
