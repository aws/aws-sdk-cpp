...
AwsEc2VpcEndpointServiceDetails::AwsEc2VpcEndpointServiceDetails(JsonView jsonValue) { *this = jsonValue; }
...
AwsEc2VpcEndpointServiceDetails& AwsEc2VpcEndpointServiceDetails::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("BaseEndpointDnsNames")) {
    ...
    for (unsigned baseEndpointDnsNamesIndex = 0; baseEndpointDnsNamesIndex < baseEndpointDnsNamesJsonList.GetLength();
         ++baseEndpointDnsNamesIndex) {
  ...
  if (jsonValue.ValueExists("GatewayLoadBalancerArns")) {
    ...
    for (unsigned gatewayLoadBalancerArnsIndex = 0; gatewayLoadBalancerArnsIndex < gatewayLoadBalancerArnsJsonList.GetLength();
         ++gatewayLoadBalancerArnsIndex) {
  ...
  if (jsonValue.ValueExists("NetworkLoadBalancerArns")) {
    ...
    for (unsigned networkLoadBalancerArnsIndex = 0; networkLoadBalancerArnsIndex < networkLoadBalancerArnsJsonList.GetLength();
         ++networkLoadBalancerArnsIndex) {
