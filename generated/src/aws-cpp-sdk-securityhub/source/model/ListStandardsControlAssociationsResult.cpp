...
ListStandardsControlAssociationsResult& ListStandardsControlAssociationsResult::operator=(
  ...
  if (jsonValue.ValueExists("StandardsControlAssociationSummaries")) {
    ...
    for (unsigned standardsControlAssociationSummariesIndex = 0;
         standardsControlAssociationSummariesIndex < standardsControlAssociationSummariesJsonList.GetLength();
         ++standardsControlAssociationSummariesIndex) {
      m_standardsControlAssociationSummaries.push_back(
          standardsControlAssociationSummariesJsonList[standardsControlAssociationSummariesIndex].AsObject());
    }
