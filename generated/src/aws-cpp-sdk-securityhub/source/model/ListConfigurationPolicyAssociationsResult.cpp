...
ListConfigurationPolicyAssociationsResult& ListConfigurationPolicyAssociationsResult::operator=(
  ...
  if (jsonValue.ValueExists("ConfigurationPolicyAssociationSummaries")) {
    Aws::Utils::Array<JsonView> configurationPolicyAssociationSummariesJsonList =
        jsonValue.GetArray("ConfigurationPolicyAssociationSummaries");
    for (unsigned configurationPolicyAssociationSummariesIndex = 0;
         configurationPolicyAssociationSummariesIndex < configurationPolicyAssociationSummariesJsonList.GetLength();
         ++configurationPolicyAssociationSummariesIndex) {
      m_configurationPolicyAssociationSummaries.push_back(
          configurationPolicyAssociationSummariesJsonList[configurationPolicyAssociationSummariesIndex].AsObject());
    }
