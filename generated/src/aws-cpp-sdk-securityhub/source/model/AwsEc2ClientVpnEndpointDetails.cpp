...
AwsEc2ClientVpnEndpointDetails::AwsEc2ClientVpnEndpointDetails(JsonView jsonValue) { *this = jsonValue; }
...
AwsEc2ClientVpnEndpointDetails& AwsEc2ClientVpnEndpointDetails::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("AuthenticationOptions")) {
    ...
    for (unsigned authenticationOptionsIndex = 0; authenticationOptionsIndex < authenticationOptionsJsonList.GetLength();
         ++authenticationOptionsIndex) {
  ...
  if (jsonValue.ValueExists("SecurityGroupIdSet")) {
    ...
    for (unsigned securityGroupIdSetIndex = 0; securityGroupIdSetIndex < securityGroupIdSetJsonList.GetLength();
         ++securityGroupIdSetIndex) {
