...
AwsWafRuleDetails::AwsWafRuleDetails(JsonView jsonValue) { *this = jsonValue; }

AwsWafRuleDetails& AwsWafRuleDetails::operator=(JsonView jsonValue) {
...
JsonValue AwsWafRuleDetails::Jsonize() const {
  JsonValue payload;
