...
RegisterConnectorV2Result::RegisterConnectorV2Result(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

RegisterConnectorV2Result& RegisterConnectorV2Result::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
