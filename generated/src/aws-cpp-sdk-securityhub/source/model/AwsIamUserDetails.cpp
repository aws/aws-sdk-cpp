...
AwsIamUserDetails::AwsIamUserDetails(JsonView jsonValue) { *this = jsonValue; }
...
JsonValue AwsIamUserDetails::Jsonize() const {
  ...
  if (m_attachedManagedPoliciesHasBeenSet) {
    ...
    for (unsigned attachedManagedPoliciesIndex = 0; attachedManagedPoliciesIndex < attachedManagedPoliciesJsonList.GetLength();
         ++attachedManagedPoliciesIndex) {
      attachedManagedPoliciesJsonList[attachedManagedPoliciesIndex].AsObject(
          m_attachedManagedPolicies[attachedManagedPoliciesIndex].Jsonize());
    }
