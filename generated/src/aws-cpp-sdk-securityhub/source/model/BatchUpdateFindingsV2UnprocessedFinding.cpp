...
BatchUpdateFindingsV2UnprocessedFinding::BatchUpdateFindingsV2UnprocessedFinding(JsonView jsonValue) { *this = jsonValue; }
...
BatchUpdateFindingsV2UnprocessedFinding& BatchUpdateFindingsV2UnprocessedFinding::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("ErrorCode")) {
    m_errorCode = BatchUpdateFindingsV2UnprocessedFindingErrorCodeMapper::GetBatchUpdateFindingsV2UnprocessedFindingErrorCodeForName(
...
JsonValue BatchUpdateFindingsV2UnprocessedFinding::Jsonize() const {
  ...
  if (m_errorCodeHasBeenSet) {
    payload.WithString(
        "ErrorCode",
        BatchUpdateFindingsV2UnprocessedFindingErrorCodeMapper::GetNameForBatchUpdateFindingsV2UnprocessedFindingErrorCode(m_errorCode));
  }
