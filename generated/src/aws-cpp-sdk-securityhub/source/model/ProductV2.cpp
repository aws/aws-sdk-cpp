...
ProductV2::ProductV2(JsonView jsonValue) { *this = jsonValue; }
...
ProductV2& ProductV2::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("IntegrationV2Types")) {
    ...
    for (unsigned integrationV2TypesIndex = 0; integrationV2TypesIndex < integrationV2TypesJsonList.GetLength();
         ++integrationV2TypesIndex) {
      m_integrationV2Types.push_back(
          IntegrationV2TypeMapper::GetIntegrationV2TypeForName(integrationV2TypesJsonList[integrationV2TypesIndex].AsString()));
    }
...
JsonValue ProductV2::Jsonize() const {
  ...
  if (m_integrationV2TypesHasBeenSet) {
    ...
    for (unsigned integrationV2TypesIndex = 0; integrationV2TypesIndex < integrationV2TypesJsonList.GetLength();
         ++integrationV2TypesIndex) {
      integrationV2TypesJsonList[integrationV2TypesIndex].AsString(
          IntegrationV2TypeMapper::GetNameForIntegrationV2Type(m_integrationV2Types[integrationV2TypesIndex]));
    }
