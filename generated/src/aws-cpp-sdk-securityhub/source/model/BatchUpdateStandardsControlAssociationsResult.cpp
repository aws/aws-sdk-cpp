...
BatchUpdateStandardsControlAssociationsResult& BatchUpdateStandardsControlAssociationsResult::operator=(
    const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("UnprocessedAssociationUpdates")) {
    ...
    for (unsigned unprocessedAssociationUpdatesIndex = 0;
         unprocessedAssociationUpdatesIndex < unprocessedAssociationUpdatesJsonList.GetLength(); ++unprocessedAssociationUpdatesIndex) {
