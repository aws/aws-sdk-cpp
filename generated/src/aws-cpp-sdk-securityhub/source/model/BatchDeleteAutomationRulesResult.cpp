...
BatchDeleteAutomationRulesResult::BatchDeleteAutomationRulesResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
BatchDeleteAutomationRulesResult& BatchDeleteAutomationRulesResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("ProcessedAutomationRules")) {
    ...
    for (unsigned processedAutomationRulesIndex = 0; processedAutomationRulesIndex < processedAutomationRulesJsonList.GetLength();
         ++processedAutomationRulesIndex) {
  ...
  if (jsonValue.ValueExists("UnprocessedAutomationRules")) {
    ...
    for (unsigned unprocessedAutomationRulesIndex = 0; unprocessedAutomationRulesIndex < unprocessedAutomationRulesJsonList.GetLength();
         ++unprocessedAutomationRulesIndex) {
