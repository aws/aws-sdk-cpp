...
DeleteInvitationsResult::DeleteInvitationsResult()
{
}

DeleteInvitationsResult::DeleteInvitationsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

DeleteInvitationsResult& DeleteInvitationsResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
