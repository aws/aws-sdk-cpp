...
AwsEcsTaskDefinitionProxyConfigurationProxyConfigurationPropertiesDetails::
    AwsEcsTaskDefinitionProxyConfigurationProxyConfigurationPropertiesDetails(JsonView jsonValue) {
  *this = jsonValue;
}

AwsEcsTaskDefinitionProxyConfigurationProxyConfigurationPropertiesDetails&
AwsEcsTaskDefinitionProxyConfigurationProxyConfigurationPropertiesDetails::operator=(JsonView jsonValue) {
