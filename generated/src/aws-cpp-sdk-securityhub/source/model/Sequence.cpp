...
Sequence::Sequence(JsonView jsonValue) { *this = jsonValue; }
...
Sequence& Sequence::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("SequenceIndicators")) {
    ...
    for (unsigned sequenceIndicatorsIndex = 0; sequenceIndicatorsIndex < sequenceIndicatorsJsonList.GetLength();
         ++sequenceIndicatorsIndex) {
