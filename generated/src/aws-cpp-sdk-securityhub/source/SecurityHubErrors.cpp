...
template <>
AWS_SECURITYHUB_API ResourceNotFoundException SecurityHubError::GetModeledError() {
  assert(this->GetErrorType() == SecurityHubErrors::RESOURCE_NOT_FOUND);
  return ResourceNotFoundException(this->GetJsonPayload().View());
}

template <>
AWS_SECURITYHUB_API InternalServerException SecurityHubError::GetModeledError() {
  assert(this->GetErrorType() == SecurityHubErrors::INTERNAL_SERVER);
  return InternalServerException(this->GetJsonPayload().View());
}

template <>
AWS_SECURITYHUB_API ValidationException SecurityHubError::GetModeledError() {
  assert(this->GetErrorType() == SecurityHubErrors::VALIDATION);
  return ValidationException(this->GetJsonPayload().View());
}

template <>
AWS_SECURITYHUB_API LimitExceededException SecurityHubError::GetModeledError() {
...
template <>
AWS_SECURITYHUB_API AccessDeniedException SecurityHubError::GetModeledError() {
