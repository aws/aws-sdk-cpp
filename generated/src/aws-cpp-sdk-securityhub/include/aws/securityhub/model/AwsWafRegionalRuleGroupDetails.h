...
class AwsWafRegionalRuleGroupDetails {
 public:
  ...
  template <typename MetricNameT = Aws::String>
  AwsWafRegionalRuleGroupDetails& WithMetricName(MetricNameT&& value) {
  ...
  template <typename NameT = Aws::String>
  AwsWafRegionalRuleGroupDetails& WithName(NameT&& value) {
  ...
  template <typename RuleGroupIdT = Aws::String>
  AwsWafRegionalRuleGroupDetails& WithRuleGroupId(RuleGroupIdT&& value) {
  ...
  template <typename RulesT = Aws::Vector<AwsWafRegionalRuleGroupRulesDetails>>
  AwsWafRegionalRuleGroupDetails& WithRules(RulesT&& value) {
    SetRules(std::forward<RulesT>(value));
    return *this;
  }
  template <typename RulesT = AwsWafRegionalRuleGroupRulesDetails>
  AwsWafRegionalRuleGroupDetails& AddRules(RulesT&& value) {
    m_rulesHasBeenSet = true;
