...
class AwsElasticsearchDomainVPCOptions {
 public:
  AWS_SECURITYHUB_API AwsElasticsearchDomainVPCOptions() = default;
  ...
  template <typename AvailabilityZonesT = Aws::Vector<Aws::String>>
  AwsElasticsearchDomainVPCOptions& WithAvailabilityZones(AvailabilityZonesT&& value) {
    SetAvailabilityZones(std::forward<AvailabilityZonesT>(value));
    return *this;
  }
  template <typename AvailabilityZonesT = Aws::String>
  AwsElasticsearchDomainVPCOptions& AddAvailabilityZones(AvailabilityZonesT&& value) {
    m_availabilityZonesHasBeenSet = true;
  ...
  template <typename SecurityGroupIdsT = Aws::Vector<Aws::String>>
  AwsElasticsearchDomainVPCOptions& WithSecurityGroupIds(SecurityGroupIdsT&& value) {
    SetSecurityGroupIds(std::forward<SecurityGroupIdsT>(value));
    return *this;
  }
  template <typename SecurityGroupIdsT = Aws::String>
  AwsElasticsearchDomainVPCOptions& AddSecurityGroupIds(SecurityGroupIdsT&& value) {
    m_securityGroupIdsHasBeenSet = true;
  ...
  template <typename SubnetIdsT = Aws::Vector<Aws::String>>
  AwsElasticsearchDomainVPCOptions& WithSubnetIds(SubnetIdsT&& value) {
    SetSubnetIds(std::forward<SubnetIdsT>(value));
    return *this;
  }
  template <typename SubnetIdsT = Aws::String>
  AwsElasticsearchDomainVPCOptions& AddSubnetIds(SubnetIdsT&& value) {
    m_subnetIdsHasBeenSet = true;
  ...
  template <typename VPCIdT = Aws::String>
  AwsElasticsearchDomainVPCOptions& WithVPCId(VPCIdT&& value) {
