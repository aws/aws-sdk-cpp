...
class GetInsightsRequest : public SecurityHubRequest {
 public:
  ...
  void SetInsightArns(InsightArnsT&& value) {
    m_insightArnsHasBeenSet = true;
    m_insightArns = std::forward<InsightArnsT>(value);
  }
  template <typename InsightArnsT = Aws::Vector<Aws::String>>
  GetInsightsRequest& WithInsightArns(InsightArnsT&& value) {
    SetInsightArns(std::forward<InsightArnsT>(value));
    return *this;
  }
  template <typename InsightArnsT = Aws::String>
  GetInsightsRequest& AddInsightArns(InsightArnsT&& value) {
    m_insightArnsHasBeenSet = true;
    m_insightArns.emplace_back(std::forward<InsightArnsT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetInsightsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
