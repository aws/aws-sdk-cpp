...
class AwsEcsTaskDefinitionContainerDefinitionsDetails {
 public:
  ...
  template <typename CommandT = Aws::Vector<Aws::String>>
  AwsEcsTaskDefinitionContainerDefinitionsDetails& WithCommand(CommandT&& value) {
    SetCommand(std::forward<CommandT>(value));
    return *this;
  }
  template <typename CommandT = Aws::String>
  AwsEcsTaskDefinitionContainerDefinitionsDetails& AddCommand(CommandT&& value) {
    m_commandHasBeenSet = true;
  ...
  inline AwsEcsTaskDefinitionContainerDefinitionsDetails& WithCpu(int value) {
    SetCpu(value);
    return *this;
  }
  ///@}
  ...
  template <typename DependsOnT = Aws::Vector<AwsEcsTaskDefinitionContainerDefinitionsDependsOnDetails>>
  AwsEcsTaskDefinitionContainerDefinitionsDetails& WithDependsOn(DependsOnT&& value) {
  ...
  AwsEcsTaskDefinitionContainerDefinitionsDetails& AddDependsOn(DependsOnT&& value) {
    m_dependsOnHasBeenSet = true;
  ...
  inline void SetDisableNetworking(bool value) {
    m_disableNetworkingHasBeenSet = true;
    m_disableNetworking = value;
  }
  inline AwsEcsTaskDefinitionContainerDefinitionsDetails& WithDisableNetworking(bool value) {
    SetDisableNetworking(value);
    return *this;
  }
  ///@}
  ...
  void SetDnsSearchDomains(DnsSearchDomainsT&& value) {
    ...
    m_dnsSearchDomains = std::forward<DnsSearchDomainsT>(value);
  }
  template <typename DnsSearchDomainsT = Aws::Vector<Aws::String>>
  AwsEcsTaskDefinitionContainerDefinitionsDetails& WithDnsSearchDomains(DnsSearchDomainsT&& value) {
    SetDnsSearchDomains(std::forward<DnsSearchDomainsT>(value));
    return *this;
  }
  template <typename DnsSearchDomainsT = Aws::String>
  AwsEcsTaskDefinitionContainerDefinitionsDetails& AddDnsSearchDomains(DnsSearchDomainsT&& value) {
    m_dnsSearchDomainsHasBeenSet = true;
    m_dnsSearchDomains.emplace_back(std::forward<DnsSearchDomainsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename DnsServersT = Aws::Vector<Aws::String>>
  AwsEcsTaskDefinitionContainerDefinitionsDetails& WithDnsServers(DnsServersT&& value) {
    SetDnsServers(std::forward<DnsServersT>(value));
    return *this;
  }
  template <typename DnsServersT = Aws::String>
  AwsEcsTaskDefinitionContainerDefinitionsDetails& AddDnsServers(DnsServersT&& value) {
    m_dnsServersHasBeenSet = true;
  ...
  void SetDockerLabels(DockerLabelsT&& value) {
    ...
    m_dockerLabels = std::forward<DockerLabelsT>(value);
  }
  template <typename DockerLabelsT = Aws::Map<Aws::String, Aws::String>>
  AwsEcsTaskDefinitionContainerDefinitionsDetails& WithDockerLabels(DockerLabelsT&& value) {
    SetDockerLabels(std::forward<DockerLabelsT>(value));
    return *this;
  }
  ...
  AwsEcsTaskDefinitionContainerDefinitionsDetails& AddDockerLabels(DockerLabelsKeyT&& key, DockerLabelsValueT&& value) {
    m_dockerLabelsHasBeenSet = true;
    m_dockerLabels.emplace(std::forward<DockerLabelsKeyT>(key), std::forward<DockerLabelsValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDockerSecurityOptions(DockerSecurityOptionsT&& value) {
    ...
    m_dockerSecurityOptions = std::forward<DockerSecurityOptionsT>(value);
  }
  template <typename DockerSecurityOptionsT = Aws::Vector<Aws::String>>
  AwsEcsTaskDefinitionContainerDefinitionsDetails& WithDockerSecurityOptions(DockerSecurityOptionsT&& value) {
    SetDockerSecurityOptions(std::forward<DockerSecurityOptionsT>(value));
    return *this;
  }
  template <typename DockerSecurityOptionsT = Aws::String>
  AwsEcsTaskDefinitionContainerDefinitionsDetails& AddDockerSecurityOptions(DockerSecurityOptionsT&& value) {
    m_dockerSecurityOptionsHasBeenSet = true;
    m_dockerSecurityOptions.emplace_back(std::forward<DockerSecurityOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename EntryPointT = Aws::Vector<Aws::String>>
  AwsEcsTaskDefinitionContainerDefinitionsDetails& WithEntryPoint(EntryPointT&& value) {
    SetEntryPoint(std::forward<EntryPointT>(value));
    return *this;
  }
  template <typename EntryPointT = Aws::String>
  AwsEcsTaskDefinitionContainerDefinitionsDetails& AddEntryPoint(EntryPointT&& value) {
    m_entryPointHasBeenSet = true;
  ...
  template <typename EnvironmentT = Aws::Vector<AwsEcsTaskDefinitionContainerDefinitionsEnvironmentDetails>>
  AwsEcsTaskDefinitionContainerDefinitionsDetails& WithEnvironment(EnvironmentT&& value) {
  ...
  AwsEcsTaskDefinitionContainerDefinitionsDetails& AddEnvironment(EnvironmentT&& value) {
    m_environmentHasBeenSet = true;
   ...
   * container.</p>
   */
  inline const Aws::Vector<AwsEcsTaskDefinitionContainerDefinitionsEnvironmentFilesDetails>& GetEnvironmentFiles() const {
    return m_environmentFiles;
  }
  ...
  template <typename EnvironmentFilesT = Aws::Vector<AwsEcsTaskDefinitionContainerDefinitionsEnvironmentFilesDetails>>
  AwsEcsTaskDefinitionContainerDefinitionsDetails& WithEnvironmentFiles(EnvironmentFilesT&& value) {
  ...
  AwsEcsTaskDefinitionContainerDefinitionsDetails& AddEnvironmentFiles(EnvironmentFilesT&& value) {
    m_environmentFilesHasBeenSet = true;
  ...
  inline AwsEcsTaskDefinitionContainerDefinitionsDetails& WithEssential(bool value) {
    SetEssential(value);
    return *this;
  }
  ///@}
  ...
  void SetExtraHosts(ExtraHostsT&& value) {
    ...
    m_extraHosts = std::forward<ExtraHostsT>(value);
  }
  template <typename ExtraHostsT = Aws::Vector<AwsEcsTaskDefinitionContainerDefinitionsExtraHostsDetails>>
  AwsEcsTaskDefinitionContainerDefinitionsDetails& WithExtraHosts(ExtraHostsT&& value) {
    SetExtraHosts(std::forward<ExtraHostsT>(value));
    return *this;
  }
  template <typename ExtraHostsT = AwsEcsTaskDefinitionContainerDefinitionsExtraHostsDetails>
  AwsEcsTaskDefinitionContainerDefinitionsDetails& AddExtraHosts(ExtraHostsT&& value) {
    m_extraHostsHasBeenSet = true;
    m_extraHosts.emplace_back(std::forward<ExtraHostsT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const AwsEcsTaskDefinitionContainerDefinitionsFirelensConfigurationDetails& GetFirelensConfiguration() const {
    return m_firelensConfiguration;
  }
  ...
  template <typename FirelensConfigurationT = AwsEcsTaskDefinitionContainerDefinitionsFirelensConfigurationDetails>
  AwsEcsTaskDefinitionContainerDefinitionsDetails& WithFirelensConfiguration(FirelensConfigurationT&& value) {
  ...
  template <typename HealthCheckT = AwsEcsTaskDefinitionContainerDefinitionsHealthCheckDetails>
  AwsEcsTaskDefinitionContainerDefinitionsDetails& WithHealthCheck(HealthCheckT&& value) {
  ...
  template <typename HostnameT = Aws::String>
  AwsEcsTaskDefinitionContainerDefinitionsDetails& WithHostname(HostnameT&& value) {
  ...
  template <typename ImageT = Aws::String>
  AwsEcsTaskDefinitionContainerDefinitionsDetails& WithImage(ImageT&& value) {
  ...
  inline AwsEcsTaskDefinitionContainerDefinitionsDetails& WithInteractive(bool value) {
  ...
  template <typename LinksT = Aws::Vector<Aws::String>>
  AwsEcsTaskDefinitionContainerDefinitionsDetails& WithLinks(LinksT&& value) {
    SetLinks(std::forward<LinksT>(value));
    return *this;
  }
  template <typename LinksT = Aws::String>
  AwsEcsTaskDefinitionContainerDefinitionsDetails& AddLinks(LinksT&& value) {
    m_linksHasBeenSet = true;
  ...
  template <typename LinuxParametersT = AwsEcsTaskDefinitionContainerDefinitionsLinuxParametersDetails>
  AwsEcsTaskDefinitionContainerDefinitionsDetails& WithLinuxParameters(LinuxParametersT&& value) {
  ...
  template <typename LogConfigurationT = AwsEcsTaskDefinitionContainerDefinitionsLogConfigurationDetails>
  AwsEcsTaskDefinitionContainerDefinitionsDetails& WithLogConfiguration(LogConfigurationT&& value) {
  ...
  inline AwsEcsTaskDefinitionContainerDefinitionsDetails& WithMemory(int value) {
    SetMemory(value);
    return *this;
  }
  ///@}
  ...
  inline AwsEcsTaskDefinitionContainerDefinitionsDetails& WithMemoryReservation(int value) {
  ...
  template <typename MountPointsT = Aws::Vector<AwsEcsTaskDefinitionContainerDefinitionsMountPointsDetails>>
  AwsEcsTaskDefinitionContainerDefinitionsDetails& WithMountPoints(MountPointsT&& value) {
  ...
  AwsEcsTaskDefinitionContainerDefinitionsDetails& AddMountPoints(MountPointsT&& value) {
    m_mountPointsHasBeenSet = true;
  ...
  template <typename NameT = Aws::String>
  AwsEcsTaskDefinitionContainerDefinitionsDetails& WithName(NameT&& value) {
  ...
  template <typename PortMappingsT = Aws::Vector<AwsEcsTaskDefinitionContainerDefinitionsPortMappingsDetails>>
  AwsEcsTaskDefinitionContainerDefinitionsDetails& WithPortMappings(PortMappingsT&& value) {
  ...
  AwsEcsTaskDefinitionContainerDefinitionsDetails& AddPortMappings(PortMappingsT&& value) {
    m_portMappingsHasBeenSet = true;
  ...
  inline AwsEcsTaskDefinitionContainerDefinitionsDetails& WithPrivileged(bool value) {
    SetPrivileged(value);
    return *this;
  }
  ///@}
  ...
  inline AwsEcsTaskDefinitionContainerDefinitionsDetails& WithPseudoTerminal(bool value) {
  ...
  inline AwsEcsTaskDefinitionContainerDefinitionsDetails& WithReadonlyRootFilesystem(bool value) {
   ...
   */
  inline const AwsEcsTaskDefinitionContainerDefinitionsRepositoryCredentialsDetails& GetRepositoryCredentials() const {
    return m_repositoryCredentials;
  }
  ...
  template <typename RepositoryCredentialsT = AwsEcsTaskDefinitionContainerDefinitionsRepositoryCredentialsDetails>
  AwsEcsTaskDefinitionContainerDefinitionsDetails& WithRepositoryCredentials(RepositoryCredentialsT&& value) {
   ...
   */
  inline const Aws::Vector<AwsEcsTaskDefinitionContainerDefinitionsResourceRequirementsDetails>& GetResourceRequirements() const {
    return m_resourceRequirements;
  }
  ...
  template <typename ResourceRequirementsT = Aws::Vector<AwsEcsTaskDefinitionContainerDefinitionsResourceRequirementsDetails>>
  AwsEcsTaskDefinitionContainerDefinitionsDetails& WithResourceRequirements(ResourceRequirementsT&& value) {
  ...
  AwsEcsTaskDefinitionContainerDefinitionsDetails& AddResourceRequirements(ResourceRequirementsT&& value) {
    m_resourceRequirementsHasBeenSet = true;
  ...
  template <typename SecretsT = Aws::Vector<AwsEcsTaskDefinitionContainerDefinitionsSecretsDetails>>
  AwsEcsTaskDefinitionContainerDefinitionsDetails& WithSecrets(SecretsT&& value) {
    SetSecrets(std::forward<SecretsT>(value));
    return *this;
  }
  template <typename SecretsT = AwsEcsTaskDefinitionContainerDefinitionsSecretsDetails>
  AwsEcsTaskDefinitionContainerDefinitionsDetails& AddSecrets(SecretsT&& value) {
    m_secretsHasBeenSet = true;
  ...
  inline AwsEcsTaskDefinitionContainerDefinitionsDetails& WithStartTimeout(int value) {
  ...
  inline AwsEcsTaskDefinitionContainerDefinitionsDetails& WithStopTimeout(int value) {
   ...
   */
  inline const Aws::Vector<AwsEcsTaskDefinitionContainerDefinitionsSystemControlsDetails>& GetSystemControls() const {
    return m_systemControls;
  }
  ...
  template <typename SystemControlsT = Aws::Vector<AwsEcsTaskDefinitionContainerDefinitionsSystemControlsDetails>>
  AwsEcsTaskDefinitionContainerDefinitionsDetails& WithSystemControls(SystemControlsT&& value) {
  ...
  AwsEcsTaskDefinitionContainerDefinitionsDetails& AddSystemControls(SystemControlsT&& value) {
    m_systemControlsHasBeenSet = true;
  ...
  template <typename UlimitsT = Aws::Vector<AwsEcsTaskDefinitionContainerDefinitionsUlimitsDetails>>
  AwsEcsTaskDefinitionContainerDefinitionsDetails& WithUlimits(UlimitsT&& value) {
    SetUlimits(std::forward<UlimitsT>(value));
    return *this;
  }
  template <typename UlimitsT = AwsEcsTaskDefinitionContainerDefinitionsUlimitsDetails>
  AwsEcsTaskDefinitionContainerDefinitionsDetails& AddUlimits(UlimitsT&& value) {
    m_ulimitsHasBeenSet = true;
  ...
  template <typename UserT = Aws::String>
  AwsEcsTaskDefinitionContainerDefinitionsDetails& WithUser(UserT&& value) {
  ...
  void SetVolumesFrom(VolumesFromT&& value) {
    ...
    m_volumesFrom = std::forward<VolumesFromT>(value);
  }
  template <typename VolumesFromT = Aws::Vector<AwsEcsTaskDefinitionContainerDefinitionsVolumesFromDetails>>
  AwsEcsTaskDefinitionContainerDefinitionsDetails& WithVolumesFrom(VolumesFromT&& value) {
    SetVolumesFrom(std::forward<VolumesFromT>(value));
    return *this;
  }
  template <typename VolumesFromT = AwsEcsTaskDefinitionContainerDefinitionsVolumesFromDetails>
  AwsEcsTaskDefinitionContainerDefinitionsDetails& AddVolumesFrom(VolumesFromT&& value) {
    m_volumesFromHasBeenSet = true;
    m_volumesFrom.emplace_back(std::forward<VolumesFromT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename WorkingDirectoryT = Aws::String>
  AwsEcsTaskDefinitionContainerDefinitionsDetails& WithWorkingDirectory(WorkingDirectoryT&& value) {
