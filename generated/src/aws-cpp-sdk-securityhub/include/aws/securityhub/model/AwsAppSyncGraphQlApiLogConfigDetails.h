...
class AwsAppSyncGraphQlApiLogConfigDetails {
 public:
  ...
  template <typename CloudWatchLogsRoleArnT = Aws::String>
  AwsAppSyncGraphQlApiLogConfigDetails& WithCloudWatchLogsRoleArn(CloudWatchLogsRoleArnT&& value) {
  ...
  inline void SetExcludeVerboseContent(bool value) {
    m_excludeVerboseContentHasBeenSet = true;
    m_excludeVerboseContent = value;
  }
  inline AwsAppSyncGraphQlApiLogConfigDetails& WithExcludeVerboseContent(bool value) {
    SetExcludeVerboseContent(value);
    return *this;
  }
  ///@}
  ...
  void SetFieldLogLevel(FieldLogLevelT&& value) {
    m_fieldLogLevelHasBeenSet = true;
    m_fieldLogLevel = std::forward<FieldLogLevelT>(value);
  }
  template <typename FieldLogLevelT = Aws::String>
  AwsAppSyncGraphQlApiLogConfigDetails& WithFieldLogLevel(FieldLogLevelT&& value) {
    SetFieldLogLevel(std::forward<FieldLogLevelT>(value));
    return *this;
  }
  ///@}
 private:
