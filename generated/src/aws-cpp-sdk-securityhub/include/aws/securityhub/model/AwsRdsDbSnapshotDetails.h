...
class AwsRdsDbSnapshotDetails {
 public:
  ...
  inline AwsRdsDbSnapshotDetails& WithAllocatedStorage(int value) {
  ...
  inline AwsRdsDbSnapshotDetails& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  inline AwsRdsDbSnapshotDetails& WithIops(int value) {
    SetIops(value);
    return *this;
  }
  ///@}
  ...
  inline AwsRdsDbSnapshotDetails& WithPercentProgress(int value) {
  ...
  inline AwsRdsDbSnapshotDetails& WithEncrypted(bool value) {
    SetEncrypted(value);
    return *this;
  }
  ///@}
  ...
  inline AwsRdsDbSnapshotDetails& WithIamDatabaseAuthenticationEnabled(bool value) {
