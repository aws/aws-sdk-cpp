...
class DescribeSecurityHubV2Result {
 public:
  ...
  void SetHubV2Arn(HubV2ArnT&& value) {
    ...
    m_hubV2Arn = std::forward<HubV2ArnT>(value);
  }
  template <typename HubV2ArnT = Aws::String>
  DescribeSecurityHubV2Result& WithHubV2Arn(HubV2ArnT&& value) {
    SetHubV2Arn(std::forward<HubV2ArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSubscribedAt(SubscribedAtT&& value) {
    ...
    m_subscribedAt = std::forward<SubscribedAtT>(value);
  }
  template <typename SubscribedAtT = Aws::String>
  DescribeSecurityHubV2Result& WithSubscribedAt(SubscribedAtT&& value) {
    SetSubscribedAt(std::forward<SubscribedAtT>(value));
    return *this;
  }
  ///@}
