...
class AwsRdsDbClusterAssociatedRole {
 public:
  AWS_SECURITYHUB_API AwsRdsDbClusterAssociatedRole() = default;
  ...
  template <typename RoleArnT = Aws::String>
  AwsRdsDbClusterAssociatedRole& WithRoleArn(RoleArnT&& value) {
  ...
  template <typename StatusT = Aws::String>
  AwsRdsDbClusterAssociatedRole& WithStatus(StatusT&& value) {
