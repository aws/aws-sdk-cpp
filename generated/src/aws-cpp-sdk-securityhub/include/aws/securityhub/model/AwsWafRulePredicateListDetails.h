...
class AwsWafRulePredicateListDetails {
 public:
  ...
  template <typename DataIdT = Aws::String>
  AwsWafRulePredicateListDetails& WithDataId(DataIdT&& value) {
  ...
  inline AwsWafRulePredicateListDetails& WithNegated(bool value) {
    SetNegated(value);
    return *this;
  }
  ///@}
  ...
  template <typename TypeT = Aws::String>
  AwsWafRulePredicateListDetails& WithType(TypeT&& value) {
