...
class AwsCodeBuildProjectLogsConfigDetails {
 public:
  ...
  template <typename CloudWatchLogsT = AwsCodeBuildProjectLogsConfigCloudWatchLogsDetails>
  AwsCodeBuildProjectLogsConfigDetails& WithCloudWatchLogs(CloudWatchLogsT&& value) {
  ...
  void SetS3Logs(S3LogsT&& value) {
    ...
    m_s3Logs = std::forward<S3LogsT>(value);
  }
  template <typename S3LogsT = AwsCodeBuildProjectLogsConfigS3LogsDetails>
  AwsCodeBuildProjectLogsConfigDetails& WithS3Logs(S3LogsT&& value) {
    SetS3Logs(std::forward<S3LogsT>(value));
    return *this;
  }
  ///@}
 private:
