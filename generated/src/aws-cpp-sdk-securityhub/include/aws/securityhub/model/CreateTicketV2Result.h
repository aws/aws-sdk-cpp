...
class CreateTicketV2Result {
 public:
  ...
  void SetTicketSrcUrl(TicketSrcUrlT&& value) {
    m_ticketSrcUrlHasBeenSet = true;
    m_ticketSrcUrl = std::forward<TicketSrcUrlT>(value);
  }
  template <typename TicketSrcUrlT = Aws::String>
  CreateTicketV2Result& WithTicketSrcUrl(TicketSrcUrlT&& value) {
    SetTicketSrcUrl(std::forward<TicketSrcUrlT>(value));
    return *this;
  }
  ///@}
