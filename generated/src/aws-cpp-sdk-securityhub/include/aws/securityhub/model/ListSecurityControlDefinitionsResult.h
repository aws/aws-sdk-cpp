...
class ListSecurityControlDefinitionsResult {
 public:
  ...
  AWS_SECURITYHUB_API ListSecurityControlDefinitionsResult& operator=(
  ...
  void SetSecurityControlDefinitions(SecurityControlDefinitionsT&& value) {
    m_securityControlDefinitionsHasBeenSet = true;
    m_securityControlDefinitions = std::forward<SecurityControlDefinitionsT>(value);
  }
  template <typename SecurityControlDefinitionsT = Aws::Vector<SecurityControlDefinition>>
  ListSecurityControlDefinitionsResult& WithSecurityControlDefinitions(SecurityControlDefinitionsT&& value) {
    SetSecurityControlDefinitions(std::forward<SecurityControlDefinitionsT>(value));
    return *this;
  }
  template <typename SecurityControlDefinitionsT = SecurityControlDefinition>
  ListSecurityControlDefinitionsResult& AddSecurityControlDefinitions(SecurityControlDefinitionsT&& value) {
    m_securityControlDefinitionsHasBeenSet = true;
    m_securityControlDefinitions.emplace_back(std::forward<SecurityControlDefinitionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListSecurityControlDefinitionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListSecurityControlDefinitionsResult& WithRequestId(RequestIdT&& value) {
