...
class AwsEc2ClientVpnEndpointClientConnectOptionsStatusDetails {
 public:
  ...
  template <typename CodeT = Aws::String>
  AwsEc2ClientVpnEndpointClientConnectOptionsStatusDetails& WithCode(CodeT&& value) {
  ...
  template <typename MessageT = Aws::String>
  AwsEc2ClientVpnEndpointClientConnectOptionsStatusDetails& WithMessage(MessageT&& value) {
