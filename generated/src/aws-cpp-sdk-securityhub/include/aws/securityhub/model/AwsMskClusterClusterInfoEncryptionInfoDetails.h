...
class AwsMskClusterClusterInfoEncryptionInfoDetails {
 public:
   ...
   */
  inline const AwsMskClusterClusterInfoEncryptionInfoEncryptionInTransitDetails& GetEncryptionInTransit() const {
    return m_encryptionInTransit;
  }
  ...
  template <typename EncryptionInTransitT = AwsMskClusterClusterInfoEncryptionInfoEncryptionInTransitDetails>
  AwsMskClusterClusterInfoEncryptionInfoDetails& WithEncryptionInTransit(EncryptionInTransitT&& value) {
  ...
  void SetEncryptionAtRest(EncryptionAtRestT&& value) {
    ...
    m_encryptionAtRest = std::forward<EncryptionAtRestT>(value);
  }
  template <typename EncryptionAtRestT = AwsMskClusterClusterInfoEncryptionInfoEncryptionAtRestDetails>
  AwsMskClusterClusterInfoEncryptionInfoDetails& WithEncryptionAtRest(EncryptionAtRestT&& value) {
    SetEncryptionAtRest(std::forward<EncryptionAtRestT>(value));
    return *this;
  }
  ///@}
 private:
