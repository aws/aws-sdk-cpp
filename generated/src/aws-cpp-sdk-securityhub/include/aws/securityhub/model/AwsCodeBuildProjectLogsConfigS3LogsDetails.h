...
class AwsCodeBuildProjectLogsConfigS3LogsDetails {
 public:
  ...
  inline AwsCodeBuildProjectLogsConfigS3LogsDetails& WithEncryptionDisabled(bool value) {
  ...
  template <typename LocationT = Aws::String>
  AwsCodeBuildProjectLogsConfigS3LogsDetails& WithLocation(LocationT&& value) {
  ...
  template <typename StatusT = Aws::String>
  AwsCodeBuildProjectLogsConfigS3LogsDetails& WithStatus(StatusT&& value) {
