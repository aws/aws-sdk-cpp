...
class AwsWafv2CustomResponseDetails {
 public:
  ...
  void SetCustomResponseBodyKey(CustomResponseBodyKeyT&& value) {
    ...
    m_customResponseBodyKey = std::forward<CustomResponseBodyKeyT>(value);
  }
  template <typename CustomResponseBodyKeyT = Aws::String>
  AwsWafv2CustomResponseDetails& WithCustomResponseBodyKey(CustomResponseBodyKeyT&& value) {
    SetCustomResponseBodyKey(std::forward<CustomResponseBodyKeyT>(value));
    return *this;
  }
  ///@}
  ...
  inline AwsWafv2CustomResponseDetails& WithResponseCode(int value) {
  ...
  AwsWafv2CustomResponseDetails& AddResponseHeaders(ResponseHeadersT&& value) {
    m_responseHeadersHasBeenSet = true;
    m_responseHeaders.emplace_back(std::forward<ResponseHeadersT>(value));
    return *this;
  }
  ///@}
 private:
