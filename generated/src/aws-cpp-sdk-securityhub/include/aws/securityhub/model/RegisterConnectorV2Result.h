...
namespace Model {
class RegisterConnectorV2Result {
 public:
  AWS_SECURITYHUB_API RegisterConnectorV2Result() = default;
  AWS_SECURITYHUB_API RegisterConnectorV2Result(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_SECURITYHUB_API RegisterConnectorV2Result& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ConnectorArnT = Aws::String>
  RegisterConnectorV2Result& WithConnectorArn(ConnectorArnT&& value) {
  ...
  template <typename ConnectorIdT = Aws::String>
  RegisterConnectorV2Result& WithConnectorId(ConnectorIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  RegisterConnectorV2Result& WithRequestId(RequestIdT&& value) {
