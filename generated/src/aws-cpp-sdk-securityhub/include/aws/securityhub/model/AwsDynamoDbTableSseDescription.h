...
class AwsDynamoDbTableSseDescription {
 public:
  ...
  void SetInaccessibleEncryptionDateTime(InaccessibleEncryptionDateTimeT&& value) {
    ...
    m_inaccessibleEncryptionDateTime = std::forward<InaccessibleEncryptionDateTimeT>(value);
  }
  template <typename InaccessibleEncryptionDateTimeT = Aws::String>
  AwsDynamoDbTableSseDescription& WithInaccessibleEncryptionDateTime(InaccessibleEncryptionDateTimeT&& value) {
    SetInaccessibleEncryptionDateTime(std::forward<InaccessibleEncryptionDateTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSseType(SseTypeT&& value) {
    ...
    m_sseType = std::forward<SseTypeT>(value);
  }
  template <typename SseTypeT = Aws::String>
  AwsDynamoDbTableSseDescription& WithSseType(SseTypeT&& value) {
    SetSseType(std::forward<SseTypeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetKmsMasterKeyArn(KmsMasterKeyArnT&& value) {
    ...
    m_kmsMasterKeyArn = std::forward<KmsMasterKeyArnT>(value);
  }
  template <typename KmsMasterKeyArnT = Aws::String>
  AwsDynamoDbTableSseDescription& WithKmsMasterKeyArn(KmsMasterKeyArnT&& value) {
    SetKmsMasterKeyArn(std::forward<KmsMasterKeyArnT>(value));
    return *this;
  }
  ///@}
 private:
