...
class AwsApiGatewayStageDetails {
 public:
  ...
  template <typename DeploymentIdT = Aws::String>
  AwsApiGatewayStageDetails& WithDeploymentId(DeploymentIdT&& value) {
  ...
  template <typename ClientCertificateIdT = Aws::String>
  AwsApiGatewayStageDetails& WithClientCertificateId(ClientCertificateIdT&& value) {
  ...
  template <typename StageNameT = Aws::String>
  AwsApiGatewayStageDetails& WithStageName(StageNameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  AwsApiGatewayStageDetails& WithDescription(DescriptionT&& value) {
  ...
  inline AwsApiGatewayStageDetails& WithCacheClusterEnabled(bool value) {
  ...
  void SetCacheClusterSize(CacheClusterSizeT&& value) {
    m_cacheClusterSizeHasBeenSet = true;
    m_cacheClusterSize = std::forward<CacheClusterSizeT>(value);
  }
  template <typename CacheClusterSizeT = Aws::String>
  AwsApiGatewayStageDetails& WithCacheClusterSize(CacheClusterSizeT&& value) {
    SetCacheClusterSize(std::forward<CacheClusterSizeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCacheClusterStatus(CacheClusterStatusT&& value) {
    ...
    m_cacheClusterStatus = std::forward<CacheClusterStatusT>(value);
  }
  template <typename CacheClusterStatusT = Aws::String>
  AwsApiGatewayStageDetails& WithCacheClusterStatus(CacheClusterStatusT&& value) {
    SetCacheClusterStatus(std::forward<CacheClusterStatusT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename MethodSettingsT = Aws::Vector<AwsApiGatewayMethodSettings>>
  AwsApiGatewayStageDetails& WithMethodSettings(MethodSettingsT&& value) {
    SetMethodSettings(std::forward<MethodSettingsT>(value));
    return *this;
  }
  template <typename MethodSettingsT = AwsApiGatewayMethodSettings>
  AwsApiGatewayStageDetails& AddMethodSettings(MethodSettingsT&& value) {
    m_methodSettingsHasBeenSet = true;
    m_methodSettings.emplace_back(std::forward<MethodSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename VariablesT = Aws::Map<Aws::String, Aws::String>>
  AwsApiGatewayStageDetails& WithVariables(VariablesT&& value) {
  ...
  template <typename DocumentationVersionT = Aws::String>
  AwsApiGatewayStageDetails& WithDocumentationVersion(DocumentationVersionT&& value) {
  ...
  template <typename AccessLogSettingsT = AwsApiGatewayAccessLogSettings>
  AwsApiGatewayStageDetails& WithAccessLogSettings(AccessLogSettingsT&& value) {
  ...
  template <typename CanarySettingsT = AwsApiGatewayCanarySettings>
  AwsApiGatewayStageDetails& WithCanarySettings(CanarySettingsT&& value) {
  ...
  inline AwsApiGatewayStageDetails& WithTracingEnabled(bool value) {
  ...
  template <typename CreatedDateT = Aws::String>
  AwsApiGatewayStageDetails& WithCreatedDate(CreatedDateT&& value) {
  ...
  template <typename LastUpdatedDateT = Aws::String>
  AwsApiGatewayStageDetails& WithLastUpdatedDate(LastUpdatedDateT&& value) {
  ...
  template <typename WebAclArnT = Aws::String>
  AwsApiGatewayStageDetails& WithWebAclArn(WebAclArnT&& value) {
