...
class FirewallPolicyStatelessRuleGroupReferencesDetails {
 public:
  ...
  inline FirewallPolicyStatelessRuleGroupReferencesDetails& WithPriority(int value) {
    SetPriority(value);
    return *this;
  }
  ///@}
  ...
  template <typename ResourceArnT = Aws::String>
  FirewallPolicyStatelessRuleGroupReferencesDetails& WithResourceArn(ResourceArnT&& value) {
