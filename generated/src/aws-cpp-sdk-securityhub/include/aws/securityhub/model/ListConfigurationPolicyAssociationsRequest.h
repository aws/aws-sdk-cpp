...
class ListConfigurationPolicyAssociationsRequest : public SecurityHubRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListConfigurationPolicyAssociationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListConfigurationPolicyAssociationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = AssociationFilters>
  ListConfigurationPolicyAssociationsRequest& WithFilters(FiltersT&& value) {
