...
namespace Model
{
  ...
  {
  public:
    AWS_SECURITYHUB_API DeleteFindingAggregatorResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteFindingAggregatorResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
