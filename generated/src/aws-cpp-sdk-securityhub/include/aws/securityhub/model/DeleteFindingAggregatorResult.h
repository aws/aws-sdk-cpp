...
namespace Model
{
  ...
  public:
    ...
    inline DeleteFindingAggregatorResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeleteFindingAggregatorResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeleteFindingAggregatorResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
