...
class AwsEcsTaskDefinitionContainerDefinitionsLinuxParametersTmpfsDetails {
 public:
  ...
  template <typename ContainerPathT = Aws::String>
  AwsEcsTaskDefinitionContainerDefinitionsLinuxParametersTmpfsDetails& WithContainerPath(ContainerPathT&& value) {
  ...
  template <typename MountOptionsT = Aws::Vector<Aws::String>>
  AwsEcsTaskDefinitionContainerDefinitionsLinuxParametersTmpfsDetails& WithMountOptions(MountOptionsT&& value) {
    SetMountOptions(std::forward<MountOptionsT>(value));
    return *this;
  }
  template <typename MountOptionsT = Aws::String>
  AwsEcsTaskDefinitionContainerDefinitionsLinuxParametersTmpfsDetails& AddMountOptions(MountOptionsT&& value) {
    m_mountOptionsHasBeenSet = true;
  ...
  inline AwsEcsTaskDefinitionContainerDefinitionsLinuxParametersTmpfsDetails& WithSize(int value) {
    SetSize(value);
    return *this;
  }
  ///@}
