...
class AwsApiGatewayRestApiDetails {
 public:
  ...
  inline AwsApiGatewayRestApiDetails& WithMinimumCompressionSize(int value) {
  ...
  void SetApiKeySource(ApiKeySourceT&& value) {
    ...
    m_apiKeySource = std::forward<ApiKeySourceT>(value);
  }
  template <typename ApiKeySourceT = Aws::String>
  AwsApiGatewayRestApiDetails& WithApiKeySource(ApiKeySourceT&& value) {
    SetApiKeySource(std::forward<ApiKeySourceT>(value));
    return *this;
  }
  ///@}
