...
class AwsCodeBuildProjectEnvironment {
 public:
   ...
   * project.</p>
   */
  inline const Aws::Vector<AwsCodeBuildProjectEnvironmentEnvironmentVariablesDetails>& GetEnvironmentVariables() const {
  ...
  inline AwsCodeBuildProjectEnvironment& WithPrivilegedMode(bool value) {
  ...
  void SetImagePullCredentialsType(ImagePullCredentialsTypeT&& value) {
    ...
    m_imagePullCredentialsType = std::forward<ImagePullCredentialsTypeT>(value);
  }
  template <typename ImagePullCredentialsTypeT = Aws::String>
  AwsCodeBuildProjectEnvironment& WithImagePullCredentialsType(ImagePullCredentialsTypeT&& value) {
    SetImagePullCredentialsType(std::forward<ImagePullCredentialsTypeT>(value));
    return *this;
  }
  ///@}
