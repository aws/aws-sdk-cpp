...
class AwsOpenSearchServiceDomainAdvancedSecurityOptionsDetails {
 public:
  ...
  inline AwsOpenSearchServiceDomainAdvancedSecurityOptionsDetails& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline AwsOpenSearchServiceDomainAdvancedSecurityOptionsDetails& WithInternalUserDatabaseEnabled(bool value) {
  ...
  void SetMasterUserOptions(MasterUserOptionsT&& value) {
    m_masterUserOptionsHasBeenSet = true;
    m_masterUserOptions = std::forward<MasterUserOptionsT>(value);
  }
  template <typename MasterUserOptionsT = AwsOpenSearchServiceDomainMasterUserOptionsDetails>
  AwsOpenSearchServiceDomainAdvancedSecurityOptionsDetails& WithMasterUserOptions(MasterUserOptionsT&& value) {
    SetMasterUserOptions(std::forward<MasterUserOptionsT>(value));
    return *this;
  }
  ///@}
 private:
