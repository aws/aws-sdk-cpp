...
class RuleGroupSourceStatelessRuleMatchAttributesSourcePorts {
 public:
  ...
  inline RuleGroupSourceStatelessRuleMatchAttributesSourcePorts& WithFromPort(int value) {
    SetFromPort(value);
    return *this;
  }
  ///@}
  ...
  inline RuleGroupSourceStatelessRuleMatchAttributesSourcePorts& WithToPort(int value) {
    SetToPort(value);
    return *this;
  }
  ///@}
