...
class AwsEfsAccessPointRootDirectoryCreationInfoDetails {
 public:
  ...
  void SetOwnerGid(OwnerGidT&& value) {
    m_ownerGidHasBeenSet = true;
    m_ownerGid = std::forward<OwnerGidT>(value);
  }
  template <typename OwnerGidT = Aws::String>
  AwsEfsAccessPointRootDirectoryCreationInfoDetails& WithOwnerGid(OwnerGidT&& value) {
    SetOwnerGid(std::forward<OwnerGidT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOwnerUid(OwnerUidT&& value) {
    m_ownerUidHasBeenSet = true;
    m_ownerUid = std::forward<OwnerUidT>(value);
  }
  template <typename OwnerUidT = Aws::String>
  AwsEfsAccessPointRootDirectoryCreationInfoDetails& WithOwnerUid(OwnerUidT&& value) {
    SetOwnerUid(std::forward<OwnerUidT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename PermissionsT = Aws::String>
  AwsEfsAccessPointRootDirectoryCreationInfoDetails& WithPermissions(PermissionsT&& value) {
