...
class Compliance {
 public:
  ...
  inline Compliance& WithStatus(ComplianceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetAssociatedStandards(AssociatedStandardsT&& value) {
    ...
    m_associatedStandards = std::forward<AssociatedStandardsT>(value);
  }
  template <typename AssociatedStandardsT = Aws::Vector<AssociatedStandard>>
  Compliance& WithAssociatedStandards(AssociatedStandardsT&& value) {
    SetAssociatedStandards(std::forward<AssociatedStandardsT>(value));
    return *this;
  }
  template <typename AssociatedStandardsT = AssociatedStandard>
  Compliance& AddAssociatedStandards(AssociatedStandardsT&& value) {
    m_associatedStandardsHasBeenSet = true;
    m_associatedStandards.emplace_back(std::forward<AssociatedStandardsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSecurityControlParameters(SecurityControlParametersT&& value) {
    ...
    m_securityControlParameters = std::forward<SecurityControlParametersT>(value);
  }
  template <typename SecurityControlParametersT = Aws::Vector<SecurityControlParameter>>
  Compliance& WithSecurityControlParameters(SecurityControlParametersT&& value) {
    SetSecurityControlParameters(std::forward<SecurityControlParametersT>(value));
    return *this;
  }
  ...
  Compliance& AddSecurityControlParameters(SecurityControlParametersT&& value) {
    m_securityControlParametersHasBeenSet = true;
    m_securityControlParameters.emplace_back(std::forward<SecurityControlParametersT>(value));
    return *this;
  }
  ///@}
 private:
