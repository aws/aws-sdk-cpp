...
class GetFindingHistoryRequest : public SecurityHubRequest {
 public:
  ...
  void SetFindingIdentifier(FindingIdentifierT&& value) {
    ...
    m_findingIdentifier = std::forward<FindingIdentifierT>(value);
  }
  template <typename FindingIdentifierT = AwsSecurityFindingIdentifier>
  GetFindingHistoryRequest& WithFindingIdentifier(FindingIdentifierT&& value) {
    SetFindingIdentifier(std::forward<FindingIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetFindingHistoryRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
