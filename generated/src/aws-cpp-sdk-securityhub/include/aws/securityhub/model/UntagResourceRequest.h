...
namespace Model
{
  ...
  /**
   */
  class UntagResourceRequest : public SecurityHubRequest
  {
  public:
    AWS_SECURITYHUB_API UntagResourceRequest() = default;
    ...
    ///@{
    /**
     * <p>The tag keys associated with the tags to remove from the resource. You can
     * remove up to 50 tags at a time.</p>
     */
