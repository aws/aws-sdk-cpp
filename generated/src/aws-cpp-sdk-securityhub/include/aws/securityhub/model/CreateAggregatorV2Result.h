...
class CreateAggregatorV2Result {
 public:
  ...
  template <typename AggregatorV2ArnT = Aws::String>
  CreateAggregatorV2Result& WithAggregatorV2Arn(AggregatorV2ArnT&& value) {
  ...
  template <typename AggregationRegionT = Aws::String>
  CreateAggregatorV2Result& WithAggregationRegion(AggregationRegionT&& value) {
  ...
  template <typename RegionLinkingModeT = Aws::String>
  CreateAggregatorV2Result& WithRegionLinkingMode(RegionLinkingModeT&& value) {
  ...
  template <typename LinkedRegionsT = Aws::Vector<Aws::String>>
  CreateAggregatorV2Result& WithLinkedRegions(LinkedRegionsT&& value) {
    SetLinkedRegions(std::forward<LinkedRegionsT>(value));
    return *this;
  }
  template <typename LinkedRegionsT = Aws::String>
  CreateAggregatorV2Result& AddLinkedRegions(LinkedRegionsT&& value) {
    m_linkedRegionsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  CreateAggregatorV2Result& WithRequestId(RequestIdT&& value) {
