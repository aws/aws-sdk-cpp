...
class GetFindingsV2Result {
 public:
  ...
  template <typename FindingsT = Aws::Vector<Aws::Utils::Document>>
  GetFindingsV2Result& WithFindings(FindingsT&& value) {
    SetFindings(std::forward<FindingsT>(value));
    return *this;
  }
  template <typename FindingsT = Aws::Utils::Document>
  GetFindingsV2Result& AddFindings(FindingsT&& value) {
    m_findingsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetFindingsV2Result& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetFindingsV2Result& WithRequestId(RequestIdT&& value) {
