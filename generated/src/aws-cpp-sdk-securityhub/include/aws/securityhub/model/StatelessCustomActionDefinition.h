...
class StatelessCustomActionDefinition {
 public:
  ...
  void SetPublishMetricAction(PublishMetricActionT&& value) {
    ...
    m_publishMetricAction = std::forward<PublishMetricActionT>(value);
  }
  template <typename PublishMetricActionT = StatelessCustomPublishMetricAction>
  StatelessCustomActionDefinition& WithPublishMetricAction(PublishMetricActionT&& value) {
    SetPublishMetricAction(std::forward<PublishMetricActionT>(value));
    return *this;
  }
  ///@}
 private:
