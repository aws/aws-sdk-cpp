...
class RuleGroupSourceStatelessRuleMatchAttributesSources {
 public:
  ...
  void SetAddressDefinition(AddressDefinitionT&& value) {
    ...
    m_addressDefinition = std::forward<AddressDefinitionT>(value);
  }
  template <typename AddressDefinitionT = Aws::String>
  RuleGroupSourceStatelessRuleMatchAttributesSources& WithAddressDefinition(AddressDefinitionT&& value) {
    SetAddressDefinition(std::forward<AddressDefinitionT>(value));
    return *this;
  }
  ///@}
 private:
