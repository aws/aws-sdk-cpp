...
class AwsS3BucketBucketVersioningConfiguration {
 public:
  ...
  inline void SetIsMfaDeleteEnabled(bool value) {
    m_isMfaDeleteEnabledHasBeenSet = true;
    m_isMfaDeleteEnabled = value;
  }
  inline AwsS3BucketBucketVersioningConfiguration& WithIsMfaDeleteEnabled(bool value) {
    SetIsMfaDeleteEnabled(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusT = Aws::String>
  AwsS3BucketBucketVersioningConfiguration& WithStatus(StatusT&& value) {
