...
class IntegerListConfigurationOptions {
 public:
  ...
  inline IntegerListConfigurationOptions& AddDefaultValue(int value) {
    m_defaultValueHasBeenSet = true;
    m_defaultValue.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline IntegerListConfigurationOptions& WithMin(int value) {
    SetMin(value);
    return *this;
  }
  ///@}
  ...
  inline IntegerListConfigurationOptions& WithMax(int value) {
    SetMax(value);
    return *this;
  }
  ///@}
  ...
  inline IntegerListConfigurationOptions& WithMaxItems(int value) {
    SetMaxItems(value);
    return *this;
  }
  ///@}
