...
class AwsBackupBackupPlanLifecycleDetails {
 public:
  ...
  inline AwsBackupBackupPlanLifecycleDetails& WithDeleteAfterDays(long long value) {
  ...
  inline AwsBackupBackupPlanLifecycleDetails& WithMoveToColdStorageAfterDays(long long value) {
