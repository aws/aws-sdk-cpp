...
class AwsEcsTaskDefinitionContainerDefinitionsLogConfigurationDetails {
 public:
  ...
  template <typename LogDriverT = Aws::String>
  AwsEcsTaskDefinitionContainerDefinitionsLogConfigurationDetails& WithLogDriver(LogDriverT&& value) {
  ...
  template <typename OptionsT = Aws::Map<Aws::String, Aws::String>>
  AwsEcsTaskDefinitionContainerDefinitionsLogConfigurationDetails& WithOptions(OptionsT&& value) {
   ...
   */
  inline const Aws::Vector<AwsEcsTaskDefinitionContainerDefinitionsLogConfigurationSecretOptionsDetails>& GetSecretOptions() const {
    return m_secretOptions;
  }
  ...
  void SetSecretOptions(SecretOptionsT&& value) {
    ...
    m_secretOptions = std::forward<SecretOptionsT>(value);
  }
  template <typename SecretOptionsT = Aws::Vector<AwsEcsTaskDefinitionContainerDefinitionsLogConfigurationSecretOptionsDetails>>
  AwsEcsTaskDefinitionContainerDefinitionsLogConfigurationDetails& WithSecretOptions(SecretOptionsT&& value) {
    SetSecretOptions(std::forward<SecretOptionsT>(value));
    return *this;
  }
  template <typename SecretOptionsT = AwsEcsTaskDefinitionContainerDefinitionsLogConfigurationSecretOptionsDetails>
  AwsEcsTaskDefinitionContainerDefinitionsLogConfigurationDetails& AddSecretOptions(SecretOptionsT&& value) {
    m_secretOptionsHasBeenSet = true;
    m_secretOptions.emplace_back(std::forward<SecretOptionsT>(value));
    return *this;
  }
  ///@}
 private:
