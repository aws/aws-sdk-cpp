...
namespace Model
{
  ...
  public:
    ...
    template<typename RuleArnT = Aws::String>
    CreateAutomationRuleV2Result& WithRuleArn(RuleArnT&& value) { SetRuleArn(std::forward<RuleArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RuleIdT = Aws::String>
    CreateAutomationRuleV2Result& WithRuleId(RuleIdT&& value) { SetRuleId(std::forward<RuleIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateAutomationRuleV2Result& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
