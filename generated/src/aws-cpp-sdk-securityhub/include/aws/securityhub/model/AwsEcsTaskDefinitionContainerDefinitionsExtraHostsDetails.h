...
class AwsEcsTaskDefinitionContainerDefinitionsExtraHostsDetails {
 public:
  ...
  template <typename HostnameT = Aws::String>
  AwsEcsTaskDefinitionContainerDefinitionsExtraHostsDetails& WithHostname(HostnameT&& value) {
  ...
  template <typename IpAddressT = Aws::String>
  AwsEcsTaskDefinitionContainerDefinitionsExtraHostsDetails& WithIpAddress(IpAddressT&& value) {
