...
class AwsNetworkFirewallFirewallDetails {
 public:
  ...
  inline AwsNetworkFirewallFirewallDetails& WithDeleteProtection(bool value) {
  ...
  void SetFirewallId(FirewallIdT&& value) {
    ...
    m_firewallId = std::forward<FirewallIdT>(value);
  }
  template <typename FirewallIdT = Aws::String>
  AwsNetworkFirewallFirewallDetails& WithFirewallId(FirewallIdT&& value) {
    SetFirewallId(std::forward<FirewallIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline AwsNetworkFirewallFirewallDetails& WithFirewallPolicyChangeProtection(bool value) {
  ...
  inline AwsNetworkFirewallFirewallDetails& WithSubnetChangeProtection(bool value) {
