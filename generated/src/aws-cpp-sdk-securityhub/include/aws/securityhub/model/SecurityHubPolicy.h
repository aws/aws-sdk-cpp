...
class SecurityHubPolicy {
 public:
  ...
  inline void SetServiceEnabled(bool value) {
    m_serviceEnabledHasBeenSet = true;
    m_serviceEnabled = value;
  }
  inline SecurityHubPolicy& WithServiceEnabled(bool value) {
  ...
  void SetEnabledStandardIdentifiers(EnabledStandardIdentifiersT&& value) {
    ...
    m_enabledStandardIdentifiers = std::forward<EnabledStandardIdentifiersT>(value);
  }
  template <typename EnabledStandardIdentifiersT = Aws::Vector<Aws::String>>
  SecurityHubPolicy& WithEnabledStandardIdentifiers(EnabledStandardIdentifiersT&& value) {
    SetEnabledStandardIdentifiers(std::forward<EnabledStandardIdentifiersT>(value));
    return *this;
  }
  ...
  SecurityHubPolicy& AddEnabledStandardIdentifiers(EnabledStandardIdentifiersT&& value) {
    m_enabledStandardIdentifiersHasBeenSet = true;
    m_enabledStandardIdentifiers.emplace_back(std::forward<EnabledStandardIdentifiersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSecurityControlsConfiguration(SecurityControlsConfigurationT&& value) {
    ...
    m_securityControlsConfiguration = std::forward<SecurityControlsConfigurationT>(value);
  }
  template <typename SecurityControlsConfigurationT = SecurityControlsConfiguration>
  SecurityHubPolicy& WithSecurityControlsConfiguration(SecurityControlsConfigurationT&& value) {
    SetSecurityControlsConfiguration(std::forward<SecurityControlsConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
