...
class AwsDynamoDbTableRestoreSummary {
 public:
  ...
  template <typename SourceBackupArnT = Aws::String>
  AwsDynamoDbTableRestoreSummary& WithSourceBackupArn(SourceBackupArnT&& value) {
  ...
  template <typename SourceTableArnT = Aws::String>
  AwsDynamoDbTableRestoreSummary& WithSourceTableArn(SourceTableArnT&& value) {
  ...
  template <typename RestoreDateTimeT = Aws::String>
  AwsDynamoDbTableRestoreSummary& WithRestoreDateTime(RestoreDateTimeT&& value) {
  ...
  inline AwsDynamoDbTableRestoreSummary& WithRestoreInProgress(bool value) {
