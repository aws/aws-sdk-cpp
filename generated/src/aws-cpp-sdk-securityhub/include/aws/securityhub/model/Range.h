...
class Range {
 public:
  ...
  inline Range& WithStart(long long value) {
    SetStart(value);
    return *this;
  }
  ///@}
  ...
  inline Range& WithEnd(long long value) {
    SetEnd(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStartColumn(long long value) {
    m_startColumnHasBeenSet = true;
    m_startColumn = value;
  }
  inline Range& WithStartColumn(long long value) {
