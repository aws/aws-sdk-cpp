...
class AwsCodeBuildProjectLogsConfigCloudWatchLogsDetails {
 public:
  ...
  template <typename GroupNameT = Aws::String>
  AwsCodeBuildProjectLogsConfigCloudWatchLogsDetails& WithGroupName(GroupNameT&& value) {
  ...
  template <typename StatusT = Aws::String>
  AwsCodeBuildProjectLogsConfigCloudWatchLogsDetails& WithStatus(StatusT&& value) {
  ...
  template <typename StreamNameT = Aws::String>
  AwsCodeBuildProjectLogsConfigCloudWatchLogsDetails& WithStreamName(StreamNameT&& value) {
