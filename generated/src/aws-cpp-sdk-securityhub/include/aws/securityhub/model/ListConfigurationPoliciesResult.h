...
class ListConfigurationPoliciesResult {
 public:
  ...
  void SetConfigurationPolicySummaries(ConfigurationPolicySummariesT&& value) {
    m_configurationPolicySummariesHasBeenSet = true;
    m_configurationPolicySummaries = std::forward<ConfigurationPolicySummariesT>(value);
  }
  template <typename ConfigurationPolicySummariesT = Aws::Vector<ConfigurationPolicySummary>>
  ListConfigurationPoliciesResult& WithConfigurationPolicySummaries(ConfigurationPolicySummariesT&& value) {
    SetConfigurationPolicySummaries(std::forward<ConfigurationPolicySummariesT>(value));
    return *this;
  }
  template <typename ConfigurationPolicySummariesT = ConfigurationPolicySummary>
  ListConfigurationPoliciesResult& AddConfigurationPolicySummaries(ConfigurationPolicySummariesT&& value) {
    m_configurationPolicySummariesHasBeenSet = true;
    m_configurationPolicySummaries.emplace_back(std::forward<ConfigurationPolicySummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListConfigurationPoliciesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListConfigurationPoliciesResult& WithRequestId(RequestIdT&& value) {
