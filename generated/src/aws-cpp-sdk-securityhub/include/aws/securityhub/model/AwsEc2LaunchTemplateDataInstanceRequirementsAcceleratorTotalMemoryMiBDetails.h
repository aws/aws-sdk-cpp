...
class AwsEc2LaunchTemplateDataInstanceRequirementsAcceleratorTotalMemoryMiBDetails {
 public:
  ...
  AWS_SECURITYHUB_API AwsEc2LaunchTemplateDataInstanceRequirementsAcceleratorTotalMemoryMiBDetails& operator=(
  ...
  inline AwsEc2LaunchTemplateDataInstanceRequirementsAcceleratorTotalMemoryMiBDetails& WithMax(int value) {
    SetMax(value);
    return *this;
  }
  ///@}
  ...
  inline AwsEc2LaunchTemplateDataInstanceRequirementsAcceleratorTotalMemoryMiBDetails& WithMin(int value) {
    SetMin(value);
    return *this;
  }
  ///@}
