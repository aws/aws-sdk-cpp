...
class AwsStepFunctionStateMachineLoggingConfigurationDestinationsDetails {
 public:
   ...
   * </p>
   */
  inline const AwsStepFunctionStateMachineLoggingConfigurationDestinationsCloudWatchLogsLogGroupDetails& GetCloudWatchLogsLogGroup() const {
    return m_cloudWatchLogsLogGroup;
  }
  ...
  template <typename CloudWatchLogsLogGroupT = AwsStepFunctionStateMachineLoggingConfigurationDestinationsCloudWatchLogsLogGroupDetails>
  AwsStepFunctionStateMachineLoggingConfigurationDestinationsDetails& WithCloudWatchLogsLogGroup(CloudWatchLogsLogGroupT&& value) {
