...
class AwsElbLoadBalancerHealthCheck {
 public:
  ...
  inline AwsElbLoadBalancerHealthCheck& WithHealthyThreshold(int value) {
  ...
  inline AwsElbLoadBalancerHealthCheck& WithInterval(int value) {
    SetInterval(value);
    return *this;
  }
  ///@}
  ...
  inline AwsElbLoadBalancerHealthCheck& WithTimeout(int value) {
    SetTimeout(value);
    return *this;
  }
  ///@}
  ...
  inline AwsElbLoadBalancerHealthCheck& WithUnhealthyThreshold(int value) {
