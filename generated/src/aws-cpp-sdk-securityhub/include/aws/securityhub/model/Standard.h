...
class Standard {
 public:
  ...
  inline void SetEnabledByDefault(bool value) {
    m_enabledByDefaultHasBeenSet = true;
    m_enabledByDefault = value;
  }
  inline Standard& WithEnabledByDefault(bool value) {
  ...
  void SetStandardsManagedBy(StandardsManagedByT&& value) {
    ...
    m_standardsManagedBy = std::forward<StandardsManagedByT>(value);
  }
  template <typename StandardsManagedByT = StandardsManagedBy>
  Standard& WithStandardsManagedBy(StandardsManagedByT&& value) {
    SetStandardsManagedBy(std::forward<StandardsManagedByT>(value));
    return *this;
  }
  ///@}
 private:
