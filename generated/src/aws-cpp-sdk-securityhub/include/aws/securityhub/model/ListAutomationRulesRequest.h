...
namespace Model
{
  ...
  {
  public:
    AWS_SECURITYHUB_API ListAutomationRulesRequest() = default;
    ...
    template<typename NextTokenT = Aws::String>
    ListAutomationRulesRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
