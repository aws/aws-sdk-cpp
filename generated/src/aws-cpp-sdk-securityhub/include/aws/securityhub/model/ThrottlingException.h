...
namespace Model
{
   ...
   * Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/securityhub-2018-10-26/ThrottlingException">AWS
   * API Reference</a></p>
   */
  class ThrottlingException
  {
  public:
    AWS_SECURITYHUB_API ThrottlingException() = default;
    AWS_SECURITYHUB_API ThrottlingException(Aws::Utils::Json::JsonView jsonValue);
