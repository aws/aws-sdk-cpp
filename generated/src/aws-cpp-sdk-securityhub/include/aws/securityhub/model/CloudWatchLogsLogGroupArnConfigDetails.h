...
class CloudWatchLogsLogGroupArnConfigDetails {
 public:
  ...
  template <typename CloudWatchLogsLogGroupArnT = Aws::String>
  CloudWatchLogsLogGroupArnConfigDetails& WithCloudWatchLogsLogGroupArn(CloudWatchLogsLogGroupArnT&& value) {
  ...
  template <typename HostedZoneIdT = Aws::String>
  CloudWatchLogsLogGroupArnConfigDetails& WithHostedZoneId(HostedZoneIdT&& value) {
  ...
  template <typename IdT = Aws::String>
  CloudWatchLogsLogGroupArnConfigDetails& WithId(IdT&& value) {
