...
class AwsCodeBuildProjectEnvironmentRegistryCredential {
 public:
  ...
  template <typename CredentialT = Aws::String>
  AwsCodeBuildProjectEnvironmentRegistryCredential& WithCredential(CredentialT&& value) {
  ...
  template <typename CredentialProviderT = Aws::String>
  AwsCodeBuildProjectEnvironmentRegistryCredential& WithCredentialProvider(CredentialProviderT&& value) {
