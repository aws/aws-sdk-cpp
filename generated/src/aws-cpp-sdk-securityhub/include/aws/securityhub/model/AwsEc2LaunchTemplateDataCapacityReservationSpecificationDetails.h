...
class AwsEc2LaunchTemplateDataCapacityReservationSpecificationDetails {
 public:
  ...
  void SetCapacityReservationPreference(CapacityReservationPreferenceT&& value) {
    m_capacityReservationPreferenceHasBeenSet = true;
    m_capacityReservationPreference = std::forward<CapacityReservationPreferenceT>(value);
  }
  template <typename CapacityReservationPreferenceT = Aws::String>
  AwsEc2LaunchTemplateDataCapacityReservationSpecificationDetails& WithCapacityReservationPreference(
      CapacityReservationPreferenceT&& value) {
    SetCapacityReservationPreference(std::forward<CapacityReservationPreferenceT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const AwsEc2LaunchTemplateDataCapacityReservationSpecificationCapacityReservationTargetDetails& GetCapacityReservationTarget()
      const {
    return m_capacityReservationTarget;
  }
  ...
  template <typename CapacityReservationTargetT = AwsEc2LaunchTemplateDataCapacityReservationSpecificationCapacityReservationTargetDetails>
  AwsEc2LaunchTemplateDataCapacityReservationSpecificationDetails& WithCapacityReservationTarget(CapacityReservationTargetT&& value) {
