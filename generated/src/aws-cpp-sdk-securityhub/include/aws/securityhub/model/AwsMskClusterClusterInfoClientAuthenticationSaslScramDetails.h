 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/securityhub-2018-10-26/AwsMskClusterClusterInfoClientAuthenticationSaslScramDetails">AWS
 * API Reference</a></p>
 */
class AwsMskClusterClusterInfoClientAuthenticationSaslScramDetails {
 public:
  ...
  inline AwsMskClusterClusterInfoClientAuthenticationSaslScramDetails& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
