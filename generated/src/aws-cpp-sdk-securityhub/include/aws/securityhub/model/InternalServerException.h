...
namespace Model
{
  ...
  /**
   * <p> The request has failed due to an internal failure of the service.
   * </p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/securityhub-2018-10-26/InternalServerException">AWS
   * API Reference</a></p>
   */
