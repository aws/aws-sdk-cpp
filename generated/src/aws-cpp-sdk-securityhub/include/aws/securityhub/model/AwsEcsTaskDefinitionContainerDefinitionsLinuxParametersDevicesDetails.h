...
class AwsEcsTaskDefinitionContainerDefinitionsLinuxParametersDevicesDetails {
 public:
  ...
  AWS_SECURITYHUB_API AwsEcsTaskDefinitionContainerDefinitionsLinuxParametersDevicesDetails& operator=(
  ...
  template <typename ContainerPathT = Aws::String>
  AwsEcsTaskDefinitionContainerDefinitionsLinuxParametersDevicesDetails& WithContainerPath(ContainerPathT&& value) {
  ...
  template <typename HostPathT = Aws::String>
  AwsEcsTaskDefinitionContainerDefinitionsLinuxParametersDevicesDetails& WithHostPath(HostPathT&& value) {
  ...
  template <typename PermissionsT = Aws::Vector<Aws::String>>
  AwsEcsTaskDefinitionContainerDefinitionsLinuxParametersDevicesDetails& WithPermissions(PermissionsT&& value) {
    SetPermissions(std::forward<PermissionsT>(value));
    return *this;
  }
  template <typename PermissionsT = Aws::String>
  AwsEcsTaskDefinitionContainerDefinitionsLinuxParametersDevicesDetails& AddPermissions(PermissionsT&& value) {
    m_permissionsHasBeenSet = true;
