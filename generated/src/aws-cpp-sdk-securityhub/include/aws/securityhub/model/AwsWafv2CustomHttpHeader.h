...
namespace Model
{
  ...
  public:
    ...
    template<typename NameT = Aws::String>
    AwsWafv2CustomHttpHeader& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename ValueT = Aws::String>
    AwsWafv2CustomHttpHeader& WithValue(ValueT&& value) { SetValue(std::forward<ValueT>(value)); return *this;}
    ///@}
  private:
