...
class AwsCertificateManagerCertificateResourceRecord {
 public:
  ...
  template <typename NameT = Aws::String>
  AwsCertificateManagerCertificateResourceRecord& WithName(NameT&& value) {
  ...
  template <typename TypeT = Aws::String>
  AwsCertificateManagerCertificateResourceRecord& WithType(TypeT&& value) {
  ...
  template <typename ValueT = Aws::String>
  AwsCertificateManagerCertificateResourceRecord& WithValue(ValueT&& value) {
