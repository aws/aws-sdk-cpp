...
class AwsWafRegionalRateBasedRuleDetails {
 public:
  ...
  template <typename MetricNameT = Aws::String>
  AwsWafRegionalRateBasedRuleDetails& WithMetricName(MetricNameT&& value) {
  ...
  template <typename NameT = Aws::String>
  AwsWafRegionalRateBasedRuleDetails& WithName(NameT&& value) {
  ...
  void SetRateKey(RateKeyT&& value) {
    ...
    m_rateKey = std::forward<RateKeyT>(value);
  }
  template <typename RateKeyT = Aws::String>
  AwsWafRegionalRateBasedRuleDetails& WithRateKey(RateKeyT&& value) {
    SetRateKey(std::forward<RateKeyT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetRateLimit(long long value) {
    m_rateLimitHasBeenSet = true;
    m_rateLimit = value;
  }
  inline AwsWafRegionalRateBasedRuleDetails& WithRateLimit(long long value) {
    SetRateLimit(value);
    return *this;
  }
  ///@}
  ...
  template <typename RuleIdT = Aws::String>
  AwsWafRegionalRateBasedRuleDetails& WithRuleId(RuleIdT&& value) {
  ...
  void SetMatchPredicates(MatchPredicatesT&& value) {
    ...
    m_matchPredicates = std::forward<MatchPredicatesT>(value);
  }
  template <typename MatchPredicatesT = Aws::Vector<AwsWafRegionalRateBasedRuleMatchPredicate>>
  AwsWafRegionalRateBasedRuleDetails& WithMatchPredicates(MatchPredicatesT&& value) {
    SetMatchPredicates(std::forward<MatchPredicatesT>(value));
    return *this;
  }
  template <typename MatchPredicatesT = AwsWafRegionalRateBasedRuleMatchPredicate>
  AwsWafRegionalRateBasedRuleDetails& AddMatchPredicates(MatchPredicatesT&& value) {
    m_matchPredicatesHasBeenSet = true;
    m_matchPredicates.emplace_back(std::forward<MatchPredicatesT>(value));
    return *this;
  }
  ///@}
 private:
