...
class SecurityControl {
 public:
  ...
  void SetSecurityControlArn(SecurityControlArnT&& value) {
    ...
    m_securityControlArn = std::forward<SecurityControlArnT>(value);
  }
  template <typename SecurityControlArnT = Aws::String>
  SecurityControl& WithSecurityControlArn(SecurityControlArnT&& value) {
    SetSecurityControlArn(std::forward<SecurityControlArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline SecurityControl& WithSeverityRating(SeverityRating value) {
  ...
  inline void SetSecurityControlStatus(ControlStatus value) {
    m_securityControlStatusHasBeenSet = true;
    m_securityControlStatus = value;
  }
  inline SecurityControl& WithSecurityControlStatus(ControlStatus value) {
    SetSecurityControlStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUpdateStatus(UpdateStatus value) {
    m_updateStatusHasBeenSet = true;
    m_updateStatus = value;
  }
  inline SecurityControl& WithUpdateStatus(UpdateStatus value) {
  ...
  void SetLastUpdateReason(LastUpdateReasonT&& value) {
    ...
    m_lastUpdateReason = std::forward<LastUpdateReasonT>(value);
  }
  template <typename LastUpdateReasonT = Aws::String>
  SecurityControl& WithLastUpdateReason(LastUpdateReasonT&& value) {
    SetLastUpdateReason(std::forward<LastUpdateReasonT>(value));
    return *this;
  }
  ///@}
 private:
