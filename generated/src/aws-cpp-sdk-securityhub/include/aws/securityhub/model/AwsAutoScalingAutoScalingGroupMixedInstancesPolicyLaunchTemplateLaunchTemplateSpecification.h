...
class AwsAutoScalingAutoScalingGroupMixedInstancesPolicyLaunchTemplateLaunchTemplateSpecification {
 public:
  ...
  AWS_SECURITYHUB_API AwsAutoScalingAutoScalingGroupMixedInstancesPolicyLaunchTemplateLaunchTemplateSpecification& operator=(
      Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename LaunchTemplateIdT = Aws::String>
  AwsAutoScalingAutoScalingGroupMixedInstancesPolicyLaunchTemplateLaunchTemplateSpecification& WithLaunchTemplateId(
      LaunchTemplateIdT&& value) {
  ...
  template <typename LaunchTemplateNameT = Aws::String>
  AwsAutoScalingAutoScalingGroupMixedInstancesPolicyLaunchTemplateLaunchTemplateSpecification& WithLaunchTemplateName(
      LaunchTemplateNameT&& value) {
  ...
  template <typename VersionT = Aws::String>
  AwsAutoScalingAutoScalingGroupMixedInstancesPolicyLaunchTemplateLaunchTemplateSpecification& WithVersion(VersionT&& value) {
