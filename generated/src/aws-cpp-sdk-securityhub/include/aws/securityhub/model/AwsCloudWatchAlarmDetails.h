...
class AwsCloudWatchAlarmDetails {
 public:
  ...
  inline AwsCloudWatchAlarmDetails& WithActionsEnabled(bool value) {
  ...
  inline AwsCloudWatchAlarmDetails& WithDatapointsToAlarm(int value) {
  ...
  inline AwsCloudWatchAlarmDetails& WithEvaluationPeriods(int value) {
  ...
  inline AwsCloudWatchAlarmDetails& WithPeriod(int value) {
    SetPeriod(value);
    return *this;
  }
  ///@}
  ...
  inline AwsCloudWatchAlarmDetails& WithThreshold(double value) {
    SetThreshold(value);
    return *this;
  }
  ///@}
