...
class AwsBackupRecoveryPointLifecycleDetails {
 public:
  AWS_SECURITYHUB_API AwsBackupRecoveryPointLifecycleDetails() = default;
  ...
  inline AwsBackupRecoveryPointLifecycleDetails& WithDeleteAfterDays(long long value) {
  ...
  inline AwsBackupRecoveryPointLifecycleDetails& WithMoveToColdStorageAfterDays(long long value) {
