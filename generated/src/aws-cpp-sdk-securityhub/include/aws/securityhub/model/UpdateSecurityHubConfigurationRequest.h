...
class UpdateSecurityHubConfigurationRequest : public SecurityHubRequest {
 public:
  ...
  inline void SetAutoEnableControls(bool value) {
    ...
    m_autoEnableControls = value;
  }
  inline UpdateSecurityHubConfigurationRequest& WithAutoEnableControls(bool value) {
    SetAutoEnableControls(value);
    return *this;
  }
  ///@}
   ...
   * standards.</p> <p>For accounts that are part of an organization, this value can
   * only be updated in the administrator account.</p>
   */
  ...
  inline void SetControlFindingGenerator(ControlFindingGenerator value) {
    ...
    m_controlFindingGenerator = value;
  }
  inline UpdateSecurityHubConfigurationRequest& WithControlFindingGenerator(ControlFindingGenerator value) {
    SetControlFindingGenerator(value);
    return *this;
  }
  ///@}
 private:
