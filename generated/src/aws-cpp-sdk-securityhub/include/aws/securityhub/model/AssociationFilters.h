...
class AssociationFilters {
 public:
  ...
  template <typename ConfigurationPolicyIdT = Aws::String>
  AssociationFilters& WithConfigurationPolicyId(ConfigurationPolicyIdT&& value) {
  ...
  inline AssociationFilters& WithAssociationType(AssociationType value) {
  ...
  inline AssociationFilters& WithAssociationStatus(ConfigurationPolicyAssociationStatus value) {
