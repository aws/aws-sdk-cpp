...
class ListFindingAggregatorsResult {
 public:
  ...
  void SetFindingAggregators(FindingAggregatorsT&& value) {
    m_findingAggregatorsHasBeenSet = true;
    m_findingAggregators = std::forward<FindingAggregatorsT>(value);
  }
  template <typename FindingAggregatorsT = Aws::Vector<FindingAggregator>>
  ListFindingAggregatorsResult& WithFindingAggregators(FindingAggregatorsT&& value) {
    SetFindingAggregators(std::forward<FindingAggregatorsT>(value));
    return *this;
  }
  template <typename FindingAggregatorsT = FindingAggregator>
  ListFindingAggregatorsResult& AddFindingAggregators(FindingAggregatorsT&& value) {
    m_findingAggregatorsHasBeenSet = true;
    m_findingAggregators.emplace_back(std::forward<FindingAggregatorsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListFindingAggregatorsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListFindingAggregatorsResult& WithRequestId(RequestIdT&& value) {
