...
class AwsEcsTaskDefinitionContainerDefinitionsUlimitsDetails {
 public:
  ...
  inline AwsEcsTaskDefinitionContainerDefinitionsUlimitsDetails& WithHardLimit(int value) {
    SetHardLimit(value);
    return *this;
  }
  ///@}
  ...
  template <typename NameT = Aws::String>
  AwsEcsTaskDefinitionContainerDefinitionsUlimitsDetails& WithName(NameT&& value) {
  ...
  inline AwsEcsTaskDefinitionContainerDefinitionsUlimitsDetails& WithSoftLimit(int value) {
    SetSoftLimit(value);
    return *this;
  }
  ///@}
