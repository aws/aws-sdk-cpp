...
class AwsEc2ClientVpnEndpointAuthenticationOptionsFederatedAuthenticationDetails {
 public:
  ...
  AWS_SECURITYHUB_API AwsEc2ClientVpnEndpointAuthenticationOptionsFederatedAuthenticationDetails& operator=(
  ...
  template <typename SamlProviderArnT = Aws::String>
  AwsEc2ClientVpnEndpointAuthenticationOptionsFederatedAuthenticationDetails& WithSamlProviderArn(SamlProviderArnT&& value) {
  ...
  void SetSelfServiceSamlProviderArn(SelfServiceSamlProviderArnT&& value) {
    m_selfServiceSamlProviderArnHasBeenSet = true;
    m_selfServiceSamlProviderArn = std::forward<SelfServiceSamlProviderArnT>(value);
  }
  template <typename SelfServiceSamlProviderArnT = Aws::String>
  AwsEc2ClientVpnEndpointAuthenticationOptionsFederatedAuthenticationDetails& WithSelfServiceSamlProviderArn(
      SelfServiceSamlProviderArnT&& value) {
    SetSelfServiceSamlProviderArn(std::forward<SelfServiceSamlProviderArnT>(value));
    return *this;
  }
  ///@}
 private:
