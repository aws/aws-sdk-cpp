...
class AwsOpenSearchServiceDomainVpcOptionsDetails {
 public:
  AWS_SECURITYHUB_API AwsOpenSearchServiceDomainVpcOptionsDetails() = default;
  ...
  template <typename SecurityGroupIdsT = Aws::Vector<Aws::String>>
  AwsOpenSearchServiceDomainVpcOptionsDetails& WithSecurityGroupIds(SecurityGroupIdsT&& value) {
    SetSecurityGroupIds(std::forward<SecurityGroupIdsT>(value));
    return *this;
  }
  template <typename SecurityGroupIdsT = Aws::String>
  AwsOpenSearchServiceDomainVpcOptionsDetails& AddSecurityGroupIds(SecurityGroupIdsT&& value) {
    m_securityGroupIdsHasBeenSet = true;
  ...
  template <typename SubnetIdsT = Aws::Vector<Aws::String>>
  AwsOpenSearchServiceDomainVpcOptionsDetails& WithSubnetIds(SubnetIdsT&& value) {
    SetSubnetIds(std::forward<SubnetIdsT>(value));
    return *this;
  }
  template <typename SubnetIdsT = Aws::String>
  AwsOpenSearchServiceDomainVpcOptionsDetails& AddSubnetIds(SubnetIdsT&& value) {
    m_subnetIdsHasBeenSet = true;
