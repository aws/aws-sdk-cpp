...
class AwsWafRegionalRulePredicateListDetails {
 public:
  ...
  void SetDataId(DataIdT&& value) {
    ...
    m_dataId = std::forward<DataIdT>(value);
  }
  template <typename DataIdT = Aws::String>
  AwsWafRegionalRulePredicateListDetails& WithDataId(DataIdT&& value) {
    SetDataId(std::forward<DataIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline AwsWafRegionalRulePredicateListDetails& WithNegated(bool value) {
    SetNegated(value);
    return *this;
  }
  ///@}
  ...
  template <typename TypeT = Aws::String>
  AwsWafRegionalRulePredicateListDetails& WithType(TypeT&& value) {
