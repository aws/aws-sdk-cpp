...
class AwsRdsDbClusterSnapshotDbClusterSnapshotAttribute {
 public:
  ...
  template <typename AttributeNameT = Aws::String>
  AwsRdsDbClusterSnapshotDbClusterSnapshotAttribute& WithAttributeName(AttributeNameT&& value) {
  ...
  template <typename AttributeValuesT = Aws::Vector<Aws::String>>
  AwsRdsDbClusterSnapshotDbClusterSnapshotAttribute& WithAttributeValues(AttributeValuesT&& value) {
    SetAttributeValues(std::forward<AttributeValuesT>(value));
    return *this;
  }
  template <typename AttributeValuesT = Aws::String>
  AwsRdsDbClusterSnapshotDbClusterSnapshotAttribute& AddAttributeValues(AttributeValuesT&& value) {
    m_attributeValuesHasBeenSet = true;
