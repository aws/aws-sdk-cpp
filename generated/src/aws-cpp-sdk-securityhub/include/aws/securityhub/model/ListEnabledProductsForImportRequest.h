...
class ListEnabledProductsForImportRequest : public SecurityHubRequest {
 public:
  AWS_SECURITYHUB_API ListEnabledProductsForImportRequest() = default;
  ...
  template <typename NextTokenT = Aws::String>
  ListEnabledProductsForImportRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListEnabledProductsForImportRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
