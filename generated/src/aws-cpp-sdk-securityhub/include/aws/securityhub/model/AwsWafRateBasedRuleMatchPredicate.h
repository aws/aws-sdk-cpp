...
class AwsWafRateBasedRuleMatchPredicate {
 public:
  ...
  template <typename DataIdT = Aws::String>
  AwsWafRateBasedRuleMatchPredicate& WithDataId(DataIdT&& value) {
  ...
  inline AwsWafRateBasedRuleMatchPredicate& WithNegated(bool value) {
    SetNegated(value);
    return *this;
  }
  ///@}
  ...
  template <typename TypeT = Aws::String>
  AwsWafRateBasedRuleMatchPredicate& WithType(TypeT&& value) {
