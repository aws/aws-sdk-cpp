...
class AwsS3BucketServerSideEncryptionRule {
 public:
   ...
   */
  inline const AwsS3BucketServerSideEncryptionByDefault& GetApplyServerSideEncryptionByDefault() const {
    return m_applyServerSideEncryptionByDefault;
  }
  ...
  template <typename ApplyServerSideEncryptionByDefaultT = AwsS3BucketServerSideEncryptionByDefault>
  AwsS3BucketServerSideEncryptionRule& WithApplyServerSideEncryptionByDefault(ApplyServerSideEncryptionByDefaultT&& value) {
