...
namespace Model
{
  ...
  public:
    ...
    template<typename MetricNameT = Aws::String>
    AwsWafRegionalRuleDetails& WithMetricName(MetricNameT&& value) { SetMetricName(std::forward<MetricNameT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    AwsWafRegionalRuleDetails& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename PredicateListT = Aws::Vector<AwsWafRegionalRulePredicateListDetails>>
    AwsWafRegionalRuleDetails& WithPredicateList(PredicateListT&& value) { SetPredicateList(std::forward<PredicateListT>(value)); return *this;}
    template<typename PredicateListT = AwsWafRegionalRulePredicateListDetails>
    AwsWafRegionalRuleDetails& AddPredicateList(PredicateListT&& value) { m_predicateListHasBeenSet = true; m_predicateList.emplace_back(std::forward<PredicateListT>(value)); return *this; }
    ///@}
    ...
    template<typename RuleIdT = Aws::String>
    AwsWafRegionalRuleDetails& WithRuleId(RuleIdT&& value) { SetRuleId(std::forward<RuleIdT>(value)); return *this;}
    ///@}
  private:
