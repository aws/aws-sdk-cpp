...
class BatchGetAutomationRulesRequest : public SecurityHubRequest {
 public:
  ...
  template <typename AutomationRulesArnsT = Aws::Vector<Aws::String>>
  BatchGetAutomationRulesRequest& WithAutomationRulesArns(AutomationRulesArnsT&& value) {
    SetAutomationRulesArns(std::forward<AutomationRulesArnsT>(value));
    return *this;
  }
  template <typename AutomationRulesArnsT = Aws::String>
  BatchGetAutomationRulesRequest& AddAutomationRulesArns(AutomationRulesArnsT&& value) {
    m_automationRulesArnsHasBeenSet = true;
