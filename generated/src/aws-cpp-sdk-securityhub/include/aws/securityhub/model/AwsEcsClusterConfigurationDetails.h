...
class AwsEcsClusterConfigurationDetails {
 public:
   ...
   */
  inline const AwsEcsClusterConfigurationExecuteCommandConfigurationDetails& GetExecuteCommandConfiguration() const {
    return m_executeCommandConfiguration;
  }
  ...
  void SetExecuteCommandConfiguration(ExecuteCommandConfigurationT&& value) {
    ...
    m_executeCommandConfiguration = std::forward<ExecuteCommandConfigurationT>(value);
  }
  template <typename ExecuteCommandConfigurationT = AwsEcsClusterConfigurationExecuteCommandConfigurationDetails>
  AwsEcsClusterConfigurationDetails& WithExecuteCommandConfiguration(ExecuteCommandConfigurationT&& value) {
    SetExecuteCommandConfiguration(std::forward<ExecuteCommandConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
