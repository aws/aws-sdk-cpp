...
class AwsEc2LaunchTemplateDataBlockDeviceMappingSetDetails {
 public:
  ...
  template <typename DeviceNameT = Aws::String>
  AwsEc2LaunchTemplateDataBlockDeviceMappingSetDetails& WithDeviceName(DeviceNameT&& value) {
  ...
  template <typename EbsT = AwsEc2LaunchTemplateDataBlockDeviceMappingSetEbsDetails>
  AwsEc2LaunchTemplateDataBlockDeviceMappingSetDetails& WithEbs(EbsT&& value) {
  ...
  template <typename NoDeviceT = Aws::String>
  AwsEc2LaunchTemplateDataBlockDeviceMappingSetDetails& WithNoDevice(NoDeviceT&& value) {
  ...
  template <typename VirtualNameT = Aws::String>
  AwsEc2LaunchTemplateDataBlockDeviceMappingSetDetails& WithVirtualName(VirtualNameT&& value) {
