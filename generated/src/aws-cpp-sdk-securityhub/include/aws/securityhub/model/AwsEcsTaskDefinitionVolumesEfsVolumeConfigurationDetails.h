...
class AwsEcsTaskDefinitionVolumesEfsVolumeConfigurationDetails {
 public:
   ...
   */
  inline const AwsEcsTaskDefinitionVolumesEfsVolumeConfigurationAuthorizationConfigDetails& GetAuthorizationConfig() const {
    return m_authorizationConfig;
  }
  ...
  template <typename AuthorizationConfigT = AwsEcsTaskDefinitionVolumesEfsVolumeConfigurationAuthorizationConfigDetails>
  AwsEcsTaskDefinitionVolumesEfsVolumeConfigurationDetails& WithAuthorizationConfig(AuthorizationConfigT&& value) {
  ...
  template <typename FilesystemIdT = Aws::String>
  AwsEcsTaskDefinitionVolumesEfsVolumeConfigurationDetails& WithFilesystemId(FilesystemIdT&& value) {
  ...
  template <typename RootDirectoryT = Aws::String>
  AwsEcsTaskDefinitionVolumesEfsVolumeConfigurationDetails& WithRootDirectory(RootDirectoryT&& value) {
  ...
  template <typename TransitEncryptionT = Aws::String>
  AwsEcsTaskDefinitionVolumesEfsVolumeConfigurationDetails& WithTransitEncryption(TransitEncryptionT&& value) {
  ...
  inline AwsEcsTaskDefinitionVolumesEfsVolumeConfigurationDetails& WithTransitEncryptionPort(int value) {
