...
class ListSecurityControlDefinitionsRequest : public SecurityHubRequest {
 public:
  ...
  template <typename StandardsArnT = Aws::String>
  ListSecurityControlDefinitionsRequest& WithStandardsArn(StandardsArnT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListSecurityControlDefinitionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListSecurityControlDefinitionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
