...
class OcsfFindingIdentifier {
 public:
  ...
  void SetCloudAccountUid(CloudAccountUidT&& value) {
    ...
    m_cloudAccountUid = std::forward<CloudAccountUidT>(value);
  }
  template <typename CloudAccountUidT = Aws::String>
  OcsfFindingIdentifier& WithCloudAccountUid(CloudAccountUidT&& value) {
    SetCloudAccountUid(std::forward<CloudAccountUidT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFindingInfoUid(FindingInfoUidT&& value) {
    ...
    m_findingInfoUid = std::forward<FindingInfoUidT>(value);
  }
  template <typename FindingInfoUidT = Aws::String>
  OcsfFindingIdentifier& WithFindingInfoUid(FindingInfoUidT&& value) {
    SetFindingInfoUid(std::forward<FindingInfoUidT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMetadataProductUid(MetadataProductUidT&& value) {
    ...
    m_metadataProductUid = std::forward<MetadataProductUidT>(value);
  }
  template <typename MetadataProductUidT = Aws::String>
  OcsfFindingIdentifier& WithMetadataProductUid(MetadataProductUidT&& value) {
    SetMetadataProductUid(std::forward<MetadataProductUidT>(value));
    return *this;
  }
  ///@}
 private:
