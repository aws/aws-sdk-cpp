...
class GetFindingHistoryResult {
 public:
  ...
  template <typename RecordsT = Aws::Vector<FindingHistoryRecord>>
  GetFindingHistoryResult& WithRecords(RecordsT&& value) {
    SetRecords(std::forward<RecordsT>(value));
    return *this;
  }
  template <typename RecordsT = FindingHistoryRecord>
  GetFindingHistoryResult& AddRecords(RecordsT&& value) {
    m_recordsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetFindingHistoryResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetFindingHistoryResult& WithRequestId(RequestIdT&& value) {
