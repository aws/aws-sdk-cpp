...
class AwsRdsDbPendingModifiedValues {
 public:
  ...
  inline AwsRdsDbPendingModifiedValues& WithAllocatedStorage(int value) {
  ...
  inline AwsRdsDbPendingModifiedValues& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  inline AwsRdsDbPendingModifiedValues& WithBackupRetentionPeriod(int value) {
  ...
  inline AwsRdsDbPendingModifiedValues& WithMultiAZ(bool value) {
    SetMultiAZ(value);
    return *this;
  }
  ///@}
  ...
  inline AwsRdsDbPendingModifiedValues& WithIops(int value) {
    SetIops(value);
    return *this;
  }
  ///@}
