...
class AwsS3BucketBucketLifecycleConfigurationRulesNoncurrentVersionTransitionsDetails {
 public:
  ...
  inline AwsS3BucketBucketLifecycleConfigurationRulesNoncurrentVersionTransitionsDetails& WithDays(int value) {
    SetDays(value);
    return *this;
  }
  ///@}
  ...
  template <typename StorageClassT = Aws::String>
  AwsS3BucketBucketLifecycleConfigurationRulesNoncurrentVersionTransitionsDetails& WithStorageClass(StorageClassT&& value) {
