...
class AwsOpenSearchServiceDomainMasterUserOptionsDetails {
 public:
  ...
  template <typename MasterUserArnT = Aws::String>
  AwsOpenSearchServiceDomainMasterUserOptionsDetails& WithMasterUserArn(MasterUserArnT&& value) {
  ...
  template <typename MasterUserNameT = Aws::String>
  AwsOpenSearchServiceDomainMasterUserOptionsDetails& WithMasterUserName(MasterUserNameT&& value) {
  ...
  template <typename MasterUserPasswordT = Aws::String>
  AwsOpenSearchServiceDomainMasterUserOptionsDetails& WithMasterUserPassword(MasterUserPasswordT&& value) {
