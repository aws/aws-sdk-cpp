...
class AwsAppSyncGraphQlApiUserPoolConfigDetails {
 public:
  ...
  void SetAppIdClientRegex(AppIdClientRegexT&& value) {
    ...
    m_appIdClientRegex = std::forward<AppIdClientRegexT>(value);
  }
  template <typename AppIdClientRegexT = Aws::String>
  AwsAppSyncGraphQlApiUserPoolConfigDetails& WithAppIdClientRegex(AppIdClientRegexT&& value) {
    SetAppIdClientRegex(std::forward<AppIdClientRegexT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename AwsRegionT = Aws::String>
  AwsAppSyncGraphQlApiUserPoolConfigDetails& WithAwsRegion(AwsRegionT&& value) {
  ...
  template <typename DefaultActionT = Aws::String>
  AwsAppSyncGraphQlApiUserPoolConfigDetails& WithDefaultAction(DefaultActionT&& value) {
  ...
  template <typename UserPoolIdT = Aws::String>
  AwsAppSyncGraphQlApiUserPoolConfigDetails& WithUserPoolId(UserPoolIdT&& value) {
