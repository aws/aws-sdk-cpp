...
class AwsWafv2CustomRequestHandlingDetails {
 public:
  ...
  void SetInsertHeaders(InsertHeadersT&& value) {
    ...
    m_insertHeaders = std::forward<InsertHeadersT>(value);
  }
  template <typename InsertHeadersT = Aws::Vector<AwsWafv2CustomHttpHeader>>
  AwsWafv2CustomRequestHandlingDetails& WithInsertHeaders(InsertHeadersT&& value) {
    SetInsertHeaders(std::forward<InsertHeadersT>(value));
    return *this;
  }
  ...
  AwsWafv2CustomRequestHandlingDetails& AddInsertHeaders(InsertHeadersT&& value) {
    m_insertHeadersHasBeenSet = true;
    m_insertHeaders.emplace_back(std::forward<InsertHeadersT>(value));
    return *this;
  }
  ///@}
 private:
