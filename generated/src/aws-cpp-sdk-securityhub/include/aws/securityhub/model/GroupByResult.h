...
class GroupByResult {
 public:
  ...
  void SetGroupByField(GroupByFieldT&& value) {
    ...
    m_groupByField = std::forward<GroupByFieldT>(value);
  }
  template <typename GroupByFieldT = Aws::String>
  GroupByResult& WithGroupByField(GroupByFieldT&& value) {
    SetGroupByField(std::forward<GroupByFieldT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGroupByValues(GroupByValuesT&& value) {
    ...
    m_groupByValues = std::forward<GroupByValuesT>(value);
  }
  template <typename GroupByValuesT = Aws::Vector<GroupByValue>>
  GroupByResult& WithGroupByValues(GroupByValuesT&& value) {
    SetGroupByValues(std::forward<GroupByValuesT>(value));
    return *this;
  }
  template <typename GroupByValuesT = GroupByValue>
  GroupByResult& AddGroupByValues(GroupByValuesT&& value) {
    m_groupByValuesHasBeenSet = true;
    m_groupByValues.emplace_back(std::forward<GroupByValuesT>(value));
    return *this;
  }
  ///@}
 private:
