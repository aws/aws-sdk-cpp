...
class RuleGroupSourceStatelessRuleMatchAttributesDestinationPorts {
 public:
  ...
  inline RuleGroupSourceStatelessRuleMatchAttributesDestinationPorts& WithFromPort(int value) {
    SetFromPort(value);
    return *this;
  }
  ///@}
  ...
  inline RuleGroupSourceStatelessRuleMatchAttributesDestinationPorts& WithToPort(int value) {
    SetToPort(value);
    return *this;
  }
  ///@}
