...
class BatchGetStandardsControlAssociationsResult {
 public:
  ...
  AWS_SECURITYHUB_API BatchGetStandardsControlAssociationsResult& operator=(
   ...
   */
  inline const Aws::Vector<StandardsControlAssociationDetail>& GetStandardsControlAssociationDetails() const {
    return m_standardsControlAssociationDetails;
  }
  template <typename StandardsControlAssociationDetailsT = Aws::Vector<StandardsControlAssociationDetail>>
  void SetStandardsControlAssociationDetails(StandardsControlAssociationDetailsT&& value) {
    m_standardsControlAssociationDetailsHasBeenSet = true;
    m_standardsControlAssociationDetails = std::forward<StandardsControlAssociationDetailsT>(value);
  }
  template <typename StandardsControlAssociationDetailsT = Aws::Vector<StandardsControlAssociationDetail>>
  BatchGetStandardsControlAssociationsResult& WithStandardsControlAssociationDetails(StandardsControlAssociationDetailsT&& value) {
    SetStandardsControlAssociationDetails(std::forward<StandardsControlAssociationDetailsT>(value));
    return *this;
  }
  ...
  BatchGetStandardsControlAssociationsResult& AddStandardsControlAssociationDetails(StandardsControlAssociationDetailsT&& value) {
    m_standardsControlAssociationDetailsHasBeenSet = true;
    m_standardsControlAssociationDetails.emplace_back(std::forward<StandardsControlAssociationDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUnprocessedAssociations(UnprocessedAssociationsT&& value) {
    m_unprocessedAssociationsHasBeenSet = true;
    m_unprocessedAssociations = std::forward<UnprocessedAssociationsT>(value);
  }
  template <typename UnprocessedAssociationsT = Aws::Vector<UnprocessedStandardsControlAssociation>>
  BatchGetStandardsControlAssociationsResult& WithUnprocessedAssociations(UnprocessedAssociationsT&& value) {
    SetUnprocessedAssociations(std::forward<UnprocessedAssociationsT>(value));
    return *this;
  }
  ...
  BatchGetStandardsControlAssociationsResult& AddUnprocessedAssociations(UnprocessedAssociationsT&& value) {
    m_unprocessedAssociationsHasBeenSet = true;
    m_unprocessedAssociations.emplace_back(std::forward<UnprocessedAssociationsT>(value));
    return *this;
  }
  ///@}
