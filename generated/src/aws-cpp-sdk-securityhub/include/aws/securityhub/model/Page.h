...
class Page {
 public:
  ...
  inline Page& WithPageNumber(long long value) {
    SetPageNumber(value);
    return *this;
  }
  ///@}
  ...
  void SetLineRange(LineRangeT&& value) {
    ...
    m_lineRange = std::forward<LineRangeT>(value);
  }
  template <typename LineRangeT = Range>
  Page& WithLineRange(LineRangeT&& value) {
    SetLineRange(std::forward<LineRangeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOffsetRange(OffsetRangeT&& value) {
    ...
    m_offsetRange = std::forward<OffsetRangeT>(value);
  }
  template <typename OffsetRangeT = Range>
  Page& WithOffsetRange(OffsetRangeT&& value) {
    SetOffsetRange(std::forward<OffsetRangeT>(value));
    return *this;
  }
  ///@}
 private:
