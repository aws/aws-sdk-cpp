 ...
 * of these attributes is populated, then Security Hub CSPM automatically populates
...
class Severity {
 public:
  ...
  inline void SetProduct(double value) {
    m_productHasBeenSet = true;
    m_product = value;
  }
  inline Severity& WithProduct(double value) {
    SetProduct(value);
    return *this;
  }
  ///@}
  ...
  inline void SetLabel(SeverityLabel value) {
    m_labelHasBeenSet = true;
    m_label = value;
  }
  inline Severity& WithLabel(SeverityLabel value) {
    SetLabel(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNormalized(int value) {
    m_normalizedHasBeenSet = true;
    m_normalized = value;
  }
  inline Severity& WithNormalized(int value) {
    SetNormalized(value);
    return *this;
  }
  ///@}
  ...
  void SetOriginal(OriginalT&& value) {
    ...
    m_original = std::forward<OriginalT>(value);
  }
  template <typename OriginalT = Aws::String>
  Severity& WithOriginal(OriginalT&& value) {
    SetOriginal(std::forward<OriginalT>(value));
    return *this;
  }
  ///@}
 private:
