...
class AwsS3BucketBucketLifecycleConfigurationRulesFilterPredicateTagDetails {
 public:
  ...
  AWS_SECURITYHUB_API AwsS3BucketBucketLifecycleConfigurationRulesFilterPredicateTagDetails& operator=(
  ...
  template <typename KeyT = Aws::String>
  AwsS3BucketBucketLifecycleConfigurationRulesFilterPredicateTagDetails& WithKey(KeyT&& value) {
  ...
  template <typename ValueT = Aws::String>
  AwsS3BucketBucketLifecycleConfigurationRulesFilterPredicateTagDetails& WithValue(ValueT&& value) {
