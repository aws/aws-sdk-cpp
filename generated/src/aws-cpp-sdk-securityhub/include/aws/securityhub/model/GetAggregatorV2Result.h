...
namespace Model
{
  ...
  {
  public:
    AWS_SECURITYHUB_API GetAggregatorV2Result() = default;
    AWS_SECURITYHUB_API GetAggregatorV2Result(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_SECURITYHUB_API GetAggregatorV2Result& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ...
    template<typename AggregatorV2ArnT = Aws::String>
    GetAggregatorV2Result& WithAggregatorV2Arn(AggregatorV2ArnT&& value) { SetAggregatorV2Arn(std::forward<AggregatorV2ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename AggregationRegionT = Aws::String>
    GetAggregatorV2Result& WithAggregationRegion(AggregationRegionT&& value) { SetAggregationRegion(std::forward<AggregationRegionT>(value)); return *this;}
    ///@}
    ...
    template<typename RegionLinkingModeT = Aws::String>
    GetAggregatorV2Result& WithRegionLinkingMode(RegionLinkingModeT&& value) { SetRegionLinkingMode(std::forward<RegionLinkingModeT>(value)); return *this;}
    ///@}
    ...
    template<typename LinkedRegionsT = Aws::Vector<Aws::String>>
    GetAggregatorV2Result& WithLinkedRegions(LinkedRegionsT&& value) { SetLinkedRegions(std::forward<LinkedRegionsT>(value)); return *this;}
    template<typename LinkedRegionsT = Aws::String>
    GetAggregatorV2Result& AddLinkedRegions(LinkedRegionsT&& value) { m_linkedRegionsHasBeenSet = true; m_linkedRegions.emplace_back(std::forward<LinkedRegionsT>(value)); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    GetAggregatorV2Result& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
