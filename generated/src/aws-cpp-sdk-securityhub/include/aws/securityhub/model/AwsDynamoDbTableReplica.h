...
class AwsDynamoDbTableReplica {
 public:
   ...
   */
  inline const Aws::Vector<AwsDynamoDbTableReplicaGlobalSecondaryIndex>& GetGlobalSecondaryIndexes() const {
   ...
   */
  inline const AwsDynamoDbTableProvisionedThroughputOverride& GetProvisionedThroughputOverride() const {
    return m_provisionedThroughputOverride;
  }
  ...
  void SetReplicaStatus(ReplicaStatusT&& value) {
    ...
    m_replicaStatus = std::forward<ReplicaStatusT>(value);
  }
  template <typename ReplicaStatusT = Aws::String>
  AwsDynamoDbTableReplica& WithReplicaStatus(ReplicaStatusT&& value) {
    SetReplicaStatus(std::forward<ReplicaStatusT>(value));
    return *this;
  }
  ///@}
