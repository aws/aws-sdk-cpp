...
class ResourcesStringFilter {
 public:
  ...
  inline void SetFieldName(ResourcesStringField value) {
    m_fieldNameHasBeenSet = true;
    m_fieldName = value;
  }
  inline ResourcesStringFilter& WithFieldName(ResourcesStringField value) {
    SetFieldName(value);
    return *this;
  }
  ///@}
  ...
  template <typename FilterT = StringFilter>
  ResourcesStringFilter& WithFilter(FilterT&& value) {
