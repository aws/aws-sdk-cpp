...
class AwsEcsServiceCapacityProviderStrategyDetails {
 public:
  ...
  inline AwsEcsServiceCapacityProviderStrategyDetails& WithBase(int value) {
    SetBase(value);
    return *this;
  }
  ///@}
  ...
  template <typename CapacityProviderT = Aws::String>
  AwsEcsServiceCapacityProviderStrategyDetails& WithCapacityProvider(CapacityProviderT&& value) {
  ...
  inline AwsEcsServiceCapacityProviderStrategyDetails& WithWeight(int value) {
    SetWeight(value);
    return *this;
  }
  ///@}
