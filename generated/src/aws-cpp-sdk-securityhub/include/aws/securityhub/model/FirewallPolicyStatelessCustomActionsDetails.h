...
class FirewallPolicyStatelessCustomActionsDetails {
 public:
  ...
  template <typename ActionDefinitionT = StatelessCustomActionDefinition>
  FirewallPolicyStatelessCustomActionsDetails& WithActionDefinition(ActionDefinitionT&& value) {
  ...
  template <typename ActionNameT = Aws::String>
  FirewallPolicyStatelessCustomActionsDetails& WithActionName(ActionNameT&& value) {
