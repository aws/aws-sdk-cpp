...
class ListEnabledProductsForImportResult {
 public:
  ...
  void SetProductSubscriptions(ProductSubscriptionsT&& value) {
    m_productSubscriptionsHasBeenSet = true;
    m_productSubscriptions = std::forward<ProductSubscriptionsT>(value);
  }
  template <typename ProductSubscriptionsT = Aws::Vector<Aws::String>>
  ListEnabledProductsForImportResult& WithProductSubscriptions(ProductSubscriptionsT&& value) {
    SetProductSubscriptions(std::forward<ProductSubscriptionsT>(value));
    return *this;
  }
  template <typename ProductSubscriptionsT = Aws::String>
  ListEnabledProductsForImportResult& AddProductSubscriptions(ProductSubscriptionsT&& value) {
    m_productSubscriptionsHasBeenSet = true;
    m_productSubscriptions.emplace_back(std::forward<ProductSubscriptionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListEnabledProductsForImportResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListEnabledProductsForImportResult& WithRequestId(RequestIdT&& value) {
