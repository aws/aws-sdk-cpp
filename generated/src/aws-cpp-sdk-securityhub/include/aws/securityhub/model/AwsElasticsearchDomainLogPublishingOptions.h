...
class AwsElasticsearchDomainLogPublishingOptions {
 public:
  ...
  void SetIndexSlowLogs(IndexSlowLogsT&& value) {
    ...
    m_indexSlowLogs = std::forward<IndexSlowLogsT>(value);
  }
  template <typename IndexSlowLogsT = AwsElasticsearchDomainLogPublishingOptionsLogConfig>
  AwsElasticsearchDomainLogPublishingOptions& WithIndexSlowLogs(IndexSlowLogsT&& value) {
    SetIndexSlowLogs(std::forward<IndexSlowLogsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSearchSlowLogs(SearchSlowLogsT&& value) {
    ...
    m_searchSlowLogs = std::forward<SearchSlowLogsT>(value);
  }
  template <typename SearchSlowLogsT = AwsElasticsearchDomainLogPublishingOptionsLogConfig>
  AwsElasticsearchDomainLogPublishingOptions& WithSearchSlowLogs(SearchSlowLogsT&& value) {
    SetSearchSlowLogs(std::forward<SearchSlowLogsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAuditLogs(AuditLogsT&& value) {
    ...
    m_auditLogs = std::forward<AuditLogsT>(value);
  }
  template <typename AuditLogsT = AwsElasticsearchDomainLogPublishingOptionsLogConfig>
  AwsElasticsearchDomainLogPublishingOptions& WithAuditLogs(AuditLogsT&& value) {
    SetAuditLogs(std::forward<AuditLogsT>(value));
    return *this;
  }
  ///@}
 private:
