...
class AwsMskClusterClusterInfoClientAuthenticationDetails {
 public:
  ...
  void SetSasl(SaslT&& value) {
    ...
    m_sasl = std::forward<SaslT>(value);
  }
  template <typename SaslT = AwsMskClusterClusterInfoClientAuthenticationSaslDetails>
  AwsMskClusterClusterInfoClientAuthenticationDetails& WithSasl(SaslT&& value) {
    SetSasl(std::forward<SaslT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUnauthenticated(UnauthenticatedT&& value) {
    ...
    m_unauthenticated = std::forward<UnauthenticatedT>(value);
  }
  template <typename UnauthenticatedT = AwsMskClusterClusterInfoClientAuthenticationUnauthenticatedDetails>
  AwsMskClusterClusterInfoClientAuthenticationDetails& WithUnauthenticated(UnauthenticatedT&& value) {
    SetUnauthenticated(std::forward<UnauthenticatedT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTls(TlsT&& value) {
    ...
    m_tls = std::forward<TlsT>(value);
  }
  template <typename TlsT = AwsMskClusterClusterInfoClientAuthenticationTlsDetails>
  AwsMskClusterClusterInfoClientAuthenticationDetails& WithTls(TlsT&& value) {
    SetTls(std::forward<TlsT>(value));
    return *this;
  }
  ///@}
 private:
