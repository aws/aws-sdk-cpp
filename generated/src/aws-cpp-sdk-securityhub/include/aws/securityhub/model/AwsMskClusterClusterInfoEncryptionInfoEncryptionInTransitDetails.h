...
class AwsMskClusterClusterInfoEncryptionInfoEncryptionInTransitDetails {
 public:
  ...
  inline void SetInCluster(bool value) {
    m_inClusterHasBeenSet = true;
    m_inCluster = value;
  }
  inline AwsMskClusterClusterInfoEncryptionInfoEncryptionInTransitDetails& WithInCluster(bool value) {
    SetInCluster(value);
    return *this;
  }
  ///@}
  ...
  void SetClientBroker(ClientBrokerT&& value) {
    m_clientBrokerHasBeenSet = true;
    m_clientBroker = std::forward<ClientBrokerT>(value);
  }
  template <typename ClientBrokerT = Aws::String>
  AwsMskClusterClusterInfoEncryptionInfoEncryptionInTransitDetails& WithClientBroker(ClientBrokerT&& value) {
    SetClientBroker(std::forward<ClientBrokerT>(value));
    return *this;
  }
  ///@}
 private:
