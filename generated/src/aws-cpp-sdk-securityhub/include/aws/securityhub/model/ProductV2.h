...
class ProductV2 {
 public:
  ...
  void SetProductV2Name(ProductV2NameT&& value) {
    ...
    m_productV2Name = std::forward<ProductV2NameT>(value);
  }
  template <typename ProductV2NameT = Aws::String>
  ProductV2& WithProductV2Name(ProductV2NameT&& value) {
    SetProductV2Name(std::forward<ProductV2NameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIntegrationV2Types(IntegrationV2TypesT&& value) {
    ...
    m_integrationV2Types = std::forward<IntegrationV2TypesT>(value);
  }
  template <typename IntegrationV2TypesT = Aws::Vector<IntegrationV2Type>>
  ProductV2& WithIntegrationV2Types(IntegrationV2TypesT&& value) {
    SetIntegrationV2Types(std::forward<IntegrationV2TypesT>(value));
    return *this;
  }
  inline ProductV2& AddIntegrationV2Types(IntegrationV2Type value) {
    m_integrationV2TypesHasBeenSet = true;
    m_integrationV2Types.push_back(value);
    return *this;
  }
  ///@}
