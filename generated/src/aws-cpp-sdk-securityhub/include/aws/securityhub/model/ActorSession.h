...
class ActorSession {
 public:
  ...
  inline void SetMfaStatus(ActorSessionMfaStatus value) {
    m_mfaStatusHasBeenSet = true;
    m_mfaStatus = value;
  }
  inline ActorSession& WithMfaStatus(ActorSessionMfaStatus value) {
    SetMfaStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCreatedTime(long long value) {
    m_createdTimeHasBeenSet = true;
    m_createdTime = value;
  }
  inline ActorSession& WithCreatedTime(long long value) {
