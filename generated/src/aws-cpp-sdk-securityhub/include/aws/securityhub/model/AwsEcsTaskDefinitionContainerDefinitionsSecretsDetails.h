...
class AwsEcsTaskDefinitionContainerDefinitionsSecretsDetails {
 public:
  ...
  template <typename NameT = Aws::String>
  AwsEcsTaskDefinitionContainerDefinitionsSecretsDetails& WithName(NameT&& value) {
  ...
  template <typename ValueFromT = Aws::String>
  AwsEcsTaskDefinitionContainerDefinitionsSecretsDetails& WithValueFrom(ValueFromT&& value) {
