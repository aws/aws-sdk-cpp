...
class AwsIamAccessKeyDetails {
 public:
  ...
  inline void SetStatus(AwsIamAccessKeyStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline AwsIamAccessKeyDetails& WithStatus(AwsIamAccessKeyStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetPrincipalType(PrincipalTypeT&& value) {
    ...
    m_principalType = std::forward<PrincipalTypeT>(value);
  }
  template <typename PrincipalTypeT = Aws::String>
  AwsIamAccessKeyDetails& WithPrincipalType(PrincipalTypeT&& value) {
    SetPrincipalType(std::forward<PrincipalTypeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPrincipalName(PrincipalNameT&& value) {
    ...
    m_principalName = std::forward<PrincipalNameT>(value);
  }
  template <typename PrincipalNameT = Aws::String>
  AwsIamAccessKeyDetails& WithPrincipalName(PrincipalNameT&& value) {
    SetPrincipalName(std::forward<PrincipalNameT>(value));
    return *this;
  }
  ///@}
