...
class Network {
 public:
  ...
  inline Network& WithDirection(NetworkDirection value) {
    SetDirection(value);
    return *this;
  }
  ///@}
  ...
  void SetSourceIpV4(SourceIpV4T&& value) {
    ...
    m_sourceIpV4 = std::forward<SourceIpV4T>(value);
  }
  template <typename SourceIpV4T = Aws::String>
  Network& WithSourceIpV4(SourceIpV4T&& value) {
    SetSourceIpV4(std::forward<SourceIpV4T>(value));
    return *this;
  }
  ///@}
  ...
  void SetSourceIpV6(SourceIpV6T&& value) {
    ...
    m_sourceIpV6 = std::forward<SourceIpV6T>(value);
  }
  template <typename SourceIpV6T = Aws::String>
  Network& WithSourceIpV6(SourceIpV6T&& value) {
    SetSourceIpV6(std::forward<SourceIpV6T>(value));
    return *this;
  }
  ///@}
  ...
  inline Network& WithSourcePort(int value) {
    SetSourcePort(value);
    return *this;
  }
  ///@}
  ...
  void SetSourceDomain(SourceDomainT&& value) {
    ...
    m_sourceDomain = std::forward<SourceDomainT>(value);
  }
  template <typename SourceDomainT = Aws::String>
  Network& WithSourceDomain(SourceDomainT&& value) {
    SetSourceDomain(std::forward<SourceDomainT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSourceMac(SourceMacT&& value) {
    ...
    m_sourceMac = std::forward<SourceMacT>(value);
  }
  template <typename SourceMacT = Aws::String>
  Network& WithSourceMac(SourceMacT&& value) {
    SetSourceMac(std::forward<SourceMacT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDestinationIpV4(DestinationIpV4T&& value) {
    ...
    m_destinationIpV4 = std::forward<DestinationIpV4T>(value);
  }
  template <typename DestinationIpV4T = Aws::String>
  Network& WithDestinationIpV4(DestinationIpV4T&& value) {
    SetDestinationIpV4(std::forward<DestinationIpV4T>(value));
    return *this;
  }
  ///@}
  ...
  void SetDestinationIpV6(DestinationIpV6T&& value) {
    ...
    m_destinationIpV6 = std::forward<DestinationIpV6T>(value);
  }
  template <typename DestinationIpV6T = Aws::String>
  Network& WithDestinationIpV6(DestinationIpV6T&& value) {
    SetDestinationIpV6(std::forward<DestinationIpV6T>(value));
    return *this;
  }
  ///@}
  ...
  inline Network& WithDestinationPort(int value) {
  ...
  void SetDestinationDomain(DestinationDomainT&& value) {
    ...
    m_destinationDomain = std::forward<DestinationDomainT>(value);
  }
  template <typename DestinationDomainT = Aws::String>
  Network& WithDestinationDomain(DestinationDomainT&& value) {
    SetDestinationDomain(std::forward<DestinationDomainT>(value));
    return *this;
  }
  ///@}
 private:
