...
class AwsEc2ClientVpnEndpointConnectionLogOptionsDetails {
 public:
  ...
  inline AwsEc2ClientVpnEndpointConnectionLogOptionsDetails& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  void SetCloudwatchLogGroup(CloudwatchLogGroupT&& value) {
    ...
    m_cloudwatchLogGroup = std::forward<CloudwatchLogGroupT>(value);
  }
  template <typename CloudwatchLogGroupT = Aws::String>
  AwsEc2ClientVpnEndpointConnectionLogOptionsDetails& WithCloudwatchLogGroup(CloudwatchLogGroupT&& value) {
    SetCloudwatchLogGroup(std::forward<CloudwatchLogGroupT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCloudwatchLogStream(CloudwatchLogStreamT&& value) {
    ...
    m_cloudwatchLogStream = std::forward<CloudwatchLogStreamT>(value);
  }
  template <typename CloudwatchLogStreamT = Aws::String>
  AwsEc2ClientVpnEndpointConnectionLogOptionsDetails& WithCloudwatchLogStream(CloudwatchLogStreamT&& value) {
    SetCloudwatchLogStream(std::forward<CloudwatchLogStreamT>(value));
    return *this;
  }
  ///@}
 private:
