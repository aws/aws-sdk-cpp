...
class AwsElasticsearchDomainLogPublishingOptionsLogConfig {
 public:
  ...
  template <typename CloudWatchLogsLogGroupArnT = Aws::String>
  AwsElasticsearchDomainLogPublishingOptionsLogConfig& WithCloudWatchLogsLogGroupArn(CloudWatchLogsLogGroupArnT&& value) {
  ...
  inline AwsElasticsearchDomainLogPublishingOptionsLogConfig& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
