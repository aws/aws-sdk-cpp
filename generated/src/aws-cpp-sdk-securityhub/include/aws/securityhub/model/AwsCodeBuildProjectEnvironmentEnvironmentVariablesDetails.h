...
class AwsCodeBuildProjectEnvironmentEnvironmentVariablesDetails {
 public:
  ...
  template <typename NameT = Aws::String>
  AwsCodeBuildProjectEnvironmentEnvironmentVariablesDetails& WithName(NameT&& value) {
  ...
  template <typename TypeT = Aws::String>
  AwsCodeBuildProjectEnvironmentEnvironmentVariablesDetails& WithType(TypeT&& value) {
  ...
  template <typename ValueT = Aws::String>
  AwsCodeBuildProjectEnvironmentEnvironmentVariablesDetails& WithValue(ValueT&& value) {
