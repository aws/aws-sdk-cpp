...
class AwsLambdaFunctionDetails {
 public:
  ...
  inline AwsLambdaFunctionDetails& WithMemorySize(int value) {
    SetMemorySize(value);
    return *this;
  }
  ///@}
  ...
  inline AwsLambdaFunctionDetails& WithTimeout(int value) {
    SetTimeout(value);
    return *this;
  }
  ///@}
  ...
  void SetPackageType(PackageTypeT&& value) {
    ...
    m_packageType = std::forward<PackageTypeT>(value);
  }
  template <typename PackageTypeT = Aws::String>
  AwsLambdaFunctionDetails& WithPackageType(PackageTypeT&& value) {
    SetPackageType(std::forward<PackageTypeT>(value));
    return *this;
  }
  ///@}
 private:
