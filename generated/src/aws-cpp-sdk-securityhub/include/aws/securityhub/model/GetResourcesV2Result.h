...
class GetResourcesV2Result {
 public:
  ...
  template <typename ResourcesT = Aws::Vector<ResourceResult>>
  GetResourcesV2Result& WithResources(ResourcesT&& value) {
    SetResources(std::forward<ResourcesT>(value));
    return *this;
  }
  template <typename ResourcesT = ResourceResult>
  GetResourcesV2Result& AddResources(ResourcesT&& value) {
    m_resourcesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetResourcesV2Result& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetResourcesV2Result& WithRequestId(RequestIdT&& value) {
