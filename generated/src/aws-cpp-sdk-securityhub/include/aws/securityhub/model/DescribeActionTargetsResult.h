...
class DescribeActionTargetsResult {
 public:
  ...
  void SetActionTargets(ActionTargetsT&& value) {
    m_actionTargetsHasBeenSet = true;
    m_actionTargets = std::forward<ActionTargetsT>(value);
  }
  template <typename ActionTargetsT = Aws::Vector<ActionTarget>>
  DescribeActionTargetsResult& WithActionTargets(ActionTargetsT&& value) {
    SetActionTargets(std::forward<ActionTargetsT>(value));
    return *this;
  }
  template <typename ActionTargetsT = ActionTarget>
  DescribeActionTargetsResult& AddActionTargets(ActionTargetsT&& value) {
    m_actionTargetsHasBeenSet = true;
    m_actionTargets.emplace_back(std::forward<ActionTargetsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeActionTargetsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeActionTargetsResult& WithRequestId(RequestIdT&& value) {
