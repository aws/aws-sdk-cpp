...
class ListConfigurationPolicyAssociationsResult {
 public:
  ...
  AWS_SECURITYHUB_API ListConfigurationPolicyAssociationsResult& operator=(
   ...
   * </p>
   */
  inline const Aws::Vector<ConfigurationPolicyAssociationSummary>& GetConfigurationPolicyAssociationSummaries() const {
    return m_configurationPolicyAssociationSummaries;
  }
  template <typename ConfigurationPolicyAssociationSummariesT = Aws::Vector<ConfigurationPolicyAssociationSummary>>
  void SetConfigurationPolicyAssociationSummaries(ConfigurationPolicyAssociationSummariesT&& value) {
    m_configurationPolicyAssociationSummariesHasBeenSet = true;
    m_configurationPolicyAssociationSummaries = std::forward<ConfigurationPolicyAssociationSummariesT>(value);
  }
  template <typename ConfigurationPolicyAssociationSummariesT = Aws::Vector<ConfigurationPolicyAssociationSummary>>
  ListConfigurationPolicyAssociationsResult& WithConfigurationPolicyAssociationSummaries(ConfigurationPolicyAssociationSummariesT&& value) {
    SetConfigurationPolicyAssociationSummaries(std::forward<ConfigurationPolicyAssociationSummariesT>(value));
    return *this;
  }
  template <typename ConfigurationPolicyAssociationSummariesT = ConfigurationPolicyAssociationSummary>
  ListConfigurationPolicyAssociationsResult& AddConfigurationPolicyAssociationSummaries(ConfigurationPolicyAssociationSummariesT&& value) {
    m_configurationPolicyAssociationSummariesHasBeenSet = true;
    m_configurationPolicyAssociationSummaries.emplace_back(std::forward<ConfigurationPolicyAssociationSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListConfigurationPolicyAssociationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListConfigurationPolicyAssociationsResult& WithRequestId(RequestIdT&& value) {
