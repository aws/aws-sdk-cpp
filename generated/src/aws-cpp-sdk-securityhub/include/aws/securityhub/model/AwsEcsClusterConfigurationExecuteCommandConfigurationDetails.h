...
class AwsEcsClusterConfigurationExecuteCommandConfigurationDetails {
 public:
  ...
  template <typename KmsKeyIdT = Aws::String>
  AwsEcsClusterConfigurationExecuteCommandConfigurationDetails& WithKmsKeyId(KmsKeyIdT&& value) {
   ...
   */
  inline const AwsEcsClusterConfigurationExecuteCommandConfigurationLogConfigurationDetails& GetLogConfiguration() const {
  ...
  template <typename LogConfigurationT = AwsEcsClusterConfigurationExecuteCommandConfigurationLogConfigurationDetails>
  AwsEcsClusterConfigurationExecuteCommandConfigurationDetails& WithLogConfiguration(LogConfigurationT&& value) {
  ...
  template <typename LoggingT = Aws::String>
  AwsEcsClusterConfigurationExecuteCommandConfigurationDetails& WithLogging(LoggingT&& value) {
