...
class ResourcesFilters {
 public:
  ...
  template <typename CompositeFiltersT = Aws::Vector<ResourcesCompositeFilter>>
  ResourcesFilters& WithCompositeFilters(CompositeFiltersT&& value) {
    SetCompositeFilters(std::forward<CompositeFiltersT>(value));
    return *this;
  }
  template <typename CompositeFiltersT = ResourcesCompositeFilter>
  ResourcesFilters& AddCompositeFilters(CompositeFiltersT&& value) {
    m_compositeFiltersHasBeenSet = true;
  ...
  inline ResourcesFilters& WithCompositeOperator(AllowedOperators value) {
