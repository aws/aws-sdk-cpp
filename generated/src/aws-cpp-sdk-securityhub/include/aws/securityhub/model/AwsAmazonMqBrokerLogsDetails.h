...
class AwsAmazonMqBrokerLogsDetails {
 public:
  ...
  inline AwsAmazonMqBrokerLogsDetails& WithAudit(bool value) {
    SetAudit(value);
    return *this;
  }
  ///@}
  ...
  inline AwsAmazonMqBrokerLogsDetails& WithGeneral(bool value) {
    SetGeneral(value);
    return *this;
  }
  ///@}
  ...
  void SetAuditLogGroup(AuditLogGroupT&& value) {
    ...
    m_auditLogGroup = std::forward<AuditLogGroupT>(value);
  }
  template <typename AuditLogGroupT = Aws::String>
  AwsAmazonMqBrokerLogsDetails& WithAuditLogGroup(AuditLogGroupT&& value) {
    SetAuditLogGroup(std::forward<AuditLogGroupT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGeneralLogGroup(GeneralLogGroupT&& value) {
    ...
    m_generalLogGroup = std::forward<GeneralLogGroupT>(value);
  }
  template <typename GeneralLogGroupT = Aws::String>
  AwsAmazonMqBrokerLogsDetails& WithGeneralLogGroup(GeneralLogGroupT&& value) {
    SetGeneralLogGroup(std::forward<GeneralLogGroupT>(value));
    return *this;
  }
  ///@}
