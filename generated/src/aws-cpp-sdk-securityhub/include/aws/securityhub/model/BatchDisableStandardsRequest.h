...
class BatchDisableStandardsRequest : public SecurityHubRequest {
 public:
  ...
  template <typename StandardsSubscriptionArnsT = Aws::Vector<Aws::String>>
  BatchDisableStandardsRequest& WithStandardsSubscriptionArns(StandardsSubscriptionArnsT&& value) {
  ...
  BatchDisableStandardsRequest& AddStandardsSubscriptionArns(StandardsSubscriptionArnsT&& value) {
    m_standardsSubscriptionArnsHasBeenSet = true;
