...
class AwsOpenSearchServiceDomainEncryptionAtRestOptionsDetails {
 public:
  ...
  inline AwsOpenSearchServiceDomainEncryptionAtRestOptionsDetails& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  template <typename KmsKeyIdT = Aws::String>
  AwsOpenSearchServiceDomainEncryptionAtRestOptionsDetails& WithKmsKeyId(KmsKeyIdT&& value) {
