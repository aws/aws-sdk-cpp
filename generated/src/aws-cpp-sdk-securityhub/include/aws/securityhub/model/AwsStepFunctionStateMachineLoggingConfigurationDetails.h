...
class AwsStepFunctionStateMachineLoggingConfigurationDetails {
 public:
   ...
   * be logged. </p>
   */
  inline const Aws::Vector<AwsStepFunctionStateMachineLoggingConfigurationDestinationsDetails>& GetDestinations() const {
  ...
  template <typename DestinationsT = Aws::Vector<AwsStepFunctionStateMachineLoggingConfigurationDestinationsDetails>>
  AwsStepFunctionStateMachineLoggingConfigurationDetails& WithDestinations(DestinationsT&& value) {
  ...
  AwsStepFunctionStateMachineLoggingConfigurationDetails& AddDestinations(DestinationsT&& value) {
    m_destinationsHasBeenSet = true;
  ...
  inline AwsStepFunctionStateMachineLoggingConfigurationDetails& WithIncludeExecutionData(bool value) {
  ...
  template <typename LevelT = Aws::String>
  AwsStepFunctionStateMachineLoggingConfigurationDetails& WithLevel(LevelT&& value) {
