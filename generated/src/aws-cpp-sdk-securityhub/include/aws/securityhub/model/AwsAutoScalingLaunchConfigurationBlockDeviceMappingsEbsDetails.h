...
class AwsAutoScalingLaunchConfigurationBlockDeviceMappingsEbsDetails {
 public:
  ...
  inline AwsAutoScalingLaunchConfigurationBlockDeviceMappingsEbsDetails& WithDeleteOnTermination(bool value) {
  ...
  inline AwsAutoScalingLaunchConfigurationBlockDeviceMappingsEbsDetails& WithEncrypted(bool value) {
    SetEncrypted(value);
    return *this;
  }
  ///@}
  ...
  inline AwsAutoScalingLaunchConfigurationBlockDeviceMappingsEbsDetails& WithIops(int value) {
    SetIops(value);
    return *this;
  }
  ///@}
  ...
  template <typename SnapshotIdT = Aws::String>
  AwsAutoScalingLaunchConfigurationBlockDeviceMappingsEbsDetails& WithSnapshotId(SnapshotIdT&& value) {
  ...
  inline AwsAutoScalingLaunchConfigurationBlockDeviceMappingsEbsDetails& WithVolumeSize(int value) {
    SetVolumeSize(value);
    return *this;
  }
  ///@}
  ...
  template <typename VolumeTypeT = Aws::String>
  AwsAutoScalingLaunchConfigurationBlockDeviceMappingsEbsDetails& WithVolumeType(VolumeTypeT&& value) {
