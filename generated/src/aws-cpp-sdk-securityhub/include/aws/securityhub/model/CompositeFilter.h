...
class CompositeFilter {
 public:
  ...
  template <typename StringFiltersT = Aws::Vector<OcsfStringFilter>>
  CompositeFilter& WithStringFilters(StringFiltersT&& value) {
    SetStringFilters(std::forward<StringFiltersT>(value));
    return *this;
  }
  template <typename StringFiltersT = OcsfStringFilter>
  CompositeFilter& AddStringFilters(StringFiltersT&& value) {
    m_stringFiltersHasBeenSet = true;
  ...
  void SetDateFilters(DateFiltersT&& value) {
    m_dateFiltersHasBeenSet = true;
    m_dateFilters = std::forward<DateFiltersT>(value);
  }
  template <typename DateFiltersT = Aws::Vector<OcsfDateFilter>>
  CompositeFilter& WithDateFilters(DateFiltersT&& value) {
    SetDateFilters(std::forward<DateFiltersT>(value));
    return *this;
  }
  template <typename DateFiltersT = OcsfDateFilter>
  CompositeFilter& AddDateFilters(DateFiltersT&& value) {
    m_dateFiltersHasBeenSet = true;
    m_dateFilters.emplace_back(std::forward<DateFiltersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBooleanFilters(BooleanFiltersT&& value) {
    m_booleanFiltersHasBeenSet = true;
    m_booleanFilters = std::forward<BooleanFiltersT>(value);
  }
  template <typename BooleanFiltersT = Aws::Vector<OcsfBooleanFilter>>
  CompositeFilter& WithBooleanFilters(BooleanFiltersT&& value) {
    SetBooleanFilters(std::forward<BooleanFiltersT>(value));
    return *this;
  }
  template <typename BooleanFiltersT = OcsfBooleanFilter>
  CompositeFilter& AddBooleanFilters(BooleanFiltersT&& value) {
    m_booleanFiltersHasBeenSet = true;
    m_booleanFilters.emplace_back(std::forward<BooleanFiltersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNumberFilters(NumberFiltersT&& value) {
    m_numberFiltersHasBeenSet = true;
    m_numberFilters = std::forward<NumberFiltersT>(value);
  }
  template <typename NumberFiltersT = Aws::Vector<OcsfNumberFilter>>
  CompositeFilter& WithNumberFilters(NumberFiltersT&& value) {
    SetNumberFilters(std::forward<NumberFiltersT>(value));
    return *this;
  }
  template <typename NumberFiltersT = OcsfNumberFilter>
  CompositeFilter& AddNumberFilters(NumberFiltersT&& value) {
    m_numberFiltersHasBeenSet = true;
    m_numberFilters.emplace_back(std::forward<NumberFiltersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMapFilters(MapFiltersT&& value) {
    m_mapFiltersHasBeenSet = true;
    m_mapFilters = std::forward<MapFiltersT>(value);
  }
  template <typename MapFiltersT = Aws::Vector<OcsfMapFilter>>
  CompositeFilter& WithMapFilters(MapFiltersT&& value) {
    SetMapFilters(std::forward<MapFiltersT>(value));
    return *this;
  }
  template <typename MapFiltersT = OcsfMapFilter>
  CompositeFilter& AddMapFilters(MapFiltersT&& value) {
    m_mapFiltersHasBeenSet = true;
    m_mapFilters.emplace_back(std::forward<MapFiltersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIpFilters(IpFiltersT&& value) {
    m_ipFiltersHasBeenSet = true;
    m_ipFilters = std::forward<IpFiltersT>(value);
  }
  template <typename IpFiltersT = Aws::Vector<OcsfIpFilter>>
  CompositeFilter& WithIpFilters(IpFiltersT&& value) {
    SetIpFilters(std::forward<IpFiltersT>(value));
    return *this;
  }
  template <typename IpFiltersT = OcsfIpFilter>
  CompositeFilter& AddIpFilters(IpFiltersT&& value) {
    m_ipFiltersHasBeenSet = true;
    m_ipFilters.emplace_back(std::forward<IpFiltersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NestedCompositeFiltersT = Aws::Vector<CompositeFilter>>
  CompositeFilter& WithNestedCompositeFilters(NestedCompositeFiltersT&& value) {
  ...
  CompositeFilter& AddNestedCompositeFilters(NestedCompositeFiltersT&& value) {
    m_nestedCompositeFiltersHasBeenSet = true;
  ...
  inline CompositeFilter& WithOperator(AllowedOperators value) {
    SetOperator(value);
    return *this;
  }
  ///@}
