...
class AwsEc2LaunchTemplateDataInstanceMarketOptionsSpotOptionsDetails {
 public:
  ...
  inline AwsEc2LaunchTemplateDataInstanceMarketOptionsSpotOptionsDetails& WithBlockDurationMinutes(int value) {
  ...
  void SetInstanceInterruptionBehavior(InstanceInterruptionBehaviorT&& value) {
    m_instanceInterruptionBehaviorHasBeenSet = true;
    m_instanceInterruptionBehavior = std::forward<InstanceInterruptionBehaviorT>(value);
  }
  template <typename InstanceInterruptionBehaviorT = Aws::String>
  AwsEc2LaunchTemplateDataInstanceMarketOptionsSpotOptionsDetails& WithInstanceInterruptionBehavior(InstanceInterruptionBehaviorT&& value) {
    SetInstanceInterruptionBehavior(std::forward<InstanceInterruptionBehaviorT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename MaxPriceT = Aws::String>
  AwsEc2LaunchTemplateDataInstanceMarketOptionsSpotOptionsDetails& WithMaxPrice(MaxPriceT&& value) {
  ...
  void SetSpotInstanceType(SpotInstanceTypeT&& value) {
    m_spotInstanceTypeHasBeenSet = true;
    m_spotInstanceType = std::forward<SpotInstanceTypeT>(value);
  }
  template <typename SpotInstanceTypeT = Aws::String>
  AwsEc2LaunchTemplateDataInstanceMarketOptionsSpotOptionsDetails& WithSpotInstanceType(SpotInstanceTypeT&& value) {
    SetSpotInstanceType(std::forward<SpotInstanceTypeT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ValidUntilT = Aws::String>
  AwsEc2LaunchTemplateDataInstanceMarketOptionsSpotOptionsDetails& WithValidUntil(ValidUntilT&& value) {
