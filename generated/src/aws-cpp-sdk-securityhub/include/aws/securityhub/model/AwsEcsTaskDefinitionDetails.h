...
class AwsEcsTaskDefinitionDetails {
 public:
   ...
   * task.</p>
   */
  inline const Aws::Vector<AwsEcsTaskDefinitionContainerDefinitionsDetails>& GetContainerDefinitions() const {
    return m_containerDefinitions;
  }
   ...
   */
  inline const Aws::Vector<AwsEcsTaskDefinitionInferenceAcceleratorsDetails>& GetInferenceAccelerators() const {
    return m_inferenceAccelerators;
  }
  ...
  void SetIpcMode(IpcModeT&& value) {
    ...
    m_ipcMode = std::forward<IpcModeT>(value);
  }
  template <typename IpcModeT = Aws::String>
  AwsEcsTaskDefinitionDetails& WithIpcMode(IpcModeT&& value) {
    SetIpcMode(std::forward<IpcModeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPidMode(PidModeT&& value) {
    ...
    m_pidMode = std::forward<PidModeT>(value);
  }
  template <typename PidModeT = Aws::String>
  AwsEcsTaskDefinitionDetails& WithPidMode(PidModeT&& value) {
    SetPidMode(std::forward<PidModeT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::Vector<AwsEcsTaskDefinitionPlacementConstraintsDetails>& GetPlacementConstraints() const {
    return m_placementConstraints;
  }
  ...
  void SetRequiresCompatibilities(RequiresCompatibilitiesT&& value) {
    ...
    m_requiresCompatibilities = std::forward<RequiresCompatibilitiesT>(value);
  }
  template <typename RequiresCompatibilitiesT = Aws::Vector<Aws::String>>
  AwsEcsTaskDefinitionDetails& WithRequiresCompatibilities(RequiresCompatibilitiesT&& value) {
    SetRequiresCompatibilities(std::forward<RequiresCompatibilitiesT>(value));
    return *this;
  }
  ...
  AwsEcsTaskDefinitionDetails& AddRequiresCompatibilities(RequiresCompatibilitiesT&& value) {
    m_requiresCompatibilitiesHasBeenSet = true;
    m_requiresCompatibilities.emplace_back(std::forward<RequiresCompatibilitiesT>(value));
    return *this;
  }
  ///@}
