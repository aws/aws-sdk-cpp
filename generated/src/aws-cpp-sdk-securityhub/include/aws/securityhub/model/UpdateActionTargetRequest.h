...
class UpdateActionTargetRequest : public SecurityHubRequest {
 public:
  ...
  template <typename ActionTargetArnT = Aws::String>
  UpdateActionTargetRequest& WithActionTargetArn(ActionTargetArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  UpdateActionTargetRequest& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateActionTargetRequest& WithDescription(DescriptionT&& value) {
