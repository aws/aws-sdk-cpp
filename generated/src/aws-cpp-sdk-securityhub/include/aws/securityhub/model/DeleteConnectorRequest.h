...
/**
 */
class DeleteConnectorRequest : public SecurityHubRequest {
 public:
  AWS_SECURITYHUB_API DeleteConnectorRequest() = default;
  ...
  template <typename ConnectorIdT = Aws::String>
  DeleteConnectorRequest& WithConnectorId(ConnectorIdT&& value) {
