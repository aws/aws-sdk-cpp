...
/**
 */
class GetConnectorRequest : public SecurityHubRequest {
 public:
  AWS_SECURITYHUB_API GetConnectorRequest() = default;
  ...
  template <typename ConnectorIdT = Aws::String>
  GetConnectorRequest& WithConnectorId(ConnectorIdT&& value) {
