...
class AutomationRulesActionV2 {
 public:
  ...
  inline void SetType(AutomationRulesActionTypeV2 value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline AutomationRulesActionV2& WithType(AutomationRulesActionTypeV2 value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetFindingFieldsUpdate(FindingFieldsUpdateT&& value) {
    ...
    m_findingFieldsUpdate = std::forward<FindingFieldsUpdateT>(value);
  }
  template <typename FindingFieldsUpdateT = AutomationRulesFindingFieldsUpdateV2>
  AutomationRulesActionV2& WithFindingFieldsUpdate(FindingFieldsUpdateT&& value) {
    SetFindingFieldsUpdate(std::forward<FindingFieldsUpdateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExternalIntegrationConfiguration(ExternalIntegrationConfigurationT&& value) {
    ...
    m_externalIntegrationConfiguration = std::forward<ExternalIntegrationConfigurationT>(value);
  }
  template <typename ExternalIntegrationConfigurationT = ExternalIntegrationConfiguration>
  AutomationRulesActionV2& WithExternalIntegrationConfiguration(ExternalIntegrationConfigurationT&& value) {
    SetExternalIntegrationConfiguration(std::forward<ExternalIntegrationConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
