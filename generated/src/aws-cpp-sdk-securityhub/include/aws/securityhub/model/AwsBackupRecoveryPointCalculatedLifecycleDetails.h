...
class AwsBackupRecoveryPointCalculatedLifecycleDetails {
 public:
  ...
  void SetDeleteAt(DeleteAtT&& value) {
    ...
    m_deleteAt = std::forward<DeleteAtT>(value);
  }
  template <typename DeleteAtT = Aws::String>
  AwsBackupRecoveryPointCalculatedLifecycleDetails& WithDeleteAt(DeleteAtT&& value) {
    SetDeleteAt(std::forward<DeleteAtT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMoveToColdStorageAt(MoveToColdStorageAtT&& value) {
    ...
    m_moveToColdStorageAt = std::forward<MoveToColdStorageAtT>(value);
  }
  template <typename MoveToColdStorageAtT = Aws::String>
  AwsBackupRecoveryPointCalculatedLifecycleDetails& WithMoveToColdStorageAt(MoveToColdStorageAtT&& value) {
    SetMoveToColdStorageAt(std::forward<MoveToColdStorageAtT>(value));
    return *this;
  }
  ///@}
 private:
