...
class AwsEcrRepositoryDetails {
 public:
   ...
   */
  inline const AwsEcrRepositoryImageScanningConfigurationDetails& GetImageScanningConfiguration() const {
    return m_imageScanningConfiguration;
  }
  ...
  void SetImageTagMutability(ImageTagMutabilityT&& value) {
    ...
    m_imageTagMutability = std::forward<ImageTagMutabilityT>(value);
  }
  template <typename ImageTagMutabilityT = Aws::String>
  AwsEcrRepositoryDetails& WithImageTagMutability(ImageTagMutabilityT&& value) {
    SetImageTagMutability(std::forward<ImageTagMutabilityT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRepositoryPolicyText(RepositoryPolicyTextT&& value) {
    ...
    m_repositoryPolicyText = std::forward<RepositoryPolicyTextT>(value);
  }
  template <typename RepositoryPolicyTextT = Aws::String>
  AwsEcrRepositoryDetails& WithRepositoryPolicyText(RepositoryPolicyTextT&& value) {
    SetRepositoryPolicyText(std::forward<RepositoryPolicyTextT>(value));
    return *this;
  }
  ///@}
 private:
