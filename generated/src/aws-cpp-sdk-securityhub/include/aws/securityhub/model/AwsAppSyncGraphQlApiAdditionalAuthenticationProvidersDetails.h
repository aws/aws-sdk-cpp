...
class AwsAppSyncGraphQlApiAdditionalAuthenticationProvidersDetails {
 public:
  ...
  template <typename AuthenticationTypeT = Aws::String>
  AwsAppSyncGraphQlApiAdditionalAuthenticationProvidersDetails& WithAuthenticationType(AuthenticationTypeT&& value) {
  ...
  template <typename LambdaAuthorizerConfigT = AwsAppSyncGraphQlApiLambdaAuthorizerConfigDetails>
  AwsAppSyncGraphQlApiAdditionalAuthenticationProvidersDetails& WithLambdaAuthorizerConfig(LambdaAuthorizerConfigT&& value) {
  ...
  template <typename OpenIdConnectConfigT = AwsAppSyncGraphQlApiOpenIdConnectConfigDetails>
  AwsAppSyncGraphQlApiAdditionalAuthenticationProvidersDetails& WithOpenIdConnectConfig(OpenIdConnectConfigT&& value) {
  ...
  template <typename UserPoolConfigT = AwsAppSyncGraphQlApiUserPoolConfigDetails>
  AwsAppSyncGraphQlApiAdditionalAuthenticationProvidersDetails& WithUserPoolConfig(UserPoolConfigT&& value) {
