...
class AwsEksClusterLoggingDetails {
 public:
  ...
  void SetClusterLogging(ClusterLoggingT&& value) {
    ...
    m_clusterLogging = std::forward<ClusterLoggingT>(value);
  }
  template <typename ClusterLoggingT = Aws::Vector<AwsEksClusterLoggingClusterLoggingDetails>>
  AwsEksClusterLoggingDetails& WithClusterLogging(ClusterLoggingT&& value) {
    SetClusterLogging(std::forward<ClusterLoggingT>(value));
    return *this;
  }
  ...
  AwsEksClusterLoggingDetails& AddClusterLogging(ClusterLoggingT&& value) {
    m_clusterLoggingHasBeenSet = true;
    m_clusterLogging.emplace_back(std::forward<ClusterLoggingT>(value));
    return *this;
  }
  ///@}
 private:
