...
namespace Model
{
  ...
  public:
    ...
    inline void SetFieldName(ResourcesDateField value) { m_fieldNameHasBeenSet = true; m_fieldName = value; }
    inline ResourcesDateFilter& WithFieldName(ResourcesDateField value) { SetFieldName(value); return *this;}
    ///@}
    ...
    template<typename FilterT = DateFilter>
    ResourcesDateFilter& WithFilter(FilterT&& value) { SetFilter(std::forward<FilterT>(value)); return *this;}
    ///@}
  private:
