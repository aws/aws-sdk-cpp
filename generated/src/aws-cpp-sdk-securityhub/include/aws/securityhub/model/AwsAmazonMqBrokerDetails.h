...
class AwsAmazonMqBrokerDetails {
 public:
  ...
  void SetAuthenticationStrategy(AuthenticationStrategyT&& value) {
    ...
    m_authenticationStrategy = std::forward<AuthenticationStrategyT>(value);
  }
  template <typename AuthenticationStrategyT = Aws::String>
  AwsAmazonMqBrokerDetails& WithAuthenticationStrategy(AuthenticationStrategyT&& value) {
    SetAuthenticationStrategy(std::forward<AuthenticationStrategyT>(value));
    return *this;
  }
  ///@}
  ...
  inline AwsAmazonMqBrokerDetails& WithAutoMinorVersionUpgrade(bool value) {
  ...
  void SetDeploymentMode(DeploymentModeT&& value) {
    ...
    m_deploymentMode = std::forward<DeploymentModeT>(value);
  }
  template <typename DeploymentModeT = Aws::String>
  AwsAmazonMqBrokerDetails& WithDeploymentMode(DeploymentModeT&& value) {
    SetDeploymentMode(std::forward<DeploymentModeT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const AwsAmazonMqBrokerMaintenanceWindowStartTimeDetails& GetMaintenanceWindowStartTime() const {
    return m_maintenanceWindowStartTime;
  }
  ...
  inline AwsAmazonMqBrokerDetails& WithPubliclyAccessible(bool value) {
