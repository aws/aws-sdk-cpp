...
class NumberFilter {
 public:
  ...
  inline void SetGte(double value) {
    m_gteHasBeenSet = true;
    m_gte = value;
  }
  inline NumberFilter& WithGte(double value) {
    SetGte(value);
    return *this;
  }
  ///@}
  ...
  inline void SetLte(double value) {
    m_lteHasBeenSet = true;
    m_lte = value;
  }
  inline NumberFilter& WithLte(double value) {
    SetLte(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEq(double value) {
    m_eqHasBeenSet = true;
    m_eq = value;
  }
  inline NumberFilter& WithEq(double value) {
    SetEq(value);
    return *this;
  }
  ///@}
  ...
  inline void SetGt(double value) {
    m_gtHasBeenSet = true;
    m_gt = value;
  }
  inline NumberFilter& WithGt(double value) {
    SetGt(value);
    return *this;
  }
  ///@}
  ...
  inline void SetLt(double value) {
    m_ltHasBeenSet = true;
    m_lt = value;
  }
  inline NumberFilter& WithLt(double value) {
    SetLt(value);
    return *this;
  }
  ///@}
