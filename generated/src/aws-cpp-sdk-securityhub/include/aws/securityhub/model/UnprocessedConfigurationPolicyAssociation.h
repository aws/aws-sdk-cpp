...
class UnprocessedConfigurationPolicyAssociation {
 public:
   ...
   */
  inline const ConfigurationPolicyAssociation& GetConfigurationPolicyAssociationIdentifiers() const {
    return m_configurationPolicyAssociationIdentifiers;
  }
  ...
  void SetConfigurationPolicyAssociationIdentifiers(ConfigurationPolicyAssociationIdentifiersT&& value) {
    ...
    m_configurationPolicyAssociationIdentifiers = std::forward<ConfigurationPolicyAssociationIdentifiersT>(value);
  }
  template <typename ConfigurationPolicyAssociationIdentifiersT = ConfigurationPolicyAssociation>
  UnprocessedConfigurationPolicyAssociation& WithConfigurationPolicyAssociationIdentifiers(
      ConfigurationPolicyAssociationIdentifiersT&& value) {
    SetConfigurationPolicyAssociationIdentifiers(std::forward<ConfigurationPolicyAssociationIdentifiersT>(value));
    return *this;
  }
  ///@}
