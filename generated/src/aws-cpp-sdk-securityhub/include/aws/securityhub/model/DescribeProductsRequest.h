...
class DescribeProductsRequest : public SecurityHubRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  DescribeProductsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeProductsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename ProductArnT = Aws::String>
  DescribeProductsRequest& WithProductArn(ProductArnT&& value) {
