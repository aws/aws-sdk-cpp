...
class BatchGetStandardsControlAssociationsRequest : public SecurityHubRequest {
 public:
   ...
   */
  inline const Aws::Vector<StandardsControlAssociationId>& GetStandardsControlAssociationIds() const {
    return m_standardsControlAssociationIds;
  }
  ...
  void SetStandardsControlAssociationIds(StandardsControlAssociationIdsT&& value) {
    m_standardsControlAssociationIdsHasBeenSet = true;
    m_standardsControlAssociationIds = std::forward<StandardsControlAssociationIdsT>(value);
  }
  template <typename StandardsControlAssociationIdsT = Aws::Vector<StandardsControlAssociationId>>
  BatchGetStandardsControlAssociationsRequest& WithStandardsControlAssociationIds(StandardsControlAssociationIdsT&& value) {
    SetStandardsControlAssociationIds(std::forward<StandardsControlAssociationIdsT>(value));
    return *this;
  }
  template <typename StandardsControlAssociationIdsT = StandardsControlAssociationId>
  BatchGetStandardsControlAssociationsRequest& AddStandardsControlAssociationIds(StandardsControlAssociationIdsT&& value) {
    m_standardsControlAssociationIdsHasBeenSet = true;
    m_standardsControlAssociationIds.emplace_back(std::forward<StandardsControlAssociationIdsT>(value));
    return *this;
  }
  ///@}
 private:
