...
class AwsWafRegionalRuleGroupRulesDetails {
 public:
  ...
  template <typename ActionT = AwsWafRegionalRuleGroupRulesActionDetails>
  AwsWafRegionalRuleGroupRulesDetails& WithAction(ActionT&& value) {
  ...
  inline AwsWafRegionalRuleGroupRulesDetails& WithPriority(int value) {
    SetPriority(value);
    return *this;
  }
  ///@}
  ...
  template <typename RuleIdT = Aws::String>
  AwsWafRegionalRuleGroupRulesDetails& WithRuleId(RuleIdT&& value) {
  ...
  template <typename TypeT = Aws::String>
  AwsWafRegionalRuleGroupRulesDetails& WithType(TypeT&& value) {
