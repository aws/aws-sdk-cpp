...
class AwsEcsClusterDefaultCapacityProviderStrategyDetails {
 public:
  ...
  inline AwsEcsClusterDefaultCapacityProviderStrategyDetails& WithBase(int value) {
    SetBase(value);
    return *this;
  }
  ///@}
  ...
  template <typename CapacityProviderT = Aws::String>
  AwsEcsClusterDefaultCapacityProviderStrategyDetails& WithCapacityProvider(CapacityProviderT&& value) {
  ...
  inline AwsEcsClusterDefaultCapacityProviderStrategyDetails& WithWeight(int value) {
    SetWeight(value);
    return *this;
  }
  ///@}
