...
class AwsEc2SecurityGroupIpPermission {
 public:
  ...
  void SetIpProtocol(IpProtocolT&& value) {
    ...
    m_ipProtocol = std::forward<IpProtocolT>(value);
  }
  template <typename IpProtocolT = Aws::String>
  AwsEc2SecurityGroupIpPermission& WithIpProtocol(IpProtocolT&& value) {
    SetIpProtocol(std::forward<IpProtocolT>(value));
    return *this;
  }
  ///@}
  ...
  inline AwsEc2SecurityGroupIpPermission& WithFromPort(int value) {
    SetFromPort(value);
    return *this;
  }
  ///@}
  ...
  inline AwsEc2SecurityGroupIpPermission& WithToPort(int value) {
    SetToPort(value);
    return *this;
  }
  ///@}
  ...
  void SetUserIdGroupPairs(UserIdGroupPairsT&& value) {
    ...
    m_userIdGroupPairs = std::forward<UserIdGroupPairsT>(value);
  }
  template <typename UserIdGroupPairsT = Aws::Vector<AwsEc2SecurityGroupUserIdGroupPair>>
  AwsEc2SecurityGroupIpPermission& WithUserIdGroupPairs(UserIdGroupPairsT&& value) {
    SetUserIdGroupPairs(std::forward<UserIdGroupPairsT>(value));
    return *this;
  }
  ...
  AwsEc2SecurityGroupIpPermission& AddUserIdGroupPairs(UserIdGroupPairsT&& value) {
    m_userIdGroupPairsHasBeenSet = true;
    m_userIdGroupPairs.emplace_back(std::forward<UserIdGroupPairsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIpv6Ranges(Ipv6RangesT&& value) {
    ...
    m_ipv6Ranges = std::forward<Ipv6RangesT>(value);
  }
  template <typename Ipv6RangesT = Aws::Vector<AwsEc2SecurityGroupIpv6Range>>
  AwsEc2SecurityGroupIpPermission& WithIpv6Ranges(Ipv6RangesT&& value) {
    SetIpv6Ranges(std::forward<Ipv6RangesT>(value));
    return *this;
  }
  ...
  AwsEc2SecurityGroupIpPermission& AddIpv6Ranges(Ipv6RangesT&& value) {
    m_ipv6RangesHasBeenSet = true;
    m_ipv6Ranges.emplace_back(std::forward<Ipv6RangesT>(value));
    return *this;
  }
  ///@}
