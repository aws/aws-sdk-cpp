...
class StandardsSubscription {
 public:
  ...
  void SetStandardsSubscriptionArn(StandardsSubscriptionArnT&& value) {
    ...
    m_standardsSubscriptionArn = std::forward<StandardsSubscriptionArnT>(value);
  }
  template <typename StandardsSubscriptionArnT = Aws::String>
  StandardsSubscription& WithStandardsSubscriptionArn(StandardsSubscriptionArnT&& value) {
    SetStandardsSubscriptionArn(std::forward<StandardsSubscriptionArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStandardsArn(StandardsArnT&& value) {
    ...
    m_standardsArn = std::forward<StandardsArnT>(value);
  }
  template <typename StandardsArnT = Aws::String>
  StandardsSubscription& WithStandardsArn(StandardsArnT&& value) {
    SetStandardsArn(std::forward<StandardsArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStandardsInput(StandardsInputT&& value) {
    ...
    m_standardsInput = std::forward<StandardsInputT>(value);
  }
  template <typename StandardsInputT = Aws::Map<Aws::String, Aws::String>>
  StandardsSubscription& WithStandardsInput(StandardsInputT&& value) {
    SetStandardsInput(std::forward<StandardsInputT>(value));
    return *this;
  }
  ...
  StandardsSubscription& AddStandardsInput(StandardsInputKeyT&& key, StandardsInputValueT&& value) {
    m_standardsInputHasBeenSet = true;
    m_standardsInput.emplace(std::forward<StandardsInputKeyT>(key), std::forward<StandardsInputValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStandardsStatus(StandardsStatus value) {
    m_standardsStatusHasBeenSet = true;
    m_standardsStatus = value;
  }
  inline StandardsSubscription& WithStandardsStatus(StandardsStatus value) {
    SetStandardsStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStandardsControlsUpdatable(StandardsControlsUpdatable value) {
    m_standardsControlsUpdatableHasBeenSet = true;
    m_standardsControlsUpdatable = value;
  }
  inline StandardsSubscription& WithStandardsControlsUpdatable(StandardsControlsUpdatable value) {
    SetStandardsControlsUpdatable(value);
    return *this;
  }
  ///@}
  ...
  void SetStandardsStatusReason(StandardsStatusReasonT&& value) {
    ...
    m_standardsStatusReason = std::forward<StandardsStatusReasonT>(value);
  }
  template <typename StandardsStatusReasonT = StandardsStatusReason>
  StandardsSubscription& WithStandardsStatusReason(StandardsStatusReasonT&& value) {
    SetStandardsStatusReason(std::forward<StandardsStatusReasonT>(value));
    return *this;
  }
  ///@}
 private:
