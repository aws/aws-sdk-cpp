...
namespace Model
{
  ...
  /**
   */
  class TagResourceRequest : public SecurityHubRequest
  {
  public:
    AWS_SECURITYHUB_API TagResourceRequest() = default;
    ...
    ///@{
    /**
     * <p>The tags to add to the resource. You can add up to 50 tags at a time. The tag
