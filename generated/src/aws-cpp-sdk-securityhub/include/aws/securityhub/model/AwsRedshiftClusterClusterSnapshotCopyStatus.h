...
class AwsRedshiftClusterClusterSnapshotCopyStatus {
 public:
  ...
  template <typename DestinationRegionT = Aws::String>
  AwsRedshiftClusterClusterSnapshotCopyStatus& WithDestinationRegion(DestinationRegionT&& value) {
  ...
  inline AwsRedshiftClusterClusterSnapshotCopyStatus& WithManualSnapshotRetentionPeriod(int value) {
  ...
  inline AwsRedshiftClusterClusterSnapshotCopyStatus& WithRetentionPeriod(int value) {
  ...
  template <typename SnapshotCopyGrantNameT = Aws::String>
  AwsRedshiftClusterClusterSnapshotCopyStatus& WithSnapshotCopyGrantName(SnapshotCopyGrantNameT&& value) {
