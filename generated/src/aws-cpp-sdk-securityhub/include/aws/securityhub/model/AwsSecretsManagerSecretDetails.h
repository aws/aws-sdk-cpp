...
class AwsSecretsManagerSecretDetails {
 public:
  ...
  inline void SetRotationOccurredWithinFrequency(bool value) {
    m_rotationOccurredWithinFrequencyHasBeenSet = true;
    m_rotationOccurredWithinFrequency = value;
  }
  inline AwsSecretsManagerSecretDetails& WithRotationOccurredWithinFrequency(bool value) {
    SetRotationOccurredWithinFrequency(value);
    return *this;
  }
  ///@}
  ...
  inline AwsSecretsManagerSecretDetails& WithRotationEnabled(bool value) {
  ...
  inline AwsSecretsManagerSecretDetails& WithDeleted(bool value) {
    SetDeleted(value);
    return *this;
  }
  ///@}
