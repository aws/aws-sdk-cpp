...
class AwsWafRegionalRateBasedRuleMatchPredicate {
 public:
  ...
  template <typename DataIdT = Aws::String>
  AwsWafRegionalRateBasedRuleMatchPredicate& WithDataId(DataIdT&& value) {
  ...
  inline AwsWafRegionalRateBasedRuleMatchPredicate& WithNegated(bool value) {
    SetNegated(value);
    return *this;
  }
  ///@}
  ...
  template <typename TypeT = Aws::String>
  AwsWafRegionalRateBasedRuleMatchPredicate& WithType(TypeT&& value) {
