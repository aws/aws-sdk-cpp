...
namespace Model
{
  ...
  {
  public:
    AWS_SECURITYHUB_API UpdateInsightResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateInsightResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
