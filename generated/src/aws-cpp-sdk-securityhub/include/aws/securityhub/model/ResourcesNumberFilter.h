...
class ResourcesNumberFilter {
 public:
  ...
  inline void SetFieldName(ResourcesNumberField value) {
    m_fieldNameHasBeenSet = true;
    m_fieldName = value;
  }
  inline ResourcesNumberFilter& WithFieldName(ResourcesNumberField value) {
    SetFieldName(value);
    return *this;
  }
  ///@}
  ...
  template <typename FilterT = NumberFilter>
  ResourcesNumberFilter& WithFilter(FilterT&& value) {
