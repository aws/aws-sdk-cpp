...
class AwsS3BucketNotificationConfigurationS3KeyFilterRule {
 public:
  ...
  inline void SetName(AwsS3BucketNotificationConfigurationS3KeyFilterRuleName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline AwsS3BucketNotificationConfigurationS3KeyFilterRule& WithName(AwsS3BucketNotificationConfigurationS3KeyFilterRuleName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValueT = Aws::String>
  AwsS3BucketNotificationConfigurationS3KeyFilterRule& WithValue(ValueT&& value) {
