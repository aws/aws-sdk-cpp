...
class AwsEcsTaskDefinitionContainerDefinitionsHealthCheckDetails {
 public:
  ...
  template <typename CommandT = Aws::Vector<Aws::String>>
  AwsEcsTaskDefinitionContainerDefinitionsHealthCheckDetails& WithCommand(CommandT&& value) {
    SetCommand(std::forward<CommandT>(value));
    return *this;
  }
  template <typename CommandT = Aws::String>
  AwsEcsTaskDefinitionContainerDefinitionsHealthCheckDetails& AddCommand(CommandT&& value) {
    m_commandHasBeenSet = true;
  ...
  inline AwsEcsTaskDefinitionContainerDefinitionsHealthCheckDetails& WithInterval(int value) {
    SetInterval(value);
    return *this;
  }
  ///@}
  ...
  inline AwsEcsTaskDefinitionContainerDefinitionsHealthCheckDetails& WithRetries(int value) {
    SetRetries(value);
    return *this;
  }
  ///@}
  ...
  inline AwsEcsTaskDefinitionContainerDefinitionsHealthCheckDetails& WithStartPeriod(int value) {
  ...
  inline AwsEcsTaskDefinitionContainerDefinitionsHealthCheckDetails& WithTimeout(int value) {
    SetTimeout(value);
    return *this;
  }
  ///@}
