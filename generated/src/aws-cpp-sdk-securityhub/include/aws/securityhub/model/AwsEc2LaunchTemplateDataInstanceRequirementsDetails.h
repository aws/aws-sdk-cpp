...
class AwsEc2LaunchTemplateDataInstanceRequirementsDetails {
 public:
   ...
   */
  inline const AwsEc2LaunchTemplateDataInstanceRequirementsAcceleratorCountDetails& GetAcceleratorCount() const {
    return m_acceleratorCount;
  }
  ...
  template <typename AcceleratorCountT = AwsEc2LaunchTemplateDataInstanceRequirementsAcceleratorCountDetails>
  AwsEc2LaunchTemplateDataInstanceRequirementsDetails& WithAcceleratorCount(AcceleratorCountT&& value) {
  ...
  template <typename AcceleratorManufacturersT = Aws::Vector<Aws::String>>
  AwsEc2LaunchTemplateDataInstanceRequirementsDetails& WithAcceleratorManufacturers(AcceleratorManufacturersT&& value) {
  ...
  AwsEc2LaunchTemplateDataInstanceRequirementsDetails& AddAcceleratorManufacturers(AcceleratorManufacturersT&& value) {
    m_acceleratorManufacturersHasBeenSet = true;
    m_acceleratorManufacturers.emplace_back(std::forward<AcceleratorManufacturersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename AcceleratorNamesT = Aws::Vector<Aws::String>>
  AwsEc2LaunchTemplateDataInstanceRequirementsDetails& WithAcceleratorNames(AcceleratorNamesT&& value) {
    SetAcceleratorNames(std::forward<AcceleratorNamesT>(value));
    return *this;
  }
  template <typename AcceleratorNamesT = Aws::String>
  AwsEc2LaunchTemplateDataInstanceRequirementsDetails& AddAcceleratorNames(AcceleratorNamesT&& value) {
    m_acceleratorNamesHasBeenSet = true;
    m_acceleratorNames.emplace_back(std::forward<AcceleratorNamesT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const AwsEc2LaunchTemplateDataInstanceRequirementsAcceleratorTotalMemoryMiBDetails& GetAcceleratorTotalMemoryMiB() const {
    return m_acceleratorTotalMemoryMiB;
  }
  ...
  template <typename AcceleratorTotalMemoryMiBT = AwsEc2LaunchTemplateDataInstanceRequirementsAcceleratorTotalMemoryMiBDetails>
  AwsEc2LaunchTemplateDataInstanceRequirementsDetails& WithAcceleratorTotalMemoryMiB(AcceleratorTotalMemoryMiBT&& value) {
  ...
  template <typename AcceleratorTypesT = Aws::Vector<Aws::String>>
  AwsEc2LaunchTemplateDataInstanceRequirementsDetails& WithAcceleratorTypes(AcceleratorTypesT&& value) {
    SetAcceleratorTypes(std::forward<AcceleratorTypesT>(value));
    return *this;
  }
  template <typename AcceleratorTypesT = Aws::String>
  AwsEc2LaunchTemplateDataInstanceRequirementsDetails& AddAcceleratorTypes(AcceleratorTypesT&& value) {
    m_acceleratorTypesHasBeenSet = true;
  ...
  void SetBareMetal(BareMetalT&& value) {
    m_bareMetalHasBeenSet = true;
    m_bareMetal = std::forward<BareMetalT>(value);
  }
  template <typename BareMetalT = Aws::String>
  AwsEc2LaunchTemplateDataInstanceRequirementsDetails& WithBareMetal(BareMetalT&& value) {
    SetBareMetal(std::forward<BareMetalT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const AwsEc2LaunchTemplateDataInstanceRequirementsBaselineEbsBandwidthMbpsDetails& GetBaselineEbsBandwidthMbps() const {
    return m_baselineEbsBandwidthMbps;
  }
  ...
  template <typename BaselineEbsBandwidthMbpsT = AwsEc2LaunchTemplateDataInstanceRequirementsBaselineEbsBandwidthMbpsDetails>
  AwsEc2LaunchTemplateDataInstanceRequirementsDetails& WithBaselineEbsBandwidthMbps(BaselineEbsBandwidthMbpsT&& value) {
  ...
  void SetBurstablePerformance(BurstablePerformanceT&& value) {
    m_burstablePerformanceHasBeenSet = true;
    m_burstablePerformance = std::forward<BurstablePerformanceT>(value);
  }
  template <typename BurstablePerformanceT = Aws::String>
  AwsEc2LaunchTemplateDataInstanceRequirementsDetails& WithBurstablePerformance(BurstablePerformanceT&& value) {
    SetBurstablePerformance(std::forward<BurstablePerformanceT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename CpuManufacturersT = Aws::Vector<Aws::String>>
  AwsEc2LaunchTemplateDataInstanceRequirementsDetails& WithCpuManufacturers(CpuManufacturersT&& value) {
    SetCpuManufacturers(std::forward<CpuManufacturersT>(value));
    return *this;
  }
  template <typename CpuManufacturersT = Aws::String>
  AwsEc2LaunchTemplateDataInstanceRequirementsDetails& AddCpuManufacturers(CpuManufacturersT&& value) {
    m_cpuManufacturersHasBeenSet = true;
    m_cpuManufacturers.emplace_back(std::forward<CpuManufacturersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ExcludedInstanceTypesT = Aws::Vector<Aws::String>>
  AwsEc2LaunchTemplateDataInstanceRequirementsDetails& WithExcludedInstanceTypes(ExcludedInstanceTypesT&& value) {
    SetExcludedInstanceTypes(std::forward<ExcludedInstanceTypesT>(value));
    return *this;
  }
  template <typename ExcludedInstanceTypesT = Aws::String>
  AwsEc2LaunchTemplateDataInstanceRequirementsDetails& AddExcludedInstanceTypes(ExcludedInstanceTypesT&& value) {
    m_excludedInstanceTypesHasBeenSet = true;
  ...
  template <typename InstanceGenerationsT = Aws::Vector<Aws::String>>
  AwsEc2LaunchTemplateDataInstanceRequirementsDetails& WithInstanceGenerations(InstanceGenerationsT&& value) {
    SetInstanceGenerations(std::forward<InstanceGenerationsT>(value));
    return *this;
  }
  template <typename InstanceGenerationsT = Aws::String>
  AwsEc2LaunchTemplateDataInstanceRequirementsDetails& AddInstanceGenerations(InstanceGenerationsT&& value) {
    m_instanceGenerationsHasBeenSet = true;
    m_instanceGenerations.emplace_back(std::forward<InstanceGenerationsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLocalStorage(LocalStorageT&& value) {
    m_localStorageHasBeenSet = true;
    m_localStorage = std::forward<LocalStorageT>(value);
  }
  template <typename LocalStorageT = Aws::String>
  AwsEc2LaunchTemplateDataInstanceRequirementsDetails& WithLocalStorage(LocalStorageT&& value) {
    SetLocalStorage(std::forward<LocalStorageT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename LocalStorageTypesT = Aws::Vector<Aws::String>>
  AwsEc2LaunchTemplateDataInstanceRequirementsDetails& WithLocalStorageTypes(LocalStorageTypesT&& value) {
    SetLocalStorageTypes(std::forward<LocalStorageTypesT>(value));
    return *this;
  }
  template <typename LocalStorageTypesT = Aws::String>
  AwsEc2LaunchTemplateDataInstanceRequirementsDetails& AddLocalStorageTypes(LocalStorageTypesT&& value) {
    m_localStorageTypesHasBeenSet = true;
    m_localStorageTypes.emplace_back(std::forward<LocalStorageTypesT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const AwsEc2LaunchTemplateDataInstanceRequirementsMemoryGiBPerVCpuDetails& GetMemoryGiBPerVCpu() const {
    return m_memoryGiBPerVCpu;
  }
  ...
  template <typename MemoryGiBPerVCpuT = AwsEc2LaunchTemplateDataInstanceRequirementsMemoryGiBPerVCpuDetails>
  AwsEc2LaunchTemplateDataInstanceRequirementsDetails& WithMemoryGiBPerVCpu(MemoryGiBPerVCpuT&& value) {
  ...
  template <typename MemoryMiBT = AwsEc2LaunchTemplateDataInstanceRequirementsMemoryMiBDetails>
  AwsEc2LaunchTemplateDataInstanceRequirementsDetails& WithMemoryMiB(MemoryMiBT&& value) {
   ...
   */
  inline const AwsEc2LaunchTemplateDataInstanceRequirementsNetworkInterfaceCountDetails& GetNetworkInterfaceCount() const {
  ...
  template <typename NetworkInterfaceCountT = AwsEc2LaunchTemplateDataInstanceRequirementsNetworkInterfaceCountDetails>
  AwsEc2LaunchTemplateDataInstanceRequirementsDetails& WithNetworkInterfaceCount(NetworkInterfaceCountT&& value) {
  ...
  inline AwsEc2LaunchTemplateDataInstanceRequirementsDetails& WithOnDemandMaxPricePercentageOverLowestPrice(int value) {
  ...
  inline AwsEc2LaunchTemplateDataInstanceRequirementsDetails& WithRequireHibernateSupport(bool value) {
  ...
  inline AwsEc2LaunchTemplateDataInstanceRequirementsDetails& WithSpotMaxPricePercentageOverLowestPrice(int value) {
   ...
   */
  inline const AwsEc2LaunchTemplateDataInstanceRequirementsTotalLocalStorageGBDetails& GetTotalLocalStorageGB() const {
    return m_totalLocalStorageGB;
  }
  ...
  template <typename TotalLocalStorageGBT = AwsEc2LaunchTemplateDataInstanceRequirementsTotalLocalStorageGBDetails>
  AwsEc2LaunchTemplateDataInstanceRequirementsDetails& WithTotalLocalStorageGB(TotalLocalStorageGBT&& value) {
  ...
  template <typename VCpuCountT = AwsEc2LaunchTemplateDataInstanceRequirementsVCpuCountDetails>
  AwsEc2LaunchTemplateDataInstanceRequirementsDetails& WithVCpuCount(VCpuCountT&& value) {
