...
class InviteMembersResult {
 public:
  AWS_SECURITYHUB_API InviteMembersResult() = default;
  ...
  template <typename UnprocessedAccountsT = Aws::Vector<Result>>
  ...
  template <typename UnprocessedAccountsT = Aws::Vector<Result>>
  InviteMembersResult& WithUnprocessedAccounts(UnprocessedAccountsT&& value) {
    SetUnprocessedAccounts(std::forward<UnprocessedAccountsT>(value));
    return *this;
  }
  template <typename UnprocessedAccountsT = Result>
  InviteMembersResult& AddUnprocessedAccounts(UnprocessedAccountsT&& value) {
    m_unprocessedAccountsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  InviteMembersResult& WithRequestId(RequestIdT&& value) {
