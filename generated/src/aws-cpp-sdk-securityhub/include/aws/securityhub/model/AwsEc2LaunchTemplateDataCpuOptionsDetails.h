...
class AwsEc2LaunchTemplateDataCpuOptionsDetails {
 public:
  AWS_SECURITYHUB_API AwsEc2LaunchTemplateDataCpuOptionsDetails() = default;
  ...
  inline AwsEc2LaunchTemplateDataCpuOptionsDetails& WithCoreCount(int value) {
    SetCoreCount(value);
    return *this;
  }
  ///@}
  ...
  inline AwsEc2LaunchTemplateDataCpuOptionsDetails& WithThreadsPerCore(int value) {
