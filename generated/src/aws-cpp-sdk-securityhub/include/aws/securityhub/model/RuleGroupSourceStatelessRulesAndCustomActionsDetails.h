...
class RuleGroupSourceStatelessRulesAndCustomActionsDetails {
 public:
  ...
  template <typename CustomActionsT = Aws::Vector<RuleGroupSourceCustomActionsDetails>>
  RuleGroupSourceStatelessRulesAndCustomActionsDetails& WithCustomActions(CustomActionsT&& value) {
    SetCustomActions(std::forward<CustomActionsT>(value));
    return *this;
  }
  template <typename CustomActionsT = RuleGroupSourceCustomActionsDetails>
  RuleGroupSourceStatelessRulesAndCustomActionsDetails& AddCustomActions(CustomActionsT&& value) {
    m_customActionsHasBeenSet = true;
  ...
  void SetStatelessRules(StatelessRulesT&& value) {
    ...
    m_statelessRules = std::forward<StatelessRulesT>(value);
  }
  template <typename StatelessRulesT = Aws::Vector<RuleGroupSourceStatelessRulesDetails>>
  RuleGroupSourceStatelessRulesAndCustomActionsDetails& WithStatelessRules(StatelessRulesT&& value) {
    SetStatelessRules(std::forward<StatelessRulesT>(value));
    return *this;
  }
  template <typename StatelessRulesT = RuleGroupSourceStatelessRulesDetails>
  RuleGroupSourceStatelessRulesAndCustomActionsDetails& AddStatelessRules(StatelessRulesT&& value) {
    m_statelessRulesHasBeenSet = true;
    m_statelessRules.emplace_back(std::forward<StatelessRulesT>(value));
    return *this;
  }
  ///@}
 private:
