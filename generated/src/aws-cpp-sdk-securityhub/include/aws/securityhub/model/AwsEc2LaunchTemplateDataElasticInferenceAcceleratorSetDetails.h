...
class AwsEc2LaunchTemplateDataElasticInferenceAcceleratorSetDetails {
 public:
  ...
  inline AwsEc2LaunchTemplateDataElasticInferenceAcceleratorSetDetails& WithCount(int value) {
    SetCount(value);
    return *this;
  }
  ///@}
  ...
  template <typename TypeT = Aws::String>
  AwsEc2LaunchTemplateDataElasticInferenceAcceleratorSetDetails& WithType(TypeT&& value) {
