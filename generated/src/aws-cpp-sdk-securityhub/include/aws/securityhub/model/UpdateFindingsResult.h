...
namespace Model
{
  ...
  {
  public:
    AWS_SECURITYHUB_API UpdateFindingsResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateFindingsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
