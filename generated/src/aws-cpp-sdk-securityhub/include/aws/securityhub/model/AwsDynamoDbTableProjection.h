...
class AwsDynamoDbTableProjection {
 public:
  ...
  void SetProjectionType(ProjectionTypeT&& value) {
    ...
    m_projectionType = std::forward<ProjectionTypeT>(value);
  }
  template <typename ProjectionTypeT = Aws::String>
  AwsDynamoDbTableProjection& WithProjectionType(ProjectionTypeT&& value) {
    SetProjectionType(std::forward<ProjectionTypeT>(value));
    return *this;
  }
  ///@}
 private:
