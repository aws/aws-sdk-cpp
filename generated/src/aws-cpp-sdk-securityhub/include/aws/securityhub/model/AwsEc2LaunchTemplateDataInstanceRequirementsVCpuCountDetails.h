...
class AwsEc2LaunchTemplateDataInstanceRequirementsVCpuCountDetails {
 public:
  ...
  inline AwsEc2LaunchTemplateDataInstanceRequirementsVCpuCountDetails& WithMax(int value) {
    SetMax(value);
    return *this;
  }
  ///@}
  ...
  inline AwsEc2LaunchTemplateDataInstanceRequirementsVCpuCountDetails& WithMin(int value) {
    SetMin(value);
    return *this;
  }
  ///@}
