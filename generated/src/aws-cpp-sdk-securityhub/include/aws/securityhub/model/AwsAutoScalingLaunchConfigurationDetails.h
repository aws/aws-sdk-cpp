...
class AwsAutoScalingLaunchConfigurationDetails {
 public:
  ...
  inline AwsAutoScalingLaunchConfigurationDetails& WithAssociatePublicIpAddress(bool value) {
   ...
   */
  inline const Aws::Vector<AwsAutoScalingLaunchConfigurationBlockDeviceMappingsDetails>& GetBlockDeviceMappings() const {
    return m_blockDeviceMappings;
  }
  ...
  inline AwsAutoScalingLaunchConfigurationDetails& WithEbsOptimized(bool value) {
