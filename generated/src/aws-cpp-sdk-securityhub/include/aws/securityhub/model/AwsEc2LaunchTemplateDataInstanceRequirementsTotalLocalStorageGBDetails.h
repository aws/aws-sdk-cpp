...
class AwsEc2LaunchTemplateDataInstanceRequirementsTotalLocalStorageGBDetails {
 public:
  ...
  AWS_SECURITYHUB_API AwsEc2LaunchTemplateDataInstanceRequirementsTotalLocalStorageGBDetails& operator=(
  ...
  inline AwsEc2LaunchTemplateDataInstanceRequirementsTotalLocalStorageGBDetails& WithMax(double value) {
    SetMax(value);
    return *this;
  }
  ///@}
  ...
  inline AwsEc2LaunchTemplateDataInstanceRequirementsTotalLocalStorageGBDetails& WithMin(double value) {
    SetMin(value);
    return *this;
  }
  ///@}
