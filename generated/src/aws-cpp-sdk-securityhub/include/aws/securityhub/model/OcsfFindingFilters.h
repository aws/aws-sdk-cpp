...
class OcsfFindingFilters {
 public:
  ...
  template <typename CompositeFiltersT = Aws::Vector<CompositeFilter>>
  OcsfFindingFilters& WithCompositeFilters(CompositeFiltersT&& value) {
    SetCompositeFilters(std::forward<CompositeFiltersT>(value));
    return *this;
  }
  template <typename CompositeFiltersT = CompositeFilter>
  OcsfFindingFilters& AddCompositeFilters(CompositeFiltersT&& value) {
    m_compositeFiltersHasBeenSet = true;
  ...
  inline OcsfFindingFilters& WithCompositeOperator(AllowedOperators value) {
