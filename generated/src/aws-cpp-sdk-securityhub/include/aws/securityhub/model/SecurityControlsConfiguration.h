...
class SecurityControlsConfiguration {
 public:
  ...
  void SetEnabledSecurityControlIdentifiers(EnabledSecurityControlIdentifiersT&& value) {
    ...
    m_enabledSecurityControlIdentifiers = std::forward<EnabledSecurityControlIdentifiersT>(value);
  }
  template <typename EnabledSecurityControlIdentifiersT = Aws::Vector<Aws::String>>
  SecurityControlsConfiguration& WithEnabledSecurityControlIdentifiers(EnabledSecurityControlIdentifiersT&& value) {
    SetEnabledSecurityControlIdentifiers(std::forward<EnabledSecurityControlIdentifiersT>(value));
    return *this;
  }
  ...
  SecurityControlsConfiguration& AddEnabledSecurityControlIdentifiers(EnabledSecurityControlIdentifiersT&& value) {
    m_enabledSecurityControlIdentifiersHasBeenSet = true;
    m_enabledSecurityControlIdentifiers.emplace_back(std::forward<EnabledSecurityControlIdentifiersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDisabledSecurityControlIdentifiers(DisabledSecurityControlIdentifiersT&& value) {
    ...
    m_disabledSecurityControlIdentifiers = std::forward<DisabledSecurityControlIdentifiersT>(value);
  }
  template <typename DisabledSecurityControlIdentifiersT = Aws::Vector<Aws::String>>
  SecurityControlsConfiguration& WithDisabledSecurityControlIdentifiers(DisabledSecurityControlIdentifiersT&& value) {
    SetDisabledSecurityControlIdentifiers(std::forward<DisabledSecurityControlIdentifiersT>(value));
    return *this;
  }
  ...
  SecurityControlsConfiguration& AddDisabledSecurityControlIdentifiers(DisabledSecurityControlIdentifiersT&& value) {
    m_disabledSecurityControlIdentifiersHasBeenSet = true;
    m_disabledSecurityControlIdentifiers.emplace_back(std::forward<DisabledSecurityControlIdentifiersT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::Vector<SecurityControlCustomParameter>& GetSecurityControlCustomParameters() const {
    return m_securityControlCustomParameters;
  }
  ...
  void SetSecurityControlCustomParameters(SecurityControlCustomParametersT&& value) {
    ...
    m_securityControlCustomParameters = std::forward<SecurityControlCustomParametersT>(value);
  }
  template <typename SecurityControlCustomParametersT = Aws::Vector<SecurityControlCustomParameter>>
  SecurityControlsConfiguration& WithSecurityControlCustomParameters(SecurityControlCustomParametersT&& value) {
    SetSecurityControlCustomParameters(std::forward<SecurityControlCustomParametersT>(value));
    return *this;
  }
  ...
  SecurityControlsConfiguration& AddSecurityControlCustomParameters(SecurityControlCustomParametersT&& value) {
    m_securityControlCustomParametersHasBeenSet = true;
    m_securityControlCustomParameters.emplace_back(std::forward<SecurityControlCustomParametersT>(value));
    return *this;
  }
  ///@}
 private:
