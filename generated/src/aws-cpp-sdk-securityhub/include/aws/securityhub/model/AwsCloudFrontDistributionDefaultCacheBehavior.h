...
class AwsCloudFrontDistributionDefaultCacheBehavior {
 public:
  AWS_SECURITYHUB_API AwsCloudFrontDistributionDefaultCacheBehavior() = default;
  ...
  void SetViewerProtocolPolicy(ViewerProtocolPolicyT&& value) {
    m_viewerProtocolPolicyHasBeenSet = true;
    m_viewerProtocolPolicy = std::forward<ViewerProtocolPolicyT>(value);
  }
  template <typename ViewerProtocolPolicyT = Aws::String>
  AwsCloudFrontDistributionDefaultCacheBehavior& WithViewerProtocolPolicy(ViewerProtocolPolicyT&& value) {
    SetViewerProtocolPolicy(std::forward<ViewerProtocolPolicyT>(value));
    return *this;
  }
  ///@}
 private:
