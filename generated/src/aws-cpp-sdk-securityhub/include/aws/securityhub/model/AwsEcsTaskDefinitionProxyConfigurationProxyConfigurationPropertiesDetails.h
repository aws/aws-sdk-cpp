...
class AwsEcsTaskDefinitionProxyConfigurationProxyConfigurationPropertiesDetails {
 public:
  ...
  AWS_SECURITYHUB_API AwsEcsTaskDefinitionProxyConfigurationProxyConfigurationPropertiesDetails& operator=(
  ...
  template <typename NameT = Aws::String>
  AwsEcsTaskDefinitionProxyConfigurationProxyConfigurationPropertiesDetails& WithName(NameT&& value) {
  ...
  template <typename ValueT = Aws::String>
  AwsEcsTaskDefinitionProxyConfigurationProxyConfigurationPropertiesDetails& WithValue(ValueT&& value) {
