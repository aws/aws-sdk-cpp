...
class BatchUpdateAutomationRulesResult {
 public:
  ...
  template <typename ProcessedAutomationRulesT = Aws::Vector<Aws::String>>
  BatchUpdateAutomationRulesResult& WithProcessedAutomationRules(ProcessedAutomationRulesT&& value) {
  ...
  BatchUpdateAutomationRulesResult& AddProcessedAutomationRules(ProcessedAutomationRulesT&& value) {
    m_processedAutomationRulesHasBeenSet = true;
  ...
  template <typename UnprocessedAutomationRulesT = Aws::Vector<UnprocessedAutomationRule>>
  BatchUpdateAutomationRulesResult& WithUnprocessedAutomationRules(UnprocessedAutomationRulesT&& value) {
  ...
  BatchUpdateAutomationRulesResult& AddUnprocessedAutomationRules(UnprocessedAutomationRulesT&& value) {
    m_unprocessedAutomationRulesHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  BatchUpdateAutomationRulesResult& WithRequestId(RequestIdT&& value) {
