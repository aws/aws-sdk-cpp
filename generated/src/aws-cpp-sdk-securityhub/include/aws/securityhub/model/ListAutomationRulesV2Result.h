...
class ListAutomationRulesV2Result {
 public:
  ...
  template <typename RulesT = Aws::Vector<AutomationRulesMetadataV2>>
  ListAutomationRulesV2Result& WithRules(RulesT&& value) {
    SetRules(std::forward<RulesT>(value));
    return *this;
  }
  template <typename RulesT = AutomationRulesMetadataV2>
  ListAutomationRulesV2Result& AddRules(RulesT&& value) {
    m_rulesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListAutomationRulesV2Result& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAutomationRulesV2Result& WithRequestId(RequestIdT&& value) {
