...
class AwsDynamoDbTableProvisionedThroughput {
 public:
  ...
  inline void SetNumberOfDecreasesToday(int value) {
    m_numberOfDecreasesTodayHasBeenSet = true;
    m_numberOfDecreasesToday = value;
  }
  inline AwsDynamoDbTableProvisionedThroughput& WithNumberOfDecreasesToday(int value) {
  ...
  inline AwsDynamoDbTableProvisionedThroughput& WithReadCapacityUnits(int value) {
  ...
  inline void SetWriteCapacityUnits(int value) {
    m_writeCapacityUnitsHasBeenSet = true;
    m_writeCapacityUnits = value;
  }
  inline AwsDynamoDbTableProvisionedThroughput& WithWriteCapacityUnits(int value) {
