...
class AwsEc2VpcEndpointServiceDetails {
 public:
  ...
  inline AwsEc2VpcEndpointServiceDetails& WithAcceptanceRequired(bool value) {
  ...
  inline AwsEc2VpcEndpointServiceDetails& WithManagesVpcEndpoints(bool value) {
  ...
  void SetServiceState(ServiceStateT&& value) {
    ...
    m_serviceState = std::forward<ServiceStateT>(value);
  }
  template <typename ServiceStateT = Aws::String>
  AwsEc2VpcEndpointServiceDetails& WithServiceState(ServiceStateT&& value) {
    SetServiceState(std::forward<ServiceStateT>(value));
    return *this;
  }
  ///@}
