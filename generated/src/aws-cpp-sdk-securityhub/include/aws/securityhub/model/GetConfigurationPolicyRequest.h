...
namespace Model
{
  ...
  {
  public:
    AWS_SECURITYHUB_API GetConfigurationPolicyRequest() = default;
    ...
    template<typename IdentifierT = Aws::String>
    GetConfigurationPolicyRequest& WithIdentifier(IdentifierT&& value) { SetIdentifier(std::forward<IdentifierT>(value)); return *this;}
    ///@}
  private:
