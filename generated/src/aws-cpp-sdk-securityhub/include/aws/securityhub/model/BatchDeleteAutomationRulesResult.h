...
class BatchDeleteAutomationRulesResult {
 public:
  ...
  void SetProcessedAutomationRules(ProcessedAutomationRulesT&& value) {
    m_processedAutomationRulesHasBeenSet = true;
    m_processedAutomationRules = std::forward<ProcessedAutomationRulesT>(value);
  }
  template <typename ProcessedAutomationRulesT = Aws::Vector<Aws::String>>
  BatchDeleteAutomationRulesResult& WithProcessedAutomationRules(ProcessedAutomationRulesT&& value) {
    SetProcessedAutomationRules(std::forward<ProcessedAutomationRulesT>(value));
    return *this;
  }
  template <typename ProcessedAutomationRulesT = Aws::String>
  BatchDeleteAutomationRulesResult& AddProcessedAutomationRules(ProcessedAutomationRulesT&& value) {
    m_processedAutomationRulesHasBeenSet = true;
    m_processedAutomationRules.emplace_back(std::forward<ProcessedAutomationRulesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUnprocessedAutomationRules(UnprocessedAutomationRulesT&& value) {
    m_unprocessedAutomationRulesHasBeenSet = true;
    m_unprocessedAutomationRules = std::forward<UnprocessedAutomationRulesT>(value);
  }
  template <typename UnprocessedAutomationRulesT = Aws::Vector<UnprocessedAutomationRule>>
  BatchDeleteAutomationRulesResult& WithUnprocessedAutomationRules(UnprocessedAutomationRulesT&& value) {
    SetUnprocessedAutomationRules(std::forward<UnprocessedAutomationRulesT>(value));
    return *this;
  }
  template <typename UnprocessedAutomationRulesT = UnprocessedAutomationRule>
  BatchDeleteAutomationRulesResult& AddUnprocessedAutomationRules(UnprocessedAutomationRulesT&& value) {
    m_unprocessedAutomationRulesHasBeenSet = true;
    m_unprocessedAutomationRules.emplace_back(std::forward<UnprocessedAutomationRulesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  BatchDeleteAutomationRulesResult& WithRequestId(RequestIdT&& value) {
