 ...
 * you must have GuardDuty enabled. For more information, see <a
...
class NetworkEndpoint {
 public:
  ...
  inline NetworkEndpoint& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  void SetAutonomousSystem(AutonomousSystemT&& value) {
    ...
    m_autonomousSystem = std::forward<AutonomousSystemT>(value);
  }
  template <typename AutonomousSystemT = NetworkAutonomousSystem>
  NetworkEndpoint& WithAutonomousSystem(AutonomousSystemT&& value) {
    SetAutonomousSystem(std::forward<AutonomousSystemT>(value));
    return *this;
  }
  ///@}
