...
class BatchGetAutomationRulesResult {
 public:
  ...
  template <typename RulesT = Aws::Vector<AutomationRulesConfig>>
  BatchGetAutomationRulesResult& WithRules(RulesT&& value) {
    SetRules(std::forward<RulesT>(value));
    return *this;
  }
  template <typename RulesT = AutomationRulesConfig>
  BatchGetAutomationRulesResult& AddRules(RulesT&& value) {
    m_rulesHasBeenSet = true;
  ...
  template <typename UnprocessedAutomationRulesT = Aws::Vector<UnprocessedAutomationRule>>
  BatchGetAutomationRulesResult& WithUnprocessedAutomationRules(UnprocessedAutomationRulesT&& value) {
  ...
  BatchGetAutomationRulesResult& AddUnprocessedAutomationRules(UnprocessedAutomationRulesT&& value) {
    m_unprocessedAutomationRulesHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  BatchGetAutomationRulesResult& WithRequestId(RequestIdT&& value) {
