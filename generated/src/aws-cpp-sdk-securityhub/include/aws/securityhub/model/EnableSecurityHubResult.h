...
namespace Model
{
  ...
  {
  public:
    AWS_SECURITYHUB_API EnableSecurityHubResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    EnableSecurityHubResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
