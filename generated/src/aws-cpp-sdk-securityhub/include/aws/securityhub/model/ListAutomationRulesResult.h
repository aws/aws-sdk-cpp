...
class ListAutomationRulesResult {
 public:
  ...
  void SetAutomationRulesMetadata(AutomationRulesMetadataT&& value) {
    m_automationRulesMetadataHasBeenSet = true;
    m_automationRulesMetadata = std::forward<AutomationRulesMetadataT>(value);
  }
  template <typename AutomationRulesMetadataT = Aws::Vector<AutomationRulesMetadata>>
  ListAutomationRulesResult& WithAutomationRulesMetadata(AutomationRulesMetadataT&& value) {
    SetAutomationRulesMetadata(std::forward<AutomationRulesMetadataT>(value));
    return *this;
  }
  template <typename AutomationRulesMetadataT = AutomationRulesMetadata>
  ListAutomationRulesResult& AddAutomationRulesMetadata(AutomationRulesMetadataT&& value) {
    m_automationRulesMetadataHasBeenSet = true;
    m_automationRulesMetadata.emplace_back(std::forward<AutomationRulesMetadataT>(value));
    return *this;
  }
  ///@}
