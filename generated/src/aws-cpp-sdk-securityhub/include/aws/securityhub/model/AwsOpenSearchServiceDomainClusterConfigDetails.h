...
class AwsOpenSearchServiceDomainClusterConfigDetails {
 public:
  ...
  inline AwsOpenSearchServiceDomainClusterConfigDetails& WithInstanceCount(int value) {
  ...
  inline void SetWarmEnabled(bool value) {
    m_warmEnabledHasBeenSet = true;
    m_warmEnabled = value;
  }
  inline AwsOpenSearchServiceDomainClusterConfigDetails& WithWarmEnabled(bool value) {
    SetWarmEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline void SetWarmCount(int value) {
    m_warmCountHasBeenSet = true;
    m_warmCount = value;
  }
  inline AwsOpenSearchServiceDomainClusterConfigDetails& WithWarmCount(int value) {
    SetWarmCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDedicatedMasterEnabled(bool value) {
    m_dedicatedMasterEnabledHasBeenSet = true;
    m_dedicatedMasterEnabled = value;
  }
  inline AwsOpenSearchServiceDomainClusterConfigDetails& WithDedicatedMasterEnabled(bool value) {
    SetDedicatedMasterEnabled(value);
    return *this;
  }
  ///@}
   ...
   */
  inline const AwsOpenSearchServiceDomainClusterConfigZoneAwarenessConfigDetails& GetZoneAwarenessConfig() const {
    return m_zoneAwarenessConfig;
  }
  ...
  void SetZoneAwarenessConfig(ZoneAwarenessConfigT&& value) {
    ...
    m_zoneAwarenessConfig = std::forward<ZoneAwarenessConfigT>(value);
  }
  template <typename ZoneAwarenessConfigT = AwsOpenSearchServiceDomainClusterConfigZoneAwarenessConfigDetails>
  AwsOpenSearchServiceDomainClusterConfigDetails& WithZoneAwarenessConfig(ZoneAwarenessConfigT&& value) {
    SetZoneAwarenessConfig(std::forward<ZoneAwarenessConfigT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetDedicatedMasterCount(int value) {
    m_dedicatedMasterCountHasBeenSet = true;
    m_dedicatedMasterCount = value;
  }
  inline AwsOpenSearchServiceDomainClusterConfigDetails& WithDedicatedMasterCount(int value) {
    SetDedicatedMasterCount(value);
    return *this;
  }
  ///@}
  ...
  template <typename InstanceTypeT = Aws::String>
  AwsOpenSearchServiceDomainClusterConfigDetails& WithInstanceType(InstanceTypeT&& value) {
  ...
  void SetWarmType(WarmTypeT&& value) {
    m_warmTypeHasBeenSet = true;
    m_warmType = std::forward<WarmTypeT>(value);
  }
  template <typename WarmTypeT = Aws::String>
  AwsOpenSearchServiceDomainClusterConfigDetails& WithWarmType(WarmTypeT&& value) {
    SetWarmType(std::forward<WarmTypeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetZoneAwarenessEnabled(bool value) {
    m_zoneAwarenessEnabledHasBeenSet = true;
    m_zoneAwarenessEnabled = value;
  }
  inline AwsOpenSearchServiceDomainClusterConfigDetails& WithZoneAwarenessEnabled(bool value) {
    SetZoneAwarenessEnabled(value);
    return *this;
  }
  ///@}
  ...
  void SetDedicatedMasterType(DedicatedMasterTypeT&& value) {
    m_dedicatedMasterTypeHasBeenSet = true;
    m_dedicatedMasterType = std::forward<DedicatedMasterTypeT>(value);
  }
  template <typename DedicatedMasterTypeT = Aws::String>
  AwsOpenSearchServiceDomainClusterConfigDetails& WithDedicatedMasterType(DedicatedMasterTypeT&& value) {
    SetDedicatedMasterType(std::forward<DedicatedMasterTypeT>(value));
    return *this;
  }
  ///@}
 private:
