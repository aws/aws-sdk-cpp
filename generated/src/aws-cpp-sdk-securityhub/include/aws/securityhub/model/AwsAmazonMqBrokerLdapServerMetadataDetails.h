...
class AwsAmazonMqBrokerLdapServerMetadataDetails {
 public:
  ...
  template <typename HostsT = Aws::Vector<Aws::String>>
  AwsAmazonMqBrokerLdapServerMetadataDetails& WithHosts(HostsT&& value) {
    SetHosts(std::forward<HostsT>(value));
    return *this;
  }
  template <typename HostsT = Aws::String>
  AwsAmazonMqBrokerLdapServerMetadataDetails& AddHosts(HostsT&& value) {
    m_hostsHasBeenSet = true;
  ...
  template <typename RoleBaseT = Aws::String>
  AwsAmazonMqBrokerLdapServerMetadataDetails& WithRoleBase(RoleBaseT&& value) {
  ...
  template <typename RoleNameT = Aws::String>
  AwsAmazonMqBrokerLdapServerMetadataDetails& WithRoleName(RoleNameT&& value) {
  ...
  template <typename RoleSearchMatchingT = Aws::String>
  AwsAmazonMqBrokerLdapServerMetadataDetails& WithRoleSearchMatching(RoleSearchMatchingT&& value) {
  ...
  inline AwsAmazonMqBrokerLdapServerMetadataDetails& WithRoleSearchSubtree(bool value) {
  ...
  template <typename ServiceAccountUsernameT = Aws::String>
  AwsAmazonMqBrokerLdapServerMetadataDetails& WithServiceAccountUsername(ServiceAccountUsernameT&& value) {
  ...
  template <typename UserBaseT = Aws::String>
  AwsAmazonMqBrokerLdapServerMetadataDetails& WithUserBase(UserBaseT&& value) {
  ...
  template <typename UserRoleNameT = Aws::String>
  AwsAmazonMqBrokerLdapServerMetadataDetails& WithUserRoleName(UserRoleNameT&& value) {
  ...
  template <typename UserSearchMatchingT = Aws::String>
  AwsAmazonMqBrokerLdapServerMetadataDetails& WithUserSearchMatching(UserSearchMatchingT&& value) {
  ...
  inline AwsAmazonMqBrokerLdapServerMetadataDetails& WithUserSearchSubtree(bool value) {
