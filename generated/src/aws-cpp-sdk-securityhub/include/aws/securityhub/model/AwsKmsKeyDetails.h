...
class AwsKmsKeyDetails {
 public:
  ...
  inline void SetCreationDate(double value) {
    m_creationDateHasBeenSet = true;
    m_creationDate = value;
  }
  inline AwsKmsKeyDetails& WithCreationDate(double value) {
  ...
  void SetKeyManager(KeyManagerT&& value) {
    ...
    m_keyManager = std::forward<KeyManagerT>(value);
  }
  template <typename KeyManagerT = Aws::String>
  AwsKmsKeyDetails& WithKeyManager(KeyManagerT&& value) {
    SetKeyManager(std::forward<KeyManagerT>(value));
    return *this;
  }
  ///@}
  ...
  void SetKeyState(KeyStateT&& value) {
    ...
    m_keyState = std::forward<KeyStateT>(value);
  }
  template <typename KeyStateT = Aws::String>
  AwsKmsKeyDetails& WithKeyState(KeyStateT&& value) {
    SetKeyState(std::forward<KeyStateT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetKeyRotationStatus(bool value) {
    m_keyRotationStatusHasBeenSet = true;
    m_keyRotationStatus = value;
  }
  inline AwsKmsKeyDetails& WithKeyRotationStatus(bool value) {
    SetKeyRotationStatus(value);
    return *this;
  }
  ///@}
 private:
