...
class AwsApiGatewayMethodSettings {
 public:
  ...
  inline AwsApiGatewayMethodSettings& WithMetricsEnabled(bool value) {
  ...
  inline AwsApiGatewayMethodSettings& WithDataTraceEnabled(bool value) {
  ...
  inline AwsApiGatewayMethodSettings& WithThrottlingBurstLimit(int value) {
  ...
  inline AwsApiGatewayMethodSettings& WithThrottlingRateLimit(double value) {
  ...
  inline AwsApiGatewayMethodSettings& WithCachingEnabled(bool value) {
  ...
  inline AwsApiGatewayMethodSettings& WithCacheTtlInSeconds(int value) {
  ...
  inline AwsApiGatewayMethodSettings& WithCacheDataEncrypted(bool value) {
  ...
  inline AwsApiGatewayMethodSettings& WithRequireAuthorizationForCacheControl(bool value) {
  ...
  void SetUnauthorizedCacheControlHeaderStrategy(UnauthorizedCacheControlHeaderStrategyT&& value) {
    ...
    m_unauthorizedCacheControlHeaderStrategy = std::forward<UnauthorizedCacheControlHeaderStrategyT>(value);
  }
  template <typename UnauthorizedCacheControlHeaderStrategyT = Aws::String>
  AwsApiGatewayMethodSettings& WithUnauthorizedCacheControlHeaderStrategy(UnauthorizedCacheControlHeaderStrategyT&& value) {
    SetUnauthorizedCacheControlHeaderStrategy(std::forward<UnauthorizedCacheControlHeaderStrategyT>(value));
    return *this;
  }
  ///@}
