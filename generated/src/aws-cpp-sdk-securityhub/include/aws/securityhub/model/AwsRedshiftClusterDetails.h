...
class AwsRedshiftClusterDetails {
 public:
  ...
  inline AwsRedshiftClusterDetails& WithAllowVersionUpgrade(bool value) {
  ...
  inline AwsRedshiftClusterDetails& WithAutomatedSnapshotRetentionPeriod(int value) {
   ...
   */
  inline const Aws::Vector<AwsRedshiftClusterDeferredMaintenanceWindow>& GetDeferredMaintenanceWindows() const {
    return m_deferredMaintenanceWindows;
  }
  ...
  inline AwsRedshiftClusterDetails& WithEncrypted(bool value) {
    SetEncrypted(value);
    return *this;
  }
  ///@}
  ...
  inline AwsRedshiftClusterDetails& WithEnhancedVpcRouting(bool value) {
  ...
  inline AwsRedshiftClusterDetails& WithManualSnapshotRetentionPeriod(int value) {
  ...
  inline AwsRedshiftClusterDetails& WithNumberOfNodes(int value) {
  ...
  inline AwsRedshiftClusterDetails& WithPubliclyAccessible(bool value) {
  ...
  void SetSnapshotScheduleState(SnapshotScheduleStateT&& value) {
    ...
    m_snapshotScheduleState = std::forward<SnapshotScheduleStateT>(value);
  }
  template <typename SnapshotScheduleStateT = Aws::String>
  AwsRedshiftClusterDetails& WithSnapshotScheduleState(SnapshotScheduleStateT&& value) {
    SetSnapshotScheduleState(std::forward<SnapshotScheduleStateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLoggingStatus(LoggingStatusT&& value) {
    ...
    m_loggingStatus = std::forward<LoggingStatusT>(value);
  }
  template <typename LoggingStatusT = AwsRedshiftClusterLoggingStatus>
  AwsRedshiftClusterDetails& WithLoggingStatus(LoggingStatusT&& value) {
    SetLoggingStatus(std::forward<LoggingStatusT>(value));
    return *this;
  }
  ///@}
 private:
