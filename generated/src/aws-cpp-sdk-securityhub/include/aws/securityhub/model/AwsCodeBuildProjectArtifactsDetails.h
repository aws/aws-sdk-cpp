...
class AwsCodeBuildProjectArtifactsDetails {
 public:
  ...
  void SetArtifactIdentifier(ArtifactIdentifierT&& value) {
    ...
    m_artifactIdentifier = std::forward<ArtifactIdentifierT>(value);
  }
  template <typename ArtifactIdentifierT = Aws::String>
  AwsCodeBuildProjectArtifactsDetails& WithArtifactIdentifier(ArtifactIdentifierT&& value) {
    SetArtifactIdentifier(std::forward<ArtifactIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetEncryptionDisabled(bool value) {
    m_encryptionDisabledHasBeenSet = true;
    m_encryptionDisabled = value;
  }
  inline AwsCodeBuildProjectArtifactsDetails& WithEncryptionDisabled(bool value) {
    SetEncryptionDisabled(value);
    return *this;
  }
  ///@}
  ...
  void SetNamespaceType(NamespaceTypeT&& value) {
    ...
    m_namespaceType = std::forward<NamespaceTypeT>(value);
  }
  template <typename NamespaceTypeT = Aws::String>
  AwsCodeBuildProjectArtifactsDetails& WithNamespaceType(NamespaceTypeT&& value) {
    SetNamespaceType(std::forward<NamespaceTypeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetOverrideArtifactName(bool value) {
    m_overrideArtifactNameHasBeenSet = true;
    m_overrideArtifactName = value;
  }
  inline AwsCodeBuildProjectArtifactsDetails& WithOverrideArtifactName(bool value) {
    SetOverrideArtifactName(value);
    return *this;
  }
  ///@}
  ...
  void SetPackaging(PackagingT&& value) {
    ...
    m_packaging = std::forward<PackagingT>(value);
  }
  template <typename PackagingT = Aws::String>
  AwsCodeBuildProjectArtifactsDetails& WithPackaging(PackagingT&& value) {
    SetPackaging(std::forward<PackagingT>(value));
    return *this;
  }
  ///@}
