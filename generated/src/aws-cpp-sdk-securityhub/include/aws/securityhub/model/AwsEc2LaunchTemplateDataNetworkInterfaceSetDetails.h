...
class AwsEc2LaunchTemplateDataNetworkInterfaceSetDetails {
 public:
  ...
  inline AwsEc2LaunchTemplateDataNetworkInterfaceSetDetails& WithAssociateCarrierIpAddress(bool value) {
  ...
  inline AwsEc2LaunchTemplateDataNetworkInterfaceSetDetails& WithAssociatePublicIpAddress(bool value) {
  ...
  inline AwsEc2LaunchTemplateDataNetworkInterfaceSetDetails& WithDeleteOnTermination(bool value) {
  ...
  template <typename DescriptionT = Aws::String>
  AwsEc2LaunchTemplateDataNetworkInterfaceSetDetails& WithDescription(DescriptionT&& value) {
  ...
  inline AwsEc2LaunchTemplateDataNetworkInterfaceSetDetails& WithDeviceIndex(int value) {
  ...
  template <typename GroupsT = Aws::Vector<Aws::String>>
  AwsEc2LaunchTemplateDataNetworkInterfaceSetDetails& WithGroups(GroupsT&& value) {
    SetGroups(std::forward<GroupsT>(value));
    return *this;
  }
  template <typename GroupsT = Aws::String>
  AwsEc2LaunchTemplateDataNetworkInterfaceSetDetails& AddGroups(GroupsT&& value) {
    m_groupsHasBeenSet = true;
  ...
  template <typename InterfaceTypeT = Aws::String>
  AwsEc2LaunchTemplateDataNetworkInterfaceSetDetails& WithInterfaceType(InterfaceTypeT&& value) {
  ...
  inline AwsEc2LaunchTemplateDataNetworkInterfaceSetDetails& WithIpv4PrefixCount(int value) {
   ...
   */
  inline const Aws::Vector<AwsEc2LaunchTemplateDataNetworkInterfaceSetIpv4PrefixesDetails>& GetIpv4Prefixes() const {
    return m_ipv4Prefixes;
  }
  ...
  template <typename Ipv4PrefixesT = Aws::Vector<AwsEc2LaunchTemplateDataNetworkInterfaceSetIpv4PrefixesDetails>>
  AwsEc2LaunchTemplateDataNetworkInterfaceSetDetails& WithIpv4Prefixes(Ipv4PrefixesT&& value) {
  ...
  AwsEc2LaunchTemplateDataNetworkInterfaceSetDetails& AddIpv4Prefixes(Ipv4PrefixesT&& value) {
    m_ipv4PrefixesHasBeenSet = true;
  ...
  inline AwsEc2LaunchTemplateDataNetworkInterfaceSetDetails& WithIpv6AddressCount(int value) {
   ...
   */
  inline const Aws::Vector<AwsEc2LaunchTemplateDataNetworkInterfaceSetIpv6AddressesDetails>& GetIpv6Addresses() const {
  ...
  template <typename Ipv6AddressesT = Aws::Vector<AwsEc2LaunchTemplateDataNetworkInterfaceSetIpv6AddressesDetails>>
  AwsEc2LaunchTemplateDataNetworkInterfaceSetDetails& WithIpv6Addresses(Ipv6AddressesT&& value) {
  ...
  AwsEc2LaunchTemplateDataNetworkInterfaceSetDetails& AddIpv6Addresses(Ipv6AddressesT&& value) {
    m_ipv6AddressesHasBeenSet = true;
  ...
  inline AwsEc2LaunchTemplateDataNetworkInterfaceSetDetails& WithIpv6PrefixCount(int value) {
   ...
   */
  inline const Aws::Vector<AwsEc2LaunchTemplateDataNetworkInterfaceSetIpv6PrefixesDetails>& GetIpv6Prefixes() const {
  ...
  template <typename Ipv6PrefixesT = Aws::Vector<AwsEc2LaunchTemplateDataNetworkInterfaceSetIpv6PrefixesDetails>>
  AwsEc2LaunchTemplateDataNetworkInterfaceSetDetails& WithIpv6Prefixes(Ipv6PrefixesT&& value) {
  ...
  AwsEc2LaunchTemplateDataNetworkInterfaceSetDetails& AddIpv6Prefixes(Ipv6PrefixesT&& value) {
    m_ipv6PrefixesHasBeenSet = true;
  ...
  inline AwsEc2LaunchTemplateDataNetworkInterfaceSetDetails& WithNetworkCardIndex(int value) {
  ...
  template <typename NetworkInterfaceIdT = Aws::String>
  AwsEc2LaunchTemplateDataNetworkInterfaceSetDetails& WithNetworkInterfaceId(NetworkInterfaceIdT&& value) {
  ...
  template <typename PrivateIpAddressT = Aws::String>
  AwsEc2LaunchTemplateDataNetworkInterfaceSetDetails& WithPrivateIpAddress(PrivateIpAddressT&& value) {
   ...
   */
  inline const Aws::Vector<AwsEc2LaunchTemplateDataNetworkInterfaceSetPrivateIpAddressesDetails>& GetPrivateIpAddresses() const {
  ...
  template <typename PrivateIpAddressesT = Aws::Vector<AwsEc2LaunchTemplateDataNetworkInterfaceSetPrivateIpAddressesDetails>>
  AwsEc2LaunchTemplateDataNetworkInterfaceSetDetails& WithPrivateIpAddresses(PrivateIpAddressesT&& value) {
  ...
  AwsEc2LaunchTemplateDataNetworkInterfaceSetDetails& AddPrivateIpAddresses(PrivateIpAddressesT&& value) {
    m_privateIpAddressesHasBeenSet = true;
  ...
  inline AwsEc2LaunchTemplateDataNetworkInterfaceSetDetails& WithSecondaryPrivateIpAddressCount(int value) {
  ...
  template <typename SubnetIdT = Aws::String>
  AwsEc2LaunchTemplateDataNetworkInterfaceSetDetails& WithSubnetId(SubnetIdT&& value) {
