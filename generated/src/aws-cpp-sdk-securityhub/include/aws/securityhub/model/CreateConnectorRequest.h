...
/**
 */
class CreateConnectorRequest : public SecurityHubRequest {
 public:
  ...
  ///@{
  /**
   * <p>The configuration for the cloud provider to connect to. Currently supports
   * Azure.</p>
   */
  inline const CspmProviderConfiguration& GetProvider() const { return m_provider; }
  inline bool ProviderHasBeenSet() const { return m_providerHasBeenSet; }
  template <typename ProviderT = CspmProviderConfiguration>
 ...
 private:
  ...
  CspmProviderConfiguration m_provider;
