...
class AwsApiGatewayV2RouteSettings {
 public:
  ...
  inline AwsApiGatewayV2RouteSettings& WithDetailedMetricsEnabled(bool value) {
  ...
  inline AwsApiGatewayV2RouteSettings& WithDataTraceEnabled(bool value) {
  ...
  inline AwsApiGatewayV2RouteSettings& WithThrottlingBurstLimit(int value) {
  ...
  inline AwsApiGatewayV2RouteSettings& WithThrottlingRateLimit(double value) {
