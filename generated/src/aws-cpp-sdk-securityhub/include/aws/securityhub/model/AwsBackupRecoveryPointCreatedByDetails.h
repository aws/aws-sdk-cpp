...
class AwsBackupRecoveryPointCreatedByDetails {
 public:
  ...
  template <typename BackupPlanArnT = Aws::String>
  AwsBackupRecoveryPointCreatedByDetails& WithBackupPlanArn(BackupPlanArnT&& value) {
  ...
  template <typename BackupPlanIdT = Aws::String>
  AwsBackupRecoveryPointCreatedByDetails& WithBackupPlanId(BackupPlanIdT&& value) {
  ...
  template <typename BackupPlanVersionT = Aws::String>
  AwsBackupRecoveryPointCreatedByDetails& WithBackupPlanVersion(BackupPlanVersionT&& value) {
  ...
  template <typename BackupRuleIdT = Aws::String>
  AwsBackupRecoveryPointCreatedByDetails& WithBackupRuleId(BackupRuleIdT&& value) {
