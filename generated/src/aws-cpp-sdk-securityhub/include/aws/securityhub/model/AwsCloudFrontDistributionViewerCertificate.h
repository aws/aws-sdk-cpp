...
class AwsCloudFrontDistributionViewerCertificate {
 public:
  ...
  void SetCertificateSource(CertificateSourceT&& value) {
    ...
    m_certificateSource = std::forward<CertificateSourceT>(value);
  }
  template <typename CertificateSourceT = Aws::String>
  AwsCloudFrontDistributionViewerCertificate& WithCertificateSource(CertificateSourceT&& value) {
    SetCertificateSource(std::forward<CertificateSourceT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetCloudFrontDefaultCertificate(bool value) {
    m_cloudFrontDefaultCertificateHasBeenSet = true;
    m_cloudFrontDefaultCertificate = value;
  }
  inline AwsCloudFrontDistributionViewerCertificate& WithCloudFrontDefaultCertificate(bool value) {
    SetCloudFrontDefaultCertificate(value);
    return *this;
  }
  ///@}
  ...
  void SetIamCertificateId(IamCertificateIdT&& value) {
    ...
    m_iamCertificateId = std::forward<IamCertificateIdT>(value);
  }
  template <typename IamCertificateIdT = Aws::String>
  AwsCloudFrontDistributionViewerCertificate& WithIamCertificateId(IamCertificateIdT&& value) {
    SetIamCertificateId(std::forward<IamCertificateIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMinimumProtocolVersion(MinimumProtocolVersionT&& value) {
    ...
    m_minimumProtocolVersion = std::forward<MinimumProtocolVersionT>(value);
  }
  template <typename MinimumProtocolVersionT = Aws::String>
  AwsCloudFrontDistributionViewerCertificate& WithMinimumProtocolVersion(MinimumProtocolVersionT&& value) {
    SetMinimumProtocolVersion(std::forward<MinimumProtocolVersionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSslSupportMethod(SslSupportMethodT&& value) {
    ...
    m_sslSupportMethod = std::forward<SslSupportMethodT>(value);
  }
  template <typename SslSupportMethodT = Aws::String>
  AwsCloudFrontDistributionViewerCertificate& WithSslSupportMethod(SslSupportMethodT&& value) {
    SetSslSupportMethod(std::forward<SslSupportMethodT>(value));
    return *this;
  }
  ///@}
 private:
