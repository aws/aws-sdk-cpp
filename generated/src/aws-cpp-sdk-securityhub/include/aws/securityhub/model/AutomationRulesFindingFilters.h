...
class AutomationRulesFindingFilters {
 public:
  ...
  template <typename ProductArnT = Aws::Vector<StringFilter>>
  AutomationRulesFindingFilters& WithProductArn(ProductArnT&& value) {
    SetProductArn(std::forward<ProductArnT>(value));
    return *this;
  }
  template <typename ProductArnT = StringFilter>
  AutomationRulesFindingFilters& AddProductArn(ProductArnT&& value) {
    m_productArnHasBeenSet = true;
    m_productArn.emplace_back(std::forward<ProductArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename AwsAccountIdT = Aws::Vector<StringFilter>>
  AutomationRulesFindingFilters& WithAwsAccountId(AwsAccountIdT&& value) {
    SetAwsAccountId(std::forward<AwsAccountIdT>(value));
    return *this;
  }
  template <typename AwsAccountIdT = StringFilter>
  AutomationRulesFindingFilters& AddAwsAccountId(AwsAccountIdT&& value) {
    m_awsAccountIdHasBeenSet = true;
  ...
  template <typename IdT = Aws::Vector<StringFilter>>
  AutomationRulesFindingFilters& WithId(IdT&& value) {
    SetId(std::forward<IdT>(value));
    return *this;
  }
  template <typename IdT = StringFilter>
  AutomationRulesFindingFilters& AddId(IdT&& value) {
    m_idHasBeenSet = true;
    m_id.emplace_back(std::forward<IdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename GeneratorIdT = Aws::Vector<StringFilter>>
  AutomationRulesFindingFilters& WithGeneratorId(GeneratorIdT&& value) {
    SetGeneratorId(std::forward<GeneratorIdT>(value));
    return *this;
  }
  template <typename GeneratorIdT = StringFilter>
  AutomationRulesFindingFilters& AddGeneratorId(GeneratorIdT&& value) {
    m_generatorIdHasBeenSet = true;
    m_generatorId.emplace_back(std::forward<GeneratorIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TypeT = Aws::Vector<StringFilter>>
  AutomationRulesFindingFilters& WithType(TypeT&& value) {
    SetType(std::forward<TypeT>(value));
    return *this;
  }
  template <typename TypeT = StringFilter>
  AutomationRulesFindingFilters& AddType(TypeT&& value) {
    m_typeHasBeenSet = true;
    m_type.emplace_back(std::forward<TypeT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename FirstObservedAtT = Aws::Vector<DateFilter>>
  AutomationRulesFindingFilters& WithFirstObservedAt(FirstObservedAtT&& value) {
    SetFirstObservedAt(std::forward<FirstObservedAtT>(value));
    return *this;
  }
  template <typename FirstObservedAtT = DateFilter>
  AutomationRulesFindingFilters& AddFirstObservedAt(FirstObservedAtT&& value) {
    m_firstObservedAtHasBeenSet = true;
  ...
  template <typename LastObservedAtT = Aws::Vector<DateFilter>>
  AutomationRulesFindingFilters& WithLastObservedAt(LastObservedAtT&& value) {
    SetLastObservedAt(std::forward<LastObservedAtT>(value));
    return *this;
  }
  template <typename LastObservedAtT = DateFilter>
  AutomationRulesFindingFilters& AddLastObservedAt(LastObservedAtT&& value) {
    m_lastObservedAtHasBeenSet = true;
  ...
  template <typename CreatedAtT = Aws::Vector<DateFilter>>
  AutomationRulesFindingFilters& WithCreatedAt(CreatedAtT&& value) {
    SetCreatedAt(std::forward<CreatedAtT>(value));
    return *this;
  }
  template <typename CreatedAtT = DateFilter>
  AutomationRulesFindingFilters& AddCreatedAt(CreatedAtT&& value) {
    m_createdAtHasBeenSet = true;
    m_createdAt.emplace_back(std::forward<CreatedAtT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename UpdatedAtT = Aws::Vector<DateFilter>>
  AutomationRulesFindingFilters& WithUpdatedAt(UpdatedAtT&& value) {
    SetUpdatedAt(std::forward<UpdatedAtT>(value));
    return *this;
  }
  template <typename UpdatedAtT = DateFilter>
  AutomationRulesFindingFilters& AddUpdatedAt(UpdatedAtT&& value) {
    m_updatedAtHasBeenSet = true;
  ...
  void SetConfidence(ConfidenceT&& value) {
    m_confidenceHasBeenSet = true;
    m_confidence = std::forward<ConfidenceT>(value);
  }
  template <typename ConfidenceT = Aws::Vector<NumberFilter>>
  AutomationRulesFindingFilters& WithConfidence(ConfidenceT&& value) {
    SetConfidence(std::forward<ConfidenceT>(value));
    return *this;
  }
  template <typename ConfidenceT = NumberFilter>
  AutomationRulesFindingFilters& AddConfidence(ConfidenceT&& value) {
    m_confidenceHasBeenSet = true;
    m_confidence.emplace_back(std::forward<ConfidenceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCriticality(CriticalityT&& value) {
    m_criticalityHasBeenSet = true;
    m_criticality = std::forward<CriticalityT>(value);
  }
  template <typename CriticalityT = Aws::Vector<NumberFilter>>
  AutomationRulesFindingFilters& WithCriticality(CriticalityT&& value) {
    SetCriticality(std::forward<CriticalityT>(value));
    return *this;
  }
  template <typename CriticalityT = NumberFilter>
  AutomationRulesFindingFilters& AddCriticality(CriticalityT&& value) {
    m_criticalityHasBeenSet = true;
    m_criticality.emplace_back(std::forward<CriticalityT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TitleT = Aws::Vector<StringFilter>>
  AutomationRulesFindingFilters& WithTitle(TitleT&& value) {
    SetTitle(std::forward<TitleT>(value));
    return *this;
  }
  template <typename TitleT = StringFilter>
  AutomationRulesFindingFilters& AddTitle(TitleT&& value) {
    m_titleHasBeenSet = true;
  ...
  template <typename DescriptionT = Aws::Vector<StringFilter>>
  AutomationRulesFindingFilters& WithDescription(DescriptionT&& value) {
    SetDescription(std::forward<DescriptionT>(value));
    return *this;
  }
  template <typename DescriptionT = StringFilter>
  AutomationRulesFindingFilters& AddDescription(DescriptionT&& value) {
    m_descriptionHasBeenSet = true;
    m_description.emplace_back(std::forward<DescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename SourceUrlT = Aws::Vector<StringFilter>>
  AutomationRulesFindingFilters& WithSourceUrl(SourceUrlT&& value) {
    SetSourceUrl(std::forward<SourceUrlT>(value));
    return *this;
  }
  template <typename SourceUrlT = StringFilter>
  AutomationRulesFindingFilters& AddSourceUrl(SourceUrlT&& value) {
    m_sourceUrlHasBeenSet = true;
    m_sourceUrl.emplace_back(std::forward<SourceUrlT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ProductNameT = Aws::Vector<StringFilter>>
  AutomationRulesFindingFilters& WithProductName(ProductNameT&& value) {
    SetProductName(std::forward<ProductNameT>(value));
    return *this;
  }
  template <typename ProductNameT = StringFilter>
  AutomationRulesFindingFilters& AddProductName(ProductNameT&& value) {
    m_productNameHasBeenSet = true;
    m_productName.emplace_back(std::forward<ProductNameT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename CompanyNameT = Aws::Vector<StringFilter>>
  AutomationRulesFindingFilters& WithCompanyName(CompanyNameT&& value) {
    SetCompanyName(std::forward<CompanyNameT>(value));
    return *this;
  }
  template <typename CompanyNameT = StringFilter>
  AutomationRulesFindingFilters& AddCompanyName(CompanyNameT&& value) {
    m_companyNameHasBeenSet = true;
    m_companyName.emplace_back(std::forward<CompanyNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSeverityLabel(SeverityLabelT&& value) {
    m_severityLabelHasBeenSet = true;
    m_severityLabel = std::forward<SeverityLabelT>(value);
  }
  template <typename SeverityLabelT = Aws::Vector<StringFilter>>
  AutomationRulesFindingFilters& WithSeverityLabel(SeverityLabelT&& value) {
    SetSeverityLabel(std::forward<SeverityLabelT>(value));
    return *this;
  }
  template <typename SeverityLabelT = StringFilter>
  AutomationRulesFindingFilters& AddSeverityLabel(SeverityLabelT&& value) {
    m_severityLabelHasBeenSet = true;
    m_severityLabel.emplace_back(std::forward<SeverityLabelT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResourceTypeT = Aws::Vector<StringFilter>>
  AutomationRulesFindingFilters& WithResourceType(ResourceTypeT&& value) {
    SetResourceType(std::forward<ResourceTypeT>(value));
    return *this;
  }
  template <typename ResourceTypeT = StringFilter>
  AutomationRulesFindingFilters& AddResourceType(ResourceTypeT&& value) {
    m_resourceTypeHasBeenSet = true;
  ...
  template <typename ResourceIdT = Aws::Vector<StringFilter>>
  AutomationRulesFindingFilters& WithResourceId(ResourceIdT&& value) {
    SetResourceId(std::forward<ResourceIdT>(value));
    return *this;
  }
  template <typename ResourceIdT = StringFilter>
  AutomationRulesFindingFilters& AddResourceId(ResourceIdT&& value) {
    m_resourceIdHasBeenSet = true;
  ...
  void SetResourcePartition(ResourcePartitionT&& value) {
    m_resourcePartitionHasBeenSet = true;
    m_resourcePartition = std::forward<ResourcePartitionT>(value);
  }
  template <typename ResourcePartitionT = Aws::Vector<StringFilter>>
  AutomationRulesFindingFilters& WithResourcePartition(ResourcePartitionT&& value) {
    SetResourcePartition(std::forward<ResourcePartitionT>(value));
    return *this;
  }
  template <typename ResourcePartitionT = StringFilter>
  AutomationRulesFindingFilters& AddResourcePartition(ResourcePartitionT&& value) {
    m_resourcePartitionHasBeenSet = true;
    m_resourcePartition.emplace_back(std::forward<ResourcePartitionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResourceRegionT = Aws::Vector<StringFilter>>
  AutomationRulesFindingFilters& WithResourceRegion(ResourceRegionT&& value) {
    SetResourceRegion(std::forward<ResourceRegionT>(value));
    return *this;
  }
  template <typename ResourceRegionT = StringFilter>
  AutomationRulesFindingFilters& AddResourceRegion(ResourceRegionT&& value) {
    m_resourceRegionHasBeenSet = true;
    m_resourceRegion.emplace_back(std::forward<ResourceRegionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResourceTagsT = Aws::Vector<MapFilter>>
  AutomationRulesFindingFilters& WithResourceTags(ResourceTagsT&& value) {
    SetResourceTags(std::forward<ResourceTagsT>(value));
    return *this;
  }
  template <typename ResourceTagsT = MapFilter>
  AutomationRulesFindingFilters& AddResourceTags(ResourceTagsT&& value) {
    m_resourceTagsHasBeenSet = true;
  ...
  void SetResourceDetailsOther(ResourceDetailsOtherT&& value) {
    m_resourceDetailsOtherHasBeenSet = true;
    m_resourceDetailsOther = std::forward<ResourceDetailsOtherT>(value);
  }
  template <typename ResourceDetailsOtherT = Aws::Vector<MapFilter>>
  AutomationRulesFindingFilters& WithResourceDetailsOther(ResourceDetailsOtherT&& value) {
    SetResourceDetailsOther(std::forward<ResourceDetailsOtherT>(value));
    return *this;
  }
  template <typename ResourceDetailsOtherT = MapFilter>
  AutomationRulesFindingFilters& AddResourceDetailsOther(ResourceDetailsOtherT&& value) {
    m_resourceDetailsOtherHasBeenSet = true;
    m_resourceDetailsOther.emplace_back(std::forward<ResourceDetailsOtherT>(value));
    return *this;
  }
  ///@}
  ...
  void SetComplianceStatus(ComplianceStatusT&& value) {
    m_complianceStatusHasBeenSet = true;
    m_complianceStatus = std::forward<ComplianceStatusT>(value);
  }
  template <typename ComplianceStatusT = Aws::Vector<StringFilter>>
  AutomationRulesFindingFilters& WithComplianceStatus(ComplianceStatusT&& value) {
    SetComplianceStatus(std::forward<ComplianceStatusT>(value));
    return *this;
  }
  template <typename ComplianceStatusT = StringFilter>
  AutomationRulesFindingFilters& AddComplianceStatus(ComplianceStatusT&& value) {
    m_complianceStatusHasBeenSet = true;
    m_complianceStatus.emplace_back(std::forward<ComplianceStatusT>(value));
    return *this;
  }
  ///@}
  ...
  void SetComplianceSecurityControlId(ComplianceSecurityControlIdT&& value) {
    m_complianceSecurityControlIdHasBeenSet = true;
    m_complianceSecurityControlId = std::forward<ComplianceSecurityControlIdT>(value);
  }
  template <typename ComplianceSecurityControlIdT = Aws::Vector<StringFilter>>
  AutomationRulesFindingFilters& WithComplianceSecurityControlId(ComplianceSecurityControlIdT&& value) {
    SetComplianceSecurityControlId(std::forward<ComplianceSecurityControlIdT>(value));
    return *this;
  }
  template <typename ComplianceSecurityControlIdT = StringFilter>
  AutomationRulesFindingFilters& AddComplianceSecurityControlId(ComplianceSecurityControlIdT&& value) {
    m_complianceSecurityControlIdHasBeenSet = true;
    m_complianceSecurityControlId.emplace_back(std::forward<ComplianceSecurityControlIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetComplianceAssociatedStandardsId(ComplianceAssociatedStandardsIdT&& value) {
    m_complianceAssociatedStandardsIdHasBeenSet = true;
    m_complianceAssociatedStandardsId = std::forward<ComplianceAssociatedStandardsIdT>(value);
  }
  template <typename ComplianceAssociatedStandardsIdT = Aws::Vector<StringFilter>>
  AutomationRulesFindingFilters& WithComplianceAssociatedStandardsId(ComplianceAssociatedStandardsIdT&& value) {
    SetComplianceAssociatedStandardsId(std::forward<ComplianceAssociatedStandardsIdT>(value));
    return *this;
  }
  template <typename ComplianceAssociatedStandardsIdT = StringFilter>
  AutomationRulesFindingFilters& AddComplianceAssociatedStandardsId(ComplianceAssociatedStandardsIdT&& value) {
    m_complianceAssociatedStandardsIdHasBeenSet = true;
    m_complianceAssociatedStandardsId.emplace_back(std::forward<ComplianceAssociatedStandardsIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVerificationState(VerificationStateT&& value) {
    m_verificationStateHasBeenSet = true;
    m_verificationState = std::forward<VerificationStateT>(value);
  }
  template <typename VerificationStateT = Aws::Vector<StringFilter>>
  AutomationRulesFindingFilters& WithVerificationState(VerificationStateT&& value) {
    SetVerificationState(std::forward<VerificationStateT>(value));
    return *this;
  }
  template <typename VerificationStateT = StringFilter>
  AutomationRulesFindingFilters& AddVerificationState(VerificationStateT&& value) {
    m_verificationStateHasBeenSet = true;
    m_verificationState.emplace_back(std::forward<VerificationStateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetWorkflowStatus(WorkflowStatusT&& value) {
    m_workflowStatusHasBeenSet = true;
    m_workflowStatus = std::forward<WorkflowStatusT>(value);
  }
  template <typename WorkflowStatusT = Aws::Vector<StringFilter>>
  AutomationRulesFindingFilters& WithWorkflowStatus(WorkflowStatusT&& value) {
    SetWorkflowStatus(std::forward<WorkflowStatusT>(value));
    return *this;
  }
  template <typename WorkflowStatusT = StringFilter>
  AutomationRulesFindingFilters& AddWorkflowStatus(WorkflowStatusT&& value) {
    m_workflowStatusHasBeenSet = true;
    m_workflowStatus.emplace_back(std::forward<WorkflowStatusT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRecordState(RecordStateT&& value) {
    m_recordStateHasBeenSet = true;
    m_recordState = std::forward<RecordStateT>(value);
  }
  template <typename RecordStateT = Aws::Vector<StringFilter>>
  AutomationRulesFindingFilters& WithRecordState(RecordStateT&& value) {
    SetRecordState(std::forward<RecordStateT>(value));
    return *this;
  }
  template <typename RecordStateT = StringFilter>
  AutomationRulesFindingFilters& AddRecordState(RecordStateT&& value) {
    m_recordStateHasBeenSet = true;
    m_recordState.emplace_back(std::forward<RecordStateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRelatedFindingsProductArn(RelatedFindingsProductArnT&& value) {
    m_relatedFindingsProductArnHasBeenSet = true;
    m_relatedFindingsProductArn = std::forward<RelatedFindingsProductArnT>(value);
  }
  template <typename RelatedFindingsProductArnT = Aws::Vector<StringFilter>>
  AutomationRulesFindingFilters& WithRelatedFindingsProductArn(RelatedFindingsProductArnT&& value) {
    SetRelatedFindingsProductArn(std::forward<RelatedFindingsProductArnT>(value));
    return *this;
  }
  template <typename RelatedFindingsProductArnT = StringFilter>
  AutomationRulesFindingFilters& AddRelatedFindingsProductArn(RelatedFindingsProductArnT&& value) {
    m_relatedFindingsProductArnHasBeenSet = true;
    m_relatedFindingsProductArn.emplace_back(std::forward<RelatedFindingsProductArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRelatedFindingsId(RelatedFindingsIdT&& value) {
    m_relatedFindingsIdHasBeenSet = true;
    m_relatedFindingsId = std::forward<RelatedFindingsIdT>(value);
  }
  template <typename RelatedFindingsIdT = Aws::Vector<StringFilter>>
  AutomationRulesFindingFilters& WithRelatedFindingsId(RelatedFindingsIdT&& value) {
    SetRelatedFindingsId(std::forward<RelatedFindingsIdT>(value));
    return *this;
  }
  template <typename RelatedFindingsIdT = StringFilter>
  AutomationRulesFindingFilters& AddRelatedFindingsId(RelatedFindingsIdT&& value) {
    m_relatedFindingsIdHasBeenSet = true;
    m_relatedFindingsId.emplace_back(std::forward<RelatedFindingsIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNoteText(NoteTextT&& value) {
    m_noteTextHasBeenSet = true;
    m_noteText = std::forward<NoteTextT>(value);
  }
  template <typename NoteTextT = Aws::Vector<StringFilter>>
  AutomationRulesFindingFilters& WithNoteText(NoteTextT&& value) {
    SetNoteText(std::forward<NoteTextT>(value));
    return *this;
  }
  template <typename NoteTextT = StringFilter>
  AutomationRulesFindingFilters& AddNoteText(NoteTextT&& value) {
    m_noteTextHasBeenSet = true;
    m_noteText.emplace_back(std::forward<NoteTextT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNoteUpdatedAt(NoteUpdatedAtT&& value) {
    m_noteUpdatedAtHasBeenSet = true;
    m_noteUpdatedAt = std::forward<NoteUpdatedAtT>(value);
  }
  template <typename NoteUpdatedAtT = Aws::Vector<DateFilter>>
  AutomationRulesFindingFilters& WithNoteUpdatedAt(NoteUpdatedAtT&& value) {
    SetNoteUpdatedAt(std::forward<NoteUpdatedAtT>(value));
    return *this;
  }
  template <typename NoteUpdatedAtT = DateFilter>
  AutomationRulesFindingFilters& AddNoteUpdatedAt(NoteUpdatedAtT&& value) {
    m_noteUpdatedAtHasBeenSet = true;
    m_noteUpdatedAt.emplace_back(std::forward<NoteUpdatedAtT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNoteUpdatedBy(NoteUpdatedByT&& value) {
    m_noteUpdatedByHasBeenSet = true;
    m_noteUpdatedBy = std::forward<NoteUpdatedByT>(value);
  }
  template <typename NoteUpdatedByT = Aws::Vector<StringFilter>>
  AutomationRulesFindingFilters& WithNoteUpdatedBy(NoteUpdatedByT&& value) {
    SetNoteUpdatedBy(std::forward<NoteUpdatedByT>(value));
    return *this;
  }
  template <typename NoteUpdatedByT = StringFilter>
  AutomationRulesFindingFilters& AddNoteUpdatedBy(NoteUpdatedByT&& value) {
    m_noteUpdatedByHasBeenSet = true;
    m_noteUpdatedBy.emplace_back(std::forward<NoteUpdatedByT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename UserDefinedFieldsT = Aws::Vector<MapFilter>>
  AutomationRulesFindingFilters& WithUserDefinedFields(UserDefinedFieldsT&& value) {
    SetUserDefinedFields(std::forward<UserDefinedFieldsT>(value));
    return *this;
  }
  template <typename UserDefinedFieldsT = MapFilter>
  AutomationRulesFindingFilters& AddUserDefinedFields(UserDefinedFieldsT&& value) {
    m_userDefinedFieldsHasBeenSet = true;
    m_userDefinedFields.emplace_back(std::forward<UserDefinedFieldsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetResourceApplicationArn(ResourceApplicationArnT&& value) {
    m_resourceApplicationArnHasBeenSet = true;
    m_resourceApplicationArn = std::forward<ResourceApplicationArnT>(value);
  }
  template <typename ResourceApplicationArnT = Aws::Vector<StringFilter>>
  AutomationRulesFindingFilters& WithResourceApplicationArn(ResourceApplicationArnT&& value) {
    SetResourceApplicationArn(std::forward<ResourceApplicationArnT>(value));
    return *this;
  }
  template <typename ResourceApplicationArnT = StringFilter>
  AutomationRulesFindingFilters& AddResourceApplicationArn(ResourceApplicationArnT&& value) {
    m_resourceApplicationArnHasBeenSet = true;
    m_resourceApplicationArn.emplace_back(std::forward<ResourceApplicationArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetResourceApplicationName(ResourceApplicationNameT&& value) {
    m_resourceApplicationNameHasBeenSet = true;
    m_resourceApplicationName = std::forward<ResourceApplicationNameT>(value);
  }
  template <typename ResourceApplicationNameT = Aws::Vector<StringFilter>>
  AutomationRulesFindingFilters& WithResourceApplicationName(ResourceApplicationNameT&& value) {
    SetResourceApplicationName(std::forward<ResourceApplicationNameT>(value));
    return *this;
  }
  template <typename ResourceApplicationNameT = StringFilter>
  AutomationRulesFindingFilters& AddResourceApplicationName(ResourceApplicationNameT&& value) {
    m_resourceApplicationNameHasBeenSet = true;
    m_resourceApplicationName.emplace_back(std::forward<ResourceApplicationNameT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename AwsAccountNameT = Aws::Vector<StringFilter>>
  AutomationRulesFindingFilters& WithAwsAccountName(AwsAccountNameT&& value) {
    SetAwsAccountName(std::forward<AwsAccountNameT>(value));
    return *this;
  }
  template <typename AwsAccountNameT = StringFilter>
  AutomationRulesFindingFilters& AddAwsAccountName(AwsAccountNameT&& value) {
    m_awsAccountNameHasBeenSet = true;
    m_awsAccountName.emplace_back(std::forward<AwsAccountNameT>(value));
    return *this;
  }
  ///@}
 private:
