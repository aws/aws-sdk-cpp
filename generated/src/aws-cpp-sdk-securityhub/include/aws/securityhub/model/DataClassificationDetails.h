...
class DataClassificationDetails {
 public:
  ...
  void SetDetailedResultsLocation(DetailedResultsLocationT&& value) {
    ...
    m_detailedResultsLocation = std::forward<DetailedResultsLocationT>(value);
  }
  template <typename DetailedResultsLocationT = Aws::String>
  DataClassificationDetails& WithDetailedResultsLocation(DetailedResultsLocationT&& value) {
    SetDetailedResultsLocation(std::forward<DetailedResultsLocationT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResultT = ClassificationResult>
  DataClassificationDetails& WithResult(ResultT&& value) {
