...
class AwsEc2VpnConnectionOptionsTunnelOptionsDetails {
 public:
  ...
  inline AwsEc2VpnConnectionOptionsTunnelOptionsDetails& WithDpdTimeoutSeconds(int value) {
  ...
  template <typename IkeVersionsT = Aws::Vector<Aws::String>>
  AwsEc2VpnConnectionOptionsTunnelOptionsDetails& WithIkeVersions(IkeVersionsT&& value) {
    SetIkeVersions(std::forward<IkeVersionsT>(value));
    return *this;
  }
  template <typename IkeVersionsT = Aws::String>
  AwsEc2VpnConnectionOptionsTunnelOptionsDetails& AddIkeVersions(IkeVersionsT&& value) {
    m_ikeVersionsHasBeenSet = true;
  ...
  template <typename OutsideIpAddressT = Aws::String>
  AwsEc2VpnConnectionOptionsTunnelOptionsDetails& WithOutsideIpAddress(OutsideIpAddressT&& value) {
  ...
  template <typename Phase1DhGroupNumbersT = Aws::Vector<int>>
  AwsEc2VpnConnectionOptionsTunnelOptionsDetails& WithPhase1DhGroupNumbers(Phase1DhGroupNumbersT&& value) {
    SetPhase1DhGroupNumbers(std::forward<Phase1DhGroupNumbersT>(value));
    return *this;
  }
  inline AwsEc2VpnConnectionOptionsTunnelOptionsDetails& AddPhase1DhGroupNumbers(int value) {
    m_phase1DhGroupNumbersHasBeenSet = true;
    m_phase1DhGroupNumbers.push_back(value);
    return *this;
  }
  ///@}
  ...
  template <typename Phase1EncryptionAlgorithmsT = Aws::Vector<Aws::String>>
  AwsEc2VpnConnectionOptionsTunnelOptionsDetails& WithPhase1EncryptionAlgorithms(Phase1EncryptionAlgorithmsT&& value) {
  ...
  AwsEc2VpnConnectionOptionsTunnelOptionsDetails& AddPhase1EncryptionAlgorithms(Phase1EncryptionAlgorithmsT&& value) {
    m_phase1EncryptionAlgorithmsHasBeenSet = true;
  ...
  template <typename Phase1IntegrityAlgorithmsT = Aws::Vector<Aws::String>>
  AwsEc2VpnConnectionOptionsTunnelOptionsDetails& WithPhase1IntegrityAlgorithms(Phase1IntegrityAlgorithmsT&& value) {
  ...
  AwsEc2VpnConnectionOptionsTunnelOptionsDetails& AddPhase1IntegrityAlgorithms(Phase1IntegrityAlgorithmsT&& value) {
    m_phase1IntegrityAlgorithmsHasBeenSet = true;
  ...
  inline AwsEc2VpnConnectionOptionsTunnelOptionsDetails& WithPhase1LifetimeSeconds(int value) {
  ...
  template <typename Phase2DhGroupNumbersT = Aws::Vector<int>>
  AwsEc2VpnConnectionOptionsTunnelOptionsDetails& WithPhase2DhGroupNumbers(Phase2DhGroupNumbersT&& value) {
    SetPhase2DhGroupNumbers(std::forward<Phase2DhGroupNumbersT>(value));
    return *this;
  }
  inline AwsEc2VpnConnectionOptionsTunnelOptionsDetails& AddPhase2DhGroupNumbers(int value) {
    m_phase2DhGroupNumbersHasBeenSet = true;
    m_phase2DhGroupNumbers.push_back(value);
    return *this;
  }
  ///@}
  ...
  template <typename Phase2EncryptionAlgorithmsT = Aws::Vector<Aws::String>>
  AwsEc2VpnConnectionOptionsTunnelOptionsDetails& WithPhase2EncryptionAlgorithms(Phase2EncryptionAlgorithmsT&& value) {
  ...
  AwsEc2VpnConnectionOptionsTunnelOptionsDetails& AddPhase2EncryptionAlgorithms(Phase2EncryptionAlgorithmsT&& value) {
    m_phase2EncryptionAlgorithmsHasBeenSet = true;
  ...
  template <typename Phase2IntegrityAlgorithmsT = Aws::Vector<Aws::String>>
  AwsEc2VpnConnectionOptionsTunnelOptionsDetails& WithPhase2IntegrityAlgorithms(Phase2IntegrityAlgorithmsT&& value) {
  ...
  AwsEc2VpnConnectionOptionsTunnelOptionsDetails& AddPhase2IntegrityAlgorithms(Phase2IntegrityAlgorithmsT&& value) {
    m_phase2IntegrityAlgorithmsHasBeenSet = true;
  ...
  inline AwsEc2VpnConnectionOptionsTunnelOptionsDetails& WithPhase2LifetimeSeconds(int value) {
  ...
  template <typename PreSharedKeyT = Aws::String>
  AwsEc2VpnConnectionOptionsTunnelOptionsDetails& WithPreSharedKey(PreSharedKeyT&& value) {
  ...
  inline AwsEc2VpnConnectionOptionsTunnelOptionsDetails& WithRekeyFuzzPercentage(int value) {
  ...
  inline AwsEc2VpnConnectionOptionsTunnelOptionsDetails& WithRekeyMarginTimeSeconds(int value) {
  ...
  inline AwsEc2VpnConnectionOptionsTunnelOptionsDetails& WithReplayWindowSize(int value) {
  ...
  template <typename TunnelInsideCidrT = Aws::String>
  AwsEc2VpnConnectionOptionsTunnelOptionsDetails& WithTunnelInsideCidr(TunnelInsideCidrT&& value) {
