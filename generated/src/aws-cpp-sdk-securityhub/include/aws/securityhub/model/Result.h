...
class Result {
 public:
  ...
  template <typename AccountIdT = Aws::String>
  Result& WithAccountId(AccountIdT&& value) {
  ...
  void SetProcessingResult(ProcessingResultT&& value) {
    m_processingResultHasBeenSet = true;
    m_processingResult = std::forward<ProcessingResultT>(value);
  }
  template <typename ProcessingResultT = Aws::String>
  Result& WithProcessingResult(ProcessingResultT&& value) {
    SetProcessingResult(std::forward<ProcessingResultT>(value));
    return *this;
  }
  ///@}
 private:
