...
class AwsEcsTaskDefinitionContainerDefinitionsVolumesFromDetails {
 public:
  ...
  inline AwsEcsTaskDefinitionContainerDefinitionsVolumesFromDetails& WithReadOnly(bool value) {
    SetReadOnly(value);
    return *this;
  }
  ///@}
  ...
  template <typename SourceContainerT = Aws::String>
  AwsEcsTaskDefinitionContainerDefinitionsVolumesFromDetails& WithSourceContainer(SourceContainerT&& value) {
