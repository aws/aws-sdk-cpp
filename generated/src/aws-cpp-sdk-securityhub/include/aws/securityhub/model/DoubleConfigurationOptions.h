...
class DoubleConfigurationOptions {
 public:
  ...
  inline DoubleConfigurationOptions& WithDefaultValue(double value) {
  ...
  inline DoubleConfigurationOptions& WithMin(double value) {
    SetMin(value);
    return *this;
  }
  ///@}
  ...
  inline DoubleConfigurationOptions& WithMax(double value) {
    SetMax(value);
    return *this;
  }
  ///@}
