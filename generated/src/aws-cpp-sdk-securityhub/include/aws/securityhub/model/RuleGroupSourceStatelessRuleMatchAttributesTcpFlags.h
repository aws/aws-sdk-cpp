...
class RuleGroupSourceStatelessRuleMatchAttributesTcpFlags {
 public:
  ...
  template <typename FlagsT = Aws::Vector<Aws::String>>
  RuleGroupSourceStatelessRuleMatchAttributesTcpFlags& WithFlags(FlagsT&& value) {
    SetFlags(std::forward<FlagsT>(value));
    return *this;
  }
  template <typename FlagsT = Aws::String>
  RuleGroupSourceStatelessRuleMatchAttributesTcpFlags& AddFlags(FlagsT&& value) {
    m_flagsHasBeenSet = true;
  ...
  template <typename MasksT = Aws::Vector<Aws::String>>
  RuleGroupSourceStatelessRuleMatchAttributesTcpFlags& WithMasks(MasksT&& value) {
    SetMasks(std::forward<MasksT>(value));
    return *this;
  }
  template <typename MasksT = Aws::String>
  RuleGroupSourceStatelessRuleMatchAttributesTcpFlags& AddMasks(MasksT&& value) {
    m_masksHasBeenSet = true;
    m_masks.emplace_back(std::forward<MasksT>(value));
    return *this;
  }
  ///@}
 private:
