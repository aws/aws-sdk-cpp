...
namespace Model
{
  ...
  {
  public:
    AWS_SECURITYHUB_API UpdateActionTargetResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateActionTargetResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
