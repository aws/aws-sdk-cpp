...
class IntegerConfigurationOptions {
 public:
  ...
  inline IntegerConfigurationOptions& WithDefaultValue(int value) {
  ...
  inline IntegerConfigurationOptions& WithMin(int value) {
    SetMin(value);
    return *this;
  }
  ///@}
  ...
  inline IntegerConfigurationOptions& WithMax(int value) {
    SetMax(value);
    return *this;
  }
  ///@}
