...
class ListConnectorsV2Result {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListConnectorsV2Result& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ConnectorsT = Aws::Vector<ConnectorSummary>>
  ListConnectorsV2Result& WithConnectors(ConnectorsT&& value) {
    SetConnectors(std::forward<ConnectorsT>(value));
    return *this;
  }
  template <typename ConnectorsT = ConnectorSummary>
  ListConnectorsV2Result& AddConnectors(ConnectorsT&& value) {
    m_connectorsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListConnectorsV2Result& WithRequestId(RequestIdT&& value) {
