...
class AwsEcsTaskDefinitionProxyConfigurationDetails {
 public:
  ...
  template <typename ContainerNameT = Aws::String>
  AwsEcsTaskDefinitionProxyConfigurationDetails& WithContainerName(ContainerNameT&& value) {
   ...
   */
  inline const Aws::Vector<AwsEcsTaskDefinitionProxyConfigurationProxyConfigurationPropertiesDetails>& GetProxyConfigurationProperties()
      const {
    return m_proxyConfigurationProperties;
  }
  ...
  void SetProxyConfigurationProperties(ProxyConfigurationPropertiesT&& value) {
    m_proxyConfigurationPropertiesHasBeenSet = true;
    m_proxyConfigurationProperties = std::forward<ProxyConfigurationPropertiesT>(value);
  }
  template <typename ProxyConfigurationPropertiesT = Aws::Vector<AwsEcsTaskDefinitionProxyConfigurationProxyConfigurationPropertiesDetails>>
  AwsEcsTaskDefinitionProxyConfigurationDetails& WithProxyConfigurationProperties(ProxyConfigurationPropertiesT&& value) {
    SetProxyConfigurationProperties(std::forward<ProxyConfigurationPropertiesT>(value));
    return *this;
  }
  ...
  AwsEcsTaskDefinitionProxyConfigurationDetails& AddProxyConfigurationProperties(ProxyConfigurationPropertiesT&& value) {
    m_proxyConfigurationPropertiesHasBeenSet = true;
    m_proxyConfigurationProperties.emplace_back(std::forward<ProxyConfigurationPropertiesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TypeT = Aws::String>
  AwsEcsTaskDefinitionProxyConfigurationDetails& WithType(TypeT&& value) {
