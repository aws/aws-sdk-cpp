...
class AwsIamAccessKeySessionContextSessionIssuer {
 public:
  ...
  template <typename TypeT = Aws::String>
  AwsIamAccessKeySessionContextSessionIssuer& WithType(TypeT&& value) {
  ...
  template <typename PrincipalIdT = Aws::String>
  AwsIamAccessKeySessionContextSessionIssuer& WithPrincipalId(PrincipalIdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  AwsIamAccessKeySessionContextSessionIssuer& WithArn(ArnT&& value) {
  ...
  template <typename AccountIdT = Aws::String>
  AwsIamAccessKeySessionContextSessionIssuer& WithAccountId(AccountIdT&& value) {
  ...
  template <typename UserNameT = Aws::String>
  AwsIamAccessKeySessionContextSessionIssuer& WithUserName(UserNameT&& value) {
