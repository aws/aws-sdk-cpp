...
class BatchUpdateStandardsControlAssociationsRequest : public SecurityHubRequest {
 public:
   ...
   */
  inline const Aws::Vector<StandardsControlAssociationUpdate>& GetStandardsControlAssociationUpdates() const {
    return m_standardsControlAssociationUpdates;
  }
  ...
  void SetStandardsControlAssociationUpdates(StandardsControlAssociationUpdatesT&& value) {
    m_standardsControlAssociationUpdatesHasBeenSet = true;
    m_standardsControlAssociationUpdates = std::forward<StandardsControlAssociationUpdatesT>(value);
  }
  template <typename StandardsControlAssociationUpdatesT = Aws::Vector<StandardsControlAssociationUpdate>>
  BatchUpdateStandardsControlAssociationsRequest& WithStandardsControlAssociationUpdates(StandardsControlAssociationUpdatesT&& value) {
    SetStandardsControlAssociationUpdates(std::forward<StandardsControlAssociationUpdatesT>(value));
    return *this;
  }
  template <typename StandardsControlAssociationUpdatesT = StandardsControlAssociationUpdate>
  BatchUpdateStandardsControlAssociationsRequest& AddStandardsControlAssociationUpdates(StandardsControlAssociationUpdatesT&& value) {
    m_standardsControlAssociationUpdatesHasBeenSet = true;
    m_standardsControlAssociationUpdates.emplace_back(std::forward<StandardsControlAssociationUpdatesT>(value));
    return *this;
  }
  ///@}
 private:
