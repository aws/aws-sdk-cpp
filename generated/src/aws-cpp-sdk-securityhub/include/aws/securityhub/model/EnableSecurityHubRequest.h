...
class EnableSecurityHubRequest : public SecurityHubRequest {
 public:
  ...
  inline void SetEnableDefaultStandards(bool value) {
    m_enableDefaultStandardsHasBeenSet = true;
    m_enableDefaultStandards = value;
  }
  inline EnableSecurityHubRequest& WithEnableDefaultStandards(bool value) {
    SetEnableDefaultStandards(value);
    return *this;
  }
  ///@}
  ...
  inline EnableSecurityHubRequest& WithControlFindingGenerator(ControlFindingGenerator value) {
