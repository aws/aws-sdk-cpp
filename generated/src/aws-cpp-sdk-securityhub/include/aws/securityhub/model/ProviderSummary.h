...
class ProviderSummary {
 public:
  ...
  inline void SetProviderName(ConnectorProviderName value) {
    m_providerNameHasBeenSet = true;
    m_providerName = value;
  }
  inline ProviderSummary& WithProviderName(ConnectorProviderName value) {
  ...
  inline ProviderSummary& WithConnectorStatus(ConnectorStatus value) {
