...
class PatchSummary {
 public:
  ...
  inline PatchSummary& WithInstalledCount(int value) {
  ...
  inline PatchSummary& WithMissingCount(int value) {
  ...
  inline PatchSummary& WithFailedCount(int value) {
  ...
  inline PatchSummary& WithInstalledOtherCount(int value) {
  ...
  inline PatchSummary& WithInstalledRejectedCount(int value) {
  ...
  inline void SetInstalledPendingReboot(int value) {
    m_installedPendingRebootHasBeenSet = true;
    m_installedPendingReboot = value;
  }
  inline PatchSummary& WithInstalledPendingReboot(int value) {
    SetInstalledPendingReboot(value);
    return *this;
  }
  ///@}
  ...
  void SetRebootOption(RebootOptionT&& value) {
    ...
    m_rebootOption = std::forward<RebootOptionT>(value);
  }
  template <typename RebootOptionT = Aws::String>
  PatchSummary& WithRebootOption(RebootOptionT&& value) {
    SetRebootOption(std::forward<RebootOptionT>(value));
    return *this;
  }
  ///@}
