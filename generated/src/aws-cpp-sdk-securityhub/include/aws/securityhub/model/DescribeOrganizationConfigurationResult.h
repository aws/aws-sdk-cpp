...
class DescribeOrganizationConfigurationResult {
 public:
  ...
  AWS_SECURITYHUB_API DescribeOrganizationConfigurationResult& operator=(
  ...
  inline void SetMemberAccountLimitReached(bool value) {
    ...
    m_memberAccountLimitReached = value;
  }
  inline DescribeOrganizationConfigurationResult& WithMemberAccountLimitReached(bool value) {
    SetMemberAccountLimitReached(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAutoEnableStandards(AutoEnableStandards value) {
    m_autoEnableStandardsHasBeenSet = true;
    m_autoEnableStandards = value;
  }
  inline DescribeOrganizationConfigurationResult& WithAutoEnableStandards(AutoEnableStandards value) {
    SetAutoEnableStandards(value);
    return *this;
  }
  ///@}
