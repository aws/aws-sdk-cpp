...
class ListOrganizationAdminAccountsRequest : public SecurityHubRequest {
 public:
  ...
  inline ListOrganizationAdminAccountsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListOrganizationAdminAccountsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListOrganizationAdminAccountsRequest& WithFeature(SecurityHubFeature value) {
    SetFeature(value);
    return *this;
  }
  ///@}
