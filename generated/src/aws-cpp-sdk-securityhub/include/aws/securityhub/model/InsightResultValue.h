...
class InsightResultValue {
 public:
  ...
  void SetGroupByAttributeValue(GroupByAttributeValueT&& value) {
    ...
    m_groupByAttributeValue = std::forward<GroupByAttributeValueT>(value);
  }
  template <typename GroupByAttributeValueT = Aws::String>
  InsightResultValue& WithGroupByAttributeValue(GroupByAttributeValueT&& value) {
    SetGroupByAttributeValue(std::forward<GroupByAttributeValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline InsightResultValue& WithCount(int value) {
    SetCount(value);
    return *this;
  }
  ///@}
