...
class AwsEc2ClientVpnEndpointClientLoginBannerOptionsDetails {
 public:
  ...
  inline AwsEc2ClientVpnEndpointClientLoginBannerOptionsDetails& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  template <typename BannerTextT = Aws::String>
  AwsEc2ClientVpnEndpointClientLoginBannerOptionsDetails& WithBannerText(BannerTextT&& value) {
