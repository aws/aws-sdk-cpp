...
class AwsEfsAccessPointRootDirectoryDetails {
 public:
  ...
  void SetCreationInfo(CreationInfoT&& value) {
    ...
    m_creationInfo = std::forward<CreationInfoT>(value);
  }
  template <typename CreationInfoT = AwsEfsAccessPointRootDirectoryCreationInfoDetails>
  AwsEfsAccessPointRootDirectoryDetails& WithCreationInfo(CreationInfoT&& value) {
    SetCreationInfo(std::forward<CreationInfoT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename PathT = Aws::String>
  AwsEfsAccessPointRootDirectoryDetails& WithPath(PathT&& value) {
