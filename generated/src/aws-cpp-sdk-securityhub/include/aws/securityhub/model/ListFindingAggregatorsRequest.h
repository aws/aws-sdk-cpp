...
class ListFindingAggregatorsRequest : public SecurityHubRequest {
 public:
  AWS_SECURITYHUB_API ListFindingAggregatorsRequest() = default;
  ...
  template <typename NextTokenT = Aws::String>
  ListFindingAggregatorsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListFindingAggregatorsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
