...
class AwsAmazonMqBrokerMaintenanceWindowStartTimeDetails {
 public:
  ...
  template <typename DayOfWeekT = Aws::String>
  AwsAmazonMqBrokerMaintenanceWindowStartTimeDetails& WithDayOfWeek(DayOfWeekT&& value) {
  ...
  void SetTimeOfDay(TimeOfDayT&& value) {
    ...
    m_timeOfDay = std::forward<TimeOfDayT>(value);
  }
  template <typename TimeOfDayT = Aws::String>
  AwsAmazonMqBrokerMaintenanceWindowStartTimeDetails& WithTimeOfDay(TimeOfDayT&& value) {
    SetTimeOfDay(std::forward<TimeOfDayT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TimeZoneT = Aws::String>
  AwsAmazonMqBrokerMaintenanceWindowStartTimeDetails& WithTimeZone(TimeZoneT&& value) {
