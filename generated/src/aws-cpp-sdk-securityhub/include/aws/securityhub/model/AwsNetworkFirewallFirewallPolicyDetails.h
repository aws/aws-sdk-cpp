...
class AwsNetworkFirewallFirewallPolicyDetails {
 public:
  ...
  template <typename FirewallPolicyT = FirewallPolicyDetails>
  AwsNetworkFirewallFirewallPolicyDetails& WithFirewallPolicy(FirewallPolicyT&& value) {
  ...
  template <typename FirewallPolicyArnT = Aws::String>
  AwsNetworkFirewallFirewallPolicyDetails& WithFirewallPolicyArn(FirewallPolicyArnT&& value) {
  ...
  template <typename FirewallPolicyIdT = Aws::String>
  AwsNetworkFirewallFirewallPolicyDetails& WithFirewallPolicyId(FirewallPolicyIdT&& value) {
  ...
  template <typename FirewallPolicyNameT = Aws::String>
  AwsNetworkFirewallFirewallPolicyDetails& WithFirewallPolicyName(FirewallPolicyNameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  AwsNetworkFirewallFirewallPolicyDetails& WithDescription(DescriptionT&& value) {
