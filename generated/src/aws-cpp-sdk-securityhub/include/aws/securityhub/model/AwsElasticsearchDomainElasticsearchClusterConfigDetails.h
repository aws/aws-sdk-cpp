...
class AwsElasticsearchDomainElasticsearchClusterConfigDetails {
 public:
  ...
  inline AwsElasticsearchDomainElasticsearchClusterConfigDetails& WithDedicatedMasterCount(int value) {
  ...
  inline AwsElasticsearchDomainElasticsearchClusterConfigDetails& WithDedicatedMasterEnabled(bool value) {
  ...
  template <typename DedicatedMasterTypeT = Aws::String>
  AwsElasticsearchDomainElasticsearchClusterConfigDetails& WithDedicatedMasterType(DedicatedMasterTypeT&& value) {
  ...
  inline AwsElasticsearchDomainElasticsearchClusterConfigDetails& WithInstanceCount(int value) {
  ...
  template <typename InstanceTypeT = Aws::String>
  AwsElasticsearchDomainElasticsearchClusterConfigDetails& WithInstanceType(InstanceTypeT&& value) {
   ...
   */
  inline const AwsElasticsearchDomainElasticsearchClusterConfigZoneAwarenessConfigDetails& GetZoneAwarenessConfig() const {
  ...
  template <typename ZoneAwarenessConfigT = AwsElasticsearchDomainElasticsearchClusterConfigZoneAwarenessConfigDetails>
  AwsElasticsearchDomainElasticsearchClusterConfigDetails& WithZoneAwarenessConfig(ZoneAwarenessConfigT&& value) {
  ...
  inline AwsElasticsearchDomainElasticsearchClusterConfigDetails& WithZoneAwarenessEnabled(bool value) {
