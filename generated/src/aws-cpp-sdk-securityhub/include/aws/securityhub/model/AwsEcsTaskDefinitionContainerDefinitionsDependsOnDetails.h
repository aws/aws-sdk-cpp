...
class AwsEcsTaskDefinitionContainerDefinitionsDependsOnDetails {
 public:
  ...
  template <typename ConditionT = Aws::String>
  AwsEcsTaskDefinitionContainerDefinitionsDependsOnDetails& WithCondition(ConditionT&& value) {
  ...
  template <typename ContainerNameT = Aws::String>
  AwsEcsTaskDefinitionContainerDefinitionsDependsOnDetails& WithContainerName(ContainerNameT&& value) {
