...
class AwsEksClusterResourcesVpcConfigDetails {
 public:
  ...
  template <typename SecurityGroupIdsT = Aws::Vector<Aws::String>>
  AwsEksClusterResourcesVpcConfigDetails& WithSecurityGroupIds(SecurityGroupIdsT&& value) {
    SetSecurityGroupIds(std::forward<SecurityGroupIdsT>(value));
    return *this;
  }
  template <typename SecurityGroupIdsT = Aws::String>
  AwsEksClusterResourcesVpcConfigDetails& AddSecurityGroupIds(SecurityGroupIdsT&& value) {
    m_securityGroupIdsHasBeenSet = true;
  ...
  template <typename SubnetIdsT = Aws::Vector<Aws::String>>
  AwsEksClusterResourcesVpcConfigDetails& WithSubnetIds(SubnetIdsT&& value) {
    SetSubnetIds(std::forward<SubnetIdsT>(value));
    return *this;
  }
  template <typename SubnetIdsT = Aws::String>
  AwsEksClusterResourcesVpcConfigDetails& AddSubnetIds(SubnetIdsT&& value) {
    m_subnetIdsHasBeenSet = true;
  ...
  inline AwsEksClusterResourcesVpcConfigDetails& WithEndpointPublicAccess(bool value) {
