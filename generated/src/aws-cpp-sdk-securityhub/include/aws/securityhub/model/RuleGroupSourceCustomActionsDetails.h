...
class RuleGroupSourceCustomActionsDetails {
 public:
  ...
  void SetActionDefinition(ActionDefinitionT&& value) {
    m_actionDefinitionHasBeenSet = true;
    m_actionDefinition = std::forward<ActionDefinitionT>(value);
  }
  template <typename ActionDefinitionT = StatelessCustomActionDefinition>
  RuleGroupSourceCustomActionsDetails& WithActionDefinition(ActionDefinitionT&& value) {
    SetActionDefinition(std::forward<ActionDefinitionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ActionNameT = Aws::String>
  RuleGroupSourceCustomActionsDetails& WithActionName(ActionNameT&& value) {
