...
class FindingHistoryRecord {
 public:
  ...
  template <typename FindingIdentifierT = AwsSecurityFindingIdentifier>
  FindingHistoryRecord& WithFindingIdentifier(FindingIdentifierT&& value) {
  ...
  template <typename UpdateTimeT = Aws::Utils::DateTime>
  FindingHistoryRecord& WithUpdateTime(UpdateTimeT&& value) {
  ...
  inline void SetFindingCreated(bool value) {
    m_findingCreatedHasBeenSet = true;
    m_findingCreated = value;
  }
  inline FindingHistoryRecord& WithFindingCreated(bool value) {
    SetFindingCreated(value);
    return *this;
  }
  ///@}
  ...
  void SetUpdateSource(UpdateSourceT&& value) {
    ...
    m_updateSource = std::forward<UpdateSourceT>(value);
  }
  template <typename UpdateSourceT = FindingHistoryUpdateSource>
  FindingHistoryRecord& WithUpdateSource(UpdateSourceT&& value) {
    SetUpdateSource(std::forward<UpdateSourceT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename UpdatesT = Aws::Vector<FindingHistoryUpdate>>
  FindingHistoryRecord& WithUpdates(UpdatesT&& value) {
    SetUpdates(std::forward<UpdatesT>(value));
    return *this;
  }
  template <typename UpdatesT = FindingHistoryUpdate>
  FindingHistoryRecord& AddUpdates(UpdatesT&& value) {
    m_updatesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  FindingHistoryRecord& WithNextToken(NextTokenT&& value) {
