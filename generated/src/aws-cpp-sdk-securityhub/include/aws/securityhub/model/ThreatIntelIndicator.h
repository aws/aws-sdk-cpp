...
class ThreatIntelIndicator {
 public:
  ...
  inline void SetType(ThreatIntelIndicatorType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline ThreatIntelIndicator& WithType(ThreatIntelIndicatorType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCategory(ThreatIntelIndicatorCategory value) {
    m_categoryHasBeenSet = true;
    m_category = value;
  }
  inline ThreatIntelIndicator& WithCategory(ThreatIntelIndicatorCategory value) {
    SetCategory(value);
    return *this;
  }
  ///@}
