...
class StartConfigurationPolicyDisassociationRequest : public SecurityHubRequest {
 public:
  ...
  template <typename TargetT = Target>
  StartConfigurationPolicyDisassociationRequest& WithTarget(TargetT&& value) {
  ...
  void SetConfigurationPolicyIdentifier(ConfigurationPolicyIdentifierT&& value) {
    m_configurationPolicyIdentifierHasBeenSet = true;
    m_configurationPolicyIdentifier = std::forward<ConfigurationPolicyIdentifierT>(value);
  }
  template <typename ConfigurationPolicyIdentifierT = Aws::String>
  StartConfigurationPolicyDisassociationRequest& WithConfigurationPolicyIdentifier(ConfigurationPolicyIdentifierT&& value) {
    SetConfigurationPolicyIdentifier(std::forward<ConfigurationPolicyIdentifierT>(value));
    return *this;
  }
  ///@}
 private:
