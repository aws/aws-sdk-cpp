...
class AwsEcsTaskDefinitionContainerDefinitionsResourceRequirementsDetails {
 public:
  ...
  template <typename TypeT = Aws::String>
  AwsEcsTaskDefinitionContainerDefinitionsResourceRequirementsDetails& WithType(TypeT&& value) {
  ...
  template <typename ValueT = Aws::String>
  AwsEcsTaskDefinitionContainerDefinitionsResourceRequirementsDetails& WithValue(ValueT&& value) {
