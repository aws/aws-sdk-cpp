...
class AwsCloudFormationStackOutputsDetails {
 public:
  ...
  template <typename DescriptionT = Aws::String>
  AwsCloudFormationStackOutputsDetails& WithDescription(DescriptionT&& value) {
  ...
  template <typename OutputKeyT = Aws::String>
  AwsCloudFormationStackOutputsDetails& WithOutputKey(OutputKeyT&& value) {
  ...
  void SetOutputValue(OutputValueT&& value) {
    ...
    m_outputValue = std::forward<OutputValueT>(value);
  }
  template <typename OutputValueT = Aws::String>
  AwsCloudFormationStackOutputsDetails& WithOutputValue(OutputValueT&& value) {
    SetOutputValue(std::forward<OutputValueT>(value));
    return *this;
  }
  ///@}
 private:
