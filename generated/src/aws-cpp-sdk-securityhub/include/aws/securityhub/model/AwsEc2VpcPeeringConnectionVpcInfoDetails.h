...
class AwsEc2VpcPeeringConnectionVpcInfoDetails {
 public:
  ...
  template <typename CidrBlockT = Aws::String>
  AwsEc2VpcPeeringConnectionVpcInfoDetails& WithCidrBlock(CidrBlockT&& value) {
  ...
  void SetCidrBlockSet(CidrBlockSetT&& value) {
    m_cidrBlockSetHasBeenSet = true;
    m_cidrBlockSet = std::forward<CidrBlockSetT>(value);
  }
  template <typename CidrBlockSetT = Aws::Vector<VpcInfoCidrBlockSetDetails>>
  AwsEc2VpcPeeringConnectionVpcInfoDetails& WithCidrBlockSet(CidrBlockSetT&& value) {
    SetCidrBlockSet(std::forward<CidrBlockSetT>(value));
    return *this;
  }
  template <typename CidrBlockSetT = VpcInfoCidrBlockSetDetails>
  AwsEc2VpcPeeringConnectionVpcInfoDetails& AddCidrBlockSet(CidrBlockSetT&& value) {
    m_cidrBlockSetHasBeenSet = true;
    m_cidrBlockSet.emplace_back(std::forward<CidrBlockSetT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIpv6CidrBlockSet(Ipv6CidrBlockSetT&& value) {
    m_ipv6CidrBlockSetHasBeenSet = true;
    m_ipv6CidrBlockSet = std::forward<Ipv6CidrBlockSetT>(value);
  }
  template <typename Ipv6CidrBlockSetT = Aws::Vector<VpcInfoIpv6CidrBlockSetDetails>>
  AwsEc2VpcPeeringConnectionVpcInfoDetails& WithIpv6CidrBlockSet(Ipv6CidrBlockSetT&& value) {
    SetIpv6CidrBlockSet(std::forward<Ipv6CidrBlockSetT>(value));
    return *this;
  }
  template <typename Ipv6CidrBlockSetT = VpcInfoIpv6CidrBlockSetDetails>
  AwsEc2VpcPeeringConnectionVpcInfoDetails& AddIpv6CidrBlockSet(Ipv6CidrBlockSetT&& value) {
    m_ipv6CidrBlockSetHasBeenSet = true;
    m_ipv6CidrBlockSet.emplace_back(std::forward<Ipv6CidrBlockSetT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename OwnerIdT = Aws::String>
  AwsEc2VpcPeeringConnectionVpcInfoDetails& WithOwnerId(OwnerIdT&& value) {
  ...
  void SetPeeringOptions(PeeringOptionsT&& value) {
    m_peeringOptionsHasBeenSet = true;
    m_peeringOptions = std::forward<PeeringOptionsT>(value);
  }
  template <typename PeeringOptionsT = VpcInfoPeeringOptionsDetails>
  AwsEc2VpcPeeringConnectionVpcInfoDetails& WithPeeringOptions(PeeringOptionsT&& value) {
    SetPeeringOptions(std::forward<PeeringOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RegionT = Aws::String>
  AwsEc2VpcPeeringConnectionVpcInfoDetails& WithRegion(RegionT&& value) {
  ...
  template <typename VpcIdT = Aws::String>
  AwsEc2VpcPeeringConnectionVpcInfoDetails& WithVpcId(VpcIdT&& value) {
