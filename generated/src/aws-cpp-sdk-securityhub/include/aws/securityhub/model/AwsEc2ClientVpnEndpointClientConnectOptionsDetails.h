...
class AwsEc2ClientVpnEndpointClientConnectOptionsDetails {
 public:
  ...
  inline AwsEc2ClientVpnEndpointClientConnectOptionsDetails& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  template <typename LambdaFunctionArnT = Aws::String>
  AwsEc2ClientVpnEndpointClientConnectOptionsDetails& WithLambdaFunctionArn(LambdaFunctionArnT&& value) {
  ...
  template <typename StatusT = AwsEc2ClientVpnEndpointClientConnectOptionsStatusDetails>
  AwsEc2ClientVpnEndpointClientConnectOptionsDetails& WithStatus(StatusT&& value) {
