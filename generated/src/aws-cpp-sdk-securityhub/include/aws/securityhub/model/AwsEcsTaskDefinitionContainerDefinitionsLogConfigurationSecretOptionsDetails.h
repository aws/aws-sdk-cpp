...
class AwsEcsTaskDefinitionContainerDefinitionsLogConfigurationSecretOptionsDetails {
 public:
  ...
  AWS_SECURITYHUB_API AwsEcsTaskDefinitionContainerDefinitionsLogConfigurationSecretOptionsDetails& operator=(
  ...
  template <typename NameT = Aws::String>
  AwsEcsTaskDefinitionContainerDefinitionsLogConfigurationSecretOptionsDetails& WithName(NameT&& value) {
  ...
  template <typename ValueFromT = Aws::String>
  AwsEcsTaskDefinitionContainerDefinitionsLogConfigurationSecretOptionsDetails& WithValueFrom(ValueFromT&& value) {
