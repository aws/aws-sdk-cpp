...
class AwsDynamoDbTableReplicaGlobalSecondaryIndex {
 public:
  ...
  template <typename IndexNameT = Aws::String>
  AwsDynamoDbTableReplicaGlobalSecondaryIndex& WithIndexName(IndexNameT&& value) {
  ...
  template <typename ProvisionedThroughputOverrideT = AwsDynamoDbTableProvisionedThroughputOverride>
  AwsDynamoDbTableReplicaGlobalSecondaryIndex& WithProvisionedThroughputOverride(ProvisionedThroughputOverrideT&& value) {
