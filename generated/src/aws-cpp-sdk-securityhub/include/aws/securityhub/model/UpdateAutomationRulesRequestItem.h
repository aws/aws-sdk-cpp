...
class UpdateAutomationRulesRequestItem {
 public:
  ...
  inline UpdateAutomationRulesRequestItem& WithRuleStatus(RuleStatus value) {
    SetRuleStatus(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateAutomationRulesRequestItem& WithRuleOrder(int value) {
    SetRuleOrder(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateAutomationRulesRequestItem& WithIsTerminal(bool value) {
    SetIsTerminal(value);
    return *this;
  }
  ///@}
