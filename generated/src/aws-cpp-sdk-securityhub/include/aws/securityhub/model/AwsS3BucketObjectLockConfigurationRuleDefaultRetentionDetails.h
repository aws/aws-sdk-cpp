...
class AwsS3BucketObjectLockConfigurationRuleDefaultRetentionDetails {
 public:
  ...
  inline AwsS3BucketObjectLockConfigurationRuleDefaultRetentionDetails& WithDays(int value) {
    SetDays(value);
    return *this;
  }
  ///@}
  ...
  template <typename ModeT = Aws::String>
  AwsS3BucketObjectLockConfigurationRuleDefaultRetentionDetails& WithMode(ModeT&& value) {
  ...
  inline AwsS3BucketObjectLockConfigurationRuleDefaultRetentionDetails& WithYears(int value) {
    SetYears(value);
    return *this;
  }
  ///@}
