...
class AwsS3AccountPublicAccessBlockDetails {
 public:
  ...
  inline AwsS3AccountPublicAccessBlockDetails& WithBlockPublicAcls(bool value) {
  ...
  inline AwsS3AccountPublicAccessBlockDetails& WithBlockPublicPolicy(bool value) {
  ...
  inline AwsS3AccountPublicAccessBlockDetails& WithIgnorePublicAcls(bool value) {
  ...
  inline AwsS3AccountPublicAccessBlockDetails& WithRestrictPublicBuckets(bool value) {
