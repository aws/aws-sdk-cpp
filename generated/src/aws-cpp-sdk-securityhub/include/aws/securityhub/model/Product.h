...
class Product {
 public:
  ...
  void SetIntegrationTypes(IntegrationTypesT&& value) {
    ...
    m_integrationTypes = std::forward<IntegrationTypesT>(value);
  }
  template <typename IntegrationTypesT = Aws::Vector<IntegrationType>>
  Product& WithIntegrationTypes(IntegrationTypesT&& value) {
    SetIntegrationTypes(std::forward<IntegrationTypesT>(value));
    return *this;
  }
  inline Product& AddIntegrationTypes(IntegrationType value) {
    m_integrationTypesHasBeenSet = true;
    m_integrationTypes.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetMarketplaceUrl(MarketplaceUrlT&& value) {
    ...
    m_marketplaceUrl = std::forward<MarketplaceUrlT>(value);
  }
  template <typename MarketplaceUrlT = Aws::String>
  Product& WithMarketplaceUrl(MarketplaceUrlT&& value) {
    SetMarketplaceUrl(std::forward<MarketplaceUrlT>(value));
    return *this;
  }
  ///@}
  ...
  void SetActivationUrl(ActivationUrlT&& value) {
    ...
    m_activationUrl = std::forward<ActivationUrlT>(value);
  }
  template <typename ActivationUrlT = Aws::String>
  Product& WithActivationUrl(ActivationUrlT&& value) {
    SetActivationUrl(std::forward<ActivationUrlT>(value));
    return *this;
  }
  ///@}
  ...
  void SetProductSubscriptionResourcePolicy(ProductSubscriptionResourcePolicyT&& value) {
    ...
    m_productSubscriptionResourcePolicy = std::forward<ProductSubscriptionResourcePolicyT>(value);
  }
  template <typename ProductSubscriptionResourcePolicyT = Aws::String>
  Product& WithProductSubscriptionResourcePolicy(ProductSubscriptionResourcePolicyT&& value) {
    SetProductSubscriptionResourcePolicy(std::forward<ProductSubscriptionResourcePolicyT>(value));
    return *this;
  }
  ///@}
 private:
