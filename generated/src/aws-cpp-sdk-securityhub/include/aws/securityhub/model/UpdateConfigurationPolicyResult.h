...
class UpdateConfigurationPolicyResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  UpdateConfigurationPolicyResult& WithArn(ArnT&& value) {
  ...
  template <typename IdT = Aws::String>
  UpdateConfigurationPolicyResult& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  UpdateConfigurationPolicyResult& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateConfigurationPolicyResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  UpdateConfigurationPolicyResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  UpdateConfigurationPolicyResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename ConfigurationPolicyT = Policy>
  UpdateConfigurationPolicyResult& WithConfigurationPolicy(ConfigurationPolicyT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateConfigurationPolicyResult& WithRequestId(RequestIdT&& value) {
