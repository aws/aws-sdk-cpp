...
class AwsBackupBackupVaultNotificationsDetails {
 public:
  ...
  template <typename BackupVaultEventsT = Aws::Vector<Aws::String>>
  AwsBackupBackupVaultNotificationsDetails& WithBackupVaultEvents(BackupVaultEventsT&& value) {
    SetBackupVaultEvents(std::forward<BackupVaultEventsT>(value));
    return *this;
  }
  template <typename BackupVaultEventsT = Aws::String>
  AwsBackupBackupVaultNotificationsDetails& AddBackupVaultEvents(BackupVaultEventsT&& value) {
    m_backupVaultEventsHasBeenSet = true;
    m_backupVaultEvents.emplace_back(std::forward<BackupVaultEventsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename SnsTopicArnT = Aws::String>
  AwsBackupBackupVaultNotificationsDetails& WithSnsTopicArn(SnsTopicArnT&& value) {
