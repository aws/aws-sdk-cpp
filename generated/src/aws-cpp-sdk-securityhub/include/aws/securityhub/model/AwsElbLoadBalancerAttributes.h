...
class AwsElbLoadBalancerAttributes {
 public:
  ...
  void SetAccessLog(AccessLogT&& value) {
    ...
    m_accessLog = std::forward<AccessLogT>(value);
  }
  template <typename AccessLogT = AwsElbLoadBalancerAccessLog>
  AwsElbLoadBalancerAttributes& WithAccessLog(AccessLogT&& value) {
    SetAccessLog(std::forward<AccessLogT>(value));
    return *this;
  }
  ///@}
  ...
  void SetConnectionDraining(ConnectionDrainingT&& value) {
    ...
    m_connectionDraining = std::forward<ConnectionDrainingT>(value);
  }
  template <typename ConnectionDrainingT = AwsElbLoadBalancerConnectionDraining>
  AwsElbLoadBalancerAttributes& WithConnectionDraining(ConnectionDrainingT&& value) {
    SetConnectionDraining(std::forward<ConnectionDrainingT>(value));
    return *this;
  }
  ///@}
  ...
  void SetConnectionSettings(ConnectionSettingsT&& value) {
    ...
    m_connectionSettings = std::forward<ConnectionSettingsT>(value);
  }
  template <typename ConnectionSettingsT = AwsElbLoadBalancerConnectionSettings>
  AwsElbLoadBalancerAttributes& WithConnectionSettings(ConnectionSettingsT&& value) {
    SetConnectionSettings(std::forward<ConnectionSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCrossZoneLoadBalancing(CrossZoneLoadBalancingT&& value) {
    ...
    m_crossZoneLoadBalancing = std::forward<CrossZoneLoadBalancingT>(value);
  }
  template <typename CrossZoneLoadBalancingT = AwsElbLoadBalancerCrossZoneLoadBalancing>
  AwsElbLoadBalancerAttributes& WithCrossZoneLoadBalancing(CrossZoneLoadBalancingT&& value) {
    SetCrossZoneLoadBalancing(std::forward<CrossZoneLoadBalancingT>(value));
    return *this;
  }
  ///@}
