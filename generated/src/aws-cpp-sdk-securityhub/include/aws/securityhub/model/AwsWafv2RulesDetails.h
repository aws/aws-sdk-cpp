...
class AwsWafv2RulesDetails {
 public:
  ...
  void SetOverrideAction(OverrideActionT&& value) {
    ...
    m_overrideAction = std::forward<OverrideActionT>(value);
  }
  template <typename OverrideActionT = Aws::String>
  AwsWafv2RulesDetails& WithOverrideAction(OverrideActionT&& value) {
    SetOverrideAction(std::forward<OverrideActionT>(value));
    return *this;
  }
  ///@}
  ...
  inline AwsWafv2RulesDetails& WithPriority(int value) {
    SetPriority(value);
    return *this;
  }
  ///@}
