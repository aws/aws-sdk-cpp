...
class AwsAppSyncGraphQlApiOpenIdConnectConfigDetails {
 public:
  ...
  inline AwsAppSyncGraphQlApiOpenIdConnectConfigDetails& WithAuthTtL(long long value) {
    SetAuthTtL(value);
    return *this;
  }
  ///@}
  ...
  template <typename ClientIdT = Aws::String>
  AwsAppSyncGraphQlApiOpenIdConnectConfigDetails& WithClientId(ClientIdT&& value) {
  ...
  inline AwsAppSyncGraphQlApiOpenIdConnectConfigDetails& WithIatTtL(long long value) {
    SetIatTtL(value);
    return *this;
  }
  ///@}
  ...
  template <typename IssuerT = Aws::String>
  AwsAppSyncGraphQlApiOpenIdConnectConfigDetails& WithIssuer(IssuerT&& value) {
