...
class AwsRdsDbClusterOptionGroupMembership {
 public:
  ...
  template <typename DbClusterOptionGroupNameT = Aws::String>
  AwsRdsDbClusterOptionGroupMembership& WithDbClusterOptionGroupName(DbClusterOptionGroupNameT&& value) {
  ...
  template <typename StatusT = Aws::String>
  AwsRdsDbClusterOptionGroupMembership& WithStatus(StatusT&& value) {
