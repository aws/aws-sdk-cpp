...
class AwsEc2LaunchTemplateDataPrivateDnsNameOptionsDetails {
 public:
  ...
  inline AwsEc2LaunchTemplateDataPrivateDnsNameOptionsDetails& WithEnableResourceNameDnsAAAARecord(bool value) {
  ...
  inline AwsEc2LaunchTemplateDataPrivateDnsNameOptionsDetails& WithEnableResourceNameDnsARecord(bool value) {
  ...
  void SetHostnameType(HostnameTypeT&& value) {
    m_hostnameTypeHasBeenSet = true;
    m_hostnameType = std::forward<HostnameTypeT>(value);
  }
  template <typename HostnameTypeT = Aws::String>
  AwsEc2LaunchTemplateDataPrivateDnsNameOptionsDetails& WithHostnameType(HostnameTypeT&& value) {
    SetHostnameType(std::forward<HostnameTypeT>(value));
    return *this;
  }
  ///@}
 private:
