...
class AwsEcsServiceNetworkConfigurationDetails {
 public:
  ...
  void SetAwsVpcConfiguration(AwsVpcConfigurationT&& value) {
    ...
    m_awsVpcConfiguration = std::forward<AwsVpcConfigurationT>(value);
  }
  template <typename AwsVpcConfigurationT = AwsEcsServiceNetworkConfigurationAwsVpcConfigurationDetails>
  AwsEcsServiceNetworkConfigurationDetails& WithAwsVpcConfiguration(AwsVpcConfigurationT&& value) {
    SetAwsVpcConfiguration(std::forward<AwsVpcConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
