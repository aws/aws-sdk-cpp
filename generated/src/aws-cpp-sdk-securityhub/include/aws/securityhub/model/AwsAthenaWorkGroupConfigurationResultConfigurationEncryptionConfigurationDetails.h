...
class AwsAthenaWorkGroupConfigurationResultConfigurationEncryptionConfigurationDetails {
 public:
  ...
  AWS_SECURITYHUB_API AwsAthenaWorkGroupConfigurationResultConfigurationEncryptionConfigurationDetails& operator=(
      Aws::Utils::Json::JsonView jsonValue);
  ...
  void SetEncryptionOption(EncryptionOptionT&& value) {
    m_encryptionOptionHasBeenSet = true;
    m_encryptionOption = std::forward<EncryptionOptionT>(value);
  }
  template <typename EncryptionOptionT = Aws::String>
  AwsAthenaWorkGroupConfigurationResultConfigurationEncryptionConfigurationDetails& WithEncryptionOption(EncryptionOptionT&& value) {
    SetEncryptionOption(std::forward<EncryptionOptionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename KmsKeyT = Aws::String>
  AwsAthenaWorkGroupConfigurationResultConfigurationEncryptionConfigurationDetails& WithKmsKey(KmsKeyT&& value) {
