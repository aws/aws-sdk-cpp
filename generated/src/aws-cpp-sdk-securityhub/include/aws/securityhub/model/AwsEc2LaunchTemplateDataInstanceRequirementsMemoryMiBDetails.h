...
class AwsEc2LaunchTemplateDataInstanceRequirementsMemoryMiBDetails {
 public:
  AWS_SECURITYHUB_API AwsEc2LaunchTemplateDataInstanceRequirementsMemoryMiBDetails() = default;
  ...
  inline AwsEc2LaunchTemplateDataInstanceRequirementsMemoryMiBDetails& WithMax(int value) {
    SetMax(value);
    return *this;
  }
  ///@}
  ...
  inline AwsEc2LaunchTemplateDataInstanceRequirementsMemoryMiBDetails& WithMin(int value) {
    SetMin(value);
    return *this;
  }
  ///@}
