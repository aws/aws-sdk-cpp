...
class AwsEc2LaunchTemplateDataNetworkInterfaceSetPrivateIpAddressesDetails {
 public:
  ...
  inline AwsEc2LaunchTemplateDataNetworkInterfaceSetPrivateIpAddressesDetails& WithPrimary(bool value) {
    SetPrimary(value);
    return *this;
  }
  ///@}
  ...
  template <typename PrivateIpAddressT = Aws::String>
  AwsEc2LaunchTemplateDataNetworkInterfaceSetPrivateIpAddressesDetails& WithPrivateIpAddress(PrivateIpAddressT&& value) {
