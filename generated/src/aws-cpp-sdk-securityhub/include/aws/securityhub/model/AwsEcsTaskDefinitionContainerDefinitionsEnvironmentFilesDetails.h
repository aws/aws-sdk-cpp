...
class AwsEcsTaskDefinitionContainerDefinitionsEnvironmentFilesDetails {
 public:
  ...
  template <typename TypeT = Aws::String>
  AwsEcsTaskDefinitionContainerDefinitionsEnvironmentFilesDetails& WithType(TypeT&& value) {
  ...
  template <typename ValueT = Aws::String>
  AwsEcsTaskDefinitionContainerDefinitionsEnvironmentFilesDetails& WithValue(ValueT&& value) {
