...
class AwsEcsTaskDefinitionContainerDefinitionsFirelensConfigurationDetails {
 public:
  ...
  template <typename OptionsT = Aws::Map<Aws::String, Aws::String>>
  AwsEcsTaskDefinitionContainerDefinitionsFirelensConfigurationDetails& WithOptions(OptionsT&& value) {
  ...
  template <typename TypeT = Aws::String>
  AwsEcsTaskDefinitionContainerDefinitionsFirelensConfigurationDetails& WithType(TypeT&& value) {
