...
class BatchUpdateFindingsV2Request : public SecurityHubRequest {
 public:
  ...
  void SetMetadataUids(MetadataUidsT&& value) {
    m_metadataUidsHasBeenSet = true;
    m_metadataUids = std::forward<MetadataUidsT>(value);
  }
  template <typename MetadataUidsT = Aws::Vector<Aws::String>>
  BatchUpdateFindingsV2Request& WithMetadataUids(MetadataUidsT&& value) {
    SetMetadataUids(std::forward<MetadataUidsT>(value));
    return *this;
  }
  template <typename MetadataUidsT = Aws::String>
  BatchUpdateFindingsV2Request& AddMetadataUids(MetadataUidsT&& value) {
    m_metadataUidsHasBeenSet = true;
    m_metadataUids.emplace_back(std::forward<MetadataUidsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFindingIdentifiers(FindingIdentifiersT&& value) {
    m_findingIdentifiersHasBeenSet = true;
    m_findingIdentifiers = std::forward<FindingIdentifiersT>(value);
  }
  template <typename FindingIdentifiersT = Aws::Vector<OcsfFindingIdentifier>>
  BatchUpdateFindingsV2Request& WithFindingIdentifiers(FindingIdentifiersT&& value) {
    SetFindingIdentifiers(std::forward<FindingIdentifiersT>(value));
    return *this;
  }
  ...
  BatchUpdateFindingsV2Request& AddFindingIdentifiers(FindingIdentifiersT&& value) {
    m_findingIdentifiersHasBeenSet = true;
    m_findingIdentifiers.emplace_back(std::forward<FindingIdentifiersT>(value));
    return *this;
  }
  ///@}
  ...
  inline BatchUpdateFindingsV2Request& WithSeverityId(int value) {
    SetSeverityId(value);
    return *this;
  }
  ///@}
  ...
  inline BatchUpdateFindingsV2Request& WithStatusId(int value) {
    SetStatusId(value);
    return *this;
  }
  ///@}
