...
class AwsRedshiftClusterResizeInfo {
 public:
  ...
  inline void SetAllowCancelResize(bool value) {
    m_allowCancelResizeHasBeenSet = true;
    m_allowCancelResize = value;
  }
  inline AwsRedshiftClusterResizeInfo& WithAllowCancelResize(bool value) {
    SetAllowCancelResize(value);
    return *this;
  }
  ///@}
  ...
  void SetResizeType(ResizeTypeT&& value) {
    ...
    m_resizeType = std::forward<ResizeTypeT>(value);
  }
  template <typename ResizeTypeT = Aws::String>
  AwsRedshiftClusterResizeInfo& WithResizeType(ResizeTypeT&& value) {
    SetResizeType(std::forward<ResizeTypeT>(value));
    return *this;
  }
  ///@}
 private:
