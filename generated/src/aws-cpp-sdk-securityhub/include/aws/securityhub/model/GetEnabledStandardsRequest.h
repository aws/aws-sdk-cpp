...
class GetEnabledStandardsRequest : public SecurityHubRequest {
 public:
  ...
  void SetStandardsSubscriptionArns(StandardsSubscriptionArnsT&& value) {
    m_standardsSubscriptionArnsHasBeenSet = true;
    m_standardsSubscriptionArns = std::forward<StandardsSubscriptionArnsT>(value);
  }
  template <typename StandardsSubscriptionArnsT = Aws::Vector<Aws::String>>
  GetEnabledStandardsRequest& WithStandardsSubscriptionArns(StandardsSubscriptionArnsT&& value) {
    SetStandardsSubscriptionArns(std::forward<StandardsSubscriptionArnsT>(value));
    return *this;
  }
  ...
  GetEnabledStandardsRequest& AddStandardsSubscriptionArns(StandardsSubscriptionArnsT&& value) {
    m_standardsSubscriptionArnsHasBeenSet = true;
    m_standardsSubscriptionArns.emplace_back(std::forward<StandardsSubscriptionArnsT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetEnabledStandardsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  ///@{
  /**
   * <p>A list of cloud providers to filter the enabled standards by. For example,
   * specify <code>Azure</code> to return only enabled standards that evaluate Azure
   * resources.</p>
   */
  ...
  inline GetEnabledStandardsRequest& AddProviders(StandardsProvider value) {
    m_providersHasBeenSet = true;
