...
class ResourcesMapFilter {
 public:
  ...
  inline void SetFieldName(ResourcesMapField value) {
    m_fieldNameHasBeenSet = true;
    m_fieldName = value;
  }
  inline ResourcesMapFilter& WithFieldName(ResourcesMapField value) {
    SetFieldName(value);
    return *this;
  }
  ///@}
  ...
  template <typename FilterT = MapFilter>
  ResourcesMapFilter& WithFilter(FilterT&& value) {
