...
class OcsfBooleanFilter {
 public:
  ...
  inline void SetFieldName(OcsfBooleanField value) {
    m_fieldNameHasBeenSet = true;
    m_fieldName = value;
  }
  inline OcsfBooleanFilter& WithFieldName(OcsfBooleanField value) {
    SetFieldName(value);
    return *this;
  }
  ///@}
  ...
  template <typename FilterT = BooleanFilter>
  OcsfBooleanFilter& WithFilter(FilterT&& value) {
