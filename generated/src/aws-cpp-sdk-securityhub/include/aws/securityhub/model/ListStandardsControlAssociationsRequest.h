...
class ListStandardsControlAssociationsRequest : public SecurityHubRequest {
 public:
  ...
  template <typename SecurityControlIdT = Aws::String>
  ListStandardsControlAssociationsRequest& WithSecurityControlId(SecurityControlIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListStandardsControlAssociationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListStandardsControlAssociationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
