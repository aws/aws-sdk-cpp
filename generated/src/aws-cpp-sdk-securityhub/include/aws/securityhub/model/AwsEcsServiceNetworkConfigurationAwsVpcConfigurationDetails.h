...
class AwsEcsServiceNetworkConfigurationAwsVpcConfigurationDetails {
 public:
  ...
  void SetAssignPublicIp(AssignPublicIpT&& value) {
    m_assignPublicIpHasBeenSet = true;
    m_assignPublicIp = std::forward<AssignPublicIpT>(value);
  }
  template <typename AssignPublicIpT = Aws::String>
  AwsEcsServiceNetworkConfigurationAwsVpcConfigurationDetails& WithAssignPublicIp(AssignPublicIpT&& value) {
    SetAssignPublicIp(std::forward<AssignPublicIpT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename SecurityGroupsT = Aws::Vector<Aws::String>>
  AwsEcsServiceNetworkConfigurationAwsVpcConfigurationDetails& WithSecurityGroups(SecurityGroupsT&& value) {
    SetSecurityGroups(std::forward<SecurityGroupsT>(value));
    return *this;
  }
  template <typename SecurityGroupsT = Aws::String>
  AwsEcsServiceNetworkConfigurationAwsVpcConfigurationDetails& AddSecurityGroups(SecurityGroupsT&& value) {
    m_securityGroupsHasBeenSet = true;
  ...
  template <typename SubnetsT = Aws::Vector<Aws::String>>
  AwsEcsServiceNetworkConfigurationAwsVpcConfigurationDetails& WithSubnets(SubnetsT&& value) {
    SetSubnets(std::forward<SubnetsT>(value));
    return *this;
  }
  template <typename SubnetsT = Aws::String>
  AwsEcsServiceNetworkConfigurationAwsVpcConfigurationDetails& AddSubnets(SubnetsT&& value) {
    m_subnetsHasBeenSet = true;
