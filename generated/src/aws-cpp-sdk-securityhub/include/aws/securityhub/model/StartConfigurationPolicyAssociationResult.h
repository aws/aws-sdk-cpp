...
class StartConfigurationPolicyAssociationResult {
 public:
  ...
  AWS_SECURITYHUB_API StartConfigurationPolicyAssociationResult& operator=(
  ...
  inline StartConfigurationPolicyAssociationResult& WithTargetType(TargetType value) {
    SetTargetType(value);
    return *this;
  }
  ///@}
  ...
  inline StartConfigurationPolicyAssociationResult& WithAssociationType(AssociationType value) {
  ...
  inline StartConfigurationPolicyAssociationResult& WithAssociationStatus(ConfigurationPolicyAssociationStatus value) {
