...
class AutomationRulesConfig {
 public:
  ...
  inline AutomationRulesConfig& WithRuleStatus(RuleStatus value) {
    SetRuleStatus(value);
    return *this;
  }
  ///@}
  ...
  inline AutomationRulesConfig& WithRuleOrder(int value) {
    SetRuleOrder(value);
    return *this;
  }
  ///@}
  ...
  inline AutomationRulesConfig& WithIsTerminal(bool value) {
    SetIsTerminal(value);
    return *this;
  }
  ///@}
