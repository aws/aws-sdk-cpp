...
class BatchUpdateAutomationRulesRequest : public SecurityHubRequest {
 public:
   ...
   */
  inline const Aws::Vector<UpdateAutomationRulesRequestItem>& GetUpdateAutomationRulesRequestItems() const {
    return m_updateAutomationRulesRequestItems;
  }
  ...
  void SetUpdateAutomationRulesRequestItems(UpdateAutomationRulesRequestItemsT&& value) {
    m_updateAutomationRulesRequestItemsHasBeenSet = true;
    m_updateAutomationRulesRequestItems = std::forward<UpdateAutomationRulesRequestItemsT>(value);
  }
  template <typename UpdateAutomationRulesRequestItemsT = Aws::Vector<UpdateAutomationRulesRequestItem>>
  BatchUpdateAutomationRulesRequest& WithUpdateAutomationRulesRequestItems(UpdateAutomationRulesRequestItemsT&& value) {
    SetUpdateAutomationRulesRequestItems(std::forward<UpdateAutomationRulesRequestItemsT>(value));
    return *this;
  }
  template <typename UpdateAutomationRulesRequestItemsT = UpdateAutomationRulesRequestItem>
  BatchUpdateAutomationRulesRequest& AddUpdateAutomationRulesRequestItems(UpdateAutomationRulesRequestItemsT&& value) {
    m_updateAutomationRulesRequestItemsHasBeenSet = true;
    m_updateAutomationRulesRequestItems.emplace_back(std::forward<UpdateAutomationRulesRequestItemsT>(value));
    return *this;
  }
  ///@}
 private:
