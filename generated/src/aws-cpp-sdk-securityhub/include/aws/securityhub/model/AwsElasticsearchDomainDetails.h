...
class AwsElasticsearchDomainDetails {
 public:
   ...
   */
  inline const AwsElasticsearchDomainElasticsearchClusterConfigDetails& GetElasticsearchClusterConfig() const {
    return m_elasticsearchClusterConfig;
  }
   ...
   */
  inline const AwsElasticsearchDomainNodeToNodeEncryptionOptions& GetNodeToNodeEncryptionOptions() const {
    return m_nodeToNodeEncryptionOptions;
  }
