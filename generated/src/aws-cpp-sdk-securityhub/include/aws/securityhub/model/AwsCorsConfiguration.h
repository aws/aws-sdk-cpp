...
class AwsCorsConfiguration {
 public:
  ...
  inline void SetAllowCredentials(bool value) {
    m_allowCredentialsHasBeenSet = true;
    m_allowCredentials = value;
  }
  inline AwsCorsConfiguration& WithAllowCredentials(bool value) {
    SetAllowCredentials(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxAge(int value) {
    m_maxAgeHasBeenSet = true;
    m_maxAge = value;
  }
  inline AwsCorsConfiguration& WithMaxAge(int value) {
    SetMaxAge(value);
    return *this;
  }
  ///@}
