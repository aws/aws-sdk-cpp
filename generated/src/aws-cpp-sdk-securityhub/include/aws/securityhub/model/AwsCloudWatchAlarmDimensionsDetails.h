...
namespace Model
{
  ...
  {
  public:
    AWS_SECURITYHUB_API AwsCloudWatchAlarmDimensionsDetails() = default;
    ...
    template<typename NameT = Aws::String>
    AwsCloudWatchAlarmDimensionsDetails& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename ValueT = Aws::String>
    AwsCloudWatchAlarmDimensionsDetails& WithValue(ValueT&& value) { SetValue(std::forward<ValueT>(value)); return *this;}
    ///@}
  private:
