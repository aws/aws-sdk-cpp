...
class AwsMskClusterClusterInfoClientAuthenticationTlsDetails {
 public:
  ...
  void SetCertificateAuthorityArnList(CertificateAuthorityArnListT&& value) {
    ...
    m_certificateAuthorityArnList = std::forward<CertificateAuthorityArnListT>(value);
  }
  template <typename CertificateAuthorityArnListT = Aws::Vector<Aws::String>>
  AwsMskClusterClusterInfoClientAuthenticationTlsDetails& WithCertificateAuthorityArnList(CertificateAuthorityArnListT&& value) {
    SetCertificateAuthorityArnList(std::forward<CertificateAuthorityArnListT>(value));
    return *this;
  }
  template <typename CertificateAuthorityArnListT = Aws::String>
  AwsMskClusterClusterInfoClientAuthenticationTlsDetails& AddCertificateAuthorityArnList(CertificateAuthorityArnListT&& value) {
    m_certificateAuthorityArnListHasBeenSet = true;
    m_certificateAuthorityArnList.emplace_back(std::forward<CertificateAuthorityArnListT>(value));
    return *this;
  }
  ///@}
  ...
  inline AwsMskClusterClusterInfoClientAuthenticationTlsDetails& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
