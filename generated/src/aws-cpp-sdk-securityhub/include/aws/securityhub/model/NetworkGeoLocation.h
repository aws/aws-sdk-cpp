 ...
 * Hub CSPM, you must have GuardDuty enabled. For more information, see <a
...
class NetworkGeoLocation {
 public:
  ...
  inline NetworkGeoLocation& WithLat(double value) {
    SetLat(value);
    return *this;
  }
  ///@}
  ...
  inline NetworkGeoLocation& WithLon(double value) {
    SetLon(value);
    return *this;
  }
  ///@}
