...
class DisableOrganizationAdminAccountRequest : public SecurityHubRequest {
 public:
  ...
  template <typename AdminAccountIdT = Aws::String>
  DisableOrganizationAdminAccountRequest& WithAdminAccountId(AdminAccountIdT&& value) {
  ...
  inline DisableOrganizationAdminAccountRequest& WithFeature(SecurityHubFeature value) {
    SetFeature(value);
    return *this;
  }
  ///@}
