...
class AwsAmazonMqBrokerLogsPendingDetails {
 public:
  ...
  inline void SetAudit(bool value) {
    m_auditHasBeenSet = true;
    m_audit = value;
  }
  inline AwsAmazonMqBrokerLogsPendingDetails& WithAudit(bool value) {
    SetAudit(value);
    return *this;
  }
  ///@}
  ...
  inline void SetGeneral(bool value) {
    m_generalHasBeenSet = true;
    m_general = value;
  }
  inline AwsAmazonMqBrokerLogsPendingDetails& WithGeneral(bool value) {
    SetGeneral(value);
    return *this;
  }
  ///@}
