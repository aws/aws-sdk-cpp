...
class AwsStepFunctionStateMachineTracingConfigurationDetails {
 public:
  AWS_SECURITYHUB_API AwsStepFunctionStateMachineTracingConfigurationDetails() = default;
  ...
  inline AwsStepFunctionStateMachineTracingConfigurationDetails& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
