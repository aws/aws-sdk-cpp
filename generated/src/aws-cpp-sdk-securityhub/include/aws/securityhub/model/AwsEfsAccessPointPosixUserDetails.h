...
class AwsEfsAccessPointPosixUserDetails {
 public:
  ...
  void SetGid(GidT&& value) {
    m_gidHasBeenSet = true;
    m_gid = std::forward<GidT>(value);
  }
  template <typename GidT = Aws::String>
  AwsEfsAccessPointPosixUserDetails& WithGid(GidT&& value) {
    SetGid(std::forward<GidT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename SecondaryGidsT = Aws::Vector<Aws::String>>
  AwsEfsAccessPointPosixUserDetails& WithSecondaryGids(SecondaryGidsT&& value) {
    SetSecondaryGids(std::forward<SecondaryGidsT>(value));
    return *this;
  }
  template <typename SecondaryGidsT = Aws::String>
  AwsEfsAccessPointPosixUserDetails& AddSecondaryGids(SecondaryGidsT&& value) {
    m_secondaryGidsHasBeenSet = true;
    m_secondaryGids.emplace_back(std::forward<SecondaryGidsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename UidT = Aws::String>
  AwsEfsAccessPointPosixUserDetails& WithUid(UidT&& value) {
