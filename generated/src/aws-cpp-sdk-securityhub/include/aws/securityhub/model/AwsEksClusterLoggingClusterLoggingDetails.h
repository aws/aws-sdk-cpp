...
class AwsEksClusterLoggingClusterLoggingDetails {
 public:
  ...
  inline AwsEksClusterLoggingClusterLoggingDetails& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  template <typename TypesT = Aws::Vector<Aws::String>>
  AwsEksClusterLoggingClusterLoggingDetails& WithTypes(TypesT&& value) {
    SetTypes(std::forward<TypesT>(value));
    return *this;
  }
  template <typename TypesT = Aws::String>
  AwsEksClusterLoggingClusterLoggingDetails& AddTypes(TypesT&& value) {
    m_typesHasBeenSet = true;
