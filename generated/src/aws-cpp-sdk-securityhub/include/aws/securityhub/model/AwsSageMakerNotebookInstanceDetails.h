...
class AwsSageMakerNotebookInstanceDetails {
 public:
  ...
  AwsSageMakerNotebookInstanceDetails& AddAcceleratorTypes(AcceleratorTypesT&& value) {
    m_acceleratorTypesHasBeenSet = true;
    m_acceleratorTypes.emplace_back(std::forward<AcceleratorTypesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDirectInternetAccess(DirectInternetAccessT&& value) {
    m_directInternetAccessHasBeenSet = true;
    m_directInternetAccess = std::forward<DirectInternetAccessT>(value);
  }
  template <typename DirectInternetAccessT = Aws::String>
  AwsSageMakerNotebookInstanceDetails& WithDirectInternetAccess(DirectInternetAccessT&& value) {
    SetDirectInternetAccess(std::forward<DirectInternetAccessT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const AwsSageMakerNotebookInstanceMetadataServiceConfigurationDetails& GetInstanceMetadataServiceConfiguration() const {
  ...
  void SetNotebookInstanceArn(NotebookInstanceArnT&& value) {
    ...
    m_notebookInstanceArn = std::forward<NotebookInstanceArnT>(value);
  }
  template <typename NotebookInstanceArnT = Aws::String>
  AwsSageMakerNotebookInstanceDetails& WithNotebookInstanceArn(NotebookInstanceArnT&& value) {
    SetNotebookInstanceArn(std::forward<NotebookInstanceArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNotebookInstanceLifecycleConfigName(NotebookInstanceLifecycleConfigNameT&& value) {
    ...
    m_notebookInstanceLifecycleConfigName = std::forward<NotebookInstanceLifecycleConfigNameT>(value);
  }
  template <typename NotebookInstanceLifecycleConfigNameT = Aws::String>
  AwsSageMakerNotebookInstanceDetails& WithNotebookInstanceLifecycleConfigName(NotebookInstanceLifecycleConfigNameT&& value) {
    SetNotebookInstanceLifecycleConfigName(std::forward<NotebookInstanceLifecycleConfigNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNotebookInstanceStatus(NotebookInstanceStatusT&& value) {
    m_notebookInstanceStatusHasBeenSet = true;
    m_notebookInstanceStatus = std::forward<NotebookInstanceStatusT>(value);
  }
  template <typename NotebookInstanceStatusT = Aws::String>
  AwsSageMakerNotebookInstanceDetails& WithNotebookInstanceStatus(NotebookInstanceStatusT&& value) {
    SetNotebookInstanceStatus(std::forward<NotebookInstanceStatusT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRootAccess(RootAccessT&& value) {
    m_rootAccessHasBeenSet = true;
    m_rootAccess = std::forward<RootAccessT>(value);
  }
  template <typename RootAccessT = Aws::String>
  AwsSageMakerNotebookInstanceDetails& WithRootAccess(RootAccessT&& value) {
    SetRootAccess(std::forward<RootAccessT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename UrlT = Aws::String>
  AwsSageMakerNotebookInstanceDetails& WithUrl(UrlT&& value) {
  ...
  inline AwsSageMakerNotebookInstanceDetails& WithVolumeSizeInGB(int value) {
