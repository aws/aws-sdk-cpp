...
class AwsEcsTaskDefinitionContainerDefinitionsLinuxParametersCapabilitiesDetails {
 public:
  ...
  AWS_SECURITYHUB_API AwsEcsTaskDefinitionContainerDefinitionsLinuxParametersCapabilitiesDetails& operator=(
  ...
  template <typename AddT = Aws::Vector<Aws::String>>
  AwsEcsTaskDefinitionContainerDefinitionsLinuxParametersCapabilitiesDetails& WithAdd(AddT&& value) {
    SetAdd(std::forward<AddT>(value));
    return *this;
  }
  template <typename AddT = Aws::String>
  AwsEcsTaskDefinitionContainerDefinitionsLinuxParametersCapabilitiesDetails& AddAdd(AddT&& value) {
    m_addHasBeenSet = true;
  ...
  template <typename DropT = Aws::Vector<Aws::String>>
  AwsEcsTaskDefinitionContainerDefinitionsLinuxParametersCapabilitiesDetails& WithDrop(DropT&& value) {
    SetDrop(std::forward<DropT>(value));
    return *this;
  }
  template <typename DropT = Aws::String>
  AwsEcsTaskDefinitionContainerDefinitionsLinuxParametersCapabilitiesDetails& AddDrop(DropT&& value) {
    m_dropHasBeenSet = true;
