...
class AwsEcsClusterConfigurationExecuteCommandConfigurationLogConfigurationDetails {
 public:
  ...
  AWS_SECURITYHUB_API AwsEcsClusterConfigurationExecuteCommandConfigurationLogConfigurationDetails& operator=(
  ...
  inline void SetCloudWatchEncryptionEnabled(bool value) {
    m_cloudWatchEncryptionEnabledHasBeenSet = true;
    m_cloudWatchEncryptionEnabled = value;
  }
  inline AwsEcsClusterConfigurationExecuteCommandConfigurationLogConfigurationDetails& WithCloudWatchEncryptionEnabled(bool value) {
    SetCloudWatchEncryptionEnabled(value);
    return *this;
  }
  ///@}
  ...
  template <typename CloudWatchLogGroupNameT = Aws::String>
  AwsEcsClusterConfigurationExecuteCommandConfigurationLogConfigurationDetails& WithCloudWatchLogGroupName(
      CloudWatchLogGroupNameT&& value) {
  ...
  template <typename S3BucketNameT = Aws::String>
  AwsEcsClusterConfigurationExecuteCommandConfigurationLogConfigurationDetails& WithS3BucketName(S3BucketNameT&& value) {
  ...
  inline void SetS3EncryptionEnabled(bool value) {
    m_s3EncryptionEnabledHasBeenSet = true;
    m_s3EncryptionEnabled = value;
  }
  inline AwsEcsClusterConfigurationExecuteCommandConfigurationLogConfigurationDetails& WithS3EncryptionEnabled(bool value) {
    SetS3EncryptionEnabled(value);
    return *this;
  }
  ///@}
  ...
  template <typename S3KeyPrefixT = Aws::String>
  AwsEcsClusterConfigurationExecuteCommandConfigurationLogConfigurationDetails& WithS3KeyPrefix(S3KeyPrefixT&& value) {
