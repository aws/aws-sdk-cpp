...
class UpdateConnectorResult {
 public:
  AWS_SECURITYHUB_API UpdateConnectorResult() = default;
  AWS_SECURITYHUB_API UpdateConnectorResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_SECURITYHUB_API UpdateConnectorResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  inline UpdateConnectorResult& WithConnectorStatus(CspmConnectorStatus value) {
  ...
  inline UpdateConnectorResult& WithEnablementStatus(CspmEnablementStatus value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateConnectorResult& WithRequestId(RequestIdT&& value) {
