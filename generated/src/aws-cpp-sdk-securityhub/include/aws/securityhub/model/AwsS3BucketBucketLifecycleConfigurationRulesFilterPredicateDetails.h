...
class AwsS3BucketBucketLifecycleConfigurationRulesFilterPredicateDetails {
 public:
   ...
   */
  inline const Aws::Vector<AwsS3BucketBucketLifecycleConfigurationRulesFilterPredicateOperandsDetails>& GetOperands() const {
    return m_operands;
  }
  ...
  template <typename OperandsT = Aws::Vector<AwsS3BucketBucketLifecycleConfigurationRulesFilterPredicateOperandsDetails>>
  AwsS3BucketBucketLifecycleConfigurationRulesFilterPredicateDetails& WithOperands(OperandsT&& value) {
  ...
  AwsS3BucketBucketLifecycleConfigurationRulesFilterPredicateDetails& AddOperands(OperandsT&& value) {
    m_operandsHasBeenSet = true;
  ...
  template <typename PrefixT = Aws::String>
  AwsS3BucketBucketLifecycleConfigurationRulesFilterPredicateDetails& WithPrefix(PrefixT&& value) {
  ...
  template <typename TagT = AwsS3BucketBucketLifecycleConfigurationRulesFilterPredicateTagDetails>
  AwsS3BucketBucketLifecycleConfigurationRulesFilterPredicateDetails& WithTag(TagT&& value) {
  ...
  template <typename TypeT = Aws::String>
  AwsS3BucketBucketLifecycleConfigurationRulesFilterPredicateDetails& WithType(TypeT&& value) {
