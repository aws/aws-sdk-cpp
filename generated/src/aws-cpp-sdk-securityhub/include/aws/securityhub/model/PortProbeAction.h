...
class PortProbeAction {
 public:
  ...
  void SetPortProbeDetails(PortProbeDetailsT&& value) {
    ...
    m_portProbeDetails = std::forward<PortProbeDetailsT>(value);
  }
  template <typename PortProbeDetailsT = Aws::Vector<PortProbeDetail>>
  PortProbeAction& WithPortProbeDetails(PortProbeDetailsT&& value) {
    SetPortProbeDetails(std::forward<PortProbeDetailsT>(value));
    return *this;
  }
  template <typename PortProbeDetailsT = PortProbeDetail>
  PortProbeAction& AddPortProbeDetails(PortProbeDetailsT&& value) {
    m_portProbeDetailsHasBeenSet = true;
    m_portProbeDetails.emplace_back(std::forward<PortProbeDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  inline PortProbeAction& WithBlocked(bool value) {
    SetBlocked(value);
    return *this;
  }
  ///@}
