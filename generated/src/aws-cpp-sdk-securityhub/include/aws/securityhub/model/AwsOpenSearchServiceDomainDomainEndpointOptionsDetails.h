...
class AwsOpenSearchServiceDomainDomainEndpointOptionsDetails {
 public:
  ...
  template <typename CustomEndpointCertificateArnT = Aws::String>
  AwsOpenSearchServiceDomainDomainEndpointOptionsDetails& WithCustomEndpointCertificateArn(CustomEndpointCertificateArnT&& value) {
  ...
  inline AwsOpenSearchServiceDomainDomainEndpointOptionsDetails& WithCustomEndpointEnabled(bool value) {
  ...
  inline AwsOpenSearchServiceDomainDomainEndpointOptionsDetails& WithEnforceHTTPS(bool value) {
  ...
  template <typename CustomEndpointT = Aws::String>
  AwsOpenSearchServiceDomainDomainEndpointOptionsDetails& WithCustomEndpoint(CustomEndpointT&& value) {
  ...
  void SetTLSSecurityPolicy(TLSSecurityPolicyT&& value) {
    m_tLSSecurityPolicyHasBeenSet = true;
    m_tLSSecurityPolicy = std::forward<TLSSecurityPolicyT>(value);
  }
  template <typename TLSSecurityPolicyT = Aws::String>
  AwsOpenSearchServiceDomainDomainEndpointOptionsDetails& WithTLSSecurityPolicy(TLSSecurityPolicyT&& value) {
    SetTLSSecurityPolicy(std::forward<TLSSecurityPolicyT>(value));
    return *this;
  }
  ///@}
 private:
