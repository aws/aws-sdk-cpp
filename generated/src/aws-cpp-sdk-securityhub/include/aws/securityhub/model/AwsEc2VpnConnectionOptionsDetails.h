...
class AwsEc2VpnConnectionOptionsDetails {
 public:
  ...
  inline AwsEc2VpnConnectionOptionsDetails& WithStaticRoutesOnly(bool value) {
  ...
  template <typename TunnelOptionsT = Aws::Vector<AwsEc2VpnConnectionOptionsTunnelOptionsDetails>>
  AwsEc2VpnConnectionOptionsDetails& WithTunnelOptions(TunnelOptionsT&& value) {
  ...
  AwsEc2VpnConnectionOptionsDetails& AddTunnelOptions(TunnelOptionsT&& value) {
    m_tunnelOptionsHasBeenSet = true;
