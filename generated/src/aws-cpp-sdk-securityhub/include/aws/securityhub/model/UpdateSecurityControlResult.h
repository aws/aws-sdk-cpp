...
namespace Model
{
  ...
  {
  public:
    AWS_SECURITYHUB_API UpdateSecurityControlResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateSecurityControlResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
