...
class AwsEcsServiceDeploymentConfigurationDetails {
 public:
   ...
   * steady state.</p>
   */
  inline const AwsEcsServiceDeploymentConfigurationDeploymentCircuitBreakerDetails& GetDeploymentCircuitBreaker() const {
    return m_deploymentCircuitBreaker;
  }
  ...
  inline AwsEcsServiceDeploymentConfigurationDetails& WithMaximumPercent(int value) {
  ...
  inline AwsEcsServiceDeploymentConfigurationDetails& WithMinimumHealthyPercent(int value) {
