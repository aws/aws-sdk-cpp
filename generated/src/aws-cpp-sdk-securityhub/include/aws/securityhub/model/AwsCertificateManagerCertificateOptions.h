...
class AwsCertificateManagerCertificateOptions {
 public:
  ...
  void SetCertificateTransparencyLoggingPreference(CertificateTransparencyLoggingPreferenceT&& value) {
    m_certificateTransparencyLoggingPreferenceHasBeenSet = true;
    m_certificateTransparencyLoggingPreference = std::forward<CertificateTransparencyLoggingPreferenceT>(value);
  }
  template <typename CertificateTransparencyLoggingPreferenceT = Aws::String>
  AwsCertificateManagerCertificateOptions& WithCertificateTransparencyLoggingPreference(CertificateTransparencyLoggingPreferenceT&& value) {
    SetCertificateTransparencyLoggingPreference(std::forward<CertificateTransparencyLoggingPreferenceT>(value));
    return *this;
  }
  ///@}
 private:
