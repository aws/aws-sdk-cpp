...
class RuleGroupSourceStatefulRulesHeaderDetails {
 public:
  ...
  template <typename DestinationT = Aws::String>
  RuleGroupSourceStatefulRulesHeaderDetails& WithDestination(DestinationT&& value) {
  ...
  template <typename DestinationPortT = Aws::String>
  RuleGroupSourceStatefulRulesHeaderDetails& WithDestinationPort(DestinationPortT&& value) {
  ...
  template <typename DirectionT = Aws::String>
  RuleGroupSourceStatefulRulesHeaderDetails& WithDirection(DirectionT&& value) {
  ...
  template <typename ProtocolT = Aws::String>
  RuleGroupSourceStatefulRulesHeaderDetails& WithProtocol(ProtocolT&& value) {
  ...
  template <typename SourceT = Aws::String>
  RuleGroupSourceStatefulRulesHeaderDetails& WithSource(SourceT&& value) {
  ...
  template <typename SourcePortT = Aws::String>
  RuleGroupSourceStatefulRulesHeaderDetails& WithSourcePort(SourcePortT&& value) {
