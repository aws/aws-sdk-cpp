...
class EnumListConfigurationOptions {
 public:
  ...
  template <typename DefaultValueT = Aws::Vector<Aws::String>>
  EnumListConfigurationOptions& WithDefaultValue(DefaultValueT&& value) {
    SetDefaultValue(std::forward<DefaultValueT>(value));
    return *this;
  }
  template <typename DefaultValueT = Aws::String>
  EnumListConfigurationOptions& AddDefaultValue(DefaultValueT&& value) {
    m_defaultValueHasBeenSet = true;
  ...
  inline EnumListConfigurationOptions& WithMaxItems(int value) {
    SetMaxItems(value);
    return *this;
  }
  ///@}
  ...
  template <typename AllowedValuesT = Aws::Vector<Aws::String>>
  EnumListConfigurationOptions& WithAllowedValues(AllowedValuesT&& value) {
    SetAllowedValues(std::forward<AllowedValuesT>(value));
    return *this;
  }
  template <typename AllowedValuesT = Aws::String>
  EnumListConfigurationOptions& AddAllowedValues(AllowedValuesT&& value) {
    m_allowedValuesHasBeenSet = true;
