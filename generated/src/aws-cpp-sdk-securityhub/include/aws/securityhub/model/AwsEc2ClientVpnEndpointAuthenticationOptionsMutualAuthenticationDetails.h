...
class AwsEc2ClientVpnEndpointAuthenticationOptionsMutualAuthenticationDetails {
 public:
  ...
  AWS_SECURITYHUB_API AwsEc2ClientVpnEndpointAuthenticationOptionsMutualAuthenticationDetails& operator=(
  ...
  void SetClientRootCertificateChain(ClientRootCertificateChainT&& value) {
    m_clientRootCertificateChainHasBeenSet = true;
    m_clientRootCertificateChain = std::forward<ClientRootCertificateChainT>(value);
  }
  template <typename ClientRootCertificateChainT = Aws::String>
  AwsEc2ClientVpnEndpointAuthenticationOptionsMutualAuthenticationDetails& WithClientRootCertificateChain(
      ClientRootCertificateChainT&& value) {
    SetClientRootCertificateChain(std::forward<ClientRootCertificateChainT>(value));
    return *this;
  }
  ///@}
 private:
