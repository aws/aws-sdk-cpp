...
class BatchDeleteAutomationRulesRequest : public SecurityHubRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "BatchDeleteAutomationRules"; }
  ...
  void SetAutomationRulesArns(AutomationRulesArnsT&& value) {
    m_automationRulesArnsHasBeenSet = true;
    m_automationRulesArns = std::forward<AutomationRulesArnsT>(value);
  }
  template <typename AutomationRulesArnsT = Aws::Vector<Aws::String>>
  BatchDeleteAutomationRulesRequest& WithAutomationRulesArns(AutomationRulesArnsT&& value) {
    SetAutomationRulesArns(std::forward<AutomationRulesArnsT>(value));
    return *this;
  }
  template <typename AutomationRulesArnsT = Aws::String>
  BatchDeleteAutomationRulesRequest& AddAutomationRulesArns(AutomationRulesArnsT&& value) {
    m_automationRulesArnsHasBeenSet = true;
    m_automationRulesArns.emplace_back(std::forward<AutomationRulesArnsT>(value));
    return *this;
  }
  ///@}
 private:
