...
class AssociationSetDetails {
 public:
  ...
  inline AssociationSetDetails& WithMain(bool value) {
    SetMain(value);
    return *this;
  }
  ///@}
  ...
  void SetRouteTableAssociationId(RouteTableAssociationIdT&& value) {
    ...
    m_routeTableAssociationId = std::forward<RouteTableAssociationIdT>(value);
  }
  template <typename RouteTableAssociationIdT = Aws::String>
  AssociationSetDetails& WithRouteTableAssociationId(RouteTableAssociationIdT&& value) {
    SetRouteTableAssociationId(std::forward<RouteTableAssociationIdT>(value));
    return *this;
  }
  ///@}
