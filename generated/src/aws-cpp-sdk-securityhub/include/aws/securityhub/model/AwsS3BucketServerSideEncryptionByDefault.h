...
class AwsS3BucketServerSideEncryptionByDefault {
 public:
  ...
  template <typename SSEAlgorithmT = Aws::String>
  AwsS3BucketServerSideEncryptionByDefault& WithSSEAlgorithm(SSEAlgorithmT&& value) {
  ...
  template <typename KMSMasterKeyIDT = Aws::String>
  AwsS3BucketServerSideEncryptionByDefault& WithKMSMasterKeyID(KMSMasterKeyIDT&& value) {
