...
class AwsWafRegionalWebAclDetails {
 public:
  ...
  void SetRulesList(RulesListT&& value) {
    m_rulesListHasBeenSet = true;
    m_rulesList = std::forward<RulesListT>(value);
  }
  template <typename RulesListT = Aws::Vector<AwsWafRegionalWebAclRulesListDetails>>
  AwsWafRegionalWebAclDetails& WithRulesList(RulesListT&& value) {
    SetRulesList(std::forward<RulesListT>(value));
    return *this;
  }
  ...
  AwsWafRegionalWebAclDetails& AddRulesList(RulesListT&& value) {
    m_rulesListHasBeenSet = true;
    m_rulesList.emplace_back(std::forward<RulesListT>(value));
    return *this;
  }
  ///@}
