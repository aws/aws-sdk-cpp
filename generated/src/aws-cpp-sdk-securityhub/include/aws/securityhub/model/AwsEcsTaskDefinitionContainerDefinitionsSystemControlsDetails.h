...
class AwsEcsTaskDefinitionContainerDefinitionsSystemControlsDetails {
 public:
  AWS_SECURITYHUB_API AwsEcsTaskDefinitionContainerDefinitionsSystemControlsDetails() = default;
  ...
  template <typename NamespaceT = Aws::String>
  AwsEcsTaskDefinitionContainerDefinitionsSystemControlsDetails& WithNamespace(NamespaceT&& value) {
  ...
  template <typename ValueT = Aws::String>
  AwsEcsTaskDefinitionContainerDefinitionsSystemControlsDetails& WithValue(ValueT&& value) {
