...
class AutomationRulesFindingFieldsUpdateV2 {
 public:
  ...
  inline void SetSeverityId(int value) {
    m_severityIdHasBeenSet = true;
    m_severityId = value;
  }
  inline AutomationRulesFindingFieldsUpdateV2& WithSeverityId(int value) {
    SetSeverityId(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatusId(int value) {
    m_statusIdHasBeenSet = true;
    m_statusId = value;
  }
  inline AutomationRulesFindingFieldsUpdateV2& WithStatusId(int value) {
    SetStatusId(value);
    return *this;
  }
  ///@}
