...
class AwsElbLoadBalancerListenerDescription {
 public:
  ...
  template <typename ListenerT = AwsElbLoadBalancerListener>
  AwsElbLoadBalancerListenerDescription& WithListener(ListenerT&& value) {
  ...
  template <typename PolicyNamesT = Aws::Vector<Aws::String>>
  AwsElbLoadBalancerListenerDescription& WithPolicyNames(PolicyNamesT&& value) {
    SetPolicyNames(std::forward<PolicyNamesT>(value));
    return *this;
  }
  template <typename PolicyNamesT = Aws::String>
  AwsElbLoadBalancerListenerDescription& AddPolicyNames(PolicyNamesT&& value) {
    m_policyNamesHasBeenSet = true;
