...
class SecurityControlDefinition {
 public:
  ...
  void SetRemediationUrl(RemediationUrlT&& value) {
    ...
    m_remediationUrl = std::forward<RemediationUrlT>(value);
  }
  template <typename RemediationUrlT = Aws::String>
  SecurityControlDefinition& WithRemediationUrl(RemediationUrlT&& value) {
    SetRemediationUrl(std::forward<RemediationUrlT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetSeverityRating(SeverityRating value) {
    m_severityRatingHasBeenSet = true;
    m_severityRating = value;
  }
  inline SecurityControlDefinition& WithSeverityRating(SeverityRating value) {
  ...
  inline void SetCurrentRegionAvailability(RegionAvailabilityStatus value) {
    m_currentRegionAvailabilityHasBeenSet = true;
    m_currentRegionAvailability = value;
  }
  inline SecurityControlDefinition& WithCurrentRegionAvailability(RegionAvailabilityStatus value) {
    SetCurrentRegionAvailability(value);
    return *this;
  }
  ///@}
  ...
  void SetCustomizableProperties(CustomizablePropertiesT&& value) {
    ...
    m_customizableProperties = std::forward<CustomizablePropertiesT>(value);
  }
  template <typename CustomizablePropertiesT = Aws::Vector<SecurityControlProperty>>
  SecurityControlDefinition& WithCustomizableProperties(CustomizablePropertiesT&& value) {
    SetCustomizableProperties(std::forward<CustomizablePropertiesT>(value));
    return *this;
  }
  inline SecurityControlDefinition& AddCustomizableProperties(SecurityControlProperty value) {
    m_customizablePropertiesHasBeenSet = true;
    m_customizableProperties.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetParameterDefinitions(ParameterDefinitionsT&& value) {
    ...
    m_parameterDefinitions = std::forward<ParameterDefinitionsT>(value);
  }
  template <typename ParameterDefinitionsT = Aws::Map<Aws::String, ParameterDefinition>>
  SecurityControlDefinition& WithParameterDefinitions(ParameterDefinitionsT&& value) {
    SetParameterDefinitions(std::forward<ParameterDefinitionsT>(value));
    return *this;
  }
  ...
  SecurityControlDefinition& AddParameterDefinitions(ParameterDefinitionsKeyT&& key, ParameterDefinitionsValueT&& value) {
    m_parameterDefinitionsHasBeenSet = true;
    m_parameterDefinitions.emplace(std::forward<ParameterDefinitionsKeyT>(key), std::forward<ParameterDefinitionsValueT>(value));
    return *this;
  }
  ///@}
 private:
