...
class AwsEc2LaunchTemplateDataMaintenanceOptionsDetails {
 public:
  ...
  void SetAutoRecovery(AutoRecoveryT&& value) {
    m_autoRecoveryHasBeenSet = true;
    m_autoRecovery = std::forward<AutoRecoveryT>(value);
  }
  template <typename AutoRecoveryT = Aws::String>
  AwsEc2LaunchTemplateDataMaintenanceOptionsDetails& WithAutoRecovery(AutoRecoveryT&& value) {
    SetAutoRecovery(std::forward<AutoRecoveryT>(value));
    return *this;
  }
  ///@}
 private:
