...
class GetFindingStatisticsV2Result {
 public:
  ...
  template <typename GroupByResultsT = Aws::Vector<GroupByResult>>
  GetFindingStatisticsV2Result& WithGroupByResults(GroupByResultsT&& value) {
    SetGroupByResults(std::forward<GroupByResultsT>(value));
    return *this;
  }
  template <typename GroupByResultsT = GroupByResult>
  GetFindingStatisticsV2Result& AddGroupByResults(GroupByResultsT&& value) {
    m_groupByResultsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetFindingStatisticsV2Result& WithRequestId(RequestIdT&& value) {
