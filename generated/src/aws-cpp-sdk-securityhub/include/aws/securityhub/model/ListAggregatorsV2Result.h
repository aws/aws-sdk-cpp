...
class ListAggregatorsV2Result {
 public:
  ...
  void SetAggregatorsV2(AggregatorsV2T&& value) {
    m_aggregatorsV2HasBeenSet = true;
    m_aggregatorsV2 = std::forward<AggregatorsV2T>(value);
  }
  template <typename AggregatorsV2T = Aws::Vector<AggregatorV2>>
  ListAggregatorsV2Result& WithAggregatorsV2(AggregatorsV2T&& value) {
    SetAggregatorsV2(std::forward<AggregatorsV2T>(value));
    return *this;
  }
  template <typename AggregatorsV2T = AggregatorV2>
  ListAggregatorsV2Result& AddAggregatorsV2(AggregatorsV2T&& value) {
    m_aggregatorsV2HasBeenSet = true;
    m_aggregatorsV2.emplace_back(std::forward<AggregatorsV2T>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAggregatorsV2Result& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAggregatorsV2Result& WithRequestId(RequestIdT&& value) {
