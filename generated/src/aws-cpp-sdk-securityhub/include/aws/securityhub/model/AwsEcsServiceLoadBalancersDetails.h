...
class AwsEcsServiceLoadBalancersDetails {
 public:
  ...
  template <typename ContainerNameT = Aws::String>
  AwsEcsServiceLoadBalancersDetails& WithContainerName(ContainerNameT&& value) {
  ...
  inline AwsEcsServiceLoadBalancersDetails& WithContainerPort(int value) {
  ...
  template <typename LoadBalancerNameT = Aws::String>
  AwsEcsServiceLoadBalancersDetails& WithLoadBalancerName(LoadBalancerNameT&& value) {
  ...
  template <typename TargetGroupArnT = Aws::String>
  AwsEcsServiceLoadBalancersDetails& WithTargetGroupArn(TargetGroupArnT&& value) {
