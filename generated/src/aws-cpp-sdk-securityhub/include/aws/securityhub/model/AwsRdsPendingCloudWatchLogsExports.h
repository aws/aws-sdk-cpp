...
class AwsRdsPendingCloudWatchLogsExports {
 public:
  ...
  template <typename LogTypesToEnableT = Aws::Vector<Aws::String>>
  AwsRdsPendingCloudWatchLogsExports& WithLogTypesToEnable(LogTypesToEnableT&& value) {
    SetLogTypesToEnable(std::forward<LogTypesToEnableT>(value));
    return *this;
  }
  template <typename LogTypesToEnableT = Aws::String>
  AwsRdsPendingCloudWatchLogsExports& AddLogTypesToEnable(LogTypesToEnableT&& value) {
    m_logTypesToEnableHasBeenSet = true;
  ...
  template <typename LogTypesToDisableT = Aws::Vector<Aws::String>>
  AwsRdsPendingCloudWatchLogsExports& WithLogTypesToDisable(LogTypesToDisableT&& value) {
    SetLogTypesToDisable(std::forward<LogTypesToDisableT>(value));
    return *this;
  }
  template <typename LogTypesToDisableT = Aws::String>
  AwsRdsPendingCloudWatchLogsExports& AddLogTypesToDisable(LogTypesToDisableT&& value) {
    m_logTypesToDisableHasBeenSet = true;
