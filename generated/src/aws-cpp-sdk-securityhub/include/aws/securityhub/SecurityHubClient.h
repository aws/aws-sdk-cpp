...
namespace SecurityHub
{
   ...
   */
  class AWS_SECURITYHUB_API SecurityHubClient : Aws::Client::ClientWithAsyncTemplateMethods<SecurityHubClient>,
    smithy::client::AwsSmithyClientT<Aws::SecurityHub::SERVICE_NAME,
