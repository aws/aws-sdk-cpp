...
class PutObjectRequest : public StreamingMediaStoreDataRequest {
 public:
  ...
  inline void SetUploadAvailability(UploadAvailability value) {
    m_uploadAvailabilityHasBeenSet = true;
    m_uploadAvailability = value;
  }
  inline PutObjectRequest& WithUploadAvailability(UploadAvailability value) {
    SetUploadAvailability(value);
    return *this;
  }
  ///@}
 private:
