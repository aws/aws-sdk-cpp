...
class AWS_MEDIASTOREDATA_API MediaStoreDataClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  MediaStoreDataClient(const Aws::MediaStoreData::MediaStoreDataClientConfiguration& clientConfiguration =
  ...
  MediaStoreDataClient(const Aws::Auth::AWSCredentials& credentials,
                       std::shared_ptr<MediaStoreDataEndpointProviderBase> endpointProvider = nullptr,
                       const Aws::MediaStoreData::MediaStoreDataClientConfiguration& clientConfiguration =
                           Aws::MediaStoreData::MediaStoreDataClientConfiguration());
  ...
  /**
   * An Async wrapper for DescribeObject that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeObjectRequestT = Model::DescribeObjectRequest>
  void DescribeObjectAsync(const DescribeObjectRequestT& request, const DescribeObjectResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename GetObjectRequestT = Model::GetObjectRequest>
  void GetObjectAsync(const GetObjectRequestT& request, const GetObjectResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListItems that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListItemsRequestT = Model::ListItemsRequest>
  void ListItemsAsync(const ListItemsResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                      const ListItemsRequestT& request = {}) const {
   ...
   */
  template <typename PutObjectRequestT = Model::PutObjectRequest>
  void PutObjectAsync(const PutObjectRequestT& request, const PutObjectResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
