...
namespace MediaStoreData
{
   ...
   */
  class AWS_MEDIASTOREDATA_API MediaStoreDataClient : Aws::Client::ClientWithAsyncTemplateMethods<MediaStoreDataClient>,
    smithy::client::AwsSmithyClientT<Aws::MediaStoreData::SERVICE_NAME,
