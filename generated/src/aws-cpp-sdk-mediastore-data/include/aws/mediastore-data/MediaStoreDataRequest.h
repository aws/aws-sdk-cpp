...
{
  class AWS_MEDIASTOREDATA_API MediaStoreDataRequest : public Aws::AmazonSerializableWebServiceRequest
  {
  public:
  ...
  typedef Aws::AmazonStreamingWebServiceRequest StreamingMediaStoreDataRequest;
