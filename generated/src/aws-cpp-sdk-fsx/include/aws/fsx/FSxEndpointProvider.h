 ...
 */
using FSxEndpointProviderBase = EndpointProviderBase<FSxClientConfiguration, FSxBuiltInParameters, FSxClientContextParameters>;

using FSxDefaultEpProviderBase = DefaultEndpointProvider<FSxClientConfiguration, FSxBuiltInParameters, FSxClientContextParameters>;
