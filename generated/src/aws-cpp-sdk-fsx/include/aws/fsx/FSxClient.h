...
class AWS_FSX_API FSxClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  FSxClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<FSxEndpointProviderBase> endpointProvider = nullptr,
   ...
   * API Reference</a></p>
   */
  virtual Model::AssociateFileSystemAliasesOutcome AssociateFileSystemAliases(
      const Model::AssociateFileSystemAliasesRequest& request) const;

  /**
   * A Callable wrapper for AssociateFileSystemAliases that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AssociateFileSystemAliasesRequestT = Model::AssociateFileSystemAliasesRequest>
  Model::AssociateFileSystemAliasesOutcomeCallable AssociateFileSystemAliasesCallable(
      const AssociateFileSystemAliasesRequestT& request) const {
    return SubmitCallable(&FSxClient::AssociateFileSystemAliases, request);
  }

  /**
   * An Async wrapper for AssociateFileSystemAliases that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateFileSystemAliasesRequestT = Model::AssociateFileSystemAliasesRequest>
  void AssociateFileSystemAliasesAsync(const AssociateFileSystemAliasesRequestT& request,
                                       const AssociateFileSystemAliasesResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for CancelDataRepositoryTask that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CancelDataRepositoryTask that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CancelDataRepositoryTaskRequestT = Model::CancelDataRepositoryTaskRequest>
  void CancelDataRepositoryTaskAsync(const CancelDataRepositoryTaskRequestT& request,
                                     const CancelDataRepositoryTaskResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CopyBackup that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CopyBackupRequestT = Model::CopyBackupRequest>
  void CopyBackupAsync(const CopyBackupRequestT& request, const CopyBackupResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CopySnapshotAndUpdateVolumeOutcome CopySnapshotAndUpdateVolume(
      const Model::CopySnapshotAndUpdateVolumeRequest& request) const;

  /**
   * A Callable wrapper for CopySnapshotAndUpdateVolume that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CopySnapshotAndUpdateVolumeRequestT = Model::CopySnapshotAndUpdateVolumeRequest>
  Model::CopySnapshotAndUpdateVolumeOutcomeCallable CopySnapshotAndUpdateVolumeCallable(
      const CopySnapshotAndUpdateVolumeRequestT& request) const {
    return SubmitCallable(&FSxClient::CopySnapshotAndUpdateVolume, request);
  }

  /**
   * An Async wrapper for CopySnapshotAndUpdateVolume that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CopySnapshotAndUpdateVolumeRequestT = Model::CopySnapshotAndUpdateVolumeRequest>
  void CopySnapshotAndUpdateVolumeAsync(const CopySnapshotAndUpdateVolumeRequestT& request,
                                        const CopySnapshotAndUpdateVolumeResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateAndAttachS3AccessPointOutcome CreateAndAttachS3AccessPoint(
      const Model::CreateAndAttachS3AccessPointRequest& request) const;

  /**
   * A Callable wrapper for CreateAndAttachS3AccessPoint that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateAndAttachS3AccessPointRequestT = Model::CreateAndAttachS3AccessPointRequest>
  Model::CreateAndAttachS3AccessPointOutcomeCallable CreateAndAttachS3AccessPointCallable(
      const CreateAndAttachS3AccessPointRequestT& request) const {
    return SubmitCallable(&FSxClient::CreateAndAttachS3AccessPoint, request);
  }

  /**
   * An Async wrapper for CreateAndAttachS3AccessPoint that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateAndAttachS3AccessPointRequestT = Model::CreateAndAttachS3AccessPointRequest>
  void CreateAndAttachS3AccessPointAsync(const CreateAndAttachS3AccessPointRequestT& request,
                                         const CreateAndAttachS3AccessPointResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateBackup that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateBackupRequestT = Model::CreateBackupRequest>
  void CreateBackupAsync(const CreateBackupResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                         const CreateBackupRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateDataRepositoryAssociationOutcome CreateDataRepositoryAssociation(
      const Model::CreateDataRepositoryAssociationRequest& request) const;

  /**
   * A Callable wrapper for CreateDataRepositoryAssociation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateDataRepositoryAssociationRequestT = Model::CreateDataRepositoryAssociationRequest>
  Model::CreateDataRepositoryAssociationOutcomeCallable CreateDataRepositoryAssociationCallable(
      const CreateDataRepositoryAssociationRequestT& request) const {
    return SubmitCallable(&FSxClient::CreateDataRepositoryAssociation, request);
  }

  /**
   * An Async wrapper for CreateDataRepositoryAssociation that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateDataRepositoryAssociationRequestT = Model::CreateDataRepositoryAssociationRequest>
  void CreateDataRepositoryAssociationAsync(const CreateDataRepositoryAssociationRequestT& request,
                                            const CreateDataRepositoryAssociationResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateDataRepositoryTask that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateDataRepositoryTask that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateDataRepositoryTaskRequestT = Model::CreateDataRepositoryTaskRequest>
  void CreateDataRepositoryTaskAsync(const CreateDataRepositoryTaskRequestT& request,
                                     const CreateDataRepositoryTaskResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateFileCache that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateFileCacheRequestT = Model::CreateFileCacheRequest>
  void CreateFileCacheAsync(const CreateFileCacheRequestT& request, const CreateFileCacheResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateFileSystemFromBackupOutcome CreateFileSystemFromBackup(
      const Model::CreateFileSystemFromBackupRequest& request) const;

  /**
   * A Callable wrapper for CreateFileSystemFromBackup that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateFileSystemFromBackupRequestT = Model::CreateFileSystemFromBackupRequest>
  Model::CreateFileSystemFromBackupOutcomeCallable CreateFileSystemFromBackupCallable(
      const CreateFileSystemFromBackupRequestT& request) const {
    return SubmitCallable(&FSxClient::CreateFileSystemFromBackup, request);
  }

  /**
   * An Async wrapper for CreateFileSystemFromBackup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateFileSystemFromBackupRequestT = Model::CreateFileSystemFromBackupRequest>
  void CreateFileSystemFromBackupAsync(const CreateFileSystemFromBackupRequestT& request,
                                       const CreateFileSystemFromBackupResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::CreateStorageVirtualMachineOutcome CreateStorageVirtualMachine(
      const Model::CreateStorageVirtualMachineRequest& request) const;

  /**
   * A Callable wrapper for CreateStorageVirtualMachine that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateStorageVirtualMachineRequestT = Model::CreateStorageVirtualMachineRequest>
  Model::CreateStorageVirtualMachineOutcomeCallable CreateStorageVirtualMachineCallable(
      const CreateStorageVirtualMachineRequestT& request) const {
    return SubmitCallable(&FSxClient::CreateStorageVirtualMachine, request);
  }

  /**
   * An Async wrapper for CreateStorageVirtualMachine that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateStorageVirtualMachineRequestT = Model::CreateStorageVirtualMachineRequest>
  void CreateStorageVirtualMachineAsync(const CreateStorageVirtualMachineRequestT& request,
                                        const CreateStorageVirtualMachineResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateVolume that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateVolumeRequestT = Model::CreateVolumeRequest>
  void CreateVolumeAsync(const CreateVolumeRequestT& request, const CreateVolumeResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateVolumeFromBackup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateVolumeFromBackup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateVolumeFromBackupRequestT = Model::CreateVolumeFromBackupRequest>
  void CreateVolumeFromBackupAsync(const CreateVolumeFromBackupRequestT& request,
                                   const CreateVolumeFromBackupResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteBackup that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteBackupRequestT = Model::DeleteBackupRequest>
  void DeleteBackupAsync(const DeleteBackupRequestT& request, const DeleteBackupResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteDataRepositoryAssociationOutcome DeleteDataRepositoryAssociation(
      const Model::DeleteDataRepositoryAssociationRequest& request) const;

  /**
   * A Callable wrapper for DeleteDataRepositoryAssociation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteDataRepositoryAssociationRequestT = Model::DeleteDataRepositoryAssociationRequest>
  Model::DeleteDataRepositoryAssociationOutcomeCallable DeleteDataRepositoryAssociationCallable(
      const DeleteDataRepositoryAssociationRequestT& request) const {
    return SubmitCallable(&FSxClient::DeleteDataRepositoryAssociation, request);
  }

  /**
   * An Async wrapper for DeleteDataRepositoryAssociation that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteDataRepositoryAssociationRequestT = Model::DeleteDataRepositoryAssociationRequest>
  void DeleteDataRepositoryAssociationAsync(const DeleteDataRepositoryAssociationRequestT& request,
                                            const DeleteDataRepositoryAssociationResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteFileCache that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteFileCacheRequestT = Model::DeleteFileCacheRequest>
  void DeleteFileCacheAsync(const DeleteFileCacheRequestT& request, const DeleteFileCacheResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteStorageVirtualMachineOutcome DeleteStorageVirtualMachine(
      const Model::DeleteStorageVirtualMachineRequest& request) const;

  /**
   * A Callable wrapper for DeleteStorageVirtualMachine that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteStorageVirtualMachineRequestT = Model::DeleteStorageVirtualMachineRequest>
  Model::DeleteStorageVirtualMachineOutcomeCallable DeleteStorageVirtualMachineCallable(
      const DeleteStorageVirtualMachineRequestT& request) const {
    return SubmitCallable(&FSxClient::DeleteStorageVirtualMachine, request);
  }

  /**
   * An Async wrapper for DeleteStorageVirtualMachine that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteStorageVirtualMachineRequestT = Model::DeleteStorageVirtualMachineRequest>
  void DeleteStorageVirtualMachineAsync(const DeleteStorageVirtualMachineRequestT& request,
                                        const DeleteStorageVirtualMachineResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeBackups that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeBackupsRequestT = Model::DescribeBackupsRequest>
  void DescribeBackupsAsync(const DescribeBackupsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const DescribeBackupsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeDataRepositoryAssociationsOutcome DescribeDataRepositoryAssociations(
      const Model::DescribeDataRepositoryAssociationsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeDataRepositoryAssociations that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeDataRepositoryAssociationsRequestT = Model::DescribeDataRepositoryAssociationsRequest>
  Model::DescribeDataRepositoryAssociationsOutcomeCallable DescribeDataRepositoryAssociationsCallable(
      const DescribeDataRepositoryAssociationsRequestT& request = {}) const {
    return SubmitCallable(&FSxClient::DescribeDataRepositoryAssociations, request);
  }

  /**
   * An Async wrapper for DescribeDataRepositoryAssociations that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeDataRepositoryAssociationsRequestT = Model::DescribeDataRepositoryAssociationsRequest>
  void DescribeDataRepositoryAssociationsAsync(const DescribeDataRepositoryAssociationsResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                               const DescribeDataRepositoryAssociationsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeDataRepositoryTasksOutcome DescribeDataRepositoryTasks(
      const Model::DescribeDataRepositoryTasksRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeDataRepositoryTasks that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeDataRepositoryTasksRequestT = Model::DescribeDataRepositoryTasksRequest>
  Model::DescribeDataRepositoryTasksOutcomeCallable DescribeDataRepositoryTasksCallable(
      const DescribeDataRepositoryTasksRequestT& request = {}) const {
    return SubmitCallable(&FSxClient::DescribeDataRepositoryTasks, request);
  }

  /**
   * An Async wrapper for DescribeDataRepositoryTasks that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeDataRepositoryTasksRequestT = Model::DescribeDataRepositoryTasksRequest>
  void DescribeDataRepositoryTasksAsync(const DescribeDataRepositoryTasksResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                        const DescribeDataRepositoryTasksRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeFileCaches that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeFileCaches that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeFileCachesRequestT = Model::DescribeFileCachesRequest>
  void DescribeFileCachesAsync(const DescribeFileCachesResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const DescribeFileCachesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeFileSystemAliases that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeFileSystemAliasesRequestT = Model::DescribeFileSystemAliasesRequest>
  Model::DescribeFileSystemAliasesOutcomeCallable DescribeFileSystemAliasesCallable(
      const DescribeFileSystemAliasesRequestT& request) const {
    return SubmitCallable(&FSxClient::DescribeFileSystemAliases, request);
  }

  /**
   * An Async wrapper for DescribeFileSystemAliases that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeFileSystemAliasesRequestT = Model::DescribeFileSystemAliasesRequest>
  void DescribeFileSystemAliasesAsync(const DescribeFileSystemAliasesRequestT& request,
                                      const DescribeFileSystemAliasesResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeS3AccessPointAttachmentsOutcome DescribeS3AccessPointAttachments(
      const Model::DescribeS3AccessPointAttachmentsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeS3AccessPointAttachments that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeS3AccessPointAttachmentsRequestT = Model::DescribeS3AccessPointAttachmentsRequest>
  Model::DescribeS3AccessPointAttachmentsOutcomeCallable DescribeS3AccessPointAttachmentsCallable(
      const DescribeS3AccessPointAttachmentsRequestT& request = {}) const {
    return SubmitCallable(&FSxClient::DescribeS3AccessPointAttachments, request);
  }

  /**
   * An Async wrapper for DescribeS3AccessPointAttachments that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeS3AccessPointAttachmentsRequestT = Model::DescribeS3AccessPointAttachmentsRequest>
  void DescribeS3AccessPointAttachmentsAsync(const DescribeS3AccessPointAttachmentsResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                             const DescribeS3AccessPointAttachmentsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeSharedVpcConfigurationOutcome DescribeSharedVpcConfiguration(
      const Model::DescribeSharedVpcConfigurationRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeSharedVpcConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeSharedVpcConfigurationRequestT = Model::DescribeSharedVpcConfigurationRequest>
  Model::DescribeSharedVpcConfigurationOutcomeCallable DescribeSharedVpcConfigurationCallable(
      const DescribeSharedVpcConfigurationRequestT& request = {}) const {
    return SubmitCallable(&FSxClient::DescribeSharedVpcConfiguration, request);
  }

  /**
   * An Async wrapper for DescribeSharedVpcConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeSharedVpcConfigurationRequestT = Model::DescribeSharedVpcConfigurationRequest>
  void DescribeSharedVpcConfigurationAsync(const DescribeSharedVpcConfigurationResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                           const DescribeSharedVpcConfigurationRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeStorageVirtualMachinesOutcome DescribeStorageVirtualMachines(
      const Model::DescribeStorageVirtualMachinesRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeStorageVirtualMachines that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeStorageVirtualMachinesRequestT = Model::DescribeStorageVirtualMachinesRequest>
  Model::DescribeStorageVirtualMachinesOutcomeCallable DescribeStorageVirtualMachinesCallable(
      const DescribeStorageVirtualMachinesRequestT& request = {}) const {
    return SubmitCallable(&FSxClient::DescribeStorageVirtualMachines, request);
  }

  /**
   * An Async wrapper for DescribeStorageVirtualMachines that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeStorageVirtualMachinesRequestT = Model::DescribeStorageVirtualMachinesRequest>
  void DescribeStorageVirtualMachinesAsync(const DescribeStorageVirtualMachinesResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                           const DescribeStorageVirtualMachinesRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for DescribeVolumes that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeVolumesRequestT = Model::DescribeVolumesRequest>
  void DescribeVolumesAsync(const DescribeVolumesResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const DescribeVolumesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DetachAndDeleteS3AccessPointOutcome DetachAndDeleteS3AccessPoint(
      const Model::DetachAndDeleteS3AccessPointRequest& request) const;

  /**
   * A Callable wrapper for DetachAndDeleteS3AccessPoint that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DetachAndDeleteS3AccessPointRequestT = Model::DetachAndDeleteS3AccessPointRequest>
  Model::DetachAndDeleteS3AccessPointOutcomeCallable DetachAndDeleteS3AccessPointCallable(
      const DetachAndDeleteS3AccessPointRequestT& request) const {
    return SubmitCallable(&FSxClient::DetachAndDeleteS3AccessPoint, request);
  }

  /**
   * An Async wrapper for DetachAndDeleteS3AccessPoint that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DetachAndDeleteS3AccessPointRequestT = Model::DetachAndDeleteS3AccessPointRequest>
  void DetachAndDeleteS3AccessPointAsync(const DetachAndDeleteS3AccessPointRequestT& request,
                                         const DetachAndDeleteS3AccessPointResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateFileSystemAliasesOutcome DisassociateFileSystemAliases(
      const Model::DisassociateFileSystemAliasesRequest& request) const;

  /**
   * A Callable wrapper for DisassociateFileSystemAliases that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DisassociateFileSystemAliasesRequestT = Model::DisassociateFileSystemAliasesRequest>
  Model::DisassociateFileSystemAliasesOutcomeCallable DisassociateFileSystemAliasesCallable(
      const DisassociateFileSystemAliasesRequestT& request) const {
    return SubmitCallable(&FSxClient::DisassociateFileSystemAliases, request);
  }

  /**
   * An Async wrapper for DisassociateFileSystemAliases that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateFileSystemAliasesRequestT = Model::DisassociateFileSystemAliasesRequest>
  void DisassociateFileSystemAliasesAsync(const DisassociateFileSystemAliasesRequestT& request,
                                          const DisassociateFileSystemAliasesResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ReleaseFileSystemNfsV3LocksOutcome ReleaseFileSystemNfsV3Locks(
      const Model::ReleaseFileSystemNfsV3LocksRequest& request) const;

  /**
   * A Callable wrapper for ReleaseFileSystemNfsV3Locks that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ReleaseFileSystemNfsV3LocksRequestT = Model::ReleaseFileSystemNfsV3LocksRequest>
  Model::ReleaseFileSystemNfsV3LocksOutcomeCallable ReleaseFileSystemNfsV3LocksCallable(
      const ReleaseFileSystemNfsV3LocksRequestT& request) const {
    return SubmitCallable(&FSxClient::ReleaseFileSystemNfsV3Locks, request);
  }

  /**
   * An Async wrapper for ReleaseFileSystemNfsV3Locks that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ReleaseFileSystemNfsV3LocksRequestT = Model::ReleaseFileSystemNfsV3LocksRequest>
  void ReleaseFileSystemNfsV3LocksAsync(const ReleaseFileSystemNfsV3LocksRequestT& request,
                                        const ReleaseFileSystemNfsV3LocksResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RestoreVolumeFromSnapshot that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename RestoreVolumeFromSnapshotRequestT = Model::RestoreVolumeFromSnapshotRequest>
  Model::RestoreVolumeFromSnapshotOutcomeCallable RestoreVolumeFromSnapshotCallable(
      const RestoreVolumeFromSnapshotRequestT& request) const {
    return SubmitCallable(&FSxClient::RestoreVolumeFromSnapshot, request);
  }

  /**
   * An Async wrapper for RestoreVolumeFromSnapshot that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RestoreVolumeFromSnapshotRequestT = Model::RestoreVolumeFromSnapshotRequest>
  void RestoreVolumeFromSnapshotAsync(const RestoreVolumeFromSnapshotRequestT& request,
                                      const RestoreVolumeFromSnapshotResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartMisconfiguredStateRecoveryOutcome StartMisconfiguredStateRecovery(
      const Model::StartMisconfiguredStateRecoveryRequest& request) const;

  /**
   * A Callable wrapper for StartMisconfiguredStateRecovery that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename StartMisconfiguredStateRecoveryRequestT = Model::StartMisconfiguredStateRecoveryRequest>
  Model::StartMisconfiguredStateRecoveryOutcomeCallable StartMisconfiguredStateRecoveryCallable(
      const StartMisconfiguredStateRecoveryRequestT& request) const {
    return SubmitCallable(&FSxClient::StartMisconfiguredStateRecovery, request);
  }

  /**
   * An Async wrapper for StartMisconfiguredStateRecovery that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename StartMisconfiguredStateRecoveryRequestT = Model::StartMisconfiguredStateRecoveryRequest>
  void StartMisconfiguredStateRecoveryAsync(const StartMisconfiguredStateRecoveryRequestT& request,
                                            const StartMisconfiguredStateRecoveryResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateDataRepositoryAssociationOutcome UpdateDataRepositoryAssociation(
      const Model::UpdateDataRepositoryAssociationRequest& request) const;

  /**
   * A Callable wrapper for UpdateDataRepositoryAssociation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateDataRepositoryAssociationRequestT = Model::UpdateDataRepositoryAssociationRequest>
  Model::UpdateDataRepositoryAssociationOutcomeCallable UpdateDataRepositoryAssociationCallable(
      const UpdateDataRepositoryAssociationRequestT& request) const {
    return SubmitCallable(&FSxClient::UpdateDataRepositoryAssociation, request);
  }

  /**
   * An Async wrapper for UpdateDataRepositoryAssociation that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateDataRepositoryAssociationRequestT = Model::UpdateDataRepositoryAssociationRequest>
  void UpdateDataRepositoryAssociationAsync(const UpdateDataRepositoryAssociationRequestT& request,
                                            const UpdateDataRepositoryAssociationResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateFileCache that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateFileCacheRequestT = Model::UpdateFileCacheRequest>
  void UpdateFileCacheAsync(const UpdateFileCacheRequestT& request, const UpdateFileCacheResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateSharedVpcConfigurationOutcome UpdateSharedVpcConfiguration(
      const Model::UpdateSharedVpcConfigurationRequest& request = {}) const;

  /**
   * A Callable wrapper for UpdateSharedVpcConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateSharedVpcConfigurationRequestT = Model::UpdateSharedVpcConfigurationRequest>
  Model::UpdateSharedVpcConfigurationOutcomeCallable UpdateSharedVpcConfigurationCallable(
      const UpdateSharedVpcConfigurationRequestT& request = {}) const {
    return SubmitCallable(&FSxClient::UpdateSharedVpcConfiguration, request);
  }

  /**
   * An Async wrapper for UpdateSharedVpcConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateSharedVpcConfigurationRequestT = Model::UpdateSharedVpcConfigurationRequest>
  void UpdateSharedVpcConfigurationAsync(const UpdateSharedVpcConfigurationResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                         const UpdateSharedVpcConfigurationRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for UpdateSnapshot that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateSnapshotRequestT = Model::UpdateSnapshotRequest>
  void UpdateSnapshotAsync(const UpdateSnapshotRequestT& request, const UpdateSnapshotResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateStorageVirtualMachineOutcome UpdateStorageVirtualMachine(
      const Model::UpdateStorageVirtualMachineRequest& request) const;

  /**
   * A Callable wrapper for UpdateStorageVirtualMachine that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateStorageVirtualMachineRequestT = Model::UpdateStorageVirtualMachineRequest>
  Model::UpdateStorageVirtualMachineOutcomeCallable UpdateStorageVirtualMachineCallable(
      const UpdateStorageVirtualMachineRequestT& request) const {
    return SubmitCallable(&FSxClient::UpdateStorageVirtualMachine, request);
  }

  /**
   * An Async wrapper for UpdateStorageVirtualMachine that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateStorageVirtualMachineRequestT = Model::UpdateStorageVirtualMachineRequest>
  void UpdateStorageVirtualMachineAsync(const UpdateStorageVirtualMachineRequestT& request,
                                        const UpdateStorageVirtualMachineResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateVolume that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateVolumeRequestT = Model::UpdateVolumeRequest>
  void UpdateVolumeAsync(const UpdateVolumeRequestT& request, const UpdateVolumeResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
