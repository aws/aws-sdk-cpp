...
class DataRepositoryTaskStatus {
 public:
  ...
  inline DataRepositoryTaskStatus& WithTotalCount(long long value) {
    SetTotalCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSucceededCount(long long value) {
    m_succeededCountHasBeenSet = true;
    m_succeededCount = value;
  }
  inline DataRepositoryTaskStatus& WithSucceededCount(long long value) {
    SetSucceededCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFailedCount(long long value) {
    m_failedCountHasBeenSet = true;
    m_failedCount = value;
  }
  inline DataRepositoryTaskStatus& WithFailedCount(long long value) {
  ...
  inline void SetReleasedCapacity(long long value) {
    m_releasedCapacityHasBeenSet = true;
    m_releasedCapacity = value;
  }
  inline DataRepositoryTaskStatus& WithReleasedCapacity(long long value) {
    SetReleasedCapacity(value);
    return *this;
  }
  ///@}
 private:
