...
class UpdateFileSystemOpenZFSConfiguration {
 public:
  ...
  inline UpdateFileSystemOpenZFSConfiguration& WithAutomaticBackupRetentionDays(int value) {
  ...
  inline UpdateFileSystemOpenZFSConfiguration& WithCopyTagsToBackups(bool value) {
  ...
  inline UpdateFileSystemOpenZFSConfiguration& WithCopyTagsToVolumes(bool value) {
  ...
  template <typename DailyAutomaticBackupStartTimeT = Aws::String>
  UpdateFileSystemOpenZFSConfiguration& WithDailyAutomaticBackupStartTime(DailyAutomaticBackupStartTimeT&& value) {
  ...
  inline UpdateFileSystemOpenZFSConfiguration& WithThroughputCapacity(int value) {
  ...
  template <typename WeeklyMaintenanceStartTimeT = Aws::String>
  UpdateFileSystemOpenZFSConfiguration& WithWeeklyMaintenanceStartTime(WeeklyMaintenanceStartTimeT&& value) {
  ...
  template <typename DiskIopsConfigurationT = DiskIopsConfiguration>
  UpdateFileSystemOpenZFSConfiguration& WithDiskIopsConfiguration(DiskIopsConfigurationT&& value) {
  ...
  template <typename AddRouteTableIdsT = Aws::Vector<Aws::String>>
  UpdateFileSystemOpenZFSConfiguration& WithAddRouteTableIds(AddRouteTableIdsT&& value) {
    SetAddRouteTableIds(std::forward<AddRouteTableIdsT>(value));
    return *this;
  }
  template <typename AddRouteTableIdsT = Aws::String>
  UpdateFileSystemOpenZFSConfiguration& AddAddRouteTableIds(AddRouteTableIdsT&& value) {
    m_addRouteTableIdsHasBeenSet = true;
  ...
  template <typename RemoveRouteTableIdsT = Aws::Vector<Aws::String>>
  UpdateFileSystemOpenZFSConfiguration& WithRemoveRouteTableIds(RemoveRouteTableIdsT&& value) {
    SetRemoveRouteTableIds(std::forward<RemoveRouteTableIdsT>(value));
    return *this;
  }
  template <typename RemoveRouteTableIdsT = Aws::String>
  UpdateFileSystemOpenZFSConfiguration& AddRemoveRouteTableIds(RemoveRouteTableIdsT&& value) {
    m_removeRouteTableIdsHasBeenSet = true;
  ...
  template <typename ReadCacheConfigurationT = OpenZFSReadCacheConfiguration>
  UpdateFileSystemOpenZFSConfiguration& WithReadCacheConfiguration(ReadCacheConfigurationT&& value) {
  ...
  template <typename EndpointIpv6AddressRangeT = Aws::String>
  UpdateFileSystemOpenZFSConfiguration& WithEndpointIpv6AddressRange(EndpointIpv6AddressRangeT&& value) {
