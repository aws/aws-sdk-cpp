...
class FileSystem {
 public:
  ...
  inline FileSystem& WithFileSystemType(FileSystemType value) {
  ...
  inline FileSystem& WithLifecycle(FileSystemLifecycle value) {
    SetLifecycle(value);
    return *this;
  }
  ///@}
  ...
  inline FileSystem& WithStorageCapacity(int value) {
  ...
  inline FileSystem& WithStorageType(StorageType value) {
  ...
  inline FileSystem& WithNetworkType(NetworkType value) {
