...
class DeleteVolumeOntapResponse {
 public:
  ...
  template <typename FinalBackupIdT = Aws::String>
  DeleteVolumeOntapResponse& WithFinalBackupId(FinalBackupIdT&& value) {
  ...
  template <typename FinalBackupTagsT = Aws::Vector<Tag>>
  DeleteVolumeOntapResponse& WithFinalBackupTags(FinalBackupTagsT&& value) {
    SetFinalBackupTags(std::forward<FinalBackupTagsT>(value));
    return *this;
  }
  template <typename FinalBackupTagsT = Tag>
  DeleteVolumeOntapResponse& AddFinalBackupTags(FinalBackupTagsT&& value) {
    m_finalBackupTagsHasBeenSet = true;
