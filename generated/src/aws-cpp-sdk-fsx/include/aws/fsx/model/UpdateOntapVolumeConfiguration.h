...
class UpdateOntapVolumeConfiguration {
 public:
  ...
  inline UpdateOntapVolumeConfiguration& WithSecurityStyle(SecurityStyle value) {
  ...
  inline UpdateOntapVolumeConfiguration& WithSizeInMegabytes(int value) {
  ...
  inline UpdateOntapVolumeConfiguration& WithStorageEfficiencyEnabled(bool value) {
  ...
  inline UpdateOntapVolumeConfiguration& WithCopyTagsToBackups(bool value) {
  ...
  inline UpdateOntapVolumeConfiguration& WithSizeInBytes(long long value) {
