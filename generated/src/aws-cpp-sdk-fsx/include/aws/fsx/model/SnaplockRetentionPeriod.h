...
class SnaplockRetentionPeriod {
 public:
  ...
  void SetMinimumRetention(MinimumRetentionT&& value) {
    ...
    m_minimumRetention = std::forward<MinimumRetentionT>(value);
  }
  template <typename MinimumRetentionT = RetentionPeriod>
  SnaplockRetentionPeriod& WithMinimumRetention(MinimumRetentionT&& value) {
    SetMinimumRetention(std::forward<MinimumRetentionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMaximumRetention(MaximumRetentionT&& value) {
    ...
    m_maximumRetention = std::forward<MaximumRetentionT>(value);
  }
  template <typename MaximumRetentionT = RetentionPeriod>
  SnaplockRetentionPeriod& WithMaximumRetention(MaximumRetentionT&& value) {
    SetMaximumRetention(std::forward<MaximumRetentionT>(value));
    return *this;
  }
  ///@}
 private:
