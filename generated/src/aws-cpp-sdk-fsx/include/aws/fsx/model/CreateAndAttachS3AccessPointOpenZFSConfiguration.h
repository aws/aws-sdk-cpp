...
class CreateAndAttachS3AccessPointOpenZFSConfiguration {
 public:
  ...
  template <typename VolumeIdT = Aws::String>
  CreateAndAttachS3AccessPointOpenZFSConfiguration& WithVolumeId(VolumeIdT&& value) {
  ...
  template <typename FileSystemIdentityT = OpenZFSFileSystemIdentity>
  CreateAndAttachS3AccessPointOpenZFSConfiguration& WithFileSystemIdentity(FileSystemIdentityT&& value) {
