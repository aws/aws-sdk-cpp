...
class OpenZFSFileSystemConfiguration {
 public:
  ...
  inline OpenZFSFileSystemConfiguration& WithAutomaticBackupRetentionDays(int value) {
  ...
  inline OpenZFSFileSystemConfiguration& WithCopyTagsToBackups(bool value) {
  ...
  inline OpenZFSFileSystemConfiguration& WithCopyTagsToVolumes(bool value) {
  ...
  template <typename DailyAutomaticBackupStartTimeT = Aws::String>
  OpenZFSFileSystemConfiguration& WithDailyAutomaticBackupStartTime(DailyAutomaticBackupStartTimeT&& value) {
  ...
  inline OpenZFSFileSystemConfiguration& WithDeploymentType(OpenZFSDeploymentType value) {
  ...
  inline OpenZFSFileSystemConfiguration& WithThroughputCapacity(int value) {
  ...
  template <typename WeeklyMaintenanceStartTimeT = Aws::String>
  OpenZFSFileSystemConfiguration& WithWeeklyMaintenanceStartTime(WeeklyMaintenanceStartTimeT&& value) {
  ...
  template <typename DiskIopsConfigurationT = DiskIopsConfiguration>
  OpenZFSFileSystemConfiguration& WithDiskIopsConfiguration(DiskIopsConfigurationT&& value) {
  ...
  void SetRootVolumeId(RootVolumeIdT&& value) {
    m_rootVolumeIdHasBeenSet = true;
    m_rootVolumeId = std::forward<RootVolumeIdT>(value);
  }
  template <typename RootVolumeIdT = Aws::String>
  OpenZFSFileSystemConfiguration& WithRootVolumeId(RootVolumeIdT&& value) {
    SetRootVolumeId(std::forward<RootVolumeIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename PreferredSubnetIdT = Aws::String>
  OpenZFSFileSystemConfiguration& WithPreferredSubnetId(PreferredSubnetIdT&& value) {
  ...
  template <typename EndpointIpAddressRangeT = Aws::String>
  OpenZFSFileSystemConfiguration& WithEndpointIpAddressRange(EndpointIpAddressRangeT&& value) {
  ...
  template <typename EndpointIpv6AddressRangeT = Aws::String>
  OpenZFSFileSystemConfiguration& WithEndpointIpv6AddressRange(EndpointIpv6AddressRangeT&& value) {
  ...
  template <typename RouteTableIdsT = Aws::Vector<Aws::String>>
  OpenZFSFileSystemConfiguration& WithRouteTableIds(RouteTableIdsT&& value) {
    SetRouteTableIds(std::forward<RouteTableIdsT>(value));
    return *this;
  }
  template <typename RouteTableIdsT = Aws::String>
  OpenZFSFileSystemConfiguration& AddRouteTableIds(RouteTableIdsT&& value) {
    m_routeTableIdsHasBeenSet = true;
  ...
  ///@{
  /**
   * <p>The IPv4 address of the endpoint that is used to access data or to manage the
   * file system.</p>
   */
  ...
  void SetEndpointIpAddress(EndpointIpAddressT&& value) {
    m_endpointIpAddressHasBeenSet = true;
    m_endpointIpAddress = std::forward<EndpointIpAddressT>(value);
  }
  template <typename EndpointIpAddressT = Aws::String>
  OpenZFSFileSystemConfiguration& WithEndpointIpAddress(EndpointIpAddressT&& value) {
    SetEndpointIpAddress(std::forward<EndpointIpAddressT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEndpointIpv6Address(EndpointIpv6AddressT&& value) {
    m_endpointIpv6AddressHasBeenSet = true;
    m_endpointIpv6Address = std::forward<EndpointIpv6AddressT>(value);
  }
  template <typename EndpointIpv6AddressT = Aws::String>
  OpenZFSFileSystemConfiguration& WithEndpointIpv6Address(EndpointIpv6AddressT&& value) {
    SetEndpointIpv6Address(std::forward<EndpointIpv6AddressT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ReadCacheConfigurationT = OpenZFSReadCacheConfiguration>
  OpenZFSFileSystemConfiguration& WithReadCacheConfiguration(ReadCacheConfigurationT&& value) {
