...
class CreateOpenZFSVolumeConfiguration {
 public:
  ...
  template <typename ParentVolumeIdT = Aws::String>
  CreateOpenZFSVolumeConfiguration& WithParentVolumeId(ParentVolumeIdT&& value) {
  ...
  inline CreateOpenZFSVolumeConfiguration& WithStorageCapacityReservationGiB(int value) {
  ...
  inline CreateOpenZFSVolumeConfiguration& WithStorageCapacityQuotaGiB(int value) {
  ...
  inline CreateOpenZFSVolumeConfiguration& WithRecordSizeKiB(int value) {
  ...
  inline CreateOpenZFSVolumeConfiguration& WithDataCompressionType(OpenZFSDataCompressionType value) {
  ...
  inline CreateOpenZFSVolumeConfiguration& WithCopyTagsToSnapshots(bool value) {
  ...
  template <typename OriginSnapshotT = CreateOpenZFSOriginSnapshotConfiguration>
  CreateOpenZFSVolumeConfiguration& WithOriginSnapshot(OriginSnapshotT&& value) {
  ...
  inline CreateOpenZFSVolumeConfiguration& WithReadOnly(bool value) {
    SetReadOnly(value);
    return *this;
  }
  ///@}
  ...
  template <typename NfsExportsT = Aws::Vector<OpenZFSNfsExport>>
  CreateOpenZFSVolumeConfiguration& WithNfsExports(NfsExportsT&& value) {
    SetNfsExports(std::forward<NfsExportsT>(value));
    return *this;
  }
  template <typename NfsExportsT = OpenZFSNfsExport>
  CreateOpenZFSVolumeConfiguration& AddNfsExports(NfsExportsT&& value) {
    m_nfsExportsHasBeenSet = true;
  ...
  template <typename UserAndGroupQuotasT = Aws::Vector<OpenZFSUserOrGroupQuota>>
  CreateOpenZFSVolumeConfiguration& WithUserAndGroupQuotas(UserAndGroupQuotasT&& value) {
    SetUserAndGroupQuotas(std::forward<UserAndGroupQuotasT>(value));
    return *this;
  }
  template <typename UserAndGroupQuotasT = OpenZFSUserOrGroupQuota>
  CreateOpenZFSVolumeConfiguration& AddUserAndGroupQuotas(UserAndGroupQuotasT&& value) {
    m_userAndGroupQuotasHasBeenSet = true;
