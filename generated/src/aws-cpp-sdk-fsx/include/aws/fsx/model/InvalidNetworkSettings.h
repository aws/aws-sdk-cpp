...
class InvalidNetworkSettings {
 public:
  ...
  template <typename MessageT = Aws::String>
  InvalidNetworkSettings& WithMessage(MessageT&& value) {
  ...
  void SetInvalidSubnetId(InvalidSubnetIdT&& value) {
    m_invalidSubnetIdHasBeenSet = true;
    m_invalidSubnetId = std::forward<InvalidSubnetIdT>(value);
  }
  template <typename InvalidSubnetIdT = Aws::String>
  InvalidNetworkSettings& WithInvalidSubnetId(InvalidSubnetIdT&& value) {
    SetInvalidSubnetId(std::forward<InvalidSubnetIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInvalidSecurityGroupId(InvalidSecurityGroupIdT&& value) {
    m_invalidSecurityGroupIdHasBeenSet = true;
    m_invalidSecurityGroupId = std::forward<InvalidSecurityGroupIdT>(value);
  }
  template <typename InvalidSecurityGroupIdT = Aws::String>
  InvalidNetworkSettings& WithInvalidSecurityGroupId(InvalidSecurityGroupIdT&& value) {
    SetInvalidSecurityGroupId(std::forward<InvalidSecurityGroupIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInvalidRouteTableId(InvalidRouteTableIdT&& value) {
    m_invalidRouteTableIdHasBeenSet = true;
    m_invalidRouteTableId = std::forward<InvalidRouteTableIdT>(value);
  }
  template <typename InvalidRouteTableIdT = Aws::String>
  InvalidNetworkSettings& WithInvalidRouteTableId(InvalidRouteTableIdT&& value) {
    SetInvalidRouteTableId(std::forward<InvalidRouteTableIdT>(value));
    return *this;
  }
  ///@}
 private:
