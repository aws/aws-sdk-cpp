...
class OntapVolumeConfiguration {
 public:
  ...
  inline void SetFlexCacheEndpointType(FlexCacheEndpointType value) {
    m_flexCacheEndpointTypeHasBeenSet = true;
    m_flexCacheEndpointType = value;
  }
  inline OntapVolumeConfiguration& WithFlexCacheEndpointType(FlexCacheEndpointType value) {
    SetFlexCacheEndpointType(value);
    return *this;
  }
  ///@}
  ...
  void SetJunctionPath(JunctionPathT&& value) {
    ...
    m_junctionPath = std::forward<JunctionPathT>(value);
  }
  template <typename JunctionPathT = Aws::String>
  OntapVolumeConfiguration& WithJunctionPath(JunctionPathT&& value) {
    SetJunctionPath(std::forward<JunctionPathT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetSecurityStyle(SecurityStyle value) {
    m_securityStyleHasBeenSet = true;
    m_securityStyle = value;
  }
  inline OntapVolumeConfiguration& WithSecurityStyle(SecurityStyle value) {
    SetSecurityStyle(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSizeInMegabytes(int value) {
    m_sizeInMegabytesHasBeenSet = true;
    m_sizeInMegabytes = value;
  }
  inline OntapVolumeConfiguration& WithSizeInMegabytes(int value) {
    SetSizeInMegabytes(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStorageEfficiencyEnabled(bool value) {
    m_storageEfficiencyEnabledHasBeenSet = true;
    m_storageEfficiencyEnabled = value;
  }
  inline OntapVolumeConfiguration& WithStorageEfficiencyEnabled(bool value) {
    SetStorageEfficiencyEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStorageVirtualMachineRoot(bool value) {
    m_storageVirtualMachineRootHasBeenSet = true;
    m_storageVirtualMachineRoot = value;
  }
  inline OntapVolumeConfiguration& WithStorageVirtualMachineRoot(bool value) {
    SetStorageVirtualMachineRoot(value);
    return *this;
  }
  ///@}
  ...
  void SetTieringPolicy(TieringPolicyT&& value) {
    ...
    m_tieringPolicy = std::forward<TieringPolicyT>(value);
  }
  template <typename TieringPolicyT = TieringPolicy>
  OntapVolumeConfiguration& WithTieringPolicy(TieringPolicyT&& value) {
    SetTieringPolicy(std::forward<TieringPolicyT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetOntapVolumeType(OntapVolumeType value) {
    m_ontapVolumeTypeHasBeenSet = true;
    m_ontapVolumeType = value;
  }
  inline OntapVolumeConfiguration& WithOntapVolumeType(OntapVolumeType value) {
    SetOntapVolumeType(value);
    return *this;
  }
  ///@}
  ...
  void SetSnapshotPolicy(SnapshotPolicyT&& value) {
    ...
    m_snapshotPolicy = std::forward<SnapshotPolicyT>(value);
  }
  template <typename SnapshotPolicyT = Aws::String>
  OntapVolumeConfiguration& WithSnapshotPolicy(SnapshotPolicyT&& value) {
    SetSnapshotPolicy(std::forward<SnapshotPolicyT>(value));
    return *this;
  }
  ///@}
  ...
  inline OntapVolumeConfiguration& WithCopyTagsToBackups(bool value) {
  ...
  void SetSnaplockConfiguration(SnaplockConfigurationT&& value) {
    ...
    m_snaplockConfiguration = std::forward<SnaplockConfigurationT>(value);
  }
  template <typename SnaplockConfigurationT = SnaplockConfiguration>
  OntapVolumeConfiguration& WithSnaplockConfiguration(SnaplockConfigurationT&& value) {
    SetSnaplockConfiguration(std::forward<SnaplockConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetVolumeStyle(VolumeStyle value) {
    m_volumeStyleHasBeenSet = true;
    m_volumeStyle = value;
  }
  inline OntapVolumeConfiguration& WithVolumeStyle(VolumeStyle value) {
    SetVolumeStyle(value);
    return *this;
  }
  ///@}
  ...
  void SetAggregateConfiguration(AggregateConfigurationT&& value) {
    ...
    m_aggregateConfiguration = std::forward<AggregateConfigurationT>(value);
  }
  template <typename AggregateConfigurationT = AggregateConfiguration>
  OntapVolumeConfiguration& WithAggregateConfiguration(AggregateConfigurationT&& value) {
    SetAggregateConfiguration(std::forward<AggregateConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  inline OntapVolumeConfiguration& WithSizeInBytes(long long value) {
