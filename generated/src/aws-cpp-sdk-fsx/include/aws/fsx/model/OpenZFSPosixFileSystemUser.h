...
class OpenZFSPosixFileSystemUser {
 public:
  ...
  inline OpenZFSPosixFileSystemUser& WithUid(long long value) {
    SetUid(value);
    return *this;
  }
  ///@}
  ...
  inline OpenZFSPosixFileSystemUser& WithGid(long long value) {
    SetGid(value);
    return *this;
  }
  ///@}
  ...
  template <typename SecondaryGidsT = Aws::Vector<long long>>
  OpenZFSPosixFileSystemUser& WithSecondaryGids(SecondaryGidsT&& value) {
    SetSecondaryGids(std::forward<SecondaryGidsT>(value));
    return *this;
  }
  inline OpenZFSPosixFileSystemUser& AddSecondaryGids(long long value) {
    m_secondaryGidsHasBeenSet = true;
