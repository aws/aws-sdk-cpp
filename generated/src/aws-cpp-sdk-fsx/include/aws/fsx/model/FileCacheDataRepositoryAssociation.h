...
class FileCacheDataRepositoryAssociation {
 public:
  ...
  void SetFileCachePath(FileCachePathT&& value) {
    ...
    m_fileCachePath = std::forward<FileCachePathT>(value);
  }
  template <typename FileCachePathT = Aws::String>
  FileCacheDataRepositoryAssociation& WithFileCachePath(FileCachePathT&& value) {
    SetFileCachePath(std::forward<FileCachePathT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDataRepositoryPath(DataRepositoryPathT&& value) {
    ...
    m_dataRepositoryPath = std::forward<DataRepositoryPathT>(value);
  }
  template <typename DataRepositoryPathT = Aws::String>
  FileCacheDataRepositoryAssociation& WithDataRepositoryPath(DataRepositoryPathT&& value) {
    SetDataRepositoryPath(std::forward<DataRepositoryPathT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDataRepositorySubdirectories(DataRepositorySubdirectoriesT&& value) {
    ...
    m_dataRepositorySubdirectories = std::forward<DataRepositorySubdirectoriesT>(value);
  }
  template <typename DataRepositorySubdirectoriesT = Aws::Vector<Aws::String>>
  FileCacheDataRepositoryAssociation& WithDataRepositorySubdirectories(DataRepositorySubdirectoriesT&& value) {
    SetDataRepositorySubdirectories(std::forward<DataRepositorySubdirectoriesT>(value));
    return *this;
  }
  template <typename DataRepositorySubdirectoriesT = Aws::String>
  FileCacheDataRepositoryAssociation& AddDataRepositorySubdirectories(DataRepositorySubdirectoriesT&& value) {
    m_dataRepositorySubdirectoriesHasBeenSet = true;
    m_dataRepositorySubdirectories.emplace_back(std::forward<DataRepositorySubdirectoriesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NFST = FileCacheNFSConfiguration>
  FileCacheDataRepositoryAssociation& WithNFS(NFST&& value) {
