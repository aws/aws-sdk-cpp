...
class DescribeFileCachesRequest : public FSxRequest {
 public:
  ...
  void SetFileCacheIds(FileCacheIdsT&& value) {
    m_fileCacheIdsHasBeenSet = true;
    m_fileCacheIds = std::forward<FileCacheIdsT>(value);
  }
  template <typename FileCacheIdsT = Aws::Vector<Aws::String>>
  DescribeFileCachesRequest& WithFileCacheIds(FileCacheIdsT&& value) {
    SetFileCacheIds(std::forward<FileCacheIdsT>(value));
    return *this;
  }
  template <typename FileCacheIdsT = Aws::String>
  DescribeFileCachesRequest& AddFileCacheIds(FileCacheIdsT&& value) {
    m_fileCacheIdsHasBeenSet = true;
    m_fileCacheIds.emplace_back(std::forward<FileCacheIdsT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeFileCachesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
