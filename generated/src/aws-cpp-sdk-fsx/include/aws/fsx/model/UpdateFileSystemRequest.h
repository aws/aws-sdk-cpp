...
class UpdateFileSystemRequest : public FSxRequest {
 public:
  ...
  inline UpdateFileSystemRequest& WithStorageCapacity(int value) {
  ...
  inline UpdateFileSystemRequest& WithStorageType(StorageType value) {
  ...
  inline UpdateFileSystemRequest& WithNetworkType(NetworkType value) {
