...
class DescribeDataRepositoryAssociationsResult {
 public:
  ...
  template <typename AssociationsT = Aws::Vector<DataRepositoryAssociation>>
  DescribeDataRepositoryAssociationsResult& WithAssociations(AssociationsT&& value) {
    SetAssociations(std::forward<AssociationsT>(value));
    return *this;
  }
  template <typename AssociationsT = DataRepositoryAssociation>
  DescribeDataRepositoryAssociationsResult& AddAssociations(AssociationsT&& value) {
    m_associationsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeDataRepositoryAssociationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeDataRepositoryAssociationsResult& WithRequestId(RequestIdT&& value) {
