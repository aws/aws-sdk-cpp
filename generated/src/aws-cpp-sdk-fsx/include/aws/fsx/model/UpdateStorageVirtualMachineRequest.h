...
class UpdateStorageVirtualMachineRequest : public FSxRequest {
 public:
  ...
  template <typename ActiveDirectoryConfigurationT = UpdateSvmActiveDirectoryConfiguration>
  UpdateStorageVirtualMachineRequest& WithActiveDirectoryConfiguration(ActiveDirectoryConfigurationT&& value) {
  ...
  template <typename ClientRequestTokenT = Aws::String>
  UpdateStorageVirtualMachineRequest& WithClientRequestToken(ClientRequestTokenT&& value) {
  ...
  template <typename StorageVirtualMachineIdT = Aws::String>
  UpdateStorageVirtualMachineRequest& WithStorageVirtualMachineId(StorageVirtualMachineIdT&& value) {
  ...
  template <typename SvmAdminPasswordT = Aws::String>
  UpdateStorageVirtualMachineRequest& WithSvmAdminPassword(SvmAdminPasswordT&& value) {
