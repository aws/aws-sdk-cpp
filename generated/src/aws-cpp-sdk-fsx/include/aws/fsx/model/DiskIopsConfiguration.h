...
class DiskIopsConfiguration {
 public:
  ...
  inline void SetMode(DiskIopsConfigurationMode value) {
    m_modeHasBeenSet = true;
    m_mode = value;
  }
  inline DiskIopsConfiguration& WithMode(DiskIopsConfigurationMode value) {
    SetMode(value);
    return *this;
  }
  ///@}
  ...
  inline DiskIopsConfiguration& WithIops(long long value) {
    SetIops(value);
    return *this;
  }
  ///@}
