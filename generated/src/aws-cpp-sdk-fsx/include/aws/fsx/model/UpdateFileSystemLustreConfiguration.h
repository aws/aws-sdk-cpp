...
class UpdateFileSystemLustreConfiguration {
 public:
  ...
  inline UpdateFileSystemLustreConfiguration& WithAutomaticBackupRetentionDays(int value) {
  ...
  inline UpdateFileSystemLustreConfiguration& WithAutoImportPolicy(AutoImportPolicyType value) {
  ...
  inline UpdateFileSystemLustreConfiguration& WithDataCompressionType(DataCompressionType value) {
  ...
  inline UpdateFileSystemLustreConfiguration& WithPerUnitStorageThroughput(int value) {
  ...
  inline UpdateFileSystemLustreConfiguration& WithThroughputCapacity(int value) {
