...
class CreateAggregateConfiguration {
 public:
  ...
  inline void SetConstituentsPerAggregate(int value) {
    m_constituentsPerAggregateHasBeenSet = true;
    m_constituentsPerAggregate = value;
  }
  inline CreateAggregateConfiguration& WithConstituentsPerAggregate(int value) {
    SetConstituentsPerAggregate(value);
    return *this;
  }
  ///@}
 private:
