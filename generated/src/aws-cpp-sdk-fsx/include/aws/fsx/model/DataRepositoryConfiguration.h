...
class DataRepositoryConfiguration {
 public:
  ...
  inline void SetLifecycle(DataRepositoryLifecycle value) {
    m_lifecycleHasBeenSet = true;
    m_lifecycle = value;
  }
  inline DataRepositoryConfiguration& WithLifecycle(DataRepositoryLifecycle value) {
    SetLifecycle(value);
    return *this;
  }
  ///@}
  ...
  void SetImportPath(ImportPathT&& value) {
    ...
    m_importPath = std::forward<ImportPathT>(value);
  }
  template <typename ImportPathT = Aws::String>
  DataRepositoryConfiguration& WithImportPath(ImportPathT&& value) {
    SetImportPath(std::forward<ImportPathT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExportPath(ExportPathT&& value) {
    ...
    m_exportPath = std::forward<ExportPathT>(value);
  }
  template <typename ExportPathT = Aws::String>
  DataRepositoryConfiguration& WithExportPath(ExportPathT&& value) {
    SetExportPath(std::forward<ExportPathT>(value));
    return *this;
  }
  ///@}
  ...
  inline DataRepositoryConfiguration& WithImportedFileChunkSize(int value) {
  ...
  inline void SetAutoImportPolicy(AutoImportPolicyType value) {
    m_autoImportPolicyHasBeenSet = true;
    m_autoImportPolicy = value;
  }
  inline DataRepositoryConfiguration& WithAutoImportPolicy(AutoImportPolicyType value) {
    SetAutoImportPolicy(value);
    return *this;
  }
  ///@}
