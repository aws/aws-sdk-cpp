...
class CopySnapshotAndUpdateVolumeResult {
 public:
  ...
  template <typename VolumeIdT = Aws::String>
  CopySnapshotAndUpdateVolumeResult& WithVolumeId(VolumeIdT&& value) {
  ...
  inline CopySnapshotAndUpdateVolumeResult& WithLifecycle(VolumeLifecycle value) {
    SetLifecycle(value);
    return *this;
  }
  ///@}
  ...
  template <typename AdministrativeActionsT = Aws::Vector<AdministrativeAction>>
  CopySnapshotAndUpdateVolumeResult& WithAdministrativeActions(AdministrativeActionsT&& value) {
  ...
  CopySnapshotAndUpdateVolumeResult& AddAdministrativeActions(AdministrativeActionsT&& value) {
    m_administrativeActionsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  CopySnapshotAndUpdateVolumeResult& WithRequestId(RequestIdT&& value) {
