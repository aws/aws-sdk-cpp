...
class UpdateSnaplockConfiguration {
 public:
  ...
  inline UpdateSnaplockConfiguration& WithAuditLogVolume(bool value) {
  ...
  inline UpdateSnaplockConfiguration& WithPrivilegedDelete(PrivilegedDelete value) {
  ...
  inline UpdateSnaplockConfiguration& WithVolumeAppendModeEnabled(bool value) {
