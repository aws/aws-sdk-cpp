...
class DisassociateFileSystemAliasesRequest : public FSxRequest {
 public:
  AWS_FSX_API DisassociateFileSystemAliasesRequest() = default;
  ...
  template <typename ClientRequestTokenT = Aws::String>
  DisassociateFileSystemAliasesRequest& WithClientRequestToken(ClientRequestTokenT&& value) {
  ...
  template <typename FileSystemIdT = Aws::String>
  DisassociateFileSystemAliasesRequest& WithFileSystemId(FileSystemIdT&& value) {
  ...
  template <typename AliasesT = Aws::Vector<Aws::String>>
  DisassociateFileSystemAliasesRequest& WithAliases(AliasesT&& value) {
    SetAliases(std::forward<AliasesT>(value));
    return *this;
  }
  template <typename AliasesT = Aws::String>
  DisassociateFileSystemAliasesRequest& AddAliases(AliasesT&& value) {
    m_aliasesHasBeenSet = true;
