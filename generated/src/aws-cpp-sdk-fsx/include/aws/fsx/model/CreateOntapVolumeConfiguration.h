...
class CreateOntapVolumeConfiguration {
 public:
  ...
  inline CreateOntapVolumeConfiguration& WithSecurityStyle(SecurityStyle value) {
  ...
  inline CreateOntapVolumeConfiguration& WithStorageEfficiencyEnabled(bool value) {
  ...
  inline void SetOntapVolumeType(InputOntapVolumeType value) {
    m_ontapVolumeTypeHasBeenSet = true;
    m_ontapVolumeType = value;
  }
  inline CreateOntapVolumeConfiguration& WithOntapVolumeType(InputOntapVolumeType value) {
  ...
  inline CreateOntapVolumeConfiguration& WithCopyTagsToBackups(bool value) {
  ...
  inline CreateOntapVolumeConfiguration& WithVolumeStyle(VolumeStyle value) {
  ...
  inline CreateOntapVolumeConfiguration& WithSizeInBytes(long long value) {
