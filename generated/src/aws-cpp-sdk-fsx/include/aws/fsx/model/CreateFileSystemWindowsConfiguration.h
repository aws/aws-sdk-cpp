...
class CreateFileSystemWindowsConfiguration {
 public:
  ...
  inline const SelfManagedActiveDirectoryConfiguration& GetSelfManagedActiveDirectoryConfiguration() const {
  ...
  inline void SetDeploymentType(WindowsDeploymentType value) {
    m_deploymentTypeHasBeenSet = true;
    m_deploymentType = value;
  }
  inline CreateFileSystemWindowsConfiguration& WithDeploymentType(WindowsDeploymentType value) {
  ...
  inline CreateFileSystemWindowsConfiguration& WithThroughputCapacity(int value) {
  ...
  inline CreateFileSystemWindowsConfiguration& WithAutomaticBackupRetentionDays(int value) {
  ...
  inline CreateFileSystemWindowsConfiguration& WithCopyTagsToBackups(bool value) {
  ...
  void SetAuditLogConfiguration(AuditLogConfigurationT&& value) {
    ...
    m_auditLogConfiguration = std::forward<AuditLogConfigurationT>(value);
  }
  template <typename AuditLogConfigurationT = WindowsAuditLogCreateConfiguration>
  CreateFileSystemWindowsConfiguration& WithAuditLogConfiguration(AuditLogConfigurationT&& value) {
    SetAuditLogConfiguration(std::forward<AuditLogConfigurationT>(value));
    return *this;
  }
  ///@}
