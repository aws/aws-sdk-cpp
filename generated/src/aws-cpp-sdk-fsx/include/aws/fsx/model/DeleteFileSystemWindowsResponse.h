...
class DeleteFileSystemWindowsResponse {
 public:
  ...
  template <typename FinalBackupIdT = Aws::String>
  DeleteFileSystemWindowsResponse& WithFinalBackupId(FinalBackupIdT&& value) {
  ...
  template <typename FinalBackupTagsT = Aws::Vector<Tag>>
  DeleteFileSystemWindowsResponse& WithFinalBackupTags(FinalBackupTagsT&& value) {
    SetFinalBackupTags(std::forward<FinalBackupTagsT>(value));
    return *this;
  }
  template <typename FinalBackupTagsT = Tag>
  DeleteFileSystemWindowsResponse& AddFinalBackupTags(FinalBackupTagsT&& value) {
    m_finalBackupTagsHasBeenSet = true;
