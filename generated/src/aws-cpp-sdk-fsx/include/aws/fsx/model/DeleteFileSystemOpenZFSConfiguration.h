...
class DeleteFileSystemOpenZFSConfiguration {
 public:
  ...
  inline DeleteFileSystemOpenZFSConfiguration& WithSkipFinalBackup(bool value) {
  ...
  template <typename FinalBackupTagsT = Aws::Vector<Tag>>
  DeleteFileSystemOpenZFSConfiguration& WithFinalBackupTags(FinalBackupTagsT&& value) {
    SetFinalBackupTags(std::forward<FinalBackupTagsT>(value));
    return *this;
  }
  template <typename FinalBackupTagsT = Tag>
  DeleteFileSystemOpenZFSConfiguration& AddFinalBackupTags(FinalBackupTagsT&& value) {
    m_finalBackupTagsHasBeenSet = true;
  ...
  template <typename OptionsT = Aws::Vector<DeleteFileSystemOpenZFSOption>>
  DeleteFileSystemOpenZFSConfiguration& WithOptions(OptionsT&& value) {
    SetOptions(std::forward<OptionsT>(value));
    return *this;
  }
  inline DeleteFileSystemOpenZFSConfiguration& AddOptions(DeleteFileSystemOpenZFSOption value) {
    m_optionsHasBeenSet = true;
