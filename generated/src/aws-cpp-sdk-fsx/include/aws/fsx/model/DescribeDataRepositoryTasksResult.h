...
class DescribeDataRepositoryTasksResult {
 public:
  ...
  void SetDataRepositoryTasks(DataRepositoryTasksT&& value) {
    m_dataRepositoryTasksHasBeenSet = true;
    m_dataRepositoryTasks = std::forward<DataRepositoryTasksT>(value);
  }
  template <typename DataRepositoryTasksT = Aws::Vector<DataRepositoryTask>>
  DescribeDataRepositoryTasksResult& WithDataRepositoryTasks(DataRepositoryTasksT&& value) {
    SetDataRepositoryTasks(std::forward<DataRepositoryTasksT>(value));
    return *this;
  }
  template <typename DataRepositoryTasksT = DataRepositoryTask>
  DescribeDataRepositoryTasksResult& AddDataRepositoryTasks(DataRepositoryTasksT&& value) {
    m_dataRepositoryTasksHasBeenSet = true;
    m_dataRepositoryTasks.emplace_back(std::forward<DataRepositoryTasksT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeDataRepositoryTasksResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeDataRepositoryTasksResult& WithRequestId(RequestIdT&& value) {
