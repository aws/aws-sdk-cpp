...
class S3DataRepositoryConfiguration {
 public:
  ...
  void SetAutoImportPolicy(AutoImportPolicyT&& value) {
    m_autoImportPolicyHasBeenSet = true;
    m_autoImportPolicy = std::forward<AutoImportPolicyT>(value);
  }
  template <typename AutoImportPolicyT = AutoImportPolicy>
  S3DataRepositoryConfiguration& WithAutoImportPolicy(AutoImportPolicyT&& value) {
    SetAutoImportPolicy(std::forward<AutoImportPolicyT>(value));
    return *this;
  }
  ///@}
