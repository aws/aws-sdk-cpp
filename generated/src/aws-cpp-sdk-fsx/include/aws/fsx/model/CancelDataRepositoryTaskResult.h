...
class CancelDataRepositoryTaskResult {
 public:
  ...
  inline void SetLifecycle(DataRepositoryTaskLifecycle value) {
    m_lifecycleHasBeenSet = true;
    m_lifecycle = value;
  }
  inline CancelDataRepositoryTaskResult& WithLifecycle(DataRepositoryTaskLifecycle value) {
    SetLifecycle(value);
    return *this;
  }
  ///@}
  ...
  template <typename TaskIdT = Aws::String>
  CancelDataRepositoryTaskResult& WithTaskId(TaskIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CancelDataRepositoryTaskResult& WithRequestId(RequestIdT&& value) {
