...
class CreateOpenZFSOriginSnapshotConfiguration {
 public:
  ...
  template <typename SnapshotARNT = Aws::String>
  CreateOpenZFSOriginSnapshotConfiguration& WithSnapshotARN(SnapshotARNT&& value) {
  ...
  inline CreateOpenZFSOriginSnapshotConfiguration& WithCopyStrategy(OpenZFSCopyStrategy value) {
