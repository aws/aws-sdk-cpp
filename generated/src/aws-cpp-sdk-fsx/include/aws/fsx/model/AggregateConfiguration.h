...
class AggregateConfiguration {
 public:
  ...
  inline void SetTotalConstituents(int value) {
    m_totalConstituentsHasBeenSet = true;
    m_totalConstituents = value;
  }
  inline AggregateConfiguration& WithTotalConstituents(int value) {
    SetTotalConstituents(value);
    return *this;
  }
  ///@}
 private:
