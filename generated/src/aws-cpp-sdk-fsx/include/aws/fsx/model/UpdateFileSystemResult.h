...
namespace Model
{
  ...
  {
  public:
    AWS_FSX_API UpdateFileSystemResult() = default;
    ...
    template<typename FileSystemT = FileSystem>
    UpdateFileSystemResult& WithFileSystem(FileSystemT&& value) { SetFileSystem(std::forward<FileSystemT>(value)); return *this;}
    ///@}
