...
class DescribeS3AccessPointAttachmentsResult {
 public:
  ...
  void SetS3AccessPointAttachments(S3AccessPointAttachmentsT&& value) {
    m_s3AccessPointAttachmentsHasBeenSet = true;
    m_s3AccessPointAttachments = std::forward<S3AccessPointAttachmentsT>(value);
  }
  template <typename S3AccessPointAttachmentsT = Aws::Vector<S3AccessPointAttachment>>
  DescribeS3AccessPointAttachmentsResult& WithS3AccessPointAttachments(S3AccessPointAttachmentsT&& value) {
    SetS3AccessPointAttachments(std::forward<S3AccessPointAttachmentsT>(value));
    return *this;
  }
  template <typename S3AccessPointAttachmentsT = S3AccessPointAttachment>
  DescribeS3AccessPointAttachmentsResult& AddS3AccessPointAttachments(S3AccessPointAttachmentsT&& value) {
    m_s3AccessPointAttachmentsHasBeenSet = true;
    m_s3AccessPointAttachments.emplace_back(std::forward<S3AccessPointAttachmentsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeS3AccessPointAttachmentsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeS3AccessPointAttachmentsResult& WithRequestId(RequestIdT&& value) {
