...
class CreateFileCacheRequest : public FSxRequest {
 public:
  ...
  inline CreateFileCacheRequest& WithFileCacheType(FileCacheType value) {
  ...
  inline CreateFileCacheRequest& WithStorageCapacity(int value) {
  ...
  inline void SetCopyTagsToDataRepositoryAssociations(bool value) {
    m_copyTagsToDataRepositoryAssociationsHasBeenSet = true;
    m_copyTagsToDataRepositoryAssociations = value;
  }
  inline CreateFileCacheRequest& WithCopyTagsToDataRepositoryAssociations(bool value) {
    SetCopyTagsToDataRepositoryAssociations(value);
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::Vector<FileCacheDataRepositoryAssociation>& GetDataRepositoryAssociations() const {
    return m_dataRepositoryAssociations;
  }
  ...
  void SetDataRepositoryAssociations(DataRepositoryAssociationsT&& value) {
    m_dataRepositoryAssociationsHasBeenSet = true;
    m_dataRepositoryAssociations = std::forward<DataRepositoryAssociationsT>(value);
  }
  template <typename DataRepositoryAssociationsT = Aws::Vector<FileCacheDataRepositoryAssociation>>
  CreateFileCacheRequest& WithDataRepositoryAssociations(DataRepositoryAssociationsT&& value) {
    SetDataRepositoryAssociations(std::forward<DataRepositoryAssociationsT>(value));
    return *this;
  }
  ...
  CreateFileCacheRequest& AddDataRepositoryAssociations(DataRepositoryAssociationsT&& value) {
    m_dataRepositoryAssociationsHasBeenSet = true;
    m_dataRepositoryAssociations.emplace_back(std::forward<DataRepositoryAssociationsT>(value));
    return *this;
  }
  ///@}
 private:
