...
class DescribeFileSystemAliasesRequest : public FSxRequest {
 public:
  ...
  template <typename ClientRequestTokenT = Aws::String>
  DescribeFileSystemAliasesRequest& WithClientRequestToken(ClientRequestTokenT&& value) {
  ...
  template <typename FileSystemIdT = Aws::String>
  DescribeFileSystemAliasesRequest& WithFileSystemId(FileSystemIdT&& value) {
  ...
  inline DescribeFileSystemAliasesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeFileSystemAliasesRequest& WithNextToken(NextTokenT&& value) {
