...
class RestoreVolumeFromSnapshotResult {
 public:
  ...
  template <typename VolumeIdT = Aws::String>
  RestoreVolumeFromSnapshotResult& WithVolumeId(VolumeIdT&& value) {
  ...
  inline RestoreVolumeFromSnapshotResult& WithLifecycle(VolumeLifecycle value) {
    SetLifecycle(value);
    return *this;
  }
  ///@}
  ...
  template <typename AdministrativeActionsT = Aws::Vector<AdministrativeAction>>
  RestoreVolumeFromSnapshotResult& WithAdministrativeActions(AdministrativeActionsT&& value) {
  ...
  RestoreVolumeFromSnapshotResult& AddAdministrativeActions(AdministrativeActionsT&& value) {
    m_administrativeActionsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  RestoreVolumeFromSnapshotResult& WithRequestId(RequestIdT&& value) {
