...
class CreateFileSystemRequest : public FSxRequest {
 public:
  ...
  inline CreateFileSystemRequest& WithFileSystemType(FileSystemType value) {
  ...
  inline CreateFileSystemRequest& WithStorageCapacity(int value) {
  ...
  inline CreateFileSystemRequest& WithStorageType(StorageType value) {
   ...
   * <code>IPV4</code>. Supported for FSx for OpenZFS, FSx for ONTAP, and FSx for
   * Windows File Server file systems.</p>
   */
  ...
  inline CreateFileSystemRequest& WithNetworkType(NetworkType value) {
