...
class CreateSvmActiveDirectoryConfiguration {
 public:
  ...
  template <typename NetBiosNameT = Aws::String>
  CreateSvmActiveDirectoryConfiguration& WithNetBiosName(NetBiosNameT&& value) {
  ...
  template <typename SelfManagedActiveDirectoryConfigurationT = SelfManagedActiveDirectoryConfiguration>
  CreateSvmActiveDirectoryConfiguration& WithSelfManagedActiveDirectoryConfiguration(SelfManagedActiveDirectoryConfigurationT&& value) {
