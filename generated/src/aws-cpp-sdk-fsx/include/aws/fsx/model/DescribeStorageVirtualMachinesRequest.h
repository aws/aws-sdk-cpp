...
class DescribeStorageVirtualMachinesRequest : public FSxRequest {
 public:
  ...
  void SetStorageVirtualMachineIds(StorageVirtualMachineIdsT&& value) {
    m_storageVirtualMachineIdsHasBeenSet = true;
    m_storageVirtualMachineIds = std::forward<StorageVirtualMachineIdsT>(value);
  }
  template <typename StorageVirtualMachineIdsT = Aws::Vector<Aws::String>>
  DescribeStorageVirtualMachinesRequest& WithStorageVirtualMachineIds(StorageVirtualMachineIdsT&& value) {
    SetStorageVirtualMachineIds(std::forward<StorageVirtualMachineIdsT>(value));
    return *this;
  }
  template <typename StorageVirtualMachineIdsT = Aws::String>
  DescribeStorageVirtualMachinesRequest& AddStorageVirtualMachineIds(StorageVirtualMachineIdsT&& value) {
    m_storageVirtualMachineIdsHasBeenSet = true;
    m_storageVirtualMachineIds.emplace_back(std::forward<StorageVirtualMachineIdsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<StorageVirtualMachineFilter>>
  DescribeStorageVirtualMachinesRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = StorageVirtualMachineFilter>
  DescribeStorageVirtualMachinesRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline DescribeStorageVirtualMachinesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeStorageVirtualMachinesRequest& WithNextToken(NextTokenT&& value) {
