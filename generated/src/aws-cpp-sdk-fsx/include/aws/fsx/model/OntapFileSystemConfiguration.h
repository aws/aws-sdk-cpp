...
class OntapFileSystemConfiguration {
 public:
  ...
  inline OntapFileSystemConfiguration& WithAutomaticBackupRetentionDays(int value) {
  ...
  inline void SetDeploymentType(OntapDeploymentType value) {
    m_deploymentTypeHasBeenSet = true;
    m_deploymentType = value;
  }
  inline OntapFileSystemConfiguration& WithDeploymentType(OntapDeploymentType value) {
  ...
  inline OntapFileSystemConfiguration& WithThroughputCapacity(int value) {
  ...
  inline OntapFileSystemConfiguration& WithHAPairs(int value) {
    SetHAPairs(value);
    return *this;
  }
  ///@}
  ...
  inline OntapFileSystemConfiguration& WithThroughputCapacityPerHAPair(int value) {
