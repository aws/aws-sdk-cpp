...
class WindowsAuditLogConfiguration {
 public:
  ...
  inline void SetFileAccessAuditLogLevel(WindowsAccessAuditLogLevel value) {
    m_fileAccessAuditLogLevelHasBeenSet = true;
    m_fileAccessAuditLogLevel = value;
  }
  inline WindowsAuditLogConfiguration& WithFileAccessAuditLogLevel(WindowsAccessAuditLogLevel value) {
    SetFileAccessAuditLogLevel(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFileShareAccessAuditLogLevel(WindowsAccessAuditLogLevel value) {
    m_fileShareAccessAuditLogLevelHasBeenSet = true;
    m_fileShareAccessAuditLogLevel = value;
  }
  inline WindowsAuditLogConfiguration& WithFileShareAccessAuditLogLevel(WindowsAccessAuditLogLevel value) {
    SetFileShareAccessAuditLogLevel(value);
    return *this;
  }
  ///@}
  ...
  void SetAuditLogDestination(AuditLogDestinationT&& value) {
    m_auditLogDestinationHasBeenSet = true;
    m_auditLogDestination = std::forward<AuditLogDestinationT>(value);
  }
  template <typename AuditLogDestinationT = Aws::String>
  WindowsAuditLogConfiguration& WithAuditLogDestination(AuditLogDestinationT&& value) {
    SetAuditLogDestination(std::forward<AuditLogDestinationT>(value));
    return *this;
  }
  ///@}
 private:
