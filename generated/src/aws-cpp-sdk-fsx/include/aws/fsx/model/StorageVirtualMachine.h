...
class StorageVirtualMachine {
 public:
  ...
  inline StorageVirtualMachine& WithLifecycle(StorageVirtualMachineLifecycle value) {
    SetLifecycle(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSubtype(StorageVirtualMachineSubtype value) {
    m_subtypeHasBeenSet = true;
    m_subtype = value;
  }
  inline StorageVirtualMachine& WithSubtype(StorageVirtualMachineSubtype value) {
    SetSubtype(value);
    return *this;
  }
  ///@}
  ...
  inline StorageVirtualMachine& WithRootVolumeSecurityStyle(StorageVirtualMachineRootVolumeSecurityStyle value) {
