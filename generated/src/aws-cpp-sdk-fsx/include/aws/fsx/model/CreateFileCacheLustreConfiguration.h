...
class CreateFileCacheLustreConfiguration {
 public:
  ...
  inline CreateFileCacheLustreConfiguration& WithPerUnitStorageThroughput(int value) {
  ...
  inline void SetDeploymentType(FileCacheLustreDeploymentType value) {
    m_deploymentTypeHasBeenSet = true;
    m_deploymentType = value;
  }
  inline CreateFileCacheLustreConfiguration& WithDeploymentType(FileCacheLustreDeploymentType value) {
