...
class FileCache {
 public:
  ...
  inline void SetFileCacheType(FileCacheType value) {
    m_fileCacheTypeHasBeenSet = true;
    m_fileCacheType = value;
  }
  inline FileCache& WithFileCacheType(FileCacheType value) {
    SetFileCacheType(value);
    return *this;
  }
  ///@}
  ...
  void SetFileCacheTypeVersion(FileCacheTypeVersionT&& value) {
    ...
    m_fileCacheTypeVersion = std::forward<FileCacheTypeVersionT>(value);
  }
  template <typename FileCacheTypeVersionT = Aws::String>
  FileCache& WithFileCacheTypeVersion(FileCacheTypeVersionT&& value) {
    SetFileCacheTypeVersion(std::forward<FileCacheTypeVersionT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetLifecycle(FileCacheLifecycle value) {
    m_lifecycleHasBeenSet = true;
    m_lifecycle = value;
  }
  inline FileCache& WithLifecycle(FileCacheLifecycle value) {
    SetLifecycle(value);
    return *this;
  }
  ///@}
  ...
  inline FileCache& WithStorageCapacity(int value) {
  ...
  void SetDataRepositoryAssociationIds(DataRepositoryAssociationIdsT&& value) {
    ...
    m_dataRepositoryAssociationIds = std::forward<DataRepositoryAssociationIdsT>(value);
  }
  template <typename DataRepositoryAssociationIdsT = Aws::Vector<Aws::String>>
  FileCache& WithDataRepositoryAssociationIds(DataRepositoryAssociationIdsT&& value) {
    SetDataRepositoryAssociationIds(std::forward<DataRepositoryAssociationIdsT>(value));
    return *this;
  }
  ...
  FileCache& AddDataRepositoryAssociationIds(DataRepositoryAssociationIdsT&& value) {
    m_dataRepositoryAssociationIdsHasBeenSet = true;
    m_dataRepositoryAssociationIds.emplace_back(std::forward<DataRepositoryAssociationIdsT>(value));
    return *this;
  }
  ///@}
 private:
