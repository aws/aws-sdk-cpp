...
class OpenZFSReadCacheConfiguration {
 public:
  ...
  inline void SetSizingMode(OpenZFSReadCacheSizingMode value) {
    m_sizingModeHasBeenSet = true;
    m_sizingMode = value;
  }
  inline OpenZFSReadCacheConfiguration& WithSizingMode(OpenZFSReadCacheSizingMode value) {
    SetSizingMode(value);
    return *this;
  }
  ///@}
  ...
  inline OpenZFSReadCacheConfiguration& WithSizeGiB(int value) {
    SetSizeGiB(value);
    return *this;
  }
  ///@}
