...
class DataRepositoryTaskFilter {
 public:
  ...
  inline void SetName(DataRepositoryTaskFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline DataRepositoryTaskFilter& WithName(DataRepositoryTaskFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  DataRepositoryTaskFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  DataRepositoryTaskFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
