...
class OpenZFSCreateRootVolumeConfiguration {
 public:
  ...
  inline OpenZFSCreateRootVolumeConfiguration& WithRecordSizeKiB(int value) {
  ...
  inline OpenZFSCreateRootVolumeConfiguration& WithDataCompressionType(OpenZFSDataCompressionType value) {
  ...
  template <typename NfsExportsT = Aws::Vector<OpenZFSNfsExport>>
  OpenZFSCreateRootVolumeConfiguration& WithNfsExports(NfsExportsT&& value) {
    SetNfsExports(std::forward<NfsExportsT>(value));
    return *this;
  }
  template <typename NfsExportsT = OpenZFSNfsExport>
  OpenZFSCreateRootVolumeConfiguration& AddNfsExports(NfsExportsT&& value) {
    m_nfsExportsHasBeenSet = true;
  ...
  template <typename UserAndGroupQuotasT = Aws::Vector<OpenZFSUserOrGroupQuota>>
  OpenZFSCreateRootVolumeConfiguration& WithUserAndGroupQuotas(UserAndGroupQuotasT&& value) {
    SetUserAndGroupQuotas(std::forward<UserAndGroupQuotasT>(value));
    return *this;
  }
  template <typename UserAndGroupQuotasT = OpenZFSUserOrGroupQuota>
  OpenZFSCreateRootVolumeConfiguration& AddUserAndGroupQuotas(UserAndGroupQuotasT&& value) {
    m_userAndGroupQuotasHasBeenSet = true;
  ...
  inline void SetCopyTagsToSnapshots(bool value) {
    m_copyTagsToSnapshotsHasBeenSet = true;
    m_copyTagsToSnapshots = value;
  }
  inline OpenZFSCreateRootVolumeConfiguration& WithCopyTagsToSnapshots(bool value) {
    SetCopyTagsToSnapshots(value);
    return *this;
  }
  ///@}
  ...
  inline OpenZFSCreateRootVolumeConfiguration& WithReadOnly(bool value) {
    SetReadOnly(value);
    return *this;
  }
  ///@}
