...
class DeleteDataRepositoryAssociationResult {
 public:
  ...
  template <typename AssociationIdT = Aws::String>
  DeleteDataRepositoryAssociationResult& WithAssociationId(AssociationIdT&& value) {
  ...
  inline DeleteDataRepositoryAssociationResult& WithLifecycle(DataRepositoryLifecycle value) {
    SetLifecycle(value);
    return *this;
  }
  ///@}
  ...
  inline DeleteDataRepositoryAssociationResult& WithDeleteDataInFileSystem(bool value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteDataRepositoryAssociationResult& WithRequestId(RequestIdT&& value) {
