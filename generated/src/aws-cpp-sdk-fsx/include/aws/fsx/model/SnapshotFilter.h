...
class SnapshotFilter {
 public:
  ...
  inline void SetName(SnapshotFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline SnapshotFilter& WithName(SnapshotFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  SnapshotFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  SnapshotFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
