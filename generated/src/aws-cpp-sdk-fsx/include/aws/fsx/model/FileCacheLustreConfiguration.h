...
class FileCacheLustreConfiguration {
 public:
  ...
  inline FileCacheLustreConfiguration& WithPerUnitStorageThroughput(int value) {
  ...
  inline FileCacheLustreConfiguration& WithDeploymentType(FileCacheLustreDeploymentType value) {
