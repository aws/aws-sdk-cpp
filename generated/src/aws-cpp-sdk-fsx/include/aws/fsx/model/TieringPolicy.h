...
class TieringPolicy {
 public:
  ...
  inline void SetCoolingPeriod(int value) {
    m_coolingPeriodHasBeenSet = true;
    m_coolingPeriod = value;
  }
  inline TieringPolicy& WithCoolingPeriod(int value) {
    SetCoolingPeriod(value);
    return *this;
  }
  ///@}
  ...
  inline void SetName(TieringPolicyName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline TieringPolicy& WithName(TieringPolicyName value) {
    SetName(value);
    return *this;
  }
  ///@}
