...
class DescribeFileSystemsRequest : public FSxRequest {
 public:
  ...
  inline DescribeFileSystemsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
