...
class CreateFileSystemLustreConfiguration {
 public:
  ...
  inline CreateFileSystemLustreConfiguration& WithImportedFileChunkSize(int value) {
  ...
  inline CreateFileSystemLustreConfiguration& WithDeploymentType(LustreDeploymentType value) {
  ...
  inline CreateFileSystemLustreConfiguration& WithAutoImportPolicy(AutoImportPolicyType value) {
  ...
  inline CreateFileSystemLustreConfiguration& WithPerUnitStorageThroughput(int value) {
  ...
  inline CreateFileSystemLustreConfiguration& WithAutomaticBackupRetentionDays(int value) {
  ...
  inline CreateFileSystemLustreConfiguration& WithCopyTagsToBackups(bool value) {
  ...
  inline CreateFileSystemLustreConfiguration& WithDriveCacheType(DriveCacheType value) {
  ...
  inline CreateFileSystemLustreConfiguration& WithDataCompressionType(DataCompressionType value) {
  ...
  inline CreateFileSystemLustreConfiguration& WithEfaEnabled(bool value) {
    SetEfaEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline CreateFileSystemLustreConfiguration& WithThroughputCapacity(int value) {
