...
class UpdateFileSystemWindowsConfiguration {
 public:
  ...
  inline UpdateFileSystemWindowsConfiguration& WithAutomaticBackupRetentionDays(int value) {
  ...
  inline UpdateFileSystemWindowsConfiguration& WithThroughputCapacity(int value) {
