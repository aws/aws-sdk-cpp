...
class DescribeDataRepositoryTasksRequest : public FSxRequest {
 public:
  ...
  template <typename TaskIdsT = Aws::Vector<Aws::String>>
  DescribeDataRepositoryTasksRequest& WithTaskIds(TaskIdsT&& value) {
    SetTaskIds(std::forward<TaskIdsT>(value));
    return *this;
  }
  template <typename TaskIdsT = Aws::String>
  DescribeDataRepositoryTasksRequest& AddTaskIds(TaskIdsT&& value) {
    m_taskIdsHasBeenSet = true;
  ...
  template <typename FiltersT = Aws::Vector<DataRepositoryTaskFilter>>
  DescribeDataRepositoryTasksRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = DataRepositoryTaskFilter>
  DescribeDataRepositoryTasksRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline DescribeDataRepositoryTasksRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeDataRepositoryTasksRequest& WithNextToken(NextTokenT&& value) {
