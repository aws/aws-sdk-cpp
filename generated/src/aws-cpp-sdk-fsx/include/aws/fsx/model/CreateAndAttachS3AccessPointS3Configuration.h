...
class CreateAndAttachS3AccessPointS3Configuration {
 public:
  ...
  template <typename VpcConfigurationT = S3AccessPointVpcConfiguration>
  CreateAndAttachS3AccessPointS3Configuration& WithVpcConfiguration(VpcConfigurationT&& value) {
  ...
  template <typename PolicyT = Aws::String>
  CreateAndAttachS3AccessPointS3Configuration& WithPolicy(PolicyT&& value) {
