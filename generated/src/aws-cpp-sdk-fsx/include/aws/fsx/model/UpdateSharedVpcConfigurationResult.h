...
namespace Model
{
  ...
  {
  public:
    AWS_FSX_API UpdateSharedVpcConfigurationResult() = default;
    ...
    template<typename EnableFsxRouteTableUpdatesFromParticipantAccountsT = Aws::String>
    UpdateSharedVpcConfigurationResult& WithEnableFsxRouteTableUpdatesFromParticipantAccounts(EnableFsxRouteTableUpdatesFromParticipantAccountsT&& value) { SetEnableFsxRouteTableUpdatesFromParticipantAccounts(std::forward<EnableFsxRouteTableUpdatesFromParticipantAccountsT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateSharedVpcConfigurationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
