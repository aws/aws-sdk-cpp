...
namespace Model
{
  ...
  public:
    ...
    template<typename NamesT = Aws::Vector<Aws::String>>
    DescribeS3AccessPointAttachmentsRequest& WithNames(NamesT&& value) { SetNames(std::forward<NamesT>(value)); return *this;}
    template<typename NamesT = Aws::String>
    DescribeS3AccessPointAttachmentsRequest& AddNames(NamesT&& value) { m_namesHasBeenSet = true; m_names.emplace_back(std::forward<NamesT>(value)); return *this; }
    ///@}
    ...
    template<typename FiltersT = Aws::Vector<S3AccessPointAttachmentsFilter>>
    DescribeS3AccessPointAttachmentsRequest& WithFilters(FiltersT&& value) { SetFilters(std::forward<FiltersT>(value)); return *this;}
    template<typename FiltersT = S3AccessPointAttachmentsFilter>
    DescribeS3AccessPointAttachmentsRequest& AddFilters(FiltersT&& value) { m_filtersHasBeenSet = true; m_filters.emplace_back(std::forward<FiltersT>(value)); return *this; }
    ///@}
    ...
    inline DescribeS3AccessPointAttachmentsRequest& WithMaxResults(int value) { SetMaxResults(value); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    DescribeS3AccessPointAttachmentsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
