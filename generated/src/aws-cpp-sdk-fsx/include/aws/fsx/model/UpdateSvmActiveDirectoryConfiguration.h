...
class UpdateSvmActiveDirectoryConfiguration {
 public:
  ...
  inline const SelfManagedActiveDirectoryConfigurationUpdates& GetSelfManagedActiveDirectoryConfiguration() const {
  ...
  template <typename SelfManagedActiveDirectoryConfigurationT = SelfManagedActiveDirectoryConfigurationUpdates>
  UpdateSvmActiveDirectoryConfiguration& WithSelfManagedActiveDirectoryConfiguration(SelfManagedActiveDirectoryConfigurationT&& value) {
  ...
  template <typename NetBiosNameT = Aws::String>
  UpdateSvmActiveDirectoryConfiguration& WithNetBiosName(NetBiosNameT&& value) {
