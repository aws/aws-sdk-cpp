...
class DeleteStorageVirtualMachineResult {
 public:
  ...
  template <typename StorageVirtualMachineIdT = Aws::String>
  DeleteStorageVirtualMachineResult& WithStorageVirtualMachineId(StorageVirtualMachineIdT&& value) {
  ...
  inline void SetLifecycle(StorageVirtualMachineLifecycle value) {
    m_lifecycleHasBeenSet = true;
    m_lifecycle = value;
  }
  inline DeleteStorageVirtualMachineResult& WithLifecycle(StorageVirtualMachineLifecycle value) {
    SetLifecycle(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DeleteStorageVirtualMachineResult& WithRequestId(RequestIdT&& value) {
