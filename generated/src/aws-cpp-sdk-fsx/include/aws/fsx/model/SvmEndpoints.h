...
class SvmEndpoints {
 public:
  ...
  void SetIscsi(IscsiT&& value) {
    ...
    m_iscsi = std::forward<IscsiT>(value);
  }
  template <typename IscsiT = SvmEndpoint>
  SvmEndpoints& WithIscsi(IscsiT&& value) {
    SetIscsi(std::forward<IscsiT>(value));
    return *this;
  }
  ///@}
  ...
  void SetManagement(ManagementT&& value) {
    ...
    m_management = std::forward<ManagementT>(value);
  }
  template <typename ManagementT = SvmEndpoint>
  SvmEndpoints& WithManagement(ManagementT&& value) {
    SetManagement(std::forward<ManagementT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNfs(NfsT&& value) {
    ...
    m_nfs = std::forward<NfsT>(value);
  }
  template <typename NfsT = SvmEndpoint>
  SvmEndpoints& WithNfs(NfsT&& value) {
    SetNfs(std::forward<NfsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSmb(SmbT&& value) {
    ...
    m_smb = std::forward<SmbT>(value);
  }
  template <typename SmbT = SvmEndpoint>
  SvmEndpoints& WithSmb(SmbT&& value) {
    SetSmb(std::forward<SmbT>(value));
    return *this;
  }
  ///@}
 private:
