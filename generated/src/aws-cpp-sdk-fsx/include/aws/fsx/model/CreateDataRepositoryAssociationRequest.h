...
class CreateDataRepositoryAssociationRequest : public FSxRequest {
 public:
  ...
  inline void SetBatchImportMetaDataOnCreate(bool value) {
    m_batchImportMetaDataOnCreateHasBeenSet = true;
    m_batchImportMetaDataOnCreate = value;
  }
  inline CreateDataRepositoryAssociationRequest& WithBatchImportMetaDataOnCreate(bool value) {
    SetBatchImportMetaDataOnCreate(value);
    return *this;
  }
  ///@}
  ...
  inline CreateDataRepositoryAssociationRequest& WithImportedFileChunkSize(int value) {
