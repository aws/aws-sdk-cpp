...
class OpenZFSVolumeConfiguration {
 public:
  ...
  void SetParentVolumeId(ParentVolumeIdT&& value) {
    ...
    m_parentVolumeId = std::forward<ParentVolumeIdT>(value);
  }
  template <typename ParentVolumeIdT = Aws::String>
  OpenZFSVolumeConfiguration& WithParentVolumeId(ParentVolumeIdT&& value) {
    SetParentVolumeId(std::forward<ParentVolumeIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVolumePath(VolumePathT&& value) {
    ...
    m_volumePath = std::forward<VolumePathT>(value);
  }
  template <typename VolumePathT = Aws::String>
  OpenZFSVolumeConfiguration& WithVolumePath(VolumePathT&& value) {
    SetVolumePath(std::forward<VolumePathT>(value));
    return *this;
  }
  ///@}
  ...
  inline OpenZFSVolumeConfiguration& WithStorageCapacityReservationGiB(int value) {
  ...
  inline OpenZFSVolumeConfiguration& WithStorageCapacityQuotaGiB(int value) {
  ...
  inline OpenZFSVolumeConfiguration& WithRecordSizeKiB(int value) {
  ...
  inline OpenZFSVolumeConfiguration& WithDataCompressionType(OpenZFSDataCompressionType value) {
  ...
  inline OpenZFSVolumeConfiguration& WithCopyTagsToSnapshots(bool value) {
  ...
  void SetOriginSnapshot(OriginSnapshotT&& value) {
    ...
    m_originSnapshot = std::forward<OriginSnapshotT>(value);
  }
  template <typename OriginSnapshotT = OpenZFSOriginSnapshotConfiguration>
  OpenZFSVolumeConfiguration& WithOriginSnapshot(OriginSnapshotT&& value) {
    SetOriginSnapshot(std::forward<OriginSnapshotT>(value));
    return *this;
  }
  ///@}
  ...
  inline OpenZFSVolumeConfiguration& WithReadOnly(bool value) {
    SetReadOnly(value);
    return *this;
  }
  ///@}
  ...
  void SetRestoreToSnapshot(RestoreToSnapshotT&& value) {
    ...
    m_restoreToSnapshot = std::forward<RestoreToSnapshotT>(value);
  }
  template <typename RestoreToSnapshotT = Aws::String>
  OpenZFSVolumeConfiguration& WithRestoreToSnapshot(RestoreToSnapshotT&& value) {
    SetRestoreToSnapshot(std::forward<RestoreToSnapshotT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetDeleteIntermediateSnaphots(bool value) {
    m_deleteIntermediateSnaphotsHasBeenSet = true;
    m_deleteIntermediateSnaphots = value;
  }
  inline OpenZFSVolumeConfiguration& WithDeleteIntermediateSnaphots(bool value) {
    SetDeleteIntermediateSnaphots(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDeleteClonedVolumes(bool value) {
    m_deleteClonedVolumesHasBeenSet = true;
    m_deleteClonedVolumes = value;
  }
  inline OpenZFSVolumeConfiguration& WithDeleteClonedVolumes(bool value) {
    SetDeleteClonedVolumes(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDeleteIntermediateData(bool value) {
    m_deleteIntermediateDataHasBeenSet = true;
    m_deleteIntermediateData = value;
  }
  inline OpenZFSVolumeConfiguration& WithDeleteIntermediateData(bool value) {
    SetDeleteIntermediateData(value);
    return *this;
  }
  ///@}
  ...
  void SetDestinationSnapshot(DestinationSnapshotT&& value) {
    ...
    m_destinationSnapshot = std::forward<DestinationSnapshotT>(value);
  }
  template <typename DestinationSnapshotT = Aws::String>
  OpenZFSVolumeConfiguration& WithDestinationSnapshot(DestinationSnapshotT&& value) {
    SetDestinationSnapshot(std::forward<DestinationSnapshotT>(value));
    return *this;
  }
  ///@}
  ...
  inline OpenZFSVolumeConfiguration& WithCopyStrategy(OpenZFSCopyStrategy value) {
