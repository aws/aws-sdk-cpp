...
class StorageVirtualMachineFilter {
 public:
  ...
  inline void SetName(StorageVirtualMachineFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline StorageVirtualMachineFilter& WithName(StorageVirtualMachineFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  StorageVirtualMachineFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  StorageVirtualMachineFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
