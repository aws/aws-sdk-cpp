...
class DataRepositoryAssociation {
 public:
  ...
  inline DataRepositoryAssociation& WithLifecycle(DataRepositoryLifecycle value) {
    SetLifecycle(value);
    return *this;
  }
  ///@}
  ...
  inline DataRepositoryAssociation& WithBatchImportMetaDataOnCreate(bool value) {
  ...
  inline DataRepositoryAssociation& WithImportedFileChunkSize(int value) {
