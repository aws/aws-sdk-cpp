...
class CreateStorageVirtualMachineResult {
 public:
  ...
  template <typename StorageVirtualMachineT = StorageVirtualMachine>
  CreateStorageVirtualMachineResult& WithStorageVirtualMachine(StorageVirtualMachineT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateStorageVirtualMachineResult& WithRequestId(RequestIdT&& value) {
