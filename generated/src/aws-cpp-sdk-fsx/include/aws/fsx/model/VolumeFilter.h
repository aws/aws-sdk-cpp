...
class VolumeFilter {
 public:
  ...
  inline void SetName(VolumeFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline VolumeFilter& WithName(VolumeFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  VolumeFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  VolumeFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
