...
class AssociateFileSystemAliasesRequest : public FSxRequest {
 public:
  ...
  template <typename ClientRequestTokenT = Aws::String>
  AssociateFileSystemAliasesRequest& WithClientRequestToken(ClientRequestTokenT&& value) {
  ...
  template <typename FileSystemIdT = Aws::String>
  AssociateFileSystemAliasesRequest& WithFileSystemId(FileSystemIdT&& value) {
  ...
  template <typename AliasesT = Aws::Vector<Aws::String>>
  AssociateFileSystemAliasesRequest& WithAliases(AliasesT&& value) {
    SetAliases(std::forward<AliasesT>(value));
    return *this;
  }
  template <typename AliasesT = Aws::String>
  AssociateFileSystemAliasesRequest& AddAliases(AliasesT&& value) {
    m_aliasesHasBeenSet = true;
