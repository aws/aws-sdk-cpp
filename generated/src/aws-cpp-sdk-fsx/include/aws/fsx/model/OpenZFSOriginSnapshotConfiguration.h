...
class OpenZFSOriginSnapshotConfiguration {
 public:
  ...
  template <typename SnapshotARNT = Aws::String>
  OpenZFSOriginSnapshotConfiguration& WithSnapshotARN(SnapshotARNT&& value) {
  ...
  inline OpenZFSOriginSnapshotConfiguration& WithCopyStrategy(OpenZFSCopyStrategy value) {
