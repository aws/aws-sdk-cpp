...
class NFSDataRepositoryConfiguration {
 public:
  ...
  inline NFSDataRepositoryConfiguration& WithVersion(NfsVersion value) {
    SetVersion(value);
    return *this;
  }
  ///@}
  ...
  template <typename DnsIpsT = Aws::Vector<Aws::String>>
  NFSDataRepositoryConfiguration& WithDnsIps(DnsIpsT&& value) {
    SetDnsIps(std::forward<DnsIpsT>(value));
    return *this;
  }
  template <typename DnsIpsT = Aws::String>
  NFSDataRepositoryConfiguration& AddDnsIps(DnsIpsT&& value) {
    m_dnsIpsHasBeenSet = true;
  ...
  void SetAutoExportPolicy(AutoExportPolicyT&& value) {
    m_autoExportPolicyHasBeenSet = true;
    m_autoExportPolicy = std::forward<AutoExportPolicyT>(value);
  }
  template <typename AutoExportPolicyT = AutoExportPolicy>
  NFSDataRepositoryConfiguration& WithAutoExportPolicy(AutoExportPolicyT&& value) {
    SetAutoExportPolicy(std::forward<AutoExportPolicyT>(value));
    return *this;
  }
  ///@}
 private:
