...
class CreateSnaplockConfiguration {
 public:
  ...
  inline void SetAuditLogVolume(bool value) {
    m_auditLogVolumeHasBeenSet = true;
    m_auditLogVolume = value;
  }
  inline CreateSnaplockConfiguration& WithAuditLogVolume(bool value) {
    SetAuditLogVolume(value);
    return *this;
  }
  ///@}
  ...
  void SetAutocommitPeriod(AutocommitPeriodT&& value) {
    ...
    m_autocommitPeriod = std::forward<AutocommitPeriodT>(value);
  }
  template <typename AutocommitPeriodT = AutocommitPeriod>
  CreateSnaplockConfiguration& WithAutocommitPeriod(AutocommitPeriodT&& value) {
    SetAutocommitPeriod(std::forward<AutocommitPeriodT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetPrivilegedDelete(PrivilegedDelete value) {
    m_privilegedDeleteHasBeenSet = true;
    m_privilegedDelete = value;
  }
  inline CreateSnaplockConfiguration& WithPrivilegedDelete(PrivilegedDelete value) {
    SetPrivilegedDelete(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSnaplockType(SnaplockType value) {
    m_snaplockTypeHasBeenSet = true;
    m_snaplockType = value;
  }
  inline CreateSnaplockConfiguration& WithSnaplockType(SnaplockType value) {
    SetSnaplockType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetVolumeAppendModeEnabled(bool value) {
    m_volumeAppendModeEnabledHasBeenSet = true;
    m_volumeAppendModeEnabled = value;
  }
  inline CreateSnaplockConfiguration& WithVolumeAppendModeEnabled(bool value) {
    SetVolumeAppendModeEnabled(value);
    return *this;
  }
  ///@}
 private:
