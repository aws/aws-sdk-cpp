...
class CompletionReport {
 public:
  ...
  inline CompletionReport& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFormat(ReportFormat value) {
    m_formatHasBeenSet = true;
    m_format = value;
  }
  inline CompletionReport& WithFormat(ReportFormat value) {
    SetFormat(value);
    return *this;
  }
  ///@}
  ...
  inline void SetScope(ReportScope value) {
    m_scopeHasBeenSet = true;
    m_scope = value;
  }
  inline CompletionReport& WithScope(ReportScope value) {
    SetScope(value);
    return *this;
  }
  ///@}
