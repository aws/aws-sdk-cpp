...
class SelfManagedActiveDirectoryConfiguration {
 public:
  ...
  template <typename DomainNameT = Aws::String>
  SelfManagedActiveDirectoryConfiguration& WithDomainName(DomainNameT&& value) {
  ...
  template <typename OrganizationalUnitDistinguishedNameT = Aws::String>
  SelfManagedActiveDirectoryConfiguration& WithOrganizationalUnitDistinguishedName(OrganizationalUnitDistinguishedNameT&& value) {
  ...
  template <typename FileSystemAdministratorsGroupT = Aws::String>
  SelfManagedActiveDirectoryConfiguration& WithFileSystemAdministratorsGroup(FileSystemAdministratorsGroupT&& value) {
  ...
  template <typename UserNameT = Aws::String>
  SelfManagedActiveDirectoryConfiguration& WithUserName(UserNameT&& value) {
  ...
  template <typename PasswordT = Aws::String>
  SelfManagedActiveDirectoryConfiguration& WithPassword(PasswordT&& value) {
  ...
  template <typename DnsIpsT = Aws::Vector<Aws::String>>
  SelfManagedActiveDirectoryConfiguration& WithDnsIps(DnsIpsT&& value) {
    SetDnsIps(std::forward<DnsIpsT>(value));
    return *this;
  }
  template <typename DnsIpsT = Aws::String>
  SelfManagedActiveDirectoryConfiguration& AddDnsIps(DnsIpsT&& value) {
    m_dnsIpsHasBeenSet = true;
