...
class CreateFileSystemOntapConfiguration {
 public:
  ...
  inline CreateFileSystemOntapConfiguration& WithAutomaticBackupRetentionDays(int value) {
  ...
  inline CreateFileSystemOntapConfiguration& WithDeploymentType(OntapDeploymentType value) {
  ...
  inline CreateFileSystemOntapConfiguration& WithThroughputCapacity(int value) {
  ...
  inline CreateFileSystemOntapConfiguration& WithHAPairs(int value) {
    SetHAPairs(value);
    return *this;
  }
  ///@}
  ...
  inline CreateFileSystemOntapConfiguration& WithThroughputCapacityPerHAPair(int value) {
