...
class WindowsAuditLogCreateConfiguration {
 public:
  ...
  inline WindowsAuditLogCreateConfiguration& WithFileAccessAuditLogLevel(WindowsAccessAuditLogLevel value) {
  ...
  inline WindowsAuditLogCreateConfiguration& WithFileShareAccessAuditLogLevel(WindowsAccessAuditLogLevel value) {
