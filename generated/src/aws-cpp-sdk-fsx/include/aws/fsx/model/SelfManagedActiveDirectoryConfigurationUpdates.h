...
class SelfManagedActiveDirectoryConfigurationUpdates {
 public:
  ...
  template <typename UserNameT = Aws::String>
  SelfManagedActiveDirectoryConfigurationUpdates& WithUserName(UserNameT&& value) {
  ...
  template <typename PasswordT = Aws::String>
  SelfManagedActiveDirectoryConfigurationUpdates& WithPassword(PasswordT&& value) {
  ...
  template <typename DnsIpsT = Aws::Vector<Aws::String>>
  SelfManagedActiveDirectoryConfigurationUpdates& WithDnsIps(DnsIpsT&& value) {
    SetDnsIps(std::forward<DnsIpsT>(value));
    return *this;
  }
  template <typename DnsIpsT = Aws::String>
  SelfManagedActiveDirectoryConfigurationUpdates& AddDnsIps(DnsIpsT&& value) {
    m_dnsIpsHasBeenSet = true;
  ...
  template <typename DomainNameT = Aws::String>
  SelfManagedActiveDirectoryConfigurationUpdates& WithDomainName(DomainNameT&& value) {
  ...
  template <typename OrganizationalUnitDistinguishedNameT = Aws::String>
  SelfManagedActiveDirectoryConfigurationUpdates& WithOrganizationalUnitDistinguishedName(OrganizationalUnitDistinguishedNameT&& value) {
  ...
  template <typename FileSystemAdministratorsGroupT = Aws::String>
  SelfManagedActiveDirectoryConfigurationUpdates& WithFileSystemAdministratorsGroup(FileSystemAdministratorsGroupT&& value) {
