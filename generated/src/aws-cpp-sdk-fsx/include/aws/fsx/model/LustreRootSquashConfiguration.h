...
class LustreRootSquashConfiguration {
 public:
  ...
  void SetRootSquash(RootSquashT&& value) {
    ...
    m_rootSquash = std::forward<RootSquashT>(value);
  }
  template <typename RootSquashT = Aws::String>
  LustreRootSquashConfiguration& WithRootSquash(RootSquashT&& value) {
    SetRootSquash(std::forward<RootSquashT>(value));
    return *this;
  }
  ///@}
