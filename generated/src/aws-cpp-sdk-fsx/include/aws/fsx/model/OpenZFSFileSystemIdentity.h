...
class OpenZFSFileSystemIdentity {
 public:
  ...
  inline void SetType(OpenZFSFileSystemUserType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline OpenZFSFileSystemIdentity& WithType(OpenZFSFileSystemUserType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename PosixUserT = OpenZFSPosixFileSystemUser>
  OpenZFSFileSystemIdentity& WithPosixUser(PosixUserT&& value) {
