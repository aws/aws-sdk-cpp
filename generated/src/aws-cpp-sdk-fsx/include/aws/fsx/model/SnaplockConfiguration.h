...
class SnaplockConfiguration {
 public:
  ...
  inline SnaplockConfiguration& WithAuditLogVolume(bool value) {
  ...
  inline SnaplockConfiguration& WithPrivilegedDelete(PrivilegedDelete value) {
  ...
  inline SnaplockConfiguration& WithSnaplockType(SnaplockType value) {
  ...
  inline SnaplockConfiguration& WithVolumeAppendModeEnabled(bool value) {
