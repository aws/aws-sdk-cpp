...
class CreateFileSystemLustreMetadataConfiguration {
 public:
  ...
  inline CreateFileSystemLustreMetadataConfiguration& WithIops(int value) {
    SetIops(value);
    return *this;
  }
  ///@}
  ...
  inline CreateFileSystemLustreMetadataConfiguration& WithMode(MetadataConfigurationMode value) {
    SetMode(value);
    return *this;
  }
  ///@}
