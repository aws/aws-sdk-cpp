...
class FileCacheCreating {
 public:
  ...
  inline FileCacheCreating& WithFileCacheType(FileCacheType value) {
  ...
  inline FileCacheCreating& WithLifecycle(FileCacheLifecycle value) {
    SetLifecycle(value);
    return *this;
  }
  ///@}
  ...
  inline FileCacheCreating& WithStorageCapacity(int value) {
  ...
  inline FileCacheCreating& WithCopyTagsToDataRepositoryAssociations(bool value) {
