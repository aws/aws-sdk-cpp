...
class CopySnapshotAndUpdateVolumeRequest : public FSxRequest {
 public:
  ...
  void SetSourceSnapshotARN(SourceSnapshotARNT&& value) {
    ...
    m_sourceSnapshotARN = std::forward<SourceSnapshotARNT>(value);
  }
  template <typename SourceSnapshotARNT = Aws::String>
  CopySnapshotAndUpdateVolumeRequest& WithSourceSnapshotARN(SourceSnapshotARNT&& value) {
    SetSourceSnapshotARN(std::forward<SourceSnapshotARNT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetCopyStrategy(OpenZFSCopyStrategy value) {
    m_copyStrategyHasBeenSet = true;
    m_copyStrategy = value;
  }
  inline CopySnapshotAndUpdateVolumeRequest& WithCopyStrategy(OpenZFSCopyStrategy value) {
    SetCopyStrategy(value);
    return *this;
  }
  ///@}
  ...
  inline CopySnapshotAndUpdateVolumeRequest& AddOptions(UpdateOpenZFSVolumeOption value) {
    m_optionsHasBeenSet = true;
