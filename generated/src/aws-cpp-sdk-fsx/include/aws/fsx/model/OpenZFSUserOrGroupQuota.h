...
class OpenZFSUserOrGroupQuota {
 public:
  ...
  inline void SetType(OpenZFSQuotaType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline OpenZFSUserOrGroupQuota& WithType(OpenZFSQuotaType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline OpenZFSUserOrGroupQuota& WithId(int value) {
    SetId(value);
    return *this;
  }
  ///@}
  ...
  inline OpenZFSUserOrGroupQuota& WithStorageCapacityQuotaGiB(int value) {
