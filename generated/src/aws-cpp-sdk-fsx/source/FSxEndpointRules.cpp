...
namespace FSx
{
const size_t FSxEndpointRules::RulesBlobStrLen = 3712;
const size_t FSxEndpointRules::RulesBlobSize = 3713;
...
't','p','s',':','/','/','f','s','x','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i',
