...
UpdateFileSystemOpenZFSConfiguration::UpdateFileSystemOpenZFSConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
UpdateFileSystemOpenZFSConfiguration& UpdateFileSystemOpenZFSConfiguration::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("RemoveRouteTableIds")) {
    ...
    for (unsigned removeRouteTableIdsIndex = 0; removeRouteTableIdsIndex < removeRouteTableIdsJsonList.GetLength();
         ++removeRouteTableIdsIndex) {
