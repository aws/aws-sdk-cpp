...
Aws::String CreateFileCacheRequest::SerializePayload() const {
  ...
  if (m_dataRepositoryAssociationsHasBeenSet) {
    ...
    for (unsigned dataRepositoryAssociationsIndex = 0; dataRepositoryAssociationsIndex < dataRepositoryAssociationsJsonList.GetLength();
         ++dataRepositoryAssociationsIndex) {
      dataRepositoryAssociationsJsonList[dataRepositoryAssociationsIndex].AsObject(
          m_dataRepositoryAssociations[dataRepositoryAssociationsIndex].Jsonize());
    }
