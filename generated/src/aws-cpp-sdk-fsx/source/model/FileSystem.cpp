...
FileSystem::FileSystem(JsonView jsonValue) { *this = jsonValue; }
...
FileSystem& FileSystem::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("AdministrativeActions")) {
    ...
    for (unsigned administrativeActionsIndex = 0; administrativeActionsIndex < administrativeActionsJsonList.GetLength();
         ++administrativeActionsIndex) {
