...
OpenZFSNfsExport::OpenZFSNfsExport(JsonView jsonValue) { *this = jsonValue; }
...
OpenZFSNfsExport& OpenZFSNfsExport::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("ClientConfigurations")) {
    ...
    for (unsigned clientConfigurationsIndex = 0; clientConfigurationsIndex < clientConfigurationsJsonList.GetLength();
         ++clientConfigurationsIndex) {
