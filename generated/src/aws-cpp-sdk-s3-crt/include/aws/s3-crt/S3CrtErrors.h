...
public:
  ...
  S3CrtError(const Aws::Client::AWSError<S3CrtErrors>& rhs) : Aws::Client::AWSError<S3CrtErrors>(rhs) {}
  S3CrtError(Aws::Client::AWSError<S3CrtErrors>&& rhs) : Aws::Client::AWSError<S3CrtErrors>(rhs) {}
