...
class GetBucketPolicyStatusRequest : public S3CrtRequest {
 public:
  AWS_S3CRT_API GetBucketPolicyStatusRequest() = default;
  ...
  template <typename BucketT = Aws::String>
  GetBucketPolicyStatusRequest& WithBucket(BucketT&& value) {
  ...
  template <typename ExpectedBucketOwnerT = Aws::String>
  GetBucketPolicyStatusRequest& WithExpectedBucketOwner(ExpectedBucketOwnerT&& value) {
  ...
  template <typename CustomizedAccessLogTagT = Aws::Map<Aws::String, Aws::String>>
  GetBucketPolicyStatusRequest& WithCustomizedAccessLogTag(CustomizedAccessLogTagT&& value) {
