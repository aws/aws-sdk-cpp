...
class Checksum {
 public:
  ...
  ///@{
  /**
   * <p>The Base64 encoded, 512-bit <code>SHA512</code> digest of the object. This
   * checksum is present if the object was uploaded with the <code>SHA512</code>
  ...
  ///@{
  /**
   * <p>The Base64 encoded, 128-bit <code>MD5</code> digest of the object. This
   * checksum is present if the object was uploaded with the <code>MD5</code>
   * checksum algorithm. For more information, see <a
   * href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html">Checking
   * object integrity</a> in the <i>Amazon S3 User Guide</i>.</p>
   */
  ...
  ///@{
  /**
   * <p>The Base64 encoded, 64-bit <code>XXHASH64</code> checksum of the object. This
   * checksum is present if the object was uploaded with the <code>XXHASH64</code>
   * checksum algorithm. For more information, see <a
   * href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html">Checking
   * object integrity</a> in the <i>Amazon S3 User Guide</i>.</p>
   */
  ...
  ///@{
  /**
   * <p>The Base64 encoded, 64-bit <code>XXHASH3</code> checksum of the object. This
   * checksum is present if the object was uploaded with the <code>XXHASH3</code>
   * checksum algorithm. For more information, see <a
   * href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html">Checking
   * object integrity</a> in the <i>Amazon S3 User Guide</i>.</p>
   */
