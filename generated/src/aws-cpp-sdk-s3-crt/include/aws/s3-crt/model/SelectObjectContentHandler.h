...
namespace S3Crt {
namespace Model {
enum class SelectObjectContentEventType { INITIAL_RESPONSE, RECORDS, STATS, PROGRESS, CONT, END, UNKNOWN };
...
class SelectObjectContentHandler : public Aws::Utils::Event::EventStreamHandler {
  ...
  typedef std::function<void(const SelectObjectContentInitialResponse&, const Utils::Event::InitialResponseType)>
      SelectObjectContentInitialResponseCallbackEx;
 ...
 public:
  ...
  inline void SetInitialResponseCallback(const SelectObjectContentInitialResponseCallback& noArgCallback) {
    m_onInitialResponse = [noArgCallback](const SelectObjectContentInitialResponse& rs, const Utils::Event::InitialResponseType) {
