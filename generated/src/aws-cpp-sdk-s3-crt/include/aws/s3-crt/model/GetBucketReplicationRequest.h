...
/**
 */
class GetBucketReplicationRequest : public S3CrtRequest {
 public:
  AWS_S3CRT_API GetBucketReplicationRequest() = default;
  ...
  template <typename ExpectedBucketOwnerT = Aws::String>
  GetBucketReplicationRequest& WithExpectedBucketOwner(ExpectedBucketOwnerT&& value) {
  ...
  template <typename CustomizedAccessLogTagT = Aws::Map<Aws::String, Aws::String>>
  GetBucketReplicationRequest& WithCustomizedAccessLogTag(CustomizedAccessLogTagT&& value) {
