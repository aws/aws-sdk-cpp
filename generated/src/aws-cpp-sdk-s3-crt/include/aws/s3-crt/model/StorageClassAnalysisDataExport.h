...
namespace Model
{
  ...
  {
  public:
    AWS_S3CRT_API StorageClassAnalysisDataExport() = default;
    AWS_S3CRT_API StorageClassAnalysisDataExport(const Aws::Utils::Xml::XmlNode& xmlNode);
    AWS_S3CRT_API StorageClassAnalysisDataExport& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
