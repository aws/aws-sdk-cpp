...
namespace Model
{
  ...
  /**
   */
  class UpdateBucketMetadataInventoryTableConfigurationRequest : public S3CrtRequest
  {
  public:
    AWS_S3CRT_API UpdateBucketMetadataInventoryTableConfigurationRequest() = default;
