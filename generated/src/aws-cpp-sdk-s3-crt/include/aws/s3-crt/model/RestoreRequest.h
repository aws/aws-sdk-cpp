...
class RestoreRequest {
 public:
  AWS_S3CRT_API RestoreRequest() = default;
  AWS_S3CRT_API RestoreRequest(const Aws::Utils::Xml::XmlNode& xmlNode);
  AWS_S3CRT_API RestoreRequest& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
  ...
  inline RestoreRequest& WithDays(int value) {
    SetDays(value);
    return *this;
  }
  ///@}
  ...
  void SetGlacierJobParameters(GlacierJobParametersT&& value) {
    ...
    m_glacierJobParameters = std::forward<GlacierJobParametersT>(value);
  }
  template <typename GlacierJobParametersT = GlacierJobParameters>
  RestoreRequest& WithGlacierJobParameters(GlacierJobParametersT&& value) {
    SetGlacierJobParameters(std::forward<GlacierJobParametersT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetType(RestoreRequestType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline RestoreRequest& WithType(RestoreRequestType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline RestoreRequest& WithTier(Tier value) {
    SetTier(value);
    return *this;
  }
  ///@}
  ...
  void SetSelectParameters(SelectParametersT&& value) {
    ...
    m_selectParameters = std::forward<SelectParametersT>(value);
  }
  template <typename SelectParametersT = SelectParameters>
  RestoreRequest& WithSelectParameters(SelectParametersT&& value) {
    SetSelectParameters(std::forward<SelectParametersT>(value));
    return *this;
  }
  ///@}
