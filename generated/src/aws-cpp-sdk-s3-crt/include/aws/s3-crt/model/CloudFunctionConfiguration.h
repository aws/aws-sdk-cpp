...
class CloudFunctionConfiguration {
 public:
  ...
  inline CloudFunctionConfiguration& AddEvents(Event value) {
    m_eventsHasBeenSet = true;
  ...
  void SetCloudFunction(CloudFunctionT&& value) {
    ...
    m_cloudFunction = std::forward<CloudFunctionT>(value);
  }
  template <typename CloudFunctionT = Aws::String>
  CloudFunctionConfiguration& WithCloudFunction(CloudFunctionT&& value) {
    SetCloudFunction(std::forward<CloudFunctionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInvocationRole(InvocationRoleT&& value) {
    ...
    m_invocationRole = std::forward<InvocationRoleT>(value);
  }
  template <typename InvocationRoleT = Aws::String>
  CloudFunctionConfiguration& WithInvocationRole(InvocationRoleT&& value) {
    SetInvocationRole(std::forward<InvocationRoleT>(value));
    return *this;
  }
  ///@}
 private:
