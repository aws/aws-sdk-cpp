...
class GetBucketRequestPaymentRequest : public S3CrtRequest {
 public:
  ...
  template <typename BucketT = Aws::String>
  GetBucketRequestPaymentRequest& WithBucket(BucketT&& value) {
  ...
  template <typename ExpectedBucketOwnerT = Aws::String>
  GetBucketRequestPaymentRequest& WithExpectedBucketOwner(ExpectedBucketOwnerT&& value) {
  ...
  template <typename CustomizedAccessLogTagT = Aws::Map<Aws::String, Aws::String>>
  GetBucketRequestPaymentRequest& WithCustomizedAccessLogTag(CustomizedAccessLogTagT&& value) {
