...
/**
 */
class GetObjectAnnotationRequest : public S3CrtRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "GetObjectAnnotation"; }
  ...
  ///@{
  /**
   * <p>The name of the annotation to retrieve.</p> <p>Length Constraints: Minimum
   * length of 1. Maximum length of 512 bytes.</p>
   */
  ...
  inline GetObjectAnnotationRequest& WithRequestPayer(RequestPayer value) {
  ...
  ///@{
  /**
   * <p>Set to <code>ENABLED</code> to validate the checksum of the annotation
   * payload on retrieval.</p>
   */
  ...
  inline GetObjectAnnotationRequest& WithChecksumMode(ChecksumMode value) {
