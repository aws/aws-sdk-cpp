...
class HeadBucketRequest : public S3CrtRequest {
 public:
  ...
  template <typename BucketT = Aws::String>
  HeadBucketRequest& WithBucket(BucketT&& value) {
  ...
  template <typename ExpectedBucketOwnerT = Aws::String>
  HeadBucketRequest& WithExpectedBucketOwner(ExpectedBucketOwnerT&& value) {
  ...
  template <typename CustomizedAccessLogTagT = Aws::Map<Aws::String, Aws::String>>
  HeadBucketRequest& WithCustomizedAccessLogTag(CustomizedAccessLogTagT&& value) {
