...
namespace Model
{
  ...
  /**
   */
  class HeadBucketRequest : public S3CrtRequest
  {
  public:
    AWS_S3CRT_API HeadBucketRequest() = default;
     ...
     * are not supported by directory buckets.</p>  <p> <b>S3 on Outposts</b> -
     * When you use this action with S3 on Outposts, you must direct requests to the S3
     * on Outposts hostname. The S3 on Outposts hostname takes the form <code>
