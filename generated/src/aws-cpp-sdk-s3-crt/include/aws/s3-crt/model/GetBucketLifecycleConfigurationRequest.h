...
/**
 */
class GetBucketLifecycleConfigurationRequest : public S3CrtRequest {
 public:
  AWS_S3CRT_API GetBucketLifecycleConfigurationRequest() = default;
  ...
  template <typename BucketT = Aws::String>
  GetBucketLifecycleConfigurationRequest& WithBucket(BucketT&& value) {
  ...
  template <typename ExpectedBucketOwnerT = Aws::String>
  GetBucketLifecycleConfigurationRequest& WithExpectedBucketOwner(ExpectedBucketOwnerT&& value) {
  ...
  template <typename CustomizedAccessLogTagT = Aws::Map<Aws::String, Aws::String>>
  GetBucketLifecycleConfigurationRequest& WithCustomizedAccessLogTag(CustomizedAccessLogTagT&& value) {
  ...
  GetBucketLifecycleConfigurationRequest& AddCustomizedAccessLogTag(CustomizedAccessLogTagKeyT&& key,
