...
namespace Model
{
  ...
  public:
    ...
    inline PutObjectRetentionResult& WithRequestCharged(RequestCharged value) { SetRequestCharged(value); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    PutObjectRetentionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
