...
namespace Model
{
  ...
  {
  public:
    AWS_S3CRT_API MetadataEntry() = default;
    ...
    template<typename NameT = Aws::String>
    MetadataEntry& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename ValueT = Aws::String>
    MetadataEntry& WithValue(ValueT&& value) { SetValue(std::forward<ValueT>(value)); return *this;}
    ///@}
  private:
