...
class EventHoldDuration {
 public:
  AWS_S3CRT_API EventHoldDuration() = default;
  AWS_S3CRT_API EventHoldDuration(const Aws::Utils::Xml::XmlNode& xmlNode);
  AWS_S3CRT_API EventHoldDuration& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
