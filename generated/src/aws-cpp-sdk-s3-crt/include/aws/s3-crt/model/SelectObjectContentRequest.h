...
class SelectObjectContentRequest : public S3CrtRequest {
 public:
  AWS_S3CRT_API SelectObjectContentRequest() = default;
   ...
   * Underlying Event Stream Handler which is used to define callback functions.
   */
  inline void SetEventStreamHandler(const SelectObjectContentHandler& value) {
    m_handler = value;
   ...
   * Underlying Event Stream Handler which is used to define callback functions.
   */
  inline SelectObjectContentRequest& WithEventStreamHandler(const SelectObjectContentHandler& value) {
  ...
  inline void SetExpressionType(ExpressionType value) {
    m_expressionTypeHasBeenSet = true;
    m_expressionType = value;
  }
  inline SelectObjectContentRequest& WithExpressionType(ExpressionType value) {
  ...
  void SetRequestProgress(RequestProgressT&& value) {
    m_requestProgressHasBeenSet = true;
    m_requestProgress = std::forward<RequestProgressT>(value);
  }
  template <typename RequestProgressT = RequestProgress>
  SelectObjectContentRequest& WithRequestProgress(RequestProgressT&& value) {
    SetRequestProgress(std::forward<RequestProgressT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInputSerialization(InputSerializationT&& value) {
    ...
    m_inputSerialization = std::forward<InputSerializationT>(value);
  }
  template <typename InputSerializationT = InputSerialization>
  SelectObjectContentRequest& WithInputSerialization(InputSerializationT&& value) {
    SetInputSerialization(std::forward<InputSerializationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOutputSerialization(OutputSerializationT&& value) {
    ...
    m_outputSerialization = std::forward<OutputSerializationT>(value);
  }
  template <typename OutputSerializationT = OutputSerialization>
  SelectObjectContentRequest& WithOutputSerialization(OutputSerializationT&& value) {
    SetOutputSerialization(std::forward<OutputSerializationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetScanRange(ScanRangeT&& value) {
    ...
    m_scanRange = std::forward<ScanRangeT>(value);
  }
  template <typename ScanRangeT = ScanRange>
  SelectObjectContentRequest& WithScanRange(ScanRangeT&& value) {
    SetScanRange(std::forward<ScanRangeT>(value));
    return *this;
  }
  ///@}
