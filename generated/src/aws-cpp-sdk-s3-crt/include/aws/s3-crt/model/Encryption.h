...
class Encryption {
 public:
  ...
  inline void SetEncryptionType(ServerSideEncryption value) {
    m_encryptionTypeHasBeenSet = true;
    m_encryptionType = value;
  }
  inline Encryption& WithEncryptionType(ServerSideEncryption value) {
  ...
  void SetKMSContext(KMSContextT&& value) {
    ...
    m_kMSContext = std::forward<KMSContextT>(value);
  }
  template <typename KMSContextT = Aws::String>
  Encryption& WithKMSContext(KMSContextT&& value) {
    SetKMSContext(std::forward<KMSContextT>(value));
    return *this;
  }
  ///@}
 private:
