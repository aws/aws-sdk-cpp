...
class ListObjectVersionsResult {
 public:
  ...
  inline ListObjectVersionsResult& WithIsTruncated(bool value) {
  ...
  void SetVersionIdMarker(VersionIdMarkerT&& value) {
    ...
    m_versionIdMarker = std::forward<VersionIdMarkerT>(value);
  }
  template <typename VersionIdMarkerT = Aws::String>
  ListObjectVersionsResult& WithVersionIdMarker(VersionIdMarkerT&& value) {
    SetVersionIdMarker(std::forward<VersionIdMarkerT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNextVersionIdMarker(NextVersionIdMarkerT&& value) {
    ...
    m_nextVersionIdMarker = std::forward<NextVersionIdMarkerT>(value);
  }
  template <typename NextVersionIdMarkerT = Aws::String>
  ListObjectVersionsResult& WithNextVersionIdMarker(NextVersionIdMarkerT&& value) {
    SetNextVersionIdMarker(std::forward<NextVersionIdMarkerT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetMaxKeys(int value) {
    m_maxKeysHasBeenSet = true;
    m_maxKeys = value;
  }
  inline ListObjectVersionsResult& WithMaxKeys(int value) {
    SetMaxKeys(value);
    return *this;
  }
  ///@}
  ...
  inline ListObjectVersionsResult& WithEncodingType(EncodingType value) {
  ...
  inline ListObjectVersionsResult& WithRequestCharged(RequestCharged value) {
