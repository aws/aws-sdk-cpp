...
class CompleteMultipartUploadResult {
 public:
  ...
  template <typename ChecksumSHA512T = Aws::String>
  CompleteMultipartUploadResult& WithChecksumSHA512(ChecksumSHA512T&& value) {
  ...
  template <typename ChecksumMD5T = Aws::String>
  CompleteMultipartUploadResult& WithChecksumMD5(ChecksumMD5T&& value) {
  ...
  template <typename ChecksumXXHASH64T = Aws::String>
  CompleteMultipartUploadResult& WithChecksumXXHASH64(ChecksumXXHASH64T&& value) {
  ...
  template <typename ChecksumXXHASH3T = Aws::String>
  CompleteMultipartUploadResult& WithChecksumXXHASH3(ChecksumXXHASH3T&& value) {
  ...
  template <typename ChecksumXXHASH128T = Aws::String>
  CompleteMultipartUploadResult& WithChecksumXXHASH128(ChecksumXXHASH128T&& value) {
  ...
  inline CompleteMultipartUploadResult& WithChecksumType(ChecksumType value) {
  ...
  inline CompleteMultipartUploadResult& WithServerSideEncryption(ServerSideEncryption value) {
  ...
  inline CompleteMultipartUploadResult& WithBucketKeyEnabled(bool value) {
  ...
  inline CompleteMultipartUploadResult& WithRequestCharged(RequestCharged value) {
