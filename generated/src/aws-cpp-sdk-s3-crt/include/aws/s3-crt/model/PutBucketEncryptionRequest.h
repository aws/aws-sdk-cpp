...
/**
 */
class PutBucketEncryptionRequest : public S3CrtRequest {
 public:
  AWS_S3CRT_API PutBucketEncryptionRequest() = default;
  ...
  inline PutBucketEncryptionRequest& WithChecksumAlgorithm(ChecksumAlgorithm value) {
