...
class InventoryTableConfiguration {
 public:
  ...
  inline void SetConfigurationState(InventoryConfigurationState value) {
    m_configurationStateHasBeenSet = true;
    m_configurationState = value;
  }
  inline InventoryTableConfiguration& WithConfigurationState(InventoryConfigurationState value) {
