...
class ListBucketMetricsConfigurationsResult {
 public:
  AWS_S3CRT_API ListBucketMetricsConfigurationsResult() = default;
  ...
  inline ListBucketMetricsConfigurationsResult& WithIsTruncated(bool value) {
  ...
  template <typename ContinuationTokenT = Aws::String>
  ListBucketMetricsConfigurationsResult& WithContinuationToken(ContinuationTokenT&& value) {
  ...
  template <typename NextContinuationTokenT = Aws::String>
  ListBucketMetricsConfigurationsResult& WithNextContinuationToken(NextContinuationTokenT&& value) {
  ...
  void SetMetricsConfigurationList(MetricsConfigurationListT&& value) {
    m_metricsConfigurationListHasBeenSet = true;
    m_metricsConfigurationList = std::forward<MetricsConfigurationListT>(value);
  }
  template <typename MetricsConfigurationListT = Aws::Vector<MetricsConfiguration>>
  ListBucketMetricsConfigurationsResult& WithMetricsConfigurationList(MetricsConfigurationListT&& value) {
    SetMetricsConfigurationList(std::forward<MetricsConfigurationListT>(value));
    return *this;
  }
  template <typename MetricsConfigurationListT = MetricsConfiguration>
  ListBucketMetricsConfigurationsResult& AddMetricsConfigurationList(MetricsConfigurationListT&& value) {
    m_metricsConfigurationListHasBeenSet = true;
    m_metricsConfigurationList.emplace_back(std::forward<MetricsConfigurationListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListBucketMetricsConfigurationsResult& WithRequestId(RequestIdT&& value) {
