...
/**
 */
class DeleteBucketRequest : public S3CrtRequest {
 public:
  AWS_S3CRT_API DeleteBucketRequest() = default;
  ...
  template <typename ExpectedBucketOwnerT = Aws::String>
  DeleteBucketRequest& WithExpectedBucketOwner(ExpectedBucketOwnerT&& value) {
  ...
  template <typename CustomizedAccessLogTagT = Aws::Map<Aws::String, Aws::String>>
  DeleteBucketRequest& WithCustomizedAccessLogTag(CustomizedAccessLogTagT&& value) {
