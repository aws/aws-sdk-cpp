...
/**
 */
class PutObjectLegalHoldRequest : public S3CrtRequest {
 public:
  AWS_S3CRT_API PutObjectLegalHoldRequest() = default;
  ...
  inline PutObjectLegalHoldRequest& WithRequestPayer(RequestPayer value) {
  ...
  inline PutObjectLegalHoldRequest& WithChecksumAlgorithm(ChecksumAlgorithm value) {
