...
/**
 */
class PutBucketNotificationConfigurationRequest : public S3CrtRequest {
 public:
  AWS_S3CRT_API PutBucketNotificationConfigurationRequest() = default;
  ...
  inline void SetSkipDestinationValidation(bool value) {
    m_skipDestinationValidationHasBeenSet = true;
    m_skipDestinationValidation = value;
  }
  inline PutBucketNotificationConfigurationRequest& WithSkipDestinationValidation(bool value) {
    SetSkipDestinationValidation(value);
    return *this;
  }
  ///@}
  ...
  PutBucketNotificationConfigurationRequest& AddCustomizedAccessLogTag(CustomizedAccessLogTagKeyT&& key,
