...
/**
 */
class DeleteObjectsRequest : public S3CrtRequest {
 public:
  ...
  inline DeleteObjectsRequest& WithRequestPayer(RequestPayer value) {
  ...
  inline DeleteObjectsRequest& WithBypassGovernanceRetention(bool value) {
  ...
  inline DeleteObjectsRequest& WithChecksumAlgorithm(ChecksumAlgorithm value) {
