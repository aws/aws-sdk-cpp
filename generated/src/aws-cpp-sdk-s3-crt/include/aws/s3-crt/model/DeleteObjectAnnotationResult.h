...
class DeleteObjectAnnotationResult {
 public:
  AWS_S3CRT_API DeleteObjectAnnotationResult() = default;
  AWS_S3CRT_API DeleteObjectAnnotationResult(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  AWS_S3CRT_API DeleteObjectAnnotationResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
