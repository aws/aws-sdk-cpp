...
class GetBucketAnalyticsConfigurationResult {
 public:
  AWS_S3CRT_API GetBucketAnalyticsConfigurationResult() = default;
  ...
  template <typename AnalyticsConfigurationT = AnalyticsConfiguration>
  GetBucketAnalyticsConfigurationResult& WithAnalyticsConfiguration(AnalyticsConfigurationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetBucketAnalyticsConfigurationResult& WithRequestId(RequestIdT&& value) {
