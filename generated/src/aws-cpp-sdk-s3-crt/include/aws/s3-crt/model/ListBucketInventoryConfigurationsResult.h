...
class ListBucketInventoryConfigurationsResult {
 public:
  ...
  template <typename ContinuationTokenT = Aws::String>
  ListBucketInventoryConfigurationsResult& WithContinuationToken(ContinuationTokenT&& value) {
  ...
  void SetInventoryConfigurationList(InventoryConfigurationListT&& value) {
    m_inventoryConfigurationListHasBeenSet = true;
    m_inventoryConfigurationList = std::forward<InventoryConfigurationListT>(value);
  }
  template <typename InventoryConfigurationListT = Aws::Vector<InventoryConfiguration>>
  ListBucketInventoryConfigurationsResult& WithInventoryConfigurationList(InventoryConfigurationListT&& value) {
    SetInventoryConfigurationList(std::forward<InventoryConfigurationListT>(value));
    return *this;
  }
  template <typename InventoryConfigurationListT = InventoryConfiguration>
  ListBucketInventoryConfigurationsResult& AddInventoryConfigurationList(InventoryConfigurationListT&& value) {
    m_inventoryConfigurationListHasBeenSet = true;
    m_inventoryConfigurationList.emplace_back(std::forward<InventoryConfigurationListT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListBucketInventoryConfigurationsResult& WithIsTruncated(bool value) {
  ...
  template <typename NextContinuationTokenT = Aws::String>
  ListBucketInventoryConfigurationsResult& WithNextContinuationToken(NextContinuationTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListBucketInventoryConfigurationsResult& WithRequestId(RequestIdT&& value) {
