...
class GetBucketAccelerateConfigurationRequest : public S3CrtRequest {
 public:
  ...
  template <typename BucketT = Aws::String>
  GetBucketAccelerateConfigurationRequest& WithBucket(BucketT&& value) {
  ...
  template <typename ExpectedBucketOwnerT = Aws::String>
  GetBucketAccelerateConfigurationRequest& WithExpectedBucketOwner(ExpectedBucketOwnerT&& value) {
  ...
  inline GetBucketAccelerateConfigurationRequest& WithRequestPayer(RequestPayer value) {
  ...
  template <typename CustomizedAccessLogTagT = Aws::Map<Aws::String, Aws::String>>
  GetBucketAccelerateConfigurationRequest& WithCustomizedAccessLogTag(CustomizedAccessLogTagT&& value) {
  ...
  GetBucketAccelerateConfigurationRequest& AddCustomizedAccessLogTag(CustomizedAccessLogTagKeyT&& key,
