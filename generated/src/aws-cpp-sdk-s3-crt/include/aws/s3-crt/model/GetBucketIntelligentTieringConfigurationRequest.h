...
class GetBucketIntelligentTieringConfigurationRequest : public S3CrtRequest {
 public:
  ...
  template <typename IdT = Aws::String>
  GetBucketIntelligentTieringConfigurationRequest& WithId(IdT&& value) {
  ...
  GetBucketIntelligentTieringConfigurationRequest& AddCustomizedAccessLogTag(CustomizedAccessLogTagKeyT&& key,
