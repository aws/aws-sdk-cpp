...
namespace Model
{
  ...
  /**
   */
  class GetBucketIntelligentTieringConfigurationRequest : public S3CrtRequest
  {
  public:
    AWS_S3CRT_API GetBucketIntelligentTieringConfigurationRequest() = default;
    ...
    template<typename BucketT = Aws::String>
    GetBucketIntelligentTieringConfigurationRequest& WithBucket(BucketT&& value) { SetBucket(std::forward<BucketT>(value)); return *this;}
    ///@}
    ...
    template<typename IdT = Aws::String>
    GetBucketIntelligentTieringConfigurationRequest& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename ExpectedBucketOwnerT = Aws::String>
    GetBucketIntelligentTieringConfigurationRequest& WithExpectedBucketOwner(ExpectedBucketOwnerT&& value) { SetExpectedBucketOwner(std::forward<ExpectedBucketOwnerT>(value)); return *this;}
    ///@}
    ...
    template<typename CustomizedAccessLogTagT = Aws::Map<Aws::String, Aws::String>>
    GetBucketIntelligentTieringConfigurationRequest& WithCustomizedAccessLogTag(CustomizedAccessLogTagT&& value) { SetCustomizedAccessLogTag(std::forward<CustomizedAccessLogTagT>(value)); return *this;}
