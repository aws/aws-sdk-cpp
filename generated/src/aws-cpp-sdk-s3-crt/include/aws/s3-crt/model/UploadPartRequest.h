...
class UploadPartRequest : public StreamingS3CrtRequest {
 public:
  ...
  inline UploadPartRequest& WithContentLength(long long value) {
  ...
  inline UploadPartRequest& WithChecksumAlgorithm(ChecksumAlgorithm value) {
  ...
  inline UploadPartRequest& WithPartNumber(int value) {
    SetPartNumber(value);
    return *this;
  }
  ///@}
  ...
  inline UploadPartRequest& WithRequestPayer(RequestPayer value) {
