...
class ListBucketAnalyticsConfigurationsRequest : public S3CrtRequest {
 public:
  ...
  template <typename BucketT = Aws::String>
  ListBucketAnalyticsConfigurationsRequest& WithBucket(BucketT&& value) {
  ...
  template <typename ContinuationTokenT = Aws::String>
  ListBucketAnalyticsConfigurationsRequest& WithContinuationToken(ContinuationTokenT&& value) {
  ...
  template <typename ExpectedBucketOwnerT = Aws::String>
  ListBucketAnalyticsConfigurationsRequest& WithExpectedBucketOwner(ExpectedBucketOwnerT&& value) {
  ...
  template <typename CustomizedAccessLogTagT = Aws::Map<Aws::String, Aws::String>>
  ListBucketAnalyticsConfigurationsRequest& WithCustomizedAccessLogTag(CustomizedAccessLogTagT&& value) {
  ...
  ListBucketAnalyticsConfigurationsRequest& AddCustomizedAccessLogTag(CustomizedAccessLogTagKeyT&& key,
