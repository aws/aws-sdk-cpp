...
/**
 */
class PutBucketIntelligentTieringConfigurationRequest : public S3CrtRequest {
 public:
  AWS_S3CRT_API PutBucketIntelligentTieringConfigurationRequest() = default;
  ...
  void SetIntelligentTieringConfiguration(IntelligentTieringConfigurationT&& value) {
    ...
    m_intelligentTieringConfiguration = std::forward<IntelligentTieringConfigurationT>(value);
  }
  template <typename IntelligentTieringConfigurationT = IntelligentTieringConfiguration>
  PutBucketIntelligentTieringConfigurationRequest& WithIntelligentTieringConfiguration(IntelligentTieringConfigurationT&& value) {
    SetIntelligentTieringConfiguration(std::forward<IntelligentTieringConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  PutBucketIntelligentTieringConfigurationRequest& AddCustomizedAccessLogTag(CustomizedAccessLogTagKeyT&& key,
