...
namespace Model
{
  ...
  public:
    ...
    template<typename ExpectedBucketOwnerT = Aws::String>
    PutBucketIntelligentTieringConfigurationRequest& WithExpectedBucketOwner(ExpectedBucketOwnerT&& value) { SetExpectedBucketOwner(std::forward<ExpectedBucketOwnerT>(value)); return *this;}
    ///@}
