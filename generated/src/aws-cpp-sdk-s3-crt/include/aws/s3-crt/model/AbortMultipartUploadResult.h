...
class AbortMultipartUploadResult {
 public:
  AWS_S3CRT_API AbortMultipartUploadResult() = default;
  ...
  inline AbortMultipartUploadResult& WithRequestCharged(RequestCharged value) {
  ...
  template <typename RequestIdT = Aws::String>
  AbortMultipartUploadResult& WithRequestId(RequestIdT&& value) {
