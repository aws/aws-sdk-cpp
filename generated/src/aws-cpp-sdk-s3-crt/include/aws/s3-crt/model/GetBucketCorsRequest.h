...
class GetBucketCorsRequest : public S3CrtRequest {
 public:
  ...
  template <typename BucketT = Aws::String>
  GetBucketCorsRequest& WithBucket(BucketT&& value) {
  ...
  template <typename ExpectedBucketOwnerT = Aws::String>
  GetBucketCorsRequest& WithExpectedBucketOwner(ExpectedBucketOwnerT&& value) {
  ...
  template <typename CustomizedAccessLogTagT = Aws::Map<Aws::String, Aws::String>>
  GetBucketCorsRequest& WithCustomizedAccessLogTag(CustomizedAccessLogTagT&& value) {
