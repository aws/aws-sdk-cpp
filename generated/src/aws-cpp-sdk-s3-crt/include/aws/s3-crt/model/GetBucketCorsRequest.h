...
namespace Model
{
  ...
  {
  public:
    AWS_S3CRT_API GetBucketCorsRequest();
    ...
    /**
     * <p>The bucket name for which to get the cors configuration.</p> <p>To use this
     * API operation against an access point, provide the alias of the access point in
