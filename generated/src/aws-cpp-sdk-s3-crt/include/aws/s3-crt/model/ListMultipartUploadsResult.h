...
class ListMultipartUploadsResult {
 public:
  AWS_S3CRT_API ListMultipartUploadsResult() = default;
  AWS_S3CRT_API ListMultipartUploadsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  AWS_S3CRT_API ListMultipartUploadsResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  ...
  void SetKeyMarker(KeyMarkerT&& value) {
    ...
    m_keyMarker = std::forward<KeyMarkerT>(value);
  }
  template <typename KeyMarkerT = Aws::String>
  ListMultipartUploadsResult& WithKeyMarker(KeyMarkerT&& value) {
    SetKeyMarker(std::forward<KeyMarkerT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUploadIdMarker(UploadIdMarkerT&& value) {
    ...
    m_uploadIdMarker = std::forward<UploadIdMarkerT>(value);
  }
  template <typename UploadIdMarkerT = Aws::String>
  ListMultipartUploadsResult& WithUploadIdMarker(UploadIdMarkerT&& value) {
    SetUploadIdMarker(std::forward<UploadIdMarkerT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNextKeyMarker(NextKeyMarkerT&& value) {
    ...
    m_nextKeyMarker = std::forward<NextKeyMarkerT>(value);
  }
  template <typename NextKeyMarkerT = Aws::String>
  ListMultipartUploadsResult& WithNextKeyMarker(NextKeyMarkerT&& value) {
    SetNextKeyMarker(std::forward<NextKeyMarkerT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNextUploadIdMarker(NextUploadIdMarkerT&& value) {
    ...
    m_nextUploadIdMarker = std::forward<NextUploadIdMarkerT>(value);
  }
  template <typename NextUploadIdMarkerT = Aws::String>
  ListMultipartUploadsResult& WithNextUploadIdMarker(NextUploadIdMarkerT&& value) {
    SetNextUploadIdMarker(std::forward<NextUploadIdMarkerT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetMaxUploads(int value) {
    m_maxUploadsHasBeenSet = true;
    m_maxUploads = value;
  }
  inline ListMultipartUploadsResult& WithMaxUploads(int value) {
    SetMaxUploads(value);
    return *this;
  }
  ///@}
  ...
  inline ListMultipartUploadsResult& WithIsTruncated(bool value) {
  ...
  inline void SetEncodingType(EncodingType value) {
    m_encodingTypeHasBeenSet = true;
    m_encodingType = value;
  }
  inline ListMultipartUploadsResult& WithEncodingType(EncodingType value) {
  ...
  inline ListMultipartUploadsResult& WithRequestCharged(RequestCharged value) {
