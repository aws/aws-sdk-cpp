...
class GetBucketRequestPaymentResult {
 public:
  ...
  inline void SetPayer(Payer value) {
    m_payerHasBeenSet = true;
    m_payer = value;
  }
  inline GetBucketRequestPaymentResult& WithPayer(Payer value) {
    SetPayer(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetBucketRequestPaymentResult& WithRequestId(RequestIdT&& value) {
