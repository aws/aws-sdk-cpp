...
class PutObjectResult {
 public:
   ...
   * header is present if the object was uploaded with the <code>SHA512</code>
   ...
   * header is present if the object was uploaded with the <code>MD5</code> checksum
   ...
   * header is present if the object was uploaded with the <code>XXHASH64</code>
   * checksum algorithm. For more information, see <a
   * href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html">Checking
   * object integrity in the Amazon S3 User Guide</a>.</p>
   */
   ...
   * header is present if the object was uploaded with the <code>XXHASH3</code>
   * checksum algorithm. For more information, see <a
   * href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html">Checking
   * object integrity in the Amazon S3 User Guide</a>.</p>
   */
  ...
  inline PutObjectResult& WithChecksumType(ChecksumType value) {
  ...
  inline PutObjectResult& WithServerSideEncryption(ServerSideEncryption value) {
  ...
  inline PutObjectResult& WithBucketKeyEnabled(bool value) {
  ...
  inline PutObjectResult& WithSize(long long value) {
    SetSize(value);
    return *this;
  }
  ///@}
  ...
  inline PutObjectResult& WithRequestCharged(RequestCharged value) {
