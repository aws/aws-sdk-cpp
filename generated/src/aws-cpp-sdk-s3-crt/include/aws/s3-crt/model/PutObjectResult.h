...
namespace Model
{
  ...
  public:
     ...
     * <code>CRC-64NVME</code> checksum algorithm, or if it was uploaded without a
     * checksum (and Amazon S3 added the default checksum, <code>CRC-64NVME</code>, to
    ...
    inline PutObjectResult& WithChecksumCRC64NVME(const Aws::String& value) { SetChecksumCRC64NVME(value); return *this;}
    inline PutObjectResult& WithChecksumCRC64NVME(Aws::String&& value) { SetChecksumCRC64NVME(std::move(value)); return *this;}
    inline PutObjectResult& WithChecksumCRC64NVME(const char* value) { SetChecksumCRC64NVME(value); return *this;}
    ///@}
    ...
    inline PutObjectResult& WithChecksumType(const ChecksumType& value) { SetChecksumType(value); return *this;}
    inline PutObjectResult& WithChecksumType(ChecksumType&& value) { SetChecksumType(std::move(value)); return *this;}
    ///@}
