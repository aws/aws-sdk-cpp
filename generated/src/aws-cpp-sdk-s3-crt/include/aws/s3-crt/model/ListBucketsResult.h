...
class ListBucketsResult {
 public:
  AWS_S3CRT_API ListBucketsResult() = default;
  AWS_S3CRT_API ListBucketsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  AWS_S3CRT_API ListBucketsResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  ...
  template <typename BucketsT = Aws::Vector<Bucket>>
  ListBucketsResult& WithBuckets(BucketsT&& value) {
    SetBuckets(std::forward<BucketsT>(value));
    return *this;
  }
  template <typename BucketsT = Bucket>
  ListBucketsResult& AddBuckets(BucketsT&& value) {
    m_bucketsHasBeenSet = true;
  ...
  template <typename OwnerT = Owner>
  ListBucketsResult& WithOwner(OwnerT&& value) {
  ...
  template <typename ContinuationTokenT = Aws::String>
  ListBucketsResult& WithContinuationToken(ContinuationTokenT&& value) {
  ...
  template <typename PrefixT = Aws::String>
  ListBucketsResult& WithPrefix(PrefixT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListBucketsResult& WithRequestId(RequestIdT&& value) {
