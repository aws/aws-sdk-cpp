...
namespace Model
{
  ...
  public:
    ...
    template<typename BucketT = Aws::String>
    PutBucketLoggingRequest& WithBucket(BucketT&& value) { SetBucket(std::forward<BucketT>(value)); return *this;}
    ///@}
    ...
    template<typename BucketLoggingStatusT = BucketLoggingStatus>
    void SetBucketLoggingStatus(BucketLoggingStatusT&& value) { m_bucketLoggingStatusHasBeenSet = true; m_bucketLoggingStatus = std::forward<BucketLoggingStatusT>(value); }
    template<typename BucketLoggingStatusT = BucketLoggingStatus>
    PutBucketLoggingRequest& WithBucketLoggingStatus(BucketLoggingStatusT&& value) { SetBucketLoggingStatus(std::forward<BucketLoggingStatusT>(value)); return *this;}
    ///@}
    ...
    template<typename ContentMD5T = Aws::String>
    PutBucketLoggingRequest& WithContentMD5(ContentMD5T&& value) { SetContentMD5(std::forward<ContentMD5T>(value)); return *this;}
    ///@}
    ...
    inline PutBucketLoggingRequest& WithChecksumAlgorithm(ChecksumAlgorithm value) { SetChecksumAlgorithm(value); return *this;}
    ///@}
    ...
    template<typename ExpectedBucketOwnerT = Aws::String>
    PutBucketLoggingRequest& WithExpectedBucketOwner(ExpectedBucketOwnerT&& value) { SetExpectedBucketOwner(std::forward<ExpectedBucketOwnerT>(value)); return *this;}
    ///@}
    ...
    template<typename CustomizedAccessLogTagT = Aws::Map<Aws::String, Aws::String>>
    PutBucketLoggingRequest& WithCustomizedAccessLogTag(CustomizedAccessLogTagT&& value) { SetCustomizedAccessLogTag(std::forward<CustomizedAccessLogTagT>(value)); return *this;}
