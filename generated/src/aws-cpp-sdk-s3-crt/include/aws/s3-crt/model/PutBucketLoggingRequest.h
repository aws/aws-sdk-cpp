...
class PutBucketLoggingRequest : public S3CrtRequest {
 public:
  ...
  void SetBucketLoggingStatus(BucketLoggingStatusT&& value) {
    m_bucketLoggingStatusHasBeenSet = true;
    m_bucketLoggingStatus = std::forward<BucketLoggingStatusT>(value);
  }
  template <typename BucketLoggingStatusT = BucketLoggingStatus>
  PutBucketLoggingRequest& WithBucketLoggingStatus(BucketLoggingStatusT&& value) {
    SetBucketLoggingStatus(std::forward<BucketLoggingStatusT>(value));
    return *this;
  }
  ///@}
  ...
  inline PutBucketLoggingRequest& WithChecksumAlgorithm(ChecksumAlgorithm value) {
