...
namespace Model
{
  ...
  {
  public:
    AWS_S3CRT_API DeletedObject() = default;
    AWS_S3CRT_API DeletedObject(const Aws::Utils::Xml::XmlNode& xmlNode);
    AWS_S3CRT_API DeletedObject& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
