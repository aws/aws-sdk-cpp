...
class PutBucketWebsiteRequest : public S3CrtRequest {
 public:
  ...
  inline PutBucketWebsiteRequest& WithChecksumAlgorithm(ChecksumAlgorithm value) {
  ...
  void SetWebsiteConfiguration(WebsiteConfigurationT&& value) {
    m_websiteConfigurationHasBeenSet = true;
    m_websiteConfiguration = std::forward<WebsiteConfigurationT>(value);
  }
  template <typename WebsiteConfigurationT = WebsiteConfiguration>
  PutBucketWebsiteRequest& WithWebsiteConfiguration(WebsiteConfigurationT&& value) {
    SetWebsiteConfiguration(std::forward<WebsiteConfigurationT>(value));
    return *this;
  }
  ///@}
