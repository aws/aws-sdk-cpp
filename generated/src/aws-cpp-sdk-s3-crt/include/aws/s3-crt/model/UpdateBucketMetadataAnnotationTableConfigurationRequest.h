...
/**
 */
class UpdateBucketMetadataAnnotationTableConfigurationRequest : public S3CrtRequest {
 public:
  AWS_S3CRT_API UpdateBucketMetadataAnnotationTableConfigurationRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "UpdateBucketMetadataAnnotationTableConfiguration"; }
  ...
  template <typename BucketT = Aws::String>
  UpdateBucketMetadataAnnotationTableConfigurationRequest& WithBucket(BucketT&& value) {
  ...
  template <typename ContentMD5T = Aws::String>
  UpdateBucketMetadataAnnotationTableConfigurationRequest& WithContentMD5(ContentMD5T&& value) {
  ...
  inline UpdateBucketMetadataAnnotationTableConfigurationRequest& WithChecksumAlgorithm(ChecksumAlgorithm value) {
   ...
   */
  inline const AnnotationTableConfigurationUpdates& GetAnnotationTableConfiguration() const { return m_annotationTableConfiguration; }
  inline bool AnnotationTableConfigurationHasBeenSet() const { return m_annotationTableConfigurationHasBeenSet; }
  template <typename AnnotationTableConfigurationT = AnnotationTableConfigurationUpdates>
  ...
  template <typename AnnotationTableConfigurationT = AnnotationTableConfigurationUpdates>
  UpdateBucketMetadataAnnotationTableConfigurationRequest& WithAnnotationTableConfiguration(AnnotationTableConfigurationT&& value) {
  ...
  template <typename ExpectedBucketOwnerT = Aws::String>
  UpdateBucketMetadataAnnotationTableConfigurationRequest& WithExpectedBucketOwner(ExpectedBucketOwnerT&& value) {
  ...
  template <typename CustomizedAccessLogTagT = Aws::Map<Aws::String, Aws::String>>
  UpdateBucketMetadataAnnotationTableConfigurationRequest& WithCustomizedAccessLogTag(CustomizedAccessLogTagT&& value) {
  ...
  UpdateBucketMetadataAnnotationTableConfigurationRequest& AddCustomizedAccessLogTag(CustomizedAccessLogTagKeyT&& key,
 ...
 private:
  ...
  AnnotationTableConfigurationUpdates m_annotationTableConfiguration;
