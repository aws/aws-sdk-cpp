...
class GetPublicAccessBlockRequest : public S3CrtRequest {
 public:
  ...
  template <typename BucketT = Aws::String>
  GetPublicAccessBlockRequest& WithBucket(BucketT&& value) {
  ...
  template <typename ExpectedBucketOwnerT = Aws::String>
  GetPublicAccessBlockRequest& WithExpectedBucketOwner(ExpectedBucketOwnerT&& value) {
  ...
  template <typename CustomizedAccessLogTagT = Aws::Map<Aws::String, Aws::String>>
  GetPublicAccessBlockRequest& WithCustomizedAccessLogTag(CustomizedAccessLogTagT&& value) {
