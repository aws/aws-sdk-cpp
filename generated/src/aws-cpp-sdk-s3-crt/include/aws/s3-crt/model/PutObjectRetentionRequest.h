...
class PutObjectRetentionRequest : public S3CrtRequest {
 public:
  ...
  void SetRetention(RetentionT&& value) {
    ...
    m_retention = std::forward<RetentionT>(value);
  }
  template <typename RetentionT = ObjectLockRetention>
  PutObjectRetentionRequest& WithRetention(RetentionT&& value) {
    SetRetention(std::forward<RetentionT>(value));
    return *this;
  }
  ///@}
  ...
  inline PutObjectRetentionRequest& WithRequestPayer(RequestPayer value) {
  ...
  inline PutObjectRetentionRequest& WithBypassGovernanceRetention(bool value) {
  ...
  inline PutObjectRetentionRequest& WithChecksumAlgorithm(ChecksumAlgorithm value) {
