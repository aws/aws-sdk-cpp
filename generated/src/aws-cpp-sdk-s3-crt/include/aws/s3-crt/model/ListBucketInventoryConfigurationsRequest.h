...
class ListBucketInventoryConfigurationsRequest : public S3CrtRequest {
 public:
   ...
   * retrieve.</p> <p> <b>Directory buckets </b> - When you use this operation with a
  ...
  template <typename BucketT = Aws::String>
  ListBucketInventoryConfigurationsRequest& WithBucket(BucketT&& value) {
  ...
  template <typename ContinuationTokenT = Aws::String>
  ListBucketInventoryConfigurationsRequest& WithContinuationToken(ContinuationTokenT&& value) {
  ...
  template <typename ExpectedBucketOwnerT = Aws::String>
  ListBucketInventoryConfigurationsRequest& WithExpectedBucketOwner(ExpectedBucketOwnerT&& value) {
  ...
  template <typename CustomizedAccessLogTagT = Aws::Map<Aws::String, Aws::String>>
  ListBucketInventoryConfigurationsRequest& WithCustomizedAccessLogTag(CustomizedAccessLogTagT&& value) {
  ...
  ListBucketInventoryConfigurationsRequest& AddCustomizedAccessLogTag(CustomizedAccessLogTagKeyT&& key,
