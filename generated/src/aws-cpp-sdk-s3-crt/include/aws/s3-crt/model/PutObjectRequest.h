...
/**
 */
class PutObjectRequest : public StreamingS3CrtRequest {
 public:
  ...
  inline PutObjectRequest& WithACL(ObjectCannedACL value) {
    SetACL(value);
    return *this;
  }
  ///@}
  ...
  inline PutObjectRequest& WithContentLength(long long value) {
  ...
  inline PutObjectRequest& WithChecksumAlgorithm(ChecksumAlgorithm value) {
  ...
  inline void SetWriteOffsetBytes(long long value) {
    m_writeOffsetBytesHasBeenSet = true;
    m_writeOffsetBytes = value;
  }
  inline PutObjectRequest& WithWriteOffsetBytes(long long value) {
    SetWriteOffsetBytes(value);
    return *this;
  }
  ///@}
  ...
  inline PutObjectRequest& WithServerSideEncryption(ServerSideEncryption value) {
  ...
  inline PutObjectRequest& WithStorageClass(StorageClass value) {
  ...
  inline PutObjectRequest& WithRequestPayer(RequestPayer value) {
  ...
  inline PutObjectRequest& WithObjectLockMode(ObjectLockMode value) {
  ...
  inline PutObjectRequest& WithObjectLockLegalHoldStatus(ObjectLockLegalHoldStatus value) {
