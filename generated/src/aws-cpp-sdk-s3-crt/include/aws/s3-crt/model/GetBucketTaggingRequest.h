...
/**
 */
class GetBucketTaggingRequest : public S3CrtRequest {
 public:
  AWS_S3CRT_API GetBucketTaggingRequest() = default;
  ...
  template <typename ExpectedBucketOwnerT = Aws::String>
  GetBucketTaggingRequest& WithExpectedBucketOwner(ExpectedBucketOwnerT&& value) {
  ...
  template <typename CustomizedAccessLogTagT = Aws::Map<Aws::String, Aws::String>>
  GetBucketTaggingRequest& WithCustomizedAccessLogTag(CustomizedAccessLogTagT&& value) {
