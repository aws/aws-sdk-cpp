...
class RestoreObjectRequest : public S3CrtRequest {
 public:
  ...
  void SetRestoreRequest(RestoreRequestT&& value) {
    m_restoreRequestHasBeenSet = true;
    m_restoreRequest = std::forward<RestoreRequestT>(value);
  }
  template <typename RestoreRequestT = RestoreRequest>
  RestoreObjectRequest& WithRestoreRequest(RestoreRequestT&& value) {
    SetRestoreRequest(std::forward<RestoreRequestT>(value));
    return *this;
  }
  ///@}
  ...
  inline RestoreObjectRequest& WithRequestPayer(RequestPayer value) {
  ...
  inline RestoreObjectRequest& WithChecksumAlgorithm(ChecksumAlgorithm value) {
