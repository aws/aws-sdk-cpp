...
class BlockedEncryptionTypes {
 public:
  AWS_S3CRT_API BlockedEncryptionTypes() = default;
  AWS_S3CRT_API BlockedEncryptionTypes(const Aws::Utils::Xml::XmlNode& xmlNode);
  AWS_S3CRT_API BlockedEncryptionTypes& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
