...
namespace Model
{
  ...
  {
  public:
    AWS_S3CRT_API Initiator() = default;
    AWS_S3CRT_API Initiator(const Aws::Utils::Xml::XmlNode& xmlNode);
    AWS_S3CRT_API Initiator& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
