...
class HeadObjectResult {
 public:
  ...
  inline HeadObjectResult& WithDeleteMarker(bool value) {
  ...
  inline void SetArchiveStatus(ArchiveStatus value) {
    m_archiveStatusHasBeenSet = true;
    m_archiveStatus = value;
  }
  inline HeadObjectResult& WithArchiveStatus(ArchiveStatus value) {
  ...
  inline HeadObjectResult& WithContentLength(long long value) {
  ...
  inline HeadObjectResult& WithChecksumType(ChecksumType value) {
  ...
  inline HeadObjectResult& WithMissingMeta(int value) {
  ...
  inline HeadObjectResult& WithServerSideEncryption(ServerSideEncryption value) {
  ...
  inline HeadObjectResult& WithBucketKeyEnabled(bool value) {
  ...
  inline HeadObjectResult& WithStorageClass(StorageClass value) {
  ...
  inline HeadObjectResult& WithRequestCharged(RequestCharged value) {
  ...
  inline HeadObjectResult& WithReplicationStatus(ReplicationStatus value) {
  ...
  inline HeadObjectResult& WithPartsCount(int value) {
    SetPartsCount(value);
    return *this;
  }
  ///@}
  ...
  inline HeadObjectResult& WithTagCount(int value) {
    SetTagCount(value);
    return *this;
  }
  ///@}
  ...
  inline HeadObjectResult& WithObjectLockMode(ObjectLockMode value) {
  ...
  inline HeadObjectResult& WithObjectLockLegalHoldStatus(ObjectLockLegalHoldStatus value) {
