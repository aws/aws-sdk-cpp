...
class ListBucketIntelligentTieringConfigurationsResult {
 public:
  AWS_S3CRT_API ListBucketIntelligentTieringConfigurationsResult() = default;
  AWS_S3CRT_API ListBucketIntelligentTieringConfigurationsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  AWS_S3CRT_API ListBucketIntelligentTieringConfigurationsResult& operator=(
  ...
  inline ListBucketIntelligentTieringConfigurationsResult& WithIsTruncated(bool value) {
  ...
  template <typename ContinuationTokenT = Aws::String>
  ListBucketIntelligentTieringConfigurationsResult& WithContinuationToken(ContinuationTokenT&& value) {
  ...
  template <typename NextContinuationTokenT = Aws::String>
  ListBucketIntelligentTieringConfigurationsResult& WithNextContinuationToken(NextContinuationTokenT&& value) {
   ...
   */
  inline const Aws::Vector<IntelligentTieringConfiguration>& GetIntelligentTieringConfigurationList() const {
    return m_intelligentTieringConfigurationList;
  }
  template <typename IntelligentTieringConfigurationListT = Aws::Vector<IntelligentTieringConfiguration>>
  void SetIntelligentTieringConfigurationList(IntelligentTieringConfigurationListT&& value) {
    m_intelligentTieringConfigurationListHasBeenSet = true;
    m_intelligentTieringConfigurationList = std::forward<IntelligentTieringConfigurationListT>(value);
  }
  template <typename IntelligentTieringConfigurationListT = Aws::Vector<IntelligentTieringConfiguration>>
  ListBucketIntelligentTieringConfigurationsResult& WithIntelligentTieringConfigurationList(IntelligentTieringConfigurationListT&& value) {
    SetIntelligentTieringConfigurationList(std::forward<IntelligentTieringConfigurationListT>(value));
    return *this;
  }
  template <typename IntelligentTieringConfigurationListT = IntelligentTieringConfiguration>
  ListBucketIntelligentTieringConfigurationsResult& AddIntelligentTieringConfigurationList(IntelligentTieringConfigurationListT&& value) {
    m_intelligentTieringConfigurationListHasBeenSet = true;
    m_intelligentTieringConfigurationList.emplace_back(std::forward<IntelligentTieringConfigurationListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListBucketIntelligentTieringConfigurationsResult& WithRequestId(RequestIdT&& value) {
