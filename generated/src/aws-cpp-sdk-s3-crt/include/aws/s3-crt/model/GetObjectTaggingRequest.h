...
class GetObjectTaggingRequest : public S3CrtRequest {
 public:
  ...
  template <typename BucketT = Aws::String>
  GetObjectTaggingRequest& WithBucket(BucketT&& value) {
  ...
  template <typename KeyT = Aws::String>
  GetObjectTaggingRequest& WithKey(KeyT&& value) {
  ...
  template <typename VersionIdT = Aws::String>
  GetObjectTaggingRequest& WithVersionId(VersionIdT&& value) {
  ...
  template <typename ExpectedBucketOwnerT = Aws::String>
  GetObjectTaggingRequest& WithExpectedBucketOwner(ExpectedBucketOwnerT&& value) {
  ...
  inline GetObjectTaggingRequest& WithRequestPayer(RequestPayer value) {
  ...
  template <typename CustomizedAccessLogTagT = Aws::Map<Aws::String, Aws::String>>
  GetObjectTaggingRequest& WithCustomizedAccessLogTag(CustomizedAccessLogTagT&& value) {
