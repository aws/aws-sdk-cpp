...
class ListBucketAnalyticsConfigurationsResult {
 public:
  AWS_S3CRT_API ListBucketAnalyticsConfigurationsResult() = default;
  AWS_S3CRT_API ListBucketAnalyticsConfigurationsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  AWS_S3CRT_API ListBucketAnalyticsConfigurationsResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  ...
  inline ListBucketAnalyticsConfigurationsResult& WithIsTruncated(bool value) {
  ...
  template <typename ContinuationTokenT = Aws::String>
  ListBucketAnalyticsConfigurationsResult& WithContinuationToken(ContinuationTokenT&& value) {
  ...
  template <typename NextContinuationTokenT = Aws::String>
  ListBucketAnalyticsConfigurationsResult& WithNextContinuationToken(NextContinuationTokenT&& value) {
  ...
  void SetAnalyticsConfigurationList(AnalyticsConfigurationListT&& value) {
    m_analyticsConfigurationListHasBeenSet = true;
    m_analyticsConfigurationList = std::forward<AnalyticsConfigurationListT>(value);
  }
  template <typename AnalyticsConfigurationListT = Aws::Vector<AnalyticsConfiguration>>
  ListBucketAnalyticsConfigurationsResult& WithAnalyticsConfigurationList(AnalyticsConfigurationListT&& value) {
    SetAnalyticsConfigurationList(std::forward<AnalyticsConfigurationListT>(value));
    return *this;
  }
  template <typename AnalyticsConfigurationListT = AnalyticsConfiguration>
  ListBucketAnalyticsConfigurationsResult& AddAnalyticsConfigurationList(AnalyticsConfigurationListT&& value) {
    m_analyticsConfigurationListHasBeenSet = true;
    m_analyticsConfigurationList.emplace_back(std::forward<AnalyticsConfigurationListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListBucketAnalyticsConfigurationsResult& WithRequestId(RequestIdT&& value) {
