...
class DeleteObjectTaggingRequest : public S3CrtRequest {
 public:
  ...
  template <typename BucketT = Aws::String>
  DeleteObjectTaggingRequest& WithBucket(BucketT&& value) {
  ...
  template <typename KeyT = Aws::String>
  DeleteObjectTaggingRequest& WithKey(KeyT&& value) {
  ...
  template <typename VersionIdT = Aws::String>
  DeleteObjectTaggingRequest& WithVersionId(VersionIdT&& value) {
  ...
  template <typename ExpectedBucketOwnerT = Aws::String>
  DeleteObjectTaggingRequest& WithExpectedBucketOwner(ExpectedBucketOwnerT&& value) {
  ...
  template <typename CustomizedAccessLogTagT = Aws::Map<Aws::String, Aws::String>>
  DeleteObjectTaggingRequest& WithCustomizedAccessLogTag(CustomizedAccessLogTagT&& value) {
