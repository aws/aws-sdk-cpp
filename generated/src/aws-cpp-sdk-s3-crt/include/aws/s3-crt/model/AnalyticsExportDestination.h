...
class AnalyticsExportDestination {
 public:
  AWS_S3CRT_API AnalyticsExportDestination() = default;
  AWS_S3CRT_API AnalyticsExportDestination(const Aws::Utils::Xml::XmlNode& xmlNode);
  AWS_S3CRT_API AnalyticsExportDestination& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
  ...
  template <typename S3BucketDestinationT = AnalyticsS3BucketDestination>
  AnalyticsExportDestination& WithS3BucketDestination(S3BucketDestinationT&& value) {
