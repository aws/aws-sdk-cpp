...
/**
 */
class ListObjectVersionsRequest : public S3CrtRequest {
 public:
  AWS_S3CRT_API ListObjectVersionsRequest() = default;
  ...
  inline ListObjectVersionsRequest& WithEncodingType(EncodingType value) {
  ...
  inline ListObjectVersionsRequest& WithMaxKeys(int value) {
    SetMaxKeys(value);
    return *this;
  }
  ///@}
  ...
  inline ListObjectVersionsRequest& WithRequestPayer(RequestPayer value) {
  ...
  void SetOptionalObjectAttributes(OptionalObjectAttributesT&& value) {
    ...
    m_optionalObjectAttributes = std::forward<OptionalObjectAttributesT>(value);
  }
  template <typename OptionalObjectAttributesT = Aws::Vector<OptionalObjectAttributes>>
  ListObjectVersionsRequest& WithOptionalObjectAttributes(OptionalObjectAttributesT&& value) {
    SetOptionalObjectAttributes(std::forward<OptionalObjectAttributesT>(value));
    return *this;
  }
  inline ListObjectVersionsRequest& AddOptionalObjectAttributes(OptionalObjectAttributes value) {
    m_optionalObjectAttributesHasBeenSet = true;
    m_optionalObjectAttributes.push_back(value);
    return *this;
  }
  ///@}
