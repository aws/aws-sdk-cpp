...
class PutObjectLockConfigurationRequest : public S3CrtRequest {
 public:
  ...
  inline PutObjectLockConfigurationRequest& WithRequestPayer(RequestPayer value) {
  ...
  inline PutObjectLockConfigurationRequest& WithChecksumAlgorithm(ChecksumAlgorithm value) {
