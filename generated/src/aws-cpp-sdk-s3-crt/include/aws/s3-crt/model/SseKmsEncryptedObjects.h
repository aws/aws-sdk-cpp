...
class SseKmsEncryptedObjects {
 public:
  AWS_S3CRT_API SseKmsEncryptedObjects() = default;
  AWS_S3CRT_API SseKmsEncryptedObjects(const Aws::Utils::Xml::XmlNode& xmlNode);
  AWS_S3CRT_API SseKmsEncryptedObjects& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
  ...
  inline void SetStatus(SseKmsEncryptedObjectsStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline SseKmsEncryptedObjects& WithStatus(SseKmsEncryptedObjectsStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
