...
class ListObjectsV2Result {
 public:
  AWS_S3CRT_API ListObjectsV2Result() = default;
  AWS_S3CRT_API ListObjectsV2Result(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  AWS_S3CRT_API ListObjectsV2Result& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  ...
  inline ListObjectsV2Result& WithIsTruncated(bool value) {
  ...
  inline ListObjectsV2Result& WithMaxKeys(int value) {
    SetMaxKeys(value);
    return *this;
  }
  ///@}
  ...
  inline ListObjectsV2Result& WithEncodingType(EncodingType value) {
  ...
  inline void SetKeyCount(int value) {
    m_keyCountHasBeenSet = true;
    m_keyCount = value;
  }
  inline ListObjectsV2Result& WithKeyCount(int value) {
    SetKeyCount(value);
    return *this;
  }
  ///@}
  ...
  inline ListObjectsV2Result& WithRequestCharged(RequestCharged value) {
