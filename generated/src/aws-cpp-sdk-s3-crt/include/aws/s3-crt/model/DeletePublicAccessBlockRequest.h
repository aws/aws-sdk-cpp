...
class DeletePublicAccessBlockRequest : public S3CrtRequest {
 public:
  ...
  template <typename BucketT = Aws::String>
  DeletePublicAccessBlockRequest& WithBucket(BucketT&& value) {
  ...
  template <typename ExpectedBucketOwnerT = Aws::String>
  DeletePublicAccessBlockRequest& WithExpectedBucketOwner(ExpectedBucketOwnerT&& value) {
  ...
  template <typename CustomizedAccessLogTagT = Aws::Map<Aws::String, Aws::String>>
  DeletePublicAccessBlockRequest& WithCustomizedAccessLogTag(CustomizedAccessLogTagT&& value) {
