...
class GetBucketAnalyticsConfigurationRequest : public S3CrtRequest {
 public:
  ...
  template <typename BucketT = Aws::String>
  GetBucketAnalyticsConfigurationRequest& WithBucket(BucketT&& value) {
  ...
  template <typename IdT = Aws::String>
  GetBucketAnalyticsConfigurationRequest& WithId(IdT&& value) {
  ...
  template <typename ExpectedBucketOwnerT = Aws::String>
  GetBucketAnalyticsConfigurationRequest& WithExpectedBucketOwner(ExpectedBucketOwnerT&& value) {
  ...
  template <typename CustomizedAccessLogTagT = Aws::Map<Aws::String, Aws::String>>
  GetBucketAnalyticsConfigurationRequest& WithCustomizedAccessLogTag(CustomizedAccessLogTagT&& value) {
  ...
  GetBucketAnalyticsConfigurationRequest& AddCustomizedAccessLogTag(CustomizedAccessLogTagKeyT&& key,
