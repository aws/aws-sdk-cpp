...
class InventoryTableConfigurationUpdates {
 public:
  AWS_S3CRT_API InventoryTableConfigurationUpdates() = default;
  AWS_S3CRT_API InventoryTableConfigurationUpdates(const Aws::Utils::Xml::XmlNode& xmlNode);
  AWS_S3CRT_API InventoryTableConfigurationUpdates& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
  ...
  inline InventoryTableConfigurationUpdates& WithConfigurationState(InventoryConfigurationState value) {
