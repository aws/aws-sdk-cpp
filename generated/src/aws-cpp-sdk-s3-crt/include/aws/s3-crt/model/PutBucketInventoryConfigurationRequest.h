...
/**
 */
class PutBucketInventoryConfigurationRequest : public S3CrtRequest {
 public:
  AWS_S3CRT_API PutBucketInventoryConfigurationRequest() = default;
  ...
  template <typename BucketT = Aws::String>
  PutBucketInventoryConfigurationRequest& WithBucket(BucketT&& value) {
  ...
  template <typename IdT = Aws::String>
  PutBucketInventoryConfigurationRequest& WithId(IdT&& value) {
  ...
  void SetInventoryConfiguration(InventoryConfigurationT&& value) {
    m_inventoryConfigurationHasBeenSet = true;
    m_inventoryConfiguration = std::forward<InventoryConfigurationT>(value);
  }
  template <typename InventoryConfigurationT = InventoryConfiguration>
  PutBucketInventoryConfigurationRequest& WithInventoryConfiguration(InventoryConfigurationT&& value) {
    SetInventoryConfiguration(std::forward<InventoryConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ExpectedBucketOwnerT = Aws::String>
  PutBucketInventoryConfigurationRequest& WithExpectedBucketOwner(ExpectedBucketOwnerT&& value) {
  ...
  template <typename CustomizedAccessLogTagT = Aws::Map<Aws::String, Aws::String>>
  PutBucketInventoryConfigurationRequest& WithCustomizedAccessLogTag(CustomizedAccessLogTagT&& value) {
  ...
  PutBucketInventoryConfigurationRequest& AddCustomizedAccessLogTag(CustomizedAccessLogTagKeyT&& key,
