...
class PutBucketTaggingRequest : public S3CrtRequest {
 public:
  AWS_S3CRT_API PutBucketTaggingRequest() = default;
  ...
  template <typename BucketT = Aws::String>
  PutBucketTaggingRequest& WithBucket(BucketT&& value) {
  ...
  template <typename ContentMD5T = Aws::String>
  PutBucketTaggingRequest& WithContentMD5(ContentMD5T&& value) {
  ...
  inline PutBucketTaggingRequest& WithChecksumAlgorithm(ChecksumAlgorithm value) {
  ...
  template <typename TaggingT = Tagging>
  PutBucketTaggingRequest& WithTagging(TaggingT&& value) {
  ...
  template <typename ExpectedBucketOwnerT = Aws::String>
  PutBucketTaggingRequest& WithExpectedBucketOwner(ExpectedBucketOwnerT&& value) {
  ...
  template <typename CustomizedAccessLogTagT = Aws::Map<Aws::String, Aws::String>>
  PutBucketTaggingRequest& WithCustomizedAccessLogTag(CustomizedAccessLogTagT&& value) {
