...
class UpdateBucketMetadataJournalTableConfigurationRequest : public S3CrtRequest {
 public:
  ...
  template <typename BucketT = Aws::String>
  UpdateBucketMetadataJournalTableConfigurationRequest& WithBucket(BucketT&& value) {
  ...
  template <typename ContentMD5T = Aws::String>
  UpdateBucketMetadataJournalTableConfigurationRequest& WithContentMD5(ContentMD5T&& value) {
  ...
  inline UpdateBucketMetadataJournalTableConfigurationRequest& WithChecksumAlgorithm(ChecksumAlgorithm value) {
  ...
  void SetJournalTableConfiguration(JournalTableConfigurationT&& value) {
    ...
    m_journalTableConfiguration = std::forward<JournalTableConfigurationT>(value);
  }
  template <typename JournalTableConfigurationT = JournalTableConfigurationUpdates>
  UpdateBucketMetadataJournalTableConfigurationRequest& WithJournalTableConfiguration(JournalTableConfigurationT&& value) {
    SetJournalTableConfiguration(std::forward<JournalTableConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ExpectedBucketOwnerT = Aws::String>
  UpdateBucketMetadataJournalTableConfigurationRequest& WithExpectedBucketOwner(ExpectedBucketOwnerT&& value) {
  ...
  template <typename CustomizedAccessLogTagT = Aws::Map<Aws::String, Aws::String>>
  UpdateBucketMetadataJournalTableConfigurationRequest& WithCustomizedAccessLogTag(CustomizedAccessLogTagT&& value) {
  ...
  UpdateBucketMetadataJournalTableConfigurationRequest& AddCustomizedAccessLogTag(CustomizedAccessLogTagKeyT&& key,
