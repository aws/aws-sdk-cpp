...
namespace Model
{
  ...
  {
  public:
    AWS_S3CRT_API GetBucketPolicyResult() = default;
    AWS_S3CRT_API GetBucketPolicyResult(GetBucketPolicyResult&&) = default;
    AWS_S3CRT_API GetBucketPolicyResult& operator=(GetBucketPolicyResult&&) = default;
    ...
    AWS_S3CRT_API GetBucketPolicyResult(Aws::AmazonWebServiceResult<Aws::Utils::Stream::ResponseStream>&& result);
    AWS_S3CRT_API GetBucketPolicyResult& operator=(Aws::AmazonWebServiceResult<Aws::Utils::Stream::ResponseStream>&& result);
