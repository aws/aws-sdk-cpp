...
namespace Model
{
  ...
  {
  public:
    AWS_S3CRT_API SessionCredentials() = default;
    AWS_S3CRT_API SessionCredentials(const Aws::Utils::Xml::XmlNode& xmlNode);
    AWS_S3CRT_API SessionCredentials& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
