...
/**
 */
class DeleteBucketMetadataTableConfigurationRequest : public S3CrtRequest {
 public:
  AWS_S3CRT_API DeleteBucketMetadataTableConfigurationRequest() = default;
  ...
  template <typename BucketT = Aws::String>
  DeleteBucketMetadataTableConfigurationRequest& WithBucket(BucketT&& value) {
  ...
  template <typename ExpectedBucketOwnerT = Aws::String>
  DeleteBucketMetadataTableConfigurationRequest& WithExpectedBucketOwner(ExpectedBucketOwnerT&& value) {
  ...
  template <typename CustomizedAccessLogTagT = Aws::Map<Aws::String, Aws::String>>
  DeleteBucketMetadataTableConfigurationRequest& WithCustomizedAccessLogTag(CustomizedAccessLogTagT&& value) {
  ...
  DeleteBucketMetadataTableConfigurationRequest& AddCustomizedAccessLogTag(CustomizedAccessLogTagKeyT&& key,
