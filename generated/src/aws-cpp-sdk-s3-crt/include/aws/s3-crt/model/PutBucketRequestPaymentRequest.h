...
/**
 */
class PutBucketRequestPaymentRequest : public S3CrtRequest {
 public:
  AWS_S3CRT_API PutBucketRequestPaymentRequest() = default;
  ...
  template <typename BucketT = Aws::String>
  PutBucketRequestPaymentRequest& WithBucket(BucketT&& value) {
  ...
  template <typename ContentMD5T = Aws::String>
  PutBucketRequestPaymentRequest& WithContentMD5(ContentMD5T&& value) {
  ...
  inline PutBucketRequestPaymentRequest& WithChecksumAlgorithm(ChecksumAlgorithm value) {
  ...
  void SetRequestPaymentConfiguration(RequestPaymentConfigurationT&& value) {
    m_requestPaymentConfigurationHasBeenSet = true;
    m_requestPaymentConfiguration = std::forward<RequestPaymentConfigurationT>(value);
  }
  template <typename RequestPaymentConfigurationT = RequestPaymentConfiguration>
  PutBucketRequestPaymentRequest& WithRequestPaymentConfiguration(RequestPaymentConfigurationT&& value) {
    SetRequestPaymentConfiguration(std::forward<RequestPaymentConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ExpectedBucketOwnerT = Aws::String>
  PutBucketRequestPaymentRequest& WithExpectedBucketOwner(ExpectedBucketOwnerT&& value) {
  ...
  template <typename CustomizedAccessLogTagT = Aws::Map<Aws::String, Aws::String>>
  PutBucketRequestPaymentRequest& WithCustomizedAccessLogTag(CustomizedAccessLogTagT&& value) {
