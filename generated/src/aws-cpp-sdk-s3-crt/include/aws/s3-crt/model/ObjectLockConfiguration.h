...
class ObjectLockConfiguration {
 public:
  ...
  inline void SetObjectLockEnabled(ObjectLockEnabled value) {
    m_objectLockEnabledHasBeenSet = true;
    m_objectLockEnabled = value;
  }
  inline ObjectLockConfiguration& WithObjectLockEnabled(ObjectLockEnabled value) {
    SetObjectLockEnabled(value);
    return *this;
  }
  ///@}
