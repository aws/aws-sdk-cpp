...
class ListPartsResult {
 public:
  AWS_S3CRT_API ListPartsResult() = default;
  ...
  inline ListPartsResult& WithPartNumberMarker(int value) {
  ...
  inline ListPartsResult& WithNextPartNumberMarker(int value) {
  ...
  inline ListPartsResult& WithMaxParts(int value) {
    SetMaxParts(value);
    return *this;
  }
  ///@}
  ...
  inline ListPartsResult& WithIsTruncated(bool value) {
  ...
  inline ListPartsResult& WithStorageClass(StorageClass value) {
  ...
  inline ListPartsResult& WithRequestCharged(RequestCharged value) {
  ...
  inline ListPartsResult& WithChecksumAlgorithm(ChecksumAlgorithm value) {
  ...
  inline ListPartsResult& WithChecksumType(ChecksumType value) {
