...
namespace Model
{
  ...
  {
  public:
    AWS_S3CRT_API JournalTableConfigurationResult() = default;
    AWS_S3CRT_API JournalTableConfigurationResult(const Aws::Utils::Xml::XmlNode& xmlNode);
    AWS_S3CRT_API JournalTableConfigurationResult& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
