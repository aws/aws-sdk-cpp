...
class CopyObjectRequest : public S3CrtRequest {
 public:
  ...
  inline void SetACL(ObjectCannedACL value) {
    m_aCLHasBeenSet = true;
    m_aCL = value;
  }
  inline CopyObjectRequest& WithACL(ObjectCannedACL value) {
    SetACL(value);
    return *this;
  }
  ///@}
  ...
  inline CopyObjectRequest& WithChecksumAlgorithm(ChecksumAlgorithm value) {
  ...
  void SetContentLanguage(ContentLanguageT&& value) {
    ...
    m_contentLanguage = std::forward<ContentLanguageT>(value);
  }
  template <typename ContentLanguageT = Aws::String>
  CopyObjectRequest& WithContentLanguage(ContentLanguageT&& value) {
    SetContentLanguage(std::forward<ContentLanguageT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCopySource(CopySourceT&& value) {
    m_copySourceHasBeenSet = true;
    m_copySource = std::forward<CopySourceT>(value);
  }
  template <typename CopySourceT = Aws::String>
  CopyObjectRequest& WithCopySource(CopySourceT&& value) {
    SetCopySource(std::forward<CopySourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCopySourceIfMatch(CopySourceIfMatchT&& value) {
    m_copySourceIfMatchHasBeenSet = true;
    m_copySourceIfMatch = std::forward<CopySourceIfMatchT>(value);
  }
  template <typename CopySourceIfMatchT = Aws::String>
  CopyObjectRequest& WithCopySourceIfMatch(CopySourceIfMatchT&& value) {
    SetCopySourceIfMatch(std::forward<CopySourceIfMatchT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCopySourceIfModifiedSince(CopySourceIfModifiedSinceT&& value) {
    m_copySourceIfModifiedSinceHasBeenSet = true;
    m_copySourceIfModifiedSince = std::forward<CopySourceIfModifiedSinceT>(value);
  }
  template <typename CopySourceIfModifiedSinceT = Aws::Utils::DateTime>
  CopyObjectRequest& WithCopySourceIfModifiedSince(CopySourceIfModifiedSinceT&& value) {
    SetCopySourceIfModifiedSince(std::forward<CopySourceIfModifiedSinceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCopySourceIfNoneMatch(CopySourceIfNoneMatchT&& value) {
    m_copySourceIfNoneMatchHasBeenSet = true;
    m_copySourceIfNoneMatch = std::forward<CopySourceIfNoneMatchT>(value);
  }
  template <typename CopySourceIfNoneMatchT = Aws::String>
  CopyObjectRequest& WithCopySourceIfNoneMatch(CopySourceIfNoneMatchT&& value) {
    SetCopySourceIfNoneMatch(std::forward<CopySourceIfNoneMatchT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCopySourceIfUnmodifiedSince(CopySourceIfUnmodifiedSinceT&& value) {
    m_copySourceIfUnmodifiedSinceHasBeenSet = true;
    m_copySourceIfUnmodifiedSince = std::forward<CopySourceIfUnmodifiedSinceT>(value);
  }
  template <typename CopySourceIfUnmodifiedSinceT = Aws::Utils::DateTime>
  CopyObjectRequest& WithCopySourceIfUnmodifiedSince(CopySourceIfUnmodifiedSinceT&& value) {
    SetCopySourceIfUnmodifiedSince(std::forward<CopySourceIfUnmodifiedSinceT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetMetadataDirective(MetadataDirective value) {
    m_metadataDirectiveHasBeenSet = true;
    m_metadataDirective = value;
  }
  inline CopyObjectRequest& WithMetadataDirective(MetadataDirective value) {
  ...
  inline void SetTaggingDirective(TaggingDirective value) {
    m_taggingDirectiveHasBeenSet = true;
    m_taggingDirective = value;
  }
  inline CopyObjectRequest& WithTaggingDirective(TaggingDirective value) {
    SetTaggingDirective(value);
    return *this;
  }
  ///@}
  ...
  inline CopyObjectRequest& WithServerSideEncryption(ServerSideEncryption value) {
  ...
  inline CopyObjectRequest& WithStorageClass(StorageClass value) {
  ...
  void SetWebsiteRedirectLocation(WebsiteRedirectLocationT&& value) {
    ...
    m_websiteRedirectLocation = std::forward<WebsiteRedirectLocationT>(value);
  }
  template <typename WebsiteRedirectLocationT = Aws::String>
  CopyObjectRequest& WithWebsiteRedirectLocation(WebsiteRedirectLocationT&& value) {
    SetWebsiteRedirectLocation(std::forward<WebsiteRedirectLocationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSSECustomerKey(SSECustomerKeyT&& value) {
    ...
    m_sSECustomerKey = std::forward<SSECustomerKeyT>(value);
  }
  template <typename SSECustomerKeyT = Aws::String>
  CopyObjectRequest& WithSSECustomerKey(SSECustomerKeyT&& value) {
    SetSSECustomerKey(std::forward<SSECustomerKeyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCopySourceSSECustomerAlgorithm(CopySourceSSECustomerAlgorithmT&& value) {
    m_copySourceSSECustomerAlgorithmHasBeenSet = true;
    m_copySourceSSECustomerAlgorithm = std::forward<CopySourceSSECustomerAlgorithmT>(value);
  }
  template <typename CopySourceSSECustomerAlgorithmT = Aws::String>
  CopyObjectRequest& WithCopySourceSSECustomerAlgorithm(CopySourceSSECustomerAlgorithmT&& value) {
    SetCopySourceSSECustomerAlgorithm(std::forward<CopySourceSSECustomerAlgorithmT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCopySourceSSECustomerKey(CopySourceSSECustomerKeyT&& value) {
    m_copySourceSSECustomerKeyHasBeenSet = true;
    m_copySourceSSECustomerKey = std::forward<CopySourceSSECustomerKeyT>(value);
  }
  template <typename CopySourceSSECustomerKeyT = Aws::String>
  CopyObjectRequest& WithCopySourceSSECustomerKey(CopySourceSSECustomerKeyT&& value) {
    SetCopySourceSSECustomerKey(std::forward<CopySourceSSECustomerKeyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCopySourceSSECustomerKeyMD5(CopySourceSSECustomerKeyMD5T&& value) {
    m_copySourceSSECustomerKeyMD5HasBeenSet = true;
    m_copySourceSSECustomerKeyMD5 = std::forward<CopySourceSSECustomerKeyMD5T>(value);
  }
  template <typename CopySourceSSECustomerKeyMD5T = Aws::String>
  CopyObjectRequest& WithCopySourceSSECustomerKeyMD5(CopySourceSSECustomerKeyMD5T&& value) {
    SetCopySourceSSECustomerKeyMD5(std::forward<CopySourceSSECustomerKeyMD5T>(value));
    return *this;
  }
  ///@}
  ...
  inline CopyObjectRequest& WithRequestPayer(RequestPayer value) {
  ...
  void SetTagging(TaggingT&& value) {
    ...
    m_tagging = std::forward<TaggingT>(value);
  }
  template <typename TaggingT = Aws::String>
  CopyObjectRequest& WithTagging(TaggingT&& value) {
    SetTagging(std::forward<TaggingT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetObjectLockMode(ObjectLockMode value) {
    ...
    m_objectLockMode = value;
  }
  inline CopyObjectRequest& WithObjectLockMode(ObjectLockMode value) {
    SetObjectLockMode(value);
    return *this;
  }
  ///@}
  ...
  void SetObjectLockRetainUntilDate(ObjectLockRetainUntilDateT&& value) {
    ...
    m_objectLockRetainUntilDate = std::forward<ObjectLockRetainUntilDateT>(value);
  }
  template <typename ObjectLockRetainUntilDateT = Aws::Utils::DateTime>
  CopyObjectRequest& WithObjectLockRetainUntilDate(ObjectLockRetainUntilDateT&& value) {
    SetObjectLockRetainUntilDate(std::forward<ObjectLockRetainUntilDateT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetObjectLockLegalHoldStatus(ObjectLockLegalHoldStatus value) {
    ...
    m_objectLockLegalHoldStatus = value;
  }
  inline CopyObjectRequest& WithObjectLockLegalHoldStatus(ObjectLockLegalHoldStatus value) {
    SetObjectLockLegalHoldStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetExpectedSourceBucketOwner(ExpectedSourceBucketOwnerT&& value) {
    m_expectedSourceBucketOwnerHasBeenSet = true;
    m_expectedSourceBucketOwner = std::forward<ExpectedSourceBucketOwnerT>(value);
  }
  template <typename ExpectedSourceBucketOwnerT = Aws::String>
  CopyObjectRequest& WithExpectedSourceBucketOwner(ExpectedSourceBucketOwnerT&& value) {
    SetExpectedSourceBucketOwner(std::forward<ExpectedSourceBucketOwnerT>(value));
    return *this;
  }
  ///@}
