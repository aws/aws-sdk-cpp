...
class ObjectVersion {
 public:
  AWS_S3CRT_API ObjectVersion() = default;
  ...
  inline ObjectVersion& AddChecksumAlgorithm(ChecksumAlgorithm value) {
    m_checksumAlgorithmHasBeenSet = true;
  ...
  inline ObjectVersion& WithChecksumType(ChecksumType value) {
  ...
  inline ObjectVersion& WithSize(long long value) {
    SetSize(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStorageClass(ObjectVersionStorageClass value) {
    m_storageClassHasBeenSet = true;
    m_storageClass = value;
  }
  inline ObjectVersion& WithStorageClass(ObjectVersionStorageClass value) {
  ...
  inline ObjectVersion& WithIsLatest(bool value) {
    SetIsLatest(value);
    return *this;
  }
  ///@}
