...
class CompleteMultipartUploadRequest : public S3CrtRequest {
 public:
  AWS_S3CRT_API CompleteMultipartUploadRequest() = default;
  ...
  void SetMultipartUpload(MultipartUploadT&& value) {
    m_multipartUploadHasBeenSet = true;
    m_multipartUpload = std::forward<MultipartUploadT>(value);
  }
  template <typename MultipartUploadT = CompletedMultipartUpload>
  CompleteMultipartUploadRequest& WithMultipartUpload(MultipartUploadT&& value) {
    SetMultipartUpload(std::forward<MultipartUploadT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ChecksumSHA512T = Aws::String>
  CompleteMultipartUploadRequest& WithChecksumSHA512(ChecksumSHA512T&& value) {
  ...
  template <typename ChecksumMD5T = Aws::String>
  CompleteMultipartUploadRequest& WithChecksumMD5(ChecksumMD5T&& value) {
  ...
  template <typename ChecksumXXHASH64T = Aws::String>
  CompleteMultipartUploadRequest& WithChecksumXXHASH64(ChecksumXXHASH64T&& value) {
  ...
  template <typename ChecksumXXHASH3T = Aws::String>
  CompleteMultipartUploadRequest& WithChecksumXXHASH3(ChecksumXXHASH3T&& value) {
  ...
  template <typename ChecksumXXHASH128T = Aws::String>
  CompleteMultipartUploadRequest& WithChecksumXXHASH128(ChecksumXXHASH128T&& value) {
  ...
  inline CompleteMultipartUploadRequest& WithChecksumType(ChecksumType value) {
  ...
  inline void SetMpuObjectSize(long long value) {
    m_mpuObjectSizeHasBeenSet = true;
    m_mpuObjectSize = value;
  }
  inline CompleteMultipartUploadRequest& WithMpuObjectSize(long long value) {
    SetMpuObjectSize(value);
    return *this;
  }
  ///@}
  ...
  inline CompleteMultipartUploadRequest& WithRequestPayer(RequestPayer value) {
