...
/**
 */
class DeleteBucketPolicyRequest : public S3CrtRequest {
 public:
  AWS_S3CRT_API DeleteBucketPolicyRequest() = default;
  ...
  template <typename BucketT = Aws::String>
  DeleteBucketPolicyRequest& WithBucket(BucketT&& value) {
  ...
  template <typename ExpectedBucketOwnerT = Aws::String>
  DeleteBucketPolicyRequest& WithExpectedBucketOwner(ExpectedBucketOwnerT&& value) {
  ...
  template <typename CustomizedAccessLogTagT = Aws::Map<Aws::String, Aws::String>>
  DeleteBucketPolicyRequest& WithCustomizedAccessLogTag(CustomizedAccessLogTagT&& value) {
