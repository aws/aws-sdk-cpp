...
S3CrtClient::S3CrtClient(const S3Crt::ClientConfiguration& clientConfiguration,
                         Aws::Client::AWSAuthV4Signer::PayloadSigningPolicy signPayloads, bool useVirtualAddressing,
                         Aws::S3Crt::US_EAST_1_REGIONAL_ENDPOINT_OPTION USEast1RegionalEndPointOption,
                         const Aws::Auth::DefaultAWSCredentialsProviderChain& credentialsProvider)
    : BASECLASS(clientConfiguration,
                Aws::MakeShared<Aws::Auth::S3ExpressSignerProvider>(
                    ALLOCATION_TAG, Aws::MakeShared<DefaultAWSCredentialsProviderChain>(ALLOCATION_TAG, credentialsProvider),
                    Aws::MakeShared<DefaultS3ExpressIdentityProvider>(ALLOCATION_TAG, *this), SERVICE_NAME,
                    Aws::Region::ComputeSignerRegion(clientConfiguration.region), signPayloads, false),
                Aws::MakeShared<S3CrtErrorMarshaller>(ALLOCATION_TAG)),
...
S3CrtClient::S3CrtClient(const AWSCredentials& credentials, const S3Crt::ClientConfiguration& clientConfiguration,
                         Aws::Client::AWSAuthV4Signer::PayloadSigningPolicy signPayloads, bool useVirtualAddressing,
                         Aws::S3Crt::US_EAST_1_REGIONAL_ENDPOINT_OPTION USEast1RegionalEndPointOption)
    : BASECLASS(clientConfiguration,
                Aws::MakeShared<Aws::Auth::S3ExpressSignerProvider>(
...
S3CrtClient::S3CrtClient(const std::shared_ptr<AWSCredentialsProvider>& credentialsProvider,
                         const S3Crt::ClientConfiguration& clientConfiguration,
                         Aws::Client::AWSAuthV4Signer::PayloadSigningPolicy signPayloads, bool useVirtualAddressing,
                         Aws::S3Crt::US_EAST_1_REGIONAL_ENDPOINT_OPTION USEast1RegionalEndPointOption)
    : BASECLASS(clientConfiguration,
                Aws::MakeShared<Aws::Auth::S3ExpressSignerProvider>(
...
std::shared_ptr<S3CrtEndpointProviderBase>& S3CrtClient::accessEndpointProvider() { return m_endpointProvider; }
...
void S3CrtClient::init(const S3Crt::ClientConfiguration& config,
  ...
  if (config.enableTcpKeepAlive) {
    uint16_t configKeepAliveS = static_cast<uint16_t>(
        std::min(static_cast<unsigned long>(std::numeric_limits<uint16_t>::max()), config.tcpKeepAliveIntervalMs / 1000ul));
  ...
  if (config.lowSpeedLimit) {
    ...
    uint32_t configMonitoringS =
        static_cast<uint32_t>(std::min(static_cast<unsigned long>(std::numeric_limits<uint32_t>::max()), config.requestTimeoutMs / 1000ul));
  ...
  m_crtCredProvider = Aws::Crt::Auth::CredentialsProvider::CreateCredentialsProviderDelegate({std::bind(
      [](const std::shared_ptr<AWSCredentialsProvider>& provider) {
        ...
        return Aws::MakeShared<Aws::Crt::Auth::Credentials>(
            ALLOCATION_TAG,
            *Aws::MakeShared<Aws::Crt::ByteCursor>(ALLOCATION_TAG,
  ...
  aws_s3_init_default_signing_config(&m_s3CrtSigningConfig, Aws::Crt::ByteCursorFromCString(config.region.c_str()),
                                     m_crtCredProvider->GetUnderlyingHandle());
  ...
  if (config.tlsConnectionOptions) {
    ...
    if (!config.caPath.empty() || !config.caFile.empty()) {
      AWS_LOGSTREAM_WARN(ALLOCATION_TAG,
                         "caPath or caFile on client configuration are ignored in case of user-configured TlsConnectionOptions provided");
    }
  }
  ...
  if (!config.proxyHost.empty()) {
    if (!config.proxyUserName.empty() || !config.proxyPassword.empty()) {
      ...
      proxyOptions.ProxyStrategy =
          Aws::Crt::Http::HttpProxyStrategy::CreateBasicHttpProxyStrategy(basicAuthConfig, Aws::get_aws_allocator());
    }
...
S3CrtClient::InvokeOperationOutcome S3CrtClient::InvokeServiceOperation(
...
int S3CrtClient::S3CrtRequestGetBodyCallback(struct aws_s3_meta_request* meta_request, const struct aws_byte_cursor* body,
...
void S3CrtClient::S3CrtRequestProgressCallback(struct aws_s3_meta_request* meta_request,
                                               const struct aws_s3_meta_request_progress* progress, void* user_data) {
  AWS_UNREFERENCED_PARAM(meta_request);
...
void S3CrtClient::S3CrtRequestFinishCallback(struct aws_s3_meta_request* meta_request,
  ...
  if (meta_request_result->error_code != AWS_ERROR_SUCCESS && meta_request_result->response_status == 0) {
    ...
    Aws::StringStream ss;
    ss << "crtCode: " << meta_request_result->error_code << ", " << aws_error_name(meta_request_result->error_code) << " - "
  ...
  if (meta_request_result->error_response_body) {
    ...
    bodyStream.seekg(0);
    bodyStream.seekp(0);
    bodyStream.write(reinterpret_cast<char*>(meta_request_result->error_response_body->buffer),
                     static_cast<std::streamsize>(meta_request_result->error_response_body->len));
    ...
    ss << aws_error_str(meta_request_result->error_code) << " (" << aws_error_lib_name(meta_request_result->error_code) << ": "
...
Aws::Client::XmlOutcome S3CrtClient::GenerateXmlOutcome(const std::shared_ptr<HttpResponse>& response) const {
  ...
  if (httpOutcome.GetResult()->GetResponseBody().tellp() > 0) {
    ...
    return XmlOutcome(AmazonWebServiceResult<XmlDocument>(std::move(xmlDoc), httpOutcome.GetResult()->GetHeaders(),
...
Aws::Client::StreamOutcome S3CrtClient::GenerateStreamOutcome(const std::shared_ptr<Http::HttpResponse>& response) const {
  ...
  if (httpOutcome.IsSuccess()) {
    return StreamOutcome(AmazonWebServiceResult<Stream::ResponseStream>(httpOutcome.GetResult()->SwapResponseStreamOwnership(),
...
void S3CrtClient::InitCommonCrtRequestOption(CrtRequestCallbackUserData* userData, aws_s3_meta_request_options* options,
  ...
  userData->originalRequest = std::move(request);
...
static void CopyObjectRequestShutdownCallback(void* user_data) {
  ...
  userData->copyResponseHandler(userData->s3CrtClient, *(static_cast<const CopyObjectRequest*>(userData->originalRequest.get())),
...
void S3CrtClient::CopyObjectAsync(const CopyObjectRequest& request, const CopyObjectResponseReceivedHandler& handler,
  ...
  AWS_ASYNC_OPERATION_GUARD(CopyObject);
  ...
  if (!request.BucketHasBeenSet()) {
    ...
    return handler(this, request,
                   CopyObjectOutcome(Aws::Client::AWSError<S3CrtErrors>(S3CrtErrors::MISSING_PARAMETER, "MISSING_PARAMETER",
  ...
  if (!request.CopySourceHasBeenSet()) {
    ...
    return handler(this, request,
                   CopyObjectOutcome(Aws::Client::AWSError<S3CrtErrors>(S3CrtErrors::MISSING_PARAMETER, "MISSING_PARAMETER",
                                                                        "Missing required field [CopySource]", false)),
                   handlerContext);
  }
  ...
  if (!endpointResolutionOutcome.IsSuccess()) {
    handler(this, request,
            CopyObjectOutcome(Aws::Client::AWSError<CoreErrors>(CoreErrors::ENDPOINT_RESOLUTION_FAILURE, "ENDPOINT_RESOLUTION_FAILURE",
  ...
  auto requestCopy = Aws::MakeUnique<CopyObjectRequest>(ALLOCATION_TAG, request);
  InitCommonCrtRequestOption(userData, &options, std::move(requestCopy), endpointResolutionOutcome.GetResult().GetURI(), Aws::Http::HttpMethod::HTTP_PUT);
  ...
  const auto checksumHeader = std::find_if(headers.begin(), headers.end(), [](const Aws::Http::HeaderValuePair& header) -> bool {
  ...
  if (request.ChecksumAlgorithmHasBeenSet() && checksumHeader == headers.end()) {
    ...
    const auto mapping = std::find_if(std::begin(crtChecksumMapping), std::end(crtChecksumMapping),
                                      [&checksumAlgorithm](const std::pair<ChecksumAlgorithm, aws_s3_checksum_algorithm>& mapping) {
                                        return mapping.first == checksumAlgorithm;
                                      });
    if (mapping != std::end(crtChecksumMapping)) {
      ...
      AWS_LOGSTREAM_ERROR("CopyObject",
                          "Could not set CRT checksum for " << ChecksumAlgorithmMapper::GetNameForChecksumAlgorithm(checksumAlgorithm));
    }
  }
...
CopyObjectOutcome S3CrtClient::CopyObject(const CopyObjectRequest& request) const {
  ...
  return TracingUtils::MakeCallWithTiming<CopyObjectOutcome>(
      [&]() -> CopyObjectOutcome {
        ...
        auto handler = CopyObjectResponseReceivedHandler{[&](const S3CrtClient*, const CopyObjectRequest&, const CopyObjectOutcome& outcome,
...
static void GetObjectRequestShutdownCallback(void* user_data) {
  ...
  userData->getResponseHandler(userData->s3CrtClient, *(static_cast<const GetObjectRequest*>(userData->originalRequest.get())),
                               std::move(outcome), userData->asyncCallerContext);
...
void S3CrtClient::GetObjectAsync(const GetObjectRequest& request, const GetObjectResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& handlerContext) const {
  AWS_ASYNC_OPERATION_GUARD(GetObject);
  if (!m_endpointProvider) {
    return handler(this, request,
  ...
  if (!request.BucketHasBeenSet()) {
    ...
    return handler(this, request,
                   GetObjectOutcome(Aws::Client::AWSError<S3CrtErrors>(S3CrtErrors::MISSING_PARAMETER, "MISSING_PARAMETER",
                                                                       "Missing required field [Bucket]", false)),
                   handlerContext);
  }
  if (!request.KeyHasBeenSet()) {
  ...
  if (!endpointResolutionOutcome.IsSuccess()) {
    handler(this, request,
            GetObjectOutcome(Aws::Client::AWSError<CoreErrors>(CoreErrors::ENDPOINT_RESOLUTION_FAILURE, "ENDPOINT_RESOLUTION_FAILURE",
                                                               endpointResolutionOutcome.GetError().GetMessage(), false)),
            handlerContext);
    return;
  }
  ...
  auto requestCopy = Aws::MakeUnique<GetObjectRequest>(ALLOCATION_TAG, request);
  InitCommonCrtRequestOption(userData, &options, std::move(requestCopy), endpointResolutionOutcome.GetResult().GetURI(), Aws::Http::HttpMethod::HTTP_GET);
  if (userData != nullptr && userData->request != nullptr && userData->request->GetContentBody() != nullptr &&
      userData->request->GetContentBody()->fail()) {
    return handler(this, request,
                   GetObjectOutcome(Aws::Client::AWSError<S3CrtErrors>(S3CrtErrors::INVALID_PARAMETER_VALUE, "INVALID_PARAMETER_VALUE",
                                                                       "Output stream in bad state", false)),
                   handlerContext);
  }
  if (handlerContext) {
    handlerContext->GetMonitorContext().StartMonitorContext(Aws::String{"S3CrtClient"}, request.GetServiceRequestName(), userData->request);
...
GetObjectOutcome S3CrtClient::GetObject(const GetObjectRequest& request) const {
  ...
  return TracingUtils::MakeCallWithTiming<GetObjectOutcome>(
      [&]() -> GetObjectOutcome {
        ...
        auto handlerContext = Aws::MakeShared<AsyncCallerContext>(ALLOCATION_TAG);
        auto handler = GetObjectResponseReceivedHandler{[&](const S3CrtClient*, const GetObjectRequest&, GetObjectOutcome outcome,
                                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) {
          res = std::move(outcome);
          sem.ReleaseAll();
        }};
...
static void PutObjectRequestShutdownCallback(void* user_data) {
  ...
  userData->putResponseHandler(userData->s3CrtClient, *(static_cast<const PutObjectRequest*>(userData->originalRequest.get())),
                               std::move(outcome), userData->asyncCallerContext);
...
void S3CrtClient::PutObjectAsync(const PutObjectRequest& request, const PutObjectResponseReceivedHandler& handler,
  ...
  if (!request.BucketHasBeenSet()) {
    ...
    return handler(this, request,
                   PutObjectOutcome(Aws::Client::AWSError<S3CrtErrors>(S3CrtErrors::MISSING_PARAMETER, "MISSING_PARAMETER",
                                                                       "Missing required field [Bucket]", false)),
                   handlerContext);
  }
  if (!request.KeyHasBeenSet()) {
  ...
  if (!endpointResolutionOutcome.IsSuccess()) {
    handler(this, request,
            PutObjectOutcome(Aws::Client::AWSError<CoreErrors>(CoreErrors::ENDPOINT_RESOLUTION_FAILURE, "ENDPOINT_RESOLUTION_FAILURE",
                                                               endpointResolutionOutcome.GetError().GetMessage(), false)),
            handlerContext);
    return;
  }
  ...
  auto requestCopy = Aws::MakeUnique<PutObjectRequest>(ALLOCATION_TAG, request);
  InitCommonCrtRequestOption(userData, &options, std::move(requestCopy), endpointResolutionOutcome.GetResult().GetURI(), Aws::Http::HttpMethod::HTTP_PUT);
  if (userData != nullptr && userData->request != nullptr && userData->request->GetContentBody() != nullptr &&
      userData->request->GetContentBody()->fail()) {
    return handler(this, request,
                   PutObjectOutcome(Aws::Client::AWSError<S3CrtErrors>(S3CrtErrors::INVALID_PARAMETER_VALUE, "INVALID_PARAMETER_VALUE",
...
PutObjectOutcome S3CrtClient::PutObject(const PutObjectRequest& request) const {
  ...
  return TracingUtils::MakeCallWithTiming<PutObjectOutcome>(
      [&]() -> PutObjectOutcome {
        ...
        auto handlerContext = Aws::MakeShared<AsyncCallerContext>(ALLOCATION_TAG);
        auto handler = PutObjectResponseReceivedHandler{[&](const S3CrtClient*, const PutObjectRequest&, const PutObjectOutcome& outcome,
                                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) {
          res = std::move(outcome);
          sem.ReleaseAll();
        }};
...
AbortMultipartUploadOutcome S3CrtClient::AbortMultipartUpload(const AbortMultipartUploadRequest& request) const {
  ...
  if (!request.UploadIdHasBeenSet()) {
    ...
    return AbortMultipartUploadOutcome(Aws::Client::AWSError<S3CrtErrors>(S3CrtErrors::MISSING_PARAMETER, "MISSING_PARAMETER",
...
CompleteMultipartUploadOutcome S3CrtClient::CompleteMultipartUpload(const CompleteMultipartUploadRequest& request) const {
  ...
  if (!request.UploadIdHasBeenSet()) {
    ...
    return CompleteMultipartUploadOutcome(Aws::Client::AWSError<S3CrtErrors>(S3CrtErrors::MISSING_PARAMETER, "MISSING_PARAMETER",
                                                                             "Missing required field [UploadId]", false));
  }
...
DeleteBucketAnalyticsConfigurationOutcome S3CrtClient::DeleteBucketAnalyticsConfiguration(
  ...
  if (!request.IdHasBeenSet()) {
    ...
    return DeleteBucketAnalyticsConfigurationOutcome(
        Aws::Client::AWSError<S3CrtErrors>(S3CrtErrors::MISSING_PARAMETER, "MISSING_PARAMETER", "Missing required field [Id]", false));
  }
...
GetBucketMetadataConfigurationOutcome S3CrtClient::GetBucketMetadataConfiguration(
    const GetBucketMetadataConfigurationRequest& request) const {
  if (!request.BucketHasBeenSet()) {
...
GetObjectAttributesOutcome S3CrtClient::GetObjectAttributes(const GetObjectAttributesRequest& request) const {
  ...
  if (!request.ObjectAttributesHasBeenSet()) {
    ...
    return GetObjectAttributesOutcome(Aws::Client::AWSError<S3CrtErrors>(S3CrtErrors::MISSING_PARAMETER, "MISSING_PARAMETER",
...
ListPartsOutcome S3CrtClient::ListParts(const ListPartsRequest& request) const {
  ...
  if (!request.UploadIdHasBeenSet()) {
    ...
    return ListPartsOutcome(Aws::Client::AWSError<S3CrtErrors>(S3CrtErrors::MISSING_PARAMETER, "MISSING_PARAMETER",
                                                               "Missing required field [UploadId]", false));
  }
...
RenameObjectOutcome S3CrtClient::RenameObject(const RenameObjectRequest& request) const {
  ...
  if (!request.RenameSourceHasBeenSet()) {
    ...
    return RenameObjectOutcome(Aws::Client::AWSError<S3CrtErrors>(S3CrtErrors::MISSING_PARAMETER, "MISSING_PARAMETER",
...
UploadPartOutcome S3CrtClient::UploadPart(const UploadPartRequest& request) const {
  ...
  if (!request.PartNumberHasBeenSet()) {
    ...
    return UploadPartOutcome(Aws::Client::AWSError<S3CrtErrors>(S3CrtErrors::MISSING_PARAMETER, "MISSING_PARAMETER",
...
UploadPartCopyOutcome S3CrtClient::UploadPartCopy(const UploadPartCopyRequest& request) const {
  ...
  if (!request.CopySourceHasBeenSet()) {
    ...
    return UploadPartCopyOutcome(Aws::Client::AWSError<S3CrtErrors>(S3CrtErrors::MISSING_PARAMETER, "MISSING_PARAMETER",
                                                                    "Missing required field [CopySource]", false));
  }
  if (!request.KeyHasBeenSet()) {
...
WriteGetObjectResponseOutcome S3CrtClient::WriteGetObjectResponse(const WriteGetObjectResponseRequest& request) const {
  if (!request.RequestRouteHasBeenSet()) {
    ...
    return WriteGetObjectResponseOutcome(Aws::Client::AWSError<S3CrtErrors>(S3CrtErrors::MISSING_PARAMETER, "MISSING_PARAMETER",
                                                                            "Missing required field [RequestRoute]", false));
  }
  if (!request.RequestTokenHasBeenSet()) {
    AWS_LOGSTREAM_ERROR("WriteGetObjectResponse", "Required field: RequestToken, is not set");
    return WriteGetObjectResponseOutcome(Aws::Client::AWSError<S3CrtErrors>(S3CrtErrors::MISSING_PARAMETER, "MISSING_PARAMETER",
                                                                            "Missing required field [RequestToken]", false));
  }
...
Aws::String S3CrtClient::GeneratePresignedUrl(const Aws::String& bucket, const Aws::String& key, Aws::Http::HttpMethod method,
...
Aws::String S3CrtClient::GeneratePresignedUrlWithSSES3(const Aws::String& bucket, const Aws::String& key, Aws::Http::HttpMethod method,
                                                       uint64_t expirationInSeconds) {
...
Aws::String S3CrtClient::GeneratePresignedUrlWithSSEKMS(const Aws::String& bucket, const Aws::String& key, Aws::Http::HttpMethod method,
...
Aws::String S3CrtClient::GeneratePresignedUrlWithSSEC(const Aws::String& bucket, const Aws::String& key, Aws::Http::HttpMethod method,
  ...
  headers.emplace(Aws::S3Crt::SSEHeaders::SERVER_SIDE_ENCRYPTION_CUSTOMER_KEY_MD5,
...
Aws::String S3CrtClient::GeneratePresignedUrlWithSSEC(const Aws::String& bucket, const Aws::String& key, Aws::Http::HttpMethod method,
  ...
  Aws::Utils::ByteBuffer buffer = Aws::Utils::HashingUtils::Base64Decode(base64EncodedAES256Key);
  Aws::String strBuffer(reinterpret_cast<char*>(buffer.GetUnderlyingData()), buffer.GetLength());
  customizedHeaders.emplace(Aws::S3Crt::SSEHeaders::SERVER_SIDE_ENCRYPTION_CUSTOMER_KEY_MD5,
                            Aws::Utils::HashingUtils::Base64Encode(Aws::Utils::HashingUtils::CalculateMD5(strBuffer)));
  return GeneratePresignedUrl(bucket, key, method, customizedHeaders, expirationInSeconds);
}

bool S3CrtClient::MultipartUploadSupported() const { return true; }

void S3CrtClient::AddContentLengthToRequest(const std::shared_ptr<Aws::Http::HttpRequest>& httpRequest,
                                            const std::shared_ptr<Aws::IOStream>& body, bool isChunked) const {
