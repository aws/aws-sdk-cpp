...
S3ExpressIdentityProvider::S3ExpressIdentityProvider(const S3CrtClient& s3Client) : m_s3Client(s3Client){}
...
DefaultS3ExpressIdentityProvider::DefaultS3ExpressIdentityProvider(const S3CrtClient& s3Client)
...
DefaultAsyncS3ExpressIdentityProvider::DefaultAsyncS3ExpressIdentityProvider(
    const S3CrtClient& s3Client, std::chrono::minutes refreshPeriod)
...
DefaultAsyncS3ExpressIdentityProvider::DefaultAsyncS3ExpressIdentityProvider(
    const S3CrtClient& s3Client, std::shared_ptr<Aws::Utils::ConcurrentCache<Aws::String, S3ExpressIdentity>> credentialsCache,
