...
bool CopyObjectRequest::HasEmbeddedError(Aws::IOStream& body, const Aws::Http::HeaderValueCollection& header) const {
  // Header is unused
...
Aws::String CopyObjectRequest::SerializePayload() const { return {}; }
...
CopyObjectRequest::EndpointParameters CopyObjectRequest::GetEndpointContextParams() const {
  ...
  if (CopySourceHasBeenSet()) {
    parameters.emplace_back(Aws::String("CopySource"), this->GetCopySource(),
