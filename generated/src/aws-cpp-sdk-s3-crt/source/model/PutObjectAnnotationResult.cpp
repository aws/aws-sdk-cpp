...
PutObjectAnnotationResult::PutObjectAnnotationResult(const Aws::AmazonWebServiceResult<XmlDocument>& result) { *this = result; }

PutObjectAnnotationResult& PutObjectAnnotationResult::operator=(const Aws::AmazonWebServiceResult<XmlDocument>& result) {
