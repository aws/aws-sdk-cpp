...
bool PutBucketTaggingRequest::HasEmbeddedError(Aws::IOStream &body,
...
Aws::Crt::Optional<Aws::Client::Checksum::ChecksumInfo> PutBucketTaggingRequest::GetChecksumInfo() const
{
