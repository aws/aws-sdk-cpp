...
bool GetBucketEncryptionRequest::HasEmbeddedError(Aws::IOStream& body, const Aws::Http::HeaderValueCollection& header) const {
  // Header is unused
...
Aws::String GetBucketEncryptionRequest::SerializePayload() const { return {}; }
