...
bool DeleteBucketMetricsConfigurationRequest::HasEmbeddedError(Aws::IOStream& body, const Aws::Http::HeaderValueCollection& header) const {
  // Header is unused
...
Aws::String DeleteBucketMetricsConfigurationRequest::SerializePayload() const { return {}; }
