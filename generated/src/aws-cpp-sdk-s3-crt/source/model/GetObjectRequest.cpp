...
Aws::String GetObjectRequest::SerializePayload() const { return {}; }
...
bool GetObjectRequest::ShouldValidateResponseChecksum() const { return m_checksumMode == ChecksumMode::ENABLED; }
