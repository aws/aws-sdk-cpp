...
Aws::String CreateBucketMetadataConfigurationRequest::SerializePayload() const
{
  XmlDocument payloadDoc = XmlDocument::CreateWithRootNode("MetadataConfiguration");
...
void CreateBucketMetadataConfigurationRequest::AddQueryStringParameters(URI& uri) const
{
    Aws::StringStream ss;
...
Aws::Http::HeaderValueCollection CreateBucketMetadataConfigurationRequest::GetRequestSpecificHeaders() const
{
...
CreateBucketMetadataConfigurationRequest::EndpointParameters CreateBucketMetadataConfigurationRequest::GetEndpointContextParams() const
{
...
Aws::String CreateBucketMetadataConfigurationRequest::GetChecksumAlgorithmName() const
{
