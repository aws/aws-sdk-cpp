...
bool PutBucketVersioningRequest::HasEmbeddedError(Aws::IOStream &body,
...
Aws::Crt::Optional<Aws::Client::Checksum::ChecksumInfo> PutBucketVersioningRequest::GetChecksumInfo() const
{
