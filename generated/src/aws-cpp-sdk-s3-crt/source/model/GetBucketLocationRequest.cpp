...
bool GetBucketLocationRequest::HasEmbeddedError(Aws::IOStream& body, const Aws::Http::HeaderValueCollection& header) const {
  // Header is unused
...
Aws::String GetBucketLocationRequest::SerializePayload() const { return {}; }
