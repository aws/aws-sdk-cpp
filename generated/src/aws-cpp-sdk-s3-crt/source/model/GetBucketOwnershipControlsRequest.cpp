...
bool GetBucketOwnershipControlsRequest::HasEmbeddedError(Aws::IOStream& body, const Aws::Http::HeaderValueCollection& header) const {
  // Header is unused
...
Aws::String GetBucketOwnershipControlsRequest::SerializePayload() const { return {}; }
