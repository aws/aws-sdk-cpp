...
bool DeleteBucketWebsiteRequest::HasEmbeddedError(Aws::IOStream& body, const Aws::Http::HeaderValueCollection& header) const {
  // Header is unused
...
Aws::String DeleteBucketWebsiteRequest::SerializePayload() const { return {}; }
