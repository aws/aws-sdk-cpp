...
bool DeleteBucketPolicyRequest::HasEmbeddedError(Aws::IOStream& body, const Aws::Http::HeaderValueCollection& header) const {
  // Header is unused
...
Aws::String DeleteBucketPolicyRequest::SerializePayload() const { return {}; }
