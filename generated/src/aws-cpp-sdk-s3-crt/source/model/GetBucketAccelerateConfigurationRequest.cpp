...
bool GetBucketAccelerateConfigurationRequest::HasEmbeddedError(Aws::IOStream& body, const Aws::Http::HeaderValueCollection& header) const {
  // Header is unused
...
Aws::String GetBucketAccelerateConfigurationRequest::SerializePayload() const { return {}; }
