...
bool PutPublicAccessBlockRequest::HasEmbeddedError(Aws::IOStream &body,
...
Aws::Crt::Optional<Aws::Client::Checksum::ChecksumInfo> PutPublicAccessBlockRequest::GetChecksumInfo() const
{
