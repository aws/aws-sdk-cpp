...
bool RestoreObjectRequest::HasEmbeddedError(Aws::IOStream &body,
...
Aws::Crt::Optional<Aws::Client::Checksum::ChecksumInfo> RestoreObjectRequest::GetChecksumInfo() const
{
