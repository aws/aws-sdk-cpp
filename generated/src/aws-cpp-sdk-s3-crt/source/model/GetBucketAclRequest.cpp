...
bool GetBucketAclRequest::HasEmbeddedError(Aws::IOStream& body, const Aws::Http::HeaderValueCollection& header) const {
  // Header is unused
...
Aws::String GetBucketAclRequest::SerializePayload() const { return {}; }
