...
PublicAccessBlockConfiguration::PublicAccessBlockConfiguration(const XmlNode& xmlNode) { *this = xmlNode; }
...
PublicAccessBlockConfiguration& PublicAccessBlockConfiguration::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!blockPublicAclsNode.IsNull()) {
      m_blockPublicAcls = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(blockPublicAclsNode.GetText()).c_str()).c_str());
    ...
    if (!ignorePublicAclsNode.IsNull()) {
      m_ignorePublicAcls = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(ignorePublicAclsNode.GetText()).c_str()).c_str());
    ...
    if (!blockPublicPolicyNode.IsNull()) {
      m_blockPublicPolicy = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(blockPublicPolicyNode.GetText()).c_str()).c_str());
    ...
    if (!restrictPublicBucketsNode.IsNull()) {
      m_restrictPublicBuckets = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(restrictPublicBucketsNode.GetText()).c_str()).c_str());
