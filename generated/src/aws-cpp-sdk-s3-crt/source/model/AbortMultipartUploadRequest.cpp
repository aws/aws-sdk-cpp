...
bool AbortMultipartUploadRequest::HasEmbeddedError(Aws::IOStream& body, const Aws::Http::HeaderValueCollection& header) const {
  // Header is unused
...
Aws::String AbortMultipartUploadRequest::SerializePayload() const { return {}; }
