...
bool PutBucketRequestPaymentRequest::HasEmbeddedError(Aws::IOStream &body,
...
Aws::Crt::Optional<Aws::Client::Checksum::ChecksumInfo> PutBucketRequestPaymentRequest::GetChecksumInfo() const
{
