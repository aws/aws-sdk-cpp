...
namespace Model
{
  ...
  {
  public:
    AWS_CODESTARCONNECTIONS_API UpdateHostResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateHostResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
