...
namespace Model
{
  ...
  {
  public:
    AWS_CODESTARCONNECTIONS_API DeleteHostResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteHostResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
