...
namespace Model
{
  ...
  {
  public:
    AWS_CODESTARCONNECTIONS_API Tag() = default;
    AWS_CODESTARCONNECTIONS_API Tag(Aws::Utils::Json::JsonView jsonValue);
    AWS_CODESTARCONNECTIONS_API Tag& operator=(Aws::Utils::Json::JsonView jsonValue);
