...
namespace CodeStarconnections
{
   ...
   */
  class AWS_CODESTARCONNECTIONS_API CodeStarconnectionsClient : Aws::Client::ClientWithAsyncTemplateMethods<CodeStarconnectionsClient>,
    smithy::client::AwsSmithyClientT<Aws::CodeStarconnections::SERVICE_NAME,
