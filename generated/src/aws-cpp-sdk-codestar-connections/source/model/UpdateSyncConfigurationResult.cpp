...
UpdateSyncConfigurationResult::UpdateSyncConfigurationResult()
{
}

UpdateSyncConfigurationResult::UpdateSyncConfigurationResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
