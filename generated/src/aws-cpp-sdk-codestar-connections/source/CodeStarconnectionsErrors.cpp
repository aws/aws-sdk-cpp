...
AWSError<CoreErrors> GetErrorForName(const char* errorName) {
  ...
  if (hashCode == CONFLICT_HASH) {
    ...
    return AWSError<CoreErrors>(static_cast<CoreErrors>(CodeStarconnectionsErrors::SYNC_CONFIGURATION_STILL_EXISTS),
    ...
    return AWSError<CoreErrors>(static_cast<CoreErrors>(CodeStarconnectionsErrors::SYNC_BLOCKER_DOES_NOT_EXIST),
                                RetryableType::NOT_RETRYABLE);
    ...
    return AWSError<CoreErrors>(static_cast<CoreErrors>(CodeStarconnectionsErrors::RETRY_LATEST_COMMIT_FAILED),
                                RetryableType::NOT_RETRYABLE);
  }
