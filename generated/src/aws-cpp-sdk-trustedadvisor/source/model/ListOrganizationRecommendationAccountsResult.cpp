...
ListOrganizationRecommendationAccountsResult& ListOrganizationRecommendationAccountsResult::operator=(
  ...
  if (jsonValue.ValueExists("accountRecommendationLifecycleSummaries")) {
    ...
    for (unsigned accountRecommendationLifecycleSummariesIndex = 0;
         accountRecommendationLifecycleSummariesIndex < accountRecommendationLifecycleSummariesJsonList.GetLength();
         ++accountRecommendationLifecycleSummariesIndex) {
      m_accountRecommendationLifecycleSummaries.push_back(
