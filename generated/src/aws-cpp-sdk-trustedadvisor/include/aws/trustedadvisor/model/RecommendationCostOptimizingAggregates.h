...
class RecommendationCostOptimizingAggregates {
 public:
  ...
  inline RecommendationCostOptimizingAggregates& WithEstimatedMonthlySavings(double value) {
  ...
  inline void SetEstimatedPercentMonthlySavings(double value) {
    m_estimatedPercentMonthlySavingsHasBeenSet = true;
    m_estimatedPercentMonthlySavings = value;
  }
  inline RecommendationCostOptimizingAggregates& WithEstimatedPercentMonthlySavings(double value) {
    SetEstimatedPercentMonthlySavings(value);
    return *this;
  }
  ///@}
 private:
