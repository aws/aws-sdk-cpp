...
class UpdateRecommendationResourceExclusionError {
 public:
  ...
  template <typename ArnT = Aws::String>
  UpdateRecommendationResourceExclusionError& WithArn(ArnT&& value) {
  ...
  template <typename ErrorCodeT = Aws::String>
  UpdateRecommendationResourceExclusionError& WithErrorCode(ErrorCodeT&& value) {
  ...
  template <typename ErrorMessageT = Aws::String>
  UpdateRecommendationResourceExclusionError& WithErrorMessage(ErrorMessageT&& value) {
