...
class OrganizationRecommendation {
 public:
  ...
  inline OrganizationRecommendation& WithLifecycleStage(RecommendationLifecycleStage value) {
  ...
  inline OrganizationRecommendation& AddPillars(RecommendationPillar value) {
    m_pillarsHasBeenSet = true;
  ...
  inline OrganizationRecommendation& WithSource(RecommendationSource value) {
    SetSource(value);
    return *this;
  }
  ///@}
  ...
  inline OrganizationRecommendation& WithStatus(RecommendationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline OrganizationRecommendation& WithType(RecommendationType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline OrganizationRecommendation& WithUpdateReasonCode(UpdateRecommendationLifecycleStageReasonCode value) {
  ...
  void SetUpdatedOnBehalfOf(UpdatedOnBehalfOfT&& value) {
    ...
    m_updatedOnBehalfOf = std::forward<UpdatedOnBehalfOfT>(value);
  }
  template <typename UpdatedOnBehalfOfT = Aws::String>
  OrganizationRecommendation& WithUpdatedOnBehalfOf(UpdatedOnBehalfOfT&& value) {
    SetUpdatedOnBehalfOf(std::forward<UpdatedOnBehalfOfT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUpdatedOnBehalfOfJobTitle(UpdatedOnBehalfOfJobTitleT&& value) {
    ...
    m_updatedOnBehalfOfJobTitle = std::forward<UpdatedOnBehalfOfJobTitleT>(value);
  }
  template <typename UpdatedOnBehalfOfJobTitleT = Aws::String>
  OrganizationRecommendation& WithUpdatedOnBehalfOfJobTitle(UpdatedOnBehalfOfJobTitleT&& value) {
    SetUpdatedOnBehalfOfJobTitle(std::forward<UpdatedOnBehalfOfJobTitleT>(value));
    return *this;
  }
  ///@}
 private:
