...
class RecommendationSummary {
 public:
  ...
  inline RecommendationSummary& WithLifecycleStage(RecommendationLifecycleStage value) {
  ...
  inline RecommendationSummary& AddPillars(RecommendationPillar value) {
    m_pillarsHasBeenSet = true;
  ...
  inline RecommendationSummary& WithSource(RecommendationSource value) {
    SetSource(value);
    return *this;
  }
  ///@}
