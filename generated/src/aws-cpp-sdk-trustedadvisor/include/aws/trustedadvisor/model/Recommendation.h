...
class Recommendation {
 public:
  ...
  ///@{
  /**
   * <p>This attribute provides additional details about potential discrepancies in
   * check status determination.</p>
   */
  ...
  inline Recommendation& WithStatusReason(StatusReason value) {
