...
class ListOrganizationRecommendationResourcesRequest : public TrustedAdvisorRequest {
 public:
  ...
  inline ListOrganizationRecommendationResourcesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename RegionCodeT = Aws::String>
  ListOrganizationRecommendationResourcesRequest& WithRegionCode(RegionCodeT&& value) {
