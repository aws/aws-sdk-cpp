...
class UpdateRecommendationLifecycleRequest : public TrustedAdvisorRequest {
 public:
  ...
  inline UpdateRecommendationLifecycleRequest& WithLifecycleStage(UpdateRecommendationLifecycleStage value) {
  ...
  template <typename UpdateReasonT = Aws::String>
  UpdateRecommendationLifecycleRequest& WithUpdateReason(UpdateReasonT&& value) {
  ...
  inline UpdateRecommendationLifecycleRequest& WithUpdateReasonCode(UpdateRecommendationLifecycleStageReasonCode value) {
