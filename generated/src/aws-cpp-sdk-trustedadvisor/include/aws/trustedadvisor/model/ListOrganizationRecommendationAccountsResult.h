...
class ListOrganizationRecommendationAccountsResult {
 public:
   ...
   * Recommendation</p>
   */
  inline const Aws::Vector<AccountRecommendationLifecycleSummary>& GetAccountRecommendationLifecycleSummaries() const {
    return m_accountRecommendationLifecycleSummaries;
  }
  template <typename AccountRecommendationLifecycleSummariesT = Aws::Vector<AccountRecommendationLifecycleSummary>>
  void SetAccountRecommendationLifecycleSummaries(AccountRecommendationLifecycleSummariesT&& value) {
    m_accountRecommendationLifecycleSummariesHasBeenSet = true;
    m_accountRecommendationLifecycleSummaries = std::forward<AccountRecommendationLifecycleSummariesT>(value);
  }
  template <typename AccountRecommendationLifecycleSummariesT = Aws::Vector<AccountRecommendationLifecycleSummary>>
  ListOrganizationRecommendationAccountsResult& WithAccountRecommendationLifecycleSummaries(
      AccountRecommendationLifecycleSummariesT&& value) {
    SetAccountRecommendationLifecycleSummaries(std::forward<AccountRecommendationLifecycleSummariesT>(value));
    return *this;
  }
  template <typename AccountRecommendationLifecycleSummariesT = AccountRecommendationLifecycleSummary>
  ListOrganizationRecommendationAccountsResult& AddAccountRecommendationLifecycleSummaries(
      AccountRecommendationLifecycleSummariesT&& value) {
    m_accountRecommendationLifecycleSummariesHasBeenSet = true;
    m_accountRecommendationLifecycleSummaries.emplace_back(std::forward<AccountRecommendationLifecycleSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListOrganizationRecommendationAccountsResult& WithRequestId(RequestIdT&& value) {
