...
class ListOrganizationRecommendationAccountsRequest : public TrustedAdvisorRequest {
 public:
  ...
  inline ListOrganizationRecommendationAccountsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename OrganizationRecommendationIdentifierT = Aws::String>
  ListOrganizationRecommendationAccountsRequest& WithOrganizationRecommendationIdentifier(OrganizationRecommendationIdentifierT&& value) {
