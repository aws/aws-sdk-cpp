...
class OrganizationRecommendationSummary {
 public:
  ...
  inline void SetLifecycleStage(RecommendationLifecycleStage value) {
    m_lifecycleStageHasBeenSet = true;
    m_lifecycleStage = value;
  }
  inline OrganizationRecommendationSummary& WithLifecycleStage(RecommendationLifecycleStage value) {
  ...
  void SetPillarSpecificAggregates(PillarSpecificAggregatesT&& value) {
    ...
    m_pillarSpecificAggregates = std::forward<PillarSpecificAggregatesT>(value);
  }
  template <typename PillarSpecificAggregatesT = RecommendationPillarSpecificAggregates>
  OrganizationRecommendationSummary& WithPillarSpecificAggregates(PillarSpecificAggregatesT&& value) {
    SetPillarSpecificAggregates(std::forward<PillarSpecificAggregatesT>(value));
    return *this;
  }
  ///@}
  ...
  inline OrganizationRecommendationSummary& AddPillars(RecommendationPillar value) {
    m_pillarsHasBeenSet = true;
  ...
  void SetResourcesAggregates(ResourcesAggregatesT&& value) {
    ...
    m_resourcesAggregates = std::forward<ResourcesAggregatesT>(value);
  }
  template <typename ResourcesAggregatesT = RecommendationResourcesAggregates>
  OrganizationRecommendationSummary& WithResourcesAggregates(ResourcesAggregatesT&& value) {
    SetResourcesAggregates(std::forward<ResourcesAggregatesT>(value));
    return *this;
  }
  ///@}
  ...
  inline OrganizationRecommendationSummary& WithSource(RecommendationSource value) {
    SetSource(value);
    return *this;
  }
  ///@}
  ...
  inline OrganizationRecommendationSummary& WithStatus(RecommendationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline OrganizationRecommendationSummary& WithType(RecommendationType value) {
    SetType(value);
    return *this;
  }
  ///@}
