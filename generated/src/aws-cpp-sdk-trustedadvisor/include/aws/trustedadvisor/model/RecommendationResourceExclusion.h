...
class RecommendationResourceExclusion {
 public:
  ...
  template <typename ArnT = Aws::String>
  RecommendationResourceExclusion& WithArn(ArnT&& value) {
  ...
  inline void SetIsExcluded(bool value) {
    m_isExcludedHasBeenSet = true;
    m_isExcluded = value;
  }
  inline RecommendationResourceExclusion& WithIsExcluded(bool value) {
    SetIsExcluded(value);
    return *this;
  }
  ///@}
