...
public:
  ...
  TrustedAdvisorError(const Aws::Client::AWSError<TrustedAdvisorErrors>& rhs) : Aws::Client::AWSError<TrustedAdvisorErrors>(rhs) {}
  TrustedAdvisorError(Aws::Client::AWSError<TrustedAdvisorErrors>&& rhs) : Aws::Client::AWSError<TrustedAdvisorErrors>(rhs) {}
