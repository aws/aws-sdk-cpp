...
namespace TrustedAdvisor
{
   ...
   */
  class AWS_TRUSTEDADVISOR_API TrustedAdvisorClient : Aws::Client::ClientWithAsyncTemplateMethods<TrustedAdvisorClient>,
    smithy::client::AwsSmithyClientT<Aws::TrustedAdvisor::SERVICE_NAME,
