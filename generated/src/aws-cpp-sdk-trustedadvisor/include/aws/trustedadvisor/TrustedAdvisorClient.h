...
class AWS_TRUSTEDADVISOR_API TrustedAdvisorClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  TrustedAdvisorClient(const Aws::TrustedAdvisor::TrustedAdvisorClientConfiguration& clientConfiguration =
  ...
  TrustedAdvisorClient(const Aws::Auth::AWSCredentials& credentials,
                       std::shared_ptr<TrustedAdvisorEndpointProviderBase> endpointProvider = nullptr,
                       const Aws::TrustedAdvisor::TrustedAdvisorClientConfiguration& clientConfiguration =
                           Aws::TrustedAdvisor::TrustedAdvisorClientConfiguration());
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchUpdateRecommendationResourceExclusionOutcome BatchUpdateRecommendationResourceExclusion(
      const Model::BatchUpdateRecommendationResourceExclusionRequest& request) const;

  /**
   * A Callable wrapper for BatchUpdateRecommendationResourceExclusion that returns a future to the operation so that it can be executed in
  ...
  Model::BatchUpdateRecommendationResourceExclusionOutcomeCallable BatchUpdateRecommendationResourceExclusionCallable(
      const BatchUpdateRecommendationResourceExclusionRequestT& request) const {
    return SubmitCallable(&TrustedAdvisorClient::BatchUpdateRecommendationResourceExclusion, request);
  }

  /**
   * An Async wrapper for BatchUpdateRecommendationResourceExclusion that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename BatchUpdateRecommendationResourceExclusionRequestT = Model::BatchUpdateRecommendationResourceExclusionRequest>
  void BatchUpdateRecommendationResourceExclusionAsync(
      const BatchUpdateRecommendationResourceExclusionRequestT& request,
      const BatchUpdateRecommendationResourceExclusionResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetOrganizationRecommendationOutcome GetOrganizationRecommendation(
      const Model::GetOrganizationRecommendationRequest& request) const;

  /**
   * A Callable wrapper for GetOrganizationRecommendation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetOrganizationRecommendationRequestT = Model::GetOrganizationRecommendationRequest>
  Model::GetOrganizationRecommendationOutcomeCallable GetOrganizationRecommendationCallable(
      const GetOrganizationRecommendationRequestT& request) const {
    return SubmitCallable(&TrustedAdvisorClient::GetOrganizationRecommendation, request);
  }

  /**
   * An Async wrapper for GetOrganizationRecommendation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetOrganizationRecommendationRequestT = Model::GetOrganizationRecommendationRequest>
  void GetOrganizationRecommendationAsync(const GetOrganizationRecommendationRequestT& request,
                                          const GetOrganizationRecommendationResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListChecks that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListChecksRequestT = Model::ListChecksRequest>
  void ListChecksAsync(const ListChecksResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                       const ListChecksRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListOrganizationRecommendationAccountsOutcome ListOrganizationRecommendationAccounts(
      const Model::ListOrganizationRecommendationAccountsRequest& request) const;

  /**
   * A Callable wrapper for ListOrganizationRecommendationAccounts that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListOrganizationRecommendationAccountsRequestT = Model::ListOrganizationRecommendationAccountsRequest>
  Model::ListOrganizationRecommendationAccountsOutcomeCallable ListOrganizationRecommendationAccountsCallable(
      const ListOrganizationRecommendationAccountsRequestT& request) const {
    return SubmitCallable(&TrustedAdvisorClient::ListOrganizationRecommendationAccounts, request);
  }

  /**
   * An Async wrapper for ListOrganizationRecommendationAccounts that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListOrganizationRecommendationAccountsRequestT = Model::ListOrganizationRecommendationAccountsRequest>
  void ListOrganizationRecommendationAccountsAsync(const ListOrganizationRecommendationAccountsRequestT& request,
                                                   const ListOrganizationRecommendationAccountsResponseReceivedHandler& handler,
                                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListOrganizationRecommendationResourcesOutcome ListOrganizationRecommendationResources(
      const Model::ListOrganizationRecommendationResourcesRequest& request) const;

  /**
   * A Callable wrapper for ListOrganizationRecommendationResources that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListOrganizationRecommendationResourcesRequestT = Model::ListOrganizationRecommendationResourcesRequest>
  Model::ListOrganizationRecommendationResourcesOutcomeCallable ListOrganizationRecommendationResourcesCallable(
      const ListOrganizationRecommendationResourcesRequestT& request) const {
    return SubmitCallable(&TrustedAdvisorClient::ListOrganizationRecommendationResources, request);
  }

  /**
   * An Async wrapper for ListOrganizationRecommendationResources that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListOrganizationRecommendationResourcesRequestT = Model::ListOrganizationRecommendationResourcesRequest>
  void ListOrganizationRecommendationResourcesAsync(const ListOrganizationRecommendationResourcesRequestT& request,
                                                    const ListOrganizationRecommendationResourcesResponseReceivedHandler& handler,
                                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListOrganizationRecommendationsOutcome ListOrganizationRecommendations(
      const Model::ListOrganizationRecommendationsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListOrganizationRecommendations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListOrganizationRecommendationsRequestT = Model::ListOrganizationRecommendationsRequest>
  Model::ListOrganizationRecommendationsOutcomeCallable ListOrganizationRecommendationsCallable(
      const ListOrganizationRecommendationsRequestT& request = {}) const {
    return SubmitCallable(&TrustedAdvisorClient::ListOrganizationRecommendations, request);
  }

  /**
   * An Async wrapper for ListOrganizationRecommendations that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListOrganizationRecommendationsRequestT = Model::ListOrganizationRecommendationsRequest>
  void ListOrganizationRecommendationsAsync(const ListOrganizationRecommendationsResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                            const ListOrganizationRecommendationsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListRecommendationResourcesOutcome ListRecommendationResources(
      const Model::ListRecommendationResourcesRequest& request) const;

  /**
   * A Callable wrapper for ListRecommendationResources that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListRecommendationResourcesRequestT = Model::ListRecommendationResourcesRequest>
  Model::ListRecommendationResourcesOutcomeCallable ListRecommendationResourcesCallable(
      const ListRecommendationResourcesRequestT& request) const {
    return SubmitCallable(&TrustedAdvisorClient::ListRecommendationResources, request);
  }

  /**
   * An Async wrapper for ListRecommendationResources that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListRecommendationResourcesRequestT = Model::ListRecommendationResourcesRequest>
  void ListRecommendationResourcesAsync(const ListRecommendationResourcesRequestT& request,
                                        const ListRecommendationResourcesResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateOrganizationRecommendationLifecycleOutcome UpdateOrganizationRecommendationLifecycle(
      const Model::UpdateOrganizationRecommendationLifecycleRequest& request) const;

  /**
   * A Callable wrapper for UpdateOrganizationRecommendationLifecycle that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  ...
  Model::UpdateOrganizationRecommendationLifecycleOutcomeCallable UpdateOrganizationRecommendationLifecycleCallable(
      const UpdateOrganizationRecommendationLifecycleRequestT& request) const {
    return SubmitCallable(&TrustedAdvisorClient::UpdateOrganizationRecommendationLifecycle, request);
  }

  /**
   * An Async wrapper for UpdateOrganizationRecommendationLifecycle that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename UpdateOrganizationRecommendationLifecycleRequestT = Model::UpdateOrganizationRecommendationLifecycleRequest>
  void UpdateOrganizationRecommendationLifecycleAsync(
      const UpdateOrganizationRecommendationLifecycleRequestT& request,
      const UpdateOrganizationRecommendationLifecycleResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateRecommendationLifecycleOutcome UpdateRecommendationLifecycle(
      const Model::UpdateRecommendationLifecycleRequest& request) const;

  /**
   * A Callable wrapper for UpdateRecommendationLifecycle that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateRecommendationLifecycleRequestT = Model::UpdateRecommendationLifecycleRequest>
  Model::UpdateRecommendationLifecycleOutcomeCallable UpdateRecommendationLifecycleCallable(
      const UpdateRecommendationLifecycleRequestT& request) const {
    return SubmitCallable(&TrustedAdvisorClient::UpdateRecommendationLifecycle, request);
  }

  /**
   * An Async wrapper for UpdateRecommendationLifecycle that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateRecommendationLifecycleRequestT = Model::UpdateRecommendationLifecycleRequest>
  void UpdateRecommendationLifecycleAsync(const UpdateRecommendationLifecycleRequestT& request,
                                          const UpdateRecommendationLifecycleResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
