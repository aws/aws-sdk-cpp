...
typedef Aws::Utils::Outcome<BatchUpdateRecommendationResourceExclusionResult, TrustedAdvisorError>
...
typedef Aws::Utils::Outcome<ListOrganizationRecommendationAccountsResult, TrustedAdvisorError>
    ListOrganizationRecommendationAccountsOutcome;
typedef Aws::Utils::Outcome<ListOrganizationRecommendationResourcesResult, TrustedAdvisorError>
...
typedef std::function<void(const TrustedAdvisorClient*, const Model::BatchUpdateRecommendationResourceExclusionRequest&,
                           const Model::BatchUpdateRecommendationResourceExclusionOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    BatchUpdateRecommendationResourceExclusionResponseReceivedHandler;
typedef std::function<void(const TrustedAdvisorClient*, const Model::GetOrganizationRecommendationRequest&,
                           const Model::GetOrganizationRecommendationOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetOrganizationRecommendationResponseReceivedHandler;
typedef std::function<void(const TrustedAdvisorClient*, const Model::GetRecommendationRequest&, const Model::GetRecommendationOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetRecommendationResponseReceivedHandler;
typedef std::function<void(const TrustedAdvisorClient*, const Model::ListChecksRequest&, const Model::ListChecksOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListChecksResponseReceivedHandler;
typedef std::function<void(const TrustedAdvisorClient*, const Model::ListOrganizationRecommendationAccountsRequest&,
                           const Model::ListOrganizationRecommendationAccountsOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListOrganizationRecommendationAccountsResponseReceivedHandler;
typedef std::function<void(const TrustedAdvisorClient*, const Model::ListOrganizationRecommendationResourcesRequest&,
                           const Model::ListOrganizationRecommendationResourcesOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListOrganizationRecommendationResourcesResponseReceivedHandler;
typedef std::function<void(const TrustedAdvisorClient*, const Model::ListOrganizationRecommendationsRequest&,
                           const Model::ListOrganizationRecommendationsOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListOrganizationRecommendationsResponseReceivedHandler;
typedef std::function<void(const TrustedAdvisorClient*, const Model::ListRecommendationResourcesRequest&,
                           const Model::ListRecommendationResourcesOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
...
typedef std::function<void(const TrustedAdvisorClient*, const Model::UpdateRecommendationLifecycleRequest&,
                           const Model::UpdateRecommendationLifecycleOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
