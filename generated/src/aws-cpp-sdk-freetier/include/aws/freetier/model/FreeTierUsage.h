...
class FreeTierUsage {
 public:
  ...
  inline void SetActualUsageAmount(double value) {
    m_actualUsageAmountHasBeenSet = true;
    m_actualUsageAmount = value;
  }
  inline FreeTierUsage& WithActualUsageAmount(double value) {
    SetActualUsageAmount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetForecastedUsageAmount(double value) {
    m_forecastedUsageAmountHasBeenSet = true;
    m_forecastedUsageAmount = value;
  }
  inline FreeTierUsage& WithForecastedUsageAmount(double value) {
    SetForecastedUsageAmount(value);
    return *this;
  }
  ///@}
  ...
  inline FreeTierUsage& WithLimit(double value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  void SetFreeTierType(FreeTierTypeT&& value) {
    ...
    m_freeTierType = std::forward<FreeTierTypeT>(value);
  }
  template <typename FreeTierTypeT = Aws::String>
  FreeTierUsage& WithFreeTierType(FreeTierTypeT&& value) {
    SetFreeTierType(std::forward<FreeTierTypeT>(value));
    return *this;
  }
  ///@}
 private:
