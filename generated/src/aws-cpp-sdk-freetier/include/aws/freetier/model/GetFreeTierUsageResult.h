...
class GetFreeTierUsageResult {
 public:
  ...
  void SetFreeTierUsages(FreeTierUsagesT&& value) {
    m_freeTierUsagesHasBeenSet = true;
    m_freeTierUsages = std::forward<FreeTierUsagesT>(value);
  }
  template <typename FreeTierUsagesT = Aws::Vector<FreeTierUsage>>
  GetFreeTierUsageResult& WithFreeTierUsages(FreeTierUsagesT&& value) {
    SetFreeTierUsages(std::forward<FreeTierUsagesT>(value));
    return *this;
  }
  template <typename FreeTierUsagesT = FreeTierUsage>
  GetFreeTierUsageResult& AddFreeTierUsages(FreeTierUsagesT&& value) {
    m_freeTierUsagesHasBeenSet = true;
    m_freeTierUsages.emplace_back(std::forward<FreeTierUsagesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetFreeTierUsageResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetFreeTierUsageResult& WithRequestId(RequestIdT&& value) {
