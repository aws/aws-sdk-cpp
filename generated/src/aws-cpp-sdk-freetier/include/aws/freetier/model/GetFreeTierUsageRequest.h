...
class GetFreeTierUsageRequest : public FreeTierRequest {
 public:
  ...
  template <typename FilterT = Expression>
  GetFreeTierUsageRequest& WithFilter(FilterT&& value) {
  ...
  inline GetFreeTierUsageRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetFreeTierUsageRequest& WithNextToken(NextTokenT&& value) {
