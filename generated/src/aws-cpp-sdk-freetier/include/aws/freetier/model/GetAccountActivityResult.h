...
class GetAccountActivityResult {
 public:
  ...
  inline void SetStatus(ActivityStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline GetAccountActivityResult& WithStatus(ActivityStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetInstructionsUrl(InstructionsUrlT&& value) {
    ...
    m_instructionsUrl = std::forward<InstructionsUrlT>(value);
  }
  template <typename InstructionsUrlT = Aws::String>
  GetAccountActivityResult& WithInstructionsUrl(InstructionsUrlT&& value) {
    SetInstructionsUrl(std::forward<InstructionsUrlT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetEstimatedTimeToCompleteInMinutes(int value) {
    m_estimatedTimeToCompleteInMinutesHasBeenSet = true;
    m_estimatedTimeToCompleteInMinutes = value;
  }
  inline GetAccountActivityResult& WithEstimatedTimeToCompleteInMinutes(int value) {
    SetEstimatedTimeToCompleteInMinutes(value);
    return *this;
  }
  ///@}
