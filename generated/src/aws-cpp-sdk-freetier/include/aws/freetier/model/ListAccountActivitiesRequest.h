...
class ListAccountActivitiesRequest : public FreeTierRequest {
 public:
  ...
  void SetFilterActivityStatuses(FilterActivityStatusesT&& value) {
    m_filterActivityStatusesHasBeenSet = true;
    m_filterActivityStatuses = std::forward<FilterActivityStatusesT>(value);
  }
  template <typename FilterActivityStatusesT = Aws::Vector<ActivityStatus>>
  ListAccountActivitiesRequest& WithFilterActivityStatuses(FilterActivityStatusesT&& value) {
    SetFilterActivityStatuses(std::forward<FilterActivityStatusesT>(value));
    return *this;
  }
  inline ListAccountActivitiesRequest& AddFilterActivityStatuses(ActivityStatus value) {
    m_filterActivityStatusesHasBeenSet = true;
    m_filterActivityStatuses.push_back(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAccountActivitiesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListAccountActivitiesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline ListAccountActivitiesRequest& WithLanguageCode(LanguageCode value) {
