...
{
const size_t ManagedBlockchainEndpointRules::RulesBlobStrLen = 3768;
const size_t ManagedBlockchainEndpointRules::RulesBlobSize = 3769;
...
'h','a','i','n','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i',
...
'n','a','g','e','d','b','l','o','c','k','c','h','a','i','n','.','{','R','e','g','i','o','n','}','.',
