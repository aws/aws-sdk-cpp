...
class AWS_MANAGEDBLOCKCHAIN_API ManagedBlockchainClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  ManagedBlockchainClient(const Aws::ManagedBlockchain::ManagedBlockchainClientConfiguration& clientConfiguration =
  ...
  ManagedBlockchainClient(const Aws::Auth::AWSCredentials& credentials,
                          std::shared_ptr<ManagedBlockchainEndpointProviderBase> endpointProvider = nullptr,
                          const Aws::ManagedBlockchain::ManagedBlockchainClientConfiguration& clientConfiguration =
                              Aws::ManagedBlockchain::ManagedBlockchainClientConfiguration());
  ...
  /**
   * An Async wrapper for CreateAccessor that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateAccessorRequestT = Model::CreateAccessorRequest>
  void CreateAccessorAsync(const CreateAccessorRequestT& request, const CreateAccessorResponseReceivedHandler& handler,
  ...
  /**
   * An Async wrapper for CreateProposal that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateProposalRequestT = Model::CreateProposalRequest>
  void CreateProposalAsync(const CreateProposalRequestT& request, const CreateProposalResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteAccessor that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteAccessorRequestT = Model::DeleteAccessorRequest>
  void DeleteAccessorAsync(const DeleteAccessorRequestT& request, const DeleteAccessorResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetAccessor that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetAccessorRequestT = Model::GetAccessorRequest>
  void GetAccessorAsync(const GetAccessorRequestT& request, const GetAccessorResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetNode that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetNodeRequestT = Model::GetNodeRequest>
  void GetNodeAsync(const GetNodeRequestT& request, const GetNodeResponseReceivedHandler& handler,
                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetProposal that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetProposalRequestT = Model::GetProposalRequest>
  void GetProposalAsync(const GetProposalRequestT& request, const GetProposalResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListAccessors that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListAccessorsRequestT = Model::ListAccessorsRequest>
  void ListAccessorsAsync(const ListAccessorsResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                          const ListAccessorsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListProposalVotes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListProposalVotes that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListProposalVotesRequestT = Model::ListProposalVotesRequest>
  void ListProposalVotesAsync(const ListProposalVotesRequestT& request, const ListProposalVotesResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListProposals that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListProposalsRequestT = Model::ListProposalsRequest>
  void ListProposalsAsync(const ListProposalsRequestT& request, const ListProposalsResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateMember that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateMemberRequestT = Model::UpdateMemberRequest>
  void UpdateMemberAsync(const UpdateMemberRequestT& request, const UpdateMemberResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for VoteOnProposal that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename VoteOnProposalRequestT = Model::VoteOnProposalRequest>
  void VoteOnProposalAsync(const VoteOnProposalRequestT& request, const VoteOnProposalResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
