...
class ApprovalThresholdPolicy {
 public:
  ...
  inline void SetThresholdPercentage(int value) {
    m_thresholdPercentageHasBeenSet = true;
    m_thresholdPercentage = value;
  }
  inline ApprovalThresholdPolicy& WithThresholdPercentage(int value) {
  ...
  inline void SetProposalDurationInHours(int value) {
    m_proposalDurationInHoursHasBeenSet = true;
    m_proposalDurationInHours = value;
  }
  inline ApprovalThresholdPolicy& WithProposalDurationInHours(int value) {
    SetProposalDurationInHours(value);
    return *this;
  }
  ///@}
  ...
  inline void SetThresholdComparator(ThresholdComparator value) {
    m_thresholdComparatorHasBeenSet = true;
    m_thresholdComparator = value;
  }
  inline ApprovalThresholdPolicy& WithThresholdComparator(ThresholdComparator value) {
