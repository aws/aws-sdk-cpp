...
class Invitation {
 public:
  ...
  inline Invitation& WithStatus(InvitationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetNetworkSummary(NetworkSummaryT&& value) {
    ...
    m_networkSummary = std::forward<NetworkSummaryT>(value);
  }
  template <typename NetworkSummaryT = NetworkSummary>
  Invitation& WithNetworkSummary(NetworkSummaryT&& value) {
    SetNetworkSummary(std::forward<NetworkSummaryT>(value));
    return *this;
  }
  ///@}
