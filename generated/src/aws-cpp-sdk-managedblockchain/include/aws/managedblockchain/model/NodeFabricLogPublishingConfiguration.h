...
class NodeFabricLogPublishingConfiguration {
 public:
  ...
  void SetChaincodeLogs(ChaincodeLogsT&& value) {
    ...
    m_chaincodeLogs = std::forward<ChaincodeLogsT>(value);
  }
  template <typename ChaincodeLogsT = LogConfigurations>
  NodeFabricLogPublishingConfiguration& WithChaincodeLogs(ChaincodeLogsT&& value) {
    SetChaincodeLogs(std::forward<ChaincodeLogsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPeerLogs(PeerLogsT&& value) {
    ...
    m_peerLogs = std::forward<PeerLogsT>(value);
  }
  template <typename PeerLogsT = LogConfigurations>
  NodeFabricLogPublishingConfiguration& WithPeerLogs(PeerLogsT&& value) {
    SetPeerLogs(std::forward<PeerLogsT>(value));
    return *this;
  }
  ///@}
 private:
