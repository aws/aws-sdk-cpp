...
class NetworkFabricAttributes {
 public:
  ...
  void SetOrderingServiceEndpoint(OrderingServiceEndpointT&& value) {
    ...
    m_orderingServiceEndpoint = std::forward<OrderingServiceEndpointT>(value);
  }
  template <typename OrderingServiceEndpointT = Aws::String>
  NetworkFabricAttributes& WithOrderingServiceEndpoint(OrderingServiceEndpointT&& value) {
    SetOrderingServiceEndpoint(std::forward<OrderingServiceEndpointT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetEdition(Edition value) {
    m_editionHasBeenSet = true;
    m_edition = value;
  }
  inline NetworkFabricAttributes& WithEdition(Edition value) {
    SetEdition(value);
    return *this;
  }
  ///@}
