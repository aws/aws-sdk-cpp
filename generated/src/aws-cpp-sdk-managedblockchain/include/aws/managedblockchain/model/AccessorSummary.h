...
class AccessorSummary {
 public:
  ...
  inline AccessorSummary& WithType(AccessorType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline AccessorSummary& WithStatus(AccessorStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline AccessorSummary& WithNetworkType(AccessorNetworkType value) {
