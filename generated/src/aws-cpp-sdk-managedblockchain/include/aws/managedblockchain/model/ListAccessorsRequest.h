...
class ListAccessorsRequest : public ManagedBlockchainRequest {
 public:
  ...
  inline ListAccessorsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAccessorsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListAccessorsRequest& WithNetworkType(AccessorNetworkType value) {
