...
class ListProposalVotesRequest : public ManagedBlockchainRequest {
 public:
  ...
  template <typename NetworkIdT = Aws::String>
  ListProposalVotesRequest& WithNetworkId(NetworkIdT&& value) {
  ...
  template <typename ProposalIdT = Aws::String>
  ListProposalVotesRequest& WithProposalId(ProposalIdT&& value) {
  ...
  inline ListProposalVotesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListProposalVotesRequest& WithNextToken(NextTokenT&& value) {
