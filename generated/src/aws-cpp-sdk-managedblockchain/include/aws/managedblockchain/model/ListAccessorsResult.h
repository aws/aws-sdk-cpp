...
class ListAccessorsResult {
 public:
  ...
  void SetAccessors(AccessorsT&& value) {
    m_accessorsHasBeenSet = true;
    m_accessors = std::forward<AccessorsT>(value);
  }
  template <typename AccessorsT = Aws::Vector<AccessorSummary>>
  ListAccessorsResult& WithAccessors(AccessorsT&& value) {
    SetAccessors(std::forward<AccessorsT>(value));
    return *this;
  }
  template <typename AccessorsT = AccessorSummary>
  ListAccessorsResult& AddAccessors(AccessorsT&& value) {
    m_accessorsHasBeenSet = true;
    m_accessors.emplace_back(std::forward<AccessorsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAccessorsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAccessorsResult& WithRequestId(RequestIdT&& value) {
