...
class ListProposalsRequest : public ManagedBlockchainRequest {
 public:
  ...
  template <typename NetworkIdT = Aws::String>
  ListProposalsRequest& WithNetworkId(NetworkIdT&& value) {
  ...
  inline ListProposalsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListProposalsRequest& WithNextToken(NextTokenT&& value) {
