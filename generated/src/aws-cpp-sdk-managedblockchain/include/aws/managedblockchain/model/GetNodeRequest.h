...
namespace Model
{
  ...
  public:
    ...
    template<typename NetworkIdT = Aws::String>
    GetNodeRequest& WithNetworkId(NetworkIdT&& value) { SetNetworkId(std::forward<NetworkIdT>(value)); return *this;}
    ///@}
    ...
    template<typename MemberIdT = Aws::String>
    GetNodeRequest& WithMemberId(MemberIdT&& value) { SetMemberId(std::forward<MemberIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NodeIdT = Aws::String>
    GetNodeRequest& WithNodeId(NodeIdT&& value) { SetNodeId(std::forward<NodeIdT>(value)); return *this;}
    ///@}
  private:
