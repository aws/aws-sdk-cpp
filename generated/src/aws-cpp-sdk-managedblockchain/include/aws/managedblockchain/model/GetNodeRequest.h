...
class GetNodeRequest : public ManagedBlockchainRequest {
 public:
  AWS_MANAGEDBLOCKCHAIN_API GetNodeRequest() = default;
  ...
  template <typename NetworkIdT = Aws::String>
  GetNodeRequest& WithNetworkId(NetworkIdT&& value) {
  ...
  template <typename MemberIdT = Aws::String>
  GetNodeRequest& WithMemberId(MemberIdT&& value) {
  ...
  template <typename NodeIdT = Aws::String>
  GetNodeRequest& WithNodeId(NodeIdT&& value) {
