...
namespace Model
{
  ...
  {
  public:
    AWS_MANAGEDBLOCKCHAIN_API DeleteAccessorResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteAccessorResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
