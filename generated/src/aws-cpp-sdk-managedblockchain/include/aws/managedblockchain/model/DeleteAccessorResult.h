...
namespace Model
{
  ...
  public:
    ...
    inline DeleteAccessorResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeleteAccessorResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeleteAccessorResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
