...
class CreateMemberRequest : public ManagedBlockchainRequest {
 public:
  ...
  void SetMemberConfiguration(MemberConfigurationT&& value) {
    m_memberConfigurationHasBeenSet = true;
    m_memberConfiguration = std::forward<MemberConfigurationT>(value);
  }
  template <typename MemberConfigurationT = MemberConfiguration>
  CreateMemberRequest& WithMemberConfiguration(MemberConfigurationT&& value) {
    SetMemberConfiguration(std::forward<MemberConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
