...
namespace Model
{
  ...
  {
  public:
    AWS_MANAGEDBLOCKCHAIN_API VoteOnProposalResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    VoteOnProposalResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
