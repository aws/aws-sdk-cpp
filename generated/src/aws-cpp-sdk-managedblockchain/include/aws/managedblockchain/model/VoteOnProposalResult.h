...
namespace Model
{
  ...
  public:
    ...
    inline VoteOnProposalResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline VoteOnProposalResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline VoteOnProposalResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
