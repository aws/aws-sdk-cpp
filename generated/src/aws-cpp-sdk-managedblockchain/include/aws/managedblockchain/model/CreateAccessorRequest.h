...
class CreateAccessorRequest : public ManagedBlockchainRequest {
 public:
  ...
  inline void SetAccessorType(AccessorType value) {
    m_accessorTypeHasBeenSet = true;
    m_accessorType = value;
  }
  inline CreateAccessorRequest& WithAccessorType(AccessorType value) {
  ...
  inline CreateAccessorRequest& WithNetworkType(AccessorNetworkType value) {
