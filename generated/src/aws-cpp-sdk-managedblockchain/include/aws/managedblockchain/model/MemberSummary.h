...
class MemberSummary {
 public:
  ...
  template <typename IdT = Aws::String>
  MemberSummary& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  MemberSummary& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  MemberSummary& WithDescription(DescriptionT&& value) {
  ...
  template <typename CreationDateT = Aws::Utils::DateTime>
  MemberSummary& WithCreationDate(CreationDateT&& value) {
  ...
  inline MemberSummary& WithIsOwned(bool value) {
    SetIsOwned(value);
    return *this;
  }
  ///@}
  ...
  template <typename ArnT = Aws::String>
  MemberSummary& WithArn(ArnT&& value) {
