...
class ListNetworksRequest : public ManagedBlockchainRequest {
 public:
  ...
  inline void SetFramework(Framework value) {
    m_frameworkHasBeenSet = true;
    m_framework = value;
  }
  inline ListNetworksRequest& WithFramework(Framework value) {
    SetFramework(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(NetworkStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ListNetworksRequest& WithStatus(NetworkStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
