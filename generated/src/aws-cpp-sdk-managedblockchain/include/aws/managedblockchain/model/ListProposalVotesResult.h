...
class ListProposalVotesResult {
 public:
  ...
  void SetProposalVotes(ProposalVotesT&& value) {
    m_proposalVotesHasBeenSet = true;
    m_proposalVotes = std::forward<ProposalVotesT>(value);
  }
  template <typename ProposalVotesT = Aws::Vector<VoteSummary>>
  ListProposalVotesResult& WithProposalVotes(ProposalVotesT&& value) {
    SetProposalVotes(std::forward<ProposalVotesT>(value));
    return *this;
  }
  template <typename ProposalVotesT = VoteSummary>
  ListProposalVotesResult& AddProposalVotes(ProposalVotesT&& value) {
    m_proposalVotesHasBeenSet = true;
    m_proposalVotes.emplace_back(std::forward<ProposalVotesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListProposalVotesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListProposalVotesResult& WithRequestId(RequestIdT&& value) {
