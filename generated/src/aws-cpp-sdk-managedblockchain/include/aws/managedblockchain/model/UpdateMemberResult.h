...
namespace Model
{
  ...
  {
  public:
    AWS_MANAGEDBLOCKCHAIN_API UpdateMemberResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateMemberResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
