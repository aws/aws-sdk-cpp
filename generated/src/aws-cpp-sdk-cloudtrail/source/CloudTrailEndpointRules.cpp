...
{
const size_t CloudTrailEndpointRules::RulesBlobStrLen = 4132;
const size_t CloudTrailEndpointRules::RulesBlobSize = 4133;
...
'"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','c','l','o','u','d','t','r',
'a','i','l','.','u','s','-','g','o','v','-','e','a','s','t','-','1','.','a','m','a','z','o','n','a',
...
'l','"',':','"','h','t','t','p','s',':','/','/','c','l','o','u','d','t','r','a','i','l','.','{','R',
...
'r','a','i','l','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R',
