...
EventSelector::EventSelector(JsonView jsonValue) { *this = jsonValue; }
...
EventSelector& EventSelector::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("ExcludeManagementEventSources")) {
    ...
    for (unsigned excludeManagementEventSourcesIndex = 0;
         excludeManagementEventSourcesIndex < excludeManagementEventSourcesJsonList.GetLength(); ++excludeManagementEventSourcesIndex) {
...
JsonValue EventSelector::Jsonize() const {
  ...
  if (m_excludeManagementEventSourcesHasBeenSet) {
    ...
    for (unsigned excludeManagementEventSourcesIndex = 0;
         excludeManagementEventSourcesIndex < excludeManagementEventSourcesJsonList.GetLength(); ++excludeManagementEventSourcesIndex) {
      excludeManagementEventSourcesJsonList[excludeManagementEventSourcesIndex].AsString(
          m_excludeManagementEventSources[excludeManagementEventSourcesIndex]);
    }
