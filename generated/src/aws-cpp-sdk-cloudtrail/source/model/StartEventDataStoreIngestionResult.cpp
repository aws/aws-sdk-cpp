...
StartEventDataStoreIngestionResult::StartEventDataStoreIngestionResult()
{
}

StartEventDataStoreIngestionResult::StartEventDataStoreIngestionResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
