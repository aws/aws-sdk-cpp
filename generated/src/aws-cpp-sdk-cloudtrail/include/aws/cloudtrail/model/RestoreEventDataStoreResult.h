...
class RestoreEventDataStoreResult {
 public:
  ...
  template <typename EventDataStoreArnT = Aws::String>
  RestoreEventDataStoreResult& WithEventDataStoreArn(EventDataStoreArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  RestoreEventDataStoreResult& WithName(NameT&& value) {
  ...
  inline RestoreEventDataStoreResult& WithStatus(EventDataStoreStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename AdvancedEventSelectorsT = Aws::Vector<AdvancedEventSelector>>
  RestoreEventDataStoreResult& WithAdvancedEventSelectors(AdvancedEventSelectorsT&& value) {
  ...
  RestoreEventDataStoreResult& AddAdvancedEventSelectors(AdvancedEventSelectorsT&& value) {
    m_advancedEventSelectorsHasBeenSet = true;
  ...
  inline RestoreEventDataStoreResult& WithMultiRegionEnabled(bool value) {
  ...
  inline RestoreEventDataStoreResult& WithOrganizationEnabled(bool value) {
  ...
  inline RestoreEventDataStoreResult& WithRetentionPeriod(int value) {
  ...
  inline RestoreEventDataStoreResult& WithTerminationProtectionEnabled(bool value) {
  ...
  template <typename CreatedTimestampT = Aws::Utils::DateTime>
  RestoreEventDataStoreResult& WithCreatedTimestamp(CreatedTimestampT&& value) {
  ...
  template <typename UpdatedTimestampT = Aws::Utils::DateTime>
  RestoreEventDataStoreResult& WithUpdatedTimestamp(UpdatedTimestampT&& value) {
  ...
  template <typename KmsKeyIdT = Aws::String>
  RestoreEventDataStoreResult& WithKmsKeyId(KmsKeyIdT&& value) {
  ...
  inline RestoreEventDataStoreResult& WithBillingMode(BillingMode value) {
  ...
  template <typename RequestIdT = Aws::String>
  RestoreEventDataStoreResult& WithRequestId(RequestIdT&& value) {
