...
class ListEventDataStoresRequest : public CloudTrailRequest {
 public:
  AWS_CLOUDTRAIL_API ListEventDataStoresRequest() = default;
  ...
  template <typename NextTokenT = Aws::String>
  ListEventDataStoresRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListEventDataStoresRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
