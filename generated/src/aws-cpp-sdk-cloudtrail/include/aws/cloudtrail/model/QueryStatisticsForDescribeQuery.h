...
class QueryStatisticsForDescribeQuery {
 public:
  ...
  inline void SetEventsMatched(long long value) {
    m_eventsMatchedHasBeenSet = true;
    m_eventsMatched = value;
  }
  inline QueryStatisticsForDescribeQuery& WithEventsMatched(long long value) {
    SetEventsMatched(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEventsScanned(long long value) {
    m_eventsScannedHasBeenSet = true;
    m_eventsScanned = value;
  }
  inline QueryStatisticsForDescribeQuery& WithEventsScanned(long long value) {
    SetEventsScanned(value);
    return *this;
  }
  ///@}
  ...
  inline QueryStatisticsForDescribeQuery& WithBytesScanned(long long value) {
  ...
  inline void SetExecutionTimeInMillis(int value) {
    m_executionTimeInMillisHasBeenSet = true;
    m_executionTimeInMillis = value;
  }
  inline QueryStatisticsForDescribeQuery& WithExecutionTimeInMillis(int value) {
