...
class S3ImportSource {
 public:
  ...
  void SetS3LocationUri(S3LocationUriT&& value) {
    ...
    m_s3LocationUri = std::forward<S3LocationUriT>(value);
  }
  template <typename S3LocationUriT = Aws::String>
  S3ImportSource& WithS3LocationUri(S3LocationUriT&& value) {
    SetS3LocationUri(std::forward<S3LocationUriT>(value));
    return *this;
  }
  ///@}
  ...
  void SetS3BucketRegion(S3BucketRegionT&& value) {
    ...
    m_s3BucketRegion = std::forward<S3BucketRegionT>(value);
  }
  template <typename S3BucketRegionT = Aws::String>
  S3ImportSource& WithS3BucketRegion(S3BucketRegionT&& value) {
    SetS3BucketRegion(std::forward<S3BucketRegionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetS3BucketAccessRoleArn(S3BucketAccessRoleArnT&& value) {
    ...
    m_s3BucketAccessRoleArn = std::forward<S3BucketAccessRoleArnT>(value);
  }
  template <typename S3BucketAccessRoleArnT = Aws::String>
  S3ImportSource& WithS3BucketAccessRoleArn(S3BucketAccessRoleArnT&& value) {
    SetS3BucketAccessRoleArn(std::forward<S3BucketAccessRoleArnT>(value));
    return *this;
  }
  ///@}
 private:
