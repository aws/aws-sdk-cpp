...
class RegisterOrganizationDelegatedAdminResult {
 public:
  AWS_CLOUDTRAIL_API RegisterOrganizationDelegatedAdminResult() = default;
  ...
  AWS_CLOUDTRAIL_API RegisterOrganizationDelegatedAdminResult& operator=(
  ...
  template <typename RequestIdT = Aws::String>
  RegisterOrganizationDelegatedAdminResult& WithRequestId(RequestIdT&& value) {
