...
class GetQueryResultsRequest : public CloudTrailRequest {
 public:
  ...
  inline void SetMaxQueryResults(int value) {
    m_maxQueryResultsHasBeenSet = true;
    m_maxQueryResults = value;
  }
  inline GetQueryResultsRequest& WithMaxQueryResults(int value) {
    SetMaxQueryResults(value);
    return *this;
  }
  ///@}
