...
class RefreshScheduleFrequency {
 public:
  ...
  inline void SetUnit(RefreshScheduleFrequencyUnit value) {
    m_unitHasBeenSet = true;
    m_unit = value;
  }
  inline RefreshScheduleFrequency& WithUnit(RefreshScheduleFrequencyUnit value) {
    SetUnit(value);
    return *this;
  }
  ///@}
  ...
  inline RefreshScheduleFrequency& WithValue(int value) {
    SetValue(value);
    return *this;
  }
  ///@}
