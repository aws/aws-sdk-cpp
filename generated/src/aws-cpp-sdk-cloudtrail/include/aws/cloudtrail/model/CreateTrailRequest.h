...
class CreateTrailRequest : public CloudTrailRequest {
 public:
  ...
  inline CreateTrailRequest& WithIncludeGlobalServiceEvents(bool value) {
  ...
  inline CreateTrailRequest& WithIsMultiRegionTrail(bool value) {
  ...
  inline CreateTrailRequest& WithEnableLogFileValidation(bool value) {
  ...
  inline CreateTrailRequest& WithIsOrganizationTrail(bool value) {
  ...
  inline CreateTrailRequest& WithRecursiveLogging(bool value) {
