...
namespace Model
{
  ...
  public:
    ...
    template<typename EventDataStoreOwnerAccountIdT = Aws::String>
    StartQueryResult& WithEventDataStoreOwnerAccountId(EventDataStoreOwnerAccountIdT&& value) { SetEventDataStoreOwnerAccountId(std::forward<EventDataStoreOwnerAccountIdT>(value)); return *this;}
    ///@}
