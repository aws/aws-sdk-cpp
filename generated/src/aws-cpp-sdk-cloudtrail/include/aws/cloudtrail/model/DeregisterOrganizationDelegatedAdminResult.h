...
namespace Model
{
  ...
  public:
    ...
    inline DeregisterOrganizationDelegatedAdminResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeregisterOrganizationDelegatedAdminResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeregisterOrganizationDelegatedAdminResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
