...
class DeregisterOrganizationDelegatedAdminResult {
 public:
  AWS_CLOUDTRAIL_API DeregisterOrganizationDelegatedAdminResult() = default;
  ...
  AWS_CLOUDTRAIL_API DeregisterOrganizationDelegatedAdminResult& operator=(
  ...
  template <typename RequestIdT = Aws::String>
  DeregisterOrganizationDelegatedAdminResult& WithRequestId(RequestIdT&& value) {
