...
class ListTagsRequest : public CloudTrailRequest {
 public:
  ...
  void SetResourceIdList(ResourceIdListT&& value) {
    m_resourceIdListHasBeenSet = true;
    m_resourceIdList = std::forward<ResourceIdListT>(value);
  }
  template <typename ResourceIdListT = Aws::Vector<Aws::String>>
  ListTagsRequest& WithResourceIdList(ResourceIdListT&& value) {
    SetResourceIdList(std::forward<ResourceIdListT>(value));
    return *this;
  }
  template <typename ResourceIdListT = Aws::String>
  ListTagsRequest& AddResourceIdList(ResourceIdListT&& value) {
    m_resourceIdListHasBeenSet = true;
    m_resourceIdList.emplace_back(std::forward<ResourceIdListT>(value));
    return *this;
  }
  ///@}
