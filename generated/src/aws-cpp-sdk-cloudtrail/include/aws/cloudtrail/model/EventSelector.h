...
class EventSelector {
 public:
  ...
  inline void SetReadWriteType(ReadWriteType value) {
    m_readWriteTypeHasBeenSet = true;
    m_readWriteType = value;
  }
  inline EventSelector& WithReadWriteType(ReadWriteType value) {
    SetReadWriteType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIncludeManagementEvents(bool value) {
    m_includeManagementEventsHasBeenSet = true;
    m_includeManagementEvents = value;
  }
  inline EventSelector& WithIncludeManagementEvents(bool value) {
    SetIncludeManagementEvents(value);
    return *this;
  }
  ///@}
  ...
  void SetDataResources(DataResourcesT&& value) {
    ...
    m_dataResources = std::forward<DataResourcesT>(value);
  }
  template <typename DataResourcesT = Aws::Vector<DataResource>>
  EventSelector& WithDataResources(DataResourcesT&& value) {
    SetDataResources(std::forward<DataResourcesT>(value));
    return *this;
  }
  template <typename DataResourcesT = DataResource>
  EventSelector& AddDataResources(DataResourcesT&& value) {
    m_dataResourcesHasBeenSet = true;
    m_dataResources.emplace_back(std::forward<DataResourcesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExcludeManagementEventSources(ExcludeManagementEventSourcesT&& value) {
    ...
    m_excludeManagementEventSources = std::forward<ExcludeManagementEventSourcesT>(value);
  }
  template <typename ExcludeManagementEventSourcesT = Aws::Vector<Aws::String>>
  EventSelector& WithExcludeManagementEventSources(ExcludeManagementEventSourcesT&& value) {
    SetExcludeManagementEventSources(std::forward<ExcludeManagementEventSourcesT>(value));
    return *this;
  }
  ...
  EventSelector& AddExcludeManagementEventSources(ExcludeManagementEventSourcesT&& value) {
    m_excludeManagementEventSourcesHasBeenSet = true;
    m_excludeManagementEventSources.emplace_back(std::forward<ExcludeManagementEventSourcesT>(value));
    return *this;
  }
  ///@}
 private:
