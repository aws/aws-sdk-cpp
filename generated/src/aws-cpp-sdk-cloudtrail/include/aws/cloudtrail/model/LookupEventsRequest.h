...
class LookupEventsRequest : public CloudTrailRequest {
 public:
  ...
  inline void SetEventCategory(EventCategory value) {
    m_eventCategoryHasBeenSet = true;
    m_eventCategory = value;
  }
  inline LookupEventsRequest& WithEventCategory(EventCategory value) {
  ...
  inline LookupEventsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
