...
class Trail {
 public:
   ...
   * Services global services such as IAM. Otherwise, <b>False</b>. Setting this
   * value to <code>true</code> only delivers global service events to the trail if
   * the trail is multi-Region or if the trail's home Region is the partition leader
   * Region (for example, us-east-1).</p>
   */
  ...
  inline Trail& WithIncludeGlobalServiceEvents(bool value) {
  ...
  inline Trail& WithIsMultiRegionTrail(bool value) {
  ...
  inline Trail& WithLogFileValidationEnabled(bool value) {
  ...
  inline void SetHasCustomEventSelectors(bool value) {
    m_hasCustomEventSelectorsHasBeenSet = true;
    m_hasCustomEventSelectors = value;
  }
  inline Trail& WithHasCustomEventSelectors(bool value) {
    SetHasCustomEventSelectors(value);
    return *this;
  }
  ///@}
  ...
  inline void SetHasInsightSelectors(bool value) {
    m_hasInsightSelectorsHasBeenSet = true;
    m_hasInsightSelectors = value;
  }
  inline Trail& WithHasInsightSelectors(bool value) {
    SetHasInsightSelectors(value);
    return *this;
  }
  ///@}
  ...
  inline Trail& WithIsOrganizationTrail(bool value) {
  ...
  ///@{
  /**
   * <p>Specifies whether recursive logging is enabled for the trail. If you set
   * <code>RecursiveLogging</code> to <code>false</code>, CloudTrail suppresses
  ...
  inline bool RecursiveLoggingHasBeenSet() const { return m_recursiveLoggingHasBeenSet; }
  inline void SetRecursiveLogging(bool value) {
    m_recursiveLoggingHasBeenSet = true;
    m_recursiveLogging = value;
  }
  inline Trail& WithRecursiveLogging(bool value) {
