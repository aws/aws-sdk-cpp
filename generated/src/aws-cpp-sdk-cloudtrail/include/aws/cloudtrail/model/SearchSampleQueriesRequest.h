...
class SearchSampleQueriesRequest : public CloudTrailRequest {
 public:
  ...
  void SetSearchPhrase(SearchPhraseT&& value) {
    m_searchPhraseHasBeenSet = true;
    m_searchPhrase = std::forward<SearchPhraseT>(value);
  }
  template <typename SearchPhraseT = Aws::String>
  SearchSampleQueriesRequest& WithSearchPhrase(SearchPhraseT&& value) {
    SetSearchPhrase(std::forward<SearchPhraseT>(value));
    return *this;
  }
  ///@}
  ...
  inline SearchSampleQueriesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
