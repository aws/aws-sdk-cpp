...
class DisableFederationResult {
 public:
  ...
  template <typename EventDataStoreArnT = Aws::String>
  DisableFederationResult& WithEventDataStoreArn(EventDataStoreArnT&& value) {
  ...
  inline DisableFederationResult& WithFederationStatus(FederationStatus value) {
  ...
  template <typename RequestIdT = Aws::String>
  DisableFederationResult& WithRequestId(RequestIdT&& value) {
