...
class ListEventDataStoresResult {
 public:
  ...
  template <typename EventDataStoresT = Aws::Vector<EventDataStore>>
  ListEventDataStoresResult& WithEventDataStores(EventDataStoresT&& value) {
    SetEventDataStores(std::forward<EventDataStoresT>(value));
    return *this;
  }
  template <typename EventDataStoresT = EventDataStore>
  ListEventDataStoresResult& AddEventDataStores(EventDataStoresT&& value) {
    m_eventDataStoresHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListEventDataStoresResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListEventDataStoresResult& WithRequestId(RequestIdT&& value) {
