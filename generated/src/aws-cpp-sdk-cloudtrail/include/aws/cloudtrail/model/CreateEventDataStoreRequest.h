...
namespace Model
{
  ...
  public:
     ...
     * you plan to copy trail events to this event data store, we recommend that you
     * consider both the age of the events that you want to copy as well as how long
     * you want to keep the copied events in your event data store. For example, if you
     * copy trail events that are 5 years old and specify a retention period of 7
     * years, the event data store will retain those events for two years.</p> 
     */
