...
class CreateEventDataStoreRequest : public CloudTrailRequest {
 public:
  ...
  inline CreateEventDataStoreRequest& WithMultiRegionEnabled(bool value) {
  ...
  inline CreateEventDataStoreRequest& WithOrganizationEnabled(bool value) {
  ...
  inline CreateEventDataStoreRequest& WithRetentionPeriod(int value) {
  ...
  inline CreateEventDataStoreRequest& WithTerminationProtectionEnabled(bool value) {
  ...
  inline void SetStartIngestion(bool value) {
    m_startIngestionHasBeenSet = true;
    m_startIngestion = value;
  }
  inline CreateEventDataStoreRequest& WithStartIngestion(bool value) {
    SetStartIngestion(value);
    return *this;
  }
  ///@}
  ...
  inline CreateEventDataStoreRequest& WithBillingMode(BillingMode value) {
