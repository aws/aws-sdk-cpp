...
class CreateEventDataStoreResult {
 public:
  ...
  template <typename EventDataStoreArnT = Aws::String>
  CreateEventDataStoreResult& WithEventDataStoreArn(EventDataStoreArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateEventDataStoreResult& WithName(NameT&& value) {
  ...
  inline CreateEventDataStoreResult& WithStatus(EventDataStoreStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename AdvancedEventSelectorsT = Aws::Vector<AdvancedEventSelector>>
  CreateEventDataStoreResult& WithAdvancedEventSelectors(AdvancedEventSelectorsT&& value) {
  ...
  CreateEventDataStoreResult& AddAdvancedEventSelectors(AdvancedEventSelectorsT&& value) {
    m_advancedEventSelectorsHasBeenSet = true;
  ...
  inline CreateEventDataStoreResult& WithMultiRegionEnabled(bool value) {
  ...
  inline CreateEventDataStoreResult& WithOrganizationEnabled(bool value) {
  ...
  inline CreateEventDataStoreResult& WithRetentionPeriod(int value) {
  ...
  inline CreateEventDataStoreResult& WithTerminationProtectionEnabled(bool value) {
  ...
  template <typename TagsListT = Aws::Vector<Tag>>
  CreateEventDataStoreResult& WithTagsList(TagsListT&& value) {
    SetTagsList(std::forward<TagsListT>(value));
    return *this;
  }
  template <typename TagsListT = Tag>
  CreateEventDataStoreResult& AddTagsList(TagsListT&& value) {
    m_tagsListHasBeenSet = true;
  ...
  template <typename CreatedTimestampT = Aws::Utils::DateTime>
  CreateEventDataStoreResult& WithCreatedTimestamp(CreatedTimestampT&& value) {
  ...
  template <typename UpdatedTimestampT = Aws::Utils::DateTime>
  CreateEventDataStoreResult& WithUpdatedTimestamp(UpdatedTimestampT&& value) {
  ...
  template <typename KmsKeyIdT = Aws::String>
  CreateEventDataStoreResult& WithKmsKeyId(KmsKeyIdT&& value) {
  ...
  inline CreateEventDataStoreResult& WithBillingMode(BillingMode value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateEventDataStoreResult& WithRequestId(RequestIdT&& value) {
