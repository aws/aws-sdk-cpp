...
class SearchSampleQueriesResult {
 public:
  ...
  template <typename SearchResultsT = Aws::Vector<SearchSampleQueriesSearchResult>>
  SearchSampleQueriesResult& WithSearchResults(SearchResultsT&& value) {
    SetSearchResults(std::forward<SearchResultsT>(value));
    return *this;
  }
  template <typename SearchResultsT = SearchSampleQueriesSearchResult>
  SearchSampleQueriesResult& AddSearchResults(SearchResultsT&& value) {
    m_searchResultsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  SearchSampleQueriesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  SearchSampleQueriesResult& WithRequestId(RequestIdT&& value) {
