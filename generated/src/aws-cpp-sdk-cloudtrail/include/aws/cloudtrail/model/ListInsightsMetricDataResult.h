...
class ListInsightsMetricDataResult {
 public:
  ...
  template <typename EventSourceT = Aws::String>
  ListInsightsMetricDataResult& WithEventSource(EventSourceT&& value) {
  ...
  template <typename EventNameT = Aws::String>
  ListInsightsMetricDataResult& WithEventName(EventNameT&& value) {
  ...
  inline ListInsightsMetricDataResult& WithInsightType(InsightType value) {
  ...
  template <typename ErrorCodeT = Aws::String>
  ListInsightsMetricDataResult& WithErrorCode(ErrorCodeT&& value) {
  ...
  template <typename TimestampsT = Aws::Vector<Aws::Utils::DateTime>>
  ListInsightsMetricDataResult& WithTimestamps(TimestampsT&& value) {
    SetTimestamps(std::forward<TimestampsT>(value));
    return *this;
  }
  template <typename TimestampsT = Aws::Utils::DateTime>
  ListInsightsMetricDataResult& AddTimestamps(TimestampsT&& value) {
    m_timestampsHasBeenSet = true;
  ...
  template <typename ValuesT = Aws::Vector<double>>
  ListInsightsMetricDataResult& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  inline ListInsightsMetricDataResult& AddValues(double value) {
    m_valuesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListInsightsMetricDataResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListInsightsMetricDataResult& WithRequestId(RequestIdT&& value) {
