...
class GenerateQueryRequest : public CloudTrailRequest {
 public:
  ...
  void SetEventDataStores(EventDataStoresT&& value) {
    m_eventDataStoresHasBeenSet = true;
    m_eventDataStores = std::forward<EventDataStoresT>(value);
  }
  template <typename EventDataStoresT = Aws::Vector<Aws::String>>
  GenerateQueryRequest& WithEventDataStores(EventDataStoresT&& value) {
    SetEventDataStores(std::forward<EventDataStoresT>(value));
    return *this;
  }
  template <typename EventDataStoresT = Aws::String>
  GenerateQueryRequest& AddEventDataStores(EventDataStoresT&& value) {
    m_eventDataStoresHasBeenSet = true;
    m_eventDataStores.emplace_back(std::forward<EventDataStoresT>(value));
    return *this;
  }
  ///@}
