...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class DeleteTrailRequest : public CloudTrailRequest
  {
  public:
    AWS_CLOUDTRAIL_API DeleteTrailRequest() = default;
    ...
    template<typename NameT = Aws::String>
    DeleteTrailRequest& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
  private:
