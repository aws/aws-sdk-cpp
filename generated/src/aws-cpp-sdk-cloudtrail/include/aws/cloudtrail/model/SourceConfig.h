...
class SourceConfig {
 public:
  ...
  inline void SetApplyToAllRegions(bool value) {
    m_applyToAllRegionsHasBeenSet = true;
    m_applyToAllRegions = value;
  }
  inline SourceConfig& WithApplyToAllRegions(bool value) {
    SetApplyToAllRegions(value);
    return *this;
  }
  ///@}
  ...
  template <typename AdvancedEventSelectorsT = Aws::Vector<AdvancedEventSelector>>
  SourceConfig& WithAdvancedEventSelectors(AdvancedEventSelectorsT&& value) {
  ...
  SourceConfig& AddAdvancedEventSelectors(AdvancedEventSelectorsT&& value) {
    m_advancedEventSelectorsHasBeenSet = true;
