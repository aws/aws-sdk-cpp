...
/**
 */
class RestoreEventDataStoreRequest : public CloudTrailRequest {
 public:
  AWS_CLOUDTRAIL_API RestoreEventDataStoreRequest() = default;
  ...
  template <typename EventDataStoreT = Aws::String>
  RestoreEventDataStoreRequest& WithEventDataStore(EventDataStoreT&& value) {
