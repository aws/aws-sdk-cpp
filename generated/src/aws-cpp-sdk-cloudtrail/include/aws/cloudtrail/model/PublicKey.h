...
class PublicKey {
 public:
  ...
  void SetValidityStartTime(ValidityStartTimeT&& value) {
    ...
    m_validityStartTime = std::forward<ValidityStartTimeT>(value);
  }
  template <typename ValidityStartTimeT = Aws::Utils::DateTime>
  PublicKey& WithValidityStartTime(ValidityStartTimeT&& value) {
    SetValidityStartTime(std::forward<ValidityStartTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetValidityEndTime(ValidityEndTimeT&& value) {
    ...
    m_validityEndTime = std::forward<ValidityEndTimeT>(value);
  }
  template <typename ValidityEndTimeT = Aws::Utils::DateTime>
  PublicKey& WithValidityEndTime(ValidityEndTimeT&& value) {
    SetValidityEndTime(std::forward<ValidityEndTimeT>(value));
    return *this;
  }
  ///@}
