...
class GetChannelResult {
 public:
  ...
  void SetSourceConfig(SourceConfigT&& value) {
    ...
    m_sourceConfig = std::forward<SourceConfigT>(value);
  }
  template <typename SourceConfigT = SourceConfig>
  GetChannelResult& WithSourceConfig(SourceConfigT&& value) {
    SetSourceConfig(std::forward<SourceConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIngestionStatus(IngestionStatusT&& value) {
    ...
    m_ingestionStatus = std::forward<IngestionStatusT>(value);
  }
  template <typename IngestionStatusT = IngestionStatus>
  GetChannelResult& WithIngestionStatus(IngestionStatusT&& value) {
    SetIngestionStatus(std::forward<IngestionStatusT>(value));
    return *this;
  }
  ///@}
