...
class PutEventSelectorsRequest : public CloudTrailRequest {
 public:
  ...
  template <typename TrailNameT = Aws::String>
  PutEventSelectorsRequest& WithTrailName(TrailNameT&& value) {
  ...
  template <typename EventSelectorsT = Aws::Vector<EventSelector>>
  PutEventSelectorsRequest& WithEventSelectors(EventSelectorsT&& value) {
    SetEventSelectors(std::forward<EventSelectorsT>(value));
    return *this;
  }
  template <typename EventSelectorsT = EventSelector>
  PutEventSelectorsRequest& AddEventSelectors(EventSelectorsT&& value) {
    m_eventSelectorsHasBeenSet = true;
  ...
  template <typename AdvancedEventSelectorsT = Aws::Vector<AdvancedEventSelector>>
  PutEventSelectorsRequest& WithAdvancedEventSelectors(AdvancedEventSelectorsT&& value) {
  ...
  PutEventSelectorsRequest& AddAdvancedEventSelectors(AdvancedEventSelectorsT&& value) {
    m_advancedEventSelectorsHasBeenSet = true;
