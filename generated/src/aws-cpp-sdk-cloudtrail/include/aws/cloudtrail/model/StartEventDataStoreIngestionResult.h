...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDTRAIL_API StartEventDataStoreIngestionResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    StartEventDataStoreIngestionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
