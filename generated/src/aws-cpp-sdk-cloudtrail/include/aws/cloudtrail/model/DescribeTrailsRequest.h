...
class DescribeTrailsRequest : public CloudTrailRequest {
 public:
  ...
  void SetTrailNameList(TrailNameListT&& value) {
    m_trailNameListHasBeenSet = true;
    m_trailNameList = std::forward<TrailNameListT>(value);
  }
  template <typename TrailNameListT = Aws::Vector<Aws::String>>
  DescribeTrailsRequest& WithTrailNameList(TrailNameListT&& value) {
    SetTrailNameList(std::forward<TrailNameListT>(value));
    return *this;
  }
  template <typename TrailNameListT = Aws::String>
  DescribeTrailsRequest& AddTrailNameList(TrailNameListT&& value) {
    m_trailNameListHasBeenSet = true;
    m_trailNameList.emplace_back(std::forward<TrailNameListT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetIncludeShadowTrails(bool value) {
    m_includeShadowTrailsHasBeenSet = true;
    m_includeShadowTrails = value;
  }
  inline DescribeTrailsRequest& WithIncludeShadowTrails(bool value) {
    SetIncludeShadowTrails(value);
    return *this;
  }
  ///@}
 private:
