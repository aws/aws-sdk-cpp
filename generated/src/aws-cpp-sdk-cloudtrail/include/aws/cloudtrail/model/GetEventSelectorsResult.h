...
class GetEventSelectorsResult {
 public:
  ...
  template <typename TrailARNT = Aws::String>
  GetEventSelectorsResult& WithTrailARN(TrailARNT&& value) {
  ...
  template <typename EventSelectorsT = Aws::Vector<EventSelector>>
  GetEventSelectorsResult& WithEventSelectors(EventSelectorsT&& value) {
    SetEventSelectors(std::forward<EventSelectorsT>(value));
    return *this;
  }
  template <typename EventSelectorsT = EventSelector>
  GetEventSelectorsResult& AddEventSelectors(EventSelectorsT&& value) {
    m_eventSelectorsHasBeenSet = true;
  ...
  template <typename AdvancedEventSelectorsT = Aws::Vector<AdvancedEventSelector>>
  GetEventSelectorsResult& WithAdvancedEventSelectors(AdvancedEventSelectorsT&& value) {
  ...
  GetEventSelectorsResult& AddAdvancedEventSelectors(AdvancedEventSelectorsT&& value) {
    m_advancedEventSelectorsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetEventSelectorsResult& WithRequestId(RequestIdT&& value) {
