...
class RequestWidget {
 public:
  ...
  void SetViewProperties(ViewPropertiesT&& value) {
    ...
    m_viewProperties = std::forward<ViewPropertiesT>(value);
  }
  template <typename ViewPropertiesT = Aws::Map<Aws::String, Aws::String>>
  RequestWidget& WithViewProperties(ViewPropertiesT&& value) {
    SetViewProperties(std::forward<ViewPropertiesT>(value));
    return *this;
  }
  ...
  RequestWidget& AddViewProperties(ViewPropertiesKeyT&& key, ViewPropertiesValueT&& value) {
    m_viewPropertiesHasBeenSet = true;
    m_viewProperties.emplace(std::forward<ViewPropertiesKeyT>(key), std::forward<ViewPropertiesValueT>(value));
    return *this;
  }
  ///@}
 private:
