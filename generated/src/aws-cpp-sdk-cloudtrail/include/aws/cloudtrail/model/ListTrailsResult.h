...
class ListTrailsResult {
 public:
  ...
  void SetTrails(TrailsT&& value) {
    ...
    m_trails = std::forward<TrailsT>(value);
  }
  template <typename TrailsT = Aws::Vector<TrailInfo>>
  ListTrailsResult& WithTrails(TrailsT&& value) {
    SetTrails(std::forward<TrailsT>(value));
    return *this;
  }
  template <typename TrailsT = TrailInfo>
  ListTrailsResult& AddTrails(TrailsT&& value) {
    m_trailsHasBeenSet = true;
    m_trails.emplace_back(std::forward<TrailsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTrailsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListTrailsResult& WithRequestId(RequestIdT&& value) {
