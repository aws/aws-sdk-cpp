...
class UpdateTrailRequest : public CloudTrailRequest {
 public:
  ...
  void SetSnsTopicName(SnsTopicNameT&& value) {
    ...
    m_snsTopicName = std::forward<SnsTopicNameT>(value);
  }
  template <typename SnsTopicNameT = Aws::String>
  UpdateTrailRequest& WithSnsTopicName(SnsTopicNameT&& value) {
    SetSnsTopicName(std::forward<SnsTopicNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline UpdateTrailRequest& WithIncludeGlobalServiceEvents(bool value) {
  ...
  inline UpdateTrailRequest& WithIsMultiRegionTrail(bool value) {
  ...
  inline void SetEnableLogFileValidation(bool value) {
    m_enableLogFileValidationHasBeenSet = true;
    m_enableLogFileValidation = value;
  }
  inline UpdateTrailRequest& WithEnableLogFileValidation(bool value) {
    SetEnableLogFileValidation(value);
    return *this;
  }
  ///@}
   ...
   * delivered by CloudTrail. The value can be an alias name prefixed by "alias/", a
   * fully specified ARN to an alias, a fully specified ARN to a key, or a globally
   * unique identifier.</p> <p>CloudTrail also supports KMS multi-Region keys. For
  ...
  inline UpdateTrailRequest& WithIsOrganizationTrail(bool value) {
  ...
  inline UpdateTrailRequest& WithRecursiveLogging(bool value) {
