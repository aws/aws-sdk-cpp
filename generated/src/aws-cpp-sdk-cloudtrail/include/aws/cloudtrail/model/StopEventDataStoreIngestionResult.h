...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDTRAIL_API StopEventDataStoreIngestionResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    StopEventDataStoreIngestionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
