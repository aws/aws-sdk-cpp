...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDTRAIL_API StopEventDataStoreIngestionRequest() = default;
    ...
    template<typename EventDataStoreT = Aws::String>
    StopEventDataStoreIngestionRequest& WithEventDataStore(EventDataStoreT&& value) { SetEventDataStore(std::forward<EventDataStoreT>(value)); return *this;}
    ///@}
  private:
