...
class GetAttributeValuesResult {
 public:
  ...
  template <typename AttributeValuesT = Aws::Vector<AttributeValue>>
  GetAttributeValuesResult& WithAttributeValues(AttributeValuesT&& value) {
    SetAttributeValues(std::forward<AttributeValuesT>(value));
    return *this;
  }
  template <typename AttributeValuesT = AttributeValue>
  GetAttributeValuesResult& AddAttributeValues(AttributeValuesT&& value) {
    m_attributeValuesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetAttributeValuesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetAttributeValuesResult& WithRequestId(RequestIdT&& value) {
