...
class GetProductsResult {
 public:
  ...
  template <typename FormatVersionT = Aws::String>
  GetProductsResult& WithFormatVersion(FormatVersionT&& value) {
  ...
  void SetPriceList(PriceListT&& value) {
    m_priceListHasBeenSet = true;
    m_priceList = std::forward<PriceListT>(value);
  }
  template <typename PriceListT = Aws::Vector<Aws::String>>
  GetProductsResult& WithPriceList(PriceListT&& value) {
    SetPriceList(std::forward<PriceListT>(value));
    return *this;
  }
  template <typename PriceListT = Aws::String>
  GetProductsResult& AddPriceList(PriceListT&& value) {
    m_priceListHasBeenSet = true;
    m_priceList.emplace_back(std::forward<PriceListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetProductsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetProductsResult& WithRequestId(RequestIdT&& value) {
