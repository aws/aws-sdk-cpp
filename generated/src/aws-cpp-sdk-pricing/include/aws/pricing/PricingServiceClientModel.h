...
typedef Aws::Utils::Outcome<GetPriceListFileUrlResult, PricingError> GetPriceListFileUrlOutcome;
typedef Aws::Utils::Outcome<GetProductsResult, PricingError> GetProductsOutcome;
typedef Aws::Utils::Outcome<ListPriceListsResult, PricingError> ListPriceListsOutcome;
...
typedef std::future<GetPriceListFileUrlOutcome> GetPriceListFileUrlOutcomeCallable;
typedef std::future<GetProductsOutcome> GetProductsOutcomeCallable;
typedef std::future<ListPriceListsOutcome> ListPriceListsOutcomeCallable;
...
typedef std::function<void(const PricingClient*, const Model::DescribeServicesRequest&, const Model::DescribeServicesOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DescribeServicesResponseReceivedHandler;
typedef std::function<void(const PricingClient*, const Model::GetAttributeValuesRequest&, const Model::GetAttributeValuesOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetAttributeValuesResponseReceivedHandler;
typedef std::function<void(const PricingClient*, const Model::GetPriceListFileUrlRequest&, const Model::GetPriceListFileUrlOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetPriceListFileUrlResponseReceivedHandler;
typedef std::function<void(const PricingClient*, const Model::GetProductsRequest&, const Model::GetProductsOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetProductsResponseReceivedHandler;
typedef std::function<void(const PricingClient*, const Model::ListPriceListsRequest&, const Model::ListPriceListsOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
