...
SMSMessageActivity::SMSMessageActivity(JsonView jsonValue) { *this = jsonValue; }

SMSMessageActivity& SMSMessageActivity::operator=(JsonView jsonValue) {
...
JsonValue SMSMessageActivity::Jsonize() const {
  JsonValue payload;
