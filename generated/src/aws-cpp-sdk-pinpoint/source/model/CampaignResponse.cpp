...
CampaignResponse::CampaignResponse(JsonView jsonValue) { *this = jsonValue; }
...
CampaignResponse& CampaignResponse::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("AdditionalTreatments")) {
    ...
    for (unsigned additionalTreatmentsIndex = 0; additionalTreatmentsIndex < additionalTreatmentsJsonList.GetLength();
         ++additionalTreatmentsIndex) {
