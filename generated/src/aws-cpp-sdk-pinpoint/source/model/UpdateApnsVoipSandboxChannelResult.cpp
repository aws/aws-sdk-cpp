...
UpdateApnsVoipSandboxChannelResult::UpdateApnsVoipSandboxChannelResult()
{
}

UpdateApnsVoipSandboxChannelResult::UpdateApnsVoipSandboxChannelResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
