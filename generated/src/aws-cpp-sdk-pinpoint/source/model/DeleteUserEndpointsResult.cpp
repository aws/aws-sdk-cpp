...
DeleteUserEndpointsResult::DeleteUserEndpointsResult()
{
}

DeleteUserEndpointsResult::DeleteUserEndpointsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
