...
JourneyRunsResponse::JourneyRunsResponse(JsonView jsonValue) { *this = jsonValue; }

JourneyRunsResponse& JourneyRunsResponse::operator=(JsonView jsonValue) {
...
JsonValue JourneyRunsResponse::Jsonize() const {
  JsonValue payload;
