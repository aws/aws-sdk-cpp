...
DeleteApnsVoipSandboxChannelResult::DeleteApnsVoipSandboxChannelResult()
{
}

DeleteApnsVoipSandboxChannelResult::DeleteApnsVoipSandboxChannelResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
