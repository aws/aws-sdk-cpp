...
namespace Pinpoint
{
const size_t PinpointEndpointRules::RulesBlobStrLen = 3462;
const size_t PinpointEndpointRules::RulesBlobSize = 3463;
...
'p','i','n','p','o','i','n','t','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t',
