...
namespace Pinpoint
{
   ...
   */
  class AWS_PINPOINT_API PinpointClient : Aws::Client::ClientWithAsyncTemplateMethods<PinpointClient>,
    smithy::client::AwsSmithyClientT<Aws::Pinpoint::SERVICE_NAME,
