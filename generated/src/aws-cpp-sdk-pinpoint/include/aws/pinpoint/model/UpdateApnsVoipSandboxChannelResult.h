...
class UpdateApnsVoipSandboxChannelResult {
 public:
  ...
  template <typename APNSVoipSandboxChannelResponseT = APNSVoipSandboxChannelResponse>
  UpdateApnsVoipSandboxChannelResult& WithAPNSVoipSandboxChannelResponse(APNSVoipSandboxChannelResponseT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateApnsVoipSandboxChannelResult& WithRequestId(RequestIdT&& value) {
