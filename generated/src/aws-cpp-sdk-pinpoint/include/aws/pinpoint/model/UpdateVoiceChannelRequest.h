...
class UpdateVoiceChannelRequest : public PinpointRequest {
 public:
  ...
  void SetVoiceChannelRequest(VoiceChannelRequestT&& value) {
    m_voiceChannelRequestHasBeenSet = true;
    m_voiceChannelRequest = std::forward<VoiceChannelRequestT>(value);
  }
  template <typename VoiceChannelRequestT = VoiceChannelRequest>
  UpdateVoiceChannelRequest& WithVoiceChannelRequest(VoiceChannelRequestT&& value) {
    SetVoiceChannelRequest(std::forward<VoiceChannelRequestT>(value));
    return *this;
  }
  ///@}
 private:
