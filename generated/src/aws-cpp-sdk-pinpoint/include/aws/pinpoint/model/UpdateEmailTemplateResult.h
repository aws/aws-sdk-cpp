...
namespace Model
{
  ...
  public:
    ...
    inline UpdateEmailTemplateResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateEmailTemplateResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateEmailTemplateResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
