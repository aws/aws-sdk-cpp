...
namespace Model
{
  ...
  {
  public:
    AWS_PINPOINT_API UpdateEmailTemplateResult() = default;
    ...
    template<typename MessageBodyT = MessageBody>
    UpdateEmailTemplateResult& WithMessageBody(MessageBodyT&& value) { SetMessageBody(std::forward<MessageBodyT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateEmailTemplateResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
