...
class GetRecommenderConfigurationsResult {
 public:
  ...
  inline const ListRecommenderConfigurationsResponse& GetListRecommenderConfigurationsResponse() const {
    return m_listRecommenderConfigurationsResponse;
  }
  ...
  void SetListRecommenderConfigurationsResponse(ListRecommenderConfigurationsResponseT&& value) {
    m_listRecommenderConfigurationsResponseHasBeenSet = true;
    m_listRecommenderConfigurationsResponse = std::forward<ListRecommenderConfigurationsResponseT>(value);
  }
  template <typename ListRecommenderConfigurationsResponseT = ListRecommenderConfigurationsResponse>
  GetRecommenderConfigurationsResult& WithListRecommenderConfigurationsResponse(ListRecommenderConfigurationsResponseT&& value) {
    SetListRecommenderConfigurationsResponse(std::forward<ListRecommenderConfigurationsResponseT>(value));
    return *this;
  }
  ///@}
