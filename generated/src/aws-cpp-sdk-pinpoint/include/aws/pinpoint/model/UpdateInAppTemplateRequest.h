...
namespace Model
{
  ...
  public:
    ...
    inline UpdateInAppTemplateRequest& WithInAppTemplateRequest(const InAppTemplateRequest& value) { SetInAppTemplateRequest(value); return *this;}
    inline UpdateInAppTemplateRequest& WithInAppTemplateRequest(InAppTemplateRequest&& value) { SetInAppTemplateRequest(std::move(value)); return *this;}
    ///@}
    ...
    inline UpdateInAppTemplateRequest& WithTemplateName(const Aws::String& value) { SetTemplateName(value); return *this;}
    inline UpdateInAppTemplateRequest& WithTemplateName(Aws::String&& value) { SetTemplateName(std::move(value)); return *this;}
    inline UpdateInAppTemplateRequest& WithTemplateName(const char* value) { SetTemplateName(value); return *this;}
    ///@}
    ...
    inline UpdateInAppTemplateRequest& WithVersion(const Aws::String& value) { SetVersion(value); return *this;}
    inline UpdateInAppTemplateRequest& WithVersion(Aws::String&& value) { SetVersion(std::move(value)); return *this;}
    inline UpdateInAppTemplateRequest& WithVersion(const char* value) { SetVersion(value); return *this;}
    ///@}
  private:
