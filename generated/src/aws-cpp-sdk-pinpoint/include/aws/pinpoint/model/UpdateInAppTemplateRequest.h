...
class UpdateInAppTemplateRequest : public PinpointRequest {
 public:
  ...
  inline void SetCreateNewVersion(bool value) {
    m_createNewVersionHasBeenSet = true;
    m_createNewVersion = value;
  }
  inline UpdateInAppTemplateRequest& WithCreateNewVersion(bool value) {
  ...
  void SetInAppTemplateRequest(InAppTemplateRequestT&& value) {
    m_inAppTemplateRequestHasBeenSet = true;
    m_inAppTemplateRequest = std::forward<InAppTemplateRequestT>(value);
  }
  template <typename InAppTemplateRequestT = InAppTemplateRequest>
  UpdateInAppTemplateRequest& WithInAppTemplateRequest(InAppTemplateRequestT&& value) {
    SetInAppTemplateRequest(std::forward<InAppTemplateRequestT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TemplateNameT = Aws::String>
  UpdateInAppTemplateRequest& WithTemplateName(TemplateNameT&& value) {
  ...
  template <typename VersionT = Aws::String>
  UpdateInAppTemplateRequest& WithVersion(VersionT&& value) {
