...
class StartCondition {
 public:
  ...
  void SetEventStartCondition(EventStartConditionT&& value) {
    ...
    m_eventStartCondition = std::forward<EventStartConditionT>(value);
  }
  template <typename EventStartConditionT = EventStartCondition>
  StartCondition& WithEventStartCondition(EventStartConditionT&& value) {
    SetEventStartCondition(std::forward<EventStartConditionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSegmentStartCondition(SegmentStartConditionT&& value) {
    ...
    m_segmentStartCondition = std::forward<SegmentStartConditionT>(value);
  }
  template <typename SegmentStartConditionT = SegmentCondition>
  StartCondition& WithSegmentStartCondition(SegmentStartConditionT&& value) {
    SetSegmentStartCondition(std::forward<SegmentStartConditionT>(value));
    return *this;
  }
  ///@}
 private:
