...
class DeleteCampaignResult {
 public:
  ...
  void SetCampaignResponse(CampaignResponseT&& value) {
    m_campaignResponseHasBeenSet = true;
    m_campaignResponse = std::forward<CampaignResponseT>(value);
  }
  template <typename CampaignResponseT = CampaignResponse>
  DeleteCampaignResult& WithCampaignResponse(CampaignResponseT&& value) {
    SetCampaignResponse(std::forward<CampaignResponseT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DeleteCampaignResult& WithRequestId(RequestIdT&& value) {
