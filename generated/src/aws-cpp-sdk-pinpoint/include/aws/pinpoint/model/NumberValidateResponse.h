...
class NumberValidateResponse {
 public:
  ...
  void SetCleansedPhoneNumberE164(CleansedPhoneNumberE164T&& value) {
    ...
    m_cleansedPhoneNumberE164 = std::forward<CleansedPhoneNumberE164T>(value);
  }
  template <typename CleansedPhoneNumberE164T = Aws::String>
  NumberValidateResponse& WithCleansedPhoneNumberE164(CleansedPhoneNumberE164T&& value) {
    SetCleansedPhoneNumberE164(std::forward<CleansedPhoneNumberE164T>(value));
    return *this;
  }
  ///@}
  ...
  void SetCleansedPhoneNumberNational(CleansedPhoneNumberNationalT&& value) {
    ...
    m_cleansedPhoneNumberNational = std::forward<CleansedPhoneNumberNationalT>(value);
  }
  template <typename CleansedPhoneNumberNationalT = Aws::String>
  NumberValidateResponse& WithCleansedPhoneNumberNational(CleansedPhoneNumberNationalT&& value) {
    SetCleansedPhoneNumberNational(std::forward<CleansedPhoneNumberNationalT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCountryCodeIso2(CountryCodeIso2T&& value) {
    ...
    m_countryCodeIso2 = std::forward<CountryCodeIso2T>(value);
  }
  template <typename CountryCodeIso2T = Aws::String>
  NumberValidateResponse& WithCountryCodeIso2(CountryCodeIso2T&& value) {
    SetCountryCodeIso2(std::forward<CountryCodeIso2T>(value));
    return *this;
  }
  ///@}
  ...
  void SetCountryCodeNumeric(CountryCodeNumericT&& value) {
    ...
    m_countryCodeNumeric = std::forward<CountryCodeNumericT>(value);
  }
  template <typename CountryCodeNumericT = Aws::String>
  NumberValidateResponse& WithCountryCodeNumeric(CountryCodeNumericT&& value) {
    SetCountryCodeNumeric(std::forward<CountryCodeNumericT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOriginalCountryCodeIso2(OriginalCountryCodeIso2T&& value) {
    ...
    m_originalCountryCodeIso2 = std::forward<OriginalCountryCodeIso2T>(value);
  }
  template <typename OriginalCountryCodeIso2T = Aws::String>
  NumberValidateResponse& WithOriginalCountryCodeIso2(OriginalCountryCodeIso2T&& value) {
    SetOriginalCountryCodeIso2(std::forward<OriginalCountryCodeIso2T>(value));
    return *this;
  }
  ///@}
  ...
  void SetPhoneType(PhoneTypeT&& value) {
    ...
    m_phoneType = std::forward<PhoneTypeT>(value);
  }
  template <typename PhoneTypeT = Aws::String>
  NumberValidateResponse& WithPhoneType(PhoneTypeT&& value) {
    SetPhoneType(std::forward<PhoneTypeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetPhoneTypeCode(int value) {
    m_phoneTypeCodeHasBeenSet = true;
    m_phoneTypeCode = value;
  }
  inline NumberValidateResponse& WithPhoneTypeCode(int value) {
    SetPhoneTypeCode(value);
    return *this;
  }
  ///@}
