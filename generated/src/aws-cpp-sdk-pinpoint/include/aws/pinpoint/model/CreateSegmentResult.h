...
namespace Model
{
  ...
  {
  public:
    AWS_PINPOINT_API CreateSegmentResult() = default;
    ...
    template<typename SegmentResponseT = SegmentResponse>
    CreateSegmentResult& WithSegmentResponse(SegmentResponseT&& value) { SetSegmentResponse(std::forward<SegmentResponseT>(value)); return *this;}
    ///@}
