...
class ListTemplateVersionsResult {
 public:
  ...
  void SetTemplateVersionsResponse(TemplateVersionsResponseT&& value) {
    m_templateVersionsResponseHasBeenSet = true;
    m_templateVersionsResponse = std::forward<TemplateVersionsResponseT>(value);
  }
  template <typename TemplateVersionsResponseT = TemplateVersionsResponse>
  ListTemplateVersionsResult& WithTemplateVersionsResponse(TemplateVersionsResponseT&& value) {
    SetTemplateVersionsResponse(std::forward<TemplateVersionsResponseT>(value));
    return *this;
  }
  ///@}
