...
namespace Model
{
  ...
  {
  public:
    AWS_PINPOINT_API GetInAppMessagesRequest() = default;
    ...
    template<typename ApplicationIdT = Aws::String>
    GetInAppMessagesRequest& WithApplicationId(ApplicationIdT&& value) { SetApplicationId(std::forward<ApplicationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename EndpointIdT = Aws::String>
    GetInAppMessagesRequest& WithEndpointId(EndpointIdT&& value) { SetEndpointId(std::forward<EndpointIdT>(value)); return *this;}
    ///@}
  private:
