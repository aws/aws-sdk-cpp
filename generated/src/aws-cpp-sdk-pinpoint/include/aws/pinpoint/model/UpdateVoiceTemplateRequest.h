...
class UpdateVoiceTemplateRequest : public PinpointRequest {
 public:
  ...
  inline UpdateVoiceTemplateRequest& WithCreateNewVersion(bool value) {
  ...
  template <typename TemplateNameT = Aws::String>
  UpdateVoiceTemplateRequest& WithTemplateName(TemplateNameT&& value) {
  ...
  template <typename VersionT = Aws::String>
  UpdateVoiceTemplateRequest& WithVersion(VersionT&& value) {
  ...
  template <typename VoiceTemplateRequestT = VoiceTemplateRequest>
  UpdateVoiceTemplateRequest& WithVoiceTemplateRequest(VoiceTemplateRequestT&& value) {
