...
namespace Model
{
  ...
  /**
   */
  class UpdateVoiceTemplateRequest : public PinpointRequest
  {
  public:
    AWS_PINPOINT_API UpdateVoiceTemplateRequest() = default;
    ...
    template<typename TemplateNameT = Aws::String>
    UpdateVoiceTemplateRequest& WithTemplateName(TemplateNameT&& value) { SetTemplateName(std::forward<TemplateNameT>(value)); return *this;}
    ///@}
    ...
    template<typename VersionT = Aws::String>
    UpdateVoiceTemplateRequest& WithVersion(VersionT&& value) { SetVersion(std::forward<VersionT>(value)); return *this;}
    ///@}
    ...
    template<typename VoiceTemplateRequestT = VoiceTemplateRequest>
    UpdateVoiceTemplateRequest& WithVoiceTemplateRequest(VoiceTemplateRequestT&& value) { SetVoiceTemplateRequest(std::forward<VoiceTemplateRequestT>(value)); return *this;}
    ///@}
  private:
