...
class CampaignDateRangeKpiResponse {
 public:
  ...
  template <typename ApplicationIdT = Aws::String>
  CampaignDateRangeKpiResponse& WithApplicationId(ApplicationIdT&& value) {
  ...
  template <typename CampaignIdT = Aws::String>
  CampaignDateRangeKpiResponse& WithCampaignId(CampaignIdT&& value) {
  ...
  template <typename EndTimeT = Aws::Utils::DateTime>
  CampaignDateRangeKpiResponse& WithEndTime(EndTimeT&& value) {
  ...
  template <typename KpiNameT = Aws::String>
  CampaignDateRangeKpiResponse& WithKpiName(KpiNameT&& value) {
  ...
  template <typename KpiResultT = BaseKpiResult>
  CampaignDateRangeKpiResponse& WithKpiResult(KpiResultT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  CampaignDateRangeKpiResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename StartTimeT = Aws::Utils::DateTime>
  CampaignDateRangeKpiResponse& WithStartTime(StartTimeT&& value) {
