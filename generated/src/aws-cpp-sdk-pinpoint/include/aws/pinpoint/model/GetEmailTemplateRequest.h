...
namespace Model
{
  ...
  /**
   */
  class GetEmailTemplateRequest : public PinpointRequest
  {
  public:
    AWS_PINPOINT_API GetEmailTemplateRequest() = default;
    ...
    template<typename TemplateNameT = Aws::String>
    GetEmailTemplateRequest& WithTemplateName(TemplateNameT&& value) { SetTemplateName(std::forward<TemplateNameT>(value)); return *this;}
    ///@}
    ...
    template<typename VersionT = Aws::String>
    GetEmailTemplateRequest& WithVersion(VersionT&& value) { SetVersion(std::forward<VersionT>(value)); return *this;}
    ///@}
  private:
