...
namespace Model
{
  ...
  /**
   */
  class GetCampaignActivitiesRequest : public PinpointRequest
  {
  public:
    AWS_PINPOINT_API GetCampaignActivitiesRequest() = default;
    ...
    template<typename ApplicationIdT = Aws::String>
    GetCampaignActivitiesRequest& WithApplicationId(ApplicationIdT&& value) { SetApplicationId(std::forward<ApplicationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename CampaignIdT = Aws::String>
    GetCampaignActivitiesRequest& WithCampaignId(CampaignIdT&& value) { SetCampaignId(std::forward<CampaignIdT>(value)); return *this;}
    ///@}
    ...
    template<typename PageSizeT = Aws::String>
    GetCampaignActivitiesRequest& WithPageSize(PageSizeT&& value) { SetPageSize(std::forward<PageSizeT>(value)); return *this;}
    ///@}
    ...
    template<typename TokenT = Aws::String>
    GetCampaignActivitiesRequest& WithToken(TokenT&& value) { SetToken(std::forward<TokenT>(value)); return *this;}
    ///@}
  private:
