...
class GetCampaignActivitiesRequest : public PinpointRequest {
 public:
  ...
  template <typename ApplicationIdT = Aws::String>
  GetCampaignActivitiesRequest& WithApplicationId(ApplicationIdT&& value) {
  ...
  template <typename CampaignIdT = Aws::String>
  GetCampaignActivitiesRequest& WithCampaignId(CampaignIdT&& value) {
  ...
  template <typename PageSizeT = Aws::String>
  GetCampaignActivitiesRequest& WithPageSize(PageSizeT&& value) {
  ...
  template <typename TokenT = Aws::String>
  GetCampaignActivitiesRequest& WithToken(TokenT&& value) {
