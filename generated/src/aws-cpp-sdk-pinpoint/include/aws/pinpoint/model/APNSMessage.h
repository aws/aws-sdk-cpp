...
class APNSMessage {
 public:
  ...
  void SetAPNSPushType(APNSPushTypeT&& value) {
    ...
    m_aPNSPushType = std::forward<APNSPushTypeT>(value);
  }
  template <typename APNSPushTypeT = Aws::String>
  APNSMessage& WithAPNSPushType(APNSPushTypeT&& value) {
    SetAPNSPushType(std::forward<APNSPushTypeT>(value));
    return *this;
  }
  ///@}
  ...
  inline APNSMessage& WithAction(Action value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  inline void SetBadge(int value) {
    m_badgeHasBeenSet = true;
    m_badge = value;
  }
  inline APNSMessage& WithBadge(int value) {
    SetBadge(value);
    return *this;
  }
  ///@}
  ...
  void SetCollapseId(CollapseIdT&& value) {
    ...
    m_collapseId = std::forward<CollapseIdT>(value);
  }
  template <typename CollapseIdT = Aws::String>
  APNSMessage& WithCollapseId(CollapseIdT&& value) {
    SetCollapseId(std::forward<CollapseIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPreferredAuthenticationMethod(PreferredAuthenticationMethodT&& value) {
    ...
    m_preferredAuthenticationMethod = std::forward<PreferredAuthenticationMethodT>(value);
  }
  template <typename PreferredAuthenticationMethodT = Aws::String>
  APNSMessage& WithPreferredAuthenticationMethod(PreferredAuthenticationMethodT&& value) {
    SetPreferredAuthenticationMethod(std::forward<PreferredAuthenticationMethodT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetSilentPush(bool value) {
    m_silentPushHasBeenSet = true;
    m_silentPush = value;
  }
  inline APNSMessage& WithSilentPush(bool value) {
    SetSilentPush(value);
    return *this;
  }
  ///@}
  ...
  void SetSubstitutions(SubstitutionsT&& value) {
    ...
    m_substitutions = std::forward<SubstitutionsT>(value);
  }
  template <typename SubstitutionsT = Aws::Map<Aws::String, Aws::Vector<Aws::String>>>
  APNSMessage& WithSubstitutions(SubstitutionsT&& value) {
    SetSubstitutions(std::forward<SubstitutionsT>(value));
    return *this;
  }
  ...
  APNSMessage& AddSubstitutions(SubstitutionsKeyT&& key, SubstitutionsValueT&& value) {
    m_substitutionsHasBeenSet = true;
    m_substitutions.emplace(std::forward<SubstitutionsKeyT>(key), std::forward<SubstitutionsValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetThreadId(ThreadIdT&& value) {
    ...
    m_threadId = std::forward<ThreadIdT>(value);
  }
  template <typename ThreadIdT = Aws::String>
  APNSMessage& WithThreadId(ThreadIdT&& value) {
    SetThreadId(std::forward<ThreadIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline APNSMessage& WithTimeToLive(int value) {
    SetTimeToLive(value);
    return *this;
  }
  ///@}
