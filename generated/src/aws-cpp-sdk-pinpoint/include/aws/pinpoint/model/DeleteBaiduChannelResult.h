...
class DeleteBaiduChannelResult {
 public:
  AWS_PINPOINT_API DeleteBaiduChannelResult() = default;
  ...
  void SetBaiduChannelResponse(BaiduChannelResponseT&& value) {
    m_baiduChannelResponseHasBeenSet = true;
    m_baiduChannelResponse = std::forward<BaiduChannelResponseT>(value);
  }
  template <typename BaiduChannelResponseT = BaiduChannelResponse>
  DeleteBaiduChannelResult& WithBaiduChannelResponse(BaiduChannelResponseT&& value) {
    SetBaiduChannelResponse(std::forward<BaiduChannelResponseT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DeleteBaiduChannelResult& WithRequestId(RequestIdT&& value) {
