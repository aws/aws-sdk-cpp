...
namespace Model
{
  ...
  public:
    ...
    inline DeletePushTemplateResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeletePushTemplateResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeletePushTemplateResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
