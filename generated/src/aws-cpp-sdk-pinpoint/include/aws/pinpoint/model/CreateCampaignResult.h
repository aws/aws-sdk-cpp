...
namespace Model
{
  ...
  {
  public:
    AWS_PINPOINT_API CreateCampaignResult() = default;
    ...
    template<typename CampaignResponseT = CampaignResponse>
    CreateCampaignResult& WithCampaignResponse(CampaignResponseT&& value) { SetCampaignResponse(std::forward<CampaignResponseT>(value)); return *this;}
    ///@}
