...
class WriteApplicationSettingsRequest {
 public:
  ...
  void SetCampaignHook(CampaignHookT&& value) {
    ...
    m_campaignHook = std::forward<CampaignHookT>(value);
  }
  template <typename CampaignHookT = CampaignHook>
  WriteApplicationSettingsRequest& WithCampaignHook(CampaignHookT&& value) {
    SetCampaignHook(std::forward<CampaignHookT>(value));
    return *this;
  }
  ///@}
  ...
  inline WriteApplicationSettingsRequest& WithCloudWatchMetricsEnabled(bool value) {
  ...
  inline void SetEventTaggingEnabled(bool value) {
    m_eventTaggingEnabledHasBeenSet = true;
    m_eventTaggingEnabled = value;
  }
  inline WriteApplicationSettingsRequest& WithEventTaggingEnabled(bool value) {
    SetEventTaggingEnabled(value);
    return *this;
  }
  ///@}
  ...
  void SetQuietTime(QuietTimeT&& value) {
    ...
    m_quietTime = std::forward<QuietTimeT>(value);
  }
  template <typename QuietTimeT = QuietTime>
  WriteApplicationSettingsRequest& WithQuietTime(QuietTimeT&& value) {
    SetQuietTime(std::forward<QuietTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetJourneyLimits(JourneyLimitsT&& value) {
    ...
    m_journeyLimits = std::forward<JourneyLimitsT>(value);
  }
  template <typename JourneyLimitsT = ApplicationSettingsJourneyLimits>
  WriteApplicationSettingsRequest& WithJourneyLimits(JourneyLimitsT&& value) {
    SetJourneyLimits(std::forward<JourneyLimitsT>(value));
    return *this;
  }
  ///@}
 private:
