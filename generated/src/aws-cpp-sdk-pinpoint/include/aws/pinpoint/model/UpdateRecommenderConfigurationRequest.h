...
class UpdateRecommenderConfigurationRequest : public PinpointRequest {
 public:
  ...
  void SetUpdateRecommenderConfiguration(UpdateRecommenderConfigurationT&& value) {
    m_updateRecommenderConfigurationHasBeenSet = true;
    m_updateRecommenderConfiguration = std::forward<UpdateRecommenderConfigurationT>(value);
  }
  template <typename UpdateRecommenderConfigurationT = UpdateRecommenderConfiguration>
  UpdateRecommenderConfigurationRequest& WithUpdateRecommenderConfiguration(UpdateRecommenderConfigurationT&& value) {
    SetUpdateRecommenderConfiguration(std::forward<UpdateRecommenderConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
