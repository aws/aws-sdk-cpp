...
class ApplicationsResponse {
 public:
  AWS_PINPOINT_API ApplicationsResponse() = default;
  ...
  template <typename ItemT = Aws::Vector<ApplicationResponse>>
  void SetItem(ItemT&& value) {
    m_itemHasBeenSet = true;
    m_item = std::forward<ItemT>(value);
  }
  template <typename ItemT = Aws::Vector<ApplicationResponse>>
  ApplicationsResponse& WithItem(ItemT&& value) {
    SetItem(std::forward<ItemT>(value));
    return *this;
  }
  template <typename ItemT = ApplicationResponse>
  ApplicationsResponse& AddItem(ItemT&& value) {
    m_itemHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ApplicationsResponse& WithNextToken(NextTokenT&& value) {
