...
namespace Model
{
  class UpdateVoiceTemplateResult
  {
  public:
    AWS_PINPOINT_API UpdateVoiceTemplateResult() = default;
    AWS_PINPOINT_API UpdateVoiceTemplateResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ...
    template<typename MessageBodyT = MessageBody>
    UpdateVoiceTemplateResult& WithMessageBody(MessageBodyT&& value) { SetMessageBody(std::forward<MessageBodyT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateVoiceTemplateResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
