...
class GetInAppTemplateResult {
 public:
  ...
  void SetInAppTemplateResponse(InAppTemplateResponseT&& value) {
    m_inAppTemplateResponseHasBeenSet = true;
    m_inAppTemplateResponse = std::forward<InAppTemplateResponseT>(value);
  }
  template <typename InAppTemplateResponseT = InAppTemplateResponse>
  GetInAppTemplateResult& WithInAppTemplateResponse(InAppTemplateResponseT&& value) {
    SetInAppTemplateResponse(std::forward<InAppTemplateResponseT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetInAppTemplateResult& WithRequestId(RequestIdT&& value) {
