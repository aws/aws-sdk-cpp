...
namespace Model
{
  ...
  public:
    ...
    template<typename GCMChannelResponseT = GCMChannelResponse>
    UpdateGcmChannelResult& WithGCMChannelResponse(GCMChannelResponseT&& value) { SetGCMChannelResponse(std::forward<GCMChannelResponseT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateGcmChannelResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
