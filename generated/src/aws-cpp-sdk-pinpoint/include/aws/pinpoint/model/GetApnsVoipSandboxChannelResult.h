...
class GetApnsVoipSandboxChannelResult {
 public:
  ...
  template <typename APNSVoipSandboxChannelResponseT = APNSVoipSandboxChannelResponse>
  GetApnsVoipSandboxChannelResult& WithAPNSVoipSandboxChannelResponse(APNSVoipSandboxChannelResponseT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetApnsVoipSandboxChannelResult& WithRequestId(RequestIdT&& value) {
