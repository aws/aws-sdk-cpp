...
class Event {
 public:
  ...
  void SetAppPackageName(AppPackageNameT&& value) {
    ...
    m_appPackageName = std::forward<AppPackageNameT>(value);
  }
  template <typename AppPackageNameT = Aws::String>
  Event& WithAppPackageName(AppPackageNameT&& value) {
    SetAppPackageName(std::forward<AppPackageNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAppTitle(AppTitleT&& value) {
    ...
    m_appTitle = std::forward<AppTitleT>(value);
  }
  template <typename AppTitleT = Aws::String>
  Event& WithAppTitle(AppTitleT&& value) {
    SetAppTitle(std::forward<AppTitleT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAppVersionCode(AppVersionCodeT&& value) {
    ...
    m_appVersionCode = std::forward<AppVersionCodeT>(value);
  }
  template <typename AppVersionCodeT = Aws::String>
  Event& WithAppVersionCode(AppVersionCodeT&& value) {
    SetAppVersionCode(std::forward<AppVersionCodeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetClientSdkVersion(ClientSdkVersionT&& value) {
    ...
    m_clientSdkVersion = std::forward<ClientSdkVersionT>(value);
  }
  template <typename ClientSdkVersionT = Aws::String>
  Event& WithClientSdkVersion(ClientSdkVersionT&& value) {
    SetClientSdkVersion(std::forward<ClientSdkVersionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSdkName(SdkNameT&& value) {
    ...
    m_sdkName = std::forward<SdkNameT>(value);
  }
  template <typename SdkNameT = Aws::String>
  Event& WithSdkName(SdkNameT&& value) {
    SetSdkName(std::forward<SdkNameT>(value));
    return *this;
  }
  ///@}
