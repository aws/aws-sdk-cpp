...
namespace Model
{
  ...
  public:
    ...
    template<typename AddressT = Aws::String>
    EndpointRequest& WithAddress(AddressT&& value) { SetAddress(std::forward<AddressT>(value)); return *this;}
    ///@}
    ...
    template<typename AttributesT = Aws::Map<Aws::String, Aws::Vector<Aws::String>>>
    EndpointRequest& WithAttributes(AttributesT&& value) { SetAttributes(std::forward<AttributesT>(value)); return *this;}
    ...
    inline EndpointRequest& WithChannelType(ChannelType value) { SetChannelType(value); return *this;}
    ///@}
    ...
    template<typename DemographicT = EndpointDemographic>
    EndpointRequest& WithDemographic(DemographicT&& value) { SetDemographic(std::forward<DemographicT>(value)); return *this;}
    ///@}
    ...
    template<typename EffectiveDateT = Aws::String>
    EndpointRequest& WithEffectiveDate(EffectiveDateT&& value) { SetEffectiveDate(std::forward<EffectiveDateT>(value)); return *this;}
    ///@}
    ...
    template<typename EndpointStatusT = Aws::String>
    EndpointRequest& WithEndpointStatus(EndpointStatusT&& value) { SetEndpointStatus(std::forward<EndpointStatusT>(value)); return *this;}
    ///@}
    ...
    template<typename LocationT = EndpointLocation>
    EndpointRequest& WithLocation(LocationT&& value) { SetLocation(std::forward<LocationT>(value)); return *this;}
    ///@}
    ...
    template<typename MetricsT = Aws::Map<Aws::String, double>>
    EndpointRequest& WithMetrics(MetricsT&& value) { SetMetrics(std::forward<MetricsT>(value)); return *this;}
    inline EndpointRequest& AddMetrics(Aws::String key, double value) {
    ...
    template<typename OptOutT = Aws::String>
    EndpointRequest& WithOptOut(OptOutT&& value) { SetOptOut(std::forward<OptOutT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    EndpointRequest& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
    ...
    template<typename UserT = EndpointUser>
    EndpointRequest& WithUser(UserT&& value) { SetUser(std::forward<UserT>(value)); return *this;}
    ///@}
  private:
