...
class APNSSandboxChannelResponse {
 public:
  AWS_PINPOINT_API APNSSandboxChannelResponse() = default;
  AWS_PINPOINT_API APNSSandboxChannelResponse(Aws::Utils::Json::JsonView jsonValue);
  AWS_PINPOINT_API APNSSandboxChannelResponse& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename ApplicationIdT = Aws::String>
  APNSSandboxChannelResponse& WithApplicationId(ApplicationIdT&& value) {
  ...
  template <typename CreationDateT = Aws::String>
  APNSSandboxChannelResponse& WithCreationDate(CreationDateT&& value) {
  ...
  template <typename DefaultAuthenticationMethodT = Aws::String>
  APNSSandboxChannelResponse& WithDefaultAuthenticationMethod(DefaultAuthenticationMethodT&& value) {
  ...
  inline APNSSandboxChannelResponse& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline APNSSandboxChannelResponse& WithHasCredential(bool value) {
  ...
  inline APNSSandboxChannelResponse& WithHasTokenKey(bool value) {
  ...
  template <typename IdT = Aws::String>
  APNSSandboxChannelResponse& WithId(IdT&& value) {
  ...
  inline APNSSandboxChannelResponse& WithIsArchived(bool value) {
    SetIsArchived(value);
    return *this;
  }
  ///@}
  ...
  template <typename LastModifiedByT = Aws::String>
  APNSSandboxChannelResponse& WithLastModifiedBy(LastModifiedByT&& value) {
  ...
  template <typename LastModifiedDateT = Aws::String>
  APNSSandboxChannelResponse& WithLastModifiedDate(LastModifiedDateT&& value) {
  ...
  template <typename PlatformT = Aws::String>
  APNSSandboxChannelResponse& WithPlatform(PlatformT&& value) {
  ...
  inline APNSSandboxChannelResponse& WithVersion(int value) {
    SetVersion(value);
    return *this;
  }
  ///@}
