...
class JourneyDateRangeKpiResponse {
 public:
  ...
  void SetKpiName(KpiNameT&& value) {
    ...
    m_kpiName = std::forward<KpiNameT>(value);
  }
  template <typename KpiNameT = Aws::String>
  JourneyDateRangeKpiResponse& WithKpiName(KpiNameT&& value) {
    SetKpiName(std::forward<KpiNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetKpiResult(KpiResultT&& value) {
    ...
    m_kpiResult = std::forward<KpiResultT>(value);
  }
  template <typename KpiResultT = BaseKpiResult>
  JourneyDateRangeKpiResponse& WithKpiResult(KpiResultT&& value) {
    SetKpiResult(std::forward<KpiResultT>(value));
    return *this;
  }
  ///@}
