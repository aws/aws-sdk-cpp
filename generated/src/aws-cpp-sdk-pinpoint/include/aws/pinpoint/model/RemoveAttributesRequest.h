...
class RemoveAttributesRequest : public PinpointRequest {
 public:
  ...
  void SetUpdateAttributesRequest(UpdateAttributesRequestT&& value) {
    m_updateAttributesRequestHasBeenSet = true;
    m_updateAttributesRequest = std::forward<UpdateAttributesRequestT>(value);
  }
  template <typename UpdateAttributesRequestT = UpdateAttributesRequest>
  RemoveAttributesRequest& WithUpdateAttributesRequest(UpdateAttributesRequestT&& value) {
    SetUpdateAttributesRequest(std::forward<UpdateAttributesRequestT>(value));
    return *this;
  }
  ///@}
 private:
