...
class ExportJobResponse {
 public:
  ...
  inline ExportJobResponse& WithCompletedPieces(int value) {
  ...
  inline ExportJobResponse& WithFailedPieces(int value) {
  ...
  inline ExportJobResponse& WithJobStatus(JobStatus value) {
    SetJobStatus(value);
    return *this;
  }
  ///@}
  ...
  inline ExportJobResponse& WithTotalFailures(int value) {
  ...
  inline ExportJobResponse& WithTotalPieces(int value) {
  ...
  inline ExportJobResponse& WithTotalProcessed(int value) {
