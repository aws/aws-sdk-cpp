...
class CreateTemplateMessageBody {
 public:
  ...
  template <typename ArnT = Aws::String>
  CreateTemplateMessageBody& WithArn(ArnT&& value) {
  ...
  template <typename MessageT = Aws::String>
  CreateTemplateMessageBody& WithMessage(MessageT&& value) {
  ...
  template <typename RequestIDT = Aws::String>
  CreateTemplateMessageBody& WithRequestID(RequestIDT&& value) {
