...
namespace Model
{
  ...
  public:
    ...
    template<typename ApplicationIdT = Aws::String>
    GetApplicationDateRangeKpiRequest& WithApplicationId(ApplicationIdT&& value) { SetApplicationId(std::forward<ApplicationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename EndTimeT = Aws::Utils::DateTime>
    GetApplicationDateRangeKpiRequest& WithEndTime(EndTimeT&& value) { SetEndTime(std::forward<EndTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename KpiNameT = Aws::String>
    GetApplicationDateRangeKpiRequest& WithKpiName(KpiNameT&& value) { SetKpiName(std::forward<KpiNameT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    GetApplicationDateRangeKpiRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename PageSizeT = Aws::String>
    GetApplicationDateRangeKpiRequest& WithPageSize(PageSizeT&& value) { SetPageSize(std::forward<PageSizeT>(value)); return *this;}
    ///@}
    ...
    template<typename StartTimeT = Aws::Utils::DateTime>
    GetApplicationDateRangeKpiRequest& WithStartTime(StartTimeT&& value) { SetStartTime(std::forward<StartTimeT>(value)); return *this;}
    ///@}
  private:
