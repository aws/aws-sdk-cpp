...
class Schedule {
 public:
  ...
  inline void SetFrequency(Frequency value) {
    m_frequencyHasBeenSet = true;
    m_frequency = value;
  }
  inline Schedule& WithFrequency(Frequency value) {
    SetFrequency(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIsLocalTime(bool value) {
    m_isLocalTimeHasBeenSet = true;
    m_isLocalTime = value;
  }
  inline Schedule& WithIsLocalTime(bool value) {
