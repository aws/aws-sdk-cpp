...
namespace Model
{
  ...
  {
  public:
    AWS_PINPOINT_API DeleteInAppTemplateResult() = default;
    ...
    template<typename MessageBodyT = MessageBody>
    DeleteInAppTemplateResult& WithMessageBody(MessageBodyT&& value) { SetMessageBody(std::forward<MessageBodyT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DeleteInAppTemplateResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
