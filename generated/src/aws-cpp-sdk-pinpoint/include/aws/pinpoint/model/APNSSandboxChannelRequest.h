...
class APNSSandboxChannelRequest {
 public:
  ...
  template <typename BundleIdT = Aws::String>
  APNSSandboxChannelRequest& WithBundleId(BundleIdT&& value) {
  ...
  template <typename CertificateT = Aws::String>
  APNSSandboxChannelRequest& WithCertificate(CertificateT&& value) {
  ...
  template <typename DefaultAuthenticationMethodT = Aws::String>
  APNSSandboxChannelRequest& WithDefaultAuthenticationMethod(DefaultAuthenticationMethodT&& value) {
  ...
  inline APNSSandboxChannelRequest& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  template <typename PrivateKeyT = Aws::String>
  APNSSandboxChannelRequest& WithPrivateKey(PrivateKeyT&& value) {
  ...
  template <typename TeamIdT = Aws::String>
  APNSSandboxChannelRequest& WithTeamId(TeamIdT&& value) {
  ...
  void SetTokenKey(TokenKeyT&& value) {
    ...
    m_tokenKey = std::forward<TokenKeyT>(value);
  }
  template <typename TokenKeyT = Aws::String>
  APNSSandboxChannelRequest& WithTokenKey(TokenKeyT&& value) {
    SetTokenKey(std::forward<TokenKeyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTokenKeyId(TokenKeyIdT&& value) {
    ...
    m_tokenKeyId = std::forward<TokenKeyIdT>(value);
  }
  template <typename TokenKeyIdT = Aws::String>
  APNSSandboxChannelRequest& WithTokenKeyId(TokenKeyIdT&& value) {
    SetTokenKeyId(std::forward<TokenKeyIdT>(value));
    return *this;
  }
  ///@}
 private:
