...
class GetCampaignVersionRequest : public PinpointRequest {
 public:
  ...
  template <typename ApplicationIdT = Aws::String>
  GetCampaignVersionRequest& WithApplicationId(ApplicationIdT&& value) {
  ...
  template <typename CampaignIdT = Aws::String>
  GetCampaignVersionRequest& WithCampaignId(CampaignIdT&& value) {
  ...
  template <typename VersionT = Aws::String>
  GetCampaignVersionRequest& WithVersion(VersionT&& value) {
