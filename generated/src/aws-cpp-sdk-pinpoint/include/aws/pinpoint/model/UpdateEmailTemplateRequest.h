...
namespace Model
{
  ...
  public:
    ...
    template<typename EmailTemplateRequestT = EmailTemplateRequest>
    UpdateEmailTemplateRequest& WithEmailTemplateRequest(EmailTemplateRequestT&& value) { SetEmailTemplateRequest(std::forward<EmailTemplateRequestT>(value)); return *this;}
    ///@}
    ...
    template<typename VersionT = Aws::String>
    UpdateEmailTemplateRequest& WithVersion(VersionT&& value) { SetVersion(std::forward<VersionT>(value)); return *this;}
    ///@}
  private:
