...
class UpdateEmailTemplateRequest : public PinpointRequest {
 public:
  AWS_PINPOINT_API UpdateEmailTemplateRequest() = default;
  ...
  inline UpdateEmailTemplateRequest& WithCreateNewVersion(bool value) {
  ...
  void SetEmailTemplateRequest(EmailTemplateRequestT&& value) {
    m_emailTemplateRequestHasBeenSet = true;
    m_emailTemplateRequest = std::forward<EmailTemplateRequestT>(value);
  }
  template <typename EmailTemplateRequestT = EmailTemplateRequest>
  UpdateEmailTemplateRequest& WithEmailTemplateRequest(EmailTemplateRequestT&& value) {
    SetEmailTemplateRequest(std::forward<EmailTemplateRequestT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TemplateNameT = Aws::String>
  UpdateEmailTemplateRequest& WithTemplateName(TemplateNameT&& value) {
  ...
  template <typename VersionT = Aws::String>
  UpdateEmailTemplateRequest& WithVersion(VersionT&& value) {
