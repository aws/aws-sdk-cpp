...
class CreateInAppTemplateResult {
 public:
  ...
  void SetTemplateCreateMessageBody(TemplateCreateMessageBodyT&& value) {
    m_templateCreateMessageBodyHasBeenSet = true;
    m_templateCreateMessageBody = std::forward<TemplateCreateMessageBodyT>(value);
  }
  template <typename TemplateCreateMessageBodyT = TemplateCreateMessageBody>
  CreateInAppTemplateResult& WithTemplateCreateMessageBody(TemplateCreateMessageBodyT&& value) {
    SetTemplateCreateMessageBody(std::forward<TemplateCreateMessageBodyT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  CreateInAppTemplateResult& WithRequestId(RequestIdT&& value) {
