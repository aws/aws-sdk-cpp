...
class DeleteApnsSandboxChannelResult {
 public:
  ...
  template <typename APNSSandboxChannelResponseT = APNSSandboxChannelResponse>
  DeleteApnsSandboxChannelResult& WithAPNSSandboxChannelResponse(APNSSandboxChannelResponseT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteApnsSandboxChannelResult& WithRequestId(RequestIdT&& value) {
