...
class UpdateTemplateActiveVersionRequest : public PinpointRequest {
 public:
  ...
  void SetTemplateActiveVersionRequest(TemplateActiveVersionRequestT&& value) {
    m_templateActiveVersionRequestHasBeenSet = true;
    m_templateActiveVersionRequest = std::forward<TemplateActiveVersionRequestT>(value);
  }
  template <typename TemplateActiveVersionRequestT = TemplateActiveVersionRequest>
  UpdateTemplateActiveVersionRequest& WithTemplateActiveVersionRequest(TemplateActiveVersionRequestT&& value) {
    SetTemplateActiveVersionRequest(std::forward<TemplateActiveVersionRequestT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TemplateNameT = Aws::String>
  UpdateTemplateActiveVersionRequest& WithTemplateName(TemplateNameT&& value) {
  ...
  template <typename TemplateTypeT = Aws::String>
  UpdateTemplateActiveVersionRequest& WithTemplateType(TemplateTypeT&& value) {
