...
class GetCampaignActivitiesResult {
 public:
  ...
  void SetActivitiesResponse(ActivitiesResponseT&& value) {
    m_activitiesResponseHasBeenSet = true;
    m_activitiesResponse = std::forward<ActivitiesResponseT>(value);
  }
  template <typename ActivitiesResponseT = ActivitiesResponse>
  GetCampaignActivitiesResult& WithActivitiesResponse(ActivitiesResponseT&& value) {
    SetActivitiesResponse(std::forward<ActivitiesResponseT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetCampaignActivitiesResult& WithRequestId(RequestIdT&& value) {
