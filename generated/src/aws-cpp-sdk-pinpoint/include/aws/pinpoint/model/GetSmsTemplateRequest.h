...
namespace Model
{
  ...
  /**
   */
  class GetSmsTemplateRequest : public PinpointRequest
  {
  public:
    AWS_PINPOINT_API GetSmsTemplateRequest() = default;
    ...
    template<typename TemplateNameT = Aws::String>
    GetSmsTemplateRequest& WithTemplateName(TemplateNameT&& value) { SetTemplateName(std::forward<TemplateNameT>(value)); return *this;}
    ///@}
    ...
    template<typename VersionT = Aws::String>
    GetSmsTemplateRequest& WithVersion(VersionT&& value) { SetVersion(std::forward<VersionT>(value)); return *this;}
    ///@}
  private:
