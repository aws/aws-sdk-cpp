...
class UpdateApnsVoipChannelRequest : public PinpointRequest {
 public:
  ...
  void SetAPNSVoipChannelRequest(APNSVoipChannelRequestT&& value) {
    m_aPNSVoipChannelRequestHasBeenSet = true;
    m_aPNSVoipChannelRequest = std::forward<APNSVoipChannelRequestT>(value);
  }
  template <typename APNSVoipChannelRequestT = APNSVoipChannelRequest>
  UpdateApnsVoipChannelRequest& WithAPNSVoipChannelRequest(APNSVoipChannelRequestT&& value) {
    SetAPNSVoipChannelRequest(std::forward<APNSVoipChannelRequestT>(value));
    return *this;
  }
  ///@}
