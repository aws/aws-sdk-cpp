...
class CreateImportJobResult {
 public:
  ...
  void SetImportJobResponse(ImportJobResponseT&& value) {
    m_importJobResponseHasBeenSet = true;
    m_importJobResponse = std::forward<ImportJobResponseT>(value);
  }
  template <typename ImportJobResponseT = ImportJobResponse>
  CreateImportJobResult& WithImportJobResponse(ImportJobResponseT&& value) {
    SetImportJobResponse(std::forward<ImportJobResponseT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  CreateImportJobResult& WithRequestId(RequestIdT&& value) {
