...
class SegmentResponse {
 public:
  ...
  void SetImportDefinition(ImportDefinitionT&& value) {
    ...
    m_importDefinition = std::forward<ImportDefinitionT>(value);
  }
  template <typename ImportDefinitionT = SegmentImportResource>
  SegmentResponse& WithImportDefinition(ImportDefinitionT&& value) {
    SetImportDefinition(std::forward<ImportDefinitionT>(value));
    return *this;
  }
  ///@}
  ...
  inline SegmentResponse& WithSegmentType(SegmentType value) {
  ...
  inline SegmentResponse& WithVersion(int value) {
    SetVersion(value);
    return *this;
  }
  ///@}
