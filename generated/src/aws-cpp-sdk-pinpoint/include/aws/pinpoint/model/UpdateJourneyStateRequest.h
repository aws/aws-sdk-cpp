...
class UpdateJourneyStateRequest : public PinpointRequest {
 public:
  ...
  void SetJourneyStateRequest(JourneyStateRequestT&& value) {
    m_journeyStateRequestHasBeenSet = true;
    m_journeyStateRequest = std::forward<JourneyStateRequestT>(value);
  }
  template <typename JourneyStateRequestT = JourneyStateRequest>
  UpdateJourneyStateRequest& WithJourneyStateRequest(JourneyStateRequestT&& value) {
    SetJourneyStateRequest(std::forward<JourneyStateRequestT>(value));
    return *this;
  }
  ///@}
 private:
