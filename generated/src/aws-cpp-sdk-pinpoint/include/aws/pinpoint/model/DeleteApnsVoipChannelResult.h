...
class DeleteApnsVoipChannelResult {
 public:
  ...
  void SetAPNSVoipChannelResponse(APNSVoipChannelResponseT&& value) {
    m_aPNSVoipChannelResponseHasBeenSet = true;
    m_aPNSVoipChannelResponse = std::forward<APNSVoipChannelResponseT>(value);
  }
  template <typename APNSVoipChannelResponseT = APNSVoipChannelResponse>
  DeleteApnsVoipChannelResult& WithAPNSVoipChannelResponse(APNSVoipChannelResponseT&& value) {
    SetAPNSVoipChannelResponse(std::forward<APNSVoipChannelResponseT>(value));
    return *this;
  }
  ///@}
