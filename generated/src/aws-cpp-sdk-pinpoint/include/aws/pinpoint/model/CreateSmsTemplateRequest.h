...
class CreateSmsTemplateRequest : public PinpointRequest {
 public:
  ...
  void SetSMSTemplateRequest(SMSTemplateRequestT&& value) {
    m_sMSTemplateRequestHasBeenSet = true;
    m_sMSTemplateRequest = std::forward<SMSTemplateRequestT>(value);
  }
  template <typename SMSTemplateRequestT = SMSTemplateRequest>
  CreateSmsTemplateRequest& WithSMSTemplateRequest(SMSTemplateRequestT&& value) {
    SetSMSTemplateRequest(std::forward<SMSTemplateRequestT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TemplateNameT = Aws::String>
  CreateSmsTemplateRequest& WithTemplateName(TemplateNameT&& value) {
