...
class SendUsersMessagesResult {
 public:
  ...
  void SetSendUsersMessageResponse(SendUsersMessageResponseT&& value) {
    m_sendUsersMessageResponseHasBeenSet = true;
    m_sendUsersMessageResponse = std::forward<SendUsersMessageResponseT>(value);
  }
  template <typename SendUsersMessageResponseT = SendUsersMessageResponse>
  SendUsersMessagesResult& WithSendUsersMessageResponse(SendUsersMessageResponseT&& value) {
    SetSendUsersMessageResponse(std::forward<SendUsersMessageResponseT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  SendUsersMessagesResult& WithRequestId(RequestIdT&& value) {
