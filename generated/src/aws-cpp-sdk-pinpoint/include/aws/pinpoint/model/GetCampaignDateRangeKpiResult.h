...
class GetCampaignDateRangeKpiResult {
 public:
  ...
  void SetCampaignDateRangeKpiResponse(CampaignDateRangeKpiResponseT&& value) {
    m_campaignDateRangeKpiResponseHasBeenSet = true;
    m_campaignDateRangeKpiResponse = std::forward<CampaignDateRangeKpiResponseT>(value);
  }
  template <typename CampaignDateRangeKpiResponseT = CampaignDateRangeKpiResponse>
  GetCampaignDateRangeKpiResult& WithCampaignDateRangeKpiResponse(CampaignDateRangeKpiResponseT&& value) {
    SetCampaignDateRangeKpiResponse(std::forward<CampaignDateRangeKpiResponseT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetCampaignDateRangeKpiResult& WithRequestId(RequestIdT&& value) {
