...
class CreateRecommenderConfigurationRequest : public PinpointRequest {
 public:
  ...
  void SetCreateRecommenderConfiguration(CreateRecommenderConfigurationT&& value) {
    m_createRecommenderConfigurationHasBeenSet = true;
    m_createRecommenderConfiguration = std::forward<CreateRecommenderConfigurationT>(value);
  }
  template <typename CreateRecommenderConfigurationT = CreateRecommenderConfiguration>
  CreateRecommenderConfigurationRequest& WithCreateRecommenderConfiguration(CreateRecommenderConfigurationT&& value) {
    SetCreateRecommenderConfiguration(std::forward<CreateRecommenderConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
