...
class APNSVoipChannelResponse {
 public:
  AWS_PINPOINT_API APNSVoipChannelResponse() = default;
  AWS_PINPOINT_API APNSVoipChannelResponse(Aws::Utils::Json::JsonView jsonValue);
  AWS_PINPOINT_API APNSVoipChannelResponse& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename ApplicationIdT = Aws::String>
  APNSVoipChannelResponse& WithApplicationId(ApplicationIdT&& value) {
  ...
  template <typename CreationDateT = Aws::String>
  APNSVoipChannelResponse& WithCreationDate(CreationDateT&& value) {
  ...
  void SetDefaultAuthenticationMethod(DefaultAuthenticationMethodT&& value) {
    ...
    m_defaultAuthenticationMethod = std::forward<DefaultAuthenticationMethodT>(value);
  }
  template <typename DefaultAuthenticationMethodT = Aws::String>
  APNSVoipChannelResponse& WithDefaultAuthenticationMethod(DefaultAuthenticationMethodT&& value) {
    SetDefaultAuthenticationMethod(std::forward<DefaultAuthenticationMethodT>(value));
    return *this;
  }
  ///@}
  ...
  inline APNSVoipChannelResponse& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline void SetHasCredential(bool value) {
    m_hasCredentialHasBeenSet = true;
    m_hasCredential = value;
  }
  inline APNSVoipChannelResponse& WithHasCredential(bool value) {
  ...
  inline void SetHasTokenKey(bool value) {
    m_hasTokenKeyHasBeenSet = true;
    m_hasTokenKey = value;
  }
  inline APNSVoipChannelResponse& WithHasTokenKey(bool value) {
    SetHasTokenKey(value);
    return *this;
  }
  ///@}
  ...
  template <typename IdT = Aws::String>
  APNSVoipChannelResponse& WithId(IdT&& value) {
  ...
  inline APNSVoipChannelResponse& WithIsArchived(bool value) {
    SetIsArchived(value);
    return *this;
  }
  ///@}
  ...
  template <typename LastModifiedByT = Aws::String>
  APNSVoipChannelResponse& WithLastModifiedBy(LastModifiedByT&& value) {
  ...
  template <typename LastModifiedDateT = Aws::String>
  APNSVoipChannelResponse& WithLastModifiedDate(LastModifiedDateT&& value) {
  ...
  template <typename PlatformT = Aws::String>
  APNSVoipChannelResponse& WithPlatform(PlatformT&& value) {
  ...
  inline APNSVoipChannelResponse& WithVersion(int value) {
    SetVersion(value);
    return *this;
  }
  ///@}
