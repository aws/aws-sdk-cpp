...
class UpdateApnsChannelRequest : public PinpointRequest {
 public:
  ...
  void SetAPNSChannelRequest(APNSChannelRequestT&& value) {
    m_aPNSChannelRequestHasBeenSet = true;
    m_aPNSChannelRequest = std::forward<APNSChannelRequestT>(value);
  }
  template <typename APNSChannelRequestT = APNSChannelRequest>
  UpdateApnsChannelRequest& WithAPNSChannelRequest(APNSChannelRequestT&& value) {
    SetAPNSChannelRequest(std::forward<APNSChannelRequestT>(value));
    return *this;
  }
  ///@}
