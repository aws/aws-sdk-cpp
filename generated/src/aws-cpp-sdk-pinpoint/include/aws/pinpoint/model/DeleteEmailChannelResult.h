...
class DeleteEmailChannelResult {
 public:
  ...
  void SetEmailChannelResponse(EmailChannelResponseT&& value) {
    m_emailChannelResponseHasBeenSet = true;
    m_emailChannelResponse = std::forward<EmailChannelResponseT>(value);
  }
  template <typename EmailChannelResponseT = EmailChannelResponse>
  DeleteEmailChannelResult& WithEmailChannelResponse(EmailChannelResponseT&& value) {
    SetEmailChannelResponse(std::forward<EmailChannelResponseT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DeleteEmailChannelResult& WithRequestId(RequestIdT&& value) {
