...
class GetSmsTemplateResult {
 public:
  ...
  void SetSMSTemplateResponse(SMSTemplateResponseT&& value) {
    m_sMSTemplateResponseHasBeenSet = true;
    m_sMSTemplateResponse = std::forward<SMSTemplateResponseT>(value);
  }
  template <typename SMSTemplateResponseT = SMSTemplateResponse>
  GetSmsTemplateResult& WithSMSTemplateResponse(SMSTemplateResponseT&& value) {
    SetSMSTemplateResponse(std::forward<SMSTemplateResponseT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetSmsTemplateResult& WithRequestId(RequestIdT&& value) {
