...
class TemplateConfiguration {
 public:
  ...
  void SetEmailTemplate(EmailTemplateT&& value) {
    ...
    m_emailTemplate = std::forward<EmailTemplateT>(value);
  }
  template <typename EmailTemplateT = Template>
  TemplateConfiguration& WithEmailTemplate(EmailTemplateT&& value) {
    SetEmailTemplate(std::forward<EmailTemplateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPushTemplate(PushTemplateT&& value) {
    ...
    m_pushTemplate = std::forward<PushTemplateT>(value);
  }
  template <typename PushTemplateT = Template>
  TemplateConfiguration& WithPushTemplate(PushTemplateT&& value) {
    SetPushTemplate(std::forward<PushTemplateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSMSTemplate(SMSTemplateT&& value) {
    ...
    m_sMSTemplate = std::forward<SMSTemplateT>(value);
  }
  template <typename SMSTemplateT = Template>
  TemplateConfiguration& WithSMSTemplate(SMSTemplateT&& value) {
    SetSMSTemplate(std::forward<SMSTemplateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVoiceTemplate(VoiceTemplateT&& value) {
    ...
    m_voiceTemplate = std::forward<VoiceTemplateT>(value);
  }
  template <typename VoiceTemplateT = Template>
  TemplateConfiguration& WithVoiceTemplate(VoiceTemplateT&& value) {
    SetVoiceTemplate(std::forward<VoiceTemplateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInAppTemplate(InAppTemplateT&& value) {
    ...
    m_inAppTemplate = std::forward<InAppTemplateT>(value);
  }
  template <typename InAppTemplateT = Template>
  TemplateConfiguration& WithInAppTemplate(InAppTemplateT&& value) {
    SetInAppTemplate(std::forward<InAppTemplateT>(value));
    return *this;
  }
  ///@}
 private:
