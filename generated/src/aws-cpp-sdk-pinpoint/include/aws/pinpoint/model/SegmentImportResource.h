...
class SegmentImportResource {
 public:
  ...
  void SetChannelCounts(ChannelCountsT&& value) {
    ...
    m_channelCounts = std::forward<ChannelCountsT>(value);
  }
  template <typename ChannelCountsT = Aws::Map<Aws::String, int>>
  SegmentImportResource& WithChannelCounts(ChannelCountsT&& value) {
    SetChannelCounts(std::forward<ChannelCountsT>(value));
    return *this;
  }
  inline SegmentImportResource& AddChannelCounts(Aws::String key, int value) {
    m_channelCountsHasBeenSet = true;
    m_channelCounts.emplace(key, value);
    return *this;
  }
  ///@}
  ...
  inline SegmentImportResource& WithFormat(Format value) {
    SetFormat(value);
    return *this;
  }
  ///@}
  ...
  inline SegmentImportResource& WithSize(int value) {
    SetSize(value);
    return *this;
  }
  ///@}
