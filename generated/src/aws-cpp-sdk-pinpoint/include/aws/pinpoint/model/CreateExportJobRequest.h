...
class CreateExportJobRequest : public PinpointRequest {
 public:
  ...
  template <typename ApplicationIdT = Aws::String>
  CreateExportJobRequest& WithApplicationId(ApplicationIdT&& value) {
  ...
  void SetExportJobRequest(ExportJobRequestT&& value) {
    m_exportJobRequestHasBeenSet = true;
    m_exportJobRequest = std::forward<ExportJobRequestT>(value);
  }
  template <typename ExportJobRequestT = ExportJobRequest>
  CreateExportJobRequest& WithExportJobRequest(ExportJobRequestT&& value) {
    SetExportJobRequest(std::forward<ExportJobRequestT>(value));
    return *this;
  }
  ///@}
 private:
