...
namespace Model
{
   ...
   * Notification service) VoIP sandbox channel for an application.</p><p><h3>See
   * Also:</h3>   <a
  ...
  {
  public:
    AWS_PINPOINT_API APNSVoipSandboxChannelResponse() = default;
    AWS_PINPOINT_API APNSVoipSandboxChannelResponse(Aws::Utils::Json::JsonView jsonValue);
    AWS_PINPOINT_API APNSVoipSandboxChannelResponse& operator=(Aws::Utils::Json::JsonView jsonValue);
    AWS_PINPOINT_API Aws::Utils::Json::JsonValue Jsonize() const;


    ///@{
    /**
     * <p>The unique identifier for the application that the APNs VoIP sandbox channel
     * applies to.</p>
     */
    ...
    template<typename ApplicationIdT = Aws::String>
    APNSVoipSandboxChannelResponse& WithApplicationId(ApplicationIdT&& value) { SetApplicationId(std::forward<ApplicationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename CreationDateT = Aws::String>
    APNSVoipSandboxChannelResponse& WithCreationDate(CreationDateT&& value) { SetCreationDate(std::forward<CreationDateT>(value)); return *this;}
    ///@}
    ...
    template<typename DefaultAuthenticationMethodT = Aws::String>
    APNSVoipSandboxChannelResponse& WithDefaultAuthenticationMethod(DefaultAuthenticationMethodT&& value) { SetDefaultAuthenticationMethod(std::forward<DefaultAuthenticationMethodT>(value)); return *this;}
    ///@}
    ...
    ///@{
    /**
     * <p>Specifies whether the APNs VoIP sandbox channel is configured to communicate
     * with APNs by using APNs tokens. To provide an authentication key for APNs
     * tokens, set the TokenKey property of the channel.</p>
     */
    ...
    ///@{
    /**
     * <p>(Deprecated) An identifier for the APNs VoIP sandbox channel. This property
     * is retained only for backward compatibility.</p>
     */
    ...
    template<typename IdT = Aws::String>
    APNSVoipSandboxChannelResponse& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename LastModifiedByT = Aws::String>
    APNSVoipSandboxChannelResponse& WithLastModifiedBy(LastModifiedByT&& value) { SetLastModifiedBy(std::forward<LastModifiedByT>(value)); return *this;}
    ///@}
    ...
    template<typename LastModifiedDateT = Aws::String>
    APNSVoipSandboxChannelResponse& WithLastModifiedDate(LastModifiedDateT&& value) { SetLastModifiedDate(std::forward<LastModifiedDateT>(value)); return *this;}
    ///@}

    ///@{
    /**
     * <p>The type of messaging or notification platform for the channel. For the APNs
     * VoIP sandbox channel, this value is APNS_VOIP_SANDBOX.</p>
     */
    ...
    template<typename PlatformT = Aws::String>
    APNSVoipSandboxChannelResponse& WithPlatform(PlatformT&& value) { SetPlatform(std::forward<PlatformT>(value)); return *this;}
    ///@}
