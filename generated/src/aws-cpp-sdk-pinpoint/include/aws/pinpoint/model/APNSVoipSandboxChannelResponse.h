...
class APNSVoipSandboxChannelResponse {
 public:
  ...
  template <typename ApplicationIdT = Aws::String>
  APNSVoipSandboxChannelResponse& WithApplicationId(ApplicationIdT&& value) {
  ...
  template <typename CreationDateT = Aws::String>
  APNSVoipSandboxChannelResponse& WithCreationDate(CreationDateT&& value) {
  ...
  template <typename DefaultAuthenticationMethodT = Aws::String>
  APNSVoipSandboxChannelResponse& WithDefaultAuthenticationMethod(DefaultAuthenticationMethodT&& value) {
  ...
  inline APNSVoipSandboxChannelResponse& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline APNSVoipSandboxChannelResponse& WithHasCredential(bool value) {
  ...
  inline APNSVoipSandboxChannelResponse& WithHasTokenKey(bool value) {
  ...
  template <typename IdT = Aws::String>
  APNSVoipSandboxChannelResponse& WithId(IdT&& value) {
  ...
  inline APNSVoipSandboxChannelResponse& WithIsArchived(bool value) {
    SetIsArchived(value);
    return *this;
  }
  ///@}
  ...
  template <typename LastModifiedByT = Aws::String>
  APNSVoipSandboxChannelResponse& WithLastModifiedBy(LastModifiedByT&& value) {
  ...
  template <typename LastModifiedDateT = Aws::String>
  APNSVoipSandboxChannelResponse& WithLastModifiedDate(LastModifiedDateT&& value) {
  ...
  template <typename PlatformT = Aws::String>
  APNSVoipSandboxChannelResponse& WithPlatform(PlatformT&& value) {
  ...
  inline APNSVoipSandboxChannelResponse& WithVersion(int value) {
    SetVersion(value);
    return *this;
  }
  ///@}
