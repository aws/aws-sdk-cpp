...
namespace Model
{
  ...
  {
  public:
    AWS_PINPOINT_API UpdateCampaignResult() = default;
    ...
    template<typename CampaignResponseT = CampaignResponse>
    UpdateCampaignResult& WithCampaignResponse(CampaignResponseT&& value) { SetCampaignResponse(std::forward<CampaignResponseT>(value)); return *this;}
    ///@}
