...
class UpdateJourneyStateResult {
 public:
  AWS_PINPOINT_API UpdateJourneyStateResult() = default;
  ...
  void SetJourneyResponse(JourneyResponseT&& value) {
    m_journeyResponseHasBeenSet = true;
    m_journeyResponse = std::forward<JourneyResponseT>(value);
  }
  template <typename JourneyResponseT = JourneyResponse>
  UpdateJourneyStateResult& WithJourneyResponse(JourneyResponseT&& value) {
    SetJourneyResponse(std::forward<JourneyResponseT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  UpdateJourneyStateResult& WithRequestId(RequestIdT&& value) {
