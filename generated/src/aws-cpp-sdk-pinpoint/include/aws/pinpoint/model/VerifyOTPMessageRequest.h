...
class VerifyOTPMessageRequest : public PinpointRequest {
 public:
  ...
  template <typename ApplicationIdT = Aws::String>
  VerifyOTPMessageRequest& WithApplicationId(ApplicationIdT&& value) {
  ...
  inline const VerifyOTPMessageRequestParameters& GetVerifyOTPMessageRequestParameters() const {
    return m_verifyOTPMessageRequestParameters;
  }
  ...
  void SetVerifyOTPMessageRequestParameters(VerifyOTPMessageRequestParametersT&& value) {
    m_verifyOTPMessageRequestParametersHasBeenSet = true;
    m_verifyOTPMessageRequestParameters = std::forward<VerifyOTPMessageRequestParametersT>(value);
  }
  template <typename VerifyOTPMessageRequestParametersT = VerifyOTPMessageRequestParameters>
  VerifyOTPMessageRequest& WithVerifyOTPMessageRequestParameters(VerifyOTPMessageRequestParametersT&& value) {
    SetVerifyOTPMessageRequestParameters(std::forward<VerifyOTPMessageRequestParametersT>(value));
    return *this;
  }
  ///@}
 private:
