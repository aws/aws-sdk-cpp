...
class AddressConfiguration {
 public:
  ...
  void SetBodyOverride(BodyOverrideT&& value) {
    ...
    m_bodyOverride = std::forward<BodyOverrideT>(value);
  }
  template <typename BodyOverrideT = Aws::String>
  AddressConfiguration& WithBodyOverride(BodyOverrideT&& value) {
    SetBodyOverride(std::forward<BodyOverrideT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetChannelType(ChannelType value) {
    m_channelTypeHasBeenSet = true;
    m_channelType = value;
  }
  inline AddressConfiguration& WithChannelType(ChannelType value) {
  ...
  void SetTitleOverride(TitleOverrideT&& value) {
    ...
    m_titleOverride = std::forward<TitleOverrideT>(value);
  }
  template <typename TitleOverrideT = Aws::String>
  AddressConfiguration& WithTitleOverride(TitleOverrideT&& value) {
    SetTitleOverride(std::forward<TitleOverrideT>(value));
    return *this;
  }
  ///@}
 private:
