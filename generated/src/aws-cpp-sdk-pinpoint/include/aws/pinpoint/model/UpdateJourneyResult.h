...
namespace Model
{
  ...
  {
  public:
    AWS_PINPOINT_API UpdateJourneyResult() = default;
    ...
    template<typename JourneyResponseT = JourneyResponse>
    UpdateJourneyResult& WithJourneyResponse(JourneyResponseT&& value) { SetJourneyResponse(std::forward<JourneyResponseT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateJourneyResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
