...
namespace Model
{
  ...
  public:
    ...
    inline UpdateJourneyResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateJourneyResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateJourneyResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
