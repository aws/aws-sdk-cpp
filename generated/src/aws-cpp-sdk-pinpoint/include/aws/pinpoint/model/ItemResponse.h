...
class ItemResponse {
 public:
  ...
  void SetEndpointItemResponse(EndpointItemResponseT&& value) {
    ...
    m_endpointItemResponse = std::forward<EndpointItemResponseT>(value);
  }
  template <typename EndpointItemResponseT = EndpointItemResponse>
  ItemResponse& WithEndpointItemResponse(EndpointItemResponseT&& value) {
    SetEndpointItemResponse(std::forward<EndpointItemResponseT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEventsItemResponse(EventsItemResponseT&& value) {
    ...
    m_eventsItemResponse = std::forward<EventsItemResponseT>(value);
  }
  template <typename EventsItemResponseT = Aws::Map<Aws::String, EventItemResponse>>
  ItemResponse& WithEventsItemResponse(EventsItemResponseT&& value) {
    SetEventsItemResponse(std::forward<EventsItemResponseT>(value));
    return *this;
  }
  ...
  ItemResponse& AddEventsItemResponse(EventsItemResponseKeyT&& key, EventsItemResponseValueT&& value) {
    m_eventsItemResponseHasBeenSet = true;
    m_eventsItemResponse.emplace(std::forward<EventsItemResponseKeyT>(key), std::forward<EventsItemResponseValueT>(value));
    return *this;
  }
  ///@}
 private:
