...
namespace Model
{
  ...
  public:
    ...
    template<typename ItemT = Aws::Vector<SegmentResponse>>
    SegmentsResponse& WithItem(ItemT&& value) { SetItem(std::forward<ItemT>(value)); return *this;}
    template<typename ItemT = SegmentResponse>
    SegmentsResponse& AddItem(ItemT&& value) { m_itemHasBeenSet = true; m_item.emplace_back(std::forward<ItemT>(value)); return *this; }
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    SegmentsResponse& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
