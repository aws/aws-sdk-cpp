...
class PhoneNumberValidateRequest : public PinpointRequest {
 public:
  ...
  void SetNumberValidateRequest(NumberValidateRequestT&& value) {
    m_numberValidateRequestHasBeenSet = true;
    m_numberValidateRequest = std::forward<NumberValidateRequestT>(value);
  }
  template <typename NumberValidateRequestT = NumberValidateRequest>
  PhoneNumberValidateRequest& WithNumberValidateRequest(NumberValidateRequestT&& value) {
    SetNumberValidateRequest(std::forward<NumberValidateRequestT>(value));
    return *this;
  }
  ///@}
 private:
