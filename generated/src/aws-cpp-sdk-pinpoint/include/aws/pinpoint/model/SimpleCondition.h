...
class SimpleCondition {
 public:
  ...
  void SetEventCondition(EventConditionT&& value) {
    ...
    m_eventCondition = std::forward<EventConditionT>(value);
  }
  template <typename EventConditionT = EventCondition>
  SimpleCondition& WithEventCondition(EventConditionT&& value) {
    SetEventCondition(std::forward<EventConditionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSegmentCondition(SegmentConditionT&& value) {
    ...
    m_segmentCondition = std::forward<SegmentConditionT>(value);
  }
  template <typename SegmentConditionT = SegmentCondition>
  SimpleCondition& WithSegmentCondition(SegmentConditionT&& value) {
    SetSegmentCondition(std::forward<SegmentConditionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSegmentDimensions(SegmentDimensionsT&& value) {
    ...
    m_segmentDimensions = std::forward<SegmentDimensionsT>(value);
  }
  template <typename SegmentDimensionsT = SegmentDimensions>
  SimpleCondition& WithSegmentDimensions(SegmentDimensionsT&& value) {
    SetSegmentDimensions(std::forward<SegmentDimensionsT>(value));
    return *this;
  }
  ///@}
 private:
