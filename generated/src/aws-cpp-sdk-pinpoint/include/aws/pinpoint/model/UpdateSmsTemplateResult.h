...
namespace Model
{
  ...
  {
  public:
    AWS_PINPOINT_API UpdateSmsTemplateResult() = default;
    ...
    template<typename MessageBodyT = MessageBody>
    UpdateSmsTemplateResult& WithMessageBody(MessageBodyT&& value) { SetMessageBody(std::forward<MessageBodyT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateSmsTemplateResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
