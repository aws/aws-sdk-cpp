...
class VerifyOTPMessageResult {
 public:
  ...
  void SetVerificationResponse(VerificationResponseT&& value) {
    m_verificationResponseHasBeenSet = true;
    m_verificationResponse = std::forward<VerificationResponseT>(value);
  }
  template <typename VerificationResponseT = VerificationResponse>
  VerifyOTPMessageResult& WithVerificationResponse(VerificationResponseT&& value) {
    SetVerificationResponse(std::forward<VerificationResponseT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  VerifyOTPMessageResult& WithRequestId(RequestIdT&& value) {
