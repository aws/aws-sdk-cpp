...
class WriteCampaignRequest {
 public:
  ...
  inline WriteCampaignRequest& WithHoldoutPercent(int value) {
  ...
  inline WriteCampaignRequest& WithIsPaused(bool value) {
    SetIsPaused(value);
    return *this;
  }
  ///@}
  ...
  inline WriteCampaignRequest& WithSegmentVersion(int value) {
  ...
  inline WriteCampaignRequest& WithPriority(int value) {
    SetPriority(value);
    return *this;
  }
  ///@}
