...
class MultiConditionalSplitActivity {
 public:
  ...
  template <typename BranchesT = Aws::Vector<MultiConditionalBranch>>
  MultiConditionalSplitActivity& WithBranches(BranchesT&& value) {
    SetBranches(std::forward<BranchesT>(value));
    return *this;
  }
  template <typename BranchesT = MultiConditionalBranch>
  MultiConditionalSplitActivity& AddBranches(BranchesT&& value) {
    m_branchesHasBeenSet = true;
  ...
  void SetDefaultActivity(DefaultActivityT&& value) {
    m_defaultActivityHasBeenSet = true;
    m_defaultActivity = std::forward<DefaultActivityT>(value);
  }
  template <typename DefaultActivityT = Aws::String>
  MultiConditionalSplitActivity& WithDefaultActivity(DefaultActivityT&& value) {
    SetDefaultActivity(std::forward<DefaultActivityT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEvaluationWaitTime(EvaluationWaitTimeT&& value) {
    ...
    m_evaluationWaitTime = std::forward<EvaluationWaitTimeT>(value);
  }
  template <typename EvaluationWaitTimeT = WaitTime>
  MultiConditionalSplitActivity& WithEvaluationWaitTime(EvaluationWaitTimeT&& value) {
    SetEvaluationWaitTime(std::forward<EvaluationWaitTimeT>(value));
    return *this;
  }
  ///@}
 private:
