...
class UpdateEndpointsBatchRequest : public PinpointRequest {
 public:
  ...
  template <typename ApplicationIdT = Aws::String>
  UpdateEndpointsBatchRequest& WithApplicationId(ApplicationIdT&& value) {
  ...
  void SetEndpointBatchRequest(EndpointBatchRequestT&& value) {
    m_endpointBatchRequestHasBeenSet = true;
    m_endpointBatchRequest = std::forward<EndpointBatchRequestT>(value);
  }
  template <typename EndpointBatchRequestT = EndpointBatchRequest>
  UpdateEndpointsBatchRequest& WithEndpointBatchRequest(EndpointBatchRequestT&& value) {
    SetEndpointBatchRequest(std::forward<EndpointBatchRequestT>(value));
    return *this;
  }
  ///@}
 private:
