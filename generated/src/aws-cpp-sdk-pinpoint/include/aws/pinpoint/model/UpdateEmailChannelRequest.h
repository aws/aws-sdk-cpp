...
class UpdateEmailChannelRequest : public PinpointRequest {
 public:
  ...
  template <typename ApplicationIdT = Aws::String>
  UpdateEmailChannelRequest& WithApplicationId(ApplicationIdT&& value) {
  ...
  void SetEmailChannelRequest(EmailChannelRequestT&& value) {
    m_emailChannelRequestHasBeenSet = true;
    m_emailChannelRequest = std::forward<EmailChannelRequestT>(value);
  }
  template <typename EmailChannelRequestT = EmailChannelRequest>
  UpdateEmailChannelRequest& WithEmailChannelRequest(EmailChannelRequestT&& value) {
    SetEmailChannelRequest(std::forward<EmailChannelRequestT>(value));
    return *this;
  }
  ///@}
 private:
