...
class SendMessagesRequest : public PinpointRequest {
 public:
  ...
  template <typename ApplicationIdT = Aws::String>
  SendMessagesRequest& WithApplicationId(ApplicationIdT&& value) {
  ...
  void SetMessageRequest(MessageRequestT&& value) {
    m_messageRequestHasBeenSet = true;
    m_messageRequest = std::forward<MessageRequestT>(value);
  }
  template <typename MessageRequestT = MessageRequest>
  SendMessagesRequest& WithMessageRequest(MessageRequestT&& value) {
    SetMessageRequest(std::forward<MessageRequestT>(value));
    return *this;
  }
  ///@}
 private:
