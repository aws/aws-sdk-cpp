...
class UpdateSegmentRequest : public PinpointRequest {
 public:
  ...
  template <typename ApplicationIdT = Aws::String>
  UpdateSegmentRequest& WithApplicationId(ApplicationIdT&& value) {
  ...
  template <typename SegmentIdT = Aws::String>
  UpdateSegmentRequest& WithSegmentId(SegmentIdT&& value) {
  ...
  template <typename WriteSegmentRequestT = WriteSegmentRequest>
  UpdateSegmentRequest& WithWriteSegmentRequest(WriteSegmentRequestT&& value) {
