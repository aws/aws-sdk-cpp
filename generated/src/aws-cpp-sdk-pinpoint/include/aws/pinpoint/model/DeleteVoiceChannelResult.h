...
class DeleteVoiceChannelResult {
 public:
  ...
  void SetVoiceChannelResponse(VoiceChannelResponseT&& value) {
    m_voiceChannelResponseHasBeenSet = true;
    m_voiceChannelResponse = std::forward<VoiceChannelResponseT>(value);
  }
  template <typename VoiceChannelResponseT = VoiceChannelResponse>
  DeleteVoiceChannelResult& WithVoiceChannelResponse(VoiceChannelResponseT&& value) {
    SetVoiceChannelResponse(std::forward<VoiceChannelResponseT>(value));
    return *this;
  }
  ///@}
