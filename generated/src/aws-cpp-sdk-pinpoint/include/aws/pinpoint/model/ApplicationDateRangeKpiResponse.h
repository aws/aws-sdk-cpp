...
namespace Model
{
  ...
  public:
    ...
    template<typename ApplicationIdT = Aws::String>
    ApplicationDateRangeKpiResponse& WithApplicationId(ApplicationIdT&& value) { SetApplicationId(std::forward<ApplicationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename EndTimeT = Aws::Utils::DateTime>
    ApplicationDateRangeKpiResponse& WithEndTime(EndTimeT&& value) { SetEndTime(std::forward<EndTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename KpiNameT = Aws::String>
    ApplicationDateRangeKpiResponse& WithKpiName(KpiNameT&& value) { SetKpiName(std::forward<KpiNameT>(value)); return *this;}
    ///@}
    ...
    template<typename KpiResultT = BaseKpiResult>
    ApplicationDateRangeKpiResponse& WithKpiResult(KpiResultT&& value) { SetKpiResult(std::forward<KpiResultT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ApplicationDateRangeKpiResponse& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename StartTimeT = Aws::Utils::DateTime>
    ApplicationDateRangeKpiResponse& WithStartTime(StartTimeT&& value) { SetStartTime(std::forward<StartTimeT>(value)); return *this;}
    ///@}
  private:
