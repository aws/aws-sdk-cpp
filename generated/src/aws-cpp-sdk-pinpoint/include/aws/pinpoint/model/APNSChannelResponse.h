...
class APNSChannelResponse {
 public:
  ...
  template <typename ApplicationIdT = Aws::String>
  APNSChannelResponse& WithApplicationId(ApplicationIdT&& value) {
  ...
  template <typename CreationDateT = Aws::String>
  APNSChannelResponse& WithCreationDate(CreationDateT&& value) {
  ...
  template <typename DefaultAuthenticationMethodT = Aws::String>
  APNSChannelResponse& WithDefaultAuthenticationMethod(DefaultAuthenticationMethodT&& value) {
  ...
  inline APNSChannelResponse& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline APNSChannelResponse& WithHasCredential(bool value) {
  ...
  inline APNSChannelResponse& WithHasTokenKey(bool value) {
  ...
  template <typename IdT = Aws::String>
  APNSChannelResponse& WithId(IdT&& value) {
  ...
  inline APNSChannelResponse& WithIsArchived(bool value) {
    SetIsArchived(value);
    return *this;
  }
  ///@}
  ...
  template <typename LastModifiedByT = Aws::String>
  APNSChannelResponse& WithLastModifiedBy(LastModifiedByT&& value) {
  ...
  template <typename LastModifiedDateT = Aws::String>
  APNSChannelResponse& WithLastModifiedDate(LastModifiedDateT&& value) {
  ...
  template <typename PlatformT = Aws::String>
  APNSChannelResponse& WithPlatform(PlatformT&& value) {
  ...
  inline APNSChannelResponse& WithVersion(int value) {
    SetVersion(value);
    return *this;
  }
  ///@}
