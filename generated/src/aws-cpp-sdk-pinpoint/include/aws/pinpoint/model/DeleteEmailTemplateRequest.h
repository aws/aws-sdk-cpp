...
namespace Model
{
  ...
  /**
   */
  class DeleteEmailTemplateRequest : public PinpointRequest
  {
  public:
    AWS_PINPOINT_API DeleteEmailTemplateRequest() = default;
    ...
    template<typename VersionT = Aws::String>
    DeleteEmailTemplateRequest& WithVersion(VersionT&& value) { SetVersion(std::forward<VersionT>(value)); return *this;}
    ///@}
  private:
