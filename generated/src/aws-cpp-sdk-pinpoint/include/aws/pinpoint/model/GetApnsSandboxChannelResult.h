...
class GetApnsSandboxChannelResult {
 public:
  ...
  template <typename APNSSandboxChannelResponseT = APNSSandboxChannelResponse>
  GetApnsSandboxChannelResult& WithAPNSSandboxChannelResponse(APNSSandboxChannelResponseT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetApnsSandboxChannelResult& WithRequestId(RequestIdT&& value) {
