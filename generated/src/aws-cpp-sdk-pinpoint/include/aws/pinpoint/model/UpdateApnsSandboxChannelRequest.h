...
class UpdateApnsSandboxChannelRequest : public PinpointRequest {
 public:
  ...
  void SetAPNSSandboxChannelRequest(APNSSandboxChannelRequestT&& value) {
    m_aPNSSandboxChannelRequestHasBeenSet = true;
    m_aPNSSandboxChannelRequest = std::forward<APNSSandboxChannelRequestT>(value);
  }
  template <typename APNSSandboxChannelRequestT = APNSSandboxChannelRequest>
  UpdateApnsSandboxChannelRequest& WithAPNSSandboxChannelRequest(APNSSandboxChannelRequestT&& value) {
    SetAPNSSandboxChannelRequest(std::forward<APNSSandboxChannelRequestT>(value));
    return *this;
  }
  ///@}
