...
class ImportJobResource {
 public:
  ...
  inline void SetDefineSegment(bool value) {
    m_defineSegmentHasBeenSet = true;
    m_defineSegment = value;
  }
  inline ImportJobResource& WithDefineSegment(bool value) {
    SetDefineSegment(value);
    return *this;
  }
  ///@}
  ...
  inline ImportJobResource& WithFormat(Format value) {
    SetFormat(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRegisterEndpoints(bool value) {
    m_registerEndpointsHasBeenSet = true;
    m_registerEndpoints = value;
  }
  inline ImportJobResource& WithRegisterEndpoints(bool value) {
    SetRegisterEndpoints(value);
    return *this;
  }
  ///@}
