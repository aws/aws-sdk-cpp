...
class PutEventStreamRequest : public PinpointRequest {
 public:
  ...
  template <typename ApplicationIdT = Aws::String>
  PutEventStreamRequest& WithApplicationId(ApplicationIdT&& value) {
  ...
  void SetWriteEventStream(WriteEventStreamT&& value) {
    m_writeEventStreamHasBeenSet = true;
    m_writeEventStream = std::forward<WriteEventStreamT>(value);
  }
  template <typename WriteEventStreamT = WriteEventStream>
  PutEventStreamRequest& WithWriteEventStream(WriteEventStreamT&& value) {
    SetWriteEventStream(std::forward<WriteEventStreamT>(value));
    return *this;
  }
  ///@}
 private:
