...
class EventCondition {
 public:
  ...
  template <typename DimensionsT = EventDimensions>
  EventCondition& WithDimensions(DimensionsT&& value) {
  ...
  void SetMessageActivity(MessageActivityT&& value) {
    m_messageActivityHasBeenSet = true;
    m_messageActivity = std::forward<MessageActivityT>(value);
  }
  template <typename MessageActivityT = Aws::String>
  EventCondition& WithMessageActivity(MessageActivityT&& value) {
    SetMessageActivity(std::forward<MessageActivityT>(value));
    return *this;
  }
  ///@}
 private:
