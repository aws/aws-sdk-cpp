...
class DefaultButtonConfiguration {
 public:
  ...
  inline void SetBorderRadius(int value) {
    m_borderRadiusHasBeenSet = true;
    m_borderRadius = value;
  }
  inline DefaultButtonConfiguration& WithBorderRadius(int value) {
  ...
  inline void SetButtonAction(ButtonAction value) {
    m_buttonActionHasBeenSet = true;
    m_buttonAction = value;
  }
  inline DefaultButtonConfiguration& WithButtonAction(ButtonAction value) {
