...
namespace Model
{
  ...
  /**
   */
  class GetVoiceTemplateRequest : public PinpointRequest
  {
  public:
    AWS_PINPOINT_API GetVoiceTemplateRequest() = default;
    ...
    template<typename TemplateNameT = Aws::String>
    GetVoiceTemplateRequest& WithTemplateName(TemplateNameT&& value) { SetTemplateName(std::forward<TemplateNameT>(value)); return *this;}
    ///@}
    ...
    template<typename VersionT = Aws::String>
    GetVoiceTemplateRequest& WithVersion(VersionT&& value) { SetVersion(std::forward<VersionT>(value)); return *this;}
    ///@}
  private:
