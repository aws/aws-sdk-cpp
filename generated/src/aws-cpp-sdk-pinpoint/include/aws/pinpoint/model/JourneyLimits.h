...
class JourneyLimits {
 public:
  ...
  inline JourneyLimits& WithDailyCap(int value) {
    SetDailyCap(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEndpointReentryCap(int value) {
    m_endpointReentryCapHasBeenSet = true;
    m_endpointReentryCap = value;
  }
  inline JourneyLimits& WithEndpointReentryCap(int value) {
    SetEndpointReentryCap(value);
    return *this;
  }
  ///@}
  ...
  inline JourneyLimits& WithMessagesPerSecond(int value) {
  ...
  void SetEndpointReentryInterval(EndpointReentryIntervalT&& value) {
    ...
    m_endpointReentryInterval = std::forward<EndpointReentryIntervalT>(value);
  }
  template <typename EndpointReentryIntervalT = Aws::String>
  JourneyLimits& WithEndpointReentryInterval(EndpointReentryIntervalT&& value) {
    SetEndpointReentryInterval(std::forward<EndpointReentryIntervalT>(value));
    return *this;
  }
  ///@}
  ...
  inline JourneyLimits& WithTotalCap(int value) {
    SetTotalCap(value);
    return *this;
  }
  ///@}
