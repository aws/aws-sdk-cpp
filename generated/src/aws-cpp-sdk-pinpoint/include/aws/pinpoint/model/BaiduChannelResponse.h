...
class BaiduChannelResponse {
 public:
  ...
  inline BaiduChannelResponse& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline BaiduChannelResponse& WithHasCredential(bool value) {
  ...
  inline BaiduChannelResponse& WithIsArchived(bool value) {
    SetIsArchived(value);
    return *this;
  }
  ///@}
  ...
  inline BaiduChannelResponse& WithVersion(int value) {
    SetVersion(value);
    return *this;
  }
  ///@}
