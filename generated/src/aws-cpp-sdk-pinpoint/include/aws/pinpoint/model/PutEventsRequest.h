...
class PutEventsRequest : public PinpointRequest {
 public:
  ...
  template <typename ApplicationIdT = Aws::String>
  PutEventsRequest& WithApplicationId(ApplicationIdT&& value) {
  ...
  void SetEventsRequest(EventsRequestT&& value) {
    m_eventsRequestHasBeenSet = true;
    m_eventsRequest = std::forward<EventsRequestT>(value);
  }
  template <typename EventsRequestT = EventsRequest>
  PutEventsRequest& WithEventsRequest(EventsRequestT&& value) {
    SetEventsRequest(std::forward<EventsRequestT>(value));
    return *this;
  }
  ///@}
 private:
