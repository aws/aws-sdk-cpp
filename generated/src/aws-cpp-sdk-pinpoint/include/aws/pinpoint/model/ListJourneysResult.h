...
class ListJourneysResult {
 public:
  ...
  void SetJourneysResponse(JourneysResponseT&& value) {
    m_journeysResponseHasBeenSet = true;
    m_journeysResponse = std::forward<JourneysResponseT>(value);
  }
  template <typename JourneysResponseT = JourneysResponse>
  ListJourneysResult& WithJourneysResponse(JourneysResponseT&& value) {
    SetJourneysResponse(std::forward<JourneysResponseT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListJourneysResult& WithRequestId(RequestIdT&& value) {
