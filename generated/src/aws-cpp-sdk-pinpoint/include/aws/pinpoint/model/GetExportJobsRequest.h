...
class GetExportJobsRequest : public PinpointRequest {
 public:
  ...
  template <typename ApplicationIdT = Aws::String>
  GetExportJobsRequest& WithApplicationId(ApplicationIdT&& value) {
  ...
  template <typename PageSizeT = Aws::String>
  GetExportJobsRequest& WithPageSize(PageSizeT&& value) {
  ...
  template <typename TokenT = Aws::String>
  GetExportJobsRequest& WithToken(TokenT&& value) {
