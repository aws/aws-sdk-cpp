...
namespace Model
{
  ...
  /**
   */
  class GetExportJobsRequest : public PinpointRequest
  {
  public:
    AWS_PINPOINT_API GetExportJobsRequest() = default;
    ...
    template<typename ApplicationIdT = Aws::String>
    GetExportJobsRequest& WithApplicationId(ApplicationIdT&& value) { SetApplicationId(std::forward<ApplicationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename PageSizeT = Aws::String>
    GetExportJobsRequest& WithPageSize(PageSizeT&& value) { SetPageSize(std::forward<PageSizeT>(value)); return *this;}
    ///@}
    ...
    template<typename TokenT = Aws::String>
    GetExportJobsRequest& WithToken(TokenT&& value) { SetToken(std::forward<TokenT>(value)); return *this;}
    ///@}
  private:
