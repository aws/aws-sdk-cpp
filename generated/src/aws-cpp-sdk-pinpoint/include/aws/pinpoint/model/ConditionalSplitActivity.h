...
class ConditionalSplitActivity {
 public:
  ...
  void SetFalseActivity(FalseActivityT&& value) {
    ...
    m_falseActivity = std::forward<FalseActivityT>(value);
  }
  template <typename FalseActivityT = Aws::String>
  ConditionalSplitActivity& WithFalseActivity(FalseActivityT&& value) {
    SetFalseActivity(std::forward<FalseActivityT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTrueActivity(TrueActivityT&& value) {
    ...
    m_trueActivity = std::forward<TrueActivityT>(value);
  }
  template <typename TrueActivityT = Aws::String>
  ConditionalSplitActivity& WithTrueActivity(TrueActivityT&& value) {
    SetTrueActivity(std::forward<TrueActivityT>(value));
    return *this;
  }
  ///@}
 private:
