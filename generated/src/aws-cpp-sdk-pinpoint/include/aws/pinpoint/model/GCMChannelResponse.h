...
class GCMChannelResponse {
 public:
  ...
  inline GCMChannelResponse& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline GCMChannelResponse& WithHasCredential(bool value) {
  ...
  inline void SetHasFcmServiceCredentials(bool value) {
    m_hasFcmServiceCredentialsHasBeenSet = true;
    m_hasFcmServiceCredentials = value;
  }
  inline GCMChannelResponse& WithHasFcmServiceCredentials(bool value) {
    SetHasFcmServiceCredentials(value);
    return *this;
  }
  ///@}
  ...
  inline GCMChannelResponse& WithIsArchived(bool value) {
    SetIsArchived(value);
    return *this;
  }
  ///@}
  ...
  inline GCMChannelResponse& WithVersion(int value) {
    SetVersion(value);
    return *this;
  }
  ///@}
