...
class RemoveAttributesResult {
 public:
  ...
  void SetAttributesResource(AttributesResourceT&& value) {
    m_attributesResourceHasBeenSet = true;
    m_attributesResource = std::forward<AttributesResourceT>(value);
  }
  template <typename AttributesResourceT = AttributesResource>
  RemoveAttributesResult& WithAttributesResource(AttributesResourceT&& value) {
    SetAttributesResource(std::forward<AttributesResourceT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  RemoveAttributesResult& WithRequestId(RequestIdT&& value) {
