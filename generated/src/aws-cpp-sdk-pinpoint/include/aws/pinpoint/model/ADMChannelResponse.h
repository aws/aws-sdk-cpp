...
class ADMChannelResponse {
 public:
  ...
  inline ADMChannelResponse& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline ADMChannelResponse& WithHasCredential(bool value) {
  ...
  inline ADMChannelResponse& WithIsArchived(bool value) {
    SetIsArchived(value);
    return *this;
  }
  ///@}
  ...
  inline ADMChannelResponse& WithVersion(int value) {
    SetVersion(value);
    return *this;
  }
  ///@}
