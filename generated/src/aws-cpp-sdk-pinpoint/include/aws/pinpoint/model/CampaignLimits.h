...
class CampaignLimits {
 public:
  ...
  inline void SetDaily(int value) {
    m_dailyHasBeenSet = true;
    m_daily = value;
  }
  inline CampaignLimits& WithDaily(int value) {
    SetDaily(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaximumDuration(int value) {
    m_maximumDurationHasBeenSet = true;
    m_maximumDuration = value;
  }
  inline CampaignLimits& WithMaximumDuration(int value) {
  ...
  inline void SetMessagesPerSecond(int value) {
    m_messagesPerSecondHasBeenSet = true;
    m_messagesPerSecond = value;
  }
  inline CampaignLimits& WithMessagesPerSecond(int value) {
  ...
  inline CampaignLimits& WithTotal(int value) {
    SetTotal(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSession(int value) {
    m_sessionHasBeenSet = true;
    m_session = value;
  }
  inline CampaignLimits& WithSession(int value) {
    SetSession(value);
    return *this;
  }
  ///@}
