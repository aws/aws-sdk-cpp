...
class ChannelResponse {
 public:
  ...
  inline ChannelResponse& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline ChannelResponse& WithHasCredential(bool value) {
  ...
  inline ChannelResponse& WithIsArchived(bool value) {
    SetIsArchived(value);
    return *this;
  }
  ///@}
  ...
  inline ChannelResponse& WithVersion(int value) {
    SetVersion(value);
    return *this;
  }
  ///@}
