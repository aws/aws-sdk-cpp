...
class GetRecommenderConfigurationResult {
 public:
  ...
  template <typename RecommenderConfigurationResponseT = RecommenderConfigurationResponse>
  GetRecommenderConfigurationResult& WithRecommenderConfigurationResponse(RecommenderConfigurationResponseT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetRecommenderConfigurationResult& WithRequestId(RequestIdT&& value) {
