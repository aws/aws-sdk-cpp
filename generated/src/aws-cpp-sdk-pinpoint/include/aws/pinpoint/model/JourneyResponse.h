...
class JourneyResponse {
 public:
  ...
  JourneyResponse& AddActivities(ActivitiesKeyT&& key, ActivitiesValueT&& value) {
    m_activitiesHasBeenSet = true;
    m_activities.emplace(std::forward<ActivitiesKeyT>(key), std::forward<ActivitiesValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetLocalTime(bool value) {
    m_localTimeHasBeenSet = true;
    m_localTime = value;
  }
  inline JourneyResponse& WithLocalTime(bool value) {
    SetLocalTime(value);
    return *this;
  }
  ///@}
  ...
  void SetRefreshFrequency(RefreshFrequencyT&& value) {
    ...
    m_refreshFrequency = std::forward<RefreshFrequencyT>(value);
  }
  template <typename RefreshFrequencyT = Aws::String>
  JourneyResponse& WithRefreshFrequency(RefreshFrequencyT&& value) {
    SetRefreshFrequency(std::forward<RefreshFrequencyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStartActivity(StartActivityT&& value) {
    ...
    m_startActivity = std::forward<StartActivityT>(value);
  }
  template <typename StartActivityT = Aws::String>
  JourneyResponse& WithStartActivity(StartActivityT&& value) {
    SetStartActivity(std::forward<StartActivityT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStartCondition(StartConditionT&& value) {
    ...
    m_startCondition = std::forward<StartConditionT>(value);
  }
  template <typename StartConditionT = StartCondition>
  JourneyResponse& WithStartCondition(StartConditionT&& value) {
    SetStartCondition(std::forward<StartConditionT>(value));
    return *this;
  }
  ///@}
  ...
  inline JourneyResponse& WithState(State value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline void SetWaitForQuietTime(bool value) {
    m_waitForQuietTimeHasBeenSet = true;
    m_waitForQuietTime = value;
  }
  inline JourneyResponse& WithWaitForQuietTime(bool value) {
    SetWaitForQuietTime(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRefreshOnSegmentUpdate(bool value) {
    m_refreshOnSegmentUpdateHasBeenSet = true;
    m_refreshOnSegmentUpdate = value;
  }
  inline JourneyResponse& WithRefreshOnSegmentUpdate(bool value) {
    SetRefreshOnSegmentUpdate(value);
    return *this;
  }
  ///@}
  ...
  void SetJourneyChannelSettings(JourneyChannelSettingsT&& value) {
    ...
    m_journeyChannelSettings = std::forward<JourneyChannelSettingsT>(value);
  }
  template <typename JourneyChannelSettingsT = JourneyChannelSettings>
  JourneyResponse& WithJourneyChannelSettings(JourneyChannelSettingsT&& value) {
    SetJourneyChannelSettings(std::forward<JourneyChannelSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetSendingSchedule(bool value) {
    m_sendingScheduleHasBeenSet = true;
    m_sendingSchedule = value;
  }
  inline JourneyResponse& WithSendingSchedule(bool value) {
  ...
  void SetClosedDays(ClosedDaysT&& value) {
    ...
    m_closedDays = std::forward<ClosedDaysT>(value);
  }
  template <typename ClosedDaysT = ClosedDays>
  JourneyResponse& WithClosedDays(ClosedDaysT&& value) {
    SetClosedDays(std::forward<ClosedDaysT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTimezoneEstimationMethods(TimezoneEstimationMethodsT&& value) {
    ...
    m_timezoneEstimationMethods = std::forward<TimezoneEstimationMethodsT>(value);
  }
  template <typename TimezoneEstimationMethodsT = Aws::Vector<__TimezoneEstimationMethodsElement>>
  JourneyResponse& WithTimezoneEstimationMethods(TimezoneEstimationMethodsT&& value) {
    SetTimezoneEstimationMethods(std::forward<TimezoneEstimationMethodsT>(value));
    return *this;
  }
  inline JourneyResponse& AddTimezoneEstimationMethods(__TimezoneEstimationMethodsElement value) {
    m_timezoneEstimationMethodsHasBeenSet = true;
    m_timezoneEstimationMethods.push_back(value);
    return *this;
  }
  ///@}
 private:
