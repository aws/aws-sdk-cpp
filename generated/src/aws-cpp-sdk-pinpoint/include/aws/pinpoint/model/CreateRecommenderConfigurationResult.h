...
class CreateRecommenderConfigurationResult {
 public:
  ...
  template <typename RecommenderConfigurationResponseT = RecommenderConfigurationResponse>
  CreateRecommenderConfigurationResult& WithRecommenderConfigurationResponse(RecommenderConfigurationResponseT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateRecommenderConfigurationResult& WithRequestId(RequestIdT&& value) {
