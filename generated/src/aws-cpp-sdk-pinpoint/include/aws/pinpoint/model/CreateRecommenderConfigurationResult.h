...
namespace Model
{
  ...
  {
  public:
    AWS_PINPOINT_API CreateRecommenderConfigurationResult();
    ...
    inline CreateRecommenderConfigurationResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline CreateRecommenderConfigurationResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline CreateRecommenderConfigurationResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
