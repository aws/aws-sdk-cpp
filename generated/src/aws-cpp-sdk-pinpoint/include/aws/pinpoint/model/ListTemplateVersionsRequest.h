...
class ListTemplateVersionsRequest : public PinpointRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListTemplateVersionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename PageSizeT = Aws::String>
  ListTemplateVersionsRequest& WithPageSize(PageSizeT&& value) {
  ...
  template <typename TemplateNameT = Aws::String>
  ListTemplateVersionsRequest& WithTemplateName(TemplateNameT&& value) {
  ...
  template <typename TemplateTypeT = Aws::String>
  ListTemplateVersionsRequest& WithTemplateType(TemplateTypeT&& value) {
