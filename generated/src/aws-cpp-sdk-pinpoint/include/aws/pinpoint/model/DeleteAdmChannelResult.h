...
namespace Model
{
  ...
  {
  public:
    AWS_PINPOINT_API DeleteAdmChannelResult() = default;
    ...
    template<typename ADMChannelResponseT = ADMChannelResponse>
    DeleteAdmChannelResult& WithADMChannelResponse(ADMChannelResponseT&& value) { SetADMChannelResponse(std::forward<ADMChannelResponseT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DeleteAdmChannelResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
