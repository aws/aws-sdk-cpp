...
class EmailMessage {
 public:
  ...
  void SetFeedbackForwardingAddress(FeedbackForwardingAddressT&& value) {
    ...
    m_feedbackForwardingAddress = std::forward<FeedbackForwardingAddressT>(value);
  }
  template <typename FeedbackForwardingAddressT = Aws::String>
  EmailMessage& WithFeedbackForwardingAddress(FeedbackForwardingAddressT&& value) {
    SetFeedbackForwardingAddress(std::forward<FeedbackForwardingAddressT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRawEmail(RawEmailT&& value) {
    ...
    m_rawEmail = std::forward<RawEmailT>(value);
  }
  template <typename RawEmailT = RawEmail>
  EmailMessage& WithRawEmail(RawEmailT&& value) {
    SetRawEmail(std::forward<RawEmailT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReplyToAddresses(ReplyToAddressesT&& value) {
    ...
    m_replyToAddresses = std::forward<ReplyToAddressesT>(value);
  }
  template <typename ReplyToAddressesT = Aws::Vector<Aws::String>>
  EmailMessage& WithReplyToAddresses(ReplyToAddressesT&& value) {
    SetReplyToAddresses(std::forward<ReplyToAddressesT>(value));
    return *this;
  }
  template <typename ReplyToAddressesT = Aws::String>
  EmailMessage& AddReplyToAddresses(ReplyToAddressesT&& value) {
    m_replyToAddressesHasBeenSet = true;
    m_replyToAddresses.emplace_back(std::forward<ReplyToAddressesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSimpleEmail(SimpleEmailT&& value) {
    ...
    m_simpleEmail = std::forward<SimpleEmailT>(value);
  }
  template <typename SimpleEmailT = SimpleEmail>
  EmailMessage& WithSimpleEmail(SimpleEmailT&& value) {
    SetSimpleEmail(std::forward<SimpleEmailT>(value));
    return *this;
  }
  ///@}
