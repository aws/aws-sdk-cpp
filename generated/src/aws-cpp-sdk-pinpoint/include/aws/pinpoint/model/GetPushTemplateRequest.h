...
namespace Model
{
  ...
  /**
   */
  class GetPushTemplateRequest : public PinpointRequest
  {
  public:
    AWS_PINPOINT_API GetPushTemplateRequest() = default;
    ...
    template<typename TemplateNameT = Aws::String>
    GetPushTemplateRequest& WithTemplateName(TemplateNameT&& value) { SetTemplateName(std::forward<TemplateNameT>(value)); return *this;}
    ///@}
    ...
    template<typename VersionT = Aws::String>
    GetPushTemplateRequest& WithVersion(VersionT&& value) { SetVersion(std::forward<VersionT>(value)); return *this;}
    ///@}
  private:
