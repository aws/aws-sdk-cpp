...
class WriteJourneyRequest {
 public:
  ...
  inline WriteJourneyRequest& WithLocalTime(bool value) {
    SetLocalTime(value);
    return *this;
  }
  ///@}
  ...
  inline WriteJourneyRequest& WithState(State value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline WriteJourneyRequest& WithWaitForQuietTime(bool value) {
  ...
  inline WriteJourneyRequest& WithRefreshOnSegmentUpdate(bool value) {
  ...
  inline WriteJourneyRequest& WithSendingSchedule(bool value) {
  ...
  inline WriteJourneyRequest& AddTimezoneEstimationMethods(__TimezoneEstimationMethodsElement value) {
    m_timezoneEstimationMethodsHasBeenSet = true;
