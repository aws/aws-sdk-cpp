...
namespace Model
{
  ...
  public:
    ...
    template<typename SegmentsResponseT = SegmentsResponse>
    GetSegmentVersionsResult& WithSegmentsResponse(SegmentsResponseT&& value) { SetSegmentsResponse(std::forward<SegmentsResponseT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    GetSegmentVersionsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
