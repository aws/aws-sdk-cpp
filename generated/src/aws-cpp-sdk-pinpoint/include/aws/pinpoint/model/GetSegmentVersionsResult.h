...
class GetSegmentVersionsResult {
 public:
  AWS_PINPOINT_API GetSegmentVersionsResult() = default;
  ...
  void SetSegmentsResponse(SegmentsResponseT&& value) {
    m_segmentsResponseHasBeenSet = true;
    m_segmentsResponse = std::forward<SegmentsResponseT>(value);
  }
  template <typename SegmentsResponseT = SegmentsResponse>
  GetSegmentVersionsResult& WithSegmentsResponse(SegmentsResponseT&& value) {
    SetSegmentsResponse(std::forward<SegmentsResponseT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetSegmentVersionsResult& WithRequestId(RequestIdT&& value) {
