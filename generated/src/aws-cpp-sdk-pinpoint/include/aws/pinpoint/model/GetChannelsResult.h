...
class GetChannelsResult {
 public:
  ...
  void SetChannelsResponse(ChannelsResponseT&& value) {
    m_channelsResponseHasBeenSet = true;
    m_channelsResponse = std::forward<ChannelsResponseT>(value);
  }
  template <typename ChannelsResponseT = ChannelsResponse>
  GetChannelsResult& WithChannelsResponse(ChannelsResponseT&& value) {
    SetChannelsResponse(std::forward<ChannelsResponseT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetChannelsResult& WithRequestId(RequestIdT&& value) {
