...
class InAppMessagesResponse {
 public:
  ...
  void SetInAppMessageCampaigns(InAppMessageCampaignsT&& value) {
    m_inAppMessageCampaignsHasBeenSet = true;
    m_inAppMessageCampaigns = std::forward<InAppMessageCampaignsT>(value);
  }
  template <typename InAppMessageCampaignsT = Aws::Vector<InAppMessageCampaign>>
  InAppMessagesResponse& WithInAppMessageCampaigns(InAppMessageCampaignsT&& value) {
    SetInAppMessageCampaigns(std::forward<InAppMessageCampaignsT>(value));
    return *this;
  }
  template <typename InAppMessageCampaignsT = InAppMessageCampaign>
  InAppMessagesResponse& AddInAppMessageCampaigns(InAppMessageCampaignsT&& value) {
    m_inAppMessageCampaignsHasBeenSet = true;
    m_inAppMessageCampaigns.emplace_back(std::forward<InAppMessageCampaignsT>(value));
    return *this;
  }
  ///@}
 private:
