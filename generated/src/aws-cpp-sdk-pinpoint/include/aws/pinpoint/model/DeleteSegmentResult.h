...
namespace Model
{
  ...
  {
  public:
    AWS_PINPOINT_API DeleteSegmentResult() = default;
    ...
    template<typename SegmentResponseT = SegmentResponse>
    DeleteSegmentResult& WithSegmentResponse(SegmentResponseT&& value) { SetSegmentResponse(std::forward<SegmentResponseT>(value)); return *this;}
    ///@}
