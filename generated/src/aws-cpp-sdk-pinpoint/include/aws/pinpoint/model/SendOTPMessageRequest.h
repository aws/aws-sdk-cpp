...
class SendOTPMessageRequest : public PinpointRequest {
 public:
  ...
  template <typename ApplicationIdT = Aws::String>
  SendOTPMessageRequest& WithApplicationId(ApplicationIdT&& value) {
  ...
  void SetSendOTPMessageRequestParameters(SendOTPMessageRequestParametersT&& value) {
    m_sendOTPMessageRequestParametersHasBeenSet = true;
    m_sendOTPMessageRequestParameters = std::forward<SendOTPMessageRequestParametersT>(value);
  }
  template <typename SendOTPMessageRequestParametersT = SendOTPMessageRequestParameters>
  SendOTPMessageRequest& WithSendOTPMessageRequestParameters(SendOTPMessageRequestParametersT&& value) {
    SetSendOTPMessageRequestParameters(std::forward<SendOTPMessageRequestParametersT>(value));
    return *this;
  }
  ///@}
 private:
