...
class ImportJobRequest {
 public:
  ...
  inline ImportJobRequest& WithDefineSegment(bool value) {
  ...
  inline ImportJobRequest& WithFormat(Format value) {
    SetFormat(value);
    return *this;
  }
  ///@}
  ...
  inline ImportJobRequest& WithRegisterEndpoints(bool value) {
