...
class Message {
 public:
  ...
  inline Message& WithAction(Action value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  void SetImageSmallIconUrl(ImageSmallIconUrlT&& value) {
    ...
    m_imageSmallIconUrl = std::forward<ImageSmallIconUrlT>(value);
  }
  template <typename ImageSmallIconUrlT = Aws::String>
  Message& WithImageSmallIconUrl(ImageSmallIconUrlT&& value) {
    SetImageSmallIconUrl(std::forward<ImageSmallIconUrlT>(value));
    return *this;
  }
  ///@}
  ...
  inline Message& WithSilentPush(bool value) {
    SetSilentPush(value);
    return *this;
  }
  ///@}
  ...
  inline Message& WithTimeToLive(int value) {
    SetTimeToLive(value);
    return *this;
  }
  ///@}
