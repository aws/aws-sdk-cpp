...
class UpdateAdmChannelRequest : public PinpointRequest {
 public:
  ...
  void SetADMChannelRequest(ADMChannelRequestT&& value) {
    m_aDMChannelRequestHasBeenSet = true;
    m_aDMChannelRequest = std::forward<ADMChannelRequestT>(value);
  }
  template <typename ADMChannelRequestT = ADMChannelRequest>
  UpdateAdmChannelRequest& WithADMChannelRequest(ADMChannelRequestT&& value) {
    SetADMChannelRequest(std::forward<ADMChannelRequestT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ApplicationIdT = Aws::String>
  UpdateAdmChannelRequest& WithApplicationId(ApplicationIdT&& value) {
