...
namespace Model
{
  ...
  {
  public:
    AWS_PINPOINT_API DeleteGcmChannelResult();
    ...
    inline DeleteGcmChannelResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeleteGcmChannelResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeleteGcmChannelResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
