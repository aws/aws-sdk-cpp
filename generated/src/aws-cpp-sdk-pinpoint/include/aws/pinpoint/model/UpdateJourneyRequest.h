...
class UpdateJourneyRequest : public PinpointRequest {
 public:
  ...
  void SetWriteJourneyRequest(WriteJourneyRequestT&& value) {
    m_writeJourneyRequestHasBeenSet = true;
    m_writeJourneyRequest = std::forward<WriteJourneyRequestT>(value);
  }
  template <typename WriteJourneyRequestT = WriteJourneyRequest>
  UpdateJourneyRequest& WithWriteJourneyRequest(WriteJourneyRequestT&& value) {
    SetWriteJourneyRequest(std::forward<WriteJourneyRequestT>(value));
    return *this;
  }
  ///@}
 private:
