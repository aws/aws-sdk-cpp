...
namespace Model
{
  ...
  {
  public:
    AWS_PINPOINT_API GetCampaignRequest() = default;
    ...
    template<typename ApplicationIdT = Aws::String>
    GetCampaignRequest& WithApplicationId(ApplicationIdT&& value) { SetApplicationId(std::forward<ApplicationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename CampaignIdT = Aws::String>
    GetCampaignRequest& WithCampaignId(CampaignIdT&& value) { SetCampaignId(std::forward<CampaignIdT>(value)); return *this;}
    ///@}
  private:
