...
namespace Model
{
  ...
  /**
   */
  class GetImportJobsRequest : public PinpointRequest
  {
  public:
    AWS_PINPOINT_API GetImportJobsRequest() = default;
    ...
    template<typename ApplicationIdT = Aws::String>
    GetImportJobsRequest& WithApplicationId(ApplicationIdT&& value) { SetApplicationId(std::forward<ApplicationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename PageSizeT = Aws::String>
    GetImportJobsRequest& WithPageSize(PageSizeT&& value) { SetPageSize(std::forward<PageSizeT>(value)); return *this;}
    ///@}
    ...
    template<typename TokenT = Aws::String>
    GetImportJobsRequest& WithToken(TokenT&& value) { SetToken(std::forward<TokenT>(value)); return *this;}
    ///@}
  private:
