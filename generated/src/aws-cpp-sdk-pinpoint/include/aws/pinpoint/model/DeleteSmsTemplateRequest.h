...
namespace Model
{
  ...
  {
  public:
    AWS_PINPOINT_API DeleteSmsTemplateRequest() = default;
    ...
    template<typename TemplateNameT = Aws::String>
    DeleteSmsTemplateRequest& WithTemplateName(TemplateNameT&& value) { SetTemplateName(std::forward<TemplateNameT>(value)); return *this;}
    ///@}
    ...
    template<typename VersionT = Aws::String>
    DeleteSmsTemplateRequest& WithVersion(VersionT&& value) { SetVersion(std::forward<VersionT>(value)); return *this;}
    ///@}
  private:
