...
class ListRecommenderConfigurationsResponse {
 public:
  ...
  template <typename ItemT = Aws::Vector<RecommenderConfigurationResponse>>
  ListRecommenderConfigurationsResponse& WithItem(ItemT&& value) {
    SetItem(std::forward<ItemT>(value));
    return *this;
  }
  template <typename ItemT = RecommenderConfigurationResponse>
  ListRecommenderConfigurationsResponse& AddItem(ItemT&& value) {
    m_itemHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListRecommenderConfigurationsResponse& WithNextToken(NextTokenT&& value) {
