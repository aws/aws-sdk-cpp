...
class APNSVoipChannelRequest {
 public:
  ...
  template <typename BundleIdT = Aws::String>
  APNSVoipChannelRequest& WithBundleId(BundleIdT&& value) {
  ...
  template <typename CertificateT = Aws::String>
  APNSVoipChannelRequest& WithCertificate(CertificateT&& value) {
  ...
  template <typename DefaultAuthenticationMethodT = Aws::String>
  APNSVoipChannelRequest& WithDefaultAuthenticationMethod(DefaultAuthenticationMethodT&& value) {
  ...
  inline APNSVoipChannelRequest& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  template <typename PrivateKeyT = Aws::String>
  APNSVoipChannelRequest& WithPrivateKey(PrivateKeyT&& value) {
  ...
  template <typename TeamIdT = Aws::String>
  APNSVoipChannelRequest& WithTeamId(TeamIdT&& value) {
  ...
  template <typename TokenKeyT = Aws::String>
  APNSVoipChannelRequest& WithTokenKey(TokenKeyT&& value) {
  ...
  template <typename TokenKeyIdT = Aws::String>
  APNSVoipChannelRequest& WithTokenKeyId(TokenKeyIdT&& value) {
