...
namespace Model
{
  ...
  {
  public:
    AWS_PINPOINT_API APNSVoipChannelRequest() = default;
    ...
    template<typename BundleIdT = Aws::String>
    APNSVoipChannelRequest& WithBundleId(BundleIdT&& value) { SetBundleId(std::forward<BundleIdT>(value)); return *this;}
    ///@}
    ...
    template<typename CertificateT = Aws::String>
    APNSVoipChannelRequest& WithCertificate(CertificateT&& value) { SetCertificate(std::forward<CertificateT>(value)); return *this;}
    ///@}
    ...
    template<typename DefaultAuthenticationMethodT = Aws::String>
    APNSVoipChannelRequest& WithDefaultAuthenticationMethod(DefaultAuthenticationMethodT&& value) { SetDefaultAuthenticationMethod(std::forward<DefaultAuthenticationMethodT>(value)); return *this;}
    ///@}
    ...
    template<typename PrivateKeyT = Aws::String>
    APNSVoipChannelRequest& WithPrivateKey(PrivateKeyT&& value) { SetPrivateKey(std::forward<PrivateKeyT>(value)); return *this;}
    ///@}
    ...
    template<typename TeamIdT = Aws::String>
    APNSVoipChannelRequest& WithTeamId(TeamIdT&& value) { SetTeamId(std::forward<TeamIdT>(value)); return *this;}
    ///@}
    ...
    template<typename TokenKeyT = Aws::String>
    APNSVoipChannelRequest& WithTokenKey(TokenKeyT&& value) { SetTokenKey(std::forward<TokenKeyT>(value)); return *this;}
    ///@}
    ...
    template<typename TokenKeyIdT = Aws::String>
    APNSVoipChannelRequest& WithTokenKeyId(TokenKeyIdT&& value) { SetTokenKeyId(std::forward<TokenKeyIdT>(value)); return *this;}
    ///@}
  private:
