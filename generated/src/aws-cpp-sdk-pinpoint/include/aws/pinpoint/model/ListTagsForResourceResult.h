...
class ListTagsForResourceResult {
 public:
  ...
  void SetTagsModel(TagsModelT&& value) {
    m_tagsModelHasBeenSet = true;
    m_tagsModel = std::forward<TagsModelT>(value);
  }
  template <typename TagsModelT = TagsModel>
  ListTagsForResourceResult& WithTagsModel(TagsModelT&& value) {
    SetTagsModel(std::forward<TagsModelT>(value));
    return *this;
  }
  ///@}
