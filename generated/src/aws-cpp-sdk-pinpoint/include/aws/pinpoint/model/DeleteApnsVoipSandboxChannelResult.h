...
class DeleteApnsVoipSandboxChannelResult {
 public:
  ...
  void SetAPNSVoipSandboxChannelResponse(APNSVoipSandboxChannelResponseT&& value) {
    m_aPNSVoipSandboxChannelResponseHasBeenSet = true;
    m_aPNSVoipSandboxChannelResponse = std::forward<APNSVoipSandboxChannelResponseT>(value);
  }
  template <typename APNSVoipSandboxChannelResponseT = APNSVoipSandboxChannelResponse>
  DeleteApnsVoipSandboxChannelResult& WithAPNSVoipSandboxChannelResponse(APNSVoipSandboxChannelResponseT&& value) {
    SetAPNSVoipSandboxChannelResponse(std::forward<APNSVoipSandboxChannelResponseT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DeleteApnsVoipSandboxChannelResult& WithRequestId(RequestIdT&& value) {
