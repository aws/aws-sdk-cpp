...
class GetApplicationSettingsResult {
 public:
  ...
  template <typename ApplicationSettingsResourceT = ApplicationSettingsResource>
  GetApplicationSettingsResult& WithApplicationSettingsResource(ApplicationSettingsResourceT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetApplicationSettingsResult& WithRequestId(RequestIdT&& value) {
