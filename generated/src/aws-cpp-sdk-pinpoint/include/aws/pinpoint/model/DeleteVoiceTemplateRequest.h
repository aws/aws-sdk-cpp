...
namespace Model
{
  ...
  /**
   */
  class DeleteVoiceTemplateRequest : public PinpointRequest
  {
  public:
    AWS_PINPOINT_API DeleteVoiceTemplateRequest() = default;
    ...
    template<typename TemplateNameT = Aws::String>
    DeleteVoiceTemplateRequest& WithTemplateName(TemplateNameT&& value) { SetTemplateName(std::forward<TemplateNameT>(value)); return *this;}
    ///@}
    ...
    template<typename VersionT = Aws::String>
    DeleteVoiceTemplateRequest& WithVersion(VersionT&& value) { SetVersion(std::forward<VersionT>(value)); return *this;}
    ///@}
  private:
