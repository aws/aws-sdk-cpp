...
class MessageResult {
 public:
  ...
  inline MessageResult& WithDeliveryStatus(DeliveryStatus value) {
  ...
  inline MessageResult& WithStatusCode(int value) {
    SetStatusCode(value);
    return *this;
  }
  ///@}
  ...
  void SetUpdatedToken(UpdatedTokenT&& value) {
    ...
    m_updatedToken = std::forward<UpdatedTokenT>(value);
  }
  template <typename UpdatedTokenT = Aws::String>
  MessageResult& WithUpdatedToken(UpdatedTokenT&& value) {
    SetUpdatedToken(std::forward<UpdatedTokenT>(value));
    return *this;
  }
  ///@}
 private:
