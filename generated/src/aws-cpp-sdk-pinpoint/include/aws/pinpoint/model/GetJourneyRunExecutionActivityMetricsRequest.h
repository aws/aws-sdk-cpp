...
class GetJourneyRunExecutionActivityMetricsRequest : public PinpointRequest {
 public:
  ...
  template <typename ApplicationIdT = Aws::String>
  GetJourneyRunExecutionActivityMetricsRequest& WithApplicationId(ApplicationIdT&& value) {
  ...
  void SetJourneyActivityId(JourneyActivityIdT&& value) {
    ...
    m_journeyActivityId = std::forward<JourneyActivityIdT>(value);
  }
  template <typename JourneyActivityIdT = Aws::String>
  GetJourneyRunExecutionActivityMetricsRequest& WithJourneyActivityId(JourneyActivityIdT&& value) {
    SetJourneyActivityId(std::forward<JourneyActivityIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetJourneyId(JourneyIdT&& value) {
    ...
    m_journeyId = std::forward<JourneyIdT>(value);
  }
  template <typename JourneyIdT = Aws::String>
  GetJourneyRunExecutionActivityMetricsRequest& WithJourneyId(JourneyIdT&& value) {
    SetJourneyId(std::forward<JourneyIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetJourneyRunExecutionActivityMetricsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename PageSizeT = Aws::String>
  GetJourneyRunExecutionActivityMetricsRequest& WithPageSize(PageSizeT&& value) {
  ...
  template <typename RunIdT = Aws::String>
  GetJourneyRunExecutionActivityMetricsRequest& WithRunId(RunIdT&& value) {
