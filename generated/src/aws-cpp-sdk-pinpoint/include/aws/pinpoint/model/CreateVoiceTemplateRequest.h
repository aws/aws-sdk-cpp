...
class CreateVoiceTemplateRequest : public PinpointRequest {
 public:
  ...
  template <typename TemplateNameT = Aws::String>
  CreateVoiceTemplateRequest& WithTemplateName(TemplateNameT&& value) {
  ...
  void SetVoiceTemplateRequest(VoiceTemplateRequestT&& value) {
    m_voiceTemplateRequestHasBeenSet = true;
    m_voiceTemplateRequest = std::forward<VoiceTemplateRequestT>(value);
  }
  template <typename VoiceTemplateRequestT = VoiceTemplateRequest>
  CreateVoiceTemplateRequest& WithVoiceTemplateRequest(VoiceTemplateRequestT&& value) {
    SetVoiceTemplateRequest(std::forward<VoiceTemplateRequestT>(value));
    return *this;
  }
  ///@}
 private:
