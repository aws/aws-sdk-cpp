...
class GetInAppMessagesResult {
 public:
  ...
  void SetInAppMessagesResponse(InAppMessagesResponseT&& value) {
    m_inAppMessagesResponseHasBeenSet = true;
    m_inAppMessagesResponse = std::forward<InAppMessagesResponseT>(value);
  }
  template <typename InAppMessagesResponseT = InAppMessagesResponse>
  GetInAppMessagesResult& WithInAppMessagesResponse(InAppMessagesResponseT&& value) {
    SetInAppMessagesResponse(std::forward<InAppMessagesResponseT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetInAppMessagesResult& WithRequestId(RequestIdT&& value) {
