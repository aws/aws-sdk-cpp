...
class MessageResponse {
 public:
  ...
  void SetEndpointResult(EndpointResultT&& value) {
    ...
    m_endpointResult = std::forward<EndpointResultT>(value);
  }
  template <typename EndpointResultT = Aws::Map<Aws::String, EndpointMessageResult>>
  MessageResponse& WithEndpointResult(EndpointResultT&& value) {
    SetEndpointResult(std::forward<EndpointResultT>(value));
    return *this;
  }
  ...
  MessageResponse& AddEndpointResult(EndpointResultKeyT&& key, EndpointResultValueT&& value) {
    m_endpointResultHasBeenSet = true;
    m_endpointResult.emplace(std::forward<EndpointResultKeyT>(key), std::forward<EndpointResultValueT>(value));
    return *this;
  }
  ///@}
