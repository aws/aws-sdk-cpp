...
namespace Model
{
  ...
  /**
   */
  class UpdatePushTemplateRequest : public PinpointRequest
  {
  public:
    ...
    inline UpdatePushTemplateRequest& WithCreateNewVersion(bool value) { SetCreateNewVersion(value); return *this;}
    ///@}
    ...
    template<typename PushNotificationTemplateRequestT = PushNotificationTemplateRequest>
    UpdatePushTemplateRequest& WithPushNotificationTemplateRequest(PushNotificationTemplateRequestT&& value) { SetPushNotificationTemplateRequest(std::forward<PushNotificationTemplateRequestT>(value)); return *this;}
    ///@}
    ...
    template<typename TemplateNameT = Aws::String>
    UpdatePushTemplateRequest& WithTemplateName(TemplateNameT&& value) { SetTemplateName(std::forward<TemplateNameT>(value)); return *this;}
    ///@}
    ...
    template<typename VersionT = Aws::String>
    UpdatePushTemplateRequest& WithVersion(VersionT&& value) { SetVersion(std::forward<VersionT>(value)); return *this;}
    ///@}
  private:
