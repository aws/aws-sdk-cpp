...
namespace Model
{
  ...
  /**
   */
  class GetCampaignVersionsRequest : public PinpointRequest
  {
  public:
    ...
    template<typename ApplicationIdT = Aws::String>
    GetCampaignVersionsRequest& WithApplicationId(ApplicationIdT&& value) { SetApplicationId(std::forward<ApplicationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename CampaignIdT = Aws::String>
    GetCampaignVersionsRequest& WithCampaignId(CampaignIdT&& value) { SetCampaignId(std::forward<CampaignIdT>(value)); return *this;}
    ///@}
    ...
    template<typename PageSizeT = Aws::String>
    GetCampaignVersionsRequest& WithPageSize(PageSizeT&& value) { SetPageSize(std::forward<PageSizeT>(value)); return *this;}
    ///@}
    ...
    template<typename TokenT = Aws::String>
    GetCampaignVersionsRequest& WithToken(TokenT&& value) { SetToken(std::forward<TokenT>(value)); return *this;}
    ///@}
  private:
