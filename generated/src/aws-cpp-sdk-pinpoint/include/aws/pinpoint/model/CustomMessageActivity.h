...
class CustomMessageActivity {
 public:
  ...
  void SetDeliveryUri(DeliveryUriT&& value) {
    ...
    m_deliveryUri = std::forward<DeliveryUriT>(value);
  }
  template <typename DeliveryUriT = Aws::String>
  CustomMessageActivity& WithDeliveryUri(DeliveryUriT&& value) {
    SetDeliveryUri(std::forward<DeliveryUriT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEndpointTypes(EndpointTypesT&& value) {
    ...
    m_endpointTypes = std::forward<EndpointTypesT>(value);
  }
  template <typename EndpointTypesT = Aws::Vector<__EndpointTypesElement>>
  CustomMessageActivity& WithEndpointTypes(EndpointTypesT&& value) {
    SetEndpointTypes(std::forward<EndpointTypesT>(value));
    return *this;
  }
  inline CustomMessageActivity& AddEndpointTypes(__EndpointTypesElement value) {
    m_endpointTypesHasBeenSet = true;
    m_endpointTypes.push_back(value);
    return *this;
  }
  ///@}
