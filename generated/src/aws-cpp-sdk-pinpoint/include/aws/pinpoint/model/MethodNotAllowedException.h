...
namespace Model
{
  ...
  {
  public:
    AWS_PINPOINT_API MethodNotAllowedException() = default;
    ...
    template<typename MessageT = Aws::String>
    MethodNotAllowedException& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
