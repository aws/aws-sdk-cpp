...
namespace Model
{
  ...
  {
  public:
    AWS_PINPOINT_API DeleteApnsChannelResult() = default;
    ...
    template<typename APNSChannelResponseT = APNSChannelResponse>
    DeleteApnsChannelResult& WithAPNSChannelResponse(APNSChannelResponseT&& value) { SetAPNSChannelResponse(std::forward<APNSChannelResponseT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DeleteApnsChannelResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
