...
class EmailChannelResponse {
 public:
  ...
  inline EmailChannelResponse& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline EmailChannelResponse& WithHasCredential(bool value) {
  ...
  inline EmailChannelResponse& WithIsArchived(bool value) {
    SetIsArchived(value);
    return *this;
  }
  ///@}
  ...
  inline EmailChannelResponse& WithMessagesPerSecond(int value) {
  ...
  void SetOrchestrationSendingRoleArn(OrchestrationSendingRoleArnT&& value) {
    ...
    m_orchestrationSendingRoleArn = std::forward<OrchestrationSendingRoleArnT>(value);
  }
  template <typename OrchestrationSendingRoleArnT = Aws::String>
  EmailChannelResponse& WithOrchestrationSendingRoleArn(OrchestrationSendingRoleArnT&& value) {
    SetOrchestrationSendingRoleArn(std::forward<OrchestrationSendingRoleArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline EmailChannelResponse& WithVersion(int value) {
    SetVersion(value);
    return *this;
  }
  ///@}
