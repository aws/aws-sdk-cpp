...
class AndroidPushNotificationTemplate {
 public:
  ...
  inline AndroidPushNotificationTemplate& WithAction(Action value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  template <typename BodyT = Aws::String>
  AndroidPushNotificationTemplate& WithBody(BodyT&& value) {
  ...
  template <typename ImageIconUrlT = Aws::String>
  AndroidPushNotificationTemplate& WithImageIconUrl(ImageIconUrlT&& value) {
  ...
  template <typename ImageUrlT = Aws::String>
  AndroidPushNotificationTemplate& WithImageUrl(ImageUrlT&& value) {
  ...
  template <typename RawContentT = Aws::String>
  AndroidPushNotificationTemplate& WithRawContent(RawContentT&& value) {
  ...
  template <typename SmallImageIconUrlT = Aws::String>
  AndroidPushNotificationTemplate& WithSmallImageIconUrl(SmallImageIconUrlT&& value) {
  ...
  template <typename SoundT = Aws::String>
  AndroidPushNotificationTemplate& WithSound(SoundT&& value) {
  ...
  template <typename TitleT = Aws::String>
  AndroidPushNotificationTemplate& WithTitle(TitleT&& value) {
  ...
  template <typename UrlT = Aws::String>
  AndroidPushNotificationTemplate& WithUrl(UrlT&& value) {
