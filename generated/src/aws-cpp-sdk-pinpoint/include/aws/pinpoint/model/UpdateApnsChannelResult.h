...
namespace Model
{
  ...
  public:
    ...
    template<typename APNSChannelResponseT = APNSChannelResponse>
    UpdateApnsChannelResult& WithAPNSChannelResponse(APNSChannelResponseT&& value) { SetAPNSChannelResponse(std::forward<APNSChannelResponseT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateApnsChannelResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
