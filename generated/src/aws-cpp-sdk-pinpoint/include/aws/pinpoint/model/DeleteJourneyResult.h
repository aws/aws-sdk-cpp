...
class DeleteJourneyResult {
 public:
  AWS_PINPOINT_API DeleteJourneyResult() = default;
  ...
  template <typename JourneyResponseT = JourneyResponse>
  DeleteJourneyResult& WithJourneyResponse(JourneyResponseT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteJourneyResult& WithRequestId(RequestIdT&& value) {
