...
namespace Model
{
  ...
  {
  public:
    AWS_PINPOINT_API UpdateRecommenderConfigurationResult() = default;
    ...
    template<typename RecommenderConfigurationResponseT = RecommenderConfigurationResponse>
    UpdateRecommenderConfigurationResult& WithRecommenderConfigurationResponse(RecommenderConfigurationResponseT&& value) { SetRecommenderConfigurationResponse(std::forward<RecommenderConfigurationResponseT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateRecommenderConfigurationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
