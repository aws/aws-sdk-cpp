...
class UpdateRecommenderConfigurationResult {
 public:
  ...
  template <typename RecommenderConfigurationResponseT = RecommenderConfigurationResponse>
  UpdateRecommenderConfigurationResult& WithRecommenderConfigurationResponse(RecommenderConfigurationResponseT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateRecommenderConfigurationResult& WithRequestId(RequestIdT&& value) {
