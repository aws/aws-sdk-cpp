...
namespace Model
{
  ...
  {
  public:
    AWS_PINPOINT_API CreatePushTemplateResult() = default;
    ...
    template<typename CreateTemplateMessageBodyT = CreateTemplateMessageBody>
    CreatePushTemplateResult& WithCreateTemplateMessageBody(CreateTemplateMessageBodyT&& value) { SetCreateTemplateMessageBody(std::forward<CreateTemplateMessageBodyT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreatePushTemplateResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
