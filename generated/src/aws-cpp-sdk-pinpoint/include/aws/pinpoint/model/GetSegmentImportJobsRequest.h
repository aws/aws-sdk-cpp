...
class GetSegmentImportJobsRequest : public PinpointRequest {
 public:
  ...
  template <typename ApplicationIdT = Aws::String>
  GetSegmentImportJobsRequest& WithApplicationId(ApplicationIdT&& value) {
  ...
  template <typename PageSizeT = Aws::String>
  GetSegmentImportJobsRequest& WithPageSize(PageSizeT&& value) {
  ...
  template <typename SegmentIdT = Aws::String>
  GetSegmentImportJobsRequest& WithSegmentId(SegmentIdT&& value) {
  ...
  template <typename TokenT = Aws::String>
  GetSegmentImportJobsRequest& WithToken(TokenT&& value) {
