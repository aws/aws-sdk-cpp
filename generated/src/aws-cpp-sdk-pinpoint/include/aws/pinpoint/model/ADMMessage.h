...
namespace Model
{
  ...
  public:
    ...
    inline ADMMessage& WithAction(Action value) { SetAction(value); return *this;}
    ///@}
    ...
    template<typename BodyT = Aws::String>
    ADMMessage& WithBody(BodyT&& value) { SetBody(std::forward<BodyT>(value)); return *this;}
    ///@}
    ...
    template<typename ConsolidationKeyT = Aws::String>
    void SetConsolidationKey(ConsolidationKeyT&& value) { m_consolidationKeyHasBeenSet = true; m_consolidationKey = std::forward<ConsolidationKeyT>(value); }
    template<typename ConsolidationKeyT = Aws::String>
    ADMMessage& WithConsolidationKey(ConsolidationKeyT&& value) { SetConsolidationKey(std::forward<ConsolidationKeyT>(value)); return *this;}
    ///@}
    ...
    template<typename DataT = Aws::Map<Aws::String, Aws::String>>
    ADMMessage& WithData(DataT&& value) { SetData(std::forward<DataT>(value)); return *this;}
    ...
    template<typename ExpiresAfterT = Aws::String>
    ADMMessage& WithExpiresAfter(ExpiresAfterT&& value) { SetExpiresAfter(std::forward<ExpiresAfterT>(value)); return *this;}
    ///@}
    ...
    template<typename IconReferenceT = Aws::String>
    ADMMessage& WithIconReference(IconReferenceT&& value) { SetIconReference(std::forward<IconReferenceT>(value)); return *this;}
    ///@}
    ...
    template<typename ImageIconUrlT = Aws::String>
    ADMMessage& WithImageIconUrl(ImageIconUrlT&& value) { SetImageIconUrl(std::forward<ImageIconUrlT>(value)); return *this;}
    ///@}
    ...
    template<typename ImageUrlT = Aws::String>
    ADMMessage& WithImageUrl(ImageUrlT&& value) { SetImageUrl(std::forward<ImageUrlT>(value)); return *this;}
    ///@}
    ...
    template<typename MD5T = Aws::String>
    ADMMessage& WithMD5(MD5T&& value) { SetMD5(std::forward<MD5T>(value)); return *this;}
    ///@}
    ...
    template<typename RawContentT = Aws::String>
    ADMMessage& WithRawContent(RawContentT&& value) { SetRawContent(std::forward<RawContentT>(value)); return *this;}
    ///@}
    ...
    template<typename SmallImageIconUrlT = Aws::String>
    ADMMessage& WithSmallImageIconUrl(SmallImageIconUrlT&& value) { SetSmallImageIconUrl(std::forward<SmallImageIconUrlT>(value)); return *this;}
    ///@}
    ...
    template<typename SoundT = Aws::String>
    ADMMessage& WithSound(SoundT&& value) { SetSound(std::forward<SoundT>(value)); return *this;}
    ///@}
    ...
    template<typename SubstitutionsT = Aws::Map<Aws::String, Aws::Vector<Aws::String>>>
    ADMMessage& WithSubstitutions(SubstitutionsT&& value) { SetSubstitutions(std::forward<SubstitutionsT>(value)); return *this;}
    ...
    template<typename TitleT = Aws::String>
    ADMMessage& WithTitle(TitleT&& value) { SetTitle(std::forward<TitleT>(value)); return *this;}
    ///@}
    ...
    template<typename UrlT = Aws::String>
    ADMMessage& WithUrl(UrlT&& value) { SetUrl(std::forward<UrlT>(value)); return *this;}
    ///@}
  private:
