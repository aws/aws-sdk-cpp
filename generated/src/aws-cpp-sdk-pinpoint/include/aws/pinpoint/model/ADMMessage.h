...
class ADMMessage {
 public:
  ...
  inline ADMMessage& WithAction(Action value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  void SetConsolidationKey(ConsolidationKeyT&& value) {
    ...
    m_consolidationKey = std::forward<ConsolidationKeyT>(value);
  }
  template <typename ConsolidationKeyT = Aws::String>
  ADMMessage& WithConsolidationKey(ConsolidationKeyT&& value) {
    SetConsolidationKey(std::forward<ConsolidationKeyT>(value));
    return *this;
  }
  ///@}
  ...
  inline ADMMessage& WithSilentPush(bool value) {
    SetSilentPush(value);
    return *this;
  }
  ///@}
