...
class CreateSegmentRequest : public PinpointRequest {
 public:
  ...
  template <typename ApplicationIdT = Aws::String>
  CreateSegmentRequest& WithApplicationId(ApplicationIdT&& value) {
  ...
  void SetWriteSegmentRequest(WriteSegmentRequestT&& value) {
    m_writeSegmentRequestHasBeenSet = true;
    m_writeSegmentRequest = std::forward<WriteSegmentRequestT>(value);
  }
  template <typename WriteSegmentRequestT = WriteSegmentRequest>
  CreateSegmentRequest& WithWriteSegmentRequest(WriteSegmentRequestT&& value) {
    SetWriteSegmentRequest(std::forward<WriteSegmentRequestT>(value));
    return *this;
  }
  ///@}
 private:
