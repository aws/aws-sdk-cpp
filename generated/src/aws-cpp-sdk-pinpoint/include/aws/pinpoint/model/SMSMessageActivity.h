...
class SMSMessageActivity {
 public:
  ...
  void SetMessageConfig(MessageConfigT&& value) {
    ...
    m_messageConfig = std::forward<MessageConfigT>(value);
  }
  template <typename MessageConfigT = JourneySMSMessage>
  SMSMessageActivity& WithMessageConfig(MessageConfigT&& value) {
    SetMessageConfig(std::forward<MessageConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNextActivity(NextActivityT&& value) {
    ...
    m_nextActivity = std::forward<NextActivityT>(value);
  }
  template <typename NextActivityT = Aws::String>
  SMSMessageActivity& WithNextActivity(NextActivityT&& value) {
    SetNextActivity(std::forward<NextActivityT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TemplateNameT = Aws::String>
  SMSMessageActivity& WithTemplateName(TemplateNameT&& value) {
  ...
  void SetTemplateVersion(TemplateVersionT&& value) {
    ...
    m_templateVersion = std::forward<TemplateVersionT>(value);
  }
  template <typename TemplateVersionT = Aws::String>
  SMSMessageActivity& WithTemplateVersion(TemplateVersionT&& value) {
    SetTemplateVersion(std::forward<TemplateVersionT>(value));
    return *this;
  }
  ///@}
 private:
