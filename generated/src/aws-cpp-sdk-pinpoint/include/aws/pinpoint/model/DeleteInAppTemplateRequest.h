...
namespace Model
{
  ...
  {
  public:
    AWS_PINPOINT_API DeleteInAppTemplateRequest() = default;
    ...
    template<typename TemplateNameT = Aws::String>
    DeleteInAppTemplateRequest& WithTemplateName(TemplateNameT&& value) { SetTemplateName(std::forward<TemplateNameT>(value)); return *this;}
    ///@}
    ...
    template<typename VersionT = Aws::String>
    DeleteInAppTemplateRequest& WithVersion(VersionT&& value) { SetVersion(std::forward<VersionT>(value)); return *this;}
    ///@}
  private:
