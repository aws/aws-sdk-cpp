...
class BaiduMessage {
 public:
  ...
  inline BaiduMessage& WithAction(Action value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  void SetIconReference(IconReferenceT&& value) {
    ...
    m_iconReference = std::forward<IconReferenceT>(value);
  }
  template <typename IconReferenceT = Aws::String>
  BaiduMessage& WithIconReference(IconReferenceT&& value) {
    SetIconReference(std::forward<IconReferenceT>(value));
    return *this;
  }
  ///@}
  ...
  inline BaiduMessage& WithSilentPush(bool value) {
    SetSilentPush(value);
    return *this;
  }
  ///@}
  ...
  inline BaiduMessage& WithTimeToLive(int value) {
    SetTimeToLive(value);
    return *this;
  }
  ///@}
