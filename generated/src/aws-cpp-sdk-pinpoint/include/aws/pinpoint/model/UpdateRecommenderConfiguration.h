...
class UpdateRecommenderConfiguration {
 public:
  AWS_PINPOINT_API UpdateRecommenderConfiguration() = default;
  ...
  template <typename AttributesT = Aws::Map<Aws::String, Aws::String>>
  UpdateRecommenderConfiguration& WithAttributes(AttributesT&& value) {
    SetAttributes(std::forward<AttributesT>(value));
    return *this;
  }
  template <typename AttributesKeyT = Aws::String, typename AttributesValueT = Aws::String>
  UpdateRecommenderConfiguration& AddAttributes(AttributesKeyT&& key, AttributesValueT&& value) {
    m_attributesHasBeenSet = true;
  ...
  template <typename DescriptionT = Aws::String>
  UpdateRecommenderConfiguration& WithDescription(DescriptionT&& value) {
  ...
  template <typename NameT = Aws::String>
  UpdateRecommenderConfiguration& WithName(NameT&& value) {
  ...
  void SetRecommendationProviderIdType(RecommendationProviderIdTypeT&& value) {
    ...
    m_recommendationProviderIdType = std::forward<RecommendationProviderIdTypeT>(value);
  }
  template <typename RecommendationProviderIdTypeT = Aws::String>
  UpdateRecommenderConfiguration& WithRecommendationProviderIdType(RecommendationProviderIdTypeT&& value) {
    SetRecommendationProviderIdType(std::forward<RecommendationProviderIdTypeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRecommendationProviderRoleArn(RecommendationProviderRoleArnT&& value) {
    ...
    m_recommendationProviderRoleArn = std::forward<RecommendationProviderRoleArnT>(value);
  }
  template <typename RecommendationProviderRoleArnT = Aws::String>
  UpdateRecommenderConfiguration& WithRecommendationProviderRoleArn(RecommendationProviderRoleArnT&& value) {
    SetRecommendationProviderRoleArn(std::forward<RecommendationProviderRoleArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRecommendationProviderUri(RecommendationProviderUriT&& value) {
    ...
    m_recommendationProviderUri = std::forward<RecommendationProviderUriT>(value);
  }
  template <typename RecommendationProviderUriT = Aws::String>
  UpdateRecommenderConfiguration& WithRecommendationProviderUri(RecommendationProviderUriT&& value) {
    SetRecommendationProviderUri(std::forward<RecommendationProviderUriT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRecommendationTransformerUri(RecommendationTransformerUriT&& value) {
    ...
    m_recommendationTransformerUri = std::forward<RecommendationTransformerUriT>(value);
  }
  template <typename RecommendationTransformerUriT = Aws::String>
  UpdateRecommenderConfiguration& WithRecommendationTransformerUri(RecommendationTransformerUriT&& value) {
    SetRecommendationTransformerUri(std::forward<RecommendationTransformerUriT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRecommendationsDisplayName(RecommendationsDisplayNameT&& value) {
    ...
    m_recommendationsDisplayName = std::forward<RecommendationsDisplayNameT>(value);
  }
  template <typename RecommendationsDisplayNameT = Aws::String>
  UpdateRecommenderConfiguration& WithRecommendationsDisplayName(RecommendationsDisplayNameT&& value) {
    SetRecommendationsDisplayName(std::forward<RecommendationsDisplayNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetRecommendationsPerMessage(int value) {
    m_recommendationsPerMessageHasBeenSet = true;
    m_recommendationsPerMessage = value;
  }
  inline UpdateRecommenderConfiguration& WithRecommendationsPerMessage(int value) {
    SetRecommendationsPerMessage(value);
    return *this;
  }
  ///@}
 private:
