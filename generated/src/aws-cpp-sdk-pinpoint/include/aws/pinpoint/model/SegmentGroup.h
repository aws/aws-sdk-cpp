...
class SegmentGroup {
 public:
  ...
  void SetSourceSegments(SourceSegmentsT&& value) {
    ...
    m_sourceSegments = std::forward<SourceSegmentsT>(value);
  }
  template <typename SourceSegmentsT = Aws::Vector<SegmentReference>>
  SegmentGroup& WithSourceSegments(SourceSegmentsT&& value) {
    SetSourceSegments(std::forward<SourceSegmentsT>(value));
    return *this;
  }
  template <typename SourceSegmentsT = SegmentReference>
  SegmentGroup& AddSourceSegments(SourceSegmentsT&& value) {
    m_sourceSegmentsHasBeenSet = true;
    m_sourceSegments.emplace_back(std::forward<SourceSegmentsT>(value));
    return *this;
  }
  ///@}
  ...
  inline SegmentGroup& WithSourceType(SourceType value) {
    SetSourceType(value);
    return *this;
  }
  ///@}
  ...
  inline SegmentGroup& WithType(Type value) {
    SetType(value);
    return *this;
  }
  ///@}
