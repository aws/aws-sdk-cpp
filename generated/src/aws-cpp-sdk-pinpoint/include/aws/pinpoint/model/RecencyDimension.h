...
class RecencyDimension {
 public:
  ...
  inline void SetDuration(Duration value) {
    m_durationHasBeenSet = true;
    m_duration = value;
  }
  inline RecencyDimension& WithDuration(Duration value) {
    SetDuration(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRecencyType(RecencyType value) {
    m_recencyTypeHasBeenSet = true;
    m_recencyType = value;
  }
  inline RecencyDimension& WithRecencyType(RecencyType value) {
