...
class ClosedDays {
 public:
  ...
  ClosedDays& AddEMAIL(EMAILT&& value) {
    m_eMAILHasBeenSet = true;
    m_eMAIL.emplace_back(std::forward<EMAILT>(value));
    return *this;
  }
  ///@}
  ...
  ClosedDays& AddSMS(SMST&& value) {
    m_sMSHasBeenSet = true;
    m_sMS.emplace_back(std::forward<SMST>(value));
    return *this;
  }
  ///@}
  ...
  ClosedDays& AddVOICE(VOICET&& value) {
    m_vOICEHasBeenSet = true;
    m_vOICE.emplace_back(std::forward<VOICET>(value));
    return *this;
  }
  ///@}
  ...
  ClosedDays& AddCUSTOM(CUSTOMT&& value) {
    m_cUSTOMHasBeenSet = true;
    m_cUSTOM.emplace_back(std::forward<CUSTOMT>(value));
    return *this;
  }
  ///@}
 private:
