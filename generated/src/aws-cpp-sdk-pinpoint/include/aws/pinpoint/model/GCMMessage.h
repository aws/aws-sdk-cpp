...
class GCMMessage {
 public:
  ...
  inline GCMMessage& WithAction(Action value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  void SetCollapseKey(CollapseKeyT&& value) {
    ...
    m_collapseKey = std::forward<CollapseKeyT>(value);
  }
  template <typename CollapseKeyT = Aws::String>
  GCMMessage& WithCollapseKey(CollapseKeyT&& value) {
    SetCollapseKey(std::forward<CollapseKeyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRestrictedPackageName(RestrictedPackageNameT&& value) {
    ...
    m_restrictedPackageName = std::forward<RestrictedPackageNameT>(value);
  }
  template <typename RestrictedPackageNameT = Aws::String>
  GCMMessage& WithRestrictedPackageName(RestrictedPackageNameT&& value) {
    SetRestrictedPackageName(std::forward<RestrictedPackageNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline GCMMessage& WithSilentPush(bool value) {
    SetSilentPush(value);
    return *this;
  }
  ///@}
  ...
  inline GCMMessage& WithTimeToLive(int value) {
    SetTimeToLive(value);
    return *this;
  }
  ///@}
