...
class SendUsersMessagesRequest : public PinpointRequest {
 public:
  ...
  template <typename ApplicationIdT = Aws::String>
  SendUsersMessagesRequest& WithApplicationId(ApplicationIdT&& value) {
  ...
  void SetSendUsersMessageRequest(SendUsersMessageRequestT&& value) {
    m_sendUsersMessageRequestHasBeenSet = true;
    m_sendUsersMessageRequest = std::forward<SendUsersMessageRequestT>(value);
  }
  template <typename SendUsersMessageRequestT = SendUsersMessageRequest>
  SendUsersMessagesRequest& WithSendUsersMessageRequest(SendUsersMessageRequestT&& value) {
    SetSendUsersMessageRequest(std::forward<SendUsersMessageRequestT>(value));
    return *this;
  }
  ///@}
 private:
