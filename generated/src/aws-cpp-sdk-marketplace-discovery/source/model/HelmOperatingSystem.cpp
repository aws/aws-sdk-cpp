...
HelmOperatingSystem::HelmOperatingSystem(JsonView jsonValue) { *this = jsonValue; }

HelmOperatingSystem& HelmOperatingSystem::operator=(JsonView jsonValue) {
...
JsonValue HelmOperatingSystem::Jsonize() const {
  JsonValue payload;
