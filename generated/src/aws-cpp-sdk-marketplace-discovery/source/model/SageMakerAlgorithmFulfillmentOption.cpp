...
SageMakerAlgorithmFulfillmentOption::SageMakerAlgorithmFulfillmentOption(JsonView jsonValue) { *this = jsonValue; }

SageMakerAlgorithmFulfillmentOption& SageMakerAlgorithmFulfillmentOption::operator=(JsonView jsonValue) {
...
JsonValue SageMakerAlgorithmFulfillmentOption::Jsonize() const {
  JsonValue payload;
