...
ContainerFulfillmentOption::ContainerFulfillmentOption(JsonView jsonValue) { *this = jsonValue; }

ContainerFulfillmentOption& ContainerFulfillmentOption::operator=(JsonView jsonValue) {
...
JsonValue ContainerFulfillmentOption::Jsonize() const {
  JsonValue payload;
