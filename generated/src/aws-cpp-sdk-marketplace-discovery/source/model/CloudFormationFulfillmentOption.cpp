...
CloudFormationFulfillmentOption::CloudFormationFulfillmentOption(JsonView jsonValue) { *this = jsonValue; }

CloudFormationFulfillmentOption& CloudFormationFulfillmentOption::operator=(JsonView jsonValue) {
...
JsonValue CloudFormationFulfillmentOption::Jsonize() const {
  JsonValue payload;
