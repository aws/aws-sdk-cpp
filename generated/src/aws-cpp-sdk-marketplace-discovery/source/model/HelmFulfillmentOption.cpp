...
HelmFulfillmentOption::HelmFulfillmentOption(JsonView jsonValue) { *this = jsonValue; }

HelmFulfillmentOption& HelmFulfillmentOption::operator=(JsonView jsonValue) {
...
JsonValue HelmFulfillmentOption::Jsonize() const {
  JsonValue payload;
