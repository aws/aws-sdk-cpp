...
Ec2ImageBuilderComponentFulfillmentOption::Ec2ImageBuilderComponentFulfillmentOption(JsonView jsonValue) { *this = jsonValue; }

Ec2ImageBuilderComponentFulfillmentOption& Ec2ImageBuilderComponentFulfillmentOption::operator=(JsonView jsonValue) {
...
JsonValue Ec2ImageBuilderComponentFulfillmentOption::Jsonize() const {
  JsonValue payload;
