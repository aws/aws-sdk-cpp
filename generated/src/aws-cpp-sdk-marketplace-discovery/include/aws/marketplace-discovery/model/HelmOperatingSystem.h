...
/**
 * <p>Describes an operating system supported by a Helm chart fulfillment
 * option.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/marketplace-discovery-2026-02-05/HelmOperatingSystem">AWS
 * API Reference</a></p>
 */
class HelmOperatingSystem {
 public:
  AWS_MARKETPLACEDISCOVERY_API HelmOperatingSystem() = default;
  AWS_MARKETPLACEDISCOVERY_API HelmOperatingSystem(Aws::Utils::Json::JsonView jsonValue);
  AWS_MARKETPLACEDISCOVERY_API HelmOperatingSystem& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename OperatingSystemFamilyNameT = Aws::String>
  HelmOperatingSystem& WithOperatingSystemFamilyName(OperatingSystemFamilyNameT&& value) {
  ...
  template <typename OperatingSystemNameT = Aws::String>
  HelmOperatingSystem& WithOperatingSystemName(OperatingSystemNameT&& value) {
