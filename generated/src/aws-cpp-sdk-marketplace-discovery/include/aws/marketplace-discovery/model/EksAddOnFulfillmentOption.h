...
/**
 * <p>Describes an Amazon EKS add-on fulfillment option.</p><p><h3>See Also:</h3>
 * <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/marketplace-discovery-2026-02-05/EksAddOnFulfillmentOption">AWS
 * API Reference</a></p>
 */
class EksAddOnFulfillmentOption {
 public:
  AWS_MARKETPLACEDISCOVERY_API EksAddOnFulfillmentOption() = default;
  AWS_MARKETPLACEDISCOVERY_API EksAddOnFulfillmentOption(Aws::Utils::Json::JsonView jsonValue);
  AWS_MARKETPLACEDISCOVERY_API EksAddOnFulfillmentOption& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename FulfillmentOptionIdT = Aws::String>
  EksAddOnFulfillmentOption& WithFulfillmentOptionId(FulfillmentOptionIdT&& value) {
  ...
  template <typename FulfillmentOptionNameT = Aws::String>
  EksAddOnFulfillmentOption& WithFulfillmentOptionName(FulfillmentOptionNameT&& value) {
  ...
  inline EksAddOnFulfillmentOption& WithFulfillmentOptionType(FulfillmentOptionType value) {
  ...
  template <typename FulfillmentOptionDisplayNameT = Aws::String>
  EksAddOnFulfillmentOption& WithFulfillmentOptionDisplayName(FulfillmentOptionDisplayNameT&& value) {
  ...
  template <typename FulfillmentOptionVersionT = Aws::String>
  EksAddOnFulfillmentOption& WithFulfillmentOptionVersion(FulfillmentOptionVersionT&& value) {
   ...
   */
  inline const Aws::Vector<EksAddOnOperatingSystem>& GetOperatingSystems() const { return m_operatingSystems; }
  inline bool OperatingSystemsHasBeenSet() const { return m_operatingSystemsHasBeenSet; }
  template <typename OperatingSystemsT = Aws::Vector<EksAddOnOperatingSystem>>
  ...
  template <typename OperatingSystemsT = Aws::Vector<EksAddOnOperatingSystem>>
  EksAddOnFulfillmentOption& WithOperatingSystems(OperatingSystemsT&& value) {
    SetOperatingSystems(std::forward<OperatingSystemsT>(value));
    return *this;
  }
  template <typename OperatingSystemsT = EksAddOnOperatingSystem>
  EksAddOnFulfillmentOption& AddOperatingSystems(OperatingSystemsT&& value) {
    m_operatingSystemsHasBeenSet = true;
  ...
  template <typename ReleaseNotesT = Aws::String>
  EksAddOnFulfillmentOption& WithReleaseNotes(ReleaseNotesT&& value) {
  ...
  template <typename UsageInstructionsT = Aws::String>
  EksAddOnFulfillmentOption& WithUsageInstructions(UsageInstructionsT&& value) {
  ...
  template <typename AwsSupportedServicesT = Aws::Vector<AwsSupportedService>>
  EksAddOnFulfillmentOption& WithAwsSupportedServices(AwsSupportedServicesT&& value) {
  ...
  EksAddOnFulfillmentOption& AddAwsSupportedServices(AwsSupportedServicesT&& value) {
    m_awsSupportedServicesHasBeenSet = true;
 ...
 private:
  ...
  Aws::Vector<EksAddOnOperatingSystem> m_operatingSystems;
