...
/**
 * <p>Describes an operating system supported by a container fulfillment
 * option.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/marketplace-discovery-2026-02-05/ContainerOperatingSystem">AWS
 * API Reference</a></p>
 */
class ContainerOperatingSystem {
 public:
  AWS_MARKETPLACEDISCOVERY_API ContainerOperatingSystem() = default;
  AWS_MARKETPLACEDISCOVERY_API ContainerOperatingSystem(Aws::Utils::Json::JsonView jsonValue);
  AWS_MARKETPLACEDISCOVERY_API ContainerOperatingSystem& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename OperatingSystemFamilyNameT = Aws::String>
  ContainerOperatingSystem& WithOperatingSystemFamilyName(OperatingSystemFamilyNameT&& value) {
  ...
  template <typename OperatingSystemNameT = Aws::String>
  ContainerOperatingSystem& WithOperatingSystemName(OperatingSystemNameT&& value) {
