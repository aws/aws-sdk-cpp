...
/**
 * <p>Defines a usage-based pricing term (typically pay-as-you-go), where buyers
 * are charged based on product usage.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/marketplace-discovery-2026-02-05/UsageBasedPricingTerm">AWS
 * API Reference</a></p>
 */
class UsageBasedPricingTerm {
 public:
  AWS_MARKETPLACEDISCOVERY_API UsageBasedPricingTerm() = default;
  AWS_MARKETPLACEDISCOVERY_API UsageBasedPricingTerm(Aws::Utils::Json::JsonView jsonValue);
  AWS_MARKETPLACEDISCOVERY_API UsageBasedPricingTerm& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  inline UsageBasedPricingTerm& WithType(TermType value) {
    SetType(value);
    return *this;
  }
  ///@}
