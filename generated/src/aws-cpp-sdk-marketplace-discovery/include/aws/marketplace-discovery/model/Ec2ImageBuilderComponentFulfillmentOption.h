...
/**
 * <p>Describes an EC2 Image Builder component fulfillment option.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/marketplace-discovery-2026-02-05/Ec2ImageBuilderComponentFulfillmentOption">AWS
 * API Reference</a></p>
 */
class Ec2ImageBuilderComponentFulfillmentOption {
 public:
  AWS_MARKETPLACEDISCOVERY_API Ec2ImageBuilderComponentFulfillmentOption() = default;
  AWS_MARKETPLACEDISCOVERY_API Ec2ImageBuilderComponentFulfillmentOption(Aws::Utils::Json::JsonView jsonValue);
  AWS_MARKETPLACEDISCOVERY_API Ec2ImageBuilderComponentFulfillmentOption& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename FulfillmentOptionIdT = Aws::String>
  Ec2ImageBuilderComponentFulfillmentOption& WithFulfillmentOptionId(FulfillmentOptionIdT&& value) {
  ...
  template <typename FulfillmentOptionNameT = Aws::String>
  Ec2ImageBuilderComponentFulfillmentOption& WithFulfillmentOptionName(FulfillmentOptionNameT&& value) {
  ...
  inline Ec2ImageBuilderComponentFulfillmentOption& WithFulfillmentOptionType(FulfillmentOptionType value) {
  ...
  template <typename FulfillmentOptionDisplayNameT = Aws::String>
  Ec2ImageBuilderComponentFulfillmentOption& WithFulfillmentOptionDisplayName(FulfillmentOptionDisplayNameT&& value) {
  ...
  template <typename FulfillmentOptionVersionT = Aws::String>
  Ec2ImageBuilderComponentFulfillmentOption& WithFulfillmentOptionVersion(FulfillmentOptionVersionT&& value) {
  ...
  template <typename OperatingSystemsT = Aws::Vector<ContainerOperatingSystem>>
  Ec2ImageBuilderComponentFulfillmentOption& WithOperatingSystems(OperatingSystemsT&& value) {
    SetOperatingSystems(std::forward<OperatingSystemsT>(value));
    return *this;
  }
  template <typename OperatingSystemsT = ContainerOperatingSystem>
  Ec2ImageBuilderComponentFulfillmentOption& AddOperatingSystems(OperatingSystemsT&& value) {
    m_operatingSystemsHasBeenSet = true;
  ...
  template <typename AwsSupportedServicesT = Aws::Vector<AwsSupportedService>>
  Ec2ImageBuilderComponentFulfillmentOption& WithAwsSupportedServices(AwsSupportedServicesT&& value) {
  ...
  Ec2ImageBuilderComponentFulfillmentOption& AddAwsSupportedServices(AwsSupportedServicesT&& value) {
    m_awsSupportedServicesHasBeenSet = true;
  ...
  template <typename ReleaseNotesT = Aws::String>
  Ec2ImageBuilderComponentFulfillmentOption& WithReleaseNotes(ReleaseNotesT&& value) {
  ...
  template <typename UsageInstructionsT = Aws::String>
  Ec2ImageBuilderComponentFulfillmentOption& WithUsageInstructions(UsageInstructionsT&& value) {
