...
class Item {
 public:
  ...
  void SetAbsoluteTime(AbsoluteTimeT&& value) {
    ...
    m_absoluteTime = std::forward<AbsoluteTimeT>(value);
  }
  template <typename AbsoluteTimeT = Aws::String>
  Item& WithAbsoluteTime(AbsoluteTimeT&& value) {
    SetAbsoluteTime(std::forward<AbsoluteTimeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetType(ChatItemType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline Item& WithType(ChatItemType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline Item& WithParticipantRole(ParticipantRole value) {
