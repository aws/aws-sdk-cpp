...
class CreateParticipantConnectionRequest : public ConnectParticipantRequest {
 public:
  ...
  inline CreateParticipantConnectionRequest& AddType(ConnectionType value) {
    m_typeHasBeenSet = true;
    m_type.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline void SetConnectParticipant(bool value) {
    m_connectParticipantHasBeenSet = true;
    m_connectParticipant = value;
  }
  inline CreateParticipantConnectionRequest& WithConnectParticipant(bool value) {
    SetConnectParticipant(value);
    return *this;
  }
  ///@}
 private:
