...
class GetTranscriptRequest : public ConnectParticipantRequest {
 public:
  ...
  inline GetTranscriptRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline void SetScanDirection(ScanDirection value) {
    m_scanDirectionHasBeenSet = true;
    m_scanDirection = value;
  }
  inline GetTranscriptRequest& WithScanDirection(ScanDirection value) {
    SetScanDirection(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSortOrder(SortKey value) {
    m_sortOrderHasBeenSet = true;
    m_sortOrder = value;
  }
  inline GetTranscriptRequest& WithSortOrder(SortKey value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  void SetStartPosition(StartPositionT&& value) {
    ...
    m_startPosition = std::forward<StartPositionT>(value);
  }
  template <typename StartPositionT = StartPosition>
  GetTranscriptRequest& WithStartPosition(StartPositionT&& value) {
    SetStartPosition(std::forward<StartPositionT>(value));
    return *this;
  }
  ///@}
