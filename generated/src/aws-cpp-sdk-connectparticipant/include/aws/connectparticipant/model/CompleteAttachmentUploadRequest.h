...
class CompleteAttachmentUploadRequest : public ConnectParticipantRequest {
 public:
  ...
  void SetAttachmentIds(AttachmentIdsT&& value) {
    m_attachmentIdsHasBeenSet = true;
    m_attachmentIds = std::forward<AttachmentIdsT>(value);
  }
  template <typename AttachmentIdsT = Aws::Vector<Aws::String>>
  CompleteAttachmentUploadRequest& WithAttachmentIds(AttachmentIdsT&& value) {
    SetAttachmentIds(std::forward<AttachmentIdsT>(value));
    return *this;
  }
  template <typename AttachmentIdsT = Aws::String>
  CompleteAttachmentUploadRequest& AddAttachmentIds(AttachmentIdsT&& value) {
    m_attachmentIdsHasBeenSet = true;
    m_attachmentIds.emplace_back(std::forward<AttachmentIdsT>(value));
    return *this;
  }
  ///@}
