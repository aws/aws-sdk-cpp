...
class CancelParticipantAuthenticationRequest : public ConnectParticipantRequest {
 public:
  ...
  template <typename SessionIdT = Aws::String>
  CancelParticipantAuthenticationRequest& WithSessionId(SessionIdT&& value) {
  ...
  template <typename ConnectionTokenT = Aws::String>
  CancelParticipantAuthenticationRequest& WithConnectionToken(ConnectionTokenT&& value) {
