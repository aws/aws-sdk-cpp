...
class Receipt {
 public:
  ...
  void SetDeliveredTimestamp(DeliveredTimestampT&& value) {
    ...
    m_deliveredTimestamp = std::forward<DeliveredTimestampT>(value);
  }
  template <typename DeliveredTimestampT = Aws::String>
  Receipt& WithDeliveredTimestamp(DeliveredTimestampT&& value) {
    SetDeliveredTimestamp(std::forward<DeliveredTimestampT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReadTimestamp(ReadTimestampT&& value) {
    ...
    m_readTimestamp = std::forward<ReadTimestampT>(value);
  }
  template <typename ReadTimestampT = Aws::String>
  Receipt& WithReadTimestamp(ReadTimestampT&& value) {
    SetReadTimestamp(std::forward<ReadTimestampT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRecipientParticipantId(RecipientParticipantIdT&& value) {
    ...
    m_recipientParticipantId = std::forward<RecipientParticipantIdT>(value);
  }
  template <typename RecipientParticipantIdT = Aws::String>
  Receipt& WithRecipientParticipantId(RecipientParticipantIdT&& value) {
    SetRecipientParticipantId(std::forward<RecipientParticipantIdT>(value));
    return *this;
  }
  ///@}
 private:
