...
namespace ConnectParticipant
{
   ...
   */
  class AWS_CONNECTPARTICIPANT_API ConnectParticipantClient : Aws::Client::ClientWithAsyncTemplateMethods<ConnectParticipantClient>,
    smithy::client::AwsSmithyClientT<Aws::ConnectParticipant::SERVICE_NAME,
