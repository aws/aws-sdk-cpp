 ...
 * Service data types</a> </p> </li> </ul> <p>Connect Customer is an easy-to-use
 * omnichannel cloud contact center service that enables companies of any size to
 * deliver superior customer service at a lower cost. Connect Customer
 * communications capabilities make it easy for companies to deliver personalized
 * interactions across communication channels, including chat. </p> <p>Use the
 * Connect Customer Participant Service to manage participants (for example,
 ...
 * message events, and retrieving chat transcripts.</p>
 */
class AWS_CONNECTPARTICIPANT_API ConnectParticipantClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  ConnectParticipantClient(const Aws::ConnectParticipant::ConnectParticipantClientConfiguration& clientConfiguration =
  ...
  ConnectParticipantClient(const Aws::Auth::AWSCredentials& credentials,
                           std::shared_ptr<ConnectParticipantEndpointProviderBase> endpointProvider = nullptr,
                           const Aws::ConnectParticipant::ConnectParticipantClientConfiguration& clientConfiguration =
                               Aws::ConnectParticipant::ConnectParticipantClientConfiguration());
   ...
   * API Reference</a></p>
   */
  virtual Model::CancelParticipantAuthenticationOutcome CancelParticipantAuthentication(
      const Model::CancelParticipantAuthenticationRequest& request) const;

  /**
   * A Callable wrapper for CancelParticipantAuthentication that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CancelParticipantAuthenticationRequestT = Model::CancelParticipantAuthenticationRequest>
  Model::CancelParticipantAuthenticationOutcomeCallable CancelParticipantAuthenticationCallable(
      const CancelParticipantAuthenticationRequestT& request) const {
    return SubmitCallable(&ConnectParticipantClient::CancelParticipantAuthentication, request);
  }

  /**
   * An Async wrapper for CancelParticipantAuthentication that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CancelParticipantAuthenticationRequestT = Model::CancelParticipantAuthenticationRequest>
  void CancelParticipantAuthenticationAsync(const CancelParticipantAuthenticationRequestT& request,
                                            const CancelParticipantAuthenticationResponseReceivedHandler& handler,
   ...
   * Customer Chat security best practices</a>. </p>  <p>
   ...
   * see <a
   * href="https://docs.aws.amazon.com/connect/latest/adminguide/security-best-practices.html#bp-security-chat">Connect
   * Customer Chat security best practices</a>. </p> <p>For WebRTC security
   ...
   * Customer WebRTC security best practices</a>. </p>  <p>
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateParticipantConnectionOutcome CreateParticipantConnection(
      const Model::CreateParticipantConnectionRequest& request) const;

  /**
   * A Callable wrapper for CreateParticipantConnection that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateParticipantConnectionRequestT = Model::CreateParticipantConnectionRequest>
  Model::CreateParticipantConnectionOutcomeCallable CreateParticipantConnectionCallable(
      const CreateParticipantConnectionRequestT& request) const {
    return SubmitCallable(&ConnectParticipantClient::CreateParticipantConnection, request);
  }

  /**
   * An Async wrapper for CreateParticipantConnection that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateParticipantConnectionRequestT = Model::CreateParticipantConnectionRequest>
  void CreateParticipantConnectionAsync(const CreateParticipantConnectionRequestT& request,
                                        const CreateParticipantConnectionResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * recommendations, see <a
   * href="https://docs.aws.amazon.com/connect/latest/adminguide/security-best-practices.html#bp-security-chat">Connect
   * Customer Chat security best practices</a>. </p><p><h3>See Also:</h3>   <a
   ...
   * recommendations, see <a
   * href="https://docs.aws.amazon.com/connect/latest/adminguide/security-best-practices.html#bp-security-chat">Connect
   * Customer Chat security best practices</a>. </p>  <ul> <li> <p>The
  ...
  /**
   * An Async wrapper for GetAttachment that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetAttachmentRequestT = Model::GetAttachmentRequest>
  void GetAttachmentAsync(const GetAttachmentRequestT& request, const GetAttachmentResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * <a
   * href="https://docs.aws.amazon.com/connect/latest/adminguide/security-best-practices.html#bp-security-chat">Connect
   * Customer Chat security best practices</a>.</p>  <ul> <li> <p>This API can
  ...
  /**
   * A Callable wrapper for GetAuthenticationUrl that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetAuthenticationUrl that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetAuthenticationUrlRequestT = Model::GetAuthenticationUrlRequest>
  void GetAuthenticationUrlAsync(const GetAuthenticationUrlRequestT& request, const GetAuthenticationUrlResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * href="https://docs.aws.amazon.com/connect/latest/adminguide/security-best-practices.html#bp-security-chat">Connect
   * Customer Chat security best practices</a>. </p> <p>If you have a process that
  ...
  /**
   * An Async wrapper for GetTranscript that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetTranscriptRequestT = Model::GetTranscriptRequest>
  void GetTranscriptAsync(const GetTranscriptRequestT& request, const GetTranscriptResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartAttachmentUpload that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartAttachmentUpload that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartAttachmentUploadRequestT = Model::StartAttachmentUploadRequest>
  void StartAttachmentUploadAsync(const StartAttachmentUploadRequestT& request, const StartAttachmentUploadResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
