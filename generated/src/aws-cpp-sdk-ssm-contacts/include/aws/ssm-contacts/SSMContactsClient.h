...
namespace SSMContacts
{
   ...
   */
  class AWS_SSMCONTACTS_API SSMContactsClient : smithy::client::AwsSmithyClientT<Aws::SSMContacts::SERVICE_NAME,
    ...
    Aws::Client::ClientWithAsyncTemplateMethods<SSMContactsClient>
  {
    public:
