...
class ListPreviewRotationShiftsResult {
 public:
  ...
  template <typename RotationShiftsT = Aws::Vector<RotationShift>>
  ListPreviewRotationShiftsResult& WithRotationShifts(RotationShiftsT&& value) {
    SetRotationShifts(std::forward<RotationShiftsT>(value));
    return *this;
  }
  template <typename RotationShiftsT = RotationShift>
  ListPreviewRotationShiftsResult& AddRotationShifts(RotationShiftsT&& value) {
    m_rotationShiftsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListPreviewRotationShiftsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListPreviewRotationShiftsResult& WithRequestId(RequestIdT&& value) {
