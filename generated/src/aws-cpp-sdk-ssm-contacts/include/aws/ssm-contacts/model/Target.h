...
class Target {
 public:
  ...
  void SetChannelTargetInfo(ChannelTargetInfoT&& value) {
    m_channelTargetInfoHasBeenSet = true;
    m_channelTargetInfo = std::forward<ChannelTargetInfoT>(value);
  }
  template <typename ChannelTargetInfoT = ChannelTargetInfo>
  Target& WithChannelTargetInfo(ChannelTargetInfoT&& value) {
    SetChannelTargetInfo(std::forward<ChannelTargetInfoT>(value));
    return *this;
  }
  ///@}
  ...
  void SetContactTargetInfo(ContactTargetInfoT&& value) {
    m_contactTargetInfoHasBeenSet = true;
    m_contactTargetInfo = std::forward<ContactTargetInfoT>(value);
  }
  template <typename ContactTargetInfoT = ContactTargetInfo>
  Target& WithContactTargetInfo(ContactTargetInfoT&& value) {
    SetContactTargetInfo(std::forward<ContactTargetInfoT>(value));
    return *this;
  }
  ///@}
 private:
