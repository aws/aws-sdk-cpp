...
class GetContactPolicyResult {
 public:
  ...
  template <typename ContactArnT = Aws::String>
  GetContactPolicyResult& WithContactArn(ContactArnT&& value) {
  ...
  template <typename PolicyT = Aws::String>
  GetContactPolicyResult& WithPolicy(PolicyT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetContactPolicyResult& WithRequestId(RequestIdT&& value) {
