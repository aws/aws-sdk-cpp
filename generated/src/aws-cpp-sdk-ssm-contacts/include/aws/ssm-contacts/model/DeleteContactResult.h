...
namespace Model
{
  ...
  {
  public:
    AWS_SSMCONTACTS_API DeleteContactResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteContactResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
