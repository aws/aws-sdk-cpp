...
namespace Model
{
  ...
  public:
    ...
    inline ListPagesByEngagementResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ListPagesByEngagementResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ListPagesByEngagementResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
