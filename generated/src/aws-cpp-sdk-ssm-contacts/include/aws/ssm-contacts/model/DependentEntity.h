...
class DependentEntity {
 public:
  ...
  void SetRelationType(RelationTypeT&& value) {
    ...
    m_relationType = std::forward<RelationTypeT>(value);
  }
  template <typename RelationTypeT = Aws::String>
  DependentEntity& WithRelationType(RelationTypeT&& value) {
    SetRelationType(std::forward<RelationTypeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDependentResourceIds(DependentResourceIdsT&& value) {
    ...
    m_dependentResourceIds = std::forward<DependentResourceIdsT>(value);
  }
  template <typename DependentResourceIdsT = Aws::Vector<Aws::String>>
  DependentEntity& WithDependentResourceIds(DependentResourceIdsT&& value) {
    SetDependentResourceIds(std::forward<DependentResourceIdsT>(value));
    return *this;
  }
  template <typename DependentResourceIdsT = Aws::String>
  DependentEntity& AddDependentResourceIds(DependentResourceIdsT&& value) {
    m_dependentResourceIdsHasBeenSet = true;
    m_dependentResourceIds.emplace_back(std::forward<DependentResourceIdsT>(value));
    return *this;
  }
  ///@}
 private:
