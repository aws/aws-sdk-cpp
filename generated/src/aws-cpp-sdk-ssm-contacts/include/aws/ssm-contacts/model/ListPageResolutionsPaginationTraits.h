...
struct ListPageResolutionsPaginationTraits {
  using RequestType = Model::ListPageResolutionsRequest;
  using ResultType = Model::ListPageResolutionsResult;
  using OutcomeType = Model::ListPageResolutionsOutcome;
  using ClientType = Client;

  static OutcomeType Invoke(Client* client, const RequestType& request) { return client->ListPageResolutions(request); }
