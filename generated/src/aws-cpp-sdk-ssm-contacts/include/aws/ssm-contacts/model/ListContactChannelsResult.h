...
class ListContactChannelsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListContactChannelsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetContactChannels(ContactChannelsT&& value) {
    m_contactChannelsHasBeenSet = true;
    m_contactChannels = std::forward<ContactChannelsT>(value);
  }
  template <typename ContactChannelsT = Aws::Vector<ContactChannel>>
  ListContactChannelsResult& WithContactChannels(ContactChannelsT&& value) {
    SetContactChannels(std::forward<ContactChannelsT>(value));
    return *this;
  }
  template <typename ContactChannelsT = ContactChannel>
  ListContactChannelsResult& AddContactChannels(ContactChannelsT&& value) {
    m_contactChannelsHasBeenSet = true;
    m_contactChannels.emplace_back(std::forward<ContactChannelsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListContactChannelsResult& WithRequestId(RequestIdT&& value) {
