...
class ListPageResolutionsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListPageResolutionsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetPageResolutions(PageResolutionsT&& value) {
    m_pageResolutionsHasBeenSet = true;
    m_pageResolutions = std::forward<PageResolutionsT>(value);
  }
  template <typename PageResolutionsT = Aws::Vector<ResolutionContact>>
  ListPageResolutionsResult& WithPageResolutions(PageResolutionsT&& value) {
    SetPageResolutions(std::forward<PageResolutionsT>(value));
    return *this;
  }
  template <typename PageResolutionsT = ResolutionContact>
  ListPageResolutionsResult& AddPageResolutions(PageResolutionsT&& value) {
    m_pageResolutionsHasBeenSet = true;
    m_pageResolutions.emplace_back(std::forward<PageResolutionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListPageResolutionsResult& WithRequestId(RequestIdT&& value) {
