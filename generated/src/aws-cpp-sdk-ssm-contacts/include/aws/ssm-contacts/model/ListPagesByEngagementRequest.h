...
class ListPagesByEngagementRequest : public SSMContactsRequest {
 public:
  ...
  template <typename EngagementIdT = Aws::String>
  ListPagesByEngagementRequest& WithEngagementId(EngagementIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListPagesByEngagementRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListPagesByEngagementRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
