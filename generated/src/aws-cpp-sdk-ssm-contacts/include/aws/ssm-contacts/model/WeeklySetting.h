...
class WeeklySetting {
 public:
  ...
  inline WeeklySetting& WithDayOfWeek(DayOfWeek value) {
    SetDayOfWeek(value);
    return *this;
  }
  ///@}
  ...
  void SetHandOffTime(HandOffTimeT&& value) {
    m_handOffTimeHasBeenSet = true;
    m_handOffTime = std::forward<HandOffTimeT>(value);
  }
  template <typename HandOffTimeT = HandOffTime>
  WeeklySetting& WithHandOffTime(HandOffTimeT&& value) {
    SetHandOffTime(std::forward<HandOffTimeT>(value));
    return *this;
  }
  ///@}
 private:
