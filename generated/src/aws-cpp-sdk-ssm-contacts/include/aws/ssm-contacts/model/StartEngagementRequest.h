...
class StartEngagementRequest : public SSMContactsRequest {
 public:
  ...
  void SetPublicSubject(PublicSubjectT&& value) {
    ...
    m_publicSubject = std::forward<PublicSubjectT>(value);
  }
  template <typename PublicSubjectT = Aws::String>
  StartEngagementRequest& WithPublicSubject(PublicSubjectT&& value) {
    SetPublicSubject(std::forward<PublicSubjectT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPublicContent(PublicContentT&& value) {
    ...
    m_publicContent = std::forward<PublicContentT>(value);
  }
  template <typename PublicContentT = Aws::String>
  StartEngagementRequest& WithPublicContent(PublicContentT&& value) {
    SetPublicContent(std::forward<PublicContentT>(value));
    return *this;
  }
  ///@}
