...
namespace Model
{
  ...
  {
  public:
    AWS_SSMCONTACTS_API ListRotationShiftsResult() = default;
    ...
    template<typename RotationShiftsT = Aws::Vector<RotationShift>>
    ListRotationShiftsResult& WithRotationShifts(RotationShiftsT&& value) { SetRotationShifts(std::forward<RotationShiftsT>(value)); return *this;}
    template<typename RotationShiftsT = RotationShift>
    ListRotationShiftsResult& AddRotationShifts(RotationShiftsT&& value) { m_rotationShiftsHasBeenSet = true; m_rotationShifts.emplace_back(std::forward<RotationShiftsT>(value)); return *this; }
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListRotationShiftsResult& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ListRotationShiftsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
