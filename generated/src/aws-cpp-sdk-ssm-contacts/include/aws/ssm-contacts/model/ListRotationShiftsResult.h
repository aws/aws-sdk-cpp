...
class ListRotationShiftsResult {
 public:
  ...
  void SetRotationShifts(RotationShiftsT&& value) {
    m_rotationShiftsHasBeenSet = true;
    m_rotationShifts = std::forward<RotationShiftsT>(value);
  }
  template <typename RotationShiftsT = Aws::Vector<RotationShift>>
  ListRotationShiftsResult& WithRotationShifts(RotationShiftsT&& value) {
    SetRotationShifts(std::forward<RotationShiftsT>(value));
    return *this;
  }
  template <typename RotationShiftsT = RotationShift>
  ListRotationShiftsResult& AddRotationShifts(RotationShiftsT&& value) {
    m_rotationShiftsHasBeenSet = true;
    m_rotationShifts.emplace_back(std::forward<RotationShiftsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListRotationShiftsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListRotationShiftsResult& WithRequestId(RequestIdT&& value) {
