...
class Receipt {
 public:
  ...
  inline void SetReceiptType(ReceiptType value) {
    m_receiptTypeHasBeenSet = true;
    m_receiptType = value;
  }
  inline Receipt& WithReceiptType(ReceiptType value) {
  ...
  void SetReceiptInfo(ReceiptInfoT&& value) {
    ...
    m_receiptInfo = std::forward<ReceiptInfoT>(value);
  }
  template <typename ReceiptInfoT = Aws::String>
  Receipt& WithReceiptInfo(ReceiptInfoT&& value) {
    SetReceiptInfo(std::forward<ReceiptInfoT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReceiptTime(ReceiptTimeT&& value) {
    ...
    m_receiptTime = std::forward<ReceiptTimeT>(value);
  }
  template <typename ReceiptTimeT = Aws::Utils::DateTime>
  Receipt& WithReceiptTime(ReceiptTimeT&& value) {
    SetReceiptTime(std::forward<ReceiptTimeT>(value));
    return *this;
  }
  ///@}
 private:
