...
class AcceptPageRequest : public SSMContactsRequest {
 public:
  ...
  inline void SetAcceptType(AcceptType value) {
    m_acceptTypeHasBeenSet = true;
    m_acceptType = value;
  }
  inline AcceptPageRequest& WithAcceptType(AcceptType value) {
    SetAcceptType(value);
    return *this;
  }
  ///@}
  ...
  void SetAcceptCode(AcceptCodeT&& value) {
    m_acceptCodeHasBeenSet = true;
    m_acceptCode = std::forward<AcceptCodeT>(value);
  }
  template <typename AcceptCodeT = Aws::String>
  AcceptPageRequest& WithAcceptCode(AcceptCodeT&& value) {
    SetAcceptCode(std::forward<AcceptCodeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAcceptCodeValidation(AcceptCodeValidation value) {
    m_acceptCodeValidationHasBeenSet = true;
    m_acceptCodeValidation = value;
  }
  inline AcceptPageRequest& WithAcceptCodeValidation(AcceptCodeValidation value) {
    SetAcceptCodeValidation(value);
    return *this;
  }
  ///@}
 private:
