...
namespace Model
{
  ...
  {
  public:
    AWS_SSMCONTACTS_API ActivateContactChannelResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    ActivateContactChannelResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
