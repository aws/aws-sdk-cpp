...
class ListRotationsRequest : public SSMContactsRequest {
 public:
  ...
  void SetRotationNamePrefix(RotationNamePrefixT&& value) {
    m_rotationNamePrefixHasBeenSet = true;
    m_rotationNamePrefix = std::forward<RotationNamePrefixT>(value);
  }
  template <typename RotationNamePrefixT = Aws::String>
  ListRotationsRequest& WithRotationNamePrefix(RotationNamePrefixT&& value) {
    SetRotationNamePrefix(std::forward<RotationNamePrefixT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListRotationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListRotationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
