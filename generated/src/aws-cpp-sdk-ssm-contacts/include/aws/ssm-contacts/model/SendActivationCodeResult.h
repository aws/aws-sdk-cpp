...
namespace Model
{
  ...
  {
  public:
    AWS_SSMCONTACTS_API SendActivationCodeResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    SendActivationCodeResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
