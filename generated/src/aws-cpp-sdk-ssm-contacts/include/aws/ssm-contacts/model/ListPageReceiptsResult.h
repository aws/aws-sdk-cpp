...
class ListPageReceiptsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListPageReceiptsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ReceiptsT = Aws::Vector<Receipt>>
  ListPageReceiptsResult& WithReceipts(ReceiptsT&& value) {
    SetReceipts(std::forward<ReceiptsT>(value));
    return *this;
  }
  template <typename ReceiptsT = Receipt>
  ListPageReceiptsResult& AddReceipts(ReceiptsT&& value) {
    m_receiptsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListPageReceiptsResult& WithRequestId(RequestIdT&& value) {
