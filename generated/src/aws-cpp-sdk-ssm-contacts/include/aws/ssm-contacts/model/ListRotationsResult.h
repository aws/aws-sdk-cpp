...
class ListRotationsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListRotationsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetRotations(RotationsT&& value) {
    ...
    m_rotations = std::forward<RotationsT>(value);
  }
  template <typename RotationsT = Aws::Vector<Rotation>>
  ListRotationsResult& WithRotations(RotationsT&& value) {
    SetRotations(std::forward<RotationsT>(value));
    return *this;
  }
  template <typename RotationsT = Rotation>
  ListRotationsResult& AddRotations(RotationsT&& value) {
    m_rotationsHasBeenSet = true;
    m_rotations.emplace_back(std::forward<RotationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListRotationsResult& WithRequestId(RequestIdT&& value) {
