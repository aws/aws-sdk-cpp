...
namespace Model
{
  ...
  {
  public:
    AWS_SSMCONTACTS_API UpdateRotationResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateRotationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
