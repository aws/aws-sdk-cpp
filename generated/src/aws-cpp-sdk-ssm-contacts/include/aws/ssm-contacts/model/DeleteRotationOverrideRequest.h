...
namespace Model
{
  ...
  {
  public:
    AWS_SSMCONTACTS_API DeleteRotationOverrideRequest() = default;
    ...
    template<typename RotationIdT = Aws::String>
    DeleteRotationOverrideRequest& WithRotationId(RotationIdT&& value) { SetRotationId(std::forward<RotationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RotationOverrideIdT = Aws::String>
    DeleteRotationOverrideRequest& WithRotationOverrideId(RotationOverrideIdT&& value) { SetRotationOverrideId(std::forward<RotationOverrideIdT>(value)); return *this;}
    ///@}
  private:
