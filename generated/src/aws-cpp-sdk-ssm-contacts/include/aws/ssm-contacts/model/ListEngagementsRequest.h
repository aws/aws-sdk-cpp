...
class ListEngagementsRequest : public SSMContactsRequest {
 public:
  ...
  void SetTimeRangeValue(TimeRangeValueT&& value) {
    m_timeRangeValueHasBeenSet = true;
    m_timeRangeValue = std::forward<TimeRangeValueT>(value);
  }
  template <typename TimeRangeValueT = TimeRange>
  ListEngagementsRequest& WithTimeRangeValue(TimeRangeValueT&& value) {
    SetTimeRangeValue(std::forward<TimeRangeValueT>(value));
    return *this;
  }
  ///@}
 private:
