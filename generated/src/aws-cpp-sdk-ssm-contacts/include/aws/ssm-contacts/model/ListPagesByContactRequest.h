...
class ListPagesByContactRequest : public SSMContactsRequest {
 public:
  ...
  template <typename ContactIdT = Aws::String>
  ListPagesByContactRequest& WithContactId(ContactIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListPagesByContactRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListPagesByContactRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
