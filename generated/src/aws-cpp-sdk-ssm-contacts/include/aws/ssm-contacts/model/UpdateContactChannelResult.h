...
namespace Model
{
  ...
  {
  public:
    AWS_SSMCONTACTS_API UpdateContactChannelResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateContactChannelResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
