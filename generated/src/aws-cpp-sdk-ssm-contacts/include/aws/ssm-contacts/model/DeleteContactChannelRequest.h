...
namespace Model
{
  ...
  {
  public:
    AWS_SSMCONTACTS_API DeleteContactChannelRequest() = default;
    ...
    template<typename ContactChannelIdT = Aws::String>
    DeleteContactChannelRequest& WithContactChannelId(ContactChannelIdT&& value) { SetContactChannelId(std::forward<ContactChannelIdT>(value)); return *this;}
    ///@}
  private:
