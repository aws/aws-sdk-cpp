...
class ListContactsRequest : public SSMContactsRequest {
 public:
  ...
  inline ListContactsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  void SetAliasPrefix(AliasPrefixT&& value) {
    m_aliasPrefixHasBeenSet = true;
    m_aliasPrefix = std::forward<AliasPrefixT>(value);
  }
  template <typename AliasPrefixT = Aws::String>
  ListContactsRequest& WithAliasPrefix(AliasPrefixT&& value) {
    SetAliasPrefix(std::forward<AliasPrefixT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListContactsRequest& WithType(ContactType value) {
    SetType(value);
    return *this;
  }
  ///@}
