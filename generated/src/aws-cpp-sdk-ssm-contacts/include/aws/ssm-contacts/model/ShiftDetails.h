...
class ShiftDetails {
 public:
  ...
  void SetOverriddenContactIds(OverriddenContactIdsT&& value) {
    m_overriddenContactIdsHasBeenSet = true;
    m_overriddenContactIds = std::forward<OverriddenContactIdsT>(value);
  }
  template <typename OverriddenContactIdsT = Aws::Vector<Aws::String>>
  ShiftDetails& WithOverriddenContactIds(OverriddenContactIdsT&& value) {
    SetOverriddenContactIds(std::forward<OverriddenContactIdsT>(value));
    return *this;
  }
  template <typename OverriddenContactIdsT = Aws::String>
  ShiftDetails& AddOverriddenContactIds(OverriddenContactIdsT&& value) {
    m_overriddenContactIdsHasBeenSet = true;
    m_overriddenContactIds.emplace_back(std::forward<OverriddenContactIdsT>(value));
    return *this;
  }
  ///@}
 private:
