...
class RotationShift {
 public:
  ...
  inline void SetType(ShiftType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline RotationShift& WithType(ShiftType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetShiftDetails(ShiftDetailsT&& value) {
    ...
    m_shiftDetails = std::forward<ShiftDetailsT>(value);
  }
  template <typename ShiftDetailsT = ShiftDetails>
  RotationShift& WithShiftDetails(ShiftDetailsT&& value) {
    SetShiftDetails(std::forward<ShiftDetailsT>(value));
    return *this;
  }
  ///@}
 private:
