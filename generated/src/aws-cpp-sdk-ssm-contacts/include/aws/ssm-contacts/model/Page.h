...
class Page {
 public:
  ...
  void SetPageArn(PageArnT&& value) {
    ...
    m_pageArn = std::forward<PageArnT>(value);
  }
  template <typename PageArnT = Aws::String>
  Page& WithPageArn(PageArnT&& value) {
    SetPageArn(std::forward<PageArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIncidentId(IncidentIdT&& value) {
    ...
    m_incidentId = std::forward<IncidentIdT>(value);
  }
  template <typename IncidentIdT = Aws::String>
  Page& WithIncidentId(IncidentIdT&& value) {
    SetIncidentId(std::forward<IncidentIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSentTime(SentTimeT&& value) {
    ...
    m_sentTime = std::forward<SentTimeT>(value);
  }
  template <typename SentTimeT = Aws::Utils::DateTime>
  Page& WithSentTime(SentTimeT&& value) {
    SetSentTime(std::forward<SentTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDeliveryTime(DeliveryTimeT&& value) {
    ...
    m_deliveryTime = std::forward<DeliveryTimeT>(value);
  }
  template <typename DeliveryTimeT = Aws::Utils::DateTime>
  Page& WithDeliveryTime(DeliveryTimeT&& value) {
    SetDeliveryTime(std::forward<DeliveryTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReadTime(ReadTimeT&& value) {
    ...
    m_readTime = std::forward<ReadTimeT>(value);
  }
  template <typename ReadTimeT = Aws::Utils::DateTime>
  Page& WithReadTime(ReadTimeT&& value) {
    SetReadTime(std::forward<ReadTimeT>(value));
    return *this;
  }
  ///@}
 private:
