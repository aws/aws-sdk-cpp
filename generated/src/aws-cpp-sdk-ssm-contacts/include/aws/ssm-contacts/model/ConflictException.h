...
class ConflictException {
 public:
  ...
  void SetDependentEntities(DependentEntitiesT&& value) {
    ...
    m_dependentEntities = std::forward<DependentEntitiesT>(value);
  }
  template <typename DependentEntitiesT = Aws::Vector<DependentEntity>>
  ConflictException& WithDependentEntities(DependentEntitiesT&& value) {
    SetDependentEntities(std::forward<DependentEntitiesT>(value));
    return *this;
  }
  template <typename DependentEntitiesT = DependentEntity>
  ConflictException& AddDependentEntities(DependentEntitiesT&& value) {
    m_dependentEntitiesHasBeenSet = true;
    m_dependentEntities.emplace_back(std::forward<DependentEntitiesT>(value));
    return *this;
  }
  ///@}
 private:
