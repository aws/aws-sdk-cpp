...
class RecurrenceSettings {
 public:
  ...
  void SetMonthlySettings(MonthlySettingsT&& value) {
    ...
    m_monthlySettings = std::forward<MonthlySettingsT>(value);
  }
  template <typename MonthlySettingsT = Aws::Vector<MonthlySetting>>
  RecurrenceSettings& WithMonthlySettings(MonthlySettingsT&& value) {
    SetMonthlySettings(std::forward<MonthlySettingsT>(value));
    return *this;
  }
  template <typename MonthlySettingsT = MonthlySetting>
  RecurrenceSettings& AddMonthlySettings(MonthlySettingsT&& value) {
    m_monthlySettingsHasBeenSet = true;
    m_monthlySettings.emplace_back(std::forward<MonthlySettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetWeeklySettings(WeeklySettingsT&& value) {
    ...
    m_weeklySettings = std::forward<WeeklySettingsT>(value);
  }
  template <typename WeeklySettingsT = Aws::Vector<WeeklySetting>>
  RecurrenceSettings& WithWeeklySettings(WeeklySettingsT&& value) {
    SetWeeklySettings(std::forward<WeeklySettingsT>(value));
    return *this;
  }
  template <typename WeeklySettingsT = WeeklySetting>
  RecurrenceSettings& AddWeeklySettings(WeeklySettingsT&& value) {
    m_weeklySettingsHasBeenSet = true;
    m_weeklySettings.emplace_back(std::forward<WeeklySettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDailySettings(DailySettingsT&& value) {
    ...
    m_dailySettings = std::forward<DailySettingsT>(value);
  }
  template <typename DailySettingsT = Aws::Vector<HandOffTime>>
  RecurrenceSettings& WithDailySettings(DailySettingsT&& value) {
    SetDailySettings(std::forward<DailySettingsT>(value));
    return *this;
  }
  template <typename DailySettingsT = HandOffTime>
  RecurrenceSettings& AddDailySettings(DailySettingsT&& value) {
    m_dailySettingsHasBeenSet = true;
    m_dailySettings.emplace_back(std::forward<DailySettingsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetNumberOfOnCalls(int value) {
    m_numberOfOnCallsHasBeenSet = true;
    m_numberOfOnCalls = value;
  }
  inline RecurrenceSettings& WithNumberOfOnCalls(int value) {
    SetNumberOfOnCalls(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRecurrenceMultiplier(int value) {
    m_recurrenceMultiplierHasBeenSet = true;
    m_recurrenceMultiplier = value;
  }
  inline RecurrenceSettings& WithRecurrenceMultiplier(int value) {
    SetRecurrenceMultiplier(value);
    return *this;
  }
  ///@}
 private:
