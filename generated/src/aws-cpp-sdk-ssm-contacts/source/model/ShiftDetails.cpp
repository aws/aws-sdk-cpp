...
ShiftDetails::ShiftDetails(JsonView jsonValue) { *this = jsonValue; }
...
ShiftDetails& ShiftDetails::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("OverriddenContactIds")) {
    ...
    for (unsigned overriddenContactIdsIndex = 0; overriddenContactIdsIndex < overriddenContactIdsJsonList.GetLength();
         ++overriddenContactIdsIndex) {
