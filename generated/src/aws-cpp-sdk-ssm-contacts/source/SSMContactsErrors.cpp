...
template <>
AWS_SSMCONTACTS_API ConflictException SSMContactsError::GetModeledError() {
  assert(this->GetErrorType() == SSMContactsErrors::CONFLICT);
  return ConflictException(this->GetJsonPayload().View());
}

template <>
AWS_SSMCONTACTS_API ThrottlingException SSMContactsError::GetModeledError() {
  assert(this->GetErrorType() == SSMContactsErrors::THROTTLING);
  return ThrottlingException(this->GetJsonPayload().View());
}

template <>
AWS_SSMCONTACTS_API ServiceQuotaExceededException SSMContactsError::GetModeledError() {
  assert(this->GetErrorType() == SSMContactsErrors::SERVICE_QUOTA_EXCEEDED);
  return ServiceQuotaExceededException(this->GetJsonPayload().View());
}

template <>
AWS_SSMCONTACTS_API InternalServerException SSMContactsError::GetModeledError() {
  assert(this->GetErrorType() == SSMContactsErrors::INTERNAL_SERVER);
  return InternalServerException(this->GetJsonPayload().View());
}

template <>
AWS_SSMCONTACTS_API ResourceNotFoundException SSMContactsError::GetModeledError() {
  assert(this->GetErrorType() == SSMContactsErrors::RESOURCE_NOT_FOUND);
  return ResourceNotFoundException(this->GetJsonPayload().View());
}

template <>
AWS_SSMCONTACTS_API ValidationException SSMContactsError::GetModeledError() {
