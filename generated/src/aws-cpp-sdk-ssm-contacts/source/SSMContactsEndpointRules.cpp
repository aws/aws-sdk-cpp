...
{
const size_t SSMContactsEndpointRules::RulesBlobStrLen = 3748;
const size_t SSMContactsEndpointRules::RulesBlobSize = 3749;
...
't','t','p','s',':','/','/','s','s','m','-','c','o','n','t','a','c','t','s','-','f','i','p','s','.',
...
's','m','-','c','o','n','t','a','c','t','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r',
