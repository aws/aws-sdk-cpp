...
class ListControlMappingsResult {
 public:
  ...
  void SetControlMappings(ControlMappingsT&& value) {
    m_controlMappingsHasBeenSet = true;
    m_controlMappings = std::forward<ControlMappingsT>(value);
  }
  template <typename ControlMappingsT = Aws::Vector<ControlMapping>>
  ListControlMappingsResult& WithControlMappings(ControlMappingsT&& value) {
    SetControlMappings(std::forward<ControlMappingsT>(value));
    return *this;
  }
  template <typename ControlMappingsT = ControlMapping>
  ListControlMappingsResult& AddControlMappings(ControlMappingsT&& value) {
    m_controlMappingsHasBeenSet = true;
    m_controlMappings.emplace_back(std::forward<ControlMappingsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListControlMappingsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListControlMappingsResult& WithRequestId(RequestIdT&& value) {
