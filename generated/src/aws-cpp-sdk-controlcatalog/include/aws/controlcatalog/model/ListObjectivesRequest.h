...
class ListObjectivesRequest : public ControlCatalogRequest {
 public:
  ...
  inline ListObjectivesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListObjectivesRequest& WithNextToken(NextTokenT&& value) {
  ...
  void SetObjectiveFilter(ObjectiveFilterT&& value) {
    m_objectiveFilterHasBeenSet = true;
    m_objectiveFilter = std::forward<ObjectiveFilterT>(value);
  }
  template <typename ObjectiveFilterT = ObjectiveFilter>
  ListObjectivesRequest& WithObjectiveFilter(ObjectiveFilterT&& value) {
    SetObjectiveFilter(std::forward<ObjectiveFilterT>(value));
    return *this;
  }
  ///@}
 private:
