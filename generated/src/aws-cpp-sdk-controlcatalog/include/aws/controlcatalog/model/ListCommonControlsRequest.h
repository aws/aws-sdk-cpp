...
class ListCommonControlsRequest : public ControlCatalogRequest {
 public:
  ...
  inline ListCommonControlsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListCommonControlsRequest& WithNextToken(NextTokenT&& value) {
  ...
  void SetCommonControlFilter(CommonControlFilterT&& value) {
    m_commonControlFilterHasBeenSet = true;
    m_commonControlFilter = std::forward<CommonControlFilterT>(value);
  }
  template <typename CommonControlFilterT = CommonControlFilter>
  ListCommonControlsRequest& WithCommonControlFilter(CommonControlFilterT&& value) {
    SetCommonControlFilter(std::forward<CommonControlFilterT>(value));
    return *this;
  }
  ///@}
 private:
