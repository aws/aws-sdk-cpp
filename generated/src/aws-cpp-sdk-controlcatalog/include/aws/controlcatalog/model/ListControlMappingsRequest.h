...
class ListControlMappingsRequest : public ControlCatalogRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListControlMappingsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListControlMappingsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename FilterT = ControlMappingFilter>
  ListControlMappingsRequest& WithFilter(FilterT&& value) {
