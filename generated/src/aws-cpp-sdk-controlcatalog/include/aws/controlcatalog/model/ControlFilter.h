...
class ControlFilter {
 public:
  ...
  void SetImplementations(ImplementationsT&& value) {
    m_implementationsHasBeenSet = true;
    m_implementations = std::forward<ImplementationsT>(value);
  }
  template <typename ImplementationsT = ImplementationFilter>
  ControlFilter& WithImplementations(ImplementationsT&& value) {
    SetImplementations(std::forward<ImplementationsT>(value));
    return *this;
  }
  ///@}
