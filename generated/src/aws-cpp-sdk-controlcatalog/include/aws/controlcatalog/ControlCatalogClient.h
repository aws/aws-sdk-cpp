...
class AWS_CONTROLCATALOG_API ControlCatalogClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  ControlCatalogClient(const Aws::ControlCatalog::ControlCatalogClientConfiguration& clientConfiguration =
  ...
  ControlCatalogClient(const Aws::Auth::AWSCredentials& credentials,
                       std::shared_ptr<ControlCatalogEndpointProviderBase> endpointProvider = nullptr,
                       const Aws::ControlCatalog::ControlCatalogClientConfiguration& clientConfiguration =
                           Aws::ControlCatalog::ControlCatalogClientConfiguration());
  ...
  /**
   * An Async wrapper for GetControl that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetControlRequestT = Model::GetControlRequest>
  void GetControlAsync(const GetControlRequestT& request, const GetControlResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for ListCommonControls that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListCommonControls that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListCommonControlsRequestT = Model::ListCommonControlsRequest>
  void ListCommonControlsAsync(const ListCommonControlsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const ListCommonControlsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListControlMappings that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListControlMappings that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListControlMappingsRequestT = Model::ListControlMappingsRequest>
  void ListControlMappingsAsync(const ListControlMappingsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const ListControlMappingsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListControls that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListControlsRequestT = Model::ListControlsRequest>
  void ListControlsAsync(const ListControlsResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                         const ListControlsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListObjectives that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListObjectivesRequestT = Model::ListObjectivesRequest>
  void ListObjectivesAsync(const ListObjectivesResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const ListObjectivesRequestT& request = {}) const {
