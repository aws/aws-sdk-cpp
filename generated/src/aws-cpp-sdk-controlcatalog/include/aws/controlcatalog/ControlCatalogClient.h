...
namespace ControlCatalog
{
   ...
   * </ul>
   */
  class AWS_CONTROLCATALOG_API ControlCatalogClient : Aws::Client::ClientWithAsyncTemplateMethods<ControlCatalogClient>,
    smithy::client::AwsSmithyClientT<Aws::ControlCatalog::SERVICE_NAME,
