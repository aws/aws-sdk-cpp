...
KxDatabaseConfiguration::KxDatabaseConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
KxDatabaseConfiguration& KxDatabaseConfiguration::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("cacheConfigurations")) {
    ...
    for (unsigned cacheConfigurationsIndex = 0; cacheConfigurationsIndex < cacheConfigurationsJsonList.GetLength();
         ++cacheConfigurationsIndex) {
