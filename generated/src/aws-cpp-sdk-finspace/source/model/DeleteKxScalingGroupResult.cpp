...
DeleteKxScalingGroupResult::DeleteKxScalingGroupResult()
{
}

DeleteKxScalingGroupResult::DeleteKxScalingGroupResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
