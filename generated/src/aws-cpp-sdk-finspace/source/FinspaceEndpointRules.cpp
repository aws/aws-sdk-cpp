...
namespace finspace
{
const size_t FinspaceEndpointRules::RulesBlobStrLen = 3732;
const size_t FinspaceEndpointRules::RulesBlobSize = 3733;
...
'{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','f','i','n','s','p','a','c','e','.',
...
'p','a','c','e','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R',
