...
namespace finspace
{
const size_t FinspaceEndpointRules::RulesBlobStrLen = 3480;
const size_t FinspaceEndpointRules::RulesBlobSize = 3481;
...
'i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','f','i','n','s',
'p','a','c','e','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i',
...
'u','r','l','"',':','"','h','t','t','p','s',':','/','/','f','i','n','s','p','a','c','e','-','f','i',
...
':','"','h','t','t','p','s',':','/','/','f','i','n','s','p','a','c','e','.','{','R','e','g','i','o',
...
'n','s','p','a','c','e','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o',
...
const char* FinspaceEndpointRules::GetRulesBlob()
{
