...
class ListKxVolumesResult {
 public:
  ...
  void SetKxVolumeSummaries(KxVolumeSummariesT&& value) {
    m_kxVolumeSummariesHasBeenSet = true;
    m_kxVolumeSummaries = std::forward<KxVolumeSummariesT>(value);
  }
  template <typename KxVolumeSummariesT = Aws::Vector<KxVolume>>
  ListKxVolumesResult& WithKxVolumeSummaries(KxVolumeSummariesT&& value) {
    SetKxVolumeSummaries(std::forward<KxVolumeSummariesT>(value));
    return *this;
  }
  template <typename KxVolumeSummariesT = KxVolume>
  ListKxVolumesResult& AddKxVolumeSummaries(KxVolumeSummariesT&& value) {
    m_kxVolumeSummariesHasBeenSet = true;
    m_kxVolumeSummaries.emplace_back(std::forward<KxVolumeSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListKxVolumesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListKxVolumesResult& WithRequestId(RequestIdT&& value) {
