...
class KxEnvironment {
 public:
  ...
  inline KxEnvironment& WithStatus(EnvironmentStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline KxEnvironment& WithTgwStatus(TgwStatus value) {
    SetTgwStatus(value);
    return *this;
  }
  ///@}
  ...
  inline KxEnvironment& WithDnsStatus(DnsStatus value) {
    SetDnsStatus(value);
    return *this;
  }
  ///@}
