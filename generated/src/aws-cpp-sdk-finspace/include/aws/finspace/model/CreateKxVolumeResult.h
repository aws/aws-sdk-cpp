...
class CreateKxVolumeResult {
 public:
  ...
  inline CreateKxVolumeResult& WithVolumeType(KxVolumeType value) {
    SetVolumeType(value);
    return *this;
  }
  ///@}
  ...
  inline CreateKxVolumeResult& WithStatus(KxVolumeStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline CreateKxVolumeResult& WithAzMode(KxAzMode value) {
    SetAzMode(value);
    return *this;
  }
  ///@}
