...
namespace Model
{
  class UpdateKxEnvironmentNetworkResult
  {
  public:
    AWS_FINSPACE_API UpdateKxEnvironmentNetworkResult() = default;
    AWS_FINSPACE_API UpdateKxEnvironmentNetworkResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_FINSPACE_API UpdateKxEnvironmentNetworkResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ...
    template<typename NameT = Aws::String>
    UpdateKxEnvironmentNetworkResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename EnvironmentIdT = Aws::String>
    UpdateKxEnvironmentNetworkResult& WithEnvironmentId(EnvironmentIdT&& value) { SetEnvironmentId(std::forward<EnvironmentIdT>(value)); return *this;}
    ///@}
    ...
    template<typename AwsAccountIdT = Aws::String>
    UpdateKxEnvironmentNetworkResult& WithAwsAccountId(AwsAccountIdT&& value) { SetAwsAccountId(std::forward<AwsAccountIdT>(value)); return *this;}
    ///@}
    ...
    inline UpdateKxEnvironmentNetworkResult& WithStatus(EnvironmentStatus value) { SetStatus(value); return *this;}
    ///@}
    ...
    inline UpdateKxEnvironmentNetworkResult& WithTgwStatus(TgwStatus value) { SetTgwStatus(value); return *this;}
    ///@}
    ...
    inline UpdateKxEnvironmentNetworkResult& WithDnsStatus(DnsStatus value) { SetDnsStatus(value); return *this;}
    ///@}
    ...
    template<typename ErrorMessageT = Aws::String>
    UpdateKxEnvironmentNetworkResult& WithErrorMessage(ErrorMessageT&& value) { SetErrorMessage(std::forward<ErrorMessageT>(value)); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    UpdateKxEnvironmentNetworkResult& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename EnvironmentArnT = Aws::String>
    UpdateKxEnvironmentNetworkResult& WithEnvironmentArn(EnvironmentArnT&& value) { SetEnvironmentArn(std::forward<EnvironmentArnT>(value)); return *this;}
    ///@}
    ...
    template<typename KmsKeyIdT = Aws::String>
    UpdateKxEnvironmentNetworkResult& WithKmsKeyId(KmsKeyIdT&& value) { SetKmsKeyId(std::forward<KmsKeyIdT>(value)); return *this;}
    ///@}
    ...
    template<typename DedicatedServiceAccountIdT = Aws::String>
    UpdateKxEnvironmentNetworkResult& WithDedicatedServiceAccountId(DedicatedServiceAccountIdT&& value) { SetDedicatedServiceAccountId(std::forward<DedicatedServiceAccountIdT>(value)); return *this;}
    ///@}
    ...
    template<typename TransitGatewayConfigurationT = TransitGatewayConfiguration>
    UpdateKxEnvironmentNetworkResult& WithTransitGatewayConfiguration(TransitGatewayConfigurationT&& value) { SetTransitGatewayConfiguration(std::forward<TransitGatewayConfigurationT>(value)); return *this;}
    ///@}
    ...
    template<typename CustomDNSConfigurationT = Aws::Vector<CustomDNSServer>>
    UpdateKxEnvironmentNetworkResult& WithCustomDNSConfiguration(CustomDNSConfigurationT&& value) { SetCustomDNSConfiguration(std::forward<CustomDNSConfigurationT>(value)); return *this;}
    template<typename CustomDNSConfigurationT = CustomDNSServer>
    UpdateKxEnvironmentNetworkResult& AddCustomDNSConfiguration(CustomDNSConfigurationT&& value) { m_customDNSConfigurationHasBeenSet = true; m_customDNSConfiguration.emplace_back(std::forward<CustomDNSConfigurationT>(value)); return *this; }
    ///@}
    ...
    template<typename CreationTimestampT = Aws::Utils::DateTime>
    UpdateKxEnvironmentNetworkResult& WithCreationTimestamp(CreationTimestampT&& value) { SetCreationTimestamp(std::forward<CreationTimestampT>(value)); return *this;}
    ///@}
    ...
    template<typename UpdateTimestampT = Aws::Utils::DateTime>
    UpdateKxEnvironmentNetworkResult& WithUpdateTimestamp(UpdateTimestampT&& value) { SetUpdateTimestamp(std::forward<UpdateTimestampT>(value)); return *this;}
    ///@}
    ...
    template<typename AvailabilityZoneIdsT = Aws::Vector<Aws::String>>
    UpdateKxEnvironmentNetworkResult& WithAvailabilityZoneIds(AvailabilityZoneIdsT&& value) { SetAvailabilityZoneIds(std::forward<AvailabilityZoneIdsT>(value)); return *this;}
    template<typename AvailabilityZoneIdsT = Aws::String>
    UpdateKxEnvironmentNetworkResult& AddAvailabilityZoneIds(AvailabilityZoneIdsT&& value) { m_availabilityZoneIdsHasBeenSet = true; m_availabilityZoneIds.emplace_back(std::forward<AvailabilityZoneIdsT>(value)); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateKxEnvironmentNetworkResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
