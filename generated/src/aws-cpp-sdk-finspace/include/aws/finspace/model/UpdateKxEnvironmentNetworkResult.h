...
class UpdateKxEnvironmentNetworkResult {
 public:
  ...
  template <typename NameT = Aws::String>
  UpdateKxEnvironmentNetworkResult& WithName(NameT&& value) {
  ...
  template <typename EnvironmentIdT = Aws::String>
  UpdateKxEnvironmentNetworkResult& WithEnvironmentId(EnvironmentIdT&& value) {
  ...
  template <typename AwsAccountIdT = Aws::String>
  UpdateKxEnvironmentNetworkResult& WithAwsAccountId(AwsAccountIdT&& value) {
  ...
  inline UpdateKxEnvironmentNetworkResult& WithStatus(EnvironmentStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateKxEnvironmentNetworkResult& WithTgwStatus(TgwStatus value) {
    SetTgwStatus(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateKxEnvironmentNetworkResult& WithDnsStatus(DnsStatus value) {
    SetDnsStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ErrorMessageT = Aws::String>
  UpdateKxEnvironmentNetworkResult& WithErrorMessage(ErrorMessageT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateKxEnvironmentNetworkResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename EnvironmentArnT = Aws::String>
  UpdateKxEnvironmentNetworkResult& WithEnvironmentArn(EnvironmentArnT&& value) {
  ...
  template <typename KmsKeyIdT = Aws::String>
  UpdateKxEnvironmentNetworkResult& WithKmsKeyId(KmsKeyIdT&& value) {
  ...
  template <typename DedicatedServiceAccountIdT = Aws::String>
  UpdateKxEnvironmentNetworkResult& WithDedicatedServiceAccountId(DedicatedServiceAccountIdT&& value) {
  ...
  template <typename TransitGatewayConfigurationT = TransitGatewayConfiguration>
  UpdateKxEnvironmentNetworkResult& WithTransitGatewayConfiguration(TransitGatewayConfigurationT&& value) {
  ...
  template <typename CustomDNSConfigurationT = Aws::Vector<CustomDNSServer>>
  UpdateKxEnvironmentNetworkResult& WithCustomDNSConfiguration(CustomDNSConfigurationT&& value) {
  ...
  UpdateKxEnvironmentNetworkResult& AddCustomDNSConfiguration(CustomDNSConfigurationT&& value) {
    m_customDNSConfigurationHasBeenSet = true;
  ...
  template <typename CreationTimestampT = Aws::Utils::DateTime>
  UpdateKxEnvironmentNetworkResult& WithCreationTimestamp(CreationTimestampT&& value) {
  ...
  template <typename UpdateTimestampT = Aws::Utils::DateTime>
  UpdateKxEnvironmentNetworkResult& WithUpdateTimestamp(UpdateTimestampT&& value) {
  ...
  template <typename AvailabilityZoneIdsT = Aws::Vector<Aws::String>>
  UpdateKxEnvironmentNetworkResult& WithAvailabilityZoneIds(AvailabilityZoneIdsT&& value) {
    SetAvailabilityZoneIds(std::forward<AvailabilityZoneIdsT>(value));
    return *this;
  }
  template <typename AvailabilityZoneIdsT = Aws::String>
  UpdateKxEnvironmentNetworkResult& AddAvailabilityZoneIds(AvailabilityZoneIdsT&& value) {
    m_availabilityZoneIdsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  UpdateKxEnvironmentNetworkResult& WithRequestId(RequestIdT&& value) {
