...
class GetKxDatabaseRequest : public FinspaceRequest {
 public:
  AWS_FINSPACE_API GetKxDatabaseRequest() = default;
  ...
  template <typename EnvironmentIdT = Aws::String>
  GetKxDatabaseRequest& WithEnvironmentId(EnvironmentIdT&& value) {
  ...
  template <typename DatabaseNameT = Aws::String>
  GetKxDatabaseRequest& WithDatabaseName(DatabaseNameT&& value) {
