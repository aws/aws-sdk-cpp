...
class ListKxEnvironmentsResult {
 public:
  ...
  template <typename EnvironmentsT = Aws::Vector<KxEnvironment>>
  ListKxEnvironmentsResult& WithEnvironments(EnvironmentsT&& value) {
    SetEnvironments(std::forward<EnvironmentsT>(value));
    return *this;
  }
  template <typename EnvironmentsT = KxEnvironment>
  ListKxEnvironmentsResult& AddEnvironments(EnvironmentsT&& value) {
    m_environmentsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListKxEnvironmentsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListKxEnvironmentsResult& WithRequestId(RequestIdT&& value) {
