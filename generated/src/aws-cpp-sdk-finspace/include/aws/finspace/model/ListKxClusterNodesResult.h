...
class ListKxClusterNodesResult {
 public:
  ...
  template <typename NodesT = Aws::Vector<KxNode>>
  ListKxClusterNodesResult& WithNodes(NodesT&& value) {
    SetNodes(std::forward<NodesT>(value));
    return *this;
  }
  template <typename NodesT = KxNode>
  ListKxClusterNodesResult& AddNodes(NodesT&& value) {
    m_nodesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListKxClusterNodesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListKxClusterNodesResult& WithRequestId(RequestIdT&& value) {
