...
namespace Model
{
  ...
  {
  public:
    AWS_FINSPACE_API DeleteKxScalingGroupResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteKxScalingGroupResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
