...
class KxSavedownStorageConfiguration {
 public:
  ...
  inline void SetType(KxSavedownStorageType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline KxSavedownStorageConfiguration& WithType(KxSavedownStorageType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline KxSavedownStorageConfiguration& WithSize(int value) {
    SetSize(value);
    return *this;
  }
  ///@}
