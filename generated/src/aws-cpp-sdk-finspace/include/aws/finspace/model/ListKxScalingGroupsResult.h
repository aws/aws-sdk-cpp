...
class ListKxScalingGroupsResult {
 public:
  ...
  void SetScalingGroups(ScalingGroupsT&& value) {
    m_scalingGroupsHasBeenSet = true;
    m_scalingGroups = std::forward<ScalingGroupsT>(value);
  }
  template <typename ScalingGroupsT = Aws::Vector<KxScalingGroup>>
  ListKxScalingGroupsResult& WithScalingGroups(ScalingGroupsT&& value) {
    SetScalingGroups(std::forward<ScalingGroupsT>(value));
    return *this;
  }
  template <typename ScalingGroupsT = KxScalingGroup>
  ListKxScalingGroupsResult& AddScalingGroups(ScalingGroupsT&& value) {
    m_scalingGroupsHasBeenSet = true;
    m_scalingGroups.emplace_back(std::forward<ScalingGroupsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListKxScalingGroupsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListKxScalingGroupsResult& WithRequestId(RequestIdT&& value) {
