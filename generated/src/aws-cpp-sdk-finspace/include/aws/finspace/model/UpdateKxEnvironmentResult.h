...
class UpdateKxEnvironmentResult {
 public:
  ...
  inline UpdateKxEnvironmentResult& WithStatus(EnvironmentStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateKxEnvironmentResult& WithTgwStatus(TgwStatus value) {
    SetTgwStatus(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateKxEnvironmentResult& WithDnsStatus(DnsStatus value) {
    SetDnsStatus(value);
    return *this;
  }
  ///@}
