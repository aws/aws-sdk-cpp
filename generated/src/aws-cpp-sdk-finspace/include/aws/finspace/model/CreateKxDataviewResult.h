...
class CreateKxDataviewResult {
 public:
  ...
  inline CreateKxDataviewResult& WithAzMode(KxAzMode value) {
    SetAzMode(value);
    return *this;
  }
  ///@}
  ...
  inline CreateKxDataviewResult& WithAutoUpdate(bool value) {
    SetAutoUpdate(value);
    return *this;
  }
  ///@}
  ...
  inline CreateKxDataviewResult& WithReadWrite(bool value) {
    SetReadWrite(value);
    return *this;
  }
  ///@}
  ...
  inline CreateKxDataviewResult& WithStatus(KxDataviewStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
