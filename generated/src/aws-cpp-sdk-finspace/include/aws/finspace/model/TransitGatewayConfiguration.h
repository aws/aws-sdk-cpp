...
class TransitGatewayConfiguration {
 public:
  ...
  template <typename TransitGatewayIDT = Aws::String>
  TransitGatewayConfiguration& WithTransitGatewayID(TransitGatewayIDT&& value) {
  ...
  void SetRoutableCIDRSpace(RoutableCIDRSpaceT&& value) {
    m_routableCIDRSpaceHasBeenSet = true;
    m_routableCIDRSpace = std::forward<RoutableCIDRSpaceT>(value);
  }
  template <typename RoutableCIDRSpaceT = Aws::String>
  TransitGatewayConfiguration& WithRoutableCIDRSpace(RoutableCIDRSpaceT&& value) {
    SetRoutableCIDRSpace(std::forward<RoutableCIDRSpaceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAttachmentNetworkAclConfiguration(AttachmentNetworkAclConfigurationT&& value) {
    m_attachmentNetworkAclConfigurationHasBeenSet = true;
    m_attachmentNetworkAclConfiguration = std::forward<AttachmentNetworkAclConfigurationT>(value);
  }
  template <typename AttachmentNetworkAclConfigurationT = Aws::Vector<NetworkACLEntry>>
  TransitGatewayConfiguration& WithAttachmentNetworkAclConfiguration(AttachmentNetworkAclConfigurationT&& value) {
    SetAttachmentNetworkAclConfiguration(std::forward<AttachmentNetworkAclConfigurationT>(value));
    return *this;
  }
  template <typename AttachmentNetworkAclConfigurationT = NetworkACLEntry>
  TransitGatewayConfiguration& AddAttachmentNetworkAclConfiguration(AttachmentNetworkAclConfigurationT&& value) {
    m_attachmentNetworkAclConfigurationHasBeenSet = true;
    m_attachmentNetworkAclConfiguration.emplace_back(std::forward<AttachmentNetworkAclConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
