...
class KxDatabaseConfiguration {
 public:
  ...
  void SetCacheConfigurations(CacheConfigurationsT&& value) {
    ...
    m_cacheConfigurations = std::forward<CacheConfigurationsT>(value);
  }
  template <typename CacheConfigurationsT = Aws::Vector<KxDatabaseCacheConfiguration>>
  KxDatabaseConfiguration& WithCacheConfigurations(CacheConfigurationsT&& value) {
    SetCacheConfigurations(std::forward<CacheConfigurationsT>(value));
    return *this;
  }
  ...
  KxDatabaseConfiguration& AddCacheConfigurations(CacheConfigurationsT&& value) {
    m_cacheConfigurationsHasBeenSet = true;
    m_cacheConfigurations.emplace_back(std::forward<CacheConfigurationsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDataviewConfiguration(DataviewConfigurationT&& value) {
    ...
    m_dataviewConfiguration = std::forward<DataviewConfigurationT>(value);
  }
  template <typename DataviewConfigurationT = KxDataviewConfiguration>
  KxDatabaseConfiguration& WithDataviewConfiguration(DataviewConfigurationT&& value) {
    SetDataviewConfiguration(std::forward<DataviewConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
