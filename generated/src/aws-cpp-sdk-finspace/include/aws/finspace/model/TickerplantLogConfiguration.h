...
class TickerplantLogConfiguration {
 public:
  ...
  void SetTickerplantLogVolumes(TickerplantLogVolumesT&& value) {
    ...
    m_tickerplantLogVolumes = std::forward<TickerplantLogVolumesT>(value);
  }
  template <typename TickerplantLogVolumesT = Aws::Vector<Aws::String>>
  TickerplantLogConfiguration& WithTickerplantLogVolumes(TickerplantLogVolumesT&& value) {
    SetTickerplantLogVolumes(std::forward<TickerplantLogVolumesT>(value));
    return *this;
  }
  ...
  TickerplantLogConfiguration& AddTickerplantLogVolumes(TickerplantLogVolumesT&& value) {
    m_tickerplantLogVolumesHasBeenSet = true;
    m_tickerplantLogVolumes.emplace_back(std::forward<TickerplantLogVolumesT>(value));
    return *this;
  }
  ///@}
 private:
