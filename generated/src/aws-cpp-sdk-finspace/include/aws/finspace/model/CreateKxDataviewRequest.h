...
class CreateKxDataviewRequest : public FinspaceRequest {
 public:
  ...
  template <typename EnvironmentIdT = Aws::String>
  CreateKxDataviewRequest& WithEnvironmentId(EnvironmentIdT&& value) {
  ...
  template <typename DatabaseNameT = Aws::String>
  CreateKxDataviewRequest& WithDatabaseName(DatabaseNameT&& value) {
  ...
  template <typename DataviewNameT = Aws::String>
  CreateKxDataviewRequest& WithDataviewName(DataviewNameT&& value) {
  ...
  inline CreateKxDataviewRequest& WithAzMode(KxAzMode value) {
    SetAzMode(value);
    return *this;
  }
  ///@}
  ...
  template <typename AvailabilityZoneIdT = Aws::String>
  CreateKxDataviewRequest& WithAvailabilityZoneId(AvailabilityZoneIdT&& value) {
  ...
  template <typename ChangesetIdT = Aws::String>
  CreateKxDataviewRequest& WithChangesetId(ChangesetIdT&& value) {
  ...
  template <typename SegmentConfigurationsT = Aws::Vector<KxDataviewSegmentConfiguration>>
  CreateKxDataviewRequest& WithSegmentConfigurations(SegmentConfigurationsT&& value) {
  ...
  CreateKxDataviewRequest& AddSegmentConfigurations(SegmentConfigurationsT&& value) {
    m_segmentConfigurationsHasBeenSet = true;
  ...
  inline CreateKxDataviewRequest& WithAutoUpdate(bool value) {
    SetAutoUpdate(value);
    return *this;
  }
  ///@}
  ...
  inline CreateKxDataviewRequest& WithReadWrite(bool value) {
    SetReadWrite(value);
    return *this;
  }
  ///@}
  ...
  template <typename DescriptionT = Aws::String>
  CreateKxDataviewRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateKxDataviewRequest& WithTags(TagsT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  CreateKxDataviewRequest& WithClientToken(ClientTokenT&& value) {
