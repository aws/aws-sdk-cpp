...
class ListKxDataviewsResult {
 public:
  ...
  void SetKxDataviews(KxDataviewsT&& value) {
    m_kxDataviewsHasBeenSet = true;
    m_kxDataviews = std::forward<KxDataviewsT>(value);
  }
  template <typename KxDataviewsT = Aws::Vector<KxDataviewListEntry>>
  ListKxDataviewsResult& WithKxDataviews(KxDataviewsT&& value) {
    SetKxDataviews(std::forward<KxDataviewsT>(value));
    return *this;
  }
  template <typename KxDataviewsT = KxDataviewListEntry>
  ListKxDataviewsResult& AddKxDataviews(KxDataviewsT&& value) {
    m_kxDataviewsHasBeenSet = true;
    m_kxDataviews.emplace_back(std::forward<KxDataviewsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListKxDataviewsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListKxDataviewsResult& WithRequestId(RequestIdT&& value) {
