...
class ListKxChangesetsResult {
 public:
  ...
  void SetKxChangesets(KxChangesetsT&& value) {
    m_kxChangesetsHasBeenSet = true;
    m_kxChangesets = std::forward<KxChangesetsT>(value);
  }
  template <typename KxChangesetsT = Aws::Vector<KxChangesetListEntry>>
  ListKxChangesetsResult& WithKxChangesets(KxChangesetsT&& value) {
    SetKxChangesets(std::forward<KxChangesetsT>(value));
    return *this;
  }
  template <typename KxChangesetsT = KxChangesetListEntry>
  ListKxChangesetsResult& AddKxChangesets(KxChangesetsT&& value) {
    m_kxChangesetsHasBeenSet = true;
    m_kxChangesets.emplace_back(std::forward<KxChangesetsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListKxChangesetsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListKxChangesetsResult& WithRequestId(RequestIdT&& value) {
