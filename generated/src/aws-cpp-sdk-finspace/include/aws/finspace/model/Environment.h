...
class Environment {
 public:
  ...
  void SetEnvironmentUrl(EnvironmentUrlT&& value) {
    ...
    m_environmentUrl = std::forward<EnvironmentUrlT>(value);
  }
  template <typename EnvironmentUrlT = Aws::String>
  Environment& WithEnvironmentUrl(EnvironmentUrlT&& value) {
    SetEnvironmentUrl(std::forward<EnvironmentUrlT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSageMakerStudioDomainUrl(SageMakerStudioDomainUrlT&& value) {
    ...
    m_sageMakerStudioDomainUrl = std::forward<SageMakerStudioDomainUrlT>(value);
  }
  template <typename SageMakerStudioDomainUrlT = Aws::String>
  Environment& WithSageMakerStudioDomainUrl(SageMakerStudioDomainUrlT&& value) {
    SetSageMakerStudioDomainUrl(std::forward<SageMakerStudioDomainUrlT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetFederationMode(FederationMode value) {
    m_federationModeHasBeenSet = true;
    m_federationMode = value;
  }
  inline Environment& WithFederationMode(FederationMode value) {
  ...
  void SetFederationParameters(FederationParametersT&& value) {
    ...
    m_federationParameters = std::forward<FederationParametersT>(value);
  }
  template <typename FederationParametersT = FederationParameters>
  Environment& WithFederationParameters(FederationParametersT&& value) {
    SetFederationParameters(std::forward<FederationParametersT>(value));
    return *this;
  }
  ///@}
 private:
