...
class DeleteKxVolumeRequest : public FinspaceRequest {
 public:
  ...
  template <typename EnvironmentIdT = Aws::String>
  DeleteKxVolumeRequest& WithEnvironmentId(EnvironmentIdT&& value) {
  ...
  template <typename VolumeNameT = Aws::String>
  DeleteKxVolumeRequest& WithVolumeName(VolumeNameT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  DeleteKxVolumeRequest& WithClientToken(ClientTokenT&& value) {
