...
class DeleteKxDatabaseRequest : public FinspaceRequest {
 public:
  ...
  template <typename EnvironmentIdT = Aws::String>
  DeleteKxDatabaseRequest& WithEnvironmentId(EnvironmentIdT&& value) {
  ...
  template <typename DatabaseNameT = Aws::String>
  DeleteKxDatabaseRequest& WithDatabaseName(DatabaseNameT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  DeleteKxDatabaseRequest& WithClientToken(ClientTokenT&& value) {
