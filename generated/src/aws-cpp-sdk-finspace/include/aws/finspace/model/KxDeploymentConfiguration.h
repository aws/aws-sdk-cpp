...
namespace Model
{
   ...
   * time it takes to update the database changesets on to a cluster. </p><p><h3>See
   * Also:</h3>   <a
  ...
  public:
     ...
     * – This options loads the updated database by stopping the exiting q process and
     * starting a new q process with updated configuration.</p> </li> <li>
     * <p>NO_RESTART – This option loads the updated database on the running q process
     * without stopping it. This option is quicker as it reduces the turn around time
     * to update a kdb database changeset configuration on a cluster.</p> </li> </ul>
     */
