...
class GetKxDataviewRequest : public FinspaceRequest {
 public:
  ...
  template <typename EnvironmentIdT = Aws::String>
  GetKxDataviewRequest& WithEnvironmentId(EnvironmentIdT&& value) {
  ...
  template <typename DatabaseNameT = Aws::String>
  GetKxDataviewRequest& WithDatabaseName(DatabaseNameT&& value) {
  ...
  template <typename DataviewNameT = Aws::String>
  GetKxDataviewRequest& WithDataviewName(DataviewNameT&& value) {
