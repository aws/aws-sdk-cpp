...
class CustomDNSServer {
 public:
  ...
  void SetCustomDNSServerName(CustomDNSServerNameT&& value) {
    ...
    m_customDNSServerName = std::forward<CustomDNSServerNameT>(value);
  }
  template <typename CustomDNSServerNameT = Aws::String>
  CustomDNSServer& WithCustomDNSServerName(CustomDNSServerNameT&& value) {
    SetCustomDNSServerName(std::forward<CustomDNSServerNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCustomDNSServerIP(CustomDNSServerIPT&& value) {
    ...
    m_customDNSServerIP = std::forward<CustomDNSServerIPT>(value);
  }
  template <typename CustomDNSServerIPT = Aws::String>
  CustomDNSServer& WithCustomDNSServerIP(CustomDNSServerIPT&& value) {
    SetCustomDNSServerIP(std::forward<CustomDNSServerIPT>(value));
    return *this;
  }
  ///@}
 private:
