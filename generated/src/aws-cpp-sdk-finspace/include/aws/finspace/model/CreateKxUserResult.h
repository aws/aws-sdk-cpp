...
class CreateKxUserResult {
 public:
  ...
  template <typename UserNameT = Aws::String>
  CreateKxUserResult& WithUserName(UserNameT&& value) {
  ...
  template <typename UserArnT = Aws::String>
  CreateKxUserResult& WithUserArn(UserArnT&& value) {
  ...
  template <typename EnvironmentIdT = Aws::String>
  CreateKxUserResult& WithEnvironmentId(EnvironmentIdT&& value) {
  ...
  template <typename IamRoleT = Aws::String>
  CreateKxUserResult& WithIamRole(IamRoleT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateKxUserResult& WithRequestId(RequestIdT&& value) {
