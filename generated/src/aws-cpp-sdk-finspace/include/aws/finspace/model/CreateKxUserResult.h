...
namespace Model
{
  ...
  {
  public:
    AWS_FINSPACE_API CreateKxUserResult() = default;
    ...
    template<typename UserNameT = Aws::String>
    CreateKxUserResult& WithUserName(UserNameT&& value) { SetUserName(std::forward<UserNameT>(value)); return *this;}
    ///@}
    ...
    template<typename UserArnT = Aws::String>
    CreateKxUserResult& WithUserArn(UserArnT&& value) { SetUserArn(std::forward<UserArnT>(value)); return *this;}
    ///@}
    ...
    template<typename EnvironmentIdT = Aws::String>
    CreateKxUserResult& WithEnvironmentId(EnvironmentIdT&& value) { SetEnvironmentId(std::forward<EnvironmentIdT>(value)); return *this;}
    ///@}
    ...
    template<typename IamRoleT = Aws::String>
    CreateKxUserResult& WithIamRole(IamRoleT&& value) { SetIamRole(std::forward<IamRoleT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateKxUserResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
