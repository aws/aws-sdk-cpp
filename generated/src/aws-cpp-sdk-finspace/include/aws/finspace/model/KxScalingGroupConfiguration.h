...
class KxScalingGroupConfiguration {
 public:
  ...
  inline void SetMemoryLimit(int value) {
    m_memoryLimitHasBeenSet = true;
    m_memoryLimit = value;
  }
  inline KxScalingGroupConfiguration& WithMemoryLimit(int value) {
  ...
  inline KxScalingGroupConfiguration& WithMemoryReservation(int value) {
  ...
  inline KxScalingGroupConfiguration& WithNodeCount(int value) {
    SetNodeCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCpu(double value) {
    m_cpuHasBeenSet = true;
    m_cpu = value;
  }
  inline KxScalingGroupConfiguration& WithCpu(double value) {
    SetCpu(value);
    return *this;
  }
  ///@}
