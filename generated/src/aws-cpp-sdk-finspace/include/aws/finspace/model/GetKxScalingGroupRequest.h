...
class GetKxScalingGroupRequest : public FinspaceRequest {
 public:
  ...
  template <typename EnvironmentIdT = Aws::String>
  GetKxScalingGroupRequest& WithEnvironmentId(EnvironmentIdT&& value) {
  ...
  void SetScalingGroupName(ScalingGroupNameT&& value) {
    ...
    m_scalingGroupName = std::forward<ScalingGroupNameT>(value);
  }
  template <typename ScalingGroupNameT = Aws::String>
  GetKxScalingGroupRequest& WithScalingGroupName(ScalingGroupNameT&& value) {
    SetScalingGroupName(std::forward<ScalingGroupNameT>(value));
    return *this;
  }
  ///@}
 private:
