...
class UpdateKxVolumeResult {
 public:
  ...
  inline UpdateKxVolumeResult& WithVolumeType(KxVolumeType value) {
    SetVolumeType(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateKxVolumeResult& WithStatus(KxVolumeStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateKxVolumeResult& WithAzMode(KxAzMode value) {
    SetAzMode(value);
    return *this;
  }
  ///@}
