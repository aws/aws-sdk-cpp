...
class ListKxClustersResult {
 public:
  ...
  void SetKxClusterSummaries(KxClusterSummariesT&& value) {
    m_kxClusterSummariesHasBeenSet = true;
    m_kxClusterSummaries = std::forward<KxClusterSummariesT>(value);
  }
  template <typename KxClusterSummariesT = Aws::Vector<KxCluster>>
  ListKxClustersResult& WithKxClusterSummaries(KxClusterSummariesT&& value) {
    SetKxClusterSummaries(std::forward<KxClusterSummariesT>(value));
    return *this;
  }
  template <typename KxClusterSummariesT = KxCluster>
  ListKxClustersResult& AddKxClusterSummaries(KxClusterSummariesT&& value) {
    m_kxClusterSummariesHasBeenSet = true;
    m_kxClusterSummaries.emplace_back(std::forward<KxClusterSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListKxClustersResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListKxClustersResult& WithRequestId(RequestIdT&& value) {
