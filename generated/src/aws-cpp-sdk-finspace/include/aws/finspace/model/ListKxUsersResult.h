...
class ListKxUsersResult {
 public:
  ...
  template <typename UsersT = Aws::Vector<KxUser>>
  ListKxUsersResult& WithUsers(UsersT&& value) {
    SetUsers(std::forward<UsersT>(value));
    return *this;
  }
  template <typename UsersT = KxUser>
  ListKxUsersResult& AddUsers(UsersT&& value) {
    m_usersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListKxUsersResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListKxUsersResult& WithRequestId(RequestIdT&& value) {
