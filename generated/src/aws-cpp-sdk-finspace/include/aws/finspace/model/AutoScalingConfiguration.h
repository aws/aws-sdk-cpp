...
class AutoScalingConfiguration {
 public:
  ...
  inline void SetMinNodeCount(int value) {
    m_minNodeCountHasBeenSet = true;
    m_minNodeCount = value;
  }
  inline AutoScalingConfiguration& WithMinNodeCount(int value) {
  ...
  inline void SetMaxNodeCount(int value) {
    m_maxNodeCountHasBeenSet = true;
    m_maxNodeCount = value;
  }
  inline AutoScalingConfiguration& WithMaxNodeCount(int value) {
  ...
  inline void SetAutoScalingMetric(AutoScalingMetric value) {
    m_autoScalingMetricHasBeenSet = true;
    m_autoScalingMetric = value;
  }
  inline AutoScalingConfiguration& WithAutoScalingMetric(AutoScalingMetric value) {
  ...
  inline void SetMetricTarget(double value) {
    m_metricTargetHasBeenSet = true;
    m_metricTarget = value;
  }
  inline AutoScalingConfiguration& WithMetricTarget(double value) {
    SetMetricTarget(value);
    return *this;
  }
  ///@}
  ...
  inline void SetScaleInCooldownSeconds(double value) {
    m_scaleInCooldownSecondsHasBeenSet = true;
    m_scaleInCooldownSeconds = value;
  }
  inline AutoScalingConfiguration& WithScaleInCooldownSeconds(double value) {
    SetScaleInCooldownSeconds(value);
    return *this;
  }
  ///@}
  ...
  inline void SetScaleOutCooldownSeconds(double value) {
    m_scaleOutCooldownSecondsHasBeenSet = true;
    m_scaleOutCooldownSeconds = value;
  }
  inline AutoScalingConfiguration& WithScaleOutCooldownSeconds(double value) {
    SetScaleOutCooldownSeconds(value);
    return *this;
  }
  ///@}
 private:
