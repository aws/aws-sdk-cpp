...
class CreateKxChangesetRequest : public FinspaceRequest {
 public:
  ...
  template <typename EnvironmentIdT = Aws::String>
  CreateKxChangesetRequest& WithEnvironmentId(EnvironmentIdT&& value) {
  ...
  template <typename DatabaseNameT = Aws::String>
  CreateKxChangesetRequest& WithDatabaseName(DatabaseNameT&& value) {
  ...
  void SetChangeRequests(ChangeRequestsT&& value) {
    ...
    m_changeRequests = std::forward<ChangeRequestsT>(value);
  }
  template <typename ChangeRequestsT = Aws::Vector<ChangeRequest>>
  CreateKxChangesetRequest& WithChangeRequests(ChangeRequestsT&& value) {
    SetChangeRequests(std::forward<ChangeRequestsT>(value));
    return *this;
  }
  template <typename ChangeRequestsT = ChangeRequest>
  CreateKxChangesetRequest& AddChangeRequests(ChangeRequestsT&& value) {
    m_changeRequestsHasBeenSet = true;
    m_changeRequests.emplace_back(std::forward<ChangeRequestsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ClientTokenT = Aws::String>
  CreateKxChangesetRequest& WithClientToken(ClientTokenT&& value) {
