...
namespace Model
{
  ...
  {
  public:
    AWS_FINSPACE_API GetKxEnvironmentResult() = default;
    ...
    template<typename NameT = Aws::String>
    GetKxEnvironmentResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename EnvironmentIdT = Aws::String>
    GetKxEnvironmentResult& WithEnvironmentId(EnvironmentIdT&& value) { SetEnvironmentId(std::forward<EnvironmentIdT>(value)); return *this;}
    ///@}
    ...
    template<typename AwsAccountIdT = Aws::String>
    GetKxEnvironmentResult& WithAwsAccountId(AwsAccountIdT&& value) { SetAwsAccountId(std::forward<AwsAccountIdT>(value)); return *this;}
    ///@}
    ...
    inline GetKxEnvironmentResult& WithStatus(EnvironmentStatus value) { SetStatus(value); return *this;}
    ///@}
    ...
    inline GetKxEnvironmentResult& WithTgwStatus(TgwStatus value) { SetTgwStatus(value); return *this;}
    ///@}
    ...
    inline GetKxEnvironmentResult& WithDnsStatus(DnsStatus value) { SetDnsStatus(value); return *this;}
    ///@}
    ...
    template<typename ErrorMessageT = Aws::String>
    GetKxEnvironmentResult& WithErrorMessage(ErrorMessageT&& value) { SetErrorMessage(std::forward<ErrorMessageT>(value)); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    GetKxEnvironmentResult& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename EnvironmentArnT = Aws::String>
    GetKxEnvironmentResult& WithEnvironmentArn(EnvironmentArnT&& value) { SetEnvironmentArn(std::forward<EnvironmentArnT>(value)); return *this;}
    ///@}
    ...
    template<typename KmsKeyIdT = Aws::String>
    GetKxEnvironmentResult& WithKmsKeyId(KmsKeyIdT&& value) { SetKmsKeyId(std::forward<KmsKeyIdT>(value)); return *this;}
    ///@}
    ...
    template<typename DedicatedServiceAccountIdT = Aws::String>
    GetKxEnvironmentResult& WithDedicatedServiceAccountId(DedicatedServiceAccountIdT&& value) { SetDedicatedServiceAccountId(std::forward<DedicatedServiceAccountIdT>(value)); return *this;}
    ///@}
    ...
    template<typename TransitGatewayConfigurationT = TransitGatewayConfiguration>
    GetKxEnvironmentResult& WithTransitGatewayConfiguration(TransitGatewayConfigurationT&& value) { SetTransitGatewayConfiguration(std::forward<TransitGatewayConfigurationT>(value)); return *this;}
    ///@}
    ...
    template<typename CustomDNSConfigurationT = Aws::Vector<CustomDNSServer>>
    GetKxEnvironmentResult& WithCustomDNSConfiguration(CustomDNSConfigurationT&& value) { SetCustomDNSConfiguration(std::forward<CustomDNSConfigurationT>(value)); return *this;}
    template<typename CustomDNSConfigurationT = CustomDNSServer>
    GetKxEnvironmentResult& AddCustomDNSConfiguration(CustomDNSConfigurationT&& value) { m_customDNSConfigurationHasBeenSet = true; m_customDNSConfiguration.emplace_back(std::forward<CustomDNSConfigurationT>(value)); return *this; }
    ///@}
    ...
    template<typename CreationTimestampT = Aws::Utils::DateTime>
    GetKxEnvironmentResult& WithCreationTimestamp(CreationTimestampT&& value) { SetCreationTimestamp(std::forward<CreationTimestampT>(value)); return *this;}
    ///@}
    ...
    template<typename UpdateTimestampT = Aws::Utils::DateTime>
    GetKxEnvironmentResult& WithUpdateTimestamp(UpdateTimestampT&& value) { SetUpdateTimestamp(std::forward<UpdateTimestampT>(value)); return *this;}
    ///@}
    ...
    template<typename AvailabilityZoneIdsT = Aws::Vector<Aws::String>>
    GetKxEnvironmentResult& WithAvailabilityZoneIds(AvailabilityZoneIdsT&& value) { SetAvailabilityZoneIds(std::forward<AvailabilityZoneIdsT>(value)); return *this;}
    template<typename AvailabilityZoneIdsT = Aws::String>
    GetKxEnvironmentResult& AddAvailabilityZoneIds(AvailabilityZoneIdsT&& value) { m_availabilityZoneIdsHasBeenSet = true; m_availabilityZoneIds.emplace_back(std::forward<AvailabilityZoneIdsT>(value)); return *this; }
    ///@}
    ...
    template<typename CertificateAuthorityArnT = Aws::String>
    GetKxEnvironmentResult& WithCertificateAuthorityArn(CertificateAuthorityArnT&& value) { SetCertificateAuthorityArn(std::forward<CertificateAuthorityArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    GetKxEnvironmentResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
