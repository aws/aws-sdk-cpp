...
class GetKxEnvironmentResult {
 public:
  ...
  template <typename NameT = Aws::String>
  GetKxEnvironmentResult& WithName(NameT&& value) {
  ...
  template <typename EnvironmentIdT = Aws::String>
  GetKxEnvironmentResult& WithEnvironmentId(EnvironmentIdT&& value) {
  ...
  template <typename AwsAccountIdT = Aws::String>
  GetKxEnvironmentResult& WithAwsAccountId(AwsAccountIdT&& value) {
  ...
  inline GetKxEnvironmentResult& WithStatus(EnvironmentStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTgwStatus(TgwStatus value) {
    m_tgwStatusHasBeenSet = true;
    m_tgwStatus = value;
  }
  inline GetKxEnvironmentResult& WithTgwStatus(TgwStatus value) {
    SetTgwStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDnsStatus(DnsStatus value) {
    m_dnsStatusHasBeenSet = true;
    m_dnsStatus = value;
  }
  inline GetKxEnvironmentResult& WithDnsStatus(DnsStatus value) {
    SetDnsStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ErrorMessageT = Aws::String>
  GetKxEnvironmentResult& WithErrorMessage(ErrorMessageT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  GetKxEnvironmentResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename EnvironmentArnT = Aws::String>
  GetKxEnvironmentResult& WithEnvironmentArn(EnvironmentArnT&& value) {
  ...
  template <typename KmsKeyIdT = Aws::String>
  GetKxEnvironmentResult& WithKmsKeyId(KmsKeyIdT&& value) {
  ...
  void SetDedicatedServiceAccountId(DedicatedServiceAccountIdT&& value) {
    ...
    m_dedicatedServiceAccountId = std::forward<DedicatedServiceAccountIdT>(value);
  }
  template <typename DedicatedServiceAccountIdT = Aws::String>
  GetKxEnvironmentResult& WithDedicatedServiceAccountId(DedicatedServiceAccountIdT&& value) {
    SetDedicatedServiceAccountId(std::forward<DedicatedServiceAccountIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TransitGatewayConfigurationT = TransitGatewayConfiguration>
  GetKxEnvironmentResult& WithTransitGatewayConfiguration(TransitGatewayConfigurationT&& value) {
  ...
  void SetCustomDNSConfiguration(CustomDNSConfigurationT&& value) {
    ...
    m_customDNSConfiguration = std::forward<CustomDNSConfigurationT>(value);
  }
  template <typename CustomDNSConfigurationT = Aws::Vector<CustomDNSServer>>
  GetKxEnvironmentResult& WithCustomDNSConfiguration(CustomDNSConfigurationT&& value) {
    SetCustomDNSConfiguration(std::forward<CustomDNSConfigurationT>(value));
    return *this;
  }
  template <typename CustomDNSConfigurationT = CustomDNSServer>
  GetKxEnvironmentResult& AddCustomDNSConfiguration(CustomDNSConfigurationT&& value) {
    m_customDNSConfigurationHasBeenSet = true;
    m_customDNSConfiguration.emplace_back(std::forward<CustomDNSConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename CreationTimestampT = Aws::Utils::DateTime>
  GetKxEnvironmentResult& WithCreationTimestamp(CreationTimestampT&& value) {
  ...
  template <typename UpdateTimestampT = Aws::Utils::DateTime>
  GetKxEnvironmentResult& WithUpdateTimestamp(UpdateTimestampT&& value) {
  ...
  template <typename AvailabilityZoneIdsT = Aws::Vector<Aws::String>>
  GetKxEnvironmentResult& WithAvailabilityZoneIds(AvailabilityZoneIdsT&& value) {
    SetAvailabilityZoneIds(std::forward<AvailabilityZoneIdsT>(value));
    return *this;
  }
  template <typename AvailabilityZoneIdsT = Aws::String>
  GetKxEnvironmentResult& AddAvailabilityZoneIds(AvailabilityZoneIdsT&& value) {
    m_availabilityZoneIdsHasBeenSet = true;
  ...
  template <typename CertificateAuthorityArnT = Aws::String>
  GetKxEnvironmentResult& WithCertificateAuthorityArn(CertificateAuthorityArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetKxEnvironmentResult& WithRequestId(RequestIdT&& value) {
