...
class UpdateKxDataviewRequest : public FinspaceRequest {
 public:
  ...
  template <typename EnvironmentIdT = Aws::String>
  UpdateKxDataviewRequest& WithEnvironmentId(EnvironmentIdT&& value) {
  ...
  template <typename DatabaseNameT = Aws::String>
  UpdateKxDataviewRequest& WithDatabaseName(DatabaseNameT&& value) {
  ...
  template <typename DataviewNameT = Aws::String>
  UpdateKxDataviewRequest& WithDataviewName(DataviewNameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateKxDataviewRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename ChangesetIdT = Aws::String>
  UpdateKxDataviewRequest& WithChangesetId(ChangesetIdT&& value) {
  ...
  template <typename SegmentConfigurationsT = Aws::Vector<KxDataviewSegmentConfiguration>>
  UpdateKxDataviewRequest& WithSegmentConfigurations(SegmentConfigurationsT&& value) {
  ...
  UpdateKxDataviewRequest& AddSegmentConfigurations(SegmentConfigurationsT&& value) {
    m_segmentConfigurationsHasBeenSet = true;
  ...
  template <typename ClientTokenT = Aws::String>
  UpdateKxDataviewRequest& WithClientToken(ClientTokenT&& value) {
