...
class KxAttachedCluster {
 public:
  ...
  inline KxAttachedCluster& WithClusterType(KxClusterType value) {
  ...
  inline void SetClusterStatus(KxClusterStatus value) {
    m_clusterStatusHasBeenSet = true;
    m_clusterStatus = value;
  }
  inline KxAttachedCluster& WithClusterStatus(KxClusterStatus value) {
