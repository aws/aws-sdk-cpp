...
class ListKxDataviewsRequest : public FinspaceRequest {
 public:
  ...
  template <typename EnvironmentIdT = Aws::String>
  ListKxDataviewsRequest& WithEnvironmentId(EnvironmentIdT&& value) {
  ...
  template <typename DatabaseNameT = Aws::String>
  ListKxDataviewsRequest& WithDatabaseName(DatabaseNameT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListKxDataviewsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListKxDataviewsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
