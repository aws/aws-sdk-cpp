...
class DeleteKxDataviewRequest : public FinspaceRequest {
 public:
  ...
  template <typename EnvironmentIdT = Aws::String>
  DeleteKxDataviewRequest& WithEnvironmentId(EnvironmentIdT&& value) {
  ...
  template <typename DatabaseNameT = Aws::String>
  DeleteKxDataviewRequest& WithDatabaseName(DatabaseNameT&& value) {
  ...
  template <typename DataviewNameT = Aws::String>
  DeleteKxDataviewRequest& WithDataviewName(DataviewNameT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  DeleteKxDataviewRequest& WithClientToken(ClientTokenT&& value) {
