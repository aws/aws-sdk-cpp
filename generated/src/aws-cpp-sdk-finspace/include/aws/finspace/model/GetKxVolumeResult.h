...
class GetKxVolumeResult {
 public:
  ...
  inline GetKxVolumeResult& WithVolumeType(KxVolumeType value) {
    SetVolumeType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(KxVolumeStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline GetKxVolumeResult& WithStatus(KxVolumeStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline GetKxVolumeResult& WithAzMode(KxAzMode value) {
    SetAzMode(value);
    return *this;
  }
  ///@}
