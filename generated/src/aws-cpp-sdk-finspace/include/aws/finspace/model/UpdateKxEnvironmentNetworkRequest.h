...
class UpdateKxEnvironmentNetworkRequest : public FinspaceRequest {
 public:
  ...
  template <typename EnvironmentIdT = Aws::String>
  UpdateKxEnvironmentNetworkRequest& WithEnvironmentId(EnvironmentIdT&& value) {
  ...
  template <typename TransitGatewayConfigurationT = TransitGatewayConfiguration>
  UpdateKxEnvironmentNetworkRequest& WithTransitGatewayConfiguration(TransitGatewayConfigurationT&& value) {
  ...
  template <typename CustomDNSConfigurationT = Aws::Vector<CustomDNSServer>>
  UpdateKxEnvironmentNetworkRequest& WithCustomDNSConfiguration(CustomDNSConfigurationT&& value) {
  ...
  UpdateKxEnvironmentNetworkRequest& AddCustomDNSConfiguration(CustomDNSConfigurationT&& value) {
    m_customDNSConfigurationHasBeenSet = true;
  ...
  template <typename ClientTokenT = Aws::String>
  UpdateKxEnvironmentNetworkRequest& WithClientToken(ClientTokenT&& value) {
