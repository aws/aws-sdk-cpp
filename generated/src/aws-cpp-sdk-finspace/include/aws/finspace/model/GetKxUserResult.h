...
class GetKxUserResult {
 public:
  ...
  template <typename UserNameT = Aws::String>
  GetKxUserResult& WithUserName(UserNameT&& value) {
  ...
  template <typename UserArnT = Aws::String>
  GetKxUserResult& WithUserArn(UserArnT&& value) {
  ...
  template <typename EnvironmentIdT = Aws::String>
  GetKxUserResult& WithEnvironmentId(EnvironmentIdT&& value) {
  ...
  template <typename IamRoleT = Aws::String>
  GetKxUserResult& WithIamRole(IamRoleT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetKxUserResult& WithRequestId(RequestIdT&& value) {
