...
class KxClusterCodeDeploymentConfiguration {
 public:
  ...
  inline void SetDeploymentStrategy(KxClusterCodeDeploymentStrategy value) {
    m_deploymentStrategyHasBeenSet = true;
    m_deploymentStrategy = value;
  }
  inline KxClusterCodeDeploymentConfiguration& WithDeploymentStrategy(KxClusterCodeDeploymentStrategy value) {
