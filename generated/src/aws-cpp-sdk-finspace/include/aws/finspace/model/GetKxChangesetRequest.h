...
class GetKxChangesetRequest : public FinspaceRequest {
 public:
  ...
  template <typename EnvironmentIdT = Aws::String>
  GetKxChangesetRequest& WithEnvironmentId(EnvironmentIdT&& value) {
  ...
  template <typename DatabaseNameT = Aws::String>
  GetKxChangesetRequest& WithDatabaseName(DatabaseNameT&& value) {
  ...
  template <typename ChangesetIdT = Aws::String>
  GetKxChangesetRequest& WithChangesetId(ChangesetIdT&& value) {
