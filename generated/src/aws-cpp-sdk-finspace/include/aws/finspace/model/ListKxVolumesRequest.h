...
class ListKxVolumesRequest : public FinspaceRequest {
 public:
  ...
  template <typename EnvironmentIdT = Aws::String>
  ListKxVolumesRequest& WithEnvironmentId(EnvironmentIdT&& value) {
  ...
  inline ListKxVolumesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListKxVolumesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListKxVolumesRequest& WithVolumeType(KxVolumeType value) {
    SetVolumeType(value);
    return *this;
  }
  ///@}
