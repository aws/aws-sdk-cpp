...
namespace Model
{
  ...
  {
  public:
    AWS_FINSPACE_API ListKxScalingGroupsRequest() = default;
    ...
    template<typename EnvironmentIdT = Aws::String>
    ListKxScalingGroupsRequest& WithEnvironmentId(EnvironmentIdT&& value) { SetEnvironmentId(std::forward<EnvironmentIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListKxScalingGroupsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
