...
class ListKxScalingGroupsRequest : public FinspaceRequest {
 public:
  ...
  template <typename EnvironmentIdT = Aws::String>
  ListKxScalingGroupsRequest& WithEnvironmentId(EnvironmentIdT&& value) {
  ...
  inline ListKxScalingGroupsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListKxScalingGroupsRequest& WithNextToken(NextTokenT&& value) {
