...
class UpdateKxUserResult {
 public:
  ...
  template <typename UserNameT = Aws::String>
  UpdateKxUserResult& WithUserName(UserNameT&& value) {
  ...
  template <typename UserArnT = Aws::String>
  UpdateKxUserResult& WithUserArn(UserArnT&& value) {
  ...
  template <typename EnvironmentIdT = Aws::String>
  UpdateKxUserResult& WithEnvironmentId(EnvironmentIdT&& value) {
  ...
  template <typename IamRoleT = Aws::String>
  UpdateKxUserResult& WithIamRole(IamRoleT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateKxUserResult& WithRequestId(RequestIdT&& value) {
