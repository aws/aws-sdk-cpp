...
class UpdateKxDataviewResult {
 public:
  ...
  inline UpdateKxDataviewResult& WithAzMode(KxAzMode value) {
    SetAzMode(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateKxDataviewResult& WithStatus(KxDataviewStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateKxDataviewResult& WithAutoUpdate(bool value) {
    SetAutoUpdate(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateKxDataviewResult& WithReadWrite(bool value) {
    SetReadWrite(value);
    return *this;
  }
  ///@}
