...
class FederationParameters {
 public:
  ...
  void SetSamlMetadataURL(SamlMetadataURLT&& value) {
    ...
    m_samlMetadataURL = std::forward<SamlMetadataURLT>(value);
  }
  template <typename SamlMetadataURLT = Aws::String>
  FederationParameters& WithSamlMetadataURL(SamlMetadataURLT&& value) {
    SetSamlMetadataURL(std::forward<SamlMetadataURLT>(value));
    return *this;
  }
  ///@}
  ...
  void SetApplicationCallBackURL(ApplicationCallBackURLT&& value) {
    ...
    m_applicationCallBackURL = std::forward<ApplicationCallBackURLT>(value);
  }
  template <typename ApplicationCallBackURLT = Aws::String>
  FederationParameters& WithApplicationCallBackURL(ApplicationCallBackURLT&& value) {
    SetApplicationCallBackURL(std::forward<ApplicationCallBackURLT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFederationURN(FederationURNT&& value) {
    ...
    m_federationURN = std::forward<FederationURNT>(value);
  }
  template <typename FederationURNT = Aws::String>
  FederationParameters& WithFederationURN(FederationURNT&& value) {
    SetFederationURN(std::forward<FederationURNT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFederationProviderName(FederationProviderNameT&& value) {
    ...
    m_federationProviderName = std::forward<FederationProviderNameT>(value);
  }
  template <typename FederationProviderNameT = Aws::String>
  FederationParameters& WithFederationProviderName(FederationProviderNameT&& value) {
    SetFederationProviderName(std::forward<FederationProviderNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAttributeMap(AttributeMapT&& value) {
    ...
    m_attributeMap = std::forward<AttributeMapT>(value);
  }
  template <typename AttributeMapT = Aws::Map<Aws::String, Aws::String>>
  FederationParameters& WithAttributeMap(AttributeMapT&& value) {
    SetAttributeMap(std::forward<AttributeMapT>(value));
    return *this;
  }
  ...
  FederationParameters& AddAttributeMap(AttributeMapKeyT&& key, AttributeMapValueT&& value) {
    m_attributeMapHasBeenSet = true;
    m_attributeMap.emplace(std::forward<AttributeMapKeyT>(key), std::forward<AttributeMapValueT>(value));
    return *this;
  }
  ///@}
 private:
