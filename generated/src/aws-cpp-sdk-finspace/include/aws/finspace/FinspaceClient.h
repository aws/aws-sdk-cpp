...
class AWS_FINSPACE_API FinspaceClient : public Aws::Client::AWSJsonClient,
                                        ...
                                        public FinspaceWaiter<FinspaceClient> {
 public:
   ...
   */
  FinspaceClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<FinspaceEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * A Callable wrapper for CreateKxChangeset that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateKxChangeset that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateKxChangesetRequestT = Model::CreateKxChangesetRequest>
  void CreateKxChangesetAsync(const CreateKxChangesetRequestT& request, const CreateKxChangesetResponseReceivedHandler& handler,
  ...
  /**
   * An Async wrapper for CreateKxCluster that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateKxClusterRequestT = Model::CreateKxClusterRequest>
  void CreateKxClusterAsync(const CreateKxClusterRequestT& request, const CreateKxClusterResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateKxDatabase that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateKxDatabase that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateKxDatabaseRequestT = Model::CreateKxDatabaseRequest>
  void CreateKxDatabaseAsync(const CreateKxDatabaseRequestT& request, const CreateKxDatabaseResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateKxDataview that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateKxDataview that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateKxDataviewRequestT = Model::CreateKxDataviewRequest>
  void CreateKxDataviewAsync(const CreateKxDataviewRequestT& request, const CreateKxDataviewResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateKxEnvironment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateKxEnvironment that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateKxEnvironmentRequestT = Model::CreateKxEnvironmentRequest>
  void CreateKxEnvironmentAsync(const CreateKxEnvironmentRequestT& request, const CreateKxEnvironmentResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateKxScalingGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateKxScalingGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateKxScalingGroupRequestT = Model::CreateKxScalingGroupRequest>
  void CreateKxScalingGroupAsync(const CreateKxScalingGroupRequestT& request, const CreateKxScalingGroupResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateKxUser that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateKxUserRequestT = Model::CreateKxUserRequest>
  void CreateKxUserAsync(const CreateKxUserRequestT& request, const CreateKxUserResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateKxVolume that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateKxVolumeRequestT = Model::CreateKxVolumeRequest>
  void CreateKxVolumeAsync(const CreateKxVolumeRequestT& request, const CreateKxVolumeResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteKxCluster that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteKxClusterRequestT = Model::DeleteKxClusterRequest>
  void DeleteKxClusterAsync(const DeleteKxClusterRequestT& request, const DeleteKxClusterResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteKxClusterNode that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteKxClusterNode that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteKxClusterNodeRequestT = Model::DeleteKxClusterNodeRequest>
  void DeleteKxClusterNodeAsync(const DeleteKxClusterNodeRequestT& request, const DeleteKxClusterNodeResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteKxDatabase that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteKxDatabase that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteKxDatabaseRequestT = Model::DeleteKxDatabaseRequest>
  void DeleteKxDatabaseAsync(const DeleteKxDatabaseRequestT& request, const DeleteKxDatabaseResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteKxDataview that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteKxDataview that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteKxDataviewRequestT = Model::DeleteKxDataviewRequest>
  void DeleteKxDataviewAsync(const DeleteKxDataviewRequestT& request, const DeleteKxDataviewResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteKxEnvironment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteKxEnvironment that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteKxEnvironmentRequestT = Model::DeleteKxEnvironmentRequest>
  void DeleteKxEnvironmentAsync(const DeleteKxEnvironmentRequestT& request, const DeleteKxEnvironmentResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteKxScalingGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteKxScalingGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteKxScalingGroupRequestT = Model::DeleteKxScalingGroupRequest>
  void DeleteKxScalingGroupAsync(const DeleteKxScalingGroupRequestT& request, const DeleteKxScalingGroupResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteKxUser that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteKxUserRequestT = Model::DeleteKxUserRequest>
  void DeleteKxUserAsync(const DeleteKxUserRequestT& request, const DeleteKxUserResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteKxVolume that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteKxVolumeRequestT = Model::DeleteKxVolumeRequest>
  void DeleteKxVolumeAsync(const DeleteKxVolumeRequestT& request, const DeleteKxVolumeResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetKxChangeset that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetKxChangesetRequestT = Model::GetKxChangesetRequest>
  void GetKxChangesetAsync(const GetKxChangesetRequestT& request, const GetKxChangesetResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetKxCluster that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetKxClusterRequestT = Model::GetKxClusterRequest>
  void GetKxClusterAsync(const GetKxClusterRequestT& request, const GetKxClusterResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetKxConnectionString that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetKxConnectionString that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetKxConnectionStringRequestT = Model::GetKxConnectionStringRequest>
  void GetKxConnectionStringAsync(const GetKxConnectionStringRequestT& request, const GetKxConnectionStringResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetKxDatabase that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetKxDatabaseRequestT = Model::GetKxDatabaseRequest>
  void GetKxDatabaseAsync(const GetKxDatabaseRequestT& request, const GetKxDatabaseResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetKxDataview that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetKxDataviewRequestT = Model::GetKxDataviewRequest>
  void GetKxDataviewAsync(const GetKxDataviewRequestT& request, const GetKxDataviewResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetKxEnvironment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetKxEnvironment that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetKxEnvironmentRequestT = Model::GetKxEnvironmentRequest>
  void GetKxEnvironmentAsync(const GetKxEnvironmentRequestT& request, const GetKxEnvironmentResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetKxScalingGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetKxScalingGroup that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetKxScalingGroupRequestT = Model::GetKxScalingGroupRequest>
  void GetKxScalingGroupAsync(const GetKxScalingGroupRequestT& request, const GetKxScalingGroupResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetKxUser that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetKxUserRequestT = Model::GetKxUserRequest>
  void GetKxUserAsync(const GetKxUserRequestT& request, const GetKxUserResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetKxVolume that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetKxVolumeRequestT = Model::GetKxVolumeRequest>
  void GetKxVolumeAsync(const GetKxVolumeRequestT& request, const GetKxVolumeResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListKxChangesets that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListKxChangesets that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListKxChangesetsRequestT = Model::ListKxChangesetsRequest>
  void ListKxChangesetsAsync(const ListKxChangesetsRequestT& request, const ListKxChangesetsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListKxClusterNodes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListKxClusterNodes that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListKxClusterNodesRequestT = Model::ListKxClusterNodesRequest>
  void ListKxClusterNodesAsync(const ListKxClusterNodesRequestT& request, const ListKxClusterNodesResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListKxClusters that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListKxClustersRequestT = Model::ListKxClustersRequest>
  void ListKxClustersAsync(const ListKxClustersRequestT& request, const ListKxClustersResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListKxDatabases that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListKxDatabasesRequestT = Model::ListKxDatabasesRequest>
  void ListKxDatabasesAsync(const ListKxDatabasesRequestT& request, const ListKxDatabasesResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListKxDataviews that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListKxDataviewsRequestT = Model::ListKxDataviewsRequest>
  void ListKxDataviewsAsync(const ListKxDataviewsRequestT& request, const ListKxDataviewsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListKxEnvironments that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListKxEnvironments that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListKxEnvironmentsRequestT = Model::ListKxEnvironmentsRequest>
  void ListKxEnvironmentsAsync(const ListKxEnvironmentsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const ListKxEnvironmentsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListKxScalingGroups that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListKxScalingGroups that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListKxScalingGroupsRequestT = Model::ListKxScalingGroupsRequest>
  void ListKxScalingGroupsAsync(const ListKxScalingGroupsRequestT& request, const ListKxScalingGroupsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListKxUsers that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListKxUsersRequestT = Model::ListKxUsersRequest>
  void ListKxUsersAsync(const ListKxUsersRequestT& request, const ListKxUsersResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListKxVolumes that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListKxVolumesRequestT = Model::ListKxVolumesRequest>
  void ListKxVolumesAsync(const ListKxVolumesRequestT& request, const ListKxVolumesResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateKxClusterCodeConfigurationOutcome UpdateKxClusterCodeConfiguration(
      const Model::UpdateKxClusterCodeConfigurationRequest& request) const;

  /**
   * A Callable wrapper for UpdateKxClusterCodeConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename UpdateKxClusterCodeConfigurationRequestT = Model::UpdateKxClusterCodeConfigurationRequest>
  Model::UpdateKxClusterCodeConfigurationOutcomeCallable UpdateKxClusterCodeConfigurationCallable(
      const UpdateKxClusterCodeConfigurationRequestT& request) const {
    return SubmitCallable(&FinspaceClient::UpdateKxClusterCodeConfiguration, request);
  }

  /**
   * An Async wrapper for UpdateKxClusterCodeConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateKxClusterCodeConfigurationRequestT = Model::UpdateKxClusterCodeConfigurationRequest>
  void UpdateKxClusterCodeConfigurationAsync(const UpdateKxClusterCodeConfigurationRequestT& request,
                                             const UpdateKxClusterCodeConfigurationResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateKxClusterDatabases that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateKxClusterDatabases that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateKxClusterDatabasesRequestT = Model::UpdateKxClusterDatabasesRequest>
  void UpdateKxClusterDatabasesAsync(const UpdateKxClusterDatabasesRequestT& request,
                                     const UpdateKxClusterDatabasesResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateKxDatabase that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateKxDatabase that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateKxDatabaseRequestT = Model::UpdateKxDatabaseRequest>
  void UpdateKxDatabaseAsync(const UpdateKxDatabaseRequestT& request, const UpdateKxDatabaseResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateKxDataview that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateKxDataview that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateKxDataviewRequestT = Model::UpdateKxDataviewRequest>
  void UpdateKxDataviewAsync(const UpdateKxDataviewRequestT& request, const UpdateKxDataviewResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateKxEnvironment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateKxEnvironment that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateKxEnvironmentRequestT = Model::UpdateKxEnvironmentRequest>
  void UpdateKxEnvironmentAsync(const UpdateKxEnvironmentRequestT& request, const UpdateKxEnvironmentResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateKxEnvironmentNetworkOutcome UpdateKxEnvironmentNetwork(
      const Model::UpdateKxEnvironmentNetworkRequest& request) const;

  /**
   * A Callable wrapper for UpdateKxEnvironmentNetwork that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateKxEnvironmentNetworkRequestT = Model::UpdateKxEnvironmentNetworkRequest>
  Model::UpdateKxEnvironmentNetworkOutcomeCallable UpdateKxEnvironmentNetworkCallable(
      const UpdateKxEnvironmentNetworkRequestT& request) const {
    return SubmitCallable(&FinspaceClient::UpdateKxEnvironmentNetwork, request);
  }

  /**
   * An Async wrapper for UpdateKxEnvironmentNetwork that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateKxEnvironmentNetworkRequestT = Model::UpdateKxEnvironmentNetworkRequest>
  void UpdateKxEnvironmentNetworkAsync(const UpdateKxEnvironmentNetworkRequestT& request,
                                       const UpdateKxEnvironmentNetworkResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateKxUser that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateKxUserRequestT = Model::UpdateKxUserRequest>
  void UpdateKxUserAsync(const UpdateKxUserRequestT& request, const UpdateKxUserResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateKxVolume that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateKxVolumeRequestT = Model::UpdateKxVolumeRequest>
  void UpdateKxVolumeAsync(const UpdateKxVolumeRequestT& request, const UpdateKxVolumeResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
