...
namespace finspace
{
   ...
   * environments.</p>
   */
  class AWS_FINSPACE_API FinspaceClient : Aws::Client::ClientWithAsyncTemplateMethods<FinspaceClient>,
    smithy::client::AwsSmithyClientT<Aws::finspace::SERVICE_NAME,
