...
#ifdef AWS_FINSPACE_EXPORTS
#define AWS_FINSPACE_API __declspec(dllexport)
#else
...
#define AWS_FINSPACE_LOCAL
#else  // defined (USE_WINDOWS_DLL_SEMANTICS) || defined (WIN32)
#define AWS_FINSPACE_API
#define AWS_FINSPACE_EXTERN extern
#if __GNUC__ >= 4
#define AWS_FINSPACE_LOCAL __attribute__((visibility("hidden")))
#else
#define AWS_FINSPACE_LOCAL
#endif
