...
class CreateClusterRequest : public CloudHSMV2Request {
 public:
  ...
  template <typename BackupRetentionPolicyT = BackupRetentionPolicy>
  CreateClusterRequest& WithBackupRetentionPolicy(BackupRetentionPolicyT&& value) {
  ...
  template <typename HsmTypeT = Aws::String>
  CreateClusterRequest& WithHsmType(HsmTypeT&& value) {
  ...
  template <typename SourceBackupIdT = Aws::String>
  CreateClusterRequest& WithSourceBackupId(SourceBackupIdT&& value) {
  ...
  inline CreateClusterRequest& WithNetworkType(NetworkType value) {
  ...
  template <typename TagListT = Aws::Vector<Tag>>
  CreateClusterRequest& WithTagList(TagListT&& value) {
    SetTagList(std::forward<TagListT>(value));
    return *this;
  }
  template <typename TagListT = Tag>
  CreateClusterRequest& AddTagList(TagListT&& value) {
    m_tagListHasBeenSet = true;
  ...
  inline CreateClusterRequest& WithMode(ClusterMode value) {
    SetMode(value);
    return *this;
  }
  ///@}
