...
class ModifyClusterRequest : public CloudHSMV2Request {
 public:
  ...
  template <typename HsmTypeT = Aws::String>
  ModifyClusterRequest& WithHsmType(HsmTypeT&& value) {
  ...
  template <typename BackupRetentionPolicyT = BackupRetentionPolicy>
  ModifyClusterRequest& WithBackupRetentionPolicy(BackupRetentionPolicyT&& value) {
  ...
  template <typename ClusterIdT = Aws::String>
  ModifyClusterRequest& WithClusterId(ClusterIdT&& value) {
