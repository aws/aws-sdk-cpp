...
class DescribeBackupsRequest : public CloudHSMV2Request {
 public:
  ...
  inline DescribeBackupsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline void SetShared(bool value) {
    m_sharedHasBeenSet = true;
    m_shared = value;
  }
  inline DescribeBackupsRequest& WithShared(bool value) {
    SetShared(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSortAscending(bool value) {
    m_sortAscendingHasBeenSet = true;
    m_sortAscending = value;
  }
  inline DescribeBackupsRequest& WithSortAscending(bool value) {
