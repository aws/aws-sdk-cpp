...
class InitializeClusterRequest : public CloudHSMV2Request {
 public:
  ...
  template <typename ClusterIdT = Aws::String>
  InitializeClusterRequest& WithClusterId(ClusterIdT&& value) {
  ...
  void SetSignedCert(SignedCertT&& value) {
    m_signedCertHasBeenSet = true;
    m_signedCert = std::forward<SignedCertT>(value);
  }
  template <typename SignedCertT = Aws::String>
  InitializeClusterRequest& WithSignedCert(SignedCertT&& value) {
    SetSignedCert(std::forward<SignedCertT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TrustAnchorT = Aws::String>
  InitializeClusterRequest& WithTrustAnchor(TrustAnchorT&& value) {
