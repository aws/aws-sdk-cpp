...
/**
 */
class DeleteResourcePolicyRequest : public CloudHSMV2Request {
 public:
  AWS_CLOUDHSMV2_API DeleteResourcePolicyRequest() = default;
  ...
  ///@{
  /**
   * <p>Amazon Resource Name (ARN) of the resource from which the policy will be
   * removed. </p>
   */
