...
class CreateHsmRequest : public CloudHSMV2Request {
 public:
  ...
  template <typename ClusterIdT = Aws::String>
  CreateHsmRequest& WithClusterId(ClusterIdT&& value) {
  ...
  template <typename AvailabilityZoneT = Aws::String>
  CreateHsmRequest& WithAvailabilityZone(AvailabilityZoneT&& value) {
  ...
  template <typename IpAddressT = Aws::String>
  CreateHsmRequest& WithIpAddress(IpAddressT&& value) {
