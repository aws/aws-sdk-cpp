...
class ModifyBackupAttributesRequest : public CloudHSMV2Request {
 public:
  ...
  template <typename BackupIdT = Aws::String>
  ModifyBackupAttributesRequest& WithBackupId(BackupIdT&& value) {
  ...
  inline void SetNeverExpires(bool value) {
    m_neverExpiresHasBeenSet = true;
    m_neverExpires = value;
  }
  inline ModifyBackupAttributesRequest& WithNeverExpires(bool value) {
