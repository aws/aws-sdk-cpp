...
class CopyBackupToRegionRequest : public CloudHSMV2Request {
 public:
  ...
  template <typename DestinationRegionT = Aws::String>
  CopyBackupToRegionRequest& WithDestinationRegion(DestinationRegionT&& value) {
  ...
  template <typename BackupIdT = Aws::String>
  CopyBackupToRegionRequest& WithBackupId(BackupIdT&& value) {
  ...
  template <typename TagListT = Aws::Vector<Tag>>
  CopyBackupToRegionRequest& WithTagList(TagListT&& value) {
    SetTagList(std::forward<TagListT>(value));
    return *this;
  }
  template <typename TagListT = Tag>
  CopyBackupToRegionRequest& AddTagList(TagListT&& value) {
    m_tagListHasBeenSet = true;
