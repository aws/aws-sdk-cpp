...
class CopyBackupToRegionResult {
 public:
  ...
  void SetDestinationBackup(DestinationBackupT&& value) {
    m_destinationBackupHasBeenSet = true;
    m_destinationBackup = std::forward<DestinationBackupT>(value);
  }
  template <typename DestinationBackupT = DestinationBackup>
  CopyBackupToRegionResult& WithDestinationBackup(DestinationBackupT&& value) {
    SetDestinationBackup(std::forward<DestinationBackupT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  CopyBackupToRegionResult& WithRequestId(RequestIdT&& value) {
