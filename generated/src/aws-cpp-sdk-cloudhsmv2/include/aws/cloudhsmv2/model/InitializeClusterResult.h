...
class InitializeClusterResult {
 public:
  ...
  inline InitializeClusterResult& WithState(ClusterState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename StateMessageT = Aws::String>
  InitializeClusterResult& WithStateMessage(StateMessageT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  InitializeClusterResult& WithRequestId(RequestIdT&& value) {
