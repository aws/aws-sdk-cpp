...
class Cluster {
 public:
  ...
  inline void SetBackupPolicy(BackupPolicy value) {
    m_backupPolicyHasBeenSet = true;
    m_backupPolicy = value;
  }
  inline Cluster& WithBackupPolicy(BackupPolicy value) {
    SetBackupPolicy(value);
    return *this;
  }
  ///@}
  ...
  void SetBackupRetentionPolicy(BackupRetentionPolicyT&& value) {
    m_backupRetentionPolicyHasBeenSet = true;
    m_backupRetentionPolicy = std::forward<BackupRetentionPolicyT>(value);
  }
  template <typename BackupRetentionPolicyT = BackupRetentionPolicy>
  Cluster& WithBackupRetentionPolicy(BackupRetentionPolicyT&& value) {
    SetBackupRetentionPolicy(std::forward<BackupRetentionPolicyT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ClusterIdT = Aws::String>
  Cluster& WithClusterId(ClusterIdT&& value) {
  ...
  template <typename CreateTimestampT = Aws::Utils::DateTime>
  Cluster& WithCreateTimestamp(CreateTimestampT&& value) {
  ...
  void SetHsms(HsmsT&& value) {
    m_hsmsHasBeenSet = true;
    m_hsms = std::forward<HsmsT>(value);
  }
  template <typename HsmsT = Aws::Vector<Hsm>>
  Cluster& WithHsms(HsmsT&& value) {
    SetHsms(std::forward<HsmsT>(value));
    return *this;
  }
  template <typename HsmsT = Hsm>
  Cluster& AddHsms(HsmsT&& value) {
    m_hsmsHasBeenSet = true;
    m_hsms.emplace_back(std::forward<HsmsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename HsmTypeT = Aws::String>
  Cluster& WithHsmType(HsmTypeT&& value) {
  ...
  void SetHsmTypeRollbackExpiration(HsmTypeRollbackExpirationT&& value) {
    m_hsmTypeRollbackExpirationHasBeenSet = true;
    m_hsmTypeRollbackExpiration = std::forward<HsmTypeRollbackExpirationT>(value);
  }
  template <typename HsmTypeRollbackExpirationT = Aws::Utils::DateTime>
  Cluster& WithHsmTypeRollbackExpiration(HsmTypeRollbackExpirationT&& value) {
    SetHsmTypeRollbackExpiration(std::forward<HsmTypeRollbackExpirationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPreCoPassword(PreCoPasswordT&& value) {
    m_preCoPasswordHasBeenSet = true;
    m_preCoPassword = std::forward<PreCoPasswordT>(value);
  }
  template <typename PreCoPasswordT = Aws::String>
  Cluster& WithPreCoPassword(PreCoPasswordT&& value) {
    SetPreCoPassword(std::forward<PreCoPasswordT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename SecurityGroupT = Aws::String>
  Cluster& WithSecurityGroup(SecurityGroupT&& value) {
  ...
  template <typename SourceBackupIdT = Aws::String>
  Cluster& WithSourceBackupId(SourceBackupIdT&& value) {
  ...
  inline Cluster& WithState(ClusterState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename StateMessageT = Aws::String>
  Cluster& WithStateMessage(StateMessageT&& value) {
  ...
  template <typename SubnetMappingT = Aws::Map<Aws::String, Aws::String>>
  Cluster& WithSubnetMapping(SubnetMappingT&& value) {
  ...
  Cluster& AddSubnetMapping(SubnetMappingKeyT&& key, SubnetMappingValueT&& value) {
    m_subnetMappingHasBeenSet = true;
    m_subnetMapping.emplace(std::forward<SubnetMappingKeyT>(key), std::forward<SubnetMappingValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline Cluster& WithNetworkType(NetworkType value) {
  ...
  template <typename CertificatesT = Certificates>
  Cluster& WithCertificates(CertificatesT&& value) {
  ...
  template <typename TagListT = Aws::Vector<Tag>>
  Cluster& WithTagList(TagListT&& value) {
    SetTagList(std::forward<TagListT>(value));
    return *this;
  }
  template <typename TagListT = Tag>
  Cluster& AddTagList(TagListT&& value) {
    m_tagListHasBeenSet = true;
  ...
  inline void SetMode(ClusterMode value) {
    m_modeHasBeenSet = true;
    m_mode = value;
  }
  inline Cluster& WithMode(ClusterMode value) {
    SetMode(value);
    return *this;
  }
  ///@}
