...
class DeleteHsmRequest : public CloudHSMV2Request {
 public:
  ...
  template <typename ClusterIdT = Aws::String>
  DeleteHsmRequest& WithClusterId(ClusterIdT&& value) {
  ...
  template <typename HsmIdT = Aws::String>
  DeleteHsmRequest& WithHsmId(HsmIdT&& value) {
  ...
  template <typename EniIdT = Aws::String>
  DeleteHsmRequest& WithEniId(EniIdT&& value) {
  ...
  template <typename EniIpT = Aws::String>
  DeleteHsmRequest& WithEniIp(EniIpT&& value) {
