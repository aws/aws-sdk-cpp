...
namespace CloudHSMV2
{
   ...
   * Guide</a>.</p>
   */
  class AWS_CLOUDHSMV2_API CloudHSMV2Client : Aws::Client::ClientWithAsyncTemplateMethods<CloudHSMV2Client>,
    smithy::client::AwsSmithyClientT<Aws::CloudHSMV2::SERVICE_NAME,
