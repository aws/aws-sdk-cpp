...
namespace Model
{
  ...
  {
  public:
    AWS_APIGATEWAYV2_API GetStagesRequest() = default;
    ...
    template<typename ApiIdT = Aws::String>
    GetStagesRequest& WithApiId(ApiIdT&& value) { SetApiId(std::forward<ApiIdT>(value)); return *this;}
    ///@}
    ...
    template<typename MaxResultsT = Aws::String>
    GetStagesRequest& WithMaxResults(MaxResultsT&& value) { SetMaxResults(std::forward<MaxResultsT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    GetStagesRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
