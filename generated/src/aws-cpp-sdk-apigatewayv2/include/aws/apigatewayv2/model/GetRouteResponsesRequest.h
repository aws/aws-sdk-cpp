...
class GetRouteResponsesRequest : public ApiGatewayV2Request {
 public:
  ...
  template <typename ApiIdT = Aws::String>
  GetRouteResponsesRequest& WithApiId(ApiIdT&& value) {
  ...
  template <typename MaxResultsT = Aws::String>
  GetRouteResponsesRequest& WithMaxResults(MaxResultsT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  GetRouteResponsesRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RouteIdT = Aws::String>
  GetRouteResponsesRequest& WithRouteId(RouteIdT&& value) {
