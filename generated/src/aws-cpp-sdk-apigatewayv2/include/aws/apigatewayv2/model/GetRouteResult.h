...
class GetRouteResult {
 public:
  ...
  inline GetRouteResult& WithApiGatewayManaged(bool value) {
  ...
  inline GetRouteResult& WithApiKeyRequired(bool value) {
  ...
  template <typename AuthorizationScopesT = Aws::Vector<Aws::String>>
  GetRouteResult& WithAuthorizationScopes(AuthorizationScopesT&& value) {
    SetAuthorizationScopes(std::forward<AuthorizationScopesT>(value));
    return *this;
  }
  template <typename AuthorizationScopesT = Aws::String>
  GetRouteResult& AddAuthorizationScopes(AuthorizationScopesT&& value) {
    m_authorizationScopesHasBeenSet = true;
  ...
  inline GetRouteResult& WithAuthorizationType(AuthorizationType value) {
  ...
  template <typename AuthorizerIdT = Aws::String>
  GetRouteResult& WithAuthorizerId(AuthorizerIdT&& value) {
  ...
  template <typename ModelSelectionExpressionT = Aws::String>
  GetRouteResult& WithModelSelectionExpression(ModelSelectionExpressionT&& value) {
  ...
  template <typename OperationNameT = Aws::String>
  GetRouteResult& WithOperationName(OperationNameT&& value) {
  ...
  template <typename RequestModelsT = Aws::Map<Aws::String, Aws::String>>
  GetRouteResult& WithRequestModels(RequestModelsT&& value) {
  ...
  template <typename RequestParametersT = Aws::Map<Aws::String, ParameterConstraints>>
  GetRouteResult& WithRequestParameters(RequestParametersT&& value) {
  ...
  template <typename RouteKeyT = Aws::String>
  GetRouteResult& WithRouteKey(RouteKeyT&& value) {
  ...
  template <typename RouteResponseSelectionExpressionT = Aws::String>
  GetRouteResult& WithRouteResponseSelectionExpression(RouteResponseSelectionExpressionT&& value) {
  ...
  template <typename TargetT = Aws::String>
  GetRouteResult& WithTarget(TargetT&& value) {
