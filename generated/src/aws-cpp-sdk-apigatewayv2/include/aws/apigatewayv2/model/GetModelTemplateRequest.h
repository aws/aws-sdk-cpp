...
/**
 */
class GetModelTemplateRequest : public ApiGatewayV2Request {
 public:
  AWS_APIGATEWAYV2_API GetModelTemplateRequest() = default;
  ...
  template <typename ApiIdT = Aws::String>
  GetModelTemplateRequest& WithApiId(ApiIdT&& value) {
  ...
  template <typename ModelIdT = Aws::String>
  GetModelTemplateRequest& WithModelId(ModelIdT&& value) {
