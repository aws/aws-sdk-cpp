...
class GetPortalProductResult {
 public:
  AWS_APIGATEWAYV2_API GetPortalProductResult() = default;
  AWS_APIGATEWAYV2_API GetPortalProductResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_APIGATEWAYV2_API GetPortalProductResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename DescriptionT = Aws::String>
  GetPortalProductResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename DisplayNameT = Aws::String>
  GetPortalProductResult& WithDisplayName(DisplayNameT&& value) {
  ...
  template <typename DisplayOrderT = DisplayOrder>
  GetPortalProductResult& WithDisplayOrder(DisplayOrderT&& value) {
  ...
  template <typename LastModifiedT = Aws::Utils::DateTime>
  GetPortalProductResult& WithLastModified(LastModifiedT&& value) {
  ...
  template <typename PortalProductArnT = Aws::String>
  GetPortalProductResult& WithPortalProductArn(PortalProductArnT&& value) {
  ...
  template <typename PortalProductIdT = Aws::String>
  GetPortalProductResult& WithPortalProductId(PortalProductIdT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  GetPortalProductResult& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsKeyT = Aws::String, typename TagsValueT = Aws::String>
  GetPortalProductResult& AddTags(TagsKeyT&& key, TagsValueT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetPortalProductResult& WithRequestId(RequestIdT&& value) {
