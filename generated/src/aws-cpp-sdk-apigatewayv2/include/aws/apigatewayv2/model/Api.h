...
class Api {
 public:
  ...
  inline Api& WithApiGatewayManaged(bool value) {
  ...
  inline Api& WithDisableSchemaValidation(bool value) {
  ...
  inline Api& WithDisableExecuteApiEndpoint(bool value) {
  ...
  inline Api& WithIpAddressType(IpAddressType value) {
  ...
  inline Api& WithProtocolType(ProtocolType value) {
