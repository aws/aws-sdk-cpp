...
namespace Model
{
  ...
  public:
    ...
    template<typename CreatedDateT = Aws::Utils::DateTime>
    CreateVpcLinkResult& WithCreatedDate(CreatedDateT&& value) { SetCreatedDate(std::forward<CreatedDateT>(value)); return *this;}
    ///@}
    ...
    template<typename SecurityGroupIdsT = Aws::Vector<Aws::String>>
    CreateVpcLinkResult& WithSecurityGroupIds(SecurityGroupIdsT&& value) { SetSecurityGroupIds(std::forward<SecurityGroupIdsT>(value)); return *this;}
    template<typename SecurityGroupIdsT = Aws::String>
    CreateVpcLinkResult& AddSecurityGroupIds(SecurityGroupIdsT&& value) { m_securityGroupIdsHasBeenSet = true; m_securityGroupIds.emplace_back(std::forward<SecurityGroupIdsT>(value)); return *this; }
    ///@}
    ...
    template<typename SubnetIdsT = Aws::Vector<Aws::String>>
    CreateVpcLinkResult& WithSubnetIds(SubnetIdsT&& value) { SetSubnetIds(std::forward<SubnetIdsT>(value)); return *this;}
    template<typename SubnetIdsT = Aws::String>
    CreateVpcLinkResult& AddSubnetIds(SubnetIdsT&& value) { m_subnetIdsHasBeenSet = true; m_subnetIds.emplace_back(std::forward<SubnetIdsT>(value)); return *this; }
    ///@}
    ...
    template<typename VpcLinkIdT = Aws::String>
    CreateVpcLinkResult& WithVpcLinkId(VpcLinkIdT&& value) { SetVpcLinkId(std::forward<VpcLinkIdT>(value)); return *this;}
    ///@}
    ...
    inline CreateVpcLinkResult& WithVpcLinkStatus(VpcLinkStatus value) { SetVpcLinkStatus(value); return *this;}
    ///@}
    ...
    template<typename VpcLinkStatusMessageT = Aws::String>
    CreateVpcLinkResult& WithVpcLinkStatusMessage(VpcLinkStatusMessageT&& value) { SetVpcLinkStatusMessage(std::forward<VpcLinkStatusMessageT>(value)); return *this;}
    ///@}
    ...
    inline CreateVpcLinkResult& WithVpcLinkVersion(VpcLinkVersion value) { SetVpcLinkVersion(value); return *this;}
    ///@}
