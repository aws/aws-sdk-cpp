...
class Integration {
 public:
  ...
  inline Integration& WithApiGatewayManaged(bool value) {
  ...
  inline Integration& WithConnectionType(ConnectionType value) {
  ...
  inline Integration& WithContentHandlingStrategy(ContentHandlingStrategy value) {
  ...
  inline Integration& WithPassthroughBehavior(PassthroughBehavior value) {
  ...
  inline Integration& WithTimeoutInMillis(int value) {
