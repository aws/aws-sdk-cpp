...
class ImportApiResult {
 public:
  ...
  template <typename ApiEndpointT = Aws::String>
  ImportApiResult& WithApiEndpoint(ApiEndpointT&& value) {
  ...
  inline ImportApiResult& WithApiGatewayManaged(bool value) {
  ...
  template <typename ApiIdT = Aws::String>
  ImportApiResult& WithApiId(ApiIdT&& value) {
  ...
  template <typename ApiKeySelectionExpressionT = Aws::String>
  ImportApiResult& WithApiKeySelectionExpression(ApiKeySelectionExpressionT&& value) {
  ...
  template <typename CorsConfigurationT = Cors>
  ImportApiResult& WithCorsConfiguration(CorsConfigurationT&& value) {
  ...
  template <typename CreatedDateT = Aws::Utils::DateTime>
  ImportApiResult& WithCreatedDate(CreatedDateT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  ImportApiResult& WithDescription(DescriptionT&& value) {
  ...
  inline ImportApiResult& WithDisableSchemaValidation(bool value) {
  ...
  inline ImportApiResult& WithDisableExecuteApiEndpoint(bool value) {
  ...
  template <typename ImportInfoT = Aws::Vector<Aws::String>>
  ImportApiResult& WithImportInfo(ImportInfoT&& value) {
    SetImportInfo(std::forward<ImportInfoT>(value));
    return *this;
  }
  template <typename ImportInfoT = Aws::String>
  ImportApiResult& AddImportInfo(ImportInfoT&& value) {
    m_importInfoHasBeenSet = true;
  ...
  inline ImportApiResult& WithIpAddressType(IpAddressType value) {
  ...
  template <typename NameT = Aws::String>
  ImportApiResult& WithName(NameT&& value) {
  ...
  inline ImportApiResult& WithProtocolType(ProtocolType value) {
  ...
  template <typename RouteSelectionExpressionT = Aws::String>
  ImportApiResult& WithRouteSelectionExpression(RouteSelectionExpressionT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  ImportApiResult& WithTags(TagsT&& value) {
  ...
  template <typename VersionT = Aws::String>
  ImportApiResult& WithVersion(VersionT&& value) {
  ...
  template <typename WarningsT = Aws::Vector<Aws::String>>
  ImportApiResult& WithWarnings(WarningsT&& value) {
    SetWarnings(std::forward<WarningsT>(value));
    return *this;
  }
  template <typename WarningsT = Aws::String>
  ImportApiResult& AddWarnings(WarningsT&& value) {
    m_warningsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ImportApiResult& WithRequestId(RequestIdT&& value) {
