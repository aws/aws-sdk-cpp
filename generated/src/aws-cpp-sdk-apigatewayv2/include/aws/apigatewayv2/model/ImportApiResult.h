...
namespace Model
{
  class ImportApiResult
  {
  public:
    AWS_APIGATEWAYV2_API ImportApiResult() = default;
    AWS_APIGATEWAYV2_API ImportApiResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_APIGATEWAYV2_API ImportApiResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ...
    template<typename ApiEndpointT = Aws::String>
    ImportApiResult& WithApiEndpoint(ApiEndpointT&& value) { SetApiEndpoint(std::forward<ApiEndpointT>(value)); return *this;}
    ///@}
    ...
    template<typename ApiIdT = Aws::String>
    ImportApiResult& WithApiId(ApiIdT&& value) { SetApiId(std::forward<ApiIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ApiKeySelectionExpressionT = Aws::String>
    ImportApiResult& WithApiKeySelectionExpression(ApiKeySelectionExpressionT&& value) { SetApiKeySelectionExpression(std::forward<ApiKeySelectionExpressionT>(value)); return *this;}
    ///@}
    ...
    template<typename CorsConfigurationT = Cors>
    ImportApiResult& WithCorsConfiguration(CorsConfigurationT&& value) { SetCorsConfiguration(std::forward<CorsConfigurationT>(value)); return *this;}
    ///@}
    ...
    template<typename CreatedDateT = Aws::Utils::DateTime>
    ImportApiResult& WithCreatedDate(CreatedDateT&& value) { SetCreatedDate(std::forward<CreatedDateT>(value)); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    ImportApiResult& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename ImportInfoT = Aws::Vector<Aws::String>>
    ImportApiResult& WithImportInfo(ImportInfoT&& value) { SetImportInfo(std::forward<ImportInfoT>(value)); return *this;}
    template<typename ImportInfoT = Aws::String>
    ImportApiResult& AddImportInfo(ImportInfoT&& value) { m_importInfoHasBeenSet = true; m_importInfo.emplace_back(std::forward<ImportInfoT>(value)); return *this; }
    ///@}
    ...
    inline ImportApiResult& WithIpAddressType(IpAddressType value) { SetIpAddressType(value); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    ImportApiResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    inline ImportApiResult& WithProtocolType(ProtocolType value) { SetProtocolType(value); return *this;}
    ///@}
    ...
    template<typename RouteSelectionExpressionT = Aws::String>
    ImportApiResult& WithRouteSelectionExpression(RouteSelectionExpressionT&& value) { SetRouteSelectionExpression(std::forward<RouteSelectionExpressionT>(value)); return *this;}
    ///@}
    ...
    template<typename TagsT = Aws::Map<Aws::String, Aws::String>>
    ImportApiResult& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
    template<typename TagsKeyT = Aws::String, typename TagsValueT = Aws::String>
    ImportApiResult& AddTags(TagsKeyT&& key, TagsValueT&& value) {
    ...
    template<typename VersionT = Aws::String>
    ImportApiResult& WithVersion(VersionT&& value) { SetVersion(std::forward<VersionT>(value)); return *this;}
    ///@}
    ...
    template<typename WarningsT = Aws::Vector<Aws::String>>
    ImportApiResult& WithWarnings(WarningsT&& value) { SetWarnings(std::forward<WarningsT>(value)); return *this;}
    template<typename WarningsT = Aws::String>
    ImportApiResult& AddWarnings(WarningsT&& value) { m_warningsHasBeenSet = true; m_warnings.emplace_back(std::forward<WarningsT>(value)); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ImportApiResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
