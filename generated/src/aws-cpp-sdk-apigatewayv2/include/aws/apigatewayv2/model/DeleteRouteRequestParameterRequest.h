...
class DeleteRouteRequestParameterRequest : public ApiGatewayV2Request {
 public:
  ...
  template <typename ApiIdT = Aws::String>
  DeleteRouteRequestParameterRequest& WithApiId(ApiIdT&& value) {
  ...
  void SetRequestParameterKey(RequestParameterKeyT&& value) {
    m_requestParameterKeyHasBeenSet = true;
    m_requestParameterKey = std::forward<RequestParameterKeyT>(value);
  }
  template <typename RequestParameterKeyT = Aws::String>
  DeleteRouteRequestParameterRequest& WithRequestParameterKey(RequestParameterKeyT&& value) {
    SetRequestParameterKey(std::forward<RequestParameterKeyT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RouteIdT = Aws::String>
  DeleteRouteRequestParameterRequest& WithRouteId(RouteIdT&& value) {
