...
namespace Model
{
  ...
  {
  public:
    AWS_APIGATEWAYV2_API GetStageRequest();
     ...
     * <p>The API identifier.</p>
     */
    inline GetStageRequest& WithApiId(const Aws::String& value) { SetApiId(value); return *this;}

    /**
     * <p>The API identifier.</p>
     */
    inline GetStageRequest& WithApiId(Aws::String&& value) { SetApiId(std::move(value)); return *this;}

    /**
     * <p>The API identifier.</p>
     */
    inline GetStageRequest& WithApiId(const char* value) { SetApiId(value); return *this;}
