...
class GetApiResult {
 public:
  ...
  inline GetApiResult& WithApiGatewayManaged(bool value) {
  ...
  inline GetApiResult& WithDisableSchemaValidation(bool value) {
  ...
  inline GetApiResult& WithDisableExecuteApiEndpoint(bool value) {
  ...
  inline GetApiResult& WithIpAddressType(IpAddressType value) {
  ...
  inline GetApiResult& WithProtocolType(ProtocolType value) {
