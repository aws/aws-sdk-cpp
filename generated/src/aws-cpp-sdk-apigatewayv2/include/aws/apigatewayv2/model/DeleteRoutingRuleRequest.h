...
namespace Model
{
  ...
  public:
    ...
    template<typename DomainNameT = Aws::String>
    DeleteRoutingRuleRequest& WithDomainName(DomainNameT&& value) { SetDomainName(std::forward<DomainNameT>(value)); return *this;}
    ///@}
    ...
    template<typename DomainNameIdT = Aws::String>
    DeleteRoutingRuleRequest& WithDomainNameId(DomainNameIdT&& value) { SetDomainNameId(std::forward<DomainNameIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RoutingRuleIdT = Aws::String>
    DeleteRoutingRuleRequest& WithRoutingRuleId(RoutingRuleIdT&& value) { SetRoutingRuleId(std::forward<RoutingRuleIdT>(value)); return *this;}
    ///@}
  private:
