...
class GetIntegrationResponseResult {
 public:
  ...
  inline GetIntegrationResponseResult& WithContentHandlingStrategy(ContentHandlingStrategy value) {
  ...
  template <typename IntegrationResponseIdT = Aws::String>
  GetIntegrationResponseResult& WithIntegrationResponseId(IntegrationResponseIdT&& value) {
  ...
  template <typename IntegrationResponseKeyT = Aws::String>
  GetIntegrationResponseResult& WithIntegrationResponseKey(IntegrationResponseKeyT&& value) {
  ...
  template <typename ResponseParametersT = Aws::Map<Aws::String, Aws::String>>
  GetIntegrationResponseResult& WithResponseParameters(ResponseParametersT&& value) {
  ...
  template <typename ResponseTemplatesT = Aws::Map<Aws::String, Aws::String>>
  GetIntegrationResponseResult& WithResponseTemplates(ResponseTemplatesT&& value) {
  ...
  template <typename TemplateSelectionExpressionT = Aws::String>
  GetIntegrationResponseResult& WithTemplateSelectionExpression(TemplateSelectionExpressionT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetIntegrationResponseResult& WithRequestId(RequestIdT&& value) {
