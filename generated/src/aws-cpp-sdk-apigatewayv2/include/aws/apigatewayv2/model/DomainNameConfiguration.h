...
class DomainNameConfiguration {
 public:
  ...
  void SetApiGatewayDomainName(ApiGatewayDomainNameT&& value) {
    ...
    m_apiGatewayDomainName = std::forward<ApiGatewayDomainNameT>(value);
  }
  template <typename ApiGatewayDomainNameT = Aws::String>
  DomainNameConfiguration& WithApiGatewayDomainName(ApiGatewayDomainNameT&& value) {
    SetApiGatewayDomainName(std::forward<ApiGatewayDomainNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline DomainNameConfiguration& WithDomainNameStatus(DomainNameStatus value) {
  ...
  inline DomainNameConfiguration& WithEndpointType(EndpointType value) {
  ...
  inline DomainNameConfiguration& WithIpAddressType(IpAddressType value) {
  ...
  inline DomainNameConfiguration& WithSecurityPolicy(SecurityPolicy value) {
