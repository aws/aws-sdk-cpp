...
namespace Model
{
  ...
  {
  public:
    AWS_APIGATEWAYV2_API GetDomainNamesResult();
     ...
     * element of the collection.</p>
     */
    inline GetDomainNamesResult& WithNextToken(const Aws::String& value) { SetNextToken(value); return *this;}

    /**
     * <p>The next page of elements from this collection. Not valid for the last
     * element of the collection.</p>
     */
    inline GetDomainNamesResult& WithNextToken(Aws::String&& value) { SetNextToken(std::move(value)); return *this;}

    /**
     * <p>The next page of elements from this collection. Not valid for the last
     * element of the collection.</p>
     */
    inline GetDomainNamesResult& WithNextToken(const char* value) { SetNextToken(value); return *this;}
