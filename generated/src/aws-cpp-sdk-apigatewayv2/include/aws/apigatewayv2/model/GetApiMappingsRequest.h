...
class GetApiMappingsRequest : public ApiGatewayV2Request {
 public:
  ...
  template <typename DomainNameT = Aws::String>
  GetApiMappingsRequest& WithDomainName(DomainNameT&& value) {
  ...
  template <typename MaxResultsT = Aws::String>
  GetApiMappingsRequest& WithMaxResults(MaxResultsT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  GetApiMappingsRequest& WithNextToken(NextTokenT&& value) {
