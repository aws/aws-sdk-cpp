...
class UpdateApiResult {
 public:
  ...
  template <typename ApiEndpointT = Aws::String>
  UpdateApiResult& WithApiEndpoint(ApiEndpointT&& value) {
  ...
  inline UpdateApiResult& WithApiGatewayManaged(bool value) {
  ...
  template <typename ApiIdT = Aws::String>
  UpdateApiResult& WithApiId(ApiIdT&& value) {
  ...
  template <typename ApiKeySelectionExpressionT = Aws::String>
  UpdateApiResult& WithApiKeySelectionExpression(ApiKeySelectionExpressionT&& value) {
  ...
  template <typename CorsConfigurationT = Cors>
  UpdateApiResult& WithCorsConfiguration(CorsConfigurationT&& value) {
  ...
  template <typename CreatedDateT = Aws::Utils::DateTime>
  UpdateApiResult& WithCreatedDate(CreatedDateT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateApiResult& WithDescription(DescriptionT&& value) {
  ...
  inline UpdateApiResult& WithDisableSchemaValidation(bool value) {
  ...
  inline UpdateApiResult& WithDisableExecuteApiEndpoint(bool value) {
  ...
  template <typename ImportInfoT = Aws::Vector<Aws::String>>
  UpdateApiResult& WithImportInfo(ImportInfoT&& value) {
    SetImportInfo(std::forward<ImportInfoT>(value));
    return *this;
  }
  template <typename ImportInfoT = Aws::String>
  UpdateApiResult& AddImportInfo(ImportInfoT&& value) {
    m_importInfoHasBeenSet = true;
  ...
  inline UpdateApiResult& WithIpAddressType(IpAddressType value) {
  ...
  template <typename NameT = Aws::String>
  UpdateApiResult& WithName(NameT&& value) {
  ...
  inline UpdateApiResult& WithProtocolType(ProtocolType value) {
  ...
  template <typename RouteSelectionExpressionT = Aws::String>
  UpdateApiResult& WithRouteSelectionExpression(RouteSelectionExpressionT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  UpdateApiResult& WithTags(TagsT&& value) {
  ...
  template <typename VersionT = Aws::String>
  UpdateApiResult& WithVersion(VersionT&& value) {
  ...
  template <typename WarningsT = Aws::Vector<Aws::String>>
  UpdateApiResult& WithWarnings(WarningsT&& value) {
    SetWarnings(std::forward<WarningsT>(value));
    return *this;
  }
  template <typename WarningsT = Aws::String>
  UpdateApiResult& AddWarnings(WarningsT&& value) {
    m_warningsHasBeenSet = true;
