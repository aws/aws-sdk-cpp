...
class CreateRoutingRuleRequest : public ApiGatewayV2Request {
 public:
  ...
  template <typename ActionsT = Aws::Vector<RoutingRuleAction>>
  CreateRoutingRuleRequest& WithActions(ActionsT&& value) {
    SetActions(std::forward<ActionsT>(value));
    return *this;
  }
  template <typename ActionsT = RoutingRuleAction>
  CreateRoutingRuleRequest& AddActions(ActionsT&& value) {
    m_actionsHasBeenSet = true;
  ...
  template <typename ConditionsT = Aws::Vector<RoutingRuleCondition>>
  CreateRoutingRuleRequest& WithConditions(ConditionsT&& value) {
    SetConditions(std::forward<ConditionsT>(value));
    return *this;
  }
  template <typename ConditionsT = RoutingRuleCondition>
  CreateRoutingRuleRequest& AddConditions(ConditionsT&& value) {
    m_conditionsHasBeenSet = true;
  ...
  template <typename DomainNameT = Aws::String>
  CreateRoutingRuleRequest& WithDomainName(DomainNameT&& value) {
  ...
  template <typename DomainNameIdT = Aws::String>
  CreateRoutingRuleRequest& WithDomainNameId(DomainNameIdT&& value) {
  ...
  inline CreateRoutingRuleRequest& WithPriority(int value) {
    SetPriority(value);
    return *this;
  }
  ///@}
