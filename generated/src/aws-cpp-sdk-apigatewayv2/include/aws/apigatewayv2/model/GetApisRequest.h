...
namespace Model
{
  ...
  public:
    ...
    template<typename MaxResultsT = Aws::String>
    GetApisRequest& WithMaxResults(MaxResultsT&& value) { SetMaxResults(std::forward<MaxResultsT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    GetApisRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
