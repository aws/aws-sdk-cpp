...
class ExportApiRequest : public ApiGatewayV2Request {
 public:
  ...
  void SetExportVersion(ExportVersionT&& value) {
    m_exportVersionHasBeenSet = true;
    m_exportVersion = std::forward<ExportVersionT>(value);
  }
  template <typename ExportVersionT = Aws::String>
  ExportApiRequest& WithExportVersion(ExportVersionT&& value) {
    SetExportVersion(std::forward<ExportVersionT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetIncludeExtensions(bool value) {
    m_includeExtensionsHasBeenSet = true;
    m_includeExtensions = value;
  }
  inline ExportApiRequest& WithIncludeExtensions(bool value) {
    SetIncludeExtensions(value);
    return *this;
  }
  ///@}
