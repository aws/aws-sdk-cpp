...
class GetRouteResponsesResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<RouteResponse>>
  GetRouteResponsesResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = RouteResponse>
  GetRouteResponsesResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetRouteResponsesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetRouteResponsesResult& WithRequestId(RequestIdT&& value) {
