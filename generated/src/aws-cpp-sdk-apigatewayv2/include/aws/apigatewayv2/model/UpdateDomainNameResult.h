...
namespace Model
{
  ...
  {
  public:
    AWS_APIGATEWAYV2_API UpdateDomainNameResult() = default;
    ...
    template<typename ApiMappingSelectionExpressionT = Aws::String>
    UpdateDomainNameResult& WithApiMappingSelectionExpression(ApiMappingSelectionExpressionT&& value) { SetApiMappingSelectionExpression(std::forward<ApiMappingSelectionExpressionT>(value)); return *this;}
    ///@}
    ...
    template<typename DomainNameConfigurationsT = Aws::Vector<DomainNameConfiguration>>
    UpdateDomainNameResult& WithDomainNameConfigurations(DomainNameConfigurationsT&& value) { SetDomainNameConfigurations(std::forward<DomainNameConfigurationsT>(value)); return *this;}
    template<typename DomainNameConfigurationsT = DomainNameConfiguration>
    UpdateDomainNameResult& AddDomainNameConfigurations(DomainNameConfigurationsT&& value) { m_domainNameConfigurationsHasBeenSet = true; m_domainNameConfigurations.emplace_back(std::forward<DomainNameConfigurationsT>(value)); return *this; }
    ///@}
