...
namespace Model
{
  ...
  {
  public:
    AWS_APIGATEWAYV2_API GetDeploymentsResult() = default;
    ...
    template<typename NextTokenT = Aws::String>
    GetDeploymentsResult& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
