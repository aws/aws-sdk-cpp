...
class GetAuthorizerResult {
 public:
  ...
  inline GetAuthorizerResult& WithAuthorizerResultTtlInSeconds(int value) {
  ...
  inline GetAuthorizerResult& WithAuthorizerType(AuthorizerType value) {
  ...
  inline GetAuthorizerResult& WithEnableSimpleResponses(bool value) {
