...
class DomainName {
 public:
  ...
  template <typename ApiMappingSelectionExpressionT = Aws::String>
  DomainName& WithApiMappingSelectionExpression(ApiMappingSelectionExpressionT&& value) {
  ...
  template <typename DomainNameConfigurationsT = Aws::Vector<DomainNameConfiguration>>
  DomainName& WithDomainNameConfigurations(DomainNameConfigurationsT&& value) {
  ...
  DomainName& AddDomainNameConfigurations(DomainNameConfigurationsT&& value) {
    m_domainNameConfigurationsHasBeenSet = true;
