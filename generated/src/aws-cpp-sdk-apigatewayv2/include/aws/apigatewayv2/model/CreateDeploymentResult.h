...
namespace Model
{
  ...
  public:
    ...
    inline CreateDeploymentResult& WithDeploymentStatus(DeploymentStatus value) { SetDeploymentStatus(value); return *this;}
    ///@}
    ...
    template<typename DeploymentStatusMessageT = Aws::String>
    CreateDeploymentResult& WithDeploymentStatusMessage(DeploymentStatusMessageT&& value) { SetDeploymentStatusMessage(std::forward<DeploymentStatusMessageT>(value)); return *this;}
    ///@}
