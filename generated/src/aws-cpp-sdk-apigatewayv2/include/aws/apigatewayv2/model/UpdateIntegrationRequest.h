...
class UpdateIntegrationRequest : public ApiGatewayV2Request {
 public:
  ...
  inline UpdateIntegrationRequest& WithConnectionType(ConnectionType value) {
  ...
  inline UpdateIntegrationRequest& WithContentHandlingStrategy(ContentHandlingStrategy value) {
  ...
  inline UpdateIntegrationRequest& WithIntegrationType(IntegrationType value) {
  ...
  inline UpdateIntegrationRequest& WithPassthroughBehavior(PassthroughBehavior value) {
  ...
  inline UpdateIntegrationRequest& WithTimeoutInMillis(int value) {
