...
namespace Model
{
  ...
  public:
    ...
    inline CreateIntegrationResponseResult& WithContentHandlingStrategy(ContentHandlingStrategy value) { SetContentHandlingStrategy(value); return *this;}
    ///@}
    ...
    template<typename IntegrationResponseIdT = Aws::String>
    CreateIntegrationResponseResult& WithIntegrationResponseId(IntegrationResponseIdT&& value) { SetIntegrationResponseId(std::forward<IntegrationResponseIdT>(value)); return *this;}
    ///@}
    ...
    template<typename IntegrationResponseKeyT = Aws::String>
    CreateIntegrationResponseResult& WithIntegrationResponseKey(IntegrationResponseKeyT&& value) { SetIntegrationResponseKey(std::forward<IntegrationResponseKeyT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseParametersT = Aws::Map<Aws::String, Aws::String>>
    CreateIntegrationResponseResult& WithResponseParameters(ResponseParametersT&& value) { SetResponseParameters(std::forward<ResponseParametersT>(value)); return *this;}
    ...
    template<typename ResponseTemplatesT = Aws::Map<Aws::String, Aws::String>>
    CreateIntegrationResponseResult& WithResponseTemplates(ResponseTemplatesT&& value) { SetResponseTemplates(std::forward<ResponseTemplatesT>(value)); return *this;}
    ...
    template<typename TemplateSelectionExpressionT = Aws::String>
    CreateIntegrationResponseResult& WithTemplateSelectionExpression(TemplateSelectionExpressionT&& value) { SetTemplateSelectionExpression(std::forward<TemplateSelectionExpressionT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateIntegrationResponseResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
