...
class UpdateIntegrationResult {
 public:
  ...
  inline void SetApiGatewayManaged(bool value) {
    m_apiGatewayManagedHasBeenSet = true;
    m_apiGatewayManaged = value;
  }
  inline UpdateIntegrationResult& WithApiGatewayManaged(bool value) {
    SetApiGatewayManaged(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateIntegrationResult& WithConnectionType(ConnectionType value) {
  ...
  inline void SetContentHandlingStrategy(ContentHandlingStrategy value) {
    m_contentHandlingStrategyHasBeenSet = true;
    m_contentHandlingStrategy = value;
  }
  inline UpdateIntegrationResult& WithContentHandlingStrategy(ContentHandlingStrategy value) {
    SetContentHandlingStrategy(value);
    return *this;
  }
  ///@}
  ...
  void SetIntegrationMethod(IntegrationMethodT&& value) {
    ...
    m_integrationMethod = std::forward<IntegrationMethodT>(value);
  }
  template <typename IntegrationMethodT = Aws::String>
  UpdateIntegrationResult& WithIntegrationMethod(IntegrationMethodT&& value) {
    SetIntegrationMethod(std::forward<IntegrationMethodT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIntegrationResponseSelectionExpression(IntegrationResponseSelectionExpressionT&& value) {
    ...
    m_integrationResponseSelectionExpression = std::forward<IntegrationResponseSelectionExpressionT>(value);
  }
  template <typename IntegrationResponseSelectionExpressionT = Aws::String>
  UpdateIntegrationResult& WithIntegrationResponseSelectionExpression(IntegrationResponseSelectionExpressionT&& value) {
    SetIntegrationResponseSelectionExpression(std::forward<IntegrationResponseSelectionExpressionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIntegrationSubtype(IntegrationSubtypeT&& value) {
    ...
    m_integrationSubtype = std::forward<IntegrationSubtypeT>(value);
  }
  template <typename IntegrationSubtypeT = Aws::String>
  UpdateIntegrationResult& WithIntegrationSubtype(IntegrationSubtypeT&& value) {
    SetIntegrationSubtype(std::forward<IntegrationSubtypeT>(value));
    return *this;
  }
  ///@}
  ...
  inline UpdateIntegrationResult& WithIntegrationType(IntegrationType value) {
  ...
  void SetIntegrationUri(IntegrationUriT&& value) {
    ...
    m_integrationUri = std::forward<IntegrationUriT>(value);
  }
  template <typename IntegrationUriT = Aws::String>
  UpdateIntegrationResult& WithIntegrationUri(IntegrationUriT&& value) {
    SetIntegrationUri(std::forward<IntegrationUriT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetPassthroughBehavior(PassthroughBehavior value) {
    m_passthroughBehaviorHasBeenSet = true;
    m_passthroughBehavior = value;
  }
  inline UpdateIntegrationResult& WithPassthroughBehavior(PassthroughBehavior value) {
    SetPassthroughBehavior(value);
    return *this;
  }
  ///@}
  ...
  void SetPayloadFormatVersion(PayloadFormatVersionT&& value) {
    ...
    m_payloadFormatVersion = std::forward<PayloadFormatVersionT>(value);
  }
  template <typename PayloadFormatVersionT = Aws::String>
  UpdateIntegrationResult& WithPayloadFormatVersion(PayloadFormatVersionT&& value) {
    SetPayloadFormatVersion(std::forward<PayloadFormatVersionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetResponseParameters(ResponseParametersT&& value) {
    ...
    m_responseParameters = std::forward<ResponseParametersT>(value);
  }
  template <typename ResponseParametersT = Aws::Map<Aws::String, Aws::Map<Aws::String, Aws::String>>>
  UpdateIntegrationResult& WithResponseParameters(ResponseParametersT&& value) {
    SetResponseParameters(std::forward<ResponseParametersT>(value));
    return *this;
  }
  ...
  UpdateIntegrationResult& AddResponseParameters(ResponseParametersKeyT&& key, ResponseParametersValueT&& value) {
    m_responseParametersHasBeenSet = true;
    m_responseParameters.emplace(std::forward<ResponseParametersKeyT>(key), std::forward<ResponseParametersValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTemplateSelectionExpression(TemplateSelectionExpressionT&& value) {
    ...
    m_templateSelectionExpression = std::forward<TemplateSelectionExpressionT>(value);
  }
  template <typename TemplateSelectionExpressionT = Aws::String>
  UpdateIntegrationResult& WithTemplateSelectionExpression(TemplateSelectionExpressionT&& value) {
    SetTemplateSelectionExpression(std::forward<TemplateSelectionExpressionT>(value));
    return *this;
  }
  ///@}
  ...
  inline UpdateIntegrationResult& WithTimeoutInMillis(int value) {
