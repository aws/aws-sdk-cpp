...
class PutRoutingRuleRequest : public ApiGatewayV2Request {
 public:
  ...
  template <typename ActionsT = Aws::Vector<RoutingRuleAction>>
  PutRoutingRuleRequest& WithActions(ActionsT&& value) {
    SetActions(std::forward<ActionsT>(value));
    return *this;
  }
  template <typename ActionsT = RoutingRuleAction>
  PutRoutingRuleRequest& AddActions(ActionsT&& value) {
    m_actionsHasBeenSet = true;
  ...
  template <typename ConditionsT = Aws::Vector<RoutingRuleCondition>>
  PutRoutingRuleRequest& WithConditions(ConditionsT&& value) {
    SetConditions(std::forward<ConditionsT>(value));
    return *this;
  }
  template <typename ConditionsT = RoutingRuleCondition>
  PutRoutingRuleRequest& AddConditions(ConditionsT&& value) {
    m_conditionsHasBeenSet = true;
  ...
  template <typename DomainNameT = Aws::String>
  PutRoutingRuleRequest& WithDomainName(DomainNameT&& value) {
  ...
  template <typename DomainNameIdT = Aws::String>
  PutRoutingRuleRequest& WithDomainNameId(DomainNameIdT&& value) {
  ...
  inline PutRoutingRuleRequest& WithPriority(int value) {
    SetPriority(value);
    return *this;
  }
  ///@}
  ...
  template <typename RoutingRuleIdT = Aws::String>
  PutRoutingRuleRequest& WithRoutingRuleId(RoutingRuleIdT&& value) {
