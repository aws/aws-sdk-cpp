...
/**
 */
class DeleteDeploymentRequest : public ApiGatewayV2Request {
 public:
  AWS_APIGATEWAYV2_API DeleteDeploymentRequest() = default;
  ...
  template <typename ApiIdT = Aws::String>
  DeleteDeploymentRequest& WithApiId(ApiIdT&& value) {
  ...
  template <typename DeploymentIdT = Aws::String>
  DeleteDeploymentRequest& WithDeploymentId(DeploymentIdT&& value) {
