...
class RoutingRuleCondition {
 public:
  ...
  void SetMatchBasePaths(MatchBasePathsT&& value) {
    ...
    m_matchBasePaths = std::forward<MatchBasePathsT>(value);
  }
  template <typename MatchBasePathsT = RoutingRuleMatchBasePaths>
  RoutingRuleCondition& WithMatchBasePaths(MatchBasePathsT&& value) {
    SetMatchBasePaths(std::forward<MatchBasePathsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMatchHeaders(MatchHeadersT&& value) {
    ...
    m_matchHeaders = std::forward<MatchHeadersT>(value);
  }
  template <typename MatchHeadersT = RoutingRuleMatchHeaders>
  RoutingRuleCondition& WithMatchHeaders(MatchHeadersT&& value) {
    SetMatchHeaders(std::forward<MatchHeadersT>(value));
    return *this;
  }
  ///@}
 private:
