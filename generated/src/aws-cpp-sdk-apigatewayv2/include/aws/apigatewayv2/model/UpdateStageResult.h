...
class UpdateStageResult {
 public:
  ...
  inline UpdateStageResult& WithApiGatewayManaged(bool value) {
  ...
  inline UpdateStageResult& WithAutoDeploy(bool value) {
    SetAutoDeploy(value);
    return *this;
  }
  ///@}
  ...
  template <typename DefaultRouteSettingsT = RouteSettings>
  UpdateStageResult& WithDefaultRouteSettings(DefaultRouteSettingsT&& value) {
  ...
  template <typename LastDeploymentStatusMessageT = Aws::String>
  UpdateStageResult& WithLastDeploymentStatusMessage(LastDeploymentStatusMessageT&& value) {
  ...
  template <typename RouteSettingsT = Aws::Map<Aws::String, RouteSettings>>
  UpdateStageResult& WithRouteSettings(RouteSettingsT&& value) {
  ...
  template <typename StageVariablesT = Aws::Map<Aws::String, Aws::String>>
  UpdateStageResult& WithStageVariables(StageVariablesT&& value) {
