...
class CreateAuthorizerResult {
 public:
  ...
  void SetAuthorizerCredentialsArn(AuthorizerCredentialsArnT&& value) {
    ...
    m_authorizerCredentialsArn = std::forward<AuthorizerCredentialsArnT>(value);
  }
  template <typename AuthorizerCredentialsArnT = Aws::String>
  CreateAuthorizerResult& WithAuthorizerCredentialsArn(AuthorizerCredentialsArnT&& value) {
    SetAuthorizerCredentialsArn(std::forward<AuthorizerCredentialsArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAuthorizerId(AuthorizerIdT&& value) {
    ...
    m_authorizerId = std::forward<AuthorizerIdT>(value);
  }
  template <typename AuthorizerIdT = Aws::String>
  CreateAuthorizerResult& WithAuthorizerId(AuthorizerIdT&& value) {
    SetAuthorizerId(std::forward<AuthorizerIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAuthorizerPayloadFormatVersion(AuthorizerPayloadFormatVersionT&& value) {
    ...
    m_authorizerPayloadFormatVersion = std::forward<AuthorizerPayloadFormatVersionT>(value);
  }
  template <typename AuthorizerPayloadFormatVersionT = Aws::String>
  CreateAuthorizerResult& WithAuthorizerPayloadFormatVersion(AuthorizerPayloadFormatVersionT&& value) {
    SetAuthorizerPayloadFormatVersion(std::forward<AuthorizerPayloadFormatVersionT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAuthorizerResultTtlInSeconds(int value) {
    m_authorizerResultTtlInSecondsHasBeenSet = true;
    m_authorizerResultTtlInSeconds = value;
  }
  inline CreateAuthorizerResult& WithAuthorizerResultTtlInSeconds(int value) {
    SetAuthorizerResultTtlInSeconds(value);
    return *this;
  }
  ///@}
  ...
  inline CreateAuthorizerResult& WithAuthorizerType(AuthorizerType value) {
  ...
  void SetAuthorizerUri(AuthorizerUriT&& value) {
    ...
    m_authorizerUri = std::forward<AuthorizerUriT>(value);
  }
  template <typename AuthorizerUriT = Aws::String>
  CreateAuthorizerResult& WithAuthorizerUri(AuthorizerUriT&& value) {
    SetAuthorizerUri(std::forward<AuthorizerUriT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetEnableSimpleResponses(bool value) {
    m_enableSimpleResponsesHasBeenSet = true;
    m_enableSimpleResponses = value;
  }
  inline CreateAuthorizerResult& WithEnableSimpleResponses(bool value) {
    SetEnableSimpleResponses(value);
    return *this;
  }
  ///@}
  ...
  CreateAuthorizerResult& AddIdentitySource(IdentitySourceT&& value) {
    m_identitySourceHasBeenSet = true;
    m_identitySource.emplace_back(std::forward<IdentitySourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIdentityValidationExpression(IdentityValidationExpressionT&& value) {
    ...
    m_identityValidationExpression = std::forward<IdentityValidationExpressionT>(value);
  }
  template <typename IdentityValidationExpressionT = Aws::String>
  CreateAuthorizerResult& WithIdentityValidationExpression(IdentityValidationExpressionT&& value) {
    SetIdentityValidationExpression(std::forward<IdentityValidationExpressionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetJwtConfiguration(JwtConfigurationT&& value) {
    ...
    m_jwtConfiguration = std::forward<JwtConfigurationT>(value);
  }
  template <typename JwtConfigurationT = JWTConfiguration>
  CreateAuthorizerResult& WithJwtConfiguration(JwtConfigurationT&& value) {
    SetJwtConfiguration(std::forward<JwtConfigurationT>(value));
    return *this;
  }
  ///@}
