...
namespace Model
{
  ...
  {
  public:
    AWS_APIGATEWAYV2_API CreateAuthorizerResult();
     ...
     * with AWS Lambda authorizers for HTTP APIs</a>.</p>
     */
    inline CreateAuthorizerResult& WithAuthorizerPayloadFormatVersion(const Aws::String& value) { SetAuthorizerPayloadFormatVersion(value); return *this;}
     ...
     * with AWS Lambda authorizers for HTTP APIs</a>.</p>
     */
    inline CreateAuthorizerResult& WithAuthorizerPayloadFormatVersion(Aws::String&& value) { SetAuthorizerPayloadFormatVersion(std::move(value)); return *this;}
     ...
     * with AWS Lambda authorizers for HTTP APIs</a>.</p>
     */
    inline CreateAuthorizerResult& WithAuthorizerPayloadFormatVersion(const char* value) { SetAuthorizerPayloadFormatVersion(value); return *this;}
     ...
     * authorizer type. Supported only for HTTP APIs.</p>
     */
    inline CreateAuthorizerResult& WithJwtConfiguration(const JWTConfiguration& value) { SetJwtConfiguration(value); return *this;}

    /**
     * <p>Represents the configuration of a JWT authorizer. Required for the JWT
     * authorizer type. Supported only for HTTP APIs.</p>
     */
    inline CreateAuthorizerResult& WithJwtConfiguration(JWTConfiguration&& value) { SetJwtConfiguration(std::move(value)); return *this;}
