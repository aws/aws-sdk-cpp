...
namespace Model
{
  ...
  public:
    ...
    template<typename AuthorizerCredentialsArnT = Aws::String>
    CreateAuthorizerResult& WithAuthorizerCredentialsArn(AuthorizerCredentialsArnT&& value) { SetAuthorizerCredentialsArn(std::forward<AuthorizerCredentialsArnT>(value)); return *this;}
    ///@}
    ...
    template<typename AuthorizerIdT = Aws::String>
    CreateAuthorizerResult& WithAuthorizerId(AuthorizerIdT&& value) { SetAuthorizerId(std::forward<AuthorizerIdT>(value)); return *this;}
    ///@}
    ...
    template<typename AuthorizerPayloadFormatVersionT = Aws::String>
    CreateAuthorizerResult& WithAuthorizerPayloadFormatVersion(AuthorizerPayloadFormatVersionT&& value) { SetAuthorizerPayloadFormatVersion(std::forward<AuthorizerPayloadFormatVersionT>(value)); return *this;}
    ///@}
    ...
    inline CreateAuthorizerResult& WithAuthorizerType(AuthorizerType value) { SetAuthorizerType(value); return *this;}
    ///@}
    ...
    inline CreateAuthorizerResult& WithEnableSimpleResponses(bool value) { SetEnableSimpleResponses(value); return *this;}
    ///@}
    ...
    CreateAuthorizerResult& AddIdentitySource(IdentitySourceT&& value) { m_identitySourceHasBeenSet = true; m_identitySource.emplace_back(std::forward<IdentitySourceT>(value)); return *this; }
    ///@}
    ...
    template<typename JwtConfigurationT = JWTConfiguration>
    CreateAuthorizerResult& WithJwtConfiguration(JwtConfigurationT&& value) { SetJwtConfiguration(std::forward<JwtConfigurationT>(value)); return *this;}
    ///@}
