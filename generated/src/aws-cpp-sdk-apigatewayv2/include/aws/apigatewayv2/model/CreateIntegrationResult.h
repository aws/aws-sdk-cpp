...
class CreateIntegrationResult {
 public:
  ...
  inline CreateIntegrationResult& WithApiGatewayManaged(bool value) {
  ...
  inline CreateIntegrationResult& WithConnectionType(ConnectionType value) {
  ...
  inline CreateIntegrationResult& WithContentHandlingStrategy(ContentHandlingStrategy value) {
  ...
  inline CreateIntegrationResult& WithIntegrationType(IntegrationType value) {
  ...
  inline CreateIntegrationResult& WithPassthroughBehavior(PassthroughBehavior value) {
  ...
  inline CreateIntegrationResult& WithTimeoutInMillis(int value) {
