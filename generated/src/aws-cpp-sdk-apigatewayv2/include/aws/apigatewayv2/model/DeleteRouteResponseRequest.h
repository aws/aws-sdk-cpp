...
class DeleteRouteResponseRequest : public ApiGatewayV2Request {
 public:
  ...
  template <typename ApiIdT = Aws::String>
  DeleteRouteResponseRequest& WithApiId(ApiIdT&& value) {
  ...
  template <typename RouteIdT = Aws::String>
  DeleteRouteResponseRequest& WithRouteId(RouteIdT&& value) {
  ...
  template <typename RouteResponseIdT = Aws::String>
  DeleteRouteResponseRequest& WithRouteResponseId(RouteResponseIdT&& value) {
