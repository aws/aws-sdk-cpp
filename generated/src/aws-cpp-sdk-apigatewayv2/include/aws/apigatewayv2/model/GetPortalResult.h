...
class GetPortalResult {
 public:
  AWS_APIGATEWAYV2_API GetPortalResult() = default;
  AWS_APIGATEWAYV2_API GetPortalResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_APIGATEWAYV2_API GetPortalResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename AuthorizationT = Authorization>
  GetPortalResult& WithAuthorization(AuthorizationT&& value) {
  ...
  template <typename EndpointConfigurationT = EndpointConfigurationResponse>
  GetPortalResult& WithEndpointConfiguration(EndpointConfigurationT&& value) {
  ...
  template <typename IncludedPortalProductArnsT = Aws::Vector<Aws::String>>
  GetPortalResult& WithIncludedPortalProductArns(IncludedPortalProductArnsT&& value) {
  ...
  GetPortalResult& AddIncludedPortalProductArns(IncludedPortalProductArnsT&& value) {
    m_includedPortalProductArnsHasBeenSet = true;
  ...
  template <typename LastModifiedT = Aws::Utils::DateTime>
  GetPortalResult& WithLastModified(LastModifiedT&& value) {
  ...
  template <typename LastPublishedT = Aws::Utils::DateTime>
  GetPortalResult& WithLastPublished(LastPublishedT&& value) {
  ...
  template <typename LastPublishedDescriptionT = Aws::String>
  GetPortalResult& WithLastPublishedDescription(LastPublishedDescriptionT&& value) {
  ...
  template <typename PortalArnT = Aws::String>
  GetPortalResult& WithPortalArn(PortalArnT&& value) {
  ...
  template <typename PortalContentT = PortalContent>
  GetPortalResult& WithPortalContent(PortalContentT&& value) {
  ...
  template <typename PortalIdT = Aws::String>
  GetPortalResult& WithPortalId(PortalIdT&& value) {
  ...
  template <typename PreviewT = Preview>
  GetPortalResult& WithPreview(PreviewT&& value) {
  ...
  inline GetPortalResult& WithPublishStatus(PublishStatus value) {
  ...
  template <typename RumAppMonitorNameT = Aws::String>
  GetPortalResult& WithRumAppMonitorName(RumAppMonitorNameT&& value) {
  ...
  template <typename StatusExceptionT = StatusException>
  GetPortalResult& WithStatusException(StatusExceptionT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  GetPortalResult& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsKeyT = Aws::String, typename TagsValueT = Aws::String>
  GetPortalResult& AddTags(TagsKeyT&& key, TagsValueT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetPortalResult& WithRequestId(RequestIdT&& value) {
