...
class Stage {
 public:
  ...
  template <typename AccessLogSettingsT = AccessLogSettings>
  Stage& WithAccessLogSettings(AccessLogSettingsT&& value) {
  ...
  inline Stage& WithApiGatewayManaged(bool value) {
  ...
  inline Stage& WithAutoDeploy(bool value) {
    SetAutoDeploy(value);
    return *this;
  }
  ///@}
  ...
  template <typename ClientCertificateIdT = Aws::String>
  Stage& WithClientCertificateId(ClientCertificateIdT&& value) {
  ...
  template <typename CreatedDateT = Aws::Utils::DateTime>
  Stage& WithCreatedDate(CreatedDateT&& value) {
  ...
  template <typename DefaultRouteSettingsT = RouteSettings>
  Stage& WithDefaultRouteSettings(DefaultRouteSettingsT&& value) {
  ...
  template <typename DeploymentIdT = Aws::String>
  Stage& WithDeploymentId(DeploymentIdT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  Stage& WithDescription(DescriptionT&& value) {
  ...
  void SetLastDeploymentStatusMessage(LastDeploymentStatusMessageT&& value) {
    m_lastDeploymentStatusMessageHasBeenSet = true;
    m_lastDeploymentStatusMessage = std::forward<LastDeploymentStatusMessageT>(value);
  }
  template <typename LastDeploymentStatusMessageT = Aws::String>
  Stage& WithLastDeploymentStatusMessage(LastDeploymentStatusMessageT&& value) {
    SetLastDeploymentStatusMessage(std::forward<LastDeploymentStatusMessageT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename LastUpdatedDateT = Aws::Utils::DateTime>
  Stage& WithLastUpdatedDate(LastUpdatedDateT&& value) {
  ...
  template <typename RouteSettingsT = Aws::Map<Aws::String, RouteSettings>>
  Stage& WithRouteSettings(RouteSettingsT&& value) {
  ...
  template <typename StageNameT = Aws::String>
  Stage& WithStageName(StageNameT&& value) {
  ...
  template <typename StageVariablesT = Aws::Map<Aws::String, Aws::String>>
  Stage& WithStageVariables(StageVariablesT&& value) {
