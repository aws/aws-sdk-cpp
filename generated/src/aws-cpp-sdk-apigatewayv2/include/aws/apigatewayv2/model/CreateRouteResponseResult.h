...
namespace Model
{
  ...
  {
  public:
    AWS_APIGATEWAYV2_API CreateRouteResponseResult() = default;
    ...
    template<typename ModelSelectionExpressionT = Aws::String>
    CreateRouteResponseResult& WithModelSelectionExpression(ModelSelectionExpressionT&& value) { SetModelSelectionExpression(std::forward<ModelSelectionExpressionT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseModelsT = Aws::Map<Aws::String, Aws::String>>
    CreateRouteResponseResult& WithResponseModels(ResponseModelsT&& value) { SetResponseModels(std::forward<ResponseModelsT>(value)); return *this;}
    template<typename ResponseModelsKeyT = Aws::String, typename ResponseModelsValueT = Aws::String>
    CreateRouteResponseResult& AddResponseModels(ResponseModelsKeyT&& key, ResponseModelsValueT&& value) {
    ...
    template<typename ResponseParametersT = Aws::Map<Aws::String, ParameterConstraints>>
    CreateRouteResponseResult& WithResponseParameters(ResponseParametersT&& value) { SetResponseParameters(std::forward<ResponseParametersT>(value)); return *this;}
    template<typename ResponseParametersKeyT = Aws::String, typename ResponseParametersValueT = ParameterConstraints>
    CreateRouteResponseResult& AddResponseParameters(ResponseParametersKeyT&& key, ResponseParametersValueT&& value) {
    ...
    template<typename RouteResponseIdT = Aws::String>
    CreateRouteResponseResult& WithRouteResponseId(RouteResponseIdT&& value) { SetRouteResponseId(std::forward<RouteResponseIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RouteResponseKeyT = Aws::String>
    CreateRouteResponseResult& WithRouteResponseKey(RouteResponseKeyT&& value) { SetRouteResponseKey(std::forward<RouteResponseKeyT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateRouteResponseResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
