...
class CreateRouteResponseResult {
 public:
  ...
  template <typename ModelSelectionExpressionT = Aws::String>
  CreateRouteResponseResult& WithModelSelectionExpression(ModelSelectionExpressionT&& value) {
  ...
  template <typename ResponseModelsT = Aws::Map<Aws::String, Aws::String>>
  CreateRouteResponseResult& WithResponseModels(ResponseModelsT&& value) {
  ...
  template <typename ResponseParametersT = Aws::Map<Aws::String, ParameterConstraints>>
  CreateRouteResponseResult& WithResponseParameters(ResponseParametersT&& value) {
  ...
  template <typename RouteResponseIdT = Aws::String>
  CreateRouteResponseResult& WithRouteResponseId(RouteResponseIdT&& value) {
  ...
  template <typename RouteResponseKeyT = Aws::String>
  CreateRouteResponseResult& WithRouteResponseKey(RouteResponseKeyT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateRouteResponseResult& WithRequestId(RequestIdT&& value) {
