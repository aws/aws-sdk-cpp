...
class GetApiMappingsResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<ApiMapping>>
  GetApiMappingsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = ApiMapping>
  GetApiMappingsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetApiMappingsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetApiMappingsResult& WithRequestId(RequestIdT&& value) {
