...
namespace Model
{
  ...
  {
  public:
    AWS_APIGATEWAYV2_API CreateStageRequest() = default;
    ...
    template<typename AccessLogSettingsT = AccessLogSettings>
    CreateStageRequest& WithAccessLogSettings(AccessLogSettingsT&& value) { SetAccessLogSettings(std::forward<AccessLogSettingsT>(value)); return *this;}
    ///@}
    ...
    template<typename ApiIdT = Aws::String>
    CreateStageRequest& WithApiId(ApiIdT&& value) { SetApiId(std::forward<ApiIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ClientCertificateIdT = Aws::String>
    CreateStageRequest& WithClientCertificateId(ClientCertificateIdT&& value) { SetClientCertificateId(std::forward<ClientCertificateIdT>(value)); return *this;}
    ///@}
    ...
    template<typename DefaultRouteSettingsT = RouteSettings>
    CreateStageRequest& WithDefaultRouteSettings(DefaultRouteSettingsT&& value) { SetDefaultRouteSettings(std::forward<DefaultRouteSettingsT>(value)); return *this;}
    ///@}
    ...
    template<typename RouteSettingsT = Aws::Map<Aws::String, RouteSettings>>
    CreateStageRequest& WithRouteSettings(RouteSettingsT&& value) { SetRouteSettings(std::forward<RouteSettingsT>(value)); return *this;}
    template<typename RouteSettingsKeyT = Aws::String, typename RouteSettingsValueT = RouteSettings>
    CreateStageRequest& AddRouteSettings(RouteSettingsKeyT&& key, RouteSettingsValueT&& value) {
    ...
    template<typename StageVariablesT = Aws::Map<Aws::String, Aws::String>>
    CreateStageRequest& WithStageVariables(StageVariablesT&& value) { SetStageVariables(std::forward<StageVariablesT>(value)); return *this;}
    template<typename StageVariablesKeyT = Aws::String, typename StageVariablesValueT = Aws::String>
    CreateStageRequest& AddStageVariables(StageVariablesKeyT&& key, StageVariablesValueT&& value) {
