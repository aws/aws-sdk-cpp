...
class GetRoutesResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<Route>>
  GetRoutesResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = Route>
  GetRoutesResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetRoutesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetRoutesResult& WithRequestId(RequestIdT&& value) {
