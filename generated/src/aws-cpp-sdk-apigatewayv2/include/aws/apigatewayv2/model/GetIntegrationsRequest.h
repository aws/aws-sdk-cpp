...
class GetIntegrationsRequest : public ApiGatewayV2Request {
 public:
  ...
  template <typename ApiIdT = Aws::String>
  GetIntegrationsRequest& WithApiId(ApiIdT&& value) {
  ...
  template <typename MaxResultsT = Aws::String>
  GetIntegrationsRequest& WithMaxResults(MaxResultsT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  GetIntegrationsRequest& WithNextToken(NextTokenT&& value) {
