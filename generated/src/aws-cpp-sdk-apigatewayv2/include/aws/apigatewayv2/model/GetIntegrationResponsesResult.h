...
class GetIntegrationResponsesResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<IntegrationResponse>>
  GetIntegrationResponsesResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = IntegrationResponse>
  GetIntegrationResponsesResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetIntegrationResponsesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetIntegrationResponsesResult& WithRequestId(RequestIdT&& value) {
