...
class CreateStageResult {
 public:
  ...
  template <typename AccessLogSettingsT = AccessLogSettings>
  CreateStageResult& WithAccessLogSettings(AccessLogSettingsT&& value) {
  ...
  inline CreateStageResult& WithApiGatewayManaged(bool value) {
  ...
  inline CreateStageResult& WithAutoDeploy(bool value) {
    SetAutoDeploy(value);
    return *this;
  }
  ///@}
  ...
  template <typename ClientCertificateIdT = Aws::String>
  CreateStageResult& WithClientCertificateId(ClientCertificateIdT&& value) {
  ...
  template <typename CreatedDateT = Aws::Utils::DateTime>
  CreateStageResult& WithCreatedDate(CreatedDateT&& value) {
  ...
  template <typename DefaultRouteSettingsT = RouteSettings>
  CreateStageResult& WithDefaultRouteSettings(DefaultRouteSettingsT&& value) {
  ...
  template <typename DeploymentIdT = Aws::String>
  CreateStageResult& WithDeploymentId(DeploymentIdT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateStageResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename LastDeploymentStatusMessageT = Aws::String>
  CreateStageResult& WithLastDeploymentStatusMessage(LastDeploymentStatusMessageT&& value) {
  ...
  template <typename LastUpdatedDateT = Aws::Utils::DateTime>
  CreateStageResult& WithLastUpdatedDate(LastUpdatedDateT&& value) {
  ...
  template <typename RouteSettingsT = Aws::Map<Aws::String, RouteSettings>>
  CreateStageResult& WithRouteSettings(RouteSettingsT&& value) {
  ...
  template <typename StageNameT = Aws::String>
  CreateStageResult& WithStageName(StageNameT&& value) {
  ...
  template <typename StageVariablesT = Aws::Map<Aws::String, Aws::String>>
  CreateStageResult& WithStageVariables(StageVariablesT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateStageResult& WithTags(TagsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateStageResult& WithRequestId(RequestIdT&& value) {
