...
namespace Model
{
  ...
  public:
    ...
    template<typename ApiIdT = Aws::String>
    UpdateModelRequest& WithApiId(ApiIdT&& value) { SetApiId(std::forward<ApiIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ContentTypeT = Aws::String>
    UpdateModelRequest& WithContentType(ContentTypeT&& value) { SetContentType(std::forward<ContentTypeT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    UpdateModelRequest& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename SchemaT = Aws::String>
    UpdateModelRequest& WithSchema(SchemaT&& value) { SetSchema(std::forward<SchemaT>(value)); return *this;}
    ///@}
  private:
