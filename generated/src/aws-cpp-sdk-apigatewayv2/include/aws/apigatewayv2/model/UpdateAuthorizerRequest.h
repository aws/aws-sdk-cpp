...
namespace Model
{
  ...
  public:
    ...
    template<typename ApiIdT = Aws::String>
    UpdateAuthorizerRequest& WithApiId(ApiIdT&& value) { SetApiId(std::forward<ApiIdT>(value)); return *this;}
    ///@}
    ...
    template<typename AuthorizerCredentialsArnT = Aws::String>
    UpdateAuthorizerRequest& WithAuthorizerCredentialsArn(AuthorizerCredentialsArnT&& value) { SetAuthorizerCredentialsArn(std::forward<AuthorizerCredentialsArnT>(value)); return *this;}
    ///@}
    ...
    template<typename AuthorizerIdT = Aws::String>
    UpdateAuthorizerRequest& WithAuthorizerId(AuthorizerIdT&& value) { SetAuthorizerId(std::forward<AuthorizerIdT>(value)); return *this;}
    ///@}
    ...
    template<typename AuthorizerPayloadFormatVersionT = Aws::String>
    UpdateAuthorizerRequest& WithAuthorizerPayloadFormatVersion(AuthorizerPayloadFormatVersionT&& value) { SetAuthorizerPayloadFormatVersion(std::forward<AuthorizerPayloadFormatVersionT>(value)); return *this;}
    ///@}
    ...
    inline UpdateAuthorizerRequest& WithAuthorizerType(AuthorizerType value) { SetAuthorizerType(value); return *this;}
    ///@}
    ...
    template<typename AuthorizerUriT = Aws::String>
    UpdateAuthorizerRequest& WithAuthorizerUri(AuthorizerUriT&& value) { SetAuthorizerUri(std::forward<AuthorizerUriT>(value)); return *this;}
    ///@}
    ...
    template<typename IdentitySourceT = Aws::Vector<Aws::String>>
    UpdateAuthorizerRequest& WithIdentitySource(IdentitySourceT&& value) { SetIdentitySource(std::forward<IdentitySourceT>(value)); return *this;}
    template<typename IdentitySourceT = Aws::String>
    UpdateAuthorizerRequest& AddIdentitySource(IdentitySourceT&& value) { m_identitySourceHasBeenSet = true; m_identitySource.emplace_back(std::forward<IdentitySourceT>(value)); return *this; }
    ///@}
    ...
    template<typename IdentityValidationExpressionT = Aws::String>
    UpdateAuthorizerRequest& WithIdentityValidationExpression(IdentityValidationExpressionT&& value) { SetIdentityValidationExpression(std::forward<IdentityValidationExpressionT>(value)); return *this;}
    ///@}
    ...
    template<typename JwtConfigurationT = JWTConfiguration>
    UpdateAuthorizerRequest& WithJwtConfiguration(JwtConfigurationT&& value) { SetJwtConfiguration(std::forward<JwtConfigurationT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    UpdateAuthorizerRequest& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
  private:
