...
class UpdateAuthorizerRequest : public ApiGatewayV2Request {
 public:
  ...
  inline UpdateAuthorizerRequest& WithAuthorizerResultTtlInSeconds(int value) {
  ...
  inline UpdateAuthorizerRequest& WithAuthorizerType(AuthorizerType value) {
  ...
  inline UpdateAuthorizerRequest& WithEnableSimpleResponses(bool value) {
