...
namespace Model
{
  ...
  {
  public:
    AWS_APIGATEWAYV2_API GetDomainNamesRequest() = default;
    ...
    template<typename MaxResultsT = Aws::String>
    GetDomainNamesRequest& WithMaxResults(MaxResultsT&& value) { SetMaxResults(std::forward<MaxResultsT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    GetDomainNamesRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
