...
class UpdateRouteResponseRequest : public ApiGatewayV2Request {
 public:
  ...
  template <typename ApiIdT = Aws::String>
  UpdateRouteResponseRequest& WithApiId(ApiIdT&& value) {
  ...
  template <typename ModelSelectionExpressionT = Aws::String>
  UpdateRouteResponseRequest& WithModelSelectionExpression(ModelSelectionExpressionT&& value) {
  ...
  template <typename ResponseModelsT = Aws::Map<Aws::String, Aws::String>>
  UpdateRouteResponseRequest& WithResponseModels(ResponseModelsT&& value) {
  ...
  template <typename ResponseParametersT = Aws::Map<Aws::String, ParameterConstraints>>
  UpdateRouteResponseRequest& WithResponseParameters(ResponseParametersT&& value) {
  ...
  template <typename RouteIdT = Aws::String>
  UpdateRouteResponseRequest& WithRouteId(RouteIdT&& value) {
  ...
  template <typename RouteResponseIdT = Aws::String>
  UpdateRouteResponseRequest& WithRouteResponseId(RouteResponseIdT&& value) {
  ...
  template <typename RouteResponseKeyT = Aws::String>
  UpdateRouteResponseRequest& WithRouteResponseKey(RouteResponseKeyT&& value) {
