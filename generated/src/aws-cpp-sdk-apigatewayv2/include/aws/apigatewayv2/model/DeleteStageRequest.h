...
namespace Model
{
  ...
  /**
   */
  class DeleteStageRequest : public ApiGatewayV2Request
  {
  public:
    AWS_APIGATEWAYV2_API DeleteStageRequest() = default;
    ...
    template<typename ApiIdT = Aws::String>
    DeleteStageRequest& WithApiId(ApiIdT&& value) { SetApiId(std::forward<ApiIdT>(value)); return *this;}
    ///@}
    ...
    template<typename StageNameT = Aws::String>
    DeleteStageRequest& WithStageName(StageNameT&& value) { SetStageName(std::forward<StageNameT>(value)); return *this;}
    ///@}
  private:
