...
namespace Model
{
  ...
  public:
    ...
    template<typename ModelSelectionExpressionT = Aws::String>
    GetRouteResponseResult& WithModelSelectionExpression(ModelSelectionExpressionT&& value) { SetModelSelectionExpression(std::forward<ModelSelectionExpressionT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseModelsT = Aws::Map<Aws::String, Aws::String>>
    GetRouteResponseResult& WithResponseModels(ResponseModelsT&& value) { SetResponseModels(std::forward<ResponseModelsT>(value)); return *this;}
    ...
    template<typename ResponseParametersT = Aws::Map<Aws::String, ParameterConstraints>>
    GetRouteResponseResult& WithResponseParameters(ResponseParametersT&& value) { SetResponseParameters(std::forward<ResponseParametersT>(value)); return *this;}
    ...
    template<typename RouteResponseIdT = Aws::String>
    GetRouteResponseResult& WithRouteResponseId(RouteResponseIdT&& value) { SetRouteResponseId(std::forward<RouteResponseIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RouteResponseKeyT = Aws::String>
    GetRouteResponseResult& WithRouteResponseKey(RouteResponseKeyT&& value) { SetRouteResponseKey(std::forward<RouteResponseKeyT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    GetRouteResponseResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
