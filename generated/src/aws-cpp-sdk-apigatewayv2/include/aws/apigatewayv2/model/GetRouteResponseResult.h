...
namespace Model
{
  ...
  {
  public:
    AWS_APIGATEWAYV2_API GetRouteResponseResult();
    ...
    inline GetRouteResponseResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline GetRouteResponseResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline GetRouteResponseResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
