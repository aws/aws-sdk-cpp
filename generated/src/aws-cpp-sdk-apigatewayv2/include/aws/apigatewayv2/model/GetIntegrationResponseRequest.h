...
class GetIntegrationResponseRequest : public ApiGatewayV2Request {
 public:
  ...
  template <typename ApiIdT = Aws::String>
  GetIntegrationResponseRequest& WithApiId(ApiIdT&& value) {
  ...
  template <typename IntegrationIdT = Aws::String>
  GetIntegrationResponseRequest& WithIntegrationId(IntegrationIdT&& value) {
  ...
  template <typename IntegrationResponseIdT = Aws::String>
  GetIntegrationResponseRequest& WithIntegrationResponseId(IntegrationResponseIdT&& value) {
