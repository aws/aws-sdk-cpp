...
class TlsConfig {
 public:
  ...
  void SetServerNameToVerify(ServerNameToVerifyT&& value) {
    ...
    m_serverNameToVerify = std::forward<ServerNameToVerifyT>(value);
  }
  template <typename ServerNameToVerifyT = Aws::String>
  TlsConfig& WithServerNameToVerify(ServerNameToVerifyT&& value) {
    SetServerNameToVerify(std::forward<ServerNameToVerifyT>(value));
    return *this;
  }
  ///@}
 private:
