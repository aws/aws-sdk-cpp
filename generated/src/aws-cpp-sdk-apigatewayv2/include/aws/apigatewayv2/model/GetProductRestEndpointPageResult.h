...
namespace Model {
class GetProductRestEndpointPageResult {
 public:
  AWS_APIGATEWAYV2_API GetProductRestEndpointPageResult() = default;
  AWS_APIGATEWAYV2_API GetProductRestEndpointPageResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_APIGATEWAYV2_API GetProductRestEndpointPageResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename DisplayContentT = EndpointDisplayContentResponse>
  GetProductRestEndpointPageResult& WithDisplayContent(DisplayContentT&& value) {
  ...
  template <typename LastModifiedT = Aws::Utils::DateTime>
  GetProductRestEndpointPageResult& WithLastModified(LastModifiedT&& value) {
  ...
  template <typename ProductRestEndpointPageArnT = Aws::String>
  GetProductRestEndpointPageResult& WithProductRestEndpointPageArn(ProductRestEndpointPageArnT&& value) {
  ...
  template <typename ProductRestEndpointPageIdT = Aws::String>
  GetProductRestEndpointPageResult& WithProductRestEndpointPageId(ProductRestEndpointPageIdT&& value) {
   ...
   */
  inline const Aws::String& GetRawDisplayContent() const { return m_rawDisplayContent; }
  template <typename RawDisplayContentT = Aws::String>
  void SetRawDisplayContent(RawDisplayContentT&& value) {
    m_rawDisplayContentHasBeenSet = true;
    m_rawDisplayContent = std::forward<RawDisplayContentT>(value);
  }
  template <typename RawDisplayContentT = Aws::String>
  GetProductRestEndpointPageResult& WithRawDisplayContent(RawDisplayContentT&& value) {
    SetRawDisplayContent(std::forward<RawDisplayContentT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RestEndpointIdentifierT = RestEndpointIdentifier>
  GetProductRestEndpointPageResult& WithRestEndpointIdentifier(RestEndpointIdentifierT&& value) {
  ...
  inline GetProductRestEndpointPageResult& WithStatus(Status value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusExceptionT = StatusException>
  GetProductRestEndpointPageResult& WithStatusException(StatusExceptionT&& value) {
  ...
  inline GetProductRestEndpointPageResult& WithTryItState(TryItState value) {
    SetTryItState(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetProductRestEndpointPageResult& WithRequestId(RequestIdT&& value) {
 ...
 private:
  ...
  Aws::String m_rawDisplayContent;
  ...
  bool m_rawDisplayContentHasBeenSet = false;
