...
class GetIntegrationsResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<Integration>>
  GetIntegrationsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = Integration>
  GetIntegrationsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetIntegrationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetIntegrationsResult& WithRequestId(RequestIdT&& value) {
