...
namespace Model
{
  ...
  {
  public:
    AWS_APIGATEWAYV2_API GetIntegrationsResult() = default;
    ...
    template<typename ItemsT = Aws::Vector<Integration>>
    GetIntegrationsResult& WithItems(ItemsT&& value) { SetItems(std::forward<ItemsT>(value)); return *this;}
    template<typename ItemsT = Integration>
    GetIntegrationsResult& AddItems(ItemsT&& value) { m_itemsHasBeenSet = true; m_items.emplace_back(std::forward<ItemsT>(value)); return *this; }
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    GetIntegrationsResult& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    GetIntegrationsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
