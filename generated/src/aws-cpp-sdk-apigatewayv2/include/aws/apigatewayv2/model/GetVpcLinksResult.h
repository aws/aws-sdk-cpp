...
class GetVpcLinksResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<VpcLink>>
  GetVpcLinksResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = VpcLink>
  GetVpcLinksResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetVpcLinksResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetVpcLinksResult& WithRequestId(RequestIdT&& value) {
