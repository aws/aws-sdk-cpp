...
class CreateApiResult {
 public:
  ...
  void SetApiEndpoint(ApiEndpointT&& value) {
    ...
    m_apiEndpoint = std::forward<ApiEndpointT>(value);
  }
  template <typename ApiEndpointT = Aws::String>
  CreateApiResult& WithApiEndpoint(ApiEndpointT&& value) {
    SetApiEndpoint(std::forward<ApiEndpointT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateApiResult& WithApiGatewayManaged(bool value) {
  ...
  template <typename ApiIdT = Aws::String>
  CreateApiResult& WithApiId(ApiIdT&& value) {
  ...
  template <typename ApiKeySelectionExpressionT = Aws::String>
  CreateApiResult& WithApiKeySelectionExpression(ApiKeySelectionExpressionT&& value) {
  ...
  template <typename CorsConfigurationT = Cors>
  CreateApiResult& WithCorsConfiguration(CorsConfigurationT&& value) {
  ...
  template <typename CreatedDateT = Aws::Utils::DateTime>
  CreateApiResult& WithCreatedDate(CreatedDateT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateApiResult& WithDescription(DescriptionT&& value) {
  ...
  inline CreateApiResult& WithDisableSchemaValidation(bool value) {
  ...
  inline CreateApiResult& WithDisableExecuteApiEndpoint(bool value) {
  ...
  void SetImportInfo(ImportInfoT&& value) {
    ...
    m_importInfo = std::forward<ImportInfoT>(value);
  }
  template <typename ImportInfoT = Aws::Vector<Aws::String>>
  CreateApiResult& WithImportInfo(ImportInfoT&& value) {
    SetImportInfo(std::forward<ImportInfoT>(value));
    return *this;
  }
  template <typename ImportInfoT = Aws::String>
  CreateApiResult& AddImportInfo(ImportInfoT&& value) {
    m_importInfoHasBeenSet = true;
    m_importInfo.emplace_back(std::forward<ImportInfoT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateApiResult& WithIpAddressType(IpAddressType value) {
  ...
  template <typename NameT = Aws::String>
  CreateApiResult& WithName(NameT&& value) {
  ...
  inline CreateApiResult& WithProtocolType(ProtocolType value) {
  ...
  template <typename RouteSelectionExpressionT = Aws::String>
  CreateApiResult& WithRouteSelectionExpression(RouteSelectionExpressionT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateApiResult& WithTags(TagsT&& value) {
  ...
  template <typename VersionT = Aws::String>
  CreateApiResult& WithVersion(VersionT&& value) {
  ...
  template <typename WarningsT = Aws::Vector<Aws::String>>
  CreateApiResult& WithWarnings(WarningsT&& value) {
    SetWarnings(std::forward<WarningsT>(value));
    return *this;
  }
  template <typename WarningsT = Aws::String>
  CreateApiResult& AddWarnings(WarningsT&& value) {
    m_warningsHasBeenSet = true;
