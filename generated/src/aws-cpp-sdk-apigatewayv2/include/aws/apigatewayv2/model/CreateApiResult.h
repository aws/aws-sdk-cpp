...
namespace Model
{
  ...
  public:
     ...
     * <p>A CORS configuration. Supported only for HTTP APIs.</p>
     */
    inline CreateApiResult& WithCorsConfiguration(const Cors& value) { SetCorsConfiguration(value); return *this;}

    /**
     * <p>A CORS configuration. Supported only for HTTP APIs.</p>
     */
    inline CreateApiResult& WithCorsConfiguration(Cors&& value) { SetCorsConfiguration(std::move(value)); return *this;}
     ...
     * only for HTTP APIs.</p>
     */
    inline CreateApiResult& WithImportInfo(const Aws::Vector<Aws::String>& value) { SetImportInfo(value); return *this;}
     ...
     * only for HTTP APIs.</p>
     */
    inline CreateApiResult& WithImportInfo(Aws::Vector<Aws::String>&& value) { SetImportInfo(std::move(value)); return *this;}
     ...
     * only for HTTP APIs.</p>
     */
    inline CreateApiResult& AddImportInfo(const Aws::String& value) { m_importInfo.push_back(value); return *this; }
     ...
     * only for HTTP APIs.</p>
     */
    inline CreateApiResult& AddImportInfo(Aws::String&& value) { m_importInfo.push_back(std::move(value)); return *this; }
     ...
     * only for HTTP APIs.</p>
     */
    inline CreateApiResult& AddImportInfo(const char* value) { m_importInfo.push_back(value); return *this; }
