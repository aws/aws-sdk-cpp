...
namespace Model
{
  ...
  {
  public:
    AWS_APIGATEWAYV2_API UpdateIntegrationResponseResult() = default;
    AWS_APIGATEWAYV2_API UpdateIntegrationResponseResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_APIGATEWAYV2_API UpdateIntegrationResponseResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ...
    inline UpdateIntegrationResponseResult& WithContentHandlingStrategy(ContentHandlingStrategy value) { SetContentHandlingStrategy(value); return *this;}
    ///@}
    ...
    template<typename IntegrationResponseIdT = Aws::String>
    UpdateIntegrationResponseResult& WithIntegrationResponseId(IntegrationResponseIdT&& value) { SetIntegrationResponseId(std::forward<IntegrationResponseIdT>(value)); return *this;}
    ///@}
    ...
    template<typename IntegrationResponseKeyT = Aws::String>
    UpdateIntegrationResponseResult& WithIntegrationResponseKey(IntegrationResponseKeyT&& value) { SetIntegrationResponseKey(std::forward<IntegrationResponseKeyT>(value)); return *this;}
    ///@}
    ...
    template<typename TemplateSelectionExpressionT = Aws::String>
    UpdateIntegrationResponseResult& WithTemplateSelectionExpression(TemplateSelectionExpressionT&& value) { SetTemplateSelectionExpression(std::forward<TemplateSelectionExpressionT>(value)); return *this;}
    ///@}
