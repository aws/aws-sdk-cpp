...
class UpdateIntegrationResponseResult {
 public:
  ...
  inline UpdateIntegrationResponseResult& WithContentHandlingStrategy(ContentHandlingStrategy value) {
  ...
  template <typename IntegrationResponseIdT = Aws::String>
  UpdateIntegrationResponseResult& WithIntegrationResponseId(IntegrationResponseIdT&& value) {
  ...
  template <typename IntegrationResponseKeyT = Aws::String>
  UpdateIntegrationResponseResult& WithIntegrationResponseKey(IntegrationResponseKeyT&& value) {
  ...
  template <typename TemplateSelectionExpressionT = Aws::String>
  UpdateIntegrationResponseResult& WithTemplateSelectionExpression(TemplateSelectionExpressionT&& value) {
