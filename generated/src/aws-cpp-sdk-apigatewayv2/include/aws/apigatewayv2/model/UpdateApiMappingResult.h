...
namespace Model
{
  ...
  {
  public:
    AWS_APIGATEWAYV2_API UpdateApiMappingResult();
    ...
    inline UpdateApiMappingResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateApiMappingResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateApiMappingResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
