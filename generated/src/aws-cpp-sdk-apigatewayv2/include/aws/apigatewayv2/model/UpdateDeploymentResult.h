...
namespace Model
{
  ...
  {
  public:
    AWS_APIGATEWAYV2_API UpdateDeploymentResult() = default;
    ...
    template<typename DeploymentIdT = Aws::String>
    UpdateDeploymentResult& WithDeploymentId(DeploymentIdT&& value) { SetDeploymentId(std::forward<DeploymentIdT>(value)); return *this;}
    ///@}
    ...
    inline UpdateDeploymentResult& WithDeploymentStatus(DeploymentStatus value) { SetDeploymentStatus(value); return *this;}
    ///@}
    ...
    template<typename DeploymentStatusMessageT = Aws::String>
    UpdateDeploymentResult& WithDeploymentStatusMessage(DeploymentStatusMessageT&& value) { SetDeploymentStatusMessage(std::forward<DeploymentStatusMessageT>(value)); return *this;}
    ///@}
