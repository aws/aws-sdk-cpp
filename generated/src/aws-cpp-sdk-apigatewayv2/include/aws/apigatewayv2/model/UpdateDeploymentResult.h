...
class UpdateDeploymentResult {
 public:
  ...
  inline UpdateDeploymentResult& WithAutoDeployed(bool value) {
  ...
  template <typename CreatedDateT = Aws::Utils::DateTime>
  UpdateDeploymentResult& WithCreatedDate(CreatedDateT&& value) {
  ...
  inline UpdateDeploymentResult& WithDeploymentStatus(DeploymentStatus value) {
  ...
  template <typename DeploymentStatusMessageT = Aws::String>
  UpdateDeploymentResult& WithDeploymentStatusMessage(DeploymentStatusMessageT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateDeploymentResult& WithDescription(DescriptionT&& value) {
