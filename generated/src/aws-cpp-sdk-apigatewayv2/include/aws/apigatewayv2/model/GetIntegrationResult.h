...
namespace Model
{
  ...
  {
  public:
    AWS_APIGATEWAYV2_API GetIntegrationResult() = default;
    ...
    inline GetIntegrationResult& WithContentHandlingStrategy(ContentHandlingStrategy value) { SetContentHandlingStrategy(value); return *this;}
    ///@}
    ...
    template<typename CredentialsArnT = Aws::String>
    GetIntegrationResult& WithCredentialsArn(CredentialsArnT&& value) { SetCredentialsArn(std::forward<CredentialsArnT>(value)); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    GetIntegrationResult& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename IntegrationIdT = Aws::String>
    GetIntegrationResult& WithIntegrationId(IntegrationIdT&& value) { SetIntegrationId(std::forward<IntegrationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename IntegrationMethodT = Aws::String>
    GetIntegrationResult& WithIntegrationMethod(IntegrationMethodT&& value) { SetIntegrationMethod(std::forward<IntegrationMethodT>(value)); return *this;}
    ///@}
    ...
    template<typename IntegrationResponseSelectionExpressionT = Aws::String>
    GetIntegrationResult& WithIntegrationResponseSelectionExpression(IntegrationResponseSelectionExpressionT&& value) { SetIntegrationResponseSelectionExpression(std::forward<IntegrationResponseSelectionExpressionT>(value)); return *this;}
    ///@}
    ...
    template<typename IntegrationSubtypeT = Aws::String>
    GetIntegrationResult& WithIntegrationSubtype(IntegrationSubtypeT&& value) { SetIntegrationSubtype(std::forward<IntegrationSubtypeT>(value)); return *this;}
    ///@}
    ...
    template<typename IntegrationUriT = Aws::String>
    GetIntegrationResult& WithIntegrationUri(IntegrationUriT&& value) { SetIntegrationUri(std::forward<IntegrationUriT>(value)); return *this;}
    ///@}
    ...
    inline GetIntegrationResult& WithPassthroughBehavior(PassthroughBehavior value) { SetPassthroughBehavior(value); return *this;}
    ///@}
    ...
    template<typename PayloadFormatVersionT = Aws::String>
    GetIntegrationResult& WithPayloadFormatVersion(PayloadFormatVersionT&& value) { SetPayloadFormatVersion(std::forward<PayloadFormatVersionT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseParametersT = Aws::Map<Aws::String, Aws::Map<Aws::String, Aws::String>>>
    GetIntegrationResult& WithResponseParameters(ResponseParametersT&& value) { SetResponseParameters(std::forward<ResponseParametersT>(value)); return *this;}
    template<typename ResponseParametersKeyT = Aws::String, typename ResponseParametersValueT = Aws::Map<Aws::String, Aws::String>>
    GetIntegrationResult& AddResponseParameters(ResponseParametersKeyT&& key, ResponseParametersValueT&& value) {
    ...
    template<typename TemplateSelectionExpressionT = Aws::String>
    GetIntegrationResult& WithTemplateSelectionExpression(TemplateSelectionExpressionT&& value) { SetTemplateSelectionExpression(std::forward<TemplateSelectionExpressionT>(value)); return *this;}
    ///@}
