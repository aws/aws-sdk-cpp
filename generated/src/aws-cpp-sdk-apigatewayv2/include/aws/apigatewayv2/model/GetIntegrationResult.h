...
class GetIntegrationResult {
 public:
  ...
  inline GetIntegrationResult& WithApiGatewayManaged(bool value) {
  ...
  inline GetIntegrationResult& WithContentHandlingStrategy(ContentHandlingStrategy value) {
  ...
  template <typename CredentialsArnT = Aws::String>
  GetIntegrationResult& WithCredentialsArn(CredentialsArnT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  GetIntegrationResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename IntegrationMethodT = Aws::String>
  GetIntegrationResult& WithIntegrationMethod(IntegrationMethodT&& value) {
  ...
  template <typename IntegrationResponseSelectionExpressionT = Aws::String>
  GetIntegrationResult& WithIntegrationResponseSelectionExpression(IntegrationResponseSelectionExpressionT&& value) {
  ...
  template <typename IntegrationSubtypeT = Aws::String>
  GetIntegrationResult& WithIntegrationSubtype(IntegrationSubtypeT&& value) {
  ...
  template <typename IntegrationUriT = Aws::String>
  GetIntegrationResult& WithIntegrationUri(IntegrationUriT&& value) {
  ...
  inline GetIntegrationResult& WithPassthroughBehavior(PassthroughBehavior value) {
  ...
  template <typename PayloadFormatVersionT = Aws::String>
  GetIntegrationResult& WithPayloadFormatVersion(PayloadFormatVersionT&& value) {
  ...
  template <typename ResponseParametersT = Aws::Map<Aws::String, Aws::Map<Aws::String, Aws::String>>>
  GetIntegrationResult& WithResponseParameters(ResponseParametersT&& value) {
  ...
  template <typename TemplateSelectionExpressionT = Aws::String>
  GetIntegrationResult& WithTemplateSelectionExpression(TemplateSelectionExpressionT&& value) {
