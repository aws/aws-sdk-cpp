...
class CreateIntegrationRequest : public ApiGatewayV2Request {
 public:
  ...
  inline CreateIntegrationRequest& WithConnectionType(ConnectionType value) {
  ...
  inline CreateIntegrationRequest& WithContentHandlingStrategy(ContentHandlingStrategy value) {
  ...
  inline CreateIntegrationRequest& WithPassthroughBehavior(PassthroughBehavior value) {
  ...
  inline CreateIntegrationRequest& WithTimeoutInMillis(int value) {
