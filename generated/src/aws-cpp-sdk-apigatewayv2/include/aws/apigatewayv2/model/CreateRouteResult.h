...
class CreateRouteResult {
 public:
  ...
  inline CreateRouteResult& WithApiGatewayManaged(bool value) {
  ...
  inline CreateRouteResult& WithApiKeyRequired(bool value) {
  ...
  template <typename AuthorizationScopesT = Aws::Vector<Aws::String>>
  CreateRouteResult& WithAuthorizationScopes(AuthorizationScopesT&& value) {
    SetAuthorizationScopes(std::forward<AuthorizationScopesT>(value));
    return *this;
  }
  template <typename AuthorizationScopesT = Aws::String>
  CreateRouteResult& AddAuthorizationScopes(AuthorizationScopesT&& value) {
    m_authorizationScopesHasBeenSet = true;
  ...
  inline CreateRouteResult& WithAuthorizationType(AuthorizationType value) {
  ...
  template <typename AuthorizerIdT = Aws::String>
  CreateRouteResult& WithAuthorizerId(AuthorizerIdT&& value) {
  ...
  template <typename ModelSelectionExpressionT = Aws::String>
  CreateRouteResult& WithModelSelectionExpression(ModelSelectionExpressionT&& value) {
  ...
  template <typename OperationNameT = Aws::String>
  CreateRouteResult& WithOperationName(OperationNameT&& value) {
  ...
  template <typename RequestModelsT = Aws::Map<Aws::String, Aws::String>>
  CreateRouteResult& WithRequestModels(RequestModelsT&& value) {
  ...
  template <typename RequestParametersT = Aws::Map<Aws::String, ParameterConstraints>>
  CreateRouteResult& WithRequestParameters(RequestParametersT&& value) {
  ...
  template <typename RouteIdT = Aws::String>
  CreateRouteResult& WithRouteId(RouteIdT&& value) {
  ...
  template <typename RouteKeyT = Aws::String>
  CreateRouteResult& WithRouteKey(RouteKeyT&& value) {
  ...
  template <typename RouteResponseSelectionExpressionT = Aws::String>
  CreateRouteResult& WithRouteResponseSelectionExpression(RouteResponseSelectionExpressionT&& value) {
  ...
  template <typename TargetT = Aws::String>
  CreateRouteResult& WithTarget(TargetT&& value) {
