...
class UpdateDomainNameRequest : public ApiGatewayV2Request {
 public:
  ...
  template <typename DomainNameConfigurationsT = Aws::Vector<DomainNameConfiguration>>
  UpdateDomainNameRequest& WithDomainNameConfigurations(DomainNameConfigurationsT&& value) {
  ...
  UpdateDomainNameRequest& AddDomainNameConfigurations(DomainNameConfigurationsT&& value) {
    m_domainNameConfigurationsHasBeenSet = true;
  ...
  template <typename MutualTlsAuthenticationT = MutualTlsAuthenticationInput>
  UpdateDomainNameRequest& WithMutualTlsAuthentication(MutualTlsAuthenticationT&& value) {
  ...
  inline UpdateDomainNameRequest& WithRoutingMode(RoutingMode value) {
