...
class RouteResponse {
 public:
  ...
  template <typename ModelSelectionExpressionT = Aws::String>
  RouteResponse& WithModelSelectionExpression(ModelSelectionExpressionT&& value) {
  ...
  template <typename ResponseModelsT = Aws::Map<Aws::String, Aws::String>>
  RouteResponse& WithResponseModels(ResponseModelsT&& value) {
  ...
  template <typename ResponseParametersT = Aws::Map<Aws::String, ParameterConstraints>>
  RouteResponse& WithResponseParameters(ResponseParametersT&& value) {
  ...
  template <typename RouteResponseIdT = Aws::String>
  RouteResponse& WithRouteResponseId(RouteResponseIdT&& value) {
  ...
  template <typename RouteResponseKeyT = Aws::String>
  RouteResponse& WithRouteResponseKey(RouteResponseKeyT&& value) {
