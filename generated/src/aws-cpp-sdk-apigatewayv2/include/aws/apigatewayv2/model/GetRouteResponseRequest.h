...
namespace Model
{
  ...
  public:
    ...
    template<typename ApiIdT = Aws::String>
    GetRouteResponseRequest& WithApiId(ApiIdT&& value) { SetApiId(std::forward<ApiIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RouteIdT = Aws::String>
    GetRouteResponseRequest& WithRouteId(RouteIdT&& value) { SetRouteId(std::forward<RouteIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RouteResponseIdT = Aws::String>
    GetRouteResponseRequest& WithRouteResponseId(RouteResponseIdT&& value) { SetRouteResponseId(std::forward<RouteResponseIdT>(value)); return *this;}
    ///@}
  private:
