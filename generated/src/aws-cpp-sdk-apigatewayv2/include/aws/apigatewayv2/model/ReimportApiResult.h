...
class ReimportApiResult {
 public:
  ...
  template <typename ApiEndpointT = Aws::String>
  ReimportApiResult& WithApiEndpoint(ApiEndpointT&& value) {
  ...
  inline ReimportApiResult& WithApiGatewayManaged(bool value) {
  ...
  template <typename ApiIdT = Aws::String>
  ReimportApiResult& WithApiId(ApiIdT&& value) {
  ...
  template <typename ApiKeySelectionExpressionT = Aws::String>
  ReimportApiResult& WithApiKeySelectionExpression(ApiKeySelectionExpressionT&& value) {
  ...
  template <typename CorsConfigurationT = Cors>
  ReimportApiResult& WithCorsConfiguration(CorsConfigurationT&& value) {
  ...
  template <typename CreatedDateT = Aws::Utils::DateTime>
  ReimportApiResult& WithCreatedDate(CreatedDateT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  ReimportApiResult& WithDescription(DescriptionT&& value) {
  ...
  inline ReimportApiResult& WithDisableSchemaValidation(bool value) {
  ...
  inline ReimportApiResult& WithDisableExecuteApiEndpoint(bool value) {
  ...
  template <typename ImportInfoT = Aws::Vector<Aws::String>>
  ReimportApiResult& WithImportInfo(ImportInfoT&& value) {
    SetImportInfo(std::forward<ImportInfoT>(value));
    return *this;
  }
  template <typename ImportInfoT = Aws::String>
  ReimportApiResult& AddImportInfo(ImportInfoT&& value) {
    m_importInfoHasBeenSet = true;
  ...
  inline ReimportApiResult& WithIpAddressType(IpAddressType value) {
  ...
  template <typename NameT = Aws::String>
  ReimportApiResult& WithName(NameT&& value) {
  ...
  inline ReimportApiResult& WithProtocolType(ProtocolType value) {
  ...
  template <typename RouteSelectionExpressionT = Aws::String>
  ReimportApiResult& WithRouteSelectionExpression(RouteSelectionExpressionT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  ReimportApiResult& WithTags(TagsT&& value) {
  ...
  template <typename VersionT = Aws::String>
  ReimportApiResult& WithVersion(VersionT&& value) {
  ...
  template <typename WarningsT = Aws::Vector<Aws::String>>
  ReimportApiResult& WithWarnings(WarningsT&& value) {
    SetWarnings(std::forward<WarningsT>(value));
    return *this;
  }
  template <typename WarningsT = Aws::String>
  ReimportApiResult& AddWarnings(WarningsT&& value) {
    m_warningsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ReimportApiResult& WithRequestId(RequestIdT&& value) {
