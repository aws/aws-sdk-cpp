...
namespace Model
{
  ...
  {
  public:
    AWS_APIGATEWAYV2_API DeleteVpcLinkResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteVpcLinkResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
