...
#ifdef AWS_APIGATEWAYV2_EXPORTS
#define AWS_APIGATEWAYV2_API __declspec(dllexport)
#else
...
#define AWS_APIGATEWAYV2_LOCAL
#else  // defined (USE_WINDOWS_DLL_SEMANTICS) || defined (WIN32)
#define AWS_APIGATEWAYV2_API
#define AWS_APIGATEWAYV2_EXTERN extern
#if __GNUC__ >= 4
#define AWS_APIGATEWAYV2_LOCAL __attribute__((visibility("hidden")))
#else
#define AWS_APIGATEWAYV2_LOCAL
#endif
