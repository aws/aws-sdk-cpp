...
{
const size_t ApiGatewayV2EndpointRules::RulesBlobStrLen = 3740;
const size_t ApiGatewayV2EndpointRules::RulesBlobSize = 3741;
...
'p','s',':','/','/','a','p','i','g','a','t','e','w','a','y','-','f','i','p','s','.','{','R','e','g',
...
'/','/','a','p','i','g','a','t','e','w','a','y','.','{','R','e','g','i','o','n','}','.','{','P','a',
