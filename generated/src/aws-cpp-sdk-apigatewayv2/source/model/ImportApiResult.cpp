...
ImportApiResult::ImportApiResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

ImportApiResult& ImportApiResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
