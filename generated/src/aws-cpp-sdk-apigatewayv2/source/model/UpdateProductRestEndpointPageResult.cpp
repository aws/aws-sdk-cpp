...
UpdateProductRestEndpointPageResult::UpdateProductRestEndpointPageResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

UpdateProductRestEndpointPageResult& UpdateProductRestEndpointPageResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
