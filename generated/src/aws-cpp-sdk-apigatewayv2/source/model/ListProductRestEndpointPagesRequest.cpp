...
Aws::String ListProductRestEndpointPagesRequest::SerializePayload() const { return {}; }

void ListProductRestEndpointPagesRequest::AddQueryStringParameters(URI& uri) const {
  Aws::StringStream ss;
