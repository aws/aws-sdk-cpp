...
CreateRouteResponseResult::CreateRouteResponseResult()
{
}

CreateRouteResponseResult::CreateRouteResponseResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
