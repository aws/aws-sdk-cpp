...
CreateApiMappingResult::CreateApiMappingResult()
{
}

CreateApiMappingResult::CreateApiMappingResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

CreateApiMappingResult& CreateApiMappingResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
