...
CreatePortalProductResult::CreatePortalProductResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

CreatePortalProductResult& CreatePortalProductResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
