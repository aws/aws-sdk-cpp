...
RoutingRuleMatchBasePaths::RoutingRuleMatchBasePaths(JsonView jsonValue)
{
  *this = jsonValue;
}

RoutingRuleMatchBasePaths& RoutingRuleMatchBasePaths::operator =(JsonView jsonValue)
{
...
JsonValue RoutingRuleMatchBasePaths::Jsonize() const
{
  JsonValue payload;
