...
{
const size_t CostExplorerEndpointRules::RulesBlobStrLen = 4296;
const size_t CostExplorerEndpointRules::RulesBlobSize = 4297;
...
'/','/','c','e','.','u','s','-','e','a','s','t','-','1','.','a','m','a','z','o','n','a','w','s','.',
'c','o','m','"',',','"','p','r','o','p','e','r','t','i','e','s','"',':','{','"','a','u','t','h','S',
'c','h','e','m','e','s','"',':','[','{','"','n','a','m','e','"',':','"','s','i','g','v','4','"',',',
'"','s','i','g','n','i','n','g','N','a','m','e','"',':','"','c','e','"',',','"','s','i','g','n','i',
...
'"',':','"','h','t','t','p','s',':','/','/','c','e','-','f','i','p','s','.','{','R','e','g','i','o',
