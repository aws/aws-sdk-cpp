...
{
const size_t CostExplorerEndpointRules::RulesBlobStrLen = 4548;
const size_t CostExplorerEndpointRules::RulesBlobSize = 4549;
...
'l','"',':','"','h','t','t','p','s',':','/','/','c','e','-','f','i','p','s','.','{','R','e','g','i',
