...
SavingsPlansPurchaseAnalysisConfiguration::SavingsPlansPurchaseAnalysisConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
SavingsPlansPurchaseAnalysisConfiguration& SavingsPlansPurchaseAnalysisConfiguration::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("SavingsPlansToExclude")) {
    ...
    for (unsigned savingsPlansToExcludeIndex = 0; savingsPlansToExcludeIndex < savingsPlansToExcludeJsonList.GetLength();
         ++savingsPlansToExcludeIndex) {
