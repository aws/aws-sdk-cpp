...
SavingsPlansPurchaseAnalysisDetails::SavingsPlansPurchaseAnalysisDetails(JsonView jsonValue) { *this = jsonValue; }
...
SavingsPlansPurchaseAnalysisDetails& SavingsPlansPurchaseAnalysisDetails::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("MetricsOverLookbackPeriod")) {
    ...
    for (unsigned metricsOverLookbackPeriodIndex = 0; metricsOverLookbackPeriodIndex < metricsOverLookbackPeriodJsonList.GetLength();
         ++metricsOverLookbackPeriodIndex) {
...
JsonValue SavingsPlansPurchaseAnalysisDetails::Jsonize() const {
  ...
  if (m_metricsOverLookbackPeriodHasBeenSet) {
    ...
    for (unsigned metricsOverLookbackPeriodIndex = 0; metricsOverLookbackPeriodIndex < metricsOverLookbackPeriodJsonList.GetLength();
         ++metricsOverLookbackPeriodIndex) {
      metricsOverLookbackPeriodJsonList[metricsOverLookbackPeriodIndex].AsObject(
          m_metricsOverLookbackPeriod[metricsOverLookbackPeriodIndex].Jsonize());
    }
