...
ReservationPurchaseRecommendation::ReservationPurchaseRecommendation(JsonView jsonValue) { *this = jsonValue; }
...
ReservationPurchaseRecommendation& ReservationPurchaseRecommendation::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("RecommendationDetails")) {
    ...
    for (unsigned recommendationDetailsIndex = 0; recommendationDetailsIndex < recommendationDetailsJsonList.GetLength();
         ++recommendationDetailsIndex) {
