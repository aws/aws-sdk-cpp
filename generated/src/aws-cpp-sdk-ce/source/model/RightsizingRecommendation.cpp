...
RightsizingRecommendation::RightsizingRecommendation(JsonView jsonValue) { *this = jsonValue; }
  ...
  if (jsonValue.ValueExists("FindingReasonCodes")) {
    ...
    for (unsigned findingReasonCodesIndex = 0; findingReasonCodesIndex < findingReasonCodesJsonList.GetLength();
      ...
      m_findingReasonCodes.push_back(
          FindingReasonCodeMapper::GetFindingReasonCodeForName(findingReasonCodesJsonList[findingReasonCodesIndex].AsString()));
    }
  ...
  if (m_findingReasonCodesHasBeenSet) {
    ...
    for (unsigned findingReasonCodesIndex = 0; findingReasonCodesIndex < findingReasonCodesJsonList.GetLength();
      ...
      findingReasonCodesJsonList[findingReasonCodesIndex].AsString(
          FindingReasonCodeMapper::GetNameForFindingReasonCode(m_findingReasonCodes[findingReasonCodesIndex]));
    }
