...
GetCostCategoriesResult::GetCostCategoriesResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
GetCostCategoriesResult& GetCostCategoriesResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("CostCategoryValues")) {
    ...
    for (unsigned costCategoryValuesIndex = 0; costCategoryValuesIndex < costCategoryValuesJsonList.GetLength();
         ++costCategoryValuesIndex) {
