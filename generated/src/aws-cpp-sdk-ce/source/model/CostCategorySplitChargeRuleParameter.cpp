...
CostCategorySplitChargeRuleParameter::CostCategorySplitChargeRuleParameter(JsonView jsonValue) { *this = jsonValue; }

CostCategorySplitChargeRuleParameter& CostCategorySplitChargeRuleParameter::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("Type")) {
    m_type =
        CostCategorySplitChargeRuleParameterTypeMapper::GetCostCategorySplitChargeRuleParameterTypeForName(jsonValue.GetString("Type"));
