...
class DiskResourceUtilization {
 public:
  ...
  void SetDiskReadOpsPerSecond(DiskReadOpsPerSecondT&& value) {
    ...
    m_diskReadOpsPerSecond = std::forward<DiskReadOpsPerSecondT>(value);
  }
  template <typename DiskReadOpsPerSecondT = Aws::String>
  DiskResourceUtilization& WithDiskReadOpsPerSecond(DiskReadOpsPerSecondT&& value) {
    SetDiskReadOpsPerSecond(std::forward<DiskReadOpsPerSecondT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDiskWriteOpsPerSecond(DiskWriteOpsPerSecondT&& value) {
    ...
    m_diskWriteOpsPerSecond = std::forward<DiskWriteOpsPerSecondT>(value);
  }
  template <typename DiskWriteOpsPerSecondT = Aws::String>
  DiskResourceUtilization& WithDiskWriteOpsPerSecond(DiskWriteOpsPerSecondT&& value) {
    SetDiskWriteOpsPerSecond(std::forward<DiskWriteOpsPerSecondT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDiskReadBytesPerSecond(DiskReadBytesPerSecondT&& value) {
    ...
    m_diskReadBytesPerSecond = std::forward<DiskReadBytesPerSecondT>(value);
  }
  template <typename DiskReadBytesPerSecondT = Aws::String>
  DiskResourceUtilization& WithDiskReadBytesPerSecond(DiskReadBytesPerSecondT&& value) {
    SetDiskReadBytesPerSecond(std::forward<DiskReadBytesPerSecondT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDiskWriteBytesPerSecond(DiskWriteBytesPerSecondT&& value) {
    ...
    m_diskWriteBytesPerSecond = std::forward<DiskWriteBytesPerSecondT>(value);
  }
  template <typename DiskWriteBytesPerSecondT = Aws::String>
  DiskResourceUtilization& WithDiskWriteBytesPerSecond(DiskWriteBytesPerSecondT&& value) {
    SetDiskWriteBytesPerSecond(std::forward<DiskWriteBytesPerSecondT>(value));
    return *this;
  }
  ///@}
 private:
