...
namespace Model
{
  ...
  {
  public:
    AWS_COSTEXPLORER_API UpdateAnomalyMonitorResult() = default;
    ...
    template<typename MonitorArnT = Aws::String>
    UpdateAnomalyMonitorResult& WithMonitorArn(MonitorArnT&& value) { SetMonitorArn(std::forward<MonitorArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateAnomalyMonitorResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
