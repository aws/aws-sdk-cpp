...
class EBSResourceUtilization {
 public:
  ...
  void SetEbsReadOpsPerSecond(EbsReadOpsPerSecondT&& value) {
    ...
    m_ebsReadOpsPerSecond = std::forward<EbsReadOpsPerSecondT>(value);
  }
  template <typename EbsReadOpsPerSecondT = Aws::String>
  EBSResourceUtilization& WithEbsReadOpsPerSecond(EbsReadOpsPerSecondT&& value) {
    SetEbsReadOpsPerSecond(std::forward<EbsReadOpsPerSecondT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEbsWriteOpsPerSecond(EbsWriteOpsPerSecondT&& value) {
    ...
    m_ebsWriteOpsPerSecond = std::forward<EbsWriteOpsPerSecondT>(value);
  }
  template <typename EbsWriteOpsPerSecondT = Aws::String>
  EBSResourceUtilization& WithEbsWriteOpsPerSecond(EbsWriteOpsPerSecondT&& value) {
    SetEbsWriteOpsPerSecond(std::forward<EbsWriteOpsPerSecondT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEbsReadBytesPerSecond(EbsReadBytesPerSecondT&& value) {
    ...
    m_ebsReadBytesPerSecond = std::forward<EbsReadBytesPerSecondT>(value);
  }
  template <typename EbsReadBytesPerSecondT = Aws::String>
  EBSResourceUtilization& WithEbsReadBytesPerSecond(EbsReadBytesPerSecondT&& value) {
    SetEbsReadBytesPerSecond(std::forward<EbsReadBytesPerSecondT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEbsWriteBytesPerSecond(EbsWriteBytesPerSecondT&& value) {
    ...
    m_ebsWriteBytesPerSecond = std::forward<EbsWriteBytesPerSecondT>(value);
  }
  template <typename EbsWriteBytesPerSecondT = Aws::String>
  EBSResourceUtilization& WithEbsWriteBytesPerSecond(EbsWriteBytesPerSecondT&& value) {
    SetEbsWriteBytesPerSecond(std::forward<EbsWriteBytesPerSecondT>(value));
    return *this;
  }
  ///@}
 private:
