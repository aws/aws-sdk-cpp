...
class RecommendationDetailHourlyMetrics {
 public:
  ...
  void SetCurrentCoverage(CurrentCoverageT&& value) {
    ...
    m_currentCoverage = std::forward<CurrentCoverageT>(value);
  }
  template <typename CurrentCoverageT = Aws::String>
  RecommendationDetailHourlyMetrics& WithCurrentCoverage(CurrentCoverageT&& value) {
    SetCurrentCoverage(std::forward<CurrentCoverageT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEstimatedCoverage(EstimatedCoverageT&& value) {
    ...
    m_estimatedCoverage = std::forward<EstimatedCoverageT>(value);
  }
  template <typename EstimatedCoverageT = Aws::String>
  RecommendationDetailHourlyMetrics& WithEstimatedCoverage(EstimatedCoverageT&& value) {
    SetEstimatedCoverage(std::forward<EstimatedCoverageT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEstimatedNewCommitmentUtilization(EstimatedNewCommitmentUtilizationT&& value) {
    ...
    m_estimatedNewCommitmentUtilization = std::forward<EstimatedNewCommitmentUtilizationT>(value);
  }
  template <typename EstimatedNewCommitmentUtilizationT = Aws::String>
  RecommendationDetailHourlyMetrics& WithEstimatedNewCommitmentUtilization(EstimatedNewCommitmentUtilizationT&& value) {
    SetEstimatedNewCommitmentUtilization(std::forward<EstimatedNewCommitmentUtilizationT>(value));
    return *this;
  }
  ///@}
 private:
