...
class CostCategoryRule {
 public:
  ...
  void SetInheritedValue(InheritedValueT&& value) {
    ...
    m_inheritedValue = std::forward<InheritedValueT>(value);
  }
  template <typename InheritedValueT = CostCategoryInheritedValueDimension>
  CostCategoryRule& WithInheritedValue(InheritedValueT&& value) {
    SetInheritedValue(std::forward<InheritedValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetType(CostCategoryRuleType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline CostCategoryRule& WithType(CostCategoryRuleType value) {
    SetType(value);
    return *this;
  }
  ///@}
