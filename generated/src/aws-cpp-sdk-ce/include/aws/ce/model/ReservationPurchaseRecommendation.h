...
class ReservationPurchaseRecommendation {
 public:
  ...
  inline ReservationPurchaseRecommendation& WithAccountScope(AccountScope value) {
  ...
  inline ReservationPurchaseRecommendation& WithLookbackPeriodInDays(LookbackPeriodInDays value) {
  ...
  inline ReservationPurchaseRecommendation& WithTermInYears(TermInYears value) {
  ...
  inline ReservationPurchaseRecommendation& WithPaymentOption(PaymentOption value) {
  ...
  void SetServiceSpecification(ServiceSpecificationT&& value) {
    ...
    m_serviceSpecification = std::forward<ServiceSpecificationT>(value);
  }
  template <typename ServiceSpecificationT = ServiceSpecification>
  ReservationPurchaseRecommendation& WithServiceSpecification(ServiceSpecificationT&& value) {
    SetServiceSpecification(std::forward<ServiceSpecificationT>(value));
    return *this;
  }
  ///@}
  ...
  ReservationPurchaseRecommendation& AddRecommendationDetails(RecommendationDetailsT&& value) {
    m_recommendationDetailsHasBeenSet = true;
    m_recommendationDetails.emplace_back(std::forward<RecommendationDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRecommendationSummary(RecommendationSummaryT&& value) {
    ...
    m_recommendationSummary = std::forward<RecommendationSummaryT>(value);
  }
  template <typename RecommendationSummaryT = ReservationPurchaseRecommendationSummary>
  ReservationPurchaseRecommendation& WithRecommendationSummary(RecommendationSummaryT&& value) {
    SetRecommendationSummary(std::forward<RecommendationSummaryT>(value));
    return *this;
  }
  ///@}
 private:
