...
class GetRightsizingRecommendationResult {
 public:
  ...
  AWS_COSTEXPLORER_API GetRightsizingRecommendationResult& operator=(
  ...
  void SetRightsizingRecommendations(RightsizingRecommendationsT&& value) {
    ...
    m_rightsizingRecommendations = std::forward<RightsizingRecommendationsT>(value);
  }
  template <typename RightsizingRecommendationsT = Aws::Vector<RightsizingRecommendation>>
  GetRightsizingRecommendationResult& WithRightsizingRecommendations(RightsizingRecommendationsT&& value) {
    SetRightsizingRecommendations(std::forward<RightsizingRecommendationsT>(value));
    return *this;
  }
  ...
  GetRightsizingRecommendationResult& AddRightsizingRecommendations(RightsizingRecommendationsT&& value) {
    m_rightsizingRecommendationsHasBeenSet = true;
    m_rightsizingRecommendations.emplace_back(std::forward<RightsizingRecommendationsT>(value));
    return *this;
  }
  ///@}
