...
class GetCostAndUsageComparisonsResult {
 public:
  ...
  void SetCostAndUsageComparisons(CostAndUsageComparisonsT&& value) {
    m_costAndUsageComparisonsHasBeenSet = true;
    m_costAndUsageComparisons = std::forward<CostAndUsageComparisonsT>(value);
  }
  template <typename CostAndUsageComparisonsT = Aws::Vector<CostAndUsageComparison>>
  GetCostAndUsageComparisonsResult& WithCostAndUsageComparisons(CostAndUsageComparisonsT&& value) {
    SetCostAndUsageComparisons(std::forward<CostAndUsageComparisonsT>(value));
    return *this;
  }
  template <typename CostAndUsageComparisonsT = CostAndUsageComparison>
  GetCostAndUsageComparisonsResult& AddCostAndUsageComparisons(CostAndUsageComparisonsT&& value) {
    m_costAndUsageComparisonsHasBeenSet = true;
    m_costAndUsageComparisons.emplace_back(std::forward<CostAndUsageComparisonsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTotalCostAndUsage(TotalCostAndUsageT&& value) {
    m_totalCostAndUsageHasBeenSet = true;
    m_totalCostAndUsage = std::forward<TotalCostAndUsageT>(value);
  }
  template <typename TotalCostAndUsageT = Aws::Map<Aws::String, ComparisonMetricValue>>
  GetCostAndUsageComparisonsResult& WithTotalCostAndUsage(TotalCostAndUsageT&& value) {
    SetTotalCostAndUsage(std::forward<TotalCostAndUsageT>(value));
    return *this;
  }
  ...
  GetCostAndUsageComparisonsResult& AddTotalCostAndUsage(TotalCostAndUsageKeyT&& key, TotalCostAndUsageValueT&& value) {
    m_totalCostAndUsageHasBeenSet = true;
    m_totalCostAndUsage.emplace(std::forward<TotalCostAndUsageKeyT>(key), std::forward<TotalCostAndUsageValueT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextPageTokenT = Aws::String>
  GetCostAndUsageComparisonsResult& WithNextPageToken(NextPageTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetCostAndUsageComparisonsResult& WithRequestId(RequestIdT&& value) {
