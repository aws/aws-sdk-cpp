...
class RightsizingRecommendationSummary {
 public:
  ...
  void SetTotalRecommendationCount(TotalRecommendationCountT&& value) {
    ...
    m_totalRecommendationCount = std::forward<TotalRecommendationCountT>(value);
  }
  template <typename TotalRecommendationCountT = Aws::String>
  RightsizingRecommendationSummary& WithTotalRecommendationCount(TotalRecommendationCountT&& value) {
    SetTotalRecommendationCount(std::forward<TotalRecommendationCountT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEstimatedTotalMonthlySavingsAmount(EstimatedTotalMonthlySavingsAmountT&& value) {
    ...
    m_estimatedTotalMonthlySavingsAmount = std::forward<EstimatedTotalMonthlySavingsAmountT>(value);
  }
  template <typename EstimatedTotalMonthlySavingsAmountT = Aws::String>
  RightsizingRecommendationSummary& WithEstimatedTotalMonthlySavingsAmount(EstimatedTotalMonthlySavingsAmountT&& value) {
    SetEstimatedTotalMonthlySavingsAmount(std::forward<EstimatedTotalMonthlySavingsAmountT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSavingsCurrencyCode(SavingsCurrencyCodeT&& value) {
    m_savingsCurrencyCodeHasBeenSet = true;
    m_savingsCurrencyCode = std::forward<SavingsCurrencyCodeT>(value);
  }
  template <typename SavingsCurrencyCodeT = Aws::String>
  RightsizingRecommendationSummary& WithSavingsCurrencyCode(SavingsCurrencyCodeT&& value) {
    SetSavingsCurrencyCode(std::forward<SavingsCurrencyCodeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSavingsPercentage(SavingsPercentageT&& value) {
    m_savingsPercentageHasBeenSet = true;
    m_savingsPercentage = std::forward<SavingsPercentageT>(value);
  }
  template <typename SavingsPercentageT = Aws::String>
  RightsizingRecommendationSummary& WithSavingsPercentage(SavingsPercentageT&& value) {
    SetSavingsPercentage(std::forward<SavingsPercentageT>(value));
    return *this;
  }
  ///@}
 private:
