...
class ResourceUtilization {
 public:
  ...
  void SetEC2ResourceUtilization(EC2ResourceUtilizationT&& value) {
    m_eC2ResourceUtilizationHasBeenSet = true;
    m_eC2ResourceUtilization = std::forward<EC2ResourceUtilizationT>(value);
  }
  template <typename EC2ResourceUtilizationT = EC2ResourceUtilization>
  ResourceUtilization& WithEC2ResourceUtilization(EC2ResourceUtilizationT&& value) {
    SetEC2ResourceUtilization(std::forward<EC2ResourceUtilizationT>(value));
    return *this;
  }
  ///@}
 private:
