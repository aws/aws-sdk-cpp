...
class GetCostForecastRequest : public CostExplorerRequest {
 public:
  ...
  inline GetCostForecastRequest& WithMetric(Metric value) {
    SetMetric(value);
    return *this;
  }
  ///@}
  ...
  inline GetCostForecastRequest& WithGranularity(Granularity value) {
  ...
  inline GetCostForecastRequest& WithPredictionIntervalLevel(int value) {
