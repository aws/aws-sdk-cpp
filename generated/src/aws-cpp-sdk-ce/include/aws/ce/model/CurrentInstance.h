...
class CurrentInstance {
 public:
  ...
  void SetResourceUtilization(ResourceUtilizationT&& value) {
    ...
    m_resourceUtilization = std::forward<ResourceUtilizationT>(value);
  }
  template <typename ResourceUtilizationT = ResourceUtilization>
  CurrentInstance& WithResourceUtilization(ResourceUtilizationT&& value) {
    SetResourceUtilization(std::forward<ResourceUtilizationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReservationCoveredHoursInLookbackPeriod(ReservationCoveredHoursInLookbackPeriodT&& value) {
    ...
    m_reservationCoveredHoursInLookbackPeriod = std::forward<ReservationCoveredHoursInLookbackPeriodT>(value);
  }
  template <typename ReservationCoveredHoursInLookbackPeriodT = Aws::String>
  CurrentInstance& WithReservationCoveredHoursInLookbackPeriod(ReservationCoveredHoursInLookbackPeriodT&& value) {
    SetReservationCoveredHoursInLookbackPeriod(std::forward<ReservationCoveredHoursInLookbackPeriodT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSavingsPlansCoveredHoursInLookbackPeriod(SavingsPlansCoveredHoursInLookbackPeriodT&& value) {
    ...
    m_savingsPlansCoveredHoursInLookbackPeriod = std::forward<SavingsPlansCoveredHoursInLookbackPeriodT>(value);
  }
  template <typename SavingsPlansCoveredHoursInLookbackPeriodT = Aws::String>
  CurrentInstance& WithSavingsPlansCoveredHoursInLookbackPeriod(SavingsPlansCoveredHoursInLookbackPeriodT&& value) {
    SetSavingsPlansCoveredHoursInLookbackPeriod(std::forward<SavingsPlansCoveredHoursInLookbackPeriodT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOnDemandHoursInLookbackPeriod(OnDemandHoursInLookbackPeriodT&& value) {
    ...
    m_onDemandHoursInLookbackPeriod = std::forward<OnDemandHoursInLookbackPeriodT>(value);
  }
  template <typename OnDemandHoursInLookbackPeriodT = Aws::String>
  CurrentInstance& WithOnDemandHoursInLookbackPeriod(OnDemandHoursInLookbackPeriodT&& value) {
    SetOnDemandHoursInLookbackPeriod(std::forward<OnDemandHoursInLookbackPeriodT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTotalRunningHoursInLookbackPeriod(TotalRunningHoursInLookbackPeriodT&& value) {
    ...
    m_totalRunningHoursInLookbackPeriod = std::forward<TotalRunningHoursInLookbackPeriodT>(value);
  }
  template <typename TotalRunningHoursInLookbackPeriodT = Aws::String>
  CurrentInstance& WithTotalRunningHoursInLookbackPeriod(TotalRunningHoursInLookbackPeriodT&& value) {
    SetTotalRunningHoursInLookbackPeriod(std::forward<TotalRunningHoursInLookbackPeriodT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMonthlyCost(MonthlyCostT&& value) {
    ...
    m_monthlyCost = std::forward<MonthlyCostT>(value);
  }
  template <typename MonthlyCostT = Aws::String>
  CurrentInstance& WithMonthlyCost(MonthlyCostT&& value) {
    SetMonthlyCost(std::forward<MonthlyCostT>(value));
    return *this;
  }
  ///@}
