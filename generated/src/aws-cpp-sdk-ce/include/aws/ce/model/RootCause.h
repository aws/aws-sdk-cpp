...
class RootCause {
 public:
  ...
  void SetLinkedAccountName(LinkedAccountNameT&& value) {
    ...
    m_linkedAccountName = std::forward<LinkedAccountNameT>(value);
  }
  template <typename LinkedAccountNameT = Aws::String>
  RootCause& WithLinkedAccountName(LinkedAccountNameT&& value) {
    SetLinkedAccountName(std::forward<LinkedAccountNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetImpact(ImpactT&& value) {
    ...
    m_impact = std::forward<ImpactT>(value);
  }
  template <typename ImpactT = RootCauseImpact>
  RootCause& WithImpact(ImpactT&& value) {
    SetImpact(std::forward<ImpactT>(value));
    return *this;
  }
  ///@}
 private:
