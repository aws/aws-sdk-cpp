...
class GetDimensionValuesResult {
 public:
  ...
  void SetDimensionValues(DimensionValuesT&& value) {
    ...
    m_dimensionValues = std::forward<DimensionValuesT>(value);
  }
  template <typename DimensionValuesT = Aws::Vector<DimensionValuesWithAttributes>>
  GetDimensionValuesResult& WithDimensionValues(DimensionValuesT&& value) {
    SetDimensionValues(std::forward<DimensionValuesT>(value));
    return *this;
  }
  ...
  GetDimensionValuesResult& AddDimensionValues(DimensionValuesT&& value) {
    m_dimensionValuesHasBeenSet = true;
    m_dimensionValues.emplace_back(std::forward<DimensionValuesT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetDimensionValuesResult& WithReturnSize(int value) {
    SetReturnSize(value);
    return *this;
  }
  ///@}
  ...
  inline GetDimensionValuesResult& WithTotalSize(int value) {
    SetTotalSize(value);
    return *this;
  }
  ///@}
