...
class SavingsPlansUtilizationDetail {
 public:
  ...
  void SetSavingsPlanArn(SavingsPlanArnT&& value) {
    ...
    m_savingsPlanArn = std::forward<SavingsPlanArnT>(value);
  }
  template <typename SavingsPlanArnT = Aws::String>
  SavingsPlansUtilizationDetail& WithSavingsPlanArn(SavingsPlanArnT&& value) {
    SetSavingsPlanArn(std::forward<SavingsPlanArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUtilization(UtilizationT&& value) {
    ...
    m_utilization = std::forward<UtilizationT>(value);
  }
  template <typename UtilizationT = SavingsPlansUtilization>
  SavingsPlansUtilizationDetail& WithUtilization(UtilizationT&& value) {
    SetUtilization(std::forward<UtilizationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSavings(SavingsT&& value) {
    ...
    m_savings = std::forward<SavingsT>(value);
  }
  template <typename SavingsT = SavingsPlansSavings>
  SavingsPlansUtilizationDetail& WithSavings(SavingsT&& value) {
    SetSavings(std::forward<SavingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAmortizedCommitment(AmortizedCommitmentT&& value) {
    ...
    m_amortizedCommitment = std::forward<AmortizedCommitmentT>(value);
  }
  template <typename AmortizedCommitmentT = SavingsPlansAmortizedCommitment>
  SavingsPlansUtilizationDetail& WithAmortizedCommitment(AmortizedCommitmentT&& value) {
    SetAmortizedCommitment(std::forward<AmortizedCommitmentT>(value));
    return *this;
  }
  ///@}
 private:
