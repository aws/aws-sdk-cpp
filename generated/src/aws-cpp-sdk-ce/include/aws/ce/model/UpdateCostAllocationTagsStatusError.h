...
class UpdateCostAllocationTagsStatusError {
 public:
  ...
  template <typename TagKeyT = Aws::String>
  UpdateCostAllocationTagsStatusError& WithTagKey(TagKeyT&& value) {
  ...
  template <typename CodeT = Aws::String>
  UpdateCostAllocationTagsStatusError& WithCode(CodeT&& value) {
  ...
  template <typename MessageT = Aws::String>
  UpdateCostAllocationTagsStatusError& WithMessage(MessageT&& value) {
