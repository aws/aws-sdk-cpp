...
class GetUsageForecastRequest : public CostExplorerRequest {
 public:
  ...
  inline GetUsageForecastRequest& WithMetric(Metric value) {
    SetMetric(value);
    return *this;
  }
  ///@}
  ...
  inline GetUsageForecastRequest& WithGranularity(Granularity value) {
  ...
  inline void SetPredictionIntervalLevel(int value) {
    m_predictionIntervalLevelHasBeenSet = true;
    m_predictionIntervalLevel = value;
  }
  inline GetUsageForecastRequest& WithPredictionIntervalLevel(int value) {
    SetPredictionIntervalLevel(value);
    return *this;
  }
  ///@}
 private:
