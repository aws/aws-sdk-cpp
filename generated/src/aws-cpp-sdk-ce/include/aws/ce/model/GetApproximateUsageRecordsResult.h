...
class GetApproximateUsageRecordsResult {
 public:
  ...
  template <typename ServicesT = Aws::Map<Aws::String, long long>>
  GetApproximateUsageRecordsResult& WithServices(ServicesT&& value) {
  ...
  inline void SetTotalRecords(long long value) {
    m_totalRecordsHasBeenSet = true;
    m_totalRecords = value;
  }
  inline GetApproximateUsageRecordsResult& WithTotalRecords(long long value) {
  ...
  void SetLookbackPeriod(LookbackPeriodT&& value) {
    m_lookbackPeriodHasBeenSet = true;
    m_lookbackPeriod = std::forward<LookbackPeriodT>(value);
  }
  template <typename LookbackPeriodT = DateInterval>
  GetApproximateUsageRecordsResult& WithLookbackPeriod(LookbackPeriodT&& value) {
    SetLookbackPeriod(std::forward<LookbackPeriodT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetApproximateUsageRecordsResult& WithRequestId(RequestIdT&& value) {
