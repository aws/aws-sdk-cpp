...
class ReservationPurchaseRecommendationSummary {
 public:
  ...
  void SetTotalEstimatedMonthlySavingsAmount(TotalEstimatedMonthlySavingsAmountT&& value) {
    ...
    m_totalEstimatedMonthlySavingsAmount = std::forward<TotalEstimatedMonthlySavingsAmountT>(value);
  }
  template <typename TotalEstimatedMonthlySavingsAmountT = Aws::String>
  ReservationPurchaseRecommendationSummary& WithTotalEstimatedMonthlySavingsAmount(TotalEstimatedMonthlySavingsAmountT&& value) {
    SetTotalEstimatedMonthlySavingsAmount(std::forward<TotalEstimatedMonthlySavingsAmountT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTotalEstimatedMonthlySavingsPercentage(TotalEstimatedMonthlySavingsPercentageT&& value) {
    ...
    m_totalEstimatedMonthlySavingsPercentage = std::forward<TotalEstimatedMonthlySavingsPercentageT>(value);
  }
  template <typename TotalEstimatedMonthlySavingsPercentageT = Aws::String>
  ReservationPurchaseRecommendationSummary& WithTotalEstimatedMonthlySavingsPercentage(TotalEstimatedMonthlySavingsPercentageT&& value) {
    SetTotalEstimatedMonthlySavingsPercentage(std::forward<TotalEstimatedMonthlySavingsPercentageT>(value));
    return *this;
  }
  ///@}
