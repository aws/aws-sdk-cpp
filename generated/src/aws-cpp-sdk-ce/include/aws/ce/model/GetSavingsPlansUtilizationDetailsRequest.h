...
class GetSavingsPlansUtilizationDetailsRequest : public CostExplorerRequest {
 public:
  ...
  template <typename FilterT = Expression>
  GetSavingsPlansUtilizationDetailsRequest& WithFilter(FilterT&& value) {
  ...
  inline GetSavingsPlansUtilizationDetailsRequest& AddDataType(SavingsPlansDataType value) {
    m_dataTypeHasBeenSet = true;
    m_dataType.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline GetSavingsPlansUtilizationDetailsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename SortByT = SortDefinition>
  GetSavingsPlansUtilizationDetailsRequest& WithSortBy(SortByT&& value) {
