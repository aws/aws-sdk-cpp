...
class SavingsPlansCoverageData {
 public:
  ...
  void SetSpendCoveredBySavingsPlans(SpendCoveredBySavingsPlansT&& value) {
    ...
    m_spendCoveredBySavingsPlans = std::forward<SpendCoveredBySavingsPlansT>(value);
  }
  template <typename SpendCoveredBySavingsPlansT = Aws::String>
  SavingsPlansCoverageData& WithSpendCoveredBySavingsPlans(SpendCoveredBySavingsPlansT&& value) {
    SetSpendCoveredBySavingsPlans(std::forward<SpendCoveredBySavingsPlansT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOnDemandCost(OnDemandCostT&& value) {
    ...
    m_onDemandCost = std::forward<OnDemandCostT>(value);
  }
  template <typename OnDemandCostT = Aws::String>
  SavingsPlansCoverageData& WithOnDemandCost(OnDemandCostT&& value) {
    SetOnDemandCost(std::forward<OnDemandCostT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTotalCost(TotalCostT&& value) {
    ...
    m_totalCost = std::forward<TotalCostT>(value);
  }
  template <typename TotalCostT = Aws::String>
  SavingsPlansCoverageData& WithTotalCost(TotalCostT&& value) {
    SetTotalCost(std::forward<TotalCostT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCoveragePercentage(CoveragePercentageT&& value) {
    ...
    m_coveragePercentage = std::forward<CoveragePercentageT>(value);
  }
  template <typename CoveragePercentageT = Aws::String>
  SavingsPlansCoverageData& WithCoveragePercentage(CoveragePercentageT&& value) {
    SetCoveragePercentage(std::forward<CoveragePercentageT>(value));
    return *this;
  }
  ///@}
 private:
