...
class ListCommitmentPurchaseAnalysesResult {
 public:
  ...
  AWS_COSTEXPLORER_API ListCommitmentPurchaseAnalysesResult& operator=(
  ...
  void SetAnalysisSummaryList(AnalysisSummaryListT&& value) {
    m_analysisSummaryListHasBeenSet = true;
    m_analysisSummaryList = std::forward<AnalysisSummaryListT>(value);
  }
  template <typename AnalysisSummaryListT = Aws::Vector<AnalysisSummary>>
  ListCommitmentPurchaseAnalysesResult& WithAnalysisSummaryList(AnalysisSummaryListT&& value) {
    SetAnalysisSummaryList(std::forward<AnalysisSummaryListT>(value));
    return *this;
  }
  template <typename AnalysisSummaryListT = AnalysisSummary>
  ListCommitmentPurchaseAnalysesResult& AddAnalysisSummaryList(AnalysisSummaryListT&& value) {
    m_analysisSummaryListHasBeenSet = true;
    m_analysisSummaryList.emplace_back(std::forward<AnalysisSummaryListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextPageTokenT = Aws::String>
  ListCommitmentPurchaseAnalysesResult& WithNextPageToken(NextPageTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListCommitmentPurchaseAnalysesResult& WithRequestId(RequestIdT&& value) {
