...
class GetSavingsPlansPurchaseRecommendationResult {
 public:
  ...
  AWS_COSTEXPLORER_API GetSavingsPlansPurchaseRecommendationResult& operator=(
  ...
  template <typename MetadataT = SavingsPlansPurchaseRecommendationMetadata>
  GetSavingsPlansPurchaseRecommendationResult& WithMetadata(MetadataT&& value) {
   ...
   * Details.</p>
   */
  inline const SavingsPlansPurchaseRecommendation& GetSavingsPlansPurchaseRecommendation() const {
    return m_savingsPlansPurchaseRecommendation;
  }
  template <typename SavingsPlansPurchaseRecommendationT = SavingsPlansPurchaseRecommendation>
  void SetSavingsPlansPurchaseRecommendation(SavingsPlansPurchaseRecommendationT&& value) {
    m_savingsPlansPurchaseRecommendationHasBeenSet = true;
    m_savingsPlansPurchaseRecommendation = std::forward<SavingsPlansPurchaseRecommendationT>(value);
  }
  template <typename SavingsPlansPurchaseRecommendationT = SavingsPlansPurchaseRecommendation>
  GetSavingsPlansPurchaseRecommendationResult& WithSavingsPlansPurchaseRecommendation(SavingsPlansPurchaseRecommendationT&& value) {
    SetSavingsPlansPurchaseRecommendation(std::forward<SavingsPlansPurchaseRecommendationT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextPageTokenT = Aws::String>
  GetSavingsPlansPurchaseRecommendationResult& WithNextPageToken(NextPageTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetSavingsPlansPurchaseRecommendationResult& WithRequestId(RequestIdT&& value) {
