...
class CostCategoryInheritedValueDimension {
 public:
  ...
  inline void SetDimensionName(CostCategoryInheritedValueDimensionName value) {
    m_dimensionNameHasBeenSet = true;
    m_dimensionName = value;
  }
  inline CostCategoryInheritedValueDimension& WithDimensionName(CostCategoryInheritedValueDimensionName value) {
  ...
  template <typename DimensionKeyT = Aws::String>
  CostCategoryInheritedValueDimension& WithDimensionKey(DimensionKeyT&& value) {
