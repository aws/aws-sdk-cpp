...
namespace Model
{
  ...
  {
  public:
    AWS_COSTEXPLORER_API DeleteAnomalySubscriptionResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteAnomalySubscriptionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
