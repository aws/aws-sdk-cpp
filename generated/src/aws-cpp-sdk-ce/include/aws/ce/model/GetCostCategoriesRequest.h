...
class GetCostCategoriesRequest : public CostExplorerRequest {
 public:
  ...
  template <typename SearchStringT = Aws::String>
  GetCostCategoriesRequest& WithSearchString(SearchStringT&& value) {
  ...
  template <typename TimePeriodT = DateInterval>
  GetCostCategoriesRequest& WithTimePeriod(TimePeriodT&& value) {
  ...
  template <typename CostCategoryNameT = Aws::String>
  GetCostCategoriesRequest& WithCostCategoryName(CostCategoryNameT&& value) {
  ...
  template <typename FilterT = Expression>
  GetCostCategoriesRequest& WithFilter(FilterT&& value) {
  ...
  template <typename SortByT = Aws::Vector<SortDefinition>>
  GetCostCategoriesRequest& WithSortBy(SortByT&& value) {
    SetSortBy(std::forward<SortByT>(value));
    return *this;
  }
  template <typename SortByT = SortDefinition>
  GetCostCategoriesRequest& AddSortBy(SortByT&& value) {
    m_sortByHasBeenSet = true;
  ...
  template <typename BillingViewArnT = Aws::String>
  GetCostCategoriesRequest& WithBillingViewArn(BillingViewArnT&& value) {
  ...
  inline GetCostCategoriesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextPageTokenT = Aws::String>
  GetCostCategoriesRequest& WithNextPageToken(NextPageTokenT&& value) {
