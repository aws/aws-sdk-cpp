...
class StartSavingsPlansPurchaseRecommendationGenerationResult {
 public:
  ...
  AWS_COSTEXPLORER_API StartSavingsPlansPurchaseRecommendationGenerationResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename RecommendationIdT = Aws::String>
  StartSavingsPlansPurchaseRecommendationGenerationResult& WithRecommendationId(RecommendationIdT&& value) {
  ...
  void SetGenerationStartedTime(GenerationStartedTimeT&& value) {
    ...
    m_generationStartedTime = std::forward<GenerationStartedTimeT>(value);
  }
  template <typename GenerationStartedTimeT = Aws::String>
  StartSavingsPlansPurchaseRecommendationGenerationResult& WithGenerationStartedTime(GenerationStartedTimeT&& value) {
    SetGenerationStartedTime(std::forward<GenerationStartedTimeT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename EstimatedCompletionTimeT = Aws::String>
  StartSavingsPlansPurchaseRecommendationGenerationResult& WithEstimatedCompletionTime(EstimatedCompletionTimeT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StartSavingsPlansPurchaseRecommendationGenerationResult& WithRequestId(RequestIdT&& value) {
