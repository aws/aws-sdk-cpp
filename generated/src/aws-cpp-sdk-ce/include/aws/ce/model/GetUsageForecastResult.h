...
class GetUsageForecastResult {
 public:
  ...
  template <typename TotalT = MetricValue>
  GetUsageForecastResult& WithTotal(TotalT&& value) {
  ...
  void SetForecastResultsByTime(ForecastResultsByTimeT&& value) {
    m_forecastResultsByTimeHasBeenSet = true;
    m_forecastResultsByTime = std::forward<ForecastResultsByTimeT>(value);
  }
  template <typename ForecastResultsByTimeT = Aws::Vector<ForecastResult>>
  GetUsageForecastResult& WithForecastResultsByTime(ForecastResultsByTimeT&& value) {
    SetForecastResultsByTime(std::forward<ForecastResultsByTimeT>(value));
    return *this;
  }
  template <typename ForecastResultsByTimeT = ForecastResult>
  GetUsageForecastResult& AddForecastResultsByTime(ForecastResultsByTimeT&& value) {
    m_forecastResultsByTimeHasBeenSet = true;
    m_forecastResultsByTime.emplace_back(std::forward<ForecastResultsByTimeT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetUsageForecastResult& WithRequestId(RequestIdT&& value) {
