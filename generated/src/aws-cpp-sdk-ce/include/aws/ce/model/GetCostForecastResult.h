...
class GetCostForecastResult {
 public:
  ...
  template <typename TotalT = MetricValue>
  GetCostForecastResult& WithTotal(TotalT&& value) {
  ...
  template <typename ForecastResultsByTimeT = Aws::Vector<ForecastResult>>
  GetCostForecastResult& WithForecastResultsByTime(ForecastResultsByTimeT&& value) {
    SetForecastResultsByTime(std::forward<ForecastResultsByTimeT>(value));
    return *this;
  }
  template <typename ForecastResultsByTimeT = ForecastResult>
  GetCostForecastResult& AddForecastResultsByTime(ForecastResultsByTimeT&& value) {
    m_forecastResultsByTimeHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetCostForecastResult& WithRequestId(RequestIdT&& value) {
