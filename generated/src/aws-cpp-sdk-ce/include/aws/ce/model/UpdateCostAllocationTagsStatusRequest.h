...
class UpdateCostAllocationTagsStatusRequest : public CostExplorerRequest {
 public:
  ...
  void SetCostAllocationTagsStatus(CostAllocationTagsStatusT&& value) {
    m_costAllocationTagsStatusHasBeenSet = true;
    m_costAllocationTagsStatus = std::forward<CostAllocationTagsStatusT>(value);
  }
  template <typename CostAllocationTagsStatusT = Aws::Vector<CostAllocationTagStatusEntry>>
  UpdateCostAllocationTagsStatusRequest& WithCostAllocationTagsStatus(CostAllocationTagsStatusT&& value) {
    SetCostAllocationTagsStatus(std::forward<CostAllocationTagsStatusT>(value));
    return *this;
  }
  template <typename CostAllocationTagsStatusT = CostAllocationTagStatusEntry>
  UpdateCostAllocationTagsStatusRequest& AddCostAllocationTagsStatus(CostAllocationTagsStatusT&& value) {
    m_costAllocationTagsStatusHasBeenSet = true;
    m_costAllocationTagsStatus.emplace_back(std::forward<CostAllocationTagsStatusT>(value));
    return *this;
  }
  ///@}
 private:
