...
class AnomalyScore {
 public:
  ...
  inline void SetMaxScore(double value) {
    m_maxScoreHasBeenSet = true;
    m_maxScore = value;
  }
  inline AnomalyScore& WithMaxScore(double value) {
    SetMaxScore(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCurrentScore(double value) {
    m_currentScoreHasBeenSet = true;
    m_currentScore = value;
  }
  inline AnomalyScore& WithCurrentScore(double value) {
