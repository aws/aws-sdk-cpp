...
class GetCostAndUsageComparisonsRequest : public CostExplorerRequest {
 public:
  ...
  template <typename BillingViewArnT = Aws::String>
  GetCostAndUsageComparisonsRequest& WithBillingViewArn(BillingViewArnT&& value) {
  ...
  template <typename BaselineTimePeriodT = DateInterval>
  GetCostAndUsageComparisonsRequest& WithBaselineTimePeriod(BaselineTimePeriodT&& value) {
  ...
  template <typename ComparisonTimePeriodT = DateInterval>
  GetCostAndUsageComparisonsRequest& WithComparisonTimePeriod(ComparisonTimePeriodT&& value) {
  ...
  template <typename MetricForComparisonT = Aws::String>
  GetCostAndUsageComparisonsRequest& WithMetricForComparison(MetricForComparisonT&& value) {
  ...
  template <typename FilterT = Expression>
  GetCostAndUsageComparisonsRequest& WithFilter(FilterT&& value) {
  ...
  template <typename GroupByT = Aws::Vector<GroupDefinition>>
  GetCostAndUsageComparisonsRequest& WithGroupBy(GroupByT&& value) {
    SetGroupBy(std::forward<GroupByT>(value));
    return *this;
  }
  template <typename GroupByT = GroupDefinition>
  GetCostAndUsageComparisonsRequest& AddGroupBy(GroupByT&& value) {
    m_groupByHasBeenSet = true;
  ...
  inline GetCostAndUsageComparisonsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextPageTokenT = Aws::String>
  GetCostAndUsageComparisonsRequest& WithNextPageToken(NextPageTokenT&& value) {
