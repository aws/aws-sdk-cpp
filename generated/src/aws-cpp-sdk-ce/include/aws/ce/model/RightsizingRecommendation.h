...
class RightsizingRecommendation {
 public:
  ...
  void SetCurrentInstance(CurrentInstanceT&& value) {
    m_currentInstanceHasBeenSet = true;
    m_currentInstance = std::forward<CurrentInstanceT>(value);
  }
  template <typename CurrentInstanceT = CurrentInstance>
  RightsizingRecommendation& WithCurrentInstance(CurrentInstanceT&& value) {
    SetCurrentInstance(std::forward<CurrentInstanceT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetRightsizingType(RightsizingType value) {
    m_rightsizingTypeHasBeenSet = true;
    m_rightsizingType = value;
  }
  inline RightsizingRecommendation& WithRightsizingType(RightsizingType value) {
    SetRightsizingType(value);
    return *this;
  }
  ///@}
  ...
  void SetModifyRecommendationDetail(ModifyRecommendationDetailT&& value) {
    ...
    m_modifyRecommendationDetail = std::forward<ModifyRecommendationDetailT>(value);
  }
  template <typename ModifyRecommendationDetailT = ModifyRecommendationDetail>
  RightsizingRecommendation& WithModifyRecommendationDetail(ModifyRecommendationDetailT&& value) {
    SetModifyRecommendationDetail(std::forward<ModifyRecommendationDetailT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTerminateRecommendationDetail(TerminateRecommendationDetailT&& value) {
    ...
    m_terminateRecommendationDetail = std::forward<TerminateRecommendationDetailT>(value);
  }
  template <typename TerminateRecommendationDetailT = TerminateRecommendationDetail>
  RightsizingRecommendation& WithTerminateRecommendationDetail(TerminateRecommendationDetailT&& value) {
    SetTerminateRecommendationDetail(std::forward<TerminateRecommendationDetailT>(value));
    return *this;
  }
  ///@}
  ...
  inline RightsizingRecommendation& AddFindingReasonCodes(FindingReasonCode value) {
    m_findingReasonCodesHasBeenSet = true;
